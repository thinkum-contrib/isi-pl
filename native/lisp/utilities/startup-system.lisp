  ...
  (WITH-PROCESS-LOCK *BOOTSTRAP-LOCK*
   ...
   (CL:LET* ((*MODULE* (GET-STELLA-MODULE "/UTILITIES" (> *STARTUP-TIME-PHASE* 1))) (*CONTEXT* *MODULE*))
    ...
    (CL:WHEN (CURRENT-STARTUP-TIME-PHASE? 7)
     (DEFINE-FUNCTION-OBJECT "STARTUP-UTILITIES-SYSTEM" "(DEFUN STARTUP-UTILITIES-SYSTEM () :PUBLIC? TRUE)"
    ...
    (CL:WHEN (CURRENT-STARTUP-TIME-PHASE? 9) (%IN-MODULE (COPY-CONS-TREE (WRAP-STRING "/UTILITIES")))
     (CL:LET* ((PHASE NULL-INTEGER) (ITER-006 0) (UPPER-BOUND-007 9))
      ...
      (CL:LOOP WHILE (CL:<= ITER-006 UPPER-BOUND-007) DO (CL:SETQ PHASE ITER-006) (CL:SETQ *STARTUP-TIME-PHASE* PHASE)
       (STARTUP-MANUALS) (STARTUP-UNITS) (STARTUP-UNIT-DEFS) (CL:SETQ ITER-006 (CL:1+ ITER-006))))
