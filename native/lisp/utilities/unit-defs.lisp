...
"
  (CL:LET* ((M NULL)) (CL:SETQ M (DEFINE-BASE-MEASURE "Mass" "kg"))
   (ADD-UNIT M "g" 0.001d0 "kg") (ADD-UNIT M "mg" 0.001d0 "g")
   (ADD-UNIT M "ug" 1.0d-6 "g") (ADD-UNIT M "ng" 1.0d-9 "g")
   (ADD-UNIT M "pg" 1.0d-12 "g") (ADD-UNIT M "d" 1.7d-24 "g")
   (ADD-UNIT M "dalton" 1.0d0 "d") (ADD-UNIT M "kd" 1000.0d0 "d")
   (ADD-UNIT M "lbs" 0.45359237d0 "kg") (ADD-UNIT M "oz" 0.0625d0 "lbs")
   (ADD-UNIT M "gr" 1.4285714285714287d-4 "lbs") (ADD-UNIT M "lb" 1.0d0 "lbs")
   (ADD-UNIT M "mton" 1000000.0d0 "g") (ADD-UNIT M "tonne" 1000000.0d0 "g")
   (ADD-UNIT M "ton" 2000.0d0 "lbs") (ADD-UNIT M "longton" 2240.0d0 "lbs")
   (ADD-UNIT M "stone" 14.0d0 "lbs") (ADD-UNIT M "hwt" 100.0d0 "lbs")
   (ADD-UNIT M "slug" 14594.14842519685d0 "g") (ADD-UNIT M "carat" 0.2d0 "g")
   ...
   (ADD-UNIT M "angstrom" 1.0d-10 "m") (ADD-UNIT M "ang" 1.0d0 "angstrom")
   (ADD-UNIT M "in" 0.0254d0 "m") (ADD-UNIT M "ft" 12.0d0 "in")
   (ADD-UNIT M "yd" 3.0d0 "ft") (ADD-UNIT M "mile" 5280.0d0 "ft")
   (ADD-UNIT M "miles" 1.0d0 "mile") (ADD-UNIT M "mi" 1.0d0 "mile")
   (ADD-UNIT M "NM" 1852.0d0 "m") (ADD-UNIT M "nautmi" 1852.0d0 "m")
   (ADD-UNIT M "fathom" 6.0d0 "ft") (ADD-UNIT M "furlong" 220.0d0 "yd")
   (ADD-UNIT M "hand" 4.0d0 "in") (ADD-UNIT M "hh" 1.0d0 "hand")
   ...
   (ADD-UNIT M "LY" 1.0d0 "lightyear") (ADD-UNIT M "parsec" 3.085678d+16 "m")
   ...
   (ADD-UNIT M "sqmile" 1.0d0 "mile2") (ADD-UNIT M "hectare" 10000.0d0 "m2")
   ...
   (ADD-UNIT M "ul" 1.0d-6 "liter") (ADD-UNIT M "nl" 1.0d-9 "liter")
   (ADD-UNIT M "pl" 1.0d-12 "liter") (ADD-UNIT M "cc" 1.0d0 "ml")
   (ADD-UNIT M "cl" 0.01d0 "liter") (ADD-UNIT M "dl" 0.1d0 "liter")
   (ADD-UNIT M "Hl" 100.0d0 "liter") (ADD-UNIT M "cuft" 1.0d0 "ft3")
   (ADD-UNIT M "cuyd" 1.0d0 "yd3") (ADD-UNIT M "acrefeet" 1.0d0 "acre.ft")
   (ADD-UNIT M "gallon" 231.0d0 "in3") (ADD-UNIT M "pint" 0.125d0 "gallon")
   (ADD-UNIT M "quart" 0.25d0 "gallon") (ADD-UNIT M "gal" 1.0d0 "gallon")
   (ADD-UNIT M "qt" 1.0d0 "quart") (ADD-UNIT M "floz" 0.0625d0 "pint")
   (ADD-UNIT M "barrel" 42.0d0 "gal") (ADD-UNIT M "cup" 0.5d0 "pint")
   (ADD-UNIT M "tbl" 0.0625d0 "cup")
   (ADD-UNIT M "tsp" 0.3333333333333333d0 "tbl")
   (ADD-UNIT M "bbl" 1.0d0 "barrel") (ADD-UNIT M "Mbbl" 1000000.0d0 "barrel")
   (ADD-UNIT M "Bbbl" 1.0d+9 "barrel") (ADD-UNIT M "BRT" 100.0d0 "ft3")
   (CL:SETQ M (DEFINE-BASE-MEASURE "Time" "s")) (ADD-UNIT M "fs" 1.0d-15 "s")
   (ADD-UNIT M "ps" 1.0d-12 "s") (ADD-UNIT M "ns" 1.0d-9 "s")
   (ADD-UNIT M "us" 1.0d-6 "s") (ADD-UNIT M "ms" 0.001d0 "s")
   (ADD-UNIT M "min" 60.0d0 "s") (ADD-UNIT M "h" 60.0d0 "min")
   (ADD-UNIT M "day" 24.0d0 "h") (ADD-UNIT M "hr" 1.0d0 "h")
   (ADD-UNIT M "week" 7.0d0 "day") (ADD-UNIT M "fortnight" 14.0d0 "day")
   (ADD-UNIT M "year" 365.24219d0 "day") (ADD-UNIT M "decade" 10.0d0 "year")
   ...
   (ADD-UNIT M "knots" 1.0d0 "kts") (ADD-UNIT M "c" 2.99792458d+8 "m/s")
   ...
   (ADD-UNIT M "umol" 1.0d-6 "mole") (ADD-UNIT M "kmol" 1000.0d0 "mole")
   (ADD-UNIT M "kilomole" 1.0d0 "kmol") (ADD-UNIT M "millimole" 1.0d0 "mmol")
   (ADD-UNIT M "micromole" 1.0d0 "umol")
   (ADD-UNIT M "molecule" 1.660540186674939d-24 "mol")
   (ADD-UNIT M "particle" 1.0d0 "molecule")
   (ADD-UNIT M "atom" 1.0d0 "molecule") (ADD-UNIT M "ion" 1.0d0 "molecule")
   (CL:SETQ M (DEFINE-DERIVED-MEASURE "Molality" "mol/kg" "mol/kg"))
   (ADD-UNIT M "molal" 1.0d0 "mol/kg")
   (CL:SETQ M
    (DEFINE-DERIVED-MEASURE "Concentration-Of-Substance" "mol/m3" "mol/m3"))
   ...
   (ADD-UNIT M "mmHg" 1.0d0 "torr") (ADD-UNIT M "psi" 6895301.7d0 "g/s2m")
   ...
   (ADD-UNIT M "BTU" 1055.05585262d0 "J") (ADD-UNIT M "cal" 4.1868d0 "J")
   (ADD-UNIT M "kcal" 1000.0d0 "cal") (ADD-UNIT M "therm" 1.0550559d+8 "J")
   ...
   (CL:SETQ M (DEFINE-DERIVED-MEASURE "Electric-Potential" "V" "m2kg/s3A"))
   ...
   (ADD-UNIT M "kohm" 1000.0d0 "ohm") (ADD-UNIT M "Mohm" 1000000.0d0 "ohm")
   (CL:SETQ M (DEFINE-DERIVED-MEASURE "Electric-Conductance" "mho" "ohm-1"))
   ...
   (CL:SETQ M (DEFINE-BASE-MEASURE "Temperature" "K"))
   (ADD-UNIT M "oK" 1.0d0 "K") (ADD-UNIT M "Kelvin" 1.0d0 "K")
   (ADD-UNIT M "oC" 1.0d0 "K") (ADD-UNIT M "oF" 0.5555555555555556d0 "K")
   (ADD-UNIT M "Rankine" 1.0d0 "oF")
   (CL:SETQ M (DEFINE-BASE-MEASURE "Data" "bit"))
   (ADD-UNIT M "byte" 8.0d0 "bit") (ADD-UNIT M "B" 1.0d0 "byte")
   (ADD-UNIT M "Kibit" 1024.0d0 "bit") (ADD-UNIT M "kibit" 1.0d0 "Kibit")
   (ADD-UNIT M "Mibit" 1024.0d0 "kibit") (ADD-UNIT M "Gibit" 1024.0d0 "Mibit")
   ...
   (ADD-UNIT M "kbit" 1000.0d0 "bit") (ADD-UNIT M "Mbit" 1000.0d0 "kbit")
   (ADD-UNIT M "Gbit" 1000.0d0 "Mbit") (ADD-UNIT M "kB" 1000.0d0 "byte")
   (ADD-UNIT M "MB" 1000.0d0 "kB") (ADD-UNIT M "GB" 1000.0d0 "MB")
   (ADD-UNIT M "TB" 1000.0d0 "GB") (ADD-UNIT M "PB" 1000.0d0 "TB")
   (CL:SETQ M (DEFINE-DIMENSIONLESS-MEASURE)) (ADD-UNIT M "%" 0.01d0 "")
   (ADD-UNIT M "%%" 0.001d0 "") (ADD-UNIT M "rad" 1.0d0 "")
   (ADD-UNIT M "radian" 1.0d0 "rad")
   (ADD-UNIT M "deg" 0.017453292519943295d0 "rad")
   (ADD-UNIT M "minute" 0.016666666666666666d0 "deg")
   (ADD-UNIT M "sec" 0.016666666666666666d0 "minute")
   (ADD-UNIT M "arcmin" 1.0d0 "minute") (ADD-UNIT M "arcsec" 1.0d0 "sec")
   (ADD-UNIT M "degree" 1.0d0 "deg") (ADD-UNIT M "mil" 0.05625d0 "deg")
   ...
   (ADD-UNIT M "pCi" 1.0d-9 "Ci") (ADD-UNIT M "rps" 360.0d0 "deg/s")
...
\")" (CL:FUNCTION INITIALIZE-UNIT-DEFINITIONS) NULL)
    ...
    (CL:LET*
     ((FUNCTION (LOOKUP-FUNCTION SYM-UNIT-DEFS-UTILITIES-STARTUP-UNIT-DEFS)))
