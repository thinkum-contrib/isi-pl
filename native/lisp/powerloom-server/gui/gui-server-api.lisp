...
(CL:DECLAIM
 (CL:SPECIAL *STARTUP-TIME-PHASE* NULL-CHARACTER *MOST-RECENT-QUERY* *LAZY-SATELLITE-RULES?* PLI::TAXONOMIC-ENV
  EOL-STRING *CONTEXT* TRUE-WRAPPER NULL-STRING-WRAPPER FALSE-WRAPPER NULL-INTEGER *KB-DIRECTORY* STANDARD-OUTPUT EOL
  *MODULE* *ROOT-MODULE* NIL))
...
(CL:DEFUN PL-OBJECT-TO-GUI-NAME (X)
  (CL:LET* ((HOMEMODULE (HOME-MODULE X)) (SURROGATE (OBJECT-SURROGATE X)))
   (CL:WHEN (CL:AND (CL:EQ SURROGATE NULL) (SURROGATE? X)) (CL:SETQ SURROGATE X))
   (CL:IF (CL:NOT (CL:EQ SURROGATE NULL))
    (CL:IF (CL:NOT (CL:EQ HOMEMODULE (%HOME-CONTEXT SURROGATE)))
     (CONCATENATE (%MODULE-NAME (%HOME-CONTEXT SURROGATE)) "/" (%SYMBOL-NAME SURROGATE)) (%SYMBOL-NAME SURROGATE))
...
(CL:DEFUN GUI-NAME-TO-PL-NAME (NAME)
  ...
  (CL:IF (QUALIFIED-STELLA-NAME? NAME)
   (CL:LET* ((BARENAME STELLA::NULL-STRING) (MODULE STELLA::NULL-STRING) (TYPE NULL))
...
(CL:DEFUN SERVER-GET-CONCEPT-COMPLETIONS (PLMODULE PREFIX)
  ...
  (CL:LET* ((MODULE (PLI::GET-MODULE (|%Value| PLMODULE) NULL)))
   (CL:LET* ((*MODULE* MODULE) (*CONTEXT* *MODULE*)) (CL:DECLARE (CL:SPECIAL *MODULE* *CONTEXT*))
    (GET-CONCEPTS-WITH-PREFIX MODULE (|%Value| PREFIX)))))
...
(CL:DEFUN SERVER-GET-INSTANCES-FOR-MODULE (PLSTRING)
  ...
  (CL:LET*
   ((MODULE (PLI::GET-MODULE (|%Value| PLSTRING) NULL)) (ALLINSTANCES (ALL-INSTANCES MODULE CL:T))
    (NONSKOLEMINSTANCES (NEW-LIST)) (RESULT (|new-PLInstanceContainer|)) (XMLINSTANCES (NEW-LIST)))
     ...
     (CL:WHEN (CL:NOT (SKOLEM? INSTANCE))
      (CL:IF (CL:EQ COLLECT-000 NULL)
       (CL:PROGN (CL:SETQ COLLECT-000 (CONS INSTANCE NIL))
        (CL:IF (CL:EQ (%THE-CONS-LIST NONSKOLEMINSTANCES) NIL)
         (CL:SETF (%THE-CONS-LIST NONSKOLEMINSTANCES) COLLECT-000)
   ...
   (CL:SETQ XMLINSTANCES (SORT XMLINSTANCES (CL:FUNCTION |PLInstance<|))) (CL:SETF (|%PLInstance| RESULT) XMLINSTANCES)
   RESULT))
...
(CL:DEFUN SERVER-GET-INSTANCE-COMPLETIONS (PLMODULE PREFIX)
  ...
  (CL:LET*
   ((MODULE (PLI::GET-MODULE (|%Value| PLMODULE) NULL)) (ALLINSTANCES (ALL-INSTANCES MODULE CL:NIL))
    (NONSKOLEMINSTANCES (NEW-LIST)) (RESULT (|new-PLInstanceContainer|)) (XMLINSTANCES (NEW-LIST))
   ...
   (CL:LET* ((INSTANCE NULL) (ITER-000 ALLINSTANCES) (COLLECT-000 NULL))
    (CL:LOOP WHILE (NEXT? ITER-000) DO (CL:SETQ INSTANCE (%VALUE ITER-000))
     (CL:WHEN
      (CL:AND (CL:NOT (SKOLEM? INSTANCE)) (STARTS-WITH? (GET-LOGIC-OBJECT-NAME INSTANCE "FALSE") DOWNCASEDPREFIX 0))
      (CL:IF (CL:EQ COLLECT-000 NULL)
       (CL:PROGN (CL:SETQ COLLECT-000 (CONS INSTANCE NIL))
        (CL:IF (CL:EQ (%THE-CONS-LIST NONSKOLEMINSTANCES) NIL)
         (CL:SETF (%THE-CONS-LIST NONSKOLEMINSTANCES) COLLECT-000)
...
(CL:DEFUN SERVER-GET-RELATION-COMPLETIONS (PLMODULE PREFIX)
  ...
  (CL:LET* ((MODULE (PLI::GET-MODULE (|%Value| PLMODULE) NULL)))
   (CL:LET* ((*MODULE* MODULE) (*CONTEXT* *MODULE*)) (CL:DECLARE (CL:SPECIAL *MODULE* *CONTEXT*))
    (GET-RELATIONS-WITH-PREFIX MODULE (|%Value| PREFIX)))))
...
(CL:DEFUN SERVER-GET-INSTANCES-FOR-CONCEPT (MODULENAME CONCEPTNAME)
  ...
  (CL:LET*
   ((MODULE (PLI::GET-MODULE (|%Value| MODULENAME) NULL))
    (ITER (PLI::GET-CONCEPT-INSTANCES (PLI::GET-CONCEPT (|%Value| CONCEPTNAME) MODULE NULL) MODULE NULL))
...
(CL:DEFUN SERVER-GET-DIRECT-INSTANCES-FOR-CONCEPT (MODULENAME CONCEPTNAME)
  ...
  (CL:LET*
   ((MODULE (PLI::GET-MODULE (|%Value| MODULENAME) NULL))
    (ITER (PLI::GET-DIRECT-CONCEPT-INSTANCES (PLI::GET-CONCEPT (|%Value| CONCEPTNAME) MODULE NULL) MODULE NULL))
    (INSTANCES (NEW-LIST)) (RESULT (|new-PLInstanceContainer|)) (XMLINSTANCES (NEW-LIST)))
   (CL:LET* ((INSTANCE NULL) (ITER-000 ITER) (COLLECT-000 NULL))
    (CL:LOOP WHILE (NEXT? ITER-000) DO (CL:SETQ INSTANCE (%VALUE ITER-000))
     (CL:IF (CL:EQ COLLECT-000 NULL)
...
(CL:DEFUN SERVER-GET-SUPERCONCEPTS-FOR-CONCEPT (MODULENAME CONCEPTNAME)
  ...
  (CL:LET*
   ((CONCEPT (PLI::S-GET-CONCEPT (GUI-NAME-TO-PL-NAME (|%Value| CONCEPTNAME)) (|%Value| MODULENAME) NULL))
    (MODULE (PLI::GET-MODULE (|%Value| MODULENAME) NULL)))
...
(CL:DEFUN SERVER-GET-SUPERRELATIONS-FOR-RELATION (MODULENAME RELATIONNAME)
  ...
  (CL:LET*
   ((RELATION (PLI::S-GET-RELATION (GUI-NAME-TO-PL-NAME (|%Value| RELATIONNAME)) (|%Value| MODULENAME) NULL))
    (MODULE (PLI::GET-MODULE (|%Value| MODULENAME) NULL)))
...
(CL:DEFUN SERVER-GET-INCLUDES-FOR-MODULE (MODULENAME)
  ...
  (CL:LET* ((MODULE (PLI::GET-MODULE (|%Value| MODULENAME) NULL)))
   (CREATE-MODULE-COLLECTION (LISTIFY (PLI::GET-PARENT-MODULES MODULE)))))
...
(CL:DEFUN SERVER-GET-VARIABLES-FOR-RELATION (MODULENAME RELATIONNAME)
  "Get the superrelations for module+relation"
  (CL:LET* ((RELATION (PLI::S-GET-RELATION (GUI-NAME-TO-PL-NAME (|%Value| RELATIONNAME)) (|%Value| MODULENAME) NULL)))
...
(CL:DEFUN SERVER-GET-PROPOSITIONS-FOR-MODULE (MODULENAME)
  ...
  (CL:LET* ((MODULE (PLI::GET-MODULE (|%Value| MODULENAME) NULL)))
   (CL:LET* ((*MODULE* MODULE) (*CONTEXT* *MODULE*)) (CL:DECLARE (CL:SPECIAL *MODULE* *CONTEXT*))
    (CL:LET*
     ((ITER (PLI::GET-PROPOSITIONS-IN-MODULE MODULE NULL)) (PROPOSITIONS (NEW-LIST))
      (RESULT (|new-PLPropositionContainer|)) (XMLINSTANCES (NEW-LIST)))
     ...
     (CL:SETQ XMLINSTANCES (MAKE-PL-PROPOSITIONS PROPOSITIONS MODULE CL:NIL))
     (CL:SETF (|%PLProposition| RESULT) XMLINSTANCES) RESULT))))
...
(CL:DEFUN SERVER-GET-RELATIONS-FOR-CONCEPT (MODULENAME CONCEPTNAME)
  ...
  (CL:LET* ((MODULE (PLI::GET-MODULE (|%Value| MODULENAME) NULL)))
   (CL:LET* ((*MODULE* MODULE) (*CONTEXT* *MODULE*)) (CL:DECLARE (CL:SPECIAL *MODULE* *CONTEXT*))
    (CL:LET*
     ((CONCEPT (PLI::GET-CONCEPT (|%Value| CONCEPTNAME) MODULE NULL)) (XMLINSTANCES (NEW-LIST))
      (RELATIONS (GET-DIRECT-RELATIONS-FOR-CONCEPT MODULE CONCEPT)) (CONTAINER (|new-PLRelationContainer|)))
     (CL:SETQ XMLINSTANCES (MAKE-PL-RELATIONS RELATIONS (|%Value| MODULENAME)))
     (CL:SETF (|%PLRelation| CONTAINER) XMLINSTANCES) CONTAINER))))
...
(CL:DEFUN SERVER-GET-INHERITED-RELATIONS-FOR-CONCEPT (MODULENAME CONCEPTNAME)
  ...
  (CL:LET* ((MODULE (PLI::GET-MODULE (|%Value| MODULENAME) NULL)))
   (CL:LET* ((*MODULE* MODULE) (*CONTEXT* *MODULE*)) (CL:DECLARE (CL:SPECIAL *MODULE* *CONTEXT*))
    (CL:LET*
     ((CONCEPT (PLI::GET-CONCEPT (|%Value| CONCEPTNAME) MODULE NULL)) (XMLINSTANCES (NEW-LIST))
      (RELATIONS (GET-INHERITED-RELATIONS-FOR-CONCEPT MODULE CONCEPT)) (CONTAINER (|new-PLRelationContainer|)))
     (CL:SETQ XMLINSTANCES (MAKE-PL-RELATIONS RELATIONS (|%Value| MODULENAME)))
     (CL:SETF (|%PLRelation| CONTAINER) XMLINSTANCES) CONTAINER))))
...
(CL:DEFUN SERVER-GET-PROPOSITIONS-FOR-INSTANCE (MODULENAME INSTANCENAME)
  ...
  (CL:LET* ((MODULE (PLI::GET-MODULE (|%Value| MODULENAME) NULL)))
   (CL:LET* ((*MODULE* MODULE) (*CONTEXT* *MODULE*)) (CL:DECLARE (CL:SPECIAL *MODULE* *CONTEXT*))
    (CL:LET*
     ((PROPOSITIONS (GET-PROPOSITIONS-FOR-OBJECT (|%Value| MODULENAME) (|%Value| INSTANCENAME) CL:NIL))
      (XMLINSTANCES (NEW-LIST)) (RESULT (|new-PLPropositionContainer|)))
     (CL:SETQ XMLINSTANCES (MAKE-PL-PROPOSITIONS PROPOSITIONS MODULE CL:NIL))
     (CL:SETF (|%PLProposition| RESULT) XMLINSTANCES) RESULT))))
...
(CL:DEFUN SERVER-GET-PROPOSITIONS-FOR-RELATION (MODULENAME INSTANCENAME)
  ...
  (CL:LET* ((MODULE (PLI::GET-MODULE (|%Value| MODULENAME) NULL)))
   (CL:LET* ((*MODULE* MODULE) (*CONTEXT* *MODULE*)) (CL:DECLARE (CL:SPECIAL *MODULE* *CONTEXT*))
    (CL:LET*
     ((PROPOSITIONS (GET-PROPOSITIONS-FOR-OBJECT (|%Value| MODULENAME) (|%Value| INSTANCENAME) CL:T))
      (XMLINSTANCES (NEW-LIST)) (RESULT (|new-PLPropositionContainer|)))
     (CL:SETQ XMLINSTANCES (MAKE-PL-PROPOSITIONS PROPOSITIONS MODULE CL:NIL))
     (CL:SETF (|%PLProposition| RESULT) XMLINSTANCES) RESULT))))
...
(CL:DEFUN SERVER-GET-RULES-FOR-RELATION (MODULENAME INSTANCENAME)
  ...
  (CL:LET* ((MODULE (PLI::GET-MODULE (|%Value| MODULENAME) NULL)))
   (CL:LET* ((*MODULE* MODULE) (*CONTEXT* *MODULE*)) (CL:DECLARE (CL:SPECIAL *MODULE* *CONTEXT*))
    (CL:LET*
     ((PROPOSITIONS (GET-RELEVANT-RULES-FOR-RELATION (|%Value| MODULENAME) (|%Value| INSTANCENAME)))
      (XMLINSTANCES (NEW-LIST)) (RESULT (|new-PLPropositionContainer|)))
     (CL:SETQ XMLINSTANCES (MAKE-PL-PROPOSITIONS PROPOSITIONS MODULE CL:T))
     (CL:SETF (|%PLProposition| RESULT) XMLINSTANCES) RESULT))))
...
(CL:DEFUN SERVER-GET-PROPOSITIONS-FOR-INSTANCE-AND-RELATION (MODULENAME INSTANCENAME RELATIONNAME)
  ...
  (CL:LET* ((MODULE (PLI::GET-MODULE (|%Value| MODULENAME) NULL)))
   (CL:LET* ((*MODULE* MODULE) (*CONTEXT* *MODULE*)) (CL:DECLARE (CL:SPECIAL *MODULE* *CONTEXT*))
    (CL:LET*
     ((PROPOSITIONS
       (GET-PROPOSITIONS-FOR-INSTANCE-AND-RELATION (|%Value| MODULENAME) (|%Value| INSTANCENAME)
        (|%Value| RELATIONNAME)))
      (XMLINSTANCES (NEW-LIST)) (RESULT (|new-PLPropositionContainer|)))
     (CL:SETQ XMLINSTANCES (MAKE-PL-PROPOSITIONS PROPOSITIONS MODULE CL:NIL))
     (CL:SETF (|%PLProposition| RESULT) XMLINSTANCES) RESULT))))
...
(CL:DEFUN SERVER-EVALUATE-LOGIC-COMMAND (MODULENAME COMMANDSTRING)
  ...
  (CL:LET*
   ((COMMAND (|%Value| COMMANDSTRING)) (MODULE (|%Value| MODULENAME)) (EVALRESULT STELLA::NULL-STRING)
    (RESULT (|new-PLString|)))
   (CL:DECLARE (CL:TYPE CL:SIMPLE-STRING COMMAND MODULE EVALRESULT))
   (CL:SETQ EVALRESULT (EVALUATE-LOGIC-COMMAND-IN-MODULE COMMAND MODULE CL:T))
...
(CL:DEFUN SERVER-GET-LOADABLE-KBS ()
  (CL:LET* ((FILEDESCRIPTIONS (LOAD-INDEX-FILE)) (RESULT (|new-PLModuleFileList|)) (PLFILES (NEW-LIST)))
   (CL:LET* ((DESC NULL) (ITER-000 FILEDESCRIPTIONS))
    (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-000 NIL)) DO (CL:SETQ DESC (%%VALUE ITER-000))
     (INSERT PLFILES (MAKE-PL-FILE DESC)) (CL:SETQ ITER-000 (%%REST ITER-000))))
...
(CL:DEFUN SERVER-LOAD-KB (PLKBNAME)
  ...
  (CL:LET*
   ((KBNAME (|%Value| PLKBNAME)) (FILEINDEX (SERVER-GET-LOADABLE-KBS))
    (FILENAME (FIND-FILENAME-FOR-KB FILEINDEX KBNAME)) (RESULT (|new-PLString|)))
   (CL:DECLARE (CL:TYPE CL:SIMPLE-STRING KBNAME FILENAME))
   (%%PRINT-STREAM (%NATIVE-STREAM STANDARD-OUTPUT) "kbName is:" KBNAME EOL)
   (%%PRINT-STREAM (%NATIVE-STREAM STANDARD-OUTPUT) "fileName is:" FILENAME EOL)
   (CL:IF (CL:NOT (CL:EQ FILENAME STELLA::NULL-STRING))
    (CL:PROGN (%%PRINT-STREAM (%NATIVE-STREAM STANDARD-OUTPUT) "Loading KB: " FILENAME EOL) (%LOAD FILENAME NIL)
     (CL:SETF (|%Value| RESULT) "OK"))
    (CL:PROGN (%%PRINT-STREAM (%NATIVE-STREAM STANDARD-OUTPUT) "Error: couldn't find fileName for " KBNAME)
     (CL:SETF (|%Value| RESULT) "ERROR")))
   RESULT))

;;; (DEFUN (SERVER-LOAD-KB2 |PLString|) ...)

(CL:DEFUN SERVER-LOAD-KB2 (FILE)
  (CL:LET* ((FILENAME (|%FileName| FILE)) (CONTENT (|%PLFileContent| FILE)) (RESULT (|new-PLString|)))
   ...
   (CL:COND
    ...
    ((CL:NOT (CL:EQ FILENAME STELLA::NULL-STRING)) (%LOAD FILENAME NIL)
     (CL:SETF (|%Value| RESULT) (EXTRACT-MODULE-NAME-FROM-FILE FILENAME))))
   RESULT))
...
(CL:DEFUN SERVER-SAVE-KB (PLMODULENAME PLKBNAME PLDESCRIPTION)
  (CL:LET*
   ((KBNAME (|%Value| PLKBNAME)) (MODULENAME (|%Value| PLMODULENAME)) (MODULE (PLI::GET-MODULE MODULENAME NULL))
    (DESCRIPTION (|%Value| PLDESCRIPTION)) (RAWFILEINDEX (LOAD-INDEX-FILE)) (FILEINDEX (SERVER-GET-LOADABLE-KBS))
    (FILENAME (FIND-FILENAME-FOR-KB FILEINDEX KBNAME)) (RESULT (|new-PLString|)))
      ...
      (NEWINDEX
       (CONS
        (CONS (WRAP-STRING KBNAME)
         (CONS (WRAP-STRING MODULENAME) (CONS (WRAP-STRING NEWFILE) (CONS (WRAP-STRING DESCRIPTION) NIL))))
        RAWFILEINDEX)))
...
(CL:DEFUN SERVER-SAVE-KB2 (PLMODULENAME PLFILENAME)
  (CL:LET*
   ((MODULENAME (|%Value| PLMODULENAME)) (MODULE (PLI::GET-MODULE MODULENAME NULL)) (FILENAME (|%Value| PLFILENAME))
    (STREAM (NEW-OUTPUT-STRING-STREAM)) (RESULT (|new-PLFile|)))
   (CL:DECLARE (CL:TYPE CL:SIMPLE-STRING MODULENAME FILENAME))
   (%%PRINT-STREAM (%NATIVE-STREAM STANDARD-OUTPUT) "Saving KB: " MODULENAME " to " FILENAME EOL)
   (DO-SAVE-MODULE MODULE STREAM) (CL:SETF (|%FileName| RESULT) FILENAME)
   (CL:LET* ((SELF-002 (|new-PLFileContent|))) (CL:SETF (|%textContent| SELF-002) (THE-STRING-READER STREAM))
    (CL:SETF (|%PLFileContent| RESULT) SELF-002))
   RESULT))

;;; (DEFUN (SERVER-CLEAR-KB |PLString|) ...)

(CL:DEFUN SERVER-CLEAR-KB (MODULE)
  (CL:LET* ((MODNAME (|%ModuleName| MODULE)) (RESULT (|new-PLString|))) (CL:DECLARE (CL:TYPE CL:SIMPLE-STRING MODNAME))
   (PLI::S-CLEAR-MODULE MODNAME NULL) (CL:SETF (|%Value| RESULT) "OK") RESULT))
...
(CL:DEFUN GET-QUERY-SESSION (QUERY ERROR?)
  (CL:LET* ((SESSIONNAME (|%QueryName| QUERY)) (SESSION (LOOKUP-SESSION SESSIONNAME CL:NIL)))
   (CL:DECLARE (CL:TYPE CL:SIMPLE-STRING SESSIONNAME))
   (CL:WHEN (CL:OR (CL:EQ SESSION NULL) (TIMED-OUT? SESSION))
    (CL:IF ERROR? (CL:ERROR (NEW-STELLA-EXCEPTION "Query session expired"))
     (CL:SETQ SESSION (CREATE-SESSION SESSIONNAME *QUERY-SESSION-TIMEOUT*))))
   SESSION))
...
(CL:DEFUN SERVER-QUERY (PLQUERY CONTINUEQUERY?)
  (CL:LET*
   ((CONTINUE? (STRING-EQL? (|%Value| CONTINUEQUERY?) "TRUE")) (SESSION (GET-QUERY-SESSION PLQUERY CONTINUE?))
    (RESULT (|new-PLQueryResult|)) (PLTUPLES (NEW-LIST)) (QUERY STELLA::NULL-STRING) (MODULENAME (|%Module| PLQUERY))
    (QUERYRESULT NULL) (MODULE (PLI::GET-MODULE MODULENAME NULL)))
   (CL:DECLARE (CL:TYPE CL:SIMPLE-STRING QUERY MODULENAME))
   (CL:IF CONTINUE? (CL:SETQ QUERY (CREATE-FOLLOWUP-QUERY-STRING PLQUERY))
    ...
    (CL:LET* ((TUPLE NULL) (ITER-000 QUERYRESULT) (COLLECT-000 NULL))
     (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-000 NIL)) DO (CL:SETQ TUPLE (%%VALUE ITER-000))
      (CL:IF (CL:EQ COLLECT-000 NULL)
       ...
       (CL:PROGN (CL:SETF (%%REST COLLECT-000) (CONS (MAKE-PL-TUPLE TUPLE) NIL))
...
(CL:DEFUN SERVER-SEARCH (SEARCHPARAMETER)
  (CL:LET*
   ((MODULENAME (|%ModuleName| SEARCHPARAMETER)) (SEARCHSTRING (|%SearchString| SEARCHPARAMETER))
    (SEARCHCONCEPT? (|%SearchConcept| SEARCHPARAMETER)) (SEARCHRELATION? (|%SearchRelation| SEARCHPARAMETER))
    (SEARCHINSTANCE? (|%SearchInstance| SEARCHPARAMETER)) (CASESENSITIVE? (|%CaseSensitive| SEARCHPARAMETER))
    (RESULT (|new-PLSearchResult|)) (SEARCHRESULTS (NEW-LIST)))
   (CL:DECLARE
    (CL:TYPE CL:SIMPLE-STRING MODULENAME SEARCHSTRING SEARCHCONCEPT? SEARCHRELATION? SEARCHINSTANCE? CASESENSITIVE?))
   (CL:IF (STRING-EQL? MODULENAME "ALL")
    (CL:SETQ SEARCHRESULTS
     (SEARCH-ALL-MODULES SEARCHSTRING SEARCHINSTANCE? SEARCHCONCEPT? SEARCHRELATION? CASESENSITIVE?))
    (CL:SETQ SEARCHRESULTS
     (SEARCH-MODULE MODULENAME SEARCHSTRING SEARCHINSTANCE? SEARCHCONCEPT? SEARCHRELATION? CASESENSITIVE?)))
   ...
   (CL:LET* ((*MODULE* MODULE) (*CONTEXT* *MODULE*)) (CL:DECLARE (CL:SPECIAL *MODULE* *CONTEXT*))
    (CL:LET*
     ((RESULT (|new-PLQueryResult|)) (PLTUPLES (NEW-LIST))
      (EXTENSION (PLI::S-GET-RELATION-EXTENSION (GUI-NAME-TO-PL-NAME (|%Value| RELATIONNAME)) MODULE NULL)))
      ...
      (CL:LOOP WHILE (NEXT? ITER-000) DO (CL:SETQ PROPOSITION (%VALUE ITER-000))
       (CL:IF (CL:EQ COLLECT-000 NULL)
        (CL:PROGN (CL:SETQ COLLECT-000 (CONS (MAKE-PL-TUPLE-FROM-PROPOSITION PROPOSITION) NIL))
         (CL:IF (CL:EQ (%THE-CONS-LIST PLTUPLES) NIL) (CL:SETF (%THE-CONS-LIST PLTUPLES) COLLECT-000)
          (ADD-CONS-TO-END-OF-CONS-LIST (%THE-CONS-LIST PLTUPLES) COLLECT-000)))
        (CL:PROGN (CL:SETF (%%REST COLLECT-000) (CONS (MAKE-PL-TUPLE-FROM-PROPOSITION PROPOSITION) NIL))
         (CL:SETQ COLLECT-000 (%%REST COLLECT-000))))))
     (CL:SETF (|%PLTuple| RESULT) PLTUPLES) RESULT))))
...
(CL:DEFUN SERVER-DESTROY-OBJECT (MODULENAME OBJECTNAME)
  "Destroy an object"
  (CL:LET*
   ((MODULESTRING (|%Value| MODULENAME)) (MODULE (PLI::GET-MODULE MODULESTRING NULL))
    (OBJECTSTRING (|%Value| OBJECTNAME)) (RESULT (|new-PLString|)))
   (CL:DECLARE (CL:TYPE CL:SIMPLE-STRING MODULESTRING OBJECTSTRING))
   (CL:LET* ((*MODULE* MODULE) (*CONTEXT* *MODULE*)) (CL:DECLARE (CL:SPECIAL *MODULE* *CONTEXT*))
    (PLI::S-DESTROY-OBJECT OBJECTSTRING MODULESTRING NULL) (CL:SETF (|%Value| RESULT) "OK") RESULT)))
  ...
  (CL:LET* ((MODULE (PLI::GET-MODULE (|%Value| MODULENAME) NULL)))
   (CL:LET* ((*MODULE* MODULE) (*CONTEXT* *MODULE*)) (CL:DECLARE (CL:SPECIAL *MODULE* *CONTEXT*))
    (CL:LET*
     ...
     (CL:WHEN (CL:NOT (CL:EQ RELATION NULL)) (INSERT XMLRELATIONS (MAKE-PL-RELATION RELATION (|%Value| MODULENAME))))
     (CL:SETF (|%PLRelation| RESULT) XMLRELATIONS) RESULT))))
  ...
  (CL:LET* ((MODULE (PLI::GET-MODULE (|%Value| MODULENAME) NULL)))
   (CL:LET* ((*MODULE* MODULE) (*CONTEXT* *MODULE*)) (CL:DECLARE (CL:SPECIAL *MODULE* *CONTEXT*))
    (CL:LET*
     ...
     (CL:WHEN (CL:NOT (CL:EQ CONCEPT NULL)) (INSERT XMLCONCEPTS (MAKE-PL-CONCEPT CONCEPT)))
     (CL:SETF (|%PLConcept| RESULT) XMLCONCEPTS) RESULT))))
  ...
  (CL:LET* ((MODULE (PLI::GET-MODULE (|%Value| MODULENAME) NULL)))
   (CL:LET* ((*MODULE* MODULE) (*CONTEXT* *MODULE*)) (CL:DECLARE (CL:SPECIAL *MODULE* *CONTEXT*))
    (CL:LET*
     ...
     (CL:WHEN (CL:AND (ISA? INSTANCE SGT-GUI-SERVER-API-LOGIC-LOGIC-OBJECT) (CL:NOT (CL:EQ INSTANCE NULL)))
...
(CL:DEFUN SERVER-GET-EXPLANATION-FOR-QUERY (QUERY RESULTNUMBER)
  (CL:LET*
   ((SESSION (GET-QUERY-SESSION QUERY CL:T)) (QUERYITERATOR (LOOKUP SESSION (WRAP-STRING "QueryIterator")))
    (SOLUTIONINDEX (CL:1- (STRING-TO-INTEGER (|%Value| RESULTNUMBER)))) (JUSTIFICATIONS NULL)
    (EXPLANATION "No explanation available.") (RESULT (|new-PLString|)) (MODULENAME (|%Module| QUERY))
   ...
   (CL:LET* ((*MODULE* MODULE) (*CONTEXT* *MODULE*)) (CL:DECLARE (CL:SPECIAL *MODULE* *CONTEXT*))
    ...
    (CL:WHEN (CL:> (LENGTH JUSTIFICATIONS) 0) (CL:SETQ EXPLANATION (GET-JUSTIFICATION-STRING (FIRST JUSTIFICATIONS))))
    (CL:SETF (|%Value| RESULT) EXPLANATION) RESULT)))
...
(CL:DEFUN SERVER-GET-INFO ()
  ...
  (CL:LET* ((RESULT (|new-PLServerInfo|)))
   (CL:IF *ALLOW-REMOTE-FILEBROWSING* (CL:SETF (|%AllowRemoteFileBrowsing| RESULT) "TRUE")
    (CL:SETF (|%AllowRemoteFileBrowsing| RESULT) "FALSE"))
   RESULT))
...
(CL:DEFUN EXTRACT-MODULE-NAME-FROM-STREAM (STREAM)
  (CL:LET* ((TREE NULL) (ITER-000 (S-EXPRESSIONS STREAM)) (I NULL-INTEGER) (ITER-001 1) (UPPER-BOUND-000 20))
   (CL:DECLARE (CL:TYPE CL:FIXNUM I ITER-001 UPPER-BOUND-000))
   (CL:LOOP WHILE (CL:AND (NEXT? ITER-000) (CL:<= ITER-001 UPPER-BOUND-000)) DO (CL:SETQ TREE (%VALUE ITER-000))
    (CL:SETQ I ITER-001) (CL:SETQ I I)
    (CL:COND
     ((CL:EQ (SAFE-PRIMARY-TYPE TREE) SGT-GUI-SERVER-API-STELLA-CONS)
      (CL:PROGN
       (CL:LET* ((OPERATOR (%%VALUE TREE)) (MODULENAME STELLA::NULL-STRING))
        ...
        (CL:COND
         ((SUBTYPE-OF-SYMBOL? (SAFE-PRIMARY-TYPE OPERATOR))
          (CL:PROGN
           (CL:COND
            ((STRING-EQL?
              (CL:IF (%CASE-SENSITIVE? *MODULE*) (STRING-UPCASE (%SYMBOL-NAME OPERATOR)) (%SYMBOL-NAME OPERATOR))
              "IN-MODULE")
             (CL:SETQ MODULENAME (COERCE-TO-MODULE-NAME (%%VALUE (%%REST TREE)) CL:NIL))
             (CL:IF (CL:EQ MODULENAME STELLA::NULL-STRING)
              (CL:LET* ((STREAM-000 (NEW-OUTPUT-STRING-STREAM)))
               (%%PRINT-STREAM (%NATIVE-STREAM STREAM-000) "Illegal IN-MODULE declaration: `" TREE "'")
...
(CL:DEFUN EXTRACT-MODULE-NAME-FROM-FILE (FILENAME)
  ...
  (CL:LET* ((MODULENAME STELLA::NULL-STRING)) (CL:DECLARE (CL:TYPE CL:SIMPLE-STRING MODULENAME))
   (CL:LET* ((IN NULL))
    (CL:UNWIND-PROTECT
     (CL:PROGN (CL:SETQ IN (OPEN-INPUT-FILE FILENAME)) (CL:SETQ MODULENAME (EXTRACT-MODULE-NAME-FROM-STREAM IN)))
...
(CL:DEFUN CREATE-QUERY-STRING (PLQUERY)
  (CL:LET*
   ((RESULT "") (QUERYBODY STELLA::NULL-STRING) (HOWMANYCLAUSE "") (INFERENCELEVELCLAUSE "") (MINSCORECLAUSE "")
    (MAXUNKNOWNSCLAUSE "") (MATCHMODECLAUSE "") (TIMEOUTCLAUSE "") (COMMANDCLAUSE "") (MOVEOUTCLAUSE "")
    (MAXIMIZESCORECLAUSE "") (DONTOPTIMIZECLAUSE ""))
   (CL:DECLARE
    (CL:TYPE CL:SIMPLE-STRING RESULT QUERYBODY HOWMANYCLAUSE INFERENCELEVELCLAUSE MINSCORECLAUSE MAXUNKNOWNSCLAUSE
     MATCHMODECLAUSE TIMEOUTCLAUSE COMMANDCLAUSE MOVEOUTCLAUSE MAXIMIZESCORECLAUSE DONTOPTIMIZECLAUSE))
   (CL:WHEN
    (CL:AND (CL:NOT (CL:EQ (|%NumResults| PLQUERY) STELLA::NULL-STRING))
     (CL:> (CL:THE CL:FIXNUM (CL:LENGTH (CL:THE CL:SIMPLE-STRING (|%NumResults| PLQUERY)))) 0)
     (CL:NOT (STRING-EQL? (|%NumResults| PLQUERY) "ALL")))
    (CL:SETQ HOWMANYCLAUSE (CONCATENATE " :HOW-MANY " (|%NumResults| PLQUERY))))
   (CL:WHEN
    (CL:AND (CL:NOT (CL:EQ (|%Timeout| PLQUERY) STELLA::NULL-STRING))
     (CL:> (CL:THE CL:FIXNUM (CL:LENGTH (CL:THE CL:SIMPLE-STRING (|%Timeout| PLQUERY)))) 0))
    (CL:SETQ TIMEOUTCLAUSE (CONCATENATE " :TIMEOUT " (|%Timeout| PLQUERY))))
   (CL:WHEN
    (CL:AND (CL:NOT (CL:EQ (|%Moveout| PLQUERY) STELLA::NULL-STRING))
     (CL:> (CL:THE CL:FIXNUM (CL:LENGTH (CL:THE CL:SIMPLE-STRING (|%Moveout| PLQUERY)))) 0))
    (CL:SETQ MOVEOUTCLAUSE (CONCATENATE " :MOVEOUT " (|%Moveout| PLQUERY))))
   (CL:WHEN
    (CL:AND (CL:NOT (CL:EQ (|%MinScore| PLQUERY) STELLA::NULL-STRING))
     (CL:> (CL:THE CL:FIXNUM (CL:LENGTH (CL:THE CL:SIMPLE-STRING (|%MinScore| PLQUERY)))) 0))
    (CL:SETQ MINSCORECLAUSE (CONCATENATE " :MINIMUM-SCORE " (|%MinScore| PLQUERY))))
   (CL:WHEN
    (CL:AND (CL:NOT (CL:EQ (|%MaximizeScore| PLQUERY) STELLA::NULL-STRING))
     (CL:> (CL:THE CL:FIXNUM (CL:LENGTH (CL:THE CL:SIMPLE-STRING (|%MaximizeScore| PLQUERY)))) 0))
    (CL:SETQ MAXIMIZESCORECLAUSE (CONCATENATE " :MAXIMIZE-SCORE? " (|%MaximizeScore| PLQUERY))))
   (CL:WHEN
    (CL:AND (CL:NOT (CL:EQ (|%DontOptimize| PLQUERY) STELLA::NULL-STRING))
     (CL:> (CL:THE CL:FIXNUM (CL:LENGTH (CL:THE CL:SIMPLE-STRING (|%DontOptimize| PLQUERY)))) 0))
    (CL:SETQ DONTOPTIMIZECLAUSE (CONCATENATE " :DONT-OPTIMIZE? " (|%DontOptimize| PLQUERY))))
   (CL:WHEN
    (CL:AND (CL:NOT (CL:EQ (|%MaxUnknowns| PLQUERY) STELLA::NULL-STRING))
     (CL:> (CL:THE CL:FIXNUM (CL:LENGTH (CL:THE CL:SIMPLE-STRING (|%MaxUnknowns| PLQUERY)))) 0))
    (CL:SETQ MAXUNKNOWNSCLAUSE (CONCATENATE " :MAXIMUM-UNKNOWNS " (|%MaxUnknowns| PLQUERY))))
   (CL:WHEN
    (CL:AND (CL:NOT (CL:EQ (|%MatchMode| PLQUERY) STELLA::NULL-STRING))
     (CL:> (CL:THE CL:FIXNUM (CL:LENGTH (CL:THE CL:SIMPLE-STRING (|%MatchMode| PLQUERY)))) 0))
   ...
   (CL:IF (CL:AND (CL:NOT (CL:EQ (|%IsAsk| PLQUERY) STELLA::NULL-STRING)) (STRING-EQL? (|%IsAsk| PLQUERY) "TRUE"))
    (CL:SETQ COMMANDCLAUSE "/LOGIC/ASK ") (CL:SETQ COMMANDCLAUSE "/LOGIC/RETRIEVE "))
   (CL:SETQ QUERYBODY (CONCATENATE (|%NumResults| PLQUERY) " " (|%Query| PLQUERY)))
   (CL:SETQ RESULT
    (CONCATENATE "(" COMMANDCLAUSE QUERYBODY HOWMANYCLAUSE TIMEOUTCLAUSE MOVEOUTCLAUSE MINSCORECLAUSE
     MAXIMIZESCORECLAUSE DONTOPTIMIZECLAUSE MAXUNKNOWNSCLAUSE MATCHMODECLAUSE INFERENCELEVELCLAUSE ")"))
   RESULT))
...
(CL:DEFUN CREATE-FOLLOWUP-QUERY-STRING (PLQUERY)
  (CL:LET* ((RESULT "") (QUERYBODY STELLA::NULL-STRING) (COMMANDCLAUSE STELLA::NULL-STRING))
   (CL:DECLARE (CL:TYPE CL:SIMPLE-STRING RESULT QUERYBODY COMMANDCLAUSE)) (CL:SETQ COMMANDCLAUSE "/LOGIC/RETRIEVE ")
   (CL:SETQ QUERYBODY (CONCATENATE (|%NumResults| PLQUERY) ""))
   (CL:SETQ RESULT (CONCATENATE "(" COMMANDCLAUSE QUERYBODY ")")) RESULT))
  ...
  (CL:LET* ((ARGUMENTS (%ARGUMENTS PROPOSITION)) (PLOBJECTUNIONS (NEW-LIST)) (RESULT (|new-PLTuple|)))
   (CL:LET* ((ARGUMENT NULL) (VECTOR-000 ARGUMENTS) (INDEX-000 0) (LENGTH-000 (LENGTH VECTOR-000)) (COLLECT-000 NULL))
    ...
    (CL:LOOP WHILE (CL:< INDEX-000 LENGTH-000) DO
     (CL:SETQ ARGUMENT (CL:AREF (CL:THE CL:SIMPLE-VECTOR (%THE-ARRAY VECTOR-000)) INDEX-000))
     (CL:IF (CL:EQ COLLECT-000 NULL)
      ...
      (CL:PROGN (CL:SETF (%%REST COLLECT-000) (CONS (MAKE-PL-OBJECT-UNION ARGUMENT) NIL))
       (CL:SETQ COLLECT-000 (%%REST COLLECT-000))))
    ...
    (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-000 NIL)) DO (CL:SETQ OBJECT (%%VALUE ITER-000))
     (CL:IF (CL:EQ COLLECT-000 NULL)
      (CL:PROGN (CL:SETQ COLLECT-000 (CONS (MAKE-PL-OBJECT-UNION OBJECT) NIL))
       (CL:IF (CL:EQ (%THE-CONS-LIST PLOBJECTUNIONS) NIL) (CL:SETF (%THE-CONS-LIST PLOBJECTUNIONS) COLLECT-000)
        (ADD-CONS-TO-END-OF-CONS-LIST (%THE-CONS-LIST PLOBJECTUNIONS) COLLECT-000)))
      (CL:PROGN (CL:SETF (%%REST COLLECT-000) (CONS (MAKE-PL-OBJECT-UNION OBJECT) NIL))
       (CL:SETQ COLLECT-000 (%%REST COLLECT-000))))
     (CL:SETQ ITER-000 (%%REST ITER-000))))
   (CL:SETF (|%PLObjectUnion| RESULT) PLOBJECTUNIONS) RESULT))
...
(CL:DEFUN MAKE-PL-OBJECT-UNION (OBJECT)
  (CL:LET* ((RESULT (|new-PLObjectUnion|))) (CL:SETF (|%LiteralValue| RESULT) "") (CL:SETF (|%Type| RESULT) "")
   (CL:WHEN (CL:EQ OBJECT NULL) (CL:SETF (|%LiteralValue| RESULT) "") (CL:SETF (|%Type| RESULT) "STRING")
    (CL:RETURN-FROM MAKE-PL-OBJECT-UNION RESULT))
   (CL:WHEN
    (CL:AND (SKOLEM? OBJECT)
     (CL:NOT (CL:EQ (ACCESS-IN-CONTEXT (%VARIABLE-VALUE OBJECT) (%HOME-CONTEXT OBJECT) CL:NIL) NULL)))
   ...
   (CL:LET* ((TEST-VALUE-000 (SAFE-PRIMARY-TYPE OBJECT)))
    (CL:COND
     ((SUBTYPE-OF-INTEGER? TEST-VALUE-000)
      (CL:PROGN (CL:SETF (|%LiteralValue| RESULT) (STRINGIFY (WRAP-INTEGER (%WRAPPER-VALUE OBJECT))))
       (CL:SETF (|%Type| RESULT) "INTEGER")))
     ((SUBTYPE-OF-FLOAT? TEST-VALUE-000)
      (CL:PROGN (CL:SETF (|%LiteralValue| RESULT) (STRINGIFY (WRAP-FLOAT (%WRAPPER-VALUE OBJECT))))
       (CL:SETF (|%Type| RESULT) "FLOAT")))
     ((SUBTYPE-OF-STRING? TEST-VALUE-000)
      (CL:PROGN (CL:SETF (|%LiteralValue| RESULT) (%WRAPPER-VALUE OBJECT)) (CL:SETF (|%Type| RESULT) "STRING")))
     ((SUBTYPE-OF? TEST-VALUE-000 SGT-GUI-SERVER-API-LOGIC-TRUTH-VALUE)
      (CL:PROGN (CL:SETF (|%LiteralValue| RESULT) (GET-TRUTH-VALUE-STRING OBJECT))
       (CL:SETF (|%Type| RESULT) "TRUTH-VALUE")))
     ...
     (CL:T (%%PRINT-STREAM (%NATIVE-STREAM STANDARD-OUTPUT) "This object has unknown type: " OBJECT " (type = )" EOL)
      (CL:IF (CL:EQ OBJECT NULL)
       (%%PRINT-STREAM (%NATIVE-STREAM STANDARD-OUTPUT) "make-pl-object-union: object is NOT defined" EOL)
...
(CL:DEFUN CODE-MODULE? (MODULE)
  (CL:OR
   (%WRAPPER-VALUE (DYNAMIC-SLOT-VALUE (%DYNAMIC-SLOTS MODULE) SYM-GUI-SERVER-API-STELLA-CODE-ONLY? FALSE-WRAPPER))
...
(CL:DEFUN COLLECT-ALL-MODULES (MODULE COLLECTEDMODULES)
  (CL:LET* ((CHILD NULL) (ITER-000 (PLI::GET-CHILD-MODULES MODULE)))
   (CL:LOOP WHILE (NEXT? ITER-000) DO (CL:SETQ CHILD (%VALUE ITER-000))
    (CL:WHEN (CL:NOT (CODE-MODULE? CHILD)) (COLLECT-ALL-MODULES CHILD COLLECTEDMODULES))))
  ...
  (CL:LET* ((CONTAINER (|new-PLModuleContainer|)) (PLMODULES (NEW-LIST)))
   (CL:LET* ((MODULE NULL) (ITER-000 (%THE-CONS-LIST COLLECTEDMODULES)))
    (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-000 NIL)) DO (CL:SETQ MODULE (%%VALUE ITER-000))
     (CL:LET*
      ((PLMODULE (|new-PLModule|)) (CHILDMODULEITER (PLI::GET-CHILD-MODULES MODULE)) (SURROGATECHILDREN (NEW-LIST)))
      ...
      (CL:IF (CL:EQ (JAVA-PACKAGE MODULE) STELLA::NULL-STRING) (CL:SETF (|%JavaPackage| PLMODULE) "")
       (CL:SETF (|%JavaPackage| PLMODULE) (JAVA-PACKAGE MODULE)))
      (CL:IF
       (CL:EQ
        (%WRAPPER-VALUE
         (DYNAMIC-SLOT-VALUE (%DYNAMIC-SLOTS MODULE) SYM-GUI-SERVER-API-STELLA-JAVA-FLOTSAM-CLASS NULL-STRING-WRAPPER))
        STELLA::NULL-STRING)
       (CL:SETF (|%JavaCatchallClass| PLMODULE) "")
       (CL:SETF (|%JavaCatchallClass| PLMODULE)
        (%WRAPPER-VALUE
         (DYNAMIC-SLOT-VALUE (%DYNAMIC-SLOTS MODULE) SYM-GUI-SERVER-API-STELLA-JAVA-FLOTSAM-CLASS
          NULL-STRING-WRAPPER))))
      ...
      (CL:IF (%CASE-SENSITIVE? MODULE) (CL:SETF (|%CaseSensitive| PLMODULE) "TRUE")
       (CL:SETF (|%CaseSensitive| PLMODULE) "FALSE"))
      (CL:IF (%WRAPPER-VALUE (DYNAMIC-SLOT-VALUE (%DYNAMIC-SLOTS MODULE) SYM-GUI-SERVER-API-STELLA-API? FALSE-WRAPPER))
       (CL:SETF (%API PLMODULE) "TRUE") (CL:SETF (%API PLMODULE) "FALSE"))
        ...
        (CL:WHEN (CL:NOT (CODE-MODULE? CHILD))
         (CL:IF (CL:EQ COLLECT-000 NULL)
          (CL:PROGN (CL:SETQ COLLECT-000 (CONS (MAKE-MODULE-SURROGATE CHILD) NIL))
           (CL:IF (CL:EQ (%THE-CONS-LIST SURROGATECHILDREN) NIL)
            (CL:SETF (%THE-CONS-LIST SURROGATECHILDREN) COLLECT-000)
            (ADD-CONS-TO-END-OF-CONS-LIST (%THE-CONS-LIST SURROGATECHILDREN) COLLECT-000)))
          (CL:PROGN (CL:SETF (%%REST COLLECT-000) (CONS (MAKE-MODULE-SURROGATE CHILD) NIL))
           (CL:SETQ COLLECT-000 (%%REST COLLECT-000)))))))
...
(CL:DEFUN GET-STELLA-LITERAL-CONCEPTS ()
  (CL:LET*
   ((COLLECTEDCONCEPTS (NEW-LIST)) (TOPCONCEPT (GET-DESCRIPTION (%SURROGATE-VALUE SGT-GUI-SERVER-API-STELLA-LITERAL)))
...
(CL:DEFUN GET-STELLA-LITERAL-CONCEPTS-HELPER (MODULE CONCEPT COLLECTEDCONCEPTS)
  (CL:LET* ((CHILD NULL) (ITER-000 (PLI::GET-DIRECT-SUBRELATIONS CONCEPT MODULE NULL)))
   (CL:LOOP WHILE (NEXT? ITER-000) DO (CL:SETQ CHILD (%VALUE ITER-000))
    (GET-STELLA-LITERAL-CONCEPTS-HELPER MODULE CHILD COLLECTEDCONCEPTS)))
...
(CL:DEFUN GET-CONCEPTS-WITH-PREFIX (MODULE PREFIX)
  ...
  (CL:LET* ((ALLCONCEPTS (GET-ALL-CONCEPTS-WITH-PREFIX MODULE CL:NIL PREFIX)) (RESULT NULL))
   (CL:SETQ RESULT (CREATE-CONCEPT-CONTAINER ALLCONCEPTS MODULE CL:NIL)) RESULT))
  ...
  (CL:LET* ((CONTAINER (|new-PLConceptContainer|)) (PLCONCEPTS (NEW-LIST)))
   (CL:LET* ((CONCEPT NULL) (ITER-000 (%THE-CONS-LIST COLLECTEDCONCEPTS)))
    (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-000 NIL)) DO (CL:SETQ CONCEPT (%%VALUE ITER-000))
     (CL:LET*
      ((PLCONCEPT (|new-PLConcept|)) (CHILDCONCEPTITER (PLI::GET-DIRECT-SUBRELATIONS CONCEPT MODULE NULL))
       (SURROGATECHILDREN (NEW-LIST)))
      (CL:SETF (|%ConceptName| PLCONCEPT) (XMLIFY-STRING (PL-OBJECT-TO-GUI-NAME CONCEPT)))
      (CL:SETF (|%Module| PLCONCEPT) (%MODULE-FULL-NAME (HOME-MODULE CONCEPT)))
      ...
      (CL:WHEN INCLUDECHILDREN?
       (CL:LET* ((CHILD NULL) (ITER-001 CHILDCONCEPTITER) (COLLECT-000 NULL))
        (CL:LOOP WHILE (NEXT? ITER-001) DO (CL:SETQ CHILD (%VALUE ITER-001))
         (CL:WHEN
          (CL:AND (CLASS? CHILD)
           (CL:NOT (COERCE-WRAPPED-BOOLEAN-TO-BOOLEAN (CL:IF (DELETED? CHILD) TRUE-WRAPPER FALSE-WRAPPER))))
          (CL:IF (CL:EQ COLLECT-000 NULL)
           (CL:PROGN (CL:SETQ COLLECT-000 (CONS (MAKE-LOGIC-SURROGATE CHILD) NIL))
            (CL:IF (CL:EQ (%THE-CONS-LIST SURROGATECHILDREN) NIL)
             (CL:SETF (%THE-CONS-LIST SURROGATECHILDREN) COLLECT-000)
             (ADD-CONS-TO-END-OF-CONS-LIST (%THE-CONS-LIST SURROGATECHILDREN) COLLECT-000)))
           (CL:PROGN (CL:SETF (%%REST COLLECT-000) (CONS (MAKE-LOGIC-SURROGATE CHILD) NIL))
            (CL:SETQ COLLECT-000 (%%REST COLLECT-000))))))))
      (CL:SETQ SURROGATECHILDREN (SORT SURROGATECHILDREN (CL:FUNCTION |PLSurrogate<|)))
      (CL:SETF (|%PLSurrogate| PLCONCEPT) SURROGATECHILDREN) (INSERT PLCONCEPTS PLCONCEPT))
     (CL:SETQ ITER-000 (%%REST ITER-000))))
   (CL:SETQ PLCONCEPTS (SORT PLCONCEPTS (CL:FUNCTION |PLConcept<|))) (CL:SETF (|%PLConcept| CONTAINER) PLCONCEPTS)
   CONTAINER))

;;; (DEFUN (GET-RELATIONS |PLRelationContainer|) ...)

(CL:DEFUN GET-RELATIONS (MODULE)
  (CL:LET* ((ALLRELATIONS (GET-ALL-RELATIONS MODULE)) (RESULT (CREATE-RELATION-CONTAINER ALLRELATIONS MODULE CL:T)))
   RESULT))
...
(CL:DEFUN GET-RELATIONS-WITH-PREFIX (MODULE PREFIX)
  ...
  #+MCL
  (CL:CHECK-TYPE PREFIX CL:SIMPLE-STRING)
  (CL:LET* ((ALLRELATIONS (GET-ALL-RELATIONS-WITH-PREFIX MODULE CL:NIL PREFIX)) (RESULT NULL))
   (CL:SETQ RESULT (CREATE-RELATION-CONTAINER ALLRELATIONS MODULE CL:NIL)) RESULT))
  ...
  (CL:LET* ((CONTAINER (|new-PLRelationContainer|)) (PLRELATIONS (NEW-LIST)))
   (CL:LET* ((RELATION NULL) (ITER-000 (%THE-CONS-LIST COLLECTEDRELATIONS)))
    (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-000 NIL)) DO (CL:SETQ RELATION (%%VALUE ITER-000))
     (CL:LET*
      ((PLRELATION (|new-PLRelation|)) (CHILDRELATIONITER (PLI::GET-DIRECT-SUBRELATIONS RELATION MODULE NULL))
       (SURROGATECHILDREN (NEW-LIST)))
      (CL:IF (FUNCTION? RELATION) (CL:SETF (|%IsFunction| PLRELATION) "TRUE")
       (CL:SETF (|%IsFunction| PLRELATION) "FALSE"))
      (CL:IF (CLOSED-TERM? RELATION) (CL:SETF (|%IsClosed| PLRELATION) "TRUE")
       (CL:SETF (|%IsClosed| PLRELATION) "FALSE"))
      (CL:SETF (|%RelationName| PLRELATION) (XMLIFY-STRING (PL-OBJECT-TO-GUI-NAME RELATION)))
      (CL:SETF (|%Module| PLRELATION) (%MODULE-FULL-NAME (HOME-MODULE RELATION)))
         ...
         (CL:WHEN
          ...
          (CL:IF (CL:EQ COLLECT-000 NULL)
           ...
           (CL:PROGN (CL:SETF (%%REST COLLECT-000) (CONS (MAKE-LOGIC-SURROGATE CHILD) NIL))
            (CL:SETQ COLLECT-000 (%%REST COLLECT-000))))))))
      (CL:SETQ SURROGATECHILDREN (SORT SURROGATECHILDREN (CL:FUNCTION |PLSurrogate<|)))
      (CL:SETF (|%PLSurrogate| PLRELATION) SURROGATECHILDREN) (INSERT PLRELATIONS PLRELATION))
     (CL:SETQ ITER-000 (%%REST ITER-000))))
   (CL:SETQ PLRELATIONS (SORT PLRELATIONS (CL:FUNCTION |PLRelation<|))) (CL:SETF (|%PLRelation| CONTAINER) PLRELATIONS)
   CONTAINER))
     ...
     (CL:IF (CL:EQ COLLECT-000 NULL)
      (CL:PROGN (CL:SETQ COLLECT-000 (CONS (MAKE-MODULE-SURROGATE MODULE) NIL))
       (CL:IF (CL:EQ (%THE-CONS-LIST SURROGATECHILDREN) NIL) (CL:SETF (%THE-CONS-LIST SURROGATECHILDREN) COLLECT-000)
        (ADD-CONS-TO-END-OF-CONS-LIST (%THE-CONS-LIST SURROGATECHILDREN) COLLECT-000)))
      (CL:PROGN (CL:SETF (%%REST COLLECT-000) (CONS (MAKE-MODULE-SURROGATE MODULE) NIL))
       (CL:SETQ COLLECT-000 (%%REST COLLECT-000))))
     (CL:SETQ ITER-000 (%%REST ITER-000))))
   (CL:SETQ SURROGATECHILDREN (SORT SURROGATECHILDREN (CL:FUNCTION |PLSurrogate<|)))
   (CL:SETF (|%PLSurrogate| PLSURROGATECOLLECTION) SURROGATECHILDREN) PLSURROGATECOLLECTION))
    ...
    (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-000 NIL)) DO (CL:SETQ SURROGATE (%%VALUE ITER-000))
     (CL:IF (CL:EQ COLLECT-000 NULL)
      (CL:PROGN (CL:SETQ COLLECT-000 (CONS (MAKE-SURROGATE-SURROGATE SURROGATE) NIL))
       (CL:IF (CL:EQ (%THE-CONS-LIST SURROGATECHILDREN) NIL) (CL:SETF (%THE-CONS-LIST SURROGATECHILDREN) COLLECT-000)
        (ADD-CONS-TO-END-OF-CONS-LIST (%THE-CONS-LIST SURROGATECHILDREN) COLLECT-000)))
      (CL:PROGN (CL:SETF (%%REST COLLECT-000) (CONS (MAKE-SURROGATE-SURROGATE SURROGATE) NIL))
       (CL:SETQ COLLECT-000 (%%REST COLLECT-000))))
     (CL:SETQ ITER-000 (%%REST ITER-000))))
   (CL:SETQ SURROGATECHILDREN (SORT SURROGATECHILDREN (CL:FUNCTION |PLSurrogate<|)))
   (CL:SETF (|%PLSurrogate| PLSURROGATECOLLECTION) SURROGATECHILDREN) PLSURROGATECOLLECTION))
    ...
    (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-000 NIL)) DO (CL:SETQ RELATION (%%VALUE ITER-000))
     (CL:IF (CL:EQ COLLECT-000 NULL)
      (CL:PROGN (CL:SETQ COLLECT-000 (CONS (MAKE-LOGIC-SURROGATE RELATION) NIL))
       (CL:IF (CL:EQ (%THE-CONS-LIST SURROGATECHILDREN) NIL) (CL:SETF (%THE-CONS-LIST SURROGATECHILDREN) COLLECT-000)
        (ADD-CONS-TO-END-OF-CONS-LIST (%THE-CONS-LIST SURROGATECHILDREN) COLLECT-000)))
      (CL:PROGN (CL:SETF (%%REST COLLECT-000) (CONS (MAKE-LOGIC-SURROGATE RELATION) NIL))
       (CL:SETQ COLLECT-000 (%%REST COLLECT-000))))
     (CL:SETQ ITER-000 (%%REST ITER-000))))
   (CL:SETQ SURROGATECHILDREN (SORT SURROGATECHILDREN (CL:FUNCTION |PLSurrogate<|)))
   (CL:SETF (|%PLSurrogate| PLSURROGATECOLLECTION) SURROGATECHILDREN) PLSURROGATECOLLECTION))
...
(CL:DEFUN CREATE-SUPERRELATIONS-CONTAINER (RELATION MODULE)
  (CL:LET* ((*MODULE* MODULE) (*CONTEXT* *MODULE*)) (CL:DECLARE (CL:SPECIAL *MODULE* *CONTEXT*))
   (CL:LET*
    ((PARENTRELATIONITER (PLI::GET-DIRECT-SUPERRELATIONS RELATION MODULE NULL)) (SURROGATECHILDREN (NEW-LIST))
     ...
     (CL:LOOP WHILE (NEXT? ITER-000) DO (CL:SETQ PARENT (%VALUE ITER-000))
      (CL:IF (CL:EQ COLLECT-000 NULL)
       (CL:PROGN (CL:SETQ COLLECT-000 (CONS (MAKE-LOGIC-SURROGATE PARENT) NIL))
        (CL:IF (CL:EQ (%THE-CONS-LIST SURROGATECHILDREN) NIL) (CL:SETF (%THE-CONS-LIST SURROGATECHILDREN) COLLECT-000)
         (ADD-CONS-TO-END-OF-CONS-LIST (%THE-CONS-LIST SURROGATECHILDREN) COLLECT-000)))
       (CL:PROGN (CL:SETF (%%REST COLLECT-000) (CONS (MAKE-LOGIC-SURROGATE PARENT) NIL))
        (CL:SETQ COLLECT-000 (%%REST COLLECT-000))))))
    (CL:SETQ SURROGATECHILDREN (SORT SURROGATECHILDREN (CL:FUNCTION |PLSurrogate<|)))
    (CL:SETF (|%PLSurrogate| PLSURROGATECOLLECTION) SURROGATECHILDREN) PLSURROGATECOLLECTION)))
  ...
  (CL:LET* ((VARIABLES (NEW-LIST)) (PLVARIABLELIST (|new-PLVariableList|)))
   (CL:COND
    ((SUBTYPE-OF? (SAFE-PRIMARY-TYPE RELATION) SGT-GUI-SERVER-API-LOGIC-NAMED-DESCRIPTION)
     (CL:PROGN
      (CL:LET*
       ((VARIABLENAME NULL) (ITER-000 (%THE-CONS-LIST (%IO-VARIABLE-NAMES RELATION))) (VARIABLETYPE NULL)
        (ITER-001 (%THE-CONS-LIST (%IO-VARIABLE-TYPES RELATION))) (COLLECT-000 NULL))
       (CL:LOOP WHILE (CL:AND (CL:NOT (CL:EQ ITER-000 NIL)) (CL:NOT (CL:EQ ITER-001 NIL))) DO
        (CL:SETQ VARIABLENAME (%%VALUE ITER-000)) (CL:SETQ VARIABLETYPE (%%VALUE ITER-001))
        (CL:IF (CL:EQ COLLECT-000 NULL)
         ...
         (CL:PROGN
          (CL:SETF (%%REST COLLECT-000) (CONS (MAKE-PL-VARIABLE (%SYMBOL-NAME VARIABLENAME) VARIABLETYPE) NIL))
          (CL:SETQ COLLECT-000 (%%REST COLLECT-000))))
...
(CL:DEFUN MAKE-PL-VARIABLE (VARIABLENAME VARIABLETYPE)
  ...
  (CL:LET* ((RESULT (|new-PLVariable|)) (PLVARIABLENAME (|new-PLString|)) (PLVARIABLETYPE (|new-PLSurrogate|)))
   (CL:SETF (|%Value| PLVARIABLENAME) VARIABLENAME) (CL:SETF (%ID PLVARIABLETYPE) (%SYMBOL-NAME VARIABLETYPE))
   (CL:SETF (|%VariableName| RESULT) PLVARIABLENAME) (CL:SETF (|%VariableType| RESULT) PLVARIABLETYPE) RESULT))
...
(CL:DEFUN MAKE-PL-RELATION (RELATION MODULENAME)
  ...
  (CL:LET* ((XMLRELATION (|new-PLRelation|)))
   (CL:SETF (|%Module| XMLRELATION) (%MODULE-FULL-NAME (HOME-MODULE RELATION)))
   (CL:IF (FUNCTION? RELATION) (CL:SETF (|%IsFunction| XMLRELATION) "TRUE")
    (CL:SETF (|%IsFunction| XMLRELATION) "FALSE"))
   (CL:IF (CLOSED-TERM? RELATION) (CL:SETF (|%IsClosed| XMLRELATION) "TRUE")
    (CL:SETF (|%IsClosed| XMLRELATION) "FALSE"))
   (CL:SETF (|%SourceString| XMLRELATION) "")
...
(CL:DEFUN MAKE-PL-CONCEPT (CONCEPT)
  (CL:LET* ((XMLCONCEPT (|new-PLConcept|))) (CL:SETF (|%Module| XMLCONCEPT) (%MODULE-FULL-NAME (HOME-MODULE CONCEPT)))
   (CL:SETF (|%SourceString| XMLCONCEPT) "")
   ...
   (CL:LET* ((RELATION NULL) (ITER-000 (%THE-CONS-LIST RELATIONS)) (COLLECT-000 NULL))
    (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-000 NIL)) DO (CL:SETQ RELATION (%%VALUE ITER-000))
     (CL:IF (CL:EQ COLLECT-000 NULL)
      ...
      (CL:PROGN (CL:SETF (%%REST COLLECT-000) (CONS (MAKE-PL-RELATION RELATION MODULENAME) NIL))
       (CL:SETQ COLLECT-000 (%%REST COLLECT-000))))
     (CL:SETQ ITER-000 (%%REST ITER-000))))
   RESULT))
...
(CL:DEFUN MAKE-SURROGATE-SURROGATE (SURROGATE)
  (CL:LET* ((RESULT (|new-PLSurrogate|))) (CL:SETF (%ID RESULT) (XMLIFY-STRING (PL-OBJECT-TO-GUI-NAME SURROGATE)))
   RESULT))
...
(CL:DEFUN MAKE-LOGIC-SURROGATE (OBJ)
  (CL:LET* ((RESULT (|new-PLSurrogate|)))
   (CL:WHEN (SKOLEM? OBJ)
    (CL:LET*
     ((RESULTSTREAM (NEW-OUTPUT-STRING-STREAM)) (NATIVESTREAM (%NATIVE-STREAM RESULTSTREAM))
...
(CL:DEFUN GET-ALL-RELATIONS-WITH-PREFIX (MODULE LOCAL? PREFIX)
  ...
  (CL:CHECK-TYPE PREFIX CL:SIMPLE-STRING)
  (CL:LET*
   ((ITER (ALL-NAMED-DESCRIPTIONS MODULE LOCAL?)) (RESULT (NEW-LIST)) (DOWNCASEDPREFIX (STRING-DOWNCASE PREFIX)))
   (CL:DECLARE (CL:TYPE CL:SIMPLE-STRING DOWNCASEDPREFIX))
   (CL:LET* ((DESCRIPTION NULL) (ITER-000 ITER) (COLLECT-000 NULL))
    (CL:LOOP WHILE (NEXT? ITER-000) DO (CL:SETQ DESCRIPTION (%VALUE ITER-000))
     (CL:WHEN
      (CL:AND (CL:NOT (CLASS? DESCRIPTION)) (CL:NOT (CL:EQ PREFIX STELLA::NULL-STRING))
...
(CL:DEFUN GET-ALL-CONCEPTS-WITH-PREFIX (MODULE LOCAL? PREFIX)
  ...
  (CL:LET*
   ...
   (CL:LET* ((DESCRIPTION NULL) (ITER-000 ITER) (COLLECT-000 NULL))
    (CL:LOOP WHILE (NEXT? ITER-000) DO (CL:SETQ DESCRIPTION (%VALUE ITER-000))
     (CL:WHEN
      (CL:AND (CLASS? DESCRIPTION) (CL:NOT (CL:EQ PREFIX STELLA::NULL-STRING))
       (STARTS-WITH? (GET-LOGIC-OBJECT-NAME DESCRIPTION "FALSE") DOWNCASEDPREFIX 0))
      (CL:IF (CL:EQ COLLECT-000 NULL)
       (CL:PROGN (CL:SETQ COLLECT-000 (CONS DESCRIPTION NIL))
        (CL:IF (CL:EQ (%THE-CONS-LIST RESULT) NIL) (CL:SETF (%THE-CONS-LIST RESULT) COLLECT-000)
...
(CL:DEFUN MAKE-PL-INSTANCE (INSTANCE)
  (CL:LET* ((XMLINSTANCE (|new-PLInstance|)))
   (CL:SETF (|%InstanceName| XMLINSTANCE) (XMLIFY-STRING (PL-OBJECT-TO-GUI-NAME INSTANCE)))
   (CL:IF (CL:NOT (CL:EQ (HOME-MODULE INSTANCE) NULL))
    (CL:SETF (|%Module| XMLINSTANCE) (%MODULE-FULL-NAME (HOME-MODULE INSTANCE))) (CL:SETF (|%Module| XMLINSTANCE) ""))
     ...
     (CL:WHEN (CL:OR (CL:NOT SKIPUNINTERNEDINSTANCES?) (CL:NOT (CL:EQ (HOME-MODULE INSTANCE) NULL)))
      (CL:IF (CL:EQ COLLECT-000 NULL)
       (CL:PROGN (CL:SETQ COLLECT-000 (CONS (MAKE-PL-INSTANCE INSTANCE) NIL))
        (CL:IF (CL:EQ (%THE-CONS-LIST RESULT) NIL) (CL:SETF (%THE-CONS-LIST RESULT) COLLECT-000)
         (ADD-CONS-TO-END-OF-CONS-LIST (%THE-CONS-LIST RESULT) COLLECT-000)))
       (CL:PROGN (CL:SETF (%%REST COLLECT-000) (CONS (MAKE-PL-INSTANCE INSTANCE) NIL))
        (CL:SETQ COLLECT-000 (%%REST COLLECT-000)))))
     (CL:SETQ ITER-000 (%%REST ITER-000))))
   RESULT))
...
(CL:DEFUN MAKE-PL-PROPOSITION (PROPOSITION MODULE ISRULE)
  (CL:LET* ((XMLPROPOSITION (|new-PLProposition|)))
   (CL:SETF (|%PropositionName| XMLPROPOSITION) (GET-PROPOSITION-STRING PROPOSITION MODULE))
   (CL:IF (ASSERTED-AS-TRUE? PROPOSITION) (CL:SETF (|%IsAsserted| XMLPROPOSITION) "TRUE")
    (CL:SETF (|%IsAsserted| XMLPROPOSITION) "FALSE"))
   (CL:LET* ((*CONTEXT* (GET-QUERY-CONTEXT)) (*MODULE* (%BASE-MODULE *CONTEXT*)))
    (CL:DECLARE (CL:SPECIAL *CONTEXT* *MODULE*))
    (CL:IF (PLI::IS-STRICT (PROPOSITION-TRUTH-VALUE PROPOSITION)) (CL:SETF (|%IsStrict| XMLPROPOSITION) "TRUE")
     (CL:SETF (|%IsStrict| XMLPROPOSITION) "FALSE")))
   (CL:IF ISRULE (CL:SETF (|%IsRule| XMLPROPOSITION) "TRUE") (CL:SETF (|%IsRule| XMLPROPOSITION) "FALSE"))
   XMLPROPOSITION))
    ...
    (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-000 NIL)) DO (CL:SETQ PROPOSITION (%%VALUE ITER-000))
     (CL:IF (CL:EQ COLLECT-000 NULL)
      (CL:PROGN (CL:SETQ COLLECT-000 (CONS (MAKE-PL-PROPOSITION PROPOSITION MODULE ISRULE) NIL))
       (CL:IF (CL:EQ (%THE-CONS-LIST RESULT) NIL) (CL:SETF (%THE-CONS-LIST RESULT) COLLECT-000)
        (ADD-CONS-TO-END-OF-CONS-LIST (%THE-CONS-LIST RESULT) COLLECT-000)))
      (CL:PROGN (CL:SETF (%%REST COLLECT-000) (CONS (MAKE-PL-PROPOSITION PROPOSITION MODULE ISRULE) NIL))
       (CL:SETQ COLLECT-000 (%%REST COLLECT-000))))
     (CL:SETQ ITER-000 (%%REST ITER-000))))
   RESULT))
...
(CL:DEFUN GET-DOCUMENTATION-FOR-OBJECT (MODULENAME OBJECTNAME)
  ...
  (CL:LET* ((RESULT (|new-PLString|)) (DOCSTRING "")) (CL:DECLARE (CL:TYPE CL:SIMPLE-STRING DOCSTRING))
   (CL:LET*
    ((DOC NULL)
     (ITER-000
      (PLI::S-GET-INFERRED-BINARY-PROPOSITION-VALUES "DOCUMENTATION" (GUI-NAME-TO-PL-NAME OBJECTNAME) MODULENAME NULL))
    ...
    (CL:LOOP WHILE (NEXT? ITER-000) DO (CL:SETQ DOC (%VALUE ITER-000)) (CL:SETQ I ITER-001)
     (CL:WHEN (STRING? DOC)
      (CL:SETQ DOCSTRING (CONCATENATE DOCSTRING (CL:IF (CL:= I 1) "" EOL-STRING) (%WRAPPER-VALUE DOC))))
     (CL:SETQ ITER-001 (CL:1+ ITER-001))))
...
(CL:DEFUN GET-PROPOSITIONS-FOR-OBJECT (MODULENAME INSTANCENAME RELATION?)
  ...
  (CL:LET*
   ((ITER (PLI::S-GET-PROPOSITIONS-OF (GUI-NAME-TO-PL-NAME INSTANCENAME) MODULENAME NULL)) (PROPOSITIONS (NEW-LIST)))
    ...
    (CL:LOOP WHILE (NEXT? ITER-000) DO (CL:SETQ RULE (%VALUE ITER-000))
     (CL:IF (CL:EQ COLLECT-000 NULL)
      (CL:PROGN (CL:SETQ COLLECT-000 (CONS RULE NIL))
       (CL:IF (CL:EQ (%THE-CONS-LIST RULES) NIL) (CL:SETF (%THE-CONS-LIST RULES) COLLECT-000)
        (ADD-CONS-TO-END-OF-CONS-LIST (%THE-CONS-LIST RULES) COLLECT-000)))
...
(CL:DEFUN RULE-PROPOSITION? (PROPOSITION)
  (CL:LET* ((TEST-VALUE-000 (%KIND PROPOSITION)))
   (CL:COND
    ((CL:OR (CL:EQ TEST-VALUE-000 KWD-GUI-SERVER-API-FORALL) (CL:EQ TEST-VALUE-000 KWD-GUI-SERVER-API-EXISTS)
...
(CL:DEFUN SUBRELATION-RULE? (RULE)
  (CL:AND (CL:EQ (%KIND RULE) KWD-GUI-SERVER-API-IMPLIES)
   (ISA? (CL:AREF (CL:THE CL:SIMPLE-VECTOR (%THE-ARRAY (%ARGUMENTS RULE))) 0)
    SGT-GUI-SERVER-API-LOGIC-NAMED-DESCRIPTION)
   (ISA? (CL:AREF (CL:THE CL:SIMPLE-VECTOR (%THE-ARRAY (%ARGUMENTS RULE))) 1)
    SGT-GUI-SERVER-API-LOGIC-NAMED-DESCRIPTION)))
...
(CL:DEFUN GET-RELEVANT-RULES-FOR-RELATION (MODULENAME RELATIONNAME)
  ...
  (CL:LET*
   ((MODULE (PLI::GET-MODULE MODULENAME NULL))
    (RELATION (PLI::S-GET-RELATION (GUI-NAME-TO-PL-NAME RELATIONNAME) MODULENAME NULL)) (RULES (NEW-LIST)))
   (CL:LET* ((*MODULE* MODULE) (*CONTEXT* *MODULE*)) (CL:DECLARE (CL:SPECIAL *MODULE* *CONTEXT*))
    (CL:LET* ((*CONTEXT* (GET-QUERY-CONTEXT)) (*MODULE* (%BASE-MODULE *CONTEXT*)))
     (CL:DECLARE (CL:SPECIAL *CONTEXT* *MODULE*))
      ...
      (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-000 NIL)) DO (CL:SETQ RULE (%%VALUE ITER-000))
       (CL:WHEN (CL:AND (TRUE? RULE) (CL:NOT (SUBRELATION-RULE? RULE)))
        (CL:IF (CL:EQ COLLECT-000 NULL)
         (CL:PROGN
          (CL:LET*
           ((TEMP-000 (DYNAMIC-SLOT-VALUE (%DYNAMIC-SLOTS RULE) SYM-GUI-SERVER-API-LOGIC-MASTER-PROPOSITION NULL)))
           (CL:SETQ COLLECT-000 (CONS (CL:IF (CL:NOT (CL:EQ TEMP-000 NULL)) TEMP-000 RULE) NIL)))
          (CL:IF (CL:EQ (%THE-CONS-LIST RULES) NIL) (CL:SETF (%THE-CONS-LIST RULES) COLLECT-000)
           (ADD-CONS-TO-END-OF-CONS-LIST (%THE-CONS-LIST RULES) COLLECT-000)))
         (CL:PROGN
          (CL:LET*
           ((TEMP-001 (DYNAMIC-SLOT-VALUE (%DYNAMIC-SLOTS RULE) SYM-GUI-SERVER-API-LOGIC-MASTER-PROPOSITION NULL)))
...
(CL:DEFUN GET-PROPOSITIONS-FOR-INSTANCE-AND-RELATION (MODULENAME INSTANCENAME RELATIONNAME)
  ...
  (CL:LET*
   ((EXPRESSIONSTRING (CONCATENATE "(" (GUI-NAME-TO-PL-NAME RELATIONNAME) " " (GUI-NAME-TO-PL-NAME INSTANCENAME)))
    (RELATION (PLI::S-GET-RELATION (GUI-NAME-TO-PL-NAME RELATIONNAME) MODULENAME NULL)) (ARITY (ARITY RELATION))
    (RESULT (NEW-LIST)))
   (CL:DECLARE (CL:TYPE CL:SIMPLE-STRING EXPRESSIONSTRING) (CL:TYPE CL:FIXNUM ARITY))
   (CL:LET*
    ((I NULL-INTEGER) (ITER-000 2) (UPPER-BOUND-000 ARITY) (UNBOUNDED?-000 (CL:= UPPER-BOUND-000 NULL-INTEGER)))
...
(CL:DECLAIM
 (CL:FTYPE (CL:FUNCTION (CL:SIMPLE-STRING CL:SIMPLE-STRING CL:T) CL:SIMPLE-STRING) EVALUATE-LOGIC-COMMAND-IN-MODULE))
(CL:DEFUN EVALUATE-LOGIC-COMMAND-IN-MODULE (COMMAND MODULENAME FINALIZE?)
  ...
  #+MCL
  (CL:CHECK-TYPE MODULENAME CL:SIMPLE-STRING)
  (CL:LET* ((MODULE (GET-STELLA-MODULE MODULENAME CL:NIL)) (RESULT NULL))
      ...
      (CL:T
       (CL:LET* ((RESULTSTREAM (NEW-OUTPUT-STRING-STREAM)) (NATIVESTREAM (%NATIVE-STREAM RESULTSTREAM)))
        (CL:LET* ((*PRINTREADABLY?* CL:T) (*PRINTPRETTY?* CL:T))
         (CL:DECLARE (CL:SPECIAL *PRINTREADABLY?* *PRINTPRETTY?*)) (CL:WHEN (USE-CL-CONSES?)
                         (CL:LET ((CL:*PRINT-PRETTY* CL:T))
                           (CL:PRIN1 result nativeStream)
                           (SETQ result NULL)))
         (CL:WHEN (CL:NOT (CL:EQ RESULT NULL)) (%%PRINT-STREAM (%NATIVE-STREAM RESULTSTREAM) RESULT)))
...
(CL:DEFUN IS-QUERY-PARTIAL? (PLQUERY)
  (CL:AND (CL:NOT (CL:EQ (|%MatchMode| PLQUERY) STELLA::NULL-STRING))
   (CL:NOT (STRING-EQL? (|%MatchMode| PLQUERY) "STRICT"))))
...
(CL:DEFUN EVALUATE-QUERY-COMMAND-IN-MODULE (SESSION QUERY MODULENAME CONTINUATIONQUERY? PARTIALQUERY?)
  ...
  (CL:CHECK-TYPE MODULENAME CL:SIMPLE-STRING)
  (CL:LET*
   ((MODULE (GET-STELLA-MODULE MODULENAME CL:NIL)) (QUERYTREE NIL) (QUERYITERATOR NULL) (TUPLE NIL) (RESULT NIL))
   (CL:WHEN (CL:EQ MODULE NULL) (CL:SETQ MODULE *MODULE*))
   (CL:HANDLER-CASE
    (CL:LET* ((*MODULE* MODULE) (*CONTEXT* *MODULE*)) (CL:DECLARE (CL:SPECIAL *MODULE* *CONTEXT*))
     (CL:SETQ QUERYTREE (READ-S-EXPRESSION-FROM-STRING QUERY))
     (CL:IF (CL:EQ (%%VALUE QUERYTREE) SYM-GUI-SERVER-API-STELLA-ASK)
      (CL:PROGN (CL:SETQ QUERYITERATOR (CREATE-ASK-QUERY (%%REST QUERYTREE)))
       (INSERT-AT SESSION (WRAP-STRING "QueryIterator") QUERYITERATOR)
       (CL:IF PARTIALQUERY? (CL:SETQ RESULT (CONS (WRAP-FLOAT (CALL-ASK-PARTIAL QUERYITERATOR)) NIL))
        (CL:SETQ RESULT (CONS (CALL-ASK QUERYITERATOR) NIL)))
       (CL:RETURN-FROM EVALUATE-QUERY-COMMAND-IN-MODULE (CONS RESULT NIL)))
      (CL:PROGN
       (CL:IF CONTINUATIONQUERY? (CL:SETQ *MOST-RECENT-QUERY* (LOOKUP SESSION (WRAP-STRING "QueryIterator")))
        (CL:SETQ *MOST-RECENT-QUERY* NULL))
       (CL:SETQ QUERYITERATOR (CREATE-RETRIEVE-QUERY (%%REST QUERYTREE)))
       (INSERT-AT SESSION (WRAP-STRING "QueryIterator") QUERYITERATOR)
       ...
       (CL:LET* ((SOLUTION NULL) (ITER-000 (ALLOCATE-ITERATOR (%SOLUTIONS QUERYITERATOR))) (COLLECT-000 NULL))
        (CL:LOOP WHILE (NEXT? ITER-000) DO (CL:SETQ SOLUTION (%VALUE ITER-000))
         (CL:SETQ TUPLE (CONSIFY (%BINDINGS SOLUTION)))
  ...
  (CL:LET* ((*MODULE* MODULE) (*CONTEXT* *MODULE*)) (CL:DECLARE (CL:SPECIAL *MODULE* *CONTEXT*))
   (CL:LET* ((SS (NEW-OUTPUT-STRING-STREAM)))
    (CL:LET* ((*PRINTMODE* KWD-GUI-SERVER-API-ORIGINAL) (*PRINTLOGICALFORMSTREAM* SS) (*PRINTREADABLY?* CL:T))
     (CL:DECLARE (CL:SPECIAL *PRINTMODE* *PRINTLOGICALFORMSTREAM* *PRINTREADABLY?*))
...
(CL:DEFUN GET-STRINGIFIED-MODULE (MODULE)
  (CL:LET*
   ((MODULENAME (%MODULE-NAME MODULE)) (PARENTS (%PARENT-MODULES MODULE)) (USES (%USES MODULE))
    (DOCUMENTATION (%DOCUMENTATION MODULE)) (PARENTSTRINGS "") (USESSTRINGS "") (RESULT STELLA::NULL-STRING))
   ...
   (CL:LET* ((PARENT NULL) (ITER-000 (%THE-CONS-LIST PARENTS)))
    (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-000 NIL)) DO (CL:SETQ PARENT (%%VALUE ITER-000))
     (CL:SETQ PARENTSTRINGS (CONCATENATE PARENTSTRINGS " " (%MODULE-FULL-NAME PARENT)))
     (CL:SETQ ITER-000 (%%REST ITER-000))))
   (CL:LET* ((USE NULL) (ITER-001 (%THE-CONS-LIST USES)))
    (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-001 NIL)) DO (CL:SETQ USE (%%VALUE ITER-001))
     (CL:SETQ USESSTRINGS (CONCATENATE USESSTRINGS " " (%MODULE-NAME USE))) (CL:SETQ ITER-001 (%%REST ITER-001))))
   ...
   (CL:WHEN (CL:NOT (CL:EQ DOCUMENTATION STELLA::NULL-STRING))
    (CL:SETQ RESULT (CONCATENATE RESULT ":documentation \"" DOCUMENTATION "\"")))
...
(CL:DEFUN REPLACE-CHOKABLE-CHARS-WITH-ENTITIES (INSTRING)
  ...
  #+MCL
  (CL:CHECK-TYPE INSTRING CL:SIMPLE-STRING)
  (CL:LET* ((SS (NEW-OUTPUT-STRING-STREAM))) (WRITE-HTML-QUOTING-CHOKABLE-CHARACTERS (%NATIVE-STREAM SS) INSTRING)
...
(CL:DEFUN COMPACT-WHITESPACE (INSTRING)
  ...
  (CL:CHECK-TYPE INSTRING CL:SIMPLE-STRING)
  (CL:LET*
   ((COUNT 0) (LENGTH (CL:THE CL:FIXNUM (CL:LENGTH INSTRING))) (CURSOR 0) (NEWCURSOR 0) (RESULT STELLA::NULL-STRING))
   (CL:DECLARE (CL:TYPE CL:FIXNUM COUNT LENGTH CURSOR NEWCURSOR) (CL:TYPE CL:SIMPLE-STRING RESULT))
...
(CL:DEFUN STRIP-MODULE (INSTRING MODULE)
  ...
  #+MCL
  (CL:CHECK-TYPE INSTRING CL:SIMPLE-STRING)
  (CL:LET* ((MODNAME (CONCATENATE (%MODULE-FULL-NAME MODULE) "/"))) (CL:DECLARE (CL:TYPE CL:SIMPLE-STRING MODNAME))
...
(CL:DEFUN LOAD-INDEX-FILE ()
  ...
  (CL:LET* ((INSTREAM (NEW-INPUT-FILE-STREAM *KB-FILENAME-INDEX*)) (STREAMITER (S-EXPRESSIONS INSTREAM)))
   (CL:LET* ((SEXP NULL) (ITER-000 STREAMITER))
    (CL:LOOP WHILE (NEXT? ITER-000) DO (CL:SETQ SEXP (%VALUE ITER-000)) (CL:RETURN-FROM LOAD-INDEX-FILE SEXP)))
   NIL))
...
(CL:DEFUN SAVE-INDEX-FILE (INDEX)
  ...
  (CL:LET* ((OUTSTREAM (NEW-OUTPUT-FILE-STREAM *KB-FILENAME-INDEX*)))
   (%%PRINT-STREAM (%NATIVE-STREAM OUTSTREAM) "(" EOL)
   (CL:LET* ((TUPLE NULL) (ITER-000 INDEX))
    (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-000 NIL)) DO (CL:SETQ TUPLE (%%VALUE ITER-000))
     (%%PRINT-STREAM (%NATIVE-STREAM OUTSTREAM) "  (\"" (%WRAPPER-VALUE (%%VALUE TUPLE)) "\" \""
      (%WRAPPER-VALUE (%%VALUE (%%REST TUPLE))) "\" \"" (%WRAPPER-VALUE (%%VALUE (%%REST (%%REST TUPLE)))) "\" \""
      (%WRAPPER-VALUE (FOURTH TUPLE)) "\")" EOL)
     (CL:SETQ ITER-000 (%%REST ITER-000))))
...
(CL:DEFUN MAKE-PL-FILE (FILEDESCRIPTION)
  (CL:LET*
   ((KB (%%VALUE FILEDESCRIPTION)) (MODULENAME (%%VALUE (%%REST FILEDESCRIPTION)))
    (FILENAME (%%VALUE (%%REST (%%REST FILEDESCRIPTION)))) (DESCRIPTION (FOURTH FILEDESCRIPTION))
    (PLFILE (|new-PLModuleFile|)))
   (CL:SETF (|%ModuleName| PLFILE) (%WRAPPER-VALUE MODULENAME))
   (CL:SETF (|%FileName| PLFILE) (%WRAPPER-VALUE FILENAME)) (CL:SETF (|%KBName| PLFILE) (%WRAPPER-VALUE KB))
...
(CL:DEFUN FIND-FILENAME-FOR-KB (FILEINDEX KBNAME)
  ...
  (CL:LET* ((PLFILE NULL) (ITER-000 (%THE-CONS-LIST (|%PLModuleFile| FILEINDEX))))
   (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-000 NIL)) DO (CL:SETQ PLFILE (%%VALUE ITER-000))
    (CL:WHEN (STRING-EQL? (STRING-DOWNCASE KBNAME) (STRING-DOWNCASE (|%KBName| PLFILE)))
     (CL:RETURN-FROM FIND-FILENAME-FOR-KB (|%FileName| PLFILE)))
    (CL:SETQ ITER-000 (%%REST ITER-000))))
  STELLA::NULL-STRING)
  ...
  (CL:LET* ((RESULT NIL) (WILDCARDPOS 0) (CURSOR 0) (WILDCARD "*") (FRAGMENT STELLA::NULL-STRING))
   ...
   (CL:LOOP WHILE (CL:NOT (CL:= (CL:SETQ WILDCARDPOS (STRING-SEARCH MATCHSTRING WILDCARD CURSOR)) NULL-INTEGER)) DO
    (CL:WHEN (CL:> WILDCARDPOS CURSOR) (CL:SETQ FRAGMENT (SUBSEQUENCE MATCHSTRING CURSOR WILDCARDPOS))
     (CL:WHEN (STRING-EQL? CASESENSITIVE? "FALSE") (CL:SETQ FRAGMENT (STRING-DOWNCASE FRAGMENT)))
   ...
   (CL:WHEN (CL:< CURSOR (CL:THE CL:FIXNUM (CL:LENGTH MATCHSTRING)))
    (CL:SETQ FRAGMENT (SUBSEQUENCE MATCHSTRING CURSOR (CL:THE CL:FIXNUM (CL:LENGTH MATCHSTRING))))
    (CL:SETQ RESULT (CONS (WRAP-STRING FRAGMENT) RESULT)))
   (REVERSE RESULT)))
...
(CL:DEFUN SEARCH-STRING-MATCH? (INPUTSTRING MATCHLIST)
  ...
  (CL:WHEN (CL:EQ MATCHLIST NIL)
   (CL:IF (CL:= (CL:THE CL:FIXNUM (CL:LENGTH INPUTSTRING)) 0) (CL:RETURN-FROM SEARCH-STRING-MATCH? CL:T)
  ...
  (CL:IF (SYMBOL? (%%VALUE MATCHLIST))
   (CL:LET* ((FIRSTNONWILD (GET-FIRST-NON-WILD MATCHLIST)) (MATCHPOS 0) (RESTOFINPUT STELLA::NULL-STRING))
    (CL:DECLARE (CL:TYPE CL:FIXNUM MATCHPOS) (CL:TYPE CL:SIMPLE-STRING RESTOFINPUT))
    (CL:WHEN (CL:EQ FIRSTNONWILD NULL) (CL:RETURN-FROM SEARCH-STRING-MATCH? CL:T))
    (CL:WHEN
     (CL:NOT (CL:= (CL:SETQ MATCHPOS (STRING-SEARCH INPUTSTRING (%WRAPPER-VALUE FIRSTNONWILD) 0)) NULL-INTEGER))
     (CL:SETQ RESTOFINPUT
      (SUBSEQUENCE INPUTSTRING
       (CL:+ MATCHPOS (CL:THE CL:FIXNUM (CL:LENGTH (CL:THE CL:SIMPLE-STRING (%WRAPPER-VALUE FIRSTNONWILD)))))
       (CL:THE CL:FIXNUM (CL:LENGTH INPUTSTRING))))
     (CL:RETURN-FROM SEARCH-STRING-MATCH?
      (SEARCH-STRING-MATCH? RESTOFINPUT (GET-REST-AFTER-FIRST-NON-WILD MATCHLIST))))
    CL:NIL)
   (CL:LET* ((FRAGMENT (%%VALUE MATCHLIST)))
    (CL:IF
     (CL:> (CL:THE CL:FIXNUM (CL:LENGTH (CL:THE CL:SIMPLE-STRING (%WRAPPER-VALUE FRAGMENT))))
      (CL:THE CL:FIXNUM (CL:LENGTH INPUTSTRING)))
     CL:NIL
     (CL:LET*
      ((INPUTSTART
        (SUBSEQUENCE INPUTSTRING 0 (CL:THE CL:FIXNUM (CL:LENGTH (CL:THE CL:SIMPLE-STRING (%WRAPPER-VALUE FRAGMENT))))))
       (RESTOFINPUT
        (SUBSEQUENCE INPUTSTRING (CL:THE CL:FIXNUM (CL:LENGTH (CL:THE CL:SIMPLE-STRING (%WRAPPER-VALUE FRAGMENT))))
         (CL:THE CL:FIXNUM (CL:LENGTH INPUTSTRING)))))
      (CL:DECLARE (CL:TYPE CL:SIMPLE-STRING INPUTSTART RESTOFINPUT))
      (CL:AND (STRING-EQL? (%WRAPPER-VALUE FRAGMENT) INPUTSTART)
...
(CL:DEFUN GET-FIRST-NON-WILD (MATCHLIST)
  (CL:LET* ((CANDIDATE NULL) (ITER-000 MATCHLIST))
   (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-000 NIL)) DO (CL:SETQ CANDIDATE (%%VALUE ITER-000))
    (CL:WHEN (STRING? CANDIDATE) (CL:RETURN-FROM GET-FIRST-NON-WILD CANDIDATE)) (CL:SETQ ITER-000 (%%REST ITER-000))))
  NULL)
...
(CL:DEFUN GET-REST-AFTER-FIRST-NON-WILD (MATCHLIST)
  (CL:LOOP WHILE (CL:NOT (CL:EQ MATCHLIST NULL)) DO
   (CL:WHEN (STRING? (%%VALUE MATCHLIST)) (CL:RETURN-FROM GET-REST-AFTER-FIRST-NON-WILD (%%REST MATCHLIST)))
     ...
     (CL:WHEN (SEARCH-STRING-MATCH? (GET-LOGIC-OBJECT-NAME OBJECT CASESENSITIVE?) MATCHLIST)
      (CL:IF (CL:EQ COLLECT-000 NULL)
       (CL:PROGN (CL:SETQ COLLECT-000 (CONS (MAKE-SEARCH-RESULT-ITEM MODULENAME OBJECT) NIL))
        (CL:IF (CL:EQ (%THE-CONS-LIST RESULT) NIL) (CL:SETF (%THE-CONS-LIST RESULT) COLLECT-000)
         (ADD-CONS-TO-END-OF-CONS-LIST (%THE-CONS-LIST RESULT) COLLECT-000)))
       (CL:PROGN (CL:SETF (%%REST COLLECT-000) (CONS (MAKE-SEARCH-RESULT-ITEM MODULENAME OBJECT) NIL))
        (CL:SETQ COLLECT-000 (%%REST COLLECT-000)))))
     (CL:SETQ ITER-000 (%%REST ITER-000))))
   RESULT))
...
(CL:DEFUN GET-LOGIC-OBJECT-NAME (OBJECT CASESENSITIVE?)
  ...
  #+MCL
  (CL:CHECK-TYPE CASESENSITIVE? CL:SIMPLE-STRING)
  (CL:LET* ((NAME (OBJECT-NAME-STRING OBJECT))) (CL:DECLARE (CL:TYPE CL:SIMPLE-STRING NAME))
   (CL:IF (STRING-EQL? CASESENSITIVE? "TRUE") NAME (STRING-DOWNCASE NAME))))
...
(CL:DEFUN SEARCH-CONCEPTS (MODULENAME MATCHLIST CASESENSITIVE?)
  ...
  (CL:LET* ((MODULE (PLI::GET-MODULE MODULENAME NULL)))
   (SEARCH-LOGIC-OBJECTS MODULENAME (GET-ALL-CONCEPTS MODULE CL:T) MATCHLIST CASESENSITIVE?)))
...
(CL:DEFUN SEARCH-RELATIONS (MODULENAME MATCHLIST CASESENSITIVE?)
  ...
  (CL:CHECK-TYPE CASESENSITIVE? CL:SIMPLE-STRING)
  (CL:LET* ((MODULE (PLI::GET-MODULE MODULENAME NULL)))
   (SEARCH-LOGIC-OBJECTS MODULENAME (GET-ALL-RELATIONS MODULE) MATCHLIST CASESENSITIVE?)))
...
(CL:DEFUN SEARCH-INSTANCES (MODULENAME MATCHLIST CASESENSITIVE?)
  ...
  (CL:CHECK-TYPE CASESENSITIVE? CL:SIMPLE-STRING)
  (CL:LET*
   ((MODULE (PLI::GET-MODULE MODULENAME NULL)) (ALLINSTANCES (ALL-INSTANCES MODULE CL:T))
...
(CL:DEFUN SEARCH-ALL-MODULES (SEARCHSTRING SEARCHINSTANCE? SEARCHCONCEPT? SEARCHRELATION? CASESENSITIVE?)
  ...
  (CL:LET* ((ROOTMODULE *ROOT-MODULE*) (ALLMODULES (COLLECT-ALL-MODULES ROOTMODULE (NEW-LIST))) (RESULT (NEW-LIST)))
   (CL:LET* ((MODULE NULL) (ITER-000 (%THE-CONS-LIST ALLMODULES)))
    (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-000 NIL)) DO (CL:SETQ MODULE (%%VALUE ITER-000))
     (CONCATENATE RESULT
      (SEARCH-MODULE (%MODULE-NAME MODULE) SEARCHSTRING SEARCHINSTANCE? SEARCHCONCEPT? SEARCHRELATION? CASESENSITIVE?))
     (CL:SETQ ITER-000 (%%REST ITER-000))))
   RESULT))
...
(CL:DEFUN SEARCH-MODULE (MODULENAME SEARCHSTRING SEARCHINSTANCE? SEARCHCONCEPT? SEARCHRELATION? CASESENSITIVE?)
  (CL:DECLARE
   (CL:TYPE CL:SIMPLE-STRING MODULENAME SEARCHSTRING SEARCHINSTANCE? SEARCHCONCEPT? SEARCHRELATION? CASESENSITIVE?))
  #+MCL
  (CL:CHECK-TYPE MODULENAME CL:SIMPLE-STRING)
  #+MCL
  (CL:CHECK-TYPE SEARCHSTRING CL:SIMPLE-STRING)
  ...
  (CL:CHECK-TYPE CASESENSITIVE? CL:SIMPLE-STRING)
  (CL:LET*
   ((CONCEPTRESULTS (NEW-LIST)) (RELATIONRESULTS (NEW-LIST)) (INSTANCERESULTS (NEW-LIST))
    (MATCHLIST (PARSE-MATCH-STRING SEARCHSTRING CASESENSITIVE?)) (RESULT (NEW-LIST))
    (MODULE (PLI::GET-MODULE MODULENAME NULL)))
   (CL:LET* ((*MODULE* MODULE) (*CONTEXT* *MODULE*)) (CL:DECLARE (CL:SPECIAL *MODULE* *CONTEXT*))
    (CL:WHEN (STRING-EQL? SEARCHINSTANCE? "TRUE")
     (CL:SETQ INSTANCERESULTS (SEARCH-INSTANCES MODULENAME MATCHLIST CASESENSITIVE?)))
    (CL:WHEN (STRING-EQL? SEARCHRELATION? "TRUE")
     (CL:SETQ RELATIONRESULTS (SEARCH-RELATIONS MODULENAME MATCHLIST CASESENSITIVE?)))
    (CL:WHEN (STRING-EQL? SEARCHCONCEPT? "TRUE")
     (CL:SETQ CONCEPTRESULTS (SEARCH-CONCEPTS MODULENAME MATCHLIST CASESENSITIVE?)))
...
(CL:DEFUN MAKE-SEARCH-RESULT-ITEM (MODULENAME OBJECT)
  ...
  #+MCL
  (CL:CHECK-TYPE MODULENAME CL:SIMPLE-STRING)
  (CL:LET* ((UNION (MAKE-PL-OBJECT-UNION OBJECT)) (RESULT (|new-PLSearchResultItem|)))
   (CL:SETF (|%ModuleName| RESULT) MODULENAME) (CL:SETF (|%PLObjectUnion| RESULT) UNION) RESULT))
...
(CL:DEFUN GET-DIRECTORY-LISTING (CURRENTDIRECTORY)
  ...
  (CL:LET* ((FILESINDIR (NEW-LIST)) (DIRSINDIR (NEW-LIST)) (RESULT (NEW-LIST)))
				   ...
				   do 
                               (cl:let ((wrapper (STELLA::NEW-STRING-WRAPPER 
                                   ...
                                   (cl:if directoryP
                                       ...
                                       (STELLA::INSERT filesInDir wrapper))))) (INSERT RESULT DIRSINDIR)
   (INSERT RESULT FILESINDIR) RESULT))
...
(CL:DEFUN SERVER-GET-DIRECTORY-LISTING (CURRENTDIRECTORY EXTENSIONFILTER)
  ...
  (CL:LET*
   ((DIRECTORYLISTING (GET-DIRECTORY-LISTING (|%Value| CURRENTDIRECTORY)))
    (PLDIRECTORYLISTING (|new-PLDirectoryContents|)) (PLFILES (NEW-LIST)) (PLDIRECTORIES (NEW-LIST))
   ...
   (CL:LET* ((FILENAME NULL) (ITER-000 (%THE-CONS-LIST (FIRST DIRECTORYLISTING))))
    (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-000 NIL)) DO (CL:SETQ FILENAME (%%VALUE ITER-000))
     (CL:WHEN (SEARCH-STRING-MATCH? (%WRAPPER-VALUE FILENAME) MATCHLIST)
      (CL:LET* ((PLFILE (|new-PLFile|))) (CL:SETF (|%FileName| PLFILE) (%WRAPPER-VALUE FILENAME))
   ...
   (CL:LET* ((DIRNAME NULL) (ITER-001 (%THE-CONS-LIST (SECOND DIRECTORYLISTING))))
    (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-001 NIL)) DO (CL:SETQ DIRNAME (%%VALUE ITER-001))
     (CL:LET* ((PLDIRECTORY (|new-PLDirectory|))) (CL:SETF (|%DirectoryName| PLDIRECTORY) (%WRAPPER-VALUE DIRNAME))
      (INSERT PLDIRECTORIES PLDIRECTORY))
     (CL:SETQ ITER-001 (%%REST ITER-001))))
   (CL:SETF (|%PLFile| PLDIRECTORYLISTING) PLFILES) (CL:SETF (|%PLDirectory| PLDIRECTORYLISTING) PLDIRECTORIES)
   PLDIRECTORYLISTING))
...
(CL:DEFUN SERVER-GET-DEFAULT-DIRECTORY-LISTING (EXTENSIONFILTER)
  ...
  (CL:LET* ((DIR (|new-PLString|))) (CL:SETF (|%Value| DIR) *DEFAULT-KB-DIRECTORY*)
...
(CL:DEFUN DISPATCH-CALL (FUNCTIONNAME ARGS)
  ...
  (CL:LET* ((CODE (LOOKUP *SERVER-DISPATCH-TABLE* FUNCTIONNAME)))
   (CL:IF (CL:EQ CODE NULL)
    (CL:LET* ((STREAM-000 (NEW-OUTPUT-STRING-STREAM)))
     (%%PRINT-STREAM (%NATIVE-STREAM STREAM-000) "Couldn't find function `" FUNCTIONNAME "' for dispatch.")
...
(CL:DEFUN INITIALIZE-DISPATCH-TABLE ()
  ...
  (INSERT-AT *SERVER-DISPATCH-TABLE* "SERVER-GET-DIRECT-INSTANCES-FOR-CONCEPT"
   (WRAP-FUNCTION-CODE (CL:FUNCTION SERVER-GET-DIRECT-INSTANCES-FOR-CONCEPT)))
  ...
  (INSERT-AT *SERVER-DISPATCH-TABLE* "SERVER-GET-PROPOSITIONS-FOR-MODULE"
   (WRAP-FUNCTION-CODE (CL:FUNCTION SERVER-GET-PROPOSITIONS-FOR-MODULE)))
  ...
  (INSERT-AT *SERVER-DISPATCH-TABLE* "SERVER-GET-INHERITED-RELATIONS-FOR-CONCEPT"
   (WRAP-FUNCTION-CODE (CL:FUNCTION SERVER-GET-INHERITED-RELATIONS-FOR-CONCEPT)))
  (INSERT-AT *SERVER-DISPATCH-TABLE* "SERVER-GET-DOCUMENTATION-FOR-CONCEPT"
   (WRAP-FUNCTION-CODE (CL:FUNCTION SERVER-GET-DOCUMENTATION-FOR-CONCEPT)))
  ...
  (INSERT-AT *SERVER-DISPATCH-TABLE* "SERVER-GET-DOCUMENTATION-FOR-RELATION"
   (WRAP-FUNCTION-CODE (CL:FUNCTION SERVER-GET-DOCUMENTATION-FOR-RELATION)))
  (INSERT-AT *SERVER-DISPATCH-TABLE* "SERVER-GET-DOCUMENTATION-FOR-INSTANCE"
   (WRAP-FUNCTION-CODE (CL:FUNCTION SERVER-GET-DOCUMENTATION-FOR-INSTANCE)))
  (INSERT-AT *SERVER-DISPATCH-TABLE* "SERVER-GET-SUPERCONCEPTS-FOR-CONCEPT"
   (WRAP-FUNCTION-CODE (CL:FUNCTION SERVER-GET-SUPERCONCEPTS-FOR-CONCEPT)))
  (INSERT-AT *SERVER-DISPATCH-TABLE* "SERVER-GET-SUPERRELATIONS-FOR-RELATION"
   (WRAP-FUNCTION-CODE (CL:FUNCTION SERVER-GET-SUPERRELATIONS-FOR-RELATION)))
  ...
  (INSERT-AT *SERVER-DISPATCH-TABLE* "SERVER-GET-SHADOWED-SURROGATES-FOR-MODULE"
   (WRAP-FUNCTION-CODE (CL:FUNCTION SERVER-GET-SHADOWED-SURROGATES-FOR-MODULE)))
  (INSERT-AT *SERVER-DISPATCH-TABLE* "SERVER-GET-VARIABLES-FOR-RELATION"
   (WRAP-FUNCTION-CODE (CL:FUNCTION SERVER-GET-VARIABLES-FOR-RELATION)))
  (INSERT-AT *SERVER-DISPATCH-TABLE* "SERVER-GET-PROPOSITIONS-FOR-INSTANCE"
   (WRAP-FUNCTION-CODE (CL:FUNCTION SERVER-GET-PROPOSITIONS-FOR-INSTANCE)))
  ...
  (INSERT-AT *SERVER-DISPATCH-TABLE* "SERVER-GET-PROPOSITIONS-FOR-CONCEPT"
   (WRAP-FUNCTION-CODE (CL:FUNCTION SERVER-GET-PROPOSITIONS-FOR-CONCEPT)))
  (INSERT-AT *SERVER-DISPATCH-TABLE* "SERVER-GET-PROPOSITIONS-FOR-RELATION"
   (WRAP-FUNCTION-CODE (CL:FUNCTION SERVER-GET-PROPOSITIONS-FOR-RELATION)))
  ...
  (INSERT-AT *SERVER-DISPATCH-TABLE* "SERVER-GET-DEFAULT-DIRECTORY-LISTING"
   (WRAP-FUNCTION-CODE (CL:FUNCTION SERVER-GET-DEFAULT-DIRECTORY-LISTING)))
  (INSERT-AT *SERVER-DISPATCH-TABLE* "SERVER-GET-EXTENSION-FOR-RELATION"
...
(CL:DEFUN MEMBER-TEST (CONCEPT)
  (CL:LET* ((CONCEPTLIST (NEW-LIST)) (NEWCONC (|new-PLConcept|)))
   (CL:SETF (|%ConceptName| NEWCONC) (|%ConceptName| CONCEPT)) (INSERT CONCEPTLIST CONCEPT)
...
(CL:DEFUN TEST-SERVER-GET-INSTANCES-FOR-MODULE ()
  (CL:LET* ((PLSTRING (|new-PLString|))) (CL:SETF (|%Value| PLSTRING) "LOGIC")
...
(CL:DEFUN TEST-SERVER-GET-RELATIONS-FOR-MODULE ()
  (CL:LET* ((PLSTRING (|new-PLString|))) (CL:SETF (|%Value| PLSTRING) "PL-KERNEL-KB")
...
(CL:DEFUN TEST-SERVER-GET-DIRECT-INSTANCES-FOR-CONCEPT ()
  (CL:LET* ((MODULE (|new-PLString|)) (CONCEPT (|new-PLString|))) (CL:SETF (|%Value| MODULE) "AIRCRAFT-KB")
   (CL:SETF (|%Value| CONCEPT) "AIRCRAFT") (SERVER-GET-DIRECT-INSTANCES-FOR-CONCEPT MODULE CONCEPT)))

;;; (DEFUN (TEST-SERVER-GET-INSTANCES-FOR-CONCEPT |PLInstanceContainer|) ...)

(CL:DEFUN TEST-SERVER-GET-INSTANCES-FOR-CONCEPT ()
  (CL:LET* ((MODULE (|new-PLString|)) (CONCEPT (|new-PLString|))) (CL:SETF (|%Value| MODULE) "AIRCRAFT-KB")
   (CL:SETF (|%Value| CONCEPT) "AIRCRAFT") (SERVER-GET-INSTANCES-FOR-CONCEPT MODULE CONCEPT)))

;;; (DEFUN (TEST-SERVER-GET-PROPOSITIONS-FOR-MODULE |PLPropositionContainer|) ...)

(CL:DEFUN TEST-SERVER-GET-PROPOSITIONS-FOR-MODULE ()
  (CL:LET* ((PLSTRING (|new-PLString|))) (CL:SETF (|%Value| PLSTRING) "AIRCRAFT-KB")
...
(CL:DEFUN TEST-SERVER-GET-PROPOSITIONS-FOR-INSTANCE ()
  (CL:LET* ((MODSTRING (|new-PLString|)) (INSTANCESTRING (|new-PLString|)))
   (CL:SETF (|%Value| MODSTRING) "AIRCRAFT-KB") (CL:SETF (|%Value| INSTANCESTRING) "F-117")
...
(CL:DEFUN TEST-SERVER-GET-TYPES-FOR-INSTANCE ()
  (CL:LET* ((MODSTRING (|new-PLString|)) (INSTANCESTRING (|new-PLString|)))
   (CL:SETF (|%Value| MODSTRING) "AIRCRAFT-KB") (CL:SETF (|%Value| INSTANCESTRING) "A-10")
...
(CL:DEFUN TEST-SERVER-GET-DOCUMENTATION-FOR-INSTANCE ()
  (CL:LET* ((MODSTRING (|new-PLString|)) (INSTANCESTRING (|new-PLString|))) (CL:SETF (|%Value| MODSTRING) "EELD")
   (CL:SETF (|%Value| INSTANCESTRING) "Action_105") (SERVER-GET-DOCUMENTATION-FOR-INSTANCE MODSTRING INSTANCESTRING)))

;;; (DEFUN (TEST-SERVER-GET-RELATIONS-FOR-CONCEPT |PLRelationContainer|) ...)

(CL:DEFUN TEST-SERVER-GET-RELATIONS-FOR-CONCEPT ()
  (CL:LET* ((MODSTRING (|new-PLString|)) (INSTANCESTRING (|new-PLString|)))
   (CL:SETF (|%Value| MODSTRING) "AIRCRAFT-KB") (CL:SETF (|%Value| INSTANCESTRING) "ENGINE")
...
(CL:DEFUN TEST-SERVER-GET-INHERITED-RELATIONS-FOR-CONCEPT ()
  (CL:LET* ((MODSTRING (|new-PLString|)) (INSTANCESTRING (|new-PLString|)))
   (CL:SETF (|%Value| MODSTRING) "AIRCRAFT-KB") (CL:SETF (|%Value| INSTANCESTRING) "AIRCRAFT")
...
(CL:DEFUN TEST-SERVER-GET-DOCUMENTATION-FOR-CONCEPT ()
  (CL:LET* ((MODSTRING (|new-PLString|)) (CONCEPTSTRING (|new-PLString|))) (CL:SETF (|%Value| MODSTRING) "AIRCRAFT-KB")
   (CL:SETF (|%Value| CONCEPTSTRING) "JFC9") (SERVER-GET-DOCUMENTATION-FOR-CONCEPT MODSTRING CONCEPTSTRING)))
...
(CL:DEFUN TEST-SERVER-GET-DOCUMENTATION-FOR-RELATION ()
  (CL:LET* ((MODSTRING (|new-PLString|)) (RELATIONSTRING (|new-PLString|)))
   (CL:SETF (|%Value| MODSTRING) "AIRCRAFT-KB") (CL:SETF (|%Value| RELATIONSTRING) "ORDNANCE")
...
(CL:DEFUN TEST-SERVER-GET-SUPERRELATIONS-FOR-RELATION ()
  (CL:LET* ((MODSTRING (|new-PLString|)) (RELATIONSTRING (|new-PLString|)))
   (CL:SETF (|%Value| MODSTRING) "AIRCRAFT-KB") (CL:SETF (|%Value| RELATIONSTRING) "AG-ORDNANCE")
...
(CL:DEFUN TEST-SERVER-GET-INCLUDES-FOR-MODULE ()
  (CL:LET* ((MODSTRING (|new-PLString|))) (CL:SETF (|%Value| MODSTRING) "AIRCRAFT-KB")
...
(CL:DEFUN TEST-SERVER-GET-VARIABLES-FOR-RELATION ()
  (CL:LET* ((MODSTRING (|new-PLString|)) (RELATIONSTRING (|new-PLString|)))
   (CL:SETF (|%Value| MODSTRING) "AIRCRAFT-KB") (CL:SETF (|%Value| RELATIONSTRING) "STORES")
...
(CL:DEFUN TEST-SERVER-GET-PROPOSITIONS-FOR-CONCEPT ()
  (CL:LET* ((MODSTRING (|new-PLString|)) (INSTANCESTRING (|new-PLString|))) (CL:SETF (|%Value| MODSTRING) "SUBMOD1")
   (CL:SETF (|%Value| INSTANCESTRING) "WIDTH-RELATION") (SERVER-GET-PROPOSITIONS-FOR-CONCEPT MODSTRING INSTANCESTRING)))

;;; (DEFUN (TEST-SERVER-GET-RULES-FOR-CONCEPT |PLPropositionContainer|) ...)

(CL:DEFUN TEST-SERVER-GET-RULES-FOR-CONCEPT ()
  (CL:LET* ((MODSTRING (|new-PLString|)) (INSTANCESTRING (|new-PLString|)))
   (CL:SETF (|%Value| MODSTRING) "AIRCRAFT-KB") (CL:SETF (|%Value| INSTANCESTRING) "WIDTH-RELATION")
...
(CL:DEFUN TEST-SERVER-GET-PROPOSITIONS-FOR-RELATION ()
  (CL:LET* ((MODSTRING (|new-PLString|)) (INSTANCESTRING (|new-PLString|)))
   (CL:SETF (|%Value| MODSTRING) "AIRCRAFT-KB") (CL:SETF (|%Value| INSTANCESTRING) "ABCD")
...
(CL:DEFUN TEST-SERVER-GET-RULES-FOR-RELATION ()
  (CL:LET* ((MODSTRING (|new-PLString|)) (INSTANCESTRING (|new-PLString|)))
   (CL:SETF (|%Value| MODSTRING) "AIRCRAFT-KB") (CL:SETF (|%Value| INSTANCESTRING) "SMART-BOMB")
...
(CL:DEFUN TEST-SERVER-GET-PROPOSITIONS-FOR-INSTANCE-AND-RELATION ()
  (CL:LET* ((MODSTRING (|new-PLString|)) (RELATIONSTRING (|new-PLString|)) (INSTANCESTRING (|new-PLString|)))
   (CL:SETF (|%Value| MODSTRING) "AIRCRAFT-KB") (CL:SETF (|%Value| RELATIONSTRING) "FLEET-SIZE")
   (CL:SETF (|%Value| INSTANCESTRING) "USAF")
...
(CL:DEFUN TEST-SERVER-EVALUATE-LOGIC-COMMAND (COMMAND)
  ...
  #+MCL
  (CL:CHECK-TYPE COMMAND CL:SIMPLE-STRING)
  (CL:LET* ((MODSTRING (|new-PLString|)) (COMMANDSTRING (|new-PLString|))) (CL:SETF (|%Value| MODSTRING) "AIRCRAFT-KB")
   (CL:SETF (|%Value| COMMANDSTRING) COMMAND) (SERVER-EVALUATE-LOGIC-COMMAND MODSTRING COMMANDSTRING)))
...
(CL:DEFUN TEST-SERVER-SAVE-KB ()
  (CL:LET* ((KBSTRING (|new-PLString|)) (MODSTRING (|new-PLString|)) (DESCSTRING (|new-PLString|)))
   (CL:SETF (|%Value| KBSTRING) "aircraft-kb10") (CL:SETF (|%Value| MODSTRING) "AIRCRAFT-KB")
   (CL:SETF (|%Value| DESCSTRING) "groovy new desc for aircraft-kb10") (SERVER-SAVE-KB MODSTRING KBSTRING DESCSTRING)))

;;; (DEFUN (TEST-SERVER-SAVE-KB2 |PLFile|) ...)

(CL:DEFUN TEST-SERVER-SAVE-KB2 ()
  (CL:LET* ((FILESTRING (|new-PLString|)) (MODSTRING (|new-PLString|)))
   (CL:SETF (|%Value| FILESTRING) "/nfs/topaz/melz/cvscheckout/powerloom/sources/logic/demos/aircraft.ploom")
   (CL:SETF (|%Value| MODSTRING) "AIRCRAFT-KB") (SERVER-SAVE-KB2 MODSTRING FILESTRING)))

;;; (DEFUN (MAKE-PL-QUERY |PLQuery|) ...)

(CL:DEFUN MAKE-PL-QUERY ()
  (CL:LET* ((PLQUERY (|new-PLQuery|))) (CL:SETF (|%Query| PLQUERY) "(HAPPY ?X)")
   (CL:SETF (|%NumResults| PLQUERY) "ALL") (CL:SETF (|%Module| PLQUERY) "SUBMOD1") (CL:SETF (|%IsAsk| PLQUERY) "FALSE")
   (CL:SETF (|%QueryName| PLQUERY) "") (CL:SETF (|%InferenceLevel| PLQUERY) "") (CL:SETF (|%Timeout| PLQUERY) "")
   (CL:SETF (|%Moveout| PLQUERY) "") (CL:SETF (|%MatchMode| PLQUERY) "PARTIAL") (CL:SETF (|%MinScore| PLQUERY) "")
   (CL:SETF (|%MaxUnknowns| PLQUERY) "") (CL:SETF (|%MaximizeScore| PLQUERY) "") (CL:SETF (|%DontOptimize| PLQUERY) "")
   PLQUERY))

;;; (DEFUN (TEST-SERVER-QUERY |PLQueryResult|) ...)

(CL:DEFUN TEST-SERVER-QUERY ()
  (CL:LET* ((RESULT NULL) (CONTINUEQUERY? (|new-PLString|)) (PLQUERY (MAKE-PL-QUERY)))
   (CL:SETF (|%Value| CONTINUEQUERY?) "FALSE")
...
(CL:DEFUN TEST-SERVER-SEARCH1 ()
  (CL:LET* ((SEARCHPARAMETER (|new-PLSearchParameter|))) (CL:SETF (|%ModuleName| SEARCHPARAMETER) "AIRCRAFT-KB")
   (CL:SETF (|%SearchString| SEARCHPARAMETER) "*pod*") (CL:SETF (|%SearchConcept| SEARCHPARAMETER) "TRUE")
   (CL:SETF (|%SearchRelation| SEARCHPARAMETER) "FALSE") (CL:SETF (|%SearchInstance| SEARCHPARAMETER) "FALSE")
...
(CL:DEFUN TEST-SERVER-GET-DEFAULT-DIRECTORY-LISTING ()
  (CL:LET* ((EXTENSION (|new-PLString|))) (CL:SETF (|%Value| EXTENSION) "*.edu")
...
(CL:DEFUN TEST-SERVER-GET-EXTENSION-FOR-RELATION ()
  (CL:LET* ((MOD (|new-PLString|)) (RELATION (|new-PLString|))) (CL:SETF (|%Value| MOD) "AIRCRAFT-KB")
   (CL:SETF (|%Value| RELATION) "cost") (SERVER-GET-EXTENSION-FOR-RELATION MOD RELATION)))

;;; (DEFUN (TEST-SERVER-GET-RELATION |PLRelationContainer|) ...)

(CL:DEFUN TEST-SERVER-GET-RELATION ()
  (CL:LET* ((MOD (|new-PLString|)) (RELATION (|new-PLString|))) (CL:SETF (|%Value| MOD) "AIRCRAFT-KB")
   (CL:SETF (|%Value| RELATION) "DUPLICATE-FREE") (SERVER-GET-RELATION MOD RELATION)))

;;; (DEFUN (TEST-SERVER-GET-CONCEPT |PLConceptContainer|) ...)

(CL:DEFUN TEST-SERVER-GET-CONCEPT ()
  (CL:LET* ((MOD (|new-PLString|)) (CONCEPT (|new-PLString|))) (CL:SETF (|%Value| MOD) "AIRCRAFT-KB")
   (CL:SETF (|%Value| CONCEPT) "DUPLICATE-FREE") (SERVER-GET-CONCEPT MOD CONCEPT)))

;;; (DEFUN (TEST-SERVER-GET-INSTANCE |PLInstanceContainer|) ...)

(CL:DEFUN TEST-SERVER-GET-INSTANCE ()
  (CL:LET* ((MOD (|new-PLString|)) (INSTANCE (|new-PLString|))) (CL:SETF (|%Value| MOD) "AIRCRAFT-KB")
   (CL:SETF (|%Value| INSTANCE) "A-10") (SERVER-GET-INSTANCE MOD INSTANCE)))

;;; (DEFUN (TEST-SERVER-GET-CONCEPT-COMPLETIONS |PLConceptContainer|) ...)

(CL:DEFUN TEST-SERVER-GET-CONCEPT-COMPLETIONS ()
  (CL:LET* ((MOD (|new-PLString|)) (PREFIX (|new-PLString|))) (CL:SETF (|%Value| MOD) "AIRCRAFT-KB")
   (CL:SETF (|%Value| PREFIX) "CO") (SERVER-GET-CONCEPT-COMPLETIONS MOD PREFIX)))

;;; (DEFUN (TEST-SERVER-GET-RELATION-COMPLETIONS |PLRelationContainer|) ...)

(CL:DEFUN TEST-SERVER-GET-RELATION-COMPLETIONS ()
  (CL:LET* ((MOD (|new-PLString|)) (PREFIX (|new-PLString|))) (CL:SETF (|%Value| MOD) "AIRCRAFT-KB")
   (CL:SETF (|%Value| PREFIX) "CO") (SERVER-GET-RELATION-COMPLETIONS MOD PREFIX)))

;;; (DEFUN (TEST-SERVER-GET-INSTANCE-COMPLETIONS |PLInstanceContainer|) ...)

(CL:DEFUN TEST-SERVER-GET-INSTANCE-COMPLETIONS ()
  (CL:LET* ((MOD (|new-PLString|)) (PREFIX (|new-PLString|))) (CL:SETF (|%Value| MOD) "AIRCRAFT-KB")
   (CL:SETF (|%Value| PREFIX) "A") (SERVER-GET-INSTANCE-COMPLETIONS MOD PREFIX)))

;;; (DEFUN (TEST-SERVER-DESTROY-OBJECT |PLString|) ...)

(CL:DEFUN TEST-SERVER-DESTROY-OBJECT ()
  (CL:LET* ((MOD (|new-PLString|)) (OBJECT (|new-PLString|))) (CL:SETF (|%Value| MOD) "AIRCRAFT-KB")
   (CL:SETF (|%Value| OBJECT) "SWING-WING") (SERVER-DESTROY-OBJECT MOD OBJECT)))

;;; (DEFUN (TEST-SERVER-GET-EXPLANATION-FOR-QUERY |PLString|) ...)

(CL:DEFUN TEST-SERVER-GET-EXPLANATION-FOR-QUERY ()
  (CL:LET* ((PLQUERY (MAKE-PL-QUERY)) (RESULTNUM (|new-PLString|))) (CL:SETF (|%Value| RESULTNUM) "4")
...
(CL:DEFUN HELP-STARTUP-GUI-SERVER-API1 ()
  (CL:PROGN (CL:SETQ KWD-GUI-SERVER-API-LOG-LEVELS (INTERN-RIGID-SYMBOL-WRT-MODULE "LOG-LEVELS" NULL 2))
   ...
   (CL:SETQ KWD-GUI-SERVER-API-HIGH (INTERN-RIGID-SYMBOL-WRT-MODULE "HIGH" NULL 2))
   (CL:SETQ KWD-GUI-SERVER-API-LOW (INTERN-RIGID-SYMBOL-WRT-MODULE "LOW" NULL 2))
   ...
   (CL:SETQ SGT-GUI-SERVER-API-LOGIC-TRUTH-VALUE
    (INTERN-RIGID-SYMBOL-WRT-MODULE "TRUTH-VALUE" (GET-STELLA-MODULE "/LOGIC" CL:T) 1))
   ...
   (CL:SETQ SYM-GUI-SERVER-API-STELLA-JAVA-FLOTSAM-CLASS
    (INTERN-RIGID-SYMBOL-WRT-MODULE "JAVA-FLOTSAM-CLASS" (GET-STELLA-MODULE "/STELLA" CL:T) 0))
   (CL:SETQ SYM-GUI-SERVER-API-STELLA-API?
    (INTERN-RIGID-SYMBOL-WRT-MODULE "API?" (GET-STELLA-MODULE "/STELLA" CL:T) 0))
   ...
   (CL:SETQ SYM-GUI-SERVER-API-LOGIC-MASTER-PROPOSITION
    (INTERN-RIGID-SYMBOL-WRT-MODULE "MASTER-PROPOSITION" (GET-STELLA-MODULE "/LOGIC" CL:T) 0))
...
(CL:DEFUN HELP-STARTUP-GUI-SERVER-API2 ()
  (CL:PROGN
   (DEFINE-FUNCTION-OBJECT "SERVER-LOG" "(DEFUN SERVER-LOG ((LOGLEVEL KEYWORD) |&REST| (MESSAGE OBJECT)))"
    (CL:FUNCTION SERVER-LOG) NULL)
   (DEFINE-FUNCTION-OBJECT "PL-OBJECT-TO-GUI-NAME" "(DEFUN (PL-OBJECT-TO-GUI-NAME STRING) ((X OBJECT)))"
    (CL:FUNCTION PL-OBJECT-TO-GUI-NAME) NULL)
   (DEFINE-FUNCTION-OBJECT "GUI-NAME-TO-PL-NAME" "(DEFUN (GUI-NAME-TO-PL-NAME STRING) ((NAME STRING)))"
   ...
   (DEFINE-FUNCTION-OBJECT "SERVER-GET-LOADABLE-KBS"
    "(DEFUN (SERVER-GET-LOADABLE-KBS |PLModuleFileList|) () :PUBLIC? TRUE)" (CL:FUNCTION SERVER-GET-LOADABLE-KBS) NULL)
   (DEFINE-FUNCTION-OBJECT "SERVER-LOAD-KB" "(DEFUN (SERVER-LOAD-KB |PLString|) ((PLKBNAME |PLString|)) :PUBLIC? TRUE)"
    (CL:FUNCTION SERVER-LOAD-KB) NULL)
   (DEFINE-FUNCTION-OBJECT "SERVER-LOAD-KB2" "(DEFUN (SERVER-LOAD-KB2 |PLString|) ((FILE |PLFile|)) :PUBLIC? TRUE)"
   ...
   (DEFINE-FUNCTION-OBJECT "SERVER-CLEAR-KB" "(DEFUN (SERVER-CLEAR-KB |PLString|) ((MODULE |PLModule|)) :PUBLIC? TRUE)"
    (CL:FUNCTION SERVER-CLEAR-KB) NULL)
   (DEFINE-FUNCTION-OBJECT "GET-QUERY-SESSION"
    "(DEFUN (GET-QUERY-SESSION /HTTP/SESSION) ((QUERY |PLQuery|) (ERROR? BOOLEAN)))" (CL:FUNCTION GET-QUERY-SESSION)
    NULL)
   ...
   (DEFINE-FUNCTION-OBJECT "EXTRACT-MODULE-NAME-FROM-FILE"
    "(DEFUN (EXTRACT-MODULE-NAME-FROM-FILE STRING) ((FILENAME STRING)))" (CL:FUNCTION EXTRACT-MODULE-NAME-FROM-FILE)
    NULL)
   (DEFINE-FUNCTION-OBJECT "CREATE-QUERY-STRING" "(DEFUN (CREATE-QUERY-STRING STRING) ((PLQUERY |PLQuery|)))"
    (CL:FUNCTION CREATE-QUERY-STRING) NULL)
   (DEFINE-FUNCTION-OBJECT "CREATE-FOLLOWUP-QUERY-STRING"
    "(DEFUN (CREATE-FOLLOWUP-QUERY-STRING STRING) ((PLQUERY |PLQuery|)))" (CL:FUNCTION CREATE-FOLLOWUP-QUERY-STRING)
    NULL)
   ...
   (DEFINE-FUNCTION-OBJECT "MAKE-PL-TUPLE" "(DEFUN (MAKE-PL-TUPLE |PLTuple|) ((TUPLE (CONS OF OBJECT))))"
    (CL:FUNCTION MAKE-PL-TUPLE) NULL)
   (DEFINE-FUNCTION-OBJECT "MAKE-PL-OBJECT-UNION" "(DEFUN (MAKE-PL-OBJECT-UNION |PLObjectUnion|) ((OBJECT OBJECT)))"
    (CL:FUNCTION MAKE-PL-OBJECT-UNION) NULL)
   (DEFINE-FUNCTION-OBJECT "GET-MODULES" "(DEFUN (GET-MODULES |PLModuleContainer|) ((MODULE MODULE)))"
    (CL:FUNCTION GET-MODULES) NULL)
   (DEFINE-FUNCTION-OBJECT "CODE-MODULE?" "(DEFUN (CODE-MODULE? BOOLEAN) ((MODULE MODULE)))" (CL:FUNCTION CODE-MODULE?)
    NULL)
...
(CL:DEFUN HELP-STARTUP-GUI-SERVER-API3 ()
  (CL:PROGN
   (DEFINE-FUNCTION-OBJECT "GET-STELLA-LITERAL-CONCEPTS"
    "(DEFUN (GET-STELLA-LITERAL-CONCEPTS (LIST OF NAMED-DESCRIPTION)) ())" (CL:FUNCTION GET-STELLA-LITERAL-CONCEPTS)
    NULL)
   ...
   (DEFINE-FUNCTION-OBJECT "GET-CONCEPTS" "(DEFUN (GET-CONCEPTS |PLConceptContainer|) ((MODULE MODULE)))"
   ...
   (DEFINE-FUNCTION-OBJECT "GET-RELATIONS" "(DEFUN (GET-RELATIONS |PLRelationContainer|) ((MODULE MODULE)))"
   ...
   (DEFINE-FUNCTION-OBJECT "CREATE-VARIABLES-LIST"
    "(DEFUN (CREATE-VARIABLES-LIST |PLVariableList|) ((RELATION LOGIC-OBJECT)))" (CL:FUNCTION CREATE-VARIABLES-LIST)
    NULL)
   ...
   (DEFINE-FUNCTION-OBJECT "MAKE-PL-CONCEPT" "(DEFUN (MAKE-PL-CONCEPT |PLConcept|) ((CONCEPT LOGIC-OBJECT)))"
   ...
   (DEFINE-FUNCTION-OBJECT "MAKE-MODULE-SURROGATE" "(DEFUN (MAKE-MODULE-SURROGATE |PLSurrogate|) ((MODULE MODULE)))"
    (CL:FUNCTION MAKE-MODULE-SURROGATE) NULL)
   (DEFINE-FUNCTION-OBJECT "MAKE-SURROGATE-SURROGATE"
    "(DEFUN (MAKE-SURROGATE-SURROGATE |PLSurrogate|) ((SURROGATE SURROGATE)))" (CL:FUNCTION MAKE-SURROGATE-SURROGATE)
    NULL)
   (DEFINE-FUNCTION-OBJECT "MAKE-LOGIC-SURROGATE" "(DEFUN (MAKE-LOGIC-SURROGATE |PLSurrogate|) ((OBJ LOGIC-OBJECT)))"
    (CL:FUNCTION MAKE-LOGIC-SURROGATE) NULL)
   (DEFINE-FUNCTION-OBJECT "GET-ALL-RELATIONS" "(DEFUN (GET-ALL-RELATIONS (LIST OF DESCRIPTION)) ((MODULE MODULE)))"
   ...
   (DEFINE-FUNCTION-OBJECT "MAKE-PL-INSTANCE" "(DEFUN (MAKE-PL-INSTANCE |PLInstance|) ((INSTANCE LOGIC-OBJECT)))"
   ...
   (DEFINE-FUNCTION-OBJECT "RULE-PROPOSITION?" "(DEFUN (RULE-PROPOSITION? BOOLEAN) ((PROPOSITION PROPOSITION)))"
    (CL:FUNCTION RULE-PROPOSITION?) NULL)
   (DEFINE-FUNCTION-OBJECT "SUBRELATION-RULE?" "(DEFUN (SUBRELATION-RULE? BOOLEAN) ((RULE PROPOSITION)))"
   ...
   (DEFINE-FUNCTION-OBJECT "IS-QUERY-PARTIAL?" "(DEFUN (IS-QUERY-PARTIAL? BOOLEAN) ((PLQUERY |PLQuery|)))"
   ...
   (DEFINE-FUNCTION-OBJECT "GET-PROPOSITION-STRING"
    "(DEFUN (GET-PROPOSITION-STRING STRING) ((PROP PROPOSITION) (MODULE MODULE)))" (CL:FUNCTION GET-PROPOSITION-STRING)
    NULL)
   (DEFINE-FUNCTION-OBJECT "GET-TRUTH-VALUE-STRING" "(DEFUN (GET-TRUTH-VALUE-STRING STRING) ((TV TRUTH-VALUE)))"
    (CL:FUNCTION GET-TRUTH-VALUE-STRING) NULL)
   (DEFINE-FUNCTION-OBJECT "XMLIFY-STRING" "(DEFUN (XMLIFY-STRING STRING) ((INSTRING STRING)))"
    (CL:FUNCTION XMLIFY-STRING) NULL)
   (DEFINE-FUNCTION-OBJECT "XMLIFY-FORMATTED-STRING" "(DEFUN (XMLIFY-FORMATTED-STRING STRING) ((INSTRING STRING)))"
    (CL:FUNCTION XMLIFY-FORMATTED-STRING) NULL)
   (DEFINE-FUNCTION-OBJECT "GET-STRINGIFIED-MODULE" "(DEFUN (GET-STRINGIFIED-MODULE STRING) ((MODULE MODULE)))"
   ...
   (DEFINE-FUNCTION-OBJECT "COMPACT-WHITESPACE" "(DEFUN (COMPACT-WHITESPACE STRING) ((INSTRING STRING)))"
    (CL:FUNCTION COMPACT-WHITESPACE) NULL)
   (DEFINE-FUNCTION-OBJECT "STRIP-NEWLINES" "(DEFUN (STRIP-NEWLINES STRING) ((INSTRING STRING)))"
    (CL:FUNCTION STRIP-NEWLINES) NULL)
   (DEFINE-FUNCTION-OBJECT "STRIP-MODULE" "(DEFUN (STRIP-MODULE STRING) ((INSTRING STRING) (MODULE MODULE)))"
   ...
   (DEFINE-FUNCTION-OBJECT "LOAD-INDEX-FILE" "(DEFUN (LOAD-INDEX-FILE (CONS OF (CONS OF STRING-WRAPPER))) ())"
    (CL:FUNCTION LOAD-INDEX-FILE) NULL)
   (DEFINE-FUNCTION-OBJECT "SAVE-INDEX-FILE" "(DEFUN SAVE-INDEX-FILE ((INDEX (CONS OF (CONS OF STRING-WRAPPER)))))"
    (CL:FUNCTION SAVE-INDEX-FILE) NULL)
   (DEFINE-FUNCTION-OBJECT "MAKE-PL-FILE"
    "(DEFUN (MAKE-PL-FILE |PLModuleFile|) ((FILEDESCRIPTION (CONS OF STRING-WRAPPER))))" (CL:FUNCTION MAKE-PL-FILE)
    NULL)
...
(CL:DEFUN HELP-STARTUP-GUI-SERVER-API4 ()
  (CL:PROGN
   ...
   (DEFINE-FUNCTION-OBJECT "GET-FIRST-NON-WILD"
    "(DEFUN (GET-FIRST-NON-WILD STRING-WRAPPER) ((MATCHLIST (CONS OF OBJECT))))" (CL:FUNCTION GET-FIRST-NON-WILD) NULL)
   ...
   (DEFINE-FUNCTION-OBJECT "GET-DIRECTORY-LISTING"
    "(DEFUN (GET-DIRECTORY-LISTING (LIST OF LIST)) ((CURRENTDIRECTORY STRING)))" (CL:FUNCTION GET-DIRECTORY-LISTING)
    NULL)
   ...
   (DEFINE-FUNCTION-OBJECT "DISPATCH-CALL" "(DEFUN (DISPATCH-CALL OBJECT) ((FUNCTIONNAME STRING) (ARGS CONS)))"
    (CL:FUNCTION DISPATCH-CALL) NULL)
   (DEFINE-FUNCTION-OBJECT "INITIALIZE-DISPATCH-TABLE" "(DEFUN INITIALIZE-DISPATCH-TABLE ())"
   ...
   (DEFINE-FUNCTION-OBJECT "TEST-SERVER-GET-DIRECT-INSTANCES-FOR-CONCEPT"
    "(DEFUN (TEST-SERVER-GET-DIRECT-INSTANCES-FOR-CONCEPT |PLInstanceContainer|) ())"
   ...
   (DEFINE-FUNCTION-OBJECT "TEST-SERVER-GET-INHERITED-RELATIONS-FOR-CONCEPT"
    "(DEFUN (TEST-SERVER-GET-INHERITED-RELATIONS-FOR-CONCEPT |PLRelationContainer|) ())"
   ...
   (DEFINE-FUNCTION-OBJECT "TEST-SERVER-GET-SOURCE-FOR-CONCEPT"
    "(DEFUN (TEST-SERVER-GET-SOURCE-FOR-CONCEPT |PLString|) ())" (CL:FUNCTION TEST-SERVER-GET-SOURCE-FOR-CONCEPT) NULL)
   ...
   (DEFINE-FUNCTION-OBJECT "TEST-SERVER-GET-SUPERRELATIONS-FOR-RELATION"
    "(DEFUN (TEST-SERVER-GET-SUPERRELATIONS-FOR-RELATION |PLSurrogateCollection|) ())"
   ...
   (DEFINE-FUNCTION-OBJECT "TEST-SERVER-GET-SHADOWED-SURROGATES-FOR-MODULE"
    "(DEFUN (TEST-SERVER-GET-SHADOWED-SURROGATES-FOR-MODULE |PLSurrogateCollection|) ())"
   ...
   (DEFINE-FUNCTION-OBJECT "TEST-SERVER-GET-PROPOSITIONS-FOR-INSTANCE-AND-RELATION"
    "(DEFUN (TEST-SERVER-GET-PROPOSITIONS-FOR-INSTANCE-AND-RELATION |PLPropositionContainer|) ())"
    (CL:FUNCTION TEST-SERVER-GET-PROPOSITIONS-FOR-INSTANCE-AND-RELATION) NULL)
   ...
   (DEFINE-FUNCTION-OBJECT "TEST-SERVER-LOAD-KB" "(DEFUN (TEST-SERVER-LOAD-KB |PLString|) ())"
    (CL:FUNCTION TEST-SERVER-LOAD-KB) NULL)
   (DEFINE-FUNCTION-OBJECT "TEST-SERVER-CLEAR-KB" "(DEFUN TEST-SERVER-CLEAR-KB ())" (CL:FUNCTION TEST-SERVER-CLEAR-KB)
    NULL)
   (DEFINE-FUNCTION-OBJECT "TEST-SERVER-SAVE-KB" "(DEFUN (TEST-SERVER-SAVE-KB |PLString|) ())"
    (CL:FUNCTION TEST-SERVER-SAVE-KB) NULL)
   (DEFINE-FUNCTION-OBJECT "TEST-SERVER-SAVE-KB2" "(DEFUN (TEST-SERVER-SAVE-KB2 |PLFile|) ())"
   ...
   (DEFINE-FUNCTION-OBJECT "TEST-SERVER-QUERY" "(DEFUN (TEST-SERVER-QUERY |PLQueryResult|) ())"
    (CL:FUNCTION TEST-SERVER-QUERY) NULL)
   (DEFINE-FUNCTION-OBJECT "TEST-SERVER-SEARCH1" "(DEFUN (TEST-SERVER-SEARCH1 |PLSearchResult|) ())"
   ...
   (DEFINE-FUNCTION-OBJECT "TEST-SERVER-GET-RELATION" "(DEFUN (TEST-SERVER-GET-RELATION |PLRelationContainer|) ())"
    (CL:FUNCTION TEST-SERVER-GET-RELATION) NULL)
   (DEFINE-FUNCTION-OBJECT "TEST-SERVER-GET-CONCEPT" "(DEFUN (TEST-SERVER-GET-CONCEPT |PLConceptContainer|) ())"
    (CL:FUNCTION TEST-SERVER-GET-CONCEPT) NULL)
   (DEFINE-FUNCTION-OBJECT "TEST-SERVER-GET-INSTANCE" "(DEFUN (TEST-SERVER-GET-INSTANCE |PLInstanceContainer|) ())"
   ...
   (DEFINE-FUNCTION-OBJECT "TEST-SERVER-DESTROY-OBJECT" "(DEFUN (TEST-SERVER-DESTROY-OBJECT |PLString|) ())"
    (CL:FUNCTION TEST-SERVER-DESTROY-OBJECT) NULL)))

(CL:DEFUN STARTUP-GUI-SERVER-API ()
  (CL:LET*
   ((*MODULE* (GET-STELLA-MODULE "/POWERLOOM-SERVER/GUI-SERVER" (> *STARTUP-TIME-PHASE* 1))) (*CONTEXT* *MODULE*))
   (CL:DECLARE (CL:SPECIAL *MODULE* *CONTEXT*))
   (CL:WHEN (CURRENT-STARTUP-TIME-PHASE? 2) (HELP-STARTUP-GUI-SERVER-API1))
   (CL:WHEN (CURRENT-STARTUP-TIME-PHASE? 4) (CL:SETQ *SERVER-DISPATCH-TABLE* (NEW-STRING-HASH-TABLE)))
   (CL:WHEN (CURRENT-STARTUP-TIME-PHASE? 6) (FINALIZE-CLASSES))
   (CL:WHEN (CURRENT-STARTUP-TIME-PHASE? 7) (HELP-STARTUP-GUI-SERVER-API2) (HELP-STARTUP-GUI-SERVER-API3)
    ...
    (DEFINE-FUNCTION-OBJECT "TEST-SERVER-GET-INFO" "(DEFUN (TEST-SERVER-GET-INFO |PLServerInfo|) ())"
     (CL:FUNCTION TEST-SERVER-GET-INFO) NULL)
    (DEFINE-FUNCTION-OBJECT "STARTUP-GUI-SERVER-API" "(DEFUN STARTUP-GUI-SERVER-API () :PUBLIC? TRUE)"
    ...
    (CL:LET* ((FUNCTION (LOOKUP-FUNCTION SYM-GUI-SERVER-API-GUI-SERVER-STARTUP-GUI-SERVER-API)))
     (SET-DYNAMIC-SLOT-VALUE (%DYNAMIC-SLOTS FUNCTION) SYM-GUI-SERVER-API-STELLA-METHOD-STARTUP-CLASSNAME
   ...
   (CL:WHEN (CURRENT-STARTUP-TIME-PHASE? 9) (%IN-MODULE (COPY-CONS-TREE (WRAP-STRING "GUI-SERVER")))
    ...
    (%SET-LOGGING-PARAMETERS "PL-Server"
     (CONS-LIST KWD-GUI-SERVER-API-LOG-LEVELS
      (GET-QUOTED-TREE "((:NONE :LOW :MEDIUM :HIGH) \"/POWERLOOM-SERVER/GUI-SERVER\")" "/POWERLOOM-SERVER/GUI-SERVER")
      KWD-GUI-SERVER-API-LEVEL
      (CL:IF (CL:EQ *POWERLOOM-EXECUTION-MODE* KWD-GUI-SERVER-API-DEVELOPMENT) KWD-GUI-SERVER-API-HIGH
       KWD-GUI-SERVER-API-LOW)
      KWD-GUI-SERVER-API-PREFIX (WRAP-STRING "PL-Server") KWD-GUI-SERVER-API-MAX-WIDTH (WRAP-INTEGER 2000)
