...
(CL:DECLAIM
  ...
  *LAZY-SATELLITE-RULES?* PLI::TAXONOMIC-ENV EOL-STRING *CONTEXT* TRUE-WRAPPER
  NULL-STRING-WRAPPER FALSE-WRAPPER NULL-INTEGER *KB-DIRECTORY*
  STANDARD-OUTPUT EOL *MODULE* *ROOT-MODULE* NIL))
  ...
  (CL:LET* ((HOMEMODULE (HOME-MODULE X)) (SURROGATE (OBJECT-SURROGATE X)))
   ...
   (CL:IF (CL:NOT (CL:EQ SURROGATE NULL))
    (CL:IF (CL:NOT (CL:EQ HOMEMODULE (%HOME-CONTEXT SURROGATE)))
     (CONCATENATE (%MODULE-NAME (%HOME-CONTEXT SURROGATE)) "/"
...
(CL:DEFUN GUI-NAME-TO-PL-NAME (NAME)
  ...
  (CL:IF (QUALIFIED-STELLA-NAME? NAME)
   (CL:LET*
    ((BARENAME STELLA::NULL-STRING) (MODULE STELLA::NULL-STRING) (TYPE NULL))
...
(CL:DEFUN SERVER-GET-INSTANCES-FOR-MODULE (PLSTRING)
  ...
  (CL:LET*
   ((MODULE (PLI::GET-MODULE (|%Value| PLSTRING) NULL))
    (ALLINSTANCES (ALL-INSTANCES MODULE CL:T)) (NONSKOLEMINSTANCES (NEW-LIST))
      ...
      (CL:IF (CL:EQ COLLECT-000 NULL)
       (CL:PROGN (CL:SETQ COLLECT-000 (CONS INSTANCE NIL))
        (CL:IF (CL:EQ (%THE-CONS-LIST NONSKOLEMINSTANCES) NIL)
         ...
         (ADD-CONS-TO-END-OF-CONS-LIST (%THE-CONS-LIST NONSKOLEMINSTANCES)
          COLLECT-000)))
       (CL:PROGN (CL:SETF (%%REST COLLECT-000) (CONS INSTANCE NIL))
        (CL:SETQ COLLECT-000 (%%REST COLLECT-000)))))))
   (CL:SETQ XMLINSTANCES (MAKE-PL-INSTANCES NONSKOLEMINSTANCES CL:T))
   (CL:SETQ XMLINSTANCES (SORT XMLINSTANCES (CL:FUNCTION |PLInstance<|)))
...
(CL:DEFUN SERVER-GET-INSTANCE-COMPLETIONS (PLMODULE PREFIX)
  ...
  (CL:LET*
   ((MODULE (PLI::GET-MODULE (|%Value| PLMODULE) NULL))
    (ALLINSTANCES (ALL-INSTANCES MODULE CL:NIL))
    (NONSKOLEMINSTANCES (NEW-LIST)) (RESULT (|new-PLInstanceContainer|))
    ...
    (CL:LOOP WHILE (NEXT? ITER-000) DO (CL:SETQ INSTANCE (%VALUE ITER-000))
     (CL:WHEN
      (CL:AND (CL:NOT (SKOLEM? INSTANCE))
       (STARTS-WITH? (GET-LOGIC-OBJECT-NAME INSTANCE "FALSE") DOWNCASEDPREFIX
        0))
      (CL:IF (CL:EQ COLLECT-000 NULL)
       (CL:PROGN (CL:SETQ COLLECT-000 (CONS INSTANCE NIL))
        (CL:IF (CL:EQ (%THE-CONS-LIST NONSKOLEMINSTANCES) NIL)
...
(CL:DEFUN SERVER-GET-RELATIONS-FOR-MODULE (PLSTRING)
  ...
  (CL:LET* ((MODULE (PLI::GET-MODULE (|%Value| PLSTRING) NULL)))
   (CL:LET* ((*MODULE* MODULE) (*CONTEXT* *MODULE*))
    (CL:DECLARE (CL:SPECIAL *MODULE* *CONTEXT*)) (GET-RELATIONS MODULE))))
  ...
  (CL:LET*
   ...
   (CL:LET* ((INSTANCE NULL) (ITER-000 ITER) (COLLECT-000 NULL))
    (CL:LOOP WHILE (NEXT? ITER-000) DO (CL:SETQ INSTANCE (%VALUE ITER-000))
     (CL:IF (CL:EQ COLLECT-000 NULL)
      (CL:PROGN (CL:SETQ COLLECT-000 (CONS INSTANCE NIL))
       (CL:IF (CL:EQ (%THE-CONS-LIST INSTANCES) NIL)
        (CL:SETF (%THE-CONS-LIST INSTANCES) COLLECT-000)
        (ADD-CONS-TO-END-OF-CONS-LIST (%THE-CONS-LIST INSTANCES)
         COLLECT-000)))
      (CL:PROGN (CL:SETF (%%REST COLLECT-000) (CONS INSTANCE NIL))
       (CL:SETQ COLLECT-000 (%%REST COLLECT-000))))))
...
(CL:DEFUN SERVER-GET-SOURCE-FOR-CONCEPT (MODULENAME CONCEPTNAME)
  ...
  (CL:LET*
   ((RESULT (|new-PLString|))
    (SOURCE
     (STRINGIFIED-SOURCE
      (PLI::S-GET-CONCEPT (GUI-NAME-TO-PL-NAME (|%Value| CONCEPTNAME))
       (|%Value| MODULENAME) NULL))))
   (CL:DECLARE (CL:TYPE CL:SIMPLE-STRING SOURCE))
   (CL:SETF (|%Value| RESULT) (XMLIFY-STRING SOURCE)) RESULT))
...
(CL:DEFUN SERVER-GET-SUPERRELATIONS-FOR-RELATION (MODULENAME RELATIONNAME)
  ...
  (CL:LET*
   ((RELATION
     (PLI::S-GET-RELATION (GUI-NAME-TO-PL-NAME (|%Value| RELATIONNAME))
      (|%Value| MODULENAME) NULL))
    (MODULE (PLI::GET-MODULE (|%Value| MODULENAME) NULL)))
...
(CL:DEFUN SERVER-GET-USES-FOR-MODULE (MODULENAME)
  ...
  (CL:LET* ((MODULE (PLI::GET-MODULE (|%Value| MODULENAME) NULL)))
   (CREATE-MODULE-COLLECTION (%USES MODULE))))
      ...
      (CL:LOOP WHILE (NEXT? ITER-000) DO
       ...
       (CL:IF (CL:EQ COLLECT-000 NULL)
        (CL:PROGN (CL:SETQ COLLECT-000 (CONS PROPOSITION NIL))
         (CL:IF (CL:EQ (%THE-CONS-LIST PROPOSITIONS) NIL)
          (CL:SETF (%THE-CONS-LIST PROPOSITIONS) COLLECT-000)
          (ADD-CONS-TO-END-OF-CONS-LIST (%THE-CONS-LIST PROPOSITIONS)
           COLLECT-000)))
...
(CL:DEFUN SERVER-GET-PROPOSITIONS-FOR-INSTANCE (MODULENAME INSTANCENAME)
  ...
  (CL:LET* ((MODULE (PLI::GET-MODULE (|%Value| MODULENAME) NULL)))
   (CL:LET* ((*MODULE* MODULE) (*CONTEXT* *MODULE*))
    ...
    (CL:LET*
     ((PROPOSITIONS
       (GET-PROPOSITIONS-FOR-OBJECT (|%Value| MODULENAME)
        (|%Value| INSTANCENAME) CL:NIL))
...
(CL:DEFUN SERVER-GET-TYPES-FOR-INSTANCE (MODULENAME INSTANCENAME)
  ...
  (CL:LET*
   ((MODULE (PLI::GET-MODULE (|%Value| MODULENAME) NULL))
    (INSTANCE
     (PLI::S-GET-OBJECT (GUI-NAME-TO-PL-NAME (|%Value| INSTANCENAME))
      (|%Value| MODULENAME) NULL))
...
(CL:DEFUN SERVER-GET-RULES-FOR-RELATION (MODULENAME INSTANCENAME)
  ...
  (CL:LET* ((MODULE (PLI::GET-MODULE (|%Value| MODULENAME) NULL)))
   (CL:LET* ((*MODULE* MODULE) (*CONTEXT* *MODULE*))
    ...
    (CL:LET*
     ((PROPOSITIONS
       (GET-RELEVANT-RULES-FOR-RELATION (|%Value| MODULENAME)
        (|%Value| INSTANCENAME)))
      (XMLINSTANCES (NEW-LIST)) (RESULT (|new-PLPropositionContainer|)))
...
(CL:DEFUN SERVER-GET-PROPOSITIONS-FOR-INSTANCE-AND-RELATION (MODULENAME INSTANCENAME RELATIONNAME)
  ...
  (CL:LET* ((MODULE (PLI::GET-MODULE (|%Value| MODULENAME) NULL)))
   (CL:LET* ((*MODULE* MODULE) (*CONTEXT* *MODULE*))
    ...
    (CL:LET*
     ((PROPOSITIONS
       (GET-PROPOSITIONS-FOR-INSTANCE-AND-RELATION (|%Value| MODULENAME)
        (|%Value| INSTANCENAME) (|%Value| RELATIONNAME)))
      (XMLINSTANCES (NEW-LIST)) (RESULT (|new-PLPropositionContainer|)))
     (CL:SETQ XMLINSTANCES (MAKE-PL-PROPOSITIONS PROPOSITIONS MODULE CL:NIL))
     (CL:SETF (|%PLProposition| RESULT) XMLINSTANCES) RESULT))))
...
(CL:DEFUN SERVER-EVALUATE-LOGIC-COMMAND (MODULENAME COMMANDSTRING)
  ...
  (CL:LET*
   ((COMMAND (|%Value| COMMANDSTRING)) (MODULE (|%Value| MODULENAME))
...
(CL:DEFUN SERVER-GET-LOADABLE-KBS ()
  (CL:LET*
   ((FILEDESCRIPTIONS (LOAD-INDEX-FILE)) (RESULT (|new-PLModuleFileList|))
    (PLFILES (NEW-LIST)))
   (CL:LET* ((DESC NULL) (ITER-000 FILEDESCRIPTIONS))
    (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-000 NIL)) DO
     (CL:SETQ DESC (%%VALUE ITER-000)) (INSERT PLFILES (MAKE-PL-FILE DESC))
...
(CL:DEFUN SERVER-LOAD-KB (PLKBNAME)
  ...
  (CL:LET*
   ...
   (%%PRINT-STREAM (%NATIVE-STREAM STANDARD-OUTPUT) "fileName is:" FILENAME
    EOL)
   (CL:IF (CL:NOT (CL:EQ FILENAME STELLA::NULL-STRING))
    (CL:PROGN
     (%%PRINT-STREAM (%NATIVE-STREAM STANDARD-OUTPUT) "Loading KB: " FILENAME
      EOL)
     (%LOAD FILENAME NIL) (CL:SETF (|%Value| RESULT) "OK"))
    (CL:PROGN
...
(CL:DEFUN SERVER-LOAD-KB2 (FILE)
  (CL:LET*
   ((FILENAME (|%FileName| FILE)) (CONTENT (|%PLFileContent| FILE))
    (RESULT (|new-PLString|)))
   (CL:DECLARE (CL:TYPE CL:SIMPLE-STRING FILENAME))
   (CL:COND
    ((CL:AND (CL:NOT (CL:EQ CONTENT NULL))
      (CL:NOT (CL:EQ (|%textContent| CONTENT) STELLA::NULL-STRING)))
     (LOAD-STREAM (NEW-INPUT-STRING-STREAM (|%textContent| CONTENT)))
     (CL:SETF (|%Value| RESULT)
      (EXTRACT-MODULE-NAME-FROM-STREAM
       (NEW-INPUT-STRING-STREAM (|%textContent| CONTENT)))))
...
(CL:DEFUN SERVER-SAVE-KB (PLMODULENAME PLKBNAME PLDESCRIPTION)
  (CL:LET*
   ((KBNAME (|%Value| PLKBNAME)) (MODULENAME (|%Value| PLMODULENAME))
    (MODULE (PLI::GET-MODULE MODULENAME NULL))
    (DESCRIPTION (|%Value| PLDESCRIPTION)) (RAWFILEINDEX (LOAD-INDEX-FILE))
   ...
   (CL:IF (CL:NOT (CL:EQ FILENAME STELLA::NULL-STRING))
    (CL:PROGN
     (%%PRINT-STREAM (%NATIVE-STREAM STANDARD-OUTPUT) "Saving KB: " MODULENAME
      " to " FILENAME EOL)
       ...
       (CONS
        (CONS (WRAP-STRING KBNAME)
         (CONS (WRAP-STRING MODULENAME)
          (CONS (WRAP-STRING NEWFILE) (CONS (WRAP-STRING DESCRIPTION) NIL))))
        RAWFILEINDEX)))
     (CL:DECLARE (CL:TYPE CL:SIMPLE-STRING NEWFILE))
     (SAVE-INDEX-FILE NEWINDEX)
     (%%PRINT-STREAM (%NATIVE-STREAM STANDARD-OUTPUT) "Saving new KB: "
      MODULENAME " to " NEWFILE EOL)
     (CL:LET* ((STREAM (NEW-OUTPUT-FILE-STREAM NEWFILE)))
      (DO-SAVE-MODULE MODULE STREAM) (FREE STREAM))
     (%%PRINT-STREAM (%NATIVE-STREAM STANDARD-OUTPUT) "new index: " NEWINDEX
      EOL)))
...
(CL:DEFUN SERVER-SAVE-KB2 (PLMODULENAME PLFILENAME)
  (CL:LET*
   ((MODULENAME (|%Value| PLMODULENAME))
    (MODULE (PLI::GET-MODULE MODULENAME NULL))
    (FILENAME (|%Value| PLFILENAME)) (STREAM (NEW-OUTPUT-STRING-STREAM))
    (RESULT (|new-PLFile|)))
   ...
   (CL:LET* ((SELF-002 (|new-PLFileContent|)))
    (CL:SETF (|%textContent| SELF-002) (THE-STRING-READER STREAM))
...
(CL:DEFUN SERVER-CLEAR-KB (MODULE)
  (CL:LET* ((MODNAME (|%ModuleName| MODULE)) (RESULT (|new-PLString|)))
...
(CL:DEFUN SERVER-QUERY (PLQUERY CONTINUEQUERY?)
  (CL:LET*
   ((CONTINUE? (STRING-EQL? (|%Value| CONTINUEQUERY?) "TRUE"))
    (SESSION (GET-QUERY-SESSION PLQUERY CONTINUE?))
    (RESULT (|new-PLQueryResult|)) (PLTUPLES (NEW-LIST))
    (QUERY STELLA::NULL-STRING) (MODULENAME (|%Module| PLQUERY))
   ...
   (CL:SETQ QUERYRESULT
    (EVALUATE-QUERY-COMMAND-IN-MODULE SESSION QUERY MODULENAME CONTINUE?
     (IS-QUERY-PARTIAL? PLQUERY)))
   (CL:LET* ((*MODULE* MODULE) (*CONTEXT* *MODULE*))
    (CL:DECLARE (CL:SPECIAL *MODULE* *CONTEXT*))
     ...
     (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-000 NIL)) DO
      ...
      (CL:IF (CL:EQ COLLECT-000 NULL)
       (CL:PROGN (CL:SETQ COLLECT-000 (CONS (MAKE-PL-TUPLE TUPLE) NIL))
        (CL:IF (CL:EQ (%THE-CONS-LIST PLTUPLES) NIL)
         (CL:SETF (%THE-CONS-LIST PLTUPLES) COLLECT-000)
         (ADD-CONS-TO-END-OF-CONS-LIST (%THE-CONS-LIST PLTUPLES)
          COLLECT-000)))
       (CL:PROGN
...
(CL:DEFUN SERVER-SEARCH (SEARCHPARAMETER)
  (CL:LET*
   ((MODULENAME (|%ModuleName| SEARCHPARAMETER))
   ...
   (CL:IF (STRING-EQL? MODULENAME "ALL")
    ...
    (CL:SETQ SEARCHRESULTS
     (SEARCH-MODULE MODULENAME SEARCHSTRING SEARCHINSTANCE? SEARCHCONCEPT?
      SEARCHRELATION? CASESENSITIVE?)))
     ...
     ((RESULT (|new-PLQueryResult|)) (PLTUPLES (NEW-LIST))
      (EXTENSION
       (PLI::S-GET-RELATION-EXTENSION
        (GUI-NAME-TO-PL-NAME (|%Value| RELATIONNAME)) MODULE NULL)))
...
(CL:DEFUN SERVER-GET-EXPLANATION-FOR-QUERY (QUERY RESULTNUMBER)
  (CL:LET*
   ((SESSION (GET-QUERY-SESSION QUERY CL:T))
    ...
    (SOLUTIONINDEX (CL:1- (STRING-TO-INTEGER (|%Value| RESULTNUMBER))))
    (JUSTIFICATIONS NULL) (EXPLANATION "No explanation available.")
    (RESULT (|new-PLString|)) (MODULENAME (|%Module| QUERY))
    (MODULE (PLI::GET-MODULE MODULENAME NULL)))
   (CL:DECLARE (CL:TYPE CL:SIMPLE-STRING EXPLANATION MODULENAME))
   (CL:LET* ((*MODULE* MODULE) (*CONTEXT* *MODULE*))
    (CL:DECLARE (CL:SPECIAL *MODULE* *CONTEXT*))
    (CL:SETQ JUSTIFICATIONS
     (GET-QUERY-JUSTIFICATIONS QUERYITERATOR (CL:TRUNCATE SOLUTIONINDEX)
      NULL-INTEGER CL:T))
    (CL:WHEN (CL:> (LENGTH JUSTIFICATIONS) 0)
     (CL:SETQ EXPLANATION (GET-JUSTIFICATION-STRING (FIRST JUSTIFICATIONS))))
...
(CL:DEFUN SERVER-GET-INFO ()
  ...
  (CL:LET* ((RESULT (|new-PLServerInfo|)))
   (CL:IF *ALLOW-REMOTE-FILEBROWSING*
    (CL:SETF (|%AllowRemoteFileBrowsing| RESULT) "TRUE")
...
(CL:DEFUN EXTRACT-MODULE-NAME-FROM-STREAM (STREAM)
  (CL:LET*
   ...
   (CL:LOOP WHILE (CL:AND (NEXT? ITER-000) (CL:<= ITER-001 UPPER-BOUND-000))
    DO (CL:SETQ TREE (%VALUE ITER-000)) (CL:SETQ I ITER-001) (CL:SETQ I I)
    (CL:COND
...
(CL:DEFUN CREATE-QUERY-STRING (PLQUERY)
  (CL:LET*
   ((RESULT "") (QUERYBODY STELLA::NULL-STRING) (HOWMANYCLAUSE "")
    ...
    (MATCHMODECLAUSE "") (TIMEOUTCLAUSE "") (COMMANDCLAUSE "")
    (MOVEOUTCLAUSE "") (MAXIMIZESCORECLAUSE "") (DONTOPTIMIZECLAUSE ""))
   (CL:DECLARE
    (CL:TYPE CL:SIMPLE-STRING RESULT QUERYBODY HOWMANYCLAUSE
     INFERENCELEVELCLAUSE MINSCORECLAUSE MAXUNKNOWNSCLAUSE MATCHMODECLAUSE
     TIMEOUTCLAUSE COMMANDCLAUSE MOVEOUTCLAUSE MAXIMIZESCORECLAUSE
     DONTOPTIMIZECLAUSE))
   (CL:WHEN
    (CL:AND (CL:NOT (CL:EQ (|%NumResults| PLQUERY) STELLA::NULL-STRING))
     (CL:>
      (CL:THE CL:FIXNUM
       (CL:LENGTH (CL:THE CL:SIMPLE-STRING (|%NumResults| PLQUERY))))
      0)
     (CL:NOT (STRING-EQL? (|%NumResults| PLQUERY) "ALL")))
    (CL:SETQ HOWMANYCLAUSE
     (CONCATENATE " :HOW-MANY " (|%NumResults| PLQUERY))))
   (CL:WHEN
    (CL:AND (CL:NOT (CL:EQ (|%Timeout| PLQUERY) STELLA::NULL-STRING))
     (CL:>
      (CL:THE CL:FIXNUM
       (CL:LENGTH (CL:THE CL:SIMPLE-STRING (|%Timeout| PLQUERY))))
      0))
   ...
   (CL:WHEN
    (CL:AND (CL:NOT (CL:EQ (|%Moveout| PLQUERY) STELLA::NULL-STRING))
     (CL:>
      (CL:THE CL:FIXNUM
       (CL:LENGTH (CL:THE CL:SIMPLE-STRING (|%Moveout| PLQUERY))))
      0))
   ...
   (CL:WHEN
    (CL:AND (CL:NOT (CL:EQ (|%MinScore| PLQUERY) STELLA::NULL-STRING))
     (CL:>
      (CL:THE CL:FIXNUM
       (CL:LENGTH (CL:THE CL:SIMPLE-STRING (|%MinScore| PLQUERY))))
      0))
    (CL:SETQ MINSCORECLAUSE
     (CONCATENATE " :MINIMUM-SCORE " (|%MinScore| PLQUERY))))
   (CL:WHEN
    (CL:AND (CL:NOT (CL:EQ (|%MaximizeScore| PLQUERY) STELLA::NULL-STRING))
     (CL:>
      (CL:THE CL:FIXNUM
       (CL:LENGTH (CL:THE CL:SIMPLE-STRING (|%MaximizeScore| PLQUERY))))
      0))
    (CL:SETQ MAXIMIZESCORECLAUSE
     (CONCATENATE " :MAXIMIZE-SCORE? " (|%MaximizeScore| PLQUERY))))
   (CL:WHEN
    (CL:AND (CL:NOT (CL:EQ (|%DontOptimize| PLQUERY) STELLA::NULL-STRING))
     (CL:>
      (CL:THE CL:FIXNUM
       (CL:LENGTH (CL:THE CL:SIMPLE-STRING (|%DontOptimize| PLQUERY))))
      0))
    (CL:SETQ DONTOPTIMIZECLAUSE
     (CONCATENATE " :DONT-OPTIMIZE? " (|%DontOptimize| PLQUERY))))
   (CL:WHEN
    (CL:AND (CL:NOT (CL:EQ (|%MaxUnknowns| PLQUERY) STELLA::NULL-STRING))
     (CL:>
      (CL:THE CL:FIXNUM
       (CL:LENGTH (CL:THE CL:SIMPLE-STRING (|%MaxUnknowns| PLQUERY))))
      0))
    (CL:SETQ MAXUNKNOWNSCLAUSE
     (CONCATENATE " :MAXIMUM-UNKNOWNS " (|%MaxUnknowns| PLQUERY))))
   (CL:WHEN
    (CL:AND (CL:NOT (CL:EQ (|%MatchMode| PLQUERY) STELLA::NULL-STRING))
     (CL:>
      (CL:THE CL:FIXNUM
       (CL:LENGTH (CL:THE CL:SIMPLE-STRING (|%MatchMode| PLQUERY))))
      0))
    (CL:SETQ MATCHMODECLAUSE
     (CONCATENATE " :MATCH-MODE :" (|%MatchMode| PLQUERY))))
   (CL:WHEN
    (CL:AND (CL:NOT (CL:EQ (|%InferenceLevel| PLQUERY) STELLA::NULL-STRING))
     (CL:>
      (CL:THE CL:FIXNUM
       (CL:LENGTH (CL:THE CL:SIMPLE-STRING (|%InferenceLevel| PLQUERY))))
      0))
    (CL:SETQ INFERENCELEVELCLAUSE
     (CONCATENATE " :INFERENCE-LEVEL :" (|%InferenceLevel| PLQUERY))))
   (CL:IF
    (CL:AND (CL:NOT (CL:EQ (|%IsAsk| PLQUERY) STELLA::NULL-STRING))
     (STRING-EQL? (|%IsAsk| PLQUERY) "TRUE"))
    (CL:SETQ COMMANDCLAUSE "/LOGIC/ASK ")
    (CL:SETQ COMMANDCLAUSE "/LOGIC/RETRIEVE "))
   (CL:SETQ QUERYBODY
    (CONCATENATE (|%NumResults| PLQUERY) " " (|%Query| PLQUERY)))
   (CL:SETQ RESULT
    (CONCATENATE "(" COMMANDCLAUSE QUERYBODY HOWMANYCLAUSE TIMEOUTCLAUSE
     MOVEOUTCLAUSE MINSCORECLAUSE MAXIMIZESCORECLAUSE DONTOPTIMIZECLAUSE
     MAXUNKNOWNSCLAUSE MATCHMODECLAUSE INFERENCELEVELCLAUSE ")"))
   RESULT))

;;; (DEFUN (CREATE-FOLLOWUP-QUERY-STRING STRING) ...)

(CL:DECLAIM
 (CL:FTYPE (CL:FUNCTION (CL:T) CL:SIMPLE-STRING) CREATE-FOLLOWUP-QUERY-STRING))
(CL:DEFUN CREATE-FOLLOWUP-QUERY-STRING (PLQUERY)
  (CL:LET*
   ((RESULT "") (QUERYBODY STELLA::NULL-STRING)
    (COMMANDCLAUSE STELLA::NULL-STRING))
   (CL:DECLARE (CL:TYPE CL:SIMPLE-STRING RESULT QUERYBODY COMMANDCLAUSE))
   (CL:SETQ COMMANDCLAUSE "/LOGIC/RETRIEVE ")
...
(CL:DEFUN MAKE-PL-TUPLE-FROM-PROPOSITION (PROPOSITION)
  (CL:LET*
   ((ARGUMENTS (%ARGUMENTS PROPOSITION)) (PLOBJECTUNIONS (NEW-LIST))
    (RESULT (|new-PLTuple|)))
   (CL:LET*
    ...
    (CL:LOOP WHILE (CL:< INDEX-000 LENGTH-000) DO
     ...
     (CL:IF (CL:EQ COLLECT-000 NULL)
      (CL:PROGN
       ...
       (CL:IF (CL:EQ (%THE-CONS-LIST PLOBJECTUNIONS) NIL)
        (CL:SETF (%THE-CONS-LIST PLOBJECTUNIONS) COLLECT-000)
        (ADD-CONS-TO-END-OF-CONS-LIST (%THE-CONS-LIST PLOBJECTUNIONS)
         COLLECT-000)))
      (CL:PROGN
       (CL:SETF (%%REST COLLECT-000)
      ...
      (CL:PROGN (CL:SETQ COLLECT-000 (CONS (MAKE-PL-OBJECT-UNION OBJECT) NIL))
       (CL:IF (CL:EQ (%THE-CONS-LIST PLOBJECTUNIONS) NIL)
        ...
        (ADD-CONS-TO-END-OF-CONS-LIST (%THE-CONS-LIST PLOBJECTUNIONS)
         COLLECT-000)))
      (CL:PROGN
       (CL:SETF (%%REST COLLECT-000) (CONS (MAKE-PL-OBJECT-UNION OBJECT) NIL))
       (CL:SETQ COLLECT-000 (%%REST COLLECT-000))))
     (CL:SETQ ITER-000 (%%REST ITER-000))))
   (CL:SETF (|%PLObjectUnion| RESULT) PLOBJECTUNIONS) RESULT))
...
(CL:DEFUN MAKE-PL-OBJECT-UNION (OBJECT)
  (CL:LET* ((RESULT (|new-PLObjectUnion|)))
   (CL:SETF (|%LiteralValue| RESULT) "") (CL:SETF (|%Type| RESULT) "")
   (CL:WHEN (CL:EQ OBJECT NULL) (CL:SETF (|%LiteralValue| RESULT) "")
    (CL:SETF (|%Type| RESULT) "STRING")
    (CL:RETURN-FROM MAKE-PL-OBJECT-UNION RESULT))
   (CL:WHEN
    (CL:AND (SKOLEM? OBJECT)
     (CL:NOT
      (CL:EQ
       (ACCESS-IN-CONTEXT (%VARIABLE-VALUE OBJECT) (%HOME-CONTEXT OBJECT)
        CL:NIL)
       NULL)))
    (CL:SETQ OBJECT
     (ACCESS-IN-CONTEXT (%VARIABLE-VALUE OBJECT) (%HOME-CONTEXT OBJECT)
   ...
   (CL:LET* ((TEST-VALUE-000 (SAFE-PRIMARY-TYPE OBJECT)))
    (CL:COND
     ((SUBTYPE-OF-INTEGER? TEST-VALUE-000)
      (CL:PROGN
       (CL:SETF (|%LiteralValue| RESULT)
        (STRINGIFY (WRAP-INTEGER (%WRAPPER-VALUE OBJECT))))
       (CL:SETF (|%Type| RESULT) "INTEGER")))
     ((SUBTYPE-OF-FLOAT? TEST-VALUE-000)
      (CL:PROGN
       (CL:SETF (|%LiteralValue| RESULT)
        (STRINGIFY (WRAP-FLOAT (%WRAPPER-VALUE OBJECT))))
       (CL:SETF (|%Type| RESULT) "FLOAT")))
     ((SUBTYPE-OF-STRING? TEST-VALUE-000)
      (CL:PROGN (CL:SETF (|%LiteralValue| RESULT) (%WRAPPER-VALUE OBJECT))
       (CL:SETF (|%Type| RESULT) "STRING")))
     ((SUBTYPE-OF? TEST-VALUE-000 SGT-GUI-SERVER-API-LOGIC-TRUTH-VALUE)
      (CL:PROGN
       (CL:SETF (|%LiteralValue| RESULT) (GET-TRUTH-VALUE-STRING OBJECT))
       (CL:SETF (|%Type| RESULT) "TRUTH-VALUE")))
     ((SUBTYPE-OF? TEST-VALUE-000 SGT-GUI-SERVER-API-LOGIC-NAMED-DESCRIPTION)
      (CL:PROGN
       (CL:SETF (|%PLSurrogate| RESULT) (MAKE-LOGIC-SURROGATE OBJECT))
       (CL:IF (CLASS? OBJECT) (CL:SETF (|%Type| RESULT) "CONCEPT")
        (CL:SETF (|%Type| RESULT) "RELATION"))))
     ((SUBTYPE-OF? TEST-VALUE-000 SGT-GUI-SERVER-API-LOGIC-SKOLEM)
      (CL:PROGN
       (CL:SETF (|%PLSurrogate| RESULT) (MAKE-LOGIC-SURROGATE OBJECT))
       (CL:SETF (|%Type| RESULT) "INSTANCE")))
      ...
      (CL:IF
       ...
       (CL:SETF (|%JavaCatchallClass| PLMODULE)
        (%WRAPPER-VALUE
         (DYNAMIC-SLOT-VALUE (%DYNAMIC-SLOTS MODULE)
          SYM-GUI-SERVER-API-STELLA-JAVA-FLOTSAM-CLASS NULL-STRING-WRAPPER))))
      (CL:IF (CL:EQ (%DOCUMENTATION MODULE) STELLA::NULL-STRING)
       (CL:SETF (|%Documentation| PLMODULE) "")
       (CL:SETF (|%Documentation| PLMODULE)
        (XMLIFY-STRING (%DOCUMENTATION MODULE))))
      (CL:IF (%CASE-SENSITIVE? MODULE)
       (CL:SETF (|%CaseSensitive| PLMODULE) "TRUE")
      ...
      (CL:LET* ((CHILD NULL) (ITER-001 CHILDMODULEITER) (COLLECT-000 NULL))
       (CL:LOOP WHILE (NEXT? ITER-001) DO (CL:SETQ CHILD (%VALUE ITER-001))
        (CL:WHEN (CL:NOT (CODE-MODULE? CHILD))
         (CL:IF (CL:EQ COLLECT-000 NULL)
          (CL:PROGN
           (CL:SETQ COLLECT-000 (CONS (MAKE-MODULE-SURROGATE CHILD) NIL))
           (CL:IF (CL:EQ (%THE-CONS-LIST SURROGATECHILDREN) NIL)
            (CL:SETF (%THE-CONS-LIST SURROGATECHILDREN) COLLECT-000)
            (ADD-CONS-TO-END-OF-CONS-LIST (%THE-CONS-LIST SURROGATECHILDREN)
             COLLECT-000)))
          (CL:PROGN
           (CL:SETF (%%REST COLLECT-000)
            (CONS (MAKE-MODULE-SURROGATE CHILD) NIL))
           (CL:SETQ COLLECT-000 (%%REST COLLECT-000)))))))
      (CL:SETF (|%PLSurrogate| PLMODULE) SURROGATECHILDREN)
...
(CL:DEFUN GET-STELLA-LITERAL-CONCEPTS ()
  (CL:LET*
   ((COLLECTEDCONCEPTS (NEW-LIST))
    (TOPCONCEPT
     (GET-DESCRIPTION (%SURROGATE-VALUE SGT-GUI-SERVER-API-STELLA-LITERAL)))
...
(CL:DEFUN GET-CONCEPTS-WITH-PREFIX (MODULE PREFIX)
  ...
  (CL:LET*
   ((ALLCONCEPTS (GET-ALL-CONCEPTS-WITH-PREFIX MODULE CL:NIL PREFIX))
    (RESULT NULL))
   (CL:SETQ RESULT (CREATE-CONCEPT-CONTAINER ALLCONCEPTS MODULE CL:NIL))
   RESULT))
    ...
    (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-000 NIL)) DO
     ...
     (CL:LET*
      ((PLCONCEPT (|new-PLConcept|))
       ...
       (SURROGATECHILDREN (NEW-LIST)))
      (CL:SETF (|%ConceptName| PLCONCEPT)
       (XMLIFY-STRING (PL-OBJECT-TO-GUI-NAME CONCEPT)))
      (CL:SETF (|%Module| PLCONCEPT)
       (%MODULE-FULL-NAME (HOME-MODULE CONCEPT)))
       ...
       (CL:LET* ((CHILD NULL) (ITER-001 CHILDCONCEPTITER) (COLLECT-000 NULL))
        (CL:LOOP WHILE (NEXT? ITER-001) DO (CL:SETQ CHILD (%VALUE ITER-001))
         (CL:WHEN
          ...
          (CL:IF (CL:EQ COLLECT-000 NULL)
           (CL:PROGN
            (CL:SETQ COLLECT-000 (CONS (MAKE-LOGIC-SURROGATE CHILD) NIL))
            (CL:IF (CL:EQ (%THE-CONS-LIST SURROGATECHILDREN) NIL)
             (CL:SETF (%THE-CONS-LIST SURROGATECHILDREN) COLLECT-000)
             (ADD-CONS-TO-END-OF-CONS-LIST (%THE-CONS-LIST SURROGATECHILDREN)
              COLLECT-000)))
      ...
      (CL:SETF (|%PLSurrogate| PLCONCEPT) SURROGATECHILDREN)
      (INSERT PLCONCEPTS PLCONCEPT))
     (CL:SETQ ITER-000 (%%REST ITER-000))))
   (CL:SETQ PLCONCEPTS (SORT PLCONCEPTS (CL:FUNCTION |PLConcept<|)))
   (CL:SETF (|%PLConcept| CONTAINER) PLCONCEPTS) CONTAINER))
...
(CL:DEFUN GET-RELATIONS-WITH-PREFIX (MODULE PREFIX)
  ...
  (CL:LET*
   ((ALLRELATIONS (GET-ALL-RELATIONS-WITH-PREFIX MODULE CL:NIL PREFIX))
    (RESULT NULL))
   (CL:SETQ RESULT (CREATE-RELATION-CONTAINER ALLRELATIONS MODULE CL:NIL))
   RESULT))
   ...
   (CL:LET* ((RELATION NULL) (ITER-000 (%THE-CONS-LIST COLLECTEDRELATIONS)))
    (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-000 NIL)) DO
     ...
     (CL:LET*
      ...
      (CL:SETF (|%RelationName| PLRELATION)
       (XMLIFY-STRING (PL-OBJECT-TO-GUI-NAME RELATION)))
      (CL:SETF (|%Module| PLRELATION)
       (%MODULE-FULL-NAME (HOME-MODULE RELATION)))
      ...
      (CL:SETQ SURROGATECHILDREN
       (SORT SURROGATECHILDREN (CL:FUNCTION |PLSurrogate<|)))
      (CL:SETF (|%PLSurrogate| PLRELATION) SURROGATECHILDREN)
      (INSERT PLRELATIONS PLRELATION))
     (CL:SETQ ITER-000 (%%REST ITER-000))))
   (CL:SETQ PLRELATIONS (SORT PLRELATIONS (CL:FUNCTION |PLRelation<|)))
   (CL:SETF (|%PLRelation| CONTAINER) PLRELATIONS) CONTAINER))
...
(CL:DEFUN CREATE-MODULE-COLLECTION (MODULES)
  (CL:LET*
   ...
   (CL:LET*
    ((MODULE NULL) (ITER-000 (%THE-CONS-LIST MODULES)) (COLLECT-000 NULL))
    (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-000 NIL)) DO
     (CL:SETQ MODULE (%%VALUE ITER-000))
     (CL:IF (CL:EQ COLLECT-000 NULL)
      (CL:PROGN
   ...
   (CL:SETQ SURROGATECHILDREN
    (SORT SURROGATECHILDREN (CL:FUNCTION |PLSurrogate<|)))
   (CL:SETF (|%PLSurrogate| PLSURROGATECOLLECTION) SURROGATECHILDREN)
...
(CL:DEFUN CREATE-SURROGATE-COLLECTION (SURROGATES)
  (CL:LET*
   ((SURROGATECHILDREN (NEW-LIST))
    (PLSURROGATECOLLECTION (|new-PLSurrogateCollection|)))
   (CL:LET*
    ((SURROGATE NULL) (ITER-000 (%THE-CONS-LIST SURROGATES))
     (COLLECT-000 NULL))
    (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-000 NIL)) DO
     (CL:SETQ SURROGATE (%%VALUE ITER-000))
     (CL:IF (CL:EQ COLLECT-000 NULL)
      (CL:PROGN
       (CL:SETQ COLLECT-000 (CONS (MAKE-SURROGATE-SURROGATE SURROGATE) NIL))
       (CL:IF (CL:EQ (%THE-CONS-LIST SURROGATECHILDREN) NIL)
        (CL:SETF (%THE-CONS-LIST SURROGATECHILDREN) COLLECT-000)
        (ADD-CONS-TO-END-OF-CONS-LIST (%THE-CONS-LIST SURROGATECHILDREN)
         COLLECT-000)))
...
(CL:DEFUN CREATE-SURROGATE-COLLECTION-FOR-LOGIC-OBJECT (RELATIONS)
  (CL:LET*
   ((SURROGATECHILDREN (NEW-LIST))
    (PLSURROGATECOLLECTION (|new-PLSurrogateCollection|)))
   (CL:LET*
    ((RELATION NULL) (ITER-000 (%THE-CONS-LIST RELATIONS)) (COLLECT-000 NULL))
    (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-000 NIL)) DO
     (CL:SETQ RELATION (%%VALUE ITER-000))
     (CL:IF (CL:EQ COLLECT-000 NULL)
      (CL:PROGN
     ...
     (CL:PROGN
      (CL:LET*
       ((VARIABLENAME NULL)
        ...
        (VARIABLETYPE NULL)
        (ITER-001 (%THE-CONS-LIST (%IO-VARIABLE-TYPES RELATION)))
        (COLLECT-000 NULL))
       (CL:LOOP WHILE
        ...
        (CL:IF (CL:EQ COLLECT-000 NULL)
         (CL:PROGN
          (CL:SETQ COLLECT-000
           (CONS (MAKE-PL-VARIABLE (%SYMBOL-NAME VARIABLENAME) VARIABLETYPE)
            NIL))
          (CL:IF (CL:EQ (%THE-CONS-LIST VARIABLES) NIL)
           (CL:SETF (%THE-CONS-LIST VARIABLES) COLLECT-000)
           (ADD-CONS-TO-END-OF-CONS-LIST (%THE-CONS-LIST VARIABLES)
            COLLECT-000)))
         (CL:PROGN
          (CL:SETF (%%REST COLLECT-000)
           (CONS (MAKE-PL-VARIABLE (%SYMBOL-NAME VARIABLENAME) VARIABLETYPE)
...
(CL:DEFUN MAKE-PL-VARIABLE (VARIABLENAME VARIABLETYPE)
  ...
  (CL:LET*
   ...
   (CL:SETF (|%Value| PLVARIABLENAME) VARIABLENAME)
   (CL:SETF (%ID PLVARIABLETYPE) (%SYMBOL-NAME VARIABLETYPE))
   (CL:SETF (|%VariableName| RESULT) PLVARIABLENAME)
   (CL:SETF (|%VariableType| RESULT) PLVARIABLETYPE) RESULT))
...
(CL:DEFUN MAKE-PL-RELATION (RELATION MODULENAME)
  ...
  (CL:LET* ((XMLRELATION (|new-PLRelation|)))
   ...
   (CL:SETF (|%RelationName| XMLRELATION)
    (XMLIFY-STRING (PL-OBJECT-TO-GUI-NAME RELATION)))
   XMLRELATION))
...
(CL:DEFUN MAKE-PL-CONCEPT (CONCEPT)
  (CL:LET* ((XMLCONCEPT (|new-PLConcept|)))
   (CL:SETF (|%Module| XMLCONCEPT) (%MODULE-FULL-NAME (HOME-MODULE CONCEPT)))
   (CL:SETF (|%SourceString| XMLCONCEPT) "")
   (CL:SETF (|%ConceptName| XMLCONCEPT)
    (XMLIFY-STRING (PL-OBJECT-TO-GUI-NAME CONCEPT)))
   XMLCONCEPT))
  ...
  (CL:LET* ((RESULT (NEW-LIST)))
   (CL:LET*
    ...
    (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-000 NIL)) DO
     ...
     (CL:IF (CL:EQ COLLECT-000 NULL)
      (CL:PROGN
       (CL:SETQ COLLECT-000 (CONS (MAKE-PL-RELATION RELATION MODULENAME) NIL))
...
(CL:DEFUN MAKE-MODULE-SURROGATE (MODULE)
  (CL:LET* ((RESULT (|new-PLSurrogate|)))
   (CL:SETF (%ID RESULT) (%MODULE-NAME MODULE)) RESULT))

;;; (DEFUN (MAKE-SURROGATE-SURROGATE |PLSurrogate|) ...)

(CL:DEFUN MAKE-SURROGATE-SURROGATE (SURROGATE)
  (CL:LET* ((RESULT (|new-PLSurrogate|)))
   (CL:SETF (%ID RESULT) (XMLIFY-STRING (PL-OBJECT-TO-GUI-NAME SURROGATE)))
   RESULT))
   ...
   (CL:WHEN (SKOLEM? OBJ)
    (CL:LET*
     ...
     (CL:LET* ((*PRINTREADABLY?* CL:T) (*PRINTPRETTY?* CL:T))
      ...
      (CL:SETQ PRINTNAME (XMLIFY-STRING (THE-STRING-READER RESULTSTREAM))))
     (CL:SETF (%ID RESULT) PRINTNAME)
...
(CL:DEFUN MAKE-PL-INSTANCE (INSTANCE)
  (CL:LET* ((XMLINSTANCE (|new-PLInstance|)))
   (CL:SETF (|%InstanceName| XMLINSTANCE)
    (XMLIFY-STRING (PL-OBJECT-TO-GUI-NAME INSTANCE)))
   (CL:IF (CL:NOT (CL:EQ (HOME-MODULE INSTANCE) NULL))
    (CL:SETF (|%Module| XMLINSTANCE)
     (%MODULE-FULL-NAME (HOME-MODULE INSTANCE)))
    (CL:SETF (|%Module| XMLINSTANCE) ""))
   (CL:SETF (|%SourceString| XMLINSTANCE)
    (CONCATENATE "(DEFOBJECT " (|%InstanceName| XMLINSTANCE) ")"))
   XMLINSTANCE))
...
(CL:DEFUN MAKE-PL-INSTANCES (INSTANCES SKIPUNINTERNEDINSTANCES?)
  (CL:LET* ((RESULT (NEW-LIST)))
   (CL:LET*
    ((INSTANCE NULL) (ITER-000 (%THE-CONS-LIST INSTANCES)) (COLLECT-000 NULL))
    (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-000 NIL)) DO
      ...
      (CL:IF (CL:EQ COLLECT-000 NULL)
       (CL:PROGN (CL:SETQ COLLECT-000 (CONS (MAKE-PL-INSTANCE INSTANCE) NIL))
        (CL:IF (CL:EQ (%THE-CONS-LIST RESULT) NIL)
         ...
         (ADD-CONS-TO-END-OF-CONS-LIST (%THE-CONS-LIST RESULT) COLLECT-000)))
       (CL:PROGN
        (CL:SETF (%%REST COLLECT-000) (CONS (MAKE-PL-INSTANCE INSTANCE) NIL))
        (CL:SETQ COLLECT-000 (%%REST COLLECT-000)))))
     (CL:SETQ ITER-000 (%%REST ITER-000))))
   RESULT))
...
(CL:DEFUN MAKE-PL-PROPOSITION (PROPOSITION MODULE ISRULE)
  (CL:LET* ((XMLPROPOSITION (|new-PLProposition|)))
   (CL:SETF (|%PropositionName| XMLPROPOSITION)
    (GET-PROPOSITION-STRING PROPOSITION MODULE))
   (CL:IF (ASSERTED-AS-TRUE? PROPOSITION)
    (CL:SETF (|%IsAsserted| XMLPROPOSITION) "TRUE")
   ...
   (CL:LET*
    ...
    (CL:IF (PLI::IS-STRICT (PROPOSITION-TRUTH-VALUE PROPOSITION))
     (CL:SETF (|%IsStrict| XMLPROPOSITION) "TRUE")
     (CL:SETF (|%IsStrict| XMLPROPOSITION) "FALSE")))
   (CL:IF ISRULE (CL:SETF (|%IsRule| XMLPROPOSITION) "TRUE")
    (CL:SETF (|%IsRule| XMLPROPOSITION) "FALSE"))
   XMLPROPOSITION))
...
(CL:DEFUN MAKE-PL-PROPOSITIONS (PROPOSITIONS MODULE ISRULE)
  (CL:LET* ((RESULT (NEW-LIST)))
   (CL:LET*
    ((PROPOSITION NULL) (ITER-000 (%THE-CONS-LIST PROPOSITIONS))
     (COLLECT-000 NULL))
    (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-000 NIL)) DO
     (CL:SETQ PROPOSITION (%%VALUE ITER-000))
     (CL:IF (CL:EQ COLLECT-000 NULL)
...
(CL:DEFUN GET-DOCUMENTATION-FOR-OBJECT (MODULENAME OBJECTNAME)
  ...
  (CL:LET* ((RESULT (|new-PLString|)) (DOCSTRING ""))
   ...
   (CL:LET*
    ...
    (CL:LOOP WHILE (NEXT? ITER-000) DO (CL:SETQ DOC (%VALUE ITER-000))
     (CL:SETQ I ITER-001)
     (CL:WHEN (STRING? DOC)
      (CL:SETQ DOCSTRING
...
(CL:DEFUN GET-DIRECT-RELATIONS-FOR-CONCEPT (MODULE CONCEPT)
  (CL:LET* ((*MODULE* MODULE) (*CONTEXT* *MODULE*))
   ...
   (CL:LET*
    ...
    (CL:LET*
     ((RELATION NULL) (ITER-000 (%THE-CONS-LIST ALLRELATIONS))
      (COLLECT-000 NULL))
     (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-000 NIL)) DO
      (CL:SETQ RELATION (%%VALUE ITER-000))
...
(CL:DEFUN GET-PROPOSITIONS-FOR-OBJECT (MODULENAME INSTANCENAME RELATION?)
  ...
  (CL:LET*
   ((ITER
     (PLI::S-GET-PROPOSITIONS-OF (GUI-NAME-TO-PL-NAME INSTANCENAME) MODULENAME
      NULL))
...
(CL:DEFUN GET-RULES-FOR-RELATION (MODULENAME INSTANCENAME)
  ...
  (CL:LET*
   ((ITER
     (PLI::S-GET-RULES (GUI-NAME-TO-PL-NAME INSTANCENAME) MODULENAME NULL))
    (RULES (NEW-LIST)))
    ...
    (CL:LOOP WHILE (NEXT? ITER-000) DO (CL:SETQ RULE (%VALUE ITER-000))
     (CL:IF (CL:EQ COLLECT-000 NULL)
      (CL:PROGN (CL:SETQ COLLECT-000 (CONS RULE NIL))
       (CL:IF (CL:EQ (%THE-CONS-LIST RULES) NIL)
        (CL:SETF (%THE-CONS-LIST RULES) COLLECT-000)
...
(CL:DEFUN GET-RELEVANT-RULES-FOR-RELATION (MODULENAME RELATIONNAME)
  ...
  (CL:LET*
   ((MODULE (PLI::GET-MODULE MODULENAME NULL))
    (RELATION
     (PLI::S-GET-RELATION (GUI-NAME-TO-PL-NAME RELATIONNAME) MODULENAME NULL))
    (RULES (NEW-LIST)))
   (CL:LET* ((*MODULE* MODULE) (*CONTEXT* *MODULE*))
    (CL:DECLARE (CL:SPECIAL *MODULE* *CONTEXT*))
    (CL:LET*
     ...
     (CL:DECLARE (CL:SPECIAL *CONTEXT* *MODULE*))
     (CL:LET*
      ((RULE NULL) (ITER-000 (CALL-GET-RULES RELATION)) (COLLECT-000 NULL))
      (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-000 NIL)) DO
        ...
        (CL:IF (CL:EQ COLLECT-000 NULL)
         (CL:PROGN
          (CL:LET*
           ...
           (CL:SETQ COLLECT-000
            (CONS (CL:IF (CL:NOT (CL:EQ TEMP-000 NULL)) TEMP-000 RULE) NIL)))
          (CL:IF (CL:EQ (%THE-CONS-LIST RULES) NIL)
           (CL:SETF (%THE-CONS-LIST RULES) COLLECT-000)
           (ADD-CONS-TO-END-OF-CONS-LIST (%THE-CONS-LIST RULES) COLLECT-000)))
         (CL:PROGN
          (CL:LET*
           ((TEMP-001
             (DYNAMIC-SLOT-VALUE (%DYNAMIC-SLOTS RULE)
              SYM-GUI-SERVER-API-LOGIC-MASTER-PROPOSITION NULL)))
           (CL:SETF (%%REST COLLECT-000)
            (CONS (CL:IF (CL:NOT (CL:EQ TEMP-001 NULL)) TEMP-001 RULE) NIL)))
          (CL:SETQ COLLECT-000 (%%REST COLLECT-000)))))
       (CL:SETQ ITER-000 (%%REST ITER-000))))
...
(CL:DEFUN GET-PROPOSITIONS-FOR-INSTANCE-AND-RELATION (MODULENAME INSTANCENAME RELATIONNAME)
  ...
  (CL:LET*
   ...
   (CL:LET*
    ((PROP NULL)
     (ITER-001 (PLI::S-GET-PROPOSITIONS EXPRESSIONSTRING MODULENAME NULL))
     (COLLECT-000 NULL))
...
(CL:DECLAIM
 (CL:FTYPE
  (CL:FUNCTION (CL:SIMPLE-STRING CL:SIMPLE-STRING CL:T) CL:SIMPLE-STRING)
       ...
       (CL:LET*
        ...
        (CL:LOOP WHILE (NEXT? ITER-000) DO
         ...
         (CL:WHEN PARTIALQUERY?
          (CONCATENATE TUPLE (CONS (WRAP-FLOAT (%MATCH-SCORE SOLUTION)) NIL)))
         (CL:IF (CL:EQ COLLECT-000 NULL)
...
(CL:DECLAIM
 (CL:FTYPE (CL:FUNCTION (CL:T CL:T) CL:SIMPLE-STRING) GET-PROPOSITION-STRING))
(CL:DEFUN GET-PROPOSITION-STRING (PROP MODULE)
  (CL:LET* ((*MODULE* MODULE) (*CONTEXT* *MODULE*))
   (CL:DECLARE (CL:SPECIAL *MODULE* *CONTEXT*))
   (CL:LET* ((SS (NEW-OUTPUT-STRING-STREAM)))
    (CL:LET*
     ((*PRINTMODE* KWD-GUI-SERVER-API-ORIGINAL) (*PRINTLOGICALFORMSTREAM* SS)
      (*PRINTREADABLY?* CL:T))
     (CL:DECLARE
      (CL:SPECIAL *PRINTMODE* *PRINTLOGICALFORMSTREAM* *PRINTREADABLY?*))
...
(CL:DECLAIM
 (CL:FTYPE (CL:FUNCTION (CL:T) CL:SIMPLE-STRING) GET-TRUTH-VALUE-STRING))
...
(CL:DECLAIM
 (CL:FTYPE (CL:FUNCTION (CL:SIMPLE-STRING) CL:SIMPLE-STRING) XMLIFY-STRING))
...
(CL:DECLAIM
 (CL:FTYPE (CL:FUNCTION (CL:T) CL:SIMPLE-STRING) GET-STRINGIFIED-MODULE))
(CL:DEFUN GET-STRINGIFIED-MODULE (MODULE)
  (CL:LET*
   ((MODULENAME (%MODULE-NAME MODULE)) (PARENTS (%PARENT-MODULES MODULE))
    (USES (%USES MODULE)) (DOCUMENTATION (%DOCUMENTATION MODULE))
    (PARENTSTRINGS "") (USESSTRINGS "") (RESULT STELLA::NULL-STRING))
   (CL:DECLARE
   ...
   (CL:LET* ((PARENT NULL) (ITER-000 (%THE-CONS-LIST PARENTS)))
    (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-000 NIL)) DO
     ...
     (CL:SETQ PARENTSTRINGS
      (CONCATENATE PARENTSTRINGS " " (%MODULE-FULL-NAME PARENT)))
     (CL:SETQ ITER-000 (%%REST ITER-000))))
   (CL:LET* ((USE NULL) (ITER-001 (%THE-CONS-LIST USES)))
    (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-001 NIL)) DO
     (CL:SETQ USE (%%VALUE ITER-001))
     (CL:SETQ USESSTRINGS (CONCATENATE USESSTRINGS " " (%MODULE-NAME USE)))
     (CL:SETQ ITER-001 (%%REST ITER-001))))
   (CL:SETQ RESULT
...
(CL:DEFUN COMPACT-WHITESPACE (INSTRING)
  ...
  (CL:CHECK-TYPE INSTRING CL:SIMPLE-STRING)
  (CL:LET*
   ((COUNT 0) (LENGTH (CL:THE CL:FIXNUM (CL:LENGTH INSTRING))) (CURSOR 0)
    (NEWCURSOR 0) (RESULT STELLA::NULL-STRING))
...
(CL:DECLAIM
 (CL:FTYPE (CL:FUNCTION (CL:SIMPLE-STRING) CL:SIMPLE-STRING) STRIP-NEWLINES))
...
(CL:DEFUN STRIP-MODULE (INSTRING MODULE)
  ...
  #+MCL
  (CL:CHECK-TYPE INSTRING CL:SIMPLE-STRING)
  (CL:LET* ((MODNAME (CONCATENATE (%MODULE-FULL-NAME MODULE) "/")))
   (CL:DECLARE (CL:TYPE CL:SIMPLE-STRING MODNAME))
...
(CL:DEFUN LOAD-INDEX-FILE ()
  (%%PRINT-STREAM (%NATIVE-STREAM STANDARD-OUTPUT) "Loading index "
   *KB-FILENAME-INDEX* "..." EOL)
  (CL:LET*
   ((INSTREAM (NEW-INPUT-FILE-STREAM *KB-FILENAME-INDEX*))
    (STREAMITER (S-EXPRESSIONS INSTREAM)))
   (CL:LET* ((SEXP NULL) (ITER-000 STREAMITER))
    (CL:LOOP WHILE (NEXT? ITER-000) DO (CL:SETQ SEXP (%VALUE ITER-000))
...
(CL:DEFUN SAVE-INDEX-FILE (INDEX)
  (%%PRINT-STREAM (%NATIVE-STREAM STANDARD-OUTPUT) "Saving index "
   *KB-FILENAME-INDEX* "..." EOL)
  (CL:LET* ((OUTSTREAM (NEW-OUTPUT-FILE-STREAM *KB-FILENAME-INDEX*)))
   ...
   (CL:LET* ((TUPLE NULL) (ITER-000 INDEX))
    (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-000 NIL)) DO
     (CL:SETQ TUPLE (%%VALUE ITER-000))
     (%%PRINT-STREAM (%NATIVE-STREAM OUTSTREAM) "  (\""
      (%WRAPPER-VALUE (%%VALUE TUPLE)) "\" \""
      (%WRAPPER-VALUE (%%VALUE (%%REST TUPLE))) "\" \""
      (%WRAPPER-VALUE (%%VALUE (%%REST (%%REST TUPLE)))) "\" \""
...
(CL:DEFUN MAKE-PL-FILE (FILEDESCRIPTION)
  (CL:LET*
   ...
   (CL:SETF (|%FileName| PLFILE) (%WRAPPER-VALUE FILENAME))
   (CL:SETF (|%KBName| PLFILE) (%WRAPPER-VALUE KB))
...
(CL:DEFUN FIND-FILENAME-FOR-KB (FILEINDEX KBNAME)
  ...
  (CL:LET*
   ((PLFILE NULL) (ITER-000 (%THE-CONS-LIST (|%PLModuleFile| FILEINDEX))))
   (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-000 NIL)) DO
    (CL:SETQ PLFILE (%%VALUE ITER-000))
    (CL:WHEN
     (STRING-EQL? (STRING-DOWNCASE KBNAME)
      (STRING-DOWNCASE (|%KBName| PLFILE)))
...
(CL:DEFUN PARSE-MATCH-STRING (MATCHSTRING CASESENSITIVE?)
  ...
  (CL:LET*
   ...
   (CL:LOOP WHILE
    (CL:NOT
     (CL:= (CL:SETQ WILDCARDPOS (STRING-SEARCH MATCHSTRING WILDCARD CURSOR))
      NULL-INTEGER))
    DO
  ...
  (CL:IF (SYMBOL? (%%VALUE MATCHLIST))
    ...
    (CL:WHEN
     ...
     (CL:SETQ RESTOFINPUT
      (SUBSEQUENCE INPUTSTRING
       (CL:+ MATCHPOS
        (CL:THE CL:FIXNUM
         (CL:LENGTH (CL:THE CL:SIMPLE-STRING (%WRAPPER-VALUE FIRSTNONWILD)))))
   ...
   (CL:LET* ((FRAGMENT (%%VALUE MATCHLIST)))
    (CL:IF
     (CL:>
      (CL:THE CL:FIXNUM
       (CL:LENGTH (CL:THE CL:SIMPLE-STRING (%WRAPPER-VALUE FRAGMENT))))
      (CL:THE CL:FIXNUM (CL:LENGTH INPUTSTRING)))
     CL:NIL
     (CL:LET*
      ((INPUTSTART
...
(CL:DEFUN SEARCH-LOGIC-OBJECTS (MODULENAME OBJECTS MATCHLIST CASESENSITIVE?)
  ...
  (CL:LET* ((RESULT (NEW-LIST)))
   (CL:LET*
    ((OBJECT NULL) (ITER-000 (%THE-CONS-LIST OBJECTS)) (COLLECT-000 NULL))
    (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-000 NIL)) DO
     (CL:SETQ OBJECT (%%VALUE ITER-000))
     (CL:WHEN
      (SEARCH-STRING-MATCH? (GET-LOGIC-OBJECT-NAME OBJECT CASESENSITIVE?)
       MATCHLIST)
      (CL:IF (CL:EQ COLLECT-000 NULL)
       (CL:PROGN
        (CL:SETQ COLLECT-000
...
(CL:DEFUN SEARCH-CONCEPTS (MODULENAME MATCHLIST CASESENSITIVE?)
  ...
  (CL:LET* ((MODULE (PLI::GET-MODULE MODULENAME NULL)))
   (SEARCH-LOGIC-OBJECTS MODULENAME (GET-ALL-CONCEPTS MODULE CL:T) MATCHLIST
    CASESENSITIVE?)))
...
(CL:DEFUN SEARCH-RELATIONS (MODULENAME MATCHLIST CASESENSITIVE?)
  ...
  (CL:CHECK-TYPE CASESENSITIVE? CL:SIMPLE-STRING)
  (CL:LET* ((MODULE (PLI::GET-MODULE MODULENAME NULL)))
   (SEARCH-LOGIC-OBJECTS MODULENAME (GET-ALL-RELATIONS MODULE) MATCHLIST
    CASESENSITIVE?)))
...
(CL:DEFUN SEARCH-ALL-MODULES (SEARCHSTRING SEARCHINSTANCE? SEARCHCONCEPT? SEARCHRELATION? CASESENSITIVE?)
  (CL:DECLARE
   (CL:TYPE CL:SIMPLE-STRING SEARCHSTRING SEARCHINSTANCE? SEARCHCONCEPT?
    SEARCHRELATION? CASESENSITIVE?))
  #+MCL
  ...
  (CL:LET*
   ...
   (CL:LET* ((MODULE NULL) (ITER-000 (%THE-CONS-LIST ALLMODULES)))
    (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-000 NIL)) DO
     (CL:SETQ MODULE (%%VALUE ITER-000))
     (CONCATENATE RESULT
      (SEARCH-MODULE (%MODULE-NAME MODULE) SEARCHSTRING SEARCHINSTANCE?
...
(CL:DEFUN MAKE-SEARCH-RESULT-ITEM (MODULENAME OBJECT)
  ...
  (CL:CHECK-TYPE MODULENAME CL:SIMPLE-STRING)
  (CL:LET*
   ((UNION (MAKE-PL-OBJECT-UNION OBJECT)) (RESULT (|new-PLSearchResultItem|)))
   (CL:SETF (|%ModuleName| RESULT) MODULENAME)
...
(CL:DEFUN SERVER-GET-DIRECTORY-LISTING (CURRENTDIRECTORY EXTENSIONFILTER)
  ...
  (CL:LET*
   ((DIRECTORYLISTING (GET-DIRECTORY-LISTING (|%Value| CURRENTDIRECTORY)))
    (PLDIRECTORYLISTING (|new-PLDirectoryContents|)) (PLFILES (NEW-LIST))
    (PLDIRECTORIES (NEW-LIST))
    (MATCHLIST (PARSE-MATCH-STRING (|%Value| EXTENSIONFILTER) "FALSE")))
   (CL:SETF (|%DirectoryName| PLDIRECTORYLISTING) (|%Value| CURRENTDIRECTORY))
   (CL:LET*
    ((FILENAME NULL) (ITER-000 (%THE-CONS-LIST (FIRST DIRECTORYLISTING))))
    (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-000 NIL)) DO
     ...
     (CL:SETQ ITER-000 (%%REST ITER-000))))
   (CL:LET*
    ((DIRNAME NULL) (ITER-001 (%THE-CONS-LIST (SECOND DIRECTORYLISTING))))
    (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-001 NIL)) DO
     (CL:SETQ DIRNAME (%%VALUE ITER-001))
     (CL:LET* ((PLDIRECTORY (|new-PLDirectory|)))
      (CL:SETF (|%DirectoryName| PLDIRECTORY) (%WRAPPER-VALUE DIRNAME))
      (INSERT PLDIRECTORIES PLDIRECTORY))
     (CL:SETQ ITER-001 (%%REST ITER-001))))
   (CL:SETF (|%PLFile| PLDIRECTORYLISTING) PLFILES)
   (CL:SETF (|%PLDirectory| PLDIRECTORYLISTING) PLDIRECTORIES)
   PLDIRECTORYLISTING))
...
(CL:DEFUN SERVER-GET-DEFAULT-DIRECTORY-LISTING (EXTENSIONFILTER)
  ...
  (CL:LET* ((DIR (|new-PLString|)))
   (CL:SETF (|%Value| DIR) *DEFAULT-KB-DIRECTORY*)
...
(CL:DEFUN DISPATCH-CALL (FUNCTIONNAME ARGS)
  ...
  (CL:LET* ((CODE (LOOKUP *SERVER-DISPATCH-TABLE* FUNCTIONNAME)))
   (CL:IF (CL:EQ CODE NULL)
    (CL:LET* ((STREAM-000 (NEW-OUTPUT-STRING-STREAM)))
     (%%PRINT-STREAM (%NATIVE-STREAM STREAM-000) "Couldn't find function `"
      FUNCTIONNAME "' for dispatch.")
...
(CL:DEFUN MEMBER-TEST (CONCEPT)
  (CL:LET* ((CONCEPTLIST (NEW-LIST)) (NEWCONC (|new-PLConcept|)))
   (CL:SETF (|%ConceptName| NEWCONC) (|%ConceptName| CONCEPT))
   (INSERT CONCEPTLIST CONCEPT)
   (%%PRINT-STREAM (%NATIVE-STREAM STANDARD-OUTPUT) "IDENTICAL MEMBER: "
    (MEMBER? CONCEPTLIST CONCEPT) EOL)
   (%%PRINT-STREAM (%NATIVE-STREAM STANDARD-OUTPUT) "NONIDENTICAL MEMBER: "
    (MEMBER? CONCEPTLIST NEWCONC) EOL)))

;;; (DEFUN (TEST-SERVER-GET-CONCEPTS-FOR-MODULE |PLConceptContainer|) ...)

(CL:DEFUN TEST-SERVER-GET-CONCEPTS-FOR-MODULE ()
  (CL:LET* ((PLSTRING (|new-PLString|))) (CL:SETF (|%Value| PLSTRING) "EELD")
...
(CL:DEFUN TEST-SERVER-GET-RELATIONS-FOR-MODULE ()
  (CL:LET* ((PLSTRING (|new-PLString|)))
   (CL:SETF (|%Value| PLSTRING) "PL-KERNEL-KB")
...
(CL:DEFUN TEST-SERVER-GET-DIRECT-INSTANCES-FOR-CONCEPT ()
  (CL:LET* ((MODULE (|new-PLString|)) (CONCEPT (|new-PLString|)))
   (CL:SETF (|%Value| MODULE) "AIRCRAFT-KB")
   (CL:SETF (|%Value| CONCEPT) "AIRCRAFT")
...
(CL:DEFUN TEST-SERVER-GET-PROPOSITIONS-FOR-MODULE ()
  (CL:LET* ((PLSTRING (|new-PLString|)))
   (CL:SETF (|%Value| PLSTRING) "AIRCRAFT-KB")
...
(CL:DEFUN TEST-SERVER-GET-PROPOSITIONS-FOR-INSTANCE ()
  (CL:LET* ((MODSTRING (|new-PLString|)) (INSTANCESTRING (|new-PLString|)))
   (CL:SETF (|%Value| MODSTRING) "AIRCRAFT-KB")
   (CL:SETF (|%Value| INSTANCESTRING) "F-117")
...
(CL:DEFUN TEST-SERVER-GET-TYPES-FOR-INSTANCE ()
  (CL:LET* ((MODSTRING (|new-PLString|)) (INSTANCESTRING (|new-PLString|)))
   (CL:SETF (|%Value| MODSTRING) "AIRCRAFT-KB")
   (CL:SETF (|%Value| INSTANCESTRING) "A-10")
...
(CL:DEFUN TEST-SERVER-GET-DOCUMENTATION-FOR-INSTANCE ()
  (CL:LET* ((MODSTRING (|new-PLString|)) (INSTANCESTRING (|new-PLString|)))
   (CL:SETF (|%Value| MODSTRING) "EELD")
   (CL:SETF (|%Value| INSTANCESTRING) "Action_105")
...
(CL:DEFUN TEST-SERVER-GET-RELATIONS-FOR-CONCEPT ()
  (CL:LET* ((MODSTRING (|new-PLString|)) (INSTANCESTRING (|new-PLString|)))
   (CL:SETF (|%Value| MODSTRING) "AIRCRAFT-KB")
   (CL:SETF (|%Value| INSTANCESTRING) "ENGINE")
...
(CL:DEFUN TEST-SERVER-GET-INHERITED-RELATIONS-FOR-CONCEPT ()
  (CL:LET* ((MODSTRING (|new-PLString|)) (INSTANCESTRING (|new-PLString|)))
   (CL:SETF (|%Value| MODSTRING) "AIRCRAFT-KB")
   (CL:SETF (|%Value| INSTANCESTRING) "AIRCRAFT")
...
(CL:DEFUN TEST-SERVER-GET-DOCUMENTATION-FOR-CONCEPT ()
  (CL:LET* ((MODSTRING (|new-PLString|)) (CONCEPTSTRING (|new-PLString|)))
   (CL:SETF (|%Value| MODSTRING) "AIRCRAFT-KB")
   (CL:SETF (|%Value| CONCEPTSTRING) "JFC9")
...
(CL:DEFUN TEST-SERVER-GET-SOURCE-FOR-CONCEPT ()
  (CL:LET* ((MODSTRING (|new-PLString|)) (CONCEPTSTRING (|new-PLString|)))
   (CL:SETF (|%Value| MODSTRING) "AIRCRAFT-KB")
   (CL:SETF (|%Value| CONCEPTSTRING) "AIR-ORGANIZATION")
...
(CL:DEFUN TEST-SERVER-GET-DOCUMENTATION-FOR-RELATION ()
  (CL:LET* ((MODSTRING (|new-PLString|)) (RELATIONSTRING (|new-PLString|)))
   (CL:SETF (|%Value| MODSTRING) "AIRCRAFT-KB")
   (CL:SETF (|%Value| RELATIONSTRING) "ORDNANCE")
...
(CL:DEFUN TEST-SERVER-GET-SUPERRELATIONS-FOR-RELATION ()
  (CL:LET* ((MODSTRING (|new-PLString|)) (RELATIONSTRING (|new-PLString|)))
   (CL:SETF (|%Value| MODSTRING) "AIRCRAFT-KB")
   (CL:SETF (|%Value| RELATIONSTRING) "AG-ORDNANCE")
...
(CL:DEFUN TEST-SERVER-GET-VARIABLES-FOR-RELATION ()
  (CL:LET* ((MODSTRING (|new-PLString|)) (RELATIONSTRING (|new-PLString|)))
   (CL:SETF (|%Value| MODSTRING) "AIRCRAFT-KB")
   (CL:SETF (|%Value| RELATIONSTRING) "STORES")
...
(CL:DEFUN TEST-SERVER-GET-PROPOSITIONS-FOR-CONCEPT ()
  (CL:LET* ((MODSTRING (|new-PLString|)) (INSTANCESTRING (|new-PLString|)))
   (CL:SETF (|%Value| MODSTRING) "SUBMOD1")
   (CL:SETF (|%Value| INSTANCESTRING) "WIDTH-RELATION")
...
(CL:DEFUN TEST-SERVER-GET-PROPOSITIONS-FOR-RELATION ()
  (CL:LET* ((MODSTRING (|new-PLString|)) (INSTANCESTRING (|new-PLString|)))
   (CL:SETF (|%Value| MODSTRING) "AIRCRAFT-KB")
   (CL:SETF (|%Value| INSTANCESTRING) "ABCD")
...
(CL:DEFUN TEST-SERVER-GET-RULES-FOR-RELATION ()
  (CL:LET* ((MODSTRING (|new-PLString|)) (INSTANCESTRING (|new-PLString|)))
   (CL:SETF (|%Value| MODSTRING) "AIRCRAFT-KB")
   (CL:SETF (|%Value| INSTANCESTRING) "SMART-BOMB")
...
(CL:DEFUN TEST-SERVER-GET-PROPOSITIONS-FOR-INSTANCE-AND-RELATION ()
  (CL:LET*
   ...
   (CL:SETF (|%Value| MODSTRING) "AIRCRAFT-KB")
   (CL:SETF (|%Value| RELATIONSTRING) "FLEET-SIZE")
   (CL:SETF (|%Value| INSTANCESTRING) "USAF")
   (SERVER-GET-PROPOSITIONS-FOR-INSTANCE-AND-RELATION MODSTRING INSTANCESTRING
    RELATIONSTRING)))
...
(CL:DEFUN TEST-SERVER-EVALUATE-LOGIC-COMMAND (COMMAND)
  ...
  #+MCL
  (CL:CHECK-TYPE COMMAND CL:SIMPLE-STRING)
  (CL:LET* ((MODSTRING (|new-PLString|)) (COMMANDSTRING (|new-PLString|)))
   (CL:SETF (|%Value| MODSTRING) "AIRCRAFT-KB")
   (CL:SETF (|%Value| COMMANDSTRING) COMMAND)
...
(CL:DEFUN TEST-SERVER-LOAD-KB ()
  (CL:LET* ((KBSTRING (|new-PLString|)))
   (CL:SETF (|%Value| KBSTRING) "aircraft-kb") (SERVER-LOAD-KB KBSTRING)))

;;; (DEFUN TEST-SERVER-CLEAR-KB ...)

(CL:DEFUN TEST-SERVER-CLEAR-KB ()
  (CL:LET* ((MOD (|new-PLModule|)))
   (CL:SETF (|%ModuleName| MOD) "AIRCRAFT-KB") (SERVER-CLEAR-KB MOD)))
...
(CL:DEFUN TEST-SERVER-SAVE-KB ()
  (CL:LET*
   ...
   (CL:SETF (|%Value| KBSTRING) "aircraft-kb10")
   (CL:SETF (|%Value| MODSTRING) "AIRCRAFT-KB")
   (CL:SETF (|%Value| DESCSTRING) "groovy new desc for aircraft-kb10")
...
(CL:DEFUN MAKE-PL-QUERY ()
  (CL:LET* ((PLQUERY (|new-PLQuery|)))
   (CL:SETF (|%Query| PLQUERY) "(HAPPY ?X)")
   (CL:SETF (|%NumResults| PLQUERY) "ALL")
   (CL:SETF (|%Module| PLQUERY) "SUBMOD1")
   (CL:SETF (|%IsAsk| PLQUERY) "FALSE") (CL:SETF (|%QueryName| PLQUERY) "")
   (CL:SETF (|%InferenceLevel| PLQUERY) "") (CL:SETF (|%Timeout| PLQUERY) "")
   (CL:SETF (|%Moveout| PLQUERY) "")
   (CL:SETF (|%MatchMode| PLQUERY) "PARTIAL")
   (CL:SETF (|%MinScore| PLQUERY) "") (CL:SETF (|%MaxUnknowns| PLQUERY) "")
   (CL:SETF (|%MaximizeScore| PLQUERY) "")
   (CL:SETF (|%DontOptimize| PLQUERY) "") PLQUERY))

;;; (DEFUN (TEST-SERVER-QUERY |PLQueryResult|) ...)

(CL:DEFUN TEST-SERVER-QUERY ()
  (CL:LET*
   ((RESULT NULL) (CONTINUEQUERY? (|new-PLString|)) (PLQUERY (MAKE-PL-QUERY)))
   (CL:SETF (|%Value| CONTINUEQUERY?) "FALSE")
   (%%PRINT-STREAM (%NATIVE-STREAM STANDARD-OUTPUT) "result1 is: "
    (SERVER-QUERY PLQUERY CONTINUEQUERY?) EOL)
   RESULT))
...
(CL:DEFUN TEST-SERVER-SEARCH1 ()
  (CL:LET* ((SEARCHPARAMETER (|new-PLSearchParameter|)))
   (CL:SETF (|%ModuleName| SEARCHPARAMETER) "AIRCRAFT-KB")
   (CL:SETF (|%SearchString| SEARCHPARAMETER) "*pod*")
   (CL:SETF (|%SearchConcept| SEARCHPARAMETER) "TRUE")
   (CL:SETF (|%SearchRelation| SEARCHPARAMETER) "FALSE")
   (CL:SETF (|%SearchInstance| SEARCHPARAMETER) "FALSE")
   (CL:SETF (|%CaseSensitive| SEARCHPARAMETER) "FALSE")
...
(CL:DEFUN TEST-SERVER-GET-EXTENSION-FOR-RELATION ()
  (CL:LET* ((MOD (|new-PLString|)) (RELATION (|new-PLString|)))
   (CL:SETF (|%Value| MOD) "AIRCRAFT-KB") (CL:SETF (|%Value| RELATION) "cost")
...
(CL:DEFUN TEST-SERVER-GET-RELATION ()
  (CL:LET* ((MOD (|new-PLString|)) (RELATION (|new-PLString|)))
   (CL:SETF (|%Value| MOD) "AIRCRAFT-KB")
   (CL:SETF (|%Value| RELATION) "DUPLICATE-FREE")
...
(CL:DEFUN TEST-SERVER-GET-CONCEPT ()
  (CL:LET* ((MOD (|new-PLString|)) (CONCEPT (|new-PLString|)))
   (CL:SETF (|%Value| MOD) "AIRCRAFT-KB")
   (CL:SETF (|%Value| CONCEPT) "DUPLICATE-FREE")
...
(CL:DEFUN TEST-SERVER-GET-INSTANCE ()
  (CL:LET* ((MOD (|new-PLString|)) (INSTANCE (|new-PLString|)))
   (CL:SETF (|%Value| MOD) "AIRCRAFT-KB") (CL:SETF (|%Value| INSTANCE) "A-10")
...
(CL:DEFUN TEST-SERVER-GET-CONCEPT-COMPLETIONS ()
  (CL:LET* ((MOD (|new-PLString|)) (PREFIX (|new-PLString|)))
   (CL:SETF (|%Value| MOD) "AIRCRAFT-KB") (CL:SETF (|%Value| PREFIX) "CO")
...
(CL:DEFUN TEST-SERVER-GET-INSTANCE-COMPLETIONS ()
  (CL:LET* ((MOD (|new-PLString|)) (PREFIX (|new-PLString|)))
   (CL:SETF (|%Value| MOD) "AIRCRAFT-KB") (CL:SETF (|%Value| PREFIX) "A")
...
(CL:DEFUN HELP-STARTUP-GUI-SERVER-API1 ()
  (CL:PROGN
   ...
   (CL:SETQ SYM-GUI-SERVER-API-STELLA-API?
    (INTERN-RIGID-SYMBOL-WRT-MODULE "API?" (GET-STELLA-MODULE "/STELLA" CL:T)
     0))
...
(CL:DEFUN HELP-STARTUP-GUI-SERVER-API4 ()
  (CL:PROGN
   ...
   (DEFINE-FUNCTION-OBJECT "MEMBER-TEST"
    "(DEFUN MEMBER-TEST ((CONCEPT |PLConcept|)))" (CL:FUNCTION MEMBER-TEST)
    NULL)
   ...
   (DEFINE-FUNCTION-OBJECT "TEST-SERVER-CLEAR-KB"
    "(DEFUN TEST-SERVER-CLEAR-KB ())" (CL:FUNCTION TEST-SERVER-CLEAR-KB) NULL)
   ...
   (DEFINE-FUNCTION-OBJECT "MAKE-PL-QUERY"
    "(DEFUN (MAKE-PL-QUERY |PLQuery|) ())" (CL:FUNCTION MAKE-PL-QUERY) NULL)
...
(CL:DEFUN STARTUP-GUI-SERVER-API ()
  (CL:LET*
   ...
   (CL:WHEN (CURRENT-STARTUP-TIME-PHASE? 7) (HELP-STARTUP-GUI-SERVER-API2)
    (HELP-STARTUP-GUI-SERVER-API3) (HELP-STARTUP-GUI-SERVER-API4)
   ...
   (CL:WHEN (CURRENT-STARTUP-TIME-PHASE? 9)
    ...
    (%SET-LOGGING-PARAMETERS "PL-Server"
     (CONS-LIST KWD-GUI-SERVER-API-LOG-LEVELS
      ...
      (CL:IF (CL:EQ *POWERLOOM-EXECUTION-MODE* KWD-GUI-SERVER-API-DEVELOPMENT)
