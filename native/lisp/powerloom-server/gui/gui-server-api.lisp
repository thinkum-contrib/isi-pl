       ...
       (CL:PROGN (CL:SETQ COLLECT-000 (CONS INSTANCE NIL))
        (CL:IF (CL:EQ (%THE-CONS-LIST NONSKOLEMINSTANCES) NIL)
         ...
         (ADD-CONS-TO-END-OF-CONS-LIST
          (%THE-CONS-LIST NONSKOLEMINSTANCES) COLLECT-000)))
   ...
   ((MODULE (PLI::GET-MODULE (|%Value| MODULENAME) NULL))
    (ITER
     (PLI::GET-CONCEPT-INSTANCES
      (PLI::GET-CONCEPT (|%Value| CONCEPTNAME) MODULE NULL) MODULE
      NULL))
...
(CL:DEFUN SERVER-GET-DOCUMENTATION-FOR-CONCEPT (MODULENAME CONCEPTNAME)
  ...
  (GET-DOCUMENTATION-FOR-OBJECT (|%Value| MODULENAME)
   (|%Value| CONCEPTNAME)))
...
(CL:DEFUN SERVER-LOAD-KB (PLKBNAME)
  (%%PRINT-STREAM (%NATIVE-STREAM STANDARD-OUTPUT) "in server-load-kb"
   EOL)
  (CL:LET*
   ...
   (%%PRINT-STREAM (%NATIVE-STREAM STANDARD-OUTPUT) "kbName is:" KBNAME
    EOL)
   (%%PRINT-STREAM (%NATIVE-STREAM STANDARD-OUTPUT) "fileName is:"
    FILENAME EOL)
   (CL:IF (CL:NOT (CL:EQ FILENAME STELLA::NULL-STRING))
    (CL:PROGN
     (%%PRINT-STREAM (%NATIVE-STREAM STANDARD-OUTPUT) "Loading KB: "
      FILENAME EOL)
...
(CL:DEFUN SERVER-SAVE-KB (PLMODULENAME PLKBNAME PLDESCRIPTION)
  (CL:LET*
   ...
   (CL:IF (CL:NOT (CL:EQ FILENAME STELLA::NULL-STRING))
    (CL:PROGN
     (%%PRINT-STREAM (%NATIVE-STREAM STANDARD-OUTPUT) "Saving KB: "
      MODULENAME " to " FILENAME EOL)
    ...
    (CL:LET*
     ...
     (CL:LET* ((STREAM (NEW-OUTPUT-FILE-STREAM NEWFILE)))
      (DO-SAVE-MODULE MODULE STREAM) (FREE STREAM))
     (%%PRINT-STREAM (%NATIVE-STREAM STANDARD-OUTPUT) "new index: "
      NEWINDEX EOL)))
...
(CL:DEFUN SERVER-SAVE-KB2 (PLMODULENAME PLFILENAME)
  (CL:LET*
   ...
   (CL:SETF (|%FileName| RESULT) FILENAME)
...
(CL:DEFUN SERVER-CLEAR-KB (MODULE)
  (CL:LET* ((MODNAME (|%ModuleName| MODULE)) (RESULT (|new-PLString|)))
   ...
   (PLI::S-CLEAR-MODULE MODNAME NULL) (CL:SETF (|%Value| RESULT) "OK")
   RESULT))
   ...
   (CL:LET* ((*MODULE* MODULE) (*CONTEXT* *MODULE*))
    ...
    (CL:LET*
     ((RESULT (|new-PLRelationContainer|))
      (RELATION
       (PLI::S-GET-RELATION
        (GUI-NAME-TO-PL-NAME (|%Value| RELATIONNAME))
        (|%Value| MODULENAME) NULL))
      (XMLRELATIONS (NEW-LIST)))
     (CL:WHEN (CL:NOT (CL:EQ RELATION NULL))
      (INSERT XMLRELATIONS
       (MAKE-PL-RELATION RELATION (|%Value| MODULENAME))))
...
(CL:DEFUN EXTRACT-MODULE-NAME-FROM-STREAM (STREAM)
  (CL:LET*
   ...
   (CL:LOOP WHILE
    ...
    (CL:SETQ TREE (%VALUE ITER-000)) (CL:SETQ I ITER-001) (CL:SETQ I I)
    (CL:COND
...
(CL:DEFUN CREATE-QUERY-STRING (PLQUERY)
  (CL:LET*
   ...
   (CL:WHEN
    (CL:AND
     (CL:NOT (CL:EQ (|%NumResults| PLQUERY) STELLA::NULL-STRING))
     (CL:>
      (CL:THE CL:FIXNUM
   ...
   (CL:WHEN
    ...
    (CL:SETQ TIMEOUTCLAUSE
     (CONCATENATE " :TIMEOUT " (|%Timeout| PLQUERY))))
   (CL:WHEN
    ...
    (CL:SETQ MOVEOUTCLAUSE
     (CONCATENATE " :MOVEOUT " (|%Moveout| PLQUERY))))
   (CL:WHEN
   ...
   (CL:WHEN
    (CL:AND
     (CL:NOT (CL:EQ (|%MaximizeScore| PLQUERY) STELLA::NULL-STRING))
     (CL:>
      (CL:THE CL:FIXNUM
       (CL:LENGTH
        (CL:THE CL:SIMPLE-STRING (|%MaximizeScore| PLQUERY))))
      0))
    (CL:SETQ MAXIMIZESCORECLAUSE
     (CONCATENATE " :MAXIMIZE-SCORE? " (|%MaximizeScore| PLQUERY))))
   (CL:WHEN
    (CL:AND
     (CL:NOT (CL:EQ (|%DontOptimize| PLQUERY) STELLA::NULL-STRING))
     (CL:>
      (CL:THE CL:FIXNUM
   ...
   (CL:WHEN
    (CL:AND
     (CL:NOT (CL:EQ (|%MaxUnknowns| PLQUERY) STELLA::NULL-STRING))
     (CL:>
      (CL:THE CL:FIXNUM
   ...
   (CL:WHEN
    (CL:AND
     (CL:NOT (CL:EQ (|%InferenceLevel| PLQUERY) STELLA::NULL-STRING))
     (CL:>
      (CL:THE CL:FIXNUM
       (CL:LENGTH
        (CL:THE CL:SIMPLE-STRING (|%InferenceLevel| PLQUERY))))
      0))
  ...
  (CL:LET* ((RESULT (|new-PLObjectUnion|)))
   ...
   (CL:WHEN
    (CL:AND (SKOLEM? OBJECT)
     (CL:NOT
      (CL:EQ
       (ACCESS-IN-CONTEXT (%VARIABLE-VALUE OBJECT)
        (%HOME-CONTEXT OBJECT) CL:NIL)
       NULL)))
    (CL:SETQ OBJECT
   ...
   (CL:LET* ((TEST-VALUE-000 (SAFE-PRIMARY-TYPE OBJECT)))
    (CL:COND
     ...
     ((SUBTYPE-OF-STRING? TEST-VALUE-000)
      (CL:PROGN
       (CL:SETF (|%LiteralValue| RESULT) (%WRAPPER-VALUE OBJECT))
       (CL:SETF (|%Type| RESULT) "STRING")))
...
(CL:DEFUN CREATE-MODULE-CONTAINER (COLLECTEDMODULES)
  (CL:LET*
   ...
   (CL:LET*
    ((MODULE NULL) (ITER-000 (%THE-CONS-LIST COLLECTEDMODULES)))
    (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-000 NIL)) DO
         ...
         (CL:IF (CL:EQ COLLECT-000 NULL)
          (CL:PROGN
           ...
           (CL:IF (CL:EQ (%THE-CONS-LIST SURROGATECHILDREN) NIL)
            ...
            (ADD-CONS-TO-END-OF-CONS-LIST
             (%THE-CONS-LIST SURROGATECHILDREN) COLLECT-000)))
          (CL:PROGN
           (CL:SETF (%%REST COLLECT-000)
            (CONS (MAKE-MODULE-SURROGATE CHILD) NIL))
           (CL:SETQ COLLECT-000 (%%REST COLLECT-000)))))))
...
(CL:DEFUN GET-STELLA-LITERAL-CONCEPTS ()
  (CL:LET*
   ((COLLECTEDCONCEPTS (NEW-LIST))
    (TOPCONCEPT
     (GET-DESCRIPTION
      (%SURROGATE-VALUE SGT-GUI-SERVER-API-STELLA-LITERAL)))
...
(CL:DEFUN CREATE-CONCEPT-CONTAINER (COLLECTEDCONCEPTS MODULE INCLUDECHILDREN?)
  (CL:LET*
   ...
   (CL:LET*
    ((CONCEPT NULL) (ITER-000 (%THE-CONS-LIST COLLECTEDCONCEPTS)))
    (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-000 NIL)) DO
...
(CL:DEFUN CREATE-RELATION-CONTAINER (COLLECTEDRELATIONS MODULE INCLUDECHILDREN?)
  (CL:LET*
   ...
   (CL:LET*
    ((RELATION NULL) (ITER-000 (%THE-CONS-LIST COLLECTEDRELATIONS)))
    (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-000 NIL)) DO
     ...
     (CL:LET*
      ...
      (CL:IF (FUNCTION? RELATION)
       (CL:SETF (|%IsFunction| PLRELATION) "TRUE")
       (CL:SETF (|%IsFunction| PLRELATION) "FALSE"))
      (CL:IF (CLOSED-TERM? RELATION)
       (CL:SETF (|%IsClosed| PLRELATION) "TRUE")
...
(CL:DEFUN CREATE-MODULE-COLLECTION (MODULES)
  (CL:LET*
   ...
   (CL:LET*
    ((MODULE NULL) (ITER-000 (%THE-CONS-LIST MODULES))
     (COLLECT-000 NULL))
    (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-000 NIL)) DO
     (CL:SETQ MODULE (%%VALUE ITER-000))
     (CL:IF (CL:EQ COLLECT-000 NULL)
...
(CL:DEFUN CREATE-SURROGATE-COLLECTION-FOR-LOGIC-OBJECT (RELATIONS)
  (CL:LET*
   ((SURROGATECHILDREN (NEW-LIST))
    (PLSURROGATECOLLECTION (|new-PLSurrogateCollection|)))
   (CL:LET*
    ((RELATION NULL) (ITER-000 (%THE-CONS-LIST RELATIONS))
     (COLLECT-000 NULL))
    (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-000 NIL)) DO
     (CL:SETQ RELATION (%%VALUE ITER-000))
     (CL:IF (CL:EQ COLLECT-000 NULL)
       ...
       (CL:LOOP WHILE
        ...
        (CL:IF (CL:EQ COLLECT-000 NULL)
         (CL:PROGN
          (CL:SETQ COLLECT-000
           (CONS
            (MAKE-PL-VARIABLE (%SYMBOL-NAME VARIABLENAME) VARIABLETYPE)
            NIL))
...
(CL:DEFUN MAKE-PL-RELATION (RELATION MODULENAME)
  ...
  (CL:LET* ((XMLRELATION (|new-PLRelation|)))
   (CL:SETF (|%Module| XMLRELATION)
    (%MODULE-FULL-NAME (HOME-MODULE RELATION)))
   (CL:IF (FUNCTION? RELATION)
    (CL:SETF (|%IsFunction| XMLRELATION) "TRUE")
    (CL:SETF (|%IsFunction| XMLRELATION) "FALSE"))
   (CL:IF (CLOSED-TERM? RELATION)
    (CL:SETF (|%IsClosed| XMLRELATION) "TRUE")
...
(CL:DEFUN MAKE-LOGIC-SURROGATE (OBJ)
  (CL:LET* ((RESULT (|new-PLSurrogate|)))
   ...
   (CL:SETF (%ID RESULT) (XMLIFY-STRING (PL-OBJECT-TO-GUI-NAME OBJ)))
   RESULT))
...
(CL:DEFUN GET-ALL-RELATIONS (MODULE)
  (CL:LET*
   ...
   (CL:LET* ((DESCRIPTION NULL) (ITER-000 ITER) (COLLECT-000 NULL))
    (CL:LOOP WHILE (NEXT? ITER-000) DO
     (CL:SETQ DESCRIPTION (%VALUE ITER-000))
...
(CL:DEFUN MAKE-PL-INSTANCES (INSTANCES SKIPUNINTERNEDINSTANCES?)
  (CL:LET* ((RESULT (NEW-LIST)))
   (CL:LET*
    ((INSTANCE NULL) (ITER-000 (%THE-CONS-LIST INSTANCES))
     (COLLECT-000 NULL))
    (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-000 NIL)) DO
     (CL:SETQ INSTANCE (%%VALUE ITER-000))
     (CL:WHEN
     ...
     (CL:WHEN (STRING? DOC)
      (CL:SETQ DOCSTRING
       (CONCATENATE DOCSTRING (CL:IF (CL:= I 1) "" EOL-STRING)
        (%WRAPPER-VALUE DOC))))
     (CL:SETQ ITER-001 (CL:1+ ITER-001))))
   (CL:SETF (|%Value| RESULT) (XMLIFY-FORMATTED-STRING DOCSTRING))
   RESULT))
     ...
     (CL:IF (CL:EQ COLLECT-000 NULL)
      (CL:PROGN (CL:SETQ COLLECT-000 (CONS RULE NIL))
       (CL:IF (CL:EQ (%THE-CONS-LIST RULES) NIL)
        ...
        (ADD-CONS-TO-END-OF-CONS-LIST (%THE-CONS-LIST RULES)
         COLLECT-000)))
       ...
       (CL:LET*
        ...
        (CL:LOOP WHILE (NEXT? ITER-000) DO
         ...
         (CL:WHEN PARTIALQUERY?
          (CONCATENATE TUPLE
           (CONS (WRAP-FLOAT (%MATCH-SCORE SOLUTION)) NIL)))
         (CL:IF (CL:EQ COLLECT-000 NULL)
...
(CL:DEFUN GET-STRINGIFIED-MODULE (MODULE)
  (CL:LET*
   ((MODULENAME (%MODULE-NAME MODULE))
    (PARENTS (%PARENT-MODULES MODULE)) (USES (%USES MODULE))
    (DOCUMENTATION (%DOCUMENTATION MODULE)) (PARENTSTRINGS "")
   ...
   (CL:LET* ((USE NULL) (ITER-001 (%THE-CONS-LIST USES)))
    (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-001 NIL)) DO
     ...
     (CL:SETQ USESSTRINGS
      (CONCATENATE USESSTRINGS " " (%MODULE-NAME USE)))
     (CL:SETQ ITER-001 (%%REST ITER-001))))
   (CL:SETQ RESULT
...
(CL:DEFUN REPLACE-CHOKABLE-CHARS-WITH-ENTITIES (INSTRING)
  ...
  (CL:CHECK-TYPE INSTRING CL:SIMPLE-STRING)
  (CL:LET* ((SS (NEW-OUTPUT-STRING-STREAM)))
   (WRITE-HTML-QUOTING-CHOKABLE-CHARACTERS (%NATIVE-STREAM SS)
    INSTRING)
   (THE-STRING-READER SS)))
...
(CL:DEFUN MAKE-PL-FILE (FILEDESCRIPTION)
  (CL:LET*
   ...
   (CL:SETF (|%KBDescription| PLFILE) (%WRAPPER-VALUE DESCRIPTION))
   PLFILE))
...
(CL:DEFUN FIND-FILENAME-FOR-KB (FILEINDEX KBNAME)
  ...
  (CL:LET*
   ((PLFILE NULL)
    (ITER-000 (%THE-CONS-LIST (|%PLModuleFile| FILEINDEX))))
   (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-000 NIL)) DO
     ...
     (CL:SETQ RESTOFINPUT
      (SUBSEQUENCE INPUTSTRING
       (CL:+ MATCHPOS
        (CL:THE CL:FIXNUM
         (CL:LENGTH
          (CL:THE CL:SIMPLE-STRING (%WRAPPER-VALUE FIRSTNONWILD)))))
     ...
     (CL:LET*
      ((INPUTSTART
        (SUBSEQUENCE INPUTSTRING 0
         (CL:THE CL:FIXNUM
          (CL:LENGTH
           (CL:THE CL:SIMPLE-STRING (%WRAPPER-VALUE FRAGMENT))))))
       (RESTOFINPUT
        (SUBSEQUENCE INPUTSTRING
         (CL:THE CL:FIXNUM
          (CL:LENGTH
...
(CL:DEFUN SEARCH-LOGIC-OBJECTS (MODULENAME OBJECTS MATCHLIST CASESENSITIVE?)
  ...
  (CL:LET* ((RESULT (NEW-LIST)))
   (CL:LET*
    ((OBJECT NULL) (ITER-000 (%THE-CONS-LIST OBJECTS))
     (COLLECT-000 NULL))
    (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-000 NIL)) DO
     (CL:SETQ OBJECT (%%VALUE ITER-000))
     (CL:WHEN
...
(CL:DEFUN SERVER-GET-DIRECTORY-LISTING (CURRENTDIRECTORY EXTENSIONFILTER)
  ...
  (CL:LET*
   ((DIRECTORYLISTING
     (GET-DIRECTORY-LISTING (|%Value| CURRENTDIRECTORY)))
    (PLDIRECTORYLISTING (|new-PLDirectoryContents|))
    (PLFILES (NEW-LIST)) (PLDIRECTORIES (NEW-LIST))
    (MATCHLIST
     (PARSE-MATCH-STRING (|%Value| EXTENSIONFILTER) "FALSE")))
   (CL:SETF (|%DirectoryName| PLDIRECTORYLISTING)
    (|%Value| CURRENTDIRECTORY))
   (CL:LET*
    ((FILENAME NULL)
     (ITER-000 (%THE-CONS-LIST (FIRST DIRECTORYLISTING))))
    (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-000 NIL)) DO
     (CL:SETQ FILENAME (%%VALUE ITER-000))
     (CL:WHEN
      (SEARCH-STRING-MATCH? (%WRAPPER-VALUE FILENAME) MATCHLIST)
   ...
   (CL:LET*
    ((DIRNAME NULL)
     (ITER-001 (%THE-CONS-LIST (SECOND DIRECTORYLISTING))))
    (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-001 NIL)) DO
...
(CL:DEFUN TEST-SERVER-LOAD-KB ()
  (CL:LET* ((KBSTRING (|new-PLString|)))
   (CL:SETF (|%Value| KBSTRING) "aircraft-kb")
...
(CL:DEFUN MAKE-PL-QUERY ()
  (CL:LET* ((PLQUERY (|new-PLQuery|)))
   ...
   (CL:SETF (|%IsAsk| PLQUERY) "FALSE")
   (CL:SETF (|%QueryName| PLQUERY) "")
   (CL:SETF (|%InferenceLevel| PLQUERY) "")
   (CL:SETF (|%Timeout| PLQUERY) "") (CL:SETF (|%Moveout| PLQUERY) "")
   (CL:SETF (|%MatchMode| PLQUERY) "PARTIAL")
   (CL:SETF (|%MinScore| PLQUERY) "")
   (CL:SETF (|%MaxUnknowns| PLQUERY) "")
...
(CL:DEFUN TEST-SERVER-DESTROY-OBJECT ()
  (CL:LET* ((MOD (|new-PLString|)) (OBJECT (|new-PLString|)))
   (CL:SETF (|%Value| MOD) "AIRCRAFT-KB")
   (CL:SETF (|%Value| OBJECT) "SWING-WING")
