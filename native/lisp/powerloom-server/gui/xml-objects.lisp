...
(CL:DEFUN |new-PLString| ()
  (CL:LET* ((SELF NULL)) (CL:SETQ SELF (CL:MAKE-INSTANCE (CL:QUOTE |PLString|)))
...
(CL:DEFUN |access-PLString-Slot-Value| (SELF SLOTNAME VALUE SETVALUE?)
  (CL:COND
   ((CL:EQ SLOTNAME |SYM-XML-OBJECTS-GUI-SERVER-Value|)
    (CL:IF SETVALUE? (CL:SETF (|%Value| SELF) (%WRAPPER-VALUE VALUE)) (CL:SETQ VALUE (WRAP-STRING (|%Value| SELF)))))
   (CL:T
...
(CL:DEFUN |new-PLSurrogate| ()
  (CL:LET* ((SELF NULL)) (CL:SETQ SELF (CL:MAKE-INSTANCE (CL:QUOTE |PLSurrogate|)))
   (CL:SETF (|%cdataContent| SELF) STELLA::NULL-STRING) (CL:SETF (|%textContent| SELF) STELLA::NULL-STRING)
...
(CL:DEFUN |access-PLSurrogate-Slot-Value| (SELF SLOTNAME VALUE SETVALUE?)
  (CL:COND
   ((CL:EQ SLOTNAME SYM-XML-OBJECTS-LOGIC-ID)
    (CL:IF SETVALUE? (CL:SETF (%ID SELF) (%WRAPPER-VALUE VALUE)) (CL:SETQ VALUE (WRAP-STRING (%ID SELF)))))
   (CL:T
    (CL:LET* ((STREAM-000 (NEW-OUTPUT-STRING-STREAM)))
     (%%PRINT-STREAM (%NATIVE-STREAM STREAM-000) "`" SLOTNAME "' is not a valid case option")
     (CL:ERROR (NEW-STELLA-EXCEPTION (THE-STRING-READER STREAM-000))))))
...
(CL:DEFUN |new-ServerException| ()
  (CL:LET* ((SELF NULL)) (CL:SETQ SELF (CL:MAKE-INSTANCE (CL:QUOTE |ServerException|)))
   (CL:SETF (|%cdataContent| SELF) STELLA::NULL-STRING) (CL:SETF (|%textContent| SELF) STELLA::NULL-STRING)
   (CL:SETF (|%Message| SELF) STELLA::NULL-STRING) (CL:SETF (|%Type| SELF) STELLA::NULL-STRING) SELF))
...
(CL:DEFUN |new-PLModuleContainer| ()
  (CL:LET* ((SELF NULL)) (CL:SETQ SELF (CL:MAKE-INSTANCE (CL:QUOTE |PLModuleContainer|)))
   (CL:SETF (|%cdataContent| SELF) STELLA::NULL-STRING) (CL:SETF (|%textContent| SELF) STELLA::NULL-STRING)
...
(CL:DEFUN |access-PLModuleContainer-Slot-Value| (SELF SLOTNAME VALUE SETVALUE?)
  (CL:COND
   ((CL:EQ SLOTNAME |SYM-XML-OBJECTS-GUI-SERVER-PLModule|)
    (CL:IF SETVALUE? (CL:SETF (|%PLModule| SELF) VALUE) (CL:SETQ VALUE (|%PLModule| SELF))))
   (CL:T
    (CL:LET* ((STREAM-000 (NEW-OUTPUT-STRING-STREAM)))
     (%%PRINT-STREAM (%NATIVE-STREAM STREAM-000) "`" SLOTNAME "' is not a valid case option")
     (CL:ERROR (NEW-STELLA-EXCEPTION (THE-STRING-READER STREAM-000))))))
...
(CL:DEFCLASS |PLModule| (|XMLObject|)
  ((|ModuleName| :TYPE CL:SIMPLE-STRING :INITFORM STELLA::NULL-STRING :ALLOCATION :INSTANCE :ACCESSOR |%ModuleName|)
   (|SourceString| :TYPE CL:SIMPLE-STRING :INITFORM STELLA::NULL-STRING :ALLOCATION :INSTANCE :ACCESSOR
    |%SourceString|)
   ...
   (|JavaCatchallClass| :TYPE CL:SIMPLE-STRING :INITFORM STELLA::NULL-STRING :ALLOCATION :INSTANCE :ACCESSOR
    |%JavaCatchallClass|)
   (|Documentation| :TYPE CL:SIMPLE-STRING :INITFORM STELLA::NULL-STRING :ALLOCATION :INSTANCE :ACCESSOR
    |%Documentation|)
   (API :TYPE CL:SIMPLE-STRING :INITFORM STELLA::NULL-STRING :ALLOCATION :INSTANCE :ACCESSOR %API)
   (|CaseSensitive| :TYPE CL:SIMPLE-STRING :INITFORM STELLA::NULL-STRING :ALLOCATION :INSTANCE :ACCESSOR
    |%CaseSensitive|)
   (|PLModule| :ALLOCATION :INSTANCE :ACCESSOR |%PLModule|)
   (|PLSurrogate| :ALLOCATION :INSTANCE :ACCESSOR |%PLSurrogate|)))

(CL:DEFUN |new-PLModule| ()
  (CL:LET* ((SELF NULL)) (CL:SETQ SELF (CL:MAKE-INSTANCE (CL:QUOTE |PLModule|)))
   (CL:SETF (|%cdataContent| SELF) STELLA::NULL-STRING) (CL:SETF (|%textContent| SELF) STELLA::NULL-STRING)
   (CL:SETF (|%PLSurrogate| SELF) NULL) (CL:SETF (|%PLModule| SELF) NULL)
   (CL:SETF (|%CaseSensitive| SELF) STELLA::NULL-STRING) (CL:SETF (%API SELF) STELLA::NULL-STRING)
   (CL:SETF (|%Documentation| SELF) STELLA::NULL-STRING) (CL:SETF (|%JavaCatchallClass| SELF) STELLA::NULL-STRING)
   (CL:SETF (|%JavaPackage| SELF) STELLA::NULL-STRING) (CL:SETF (|%LispPackage| SELF) STELLA::NULL-STRING)
   (CL:SETF (|%CppPackage| SELF) STELLA::NULL-STRING) (CL:SETF (|%SourceString| SELF) STELLA::NULL-STRING)
...
(CL:DEFUN |access-PLModule-Slot-Value| (SELF SLOTNAME VALUE SETVALUE?)
  (CL:COND
   ...
   ((CL:EQ SLOTNAME |SYM-XML-OBJECTS-GUI-SERVER-JavaCatchallClass|)
    (CL:IF SETVALUE? (CL:SETF (|%JavaCatchallClass| SELF) (%WRAPPER-VALUE VALUE))
   ...
   ((CL:EQ SLOTNAME SYM-XML-OBJECTS-GUI-SERVER-API)
    (CL:IF SETVALUE? (CL:SETF (%API SELF) (%WRAPPER-VALUE VALUE)) (CL:SETQ VALUE (WRAP-STRING (%API SELF)))))
   ...
   ((CL:EQ SLOTNAME |SYM-XML-OBJECTS-GUI-SERVER-PLSurrogate|)
    (CL:IF SETVALUE? (CL:SETF (|%PLSurrogate| SELF) VALUE) (CL:SETQ VALUE (|%PLSurrogate| SELF))))
   (CL:T
    (CL:LET* ((STREAM-000 (NEW-OUTPUT-STRING-STREAM)))
     (%%PRINT-STREAM (%NATIVE-STREAM STREAM-000) "`" SLOTNAME "' is not a valid case option")
     (CL:ERROR (NEW-STELLA-EXCEPTION (THE-STRING-READER STREAM-000))))))
...
(CL:DEFUN |new-PLConcept| ()
  (CL:LET* ((SELF NULL)) (CL:SETQ SELF (CL:MAKE-INSTANCE (CL:QUOTE |PLConcept|)))
   (CL:SETF (|%cdataContent| SELF) STELLA::NULL-STRING) (CL:SETF (|%textContent| SELF) STELLA::NULL-STRING)
   (CL:SETF (|%PLSurrogate| SELF) NULL) (CL:SETF (|%PLConcept| SELF) NULL)
   (CL:SETF (|%SourceString| SELF) STELLA::NULL-STRING) (CL:SETF (|%Module| SELF) STELLA::NULL-STRING)
...
(CL:DEFUN |access-PLConcept-Slot-Value| (SELF SLOTNAME VALUE SETVALUE?)
  (CL:COND
   ...
   ((CL:EQ SLOTNAME |SYM-XML-OBJECTS-GUI-SERVER-PLConcept|)
    (CL:IF SETVALUE? (CL:SETF (|%PLConcept| SELF) VALUE) (CL:SETQ VALUE (|%PLConcept| SELF))))
   ((CL:EQ SLOTNAME |SYM-XML-OBJECTS-GUI-SERVER-PLSurrogate|)
    (CL:IF SETVALUE? (CL:SETF (|%PLSurrogate| SELF) VALUE) (CL:SETQ VALUE (|%PLSurrogate| SELF))))
   (CL:T
    (CL:LET* ((STREAM-000 (NEW-OUTPUT-STRING-STREAM)))
...
(CL:DEFUN |new-PLConceptContainer| ()
  (CL:LET* ((SELF NULL)) (CL:SETQ SELF (CL:MAKE-INSTANCE (CL:QUOTE |PLConceptContainer|)))
   (CL:SETF (|%cdataContent| SELF) STELLA::NULL-STRING) (CL:SETF (|%textContent| SELF) STELLA::NULL-STRING)
...
(CL:DEFCLASS |PLRelation| (|XMLObject|)
  ((|RelationName| :TYPE CL:SIMPLE-STRING :INITFORM STELLA::NULL-STRING :ALLOCATION :INSTANCE :ACCESSOR
    |%RelationName|)
   (|SourceString| :TYPE CL:SIMPLE-STRING :INITFORM STELLA::NULL-STRING :ALLOCATION :INSTANCE :ACCESSOR
    |%SourceString|)
   (|Module| :TYPE CL:SIMPLE-STRING :INITFORM STELLA::NULL-STRING :ALLOCATION :INSTANCE :ACCESSOR |%Module|)
...
(CL:DEFUN |new-PLRelation| ()
  (CL:LET* ((SELF NULL)) (CL:SETQ SELF (CL:MAKE-INSTANCE (CL:QUOTE |PLRelation|)))
   (CL:SETF (|%cdataContent| SELF) STELLA::NULL-STRING) (CL:SETF (|%textContent| SELF) STELLA::NULL-STRING)
   (CL:SETF (|%PLSurrogate| SELF) NULL) (CL:SETF (|%PLRelation| SELF) NULL)
   (CL:SETF (|%IsClosed| SELF) STELLA::NULL-STRING) (CL:SETF (|%IsFunction| SELF) STELLA::NULL-STRING)
   (CL:SETF (|%Module| SELF) STELLA::NULL-STRING) (CL:SETF (|%SourceString| SELF) STELLA::NULL-STRING)
...
(CL:DEFUN |access-PLRelation-Slot-Value| (SELF SLOTNAME VALUE SETVALUE?)
  (CL:COND
   ...
   ((CL:EQ SLOTNAME |SYM-XML-OBJECTS-GUI-SERVER-PLRelation|)
    (CL:IF SETVALUE? (CL:SETF (|%PLRelation| SELF) VALUE) (CL:SETQ VALUE (|%PLRelation| SELF))))
   ((CL:EQ SLOTNAME |SYM-XML-OBJECTS-GUI-SERVER-PLSurrogate|)
    (CL:IF SETVALUE? (CL:SETF (|%PLSurrogate| SELF) VALUE) (CL:SETQ VALUE (|%PLSurrogate| SELF))))
   (CL:T
    (CL:LET* ((STREAM-000 (NEW-OUTPUT-STRING-STREAM)))
...
(CL:DEFUN |new-PLRelationContainer| ()
  (CL:LET* ((SELF NULL)) (CL:SETQ SELF (CL:MAKE-INSTANCE (CL:QUOTE |PLRelationContainer|)))
   (CL:SETF (|%cdataContent| SELF) STELLA::NULL-STRING) (CL:SETF (|%textContent| SELF) STELLA::NULL-STRING)
...
(CL:DEFCLASS |PLInstance| (|XMLObject|)
  ((|InstanceName| :TYPE CL:SIMPLE-STRING :INITFORM STELLA::NULL-STRING :ALLOCATION :INSTANCE :ACCESSOR
    |%InstanceName|)
   (|Module| :TYPE CL:SIMPLE-STRING :INITFORM STELLA::NULL-STRING :ALLOCATION :INSTANCE :ACCESSOR |%Module|)
   (|SourceString| :TYPE CL:SIMPLE-STRING :INITFORM STELLA::NULL-STRING :ALLOCATION :INSTANCE :ACCESSOR
    |%SourceString|)))
...
(CL:DEFUN |new-PLInstance| ()
  (CL:LET* ((SELF NULL)) (CL:SETQ SELF (CL:MAKE-INSTANCE (CL:QUOTE |PLInstance|)))
   (CL:SETF (|%cdataContent| SELF) STELLA::NULL-STRING) (CL:SETF (|%textContent| SELF) STELLA::NULL-STRING)
   (CL:SETF (|%SourceString| SELF) STELLA::NULL-STRING) (CL:SETF (|%Module| SELF) STELLA::NULL-STRING)
...
(CL:DEFUN |new-PLInstanceContainer| ()
  (CL:LET* ((SELF NULL)) (CL:SETQ SELF (CL:MAKE-INSTANCE (CL:QUOTE |PLInstanceContainer|)))
   (CL:SETF (|%cdataContent| SELF) STELLA::NULL-STRING) (CL:SETF (|%textContent| SELF) STELLA::NULL-STRING)
...
(CL:DEFUN |access-PLInstanceContainer-Slot-Value| (SELF SLOTNAME VALUE SETVALUE?)
  (CL:COND
   ((CL:EQ SLOTNAME |SYM-XML-OBJECTS-GUI-SERVER-PLInstance|)
    (CL:IF SETVALUE? (CL:SETF (|%PLInstance| SELF) VALUE) (CL:SETQ VALUE (|%PLInstance| SELF))))
   (CL:T
    (CL:LET* ((STREAM-000 (NEW-OUTPUT-STRING-STREAM)))
     (%%PRINT-STREAM (%NATIVE-STREAM STREAM-000) "`" SLOTNAME "' is not a valid case option")
     (CL:ERROR (NEW-STELLA-EXCEPTION (THE-STRING-READER STREAM-000))))))
...
(CL:DEFCLASS |PLProposition| (|XMLObject|)
  ((|PropositionName| :TYPE CL:SIMPLE-STRING :INITFORM STELLA::NULL-STRING :ALLOCATION :INSTANCE :ACCESSOR
    |%PropositionName|)
...
(CL:DEFUN |new-PLProposition| ()
  (CL:LET* ((SELF NULL)) (CL:SETQ SELF (CL:MAKE-INSTANCE (CL:QUOTE |PLProposition|)))
   (CL:SETF (|%cdataContent| SELF) STELLA::NULL-STRING) (CL:SETF (|%textContent| SELF) STELLA::NULL-STRING)
   (CL:SETF (|%IsRule| SELF) STELLA::NULL-STRING) (CL:SETF (|%IsAsserted| SELF) STELLA::NULL-STRING)
...
(CL:DEFUN |access-PLProposition-Slot-Value| (SELF SLOTNAME VALUE SETVALUE?)
  (CL:COND
   ((CL:EQ SLOTNAME |SYM-XML-OBJECTS-GUI-SERVER-PropositionName|)
    (CL:IF SETVALUE? (CL:SETF (|%PropositionName| SELF) (%WRAPPER-VALUE VALUE))
...
(CL:DEFUN |new-PLPropositionContainer| ()
  (CL:LET* ((SELF NULL)) (CL:SETQ SELF (CL:MAKE-INSTANCE (CL:QUOTE |PLPropositionContainer|)))
   (CL:SETF (|%cdataContent| SELF) STELLA::NULL-STRING) (CL:SETF (|%textContent| SELF) STELLA::NULL-STRING)
...
(CL:DEFUN |access-PLPropositionContainer-Slot-Value| (SELF SLOTNAME VALUE SETVALUE?)
  (CL:COND
   ((CL:EQ SLOTNAME |SYM-XML-OBJECTS-GUI-SERVER-PLProposition|)
    (CL:IF SETVALUE? (CL:SETF (|%PLProposition| SELF) VALUE) (CL:SETQ VALUE (|%PLProposition| SELF))))
   (CL:T
    (CL:LET* ((STREAM-000 (NEW-OUTPUT-STRING-STREAM)))
     (%%PRINT-STREAM (%NATIVE-STREAM STREAM-000) "`" SLOTNAME "' is not a valid case option")
     (CL:ERROR (NEW-STELLA-EXCEPTION (THE-STRING-READER STREAM-000))))))
...
(CL:DEFUN |new-PLVariable| ()
  (CL:LET* ((SELF NULL)) (CL:SETQ SELF (CL:MAKE-INSTANCE (CL:QUOTE |PLVariable|)))
   (CL:SETF (|%cdataContent| SELF) STELLA::NULL-STRING) (CL:SETF (|%textContent| SELF) STELLA::NULL-STRING)
   (CL:SETF (|%VariableType| SELF) NULL) (CL:SETF (|%VariableName| SELF) NULL) SELF))
...
(CL:DEFUN |access-PLVariable-Slot-Value| (SELF SLOTNAME VALUE SETVALUE?)
  (CL:COND
   ((CL:EQ SLOTNAME |SYM-XML-OBJECTS-GUI-SERVER-VariableName|)
    (CL:IF SETVALUE? (CL:SETF (|%VariableName| SELF) VALUE) (CL:SETQ VALUE (|%VariableName| SELF))))
   ((CL:EQ SLOTNAME |SYM-XML-OBJECTS-GUI-SERVER-VariableType|)
    (CL:IF SETVALUE? (CL:SETF (|%VariableType| SELF) VALUE) (CL:SETQ VALUE (|%VariableType| SELF))))
   (CL:T
    (CL:LET* ((STREAM-000 (NEW-OUTPUT-STRING-STREAM)))
     (%%PRINT-STREAM (%NATIVE-STREAM STREAM-000) "`" SLOTNAME "' is not a valid case option")
     (CL:ERROR (NEW-STELLA-EXCEPTION (THE-STRING-READER STREAM-000))))))
...
(CL:DEFUN |new-PLVariableList| ()
  (CL:LET* ((SELF NULL)) (CL:SETQ SELF (CL:MAKE-INSTANCE (CL:QUOTE |PLVariableList|)))
   (CL:SETF (|%cdataContent| SELF) STELLA::NULL-STRING) (CL:SETF (|%textContent| SELF) STELLA::NULL-STRING)
...
(CL:DEFUN |access-PLVariableList-Slot-Value| (SELF SLOTNAME VALUE SETVALUE?)
  (CL:COND
   ((CL:EQ SLOTNAME |SYM-XML-OBJECTS-GUI-SERVER-PLVariable|)
    (CL:IF SETVALUE? (CL:SETF (|%PLVariable| SELF) VALUE) (CL:SETQ VALUE (|%PLVariable| SELF))))
   (CL:T
    (CL:LET* ((STREAM-000 (NEW-OUTPUT-STRING-STREAM)))
     (%%PRINT-STREAM (%NATIVE-STREAM STREAM-000) "`" SLOTNAME "' is not a valid case option")
     (CL:ERROR (NEW-STELLA-EXCEPTION (THE-STRING-READER STREAM-000))))))
...
(CL:DEFUN |new-PLModuleFileList| ()
  (CL:LET* ((SELF NULL)) (CL:SETQ SELF (CL:MAKE-INSTANCE (CL:QUOTE |PLModuleFileList|)))
   (CL:SETF (|%cdataContent| SELF) STELLA::NULL-STRING) (CL:SETF (|%textContent| SELF) STELLA::NULL-STRING)
...
(CL:DEFUN |access-PLModuleFileList-Slot-Value| (SELF SLOTNAME VALUE SETVALUE?)
  (CL:COND
   ((CL:EQ SLOTNAME |SYM-XML-OBJECTS-GUI-SERVER-PLModuleFile|)
    (CL:IF SETVALUE? (CL:SETF (|%PLModuleFile| SELF) VALUE) (CL:SETQ VALUE (|%PLModuleFile| SELF))))
   (CL:T
    (CL:LET* ((STREAM-000 (NEW-OUTPUT-STRING-STREAM)))
     (%%PRINT-STREAM (%NATIVE-STREAM STREAM-000) "`" SLOTNAME "' is not a valid case option")
     (CL:ERROR (NEW-STELLA-EXCEPTION (THE-STRING-READER STREAM-000))))))
...
(CL:DEFCLASS |PLModuleFile| (|XMLObject|)
  ((|KBName| :TYPE CL:SIMPLE-STRING :INITFORM STELLA::NULL-STRING :ALLOCATION :INSTANCE :ACCESSOR |%KBName|)
   (|ModuleName| :TYPE CL:SIMPLE-STRING :INITFORM STELLA::NULL-STRING :ALLOCATION :INSTANCE :ACCESSOR |%ModuleName|)
   (|KBDescription| :TYPE CL:SIMPLE-STRING :INITFORM STELLA::NULL-STRING :ALLOCATION :INSTANCE :ACCESSOR
    |%KBDescription|)
...
(CL:DEFUN |new-PLModuleFile| ()
  (CL:LET* ((SELF NULL)) (CL:SETQ SELF (CL:MAKE-INSTANCE (CL:QUOTE |PLModuleFile|)))
   (CL:SETF (|%cdataContent| SELF) STELLA::NULL-STRING) (CL:SETF (|%textContent| SELF) STELLA::NULL-STRING)
   (CL:SETF (|%FileName| SELF) STELLA::NULL-STRING) (CL:SETF (|%KBDescription| SELF) STELLA::NULL-STRING)
...
(CL:DEFUN |new-PLFile| ()
  (CL:LET* ((SELF NULL)) (CL:SETQ SELF (CL:MAKE-INSTANCE (CL:QUOTE |PLFile|)))
   (CL:SETF (|%cdataContent| SELF) STELLA::NULL-STRING) (CL:SETF (|%textContent| SELF) STELLA::NULL-STRING)
   (CL:SETF (|%PLFileContent| SELF) NULL) (CL:SETF (|%FileName| SELF) STELLA::NULL-STRING) SELF))
...
(CL:DEFUN |access-PLFile-Slot-Value| (SELF SLOTNAME VALUE SETVALUE?)
  (CL:COND
   ...
   ((CL:EQ SLOTNAME |SYM-XML-OBJECTS-GUI-SERVER-PLFileContent|)
    (CL:IF SETVALUE? (CL:SETF (|%PLFileContent| SELF) VALUE) (CL:SETQ VALUE (|%PLFileContent| SELF))))
   (CL:T
    (CL:LET* ((STREAM-000 (NEW-OUTPUT-STRING-STREAM)))
     (%%PRINT-STREAM (%NATIVE-STREAM STREAM-000) "`" SLOTNAME "' is not a valid case option")
     (CL:ERROR (NEW-STELLA-EXCEPTION (THE-STRING-READER STREAM-000))))))
...
(CL:DEFUN |new-PLFileContent| ()
  (CL:LET* ((SELF NULL)) (CL:SETQ SELF (CL:MAKE-INSTANCE (CL:QUOTE |PLFileContent|)))
...
(CL:DEFCLASS |PLDirectory| (|XMLObject|)
  ((|DirectoryName| :TYPE CL:SIMPLE-STRING :INITFORM STELLA::NULL-STRING :ALLOCATION :INSTANCE :ACCESSOR
    |%DirectoryName|)))

(CL:DEFUN |new-PLDirectory| ()
  (CL:LET* ((SELF NULL)) (CL:SETQ SELF (CL:MAKE-INSTANCE (CL:QUOTE |PLDirectory|)))
   (CL:SETF (|%cdataContent| SELF) STELLA::NULL-STRING) (CL:SETF (|%textContent| SELF) STELLA::NULL-STRING)
...
(CL:DEFUN |new-PLDirectoryContents| ()
  (CL:LET* ((SELF NULL)) (CL:SETQ SELF (CL:MAKE-INSTANCE (CL:QUOTE |PLDirectoryContents|)))
   (CL:SETF (|%cdataContent| SELF) STELLA::NULL-STRING) (CL:SETF (|%textContent| SELF) STELLA::NULL-STRING)
...
(CL:DEFUN |access-PLDirectoryContents-Slot-Value| (SELF SLOTNAME VALUE SETVALUE?)
  (CL:COND
   ...
   ((CL:EQ SLOTNAME |SYM-XML-OBJECTS-GUI-SERVER-PLDirectory|)
    (CL:IF SETVALUE? (CL:SETF (|%PLDirectory| SELF) VALUE) (CL:SETQ VALUE (|%PLDirectory| SELF))))
   ((CL:EQ SLOTNAME |SYM-XML-OBJECTS-GUI-SERVER-PLFile|)
    (CL:IF SETVALUE? (CL:SETF (|%PLFile| SELF) VALUE) (CL:SETQ VALUE (|%PLFile| SELF))))
   (CL:T
    (CL:LET* ((STREAM-000 (NEW-OUTPUT-STRING-STREAM)))
     (%%PRINT-STREAM (%NATIVE-STREAM STREAM-000) "`" SLOTNAME "' is not a valid case option")
     (CL:ERROR (NEW-STELLA-EXCEPTION (THE-STRING-READER STREAM-000))))))
...
(CL:DEFUN |new-PLSurrogateCollection| ()
  (CL:LET* ((SELF NULL)) (CL:SETQ SELF (CL:MAKE-INSTANCE (CL:QUOTE |PLSurrogateCollection|)))
   (CL:SETF (|%cdataContent| SELF) STELLA::NULL-STRING) (CL:SETF (|%textContent| SELF) STELLA::NULL-STRING)
...
(CL:DEFCLASS |PLObjectUnion| (|XMLObject|)
  ((|Type| :TYPE CL:SIMPLE-STRING :INITFORM STELLA::NULL-STRING :ALLOCATION :INSTANCE :ACCESSOR |%Type|)
   (|PLSurrogate| :ALLOCATION :INSTANCE :ACCESSOR |%PLSurrogate|)
   (|LiteralValue| :TYPE CL:SIMPLE-STRING :INITFORM STELLA::NULL-STRING :ALLOCATION :INSTANCE :ACCESSOR
    |%LiteralValue|)))

(CL:DEFUN |new-PLObjectUnion| ()
  (CL:LET* ((SELF NULL)) (CL:SETQ SELF (CL:MAKE-INSTANCE (CL:QUOTE |PLObjectUnion|)))
   (CL:SETF (|%cdataContent| SELF) STELLA::NULL-STRING) (CL:SETF (|%textContent| SELF) STELLA::NULL-STRING)
   (CL:SETF (|%LiteralValue| SELF) STELLA::NULL-STRING) (CL:SETF (|%PLSurrogate| SELF) NULL)
...
(CL:DEFUN |new-PLTuple| ()
  (CL:LET* ((SELF NULL)) (CL:SETQ SELF (CL:MAKE-INSTANCE (CL:QUOTE |PLTuple|)))
   (CL:SETF (|%cdataContent| SELF) STELLA::NULL-STRING) (CL:SETF (|%textContent| SELF) STELLA::NULL-STRING)
...
(CL:DEFUN |access-PLTuple-Slot-Value| (SELF SLOTNAME VALUE SETVALUE?)
  (CL:COND
   ((CL:EQ SLOTNAME |SYM-XML-OBJECTS-GUI-SERVER-PLObjectUnion|)
    (CL:IF SETVALUE? (CL:SETF (|%PLObjectUnion| SELF) VALUE) (CL:SETQ VALUE (|%PLObjectUnion| SELF))))
   (CL:T
    (CL:LET* ((STREAM-000 (NEW-OUTPUT-STRING-STREAM)))
     (%%PRINT-STREAM (%NATIVE-STREAM STREAM-000) "`" SLOTNAME "' is not a valid case option")
     (CL:ERROR (NEW-STELLA-EXCEPTION (THE-STRING-READER STREAM-000))))))
...
(CL:DEFCLASS |PLQuery| (|XMLObject|)
  ((|IsAsk| :TYPE CL:SIMPLE-STRING :INITFORM STELLA::NULL-STRING :ALLOCATION :INSTANCE :ACCESSOR |%IsAsk|)
   ...
   (|Module| :TYPE CL:SIMPLE-STRING :INITFORM STELLA::NULL-STRING :ALLOCATION :INSTANCE :ACCESSOR |%Module|)
   (|InferenceLevel| :TYPE CL:SIMPLE-STRING :INITFORM STELLA::NULL-STRING :ALLOCATION :INSTANCE :ACCESSOR
    |%InferenceLevel|)
   ...
   (|MaximizeScore| :TYPE CL:SIMPLE-STRING :INITFORM STELLA::NULL-STRING :ALLOCATION :INSTANCE :ACCESSOR
    |%MaximizeScore|)
   (|DontOptimize| :TYPE CL:SIMPLE-STRING :INITFORM STELLA::NULL-STRING :ALLOCATION :INSTANCE :ACCESSOR
    |%DontOptimize|)))

(CL:DEFUN |new-PLQuery| ()
  (CL:LET* ((SELF NULL)) (CL:SETQ SELF (CL:MAKE-INSTANCE (CL:QUOTE |PLQuery|)))
   (CL:SETF (|%cdataContent| SELF) STELLA::NULL-STRING) (CL:SETF (|%textContent| SELF) STELLA::NULL-STRING)
   (CL:SETF (|%DontOptimize| SELF) STELLA::NULL-STRING) (CL:SETF (|%MaximizeScore| SELF) STELLA::NULL-STRING)
   (CL:SETF (|%MaxUnknowns| SELF) STELLA::NULL-STRING) (CL:SETF (|%MinScore| SELF) STELLA::NULL-STRING)
   (CL:SETF (|%NumResults| SELF) STELLA::NULL-STRING) (CL:SETF (|%MatchMode| SELF) STELLA::NULL-STRING)
   (CL:SETF (|%Moveout| SELF) STELLA::NULL-STRING) (CL:SETF (|%Timeout| SELF) STELLA::NULL-STRING)
   (CL:SETF (|%InferenceLevel| SELF) STELLA::NULL-STRING) (CL:SETF (|%Module| SELF) STELLA::NULL-STRING)
   (CL:SETF (|%Query| SELF) STELLA::NULL-STRING) (CL:SETF (|%QueryName| SELF) STELLA::NULL-STRING)
...
(CL:DEFUN |access-PLQuery-Slot-Value| (SELF SLOTNAME VALUE SETVALUE?)
  (CL:COND
   ((CL:EQ SLOTNAME |SYM-XML-OBJECTS-GUI-SERVER-IsAsk|)
    (CL:IF SETVALUE? (CL:SETF (|%IsAsk| SELF) (%WRAPPER-VALUE VALUE)) (CL:SETQ VALUE (WRAP-STRING (|%IsAsk| SELF)))))
   ...
   ((CL:EQ SLOTNAME |SYM-XML-OBJECTS-GUI-SERVER-Query|)
    (CL:IF SETVALUE? (CL:SETF (|%Query| SELF) (%WRAPPER-VALUE VALUE)) (CL:SETQ VALUE (WRAP-STRING (|%Query| SELF)))))
   ((CL:EQ SLOTNAME |SYM-XML-OBJECTS-GUI-SERVER-Module|)
    (CL:IF SETVALUE? (CL:SETF (|%Module| SELF) (%WRAPPER-VALUE VALUE)) (CL:SETQ VALUE (WRAP-STRING (|%Module| SELF)))))
...
(CL:DEFUN |new-PLQueryResult| ()
  (CL:LET* ((SELF NULL)) (CL:SETQ SELF (CL:MAKE-INSTANCE (CL:QUOTE |PLQueryResult|)))
   (CL:SETF (|%cdataContent| SELF) STELLA::NULL-STRING) (CL:SETF (|%textContent| SELF) STELLA::NULL-STRING)
...
(CL:DEFUN |access-PLQueryResult-Slot-Value| (SELF SLOTNAME VALUE SETVALUE?)
  (CL:COND
   ((CL:EQ SLOTNAME |SYM-XML-OBJECTS-GUI-SERVER-PLTuple|)
    (CL:IF SETVALUE? (CL:SETF (|%PLTuple| SELF) VALUE) (CL:SETQ VALUE (|%PLTuple| SELF))))
   (CL:T
    (CL:LET* ((STREAM-000 (NEW-OUTPUT-STRING-STREAM)))
     (%%PRINT-STREAM (%NATIVE-STREAM STREAM-000) "`" SLOTNAME "' is not a valid case option")
     (CL:ERROR (NEW-STELLA-EXCEPTION (THE-STRING-READER STREAM-000))))))
...
(CL:DEFCLASS |PLSearchParameter| (|XMLObject|)
  ((|ModuleName| :TYPE CL:SIMPLE-STRING :INITFORM STELLA::NULL-STRING :ALLOCATION :INSTANCE :ACCESSOR |%ModuleName|)
   (|SearchString| :TYPE CL:SIMPLE-STRING :INITFORM STELLA::NULL-STRING :ALLOCATION :INSTANCE :ACCESSOR
    |%SearchString|)
   (|SearchConcept| :TYPE CL:SIMPLE-STRING :INITFORM STELLA::NULL-STRING :ALLOCATION :INSTANCE :ACCESSOR
    |%SearchConcept|)
   (|SearchRelation| :TYPE CL:SIMPLE-STRING :INITFORM STELLA::NULL-STRING :ALLOCATION :INSTANCE :ACCESSOR
    |%SearchRelation|)
   (|SearchInstance| :TYPE CL:SIMPLE-STRING :INITFORM STELLA::NULL-STRING :ALLOCATION :INSTANCE :ACCESSOR
    |%SearchInstance|)
   (|CaseSensitive| :TYPE CL:SIMPLE-STRING :INITFORM STELLA::NULL-STRING :ALLOCATION :INSTANCE :ACCESSOR
    |%CaseSensitive|)))

(CL:DEFUN |new-PLSearchParameter| ()
  (CL:LET* ((SELF NULL)) (CL:SETQ SELF (CL:MAKE-INSTANCE (CL:QUOTE |PLSearchParameter|)))
   (CL:SETF (|%cdataContent| SELF) STELLA::NULL-STRING) (CL:SETF (|%textContent| SELF) STELLA::NULL-STRING)
   (CL:SETF (|%CaseSensitive| SELF) STELLA::NULL-STRING) (CL:SETF (|%SearchInstance| SELF) STELLA::NULL-STRING)
   (CL:SETF (|%SearchRelation| SELF) STELLA::NULL-STRING) (CL:SETF (|%SearchConcept| SELF) STELLA::NULL-STRING)
   (CL:SETF (|%SearchString| SELF) STELLA::NULL-STRING) (CL:SETF (|%ModuleName| SELF) STELLA::NULL-STRING) SELF))
...
(CL:DEFUN |new-PLSearchResult| ()
  (CL:LET* ((SELF NULL)) (CL:SETQ SELF (CL:MAKE-INSTANCE (CL:QUOTE |PLSearchResult|)))
   (CL:SETF (|%cdataContent| SELF) STELLA::NULL-STRING) (CL:SETF (|%textContent| SELF) STELLA::NULL-STRING)
...
(CL:DEFUN |new-PLSearchResultItem| ()
  (CL:LET* ((SELF NULL)) (CL:SETQ SELF (CL:MAKE-INSTANCE (CL:QUOTE |PLSearchResultItem|)))
   (CL:SETF (|%cdataContent| SELF) STELLA::NULL-STRING) (CL:SETF (|%textContent| SELF) STELLA::NULL-STRING)
   (CL:SETF (|%PLObjectUnion| SELF) NULL) (CL:SETF (|%ModuleName| SELF) STELLA::NULL-STRING) SELF))
...
(CL:DEFCLASS |PLServerInfo| (|XMLObject|)
  ((|AllowRemoteFileBrowsing| :TYPE CL:SIMPLE-STRING :INITFORM STELLA::NULL-STRING :ALLOCATION :INSTANCE :ACCESSOR
    |%AllowRemoteFileBrowsing|)))

(CL:DEFUN |new-PLServerInfo| ()
  (CL:LET* ((SELF NULL)) (CL:SETQ SELF (CL:MAKE-INSTANCE (CL:QUOTE |PLServerInfo|)))
   (CL:SETF (|%cdataContent| SELF) STELLA::NULL-STRING) (CL:SETF (|%textContent| SELF) STELLA::NULL-STRING)
...
(CL:DEFUN |access-PLServerInfo-Slot-Value| (SELF SLOTNAME VALUE SETVALUE?)
  (CL:COND
   ((CL:EQ SLOTNAME |SYM-XML-OBJECTS-GUI-SERVER-AllowRemoteFileBrowsing|)
    (CL:IF SETVALUE? (CL:SETF (|%AllowRemoteFileBrowsing| SELF) (%WRAPPER-VALUE VALUE))
...
(CL:DEFUN HELP-STARTUP-XML-OBJECTS1 ()
  (CL:PROGN (CL:SETQ |SGT-XML-OBJECTS-GUI-SERVER-PLString| (INTERN-RIGID-SYMBOL-WRT-MODULE "PLString" NULL 1))
   ...
   (CL:SETQ |SYM-XML-OBJECTS-XML-OBJECTS-textContent|
    (INTERN-RIGID-SYMBOL-WRT-MODULE "textContent" (GET-STELLA-MODULE "/STELLA/XML-OBJECTS" CL:T) 0))
...
(CL:DEFUN HELP-STARTUP-XML-OBJECTS2 ()
  (CL:PROGN
   (CL:SETQ |SYM-XML-OBJECTS-GUI-SERVER-DirectoryName| (INTERN-RIGID-SYMBOL-WRT-MODULE "DirectoryName" NULL 0))
  ...
  (CL:LET*
   ...
   (CL:WHEN (CURRENT-STARTUP-TIME-PHASE? 5)
    (CL:LET*
     ...
     (CL:SETF (%CLASS-SLOT-ACCESSOR-CODE CLASS) (CL:FUNCTION |access-PLString-Slot-Value|)))
    (CL:LET*
     ((CLASS
     ...
     (CL:SETF (%CLASS-SLOT-ACCESSOR-CODE CLASS) (CL:FUNCTION |access-PLSurrogate-Slot-Value|)))
    (CL:LET*
     ((CLASS
    ...
    (CL:LET*
     ...
     (CL:SETF (%CLASS-SLOT-ACCESSOR-CODE CLASS) (CL:FUNCTION |access-PLModule-Slot-Value|)))
    (CL:LET*
     ((CLASS
     ...
     (CL:SETF (%CLASS-SLOT-ACCESSOR-CODE CLASS) (CL:FUNCTION |access-PLConcept-Slot-Value|)))
    (CL:LET*
     ((CLASS
    ...
    (CL:LET*
     ...
     (CL:SETF (%CLASS-SLOT-ACCESSOR-CODE CLASS) (CL:FUNCTION |access-PLRelation-Slot-Value|)))
    (CL:LET*
     ((CLASS
    ...
    (CL:LET*
     ...
     (CL:SETF (%CLASS-SLOT-ACCESSOR-CODE CLASS) (CL:FUNCTION |access-PLInstance-Slot-Value|)))
    (CL:LET*
     ((CLASS
    ...
    (CL:LET*
     ...
     (CL:SETF (%CLASS-SLOT-ACCESSOR-CODE CLASS) (CL:FUNCTION |access-PLRule-Slot-Value|)))
    (CL:LET*
     ((CLASS
     ...
     (CL:SETF (%CLASS-SLOT-ACCESSOR-CODE CLASS) (CL:FUNCTION |access-PLVariable-Slot-Value|)))
    (CL:LET*
     ((CLASS
    ...
    (CL:LET*
     ...
     (CL:SETF (%CLASS-SLOT-ACCESSOR-CODE CLASS) (CL:FUNCTION |access-PLFile-Slot-Value|)))
    (CL:LET*
     ((CLASS
    ...
    (CL:LET*
     ...
     (CL:SETF (%CLASS-SLOT-ACCESSOR-CODE CLASS) (CL:FUNCTION |access-PLDirectory-Slot-Value|)))
    (CL:LET*
     ((CLASS
    ...
    (CL:LET*
     ...
     (CL:SETF (%CLASS-SLOT-ACCESSOR-CODE CLASS) (CL:FUNCTION |access-PLTuple-Slot-Value|)))
    (CL:LET*
     ((CLASS
     ...
     (CL:SETF (%CLASS-SLOT-ACCESSOR-CODE CLASS) (CL:FUNCTION |access-PLQuery-Slot-Value|)))
    (CL:LET*
     ((CLASS
   ...
   (CL:WHEN (CURRENT-STARTUP-TIME-PHASE? 7)
    ...
    (DEFINE-FUNCTION-OBJECT " |PLSurrogate<|"
     "(DEFUN (|PLSurrogate<| BOOLEAN) ((INST1 |PLSurrogate|) (INST2 |PLSurrogate|)))" (CL:FUNCTION |PLSurrogate<|)
     NULL)
    (DEFINE-FUNCTION-OBJECT " |PLModule<|" "(DEFUN (|PLModule<| BOOLEAN) ((INST1 |PLModule|) (INST2 |PLModule|)))"
     (CL:FUNCTION |PLModule<|) NULL)
    (DEFINE-FUNCTION-OBJECT " |PLInstance<|"
     "(DEFUN (|PLInstance<| BOOLEAN) ((INST1 |PLInstance|) (INST2 |PLInstance|)))" (CL:FUNCTION |PLInstance<|) NULL)
    (DEFINE-FUNCTION-OBJECT " |PLConcept<|" "(DEFUN (|PLConcept<| BOOLEAN) ((INST1 |PLConcept|) (INST2 |PLConcept|)))"
     (CL:FUNCTION |PLConcept<|) NULL)
    (DEFINE-FUNCTION-OBJECT " |PLRelation<|"
     "(DEFUN (|PLRelation<| BOOLEAN) ((INST1 |PLRelation|) (INST2 |PLRelation|)))" (CL:FUNCTION |PLRelation<|) NULL)
    (DEFINE-FUNCTION-OBJECT "STARTUP-XML-OBJECTS" "(DEFUN STARTUP-XML-OBJECTS () :PUBLIC? TRUE)"
     (CL:FUNCTION STARTUP-XML-OBJECTS) NULL)
    (CL:LET* ((FUNCTION (LOOKUP-FUNCTION SYM-XML-OBJECTS-GUI-SERVER-STARTUP-XML-OBJECTS)))
     (SET-DYNAMIC-SLOT-VALUE (%DYNAMIC-SLOTS FUNCTION) SYM-XML-OBJECTS-STELLA-METHOD-STARTUP-CLASSNAME
