  ...
  (CL:LET*
   ...
   (CL:COND
    ((SUBTYPE-OF? (SAFE-PRIMARY-TYPE SELF)
      SGT-EXPLANATIONS-LOGIC-PROPOSITION)
     (CL:PROGN
   ...
   (CL:LET* ((TEST-VALUE-000 (SAFE-PRIMARY-TYPE SELF)))
    (CL:COND
     ((SUBTYPE-OF? TEST-VALUE-000
       SGT-EXPLANATIONS-STELLA-LITERAL-WRAPPER)
      (CL:PROGN (PPRINT-LITERAL-WRAPPER-FOR-HTML SELF STREAM)))
     ((SUBTYPE-OF? TEST-VALUE-000
       SGT-EXPLANATIONS-LOGIC-PATTERN-VARIABLE)
    ...
    ((SUBTYPE-OF? TEST-VALUE-000 SGT-EXPLANATIONS-LOGIC-LOGIC-OBJECT)
     (CL:PROGN
      (CL:LET* ((WRITEMODULE (HOME-MODULE OBJECT)))
       (PLGUI-WRITE-URL-IN-DETAIL STREAM STELLA::NULL-STRING ACTION
        OBJECTTYPE (NAME WRITEMODULE) (OBJECT-STRING-NAME OBJECT)
...
(CL:DEFUN PRINT-JUSTIFICATION-TO-HTML-FILE (JUSTIFICATION FILE)
  ...
  (CL:LET*
   ...
   (CL:DECLARE
     ...
     *LOGIC-DIALECT* *MOST-RECENT-EXPLANATION-MAPPING*))
   (CL:WHEN
    (CL:EQ (LOOKUP *LOGIC-DIALECT-PRINT-FUNCTIONS* *LOGIC-DIALECT*)
     NULL)
    ...
    (CL:UNWIND-PROTECT
     (CL:PROGN (CL:SETQ STREAM (OPEN-OUTPUT-FILE FILE))
      (%%PRINT-STREAM (%NATIVE-STREAM STREAM) EOL
       "Explanation #1 score=" (%POSITIVE-SCORE JUSTIFICATION) ":" EOL
       EOL)
      (PRINT-WHYNOT-JUSTIFICATION (VISIBLE-JUSTIFICATION JUSTIFICATION)
       STREAM NULL-INTEGER KWD-EXPLANATIONS-BRIEF CL:NIL))
  ...
  (CL:LET*
   ...
   (CL:LET*
    ...
    (CL:LET* ((RESULT (THE-STRING-READER STRINGSTREAM)))
     ...
     (CL:WHEN
      (CL:NOT
       (CL:EQ *PLGUI-EXPLANATION-TRACE-FILE* STELLA::NULL-STRING))
      (CL:LET* ((OUT NULL))
       (CL:UNWIND-PROTECT
        (CL:PROGN
         (CL:SETQ OUT
          (OPEN-OUTPUT-FILE *PLGUI-EXPLANATION-TRACE-FILE*))
  ...
  (CL:LET*
   ...
   (CL:WHEN (CURRENT-STARTUP-TIME-PHASE? 7)
    ...
    (CL:LET*
     ((FUNCTION
       (LOOKUP-FUNCTION
        SYM-EXPLANATIONS-GUI-SERVER-STARTUP-EXPLANATIONS)))
   ...
   (CL:WHEN (CURRENT-STARTUP-TIME-PHASE? 9)
    ...
    (REGISTER-LOGIC-DIALECT-PRINT-FUNCTION
     KWD-EXPLANATIONS-JAVA-GUI-HTML
