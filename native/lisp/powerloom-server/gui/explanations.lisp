...
(CL:DECLAIM
 (CL:SPECIAL *STARTUP-TIME-PHASE* *MODULE* NULL-FLOAT *LOGIC-DIALECT-PRINT-FUNCTIONS* *LOGIC-DIALECT*
  *MOST-RECENT-EXPLANATION-MAPPING* NULL-INTEGER STANDARD-OUTPUT STANDARD-ERROR VALUE-OF-SEPARATOR *PLGUI-URL-ACTION*
  EOL))
...
(CL:DEFUN PLGUI-HTML-PPRINT-OBJECT (SELF STREAM)
  (CL:LET*
   ((*LOGIC-DIALECT* KWD-EXPLANATIONS-KIF)
    (*PPRINT-ATOMIC-OBJECT-RENDERER* (CL:FUNCTION PLGUI-HTML-PPRINT-ATOMIC-OBJECT)))
    ...
    ((SUBTYPE-OF? (SAFE-PRIMARY-TYPE SELF) SGT-EXPLANATIONS-LOGIC-PROPOSITION)
     (CL:PROGN
      (CL:LET* ((TEST-VALUE-000 (%KIND SELF)))
       (CL:COND
        ((CL:OR (CL:EQ TEST-VALUE-000 KWD-EXPLANATIONS-ISA) (CL:EQ TEST-VALUE-000 KWD-EXPLANATIONS-FUNCTION)
          (CL:EQ TEST-VALUE-000 KWD-EXPLANATIONS-PREDICATE) (CL:EQ TEST-VALUE-000 KWD-EXPLANATIONS-NOT)
   ...
   (CL:LET* ((TEST-VALUE-000 (SAFE-PRIMARY-TYPE SELF)))
    (CL:COND
     ...
     ((SUBTYPE-OF? TEST-VALUE-000 SGT-EXPLANATIONS-LOGIC-LOGIC-OBJECT)
      (CL:PROGN
       (CL:IF (CL:NOT (CL:EQ (%SURROGATE-VALUE-INVERSE SELF) NULL)) (PRINT-PLGUI-URL SELF STREAM)
    ...
    ((SUBTYPE-OF? TEST-VALUE-000 SGT-EXPLANATIONS-LOGIC-LOGIC-OBJECT)
     (CL:PROGN
      (CL:LET* ((WRITEMODULE (HOME-MODULE OBJECT)))
       (PLGUI-WRITE-URL-IN-DETAIL STREAM STELLA::NULL-STRING ACTION OBJECTTYPE (NAME WRITEMODULE)
        (OBJECT-STRING-NAME OBJECT) (OBJECT-STRING-NAME OBJECT) CL:NIL))))
    ((SUBTYPE-OF? TEST-VALUE-000 SGT-EXPLANATIONS-STELLA-MODULE)
     (CL:PROGN
      (PLGUI-WRITE-URL-IN-DETAIL STREAM STELLA::NULL-STRING ACTION OBJECTTYPE (NAME OBJECT) (NAME OBJECT) (NAME OBJECT)
       CL:NIL)))
    (CL:T
     (%%PRINT-STREAM (%NATIVE-STREAM STANDARD-OUTPUT) STANDARD-ERROR "Don't know how to write URL for object" OBJECT)
...
(CL:DEFUN PRINT-JUSTIFICATION-TO-HTML-FILE (JUSTIFICATION FILE)
  ...
  (CL:LET*
   ((*EXPLANATION-FORMAT* KWD-EXPLANATIONS-HTML) (*EXPLANATION-AUDIENCE* KWD-EXPLANATIONS-LAY)
    (*LOGIC-DIALECT* KWD-EXPLANATIONS-KIF-ONTOSAURUS) (*MOST-RECENT-EXPLANATION-MAPPING* (NEW-KEY-VALUE-LIST)))
   (CL:DECLARE
    (CL:SPECIAL *EXPLANATION-FORMAT* *EXPLANATION-AUDIENCE* *LOGIC-DIALECT* *MOST-RECENT-EXPLANATION-MAPPING*))
   (CL:WHEN (CL:EQ (LOOKUP *LOGIC-DIALECT-PRINT-FUNCTIONS* *LOGIC-DIALECT*) NULL)
   ...
   (CL:LET* ((STREAM NULL))
    (CL:UNWIND-PROTECT
     (CL:PROGN (CL:SETQ STREAM (OPEN-OUTPUT-FILE FILE))
      (%%PRINT-STREAM (%NATIVE-STREAM STREAM) EOL "Explanation #1 score=" (%POSITIVE-SCORE JUSTIFICATION) ":" EOL EOL)
      (PRINT-WHYNOT-JUSTIFICATION (VISIBLE-JUSTIFICATION JUSTIFICATION) STREAM NULL-INTEGER KWD-EXPLANATIONS-BRIEF
       CL:NIL))
...
(CL:DEFUN GET-JUSTIFICATION-STRING (JUSTIFICATION)
  (CL:LET*
   ((*EXPLANATION-FORMAT* KWD-EXPLANATIONS-HTML) (*EXPLANATION-AUDIENCE* KWD-EXPLANATIONS-LAY)
    (*LOGIC-DIALECT* KWD-EXPLANATIONS-JAVA-GUI-HTML) (*MOST-RECENT-EXPLANATION-MAPPING* (NEW-KEY-VALUE-LIST)))
   (CL:DECLARE
    (CL:SPECIAL *EXPLANATION-FORMAT* *EXPLANATION-AUDIENCE* *LOGIC-DIALECT* *MOST-RECENT-EXPLANATION-MAPPING*))
   (CL:LET*
    ...
    (CL:WHEN (CL:NOT (CL:= (%POSITIVE-SCORE JUSTIFICATION) NULL-FLOAT))
     (%%PRINT-STREAM (%NATIVE-STREAM STRINGSTREAM) " score=" (%POSITIVE-SCORE JUSTIFICATION)))
    (%%PRINT-STREAM (%NATIVE-STREAM STRINGSTREAM) ":" EOL EOL)
    (PRINT-WHYNOT-JUSTIFICATION (VISIBLE-JUSTIFICATION JUSTIFICATION) STRINGSTREAM NULL-INTEGER KWD-EXPLANATIONS-BRIEF
     CL:NIL)
    (CL:LET* ((RESULT (THE-STRING-READER STRINGSTREAM))) (CL:DECLARE (CL:TYPE CL:SIMPLE-STRING RESULT))
     (CL:WHEN (CL:NOT (CL:EQ *PLGUI-EXPLANATION-TRACE-FILE* STELLA::NULL-STRING))
      (CL:LET* ((OUT NULL))
       (CL:UNWIND-PROTECT
        (CL:PROGN (CL:SETQ OUT (OPEN-OUTPUT-FILE *PLGUI-EXPLANATION-TRACE-FILE*))
...
(CL:DEFUN STARTUP-EXPLANATIONS ()
  (CL:LET*
   ...
   (CL:WHEN (CURRENT-STARTUP-TIME-PHASE? 2)
    (CL:SETQ KWD-EXPLANATIONS-KIF (INTERN-RIGID-SYMBOL-WRT-MODULE "KIF" NULL 2))
    (CL:SETQ KWD-EXPLANATIONS-ISA (INTERN-RIGID-SYMBOL-WRT-MODULE "ISA" NULL 2))
    (CL:SETQ KWD-EXPLANATIONS-FUNCTION (INTERN-RIGID-SYMBOL-WRT-MODULE "FUNCTION" NULL 2))
    (CL:SETQ KWD-EXPLANATIONS-PREDICATE (INTERN-RIGID-SYMBOL-WRT-MODULE "PREDICATE" NULL 2))
    (CL:SETQ KWD-EXPLANATIONS-NOT (INTERN-RIGID-SYMBOL-WRT-MODULE "NOT" NULL 2))
   ...
   (CL:WHEN (CURRENT-STARTUP-TIME-PHASE? 4) (CL:SETQ *PLGUI-EXPLANATION-TRACE-FILE* STELLA::NULL-STRING))
   (CL:WHEN (CURRENT-STARTUP-TIME-PHASE? 6) (FINALIZE-CLASSES))
   (CL:WHEN (CURRENT-STARTUP-TIME-PHASE? 7)
    (DEFINE-FUNCTION-OBJECT "PLGUI-HTML-PPRINT-OBJECT"
     "(DEFUN PLGUI-HTML-PPRINT-OBJECT ((SELF OBJECT) (STREAM OUTPUT-STREAM)))" (CL:FUNCTION PLGUI-HTML-PPRINT-OBJECT)
     NULL)
    ...
    (DEFINE-FUNCTION-OBJECT "GET-JUSTIFICATION-STRING"
     "(DEFUN (GET-JUSTIFICATION-STRING STRING) ((JUSTIFICATION JUSTIFICATION)))" (CL:FUNCTION GET-JUSTIFICATION-STRING)
     NULL)
