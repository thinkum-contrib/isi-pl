...
(CL:DECLAIM
 (CL:SPECIAL STELLA::*STARTUP-TIME-PHASE* STELLA::STANDARD-OUTPUT STELLA::EOL STELLA::*MODULE* STELLA::NIL STELLA::*CONTEXT* STELLA::*POWERLOOM-LOCK*
  STELLA::NULL-INTEGER))
...
(CL:DEFUN |new-module| ()
  (CL:LET* ((SELF STELLA::NULL)) (CL:SETQ SELF (CL:MAKE-INSTANCE (CL:QUOTE |module|))) (CL:SETF (STELLA::|%cdataContent| SELF) STELLA::NULL-STRING)
...
(CL:DEFCLASS |nresults| (STELLA::|XMLObject|)
  ((STELLA::|type| :TYPE CL:SIMPLE-STRING :INITFORM STELLA::NULL-STRING :ALLOCATION :INSTANCE :ACCESSOR STELLA::|%type|)))

(CL:DEFUN |new-nresults| ()
  (CL:LET* ((SELF STELLA::NULL)) (CL:SETQ SELF (CL:MAKE-INSTANCE (CL:QUOTE |nresults|))) (CL:SETF (STELLA::|%cdataContent| SELF) STELLA::NULL-STRING)
   (CL:SETF (STELLA::|%textContent| SELF) STELLA::NULL-STRING) (CL:SETF (STELLA::|%type| SELF) STELLA::NULL-STRING) SELF))
...
(CL:DEFUN |access-nresults-Slot-Value| (SELF SLOTNAME VALUE SETVALUE?)
  (CL:COND
   ((CL:EQ SLOTNAME |SYM-SOAP-SERVER-XSI-type|)
    (CL:IF SETVALUE? (CL:SETF (STELLA::|%type| SELF) (STELLA::%WRAPPER-VALUE VALUE)) (CL:SETQ VALUE (STELLA::WRAP-STRING (STELLA::|%type| SELF)))))
   (CL:T
...
(CL:DEFUN |new-pattern| ()
  (CL:LET* ((SELF STELLA::NULL)) (CL:SETQ SELF (CL:MAKE-INSTANCE (CL:QUOTE |pattern|))) (CL:SETF (STELLA::|%cdataContent| SELF) STELLA::NULL-STRING)
   (CL:SETF (STELLA::|%textContent| SELF) STELLA::NULL-STRING) SELF))
...
(CL:DEFUN |new-options| ()
  (CL:LET* ((SELF STELLA::NULL)) (CL:SETQ SELF (CL:MAKE-INSTANCE (CL:QUOTE |options|))) (CL:SETF (STELLA::|%cdataContent| SELF) STELLA::NULL-STRING)
   (CL:SETF (STELLA::|%textContent| SELF) STELLA::NULL-STRING) SELF))
...
(CL:DEFUN NEW-SOAP-COMMAND ()
  (CL:LET* ((SELF STELLA::NULL)) (CL:SETQ SELF (CL:MAKE-INSTANCE (CL:QUOTE SOAP-COMMAND))) (CL:SETF (STELLA::|%cdataContent| SELF) STELLA::NULL-STRING)
...
(CL:DEFUN ACCESS-SOAP-COMMAND-SLOT-VALUE (SELF SLOTNAME VALUE SETVALUE?)
  (CL:COND ((CL:EQ SLOTNAME SYM-SOAP-SERVER-PLSOAP-TARGET-MODULE) (CL:IF SETVALUE? (CL:SETF (%TARGET-MODULE SELF) VALUE) (CL:SETQ VALUE (%TARGET-MODULE SELF))))
   (CL:T
    (CL:LET* ((STREAM-000 (STELLA::NEW-OUTPUT-STRING-STREAM))) (STELLA::%%PRINT-STREAM (STELLA::%NATIVE-STREAM STREAM-000) "`" SLOTNAME "' is not a valid case option")
     (CL:ERROR (STELLA::NEW-STELLA-EXCEPTION (STELLA::THE-STRING-READER STREAM-000))))))
  VALUE)
...
(CL:DEFUN |new-command| ()
  (CL:LET* ((SELF STELLA::NULL)) (CL:SETQ SELF (CL:MAKE-INSTANCE (CL:QUOTE |command|))) (CL:SETF (STELLA::|%cdataContent| SELF) STELLA::NULL-STRING)
   (CL:SETF (STELLA::|%textContent| SELF) STELLA::NULL-STRING) (CL:SETF (%TARGET-MODULE SELF) STELLA::NULL) SELF))
...
(CL:DEFUN |new-assertion| ()
  (CL:LET* ((SELF STELLA::NULL)) (CL:SETQ SELF (CL:MAKE-INSTANCE (CL:QUOTE |assertion|))) (CL:SETF (STELLA::|%cdataContent| SELF) STELLA::NULL-STRING)
   (CL:SETF (STELLA::|%textContent| SELF) STELLA::NULL-STRING) (CL:SETF (%TARGET-MODULE SELF) STELLA::NULL) SELF))
...
(CL:DEFUN |new-retraction| ()
  (CL:LET* ((SELF STELLA::NULL)) (CL:SETQ SELF (CL:MAKE-INSTANCE (CL:QUOTE |retraction|))) (CL:SETF (STELLA::|%cdataContent| SELF) STELLA::NULL-STRING)
   (CL:SETF (STELLA::|%textContent| SELF) STELLA::NULL-STRING) (CL:SETF (%TARGET-MODULE SELF) STELLA::NULL) SELF))
...
(CL:DEFUN |new-ask| ()
  (CL:LET* ((SELF STELLA::NULL)) (CL:SETQ SELF (CL:MAKE-INSTANCE (CL:QUOTE |ask|))) (CL:SETF (STELLA::|%cdataContent| SELF) STELLA::NULL-STRING)
   (CL:SETF (STELLA::|%textContent| SELF) STELLA::NULL-STRING) (CL:SETF (STELLA::%OPTIONS SELF) STELLA::NULL) (CL:SETF (%TARGET-MODULE SELF) STELLA::NULL) SELF))
...
(CL:DEFUN |access-ask-Slot-Value| (SELF SLOTNAME VALUE SETVALUE?)
  (CL:COND ((CL:EQ SLOTNAME SYM-SOAP-SERVER-PLSOAP-TARGET-MODULE) (CL:IF SETVALUE? (CL:SETF (%TARGET-MODULE SELF) VALUE) (CL:SETQ VALUE (%TARGET-MODULE SELF))))
   ((CL:EQ SLOTNAME SYM-SOAP-SERVER-STELLA-OPTIONS) (CL:IF SETVALUE? (CL:SETF (STELLA::%OPTIONS SELF) VALUE) (CL:SETQ VALUE (STELLA::%OPTIONS SELF))))
   (CL:T
    (CL:LET* ((STREAM-000 (STELLA::NEW-OUTPUT-STRING-STREAM))) (STELLA::%%PRINT-STREAM (STELLA::%NATIVE-STREAM STREAM-000) "`" SLOTNAME "' is not a valid case option")
     (CL:ERROR (STELLA::NEW-STELLA-EXCEPTION (STELLA::THE-STRING-READER STREAM-000))))))
  VALUE)
...
(CL:DEFCLASS |retrieval| (SOAP-COMMAND)
  ((NRESULTS :ALLOCATION :INSTANCE :ACCESSOR %NRESULTS) (STELLA::PATTERN :ALLOCATION :INSTANCE :ACCESSOR STELLA::%PATTERN)
   (STELLA::OPTIONS :ALLOCATION :INSTANCE :ACCESSOR STELLA::%OPTIONS)))

(CL:DEFUN |new-retrieval| ()
  (CL:LET* ((SELF STELLA::NULL)) (CL:SETQ SELF (CL:MAKE-INSTANCE (CL:QUOTE |retrieval|))) (CL:SETF (STELLA::|%cdataContent| SELF) STELLA::NULL-STRING)
   (CL:SETF (STELLA::|%textContent| SELF) STELLA::NULL-STRING) (CL:SETF (STELLA::%OPTIONS SELF) STELLA::NULL) (CL:SETF (STELLA::%PATTERN SELF) STELLA::NULL)
   (CL:SETF (%NRESULTS SELF) STELLA::NULL) (CL:SETF (%TARGET-MODULE SELF) STELLA::NULL) SELF))
...
(CL:DEFUN |access-retrieval-Slot-Value| (SELF SLOTNAME VALUE SETVALUE?)
  (CL:COND ((CL:EQ SLOTNAME SYM-SOAP-SERVER-PLSOAP-TARGET-MODULE) (CL:IF SETVALUE? (CL:SETF (%TARGET-MODULE SELF) VALUE) (CL:SETQ VALUE (%TARGET-MODULE SELF))))
   ((CL:EQ SLOTNAME SYM-SOAP-SERVER-PLSOAP-NRESULTS) (CL:IF SETVALUE? (CL:SETF (%NRESULTS SELF) VALUE) (CL:SETQ VALUE (%NRESULTS SELF))))
   ((CL:EQ SLOTNAME SYM-SOAP-SERVER-LOGIC-PATTERN) (CL:IF SETVALUE? (CL:SETF (STELLA::%PATTERN SELF) VALUE) (CL:SETQ VALUE (STELLA::%PATTERN SELF))))
   ((CL:EQ SLOTNAME SYM-SOAP-SERVER-STELLA-OPTIONS) (CL:IF SETVALUE? (CL:SETF (STELLA::%OPTIONS SELF) VALUE) (CL:SETQ VALUE (STELLA::%OPTIONS SELF))))
   (CL:T
    (CL:LET* ((STREAM-000 (STELLA::NEW-OUTPUT-STRING-STREAM))) (STELLA::%%PRINT-STREAM (STELLA::%NATIVE-STREAM STREAM-000) "`" SLOTNAME "' is not a valid case option")
     (CL:ERROR (STELLA::NEW-STELLA-EXCEPTION (STELLA::THE-STRING-READER STREAM-000))))))
...
(CL:DEFUN |new-query| ()
  (CL:LET* ((SELF STELLA::NULL)) (CL:SETQ SELF (CL:MAKE-INSTANCE (CL:QUOTE |query|))) (CL:SETF (STELLA::|%cdataContent| SELF) STELLA::NULL-STRING)
   (CL:SETF (STELLA::|%textContent| SELF) STELLA::NULL-STRING) SELF))
...
(CL:DEFUN |new-result| ()
  (CL:LET* ((SELF STELLA::NULL)) (CL:SETQ SELF (CL:MAKE-INSTANCE (CL:QUOTE |result|))) (CL:SETF (STELLA::|%cdataContent| SELF) STELLA::NULL-STRING)
   (CL:SETF (STELLA::|%textContent| SELF) STELLA::NULL-STRING) SELF))
...
(CL:DEFCLASS |answer| (STELLA::|XMLObject|)
  ((STELLA::QUERY :ALLOCATION :INSTANCE :ACCESSOR STELLA::%QUERY) (STELLA::RESULT :ALLOCATION :INSTANCE :ACCESSOR STELLA::%RESULT)))

(CL:DEFUN |new-answer| ()
  (CL:LET* ((SELF STELLA::NULL)) (CL:SETQ SELF (CL:MAKE-INSTANCE (CL:QUOTE |answer|))) (CL:SETF (STELLA::|%cdataContent| SELF) STELLA::NULL-STRING)
   (CL:SETF (STELLA::|%textContent| SELF) STELLA::NULL-STRING) (CL:SETF (STELLA::%RESULT SELF) STELLA::NULL) (CL:SETF (STELLA::%QUERY SELF) STELLA::NULL) SELF))
...
(CL:DEFUN |access-answer-Slot-Value| (SELF SLOTNAME VALUE SETVALUE?)
  (CL:COND ((CL:EQ SLOTNAME SYM-SOAP-SERVER-LOGIC-QUERY) (CL:IF SETVALUE? (CL:SETF (STELLA::%QUERY SELF) VALUE) (CL:SETQ VALUE (STELLA::%QUERY SELF))))
   ((CL:EQ SLOTNAME SYM-SOAP-SERVER-STELLA-RESULT) (CL:IF SETVALUE? (CL:SETF (STELLA::%RESULT SELF) VALUE) (CL:SETQ VALUE (STELLA::%RESULT SELF))))
   (CL:T
    (CL:LET* ((STREAM-000 (STELLA::NEW-OUTPUT-STRING-STREAM))) (STELLA::%%PRINT-STREAM (STELLA::%NATIVE-STREAM STREAM-000) "`" SLOTNAME "' is not a valid case option")
     (CL:ERROR (STELLA::NEW-STELLA-EXCEPTION (STELLA::THE-STRING-READER STREAM-000))))))
  VALUE)
...
(CL:DEFUN |new-item| ()
  (CL:LET* ((SELF STELLA::NULL)) (CL:SETQ SELF (CL:MAKE-INSTANCE (CL:QUOTE |item|))) (CL:SETF (STELLA::|%cdataContent| SELF) STELLA::NULL-STRING)
   (CL:SETF (STELLA::|%textContent| SELF) STELLA::NULL-STRING) (CL:SETF (STELLA::|%type| SELF) STELLA::NULL-STRING) SELF))
...
(CL:DEFUN |new-proposition| ()
  (CL:LET* ((SELF STELLA::NULL)) (CL:SETQ SELF (CL:MAKE-INSTANCE (CL:QUOTE |proposition|))) (CL:SETF (STELLA::|%cdataContent| SELF) STELLA::NULL-STRING)
   (CL:SETF (STELLA::|%textContent| SELF) STELLA::NULL-STRING) SELF))
...
(CL:DEFUN |new-tuple| ()
  (CL:LET* ((SELF STELLA::NULL)) (CL:SETQ SELF (CL:MAKE-INSTANCE (CL:QUOTE |tuple|))) (CL:SETF (STELLA::|%cdataContent| SELF) STELLA::NULL-STRING)
   (CL:SETF (STELLA::|%textContent| SELF) STELLA::NULL-STRING) (CL:SETF (STELLA::%ITEM SELF) STELLA::NULL) (CL:SETF (%NRESULTS SELF) STELLA::NULL) SELF))
...
(CL:DEFUN |access-tuple-Slot-Value| (SELF SLOTNAME VALUE SETVALUE?)
  (CL:COND ((CL:EQ SLOTNAME SYM-SOAP-SERVER-PLSOAP-NRESULTS) (CL:IF SETVALUE? (CL:SETF (%NRESULTS SELF) VALUE) (CL:SETQ VALUE (%NRESULTS SELF))))
   ((CL:EQ SLOTNAME SYM-SOAP-SERVER-STELLA-ITEM) (CL:IF SETVALUE? (CL:SETF (STELLA::%ITEM SELF) VALUE) (CL:SETQ VALUE (STELLA::%ITEM SELF))))
   (CL:T
    (CL:LET* ((STREAM-000 (STELLA::NEW-OUTPUT-STRING-STREAM))) (STELLA::%%PRINT-STREAM (STELLA::%NATIVE-STREAM STREAM-000) "`" SLOTNAME "' is not a valid case option")
     (CL:ERROR (STELLA::NEW-STELLA-EXCEPTION (STELLA::THE-STRING-READER STREAM-000))))))
  VALUE)
...
(CL:DEFUN |new-tuples| ()
  (CL:LET* ((SELF STELLA::NULL)) (CL:SETQ SELF (CL:MAKE-INSTANCE (CL:QUOTE |tuples|))) (CL:SETF (STELLA::|%cdataContent| SELF) STELLA::NULL-STRING)
   (CL:SETF (STELLA::|%textContent| SELF) STELLA::NULL-STRING) (CL:SETF (%TUPLE SELF) STELLA::NULL) (CL:SETF (STELLA::%PATTERN SELF) STELLA::NULL)
   (CL:SETF (STELLA::%QUERY SELF) STELLA::NULL) (CL:SETF (%NRESULTS SELF) STELLA::NULL) SELF))
...
(CL:DEFUN |access-tuples-Slot-Value| (SELF SLOTNAME VALUE SETVALUE?)
  (CL:COND ((CL:EQ SLOTNAME SYM-SOAP-SERVER-PLSOAP-NRESULTS) (CL:IF SETVALUE? (CL:SETF (%NRESULTS SELF) VALUE) (CL:SETQ VALUE (%NRESULTS SELF))))
   ((CL:EQ SLOTNAME SYM-SOAP-SERVER-LOGIC-QUERY) (CL:IF SETVALUE? (CL:SETF (STELLA::%QUERY SELF) VALUE) (CL:SETQ VALUE (STELLA::%QUERY SELF))))
   ((CL:EQ SLOTNAME SYM-SOAP-SERVER-LOGIC-PATTERN) (CL:IF SETVALUE? (CL:SETF (STELLA::%PATTERN SELF) VALUE) (CL:SETQ VALUE (STELLA::%PATTERN SELF))))
   ((CL:EQ SLOTNAME SYM-SOAP-SERVER-PLSOAP-TUPLE) (CL:IF SETVALUE? (CL:SETF (%TUPLE SELF) VALUE) (CL:SETQ VALUE (%TUPLE SELF))))
   (CL:T
    (CL:LET* ((STREAM-000 (STELLA::NEW-OUTPUT-STRING-STREAM))) (STELLA::%%PRINT-STREAM (STELLA::%NATIVE-STREAM STREAM-000) "`" SLOTNAME "' is not a valid case option")
     (CL:ERROR (STELLA::NEW-STELLA-EXCEPTION (STELLA::THE-STRING-READER STREAM-000))))))
  VALUE)
...
(CL:DEFCLASS |propositions| (STELLA::|XMLObject|)
  ((NRESULTS :ALLOCATION :INSTANCE :ACCESSOR %NRESULTS) (STELLA::PROPOSITION :ALLOCATION :INSTANCE :ACCESSOR STELLA::%PROPOSITION)))

(CL:DEFUN |new-propositions| ()
  (CL:LET* ((SELF STELLA::NULL)) (CL:SETQ SELF (CL:MAKE-INSTANCE (CL:QUOTE |propositions|))) (CL:SETF (STELLA::|%cdataContent| SELF) STELLA::NULL-STRING)
   (CL:SETF (STELLA::|%textContent| SELF) STELLA::NULL-STRING) (CL:SETF (STELLA::%PROPOSITION SELF) STELLA::NULL) (CL:SETF (%NRESULTS SELF) STELLA::NULL) SELF))
...
(CL:DEFUN |access-propositions-Slot-Value| (SELF SLOTNAME VALUE SETVALUE?)
  (CL:COND ((CL:EQ SLOTNAME SYM-SOAP-SERVER-PLSOAP-NRESULTS) (CL:IF SETVALUE? (CL:SETF (%NRESULTS SELF) VALUE) (CL:SETQ VALUE (%NRESULTS SELF))))
   ((CL:EQ SLOTNAME SYM-SOAP-SERVER-LOGIC-PROPOSITION) (CL:IF SETVALUE? (CL:SETF (STELLA::%PROPOSITION SELF) VALUE) (CL:SETQ VALUE (STELLA::%PROPOSITION SELF))))
   (CL:T
    (CL:LET* ((STREAM-000 (STELLA::NEW-OUTPUT-STRING-STREAM))) (STELLA::%%PRINT-STREAM (STELLA::%NATIVE-STREAM STREAM-000) "`" SLOTNAME "' is not a valid case option")
     (CL:ERROR (STELLA::NEW-STELLA-EXCEPTION (STELLA::THE-STRING-READER STREAM-000))))))
  VALUE)
...
(CL:DEFUN |new-powerloomerror| ()
  (CL:LET* ((SELF STELLA::NULL)) (CL:SETQ SELF (CL:MAKE-INSTANCE (CL:QUOTE |powerloomerror|))) (CL:SETF (STELLA::|%cdataContent| SELF) STELLA::NULL-STRING)
   (CL:SETF (STELLA::|%textContent| SELF) STELLA::NULL-STRING) SELF))
...
(CL:DEFUN |new-stellaerror| ()
  (CL:LET* ((SELF STELLA::NULL)) (CL:SETQ SELF (CL:MAKE-INSTANCE (CL:QUOTE |stellaerror|))) (CL:SETF (STELLA::|%cdataContent| SELF) STELLA::NULL-STRING)
   (CL:SETF (STELLA::|%textContent| SELF) STELLA::NULL-STRING) SELF))
...
(CL:DEFUN |new-nativeerror| ()
  (CL:LET* ((SELF STELLA::NULL)) (CL:SETQ SELF (CL:MAKE-INSTANCE (CL:QUOTE |nativeerror|))) (CL:SETF (STELLA::|%cdataContent| SELF) STELLA::NULL-STRING)
   (CL:SETF (STELLA::|%textContent| SELF) STELLA::NULL-STRING) SELF))
...
(CL:DEFUN POWERLOOM-PROCESS-SOAP-REQUEST (REQUEST-BODY)
  ...
  (CL:LET* ((ANSWER STELLA::NULL) (REQUEST STELLA::NULL))
   (CL:LET* ((STELLA::*DEFAULT-XML-OBJECT-MODULE* *POWERLOOM-SOAP-MODULE*)) (CL:DECLARE (CL:SPECIAL STELLA::*DEFAULT-XML-OBJECT-MODULE*))
    (CL:HANDLER-CASE
     (CL:PROGN (CL:SETQ REQUEST (STELLA::FROM-XML-STRING REQUEST-BODY)) (CL:SETQ ANSWER (PROCESS-SOAP-ENCODED-COMMAND (STELLA::|%contents| (STELLA::|%body| REQUEST)))))
     (STELLA::LOGIC-EXCEPTION (E) (CL:SETQ ANSWER (|new-powerloomerror|)) (STELLA::SET-CONTENT ANSWER (STELLA::EXCEPTION-MESSAGE E))
      (CL:SETQ ANSWER (STELLA::CREATE-SOAP-FAULT "SOAP-ENV:Server" "PowerLoom error" STELLA::NULL-STRING ANSWER)))
     (STELLA::STELLA-EXCEPTION (E) (CL:SETQ ANSWER (|new-stellaerror|)) (STELLA::SET-CONTENT ANSWER (STELLA::EXCEPTION-MESSAGE E))
      (CL:SETQ ANSWER (STELLA::CREATE-SOAP-FAULT "SOAP-ENV:Server" "PowerLoom error" STELLA::NULL-STRING ANSWER)))
...
(CL:DEFUN POWERLOOM-SOAP-REQUEST-HANDLER (XCHG)
  "WRITE ME"
  (CL:LET* ((REQUEST (STELLA::GET-REQUEST-BODY XCHG)) (REPLY (STELLA::GET-REPLY-STREAM XCHG))) (CL:DECLARE (CL:TYPE CL:SIMPLE-STRING REQUEST))
    ...
    (CL:COND ((STELLA::SUBTYPE-OF? TEST-VALUE-000 |SGT-SOAP-SERVER-PLSOAP-ask|) (CL:PROGN))
     ...
     (CL:T
      (CL:LET* ((STREAM-000 (STELLA::NEW-OUTPUT-STRING-STREAM)))
       (STELLA::%%PRINT-STREAM (STELLA::%NATIVE-STREAM STREAM-000) "Command not supported in read-only mode.`" COMMAND-FORM "'")
       (CL:ERROR (STELLA::NEW-STELLA-EXCEPTION (STELLA::THE-STRING-READER STREAM-000)))))))))

;;; (DEFUN (PROCESS-SOAP-ENCODED-COMMAND |XMLObject|) ...)

(CL:DEFUN PROCESS-SOAP-ENCODED-COMMAND (COMMAND-FORM)
  (CL:LET* ((MODULE-NAME (SAFE-GET-CONTENT (%TARGET-MODULE COMMAND-FORM))) (MODULE STELLA::NULL)) (CL:DECLARE (CL:TYPE CL:SIMPLE-STRING MODULE-NAME))
   (CHECK-READ-ONLY COMMAND-FORM)
   (CL:WHEN (CL:EQ MODULE-NAME STELLA::NULL-STRING)
    (CL:LET* ((STREAM-000 (STELLA::NEW-OUTPUT-STRING-STREAM))) (STELLA::%%PRINT-STREAM (STELLA::%NATIVE-STREAM STREAM-000) "No module specified. `" COMMAND-FORM "'")
     (CL:ERROR (STELLA::NEW-STELLA-EXCEPTION (STELLA::THE-STRING-READER STREAM-000)))))
   ...
   (CL:LET* ((STELLA::*TYPECHECKMODE* KWD-SOAP-SERVER-IGNORE-TYPE-VIOLATIONS)) (CL:DECLARE (CL:SPECIAL STELLA::*TYPECHECKMODE*))
     ...
     (CL:LET* ((TEST-VALUE-000 (STELLA::SAFE-PRIMARY-TYPE COMMAND-FORM)))
      (CL:COND
       ((STELLA::SUBTYPE-OF? TEST-VALUE-000 |SGT-SOAP-SERVER-PLSOAP-command|)
        (CL:PROGN
         (CL:LET* ((COMMAND-STRING (SAFE-GET-CONTENT COMMAND-FORM))) (CL:DECLARE (CL:TYPE CL:SIMPLE-STRING COMMAND-STRING))
          (CL:WHEN (CL:OR (CL:EQ COMMAND-STRING STELLA::NULL-STRING) (STELLA::STRING-EQL? COMMAND-STRING ""))
           (CL:LET* ((STREAM-002 (STELLA::NEW-OUTPUT-STRING-STREAM))) (STELLA::%%PRINT-STREAM (STELLA::%NATIVE-STREAM STREAM-002) "Command was empty.`" COMMAND-FORM "'")
       ...
       ((STELLA::SUBTYPE-OF? TEST-VALUE-000 |SGT-SOAP-SERVER-PLSOAP-assertion|)
        (CL:PROGN
         (CL:LET* ((COMMAND-STRING (SAFE-GET-CONTENT COMMAND-FORM))) (CL:DECLARE (CL:TYPE CL:SIMPLE-STRING COMMAND-STRING))
          (CL:WHEN (CL:OR (CL:EQ COMMAND-STRING STELLA::NULL-STRING) (STELLA::STRING-EQL? COMMAND-STRING ""))
           (CL:LET* ((STREAM-003 (STELLA::NEW-OUTPUT-STRING-STREAM))) (STELLA::%%PRINT-STREAM (STELLA::%NATIVE-STREAM STREAM-003) "Command was empty.`" COMMAND-FORM "'")
       ...
       ((STELLA::SUBTYPE-OF? TEST-VALUE-000 |SGT-SOAP-SERVER-PLSOAP-retraction|)
        (CL:PROGN
         (CL:LET* ((COMMAND-STRING (SAFE-GET-CONTENT COMMAND-FORM))) (CL:DECLARE (CL:TYPE CL:SIMPLE-STRING COMMAND-STRING))
          (CL:WHEN (CL:OR (CL:EQ COMMAND-STRING STELLA::NULL-STRING) (STELLA::STRING-EQL? COMMAND-STRING ""))
           (CL:LET* ((STREAM-004 (STELLA::NEW-OUTPUT-STRING-STREAM))) (STELLA::%%PRINT-STREAM (STELLA::%NATIVE-STREAM STREAM-004) "Command was empty.`" COMMAND-FORM "'")
       ...
       ((STELLA::SUBTYPE-OF? TEST-VALUE-000 |SGT-SOAP-SERVER-PLSOAP-ask|)
        (CL:PROGN
         (CL:LET*
          ((BASE-QUERY-STRING (SAFE-GET-CONTENT COMMAND-FORM)) (QUERY-STRING BASE-QUERY-STRING) (QUERY-OPTIONS (SAFE-GET-CONTENT (STELLA::%OPTIONS COMMAND-FORM))))
          ...
          (CL:WHEN (CL:OR (CL:EQ QUERY-STRING STELLA::NULL-STRING) (STELLA::STRING-EQL? QUERY-STRING ""))
           (CL:LET* ((STREAM-005 (STELLA::NEW-OUTPUT-STRING-STREAM))) (STELLA::%%PRINT-STREAM (STELLA::%NATIVE-STREAM STREAM-005) "Query was empty.`" COMMAND-FORM "'")
       ...
       ((STELLA::SUBTYPE-OF? TEST-VALUE-000 |SGT-SOAP-SERVER-PLSOAP-retrieval|)
        (CL:PROGN
         (CL:LET*
          ((N-RESULTS (SAFE-GET-CONTENT (%NRESULTS COMMAND-FORM))) (QUERY-PATTERN (SAFE-GET-CONTENT (STELLA::%PATTERN COMMAND-FORM)))
           (QUERY-OPTIONS (SAFE-GET-CONTENT (STELLA::%OPTIONS COMMAND-FORM))) (BASE-QUERY-STRING (SAFE-GET-CONTENT COMMAND-FORM)) (QUERY-STRING BASE-QUERY-STRING)
          ...
          (CL:WHEN (CL:OR (CL:EQ QUERY-STRING STELLA::NULL-STRING) (STELLA::STRING-EQL? QUERY-STRING ""))
           (CL:LET* ((STREAM-006 (STELLA::NEW-OUTPUT-STRING-STREAM))) (STELLA::%%PRINT-STREAM (STELLA::%NATIVE-STREAM STREAM-006) "Query was empty.`" COMMAND-FORM "'")
          ...
          (CL:WHEN (CL:NOT (CL:OR (CL:EQ QUERY-PATTERN STELLA::NULL-STRING) (STELLA::STRING-EQL? QUERY-PATTERN "")))
           (CL:IF (CL:NOT (CL:= (STELLA::POSITION QUERY-PATTERN #\( 0) STELLA::NULL-INTEGER)) (CL:SETQ QUERY-STRING (STELLA::CONCATENATE QUERY-PATTERN " " QUERY-STRING))
          ...
          (CL:IF (CL:OR (CL:EQ N-RESULTS STELLA::NULL-STRING) (STELLA::STRING-EQL? N-RESULTS ""))
           (CL:SETQ QUERY-STRING (STELLA::CONCATENATE "/STELLA/ALL " QUERY-STRING)) (CL:SETQ QUERY-STRING (STELLA::CONCATENATE N-RESULTS " " QUERY-STRING)))
          (CL:WHEN (CL:NOT (CL:OR (CL:EQ QUERY-OPTIONS STELLA::NULL-STRING) (STELLA::STRING-EQL? QUERY-OPTIONS "")))
           (CL:SETQ QUERY-STRING (STELLA::CONCATENATE QUERY-STRING " " QUERY-OPTIONS)))
          (CL:LET* ((MDL-000 (PLI::GET-MODULE MODULE-NAME STELLA::NULL)) (CXT-000 MDL-000))
           ...
           (CL:LET* ((STELLA::*MODULE* MDL-000) (STELLA::*CONTEXT* CXT-000)) (CL:DECLARE (CL:SPECIAL STELLA::*MODULE* STELLA::*CONTEXT*))
            (STELLA::WITH-PROCESS-LOCK STELLA::*POWERLOOM-LOCK*
             (CL:LET* ((SEXP STELLA::NULL) (ITER-000 (STELLA::S-EXPRESSIONS (STELLA::NEW-INPUT-STRING-STREAM QUERY-STRING))) (COLLECT-000 STELLA::NULL))
              (CL:LOOP WHILE (STELLA::NEXT? ITER-000) DO (CL:SETQ SEXP (STELLA::%VALUE ITER-000))
               (CL:IF (CL:EQ COLLECT-000 STELLA::NULL)
                (CL:PROGN (CL:SETQ COLLECT-000 (STELLA::CONS SEXP STELLA::NIL))
                 (CL:IF (CL:EQ QUERY-FORM STELLA::NIL) (CL:SETQ QUERY-FORM COLLECT-000) (STELLA::ADD-CONS-TO-END-OF-CONS-LIST QUERY-FORM COLLECT-000)))
...
(CL:DEFUN SOAP-ENCODE-COMMAND-RESPONSE (OBJ)
  (CL:LET* ((STELLA::*PRINTREADABLY?* CL:T) (STELLA::*PRINTMODE* KWD-SOAP-SERVER-REALISTIC)) (CL:DECLARE (CL:SPECIAL STELLA::*PRINTREADABLY?* STELLA::*PRINTMODE*))
...
(CL:DEFUN SOAP-ENCODE-ASSERT-RESPONSE (ITER)
  (CL:LET* ((STELLA::*PRINTREADABLY?* CL:T) (STELLA::*PRINTMODE* KWD-SOAP-SERVER-REALISTIC)) (CL:DECLARE (CL:SPECIAL STELLA::*PRINTREADABLY?* STELLA::*PRINTMODE*))
   (CL:LET* ((ANSWER (|new-propositions|)) (PROPS (STELLA::NEW-LIST)) (PROP-FORM STELLA::NULL) (COUNT (|new-nresults|)) (N 0)) (CL:DECLARE (CL:TYPE CL:FIXNUM N))
    (CL:LET* ((PROP STELLA::NULL) (ITER-000 ITER))
     (CL:LOOP WHILE (STELLA::NEXT? ITER-000) DO (CL:SETQ PROP (STELLA::%VALUE ITER-000)) (CL:SETQ N (CL:1+ N)) (CL:SETQ PROP-FORM (|new-proposition|))
      (STELLA::SET-CONTENT PROP-FORM (STELLA::STRINGIFY PROP)) (STELLA::PUSH PROPS PROP-FORM)))
    (CL:SETF (STELLA::|%textContent| COUNT) (STELLA::INTEGER-TO-STRING (CL:TRUNCATE N))) (CL:SETF (STELLA::|%type| COUNT) "XSD:int") (CL:SETF (%NRESULTS ANSWER) COUNT)
  ...
  (CL:LET* ((STELLA::*PRINTREADABLY?* CL:T) (STELLA::*PRINTMODE* KWD-SOAP-SERVER-REALISTIC)) (CL:DECLARE (CL:SPECIAL STELLA::*PRINTREADABLY?* STELLA::*PRINTMODE*))
   (CL:LET* ((SELF-000 (|new-result|))) (CL:SETF (STELLA::|%textContent| SELF-000) (STELLA::STRINGIFY TV))
    (CL:LET* ((TRUTH-VALUE SELF-000) (ANS (|new-answer|)))
     (CL:LET* ((SELF-002 (|new-query|))) (CL:SETF (STELLA::|%textContent| SELF-002) QUERY-STRING) (CL:SETF (STELLA::%QUERY ANS) SELF-002))
   ...
   (CL:LET* ((TEST-VALUE-000 (STELLA::SAFE-PRIMARY-TYPE OBJ)))
    (CL:COND
     ...
     ((STELLA::SUBTYPE-OF-INTEGER? TEST-VALUE-000)
      (CL:PROGN (CL:SETF (STELLA::|%textContent| ENCODED-ITEM) (STELLA::INTEGER-TO-STRING (CL:TRUNCATE (STELLA::UNWRAP-INTEGER OBJ))))
       (CL:SETF (STELLA::|%type| ENCODED-ITEM) "XSD:int")))
     ((STELLA::SUBTYPE-OF-STRING? TEST-VALUE-000)
      (CL:PROGN (CL:SETF (STELLA::|%cdataContent| ENCODED-ITEM) (STELLA::UNWRAP-STRING OBJ)) (CL:SETF (STELLA::|%type| ENCODED-ITEM) "XSD:string")))
...
(CL:DEFUN SOAP-ENCODE-TUPLE (OBJ)
  (CL:LET* ((RESULT (|new-tuple|)) (ITEMS (STELLA::NEW-LIST)) (COUNT (|new-nresults|)) (N 0)) (CL:DECLARE (CL:TYPE CL:FIXNUM N))
   (CL:COND
    ((CL:EQ (STELLA::SAFE-PRIMARY-TYPE OBJ) SGT-SOAP-SERVER-STELLA-CONS)
     (CL:PROGN
      (CL:LET* ((I STELLA::NULL) (ITER-000 OBJ))
       (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-000 STELLA::NIL)) DO (CL:SETQ I (STELLA::%%VALUE ITER-000)) (CL:SETQ N (CL:1+ N)) (STELLA::PUSH ITEMS (SOAP-ENCODE-ITEM I))
        (CL:SETQ ITER-000 (STELLA::%%REST ITER-000))))))
    (CL:T (CL:SETQ N 1) (STELLA::PUSH ITEMS (SOAP-ENCODE-ITEM OBJ))))
   (CL:SETF (STELLA::|%textContent| COUNT) (STELLA::INTEGER-TO-STRING (CL:TRUNCATE N))) (CL:SETF (STELLA::|%type| COUNT) "XSD:int") (CL:SETF (%NRESULTS RESULT) COUNT)
...
(CL:DEFUN SOAP-ENCODE-RETRIEVAL-ANSWER (QUERY-STRING ITER)
  ...
  (CL:LET* ((STELLA::*PRINTREADABLY?* CL:T) (STELLA::*PRINTMODE* KWD-SOAP-SERVER-REALISTIC)) (CL:DECLARE (CL:SPECIAL STELLA::*PRINTREADABLY?* STELLA::*PRINTMODE*))
   (CL:LET*
    ((RESULT (|new-tuples|)) (TUPLES (STELLA::NEW-LIST)) (COUNT (|new-nresults|)) (THE-QUERY (|new-query|)) (QUERY-PATTERN (|new-pattern|))
     (SS (STELLA::NEW-OUTPUT-STRING-STREAM)) (FIRST? CL:T) (N 0))
    (CL:DECLARE (CL:TYPE CL:FIXNUM N))
    (CL:LET* ((VAR STELLA::NULL) (VECTOR-000 (STELLA::%EXTERNAL-VARIABLES ITER)) (INDEX-000 0) (LENGTH-000 (STELLA::LENGTH VECTOR-000)))
     (CL:DECLARE (CL:TYPE CL:FIXNUM INDEX-000 LENGTH-000))
     (CL:LOOP WHILE (CL:< INDEX-000 LENGTH-000) DO (CL:SETQ VAR (CL:AREF (CL:THE CL:SIMPLE-VECTOR (STELLA::%THE-ARRAY VECTOR-000)) INDEX-000))
      (CL:IF FIRST? (CL:PROGN (STELLA::%%PRINT-STREAM (STELLA::%NATIVE-STREAM SS) "(" (STELLA::%SKOLEM-NAME VAR)) (CL:SETQ FIRST? CL:NIL))
    ...
    (CL:LET* ((ANSWER STELLA::NULL) (ITER-000 (STELLA::CONSIFY-CURRENT-SOLUTIONS ITER)))
     (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-000 STELLA::NIL)) DO (CL:SETQ ANSWER (STELLA::%%VALUE ITER-000)) (CL:SETQ N (CL:1+ N))
      (STELLA::PUSH TUPLES (SOAP-ENCODE-TUPLE ANSWER)) (CL:SETQ ITER-000 (STELLA::%%REST ITER-000))))
    (CL:SETF (STELLA::|%textContent| COUNT) (STELLA::INTEGER-TO-STRING (CL:TRUNCATE N))) (CL:SETF (STELLA::|%type| COUNT) "XSD:int")
    (CL:SETF (STELLA::|%textContent| THE-QUERY) QUERY-STRING) (CL:SETF (STELLA::|%textContent| QUERY-PATTERN) (STELLA::THE-STRING-READER SS))
    (CL:SETF (%NRESULTS RESULT) COUNT) (CL:SETF (STELLA::%QUERY RESULT) THE-QUERY) (CL:SETF (STELLA::%PATTERN RESULT) QUERY-PATTERN)
   ...
   ((REQ (CREATE-TEST-STRING TYPE CONTENT))
    (RES
     (STELLA::%DO-HTTP-REQUEST (STELLA::CONCATENATE "http://" TARGET "/ploom/soap-rpc/powerloom-soap-service")
      (STELLA::CONS-LIST KWD-SOAP-SERVER-METHOD KWD-SOAP-SERVER-POST KWD-SOAP-SERVER-HEADERS (STELLA::MAKE-SOAP-RPC-REQUEST-HEADERS) KWD-SOAP-SERVER-CONTENT
       (STELLA::WRAP-STRING REQ))))
    (R-STREAM (STELLA::NEW-INPUT-STRING-STREAM RES)))
   (CL:DECLARE (CL:TYPE CL:SIMPLE-STRING REQ RES)) (STELLA::%%PRINT-STREAM (STELLA::%NATIVE-STREAM STELLA::STANDARD-OUTPUT) "Sent" EOL REQ EOL)
   (STELLA::%%PRINT-STREAM (STELLA::%NATIVE-STREAM STELLA::STANDARD-OUTPUT) EOL EOL "Received" EOL)
   (CL:LET* ((LINE STELLA::NULL-STRING) (ITER-000 (STELLA::LINES R-STREAM))) (CL:DECLARE (CL:TYPE CL:SIMPLE-STRING LINE))
...
(CL:DEFUN HELP-STARTUP-SOAP-SERVER1 ()
  (CL:PROGN (CL:SETQ |SGT-SOAP-SERVER-PLSOAP-module| (STELLA::INTERN-RIGID-SYMBOL-WRT-MODULE "module" STELLA::NULL 1))
   ...
   (CL:SETQ |SYM-SOAP-SERVER-XSI-type| (STELLA::INTERN-RIGID-SYMBOL-WRT-MODULE "type" (STELLA::GET-STELLA-MODULE "/STELLA/XML-OBJECTS/XSI" CL:T) 0))
   ...
   (CL:SETQ SYM-SOAP-SERVER-PLSOAP-TARGET-MODULE (STELLA::INTERN-RIGID-SYMBOL-WRT-MODULE "TARGET-MODULE" STELLA::NULL 0))
   ...
   (CL:SETQ SYM-SOAP-SERVER-STELLA-OPTIONS (STELLA::INTERN-RIGID-SYMBOL-WRT-MODULE "OPTIONS" (STELLA::GET-STELLA-MODULE "/STELLA" CL:T) 0))
   ...
   (CL:SETQ SYM-SOAP-SERVER-LOGIC-PATTERN (STELLA::INTERN-RIGID-SYMBOL-WRT-MODULE "PATTERN" (STELLA::GET-STELLA-MODULE "/LOGIC" CL:T) 0))
   ...
   (CL:SETQ SYM-SOAP-SERVER-LOGIC-QUERY (STELLA::INTERN-RIGID-SYMBOL-WRT-MODULE "QUERY" (STELLA::GET-STELLA-MODULE "/LOGIC" CL:T) 0))
   (CL:SETQ SYM-SOAP-SERVER-STELLA-RESULT (STELLA::INTERN-RIGID-SYMBOL-WRT-MODULE "RESULT" (STELLA::GET-STELLA-MODULE "/STELLA" CL:T) 0))
   ...
   (CL:SETQ SYM-SOAP-SERVER-STELLA-ITEM (STELLA::INTERN-RIGID-SYMBOL-WRT-MODULE "ITEM" (STELLA::GET-STELLA-MODULE "/STELLA" CL:T) 0))
   ...
   (CL:SETQ |SGT-SOAP-SERVER-PLSOAP-propositions| (STELLA::INTERN-RIGID-SYMBOL-WRT-MODULE "propositions" STELLA::NULL 1))
   (CL:SETQ SYM-SOAP-SERVER-LOGIC-PROPOSITION (STELLA::INTERN-RIGID-SYMBOL-WRT-MODULE "PROPOSITION" (STELLA::GET-STELLA-MODULE "/LOGIC" CL:T) 0))
   (CL:SETQ |SGT-SOAP-SERVER-PLSOAP-powerloomerror| (STELLA::INTERN-RIGID-SYMBOL-WRT-MODULE "powerloomerror" STELLA::NULL 1))
   ...
   (CL:SETQ KWD-SOAP-SERVER-IGNORE-TYPE-VIOLATIONS (STELLA::INTERN-RIGID-SYMBOL-WRT-MODULE "IGNORE-TYPE-VIOLATIONS" STELLA::NULL 2))
   (CL:SETQ KWD-SOAP-SERVER-REALISTIC (STELLA::INTERN-RIGID-SYMBOL-WRT-MODULE "REALISTIC" STELLA::NULL 2))
   (CL:SETQ SGT-SOAP-SERVER-STELLA-CONS (STELLA::INTERN-RIGID-SYMBOL-WRT-MODULE "CONS" (STELLA::GET-STELLA-MODULE "/STELLA" CL:T) 1))
   ...
   (CL:SETQ SYM-SOAP-SERVER-PLSOAP-STARTUP-SOAP-SERVER (STELLA::INTERN-RIGID-SYMBOL-WRT-MODULE "STARTUP-SOAP-SERVER" STELLA::NULL 0))
...
(CL:DEFUN STARTUP-SOAP-SERVER ()
  (CL:LET* ((STELLA::*MODULE* (STELLA::GET-STELLA-MODULE "/POWERLOOM-SERVER/PLSOAP" (STELLA::> STELLA::*STARTUP-TIME-PHASE* 1))) (STELLA::*CONTEXT* STELLA::*MODULE*))
   (CL:DECLARE (CL:SPECIAL STELLA::*MODULE* STELLA::*CONTEXT*)) (CL:WHEN (STELLA::CURRENT-STARTUP-TIME-PHASE? 2) (HELP-STARTUP-SOAP-SERVER1))
   (CL:WHEN (STELLA::CURRENT-STARTUP-TIME-PHASE? 4) (CL:SETQ *POWERLOOM-SOAP-MODULE* (STELLA::GET-STELLA-MODULE "PLSOAP" CL:T)))
   (CL:WHEN (STELLA::CURRENT-STARTUP-TIME-PHASE? 5)
    ...
    (CL:LET*
     ((CLASS
       (STELLA::DEFINE-CLASS-FROM-STRINGIFIED-SOURCE "nresults" "(DEFCLASS |nresults| (|XMLObject|) :PUBLIC-SLOTS ((/STELLA/XML-OBJECTS/XSI/|type| :TYPE STRING)))")))
    ...
    (CL:LET*
     ((CLASS
       (STELLA::DEFINE-CLASS-FROM-STRINGIFIED-SOURCE "SOAP-COMMAND" "(DEFCLASS SOAP-COMMAND (|XMLObject|) :DOCUMENTATION \"Common parent in type hierarchy.  This will
not actually be realized in surface syntax.\" :PUBLIC-SLOTS ((TARGET-MODULE :TYPE |module|)))")))
    ...
    (CL:LET* ((CLASS (STELLA::DEFINE-CLASS-FROM-STRINGIFIED-SOURCE "command" "(DEFCLASS |command| (SOAP-COMMAND) :PUBLIC-SLOTS ((TARGET-MODULE :TYPE |module|)))")))
    ...
    (CL:LET* ((CLASS (STELLA::DEFINE-CLASS-FROM-STRINGIFIED-SOURCE "assertion" "(DEFCLASS |assertion| (SOAP-COMMAND) :PUBLIC-SLOTS ((TARGET-MODULE :TYPE |module|)))")))
    ...
    (CL:LET*
     ((CLASS (STELLA::DEFINE-CLASS-FROM-STRINGIFIED-SOURCE "retraction" "(DEFCLASS |retraction| (SOAP-COMMAND) :PUBLIC-SLOTS ((TARGET-MODULE :TYPE |module|)))")))
    ...
    (CL:LET*
     ((CLASS
       (STELLA::DEFINE-CLASS-FROM-STRINGIFIED-SOURCE "ask" "(DEFCLASS |ask| (SOAP-COMMAND) :PUBLIC-SLOTS ((TARGET-MODULE :TYPE |module|) (OPTIONS :TYPE |options|)))")))
     (CL:SETF (STELLA::%CLASS-CONSTRUCTOR-CODE CLASS) (CL:FUNCTION |new-ask|)) (CL:SETF (STELLA::%CLASS-SLOT-ACCESSOR-CODE CLASS) (CL:FUNCTION |access-ask-Slot-Value|)))
    (CL:LET*
     ((CLASS
    ...
    (CL:LET*
     ((CLASS (STELLA::DEFINE-CLASS-FROM-STRINGIFIED-SOURCE "answer" "(DEFCLASS |answer| (|XMLObject|) :PUBLIC-SLOTS ((QUERY :TYPE |query|) (RESULT :TYPE |result|)))")))
    ...
    (CL:LET*
     ((CLASS (STELLA::DEFINE-CLASS-FROM-STRINGIFIED-SOURCE "item" "(DEFCLASS |item| (|XMLObject|) :PUBLIC-SLOTS ((/STELLA/XML-OBJECTS/XSI/|type| :TYPE STRING)))")))
    ...
    (CL:LET* ((CLASS (STELLA::DEFINE-CLASS-FROM-STRINGIFIED-SOURCE "proposition" "(DEFCLASS |proposition| (|XMLObject|))")))
    ...
    (CL:LET* ((CLASS (STELLA::DEFINE-CLASS-FROM-STRINGIFIED-SOURCE "powerloomerror" "(DEFCLASS |powerloomerror| (|XMLObject|))")))
     (CL:SETF (STELLA::%CLASS-CONSTRUCTOR-CODE CLASS) (CL:FUNCTION |new-powerloomerror|)))
    (CL:LET* ((CLASS (STELLA::DEFINE-CLASS-FROM-STRINGIFIED-SOURCE "stellaerror" "(DEFCLASS |stellaerror| (|XMLObject|))")))
     (CL:SETF (STELLA::%CLASS-CONSTRUCTOR-CODE CLASS) (CL:FUNCTION |new-stellaerror|)))
    (CL:LET* ((CLASS (STELLA::DEFINE-CLASS-FROM-STRINGIFIED-SOURCE "nativeerror" "(DEFCLASS |nativeerror| (|XMLObject|))")))
   ...
   (CL:WHEN (STELLA::CURRENT-STARTUP-TIME-PHASE? 7)
    (STELLA::DEFINE-FUNCTION-OBJECT "POWERLOOM-PROCESS-SOAP-REQUEST" "(DEFUN (POWERLOOM-PROCESS-SOAP-REQUEST STRING) ((REQUEST-BODY STRING)))"
     (CL:FUNCTION POWERLOOM-PROCESS-SOAP-REQUEST) STELLA::NULL)
    (STELLA::DEFINE-FUNCTION-OBJECT "POWERLOOM-SOAP-REQUEST-HANDLER"
     "(DEFUN POWERLOOM-SOAP-REQUEST-HANDLER ((XCHG /HTTP/HTTP-EXCHANGE)) :DOCUMENTATION \"WRITE ME\" :PUBLIC? TRUE)" (CL:FUNCTION POWERLOOM-SOAP-REQUEST-HANDLER)
     STELLA::NULL)
    (STELLA::DEFINE-FUNCTION-OBJECT "SAFE-GET-CONTENT" "(DEFUN (SAFE-GET-CONTENT STRING) ((OBJ |XMLObject|)))" (CL:FUNCTION SAFE-GET-CONTENT) STELLA::NULL)
    (STELLA::DEFINE-FUNCTION-OBJECT "CHECK-READ-ONLY" "(DEFUN CHECK-READ-ONLY ((COMMAND-FORM SOAP-COMMAND)))" (CL:FUNCTION CHECK-READ-ONLY) STELLA::NULL)
    (STELLA::DEFINE-FUNCTION-OBJECT "PROCESS-SOAP-ENCODED-COMMAND" "(DEFUN (PROCESS-SOAP-ENCODED-COMMAND |XMLObject|) ((COMMAND-FORM SOAP-COMMAND)))"
     (CL:FUNCTION PROCESS-SOAP-ENCODED-COMMAND) STELLA::NULL)
    (STELLA::DEFINE-FUNCTION-OBJECT "SOAP-ENCODE-COMMAND-RESPONSE" "(DEFUN (SOAP-ENCODE-COMMAND-RESPONSE |XMLObject|) ((OBJ OBJECT)))"
     (CL:FUNCTION SOAP-ENCODE-COMMAND-RESPONSE) STELLA::NULL)
    (STELLA::DEFINE-FUNCTION-OBJECT "SOAP-ENCODE-ASSERT-RESPONSE" "(DEFUN (SOAP-ENCODE-ASSERT-RESPONSE |XMLObject|) ((ITER (/PLI/PL-ITERATOR OF PROPOSITION))))"
     (CL:FUNCTION SOAP-ENCODE-ASSERT-RESPONSE) STELLA::NULL)
    (STELLA::DEFINE-FUNCTION-OBJECT "SOAP-ENCODE-SIMPLE-ANSWER" "(DEFUN (SOAP-ENCODE-SIMPLE-ANSWER |XMLObject|) ((QUERY-STRING STRING) (TV TRUTH-VALUE)))"
     (CL:FUNCTION SOAP-ENCODE-SIMPLE-ANSWER) STELLA::NULL)
    (STELLA::DEFINE-FUNCTION-OBJECT "SOAP-ENCODE-ITEM" "(DEFUN (SOAP-ENCODE-ITEM |item|) ((OBJ OBJECT)))" (CL:FUNCTION SOAP-ENCODE-ITEM) STELLA::NULL)
    (STELLA::DEFINE-FUNCTION-OBJECT "SOAP-ENCODE-TUPLE" "(DEFUN (SOAP-ENCODE-TUPLE |tuple|) ((OBJ OBJECT)))" (CL:FUNCTION SOAP-ENCODE-TUPLE) STELLA::NULL)
    (STELLA::DEFINE-FUNCTION-OBJECT "SOAP-ENCODE-RETRIEVAL-ANSWER" "(DEFUN (SOAP-ENCODE-RETRIEVAL-ANSWER |XMLObject|) ((QUERY-STRING STRING) (ITER QUERY-ITERATOR)))"
     (CL:FUNCTION SOAP-ENCODE-RETRIEVAL-ANSWER) STELLA::NULL)
    (STELLA::DEFINE-FUNCTION-OBJECT "BUILD-AND-SEND-REQUEST" "(DEFUN BUILD-AND-SEND-REQUEST ((TARGET STRING) (TYPE STRING) (CONTENT STRING)))"
     (CL:FUNCTION BUILD-AND-SEND-REQUEST) STELLA::NULL)
    (STELLA::DEFINE-FUNCTION-OBJECT "CREATE-TEST-STRING" "(DEFUN (CREATE-TEST-STRING STRING) ((BODY-TAG-NAME STRING) (CONTENT STRING)))" (CL:FUNCTION CREATE-TEST-STRING)
     STELLA::NULL)
    (STELLA::DEFINE-FUNCTION-OBJECT "STARTUP-SOAP-SERVER" "(DEFUN STARTUP-SOAP-SERVER () :PUBLIC? TRUE)" (CL:FUNCTION STARTUP-SOAP-SERVER) STELLA::NULL)
    (CL:LET* ((FUNCTION (STELLA::LOOKUP-FUNCTION SYM-SOAP-SERVER-PLSOAP-STARTUP-SOAP-SERVER)))
     (STELLA::SET-DYNAMIC-SLOT-VALUE (STELLA::%DYNAMIC-SLOTS FUNCTION) SYM-SOAP-SERVER-STELLA-METHOD-STARTUP-CLASSNAME (STELLA::WRAP-STRING "_StartupSoapServer")
   ...
   (CL:WHEN (STELLA::CURRENT-STARTUP-TIME-PHASE? 9) (STELLA::%IN-MODULE (STELLA::COPY-CONS-TREE (STELLA::WRAP-STRING "PLSOAP")))
    (STELLA::DEFINE-STELLA-GLOBAL-VARIABLE-FROM-STRINGIFIED-SOURCE "(DEFGLOBAL *SOAP-READ-ONLY?* BOOLEAN FALSE)")
    (STELLA::INSERT-AT STELLA::*NAMESPACE-PREFIX-URI-TABLE* (STELLA::WRAP-STRING "PLSOAP") (STELLA::WRAP-STRING "http://www.isi.edu/powerloom/"))
    (STELLA::INSERT-AT STELLA::*NAMESPACE-URI-PREFIX-TABLE* (STELLA::WRAP-STRING "http://www.isi.edu/powerloom/") (STELLA::WRAP-STRING "PLSOAP"))
    (STELLA::DEFINE-STELLA-GLOBAL-VARIABLE-FROM-STRINGIFIED-SOURCE "(DEFGLOBAL *POWERLOOM-SOAP-MODULE* MODULE (GET-STELLA-MODULE \"PLSOAP\" TRUE))")
    (STELLA::PUBLISH-HANDLER "/ploom/soap-rpc/powerloom-soap-service" (CL:FUNCTION POWERLOOM-SOAP-REQUEST-HANDLER) KWD-SOAP-SERVER-CONTENT-TYPE
     (STELLA::WRAP-STRING (STELLA::GET-HTTP-MIME-TYPE KWD-SOAP-SERVER-XML STELLA::NULL)) KWD-SOAP-SERVER-DOCUMENTATION
