...
(CL:DECLAIM
 (CL:SPECIAL STELLA::*STARTUP-TIME-PHASE* STELLA::STANDARD-OUTPUT
  STELLA::EOL STELLA::*MODULE* STELLA::NIL STELLA::*CONTEXT*
  STELLA::*POWERLOOM-LOCK* STELLA::NULL-INTEGER))
...
(CL:DEFCLASS |propositions| (STELLA::|XMLObject|)
  ((NRESULTS :ALLOCATION :INSTANCE :ACCESSOR %NRESULTS)
   (STELLA::PROPOSITION :ALLOCATION :INSTANCE :ACCESSOR
    STELLA::%PROPOSITION)))
...
(CL:DEFUN POWERLOOM-PROCESS-SOAP-REQUEST (REQUEST-BODY)
  ...
  (CL:LET* ((ANSWER STELLA::NULL) (REQUEST STELLA::NULL))
   (CL:LET*
    ((STELLA::*DEFAULT-XML-OBJECT-MODULE* *POWERLOOM-SOAP-MODULE*))
    ...
    (CL:HANDLER-CASE
     ...
     (STELLA::LOGIC-EXCEPTION (E)
      (CL:SETQ ANSWER (|new-powerloomerror|))
...
(CL:DEFUN POWERLOOM-SOAP-REQUEST-HANDLER (XCHG)
  ...
  (CL:LET*
   ...
   (STELLA::%%PRINT-STREAM REPLY
    (POWERLOOM-PROCESS-SOAP-REQUEST REQUEST))))

;;; (DEFUN (SAFE-GET-CONTENT STRING) ...)

(CL:DECLAIM
 (CL:FTYPE (CL:FUNCTION (CL:T) CL:SIMPLE-STRING) SAFE-GET-CONTENT))
...
(CL:DEFUN PROCESS-SOAP-ENCODED-COMMAND (COMMAND-FORM)
  (CL:LET*
   ...
   (CL:LET*
    ((STELLA::*TYPECHECKMODE* KWD-SOAP-SERVER-IGNORE-TYPE-VIOLATIONS))
    ...
    (CL:LET*
     ...
     (CL:LET*
      ((TEST-VALUE-000 (STELLA::SAFE-PRIMARY-TYPE COMMAND-FORM)))
      (CL:COND
       ((STELLA::SUBTYPE-OF? TEST-VALUE-000
         |SGT-SOAP-SERVER-PLSOAP-command|)
        (CL:PROGN
         (CL:LET* ((COMMAND-STRING (SAFE-GET-CONTENT COMMAND-FORM)))
          ...
          (SOAP-ENCODE-COMMAND-RESPONSE
           (PLI::S-EVALUATE COMMAND-STRING MODULE-NAME
            STELLA::NULL)))))
       ((STELLA::SUBTYPE-OF? TEST-VALUE-000
         |SGT-SOAP-SERVER-PLSOAP-assertion|)
        (CL:PROGN
        ...
        (CL:PROGN
         (CL:LET*
          ((BASE-QUERY-STRING (SAFE-GET-CONTENT COMMAND-FORM))
           ...
           (QUERY-OPTIONS
            (SAFE-GET-CONTENT (STELLA::%OPTIONS COMMAND-FORM))))
          (CL:DECLARE
        ...
        (CL:PROGN
         (CL:LET*
          ((N-RESULTS (SAFE-GET-CONTENT (%NRESULTS COMMAND-FORM)))
           (QUERY-PATTERN
            (SAFE-GET-CONTENT (STELLA::%PATTERN COMMAND-FORM)))
           (QUERY-OPTIONS
            (SAFE-GET-CONTENT (STELLA::%OPTIONS COMMAND-FORM)))
           (BASE-QUERY-STRING (SAFE-GET-CONTENT COMMAND-FORM))
           (QUERY-STRING BASE-QUERY-STRING) (QUERY-FORM STELLA::NIL))
          (CL:DECLARE
           (CL:TYPE CL:SIMPLE-STRING N-RESULTS QUERY-PATTERN
            QUERY-OPTIONS BASE-QUERY-STRING QUERY-STRING))
          (CL:WHEN
           (CL:OR (CL:EQ QUERY-STRING STELLA::NULL-STRING)
            (STELLA::STRING-EQL? QUERY-STRING ""))
          ...
          (CL:WHEN
           ...
           (CL:IF
            ...
            (CL:SETQ QUERY-STRING
             (STELLA::CONCATENATE "(" QUERY-PATTERN ") "
              QUERY-STRING))))
          (CL:IF
...
(CL:DEFUN SOAP-ENCODE-COMMAND-RESPONSE (OBJ)
  (CL:LET*
   ...
   (CL:DECLARE
    (CL:SPECIAL STELLA::*PRINTREADABLY?* STELLA::*PRINTMODE*))
...
(CL:DEFUN SOAP-ENCODE-ASSERT-RESPONSE (ITER)
  (CL:LET*
   ...
   (CL:LET*
    ...
    (CL:SETF (STELLA::%PROPOSITION ANSWER) (STELLA::REVERSE PROPS))
    ANSWER)))
  ...
  (CL:LET* ((ENCODED-ITEM (|new-item|)))
   (CL:LET* ((TEST-VALUE-000 (STELLA::SAFE-PRIMARY-TYPE OBJ)))
    (CL:COND
     ...
     (CL:T
      (STELLA::SET-CONTENT ENCODED-ITEM (STELLA::STRINGIFY OBJ)))))
   ENCODED-ITEM))
...
(CL:DEFUN SOAP-ENCODE-TUPLE (OBJ)
  (CL:LET*
   ((RESULT (|new-tuple|)) (ITEMS (STELLA::NEW-LIST))
    (COUNT (|new-nresults|)) (N 0))
   (CL:DECLARE (CL:TYPE CL:FIXNUM N))
   (CL:COND
    ((CL:EQ (STELLA::SAFE-PRIMARY-TYPE OBJ)
      SGT-SOAP-SERVER-STELLA-CONS)
     (CL:PROGN
...
(CL:DEFUN SOAP-ENCODE-RETRIEVAL-ANSWER (QUERY-STRING ITER)
  ...
  (CL:LET*
   ...
   (CL:LET*
    ...
    (CL:LET*
     ((VAR STELLA::NULL)
      (VECTOR-000 (STELLA::%EXTERNAL-VARIABLES ITER)) (INDEX-000 0)
...
(CL:DEFUN BUILD-AND-SEND-REQUEST (TARGET TYPE CONTENT)
  ...
  (CL:LET*
   ...
   (STELLA::%%PRINT-STREAM
    (STELLA::%NATIVE-STREAM STELLA::STANDARD-OUTPUT) "Sent" EOL REQ
    EOL)
   (STELLA::%%PRINT-STREAM
    (STELLA::%NATIVE-STREAM STELLA::STANDARD-OUTPUT) EOL EOL "Received"
    EOL)
   (CL:LET*
    ((LINE STELLA::NULL-STRING) (ITER-000 (STELLA::LINES R-STREAM)))
    (CL:DECLARE (CL:TYPE CL:SIMPLE-STRING LINE))
    (CL:LOOP WHILE (STELLA::NEXT? ITER-000) DO
     (CL:SETQ LINE (STELLA::%VALUE ITER-000))
     (STELLA::%%PRINT-STREAM
      (STELLA::%NATIVE-STREAM STELLA::STANDARD-OUTPUT) LINE EOL)))
   (STELLA::%%PRINT-STREAM
    (STELLA::%NATIVE-STREAM STELLA::STANDARD-OUTPUT) EOL EOL)))
...
(CL:DEFUN HELP-STARTUP-SOAP-SERVER1 ()
  (CL:PROGN
   ...
   (CL:SETQ SGT-SOAP-SERVER-PLSOAP-SOAP-COMMAND
    (STELLA::INTERN-RIGID-SYMBOL-WRT-MODULE "SOAP-COMMAND" STELLA::NULL
     1))
   (CL:SETQ SYM-SOAP-SERVER-PLSOAP-TARGET-MODULE
    (STELLA::INTERN-RIGID-SYMBOL-WRT-MODULE "TARGET-MODULE"
     STELLA::NULL 0))
   ...
   (CL:SETQ |SGT-SOAP-SERVER-PLSOAP-assertion|
    (STELLA::INTERN-RIGID-SYMBOL-WRT-MODULE "assertion" STELLA::NULL
     1))
   (CL:SETQ |SGT-SOAP-SERVER-PLSOAP-retraction|
    (STELLA::INTERN-RIGID-SYMBOL-WRT-MODULE "retraction" STELLA::NULL
     1))
   ...
   (CL:SETQ |SGT-SOAP-SERVER-PLSOAP-retrieval|
    (STELLA::INTERN-RIGID-SYMBOL-WRT-MODULE "retrieval" STELLA::NULL
     1))
   ...
   (CL:SETQ |SGT-SOAP-SERVER-PLSOAP-proposition|
    (STELLA::INTERN-RIGID-SYMBOL-WRT-MODULE "proposition" STELLA::NULL
     1))
   ...
   (CL:SETQ |SGT-SOAP-SERVER-PLSOAP-propositions|
    (STELLA::INTERN-RIGID-SYMBOL-WRT-MODULE "propositions" STELLA::NULL
     1))
   ...
   (CL:SETQ |SGT-SOAP-SERVER-PLSOAP-powerloomerror|
    (STELLA::INTERN-RIGID-SYMBOL-WRT-MODULE "powerloomerror"
     STELLA::NULL 1))
   (CL:SETQ |SGT-SOAP-SERVER-PLSOAP-stellaerror|
    (STELLA::INTERN-RIGID-SYMBOL-WRT-MODULE "stellaerror" STELLA::NULL
     1))
   (CL:SETQ |SGT-SOAP-SERVER-PLSOAP-nativeerror|
    (STELLA::INTERN-RIGID-SYMBOL-WRT-MODULE "nativeerror" STELLA::NULL
     1))
   (CL:SETQ KWD-SOAP-SERVER-CONTENT-TYPE
    (STELLA::INTERN-RIGID-SYMBOL-WRT-MODULE "CONTENT-TYPE" STELLA::NULL
     2))
   ...
   (CL:SETQ KWD-SOAP-SERVER-REALISTIC
    (STELLA::INTERN-RIGID-SYMBOL-WRT-MODULE "REALISTIC" STELLA::NULL
     2))
   ...
   (CL:SETQ SYM-SOAP-SERVER-PLSOAP-STARTUP-SOAP-SERVER
    (STELLA::INTERN-RIGID-SYMBOL-WRT-MODULE "STARTUP-SOAP-SERVER"
     STELLA::NULL 0))
...
not actually be realized in surface syntax.\" :PUBLIC-SLOTS ((TARGET-MODULE :TYPE |module|)))")))
    ...
    (CL:LET*
     ((FUNCTION
       (STELLA::LOOKUP-FUNCTION
        SYM-SOAP-SERVER-PLSOAP-STARTUP-SOAP-SERVER)))
   ...
   (CL:WHEN (STELLA::CURRENT-STARTUP-TIME-PHASE? 9)
    ...
    (STELLA::PUBLISH-HANDLER "/ploom/soap-rpc/powerloom-soap-service"
     (CL:FUNCTION POWERLOOM-SOAP-REQUEST-HANDLER)
     KWD-SOAP-SERVER-CONTENT-TYPE
     (STELLA::WRAP-STRING
