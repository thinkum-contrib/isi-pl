...
(CL:DEFUN STARTUP-POWERLOOM-SERVER-SYSTEM ()
  (WITH-PROCESS-LOCK *BOOTSTRAP-LOCK*
   ...
   (CL:LET*
    ((*MODULE*
      (GET-STELLA-MODULE "/POWERLOOM-SERVER"
    ...
    (CL:WHEN (CURRENT-STARTUP-TIME-PHASE? 2)
     (CL:SETQ
      ...
      (INTERN-RIGID-SYMBOL-WRT-MODULE "STARTUP-POWERLOOM-SERVER-SYSTEM"
       NULL 0))
    ...
    (CL:WHEN (CURRENT-STARTUP-TIME-PHASE? 7)
     ...
     (CL:LET*
      ...
      (SET-DYNAMIC-SLOT-VALUE (%DYNAMIC-SLOTS FUNCTION)
       ...
       (WRAP-STRING "StartupPowerloomServerSystem")
       NULL-STRING-WRAPPER)))
    ...
    (CL:WHEN (CURRENT-STARTUP-TIME-PHASE? 9)
     ...
     (CL:LET* ((PHASE NULL-INTEGER) (ITER-001 0) (UPPER-BOUND-002 9))
      ...
      (CL:LOOP WHILE (CL:<= ITER-001 UPPER-BOUND-002) DO
       ...
       (STARTUP-XML-OBJECTS) (STARTUP-GUI-SERVER-API)
       (STARTUP-GUI-SERVER) (STARTUP-EXPLANATIONS)
       (PLSOAP::STARTUP-SOAP-SERVER)
