...
(CL:DEFUN STARTUP-POWERLOOM-SERVER-SYSTEM ()
  (WITH-PROCESS-LOCK *BOOTSTRAP-LOCK*
   ...
   (CL:LET* ((*MODULE* (GET-STELLA-MODULE "/POWERLOOM-SERVER" (> *STARTUP-TIME-PHASE* 1))) (*CONTEXT* *MODULE*))
    (CL:DECLARE (CL:SPECIAL *MODULE* *CONTEXT*))
    (CL:WHEN (CURRENT-STARTUP-TIME-PHASE? 2)
     (CL:SETQ SYM-STARTUP-SYSTEM-POWERLOOM-SERVER-STARTUP-POWERLOOM-SERVER-SYSTEM
      (INTERN-RIGID-SYMBOL-WRT-MODULE "STARTUP-POWERLOOM-SERVER-SYSTEM" NULL 0))
    ...
    (CL:WHEN (CURRENT-STARTUP-TIME-PHASE? 7)
     (DEFINE-FUNCTION-OBJECT "STARTUP-POWERLOOM-SERVER-SYSTEM"
      "(DEFUN STARTUP-POWERLOOM-SERVER-SYSTEM () :PUBLIC? TRUE)" (CL:FUNCTION STARTUP-POWERLOOM-SERVER-SYSTEM) NULL)
    ...
    (CL:WHEN (CURRENT-STARTUP-TIME-PHASE? 9) (%IN-MODULE (COPY-CONS-TREE (WRAP-STRING "/POWERLOOM-SERVER")))
     (CL:LET* ((PHASE NULL-INTEGER) (ITER-001 0) (UPPER-BOUND-002 9))
      ...
      (CL:LOOP WHILE (CL:<= ITER-001 UPPER-BOUND-002) DO (CL:SETQ PHASE ITER-001) (CL:SETQ *STARTUP-TIME-PHASE* PHASE)
       (STARTUP-XML-OBJECTS) (STARTUP-GUI-SERVER-API) (STARTUP-GUI-SERVER) (STARTUP-EXPLANATIONS)
       (PLSOAP::STARTUP-SOAP-SERVER) (CL:SETQ ITER-001 (CL:1+ ITER-001))))
