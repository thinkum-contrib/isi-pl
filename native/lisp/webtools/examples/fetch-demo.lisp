...
(CL:DEFCLASS |runAgentAndWaitForResponse| (|XMLObject|)
  ((|arg0| :ALLOCATION :INSTANCE :ACCESSOR |%arg0|) (|arg1| :ALLOCATION :INSTANCE :ACCESSOR |%arg1|)
   (|arg2| :ALLOCATION :INSTANCE :ACCESSOR |%arg2|)))

(CL:DEFUN |new-runAgentAndWaitForResponse| ()
  (CL:LET* ((SELF NULL)) (CL:SETQ SELF (CL:MAKE-INSTANCE (CL:QUOTE |runAgentAndWaitForResponse|)))
   (CL:SETF (|%cdataContent| SELF) STELLA::NULL-STRING) (CL:SETF (|%textContent| SELF) STELLA::NULL-STRING)
   (CL:SETF (|%arg2| SELF) NULL) (CL:SETF (|%arg1| SELF) NULL) (CL:SETF (|%arg0| SELF) NULL) SELF))
...
(CL:DEFUN |access-runAgentAndWaitForResponse-Slot-Value| (SELF SLOTNAME VALUE SETVALUE?)
  (CL:COND
   ((CL:EQ SLOTNAME |SYM-FETCH-DEMO-FETCH-arg0|)
    (CL:IF SETVALUE? (CL:SETF (|%arg0| SELF) VALUE) (CL:SETQ VALUE (|%arg0| SELF))))
   ((CL:EQ SLOTNAME |SYM-FETCH-DEMO-FETCH-arg1|)
    (CL:IF SETVALUE? (CL:SETF (|%arg1| SELF) VALUE) (CL:SETQ VALUE (|%arg1| SELF))))
   ((CL:EQ SLOTNAME |SYM-FETCH-DEMO-FETCH-arg2|)
    (CL:IF SETVALUE? (CL:SETF (|%arg2| SELF) VALUE) (CL:SETQ VALUE (|%arg2| SELF))))
   (CL:T
...
(CL:DEFUN |new-runAgentAndWaitForResponseResponse| ()
  (CL:LET* ((SELF NULL)) (CL:SETQ SELF (CL:MAKE-INSTANCE (CL:QUOTE |runAgentAndWaitForResponseResponse|)))
   (CL:SETF (|%cdataContent| SELF) STELLA::NULL-STRING) (CL:SETF (|%textContent| SELF) STELLA::NULL-STRING)
...
(CL:DEFUN |new-runAgentAndWaitForResponseReturn| ()
  (CL:LET* ((SELF NULL)) (CL:SETQ SELF (CL:MAKE-INSTANCE (CL:QUOTE |runAgentAndWaitForResponseReturn|)))
   (CL:SETF (|%cdataContent| SELF) STELLA::NULL-STRING) (CL:SETF (|%textContent| SELF) STELLA::NULL-STRING)
...
(CL:DEFUN GET-FETCH-RESPONSE1 ()
  (CL:LET*
   ((|url| "http://pegasus2.isi.edu:8080/axis/services/AgentRunnerService") (|headers| (NEW-PROPERTY-LIST))
    (|response| STELLA::NULL-STRING))
   ...
   (CL:SETQ |response|
    (%DO-HTTP-REQUEST |url|
     (CONS-LIST KWD-FETCH-DEMO-METHOD KWD-FETCH-DEMO-POST KWD-FETCH-DEMO-HEADERS |headers| KWD-FETCH-DEMO-CONTENT
...
(CL:DEFUN GET-FETCH-RESPONSE2 ()
  (CL:LET*
   ((|url| "http://pegasus2.isi.edu:8080/axis/services/AgentRunnerService") (|headers| (NEW-PROPERTY-LIST))
    (|response| STELLA::NULL-STRING) (|request| (MAKE-FETCH-REQUEST1)))
...
(CL:DEFUN GET-FETCH-RESPONSE3 ()
  (CL:LET*
   ((|url| "http://pegasus2.isi.edu:8080/axis/services/AgentRunnerService")
    (|requestObject| (MAKE-FETCH-REQUEST-OBJECT1)) (|responseObject| (CALL-WEBSERVICE |requestObject| |url|)))
         ...
         (CL:LET* ((|arg0| SELF-003))
          (CL:LET* ((SELF-004 (|new-arg1|))) (CL:SETF (|%item| SELF-004) |item|)
           (CL:LET* ((|arg1| SELF-004) (|arg2| (|new-arg2|)))
            (CL:LET* ((SELF-006 (|new-runAgentAndWaitForResponse|))) (CL:SETF (|%arg0| SELF-006) |arg0|)
             (CL:SETF (|%arg1| SELF-006) |arg1|) (CL:SETF (|%arg2| SELF-006) |arg2|)
             (CL:LET* ((|runAgentAndWaitForResponse| SELF-006)) |runAgentAndWaitForResponse|)))))))))))))

(CL:DEFUN STARTUP-FETCH-DEMO ()
  (CL:LET* ((*MODULE* (GET-STELLA-MODULE "/STELLA/XML-OBJECTS/FETCH" (> *STARTUP-TIME-PHASE* 1))) (*CONTEXT* *MODULE*))
   ...
   (CL:WHEN (CURRENT-STARTUP-TIME-PHASE? 2)
    ...
    (CL:SETQ |SGT-FETCH-DEMO-FETCH-runAgentAndWaitForResponseResponse|
     (INTERN-RIGID-SYMBOL-WRT-MODULE "runAgentAndWaitForResponseResponse" NULL 1))
    ...
    (CL:SETQ |SGT-FETCH-DEMO-FETCH-runAgentAndWaitForResponseReturn|
     (INTERN-RIGID-SYMBOL-WRT-MODULE "runAgentAndWaitForResponseReturn" NULL 1))
    (CL:SETQ |SYM-FETCH-DEMO-XSI-type|
     (INTERN-RIGID-SYMBOL-WRT-MODULE "type" (GET-STELLA-MODULE "/STELLA/XML-OBJECTS/XSI" CL:T) 0))
    (CL:SETQ KWD-FETCH-DEMO-METHOD (INTERN-RIGID-SYMBOL-WRT-MODULE "METHOD" NULL 2))
    (CL:SETQ KWD-FETCH-DEMO-POST (INTERN-RIGID-SYMBOL-WRT-MODULE "POST" NULL 2))
    (CL:SETQ KWD-FETCH-DEMO-HEADERS (INTERN-RIGID-SYMBOL-WRT-MODULE "HEADERS" NULL 2))
    (CL:SETQ KWD-FETCH-DEMO-CONTENT (INTERN-RIGID-SYMBOL-WRT-MODULE "CONTENT" NULL 2))
   ...
   (CL:WHEN (CURRENT-STARTUP-TIME-PHASE? 7)
    (DEFINE-FUNCTION-OBJECT "GET-FETCH-RESPONSE1" "(DEFUN GET-FETCH-RESPONSE1 ())" (CL:FUNCTION GET-FETCH-RESPONSE1)
     NULL)
    (DEFINE-FUNCTION-OBJECT "GET-FETCH-RESPONSE2" "(DEFUN GET-FETCH-RESPONSE2 ())" (CL:FUNCTION GET-FETCH-RESPONSE2)
     NULL)
    (DEFINE-FUNCTION-OBJECT "GET-FETCH-RESPONSE3" "(DEFUN GET-FETCH-RESPONSE3 ())" (CL:FUNCTION GET-FETCH-RESPONSE3)
     NULL)
    (DEFINE-FUNCTION-OBJECT "MAKE-FETCH-REQUEST1" "(DEFUN (MAKE-FETCH-REQUEST1 STRING) ())"
     (CL:FUNCTION MAKE-FETCH-REQUEST1) NULL)
    (DEFINE-FUNCTION-OBJECT "MAKE-FETCH-REQUEST-OBJECT1" "(DEFUN (MAKE-FETCH-REQUEST-OBJECT1 XMLObject) ())"
     (CL:FUNCTION MAKE-FETCH-REQUEST-OBJECT1) NULL)
    (DEFINE-FUNCTION-OBJECT "STARTUP-FETCH-DEMO" "(DEFUN STARTUP-FETCH-DEMO () :PUBLIC? TRUE)"
     (CL:FUNCTION STARTUP-FETCH-DEMO) NULL)
    (CL:LET* ((FUNCTION (LOOKUP-FUNCTION SYM-FETCH-DEMO-FETCH-STARTUP-FETCH-DEMO)))
     (SET-DYNAMIC-SLOT-VALUE (%DYNAMIC-SLOTS FUNCTION) SYM-FETCH-DEMO-STELLA-METHOD-STARTUP-CLASSNAME
   ...
   (CL:WHEN (CURRENT-STARTUP-TIME-PHASE? 9) (%IN-MODULE (COPY-CONS-TREE (WRAP-STRING "FETCH")))
    (INSERT-AT *NAMESPACE-PREFIX-URI-TABLE* (WRAP-STRING "FETCH")
     (WRAP-STRING "http://pegasus2.isi.edu:8080/axis/services/AgentRunnerService/"))
    (INSERT-AT *NAMESPACE-URI-PREFIX-TABLE*
     (WRAP-STRING "http://pegasus2.isi.edu:8080/axis/services/AgentRunnerService/") (WRAP-STRING "FETCH"))
