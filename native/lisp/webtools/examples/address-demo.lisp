...
(CL:DEFUN STARTUP-ADDRESS-DEMO ()
  (CL:LET*
   ...
   (CL:WHEN (CURRENT-STARTUP-TIME-PHASE? 7)
    ...
    (CL:LET*
     ((FUNCTION
       (LOOKUP-FUNCTION SYM-ADDRESS-DEMO-ADDRESS-DEMO-STARTUP-ADDRESS-DEMO)))
   ...
   (CL:WHEN (CURRENT-STARTUP-TIME-PHASE? 9)
    ...
    (INSERT-AT *NAMESPACE-PREFIX-URI-TABLE* (WRAP-STRING "ADDRESS-DEMO")
     (WRAP-STRING "urn:xml-soap-address-demo"))
    (INSERT-AT *NAMESPACE-URI-PREFIX-TABLE*
     (WRAP-STRING "urn:xml-soap-address-demo") (WRAP-STRING "ADDRESS-DEMO"))
    (CL:SETQ *INVISIBLE-NAMESPACES-ON-OUTPUT*
     (CONS (WRAP-STRING "ADDRESS-DEMO") *INVISIBLE-NAMESPACES-ON-OUTPUT*)))))
