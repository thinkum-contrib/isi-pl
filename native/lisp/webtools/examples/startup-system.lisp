   ...
   (CL:LET*
    ...
    (CL:WHEN (CURRENT-STARTUP-TIME-PHASE? 2)
     (CL:SETQ SYM-STARTUP-SYSTEM-SAMPLE-STARTUP-WEBTOOLS-EXAMPLES-SYSTEM
      (INTERN-RIGID-SYMBOL-WRT-MODULE "STARTUP-WEBTOOLS-EXAMPLES-SYSTEM" NULL 0))
    ...
    (CL:WHEN (CURRENT-STARTUP-TIME-PHASE? 7)
     (DEFINE-FUNCTION-OBJECT "STARTUP-WEBTOOLS-EXAMPLES-SYSTEM"
      "(DEFUN STARTUP-WEBTOOLS-EXAMPLES-SYSTEM () :PUBLIC? TRUE)" (CL:FUNCTION STARTUP-WEBTOOLS-EXAMPLES-SYSTEM) NULL)
    ...
    (CL:WHEN (CURRENT-STARTUP-TIME-PHASE? 9) (%IN-MODULE (COPY-CONS-TREE (WRAP-STRING "/STELLA/XML-OBJECTS/SAMPLE")))
     (CL:LET* ((PHASE NULL-INTEGER) (ITER-000 0) (UPPER-BOUND-001 9))
      ...
      (CL:LOOP WHILE (CL:<= ITER-000 UPPER-BOUND-001) DO (CL:SETQ PHASE ITER-000) (CL:SETQ *STARTUP-TIME-PHASE* PHASE)
       (STARTUP-SAMPLE-CONTENTS) (STARTUP-ADDRESS-EXAMPLE) (STARTUP-ADDRESS-DEMO) (STARTUP-FETCH-DEMO-CONTENT)
