...
(CL:DEFUN |new-getAddressFromName| ()
  (CL:LET* ((SELF NULL)) (CL:SETQ SELF (CL:MAKE-INSTANCE (CL:QUOTE |getAddressFromName|)))
...
(CL:DEFUN |access-getAddressFromName-Slot-Value| (SELF SLOTNAME VALUE SETVALUE?)
  (CL:COND
   ((CL:EQ SLOTNAME |SYM-ADDRESS-EXAMPLE-ADDRESS-EXAMPLE-nameElement|)
    (CL:IF SETVALUE? (CL:SETF (|%nameElement| SELF) VALUE) (CL:SETQ VALUE (|%nameElement| SELF))))
   (CL:T
...
(CL:DEFCLASS |return| (|XMLObject|)
  ((|streetNum| :ALLOCATION :INSTANCE :ACCESSOR |%streetNum|)
   (|streetName| :ALLOCATION :INSTANCE :ACCESSOR |%streetName|) (|city| :ALLOCATION :INSTANCE :ACCESSOR |%city|)
   (|state| :ALLOCATION :INSTANCE :ACCESSOR |%state|) (|zip| :ALLOCATION :INSTANCE :ACCESSOR |%zip|)
...
(CL:DEFUN |new-return| ()
  (CL:LET* ((SELF NULL)) (CL:SETQ SELF (CL:MAKE-INSTANCE (CL:QUOTE |return|)))
   (CL:SETF (|%cdataContent| SELF) STELLA::NULL-STRING) (CL:SETF (|%textContent| SELF) STELLA::NULL-STRING)
   (CL:SETF (|%type| SELF) "ADDRESS-DEMO:address") (CL:SETF (|%phone| SELF) NULL) (CL:SETF (|%zip| SELF) NULL)
   (CL:SETF (|%state| SELF) NULL) (CL:SETF (|%city| SELF) NULL) (CL:SETF (|%streetName| SELF) NULL)
...
(CL:DEFUN |access-return-Slot-Value| (SELF SLOTNAME VALUE SETVALUE?)
  (CL:COND
   ((CL:EQ SLOTNAME |SYM-ADDRESS-EXAMPLE-ADDRESS-EXAMPLE-streetNum|)
    (CL:IF SETVALUE? (CL:SETF (|%streetNum| SELF) VALUE) (CL:SETQ VALUE (|%streetNum| SELF))))
   ((CL:EQ SLOTNAME |SYM-ADDRESS-EXAMPLE-ADDRESS-EXAMPLE-streetName|)
    (CL:IF SETVALUE? (CL:SETF (|%streetName| SELF) VALUE) (CL:SETQ VALUE (|%streetName| SELF))))
   ((CL:EQ SLOTNAME |SYM-ADDRESS-EXAMPLE-ADDRESS-EXAMPLE-city|)
    (CL:IF SETVALUE? (CL:SETF (|%city| SELF) VALUE) (CL:SETQ VALUE (|%city| SELF))))
   ((CL:EQ SLOTNAME |SYM-ADDRESS-EXAMPLE-ADDRESS-EXAMPLE-state|)
    (CL:IF SETVALUE? (CL:SETF (|%state| SELF) VALUE) (CL:SETQ VALUE (|%state| SELF))))
   ((CL:EQ SLOTNAME |SYM-ADDRESS-EXAMPLE-ADDRESS-EXAMPLE-zip|)
    (CL:IF SETVALUE? (CL:SETF (|%zip| SELF) VALUE) (CL:SETQ VALUE (|%zip| SELF))))
   ((CL:EQ SLOTNAME |SYM-ADDRESS-EXAMPLE-ADDRESS-EXAMPLE-phone|)
    (CL:IF SETVALUE? (CL:SETF (|%phone| SELF) VALUE) (CL:SETQ VALUE (|%phone| SELF))))
   ((CL:EQ SLOTNAME |SYM-ADDRESS-EXAMPLE-XSI-type|)
    (CL:IF SETVALUE? (CL:SETF (|%type| SELF) (%WRAPPER-VALUE VALUE)) (CL:SETQ VALUE (WRAP-STRING (|%type| SELF)))))
   (CL:T
    (CL:LET* ((STREAM-000 (NEW-OUTPUT-STRING-STREAM)))
     (%%PRINT-STREAM (%NATIVE-STREAM STREAM-000) "`" SLOTNAME "' is not a valid case option")
     (CL:ERROR (NEW-STELLA-EXCEPTION (THE-STRING-READER STREAM-000))))))
...
(CL:DEFUN |new-getAddressFromNameResponse| ()
  (CL:LET* ((SELF NULL)) (CL:SETQ SELF (CL:MAKE-INSTANCE (CL:QUOTE |getAddressFromNameResponse|)))
   (CL:SETF (|%cdataContent| SELF) STELLA::NULL-STRING) (CL:SETF (|%textContent| SELF) STELLA::NULL-STRING)
...
(CL:DEFUN |access-getAddressFromNameResponse-Slot-Value| (SELF SLOTNAME VALUE SETVALUE?)
  (CL:COND
   ((CL:EQ SLOTNAME |SYM-ADDRESS-EXAMPLE-ADDRESS-EXAMPLE-return|)
    (CL:IF SETVALUE? (CL:SETF (|%return| SELF) VALUE) (CL:SETQ VALUE (|%return| SELF))))
   (CL:T
    (CL:LET* ((STREAM-000 (NEW-OUTPUT-STRING-STREAM)))
     (%%PRINT-STREAM (%NATIVE-STREAM STREAM-000) "`" SLOTNAME "' is not a valid case option")
     (CL:ERROR (NEW-STELLA-EXCEPTION (THE-STRING-READER STREAM-000))))))
...
(CL:DEFUN |new-nameToLookup| ()
  (CL:LET* ((SELF NULL)) (CL:SETQ SELF (CL:MAKE-INSTANCE (CL:QUOTE |nameToLookup|)))
   (CL:SETF (|%cdataContent| SELF) STELLA::NULL-STRING) (CL:SETF (|%textContent| SELF) STELLA::NULL-STRING)
...
(CL:DEFUN |new-Address| ()
  (CL:LET* ((SELF NULL)) (CL:SETQ SELF (CL:MAKE-INSTANCE (CL:QUOTE |Address|)))
   (CL:SETF (|%cdataContent| SELF) STELLA::NULL-STRING) (CL:SETF (|%textContent| SELF) STELLA::NULL-STRING)
   (CL:SETF (|%phone| SELF) NULL) (CL:SETF (|%zip| SELF) NULL) (CL:SETF (|%state| SELF) NULL)
...
(CL:DEFUN |new-StreetNum| ()
  (CL:LET* ((SELF NULL)) (CL:SETQ SELF (CL:MAKE-INSTANCE (CL:QUOTE |StreetNum|)))
...
(CL:DEFUN |new-StreetName| ()
  (CL:LET* ((SELF NULL)) (CL:SETQ SELF (CL:MAKE-INSTANCE (CL:QUOTE |StreetName|)))
   (CL:SETF (|%cdataContent| SELF) STELLA::NULL-STRING) (CL:SETF (|%textContent| SELF) STELLA::NULL-STRING) SELF))
...
(CL:DEFCLASS |PhoneNumber| (|XMLObject|)
  ((|areaCode| :ALLOCATION :INSTANCE :ACCESSOR |%areaCode|) (|exchange| :ALLOCATION :INSTANCE :ACCESSOR |%exchange|)
   (|number| :ALLOCATION :INSTANCE :ACCESSOR |%number|)))

(CL:DEFUN |new-PhoneNumber| ()
  (CL:LET* ((SELF NULL)) (CL:SETQ SELF (CL:MAKE-INSTANCE (CL:QUOTE |PhoneNumber|)))
   (CL:SETF (|%cdataContent| SELF) STELLA::NULL-STRING) (CL:SETF (|%textContent| SELF) STELLA::NULL-STRING)
   (CL:SETF (|%number| SELF) NULL) (CL:SETF (|%exchange| SELF) NULL) (CL:SETF (|%areaCode| SELF) NULL) SELF))
...
(CL:DEFUN |access-PhoneNumber-Slot-Value| (SELF SLOTNAME VALUE SETVALUE?)
  (CL:COND
   ((CL:EQ SLOTNAME |SYM-ADDRESS-EXAMPLE-ADDRESS-EXAMPLE-areaCode|)
    (CL:IF SETVALUE? (CL:SETF (|%areaCode| SELF) VALUE) (CL:SETQ VALUE (|%areaCode| SELF))))
   ((CL:EQ SLOTNAME |SYM-ADDRESS-EXAMPLE-ADDRESS-EXAMPLE-exchange|)
    (CL:IF SETVALUE? (CL:SETF (|%exchange| SELF) VALUE) (CL:SETQ VALUE (|%exchange| SELF))))
   ((CL:EQ SLOTNAME |SYM-ADDRESS-EXAMPLE-ADDRESS-EXAMPLE-number|)
    (CL:IF SETVALUE? (CL:SETF (|%number| SELF) VALUE) (CL:SETQ VALUE (|%number| SELF))))
   (CL:T
    (CL:LET* ((STREAM-000 (NEW-OUTPUT-STRING-STREAM)))
     (%%PRINT-STREAM (%NATIVE-STREAM STREAM-000) "`" SLOTNAME "' is not a valid case option")
     (CL:ERROR (NEW-STELLA-EXCEPTION (THE-STRING-READER STREAM-000))))))
...
(CL:DEFUN |new-AreaCode| ()
  (CL:LET* ((SELF NULL)) (CL:SETQ SELF (CL:MAKE-INSTANCE (CL:QUOTE |AreaCode|)))
   (CL:SETF (|%cdataContent| SELF) STELLA::NULL-STRING) (CL:SETF (|%textContent| SELF) STELLA::NULL-STRING) SELF))
...
(CL:DEFUN |new-Exchange| ()
  (CL:LET* ((SELF NULL)) (CL:SETQ SELF (CL:MAKE-INSTANCE (CL:QUOTE |Exchange|)))
   (CL:SETF (|%cdataContent| SELF) STELLA::NULL-STRING) (CL:SETF (|%textContent| SELF) STELLA::NULL-STRING) SELF))
...
(CL:DEFUN |new-phoneNumber| ()
  (CL:LET* ((SELF NULL)) (CL:SETQ SELF (CL:MAKE-INSTANCE (CL:QUOTE |phoneNumber|)))
   (CL:SETF (|%cdataContent| SELF) STELLA::NULL-STRING) (CL:SETF (|%textContent| SELF) STELLA::NULL-STRING)
   (CL:SETF (|%type| SELF) "ADDRESS-DEMO:phone") (CL:SETF (|%number| SELF) NULL) (CL:SETF (|%exchange| SELF) NULL)
      ...
      (CL:LET* ((|exchange| SELF-001))
       (CL:LET* ((SELF-002 (|new-number|))) (CL:SETF (|%textContent| SELF-002) "3210")
        (CL:LET* ((|number| SELF-002))
         (CL:LET* ((SELF-003 (|new-phoneNumber|))) (CL:SETF (|%areaCode| SELF-003) |areaCode|)
          (CL:SETF (|%exchange| SELF-003) |exchange|) (CL:SETF (|%number| SELF-003) |number|)
           ...
           (CL:LET* ((SELF-004 (|new-streetNum|))) (CL:SETF (|%textContent| SELF-004) "919")
            (CL:LET* ((|streetNum| SELF-004))
             (CL:LET* ((SELF-005 (|new-streetName|)))
              (CL:SETF (|%textContent| SELF-005) (CONCATENATE "Street for " |theName|))
                 ...
                 (CL:LET* ((SELF-007 (|new-state|))) (CL:SETF (|%textContent| SELF-007) "UT")
                  (CL:LET* ((|state| SELF-007))
                   (CL:LET* ((SELF-008 (|new-zip|))) (CL:SETF (|%textContent| SELF-008) "43434")
                    (CL:LET* ((|zip| SELF-008))
                     (CL:LET* ((SELF-009 (|new-return|))) (CL:SETF (|%streetNum| SELF-009) |streetNum|)
                      (CL:SETF (|%streetName| SELF-009) |streetName|) (CL:SETF (|%city| SELF-009) |city|)
                      (CL:SETF (|%state| SELF-009) |state|) (CL:SETF (|%zip| SELF-009) |zip|)
...
(CL:DEFUN ADDRESS-TEST1 ()
  (CL:LET* ((|result| (NEW-OUTPUT-STRING-STREAM))) (PROCESS-SOAP-RPC-REQUEST *ADDRESS-REQUEST* CL:NIL |result|)
   (%%PRINT-STREAM (%NATIVE-STREAM STANDARD-OUTPUT) "Retrieved envelope is: " EOL
  ...
  (CL:LET*
   ((|resultString|
     (%DO-HTTP-REQUEST "http://localhost:8012/ploom/soap-rpc"
      (CONS-LIST KWD-ADDRESS-EXAMPLE-METHOD KWD-ADDRESS-EXAMPLE-POST KWD-ADDRESS-EXAMPLE-CONTENT
       (WRAP-STRING *ADDRESS-REQUEST*)))))
   (CL:DECLARE (CL:TYPE CL:SIMPLE-STRING |resultString|))
   (%%PRINT-STREAM (%NATIVE-STREAM STANDARD-OUTPUT) "Retrieved envelope is: " EOL |resultString|)))

;;; (DEFUN GET-APACHE-RESPONSE1 ...)

(CL:DEFUN GET-APACHE-RESPONSE1 ()
  (CL:LET*
   ((|url| "http://localhost:8080/soap/servlet/rpcrouter") (|headers| (NEW-PROPERTY-LIST))
    (|response| STELLA::NULL-STRING) (|responseEnvelope| NULL) (|address| NULL) (|addressString| STELLA::NULL-STRING))
   (CL:DECLARE (CL:TYPE CL:SIMPLE-STRING |url| |response| |addressString|))
   (INSERT-AT |headers| (WRAP-STRING "content-type") (WRAP-STRING "text/xml; charset=utf-8"))
   (CL:SETQ |response|
    (%DO-HTTP-REQUEST |url|
     (CONS-LIST KWD-ADDRESS-EXAMPLE-METHOD KWD-ADDRESS-EXAMPLE-POST KWD-ADDRESS-EXAMPLE-HEADERS |headers|
      KWD-ADDRESS-EXAMPLE-CONTENT (WRAP-STRING *ADDRESS-REQUEST*))))
   (%%PRINT-STREAM (%NATIVE-STREAM STANDARD-OUTPUT) "Response: " EOL |response| EOL)
...
(CL:DEFUN GET-APACHE-RESPONSE2 ()
  (CL:LET*
   ((|url| "http://tubular.isi.edu:8080/soap/servlet/rpcrouter") (|requestObject| (MAKE-REQUEST-OBJECT1))
    (|responseObject| (CALL-WEBSERVICE |requestObject| |url|)))
   (CL:DECLARE (CL:TYPE CL:SIMPLE-STRING |url|))
   (CL:LET* ((*SUPRESS-NAMESPACES?* CL:T)) (CL:DECLARE (CL:SPECIAL *SUPRESS-NAMESPACES?*))
    (%%PRINT-STREAM (%NATIVE-STREAM STANDARD-OUTPUT) "Retrieved Response object is: " EOL
    ...
    (CL:LET* ((TEST-VALUE-000 (SAFE-PRIMARY-TYPE |responseObject|)))
     (CL:COND
      ((SUBTYPE-OF? TEST-VALUE-000 |SGT-ADDRESS-EXAMPLE-ADDRESS-EXAMPLE-getAddressFromNameResponse|)
       (CL:PROGN
        (CL:LET* ((|streetName| (|%textContent| (|%streetName| (|%return| |responseObject|)))))
      ...
      ((SUBTYPE-OF? TEST-VALUE-000 |SGT-ADDRESS-EXAMPLE-SOAP-ENV-Fault|)
       (CL:PROGN
        (CL:LET*
         ...
         (%%PRINT-STREAM (%NATIVE-STREAM STANDARD-OUTPUT) "Received SOAP Fault:" EOL)
         (%%PRINT-STREAM (%NATIVE-STREAM STANDARD-OUTPUT) " CODE   : " |code| EOL)
         (%%PRINT-STREAM (%NATIVE-STREAM STANDARD-OUTPUT) " STRING : " |string| EOL)
...
(CL:DEFUN HELP-STARTUP-ADDRESS-EXAMPLE1 ()
  (CL:PROGN
   ...
   (CL:SETQ |SYM-ADDRESS-EXAMPLE-XSI-type|
    (INTERN-RIGID-SYMBOL-WRT-MODULE "type" (GET-STELLA-MODULE "/STELLA/XML-OBJECTS/XSI" CL:T) 0))
   ...
   (CL:SETQ |SGT-ADDRESS-EXAMPLE-SOAP-ENV-Fault|
    (INTERN-RIGID-SYMBOL-WRT-MODULE "Fault" (GET-STELLA-MODULE "/STELLA/XML-OBJECTS/SOAP-ENV" CL:T) 1))
...
(CL:DEFUN STARTUP-ADDRESS-EXAMPLE ()
  (CL:LET*
   ((*MODULE* (GET-STELLA-MODULE "/STELLA/XML-OBJECTS/ADDRESS-EXAMPLE" (> *STARTUP-TIME-PHASE* 1)))
    (*CONTEXT* *MODULE*))
   ...
   (CL:WHEN (CURRENT-STARTUP-TIME-PHASE? 5)
    ...
    (CL:LET*
     ...
     (CL:SETF (%CLASS-SLOT-ACCESSOR-CODE CLASS) (CL:FUNCTION |access-return-Slot-Value|)))
    (CL:LET*
     ((CLASS
    ...
    (CL:LET*
     ...
     (CL:SETF (%CLASS-SLOT-ACCESSOR-CODE CLASS) (CL:FUNCTION |access-Address-Slot-Value|)))
    ...
    (CL:LET* ((CLASS (DEFINE-CLASS-FROM-STRINGIFIED-SOURCE "City" "(DEFCLASS City (XMLObject))")))
     (CL:SETF (%CLASS-CONSTRUCTOR-CODE CLASS) (CL:FUNCTION |new-City|)))
    (CL:LET* ((CLASS (DEFINE-CLASS-FROM-STRINGIFIED-SOURCE "State" "(DEFCLASS State (XMLObject))")))
     (CL:SETF (%CLASS-CONSTRUCTOR-CODE CLASS) (CL:FUNCTION |new-State|)))
    (CL:LET* ((CLASS (DEFINE-CLASS-FROM-STRINGIFIED-SOURCE "Zip" "(DEFCLASS Zip (XMLObject))")))
    ...
    (CL:LET*
     ...
     (CL:SETF (%CLASS-SLOT-ACCESSOR-CODE CLASS) (CL:FUNCTION |access-PhoneNumber-Slot-Value|)))
    ...
    (CL:LET*
     ...
     (CL:SETF (%CLASS-CONSTRUCTOR-CODE CLASS) (CL:FUNCTION |new-streetNum|))
     (CL:SETF (%CLASS-SLOT-ACCESSOR-CODE CLASS) (CL:FUNCTION |access-streetNum-Slot-Value|)))
    (CL:LET*
     ((CLASS
     ...
     (CL:SETF (%CLASS-CONSTRUCTOR-CODE CLASS) (CL:FUNCTION |new-streetName|))
     (CL:SETF (%CLASS-SLOT-ACCESSOR-CODE CLASS) (CL:FUNCTION |access-streetName-Slot-Value|)))
    (CL:LET*
     ((CLASS
     ...
     (CL:SETF (%CLASS-CONSTRUCTOR-CODE CLASS) (CL:FUNCTION |new-city|))
     (CL:SETF (%CLASS-SLOT-ACCESSOR-CODE CLASS) (CL:FUNCTION |access-city-Slot-Value|)))
    (CL:LET*
     ((CLASS
     ...
     (CL:SETF (%CLASS-CONSTRUCTOR-CODE CLASS) (CL:FUNCTION |new-state|))
     (CL:SETF (%CLASS-SLOT-ACCESSOR-CODE CLASS) (CL:FUNCTION |access-state-Slot-Value|)))
    (CL:LET*
     ((CLASS
     ...
     (CL:SETF (%CLASS-CONSTRUCTOR-CODE CLASS) (CL:FUNCTION |new-zip|))
     (CL:SETF (%CLASS-SLOT-ACCESSOR-CODE CLASS) (CL:FUNCTION |access-zip-Slot-Value|)))
    (CL:LET*
     ((CLASS
       (DEFINE-CLASS-FROM-STRINGIFIED-SOURCE "phoneNumber"
    ...
    (CL:LET*
     ...
     (CL:SETF (%CLASS-CONSTRUCTOR-CODE CLASS) (CL:FUNCTION |new-areaCode|))
     (CL:SETF (%CLASS-SLOT-ACCESSOR-CODE CLASS) (CL:FUNCTION |access-areaCode-Slot-Value|)))
    (CL:LET*
     ((CLASS
     ...
     (CL:SETF (%CLASS-CONSTRUCTOR-CODE CLASS) (CL:FUNCTION |new-exchange|))
     (CL:SETF (%CLASS-SLOT-ACCESSOR-CODE CLASS) (CL:FUNCTION |access-exchange-Slot-Value|)))
    (CL:LET*
     ((CLASS
     ...
     (CL:SETF (%CLASS-CONSTRUCTOR-CODE CLASS) (CL:FUNCTION |new-number|))
     (CL:SETF (%CLASS-SLOT-ACCESSOR-CODE CLASS) (CL:FUNCTION |access-number-Slot-Value|))))
   (CL:WHEN (CURRENT-STARTUP-TIME-PHASE? 6) (FINALIZE-CLASSES))
   (CL:WHEN (CURRENT-STARTUP-TIME-PHASE? 7)
    (DEFINE-FUNCTION-OBJECT "getAddressFromName"
     "(DEFUN (getAddressFromName getAddressFromNameResponse) ((name nameToLookup)))" (CL:FUNCTION |getAddressFromName|)
     NULL)
    (DEFINE-FUNCTION-OBJECT "MAKE-REQUEST-OBJECT1" "(DEFUN (MAKE-REQUEST-OBJECT1 getAddressFromName) ())"
    ...
    (DEFINE-FUNCTION-OBJECT "GET-APACHE-RESPONSE1" "(DEFUN GET-APACHE-RESPONSE1 ())" (CL:FUNCTION GET-APACHE-RESPONSE1)
     NULL)
    (DEFINE-FUNCTION-OBJECT "GET-APACHE-RESPONSE2" "(DEFUN GET-APACHE-RESPONSE2 ())" (CL:FUNCTION GET-APACHE-RESPONSE2)
     NULL)
    (DEFINE-FUNCTION-OBJECT "STARTUP-ADDRESS-EXAMPLE" "(DEFUN STARTUP-ADDRESS-EXAMPLE () :PUBLIC? TRUE)"
    ...
    (CL:LET* ((FUNCTION (LOOKUP-FUNCTION SYM-ADDRESS-EXAMPLE-ADDRESS-EXAMPLE-STARTUP-ADDRESS-EXAMPLE)))
     (SET-DYNAMIC-SLOT-VALUE (%DYNAMIC-SLOTS FUNCTION) SYM-ADDRESS-EXAMPLE-STELLA-METHOD-STARTUP-CLASSNAME
