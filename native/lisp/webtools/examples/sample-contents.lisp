...
(CL:DEFCLASS |SampleContents| (|XMLObject|)
  ((|sampleAttr| :TYPE CL:SIMPLE-STRING :INITFORM STELLA::NULL-STRING :ALLOCATION :INSTANCE :ACCESSOR |%sampleAttr|)
   (|sub| :ALLOCATION :INSTANCE :ACCESSOR |%sub|) (|SampleListItem| :ALLOCATION :INSTANCE :ACCESSOR |%SampleListItem|)))

(CL:DEFUN |new-SampleContents| ()
  (CL:LET* ((SELF NULL)) (CL:SETQ SELF (CL:MAKE-INSTANCE (CL:QUOTE |SampleContents|)))
...
(CL:DEFUN |access-SampleContents-Slot-Value| (SELF SLOTNAME VALUE SETVALUE?)
  (CL:COND
   ...
   ((CL:EQ SLOTNAME |SYM-SAMPLE-CONTENTS-SAMPLE-sub|)
    (CL:IF SETVALUE? (CL:SETF (|%sub| SELF) VALUE) (CL:SETQ VALUE (|%sub| SELF))))
   ((CL:EQ SLOTNAME |SYM-SAMPLE-CONTENTS-SAMPLE-SampleListItem|)
    (CL:IF SETVALUE? (CL:SETF (|%SampleListItem| SELF) VALUE) (CL:SETQ VALUE (|%SampleListItem| SELF))))
   (CL:T
...
(CL:DEFUN |new-SampleNested| ()
  (CL:LET* ((SELF NULL)) (CL:SETQ SELF (CL:MAKE-INSTANCE (CL:QUOTE |SampleNested|)))
   (CL:SETF (|%cdataContent| SELF) STELLA::NULL-STRING) (CL:SETF (|%textContent| SELF) STELLA::NULL-STRING)
...
(CL:DEFUN |new-SampleListItem| ()
  (CL:LET* ((SELF NULL)) (CL:SETQ SELF (CL:MAKE-INSTANCE (CL:QUOTE |SampleListItem|)))
   (CL:SETF (|%cdataContent| SELF) STELLA::NULL-STRING) (CL:SETF (|%textContent| SELF) STELLA::NULL-STRING)
...
(CL:DEFUN STARTUP-SAMPLE-CONTENTS ()
  (CL:LET*
   ((*MODULE* (GET-STELLA-MODULE "/STELLA/XML-OBJECTS/SAMPLE" (> *STARTUP-TIME-PHASE* 1))) (*CONTEXT* *MODULE*))
   (CL:DECLARE (CL:SPECIAL *MODULE* *CONTEXT*))
   (CL:WHEN (CURRENT-STARTUP-TIME-PHASE? 2)
    (CL:SETQ |SGT-SAMPLE-CONTENTS-SAMPLE-SampleContents| (INTERN-RIGID-SYMBOL-WRT-MODULE "SampleContents" NULL 1))
   ...
   (CL:WHEN (CURRENT-STARTUP-TIME-PHASE? 7)
    (DEFINE-FUNCTION-OBJECT "STARTUP-SAMPLE-CONTENTS" "(DEFUN STARTUP-SAMPLE-CONTENTS () :PUBLIC? TRUE)"
    ...
    (CL:LET* ((FUNCTION (LOOKUP-FUNCTION SYM-SAMPLE-CONTENTS-SAMPLE-STARTUP-SAMPLE-CONTENTS)))
     (SET-DYNAMIC-SLOT-VALUE (%DYNAMIC-SLOTS FUNCTION) SYM-SAMPLE-CONTENTS-STELLA-METHOD-STARTUP-CLASSNAME
   ...
   (CL:WHEN (CURRENT-STARTUP-TIME-PHASE? 9) (%IN-MODULE (COPY-CONS-TREE (WRAP-STRING "SAMPLE")))
    ...
    (INSERT-AT *NAMESPACE-URI-PREFIX-TABLE* (WRAP-STRING "http://www.isi.edu/powerloom/sample/")
     (WRAP-STRING "SAMPLE")))))
