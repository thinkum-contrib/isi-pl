...
(CL:DECLAIM
 (CL:FTYPE
  (CL:FUNCTION (CL:SIMPLE-STRING)
   (CL:VALUES CL:SIMPLE-STRING CL:SIMPLE-STRING CL:SIMPLE-STRING CL:SIMPLE-STRING CL:SIMPLE-STRING CL:SIMPLE-STRING
    CL:SIMPLE-STRING))
...
References:  http://www.gbiv.com/protocols/uri/rfc/rfc3986.html"
  ...
  (CL:LET*
   ((FIELD-START 0) (FIELD-END (STRING-SEARCH URL (MAKE-STRING 1 #\:) 0)) (PROTOCOL "") (USER-INFORMATION "")
    (DOMAIN-NAME "") (PORT-NUMBER "") (PATH "") (QUERY "") (FRAGMENT ""))
   (CL:DECLARE (CL:TYPE CL:FIXNUM FIELD-START FIELD-END)
    (CL:TYPE CL:SIMPLE-STRING PROTOCOL USER-INFORMATION DOMAIN-NAME PORT-NUMBER PATH QUERY FRAGMENT))
   (CL:WHEN (CL:NOT (CL:= FIELD-END NULL-INTEGER)) (CL:SETQ PROTOCOL (SUBSEQUENCE URL 0 FIELD-END))
    (CL:IF (CL:= FIELD-END (STRING-SEARCH URL "://" FIELD-END)) (CL:SETQ FIELD-END (CL:+ FIELD-END 3))
     (CL:SETQ FIELD-END (CL:1+ FIELD-END)))
    (CL:SETQ FIELD-START FIELD-END) (CL:SETQ FIELD-END (POSITION URL #\/ FIELD-START))
    (CL:SETQ DOMAIN-NAME (SUBSEQUENCE URL FIELD-START FIELD-END)) (CL:SETQ FIELD-START FIELD-END))
   ...
   (CL:WHEN (CL:NOT (CL:= FIELD-START NULL-INTEGER))
    (CL:SETQ PORT-NUMBER (SUBSEQUENCE DOMAIN-NAME (CL:1+ FIELD-START) NULL-INTEGER))
...
(CL:DECLAIM
 (CL:FTYPE
  (CL:FUNCTION
   (CL:SIMPLE-STRING CL:SIMPLE-STRING CL:SIMPLE-STRING CL:FIXNUM CL:SIMPLE-STRING CL:SIMPLE-STRING CL:SIMPLE-STRING)
   CL:SIMPLE-STRING)
...
components.  Undefined portions can be supplied as NULL or the empty string."
  ...
  (CL:LET* ((URL (NEW-OUTPUT-STRING-STREAM)))
   (CL:WHEN (CL:NOT (BLANK-STRING? PROTOCOL)) (%%PRINT-STREAM (%NATIVE-STREAM URL) PROTOCOL "://"))
   ...
   (CL:WHEN (CL:NOT (BLANK-STRING? PATH))
    (CL:IF (STARTS-WITH? PATH "/" 0) (%%PRINT-STREAM (%NATIVE-STREAM URL) PATH)
     (%%PRINT-STREAM (%NATIVE-STREAM URL) "/" PATH)))
   (CL:WHEN (CL:NOT (BLANK-STRING? QUERY)) (%%PRINT-STREAM (%NATIVE-STREAM URL) "?" QUERY))
   (CL:WHEN (CL:NOT (BLANK-STRING? FRAGMENT)) (%%PRINT-STREAM (%NATIVE-STREAM URL) "#" FRAGMENT))
...
(CL:DEFUN NEW-HTTP-EXCEPTION (MESSAGE)
  ...
  (CL:LET* ((SELF NULL))
   (CL:SETQ SELF
    (CL:MAKE-CONDITION (CL:QUOTE HTTP-EXCEPTION) *CONDITION-MESSAGE-KEYWORD* (REPLACE-SUBSTRINGS MESSAGE "~~" "~")))
...
(CL:DECLAIM
 (CL:FTYPE (CL:FUNCTION (CL:SIMPLE-STRING CL:T) (CL:VALUES CL:SIMPLE-STRING CL:FIXNUM CL:SIMPLE-STRING))
...
message parsing code."
  ...
  (CL:LET*
   ((SPACE1 (POSITION LINE #\  0))
    (SPACE2 (CL:IF (CL:= SPACE1 NULL-INTEGER) NULL-INTEGER (POSITION LINE #\  (CL:1+ SPACE1)))))
   (CL:DECLARE (CL:TYPE CL:FIXNUM SPACE1 SPACE2))
   (CL:WHEN (CL:= SPACE2 NULL-INTEGER)
    (CL:LET* ((STREAM-000 (NEW-OUTPUT-STRING-STREAM)))
     (%%PRINT-STREAM (%NATIVE-STREAM STREAM-000) "Malformed header line: `" LINE "'")
     (CL:ERROR (NEW-STELLA-EXCEPTION (THE-STRING-READER STREAM-000)))))
   (INSERT-AT FIELDS (WRAP-STRING "") (WRAP-STRING LINE))
   (CL:VALUES (SUBSEQUENCE LINE 0 SPACE1) (CL:TRUNCATE (STRING-TO-INTEGER (SUBSEQUENCE LINE (CL:1+ SPACE1) SPACE2)))
...
message parsing code."
  ...
  (CL:LET* ((COLON-POSITION (POSITION LINE #\: 0))) (CL:DECLARE (CL:TYPE CL:FIXNUM COLON-POSITION))
   (CL:IF (CL:= COLON-POSITION NULL-INTEGER)
    (CL:LET* ((STREAM-000 (NEW-OUTPUT-STRING-STREAM)))
     (%%PRINT-STREAM (%NATIVE-STREAM STREAM-000) "Bad header seen: `" LINE "'")
     (CL:ERROR (NEW-STELLA-EXCEPTION (THE-STRING-READER STREAM-000))))
    (INSERT-AT FIELDS (WRAP-STRING (SUBSEQUENCE LINE 0 COLON-POSITION))
     (WRAP-STRING (SUBSEQUENCE LINE (CL:+ COLON-POSITION 2) NULL-INTEGER))))))
...
(CL:DEFUN READ-HTTP-HEADER-LINE (STREAM)
  (CL:LET* ((LINE (NATIVE-READ-LINE STREAM)) (LENGTH (CL:THE CL:FIXNUM (CL:LENGTH LINE))) (NEXTCHAR NULL-CHARACTER))
   ...
   (CL:COND ((CL:EQL NEXTCHAR #\Linefeed)) (CL:T (UNREAD-CHARACTER NEXTCHAR STREAM))) LINE))

;;; (DEFUN (READ-HTTP-HEADER INTEGER STRING STRING) ...)

(CL:DECLAIM
 (CL:FTYPE (CL:FUNCTION (CL:T CL:T) (CL:VALUES CL:FIXNUM CL:SIMPLE-STRING CL:SIMPLE-STRING)) READ-HTTP-HEADER))
...
all values."
  (CL:LET* ((VERSION-STRING STELLA::NULL-STRING) (RESPONSE-CODE NULL-INTEGER) (RESPONSE-MESSAGE STELLA::NULL-STRING))
   ...
   (CL:MULTIPLE-VALUE-SETQ (VERSION-STRING RESPONSE-CODE RESPONSE-MESSAGE)
   ...
   (CL:LET* ((LINE STELLA::NULL-STRING)) (CL:DECLARE (CL:TYPE CL:SIMPLE-STRING LINE))
    (CL:LOOP (CL:SETQ LINE (READ-HTTP-HEADER-LINE STREAM))
     (CL:COND ((STRING-EQL? LINE "") (CL:RETURN)) ((CL:EQ LINE STELLA::NULL-STRING) (CL:RETURN))
  ...
  (CL:LET* ((TEST-VALUE-000 (SAFE-PRIMARY-TYPE CONTENT)))
   (CL:COND
    ((SUBTYPE-OF-STRING? TEST-VALUE-000)
     (CL:PROGN
      (CL:VALUES CONTENT
       (CL:TRUNCATE (CL:THE CL:FIXNUM (CL:LENGTH (CL:THE CL:SIMPLE-STRING (UNWRAP-STRING CONTENT))))))))
    ((SUBTYPE-OF? TEST-VALUE-000 SGT-HTTP-CLIENT-STELLA-FILE-INPUT-STREAM)
...
")
   ...
   (CL:WHEN (CL:NOT (CL:EQ CONTENT NULL))
    (CL:MULTIPLE-VALUE-SETQ (CONTENT CONTENTLENGTH) (GET-CONTENT-AND-LENGTH CONTENT))
    (CL:WHEN (CL:EQ HEADERS NULL) (CL:SETQ HEADERS (NEW-KEY-VALUE-LIST)))
...
")
   (CL:WHEN (CL:NOT (CL:EQ CONTENT NULL))
    (CL:LET* ((TEST-VALUE-000 (SAFE-PRIMARY-TYPE CONTENT)))
     (CL:COND
      ((SUBTYPE-OF-STRING? TEST-VALUE-000) (CL:PROGN (%%PRINT-STREAM (%NATIVE-STREAM STREAM) (UNWRAP-STRING CONTENT))))
      ((SUBTYPE-OF? TEST-VALUE-000 SGT-HTTP-CLIENT-STELLA-INPUT-STREAM)
   ...
   (CL:LET* ((*PRINTREADABLY?* CL:NIL)) (CL:DECLARE (CL:SPECIAL *PRINTREADABLY?*))
    (CL:LET* ((IN NULL) (OUT NULL)) (CL:MULTIPLE-VALUE-SETQ (IN OUT) (OPEN-NETWORK-STREAM HOST PORT))
     ...
     (CL:LET* ((RETURN-CODE NULL-INTEGER) (RETURN-MESSAGE STELLA::NULL-STRING) (VERSION STELLA::NULL-STRING))
      ...
      (CL:MULTIPLE-VALUE-SETQ (RETURN-CODE RETURN-MESSAGE VERSION) (READ-HTTP-HEADER IN RETURN-HEADERS))
      ...
      (CL:COND ((HTTP-SUCCESS-RESPONSE-CODE? RETURN-CODE) IN)
       (CL:T
        (CL:LET* ((SELF-001 (NEW-HTTP-EXCEPTION RETURN-MESSAGE))) (CL:SETF (%ERROR-CODE SELF-001) RETURN-CODE)
         (CL:LET* ((EX SELF-001))
          (%%PRINT-STREAM (%NATIVE-STREAM STANDARD-OUTPUT) "http-post-data: code=" RETURN-CODE ", message="
...
(CL:DECLAIM
 (CL:FTYPE (CL:FUNCTION (CL:SIMPLE-STRING CL:FIXNUM CL:SIMPLE-STRING CL:T CL:T) CL:SIMPLE-STRING)
...
CAUTION: String conversion will not do the right thing for binary data in Java."
  ...
  #+MCL
  (CL:CHECK-TYPE URL-PATH CL:SIMPLE-STRING)
  (CL:LET* ((STREAM (HTTP-POST-DATA HOST PORT URL-PATH HEADERS CONTENT)) (DATA (STREAM-TO-STRING STREAM)))
   (CL:DECLARE (CL:TYPE CL:SIMPLE-STRING DATA)) (CLOSE-STREAM STREAM) DATA))
...
in `return-headers' if not null'.  If an error occurs an HTTP-EXCEPTION is signaled."
  ...
  (CL:LET* ((*PRINTREADABLY?* CL:NIL)) (CL:DECLARE (CL:SPECIAL *PRINTREADABLY?*))
   (CL:LET* ((IN NULL) (OUT NULL)) (CL:MULTIPLE-VALUE-SETQ (IN OUT) (OPEN-NETWORK-STREAM HOST PORT))
    (WRITE-HTTP-REQUEST OUT KWD-HTTP-CLIENT-GET HOST URL-PATH NULL NULL)
    (CL:LET* ((RETURN-CODE NULL-INTEGER) (RETURN-MESSAGE STELLA::NULL-STRING) (VERSION STELLA::NULL-STRING))
     (CL:DECLARE (CL:TYPE CL:FIXNUM RETURN-CODE) (CL:TYPE CL:SIMPLE-STRING RETURN-MESSAGE VERSION))
     (CL:MULTIPLE-VALUE-SETQ (RETURN-CODE RETURN-MESSAGE VERSION) (READ-HTTP-HEADER IN RETURN-HEADERS))
     (CL:SETQ VERSION VERSION)
     (CL:COND ((HTTP-SUCCESS-RESPONSE-CODE? RETURN-CODE) IN)
      (CL:T
       (CL:LET* ((SELF-001 (NEW-HTTP-EXCEPTION RETURN-MESSAGE))) (CL:SETF (%ERROR-CODE SELF-001) RETURN-CODE)
        (CL:LET* ((EX SELF-001))
         (%%PRINT-STREAM (%NATIVE-STREAM STANDARD-OUTPUT) "http-get-data: code=" RETURN-CODE ", message="
          RETURN-MESSAGE ", version=" VERSION)
         (CLOSE-STREAM IN) (CLOSE-STREAM OUT) (CL:ERROR EX)))))))))
...
(CL:DECLAIM
 (CL:FTYPE (CL:FUNCTION (CL:SIMPLE-STRING CL:FIXNUM CL:SIMPLE-STRING CL:T) CL:SIMPLE-STRING) HTTP-GET-DATA-TO-STRING))
...
CAUTION: String conversion will not do the right thing for binary data in Java."
  ...
  #+MCL
  (CL:CHECK-TYPE URL-PATH CL:SIMPLE-STRING)
  (CL:LET* ((STREAM (HTTP-GET-DATA HOST PORT URL-PATH RETURN-HEADERS)) (DATA (STREAM-TO-STRING STREAM)))
   (CL:DECLARE (CL:TYPE CL:SIMPLE-STRING DATA)) (CLOSE-STREAM STREAM) DATA))
...
host with absolute pathnames are supported."
  ...
  (CL:CHECK-TYPE URL CL:SIMPLE-STRING)
  (CL:LET*
   ((PROTOCOL STELLA::NULL-STRING) (USER-INFO STELLA::NULL-STRING) (HOST STELLA::NULL-STRING)
    (PORT STELLA::NULL-STRING) (PATH STELLA::NULL-STRING) (QUERY STELLA::NULL-STRING) (FRAGMENT STELLA::NULL-STRING))
    ...
    (CL:COND
     ((STRING-EQL? TEST-VALUE-000 "http")
      (CL:COND
       ...
       (CL:T
        (CL:LET*
         ((THEPORT HTTP-DEFAULT-PORT) (THEPATH (COMPOSE-INTERNET-URL "" "" "" NULL-INTEGER PATH QUERY FRAGMENT)))
     ...
     (CL:T
      (CL:LET* ((STREAM-003 (NEW-OUTPUT-STRING-STREAM)))
       (%%PRINT-STREAM (%NATIVE-STREAM STREAM-003) "open-url-stream: only http and file URLs are supported: `" URL "'")
...
Syntax is `(WITH-INPUT-URL (var url) body+)'."
  (CL:LET* ((VAR (%%VALUE BINDING)))
   (LIST* SYM-HTTP-CLIENT-STELLA-LET
    (CONS (CONS VAR (LIST* SYM-HTTP-CLIENT-STELLA-INPUT-STREAM SYM-HTTP-CLIENT-STELLA-NULL NIL)) NIL)
    (LIST* SYM-HTTP-CLIENT-STELLA-UNWIND-PROTECT
     (LIST* SYM-HTTP-CLIENT-STELLA-PROGN
      (LIST* SYM-HTTP-CLIENT-STELLA-SETQ VAR
       (CONS (LIST* SYM-HTTP-CLIENT-HTTP-OPEN-URL-STREAM (%%VALUE (%%REST BINDING)) NIL) NIL))
      (CONCATENATE BODY NIL))
     (LIST* SYM-HTTP-CLIENT-STELLA-WHEN (LIST* SYM-HTTP-CLIENT-STELLA-DEFINED? VAR NIL)
...
(CL:DEFUN %DOWNLOAD-URL (URL FILE)
  ...
  (CL:LET* ((OUT NULL))
   (CL:UNWIND-PROTECT
    (CL:PROGN (CL:SETQ OUT (OPEN-OUTPUT-FILE FILE)) (COPY-STREAM-TO-STREAM (OPEN-URL-STREAM URL) OUT))
...
(CL:DEFUN DOWNLOAD-URL-TO-STRING-EVALUATOR-WRAPPER (ARGUMENTS)
  (CL:LET* ((RESULT (%DOWNLOAD-URL-TO-STRING (%WRAPPER-VALUE (%%VALUE ARGUMENTS)))))
...
(CL:DEFUN %DO-HTTP-REQUEST (URI OPTIONS)
  ...
  (CL:LET*
   ((PROPLIST (VET-OPTIONS OPTIONS (GET-QUOTED-TREE "((:METHOD :HEADERS :CONTENT) \"/HTTP\")" "/HTTP")))
    (METHOD (LOOKUP-WITH-DEFAULT PROPLIST KWD-HTTP-CLIENT-METHOD KWD-HTTP-CLIENT-GET))
    (HEADERS (LOOKUP PROPLIST KWD-HTTP-CLIENT-HEADERS)) (CONTENT (LOOKUP PROPLIST KWD-HTTP-CLIENT-CONTENT)))
   (CL:WHEN (CL:NOT (CL:EQ HEADERS NULL))
   ...
   (CL:LET*
    ((PROTOCOL STELLA::NULL-STRING) (USER-INFO STELLA::NULL-STRING) (HOST STELLA::NULL-STRING)
     (PORT STELLA::NULL-STRING) (PATH STELLA::NULL-STRING) (QUERY STELLA::NULL-STRING) (FRAGMENT STELLA::NULL-STRING))
    (CL:DECLARE (CL:TYPE CL:SIMPLE-STRING PROTOCOL USER-INFO HOST PORT PATH QUERY FRAGMENT))
    (CL:MULTIPLE-VALUE-SETQ (PROTOCOL USER-INFO HOST PORT PATH QUERY FRAGMENT) (DECOMPOSE-INTERNET-URL URI))
    (CL:SETQ USER-INFO USER-INFO)
    (CL:WHEN (CL:NOT (STRING-EQUAL? PROTOCOL "http"))
     (CL:LET* ((STREAM-000 (NEW-OUTPUT-STRING-STREAM)))
      (%%PRINT-STREAM (%NATIVE-STREAM STREAM-000) "do-http-request: unsupported protocol: `" PROTOCOL "'")
      (CL:ERROR (NEW-BAD-ARGUMENT-EXCEPTION (THE-STRING-READER STREAM-000)))))
    (CL:LET* ((THEPORT HTTP-DEFAULT-PORT) (THEPATH (COMPOSE-INTERNET-URL "" "" "" NULL-INTEGER PATH QUERY FRAGMENT)))
     ...
     (CL:COND ((CL:EQ METHOD KWD-HTTP-CLIENT-GET) (HTTP-GET-DATA-TO-STRING HOST THEPORT THEPATH HEADERS))
      ...
      (CL:T
       (CL:LET* ((STREAM-001 (NEW-OUTPUT-STRING-STREAM)))
        (%%PRINT-STREAM (%NATIVE-STREAM STREAM-001) "do-http-request: unsupported method: `" METHOD "'")
        (CL:ERROR (NEW-BAD-ARGUMENT-EXCEPTION (THE-STRING-READER STREAM-001))))))))))

(CL:DEFUN DO-HTTP-REQUEST-EVALUATOR-WRAPPER (ARGUMENTS)
  (CL:LET* ((RESULT (%DO-HTTP-REQUEST (%WRAPPER-VALUE (%%VALUE ARGUMENTS)) (%%REST ARGUMENTS))))
   (CL:DECLARE (CL:TYPE CL:SIMPLE-STRING RESULT))
   (CL:IF (CL:NOT (CL:EQ RESULT STELLA::NULL-STRING)) (WRAP-STRING RESULT) NULL)))
  ...
  (CL:LET* ((*MODULE* (GET-STELLA-MODULE "/HTTP" (> *STARTUP-TIME-PHASE* 1))) (*CONTEXT* *MODULE*))
   ...
   (CL:WHEN (CURRENT-STARTUP-TIME-PHASE? 2) (CL:SETQ KWD-HTTP-CLIENT-MAC (INTERN-RIGID-SYMBOL-WRT-MODULE "MAC" NULL 2))
    ...
    (CL:SETQ SGT-HTTP-CLIENT-STELLA-FILE-INPUT-STREAM
     (INTERN-RIGID-SYMBOL-WRT-MODULE "FILE-INPUT-STREAM" (GET-STELLA-MODULE "/STELLA" CL:T) 1))
    (CL:SETQ SGT-HTTP-CLIENT-STELLA-INPUT-STREAM
     (INTERN-RIGID-SYMBOL-WRT-MODULE "INPUT-STREAM" (GET-STELLA-MODULE "/STELLA" CL:T) 1))
    (CL:SETQ KWD-HTTP-CLIENT-POST (INTERN-RIGID-SYMBOL-WRT-MODULE "POST" NULL 2))
    (CL:SETQ KWD-HTTP-CLIENT-GET (INTERN-RIGID-SYMBOL-WRT-MODULE "GET" NULL 2))
    ...
    (CL:SETQ SYM-HTTP-CLIENT-STELLA-INPUT-STREAM
     (INTERN-RIGID-SYMBOL-WRT-MODULE "INPUT-STREAM" (GET-STELLA-MODULE "/STELLA" CL:T) 0))
    ...
    (CL:SETQ SYM-HTTP-CLIENT-STELLA-UNWIND-PROTECT
     (INTERN-RIGID-SYMBOL-WRT-MODULE "UNWIND-PROTECT" (GET-STELLA-MODULE "/STELLA" CL:T) 0))
    ...
    (CL:SETQ SYM-HTTP-CLIENT-STELLA-CLOSE-STREAM
     (INTERN-RIGID-SYMBOL-WRT-MODULE "CLOSE-STREAM" (GET-STELLA-MODULE "/STELLA" CL:T) 0))
    ...
    (CL:SETQ KWD-HTTP-CLIENT-METHOD (INTERN-RIGID-SYMBOL-WRT-MODULE "METHOD" NULL 2))
    (CL:SETQ KWD-HTTP-CLIENT-HEADERS (INTERN-RIGID-SYMBOL-WRT-MODULE "HEADERS" NULL 2))
...
References:  http://www.gbiv.com/protocols/uri/rfc/rfc3986.html\" :PUBLIC? TRUE)" (CL:FUNCTION DECOMPOSE-INTERNET-URL)
     NULL)
...
message parsing code.\" :PUBLIC? TRUE)" (CL:FUNCTION HANDLE-HTTP-HEADER-OTHER-LINE) NULL)
    (DEFINE-FUNCTION-OBJECT "READ-HTTP-HEADER-LINE" "(DEFUN (READ-HTTP-HEADER-LINE STRING) ((STREAM INPUT-STREAM)))"
...
all values.\" :PUBLIC? TRUE)" (CL:FUNCTION READ-HTTP-HEADER) NULL)
    (DEFINE-FUNCTION-OBJECT "GET-CONTENT-AND-LENGTH"
     "(DEFUN (GET-CONTENT-AND-LENGTH OBJECT LONG-INTEGER) ((CONTENT OBJECT)))" (CL:FUNCTION GET-CONTENT-AND-LENGTH)
     NULL)
...
CAUTION: String conversion will not do the right thing for binary data in Java.\" :PUBLIC? TRUE :COMMAND? TRUE)"
     (CL:FUNCTION %DOWNLOAD-URL-TO-STRING) (CL:FUNCTION DOWNLOAD-URL-TO-STRING-EVALUATOR-WRAPPER))
    ...
    (DEFINE-FUNCTION-OBJECT "STARTUP-HTTP-CLIENT" "(DEFUN STARTUP-HTTP-CLIENT () :PUBLIC? TRUE)"
     (CL:FUNCTION STARTUP-HTTP-CLIENT) NULL)
    (CL:LET* ((FUNCTION (LOOKUP-FUNCTION SYM-HTTP-CLIENT-HTTP-STARTUP-HTTP-CLIENT)))
     (SET-DYNAMIC-SLOT-VALUE (%DYNAMIC-SLOTS FUNCTION) SYM-HTTP-CLIENT-STELLA-METHOD-STARTUP-CLASSNAME
   ...
   (CL:WHEN (CURRENT-STARTUP-TIME-PHASE? 9) (%IN-MODULE (COPY-CONS-TREE (WRAP-STRING "HTTP")))
    ...
    (REGISTER-NATIVE-NAME SYM-HTTP-CLIENT-HTTP-DOWNLOAD-URL-TO-STRING KWD-HTTP-CLIENT-COMMON-LISP
     KWD-HTTP-CLIENT-FUNCTION)
