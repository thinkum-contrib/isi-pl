...
(CL:DECLAIM
 (CL:SPECIAL *STARTUP-TIME-PHASE* NULL-CHARACTER *MODULE* *NAMESPACE-URI-PREFIX-TABLE* NULL-STRING-WRAPPER
  STANDARD-OUTPUT EOL *INVISIBLE-NAMESPACES-ON-OUTPUT* *NAMESPACE-PREFIX-URI-TABLE* NIL NULL-INTEGER NULL-FLOAT))
...
(CL:DEFMETHOD TO-XML ((|object| |XMLObject|) |namespaceStack|)
  (CL:LET*
   ((|objectTag| (MAKE-ELEMENT-TAG |object|)) (|slots| (GET-MAPPED-SLOTS |object|))
    (|objectNamespace| (GET-NAMESPACE-PREFIX |object|)) (|newNamespaceStack| |namespaceStack|)
    (|attributeNamespaceName| NULL) (|attributeValueNamespaceName| NULL) (|namespaceURI| NULL)
    (|namespaceAttributes| NIL) (|attributes| NIL) (|elements| NIL) (|collections| NIL))
   ...
   (CL:WHEN (CL:NOT (MEMBER? |newNamespaceStack| (WRAP-STRING |objectNamespace|)))
    ...
    (CL:WHEN (CL:NOT (CL:EQ |namespaceURI| NULL))
     (CL:SETQ |namespaceAttributes| (CONS (MAKE-NAMESPACE-ATTRIBUTE |objectNamespace|) |namespaceAttributes|))
    ...
    (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-000 NIL)) DO (CL:SETQ |slot| (%%VALUE ITER-000))
     (CL:WHEN (CL:AND (ATTRIBUTE-SLOT? |slot|) (CL:NOT (SLOT-VALUE-IS-NULL? |object| |slot|)))
      ...
      (CL:WHEN (CL:NOT (MEMBER? |newNamespaceStack| |attributeNamespaceName|))
       (CL:SETQ |newNamespaceStack| (CONS |attributeNamespaceName| |newNamespaceStack|))
       (CL:SETQ |namespaceURI| (LOOKUP *NAMESPACE-PREFIX-URI-TABLE* |attributeNamespaceName|))
       (CL:WHEN (CL:NOT (CL:EQ |namespaceURI| NULL))
        (CL:SETQ |namespaceAttributes|
         (CONS (MAKE-NAMESPACE-ATTRIBUTE (%WRAPPER-VALUE |attributeNamespaceName|)) |namespaceAttributes|))
        (CL:SETQ |namespaceAttributes| (CONS |namespaceURI| |namespaceAttributes|))))
      (CL:SETQ |attributeValueNamespaceName| (GET-ATTRIBUTE-VALUE-NAMESPACE-NAME |object| |slot|))
      (CL:WHEN
       (CL:NOT
        (CL:OR (CL:EQ |attributeValueNamespaceName| NULL) (MEMBER? |newNamespaceStack| |attributeValueNamespaceName|)))
       ...
       (CL:WHEN (CL:NOT (CL:EQ |namespaceURI| NULL))
        (CL:SETQ |namespaceAttributes|
         (CONS (MAKE-NAMESPACE-ATTRIBUTE (%WRAPPER-VALUE |attributeValueNamespaceName|)) |namespaceAttributes|))
        (CL:SETQ |namespaceAttributes| (CONS |namespaceURI| |namespaceAttributes|)))))
     ...
     (CL:COND
      ((ELEMENT-SLOT? |slot|)
       (CL:WHEN (CL:NOT (SLOT-VALUE-IS-NULL? |object| |slot|))
        (CL:SETQ |elements| (CONS (MAKE-ELEMENT |object| |slot| |newNamespaceStack|) |elements|))))
   ...
   (CONS |objectTag|
    (CONS (CONCATENATE (REVERSE |namespaceAttributes|) (CONCATENATE (REVERSE |attributes|) NIL))
     (CONCATENATE (REVERSE |elements|)
      (CONCATENATE (REVERSE |collections|) (CONCATENATE (MAKE-CONTENT-EXPRESSION |object|) NIL)))))))
...
(CL:DEFUN GET-NAMESPACE-PREFIX (|object|)
  (CL:LET* ((|theClass| (%SURROGATE-VALUE (PRIMARY-TYPE |object|))) (|module| (HOME-MODULE |theClass|)))
   (%MODULE-NAME |module|)))
...
(CL:DEFUN GET-NAMESPACE-URI (|namespacePrefix|)
  ...
  (CL:LET* ((|uri| (LOOKUP *NAMESPACE-PREFIX-URI-TABLE* (WRAP-STRING |namespacePrefix|))))
   (CL:IF (CL:NOT (CL:EQ |uri| NULL)) |uri| NULL)))

;;; (DEFUN (MAKE-CONTENT-EXPRESSION CONS) ...)

(CL:DEFUN MAKE-CONTENT-EXPRESSION (|object|)
  (CL:LET* ((|result| NIL) (|content| (|%textContent| |object|)) (|cdata| (|%cdataContent| |object|)))
...
(CL:DEFUN MAKE-ELEMENT-TAG (|object|)
  (CL:LET*
   ((|tagType| (GET-ELEMENT-NAME-FROM-OBJECT |object|)) (|namespacePrefix| (GET-NAMESPACE-PREFIX |object|))
   ...
   (CL:IF
    (CL:OR (CL:EQ |namespaceURI| NULL)
     (CL:AND *SUPRESS-NAMESPACES?* (MEMBER? *INVISIBLE-NAMESPACES-ON-OUTPUT* (WRAP-STRING |namespacePrefix|))))
    (CL:LET* ((SELF-000 (NEW-XML-ELEMENT))) (CL:SETF (%NAME SELF-000) |tagType|)
     (CL:SETF (%SURFACE-FORM SELF-000) |tagType|) (CL:LET* ((VALUE-000 SELF-000)) VALUE-000))
    (CL:LET* ((SELF-001 (NEW-XML-ELEMENT))) (CL:SETF (%NAME SELF-001) |tagType|)
     (CL:SETF (%SURFACE-FORM SELF-001) (CONCATENATE |namespacePrefix| ":" |tagType|))
     (CL:SETF (%NAMESPACE-NAME SELF-001) |namespacePrefix|)
     (CL:SETF (%NAMESPACE-URI SELF-001) (%WRAPPER-VALUE |namespaceURI|)) (CL:LET* ((VALUE-001 SELF-001)) VALUE-001)))))
...
(CL:DEFUN MAKE-NAMESPACE-ATTRIBUTE (|namespaceName|)
  ...
  (CL:LET* ((SELF-000 (NEW-XML-GLOBAL-ATTRIBUTE)))
   (CL:SETF (%SURFACE-FORM SELF-000) (CONCATENATE "xmlns:" |namespaceName|)) (CL:SETF (%NAME SELF-000) |namespaceName|)
...
(CL:DEFUN GET-ATTRIBUTE-VALUE-NAMESPACE-NAME (|parentObject| |slot|)
  (CL:LET* ((|attributeValue| (UNWRAP-STRING (GET-OBJECT-SLOT-VALUE |parentObject| |slot|))))
   (CL:DECLARE (CL:TYPE CL:SIMPLE-STRING |attributeValue|))
   (CL:WHEN (CL:NOT (CL:EQ |attributeValue| STELLA::NULL-STRING))
    (CL:LET* ((|valueNamespaceName| (GET-VALUE-NAMESPACE-PREFIX |attributeValue|)))
     (CL:DECLARE (CL:TYPE CL:SIMPLE-STRING |valueNamespaceName|))
     (CL:WHEN
      (CL:AND (CL:NOT (CL:EQ |valueNamespaceName| STELLA::NULL-STRING))
       (CL:NOT (CL:EQ (LOOKUP *NAMESPACE-PREFIX-URI-TABLE* (WRAP-STRING |valueNamespaceName|)) NULL)))
...
(CL:DEFUN GET-VALUE-NAMESPACE-PREFIX (|valueString|)
  ...
  (CL:LET* ((|colonPos| (STRING-SEARCH |valueString| ":" 0))) (CL:DECLARE (CL:TYPE CL:FIXNUM |colonPos|))
   (CL:WHEN (CL:NOT (CL:= |colonPos| NULL-INTEGER))
    (CL:RETURN-FROM GET-VALUE-NAMESPACE-PREFIX (SUBSEQUENCE |valueString| 0 |colonPos|)))
   STELLA::NULL-STRING))
   ...
   (CL:LET* ((CHOOSE-VALUE-000 NULL))
    (CL:IF
     ...
     (CL:LET* ((SELF-001 (NEW-XML-GLOBAL-ATTRIBUTE))) (CL:SETF (%NAME SELF-001) (%SYMBOL-NAME |attributeName|))
      (CL:SETF (%SURFACE-FORM SELF-001) (CONCATENATE |namespacePrefix| ":" (%SYMBOL-NAME |attributeName|)))
      (CL:SETF (%NAMESPACE-NAME SELF-001) |namespacePrefix|)
   ...
   (CL:LET* ((|element| NULL) (ITER-000 (%THE-CONS-LIST |elements|)) (COLLECT-000 NULL))
    (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-000 NIL)) DO (CL:SETQ |element| (%%VALUE ITER-000))
     (CL:IF (CL:EQ COLLECT-000 NULL)
      ...
      (CL:PROGN (CL:SETF (%%REST COLLECT-000) (CONS (TO-XML |element| |namespaceStack|) NIL))
...
(CL:DEFUN FROM-XML (|expr|)
  (CL:LET*
   ((|elementName| (GET-ELEMENT-NAME-FROM-EXPR |expr|))
    ...
    (|attributeExpressions| (%%VALUE (%%REST |expr|))) (|elementExpressions| (%%REST (%%REST |expr|)))
    (|theObject|
     (MAKE-XML-OBJECT (%WRAPPER-VALUE |elementName|) (%WRAPPER-VALUE |elementNamespaceName|)
      (%WRAPPER-VALUE |elementNamespaceURI|))))
   (SET-ATTRIBUTES |theObject| |attributeExpressions|) (SET-ELEMENTS |theObject| |elementExpressions|)
   ...
   (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-000 NIL)) DO (CL:SETQ |expr| (%%VALUE ITER-000))
    (CL:COND
     ((SUBTYPE-OF-STRING? (SAFE-PRIMARY-TYPE |expr|))
      (CL:PROGN (SET-OBJECT-SLOT-VALUE |object| (LOOKUP-CONTENT-SLOT |object|) |expr|)))
     (CL:T
      (CL:IF (CL:AND (ISA? |expr| SGT-MARSHALLER-STELLA-CONS) (XML-CDATA? (%%VALUE |expr|)))
       ...
       (CL:LET* ((|matchingSlot| (LOOKUP-ELEMENT-SLOT |object| |expr|)))
        (CL:WHEN (CL:NOT (CL:EQ |matchingSlot| NULL))
         (CL:LET* ((|value| (FROM-XML |expr|))) (SET-OBJECT-SLOT-VALUE |object| |matchingSlot| |value|)))))))
    (CL:SETQ ITER-000 (%%REST ITER-000)))))
  ...
  (CL:LET* ((SELF-000 (NEW-PROPERTY-LIST))) (CL:SETF (%THE-PLIST SELF-000) |attributeExprs|)
   (CL:LET* ((|plist| SELF-000))
    (CL:LET* ((|attribute| NULL) (|value| NULL) (ITER-000 (%THE-PLIST |plist|)))
     (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-000 NIL)) DO (CL:SETQ |attribute| (%%VALUE ITER-000))
    ...
    (CL:COND ((SUBTYPE-OF-STRING? (SAFE-PRIMARY-TYPE |expr|)) (CL:PROGN))
     (CL:T
      (CL:LET* ((|matchingSlot| (LOOKUP-COLLECTION-SLOT |object| |expr|)))
       (CL:WHEN (CL:NOT (CL:EQ |matchingSlot| NULL))
        (CL:LET* ((|value| (FROM-XML |expr|))) (SET-COLLECTION-SLOT-VALUE |object| |matchingSlot| |value|))))))
    (CL:SETQ ITER-000 (%%REST ITER-000)))))
  ...
  (CL:LET* ((|name| (%NAME |tag|))) (CL:DECLARE (CL:TYPE CL:SIMPLE-STRING |name|))
   ...
   (CL:WHEN (CL:OR |useType?| |useParametricType?|)
    (CL:LET* ((|slotType| NULL) (|slotParametricType| NULL))
     (CL:MULTIPLE-VALUE-SETQ (|slotType| |slotParametricType|) (SLOT-BASE-AND-PARAMETER-TYPE |slot|))
     (CL:WHEN (CL:AND |useType?| (STRING-EQL? |name| (%SYMBOL-NAME |slotType|)))
      (CL:RETURN-FROM SLOT-REPRESENTS-TAG? CL:T))
     (CL:WHEN (CL:AND |useParametricType?| (STRING-EQL? |name| (%SYMBOL-NAME |slotParametricType|)))
      (CL:RETURN-FROM SLOT-REPRESENTS-TAG? CL:T))))
   CL:NIL))
    ...
    (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-000 NIL)) DO (CL:SETQ |slot| (%%VALUE ITER-000))
     (CL:WHEN (ELEMENT-SLOT? |slot|)
      (CL:COND ((SLOT-REPRESENTS-TAG? |slot| |tag| CL:T CL:NIL) (CL:RETURN-FROM LOOKUP-ELEMENT-SLOT |slot|))
       ...
       (CL:T)))
     (CL:SETQ ITER-000 (%%REST ITER-000))))
   (CL:COND ((CL:EQ |general-slots| NIL) NULL) ((CL:EQ (%%REST |general-slots|) NIL) (%%VALUE |general-slots|))
    (CL:T NULL))))
...
(CL:DEFUN LOOKUP-ATTRIBUTE-SLOT (|object| |attribute|)
  (CL:LET* ((|slot| NULL) (ITER-000 (%THE-CONS-LIST (GET-MAPPED-SLOTS |object|))))
   (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-000 NIL)) DO (CL:SETQ |slot| (%%VALUE ITER-000))
    (CL:WHEN (CL:AND (ATTRIBUTE-SLOT? |slot|) (SLOT-REPRESENTS-TAG? |slot| |attribute| CL:NIL CL:NIL))
...
(CL:DEFUN LOOKUP-COLLECTION-SLOT (|object| |elementExpr|)
  (CL:LET* ((|tag| (%%VALUE |elementExpr|)))
   (CL:LET* ((|slot| NULL) (ITER-000 (%THE-CONS-LIST (GET-MAPPED-SLOTS |object|))))
    (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-000 NIL)) DO (CL:SETQ |slot| (%%VALUE ITER-000))
     (CL:WHEN (CL:AND (COLLECTION-SLOT? |slot|) (SLOT-REPRESENTS-TAG? |slot| |tag| CL:NIL CL:T))
...
(CL:DEFCLASS ID-PARENT-STRUCT (OBJECT)
  ((|id| :TYPE CL:FIXNUM :INITFORM NULL-INTEGER :ALLOCATION :INSTANCE :ACCESSOR |%id|)
   (|parents| :ALLOCATION :INSTANCE :ACCESSOR |%parents|)))

(CL:DEFUN NEW-ID-PARENT-STRUCT ()
  (CL:LET* ((SELF NULL)) (CL:SETQ SELF (CL:MAKE-INSTANCE (CL:QUOTE ID-PARENT-STRUCT))) (CL:SETF (|%parents| SELF) NULL)
   (CL:SETF (|%id| SELF) NULL-INTEGER) SELF))
...
(CL:DEFUN ACCESS-ID-PARENT-STRUCT-SLOT-VALUE (SELF SLOTNAME VALUE SETVALUE?)
  (CL:COND
   ((CL:EQ SLOTNAME |SYM-MARSHALLER-XML-OBJECTS-id|)
    (CL:IF SETVALUE? (CL:SETF (|%id| SELF) (%WRAPPER-VALUE VALUE)) (CL:SETQ VALUE (WRAP-INTEGER (|%id| SELF)))))
   ((CL:EQ SLOTNAME |SYM-MARSHALLER-XML-OBJECTS-parents|)
    (CL:IF SETVALUE? (CL:SETF (|%parents| SELF) VALUE) (CL:SETQ VALUE (|%parents| SELF))))
   (CL:T
...
(CL:DEFUN GET-NEXT-ID ()
  (CL:LET* ((|currentID| *CURRENT-ID*)) (CL:DECLARE (CL:TYPE CL:FIXNUM |currentID|))
...
(CL:DEFUN INSERT-NODE-PARENTS-TABLE (|node| |parent|)
  ...
  (CL:LET* ((|parents| (LOOKUP *NODE-PARENTS-TABLE* |node|)) (|result| CL:NIL))
   (CL:WHEN (CL:EQ |parents| NULL) (CL:SETQ |result| CL:T) (CL:SETQ |parents| (NEW-LIST))
...
(CL:DEFUN INSERT-NODE-ID-PARENTS-TABLE (|node| |parent|)
  (CL:LET* ((|idParentStruct| (LOOKUP *NODE-ID-PARENTS-TABLE* |node|)) (|parents| NULL))
   (CL:IF (CL:EQ |idParentStruct| NULL)
    (CL:PROGN (CL:SETQ |idParentStruct| (NEW-ID-PARENT-STRUCT)) (CL:SETQ |parents| (NEW-LIST))
     (CL:SETF (|%id| |idParentStruct|) (GET-NEXT-ID)) (CL:SETF (|%parents| |idParentStruct|) |parents|)
...
(CL:DEFUN GET-CHILDREN (|node|)
  (CL:LET* ((|result| NIL))
   (CL:LET* ((|slot| NULL) (ITER-000 (%THE-CONS-LIST (GET-MAPPED-SLOTS |node|))))
    (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-000 NIL)) DO (CL:SETQ |slot| (%%VALUE ITER-000))
     (CL:WHEN (CL:AND (ELEMENT-SLOT? |slot|) (CL:NOT (SLOT-VALUE-IS-NULL? |node| |slot|)))
      (CL:SETQ |result| (CONS (GET-OBJECT-SLOT-VALUE |node| |slot|) |result|)))
     (CL:SETQ ITER-000 (%%REST ITER-000))))
   |result|))
   ...
   (CL:WHEN |firstVisit?|
    (CL:LET* ((|child| NULL) (ITER-000 |children|))
     (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-000 NIL)) DO (CL:SETQ |child| (%%VALUE ITER-000))
      (HELP-POPULATE-NODE-PARENTS-TABLE |child| |node|) (CL:SETQ ITER-000 (%%REST ITER-000)))))))
...
(CL:DEFUN CREATE-NODE-ID-PARENT-TABLE ()
  (CL:LET* ((|node| NULL) (|parents| NULL) (ITER-000 (%THE-PLIST *NODE-PARENTS-TABLE*)))
   (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-000 NIL)) DO (CL:SETQ |node| (%%VALUE ITER-000))
    ...
    (CL:PROGN (%%PRINT-STREAM (%NATIVE-STREAM STANDARD-OUTPUT) "node = " |node| ", parents = " |parents| EOL)
     (CL:WHEN (CL:> (LENGTH |parents|) 1)
      (CL:LET* ((|parent| NULL) (ITER-001 (%THE-CONS-LIST |parents|)))
       (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-001 NIL)) DO (CL:SETQ |parent| (%%VALUE ITER-001))
        (INSERT-NODE-ID-PARENTS-TABLE |node| |parent|) (CL:SETQ ITER-001 (%%REST ITER-001))))))
    (CL:SETQ ITER-000 (%%REST (%%REST ITER-000))))))
...
(CL:DEFUN HELP-SIMULATE-MULTIREF-OUTPUT (|node| |parent| |indent|)
  ...
  (CL:LET* ((|nodeName| (GET-ELEMENT-NAME-FROM-OBJECT |node|)) (|children| (GET-CHILDREN |node|)))
   (CL:DECLARE (CL:TYPE CL:SIMPLE-STRING |nodeName|))
   (CL:LET*
    ((I NULL-INTEGER) (ITER-000 1) (UPPER-BOUND-000 |indent|) (UNBOUNDED?-000 (CL:= UPPER-BOUND-000 NULL-INTEGER)))
    (CL:DECLARE (CL:TYPE CL:FIXNUM I ITER-000 UPPER-BOUND-000))
    (CL:LOOP WHILE (CL:OR UNBOUNDED?-000 (CL:<= ITER-000 UPPER-BOUND-000)) DO (CL:SETQ I ITER-000) (CL:SETQ I I)
     (%%PRINT-STREAM (%NATIVE-STREAM STANDARD-OUTPUT) " ") (CL:SETQ ITER-000 (CL:1+ ITER-000))))
   (%%PRINT-STREAM (%NATIVE-STREAM STANDARD-OUTPUT) |nodeName|)
   (CL:COND
    ((FIRST-PARENT-FOR-MULTIREF-NODE? |node| |parent|)
     (%%PRINT-STREAM (%NATIVE-STREAM STANDARD-OUTPUT) " id=" (GET-NODE-ID |node|)))
    ((NTH-PARENT-FOR-MULTIREF-NODE? |node| |parent|)
     (%%PRINT-STREAM (%NATIVE-STREAM STANDARD-OUTPUT) " href=" (GET-NODE-ID |node|))))
   (%%PRINT-STREAM (%NATIVE-STREAM STANDARD-OUTPUT) EOL)
   (CL:LET* ((|child| NULL) (ITER-001 |children|))
    (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-001 NIL)) DO (CL:SETQ |child| (%%VALUE ITER-001))
     (HELP-SIMULATE-MULTIREF-OUTPUT |child| |node| (CL:+ |indent| 2)) (CL:SETQ ITER-001 (%%REST ITER-001))))))
   ...
   (CL:LET* ((TEST-VALUE-000 (SAFE-PRIMARY-TYPE |typeSpec|)))
    (CL:COND ((SUBTYPE-OF-SURROGATE? TEST-VALUE-000) (CL:PROGN (CL:VALUES |typeSpec| NULL)))
     ((SUBTYPE-OF-PARAMETRIC-TYPE-SPECIFIER? TEST-VALUE-000)
      (CL:PROGN (CL:VALUES (%SPECIFIER-BASE-TYPE |typeSpec|) (FIRST (%SPECIFIER-PARAMETER-TYPES |typeSpec|)))))
   ...
   (CL:LOOP WHILE (NEXT? ITER-000) DO (CL:SETQ |item| (%VALUE ITER-000))
    (CL:WHEN
     (CL:OR (CL:NOT |skipFrontmatter?|)
      (CL:AND (ISA? |item| SGT-MARSHALLER-STELLA-CONS) (ISA? (%%VALUE |item|) SGT-MARSHALLER-STELLA-XML-ELEMENT))
...
(CL:DEFUN FIND-SLOT (|name| |slots| |useParametricType?| |useType?|)
  ...
  (CL:WHEN
   (CL:AND |useType?| (CL:= (LENGTH |slots|) 1)
    (CL:EQ (SLOT-BASE-AND-PARAMETER-TYPE (FIRST |slots|)) |SGT-MARSHALLER-XML-OBJECTS-XMLObject|))
   ...
   (CL:LET* ((|slot| NULL) (ITER-000 (%THE-CONS-LIST |slots|)))
    (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-000 NIL)) DO (CL:SETQ |slot| (%%VALUE ITER-000))
     (CL:LET* ((|slotType| NULL) (|slotParametricType| NULL))
      (CL:MULTIPLE-VALUE-SETQ (|slotType| |slotParametricType|) (SLOT-BASE-AND-PARAMETER-TYPE |slot|))
      (CL:WHEN
       (CL:OR (CL:AND |useType?| (STRING-EQL? |name| (%SYMBOL-NAME |slotType|)))
        (CL:AND |useParametricType?| (STRING-EQL? |name| (%SYMBOL-NAME |slotParametricType|)))
...
(CL:DEFUN GET-ELEMENT-NAME-FROM-OBJECT (|object|)
  (CL:LET* ((|className| (%SYMBOL-NAME (PRIMARY-TYPE |object|)))) (CL:DECLARE (CL:TYPE CL:SIMPLE-STRING |className|))
   |className|))
...
(CL:DEFUN LOOKUP-OBJECT-CREATION-MODULE (|namespacePrefix|)
  ...
  (CL:LET* ((|creationModule| NULL))
   ...
   (CL:WHEN (CL:EQ |creationModule| NULL)
    (CL:IF (CL:NOT (CL:EQ *DEFAULT-XML-OBJECT-MODULE* NULL)) (CL:SETQ |creationModule| *DEFAULT-XML-OBJECT-MODULE*)
...
(CL:DEFUN MAKE-XML-OBJECT (|className| |namespacePrefix| |namespaceURI|)
  ...
  (CL:LET*
   ((|theType| (LOOKUP-SURROGATE-IN-MODULE |className| (LOOKUP-OBJECT-CREATION-MODULE |namespacePrefix|) CL:T)))
   (CL:WHEN (CL:EQ |theType| NULL)
    (CL:LET* ((STREAM-000 (NEW-OUTPUT-STRING-STREAM)))
     (%%PRINT-STREAM (%NATIVE-STREAM STREAM-000) "Couldn't find a class for `" |className| "' in target module `"
      (LOOKUP-OBJECT-CREATION-MODULE |namespacePrefix|) "'")
     (CL:ERROR (NEW-NO-SUCH-OBJECT-EXCEPTION (THE-STRING-READER STREAM-000)))))
   (CL:LET* ((|theClass| (%SURROGATE-VALUE |theType|)) (|theConstructor| (%CLASS-CONSTRUCTOR-CODE |theClass|)))
...
(CL:DEFUN ATTRIBUTE-SLOT? (|slot|)
  (CL:LET* ((|stringType| SGT-MARSHALLER-STELLA-STRING) (|slotType| (TYPE |slot|)))
   (CL:AND (CL:NOT (CL:EQ (%SLOT-NAME |slot|) |SYM-MARSHALLER-XML-OBJECTS-textContent|))
    (SUBTYPE-OF? |slotType| |stringType|))))

;;; (DEFUN (ELEMENT-SLOT? BOOLEAN) ...)

(CL:DEFUN ELEMENT-SLOT? (|slot|)
  (CL:LET* ((|rootXMLType| |SGT-MARSHALLER-XML-OBJECTS-XMLObject|) (|slotType| (TYPE |slot|)))
    ...
    (CL:COND
     ((CL:EQ |encoding| KWD-MARSHALLER-BASE64)
      (CL:IF (STRING? |value|) (CL:SETQ |value| (WRAP-STRING (BASE64-DECODE-STRING (%WRAPPER-VALUE |value|))))
       (CL:LET* ((STREAM-000 (NEW-OUTPUT-STRING-STREAM)))
        (%%PRINT-STREAM (%NATIVE-STREAM STREAM-000) "Don't know how to base64-decode this object: `" |value| "'")
        (CL:ERROR (NEW-STELLA-EXCEPTION (THE-STRING-READER STREAM-000))))))
     ((CL:EQ |encoding| KWD-MARSHALLER-PLAIN))
     (CL:T
      (CL:LET* ((STREAM-001 (NEW-OUTPUT-STRING-STREAM)))
       (%%PRINT-STREAM (%NATIVE-STREAM STREAM-001) "Unknown encoding scheme: `" |encoding| "'")
    ...
    (CL:COND
     ((CL:EQ |encoding| KWD-MARSHALLER-BASE64)
      (CL:IF (STRING? |value|) (CL:SETQ |value| (WRAP-STRING (BASE64-ENCODE-STRING (%WRAPPER-VALUE |value|))))
       (CL:LET* ((STREAM-000 (NEW-OUTPUT-STRING-STREAM)))
        (%%PRINT-STREAM (%NATIVE-STREAM STREAM-000) "Don't know how to base64-encode this object: `" |value| "'")
        (CL:ERROR (NEW-STELLA-EXCEPTION (THE-STRING-READER STREAM-000))))))
     ((CL:EQ |encoding| KWD-MARSHALLER-PLAIN))
     (CL:T
      (CL:LET* ((STREAM-001 (NEW-OUTPUT-STRING-STREAM)))
...
(CL:DEFUN INITIALIZE-BASE64-DECODING-TABLE ()
  (CL:LET* ((|buffer| (CL:MAKE-ARRAY 256))) (CL:DECLARE (CL:TYPE CL:SIMPLE-VECTOR |buffer|))
   (CL:LET* ((|i| NULL-INTEGER) (ITER-000 0) (UPPER-BOUND-000 255))
    (CL:DECLARE (CL:TYPE CL:FIXNUM |i| ITER-000 UPPER-BOUND-000))
    (CL:LOOP WHILE (CL:<= ITER-000 UPPER-BOUND-000) DO (CL:SETQ |i| ITER-000) (CL:SETF (CL:AREF |buffer| |i|) -1)
     (CL:SETQ ITER-000 (CL:1+ ITER-000))))
   (CL:LET*
    ((|ch| NULL-CHARACTER) (VECTOR-000 *BASE64-ENCODING-TABLE*) (INDEX-000 0)
     (LENGTH-000 (CL:THE CL:FIXNUM (CL:LENGTH VECTOR-000))) (|code| NULL-INTEGER) (ITER-001 0) (UPPER-BOUND-001 63))
    ...
    (CL:LOOP WHILE (CL:AND (CL:< INDEX-000 LENGTH-000) (CL:<= ITER-001 UPPER-BOUND-001)) DO
     ...
     (CL:SETQ |code| ITER-001) (CL:SETF (CL:AREF |buffer| (CL:THE CL:FIXNUM (CL:CHAR-CODE |ch|))) |code|)
...
(CL:DEFUN BASE64-ENCODE-STRING (|input|)
  ...
  (CL:LET*
   ((|inputLength| (CL:THE CL:FIXNUM (CL:LENGTH |input|))) (|codeLength| (CL:* (CEILING (CL:/ |inputLength| 3.0d0)) 4))
    (|nofLines| (CEILING (CL:/ |codeLength| 76.0d0))) (|outputLength| (CL:+ |codeLength| (CL:* |nofLines| 2)))
    (|output| (MAKE-RAW-MUTABLE-STRING |outputLength|)) (|encodingTable| *BASE64-ENCODING-TABLE*) (|triple| 0)
    (|inputCursor| 0) (|outputCursor| 0) (|eolPosition| 76) (|nofPads| 0))
   (CL:DECLARE
    (CL:TYPE CL:FIXNUM |inputLength| |codeLength| |nofLines| |outputLength| |triple| |inputCursor| |outputCursor|
     |eolPosition| |nofPads|)
   ...
   (CL:LOOP (CL:WHEN (CL:= |inputCursor| |inputLength|) (CL:RETURN))
     ...
     ((SELF |output|)
      (CH
       (CL:LET
        ((SELF |encodingTable|)
         (POSITION
          (CL:LET ((ARG |triple|) (COUNT 18)) (CL:DECLARE (CL:TYPE CL:FIXNUM ARG COUNT))
        ...
        ((SELF |encodingTable|)
         (POSITION
          (CL:THE CL:FIXNUM
           (CL:LOGAND
            (CL:THE CL:FIXNUM
             (CL:LET ((ARG |triple|) (COUNT 12)) (CL:DECLARE (CL:TYPE CL:FIXNUM ARG COUNT))
              (CL:THE CL:FIXNUM (CL:ASH ARG (CL:THE CL:FIXNUM (CL:- COUNT))))))
            63))))
        (CL:DECLARE (CL:TYPE CL:SIMPLE-STRING SELF) (CL:TYPE CL:FIXNUM POSITION))
        (CL:SCHAR (CL:THE CL:SIMPLE-STRING SELF) (CL:THE CL:FIXNUM POSITION))))
        ...
        ((SELF |encodingTable|)
         (POSITION
          (CL:THE CL:FIXNUM
           (CL:LOGAND
            (CL:THE CL:FIXNUM
             (CL:LET ((ARG |triple|) (COUNT 6)) (CL:DECLARE (CL:TYPE CL:FIXNUM ARG COUNT))
              (CL:THE CL:FIXNUM (CL:ASH ARG (CL:THE CL:FIXNUM (CL:- COUNT))))))
            63))))
        (CL:DECLARE (CL:TYPE CL:SIMPLE-STRING SELF) (CL:TYPE CL:FIXNUM POSITION))
        (CL:SCHAR (CL:THE CL:SIMPLE-STRING SELF) (CL:THE CL:FIXNUM POSITION))))
    ...
    (CL:LET
     ((SELF |output|)
      (CH
       (CL:LET ((SELF |encodingTable|) (POSITION (CL:THE CL:FIXNUM (CL:LOGAND |triple| 63))))
        (CL:DECLARE (CL:TYPE CL:SIMPLE-STRING SELF) (CL:TYPE CL:FIXNUM POSITION))
        (CL:SCHAR (CL:THE CL:SIMPLE-STRING SELF) (CL:THE CL:FIXNUM POSITION))))
      (POSITION |outputCursor|))
     (CL:DECLARE (CL:TYPE CL:SIMPLE-STRING SELF) (CL:TYPE CL:FIXNUM POSITION))
    ...
    (CL:WHEN (CL:= |outputCursor| |eolPosition|) (CL:SETQ |eolPosition| (CL:+ |eolPosition| 78))
     ...
     (CL:LET ((SELF |output|) (CH #\Linefeed) (POSITION |outputCursor|))
      ...
      (SETF (CL:SCHAR (CL:THE CL:SIMPLE-STRING SELF) (CL:THE CL:FIXNUM POSITION)) (CL:THE CL:CHARACTER CH)))
     (CL:SETQ |outputCursor| (CL:1+ |outputCursor|))))
   (CL:ECASE (CL:THE CL:FIXNUM (CL:REM |inputLength| 3)) (0 (CL:SETQ |nofPads| 0)) (1 (CL:SETQ |nofPads| 2))
    (2 (CL:SETQ |nofPads| 1)))
   (CL:LET*
    ((|i| NULL-INTEGER) (ITER-000 1) (UPPER-BOUND-000 |nofPads|) (UNBOUNDED?-000 (CL:= UPPER-BOUND-000 NULL-INTEGER)))
    (CL:DECLARE (CL:TYPE CL:FIXNUM |i| ITER-000 UPPER-BOUND-000))
   ...
   (CL:WHEN (CL:>= |outputLength| 2)
    (CL:LET ((SELF |output|) (CH #\Return) (POSITION (CL:- |outputLength| 2)))
     (CL:DECLARE (CL:TYPE CL:SIMPLE-STRING SELF) (CL:TYPE CL:FIXNUM POSITION))
     (SETF (CL:SCHAR (CL:THE CL:SIMPLE-STRING SELF) (CL:THE CL:FIXNUM POSITION)) (CL:THE CL:CHARACTER CH)))
    (CL:LET ((SELF |output|) (CH #\Linefeed) (POSITION (CL:1- |outputLength|)))
     (CL:DECLARE (CL:TYPE CL:SIMPLE-STRING SELF) (CL:TYPE CL:FIXNUM POSITION))
     (SETF (CL:SCHAR (CL:THE CL:SIMPLE-STRING SELF) (CL:THE CL:FIXNUM POSITION)) (CL:THE CL:CHARACTER CH))))
   ...
   ((|inputLength| (CL:THE CL:FIXNUM (CL:LENGTH |input|)))
    (|outputLength|
     (CL:*
      ...
      3))
    (|output| (MAKE-RAW-MUTABLE-STRING |outputLength|)) (|decodingTable| *BASE64-DECODING-TABLE*) (|code| 0)
    (|triple| 0) (|nofPads| 0) (|inputCursor| 0) (|outputCursor| 0))
   (CL:DECLARE (CL:TYPE CL:FIXNUM |inputLength| |outputLength| |code| |triple| |nofPads| |inputCursor| |outputCursor|)
    (CL:TYPE CL:SIMPLE-STRING |output|) (CL:TYPE CL:SIMPLE-VECTOR |decodingTable|))
   (CL:LOOP
    (CL:LOOP (CL:WHEN (CL:= |inputCursor| |inputLength|) (CL:RETURN))
     (CL:SETQ |code|
    ...
    (CL:COND
     ((CL:= |nofPads| 0)
      (CL:LET
       ((SELF |output|)
        (CH
         (CL:CODE-CHAR
          (CL:THE CL:FIXNUM
           (CL:LET ((ARG |triple|) (COUNT 16)) (CL:DECLARE (CL:TYPE CL:FIXNUM ARG COUNT))
            (CL:THE CL:FIXNUM (CL:ASH ARG (CL:THE CL:FIXNUM (CL:- COUNT))))))))
        (POSITION |outputCursor|))
       (CL:DECLARE (CL:TYPE CL:SIMPLE-STRING SELF) (CL:TYPE CL:FIXNUM POSITION))
       (SETF (CL:SCHAR (CL:THE CL:SIMPLE-STRING SELF) (CL:THE CL:FIXNUM POSITION)) (CL:THE CL:CHARACTER CH)))
        ...
        (CH
         (CL:CODE-CHAR
          (CL:THE CL:FIXNUM
           (CL:LOGAND
            (CL:THE CL:FIXNUM
             (CL:LET ((ARG |triple|) (COUNT 8)) (CL:DECLARE (CL:TYPE CL:FIXNUM ARG COUNT))
              (CL:THE CL:FIXNUM (CL:ASH ARG (CL:THE CL:FIXNUM (CL:- COUNT))))))
            255))))
        (POSITION |outputCursor|))
       (CL:DECLARE (CL:TYPE CL:SIMPLE-STRING SELF) (CL:TYPE CL:FIXNUM POSITION))
      ...
      (CL:SETQ |outputCursor| (CL:1+ |outputCursor|))
      (CL:LET
       ((SELF |output|) (CH (CL:CODE-CHAR (CL:THE CL:FIXNUM (CL:LOGAND |triple| 255)))) (POSITION |outputCursor|))
       (CL:DECLARE (CL:TYPE CL:SIMPLE-STRING SELF) (CL:TYPE CL:FIXNUM POSITION))
       (SETF (CL:SCHAR (CL:THE CL:SIMPLE-STRING SELF) (CL:THE CL:FIXNUM POSITION)) (CL:THE CL:CHARACTER CH)))
      (CL:SETQ |outputCursor| (CL:1+ |outputCursor|)))
     (CL:T
...
(CL:DEFUN NEW-A ()
  (CL:LET* ((SELF NULL)) (CL:SETQ SELF (CL:MAKE-INSTANCE (CL:QUOTE A)))
   (CL:SETF (|%cdataContent| SELF) STELLA::NULL-STRING) (CL:SETF (|%textContent| SELF) STELLA::NULL-STRING)
...
(CL:DEFUN NEW-F ()
  (CL:LET* ((SELF NULL)) (CL:SETQ SELF (CL:MAKE-INSTANCE (CL:QUOTE F)))
   (CL:SETF (|%cdataContent| SELF) STELLA::NULL-STRING) (CL:SETF (|%textContent| SELF) STELLA::NULL-STRING) SELF))
         ...
         (CL:LET* ((SELF-004 (NEW-B))) (CL:SETF (|%d| SELF-004) |d|)
          (CL:LET* ((|b| SELF-004))
           (CL:LET* ((SELF-005 (NEW-A))) (CL:SETF (|%b| SELF-005) |b|) (CL:SETF (|%c| SELF-005) |c|)
            (CL:LET* ((|a| SELF-005)) (RESET-MULTIREF-TABLES) (POPULATE-NODE-PARENTS-TABLE |a|)
             (CREATE-NODE-ID-PARENT-TABLE) (SIMULATE-MULTIREF-OUTPUT |a|)))))))))))))

(CL:DEFUN HELP-STARTUP-MARSHALLER1 ()
  (CL:PROGN
   (CL:SETQ SGT-MARSHALLER-STELLA-CONS (INTERN-RIGID-SYMBOL-WRT-MODULE "CONS" (GET-STELLA-MODULE "/STELLA" CL:T) 1))
   ...
   (CL:SETQ SGT-MARSHALLER-STELLA-STRING
    (INTERN-RIGID-SYMBOL-WRT-MODULE "STRING" (GET-STELLA-MODULE "/STELLA" CL:T) 1))
   ...
   (CL:SETQ KWD-MARSHALLER-BASE64 (INTERN-RIGID-SYMBOL-WRT-MODULE "BASE64" NULL 2))
   (CL:SETQ KWD-MARSHALLER-PLAIN (INTERN-RIGID-SYMBOL-WRT-MODULE "PLAIN" NULL 2))
   ...
   (CL:SETQ SGT-MARSHALLER-XML-OBJECTS-E (INTERN-RIGID-SYMBOL-WRT-MODULE "E" NULL 1))
   (CL:SETQ SGT-MARSHALLER-XML-OBJECTS-F (INTERN-RIGID-SYMBOL-WRT-MODULE "F" NULL 1))
...
(CL:DEFUN HELP-STARTUP-MARSHALLER2 ()
  (CL:PROGN
   ...
   (CL:LET*
    ((CLASS
      (DEFINE-CLASS-FROM-STRINGIFIED-SOURCE "A" "(DEFCLASS A (XMLObject) :PUBLIC-SLOTS ((b :TYPE B) (c :TYPE C)))")))
    (CL:SETF (%CLASS-CONSTRUCTOR-CODE CLASS) (CL:FUNCTION NEW-A))
    (CL:SETF (%CLASS-SLOT-ACCESSOR-CODE CLASS) (CL:FUNCTION ACCESS-A-SLOT-VALUE)))
   (CL:LET* ((CLASS (DEFINE-CLASS-FROM-STRINGIFIED-SOURCE "B" "(DEFCLASS B (XMLObject) :PUBLIC-SLOTS ((d :TYPE D)))")))
    ...
    (CL:SETF (%CLASS-SLOT-ACCESSOR-CODE CLASS) (CL:FUNCTION ACCESS-B-SLOT-VALUE)))
   (CL:LET*
    ((CLASS
      (DEFINE-CLASS-FROM-STRINGIFIED-SOURCE "C" "(DEFCLASS C (XMLObject) :PUBLIC-SLOTS ((d :TYPE D) (e :TYPE E)))")))
    (CL:SETF (%CLASS-CONSTRUCTOR-CODE CLASS) (CL:FUNCTION NEW-C))
    (CL:SETF (%CLASS-SLOT-ACCESSOR-CODE CLASS) (CL:FUNCTION ACCESS-C-SLOT-VALUE)))
   (CL:LET* ((CLASS (DEFINE-CLASS-FROM-STRINGIFIED-SOURCE "D" "(DEFCLASS D (XMLObject) :PUBLIC-SLOTS ((f :TYPE F)))")))
    ...
    (CL:SETF (%CLASS-SLOT-ACCESSOR-CODE CLASS) (CL:FUNCTION ACCESS-D-SLOT-VALUE)))
   (CL:LET* ((CLASS (DEFINE-CLASS-FROM-STRINGIFIED-SOURCE "E" "(DEFCLASS E (XMLObject) :PUBLIC-SLOTS ((f :TYPE F)))")))
    ...
    (CL:SETF (%CLASS-SLOT-ACCESSOR-CODE CLASS) (CL:FUNCTION ACCESS-E-SLOT-VALUE)))
   (CL:LET* ((CLASS (DEFINE-CLASS-FROM-STRINGIFIED-SOURCE "F" "(DEFCLASS F (XMLObject))")))
...
(CL:DEFUN HELP-STARTUP-MARSHALLER3 ()
  (CL:PROGN
   (DEFINE-FUNCTION-OBJECT "SLOT-VALUE-IS-NULL?"
    "(DEFUN (SLOT-VALUE-IS-NULL? BOOLEAN) ((parentObject XMLObject) (slot SLOT)))" (CL:FUNCTION SLOT-VALUE-IS-NULL?)
    NULL)
   ...
   (DEFINE-METHOD-OBJECT "(DEFMETHOD (TO-XML CONS) ((object XMLObject) (namespaceStack (CONS OF STRING-WRAPPER))))"
    (CL:FUNCTION TO-XML) NULL)
   (DEFINE-FUNCTION-OBJECT "GET-NAMESPACE-PREFIX" "(DEFUN (GET-NAMESPACE-PREFIX STRING) ((object XMLObject)))"
    (CL:FUNCTION GET-NAMESPACE-PREFIX) NULL)
   (DEFINE-FUNCTION-OBJECT "GET-NAMESPACE-URI" "(DEFUN (GET-NAMESPACE-URI STRING-WRAPPER) ((namespacePrefix STRING)))"
    (CL:FUNCTION GET-NAMESPACE-URI) NULL)
   (DEFINE-FUNCTION-OBJECT "MAKE-CONTENT-EXPRESSION" "(DEFUN (MAKE-CONTENT-EXPRESSION CONS) ((object XMLObject)))"
    (CL:FUNCTION MAKE-CONTENT-EXPRESSION) NULL)
   (DEFINE-FUNCTION-OBJECT "MAKE-ELEMENT-TAG" "(DEFUN (MAKE-ELEMENT-TAG XML-ELEMENT) ((object XMLObject)))"
    (CL:FUNCTION MAKE-ELEMENT-TAG) NULL)
   (DEFINE-FUNCTION-OBJECT "MAKE-NAMESPACE-ATTRIBUTE"
    "(DEFUN (MAKE-NAMESPACE-ATTRIBUTE XML-ATTRIBUTE) ((namespaceName STRING)))" (CL:FUNCTION MAKE-NAMESPACE-ATTRIBUTE)
    NULL)
   ...
   (DEFINE-FUNCTION-OBJECT "GET-VALUE-NAMESPACE-PREFIX"
    "(DEFUN (GET-VALUE-NAMESPACE-PREFIX STRING) ((valueString STRING)))" (CL:FUNCTION GET-VALUE-NAMESPACE-PREFIX) NULL)
   ...
   (DEFINE-FUNCTION-OBJECT "SET-ELEMENTS" "(DEFUN SET-ELEMENTS ((object XMLObject) (elementExprs CONS)))"
    (CL:FUNCTION SET-ELEMENTS) NULL)
   (DEFINE-FUNCTION-OBJECT "SET-ATTRIBUTES" "(DEFUN SET-ATTRIBUTES ((object XMLObject) (attributeExprs CONS)))"
    (CL:FUNCTION SET-ATTRIBUTES) NULL)
   (DEFINE-FUNCTION-OBJECT "SET-COLLECTIONS" "(DEFUN SET-COLLECTIONS ((object XMLObject) (elementExprs CONS)))"
    (CL:FUNCTION SET-COLLECTIONS) NULL)
   (DEFINE-FUNCTION-OBJECT "GET-MAPPED-SLOTS" "(DEFUN (GET-MAPPED-SLOTS (LIST OF SLOT)) ((object XMLObject)))"
   ...
   (DEFINE-FUNCTION-OBJECT "LOOKUP-CONTENT-SLOT" "(DEFUN (LOOKUP-CONTENT-SLOT STORAGE-SLOT) ((object XMLObject)))"
    (CL:FUNCTION LOOKUP-CONTENT-SLOT) NULL)
   (DEFINE-FUNCTION-OBJECT "RESET-MULTIREF-TABLES" "(DEFUN RESET-MULTIREF-TABLES ())"
   ...
   (DEFINE-FUNCTION-OBJECT "GET-CHILDREN" "(DEFUN (GET-CHILDREN (CONS OF XMLObject)) ((node XMLObject)))"
    (CL:FUNCTION GET-CHILDREN) NULL)
   (DEFINE-FUNCTION-OBJECT "POPULATE-NODE-PARENTS-TABLE" "(DEFUN POPULATE-NODE-PARENTS-TABLE ((node XMLObject)))"
   ...
   (DEFINE-FUNCTION-OBJECT "CREATE-NODE-ID-PARENT-TABLE" "(DEFUN CREATE-NODE-ID-PARENT-TABLE ())"
    (CL:FUNCTION CREATE-NODE-ID-PARENT-TABLE) NULL)
   (DEFINE-FUNCTION-OBJECT "SIMULATE-MULTIREF-OUTPUT" "(DEFUN SIMULATE-MULTIREF-OUTPUT ((node XMLObject)))"
   ...
   (DEFINE-FUNCTION-OBJECT "GET-NODE-ID" "(DEFUN (GET-NODE-ID INTEGER) ((node XMLObject)))" (CL:FUNCTION GET-NODE-ID)
    NULL)
   ...
   (DEFINE-FUNCTION-OBJECT "SLOT-BASE-AND-PARAMETER-TYPE"
    "(DEFUN (SLOT-BASE-AND-PARAMETER-TYPE TYPE TYPE-SPEC) ((slot SLOT)))" (CL:FUNCTION SLOT-BASE-AND-PARAMETER-TYPE)
    NULL)
   ...
   (DEFINE-FUNCTION-OBJECT "PARSE-XML" "(DEFUN (PARSE-XML CONS) ((string STRING) (skipFrontmatter? BOOLEAN)))"
   ...
   (DEFINE-FUNCTION-OBJECT "GET-ELEMENT-NAME-FROM-EXPR"
    "(DEFUN (GET-ELEMENT-NAME-FROM-EXPR STRING-WRAPPER) ((expression CONS)))" (CL:FUNCTION GET-ELEMENT-NAME-FROM-EXPR)
    NULL)
   ...
   (DEFINE-FUNCTION-OBJECT "GET-ELEMENT-NAME-FROM-OBJECT"
    "(DEFUN (GET-ELEMENT-NAME-FROM-OBJECT STRING) ((object XMLObject)))" (CL:FUNCTION GET-ELEMENT-NAME-FROM-OBJECT)
    NULL)
   (DEFINE-FUNCTION-OBJECT "STRINGIFY-XML" "(DEFUN (STRINGIFY-XML STRING) ((expression CONS)))"
   ...
   (DEFINE-FUNCTION-OBJECT "ATTRIBUTE-SLOT?" "(DEFUN (ATTRIBUTE-SLOT? BOOLEAN) ((slot SLOT)))"
    (CL:FUNCTION ATTRIBUTE-SLOT?) NULL)
   (DEFINE-FUNCTION-OBJECT "ELEMENT-SLOT?" "(DEFUN (ELEMENT-SLOT? BOOLEAN) ((slot SLOT)))" (CL:FUNCTION ELEMENT-SLOT?)
    NULL)
   (DEFINE-FUNCTION-OBJECT "COLLECTION-SLOT?" "(DEFUN (COLLECTION-SLOT? BOOLEAN) ((slot SLOT)))"
   ...
   (DEFINE-FUNCTION-OBJECT "DECODE-SLOT-VALUE"
    "(DEFUN (DECODE-SLOT-VALUE OBJECT) ((slot STORAGE-SLOT) (value OBJECT)))" (CL:FUNCTION DECODE-SLOT-VALUE) NULL)
   (DEFINE-FUNCTION-OBJECT "ENCODE-SLOT-VALUE"
    "(DEFUN (ENCODE-SLOT-VALUE OBJECT) ((slot STORAGE-SLOT) (value OBJECT)))" (CL:FUNCTION ENCODE-SLOT-VALUE) NULL)
...
(CL:DEFUN STARTUP-MARSHALLER ()
  (CL:LET* ((*MODULE* (GET-STELLA-MODULE "/STELLA/XML-OBJECTS" (> *STARTUP-TIME-PHASE* 1))) (*CONTEXT* *MODULE*))
   (CL:DECLARE (CL:SPECIAL *MODULE* *CONTEXT*)) (CL:WHEN (CURRENT-STARTUP-TIME-PHASE? 2) (HELP-STARTUP-MARSHALLER1))
   (CL:WHEN (CURRENT-STARTUP-TIME-PHASE? 4) (CL:SETQ *NODE-PARENTS-TABLE* (NEW-PROPERTY-LIST))
    (CL:SETQ *NODE-ID-PARENTS-TABLE* (NEW-HASH-TABLE))
   ...
   (CL:WHEN (CURRENT-STARTUP-TIME-PHASE? 7) (HELP-STARTUP-MARSHALLER3)
    ...
    (DEFINE-FUNCTION-OBJECT "STARTUP-MARSHALLER" "(DEFUN STARTUP-MARSHALLER () :PUBLIC? TRUE)"
     (CL:FUNCTION STARTUP-MARSHALLER) NULL)
    (CL:LET* ((FUNCTION (LOOKUP-FUNCTION SYM-MARSHALLER-XML-OBJECTS-STARTUP-MARSHALLER)))
     (SET-DYNAMIC-SLOT-VALUE (%DYNAMIC-SLOTS FUNCTION) SYM-MARSHALLER-STELLA-METHOD-STARTUP-CLASSNAME
