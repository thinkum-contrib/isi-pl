...
(CL:DEFUN STARTUP-WEBTOOLS-SYSTEM ()
  (WITH-PROCESS-LOCK *BOOTSTRAP-LOCK*
   ...
   (CL:LET* ((*MODULE* (GET-STELLA-MODULE "/HTTP/WEBTOOLS" (> *STARTUP-TIME-PHASE* 1))) (*CONTEXT* *MODULE*))
    (CL:DECLARE (CL:SPECIAL *MODULE* *CONTEXT*))
    (CL:WHEN (CURRENT-STARTUP-TIME-PHASE? 2)
     (CL:SETQ SYM-STARTUP-SYSTEM-WEBTOOLS-STARTUP-WEBTOOLS-SYSTEM
      (INTERN-RIGID-SYMBOL-WRT-MODULE "STARTUP-WEBTOOLS-SYSTEM" NULL 0))
    ...
    (CL:WHEN (CURRENT-STARTUP-TIME-PHASE? 7)
     (DEFINE-FUNCTION-OBJECT "STARTUP-WEBTOOLS-SYSTEM" "(DEFUN STARTUP-WEBTOOLS-SYSTEM () :PUBLIC? TRUE)"
    ...
    (CL:WHEN (CURRENT-STARTUP-TIME-PHASE? 9) (%IN-MODULE (COPY-CONS-TREE (WRAP-STRING "/HTTP/WEBTOOLS")))
     (CL:LET* ((PHASE NULL-INTEGER) (ITER-006 0) (UPPER-BOUND-007 9))
      ...
      (CL:LOOP WHILE (CL:<= ITER-006 UPPER-BOUND-007) DO (CL:SETQ PHASE ITER-006) (CL:SETQ *STARTUP-TIME-PHASE* PHASE)
       (STARTUP-HTTP-CLIENT) (STARTUP-HTTP-SERVER) (STARTUP-SESSIONS) (STARTUP-XML-OBJECT) (STARTUP-XML-SCHEMA)
       (STARTUP-XML-SCHEMA-INSTANCE) (STARTUP-APACHE-SOAP) (STARTUP-SOAP-ENV) (STARTUP-MARSHALLER) (STARTUP-SOAP)
