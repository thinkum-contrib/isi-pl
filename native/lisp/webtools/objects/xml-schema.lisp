...
(CL:DEFUN STARTUP-XML-SCHEMA ()
  (CL:LET*
   ...
   (CL:WHEN (CURRENT-STARTUP-TIME-PHASE? 2)
    (CL:SETQ SYM-XML-SCHEMA-XSD-STARTUP-XML-SCHEMA
     (INTERN-RIGID-SYMBOL-WRT-MODULE "STARTUP-XML-SCHEMA" NULL 0))
    (CL:SETQ SYM-XML-SCHEMA-STELLA-METHOD-STARTUP-CLASSNAME
     (INTERN-RIGID-SYMBOL-WRT-MODULE "METHOD-STARTUP-CLASSNAME"
      (GET-STELLA-MODULE "/STELLA" CL:T) 0)))
   (CL:WHEN (CURRENT-STARTUP-TIME-PHASE? 6) (FINALIZE-CLASSES))
   (CL:WHEN (CURRENT-STARTUP-TIME-PHASE? 7)
    (DEFINE-FUNCTION-OBJECT "STARTUP-XML-SCHEMA"
   ...
   (CL:WHEN (CURRENT-STARTUP-TIME-PHASE? 9)
    (%IN-MODULE (COPY-CONS-TREE (WRAP-STRING "XSD")))
