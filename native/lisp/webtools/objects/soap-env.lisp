...
(CL:DEFCLASS |Envelope| (|XMLObject|)
  ((|encodingStyle| :TYPE CL:SIMPLE-STRING :INITFORM STELLA::NULL-STRING :ALLOCATION :INSTANCE :ACCESSOR |%encodingStyle|)
   (|body| :ALLOCATION :INSTANCE :ACCESSOR |%body|)))

(CL:DEFUN |new-Envelope| ()
  (CL:LET* ((SELF NULL)) (CL:SETQ SELF (CL:MAKE-INSTANCE (CL:QUOTE |Envelope|))) (CL:SETF (|%cdataContent| SELF) STELLA::NULL-STRING)
   (CL:SETF (|%textContent| SELF) STELLA::NULL-STRING) (CL:SETF (|%body| SELF) NULL) (CL:SETF (|%encodingStyle| SELF) "http://schemas.xmlsoap.org/soap/encoding/") SELF))
...
(CL:DEFUN |access-Envelope-Slot-Value| (SELF SLOTNAME VALUE SETVALUE?)
  (CL:COND
   ((CL:EQ SLOTNAME |SYM-SOAP-ENV-SOAP-ENV-encodingStyle|)
    (CL:IF SETVALUE? (CL:SETF (|%encodingStyle| SELF) (%WRAPPER-VALUE VALUE)) (CL:SETQ VALUE (WRAP-STRING (|%encodingStyle| SELF)))))
   ((CL:EQ SLOTNAME |SYM-SOAP-ENV-XML-OBJECTS-body|) (CL:IF SETVALUE? (CL:SETF (|%body| SELF) VALUE) (CL:SETQ VALUE (|%body| SELF))))
   (CL:T
...
(CL:DEFUN |new-Body| ()
  (CL:LET* ((SELF NULL)) (CL:SETQ SELF (CL:MAKE-INSTANCE (CL:QUOTE |Body|))) (CL:SETF (|%cdataContent| SELF) STELLA::NULL-STRING)
   (CL:SETF (|%textContent| SELF) STELLA::NULL-STRING) (CL:SETF (|%contents| SELF) NULL) SELF))
...
(CL:DEFUN |access-Body-Slot-Value| (SELF SLOTNAME VALUE SETVALUE?)
  (CL:COND ((CL:EQ SLOTNAME |SYM-SOAP-ENV-SOAP-ENV-contents|) (CL:IF SETVALUE? (CL:SETF (|%contents| SELF) VALUE) (CL:SETQ VALUE (|%contents| SELF))))
   (CL:T
    (CL:LET* ((STREAM-000 (NEW-OUTPUT-STRING-STREAM))) (%%PRINT-STREAM (%NATIVE-STREAM STREAM-000) "`" SLOTNAME "' is not a valid case option")
     (CL:ERROR (NEW-STELLA-EXCEPTION (THE-STRING-READER STREAM-000))))))
  VALUE)
...
(CL:DEFCLASS |Fault| (|XMLObject|)
  ((|faultcode| :ALLOCATION :INSTANCE :ACCESSOR |%faultcode|) (|faultstring| :ALLOCATION :INSTANCE :ACCESSOR |%faultstring|)
   (|faultactor| :ALLOCATION :INSTANCE :ACCESSOR |%faultactor|) (|detail| :ALLOCATION :INSTANCE :ACCESSOR |%detail|)))

(CL:DEFUN |new-Fault| ()
  (CL:LET* ((SELF NULL)) (CL:SETQ SELF (CL:MAKE-INSTANCE (CL:QUOTE |Fault|))) (CL:SETF (|%cdataContent| SELF) STELLA::NULL-STRING)
   (CL:SETF (|%textContent| SELF) STELLA::NULL-STRING) (CL:SETF (|%detail| SELF) NULL) (CL:SETF (|%faultactor| SELF) NULL) (CL:SETF (|%faultstring| SELF) NULL)
...
(CL:DEFUN |access-Fault-Slot-Value| (SELF SLOTNAME VALUE SETVALUE?)
  (CL:COND ((CL:EQ SLOTNAME |SYM-SOAP-ENV-SOAP-ENV-faultcode|) (CL:IF SETVALUE? (CL:SETF (|%faultcode| SELF) VALUE) (CL:SETQ VALUE (|%faultcode| SELF))))
   ((CL:EQ SLOTNAME |SYM-SOAP-ENV-SOAP-ENV-faultstring|) (CL:IF SETVALUE? (CL:SETF (|%faultstring| SELF) VALUE) (CL:SETQ VALUE (|%faultstring| SELF))))
   ((CL:EQ SLOTNAME |SYM-SOAP-ENV-SOAP-ENV-faultactor|) (CL:IF SETVALUE? (CL:SETF (|%faultactor| SELF) VALUE) (CL:SETQ VALUE (|%faultactor| SELF))))
   ((CL:EQ SLOTNAME |SYM-SOAP-ENV-SOAP-ENV-detail|) (CL:IF SETVALUE? (CL:SETF (|%detail| SELF) VALUE) (CL:SETQ VALUE (|%detail| SELF))))
   (CL:T
    (CL:LET* ((STREAM-000 (NEW-OUTPUT-STRING-STREAM))) (%%PRINT-STREAM (%NATIVE-STREAM STREAM-000) "`" SLOTNAME "' is not a valid case option")
     (CL:ERROR (NEW-STELLA-EXCEPTION (THE-STRING-READER STREAM-000))))))
  VALUE)
...
(CL:DEFUN |new-FaultCode| ()
  (CL:LET* ((SELF NULL)) (CL:SETQ SELF (CL:MAKE-INSTANCE (CL:QUOTE |FaultCode|))) (CL:SETF (|%cdataContent| SELF) STELLA::NULL-STRING)
...
(CL:DEFUN |new-FaultString| ()
  (CL:LET* ((SELF NULL)) (CL:SETQ SELF (CL:MAKE-INSTANCE (CL:QUOTE |FaultString|))) (CL:SETF (|%cdataContent| SELF) STELLA::NULL-STRING)
   (CL:SETF (|%textContent| SELF) STELLA::NULL-STRING) SELF))
...
(CL:DEFUN |new-FaultActor| ()
  (CL:LET* ((SELF NULL)) (CL:SETQ SELF (CL:MAKE-INSTANCE (CL:QUOTE |FaultActor|))) (CL:SETF (|%cdataContent| SELF) STELLA::NULL-STRING)
   (CL:SETF (|%textContent| SELF) STELLA::NULL-STRING) SELF))
...
(CL:DEFUN |new-Detail| ()
  (CL:LET* ((SELF NULL)) (CL:SETQ SELF (CL:MAKE-INSTANCE (CL:QUOTE |Detail|))) (CL:SETF (|%cdataContent| SELF) STELLA::NULL-STRING)
   (CL:SETF (|%textContent| SELF) STELLA::NULL-STRING) (CL:SETF (|%contents| SELF) NULL) SELF))
  ...
  (CL:LET* ((*MODULE* (GET-STELLA-MODULE "/STELLA/XML-OBJECTS/SOAP-ENV" (> *STARTUP-TIME-PHASE* 1))) (*CONTEXT* *MODULE*)) (CL:DECLARE (CL:SPECIAL *MODULE* *CONTEXT*))
   ...
   (CL:WHEN (CURRENT-STARTUP-TIME-PHASE? 5)
    (CL:LET*
     ...
     (CL:SETF (%CLASS-CONSTRUCTOR-CODE CLASS) (CL:FUNCTION |new-Envelope|)) (CL:SETF (%CLASS-SLOT-ACCESSOR-CODE CLASS) (CL:FUNCTION |access-Envelope-Slot-Value|)))
    (CL:LET* ((CLASS (DEFINE-CLASS-FROM-STRINGIFIED-SOURCE "Body" "(DEFCLASS Body (XMLObject) :PUBLIC-SLOTS ((contents :TYPE XMLObject)))")))
     (CL:SETF (%CLASS-CONSTRUCTOR-CODE CLASS) (CL:FUNCTION |new-Body|)) (CL:SETF (%CLASS-SLOT-ACCESSOR-CODE CLASS) (CL:FUNCTION |access-Body-Slot-Value|)))
    (CL:LET*
     ((CLASS
     ...
     (CL:SETF (%CLASS-CONSTRUCTOR-CODE CLASS) (CL:FUNCTION |new-Fault|)) (CL:SETF (%CLASS-SLOT-ACCESSOR-CODE CLASS) (CL:FUNCTION |access-Fault-Slot-Value|)))
    ...
    (CL:LET* ((CLASS (DEFINE-CLASS-FROM-STRINGIFIED-SOURCE "FaultString" "(DEFCLASS FaultString (XMLObject))")))
     (CL:SETF (%CLASS-CONSTRUCTOR-CODE CLASS) (CL:FUNCTION |new-FaultString|)))
    ...
    (CL:LET* ((CLASS (DEFINE-CLASS-FROM-STRINGIFIED-SOURCE "Detail" "(DEFCLASS Detail (XMLObject) :PUBLIC-SLOTS ((contents :TYPE XMLObject)))")))
     (CL:SETF (%CLASS-CONSTRUCTOR-CODE CLASS) (CL:FUNCTION |new-Detail|)) (CL:SETF (%CLASS-SLOT-ACCESSOR-CODE CLASS) (CL:FUNCTION |access-Detail-Slot-Value|))))
   ...
   (CL:WHEN (CURRENT-STARTUP-TIME-PHASE? 7)
    ...
    (CL:LET* ((FUNCTION (LOOKUP-FUNCTION SYM-SOAP-ENV-SOAP-ENV-STARTUP-SOAP-ENV)))
     (SET-DYNAMIC-SLOT-VALUE (%DYNAMIC-SLOTS FUNCTION) SYM-SOAP-ENV-STELLA-METHOD-STARTUP-CLASSNAME (WRAP-STRING "_StartupSoapEnv") NULL-STRING-WRAPPER)))
