...
(CL:DEFUN STARTUP-ASERVE-INIT ()
  (CL:LET* ((*MODULE* *STELLA-MODULE*) (*CONTEXT* *MODULE*)) (CL:DECLARE (CL:SPECIAL *MODULE* *CONTEXT*))
   (CL:WHEN (CURRENT-STARTUP-TIME-PHASE? 2)
    (CL:SETQ SYM-ASERVE-INIT-STELLA-STARTUP-ASERVE-INIT (INTERN-RIGID-SYMBOL-WRT-MODULE "STARTUP-ASERVE-INIT" NULL 0))
    (CL:SETQ SYM-ASERVE-INIT-STELLA-METHOD-STARTUP-CLASSNAME
     (INTERN-RIGID-SYMBOL-WRT-MODULE "METHOD-STARTUP-CLASSNAME" NULL 0)))
   (CL:WHEN (CURRENT-STARTUP-TIME-PHASE? 6) (FINALIZE-CLASSES))
   (CL:WHEN (CURRENT-STARTUP-TIME-PHASE? 7)
    (DEFINE-FUNCTION-OBJECT "STARTUP-ASERVE-INIT" "(DEFUN STARTUP-ASERVE-INIT () :PUBLIC? TRUE)"
     (CL:FUNCTION STARTUP-ASERVE-INIT) NULL)
    (CL:LET* ((FUNCTION (LOOKUP-FUNCTION SYM-ASERVE-INIT-STELLA-STARTUP-ASERVE-INIT)))
     (SET-DYNAMIC-SLOT-VALUE (%DYNAMIC-SLOTS FUNCTION) SYM-ASERVE-INIT-STELLA-METHOD-STARTUP-CLASSNAME
