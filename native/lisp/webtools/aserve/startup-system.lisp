...
(CL:DEFUN STARTUP-WEBTOOLS-ASERVE-SYSTEM ()
  (WITH-PROCESS-LOCK *BOOTSTRAP-LOCK*
   ...
   (CL:WHEN (CURRENT-STARTUP-TIME-PHASE? 1)
    (DEFINE-MODULE-FROM-STRINGIFIED-SOURCE "/HTTP/ASERVE" "(:LISP-PACKAGE \"STELLA\" :CODE-ONLY? TRUE)"))
   (CL:LET* ((*MODULE* (GET-STELLA-MODULE "/HTTP/ASERVE" (> *STARTUP-TIME-PHASE* 1))) (*CONTEXT* *MODULE*))
    (CL:DECLARE (CL:SPECIAL *MODULE* *CONTEXT*))
    (CL:WHEN (CURRENT-STARTUP-TIME-PHASE? 2)
     (CL:SETQ SYM-STARTUP-SYSTEM-ASERVE-STARTUP-WEBTOOLS-ASERVE-SYSTEM
      (INTERN-RIGID-SYMBOL-WRT-MODULE "STARTUP-WEBTOOLS-ASERVE-SYSTEM" NULL 0))
    ...
    (CL:WHEN (CURRENT-STARTUP-TIME-PHASE? 7)
     (DEFINE-FUNCTION-OBJECT "STARTUP-WEBTOOLS-ASERVE-SYSTEM" "(DEFUN STARTUP-WEBTOOLS-ASERVE-SYSTEM () :PUBLIC? TRUE)"
    ...
    (CL:WHEN (CURRENT-STARTUP-TIME-PHASE? 9) (%IN-MODULE (COPY-CONS-TREE (WRAP-STRING "/HTTP/ASERVE")))
     (CL:LET* ((PHASE NULL-INTEGER) (ITER-002 0) (UPPER-BOUND-003 9))
      ...
      (CL:LOOP WHILE (CL:<= ITER-002 UPPER-BOUND-003) DO (CL:SETQ PHASE ITER-002) (CL:SETQ *STARTUP-TIME-PHASE* PHASE)
       (STARTUP-ASERVE-INIT) (STARTUP-HTTP-SERVER-IMPL) (CL:SETQ ITER-002 (CL:1+ ITER-002))))
