...
(CL:DECLAIM
 (CL:SPECIAL *STARTUP-TIME-PHASE* *MODULE* NULL-CHARACTER EOL STANDARD-OUTPUT
  *CHARACTER-TYPE-TABLE* NULL-INTEGER NIL TRUE-WRAPPER FALSE-WRAPPER))
...
(CL:DEFCLASS CONNECTION (STANDARD-OBJECT)
  ((NATIVE-CONNECTION :ALLOCATION :INSTANCE :ACCESSOR %NATIVE-CONNECTION)
   (CONNECTION-STRING :TYPE CL:SIMPLE-STRING :INITFORM STELLA::NULL-STRING
    :ALLOCATION :INSTANCE :ACCESSOR %CONNECTION-STRING)
   (PROTOCOL :TYPE CL:SIMPLE-STRING :INITFORM STELLA::NULL-STRING :ALLOCATION
    :INSTANCE :ACCESSOR %PROTOCOL)
   (DBMS-NAME :DOCUMENTATION
    "Indicates to what kind of DBMS we are connected." :ALLOCATION :INSTANCE
    :ACCESSOR %DBMS-NAME)
   (STATEMENT :DOCUMENTATION
    "Prepared statement associated with this connection." :ALLOCATION
    :INSTANCE :ACCESSOR %STATEMENT)
   (AUTO-COMMIT? :DOCUMENTATION "State of connection's auto-commit feature."
    :ALLOCATION :INSTANCE :ACCESSOR %AUTO-COMMIT?)
   (CREATION-TIME :DOCUMENTATION "Time at which connection was created."
    :ALLOCATION :INSTANCE :ACCESSOR %CREATION-TIME)
...
(CL:DEFUN NEW-CONNECTION ()
  (CL:LET* ((SELF NULL))
   ...
   (CL:SETF (%RENEWAL-TIME SELF) NULL) (CL:SETF (%LAST-ACCESS-TIME SELF) NULL)
   (CL:SETF (%CREATION-TIME SELF) NULL) (CL:SETF (%AUTO-COMMIT? SELF) CL:T)
   (CL:SETF (%STATEMENT SELF) NULL) (CL:SETF (%DBMS-NAME SELF) NULL)
...
(CL:DEFUN ACCESS-CONNECTION-SLOT-VALUE (SELF SLOTNAME VALUE SETVALUE?)
  (CL:COND
   ...
   ((CL:EQ SLOTNAME SYM-SDBC-SDBC-AUTO-COMMIT?)
    (CL:IF SETVALUE?
     (CL:SETF (%AUTO-COMMIT? SELF) (COERCE-WRAPPED-BOOLEAN-TO-BOOLEAN VALUE))
...
(CL:DEFCLASS PREPARED-STATEMENT (STANDARD-OBJECT)
  ((CONNECTION :ALLOCATION :INSTANCE :ACCESSOR %CONNECTION)
   ...
   (SQL :TYPE CL:SIMPLE-STRING :INITFORM STELLA::NULL-STRING :ALLOCATION
    :INSTANCE :ACCESSOR %SQL)
...
(CL:DEFUN NEW-PREPARED-STATEMENT ()
  (CL:LET* ((SELF NULL))
   ...
   (CL:SETF (%SQL SELF) STELLA::NULL-STRING) (CL:SETF (%STATEMENT SELF) NULL)
   (CL:SETF (%CONNECTION SELF) NULL) SELF))
   ...
   (CL:LET* ((TEMP-000 (LOOKUP OPTIONS KWD-SDBC-PROTOCOL)))
    (CL:LET*
     ((PROTOCOL
      ...
      (SERVER-TYPE (UNWRAP-STRING (LOOKUP OPTIONS KWD-SDBC-SERVER-TYPE)))
    ...
    (CL:SETQ NEWCON
     (%CONNECT
      (CONS-LIST KWD-SDBC-PROTOCOL (WRAP-STRING (%PROTOCOL CON))
       KWD-SDBC-CONNECTION-STRING (WRAP-STRING (%CONNECTION-STRING CON)))))
    (%DISCONNECT CON)
...
(CL:DECLAIM
 (CL:FTYPE (CL:FUNCTION (CL:T) CL:SIMPLE-STRING) MAKE-JDBC-CONNECTION-STRING))
(CL:DEFUN MAKE-JDBC-CONNECTION-STRING (OPTIONS)
  ...
  (CL:LET* ((CON (NEW-OUTPUT-STRING-STREAM)) (VALUE STELLA::NULL-STRING))
      ...
      (CL:LET* ((TEST-VALUE-000 (SAFE-PRIMARY-TYPE PORT)))
       (CL:COND
        ((SUBTYPE-OF-STRING? TEST-VALUE-000)
         (CL:PROGN
          (%%PRINT-STREAM (%NATIVE-STREAM CON) ":" (UNWRAP-STRING PORT))))
        ((SUBTYPE-OF-INTEGER? TEST-VALUE-000)
         (CL:PROGN
          (%%PRINT-STREAM (%NATIVE-STREAM CON) ":" (UNWRAP-INTEGER PORT))))
        (CL:T))))
         ...
         (CL:WHEN (CL:NOT (CL:EQ VAL NULL))
          (CL:COND
           ((CL:OR (CL:EQ OPTION KWD-SDBC-SERVER-TYPE)
             ...
             (CL:EQ OPTION KWD-SDBC-PORT) (CL:EQ OPTION KWD-SDBC-DB-NAME)
...
(CL:DECLAIM
 (CL:FTYPE (CL:FUNCTION (CL:T) CL:SIMPLE-STRING) MAKE-ODBC-CONNECTION-STRING))
...
(CL:DEFUN CL-NATIVE-CLSQL-CONNECT (OPTIONS SERVER-TYPE)
  ...
  (CL:LET*
   ...
   (CL:DECLARE
    (CL:TYPE CL:SIMPLE-STRING CONNECTION-STRING USER PASSWORD DB-NAME HOST
     ERROR-MESSAGE))
   #+:CLSQL
       (cl:handler-case
...
values."
  ...
  (CL:LET* ((START 0) (END 0) (OPERATOR ""))
   ...
   (CL:OR (STRING-EQUAL? OPERATOR "SELECT") (STRING-EQUAL? OPERATOR "SHOW")
    (STRING-EQUAL? OPERATOR "DESCRIBE") (STRING-EQUAL? OPERATOR "EXPLAIN")
...
(CL:DEFUN CL-TRANSLATE-SQL-PARAMETER-TYPE-SPECIFIER (STELLATYPE)
  (CL:LET* ((RESULT NULL))
   (CL:COND
    ((CL:OR (CL:EQ STELLATYPE NULL) (CL:EQ STELLATYPE SYM-SDBC-STELLA-NULL))
   ...
   (CL:LET* ((TYPE NULL) (ITER-000 STELLATYPES) (COLLECT-000 NULL))
    (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-000 NIL)) DO
     ...
     (CL:IF (CL:EQ COLLECT-000 NULL)
      (CL:PROGN
       (CL:SETQ COLLECT-000 (CONS (CL-TRANSLATE-SQL-TYPE-SPECIFIER TYPE) NIL))
...
(CL:DEFUN PRINT-VALUE-LIST (STREAM VALUES QUOTECHAR)
  (CL:LET* ((VALUE NULL) (ITER-000 VALUES) (I NULL-INTEGER) (ITER-001 1))
        ...
        ((SUBTYPE-OF-STRING? TEST-VALUE-000)
         (CL:PROGN
          (%%PRINT-STREAM (%NATIVE-STREAM STREAM) QUOTECHAR
           (SQL-ESCAPE-STRING (%WRAPPER-VALUE VALUE) QUOTECHAR) QUOTECHAR)))
        (CL:T
         (%%PRINT-STREAM (%NATIVE-STREAM STREAM) QUOTECHAR
          (SQL-ESCAPE-STRING (STRINGIFY VALUE) QUOTECHAR) QUOTECHAR))))))
...
insert which is significantly faster than inserting rows one by one."
  ...
  (CL:LET*
   ((SQL NULL)
    (IDQUOTE
     (SQL-QUOTE-CHARACTER (GET-DBMS-NAME CONNECTION) KWD-SDBC-IDENTIFIER))
    (VALUEQUOTE
   ...
   (CL:LOOP (CL:SETQ SQL (NEW-OUTPUT-STRING-STREAM))
    ...
    (CL:WHEN
     (CL:AND (CL:NOT (CL:EQ COLUMNS NULL)) (CL:NOT (CL:EQ COLUMNS NIL)))
     ...
     ((CL:AND (CL:EQ (GET-DBMS-NAME CONNECTION) KWD-SDBC-ORACLE)
      ...
      (CL:LET*
       ...
       (CL:LOOP WHILE
        ...
        (CL:SETQ ROWS (%%REST ROWS)) (CL:SETQ ITER-000 (%%REST ITER-000))
     ...
     (CL:T (%%PRINT-STREAM (%NATIVE-STREAM SQL) " VALUES")
      (CL:LET*
       ...
       (CL:LOOP WHILE
        ...
        (%%PRINT-STREAM (%NATIVE-STREAM SQL) "(")
        (PRINT-VALUE-LIST SQL VALUES VALUEQUOTE)
        (%%PRINT-STREAM (%NATIVE-STREAM SQL) ")") (CL:SETQ ROWS (%%REST ROWS))
     ...
     (CL:IF (CL:EQ COLLECT-000 NULL)
      (CL:PROGN
       (CL:SETQ COLLECT-000
        (CONS
         (CL:IF (STRING? VALUE)
          (CONVERT-STRING-TO-TYPED-OBJECT (%WRAPPER-VALUE VALUE) TYPE) VALUE)
         NIL))
       (CL:IF (CL:EQ RESULT NIL) (CL:SETQ RESULT COLLECT-000)
        (ADD-CONS-TO-END-OF-CONS-LIST RESULT COLLECT-000)))
      (CL:PROGN
...
`value' for proper translation and coercion."
  ...
  (CL:LET* ((CONNECTION (%CONNECTION STATEMENT)) (NCON NULL))
   ...
   (CL:WHEN (CL:EQ TYPESPEC SGT-SDBC-STELLA-CALENDAR-DATE)
    ...
    (CL:WHEN (CL:NOT (CL:EQ VALUE NULL))
     (CL:SETQ VALUE (WRAP-STRING (CALENDAR-DATE-TO-SQL-STRING VALUE)))))
...
(CL:DEFCLASS TABLE-INFO (STANDARD-OBJECT)
  ((DATABASE :TYPE CL:SIMPLE-STRING :INITFORM STELLA::NULL-STRING :ALLOCATION
    :INSTANCE :ACCESSOR %DATABASE)
   (SCHEMA :TYPE CL:SIMPLE-STRING :INITFORM STELLA::NULL-STRING :ALLOCATION
    :INSTANCE :ACCESSOR %SCHEMA)
   ...
   (REMARKS :TYPE CL:SIMPLE-STRING :INITFORM STELLA::NULL-STRING :ALLOCATION
    :INSTANCE :ACCESSOR %REMARKS)
...
for numeric or decimal types this is precision." :ALLOCATION :INSTANCE
   ...
   (DECIMAL-DIGITS :TYPE CL:FIXNUM :INITFORM NULL-INTEGER :DOCUMENTATION
    "The number of fractional digits." :ALLOCATION :INSTANCE :ACCESSOR
    %DECIMAL-DIGITS)
...
NULL values, NULL means nullability unknown." :ALLOCATION :INSTANCE :ACCESSOR
    %NULLABLE?)
   (IS-NULLABLE? :DOCUMENTATION
    "TRUE means might allow NULL values, FALSE means definitely does not
allow NULL values, NULL means nullability unknown." :ALLOCATION :INSTANCE
    :ACCESSOR %IS-NULLABLE?)
   (DOCUMENTATION :TYPE CL:SIMPLE-STRING :INITFORM STELLA::NULL-STRING
    :DOCUMENTATION "Comment describing column (may be null)." :ALLOCATION
    :INSTANCE :ACCESSOR %DOCUMENTATION)
   ...
   (SQL-DATETIME-SUB :TYPE CL:FIXNUM :INITFORM NULL-INTEGER :DOCUMENTATION
    "Not used." :ALLOCATION :INSTANCE :ACCESSOR %SQL-DATETIME-SUB)
   (CHAR-OCTET-LENGTH :TYPE CL:FIXNUM :INITFORM NULL-INTEGER :DOCUMENTATION
    "For char types the maximum number of bytes in the column." :ALLOCATION
    :INSTANCE :ACCESSOR %CHAR-OCTET-LENGTH)
   (ORDINAL-POSITION :TYPE CL:FIXNUM :INITFORM NULL-INTEGER :DOCUMENTATION
    "Index of column in table (starting at 1)." :ALLOCATION :INSTANCE
    :ACCESSOR %ORDINAL-POSITION)))
...
manual filtering here."
  (CL:DECLARE
   (CL:TYPE CL:SIMPLE-STRING CATALOG-NAME SCHEMA-NAME TABLE-NAME TABLE-TYPE))
  #+MCL
    ...
    (CL:LOOP WHILE (NEXT? ITER-000) DO (CL:SETQ TABLE-ROW (%VALUE ITER-000))
     (CL:TAGBODY
       ...
       (CL:AND FILTERTABLES?
        (CL:OR
         ...
         (CL:AND (CL:NOT (CL:EQ TABLE-NAME STELLA::NULL-STRING))
          (CL:NOT
           (EQL-TO-STRING? (%%VALUE (%%REST (%%REST TABLE-ROW))) TABLE-NAME)))
      ...
      (CL:LET* ((SELF-001 (NEW-TABLE-INFO)))
       (CL:SETF (%DATABASE SELF-001) (%WRAPPER-VALUE (%%VALUE TABLE-ROW)))
...
(CL:DEFUN %GET-COLUMNS (CONNECTION CATALOGNAME SCHEMANAME TABLENAME COLUMNNAME)
  (CL:DECLARE
   (CL:TYPE CL:SIMPLE-STRING CATALOGNAME SCHEMANAME TABLENAME COLUMNNAME))
  #+MCL
      ...
      (CL:LET* ((TEST-VALUE-002 (GET-DBMS-NAME CONNECTION)))
       (CL:COND
        ((CL:EQ TEST-VALUE-002 KWD-SDBC-MYSQL)
         (CL:RETURN-FROM %GET-SERVER-INFO
          (CONS-TREE-NTH
           (%EXECUTE-SQL CONNECTION (WRAP-STRING "select version()") NIL) 0
           0)))
...
(CL:DEFUN GUESS-DBMS-NAME (CONNECTION)
  (CL:LET*
   ((DBMSNAME STELLA::NULL-STRING) (NCON (%NATIVE-CONNECTION CONNECTION)))
...
(CL:DECLAIM
 (CL:FTYPE (CL:FUNCTION (CL:T) CL:SIMPLE-STRING) CALENDAR-DATE-TO-SQL-STRING))
  ...
  (CL:LET* ((COMMANDNAME (LOOKUP TEMPLATE KWD-SDBC-COMMAND)))
   (CL:LET* ((TEMP-000 (LOOKUP TEMPLATE KWD-SDBC-DATA-SOURCE)))
    (CL:LET*
     ((DATASOURCES
       (CONSIFY
        (CL:IF (CL:NOT (CL:EQ TEMP-000 NULL)) TEMP-000 KWD-SDBC-DEFAULT)))
     ...
     (CL:WHEN (CL:NOT (STRING? SQL))
      (CL:LET* ((STREAM-001 (NEW-OUTPUT-STRING-STREAM)))
       (%%PRINT-STREAM (%NATIVE-STREAM STREAM-001)
        "Illegal or missing :sql specification in SQL template: `" SQL "'" EOL
        "   String expected.")
...
(CL:DEFUN LOOKUP-SQL-CMD-TEMPLATE (COMMANDNAME DATASOURCE)
  (CL:LET*
   ((TEMPLATES (LOOKUP *SQL-COMMAND-TEMPLATES* COMMANDNAME)) (TEMPLATE NULL))
   (CL:WHEN (CL:EQ TEMPLATES NULL)
    (CL:RETURN-FROM LOOKUP-SQL-CMD-TEMPLATE NULL))
   (CL:SETQ TEMPLATE
    (LOOKUP TEMPLATES
     (CL:IF (CL:NOT (CL:EQ DATASOURCE NULL)) DATASOURCE KWD-SDBC-DEFAULT)))
     ...
     (CL:COND
      ((CL:NOT (CL:EQ KEY NULL))
       (INSERT-AT VARIABLES KEY
        (CL:IF (CL:EQ ITEM STELLA::NULL-STRING) NULL (WRAP-STRING ITEM)))
       (CL:SETQ KEY NULL))
...
(CL:DEFUN READ-SQL-CMD-TEMPLATE-VARIABLE (TEMPLATE START END)
  ...
  (CL:LET* ((CURSOR START) (ESCAPED? CL:NIL))
     ...
     (CL:WHEN (CL:< CURSOR END)
      (CL:IF ESCAPED?
       (CL:RETURN-FROM READ-SQL-CMD-TEMPLATE-VARIABLE
        (CL:VALUES
         (UNESCAPE-TOKEN-STRING (SUBSEQUENCE TEMPLATE (CL:1+ START) CURSOR)
          #\\ CL:NIL)
         (CL:1+ CURSOR)))
       (CL:RETURN-FROM READ-SQL-CMD-TEMPLATE-VARIABLE
   ...
   (CL:LET* ((STREAM-000 (NEW-OUTPUT-STRING-STREAM)))
    (%%PRINT-STREAM (%NATIVE-STREAM STREAM-000)
     "Illegal template variable syntax at position `" CURSOR "' in" EOL EOL
     "    `" TEMPLATE "'")
    (CL:ERROR (NEW-STELLA-EXCEPTION (THE-STRING-READER STREAM-000))))))
   ...
   (CL:LET* ((VAR NULL) (VALUE NULL) (ITER-000 (%THE-KV-LIST VARIABLES)))
    (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-000 NULL)) DO
     ...
     (CL:WHEN (CL:NOT (CL:= START NULL-INTEGER))
      (CL:LET*
       ((VARSPEC STELLA::NULL-STRING) (FROM NULL-INTEGER) (TO NULL-INTEGER)
        (DEFAULT STELLA::NULL-STRING))
       ...
       (CL:MULTIPLE-VALUE-SETQ (VARSPEC FROM TO DEFAULT)
        (PARSE-SQL-CMD-TEMPLATE-VARIABLE-RANGE-AND-DEFAULT TEMPLATEVARIABLE
         (%WRAPPER-VALUE VAR) START))
       (CL:WHEN
        (CL:AND (CL:> START 0)
         (MEMBER? QUOTES
          ...
          (CL:PROGN
           (CL:IF (CL:OR (CL:EQ VALUE NIL) (CL:>= FROM (LENGTH VALUE)))
            ...
            (CL:LET* ((RESULT (NEW-OUTPUT-STRING-STREAM)))
             (CL:LET*
              ((ELT NULL) (ITER-001 VALUE) (I NULL-INTEGER) (ITER-002 0))
              ...
              (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-001 NIL)) DO
               ...
               (CL:WHEN
                ...
                (%%PRINT-STREAM (%NATIVE-STREAM RESULT)
                 (REPLACE-SUBSTRINGS TEMPLATEVARIABLE (%WRAPPER-VALUE ELT)
                  VARSPEC)))
               (CL:SETQ ITER-001 (%%REST ITER-001))
...
(CL:DEFUN PARSE-SQL-CMD-TEMPLATE-VARIABLE-RANGE-AND-DEFAULT (TEMPLATEVARIABLE VARIABLENAME START)
  ...
  (CL:LET*
   ...
   (CL:DECLARE
    (CL:TYPE CL:FIXNUM VARIABLESTART END STARTIDX ENDIDX CURSOR NOFELEMENTS)
   ...
   (CL:LOOP WHILE (CL:< CURSOR END) DO
    (CL:COND
     ((CL:AND
       ...
       (CL:< NOFELEMENTS 2))
      (CL:SETQ RANGE
       (CONS (WRAP-STRING (SUBSEQUENCE TEMPLATEVARIABLE START CURSOR)) RANGE))
   ...
   (CL:SETQ RANGE
    (CONS (WRAP-STRING (SUBSEQUENCE TEMPLATEVARIABLE START CURSOR)) RANGE))
   (CL:LET*
    ((ELT NULL) (ITER-000 (REVERSE RANGE)) (I NULL-INTEGER) (ITER-001 1))
    (CL:DECLARE (CL:TYPE CL:FIXNUM I ITER-001))
    (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-000 NIL)) DO
         ...
         (CL:IF (STRING-EQL? ELEMENT "") (CL:PROGN (CL:SETQ DEFAULT ELEMENT))
          (CL:IF (STRING-EQL? ELEMENT ":")
           ...
           (CL:LET* ((ALWAYS?-002 CL:T))
            ...
            (CL:IF ALWAYS?-002
             (CL:PROGN
              (CL:SETQ ENDIDX (CL:TRUNCATE (STRING-TO-INTEGER ELEMENT))))
             (CL:PROGN (CL:SETQ DEFAULT ELEMENT)))))))
...
(CL:DEFUN TEST-TRANSACTIONS ()
  (%%PRINT-STREAM (%NATIVE-STREAM STANDARD-OUTPUT) "testing transactions..."
   EOL)
  (CL:HANDLER-CASE
   (CL:LET*
    ((CON
    ...
    (CL:DECLARE (CL:TYPE CL:SIMPLE-STRING SELECTSQL INSERTSQL1 INSERTSQL2))
    (%SET-AUTO-COMMIT CON CL:NIL)
    (%%PRINT-STREAM (%NATIVE-STREAM STANDARD-OUTPUT) "Table before insert:"
     EOL)
    (PRINT-TABLE (%EXECUTE-SQL CON (WRAP-STRING SELECTSQL) NIL))
    (%EXECUTE-SQL CON (WRAP-STRING INSERTSQL1) NIL)
    (%%PRINT-STREAM (%NATIVE-STREAM STANDARD-OUTPUT) "Table after insert1:"
     EOL)
    (PRINT-TABLE (%EXECUTE-SQL CON (WRAP-STRING SELECTSQL) NIL)) (%COMMIT CON)
    (%%PRINT-STREAM (%NATIVE-STREAM STANDARD-OUTPUT) "Table after commit:"
     EOL)
    (PRINT-TABLE (%EXECUTE-SQL CON (WRAP-STRING SELECTSQL) NIL))
    (%EXECUTE-SQL CON (WRAP-STRING INSERTSQL2) NIL)
    (%%PRINT-STREAM (%NATIVE-STREAM STANDARD-OUTPUT) "Table after insert2:"
     EOL)
    (PRINT-TABLE (%EXECUTE-SQL CON (WRAP-STRING SELECTSQL) NIL))
    (%ROLLBACK CON)
    (%%PRINT-STREAM (%NATIVE-STREAM STANDARD-OUTPUT) "Table after rollback:"
     EOL)
    (PRINT-TABLE (%EXECUTE-SQL CON (WRAP-STRING SELECTSQL) NIL))
    (%DISCONNECT CON))
   (DATABASE-EXCEPTION (E)
   ...
   (CL:LET*
    ...
    (CL:LET* ((ROW NULL) (ITER-000 RESULT))
     (CL:LOOP WHILE (NEXT? ITER-000) DO (CL:SETQ ROW (%VALUE ITER-000))
      (%%PRINT-STREAM (%NATIVE-STREAM STANDARD-OUTPUT) "Retrieved row : "
       (%VALUE RESULT) EOL)))
    (%DISCONNECT CON))
   (DATABASE-EXCEPTION (E)
    (%%PRINT-STREAM (%NATIVE-STREAM STANDARD-OUTPUT)
...
(CL:DEFUN TEST-RETRIEVE-ALL ()
  (%%PRINT-STREAM (%NATIVE-STREAM STANDARD-OUTPUT) "Testing retrieve all..."
   EOL)
  (CL:HANDLER-CASE
   (CL:LET*
    ((CON
     ...
     (TYPES
      (LIST* SGT-SDBC-STELLA-INTEGER SGT-SDBC-STELLA-DOUBLE-FLOAT
       ...
       SGT-SDBC-STELLA-STRING SGT-SDBC-STELLA-CALENDAR-DATE NIL))
     (RESULT
      (%EXECUTE-SQL CON (WRAP-STRING SQL) (CONS-LIST KWD-SDBC-TYPES TYPES))))
    (CL:DECLARE (CL:TYPE CL:SIMPLE-STRING SQL))
    (CL:WHEN (CL:NOT (CL:EQ RESULT NULL)) (PRINT-TABLE RESULT))
    (%DISCONNECT CON)
    (%%PRINT-STREAM (%NATIVE-STREAM STANDARD-OUTPUT) "connection string: " CON
     EOL))
   (DATABASE-EXCEPTION (E)
    (%%PRINT-STREAM (%NATIVE-STREAM STANDARD-OUTPUT)
     "Caught Database Exception: " (EXCEPTION-MESSAGE E) EOL))))
...
(CL:DEFUN HELP-STARTUP-SDBC2 ()
  (CL:PROGN
   ...
   (CL:SETQ SYM-SDBC-STELLA-TYPE
    (INTERN-RIGID-SYMBOL-WRT-MODULE "TYPE" (GET-STELLA-MODULE "/STELLA" CL:T)
     0))
...
values.\" :PUBLIC? FALSE)" (CL:FUNCTION SQL-QUERY?) NULL)
   ...
   (DEFINE-FUNCTION-OBJECT "EXECUTE-SQL"
    "(DEFUN (EXECUTE-SQL OBJECT) ((CONNECTION CONNECTION) (SQL OBJECT) |&REST| (OPTIONS OBJECT)) :PUBLIC? TRUE :COMMAND? TRUE :DOCUMENTATION \"Execute a SQL statement, and return a table as the reuslt
                  ...
                  NULL.  If NULL is specified, values are returned as strings.
                  A DATABASE-EXCEPTION is thrown if execution is unsuccessful.\")"
    (CL:FUNCTION %EXECUTE-SQL) (CL:FUNCTION EXECUTE-SQL-EVALUATOR-WRAPPER))
...
values (e.g., for something like `seq.nextval' in Oracle).\" :PUBLIC? TRUE :COMMAND? TRUE)"
    (CL:FUNCTION %INSERT-ROW) (CL:FUNCTION INSERT-ROW-EVALUATOR-WRAPPER))
...
manual filtering here.\" :PUBLIC? TRUE :COMMAND? TRUE)"
    (CL:FUNCTION %GET-TABLES) (CL:FUNCTION GET-TABLES-EVALUATOR-WRAPPER))
   ...
   (DEFINE-FUNCTION-OBJECT "PRINT-TABLE"
    "(DEFUN PRINT-TABLE ((TABLE OBJECT)))" (CL:FUNCTION PRINT-TABLE) NULL)
   ...
   (DEFINE-FUNCTION-OBJECT "TEST-PREPARED-STATEMENT"
    "(DEFUN TEST-PREPARED-STATEMENT ())" (CL:FUNCTION TEST-PREPARED-STATEMENT)
    NULL)
   (DEFINE-FUNCTION-OBJECT "TEST-TRANSACTIONS" "(DEFUN TEST-TRANSACTIONS ())"
    (CL:FUNCTION TEST-TRANSACTIONS) NULL)
   (DEFINE-FUNCTION-OBJECT "TEST-RESULT-SET" "(DEFUN TEST-RESULT-SET ())"
    (CL:FUNCTION TEST-RESULT-SET) NULL)
   (DEFINE-FUNCTION-OBJECT "TEST-RETRIEVE-ALL" "(DEFUN TEST-RETRIEVE-ALL ())"
    (CL:FUNCTION TEST-RETRIEVE-ALL) NULL)
   (DEFINE-FUNCTION-OBJECT "MAIN" "(DEFUN MAIN () :PUBLIC? TRUE)"
    (CL:FUNCTION MAIN) NULL)
   (DEFINE-FUNCTION-OBJECT "STARTUP-SDBC"
    "(DEFUN STARTUP-SDBC () :PUBLIC? TRUE)" (CL:FUNCTION STARTUP-SDBC) NULL)
   (CL:LET* ((FUNCTION (LOOKUP-FUNCTION SYM-SDBC-SDBC-STARTUP-SDBC)))
    (SET-DYNAMIC-SLOT-VALUE (%DYNAMIC-SLOTS FUNCTION)
     SYM-SDBC-STELLA-METHOD-STARTUP-CLASSNAME (WRAP-STRING "_StartupSdbc")
     NULL-STRING-WRAPPER))))
   ...
   (CL:WHEN (CURRENT-STARTUP-TIME-PHASE? 9)
    ...
    (%SET-LOGGING-PARAMETERS "SDBC"
     (CONS-LIST KWD-SDBC-LOG-LEVELS
      (GET-QUOTED-TREE "((:NONE :LOW :MEDIUM :HIGH) \"/SDBC\")" "/SDBC")
      KWD-SDBC-LEVEL KWD-SDBC-NONE KWD-SDBC-MAX-WIDTH (WRAP-INTEGER 250)))
    ...
    (REGISTER-NATIVE-NAME SYM-SDBC-SDBC-DISCONNECT KWD-SDBC-COMMON-LISP
     KWD-SDBC-FUNCTION)
    (REGISTER-NATIVE-NAME SYM-SDBC-SDBC-EXECUTE-SQL KWD-SDBC-COMMON-LISP
     KWD-SDBC-FUNCTION)
    (REGISTER-NATIVE-NAME SYM-SDBC-SDBC-INSERT-ROW KWD-SDBC-COMMON-LISP
     KWD-SDBC-FUNCTION)
    (REGISTER-NATIVE-NAME SYM-SDBC-SDBC-INSERT-ROWS KWD-SDBC-COMMON-LISP
     KWD-SDBC-FUNCTION)
    (REGISTER-NATIVE-NAME SYM-SDBC-SDBC-PREPARE-STATEMENT KWD-SDBC-COMMON-LISP
     KWD-SDBC-FUNCTION)
    (REGISTER-NATIVE-NAME SYM-SDBC-SDBC-BIND-PARAMETER KWD-SDBC-COMMON-LISP
     KWD-SDBC-FUNCTION)
    (REGISTER-NATIVE-NAME SYM-SDBC-SDBC-SET-AUTO-COMMIT KWD-SDBC-COMMON-LISP
     KWD-SDBC-FUNCTION)
    ...
    (REGISTER-NATIVE-NAME SYM-SDBC-SDBC-GET-TABLES KWD-SDBC-COMMON-LISP
     KWD-SDBC-FUNCTION)
    (REGISTER-NATIVE-NAME SYM-SDBC-SDBC-GET-COLUMNS KWD-SDBC-COMMON-LISP
     KWD-SDBC-FUNCTION)
    (REGISTER-NATIVE-NAME SYM-SDBC-SDBC-GET-SERVER-INFO KWD-SDBC-COMMON-LISP
     KWD-SDBC-FUNCTION)
