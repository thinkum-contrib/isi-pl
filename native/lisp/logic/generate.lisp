  ...
  (CL:COND
   ...
   (CL:T
    (LIST* SYM-GENERATE-LOGIC-KAPPA
     ...
     (CONS (GENERATE-PROPOSITION (%PROPOSITION SELF)) NIL)))))
...
(CL:DEFUN GENERATE-DESCRIPTION-PROPOSITION (SELF)
  (CL:LET*
   ((PROP (GENERATE-PROPOSITION (%PROPOSITION SELF))) (EXISTENTALS NIL))
   (CL:LET*
...
(CL:DEFUN GENERATE-DESCRIPTIONS-AS-RULE (HEAD TAIL FORWARDRULE?)
  (CL:LET*
   ...
   (CL:LET*
    ((VAR NULL) (VECTOR-000 (%IO-VARIABLES HEAD)) (INDEX-000 0)
     (LENGTH-000 (LENGTH VECTOR-000)) (COLLECT-000 NULL))
    (CL:DECLARE (CL:TYPE CL:FIXNUM INDEX-000 LENGTH-000))
    (CL:LOOP WHILE (CL:< INDEX-000 LENGTH-000) DO
     (CL:PROGN
