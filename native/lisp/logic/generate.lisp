...
(CL:DEFUN GENERATE-ONE-VARIABLE (SELF TYPED?)
  ...
  (CL:LET* ((NAME (GENERATE-NAME-OF-VARIABLE SELF)))
   (CL:IF
    ...
    (CONS NAME (CONS (SURROGATE-TO-SYMBOL (LOGICAL-TYPE SELF)) NIL))
    NAME)))
...
(CL:DEFUN GENERATE-FUNCTION-AS-TERM (SELF)
  (CL:LET* ((ARGUMENTS NIL))
   (CL:LET*
    ((ARG NULL) (ITER-000 (BUT-LAST (%ARGUMENTS SELF)))
     (COLLECT-000 NULL))
...
(CL:DEFUN GENERATE-DESCRIPTION-PROPOSITION (SELF INVERT?)
  (CL:LET*
   ...
   (CL:LET*
    ((I NULL-INTEGER) (VAR NULL) (ITER-000 EXISTENTALS) (ITER-001 0))
...
(CL:DEFUN GENERATE-DESCRIPTIONS-AS-RULE (HEAD TAIL RULE REVERSEPOLARITY?)
  (CL:LET*
   ((FORWARDARROW?
    ...
    (ARROW
     (TYPE-TO-SYMBOL (CHOOSE-IMPLICATION-OPERATOR RULE FORWARDARROW?)))
