...
(CL:DEFVAR SGT-KIF-IN-LOGIC-EXCEPTION-RECORD NULL)
(CL:DEFVAR SYM-KIF-IN-STELLA-CONTEXT NULL)
(CL:DEFVAR SYM-KIF-IN-STELLA-MODULE NULL)
...
(CL:DEFINE-CONDITION CLASH (LOGIC-EXCEPTION)
  ((PROPOSITION :DOCUMENTATION "The main proposition involved in the clash"
    :ALLOCATION :INSTANCE :ACCESSOR %PROPOSITION)
...
(CL:DEFINE-CONDITION INTERVAL-CLASH (CLASH)
  ((INTERVAL-MEMBER :DOCUMENTATION
    "The owner of the interval cache that is unsatisfiable." :ALLOCATION
    :INSTANCE :ACCESSOR %INTERVAL-MEMBER)
...
(CL:DEFUN NEW-INTERVAL-CLASH (MESSAGE)
  ...
  (CL:LET* ((SELF NULL))
   (CL:SETQ SELF
    (CL:MAKE-CONDITION (CL:QUOTE INTERVAL-CLASH) *CONDITION-MESSAGE-KEYWORD*
     (REPLACE-SUBSTRINGS MESSAGE "~~" "~")))
...
(CL:DEFINE-CONDITION VARIABLE-VALUE-CLASH (CLASH)
  ((SKOLEM :DOCUMENTATION "Skolem which is getting multiple values."
   ...
   (VALUE1 :DOCUMENTATION "First value in value clash" :ALLOCATION :INSTANCE
    :ACCESSOR %VALUE1)
   (VALUE2 :DOCUMENTATION "Second value in value clash" :ALLOCATION :INSTANCE
    :ACCESSOR %VALUE2)))
...
(CL:DEFINE-CONDITION UNIFICATION-CLASH (CLASH)
  ((VALUE1 :DOCUMENTATION "First value in unification clash" :ALLOCATION
    :INSTANCE :ACCESSOR %VALUE1)
   (VALUE2 :DOCUMENTATION "Second value in unification clash" :ALLOCATION
...
(CL:DEFUN HELP-STARTUP-KIF-IN1 ()
  (CL:PROGN
   (CL:SETQ SGT-KIF-IN-LOGIC-EXCEPTION-RECORD
    (INTERN-RIGID-SYMBOL-WRT-MODULE "EXCEPTION-RECORD" NULL 1))
   (CL:SETQ SYM-KIF-IN-STELLA-CONTEXT
    (INTERN-RIGID-SYMBOL-WRT-MODULE "CONTEXT"
     (GET-STELLA-MODULE "/STELLA" CL:T) 0))
   (CL:SETQ SYM-KIF-IN-STELLA-MODULE
...
(CL:DEFUN STARTUP-KIF-IN ()
  (CL:LET*
   ...
   (CL:WHEN (CURRENT-STARTUP-TIME-PHASE? 5) (HELP-STARTUP-KIF-IN2))
