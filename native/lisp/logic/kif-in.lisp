...
(CL:DECLAIM (CL:SPECIAL *STARTUP-TIME-PHASE* *MODULE* NIL TRUE EOL FALSE))
      ...
      (CL:LET* ((TEST-VALUE-000 (%%VALUE SENTENCE)))
       (CL:COND
        ...
        ((CL:EQ TEST-VALUE-000 SYM-KIF-IN-STELLA-OR)
         (CL:LET*
          ((ANTECEDENT
            (LIST* SYM-KIF-IN-STELLA-NOT (%%VALUE (%%REST SENTENCE)) NIL))
...
(CL:DEFUN HELP-STARTUP-KIF-IN1 ()
  (CL:PROGN
   ...
   (CL:SETQ SYM-KIF-IN-STELLA-WHERE
    (INTERN-RIGID-SYMBOL-WRT-MODULE "WHERE" (GET-STELLA-MODULE "/STELLA" TRUE)
     0))
...
bases, they are mainly used internally by PowerLoom.\" :PUBLIC? TRUE :COMMAND? TRUE :EVALUATE-ARGUMENTS? FALSE)"
    ...
    (CL:LET* ((FUNCTION (LOOKUP-FUNCTION SYM-KIF-IN-LOGIC-STARTUP-KIF-IN)))
     (SET-DYNAMIC-SLOT-VALUE (%DYNAMIC-SLOTS FUNCTION)
      ...
      (WRAP-STRING "_Startup-Kif-In") NULL-STRING-WRAPPER)))
