...
(CL:DEFVAR SYM-KIF-IN-STELLA-+ NULL)
(CL:DEFVAR SYM-KIF-IN-PL-KERNEL-KB-PLUS NULL)
(CL:DEFVAR SYM-KIF-IN-STELLA-- NULL)
(CL:DEFVAR SYM-KIF-IN-PL-KERNEL-KB-MINUS NULL)
(CL:DEFVAR SYM-KIF-IN-STELLA-* NULL)
(CL:DEFVAR SYM-KIF-IN-PL-KERNEL-KB-TIMES NULL)
(CL:DEFVAR SYM-KIF-IN-STELLA-/ NULL)
(CL:DEFVAR SYM-KIF-IN-PL-KERNEL-KB-DIVIDE NULL)
(CL:DEFVAR SYM-KIF-IN-STELLA-> NULL)
(CL:DEFVAR SYM-KIF-IN-PL-KERNEL-KB-GREATER-THAN NULL)
(CL:DEFVAR SYM-KIF-IN-STELLA->= NULL)
(CL:DEFVAR SYM-KIF-IN-PL-KERNEL-KB-GREATER-OR-EQUAL NULL)
(CL:DEFVAR SYM-KIF-IN-STELLA-< NULL)
(CL:DEFVAR SYM-KIF-IN-PL-KERNEL-KB-LESS-THAN NULL)
(CL:DEFVAR SYM-KIF-IN-STELLA-=< NULL)
(CL:DEFVAR SYM-KIF-IN-PL-KERNEL-KB-LESS-OR-EQUAL NULL)
(CL:DEFVAR SYM-KIF-IN-LOGIC-<<= NULL)
(CL:DEFVAR SYM-KIF-IN-LOGIC-DIRECTION NULL)
(CL:DEFVAR SYM-KIF-IN-LOGIC-BACKWARD NULL)
(CL:DEFVAR SYM-KIF-IN-LOGIC-=>> NULL)
(CL:DEFVAR SYM-KIF-IN-LOGIC-FORWARD NULL)
(CL:DEFVAR SYM-KIF-IN-LOGIC-<~ NULL)
(CL:DEFVAR SYM-KIF-IN-LOGIC-CONFIDENCE-LEVEL NULL)
(CL:DEFVAR SYM-KIF-IN-STELLA-DEFAULT NULL)
(CL:DEFVAR SYM-KIF-IN-LOGIC-~> NULL)
(CL:DEFVAR SYM-KIF-IN-LOGIC-<<~ NULL)
(CL:DEFVAR SYM-KIF-IN-LOGIC-~>> NULL)
...
(CL:DEFUN KIF-SYMBOL-TO-STELLA-SYMBOL (SYMBOL)
  (CL:IF
   ...
   SYMBOL (SYMBOL-TO-SURROGATE SYMBOL)))
    ...
    ((CL:EQ TEST-VALUE-000 SGT-KIF-IN-STELLA-CONS)
     (CL:PROGN
      (CL:CASE (LENGTH TREE)
       ...
       (CL:OTHERWISE (CL:RETURN-FROM KIF-VARIABLE-DECLARATION? FALSE)))))
   ...
   ((CL:EQ (SAFE-PRIMARY-TYPE TREE) SGT-KIF-IN-STELLA-CONS)
    (CL:PROGN
     ...
     (CL:IF (CL:NOT (CL:EQ (%%VALUE (%%REST TREE)) NULL))
      (CL:PROGN
       (SECOND-SETTER TREE (SYMBOL-TO-SURROGATE (%%VALUE (%%REST TREE))))
   ...
   ((CL:EQ (SAFE-PRIMARY-TYPE TREE) SGT-KIF-IN-STELLA-CONS)
    (CL:PROGN
     (CL:WHEN
      ...
      (CL:RETURN-FROM STELLA-VARIABLE-DECLARATIONS? TRUE))))
   (CL:T))
  FALSE)
  ...
  (CL:WHEN (CL:NOT (CL:OR (CL:= (LENGTH TREE) 3) (CL:= (LENGTH TREE) 2)))
   (CL:LET* ((STREAM-000 (NEW-OUTPUT-STRING-STREAM)))
    (CL:LET* ((*PRINTREADABLY?* TRUE))
     (CL:DECLARE (CL:SPECIAL *PRINTREADABLY?*))
     (%%PRINT-STREAM (%NATIVE-STREAM STREAM-000)
      "PARSING ERROR: Illegal `" (%%VALUE TREE) "' tree: `" TREE "'." EOL)
     (HELP-SIGNAL-PROPOSITION-ERROR STREAM-000 KWD-KIF-IN-ERROR))
    (CL:ERROR (NEW-PARSING-ERROR (THE-STRING-READER STREAM-000)))))
  (CL:LET*
   ((DECLARATIONS
     (KIF-VARIABLE-DECLARATIONS-TO-STELLA (%%VALUE (%%REST TREE)) FALSE)))
   (CL:COND
...
(CL:DEFUN KIF-KAPPA-TO-STELLA-KAPPA (TREE)
  ...
  (CL:LET* ((SENTENCES (%%REST (%%REST TREE))))
   (SECOND-SETTER TREE
    (KIF-VARIABLE-DECLARATIONS-TO-STELLA (%%VALUE (%%REST TREE)) TRUE))
...
(CL:DEFUN KIF-IMPLIES-TO-OR-NOT (TREE)
  ...
  (CL:CASE (LENGTH TREE) (2 (%%VALUE (%%REST TREE)))
   (3
    (SECOND-SETTER TREE
     (LIST* SYM-KIF-IN-STELLA-NOT (%%VALUE (%%REST TREE)) NIL))
    TREE)
  ...
  (CL:WHEN (CL:> (LENGTH TREE) 3)
   (CL:LET* ((STREAM-000 (NEW-OUTPUT-STRING-STREAM)))
    (CL:LET* ((*PRINTREADABLY?* TRUE))
     ...
     (HELP-SIGNAL-PROPOSITION-ERROR STREAM-000 KWD-KIF-IN-ERROR))
    (CL:ERROR (NEW-PARSING-ERROR (THE-STRING-READER STREAM-000)))))
  (CL:LET* ((COPY (COPY-CONS-TREE TREE)))
   (FIRST-SETTER COPY SYM-KIF-IN-STELLA-=>)
   (FIRST-SETTER TREE SYM-KIF-IN-STELLA-<=)
      ...
      (CL:LET* ((TEST-VALUE-000 (%%VALUE SENTENCE)))
       (CL:COND
        ((CL:EQ TEST-VALUE-000 SYM-KIF-IN-STELLA-AND)
         (CL:LET* ((FORALLS NIL))
          (CL:LET* ((CONJUNCT NULL) (ITER-000 (%%REST SENTENCE)))
           (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-000 NIL)) DO
            (CL:PROGN (CL:SETQ CONJUNCT (%%VALUE ITER-000))
             (CL:SETQ ITER-000 (%%REST ITER-000)))
            (CL:SETQ FORALLS
             (CONS
        ...
        ((CL:EQ TEST-VALUE-000 SYM-KIF-IN-STELLA-OR)
         (CL:LET*
          ((ANTECEDENT (%%VALUE (%%REST (%%VALUE (%%REST SENTENCE)))))
...
(CL:DEFUN KIF-PREDICATION-TO-STELLA-PREDICATION (TREE)
  (CL:LET*
   ...
   (CHANGE-KIF-EXPRESSIONS-TO-STELLA-EXPRESSIONS ARGUMENTS TRUE) TREE))
...
;;; (DEFGLOBAL *DECORATION-TRANSLATION-TABLE* ...)

(CL:DEFVAR *DECORATION-TRANSLATION-TABLE* NULL)

;;; (DEFUN (CANONICALIZE-DECORATION CONS) ...)

(CL:DEFUN CANONICALIZE-DECORATION (TREE)
  (CL:LET* ((OPERATOR (%%VALUE TREE)))
   (CL:WHEN (CL:EQ OPERATOR KWD-KIF-IN-ABOUT)
    (FIRST-SETTER TREE SYM-KIF-IN-LOGIC-ABOUT)
    (CL:RETURN-FROM CANONICALIZE-DECORATION TREE))
   (CL:LET* ((ENTRY NULL) (ITER-000 *DECORATION-TRANSLATION-TABLE*))
    (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-000 NIL)) DO
     (CL:PROGN (CL:SETQ ENTRY (%%VALUE ITER-000))
      (CL:SETQ ITER-000 (%%REST ITER-000)))
     (CL:WHEN (EQL? OPERATOR (%%VALUE ENTRY))
      (FIRST-SETTER TREE (%%VALUE (%%REST ENTRY)))
      (CL:RETURN-FROM CANONICALIZE-DECORATION
   ...
   (CL:LET* ((STREAM-000 (NEW-OUTPUT-STRING-STREAM)))
    (%%PRINT-STREAM (%NATIVE-STREAM STREAM-000) "``" OPERATOR
     "'' not found in *DECORATION-TRANSLATION-TABLE*")
...
(CL:DEFUN WRAP-KIF-WITH-FORALL (TREE DECLAREDVARIABLES)
  ...
  (CL:LET* ((UNDECLAREDVARIABLES (NEW-LIST)))
   ...
   (CL:CASE (LENGTH UNDECLAREDVARIABLES)
    ...
    (CL:OTHERWISE
     (LIST* SYM-KIF-IN-STELLA-FORALL
      (COPY-CONS-TREE (%THE-CONS-LIST UNDECLAREDVARIABLES))
      (CONS TREE NIL))))))
...
(CL:DEFUN CONVERT-TO-PREFIX-PROPOSITION-TREE (TREE)
  (CL:COND
   ((CL:EQ (SAFE-PRIMARY-TYPE TREE) SGT-KIF-IN-STELLA-CONS)
    (CL:PROGN
     (CL:LET* ((OPERATOR (%%VALUE TREE)))
      (CL:IF (QUANTIFIER-SYMBOL? OPERATOR)
...
(CL:DEFUN HELP-STARTUP-KIF-IN1 ()
  (CL:PROGN
   ...
   (CL:SETQ SYM-KIF-IN-STELLA-+
    (INTERN-RIGID-SYMBOL-WRT-MODULE "+" (GET-STELLA-MODULE "/STELLA" TRUE)
     0))
   (CL:SETQ SYM-KIF-IN-PL-KERNEL-KB-PLUS
    (INTERN-RIGID-SYMBOL-WRT-MODULE "PLUS"
     (GET-STELLA-MODULE "/PL-KERNEL-KB" TRUE) 0))
   (CL:SETQ SYM-KIF-IN-STELLA--
    (INTERN-RIGID-SYMBOL-WRT-MODULE "-" (GET-STELLA-MODULE "/STELLA" TRUE)
     0))
   (CL:SETQ SYM-KIF-IN-PL-KERNEL-KB-MINUS
    (INTERN-RIGID-SYMBOL-WRT-MODULE "MINUS"
     (GET-STELLA-MODULE "/PL-KERNEL-KB" TRUE) 0))
   (CL:SETQ SYM-KIF-IN-STELLA-*
    (INTERN-RIGID-SYMBOL-WRT-MODULE "*" (GET-STELLA-MODULE "/STELLA" TRUE)
     0))
   (CL:SETQ SYM-KIF-IN-PL-KERNEL-KB-TIMES
    (INTERN-RIGID-SYMBOL-WRT-MODULE "TIMES"
     (GET-STELLA-MODULE "/PL-KERNEL-KB" TRUE) 0))
   (CL:SETQ SYM-KIF-IN-STELLA-/
    (INTERN-RIGID-SYMBOL-WRT-MODULE "/" (GET-STELLA-MODULE "/STELLA" TRUE)
     0))
   (CL:SETQ SYM-KIF-IN-PL-KERNEL-KB-DIVIDE
    (INTERN-RIGID-SYMBOL-WRT-MODULE "DIVIDE"
     (GET-STELLA-MODULE "/PL-KERNEL-KB" TRUE) 0))
   (CL:SETQ SYM-KIF-IN-STELLA->
    (INTERN-RIGID-SYMBOL-WRT-MODULE ">" (GET-STELLA-MODULE "/STELLA" TRUE)
     0))
   (CL:SETQ SYM-KIF-IN-PL-KERNEL-KB-GREATER-THAN
    (INTERN-RIGID-SYMBOL-WRT-MODULE "GREATER-THAN"
     (GET-STELLA-MODULE "/PL-KERNEL-KB" TRUE) 0))
   (CL:SETQ SYM-KIF-IN-STELLA->=
    (INTERN-RIGID-SYMBOL-WRT-MODULE ">="
     (GET-STELLA-MODULE "/STELLA" TRUE) 0))
   (CL:SETQ SYM-KIF-IN-PL-KERNEL-KB-GREATER-OR-EQUAL
    (INTERN-RIGID-SYMBOL-WRT-MODULE "GREATER-OR-EQUAL"
     (GET-STELLA-MODULE "/PL-KERNEL-KB" TRUE) 0))
   (CL:SETQ SYM-KIF-IN-STELLA-<
    (INTERN-RIGID-SYMBOL-WRT-MODULE "<" (GET-STELLA-MODULE "/STELLA" TRUE)
     0))
   (CL:SETQ SYM-KIF-IN-PL-KERNEL-KB-LESS-THAN
    (INTERN-RIGID-SYMBOL-WRT-MODULE "LESS-THAN"
     (GET-STELLA-MODULE "/PL-KERNEL-KB" TRUE) 0))
   (CL:SETQ SYM-KIF-IN-STELLA-=<
    (INTERN-RIGID-SYMBOL-WRT-MODULE "=<"
     (GET-STELLA-MODULE "/STELLA" TRUE) 0))
   (CL:SETQ SYM-KIF-IN-PL-KERNEL-KB-LESS-OR-EQUAL
    (INTERN-RIGID-SYMBOL-WRT-MODULE "LESS-OR-EQUAL"
     (GET-STELLA-MODULE "/PL-KERNEL-KB" TRUE) 0))
   (CL:SETQ SYM-KIF-IN-LOGIC-<<=
    (INTERN-RIGID-SYMBOL-WRT-MODULE "<<=" NULL 0))
   (CL:SETQ SYM-KIF-IN-LOGIC-DIRECTION
    (INTERN-RIGID-SYMBOL-WRT-MODULE "DIRECTION" NULL 0))
   (CL:SETQ SYM-KIF-IN-LOGIC-BACKWARD
    (INTERN-RIGID-SYMBOL-WRT-MODULE "BACKWARD" NULL 0))
   (CL:SETQ SYM-KIF-IN-LOGIC-=>>
    (INTERN-RIGID-SYMBOL-WRT-MODULE "=>>" NULL 0))
   (CL:SETQ SYM-KIF-IN-LOGIC-FORWARD
    (INTERN-RIGID-SYMBOL-WRT-MODULE "FORWARD" NULL 0))
   (CL:SETQ SYM-KIF-IN-LOGIC-<~
    (INTERN-RIGID-SYMBOL-WRT-MODULE "<~" NULL 0))
   (CL:SETQ SYM-KIF-IN-LOGIC-CONFIDENCE-LEVEL
    (INTERN-RIGID-SYMBOL-WRT-MODULE "CONFIDENCE-LEVEL" NULL 0))
   (CL:SETQ SYM-KIF-IN-STELLA-DEFAULT
...
(CL:DEFUN STARTUP-KIF-IN ()
  (CL:LET*
   ...
   (CL:WHEN (CURRENT-STARTUP-TIME-PHASE? 2) (HELP-STARTUP-KIF-IN1)
    (HELP-STARTUP-KIF-IN2))
   (CL:WHEN (CURRENT-STARTUP-TIME-PHASE? 4)
    (CL:LET* ((SELF-005 (NEW-PROPERTY-LIST)))
     (CL:SETF (%THE-PLIST SELF-005)
      (LIST* SYM-KIF-IN-STELLA-+ SYM-KIF-IN-PL-KERNEL-KB-PLUS
       SYM-KIF-IN-STELLA-- SYM-KIF-IN-PL-KERNEL-KB-MINUS
       SYM-KIF-IN-STELLA-* SYM-KIF-IN-PL-KERNEL-KB-TIMES
       SYM-KIF-IN-STELLA-/ SYM-KIF-IN-PL-KERNEL-KB-DIVIDE
       SYM-KIF-IN-STELLA-> SYM-KIF-IN-PL-KERNEL-KB-GREATER-THAN
       SYM-KIF-IN-STELLA->= SYM-KIF-IN-PL-KERNEL-KB-GREATER-OR-EQUAL
       SYM-KIF-IN-STELLA-< SYM-KIF-IN-PL-KERNEL-KB-LESS-THAN
       SYM-KIF-IN-STELLA-=< SYM-KIF-IN-PL-KERNEL-KB-LESS-OR-EQUAL NIL))
     (CL:SETQ KIF-OPERATOR-TO-INTERNAL-STELLA-TABLE SELF-005))
    (CL:SETQ *DECORATION-TRANSLATION-TABLE*
     (LIST*
      (LIST* SYM-KIF-IN-LOGIC-<<= SYM-KIF-IN-STELLA-<=
       (CONS
        (LIST* SYM-KIF-IN-LOGIC-DIRECTION SYM-KIF-IN-LOGIC-BACKWARD NIL)
        NIL)
       NIL)
      (LIST* SYM-KIF-IN-LOGIC-=>> SYM-KIF-IN-STELLA-=>
       (CONS
        (LIST* SYM-KIF-IN-LOGIC-DIRECTION SYM-KIF-IN-LOGIC-FORWARD NIL)
        NIL)
       NIL)
      (LIST* SYM-KIF-IN-LOGIC-<~ SYM-KIF-IN-STELLA-<=
       (CONS
        (LIST* SYM-KIF-IN-LOGIC-CONFIDENCE-LEVEL SYM-KIF-IN-STELLA-DEFAULT
         NIL)
        NIL)
       NIL)
      (LIST* SYM-KIF-IN-LOGIC-~> SYM-KIF-IN-STELLA-=>
   ...
   (CL:WHEN (CURRENT-STARTUP-TIME-PHASE? 7)
    ...
    (DEFINE-FUNCTION-OBJECT "CANONICALIZE-DECORATION"
     "(DEFUN (CANONICALIZE-DECORATION CONS) ((TREE CONS)))"
     (CL:FUNCTION CANONICALIZE-DECORATION) NULL)
    ...
    (DEFINE-FUNCTION-OBJECT "UNTYPED-STELLA-TREE-TO-TYPED-STELLA"
     "(DEFUN UNTYPED-STELLA-TREE-TO-TYPED-STELLA ((TREE CONS)))"
     (CL:FUNCTION UNTYPED-STELLA-TREE-TO-TYPED-STELLA) NULL)
...
bases, they are mainly used internally by PowerLoom.\" :PUBLIC? TRUE :COMMAND? TRUE :EVALUATE-ARGUMENTS? FALSE)"
    ...
    (CL:LET*
     ...
     (SET-DYNAMIC-SLOT-VALUE (%DYNAMIC-SLOTS FUNCTION)
      ...
      (WRAP-STRING "Startup-Kif-In") NULL-STRING-WRAPPER)))
...
instances named by the system.\")")
    (DEFINE-STELLA-GLOBAL-VARIABLE-FROM-STRINGIFIED-SOURCE
     "(DEFGLOBAL KIF-OPERATOR-TO-INTERNAL-STELLA-TABLE (PROPERTY-LIST OF SYMBOL SYMBOL) (NEW PROPERTY-LIST :THE-PLIST (BQUOTE (+ /PL-KERNEL-KB/PLUS - /PL-KERNEL-KB/MINUS * /PL-KERNEL-KB/TIMES / /PL-KERNEL-KB/DIVIDE > /PL-KERNEL-KB/GREATER-THAN >= /PL-KERNEL-KB/GREATER-OR-EQUAL < /PL-KERNEL-KB/LESS-THAN =< /PL-KERNEL-KB/LESS-OR-EQUAL))) :DOCUMENTATION \"Used to encode/decode KIF operators to the internal
version of Stella operators.\")")
    (DEFINE-STELLA-GLOBAL-VARIABLE-FROM-STRINGIFIED-SOURCE
     "(DEFGLOBAL *DECORATION-TRANSLATION-TABLE* (CONS OF CONS) (BQUOTE ((<<= <= ((DIRECTION BACKWARD))) (=>> => ((DIRECTION FORWARD))) (<~ <= ((CONFIDENCE-LEVEL DEFAULT))) (~> => ((CONFIDENCE-LEVEL DEFAULT))) (<<~ <= ((CONFIDENCE-LEVEL DEFAULT) (DIRECTION BACKWARD))) (~>> => ((CONFIDENCE-LEVEL DEFAULT) (DIRECTION FORWARD))))))")
    (DEFINE-STELLA-GLOBAL-VARIABLE-FROM-STRINGIFIED-SOURCE
