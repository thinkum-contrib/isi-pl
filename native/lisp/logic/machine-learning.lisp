...
(CL:DECLAIM
  ...
  *LOG-MATCH-RULES* *DROP-FUNCTION-VALUES?* *FAIL-UNBOUND-CLAUSES?*
  TRUE-WRAPPER *MODULE* NIL STANDARD-OUTPUT EOL NULL-FLOAT
  NULL-INTEGER))
...
(CL:DEFUN GET-CLASSIFICATION-RELATIONS (CONS-QUERY)
  (CL:LET*
   ((QUERY
     (MAKE-QUERY NIL (COPY-CONS-TREE CONS-QUERY) NIL NIL "Antecedent"))
...
(CL:DEFUN CREATE-INPUT-SIGNATURE (CONS-QUERY)
  (CL:LET*
   ((QUERY
     (MAKE-QUERY NIL (COPY-CONS-TREE CONS-QUERY) NIL NIL "Signature"))
