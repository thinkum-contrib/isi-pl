...
(CL:DECLAIM
 (CL:SPECIAL *STARTUP-TIME-PHASE* *TRACED-KEYWORDS* TRUE-TRUTH-VALUE
  ...
  STANDARD-OUTPUT EOL *CONTEXT* *MEMOIZATION-ENABLED?*
  MEMOIZED-NULL-VALUE TRUE-WRAPPER NIL FALSE-WRAPPER))
    ...
    ((CL:OR (CL:EQ TEST-VALUE-000 KWD-CLASSIFY-PREDICATE)
     ...
     (CL:LET* ((TEST-VALUE-001 CL:NIL))
      (CL:LET* ((ALWAYS?-000 CL:T))
       (CL:LET*
        ((ARG1 NULL) (VECTOR-000 (%ARGUMENTS PROPOSITION))
        ...
        (CL:LOOP WHILE
         ...
         (CL:SETQ ARG2
          (CL:AREF (CL:THE CL:SIMPLE-VECTOR (%THE-ARRAY VECTOR-001))
           INDEX-001))
         (CL:WHEN (CL:NOT (CL:EQ ARG1 ARG2))
...
(CL:DEFUN ALL-INTENSIONAL-PARENTS (SELF)
  (CL:LET* ((COLLECTION (NEW-LIST)))
   (HELP-COLLECT-INTENSIONAL-PARENTS SELF (%PROPOSITION SELF)
    COLLECTION)
   COLLECTION))
     ...
     (CL:PROGN
      (CL:COND
       ...
       ((CL:NOT
        ...
        (CL:RETURN-FROM INFERABLE-THROUGH-BY-SOME-DESCENDANT? CL:T))
       ((CL:NOT
         (INFERABLE-WITH-CYCLE-CHECK? THROUGHCHILD ALREADYVISITEDLIST))
        (CL:RETURN-FROM INFERABLE-THROUGH-BY-SOME-DESCENDANT? CL:NIL)))
      (CL:SETQ ALREADYVISITEDLIST
       (CONS THROUGHCHILD ALREADYVISITEDLIST))
      (CL:LET*
       ((P NULL)
        (ITER-000
         (APPLICABLE-RULES-OF-DESCRIPTION THROUGHCHILD
          KWD-CLASSIFY-BACKWARD CL:NIL)))
      ...
      (CL:LET* ((TEST-VALUE-000 CL:NIL))
       (CL:LET* ((FOUND?-000 CL:NIL))
        (CL:LET*
         ((PARENT NULL)
          (ITER-001
           (%THE-CONS-LIST (ALL-INTENSIONAL-PARENTS THROUGHCHILD))))
           ...
           (CL:WHEN TEST-VALUE-001
            (CL:LET* ((FOUND?-001 CL:NIL))
             (CL:LET*
              ((P NULL)
               (ITER-001
                (APPLICABLE-RULES-OF-DESCRIPTION SELF
                 KWD-CLASSIFY-BACKWARD CL:NIL)))
              (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-001 NIL)) DO
...
(CL:DEFUN NEW-MARKER-TABLE ()
  (CL:LET* ((SELF NULL))
   ...
   (CL:SETF (%RECALL-TABLE SELF) NULL)
...
(CL:DEFUN ALL-NAMED-DIRECT-SUBDESCRIPTIONS (SELF)
  (CL:LET* ((RESULT NIL))
   (CL:LET*
    ((D NULL) (ITER-000 (ALL-DIRECT-SUBCOLLECTIONS SELF CL:NIL)))
    (CL:LOOP WHILE (NEXT? ITER-000) DO (CL:SETQ D (%VALUE ITER-000))
     (CL:WHEN (ISA? D SGT-CLASSIFY-LOGIC-NAMED-DESCRIPTION)
      (CL:SETQ RESULT (CONS D RESULT)))))
   RESULT))
...
(CL:DEFUN ADD-SUBSUMPTION-LINK (SUBDESCRIPTION SUPERDESCRIPTION)
  ...
  (CL:LET*
   ((P NULL)
    (ITER-000
     (ALL-NAMED-DIRECT-SUPERDESCRIPTIONS SUPERDESCRIPTION CL:NIL)))
   (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-000 NIL)) DO
    (CL:SETQ P (%%VALUE ITER-000))
...
(CL:DEFCLASS CLASSIFICATION-CACHE (STANDARD-OBJECT)
  ((INFERABLE-DIRECT-SUBDESCRIPTIONS :ALLOCATION :INSTANCE :ACCESSOR
   ...
   (CACHE-UPCLASSIFICATION-TIMESTAMP :TYPE CL:FIXNUM :INITFORM
    NULL-INTEGER :ALLOCATION :INSTANCE :ACCESSOR
    %CACHE-UPCLASSIFICATION-TIMESTAMP)
   (CACHE-DOWNCLASSIFICATION-TIMESTAMP :TYPE CL:FIXNUM :INITFORM
    NULL-INTEGER :ALLOCATION :INSTANCE :ACCESSOR
    %CACHE-DOWNCLASSIFICATION-TIMESTAMP)
   (INTRODUCTION-TIMESTAMP :TYPE CL:FIXNUM :INITFORM NULL-INTEGER
    :ALLOCATION :INSTANCE :ACCESSOR %INTRODUCTION-TIMESTAMP))
...
(CL:DEFUN ACCESS-CLASSIFICATION-CACHE-SLOT-VALUE (SELF SLOTNAME VALUE SETVALUE?)
  (CL:COND
   ((CL:EQ SLOTNAME
     SYM-CLASSIFY-LOGIC-INFERABLE-DIRECT-SUBDESCRIPTIONS)
    (CL:IF SETVALUE?
     (CL:SETF (%INFERABLE-DIRECT-SUBDESCRIPTIONS SELF) VALUE)
     (CL:SETQ VALUE (%INFERABLE-DIRECT-SUBDESCRIPTIONS SELF))))
   ((CL:EQ SLOTNAME
     SYM-CLASSIFY-LOGIC-CACHE-UPCLASSIFICATION-TIMESTAMP)
    (CL:IF SETVALUE?
     (CL:SETF (%CACHE-UPCLASSIFICATION-TIMESTAMP SELF)
      (%WRAPPER-VALUE VALUE))
     (CL:SETQ VALUE
      (WRAP-INTEGER (%CACHE-UPCLASSIFICATION-TIMESTAMP SELF)))))
   ((CL:EQ SLOTNAME
     SYM-CLASSIFY-LOGIC-CACHE-DOWNCLASSIFICATION-TIMESTAMP)
    (CL:IF SETVALUE?
...
(CL:DEFUN NEW-CLASSIFICATION-SESSION ()
  (CL:LET* ((SELF NULL))
   ...
   (CL:SETF (%INTRODUCTION-TIMESTAMP-STACK SELF)
    (LIST (WRAP-INTEGER 0)))
...
(CL:DEFUN ACCESS-CLASSIFICATION-SESSION-SLOT-VALUE (SELF SLOTNAME VALUE SETVALUE?)
  (CL:COND
   ...
   ((CL:EQ SLOTNAME SYM-CLASSIFY-LOGIC-INTRODUCTION-TIMESTAMP-STACK)
    (CL:IF SETVALUE?
     (CL:SETF (%INTRODUCTION-TIMESTAMP-STACK SELF) VALUE)
   ...
   ((CL:EQ SLOTNAME SYM-CLASSIFY-LOGIC-EVERYTHING-CLASSIFIED?)
    (CL:IF SETVALUE?
     (CL:SETF (%EVERYTHING-CLASSIFIED? SELF)
      (COERCE-WRAPPED-BOOLEAN-TO-BOOLEAN VALUE))
     (CL:SETQ VALUE
      (CL:IF (%EVERYTHING-CLASSIFIED? SELF) TRUE-WRAPPER
       FALSE-WRAPPER))))
...
(CL:DEFUN GET-CLASSIFICATION-CACHE (SELF)
  (CL:LET* ((SESSION *CLASSIFICATIONSESSION*) (CACHE NULL))
   ...
   (CL:WHEN (CL:EQ CACHE NULL)
    (CL:SETQ CACHE (NEW-CLASSIFICATION-CACHE))
...
(CL:DECLAIM
 (CL:FTYPE (CL:FUNCTION () CL:FIXNUM) CURRENT-CLASSIFICATION-TIME))
...
(CL:DEFUN FLUSH-CLASSIFICATION-SESSIONS ()
  (CL:LET*
   ((JITWORLD
     (LOOKUP-INFERENCE-CACHE *MODULE* KWD-CLASSIFY-JUST-IN-TIME))
...
(CL:DEFUN UPCLASSIFIED? (SELF)
  (> (UPCLASSIFICATION-TIMESTAMP SELF)
...
(CL:DEFUN COLLECT-SUBSUMING-PARENTS-BELOW (SELF SUPER NEWPARENTDESCRIPTIONS ALREADYVISITEDTABLE SELFISBELOWTABLE SUBSUMPTIONTEST)
  ...
  (CL:WHEN
   ...
   (%%PRINT-STREAM (%NATIVE-STREAM STANDARD-OUTPUT)
    "   ALL-INFERABLE-SUBS:  "
    (CONS-LIST (LISTIFY (ALL-INFERABLE-DIRECT-SUBCOLLECTIONS SUPER)))
    EOL))
...
(CL:DEFUN HELP-UPCLASSIFY-ONE-ENTITY (SELF INSTANCEORDESCRIPTION)
  ...
  (CL:LET*
   ...
   (CL:WHEN
    (CL:AND (CL:NOT (CL:EQ *TRACED-KEYWORDS* NULL))
     (MEMB? *TRACED-KEYWORDS* KWD-CLASSIFY-CLASSIFIER))
    (%%PRINT-STREAM (%NATIVE-STREAM STANDARD-OUTPUT) "   WORLD: "
     *CONTEXT* "  self: " SELF EOL "   ANCESTORS: "
...
(CL:DEFUN UPCLASSIFY-ONE-INSTANCE (SELF)
  (CL:WHEN (UPCLASSIFIED? SELF)
   (CL:RETURN-FROM UPCLASSIFY-ONE-INSTANCE))
  (CL:WHEN
   (CL:AND (CL:NOT (CL:EQ *TRACED-KEYWORDS* NULL))
    (CL:OR (MEMB? *TRACED-KEYWORDS* KWD-CLASSIFY-CLASSIFIER)
     (MEMB? *TRACED-KEYWORDS* KWD-CLASSIFY-CLASSIFIER-PROFILE)))
   (%%PRINT-STREAM (%NATIVE-STREAM STANDARD-OUTPUT) "UPCLASSIFY:  "
    SELF EOL))
...
(CL:DEFUN UPCLASSIFY-ONE-DESCRIPTION (SELF)
  ...
  (CL:WHEN
   (CL:AND (CL:NOT (CL:EQ *TRACED-KEYWORDS* NULL))
    (CL:OR (MEMB? *TRACED-KEYWORDS* KWD-CLASSIFY-CLASSIFIER)
     (MEMB? *TRACED-KEYWORDS* KWD-CLASSIFY-CLASSIFIER-PROFILE)))
   (%%PRINT-STREAM (%NATIVE-STREAM STANDARD-OUTPUT) "UPCLASSIFY: " SELF
    EOL))
  (EMIT-THINKING-DOT KWD-CLASSIFY-UPCLASSIFY)
   ...
   (CL:LET* ((E NULL) (ITER-000 EQUIVALENTS))
    (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-000 NIL)) DO
     ...
     (CL:WHEN (CL:NOT (NAMED-DESCRIPTION? E))
      (CL:LET*
       ((PD NULL)
        (ITER-001 (%THE-CONS-LIST (ALL-INTENSIONAL-PARENTS E))))
       (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-001 NIL)) DO
  ...
  (CL:LET*
   ((SUPER NULL)
    (ITER-002 (ALL-NAMED-DIRECT-SUPERDESCRIPTIONS SELF CL:T)))
   (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-002 NIL)) DO
...
(CL:DEFUN COLLECTION-WITH-FEWEST-CHILDREN (COLLECTIONS)
  (CL:WHEN (CL:EQ (%%REST COLLECTIONS) NULL)
   (CL:RETURN-FROM COLLECTION-WITH-FEWEST-CHILDREN
    (%%VALUE COLLECTIONS)))
  (CL:LET*
   ((BESTCOLLECTION (%%VALUE COLLECTIONS)) (LOWESTCHILDCOUNT 100))
   (CL:DECLARE (CL:TYPE CL:FIXNUM LOWESTCHILDCOUNT))
   (CL:LET* ((C NULL) (ITER-000 COLLECTIONS))
    (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-000 NIL)) DO
     (CL:SETQ C (%%VALUE ITER-000))
     (CL:LET* ((CHILDCOUNT 0))
      (CL:DECLARE (CL:TYPE CL:FIXNUM CHILDCOUNT))
      (CL:LET*
       ((P
         (ALLOCATE-ITERATOR
   ...
   (CL:WHEN (CL:NOT (DOWNCLASSIFIED? SELF))
    ...
    (CL:LET*
     ...
     (CL:WHEN (CL:NOT (CL:EQ BESTPARENT NULL))
      (CL:LET*
       ((CHILD NULL)
        (ITER-000 (ALL-NAMED-DIRECT-SUBDESCRIPTIONS BESTPARENT)))
       (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-000 NIL)) DO
  ...
  (CL:LET*
   ...
   (CL:LET* ((CP NULL) (ITER-001 (%THE-CONS-LIST CHILDIMPLIES)))
    (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-001 NIL)) DO
     ...
     (CL:SETQ CHILD
      (CL:AREF (CL:THE CL:SIMPLE-VECTOR (%THE-ARRAY (%ARGUMENTS CP)))
       0))
     (CL:LET* ((PP NULL) (ITER-002 (%THE-CONS-LIST PARENTIMPLIES)))
      (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-002 NIL)) DO
       (CL:SETQ PP (%%VALUE ITER-002))
       (CL:SETQ PARENT
        (CL:AREF (CL:THE CL:SIMPLE-VECTOR (%THE-ARRAY (%ARGUMENTS PP)))
         1))
       (CL:SETQ BRIDGEPROP
       ...
       (CL:WHEN
        ...
        (SET-DYNAMIC-SLOT-VALUE (%DYNAMIC-SLOTS BRIDGEPROP)
         SYM-CLASSIFY-LOGIC-SUBRELATION-LINK? TRUE-WRAPPER
         FALSE-WRAPPER))
       ...
       (CL:WHEN (NAMED-DESCRIPTION? E)
        (CL:IF (CL:EQ COLLECT-000 NULL)
         (CL:PROGN (CL:SETQ COLLECT-000 (CONS E NIL))
          (CL:IF (CL:EQ EQUIVALENTS NIL)
           (CL:SETQ EQUIVALENTS COLLECT-000)
  ...
  (CL:LET*
   ...
   (CL:LET*
    ...
    (CL:COND ((CL:EQ MODULE NULL) (UPCLASSIFY-ALL-DESCRIPTIONS))
     (LOCAL?
      (CL:LET*
       ((D NULL) (ITER-000 (ALL-NAMED-DESCRIPTIONS MODULE CL:T)))
       (CL:LOOP WHILE (NEXT? ITER-000) DO (CL:SETQ D (%VALUE ITER-000))
       ...
       (CL:WHEN (CL:NOT (%EVERYTHING-CLASSIFIED? SESSION))
        (CL:LET* ((M NULL) (ITER-001 (ALL-INCLUDED-MODULES MODULE)))
         (CL:LOOP WHILE (NEXT? ITER-001) DO
          ...
          (CL:LET*
           ((D NULL) (ITER-002 (ALL-NAMED-DESCRIPTIONS M CL:T)))
    ...
    (THEOPTIONS
     (PARSE-OPTIONS
      (CL:IF (KEYWORD? (%%VALUE OPTIONSLIST)) OPTIONSLIST
       (CONS-LIST KWD-CLASSIFY-MODULE (%%VALUE OPTIONSLIST)
        KWD-CLASSIFY-LOCAL? (%%VALUE (%%REST OPTIONSLIST))))
      (LIST* KWD-CLASSIFY-MODULE SGT-CLASSIFY-STELLA-MODULE
       KWD-CLASSIFY-LOCAL? SGT-CLASSIFY-STELLA-BOOLEAN NIL)
      CL:T CL:NIL))
    (THEMODULE
     (LOOKUP-WITH-DEFAULT THEOPTIONS KWD-CLASSIFY-MODULE NULL))
    (LOCAL?
     (COERCE-WRAPPED-BOOLEAN-TO-BOOLEAN
      (LOOKUP-WITH-DEFAULT THEOPTIONS KWD-CLASSIFY-LOCAL?
       FALSE-WRAPPER))))
   (CL:WHEN
    (CL:AND (CL:EQ THEMODULE NULL)
     (CL:NOT (MEMBER? OPTIONSLIST KWD-CLASSIFY-MODULE)))
        ...
        (CL:WHEN TEST-VALUE-000
         (CL:LET* ((FOUND?-000 CL:NIL))
          (CL:LET*
           ((SUPER NULL)
            (ITER-001
             (ALL-ANCESTOR-COLLECTIONS D KWD-CLASSIFY-DESCRIPTION)))
           (CL:LOOP WHILE (NEXT? ITER-001) DO
            (CL:SETQ SUPER (%VALUE ITER-001))
        ...
        (CL:WHEN TEST-VALUE-000
         (CL:IF (CL:EQ COLLECT-000 NULL)
          (CL:PROGN (CL:SETQ COLLECT-000 (CONS D NIL))
           (CL:IF (CL:EQ UNCLASSIFIED NIL)
            (CL:SETQ UNCLASSIFIED COLLECT-000)
        ...
        (CL:WHEN TEST-VALUE-000
         (CL:LET* ((FOUND?-000 CL:NIL))
          (CL:LET*
           ((TYPE NULL)
            (ITER-001
             (ALL-ANCESTOR-COLLECTIONS I KWD-CLASSIFY-INSTANCE)))
           (CL:LOOP WHILE (NEXT? ITER-001) DO
...
(CL:DEFUN HELP-STARTUP-CLASSIFY1 ()
  (CL:PROGN
   (CL:SETQ KWD-CLASSIFY-IMPLIES-PROPOSITION-UPDATE
    (INTERN-RIGID-SYMBOL-WRT-MODULE "IMPLIES-PROPOSITION-UPDATE" NULL
     2))
   ...
   (CL:SETQ SYM-CLASSIFY-LOGIC-CACHE-DOWNCLASSIFICATION-TIMESTAMP
    (INTERN-RIGID-SYMBOL-WRT-MODULE
     "CACHE-DOWNCLASSIFICATION-TIMESTAMP" NULL 0))
   ...
   (CL:SETQ SYM-CLASSIFY-LOGIC-CLASSIFICATION-CACHE-TABLE
    (INTERN-RIGID-SYMBOL-WRT-MODULE "CLASSIFICATION-CACHE-TABLE" NULL
     0))
   ...
   (CL:SETQ KWD-CLASSIFY-MODULE
    (INTERN-RIGID-SYMBOL-WRT-MODULE "MODULE" NULL 2))
   (CL:SETQ KWD-CLASSIFY-LOCAL?
    (INTERN-RIGID-SYMBOL-WRT-MODULE "LOCAL?" NULL 2))
   (CL:SETQ SGT-CLASSIFY-STELLA-MODULE
   ...
   (CL:SETQ SYM-CLASSIFY-LOGIC-LIST-UNCLASSIFIED-RELATIONS
    (INTERN-RIGID-SYMBOL-WRT-MODULE "LIST-UNCLASSIFIED-RELATIONS" NULL
     0))
   ...
   (CL:SETQ SYM-CLASSIFY-LOGIC-LIST-UNCLASSIFIED-INSTANCES
    (INTERN-RIGID-SYMBOL-WRT-MODULE "LIST-UNCLASSIFIED-INSTANCES" NULL
     0))
...
is set, then the iterator 'recall-marked-objects' can be invoked
on the new marker storage object.\")"
    (CL:FUNCTION CREATE-MARKER-STORAGE) NULL)
...
state of descriptions participating in a classification session.\" :TYPE CLASSIFICATION-SESSION :ALLOCATION :DYNAMIC)")
   ...
   (DEFINE-FUNCTION-OBJECT
    "FLUSH-INFERABLE-DIRECT-SUBDESCRIPTIONS-CACHE"
...
or `list-unclassified-instances'.\" :PUBLIC? TRUE)")
    ...
    (REGISTER-NATIVE-NAME
     SYM-CLASSIFY-LOGIC-LIST-UNCLASSIFIED-RELATIONS
     KWD-CLASSIFY-COMMON-LISP KWD-CLASSIFY-FUNCTION)
    (REGISTER-NATIVE-NAME SYM-CLASSIFY-LOGIC-CLASSIFY-INSTANCES
     KWD-CLASSIFY-COMMON-LISP KWD-CLASSIFY-FUNCTION)
    (REGISTER-NATIVE-NAME
     SYM-CLASSIFY-LOGIC-LIST-UNCLASSIFIED-INSTANCES
     KWD-CLASSIFY-COMMON-LISP KWD-CLASSIFY-FUNCTION))))
