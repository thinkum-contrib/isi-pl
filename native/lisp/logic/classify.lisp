...
(CL:DEFVAR SGT-CLASSIFY-LOGIC-INFERABLE-WITH-CYCLE-CHECK?-MEMO-TABLE-000 NULL)
...
(CL:DECLAIM
 (CL:SPECIAL *STARTUP-TIME-PHASE* *TRACED-KEYWORDS* TRUE-TRUTH-VALUE
  ...
  TRUE-WRAPPER NIL FALSE-WRAPPER FALSE TRUE))
    ...
    ((SUBTYPE-OF? (SAFE-PRIMARY-TYPE SELF)
     ...
     (CL:PROGN
      (CL:LET*
       ((MEMO-TABLE-000
         (%SURROGATE-VALUE
          SGT-CLASSIFY-LOGIC-INFERABLE-WITH-CYCLE-CHECK?-MEMO-TABLE-000))
...
(CL:DEFUN ADD-SUBSUMPTION-LINK (SUBDESCRIPTION SUPERDESCRIPTION)
  ...
  (CL:LET*
   ((P NULL)
    (ITER-000 (ALL-NAMED-DIRECT-SUPERDESCRIPTIONS SUPERDESCRIPTION FALSE)))
   (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-000 NIL)) DO
    (CL:PROGN (CL:SETQ P (%%VALUE ITER-000))
     (CL:SETQ ITER-000 (%%REST ITER-000)))
   ...
   (CL:LET* ((D NULL) (ITER-000 (COPY-CONS-LIST DESCRIPTIONS)))
    (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-000 NIL)) DO
     ...
     (CL:WHEN (CL:NOT (NAMED-COLLECTION? D))
      ...
      (CL:LET* ((SUPER NULL) (ITER-001 (ALL-DIRECT-SUPERCOLLECTIONS D FALSE)))
...
(CL:DEFUN HELP-COLLECT-PARENTS-BELOW? (SELF SUPER NEWPARENTDESCRIPTIONS ALREADYVISITEDTABLE SELFISBELOWTABLE SUBSUMPTIONTEST)
  ...
  (CL:LET* ((FOUNDSUBSUMINGSUB? FALSE)) (SET-MARKER ALREADYVISITEDTABLE SUPER)
   (CL:COND
    ((TEST-MARKER? SELFISBELOWTABLE SUPER) (CL:SETQ FOUNDSUBSUMINGSUB? TRUE)
     (CL:LET*
      ((SUB NULL)
       (ITER-000
     ...
     (CL:WHEN (CL:NOT (NAMED-DESCRIPTION? E))
      (CL:LET*
       ...
       (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-001 NIL)) DO
        ...
        (ADD-SUBSUMPTION-LINK SELF PD)))))))
  (CL:LET*
   ((SUPER NULL) (ITER-002 (ALL-NAMED-DIRECT-SUPERDESCRIPTIONS SELF TRUE)))
   (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-002 NIL)) DO
    ...
    (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-000 NIL)) DO
     ...
     (CL:LET* ((CHILDCOUNT 0)) (CL:DECLARE (CL:TYPE CL:FIXNUM CHILDCOUNT))
      (CL:LET*
       ((P
         (ALLOCATE-ITERATOR
          (APPLICABLE-RULES-OF-DESCRIPTION C KWD-CLASSIFY-BACKWARD TRUE))))
...
non-inferable/primitive ancestor relations."
  ...
  (FINALIZE-OBJECTS)
  (CL:LET* ((THEMODULE (COERCE-TO-MODULE MODULE TRUE)) (UNCLASSIFIED NIL))
   (CL:WHEN (CL:NOT (CL:EQ THEMODULE NULL))
    (CL:WHEN (CL:EQ MODULE NULL) (CL:SETQ THEMODULE NULL))
    (CL:LET*
     ((*CLASSIFICATIONSESSION*
  ...
  (CL:LET*
   ...
   (CL:WHEN (MEMBER? (ALL-SUPERCOLLECTIONS SELF) SELF)
    (CL:LOOP (CL:SETQ U (POP UNSCANNEDEQUIVALENTS))
     (CL:LET* ((PARENT NULL) (ITER-000 (ALL-DIRECT-SUPERCOLLECTIONS U FALSE)))
...
(CL:DEFUN HELP-STARTUP-CLASSIFY1 ()
  (CL:PROGN
   ...
   (CL:SETQ SGT-CLASSIFY-LOGIC-INFERABLE-WITH-CYCLE-CHECK?-MEMO-TABLE-000
    (INTERN-RIGID-SYMBOL-WRT-MODULE
     "INFERABLE-WITH-CYCLE-CHECK?-MEMO-TABLE-000" NULL 1))
