...
(CL:DECLAIM
 (CL:SPECIAL *STARTUP-TIME-PHASE* TRUE-TRUTH-VALUE DEFAULT-TRUE-TRUTH-VALUE NULL-INTEGER SHALLOW-INFERENCE
  SUBSUMPTION-INFERENCE TRUE-WRAPPER FALSE-WRAPPER *CONTEXT* *MEMOIZATION-ENABLED?* MEMOIZED-NULL-VALUE NIL
  STANDARD-OUTPUT EOL *MODULE*))
...
(CL:DEFUN COERCE-TO-INSTANCE-IN-MODULE (SELF MODULE LOCAL? ORIGINAL)
  (CL:WHEN (CL:EQ SELF NULL)
   (CL:WHEN (CL:NOT (CL:EQ ORIGINAL NULL))
    (%%PRINT-STREAM (%NATIVE-STREAM STANDARD-OUTPUT) "Can't find the entity referenced as: `" ORIGINAL "'." EOL))
  ...
  (CL:LET* ((TEST-VALUE-000 (SAFE-PRIMARY-TYPE SELF)))
   (CL:COND ((SUBTYPE-OF? TEST-VALUE-000 SGT-FRAME-SUPPORT-LOGIC-LOGIC-OBJECT) (CL:PROGN SELF))
     ...
     (CL:PROGN
      (CL:LET* ((NAME (%WRAPPER-VALUE SELF)) (MODULEFROMSTRING NULL)) (CL:DECLARE (CL:TYPE CL:SIMPLE-STRING NAME))
       (CL:WHEN (QUALIFIED-STELLA-NAME? NAME)
        (CL:MULTIPLE-VALUE-SETQ (MODULEFROMSTRING NAME) (COMPUTE-MODULE-AND-BARE-NAME NAME)))
       (CL:WHEN (CL:EQ MODULE NULL)
        (CL:IF (CL:NOT (CL:EQ MODULEFROMSTRING NULL)) (CL:SETQ MODULE MODULEFROMSTRING) (CL:SETQ MODULE *MODULE*)))
       (CL:LET* ((SURROGATE (LOOKUP-SURROGATE-IN-MODULE NAME MODULE LOCAL?)))
        (CL:WHEN (CL:OR (CL:EQ SURROGATE NULL) (CL:EQ (%SURROGATE-VALUE SURROGATE) NULL))
         (CL:COND
          ((CL:AND (CL:NOT (CL:EQ SURROGATE NULL)) (CL:NOT (CL:EQ (HOME-OBJECT-STORE SURROGATE) NULL)))
           (FETCH-INSTANCE (HOME-OBJECT-STORE SURROGATE) SURROGATE))
          ((CL:AND (CL:EQ SURROGATE NULL)
            (CL:NOT
             (CL:EQ (DYNAMIC-SLOT-VALUE (%DYNAMIC-SLOTS MODULE) SYM-FRAME-SUPPORT-LOGIC-OBJECT-STORE NULL) NULL)))
           (FETCH-INSTANCE (DYNAMIC-SLOT-VALUE (%DYNAMIC-SLOTS MODULE) SYM-FRAME-SUPPORT-LOGIC-OBJECT-STORE NULL)
            (INTERN-SURROGATE-IN-MODULE NAME MODULE LOCAL?)))))
        (CL:IF (CL:AND (CL:NOT (CL:EQ SURROGATE NULL)) (CL:NOT (CL:EQ (%SURROGATE-VALUE SURROGATE) NULL)))
         (COERCE-TO-INSTANCE-IN-MODULE SURROGATE MODULE CL:T ORIGINAL) NULL)))))
    ((SUBTYPE-OF-SYMBOL? TEST-VALUE-000)
     (CL:PROGN
      (CL:LET*
       ((STARTINGMODULE (CL:IF (CL:NOT (CL:EQ MODULE NULL)) MODULE (%HOME-CONTEXT SELF)))
        (VALUE
         (COERCE-TO-INSTANCE-IN-MODULE (LOOKUP-SURROGATE-IN-MODULE (%SYMBOL-NAME SELF) STARTINGMODULE LOCAL?) NULL
          LOCAL? NULL)))
       (CL:COND ((CL:NOT (CL:EQ VALUE NULL)) VALUE)
        ((CL:NOT (CL:EQ MODULE *MODULE*))
         (COERCE-TO-INSTANCE-IN-MODULE (LOOKUP-SURROGATE-IN-MODULE (%SYMBOL-NAME SELF) *MODULE* LOCAL?) *MODULE* LOCAL?
          ORIGINAL))
    ...
    ((SUBTYPE-OF-KEYWORD? TEST-VALUE-000)
     (CL:PROGN (COERCE-TO-INSTANCE-IN-MODULE (WRAP-STRING (%SYMBOL-NAME SELF)) MODULE LOCAL? ORIGINAL)))
    ((SUBTYPE-OF? TEST-VALUE-000 SGT-FRAME-SUPPORT-STELLA-THING) (CL:PROGN SELF))
    ((SUBTYPE-OF? TEST-VALUE-000 SGT-FRAME-SUPPORT-LOGIC-PROPOSITION) (CL:PROGN SELF))
...
or surrogate.  If 'instanceRef' is a surrogate, the search originates
in the module the surrogate was interned in."
  (CL:LET* ((INSTANCE (COERCE-TO-INSTANCE-IN-MODULE INSTANCEREF NULL CL:NIL NULL)))
...
(CL:DEFUN COLLECTION? (OBJECTREF)
  ...
  (CL:LET* ((INSTANCE (GET-INSTANCE OBJECTREF))) (CL:WHEN (CL:EQ INSTANCE NULL) (CL:RETURN-FROM COLLECTION? CL:NIL))
   (CL:COND
    ((SUBTYPE-OF? (SAFE-PRIMARY-TYPE INSTANCE) SGT-FRAME-SUPPORT-LOGIC-LOGIC-OBJECT)
     (CL:PROGN (TEST-ISA? INSTANCE SGT-FRAME-SUPPORT-PL-KERNEL-KB-COLLECTION)))
    (CL:T CL:NIL))))
...
(CL:DEFUN CLASS? (OBJECTREF)
  ...
  (CL:LET* ((INSTANCE (GET-INSTANCE OBJECTREF)))
   (CL:IF (CL:EQ INSTANCE NULL) CL:NIL (TEST-ISA? INSTANCE SGT-FRAME-SUPPORT-PL-KERNEL-KB-CLASS))))
...
(CL:DEFUN RELATION? (OBJECTREF)
  "Return TRUE if 'objectRef' denotes a relation or a class."
  (CL:LET* ((INSTANCE (GET-INSTANCE OBJECTREF)))
   (CL:IF (CL:EQ INSTANCE NULL) CL:NIL (TEST-ISA? INSTANCE SGT-FRAME-SUPPORT-PL-KERNEL-KB-RELATION))))
   ...
   (CL:COND ((SUBTYPE-OF? TEST-VALUE-000 SGT-FRAME-SUPPORT-STELLA-LITERAL-WRAPPER) (CL:PROGN (PERMANENTIFY SELF)))
    ((SUBTYPE-OF-SURROGATE? TEST-VALUE-000)
     (CL:PROGN
      ...
      (%%PRINT-STREAM (%NATIVE-STREAM STANDARD-OUTPUT) "Can't termify the surrogate 'self' because it is undefined.")
      NULL))
    ((SUBTYPE-OF? TEST-VALUE-000 SGT-FRAME-SUPPORT-LOGIC-LOGIC-OBJECT) (CL:PROGN (VALUE-OF SELF)))
    ((SUBTYPE-OF? TEST-VALUE-000 SGT-FRAME-SUPPORT-STELLA-THING) (CL:PROGN SELF))
    (CL:T (%%PRINT-STREAM (%NATIVE-STREAM STANDARD-OUTPUT) "Can't 'termify': " SELF) NULL))))
...
(CL:DEFUN RELATION-ARITY-OK? (RELATIONREF ARITY)
  ...
  (CL:LET* ((RELATION (GET-DESCRIPTION RELATIONREF)))
   (CL:WHEN (CL:EQ RELATION NULL)
    (%%PRINT-STREAM (%NATIVE-STREAM STANDARD-OUTPUT) "Reference to undefined relation " (%SYMBOL-NAME RELATIONREF) EOL)
    (CL:RETURN-FROM RELATION-ARITY-OK? CL:NIL))
   (CL:WHEN (CL:NOT (CL:= (ARITY RELATION) ARITY))
    (%%PRINT-STREAM (%NATIVE-STREAM STANDARD-OUTPUT) "Error:  Relation " (%SYMBOL-NAME RELATIONREF) " has arity "
   ...
   (CL:LET* ((P NULL) (ITER-000 (ALL-TRUE-DEPENDENT-ISA-PROPOSITIONS SELF)))
    (CL:LOOP WHILE (NEXT? ITER-000) DO (CL:SETQ P (%VALUE ITER-000))
     (CL:LET* ((DESCRIPTION (GET-DESCRIPTION (%OPERATOR P))))
      (CL:WHEN (CL:NOT (MEMBER? TYPES DESCRIPTION)) (CL:SETQ TYPES (CONS DESCRIPTION TYPES))))))
   TYPES))
  ...
  (CL:LET* ((MEMO-TABLE-000 NULL) (MEMOIZED-ENTRY-000 NULL) (MEMOIZED-VALUE-000 NULL))
   (CL:WHEN *MEMOIZATION-ENABLED?*
    ...
    (CL:WHEN (CL:EQ MEMO-TABLE-000 NULL)
     (INITIALIZE-MEMOIZATION-TABLE SGT-FRAME-SUPPORT-LOGIC-F-ALL-TAXONOMIC-TYPES-MEMO-TABLE-000
...
satisfied by 'self'."
  (CL:LET* ((MEMO-TABLE-000 NULL) (MEMOIZED-ENTRY-000 NULL) (MEMOIZED-VALUE-000 NULL))
   (CL:WHEN *MEMOIZATION-ENABLED?*
    ...
    (CL:WHEN (CL:EQ MEMO-TABLE-000 NULL)
     (INITIALIZE-MEMOIZATION-TABLE SGT-FRAME-SUPPORT-LOGIC-F-ALL-TYPES-MEMO-TABLE-000
      "(:MAX-VALUES 500 :TIMESTAMPS (:KB-UPDATE))")
     (CL:SETQ MEMO-TABLE-000 (%SURROGATE-VALUE SGT-FRAME-SUPPORT-LOGIC-F-ALL-TYPES-MEMO-TABLE-000)))
    (CL:SETQ MEMOIZED-ENTRY-000 (LOOKUP-MRU-MEMOIZED-VALUE MEMO-TABLE-000 SELF *CONTEXT* MEMOIZED-NULL-VALUE NULL 2))
    (CL:SETQ MEMOIZED-VALUE-000 (%%VALUE MEMOIZED-ENTRY-000)))
       ...
       (CL:LET* ((C NULL) (ITER-001 (ALL-SUPERCOLLECTIONS D)))
        (CL:LOOP WHILE (NEXT? ITER-001) DO (CL:SETQ C (%VALUE ITER-001))
         (CL:WHEN (ISA? C SGT-FRAME-SUPPORT-LOGIC-NAMED-DESCRIPTION)
          (CL:WHEN (CL:NOT (MEMBER? TYPES C)) (PUSH TYPES C)))))
  ...
  (CL:LET* ((C NULL) (ITER-000 (ALL-DIRECT-SUBCOLLECTIONS SUPER CL:T)))
   (CL:LOOP WHILE (NEXT? ITER-000) DO (CL:SETQ C (%VALUE ITER-000))
    (CL:IF (ISA? C SGT-FRAME-SUPPORT-LOGIC-NAMED-DESCRIPTION)
     (CL:WHEN (CL:AND (CL:NOT (MEMBER? TYPES C)) (TEST-TYPE-ON-INSTANCE? SELF (%SURROGATE-VALUE-INVERSE C)))
      (INSERT-NEW TYPES C) (HELP-ALL-SUBTYPES C SELF TYPES))
...
(CL:DEFMETHOD LEVELLIZED-TEST-TYPE-ON-INSTANCE? ((LEVEL SUBSUMPTION-INFERENCE-LEVEL) SELF TYPE)
  (CL:LET* ((FOUND?-000 CL:NIL))
   (CL:LET* ((P NULL) (ITER-000 (ALL-TRUE-DEPENDENT-PROPOSITIONS SELF TYPE CL:T)))
    (CL:LOOP WHILE (NEXT? ITER-000) DO (CL:SETQ P (%VALUE ITER-000))
     (CL:WHEN (CL:EQ (%KIND P) KWD-FRAME-SUPPORT-ISA) (CL:SETQ FOUND?-000 CL:T) (CL:RETURN))))
...
If 'reflexive?', include 'relation' in the list."
  (CL:LET* ((MEMO-TABLE-000 NULL) (MEMOIZED-ENTRY-000 NULL) (MEMOIZED-VALUE-000 NULL))
   (CL:WHEN *MEMOIZATION-ENABLED?*
    ...
    (CL:WHEN (CL:EQ MEMO-TABLE-000 NULL)
     (INITIALIZE-MEMOIZATION-TABLE SGT-FRAME-SUPPORT-LOGIC-F-ALL-EQUIVALENT-RELATIONS-MEMO-TABLE-000
      "(:MAX-VALUES 500 :TIMESTAMPS (:META-KB-UPDATE))")
     (CL:SETQ MEMO-TABLE-000 (%SURROGATE-VALUE SGT-FRAME-SUPPORT-LOGIC-F-ALL-EQUIVALENT-RELATIONS-MEMO-TABLE-000)))
    (CL:SETQ MEMOIZED-ENTRY-000
     (LOOKUP-MRU-MEMOIZED-VALUE MEMO-TABLE-000 RELATION *CONTEXT* (CL:IF REFLEXIVE? TRUE-WRAPPER FALSE-WRAPPER)
   ...
   (CL:COND
    ((CL:NOT (CL:EQ MEMOIZED-VALUE-000 NULL))
     (CL:WHEN (CL:EQ MEMOIZED-VALUE-000 MEMOIZED-NULL-VALUE) (CL:SETQ MEMOIZED-VALUE-000 NULL)))
    (CL:T
     (CL:SETQ MEMOIZED-VALUE-000 (FILTER-OUT-UNNAMED-DESCRIPTIONS (ALL-EQUIVALENT-COLLECTIONS RELATION REFLEXIVE?)))
     (CL:WHEN *MEMOIZATION-ENABLED?*
      (CL:SETF (%%VALUE MEMOIZED-ENTRY-000)
       (CL:IF (CL:EQ MEMOIZED-VALUE-000 NULL) MEMOIZED-NULL-VALUE MEMOIZED-VALUE-000)))))
   (CL:LET* ((VALUE-000 MEMOIZED-VALUE-000)) VALUE-000)))
  ...
  (CL:WHEN (MEMBER? RELATIONSLIST RELATION)
   (CL:LET* ((M NULL) (ITER-000 (ALL-EQUIVALENT-RELATIONS RELATION CL:T)))
    (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-000 NIL)) DO (CL:SETQ M (%%VALUE ITER-000))
     (CL:SETQ RELATIONSLIST (REMOVE RELATIONSLIST M)) (CL:SETQ ITER-000 (%%REST ITER-000)))))
  RELATIONSLIST)
...
(CL:DEFUN ALL-SUPERRELATIONS (RELATION REMOVEEQUIVALENTS?)
  ...
  (CL:LET* ((MEMO-TABLE-000 NULL) (MEMOIZED-ENTRY-000 NULL) (MEMOIZED-VALUE-000 NULL))
   (CL:WHEN *MEMOIZATION-ENABLED?*
    ...
    (CL:WHEN (CL:EQ MEMO-TABLE-000 NULL)
     (INITIALIZE-MEMOIZATION-TABLE SGT-FRAME-SUPPORT-LOGIC-F-ALL-SUPERRELATIONS-MEMO-TABLE-000
      "(:MAX-VALUES 500 :TIMESTAMPS (:META-KB-UPDATE))")
     (CL:SETQ MEMO-TABLE-000 (%SURROGATE-VALUE SGT-FRAME-SUPPORT-LOGIC-F-ALL-SUPERRELATIONS-MEMO-TABLE-000)))
    (CL:SETQ MEMOIZED-ENTRY-000
     (LOOKUP-MRU-MEMOIZED-VALUE MEMO-TABLE-000 RELATION *CONTEXT* (CL:IF REMOVEEQUIVALENTS? TRUE-WRAPPER FALSE-WRAPPER)
      MEMOIZED-NULL-VALUE -1))
    (CL:SETQ MEMOIZED-VALUE-000 (%%VALUE MEMOIZED-ENTRY-000)))
   (CL:COND
    ((CL:NOT (CL:EQ MEMOIZED-VALUE-000 NULL))
...
relation."
  (CL:LET* ((MEMO-TABLE-000 NULL) (MEMOIZED-ENTRY-000 NULL) (MEMOIZED-VALUE-000 NULL))
   (CL:WHEN *MEMOIZATION-ENABLED?*
    ...
    (CL:WHEN (CL:EQ MEMO-TABLE-000 NULL)
     (INITIALIZE-MEMOIZATION-TABLE SGT-FRAME-SUPPORT-LOGIC-F-ALL-SUBRELATIONS-MEMO-TABLE-000
...
relations equivalent to 'relation'."
  (CL:LET* ((MEMO-TABLE-000 NULL) (MEMOIZED-ENTRY-000 NULL) (MEMOIZED-VALUE-000 NULL))
   (CL:WHEN *MEMOIZATION-ENABLED?*
    ...
    (CL:WHEN (CL:EQ MEMO-TABLE-000 NULL)
     (INITIALIZE-MEMOIZATION-TABLE SGT-FRAME-SUPPORT-LOGIC-F-ALL-DIRECT-SUPERRELATIONS-MEMO-TABLE-000
      "(:MAX-VALUES 500 :TIMESTAMPS (:META-KB-UPDATE))")
     (CL:SETQ MEMO-TABLE-000 (%SURROGATE-VALUE SGT-FRAME-SUPPORT-LOGIC-F-ALL-DIRECT-SUPERRELATIONS-MEMO-TABLE-000)))
    (CL:SETQ MEMOIZED-ENTRY-000
     (LOOKUP-MRU-MEMOIZED-VALUE MEMO-TABLE-000 RELATION *CONTEXT* (CL:IF REMOVEEQUIVALENTS? TRUE-WRAPPER FALSE-WRAPPER)
   ...
   (CL:COND
    ...
    (CL:T
     (CL:SETQ MEMOIZED-VALUE-000
      (FILTER-OUT-UNNAMED-DESCRIPTIONS (CONSIFY (ALL-DIRECT-SUPERCOLLECTIONS RELATION REMOVEEQUIVALENTS?))))
     (CL:WHEN *MEMOIZATION-ENABLED?*
      (CL:SETF (%%VALUE MEMOIZED-ENTRY-000)
       (CL:IF (CL:EQ MEMOIZED-VALUE-000 NULL) MEMOIZED-NULL-VALUE MEMOIZED-VALUE-000)))))
   (CL:LET* ((VALUE-000 MEMOIZED-VALUE-000)) VALUE-000)))
...
relations equivalent to 'relation'."
  (CL:LET* ((MEMO-TABLE-000 NULL) (MEMOIZED-ENTRY-000 NULL) (MEMOIZED-VALUE-000 NULL))
   (CL:WHEN *MEMOIZATION-ENABLED?*
    ...
    (CL:WHEN (CL:EQ MEMO-TABLE-000 NULL)
     (INITIALIZE-MEMOIZATION-TABLE SGT-FRAME-SUPPORT-LOGIC-F-ALL-DIRECT-SUBRELATIONS-MEMO-TABLE-000
      "(:MAX-VALUES 500 :TIMESTAMPS (:META-KB-UPDATE))")
     (CL:SETQ MEMO-TABLE-000 (%SURROGATE-VALUE SGT-FRAME-SUPPORT-LOGIC-F-ALL-DIRECT-SUBRELATIONS-MEMO-TABLE-000)))
    (CL:SETQ MEMOIZED-ENTRY-000
     (LOOKUP-MRU-MEMOIZED-VALUE MEMO-TABLE-000 RELATION *CONTEXT* (CL:IF REMOVEEQUIVALENTS? TRUE-WRAPPER FALSE-WRAPPER)
   ...
   (CL:COND
    ...
    (CL:T
     (CL:SETQ MEMOIZED-VALUE-000
      (FILTER-OUT-UNNAMED-DESCRIPTIONS (CONSIFY (ALL-DIRECT-SUBCOLLECTIONS RELATION REMOVEEQUIVALENTS?))))
     (CL:WHEN *MEMOIZATION-ENABLED?*
      (CL:SETF (%%VALUE MEMOIZED-ENTRY-000)
       (CL:IF (CL:EQ MEMOIZED-VALUE-000 NULL) MEMOIZED-NULL-VALUE MEMOIZED-VALUE-000)))))
   (CL:LET* ((VALUE-000 MEMOIZED-VALUE-000)) VALUE-000)))
...
(CL:DEFMETHOD LEVELLIZED-ALL-CLASS-INSTANCES ((LEVEL SUBSUMPTION-INFERENCE-LEVEL) TYPE)
  (CL:LET* ((MEMBERS NIL))
   (CL:LET* ((M NULL) (ITER-000 (%THE-CONS-LIST (ASSERTED-COLLECTION-MEMBERS (GET-DESCRIPTION TYPE) CL:NIL))))
    (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-000 NIL)) DO (CL:SETQ M (%%VALUE ITER-000)) (CL:SETQ MEMBERS (CONS M MEMBERS))
     (CL:SETQ ITER-000 (%%REST ITER-000))))
   MEMBERS))
...
(CL:DEFMETHOD LEVELLIZED-ALL-CLASS-INSTANCES ((LEVEL ASSERTION-INFERENCE-LEVEL) TYPE)
  (CL:LET* ((MEMBERS NIL))
   (CL:LET* ((M NULL) (ITER-000 (%THE-CONS-LIST (ASSERTED-COLLECTION-MEMBERS (GET-DESCRIPTION TYPE) CL:T))))
    (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-000 NIL)) DO (CL:SETQ M (%%VALUE ITER-000))
     (CL:WHEN (LEVELLIZED-TEST-TYPE-ON-INSTANCE? LEVEL M TYPE) (CL:SETQ MEMBERS (CONS M MEMBERS)))
     (CL:SETQ ITER-000 (%%REST ITER-000))))
   MEMBERS))
...
'relation' (a surrogate) applied to 'nMinusOneArguments' plus that last value."
  (CL:WHEN (CL:NOT (RELATION-ARITY-OK? RELATION (CL:1+ (LENGTH NMINUSONEARGUMENTS))))
...
(CL:DEFMETHOD LEVELLIZED-ALL-RELATION-VALUES ((LEVEL SUBSUMPTION-INFERENCE-LEVEL) RELATION NMINUSONEARGUMENTS)
  (CL:LET* ((VALUES NIL))
   (CL:LET*
    ((P NULL)
     (ITER-000 (ALL-PROPOSITIONS-MATCHING-ARGUMENTS NMINUSONEARGUMENTS RELATION (CL:EQ LEVEL SUBSUMPTION-INFERENCE))))
...
(CL:DEFMETHOD LEVELLIZED-TEST-RELATION-ON-ARGUMENTS? ((LEVEL SUBSUMPTION-INFERENCE-LEVEL) RELATION ARGUMENTS)
  (CL:LET* ((FOUND?-000 CL:NIL))
   (CL:LET*
    ((P
      (ALLOCATE-ITERATOR
       (ALL-PROPOSITIONS-MATCHING-ARGUMENTS ARGUMENTS RELATION (CL:EQ LEVEL SUBSUMPTION-INFERENCE)))))
...
(CL:DEFMETHOD LEVELLIZED-GET-SLOT-MINIMUM-CARDINALITY ((LEVEL SHALLOW-INFERENCE-LEVEL) SELF RELATION)
  (CL:LET*
   ((DESCRIPTION (GET-DESCRIPTION RELATION))
    (MINCARDINALITY
     (%%VALUE (ALL-RELATION-VALUES SGT-FRAME-SUPPORT-PL-KERNEL-KB-RANGE-MIN-CARDINALITY (CONS-LIST DESCRIPTION SELF))))
    (FILLERCOUNT (LENGTH (ALL-SLOT-VALUES SELF RELATION))))
   (CL:DECLARE (CL:TYPE CL:FIXNUM FILLERCOUNT))
   (CL:WHEN (CL:EQ MINCARDINALITY NULL) (CL:SETQ MINCARDINALITY (WRAP-INTEGER 0)))
...
(CL:DEFMETHOD LEVELLIZED-GET-SLOT-MINIMUM-CARDINALITY ((LEVEL SUBSUMPTION-INFERENCE-LEVEL) SELF RELATION)
  (CL:LET* ((MINCARDINALITY (LEVELLIZED-GET-SLOT-MINIMUM-CARDINALITY SHALLOW-INFERENCE SELF RELATION)))
   ...
   (CL:LET* ((SUBDESCRIPTION NULL) (ITER-000 (ALL-SUBRELATIONS (GET-DESCRIPTION RELATION) CL:NIL)))
    (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-000 NIL)) DO (CL:SETQ SUBDESCRIPTION (%%VALUE ITER-000))
     (CL:LET*
      ((SUBMINCARDINALITY
        (%%VALUE
         (ALL-RELATION-VALUES SGT-FRAME-SUPPORT-PL-KERNEL-KB-RANGE-MIN-CARDINALITY (CONS-LIST SUBDESCRIPTION SELF)))))
      (CL:WHEN (CL:NOT (CL:EQ SUBMINCARDINALITY NULL))
       (CL:SETQ MINCARDINALITY (MAX MINCARDINALITY (%WRAPPER-VALUE SUBMINCARDINALITY)))))
     (CL:SETQ ITER-000 (%%REST ITER-000))))
   MINCARDINALITY))
...
(CL:DEFMETHOD LEVELLIZED-GET-SLOT-MAXIMUM-CARDINALITY ((LEVEL SHALLOW-INFERENCE-LEVEL) SELF RELATION)
  (CL:LET*
   ((DESCRIPTION (GET-DESCRIPTION RELATION))
    (MAXCARDINALITY
     (%%VALUE (ALL-RELATION-VALUES SGT-FRAME-SUPPORT-PL-KERNEL-KB-RANGE-MAX-CARDINALITY (CONS-LIST DESCRIPTION SELF))))
    (FILLERCOUNT NULL-INTEGER))
   (CL:DECLARE (CL:TYPE CL:FIXNUM FILLERCOUNT))
   (CL:COND ((TEST-CLOSED-SLOT? RELATION) (CL:SETQ FILLERCOUNT (LENGTH (ALL-SLOT-VALUES SELF RELATION))))
...
(CL:DEFMETHOD LEVELLIZED-GET-SLOT-MAXIMUM-CARDINALITY ((LEVEL SUBSUMPTION-INFERENCE-LEVEL) SELF RELATION)
  (CL:LET* ((MAXCARDINALITY (LEVELLIZED-GET-SLOT-MAXIMUM-CARDINALITY SHALLOW-INFERENCE SELF RELATION)))
   ...
   (CL:LET* ((SUPERDESCRIPTION NULL) (ITER-000 (ALL-SUPERRELATIONS (GET-DESCRIPTION RELATION) CL:NIL)))
    (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-000 NIL)) DO (CL:SETQ SUPERDESCRIPTION (%%VALUE ITER-000))
     (CL:LET*
      ((SUPERMAXCARDINALITY
        (%%VALUE
         (ALL-RELATION-VALUES SGT-FRAME-SUPPORT-PL-KERNEL-KB-RANGE-MAX-CARDINALITY
          (CONS-LIST SUPERDESCRIPTION SELF)))))
      (CL:WHEN (CL:NOT (CL:EQ SUPERMAXCARDINALITY NULL))
       (CL:IF (CL:NOT (CL:= MAXCARDINALITY NULL-INTEGER))
        (CL:SETQ MAXCARDINALITY (MIN MAXCARDINALITY (%WRAPPER-VALUE SUPERMAXCARDINALITY)))
...
(CL:DEFMETHOD LEVELLIZED-ALL-SLOT-VALUE-TYPES ((LEVEL SHALLOW-INFERENCE-LEVEL) SELF RELATION)
  (CL:LET*
   ((DESCRIPTION (GET-DESCRIPTION RELATION))
    (VALUETYPES (ALL-RELATION-VALUES SGT-FRAME-SUPPORT-PL-KERNEL-KB-RANGE-TYPE (CONS-LIST DESCRIPTION SELF))))
      ...
      (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-000 NIL)) DO (CL:SETQ F (%%VALUE ITER-000))
       (CL:LET* ((D NULL) (ITER-001 (ALL-ASSERTED-TYPES F)))
        (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-001 NIL)) DO (CL:SETQ D (%%VALUE ITER-001))
         (CL:WHEN (CL:NOT (MEMBER? POSSIBLETYPES D)) (CL:SETQ POSSIBLETYPES (CONS D POSSIBLETYPES)))
         ...
         (CL:LET* ((ALWAYS?-000 CL:T))
          (CL:LET* ((F NULL) (ITER-003 FILLERS))
           (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-003 NIL)) DO (CL:SETQ F (%%VALUE ITER-003))
            (CL:WHEN (CL:NOT (TEST-TYPE-ON-INSTANCE? F (%SURROGATE-VALUE-INVERSE D))) (CL:SETQ ALWAYS?-000 CL:NIL)
             (CL:RETURN))
  ...
  (CL:LET* ((VALUETYPES (LEVELLIZED-ALL-SLOT-VALUE-TYPES SHALLOW-INFERENCE SELF RELATION)))
   (CL:LET* ((SUPERRELATION NULL) (ITER-000 (ALL-SUPERRELATIONS (GET-DESCRIPTION RELATION) CL:NIL)))
    (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-000 NIL)) DO (CL:SETQ SUPERRELATION (%%VALUE ITER-000))
     (CL:LET*
      ((SUPERTYPE NULL)
       (ITER-001 (ALL-RELATION-VALUES SGT-FRAME-SUPPORT-PL-KERNEL-KB-RANGE-TYPE (CONS-LIST SUPERRELATION SELF))))
      (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-001 NIL)) DO (CL:SETQ SUPERTYPE (%%VALUE ITER-001))
       (CL:WHEN (CL:NOT (MEMBER? VALUETYPES SUPERTYPE)) (CL:SETQ VALUETYPES (CONS SUPERTYPE VALUETYPES)))
       (CL:SETQ ITER-001 (%%REST ITER-001))))
     (CL:SETQ ITER-000 (%%REST ITER-000))))
   (FILTER-OUT-UNNAMED-DESCRIPTIONS VALUETYPES)))
...
(CL:DEFMETHOD LEVELLIZED-TEST-TYPE-ON-INSTANCE? ((LEVEL NORMAL-INFERENCE-LEVEL) SELF TYPE)
  (CL:WHEN (CL:NOT *LEVELLIZED-BACKCHAINING-ENABLED?*)
   (CL:RETURN-FROM LEVELLIZED-TEST-TYPE-ON-INSTANCE?
...
(CL:DEFMETHOD LEVELLIZED-ALL-CLASS-INSTANCES ((LEVEL NORMAL-INFERENCE-LEVEL) TYPE)
  (CL:WHEN (CL:NOT *LEVELLIZED-BACKCHAINING-ENABLED?*)
   (CL:RETURN-FROM LEVELLIZED-ALL-CLASS-INSTANCES (LEVELLIZED-ALL-CLASS-INSTANCES SUBSUMPTION-INFERENCE TYPE)))
  (APPLY-CACHED-RETRIEVE (LIST* SYM-FRAME-SUPPORT-LOGIC-?CONCEPT SYM-FRAME-SUPPORT-LOGIC-?X NIL)
   (LIST* SYM-FRAME-SUPPORT-LOGIC-?CONCEPT SYM-FRAME-SUPPORT-LOGIC-?X NIL) (CONS-LIST TYPE NULL) (CONS-LIST)
...
(CL:DEFMETHOD LEVELLIZED-ALL-RELATION-VALUES ((LEVEL NORMAL-INFERENCE-LEVEL) RELATION NMINUSONEARGUMENTS)
  (CL:WHEN (CL:NOT *LEVELLIZED-BACKCHAINING-ENABLED?*)
   (CL:RETURN-FROM LEVELLIZED-ALL-RELATION-VALUES
    (LEVELLIZED-ALL-RELATION-VALUES SUBSUMPTION-INFERENCE RELATION NMINUSONEARGUMENTS)))
  (CL:CASE (LENGTH NMINUSONEARGUMENTS)
   ...
   (1
    (CL:LET* ((ARG1 (%%VALUE NMINUSONEARGUMENTS)))
     (APPLY-CACHED-RETRIEVE
      (LIST* SYM-FRAME-SUPPORT-LOGIC-?RELATION SYM-FRAME-SUPPORT-LOGIC-?X SYM-FRAME-SUPPORT-LOGIC-?Y NIL)
      (LIST* SYM-FRAME-SUPPORT-LOGIC-?RELATION SYM-FRAME-SUPPORT-LOGIC-?X SYM-FRAME-SUPPORT-LOGIC-?Y NIL)
   ...
   (2
    (CL:LET* ((ARG1 (%%VALUE NMINUSONEARGUMENTS)) (ARG2 (%%VALUE (%%REST NMINUSONEARGUMENTS))))
     (APPLY-CACHED-RETRIEVE
      (LIST* SYM-FRAME-SUPPORT-LOGIC-?RELATION SYM-FRAME-SUPPORT-LOGIC-?X SYM-FRAME-SUPPORT-LOGIC-?Y
   ...
   (3
    (CL:LET*
     ((ARG1 (%%VALUE NMINUSONEARGUMENTS)) (ARG2 (%%VALUE (%%REST NMINUSONEARGUMENTS)))
      (ARG3 (%%VALUE (%%REST (%%REST NMINUSONEARGUMENTS)))))
     (APPLY-CACHED-RETRIEVE
      (LIST* SYM-FRAME-SUPPORT-LOGIC-?RELATION SYM-FRAME-SUPPORT-LOGIC-?W SYM-FRAME-SUPPORT-LOGIC-?X
    ...
    (CONSIFY
     (CALL-RETRIEVE
      (LIST* SYM-FRAME-SUPPORT-LOGIC-ALL SYM-FRAME-SUPPORT-LOGIC-?X
       (CONS (INTERN-SYMBOL-IN-MODULE (%SYMBOL-NAME RELATION) (%HOME-CONTEXT RELATION) CL:NIL)
        (CONCATENATE NMINUSONEARGUMENTS (CONS SYM-FRAME-SUPPORT-LOGIC-?X NIL)))
       NIL))))))
...
(CL:DEFMETHOD LEVELLIZED-TEST-RELATION-ON-ARGUMENTS? ((LEVEL NORMAL-INFERENCE-LEVEL) RELATION ARGUMENTS)
  (CL:WHEN (CL:NOT *LEVELLIZED-BACKCHAINING-ENABLED?*)
   (CL:RETURN-FROM LEVELLIZED-TEST-RELATION-ON-ARGUMENTS?
    (LEVELLIZED-TEST-RELATION-ON-ARGUMENTS? SUBSUMPTION-INFERENCE RELATION ARGUMENTS)))
  (CL:CASE (LENGTH ARGUMENTS)
   (1
    (CL:LET* ((ARG1 (%%VALUE ARGUMENTS)))
     (APPLY-CACHED-ASK (LIST* SYM-FRAME-SUPPORT-LOGIC-?RELATION SYM-FRAME-SUPPORT-LOGIC-?X NIL)
      (LIST* SYM-FRAME-SUPPORT-LOGIC-?RELATION SYM-FRAME-SUPPORT-LOGIC-?X NIL) (CONS-LIST RELATION ARG1) (CONS-LIST)
   ...
   (3
    (CL:LET*
     ((ARG1 (%%VALUE ARGUMENTS)) (ARG2 (%%VALUE (%%REST ARGUMENTS))) (ARG3 (%%VALUE (%%REST (%%REST ARGUMENTS)))))
     (APPLY-CACHED-ASK
      (LIST* SYM-FRAME-SUPPORT-LOGIC-?RELATION SYM-FRAME-SUPPORT-LOGIC-?X SYM-FRAME-SUPPORT-LOGIC-?Y NIL)
      (LIST* SYM-FRAME-SUPPORT-LOGIC-?RELATION SYM-FRAME-SUPPORT-LOGIC-?X SYM-FRAME-SUPPORT-LOGIC-?Y NIL)
...
(CL:DEFMETHOD LEVELLIZED-GET-SLOT-MINIMUM-CARDINALITY ((LEVEL NORMAL-INFERENCE-LEVEL) SELF RELATION)
  (CL:WHEN (CL:NOT *LEVELLIZED-BACKCHAINING-ENABLED?*)
   (CL:RETURN-FROM LEVELLIZED-GET-SLOT-MINIMUM-CARDINALITY
    (LEVELLIZED-GET-SLOT-MINIMUM-CARDINALITY SUBSUMPTION-INFERENCE SELF RELATION)))
  (CL:LET*
   ((N
     (APPLY-CACHED-RETRIEVE
      (LIST* SYM-FRAME-SUPPORT-LOGIC-?RELATION SYM-FRAME-SUPPORT-LOGIC-?OBJECT SYM-FRAME-SUPPORT-LOGIC-?N NIL)
      (LIST* SYM-FRAME-SUPPORT-LOGIC-RANGE-MIN-CARDINALITY SYM-FRAME-SUPPORT-LOGIC-?RELATION
...
(CL:DEFMETHOD LEVELLIZED-GET-SLOT-MAXIMUM-CARDINALITY ((LEVEL NORMAL-INFERENCE-LEVEL) SELF RELATION)
  (CL:WHEN (CL:NOT *LEVELLIZED-BACKCHAINING-ENABLED?*)
   (CL:RETURN-FROM LEVELLIZED-GET-SLOT-MAXIMUM-CARDINALITY
    (LEVELLIZED-GET-SLOT-MAXIMUM-CARDINALITY SUBSUMPTION-INFERENCE SELF RELATION)))
  (CL:LET*
   ((N
     (APPLY-CACHED-RETRIEVE
      (LIST* SYM-FRAME-SUPPORT-LOGIC-?RELATION SYM-FRAME-SUPPORT-LOGIC-?OBJECT SYM-FRAME-SUPPORT-LOGIC-?N NIL)
      (LIST* SYM-FRAME-SUPPORT-LOGIC-RANGE-MAX-CARDINALITY SYM-FRAME-SUPPORT-LOGIC-?RELATION
       SYM-FRAME-SUPPORT-LOGIC-?OBJECT SYM-FRAME-SUPPORT-LOGIC-?N NIL)
      (CONS-LIST RELATION SELF NULL) (CONS-LIST)
...
(CL:DEFMETHOD LEVELLIZED-ALL-SLOT-VALUE-TYPES ((LEVEL NORMAL-INFERENCE-LEVEL) SELF RELATION)
  (CL:WHEN (CL:NOT *LEVELLIZED-BACKCHAINING-ENABLED?*)
   (CL:RETURN-FROM LEVELLIZED-ALL-SLOT-VALUE-TYPES
    (LEVELLIZED-ALL-SLOT-VALUE-TYPES SUBSUMPTION-INFERENCE SELF RELATION)))
  (APPLY-CACHED-RETRIEVE
   (LIST* SYM-FRAME-SUPPORT-LOGIC-?RELATION SYM-FRAME-SUPPORT-LOGIC-?OBJECT SYM-FRAME-SUPPORT-LOGIC-?TYPE NIL)
   (LIST* SYM-FRAME-SUPPORT-STELLA-AND
    (LIST* SYM-FRAME-SUPPORT-LOGIC-RANGE-TYPE SYM-FRAME-SUPPORT-LOGIC-?RELATION SYM-FRAME-SUPPORT-LOGIC-?OBJECT
     SYM-FRAME-SUPPORT-LOGIC-?TYPE NIL)
    (LIST* SYM-FRAME-SUPPORT-LOGIC-BOUND-VARIABLES SYM-FRAME-SUPPORT-LOGIC-?TYPE NIL)
    (LIST* SYM-FRAME-SUPPORT-LOGIC-CONCEPT SYM-FRAME-SUPPORT-LOGIC-?TYPE NIL) NIL)
   (CONS-LIST RELATION SELF NULL) (CONS-LIST)
...
(CL:DEFUN HELP-STARTUP-FRAME-SUPPORT1 ()
  (CL:PROGN (CL:SETQ SYM-FRAME-SUPPORT-LOGIC-OBJECT-STORE (INTERN-RIGID-SYMBOL-WRT-MODULE "OBJECT-STORE" NULL 0))
   ...
   (CL:SETQ SGT-FRAME-SUPPORT-PL-KERNEL-KB-SCALAR
    (INTERN-RIGID-SYMBOL-WRT-MODULE "SCALAR" (GET-STELLA-MODULE "/PL-KERNEL-KB" CL:T) 1))
   ...
   (CL:SETQ SGT-FRAME-SUPPORT-LOGIC-F-ALL-TAXONOMIC-TYPES-MEMO-TABLE-000
    (INTERN-RIGID-SYMBOL-WRT-MODULE "F-ALL-TAXONOMIC-TYPES-MEMO-TABLE-000" NULL 1))
   (CL:SETQ SGT-FRAME-SUPPORT-LOGIC-F-ALL-TYPES-MEMO-TABLE-000
    (INTERN-RIGID-SYMBOL-WRT-MODULE "F-ALL-TYPES-MEMO-TABLE-000" NULL 1))
   (CL:SETQ KWD-FRAME-SUPPORT-ISA (INTERN-RIGID-SYMBOL-WRT-MODULE "ISA" NULL 2))
   (CL:SETQ SGT-FRAME-SUPPORT-LOGIC-F-ALL-EQUIVALENT-RELATIONS-MEMO-TABLE-000
    (INTERN-RIGID-SYMBOL-WRT-MODULE "F-ALL-EQUIVALENT-RELATIONS-MEMO-TABLE-000" NULL 1))
   (CL:SETQ SGT-FRAME-SUPPORT-LOGIC-F-ALL-SUPERRELATIONS-MEMO-TABLE-000
    (INTERN-RIGID-SYMBOL-WRT-MODULE "F-ALL-SUPERRELATIONS-MEMO-TABLE-000" NULL 1))
   (CL:SETQ SGT-FRAME-SUPPORT-LOGIC-F-ALL-SUBRELATIONS-MEMO-TABLE-000
    (INTERN-RIGID-SYMBOL-WRT-MODULE "F-ALL-SUBRELATIONS-MEMO-TABLE-000" NULL 1))
   (CL:SETQ SGT-FRAME-SUPPORT-LOGIC-F-ALL-DIRECT-SUPERRELATIONS-MEMO-TABLE-000
    (INTERN-RIGID-SYMBOL-WRT-MODULE "F-ALL-DIRECT-SUPERRELATIONS-MEMO-TABLE-000" NULL 1))
   (CL:SETQ SGT-FRAME-SUPPORT-LOGIC-F-ALL-DIRECT-SUBRELATIONS-MEMO-TABLE-000
    (INTERN-RIGID-SYMBOL-WRT-MODULE "F-ALL-DIRECT-SUBRELATIONS-MEMO-TABLE-000" NULL 1))
   (CL:SETQ SGT-FRAME-SUPPORT-PL-KERNEL-KB-RANGE-MIN-CARDINALITY
    (INTERN-RIGID-SYMBOL-WRT-MODULE "RANGE-MIN-CARDINALITY" (GET-STELLA-MODULE "/PL-KERNEL-KB" CL:T) 1))
   (CL:SETQ SGT-FRAME-SUPPORT-PL-KERNEL-KB-RANGE-MAX-CARDINALITY
    (INTERN-RIGID-SYMBOL-WRT-MODULE "RANGE-MAX-CARDINALITY" (GET-STELLA-MODULE "/PL-KERNEL-KB" CL:T) 1))
   (CL:SETQ SGT-FRAME-SUPPORT-PL-KERNEL-KB-RANGE-TYPE
    (INTERN-RIGID-SYMBOL-WRT-MODULE "RANGE-TYPE" (GET-STELLA-MODULE "/PL-KERNEL-KB" CL:T) 1))
   ...
   (CL:SETQ SYM-FRAME-SUPPORT-LOGIC-M-NORMAL-INFERENCE-LEVEL.LEVELLIZED-TEST-RELATION-ON-ARGUMENTS?-QUERY-000
    (INTERN-RIGID-SYMBOL-WRT-MODULE "M-NORMAL-INFERENCE-LEVEL.LEVELLIZED-TEST-RELATION-ON-ARGUMENTS?-QUERY-000" NULL
     0))
   (CL:SETQ SYM-FRAME-SUPPORT-LOGIC-M-NORMAL-INFERENCE-LEVEL.LEVELLIZED-TEST-RELATION-ON-ARGUMENTS?-QUERY-001
    (INTERN-RIGID-SYMBOL-WRT-MODULE "M-NORMAL-INFERENCE-LEVEL.LEVELLIZED-TEST-RELATION-ON-ARGUMENTS?-QUERY-001" NULL
     0))
   (CL:SETQ SYM-FRAME-SUPPORT-LOGIC-M-NORMAL-INFERENCE-LEVEL.LEVELLIZED-TEST-RELATION-ON-ARGUMENTS?-QUERY-002
    (INTERN-RIGID-SYMBOL-WRT-MODULE "M-NORMAL-INFERENCE-LEVEL.LEVELLIZED-TEST-RELATION-ON-ARGUMENTS?-QUERY-002" NULL
     0))
   (CL:SETQ SYM-FRAME-SUPPORT-LOGIC-M-NORMAL-INFERENCE-LEVEL.LEVELLIZED-TEST-RELATION-ON-ARGUMENTS?-QUERY-003
    (INTERN-RIGID-SYMBOL-WRT-MODULE "M-NORMAL-INFERENCE-LEVEL.LEVELLIZED-TEST-RELATION-ON-ARGUMENTS?-QUERY-003" NULL
     0))
   ...
   (CL:SETQ SYM-FRAME-SUPPORT-LOGIC-M-NORMAL-INFERENCE-LEVEL.LEVELLIZED-GET-SLOT-MINIMUM-CARDINALITY-QUERY-000
    (INTERN-RIGID-SYMBOL-WRT-MODULE "M-NORMAL-INFERENCE-LEVEL.LEVELLIZED-GET-SLOT-MINIMUM-CARDINALITY-QUERY-000" NULL
     0))
   ...
   (CL:SETQ SYM-FRAME-SUPPORT-LOGIC-M-NORMAL-INFERENCE-LEVEL.LEVELLIZED-GET-SLOT-MAXIMUM-CARDINALITY-QUERY-000
    (INTERN-RIGID-SYMBOL-WRT-MODULE "M-NORMAL-INFERENCE-LEVEL.LEVELLIZED-GET-SLOT-MAXIMUM-CARDINALITY-QUERY-000" NULL
     0))
...
that can be passed as an argument wherever an instance is expected.\")" (CL:FUNCTION TERMIFY) NULL)
   (DEFINE-FUNCTION-OBJECT "RELATION-ARITY-OK?"
    "(DEFUN (RELATION-ARITY-OK? BOOLEAN) ((RELATIONREF SURROGATE) (ARITY INTEGER)))" (CL:FUNCTION RELATION-ARITY-OK?)
    NULL)
...
satisfied by 'self'.\" :PUBLIC? TRUE)" (CL:FUNCTION ALL-TYPES) NULL)
   ...
   (DEFINE-FUNCTION-OBJECT "HELP-ALL-SUBTYPES"
    "(DEFUN HELP-ALL-SUBTYPES ((SUPER DESCRIPTION) (SELF OBJECT) (TYPES LIST)))" (CL:FUNCTION HELP-ALL-SUBTYPES) NULL)
...
'relation' (a surrogate) applied to 'nMinusOneArguments' plus that last value.\")" (CL:FUNCTION ALL-RELATION-VALUES)
    NULL)
   (DEFINE-METHOD-OBJECT
...
(CL:DEFUN STARTUP-FRAME-SUPPORT ()
  (CL:LET* ((*MODULE* (GET-STELLA-MODULE "/LOGIC" (> *STARTUP-TIME-PHASE* 1))) (*CONTEXT* *MODULE*))
   (CL:DECLARE (CL:SPECIAL *MODULE* *CONTEXT*)) (CL:WHEN (CURRENT-STARTUP-TIME-PHASE? 2) (HELP-STARTUP-FRAME-SUPPORT1))
   ...
   (CL:WHEN (CURRENT-STARTUP-TIME-PHASE? 7) (HELP-STARTUP-FRAME-SUPPORT2)
    ...
    (DEFINE-METHOD-OBJECT
     ...
     (CL:FUNCTION LEVELLIZED-ALL-SLOT-VALUE-TYPES) NULL)
    (DEFINE-FUNCTION-OBJECT "STARTUP-FRAME-SUPPORT" "(DEFUN STARTUP-FRAME-SUPPORT () :PUBLIC? TRUE)"
     (CL:FUNCTION STARTUP-FRAME-SUPPORT) NULL)
    (CL:LET* ((FUNCTION (LOOKUP-FUNCTION SYM-FRAME-SUPPORT-LOGIC-STARTUP-FRAME-SUPPORT)))
     (SET-DYNAMIC-SLOT-VALUE (%DYNAMIC-SLOTS FUNCTION) SYM-FRAME-SUPPORT-STELLA-METHOD-STARTUP-CLASSNAME
   ...
   (CL:WHEN (CURRENT-STARTUP-TIME-PHASE? 9) (%IN-MODULE (COPY-CONS-TREE (WRAP-STRING "LOGIC")))
    (REGISTER-NATIVE-NAME SYM-FRAME-SUPPORT-LOGIC-FIND-INSTANCE KWD-FRAME-SUPPORT-COMMON-LISP
     KWD-FRAME-SUPPORT-FUNCTION)
