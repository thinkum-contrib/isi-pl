...
(CL:DEFVAR SGT-FRAME-SUPPORT-LOGIC-ALL-TYPES-MEMO-TABLE-000 NULL)
...
satisfied by 'self'."
  (CL:LET*
   ((MEMO-TABLE-000
     (%SURROGATE-VALUE SGT-FRAME-SUPPORT-LOGIC-ALL-TYPES-MEMO-TABLE-000))
    (MEMOIZED-ENTRY-000 NULL) (MEMOIZED-VALUE-000 NULL))
   (CL:WHEN (CL:EQ MEMO-TABLE-000 NULL)
    (INITIALIZE-MEMOIZATION-TABLE
     SGT-FRAME-SUPPORT-LOGIC-ALL-TYPES-MEMO-TABLE-000
...
(CL:DEFMETHOD LEVELLIZED-TEST-TYPE-ON-INSTANCE? ((LEVEL SHALLOW-INFERENCE-LEVEL) SELF TYPE)
  (CL:LET* ((FOUND?-000 FALSE))
   (CL:LET*
    ((P NULL) (ITER-000 (ALL-TRUE-DEPENDENT-PROPOSITIONS SELF TYPE FALSE)))
    (CL:LOOP WHILE (NEXT? ITER-000) DO (CL:SETQ P (%VALUE ITER-000))
     (CL:WHEN (CL:EQ (%KIND P) KWD-FRAME-SUPPORT-ISA)
      (CL:SETQ FOUND?-000 TRUE) (CL:RETURN))))
   (CL:LET* ((VALUE-000 FOUND?-000)) VALUE-000)))
...
(CL:DEFUN HELP-STARTUP-FRAME-SUPPORT1 ()
  (CL:PROGN
   ...
   (CL:SETQ SGT-FRAME-SUPPORT-LOGIC-ALL-TYPES-MEMO-TABLE-000
    (INTERN-RIGID-SYMBOL-WRT-MODULE "ALL-TYPES-MEMO-TABLE-000" NULL 1))
   (CL:SETQ KWD-FRAME-SUPPORT-ISA
    (INTERN-RIGID-SYMBOL-WRT-MODULE "ISA" NULL 2))
   (CL:SETQ SGT-FRAME-SUPPORT-LOGIC-ALL-EQUIVALENT-RELATIONS-MEMO-TABLE-000
    (INTERN-RIGID-SYMBOL-WRT-MODULE "ALL-EQUIVALENT-RELATIONS-MEMO-TABLE-000"
     NULL 1))
   (CL:SETQ SGT-FRAME-SUPPORT-LOGIC-ALL-SUPERRELATIONS-MEMO-TABLE-000
    (INTERN-RIGID-SYMBOL-WRT-MODULE "ALL-SUPERRELATIONS-MEMO-TABLE-000" NULL
     1))
   (CL:SETQ SGT-FRAME-SUPPORT-LOGIC-ALL-SUBRELATIONS-MEMO-TABLE-000
    (INTERN-RIGID-SYMBOL-WRT-MODULE "ALL-SUBRELATIONS-MEMO-TABLE-000" NULL 1))
   (CL:SETQ SGT-FRAME-SUPPORT-LOGIC-ALL-DIRECT-SUPERRELATIONS-MEMO-TABLE-000
    (INTERN-RIGID-SYMBOL-WRT-MODULE "ALL-DIRECT-SUPERRELATIONS-MEMO-TABLE-000"
     NULL 1))
   (CL:SETQ SGT-FRAME-SUPPORT-LOGIC-ALL-DIRECT-SUBRELATIONS-MEMO-TABLE-000
    (INTERN-RIGID-SYMBOL-WRT-MODULE "ALL-DIRECT-SUBRELATIONS-MEMO-TABLE-000"
     NULL 1))
