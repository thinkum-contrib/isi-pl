...
(CL:DEFVAR SGT-FRAME-SUPPORT-LOGIC-COLLECTION?-MEMO-TABLE-000 NULL)
(CL:DEFVAR SGT-FRAME-SUPPORT-PL-KERNEL-KB-CLASS NULL)
(CL:DEFVAR SGT-FRAME-SUPPORT-LOGIC-CLASS?-MEMO-TABLE-000 NULL)
(CL:DEFVAR SGT-FRAME-SUPPORT-PL-KERNEL-KB-RELATION NULL)
(CL:DEFVAR SGT-FRAME-SUPPORT-LOGIC-RELATION?-MEMO-TABLE-000 NULL)
(CL:DEFVAR SGT-FRAME-SUPPORT-PL-KERNEL-KB-FUNCTION NULL)
(CL:DEFVAR SGT-FRAME-SUPPORT-LOGIC-FUNCTION?-MEMO-TABLE-000 NULL)
...
(CL:DEFVAR SGT-FRAME-SUPPORT-LOGIC-ALL-EQUIVALENT-RELATIONS-MEMO-TABLE-000 NULL)
(CL:DEFVAR SGT-FRAME-SUPPORT-LOGIC-ALL-SUPERRELATIONS-MEMO-TABLE-000 NULL)
(CL:DEFVAR SGT-FRAME-SUPPORT-LOGIC-ALL-SUBRELATIONS-MEMO-TABLE-000 NULL)
(CL:DEFVAR SGT-FRAME-SUPPORT-LOGIC-ALL-DIRECT-SUPERRELATIONS-MEMO-TABLE-000 NULL)
(CL:DEFVAR SGT-FRAME-SUPPORT-LOGIC-ALL-DIRECT-SUBRELATIONS-MEMO-TABLE-000 NULL)
(CL:DEFVAR SGT-FRAME-SUPPORT-PL-KERNEL-KB-MINIMUM-CARDINALITY NULL)
(CL:DEFVAR SGT-FRAME-SUPPORT-PL-KERNEL-KB-MAXIMUM-CARDINALITY NULL)
(CL:DEFVAR SGT-FRAME-SUPPORT-PL-KERNEL-KB-VALUE-TYPE NULL)
...
(CL:DECLAIM
 (CL:SPECIAL *STARTUP-TIME-PHASE* SHALLOW-INFERENCE SUBSUMPTION-INFERENCE
  *CONTEXT* *MEMOIZATION-ENABLED?* MEMOIZED-NULL-VALUE TRUE-WRAPPER
  FALSE-WRAPPER STANDARD-OUTPUT EOL *MODULE*))
...
in the module the surrogate was interned in."
  (CL:LET*
   ((INSTANCE (COERCE-TO-INSTANCE-IN-MODULE INSTANCEREF NULL FALSE NULL)))
...
;;; (DEFUN (HELP-MEMOIZE-COLLECTION? BOOLEAN) ...)

(CL:DEFUN HELP-MEMOIZE-COLLECTION? (OBJECTREF)
  (CL:LET* ((INSTANCE (GET-INSTANCE OBJECTREF)))
   (CL:WHEN (CL:EQ INSTANCE NULL)
    (CL:RETURN-FROM HELP-MEMOIZE-COLLECTION? FALSE))
   (CL:COND
...
(CL:DEFUN COLLECTION? (OBJECTREF)
  ...
  (CL:LET*
   ((MEMO-TABLE-000
     (%SURROGATE-VALUE
      SGT-FRAME-SUPPORT-LOGIC-COLLECTION?-MEMO-TABLE-000))
   ...
   (CL:WHEN *MEMOIZATION-ENABLED?*
    (CL:SETQ MEMOIZED-ENTRY-000
     (LOOKUP-MRU-MEMOIZED-VALUE MEMO-TABLE-000 OBJECTREF *CONTEXT*
   ...
   (CL:COND
    ...
    (CL:T
     (CL:SETQ MEMOIZED-VALUE-000
      (CL:IF (HELP-MEMOIZE-COLLECTION? OBJECTREF) TRUE-WRAPPER
       FALSE-WRAPPER))
     (CL:WHEN *MEMOIZATION-ENABLED?*
...
;;; (DEFUN (HELP-MEMOIZE-CLASS? BOOLEAN) ...)

(CL:DEFUN HELP-MEMOIZE-CLASS? (OBJECTREF)
  (CL:LET* ((INSTANCE (GET-INSTANCE OBJECTREF)))
   (CL:WHEN (CL:EQ INSTANCE NULL)
    (CL:RETURN-FROM HELP-MEMOIZE-CLASS? FALSE))
   (CL:COND
    ((SUBTYPE-OF? (SAFE-PRIMARY-TYPE INSTANCE)
      SGT-FRAME-SUPPORT-LOGIC-LOGIC-OBJECT)
     (CL:PROGN (TEST-ISA? INSTANCE SGT-FRAME-SUPPORT-PL-KERNEL-KB-CLASS)))
    (CL:T FALSE))))
...
(CL:DEFUN CLASS? (OBJECTREF)
  ...
  (CL:LET*
   ((MEMO-TABLE-000
     (%SURROGATE-VALUE SGT-FRAME-SUPPORT-LOGIC-CLASS?-MEMO-TABLE-000))
    (MEMOIZED-ENTRY-000 NULL) (MEMOIZED-VALUE-000 NULL))
   (CL:WHEN (CL:EQ MEMO-TABLE-000 NULL)
    (INITIALIZE-MEMOIZATION-TABLE
     SGT-FRAME-SUPPORT-LOGIC-CLASS?-MEMO-TABLE-000
   ...
   (CL:COND
    ...
    (CL:T
     (CL:SETQ MEMOIZED-VALUE-000
      (CL:IF (HELP-MEMOIZE-CLASS? OBJECTREF) TRUE-WRAPPER FALSE-WRAPPER))
     (CL:WHEN *MEMOIZATION-ENABLED?*
      (CL:SETF (%%VALUE MEMOIZED-ENTRY-000)
       (CL:IF (CL:EQ MEMOIZED-VALUE-000 NULL) MEMOIZED-NULL-VALUE
        MEMOIZED-VALUE-000)))))
...
;;; (DEFUN (HELP-MEMOIZE-RELATION? BOOLEAN) ...)

(CL:DEFUN HELP-MEMOIZE-RELATION? (OBJECTREF)
  (CL:LET* ((INSTANCE (GET-INSTANCE OBJECTREF)))
   (CL:WHEN (CL:EQ INSTANCE NULL)
    (CL:RETURN-FROM HELP-MEMOIZE-RELATION? FALSE))
   (CL:COND
    ((SUBTYPE-OF? (SAFE-PRIMARY-TYPE INSTANCE)
      SGT-FRAME-SUPPORT-LOGIC-LOGIC-OBJECT)
     (CL:PROGN
...
(CL:DEFUN RELATION? (OBJECTREF)
  ...
  (CL:LET*
   ((MEMO-TABLE-000
     (%SURROGATE-VALUE SGT-FRAME-SUPPORT-LOGIC-RELATION?-MEMO-TABLE-000))
    (MEMOIZED-ENTRY-000 NULL) (MEMOIZED-VALUE-000 NULL))
   (CL:WHEN (CL:EQ MEMO-TABLE-000 NULL)
    (INITIALIZE-MEMOIZATION-TABLE
     SGT-FRAME-SUPPORT-LOGIC-RELATION?-MEMO-TABLE-000
     "(:MAX-VALUES 500 :TIMESTAMPS (:META-KB-UPDATE))")
    (CL:SETQ MEMO-TABLE-000
     (%SURROGATE-VALUE SGT-FRAME-SUPPORT-LOGIC-RELATION?-MEMO-TABLE-000)))
   (CL:WHEN *MEMOIZATION-ENABLED?*
   ...
   (CL:COND
    ...
    (CL:T
     (CL:SETQ MEMOIZED-VALUE-000
      (CL:IF (HELP-MEMOIZE-RELATION? OBJECTREF) TRUE-WRAPPER
       FALSE-WRAPPER))
     (CL:WHEN *MEMOIZATION-ENABLED?*
      (CL:SETF (%%VALUE MEMOIZED-ENTRY-000)
       (CL:IF (CL:EQ MEMOIZED-VALUE-000 NULL) MEMOIZED-NULL-VALUE
...
;;; (DEFUN (HELP-MEMOIZE-FUNCTION? BOOLEAN) ...)

(CL:DEFUN HELP-MEMOIZE-FUNCTION? (RELATIONREF)
   ...
   (CL:WHEN
    (CL:OR (CL:EQ INSTANCE NULL)
     (CL:EQ (%SURROGATE-VALUE SGT-FRAME-SUPPORT-PL-KERNEL-KB-FUNCTION)
      NULL))
    (CL:RETURN-FROM HELP-MEMOIZE-FUNCTION? FALSE))
   (CL:COND
    ((SUBTYPE-OF? (SAFE-PRIMARY-TYPE INSTANCE)
      SGT-FRAME-SUPPORT-LOGIC-LOGIC-OBJECT)
     (CL:PROGN
...
(CL:DEFUN FUNCTION? (RELATIONREF)
  ...
  (CL:LET*
   ((MEMO-TABLE-000
     (%SURROGATE-VALUE SGT-FRAME-SUPPORT-LOGIC-FUNCTION?-MEMO-TABLE-000))
    (MEMOIZED-ENTRY-000 NULL) (MEMOIZED-VALUE-000 NULL))
   (CL:WHEN (CL:EQ MEMO-TABLE-000 NULL)
    (INITIALIZE-MEMOIZATION-TABLE
     SGT-FRAME-SUPPORT-LOGIC-FUNCTION?-MEMO-TABLE-000
     "(:MAX-VALUES 500 :TIMESTAMPS (:META-KB-UPDATE))")
    (CL:SETQ MEMO-TABLE-000
     (%SURROGATE-VALUE SGT-FRAME-SUPPORT-LOGIC-FUNCTION?-MEMO-TABLE-000)))
   (CL:WHEN *MEMOIZATION-ENABLED?*
   ...
   (CL:COND
    ...
    (CL:T
     (CL:SETQ MEMOIZED-VALUE-000
      (CL:IF (HELP-MEMOIZE-FUNCTION? RELATIONREF) TRUE-WRAPPER
       FALSE-WRAPPER))
     (CL:WHEN *MEMOIZATION-ENABLED?*
      (CL:SETF (%%VALUE MEMOIZED-ENTRY-000)
       (CL:IF (CL:EQ MEMOIZED-VALUE-000 NULL) MEMOIZED-NULL-VALUE
...
(CL:DEFMETHOD LEVELLIZED-TEST-TYPE-ON-INSTANCE? ((LEVEL SUBSUMPTION-INFERENCE-LEVEL) SELF TYPE)
  (CL:LET* ((FOUND?-000 FALSE))
   (CL:LET*
    ((P NULL) (ITER-000 (ALL-TRUE-DEPENDENT-PROPOSITIONS SELF TYPE TRUE)))
    (CL:LOOP WHILE (NEXT? ITER-000) DO (CL:SETQ P (%VALUE ITER-000))
     (CL:WHEN (CL:EQ (%KIND P) KWD-FRAME-SUPPORT-ISA)
...
If 'reflexive?', include 'relation' in the list."
  (CL:LET*
   ((MEMO-TABLE-000
     (%SURROGATE-VALUE
      SGT-FRAME-SUPPORT-LOGIC-ALL-EQUIVALENT-RELATIONS-MEMO-TABLE-000))
    (MEMOIZED-ENTRY-000 NULL) (MEMOIZED-VALUE-000 NULL))
   (CL:WHEN (CL:EQ MEMO-TABLE-000 NULL)
    (INITIALIZE-MEMOIZATION-TABLE
     SGT-FRAME-SUPPORT-LOGIC-ALL-EQUIVALENT-RELATIONS-MEMO-TABLE-000
...
(CL:DEFUN REMOVE-EQUIVALENT-RELATIONS (RELATIONSLIST RELATION)
  (CL:WHEN (MEMBER? RELATIONSLIST RELATION)
   (CL:LET* ((M NULL) (ITER-000 (ALL-EQUIVALENT-RELATIONS RELATION TRUE)))
    (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-000 NIL)) DO
...
(CL:DEFUN ALL-SUPERRELATIONS (RELATION REMOVEEQUIVALENTS?)
  ...
  (CL:LET*
   ((MEMO-TABLE-000
     (%SURROGATE-VALUE
      SGT-FRAME-SUPPORT-LOGIC-ALL-SUPERRELATIONS-MEMO-TABLE-000))
    (MEMOIZED-ENTRY-000 NULL) (MEMOIZED-VALUE-000 NULL))
   (CL:WHEN (CL:EQ MEMO-TABLE-000 NULL)
    (INITIALIZE-MEMOIZATION-TABLE
     SGT-FRAME-SUPPORT-LOGIC-ALL-SUPERRELATIONS-MEMO-TABLE-000
...
relation."
  (CL:LET*
   ((MEMO-TABLE-000
     (%SURROGATE-VALUE
      SGT-FRAME-SUPPORT-LOGIC-ALL-SUBRELATIONS-MEMO-TABLE-000))
    (MEMOIZED-ENTRY-000 NULL) (MEMOIZED-VALUE-000 NULL))
   (CL:WHEN (CL:EQ MEMO-TABLE-000 NULL)
    (INITIALIZE-MEMOIZATION-TABLE
     SGT-FRAME-SUPPORT-LOGIC-ALL-SUBRELATIONS-MEMO-TABLE-000
...
relations equivalent to 'relation'."
  (CL:LET*
   ((MEMO-TABLE-000
     (%SURROGATE-VALUE
      SGT-FRAME-SUPPORT-LOGIC-ALL-DIRECT-SUPERRELATIONS-MEMO-TABLE-000))
    (MEMOIZED-ENTRY-000 NULL) (MEMOIZED-VALUE-000 NULL))
   (CL:WHEN (CL:EQ MEMO-TABLE-000 NULL)
    (INITIALIZE-MEMOIZATION-TABLE
     SGT-FRAME-SUPPORT-LOGIC-ALL-DIRECT-SUPERRELATIONS-MEMO-TABLE-000
...
relations equivalent to 'relation'."
  (CL:LET*
   ((MEMO-TABLE-000
     (%SURROGATE-VALUE
      SGT-FRAME-SUPPORT-LOGIC-ALL-DIRECT-SUBRELATIONS-MEMO-TABLE-000))
    (MEMOIZED-ENTRY-000 NULL) (MEMOIZED-VALUE-000 NULL))
   (CL:WHEN (CL:EQ MEMO-TABLE-000 NULL)
    (INITIALIZE-MEMOIZATION-TABLE
     SGT-FRAME-SUPPORT-LOGIC-ALL-DIRECT-SUBRELATIONS-MEMO-TABLE-000
  ...
  (CL:LET*
   ((DESCRIPTION (GET-DESCRIPTION RELATION))
    (MINCARDINALITY
     (%%VALUE
      (ALL-RELATION-VALUES
       SGT-FRAME-SUPPORT-PL-KERNEL-KB-MINIMUM-CARDINALITY
  ...
  (CL:LET*
   ((DESCRIPTION (GET-DESCRIPTION RELATION))
    (MAXCARDINALITY
     (%%VALUE
      (ALL-RELATION-VALUES
       SGT-FRAME-SUPPORT-PL-KERNEL-KB-MAXIMUM-CARDINALITY
       (CONS-LIST DESCRIPTION SELF))))
...
(CL:DEFMETHOD LEVELLIZED-ALL-SLOT-VALUE-TYPES ((LEVEL SHALLOW-INFERENCE-LEVEL) SELF RELATION)
  (CL:LET*
   ((DESCRIPTION (GET-DESCRIPTION RELATION))
    (VALUETYPES
     (ALL-RELATION-VALUES SGT-FRAME-SUPPORT-PL-KERNEL-KB-VALUE-TYPE
      (CONS-LIST DESCRIPTION SELF))))
   (CL:WHEN
...
(CL:DEFUN HELP-STARTUP-FRAME-SUPPORT1 ()
  (CL:PROGN
   ...
   (CL:SETQ SGT-FRAME-SUPPORT-LOGIC-COLLECTION?-MEMO-TABLE-000
    (INTERN-RIGID-SYMBOL-WRT-MODULE "COLLECTION?-MEMO-TABLE-000" NULL 1))
   (CL:SETQ SGT-FRAME-SUPPORT-PL-KERNEL-KB-CLASS
    (INTERN-RIGID-SYMBOL-WRT-MODULE "CLASS"
     (GET-STELLA-MODULE "/PL-KERNEL-KB" TRUE) 1))
   (CL:SETQ SGT-FRAME-SUPPORT-LOGIC-CLASS?-MEMO-TABLE-000
    (INTERN-RIGID-SYMBOL-WRT-MODULE "CLASS?-MEMO-TABLE-000" NULL 1))
   (CL:SETQ SGT-FRAME-SUPPORT-PL-KERNEL-KB-RELATION
    (INTERN-RIGID-SYMBOL-WRT-MODULE "RELATION"
     (GET-STELLA-MODULE "/PL-KERNEL-KB" TRUE) 1))
   (CL:SETQ SGT-FRAME-SUPPORT-LOGIC-RELATION?-MEMO-TABLE-000
    (INTERN-RIGID-SYMBOL-WRT-MODULE "RELATION?-MEMO-TABLE-000" NULL 1))
   (CL:SETQ SGT-FRAME-SUPPORT-PL-KERNEL-KB-FUNCTION
    (INTERN-RIGID-SYMBOL-WRT-MODULE "FUNCTION"
     (GET-STELLA-MODULE "/PL-KERNEL-KB" TRUE) 1))
   (CL:SETQ SGT-FRAME-SUPPORT-LOGIC-FUNCTION?-MEMO-TABLE-000
    (INTERN-RIGID-SYMBOL-WRT-MODULE "FUNCTION?-MEMO-TABLE-000" NULL 1))
   ...
   (CL:SETQ
    ...
    (INTERN-RIGID-SYMBOL-WRT-MODULE
     "ALL-EQUIVALENT-RELATIONS-MEMO-TABLE-000" NULL 1))
   (CL:SETQ SGT-FRAME-SUPPORT-LOGIC-ALL-SUPERRELATIONS-MEMO-TABLE-000
    (INTERN-RIGID-SYMBOL-WRT-MODULE "ALL-SUPERRELATIONS-MEMO-TABLE-000"
     NULL 1))
   (CL:SETQ SGT-FRAME-SUPPORT-LOGIC-ALL-SUBRELATIONS-MEMO-TABLE-000
    (INTERN-RIGID-SYMBOL-WRT-MODULE "ALL-SUBRELATIONS-MEMO-TABLE-000" NULL
     1))
   (CL:SETQ
    SGT-FRAME-SUPPORT-LOGIC-ALL-DIRECT-SUPERRELATIONS-MEMO-TABLE-000
    (INTERN-RIGID-SYMBOL-WRT-MODULE
     "ALL-DIRECT-SUPERRELATIONS-MEMO-TABLE-000" NULL 1))
   (CL:SETQ SGT-FRAME-SUPPORT-LOGIC-ALL-DIRECT-SUBRELATIONS-MEMO-TABLE-000
    (INTERN-RIGID-SYMBOL-WRT-MODULE
     "ALL-DIRECT-SUBRELATIONS-MEMO-TABLE-000" NULL 1))
   (CL:SETQ SGT-FRAME-SUPPORT-PL-KERNEL-KB-MINIMUM-CARDINALITY
    (INTERN-RIGID-SYMBOL-WRT-MODULE "MINIMUM-CARDINALITY"
     (GET-STELLA-MODULE "/PL-KERNEL-KB" TRUE) 1))
   (CL:SETQ SGT-FRAME-SUPPORT-PL-KERNEL-KB-MAXIMUM-CARDINALITY
    (INTERN-RIGID-SYMBOL-WRT-MODULE "MAXIMUM-CARDINALITY"
     (GET-STELLA-MODULE "/PL-KERNEL-KB" TRUE) 1))
   (CL:SETQ SGT-FRAME-SUPPORT-PL-KERNEL-KB-VALUE-TYPE
    (INTERN-RIGID-SYMBOL-WRT-MODULE "VALUE-TYPE"
     (GET-STELLA-MODULE "/PL-KERNEL-KB" TRUE) 1))
...
in the module the surrogate was interned in.\" :PUBLIC? TRUE)"
   ...
   (DEFINE-FUNCTION-OBJECT "HELP-MEMOIZE-COLLECTION?"
    "(DEFUN (HELP-MEMOIZE-COLLECTION? BOOLEAN) ((OBJECTREF OBJECT)))"
    (CL:FUNCTION HELP-MEMOIZE-COLLECTION?) NULL)
   ...
   (DEFINE-FUNCTION-OBJECT "HELP-MEMOIZE-CLASS?"
    "(DEFUN (HELP-MEMOIZE-CLASS? BOOLEAN) ((OBJECTREF OBJECT)))"
    (CL:FUNCTION HELP-MEMOIZE-CLASS?) NULL)
   ...
   (DEFINE-FUNCTION-OBJECT "HELP-MEMOIZE-RELATION?"
    "(DEFUN (HELP-MEMOIZE-RELATION? BOOLEAN) ((OBJECTREF OBJECT)))"
    (CL:FUNCTION HELP-MEMOIZE-RELATION?) NULL)
   ...
   (DEFINE-FUNCTION-OBJECT "HELP-MEMOIZE-FUNCTION?"
    "(DEFUN (HELP-MEMOIZE-FUNCTION? BOOLEAN) ((RELATIONREF OBJECT)))"
    (CL:FUNCTION HELP-MEMOIZE-FUNCTION?) NULL)
   ...
   (CL:WHEN (CURRENT-STARTUP-TIME-PHASE? 7) (HELP-STARTUP-FRAME-SUPPORT2)
    ...
    (CL:LET*
     ...
     (SET-DYNAMIC-SLOT-VALUE (%DYNAMIC-SLOTS FUNCTION)
      ...
      (WRAP-STRING "Startup-Frame-Support") NULL-STRING-WRAPPER)))
