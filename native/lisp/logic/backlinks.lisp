...
(CL:DEFUN REWRAP-ITH-ARGUMENT? (ARGUMENT PROPOSITION I)
  ...
  (CL:LET* ((TEST-VALUE-000 (SAFE-PRIMARY-TYPE ARGUMENT)))
   (CL:COND
    ...
    (CL:T
     (CL:AND
      (CL:NOT (ISA? ARGUMENT SGT-BACKLINKS-LOGIC-BACKLINKS-MIXIN))
  ...
  (CL:LET*
   ...
   (CL:LET*
    ...
    (CL:LOOP WHILE (CL:< INDEX-000 LENGTH-000) DO
     ...
     (CL:SETQ INDEX-000 (CL:1+ INDEX-000))))
   (CL:WHEN
    (CL:AND (CL:= LOWESTBACKLINKCOUNT NULL-INTEGER)
   ...
   (CL:COND
    ((CL:= LOWESTBACKLINKCOUNT NULL-INTEGER) (CL:VALUES NULL CL:NIL))
        ...
        (CL:LET*
         ...
         (CL:LOOP WHILE (CL:< INDEX-000 LENGTH-000) DO
          ...
          (CL:WHEN (EQL? ARG FROM)
           (CL:LET
            ((SELF (%THE-ARRAY (%ARGUMENTS P))) (VALUE TOVALUE)
             (POSITION I))
            (CL:DECLARE (CL:TYPE CL:SIMPLE-VECTOR SELF)
             (CL:TYPE CL:FIXNUM POSITION))
            (CL:SETF (CL:AREF SELF POSITION) VALUE)))
