...
(CL:DEFVAR SGT-BACKLINKS-LOGIC-NON-PAGING-INDEX NULL)
...
(CL:DECLAIM
  ...
  *LOADINGREGENERABLEOBJECTS?* NIL-LIST UNKNOWN-TRUTH-VALUE FALSE-WRAPPER
  TRUE-WRAPPER NULL-INTEGER TRUE NIL-NON-PAGING-INDEX STANDARD-OUTPUT EOL NIL
  *MODULE* FALSE))

;;; (DEFUN (TYPE-HAS-BACKLINKS? BOOLEAN) ...)

(CL:DEFUN TYPE-HAS-BACKLINKS? (TYPE)
  (CL:IF (CL:EQ (%SURROGATE-VALUE TYPE) NULL) FALSE
    ...
    ((SUBTYPE-OF? TEST-VALUE-001 SGT-BACKLINKS-LOGIC-LOGIC-OBJECT)
     (CL:PROGN
      (CL:LET* ((INDEX (%DEPENDENT-PROPOSITIONS-INDEX SELF)))
       ...
       (CL:SETF (%DEPENDENT-PROPOSITIONS-INDEX SELF) INDEX)
       (CL:RETURN-FROM GET-BACKLINKS-INDEX INDEX))))
...
(CL:DEFUN ADD-DEPENDENT-PROPOSITION-TO-SPECIALIZED-INDEX (INDEX PROPOSITION ARGUMENT)
  (CL:LET* ((TABLE (%PREDICATE-PROPOSITIONS-TABLE INDEX)))
   (CL:WHEN (CL:EQ TABLE NULL) (CL:SETQ TABLE (NEW-HASH-TABLE))
    (CL:SETF (%PREDICATE-PROPOSITIONS-TABLE INDEX) TABLE)
    (CL:LET*
     ((PROP NULL)
      (ITER-000 (ALLOCATE-ITERATOR (%DEPENDENT-PROPOSITIONS-LIST INDEX))))
   ...
   (CL:COND
    ...
    (CL:T
     (CL:LET* ((SURROGATE (%OPERATOR PROPOSITION)) (BUCKET NULL))
...
(CL:DEFUN HELP-ADD-DEPENDENT-PROPOSITION (INDEX PROPOSITION ARGUMENT)
  (CL:LET*
   ((ALLDEPENDENTPROPOSITIONS (%DEPENDENT-PROPOSITIONS-LIST INDEX))
  ...
  (CL:LET* ((TEST-VALUE-000 (SAFE-PRIMARY-TYPE SELF)))
   (CL:COND
    ((SUBTYPE-OF? TEST-VALUE-000 SGT-BACKLINKS-LOGIC-PROPOSITION)
     (CL:PROGN
      (CL:COND ((CL:EQ (%KIND SELF) KWD-BACKLINKS-CONSTANT))
       (CL:T
        (CL:LET* ((INDEX (%DEPENDENT-PROPOSITIONS SELF)))
    ...
    ((SUBTYPE-OF? TEST-VALUE-000 SGT-BACKLINKS-LOGIC-LOGIC-OBJECT)
     (CL:PROGN
      (CL:WHEN
       (CL:AND (DESCRIPTION-MODE?) (ISA? SELF SGT-BACKLINKS-LOGIC-DESCRIPTION)
      ...
      (CL:LET* ((INDEX (GET-BACKLINKS-INDEX SELF)))
       (CL:WHEN
        ...
        (%%PRINT-STREAM (%NATIVE-STREAM STANDARD-OUTPUT)
         "Can we eliminate the skolem `" SELF "' from the description???" EOL
         EOL))
    ...
    ((SUBTYPE-OF? TEST-VALUE-000 SGT-BACKLINKS-STELLA-THING)
     (CL:PROGN
      (HELP-ADD-DEPENDENT-PROPOSITION (GET-BACKLINKS-INDEX SELF) PROPOSITION
       SELF)))
    (CL:T))))
...
(CL:DEFUN HELP-REMOVE-DEPENDENT-PROPOSITION (INDEX PROPOSITION)
  (CL:LET*
   ((LIST (%DEPENDENT-PROPOSITIONS-LIST INDEX))
    (TABLE (%PREDICATE-PROPOSITIONS-TABLE INDEX)))
   (CL:WHEN (CL:NOT (CL:EQ LIST NULL))
    (CL:COND
     ((SUBTYPE-OF? (SAFE-PRIMARY-TYPE LIST)
       SGT-BACKLINKS-LOGIC-NON-PAGING-INDEX)
      (CL:PROGN (REMOVE LIST PROPOSITION)))
     (CL:T
      (CL:LET* ((STREAM-000 (NEW-OUTPUT-STRING-STREAM)))
       (%%PRINT-STREAM (%NATIVE-STREAM STREAM-000)
        "INTERNAL ERROR: `remove' not yet implemented for paging indices")
       (CL:ERROR (NEW-STELLA-EXCEPTION (THE-STRING-READER STREAM-000)))))))
   (CL:WHEN (CL:NOT (CL:EQ TABLE NULL))
    (CL:COND
     ((CL:EQ (%KIND PROPOSITION) KWD-BACKLINKS-ISA)
      (CL:SETQ LIST (%DEPENDENT-ISA-PROPOSITIONS-LIST INDEX))
      (CL:WHEN (CL:NOT (CL:EQ LIST NULL))
       (CL:COND
        ((SUBTYPE-OF? (SAFE-PRIMARY-TYPE LIST)
          SGT-BACKLINKS-LOGIC-NON-PAGING-INDEX)
   ...
   (CL:LET* ((TEST-VALUE-000 (SAFE-PRIMARY-TYPE ARGUMENT)))
    (CL:COND
     ((SUBTYPE-OF-INTEGER? TEST-VALUE-000)
      (CL:PROGN
       (CL:LET* ((VALUE (%WRAPPER-VALUE ARGUMENT)))
    ...
    (CL:WHEN TEST-VALUE-000 (CL:SETQ TEST-VALUE-000 (CL:= I 0))
     (CL:WHEN TEST-VALUE-000
      (CL:LET* ((ALWAYS?-000 TRUE))
       (CL:LET*
        ((T NULL) (ITER-000 (BUT-LAST (%IO-VARIABLE-TYPES DESCRIPTION))))
...
(CL:DEFUN REWRAP-ITH-ARGUMENT? (ARGUMENT PROPOSITION I)
  ...
  (CL:LET* ((TEST-VALUE-000 (SAFE-PRIMARY-TYPE ARGUMENT)))
   (CL:COND
    ...
    ((SUBTYPE-OF? TEST-VALUE-000 SGT-BACKLINKS-STELLA-THING) (CL:PROGN FALSE))
    (CL:T
  ...
  (CL:LET*
   ...
   (CL:LOOP WHILE (CL:< INDEX-000 LENGTH-000) DO
    ...
    (CL:WHEN
     ...
     (CL:LET
      ((SELF (%THE-ARRAY (%ARGUMENTS SELF))) (VALUE (REWRAP-ARGUMENT ARG))
       (POSITION I))
   ...
   ((SUBTYPE-OF? (SAFE-PRIMARY-TYPE SELF) SGT-BACKLINKS-LOGIC-PROPOSITION)
    (CL:PROGN
     (CL:COND ((CL:EQ RELATION NULL) (%DEPENDENT-PROPOSITIONS SELF))
      (CL:T
       (CL:LET*
        ((DEPENDENTS (CREATE-SEQUENCE-INDEX KWD-BACKLINKS-NON-PAGING NULL)))
        (CL:LET*
         ((PROP NULL)
   ...
   (CL:T
    (CL:LET* ((INDEX (GET-BACKLINKS-INDEX SELF)) (ALLPROPOSITIONSINDEX NULL))
     (CL:WHEN (CL:EQ INDEX NULL)
      (CL:RETURN-FROM UNFILTERED-DEPENDENT-PROPOSITIONS NIL-NON-PAGING-INDEX))
     (CL:SETQ ALLPROPOSITIONSINDEX (%DEPENDENT-PROPOSITIONS-LIST INDEX))
     (CL:WHEN (CL:EQ RELATION NULL)
      (CL:RETURN-FROM UNFILTERED-DEPENDENT-PROPOSITIONS ALLPROPOSITIONSINDEX))
     (CL:LET*
      ((TABLE (%PREDICATE-PROPOSITIONS-TABLE INDEX))
       (LIST
      ...
      (CL:WHEN
       ...
       (CL:LET*
        ...
        (CL:WHEN (CL:NOT (CL:EQ PAGINGLIST NULL))
         (CL:LET* ((V-029 NIL))
          (CL:LET*
           ((PROP NULL) (ITER-001 (%THE-SEQUENCE LIST)) (COLLECT-000 NULL))
          ...
          (CL:SETF (%THE-SEQUENCE PAGINGLIST) V-029))
...
(CL:DEFUN ALL-SPECIALIZING-DEPENDENT-PROPOSITIONS-NEXT? (SELF)
  (CL:LET*
   ((ITERATOR (%ITERATOR-NESTED-ITERATOR SELF))
    (RELATION (%%VALUE (%ITERATOR-CONS-LIST SELF))))
   (CL:LOOP
    (CL:LOOP WHILE (NEXT? ITERATOR) DO
     (CL:LET* ((PROPOSITION (%VALUE ITERATOR)))
      (CL:WHEN
       (CL:EQ (%OPERATOR PROPOSITION) (%SURROGATE-VALUE-INVERSE RELATION))
       (CL:SETF (%VALUE SELF) PROPOSITION)
       (CL:RETURN-FROM ALL-SPECIALIZING-DEPENDENT-PROPOSITIONS-NEXT? TRUE))))
    ...
    (CL:SETQ ITERATOR
     (ALLOCATE-ITERATOR
      (UNFILTERED-DEPENDENT-PROPOSITIONS (%ITERATOR-OBJECT SELF)
...
(CL:DEFUN ALL-SPECIALIZING-DEPENDENT-PROPOSITIONS (SELF RELATIONREF)
  (CL:LET* ((RELATION (GET-DESCRIPTION RELATIONREF)))
   (CL:LET* ((SELF-000 (NEW-ALL-PURPOSE-ITERATOR)))
    (CL:SETF (%ITERATOR-OBJECT SELF-000) SELF)
    (CL:SETF (%ITERATOR-CONS-LIST SELF-000)
    ...
    ((SUBTYPE-OF? TEST-VALUE-000 SGT-BACKLINKS-LOGIC-LOGIC-OBJECT)
     (CL:PROGN
      (CL:LET*
       ...
       (CL:WHEN (CL:EQ LIST NULL)
        (CL:SETQ LIST (%DEPENDENT-PROPOSITIONS-LIST INDEX))
        (CL:WHEN (ISA? LIST SGT-BACKLINKS-LOGIC-PAGING-INDEX)
         (CL:LET*
          ...
          (CL:WHEN (CL:NOT (CL:EQ PAGINGLIST NULL))
           (CL:LET* ((V-030 NIL))
            (CL:LET*
             ((PROP NULL) (ITER-000 (%THE-SEQUENCE LIST)) (COLLECT-000 NULL))
             (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-000 NIL)) DO
              ...
              (CL:WHEN (CL:EQ (%KIND PROP) KWD-BACKLINKS-ISA)
               (CL:IF (CL:EQ COLLECT-000 NULL)
                (CL:PROGN (CL:SETQ COLLECT-000 (CONS PROP NIL))
                 (CL:IF (CL:EQ V-030 NIL) (CL:SETQ V-030 COLLECT-000)
                  (ADD-CONS-TO-END-OF-CONS-LIST V-030 COLLECT-000)))
                (CL:PROGN (CL:SETF (%%REST COLLECT-000) (CONS PROP NIL))
                 (CL:SETQ COLLECT-000 (%%REST COLLECT-000)))))))
            (CL:SETF (%THE-SEQUENCE PAGINGLIST) V-030))
           (CL:SETQ LIST PAGINGLIST)))))
       LIST)))
    ((SUBTYPE-OF? TEST-VALUE-000 SGT-BACKLINKS-STELLA-THING)
     (CL:PROGN
        ...
        (CL:WHEN (ISA? LIST SGT-BACKLINKS-LOGIC-PAGING-INDEX)
         (CL:LET*
          ...
          (CL:WHEN (CL:NOT (CL:EQ PAGINGLIST NULL))
           (CL:LET* ((V-031 NIL))
            (CL:LET*
             ((PROP NULL) (ITER-001 (%THE-SEQUENCE LIST)) (COLLECT-001 NULL))
             (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-001 NIL)) DO
              (CL:PROGN (CL:SETQ PROP (%%VALUE ITER-001))
               (CL:SETQ ITER-001 (%%REST ITER-001)))
              (CL:WHEN (CL:EQ (%KIND PROP) KWD-BACKLINKS-ISA)
               (CL:IF (CL:EQ COLLECT-001 NULL)
                (CL:PROGN (CL:SETQ COLLECT-001 (CONS PROP NIL))
                 (CL:IF (CL:EQ V-031 NIL) (CL:SETQ V-031 COLLECT-001)
                  (ADD-CONS-TO-END-OF-CONS-LIST V-031 COLLECT-001)))
                (CL:PROGN (CL:SETF (%%REST COLLECT-001) (CONS PROP NIL))
                 (CL:SETQ COLLECT-001 (%%REST COLLECT-001)))))))
            (CL:SETF (%THE-SEQUENCE PAGINGLIST) V-031))
           (CL:SETQ LIST PAGINGLIST)))))
       LIST)))
    (CL:T
     (CL:LET*
      ...
      (CL:LET* ((INDEX (GET-BACKLINKS-INDEX SELF)))
       (CL:IF (CL:EQ INDEX NULL) NIL-NON-PAGING-INDEX
        (CL:LET* ((TABLE (%PREDICATE-PROPOSITIONS-TABLE INDEX)) (LIST NULL))
         (CL:WHEN (CL:NOT (CL:EQ TABLE NULL))
          (CL:SETQ LIST (LOOKUP TABLE SGT-BACKLINKS-PL-KERNEL-KB-SUBSET-OF))
          ...
          (CL:WHEN (ISA? LIST SGT-BACKLINKS-LOGIC-PAGING-INDEX)
           (CL:LET*
            ...
            (CL:WHEN (CL:NOT (CL:EQ PAGINGLIST NULL))
             (CL:LET* ((V-032 NIL))
              (CL:LET*
               ((PROP NULL) (ITER-000 (%THE-SEQUENCE LIST))
                (COLLECT-000 NULL))
               (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-000 NIL)) DO
                (CL:PROGN (CL:SETQ PROP (%%VALUE ITER-000))
                 (CL:SETQ ITER-000 (%%REST ITER-000)))
                (CL:WHEN
                 (CL:EQ (%OPERATOR PROP) SGT-BACKLINKS-PL-KERNEL-KB-SUBSET-OF)
                 (CL:IF (CL:EQ COLLECT-000 NULL)
                  (CL:PROGN (CL:SETQ COLLECT-000 (CONS PROP NIL))
                   (CL:IF (CL:EQ V-032 NIL) (CL:SETQ V-032 COLLECT-000)
                    (ADD-CONS-TO-END-OF-CONS-LIST V-032 COLLECT-000)))
                  (CL:PROGN (CL:SETF (%%REST COLLECT-000) (CONS PROP NIL))
                   (CL:SETQ COLLECT-000 (%%REST COLLECT-000)))))))
              (CL:SETF (%THE-SEQUENCE PAGINGLIST) V-032))
             (CL:SETQ LIST PAGINGLIST)))))
         LIST)))))
    ((SUBTYPE-OF? TEST-VALUE-000 SGT-BACKLINKS-STELLA-THING)
     (CL:PROGN
          ...
          (CL:WHEN (ISA? LIST SGT-BACKLINKS-LOGIC-PAGING-INDEX)
           (CL:LET*
            ...
            (CL:WHEN (CL:NOT (CL:EQ PAGINGLIST NULL))
             (CL:LET* ((V-033 NIL))
              (CL:LET*
               ((PROP NULL) (ITER-001 (%THE-SEQUENCE LIST))
                (COLLECT-001 NULL))
               (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-001 NIL)) DO
                (CL:PROGN (CL:SETQ PROP (%%VALUE ITER-001))
                 (CL:SETQ ITER-001 (%%REST ITER-001)))
                (CL:WHEN
                 ...
                 (CL:IF (CL:EQ COLLECT-001 NULL)
                  (CL:PROGN (CL:SETQ COLLECT-001 (CONS PROP NIL))
                   (CL:IF (CL:EQ V-033 NIL) (CL:SETQ V-033 COLLECT-001)
                    (ADD-CONS-TO-END-OF-CONS-LIST V-033 COLLECT-001)))
                  (CL:PROGN (CL:SETF (%%REST COLLECT-001) (CONS PROP NIL))
                   (CL:SETQ COLLECT-001 (%%REST COLLECT-001)))))))
              (CL:SETF (%THE-SEQUENCE PAGINGLIST) V-033))
             (CL:SETQ LIST PAGINGLIST)))))
         LIST)))))
    (CL:T
     (CL:LET* ((INDEX (GET-BACKLINKS-INDEX SELF)))
      (CL:IF (CL:EQ INDEX NULL) NIL-NON-PAGING-INDEX
       (CL:LET* ((TABLE (%PREDICATE-PROPOSITIONS-TABLE INDEX)))
        (CL:IF (CL:NOT (CL:EQ TABLE NULL))
         (CL:LET*
          ((TEMP-000 (LOOKUP TABLE SGT-BACKLINKS-PL-KERNEL-KB-SUBSET-OF)))
          (CL:LET*
           ((VALUE-000
...
(CL:DEFUN MAKE-RELATION-PATTERN (RELATION ARGUMENT)
  (CONS KWD-BACKLINKS-RELATION
   (CONS (CL:IF (CL:EQ NIL NULL) NIL NIL) (CONS RELATION (CONS ARGUMENT NIL)))))
...
(CL:DEFUN MAKE-RELATION-PATTERN-4 (RELATION ARGUMENT1 ARGUMENT2 ARGUMENT3 ARGUMENT4)
  (CONS KWD-BACKLINKS-RELATION
   (CONS (CL:IF (CL:EQ NIL NULL) NIL NIL)
    (CONS RELATION
     (CONS ARGUMENT1 (CONS ARGUMENT2 (CONS ARGUMENT3 (CONS ARGUMENT4 NIL))))))))
...
(CL:DEFUN MAKE-RELATION-PATTERN-N (RELATION CL:&REST ARGUMENTS)
  (CL:LET* ((ARGLIST-000 NIL))
   ...
   (CL:LET*
    ((VALUE-000
      (CONS KWD-BACKLINKS-RELATION
       (CONS (CL:IF (CL:EQ NIL NULL) NIL NIL) (CONS RELATION ARGLIST-000)))))
    VALUE-000)))
   ...
   (CL:LET* ((TEST-VALUE-000 (%%VALUE PATTERN)))
    (CL:COND
     ...
     (CL:T
      (CL:LET* ((STREAM-000 (NEW-OUTPUT-STRING-STREAM)))
       (%%PRINT-STREAM (%NATIVE-STREAM STREAM-000)
        "get-selection-key-equivalents: Can't yet handle pattern `" PATTERN
        "'")
       (CL:ERROR (NEW-STELLA-EXCEPTION (THE-STRING-READER STREAM-000)))))))
...
(CL:DEFUN SELECT-PROPOSITIONS (PATTERN)
  (CL:LET* ((KIND (%%VALUE PATTERN)) (ARGUMENTS (%%REST (%%REST PATTERN))))
   (CL:COND
    ...
    ((CL:EQ KIND KWD-BACKLINKS-RULES) (SELECT-RULE-PROPOSITIONS PATTERN))
    (CL:T
     (CL:LET* ((STREAM-000 (NEW-OUTPUT-STRING-STREAM)))
      (%%PRINT-STREAM (%NATIVE-STREAM STREAM-000)
   ...
   (CL:LET* ((SEQUENCE (%THE-SEQUENCE INDEX)) (FILTEREDSEQUENCE NIL))
    ...
    (CL:LET* ((PROP NULL) (ITER-000 SEQUENCE))
     (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-000 NIL)) DO
      (CL:PROGN (CL:SETQ PROP (%%VALUE ITER-000))
       (CL:SETQ ITER-000 (%%REST ITER-000)))
      (CL:WHEN
       (CL:AND (CL:EQ (%KIND PROP) KWD-BACKLINKS-ISA)
        (CL:NOT (DELETED? PROP)))
    ...
    (CL:IF (CL:EQ FILTEREDSEQUENCE NIL) NIL-NON-PAGING-INDEX
     (CL:LET* ((SELF-000 (NEW-NON-PAGING-INDEX)))
      (CL:SETF (%THE-SEQUENCE SELF-000) FILTEREDSEQUENCE)
      (CL:LET* ((VALUE-000 SELF-000)) VALUE-000))))))
...
(CL:DEFUN SELECT-RELATION-PROPOSITIONS (PATTERN)
  (CL:LET*
   ((ARGUMENTS (%%REST (%%REST PATTERN))) (RELATION (%%VALUE ARGUMENTS))
    (KEYS (%%REST ARGUMENTS)))
     ...
     (CL:WHEN (CL:EQ ANCHOR NULL)
      (CL:LET* ((DESCRIPTION (GET-DESCRIPTION RELATION)))
       (CL:IF (CL:NOT (CL:EQ DESCRIPTION NULL))
        (CL:RETURN-FROM SELECT-RELATION-PROPOSITIONS
         (GET-DESCRIPTION-EXTENSION DESCRIPTION TRUE))
        (CL:RETURN-FROM SELECT-RELATION-PROPOSITIONS NIL-NON-PAGING-INDEX))))
     (CL:LET*
      ((INDEX (UNFILTERED-DEPENDENT-PROPOSITIONS ANCHOR RELATION))
       (SEQUENCE (%THE-SEQUENCE INDEX)) (FILTEREDSEQUENCE NIL))
      (CL:COND
        ...
        (CL:PROGN
         (CL:WHEN
          (CL:AND (CL:NOT (CL:EQ (%STORE INDEX) NULL))
           (CL:EQ (%%VALUE (%SELECTION-PATTERN INDEX))
            KWD-BACKLINKS-RELATION))
          (CL:SETF (%SELECTION-PATTERN INDEX) PATTERN)
          (CL:RETURN-FROM SELECT-RELATION-PROPOSITIONS INDEX))))
       (CL:T))
      (CL:WHEN (CL:EQ SEQUENCE NIL)
       (CL:RETURN-FROM SELECT-RELATION-PROPOSITIONS NIL-NON-PAGING-INDEX))
      (CL:LET* ((PROP NULL) (ITER-001 SEQUENCE))
       (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-001 NIL)) DO
        (CL:PROGN (CL:SETQ PROP (%%VALUE ITER-001))
         (CL:SETQ ITER-001 (%%REST ITER-001)))
        (CL:LET* ((TEST-VALUE-000 FALSE))
         (CL:SETQ TEST-VALUE-000 (EQUAL? RELATION (%OPERATOR PROP)))
         (CL:WHEN TEST-VALUE-000
          (CL:SETQ TEST-VALUE-000 (CL:NOT (DELETED? PROP)))
          (CL:WHEN TEST-VALUE-000
           (CL:IF (CL:EQ (%%REST KEYS) NIL) (CL:SETQ TEST-VALUE-000 TRUE)
            (CL:LET* ((ALWAYS?-000 TRUE))
             (CL:LET*
              ((ARG NULL) (KEY NULL) (ITER-002 KEYS)
               (VECTOR-000 (%ARGUMENTS PROP)) (INDEX-000 0)
              ...
              (CL:LOOP WHILE
               ...
               DO
               (CL:PROGN (CL:SETQ KEY (%%VALUE ITER-002))
               ...
               (CL:WHEN
                (CL:NOT
                 (CL:OR (CL:EQ KEY NULL)
                  (EQUAL? (VALUE-OF KEY) (VALUE-OF ARG))
                  (CL:AND
                   (ISA? (VALUE-OF KEY) SGT-BACKLINKS-LOGIC-PROPOSITION)
                   (ISA? (VALUE-OF ARG) SGT-BACKLINKS-LOGIC-PROPOSITION)
                   (UNIFY-PROPOSITIONS? (VALUE-OF KEY) (VALUE-OF ARG)
                    (NEW-KEY-VALUE-LIST)))))
                (CL:SETQ ALWAYS?-000 FALSE) (CL:RETURN))))
             (CL:SETQ TEST-VALUE-000 ALWAYS?-000)))))
         (CL:WHEN TEST-VALUE-000
      ...
      (CL:IF (CL:EQ FILTEREDSEQUENCE NIL) NIL-NON-PAGING-INDEX
       (CL:LET* ((SELF-001 (NEW-NON-PAGING-INDEX)))
        (CL:SETF (%THE-SEQUENCE SELF-001) (REVERSE FILTEREDSEQUENCE))
...
(CL:DEFUN SELECT-RULE-PROPOSITIONS (PATTERN)
  (CL:LET*
   ((ARGUMENTS (%%REST (%%REST PATTERN))) (POSRELATION (%%VALUE ARGUMENTS))
  ...
  (CL:LET* ((OPTIONS (%%VALUE (%%REST PATTERN))))
   (CL:LOOP WHILE (CL:NOT (CL:EQ OPTIONS NIL)) DO
    (CL:WHEN
     ...
     (CL:RETURN-FROM EVALUATION-SELECTION-PATTERN? TRUE))
  ...
  (CL:LET*
   ...
   (CL:WHEN
    (CL:AND (CL:= COUNT 0)
     (CL:NOT
      (CL:EQ
       (ALL-DIRECT-SUBRELATIONS (SURROGATE-TO-DESCRIPTION RELATION) FALSE)
       NIL)))
    (CL:SETQ COUNT 1))
   (CL:LET* ((EQUIV NULL) (ITER-000 EQUIVALENTS))
    (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-000 NIL)) DO
     (CL:PROGN (CL:SETQ EQUIV (%%VALUE ITER-000))
      (CL:SETQ ITER-000 (%%REST ITER-000)))
     (CL:SETQ COUNT
...
(CL:DEFUN SELECT-ARGUMENT-WITH-BACKLINKS (PROPOSITION)
  (CL:LET*
   ((RELATION (%OPERATOR PROPOSITION)) (KIND (%KIND PROPOSITION)) (VALUE NULL)
    ...
    (CL:LOOP WHILE (CL:< INDEX-000 LENGTH-000) DO
     ...
     (CL:TAGBODY (CL:SETQ VALUE (ARGUMENT-BOUND-TO ARG))
      (CL:WHEN (CL:NOT (CL:EQ VALUE NULL))
       (CL:WHEN FALSE (CL:SETQ FOUNDDISCOURAGEDARGUMENT? TRUE)
        (CL:GO :CONTINUE))
       (CL:SETQ COUNT (COUNT-BACKLINKS-ON-RELATION VALUE KIND RELATION))
       (CL:WHEN
        (CL:AND (DEFINED? COUNT)
         (CL:OR (NULL? LOWESTBACKLINKCOUNT) (CL:< COUNT LOWESTBACKLINKCOUNT)))
   ...
   (CL:WHEN (CL:AND (NULL? LOWESTBACKLINKCOUNT) FOUNDDISCOURAGEDARGUMENT?)
    (CL:LET*
     ...
     (CL:LOOP WHILE (CL:< INDEX-001 LENGTH-001) DO
      ...
      (CL:TAGBODY (CL:SETQ VALUE (ARGUMENT-BOUND-TO ARG))
       (CL:WHEN (CL:NOT (CL:EQ VALUE NULL))
        (CL:WHEN (CL:NOT FALSE) (CL:GO :CONTINUE))
        (CL:SETQ COUNT (COUNT-BACKLINKS-ON-RELATION VALUE KIND RELATION))
        (CL:WHEN
         (CL:AND (DEFINED? COUNT)
  ...
  (CL:LET* ((I NULL) (ITER-000 INSTANCES))
   (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-000 NIL)) DO
    (CL:PROGN (CL:SETQ I (%%VALUE ITER-000))
     (CL:SETQ ITER-000 (%%REST ITER-000)))
    (CL:WHEN (CL:AND (CL:NOT (CL:EQ I NULL)) (CL:NOT FALSE))
  ...
  (CL:LET* ((I NULL) (ITER-001 INSTANCES))
   (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-001 NIL)) DO
    (CL:PROGN (CL:SETQ I (%%VALUE ITER-001))
     (CL:SETQ ITER-001 (%%REST ITER-001)))
    (CL:WHEN (CL:AND (CL:NOT (CL:EQ I NULL)) FALSE)
     (CL:LET* ((VALUE (VALUE-OF I)))
      (CL:WHEN (INSTANCE-HAS-BACKLINKS? VALUE)
       (CL:RETURN-FROM SELECT-INSTANCE-WITH-BACKLINKS VALUE))))))
  NULL)
     ...
     (CL:LET* ((BACKLINKEDARGUMENT (SELECT-ARGUMENT-WITH-BACKLINKS GOAL)))
      ...
      (CL:LET* ((VALUE-000 NULL))
       (CL:LET*
        ...
        (CL:LOOP WHILE (NEXT? ITER-000) DO (CL:SETQ P (%VALUE ITER-000))
         (CL:WHEN
          (CL:AND (CL:EQ (%OPERATOR P) (%OPERATOR GOAL))
  ...
  (CL:LET* ((V-034 NIL))
   (CL:LET*
    ...
    (CL:LOOP WHILE (NEXT? ITER-000) DO (CL:SETQ P (%VALUE ITER-000))
     (CL:IF (CL:EQ COLLECT-000 NULL)
      (CL:PROGN (CL:SETQ COLLECT-000 (CONS P NIL))
       (CL:IF (CL:EQ V-034 NIL) (CL:SETQ V-034 COLLECT-000)
        (ADD-CONS-TO-END-OF-CONS-LIST V-034 COLLECT-000)))
      (CL:PROGN (CL:SETF (%%REST COLLECT-000) (CONS P NIL))
       (CL:SETQ COLLECT-000 (%%REST COLLECT-000))))))
   (CL:LET* ((TOPROPOSITIONS V-034))
    ...
    (CL:LET*
     ...
     (CL:LOOP WHILE (NEXT? ITER-001) DO (CL:SETQ P (%VALUE ITER-001))
      (CL:WHEN (CL:NOT (MEMBER? EXCEPTPROPOSITIONS P))
       (CL:LET*
        ((I NULL-INTEGER) (ARG NULL) (VECTOR-000 (%ARGUMENTS P)) (INDEX-000 0)
        ...
        (CL:LOOP WHILE (CL:< INDEX-000 LENGTH-000) DO
         ...
         (CL:WHEN (EQL? ARG FROM)
          (CL:LET ((SELF (%THE-ARRAY (%ARGUMENTS P))) (VALUE TO) (POSITION I))
           (CL:DECLARE (CL:TYPE CL:SIMPLE-VECTOR SELF)
            (CL:TYPE CL:FIXNUM POSITION))
           (CL:SETF (CL:AREF SELF POSITION) VALUE)))))
       (CL:LET* ((TEST-VALUE-000 FALSE))
...
(CL:DEFUN GET-DESCRIPTION-EXTENSION (DESCRIPTION UPDATE?)
  (CL:LET* ((EXTENSION (%EXTENSION DESCRIPTION)))
   (CL:COND
    ...
    (UPDATE?
     (CL:SETQ EXTENSION
      (CREATE-SEQUENCE-INDEX KWD-BACKLINKS-PAGING
       (CONS KWD-BACKLINKS-RELATION
        (CONS (CL:IF (CL:EQ NIL NULL) NIL NIL)
         (CONS (%SURROGATE-VALUE-INVERSE DESCRIPTION) NIL)))))
     (CL:SETF (%EXTENSION DESCRIPTION) EXTENSION) EXTENSION)
...
(CL:DEFUN CLEANUP-ALL-DESCRIPTION-EXTENSIONS ()
  (CL:LET* ((DESCRIPTION NULL) (ITER-000 (ALL-NAMED-DESCRIPTIONS NULL FALSE)))
   (CL:LOOP WHILE (NEXT? ITER-000) DO (CL:SETQ DESCRIPTION (%VALUE ITER-000))
    (CL:WHEN
     (CL:AND (CL:NOT (CL:EQ (%EXTENSION DESCRIPTION) NULL))
      (CL:NOT (CL:EQ (%EXTENSION DESCRIPTION) NIL-PAGING-INDEX)))
     (REMOVE-DELETED-MEMBERS (%EXTENSION DESCRIPTION))))))
...
(CL:DEFUN UPDATE-DESCRIPTION-EXTENSION (SELF)
  (CL:WHEN (DESCRIPTION-MODE?) (CL:RETURN-FROM UPDATE-DESCRIPTION-EXTENSION))
            ...
            (CL:WHEN
             (CL:OR
              (CL:AND (CLASS-DESCRIPTION? DESCRIPTION)
               (LITERAL-TYPE? (%SURROGATE-VALUE-INVERSE DESCRIPTION)))
...
(CL:DEFUN COLLECTION-IMPLIES-COLLECTION? (SUBCOLLECTION SUPERCOLLECTION)
  (CL:IF (CL:EQ SUBCOLLECTION SUPERCOLLECTION) TRUE
...
(CL:DEFUN HELP-STARTUP-BACKLINKS1 ()
  (CL:PROGN
   ...
   (CL:SETQ SGT-BACKLINKS-LOGIC-NON-PAGING-INDEX
...
(CL:DEFUN STARTUP-BACKLINKS ()
  (CL:LET*
   ...
   (CL:WHEN (CURRENT-STARTUP-TIME-PHASE? 4)
    ...
    (CL:SETQ *BACKLINK-ALL-PROPOSITION-ARGUMENTS?* FALSE)
    (CL:SETQ *SUPPRESSINSERTIONINTOCLASSEXTENSION?* FALSE))
   ...
   (CL:WHEN (CURRENT-STARTUP-TIME-PHASE? 7) (HELP-STARTUP-BACKLINKS2)
    ...
    (CL:LET*
     ...
     (SET-DYNAMIC-SLOT-VALUE (%DYNAMIC-SLOTS FUNCTION)
      ...
      (WRAP-STRING "_Startup-Backlinks") NULL-STRING-WRAPPER)))
