...
(CL:DECLAIM
 (CL:SPECIAL *STARTUP-TIME-PHASE* NIL-PAGING-INDEX *LOADINGREGENERABLEOBJECTS?* *EVALUATIONMODE* UNKNOWN-TRUTH-VALUE
  *CONTEXT* *MEMOIZATION-ENABLED?* MEMOIZED-NULL-VALUE TRUE-WRAPPER *ALL-OBJECT-STORES* NIL-LIST NULL-INTEGER
  STANDARD-OUTPUT NIL-NON-PAGING-INDEX *POWERLOOM-EXECUTION-MODE* STANDARD-WARNING EOL FALSE-WRAPPER NIL *MODULE*))
   ...
   (CL:SETF (%DEPENDENT-PROPOSITIONS-LIST INDEX)
    (CL:IF (ISA? SELF SGT-BACKLINKS-LOGIC-PATTERN-VARIABLE) (CREATE-SEQUENCE-INDEX KWD-BACKLINKS-NON-PAGING NIL)
     (CREATE-SEQUENCE-INDEX *MODULE*
      (CONS KWD-BACKLINKS-DEPENDENTS (CONS (CL:IF (CL:EQ NIL NULL) NIL NIL) (CONS SELF NIL))))))
   INDEX))
  ...
  (CL:LET* ((TEST-VALUE-001 (SAFE-PRIMARY-TYPE SELF)))
   (CL:COND
    ((SUBTYPE-OF? TEST-VALUE-001 SGT-BACKLINKS-LOGIC-LOGIC-OBJECT)
     (CL:PROGN
      (CL:LET* ((INDEX (%DEPENDENT-PROPOSITIONS-INDEX SELF)))
       (CL:WHEN (CL:NOT (CL:EQ INDEX NULL)) (CL:RETURN-FROM GET-BACKLINKS-INDEX INDEX))
       (CL:SETQ INDEX (CREATE-BACKLINKS-INDEX SELF)) (CL:SETF (%DEPENDENT-PROPOSITIONS-INDEX SELF) INDEX)
       (CL:RETURN-FROM GET-BACKLINKS-INDEX INDEX))))
    ((SUBTYPE-OF? TEST-VALUE-001 SGT-BACKLINKS-STELLA-THING)
     (CL:PROGN
      (CL:LET*
       ((INDEX (DYNAMIC-SLOT-VALUE (%DYNAMIC-SLOTS SELF) SYM-BACKLINKS-LOGIC-DEPENDENT-PROPOSITIONS-INDEX NULL)))
       (CL:WHEN (CL:NOT (CL:EQ INDEX NULL)) (CL:RETURN-FROM GET-BACKLINKS-INDEX INDEX))
       (CL:SETQ INDEX (CREATE-BACKLINKS-INDEX SELF))
       (SET-DYNAMIC-SLOT-VALUE (%DYNAMIC-SLOTS SELF) SYM-BACKLINKS-LOGIC-DEPENDENT-PROPOSITIONS-INDEX INDEX NULL)
       (CL:RETURN-FROM GET-BACKLINKS-INDEX INDEX))))
    ((SUBTYPE-OF? TEST-VALUE-001 SGT-BACKLINKS-LOGIC-PROPOSITION)
     (CL:PROGN
      (CL:LET*
       ...
       (CL:WHEN
        (CL:NOT
         (CL:OR (EMPTY? (%DEPENDENT-PROPOSITIONS SELF))
          (%WRAPPER-VALUE (DYNAMIC-SLOT-VALUE (%DYNAMIC-SLOTS SELF) SYM-BACKLINKS-LOGIC-DESCRIPTIVE? FALSE-WRAPPER))))
        (CL:SETQ INDEX (CREATE-BACKLINKS-INDEX SELF))
        (SET-DYNAMIC-SLOT-VALUE (%DYNAMIC-SLOTS SELF) SYM-BACKLINKS-LOGIC-DEPENDENT-PROPOSITIONS-INDEX INDEX NULL)
        (CL:LET* ((PROP NULL) (ITER-000 (ALLOCATE-ITERATOR (%DEPENDENT-PROPOSITIONS SELF))))
         (CL:LOOP WHILE (NEXT? ITER-000) DO (CL:SETQ PROP (%VALUE ITER-000))
          (HELP-ADD-DEPENDENT-PROPOSITION INDEX PROP SELF))))
       (CL:RETURN-FROM GET-BACKLINKS-INDEX INDEX))))
  ...
  (CL:LET* ((TABLE (%PREDICATE-PROPOSITIONS-TABLE INDEX)))
   (CL:WHEN (CL:EQ TABLE NULL) (CL:SETQ TABLE (NEW-HASH-TABLE)) (CL:SETF (%PREDICATE-PROPOSITIONS-TABLE INDEX) TABLE)
    (CL:LET* ((PROP NULL) (ITER-000 (ALLOCATE-ITERATOR (%DEPENDENT-PROPOSITIONS-LIST INDEX))))
     (CL:LOOP WHILE (NEXT? ITER-000) DO (CL:SETQ PROP (%VALUE ITER-000))
      (ADD-DEPENDENT-PROPOSITION-TO-SPECIALIZED-INDEX INDEX PROP ARGUMENT))))
   (CL:COND
    ...
    (CL:T
     (CL:LET* ((SURROGATE (%OPERATOR PROPOSITION)) (BUCKET NULL)) (CL:SETQ BUCKET (LOOKUP TABLE SURROGATE))
      (CL:WHEN (CL:EQ BUCKET NULL)
       (CL:SETQ BUCKET
        (CREATE-SEQUENCE-INDEX *MODULE*
         (CONS KWD-BACKLINKS-RELATION (CONS (CL:IF (CL:EQ NIL NULL) NIL NIL) (CONS SURROGATE (CONS ARGUMENT NIL))))))
...
(CL:DEFUN HELP-ADD-DEPENDENT-PROPOSITION (INDEX PROPOSITION ARGUMENT)
  (CL:LET*
   ((ALLDEPENDENTPROPOSITIONS (%DEPENDENT-PROPOSITIONS-LIST INDEX)) (TABLE (%PREDICATE-PROPOSITIONS-TABLE INDEX)))
   ...
   (CL:WHEN (CL:EQ TABLE NULL)
    (CL:WHEN (CL:< (SEQUENCE-INDEX.ESTIMATED-LENGTH ALLDEPENDENTPROPOSITIONS) *SPECIALIZED-BACKLINKS-CROSSOVER-POINT*)
     (INSERT ALLDEPENDENTPROPOSITIONS PROPOSITION) (CL:RETURN-FROM HELP-ADD-DEPENDENT-PROPOSITION)))
   (ADD-DEPENDENT-PROPOSITION-TO-SPECIALIZED-INDEX INDEX PROPOSITION ARGUMENT)
  ...
  (CL:LET*
   ((DESCRIPTION?
     (CL:OR (DESCRIPTION-MODE?)
      (%WRAPPER-VALUE
       (DYNAMIC-SLOT-VALUE (%DYNAMIC-SLOTS PROPOSITION) SYM-BACKLINKS-LOGIC-DESCRIPTIVE? FALSE-WRAPPER)))))
   (CL:LET* ((TEST-VALUE-000 (SAFE-PRIMARY-TYPE SELF)))
    (CL:COND
     ((SUBTYPE-OF? TEST-VALUE-000 SGT-BACKLINKS-LOGIC-PROPOSITION)
      (CL:PROGN
       (CL:COND ((CL:EQ (%KIND SELF) KWD-BACKLINKS-CONSTANT))
        (CL:T
         (CL:LET*
          ((INDEX (%DEPENDENT-PROPOSITIONS SELF))
           (BACKLINKS
            (DYNAMIC-SLOT-VALUE (%DYNAMIC-SLOTS SELF) SYM-BACKLINKS-LOGIC-DEPENDENT-PROPOSITIONS-INDEX NULL)))
          ...
          (CL:WHEN (CL:EQ INDEX NIL-NON-PAGING-INDEX)
           (CL:SETQ INDEX (CREATE-SEQUENCE-INDEX KWD-BACKLINKS-NON-PAGING NIL))
           (CL:SETF (%DEPENDENT-PROPOSITIONS SELF) INDEX))
          (INSERT INDEX PROPOSITION)
          (CL:WHEN (CL:NOT (CL:EQ BACKLINKS NULL)) (HELP-ADD-DEPENDENT-PROPOSITION BACKLINKS PROPOSITION SELF)))))))
      ...
      (CL:PROGN
       (CL:WHEN
        ...
        (CL:ERROR
         ...
         SELF PROPOSITION))
       (CL:WHEN
        (CL:AND (CL:EQ *POWERLOOM-EXECUTION-MODE* KWD-BACKLINKS-DEBUGGING) DESCRIPTION? (SKOLEM? SELF)
         (CL:NOT (VARIABLE? SELF))
         (CL:NOT
          (%WRAPPER-VALUE
           (DYNAMIC-SLOT-VALUE (%DYNAMIC-SLOTS SELF) SYM-BACKLINKS-LOGIC-HYPOTHESIZED-INSTANCE? FALSE-WRAPPER))))
        (CL:LET* ((*PRINTREADABLY?* CL:T)) (CL:DECLARE (CL:SPECIAL *PRINTREADABLY?*))
         (%%PRINT-STREAM (%NATIVE-STREAM STANDARD-WARNING) "WARNING: Found skolem " SELF " in descriptive proposition "
          PROPOSITION EOL)
      ...
      (CL:PROGN
       (CL:WHEN (CL:NOT DESCRIPTION?)
        (CL:LET* ((INDEX (GET-BACKLINKS-INDEX SELF)))
         (CL:WHEN (CL:NOT (CL:EQ INDEX NULL)) (HELP-ADD-DEPENDENT-PROPOSITION INDEX PROPOSITION SELF))))))
     ((SUBTYPE-OF? TEST-VALUE-000 SGT-BACKLINKS-STELLA-THING)
      (CL:PROGN
       (CL:WHEN (CL:NOT DESCRIPTION?) (HELP-ADD-DEPENDENT-PROPOSITION (GET-BACKLINKS-INDEX SELF) PROPOSITION SELF))))
     (CL:T)))))
   ...
   (CL:COND
    ((SUBTYPE-OF? TEST-VALUE-000 SGT-BACKLINKS-LOGIC-PROPOSITION)
     (CL:PROGN (REMOVE (%DEPENDENT-PROPOSITIONS SELF) PROPOSITION)
      (CL:LET*
       ((BACKLINKS (DYNAMIC-SLOT-VALUE (%DYNAMIC-SLOTS SELF) SYM-BACKLINKS-LOGIC-DEPENDENT-PROPOSITIONS-INDEX NULL)))
       (CL:WHEN (CL:NOT (CL:EQ BACKLINKS NULL)) (HELP-REMOVE-DEPENDENT-PROPOSITION BACKLINKS PROPOSITION)))))
    ((SUBTYPE-OF? TEST-VALUE-000 SGT-BACKLINKS-LOGIC-LOGIC-OBJECT)
     (CL:PROGN (HELP-REMOVE-DEPENDENT-PROPOSITION (GET-BACKLINKS-INDEX SELF) PROPOSITION)))
    ((SUBTYPE-OF-WRAPPER? TEST-VALUE-000)
     (CL:PROGN
      (CL:LET* ((INDEX (GET-BACKLINKS-INDEX SELF)))
       (CL:WHEN (CL:NOT (CL:EQ INDEX NULL)) (HELP-REMOVE-DEPENDENT-PROPOSITION INDEX PROPOSITION)))))
    ((SUBTYPE-OF? TEST-VALUE-000 SGT-BACKLINKS-STELLA-THING)
     (CL:PROGN (HELP-REMOVE-DEPENDENT-PROPOSITION (GET-BACKLINKS-INDEX SELF) PROPOSITION)))
    (CL:T))))
...
(CL:DEFUN HELP-REMOVE-DEPENDENT-PROPOSITION (INDEX PROPOSITION)
  (CL:LET* ((LIST (%DEPENDENT-PROPOSITIONS-LIST INDEX)) (TABLE (%PREDICATE-PROPOSITIONS-TABLE INDEX)))
   ...
   (CL:WHEN (CL:NOT (CL:EQ TABLE NULL))
    (CL:COND
     ((CL:EQ (%KIND PROPOSITION) KWD-BACKLINKS-ISA) (CL:SETQ LIST (%DEPENDENT-ISA-PROPOSITIONS-LIST INDEX))
      (CL:WHEN (CL:NOT (CL:EQ LIST NULL)) (REMOVE LIST PROPOSITION)))
     (CL:T (CL:SETQ LIST (LOOKUP TABLE (%OPERATOR PROPOSITION)))
      (CL:WHEN (CL:NOT (CL:EQ LIST NULL)) (REMOVE LIST PROPOSITION)))))))
...
(CL:DEFMETHOD REMOVE-DELETED-MEMBERS ((SELF BACKLINKS-INDEX))
  (CL:WHEN (CL:NOT (CL:EQ (%DEPENDENT-PROPOSITIONS-LIST SELF) NULL))
   (REMOVE-DELETED-MEMBERS (%DEPENDENT-PROPOSITIONS-LIST SELF)))
  (CL:WHEN (CL:NOT (CL:EQ (%DEPENDENT-ISA-PROPOSITIONS-LIST SELF) NULL))
   (REMOVE-DELETED-MEMBERS (%DEPENDENT-ISA-PROPOSITIONS-LIST SELF)))
  (CL:LET*
   ((TABLE (%PREDICATE-PROPOSITIONS-TABLE SELF))
    (HASHTABLE (CL:IF (CL:NOT (CL:EQ TABLE NULL)) (%THE-STELLA-HASH-TABLE TABLE) NULL)))
   (CL:WHEN (CL:NOT (CL:EQ HASHTABLE NULL))
    (CL:LET* ((KEY NULL) (INDEX NULL) (ITER-000 (ALLOCATE-ITERATOR HASHTABLE)))
     (CL:LOOP WHILE (NEXT? ITER-000) DO (CL:SETQ KEY (%KEY ITER-000)) (CL:SETQ INDEX (%VALUE ITER-000))
      (CL:SETQ KEY KEY) (REMOVE-DELETED-MEMBERS INDEX))))
   SELF))
   ...
   (CL:LET* ((TEST-VALUE-000 (SAFE-PRIMARY-TYPE ARGUMENT)))
    (CL:COND
     ((SUBTYPE-OF-INTEGER? TEST-VALUE-000)
      (CL:PROGN
       (CL:LET* ((VALUE (%WRAPPER-VALUE ARGUMENT))) (CL:DECLARE (CL:TYPE CL:FIXNUM VALUE))
        (CL:SETQ WRAPPER (LOOKUP *INTEGER-LOGIC-WRAPPER-TABLE* VALUE))
        (CL:WHEN (CL:EQ WRAPPER NULL) (CL:SETQ WRAPPER (NEW-INTEGER-LOGIC-WRAPPER VALUE))
         (INSERT-AT *INTEGER-LOGIC-WRAPPER-TABLE* VALUE WRAPPER)))))
     ((SUBTYPE-OF-FLOAT? TEST-VALUE-000)
      (CL:PROGN
       (CL:LET* ((VALUE (%WRAPPER-VALUE ARGUMENT))) (CL:DECLARE (CL:TYPE CL:DOUBLE-FLOAT VALUE))
        (CL:SETQ WRAPPER (LOOKUP *FLOAT-LOGIC-WRAPPER-TABLE* VALUE))
        (CL:WHEN (CL:EQ WRAPPER NULL) (CL:SETQ WRAPPER (NEW-FLOAT-LOGIC-WRAPPER VALUE))
         (INSERT-AT *FLOAT-LOGIC-WRAPPER-TABLE* VALUE WRAPPER)))))
     ((SUBTYPE-OF-STRING? TEST-VALUE-000)
      (CL:PROGN
       (CL:LET* ((VALUE (%WRAPPER-VALUE ARGUMENT))) (CL:DECLARE (CL:TYPE CL:SIMPLE-STRING VALUE))
        (CL:SETQ WRAPPER (LOOKUP *STRING-LOGIC-WRAPPER-TABLE* VALUE))
        (CL:WHEN (CL:EQ WRAPPER NULL) (CL:SETQ WRAPPER (NEW-STRING-LOGIC-WRAPPER VALUE))
         (INSERT-AT *STRING-LOGIC-WRAPPER-TABLE* VALUE WRAPPER)))))
     ((SUBTYPE-OF? TEST-VALUE-000 SGT-BACKLINKS-STELLA-LITERAL-WRAPPER)
      (CL:PROGN
       (%%PRINT-STREAM (%NATIVE-STREAM STANDARD-OUTPUT) "Backlinking not implemented on literal of type: `"
      ...
      (CL:WHEN TEST-VALUE-000
       (CL:LET* ((ALWAYS?-000 CL:T))
        (CL:LET* ((T NULL) (ITER-000 (BUT-LAST (%IO-VARIABLE-TYPES DESCRIPTION))))
         (CL:LOOP WHILE (NEXT? ITER-000) DO (CL:SETQ T (%VALUE ITER-000))
          (CL:WHEN (CL:NOT (LOGICAL-SUBTYPE-OF-LITERAL? T)) (CL:SETQ ALWAYS?-000 CL:NIL) (CL:RETURN))))
...
(CL:DEFUN REWRAP-ITH-ARGUMENT? (ARGUMENT PROPOSITION I)
  ...
  (CL:LET* ((TEST-VALUE-000 (SAFE-PRIMARY-TYPE ARGUMENT)))
   (CL:COND ((SUBTYPE-OF? TEST-VALUE-000 SGT-BACKLINKS-LOGIC-LOGIC-OBJECT) (CL:PROGN CL:NIL))
    ((SUBTYPE-OF? TEST-VALUE-000 SGT-BACKLINKS-LOGIC-PROPOSITION) (CL:PROGN CL:NIL))
    ((SUBTYPE-OF-SURROGATE? TEST-VALUE-000) (CL:PROGN CL:NIL))
    ((SUBTYPE-OF? TEST-VALUE-000 SGT-BACKLINKS-STELLA-THING) (CL:PROGN CL:NIL))
  ...
  (CL:LET*
   ...
   (CL:LOOP WHILE (CL:< INDEX-000 LENGTH-000) DO
    ...
    (CL:WHEN (CL:AND (CL:NOT (CL:EQ ARG NULL)) (REWRAP-ITH-ARGUMENT? ARG SELF I))
     (CL:LET ((SELF (%THE-ARRAY (%ARGUMENTS SELF))) (VALUE (REWRAP-ARGUMENT ARG)) (POSITION I))
     ...
     (CL:COND ((CL:EQ RELATION NULL) (%DEPENDENT-PROPOSITIONS SELF))
      (CL:T
       (CL:LET* ((DEPENDENTS (CREATE-SEQUENCE-INDEX KWD-BACKLINKS-NON-PAGING NULL)))
        (CL:LET* ((PROP NULL) (ITER-000 (ALLOCATE-ITERATOR (%DEPENDENT-PROPOSITIONS SELF))))
         (CL:LOOP WHILE (NEXT? ITER-000) DO (CL:SETQ PROP (%VALUE ITER-000))
          (CL:WHEN (CL:EQ (%OPERATOR PROP) RELATION) (PUSH DEPENDENTS PROP))))
        DEPENDENTS)))))
   (CL:T
    (CL:LET* ((INDEX (GET-BACKLINKS-INDEX SELF)) (ALLPROPOSITIONSINDEX NULL))
     ...
     (CL:LET*
      ((TABLE (%PREDICATE-PROPOSITIONS-TABLE INDEX))
       (LIST (CL:IF (CL:EQ TABLE NULL) ALLPROPOSITIONSINDEX (LOOKUP TABLE RELATION))))
         ...
         (PAGINGLIST
          (CL:IF (CL:NOT (CL:EQ STORE NULL))
           (CREATE-SEQUENCE-INDEX STORE
            (CONS KWD-BACKLINKS-RELATION (CONS (CL:IF (CL:EQ NIL NULL) NIL NIL) (CONS RELATION (CONS SELF NIL)))))
           NULL)))
  ...
  (CL:LET* ((RESULT (HELP-UNFILTERED-DEPENDENT-PROPOSITIONS SELF RELATION)))
   (CL:WHEN (CL:NOT (CL:EQ *ALL-OBJECT-STORES* NIL-LIST))
    (CL:LET* ((BASERESULT RESULT))
     (CL:COND
      ((CL:EQ RELATION NULL)
       (CL:SETQ RESULT (MAYBE-WRAP-SEQUENCE-INDEX BASERESULT NULL KWD-BACKLINKS-DEPENDENTS SELF NULL)))
        ...
        (CL:LET* ((INDEX (GET-BACKLINKS-INDEX SELF)))
         (CL:WHEN
          (CL:AND (CL:NOT (CL:EQ INDEX NULL))
           (CL:OR (CL:EQ BASERESULT (%DEPENDENT-PROPOSITIONS-LIST INDEX))
            (CL:EQ BASERESULT (%DEPENDENT-ISA-PROPOSITIONS-LIST INDEX))))
          (CL:LET* ((VALUE-000 NIL))
...
(CL:DEFUN ALL-SPECIALIZING-DEPENDENT-PROPOSITIONS-NEXT? (SELF)
  (CL:LET* ((ITERATOR (%ITERATOR-NESTED-ITERATOR SELF)) (RELATION (%%VALUE (%ITERATOR-CONS-LIST SELF))))
   (CL:LOOP
    ...
    (CL:SETQ RELATION (%%VALUE (%ITERATOR-CONS-LIST SELF)))
    (CL:WHEN (CL:EQ RELATION NULL) (CL:SETF (%VALUE SELF) NULL)
     (CL:RETURN-FROM ALL-SPECIALIZING-DEPENDENT-PROPOSITIONS-NEXT? CL:NIL))
    (CL:SETQ ITERATOR
     (ALLOCATE-ITERATOR
      (UNFILTERED-DEPENDENT-PROPOSITIONS (%ITERATOR-OBJECT SELF) (%SURROGATE-VALUE-INVERSE RELATION))))
...
(CL:DEFUN ALL-SPECIALIZING-DEPENDENT-PROPOSITIONS (SELF RELATIONREF)
  (CL:LET* ((RELATION (GET-DESCRIPTION RELATIONREF)))
   (CL:LET* ((SELF-000 (NEW-ALL-PURPOSE-ITERATOR))) (CL:SETF (%ITERATOR-OBJECT SELF-000) SELF)
    ...
    (CL:SETF (%ITERATOR-NEXT-CODE SELF-000) (CL:FUNCTION ALL-SPECIALIZING-DEPENDENT-PROPOSITIONS-NEXT?))
     ...
     (CL:PROGN
      (CL:LET*
       ((INDEX (GET-BACKLINKS-INDEX SELF))
        (LIST (CL:IF (CL:EQ INDEX NULL) NIL-NON-PAGING-INDEX (%DEPENDENT-ISA-PROPOSITIONS-LIST INDEX))))
         ...
         (CL:LET*
          ((STORE (%STORE LIST))
           (PAGINGLIST
            (CL:IF (CL:NOT (CL:EQ STORE NULL))
             (CREATE-SEQUENCE-INDEX STORE
              (CONS KWD-BACKLINKS-ISA (CONS (CL:IF (CL:EQ NIL NULL) NIL NIL) (CONS SELF NIL))))
             NULL)))
          (CL:WHEN (CL:NOT (CL:EQ PAGINGLIST NULL))
           (CL:LET* ((VALUE-000 NIL))
              ...
              (CL:WHEN (CL:EQ (%KIND PROP) KWD-BACKLINKS-ISA)
               (CL:IF (CL:EQ COLLECT-001 NULL)
                (CL:PROGN (CL:SETQ COLLECT-001 (CONS PROP NIL))
                 (CL:IF (CL:EQ VALUE-001 NIL) (CL:SETQ VALUE-001 COLLECT-001)
                  (ADD-CONS-TO-END-OF-CONS-LIST VALUE-001 COLLECT-001)))
              ...
              (CL:IF (CL:NOT (CL:EQ STORE NULL))
               (CREATE-SEQUENCE-INDEX STORE
                (CONS KWD-BACKLINKS-RELATION
                 (CONS (CL:IF (CL:EQ NIL NULL) NIL NIL) (CONS SGT-BACKLINKS-PL-KERNEL-KB-SUBSET-OF (CONS SELF NIL)))))
               NULL)))
            (CL:WHEN (CL:NOT (CL:EQ PAGINGLIST NULL))
             (CL:LET* ((VALUE-000 NIL))
              (CL:LET* ((PROP NULL) (ITER-000 (%THE-SEQUENCE LIST)) (COLLECT-000 NULL))
...
(CL:DEFUN INHERITS-TRUTH-FROM-MASTER? (SELF)
  (CL:LET* ((MASTER (DYNAMIC-SLOT-VALUE (%DYNAMIC-SLOTS SELF) SYM-BACKLINKS-LOGIC-MASTER-PROPOSITION NULL)))
   (CL:WHEN (CL:AND (CL:NOT (CL:EQ MASTER NULL)) (TRUE? MASTER)) (ASSIGN-TRUTH-VALUE SELF TRUE-WRAPPER)
     ...
     (ITER-000
      (ALLOCATE-ITERATOR
       (SELECT-RULE-PROPOSITIONS
        (MAKE-RULES-PATTERN (CL:IF (CL:EQ DIRECTION KWD-BACKLINKS-FORWARD) NULL SELF)
    ...
    (CL:LOOP WHILE (NEXT? ITER-000) DO (CL:SETQ P (%VALUE ITER-000))
     (CL:WHEN
      (CL:OR
       (CL:AND (TRUE? P)
        (CL:NOT
         (%WRAPPER-VALUE (DYNAMIC-SLOT-VALUE (%DYNAMIC-SLOTS P) SYM-BACKLINKS-LOGIC-SUBSUMPTION-LINK? FALSE-WRAPPER))))
...
(CL:DEFUN MAKE-RELATION-PATTERN-2 (RELATION ARGUMENT1 ARGUMENT2)
  (CONS KWD-BACKLINKS-RELATION
   (CONS (CL:IF (CL:EQ NIL NULL) NIL NIL) (CONS RELATION (CONS ARGUMENT1 (CONS ARGUMENT2 NIL))))))

;;; (DEFUN (MAKE-RELATION-PATTERN-3 SELECTION-PATTERN) ...)

(CL:DEFUN MAKE-RELATION-PATTERN-3 (RELATION ARGUMENT1 ARGUMENT2 ARGUMENT3)
  (CONS KWD-BACKLINKS-RELATION
   (CONS (CL:IF (CL:EQ NIL NULL) NIL NIL) (CONS RELATION (CONS ARGUMENT1 (CONS ARGUMENT2 (CONS ARGUMENT3 NIL)))))))
...
(CL:DEFUN MAKE-RELATION-PATTERN-4 (RELATION ARGUMENT1 ARGUMENT2 ARGUMENT3 ARGUMENT4)
  (CONS KWD-BACKLINKS-RELATION
   (CONS (CL:IF (CL:EQ NIL NULL) NIL NIL)
    (CONS RELATION (CONS ARGUMENT1 (CONS ARGUMENT2 (CONS ARGUMENT3 (CONS ARGUMENT4 NIL))))))))
...
(CL:DEFUN MAKE-RELATION-PATTERN-N (RELATION CL:&REST ARGUMENTS)
  (CL:LET* ((ARGLIST-000 NIL))
   ...
   (CL:LET*
    ((VALUE-000 (CONS KWD-BACKLINKS-RELATION (CONS (CL:IF (CL:EQ NIL NULL) NIL NIL) (CONS RELATION ARGLIST-000)))))
    VALUE-000)))
  ...
  (CL:LET* ((CANDIDATEKEYS (%%REST (%%REST PATTERN))))
   ...
   (CL:LET* ((KEY NULL) (ITER-000 CANDIDATEKEYS))
    (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-000 NIL)) DO (CL:SETQ KEY (%%VALUE ITER-000))
     (CL:COND
      ((SUBTYPE-OF? (SAFE-PRIMARY-TYPE KEY) SGT-BACKLINKS-LOGIC-LOGIC-OBJECT)
       (CL:PROGN
  ...
  (CL:LET* ((KIND (%%VALUE PATTERN)) (ARGUMENTS (%%REST (%%REST PATTERN))) (RESULT NULL))
   (CL:COND
    ((CL:EQ KIND KWD-BACKLINKS-DEPENDENTS)
     (CL:SETQ RESULT (UNFILTERED-DEPENDENT-PROPOSITIONS (%%VALUE ARGUMENTS) NULL)))
    ...
    (CL:T
     (CL:LET* ((STREAM-000 (NEW-OUTPUT-STRING-STREAM)))
      (%%PRINT-STREAM (%NATIVE-STREAM STREAM-000) "select-propositions: Can't yet handle pattern `" PATTERN "'")
      (CL:ERROR (NEW-STELLA-EXCEPTION (THE-STRING-READER STREAM-000))))))
   (CL:WHEN (CL:NOT (CL:EQ *ALL-OBJECT-STORES* NIL-LIST))
    (CL:SETQ RESULT (MAYBE-WRAP-SEQUENCE-INDEX RESULT PATTERN NULL NULL NULL)))
   RESULT))
  ...
  (CL:LET* ((OBJECT (%%VALUE (%%REST (%%REST PATTERN)))) (INDEX (UNFILTERED-DEPENDENT-ISA-PROPOSITIONS OBJECT)))
   (CL:COND
    ((SUBTYPE-OF? (SAFE-PRIMARY-TYPE INDEX) SGT-BACKLINKS-LOGIC-PAGING-INDEX)
     (CL:PROGN
      (CL:WHEN (CL:EQ (%%VALUE (%SELECTION-PATTERN INDEX)) KWD-BACKLINKS-ISA)
       (CL:RETURN-FROM SELECT-ISA-PROPOSITIONS INDEX))))
    (CL:T))
   (CL:LET* ((SEQUENCE (%THE-SEQUENCE INDEX)) (FILTEREDSEQUENCE NIL))
    (CL:WHEN (CL:EQ SEQUENCE NIL) (CL:RETURN-FROM SELECT-ISA-PROPOSITIONS NIL-NON-PAGING-INDEX))
    (CL:LET* ((PROP NULL) (ITER-000 SEQUENCE))
     (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-000 NIL)) DO (CL:SETQ PROP (%%VALUE ITER-000))
      (CL:WHEN (CL:AND (CL:EQ (%KIND PROP) KWD-BACKLINKS-ISA) (CL:NOT (DELETED? PROP)))
       (CL:SETQ FILTEREDSEQUENCE (CONS PROP FILTEREDSEQUENCE)))
      (CL:SETQ ITER-000 (%%REST ITER-000))))
    (CL:IF (CL:EQ FILTEREDSEQUENCE NIL) NIL-NON-PAGING-INDEX
     (CL:LET* ((SELF-000 (NEW-NON-PAGING-INDEX))) (CL:SETF (%THE-SEQUENCE SELF-000) FILTEREDSEQUENCE)
      (CL:LET* ((VALUE-000 SELF-000)) VALUE-000))))))
  ...
  (CL:LET* ((ARGUMENTS (%%REST (%%REST PATTERN))) (RELATION (%%VALUE ARGUMENTS)) (KEYS (%%REST ARGUMENTS)))
   (CL:LET* ((VALUE-000 NULL))
    (CL:LET* ((KEY NULL) (ITER-000 KEYS))
     (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-000 NIL)) DO (CL:SETQ KEY (%%VALUE ITER-000))
      (CL:WHEN (CL:AND (CL:NOT (CL:EQ KEY NULL)) (INSTANCE-HAS-BACKLINKS? KEY)) (CL:SETQ VALUE-000 KEY) (CL:RETURN))
      (CL:SETQ ITER-000 (%%REST ITER-000))))
     ...
     (CL:WHEN (CL:EQ ANCHOR NULL)
      (CL:LET* ((DESCRIPTION (GET-DESCRIPTION RELATION)))
       (CL:IF (CL:NOT (CL:EQ DESCRIPTION NULL))
        (CL:RETURN-FROM HELP-SELECT-RELATION-PROPOSITIONS (GET-DESCRIPTION-EXTENSION DESCRIPTION CL:T))
        (CL:RETURN-FROM HELP-SELECT-RELATION-PROPOSITIONS NIL-NON-PAGING-INDEX))))
     (CL:LET*
      ((INDEX (UNFILTERED-DEPENDENT-PROPOSITIONS ANCHOR RELATION)) (SEQUENCE (%THE-SEQUENCE INDEX))
       (FILTEREDSEQUENCE NIL) (ALLKEYVALUES NULL))
      (CL:COND
       ((SUBTYPE-OF? (SAFE-PRIMARY-TYPE INDEX) SGT-BACKLINKS-LOGIC-PAGING-INDEX)
        (CL:PROGN
         (CL:WHEN
          (CL:AND (CL:NOT (CL:EQ (%STORE INDEX) NULL))
           (CL:EQ (%%VALUE (%SELECTION-PATTERN INDEX)) KWD-BACKLINKS-RELATION))
      ...
      (CL:LET* ((PROP NULL) (ITER-001 SEQUENCE))
       (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-001 NIL)) DO (CL:SETQ PROP (%%VALUE ITER-001))
        (CL:TAGBODY
            ...
            (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-002 NIL)) DO (CL:SETQ KEY (%%VALUE ITER-002))
             (CL:IF (CL:EQ COLLECT-000 NULL)
              (CL:PROGN (CL:SETQ COLLECT-000 (CONS (VALUE-OF KEY) NIL))
               (CL:IF (CL:EQ ALLKEYVALUES NIL) (CL:SETQ ALLKEYVALUES COLLECT-000)
                (ADD-CONS-TO-END-OF-CONS-LIST ALLKEYVALUES COLLECT-000)))
              (CL:PROGN (CL:SETF (%%REST COLLECT-000) (CONS (VALUE-OF KEY) NIL))
               (CL:SETQ COLLECT-000 (%%REST COLLECT-000))))
          ...
          (CL:LET* ((ARGUMENTS (%ARGUMENTS PROP)))
           (CL:LET* ((TEST-VALUE-000 CL:NIL)) (CL:SETQ TEST-VALUE-000 (CL:NOT (CL:EQ ARGUMENTS NULL)))
            (CL:WHEN TEST-VALUE-000
             (CL:LET* ((ALWAYS?-000 CL:T))
              (CL:LET*
               ((KEY NULL) (ITER-003 ALLKEYVALUES) (ARG NULL) (VECTOR-000 ARGUMENTS) (INDEX-000 0)
                (LENGTH-000 (LENGTH VECTOR-000)))
               (CL:DECLARE (CL:TYPE CL:FIXNUM INDEX-000 LENGTH-000))
               (CL:LOOP WHILE (CL:AND (CL:NOT (CL:EQ ITER-003 NIL)) (CL:< INDEX-000 LENGTH-000)) DO
                 ...
                 (CL:NOT
                  (CL:OR (CL:EQ KEY NULL) (EQUAL? KEY (VALUE-OF ARG))
                   (CL:AND (ISA? KEY SGT-BACKLINKS-LOGIC-PROPOSITION)
                    (ISA? (VALUE-OF ARG) SGT-BACKLINKS-LOGIC-PROPOSITION)
         ...
         (CL:WHEN (CL:NOT (DELETED-PROPOSITION? PROP)) (CL:SETQ FILTEREDSEQUENCE (CONS PROP FILTEREDSEQUENCE)))
         :CONTINUE)
        (CL:SETQ ITER-001 (%%REST ITER-001))))
      (CL:IF (CL:EQ FILTEREDSEQUENCE NIL) NIL-NON-PAGING-INDEX
       (CL:LET* ((SELF-001 (NEW-NON-PAGING-INDEX))) (CL:SETF (%THE-SEQUENCE SELF-001) FILTEREDSEQUENCE)
...
(CL:DEFUN SELECT-RELATION-PROPOSITIONS (PATTERN)
  (CL:LET* ((ARGUMENTS (%%REST (%%REST PATTERN))) (RELATION (%%VALUE ARGUMENTS)) (KEY1 NULL) (KEY2 NULL))
    ...
    (CL:LET* ((MEMO-TABLE-000 NULL) (MEMOIZED-ENTRY-000 NULL) (MEMOIZED-VALUE-000 NULL))
     (CL:WHEN *MEMOIZATION-ENABLED?*
      ...
      (CL:WHEN (CL:EQ MEMO-TABLE-000 NULL)
       (INITIALIZE-MEMOIZATION-TABLE SGT-BACKLINKS-LOGIC-F-SELECT-RELATION-PROPOSITIONS-MEMO-TABLE-000
        "(:MAX-VALUES 50 :TIMESTAMPS (:KB-UPDATE))")
       (CL:SETQ MEMO-TABLE-000 (%SURROGATE-VALUE SGT-BACKLINKS-LOGIC-F-SELECT-RELATION-PROPOSITIONS-MEMO-TABLE-000)))
      (CL:SETQ MEMOIZED-ENTRY-000
       (LOOKUP-MRU-MEMOIZED-VALUE MEMO-TABLE-000 RELATION *CONTEXT* MEMOIZED-NULL-VALUE NULL 2))
    ...
    (CL:LET* ((MEMO-TABLE-001 NULL) (MEMOIZED-ENTRY-001 NULL) (MEMOIZED-VALUE-001 NULL))
     (CL:WHEN *MEMOIZATION-ENABLED?*
      ...
      (CL:WHEN (CL:EQ MEMO-TABLE-001 NULL)
       (INITIALIZE-MEMOIZATION-TABLE SGT-BACKLINKS-LOGIC-F-SELECT-RELATION-PROPOSITIONS-MEMO-TABLE-001
        "(:MAX-VALUES 1000 :TIMESTAMPS (:KB-UPDATE))")
       (CL:SETQ MEMO-TABLE-001 (%SURROGATE-VALUE SGT-BACKLINKS-LOGIC-F-SELECT-RELATION-PROPOSITIONS-MEMO-TABLE-001)))
      (CL:SETQ MEMOIZED-ENTRY-001
       (LOOKUP-MRU-MEMOIZED-VALUE MEMO-TABLE-001 RELATION KEY1 *CONTEXT* MEMOIZED-NULL-VALUE 4))
      (CL:SETQ MEMOIZED-VALUE-001 (%%VALUE MEMOIZED-ENTRY-001)))
     (CL:COND
      ((CL:NOT (CL:EQ MEMOIZED-VALUE-001 NULL))
       (CL:WHEN (CL:EQ MEMOIZED-VALUE-001 MEMOIZED-NULL-VALUE) (CL:SETQ MEMOIZED-VALUE-001 NULL)))
      (CL:T (CL:SETQ MEMOIZED-VALUE-001 (HELP-SELECT-RELATION-PROPOSITIONS PATTERN))
       (CL:WHEN *MEMOIZATION-ENABLED?*
        (CL:SETF (%%VALUE MEMOIZED-ENTRY-001)
         (CL:IF (CL:EQ MEMOIZED-VALUE-001 NULL) MEMOIZED-NULL-VALUE MEMOIZED-VALUE-001)))))
    ...
    (CL:LET* ((MEMO-TABLE-002 NULL) (MEMOIZED-ENTRY-002 NULL) (MEMOIZED-VALUE-002 NULL))
     (CL:WHEN *MEMOIZATION-ENABLED?*
      ...
      (CL:WHEN (CL:EQ MEMO-TABLE-002 NULL)
       (INITIALIZE-MEMOIZATION-TABLE SGT-BACKLINKS-LOGIC-F-SELECT-RELATION-PROPOSITIONS-MEMO-TABLE-002
        "(:MAX-VALUES 1000 :TIMESTAMPS (:KB-UPDATE))")
       (CL:SETQ MEMO-TABLE-002 (%SURROGATE-VALUE SGT-BACKLINKS-LOGIC-F-SELECT-RELATION-PROPOSITIONS-MEMO-TABLE-002)))
      (CL:SETQ MEMOIZED-ENTRY-002 (LOOKUP-MRU-MEMOIZED-VALUE MEMO-TABLE-002 RELATION KEY1 KEY2 *CONTEXT* 8))
      (CL:SETQ MEMOIZED-VALUE-002 (%%VALUE MEMOIZED-ENTRY-002)))
     (CL:COND
      ((CL:NOT (CL:EQ MEMOIZED-VALUE-002 NULL))
       (CL:WHEN (CL:EQ MEMOIZED-VALUE-002 MEMOIZED-NULL-VALUE) (CL:SETQ MEMOIZED-VALUE-002 NULL)))
      (CL:T (CL:SETQ MEMOIZED-VALUE-002 (HELP-SELECT-RELATION-PROPOSITIONS PATTERN))
       (CL:WHEN *MEMOIZATION-ENABLED?*
        (CL:SETF (%%VALUE MEMOIZED-ENTRY-002)
         (CL:IF (CL:EQ MEMOIZED-VALUE-002 NULL) MEMOIZED-NULL-VALUE MEMOIZED-VALUE-002)))))
...
(CL:DEFUN SELECT-RULE-PROPOSITIONS (PATTERN)
  (CL:LET*
   ((ARGUMENTS (%%REST (%%REST PATTERN))) (POSRELATION (%%VALUE ARGUMENTS)) (NEGRELATION (%%VALUE (%%REST ARGUMENTS)))
    (DESCRIPTION NULL) (STORE NULL))
   (CL:WHEN (CL:NOT (CL:EQ POSRELATION NULL))
    (CL:COND
     ((SUBTYPE-OF? (SAFE-PRIMARY-TYPE POSRELATION) SGT-BACKLINKS-LOGIC-DESCRIPTION)
   ...
   (CL:WHEN (CL:NOT (CL:EQ NEGRELATION NULL))
    (CL:COND
     ((SUBTYPE-OF? (SAFE-PRIMARY-TYPE NEGRELATION) SGT-BACKLINKS-LOGIC-DESCRIPTION)
      (CL:PROGN (CL:SETQ DESCRIPTION NEGRELATION)))
     (CL:T (CL:SETQ DESCRIPTION (GET-DESCRIPTION NEGRELATION)))))
   (CL:WHEN (CL:NOT (CL:EQ DESCRIPTION NULL)) (DERIVE-DEFERRED-SATELLITE-RULES DESCRIPTION)
   ...
   (CL:IF (CL:NOT (CL:EQ STORE NULL)) (CREATE-SEQUENCE-INDEX STORE PATTERN)
    (CL:IF (CL:NOT (CL:EQ DESCRIPTION NULL))
     (SELECT-RELATION-PROPOSITIONS
      (MAKE-RELATION-PATTERN-2 SGT-BACKLINKS-PL-KERNEL-KB-SUBSET-OF NEGRELATION POSRELATION))
...
(CL:DEFUN EVALUATE-SELECTION-PATTERN (PATTERN)
  (CL:SETQ PATTERN
   (MAKE-SELECTION-PATTERN (%%VALUE PATTERN)
    (LIST* KWD-BACKLINKS-EVALUATE? SYM-BACKLINKS-STELLA-TRUE (CONCATENATE (%%VALUE (%%REST PATTERN)) NIL))
    (%%REST (%%REST PATTERN))))
   ...
   (CL:LOOP WHILE (NEXT? ITER-000) DO (CL:SETQ PROPOSITION (%VALUE ITER-000))
    (CL:WHEN (KNOWN-TRUTH-VALUE? (ACCESS-IN-CONTEXT (%TRUTH-VALUE PROPOSITION) (%HOME-CONTEXT PROPOSITION) CL:NIL))
     (CL:RETURN-FROM EVALUATE-SELECTION-PATTERN
      (ACCESS-IN-CONTEXT (%TRUTH-VALUE PROPOSITION) (%HOME-CONTEXT PROPOSITION) CL:NIL)))))
  UNKNOWN-TRUTH-VALUE)
   ...
   (CL:LOOP WHILE (CL:NOT (CL:EQ OPTIONS NIL)) DO
    (CL:WHEN
     (CL:AND (CL:EQ (%%VALUE OPTIONS) KWD-BACKLINKS-EVALUATE?)
      (CL:EQ (COERCE-TO-BOOLEAN (%%VALUE (%%REST OPTIONS))) TRUE-WRAPPER))
...
(CL:DEFUN COUNT-BACKLINKS-ON-RELATION (SELF KIND RELATION)
  (CL:LET*
   ((INDEX (GET-BACKLINKS-INDEX SELF))
    (EQUIVALENTS (CL:IF (ISA? SELF SGT-BACKLINKS-LOGIC-LOGIC-OBJECT) (VARIABLE-VALUE-INVERSE SELF) NIL)) (COUNT 0))
   (CL:DECLARE (CL:TYPE CL:FIXNUM COUNT))
   (CL:WHEN (CL:EQ INDEX NULL) (CL:RETURN-FROM COUNT-BACKLINKS-ON-RELATION NULL-INTEGER))
   (CL:SETQ COUNT
    (ESTIMATED-LENGTH
     (SELECT-PROPOSITIONS
      (CONS KWD-BACKLINKS-RELATION (CONS (CL:IF (CL:EQ NIL NULL) NIL NIL) (CONS RELATION (CONS SELF NIL)))))))
   (CL:WHEN
    (CL:AND (CL:= COUNT 0) (CL:NOT (CL:EQ (ALL-DIRECT-SUBRELATIONS (SURROGATE-TO-DESCRIPTION RELATION) CL:NIL) NIL)))
    (CL:SETQ COUNT 1))
   (CL:LET* ((EQUIV NULL) (ITER-000 EQUIVALENTS))
    (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-000 NIL)) DO (CL:SETQ EQUIV (%%VALUE ITER-000))
     (CL:SETQ COUNT (CL:+ COUNT (COUNT-BACKLINKS-ON-RELATION EQUIV KIND RELATION)))
     (CL:SETQ ITER-000 (%%REST ITER-000))))
   COUNT))
...
(CL:DEFUN SELECT-ARGUMENT-WITH-BACKLINKS (PROPOSITION)
  (CL:LET*
   ((RELATION (%OPERATOR PROPOSITION)) (KIND (%KIND PROPOSITION)) (VALUE NULL) (COUNT NULL-INTEGER)
    (LOWESTBACKLINKCOUNT NULL-INTEGER) (BESTARGUMENT NULL) (FOUNDDISCOURAGEDARGUMENT? CL:NIL))
    ...
    (CL:LOOP WHILE (CL:< INDEX-000 LENGTH-000) DO
     ...
     (CL:TAGBODY (CL:SETQ VALUE (ARGUMENT-BOUND-TO ARG))
      (CL:WHEN (CL:NOT (CL:EQ VALUE NULL)) (CL:WHEN CL:NIL (CL:SETQ FOUNDDISCOURAGEDARGUMENT? CL:T) (CL:GO :CONTINUE))
       ...
       (CL:WHEN
        (CL:AND (CL:NOT (CL:= COUNT NULL-INTEGER))
         (CL:OR (CL:= LOWESTBACKLINKCOUNT NULL-INTEGER) (CL:< COUNT LOWESTBACKLINKCOUNT)))
   ...
   (CL:WHEN (CL:AND (CL:= LOWESTBACKLINKCOUNT NULL-INTEGER) FOUNDDISCOURAGEDARGUMENT?)
    (CL:LET* ((ARG NULL) (VECTOR-001 (%ARGUMENTS PROPOSITION)) (INDEX-001 0) (LENGTH-001 (LENGTH VECTOR-001)))
     ...
     (CL:LOOP WHILE (CL:< INDEX-001 LENGTH-001) DO
      ...
      (CL:TAGBODY (CL:SETQ VALUE (ARGUMENT-BOUND-TO ARG))
       (CL:WHEN (CL:NOT (CL:EQ VALUE NULL)) (CL:WHEN (CL:NOT CL:NIL) (CL:GO :CONTINUE))
        (CL:SETQ COUNT (COUNT-BACKLINKS-ON-RELATION VALUE KIND RELATION))
        (CL:WHEN
         (CL:AND (CL:NOT (CL:= COUNT NULL-INTEGER))
          (CL:OR (CL:= LOWESTBACKLINKCOUNT NULL-INTEGER) (CL:< COUNT LOWESTBACKLINKCOUNT)))
   ...
   (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-000 NIL)) DO (CL:SETQ I (%%VALUE ITER-000))
    (CL:WHEN (CL:AND (CL:NOT (CL:EQ I NULL)) (CL:NOT CL:NIL))
     (CL:LET* ((VALUE (VALUE-OF I)))
      (CL:WHEN (INSTANCE-HAS-BACKLINKS? VALUE) (CL:RETURN-FROM SELECT-INSTANCE-WITH-BACKLINKS VALUE))))
    (CL:SETQ ITER-000 (%%REST ITER-000))))
     ...
     (CL:LOOP WHILE (NEXT? ITER-000) DO (CL:SETQ ARG (%VALUE ITER-000))
      (CL:WHEN (INSTANCE-HAS-BACKLINKS? (VALUE-OF ARG))
       (CL:RETURN-FROM FIND-SIMILAR-PROPOSITIONS
        (UNFILTERED-DEPENDENT-PROPOSITIONS (VALUE-OF ARG) (%OPERATOR SELF)))))))
   (CL:T
...
(CL:DEFUN FIND-MATCHING-CONCEIVED-PROPOSITION (GOAL)
  (CL:LET* ((TEST-VALUE-000 (%KIND GOAL)))
   (CL:COND
    ((CL:OR (CL:EQ TEST-VALUE-000 KWD-BACKLINKS-PREDICATE) (CL:EQ TEST-VALUE-000 KWD-BACKLINKS-FUNCTION)
      (CL:EQ TEST-VALUE-000 KWD-BACKLINKS-ISA) (CL:EQ TEST-VALUE-000 KWD-BACKLINKS-EQUIVALENT))
     (CL:LET* ((BACKLINKEDARGUMENT (SELECT-ARGUMENT-WITH-BACKLINKS GOAL)))
      ...
      (CL:LET* ((VALUE-000 NULL))
       (CL:LET*
        ((P NULL)
         (ITER-000 (ALLOCATE-ITERATOR (UNFILTERED-DEPENDENT-PROPOSITIONS BACKLINKEDARGUMENT (%OPERATOR GOAL)))))
        (CL:LOOP WHILE (NEXT? ITER-000) DO (CL:SETQ P (%VALUE ITER-000))
         (CL:WHEN (CL:AND (CL:EQ (%OPERATOR P) (%OPERATOR GOAL)) (ARGUMENTS-MATCH-ARGUMENTS? P GOAL))
...
(CL:DEFUN TRANSFER-PROPOSITIONS-EXCEPT-FOR (FROM TO EXCEPTPROPOSITIONS)
  ...
  (CL:LET* ((VALUE-000 NIL))
   ...
   (CL:LET* ((TOPROPOSITIONS VALUE-000) (TOVALUE NULL))
    (CL:WHEN (CL:EQ EXCEPTPROPOSITIONS NULL) (CL:SETQ EXCEPTPROPOSITIONS NIL-LIST))
      ...
      (CL:LOOP WHILE (NEXT? ITER-001) DO (CL:SETQ P (%VALUE ITER-001))
       (CL:WHEN (CL:NOT (MEMBER? EXCEPTPROPOSITIONS P))
        (CL:IF (%WRAPPER-VALUE (DYNAMIC-SLOT-VALUE (%DYNAMIC-SLOTS P) SYM-BACKLINKS-LOGIC-DESCRIPTIVE? FALSE-WRAPPER))
         ...
         (CL:SETQ *EVALUATIONMODE* KWD-BACKLINKS-EXTENSIONAL-ASSERTION))
        (CL:SETQ TOVALUE (EVALUATE-TERM TO))
        (CL:LET*
         ((ARG NULL) (VECTOR-000 (%ARGUMENTS P)) (INDEX-000 0) (LENGTH-000 (LENGTH VECTOR-000)) (I NULL-INTEGER)
          (ITER-002 0))
         ...
         (CL:LOOP WHILE (CL:< INDEX-000 LENGTH-000) DO
          ...
          (CL:WHEN (EQL? ARG FROM)
           (CL:LET ((SELF (%THE-ARRAY (%ARGUMENTS P))) (VALUE TOVALUE) (POSITION I))
            (CL:DECLARE (CL:TYPE CL:SIMPLE-VECTOR SELF) (CL:TYPE CL:FIXNUM POSITION))
            (CL:SETF (CL:AREF SELF POSITION) VALUE)))
         ...
         (CL:LET* ((FOUND?-000 CL:NIL))
          (CL:LET* ((TOP NULL) (ITER-003 TOPROPOSITIONS))
           (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-003 NIL)) DO (CL:SETQ TOP (%%VALUE ITER-003))
            (CL:WHEN (EQUIVALENT-PROPOSITIONS? P TOP NULL) (CL:SETQ FOUND?-000 CL:T) (CL:RETURN))
            (CL:SETQ ITER-003 (%%REST ITER-003))))
          (CL:SETQ TEST-VALUE-000 FOUND?-000))
         (CL:SETQ TEST-VALUE-000 (CL:NOT TEST-VALUE-000))
         (CL:WHEN TEST-VALUE-000 (REMOVE-DEPENDENT-PROPOSITION-LINK FROM P)
...
(CL:DEFUN GET-DESCRIPTION-EXTENSION (DESCRIPTION UPDATE?)
  (CL:LET* ((EXTENSION (%EXTENSION DESCRIPTION)) (RESULT NULL))
   (CL:COND
    ((CL:AND (CL:NOT (CL:EQ EXTENSION NULL)) (CL:NOT (CL:EQ EXTENSION NIL-PAGING-INDEX))) (CL:SETQ RESULT EXTENSION))
    (UPDATE?
     (CL:SETQ EXTENSION
      (CREATE-SEQUENCE-INDEX KWD-BACKLINKS-PAGING
       (CONS KWD-BACKLINKS-RELATION
        (CONS (CL:IF (CL:EQ NIL NULL) NIL NIL) (CONS (%SURROGATE-VALUE-INVERSE DESCRIPTION) NIL)))))
     (CL:SETF (%EXTENSION DESCRIPTION) EXTENSION) (CL:SETQ RESULT EXTENSION))
    (CL:T (CL:SETQ RESULT NIL-PAGING-INDEX)))
   (CL:WHEN (CL:NOT (CL:EQ *ALL-OBJECT-STORES* NIL-LIST))
    (CL:SETQ RESULT
     (MAYBE-WRAP-SEQUENCE-INDEX RESULT NULL KWD-BACKLINKS-RELATION (%SURROGATE-VALUE-INVERSE DESCRIPTION) NULL)))
   RESULT))
...
(CL:DEFUN CLEANUP-ALL-DESCRIPTION-EXTENSIONS ()
  (CL:LET* ((DESCRIPTION NULL) (ITER-000 (ALL-NAMED-DESCRIPTIONS NULL CL:NIL)))
   (CL:LOOP WHILE (NEXT? ITER-000) DO (CL:SETQ DESCRIPTION (%VALUE ITER-000))
    (CL:WHEN
     (CL:AND (CL:NOT (CL:EQ (%EXTENSION DESCRIPTION) NULL)) (CL:NOT (CL:EQ (%EXTENSION DESCRIPTION) NIL-PAGING-INDEX)))
     (REMOVE-DELETED-MEMBERS (%EXTENSION DESCRIPTION))))))
...
(CL:DEFUN UPDATE-DESCRIPTION-EXTENSION (SELF)
  ...
  (CL:LET* ((TEST-VALUE-000 (%KIND SELF)))
   (CL:COND
    ((CL:OR (CL:EQ TEST-VALUE-000 KWD-BACKLINKS-ISA) (CL:EQ TEST-VALUE-000 KWD-BACKLINKS-PREDICATE)
     ...
     (CL:LET* ((DESCRIPTION (GET-DESCRIPTION (%OPERATOR SELF))))
      (CL:LET* ((ARG NULL) (VECTOR-000 (%ARGUMENTS SELF)) (INDEX-000 0) (LENGTH-000 (LENGTH VECTOR-000)))
       ...
       (CL:LOOP WHILE (CL:< INDEX-000 LENGTH-000) DO
        ...
        (CL:LET* ((TEST-VALUE-001 (SAFE-PRIMARY-TYPE ARG)))
         (CL:COND
          ((SUBTYPE-OF? TEST-VALUE-001 SGT-BACKLINKS-LOGIC-PATTERN-VARIABLE)
           (CL:PROGN (CL:RETURN-FROM UPDATE-DESCRIPTION-EXTENSION)))
          ((SUBTYPE-OF? TEST-VALUE-001 SGT-BACKLINKS-LOGIC-SKOLEM)
           (CL:PROGN
            (CL:WHEN
             (CL:OR (CL:AND (CLASS-DESCRIPTION? DESCRIPTION) (LITERAL-TYPE? (%SURROGATE-VALUE-INVERSE DESCRIPTION)))
              *SUPPRESSINSERTIONINTOCLASSEXTENSION?*
              (%WRAPPER-VALUE
               (DYNAMIC-SLOT-VALUE (%DYNAMIC-SLOTS ARG) SYM-BACKLINKS-LOGIC-HYPOTHESIZED-INSTANCE? FALSE-WRAPPER)))
             (CL:RETURN-FROM UPDATE-DESCRIPTION-EXTENSION))))
          ((SUBTYPE-OF? TEST-VALUE-001 SGT-BACKLINKS-LOGIC-LOGIC-OBJECT)
           (CL:PROGN
            (CL:WHEN
      ...
      (CL:WHEN (CL:NOT *LOADINGREGENERABLEOBJECTS?*) (INSERT (%EXTENSION DESCRIPTION) SELF))))
    (CL:T))))

;;; (DEFUN (ALL-EXTENSION-MEMBERS ITERATOR) ...)

(CL:DEFUN ALL-EXTENSION-MEMBERS (DESCRIPTION)
  (CL:LET* ((EXTENSION (GET-DESCRIPTION-EXTENSION DESCRIPTION CL:T))) (REMOVE-DELETED-MEMBERS EXTENSION)
   (ALLOCATE-ITERATOR EXTENSION)))
...
(CL:DEFUN HELP-STARTUP-BACKLINKS1 ()
  (CL:PROGN (CL:SETQ SGT-BACKLINKS-LOGIC-PATTERN-VARIABLE (INTERN-RIGID-SYMBOL-WRT-MODULE "PATTERN-VARIABLE" NULL 1))
   ...
   (CL:SETQ SYM-BACKLINKS-LOGIC-DEPENDENT-PROPOSITIONS-INDEX
    (INTERN-RIGID-SYMBOL-WRT-MODULE "DEPENDENT-PROPOSITIONS-INDEX" NULL 0))
   ...
   (CL:SETQ KWD-BACKLINKS-ISA (INTERN-RIGID-SYMBOL-WRT-MODULE "ISA" NULL 2))
   (CL:SETQ KWD-BACKLINKS-RELATION (INTERN-RIGID-SYMBOL-WRT-MODULE "RELATION" NULL 2))
   ...
   (CL:SETQ SGT-BACKLINKS-LOGIC-F-SELECT-RELATION-PROPOSITIONS-MEMO-TABLE-000
    (INTERN-RIGID-SYMBOL-WRT-MODULE "F-SELECT-RELATION-PROPOSITIONS-MEMO-TABLE-000" NULL 1))
   (CL:SETQ SGT-BACKLINKS-LOGIC-F-SELECT-RELATION-PROPOSITIONS-MEMO-TABLE-001
    (INTERN-RIGID-SYMBOL-WRT-MODULE "F-SELECT-RELATION-PROPOSITIONS-MEMO-TABLE-001" NULL 1))
   (CL:SETQ SGT-BACKLINKS-LOGIC-F-SELECT-RELATION-PROPOSITIONS-MEMO-TABLE-002
    (INTERN-RIGID-SYMBOL-WRT-MODULE "F-SELECT-RELATION-PROPOSITIONS-MEMO-TABLE-002" NULL 1))
...
(CL:DEFUN HELP-STARTUP-BACKLINKS2 ()
  (CL:PROGN
   (DEFINE-FUNCTION-OBJECT "TYPE-HAS-BACKLINKS?" "(DEFUN (TYPE-HAS-BACKLINKS? BOOLEAN) ((TYPE TYPE)))"
...
first class logic objects.\" :PUBLIC? TRUE :ALLOCATION :DYNAMIC)")
   (DEFINE-FUNCTION-OBJECT "CREATE-BACKLINKS-INDEX" "(DEFUN (CREATE-BACKLINKS-INDEX BACKLINKS-INDEX) ((SELF OBJECT)))"
    (CL:FUNCTION CREATE-BACKLINKS-INDEX) NULL)
   (DEFINE-FUNCTION-OBJECT "GET-BACKLINKS-INDEX" "(DEFUN (GET-BACKLINKS-INDEX BACKLINKS-INDEX) ((SELF OBJECT)))"
   ...
   (DEFINE-METHOD-OBJECT "(DEFMETHOD (REMOVE-DELETED-MEMBERS (LIKE SELF)) ((SELF BACKLINKS-INDEX)))"
    (CL:FUNCTION REMOVE-DELETED-MEMBERS) NULL)
   (DEFINE-FUNCTION-OBJECT "REWRAP-ARGUMENT" "(DEFUN (REWRAP-ARGUMENT OBJECT) ((ARGUMENT OBJECT)))"
    (CL:FUNCTION REWRAP-ARGUMENT) NULL)
   (DEFINE-FUNCTION-OBJECT "INDEX-ITH-DOMAIN?"
    "(DEFUN (INDEX-ITH-DOMAIN? BOOLEAN) ((DESCRIPTION NAMED-DESCRIPTION) (I INTEGER)))" (CL:FUNCTION INDEX-ITH-DOMAIN?)
    NULL)
   ...
   (DEFINE-FUNCTION-OBJECT "REWRAP-PROPOSITION-ARGUMENTS" "(DEFUN REWRAP-PROPOSITION-ARGUMENTS ((SELF PROPOSITION)))"
    (CL:FUNCTION REWRAP-PROPOSITION-ARGUMENTS) NULL)
   (DEFINE-FUNCTION-OBJECT "HELP-UNFILTERED-DEPENDENT-PROPOSITIONS"
    "(DEFUN (HELP-UNFILTERED-DEPENDENT-PROPOSITIONS PROPOSITIONS-INDEX) ((SELF OBJECT) (RELATION SURROGATE)))"
    (CL:FUNCTION HELP-UNFILTERED-DEPENDENT-PROPOSITIONS) NULL)
   ...
   (DEFINE-FUNCTION-OBJECT "INHERITS-TRUTH-FROM-MASTER?"
    "(DEFUN (INHERITS-TRUTH-FROM-MASTER? BOOLEAN) ((SELF PROPOSITION)))" (CL:FUNCTION INHERITS-TRUTH-FROM-MASTER?)
    NULL)
   ...
   (DEFINE-FUNCTION-OBJECT "SELECT-PROPOSITIONS"
    "(DEFUN (SELECT-PROPOSITIONS PROPOSITIONS-INDEX) ((PATTERN SELECTION-PATTERN)))" (CL:FUNCTION SELECT-PROPOSITIONS)
    NULL)
   ...
   (DEFINE-FUNCTION-OBJECT "SURROGATIFY-DISCOURAGED-ARGUMENTS"
    "(DEFUN SURROGATIFY-DISCOURAGED-ARGUMENTS ((SELF PROPOSITION)))" (CL:FUNCTION SURROGATIFY-DISCOURAGED-ARGUMENTS)
    NULL)
   ...
   (DEFINE-FUNCTION-OBJECT "INSTANCE-HAS-BACKLINKS?" "(DEFUN (INSTANCE-HAS-BACKLINKS? BOOLEAN) ((SELF OBJECT)))"
   ...
   (DEFINE-FUNCTION-OBJECT "CLEANUP-ALL-DESCRIPTION-EXTENSIONS" "(DEFUN CLEANUP-ALL-DESCRIPTION-EXTENSIONS ())"
...
(CL:DEFUN STARTUP-BACKLINKS ()
  (CL:LET* ((*MODULE* (GET-STELLA-MODULE "/LOGIC" (> *STARTUP-TIME-PHASE* 1))) (*CONTEXT* *MODULE*))
   (CL:DECLARE (CL:SPECIAL *MODULE* *CONTEXT*)) (CL:WHEN (CURRENT-STARTUP-TIME-PHASE? 2) (HELP-STARTUP-BACKLINKS1))
   (CL:WHEN (CURRENT-STARTUP-TIME-PHASE? 4) (CL:SETQ *INTEGER-LOGIC-WRAPPER-TABLE* (NEW-INTEGER-HASH-TABLE))
   ...
   (CL:WHEN (CURRENT-STARTUP-TIME-PHASE? 7) (HELP-STARTUP-BACKLINKS2)
    (DEFINE-FUNCTION-OBJECT "UPDATE-DESCRIPTION-EXTENSION" "(DEFUN UPDATE-DESCRIPTION-EXTENSION ((SELF PROPOSITION)))"
     (CL:FUNCTION UPDATE-DESCRIPTION-EXTENSION) NULL)
    (DEFINE-FUNCTION-OBJECT "ALL-EXTENSION-MEMBERS"
     "(DEFUN (ALL-EXTENSION-MEMBERS ITERATOR) ((DESCRIPTION NAMED-DESCRIPTION)))" (CL:FUNCTION ALL-EXTENSION-MEMBERS)
     NULL)
    ...
    (DEFINE-FUNCTION-OBJECT "STARTUP-BACKLINKS" "(DEFUN STARTUP-BACKLINKS () :PUBLIC? TRUE)"
     (CL:FUNCTION STARTUP-BACKLINKS) NULL)
    (CL:LET* ((FUNCTION (LOOKUP-FUNCTION SYM-BACKLINKS-LOGIC-STARTUP-BACKLINKS)))
     (SET-DYNAMIC-SLOT-VALUE (%DYNAMIC-SLOTS FUNCTION) SYM-BACKLINKS-STELLA-METHOD-STARTUP-CLASSNAME
    ...
    (CL:SETQ *WRAPPED-TYPE-TABLE*
     (CONCATENATE *WRAPPED-TYPE-TABLE*
      (LIST* (LIST* SGT-BACKLINKS-LOGIC-INTEGER-LOGIC-WRAPPER SGT-BACKLINKS-STELLA-INTEGER NIL)
       (LIST* SGT-BACKLINKS-LOGIC-FLOAT-LOGIC-WRAPPER SGT-BACKLINKS-STELLA-FLOAT NIL)
       (LIST* SGT-BACKLINKS-LOGIC-STRING-LOGIC-WRAPPER SGT-BACKLINKS-STELLA-STRING NIL) NIL)))
    (DEFINE-STELLA-GLOBAL-VARIABLE-FROM-STRINGIFIED-SOURCE
