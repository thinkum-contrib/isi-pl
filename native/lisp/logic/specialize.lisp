...
(CL:DEFVAR SGT-SPECIALIZE-LOGIC-TEST-ISA?-MEMO-TABLE-001 NULL)
...
(CL:DEFVAR SGT-SPECIALIZE-LOGIC-ALL-SUPERCOLLECTIONS-MEMO-TABLE-000 NULL)
(CL:DEFVAR SGT-SPECIALIZE-PL-KERNEL-KB-MEMBER-OF NULL)
(CL:DEFVAR SGT-SPECIALIZE-LOGIC-ALL-SUPPORTED-NAMED-SUBCOLLECTIONS-MEMO-TABLE-000 NULL)
...
(CL:DECLAIM
  ...
  *DONTUSEDEFAULTKNOWLEDGE?* *CONTEXT* *MEMOIZATION-ENABLED?*
  MEMOIZED-NULL-VALUE TRUE-WRAPPER FALSE-WRAPPER NULL-INTEGER
  *CYC-KLUDGES-ENABLED?* *QUERYITERATOR* NIL-PAGING-INDEX NIL-NON-PAGING-INDEX
  FALSE *REVERSEPOLARITY?* TRUE-TRUTH-VALUE NIL TRUE))
...
(CL:DEFUN TRUE-PROPOSITIONS-ITERATOR.NEXT? (SELF)
  (CL:LET* ((CURSOR (%PROPOSITION-CURSOR SELF)) (PROPOSITION NULL))
   (CL:WHEN (CL:EQ CURSOR NULL)
    (CL:RETURN-FROM TRUE-PROPOSITIONS-ITERATOR.NEXT? FALSE))
   (CL:LOOP
    (CL:TAGBODY
     ...
     (CL:WHEN
      ...
      (CL:RETURN-FROM TRUE-PROPOSITIONS-ITERATOR.NEXT? TRUE))
     :CONTINUE))))
  ...
  (CL:LET* ((SPECIALIZINGRELATIONS (%SPECIALIZING-RELATIONS SELF)))
   (CL:LOOP
    (CL:WHEN (TRUE-PROPOSITIONS-ITERATOR.NEXT? SELF)
     ...
     (CL:RETURN-FROM SPECIALIZING-PROPOSITIONS-ITERATOR.NEXT? TRUE))
    ...
    (CL:WHEN (CL:EQ SPECIALIZINGRELATIONS NIL) (CL:SETF (%VALUE SELF) NULL)
     (CL:RETURN-FROM SPECIALIZING-PROPOSITIONS-ITERATOR.NEXT? FALSE))
    ...
    ((SUBTYPE-OF? (SAFE-PRIMARY-TYPE PRIMARYKEY)
     ...
     (CL:PROGN
      (CL:WHEN (CL:EQ (VARIABLE-VALUE-INVERSE PRIMARYKEY) NIL)
       (CL:RETURN-FROM EMPTY-PROPOSITIONS-INDEX? TRUE))))
    (CL:T (CL:RETURN-FROM EMPTY-PROPOSITIONS-INDEX? TRUE))))
  FALSE)
...
(CL:DEFUN ALL-TRUE-DEPENDENT-ISA-PROPOSITIONS (SELF)
  (CL:LET*
   ...
   (CL:IF (EMPTY-PROPOSITIONS-INDEX? INDEX SELF FALSE)
    EMPTY-PROPOSITIONS-ITERATOR
   ...
   (CL:LET* ((V-071 NIL))
    (CL:LET*
     ...
     (CL:LOOP WHILE (NEXT? ITER-000) DO (CL:SETQ PROP (%VALUE ITER-000))
      (CL:LET* ((ALWAYS?-000 TRUE))
       (CL:LET* ((I NULL-INTEGER) (A1 NULL) (ITER-001 ARGUMENTS) (ITER-002 0))
        (CL:DECLARE (CL:TYPE CL:FIXNUM ITER-002 I))
        (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-001 NIL)) DO
         (CL:PROGN (CL:SETQ A1 (%%VALUE ITER-001))
       ...
       (CL:WHEN ALWAYS?-000
        (CL:IF (CL:EQ COLLECT-000 NULL)
         (CL:PROGN (CL:SETQ COLLECT-000 (CONS PROP NIL))
          (CL:IF (CL:EQ V-071 NIL) (CL:SETQ V-071 COLLECT-000)
           (ADD-CONS-TO-END-OF-CONS-LIST V-071 COLLECT-000)))
         (CL:PROGN (CL:SETF (%%REST COLLECT-000) (CONS PROP NIL))
          (CL:SETQ COLLECT-000 (%%REST COLLECT-000))))))))
    (CL:LET* ((VALUE-000 V-071)) VALUE-000))))
...
(CL:DEFUN TEST-PROPERTY? (SELF RELATION)
  (CL:LET*
   ((MEMO-TABLE-000
     (%SURROGATE-VALUE SGT-SPECIALIZE-LOGIC-TEST-PROPERTY?-MEMO-TABLE-000))
...
(CL:DEFUN TEST-ISA? (MEMBER TYPE)
  (CL:COND ((CL:EQ TYPE SGT-SPECIALIZE-STELLA-THING) TRUE)
   ...
   (CL:T
    (CL:LET*
     ((MEMO-TABLE-001
       (%SURROGATE-VALUE SGT-SPECIALIZE-LOGIC-TEST-ISA?-MEMO-TABLE-001))
      (MEMOIZED-ENTRY-001 NULL) (MEMOIZED-VALUE-001 NULL))
     (CL:WHEN (CL:EQ MEMO-TABLE-001 NULL)
      (INITIALIZE-MEMOIZATION-TABLE
       SGT-SPECIALIZE-LOGIC-TEST-ISA?-MEMO-TABLE-001
    ...
    ((P NULL)
     (ITER-000
      (ALL-TRUE-DEPENDENT-PROPOSITIONS MEMBER
       SGT-SPECIALIZE-PL-KERNEL-KB-COLLECTIONOF TRUE)))
    (CL:LOOP WHILE (NEXT? ITER-000) DO (CL:SETQ P (%VALUE ITER-000))
     (CL:WHEN
      (CL:AND (CL:NOT (DELETED? P))
       (CL:IF *REVERSEPOLARITY?* (FALSE? P)
   ...
   (CL:IF (CL:NOT (CL:EQ ADJACENCYITERATOR NULL))
    ...
    (CL:PROGN
     ...
     (CL:WHEN (CL:EQ ADJACENCYITERATOR NULL)
      (CL:RETURN-FROM TRANSITIVE-CLOSURE-ITERATOR.NEXT? FALSE))))
   (CL:LOOP
    ...
    (CL:WHEN
     ...
     (CL:RETURN-FROM TRANSITIVE-CLOSURE-ITERATOR.NEXT? TRUE)))))
...
(CL:DEFUN ALL-DIRECTLY-LINKED-OBJECTS (SELF RELATION INVERSE?)
  (CL:LET*
   ((PATTERN
     (CL:IF INVERSE? (MAKE-RELATION-PATTERN-2 RELATION NULL SELF)
      (MAKE-RELATION-PATTERN-2 RELATION SELF NULL)))
    (INDEX (SELECT-PROPOSITIONS PATTERN)))
   (CL:WHEN (EMPTY-PROPOSITIONS-INDEX? INDEX SELF FALSE)
...
(CL:DEFUN ALL-DIRECT-SUPERCOLLECTIONS (SELF PERFORMFILTERING?)
  ...
  (CL:LET*
   ...
   (CL:LET*
    ((DIRECTSUPERS NIL) (EQUIVALENTS (ALL-EQUIVALENT-COLLECTIONS SELF TRUE)))
...
(CL:DEFUN ALL-DIRECT-SUBCOLLECTIONS (SELF PERFORMFILTERING?)
  ...
  (CL:LET*
   ...
   (CL:LET*
    ((DIRECTSUBS NIL) (EQUIVALENTS (ALL-EQUIVALENT-COLLECTIONS SELF TRUE)))
    (CL:IF (CL:NOT (CL:EQ (%%REST EQUIVALENTS) NIL))
     (CL:LET* ((E NULL) (ITER-000 EQUIVALENTS))
      (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-000 NIL)) DO
       (CL:PROGN (CL:SETQ E (%%VALUE ITER-000))
        (CL:SETQ ITER-000 (%%REST ITER-000)))
       (CL:LET* ((CHILD NULL) (ITER-001 (ALL-DIRECT-SUBCOLLECTIONS E FALSE)))
...
(CL:DEFUN ALL-SUPERCOLLECTIONS (SELF)
  (CL:LET*
   ((MEMO-TABLE-000
     (%SURROGATE-VALUE
      SGT-SPECIALIZE-LOGIC-ALL-SUPERCOLLECTIONS-MEMO-TABLE-000))
    (MEMOIZED-ENTRY-000 NULL) (MEMOIZED-VALUE-000 NULL))
   (CL:WHEN (CL:EQ MEMO-TABLE-000 NULL)
    (INITIALIZE-MEMOIZATION-TABLE
     SGT-SPECIALIZE-LOGIC-ALL-SUPERCOLLECTIONS-MEMO-TABLE-000
...
(CL:DEFUN ALL-ISA-COLLECTIONS (SELF)
  (CL:LET* ((COLLECTIONS NIL))
   (CL:LET*
    ((P NULL) (ITER-000 (ALL-TRUE-DEPENDENT-PROPOSITIONS SELF NULL FALSE)))
    (CL:LOOP WHILE (NEXT? ITER-000) DO (CL:SETQ P (%VALUE ITER-000))
...
(CL:DEFUN ALL-SUPPORTED-NAMED-SUBCOLLECTIONS (SELF)
  (CL:LET*
   ((MEMO-TABLE-000
     (%SURROGATE-VALUE
      SGT-SPECIALIZE-LOGIC-ALL-SUPPORTED-NAMED-SUBCOLLECTIONS-MEMO-TABLE-000))
    (MEMOIZED-ENTRY-000 NULL) (MEMOIZED-VALUE-000 NULL))
   (CL:WHEN (CL:EQ MEMO-TABLE-000 NULL)
    (INITIALIZE-MEMOIZATION-TABLE
     SGT-SPECIALIZE-LOGIC-ALL-SUPPORTED-NAMED-SUBCOLLECTIONS-MEMO-TABLE-000
...
(CL:DEFUN VALUE-CLASHES-WITH-SKOLEM? (SKOLEM VALUE)
  (CL:LET* ((TYPE (%SKOLEM-TYPE SKOLEM)))
   (CL:COND ((CL:EQ TYPE NULL) FALSE)
    ((CL:NOT (CHECK-TYPE? VALUE TYPE TRUE)) TRUE)
...
(CL:DEFUN ALL-CLASHING-PROPOSITIONS (SELF)
  (CL:WHEN (CL:NOT (CL:EQ (%KIND SELF) KWD-SPECIALIZE-FUNCTION))
   (CL:RETURN-FROM ALL-CLASHING-PROPOSITIONS EMPTY-PROPOSITIONS-ITERATOR))
  (CL:LET* ((BACKLINKEDARGUMENT (SELECT-ARGUMENT-WITH-BACKLINKS SELF)))
   (CL:WHEN (CL:EQ BACKLINKEDARGUMENT NULL)
    (CL:RETURN-FROM ALL-CLASHING-PROPOSITIONS EMPTY-PROPOSITIONS-ITERATOR))
   (CL:LET*
    ((PATTERN
      (CONS KWD-SPECIALIZE-RELATION
       (CONS (CL:IF (CL:EQ NIL NULL) NIL NIL)
        (CONS (%OPERATOR SELF) (CONS BACKLINKEDARGUMENT NIL)))))
     (INDEX (SELECT-PROPOSITIONS PATTERN)))
    (CL:WHEN (EMPTY-PROPOSITIONS-INDEX? INDEX BACKLINKEDARGUMENT FALSE)
     (CL:RETURN-FROM ALL-CLASHING-PROPOSITIONS EMPTY-PROPOSITIONS-ITERATOR))
     ...
     (CL:WHEN
      ...
      (CL:IF (CL:EQ COLLECT-000 NULL)
       ...
       (CL:PROGN (CL:SETF (%%REST COLLECT-000) (CONS CLASS NIL))
        (CL:SETQ COLLECT-000 (%%REST COLLECT-000)))))))
   (CL:LET* ((SLOT NULL) (ITER-001 (ALL-SLOTS NULL FALSE)) (COLLECT-001 NULL))
...
(CL:DEFUN HELP-STARTUP-SPECIALIZE1 ()
  (CL:PROGN
   ...
   (CL:SETQ SGT-SPECIALIZE-LOGIC-TEST-PROPERTY?-MEMO-TABLE-000
    (INTERN-RIGID-SYMBOL-WRT-MODULE "TEST-PROPERTY?-MEMO-TABLE-000" NULL 1))
   ...
   (CL:SETQ SGT-SPECIALIZE-LOGIC-TEST-ISA?-MEMO-TABLE-001
    (INTERN-RIGID-SYMBOL-WRT-MODULE "TEST-ISA?-MEMO-TABLE-001" NULL 1))
   (CL:SETQ SGT-SPECIALIZE-LOGIC-ACCESS-BINARY-VALUE-MEMO-TABLE-000
    (INTERN-RIGID-SYMBOL-WRT-MODULE "ACCESS-BINARY-VALUE-MEMO-TABLE-000" NULL
     1))
   ...
   (CL:SETQ SGT-SPECIALIZE-PL-KERNEL-KB-SUBSET-OF
    (INTERN-RIGID-SYMBOL-WRT-MODULE "SUBSET-OF"
     (GET-STELLA-MODULE "/PL-KERNEL-KB" TRUE) 1))
   (CL:SETQ SGT-SPECIALIZE-LOGIC-ALL-SUPERCOLLECTIONS-MEMO-TABLE-000
    (INTERN-RIGID-SYMBOL-WRT-MODULE "ALL-SUPERCOLLECTIONS-MEMO-TABLE-000" NULL
     1))
   ...
   (CL:SETQ
    ...
    (INTERN-RIGID-SYMBOL-WRT-MODULE
     "ALL-SUPPORTED-NAMED-SUBCOLLECTIONS-MEMO-TABLE-000" NULL 1))
...
but return a SUPPORTED-CLOSURE-ITERATOR instead.\" :PUBLIC? TRUE)"
   ...
   (CL:LET*
    ...
    (SET-DYNAMIC-SLOT-VALUE (%DYNAMIC-SLOTS FUNCTION)
     ...
     (WRAP-STRING "_Startup-Specialize") NULL-STRING-WRAPPER))))
