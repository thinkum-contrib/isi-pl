...
(CL:DECLAIM
 (CL:SPECIAL *STARTUP-TIME-PHASE* *MODULE* *DONTUSEDEFAULTKNOWLEDGE?* *CONTEXT* *MEMOIZATION-ENABLED?*
  MEMOIZED-NULL-VALUE TRUE-WRAPPER FALSE-WRAPPER NULL-INTEGER *CYC-KLUDGES-ENABLED?* *QUERYITERATOR* NIL-PAGING-INDEX
  NIL-NON-PAGING-INDEX *REVERSEPOLARITY?* TRUE-TRUTH-VALUE NIL))
...
(CL:DEFUN NEW-ABSTRACT-PROPOSITIONS-ITERATOR ()
  (CL:LET* ((SELF NULL)) (CL:SETQ SELF (CL:MAKE-INSTANCE (CL:QUOTE ABSTRACT-PROPOSITIONS-ITERATOR)))
   (CL:SETF (%FIRST-ITERATION? SELF) CL:T) (CL:SETF (%VALUE SELF) NULL) (CL:SETF (%EQUIVALENTS-STACK SELF) NULL)
   (CL:SETF (%PROPOSITION-CURSOR SELF) NULL) (CL:SETF (%SELECTION-PATTERN SELF) NULL) SELF))
...
(CL:DEFUN ACCESS-ABSTRACT-PROPOSITIONS-ITERATOR-SLOT-VALUE (SELF SLOTNAME VALUE SETVALUE?)
  (CL:COND
   ...
   ((CL:EQ SLOTNAME SYM-SPECIALIZE-LOGIC-PROPOSITION-CURSOR)
    (CL:IF SETVALUE? (CL:SETF (%PROPOSITION-CURSOR SELF) VALUE) (CL:SETQ VALUE (%PROPOSITION-CURSOR SELF))))
   ((CL:EQ SLOTNAME SYM-SPECIALIZE-LOGIC-EQUIVALENTS-STACK)
    (CL:IF SETVALUE? (CL:SETF (%EQUIVALENTS-STACK SELF) VALUE) (CL:SETQ VALUE (%EQUIVALENTS-STACK SELF))))
   (CL:T
...
(CL:DEFUN NEW-TRUE-PROPOSITIONS-ITERATOR ()
  (CL:LET* ((SELF NULL)) (CL:SETQ SELF (CL:MAKE-INSTANCE (CL:QUOTE TRUE-PROPOSITIONS-ITERATOR)))
   (CL:SETF (%FIRST-ITERATION? SELF) CL:T) (CL:SETF (%VALUE SELF) NULL) (CL:SETF (%EQUIVALENTS-STACK SELF) NULL)
   (CL:SETF (%PROPOSITION-CURSOR SELF) NULL) (CL:SETF (%SELECTION-PATTERN SELF) NULL)
   (CL:SETF (%TRUTH-VALUE SELF) NULL) SELF))
...
(CL:DEFUN NEW-SPECIALIZING-PROPOSITIONS-ITERATOR ()
  (CL:LET* ((SELF NULL)) (CL:SETQ SELF (CL:MAKE-INSTANCE (CL:QUOTE SPECIALIZING-PROPOSITIONS-ITERATOR)))
   (CL:SETF (%FIRST-ITERATION? SELF) CL:T) (CL:SETF (%VALUE SELF) NULL) (CL:SETF (%EQUIVALENTS-STACK SELF) NULL)
   (CL:SETF (%PROPOSITION-CURSOR SELF) NULL) (CL:SETF (%SELECTION-PATTERN SELF) NULL)
...
(CL:DEFUN PROPOSITIONS-ITERATOR-TRUTH-VALUE (SELF)
  (CL:LET* ((TEST-VALUE-000 (SAFE-PRIMARY-TYPE SELF)))
   (CL:COND
    ((SUBTYPE-OF? TEST-VALUE-000 SGT-SPECIALIZE-LOGIC-TRUE-PROPOSITIONS-ITERATOR) (CL:PROGN (%TRUTH-VALUE SELF)))
    ((SUBTYPE-OF? TEST-VALUE-000 SGT-SPECIALIZE-LOGIC-DESCRIPTION-EXTENSION-ITERATOR) (CL:PROGN (%TRUTH-VALUE SELF)))
    (CL:T NULL))))
...
(CL:DEFUN NEXT-EQUIVALENT-SELECTION-PATTERN (SELF)
  (CL:LET*
   ((PATTERN (%SELECTION-PATTERN SELF)) (KEYWITHEQUIVALENTS NULL) (EQUIVALENTSSTACK (%EQUIVALENTS-STACK SELF))
    (NEWSKOLEM NULL) (EQUIVALENTSKOLEMS NULL))
   (CL:WHEN (CL:EQ EQUIVALENTSSTACK NULL) (CL:SETQ KEYWITHEQUIVALENTS (FIND-SELECTION-KEY-WITH-EQUIVALENTS PATTERN))
   ...
   (CL:WHEN (CL:EQ EQUIVALENTSSTACK NULL) (CL:SETF (%EQUIVALENTS-STACK SELF) NIL)
    (CL:RETURN-FROM NEXT-EQUIVALENT-SELECTION-PATTERN NULL))
   (CL:WHEN (CL:EQ EQUIVALENTSSTACK NIL) (CL:RETURN-FROM NEXT-EQUIVALENT-SELECTION-PATTERN NULL))
   (CL:SETQ EQUIVALENTSKOLEMS (%%VALUE EQUIVALENTSSTACK)) (CL:SETQ NEWSKOLEM (%%VALUE EQUIVALENTSKOLEMS))
   (FIRST-SETTER EQUIVALENTSSTACK (%%REST EQUIVALENTSKOLEMS))
   (CL:WHEN (CL:EQ (%%VALUE EQUIVALENTSSTACK) NIL) (CL:SETQ EQUIVALENTSSTACK (%%REST EQUIVALENTSSTACK)))
   (CL:WHEN (CL:NOT (CL:EQ (VARIABLE-VALUE-INVERSE NEWSKOLEM) NIL))
    (CL:SETQ EQUIVALENTSSTACK (CONS (VARIABLE-VALUE-INVERSE NEWSKOLEM) EQUIVALENTSSTACK)))
   (CL:SETF (%EQUIVALENTS-STACK SELF) EQUIVALENTSSTACK)
   (CL:WHEN (CL:EQ KEYWITHEQUIVALENTS NULL) (CL:SETQ KEYWITHEQUIVALENTS (FIND-SELECTION-KEY-WITH-EQUIVALENTS PATTERN)))
...
(CL:DEFUN PROPOSITION-TRUTH-VALUE (PROPOSITION)
  (CL:LET* ((TRUTHVALUE (ACCESS-IN-CONTEXT (%TRUTH-VALUE PROPOSITION) (%HOME-CONTEXT PROPOSITION) CL:NIL)))
   (CL:IF (CL:NOT (CL:EQ TRUTHVALUE NULL)) TRUTHVALUE
    (CL:IF (CL:AND (CL:NOT *REVERSEPOLARITY?*) (FUNCTION-WITH-DEFINED-VALUE? PROPOSITION)) TRUE-TRUTH-VALUE NULL))))
...
(CL:DEFUN TRUE-PROPOSITIONS-ITERATOR.NEXT? (SELF)
  (CL:LET* ((CURSOR (%PROPOSITION-CURSOR SELF)) (PROPOSITION NULL))
   (CL:WHEN (CL:EQ CURSOR NULL) (CL:RETURN-FROM TRUE-PROPOSITIONS-ITERATOR.NEXT? CL:NIL))
   (CL:LOOP
    (CL:TAGBODY
     (CL:COND ((NEXT? CURSOR) (CL:SETQ PROPOSITION (%VALUE CURSOR)))
      (CL:T
       (CL:LET* ((PATTERN (NEXT-EQUIVALENT-SELECTION-PATTERN SELF)))
        (CL:COND
         ((CL:NOT (CL:EQ PATTERN NULL)) (CL:SETQ CURSOR (ALLOCATE-ITERATOR (SELECT-PROPOSITIONS PATTERN)))
     ...
     (CL:WHEN
      (CL:AND (CL:NOT (DELETED? PROPOSITION))
       (CL:IF *REVERSEPOLARITY?* (FALSE? PROPOSITION)
        (CL:OR (TRUE? PROPOSITION) (FUNCTION-WITH-DEFINED-VALUE? PROPOSITION))))
      (CL:SETF (%VALUE SELF) PROPOSITION) (CL:SETF (%TRUTH-VALUE SELF) (PROPOSITION-TRUTH-VALUE PROPOSITION))
...
(CL:DEFUN SPECIALIZING-PROPOSITIONS-ITERATOR.NEXT? (SELF)
  (CL:LET* ((SPECIALIZINGRELATIONS (%SPECIALIZING-RELATIONS SELF)))
   (CL:LOOP
    (CL:WHEN (TRUE-PROPOSITIONS-ITERATOR.NEXT? SELF)
     (CL:WHEN (CL:AND (CL:NOT (CL:EQ SPECIALIZINGRELATIONS NULL)) (CL:NOT (CL:EQ SPECIALIZINGRELATIONS NIL)))
      (CL:SETF (%TRUTH-VALUE SELF)
       (CONJOIN-TRUTH-VALUES (%TRUTH-VALUE SELF) (%%VALUE (%%REST (%%VALUE SPECIALIZINGRELATIONS))))))
    ...
    (CL:IF (CL:EQ SPECIALIZINGRELATIONS NULL)
     (CL:COND
      ((CL:EQ (%%VALUE (%SELECTION-PATTERN SELF)) KWD-SPECIALIZE-RELATION)
       (CL:LET*
        ((RELATIONDESCRIPTION (SURROGATE-TO-DESCRIPTION (%%VALUE (%%REST (%%REST (%SELECTION-PATTERN SELF)))))))
        (CL:IF (CL:NOT (CL:EQ RELATIONDESCRIPTION NULL))
         (CL:SETQ SPECIALIZINGRELATIONS (ALL-SUPPORTED-NAMED-SUBCOLLECTIONS RELATIONDESCRIPTION))
         (CL:SETQ SPECIALIZINGRELATIONS NIL))))
      (CL:T
       (CL:LET* ((STREAM-000 (NEW-OUTPUT-STRING-STREAM)))
        (%%PRINT-STREAM (%NATIVE-STREAM STREAM-000) "Illegal selection pattern in `" SELF "'")
        (CL:ERROR (NEW-STELLA-EXCEPTION (THE-STRING-READER STREAM-000))))))
    ...
    (CL:SETF (%PROPOSITION-CURSOR SELF) (ALLOCATE-ITERATOR (SELECT-PROPOSITIONS (%SELECTION-PATTERN SELF))))
...
(CL:DEFUN EMPTY-PROPOSITIONS-INDEX? (INDEX PRIMARYKEY SPECIALIZE?)
  (CL:WHEN (CL:AND (CL:NOT SPECIALIZE?) (CL:OR (CL:EQ INDEX NIL-PAGING-INDEX) (CL:EQ INDEX NIL-NON-PAGING-INDEX)))
   (CL:COND
    ((SUBTYPE-OF? (SAFE-PRIMARY-TYPE PRIMARYKEY) SGT-SPECIALIZE-LOGIC-LOGIC-OBJECT)
     (CL:PROGN
      (CL:WHEN (CL:EQ (VARIABLE-VALUE-INVERSE PRIMARYKEY) NIL) (CL:RETURN-FROM EMPTY-PROPOSITIONS-INDEX? CL:T))))
...
(CL:DEFUN ALL-TRUE-DEPENDENT-PROPOSITIONS (SELF RELATION SPECIALIZE?)
  (CL:WHEN (CL:NOT (CL:OR (CL:NOT (CL:EQ RELATION NULL)) (CL:NOT SPECIALIZE?)))
   (CL:ERROR "Safety violation: INTERNAL-ERROR: Expected defined relation argument"))
  (CL:LET*
   ((PATTERN
     (CL:IF (CL:NOT (CL:EQ RELATION NULL))
      (CONS KWD-SPECIALIZE-RELATION (CONS (CL:IF (CL:EQ NIL NULL) NIL NIL) (CONS RELATION (CONS (VALUE-OF SELF) NIL))))
   ...
   (CL:WHEN (EMPTY-PROPOSITIONS-INDEX? INDEX SELF SPECIALIZE?)
    (CL:RETURN-FROM ALL-TRUE-DEPENDENT-PROPOSITIONS EMPTY-PROPOSITIONS-ITERATOR))
   (CL:SETQ ITERATOR (CL:IF SPECIALIZE? (NEW-SPECIALIZING-PROPOSITIONS-ITERATOR) (NEW-TRUE-PROPOSITIONS-ITERATOR)))
   (CL:SETF (%SELECTION-PATTERN ITERATOR) PATTERN) (CL:SETF (%PROPOSITION-CURSOR ITERATOR) (ALLOCATE-ITERATOR INDEX))
   ITERATOR))
...
(CL:DEFUN ALL-TRUE-DEPENDENT-ISA-PROPOSITIONS (SELF)
  (CL:LET*
   ((PATTERN (CONS KWD-SPECIALIZE-ISA (CONS (CL:IF (CL:EQ NIL NULL) NIL NIL) (CONS (VALUE-OF SELF) NIL))))
    ...
    (CL:LET* ((ALWAYS?-000 CL:T))
     (CL:LET*
      ...
      (CL:LOOP WHILE (CL:AND (CL:< INDEX-000 LENGTH-000) (CL:< INDEX-001 LENGTH-001)) DO
       ...
       (CL:WHEN
        (CL:NOT (CL:AND (CL:NOT (NULL-INSTANCE? SUBARG)) (BIND-ARGUMENT-TO-VALUE? SUPERARG (VALUE-OF SUBARG) CL:NIL)))
   ...
   (CL:LET* ((ALWAYS?-000 CL:T))
    (CL:LET*
     ...
     (CL:LOOP WHILE (CL:AND (CL:< INDEX-000 LENGTH-000) (CL:< INDEX-001 LENGTH-001)) DO
      (CL:SETQ SUPERARG (CL:AREF (CL:THE CL:SIMPLE-VECTOR (%THE-ARRAY VECTOR-000)) INDEX-000))
      (CL:SETQ SUBARG (CL:AREF (CL:THE CL:SIMPLE-VECTOR (%THE-ARRAY VECTOR-001)) INDEX-001))
      (CL:WHEN (CL:NOT (EQL? (VALUE-OF SUPERARG) (VALUE-OF SUBARG))) (CL:SETQ ALWAYS?-000 CL:NIL) (CL:RETURN))
      (CL:SETQ INDEX-000 (CL:1+ INDEX-000)) (CL:SETQ INDEX-001 (CL:1+ INDEX-001))))
    (CL:SETQ TEST-VALUE-000 ALWAYS?-000))
   (CL:WHEN TEST-VALUE-000
    (CL:SETQ TEST-VALUE-000 (CL:= (LENGTH (%ARGUMENTS REFERENCEPROPOSITION)) (LENGTH (%ARGUMENTS SUBPROPOSITION)))))
...
(CL:DEFUN ALL-MATCHING-PROPOSITIONS (SELF)
  (CL:LET* ((BACKLINKEDARGUMENT NULL) (NOMATCHINGPROPOSITIONS? CL:NIL))
   ...
   (CL:WHEN (CL:EQ BACKLINKEDARGUMENT NULL)
    (CL:WHEN *REVERSEPOLARITY?* (CL:RETURN-FROM ALL-MATCHING-PROPOSITIONS EMPTY-PROPOSITIONS-ITERATOR))
      ...
      (CL:LET* ((FOUND?-000 CL:NIL))
       (CL:LET* ((ARG NULL) (VECTOR-000 (%ARGUMENTS SELF)) (INDEX-000 0) (LENGTH-000 (LENGTH VECTOR-000)))
        ...
        (CL:LOOP WHILE (CL:< INDEX-000 LENGTH-000) DO
         ...
         (CL:WHEN (CL:NOT (CL:EQ (ARGUMENT-BOUND-TO ARG) NULL)) (CL:SETQ FOUND?-000 CL:T) (CL:RETURN))
         (CL:SETQ INDEX-000 (CL:1+ INDEX-000))))
       (CL:SETQ TEST-VALUE-000 FOUND?-000))
      (CL:WHEN TEST-VALUE-000
       (CL:SETQ TEST-VALUE-000 (> (DYNAMICALLY-ESTIMATE-EXTENSION-SIZE (GET-DESCRIPTION (%OPERATOR SELF))) 500)))
   ...
   (CL:LET* ((PATTERNARGS NIL) (BINDING NULL))
    (CL:LET*
     ((ARG NULL) (VECTOR-001 (%ARGUMENTS SELF)) (INDEX-001 0) (LENGTH-001 (LENGTH VECTOR-001)) (COLLECT-000 NULL))
     ...
     (CL:LOOP WHILE (CL:< INDEX-001 LENGTH-001) DO
      ...
      (CL:WHEN
       (CL:AND (CL:NOT (CL:EQ BINDING NULL)) (ISA? BINDING SGT-SPECIALIZE-LOGIC-PROPOSITION)
    ...
    (CL:IF (CL:EQ (%%REST PATTERNARGS) NIL) (ALL-TRUE-DEPENDENT-PROPOSITIONS BACKLINKEDARGUMENT (%OPERATOR SELF) CL:T)
     (CL:LET*
      ((PATTERN
        (CONS KWD-SPECIALIZE-RELATION (CONS (CL:IF (CL:EQ NIL NULL) NIL NIL) (CONS (%OPERATOR SELF) PATTERNARGS)))))
...
(CL:DEFUN ALL-PROPOSITIONS-MATCHING-ARGUMENTS (ARGUMENTS RELATION SPECIALIZE?)
  (CL:LET* ((BACKLINKEDINSTANCE (SELECT-INSTANCE-WITH-BACKLINKS ARGUMENTS RELATION)))
   ...
   (CL:LET* ((VALUE-000 NIL))
    (CL:LET*
     ((PROP NULL) (ITER-000 (ALL-TRUE-DEPENDENT-PROPOSITIONS BACKLINKEDINSTANCE RELATION SPECIALIZE?))
      (COLLECT-000 NULL))
      ...
      (CL:LET* ((ALWAYS?-000 CL:T))
       (CL:LET* ((A1 NULL) (ITER-001 ARGUMENTS) (I NULL-INTEGER) (ITER-002 0))
        ...
        (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-001 NIL)) DO (CL:SETQ A1 (%%VALUE ITER-001)) (CL:SETQ I ITER-002)
         (CL:WHEN
          (CL:NOT (EQL? (VALUE-OF A1) (VALUE-OF (CL:AREF (CL:THE CL:SIMPLE-VECTOR (%THE-ARRAY (%ARGUMENTS PROP))) I))))
          (CL:SETQ ALWAYS?-000 CL:NIL) (CL:RETURN))
...
(CL:DEFUN ALL-DEFINING-PROPOSITIONS (OUTPUTARGUMENT RELATION SPECIALIZE?)
  (CL:LET* ((*REVERSEPOLARITY?* CL:NIL)) (CL:DECLARE (CL:SPECIAL *REVERSEPOLARITY?*))
   (CL:LET* ((RESULT NIL) (OUTPUTARGUMENTVALUE (VALUE-OF OUTPUTARGUMENT)))
    (CL:LET*
     ((PROP NULL) (ITER-000 (ALL-TRUE-DEPENDENT-PROPOSITIONS OUTPUTARGUMENTVALUE RELATION SPECIALIZE?))
      (COLLECT-000 NULL))
     (CL:LOOP WHILE (NEXT? ITER-000) DO (CL:SETQ PROP (%VALUE ITER-000))
      (CL:WHEN
       ...
       (CL:WHEN
        (CL:AND (CL:EQ (%OPERATOR P) RELATION)
         (CL:AND (CL:NOT (DELETED? P))
          (CL:IF *REVERSEPOLARITY?* (FALSE? P) (CL:OR (TRUE? P) (FUNCTION-WITH-DEFINED-VALUE? P)))))
  ...
  (CL:LET* ((MEMO-TABLE-000 NULL) (MEMOIZED-ENTRY-000 NULL) (MEMOIZED-VALUE-000 NULL))
   (CL:WHEN *MEMOIZATION-ENABLED?*
    ...
    (CL:WHEN (CL:EQ MEMO-TABLE-000 NULL)
     (INITIALIZE-MEMOIZATION-TABLE SGT-SPECIALIZE-LOGIC-F-TEST-PROPERTY?-MEMO-TABLE-000
      "(:MAX-VALUES 500 :TIMESTAMPS (:KB-UPDATE))")
     (CL:SETQ MEMO-TABLE-000 (%SURROGATE-VALUE SGT-SPECIALIZE-LOGIC-F-TEST-PROPERTY?-MEMO-TABLE-000)))
    (CL:SETQ MEMOIZED-ENTRY-000
     (LOOKUP-MRU-MEMOIZED-VALUE MEMO-TABLE-000 SELF RELATION *CONTEXT* MEMOIZED-NULL-VALUE 6))
...
(CL:DEFUN TEST-ISA? (MEMBER TYPE)
  (CL:COND ((CL:EQ TYPE SGT-SPECIALIZE-STELLA-THING) CL:T)
   ((CL:OR (CL:EQ TYPE SGT-SPECIALIZE-PL-KERNEL-KB-CLASS) (CL:EQ TYPE SGT-SPECIALIZE-PL-KERNEL-KB-RELATION)
     (CL:EQ TYPE SGT-SPECIALIZE-PL-KERNEL-KB-FUNCTION) (CL:EQ TYPE SGT-SPECIALIZE-PL-KERNEL-KB-COLLECTION)
    ...
    (CL:LET* ((MEMO-TABLE-000 NULL) (MEMOIZED-ENTRY-000 NULL) (MEMOIZED-VALUE-000 NULL))
     (CL:WHEN *MEMOIZATION-ENABLED?*
      ...
      (CL:WHEN (CL:EQ MEMO-TABLE-000 NULL)
       (INITIALIZE-MEMOIZATION-TABLE SGT-SPECIALIZE-LOGIC-F-TEST-ISA?-MEMO-TABLE-000
        "(:MAX-VALUES 1000 :TIMESTAMPS (:META-KB-UPDATE))")
       (CL:SETQ MEMO-TABLE-000 (%SURROGATE-VALUE SGT-SPECIALIZE-LOGIC-F-TEST-ISA?-MEMO-TABLE-000)))
      (CL:SETQ MEMOIZED-ENTRY-000
       (LOOKUP-MRU-MEMOIZED-VALUE MEMO-TABLE-000 MEMBER TYPE *CONTEXT* MEMOIZED-NULL-VALUE 6))
      (CL:SETQ MEMOIZED-VALUE-000 (%%VALUE MEMOIZED-ENTRY-000)))
     (CL:COND
      ((CL:NOT (CL:EQ MEMOIZED-VALUE-000 NULL))
       (CL:WHEN (CL:EQ MEMOIZED-VALUE-000 MEMOIZED-NULL-VALUE) (CL:SETQ MEMOIZED-VALUE-000 NULL)))
    ...
    (CL:LET* ((MEMO-TABLE-001 NULL) (MEMOIZED-ENTRY-001 NULL) (MEMOIZED-VALUE-001 NULL))
     (CL:WHEN *MEMOIZATION-ENABLED?*
      ...
      (CL:WHEN (CL:EQ MEMO-TABLE-001 NULL)
       (INITIALIZE-MEMOIZATION-TABLE SGT-SPECIALIZE-LOGIC-F-TEST-ISA?-MEMO-TABLE-001
        "(:MAX-VALUES 1000 :TIMESTAMPS (:KB-UPDATE))")
       (CL:SETQ MEMO-TABLE-001 (%SURROGATE-VALUE SGT-SPECIALIZE-LOGIC-F-TEST-ISA?-MEMO-TABLE-001)))
      (CL:SETQ MEMOIZED-ENTRY-001
       (LOOKUP-MRU-MEMOIZED-VALUE MEMO-TABLE-001 MEMBER TYPE *CONTEXT* MEMOIZED-NULL-VALUE 6))
   ...
   (CL:LET* ((RESULT NULL) (ITERATOR (ALL-TRUE-DEPENDENT-PROPOSITIONS SELF RELATION CL:NIL)) (PROPOSITION NULL))
    (CL:LOOP WHILE (NEXT? ITERATOR) DO (CL:SETQ PROPOSITION (%VALUE ITERATOR))
     (CL:WHEN (EQL? (CL:AREF (CL:THE CL:SIMPLE-VECTOR (%THE-ARRAY (%ARGUMENTS PROPOSITION))) 0) SELF)
      (CL:SETQ RESULT (VALUE-OF (CL:AREF (CL:THE CL:SIMPLE-VECTOR (%THE-ARRAY (%ARGUMENTS PROPOSITION))) 1)))
...
(CL:DEFUN ACCESS-BINARY-VALUE (SELF RELATION)
  (CL:LET* ((MEMO-TABLE-000 NULL) (MEMOIZED-ENTRY-000 NULL) (MEMOIZED-VALUE-000 NULL))
   (CL:WHEN *MEMOIZATION-ENABLED?*
    ...
    (CL:WHEN (CL:EQ MEMO-TABLE-000 NULL)
     (INITIALIZE-MEMOIZATION-TABLE SGT-SPECIALIZE-LOGIC-F-ACCESS-BINARY-VALUE-MEMO-TABLE-000
      "(:MAX-VALUES 1000 :TIMESTAMPS (:KB-UPDATE))")
     (CL:SETQ MEMO-TABLE-000 (%SURROGATE-VALUE SGT-SPECIALIZE-LOGIC-F-ACCESS-BINARY-VALUE-MEMO-TABLE-000)))
    (CL:SETQ MEMOIZED-ENTRY-000
     (LOOKUP-MRU-MEMOIZED-VALUE MEMO-TABLE-000 SELF RELATION *CONTEXT* MEMOIZED-NULL-VALUE 6))
...
(CL:DEFUN TEST-COLLECTIONOF-MEMBER-OF? (MEMBER TYPE)
  (CL:LET* ((*REVERSEPOLARITY?* CL:NIL) (*CONTEXT* (GET-PROPERTY-TEST-CONTEXT)))
   (CL:DECLARE (CL:SPECIAL *REVERSEPOLARITY?* *CONTEXT*))
   (CL:LET*
    ((P NULL) (ITER-000 (ALL-TRUE-DEPENDENT-PROPOSITIONS MEMBER SGT-SPECIALIZE-PL-KERNEL-KB-COLLECTIONOF CL:T)))
    (CL:LOOP WHILE (NEXT? ITER-000) DO (CL:SETQ P (%VALUE ITER-000))
     (CL:WHEN
      (CL:AND (CL:NOT (DELETED? P))
       (CL:IF *REVERSEPOLARITY?* (FALSE? P) (CL:OR (TRUE? P) (FUNCTION-WITH-DEFINED-VALUE? P))))
      (CL:LET* ((COLLECTION (LAST (%ARGUMENTS P))))
       (CL:WHEN
        (CL:AND (CL:NOT (EQL? MEMBER COLLECTION))
         (COLLECTION-IMPLIES-COLLECTION? COLLECTION (SURROGATE-TO-DESCRIPTION TYPE)))
...
(CL:DEFCLASS TRANSITIVE-CLOSURE-ITERATOR (ITERATOR)
  ((ALLOCATE-ADJACENCY-ITERATOR-FUNCTION :ALLOCATION :INSTANCE :ACCESSOR %ALLOCATE-ADJACENCY-ITERATOR-FUNCTION)
   (FILTER? :ALLOCATION :INSTANCE :ACCESSOR %FILTER?)
   (ADJACENCY-ITERATOR-STACK :ALLOCATION :INSTANCE :ACCESSOR %ADJACENCY-ITERATOR-STACK)
...
(CL:DEFUN NEW-TRANSITIVE-CLOSURE-ITERATOR ()
  (CL:LET* ((SELF NULL)) (CL:SETQ SELF (CL:MAKE-INSTANCE (CL:QUOTE TRANSITIVE-CLOSURE-ITERATOR)))
   (CL:SETF (%FIRST-ITERATION? SELF) CL:T) (CL:SETF (%VALUE SELF) NULL) (CL:SETF (%BEEN-THERE-LIST SELF) NULL)
   (CL:SETF (%ADJACENCY-ITERATOR-STACK SELF) NIL) (CL:SETF (%FILTER? SELF) NULL)
...
(CL:DEFUN ACCESS-TRANSITIVE-CLOSURE-ITERATOR-SLOT-VALUE (SELF SLOTNAME VALUE SETVALUE?)
  (CL:COND
   ...
   ((CL:EQ SLOTNAME SYM-SPECIALIZE-LOGIC-BEEN-THERE-LIST)
    (CL:IF SETVALUE? (CL:SETF (%BEEN-THERE-LIST SELF) VALUE) (CL:SETQ VALUE (%BEEN-THERE-LIST SELF))))
   (CL:T
    (CL:LET* ((STREAM-000 (NEW-OUTPUT-STRING-STREAM)))
     (%%PRINT-STREAM (%NATIVE-STREAM STREAM-000) "`" SLOTNAME "' is not a valid case option")
     (CL:ERROR (NEW-STELLA-EXCEPTION (THE-STRING-READER STREAM-000))))))
...
(CL:DEFUN TRANSITIVE-CLOSURE-ITERATOR.NEXT? (SELF)
  (CL:LET* ((NODE (%VALUE SELF)) (ADJACENCYITERATOR (CL:FUNCALL (%ALLOCATE-ADJACENCY-ITERATOR-FUNCTION SELF) NODE)))
   (CL:IF (CL:NOT (CL:EQ ADJACENCYITERATOR NULL))
    (CL:SETF (%ADJACENCY-ITERATOR-STACK SELF) (CONS ADJACENCYITERATOR (%ADJACENCY-ITERATOR-STACK SELF)))
   ...
   (CL:LOOP
    (CL:LOOP WHILE (CL:NOT (NEXT? ADJACENCYITERATOR)) DO
     (CL:SETF (%ADJACENCY-ITERATOR-STACK SELF) (%%REST (%ADJACENCY-ITERATOR-STACK SELF)))
    ...
    (CL:WHEN
     ...
     (CL:SETF (%BEEN-THERE-LIST SELF) (CONS NODE (%BEEN-THERE-LIST SELF))) (CL:SETF (%VALUE SELF) NODE)
...
descendants, but they don't get returned)."
  (CL:LET* ((ITERATOR (NEW-TRANSITIVE-CLOSURE-ITERATOR))) (CL:SETF (%VALUE ITERATOR) STARTNODE)
   (CL:SETF (%BEEN-THERE-LIST ITERATOR) NIL)
   (CL:SETF (%ALLOCATE-ADJACENCY-ITERATOR-FUNCTION ITERATOR) ALLOCATEADJACENCYITERATOR)
...
(CL:DEFUN NEW-SUPPORTED-CLOSURE-ITERATOR ()
  (CL:LET* ((SELF NULL)) (CL:SETQ SELF (CL:MAKE-INSTANCE (CL:QUOTE SUPPORTED-CLOSURE-ITERATOR)))
   (CL:SETF (%FIRST-ITERATION? SELF) CL:T) (CL:SETF (%VALUE SELF) NULL) (CL:SETF (%BEEN-THERE-LIST SELF) NULL)
   (CL:SETF (%FILTER? SELF) NULL) (CL:SETF (%ALLOCATE-ADJACENCY-ITERATOR-FUNCTION SELF) NULL)
...
but return a SUPPORTED-CLOSURE-ITERATOR instead."
  (CL:LET* ((ITERATOR (NEW-SUPPORTED-CLOSURE-ITERATOR))) (CL:SETF (%VALUE ITERATOR) STARTNODE)
   (CL:SETF (%BEEN-THERE-LIST ITERATOR) NIL)
   (CL:SETF (%ALLOCATE-ADJACENCY-ITERATOR-FUNCTION ITERATOR) ALLOCATEADJACENCYITERATOR)
   (CL:SETF (%FILTER? ITERATOR) FILTERFUNCTION) ITERATOR))
...
(CL:DEFMETHOD NEXT? ((SELF SUPPORTED-CLOSURE-ITERATOR))
  (CL:COND
   ((TRANSITIVE-CLOSURE-ITERATOR.NEXT? SELF)
    (CL:SETF (%VALUE SELF) (CONS (%VALUE SELF) (CONS (%TRUTH-VALUE (%%VALUE (%ADJACENCY-ITERATOR-STACK SELF))) NIL)))
    CL:T)
   (CL:T CL:NIL)))
...
(CL:DEFUN NEW-DIRECTLY-LINKED-OBJECTS-ITERATOR ()
  (CL:LET* ((SELF NULL)) (CL:SETQ SELF (CL:MAKE-INSTANCE (CL:QUOTE DIRECTLY-LINKED-OBJECTS-ITERATOR)))
   (CL:SETF (%FIRST-ITERATION? SELF) CL:T) (CL:SETF (%VALUE SELF) NULL) (CL:SETF (%EQUIVALENTS-STACK SELF) NULL)
   (CL:SETF (%PROPOSITION-CURSOR SELF) NULL) (CL:SETF (%SELECTION-PATTERN SELF) NULL)
   (CL:SETF (%TRUTH-VALUE SELF) NULL) (CL:SETF (%ROOT-TRUTH-VALUE SELF) TRUE-TRUTH-VALUE)
...
(CL:DEFUN ACCESS-DIRECTLY-LINKED-OBJECTS-ITERATOR-SLOT-VALUE (SELF SLOTNAME VALUE SETVALUE?)
  (CL:COND
   ((CL:EQ SLOTNAME SYM-SPECIALIZE-LOGIC-INVERSE?)
    (CL:IF SETVALUE? (CL:SETF (%INVERSE? SELF) (COERCE-WRAPPED-BOOLEAN-TO-BOOLEAN VALUE))
     (CL:SETQ VALUE (CL:IF (%INVERSE? SELF) TRUE-WRAPPER FALSE-WRAPPER))))
   ((CL:EQ SLOTNAME SYM-SPECIALIZE-LOGIC-ROOT-TRUTH-VALUE)
    (CL:IF SETVALUE? (CL:SETF (%ROOT-TRUTH-VALUE SELF) VALUE) (CL:SETQ VALUE (%ROOT-TRUTH-VALUE SELF))))
   (CL:T
    (CL:LET* ((STREAM-000 (NEW-OUTPUT-STRING-STREAM)))
     (%%PRINT-STREAM (%NATIVE-STREAM STREAM-000) "`" SLOTNAME "' is not a valid case option")
     (CL:ERROR (NEW-STELLA-EXCEPTION (THE-STRING-READER STREAM-000))))))
  ...
  (CL:LET* ((PROPOSITION NULL))
   (CL:LET* ((*REVERSEPOLARITY?* CL:NIL)) (CL:DECLARE (CL:SPECIAL *REVERSEPOLARITY?*))
    (CL:WHEN (TRUE-PROPOSITIONS-ITERATOR.NEXT? SELF) (CL:SETQ PROPOSITION (%VALUE SELF))
     ...
     (CL:SETF (%TRUTH-VALUE SELF) (CONJOIN-TRUTH-VALUES (%TRUTH-VALUE SELF) (%ROOT-TRUTH-VALUE SELF)))
...
(CL:DEFUN ALL-DIRECTLY-LINKED-OBJECTS (SELF RELATION INVERSE?)
  (CL:LET*
   ...
   (CL:LET* ((SELF-000 (NEW-DIRECTLY-LINKED-OBJECTS-ITERATOR))) (CL:SETF (%SELECTION-PATTERN SELF-000) PATTERN)
    (CL:SETF (%PROPOSITION-CURSOR SELF-000) (ALLOCATE-ITERATOR INDEX)) (CL:SETF (%INVERSE? SELF-000) INVERSE?)
    (CL:LET* ((VALUE-000 SELF-000)) VALUE-000))))
...
(CL:DEFUN ALL-DIRECT-SUPERCOLLECTIONS (SELF PERFORMFILTERING?)
  ...
  (CL:LET*
   ((DIRECTLYLINKEDOBJECTS
     (ALL-DIRECTLY-LINKED-OBJECTS SELF SGT-SPECIALIZE-PL-KERNEL-KB-SUBSET-OF *REVERSEPOLARITY?*)))
      ...
      (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-000 NIL)) DO (CL:SETQ E (%%VALUE ITER-000))
       (CL:LET* ((PARENT NULL) (ITER-001 (ALL-DIRECT-SUPERCOLLECTIONS E CL:NIL)))
        (CL:LOOP WHILE (NEXT? ITER-001) DO (CL:SETQ PARENT (%VALUE ITER-001))
         (CL:WHEN (CL:AND (CL:NOT (MEMBER? EQUIVALENTS PARENT)) (CL:NOT (MEMBER? DIRECTSUPERS PARENT)))
...
(CL:DEFUN ALL-DIRECT-SUBCOLLECTIONS (SELF PERFORMFILTERING?)
  ...
  (CL:LET*
   ((DIRECTLYLINKEDOBJECTS
     (ALL-DIRECTLY-LINKED-OBJECTS SELF SGT-SPECIALIZE-PL-KERNEL-KB-SUBSET-OF (CL:NOT *REVERSEPOLARITY?*))))
      ...
      (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-000 NIL)) DO (CL:SETQ E (%%VALUE ITER-000))
       (CL:LET* ((CHILD NULL) (ITER-001 (ALL-DIRECT-SUBCOLLECTIONS E CL:NIL)))
        (CL:LOOP WHILE (NEXT? ITER-001) DO (CL:SETQ CHILD (%VALUE ITER-001))
         (CL:WHEN (CL:AND (CL:NOT (MEMBER? EQUIVALENTS CHILD)) (CL:NOT (MEMBER? DIRECTSUBS CHILD)))
...
(CL:DEFUN ALL-SUPERCOLLECTIONS (SELF)
  (CL:LET* ((MEMO-TABLE-000 NULL) (MEMOIZED-ENTRY-000 NULL) (MEMOIZED-VALUE-000 NULL))
   (CL:WHEN *MEMOIZATION-ENABLED?*
    ...
    (CL:WHEN (CL:EQ MEMO-TABLE-000 NULL)
     (INITIALIZE-MEMOIZATION-TABLE SGT-SPECIALIZE-LOGIC-F-ALL-SUPERCOLLECTIONS-MEMO-TABLE-000
      "(:MAX-VALUES 1000 :TIMESTAMPS (:META-KB-UPDATE))")
     (CL:SETQ MEMO-TABLE-000 (%SURROGATE-VALUE SGT-SPECIALIZE-LOGIC-F-ALL-SUPERCOLLECTIONS-MEMO-TABLE-000)))
    (CL:SETQ MEMOIZED-ENTRY-000
     (LOOKUP-MRU-MEMOIZED-VALUE MEMO-TABLE-000 SELF *CONTEXT* (CL:IF *REVERSEPOLARITY?* TRUE-WRAPPER FALSE-WRAPPER)
    ...
    (CL:T
     (CL:SETQ MEMOIZED-VALUE-000
      (NEW-MEMOIZABLE-ITERATOR
       (ALLOCATE-TRANSITIVE-CLOSURE-ITERATOR SELF (CL:FUNCTION ALL-DIRECT-SUPERCOLLECTIONS-WITH-EQUIVALENTS) NULL)))
     (CL:WHEN *MEMOIZATION-ENABLED?*
      (CL:SETF (%%VALUE MEMOIZED-ENTRY-000)
       (CL:IF (CL:EQ MEMOIZED-VALUE-000 NULL) MEMOIZED-NULL-VALUE MEMOIZED-VALUE-000)))))
   ...
   (CL:LET* ((P NULL) (ITER-000 (ALL-TRUE-DEPENDENT-PROPOSITIONS SELF NULL CL:NIL)))
    (CL:LOOP WHILE (NEXT? ITER-000) DO (CL:SETQ P (%VALUE ITER-000))
     (CL:WHEN (CL:EQ (%KIND P) KWD-SPECIALIZE-ISA)
      (CL:SETQ COLLECTIONS (CONS (GET-DESCRIPTION (%OPERATOR P)) COLLECTIONS)))))
  ...
  (CL:LET* ((MEMO-TABLE-000 NULL) (MEMOIZED-ENTRY-000 NULL) (MEMOIZED-VALUE-000 NULL))
   (CL:WHEN *MEMOIZATION-ENABLED?*
    (CL:SETQ MEMO-TABLE-000
     (%SURROGATE-VALUE SGT-SPECIALIZE-LOGIC-F-ALL-SUPPORTED-NAMED-SUBCOLLECTIONS-MEMO-TABLE-000))
    (CL:WHEN (CL:EQ MEMO-TABLE-000 NULL)
     (INITIALIZE-MEMOIZATION-TABLE SGT-SPECIALIZE-LOGIC-F-ALL-SUPPORTED-NAMED-SUBCOLLECTIONS-MEMO-TABLE-000
      "(:MAX-VALUES 1000 :TIMESTAMPS (:META-KB-UPDATE))")
     (CL:SETQ MEMO-TABLE-000
      (%SURROGATE-VALUE SGT-SPECIALIZE-LOGIC-F-ALL-SUPPORTED-NAMED-SUBCOLLECTIONS-MEMO-TABLE-000)))
    (CL:SETQ MEMOIZED-ENTRY-000
     (LOOKUP-MRU-MEMOIZED-VALUE MEMO-TABLE-000 SELF
      (CL:IF (CL:NOT *DONTUSEDEFAULTKNOWLEDGE?*) TRUE-WRAPPER FALSE-WRAPPER) *CONTEXT*
...
(CL:DEFUN ALL-DIRECTLY-LINKED-SUBCOLLECTIONS (SELF)
  (CL:LET* ((OBJECT NULL) (TRUTHVALUE NULL) (ITERATOR NULL))
   (CL:LET* ((TEST-VALUE-000 (SAFE-PRIMARY-TYPE SELF)))
    (CL:COND
     ((CL:EQ TEST-VALUE-000 SGT-SPECIALIZE-STELLA-CONS)
      (CL:PROGN (CL:SETQ OBJECT (%%VALUE SELF)) (CL:SETQ TRUTHVALUE (%%VALUE (%%REST SELF)))))
   ...
   (CL:SETQ ITERATOR
    (ALL-DIRECTLY-LINKED-OBJECTS OBJECT SGT-SPECIALIZE-PL-KERNEL-KB-SUBSET-OF (CL:NOT *REVERSEPOLARITY?*)))
   (CL:COND
...
(CL:DEFUN HELP-ALL-SUPPORTED-NAMED-SUBCOLLECTIONS (SELF)
  (CL:LET*
   ((SUBCOLLECTIONS NIL)
    (CLOSUREITERATOR
     (ALLOCATE-SUPPORTED-CLOSURE-ITERATOR (CONS SELF (CONS TRUE-TRUTH-VALUE NIL))
  ...
  (CL:LET* ((TYPE (%SKOLEM-TYPE SKOLEM)))
   (CL:COND ((CL:EQ TYPE NULL) CL:NIL)
    ((CL:NOT
     ...
     CL:T)
    ((CL:AND (LITERAL-TYPE? TYPE) (LOGICAL-SUBTYPE-OF? TYPE SGT-SPECIALIZE-STELLA-NUMBER))
...
(CL:DEFUN CLASHES-WITH-FUNCTION-PROPOSITION? (NEXTPROPOSITION REFERENCEPROPOSITION)
  (CL:LET* ((ALWAYS?-000 CL:T))
   (CL:LET*
    ((SUPERARG NULL) (ITER-000 (BUT-LAST (%ARGUMENTS REFERENCEPROPOSITION))) (SUBARG NULL)
     (ITER-001 (BUT-LAST (%ARGUMENTS NEXTPROPOSITION))))
    (CL:LOOP WHILE (CL:AND (NEXT? ITER-000) (NEXT? ITER-001)) DO (CL:SETQ SUPERARG (%VALUE ITER-000))
     (CL:SETQ SUBARG (%VALUE ITER-001))
     (CL:WHEN (CL:NOT (EQL? (ARGUMENT-BOUND-TO SUPERARG) (VALUE-OF SUBARG))) (CL:SETQ ALWAYS?-000 CL:NIL)
      (CL:RETURN))))
   (CL:WHEN ALWAYS?-000
    (CL:LET*
     ((LASTSUPERVALUE (ARGUMENT-BOUND-TO (LAST (%ARGUMENTS REFERENCEPROPOSITION))))
...
(CL:DEFUN NEW-CLASHING-PROPOSITIONS-ITERATOR ()
  (CL:LET* ((SELF NULL)) (CL:SETQ SELF (CL:MAKE-INSTANCE (CL:QUOTE CLASHING-PROPOSITIONS-ITERATOR)))
   (CL:SETF (%FIRST-ITERATION? SELF) CL:T) (CL:SETF (%VALUE SELF) NULL) (CL:SETF (%EQUIVALENTS-STACK SELF) NULL)
   (CL:SETF (%PROPOSITION-CURSOR SELF) NULL) (CL:SETF (%SELECTION-PATTERN SELF) NULL)
   (CL:SETF (%TRUTH-VALUE SELF) NULL) (CL:SETF (%REFERENCE-PROPOSITION SELF) NULL) SELF))
...
(CL:DEFMETHOD NEXT? ((SELF CLASHING-PROPOSITIONS-ITERATOR))
  (CL:LET* ((REFERENCEPROP (%REFERENCE-PROPOSITION SELF)))
   (CL:LOOP WHILE (TRUE-PROPOSITIONS-ITERATOR.NEXT? SELF) DO
    (CL:WHEN (CLASHES-WITH-FUNCTION-PROPOSITION? (%VALUE SELF) REFERENCEPROP) (CL:RETURN-FROM NEXT? CL:T)))
   (CL:SETF (%VALUE SELF) NULL) CL:NIL))
   ...
   (CL:LET*
    ((PATTERN
      (CONS KWD-SPECIALIZE-RELATION
       (CONS (CL:IF (CL:EQ NIL NULL) NIL NIL) (CONS (%OPERATOR SELF) (CONS (VALUE-OF BACKLINKEDARG) NIL)))))
     (INDEX (SELECT-PROPOSITIONS PATTERN)))
    ...
    (CL:LET* ((SELF-000 (NEW-CLASHING-PROPOSITIONS-ITERATOR))) (CL:SETF (%SELECTION-PATTERN SELF-000) PATTERN)
     ...
     (CL:SETF (%REFERENCE-PROPOSITION SELF-000) SELF) (CL:LET* ((VALUE-000 SELF-000)) VALUE-000)))))
   ...
   (CL:LET* ((R NULL) (ITER-000 (%THE-CONS-LIST RELATIONSWITHDESCRIPTIONS)))
    (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-000 NIL)) DO (CL:SETQ R (%%VALUE ITER-000))
     (CREATE-DESCRIPTION-IMPLICATION-SUBSUMPTION-NODE
      (DYNAMIC-SLOT-VALUE (%DYNAMIC-SLOTS R) SYM-SPECIALIZE-LOGIC-DESCRIPTION NULL) NULL)
     (CL:SETQ ITER-000 (%%REST ITER-000))))
       ...
       (CL:WHEN (MEMBER? RELATIONSWITHDESCRIPTIONS SUPER)
        (CREATE-TAXONOMY-LINK *IMPLICATION-SUBSUMPTION-GRAPH*
         (FIND-DESCRIPTION-IMPLICATION-SUBSUMPTION-NODE
          (DYNAMIC-SLOT-VALUE (%DYNAMIC-SLOTS SUPER) SYM-SPECIALIZE-LOGIC-DESCRIPTION NULL))
         (FIND-DESCRIPTION-IMPLICATION-SUBSUMPTION-NODE
          (DYNAMIC-SLOT-VALUE (%DYNAMIC-SLOTS R) SYM-SPECIALIZE-LOGIC-DESCRIPTION NULL))))))
  ...
  (CL:LET* ((R NULL) (ITER-000 (%THE-CONS-LIST (RELATIONS-WITH-DESCRIPTIONS))))
   (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-000 NIL)) DO (CL:SETQ R (%%VALUE ITER-000))
    (SET-DYNAMIC-SLOT-VALUE
     (%DYNAMIC-SLOTS (DYNAMIC-SLOT-VALUE (%DYNAMIC-SLOTS R) SYM-SPECIALIZE-LOGIC-DESCRIPTION NULL))
...
(CL:DEFUN CREATE-DESCRIPTION-IMPLICATION-SUBSUMPTION-NODE (DESCRIPTION PARENTNODE)
  (CL:LET*
   ((NODE (CREATE-TAXONOMY-NODE *IMPLICATION-SUBSUMPTION-GRAPH* PARENTNODE DESCRIPTION (CL:EQ PARENTNODE NULL))))
...
(CL:DEFUN FIND-OR-CREATE-DESCRIPTION-IMPLICATION-SUBSUMPTION-NODE (DESCRIPTION)
  (CL:LET* ((RESULT (FIND-DESCRIPTION-IMPLICATION-SUBSUMPTION-NODE DESCRIPTION)))
   (CL:WHEN (CL:NOT (CL:EQ RESULT NULL))
    (CL:RETURN-FROM FIND-OR-CREATE-DESCRIPTION-IMPLICATION-SUBSUMPTION-NODE RESULT))
...
(CL:DEFUN CREATE-DESCRIPTION-FOR-STELLA-RELATION-AND-ANCESTORS (SELF)
  ...
  (CL:LET*
   ((DESCRIPTION (GET-DESCRIPTION SELF))
    (TAXONOMYNODE (FIND-OR-CREATE-DESCRIPTION-IMPLICATION-SUBSUMPTION-NODE DESCRIPTION)))
...
(CL:DEFUN TAXONOMY-IMPLIES-OR-IS-SUBSUMED? (PREMISE CONCLUSION)
  (CL:LET*
   ((PREMISEDESCRIPTION (DYNAMIC-SLOT-VALUE (%DYNAMIC-SLOTS PREMISE) SYM-SPECIALIZE-LOGIC-DESCRIPTION NULL))
    (CONCLUSIONDESCRIPTION NULL))
   (CL:WHEN
    (CL:OR (CL:EQ PREMISEDESCRIPTION NULL)
     (CL:EQ (FIND-DESCRIPTION-IMPLICATION-SUBSUMPTION-NODE PREMISEDESCRIPTION) NULL))
    (CL:SETQ PREMISEDESCRIPTION (CREATE-DESCRIPTION-FOR-STELLA-RELATION-AND-ANCESTORS PREMISE)))
   (CL:SETQ CONCLUSIONDESCRIPTION
    (DYNAMIC-SLOT-VALUE (%DYNAMIC-SLOTS CONCLUSION) SYM-SPECIALIZE-LOGIC-DESCRIPTION NULL))
   ...
   (CL:WHEN (CL:EQ (FIND-DESCRIPTION-IMPLICATION-SUBSUMPTION-NODE CONCLUSIONDESCRIPTION) NULL)
    (CL:ERROR
     (NEW-STELLA-EXCEPTION "'taxonomy-implies-or-is-subsumed?' conclusionDescription should have taxonomy-node")))
   (TAXONOMY-SUBNODE-OF? (FIND-DESCRIPTION-IMPLICATION-SUBSUMPTION-NODE PREMISEDESCRIPTION)
...
(CL:DEFUN HELP-STARTUP-SPECIALIZE1 ()
  (CL:PROGN
   ...
   (CL:SETQ SGT-SPECIALIZE-LOGIC-SPECIALIZING-PROPOSITIONS-ITERATOR
    (INTERN-RIGID-SYMBOL-WRT-MODULE "SPECIALIZING-PROPOSITIONS-ITERATOR" NULL 1))
   ...
   (CL:SETQ KWD-SPECIALIZE-DEPENDENTS (INTERN-RIGID-SYMBOL-WRT-MODULE "DEPENDENTS" NULL 2))
   ...
   (CL:SETQ SGT-SPECIALIZE-PL-KERNEL-KB-CLASS
    (INTERN-RIGID-SYMBOL-WRT-MODULE "CLASS" (GET-STELLA-MODULE "/PL-KERNEL-KB" CL:T) 1))
   ...
   (CL:SETQ SGT-SPECIALIZE-PL-KERNEL-KB-COLLECTION
    (INTERN-RIGID-SYMBOL-WRT-MODULE "COLLECTION" (GET-STELLA-MODULE "/PL-KERNEL-KB" CL:T) 1))
   ...
   (CL:SETQ SGT-SPECIALIZE-LOGIC-F-ACCESS-BINARY-VALUE-MEMO-TABLE-000
    (INTERN-RIGID-SYMBOL-WRT-MODULE "F-ACCESS-BINARY-VALUE-MEMO-TABLE-000" NULL 1))
   ...
   (CL:SETQ SYM-SPECIALIZE-LOGIC-ALLOCATE-ADJACENCY-ITERATOR-FUNCTION
    (INTERN-RIGID-SYMBOL-WRT-MODULE "ALLOCATE-ADJACENCY-ITERATOR-FUNCTION" NULL 0))
   ...
   (CL:SETQ SGT-SPECIALIZE-LOGIC-DIRECTLY-LINKED-OBJECTS-ITERATOR
    (INTERN-RIGID-SYMBOL-WRT-MODULE "DIRECTLY-LINKED-OBJECTS-ITERATOR" NULL 1))
   ...
   (CL:SETQ SGT-SPECIALIZE-LOGIC-F-ALL-SUPERCOLLECTIONS-MEMO-TABLE-000
    (INTERN-RIGID-SYMBOL-WRT-MODULE "F-ALL-SUPERCOLLECTIONS-MEMO-TABLE-000" NULL 1))
   ...
   (CL:SETQ SGT-SPECIALIZE-STELLA-NUMBER
    (INTERN-RIGID-SYMBOL-WRT-MODULE "NUMBER" (GET-STELLA-MODULE "/STELLA" CL:T) 1))
   ...
   (CL:SETQ SYM-SPECIALIZE-STELLA-TAXONOMY-NODE
    (INTERN-RIGID-SYMBOL-WRT-MODULE "TAXONOMY-NODE" (GET-STELLA-MODULE "/STELLA" CL:T) 0))
...
(CL:DEFUN HELP-STARTUP-SPECIALIZE3 ()
  (CL:PROGN
   ...
   (DEFINE-FUNCTION-OBJECT "PROPOSITION-TRUTH-VALUE"
    "(DEFUN (PROPOSITION-TRUTH-VALUE TRUTH-VALUE) ((PROPOSITION PROPOSITION)))" (CL:FUNCTION PROPOSITION-TRUTH-VALUE)
    NULL)
   ...
   (DEFINE-METHOD-OBJECT "(DEFMETHOD (NEXT? BOOLEAN) ((SELF SPECIALIZING-PROPOSITIONS-ITERATOR)))" (CL:FUNCTION NEXT?)
    NULL)
   ...
   (DEFINE-FUNCTION-OBJECT "TEST-PROPERTY?"
    "(DEFUN (TEST-PROPERTY? BOOLEAN) ((SELF OBJECT) (RELATION SURROGATE)) :PUBLIC? TRUE)" (CL:FUNCTION TEST-PROPERTY?)
    NULL)
   (DEFINE-FUNCTION-OBJECT "HELP-MEMOIZE-TEST-ISA?"
    "(DEFUN (HELP-MEMOIZE-TEST-ISA? BOOLEAN) ((MEMBER OBJECT) (TYPE SURROGATE)))" (CL:FUNCTION HELP-MEMOIZE-TEST-ISA?)
    NULL)
   (DEFINE-FUNCTION-OBJECT "TEST-ISA?" "(DEFUN (TEST-ISA? BOOLEAN) ((MEMBER OBJECT) (TYPE SURROGATE)) :PUBLIC? TRUE)"
...
but return a SUPPORTED-CLOSURE-ITERATOR instead.\" :PUBLIC? TRUE)" (CL:FUNCTION ALLOCATE-SUPPORTED-CLOSURE-ITERATOR)
    NULL)
   (DEFINE-METHOD-OBJECT "(DEFMETHOD (NEXT? BOOLEAN) ((SELF SUPPORTED-CLOSURE-ITERATOR)))" (CL:FUNCTION NEXT?) NULL)
   (DEFINE-METHOD-OBJECT "(DEFMETHOD (NEXT? BOOLEAN) ((SELF DIRECTLY-LINKED-OBJECTS-ITERATOR)))" (CL:FUNCTION NEXT?)
    NULL)
   ...
   (DEFINE-FUNCTION-OBJECT "ALL-SUBCOLLECTIONS"
    "(DEFUN (ALL-SUBCOLLECTIONS (ITERATOR OF LOGIC-OBJECT)) ((SELF LOGIC-OBJECT)))" (CL:FUNCTION ALL-SUBCOLLECTIONS)
    NULL)
   (DEFINE-FUNCTION-OBJECT "ALL-ISA-COLLECTIONS" "(DEFUN (ALL-ISA-COLLECTIONS (CONS OF LOGIC-OBJECT)) ((SELF OBJECT)))"
   ...
   (DEFINE-METHOD-OBJECT "(DEFMETHOD (NEXT? BOOLEAN) ((SELF CLASHING-PROPOSITIONS-ITERATOR)))" (CL:FUNCTION NEXT?)
    NULL)
   ...
   (DEFINE-FUNCTION-OBJECT "RELATIONS-WITH-DESCRIPTIONS" "(DEFUN (RELATIONS-WITH-DESCRIPTIONS (LIST OF RELATION)) ())"
    (CL:FUNCTION RELATIONS-WITH-DESCRIPTIONS) NULL)
   (DEFINE-FUNCTION-OBJECT "BUILD-SUBSUMPTION-TAXONOMY-GRAPH" "(DEFUN BUILD-SUBSUMPTION-TAXONOMY-GRAPH ())"
    (CL:FUNCTION BUILD-SUBSUMPTION-TAXONOMY-GRAPH) NULL)
   (DEFINE-FUNCTION-OBJECT "CLEAR-IMPLICATION-SUBSUMPTION-GRAPH" "(DEFUN CLEAR-IMPLICATION-SUBSUMPTION-GRAPH ())"
    (CL:FUNCTION CLEAR-IMPLICATION-SUBSUMPTION-GRAPH) NULL)
   (DEFINE-FUNCTION-OBJECT "INITIALIZE-IMPLICATION-SUBSUMPTION-GRAPH"
    "(DEFUN INITIALIZE-IMPLICATION-SUBSUMPTION-GRAPH ())" (CL:FUNCTION INITIALIZE-IMPLICATION-SUBSUMPTION-GRAPH) NULL)
   ...
   (DEFINE-FUNCTION-OBJECT "STARTUP-SPECIALIZE" "(DEFUN STARTUP-SPECIALIZE () :PUBLIC? TRUE)"
    (CL:FUNCTION STARTUP-SPECIALIZE) NULL)
   (CL:LET* ((FUNCTION (LOOKUP-FUNCTION SYM-SPECIALIZE-LOGIC-STARTUP-SPECIALIZE)))
    (SET-DYNAMIC-SLOT-VALUE (%DYNAMIC-SLOTS FUNCTION) SYM-SPECIALIZE-STELLA-METHOD-STARTUP-CLASSNAME
...
(CL:DEFUN STARTUP-SPECIALIZE ()
  (CL:LET* ((*MODULE* (GET-STELLA-MODULE "/LOGIC" (> *STARTUP-TIME-PHASE* 1))) (*CONTEXT* *MODULE*))
   (CL:DECLARE (CL:SPECIAL *MODULE* *CONTEXT*)) (CL:WHEN (CURRENT-STARTUP-TIME-PHASE? 2) (HELP-STARTUP-SPECIALIZE1))
