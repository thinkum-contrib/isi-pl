...
(CL:DECLAIM
 (CL:SPECIAL *STARTUP-TIME-PHASE* *ACTIVATED-NETWORKS* *MOST-RECENT-QUERY*
  ...
  NULL-FLOAT-WRAPPER STANDARD-OUTPUT EOL TRUE-WRAPPER FALSE-WRAPPER
  NULL-FLOAT))
...
(CL:DEFMETHOD COMPUTE-AND-SCORE ((SELF NN-PARTIAL-MATCH))
  (CL:LET*
   ...
   (CL:LET*
    ((SCORE NULL)
     (ITER-000 (REVERSE (COPY-CONS-LIST (%ARGUMENT-SCORES SELF)))) (ARG NULL)
   ...
   (CL:WHEN (CL:NOT (CL:EQ SUPPORT NULL))
    ...
    (CL:LET*
     ((NET NULL) (ITER-001 (%THE-CONS-LIST (REVERSE NETLIST)))
      (SCORELIST NULL) (ITER-002 (%THE-CONS-LIST (REVERSE ACTIVATIONLIST))))
     (CL:LOOP WHILE
      (CL:AND (CL:NOT (CL:EQ ITER-001 NIL)) (CL:NOT (CL:EQ ITER-002 NIL))) DO
      (CL:SETQ NET (%%VALUE ITER-001)) (CL:SETQ SCORELIST (%%VALUE ITER-002))
      (CL:LET*
       ((PROP NULL) (VECTOR-001 (%ARGUMENTS (%PROPOSITION NET))) (INDEX-001 0)
        (LENGTH-001 (LENGTH VECTOR-001)) (K NULL)
