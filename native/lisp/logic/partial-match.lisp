...
(CL:DECLAIM
 (CL:SPECIAL *STARTUP-TIME-PHASE* *ACTIVATED-NETWORKS* *MOST-RECENT-QUERY* STANDARD-ERROR *MODULE* FALSE-TRUTH-VALUE
  DEFAULT-FALSE-TRUTH-VALUE TRUE-TRUTH-VALUE NULL-INTEGER UNKNOWN-TRUTH-VALUE NIL *QUERYITERATOR* NULL-FLOAT-WRAPPER
...
(CL:DEFCLASS PARTIAL-MATCH-FRAME (STANDARD-OBJECT)
  ((KIND :ALLOCATION :INSTANCE :ACCESSOR %KIND) (CONTROL-FRAME :ALLOCATION :INSTANCE :ACCESSOR %CONTROL-FRAME)
   (PARENT :ALLOCATION :INSTANCE :ACCESSOR %PARENT) (CHILD :ALLOCATION :INSTANCE :ACCESSOR %CHILD)
...
(CL:DEFUN ACCESS-PARTIAL-MATCH-FRAME-SLOT-VALUE (SELF SLOTNAME VALUE SETVALUE?)
  (CL:COND
   ...
   ((CL:EQ SLOTNAME SYM-PARTIAL-MATCH-LOGIC-PARENT)
    (CL:IF SETVALUE? (CL:SETF (%PARENT SELF) VALUE) (CL:SETQ VALUE (%PARENT SELF))))
   ((CL:EQ SLOTNAME SYM-PARTIAL-MATCH-LOGIC-CHILD)
    (CL:IF SETVALUE? (CL:SETF (%CHILD SELF) VALUE) (CL:SETQ VALUE (%CHILD SELF))))
   ...
   ((CL:EQ SLOTNAME SYM-PARTIAL-MATCH-LOGIC-DYNAMIC-CUTOFF)
    (CL:IF SETVALUE? (CL:SETF (%DYNAMIC-CUTOFF SELF) (%WRAPPER-VALUE VALUE))
   ...
   ((CL:EQ SLOTNAME SYM-PARTIAL-MATCH-LOGIC-ARGUMENT-WEIGHTS)
    (CL:IF SETVALUE? (CL:SETF (%ARGUMENT-WEIGHTS SELF) VALUE) (CL:SETQ VALUE (%ARGUMENT-WEIGHTS SELF))))
   ((CL:EQ SLOTNAME SYM-PARTIAL-MATCH-LOGIC-UNBOUND-VARS)
    (CL:IF SETVALUE? (CL:SETF (%UNBOUND-VARS SELF) VALUE) (CL:SETQ VALUE (%UNBOUND-VARS SELF))))
   ((CL:EQ SLOTNAME SYM-PARTIAL-MATCH-LOGIC-SUCCESS?)
    (CL:IF SETVALUE? (CL:SETF (%SUCCESS? SELF) (COERCE-WRAPPED-BOOLEAN-TO-BOOLEAN VALUE))
...
(CL:DEFUN LINK-TO-PARENT-PARTIAL-MATCH-FRAME (SELF)
  (CL:LET* ((CONTROLFRAME (%UP (%CONTROL-FRAME SELF))))
   (CL:LOOP WHILE (CL:AND (CL:NOT (CL:EQ CONTROLFRAME NULL)) (CL:EQ (%PARTIAL-MATCH-FRAME CONTROLFRAME) NULL)) DO
    (CL:SETQ CONTROLFRAME (%UP CONTROLFRAME)))
   (CL:WHEN (CL:NOT (CL:EQ CONTROLFRAME NULL)) (CL:SETF (%PARENT SELF) (%PARTIAL-MATCH-FRAME CONTROLFRAME))
...
(CL:DEFMETHOD CREATE-PARTIAL-MATCH-FRAME ((SELF PARTIAL-MATCH-FRAME) FRAME KIND)
  ...
  (CL:LET* ((STREAM-000 (NEW-OUTPUT-STRING-STREAM)))
   (%%PRINT-STREAM (%NATIVE-STREAM STREAM-000) "Missing concrete method named 'create-partial-match-frame' on the" EOL
  ...
  (CL:LET* ((CUTOFF (COMPUTE-DYNAMIC-CUTOFF SELF))) (CL:DECLARE (CL:TYPE CL:DOUBLE-FLOAT CUTOFF))
   (CL:WHEN (CL:NOT (CL:= CUTOFF NULL-FLOAT))
    (CL:WHEN (CL:OR (CL:< CUTOFF -100) (CL:> CUTOFF 100))
     (CL:WARN "*** fishy dynamic cutoff=`~A' computed, resetting to 0.0" CUTOFF) (CL:SETQ CUTOFF 0.0d0))
...
(CL:DEFMETHOD CUTOFF-PARTIAL-MATCH? ((SELF PARTIAL-MATCH-FRAME) TRACE?)
  (CL:LET* ((SCORE (%POSITIVE-SCORE SELF)) (CUTOFF (%DYNAMIC-CUTOFF SELF)) (CUTOFF? CL:NIL))
   ...
   (CL:WHEN (CL:AND CUTOFF? TRACE?)
    (%%PRINT-STREAM (%NATIVE-STREAM STANDARD-OUTPUT) "*** Cutting off search, cutoff=" CUTOFF EOL))
   CUTOFF?))
...
(CL:DEFMETHOD PROPOSITION-WEIGHT ((SELF PARTIAL-MATCH-FRAME) PROPOSITION)
  (CL:IF (CL:NOT (CL:EQ PROPOSITION NULL))
   (CL:LET*
    ((WEIGHT
      (%WRAPPER-VALUE
       (DYNAMIC-SLOT-VALUE (%DYNAMIC-SLOTS PROPOSITION) SYM-PARTIAL-MATCH-LOGIC-WEIGHT NULL-FLOAT-WRAPPER))))
...
(CL:DEFMETHOD DEFINED-FRAME-PARTIAL-TRUTH? ((SELF CONTROL-FRAME))
  (CL:AND (CL:NOT (CL:EQ (%PARTIAL-MATCH-FRAME SELF) NULL))
   (CL:OR (CL:NOT (CL:= (%POSITIVE-SCORE (%PARTIAL-MATCH-FRAME SELF)) NULL-FLOAT))
    (CL:NOT (CL:= (%NEGATIVE-SCORE (%PARTIAL-MATCH-FRAME SELF)) NULL-FLOAT)))))
...
(CL:DEFMETHOD SET-FRAME-PARTIAL-TRUTH ((SELF PARTIAL-MATCH-FRAME) TRUTHVALUE POSSCORE NEGSCORE IGNOREPOLARITY?)
  ...
  (CL:LET* ((FLIPPOLARITY? (CL:AND (%REVERSE-POLARITY? (%CONTROL-FRAME SELF)) (CL:NOT IGNOREPOLARITY?))))
   (CL:WHEN (CL:AND (CL:= POSSCORE NULL-FLOAT) (CL:NOT (CL:EQ TRUTHVALUE NULL)))
    (CL:SETQ POSSCORE (%POSITIVE-SCORE TRUTHVALUE)))
   (CL:WHEN (CL:AND (CL:= NEGSCORE NULL-FLOAT) (CL:NOT (CL:EQ TRUTHVALUE NULL)))
    (CL:SETQ NEGSCORE (%POSITIVE-SCORE (INVERT-TRUTH-VALUE TRUTHVALUE))))
   (CL:WHEN FLIPPOLARITY?
    (CL:LET* ((AUX POSSCORE)) (CL:DECLARE (CL:TYPE CL:DOUBLE-FLOAT AUX)) (CL:SETQ POSSCORE (CL:- 0 POSSCORE))
     (CL:SETQ NEGSCORE AUX)))
   ...
   (SET-DYNAMIC-SLOT-VALUE (%DYNAMIC-SLOTS *QUERYITERATOR*) SYM-PARTIAL-MATCH-LOGIC-LATEST-POSITIVE-SCORE
    (WRAP-FLOAT POSSCORE) NULL-FLOAT-WRAPPER)))
...
(CL:DEFMETHOD PROPAGATE-FRAME-PARTIAL-TRUTH ((SOURCE PARTIAL-MATCH-FRAME) TARGET)
  (CL:LET*
   ((TARGETPMF (%PARTIAL-MATCH-FRAME TARGET))
    (FLIPPOLARITY? (CL:NOT (CL:EQ (%REVERSE-POLARITY? (%CONTROL-FRAME SOURCE)) (%REVERSE-POLARITY? TARGET)))))
   (CL:WHEN (CL:EQ TARGETPMF NULL)
    (CL:COND
     (FLIPPOLARITY?
      (CL:SETQ TARGETPMF
       (CREATE-OBJECT (PRIMARY-TYPE SOURCE) KWD-PARTIAL-MATCH-CONTROL-FRAME TARGET KWD-PARTIAL-MATCH-KIND
        (%STATE TARGET)))
   ...
   (CL:COND
    (FLIPPOLARITY? (CL:SETF (%POSITIVE-SCORE TARGETPMF) (CL:- 0 (%POSITIVE-SCORE SOURCE)))
     (CL:SETF (%NEGATIVE-SCORE TARGETPMF) (%POSITIVE-SCORE SOURCE)))
    (CL:T (CL:SETF (%POSITIVE-SCORE TARGETPMF) (%POSITIVE-SCORE SOURCE))
...
(CL:DEFMETHOD TRACE-FRAME-PARTIAL-TRUTH ((SELF PARTIAL-MATCH-FRAME) LASTMOVE STREAM)
  (CL:LET* ((WEIGHT (PROPOSITION-WEIGHT SELF (%PROPOSITION (%CONTROL-FRAME SELF)))))
   ...
   (CL:COND
    ...
    ((CL:OR (CL:EQ LASTMOVE KWD-PARTIAL-MATCH-UP-TRUE) (CL:EQ LASTMOVE KWD-PARTIAL-MATCH-UP-FAIL))
     (CL:LET* ((SCORE (%POSITIVE-SCORE SELF))) (CL:DECLARE (CL:TYPE CL:DOUBLE-FLOAT SCORE))
      (%%PRINT-STREAM (%NATIVE-STREAM STREAM) "score=" SCORE)
      (CL:WHEN (CL:AND (CL:NOT (CL:= WEIGHT NULL-FLOAT)) (CL:NOT (CL:= WEIGHT 1.0d0)))
...
(CL:DEFMETHOD SET-JUSTIFICATION-PARTIAL-TRUTH ((SELF CONTROL-FRAME) JUSTIFICATION)
  (CL:LET* ((PMF (%PARTIAL-MATCH-FRAME SELF)))
   (CL:WHEN (CL:NOT (CL:EQ PMF NULL)) (SET-JUSTIFICATION-PARTIAL-TRUTH PMF JUSTIFICATION))))
...
(CL:DEFMETHOD SET-BASE-PARTIAL-MATCH-TRUTH ((SELF PARTIAL-MATCH-FRAME) PROP TRUTH)
  ...
  (CL:COND
   ((CL:EQ TRUTH KWD-PARTIAL-MATCH-TRUE)
    (SET-DYNAMIC-SLOT-VALUE (%DYNAMIC-SLOTS *QUERYITERATOR*) SYM-PARTIAL-MATCH-LOGIC-LATEST-POSITIVE-SCORE
     (WRAP-FLOAT 1.0d0) NULL-FLOAT-WRAPPER))
   ((CL:EQ TRUTH KWD-PARTIAL-MATCH-FAIL)
    (SET-DYNAMIC-SLOT-VALUE (%DYNAMIC-SLOTS *QUERYITERATOR*) SYM-PARTIAL-MATCH-LOGIC-LATEST-POSITIVE-SCORE
     (WRAP-FLOAT 0.0d0) NULL-FLOAT-WRAPPER))
   (CL:T
    (CL:LET* ((STREAM-000 (NEW-OUTPUT-STRING-STREAM)))
     (%%PRINT-STREAM (%NATIVE-STREAM STREAM-000) "`" TRUTH "' is not a valid case option")
     (CL:ERROR (NEW-STELLA-EXCEPTION (THE-STRING-READER STREAM-000)))))))
...
(CL:DEFUN NEW-INCREMENTAL-PARTIAL-MATCH (KIND CONTROL-FRAME)
  (CL:LET* ((SELF NULL)) (CL:SETQ SELF (CL:MAKE-INSTANCE (CL:QUOTE INCREMENTAL-PARTIAL-MATCH)))
   (CL:SETF (%KIND SELF) KIND) (CL:SETF (%CONTROL-FRAME SELF) CONTROL-FRAME) (CL:SETF (%SUCCESS? SELF) CL:NIL)
   (CL:SETF (%UNBOUND-VARS SELF) NIL) (CL:SETF (%ARGUMENT-WEIGHTS SELF) NIL) (CL:SETF (%ARGUMENT-SCORES SELF) NIL)
   (CL:SETF (%DYNAMIC-CUTOFF SELF) NULL-FLOAT) (CL:SETF (%NEGATIVE-SCORE SELF) NULL-FLOAT)
   (CL:SETF (%POSITIVE-SCORE SELF) NULL-FLOAT) (CL:SETF (%MAXIMUM-SCORE SELF) 0.0d0)
   (CL:SETF (%TOTAL-WEIGHT SELF) NULL-FLOAT) (CL:SETF (%ACCUMULATED-WEIGHT SELF) 0.0d0)
   (CL:SETF (%ACCUMULATED-SCORE SELF) 0.0d0) (CL:SETF (%CHILD SELF) NULL) (CL:SETF (%PARENT SELF) NULL)
...
(CL:DEFUN ACCESS-INCREMENTAL-PARTIAL-MATCH-SLOT-VALUE (SELF SLOTNAME VALUE SETVALUE?)
  (CL:COND
   ...
   ((CL:EQ SLOTNAME SYM-PARTIAL-MATCH-LOGIC-ACCUMULATED-SCORE)
    (CL:IF SETVALUE? (CL:SETF (%ACCUMULATED-SCORE SELF) (%WRAPPER-VALUE VALUE))
     (CL:SETQ VALUE (WRAP-FLOAT (%ACCUMULATED-SCORE SELF)))))
   ((CL:EQ SLOTNAME SYM-PARTIAL-MATCH-LOGIC-ACCUMULATED-WEIGHT)
    (CL:IF SETVALUE? (CL:SETF (%ACCUMULATED-WEIGHT SELF) (%WRAPPER-VALUE VALUE))
   ...
   ((CL:EQ SLOTNAME SYM-PARTIAL-MATCH-LOGIC-MAXIMUM-SCORE)
    (CL:IF SETVALUE? (CL:SETF (%MAXIMUM-SCORE SELF) (%WRAPPER-VALUE VALUE))
   ...
   (CL:COND
    ((CL:EQ KIND KWD-PARTIAL-MATCH-AND)
     (CL:LET* ((ARGUMENTWEIGHT NULL-FLOAT) (TOTALWEIGHT 0.0d0) (NOFWEIGHTEDARGS 0))
      ...
      (CL:LET*
       ((ARG NULL) (VECTOR-000 (%ARGUMENTS (%PROPOSITION FRAME))) (INDEX-000 0) (LENGTH-000 (LENGTH VECTOR-000)))
       ...
       (CL:LOOP WHILE (CL:< INDEX-000 LENGTH-000) DO
        ...
        (CL:COND
         ((CL:AND (CL:EQ (%KIND ARG) KWD-PARTIAL-MATCH-AND)
           (CL:=
            (%WRAPPER-VALUE
             (DYNAMIC-SLOT-VALUE (%DYNAMIC-SLOTS ARG) SYM-PARTIAL-MATCH-LOGIC-WEIGHT NULL-FLOAT-WRAPPER))
            NULL-FLOAT))
          (CL:SETQ NOFWEIGHTEDARGS 0)
          (CL:LET* ((SUBARG NULL) (VECTOR-001 (%ARGUMENTS ARG)) (INDEX-001 0) (LENGTH-001 (LENGTH VECTOR-001)))
           ...
           (CL:LOOP WHILE (CL:< INDEX-001 LENGTH-001) DO
            ...
            (CL:WHEN
             (CL:OR (CL:= (PROPOSITION-WEIGHT SELF SUBARG) NULL-FLOAT) (CL:> (PROPOSITION-WEIGHT SELF SUBARG) 0.0d0))
             (CL:SETQ NOFWEIGHTEDARGS (CL:1+ NOFWEIGHTEDARGS)))
            (CL:SETQ INDEX-001 (CL:1+ INDEX-001))))
          (CL:SETQ ARGUMENTWEIGHT (CL:* 1.0d0 NOFWEIGHTEDARGS))
          (SET-DYNAMIC-SLOT-VALUE (%DYNAMIC-SLOTS ARG) SYM-PARTIAL-MATCH-LOGIC-WEIGHT (WRAP-FLOAT ARGUMENTWEIGHT)
           NULL-FLOAT-WRAPPER))
   ...
   (CL:WHEN (CL:NOT (CL:EQ PARENT NULL))
    (CL:COND
     ((CL:EQ (%KIND PARENT) KWD-PARTIAL-MATCH-AND)
      (CL:LET*
       ((PCUTOFF (%DYNAMIC-CUTOFF PARENT)) (TOTWEIGHT (%TOTAL-WEIGHT PARENT))
        (PROPWEIGHT (PROPOSITION-WEIGHT SELF (%PROPOSITION (%CONTROL-FRAME SELF))))
        ...
        (UNSCALEDCUTOFF (CL:- (CL:* PCUTOFF TOTWEIGHT) (%ACCUMULATED-SCORE PARENT) MAXOTHER)))
       (CL:DECLARE (CL:TYPE CL:DOUBLE-FLOAT PCUTOFF TOTWEIGHT PROPWEIGHT WEIGHT MAXOTHER UNSCALEDCUTOFF))
    ...
    (CL:COND ((CL:AND (CL:< CUTOFF 0.0d0) (CL:NOT (%REVERSE-POLARITY? (%CONTROL-FRAME SELF)))) (CL:SETQ CUTOFF 0.0d0))
     ...
     ((CL:NOT (CL:EQ (%REVERSE-POLARITY? (%CONTROL-FRAME SELF)) (%REVERSE-POLARITY? (%CONTROL-FRAME PARENT))))
...
(CL:DEFMETHOD POP-AND-PARTIAL-MATCH-SCORE ((SELF INCREMENTAL-PARTIAL-MATCH))
  (CL:SETF (%ACCUMULATED-SCORE SELF)
   (CL:- (%ACCUMULATED-SCORE SELF)
    (CL:* (%WRAPPER-VALUE (%%VALUE (%ARGUMENT-SCORES SELF))) (%WRAPPER-VALUE (%%VALUE (%ARGUMENT-WEIGHTS SELF))))))
  (CL:SETF (%ACCUMULATED-WEIGHT SELF)
   (CL:- (%ACCUMULATED-WEIGHT SELF) (%WRAPPER-VALUE (%%VALUE (%ARGUMENT-WEIGHTS SELF)))))
     ...
     (CL:LET* ((FOUND?-000 CL:NIL))
      (CL:LET* ((VAR NULL) (ITER-000 (GET-UNBOUND-VARIABLES CONJUNCT)))
       (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-000 NIL)) DO (CL:SETQ VAR (%%VALUE ITER-000))
        (CL:WHEN (MEMBER? FORBIDDENVARS VAR) (CL:SETQ FOUND?-000 CL:T) (CL:RETURN))
        (CL:SETQ ITER-000 (%%REST ITER-000))))
      (CL:SETQ TEST-VALUE-000 FOUND?-000)))
    (CL:WHEN (CL:NOT TEST-VALUE-000)
     (CL:SETQ TEST-VALUE-000 (CL:AND FAILUNCONSTRAINEDCLAUSES? (ALL-VARIABLES-UNBOUND? CONJUNCT))))
    (CL:WHEN TEST-VALUE-000
     (CL:LET* ((RESULT (CREATE-DOWN-FRAME FRAME CONJUNCT))) (SET-FRAME-TRUTH-VALUE RESULT UNKNOWN-TRUTH-VALUE)
      ...
      (CL:LET* ((SELF-000 (NEW-PRIMITIVE-STRATEGY)))
       (CL:SETF (%INFERENCE-RULE SELF-000) KWD-PARTIAL-MATCH-SKIPPED-CONJUNCT)
      ...
      (CL:LET
       ((SELF (%THE-ARRAY (DYNAMIC-SLOT-VALUE (%DYNAMIC-SLOTS FRAME) SYM-PARTIAL-MATCH-STELLA-ARGUMENTS NULL)))
      ...
      (CL:WHEN (TRACE-KEYWORD? KWD-PARTIAL-MATCH-GOAL-TREE)
       (%%PRINT-STREAM (%NATIVE-STREAM STANDARD-OUTPUT) "*** Skipping clause " CONJUNCT EOL))
...
(CL:DEFMETHOD CONTINUE-PARTIAL-AND-PROOF ((SELF INCREMENTAL-PARTIAL-MATCH) FRAME LASTMOVE)
  (CL:LET* ((FORBIDDENVARS NIL))
   (CL:COND ((CL:EQ LASTMOVE KWD-PARTIAL-MATCH-DOWN) (SET-DYNAMIC-CUTOFF SELF))
    ((CL:OR (CL:EQ LASTMOVE KWD-PARTIAL-MATCH-UP-TRUE) (CL:EQ LASTMOVE KWD-PARTIAL-MATCH-UP-FAIL))
     (CL:LET*
      ((SUCCESS? (CL:EQ LASTMOVE KWD-PARTIAL-MATCH-UP-TRUE)) (ANDPROPOSITION (%PROPOSITION FRAME))
       (CONJUNCTFRAME (%RESULT FRAME)) (CONJUNCT (%PROPOSITION CONJUNCTFRAME))
       (SCORE (%POSITIVE-SCORE (%PARTIAL-MATCH-FRAME CONJUNCTFRAME))) (WEIGHT (PROPOSITION-WEIGHT SELF CONJUNCT)))
      (CL:DECLARE (CL:TYPE CL:DOUBLE-FLOAT SCORE WEIGHT)) (CL:SETQ LASTMOVE KWD-PARTIAL-MATCH-UP-TRUE)
      (PUSH-AND-PARTIAL-MATCH-SCORE SELF SCORE WEIGHT)
      (CL:COND
       ((CUTOFF-PARTIAL-MATCH? (%PARTIAL-MATCH-FRAME CONJUNCTFRAME) (TRACE-KEYWORD? KWD-PARTIAL-MATCH-GOAL-TREE))
        (CL:SETQ LASTMOVE KWD-PARTIAL-MATCH-UP-FAIL))
       ((CL:AND
         (CL:OR (CL:EQ (%TRUTH-VALUE CONJUNCTFRAME) FALSE-TRUTH-VALUE)
          (CL:EQ (%TRUTH-VALUE CONJUNCTFRAME) DEFAULT-FALSE-TRUTH-VALUE))
         (CL:OR (CL:EQ (%TRUTH-VALUE CONJUNCTFRAME) TRUE-TRUTH-VALUE)
          (CL:EQ (%TRUTH-VALUE CONJUNCTFRAME) FALSE-TRUTH-VALUE)))
        (CL:SETQ LASTMOVE KWD-PARTIAL-MATCH-UP-FAIL))
       ((CL:AND (COERCE-WRAPPED-BOOLEAN-TO-BOOLEAN (VARIABLE-TYPE? CONJUNCT)) (CL:NOT SUCCESS?))
        (CL:SETQ LASTMOVE KWD-PARTIAL-MATCH-UP-FAIL))
       (CL:T
        (CL:WHEN (CL:= (%ARGUMENT-CURSOR FRAME) (CL:1- (LENGTH (%ARGUMENTS ANDPROPOSITION))))
         (CL:SETQ SCORE (COMPUTE-AND-SCORE SELF))
         (CL:IF
          (CL:OR (CL:<= SCORE *MINIMUM-SCORE-CUTOFF*)
           (CL:AND (CL:NOT (ALL-ARGUMENTS-BOUND? ANDPROPOSITION)) (CL:NOT (ALLOW-UNBOUND-VARIABLES? SELF))))
          (CL:SETQ LASTMOVE KWD-PARTIAL-MATCH-UP-FAIL)
     ...
     ((CL:EQ RESULT KWD-PARTIAL-MATCH-MOVE-DOWN)
      (CL:LET*
       ...
       (CL:LOOP WHILE (CL:<= ITER-000 UPPER-BOUND-000) DO (CL:SETQ I ITER-000) (CL:SETQ I I)
        (POP-AND-PARTIAL-MATCH-SCORE SELF) (CL:SETQ ITER-000 (CL:1+ ITER-000))))
      (CL:WHEN (SKIP-AND-CLAUSE? SELF FRAME FORBIDDENVARS)
       (CL:SETQ RESULT (CONTINUE-PARTIAL-AND-PROOF SELF FRAME KWD-PARTIAL-MATCH-UP-FAIL))))
     ((CL:EQ RESULT KWD-PARTIAL-MATCH-FAILURE)
      (SET-FRAME-PARTIAL-TRUTH SELF (%TRUTH-VALUE FRAME) NULL-FLOAT NULL-FLOAT CL:NIL))
     (CL:T))
    RESULT)))
   ...
   (CL:WHEN (CL:= LATESTSCORE MAXIMUMSCORE) (CL:SETQ MAXIMUMSCORE 0.0d0)
    (CL:LET* ((SCORE NULL) (ITER-000 (%ARGUMENT-SCORES SELF)) (WEIGHT NULL) (ITER-001 (%ARGUMENT-WEIGHTS SELF)))
     (CL:LOOP WHILE (CL:AND (CL:NOT (CL:EQ ITER-000 NIL)) (CL:NOT (CL:EQ ITER-001 NIL))) DO
      ...
      (CL:WHEN (CL:> (CL:* (%WRAPPER-VALUE SCORE) (%WRAPPER-VALUE WEIGHT)) MAXIMUMSCORE)
       (CL:SETQ MAXIMUMSCORE (CL:* (%WRAPPER-VALUE SCORE) (%WRAPPER-VALUE WEIGHT))))
...
(CL:DEFMETHOD CONTINUE-PARTIAL-OR-PROOF ((SELF INCREMENTAL-PARTIAL-MATCH) LASTMOVE)
  (CL:LET* ((FRAME (%CONTROL-FRAME SELF)) (ORPROPOSITION (%PROPOSITION FRAME)) (RESULT NULL))
   (CL:COND ((CL:EQ LASTMOVE KWD-PARTIAL-MATCH-DOWN) (SET-DYNAMIC-CUTOFF SELF))
    ((CL:OR (CL:EQ LASTMOVE KWD-PARTIAL-MATCH-UP-TRUE) (CL:EQ LASTMOVE KWD-PARTIAL-MATCH-UP-FAIL))
     (CL:LET*
      ((SUCESS? (CL:EQ LASTMOVE KWD-PARTIAL-MATCH-UP-TRUE)) (RESULT (%RESULT FRAME))
       (DISJUNCTS (%ARGUMENTS ORPROPOSITION))
       (DISJUNCT
        (CL:AREF (CL:THE CL:SIMPLE-VECTOR (%THE-ARRAY DISJUNCTS)) (CL:THE CL:FIXNUM (%ARGUMENT-CURSOR FRAME))))
       (SCORE NULL-FLOAT))
      ...
      (CL:SETQ SCORE (COMPUTE-OR-SCORE SELF)) (SET-FRAME-PARTIAL-TRUTH SELF NULL SCORE NULL-FLOAT CL:NIL)
      (CL:COND
       ((CL:OR (CL:AND (CL:NOT (ALL-ARGUMENTS-BOUND? DISJUNCT)) (CL:NOT (ALLOW-UNBOUND-VARIABLES? SELF)))
         ...
         (CL:AND (CL:NOT SUCESS?) (CL:= (%ARGUMENT-CURSOR FRAME) (CL:1- (LENGTH DISJUNCTS)))))
   ...
   (CL:COND
    ((CL:EQ RESULT KWD-PARTIAL-MATCH-MOVE-DOWN)
     (CL:LET*
      ((I NULL-INTEGER) (ITER-000 (%ARGUMENT-CURSOR FRAME)) (UPPER-BOUND-000 (CL:1- (LENGTH (%ARGUMENT-SCORES SELF)))))
      (CL:DECLARE (CL:TYPE CL:FIXNUM I ITER-000 UPPER-BOUND-000))
      (CL:LOOP WHILE (CL:<= ITER-000 UPPER-BOUND-000) DO (CL:SETQ I ITER-000) (CL:SETQ I I)
       (POP-OR-PARTIAL-MATCH-SCORE SELF) (CL:SETQ ITER-000 (CL:1+ ITER-000)))))
    ((CL:EQ RESULT KWD-PARTIAL-MATCH-FAILURE)
     (SET-FRAME-PARTIAL-TRUTH SELF NULL (COMPUTE-OR-SCORE SELF) NULL-FLOAT CL:NIL))
    (CL:T))
   RESULT))
    ...
    ((CL:OR (CL:EQ LASTMOVE KWD-PARTIAL-MATCH-UP-TRUE) (CL:EQ LASTMOVE KWD-PARTIAL-MATCH-UP-FAIL))
     (CL:LET* ((RESULT (%RESULT FRAME)) (RESULTPMF (%PARTIAL-MATCH-FRAME RESULT)))
      (CL:SETF (%POSITIVE-SCORE RESULTPMF)
       (CL:* (%POSITIVE-SCORE RESULTPMF) (PROPOSITION-WEIGHT RESULTPMF (%PROPOSITION RESULT))))
  ...
  (CL:LET* ((FRAME (%CONTROL-FRAME SELF)) (RESULT NULL))
   (CL:COND ((CL:EQ LASTMOVE KWD-PARTIAL-MATCH-DOWN) (SET-DYNAMIC-CUTOFF SELF))
    ((CL:EQ LASTMOVE KWD-PARTIAL-MATCH-UP-FAIL)
     (CL:WHEN (CL:NOT (CL:EQ (%DOWN FRAME) NULL)) (CL:SETF (%DOWN FRAME) NULL)))
    (CL:T))
   (CL:LOOP (CL:SETQ RESULT (CONTINUE-STRATEGIES-PROOFS FRAME LASTMOVE))
    (CL:COND
     ((CL:EQ RESULT KWD-PARTIAL-MATCH-CONTINUING-SUCCESS)
      (CL:IF (CUTOFF-PARTIAL-MATCH? SELF (TRACE-KEYWORD? KWD-PARTIAL-MATCH-GOAL-TREE))
...
(CL:DEFMETHOD CONTINUE-PARTIAL-ANTECEDENTS-PROOF ((SELF INCREMENTAL-PARTIAL-MATCH) LASTMOVE)
  (CL:LET* ((FRAME (%CONTROL-FRAME SELF)) (GOAL (EXTRACT-SUBGOAL-OF-FRAME FRAME)) (SCORE NULL-FLOAT) (RESULT NULL))
   ...
   (CL:COND ((CL:EQ LASTMOVE KWD-PARTIAL-MATCH-DOWN) (SET-DYNAMIC-CUTOFF SELF))
    ((CL:OR (CL:EQ LASTMOVE KWD-PARTIAL-MATCH-UP-TRUE) (CL:EQ LASTMOVE KWD-PARTIAL-MATCH-UP-FAIL))
     ...
     (PUSH-OR-PARTIAL-MATCH-SCORE SELF SCORE
      (PROPOSITION-WEIGHT SELF
       (DYNAMIC-SLOT-VALUE (%DYNAMIC-SLOTS FRAME) SYM-PARTIAL-MATCH-LOGIC-ANTECEDENTS-RULE NULL)))
    ...
    (CL:T
     (CL:LET* ((STREAM-000 (NEW-OUTPUT-STRING-STREAM)))
      (%%PRINT-STREAM (%NATIVE-STREAM STREAM-000) "`" LASTMOVE "' is not a valid case option")
      (CL:ERROR (NEW-STELLA-EXCEPTION (THE-STRING-READER STREAM-000))))))
   (CL:WHEN (CL:AND (CL:EQ LASTMOVE KWD-PARTIAL-MATCH-UP-FAIL) (CL:NOT (CL:EQ (%DOWN FRAME) NULL)))
    (CL:SETF (%DOWN FRAME) NULL))
   (CL:SETQ RESULT (CONTINUE-ANTECEDENTS-PROOF FRAME LASTMOVE))
   (CL:WHEN (CL:AND (CL:EQ LASTMOVE KWD-PARTIAL-MATCH-UP-TRUE) (CL:EQ (%TRUTH-VALUE FRAME) NULL))
    ...
    ((CL:EQ LASTMOVE KWD-PARTIAL-MATCH-UP-FAIL)
     (CL:LET* ((RESULT (%RESULT FRAME)) (RESULTPMF (%PARTIAL-MATCH-FRAME RESULT)))
      (CL:SETF (%POSITIVE-SCORE RESULTPMF)
       (CL:IF
        (CL:NOT
         (CL:EQ (DYNAMIC-SLOT-VALUE (%DYNAMIC-SLOTS FRAME) SYM-PARTIAL-MATCH-LOGIC-INFERENCE-CUTOFF-REASON NULL) NULL))
        0.0d0 (CL:* (%POSITIVE-SCORE RESULTPMF) (PROPOSITION-WEIGHT RESULTPMF (%PROPOSITION RESULT)) -1.0d0)))
      (PROPAGATE-FRAME-PARTIAL-TRUTH RESULTPMF FRAME)))
    (CL:T
     (CL:LET* ((STREAM-000 (NEW-OUTPUT-STRING-STREAM)))
      (%%PRINT-STREAM (%NATIVE-STREAM STREAM-000) "`" LASTMOVE "' is not a valid case option")
...
(CL:DEFUN NEW-NN-PARTIAL-MATCH (KIND CONTROL-FRAME)
  (CL:LET* ((SELF NULL)) (CL:SETQ SELF (CL:MAKE-INSTANCE (CL:QUOTE NN-PARTIAL-MATCH))) (CL:SETF (%KIND SELF) KIND)
   (CL:SETF (%CONTROL-FRAME SELF) CONTROL-FRAME) (CL:SETF (%SUCCESS? SELF) CL:NIL) (CL:SETF (%UNBOUND-VARS SELF) NIL)
   (CL:SETF (%ARGUMENT-WEIGHTS SELF) NIL) (CL:SETF (%ARGUMENT-SCORES SELF) NIL)
   (CL:SETF (%DYNAMIC-CUTOFF SELF) NULL-FLOAT) (CL:SETF (%NEGATIVE-SCORE SELF) NULL-FLOAT)
   (CL:SETF (%POSITIVE-SCORE SELF) NULL-FLOAT) (CL:SETF (%ARITY SELF) NULL-INTEGER) (CL:SETF (%RULES SELF) NIL)
   (CL:SETF (%MAXIMUM-SCORE SELF) 0.0d0) (CL:SETF (%ACCUMULATED-SCORE SELF) 0.0d0) (CL:SETF (%CHILD SELF) NULL)
   (CL:SETF (%PARENT SELF) NULL) (INITIALIZE-NN-PARTIAL-MATCH SELF) SELF))
...
(CL:DEFUN ACCESS-NN-PARTIAL-MATCH-SLOT-VALUE (SELF SLOTNAME VALUE SETVALUE?)
  (CL:COND
   ...
   ((CL:EQ SLOTNAME SYM-PARTIAL-MATCH-LOGIC-RULES)
    (CL:IF SETVALUE? (CL:SETF (%RULES SELF) VALUE) (CL:SETQ VALUE (%RULES SELF))))
   ((CL:EQ SLOTNAME SYM-PARTIAL-MATCH-STELLA-ARITY)
    (CL:IF SETVALUE? (CL:SETF (%ARITY SELF) (%WRAPPER-VALUE VALUE)) (CL:SETQ VALUE (WRAP-INTEGER (%ARITY SELF)))))
   (CL:T
    (CL:LET* ((STREAM-000 (NEW-OUTPUT-STRING-STREAM)))
     (%%PRINT-STREAM (%NATIVE-STREAM STREAM-000) "`" SLOTNAME "' is not a valid case option")
     (CL:ERROR (NEW-STELLA-EXCEPTION (THE-STRING-READER STREAM-000))))))
    ...
    (CL:COND
     ((CL:OR (CL:EQ TEST-VALUE-000 KWD-PARTIAL-MATCH-AND) (CL:EQ TEST-VALUE-000 KWD-PARTIAL-MATCH-OR))
      (CL:WHEN (CL:EQ (DYNAMIC-SLOT-VALUE (%DYNAMIC-SLOTS PROP) SYM-PARTIAL-MATCH-LOGIC-NEURAL-NETWORK NULL) NULL)
       (SET-DYNAMIC-SLOT-VALUE (%DYNAMIC-SLOTS PROP) SYM-PARTIAL-MATCH-LOGIC-NEURAL-NETWORK
   ...
   (CL:LET* ((TEST-VALUE-000 (%KIND SELF)))
    (CL:COND
     ((CL:EQ TEST-VALUE-000 KWD-PARTIAL-MATCH-ATOMIC-GOAL)
      (CL:RETURN-FROM COMPUTE-DYNAMIC-CUTOFF (%DYNAMIC-CUTOFF (%PARENT SELF))))
     ((CL:OR (CL:EQ TEST-VALUE-000 KWD-PARTIAL-MATCH-AND) (CL:EQ TEST-VALUE-000 KWD-PARTIAL-MATCH-OR))
      (CL:LET*
       ((PARENT (%PARENT SELF))
        (NET
         (DYNAMIC-SLOT-VALUE (%DYNAMIC-SLOTS (%PROPOSITION (%CONTROL-FRAME SELF)))
       ...
       (CL:WHEN (CL:> (%DYNAMIC-CUTOFF PARENT) 0.1d0)
        (CL:LET* ((INPUT NULL) (VECTOR-000 (%INPUT NET)) (INDEX-000 0) (LENGTH-000 (LENGTH VECTOR-000)))
         (CL:DECLARE (CL:TYPE CL:FIXNUM INDEX-000 LENGTH-000))
         (CL:LOOP WHILE (CL:< INDEX-000 LENGTH-000) DO
          (CL:SETQ INPUT (CL:AREF (CL:THE CL:SIMPLE-VECTOR (%THE-ARRAY VECTOR-000)) INDEX-000))
...
(CL:DEFMETHOD PROPOSITION-WEIGHT ((SELF NN-PARTIAL-MATCH) PROPOSITION)
  ...
  (CL:WHEN (COERCE-WRAPPED-BOOLEAN-TO-BOOLEAN (VARIABLE-TYPE? PROPOSITION))
   (SET-DYNAMIC-SLOT-VALUE (%DYNAMIC-SLOTS PROPOSITION) SYM-PARTIAL-MATCH-LOGIC-WEIGHT (WRAP-FLOAT 0.0d0)
    NULL-FLOAT-WRAPPER))
  (CL:WHEN (CL:NOT (CL:EQ (ACCESS-IN-CONTEXT (%TRUTH-VALUE PROPOSITION) (%HOME-CONTEXT PROPOSITION) CL:NIL) NULL))
   (SET-DYNAMIC-SLOT-VALUE (%DYNAMIC-SLOTS PROPOSITION) SYM-PARTIAL-MATCH-LOGIC-WEIGHT
    (WRAP-FLOAT (%POSITIVE-SCORE (ACCESS-IN-CONTEXT (%TRUTH-VALUE PROPOSITION) (%HOME-CONTEXT PROPOSITION) CL:NIL)))
    NULL-FLOAT-WRAPPER))
  (CL:WHEN
   (CL:=
    (%WRAPPER-VALUE
     (DYNAMIC-SLOT-VALUE (%DYNAMIC-SLOTS PROPOSITION) SYM-PARTIAL-MATCH-LOGIC-WEIGHT NULL-FLOAT-WRAPPER))
    NULL-FLOAT)
   (SET-DYNAMIC-SLOT-VALUE (%DYNAMIC-SLOTS PROPOSITION) SYM-PARTIAL-MATCH-LOGIC-WEIGHT (WRAP-FLOAT 1.0d0)
    NULL-FLOAT-WRAPPER))
    ...
    (CL:IF (CL:NOT (CL:EQ PROP NULL))
     (CL:PROGN
      (CL:IF
       (CL:NOT
        (CL:=
         (%WRAPPER-VALUE (DYNAMIC-SLOT-VALUE (%DYNAMIC-SLOTS PROP) SYM-PARTIAL-MATCH-LOGIC-WEIGHT NULL-FLOAT-WRAPPER))
         NULL-FLOAT))
       (SET-DYNAMIC-SLOT-VALUE (%DYNAMIC-SLOTS PROP) SYM-PARTIAL-MATCH-LOGIC-MATCH-SCORE
        (WRAP-FLOAT
         (%WRAPPER-VALUE (DYNAMIC-SLOT-VALUE (%DYNAMIC-SLOTS PROP) SYM-PARTIAL-MATCH-LOGIC-WEIGHT NULL-FLOAT-WRAPPER)))
        NULL-FLOAT-WRAPPER)
       (SET-DYNAMIC-SLOT-VALUE (%DYNAMIC-SLOTS PROP) SYM-PARTIAL-MATCH-LOGIC-MATCH-SCORE (WRAP-FLOAT 1.0d0)
        NULL-FLOAT-WRAPPER))
      (SET-DYNAMIC-SLOT-VALUE (%DYNAMIC-SLOTS *QUERYITERATOR*) SYM-PARTIAL-MATCH-LOGIC-LATEST-POSITIVE-SCORE
       (WRAP-FLOAT
        (%WRAPPER-VALUE
         (DYNAMIC-SLOT-VALUE (%DYNAMIC-SLOTS PROP) SYM-PARTIAL-MATCH-LOGIC-MATCH-SCORE NULL-FLOAT-WRAPPER)))
       NULL-FLOAT-WRAPPER))
     (SET-DYNAMIC-SLOT-VALUE (%DYNAMIC-SLOTS *QUERYITERATOR*) SYM-PARTIAL-MATCH-LOGIC-LATEST-POSITIVE-SCORE
      (WRAP-FLOAT 1.0d0) NULL-FLOAT-WRAPPER)))
   ((CL:EQ TRUTH KWD-PARTIAL-MATCH-FAIL)
    (CL:WHEN (CL:NOT (CL:EQ PROP NULL))
     (SET-DYNAMIC-SLOT-VALUE (%DYNAMIC-SLOTS PROP) SYM-PARTIAL-MATCH-LOGIC-MATCH-SCORE (WRAP-FLOAT 0.0d0)
      NULL-FLOAT-WRAPPER))
    (SET-DYNAMIC-SLOT-VALUE (%DYNAMIC-SLOTS *QUERYITERATOR*) SYM-PARTIAL-MATCH-LOGIC-LATEST-POSITIVE-SCORE
     (WRAP-FLOAT 0.0d0) NULL-FLOAT-WRAPPER))
   (CL:T
...
(CL:DEFMETHOD SET-CACHE-PARTIAL-TRUTH ((SELF NN-PARTIAL-MATCH) CACHE)
  (CL:SETF (%POSITIVE-SCORE CACHE)
   (%WRAPPER-VALUE
    (DYNAMIC-SLOT-VALUE (%DYNAMIC-SLOTS *QUERYITERATOR*) SYM-PARTIAL-MATCH-LOGIC-LATEST-POSITIVE-SCORE
     NULL-FLOAT-WRAPPER))))
  ...
  (CL:LET* ((FRAME (%CONTROL-FRAME SELF)))
   (CL:WHEN
    ...
    (CL:LET*
     ...
     (SET-DYNAMIC-SLOT-VALUE (%DYNAMIC-SLOTS ANTE) SYM-PARTIAL-MATCH-LOGIC-MATCH-SCORE (WRAP-FLOAT SCORE)
      NULL-FLOAT-WRAPPER)))))
...
(CL:DEFMETHOD COMPUTE-AND-SCORE ((SELF NN-PARTIAL-MATCH))
  (CL:LET*
   ((NET
     (DYNAMIC-SLOT-VALUE (%DYNAMIC-SLOTS (%PROPOSITION (%CONTROL-FRAME SELF))) SYM-PARTIAL-MATCH-LOGIC-NEURAL-NETWORK
      NULL)))
   (CL:LET*
    ((SCORE NULL) (ITER-000 (REVERSE (COPY-CONS-LIST (%ARGUMENT-SCORES SELF)))) (ARG NULL)
     (VECTOR-000 (%ARGUMENTS (%PROPOSITION (%CONTROL-FRAME SELF)))) (INDEX-000 0) (LENGTH-000 (LENGTH VECTOR-000)))
    (CL:DECLARE (CL:TYPE CL:FIXNUM INDEX-000 LENGTH-000))
    (CL:LOOP WHILE (CL:AND (CL:NOT (CL:EQ ITER-000 NIL)) (CL:< INDEX-000 LENGTH-000)) DO
     (CL:SETQ SCORE (%%VALUE ITER-000))
     (CL:SETQ ARG (CL:AREF (CL:THE CL:SIMPLE-VECTOR (%THE-ARRAY VECTOR-000)) INDEX-000))
     (SET-DYNAMIC-SLOT-VALUE (%DYNAMIC-SLOTS ARG) SYM-PARTIAL-MATCH-LOGIC-MATCH-SCORE
      (WRAP-FLOAT (%WRAPPER-VALUE SCORE)) NULL-FLOAT-WRAPPER)
     (CL:SETQ ITER-000 (%%REST ITER-000)) (CL:SETQ INDEX-000 (CL:1+ INDEX-000))))
   (CL:WHEN (CL:NOT (CL:EQ NET NULL)) (CL:RETURN-FROM COMPUTE-AND-SCORE (ACTIVATE-PROPOSITIONAL-NEURAL-NETWORK NET)))
   0.0d0))
   ...
   (CL:LET*
    ...
    (CL:LOOP WHILE (CL:AND (CL:NOT (CL:EQ ITER-000 NIL)) (CL:< INDEX-000 LENGTH-000)) DO
     ...
     (SET-DYNAMIC-SLOT-VALUE (%DYNAMIC-SLOTS ARG) SYM-PARTIAL-MATCH-LOGIC-MATCH-SCORE
      (WRAP-FLOAT (%WRAPPER-VALUE SCORE)) NULL-FLOAT-WRAPPER)
     (CL:SETQ ITER-000 (%%REST ITER-000)) (CL:SETQ INDEX-000 (CL:1+ INDEX-000))))
   (CL:WHEN (CL:NOT (CL:EQ NET NULL)) (CL:RETURN-FROM COMPUTE-OR-SCORE (ACTIVATE-PROPOSITIONAL-NEURAL-NETWORK NET)))
   0.0d0))
...
(CL:DEFUN PRUNE-NN-SEARCH? (SELF)
  (CL:LET*
   ((MAX-POSSIBLE-ACTIVE (CL:+ (%ACCUMULATED-SCORE SELF) (CL:- (%ARITY SELF) (LENGTH (%ARGUMENT-SCORES SELF))))))
   (CL:DECLARE (CL:TYPE CL:DOUBLE-FLOAT MAX-POSSIBLE-ACTIVE))
   (CL:IF
    (CL:AND *GREEDY-NETWORK-PRUNING* (CL:NOT (CL:EQ *RULE-COMBINATION* KWD-PARTIAL-MATCH-NOISY-OR))
     (CL:< MAX-POSSIBLE-ACTIVE (%DYNAMIC-CUTOFF SELF)))
    (CL:PROGN
     (CL:WHEN (TRACE-KEYWORD? KWD-PARTIAL-MATCH-GOAL-TREE)
      (%%PRINT-STREAM (%NATIVE-STREAM STANDARD-OUTPUT) "*** Cutting off search, cutoff: " (%DYNAMIC-CUTOFF SELF)
...
(CL:DEFUN MAKE-PARTIAL-MATCH-FRAME (QUERY)
  (CL:LET*
   ((MATCHMODE (LOOKUP (%OPTIONS QUERY) KWD-PARTIAL-MATCH-MATCH-MODE)) (FRAME (%BASE-CONTROL-FRAME QUERY))
    (KIND (%STATE FRAME)))
   (CL:WHEN (CL:EQ MATCHMODE NULL) (CL:SETQ MATCHMODE *PARTIAL-MATCH-MODE*))
   (CL:COND
    ((CL:OR (CL:EQ MATCHMODE KWD-PARTIAL-MATCH-BASIC) (CL:EQ MATCHMODE KWD-PARTIAL-MATCH-INCREMENTAL))
     (NEW-INCREMENTAL-PARTIAL-MATCH KIND FRAME))
    ((CL:OR (CL:EQ MATCHMODE KWD-PARTIAL-MATCH-NN) (CL:EQ MATCHMODE KWD-PARTIAL-MATCH-NEURAL-NETWORK))
     (NEW-NN-PARTIAL-MATCH KIND FRAME))
    (CL:T
     (CL:LET* ((CLASS NULL) (CLASSNAME (CONCATENATE (%SYMBOL-NAME MATCHMODE) "-PARTIAL-MATCH")))
        ...
        (CL:IF (CL:AND (CL:NOT (CL:EQ CLASS NULL)) (ISA? CLASS SGT-PARTIAL-MATCH-STELLA-CLASS))
         ...
         (CL:LET* ((STREAM-000 (NEW-OUTPUT-STRING-STREAM)))
          (CL:LET* ((*PRINTREADABLY?* CL:T)) (CL:DECLARE (CL:SPECIAL *PRINTREADABLY?*))
           (%%PRINT-STREAM (%NATIVE-STREAM STREAM-000) "PARSING ERROR: Unknown partial match mode: `" MATCHMODE "'."
            EOL)
...
(CL:DEFUN INITIALIZE-PARTIAL-QUERY (QUERY)
  (CL:LET* ((PARTIALMATCHFRAME (%PARTIAL-MATCH-STRATEGY QUERY)))
   (CL:WHEN (CL:EQ PARTIALMATCHFRAME NULL) (CL:SETQ PARTIALMATCHFRAME (MAKE-PARTIAL-MATCH-FRAME QUERY))
...
(CL:DEFMETHOD INITIALIZE-PARTIAL-MATCH-STRATEGY ((SELF PARTIAL-MATCH-FRAME) QUERY)
  (CL:LET* ((MINIMUMSCORE (LOOKUP (%OPTIONS QUERY) KWD-PARTIAL-MATCH-MINIMUM-SCORE)) (EPSILON 0.001d0))
   ...
   (SET-DYNAMIC-SLOT-VALUE (%DYNAMIC-SLOTS QUERY) SYM-PARTIAL-MATCH-LOGIC-LATEST-POSITIVE-SCORE (WRAP-FLOAT 0.0d0)
    NULL-FLOAT-WRAPPER)))
...
(CL:DEFUN CREATE-AND-LINK-PARTIAL-MATCH-FRAME (FRAME KIND)
  (CL:LET*
   ...
   (CL:SETF (%KIND PARTIALMATCHFRAME) KIND) (CL:SETF (%PARTIAL-MATCH-FRAME FRAME) PARTIALMATCHFRAME)
...
(CL:DEFUN GET-UNBOUND-VARIABLES (PROP)
  (CL:LET* ((RESULT NIL))
   (CL:LET* ((ARG NULL) (VECTOR-000 (%ARGUMENTS PROP)) (INDEX-000 0) (LENGTH-000 (LENGTH VECTOR-000)))
    ...
    (CL:LOOP WHILE (CL:< INDEX-000 LENGTH-000) DO
     (CL:SETQ ARG (CL:AREF (CL:THE CL:SIMPLE-VECTOR (%THE-ARRAY VECTOR-000)) INDEX-000))
     (CL:LET* ((BIND (ARGUMENT-BOUND-TO ARG))) (CL:WHEN (CL:EQ BIND NULL) (CL:SETQ RESULT (CONS ARG RESULT))))
...
(CL:DEFUN ALL-VARIABLES-UNBOUND? (PROP)
  (CL:LET* ((FOUND?-000 CL:NIL))
   (CL:LET* ((VAR NULL) (VECTOR-000 (%ARGUMENTS PROP)) (INDEX-000 0) (LENGTH-000 (LENGTH VECTOR-000)))
    (CL:DECLARE (CL:TYPE CL:FIXNUM INDEX-000 LENGTH-000))
    (CL:LOOP WHILE (CL:< INDEX-000 LENGTH-000) DO
     (CL:SETQ VAR (CL:AREF (CL:THE CL:SIMPLE-VECTOR (%THE-ARRAY VECTOR-000)) INDEX-000))
     (CL:WHEN (CL:NOT (CL:EQ (ARGUMENT-BOUND-TO VAR) NULL)) (CL:SETQ FOUND?-000 CL:T) (CL:RETURN))
     (CL:SETQ INDEX-000 (CL:1+ INDEX-000))))
...
(CL:DEFUN RECORD-LATEST-PARTIAL-MATCH-SCORE (FRAME)
  (CL:LET*
   ...
   (CL:WHEN
    (CL:AND (CL:EQ (%KIND PFRAME) KWD-PARTIAL-MATCH-AND) (COERCE-WRAPPED-BOOLEAN-TO-BOOLEAN (VARIABLE-TYPE? PROP))
     (CL:NOT (%SUCCESS? PFRAME)))
    (CL:SETQ *AND-MISSED-A-BINDING* CL:T))
   (CL:WHEN
    (CL:AND (CL:EQ (%KIND PFRAME) KWD-PARTIAL-MATCH-AND) (CL:= SCORE 0.0d0)
     (CL:EQ (%KIND PROP) KWD-PARTIAL-MATCH-FUNCTION)
     (CL:AND (ISA? (LAST (%ARGUMENTS PROP)) SGT-PARTIAL-MATCH-LOGIC-PATTERN-VARIABLE)
...
(CL:DEFUN COMPUTE-PARTIAL-MATCH-SCORE? (FRAME)
  (CL:LET* ((PARTIALMATCHFRAME (%PARTIAL-MATCH-FRAME FRAME)) (SCORE NULL-FLOAT))
   (CL:DECLARE (CL:TYPE CL:DOUBLE-FLOAT SCORE))
   (CL:LET* ((TEST-VALUE-000 (%KIND PARTIALMATCHFRAME)))
    (CL:COND ((CL:EQ TEST-VALUE-000 KWD-PARTIAL-MATCH-AND) (CL:SETQ SCORE (COMPUTE-AND-SCORE PARTIALMATCHFRAME)))
     ...
     ((CL:EQ TEST-VALUE-000 KWD-PARTIAL-MATCH-ATOMIC-GOAL) (CL:SETQ SCORE (COMPUTE-GOAL-SCORE PARTIALMATCHFRAME)))
     (CL:T)))
   (SET-DYNAMIC-SLOT-VALUE (%DYNAMIC-SLOTS *QUERYITERATOR*) SYM-PARTIAL-MATCH-LOGIC-LATEST-POSITIVE-SCORE
    (WRAP-FLOAT SCORE) NULL-FLOAT-WRAPPER)
   (CL:SETF (%POSITIVE-SCORE PARTIALMATCHFRAME) SCORE)
   (SET-DYNAMIC-SLOT-VALUE (%DYNAMIC-SLOTS (%PROPOSITION FRAME)) SYM-PARTIAL-MATCH-LOGIC-MATCH-SCORE (WRAP-FLOAT SCORE)
    NULL-FLOAT-WRAPPER)
...
illegal queries and logical expressions."
  (CL:LET* ((THEQUERY (CREATE-RETRIEVE-QUERY QUERY))) (INITIALIZE-PARTIAL-QUERY THEQUERY)
   (RETRIEVE-PARTIAL-SOLUTIONS (%PARTIAL-MATCH-STRATEGY THEQUERY) THEQUERY)
   (CL:WHEN (CL:EQ (LOOKUP-QUERY-OPTION THEQUERY KWD-PARTIAL-MATCH-SORT-BY) KWD-PARTIAL-MATCH-SCORE)
...
(CL:DEFMETHOD RETRIEVE-PARTIAL-SOLUTIONS ((SELF PARTIAL-MATCH-FRAME) QUERY)
  (CL:SETQ QUERY QUERY)
  (CL:LET* ((STREAM-000 (NEW-OUTPUT-STRING-STREAM)))
   (%%PRINT-STREAM (%NATIVE-STREAM STREAM-000) "Don't know how to retrieve partial solutions for `" SELF "'")
   (CL:ERROR (NEW-STELLA-EXCEPTION (THE-STRING-READER STREAM-000)))))
...
(CL:DEFMETHOD RETRIEVE-PARTIAL-SOLUTIONS ((SELF INCREMENTAL-PARTIAL-MATCH) QUERY)
  (CL:LET* ((MAXIMIZESCORE? (LOOKUP-QUERY-OPTION QUERY KWD-PARTIAL-MATCH-MAXIMIZE-SCORE?)))
   ...
   (CL:LET*
    ((*QUERYITERATOR* QUERY) (*REVERSEPOLARITY?* CL:NIL) (*GENERATE-ALL-PROOFS?* CL:NIL)
    ...
    (CL:LET*
     ((I NULL-INTEGER) (ITER-000 1) (UPPER-BOUND-000 (LOOKUP-HOW-MANY-SOLUTIONS QUERY))
      (UNBOUNDED?-000 (CL:= UPPER-BOUND-000 NULL-INTEGER)) (SOLUTION NULL) (ITER-001 QUERY))
     (CL:DECLARE (CL:TYPE CL:FIXNUM I ITER-000 UPPER-BOUND-000))
     (CL:LOOP WHILE (CL:AND (CL:OR UNBOUNDED?-000 (CL:<= ITER-000 UPPER-BOUND-000)) (NEXT? ITER-001)) DO
      (CL:SETQ I ITER-000) (CL:SETQ SOLUTION (%VALUE ITER-001)) (CL:PROGN (CL:SETQ SOLUTION SOLUTION) (CL:SETQ I I))
...
(CL:DEFUN ASK-PARTIAL-EVALUATOR-WRAPPER (ARGUMENTS)
  (CL:LET* ((RESULT (%ASK-PARTIAL ARGUMENTS))) (CL:DECLARE (CL:TYPE CL:DOUBLE-FLOAT RESULT))
...
(CL:DEFUN RETURN-PARTIAL-TRUTH (QUERY TOP?)
  (CL:WHEN (CL:NOT TOP?)
   (INSERT-AT (%OPTIONS QUERY) KWD-PARTIAL-MATCH-MAXIMIZE-SCORE? (CL:IF TOP? TRUE-WRAPPER FALSE-WRAPPER)))
...
(CL:DEFUN CALL-ASK-PARTIAL (QUERY)
  (CL:LET* ((THEQUERY (CREATE-ASK-QUERY QUERY))) (INITIALIZE-PARTIAL-QUERY THEQUERY)
   (CL:WHEN (CL:EQ *MOST-RECENT-QUERY* NULL) (CL:SETQ *MOST-RECENT-QUERY* THEQUERY))
...
(CL:DEFMETHOD COMPUTE-PARTIAL-TRUTH ((SELF PARTIAL-MATCH-FRAME) QUERY)
  (CL:SETQ QUERY QUERY)
  (CL:LET* ((STREAM-000 (NEW-OUTPUT-STRING-STREAM)))
   (%%PRINT-STREAM (%NATIVE-STREAM STREAM-000) "Don't know how to compute partial truth for `" SELF "'")
   (CL:ERROR (NEW-STELLA-EXCEPTION (THE-STRING-READER STREAM-000)))))
...
(CL:DEFMETHOD COMPUTE-PARTIAL-TRUTH ((SELF INCREMENTAL-PARTIAL-MATCH) QUERY)
  (CL:LET*
   ((BASEFRAME (%BASE-CONTROL-FRAME QUERY)) (PARTIALMATCHFRAME (%PARTIAL-MATCH-STRATEGY QUERY))
    (MINIMUMSCORE (LOOKUP (%OPTIONS QUERY) KWD-PARTIAL-MATCH-MINIMUM-SCORE))
    (MAXIMIZESCORE? (CL:NOT (EQL? (LOOKUP (%OPTIONS QUERY) KWD-PARTIAL-MATCH-MAXIMIZE-SCORE?) FALSE-WRAPPER)))
    (EPSILON 0.001d0) (LATESTSCORE 0.0d0) (HIGHESTSCORE 0.0d0) (BESTJUSTIFICATION NULL))
   ...
   (CL:SETF (%DYNAMIC-CUTOFF PARTIALMATCHFRAME)
    (CL:IF (CL:NOT (CL:EQ MINIMUMSCORE NULL)) (%WRAPPER-VALUE MINIMUMSCORE) EPSILON))
   (CL:LET*
    ((*QUERYITERATOR* QUERY) (*GENERATE-ALL-PROOFS?* CL:T) (*INFERENCELEVEL* (CURRENT-INFERENCE-LEVEL))
    ...
    (CL:LOOP (CL:WHEN (CL:NOT (NEXT? QUERY)) (CL:RETURN)) (CL:SETQ LATESTSCORE (%POSITIVE-SCORE PARTIALMATCHFRAME))
     ...
     (CL:SETQ BESTJUSTIFICATION
      (DYNAMIC-SLOT-VALUE (%DYNAMIC-SLOTS BASEFRAME) SYM-PARTIAL-MATCH-LOGIC-JUSTIFICATION NULL))
     (CL:SETQ HIGHESTSCORE LATESTSCORE) (CL:SETF (%DYNAMIC-CUTOFF PARTIALMATCHFRAME) (CL:+ HIGHESTSCORE EPSILON))
     (CL:WHEN (CL:OR (CL:NOT MAXIMIZESCORE?) (KNOWN-TRUTH-VALUE? (%TRUTH-VALUE BASEFRAME))) (CL:RETURN))))
   (SET-DYNAMIC-SLOT-VALUE (%DYNAMIC-SLOTS BASEFRAME) SYM-PARTIAL-MATCH-LOGIC-JUSTIFICATION BESTJUSTIFICATION NULL)
   HIGHESTSCORE))
...
(CL:DEFMETHOD COMPUTE-PARTIAL-TRUTH ((SELF NN-PARTIAL-MATCH) QUERY)
  (CL:LET*
   ((PROPOSITION (%PROPOSITION (%BASE-CONTROL-FRAME QUERY))) (PARTIALMATCHFRAME (%PARTIAL-MATCH-STRATEGY QUERY))
    (MINIMUMSCORE (LOOKUP (%OPTIONS QUERY) KWD-PARTIAL-MATCH-MINIMUM-SCORE))
    (MAXIMIZESCORE? (CL:NOT (EQL? (LOOKUP (%OPTIONS QUERY) KWD-PARTIAL-MATCH-MAXIMIZE-SCORE?) FALSE-WRAPPER)))
    (EPSILON 0.001d0) (LATESTSCORE 0.0d0) (HIGHESTSCORE 0.0d0) (SCORELIST (NEW-LIST)) (WEIGHT 0.0d0) (NETLIST NULL)
   ...
   (CL:LET* ((*QUERYITERATOR* QUERY)) (CL:DECLARE (CL:SPECIAL *QUERYITERATOR*))
    (CL:LOOP
     ...
     (CL:SETQ LATESTSCORE
      (%WRAPPER-VALUE
       (DYNAMIC-SLOT-VALUE (%DYNAMIC-SLOTS QUERY) SYM-PARTIAL-MATCH-LOGIC-LATEST-POSITIVE-SCORE NULL-FLOAT-WRAPPER)))
     (CL:WHEN (MEMBER? SCORELIST (WRAP-FLOAT LATESTSCORE)) (CL:RETURN))
     (CL:WHEN (CL:> LATESTSCORE HIGHESTSCORE) (CL:SETQ SUPPORT (SUPPORT PROPOSITION))
      (CL:SETQ ACTIVATIONLIST (NEW-LIST)) (CL:SETQ NETLIST *ACTIVATED-NETWORKS*)
      (CL:LET* ((NET NULL) (ITER-000 (%THE-CONS-LIST *ACTIVATED-NETWORKS*)))
       (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-000 NIL)) DO (CL:SETQ NET (%%VALUE ITER-000))
        (CL:LET* ((PROPSCORES (NEW-LIST)))
         (CL:LET*
          ((PROP NULL) (VECTOR-000 (%ARGUMENTS (%PROPOSITION NET))) (INDEX-000 0) (LENGTH-000 (LENGTH VECTOR-000))
           (COLLECT-000 NULL))
          (CL:DECLARE (CL:TYPE CL:FIXNUM INDEX-000 LENGTH-000))
          (CL:LOOP WHILE (CL:< INDEX-000 LENGTH-000) DO
           (CL:SETQ PROP (CL:AREF (CL:THE CL:SIMPLE-VECTOR (%THE-ARRAY VECTOR-000)) INDEX-000))
     ...
     (CL:WHEN (CL:> LATESTSCORE HIGHESTSCORE) (CL:SETQ HIGHESTSCORE LATESTSCORE))
     (CL:SETF (%DYNAMIC-CUTOFF PARTIALMATCHFRAME) (CL:+ HIGHESTSCORE EPSILON))
     (CL:WHEN (CL:OR (CL:NOT MAXIMIZESCORE?) (CL:= HIGHESTSCORE 1.0d0)) (CL:RETURN))
     (PUSH SCORELIST (WRAP-FLOAT LATESTSCORE))))
   (CL:WHEN (CL:NOT (CL:EQ SUPPORT NULL))
    (SET-DYNAMIC-SLOT-VALUE (%DYNAMIC-SLOTS PROPOSITION) SYM-PARTIAL-MATCH-LOGIC-SUPPORT SUPPORT NULL)
    (CL:LET*
     ((NET NULL) (ITER-001 (%THE-CONS-LIST (REVERSE NETLIST))) (SCORELIST NULL)
     ...
     (CL:LOOP WHILE (CL:AND (CL:NOT (CL:EQ ITER-001 NIL)) (CL:NOT (CL:EQ ITER-002 NIL))) DO
      ...
      (CL:LET*
       ((PROP NULL) (VECTOR-001 (%ARGUMENTS (%PROPOSITION NET))) (INDEX-001 0) (LENGTH-001 (LENGTH VECTOR-001))
        (K NULL) (ITER-003 (%THE-CONS-LIST SCORELIST)))
       (CL:DECLARE (CL:TYPE CL:FIXNUM INDEX-001 LENGTH-001))
       (CL:LOOP WHILE (CL:AND (CL:< INDEX-001 LENGTH-001) (CL:NOT (CL:EQ ITER-003 NIL))) DO
        (CL:SETQ PROP (CL:AREF (CL:THE CL:SIMPLE-VECTOR (%THE-ARRAY VECTOR-001)) INDEX-001))
  ...
  (CL:LET*
   ((PATTERN
     (CONS KWD-PARTIAL-MATCH-RELATION
      (CONS (CL:IF (CL:EQ NIL NULL) NIL NIL) (CONS (%OPERATOR SELF) (CONS (GET-NULL-INSTANCE) NIL))))))
   (CL:LET* ((SELF-000 (NEW-SPECIALIZING-PROPOSITIONS-ITERATOR))) (CL:SETF (%SELECTION-PATTERN SELF-000) PATTERN)
    (CL:SETF (%PROPOSITION-CURSOR SELF-000) (ALLOCATE-ITERATOR (SELECT-PROPOSITIONS PATTERN)))
  ...
  (CL:LET*
   ...
   (CL:LET* ((TEST-VALUE-000 CL:NIL))
    (CL:LET* ((ALWAYS?-000 CL:T))
     (CL:LET*
      ((SUPERARG NULL) (VECTOR-000 (%ARGUMENTS REFERENCEPROPOSITION)) (INDEX-000 0) (LENGTH-000 (LENGTH VECTOR-000))
       (SUBARG NULL) (VECTOR-001 (%ARGUMENTS SUBPROPOSITION)) (INDEX-001 0) (LENGTH-001 (LENGTH VECTOR-001)))
    ...
    (CL:WHEN TEST-VALUE-000
     (CL:SETQ TEST-VALUE-000 (CL:= (LENGTH (%ARGUMENTS REFERENCEPROPOSITION)) (LENGTH (%ARGUMENTS SUBPROPOSITION)))))
...
(CL:DEFUN TRY-SCAN-PARTIAL-PROPOSITIONS-PROOF (FRAME)
  (CL:LET*
   ((PROPOSITION (%PROPOSITION FRAME))
    (ITERATOR (DYNAMIC-SLOT-VALUE (%DYNAMIC-SLOTS FRAME) SYM-PARTIAL-MATCH-STELLA-ITERATOR NULL))
   ...
   (CL:WHEN (CL:NOT (CL:EQ ITERATOR NULL))
    (CL:LOOP WHILE (NEXT? ITERATOR) DO
     (CL:WHEN (PARTIAL-ARGUMENTS-UNIFY-WITH-ARGUMENTS? (%VALUE ITERATOR) PROPOSITION)
   ...
   (CL:WHEN (CL:NOT (CL:EQ RESULT KWD-PARTIAL-MATCH-FAILURE))
    (CL:LET*
     ((TRUTHVALUE (PROPOSITIONS-ITERATOR-TRUTH-VALUE ITERATOR))
      (WEIGHT
       (%WRAPPER-VALUE
        (DYNAMIC-SLOT-VALUE (%DYNAMIC-SLOTS (%VALUE ITERATOR)) SYM-PARTIAL-MATCH-LOGIC-WEIGHT NULL-FLOAT-WRAPPER))))
     (CL:DECLARE (CL:TYPE CL:DOUBLE-FLOAT WEIGHT)) (CL:SETF (%TRUTH-VALUE FRAME) UNKNOWN-TRUTH-VALUE)
     (CL:WHEN (CL:= WEIGHT NULL-FLOAT) (CL:SETQ WEIGHT 1.0d0))
     (SET-FRAME-PARTIAL-TRUTH (%PARTIAL-MATCH-FRAME FRAME) UNKNOWN-TRUTH-VALUE
...
(CL:DEFUN HELP-STARTUP-PARTIAL-MATCH1 ()
  (CL:PROGN (CL:SETQ KWD-PARTIAL-MATCH-BASIC (INTERN-RIGID-SYMBOL-WRT-MODULE "BASIC" NULL 2))
   ...
   (CL:SETQ KWD-PARTIAL-MATCH-FUNCTION (INTERN-RIGID-SYMBOL-WRT-MODULE "FUNCTION" NULL 2))
   (CL:SETQ KWD-PARTIAL-MATCH-MAX (INTERN-RIGID-SYMBOL-WRT-MODULE "MAX" NULL 2))
   ...
   (CL:SETQ KWD-PARTIAL-MATCH-KIND (INTERN-RIGID-SYMBOL-WRT-MODULE "KIND" NULL 2))
   (CL:SETQ KWD-PARTIAL-MATCH-DOWN (INTERN-RIGID-SYMBOL-WRT-MODULE "DOWN" NULL 2))
   (CL:SETQ KWD-PARTIAL-MATCH-UP-TRUE (INTERN-RIGID-SYMBOL-WRT-MODULE "UP-TRUE" NULL 2))
   (CL:SETQ KWD-PARTIAL-MATCH-UP-FAIL (INTERN-RIGID-SYMBOL-WRT-MODULE "UP-FAIL" NULL 2))
   (CL:SETQ KWD-PARTIAL-MATCH-TRUE (INTERN-RIGID-SYMBOL-WRT-MODULE "TRUE" NULL 2))
   ...
   (CL:SETQ SYM-PARTIAL-MATCH-STELLA-ARITY
    (INTERN-RIGID-SYMBOL-WRT-MODULE "ARITY" (GET-STELLA-MODULE "/STELLA" CL:T) 0))
...
(CL:DEFUN HELP-STARTUP-PARTIAL-MATCH2 ()
  (CL:PROGN (CL:SETQ KWD-PARTIAL-MATCH-MINIMUM-SCORE (INTERN-RIGID-SYMBOL-WRT-MODULE "MINIMUM-SCORE" NULL 2))
   ...
   (CL:SETQ SGT-PARTIAL-MATCH-PL-KERNEL-KB-NULL
    (INTERN-RIGID-SYMBOL-WRT-MODULE "NULL" (GET-STELLA-MODULE "/PL-KERNEL-KB" CL:T) 1))
...
(CL:DEFUN HELP-STARTUP-PARTIAL-MATCH3 ()
  (CL:PROGN
   (DEFINE-FUNCTION-OBJECT "SET-PARTIAL-MATCH-MODE"
    "(DEFUN SET-PARTIAL-MATCH-MODE ((K KEYWORD)) :COMMAND? TRUE :PUBLIC? TRUE)" (CL:FUNCTION %SET-PARTIAL-MATCH-MODE)
    NULL)
   (DEFINE-FUNCTION-OBJECT "SET-RULE-COMBINATION" "(DEFUN SET-RULE-COMBINATION ((K KEYWORD)) :COMMAND? TRUE)"
   ...
   (DEFINE-FUNCTION-OBJECT "SET-MAXIMUM-SCORE-CUTOFF"
    "(DEFUN SET-MAXIMUM-SCORE-CUTOFF ((C FLOAT)) :COMMAND? TRUE :PUBLIC? TRUE)" (CL:FUNCTION %SET-MAXIMUM-SCORE-CUTOFF)
    (CL:FUNCTION SET-MAXIMUM-SCORE-CUTOFF-EVALUATOR-WRAPPER))
   (DEFINE-FUNCTION-OBJECT "SET-MINIMUM-SCORE-CUTOFF"
    "(DEFUN SET-MINIMUM-SCORE-CUTOFF ((C FLOAT)) :COMMAND? TRUE :PUBLIC? TRUE)" (CL:FUNCTION %SET-MINIMUM-SCORE-CUTOFF)
   ...
   (DEFINE-METHOD-OBJECT "(DEFMETHOD (COMPUTE-DYNAMIC-CUTOFF PARTIAL-MATCH-SCORE) ((SELF PARTIAL-MATCH-FRAME)))"
    (CL:FUNCTION COMPUTE-DYNAMIC-CUTOFF) NULL)
   (DEFINE-METHOD-OBJECT "(DEFMETHOD SET-DYNAMIC-CUTOFF ((SELF PARTIAL-MATCH-FRAME)))" (CL:FUNCTION SET-DYNAMIC-CUTOFF)
    NULL)
   (DEFINE-METHOD-OBJECT "(DEFMETHOD (CUTOFF-PARTIAL-MATCH? BOOLEAN) ((SELF PARTIAL-MATCH-FRAME) (TRACE? BOOLEAN)))"
   ...
   (DEFINE-METHOD-OBJECT "(DEFMETHOD CLEAR-FRAME-PARTIAL-TRUTH ((SELF PARTIAL-MATCH-FRAME)))"
   ...
   (DEFINE-METHOD-OBJECT "(DEFMETHOD SET-CACHE-PARTIAL-TRUTH ((SELF CONTROL-FRAME) (CACHE ATOMIC-GOAL-CACHE)))"
    (CL:FUNCTION SET-CACHE-PARTIAL-TRUTH) NULL)
   (DEFINE-METHOD-OBJECT "(DEFMETHOD SET-CACHE-PARTIAL-TRUTH ((SELF PARTIAL-MATCH-FRAME) (CACHE ATOMIC-GOAL-CACHE)))"
    (CL:FUNCTION SET-CACHE-PARTIAL-TRUTH) NULL)
   (DEFINE-METHOD-OBJECT
   ...
   (DEFINE-METHOD-OBJECT
    ...
    (CL:FUNCTION SET-JUSTIFICATION-PARTIAL-TRUTH) NULL)
   (DEFINE-METHOD-OBJECT "(DEFMETHOD (ALLOW-UNBOUND-VARIABLES? BOOLEAN) ((SELF PARTIAL-MATCH-FRAME)))"
    (CL:FUNCTION ALLOW-UNBOUND-VARIABLES?) NULL)
   (DEFINE-METHOD-OBJECT "(DEFMETHOD (COMPUTE-AND-SCORE PARTIAL-MATCH-SCORE) ((SELF PARTIAL-MATCH-FRAME)))"
   ...
   (DEFINE-METHOD-OBJECT "(DEFMETHOD (COMPUTE-OR-SCORE PARTIAL-MATCH-SCORE) ((SELF PARTIAL-MATCH-FRAME)))"
   ...
   (DEFINE-METHOD-OBJECT "(DEFMETHOD (COMPUTE-NOT-SCORE PARTIAL-MATCH-SCORE) ((SELF PARTIAL-MATCH-FRAME)))"
   ...
   (DEFINE-METHOD-OBJECT "(DEFMETHOD (COMPUTE-GOAL-SCORE PARTIAL-MATCH-SCORE) ((SELF PARTIAL-MATCH-FRAME)))"
   ...
   (DEFINE-METHOD-OBJECT "(DEFMETHOD POP-PARTIAL-MATCH-SCORE ((SELF PARTIAL-MATCH-FRAME)))"
    (CL:FUNCTION POP-PARTIAL-MATCH-SCORE) NULL)
   (DEFINE-METHOD-OBJECT "(DEFMETHOD (EARLY-PARTIAL-MATCH-AND-FAILURE? BOOLEAN) ((SELF PARTIAL-MATCH-FRAME)))"
    (CL:FUNCTION EARLY-PARTIAL-MATCH-AND-FAILURE?) NULL)
   (DEFINE-METHOD-OBJECT "(DEFMETHOD (EARLY-PARTIAL-MATCH-OR-SUCCESS? BOOLEAN) ((SELF PARTIAL-MATCH-FRAME)))"
   ...
   (DEFINE-METHOD-OBJECT
    ...
    (CL:FUNCTION CREATE-PARTIAL-MATCH-FRAME) NULL)
   (DEFINE-METHOD-OBJECT "(DEFMETHOD (COMPUTE-DYNAMIC-CUTOFF PARTIAL-MATCH-SCORE) ((SELF INCREMENTAL-PARTIAL-MATCH)))"
    (CL:FUNCTION COMPUTE-DYNAMIC-CUTOFF) NULL)
   (DEFINE-METHOD-OBJECT "(DEFMETHOD CLEAR-FRAME-PARTIAL-TRUTH ((SELF INCREMENTAL-PARTIAL-MATCH)))"
    (CL:FUNCTION CLEAR-FRAME-PARTIAL-TRUTH) NULL)
   (DEFINE-METHOD-OBJECT
   ...
   (DEFINE-METHOD-OBJECT "(DEFMETHOD POP-AND-PARTIAL-MATCH-SCORE ((SELF INCREMENTAL-PARTIAL-MATCH)))"
    (CL:FUNCTION POP-AND-PARTIAL-MATCH-SCORE) NULL)
   (DEFINE-METHOD-OBJECT "(DEFMETHOD (COMPUTE-AND-SCORE PARTIAL-MATCH-SCORE) ((SELF INCREMENTAL-PARTIAL-MATCH)))"
    (CL:FUNCTION COMPUTE-AND-SCORE) NULL)
   (DEFINE-METHOD-OBJECT
   ...
   (DEFINE-METHOD-OBJECT "(DEFMETHOD POP-OR-PARTIAL-MATCH-SCORE ((SELF INCREMENTAL-PARTIAL-MATCH)))"
    (CL:FUNCTION POP-OR-PARTIAL-MATCH-SCORE) NULL)
   (DEFINE-METHOD-OBJECT "(DEFMETHOD (COMPUTE-OR-SCORE PARTIAL-MATCH-SCORE) ((SELF INCREMENTAL-PARTIAL-MATCH)))"
    (CL:FUNCTION COMPUTE-OR-SCORE) NULL)
   (DEFINE-METHOD-OBJECT
    "(DEFMETHOD (CONTINUE-PARTIAL-OR-PROOF KEYWORD) ((SELF INCREMENTAL-PARTIAL-MATCH) (LASTMOVE KEYWORD)))"
    (CL:FUNCTION CONTINUE-PARTIAL-OR-PROOF) NULL)
   (DEFINE-METHOD-OBJECT "(DEFMETHOD (COMPUTE-NOT-SCORE PARTIAL-MATCH-SCORE) ((SELF INCREMENTAL-PARTIAL-MATCH)))"
    (CL:FUNCTION COMPUTE-NOT-SCORE) NULL)
   (DEFINE-METHOD-OBJECT
    "(DEFMETHOD (CONTINUE-PARTIAL-NOT-PROOF KEYWORD) ((SELF INCREMENTAL-PARTIAL-MATCH) (LASTMOVE KEYWORD)))"
    (CL:FUNCTION CONTINUE-PARTIAL-NOT-PROOF) NULL)
   (DEFINE-METHOD-OBJECT "(DEFMETHOD (COMPUTE-GOAL-SCORE PARTIAL-MATCH-SCORE) ((SELF INCREMENTAL-PARTIAL-MATCH)))"
    (CL:FUNCTION COMPUTE-GOAL-SCORE) NULL)
   (DEFINE-METHOD-OBJECT
   ...
   (DEFINE-METHOD-OBJECT
    ...
    (CL:FUNCTION CONTINUE-PARTIAL-FAIL-PROOF) NULL)
   (DEFINE-METHOD-OBJECT "(DEFMETHOD INITIALIZE-NN-PARTIAL-MATCH ((SELF NN-PARTIAL-MATCH)))"
   ...
   (DEFINE-METHOD-OBJECT
    ...
    (CL:FUNCTION CREATE-PARTIAL-MATCH-FRAME) NULL)
   (DEFINE-METHOD-OBJECT "(DEFMETHOD (COMPUTE-DYNAMIC-CUTOFF PARTIAL-MATCH-SCORE) ((SELF NN-PARTIAL-MATCH)))"
    (CL:FUNCTION COMPUTE-DYNAMIC-CUTOFF) NULL)))

(CL:DEFUN HELP-STARTUP-PARTIAL-MATCH4 ()
  (CL:PROGN
   (DEFINE-METHOD-OBJECT "(DEFMETHOD (PROPOSITION-WEIGHT FLOAT) ((SELF NN-PARTIAL-MATCH) (PROPOSITION PROPOSITION)))"
    (CL:FUNCTION PROPOSITION-WEIGHT) NULL)
   (DEFINE-METHOD-OBJECT
    "(DEFMETHOD SET-BASE-PARTIAL-MATCH-TRUTH ((SELF NN-PARTIAL-MATCH) (PROP PROPOSITION) (TRUTH KEYWORD)))"
    (CL:FUNCTION SET-BASE-PARTIAL-MATCH-TRUTH) NULL)
   (DEFINE-METHOD-OBJECT "(DEFMETHOD SET-CACHE-PARTIAL-TRUTH ((SELF NN-PARTIAL-MATCH) (CACHE ATOMIC-GOAL-CACHE)))"
    (CL:FUNCTION SET-CACHE-PARTIAL-TRUTH) NULL)
   (DEFINE-METHOD-OBJECT
   ...
   (DEFINE-METHOD-OBJECT
    ...
    (CL:FUNCTION RECORD-PARTIAL-MATCH-SCORE) NULL)
   (DEFINE-METHOD-OBJECT "(DEFMETHOD POP-PARTIAL-MATCH-SCORE ((SELF NN-PARTIAL-MATCH)))"
    (CL:FUNCTION POP-PARTIAL-MATCH-SCORE) NULL)
   (DEFINE-METHOD-OBJECT "(DEFMETHOD (COMPUTE-AND-SCORE PARTIAL-MATCH-SCORE) ((SELF NN-PARTIAL-MATCH)))"
    (CL:FUNCTION COMPUTE-AND-SCORE) NULL)
   (DEFINE-METHOD-OBJECT "(DEFMETHOD (COMPUTE-OR-SCORE PARTIAL-MATCH-SCORE) ((SELF NN-PARTIAL-MATCH)))"
    (CL:FUNCTION COMPUTE-OR-SCORE) NULL)
   (DEFINE-METHOD-OBJECT "(DEFMETHOD (COMPUTE-NOT-SCORE PARTIAL-MATCH-SCORE) ((SELF NN-PARTIAL-MATCH)))"
    (CL:FUNCTION COMPUTE-NOT-SCORE) NULL)
   (DEFINE-METHOD-OBJECT "(DEFMETHOD (COMPUTE-GOAL-SCORE PARTIAL-MATCH-SCORE) ((SELF NN-PARTIAL-MATCH)))"
    (CL:FUNCTION COMPUTE-GOAL-SCORE) NULL)
   (DEFINE-FUNCTION-OBJECT "PROBABILISTIC-SUM-N" "(DEFUN (PROBABILISTIC-SUM-N FLOAT) ((FORM (CONS OF FLOAT-WRAPPER))))"
    (CL:FUNCTION PROBABILISTIC-SUM-N) NULL)
   (DEFINE-FUNCTION-OBJECT "PROBABILISTIC-SUM" "(DEFUN (PROBABILISTIC-SUM FLOAT) ((X FLOAT) (Y FLOAT)))"
    (CL:FUNCTION PROBABILISTIC-SUM) NULL)
   (DEFINE-METHOD-OBJECT "(DEFMETHOD (EARLY-PARTIAL-MATCH-AND-FAILURE? BOOLEAN) ((SELF NN-PARTIAL-MATCH)))"
    (CL:FUNCTION EARLY-PARTIAL-MATCH-AND-FAILURE?) NULL)
   (DEFINE-METHOD-OBJECT "(DEFMETHOD (EARLY-PARTIAL-MATCH-OR-SUCCESS? BOOLEAN) ((SELF NN-PARTIAL-MATCH)))"
    (CL:FUNCTION EARLY-PARTIAL-MATCH-OR-SUCCESS?) NULL)
   (DEFINE-FUNCTION-OBJECT "PRUNE-NN-SEARCH?" "(DEFUN (PRUNE-NN-SEARCH? BOOLEAN) ((SELF NN-PARTIAL-MATCH)))"
   ...
   (DEFINE-FUNCTION-OBJECT "INITIALIZE-PARTIAL-QUERY" "(DEFUN INITIALIZE-PARTIAL-QUERY ((QUERY QUERY-ITERATOR)))"
   ...
   (DEFINE-FUNCTION-OBJECT "GET-UNBOUND-VARIABLES" "(DEFUN (GET-UNBOUND-VARIABLES CONS) ((PROP PROPOSITION)))"
    (CL:FUNCTION GET-UNBOUND-VARIABLES) NULL)
   (DEFINE-FUNCTION-OBJECT "ALL-VARIABLES-UNBOUND?" "(DEFUN (ALL-VARIABLES-UNBOUND? BOOLEAN) ((PROP PROPOSITION)))"
    (CL:FUNCTION ALL-VARIABLES-UNBOUND?) NULL)
   (DEFINE-FUNCTION-OBJECT "UNBOUND-VARIABLES-IN-FRAME?"
    "(DEFUN (UNBOUND-VARIABLES-IN-FRAME? BOOLEAN) ((FRAME CONTROL-FRAME)))" (CL:FUNCTION UNBOUND-VARIABLES-IN-FRAME?)
    NULL)
   (DEFINE-FUNCTION-OBJECT "RECORD-LATEST-PARTIAL-MATCH-SCORE"
    "(DEFUN RECORD-LATEST-PARTIAL-MATCH-SCORE ((FRAME CONTROL-FRAME)))" (CL:FUNCTION RECORD-LATEST-PARTIAL-MATCH-SCORE)
    NULL)
   ...
   (DEFINE-FUNCTION-OBJECT "COMPUTE-PARTIAL-MATCH-SCORE?"
    "(DEFUN (COMPUTE-PARTIAL-MATCH-SCORE? BOOLEAN) ((FRAME CONTROL-FRAME)))" (CL:FUNCTION COMPUTE-PARTIAL-MATCH-SCORE?)
    NULL)
...
bindings.  To only get maximal scores use `:MAXIMIZE-SCORE? TRUE' (this is not
yet implemented - you can use `ask-partial' to maximize scores for individual
solutions by hand).\" :PUBLIC? TRUE :COMMAND? TRUE :EVALUATE-ARGUMENTS? FALSE)" (CL:FUNCTION %RETRIEVE-PARTIAL)
...
illegal queries and logical expressions.\" :PUBLIC? TRUE)" (CL:FUNCTION CALL-RETRIEVE-PARTIAL) NULL)
   ...
   (DEFINE-METHOD-OBJECT
    ...
    (CL:FUNCTION RETRIEVE-PARTIAL-SOLUTIONS) NULL)
   (DEFINE-FUNCTION-OBJECT "SORT-SOLUTIONS-BY-SCORE" "(DEFUN SORT-SOLUTIONS-BY-SCORE ((QUERY QUERY-ITERATOR)))"
...
for the supplied proposition instead of a truth value.  If the option
:MAXIMIZE-SCORE? is set to FALSE, return after the first partial match score
has been generated.\" :PUBLIC? TRUE :COMMAND? TRUE :EVALUATE-ARGUMENTS? FALSE)" (CL:FUNCTION %ASK-PARTIAL)
    (CL:FUNCTION ASK-PARTIAL-EVALUATOR-WRAPPER))
   (DEFINE-FUNCTION-OBJECT "RETURN-PARTIAL-TRUTH"
    "(DEFUN (RETURN-PARTIAL-TRUTH FLOAT) ((QUERY QUERY-ITERATOR) (TOP? BOOLEAN)))" (CL:FUNCTION RETURN-PARTIAL-TRUTH)
    NULL)
   (DEFINE-FUNCTION-OBJECT "CALL-ASK-PARTIAL" "(DEFUN (CALL-ASK-PARTIAL FLOAT) ((QUERY OBJECT)))"
   ...
   (DEFINE-METHOD-OBJECT
    ...
    (CL:FUNCTION COMPUTE-PARTIAL-TRUTH) NULL)
   (DEFINE-METHOD-OBJECT "(DEFMETHOD (COMPUTE-PARTIAL-TRUTH FLOAT) ((SELF NN-PARTIAL-MATCH) (QUERY QUERY-ITERATOR)))"
    (CL:FUNCTION COMPUTE-PARTIAL-TRUTH) NULL)
   (DEFINE-FUNCTION-OBJECT "NULL-INSTANCE?" "(DEFUN (NULL-INSTANCE? BOOLEAN) ((X OBJECT)))"
    (CL:FUNCTION NULL-INSTANCE?) NULL)
   (DEFINE-FUNCTION-OBJECT "GET-NULL-INSTANCE" "(DEFUN (GET-NULL-INSTANCE LOGIC-OBJECT) ())"
    (CL:FUNCTION GET-NULL-INSTANCE) NULL)
   (DEFINE-FUNCTION-OBJECT "NULL-INSTANCE-PROPOSITIONS-EXIST?" "(DEFUN (NULL-INSTANCE-PROPOSITIONS-EXIST? BOOLEAN) ())"
   ...
   (DEFINE-FUNCTION-OBJECT "STARTUP-PARTIAL-MATCH" "(DEFUN STARTUP-PARTIAL-MATCH () :PUBLIC? TRUE)"
    (CL:FUNCTION STARTUP-PARTIAL-MATCH) NULL)
   (CL:LET* ((FUNCTION (LOOKUP-FUNCTION SYM-PARTIAL-MATCH-LOGIC-STARTUP-PARTIAL-MATCH)))
    (SET-DYNAMIC-SLOT-VALUE (%DYNAMIC-SLOTS FUNCTION) SYM-PARTIAL-MATCH-STELLA-METHOD-STARTUP-CLASSNAME
...
(CL:DEFUN STARTUP-PARTIAL-MATCH ()
  (CL:LET* ((*MODULE* (GET-STELLA-MODULE "/LOGIC" (> *STARTUP-TIME-PHASE* 1))) (*CONTEXT* *MODULE*))
   ...
   (CL:WHEN (CURRENT-STARTUP-TIME-PHASE? 4) (CL:SETQ *PARTIAL-MATCH-MODE* KWD-PARTIAL-MATCH-BASIC)
    (CL:SETQ *RULE-COMBINATION* KWD-PARTIAL-MATCH-MAX) (CL:SETQ *PLANABLE-PREDICATES* NIL))
...
user-defined partial match implementations.\" :ABSTRACT? TRUE :SLOTS ((KIND :TYPE KEYWORD :REQUIRED? TRUE) (CONTROL-FRAME :TYPE CONTROL-FRAME :REQUIRED? TRUE) (PARENT :TYPE PARTIAL-MATCH-FRAME) (CHILD :TYPE PARTIAL-MATCH-FRAME) (POSITIVE-SCORE :TYPE PARTIAL-MATCH-SCORE :INITIALLY NULL) (NEGATIVE-SCORE :TYPE PARTIAL-MATCH-SCORE :INITIALLY NULL) (DYNAMIC-CUTOFF :TYPE FLOAT) (ARGUMENT-SCORES :TYPE (CONS OF FLOAT-WRAPPER) :INITIALLY NIL) (ARGUMENT-WEIGHTS :TYPE (CONS OF FLOAT-WRAPPER) :INITIALLY NIL) (UNBOUND-VARS :TYPE CONS :INITIALLY NIL) (SUCCESS? :TYPE BOOLEAN :INITIALLY FALSE)))")))
   ...
   (CL:WHEN (CURRENT-STARTUP-TIME-PHASE? 7) (HELP-STARTUP-PARTIAL-MATCH3) (HELP-STARTUP-PARTIAL-MATCH4))
   ...
   (CL:WHEN (CURRENT-STARTUP-TIME-PHASE? 9) (%IN-MODULE (COPY-CONS-TREE (WRAP-STRING "LOGIC")))
    ...
    (REGISTER-NATIVE-NAME SYM-PARTIAL-MATCH-LOGIC-SET-PARTIAL-MATCH-MODE KWD-PARTIAL-MATCH-COMMON-LISP
     KWD-PARTIAL-MATCH-FUNCTION)
...
to 1.0 during partial match operations.\")")
    (REGISTER-NATIVE-NAME SYM-PARTIAL-MATCH-LOGIC-SET-RULE-COMBINATION KWD-PARTIAL-MATCH-COMMON-LISP
     KWD-PARTIAL-MATCH-FUNCTION)
    (REGISTER-NATIVE-NAME SYM-PARTIAL-MATCH-LOGIC-SET-GREEDY-NETWORK-PRUNING KWD-PARTIAL-MATCH-COMMON-LISP
     KWD-PARTIAL-MATCH-FUNCTION)
    (REGISTER-NATIVE-NAME SYM-PARTIAL-MATCH-LOGIC-SET-MAXIMUM-SCORE-CUTOFF KWD-PARTIAL-MATCH-COMMON-LISP
     KWD-PARTIAL-MATCH-FUNCTION)
    (REGISTER-NATIVE-NAME SYM-PARTIAL-MATCH-LOGIC-SET-MINIMUM-SCORE-CUTOFF KWD-PARTIAL-MATCH-COMMON-LISP
     KWD-PARTIAL-MATCH-FUNCTION)
    (DEFINE-STELLA-GLOBAL-VARIABLE-FROM-STRINGIFIED-SOURCE "(DEFGLOBAL *AND-MISSED-A-BINDING* BOOLEAN FALSE)")
    (REGISTER-NATIVE-NAME SYM-PARTIAL-MATCH-LOGIC-RETRIEVE-PARTIAL KWD-PARTIAL-MATCH-COMMON-LISP
     KWD-PARTIAL-MATCH-FUNCTION)
