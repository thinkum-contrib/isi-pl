...
(CL:DECLAIM
 (CL:SPECIAL *STARTUP-TIME-PHASE* *MODULE* NIL *REVERSEPOLARITY?* UNKNOWN-TRUTH-VALUE TRUE-TRUTH-VALUE
  FALSE-TRUTH-VALUE *CONTEXT* TRUE-WRAPPER FALSE-WRAPPER NULL-INTEGER NULL-FLOAT))
    ...
    ((SUBTYPE-OF-FLOAT? TEST-VALUE-002)
     (CL:PROGN
      (CL:LET* ((TEST-VALUE-001 (SAFE-PRIMARY-TYPE Y)))
       (CL:COND
        ((SUBTYPE-OF-INTEGER? TEST-VALUE-001) (CL:PROGN (CL:= (%WRAPPER-VALUE X) (CL:FLOAT (%WRAPPER-VALUE Y) 0.0d0))))
   ...
   (CL:COND
    ...
    ((SUBTYPE-OF-FLOAT? TEST-VALUE-002)
     (CL:PROGN
      (CL:LET* ((TEST-VALUE-001 (SAFE-PRIMARY-TYPE Y)))
       (CL:COND
        ((SUBTYPE-OF-INTEGER? TEST-VALUE-001) (CL:PROGN (< (%WRAPPER-VALUE X) (CL:FLOAT (%WRAPPER-VALUE Y) 0.0d0))))
         ...
         ((SUBTYPE-OF-INTEGER? TEST-VALUE-000)
          (CL:PROGN
           (CL:RETURN-FROM |/PL-KERNEL-KB/PLUS-COMPUTATION|
            (WRAP-INTEGER (CL:TRUNCATE (CL:+ (%WRAPPER-VALUE X) (%WRAPPER-VALUE Y)))))))
         ((SUBTYPE-OF-FLOAT? TEST-VALUE-000)
          (CL:PROGN (CL:SETQ FLOATRESULT (CL:+ (%WRAPPER-VALUE X) (%WRAPPER-VALUE Y)))))
         (CL:T
          (CL:LET* ((STREAM-000 (NEW-OUTPUT-STRING-STREAM)))
           (%%PRINT-STREAM (%NATIVE-STREAM STREAM-000) "`" TEST-VALUE-000 "' is not a valid case option")
           (CL:ERROR (NEW-STELLA-EXCEPTION (THE-STRING-READER STREAM-000)))))))))
         ...
         (CL:COND
          ((SUBTYPE-OF-INTEGER? TEST-VALUE-000)
           (CL:PROGN
            (CL:IF
             (CL:=
              (CL:THE CL:FIXNUM (CL:REM (CL:THE CL:FIXNUM (%WRAPPER-VALUE X)) (CL:THE CL:FIXNUM (%WRAPPER-VALUE Y))))
              0)
             (CL:RETURN-FROM |/PL-KERNEL-KB/DIVIDE-COMPUTATION|
              (WRAP-INTEGER
               (CL:LET ((X (%WRAPPER-VALUE X)) (Y (%WRAPPER-VALUE Y))) (CL:DECLARE (CL:TYPE CL:FIXNUM X Y))
...
(CL:DEFUN |/PL-KERNEL-KB/SQRT-COMPUTATION| (X)
  (CL:LET* ((FLOATRESULT NULL-FLOAT) (INTEGERRESULT NULL-INTEGER))
   (CL:DECLARE (CL:TYPE CL:DOUBLE-FLOAT FLOATRESULT) (CL:TYPE CL:FIXNUM INTEGERRESULT))
   (CL:LET* ((TEST-VALUE-000 (SAFE-PRIMARY-TYPE X)))
    (CL:COND
     ((SUBTYPE-OF-INTEGER? TEST-VALUE-000)
      (CL:PROGN
       (CL:SETQ FLOATRESULT
        (CL:THE CL:DOUBLE-FLOAT (CL:SQRT (CL:THE CL:DOUBLE-FLOAT (CL:FLOAT (%WRAPPER-VALUE X) 0.0d0)))))
       (CL:SETQ INTEGERRESULT (CL:TRUNCATE FLOATRESULT))
       (CL:IF (CL:= FLOATRESULT (CL:FLOAT INTEGERRESULT 0.0d0))
        (CL:RETURN-FROM |/PL-KERNEL-KB/SQRT-COMPUTATION| (WRAP-INTEGER INTEGERRESULT))
        (CL:RETURN-FROM |/PL-KERNEL-KB/SQRT-COMPUTATION| (WRAP-FLOAT FLOATRESULT)))))
     ((SUBTYPE-OF-FLOAT? TEST-VALUE-000)
      (CL:PROGN (CL:SETQ FLOATRESULT (CL:THE CL:DOUBLE-FLOAT (CL:SQRT (CL:THE CL:DOUBLE-FLOAT (%WRAPPER-VALUE X)))))))
     (CL:T
      (CL:LET* ((STREAM-000 (NEW-OUTPUT-STRING-STREAM)))
       (%%PRINT-STREAM (%NATIVE-STREAM STREAM-000) "`" TEST-VALUE-000 "' is not a valid case option")
       (CL:ERROR (NEW-STELLA-EXCEPTION (THE-STRING-READER STREAM-000)))))))
...
(CL:DEFUN |/PL-KERNEL-KB/ABS-COMPUTATION| (X)
  (CL:LET* ((TEST-VALUE-000 (SAFE-PRIMARY-TYPE X)))
   (CL:COND
    ((SUBTYPE-OF-INTEGER? TEST-VALUE-000)
     (CL:PROGN (CL:IF (CL:< (UNWRAP-INTEGER X) 0) (WRAP-INTEGER (CL:- 0 (UNWRAP-INTEGER X))) X)))
    ((SUBTYPE-OF-FLOAT? TEST-VALUE-000)
     (CL:PROGN (CL:IF (CL:< (UNWRAP-FLOAT X) 0.0d0) (WRAP-FLOAT (CL:- 0.0d0 (UNWRAP-FLOAT X))) X)))
    (CL:T
     (CL:LET* ((STREAM-000 (NEW-OUTPUT-STRING-STREAM)))
      (%%PRINT-STREAM (%NATIVE-STREAM STREAM-000) "`" TEST-VALUE-000 "' is not a valid case option")
      (CL:ERROR (NEW-STELLA-EXCEPTION (THE-STRING-READER STREAM-000))))))))
...
(CL:DEFUN |/PL-KERNEL-KB/PLUS-CONSTRAINT| (MISSING-ARGUMENT X1 X2 X3)
  (CL:LET* ((VALUE NULL))
   (CL:CASE (%WRAPPER-VALUE MISSING-ARGUMENT)
    (-1
     (CL:SETQ VALUE
      (CL:IF (|/PL-KERNEL-KB/ARITHMETIC-EQUAL-TEST| (|/PL-KERNEL-KB/PLUS-COMPUTATION| X1 X2) X3) TRUE-WRAPPER
       FALSE-WRAPPER)))
...
(CL:DEFUN |/PL-KERNEL-KB/MINUS-CONSTRAINT| (MISSING-ARGUMENT X1 X2 X3)
  (CL:LET* ((VALUE NULL))
   (CL:CASE (%WRAPPER-VALUE MISSING-ARGUMENT)
    (-1
     (CL:SETQ VALUE
      (CL:IF (|/PL-KERNEL-KB/ARITHMETIC-EQUAL-TEST| (|/PL-KERNEL-KB/MINUS-COMPUTATION| X1 X2) X3) TRUE-WRAPPER
       FALSE-WRAPPER)))
...
(CL:DEFUN |/PL-KERNEL-KB/TIMES-CONSTRAINT| (MISSING-ARGUMENT X1 X2 X3)
  (CL:LET* ((VALUE NULL))
   (CL:CASE (%WRAPPER-VALUE MISSING-ARGUMENT)
    (-1
     (CL:SETQ VALUE
      (CL:IF (|/PL-KERNEL-KB/ARITHMETIC-EQUAL-TEST| (|/PL-KERNEL-KB/TIMES-COMPUTATION| X1 X2) X3) TRUE-WRAPPER
       FALSE-WRAPPER)))
    ...
    (-1
     (CL:LET* ((RATIO (|/PL-KERNEL-KB/DIVIDE-COMPUTATION| X1 X2)))
      (CL:IF (CL:NOT (CL:EQ RATIO NULL))
       (CL:SETQ VALUE (CL:IF (|/PL-KERNEL-KB/ARITHMETIC-EQUAL-TEST| RATIO X3) TRUE-WRAPPER FALSE-WRAPPER))
...
(CL:DEFUN |/PL-KERNEL-KB/NEGATE-CONSTRAINT| (MISSING-ARGUMENT X1 X2)
  (CL:LET* ((VALUE NULL))
   (CL:CASE (%WRAPPER-VALUE MISSING-ARGUMENT)
    (-1
     (CL:SETQ VALUE
      (CL:IF (|/PL-KERNEL-KB/ARITHMETIC-EQUAL-TEST| X1 (|/PL-KERNEL-KB/NEGATE-COMPUTATION| X2)) TRUE-WRAPPER
       FALSE-WRAPPER)))
    (0 (CL:SETQ VALUE (|/PL-KERNEL-KB/NEGATE-COMPUTATION| X2)))
    (1 (CL:SETQ VALUE (|/PL-KERNEL-KB/NEGATE-COMPUTATION| X1))) (CL:OTHERWISE))
   VALUE))
...
(CL:DEFUN |/PL-KERNEL-KB/SQRT-CONSTRAINT| (MISSING-ARGUMENT X1 X2)
  (CL:LET* ((VALUE NULL))
   (CL:CASE (%WRAPPER-VALUE MISSING-ARGUMENT)
    (-1
     (CL:SETQ VALUE
      (CL:IF (|/PL-KERNEL-KB/ARITHMETIC-EQUAL-TEST| (|/PL-KERNEL-KB/TIMES-COMPUTATION| X2 X2) X1) TRUE-WRAPPER
       FALSE-WRAPPER)))
    (0 (CL:SETQ VALUE (|/PL-KERNEL-KB/TIMES-COMPUTATION| X2 X2)))
    (1
     (CL:IF (|/PL-KERNEL-KB/ARITHMETIC-LESS-TEST| X1 (WRAP-INTEGER 0)) (CL:SETQ VALUE NULL)
    ...
    ((SUBTYPE-OF-FLOAT? TEST-VALUE-000)
     (CL:PROGN
      (CL:IF (CL:> (%WRAPPER-VALUE X) 0)
       (WRAP-FLOAT (CL:THE CL:DOUBLE-FLOAT (CL:LOG (CL:THE CL:DOUBLE-FLOAT (%WRAPPER-VALUE X))))) NULL)))
    ((SUBTYPE-OF-INTEGER? TEST-VALUE-000)
     (CL:PROGN
      (CL:IF (CL:> (%WRAPPER-VALUE X) 0)
       (WRAP-FLOAT (CL:THE CL:DOUBLE-FLOAT (CL:LOG (CL:THE CL:DOUBLE-FLOAT (NUMBER-WRAPPER-TO-FLOAT X))))) NULL)))
   ...
   (CL:COND
    ((SUBTYPE-OF-FLOAT? TEST-VALUE-000)
     (CL:PROGN
      (CL:IF (CL:> (%WRAPPER-VALUE X) 0)
       (WRAP-FLOAT
        (CL:LET ((N (%WRAPPER-VALUE X))) (CL:DECLARE (CL:TYPE CL:DOUBLE-FLOAT N))
    ...
    ((SUBTYPE-OF-INTEGER? TEST-VALUE-000)
     (CL:PROGN
      (CL:IF (CL:> (%WRAPPER-VALUE X) 0)
       (WRAP-FLOAT
        (CL:LET ((N (NUMBER-WRAPPER-TO-FLOAT X))) (CL:DECLARE (CL:TYPE CL:DOUBLE-FLOAT N))
         (CL:THE CL:DOUBLE-FLOAT (CL:LOG n 10.0d0))))
       NULL)))
    ((SUBTYPE-OF-LONG-INTEGER? TEST-VALUE-000)
     (CL:PROGN
...
(CL:DEFUN |/PL-KERNEL-KB/EXP-COMPUTATION| (X)
  (CL:LET* ((TEST-VALUE-000 (SAFE-PRIMARY-TYPE X)))
   (CL:COND
    ((SUBTYPE-OF-FLOAT? TEST-VALUE-000)
     (CL:PROGN (WRAP-FLOAT (CL:THE CL:DOUBLE-FLOAT (CL:EXP (CL:THE CL:DOUBLE-FLOAT (%WRAPPER-VALUE X)))))))
    ((SUBTYPE-OF-INTEGER? TEST-VALUE-000)
     (CL:PROGN (WRAP-FLOAT (CL:THE CL:DOUBLE-FLOAT (CL:EXP (CL:THE CL:DOUBLE-FLOAT (NUMBER-WRAPPER-TO-FLOAT X)))))))
    ((SUBTYPE-OF-LONG-INTEGER? TEST-VALUE-000)
     (CL:PROGN (WRAP-FLOAT (CL:THE CL:DOUBLE-FLOAT (CL:EXP (CL:THE CL:DOUBLE-FLOAT (NUMBER-WRAPPER-TO-FLOAT X)))))))
    (CL:T
     (CL:LET* ((STREAM-000 (NEW-OUTPUT-STRING-STREAM)))
     ...
     (CL:PROGN
      (WRAP-FLOAT
       (CL:THE CL:DOUBLE-FLOAT
        (CL:EXPT (CL:THE CL:DOUBLE-FLOAT (%WRAPPER-VALUE X)) (CL:THE CL:DOUBLE-FLOAT (COERCE-TO-FLOAT N)))))))
    ((SUBTYPE-OF-INTEGER? TEST-VALUE-000)
     (CL:PROGN
      (WRAP-FLOAT
       (CL:THE CL:DOUBLE-FLOAT
        (CL:EXPT (CL:THE CL:DOUBLE-FLOAT (NUMBER-WRAPPER-TO-FLOAT X)) (CL:THE CL:DOUBLE-FLOAT (COERCE-TO-FLOAT N)))))))
    ((SUBTYPE-OF-LONG-INTEGER? TEST-VALUE-000)
     (CL:PROGN
      (WRAP-FLOAT
       (CL:THE CL:DOUBLE-FLOAT
...
(CL:DEFUN |/PL-KERNEL-KB/LOG-CONSTRAINT| (MISSING-ARGUMENT X LOG)
  (CL:LET* ((VALUE NULL))
   (CL:CASE (%WRAPPER-VALUE MISSING-ARGUMENT)
    ...
    (0 (CL:SETQ VALUE (|/PL-KERNEL-KB/EXP-COMPUTATION| LOG))) (1 (CL:SETQ VALUE (|/PL-KERNEL-KB/LOG-COMPUTATION| X)))
    (CL:OTHERWISE))
   VALUE))
    ...
    (-1
     (CL:SETQ VALUE
      (CL:IF
       ...
       TRUE-WRAPPER FALSE-WRAPPER)))
    (0 (CL:SETQ VALUE (|/PL-KERNEL-KB/EXPT-COMPUTATION| (WRAP-FLOAT 10.0d0) LOG)))
    (1 (CL:SETQ VALUE (|/PL-KERNEL-KB/LOG10-COMPUTATION| X))) (CL:OTHERWISE))
   VALUE))
    ...
    (-1
     (CL:SETQ VALUE
      (CL:IF
       ...
       TRUE-WRAPPER FALSE-WRAPPER)))
    (0 (CL:SETQ VALUE (|/PL-KERNEL-KB/LOG-COMPUTATION| Y))) (1 (CL:SETQ VALUE (|/PL-KERNEL-KB/EXP-COMPUTATION| X)))
    (CL:OTHERWISE))
   VALUE))
...
(CL:DEFCLASS |/PL-KERNEL-KB/INTEGER-INTERVAL| (THING)
  ((|/PL-KERNEL-KB/INTERVAL-LOWER-BOUND| :TYPE CL:FIXNUM :INITFORM NULL-INTEGER :ALLOCATION :INSTANCE :ACCESSOR
    |/PL-KERNEL-KB/%INTERVAL-LOWER-BOUND|)
   (|/PL-KERNEL-KB/INTERVAL-UPPER-BOUND| :TYPE CL:FIXNUM :INITFORM NULL-INTEGER :ALLOCATION :INSTANCE :ACCESSOR
    |/PL-KERNEL-KB/%INTERVAL-UPPER-BOUND|))
  (:DOCUMENTATION "An interval of integers"))

(CL:DEFUN |/PL-KERNEL-KB/NEW-INTEGER-INTERVAL| ()
  (CL:LET* ((SELF NULL)) (CL:SETQ SELF (CL:MAKE-INSTANCE (CL:QUOTE |/PL-KERNEL-KB/INTEGER-INTERVAL|)))
...
(CL:DEFUN |/PL-KERNEL-KB/NEW-INTERVAL-CACHE| ()
  (CL:LET* ((SELF NULL)) (CL:SETQ SELF (CL:MAKE-INSTANCE (CL:QUOTE |/PL-KERNEL-KB/INTERVAL-CACHE|)))
   (CL:SETF (%DYNAMIC-SLOTS SELF) (NEW-KEY-VALUE-LIST)) (CL:SETF (%SURROGATE-VALUE-INVERSE SELF) NULL)
   (CL:SETF (%STRICT-UPPER-BOUND? SELF) CL:NIL) (CL:SETF (%STRICT-LOWER-BOUND? SELF) CL:NIL)
   (CL:SETF (%UPPER-BOUND SELF) NULL) (CL:SETF (%LOWER-BOUND SELF) NULL) (CL:SETF (%INTERVAL-MEMBER SELF) NULL)
...
(CL:DEFUN |/PL-KERNEL-KB/ACCESS-INTERVAL-CACHE-SLOT-VALUE| (SELF SLOTNAME VALUE SETVALUE?)
  (CL:COND
   ...
   ((CL:EQ SLOTNAME |/PL-KERNEL-KB/SYM-ARITHMETIC-STELLA-LOWER-BOUND|)
    (CL:IF SETVALUE? (CL:SETF (%LOWER-BOUND SELF) VALUE) (CL:SETQ VALUE (%LOWER-BOUND SELF))))
   ((CL:EQ SLOTNAME |/PL-KERNEL-KB/SYM-ARITHMETIC-STELLA-UPPER-BOUND|)
    (CL:IF SETVALUE? (CL:SETF (%UPPER-BOUND SELF) VALUE) (CL:SETQ VALUE (%UPPER-BOUND SELF))))
...
(CL:DEFMETHOD PRINT-OBJECT ((SELF |/PL-KERNEL-KB/INTERVAL-CACHE|) STREAM)
  (CL:PROGN (%%PRINT-STREAM STREAM "|cache-of: " (%INTERVAL-MEMBER SELF) " ")
   (|/PL-KERNEL-KB/PRINT-INTERVAL| STREAM (%LOWER-BOUND SELF) (%STRICT-LOWER-BOUND? SELF) (%UPPER-BOUND SELF)
...
(CL:DEFUN |/PL-KERNEL-KB/CREATE-INTERVAL-CACHE| (INTERVALMEMBER)
  (CL:LET* ((INTERVALCACHE (|/PL-KERNEL-KB/NEW-INTERVAL-CACHE|)))
   (CL:SETF (%INTERVAL-MEMBER INTERVALCACHE) INTERVALMEMBER) (CL:SETF (%HOME-CONTEXT INTERVALCACHE) *CONTEXT*)
   (ASSERT-BINARY-VALUE |/PL-KERNEL-KB/SGT-ARITHMETIC-PL-KERNEL-KB-INTERVAL-CACHE-OF| INTERVALMEMBER INTERVALCACHE)
   INTERVALCACHE))
   ...
   (CL:COND
    ((CL:AND (CL:NOT (CL:EQ INTERVALCACHE NULL)) (CL:NOT (SKOLEM? INTERVALCACHE)))
     (CL:LET* ((THISCACHE INTERVALCACHE) (COPYCACHE NULL) (PROPOSITION NULL))
      ...
      (CL:LET* ((SELF-000 (|/PL-KERNEL-KB/NEW-INTERVAL-CACHE|))) (CL:SETF (%HOME-CONTEXT SELF-000) *CONTEXT*)
       (CL:SETF (%INTERVAL-MEMBER SELF-000) SELF) (CL:SETF (%LOWER-BOUND SELF-000) (%LOWER-BOUND THISCACHE))
       (CL:SETF (%UPPER-BOUND SELF-000) (%UPPER-BOUND THISCACHE))
       (CL:SETF (%STRICT-LOWER-BOUND? SELF-000) (%STRICT-LOWER-BOUND? THISCACHE))
       (CL:SETF (%STRICT-UPPER-BOUND? SELF-000) (%STRICT-UPPER-BOUND? THISCACHE)) (CL:SETQ COPYCACHE SELF-000))
      (CL:LET* ((VALUE-000 NULL))
       (CL:LET*
        ((P NULL)
         (ITER-000
          (ALLOCATE-ITERATOR
           (UNFILTERED-DEPENDENT-PROPOSITIONS SELF |/PL-KERNEL-KB/SGT-ARITHMETIC-PL-KERNEL-KB-INTERVAL-CACHE-OF|))))
        (CL:LOOP WHILE (NEXT? ITER-000) DO (CL:SETQ P (%VALUE ITER-000))
         (CL:WHEN (CL:EQ (%OPERATOR P) |/PL-KERNEL-KB/SGT-ARITHMETIC-PL-KERNEL-KB-INTERVAL-CACHE-OF|)
...
")))
   (CL:LET* ((MESSAGE MESSAGE-000) (CLASH (NEW-INTERVAL-CLASH MESSAGE)))
    (CL:DECLARE (CL:TYPE CL:SIMPLE-STRING MESSAGE)) (CL:SETF (%CONTEXT CLASH) *CONTEXT*)
    (CL:SETF (%INTERVAL-MEMBER CLASH) (%INTERVAL-MEMBER INTERVAL))
    (CL:SETF (%LOWER-BOUND CLASH) (%LOWER-BOUND INTERVAL)) (CL:SETF (%UPPER-BOUND CLASH) (%UPPER-BOUND INTERVAL))
    (CL:SETF (%STRICT-LOWER-BOUND? CLASH) (%STRICT-LOWER-BOUND? INTERVAL))
...
(CL:DEFUN |/PL-KERNEL-KB/EVALUATE-ADJACENT-INEQUALITIES| (SELF)
  (CL:LET*
   ((DEP NULL)
    (ITER-000 (ALL-SPECIALIZING-DEPENDENT-PROPOSITIONS SELF |/PL-KERNEL-KB/SGT-ARITHMETIC-PL-KERNEL-KB-INEQUALITY|)))
   (CL:LOOP WHILE (NEXT? ITER-000) DO (CL:SETQ DEP (%VALUE ITER-000))
    (CL:LET* ((ALWAYS?-000 CL:T))
     (CL:LET* ((ARG NULL) (VECTOR-000 (%ARGUMENTS DEP)) (INDEX-000 0) (LENGTH-000 (LENGTH VECTOR-000)))
      (CL:DECLARE (CL:TYPE CL:FIXNUM INDEX-000 LENGTH-000))
      (CL:LOOP WHILE (CL:< INDEX-000 LENGTH-000) DO
       (CL:SETQ ARG (CL:AREF (CL:THE CL:SIMPLE-VECTOR (%THE-ARRAY VECTOR-000)) INDEX-000))
       (CL:WHEN
        (CL:NOT (CL:OR (ISA? (VALUE-OF ARG) |/PL-KERNEL-KB/SGT-ARITHMETIC-LOGIC-LOGIC-OBJECT|) (CL:NOT (TRUE? DEP))))
...
(CL:DEFMETHOD |/PL-KERNEL-KB/INTEGER-VALUED-MEMBER?| ((INTERVAL |/PL-KERNEL-KB/INTERVAL-CACHE|))
  (CL:LET* ((MEMBER (%INTERVAL-MEMBER INTERVAL)))
   (CL:AND (ISA? MEMBER |/PL-KERNEL-KB/SGT-ARITHMETIC-LOGIC-SKOLEM|)
    (SUBTYPE-OF? (%SKOLEM-TYPE MEMBER) |/PL-KERNEL-KB/SGT-ARITHMETIC-STELLA-INTEGER|))))
      ...
      ((SUBTYPE-OF-INTEGER? TEST-VALUE-000)
       (CL:PROGN
        (CL:IF (%STRICT-LOWER-BOUND? INTERVAL)
         (CL:RETURN-FROM |/PL-KERNEL-KB/INTEGER-LOWER-BOUND| (WRAP-INTEGER (CL:1+ (UNWRAP-INTEGER LB))))
         (CL:RETURN-FROM |/PL-KERNEL-KB/INTEGER-LOWER-BOUND| LB))))
      ((SUBTYPE-OF-FLOAT? TEST-VALUE-000)
       (CL:PROGN
        (CL:IF (%STRICT-LOWER-BOUND? INTERVAL)
         (CL:IF (INTEGER-VALUED? (UNWRAP-FLOAT LB))
          (CL:RETURN-FROM |/PL-KERNEL-KB/INTEGER-LOWER-BOUND| (WRAP-INTEGER (CL:1+ (FLOOR (UNWRAP-FLOAT LB)))))
      ...
      ((SUBTYPE-OF-INTEGER? TEST-VALUE-000)
       (CL:PROGN
        (CL:IF (%STRICT-UPPER-BOUND? INTERVAL)
         (CL:RETURN-FROM |/PL-KERNEL-KB/INTEGER-UPPER-BOUND| (WRAP-INTEGER (CL:1- (UNWRAP-INTEGER UB))))
         (CL:RETURN-FROM |/PL-KERNEL-KB/INTEGER-UPPER-BOUND| UB))))
      ((SUBTYPE-OF-FLOAT? TEST-VALUE-000)
       (CL:PROGN
        (CL:IF (%STRICT-UPPER-BOUND? INTERVAL)
         (CL:IF (INTEGER-VALUED? (UNWRAP-FLOAT UB))
          (CL:RETURN-FROM |/PL-KERNEL-KB/INTEGER-UPPER-BOUND| (WRAP-INTEGER (CL:1- (FLOOR (UNWRAP-FLOAT UB)))))
...
(CL:DEFMETHOD |/PL-KERNEL-KB/EVALUATE-TIGHTER-INTEGER-INTERVAL| ((INTERVAL |/PL-KERNEL-KB/INTERVAL-CACHE|))
  (CL:LET* ((LB (|/PL-KERNEL-KB/INTEGER-LOWER-BOUND| INTERVAL)) (UB (|/PL-KERNEL-KB/INTEGER-UPPER-BOUND| INTERVAL)))
   (CL:WHEN (CL:AND (CL:NOT (CL:EQ LB NULL)) (CL:NOT (CL:EQ UB NULL)) (EQL? LB UB))
...
(CL:DEFMETHOD |/PL-KERNEL-KB/EVALUATE-TIGHTER-INTERVAL| ((INTERVAL |/PL-KERNEL-KB/INTERVAL-CACHE|))
  (CL:WHEN (CL:AND (CL:NOT (CL:EQ (%LOWER-BOUND INTERVAL) NULL)) (CL:NOT (CL:EQ (%UPPER-BOUND INTERVAL) NULL)))
   (CL:IF (EQL? (%LOWER-BOUND INTERVAL) (%UPPER-BOUND INTERVAL))
    (CL:IF (CL:OR (%STRICT-LOWER-BOUND? INTERVAL) (%STRICT-UPPER-BOUND? INTERVAL))
     (|/PL-KERNEL-KB/SIGNAL-INTERVAL-CLASH| INTERVAL)
     (EQUATE-VALUES NULL (%INTERVAL-MEMBER INTERVAL) (%LOWER-BOUND INTERVAL)))
    (CL:HANDLER-CASE
     (CL:PROGN
      (CL:WHEN
       (|/PL-KERNEL-KB/COMPARE-INTERVAL-BOUNDS?| |/PL-KERNEL-KB/SGT-ARITHMETIC-PL-KERNEL-KB->| (%LOWER-BOUND INTERVAL)
...
(CL:DEFMETHOD |/PL-KERNEL-KB/PROPAGATE-INEQUALITY-TO-INTERVAL-CACHE| ((SELF |/PL-KERNEL-KB/INTERVAL-CACHE|) VALUE OPERATOR)
  ...
  (CL:WHEN
   (CL:NOT
    (CL:OR (ISA? VALUE |/PL-KERNEL-KB/SGT-ARITHMETIC-STELLA-NUMBER-WRAPPER|)
     (ISA? VALUE |/PL-KERNEL-KB/SGT-ARITHMETIC-LOGIC-QUANTITY-LOGIC-WRAPPER|)))
   (CL:RETURN-FROM |/PL-KERNEL-KB/PROPAGATE-INEQUALITY-TO-INTERVAL-CACHE|))
     ...
     ((CL:EQ OPERATOR |/PL-KERNEL-KB/SGT-ARITHMETIC-PL-KERNEL-KB->|)
      (CL:WHEN
       (CL:OR (CL:EQ (%LOWER-BOUND SELF) NULL)
        (|/PL-KERNEL-KB/COMPARE-INTERVAL-BOUNDS?| |/PL-KERNEL-KB/SGT-ARITHMETIC-PL-KERNEL-KB->| VALUE
         (%LOWER-BOUND SELF))
     ...
     ((CL:EQ OPERATOR |/PL-KERNEL-KB/SGT-ARITHMETIC-PL-KERNEL-KB->=|)
      (CL:WHEN
       (CL:OR (CL:EQ (%LOWER-BOUND SELF) NULL)
        (|/PL-KERNEL-KB/COMPARE-INTERVAL-BOUNDS?| |/PL-KERNEL-KB/SGT-ARITHMETIC-PL-KERNEL-KB->| VALUE
         (%LOWER-BOUND SELF)))
       (CL:SETF (%LOWER-BOUND SELF) VALUE) (CL:SETF (%STRICT-LOWER-BOUND? SELF) CL:NIL)
     ...
     ((CL:EQ OPERATOR |/PL-KERNEL-KB/SGT-ARITHMETIC-PL-KERNEL-KB-=<|)
      (CL:WHEN
       (CL:OR (CL:EQ (%UPPER-BOUND SELF) NULL)
        (|/PL-KERNEL-KB/COMPARE-INTERVAL-BOUNDS?| |/PL-KERNEL-KB/SGT-ARITHMETIC-PL-KERNEL-KB-<| VALUE
         (%UPPER-BOUND SELF)))
       (CL:SETF (%UPPER-BOUND SELF) VALUE) (CL:SETF (%STRICT-UPPER-BOUND? SELF) CL:NIL)
       (CL:SETQ TIGHTERINTERVAL? CL:T)))
     (CL:T
      (CL:LET* ((STREAM-000 (NEW-OUTPUT-STRING-STREAM)))
  ...
  (CL:COND
   ((CL:OR (CL:EQ OPERATOR |/PL-KERNEL-KB/SGT-ARITHMETIC-PL-KERNEL-KB->|)
    ...
    (|/PL-KERNEL-KB/PROPAGATE-INEQUALITY-TO-INTERVAL-CACHE| CACHE1
     (|/PL-KERNEL-KB/ACCESS-INTERVAL-CACHE-BOUNDS| CACHE2 |/PL-KERNEL-KB/KWD-ARITHMETIC-LOWER-BOUND|) OPERATOR)
    (|/PL-KERNEL-KB/PROPAGATE-INEQUALITY-TO-INTERVAL-CACHE| CACHE2
     (|/PL-KERNEL-KB/ACCESS-INTERVAL-CACHE-BOUNDS| CACHE1 |/PL-KERNEL-KB/KWD-ARITHMETIC-UPPER-BOUND|)
     (|/PL-KERNEL-KB/INVERSE-INEQUALITY-OPERATOR| OPERATOR)))
   ((CL:OR (CL:EQ OPERATOR |/PL-KERNEL-KB/SGT-ARITHMETIC-PL-KERNEL-KB-<|)
     (CL:EQ OPERATOR |/PL-KERNEL-KB/SGT-ARITHMETIC-PL-KERNEL-KB-=<|))
    (|/PL-KERNEL-KB/PROPAGATE-INEQUALITY-TO-INTERVAL-CACHE| CACHE1
     (|/PL-KERNEL-KB/ACCESS-INTERVAL-CACHE-BOUNDS| CACHE2 |/PL-KERNEL-KB/KWD-ARITHMETIC-UPPER-BOUND|) OPERATOR)
    (|/PL-KERNEL-KB/PROPAGATE-INEQUALITY-TO-INTERVAL-CACHE| CACHE2
     (|/PL-KERNEL-KB/ACCESS-INTERVAL-CACHE-BOUNDS| CACHE1 |/PL-KERNEL-KB/KWD-ARITHMETIC-LOWER-BOUND|)
     (|/PL-KERNEL-KB/INVERSE-INEQUALITY-OPERATOR| OPERATOR)))
   (CL:T
    (CL:LET* ((STREAM-000 (NEW-OUTPUT-STRING-STREAM)))
     (%%PRINT-STREAM (%NATIVE-STREAM STREAM-000) "`" OPERATOR "' is not a valid case option")
...
(CL:DEFUN |/PL-KERNEL-KB/ACCESS-INTERVAL-BOUNDS| (X LOWERORUPPER)
  (CL:LET* ((TEST-VALUE-000 (SAFE-PRIMARY-TYPE X)))
   (CL:COND
    ((SUBTYPE-OF? TEST-VALUE-000 |/PL-KERNEL-KB/SGT-ARITHMETIC-STELLA-NUMBER-WRAPPER|) (CL:PROGN (CL:VALUES X CL:NIL)))
    ...
    (CL:T
     (|/PL-KERNEL-KB/ACCESS-INTERVAL-CACHE-BOUNDS|
      (ACCESS-BINARY-VALUE X |/PL-KERNEL-KB/SGT-ARITHMETIC-PL-KERNEL-KB-INTERVAL-CACHE-OF|) LOWERORUPPER)))))
  ...
  (CL:IF (CL:EQ INTERVALCACHE NULL) (CL:VALUES NULL CL:NIL)
   (CL:COND
    ((CL:EQ LOWERORUPPER |/PL-KERNEL-KB/KWD-ARITHMETIC-LOWER-BOUND|)
     (CL:VALUES (%LOWER-BOUND INTERVALCACHE) (%STRICT-LOWER-BOUND? INTERVALCACHE)))
    ((CL:EQ LOWERORUPPER |/PL-KERNEL-KB/KWD-ARITHMETIC-UPPER-BOUND|)
     (CL:VALUES (%UPPER-BOUND INTERVALCACHE) (%STRICT-UPPER-BOUND? INTERVALCACHE)))
    (CL:T
     (CL:LET* ((STREAM-000 (NEW-OUTPUT-STRING-STREAM)))
...
(CL:DEFUN |/PL-KERNEL-KB/COMPARE-INTERVAL-BOUNDS?| (RELATION X Y)
  (CL:WHEN (CL:OR (|/PL-KERNEL-KB/NULL-LITERAL-WRAPPER?| X) (|/PL-KERNEL-KB/NULL-LITERAL-WRAPPER?| Y))
   (CL:RETURN-FROM |/PL-KERNEL-KB/COMPARE-INTERVAL-BOUNDS?| CL:NIL))
  (CL:WHEN (CL:EQ RELATION |/PL-KERNEL-KB/SGT-ARITHMETIC-PL-KERNEL-KB-=|)
      ...
      (CL:LET* ((TEST-VALUE-000 (SAFE-PRIMARY-TYPE Y)))
       (CL:COND
        ((SUBTYPE-OF? TEST-VALUE-000 |/PL-KERNEL-KB/SGT-ARITHMETIC-STELLA-NUMBER-WRAPPER|)
         (CL:PROGN
          (CL:LET* ((FLOAT-X (NUMBER-WRAPPER-TO-FLOAT X)) (FLOAT-Y (NUMBER-WRAPPER-TO-FLOAT Y)))
        ...
        ((SUBTYPE-OF? TEST-VALUE-000 |/PL-KERNEL-KB/SGT-ARITHMETIC-LOGIC-QUANTITY-LOGIC-WRAPPER|)
         (CL:PROGN
          (CL:LET* ((QUANTITY-Y (%WRAPPER-VALUE Y)) (QUANTITY-X (COERCE-TO QUANTITY-Y X)))
           (CL:COND
            ((CL:EQ RELATION |/PL-KERNEL-KB/SGT-ARITHMETIC-PL-KERNEL-KB-=<|) (LESS-EQUAL? QUANTITY-X QUANTITY-Y))
            ...
            (CL:T
             (CL:LET* ((STREAM-001 (NEW-OUTPUT-STRING-STREAM)))
              (%%PRINT-STREAM (%NATIVE-STREAM STREAM-001) "`" RELATION "' is not a valid case option")
              (CL:ERROR (NEW-STELLA-EXCEPTION (THE-STRING-READER STREAM-001)))))))))
        (CL:T
         (CL:LET* ((STREAM-002 (NEW-OUTPUT-STRING-STREAM)))
           ...
           (CL:COND
            ...
            (CL:T
             (CL:LET* ((STREAM-003 (NEW-OUTPUT-STRING-STREAM)))
              (%%PRINT-STREAM (%NATIVE-STREAM STREAM-003) "`" RELATION "' is not a valid case option")
          ...
          (CL:COND
           ...
           (CL:T
            (CL:LET* ((STREAM-004 (NEW-OUTPUT-STRING-STREAM)))
             (%%PRINT-STREAM (%NATIVE-STREAM STREAM-004) "`" RELATION "' is not a valid case option")
             (CL:ERROR (NEW-STELLA-EXCEPTION (THE-STRING-READER STREAM-004))))))))
        (CL:T
         (CL:LET* ((STREAM-005 (NEW-OUTPUT-STRING-STREAM)))
          (%%PRINT-STREAM (%NATIVE-STREAM STREAM-005) "`" TEST-VALUE-001 "' is not a valid case option")
          (CL:ERROR (NEW-STELLA-EXCEPTION (THE-STRING-READER STREAM-005)))))))))
    (CL:T
     (CL:LET* ((STREAM-006 (NEW-OUTPUT-STRING-STREAM)))
      (%%PRINT-STREAM (%NATIVE-STREAM STREAM-006) "`" TEST-VALUE-002 "' is not a valid case option")
...
(CL:DEFUN |/PL-KERNEL-KB/SATISFIES-INTERVAL-BOUNDS?| (OBJECT VALUE)
  (CL:LET* ((LB NULL) (STRICTLOWER? CL:NIL) (UB NULL) (STRICTUPPER? CL:NIL) (ANSWER CL:T))
   (CL:MULTIPLE-VALUE-SETQ (LB STRICTLOWER?)
    (|/PL-KERNEL-KB/ACCESS-INTERVAL-BOUNDS| OBJECT |/PL-KERNEL-KB/KWD-ARITHMETIC-LOWER-BOUND|))
   (CL:MULTIPLE-VALUE-SETQ (UB STRICTUPPER?)
    (|/PL-KERNEL-KB/ACCESS-INTERVAL-BOUNDS| OBJECT |/PL-KERNEL-KB/KWD-ARITHMETIC-UPPER-BOUND|))
   (CL:WHEN (|/PL-KERNEL-KB/NULL-LITERAL-WRAPPER?| VALUE)
   ...
   (CL:WHEN (CL:NOT (|/PL-KERNEL-KB/NULL-LITERAL-WRAPPER?| LB))
    (CL:IF STRICTLOWER?
     ...
     (CL:SETQ ANSWER
      (|/PL-KERNEL-KB/COMPARE-INTERVAL-BOUNDS?| |/PL-KERNEL-KB/SGT-ARITHMETIC-PL-KERNEL-KB-=<| LB VALUE))))
   (CL:WHEN (CL:NOT (|/PL-KERNEL-KB/NULL-LITERAL-WRAPPER?| UB))
    (CL:IF STRICTUPPER?
     (CL:SETQ ANSWER
      (CL:AND ANSWER
       (|/PL-KERNEL-KB/COMPARE-INTERVAL-BOUNDS?| |/PL-KERNEL-KB/SGT-ARITHMETIC-PL-KERNEL-KB-<| VALUE UB)))
     (CL:SETQ ANSWER
      (CL:AND ANSWER
       (|/PL-KERNEL-KB/COMPARE-INTERVAL-BOUNDS?| |/PL-KERNEL-KB/SGT-ARITHMETIC-PL-KERNEL-KB-=<| VALUE UB)))))
   ANSWER))
...
(CL:DEFUN |/PL-KERNEL-KB/LESS-SPECIALIST-HELPER| (FRAME RELATION XARG YARG)
  (CL:LET*
   ((X (ARGUMENT-BOUND-TO XARG)) (Y (ARGUMENT-BOUND-TO YARG)) (XBOUND NULL) (STRICTX? CL:NIL) (YBOUND NULL)
    (STRICTY? CL:NIL) (SUCCESS? CL:NIL))
   (CL:WHEN (CL:EQ Y NULL)
    ...
    (CL:MULTIPLE-VALUE-SETQ (XBOUND STRICTX?)
     (|/PL-KERNEL-KB/ACCESS-INTERVAL-BOUNDS| X |/PL-KERNEL-KB/KWD-ARITHMETIC-UPPER-BOUND|))
    (CL:WHEN
     (CL:AND (CL:NOT (|/PL-KERNEL-KB/NULL-LITERAL-WRAPPER?| XBOUND))
      (CL:OR (CL:EQ RELATION |/PL-KERNEL-KB/SGT-ARITHMETIC-PL-KERNEL-KB-=<|)
       (ISA? XBOUND |/PL-KERNEL-KB/SGT-ARITHMETIC-STELLA-INTEGER-WRAPPER|)))
     (CL:WHEN (CL:EQ RELATION |/PL-KERNEL-KB/SGT-ARITHMETIC-PL-KERNEL-KB-<|)
   ...
   (CL:WHEN (CL:EQ X NULL)
    (CL:MULTIPLE-VALUE-SETQ (YBOUND STRICTY?)
     (|/PL-KERNEL-KB/ACCESS-INTERVAL-BOUNDS| Y |/PL-KERNEL-KB/KWD-ARITHMETIC-LOWER-BOUND|))
    (CL:WHEN
     (CL:AND (CL:NOT (|/PL-KERNEL-KB/NULL-NUMBER?| YBOUND))
      (CL:OR (CL:EQ RELATION |/PL-KERNEL-KB/SGT-ARITHMETIC-PL-KERNEL-KB-=<|)
       (ISA? YBOUND |/PL-KERNEL-KB/SGT-ARITHMETIC-STELLA-INTEGER-WRAPPER|)))
     (CL:WHEN (CL:EQ RELATION |/PL-KERNEL-KB/SGT-ARITHMETIC-PL-KERNEL-KB-<|)
   ...
   (CL:LET* ((SUCCESS? CL:NIL))
      ...
      ((CL:EQ RELATION |/PL-KERNEL-KB/SGT-ARITHMETIC-PL-KERNEL-KB-<|)
       (CL:SETQ SUCCESS?
        (CL:OR
         ...
         (|/PL-KERNEL-KB/COMPARE-INTERVAL-BOUNDS?| |/PL-KERNEL-KB/SGT-ARITHMETIC-PL-KERNEL-KB-<| XBOUND YBOUND))))
      ((CL:EQ RELATION |/PL-KERNEL-KB/SGT-ARITHMETIC-PL-KERNEL-KB-=<|)
       (CL:SETQ SUCCESS? (|/PL-KERNEL-KB/COMPARE-INTERVAL-BOUNDS?| RELATION XBOUND YBOUND)))
      (CL:T
       (CL:LET* ((STREAM-000 (NEW-OUTPUT-STRING-STREAM)))
        (%%PRINT-STREAM (%NATIVE-STREAM STREAM-000) "`" RELATION "' is not a valid case option")
        (CL:ERROR (NEW-STELLA-EXCEPTION (THE-STRING-READER STREAM-000))))))
    ...
    (CL:MULTIPLE-VALUE-SETQ (XBOUND STRICTX?)
     (|/PL-KERNEL-KB/ACCESS-INTERVAL-BOUNDS| X |/PL-KERNEL-KB/KWD-ARITHMETIC-LOWER-BOUND|))
    (CL:MULTIPLE-VALUE-SETQ (YBOUND STRICTY?)
     (|/PL-KERNEL-KB/ACCESS-INTERVAL-BOUNDS| Y |/PL-KERNEL-KB/KWD-ARITHMETIC-UPPER-BOUND|))
    (CL:HANDLER-CASE
     (CL:COND
      ((CL:EQ RELATION |/PL-KERNEL-KB/SGT-ARITHMETIC-PL-KERNEL-KB-=<|)
       (CL:SETQ SUCCESS?
    ...
    (CL:WHEN SUCCESS? (SET-FRAME-TRUTH-VALUE FRAME FALSE-TRUTH-VALUE)
     (CL:RETURN-FROM |/PL-KERNEL-KB/LESS-SPECIALIST-HELPER| |/PL-KERNEL-KB/KWD-ARITHMETIC-TERMINAL-FAILURE|)))
   (CL:IF (CL:AND (SKOLEM? X) (SKOLEM? Y)) |/PL-KERNEL-KB/KWD-ARITHMETIC-FAILURE|
     ...
     (CL:COND
      ((CL:EQ RELATION |/PL-KERNEL-KB/SGT-ARITHMETIC-PL-KERNEL-KB-<|)
       (|/PL-KERNEL-KB/LESS-SPECIALIST-HELPER| FRAME |/PL-KERNEL-KB/SGT-ARITHMETIC-PL-KERNEL-KB-=<|
        ...
        (CL:AREF (CL:THE CL:SIMPLE-VECTOR (%THE-ARRAY (%ARGUMENTS PROPOSITION))) 0)))
      ((CL:EQ RELATION |/PL-KERNEL-KB/SGT-ARITHMETIC-PL-KERNEL-KB-=<|)
       (|/PL-KERNEL-KB/LESS-SPECIALIST-HELPER| FRAME |/PL-KERNEL-KB/SGT-ARITHMETIC-PL-KERNEL-KB-<|
        (CL:AREF (CL:THE CL:SIMPLE-VECTOR (%THE-ARRAY (%ARGUMENTS PROPOSITION))) 1)
        (CL:AREF (CL:THE CL:SIMPLE-VECTOR (%THE-ARRAY (%ARGUMENTS PROPOSITION))) 0)))
...
(CL:DEFUN |/PL-KERNEL-KB/INEQUALITY-EVALUATOR| (SELF)
  ...
  (CL:LET*
   ((ARG1 (CL:AREF (CL:THE CL:SIMPLE-VECTOR (%THE-ARRAY (%ARGUMENTS SELF))) 0))
    (ARG2 (CL:AREF (CL:THE CL:SIMPLE-VECTOR (%THE-ARRAY (%ARGUMENTS SELF))) 1)) (VALUE1 (VALUE-OF ARG1))
    (VALUE2 (VALUE-OF ARG2)) (SKOLEM1? (ISA? VALUE1 |/PL-KERNEL-KB/SGT-ARITHMETIC-LOGIC-LOGIC-OBJECT|))
   ...
   (CL:WHEN (EQL? VALUE1 VALUE2)
    (CL:COND
     ((CL:NOT (EQL? ARG1 VALUE1))
      (CL:COND
       ((CL:NOT (EQL? ARG2 VALUE2))
        (|/PL-KERNEL-KB/UNIFY-INTERVAL-CACHES| (|/PL-KERNEL-KB/GET-INTERVAL-CACHE| ARG1)
         (|/PL-KERNEL-KB/GET-INTERVAL-CACHE| ARG2) |/PL-KERNEL-KB/SGT-ARITHMETIC-PL-KERNEL-KB-=<|)
        (|/PL-KERNEL-KB/UNIFY-INTERVAL-CACHES| (|/PL-KERNEL-KB/GET-INTERVAL-CACHE| ARG1)
         (|/PL-KERNEL-KB/GET-INTERVAL-CACHE| ARG2) |/PL-KERNEL-KB/SGT-ARITHMETIC-PL-KERNEL-KB->=|)
        (CL:SETQ VALUE2 ARG2) (CL:SETQ SKOLEM2? CL:T))
       (CL:T
        (|/PL-KERNEL-KB/PROPAGATE-INEQUALITY-TO-INTERVAL-CACHE| (|/PL-KERNEL-KB/GET-INTERVAL-CACHE| ARG1) VALUE2
     ...
     ((CL:NOT (EQL? ARG2 VALUE2))
      (CL:COND
       ((CL:NOT (EQL? ARG1 VALUE1))
        (|/PL-KERNEL-KB/UNIFY-INTERVAL-CACHES| (|/PL-KERNEL-KB/GET-INTERVAL-CACHE| ARG2)
         (|/PL-KERNEL-KB/GET-INTERVAL-CACHE| ARG1) |/PL-KERNEL-KB/SGT-ARITHMETIC-PL-KERNEL-KB-=<|)
        (|/PL-KERNEL-KB/UNIFY-INTERVAL-CACHES| (|/PL-KERNEL-KB/GET-INTERVAL-CACHE| ARG2)
         (|/PL-KERNEL-KB/GET-INTERVAL-CACHE| ARG1) |/PL-KERNEL-KB/SGT-ARITHMETIC-PL-KERNEL-KB->=|)
        (CL:SETQ VALUE1 ARG1) (CL:SETQ SKOLEM1? CL:T))
       (CL:T
        (|/PL-KERNEL-KB/PROPAGATE-INEQUALITY-TO-INTERVAL-CACHE| (|/PL-KERNEL-KB/GET-INTERVAL-CACHE| ARG2) VALUE1
         |/PL-KERNEL-KB/SGT-ARITHMETIC-PL-KERNEL-KB-=<|)
        (|/PL-KERNEL-KB/PROPAGATE-INEQUALITY-TO-INTERVAL-CACHE| (|/PL-KERNEL-KB/GET-INTERVAL-CACHE| ARG2) VALUE1
         |/PL-KERNEL-KB/SGT-ARITHMETIC-PL-KERNEL-KB->=|)))
      (CL:SETQ VALUE2 ARG2) (CL:SETQ SKOLEM2? CL:T))))
   (CL:IF SKOLEM1?
    (CL:IF SKOLEM2?
     (|/PL-KERNEL-KB/UNIFY-INTERVAL-CACHES| (|/PL-KERNEL-KB/GET-INTERVAL-CACHE| VALUE1)
      (|/PL-KERNEL-KB/GET-INTERVAL-CACHE| VALUE2) OPERATOR)
     (|/PL-KERNEL-KB/PROPAGATE-INEQUALITY-TO-INTERVAL-CACHE| (|/PL-KERNEL-KB/GET-INTERVAL-CACHE| VALUE1) VALUE2
      OPERATOR))
    (CL:IF SKOLEM2?
     (|/PL-KERNEL-KB/PROPAGATE-INEQUALITY-TO-INTERVAL-CACHE| (|/PL-KERNEL-KB/GET-INTERVAL-CACHE| VALUE2) VALUE1
      (|/PL-KERNEL-KB/INVERSE-INEQUALITY-OPERATOR| OPERATOR))
     (CL:COND
      ((|/PL-KERNEL-KB/COMPARE-INTERVAL-BOUNDS?| OPERATOR VALUE1 VALUE2) (ASSIGN-TRUTH-VALUE SELF TRUE-WRAPPER))
      ((TRUE? SELF) (SIGNAL-TRUTH-VALUE-CLASH SELF)) (CL:T (ASSIGN-TRUTH-VALUE SELF FALSE-WRAPPER)))))))
   ...
   (CL:LET* ((OUT (NEW-OUTPUT-STRING-STREAM))) (%%PRINT-STREAM (%NATIVE-STREAM OUT) (PLI::OBJECT-TO-STRING X))
    (CL:LET* ((ARG NULL) (ITER-000 YARGS))
     (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-000 NIL)) DO (CL:SETQ ARG (%%VALUE ITER-000))
      (%%PRINT-STREAM (%NATIVE-STREAM OUT) (PLI::OBJECT-TO-STRING ARG)) (CL:SETQ ITER-000 (%%REST ITER-000))))
...
(CL:DEFUN |/PL-KERNEL-KB/SUBSEQUENCE-SPECIALIST| (FRAME LASTMOVE)
  ...
  (CL:LET*
   ((ARGUMENTS (%ARGUMENTS (%PROPOSITION FRAME)))
    (SUPERARG (CL:AREF (CL:THE CL:SIMPLE-VECTOR (%THE-ARRAY ARGUMENTS)) 0))
    (P1ARG (CL:AREF (CL:THE CL:SIMPLE-VECTOR (%THE-ARRAY ARGUMENTS)) 1))
    (P2ARG (CL:AREF (CL:THE CL:SIMPLE-VECTOR (%THE-ARRAY ARGUMENTS)) 2))
   ...
   (CL:WHEN (CL:EQ ITERATOR NULL)
    (CL:LET*
     ((SUPERARGVALUE (ARGUMENT-BOUND-TO SUPERARG))
      (SUPER (CL:IF (STRING? SUPERARGVALUE) (UNWRAP-STRING SUPERARGVALUE) (PLI::OBJECT-TO-STRING SUPERARGVALUE)))
      (SUPERLENGTH NULL-INTEGER) (P1ARGVALUE (ARGUMENT-BOUND-TO P1ARG)) (P1 NULL-INTEGER)
      (P2ARGVALUE (ARGUMENT-BOUND-TO P2ARG)) (P2 NULL-INTEGER) (SUBARGVALUE (ARGUMENT-BOUND-TO SUBARG))
      (SUB (CL:IF (STRING? SUBARGVALUE) (UNWRAP-STRING SUBARGVALUE) (PLI::OBJECT-TO-STRING SUBARGVALUE)))
      ...
      ((CL:EQ SUB STELLA::NULL-STRING)
       (CL:IF (CL:AND (CL:NOT (CL:= P1 NULL-INTEGER)) (CL:NOT (CL:= P2 NULL-INTEGER)))
        (CL:RETURN-FROM |/PL-KERNEL-KB/SUBSEQUENCE-SPECIALIST|
         (SELECT-PROOF-RESULT (BIND-ARGUMENT-TO-VALUE? SUBARG (WRAP-STRING (SUBSEQUENCE SUPER P1 P2)) CL:T) CL:NIL
          CL:T))
        (CL:RETURN-FROM |/PL-KERNEL-KB/SUBSEQUENCE-SPECIALIST| |/PL-KERNEL-KB/KWD-ARITHMETIC-FAILURE|)))
      ((CL:= P1 NULL-INTEGER)
       (CL:IF (CL:= P2 NULL-INTEGER)
        (SET-DYNAMIC-SLOT-VALUE (%DYNAMIC-SLOTS FRAME) |/PL-KERNEL-KB/SYM-ARITHMETIC-STELLA-ITERATOR|
   ...
   (CL:IF
    (CL:AND (NEXT? ITERATOR) (BIND-ARGUMENT-TO-VALUE? P1ARG (%%VALUE (%VALUE ITERATOR)) CL:T)
     (BIND-ARGUMENT-TO-VALUE? P2ARG (%%VALUE (%%REST (%VALUE ITERATOR))) CL:T))
...
(CL:DECLAIM
 (CL:FTYPE (CL:FUNCTION (CL:T CL:T CL:T CL:T) (CL:VALUES CL:SIMPLE-STRING CL:FIXNUM CL:FIXNUM))
...
(CL:DEFUN |/PL-KERNEL-KB/NORMALIZE-STRING-COMPUTATION-ARGS| (X START END COERCE?)
  ...
  (CL:LET*
   ((THESTART (%WRAPPER-VALUE START)) (THEEND (%WRAPPER-VALUE END))
    (NAME (CL:IF (STRING? X) (%WRAPPER-VALUE X) (OBJECT-NAME-STRING X))) (NAMELENGTH 0))
   ...
   (CL:WHEN (CL:< THESTART 0) (CL:SETQ THESTART (CL:1+ (CL:+ NAMELENGTH THESTART))))
   (CL:WHEN (CL:< THESTART 0)
    (CL:RETURN-FROM |/PL-KERNEL-KB/NORMALIZE-STRING-COMPUTATION-ARGS|
     (CL:VALUES STELLA::NULL-STRING NULL-INTEGER NULL-INTEGER)))
   (CL:WHEN (CL:< THEEND 0) (CL:SETQ THEEND (CL:1+ (CL:+ NAMELENGTH THEEND))))
   (CL:IF (CL:OR (CL:< THEEND 0) (CL:> THEEND NAMELENGTH)) (CL:VALUES STELLA::NULL-STRING NULL-INTEGER NULL-INTEGER)
...
(CL:DEFUN |/PL-KERNEL-KB/STRING-MATCH-COMPUTATION-HELPER| (PATTERN X START END IGNORE-CASE?)
  ...
  (CL:LET* ((THEPATTERN (%WRAPPER-VALUE PATTERN)) (MATCHPOSITION NULL-INTEGER))
   (CL:DECLARE (CL:TYPE CL:SIMPLE-STRING THEPATTERN) (CL:TYPE CL:FIXNUM MATCHPOSITION))
   (CL:LET* ((NAME STELLA::NULL-STRING) (THESTART NULL-INTEGER) (THEEND NULL-INTEGER))
    (CL:DECLARE (CL:TYPE CL:SIMPLE-STRING NAME) (CL:TYPE CL:FIXNUM THESTART THEEND))
    (CL:MULTIPLE-VALUE-SETQ (NAME THESTART THEEND)
     (|/PL-KERNEL-KB/NORMALIZE-STRING-COMPUTATION-ARGS| X START END CL:NIL))
    (CL:WHEN (CL:EQ NAME STELLA::NULL-STRING) (CL:RETURN-FROM |/PL-KERNEL-KB/STRING-MATCH-COMPUTATION-HELPER| NULL))
    (CL:IF IGNORE-CASE? (CL:SETQ MATCHPOSITION (STRING-SEARCH-IGNORE-CASE NAME THEPATTERN THESTART))
     (CL:SETQ MATCHPOSITION (STRING-SEARCH NAME THEPATTERN THESTART)))
    (CL:IF
     (CL:AND (CL:NOT (CL:= MATCHPOSITION NULL-INTEGER))
      (CL:<= (CL:+ MATCHPOSITION (CL:THE CL:FIXNUM (CL:LENGTH THEPATTERN))) THEEND))
...
(CL:DEFUN |/PL-KERNEL-KB/STRING-UPCASE-COMPUTATION| (X START END)
  (CL:LET* ((NAME STELLA::NULL-STRING) (THESTART NULL-INTEGER) (THEEND NULL-INTEGER))
   ...
   (CL:IF (CL:AND (CL:= THESTART 0) (CL:= THEEND (CL:THE CL:FIXNUM (CL:LENGTH NAME))))
    (WRAP-STRING (STRING-UPCASE NAME))
    (WRAP-STRING
     (CONCATENATE (SUBSEQUENCE NAME 0 THESTART) (STRING-UPCASE (SUBSEQUENCE NAME THESTART THEEND))
...
(CL:DEFUN |/PL-KERNEL-KB/STRING-DOWNCASE-COMPUTATION| (X START END)
  (CL:LET* ((NAME STELLA::NULL-STRING) (THESTART NULL-INTEGER) (THEEND NULL-INTEGER))
   ...
   (CL:IF (CL:AND (CL:= THESTART 0) (CL:= THEEND (CL:THE CL:FIXNUM (CL:LENGTH NAME))))
    ...
    (WRAP-STRING
     (CONCATENATE (SUBSEQUENCE NAME 0 THESTART) (STRING-DOWNCASE (SUBSEQUENCE NAME THESTART THEEND))
      (SUBSEQUENCE NAME THEEND NULL-INTEGER))))))
...
(CL:DEFUN |/PL-KERNEL-KB/STRING-CAPITALIZE-COMPUTATION| (X START END)
  (CL:LET* ((NAME STELLA::NULL-STRING) (THESTART NULL-INTEGER) (THEEND NULL-INTEGER))
   ...
   (CL:IF (CL:AND (CL:= THESTART 0) (CL:= THEEND (CL:THE CL:FIXNUM (CL:LENGTH NAME))))
    ...
    (WRAP-STRING
     (CONCATENATE (SUBSEQUENCE NAME 0 THESTART) (STRING-CAPITALIZE (SUBSEQUENCE NAME THESTART THEEND))
      (SUBSEQUENCE NAME THEEND NULL-INTEGER))))))
...
(CL:DEFUN |/PL-KERNEL-KB/STRING-REPLACE-COMPUTATION| (X FROM TO START END)
  (CL:LET* ((NAME STELLA::NULL-STRING) (THESTART NULL-INTEGER) (THEEND NULL-INTEGER))
   ...
   (CL:MULTIPLE-VALUE-SETQ (NAME THESTART THEEND)
    (|/PL-KERNEL-KB/NORMALIZE-STRING-COMPUTATION-ARGS| X START END CL:NIL))
   (CL:WHEN (CL:OR (CL:EQ NAME STELLA::NULL-STRING) (CL:NOT (STRING? FROM)) (CL:NOT (STRING? TO)))
    (CL:RETURN-FROM |/PL-KERNEL-KB/STRING-REPLACE-COMPUTATION| NULL))
   (CL:IF (CL:AND (CL:= THESTART 0) (CL:= THEEND (CL:THE CL:FIXNUM (CL:LENGTH NAME))))
    (WRAP-STRING (REPLACE-SUBSTRINGS NAME (%WRAPPER-VALUE TO) (%WRAPPER-VALUE FROM)))
    (WRAP-STRING
     (CONCATENATE (SUBSEQUENCE NAME 0 THESTART)
      (REPLACE-SUBSTRINGS (SUBSEQUENCE NAME THESTART THEEND) (%WRAPPER-VALUE TO) (%WRAPPER-VALUE FROM))
      (SUBSEQUENCE NAME THEEND NULL-INTEGER))))))
...
(CL:DEFUN |/PL-KERNEL-KB/STRING-COMPARE-COMPUTATION-HELPER| (O1 O2 START1 END1 START2 END2 IGNORECASE?)
  (CL:LET* ((NAME1 STELLA::NULL-STRING) (THESTART1 NULL-INTEGER) (THEEND1 NULL-INTEGER))
   ...
   (CL:MULTIPLE-VALUE-SETQ (NAME1 THESTART1 THEEND1)
    (|/PL-KERNEL-KB/NORMALIZE-STRING-COMPUTATION-ARGS| O1 START1 END1 CL:NIL))
   ...
   (CL:LET* ((NAME2 STELLA::NULL-STRING) (THESTART2 NULL-INTEGER) (THEEND2 NULL-INTEGER))
    ...
    (CL:MULTIPLE-VALUE-SETQ (NAME2 THESTART2 THEEND2)
     (|/PL-KERNEL-KB/NORMALIZE-STRING-COMPUTATION-ARGS| O2 START2 END2 CL:NIL))
    (CL:WHEN (CL:EQ NAME2 STELLA::NULL-STRING) (CL:RETURN-FROM |/PL-KERNEL-KB/STRING-COMPARE-COMPUTATION-HELPER| NULL))
    (CL:WHEN (CL:OR (CL:> THESTART1 0) (CL:< THEEND1 (CL:THE CL:FIXNUM (CL:LENGTH NAME1))))
     (CL:SETQ NAME1 (SUBSEQUENCE NAME1 THESTART1 THEEND1)))
    (CL:WHEN (CL:OR (CL:> THESTART2 0) (CL:< THEEND2 (CL:THE CL:FIXNUM (CL:LENGTH NAME2))))
...
(CL:DEFUN |/PL-KERNEL-KB/STRING-TO-NUMBER-COMPUTATION| (X START END)
  (CL:LET* ((NAME STELLA::NULL-STRING) (THESTART NULL-INTEGER) (THEEND NULL-INTEGER))
   ...
   (CL:WHEN (CL:OR (CL:> THESTART 0) (CL:< THEEND (CL:THE CL:FIXNUM (CL:LENGTH NAME))))
    (CL:SETQ NAME (SUBSEQUENCE NAME THESTART THEEND)))
   (CL:HANDLER-CASE
    (CL:RETURN-FROM |/PL-KERNEL-KB/STRING-TO-NUMBER-COMPUTATION| (WRAP-INTEGER-VALUE (STRING-TO-INTEGER NAME)))
    (CL:CONDITION ()))
   (CL:HANDLER-CASE (CL:RETURN-FROM |/PL-KERNEL-KB/STRING-TO-NUMBER-COMPUTATION| (WRAP-FLOAT (STRING-TO-FLOAT NAME)))
    (CL:CONDITION ()))
   NULL))
    ...
    ((SUBTYPE-OF-STRING? TEST-VALUE-000)
     (CL:PROGN
      (CL:RETURN-FROM |/PL-KERNEL-KB/LENGTH-COMPUTATION|
       (WRAP-INTEGER (CL:THE CL:FIXNUM (CL:LENGTH (CL:THE CL:SIMPLE-STRING (%WRAPPER-VALUE X))))))))
    ((SUBTYPE-OF? TEST-VALUE-000 |/PL-KERNEL-KB/SGT-ARITHMETIC-LOGIC-SKOLEM|)
     (CL:PROGN
      (CL:COND
       ((CL:OR (ENUMERATED-LIST? X) (ENUMERATED-SET? X))
        (CL:RETURN-FROM |/PL-KERNEL-KB/LENGTH-COMPUTATION|
         (WRAP-INTEGER (CL:1- (LENGTH (%ARGUMENTS (%DEFINING-PROPOSITION X)))))))
       ((LOGICAL-COLLECTION? X)
        (CL:LET* ((LISTVALUE (ASSERTED-COLLECTION-MEMBERS X CL:T)))
         (CL:WHEN (CL:NOT (CL:EQ LISTVALUE NULL))
          (CL:RETURN-FROM |/PL-KERNEL-KB/LENGTH-COMPUTATION| (WRAP-INTEGER (LENGTH LISTVALUE)))))))))
    (CL:T)))
  NULL)
...
(CL:DEFUN |/PL-KERNEL-KB/HELP-STARTUP-ARITHMETIC1| ()
  (CL:PROGN
   ...
   (CL:SETQ |/PL-KERNEL-KB/SYM-ARITHMETIC-PL-KERNEL-KB-INTERVAL-LOWER-BOUND|
    (INTERN-RIGID-SYMBOL-WRT-MODULE "INTERVAL-LOWER-BOUND" NULL 0))
   (CL:SETQ |/PL-KERNEL-KB/SYM-ARITHMETIC-PL-KERNEL-KB-INTERVAL-UPPER-BOUND|
   ...
   (CL:SETQ |/PL-KERNEL-KB/SYM-ARITHMETIC-LOGIC-INTERVAL-MEMBER|
    (INTERN-RIGID-SYMBOL-WRT-MODULE "INTERVAL-MEMBER" (GET-STELLA-MODULE "/LOGIC" CL:T) 0))
   (CL:SETQ |/PL-KERNEL-KB/SYM-ARITHMETIC-STELLA-LOWER-BOUND|
    (INTERN-RIGID-SYMBOL-WRT-MODULE "LOWER-BOUND" (GET-STELLA-MODULE "/STELLA" CL:T) 0))
   (CL:SETQ |/PL-KERNEL-KB/SYM-ARITHMETIC-STELLA-UPPER-BOUND|
    (INTERN-RIGID-SYMBOL-WRT-MODULE "UPPER-BOUND" (GET-STELLA-MODULE "/STELLA" CL:T) 0))
   (CL:SETQ |/PL-KERNEL-KB/SYM-ARITHMETIC-LOGIC-STRICT-LOWER-BOUND?|
    (INTERN-RIGID-SYMBOL-WRT-MODULE "STRICT-LOWER-BOUND?" (GET-STELLA-MODULE "/LOGIC" CL:T) 0))
   (CL:SETQ |/PL-KERNEL-KB/SYM-ARITHMETIC-LOGIC-STRICT-UPPER-BOUND?|
    (INTERN-RIGID-SYMBOL-WRT-MODULE "STRICT-UPPER-BOUND?" (GET-STELLA-MODULE "/LOGIC" CL:T) 0))
   ...
   (CL:SETQ |/PL-KERNEL-KB/SGT-ARITHMETIC-LOGIC-QUANTITY-LOGIC-WRAPPER|
    (INTERN-RIGID-SYMBOL-WRT-MODULE "QUANTITY-LOGIC-WRAPPER" (GET-STELLA-MODULE "/LOGIC" CL:T) 1))
   (CL:SETQ |/PL-KERNEL-KB/SGT-ARITHMETIC-PL-KERNEL-KB->=| (INTERN-RIGID-SYMBOL-WRT-MODULE ">=" NULL 1))
   (CL:SETQ |/PL-KERNEL-KB/SGT-ARITHMETIC-PL-KERNEL-KB-<| (INTERN-RIGID-SYMBOL-WRT-MODULE "<" NULL 1))
   (CL:SETQ |/PL-KERNEL-KB/SGT-ARITHMETIC-PL-KERNEL-KB-=<| (INTERN-RIGID-SYMBOL-WRT-MODULE "=<" NULL 1))
   ...
   (CL:SETQ |/PL-KERNEL-KB/SYM-ARITHMETIC-PL-KERNEL-KB-STARTUP-ARITHMETIC|
...
(CL:DEFUN |/PL-KERNEL-KB/HELP-STARTUP-ARITHMETIC2| ()
  (CL:PROGN
   ...
   (DEFINE-FUNCTION-OBJECT "SIGNAL-INTERVAL-CLASH" "(DEFUN SIGNAL-INTERVAL-CLASH ((INTERVAL INTERVAL-CACHE)))"
   ...
   (DEFINE-METHOD-OBJECT "(DEFMETHOD (INTEGER-VALUED-MEMBER? BOOLEAN) ((INTERVAL INTERVAL-CACHE)))"
    (CL:FUNCTION |/PL-KERNEL-KB/INTEGER-VALUED-MEMBER?|) NULL)
   (DEFINE-METHOD-OBJECT "(DEFMETHOD (INTEGER-LOWER-BOUND INTEGER-WRAPPER) ((INTERVAL INTERVAL-CACHE)))"
    (CL:FUNCTION |/PL-KERNEL-KB/INTEGER-LOWER-BOUND|) NULL)
   (DEFINE-METHOD-OBJECT "(DEFMETHOD (INTEGER-UPPER-BOUND INTEGER-WRAPPER) ((INTERVAL INTERVAL-CACHE)))"
    (CL:FUNCTION |/PL-KERNEL-KB/INTEGER-UPPER-BOUND|) NULL)
   (DEFINE-METHOD-OBJECT "(DEFMETHOD EVALUATE-TIGHTER-INTEGER-INTERVAL ((INTERVAL INTERVAL-CACHE)))"
    (CL:FUNCTION |/PL-KERNEL-KB/EVALUATE-TIGHTER-INTEGER-INTERVAL|) NULL)
   (DEFINE-METHOD-OBJECT "(DEFMETHOD EVALUATE-TIGHTER-INTERVAL ((INTERVAL INTERVAL-CACHE)))"
   ...
   (DEFINE-FUNCTION-OBJECT "NULL-NUMBER?" "(DEFUN (NULL-NUMBER? BOOLEAN) ((SELF NUMBER-WRAPPER)) :PUBLIC? TRUE)"
   ...
   (DEFINE-FUNCTION-OBJECT "INEQUALITY-EVALUATOR" "(DEFUN INEQUALITY-EVALUATOR ((SELF PROPOSITION)))"
...
(CL:DEFUN |/PL-KERNEL-KB/STARTUP-ARITHMETIC| ()
  (CL:LET* ((*MODULE* (GET-STELLA-MODULE "/PL-KERNEL-KB" (> *STARTUP-TIME-PHASE* 1))) (*CONTEXT* *MODULE*))
   ...
   (CL:WHEN (CURRENT-STARTUP-TIME-PHASE? 7) (|/PL-KERNEL-KB/HELP-STARTUP-ARITHMETIC2|)
    ...
    (DEFINE-FUNCTION-OBJECT "LENGTH-COMPUTATION" "(DEFUN (LENGTH-COMPUTATION INTEGER-WRAPPER) ((X OBJECT)))"
     (CL:FUNCTION |/PL-KERNEL-KB/LENGTH-COMPUTATION|) NULL)
    (DEFINE-FUNCTION-OBJECT "STARTUP-ARITHMETIC" "(DEFUN STARTUP-ARITHMETIC () :PUBLIC? TRUE)"
    ...
    (CL:LET* ((FUNCTION (LOOKUP-FUNCTION |/PL-KERNEL-KB/SYM-ARITHMETIC-PL-KERNEL-KB-STARTUP-ARITHMETIC|)))
     (SET-DYNAMIC-SLOT-VALUE (%DYNAMIC-SLOTS FUNCTION) |/PL-KERNEL-KB/SYM-ARITHMETIC-STELLA-METHOD-STARTUP-CLASSNAME|
