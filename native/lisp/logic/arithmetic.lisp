...
(CL:DECLAIM
 (CL:SPECIAL *STARTUP-TIME-PHASE* *MODULE* *REVERSEPOLARITY?* TRUE-TRUTH-VALUE
  FALSE-TRUTH-VALUE *TRACED-KEYWORDS* STANDARD-OUTPUT TRUE EOL *CONTEXT* FALSE
         ...
         ((SUBTYPE-OF-INTEGER? TEST-VALUE-000)
          (CL:PROGN
           (CL:RETURN-FROM /PL-KERNEL-KB/PLUS-COMPUTATION
            (WRAP-INTEGER
             (CL:TRUNCATE (CL:+ (%WRAPPER-VALUE X) (%WRAPPER-VALUE Y)))))))
         ((SUBTYPE-OF-FLOAT? TEST-VALUE-000)
          (CL:PROGN
           (CL:SETQ FLOATRESULT
    ...
    (-1
     (CL:LET* ((RATIO (/PL-KERNEL-KB/DIVIDE-COMPUTATION X1 X2)))
      (CL:IF (CL:NOT (CL:EQ RATIO NULL))
       (CL:SETQ VALUE
        (CL:IF (/PL-KERNEL-KB/ARITHMETIC-EQUAL-TEST RATIO X3) TRUE-WRAPPER
         FALSE-WRAPPER))
...
(CL:DEFCLASS /PL-KERNEL-KB/INTEGER-INTERVAL (THING)
  ((/PL-KERNEL-KB/INTERVAL-LOWER-BOUND :TYPE CL:FIXNUM :INITFORM NULL-INTEGER
    :ALLOCATION :INSTANCE :ACCESSOR /PL-KERNEL-KB/%INTERVAL-LOWER-BOUND)
   (/PL-KERNEL-KB/INTERVAL-UPPER-BOUND :TYPE CL:FIXNUM :INITFORM NULL-INTEGER
    :ALLOCATION :INSTANCE :ACCESSOR /PL-KERNEL-KB/%INTERVAL-UPPER-BOUND))
  (:DOCUMENTATION "An interval of integers"))

(CL:DEFUN /PL-KERNEL-KB/NEW-INTEGER-INTERVAL ()
  (CL:LET* ((SELF NULL))
   (CL:SETQ SELF (CL:MAKE-INSTANCE (CL:QUOTE /PL-KERNEL-KB/INTEGER-INTERVAL)))
...
(CL:DEFUN /PL-KERNEL-KB/NEW-INTERVAL-CACHE ()
  (CL:LET* ((SELF NULL))
   (CL:SETQ SELF (CL:MAKE-INSTANCE (CL:QUOTE /PL-KERNEL-KB/INTERVAL-CACHE)))
   (CL:SETF (%DYNAMIC-SLOTS SELF) (NEW-KEY-VALUE-LIST))
   (CL:SETF (%SURROGATE-VALUE-INVERSE SELF) NULL)
...
(CL:DEFUN /PL-KERNEL-KB/ACCESS-INTERVAL-CACHE-SLOT-VALUE (SELF SLOTNAME VALUE SETVALUE?)
  (CL:COND
   ...
   ((CL:EQ SLOTNAME /PL-KERNEL-KB/SYM-ARITHMETIC-PL-KERNEL-KB-INTERVAL-MEMBER)
...
(CL:DEFMETHOD PRINT-OBJECT ((SELF /PL-KERNEL-KB/INTEGER-INTERVAL-CACHE) STREAM)
  (%%PRINT-STREAM STREAM "|IIcache-of: " (/PL-KERNEL-KB/%INTERVAL-MEMBER SELF)
   " ["
...
(CL:DEFMETHOD PRINT-OBJECT ((SELF /PL-KERNEL-KB/FLOAT-INTERVAL-CACHE) STREAM)
  (%%PRINT-STREAM STREAM "|FIcache-of: " (/PL-KERNEL-KB/%INTERVAL-MEMBER SELF)
...
(CL:DEFUN /PL-KERNEL-KB/CREATE-INTERVAL-CACHE (INTERVALMEMBER INTEGER?)
  (CL:LET*
   ...
   (ASSERT-BINARY-VALUE
    /PL-KERNEL-KB/SGT-ARITHMETIC-PL-KERNEL-KB-INTERVAL-CACHE-OF INTERVALMEMBER
    INTERVALCACHE)
   INTERVALCACHE))
  ...
  (CL:LET*
   ...
   (CL:IF
    ...
    (/PL-KERNEL-KB/CREATE-INTERVAL-CACHE SELF
     (CL:OR (TEST-ISA? SELF /PL-KERNEL-KB/SGT-ARITHMETIC-STELLA-INTEGER)
...
(CL:DEFUN /PL-KERNEL-KB/COERCE-INTERVAL-BOUND-TO-INTEGER (SELF OPERATOR)
  (CL:LET* ((TEST-VALUE-000 (SAFE-PRIMARY-TYPE SELF)))
   (CL:COND
    ((SUBTYPE-OF-INTEGER? TEST-VALUE-000)
     (CL:PROGN
      (/PL-KERNEL-KB/INTEGER.COERCE-INTERVAL-BOUND-TO-INTEGER SELF OPERATOR)))
    ((SUBTYPE-OF-FLOAT? TEST-VALUE-000)
     (CL:PROGN
      (/PL-KERNEL-KB/FLOAT.COERCE-INTERVAL-BOUND-TO-INTEGER SELF OPERATOR)))
    (CL:T NULL-INTEGER))))
(CL:DECLAIM
...
(CL:DEFUN /PL-KERNEL-KB/SIGNAL-INTERVAL-CLASH (INTERVAL)
  ...
  (CL:LET* ((STREAM-000 (NEW-OUTPUT-STRING-STREAM)))
   (%%PRINT-STREAM (%NATIVE-STREAM STREAM-000) "Clash in interval values `"
    INTERVAL "'" EOL)
...
(CL:DEFMETHOD /PL-KERNEL-KB/PROPAGATE-INEQUALITY-TO-INTERVAL-CACHE ((SELF /PL-KERNEL-KB/FLOAT-INTERVAL-CACHE) VALUE OPERATOR)
  (CL:WHEN
   (CL:NOT (ISA? VALUE /PL-KERNEL-KB/SGT-ARITHMETIC-STELLA-NUMBER-WRAPPER))
   (CL:RETURN-FROM /PL-KERNEL-KB/PROPAGATE-INEQUALITY-TO-INTERVAL-CACHE))
  (CL:LET*
...
(CL:DEFUN /PL-KERNEL-KB/NULL-NUMBER? (SELF)
  (CL:WHEN (CL:EQ SELF NULL) (CL:RETURN-FROM /PL-KERNEL-KB/NULL-NUMBER? TRUE))
  (CL:LET* ((TEST-VALUE-000 (SAFE-PRIMARY-TYPE SELF)))
   (CL:COND
    ((SUBTYPE-OF-INTEGER? TEST-VALUE-000)
  ...
  (CL:LET*
   ((PROPOSITION (%PROPOSITION FRAME)) (RELATION (%OPERATOR PROPOSITION))
    ...
    (YARG
     (CL:AREF (CL:THE CL:SIMPLE-VECTOR (%THE-ARRAY (%ARGUMENTS PROPOSITION)))
      1))
    (X (ARGUMENT-BOUND-TO XARG)) (Y (ARGUMENT-BOUND-TO YARG)) (XBOUND NULL)
    (STRICTX? FALSE) (YBOUND NULL) (STRICTY? FALSE))
   ...
   (CL:LET* ((SUCCESS? FALSE))
    ...
    (CL:COND
     ...
     ((CL:EQ RELATION /PL-KERNEL-KB/SGT-ARITHMETIC-PL-KERNEL-KB-=<)
      (CL:SETQ SUCCESS?
       (/PL-KERNEL-KB/COMPARE-INTERVAL-BOUNDS? RELATION XBOUND YBOUND)))
     (CL:T
      (CL:LET* ((STREAM-001 (NEW-OUTPUT-STRING-STREAM)))
   ...
   (CL:LET*
    ...
    (CL:LET
     ((SELF (%THE-ARRAY ARGUMENTS))
      (VALUE (CL:AREF (CL:THE CL:SIMPLE-VECTOR (%THE-ARRAY ARGUMENTS)) 1))
      (POSITION 0))
...
(CL:DEFUN /PL-KERNEL-KB/INEQUALITY-EVALUATOR (SELF)
  ...
  (CL:LET*
   ((ARG1
    ...
    (SKOLEM1? (ISA? VALUE1 /PL-KERNEL-KB/SGT-ARITHMETIC-LOGIC-LOGIC-OBJECT))
    (SKOLEM2? (ISA? VALUE2 /PL-KERNEL-KB/SGT-ARITHMETIC-LOGIC-LOGIC-OBJECT))
   ...
   (CL:CASE (%WRAPPER-VALUE MISSING-ARGUMENT)
    ...
    (0
     (CL:LET*
      ...
      (CL:DECLARE (CL:TYPE CL:SIMPLE-STRING S2 S3) (CL:TYPE CL:FIXNUM N))
      (CL:IF
       (CL:AND (CL:>= N 0) (STRING-EQL? (SUBSEQUENCE S3 N NULL-INTEGER) S2))
    ...
    (1
     (CL:LET*
      ...
      (CL:DECLARE (CL:TYPE CL:SIMPLE-STRING S1 S3) (CL:TYPE CL:FIXNUM L1))
      (CL:IF (STRING-EQL? (SUBSEQUENCE S3 0 L1) S1)
       (CL:SETQ VALUE (WRAP-STRING (SUBSEQUENCE S3 L1 NULL-INTEGER)))
       (CL:SETQ VALUE NULL))))
    (2
     (CL:SETQ VALUE
      (WRAP-STRING (CONCATENATE (%WRAPPER-VALUE X1) (%WRAPPER-VALUE X2)))))
    (CL:OTHERWISE))
   VALUE))
  ...
  (CL:LET*
   ...
   (CL:WHEN (CL:EQ ITERATOR NULL)
    (CL:COND
     ...
     ((CL:EQ SUBARGVALUE NULL)
      (CL:LET*
       ((P1 NULL-INTEGER) (P2 NULL-INTEGER) (SUPER STELLA::NULL-STRING))
       (CL:DECLARE (CL:TYPE CL:FIXNUM P1 P2) (CL:TYPE CL:SIMPLE-STRING SUPER))
       (CL:IF (CL:OR (CL:EQ P1ARGVALUE NULL) (CL:EQ P2ARGVALUE NULL))
        ...
        (CL:PROGN (CL:SETQ P1 (%WRAPPER-VALUE P1ARGVALUE))
         ...
         (CL:IF
          (CL:OR (CL:< P1 0) (CL:> P2 (CL:THE CL:FIXNUM (CL:LENGTH SUPER))))
          (CL:RETURN-FROM /PL-KERNEL-KB/SUBSEQUENCE-SPECIALIST
           /PL-KERNEL-KB/KWD-ARITHMETIC-TERMINAL-FAILURE)
          (CL:RETURN-FROM /PL-KERNEL-KB/SUBSEQUENCE-SPECIALIST
           (SELECT-PROOF-RESULT
     ...
     ((CL:EQ P1ARGVALUE NULL)
      (CL:IF (CL:EQ P2ARGVALUE NULL)
       ...
       (CL:LET*
        ((P2 (%WRAPPER-VALUE P2ARGVALUE)) (SUB (UNWRAP-STRING SUBARGVALUE))
        ...
        (CL:COND
         ((CL:> LSUB P2)
          (CL:RETURN-FROM /PL-KERNEL-KB/SUBSEQUENCE-SPECIALIST
           /PL-KERNEL-KB/KWD-ARITHMETIC-TERMINAL-FAILURE))
         ((STRING-EQL?
           (SUBSEQUENCE (UNWRAP-STRING SUPERARGVALUE) (CL:- P2 LSUB) P2) SUB)
          (CL:RETURN-FROM /PL-KERNEL-KB/SUBSEQUENCE-SPECIALIST
           (SELECT-PROOF-RESULT
            (BIND-ARGUMENT-TO-VALUE? P1ARG (WRAP-INTEGER (CL:- P2 LSUB)) TRUE)
            FALSE TRUE)))
         (CL:T
          (CL:RETURN-FROM /PL-KERNEL-KB/SUBSEQUENCE-SPECIALIST
           /PL-KERNEL-KB/KWD-ARITHMETIC-TERMINAL-FAILURE))))))
     ((CL:EQ P2ARGVALUE NULL)
      (CL:LET*
       ((P1 (%WRAPPER-VALUE P1ARGVALUE)) (SUB (UNWRAP-STRING SUBARGVALUE))
        (LSUB (CL:THE CL:FIXNUM (CL:LENGTH SUB)))
       ...
       (CL:COND
        ...
        ((STRING-EQL? SUB (SUBSEQUENCE SUPER P1 (CL:+ P1 LSUB)))
         (CL:RETURN-FROM /PL-KERNEL-KB/SUBSEQUENCE-SPECIALIST
          (SELECT-PROOF-RESULT
           (BIND-ARGUMENT-TO-VALUE? P2ARG (WRAP-INTEGER (CL:+ P1 LSUB)) TRUE)
           FALSE TRUE)))
        (CL:T
         (CL:RETURN-FROM /PL-KERNEL-KB/SUBSEQUENCE-SPECIALIST
          /PL-KERNEL-KB/KWD-ARITHMETIC-TERMINAL-FAILURE)))))
   ...
   (CL:IF
    (CL:AND (NEXT? ITERATOR)
     ...
     (BIND-ARGUMENT-TO-VALUE? P2ARG (%%VALUE (%%REST (%VALUE ITERATOR)))
      TRUE))
...
(CL:DEFUN /PL-KERNEL-KB/STRING-MATCH-COMPUTATION (PATTERN X START END)
  (CL:WHEN (CL:NOT (CL:AND (STRING? PATTERN) (INTEGER? START) (INTEGER? END)))
   (CL:RETURN-FROM /PL-KERNEL-KB/STRING-MATCH-COMPUTATION NULL))
  (CL:LET*
   ((THEPATTERN (%WRAPPER-VALUE PATTERN)) (THESTART (%WRAPPER-VALUE START))
    (THEEND (%WRAPPER-VALUE END))
    (NAME (CL:IF (STRING? X) (%WRAPPER-VALUE X) (OBJECT-NAME-STRING X)))
...
(CL:DEFUN /PL-KERNEL-KB/HELP-STARTUP-ARITHMETIC1 ()
  (CL:PROGN
   ...
   (CL:SETQ /PL-KERNEL-KB/SGT-ARITHMETIC-PL-KERNEL-KB-INTEGER-INTERVAL-CACHE
  ...
  (CL:LET*
   ...
   (CL:WHEN (CURRENT-STARTUP-TIME-PHASE? 5)
    ...
    (CL:LET*
     ...
     (CL:SETF (%CLASS-SLOT-ACCESSOR-CODE CLASS)
      (CL:FUNCTION /PL-KERNEL-KB/ACCESS-INTEGER-INTERVAL-CACHE-SLOT-VALUE)))
    (CL:LET*
     ((CLASS
     ...
     (CL:SETF (%CLASS-SLOT-ACCESSOR-CODE CLASS)
      (CL:FUNCTION /PL-KERNEL-KB/ACCESS-FLOAT-INTERVAL-CACHE-SLOT-VALUE))))
   ...
   (CL:WHEN (CURRENT-STARTUP-TIME-PHASE? 7)
    ...
    (DEFINE-FUNCTION-OBJECT "FLOAT.COERCE-INTERVAL-BOUND-TO-INTEGER"
     ...
     (CL:FUNCTION /PL-KERNEL-KB/FLOAT.COERCE-INTERVAL-BOUND-TO-INTEGER) NULL)
