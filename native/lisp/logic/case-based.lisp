...
(CL:DECLAIM
 (CL:SPECIAL *STARTUP-TIME-PHASE* *MODULE* *TRAINING-EXAMPLES*
  NULL-FLOAT *SAVE-NETWORK-FILE* TRUE NULL-INTEGER STANDARD-OUTPUT EOL
  NIL FALSE))
   ...
   (CL:LET*
    ...
    (CL:LOOP WHILE
     ...
     (CL:LET
      ...
      (CL:SETF (CL:AREF SELF POSITION) VALUE))))
   (CL:LET*
    ((CASE NULL) (I NULL-INTEGER) (ITER-002 1)
     (UPPER-BOUND-001 NUM-TRAIN)
