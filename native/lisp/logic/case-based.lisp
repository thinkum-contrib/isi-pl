...
(CL:DECLAIM
  ...
  *SAVE-NETWORK-FILE* TRUE NULL-INTEGER STANDARD-OUTPUT EOL NIL FALSE))

;;; (DEFGLOBAL *LOG-MATCH-RULES* ...)

(CL:DEFVAR *LOG-MATCH-RULES* FALSE)

;;; (DEFGLOBAL *LOG-ANTECEDENT-CONSTRUCTION* ...)

(CL:DEFVAR *LOG-ANTECEDENT-CONSTRUCTION* FALSE)
...
(CL:DEFVAR *ONLY-VARIABLIZE-VISITED-INSTANCES* FALSE)
...
(CL:DEFUN CREATE-CASE-INSTANCE-VECTOR (CLASS)
  (CL:LET*
   ...
   (CL:LET*
    ((INST NULL) (I NULL-INTEGER) (ITER-000 0) (UPPER-BOUND-000 (CL:1- NUM))
     (ITER-001 ITERATOR))
    ...
    (CL:LOOP WHILE
     ...
     (CL:PROGN (CL:SETQ INST (%%VALUE ITER-001))
  ...
  (CL:LET* ((SLOT-VALUES (NEW-VECTOR (LENGTH INSTANCES))))
   (CL:LET*
    ((INST NULL) (I NULL-INTEGER) (ITER-000 0)
     (UPPER-BOUND-000 (CL:1- (LENGTH INSTANCES)))
...
(CL:DEFUN %GUESS (INST-NAME SLOT-NAME)
  ...
  (CL:LET*
   ...
   (CL:DECLARE (CL:TYPE CL:SIMPLE-STRING RULE-NAME))
   (CL:WHEN (CL:NOT (MEMBER? *CASE-RULE-NAMES* RULE-NAME-SYMBOL))
    (%%PRINT-STREAM (%NATIVE-STREAM STANDARD-OUTPUT) "Building match rule."
     EOL)
   ...
   (CL:LET* ((I NULL-INTEGER) (ITER-001 0) (UPPER-BOUND-001 (CL:1- NUM)))
    ...
    (CL:LOOP WHILE (CL:<= ITER-001 UPPER-BOUND-001) DO
     ...
     (CL:LET
      ...
      (CL:SETF (CL:AREF SELF POSITION) VALUE))))
   (CL:LET*
    ((CASE NULL) (I NULL-INTEGER) (ITER-002 0) (UPPER-BOUND-002 (CL:1- NUM))
     (ITER-003 (%THE-CONS-LIST CASES)))
    ...
    (CL:LOOP WHILE
     ...
     (CL:PROGN (CL:SETQ CASE (%%VALUE ITER-003))
      ...
      (CL:LET* ((SCORE (MATCH-INSTANCES PROBE CASE)))
       ...
       (CL:WHEN
        (CL:> (%WRAPPER-VALUE SCORE)
         (%WRAPPER-VALUE
          (CL:AREF (CL:THE CL:SIMPLE-VECTOR (%THE-ARRAY MATCH-SCORES))
           (CL:THE CL:FIXNUM
            (%WRAPPER-VALUE
             (CL:AREF (CL:THE CL:SIMPLE-VECTOR (%THE-ARRAY NEAREST-NEIGHBORS))
              FARTHEST))))))
        (CL:LET
         ((SELF (%THE-ARRAY NEAREST-NEIGHBORS)) (VALUE (WRAP-INTEGER I))
          (POSITION FARTHEST))
         (CL:DECLARE (CL:TYPE CL:SIMPLE-VECTOR SELF)
          (CL:TYPE CL:FIXNUM POSITION))
         (CL:SETF (CL:AREF SELF POSITION) VALUE))
        ...
        (CL:LET*
         ...
         (CL:DECLARE (CL:TYPE CL:FIXNUM ITER-004 UPPER-BOUND-003 J))
         (CL:LOOP WHILE (CL:<= ITER-004 UPPER-BOUND-003) DO
          (CL:PROGN (CL:SETQ J ITER-004) (CL:SETQ ITER-004 (CL:1+ ITER-004)))
          (CL:WHEN
           (CL:<
            (%WRAPPER-VALUE
             (CL:AREF (CL:THE CL:SIMPLE-VECTOR (%THE-ARRAY MATCH-SCORES))
     ...
     (CL:COND
      ...
      ((SUBTYPE-OF-INTEGER? TEST-VALUE-000)
       (CL:LET*
        ...
        (CL:RETURN-FROM COMBINE-CASE-ANSWERS
         (WRAP-FLOAT
          (CL:/ (CL:FLOAT (%WRAPPER-VALUE SUM) 0.0d0) *NUM-NEIGHBORS*)))))
      (CL:T
       (%%PRINT-STREAM (%NATIVE-STREAM STANDARD-OUTPUT)
        "Warning:  Slot type not number.  Cannot average" EOL)))))
   (CL:T))
...
(CL:DEFUN GENERATE-CASE-RULE-WO-SLOT (CASES CLASS-NAME SLOT-NAME)
  (CL:LET*
   ...
   (CL:LET* ((FPTR (NEW-OUTPUT-FILE-STREAM "current-cases.ste")))
    ...
    (CL:LET*
     ((CASE-NAME NULL) (I NULL-INTEGER) (ITER-002 0)
      (UPPER-BOUND-000 (CL:1- NUM-CASES))
     ...
     (CL:LOOP WHILE
      ...
      (%%PRINT-STREAM (%NATIVE-STREAM FPTR) "(add-case " CASE-NAME ")" EOL))))
   (BUILD-CASE-RULE KIND)
   (CL:LET*
    ((CASE-NAME NULL) (VAL NULL) (VECTOR-002 SLOT-VALUES) (INDEX-002 0)
     (LENGTH-002 (LENGTH VECTOR-002)) (ITER-004 (%THE-CONS-LIST CASE-NAMES)))
    ...
    (CL:LOOP WHILE
     ...
     (CL:PROGN (CL:SETQ CASE-NAME (%%VALUE ITER-004))
...
(CL:DEFUN %TRAIN-AND-TEST-CASE-MATCHER (CLASS-NAME SLOT-NAME NUM-TRAIN NUM-TEST CYCLES)
  ...
  (CL:LET*
   ...
   (%%PRINT-STREAM (%NATIVE-STREAM STANDARD-OUTPUT) "Training case matcher"
    EOL)
    ...
    (CL:LET*
     ...
     (CL:LOOP WHILE (CL:<= ITER-002 UPPER-BOUND-001) DO
      ...
      (CL:IF (CL:EQ COLLECT-000 NULL)
       (CL:PROGN
        (CL:SETQ COLLECT-000
         (CONS (CL:AREF (CL:THE CL:SIMPLE-VECTOR (%THE-ARRAY INSTANCES)) I)
          NIL))
    ...
    (CL:LET*
     ...
     (CL:LOOP WHILE (CL:<= ITER-003 UPPER-BOUND-002) DO
      ...
      (CL:LET*
       ...
       (%%PRINT-STREAM (%NATIVE-STREAM STANDARD-OUTPUT) PROBE "  Predicted: "
        ANSWER ", Correct: " CORRECT-ANSWER EOL)
...
(CL:DEFUN %TEST-CASE-BASED-REASONER (CLASS-NAME SLOT-NAME NUM-TRAIN NUM-TEST)
  ...
  (CL:LET*
   ...
   (CL:LET*
    ((CASE NULL) (I NULL-INTEGER) (ITER-000 0)
     (UPPER-BOUND-000 (CL:1- NUM-CASES))
    ...
    (CL:LOOP WHILE
     ...
     (CL:LET ((SELF (%THE-ARRAY CASE-VECTOR)) (VALUE CASE) (POSITION I))
      ...
      (CL:SETF (CL:AREF SELF POSITION) VALUE))))
   (CL:LET*
    ((CASE NULL) (I NULL-INTEGER) (ITER-002 1) (UPPER-BOUND-001 NUM-TRAIN)
   ...
   (CL:LET*
    ...
    (CL:LOOP WHILE (CL:<= ITER-004 UPPER-BOUND-002) DO
     ...
     (CL:LET*
      ((PROBE (CL:AREF (CL:THE CL:SIMPLE-VECTOR (%THE-ARRAY CASE-VECTOR)) I))
       (CASE-NAME (OBJECT-NAME PROBE))
       (CORRECT-ANSWER (GET-SLOT-VALUE PROBE SLOT))
       (ANSWER (GENERATE-CASE-BASED-ANSWER PROBE SLOT TRAINING-CASES)))
      (CL:WHEN (EQL? ANSWER CORRECT-ANSWER)
       (CL:SETQ NUM-CORRECT (CL:1+ NUM-CORRECT)))
      (%%PRINT-STREAM (%NATIVE-STREAM FPTR) "Case " CASE-NAME " predicted: "
       ANSWER " correct: " CORRECT-ANSWER)
      (%%PRINT-STREAM (%NATIVE-STREAM STANDARD-OUTPUT) "Case " CASE-NAME
...
(CL:DEFUN %TEST-CASE-MATCHER (CLASS-NAME SLOT-NAME)
  ...
  (CL:LET*
   ...
   (CL:LET*
    ((CASE-NAME NULL) (PROBE NULL) (CASE NULL)
     (ITER-003 (%THE-CONS-LIST CASES)) (ITER-004 (%THE-CONS-LIST CASES))
    ...
    (CL:LOOP WHILE
     ...
     (CL:PROGN (CL:SETQ CASE (%%VALUE ITER-003))
      (CL:SETQ ITER-003 (%%REST ITER-003)))
     (CL:PROGN (CL:SETQ PROBE (%%VALUE ITER-004))
      (CL:SETQ ITER-004 (%%REST ITER-004)))
     (CL:PROGN (CL:SETQ CASE-NAME (%%VALUE ITER-005))
...
(CL:DEFUN GENERATE-CASE-TRAINING-EXAMPLES (INSTANCES SLOT)
  (CL:LET*
    ...
    (CL:LOOP WHILE (CL:<= ITER-001 UPPER-BOUND-001) DO
     ...
     (CL:LET*
      ...
      (CL:LOOP WHILE (CL:OR UNBOUNDED?-000 (CL:<= ITER-002 UPPER-BOUND-002))
       ...
       (CL:SETQ J J) (CL:SETQ L (RANDOM NUM-INSTANCES))
       (CL:LOOP WHILE (CL:= I L) DO (CL:SETQ L (RANDOM NUM-INSTANCES)))
       (CL:LET
        ((SELF (%THE-ARRAY INDEX)) (VALUE (WRAP-INTEGER L)) (POSITION K))
        (CL:DECLARE (CL:TYPE CL:SIMPLE-VECTOR SELF)
         (CL:TYPE CL:FIXNUM POSITION))
        (CL:SETF (CL:AREF SELF POSITION) VALUE))
       (CL:LET
      ...
      ((SELF (%THE-ARRAY MATCH-SCORES))
       (VALUE
        (WRAP-FLOAT
         (CL:- 1.0d0
          (%WRAPPER-VALUE
           (CL:AREF (CL:THE CL:SIMPLE-VECTOR (%THE-ARRAY MATCH-SCORES)) I)))))
       (POSITION I))
      (CL:DECLARE (CL:TYPE CL:SIMPLE-VECTOR SELF)
       (CL:TYPE CL:FIXNUM POSITION))
      (CL:SETF (CL:AREF SELF POSITION) VALUE))))
   (CL:LET*
    ...
    (CL:DECLARE (CL:TYPE CL:FIXNUM ITER-004 UPPER-BOUND-004 I))
    (CL:LOOP WHILE (CL:<= ITER-004 UPPER-BOUND-004) DO
     ...
     (CL:LET*
      ...
      (CL:DECLARE (CL:TYPE CL:FIXNUM ITER-005 UPPER-BOUND-005 J))
      (CL:LOOP WHILE (CL:OR UNBOUNDED?-001 (CL:<= ITER-005 UPPER-BOUND-005))
       DO (CL:PROGN (CL:SETQ J ITER-005) (CL:SETQ ITER-005 (CL:1+ ITER-005)))
       (CL:SETQ J J)
       (CL:LET* ((EXAMPLE (NEW-TRAINING-EXAMPLE)))
        ...
        (CL:SETF (%SCORE EXAMPLE)
         (%WRAPPER-VALUE
          (CL:AREF (CL:THE CL:SIMPLE-VECTOR (%THE-ARRAY MATCH-SCORES)) K)))
...
(CL:DEFUN CALCULATE-CASE-MATCH (X Y)
  (CL:LET* ((TEST-VALUE-000 (SAFE-PRIMARY-TYPE X)))
   (CL:COND
    ...
    ((SUBTYPE-OF-INTEGER? TEST-VALUE-000)
     (CL:PROGN
      (CL:FLOAT (ABS (CL:- (%WRAPPER-VALUE X) (%WRAPPER-VALUE Y))) 0.0d0)))
...
(CL:DEFUN STRING-ARGUMENT? (CLAUSE)
  (CL:LET* ((ELE NULL) (ITER-000 CLAUSE))
   (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-000 NIL)) DO
    (CL:PROGN (CL:SETQ ELE (%%VALUE ITER-000))
     (CL:SETQ ITER-000 (%%REST ITER-000)))
      ...
      ((CL:EQ TEST-VALUE-000 SGT-CASE-BASED-STELLA-CONS)
       (CL:PROGN
        (CL:WHEN (STRING-ARGUMENT? ELE)
         (CL:RETURN-FROM STRING-ARGUMENT? TRUE))))
      ((SUBTYPE-OF-STRING? TEST-VALUE-000)
       (CL:PROGN (CL:RETURN-FROM STRING-ARGUMENT? TRUE)))
      (CL:T)))))
  FALSE)
...
(CL:DEFUN FILTER-ANTECEDENT (ANTECEDENT RULE-NAME)
  ...
  (CL:LET* ((CLAUSE (ALLOCATE-ITERATOR ANTECEDENT)))
   (CL:LOOP WHILE (NEXT? CLAUSE) DO
    (CL:WHEN (STRING-ARGUMENT? (%VALUE CLAUSE)) (VALUE-SETTER CLAUSE NULL))))
           ...
           (CL:WHEN (CL:NOT (EQL? (%%VALUE SUB) (%%VALUE (%%REST SUB))))
            (CL:LET* ((ANT NULL) (ITER-002 (%THE-CONS-LIST ANTECEDENT)))
             (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-002 NIL)) DO
              (CL:PROGN (CL:SETQ ANT (%%VALUE ITER-002))
               (CL:SETQ ITER-002 (%%REST ITER-002)))
  ...
  (CL:LET* ((PREDICATE (%%VALUE CLAUSE)) (ARITY (LENGTH CLAUSE)))
   ...
   (CL:LET* ((ANT NULL) (ITER-000 (%THE-CONS-LIST ANTECEDENT)))
    (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-000 NIL)) DO
     ...
     (CL:LET* ((REAL-ANT ANT))
      (CL:WHEN *LOG-ANTECEDENT-CONSTRUCTION*
       (%%PRINT-STREAM (%NATIVE-STREAM STANDARD-OUTPUT) "   Comparing " CLAUSE
        " to " REAL-ANT EOL))
      (CL:WHEN
       ...
       (CL:LET* ((SUBS NIL))
        (CL:LET*
         ((VAR2 NULL) (VAR1 NULL) (ITER-001 (%%REST CLAUSE))
          (ITER-002 (%%REST REAL-ANT)) (COLLECT-000 NULL))
         (CL:LOOP WHILE
          (CL:AND (CL:NOT (CL:EQ ITER-001 NIL)) (CL:NOT (CL:EQ ITER-002 NIL)))
          DO
          (CL:PROGN (CL:SETQ VAR1 (%%VALUE ITER-001))
           (CL:SETQ ITER-001 (%%REST ITER-001)))
          (CL:PROGN (CL:SETQ VAR2 (%%VALUE ITER-002))
           (CL:SETQ ITER-002 (%%REST ITER-002)))
          ...
          (CL:IF (CL:EQ COLLECT-000 NULL)
           ...
           (CL:PROGN
            ...
            (CL:SETQ COLLECT-000 (%%REST COLLECT-000))))))
        (CL:WHEN *LOG-ANTECEDENT-CONSTRUCTION*
         (%%PRINT-STREAM (%NATIVE-STREAM STANDARD-OUTPUT) "   Found match: "
          SUBS EOL))
  ...
  (CL:LET* ((VAR NULL) (ITER-000 (%THE-CONS-LIST VARS)))
   (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-000 NIL)) DO
    ...
    (CL:WHEN (CL:NOT (CL:= (POSITION CLAUSE1 VAR 0) (POSITION CLAUSE2 VAR 0)))
     (CL:RETURN-FROM PARAMETERS-ALIGNED? FALSE))))
  (CL:LET*
   ((P2 NULL) (P1 NULL) (ITER-001 (%%REST CLAUSE1))
    (ITER-002 (%%REST CLAUSE2)))
   (CL:LOOP WHILE
    (CL:AND (CL:NOT (CL:EQ ITER-001 NIL)) (CL:NOT (CL:EQ ITER-002 NIL))) DO
    (CL:PROGN (CL:SETQ P1 (%%VALUE ITER-001))
     (CL:SETQ ITER-001 (%%REST ITER-001)))
    (CL:PROGN (CL:SETQ P2 (%%VALUE ITER-002))
     (CL:SETQ ITER-002 (%%REST ITER-002)))
    (CL:COND
     ((CONS? P1)
      (CL:WHEN
...
(CL:DEFVAR *PRINT-CASE-DISTANCES* FALSE)
...
(CL:DEFUN INTERN-LOGIC-SYMBOL (NAME)
  ...
  (INTERN-SYMBOL-IN-MODULE NAME (GET-MODULE (WRAP-STRING "LOGIC")) TRUE))
...
(CL:DEFUN HELP-STARTUP-CASE-BASED2 ()
  (CL:PROGN (CL:SETQ *LOG-MATCH-RULES* FALSE)
   (CL:SETQ *LOG-ANTECEDENT-CONSTRUCTION* FALSE)
   (CL:SETQ *CASE-SOLUTION-COMBINATION* KWD-CASE-BASED-WEIGHTED-VOTE)
   (CL:SETQ *CASE-RULE-NAMES* (NEW-LIST))
   (CL:SETQ *VISITED-INSTANCES* (NEW-LIST))
   (CL:SETQ *ONLY-VARIABLIZE-VISITED-INSTANCES* FALSE)
   (CL:SETQ *VISITED-PROPOSITIONS* (NEW-LIST))
   (CL:SETQ *CASE-ANTECEDENT-TABLE* (NEW-STRING-HASH-TABLE))
   (CL:SETQ *CASE-TYPES-TABLE* (NEW-STRING-HASH-TABLE))
   (CL:SETQ *CASE-NAME-TABLE* (NEW-HASH-TABLE))
   (CL:SETQ *PRINT-CASE-DISTANCES* FALSE)))
  ...
  (CL:PROGN
   ...
   (CL:LET*
    ...
    (SET-DYNAMIC-SLOT-VALUE (%DYNAMIC-SLOTS FUNCTION)
     ...
     (WRAP-STRING "_Startup-Case-Based") NULL-STRING-WRAPPER))))
