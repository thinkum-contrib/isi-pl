...
(CL:DECLAIM
 (CL:SPECIAL *STARTUP-TIME-PHASE* TRUE-WRAPPER ZERO-WRAPPER *PRINT-CASE-DISTANCES* *MODULE* *TESTING-EXAMPLES*
  *RULE-COMBINATION* *TRAINING-EXAMPLES* STANDARD-ERROR *PARTIAL-SUPPORT-CACHE* NULL-FLOAT-WRAPPER NIL STANDARD-OUTPUT
  EOL NULL-INTEGER NULL-FLOAT))
...
(CL:DEFCLASS PROPOSITION-NEURAL-NETWORK (STANDARD-OBJECT)
  ((PROPOSITION :ALLOCATION :INSTANCE :ACCESSOR %PROPOSITION) (INPUT :ALLOCATION :INSTANCE :ACCESSOR %INPUT)
   (HIDDEN :ALLOCATION :INSTANCE :ACCESSOR %HIDDEN)
   (OUTPUT :TYPE CL:DOUBLE-FLOAT :INITFORM NULL-FLOAT :ALLOCATION :INSTANCE :ACCESSOR %OUTPUT)
   (INPUT-ERROR :ALLOCATION :INSTANCE :ACCESSOR %INPUT-ERROR)
   (HIDDEN-ERROR :ALLOCATION :INSTANCE :ACCESSOR %HIDDEN-ERROR) (IH :ALLOCATION :INSTANCE :ACCESSOR %IH)
   (IH-DELTA :ALLOCATION :INSTANCE :ACCESSOR %IH-DELTA) (HO :ALLOCATION :INSTANCE :ACCESSOR %HO)
   (HO-DELTA :ALLOCATION :INSTANCE :ACCESSOR %HO-DELTA) (IH-SLOPE :ALLOCATION :INSTANCE :ACCESSOR %IH-SLOPE)
...
(CL:DEFUN NEW-PROPOSITION-NEURAL-NETWORK ()
  (CL:LET* ((SELF NULL)) (CL:SETQ SELF (CL:MAKE-INSTANCE (CL:QUOTE PROPOSITION-NEURAL-NETWORK)))
   (CL:SETF (%HO-PREV-SLOPE SELF) NULL) (CL:SETF (%HO-SLOPE SELF) NULL) (CL:SETF (%IH-PREV-SLOPE SELF) NULL)
   (CL:SETF (%IH-SLOPE SELF) NULL) (CL:SETF (%HO-DELTA SELF) NULL) (CL:SETF (%HO SELF) NULL)
   (CL:SETF (%IH-DELTA SELF) NULL) (CL:SETF (%IH SELF) NULL) (CL:SETF (%HIDDEN-ERROR SELF) NULL)
   (CL:SETF (%INPUT-ERROR SELF) NULL) (CL:SETF (%OUTPUT SELF) NULL-FLOAT) (CL:SETF (%HIDDEN SELF) NULL)
...
(CL:DEFUN ACCESS-PROPOSITION-NEURAL-NETWORK-SLOT-VALUE (SELF SLOTNAME VALUE SETVALUE?)
  (CL:COND
   ...
   ((CL:EQ SLOTNAME SYM-NEURAL-NETWORK-LOGIC-INPUT)
    (CL:IF SETVALUE? (CL:SETF (%INPUT SELF) VALUE) (CL:SETQ VALUE (%INPUT SELF))))
   ((CL:EQ SLOTNAME SYM-NEURAL-NETWORK-LOGIC-HIDDEN)
    (CL:IF SETVALUE? (CL:SETF (%HIDDEN SELF) VALUE) (CL:SETQ VALUE (%HIDDEN SELF))))
   ((CL:EQ SLOTNAME SYM-NEURAL-NETWORK-LOGIC-OUTPUT)
    (CL:IF SETVALUE? (CL:SETF (%OUTPUT SELF) (%WRAPPER-VALUE VALUE)) (CL:SETQ VALUE (WRAP-FLOAT (%OUTPUT SELF)))))
   ((CL:EQ SLOTNAME SYM-NEURAL-NETWORK-LOGIC-INPUT-ERROR)
    (CL:IF SETVALUE? (CL:SETF (%INPUT-ERROR SELF) VALUE) (CL:SETQ VALUE (%INPUT-ERROR SELF))))
   ((CL:EQ SLOTNAME SYM-NEURAL-NETWORK-LOGIC-HIDDEN-ERROR)
    (CL:IF SETVALUE? (CL:SETF (%HIDDEN-ERROR SELF) VALUE) (CL:SETQ VALUE (%HIDDEN-ERROR SELF))))
   ...
   ((CL:EQ SLOTNAME SYM-NEURAL-NETWORK-LOGIC-IH-DELTA)
    (CL:IF SETVALUE? (CL:SETF (%IH-DELTA SELF) VALUE) (CL:SETQ VALUE (%IH-DELTA SELF))))
   ...
   ((CL:EQ SLOTNAME SYM-NEURAL-NETWORK-LOGIC-HO-DELTA)
    (CL:IF SETVALUE? (CL:SETF (%HO-DELTA SELF) VALUE) (CL:SETQ VALUE (%HO-DELTA SELF))))
   ((CL:EQ SLOTNAME SYM-NEURAL-NETWORK-LOGIC-IH-SLOPE)
    (CL:IF SETVALUE? (CL:SETF (%IH-SLOPE SELF) VALUE) (CL:SETQ VALUE (%IH-SLOPE SELF))))
   ((CL:EQ SLOTNAME SYM-NEURAL-NETWORK-LOGIC-IH-PREV-SLOPE)
    (CL:IF SETVALUE? (CL:SETF (%IH-PREV-SLOPE SELF) VALUE) (CL:SETQ VALUE (%IH-PREV-SLOPE SELF))))
   ((CL:EQ SLOTNAME SYM-NEURAL-NETWORK-LOGIC-HO-SLOPE)
    (CL:IF SETVALUE? (CL:SETF (%HO-SLOPE SELF) VALUE) (CL:SETQ VALUE (%HO-SLOPE SELF))))
   ((CL:EQ SLOTNAME SYM-NEURAL-NETWORK-LOGIC-HO-PREV-SLOPE)
    (CL:IF SETVALUE? (CL:SETF (%HO-PREV-SLOPE SELF) VALUE) (CL:SETQ VALUE (%HO-PREV-SLOPE SELF))))
   (CL:T
...
(CL:DEFUN CHECK-MASTER-NETWORK-LIST ()
  (CL:LET* ((NET NULL) (ITER-000 (%THE-CONS-LIST *MASTER-NEURAL-NETWORK-LIST*)) (I NULL-INTEGER) (ITER-001 0))
   ...
   (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-000 NIL)) DO (CL:SETQ NET (%%VALUE ITER-000)) (CL:SETQ I ITER-001)
    (%%PRINT-STREAM (%NATIVE-STREAM STANDARD-OUTPUT) "Net " I ": " (LENGTH (%INPUT NET)) " inputs, "
...
(CL:DEFUN CLEAR-ALL-NEURAL-NETWORKS ()
  (CL:LET* ((NET NULL) (ITER-000 (%THE-CONS-LIST *MASTER-NEURAL-NETWORK-LIST*)))
   (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-000 NIL)) DO (CL:SETQ NET (%%VALUE ITER-000)) (RANDOMIZE-NEURAL-NETWORK NET)
...
(CL:DEFUN CLEAR-ALL-SLOPES ()
  (CL:LET* ((NET NULL) (ITER-000 (%THE-CONS-LIST *MASTER-NEURAL-NETWORK-LIST*)))
   (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-000 NIL)) DO (CL:SETQ NET (%%VALUE ITER-000)) (CLEAR-SLOPES NET)
    (CL:SETQ ITER-000 (%%REST ITER-000)))))

;;; (DEFUN CLEAR-SLOPES ...)

(CL:DEFUN CLEAR-SLOPES (NET)
  (CL:LET* ((H NULL-INTEGER) (ITER-000 0) (UPPER-BOUND-000 (CL:1- (LENGTH (%HIDDEN NET)))))
   (CL:DECLARE (CL:TYPE CL:FIXNUM H ITER-000 UPPER-BOUND-000))
   (CL:LOOP WHILE (CL:<= ITER-000 UPPER-BOUND-000) DO (CL:SETQ H ITER-000)
    (CL:LET* ((I NULL-INTEGER) (ITER-001 0) (UPPER-BOUND-001 (CL:1- (LENGTH (%INPUT NET)))))
       ...
       ((SELF (%THE-ARRAY (%IH-PREV-SLOPE NET)))
        (VALUE
         (CL:AREF (CL:THE CL:SIMPLE-VECTOR (%THE-ARRAY (%IH-SLOPE NET)))
          (CL:THE CL:FIXNUM (CL:+ (CL:* I (%NOF-COLUMNS (%IH-SLOPE NET))) H))))
    ...
    (CL:LET
     ((SELF (%THE-ARRAY (%HO-PREV-SLOPE NET)))
      (VALUE (CL:AREF (CL:THE CL:SIMPLE-VECTOR (%THE-ARRAY (%HO-SLOPE NET))) H)) (POSITION H))
    ...
    (CL:LET
     ((SELF (%THE-ARRAY (%HO-SLOPE NET)))
      (VALUE
       (WRAP-FLOAT
        (CL:* (%WRAPPER-VALUE (CL:AREF (CL:THE CL:SIMPLE-VECTOR (%THE-ARRAY (%HO NET))) H)) *WEIGHT-DECAY*)))
      (POSITION H))
     (CL:DECLARE (CL:TYPE CL:SIMPLE-VECTOR SELF) (CL:TYPE CL:FIXNUM POSITION)) (CL:SETF (CL:AREF SELF POSITION) VALUE))
...
(CL:DEFUN RANDOMIZE-NEURAL-NETWORK (NET)
  (CL:LET* ((NUM-IN (LENGTH (%INPUT NET))) (NUM-HIDDEN (LENGTH (%HIDDEN NET))))
   (CL:DECLARE (CL:TYPE CL:FIXNUM NUM-IN NUM-HIDDEN))
   (CL:LET* ((H NULL-INTEGER) (ITER-000 0) (UPPER-BOUND-000 (CL:1- NUM-HIDDEN)))
    (CL:DECLARE (CL:TYPE CL:FIXNUM H ITER-000 UPPER-BOUND-000))
    (CL:LOOP WHILE (CL:<= ITER-000 UPPER-BOUND-000) DO (CL:SETQ H ITER-000)
     (CL:LET ((SELF (%THE-ARRAY (%HO-DELTA NET))) (VALUE (WRAP-FLOAT 0.0d0)) (POSITION H))
      (CL:DECLARE (CL:TYPE CL:SIMPLE-VECTOR SELF) (CL:TYPE CL:FIXNUM POSITION))
      (CL:SETF (CL:AREF SELF POSITION) VALUE))
     (CL:LET* ((I NULL-INTEGER) (ITER-001 0) (UPPER-BOUND-001 (CL:1- NUM-IN)))
      ...
      (CL:LOOP WHILE (CL:<= ITER-001 UPPER-BOUND-001) DO (CL:SETQ I ITER-001)
       ...
       (CL:SETQ ITER-001 (CL:1+ ITER-001))))
     (CL:SETQ ITER-000 (CL:1+ ITER-000))))
   (CL:LET* ((I NULL-INTEGER) (ITER-002 0) (UPPER-BOUND-002 (CL:1- NUM-HIDDEN)))
    ...
    (CL:LOOP WHILE (CL:<= ITER-002 UPPER-BOUND-002) DO (CL:SETQ I ITER-002)
     (CL:LET* ((J NULL-INTEGER) (ITER-003 0) (UPPER-BOUND-003 (CL:1- NUM-IN)))
      ...
      (CL:LOOP WHILE (CL:<= ITER-003 UPPER-BOUND-003) DO (CL:SETQ J ITER-003)
       (CL:LET
        ((SELF (%THE-ARRAY (%IH NET))) (VALUE (WRAP-FLOAT (RANDOM-WEIGHT *WEIGHT-RANGE*)))
...
(CL:DEFUN CREATE-NEURAL-NETWORK (PROP)
  (CL:LET* ((NET NULL) (NUM-IN (CL:1+ (LENGTH (%ARGUMENTS PROP)))) (NUM-HIDDEN (MIN (CL:+ NUM-IN 0) 20)))
   (CL:DECLARE (CL:TYPE CL:FIXNUM NUM-IN NUM-HIDDEN))
   (CL:WHEN (CL:> NUM-IN 100) (CL:SETQ NUM-HIDDEN (CL:+ (FLOOR (CL:/ NUM-IN 10.0d0)) 10)))
   (CL:SETQ NET (ALLOCATE-NEURAL-NETWORK NUM-IN NUM-HIDDEN)) (PUSH *MASTER-NEURAL-NETWORK-LIST* NET)
...
(CL:DEFUN DEFINE-NEURAL-NETWORK-FROM-PARSE-TREE (TREE)
  (CL:LET*
   ((PROP (BUILD-PROPOSITION (%%VALUE TREE))) (NET (CREATE-NEURAL-NETWORK PROP)) (IH (%%VALUE (%%REST TREE)))
    (HO (%%VALUE (%%REST (%%REST TREE)))) (K 0))
   (CL:DECLARE (CL:TYPE CL:FIXNUM K))
   (CL:LET* ((I NULL-INTEGER) (ITER-000 0) (UPPER-BOUND-000 (CL:1- (LENGTH (%INPUT NET)))))
    (CL:DECLARE (CL:TYPE CL:FIXNUM I ITER-000 UPPER-BOUND-000))
    (CL:LOOP WHILE (CL:<= ITER-000 UPPER-BOUND-000) DO (CL:SETQ I ITER-000)
     (CL:LET* ((H NULL-INTEGER) (ITER-001 0) (UPPER-BOUND-001 (CL:1- (LENGTH (%HIDDEN NET)))))
   ...
   (CL:LET* ((H NULL-INTEGER) (ITER-002 0) (UPPER-BOUND-002 (CL:1- (LENGTH (%HIDDEN NET)))) (NUM NULL) (ITER-003 HO))
    ...
    (CL:LOOP WHILE (CL:AND (CL:<= ITER-002 UPPER-BOUND-002) (CL:NOT (CL:EQ ITER-003 NIL))) DO (CL:SETQ H ITER-002)
     (CL:SETQ NUM (%%VALUE ITER-003))
...
(CL:DEFUN ALLOCATE-NEURAL-NETWORK (NUM-IN NUM-HIDDEN)
  ...
  (CL:LET* ((NET (NEW-PROPOSITION-NEURAL-NETWORK))) (CL:SETF (%INPUT NET) (NEW-VECTOR NUM-IN))
   (CL:SETF (%HIDDEN NET) (NEW-VECTOR NUM-HIDDEN)) (CL:SETF (%IH NET) (NEW-2_D_ARRAY NUM-IN NUM-HIDDEN))
   (CL:SETF (%IH-DELTA NET) (NEW-2_D_ARRAY NUM-IN NUM-HIDDEN)) (CL:SETF (%INPUT-ERROR NET) (NEW-VECTOR NUM-IN))
   (CL:SETF (%HIDDEN-ERROR NET) (NEW-VECTOR NUM-HIDDEN)) (CL:SETF (%HO NET) (NEW-VECTOR NUM-HIDDEN))
   (CL:SETF (%HO-DELTA NET) (NEW-VECTOR NUM-HIDDEN))
   (CL:WHEN (CL:EQ *NEURAL-NETWORK-TRAINING-METHOD* KWD-NEURAL-NETWORK-QUICKPROP)
...
(CL:DEFUN ACTIVATE-PROPOSITIONAL-NEURAL-NETWORK (NET)
  (CL:LET*
   ((NUM-IN (LENGTH (%INPUT NET))) (NUM-HIDDEN (LENGTH (%HIDDEN NET))) (ARGUMENTS (%ARGUMENTS (%PROPOSITION NET)))
    (STOP (CL:1- NUM-IN)) (INPUT (%INPUT NET)) (HIDDEN (%HIDDEN NET)) (IH (%IH NET)) (HO (%HO NET)) (SCORE 0.0d0)
    (SUM 0.0d0))
   (CL:DECLARE (CL:TYPE CL:FIXNUM NUM-IN NUM-HIDDEN STOP) (CL:TYPE CL:DOUBLE-FLOAT SCORE SUM))
   (PUSH *ACTIVATED-NETWORKS* NET)
   (CL:LET ((SELF (%THE-ARRAY (%INPUT NET))) (VALUE (WRAP-FLOAT 1.0d0)) (POSITION 0))
    (CL:DECLARE (CL:TYPE CL:SIMPLE-VECTOR SELF) (CL:TYPE CL:FIXNUM POSITION)) (CL:SETF (CL:AREF SELF POSITION) VALUE))
     ...
     (CL:IF
      (CL:NOT
       (CL:=
        (%WRAPPER-VALUE
         (DYNAMIC-SLOT-VALUE
          (%DYNAMIC-SLOTS (CL:AREF (CL:THE CL:SIMPLE-VECTOR (%THE-ARRAY ARGUMENTS)) (CL:THE CL:FIXNUM (CL:1- I))))
      ...
      (CL:LET
       ...
       (CL:DECLARE (CL:TYPE CL:SIMPLE-VECTOR SELF) (CL:TYPE CL:FIXNUM POSITION))
       (CL:SETF (CL:AREF SELF POSITION) VALUE))
      (CL:LET ((SELF (%THE-ARRAY INPUT)) (VALUE (WRAP-FLOAT 0.0d0)) (POSITION I))
       (CL:DECLARE (CL:TYPE CL:SIMPLE-VECTOR SELF) (CL:TYPE CL:FIXNUM POSITION))
       (CL:SETF (CL:AREF SELF POSITION) VALUE)))
     (CL:SETQ ITER-000 (CL:1+ ITER-000))))
   (CL:LET* ((I NULL-INTEGER) (ITER-001 0) (UPPER-BOUND-001 (CL:1- NUM-HIDDEN)))
    (CL:DECLARE (CL:TYPE CL:FIXNUM I ITER-001 UPPER-BOUND-001))
    (CL:LOOP WHILE (CL:<= ITER-001 UPPER-BOUND-001) DO (CL:SETQ I ITER-001)
     (CL:LET*
      ((J NULL-INTEGER) (ITER-002 0) (UPPER-BOUND-002 STOP) (UNBOUNDED?-001 (CL:= UPPER-BOUND-002 NULL-INTEGER)))
     ...
     (CL:LET
      ((SELF (%THE-ARRAY HIDDEN))
       (VALUE
        (WRAP-FLOAT (CL:/ 1.0d0 (CL:+ 1.0d0 (CL:THE CL:DOUBLE-FLOAT (CL:EXP (CL:THE CL:DOUBLE-FLOAT (CL:- 0 SUM))))))))
       (POSITION I))
      (CL:DECLARE (CL:TYPE CL:SIMPLE-VECTOR SELF) (CL:TYPE CL:FIXNUM POSITION))
      (CL:SETF (CL:AREF SELF POSITION) VALUE))
     (CL:SETQ SCORE
      (CL:+ SCORE
       (CL:* (%WRAPPER-VALUE (CL:AREF (CL:THE CL:SIMPLE-VECTOR (%THE-ARRAY HIDDEN)) I))
        (%WRAPPER-VALUE (CL:AREF (CL:THE CL:SIMPLE-VECTOR (%THE-ARRAY HO)) I)))))
     (CL:SETQ ITER-001 (CL:1+ ITER-001))))
   ...
   (CL:SETF (%OUTPUT NET)
    (CL:/ 1.0d0 (CL:+ 1.0d0 (CL:THE CL:DOUBLE-FLOAT (CL:EXP (CL:THE CL:DOUBLE-FLOAT (CL:- 0 SCORE)))))))
   (SET-DYNAMIC-SLOT-VALUE (%DYNAMIC-SLOTS (%PROPOSITION NET)) SYM-NEURAL-NETWORK-LOGIC-MATCH-SCORE
    (WRAP-FLOAT (%OUTPUT NET)) NULL-FLOAT-WRAPPER)
   (%OUTPUT NET)))
...
(CL:DEFUN %TRAIN-NEURAL-NETWORK (CYCLES NUM-TRAINING)
  ...
  (CL:IF *TRAIN-CACHED-NETWORKS?* (TRAIN-CACHED-NEURAL-NETWORKS CYCLES NUM-TRAINING)
...
(CL:DEFUN TRAIN-UNCACHED-NEURAL-NETWORKS (CYCLES NUM-TRAINING)
  ...
  (CL:LET* ((MSE 0.0d0) (NUM-EX (LENGTH *TRAINING-EXAMPLES*)) (LOOK-PTR NULL) (EXAMPLES (NEW-VECTOR NUM-TRAINING)))
   ...
   (CL:WHEN (CL:> NUM-TRAINING NUM-EX)
    (%%PRINT-STREAM (%NATIVE-STREAM STANDARD-ERROR) "Error: There are only " NUM-EX " training examples")
    (CL:RETURN-FROM TRAIN-UNCACHED-NEURAL-NETWORKS))
   (SHUFFLE-LIST *TRAINING-EXAMPLES*)
   (CL:LET* ((I NULL-INTEGER) (ITER-000 0) (UPPER-BOUND-000 (CL:1- NUM-TRAINING)))
    (CL:DECLARE (CL:TYPE CL:FIXNUM I ITER-000 UPPER-BOUND-000))
    (CL:LOOP WHILE (CL:<= ITER-000 UPPER-BOUND-000) DO (CL:SETQ I ITER-000)
     (CL:LET ((SELF (%THE-ARRAY EXAMPLES)) (VALUE (NTH *TRAINING-EXAMPLES* I)) (POSITION I))
      (CL:DECLARE (CL:TYPE CL:SIMPLE-VECTOR SELF) (CL:TYPE CL:FIXNUM POSITION))
      (CL:SETF (CL:AREF SELF POSITION) VALUE))
     (CL:SETQ ITER-000 (CL:1+ ITER-000))))
   (CL:LET* ((CYCLE NULL-INTEGER) (ITER-001 0) (UPPER-BOUND-001 (CL:1- CYCLES)))
    ...
    (CL:LOOP WHILE (CL:<= ITER-001 UPPER-BOUND-001) DO (CL:SETQ CYCLE ITER-001) (CL:SETQ MSE 0.0d0)
     (CL:COND
      ((CL:OR (CL:EQ *NEURAL-NETWORK-TRAINING-METHOD* KWD-NEURAL-NETWORK-BACKPROP)
        (CL:EQ *NEURAL-NETWORK-TRAINING-METHOD* KWD-NEURAL-NETWORK-BACKPROPAGATION))
       (SHUFFLE-VECTOR EXAMPLES))
      ((CL:EQ *NEURAL-NETWORK-TRAINING-METHOD* KWD-NEURAL-NETWORK-QUICKPROP) (CLEAR-ALL-SLOPES))
      (CL:T
       (CL:LET* ((STREAM-000 (NEW-OUTPUT-STRING-STREAM)))
        (%%PRINT-STREAM (%NATIVE-STREAM STREAM-000) "`" *NEURAL-NETWORK-TRAINING-METHOD*
         "' is not a valid case option")
        (CL:ERROR (NEW-STELLA-EXCEPTION (THE-STRING-READER STREAM-000))))))
     (CL:LET*
      ((EXAMPLE NULL) (VECTOR-000 EXAMPLES) (INDEX-000 0) (LENGTH-000 (LENGTH VECTOR-000)) (K NULL-INTEGER)
       (ITER-002 0))
      (CL:DECLARE (CL:TYPE CL:FIXNUM INDEX-000 LENGTH-000 K ITER-002))
      (CL:LOOP WHILE (CL:< INDEX-000 LENGTH-000) DO
       (CL:SETQ EXAMPLE (CL:AREF (CL:THE CL:SIMPLE-VECTOR (%THE-ARRAY VECTOR-000)) INDEX-000)) (CL:SETQ K ITER-002)
       (CL:WHEN *TRACE-NEURAL-NETWORK-TRAINING*
        (%%PRINT-STREAM (%NATIVE-STREAM STANDARD-OUTPUT) "Example " K ": " (%QUERY EXAMPLE) "  " (%SCORE EXAMPLE) EOL))
       ...
       (CL:LET*
        ((FORM (COPY-CONS-TREE (%QUERY EXAMPLE))) (TARGET (%SCORE EXAMPLE))
         (QUERY (MAKE-QUERY NIL (COERCE-TO-TREE FORM) NIL NIL)) (PROP (%PROPOSITION (%BASE-CONTROL-FRAME QUERY)))
         (OUTPUT (RETURN-PARTIAL-TRUTH QUERY CL:T)) (ERROR (COMPUTE-ERROR TARGET OUTPUT)))
        (CL:DECLARE (CL:TYPE CL:DOUBLE-FLOAT TARGET OUTPUT ERROR))
        (CL:WHEN *TRACE-NEURAL-NETWORK-TRAINING*
         (%%PRINT-STREAM (%NATIVE-STREAM STANDARD-OUTPUT) "   Output: " OUTPUT EOL))
        (CL:SETQ MSE (CL:+ MSE (CL:* ERROR ERROR))) (CL:SETQ *PARTIAL-SUPPORT-CACHE* (NEW-LIST))
        (CL:COND
         ((CL:OR (CL:EQ *NEURAL-NETWORK-TRAINING-METHOD* KWD-NEURAL-NETWORK-BACKPROPAGATION)
         ...
         (CL:T
          (CL:LET* ((STREAM-001 (NEW-OUTPUT-STRING-STREAM)))
           (%%PRINT-STREAM (%NATIVE-STREAM STREAM-001) "`" *NEURAL-NETWORK-TRAINING-METHOD*
            "' is not a valid case option")
     ...
     (CL:WHEN (CL:AND (CL:> *ERROR-PRINT-CYCLE* 0) (CL:= (CL:THE CL:FIXNUM (CL:REM CYCLE *ERROR-PRINT-CYCLE*)) 0))
      (CL:WHEN (CL:NOT (CL:EQ *SAVE-NETWORK-FILE* STELLA::NULL-STRING))
       (CL:WHEN (CL:EQ LOOK-PTR NULL)
        (CL:SETQ LOOK-PTR (NEW-OUTPUT-FILE-STREAM (CONCATENATE *SAVE-NETWORK-FILE* ".err"))))
...
(CL:DEFUN BACKPROPAGATE-ERROR (PROP ERROR)
  ...
  (CL:LET*
   ((NET (DYNAMIC-SLOT-VALUE (%DYNAMIC-SLOTS PROP) SYM-NEURAL-NETWORK-LOGIC-NEURAL-NETWORK NULL))
    (OUTPUT
     (%WRAPPER-VALUE
      (DYNAMIC-SLOT-VALUE (%DYNAMIC-SLOTS PROP) SYM-NEURAL-NETWORK-LOGIC-MATCH-SCORE NULL-FLOAT-WRAPPER)))
    (NUM-HIDDEN 0) (DELTA 0.0d0) (SAVED-INPUT NULL) (SAVED-HIDDEN NULL) (HIDDEN-ERROR NULL) (INPUT-ERROR NULL)
    (NUM-IN 0) (RECURSIVE-CONFLICT CL:NIL) (FULL-ERROR ERROR))
   ...
   (CL:WHEN (CL:NOT (CL:EQ NET NULL)) (CL:SETQ NUM-IN (LENGTH (%INPUT NET)))
    (CL:SETQ NUM-HIDDEN (LENGTH (%HIDDEN NET))) (CL:SETQ SAVED-INPUT (%INPUT NET)) (CL:SETQ SAVED-HIDDEN (%HIDDEN NET))
    (CL:LET ((SELF (%THE-ARRAY (%INPUT NET))) (VALUE (WRAP-FLOAT 1.0d0)) (POSITION 0))
     (CL:DECLARE (CL:TYPE CL:SIMPLE-VECTOR SELF) (CL:TYPE CL:FIXNUM POSITION)) (CL:SETF (CL:AREF SELF POSITION) VALUE))
    (CL:LET* ((I NULL-INTEGER) (ITER-000 1) (UPPER-BOUND-000 (CL:1- NUM-IN)))
     (CL:DECLARE (CL:TYPE CL:FIXNUM I ITER-000 UPPER-BOUND-000))
     (CL:LOOP WHILE (CL:<= ITER-000 UPPER-BOUND-000) DO (CL:SETQ I ITER-000)
      (CL:LET* ((VALUE (%WRAPPER-VALUE (CL:AREF (CL:THE CL:SIMPLE-VECTOR (%THE-ARRAY (%INPUT NET))) I))))
        ...
        (CL:NOT
         (CL:= VALUE
          (%WRAPPER-VALUE
           (DYNAMIC-SLOT-VALUE
            (%DYNAMIC-SLOTS
             (CL:AREF (CL:THE CL:SIMPLE-VECTOR (%THE-ARRAY (%ARGUMENTS PROP))) (CL:THE CL:FIXNUM (CL:1- I))))
            SYM-NEURAL-NETWORK-LOGIC-MATCH-SCORE NULL-FLOAT-WRAPPER))))
    ...
    (CL:WHEN RECURSIVE-CONFLICT (CL:SETQ SAVED-INPUT (NEW-VECTOR NUM-IN))
     ...
     (CL:LET* ((I NULL-INTEGER) (ITER-002 0) (UPPER-BOUND-002 (CL:1- NUM-IN)))
      ...
      (CL:LOOP WHILE (CL:<= ITER-002 UPPER-BOUND-002) DO (CL:SETQ I ITER-002)
       (CL:LET
        ((SELF (%THE-ARRAY SAVED-INPUT)) (VALUE (CL:AREF (CL:THE CL:SIMPLE-VECTOR (%THE-ARRAY (%INPUT NET))) I))
         (POSITION I))
        (CL:DECLARE (CL:TYPE CL:SIMPLE-VECTOR SELF) (CL:TYPE CL:FIXNUM POSITION))
        (CL:SETF (CL:AREF SELF POSITION) VALUE))
       (CL:SETQ ITER-002 (CL:1+ ITER-002))))
     (CL:LET* ((I NULL-INTEGER) (ITER-003 0) (UPPER-BOUND-003 (CL:1- NUM-HIDDEN)))
      (CL:DECLARE (CL:TYPE CL:FIXNUM I ITER-003 UPPER-BOUND-003))
      (CL:LOOP WHILE (CL:<= ITER-003 UPPER-BOUND-003) DO (CL:SETQ I ITER-003)
       (CL:LET
        ((SELF (%THE-ARRAY SAVED-HIDDEN)) (VALUE (CL:AREF (CL:THE CL:SIMPLE-VECTOR (%THE-ARRAY (%HIDDEN NET))) I))
         (POSITION I))
        (CL:DECLARE (CL:TYPE CL:SIMPLE-VECTOR SELF) (CL:TYPE CL:FIXNUM POSITION))
        (CL:SETF (CL:AREF SELF POSITION) VALUE))
       (CL:SETQ ITER-003 (CL:1+ ITER-003)))))
    (CL:SETQ HIDDEN-ERROR (NEW-VECTOR NUM-HIDDEN)) (CL:SETQ INPUT-ERROR (NEW-VECTOR NUM-IN))
    (CL:LET* ((H NULL-INTEGER) (ITER-004 0) (UPPER-BOUND-004 (CL:1- NUM-HIDDEN)))
     ...
     (CL:LOOP WHILE (CL:<= ITER-004 UPPER-BOUND-004) DO (CL:SETQ H ITER-004)
      (CL:LET
       ((SELF (%THE-ARRAY HIDDEN-ERROR))
        (VALUE (WRAP-FLOAT (CL:* ERROR (%WRAPPER-VALUE (CL:AREF (CL:THE CL:SIMPLE-VECTOR (%THE-ARRAY (%HO NET))) H)))))
        (POSITION H))
       (CL:DECLARE (CL:TYPE CL:SIMPLE-VECTOR SELF) (CL:TYPE CL:FIXNUM POSITION))
       (CL:SETF (CL:AREF SELF POSITION) VALUE))
      (CL:LET
    ...
    (CL:LET* ((I NULL-INTEGER) (ITER-005 0) (UPPER-BOUND-005 (CL:1- NUM-IN)))
     ...
     (CL:LOOP WHILE (CL:<= ITER-005 UPPER-BOUND-005) DO (CL:SETQ I ITER-005)
      (CL:LET ((SELF (%THE-ARRAY INPUT-ERROR)) (VALUE (WRAP-FLOAT 0.0d0)) (POSITION I))
       (CL:DECLARE (CL:TYPE CL:SIMPLE-VECTOR SELF) (CL:TYPE CL:FIXNUM POSITION))
       (CL:SETF (CL:AREF SELF POSITION) VALUE))
      (CL:LET* ((H NULL-INTEGER) (ITER-006 0) (UPPER-BOUND-006 (CL:1- NUM-HIDDEN)))
   ...
   (CL:LET* ((TEST-VALUE-000 (%KIND PROP)))
    (CL:COND
     ((CL:OR (CL:EQ TEST-VALUE-000 KWD-NEURAL-NETWORK-AND) (CL:EQ TEST-VALUE-000 KWD-NEURAL-NETWORK-OR))
      (CL:LET*
       ((CHILD NULL) (VECTOR-000 (%ARGUMENTS PROP)) (INDEX-000 0) (LENGTH-000 (LENGTH VECTOR-000)) (I NULL-INTEGER)
        (ITER-007 1) (UPPER-BOUND-007 (CL:1- NUM-IN)))
       ...
       (CL:LOOP WHILE (CL:AND (CL:< INDEX-000 LENGTH-000) (CL:<= ITER-007 UPPER-BOUND-007)) DO
        ...
        (BACKPROPAGATE-ERROR CHILD (%WRAPPER-VALUE (CL:AREF (CL:THE CL:SIMPLE-VECTOR (%THE-ARRAY INPUT-ERROR)) I)))
        (CL:SETQ INDEX-000 (CL:1+ INDEX-000)) (CL:SETQ ITER-007 (CL:1+ ITER-007))))
      (CL:LET* ((H NULL-INTEGER) (ITER-008 0) (UPPER-BOUND-008 (CL:1- NUM-HIDDEN)))
       (CL:DECLARE (CL:TYPE CL:FIXNUM H ITER-008 UPPER-BOUND-008))
       (CL:LOOP WHILE (CL:<= ITER-008 UPPER-BOUND-008) DO (CL:SETQ H ITER-008)
        (CL:SETQ DELTA
         (CL:+
          (CL:* *MOMENTUM-TERM* (%WRAPPER-VALUE (CL:AREF (CL:THE CL:SIMPLE-VECTOR (%THE-ARRAY (%HO-DELTA NET))) H)))
          (CL:* *LEARNING-RATE* ERROR
           (%WRAPPER-VALUE (CL:AREF (CL:THE CL:SIMPLE-VECTOR (%THE-ARRAY SAVED-HIDDEN)) H)))))
        (CL:LET
         ((SELF (%THE-ARRAY (%HO NET)))
          (VALUE
           (WRAP-FLOAT (CL:+ (%WRAPPER-VALUE (CL:AREF (CL:THE CL:SIMPLE-VECTOR (%THE-ARRAY (%HO NET))) H)) DELTA)))
          (POSITION H))
         (CL:DECLARE (CL:TYPE CL:SIMPLE-VECTOR SELF) (CL:TYPE CL:FIXNUM POSITION))
         (CL:SETF (CL:AREF SELF POSITION) VALUE))
        (CL:LET ((SELF (%THE-ARRAY (%HO-DELTA NET))) (VALUE (WRAP-FLOAT DELTA)) (POSITION H))
         (CL:DECLARE (CL:TYPE CL:SIMPLE-VECTOR SELF) (CL:TYPE CL:FIXNUM POSITION))
         (CL:SETF (CL:AREF SELF POSITION) VALUE))
        (CL:SETQ ITER-008 (CL:1+ ITER-008))))
      (CL:LET* ((I NULL-INTEGER) (ITER-009 0) (UPPER-BOUND-009 (CL:1- NUM-IN)))
       (CL:DECLARE (CL:TYPE CL:FIXNUM I ITER-009 UPPER-BOUND-009))
       (CL:LOOP WHILE (CL:<= ITER-009 UPPER-BOUND-009) DO (CL:SETQ I ITER-009)
        (CL:LET* ((H NULL-INTEGER) (ITER-010 0) (UPPER-BOUND-010 (CL:1- NUM-HIDDEN)))
            ...
            (CL:* *MOMENTUM-TERM*
             (%WRAPPER-VALUE
              (CL:AREF (CL:THE CL:SIMPLE-VECTOR (%THE-ARRAY (%IH-DELTA NET)))
               (CL:THE CL:FIXNUM (CL:+ (CL:* I (%NOF-COLUMNS (%IH-DELTA NET))) H)))))
        ...
        (CL:COND
         ((CL:EQ *RULE-COMBINATION* KWD-NEURAL-NETWORK-MAX) (CL:SETQ GUILTY (CONS-LIST (%%VALUE PROOFS)))
          (CL:LET* ((PROOF NULL) (ITER-011 (%%REST PROOFS)))
           (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-011 NIL)) DO (CL:SETQ PROOF (%%VALUE ITER-011))
            (CL:WHEN (CL:= (%SCORE PROOF) OUTPUT) (CL:SETQ GUILTY (CONS-LIST PROOF)))
            (CL:SETQ ITER-011 (%%REST ITER-011)))))
         ((CL:EQ *RULE-COMBINATION* KWD-NEURAL-NETWORK-NOISY-OR) (CL:SETQ GUILTY PROOFS))
         (CL:T
          (CL:LET* ((STREAM-000 (NEW-OUTPUT-STRING-STREAM)))
           (%%PRINT-STREAM (%NATIVE-STREAM STREAM-000) "`" *RULE-COMBINATION* "' is not a valid case option")
           (CL:ERROR (NEW-STELLA-EXCEPTION (THE-STRING-READER STREAM-000))))))
          ...
          (CL:WHEN (CL:NOT (MEMBER? *PARTIAL-SUPPORT-CACHE* (WRAP-INTEGER (%ID PROOF))))
           (CL:LET* ((FACT (%FACT PROOF)))
            (CL:IF (CL:= (LENGTH (%ARGUMENT-SCORES PROOF)) 1)
             (SET-DYNAMIC-SLOT-VALUE (%DYNAMIC-SLOTS FACT) SYM-NEURAL-NETWORK-LOGIC-MATCH-SCORE
              (WRAP-FLOAT (%WRAPPER-VALUE (%%VALUE (%ARGUMENT-SCORES PROOF)))) NULL-FLOAT-WRAPPER)
             (CL:LET*
              ((SCORE NULL) (ITER-013 (%ARGUMENT-SCORES PROOF)) (ARG NULL) (VECTOR-001 (%ARGUMENTS FACT)) (INDEX-001 0)
               (LENGTH-001 (LENGTH VECTOR-001)))
              (CL:DECLARE (CL:TYPE CL:FIXNUM INDEX-001 LENGTH-001))
              (CL:LOOP WHILE (CL:AND (CL:NOT (CL:EQ ITER-013 NIL)) (CL:< INDEX-001 LENGTH-001)) DO
               (CL:SETQ SCORE (%%VALUE ITER-013))
            ...
            (BACKPROPAGATE-ERROR (%FACT PROOF) (CL:* FULL-ERROR (%SCORE PROOF))) (POP *PARTIAL-SUPPORT-CACHE*)))
  ...
  (CL:LET*
   ((NET (DYNAMIC-SLOT-VALUE (%DYNAMIC-SLOTS PROP) SYM-NEURAL-NETWORK-LOGIC-NEURAL-NETWORK NULL))
    (OUTPUT
     (%WRAPPER-VALUE
      (DYNAMIC-SLOT-VALUE (%DYNAMIC-SLOTS PROP) SYM-NEURAL-NETWORK-LOGIC-MATCH-SCORE NULL-FLOAT-WRAPPER)))
    (FULL-ERROR ERROR) (TEMP 0.0d0) (NUM-IN 0) (NUM-HIDDEN 0) (INPUT-ERROR NULL))
   ...
   (CL:WHEN (CL:NOT (CL:EQ NET NULL)) (CL:SETQ NUM-IN (LENGTH (%INPUT NET)))
    ...
    (CL:LET* ((I NULL-INTEGER) (ITER-000 1) (UPPER-BOUND-000 (CL:1- NUM-IN)))
     ...
     (CL:LOOP WHILE (CL:<= ITER-000 UPPER-BOUND-000) DO (CL:SETQ I ITER-000)
      ...
      (CL:SETQ ITER-000 (CL:1+ ITER-000))))
    (ACTIVATE-PROPOSITIONAL-NEURAL-NETWORK NET)
    (CL:SETQ ERROR (CL:* ERROR (CL:+ *SIGMOID-PRIME-OFFSET* (CL:* OUTPUT (CL:- 1.0d0 OUTPUT)))))
    (CL:SETQ INPUT-ERROR (NEW-VECTOR NUM-IN)) (ZERO-VECTOR INPUT-ERROR)
    (CL:LET* ((H NULL-INTEGER) (ITER-001 0) (UPPER-BOUND-001 (CL:1- NUM-HIDDEN)))
     (CL:DECLARE (CL:TYPE CL:FIXNUM H ITER-001 UPPER-BOUND-001))
     (CL:LOOP WHILE (CL:<= ITER-001 UPPER-BOUND-001) DO (CL:SETQ H ITER-001)
      (CL:LET
       ((SELF (%THE-ARRAY (%HO-SLOPE NET)))
   ...
   (CL:LET* ((TEST-VALUE-000 (%KIND PROP)))
    (CL:COND
     ((CL:OR (CL:EQ TEST-VALUE-000 KWD-NEURAL-NETWORK-AND) (CL:EQ TEST-VALUE-000 KWD-NEURAL-NETWORK-OR))
      (CL:LET*
       ((CHILD NULL) (VECTOR-000 (%ARGUMENTS PROP)) (INDEX-000 0) (LENGTH-000 (LENGTH VECTOR-000)) (I NULL-INTEGER)
        (ITER-003 1) (UPPER-BOUND-003 (CL:1- NUM-IN)))
       ...
       (CL:LOOP WHILE (CL:AND (CL:< INDEX-000 LENGTH-000) (CL:<= ITER-003 UPPER-BOUND-003)) DO
        ...
        (QUICKPROPAGATE-ERROR CHILD (%WRAPPER-VALUE (CL:AREF (CL:THE CL:SIMPLE-VECTOR (%THE-ARRAY INPUT-ERROR)) I)))
        ...
        (CL:COND
         ((CL:EQ *RULE-COMBINATION* KWD-NEURAL-NETWORK-MAX) (CL:SETQ GUILTY (CONS-LIST (%%VALUE PROOFS)))
          (CL:LET* ((PROOF NULL) (ITER-004 (%%REST PROOFS)))
           (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-004 NIL)) DO (CL:SETQ PROOF (%%VALUE ITER-004))
            (CL:WHEN (CL:= (%SCORE PROOF) OUTPUT) (CL:SETQ GUILTY (CONS-LIST PROOF)))
           ...
           (CL:LET* ((FACT (%FACT PROOF)))
            (CL:IF (CL:= (LENGTH (%ARGUMENT-SCORES PROOF)) 1)
             (SET-DYNAMIC-SLOT-VALUE (%DYNAMIC-SLOTS FACT) SYM-NEURAL-NETWORK-LOGIC-MATCH-SCORE
              (WRAP-FLOAT (%WRAPPER-VALUE (%%VALUE (%ARGUMENT-SCORES PROOF)))) NULL-FLOAT-WRAPPER)
             (CL:LET*
              ((SCORE NULL) (ITER-006 (%ARGUMENT-SCORES PROOF)) (ARG NULL) (VECTOR-001 (%ARGUMENTS FACT)) (INDEX-001 0)
               (LENGTH-001 (LENGTH VECTOR-001)))
              (CL:DECLARE (CL:TYPE CL:FIXNUM INDEX-001 LENGTH-001))
              (CL:LOOP WHILE (CL:AND (CL:NOT (CL:EQ ITER-006 NIL)) (CL:< INDEX-001 LENGTH-001)) DO
               (CL:SETQ SCORE (%%VALUE ITER-006))
               (CL:SETQ ARG (CL:AREF (CL:THE CL:SIMPLE-VECTOR (%THE-ARRAY VECTOR-001)) INDEX-001))
               (SET-DYNAMIC-SLOT-VALUE (%DYNAMIC-SLOTS ARG) SYM-NEURAL-NETWORK-LOGIC-MATCH-SCORE
                (WRAP-FLOAT (%WRAPPER-VALUE SCORE)) NULL-FLOAT-WRAPPER)
               (CL:SETQ ITER-006 (%%REST ITER-006)) (CL:SETQ INDEX-001 (CL:1+ INDEX-001)))))
            (PUSH *PARTIAL-SUPPORT-CACHE* (WRAP-INTEGER (%ID PROOF)))
            (QUICKPROPAGATE-ERROR (%FACT PROOF) (CL:* FULL-ERROR (%SCORE PROOF))) (POP *PARTIAL-SUPPORT-CACHE*)))
...
(CL:DEFUN MODIFY-WEIGHTS ()
  (CL:LET* ((DELTA 0.0d0) (NUM-IN 0) (NUM-HIDDEN 0))
   (CL:DECLARE (CL:TYPE CL:DOUBLE-FLOAT DELTA) (CL:TYPE CL:FIXNUM NUM-IN NUM-HIDDEN))
   (CL:LET* ((NET NULL) (ITER-000 (%THE-CONS-LIST *MASTER-NEURAL-NETWORK-LIST*)))
    (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-000 NIL)) DO (CL:SETQ NET (%%VALUE ITER-000))
     (CL:SETQ NUM-IN (LENGTH (%INPUT NET))) (CL:SETQ NUM-HIDDEN (LENGTH (%HIDDEN NET)))
     (CL:LET* ((H NULL-INTEGER) (ITER-001 0) (UPPER-BOUND-000 (CL:1- NUM-HIDDEN)))
     ...
     (CL:LET* ((I NULL-INTEGER) (ITER-002 0) (UPPER-BOUND-001 (CL:1- NUM-IN)))
      ...
      (CL:LOOP WHILE (CL:<= ITER-002 UPPER-BOUND-001) DO (CL:SETQ I ITER-002)
       (CL:LET* ((H NULL-INTEGER) (ITER-003 0) (UPPER-BOUND-002 (CL:1- NUM-HIDDEN)))
          ...
          (COMPUTE-QP-DELTA
           (%WRAPPER-VALUE
            (CL:AREF (CL:THE CL:SIMPLE-VECTOR (%THE-ARRAY (%IH-SLOPE NET)))
             (CL:THE CL:FIXNUM (CL:+ (CL:* I (%NOF-COLUMNS (%IH-SLOPE NET))) H))))
           (%WRAPPER-VALUE
            (CL:AREF (CL:THE CL:SIMPLE-VECTOR (%THE-ARRAY (%IH-PREV-SLOPE NET)))
             (CL:THE CL:FIXNUM (CL:+ (CL:* I (%NOF-COLUMNS (%IH-PREV-SLOPE NET))) H))))
           (%WRAPPER-VALUE
            (CL:AREF (CL:THE CL:SIMPLE-VECTOR (%THE-ARRAY (%IH-DELTA NET)))
             (CL:THE CL:FIXNUM (CL:+ (CL:* I (%NOF-COLUMNS (%IH-DELTA NET))) H))))))
         (CL:LET
...
(CL:DEFUN TEST-OVER-TRAINING-EXAMPLES ()
  (CL:LET* ((MSE 0.0d0) (ERROR 0.0d0) (OUTPUT 0.0d0) (FORM NIL) (QUERY NULL))
   ...
   (CL:LET* ((EXAMPLE NULL) (ITER-000 (%THE-CONS-LIST *TRAINING-EXAMPLES*)) (I NULL-INTEGER) (ITER-001 0))
    (CL:DECLARE (CL:TYPE CL:FIXNUM I ITER-001))
    (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-000 NIL)) DO (CL:SETQ EXAMPLE (%%VALUE ITER-000)) (CL:SETQ I ITER-001)
     (CL:WHEN (CL:NOT (CL:EQ (%MODULE EXAMPLE) NULL)) (CHANGE-MODULE (%MODULE EXAMPLE)))
     (CL:SETQ FORM (COPY-CONS-TREE (%QUERY EXAMPLE))) (CL:SETQ QUERY (MAKE-QUERY NIL (COERCE-TO-TREE FORM) NIL NIL))
     (CL:SETQ OUTPUT (RETURN-PARTIAL-TRUTH QUERY CL:T))
     (%%PRINT-STREAM (%NATIVE-STREAM STANDARD-OUTPUT) "Example " I ": " (%%VALUE (%%REST (%QUERY EXAMPLE))) ", " OUTPUT
      "  Target: " (%SCORE EXAMPLE) EOL)
     (CL:SETQ ERROR (CL:- (%SCORE EXAMPLE) OUTPUT)) (CL:SETQ MSE (CL:+ MSE (CL:* ERROR ERROR)))
     (CL:SETQ ITER-000 (%%REST ITER-000)) (CL:SETQ ITER-001 (CL:1+ ITER-001))))
   MSE))

(CL:DEFUN TEST-OVER-TRAINING-EXAMPLES-EVALUATOR-WRAPPER (ARGUMENTS)
  (CL:SETQ ARGUMENTS ARGUMENTS)
  (CL:LET* ((RESULT (TEST-OVER-TRAINING-EXAMPLES))) (CL:DECLARE (CL:TYPE CL:DOUBLE-FLOAT RESULT))
...
(CL:DEFUN %TRAIN-AND-TEST-NEURAL-NETWORK (CYCLES NUM-TRAINING NUM-TESTING)
  ...
  (CL:LET* ((MSE 0.0d0) (TESTING-EXAMPLES (NEW-VECTOR NUM-TESTING))) (CL:DECLARE (CL:TYPE CL:DOUBLE-FLOAT MSE))
   (CL:LET* ((I NULL-INTEGER) (ITER-000 NUM-TRAINING) (UPPER-BOUND-000 (CL:+ NUM-TRAINING (CL:1- NUM-TESTING))))
    ...
    (CL:LOOP WHILE (CL:<= ITER-000 UPPER-BOUND-000) DO (CL:SETQ I ITER-000)
     (CL:LET
      ((SELF (%THE-ARRAY TESTING-EXAMPLES)) (VALUE (NTH *TRAINING-EXAMPLES* I)) (POSITION (CL:- I NUM-TRAINING)))
      (CL:DECLARE (CL:TYPE CL:SIMPLE-VECTOR SELF) (CL:TYPE CL:FIXNUM POSITION))
      (CL:SETF (CL:AREF SELF POSITION) VALUE))
     (CL:SETQ ITER-000 (CL:1+ ITER-000))))
   (CL:LET* ((EXAMPLE NULL) (VECTOR-000 TESTING-EXAMPLES) (INDEX-000 0) (LENGTH-000 (LENGTH VECTOR-000)))
    (CL:DECLARE (CL:TYPE CL:FIXNUM INDEX-000 LENGTH-000))
    (CL:LOOP WHILE (CL:< INDEX-000 LENGTH-000) DO
     (CL:SETQ EXAMPLE (CL:AREF (CL:THE CL:SIMPLE-VECTOR (%THE-ARRAY VECTOR-000)) INDEX-000))
     (CL:WHEN (CL:NOT (CL:EQ (%MODULE EXAMPLE) NULL)) (CHANGE-MODULE (%MODULE EXAMPLE)))
     (CL:LET*
      ((FORM (COPY-CONS-TREE (%QUERY EXAMPLE))) (QUERY (MAKE-QUERY NIL (COERCE-TO-TREE FORM) NIL NIL))
       (OUTPUT (RETURN-PARTIAL-TRUTH QUERY CL:T)) (ERROR (CL:- (%SCORE EXAMPLE) OUTPUT)))
...
(CL:DEFUN TEST-NEURAL-NETWORK ()
  (CL:LET* ((ERROR-SUM 0.0d0) (NUM-TESTING (LENGTH *TESTING-EXAMPLES*)))
   (CL:DECLARE (CL:TYPE CL:DOUBLE-FLOAT ERROR-SUM) (CL:TYPE CL:FIXNUM NUM-TESTING))
   (CL:LET* ((EXAMPLE NULL) (ITER-000 (%THE-CONS-LIST *TESTING-EXAMPLES*)))
    (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-000 NIL)) DO (CL:SETQ EXAMPLE (%%VALUE ITER-000))
     ...
     (CL:LET*
      ...
      (CL:SETQ ERROR-SUM (CL:+ ERROR-SUM (CL:IF (CL:< ERROR 0.0d0) (CL:- 0.0d0 ERROR) ERROR))))
     (CL:SETQ ITER-000 (%%REST ITER-000))))
   (CL:SETQ ERROR-SUM (CL:/ ERROR-SUM NUM-TESTING)) ERROR-SUM))

(CL:DEFUN TEST-NEURAL-NETWORK-EVALUATOR-WRAPPER (ARGUMENTS)
  (CL:SETQ ARGUMENTS ARGUMENTS)
  (CL:LET* ((RESULT (TEST-NEURAL-NETWORK))) (CL:DECLARE (CL:TYPE CL:DOUBLE-FLOAT RESULT))
   (CL:IF (CL:NOT (CL:= RESULT NULL-FLOAT)) (WRAP-FLOAT RESULT) NULL)))
...
(CL:DEFUN %MULTIPLE-NETWORK-TRAINING-RUNS (RUNS CYCLES NUM-TRAINING)
  ...
  (CL:LET* ((ERRORS (NEW-VECTOR RUNS)) (SUM 0.0d0)) (CL:DECLARE (CL:TYPE CL:DOUBLE-FLOAT SUM))
   (CL:LET* ((I NULL-INTEGER) (ITER-000 0) (UPPER-BOUND-000 (CL:1- RUNS)))
    (CL:DECLARE (CL:TYPE CL:FIXNUM I ITER-000 UPPER-BOUND-000))
    (CL:LOOP WHILE (CL:<= ITER-000 UPPER-BOUND-000) DO (CL:SETQ I ITER-000) (CLEAR-ALL-NEURAL-NETWORKS)
     (%TRAIN-NEURAL-NETWORK CYCLES NUM-TRAINING)
...
(CL:DEFUN TRAIN-CACHED-NEURAL-NETWORKS (CYCLES NUM-TRAINING)
  ...
  (CL:CHECK-TYPE NUM-TRAINING CL:FIXNUM)
  (CL:LET*
   ((MSE 0.0d0) (ABS-ERROR 0.0d0) (ERROR 0.0d0) (TARGET 0.0d0) (OUTPUT 0.0d0) (NUM-EX (LENGTH *TRAINING-EXAMPLES*))
    (INDEX (NEW-VECTOR NUM-TRAINING)) (LOOK-PTR NULL) (EXAMPLES (NEW-VECTOR NUM-TRAINING))
   ...
   (CL:WHEN (CL:> NUM-TRAINING NUM-EX)
    (%%PRINT-STREAM (%NATIVE-STREAM STANDARD-OUTPUT) "Error: There are only " NUM-EX " training examples")
    (CL:RETURN-FROM TRAIN-CACHED-NEURAL-NETWORKS))
   (CL:LET*
    ((I NULL-INTEGER) (ITER-000 0) (UPPER-BOUND-000 (CL:1- NUM-TRAINING)) (EXAMPLE NULL)
   ...
   (CL:LET* ((I NULL-INTEGER) (ITER-002 0) (UPPER-BOUND-001 (CL:1- NUM-TRAINING)))
    (CL:DECLARE (CL:TYPE CL:FIXNUM I ITER-002 UPPER-BOUND-001))
    (CL:LOOP WHILE (CL:<= ITER-002 UPPER-BOUND-001) DO (CL:SETQ I ITER-002)
     (CL:LET* ((EXAMPLE (CL:AREF (CL:THE CL:SIMPLE-VECTOR (%THE-ARRAY EXAMPLES)) I)) (TIMESTAMP (GET-NOW-TIMESTAMP)))
      ...
      (CL:IF (CL:AND (CL:NOT (CL:EQ (%CACHED-SOLUTION EXAMPLE) NULL)) (CL:= TIMESTAMP (%TIMESTAMP EXAMPLE)))
       ...
       (CL:LET* ((CURRENT-MODULE *MODULE*))
        ...
        (CL:LET ((SELF (%THE-ARRAY NET-RECORDS)) (VALUE (CREATE-CACHED-NETWORK (%QUERY EXAMPLE))) (POSITION I))
         (CL:DECLARE (CL:TYPE CL:SIMPLE-VECTOR SELF) (CL:TYPE CL:FIXNUM POSITION))
         (CL:SETF (CL:AREF SELF POSITION) VALUE))
        (CL:SETF (%CACHED-SOLUTION EXAMPLE) (CL:AREF (CL:THE CL:SIMPLE-VECTOR (%THE-ARRAY NET-RECORDS)) I))
        (CL:SETF (%TIMESTAMP EXAMPLE) TIMESTAMP) (CHANGE-MODULE CURRENT-MODULE))))
     (CL:SETQ ITER-002 (CL:1+ ITER-002))))
   (%%PRINT-STREAM (%NATIVE-STREAM STANDARD-OUTPUT) "Training Networks" EOL)
   (CL:LET* ((CYCLE NULL-INTEGER) (ITER-003 0) (UPPER-BOUND-002 (CL:1- CYCLES)))
    (CL:DECLARE (CL:TYPE CL:FIXNUM CYCLE ITER-003 UPPER-BOUND-002))
    (CL:LOOP WHILE (CL:<= ITER-003 UPPER-BOUND-002) DO (CL:SETQ CYCLE ITER-003) (CL:SETQ MSE 0.0d0)
      ...
      (CL:T
       (CL:LET* ((STREAM-000 (NEW-OUTPUT-STRING-STREAM)))
        (%%PRINT-STREAM (%NATIVE-STREAM STREAM-000) "`" *NEURAL-NETWORK-TRAINING-METHOD*
         "' is not a valid case option")
        (CL:ERROR (NEW-STELLA-EXCEPTION (THE-STRING-READER STREAM-000))))))
     (CL:LET* ((K NULL-INTEGER) (ITER-004 0) (UPPER-BOUND-003 (CL:1- NUM-TRAINING)))
      ...
      (CL:LOOP WHILE (CL:<= ITER-004 UPPER-BOUND-003) DO (CL:SETQ K ITER-004)
        ...
        (%%PRINT-STREAM (%NATIVE-STREAM STANDARD-OUTPUT) "Example " K ": "
         (%QUERY
          (CL:AREF (CL:THE CL:SIMPLE-VECTOR (%THE-ARRAY EXAMPLES))
           (CL:THE CL:FIXNUM (%WRAPPER-VALUE (CL:AREF (CL:THE CL:SIMPLE-VECTOR (%THE-ARRAY INDEX)) K)))))
         "  "
         (%SCORE
          (CL:AREF (CL:THE CL:SIMPLE-VECTOR (%THE-ARRAY EXAMPLES))
           (CL:THE CL:FIXNUM (%WRAPPER-VALUE (CL:AREF (CL:THE CL:SIMPLE-VECTOR (%THE-ARRAY INDEX)) K)))))
       ...
       (CL:WHEN *TRACE-NEURAL-NETWORK-TRAINING*
        (%%PRINT-STREAM (%NATIVE-STREAM STANDARD-OUTPUT) "   Output: " OUTPUT EOL))
       (CL:SETQ ABS-ERROR (CL:+ ABS-ERROR (CL:IF (CL:< ERROR 0.0d0) (CL:- 0.0d0 ERROR) ERROR)))
...
(CL:DEFUN CACHED-BACKPROPAGATE-ERROR (TREE ERROR)
  ...
  (CL:CHECK-TYPE ERROR CL:DOUBLE-FLOAT)
  (CL:LET*
   ((NET NULL) (TEMP 0.0d0) (DELTA 0.0d0) (INPUT NULL) (HIDDEN NULL) (HIDDEN-ERROR NULL) (INPUT-ERROR NULL)
     ...
     ((CL:EQ *RULE-COMBINATION* KWD-NEURAL-NETWORK-MAX)
      (CL:LET* ((MAX 0.0d0) (GUILTY NIL)) (CL:DECLARE (CL:TYPE CL:DOUBLE-FLOAT MAX))
       (CL:LET* ((NET-DEF NULL) (ITER-000 TREE))
        (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-000 NIL)) DO (CL:SETQ NET-DEF (%%VALUE ITER-000))
         (CL:SETQ NET (%%VALUE NET-DEF))
         (CL:WHEN (CL:> (%OUTPUT NET) MAX) (CL:SETQ MAX (%OUTPUT NET)) (CL:SETQ GUILTY NET-DEF))
         (CL:SETQ ITER-000 (%%REST ITER-000))))
     ...
     ((CL:EQ *RULE-COMBINATION* KWD-NEURAL-NETWORK-NOISY-OR)
      (CL:LET* ((NET-DEF NULL) (ITER-001 TREE))
       (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-001 NIL)) DO (CL:SETQ NET-DEF (%%VALUE ITER-001))
        (CACHED-BACKPROPAGATE-ERROR NET-DEF (CL:* ERROR (%OUTPUT (%%VALUE NET-DEF))))
   ...
   (CL:SETQ NET (%%VALUE TREE)) (CL:SETQ INPUT (%INPUT NET)) (CL:SETQ HIDDEN (%HIDDEN NET))
   (CL:SETQ INPUT-ERROR (%INPUT-ERROR NET)) (CL:SETQ HIDDEN-ERROR (%HIDDEN-ERROR NET))
   (CL:SETQ ERROR (CL:* ERROR (%OUTPUT NET) (CL:- 1.0d0 (%OUTPUT NET))))
   (CL:LET*
    ((I NULL-INTEGER) (ITER-002 1) (UPPER-BOUND-000 (CL:1- (LENGTH (%INPUT NET)))) (ELE NULL) (ITER-003 (%%REST TREE)))
    (CL:DECLARE (CL:TYPE CL:FIXNUM I ITER-002 UPPER-BOUND-000))
    (CL:LOOP WHILE (CL:AND (CL:<= ITER-002 UPPER-BOUND-000) (CL:NOT (CL:EQ ITER-003 NIL))) DO (CL:SETQ I ITER-002)
           ...
           ((CL:EQ *RULE-COMBINATION* KWD-NEURAL-NETWORK-MAX) (CL:SETQ TEMP 0.0d0)
            (CL:LET* ((NET-DEF NULL) (ITER-004 ELE))
             (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-004 NIL)) DO (CL:SETQ NET-DEF (%%VALUE ITER-004))
              (CL:WHEN (CL:> (%OUTPUT (%%VALUE NET-DEF)) TEMP) (CL:SETQ TEMP (%OUTPUT NET)))
              (CL:SETQ ITER-004 (%%REST ITER-004)))))
           ((CL:EQ *RULE-COMBINATION* KWD-NEURAL-NETWORK-NOISY-OR)
            (CL:LET* ((SCORES NIL))
             (CL:LET* ((NET-DEF NULL) (ITER-005 ELE) (COLLECT-000 NULL))
              (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-005 NIL)) DO (CL:SETQ NET-DEF (%%VALUE ITER-005))
               (CL:IF (CL:EQ COLLECT-000 NULL)
                ...
                (CL:PROGN (CL:SETF (%%REST COLLECT-000) (CONS (WRAP-FLOAT (%OUTPUT (%%VALUE NET-DEF))) NIL))
                 (CL:SETQ COLLECT-000 (%%REST COLLECT-000))))
               (CL:SETQ ITER-005 (%%REST ITER-005))))
             (CL:SETQ TEMP (PROBABILISTIC-SUM-N SCORES))))
           (CL:T
            (CL:LET* ((STREAM-001 (NEW-OUTPUT-STRING-STREAM)))
             (%%PRINT-STREAM (%NATIVE-STREAM STREAM-001) "`" *RULE-COMBINATION* "' is not a valid case option")
             (CL:ERROR (NEW-STELLA-EXCEPTION (THE-STRING-READER STREAM-001)))))))))
       ((SUBTYPE-OF-FLOAT? TEST-VALUE-000) (CL:PROGN (CL:SETQ TEMP (%WRAPPER-VALUE ELE))))
       (CL:T
        (CL:LET* ((STREAM-002 (NEW-OUTPUT-STRING-STREAM)))
         (%%PRINT-STREAM (%NATIVE-STREAM STREAM-002) "`" TEST-VALUE-000 "' is not a valid case option")
   ...
   (CL:WHEN RECURSIVE-CONFLICT? (ACTIVATE-CACHED-NETWORK (CONS-LIST TREE))
    (CL:SETQ HIDDEN (NEW-VECTOR (LENGTH (%HIDDEN NET)))) (CL:SETQ HIDDEN-ERROR (NEW-VECTOR (LENGTH (%HIDDEN NET))))
    (CL:SETQ INPUT (NEW-VECTOR (LENGTH (%INPUT NET))))
    (CL:LET* ((I NULL-INTEGER) (ITER-006 0) (UPPER-BOUND-001 (CL:1- (LENGTH INPUT))))
     (CL:DECLARE (CL:TYPE CL:FIXNUM I ITER-006 UPPER-BOUND-001))
     (CL:LOOP WHILE (CL:<= ITER-006 UPPER-BOUND-001) DO (CL:SETQ I ITER-006)
      (CL:LET
       ((SELF (%THE-ARRAY INPUT)) (VALUE (CL:AREF (CL:THE CL:SIMPLE-VECTOR (%THE-ARRAY (%INPUT NET))) I)) (POSITION I))
       (CL:DECLARE (CL:TYPE CL:SIMPLE-VECTOR SELF) (CL:TYPE CL:FIXNUM POSITION))
       (CL:SETF (CL:AREF SELF POSITION) VALUE))
      (CL:SETQ ITER-006 (CL:1+ ITER-006))))
    (CL:LET* ((H NULL-INTEGER) (ITER-007 0) (UPPER-BOUND-002 (CL:1- (LENGTH HIDDEN))))
     (CL:DECLARE (CL:TYPE CL:FIXNUM H ITER-007 UPPER-BOUND-002))
     (CL:LOOP WHILE (CL:<= ITER-007 UPPER-BOUND-002) DO (CL:SETQ H ITER-007)
      (CL:LET
       ((SELF (%THE-ARRAY HIDDEN)) (VALUE (CL:AREF (CL:THE CL:SIMPLE-VECTOR (%THE-ARRAY (%HIDDEN NET))) H))
        (POSITION H))
       (CL:DECLARE (CL:TYPE CL:SIMPLE-VECTOR SELF) (CL:TYPE CL:FIXNUM POSITION))
       (CL:SETF (CL:AREF SELF POSITION) VALUE))
      (CL:SETQ ITER-007 (CL:1+ ITER-007)))))
   (CL:LET* ((H NULL-INTEGER) (ITER-008 0) (UPPER-BOUND-003 (CL:1- (LENGTH HIDDEN))))
    ...
    (CL:LOOP WHILE (CL:<= ITER-008 UPPER-BOUND-003) DO (CL:SETQ H ITER-008)
     ...
     (CL:LET
      ...
      (CL:SETF (CL:AREF SELF POSITION) VALUE))
     (CL:SETQ ITER-008 (CL:1+ ITER-008))))
   (CL:LET* ((I NULL-INTEGER) (ITER-009 0) (UPPER-BOUND-004 (CL:1- (LENGTH INPUT))))
    (CL:DECLARE (CL:TYPE CL:FIXNUM I ITER-009 UPPER-BOUND-004))
    (CL:LOOP WHILE (CL:<= ITER-009 UPPER-BOUND-004) DO (CL:SETQ I ITER-009)
     (CL:LET ((SELF (%THE-ARRAY INPUT-ERROR)) (VALUE (WRAP-FLOAT 0.0d0)) (POSITION I))
      (CL:DECLARE (CL:TYPE CL:SIMPLE-VECTOR SELF) (CL:TYPE CL:FIXNUM POSITION))
      (CL:SETF (CL:AREF SELF POSITION) VALUE))
     (CL:LET* ((H NULL-INTEGER) (ITER-010 0) (UPPER-BOUND-005 (CL:1- (LENGTH HIDDEN))))
      ...
      (CL:LOOP WHILE (CL:<= ITER-010 UPPER-BOUND-005) DO (CL:SETQ H ITER-010)
       ...
       (CL:SETQ ITER-010 (CL:1+ ITER-010))))
     (CL:SETQ ITER-009 (CL:1+ ITER-009))))
   (CL:LET* ((INPUT NULL) (ITER-011 (%%REST TREE)) (I NULL-INTEGER) (ITER-012 1))
    ...
    (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-011 NIL)) DO (CL:SETQ INPUT (%%VALUE ITER-011)) (CL:SETQ I ITER-012)
     (CL:WHEN (ISA? INPUT SGT-NEURAL-NETWORK-STELLA-CONS)
      (CACHED-BACKPROPAGATE-ERROR INPUT
       (%WRAPPER-VALUE (CL:AREF (CL:THE CL:SIMPLE-VECTOR (%THE-ARRAY INPUT-ERROR)) I))))
     (CL:SETQ ITER-011 (%%REST ITER-011)) (CL:SETQ ITER-012 (CL:1+ ITER-012))))
   (CL:LET* ((H NULL-INTEGER) (ITER-013 0) (UPPER-BOUND-006 (CL:1- (LENGTH HIDDEN))))
    ...
    (CL:LOOP WHILE (CL:<= ITER-013 UPPER-BOUND-006) DO (CL:SETQ H ITER-013)
     ...
     (CL:LET
      ((SELF (%THE-ARRAY (%HO NET)))
       (VALUE (WRAP-FLOAT (CL:+ (%WRAPPER-VALUE (CL:AREF (CL:THE CL:SIMPLE-VECTOR (%THE-ARRAY (%HO NET))) H)) DELTA)))
       (POSITION H))
      (CL:DECLARE (CL:TYPE CL:SIMPLE-VECTOR SELF) (CL:TYPE CL:FIXNUM POSITION))
      (CL:SETF (CL:AREF SELF POSITION) VALUE))
     (CL:LET ((SELF (%THE-ARRAY (%HO-DELTA NET))) (VALUE (WRAP-FLOAT DELTA)) (POSITION H))
      (CL:DECLARE (CL:TYPE CL:SIMPLE-VECTOR SELF) (CL:TYPE CL:FIXNUM POSITION))
      (CL:SETF (CL:AREF SELF POSITION) VALUE))
     (CL:LET* ((I NULL-INTEGER) (ITER-014 0) (UPPER-BOUND-007 (CL:1- (LENGTH INPUT))))
...
(CL:DEFUN CACHED-QUICKPROPAGATE-ERROR (TREE ERROR)
  ...
  #+MCL
  (CL:CHECK-TYPE ERROR CL:DOUBLE-FLOAT)
  (CL:LET* ((NET NULL) (TEMP 0.0d0) (INPUT NULL) (HIDDEN NULL) (INPUT-ERROR NULL) (RECURSIVE-CONFLICT? CL:NIL))
   ...
   (CL:WHEN (ISA? (%%VALUE TREE) SGT-NEURAL-NETWORK-STELLA-CONS)
    (CL:COND
     ...
     ((CL:EQ *RULE-COMBINATION* KWD-NEURAL-NETWORK-NOISY-OR)
      (CL:LET* ((NET-DEF NULL) (ITER-001 TREE))
       (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-001 NIL)) DO (CL:SETQ NET-DEF (%%VALUE ITER-001))
        (CACHED-QUICKPROPAGATE-ERROR NET-DEF (CL:* ERROR (%OUTPUT (%%VALUE NET-DEF))))
        (CL:SETQ ITER-001 (%%REST ITER-001)))))
     (CL:T
      (CL:LET* ((STREAM-000 (NEW-OUTPUT-STRING-STREAM)))
       (%%PRINT-STREAM (%NATIVE-STREAM STREAM-000) "`" *RULE-COMBINATION* "' is not a valid case option")
   ...
   (CL:LET* ((H NULL-INTEGER) (ITER-006 0) (UPPER-BOUND-001 (CL:1- (LENGTH HIDDEN))))
      ...
      (CL:* ERROR (%WRAPPER-VALUE (CL:AREF (CL:THE CL:SIMPLE-VECTOR (%THE-ARRAY (%HO NET))) H))
       (CL:+ *SIGMOID-PRIME-OFFSET*
        (CL:* (%WRAPPER-VALUE (CL:AREF (CL:THE CL:SIMPLE-VECTOR (%THE-ARRAY HIDDEN)) H))
         (CL:- 1.0d0 (%WRAPPER-VALUE (CL:AREF (CL:THE CL:SIMPLE-VECTOR (%THE-ARRAY HIDDEN)) H)))))))
     (CL:LET* ((I NULL-INTEGER) (ITER-007 0) (UPPER-BOUND-002 (CL:1- (LENGTH INPUT))))
      ...
      (CL:LOOP WHILE (CL:<= ITER-007 UPPER-BOUND-002) DO (CL:SETQ I ITER-007)
       ...
       (CL:SETQ ITER-007 (CL:1+ ITER-007))))
     (CL:SETQ ITER-006 (CL:1+ ITER-006))))
   (CL:LET* ((INPUT NULL) (ITER-008 (%%REST TREE)) (I NULL-INTEGER) (ITER-009 1))
...
(CL:DEFUN CREATE-CACHED-NETWORK (CONS-QUERY)
  (CL:LET*
   ((QUERY (MAKE-QUERY NIL (COERCE-TO-TREE (COPY-CONS-TREE CONS-QUERY)) NIL NIL))
   ...
   (CL:WHEN (ISA? TREE SGT-NEURAL-NETWORK-STELLA-CONS) (CL:RETURN-FROM CREATE-CACHED-NETWORK TREE)) NIL))
...
(CL:DEFUN BUILD-NETWORK-TREE (PROP PROP-LIST)
  ...
  (CL:COND
     ...
     (CL:LET* ((PROOF NULL) (ITER-000 PROOFS))
      (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-000 NIL)) DO (CL:SETQ PROOF (%%VALUE ITER-000))
       (CL:LET* ((FACT (%FACT PROOF)) (PROOF-TREE NIL))
        (CL:LET*
         ((ARG NULL) (VECTOR-000 (%ARGUMENTS FACT)) (INDEX-000 0) (LENGTH-000 (LENGTH VECTOR-000)) (SCORE NULL)
         ...
         (CL:LOOP WHILE (CL:AND (CL:< INDEX-000 LENGTH-000) (CL:NOT (CL:EQ ITER-001 NIL))) DO
          ...
          (CL:WHEN (ISA? ARG SGT-NEURAL-NETWORK-LOGIC-PROPOSITION)
           ...
           (CL:IF (CL:EQ COLLECT-000 NULL)
            ...
            (CL:PROGN (CL:SETF (%%REST COLLECT-000) (CONS (BUILD-NETWORK-TREE ARG (CONS PROP PROP-LIST)) NIL))
             (CL:SETQ COLLECT-000 (%%REST COLLECT-000)))))
          (CL:SETQ INDEX-000 (CL:1+ INDEX-000)) (CL:SETQ ITER-001 (%%REST ITER-001))))
        (CL:IF
         (CL:NOT (CL:EQ (DYNAMIC-SLOT-VALUE (%DYNAMIC-SLOTS FACT) SYM-NEURAL-NETWORK-LOGIC-NEURAL-NETWORK NULL) NULL))
         (CL:SETQ TREE
          (CONS
           (CONS (DYNAMIC-SLOT-VALUE (%DYNAMIC-SLOTS FACT) SYM-NEURAL-NETWORK-LOGIC-NEURAL-NETWORK NULL) PROOF-TREE)
           TREE))
         (CL:SETQ TREE
          (CONS
           (WRAP-FLOAT
   ...
   ((CL:NOT (CL:EQ (DYNAMIC-SLOT-VALUE (%DYNAMIC-SLOTS PROP) SYM-NEURAL-NETWORK-LOGIC-NEURAL-NETWORK NULL) NULL))
    (CL:LET* ((TREE NIL))
     (CL:LET*
      ((ARG NULL) (VECTOR-001 (%ARGUMENTS PROP)) (INDEX-001 0) (LENGTH-001 (LENGTH VECTOR-001)) (I NULL-INTEGER)
       (ITER-002 1) (COLLECT-001 NULL))
      ...
      (CL:LOOP WHILE (CL:< INDEX-001 LENGTH-001) DO
         ...
         (%WRAPPER-VALUE
          (CL:AREF
           (CL:THE CL:SIMPLE-VECTOR
            (%THE-ARRAY
             (%INPUT (DYNAMIC-SLOT-VALUE (%DYNAMIC-SLOTS PROP) SYM-NEURAL-NETWORK-LOGIC-NEURAL-NETWORK NULL))))
           I)))
        NULL-FLOAT-WRAPPER)
       (CL:IF (CL:EQ COLLECT-001 NULL)
        ...
        (CL:PROGN (CL:SETF (%%REST COLLECT-001) (CONS (BUILD-NETWORK-TREE ARG (CONS PROP PROP-LIST)) NIL))
         (CL:SETQ COLLECT-001 (%%REST COLLECT-001))))
       (CL:SETQ INDEX-001 (CL:1+ INDEX-001)) (CL:SETQ ITER-002 (CL:1+ ITER-002))))
     (CL:SETQ TREE (CONS (DYNAMIC-SLOT-VALUE (%DYNAMIC-SLOTS PROP) SYM-NEURAL-NETWORK-LOGIC-NEURAL-NETWORK NULL) TREE))
     (CONS-LIST TREE)))
   (CL:T
    (WRAP-FLOAT
     (%WRAPPER-VALUE
    ...
    (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-000 NIL)) DO (CL:SETQ CACHED-NET (%%VALUE ITER-000)) (CL:SETQ K ITER-001)
     (CL:LET* ((NET (%%VALUE CACHED-NET))) (CL:SETQ SUM 0.0d0) (CL:SETQ SCORE 0.0d0)
      (CL:LET ((SELF (%THE-ARRAY (%INPUT NET))) (VALUE (WRAP-FLOAT 1.0d0)) (POSITION 0))
       ...
       (CL:SETF (CL:AREF SELF POSITION) VALUE))
      (CL:LET*
       ((I NULL-INTEGER) (ITER-002 1) (UPPER-BOUND-000 (CL:1- (LENGTH (%INPUT NET)))) (INPUT NULL)
        (ITER-003 (%%REST CACHED-NET)))
       (CL:DECLARE (CL:TYPE CL:FIXNUM I ITER-002 UPPER-BOUND-000))
       (CL:LOOP WHILE (CL:AND (CL:<= ITER-002 UPPER-BOUND-000) (CL:NOT (CL:EQ ITER-003 NIL))) DO (CL:SETQ I ITER-002)
        (CL:SETQ INPUT (%%VALUE ITER-003))
        (CL:IF (ISA? INPUT SGT-NEURAL-NETWORK-STELLA-CONS)
         ...
         (CL:LET ((SELF (%THE-ARRAY (%INPUT NET))) (VALUE INPUT) (POSITION I))
          ...
          (CL:SETF (CL:AREF SELF POSITION) VALUE)))
        (CL:SETQ ITER-002 (CL:1+ ITER-002)) (CL:SETQ ITER-003 (%%REST ITER-003))))
      (CL:LET* ((I NULL-INTEGER) (ITER-004 0) (UPPER-BOUND-001 (CL:1- (LENGTH (%HIDDEN NET)))))
       (CL:DECLARE (CL:TYPE CL:FIXNUM I ITER-004 UPPER-BOUND-001))
       (CL:LOOP WHILE (CL:<= ITER-004 UPPER-BOUND-001) DO (CL:SETQ I ITER-004)
        (CL:LET* ((J NULL-INTEGER) (ITER-005 0) (UPPER-BOUND-002 (CL:1- (LENGTH (%INPUT NET)))))
          ...
          (CL:SETQ SUM
           (CL:+ SUM
            (CL:* (%WRAPPER-VALUE (CL:AREF (CL:THE CL:SIMPLE-VECTOR (%THE-ARRAY (%INPUT NET))) J))
             (%WRAPPER-VALUE
              (CL:AREF (CL:THE CL:SIMPLE-VECTOR (%THE-ARRAY (%IH NET)))
               (CL:THE CL:FIXNUM (CL:+ (CL:* J (%NOF-COLUMNS (%IH NET))) I)))))))
          (CL:SETQ ITER-005 (CL:1+ ITER-005))))
        (CL:LET
         ((SELF (%THE-ARRAY (%HIDDEN NET)))
          (VALUE
           (WRAP-FLOAT
            (CL:/ 1.0d0 (CL:+ 1.0d0 (CL:THE CL:DOUBLE-FLOAT (CL:EXP (CL:THE CL:DOUBLE-FLOAT (CL:- 0 SUM))))))))
          (POSITION I))
         (CL:DECLARE (CL:TYPE CL:SIMPLE-VECTOR SELF) (CL:TYPE CL:FIXNUM POSITION))
         (CL:SETF (CL:AREF SELF POSITION) VALUE))
        (CL:SETQ SCORE
      ...
      (CL:SETF (%OUTPUT NET)
       (CL:/ 1.0d0 (CL:+ 1.0d0 (CL:THE CL:DOUBLE-FLOAT (CL:EXP (CL:THE CL:DOUBLE-FLOAT (CL:- 0 SCORE)))))))
      (CL:LET ((SELF (%THE-ARRAY SCORES)) (VALUE (WRAP-FLOAT (%OUTPUT NET))) (POSITION K))
       (CL:DECLARE (CL:TYPE CL:SIMPLE-VECTOR SELF) (CL:TYPE CL:FIXNUM POSITION))
       (CL:SETF (CL:AREF SELF POSITION) VALUE)))
     (CL:SETQ ITER-000 (%%REST ITER-000)) (CL:SETQ ITER-001 (CL:1+ ITER-001))))
   (CL:COND
    ((CL:EQ *RULE-COMBINATION* KWD-NEURAL-NETWORK-MAX)
     (CL:LET* ((MAX (CL:AREF (CL:THE CL:SIMPLE-VECTOR (%THE-ARRAY SCORES)) 0)))
      (CL:LET* ((I NULL-INTEGER) (ITER-006 0) (UPPER-BOUND-003 (CL:1- (LENGTH SCORES))))
     ...
     (CL:CASE (LENGTH SCORES) (0 0.0d0) (1 (%WRAPPER-VALUE (CL:AREF (CL:THE CL:SIMPLE-VECTOR (%THE-ARRAY SCORES)) 0)))
      ...
      (CL:OTHERWISE
       (CL:LET* ((CONS-SCORES NIL))
        (CL:LET* ((ELE NULL) (VECTOR-000 SCORES) (INDEX-000 0) (LENGTH-000 (LENGTH VECTOR-000)) (COLLECT-000 NULL))
         (CL:DECLARE (CL:TYPE CL:FIXNUM INDEX-000 LENGTH-000))
         (CL:LOOP WHILE (CL:< INDEX-000 LENGTH-000) DO
          (CL:SETQ ELE (CL:AREF (CL:THE CL:SIMPLE-VECTOR (%THE-ARRAY VECTOR-000)) INDEX-000))
          (CL:IF (CL:EQ COLLECT-000 NULL)
...
'n' must be <= 2^15."
  ...
  (CL:CHECK-TYPE N CL:DOUBLE-FLOAT)
  (CL:WHEN (CL:> N 32768)
   (CL:ERROR (NEW-STELLA-EXCEPTION "random: Can only generate random numbers between 0 and (2^15)-1.")))
...
(CL:DEFUN ZERO-VECTOR (V)
  (CL:LET* ((I NULL-INTEGER) (ITER-000 0) (UPPER-BOUND-000 (CL:1- (LENGTH V))))
   (CL:DECLARE (CL:TYPE CL:FIXNUM I ITER-000 UPPER-BOUND-000))
   (CL:LOOP WHILE (CL:<= ITER-000 UPPER-BOUND-000) DO (CL:SETQ I ITER-000)
...
(CL:DEFUN %STRUCTURED-NEURAL-NETWORK-REGRESSION (CLASS-NAME SLOT-NAME CYCLES)
  ...
  (CL:LET*
   ((CLASS (%SURROGATE-VALUE-INVERSE (GET-DESCRIPTION CLASS-NAME)))
    (SLOT (%SURROGATE-VALUE-INVERSE (GET-DESCRIPTION SLOT-NAME))) (ILIST (LISTIFY (ALL-CLASS-INSTANCES CLASS)))
    (INSTANCES (NEW-VECTOR (LENGTH ILIST))))
   (CL:WHEN (CL:NOT (FLOAT-FUNCTION? SLOT))
    (%%PRINT-STREAM (%NATIVE-STREAM STANDARD-OUTPUT) "ERROR " SLOT-NAME " is not a function of type float or integer"
     EOL)
    (CL:RETURN-FROM %STRUCTURED-NEURAL-NETWORK-REGRESSION))
   (CL:LET*
    ((I NULL-INTEGER) (ITER-000 0) (UPPER-BOUND-000 (CL:1- (LENGTH ILIST))) (INSTANCE NULL)
   ...
   (CL:LET* ((NUM (GENERATE-REGRESSION-TRAINING-EXAMPLES INSTANCES SLOT))) (CL:DECLARE (CL:TYPE CL:FIXNUM NUM))
    (%%PRINT-STREAM (%NATIVE-STREAM STANDARD-OUTPUT) "Training regression networks" EOL)
    (TRAIN-CACHED-NEURAL-NETWORKS CYCLES NUM))))

(CL:DEFUN STRUCTURED-NEURAL-NETWORK-REGRESSION-EVALUATOR-WRAPPER (ARGUMENTS)
  (%STRUCTURED-NEURAL-NETWORK-REGRESSION (%%VALUE ARGUMENTS) (%%VALUE (%%REST ARGUMENTS))
   (%WRAPPER-VALUE (%%VALUE (%%REST (%%REST ARGUMENTS))))))
...
(CL:DEFUN GET-NN-NEAREST-NEIGHBORS (PROBE CASES K)
  ...
  (CL:LET*
   ((RESULT (NEW-LIST)) (CURRENT-MODULE *MODULE*) (NEIGHBORS (NEW-VECTOR K)) (FARTHEST 0) (DISTANCE 0.0d0)
   ...
   (CL:LET* ((I NULL-INTEGER) (ITER-000 0) (UPPER-BOUND-000 (CL:1- K)))
    (CL:DECLARE (CL:TYPE CL:FIXNUM I ITER-000 UPPER-BOUND-000))
    (CL:LOOP WHILE (CL:<= ITER-000 UPPER-BOUND-000) DO (CL:SETQ I ITER-000)
     (CL:LET ((SELF (%THE-ARRAY DISTANCES)) (VALUE (WRAP-FLOAT 999999.0d0)) (POSITION I))
      (CL:DECLARE (CL:TYPE CL:SIMPLE-VECTOR SELF) (CL:TYPE CL:FIXNUM POSITION))
      (CL:SETF (CL:AREF SELF POSITION) VALUE))
     (CL:SETQ ITER-000 (CL:1+ ITER-000))))
   ...
   (CL:LET* ((CASE NULL) (ITER-001 (%THE-CONS-LIST CASES)))
    (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-001 NIL)) DO (CL:SETQ CASE (%%VALUE ITER-001))
     (CL:WHEN (CL:EQ (%NN-HIDDEN CASE) NULL)
      (CL:WHEN (CL:NOT (CL:EQ (%MODULE CASE) NULL)) (CHANGE-MODULE (%MODULE CASE)))
      (CL:WHEN (CL:EQ (%NN-HIDDEN CASE) NULL) (CL:SETF (%NN-HIDDEN CASE) (CREATE-HIDDEN-SIGNATURE (%QUERY CASE))))
     ...
     (CL:WHEN *PRINT-CASE-DISTANCES*
      (%%PRINT-STREAM (%NATIVE-STREAM STANDARD-OUTPUT) "  Distance from " (LAST (%QUERY CASE)) ": " DISTANCE EOL))
     (CL:SETF (%TEMP CASE) DISTANCE)
     (CL:WHEN (CL:< DISTANCE (%WRAPPER-VALUE (CL:AREF (CL:THE CL:SIMPLE-VECTOR (%THE-ARRAY DISTANCES)) FARTHEST)))
      (CL:LET ((SELF (%THE-ARRAY DISTANCES)) (VALUE (WRAP-FLOAT DISTANCE)) (POSITION FARTHEST))
       (CL:DECLARE (CL:TYPE CL:SIMPLE-VECTOR SELF) (CL:TYPE CL:FIXNUM POSITION))
       (CL:SETF (CL:AREF SELF POSITION) VALUE))
      ...
      (CL:LET* ((J NULL-INTEGER) (ITER-002 1) (UPPER-BOUND-001 (CL:1- K)))
       ...
       (CL:LOOP WHILE (CL:<= ITER-002 UPPER-BOUND-001) DO (CL:SETQ J ITER-002)
        ...
        (CL:SETQ ITER-002 (CL:1+ ITER-002)))))
     (CL:SETQ ITER-001 (%%REST ITER-001))))
   (CL:LET* ((I NULL-INTEGER) (ITER-003 0) (UPPER-BOUND-002 (CL:1- K)) (COLLECT-000 NULL))
    ...
    (CL:LOOP WHILE (CL:<= ITER-003 UPPER-BOUND-002) DO (CL:SETQ I ITER-003)
     (CL:WHEN (CL:NOT (CL:EQ (CL:AREF (CL:THE CL:SIMPLE-VECTOR (%THE-ARRAY NEIGHBORS)) I) NULL))
      (CL:IF (CL:EQ COLLECT-000 NULL)
       ...
       (CL:PROGN (CL:SETF (%%REST COLLECT-000) (CONS (CL:AREF (CL:THE CL:SIMPLE-VECTOR (%THE-ARRAY NEIGHBORS)) I) NIL))
        (CL:SETQ COLLECT-000 (%%REST COLLECT-000)))))
     (CL:SETQ ITER-003 (CL:1+ ITER-003))))
   RESULT))
...
(CL:DEFUN %SWAP-IN-NEW-NETWORKS (OLD-NETS NEW-NETS)
  (CL:LET* ((OLD-NET NULL) (ITER-000 (%THE-CONS-LIST OLD-NETS)) (NEW-NET NULL) (ITER-001 (%THE-CONS-LIST NEW-NETS)))
   (CL:LOOP WHILE (CL:AND (CL:NOT (CL:EQ ITER-000 NIL)) (CL:NOT (CL:EQ ITER-001 NIL))) DO
    ...
    (SET-DYNAMIC-SLOT-VALUE (%DYNAMIC-SLOTS (%PROPOSITION OLD-NET)) SYM-NEURAL-NETWORK-LOGIC-NEURAL-NETWORK NEW-NET
     NULL)
    (CL:SETF (%PROPOSITION NEW-NET) (%PROPOSITION OLD-NET)) (CL:SETQ ITER-000 (%%REST ITER-000))
    (CL:SETQ ITER-001 (%%REST ITER-001))))
...
(CL:DEFUN %SWAP-IN-NETWORK-FILE (FILE)
  ...
  (CL:LET* ((NEW-NETS (%LOAD-NEURAL-NETWORK-FILE FILE)))
   (CL:LET*
    ((OLD-NET NULL) (ITER-000 (%THE-CONS-LIST *MASTER-NEURAL-NETWORK-LIST*)) (NEW-NET NULL)
     (ITER-001 (%THE-CONS-LIST NEW-NETS)))
    (CL:LOOP WHILE (CL:AND (CL:NOT (CL:EQ ITER-000 NIL)) (CL:NOT (CL:EQ ITER-001 NIL))) DO
     (CL:SETQ OLD-NET (%%VALUE ITER-000)) (CL:SETQ NEW-NET (%%VALUE ITER-001))
     (CL:WHEN
      (CL:OR (CL:NOT (CL:= (LENGTH (%INPUT OLD-NET)) (LENGTH (%INPUT NEW-NET))))
       (CL:NOT (CL:= (LENGTH (%HIDDEN OLD-NET)) (LENGTH (%HIDDEN NEW-NET)))))
      (%%PRINT-STREAM (%NATIVE-STREAM STANDARD-OUTPUT) "Error: network file does not match master list" EOL)
...
(CL:DEFUN %LOAD-NEURAL-NETWORK-FILE (FILE)
  ...
  (CL:CHECK-TYPE FILE CL:SIMPLE-STRING)
  (CL:LET*
   ((NETS (NEW-LIST)) (STREAM (NEW-INPUT-FILE-STREAM FILE)) (NUM-HIDDEN 0) (PROP NIL) (TEMP NULL) (NUM-IN 0)
    (NET NULL))
   (CL:DECLARE (CL:TYPE CL:FIXNUM NUM-HIDDEN NUM-IN))
   (CL:LOOP
    (CL:WHEN (CL:NOT (CL:EQ (READ-S-EXPRESSION STREAM) SYM-NEURAL-NETWORK-LOGIC-DEFNETWORK))
    ...
    (CL:LET* ((I NULL-INTEGER) (ITER-000 0) (UPPER-BOUND-000 (CL:1- NUM-IN)))
     ...
     (CL:LOOP WHILE (CL:<= ITER-000 UPPER-BOUND-000) DO (CL:SETQ I ITER-000)
      (CL:LET* ((H NULL-INTEGER) (ITER-001 0) (UPPER-BOUND-001 (CL:1- NUM-HIDDEN)))
       (CL:DECLARE (CL:TYPE CL:FIXNUM H ITER-001 UPPER-BOUND-001))
       (CL:LOOP WHILE (CL:<= ITER-001 UPPER-BOUND-001) DO (CL:SETQ H ITER-001)
        (CL:SETQ TEMP (READ-S-EXPRESSION STREAM)) (CL:WHEN (EQL? TEMP ZERO-WRAPPER) (CL:SETQ TEMP (WRAP-FLOAT 0.0d0)))
        (CL:LET ((SELF (%THE-ARRAY (%IH NET))) (VALUE TEMP) (POSITION (CL:+ (CL:* I (%NOF-COLUMNS (%IH NET))) H)))
         (CL:DECLARE (CL:TYPE CL:SIMPLE-VECTOR SELF) (CL:TYPE CL:FIXNUM POSITION))
         (CL:SETF (CL:AREF SELF POSITION) VALUE))
        (CL:SETQ ITER-001 (CL:1+ ITER-001))))
      (CL:SETQ ITER-000 (CL:1+ ITER-000))))
    (CL:LET* ((H NULL-INTEGER) (ITER-002 0) (UPPER-BOUND-002 (CL:1- NUM-HIDDEN)))
     (CL:DECLARE (CL:TYPE CL:FIXNUM H ITER-002 UPPER-BOUND-002))
     (CL:LOOP WHILE (CL:<= ITER-002 UPPER-BOUND-002) DO (CL:SETQ H ITER-002)
      (CL:LET ((SELF (%THE-ARRAY (%HO NET))) (VALUE (READ-S-EXPRESSION STREAM)) (POSITION H))
       (CL:DECLARE (CL:TYPE CL:SIMPLE-VECTOR SELF) (CL:TYPE CL:FIXNUM POSITION))
       (CL:SETF (CL:AREF SELF POSITION) VALUE))
      (CL:SETQ ITER-002 (CL:1+ ITER-002))))
    (PUSH NETS NET))))
...
name will be used to perform periodic saves."
  ...
  (CL:WHEN (CL:NOT (CL:EQ FILE STELLA::NULL-STRING))
   ...
   (CL:LET* ((FPTR (NEW-OUTPUT-FILE-STREAM FILE)))
    (CL:LET* ((NET NULL) (ITER-000 (%THE-CONS-LIST *MASTER-NEURAL-NETWORK-LIST*)))
     (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-000 NIL)) DO (CL:SETQ NET (%%VALUE ITER-000)) (PRINT-NEURAL-NETWORK NET FPTR)
      (%%PRINT-STREAM (%NATIVE-STREAM FPTR) EOL) (CL:SETQ ITER-000 (%%REST ITER-000))))
    (FREE FPTR))))
...
(CL:DEFUN PRINT-NEURAL-NETWORK (NET STREAM)
  ...
  (CL:LET* ((I NULL-INTEGER) (ITER-000 0) (UPPER-BOUND-000 (CL:1- (LENGTH (%INPUT NET)))))
   (CL:DECLARE (CL:TYPE CL:FIXNUM I ITER-000 UPPER-BOUND-000))
   (CL:LOOP WHILE (CL:<= ITER-000 UPPER-BOUND-000) DO (CL:SETQ I ITER-000)
    (CL:LET* ((J NULL-INTEGER) (ITER-001 0) (UPPER-BOUND-001 (CL:1- (LENGTH (%HIDDEN NET)))))
    ...
    (CL:SETQ ITER-000 (CL:1+ ITER-000))))
  (%%PRINT-STREAM (%NATIVE-STREAM STREAM) EOL)
  (CL:LET* ((NUM NULL) (VECTOR-000 (%HO NET)) (INDEX-000 0) (LENGTH-000 (LENGTH VECTOR-000)))
   (CL:DECLARE (CL:TYPE CL:FIXNUM INDEX-000 LENGTH-000))
   (CL:LOOP WHILE (CL:< INDEX-000 LENGTH-000) DO
    (CL:SETQ NUM (CL:AREF (CL:THE CL:SIMPLE-VECTOR (%THE-ARRAY VECTOR-000)) INDEX-000))
    (CL:LET* ((VALUE (%WRAPPER-VALUE NUM))) (CL:DECLARE (CL:TYPE CL:DOUBLE-FLOAT VALUE))
...
(CL:DEFUN CREATE-HIDDEN-SIGNATURE (CONS-QUERY)
  (CL:LET* ((QUERY (MAKE-QUERY NIL (COPY-CONS-TREE CONS-QUERY) NIL NIL)) (PMF NULL) (NET NULL) (RESULT NULL))
   (INSERT-AT (%OPTIONS QUERY) KWD-NEURAL-NETWORK-MATCH-MODE KWD-NEURAL-NETWORK-NN)
   (INSERT-AT (%OPTIONS QUERY) KWD-NEURAL-NETWORK-MAXIMIZE-SCORE? TRUE-WRAPPER) (CALL-ASK-PARTIAL QUERY)
   (CL:SETQ PMF (%CHILD (%CHILD (%PARTIAL-MATCH-FRAME (%BASE-CONTROL-FRAME QUERY)))))
   (CL:SETQ NET
    (DYNAMIC-SLOT-VALUE (%DYNAMIC-SLOTS (%PROPOSITION (%CONTROL-FRAME PMF))) SYM-NEURAL-NETWORK-LOGIC-NEURAL-NETWORK
     NULL))
   (CL:SETQ RESULT (NEW-VECTOR (LENGTH (%HIDDEN NET))))
   (CL:LET* ((I NULL-INTEGER) (ITER-000 0) (UPPER-BOUND-000 (CL:1- (LENGTH (%HIDDEN NET)))))
    (CL:DECLARE (CL:TYPE CL:FIXNUM I ITER-000 UPPER-BOUND-000))
    (CL:LOOP WHILE (CL:<= ITER-000 UPPER-BOUND-000) DO (CL:SETQ I ITER-000)
     (CL:LET
      ((SELF (%THE-ARRAY RESULT)) (VALUE (CL:AREF (CL:THE CL:SIMPLE-VECTOR (%THE-ARRAY (%HIDDEN NET))) I))
       (POSITION I))
      (CL:DECLARE (CL:TYPE CL:SIMPLE-VECTOR SELF) (CL:TYPE CL:FIXNUM POSITION))
      (CL:SETF (CL:AREF SELF POSITION) VALUE))
     (CL:SETQ ITER-000 (CL:1+ ITER-000))))
...
(CL:DEFUN NEW-2_D_ARRAY (NOF-ROWS NOF-COLUMNS)
  ...
  (CL:LET* ((SELF NULL)) (CL:SETQ SELF (CL:MAKE-INSTANCE (CL:QUOTE 2_D_ARRAY))) (CL:SETF (%NOF-ROWS SELF) NOF-ROWS)
   (CL:SETF (%NOF-COLUMNS SELF) NOF-COLUMNS) (CL:SETF (%THE-ARRAY SELF) STELLA::NULL-NATIVE-VECTOR)
...
Missing values will be padded with NULL, extraneous values will be ignored."
  ...
  #+MCL
  (CL:CHECK-TYPE NOF-COLUMNS CL:FIXNUM)
  (CL:LET* ((ARRAY (NEW-2_D_ARRAY NOF-ROWS NOF-COLUMNS)) (NATIVEARRAY (%THE-ARRAY ARRAY)))
   (CL:DECLARE (CL:TYPE CL:SIMPLE-VECTOR NATIVEARRAY))
   (CL:LET*
    ((I NULL-INTEGER) (ITER-000 0) (UPPER-BOUND-000 (CL:1- (CL:* NOF-ROWS NOF-COLUMNS))) (VALUE NULL)
     (ITER-001 VALUES))
    (CL:DECLARE (CL:TYPE CL:FIXNUM I ITER-000 UPPER-BOUND-000))
    (CL:LOOP WHILE (CL:AND (CL:<= ITER-000 UPPER-BOUND-000) ITER-001) DO (CL:SETQ I ITER-000)
     (CL:SETQ VALUE (CL:POP ITER-001))
...
will be ignored."
  (CL:LET* ((NATIVEARRAY (%THE-ARRAY SELF))) (CL:DECLARE (CL:TYPE CL:SIMPLE-VECTOR NATIVEARRAY))
   (CL:LET*
    ((I NULL-INTEGER) (ITER-000 0) (UPPER-BOUND-000 (CL:1- (CL:* (%NOF-ROWS SELF) (%NOF-COLUMNS SELF)))) (VALUE NULL)
     (ITER-001 VALUES))
    (CL:DECLARE (CL:TYPE CL:FIXNUM I ITER-000 UPPER-BOUND-000))
    (CL:LOOP WHILE (CL:AND (CL:<= ITER-000 UPPER-BOUND-000) ITER-001) DO (CL:SETQ I ITER-000)
     (CL:SETQ VALUE (CL:POP ITER-001))
...
(CL:DEFMETHOD PRINT-ARRAY ((SELF 2_D_ARRAY) STREAM)
  ...
  (CL:LET* ((NOF-ROWS (%NOF-ROWS SELF)) (NOF-COLUMNS (%NOF-COLUMNS SELF)) (LIMIT 9))
   (CL:DECLARE (CL:TYPE CL:FIXNUM NOF-ROWS NOF-COLUMNS LIMIT)) (%%PRINT-STREAM STREAM "|i|[")
   (CL:LET* ((ROW NULL-INTEGER) (ITER-000 0) (UPPER-BOUND-000 (CL:1- NOF-ROWS)))
    ...
    (CL:LOOP WHILE (CL:<= ITER-000 UPPER-BOUND-000) DO (CL:SETQ ROW ITER-000) (%%PRINT-STREAM STREAM "[")
     (CL:LET* ((COLUMN NULL-INTEGER) (ITER-001 0) (UPPER-BOUND-001 (CL:1- NOF-COLUMNS)))
      ...
      (CL:LOOP WHILE (CL:<= ITER-001 UPPER-BOUND-001) DO (CL:SETQ COLUMN ITER-001)
       ...
       (CL:COND ((CL:> COLUMN LIMIT) (%%PRINT-STREAM STREAM " ...]") (CL:RETURN))
        ((CL:< COLUMN (CL:1- NOF-COLUMNS)) (%%PRINT-STREAM STREAM " ")) (CL:T (%%PRINT-STREAM STREAM "]")))
       (CL:SETQ ITER-001 (CL:1+ ITER-001))))
     (CL:COND ((CL:> ROW LIMIT) (%%PRINT-STREAM STREAM " ...]") (CL:RETURN))
      ((CL:< ROW (CL:1- NOF-ROWS)) (%%PRINT-STREAM STREAM " ")) (CL:T (%%PRINT-STREAM STREAM "]")))
     (CL:SETQ ITER-000 (CL:1+ ITER-000))))))
...
(CL:DEFUN NEW-FLOAT-VECTOR (ARRAY-SIZE)
  ...
  (CL:LET* ((SELF NULL)) (CL:SETQ SELF (CL:MAKE-INSTANCE (CL:QUOTE FLOAT-VECTOR)))
...
(CL:DEFUN INITIALIZE-FLOAT-VECTOR (SELF)
  (CL:LET* ((VECTOR (NEW-VECTOR (%ARRAY-SIZE SELF))))
   (CL:LET* ((I NULL-INTEGER) (ITER-000 0) (UPPER-BOUND-000 (CL:1- (LENGTH VECTOR))))
    (CL:DECLARE (CL:TYPE CL:FIXNUM I ITER-000 UPPER-BOUND-000))
    (CL:LOOP WHILE (CL:<= ITER-000 UPPER-BOUND-000) DO (CL:SETQ I ITER-000)
     (CL:LET ((SELF (%THE-ARRAY VECTOR)) (VALUE (NEW-FLOAT-WRAPPER NULL-FLOAT)) (POSITION I))
      (CL:DECLARE (CL:TYPE CL:SIMPLE-VECTOR SELF) (CL:TYPE CL:FIXNUM POSITION))
      (CL:SETF (CL:AREF SELF POSITION) VALUE))
     (CL:SETQ ITER-000 (CL:1+ ITER-000))))
   (CL:SETF (%THE-ARRAY SELF) (%THE-ARRAY VECTOR)) (CL:SETF (%THE-ARRAY VECTOR) STELLA::NULL-NATIVE-VECTOR)))
...
(CL:DEFUN CREATE-FLOAT-VECTOR (CL:&REST VALUES)
  ...
  (CL:LET* ((VECTOR (NEW-FLOAT-VECTOR (CL:LENGTH VALUES))))
   (CL:LET* ((V NULL-FLOAT) (ITER-000 VALUES) (I NULL-INTEGER) (ITER-001 0))
    ...
    (CL:LOOP WHILE ITER-000 DO (CL:SETQ V (CL:POP ITER-000)) (CL:SETQ I ITER-001)
     (CL:SETF (%WRAPPER-VALUE (CL:AREF (CL:THE CL:SIMPLE-VECTOR (%THE-ARRAY VECTOR)) I)) V)
     (CL:SETQ ITER-001 (CL:1+ ITER-001))))
   VECTOR))
  ...
  (CL:IF (CL:= (%ARRAY-SIZE SELF) 0) (%%PRINT-STREAM STREAM "|i|[]")
   (CL:LET* ((I 0) (LIMIT 9)) (CL:DECLARE (CL:TYPE CL:FIXNUM I LIMIT)) (%%PRINT-STREAM STREAM "|i|[")
    (CL:LET* ((ELEMENT NULL-FLOAT) (VECTOR-000 SELF) (INDEX-000 0) (LENGTH-000 (%ARRAY-SIZE VECTOR-000)))
     ...
     (CL:LOOP WHILE (CL:< INDEX-000 LENGTH-000) DO
      (CL:SETQ ELEMENT (%WRAPPER-VALUE (CL:AREF (CL:THE CL:SIMPLE-VECTOR (%THE-ARRAY VECTOR-000)) INDEX-000)))
      (%%PRINT-STREAM STREAM ELEMENT) (CL:SETQ I (CL:1+ I)) (CL:WHEN (CL:> I LIMIT) (CL:RETURN))
      (CL:WHEN (CL:< I (%ARRAY-SIZE SELF)) (%%PRINT-STREAM STREAM " ")) (CL:SETQ INDEX-000 (CL:1+ INDEX-000))))
    (CL:IF (CL:OR (CL:<= I LIMIT) (CL:= I (%ARRAY-SIZE SELF))) (%%PRINT-STREAM STREAM "]")
     (%%PRINT-STREAM STREAM " ...]")))))
...
(CL:DEFMETHOD MEMBER? ((SELF FLOAT-VECTOR) OBJECT)
  ...
  (CL:LET* ((ARRAY (%THE-ARRAY SELF))) (CL:DECLARE (CL:TYPE CL:SIMPLE-VECTOR ARRAY))
   (CL:LET* ((I NULL-INTEGER) (ITER-000 0) (UPPER-BOUND-000 (CL:1- (%ARRAY-SIZE SELF))))
    (CL:DECLARE (CL:TYPE CL:FIXNUM I ITER-000 UPPER-BOUND-000))
    (CL:LOOP WHILE (CL:<= ITER-000 UPPER-BOUND-000) DO (CL:SETQ I ITER-000)
     (CL:WHEN (CL:= (%WRAPPER-VALUE (CL:AREF ARRAY I)) OBJECT) (CL:RETURN-FROM MEMBER? CL:T))
     (CL:SETQ ITER-000 (CL:1+ ITER-000))))
   CL:NIL))
...
(CL:DEFUN NEW-2_D_FLOAT-ARRAY (NOF-ROWS NOF-COLUMNS)
  ...
  #+MCL
  (CL:CHECK-TYPE NOF-COLUMNS CL:FIXNUM)
  (CL:LET* ((SELF NULL)) (CL:SETQ SELF (CL:MAKE-INSTANCE (CL:QUOTE 2_D_FLOAT-ARRAY)))
   (CL:SETF (%NOF-ROWS SELF) NOF-ROWS) (CL:SETF (%NOF-COLUMNS SELF) NOF-COLUMNS)
...
Missing values will be padded with NULL, extraneous values will be ignored."
  ...
  #+MCL
  (CL:CHECK-TYPE NOF-COLUMNS CL:FIXNUM)
  (CL:LET* ((ARRAY (NEW-2_D_FLOAT-ARRAY NOF-ROWS NOF-COLUMNS)) (NATIVEARRAY (%THE-ARRAY ARRAY)))
   (CL:DECLARE (CL:TYPE CL:SIMPLE-VECTOR NATIVEARRAY))
   (CL:LET*
    ((I NULL-INTEGER) (ITER-000 0) (UPPER-BOUND-000 (CL:1- (CL:* NOF-ROWS NOF-COLUMNS))) (VALUE NULL-FLOAT)
     (ITER-001 VALUES))
    (CL:DECLARE (CL:TYPE CL:FIXNUM I ITER-000 UPPER-BOUND-000) (CL:TYPE CL:DOUBLE-FLOAT VALUE))
    (CL:LOOP WHILE (CL:AND (CL:<= ITER-000 UPPER-BOUND-000) ITER-001) DO (CL:SETQ I ITER-000)
     (CL:SETQ VALUE (CL:POP ITER-001)) (CL:SETF (%WRAPPER-VALUE (CL:AREF NATIVEARRAY I)) VALUE)
     (CL:SETQ ITER-000 (CL:1+ ITER-000))))
   ARRAY))
...
will be ignored."
  (CL:LET* ((NATIVEARRAY (%THE-ARRAY SELF))) (CL:DECLARE (CL:TYPE CL:SIMPLE-VECTOR NATIVEARRAY))
   (CL:LET*
    ((I NULL-INTEGER) (ITER-000 0) (UPPER-BOUND-000 (CL:1- (CL:* (%NOF-ROWS SELF) (%NOF-COLUMNS SELF))))
...
(CL:DEFUN HELP-STARTUP-NEURAL-NETWORK1 ()
  (CL:PROGN (CL:SETQ KWD-NEURAL-NETWORK-BACKPROP (INTERN-RIGID-SYMBOL-WRT-MODULE "BACKPROP" NULL 2))
   ...
   (CL:SETQ SYM-NEURAL-NETWORK-LOGIC-SET-TRACE-NEURAL-NETWORK-TRAINING
    (INTERN-RIGID-SYMBOL-WRT-MODULE "SET-TRACE-NEURAL-NETWORK-TRAINING" NULL 0))
   ...
   (CL:SETQ SYM-NEURAL-NETWORK-LOGIC-SET-TRAIN-CACHED-NEURAL-NETWORKS
    (INTERN-RIGID-SYMBOL-WRT-MODULE "SET-TRAIN-CACHED-NEURAL-NETWORKS" NULL 0))
   ...
   (CL:SETQ SYM-NEURAL-NETWORK-LOGIC-SET-NEURAL-NETWORK-TRAINING-METHOD
    (INTERN-RIGID-SYMBOL-WRT-MODULE "SET-NEURAL-NETWORK-TRAINING-METHOD" NULL 0))
   (CL:SETQ SYM-NEURAL-NETWORK-LOGIC-SET-ERROR-PRINT-CYCLE
    (INTERN-RIGID-SYMBOL-WRT-MODULE "SET-ERROR-PRINT-CYCLE" NULL 0))
   (CL:SETQ KWD-NEURAL-NETWORK-AND (INTERN-RIGID-SYMBOL-WRT-MODULE "AND" NULL 2))
   (CL:SETQ KWD-NEURAL-NETWORK-OR (INTERN-RIGID-SYMBOL-WRT-MODULE "OR" NULL 2))
   ...
   (CL:SETQ SYM-NEURAL-NETWORK-LOGIC-STRUCTURED-NEURAL-NETWORK-REGRESSION
    (INTERN-RIGID-SYMBOL-WRT-MODULE "STRUCTURED-NEURAL-NETWORK-REGRESSION" NULL 0))
   ...
   (CL:SETQ SYM-NEURAL-NETWORK-STELLA-ARRAY-SIZE
    (INTERN-RIGID-SYMBOL-WRT-MODULE "ARRAY-SIZE" (GET-STELLA-MODULE "/STELLA" CL:T) 0))
...
(CL:DEFUN HELP-STARTUP-NEURAL-NETWORK2 ()
  (CL:PROGN (DEFINE-STELLA-TYPE-FROM-STRINGIFIED-SOURCE "(DEFTYPE WEIGHT-VECTOR (VECTOR OF FLOAT-WRAPPER))")
   ...
   (CL:LET*
    ...
    (CL:SETF (%CLASS-SLOT-ACCESSOR-CODE CLASS) (CL:FUNCTION ACCESS-2_D_ARRAY-SLOT-VALUE)))
   (CL:LET*
    ((CLASS
    ...
    (CL:SETF (%CLASS-SLOT-ACCESSOR-CODE CLASS) (CL:FUNCTION ACCESS-FLOAT-VECTOR-SLOT-VALUE)))
   (CL:LET*
    ((CLASS
...
or a NULL number turns off periodic saving.\" :COMMAND? TRUE :PUBLIC? TRUE)" (CL:FUNCTION %SET-SAVE-NETWORK-CYCLE)
   ...
   (DEFINE-FUNCTION-OBJECT "SET-ERROR-CUTOFF" "(DEFUN SET-ERROR-CUTOFF ((F FLOAT)) :COMMAND? TRUE :PUBLIC? TRUE)"
    (CL:FUNCTION %SET-ERROR-CUTOFF) (CL:FUNCTION SET-ERROR-CUTOFF-EVALUATOR-WRAPPER))
   ...
   (DEFINE-FUNCTION-OBJECT "SET-LEARNING-RATE" "(DEFUN SET-LEARNING-RATE ((RATE FLOAT)) :COMMAND? TRUE :PUBLIC? TRUE)"
    (CL:FUNCTION %SET-LEARNING-RATE) (CL:FUNCTION SET-LEARNING-RATE-EVALUATOR-WRAPPER))
   (DEFINE-FUNCTION-OBJECT "SET-MOMENTUM-TERM" "(DEFUN SET-MOMENTUM-TERM ((M FLOAT)) :COMMAND? TRUE :PUBLIC? TRUE)"
    (CL:FUNCTION %SET-MOMENTUM-TERM) (CL:FUNCTION SET-MOMENTUM-TERM-EVALUATOR-WRAPPER))
   (DEFINE-FUNCTION-OBJECT "SET-WEIGHT-RANGE" "(DEFUN SET-WEIGHT-RANGE ((W FLOAT)) :COMMAND? TRUE :PUBLIC? TRUE)"
    (CL:FUNCTION %SET-WEIGHT-RANGE) (CL:FUNCTION SET-WEIGHT-RANGE-EVALUATOR-WRAPPER))
...
with extension `.err'.  A number <= 0 (or NULL) turns off periodic saving.\" :COMMAND? TRUE :PUBLIC? TRUE)"
    (CL:FUNCTION %SET-ERROR-PRINT-CYCLE) (CL:FUNCTION SET-ERROR-PRINT-CYCLE-EVALUATOR-WRAPPER))
   (DEFINE-FUNCTION-OBJECT "DELETE-ALL-NEURAL-NETWORKS"
    "(DEFUN DELETE-ALL-NEURAL-NETWORKS () :COMMAND? TRUE :PUBLIC? TRUE)" (CL:FUNCTION DELETE-ALL-NEURAL-NETWORKS) NULL)
   (DEFINE-FUNCTION-OBJECT "CHECK-MASTER-NETWORK-LIST"
    "(DEFUN CHECK-MASTER-NETWORK-LIST () :COMMAND? TRUE :PUBLIC? TRUE)" (CL:FUNCTION CHECK-MASTER-NETWORK-LIST) NULL)
   (DEFINE-FUNCTION-OBJECT "CLEAR-ALL-NEURAL-NETWORKS"
    "(DEFUN CLEAR-ALL-NEURAL-NETWORKS () :COMMAND? TRUE :PUBLIC? TRUE)" (CL:FUNCTION CLEAR-ALL-NEURAL-NETWORKS) NULL)
   (DEFINE-FUNCTION-OBJECT "CLEAR-ALL-SLOPES" "(DEFUN CLEAR-ALL-SLOPES ())" (CL:FUNCTION CLEAR-ALL-SLOPES) NULL)
   (DEFINE-FUNCTION-OBJECT "CLEAR-SLOPES" "(DEFUN CLEAR-SLOPES ((NET PROPOSITION-NEURAL-NETWORK)))"
    (CL:FUNCTION CLEAR-SLOPES) NULL)
   (DEFINE-FUNCTION-OBJECT "RANDOMIZE-NEURAL-NETWORK"
    "(DEFUN RANDOMIZE-NEURAL-NETWORK ((NET PROPOSITION-NEURAL-NETWORK)))" (CL:FUNCTION RANDOMIZE-NEURAL-NETWORK) NULL)
   ...
   (DEFINE-FUNCTION-OBJECT "MAKE-NET-INPUT-STRING" "(DEFUN (MAKE-NET-INPUT-STRING STRING) ((INPUT WEIGHT-VECTOR)))"
   ...
   (DEFINE-FUNCTION-OBJECT "BACKPROPAGATE-ERROR" "(DEFUN BACKPROPAGATE-ERROR ((PROP PROPOSITION) (ERROR FLOAT)))"
    (CL:FUNCTION BACKPROPAGATE-ERROR) NULL)
   (DEFINE-FUNCTION-OBJECT "QUICKPROPAGATE-ERROR" "(DEFUN QUICKPROPAGATE-ERROR ((PROP PROPOSITION) (ERROR FLOAT)))"
    (CL:FUNCTION QUICKPROPAGATE-ERROR) NULL)
   (DEFINE-FUNCTION-OBJECT "COMPUTE-ERROR" "(DEFUN (COMPUTE-ERROR FLOAT) ((TRAINING FLOAT) (OUTPUT FLOAT)))"
    (CL:FUNCTION COMPUTE-ERROR) NULL)
   (DEFINE-FUNCTION-OBJECT "COMPUTE-DELTA"
    "(DEFUN (COMPUTE-DELTA FLOAT) ((SLOPE FLOAT) (PREV-SLOPE FLOAT) (PREV-DELTA FLOAT)))" (CL:FUNCTION COMPUTE-DELTA)
    NULL)
   ...
   (DEFINE-FUNCTION-OBJECT "TEST-NEURAL-NETWORK" "(DEFUN (TEST-NEURAL-NETWORK FLOAT) () :COMMAND? TRUE :PUBLIC? TRUE)"
    (CL:FUNCTION TEST-NEURAL-NETWORK) (CL:FUNCTION TEST-NEURAL-NETWORK-EVALUATOR-WRAPPER))
   ...
   (DEFINE-FUNCTION-OBJECT "CACHED-BACKPROPAGATE-ERROR"
    "(DEFUN CACHED-BACKPROPAGATE-ERROR ((TREE CONS) (ERROR FLOAT)))" (CL:FUNCTION CACHED-BACKPROPAGATE-ERROR) NULL)
   (DEFINE-FUNCTION-OBJECT "CACHED-QUICKPROPAGATE-ERROR"
    "(DEFUN CACHED-QUICKPROPAGATE-ERROR ((TREE CONS) (ERROR FLOAT)))" (CL:FUNCTION CACHED-QUICKPROPAGATE-ERROR) NULL)
   (DEFINE-FUNCTION-OBJECT "CREATE-CACHED-NETWORK" "(DEFUN (CREATE-CACHED-NETWORK CONS) ((CONS-QUERY CONS)))"
   ...
   (DEFINE-FUNCTION-OBJECT "ACTIVATE-CACHED-NETWORK" "(DEFUN (ACTIVATE-CACHED-NETWORK FLOAT) ((TREE (CONS OF CONS))))"
    (CL:FUNCTION ACTIVATE-CACHED-NETWORK) NULL)
   (DEFINE-FUNCTION-OBJECT "RANDOM-WEIGHT" "(DEFUN (RANDOM-WEIGHT FLOAT) ((N FLOAT)))" (CL:FUNCTION RANDOM-WEIGHT)
    NULL)
...
'n' must be <= 2^15.\")" (CL:FUNCTION RANDOM-FLOAT) NULL)
   (DEFINE-FUNCTION-OBJECT "CONS-TO-VECTOR" "(DEFUN (CONS-TO-VECTOR VECTOR) ((FORM CONS)))"
   ...
   (DEFINE-FUNCTION-OBJECT "SWAP-IN-NETWORK-FILE"
    "(DEFUN SWAP-IN-NETWORK-FILE ((FILE STRING)) :COMMAND? TRUE :PUBLIC? TRUE)" (CL:FUNCTION %SWAP-IN-NETWORK-FILE)
   ...
   (DEFINE-FUNCTION-OBJECT "LOAD-NEURAL-NETWORK-FILE"
    ...
    (CL:FUNCTION %LOAD-NEURAL-NETWORK-FILE) (CL:FUNCTION LOAD-NEURAL-NETWORK-FILE-EVALUATOR-WRAPPER))
...
name will be used to perform periodic saves.\" :COMMAND? TRUE :PUBLIC? TRUE)" (CL:FUNCTION %SAVE-ALL-NEURAL-NETWORKS)
   ...
   (DEFINE-FUNCTION-OBJECT "CREATE-HIDDEN-SIGNATURE"
    "(DEFUN (CREATE-HIDDEN-SIGNATURE WEIGHT-VECTOR) ((CONS-QUERY CONS)))" (CL:FUNCTION CREATE-HIDDEN-SIGNATURE) NULL)
   (DEFINE-FUNCTION-OBJECT "INITIALIZE-2_D_ARRAY" "(DEFUN INITIALIZE-2_D_ARRAY ((SELF 2_D_ARRAY)))"
...
(CL:DEFUN HELP-STARTUP-NEURAL-NETWORK4 ()
  (CL:PROGN
   (DEFINE-FUNCTION-OBJECT "INITIALIZE-FLOAT-VECTOR" "(DEFUN INITIALIZE-FLOAT-VECTOR ((SELF FLOAT-VECTOR)))"
   ...
   (DEFINE-METHOD-OBJECT "(DEFMETHOD PRINT-VECTOR ((SELF FLOAT-VECTOR) (STREAM NATIVE-OUTPUT-STREAM)))"
   ...
   (DEFINE-METHOD-OBJECT "(DEFMETHOD (MEMBER? BOOLEAN) ((SELF FLOAT-VECTOR) (OBJECT FLOAT)))" (CL:FUNCTION MEMBER?)
    NULL)
   (DEFINE-FUNCTION-OBJECT "INITIALIZE-2_D_FLOAT-ARRAY" "(DEFUN INITIALIZE-2_D_FLOAT-ARRAY ((SELF 2_D_FLOAT-ARRAY)))"
...
will be ignored.\" :PUBLIC? TRUE)" (CL:FUNCTION FILL-ARRAY) NULL)
   (DEFINE-METHOD-OBJECT
    ...
    (CL:FUNCTION PRINT-ARRAY) NULL)
   (DEFINE-FUNCTION-OBJECT "STARTUP-NEURAL-NETWORK" "(DEFUN STARTUP-NEURAL-NETWORK () :PUBLIC? TRUE)"
    (CL:FUNCTION STARTUP-NEURAL-NETWORK) NULL)
   (CL:LET* ((FUNCTION (LOOKUP-FUNCTION SYM-NEURAL-NETWORK-LOGIC-STARTUP-NEURAL-NETWORK)))
    (SET-DYNAMIC-SLOT-VALUE (%DYNAMIC-SLOTS FUNCTION) SYM-NEURAL-NETWORK-STELLA-METHOD-STARTUP-CLASSNAME
...
(CL:DEFUN STARTUP-NEURAL-NETWORK ()
  (CL:LET* ((*MODULE* (GET-STELLA-MODULE "/LOGIC" (> *STARTUP-TIME-PHASE* 1))) (*CONTEXT* *MODULE*))
   ...
   (CL:WHEN (CURRENT-STARTUP-TIME-PHASE? 4) (CL:SETQ *NEURAL-NETWORK-TRAINING-METHOD* KWD-NEURAL-NETWORK-BACKPROP)
    (CL:SETQ *SAVE-NETWORK-FILE* STELLA::NULL-STRING)
    (CL:SETQ *SHRINK-FACTOR* (CL:/ *MAX-MOVEMENT* (CL:+ 1.0d0 *MAX-MOVEMENT*)))
    (CL:SETQ *MASTER-NEURAL-NETWORK-LIST* (NEW-LIST)) (CL:SETQ *ACTIVATED-NETWORKS* (NEW-LIST))
   ...
   (CL:WHEN (CURRENT-STARTUP-TIME-PHASE? 9) (%IN-MODULE (COPY-CONS-TREE (WRAP-STRING "LOGIC")))
    ...
    (REGISTER-NATIVE-NAME SYM-NEURAL-NETWORK-LOGIC-SET-TRACE-NEURAL-NETWORK-TRAINING KWD-NEURAL-NETWORK-COMMON-LISP
     KWD-NEURAL-NETWORK-FUNCTION)
    (REGISTER-NATIVE-NAME SYM-NEURAL-NETWORK-LOGIC-SET-SAVE-NETWORK-CYCLE KWD-NEURAL-NETWORK-COMMON-LISP
     KWD-NEURAL-NETWORK-FUNCTION)
    (REGISTER-NATIVE-NAME SYM-NEURAL-NETWORK-LOGIC-SET-ERROR-CUTOFF KWD-NEURAL-NETWORK-COMMON-LISP
     KWD-NEURAL-NETWORK-FUNCTION)
    (REGISTER-NATIVE-NAME SYM-NEURAL-NETWORK-LOGIC-SET-TRAIN-CACHED-NEURAL-NETWORKS KWD-NEURAL-NETWORK-COMMON-LISP
     KWD-NEURAL-NETWORK-FUNCTION)
    (REGISTER-NATIVE-NAME SYM-NEURAL-NETWORK-LOGIC-SET-LEARNING-RATE KWD-NEURAL-NETWORK-COMMON-LISP
     KWD-NEURAL-NETWORK-FUNCTION)
    (REGISTER-NATIVE-NAME SYM-NEURAL-NETWORK-LOGIC-SET-MOMENTUM-TERM KWD-NEURAL-NETWORK-COMMON-LISP
     KWD-NEURAL-NETWORK-FUNCTION)
    (REGISTER-NATIVE-NAME SYM-NEURAL-NETWORK-LOGIC-SET-WEIGHT-RANGE KWD-NEURAL-NETWORK-COMMON-LISP
     KWD-NEURAL-NETWORK-FUNCTION)
    (REGISTER-NATIVE-NAME SYM-NEURAL-NETWORK-LOGIC-SET-NEURAL-NETWORK-TRAINING-METHOD KWD-NEURAL-NETWORK-COMMON-LISP
     KWD-NEURAL-NETWORK-FUNCTION)
    (REGISTER-NATIVE-NAME SYM-NEURAL-NETWORK-LOGIC-SET-ERROR-PRINT-CYCLE KWD-NEURAL-NETWORK-COMMON-LISP
     KWD-NEURAL-NETWORK-FUNCTION)
    (REGISTER-NATIVE-NAME SYM-NEURAL-NETWORK-LOGIC-GNP KWD-NEURAL-NETWORK-COMMON-LISP KWD-NEURAL-NETWORK-FUNCTION)
    (REGISTER-NATIVE-NAME SYM-NEURAL-NETWORK-LOGIC-DEFNETWORK KWD-NEURAL-NETWORK-COMMON-LISP
     KWD-NEURAL-NETWORK-FUNCTION)
    (REGISTER-NATIVE-NAME SYM-NEURAL-NETWORK-LOGIC-TRAIN-NEURAL-NETWORK KWD-NEURAL-NETWORK-COMMON-LISP
     KWD-NEURAL-NETWORK-FUNCTION)
    (DEFINE-STELLA-GLOBAL-VARIABLE-FROM-STRINGIFIED-SOURCE
     "(DEFGLOBAL *PARTIAL-SUPPORT-CACHE* (LIST OF INTEGER-WRAPPER) (NEW LIST))")
    (REGISTER-NATIVE-NAME SYM-NEURAL-NETWORK-LOGIC-TRAIN-AND-TEST-NEURAL-NETWORK KWD-NEURAL-NETWORK-COMMON-LISP
     KWD-NEURAL-NETWORK-FUNCTION)
    (REGISTER-NATIVE-NAME SYM-NEURAL-NETWORK-LOGIC-MULTIPLE-NETWORK-TRAINING-RUNS KWD-NEURAL-NETWORK-COMMON-LISP
     KWD-NEURAL-NETWORK-FUNCTION)
    (DEFINE-STELLA-GLOBAL-VARIABLE-FROM-STRINGIFIED-SOURCE
     "(DEFGLOBAL *LEARNING-CURVE* (VECTOR OF FLOAT-WRAPPER) NULL)")
    (REGISTER-NATIVE-NAME SYM-NEURAL-NETWORK-LOGIC-STRUCTURED-NEURAL-NETWORK-REGRESSION KWD-NEURAL-NETWORK-COMMON-LISP
     KWD-NEURAL-NETWORK-FUNCTION)
    (REGISTER-NATIVE-NAME SYM-NEURAL-NETWORK-LOGIC-SWAP-IN-NEW-NETWORKS KWD-NEURAL-NETWORK-COMMON-LISP
     KWD-NEURAL-NETWORK-FUNCTION)
    (REGISTER-NATIVE-NAME SYM-NEURAL-NETWORK-LOGIC-SWAP-IN-NETWORK-FILE KWD-NEURAL-NETWORK-COMMON-LISP
     KWD-NEURAL-NETWORK-FUNCTION)
    (REGISTER-NATIVE-NAME SYM-NEURAL-NETWORK-LOGIC-LOAD-NEURAL-NETWORK-FILE KWD-NEURAL-NETWORK-COMMON-LISP
     KWD-NEURAL-NETWORK-FUNCTION)
    (REGISTER-NATIVE-NAME SYM-NEURAL-NETWORK-LOGIC-SAVE-ALL-NEURAL-NETWORKS KWD-NEURAL-NETWORK-COMMON-LISP
     KWD-NEURAL-NETWORK-FUNCTION)
    (REGISTER-NATIVE-NAME SYM-NEURAL-NETWORK-LOGIC-SAVE-NEURAL-NETWORK KWD-NEURAL-NETWORK-COMMON-LISP
     KWD-NEURAL-NETWORK-FUNCTION))))
