...
(CL:DECLAIM
  ...
  *TRAINING-EXAMPLES* STANDARD-ERROR TRUE *PARTIAL-SUPPORT-CACHE*
  NULL-FLOAT-WRAPPER NIL STANDARD-OUTPUT EOL NULL-INTEGER NULL-FLOAT FALSE))
...
(CL:DEFVAR *TRAIN-CACHED-NETWORKS?* FALSE)
  ...
  (CL:LET*
   ...
   (CL:LET*
    ...
    (CL:LOOP WHILE
     ...
     DO (CL:PROGN (CL:SETQ H ITER-002) (CL:SETQ ITER-002 (CL:1+ ITER-002)))
    ...
    (CL:LOOP WHILE (CL:<= ITER-001 UPPER-BOUND-001) DO
     ...
     (CL:LET*
      ...
      (CL:LOOP WHILE (CL:OR UNBOUNDED?-001 (CL:<= ITER-002 UPPER-BOUND-002))
       DO (CL:PROGN (CL:SETQ J ITER-002) (CL:SETQ ITER-002 (CL:1+ ITER-002)))
       (CL:SETQ SUM
        (CL:+ SUM
         (CL:*
          (%WRAPPER-VALUE
...
(CL:DEFUN TRAIN-UNCACHED-NEURAL-NETWORKS (CYCLES NUM-TRAINING)
  ...
  (CL:LET*
   ...
   (CL:LET*
    ...
    (CL:LOOP WHILE (CL:<= ITER-001 UPPER-BOUND-001) DO
     (CL:PROGN (CL:SETQ CYCLE ITER-001) (CL:SETQ ITER-001 (CL:1+ ITER-001)))
     (CL:SETQ MSE 0.0d0)
     (CL:COND
      ((CL:OR
    ...
    (CL:COND
     ((CL:OR (CL:EQ TEST-VALUE-000 KWD-NEURAL-NETWORK-AND)
      ...
      (CL:LET*
       ...
       (CL:DECLARE
        (CL:TYPE CL:FIXNUM INDEX-000 LENGTH-000 ITER-007 UPPER-BOUND-007 I))
       (CL:LOOP WHILE
    ...
    (CL:COND
     ((CL:OR (CL:EQ TEST-VALUE-000 KWD-NEURAL-NETWORK-AND)
      ...
      (CL:LET*
       ...
       (CL:DECLARE
        (CL:TYPE CL:FIXNUM INDEX-000 LENGTH-000 ITER-003 UPPER-BOUND-003 I))
       (CL:LOOP WHILE
      ...
      (CL:LOOP WHILE (CL:<= ITER-002 UPPER-BOUND-001) DO
       ...
       (CL:LET*
        ...
        (CL:LOOP WHILE (CL:<= ITER-003 UPPER-BOUND-002) DO
         (CL:PROGN (CL:SETQ H ITER-003) (CL:SETQ ITER-003 (CL:1+ ITER-003)))
         (CL:SETQ DELTA
          (COMPUTE-QP-DELTA
           (%WRAPPER-VALUE
            (CL:AREF (CL:THE CL:SIMPLE-VECTOR (%THE-ARRAY (%IH-SLOPE NET)))
...
(CL:DEFUN TRAIN-CACHED-NEURAL-NETWORKS (CYCLES NUM-TRAINING)
  ...
  (CL:LET*
   ...
   (CL:LET*
    ...
    (CL:LOOP WHILE (CL:<= ITER-003 UPPER-BOUND-002) DO
     (CL:PROGN (CL:SETQ CYCLE ITER-003) (CL:SETQ ITER-003 (CL:1+ ITER-003)))
  ...
  (CL:LET*
   ...
   (CL:LET*
    ((ELE NULL) (I NULL-INTEGER) (ITER-002 1)
     (UPPER-BOUND-000 (CL:1- (LENGTH (%INPUT NET)))) (ITER-003 (%%REST TREE)))
    (CL:DECLARE (CL:TYPE CL:FIXNUM ITER-002 UPPER-BOUND-000 I))
    (CL:LOOP WHILE
     (CL:AND (CL:<= ITER-002 UPPER-BOUND-000) (CL:NOT (CL:EQ ITER-003 NIL)))
     DO (CL:PROGN (CL:SETQ I ITER-002) (CL:SETQ ITER-002 (CL:1+ ITER-002)))
     ...
     (CL:LET*
      ((VALUE
        (%WRAPPER-VALUE
         (CL:AREF (CL:THE CL:SIMPLE-VECTOR (%THE-ARRAY (%INPUT NET))) I))))
      (CL:DECLARE (CL:TYPE CL:DOUBLE-FLOAT VALUE))
      (CL:WHEN (CL:NOT (CL:= VALUE TEMP)) (CL:SETQ RECURSIVE-CONFLICT? TRUE)
       (CL:RETURN)))))
     ...
     (CL:LET* ((PROOF NULL) (ITER-000 PROOFS))
      (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-000 NIL)) DO
       ...
       (CL:LET* ((FACT (%FACT PROOF)) (PROOF-TREE NIL))
        (CL:LET*
         ((SCORE NULL) (ARG NULL) (VECTOR-000 (%ARGUMENTS FACT)) (INDEX-000 0)
          (LENGTH-000 (LENGTH VECTOR-000)) (ITER-001 (%ARGUMENT-SCORES PROOF))
          (COLLECT-000 NULL))
         (CL:DECLARE (CL:TYPE CL:FIXNUM INDEX-000 LENGTH-000))
         (CL:LOOP WHILE
...
(CL:DEFUN ACTIVATE-CACHED-NETWORK (TREE)
  (CL:LET* ((SCORES (NEW-VECTOR (LENGTH TREE))) (SCORE 0.0d0) (SUM 0.0d0))
   ...
   (CL:LET* ((K NULL-INTEGER) (CACHED-NET NULL) (ITER-000 TREE) (ITER-001 0))
  ...
  (CL:LET*
   ...
   (CL:LET*
    ((VALUE NULL) (I NULL-INTEGER) (ITER-000 0)
     (UPPER-BOUND-000 (CL:1- (CL:* NOF-ROWS NOF-COLUMNS))) (ITER-001 VALUES))
    (CL:DECLARE (CL:TYPE CL:FIXNUM ITER-000 UPPER-BOUND-000 I))
...
(CL:DEFUN CREATE-FLOAT-VECTOR (CL:&REST VALUES)
  ...
  (CL:LET* ((VECTOR (NEW-FLOAT-VECTOR (CL:LENGTH VALUES))))
   (CL:LET* ((I NULL-INTEGER) (V NULL-FLOAT) (ITER-000 VALUES) (ITER-001 0))
    (CL:DECLARE (CL:TYPE CL:FIXNUM ITER-001 I) (CL:TYPE CL:DOUBLE-FLOAT V))
    (CL:LOOP WHILE ITER-000 DO (CL:SETQ V (CL:POP ITER-000))
     (CL:PROGN (CL:SETQ I ITER-001) (CL:SETQ ITER-001 (CL:1+ ITER-001)))
     (CL:SETF
      (%WRAPPER-VALUE
...
(CL:DEFUN HELP-STARTUP-NEURAL-NETWORK2 ()
  (CL:PROGN
   ...
   (CL:SETQ *TRACE-NEURAL-NETWORK-TRAINING* FALSE)
   (CL:SETQ *TRAIN-CACHED-NETWORKS?* TRUE)
...
(CL:DEFUN HELP-STARTUP-NEURAL-NETWORK5 ()
  (CL:PROGN
...
will be ignored.\" :PUBLIC? TRUE)" (CL:FUNCTION FILL-ARRAY) NULL)
   ...
   (CL:LET*
    ...
    (SET-DYNAMIC-SLOT-VALUE (%DYNAMIC-SLOTS FUNCTION)
     ...
     (WRAP-STRING "_Startup-Neural-Network") NULL-STRING-WRAPPER))))
   ...
   (CL:WHEN (CURRENT-STARTUP-TIME-PHASE? 2) (HELP-STARTUP-NEURAL-NETWORK1)
    ...
    (CL:SETQ SYM-NEURAL-NETWORK-STELLA-METHOD-STARTUP-CLASSNAME
     (INTERN-RIGID-SYMBOL-WRT-MODULE "METHOD-STARTUP-CLASSNAME"
      (GET-STELLA-MODULE "/STELLA" TRUE) 0)))
   (CL:WHEN (CURRENT-STARTUP-TIME-PHASE? 4) (HELP-STARTUP-NEURAL-NETWORK2))
   (CL:WHEN (CURRENT-STARTUP-TIME-PHASE? 5) (HELP-STARTUP-NEURAL-NETWORK3))
   (CL:WHEN (CURRENT-STARTUP-TIME-PHASE? 6) (FINALIZE-CLASSES))
   (CL:WHEN (CURRENT-STARTUP-TIME-PHASE? 7) (HELP-STARTUP-NEURAL-NETWORK4)
    (HELP-STARTUP-NEURAL-NETWORK5))
