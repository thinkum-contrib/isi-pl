  ...
  (CL:LET*
   ...
   (CL:LET*
    ...
    (CL:LOOP WHILE (CL:<= ITER-001 UPPER-BOUND-001) DO
     ...
     (CL:LET*
      ((K NULL-INTEGER) (EXAMPLE NULL) (VECTOR-000 EXAMPLES)
    ...
    (CL:COND
     ((CL:OR (CL:EQ TEST-VALUE-000 KWD-NEURAL-NETWORK-AND)
      ...
      (CL:LET*
       ...
       (CL:DECLARE
        (CL:TYPE CL:FIXNUM INDEX-000 LENGTH-000 ITER-007
         UPPER-BOUND-007 I))
       (CL:LOOP WHILE
          ...
          (CL:WHEN
           ...
           (CL:LET* ((FACT (%FACT PROOF)))
            (CL:IF (CL:= (LENGTH (%ARGUMENT-SCORES PROOF)) 1)
             ...
             (CL:LET*
              ((ARG NULL) (SCORE NULL)
               (ITER-013 (%ARGUMENT-SCORES PROOF))
              ...
              (CL:LOOP WHILE
               ...
               (SET-DYNAMIC-SLOT-VALUE (%DYNAMIC-SLOTS ARG)
                SYM-NEURAL-NETWORK-LOGIC-MATCH-SCORE
                (WRAP-FLOAT (%WRAPPER-VALUE SCORE))
                NULL-FLOAT-WRAPPER))))
          ...
          (CL:WHEN
           ...
           (CL:LET* ((FACT (%FACT PROOF)))
            (CL:IF (CL:= (LENGTH (%ARGUMENT-SCORES PROOF)) 1)
             ...
             (CL:LET*
              ((ARG NULL) (SCORE NULL)
               (ITER-006 (%ARGUMENT-SCORES PROOF))
               (VECTOR-001 (%ARGUMENTS FACT)) (INDEX-001 0)
               (LENGTH-001 (LENGTH VECTOR-001)))
              (CL:DECLARE (CL:TYPE CL:FIXNUM INDEX-001 LENGTH-001))
              (CL:LOOP WHILE
...
(CL:DEFUN CACHED-QUICKPROPAGATE-ERROR (TREE ERROR)
  ...
  (CL:LET*
   ((NET NULL) (TEMP 0.0d0) (INPUT NULL) (HIDDEN NULL)
    (INPUT-ERROR NULL) (RECURSIVE-CONFLICT? FALSE))
     ...
     (CL:LET*
      ...
      (CL:LOOP WHILE (CL:<= ITER-007 UPPER-BOUND-002) DO
       ...
       (CL:LET
        ...
        (CL:SETF (CL:AREF SELF POSITION) VALUE))))))
   (CL:LET*
    ((I NULL-INTEGER) (INPUT NULL) (ITER-008 (%%REST TREE))
     (ITER-009 1))
...
(CL:DEFUN STARTUP-NEURAL-NETWORK ()
  (CL:LET*
   ...
   (CL:WHEN (CURRENT-STARTUP-TIME-PHASE? 5)
    (HELP-STARTUP-NEURAL-NETWORK3))
   (CL:WHEN (CURRENT-STARTUP-TIME-PHASE? 6) (FINALIZE-CLASSES))
   (CL:WHEN (CURRENT-STARTUP-TIME-PHASE? 7)
    (HELP-STARTUP-NEURAL-NETWORK4) (HELP-STARTUP-NEURAL-NETWORK5))
