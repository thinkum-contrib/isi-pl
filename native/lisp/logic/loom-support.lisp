...
(CL:DECLAIM
 (CL:SPECIAL STELLA::*STARTUP-TIME-PHASE*
  ...
  STELLA::*CONTEXT* STELLA::*PL-KERNEL-MODULE* STELLA::STANDARD-OUTPUT
  STELLA::EOL STELLA::NIL))
      ...
      (CL:LET*
       ((RELATION
         (STELLA::INTERN-SYMBOL-IN-MODULE
          (STELLA::%SYMBOL-NAME (STELLA::%OPERATOR P))
      ...
      (CL:PROGN
       (CL:WHEN
        ...
        (CL:RETURN-FROM GET-INSTANCE-NAME
         (STELLA::INTERN-SYMBOL-IN-MODULE
          (STELLA::%SYMBOL-NAME (STELLA::%SURROGATE-VALUE-INVERSE INSTANCE))
          (STELLA::%HOME-CONTEXT (STELLA::%SURROGATE-VALUE-INVERSE INSTANCE))
          CL:T)))))
     ((STELLA::SUBTYPE-OF? TEST-VALUE-000 SGT-LOOM-SUPPORT-STELLA-THING)
      (CL:PROGN
       (CL:WHEN
    ...
    (CL:IF DIRECT?
     (CL:LET*
      ...
      (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-000 STELLA::NIL)) DO
       ...
       (CL:SETQ ITER-000 (STELLA::%%REST ITER-000))))
     (CL:LET*
      ((SUB STELLA::NULL) (ITER-001 (STELLA::ALL-SUBRELATIONS RELATION CL:T)))
      (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-001 STELLA::NIL)) DO
      ...
      (CL:IF (NAMED? R)
       (CL:SETQ CLAUSES
        (STELLA::CONS
         (STELLA::CONS
          (STELLA::INTERN-SYMBOL-IN-MODULE
           (STELLA::%SYMBOL-NAME (STELLA::%SURROGATE-VALUE-INVERSE R))
  ...
  (CL:LET* ((INSTANCE (STELLA::GET-INSTANCE INSTANCEREF)))
   (CL:WHEN (CL:NOT (CL:EQ INSTANCE STELLA::NULL))
    (CL:RETURN-FROM COLLECTION-MEMBERS
     (STELLA::CONSIFY (STELLA::ASSERTED-COLLECTION-MEMBERS INSTANCE CL:NIL))))
   STELLA::NIL))
...
(CL:DEFUN HELP-STARTUP-LOOM-SUPPORT1 ()
  (CL:PROGN
   ...
   (CL:SETQ SYM-LOOM-SUPPORT-LOOM-API-F-GET-LOOM-ROLES-QUERY-000
    (STELLA::INTERN-RIGID-SYMBOL-WRT-MODULE "F-GET-LOOM-ROLES-QUERY-000"
     STELLA::NULL 0))
   ...
   (CL:SETQ SYM-LOOM-SUPPORT-LOOM-API-F-GET-PARTITIONS-QUERY-000
    (STELLA::INTERN-RIGID-SYMBOL-WRT-MODULE "F-GET-PARTITIONS-QUERY-000"
     STELLA::NULL 0))
...
(CL:DEFUN STARTUP-LOOM-SUPPORT ()
  (CL:LET*
   ...
   (CL:WHEN (STELLA::CURRENT-STARTUP-TIME-PHASE? 9)
    (STELLA::%IN-MODULE
     (STELLA::COPY-CONS-TREE (STELLA::WRAP-STRING "LOOM-API")))
    (STELLA::%DEFRELATION
     (STELLA::CONS-LIST
