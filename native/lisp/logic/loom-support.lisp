...
(CL:DECLAIM
 (CL:SPECIAL STELLA::*STARTUP-TIME-PHASE* STELLA::SYSTEM-DEFINED-ARGUMENT-NAMES STELLA::*MODULE* STELLA::NULL-INTEGER
  STELLA::*CONTEXT* STELLA::*PL-KERNEL-MODULE* STELLA::STANDARD-OUTPUT STELLA::EOL STELLA::NIL))
  ...
  (CL:LET* ((TEST-VALUE-000 (STELLA::SAFE-PRIMARY-TYPE SURROGATEREF)))
   (CL:COND
    ((STELLA::SUBTYPE-OF-STRING? TEST-VALUE-000)
     (CL:PROGN (STELLA::STRING-TO-SURROGATE (STELLA::%WRAPPER-VALUE SURROGATEREF))))
    ((STELLA::SUBTYPE-OF-SURROGATE? TEST-VALUE-000) (CL:PROGN SURROGATEREF))
    ((STELLA::SUBTYPE-OF-SYMBOL? TEST-VALUE-000) (CL:PROGN (STELLA::SYMBOL-TO-SURROGATE SURROGATEREF)))
    (CL:T STELLA::NULL))))
...
(CL:DEFUN NEW-LOOM-ROLE ()
  (CL:LET* ((SELF STELLA::NULL)) (CL:SETQ SELF (CL:MAKE-INSTANCE (CL:QUOTE LOOM-ROLE)))
...
instance if one doesn't already exist."
  (CL:LET*
   ((INSTANCE (STELLA::GET-INSTANCE INSTANCEREF)) (RELATION (STELLA::GET-RELATION RELATIONREF)) (ROLE STELLA::NULL))
   (CL:WHEN (CL:OR (CL:EQ INSTANCE STELLA::NULL) (CL:EQ RELATION STELLA::NULL))
    (CL:RETURN-FROM FIND-OR-CREATE-LOOM-ROLE STELLA::NULL))
   (CL:SETQ ROLE
    (STELLA::%%VALUE
     (STELLA::APPLY-CACHED-RETRIEVE
      (STELLA::LIST* SYM-LOOM-SUPPORT-LOOM-API-?I SYM-LOOM-SUPPORT-LOOM-API-?R SYM-LOOM-SUPPORT-LOOM-API-?ROLE
       STELLA::NIL)
      (STELLA::LIST* SYM-LOOM-SUPPORT-LOOM-API-LOOM-ROLE-OF SYM-LOOM-SUPPORT-LOOM-API-?I SYM-LOOM-SUPPORT-LOOM-API-?R
       SYM-LOOM-SUPPORT-LOOM-API-?ROLE STELLA::NIL)
      (STELLA::CONS-LIST INSTANCE RELATION STELLA::NULL) (STELLA::CONS-LIST)
...
frame predicate or domain propositions inherited by 'instance'."
  (CL:LET* ((INSTANCE (STELLA::GET-INSTANCE INSTANCEREF)))
   (CL:WHEN (CL:EQ INSTANCE STELLA::NULL) (CL:RETURN-FROM GET-LOOM-ROLES STELLA::NULL))
   (CL:WHEN INFERROLES? (GET-RELATION-INDUCED-ROLES INSTANCE))
   (STELLA::APPLY-CACHED-RETRIEVE
    (STELLA::LIST* SYM-LOOM-SUPPORT-LOOM-API-?I SYM-LOOM-SUPPORT-LOOM-API-?ROLE STELLA::NIL)
...
(CL:DEFUN GET-RELATION-INDUCED-ROLES (INSTANCEREF)
  (CL:LET* ((INSTANCE (STELLA::GET-INSTANCE INSTANCEREF)) (RELATIONS STELLA::NIL) (ROLES STELLA::NIL))
   ...
   (CL:SETQ RELATIONS
    (STELLA::APPLY-CACHED-RETRIEVE
     (STELLA::LIST* SYM-LOOM-SUPPORT-LOOM-API-?R SYM-LOOM-SUPPORT-LOOM-API-?I STELLA::NIL)
     (STELLA::LIST* SYM-LOOM-SUPPORT-STELLA-OR
      (STELLA::LIST* SYM-LOOM-SUPPORT-STELLA-EXISTS
       (STELLA::LIST* SYM-LOOM-SUPPORT-LOOM-API-?FR SYM-LOOM-SUPPORT-LOOM-API-?V STELLA::NIL)
       (STELLA::LIST* SYM-LOOM-SUPPORT-STELLA-AND
        (STELLA::LIST* SYM-LOOM-SUPPORT-LOOM-API-FRAME-PREDICATE SYM-LOOM-SUPPORT-LOOM-API-?FR STELLA::NIL)
        (STELLA::LIST* SYM-LOOM-SUPPORT-PL-KERNEL-KB-HOLDS SYM-LOOM-SUPPORT-LOOM-API-?FR SYM-LOOM-SUPPORT-LOOM-API-?R
         SYM-LOOM-SUPPORT-LOOM-API-?I SYM-LOOM-SUPPORT-LOOM-API-?V STELLA::NIL)
        (STELLA::LIST* SYM-LOOM-SUPPORT-STELLA-NOT
         (STELLA::LIST* SYM-LOOM-SUPPORT-STELLA-AND
          (STELLA::LIST* SYM-LOOM-SUPPORT-STELLA-= SYM-LOOM-SUPPORT-LOOM-API-?FR
           SYM-LOOM-SUPPORT-PL-KERNEL-KB-RANGE-MAX-CARDINALITY STELLA::NIL)
          (STELLA::LIST* SYM-LOOM-SUPPORT-STELLA-= SYM-LOOM-SUPPORT-LOOM-API-?V (STELLA::WRAP-INTEGER 0) STELLA::NIL)
          STELLA::NIL)
         STELLA::NIL)
        STELLA::NIL)
       STELLA::NIL)
      (STELLA::LIST* SYM-LOOM-SUPPORT-STELLA-EXISTS (STELLA::CONS SYM-LOOM-SUPPORT-LOGIC-?C STELLA::NIL)
       (STELLA::LIST* SYM-LOOM-SUPPORT-STELLA-AND
        (STELLA::LIST* SYM-LOOM-SUPPORT-LOOM-API-INSTANCE-OF SYM-LOOM-SUPPORT-LOOM-API-?I SYM-LOOM-SUPPORT-LOGIC-?C
         STELLA::NIL)
        (STELLA::LIST* SYM-LOOM-SUPPORT-PL-KERNEL-KB-DOMAIN SYM-LOOM-SUPPORT-LOOM-API-?R SYM-LOOM-SUPPORT-LOGIC-?C
         STELLA::NIL)
        STELLA::NIL)
       STELLA::NIL)
      STELLA::NIL)
   ...
   (CL:LET* ((R STELLA::NULL) (ITER-000 RELATIONS))
    (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-000 STELLA::NIL)) DO (CL:SETQ R (STELLA::%%VALUE ITER-000))
     (CL:SETQ ROLES (STELLA::CONS (FIND-OR-CREATE-LOOM-ROLE INSTANCE R CL:T) ROLES))
...
(CL:DEFUN RELATION-OF-LOOM-ROLE (ROLE)
  ...
  (STELLA::%%VALUE
   (STELLA::APPLY-CACHED-RETRIEVE
    (STELLA::LIST* SYM-LOOM-SUPPORT-LOOM-API-?R SYM-LOOM-SUPPORT-LOOM-API-?ROLE STELLA::NIL)
...
that role on 'instanceRef'."
  (CL:LET* ((INSTANCE (STELLA::GET-INSTANCE INSTANCEREF)) (TABLE (STELLA::NEW-KEY-VALUE-LIST)))
   ...
   (CL:LET*
    ((P STELLA::NULL)
     (ITER-000
      (STELLA::CONCATENATE (STELLA::ALL-TRUE-DEPENDENT-PROPOSITIONS INSTANCE STELLA::NULL CL:T)
       (STELLA::ALL-TRUE-DEPENDENT-PROPOSITIONS INSTANCE STELLA::NULL CL:T))))
    (CL:LOOP WHILE (STELLA::NEXT? ITER-000) DO (CL:SETQ P (STELLA::%VALUE ITER-000))
     (CL:WHEN
      (CL:AND (CL:= (STELLA::LENGTH (STELLA::%ARGUMENTS P)) 2)
       (STELLA::EQL? (CL:AREF (CL:THE CL:SIMPLE-VECTOR (STELLA::%THE-ARRAY (STELLA::%ARGUMENTS P))) 0) INSTANCE))
      (CL:LET*
       ((RELATION
         (STELLA::INTERN-SYMBOL-IN-MODULE (STELLA::%SYMBOL-NAME (STELLA::%OPERATOR P))
          (STELLA::%HOME-CONTEXT (STELLA::%OPERATOR P)) CL:T))
   ...
   (CL:LET* ((RESULT STELLA::NIL))
    (CL:LET* ((KEY STELLA::NULL) (VALUE STELLA::NULL) (ITER-001 (STELLA::%THE-KV-LIST TABLE)))
     (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-001 STELLA::NULL)) DO (CL:SETQ KEY (STELLA::%KEY ITER-001))
      (CL:SETQ VALUE (STELLA::%VALUE ITER-001))
      (CL:SETQ RESULT (STELLA::CONS (STELLA::CONS KEY (STELLA::CONCATENATE VALUE STELLA::NIL)) RESULT))
...
(CL:DEFUN GET-PARENT-CONTEXTS (MODULEREF)
  ...
  (CL:LET* ((MODULE (STELLA::GET-MODULE MODULEREF)))
   (CL:IF (CL:EQ MODULE STELLA::NULL) STELLA::NULL (STELLA::CONSIFY (STELLA::%PARENT-MODULES MODULE)))))

;;; (DEFUN (GET-CHILD-CONTEXTS (CONS OF MODULE)) ...)

(CL:DEFUN GET-CHILD-CONTEXTS (MODULEREF)
  "Return a list of child modules of 'moduleRef'."
  (CL:LET* ((MODULE (STELLA::GET-MODULE MODULEREF)) (CHILDREN STELLA::NIL))
   (CL:WHEN (CL:EQ MODULE STELLA::NULL) (CL:RETURN-FROM GET-CHILD-CONTEXTS STELLA::NULL))
   (CL:LET* ((CXT STELLA::NULL) (ITER-000 (STELLA::%THE-CONS-LIST (STELLA::%CHILD-CONTEXTS MODULE))))
    (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-000 STELLA::NIL)) DO (CL:SETQ CXT (STELLA::%%VALUE ITER-000))
     (CL:WHEN (STELLA::ISA? CXT SGT-LOOM-SUPPORT-STELLA-MODULE) (CL:SETQ CHILDREN (STELLA::CONS CXT CHILDREN)))
     (CL:SETQ ITER-000 (STELLA::%%REST ITER-000))))
   CHILDREN))
...
or NULL if it is not context sensitive."
  (CL:LET* ((INSTANCE (STELLA::GET-INSTANCE INSTANCEREF)))
   (CL:WHEN (CL:EQ INSTANCE STELLA::NULL) (CL:RETURN-FROM CONTEXT-OF-INSTANCE STELLA::NULL))
   (CL:COND
    ((STELLA::SUBTYPE-OF? (STELLA::SAFE-PRIMARY-TYPE INSTANCE) SGT-LOOM-SUPPORT-LOGIC-LOGIC-OBJECT)
...
(CL:DEFUN CLEAR-USER-CONTEXTS ()
  ...
  (CL:LET* ((MDL STELLA::NULL) (ITER-000 (STELLA::ALL-MODULES)))
   (CL:LOOP WHILE (STELLA::NEXT? ITER-000) DO (CL:SETQ MDL (STELLA::%VALUE ITER-000))
    (CL:WHEN
     (CL:AND (STELLA::CLEARABLE? MDL) (CL:NOT (STELLA::MEMBER? (STELLA::CONS-LIST STELLA::*PL-KERNEL-MODULE*) MDL)))
     (STELLA::%%PRINT-STREAM (STELLA::%NATIVE-STREAM STELLA::STANDARD-OUTPUT) "Clearing: " MDL EOL)
     (STELLA::CALL-CLEAR-MODULE (STELLA::CONS-LIST MDL))))))

;;; (DEFUN (LIST-CONTEXT CONS) ...)

(CL:DEFUN LIST-CONTEXT (CONTEXT VALUES)
  (CL:LET* ((STELLA::*CONTEXT* CONTEXT) (STELLA::*MODULE* (STELLA::%BASE-MODULE STELLA::*CONTEXT*)))
   ...
   (CL:COND ((CL:EQ VALUES KWD-LOOM-SUPPORT-ALL) (STELLA::CONSIFY (STELLA::ALL-NAMED-TERMS CONTEXT CL:NIL)))
    ((CL:EQ VALUES KWD-LOOM-SUPPORT-CONCEPTS)
     (STELLA::APPLY-CACHED-RETRIEVE (STELLA::CONS SYM-LOOM-SUPPORT-LOGIC-?X STELLA::NIL)
      (STELLA::LIST* SYM-LOOM-SUPPORT-PL-KERNEL-KB-CLASS SYM-LOOM-SUPPORT-LOGIC-?X STELLA::NIL)
      (STELLA::CONS-LIST STELLA::NULL) (STELLA::CONS-LIST) SYM-LOOM-SUPPORT-LOOM-API-F-LIST-CONTEXT-QUERY-000))
    ((CL:EQ VALUES KWD-LOOM-SUPPORT-RELATIONS)
     (STELLA::APPLY-CACHED-RETRIEVE (STELLA::CONS SYM-LOOM-SUPPORT-LOGIC-?X STELLA::NIL)
      (STELLA::LIST* SYM-LOOM-SUPPORT-STELLA-AND
       (STELLA::LIST* SYM-LOOM-SUPPORT-PL-KERNEL-KB-RELATION SYM-LOOM-SUPPORT-LOGIC-?X STELLA::NIL)
       (STELLA::LIST* SYM-LOOM-SUPPORT-LOGIC-FAIL
        (STELLA::LIST* SYM-LOOM-SUPPORT-PL-KERNEL-KB-CLASS SYM-LOOM-SUPPORT-LOGIC-?X STELLA::NIL) STELLA::NIL)
       STELLA::NIL)
    ...
    (CL:T
     (CL:LET* ((STREAM-000 (STELLA::NEW-OUTPUT-STRING-STREAM)))
      (STELLA::%%PRINT-STREAM (STELLA::%NATIVE-STREAM STREAM-000) "`" VALUES "' is not a valid case option")
  ...
  (CL:LET* ((RELATION (STELLA::GET-RELATION RELATIONREF)))
   (CL:IF (CL:NOT (CL:EQ RELATION STELLA::NULL))
    (CL:LET* ((TEST-VALUE-000 (STELLA::SAFE-PRIMARY-TYPE RELATION)))
     (CL:COND
      ((STELLA::SUBTYPE-OF? TEST-VALUE-000 SGT-LOOM-SUPPORT-LOGIC-DESCRIPTION) (CL:PROGN (STELLA::ARITY RELATION)))
...
by 'module'.  'instanceRef' can be a string, symbol, or surrogate."
  (CL:LET* ((INSTANCE (STELLA::COERCE-TO-INSTANCE-IN-MODULE INSTANCEREF MODULE LOCAL? STELLA::NULL)))
...
'instanceRef'."
  (CL:COND ((CL:EQ INSTANCEREF STELLA::NULL) STELLA::NULL)
   ((STELLA::ISA? INSTANCEREF SGT-LOOM-SUPPORT-STELLA-SURROGATE)
    (CL:IF (CL:EQ (STELLA::%SURROGATE-VALUE INSTANCEREF) STELLA::NULL) STELLA::NULL INSTANCEREF))
   (CL:T
    (CL:LET* ((INSTANCE (STELLA::GET-INSTANCE INSTANCEREF)))
     (CL:WHEN (CL:EQ INSTANCE STELLA::NULL) (CL:RETURN-FROM GET-INSTANCE-SURROGATE STELLA::NULL))
     (CL:LET* ((TEST-VALUE-000 (STELLA::SAFE-PRIMARY-TYPE INSTANCE)))
      (CL:COND
       ((STELLA::SUBTYPE-OF? TEST-VALUE-000 SGT-LOOM-SUPPORT-LOGIC-LOGIC-OBJECT)
        (CL:PROGN
         (CL:IF (CL:NOT (CL:EQ INSTANCE STELLA::NULL)) (STELLA::%SURROGATE-VALUE-INVERSE INSTANCE) STELLA::NULL)))
      ...
      (CL:PROGN
       (CL:WHEN
        (CL:AND (CL:NOT (CL:EQ INSTANCE STELLA::NULL))
         (CL:NOT (CL:EQ (STELLA::%SURROGATE-VALUE-INVERSE INSTANCE) STELLA::NULL)))
     ...
     (CL:WHEN (STELLA::NAMED-DESCRIPTION? E)
      (CL:IF (CL:EQ COLLECT-000 STELLA::NULL)
       (CL:PROGN (CL:SETQ COLLECT-000 (STELLA::CONS (STELLA::DESCRIPTION-NAME E) STELLA::NIL))
        (CL:IF (CL:EQ EQUIVALENTNAMES STELLA::NIL) (CL:SETQ EQUIVALENTNAMES COLLECT-000)
         (STELLA::ADD-CONS-TO-END-OF-CONS-LIST EQUIVALENTNAMES COLLECT-000)))
       (CL:PROGN (CL:SETF (STELLA::%%REST COLLECT-000) (STELLA::CONS (STELLA::DESCRIPTION-NAME E) STELLA::NIL))
...
name of an instance, and does not denote a relation, class, or set."
  (CL:LET* ((STELLA::*SUPPRESSNONLOGICOBJECTWARNING?* CL:T))
   ...
   (CL:LET* ((INSTANCE (STELLA::GET-INSTANCE OBJECT)))
    (CL:AND (CL:NOT (CL:EQ INSTANCE STELLA::NULL)) (CL:NOT (STELLA::COLLECTION? INSTANCE))))))
  ...
  (CL:LET* ((CLASSTYPE (GET-INSTANCE-SURROGATE CLASSREF)) (SURROGATE (SAFE-SURROGATIFY INSTANCEREF)))
   (CL:IF
    (CL:AND (STELLA::CLASS? CLASSTYPE)
     (CL:OR (CL:EQ INSTANCEREF STELLA::NULL) (CL:NOT (CL:EQ SURROGATE STELLA::NULL))))
  ...
  (CL:LET* ((INSTANCE (STELLA::GET-INSTANCE INSTANCEREF)) (CLASSTYPE (GET-INSTANCE-SURROGATE CLASSREF)))
   (CL:COND
    ((CL:NOT (CL:EQ INSTANCE STELLA::NULL))
     (CL:IF (CL:OR (CL:EQ CLASSREF STELLA::NULL) (INSTANCE-OF? INSTANCE CLASSTYPE)) INSTANCE STELLA::NULL))
...
belongs to the class referenced by 'classRef'."
  (CL:LET* ((INSTANCE (STELLA::GET-INSTANCE INSTANCEREF)) (CLASSTYPE (GET-INSTANCE-SURROGATE CLASSREF)))
   (CL:AND (CL:NOT (CL:EQ INSTANCE STELLA::NULL)) (CL:NOT (CL:EQ CLASSTYPE STELLA::NULL))
...
is an instance of the class referenced by 'classRef'."
  (CL:LET* ((INSTANCE (STELLA::GET-INSTANCE INSTANCEREF)) (CLASSTYPE (GET-INSTANCE-SURROGATE CLASSREF)))
   (CL:WHEN (CL:AND (CL:NOT (CL:EQ INSTANCE STELLA::NULL)) (STELLA::CLASS? CLASSTYPE))
    (STELLA::UPDATE-ISA-PROPOSITION INSTANCE CLASSTYPE KWD-LOOM-SUPPORT-ASSERT-TRUE))))
...
is an instance of the class referenced by 'classRef'."
  (CL:LET* ((INSTANCE (STELLA::GET-INSTANCE INSTANCEREF)) (CLASSTYPE (GET-INSTANCE-SURROGATE CLASSREF)))
   (CL:WHEN (CL:AND (CL:NOT (CL:EQ INSTANCE STELLA::NULL)) (STELLA::CLASS? CLASSTYPE))
    (STELLA::UPDATE-ISA-PROPOSITION INSTANCE CLASSTYPE KWD-LOOM-SUPPORT-RETRACT-TRUE))))
...
(CL:DEFUN GET-TYPES (INSTANCEREF DIRECTORASSERTED)
  ...
  (CL:LET* ((INSTANCE (STELLA::GET-INSTANCE INSTANCEREF)) (RESULT STELLA::NIL))
   (CL:WHEN (CL:EQ INSTANCE STELLA::NULL) (CL:RETURN-FROM GET-TYPES STELLA::NULL))
   (CL:COND
    ((CL:EQ DIRECTORASSERTED KWD-LOOM-SUPPORT-DIRECT)
     (CL:LET* ((D STELLA::NULL) (ITER-000 (STELLA::ALL-DIRECT-TYPES INSTANCE)))
      (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-000 STELLA::NIL)) DO (CL:SETQ D (STELLA::%%VALUE ITER-000))
       (CL:SETQ RESULT (STELLA::CONS D RESULT)) (CL:SETQ ITER-000 (STELLA::%%REST ITER-000)))))
    ((CL:EQ DIRECTORASSERTED KWD-LOOM-SUPPORT-ASSERTED)
     (CL:LET* ((D STELLA::NULL) (ITER-001 (STELLA::ALL-ASSERTED-TYPES INSTANCE)))
      (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-001 STELLA::NIL)) DO (CL:SETQ D (STELLA::%%VALUE ITER-001))
       (CL:SETQ RESULT (STELLA::CONS D RESULT)) (CL:SETQ ITER-001 (STELLA::%%REST ITER-001)))))
    (CL:T
     (CL:LET* ((D STELLA::NULL) (ITER-002 (STELLA::ALL-TYPES INSTANCE)))
      (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-002 STELLA::NIL)) DO (CL:SETQ D (STELLA::%%VALUE ITER-002))
       (CL:SETQ RESULT (STELLA::CONS D RESULT)) (CL:SETQ ITER-002 (STELLA::%%REST ITER-002))))))
   RESULT))
...
or retract if 'assert?' is FALSE."
  (CL:LET*
   ((INSTANCE (STELLA::GET-INSTANCE INSTANCEREF)) (RELATION (STELLA::GET-RELATION RELATIONREF))
    (VALUE (STELLA::GET-INSTANCE VALUEREF)))
   (CL:WHEN
    (CL:AND (CL:NOT (CL:EQ INSTANCE STELLA::NULL)) (CL:NOT (CL:EQ RELATION STELLA::NULL))
     (CL:= (RELATION-ARITY RELATION) 2) (CL:NOT (CL:EQ VALUE STELLA::NULL)))
...
'relationRef' applied to 'instanceRef'."
  (CL:LET* ((DEFAULTVALUES STELLA::NULL))
   (CL:LET*
    ((STELLA::*CONTEXT* (STELLA::GET-INFERENCE-CACHE STELLA::*MODULE* KWD-LOOM-SUPPORT-DEFAULT))
     (STELLA::*MODULE* (STELLA::%BASE-MODULE STELLA::*CONTEXT*)))
    (CL:DECLARE (CL:SPECIAL STELLA::*CONTEXT* STELLA::*MODULE*))
    (CL:SETQ DEFAULTVALUES (GET-ROLE-VALUES INSTANCEREF RELATIONREF)))
   (CL:LET*
    ((STELLA::*CONTEXT* (STELLA::GET-INFERENCE-CACHE STELLA::*MODULE* KWD-LOOM-SUPPORT-STRICT))
     (STELLA::*MODULE* (STELLA::%BASE-MODULE STELLA::*CONTEXT*)))
    (CL:DECLARE (CL:SPECIAL STELLA::*CONTEXT* STELLA::*MODULE*))
    (CL:LET* ((V STELLA::NULL) (ITER-000 (GET-ROLE-VALUES INSTANCEREF RELATIONREF)))
     (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-000 STELLA::NIL)) DO (CL:SETQ V (STELLA::%%VALUE ITER-000))
      (CL:SETQ DEFAULTVALUES (STELLA::REMOVE DEFAULTVALUES V)) (CL:SETQ ITER-000 (STELLA::%%REST ITER-000)))))
   DEFAULTVALUES))
       ...
       (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-000 STELLA::NIL)) DO (CL:SETQ I (STELLA::%%VALUE ITER-000))
        ...
        (CL:LET* ((S STELLA::NULL) (ITER-001 DIRECTSUBS))
         (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-001 STELLA::NIL)) DO (CL:SETQ S (STELLA::%%VALUE ITER-001))
          (CL:WHEN (INSTANCE-OF? I S) (CL:SETQ INSTANCE-OF-SUB? CL:T) (CL:RETURN))
          (CL:SETQ ITER-001 (STELLA::%%REST ITER-001))))
        (CL:WHEN (CL:NOT INSTANCE-OF-SUB?) (CL:SETQ DIRECTINSTANCES (STELLA::CONS I DIRECTINSTANCES)))
        (CL:SETQ ITER-000 (STELLA::%%REST ITER-000))))
      DIRECTINSTANCES)
...
Side-effect: Upclassify 'subrelationRef'."
  (CL:LET*
   ((SUBRELATION (STELLA::GET-RELATION SUBRELATIONREF))
    (SUBRELATIONTYPE
     (CL:IF (CL:NOT (CL:EQ SUBRELATION STELLA::NULL)) (STELLA::%SURROGATE-VALUE-INVERSE SUBRELATION) STELLA::NULL))
   ...
   (CL:WHEN (STELLA::RELATION? RELATION)
    (CL:IF DIRECT?
     (CL:LET* ((SUPER STELLA::NULL) (ITER-000 (STELLA::ALL-DIRECT-SUPERRELATIONS RELATION CL:T)))
      (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-000 STELLA::NIL)) DO (CL:SETQ SUPER (STELLA::%%VALUE ITER-000))
       (CL:SETQ RESULT (STELLA::CONS SUPER RESULT)) (CL:SETQ ITER-000 (STELLA::%%REST ITER-000))))
     (CL:LET* ((SUPER STELLA::NULL) (ITER-001 (STELLA::ALL-SUPERRELATIONS RELATION CL:T)))
      (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-001 STELLA::NIL)) DO (CL:SETQ SUPER (STELLA::%%VALUE ITER-001))
       (CL:SETQ RESULT (STELLA::CONS SUPER RESULT)) (CL:SETQ ITER-001 (STELLA::%%REST ITER-001))))))
   RESULT))
   ...
   (CL:WHEN (STELLA::RELATION? RELATION)
    (CL:IF DIRECT?
     (CL:LET* ((SUB STELLA::NULL) (ITER-000 (STELLA::ALL-DIRECT-SUBRELATIONS RELATION CL:T)))
      (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-000 STELLA::NIL)) DO (CL:SETQ SUB (STELLA::%%VALUE ITER-000))
       (CL:SETQ RESULT (STELLA::CONS SUB RESULT)) (CL:SETQ ITER-000 (STELLA::%%REST ITER-000))))
     (CL:LET* ((SUB STELLA::NULL) (ITER-001 (STELLA::ALL-SUBRELATIONS RELATION CL:T)))
      (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-001 STELLA::NIL)) DO (CL:SETQ SUB (STELLA::%%VALUE ITER-001))
       (CL:SETQ RESULT (STELLA::CONS SUB RESULT)) (CL:SETQ ITER-001 (STELLA::%%REST ITER-001))))))
   RESULT))
    ...
    (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-000 STELLA::NIL)) DO (CL:SETQ R (STELLA::%%VALUE ITER-000))
     (CL:IF (CL:EQ COLLECT-000 STELLA::NULL)
      (CL:PROGN (CL:SETQ COLLECT-000 (STELLA::CONS (STELLA::GET-RELATION R) STELLA::NIL))
       (CL:IF (CL:EQ RELATIONS STELLA::NIL) (CL:SETQ RELATIONS COLLECT-000)
        (STELLA::ADD-CONS-TO-END-OF-CONS-LIST RELATIONS COLLECT-000)))
      (CL:PROGN (CL:SETF (STELLA::%%REST COLLECT-000) (STELLA::CONS (STELLA::GET-RELATION R) STELLA::NIL))
       (CL:SETQ COLLECT-000 (STELLA::%%REST COLLECT-000))))
     (CL:SETQ ITER-000 (STELLA::%%REST ITER-000))))
   (CL:SETQ RELATIONS (STELLA::REMOVE-DUPLICATES RELATIONS))
   (CL:WHEN (CL:EQ (STELLA::%%REST RELATIONS) STELLA::NIL) (CL:RETURN-FROM MOST-SPECIFIC-RELATIONS RELATIONS))
      ...
      (CL:LET* ((YOUNGESTRELATION (STELLA::%%VALUE RELATIONS)))
       (CL:LET* ((R STELLA::NULL) (ITER-001 (STELLA::%%REST RELATIONS)))
        (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-001 STELLA::NIL)) DO (CL:SETQ R (STELLA::%%VALUE ITER-001))
         (CL:WHEN (CL:> (STELLA::INTRODUCTION-TIMESTAMP R) (STELLA::INTRODUCTION-TIMESTAMP YOUNGESTRELATION))
       ...
       (CL:LET* ((R STELLA::NULL) (ITER-002 RELATIONS))
        (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-002 STELLA::NIL)) DO (CL:SETQ R (STELLA::%%VALUE ITER-002))
         (CL:WHEN (CL:NOT (STELLA::UPCLASSIFIED-LATER-THAN? R YOUNGESTRELATION))
...
of relations in 'relationRefs'."
  (CL:LET* ((RELATIONS STELLA::NIL) (CONJUNCTIONDESCRIPTION STELLA::NULL))
   ...
   (CL:WHEN (CL:EQ (STELLA::%%REST RELATIONS) STELLA::NIL)
    (CL:RETURN-FROM COMPUTE-CONJUNCTION-RELATION (STELLA::%%VALUE RELATIONS)))
   (CL:LET* ((CLAUSES STELLA::NIL) (VARIABLES STELLA::NIL))
    (CL:LET*
     ((V STELLA::NULL) (ITER-001 STELLA::SYSTEM-DEFINED-ARGUMENT-NAMES)
      (I (STELLA::INTERVAL 1 (RELATION-ARITY (STELLA::%%VALUE RELATIONS)))) (COLLECT-001 STELLA::NULL))
     (CL:LOOP WHILE (CL:AND (CL:NOT (CL:EQ ITER-001 STELLA::NIL)) (STELLA::NEXT? I)) DO
      (CL:SETQ V (STELLA::%%VALUE ITER-001))
      (CL:IF (CL:EQ COLLECT-001 STELLA::NULL)
       (CL:PROGN (CL:SETQ COLLECT-001 (STELLA::CONS V STELLA::NIL))
        (CL:IF (CL:EQ VARIABLES STELLA::NIL) (CL:SETQ VARIABLES COLLECT-001)
         (STELLA::ADD-CONS-TO-END-OF-CONS-LIST VARIABLES COLLECT-001)))
       (CL:PROGN (CL:SETF (STELLA::%%REST COLLECT-001) (STELLA::CONS V STELLA::NIL))
     ...
     (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-002 STELLA::NIL)) DO (CL:SETQ R (STELLA::%%VALUE ITER-002))
      (CL:IF (NAMED? R)
       (CL:SETQ CLAUSES
        (STELLA::CONS
         (STELLA::CONS
          (STELLA::INTERN-SYMBOL-IN-MODULE (STELLA::%SYMBOL-NAME (STELLA::%SURROGATE-VALUE-INVERSE R))
           (STELLA::%HOME-CONTEXT (STELLA::%SURROGATE-VALUE-INVERSE R)) CL:T)
          (STELLA::CONCATENATE (STELLA::COPY-CONS-LIST VARIABLES) STELLA::NIL))
         CLAUSES))
       (CL:SETQ CLAUSES
        (STELLA::CONS (STELLA::%%VALUE (STELLA::%%REST (STELLA::%%REST (STELLA::GENERATE-EXPRESSION R CL:T))))
         CLAUSES)))
      (CL:SETQ ITER-002 (STELLA::%%REST ITER-002))))
   ...
   (CL:LET* ((SUPERS STELLA::NULL) (SUBS STELLA::NULL) (EQUIVALENTS STELLA::NULL))
    ...
    (CL:IF (CL:NOT (CL:EQ EQUIVALENTS STELLA::NIL)) (STELLA::%%VALUE EQUIVALENTS) CONJUNCTIONDESCRIPTION))))
...
(CL:DEFUN GET-DOMAIN (RELATIONREF)
  ...
  (CL:LET* ((RELATION (STELLA::GET-RELATION RELATIONREF)))
   (CL:WHEN (CL:EQ RELATION STELLA::NULL) (CL:RETURN-FROM GET-DOMAIN STELLA::NULL))
   (STELLA::%%VALUE
    (STELLA::APPLY-CACHED-RETRIEVE
     (STELLA::LIST* SYM-LOOM-SUPPORT-LOOM-API-?D SYM-LOOM-SUPPORT-LOOM-API-?R STELLA::NIL)
     (STELLA::LIST* SYM-LOOM-SUPPORT-PL-KERNEL-KB-DOMAIN SYM-LOOM-SUPPORT-LOOM-API-?R SYM-LOOM-SUPPORT-LOOM-API-?D
      STELLA::NIL)
     (STELLA::CONS-LIST STELLA::NULL RELATION) (STELLA::CONS-LIST) SYM-LOOM-SUPPORT-LOOM-API-F-GET-DOMAIN-QUERY-000))))
...
(CL:DEFUN GET-RANGE (RELATIONREF)
  ...
  (CL:LET* ((RELATION (STELLA::GET-RELATION RELATIONREF)))
   (CL:WHEN (CL:EQ RELATION STELLA::NULL) (CL:RETURN-FROM GET-RANGE STELLA::NULL))
   (STELLA::%%VALUE
    (STELLA::APPLY-CACHED-RETRIEVE
     (STELLA::LIST* SYM-LOOM-SUPPORT-LOOM-API-?D SYM-LOOM-SUPPORT-LOOM-API-?R STELLA::NIL)
     (STELLA::LIST* SYM-LOOM-SUPPORT-PL-KERNEL-KB-RANGE SYM-LOOM-SUPPORT-LOOM-API-?R SYM-LOOM-SUPPORT-LOOM-API-?D
      STELLA::NIL)
     (STELLA::CONS-LIST STELLA::NULL RELATION) (STELLA::CONS-LIST) SYM-LOOM-SUPPORT-LOOM-API-F-GET-RANGE-QUERY-000))))
...
and assert it or retract it."
  (STELLA::UPDATE-PROPOSITION (STELLA::TRANSLATE-LOOM-SENTENCE-TO-KIF LOOMSENTENCE)
   (CL:IF RETRACT? KWD-LOOM-SUPPORT-RETRACT-TRUE KWD-LOOM-SUPPORT-ASSERT-TRUE)))
...
(CL:DEFUN DELETE-INSTANCE (INSTANCEREF)
  ...
  (CL:LET* ((INSTANCE (STELLA::GET-INSTANCE INSTANCEREF)))
   (CL:WHEN (CL:NOT (CL:EQ INSTANCE STELLA::NULL)) (STELLA::DESTROY-TERM INSTANCE))))
     ...
     (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-000 STELLA::NIL)) DO (CL:SETQ C (STELLA::%%VALUE ITER-000))
      (CL:LET*
       ((MDC STELLA::NULL)
        (ITER-001
         (STELLA::APPLY-CACHED-RETRIEVE
          (STELLA::LIST* SYM-LOOM-SUPPORT-LOGIC-?C SYM-LOOM-SUPPORT-LOGIC-?MDC STELLA::NIL)
          (STELLA::LIST* SYM-LOOM-SUPPORT-STELLA-AND
           (STELLA::LIST* SYM-LOOM-SUPPORT-PL-KERNEL-KB-MEMBER-OF SYM-LOOM-SUPPORT-LOGIC-?C SYM-LOOM-SUPPORT-LOGIC-?MDC
            STELLA::NIL)
           (STELLA::LIST* SYM-LOOM-SUPPORT-PL-KERNEL-KB-MUTUALLY-DISJOINT-COLLECTION SYM-LOOM-SUPPORT-LOGIC-?MDC
            STELLA::NIL)
           STELLA::NIL)
       ...
       (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-001 STELLA::NIL)) DO (CL:SETQ MDC (STELLA::%%VALUE ITER-001))
        (CL:WHEN (CL:NOT (STELLA::MEMBER? PARTITIONS MDC)) (CL:SETQ PARTITIONS (STELLA::CONS MDC PARTITIONS)))
        (CL:SETQ ITER-001 (STELLA::%%REST ITER-001))))
      (CL:SETQ ITER-000 (STELLA::%%REST ITER-000)))))
   PARTITIONS))
...
disjoint."
  (CL:LET* ((RELATION1 (STELLA::GET-RELATION RELATIONREF1)) (RELATION2 (STELLA::GET-RELATION RELATIONREF2)))
  ...
  (CL:LET* ((MDC (STELLA::GET-INSTANCE INSTANCEREF)) (COVEREDCLASS (STELLA::GET-CLASS CLASSREF)))
   (CL:WHEN
    (CL:OR (CL:EQ MDC STELLA::NULL)
     (CL:NOT (STELLA::TEST-PROPERTY? MDC SGT-LOOM-SUPPORT-PL-KERNEL-KB-MUTUALLY-DISJOINT-COLLECTION)))
    (CL:RETURN-FROM COVERING? CL:NIL))
   (CL:LET*
    ((C
      (STELLA::ALLOCATE-ITERATOR
       (STELLA::APPLY-CACHED-RETRIEVE
        (STELLA::LIST* SYM-LOOM-SUPPORT-LOGIC-?MDC SYM-LOOM-SUPPORT-LOOM-API-?COVERED STELLA::NIL)
        (STELLA::LIST* SYM-LOOM-SUPPORT-PL-KERNEL-KB-COVERING SYM-LOOM-SUPPORT-LOGIC-?MDC
...
(CL:DEFUN COLLECTION-MEMBERS (INSTANCEREF)
  ...
  (CL:LET* ((INSTANCE (STELLA::GET-INSTANCE INSTANCEREF)))
   (CL:WHEN (CL:NOT (CL:EQ INSTANCE STELLA::NULL))
    (CL:RETURN-FROM COLLECTION-MEMBERS (STELLA::CONSIFY (STELLA::ASSERTED-COLLECTION-MEMBERS INSTANCE CL:NIL))))
   STELLA::NIL))

(CL:DEFUN HELP-STARTUP-LOOM-SUPPORT1 ()
  (CL:PROGN
   (CL:SETQ SGT-LOOM-SUPPORT-LOOM-API-LOOM-ROLE (STELLA::INTERN-RIGID-SYMBOL-WRT-MODULE "LOOM-ROLE" STELLA::NULL 1))
   (CL:SETQ SYM-LOOM-SUPPORT-LOOM-API-LOOM-ROLE-OF
    (STELLA::INTERN-RIGID-SYMBOL-WRT-MODULE "LOOM-ROLE-OF" STELLA::NULL 0))
   ...
   (CL:SETQ SGT-LOOM-SUPPORT-LOOM-API-LOOM-ROLE-OF
    (STELLA::INTERN-RIGID-SYMBOL-WRT-MODULE "LOOM-ROLE-OF" STELLA::NULL 1))
   ...
   (CL:SETQ SYM-LOOM-SUPPORT-LOOM-API-F-GET-LOOM-ROLES-QUERY-000
    (STELLA::INTERN-RIGID-SYMBOL-WRT-MODULE "F-GET-LOOM-ROLES-QUERY-000" STELLA::NULL 0))
   (CL:SETQ SYM-LOOM-SUPPORT-STELLA-OR
    (STELLA::INTERN-RIGID-SYMBOL-WRT-MODULE "OR" (STELLA::GET-STELLA-MODULE "/STELLA" CL:T) 0))
   ...
   (CL:SETQ SYM-LOOM-SUPPORT-LOOM-API-FRAME-PREDICATE
    (STELLA::INTERN-RIGID-SYMBOL-WRT-MODULE "FRAME-PREDICATE" STELLA::NULL 0))
   (CL:SETQ SYM-LOOM-SUPPORT-PL-KERNEL-KB-HOLDS
    (STELLA::INTERN-RIGID-SYMBOL-WRT-MODULE "HOLDS" (STELLA::GET-STELLA-MODULE "/PL-KERNEL-KB" CL:T) 0))
   (CL:SETQ SYM-LOOM-SUPPORT-STELLA-NOT
    (STELLA::INTERN-RIGID-SYMBOL-WRT-MODULE "NOT" (STELLA::GET-STELLA-MODULE "/STELLA" CL:T) 0))
   (CL:SETQ SYM-LOOM-SUPPORT-STELLA-=
    (STELLA::INTERN-RIGID-SYMBOL-WRT-MODULE "=" (STELLA::GET-STELLA-MODULE "/STELLA" CL:T) 0))
   (CL:SETQ SYM-LOOM-SUPPORT-PL-KERNEL-KB-RANGE-MAX-CARDINALITY
    (STELLA::INTERN-RIGID-SYMBOL-WRT-MODULE "RANGE-MAX-CARDINALITY" (STELLA::GET-STELLA-MODULE "/PL-KERNEL-KB" CL:T)
     0))
   (CL:SETQ SYM-LOOM-SUPPORT-LOGIC-?C
    (STELLA::INTERN-RIGID-SYMBOL-WRT-MODULE "?C" (STELLA::GET-STELLA-MODULE "/LOGIC" CL:T) 0))
   (CL:SETQ SYM-LOOM-SUPPORT-LOOM-API-INSTANCE-OF
    (STELLA::INTERN-RIGID-SYMBOL-WRT-MODULE "INSTANCE-OF" STELLA::NULL 0))
   (CL:SETQ SYM-LOOM-SUPPORT-PL-KERNEL-KB-DOMAIN
    (STELLA::INTERN-RIGID-SYMBOL-WRT-MODULE "DOMAIN" (STELLA::GET-STELLA-MODULE "/PL-KERNEL-KB" CL:T) 0))
   ...
   (CL:SETQ SYM-LOOM-SUPPORT-LOOM-API-F-RELATION-OF-LOOM-ROLE-QUERY-000
    (STELLA::INTERN-RIGID-SYMBOL-WRT-MODULE "F-RELATION-OF-LOOM-ROLE-QUERY-000" STELLA::NULL 0))
   ...
   (CL:SETQ SYM-LOOM-SUPPORT-LOGIC-?X
    (STELLA::INTERN-RIGID-SYMBOL-WRT-MODULE "?X" (STELLA::GET-STELLA-MODULE "/LOGIC" CL:T) 0))
   (CL:SETQ SYM-LOOM-SUPPORT-PL-KERNEL-KB-CLASS
    (STELLA::INTERN-RIGID-SYMBOL-WRT-MODULE "CLASS" (STELLA::GET-STELLA-MODULE "/PL-KERNEL-KB" CL:T) 0))
   (CL:SETQ SYM-LOOM-SUPPORT-LOOM-API-F-LIST-CONTEXT-QUERY-000
    (STELLA::INTERN-RIGID-SYMBOL-WRT-MODULE "F-LIST-CONTEXT-QUERY-000" STELLA::NULL 0))
   ...
   (CL:SETQ SYM-LOOM-SUPPORT-PL-KERNEL-KB-RELATION
    (STELLA::INTERN-RIGID-SYMBOL-WRT-MODULE "RELATION" (STELLA::GET-STELLA-MODULE "/PL-KERNEL-KB" CL:T) 0))
   ...
   (CL:SETQ SYM-LOOM-SUPPORT-LOOM-API-F-LIST-CONTEXT-QUERY-001
    (STELLA::INTERN-RIGID-SYMBOL-WRT-MODULE "F-LIST-CONTEXT-QUERY-001" STELLA::NULL 0))
   ...
   (CL:SETQ SGT-LOOM-SUPPORT-PL-KERNEL-KB-ARITY
    (STELLA::INTERN-RIGID-SYMBOL-WRT-MODULE "ARITY" (STELLA::GET-STELLA-MODULE "/PL-KERNEL-KB" CL:T) 1))
   (CL:SETQ SGT-LOOM-SUPPORT-LOGIC-DESCRIPTION
    (STELLA::INTERN-RIGID-SYMBOL-WRT-MODULE "DESCRIPTION" (STELLA::GET-STELLA-MODULE "/LOGIC" CL:T) 1))
   (CL:SETQ SGT-LOOM-SUPPORT-STELLA-SURROGATE
    (STELLA::INTERN-RIGID-SYMBOL-WRT-MODULE "SURROGATE" (STELLA::GET-STELLA-MODULE "/STELLA" CL:T) 1))
   (CL:SETQ SGT-LOOM-SUPPORT-STELLA-THING
    (STELLA::INTERN-RIGID-SYMBOL-WRT-MODULE "THING" (STELLA::GET-STELLA-MODULE "/STELLA" CL:T) 1))
   ...
   (CL:SETQ SYM-LOOM-SUPPORT-LOGIC-KAPPA
    (STELLA::INTERN-RIGID-SYMBOL-WRT-MODULE "KAPPA" (STELLA::GET-STELLA-MODULE "/LOGIC" CL:T) 0))
   ...
   (CL:SETQ SYM-LOOM-SUPPORT-LOOM-API-F-GET-DOMAIN-QUERY-000
    (STELLA::INTERN-RIGID-SYMBOL-WRT-MODULE "F-GET-DOMAIN-QUERY-000" STELLA::NULL 0))
   (CL:SETQ SYM-LOOM-SUPPORT-PL-KERNEL-KB-RANGE
    (STELLA::INTERN-RIGID-SYMBOL-WRT-MODULE "RANGE" (STELLA::GET-STELLA-MODULE "/PL-KERNEL-KB" CL:T) 0))
   (CL:SETQ SYM-LOOM-SUPPORT-LOOM-API-F-GET-RANGE-QUERY-000
    (STELLA::INTERN-RIGID-SYMBOL-WRT-MODULE "F-GET-RANGE-QUERY-000" STELLA::NULL 0))
   (CL:SETQ SYM-LOOM-SUPPORT-LOGIC-?MDC
    (STELLA::INTERN-RIGID-SYMBOL-WRT-MODULE "?MDC" (STELLA::GET-STELLA-MODULE "/LOGIC" CL:T) 0))
   (CL:SETQ SYM-LOOM-SUPPORT-PL-KERNEL-KB-MEMBER-OF
    (STELLA::INTERN-RIGID-SYMBOL-WRT-MODULE "MEMBER-OF" (STELLA::GET-STELLA-MODULE "/PL-KERNEL-KB" CL:T) 0))
   (CL:SETQ SYM-LOOM-SUPPORT-PL-KERNEL-KB-MUTUALLY-DISJOINT-COLLECTION
    (STELLA::INTERN-RIGID-SYMBOL-WRT-MODULE "MUTUALLY-DISJOINT-COLLECTION"
     (STELLA::GET-STELLA-MODULE "/PL-KERNEL-KB" CL:T) 0))
   (CL:SETQ SYM-LOOM-SUPPORT-LOOM-API-F-GET-PARTITIONS-QUERY-000
    (STELLA::INTERN-RIGID-SYMBOL-WRT-MODULE "F-GET-PARTITIONS-QUERY-000" STELLA::NULL 0))
   ...
   (CL:SETQ SYM-LOOM-SUPPORT-PL-KERNEL-KB-COVERING
    (STELLA::INTERN-RIGID-SYMBOL-WRT-MODULE "COVERING" (STELLA::GET-STELLA-MODULE "/PL-KERNEL-KB" CL:T) 0))))

(CL:DEFUN HELP-STARTUP-LOOM-SUPPORT2 ()
  (CL:PROGN
   (STELLA::DEFINE-FUNCTION-OBJECT "SAFE-SURROGATIFY" "(DEFUN (SAFE-SURROGATIFY SURROGATE) ((SURROGATEREF OBJECT)))"
...
'inferRoles', create roles on the fly corresponding to
frame predicate or domain propositions inherited by 'instance'.\" :PUBLIC? TRUE)" (CL:FUNCTION GET-LOOM-ROLES)
    STELLA::NULL)
...
or NULL if it is not context sensitive.\")" (CL:FUNCTION CONTEXT-OF-INSTANCE) STELLA::NULL)
   ...
   (STELLA::DEFINE-FUNCTION-OBJECT "LIST-CONTEXT" "(DEFUN (LIST-CONTEXT CONS) ((CONTEXT MODULE) (VALUES KEYWORD)))"
...
the module 'module'.  If 'local?' is FALSE, also search modules inherited
by 'module'.  'instanceRef' can be a string, symbol, or surrogate.\" :PUBLIC? TRUE)" (CL:FUNCTION FIND-CLASS)
    STELLA::NULL)
...
the module 'module'.  If 'local?' is FALSE, also search modules inherited
by 'module'.  'instanceRef' can be a string, symbol, or surrogate.\" :PUBLIC? TRUE)" (CL:FUNCTION FIND-RELATION)
    STELLA::NULL)
...
name of an instance, and does not denote a relation, class, or set.\" :PUBLIC? TRUE)" (CL:FUNCTION INDIVIDUAL?)
    STELLA::NULL)
...
of type 'classRef', or create one of type 'classRef'.\" :PUBLIC? TRUE)" (CL:FUNCTION FIND-OR-CREATE-INSTANCE)
    STELLA::NULL)
...
Does not include relations equivalent to 'relationRef'.\" :PUBLIC? TRUE)" (CL:FUNCTION GET-SUPERRELATIONS)
    STELLA::NULL)
...
the range of relation 'relationRef' applied to 'instanceRef'.\" :PUBLIC? TRUE)" (CL:FUNCTION GET-MIN-CARDINALITY)
    STELLA::NULL)
...
the range of relation 'relationRef' applied to 'instanceRef'.\" :PUBLIC? TRUE)" (CL:FUNCTION GET-MAX-CARDINALITY)
    STELLA::NULL)
...
the range of relation 'relationRef' applied to 'instanceRef'.\" :PUBLIC? TRUE)" (CL:FUNCTION GET-VALUE-RESTRICTION)
    STELLA::NULL)
...
some concept.\")" (CL:FUNCTION COVERING?) STELLA::NULL)
   ...
   (STELLA::DEFINE-FUNCTION-OBJECT "STARTUP-LOOM-SUPPORT" "(DEFUN STARTUP-LOOM-SUPPORT () :PUBLIC? TRUE)"
   ...
   (CL:LET* ((FUNCTION (STELLA::LOOKUP-FUNCTION SYM-LOOM-SUPPORT-LOOM-API-STARTUP-LOOM-SUPPORT)))
    (STELLA::SET-DYNAMIC-SLOT-VALUE (STELLA::%DYNAMIC-SLOTS FUNCTION) SYM-LOOM-SUPPORT-STELLA-METHOD-STARTUP-CLASSNAME
     (STELLA::WRAP-STRING "_StartupLoomSupport") STELLA::NULL-STRING-WRAPPER))))

(CL:DEFUN STARTUP-LOOM-SUPPORT ()
  (CL:LET*
   ((STELLA::*MODULE* (STELLA::GET-STELLA-MODULE "/PL-KERNEL-KB/LOOM-API" (STELLA::> STELLA::*STARTUP-TIME-PHASE* 1)))
   ...
   (CL:WHEN (STELLA::CURRENT-STARTUP-TIME-PHASE? 2) (HELP-STARTUP-LOOM-SUPPORT1)
    (CL:SETQ SYM-LOOM-SUPPORT-LOOM-API-F-COVERING?-QUERY-000
     (STELLA::INTERN-RIGID-SYMBOL-WRT-MODULE "F-COVERING?-QUERY-000" STELLA::NULL 0))
    (CL:SETQ SYM-LOOM-SUPPORT-LOOM-API-STARTUP-LOOM-SUPPORT
     (STELLA::INTERN-RIGID-SYMBOL-WRT-MODULE "STARTUP-LOOM-SUPPORT" STELLA::NULL 0))
   ...
   (CL:WHEN (STELLA::CURRENT-STARTUP-TIME-PHASE? 5)
    (CL:LET*
     ((CLASS
       (STELLA::DEFINE-CLASS-FROM-STRINGIFIED-SOURCE "LOOM-ROLE" "(DEFCLASS LOOM-ROLE (THING) :DOCUMENTATION \"\")")))
   ...
   (CL:WHEN (STELLA::CURRENT-STARTUP-TIME-PHASE? 7) (HELP-STARTUP-LOOM-SUPPORT2))
   ...
   (CL:WHEN (STELLA::CURRENT-STARTUP-TIME-PHASE? 9)
    (STELLA::%IN-MODULE (STELLA::COPY-CONS-TREE (STELLA::WRAP-STRING "LOOM-API")))
    (STELLA::%DEFRELATION
     (STELLA::CONS-LIST (STELLA::COPY-CONS-TREE SYM-LOOM-SUPPORT-LOOM-API-LOOM-ROLE-OF)
      (STELLA::COPY-CONS-TREE
       (STELLA::GET-QUOTED-TREE "(((?C CLASS) (?R RELATION) (?ROLE LOOM-ROLE)) \"/PL-KERNEL-KB/LOOM-API\")"
        "/PL-KERNEL-KB/LOOM-API"))
      KWD-LOOM-SUPPORT-DOCUMENTATION (STELLA::COPY-CONS-TREE (STELLA::WRAP-STRING "")) KWD-LOOM-SUPPORT-AXIOMS
      (STELLA::COPY-CONS-TREE
       (STELLA::GET-QUOTED-TREE "((SINGLE-VALUED LOOM-ROLE-OF) \"/PL-KERNEL-KB/LOOM-API\")"
        "/PL-KERNEL-KB/LOOM-API")))))))
