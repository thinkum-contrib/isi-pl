...
(CL:DECLAIM
 (CL:SPECIAL STELLA::*STARTUP-TIME-PHASE*
  ...
  STELLA::NULL-INTEGER STELLA::*CONTEXT* STELLA::FALSE
  STELLA::*PL-KERNEL-MODULE* STELLA::STANDARD-OUTPUT STELLA::EOL
  STELLA::TRUE STELLA::NIL))
...
plus the names of any equivalent relations."
  (CL:LET*
   ...
   (CL:LET*
    ((E STELLA::NULL)
     (ITER-000
      (STELLA::ALL-EQUIVALENT-COLLECTIONS RELATION STELLA::TRUE))
      ...
      ((INSTANCES (STELLA::ALL-CLASS-INSTANCES CLASSTYPE))
       ...
       (DIRECTSUBS
        (STELLA::ALL-DIRECT-SUBRELATIONS
         (STELLA::GET-INSTANCE CLASSREF) STELLA::TRUE))
       ...
       (CL:SETQ CLAUSES
        (STELLA::CONS
         (STELLA::%%VALUE
          (STELLA::%%REST
           (STELLA::%%REST
            (STELLA::GENERATE-EXPRESSION R STELLA::TRUE))))
         CLAUSES)))))
...
specify disjointness of children of the class classRef'."
  (CL:LET*
   ...
   (CL:WHEN (CL:NOT (CL:EQ CLASS STELLA::NULL))
    (CL:LET*
     ((C STELLA::NULL)
      (ITER-000 (GET-SUBRELATIONS CLASS STELLA::TRUE)))
     (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-000 STELLA::NIL)) DO
