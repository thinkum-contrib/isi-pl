...
(CL:DEFVAR SYM-LOOM-SUPPORT-LOOM-API-QUERY-072 STELLA::NULL)
(CL:DEFVAR SGT-LOOM-SUPPORT-LOOM-API-LOOM-ROLE-OF STELLA::NULL)
(CL:DEFVAR SYM-LOOM-SUPPORT-STELLA-EXISTS STELLA::NULL)
(CL:DEFVAR SYM-LOOM-SUPPORT-LOOM-API-QUERY-073 STELLA::NULL)
...
(CL:DEFVAR SYM-LOOM-SUPPORT-LOOM-API-RANGE-MAX-CARDINALITY STELLA::NULL)
...
(CL:DEFVAR SYM-LOOM-SUPPORT-LOOM-API-QUERY-074 STELLA::NULL)
(CL:DEFVAR SYM-LOOM-SUPPORT-LOOM-API-QUERY-075 STELLA::NULL)
...
(CL:DEFVAR SYM-LOOM-SUPPORT-LOOM-API-QUERY-076 STELLA::NULL)
...
(CL:DEFVAR SYM-LOOM-SUPPORT-LOOM-API-QUERY-077 STELLA::NULL)
...
(CL:DEFVAR SYM-LOOM-SUPPORT-LOOM-API-QUERY-078 STELLA::NULL)
(CL:DEFVAR SYM-LOOM-SUPPORT-PL-KERNEL-KB-RANGE STELLA::NULL)
(CL:DEFVAR SYM-LOOM-SUPPORT-LOOM-API-QUERY-079 STELLA::NULL)
(CL:DEFVAR SYM-LOOM-SUPPORT-LOGIC-?MDC STELLA::NULL)
(CL:DEFVAR SYM-LOOM-SUPPORT-PL-KERNEL-KB-MEMBER-OF STELLA::NULL)
(CL:DEFVAR SYM-LOOM-SUPPORT-LOGIC-MUTUALLY-DISJOINT-COLLECTION STELLA::NULL)
(CL:DEFVAR SYM-LOOM-SUPPORT-LOOM-API-QUERY-080 STELLA::NULL)
...
(CL:DEFVAR SYM-LOOM-SUPPORT-LOOM-API-QUERY-081 STELLA::NULL)
...
(CL:DECLAIM
 (CL:SPECIAL STELLA::*STARTUP-TIME-PHASE*
  STELLA::SYSTEM-DEFINED-ARGUMENT-NAMES STELLA::*MODULE* STELLA::NULL-INTEGER
  STELLA::*CONTEXT* STELLA::FALSE STELLA::*PL-KERNEL-MODULE*
  STELLA::STANDARD-OUTPUT STELLA::EOL STELLA::TRUE STELLA::NIL))
  ...
  (CL:LET* ((TEST-VALUE-000 (STELLA::SAFE-PRIMARY-TYPE SURROGATEREF)))
   (CL:COND
    ((STELLA::SUBTYPE-OF-STRING? TEST-VALUE-000)
     (CL:PROGN
      (STELLA::STRING-TO-SURROGATE (STELLA::%WRAPPER-VALUE SURROGATEREF))))
...
(CL:DEFUN ACCESS-LOOM-ROLE-SLOT-VALUE (SELF SLOTNAME VALUE SETVALUE?)
  (CL:COND
   (CL:T
    (CL:IF SETVALUE?
     (STELLA::SET-DYNAMIC-SLOT-VALUE (STELLA::%DYNAMIC-SLOTS SELF) SLOTNAME
      VALUE STELLA::NULL)
   ...
   (CL:SETQ ROLE
    (STELLA::%%VALUE
     (STELLA::APPLY-CACHED-RETRIEVE
      (STELLA::LIST* SYM-LOOM-SUPPORT-LOOM-API-?I SYM-LOOM-SUPPORT-LOOM-API-?R
      ...
      SYM-LOOM-SUPPORT-LOOM-API-QUERY-072)))
...
frame predicate or domain propositions inherited by 'instance'."
  (CL:LET* ((INSTANCE (STELLA::GET-INSTANCE INSTANCEREF)))
   ...
   (STELLA::APPLY-CACHED-RETRIEVE
    ...
    SYM-LOOM-SUPPORT-LOOM-API-QUERY-073)))

;;; (DEFUN (GET-RELATION-INDUCED-ROLES (CONS OF LOOM-ROLE)) ...)

(CL:DEFUN GET-RELATION-INDUCED-ROLES (INSTANCEREF)
  (CL:LET*
   ((INSTANCE (STELLA::GET-INSTANCE INSTANCEREF)) (RELATIONS STELLA::NIL)
    (ROLES STELLA::NIL))
   (CL:WHEN (CL:EQ INSTANCE STELLA::NULL)
    (CL:RETURN-FROM GET-RELATION-INDUCED-ROLES STELLA::NULL))
   (CL:SETQ RELATIONS
    (STELLA::APPLY-CACHED-RETRIEVE
     (STELLA::LIST* SYM-LOOM-SUPPORT-LOOM-API-?R SYM-LOOM-SUPPORT-LOOM-API-?I
      STELLA::NIL)
        ...
        (STELLA::LIST* SYM-LOOM-SUPPORT-STELLA-NOT
         (STELLA::LIST* SYM-LOOM-SUPPORT-STELLA-AND
          (STELLA::LIST* SYM-LOOM-SUPPORT-STELLA-=
           ...
           SYM-LOOM-SUPPORT-LOOM-API-RANGE-MAX-CARDINALITY STELLA::NIL)
          (STELLA::LIST* SYM-LOOM-SUPPORT-STELLA-=
           SYM-LOOM-SUPPORT-LOOM-API-?V (STELLA::WRAP-INTEGER 0) STELLA::NIL)
          STELLA::NIL)
         STELLA::NIL)
        STELLA::NIL)
       STELLA::NIL)
      (STELLA::LIST* SYM-LOOM-SUPPORT-STELLA-EXISTS
       ...
       (STELLA::LIST* SYM-LOOM-SUPPORT-STELLA-AND
        (STELLA::LIST* SYM-LOOM-SUPPORT-LOOM-API-INSTANCE-OF
         SYM-LOOM-SUPPORT-LOOM-API-?I SYM-LOOM-SUPPORT-LOGIC-?C STELLA::NIL)
        (STELLA::LIST* SYM-LOOM-SUPPORT-PL-KERNEL-KB-DOMAIN
         SYM-LOOM-SUPPORT-LOOM-API-?R SYM-LOOM-SUPPORT-LOGIC-?C STELLA::NIL)
        STELLA::NIL)
       STELLA::NIL)
      STELLA::NIL)
     (STELLA::CONS-LIST STELLA::NULL INSTANCE) (STELLA::CONS-LIST)
     SYM-LOOM-SUPPORT-LOOM-API-QUERY-074))
   (CL:LET* ((R STELLA::NULL) (ITER-000 RELATIONS))
    (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-000 STELLA::NIL)) DO
     (CL:PROGN (CL:SETQ R (STELLA::%%VALUE ITER-000))
      (CL:SETQ ITER-000 (STELLA::%%REST ITER-000)))
     (CL:SETQ ROLES
      (STELLA::CONS (FIND-OR-CREATE-LOOM-ROLE INSTANCE R STELLA::TRUE)
       ROLES))))
   ROLES))
...
(CL:DEFUN RELATION-OF-LOOM-ROLE (ROLE)
  ...
  (STELLA::%%VALUE
   (STELLA::APPLY-CACHED-RETRIEVE
    ...
    SYM-LOOM-SUPPORT-LOOM-API-QUERY-075)))
    ...
    (CL:LOOP WHILE (STELLA::NEXT? ITER-000) DO
     ...
     (CL:WHEN
      (CL:AND (CL:= (STELLA::LENGTH (STELLA::%ARGUMENTS P)) 2)
       (STELLA::EQL?
        (CL:AREF
         (CL:THE CL:SIMPLE-VECTOR (STELLA::%THE-ARRAY (STELLA::%ARGUMENTS P)))
         0)
        INSTANCE))
      (CL:LET*
...
(CL:DEFUN GET-CHILD-CONTEXTS (MODULEREF)
  ...
  (CL:LET* ((MODULE (STELLA::GET-MODULE MODULEREF)) (CHILDREN STELLA::NIL))
   ...
   (CL:LET*
    ...
    (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-000 STELLA::NIL)) DO
     (CL:PROGN (CL:SETQ CXT (STELLA::%%VALUE ITER-000))
      (CL:SETQ ITER-000 (STELLA::%%REST ITER-000)))
   ...
   (CL:LOOP WHILE (STELLA::NEXT? ITER-000) DO
    ...
    (CL:WHEN
     (CL:AND (STELLA::CLEARABLE? MDL)
      (CL:NOT
       (STELLA::MEMBER? (STELLA::CONS-LIST STELLA::*PL-KERNEL-MODULE*) MDL)))
  ...
  (CL:LET*
   ...
   (CL:COND
    ((CL:EQ VALUES KWD-LOOM-SUPPORT-ALL)
     (STELLA::CONSIFY (STELLA::ALL-NAMED-TERMS CONTEXT STELLA::FALSE)))
    ((CL:EQ VALUES KWD-LOOM-SUPPORT-CONCEPTS)
     (STELLA::APPLY-CACHED-RETRIEVE
      ...
      SYM-LOOM-SUPPORT-LOOM-API-QUERY-076))
    ((CL:EQ VALUES KWD-LOOM-SUPPORT-RELATIONS)
     (STELLA::APPLY-CACHED-RETRIEVE
      ...
      (STELLA::LIST* SYM-LOOM-SUPPORT-STELLA-AND
       ...
       STELLA::NIL)
      (STELLA::CONS-LIST STELLA::NULL) (STELLA::CONS-LIST)
      SYM-LOOM-SUPPORT-LOOM-API-QUERY-077))
    ((CL:EQ VALUES KWD-LOOM-SUPPORT-INSTANCES)
     (STELLA::CONSIFY (STELLA::ALL-INSTANCES CONTEXT STELLA::FALSE)))
    (CL:T
     (CL:LET* ((STREAM-000 (STELLA::NEW-OUTPUT-STRING-STREAM)))
      (STELLA::%%PRINT-STREAM (STELLA::%NATIVE-STREAM STREAM-000) "`" VALUES
  ...
  (CL:LET* ((RELATION (STELLA::GET-RELATION RELATIONREF)))
   (CL:IF (CL:NOT (CL:EQ RELATION STELLA::NULL))
    (CL:LET* ((TEST-VALUE-000 (STELLA::SAFE-PRIMARY-TYPE RELATION)))
     (CL:COND
      ((STELLA::SUBTYPE-OF? TEST-VALUE-000 SGT-LOOM-SUPPORT-LOGIC-DESCRIPTION)
      ...
      (CL:PROGN
       (CL:WHEN
        (CL:AND (CL:NOT (CL:EQ INSTANCE STELLA::NULL))
         (CL:NOT
          (CL:EQ (STELLA::%SURROGATE-VALUE-INVERSE INSTANCE) STELLA::NULL)))
...
plus the names of any equivalent relations."
  (CL:LET*
   ...
   (CL:LET*
    ((E STELLA::NULL)
     (ITER-000 (STELLA::ALL-EQUIVALENT-COLLECTIONS RELATION STELLA::TRUE))
     (COLLECT-000 STELLA::NULL))
    (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-000 STELLA::NIL)) DO
     (CL:PROGN (CL:SETQ E (STELLA::%%VALUE ITER-000))
      (CL:SETQ ITER-000 (STELLA::%%REST ITER-000)))
...
name of an instance."
  (CL:LET* ((STELLA::*SUPPRESSNONLOGICOBJECTWARNING?* STELLA::TRUE))
  ...
  (CL:LET*
   ...
   (CL:COND
    ((CL:NOT (CL:EQ INSTANCE STELLA::NULL))
     (CL:IF
      (CL:OR (CL:EQ CLASSREF STELLA::NULL) (INSTANCE-OF? INSTANCE CLASSTYPE))
...
is an instance of the class referenced by 'classRef'."
  (CL:LET*
   ((INSTANCE (STELLA::GET-INSTANCE INSTANCEREF))
    (CLASSTYPE (GET-INSTANCE-SURROGATE CLASSREF)))
   (CL:WHEN
    (CL:AND (CL:NOT (CL:EQ INSTANCE STELLA::NULL)) (STELLA::CLASS? CLASSTYPE))
...
or retract if 'assert?' is FALSE."
  (CL:LET*
   ...
   (CL:WHEN
    (CL:AND (CL:NOT (CL:EQ INSTANCE STELLA::NULL))
     (CL:NOT (CL:EQ RELATION STELLA::NULL)) (CL:= (RELATION-ARITY RELATION) 2)
...
(CL:DEFUN ADD-ROLE-VALUE (INSTANCEREF RELATIONREF VALUEREF)
  "Assert the tuple '(relationRef instanceRef valueRef)'."
  (UPDATE-ROLE-VALUE INSTANCEREF RELATIONREF VALUEREF STELLA::TRUE))
...
(CL:DEFUN REMOVE-ROLE-VALUE (INSTANCEREF RELATIONREF VALUEREF)
  ...
  (UPDATE-ROLE-VALUE INSTANCEREF RELATIONREF VALUEREF STELLA::FALSE))
  ...
  (CL:LET*
   ...
   (CL:IF
    (CL:AND (CL:NOT (CL:EQ INSTANCE STELLA::NULL))
     (CL:NOT (CL:EQ RELATION STELLA::NULL))
     (CL:= (RELATION-ARITY RELATION) 2))
    (STELLA::ALL-SLOT-VALUES INSTANCE (GET-INSTANCE-SURROGATE RELATION))
    STELLA::NULL)))
...
'relationRef' applied to 'instanceRef'."
  (CL:LET* ((DEFAULTVALUES STELLA::NULL))
   (CL:LET*
    ((STELLA::*CONTEXT*
      (STELLA::GET-INFERENCE-CACHE STELLA::*MODULE* KWD-LOOM-SUPPORT-DEFAULT))
     (STELLA::*MODULE* (STELLA::%BASE-MODULE STELLA::*CONTEXT*)))
    (CL:DECLARE (CL:SPECIAL STELLA::*CONTEXT* STELLA::*MODULE*))
    (CL:SETQ DEFAULTVALUES (GET-ROLE-VALUES INSTANCEREF RELATIONREF)))
   (CL:LET*
    ((STELLA::*CONTEXT*
      (STELLA::GET-INFERENCE-CACHE STELLA::*MODULE* KWD-LOOM-SUPPORT-STRICT))
     (STELLA::*MODULE* (STELLA::%BASE-MODULE STELLA::*CONTEXT*)))
    (CL:DECLARE (CL:SPECIAL STELLA::*CONTEXT* STELLA::*MODULE*))
    (CL:LET*
     ((V STELLA::NULL) (ITER-000 (GET-ROLE-VALUES INSTANCEREF RELATIONREF)))
     (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-000 STELLA::NIL)) DO
      (CL:PROGN (CL:SETQ V (STELLA::%%VALUE ITER-000))
       (CL:SETQ ITER-000 (STELLA::%%REST ITER-000)))
    ...
    (CL:IF DIRECT?
     (CL:LET*
      ((INSTANCES (STELLA::ALL-CLASS-INSTANCES CLASSTYPE))
       ...
       (DIRECTSUBS
        (STELLA::ALL-DIRECT-SUBRELATIONS (STELLA::GET-INSTANCE CLASSREF)
         STELLA::TRUE))
       (INSTANCE-OF-SUB? STELLA::FALSE))
      (CL:LET* ((I STELLA::NULL) (ITER-000 INSTANCES))
       (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-000 STELLA::NIL)) DO
        (CL:PROGN (CL:SETQ I (STELLA::%%VALUE ITER-000))
         (CL:SETQ ITER-000 (STELLA::%%REST ITER-000)))
        (CL:SETQ INSTANCE-OF-SUB? STELLA::FALSE)
        (CL:LET* ((S STELLA::NULL) (ITER-001 DIRECTSUBS))
         (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-001 STELLA::NIL)) DO
          (CL:PROGN (CL:SETQ S (STELLA::%%VALUE ITER-001))
           (CL:SETQ ITER-001 (STELLA::%%REST ITER-001)))
          (CL:WHEN (INSTANCE-OF? I S) (CL:SETQ INSTANCE-OF-SUB? STELLA::TRUE)
           (CL:RETURN))))
...
Side-effect: Upclassify 'subrelationRef'."
  (CL:LET*
   ...
   (CL:IF
    ...
    (CL:PROGN (STELLA::FIND-DIRECT-SUPERS-AND-SUBS SUBRELATION STELLA::TRUE)
  ...
  (CL:LET*
   ...
   (CL:WHEN (STELLA::RELATION? RELATION)
    (CL:IF DIRECT?
     (CL:LET*
      ((SUPER STELLA::NULL)
       (ITER-000 (STELLA::ALL-DIRECT-SUPERRELATIONS RELATION STELLA::TRUE)))
      (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-000 STELLA::NIL)) DO
       (CL:PROGN (CL:SETQ SUPER (STELLA::%%VALUE ITER-000))
        (CL:SETQ ITER-000 (STELLA::%%REST ITER-000)))
       (CL:SETQ RESULT (STELLA::CONS SUPER RESULT))))
     (CL:LET*
      ((SUPER STELLA::NULL)
       (ITER-001 (STELLA::ALL-SUPERRELATIONS RELATION STELLA::TRUE)))
      (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-001 STELLA::NIL)) DO
       (CL:PROGN (CL:SETQ SUPER (STELLA::%%VALUE ITER-001))
        (CL:SETQ ITER-001 (STELLA::%%REST ITER-001)))
       (CL:SETQ RESULT (STELLA::CONS SUPER RESULT))))))
   RESULT))
  ...
  (CL:LET*
   ...
   (CL:WHEN (STELLA::RELATION? RELATION)
    (CL:IF DIRECT?
     (CL:LET*
      ((SUB STELLA::NULL)
       (ITER-000 (STELLA::ALL-DIRECT-SUBRELATIONS RELATION STELLA::TRUE)))
      (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-000 STELLA::NIL)) DO
       (CL:PROGN (CL:SETQ SUB (STELLA::%%VALUE ITER-000))
        (CL:SETQ ITER-000 (STELLA::%%REST ITER-000)))
       (CL:SETQ RESULT (STELLA::CONS SUB RESULT))))
     (CL:LET*
      ((SUB STELLA::NULL)
       (ITER-001 (STELLA::ALL-SUBRELATIONS RELATION STELLA::TRUE)))
      (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-001 STELLA::NIL)) DO
       (CL:PROGN (CL:SETQ SUB (STELLA::%%VALUE ITER-001))
        (CL:SETQ ITER-001 (STELLA::%%REST ITER-001)))
       (CL:SETQ RESULT (STELLA::CONS SUB RESULT))))))
   RESULT))
...
all relations are classified before filtering for most-specific."
  (CL:LET* ((RELATIONS STELLA::NIL))
   (CL:LET*
    ((R STELLA::NULL) (ITER-000 RELATIONREFS) (COLLECT-000 STELLA::NULL))
    (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-000 STELLA::NIL)) DO
     (CL:PROGN (CL:SETQ R (STELLA::%%VALUE ITER-000))
      (CL:SETQ ITER-000 (STELLA::%%REST ITER-000)))
     (CL:IF (CL:EQ COLLECT-000 STELLA::NULL)
   ...
   (CL:WHEN CLASSIFYFIRST?
    (CL:LET*
     ((STELLA::*CLASSIFICATIONSESSION*
       (STELLA::GET-CLASSIFICATION-SESSION KWD-LOOM-SUPPORT-DESCRIPTION)))
     ...
     (CL:LET* ((STELLA::*CONTEXT* (STELLA::GET-CLASSIFICATION-WORLD)))
      ...
      (CL:LET* ((YOUNGESTRELATION (STELLA::%%VALUE RELATIONS)))
       (CL:LET* ((R STELLA::NULL) (ITER-001 (STELLA::%%REST RELATIONS)))
        (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-001 STELLA::NIL)) DO
         (CL:PROGN (CL:SETQ R (STELLA::%%VALUE ITER-001))
          (CL:SETQ ITER-001 (STELLA::%%REST ITER-001)))
         (CL:WHEN
       ...
       (CL:LET* ((R STELLA::NULL) (ITER-002 RELATIONS))
        (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-002 STELLA::NIL)) DO
         (CL:PROGN (CL:SETQ R (STELLA::%%VALUE ITER-002))
          (CL:SETQ ITER-002 (STELLA::%%REST ITER-002)))
         (CL:WHEN
          (CL:NOT (STELLA::UPCLASSIFIED-LATER-THAN? R YOUNGESTRELATION))
   ...
   (CL:LET* ((CLAUSES STELLA::NIL) (VARIABLES STELLA::NIL))
    (CL:LET*
     ((V STELLA::NULL) (ITER-001 STELLA::SYSTEM-DEFINED-ARGUMENT-NAMES)
      (I (STELLA::INTERVAL 1 (RELATION-ARITY (STELLA::%%VALUE RELATIONS))))
      (COLLECT-001 STELLA::NULL))
     (CL:LOOP WHILE
      (CL:AND (CL:NOT (CL:EQ ITER-001 STELLA::NIL)) (STELLA::NEXT? I)) DO
      (CL:PROGN (CL:SETQ V (STELLA::%%VALUE ITER-001))
       (CL:SETQ ITER-001 (STELLA::%%REST ITER-001)))
      (CL:IF (CL:EQ COLLECT-001 STELLA::NULL)
       ...
       (CL:PROGN
        (CL:SETF (STELLA::%%REST COLLECT-001) (STELLA::CONS V STELLA::NIL))
     ...
     (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-002 STELLA::NIL)) DO
      ...
      (CL:IF (NAMED? R)
       (CL:SETQ CLAUSES
        (STELLA::CONS
         (STELLA::CONS
          (STELLA::SURROGATE-TO-SYMBOL (STELLA::%SURROGATE-VALUE-INVERSE R))
       ...
       (CL:SETQ CLAUSES
        (STELLA::CONS
         (STELLA::%%VALUE
          (STELLA::%%REST
           (STELLA::%%REST (STELLA::GENERATE-EXPRESSION R STELLA::TRUE))))
         CLAUSES)))))
    (CL:SETQ CONJUNCTIONDESCRIPTION
     (STELLA::CONCEIVE-TERM
      (STELLA::LIST* SYM-LOOM-SUPPORT-LOGIC-KAPPA
       ...
       STELLA::NIL))))
   (CL:LET*
    ((SUPERS STELLA::NULL) (SUBS STELLA::NULL) (EQUIVALENTS STELLA::NULL))
    (CL:MULTIPLE-VALUE-SETQ (SUPERS SUBS EQUIVALENTS)
     (STELLA::FIND-DIRECT-SUPERS-AND-SUBS CONJUNCTIONDESCRIPTION
      STELLA::TRUE))
...
(CL:DEFUN GET-DOMAIN (RELATIONREF)
  ...
  (CL:LET* ((RELATION (STELLA::GET-RELATION RELATIONREF)))
   ...
   (STELLA::%%VALUE
    (STELLA::APPLY-CACHED-RETRIEVE
     (STELLA::LIST* SYM-LOOM-SUPPORT-LOOM-API-?D SYM-LOOM-SUPPORT-LOOM-API-?R
      STELLA::NIL)
     (STELLA::LIST* SYM-LOOM-SUPPORT-PL-KERNEL-KB-DOMAIN
      SYM-LOOM-SUPPORT-LOOM-API-?R SYM-LOOM-SUPPORT-LOOM-API-?D STELLA::NIL)
     (STELLA::CONS-LIST STELLA::NULL RELATION) (STELLA::CONS-LIST)
     SYM-LOOM-SUPPORT-LOOM-API-QUERY-078))))
   ...
   (STELLA::%%VALUE
    (STELLA::APPLY-CACHED-RETRIEVE
     ...
     (STELLA::LIST* SYM-LOOM-SUPPORT-PL-KERNEL-KB-RANGE
      SYM-LOOM-SUPPORT-LOOM-API-?R SYM-LOOM-SUPPORT-LOOM-API-?D STELLA::NIL)
     (STELLA::CONS-LIST STELLA::NULL RELATION) (STELLA::CONS-LIST)
     SYM-LOOM-SUPPORT-LOOM-API-QUERY-079))))
...
the range of relation 'relationRef' applied to 'instanceRef'."
  (CL:LET*
   ...
   (CL:WHEN (CL:EQ TYPE STELLA::NULL)
    (CL:SETQ TYPE (STELLA::GET-DESCRIPTION SGT-LOOM-SUPPORT-STELLA-THING)))
   TYPE))
...
source expression for 'instanceRef'."
  (CL:LET* ((INSTANCE (STELLA::GET-INSTANCE INSTANCEREF)))
   (STELLA::GENERATE-EXPRESSION INSTANCE STELLA::FALSE)))
...
specify disjointness of children of the class classRef'."
  (CL:LET* ((CLASS (STELLA::GET-CLASS CLASSREF)) (PARTITIONS STELLA::NIL))
   (CL:WHEN (CL:NOT (CL:EQ CLASS STELLA::NULL))
    (CL:LET*
     ((C STELLA::NULL) (ITER-000 (GET-SUBRELATIONS CLASS STELLA::TRUE)))
     (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-000 STELLA::NIL)) DO
      (CL:PROGN (CL:SETQ C (STELLA::%%VALUE ITER-000))
       (CL:SETQ ITER-000 (STELLA::%%REST ITER-000)))
      (CL:LET*
       ((MDC STELLA::NULL)
        (ITER-001
         (STELLA::APPLY-CACHED-RETRIEVE
          (STELLA::LIST* SYM-LOOM-SUPPORT-LOGIC-?C SYM-LOOM-SUPPORT-LOGIC-?MDC
           STELLA::NIL)
          (STELLA::LIST* SYM-LOOM-SUPPORT-STELLA-AND
           (STELLA::LIST* SYM-LOOM-SUPPORT-PL-KERNEL-KB-MEMBER-OF
            SYM-LOOM-SUPPORT-LOGIC-?C SYM-LOOM-SUPPORT-LOGIC-?MDC STELLA::NIL)
           (STELLA::LIST* SYM-LOOM-SUPPORT-LOGIC-MUTUALLY-DISJOINT-COLLECTION
            SYM-LOOM-SUPPORT-LOGIC-?MDC STELLA::NIL)
           STELLA::NIL)
          (STELLA::CONS-LIST C STELLA::NULL) (STELLA::CONS-LIST)
          SYM-LOOM-SUPPORT-LOOM-API-QUERY-080)))
       (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-001 STELLA::NIL)) DO
        (CL:PROGN (CL:SETQ MDC (STELLA::%%VALUE ITER-001))
         (CL:SETQ ITER-001 (STELLA::%%REST ITER-001)))
...
some concept."
  (CL:LET*
   ...
   (CL:WHEN
    ...
    (CL:RETURN-FROM COVERING? STELLA::FALSE))
   (CL:LET*
    ((C
      (STELLA::ALLOCATE-ITERATOR
       (STELLA::APPLY-CACHED-RETRIEVE
        ...
        SYM-LOOM-SUPPORT-LOOM-API-QUERY-081))))
    (CL:LOOP WHILE (STELLA::NEXT? C) DO
     (CL:RETURN-FROM COVERING? STELLA::TRUE)))
   STELLA::FALSE))
  ...
  (CL:LET* ((INSTANCE (STELLA::GET-INSTANCE INSTANCEREF)))
   (CL:WHEN (CL:NOT (CL:EQ INSTANCE STELLA::NULL))
    (CL:RETURN-FROM COLLECTION-MEMBERS
     (STELLA::CONSIFY
      (STELLA::ASSERTED-COLLECTION-MEMBERS INSTANCE STELLA::FALSE))))
   STELLA::NIL))

(CL:DEFUN HELP-STARTUP-LOOM-SUPPORT1 ()
  (CL:PROGN
   (CL:SETQ SGT-LOOM-SUPPORT-LOOM-API-LOOM-ROLE
    (STELLA::INTERN-RIGID-SYMBOL-WRT-MODULE "LOOM-ROLE" STELLA::NULL 1))
   ...
   (CL:SETQ SYM-LOOM-SUPPORT-LOOM-API-QUERY-072
    (STELLA::INTERN-RIGID-SYMBOL-WRT-MODULE "QUERY-072" STELLA::NULL 0))
   ...
   (CL:SETQ SYM-LOOM-SUPPORT-LOOM-API-QUERY-073
    (STELLA::INTERN-RIGID-SYMBOL-WRT-MODULE "QUERY-073" STELLA::NULL 0))
   ...
   (CL:SETQ SYM-LOOM-SUPPORT-PL-KERNEL-KB-HOLDS
    (STELLA::INTERN-RIGID-SYMBOL-WRT-MODULE "HOLDS"
     (STELLA::GET-STELLA-MODULE "/PL-KERNEL-KB" STELLA::TRUE) 0))
   ...
   (CL:SETQ SYM-LOOM-SUPPORT-STELLA-=
    (STELLA::INTERN-RIGID-SYMBOL-WRT-MODULE "="
     (STELLA::GET-STELLA-MODULE "/STELLA" STELLA::TRUE) 0))
   (CL:SETQ SYM-LOOM-SUPPORT-LOOM-API-RANGE-MAX-CARDINALITY
   ...
   (CL:SETQ SYM-LOOM-SUPPORT-PL-KERNEL-KB-DOMAIN
    (STELLA::INTERN-RIGID-SYMBOL-WRT-MODULE "DOMAIN"
     (STELLA::GET-STELLA-MODULE "/PL-KERNEL-KB" STELLA::TRUE) 0))
   (CL:SETQ SYM-LOOM-SUPPORT-LOOM-API-QUERY-074
    (STELLA::INTERN-RIGID-SYMBOL-WRT-MODULE "QUERY-074" STELLA::NULL 0))
   (CL:SETQ SYM-LOOM-SUPPORT-LOOM-API-QUERY-075
    (STELLA::INTERN-RIGID-SYMBOL-WRT-MODULE "QUERY-075" STELLA::NULL 0))
   ...
   (CL:SETQ SYM-LOOM-SUPPORT-PL-KERNEL-KB-CLASS
    (STELLA::INTERN-RIGID-SYMBOL-WRT-MODULE "CLASS"
     (STELLA::GET-STELLA-MODULE "/PL-KERNEL-KB" STELLA::TRUE) 0))
   (CL:SETQ SYM-LOOM-SUPPORT-LOOM-API-QUERY-076
    (STELLA::INTERN-RIGID-SYMBOL-WRT-MODULE "QUERY-076" STELLA::NULL 0))
   (CL:SETQ KWD-LOOM-SUPPORT-RELATIONS
    (STELLA::INTERN-RIGID-SYMBOL-WRT-MODULE "RELATIONS" STELLA::NULL 2))
   ...
   (CL:SETQ SYM-LOOM-SUPPORT-LOGIC-FAIL
    (STELLA::INTERN-RIGID-SYMBOL-WRT-MODULE "FAIL"
     (STELLA::GET-STELLA-MODULE "/LOGIC" STELLA::TRUE) 0))
   (CL:SETQ SYM-LOOM-SUPPORT-LOOM-API-QUERY-077
    (STELLA::INTERN-RIGID-SYMBOL-WRT-MODULE "QUERY-077" STELLA::NULL 0))
   (CL:SETQ KWD-LOOM-SUPPORT-INSTANCES
    (STELLA::INTERN-RIGID-SYMBOL-WRT-MODULE "INSTANCES" STELLA::NULL 2))
   (CL:SETQ SGT-LOOM-SUPPORT-PL-KERNEL-KB-ARITY
    (STELLA::INTERN-RIGID-SYMBOL-WRT-MODULE "ARITY"
     (STELLA::GET-STELLA-MODULE "/PL-KERNEL-KB" STELLA::TRUE) 1))
   ...
   (CL:SETQ KWD-LOOM-SUPPORT-DESCRIPTION
    (STELLA::INTERN-RIGID-SYMBOL-WRT-MODULE "DESCRIPTION" STELLA::NULL 2))
   ...
   (CL:SETQ SYM-LOOM-SUPPORT-LOOM-API-QUERY-078
    (STELLA::INTERN-RIGID-SYMBOL-WRT-MODULE "QUERY-078" STELLA::NULL 0))
   (CL:SETQ SYM-LOOM-SUPPORT-PL-KERNEL-KB-RANGE
    (STELLA::INTERN-RIGID-SYMBOL-WRT-MODULE "RANGE"
     (STELLA::GET-STELLA-MODULE "/PL-KERNEL-KB" STELLA::TRUE) 0))
   (CL:SETQ SYM-LOOM-SUPPORT-LOOM-API-QUERY-079
    (STELLA::INTERN-RIGID-SYMBOL-WRT-MODULE "QUERY-079" STELLA::NULL 0))
   ...
   (CL:SETQ SYM-LOOM-SUPPORT-PL-KERNEL-KB-MEMBER-OF
    (STELLA::INTERN-RIGID-SYMBOL-WRT-MODULE "MEMBER-OF"
     (STELLA::GET-STELLA-MODULE "/PL-KERNEL-KB" STELLA::TRUE) 0))
   (CL:SETQ SYM-LOOM-SUPPORT-LOGIC-MUTUALLY-DISJOINT-COLLECTION
    (STELLA::INTERN-RIGID-SYMBOL-WRT-MODULE "MUTUALLY-DISJOINT-COLLECTION"
     (STELLA::GET-STELLA-MODULE "/LOGIC" STELLA::TRUE) 0))
   (CL:SETQ SYM-LOOM-SUPPORT-LOOM-API-QUERY-080
    (STELLA::INTERN-RIGID-SYMBOL-WRT-MODULE "QUERY-080" STELLA::NULL 0))
...
(CL:DEFUN STARTUP-LOOM-SUPPORT ()
  (CL:LET*
   ...
   (CL:WHEN (STELLA::CURRENT-STARTUP-TIME-PHASE? 2)
    ...
    (CL:SETQ SYM-LOOM-SUPPORT-LOOM-API-QUERY-081
     (STELLA::INTERN-RIGID-SYMBOL-WRT-MODULE "QUERY-081" STELLA::NULL 0))
...
or NULL if it is not context sensitive.\")" (CL:FUNCTION CONTEXT-OF-INSTANCE)
     STELLA::NULL)
...
is matched with a logical constant.\" :PUBLIC? TRUE)" (CL:FUNCTION NAMED?)
     STELLA::NULL)
...
applied to 'instanceRef'.\" :PUBLIC? TRUE)" (CL:FUNCTION GET-ROLE-VALUE)
     STELLA::NULL)
...
applied to 'instanceRef'.\" :PUBLIC? TRUE)" (CL:FUNCTION GET-ROLE-VALUES)
     STELLA::NULL)
...
some concept.\")" (CL:FUNCTION COVERING?) STELLA::NULL)
    ...
    (CL:LET*
     ...
     (STELLA::SET-DYNAMIC-SLOT-VALUE (STELLA::%DYNAMIC-SLOTS FUNCTION)
      ...
      (STELLA::WRAP-STRING "_Startup-Loom-Support")
