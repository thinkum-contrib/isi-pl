...
(CL:DEFVAR SYM-LOOM-SUPPORT-PL-KERNEL-KB-MAXIMUM-CARDINALITY STELLA::NULL)
(CL:DEFVAR SYM-LOOM-SUPPORT-PL-KERNEL-KB-INSTANCE-OF STELLA::NULL)
(CL:DEFVAR SYM-LOOM-SUPPORT-PL-KERNEL-KB-DOMAIN STELLA::NULL)
(CL:DEFVAR SYM-LOOM-SUPPORT-LOOM-API-QUERY-085 STELLA::NULL)
(CL:DEFVAR SYM-LOOM-SUPPORT-LOOM-API-QUERY-086 STELLA::NULL)
...
(CL:DEFVAR SYM-LOOM-SUPPORT-LOOM-API-QUERY-087 STELLA::NULL)
(CL:DEFVAR KWD-LOOM-SUPPORT-RELATIONS STELLA::NULL)
(CL:DEFVAR SYM-LOOM-SUPPORT-LOGIC-FAIL STELLA::NULL)
(CL:DEFVAR SYM-LOOM-SUPPORT-LOOM-API-QUERY-088 STELLA::NULL)
...
(CL:DEFVAR SYM-LOOM-SUPPORT-PL-KERNEL-KB-?D STELLA::NULL)
(CL:DEFVAR SYM-LOOM-SUPPORT-LOOM-API-QUERY-089 STELLA::NULL)
(CL:DEFVAR SYM-LOOM-SUPPORT-PL-KERNEL-KB-RANGE STELLA::NULL)
(CL:DEFVAR SYM-LOOM-SUPPORT-LOOM-API-QUERY-090 STELLA::NULL)
...
(CL:DEFVAR SYM-LOOM-SUPPORT-LOOM-API-QUERY-091 STELLA::NULL)
...
(CL:DEFVAR SYM-LOOM-SUPPORT-LOOM-API-QUERY-092 STELLA::NULL)
...
(CL:DECLAIM
 (CL:SPECIAL STELLA::*STARTUP-TIME-PHASE*
  STELLA::SYSTEM-DEFINED-ARGUMENT-NAMES STELLA::*MODULE* STELLA::*CONTEXT*
  STELLA::*PL-KERNEL-MODULE* STELLA::STANDARD-OUTPUT STELLA::EOL))
   ...
   (CL:SETQ ROLE
    (STELLA::%%VALUE
     (STELLA::APPLY-CACHED-RETRIEVE
      (STELLA::LIST* SYM-LOOM-SUPPORT-PL-KERNEL-KB-?I
       SYM-LOOM-SUPPORT-PL-KERNEL-KB-?R SYM-LOOM-SUPPORT-LOOM-API-?ROLE
       STELLA::NIL)
      (STELLA::LIST* SYM-LOOM-SUPPORT-LOOM-API-LOOM-ROLE-OF
       SYM-LOOM-SUPPORT-PL-KERNEL-KB-?I SYM-LOOM-SUPPORT-PL-KERNEL-KB-?R
       SYM-LOOM-SUPPORT-LOOM-API-?ROLE STELLA::NIL)
      (STELLA::CONS-LIST INSTANCE RELATION STELLA::NULL)
      (STELLA::CONS-LIST) SYM-LOOM-SUPPORT-LOOM-API-QUERY-083)))
  ...
  (CL:LET* ((INSTANCE (STELLA::GET-INSTANCE INSTANCEREF)))
   ...
   (STELLA::APPLY-CACHED-RETRIEVE
    ...
    (STELLA::LIST* SYM-LOOM-SUPPORT-STELLA-EXISTS
     SYM-LOOM-SUPPORT-PL-KERNEL-KB-?R
     (STELLA::LIST* SYM-LOOM-SUPPORT-LOOM-API-LOOM-ROLE-OF
      SYM-LOOM-SUPPORT-PL-KERNEL-KB-?I SYM-LOOM-SUPPORT-PL-KERNEL-KB-?R
      SYM-LOOM-SUPPORT-LOOM-API-?ROLE STELLA::NIL)
     STELLA::NIL)
    (STELLA::CONS-LIST INSTANCE STELLA::NULL) (STELLA::CONS-LIST)
    SYM-LOOM-SUPPORT-LOOM-API-QUERY-084)))
...
(CL:DEFUN GET-RELATION-INDUCED-ROLES (INSTANCEREF)
  (CL:LET*
   ...
   (CL:SETQ RELATIONS
    (STELLA::APPLY-CACHED-RETRIEVE
     (STELLA::LIST* SYM-LOOM-SUPPORT-PL-KERNEL-KB-?R
      SYM-LOOM-SUPPORT-PL-KERNEL-KB-?I STELLA::NIL)
     (STELLA::LIST* SYM-LOOM-SUPPORT-STELLA-OR
      (STELLA::LIST* SYM-LOOM-SUPPORT-STELLA-EXISTS
       (STELLA::LIST* SYM-LOOM-SUPPORT-LOOM-API-?FR
        SYM-LOOM-SUPPORT-PL-KERNEL-KB-?V STELLA::NIL)
       (STELLA::LIST* SYM-LOOM-SUPPORT-STELLA-AND
        (STELLA::LIST* SYM-LOOM-SUPPORT-PL-KERNEL-KB-FRAME-PREDICATE
         SYM-LOOM-SUPPORT-LOOM-API-?FR STELLA::NIL)
        (STELLA::LIST* SYM-LOOM-SUPPORT-PL-KERNEL-KB-HOLDS
         SYM-LOOM-SUPPORT-LOOM-API-?FR SYM-LOOM-SUPPORT-PL-KERNEL-KB-?R
         SYM-LOOM-SUPPORT-PL-KERNEL-KB-?I SYM-LOOM-SUPPORT-PL-KERNEL-KB-?V
         STELLA::NIL)
        (STELLA::LIST* SYM-LOOM-SUPPORT-STELLA-NOT
         (STELLA::LIST* SYM-LOOM-SUPPORT-STELLA-AND
          (STELLA::LIST* SYM-LOOM-SUPPORT-STELLA-=
           SYM-LOOM-SUPPORT-LOOM-API-?FR
           SYM-LOOM-SUPPORT-PL-KERNEL-KB-MAXIMUM-CARDINALITY STELLA::NIL)
          (STELLA::LIST* SYM-LOOM-SUPPORT-STELLA-=
           SYM-LOOM-SUPPORT-PL-KERNEL-KB-?V (STELLA::WRAP-INTEGER 0)
           STELLA::NIL)
          STELLA::NIL)
         STELLA::NIL)
        STELLA::NIL)
      ...
      (STELLA::LIST* SYM-LOOM-SUPPORT-STELLA-EXISTS
       ...
       (STELLA::LIST* SYM-LOOM-SUPPORT-STELLA-AND
        (STELLA::LIST* SYM-LOOM-SUPPORT-PL-KERNEL-KB-INSTANCE-OF
         SYM-LOOM-SUPPORT-PL-KERNEL-KB-?I SYM-LOOM-SUPPORT-LOGIC-?C
         STELLA::NIL)
        (STELLA::LIST* SYM-LOOM-SUPPORT-PL-KERNEL-KB-DOMAIN
         SYM-LOOM-SUPPORT-PL-KERNEL-KB-?R SYM-LOOM-SUPPORT-LOGIC-?C
         STELLA::NIL)
        STELLA::NIL)
       STELLA::NIL)
      STELLA::NIL)
     (STELLA::CONS-LIST STELLA::NULL INSTANCE) (STELLA::CONS-LIST)
     SYM-LOOM-SUPPORT-LOOM-API-QUERY-085))
  ...
  (STELLA::%%VALUE
   (STELLA::APPLY-CACHED-RETRIEVE
    (STELLA::LIST* SYM-LOOM-SUPPORT-PL-KERNEL-KB-?R
     SYM-LOOM-SUPPORT-LOOM-API-?ROLE STELLA::NIL)
    (STELLA::LIST* SYM-LOOM-SUPPORT-STELLA-EXISTS
     SYM-LOOM-SUPPORT-PL-KERNEL-KB-?I
     (STELLA::LIST* SYM-LOOM-SUPPORT-LOOM-API-LOOM-ROLE-OF
      SYM-LOOM-SUPPORT-PL-KERNEL-KB-?I SYM-LOOM-SUPPORT-PL-KERNEL-KB-?R
      SYM-LOOM-SUPPORT-LOOM-API-?ROLE STELLA::NIL)
     STELLA::NIL)
    (STELLA::CONS-LIST STELLA::NULL ROLE) (STELLA::CONS-LIST)
    SYM-LOOM-SUPPORT-LOOM-API-QUERY-086)))
   ...
   (CL:COND
    ...
    ((CL:EQ VALUES KWD-LOOM-SUPPORT-CONCEPTS)
     (STELLA::APPLY-CACHED-RETRIEVE
      ...
      SYM-LOOM-SUPPORT-LOOM-API-QUERY-087))
    ((CL:EQ VALUES KWD-LOOM-SUPPORT-RELATIONS)
     (STELLA::APPLY-CACHED-RETRIEVE
      ...
      (STELLA::LIST* SYM-LOOM-SUPPORT-STELLA-AND
       ...
       STELLA::NIL)
      (STELLA::CONS-LIST STELLA::NULL) (STELLA::CONS-LIST)
      SYM-LOOM-SUPPORT-LOOM-API-QUERY-088))
...
(CL:DEFUN STELLA::NAMED? (INSTANCEREF)
        ...
        (CL:LET* ((S STELLA::NULL) (ITER-001 DIRECTSUBS))
         (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-001 STELLA::NIL)) DO
          (CL:PROGN (CL:SETQ S (STELLA::%%VALUE ITER-001))
           (CL:SETQ ITER-001 (STELLA::%%REST ITER-001)))
          (CL:WHEN (INSTANCE-OF? I S)
           (CL:SETQ INSTANCE-OF-SUB? STELLA::TRUE) (CL:RETURN))))
...
Side-effect: Upclassify 'subrelationRef'."
  (CL:LET*
   ...
   (CL:IF
    ...
    (CL:PROGN
     (STELLA::FIND-DIRECT-SUPERS-AND-SUBS SUBRELATION STELLA::TRUE)
   ...
   (CL:LET* ((CLAUSES STELLA::NIL) (VARIABLES STELLA::NIL))
    (CL:LET*
     ((V STELLA::NULL) (ITER-001 STELLA::SYSTEM-DEFINED-ARGUMENT-NAMES)
      (I
       (STELLA::INTERVAL 1 (RELATION-ARITY (STELLA::%%VALUE RELATIONS))))
...
(CL:DEFUN GET-DOMAIN (RELATIONREF)
  ...
  (CL:LET* ((RELATION (STELLA::GET-RELATION RELATIONREF)))
   ...
   (STELLA::%%VALUE
    (STELLA::APPLY-CACHED-RETRIEVE
     (STELLA::LIST* SYM-LOOM-SUPPORT-PL-KERNEL-KB-?D
      SYM-LOOM-SUPPORT-PL-KERNEL-KB-?R STELLA::NIL)
     (STELLA::LIST* SYM-LOOM-SUPPORT-PL-KERNEL-KB-DOMAIN
      SYM-LOOM-SUPPORT-PL-KERNEL-KB-?R SYM-LOOM-SUPPORT-PL-KERNEL-KB-?D
      STELLA::NIL)
     (STELLA::CONS-LIST STELLA::NULL RELATION) (STELLA::CONS-LIST)
     SYM-LOOM-SUPPORT-LOOM-API-QUERY-089))))
   ...
   (STELLA::%%VALUE
    (STELLA::APPLY-CACHED-RETRIEVE
     ...
     (STELLA::LIST* SYM-LOOM-SUPPORT-PL-KERNEL-KB-RANGE
      ...
      STELLA::NIL)
     (STELLA::CONS-LIST STELLA::NULL RELATION) (STELLA::CONS-LIST)
     SYM-LOOM-SUPPORT-LOOM-API-QUERY-090))))
         ...
         (STELLA::APPLY-CACHED-RETRIEVE
          ...
          (STELLA::LIST* SYM-LOOM-SUPPORT-STELLA-AND
           (STELLA::LIST* SYM-LOOM-SUPPORT-PL-KERNEL-KB-MEMBER-OF
            ...
            STELLA::NIL)
           (STELLA::LIST*
            SYM-LOOM-SUPPORT-LOGIC-MUTUALLY-DISJOINT-COLLECTION
            SYM-LOOM-SUPPORT-LOGIC-?MDC STELLA::NIL)
           STELLA::NIL)
          (STELLA::CONS-LIST C STELLA::NULL) (STELLA::CONS-LIST)
          SYM-LOOM-SUPPORT-LOOM-API-QUERY-091)))
       (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-001 STELLA::NIL)) DO
...
(CL:DEFUN HELP-STARTUP-LOOM-SUPPORT1 ()
  (CL:PROGN
   ...
   (CL:SETQ SYM-LOOM-SUPPORT-PL-KERNEL-KB-?R
    (STELLA::INTERN-RIGID-SYMBOL-WRT-MODULE "?R"
     (STELLA::GET-STELLA-MODULE "/PL-KERNEL-KB" STELLA::TRUE) 0))
   ...
   (CL:SETQ SYM-LOOM-SUPPORT-LOOM-API-LOOM-ROLE
    (STELLA::INTERN-RIGID-SYMBOL-WRT-MODULE "LOOM-ROLE" STELLA::NULL 0))
   (CL:SETQ KWD-LOOM-SUPPORT-DOCUMENTATION
    (STELLA::INTERN-RIGID-SYMBOL-WRT-MODULE "DOCUMENTATION" STELLA::NULL
     2))
   (CL:SETQ KWD-LOOM-SUPPORT-AXIOMS
    (STELLA::INTERN-RIGID-SYMBOL-WRT-MODULE "AXIOMS" STELLA::NULL 2))
   (CL:SETQ SYM-LOOM-SUPPORT-PL-KERNEL-KB-SINGLE-VALUED
    (STELLA::INTERN-RIGID-SYMBOL-WRT-MODULE "SINGLE-VALUED"
     (STELLA::GET-STELLA-MODULE "/PL-KERNEL-KB" STELLA::TRUE) 0))
   (CL:SETQ SYM-LOOM-SUPPORT-PL-KERNEL-KB-?I
    (STELLA::INTERN-RIGID-SYMBOL-WRT-MODULE "?I"
     (STELLA::GET-STELLA-MODULE "/PL-KERNEL-KB" STELLA::TRUE) 0))
   (CL:SETQ SYM-LOOM-SUPPORT-LOOM-API-QUERY-083
    (STELLA::INTERN-RIGID-SYMBOL-WRT-MODULE "QUERY-083" STELLA::NULL 0))
   ...
   (CL:SETQ SYM-LOOM-SUPPORT-LOOM-API-QUERY-084
    (STELLA::INTERN-RIGID-SYMBOL-WRT-MODULE "QUERY-084" STELLA::NULL 0))
   ...
   (CL:SETQ SYM-LOOM-SUPPORT-PL-KERNEL-KB-?V
    (STELLA::INTERN-RIGID-SYMBOL-WRT-MODULE "?V"
     (STELLA::GET-STELLA-MODULE "/PL-KERNEL-KB" STELLA::TRUE) 0))
   (CL:SETQ SYM-LOOM-SUPPORT-STELLA-AND
    (STELLA::INTERN-RIGID-SYMBOL-WRT-MODULE "AND"
     (STELLA::GET-STELLA-MODULE "/STELLA" STELLA::TRUE) 0))
   (CL:SETQ SYM-LOOM-SUPPORT-PL-KERNEL-KB-FRAME-PREDICATE
   ...
   (CL:SETQ SYM-LOOM-SUPPORT-STELLA-=
    (STELLA::INTERN-RIGID-SYMBOL-WRT-MODULE "="
     (STELLA::GET-STELLA-MODULE "/STELLA" STELLA::TRUE) 0))
   (CL:SETQ SYM-LOOM-SUPPORT-PL-KERNEL-KB-MAXIMUM-CARDINALITY
    (STELLA::INTERN-RIGID-SYMBOL-WRT-MODULE "MAXIMUM-CARDINALITY"
     (STELLA::GET-STELLA-MODULE "/PL-KERNEL-KB" STELLA::TRUE) 0))
   (CL:SETQ SYM-LOOM-SUPPORT-PL-KERNEL-KB-INSTANCE-OF
    (STELLA::INTERN-RIGID-SYMBOL-WRT-MODULE "INSTANCE-OF"
     (STELLA::GET-STELLA-MODULE "/PL-KERNEL-KB" STELLA::TRUE) 0))
   (CL:SETQ SYM-LOOM-SUPPORT-PL-KERNEL-KB-DOMAIN
    (STELLA::INTERN-RIGID-SYMBOL-WRT-MODULE "DOMAIN"
     (STELLA::GET-STELLA-MODULE "/PL-KERNEL-KB" STELLA::TRUE) 0))
   (CL:SETQ SYM-LOOM-SUPPORT-LOOM-API-QUERY-085
    (STELLA::INTERN-RIGID-SYMBOL-WRT-MODULE "QUERY-085" STELLA::NULL 0))
   (CL:SETQ SYM-LOOM-SUPPORT-LOOM-API-QUERY-086
    (STELLA::INTERN-RIGID-SYMBOL-WRT-MODULE "QUERY-086" STELLA::NULL 0))
   ...
   (CL:SETQ SYM-LOOM-SUPPORT-LOGIC-?X
    (STELLA::INTERN-RIGID-SYMBOL-WRT-MODULE "?X"
     (STELLA::GET-STELLA-MODULE "/LOGIC" STELLA::TRUE) 0))
   (CL:SETQ SYM-LOOM-SUPPORT-LOOM-API-QUERY-087
    (STELLA::INTERN-RIGID-SYMBOL-WRT-MODULE "QUERY-087" STELLA::NULL 0))
   ...
   (CL:SETQ SYM-LOOM-SUPPORT-LOGIC-FAIL
    (STELLA::INTERN-RIGID-SYMBOL-WRT-MODULE "FAIL"
     (STELLA::GET-STELLA-MODULE "/LOGIC" STELLA::TRUE) 0))
   (CL:SETQ SYM-LOOM-SUPPORT-LOOM-API-QUERY-088
    (STELLA::INTERN-RIGID-SYMBOL-WRT-MODULE "QUERY-088" STELLA::NULL 0))
   ...
   (CL:SETQ SYM-LOOM-SUPPORT-LOGIC-KAPPA
    (STELLA::INTERN-RIGID-SYMBOL-WRT-MODULE "KAPPA"
     (STELLA::GET-STELLA-MODULE "/LOGIC" STELLA::TRUE) 0))
   (CL:SETQ SYM-LOOM-SUPPORT-PL-KERNEL-KB-?D
    (STELLA::INTERN-RIGID-SYMBOL-WRT-MODULE "?D"
     (STELLA::GET-STELLA-MODULE "/PL-KERNEL-KB" STELLA::TRUE) 0))
   (CL:SETQ SYM-LOOM-SUPPORT-LOOM-API-QUERY-089
   ...
   (CL:SETQ SYM-LOOM-SUPPORT-PL-KERNEL-KB-RANGE
    (STELLA::INTERN-RIGID-SYMBOL-WRT-MODULE "RANGE"
     (STELLA::GET-STELLA-MODULE "/PL-KERNEL-KB" STELLA::TRUE) 0))
   (CL:SETQ SYM-LOOM-SUPPORT-LOOM-API-QUERY-090
    (STELLA::INTERN-RIGID-SYMBOL-WRT-MODULE "QUERY-090" STELLA::NULL 0))
   ...
   (CL:SETQ SYM-LOOM-SUPPORT-LOGIC-MUTUALLY-DISJOINT-COLLECTION
    (STELLA::INTERN-RIGID-SYMBOL-WRT-MODULE "MUTUALLY-DISJOINT-COLLECTION"
     (STELLA::GET-STELLA-MODULE "/LOGIC" STELLA::TRUE) 0))
   (CL:SETQ SYM-LOOM-SUPPORT-LOOM-API-QUERY-091
    (STELLA::INTERN-RIGID-SYMBOL-WRT-MODULE "QUERY-091" STELLA::NULL 0))
...
is matched with a logical constant.\" :PUBLIC? TRUE)"
    (CL:FUNCTION STELLA::NAMED?) STELLA::NULL)
...
some concept.\")" (CL:FUNCTION COVERING?) STELLA::NULL)
   ...
   (CL:LET*
    ...
    (STELLA::SET-DYNAMIC-SLOT-VALUE (STELLA::%DYNAMIC-SLOTS FUNCTION)
     ...
     (STELLA::WRAP-STRING "Startup-Loom-Support")
  ...
  (CL:LET*
   ...
   (CL:WHEN (STELLA::CURRENT-STARTUP-TIME-PHASE? 2)
    ...
    (CL:SETQ SYM-LOOM-SUPPORT-PL-KERNEL-KB-COVERING
     (STELLA::INTERN-RIGID-SYMBOL-WRT-MODULE "COVERING"
      (STELLA::GET-STELLA-MODULE "/PL-KERNEL-KB" STELLA::TRUE) 0))
    (CL:SETQ SYM-LOOM-SUPPORT-LOOM-API-QUERY-092
     (STELLA::INTERN-RIGID-SYMBOL-WRT-MODULE "QUERY-092" STELLA::NULL 0))
   ...
   (CL:WHEN (STELLA::CURRENT-STARTUP-TIME-PHASE? 9)
    (STELLA::%DEFRELATION
     (STELLA::CONS-LIST SYM-LOOM-SUPPORT-LOOM-API-LOOM-ROLE-OF
      (STELLA::LIST*
       (STELLA::LIST* SYM-LOOM-SUPPORT-LOGIC-?C
        SYM-LOOM-SUPPORT-PL-KERNEL-KB-CLASS STELLA::NIL)
       (STELLA::LIST* SYM-LOOM-SUPPORT-PL-KERNEL-KB-?R
        SYM-LOOM-SUPPORT-PL-KERNEL-KB-RELATION STELLA::NIL)
       (STELLA::LIST* SYM-LOOM-SUPPORT-LOOM-API-?ROLE
        SYM-LOOM-SUPPORT-LOOM-API-LOOM-ROLE STELLA::NIL)
       STELLA::NIL)
      KWD-LOOM-SUPPORT-DOCUMENTATION (STELLA::WRAP-STRING "")
      KWD-LOOM-SUPPORT-AXIOMS
      (STELLA::LIST* SYM-LOOM-SUPPORT-PL-KERNEL-KB-SINGLE-VALUED
       SYM-LOOM-SUPPORT-LOOM-API-LOOM-ROLE-OF STELLA::NIL))))))
