...
(CL:DECLAIM
 (CL:SPECIAL *STARTUP-TIME-PHASE* INCONSISTENT-TRUTH-VALUE
  TRUE-TRUTH-VALUE *CONTEXT* *MODULE* *REVERSEPOLARITY?* NIL-LIST
  NULL-INTEGER UNKNOWN-TRUTH-VALUE STANDARD-OUTPUT EOL *QUERYITERATOR*
  *CURRENTJUSTIFICATION* TRUE-WRAPPER FALSE-WRAPPER NIL NULL-FLOAT))
...
proposition of this justification." :ALLOCATION :INSTANCE :ACCESSOR
   ...
   (PROPOSITION :DOCUMENTATION
    "The proposition supported by this justification." :ALLOCATION
    :INSTANCE :ACCESSOR %PROPOSITION)
   (ANTECEDENTS :DOCUMENTATION
    "Antecedents justifications of this justification." :ALLOCATION
    :INSTANCE :ACCESSOR %ANTECEDENTS)
...
is a :PATTERN justification, the slot points to the parent pattern."
   ...
   (TRUTH-VALUE :DOCUMENTATION
    "Truth value of the derived proposition." :ALLOCATION :INSTANCE
    ...
    (CL:PROGN
     ...
     (CL:WHEN (CL:NOT (CL:EQ JUSTIFICATION NULL))
      (CL:LET*
       ((PATTERN
         (CL:IF
          (CL:EQ (%INFERENCE-RULE JUSTIFICATION)
           KWD-JUSTIFICATIONS-PATTERN)
          JUSTIFICATION (%PATTERN-JUSTIFICATION JUSTIFICATION)))
        (SUBSTITUTION
         (CL:IF (CL:NOT (CL:EQ PATTERN NULL)) (%SUBSTITUTION PATTERN)
          NULL))
        (VALUE NULL))
...
as propositions and substitutions."
  (CL:LET* ((COPY NULL) (ANTECEDENTS NIL))
   ...
   (CL:LET*
    ((ANTECEDENT NULL) (ITER-000 (%ANTECEDENTS SELF))
     (COLLECT-000 NULL))
     ...
     (CL:COND
      ...
      ((CL:AND (CL:NOT (CL:EQ (%PROPOSITION FRAME) NULL))
       ...
       (%%PRINT-STREAM (%NATIVE-STREAM STANDARD-OUTPUT)
        "RECORD-PRIMITIVE-JUSTIFICATION:  Test to see if clause needed."
        EOL)
       (CL:SETQ JUSTIFICATION
     ...
     (CL:LET*
       ...
       (CL:LET* ((OLDSUBSTITUTION SUBSTITUTION))
        ...
        (CL:LET*
         ...
         (CL:LOOP WHILE (NEXT? ITER-000) DO
          (CL:SETQ KEY (%KEY ITER-000)) (CL:SETQ VAL (%VALUE ITER-000))
      ...
      (CL:LET*
       ...
       (CL:WHEN COLLECTIONFRAME?
        ...
        (CL:LET* ((PATTERNCOPY NULL))
         (CL:LET* ((SELF-003 (NEW-JUSTIFICATION)))
          (CL:SETF (%INFERENCE-RULE SELF-003)
           KWD-JUSTIFICATIONS-PATTERN)
       ...
       (CL:WHEN (CL:NOT COLLECTIONFRAME?)
        (BACKLINK-TO-PATTERN-JUSTIFICATION ANTECEDENT
         JUSTIFICATION)))))
    (CL:T))))
       ...
       (RULECONSEQUENT
        (%PROPOSITION
         (CL:IF (CL:EQ INFERENCERULE KWD-JUSTIFICATIONS-MODUS-PONENS)
          ...
          (CL:AREF
           (CL:THE CL:SIMPLE-VECTOR (%THE-ARRAY (%ARGUMENTS RULE)))
           0))))
       (INVERTED?
        (CL:EQ (%KIND RULECONSEQUENT) KWD-JUSTIFICATIONS-NOT)))
      (CL:LET* ((SELF-000 (NEW-JUSTIFICATION)))
  ...
  (CL:COND
   ((CL:EQ LASTMOVE KWD-JUSTIFICATIONS-UP-TRUE)
    (CL:LET* ((ANTECEDENT NULL))
     ...
     (CL:LET* ((SELF-000 (NEW-JUSTIFICATION)))
      (CL:SETF (%INFERENCE-RULE SELF-000)
       KWD-JUSTIFICATIONS-NEGATED-FAIL)
      (CL:SETF (%ANTECEDENTS SELF-000) (CONS ANTECEDENT NIL))
      (RECORD-GOAL-JUSTIFICATION FRAME SELF-000))))
   (CL:T)))
   ...
   ((CL:EQ LASTMOVE KWD-JUSTIFICATIONS-UP-FAIL)
    (CL:LET* ((SELF-000 (NEW-JUSTIFICATION)))
     ...
     (CL:SETF (%PROPOSITION SELF-000)
      (CL:IF
       (CL:EQ (%KIND (%PROPOSITION FRAME)) KWD-JUSTIFICATIONS-FAIL)
     ...
     (CL:WHEN (CL:EQ THESUBSTITUTION NULL)
      (CL:LET* ((ANT NULL) (ITER-000 (%ANTECEDENTS SELF)))
       (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-000 NIL)) DO
        ...
        (CL:WHEN
         (CL:EQ (%INFERENCE-RULE ANT) KWD-JUSTIFICATIONS-PATTERN)
...
(CL:DEFUN GET-QUERY-JUSTIFICATIONS (QUERY SOLUTIONINDEX MAXJUSTIFICATIONS CREATE?)
  ...
  (CL:LET*
   ((ASKQUERY? (QUERY-IS-TRUE-FALSE? QUERY))
    (SOLUTIONS (%SOLUTIONS QUERY)) (SOLUTION NULL)
   ...
   (CL:WHEN
    (CL:OR ASKQUERY? (CL:= SOLUTIONINDEX NULL-INTEGER)
     (CL:< SOLUTIONINDEX 0))
    ...
    ((CL:EQ (%JUSTIFICATION SOLUTION) NULL)
     (CL:COND
      (CREATE?
       ...
       (CL:SETF (%ALL-JUSTIFICATIONS SOLUTION) JUSTIFICATIONS)
       JUSTIFICATIONS)
      (CL:T NIL-LIST)))
    (CL:T
     (CL:WHEN
      ...
      (CL:LET*
       ((JUST NULL)
        (ITER-000 (%THE-CONS-LIST (%ALL-JUSTIFICATIONS SOLUTION)))
        (IGNORE NULL-INTEGER) (ITER-001 1)
         ...
         (CL:PROGN (CL:SETQ COLLECT-000 (CONS JUST NIL))
          (CL:IF (CL:EQ (%THE-CONS-LIST JUSTIFICATIONS) NIL)
           ...
           (ADD-CONS-TO-END-OF-CONS-LIST
            (%THE-CONS-LIST JUSTIFICATIONS) COLLECT-000)))
     ...
     (CL:LET
      ((SELF (%THE-ARRAY (%ARGUMENTS FORWARDGOAL)))
       (VALUE
        (CL:AREF
         (CL:THE CL:SIMPLE-VECTOR
          (%THE-ARRAY (%ARGUMENTS FORWARDRULE)))
         0))
       (POSITION 0))
  ...
  (CL:LET*
   ...
   (CL:LET* ((STREAM-000 (NEW-OUTPUT-STRING-STREAM)))
    (%%PRINT-STREAM (%NATIVE-STREAM STREAM-000)
     "get-rule-io-variables: don't know how to access IO-vars of rule: `"
     RULE "'")
    (CL:ERROR (NEW-STELLA-EXCEPTION (THE-STRING-READER STREAM-000))))))
      ...
      (CL:LET*
       ...
       (CL:LOOP WHILE
        ...
        (CL:SETQ VAR
         (CL:AREF (CL:THE CL:SIMPLE-VECTOR (%THE-ARRAY VECTOR-001))
          INDEX-001))
        (INSERT-AT SUBSTITUTION VAR ARG)
        (CL:SETQ INDEX-000 (CL:1+ INDEX-000))
        (CL:SETQ INDEX-001 (CL:1+ INDEX-001))))))
  ...
  (CL:LET*
   ...
   (CL:LET* ((FJ NULL) (ITER-000 (%THE-CONS-LIST JUSTIFICATIONS)))
    (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-000 NIL)) DO
     ...
     (CL:WHEN
      (CL:EQ (%PROPOSITION (%%VALUE (%ANTECEDENTS FJ))) FORWARDRULE)
...
(CL:DEFUN CREATE-SUBSET-JUSTIFICATION (MAIN-PROPOSITION MATCHING-PROPOSITION)
  (CL:LET*
   ...
   (CL:WHEN
    ...
    (CL:WHEN
     (RELATIONREF-SPECIALIZES-RELATIONREF? MATCHING-OPERATOR
      MAIN-OPERATOR)
     (CL:LET* ((SUBSET-PROPOSITION NULL) (SUBSET-JUSTIFICATIONS NIL))
      ...
      (CL:LET* ((SELF-000 (NEW-PRIMITIVE-STRATEGY)))
       ...
       (CL:SETQ SUBSET-JUSTIFICATIONS
        (CONS SELF-000 SUBSET-JUSTIFICATIONS)))
      (CL:LET* ((SELF-001 (NEW-PRIMITIVE-STRATEGY)))
       (CL:SETF (%PROPOSITION SELF-001) MATCHING-PROPOSITION)
       (CL:SETF (%STRATEGY SELF-001)
        KWD-JUSTIFICATIONS-LOOKUP-ASSERTIONS)
       (CL:SETQ SUBSET-JUSTIFICATIONS
        (CONS SELF-001 SUBSET-JUSTIFICATIONS)))
...
(CL:DEFCLASS CLASH-JUSTIFICATION (JUSTIFICATION)
  ((DIRECTION :DOCUMENTATION
    "The inference direction for this inference." :ALLOCATION :INSTANCE
    :ACCESSOR %DIRECTION)))

(CL:DEFUN NEW-CLASH-JUSTIFICATION ()
  (CL:LET* ((SELF NULL))
   (CL:SETQ SELF (CL:MAKE-INSTANCE (CL:QUOTE CLASH-JUSTIFICATION)))
   (CL:SETF (%NEGATIVE-SCORE SELF) NULL-FLOAT)
   (CL:SETF (%POSITIVE-SCORE SELF) NULL-FLOAT)
   (CL:SETF (%TRUTH-VALUE SELF) NULL)
   (CL:SETF (%REVERSE-POLARITY? SELF) CL:NIL)
   ...
   (CL:SETF (%PATTERN-JUSTIFICATION SELF) NULL)
   (CL:SETF (%ANTECEDENTS SELF) NIL) (CL:SETF (%PROPOSITION SELF) NULL)
   (CL:SETF (%INFERENCE-RULE SELF) NULL)
...
(CL:DEFUN ACCESS-CLASH-JUSTIFICATION-SLOT-VALUE (SELF SLOTNAME VALUE SETVALUE?)
  (CL:COND
   ((CL:EQ SLOTNAME SYM-JUSTIFICATIONS-LOGIC-DIRECTION)
    (CL:IF SETVALUE? (CL:SETF (%DIRECTION SELF) VALUE)
     (CL:SETQ VALUE (%DIRECTION SELF))))
   (CL:T
    (CL:LET* ((STREAM-000 (NEW-OUTPUT-STRING-STREAM)))
     (%%PRINT-STREAM (%NATIVE-STREAM STREAM-000) "`" SLOTNAME
      "' is not a valid case option")
...
(CL:DEFUN CREATE-CLASH-JUSTIFICATION (PROP ANTECEDENTS DIRECTION)
  (CL:LET* ((SELF-000 (NEW-CLASH-JUSTIFICATION)))
   (CL:SETF (%INFERENCE-RULE SELF-000) KWD-JUSTIFICATIONS-CLASH)
   (CL:SETF (%DIRECTION SELF-000) DIRECTION)
   (CL:SETF (%PROPOSITION SELF-000) PROP)
   (CL:SETF (%TRUTH-VALUE SELF-000) INCONSISTENT-TRUTH-VALUE)
   (CL:SETF (%ANTECEDENTS SELF-000) ANTECEDENTS)
   (CL:LET* ((VALUE-000 SELF-000)) VALUE-000)))
...
(CL:DEFUN HELP-STARTUP-JUSTIFICATIONS1 ()
  (CL:PROGN
   ...
   (CL:SETQ KWD-JUSTIFICATIONS-NEGATED-FAIL
    (INTERN-RIGID-SYMBOL-WRT-MODULE "NEGATED-FAIL" NULL 2))
...
(CL:DEFUN HELP-STARTUP-JUSTIFICATIONS2 ()
  (CL:PROGN
   ...
   (CL:SETQ SGT-JUSTIFICATIONS-LOGIC-CLASH-JUSTIFICATION
    (INTERN-RIGID-SYMBOL-WRT-MODULE "CLASH-JUSTIFICATION" NULL 1))
   (CL:SETQ SYM-JUSTIFICATIONS-LOGIC-DIRECTION
    (INTERN-RIGID-SYMBOL-WRT-MODULE "DIRECTION" NULL 0))
   (CL:SETQ KWD-JUSTIFICATIONS-CLASH
...
is a :PATTERN justification, the slot points to the parent pattern.\") (SUBSTITUTION :TYPE (ENTITY-MAPPING OF PATTERN-VARIABLE OBJECT) :DOCUMENTATION \"List of variable bindings recorded for :PATTERN justifications.\") (REVERSE-POLARITY? :TYPE BOOLEAN :DOCUMENTATION \"True if proposition was derived in reverse polarity.\") (TRUTH-VALUE :TYPE TRUTH-VALUE :DOCUMENTATION \"Truth value of the derived proposition.\") (POSITIVE-SCORE :TYPE PARTIAL-MATCH-SCORE :DOCUMENTATION \"Positive partial match score of the derived proposition.\") (NEGATIVE-SCORE :TYPE PARTIAL-MATCH-SCORE :DOCUMENTATION \"Negative partial match score of the derived proposition.\")) :METHODS ((INFERENCE-STRATEGY ((SELF JUSTIFICATION)) :TYPE KEYWORD (RETURN NULL)) (INFERENCE-DIRECTION ((SELF JUSTIFICATION)) :TYPE KEYWORD (RETURN :BACKWARD))))")))
    ...
    (CL:LET*
     ...
     (CL:SETF (%CLASS-CONSTRUCTOR-CODE CLASS)
      (CL:FUNCTION NEW-CLASH-JUSTIFICATION))
     (CL:SETF (%CLASS-SLOT-ACCESSOR-CODE CLASS)
      (CL:FUNCTION ACCESS-CLASH-JUSTIFICATION-SLOT-VALUE))))
...
the explanation of concluded results.\")")
    ...
    (DEFINE-EXPLANATION-PHRASE KWD-JUSTIFICATIONS-NEGATED-FAIL
     KWD-JUSTIFICATIONS-TECHNICAL
