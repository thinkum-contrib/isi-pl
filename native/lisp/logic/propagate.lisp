...
(CL:DECLAIM
 (CL:SPECIAL *STARTUP-TIME-PHASE* STANDARD-ERROR DEFAULT-FALSE-TRUTH-VALUE
  *INVISIBLEASSERTION?* *MODULE* DEFAULT-TRUE-TRUTH-VALUE *TRACED-KEYWORDS*
  STANDARD-OUTPUT EOL NULL-INTEGER-WRAPPER NULL-INTEGER *MEMOIZATION-ENABLED?*
  MEMOIZED-NULL-VALUE NIL TRUE-WRAPPER FALSE-WRAPPER *CONTEXT*))
...
(CL:DEFMETHOD COPY ((SELF PROPAGATION-ENVIRONMENT))
  (CL:LET* ((COPY (NEW-PROPAGATION-ENVIRONMENT)))
   ...
   (CL:LET*
    ((PROP NULL) (ITER-001 (ALLOCATE-ITERATOR (%FORWARD-CHAINING-SET SELF))))
   ...
   (CL:LET*
    ((OBJ NULL) (ITER-002 (ALLOCATE-ITERATOR (%ELABORATED-OBJECTS SELF))))
...
(CL:DEFUN EVALUATION-STATE-SETTER (PROPOSITION STATE)
  ...
  (CL:WHEN (CL:NOT (DESCRIPTION-MODE?))
   (INSERT-AT (%EVALUATION-STATES (GET-PROPAGATION-ENVIRONMENT *CONTEXT*))
    PROPOSITION STATE)))
...
(CL:DEFUN POST-FOR-EVALUATION (SELF WORLD)
  ...
  (CL:WHEN (CL:NOT *FILLINGCONSTRAINTPROPAGATIONQUEUES?*)
   (CL:LET* ((*CONTEXT* WORLD) (*MODULE* (%BASE-MODULE *CONTEXT*)))
    (CL:DECLARE (CL:SPECIAL *CONTEXT* *MODULE*)) (EVALUATE-PROPOSITION SELF)
...
(CL:DEFUN POST-TO-FORWARD-CHAINING-QUEUE (SELF WORLD)
  ...
  (CL:WHEN (CL:EQ WORLD NULL) (CL:SETQ WORLD *CONTEXT*))
  (CL:LET*
   ((ENVIRONMENT (GET-PROPAGATION-ENVIRONMENT WORLD)) (DESCRIPTION NULL))
...
(CL:DEFMETHOD SKOLEM-GENERATION-COUNT ((SELF SKOLEM))
  (CL:LET*
   ((ANSWER
     (%WRAPPER-VALUE
      (DYNAMIC-SLOT-VALUE (%DYNAMIC-SLOTS SELF)
       SYM-PROPAGATE-LOGIC-SKOLEM-GENERATION-COUNT NULL-INTEGER-WRAPPER))))
  ...
  (CL:LET* ((*COLLECTFORWARDPROPOSITIONS* NIL))
   ...
   (CL:LET*
       ...
       (CL:WHEN (CL:>= SKOLEMGENERATIONCOUNT *MAX-SKOLEM-GENERATION-COUNT*)
        (CL:WHEN
         ...
         (%%PRINT-STREAM (%NATIVE-STREAM STANDARD-OUTPUT)
          "*** cutting off forward skolemization on: " TRIGGERPROPOSITION
          EOL))
    ...
    (CL:LET*
     ...
     (CL:DECLARE
      (CL:SPECIAL *QUERYITERATOR* *DONT-CHECK-FOR-DUPLICATE-PROPOSITIONS?*))
     ...
     (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-000 NIL)) DO
      ...
      (CL:WHEN
       ...
       (SET-DYNAMIC-SLOT-VALUE (%DYNAMIC-SLOTS SKOLEM)
        ...
        (WRAP-INTEGER
         (MAX (CL:1+ SKOLEMGENERATIONCOUNT) (SKOLEM-GENERATION-COUNT SKOLEM)))
...
(CL:DEFUN TRACE-FORWARD-RULE (RULE TRIGGER CONSEQUENTS)
  (CL:WHEN
   (CL:AND (CL:NOT (CL:EQ CONSEQUENTS NULL)) (CL:NOT (CL:EQ CONSEQUENTS NIL)))
   (CL:LET* ((INDENT 11)) (CL:DECLARE (CL:TYPE CL:FIXNUM INDENT))
    (%%PRINT-STREAM (%NATIVE-STREAM STANDARD-OUTPUT) "RUNNING FORWARD RULE:"
     EOL "  TRIGGER: ")
     ...
     (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-000 NIL)) DO
      ...
      (CL:WHEN (CL:> I 1)
       ...
       (CL:LET*
        ...
        (CL:LOOP WHILE (CL:OR UNBOUNDED?-000 (CL:<= ITER-002 UPPER-BOUND-000))
         DO (CL:SETQ I ITER-002) (CL:SETQ I I)
         (%%PRINT-STREAM (%NATIVE-STREAM STANDARD-OUTPUT) " ")
  ...
  (CL:LET* ((RULES NULL) (INDICES NULL))
   ...
   (CL:LET* ((R NULL) (TOUCHEDDEFAULT? NULL) (ITER-001 (%THE-KV-LIST RULES)))
    (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-001 NULL)) DO
     (CL:SETQ R (%KEY ITER-001)) (CL:SETQ TOUCHEDDEFAULT? (%VALUE ITER-001))
     ...
     (CL:SETQ ITER-001 (%REST ITER-001))))
   (CL:LET*
    ((FWDINDEX NULL) (TOUCHEDDEFAULT? NULL) (ITER-002 (%THE-KV-LIST INDICES)))
    (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-002 NULL)) DO
     ...
     (CL:TAGBODY
      (CL:LET* ((INPUTARGS NIL))
       ...
       (CL:LET*
        ...
        (CL:LOOP WHILE (CL:AND (NEXT? IT) (CL:NOT (CL:EQ ITER-003 NIL))) DO
         (CL:SETQ ARG (%%VALUE ITER-003)) (CL:PROGN) (VALUE-SETTER IT ARG)
      ...
      (CL:LET*
       ...
       (CL:LET*
        ((OB NULL) (ITER-004 OUTPUTBINDINGS) (TV NULL) (ITER-005 TRUTHVALUES))
        (CL:LOOP WHILE
         (CL:AND (CL:NOT (CL:EQ ITER-004 NIL)) (CL:NOT (CL:EQ ITER-005 NIL)))
         DO (CL:SETQ OB (%%VALUE ITER-004)) (CL:SETQ TV (%%VALUE ITER-005))
...
(CL:DEFMETHOD REACT-TO-INFERENCE-UPDATE ((SELF PROPOSITION))
  ...
  (CL:LET*
   ((PROP NULL) (ITER-000 (ALLOCATE-ITERATOR (%DEPENDENT-PROPOSITIONS SELF))))
   (CL:LOOP WHILE (NEXT? ITER-000) DO (CL:SETQ PROP (%VALUE ITER-000))
    (POST-FOR-EVALUATION PROP *CONTEXT*)))
  (CL:WHEN *FILLINGCONSTRAINTPROPAGATIONQUEUES?*
     ...
     (CL:WHEN (NON-EMPTY? QUEUE)
      ...
      (CL:LET* ((PROPOSITION NULL) (ITER-001 (%THE-CONS-LIST QUEUE)))
       (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-001 NIL)) DO
        ...
        (CL:WHEN
         (CL:AND (CL:NOT (CL:EQ DESCRIPTION NULL)) (FALSE? PROPOSITION))
         (CL:SETQ DESCRIPTION
        ...
        (CL:LET* ((FOUND?-000 CL:NIL))
         (CL:LET* ((TYPE2 NULL) (ITER-001 SECONDARGTYPES))
          (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-001 NIL)) DO
           ...
           (CL:WHEN (DISJOINT-TERMS? TYPE1 TYPE2) (CL:SETQ FOUND?-000 CL:T)
            (CL:RETURN))
           (CL:SETQ ITER-001 (%%REST ITER-001))))
         (CL:WHEN FOUND?-000
...
(CL:DEFUN EVALUATE-FUNCTION-PROPOSITION (SELF)
  ...
  (CL:LET*
   ((DESCRIPTION (GET-DESCRIPTION (%OPERATOR SELF)))
    (COMPUTATION (LOOKUP-CONSTRAINT-FUNCTION DESCRIPTION)) (STOREDVALUE NULL)
    (COMPUTEDVALUE NULL) (MISSINGVALUEINDEX -1))
   ...
   (CL:WHEN (CL:NOT (CL:EQ COMPUTATION NULL))
    (CL:SETQ COMPUTEDVALUE (COMPUTE-RELATION-VALUE SELF COMPUTATION CL:NIL))
    (CL:WHEN (CL:NOT (CL:EQ COMPUTEDVALUE NULL))
...
(CL:DEFUN EVALUATE-PREDICATE-PROPOSITION (SELF)
  (CL:LET*
   ((DESCRIPTION (GET-DESCRIPTION (%OPERATOR SELF)))
    (COMPUTATION (LOOKUP-CONSTRAINT-FUNCTION DESCRIPTION)) (SUCCESS? CL:NIL))
   (CL:WHEN (CL:NOT (CL:EQ COMPUTATION NULL))
    (CL:SETQ SUCCESS?
   ...
   (CL:WHEN (CL:NOT (CL:EQ COMPUTATION NULL))
    (CL:SETQ SUCCESS?
     (EQL? (COMPUTE-RELATION-VALUE SELF COMPUTATION CL:NIL) TRUE-WRAPPER))
    (ASSIGN-TRUTH-VALUE SELF (CL:IF SUCCESS? TRUE-WRAPPER FALSE-WRAPPER)))))
         ...
         (CL:PROGN
          (CL:LET* ((*FILLINGCONSTRAINTPROPAGATIONQUEUES?* CL:T))
           ...
           (CL:LET*
            ((P NULL)
             (ITER-000
              (%THE-CONS-LIST (%DEFERRED-DEFAULT-PROPOSITIONS ENVIRONMENT))))
            (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-000 NIL)) DO
             (CL:SETQ P (%%VALUE ITER-000))
       ...
       (CL:LOOP WHILE (CL:< INDEX-000 LENGTH-000) DO
        ...
        (CL:WHEN (ISA? ARG SGT-PROPAGATE-STELLA-SURROGATE)
         (CL:LET* ((VALUE (VALUE-OF ARG)))
          (CL:WHEN (CL:NOT (CL:EQ VALUE NULL)) (ELABORATE-INSTANCE VALUE))))
        (CL:SETQ INDEX-000 (CL:1+ INDEX-000)))))
...
(CL:DEFUN POST-RELATED-FACTS (SELF ENVIRONMENT)
  (CL:LET* ((TEST-VALUE-000 (SAFE-PRIMARY-TYPE SELF)))
   (CL:COND
    ((SUBTYPE-OF? TEST-VALUE-000 SGT-PROPAGATE-LOGIC-LOGIC-OBJECT)
     (CL:PROGN
      (CL:IF (MEMBER? (%ELABORATED-OBJECTS ENVIRONMENT) SELF)
    ...
    ((SUBTYPE-OF? TEST-VALUE-000 SGT-PROPAGATE-LOGIC-PROPOSITION)
     (CL:PROGN
      (CL:WHEN
       (CL:NOT (CL:EQ (LOOKUP (%EVALUATION-STATES ENVIRONMENT) SELF) NULL))
       (CL:RETURN-FROM POST-RELATED-FACTS))
...
(CL:DEFUN HELP-COLLECT-FACTS (SELF FACTS BEENTHERE INCLUDEUNKNOWN?)
  (CL:LET* ((TEST-VALUE-000 (SAFE-PRIMARY-TYPE SELF)))
   (CL:COND
    ((SUBTYPE-OF? TEST-VALUE-000 SGT-PROPAGATE-LOGIC-LOGIC-OBJECT)
     (CL:PROGN
      (CL:IF (MEMBER? BEENTHERE SELF) (CL:RETURN-FROM HELP-COLLECT-FACTS)
...
(CL:DEFUN RETRACT-FACTS-OF-INSTANCE (SELF)
  ...
  (CL:LET*
   ((P NULL)
    (ITER-000 (%THE-CONS-LIST (ALL-FACTS-OF-INSTANCE SELF CL:NIL CL:T))))
   (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-000 NIL)) DO
    (CL:SETQ P (%%VALUE ITER-000))
    (CL:TAGBODY
     (CL:COND
     ...
     (CL:LET*
      ...
      (CL:WHEN (CL:NOT (CL:EQ EXPLODEDSTRING NULL))
       (CL:LET* ((TABLE (NEW-KEY-VALUE-LIST)) (SENTENCE ""))
        ...
        (CL:LET*
         ((VBL NULL) (ITER-000 (%THE-CONS-LIST (%IO-VARIABLE-NAMES RELATION)))
          (ARG NULL) (VECTOR-000 (%ARGUMENTS SELF)) (INDEX-000 0)
          (LENGTH-000 (LENGTH VECTOR-000)))
         (CL:DECLARE (CL:TYPE CL:FIXNUM INDEX-000 LENGTH-000))
         (CL:LOOP WHILE
          ...
          (CL:SETQ ARG
           (CL:AREF (CL:THE CL:SIMPLE-VECTOR (%THE-ARRAY VECTOR-000))
            INDEX-000))
          (INSERT-AT TABLE VBL ARG) (CL:SETQ ITER-000 (%%REST ITER-000))
          (CL:SETQ INDEX-000 (CL:1+ INDEX-000))))
    ...
    (CL:LOOP WHILE (CL:OR UNBOUNDED?-000 (CL:<= ITER-001 UPPER-BOUND-000)) DO
     ...
     (CL:LET* ((SEED NULL) (ITER-003 (%THE-CONS-LIST SEEDS)))
      (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-003 NIL)) DO
       ...
       (CL:LET*
        ((PROP NULL)
         (ITER-004 (%THE-CONS-LIST (ALL-FACTS-OF-INSTANCE SEED CL:NIL CL:T))))
        (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-004 NIL)) DO
