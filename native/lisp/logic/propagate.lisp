...
(CL:DECLAIM
 (CL:SPECIAL *STARTUP-TIME-PHASE* STANDARD-ERROR
  DEFAULT-FALSE-TRUTH-VALUE *INVISIBLEASSERTION?* *MODULE*
  DEFAULT-TRUE-TRUTH-VALUE *TRACED-KEYWORDS* STANDARD-OUTPUT EOL
  NULL-INTEGER-WRAPPER NULL-INTEGER *MEMOIZATION-ENABLED?*
