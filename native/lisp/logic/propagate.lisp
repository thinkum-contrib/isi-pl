...
(CL:DECLAIM
  ...
  *MODULE* DEFAULT-TRUE-TRUTH-VALUE NULL-INTEGER STANDARD-OUTPUT EOL
  *COLLECTFORWARDPROPOSITIONS* *MEMOIZATION-ENABLED?*
  MEMOIZED-NULL-VALUE TRUE-WRAPPER FALSE-WRAPPER TRUE *CONTEXT* NIL
  FALSE))
...
(CL:DEFUN APPLY-FORWARD-RULES-TO-VECTOR (TRIGGERDESCRIPTION ARGUMENTS TRIGGERPROPOSITION)
  ...
  (CL:LET* ((RULES NULL) (INDICES NULL))
   ...
   (CL:LET*
    ((TOUCHEDDEFAULT? NULL) (R NULL) (ITER-001 (%THE-KV-LIST RULES)))
      ...
      (CL:LET* ((OUTPUTBINDINGS NULL) (TRUTHVALUES NULL))
       (CL:MULTIPLE-VALUE-SETQ (OUTPUTBINDINGS TRUTHVALUES)
        (APPLY-CACHED-RETRIEVE (%IO-VARIABLES FWDINDEX)
         ...
         (%CACHE-ID FWDINDEX)))
       (CL:LET*
        ((TV NULL) (OB NULL) (ITER-004 OUTPUTBINDINGS)
...
(CL:DEFUN REACT-TO-KB-UPDATE (CONTEXT OBJECT)
  (CL:LET*
   ((SKOLEM? FALSE) (PROPOSITION? FALSE) (METAPROPOSITION? FALSE))
    ...
    (CL:LET*
     ...
     (CL:LOOP WHILE (CL:< INDEX-000 LENGTH-000) DO
      ...
      (CL:IF (CL:EQ COLLECT-000 NULL)
       ...
       (CL:PROGN
        (CL:SETF (%%REST COLLECT-000) (CONS (VALUE-OF ARG) NIL))
...
(CL:DEFUN RETRACT-FACTS-OF-INSTANCE (SELF)
  ...
  (CL:LET*
   ((P NULL)
    (ITER-000
     (%THE-CONS-LIST (ALL-FACTS-OF-INSTANCE SELF FALSE TRUE))))
   (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-000 NIL)) DO
    (CL:PROGN (CL:SETQ P (%%VALUE ITER-000))
     (CL:SETQ ITER-000 (%%REST ITER-000)))
    (CL:TAGBODY
     ...
     (CL:LET* ((SEED NULL) (ITER-003 (%THE-CONS-LIST SEEDS)))
      (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-003 NIL)) DO
       ...
       (CL:LET*
        ((PROP NULL)
         (ITER-004
          (%THE-CONS-LIST (ALL-FACTS-OF-INSTANCE SEED FALSE TRUE))))
        (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-004 NIL)) DO
