...
(CL:DEFVAR SYM-EXPLANATIONS-LOGIC-DEPTH NULL)
...
(CL:DECLAIM
  ...
  *MOST-RECENT-QUERY* STANDARD-OUTPUT *CYC-KLUDGES-ENABLED?* *LOGIC-DIALECT*
  ...
  FALSE-WRAPPER NULL-INTEGER FALSE TRUE NIL))
  ...
  (CL:LET*
   ...
   (CL:LET* ((PHRASE NULL) (ITER-000 ENTRY))
    (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-000 NIL)) DO
     (CL:PROGN (CL:SETQ PHRASE (%%VALUE ITER-000))
      (CL:SETQ ITER-000 (%%REST ITER-000)))
     (CL:LET* ((TEST-VALUE-000 FALSE))
      (CL:LET* ((ALWAYS?-000 TRUE))
       (CL:LET* ((MOD NULL) (ITER-001 (%%REST PHRASE)))
        (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-001 NIL)) DO
         (CL:PROGN (CL:SETQ MOD (%%VALUE ITER-001))
          (CL:SETQ ITER-001 (%%REST ITER-001)))
         (CL:WHEN (CL:NOT (MEMB? MODIFIERS MOD)) (CL:SETQ ALWAYS?-000 FALSE)
          (CL:RETURN))))
...
(CL:DEFUN NEW-EXPLANATION-INFO ()
  (CL:LET* ((SELF NULL))
   ...
   (CL:SETF (%EXPLAINED? SELF) FALSE) (CL:SETF (%DEPTH SELF) NULL-INTEGER)
...
(CL:DEFUN ACCESS-EXPLANATION-INFO-SLOT-VALUE (SELF SLOTNAME VALUE SETVALUE?)
  (CL:COND
   ...
   ((CL:EQ SLOTNAME SYM-EXPLANATIONS-LOGIC-DEPTH)
...
(CL:DEFUN GET-EXPLANATION-INFO (SELF MAPPING CREATE?)
  (CL:LET* ((INFO (LOOKUP MAPPING SELF)))
   (CL:WHEN (CL:EQ INFO NULL)
    (CL:LET* ((INFO NULL) (JUST NULL) (ITER-000 (%THE-KV-LIST MAPPING)))
     (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-000 NULL)) DO
      (CL:SETQ JUST (%KEY ITER-000))
      (CL:PROGN (CL:SETQ INFO (%VALUE ITER-000))
       (CL:SETQ ITER-000 (%REST ITER-000)))
...
(CL:DEFUN LOOKUP-JUSTIFICATION (MAPPING LABEL)
  ...
  (CL:LET*
   ((INFO NULL) (JUSTIFICATION NULL) (ITER-000 (%THE-KV-LIST MAPPING)))
   (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-000 NULL)) DO
...
(CL:DEFUN RESET-MAPPING-FOR-SUBEXPLANATION (MAPPING)
  (CL:LET*
   ...
   (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-000 NULL)) DO
    ...
    (CL:PROGN (CL:SETQ INFO (%VALUE ITER-000))
     (CL:SETQ ITER-000 (%REST ITER-000)))
    (CL:SETQ JUSTIFICATION JUSTIFICATION) (CL:SETF (%EXPLAINED? INFO) FALSE))))
...
(CL:DEFUN PRINT-JUSTIFICATION-PROPOSITION-FOR-FORMAT (SELF STREAM INDENT)
  ...
  (CL:COND
   ...
   ((CL:EQ *EXPLANATION-FORMAT* KWD-EXPLANATIONS-HTML)
    (CL:LET* ((STRING-STREAM (NEW-OUTPUT-STRING-STREAM)) (QUOTEHTML? TRUE))
  ...
  (CL:LET*
   ...
   (CL:COND
    ...
    ((CL:EQ *EXPLANATION-FORMAT* KWD-EXPLANATIONS-HTML)
     ...
     (%%PRINT-STREAM (%NATIVE-STREAM STREAM) EOL))
    ((CL:EQ *EXPLANATION-FORMAT* KWD-EXPLANATIONS-XML)
     (%%PRINT-STREAM (%NATIVE-STREAM STREAM) "<method>" INFERENCE "</method>"
      EOL))
    (CL:T
     (CL:LET* ((STREAM-000 (NEW-OUTPUT-STRING-STREAM)))
      (%%PRINT-STREAM (%NATIVE-STREAM STREAM-000) "`" *EXPLANATION-FORMAT*
    ...
    (CL:WHEN (CL:NOT (CL:EQ SUBSTITUTION NULL))
     ...
     (CL:LET*
      ((I NULL-INTEGER) (VALUE NULL) (VAR NULL)
       (ITER-000 (%THE-KV-LIST SUBSTITUTION)) (ITER-001 1)
  ...
  (CL:LET*
   ...
   (CL:LET*
    ((I NULL-INTEGER) (ANTECEDENT NULL)
     (ITER-001 (%THE-CONS-LIST ANTECEDENTS)) (ITER-002 1))
     ...
     (CL:COND
      ((CL:EQ *EXPLANATION-FORMAT* KWD-EXPLANATIONS-ASCII)
       ...
       (CL:LET*
        ...
        (CL:DECLARE (CL:TYPE CL:FIXNUM ITER-003 UPPER-BOUND-000 I))
   ...
   (CL:LET* ((ANTECEDENT NULL) (ITER-004 NEWANTECEDENTS))
    (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-004 NIL)) DO
     (CL:PROGN (CL:SETQ ANTECEDENT (%%VALUE ITER-004))
...
following subtypes of EXPLAIN-EXCEPTION:
  ...
  (CL:CHECK-TYPE LABEL CL:SIMPLE-STRING)
  (CL:LET*
   ((QUERY *MOST-RECENT-QUERY*) (PARTIALQUERY? FALSE) (JUSTIFICATION NULL))
...
(CL:DEFUN PARSE-WHY-ARGUMENTS (ARGS)
  (CL:LET*
   ((LABEL STELLA::NULL-STRING) (DEPTH *DEFAULT-EXPLANATION-DEPTH*)
    (STYLE NULL) (SUMMARY? FALSE) (FIRSTARG (%%VALUE ARGS)))
   ...
   (CL:WHEN (CL:NOT (CL:EQ FIRSTARG NULL))
    ...
    (CL:LET* ((I NULL-INTEGER) (ARG NULL) (ITER-000 ARGS) (ITER-001 0))
     ...
     (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-000 NIL)) DO
      ...
      (CL:WHEN (COMMAND-OPTION-EQL? ARG "SUMMARY") (CL:SETQ SUMMARY? TRUE))
...
(CL:DEFUN HELP-STARTUP-EXPLANATIONS1 ()
  (CL:PROGN
   ...
   (CL:SETQ SYM-EXPLANATIONS-STELLA-LABEL
    (INTERN-RIGID-SYMBOL-WRT-MODULE "LABEL" (GET-STELLA-MODULE "/STELLA" TRUE)
     0))
   (CL:SETQ SYM-EXPLANATIONS-LOGIC-DEPTH
   ...
   EXPLAIN-QUERY-TRUE-EXCEPTION\")" (CL:FUNCTION GET-WHY-JUSTIFICATION) NULL)
    ...
    (CL:LET*
     ...
     (SET-DYNAMIC-SLOT-VALUE (%DYNAMIC-SLOTS FUNCTION)
      ...
      (WRAP-STRING "_Startup-Explanations") NULL-STRING-WRAPPER)))
