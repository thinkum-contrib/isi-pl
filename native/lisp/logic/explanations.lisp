...
(CL:DECLAIM
 (CL:SPECIAL *STARTUP-TIME-PHASE* *MODULE* ONE-WRAPPER *CHARACTER-TYPE-TABLE*
  *MOST-RECENT-QUERY* STANDARD-OUTPUT *CYC-KLUDGES-ENABLED?* *LOGIC-DIALECT*
  UNKNOWN-TRUTH-VALUE EOL *MOST-RECENT-EXPLANATION-MAPPING* TRUE-WRAPPER
...
(CL:DECLAIM
 (CL:FTYPE (CL:FUNCTION (CL:T) CL:SIMPLE-STRING) EXPLANATION-TRUTH-MARKER))
  ...
  (CL:LET* ((HOLDSBY NULL))
   ...
   (CL:COND
    ((CL:EQ *EXPLANATION-FORMAT* KWD-EXPLANATIONS-HTML)
     (CL:LET*
      ((LABEL "Fact:") (GREEN "#00ff00") (YELLOW "#ffd70") (RED "#ff0000")
       (COLOR STELLA::NULL-STRING))
      (CL:DECLARE (CL:TYPE CL:SIMPLE-STRING LABEL GREEN YELLOW RED COLOR))
      (CL:COND
       ((CL:EQ HOLDSBY KWD-EXPLANATIONS-ASSERTION)
        (CL:WHEN
         (CL:EQ (%KIND (%PROPOSITION JUSTIFICATION)) KWD-EXPLANATIONS-IMPLIES)
         (CL:SETQ LABEL "Rule:"))
        (CL:SETQ COLOR GREEN))
       ...
       ((CL:EQ HOLDSBY KWD-EXPLANATIONS-INFERENCE) (CL:SETQ LABEL "Inferred:")
        (CL:IF (PARTIALLY-FOLLOWS? JUSTIFICATION) (CL:SETQ COLOR YELLOW)
         (CL:SETQ COLOR GREEN)))
       (CL:T
      ...
      (CL:WHEN (CL:NOT (CL:EQ COLOR STELLA::NULL-STRING))
       (CL:SETQ LABEL
        (CONCATENATE "<font color=\"" COLOR "\">" "<strong>" LABEL "</strong>"
         "</font>")))
      LABEL))
    (CL:T
     (CL:COND
  ...
  (CL:LET*
   ((VOCABULARY
     (LOOKUP *EXPLANATION-VOCABULARIES*
      (CL:IF (CL:NOT (CL:EQ AUDIENCE NULL)) AUDIENCE *EXPLANATION-AUDIENCE*)))
   ...
   (CL:WHEN (CL:EQ ENTRY NULL)
    (CL:RETURN-FROM LOOKUP-EXPLANATION-PHRASE
     (LOOKUP-EXPLANATION-PHRASE KWD-EXPLANATIONS-UNKNOWN-RULE NIL AUDIENCE)))
      ...
      (CL:LET* ((ALWAYS?-000 CL:T))
       (CL:LET* ((MOD NULL) (ITER-001 (%%REST PHRASE)))
        (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-001 NIL)) DO
         ...
         (CL:WHEN (CL:NOT (MEMB? MODIFIERS MOD)) (CL:SETQ ALWAYS?-000 CL:NIL)
          (CL:RETURN))
...
(CL:DEFCLASS EXPLANATION-INFO (STANDARD-OBJECT)
  ((LABEL :TYPE CL:SIMPLE-STRING :INITFORM STELLA::NULL-STRING :ALLOCATION
    :INSTANCE :ACCESSOR %LABEL)
...
(CL:DEFUN NEW-EXPLANATION-INFO ()
  (CL:LET* ((SELF NULL))
   ...
   (CL:SETF (%EXPLAINED? SELF) CL:NIL) (CL:SETF (%DEPTH SELF) NULL-INTEGER)
...
(CL:DEFUN ACCESS-EXPLANATION-INFO-SLOT-VALUE (SELF SLOTNAME VALUE SETVALUE?)
  (CL:COND
   ...
   ((CL:EQ SLOTNAME SYM-EXPLANATIONS-LOGIC-EXPLAINED?)
    (CL:IF SETVALUE?
     (CL:SETF (%EXPLAINED? SELF) (COERCE-WRAPPED-BOOLEAN-TO-BOOLEAN VALUE))
   ...
   (CL:WHEN (CL:EQ INFO NULL)
    (CL:LET* ((JUST NULL) (INFO NULL) (ITER-000 (%THE-KV-LIST MAPPING)))
     (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-000 NULL)) DO
      ...
      (CL:WHEN (JUSTIFICATION-EQL? JUST SELF) (INSERT-AT MAPPING SELF INFO)
...
(CL:DEFUN LOOKUP-JUSTIFICATION (MAPPING LABEL)
  ...
  (CL:LET*
   ...
   (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-000 NULL)) DO
    (CL:SETQ JUSTIFICATION (%KEY ITER-000)) (CL:SETQ INFO (%VALUE ITER-000))
...
(CL:DEFUN RESET-MAPPING-FOR-SUBEXPLANATION (MAPPING)
  (CL:LET*
   ...
   (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-000 NULL)) DO
    (CL:SETQ JUSTIFICATION (%KEY ITER-000)) (CL:SETQ INFO (%VALUE ITER-000))
    (CL:SETQ JUSTIFICATION JUSTIFICATION) (CL:SETF (%EXPLAINED? INFO) CL:NIL)
    (CL:SETQ ITER-000 (%REST ITER-000)))))
...
(CL:DEFUN PRINT-ONE-EXPLANATION (SELF STREAM MAPPING MAXDEPTH UNEXPLAINED)
  ...
  (CL:COND
   ...
   (CL:T
    (CL:LET* ((STREAM-000 (NEW-OUTPUT-STRING-STREAM)))
     (%%PRINT-STREAM (%NATIVE-STREAM STREAM-000) "`" *EXPLANATION-FORMAT*
      "' is not a valid case option")
     (CL:ERROR (NEW-STELLA-EXCEPTION (THE-STRING-READER STREAM-000)))))))
  ...
  (CL:LET* ((*INDENTCOUNTER* INDENT) (*PRINTMODE* KWD-EXPLANATIONS-REALISTIC))
   ...
   (CL:LET* ((PROPOSITION (%PROPOSITION SELF)))
    (CL:WHEN (%REVERSE-POLARITY? SELF)
     (CL:SETQ PROPOSITION (CREATE-PROPOSITION SYM-EXPLANATIONS-STELLA-NOT 1))
     (CL:LET
...
(CL:DEFUN PRINT-EXPLANATION-HEADER (SELF STREAM MAPPING)
  (CL:LET*
   ...
   (CL:COND
    ...
    (CL:T
     (CL:LET* ((STREAM-001 (NEW-OUTPUT-STRING-STREAM)))
      (%%PRINT-STREAM (%NATIVE-STREAM STREAM-001) "`" *EXPLANATION-FORMAT*
       "' is not a valid case option")
      (CL:ERROR (NEW-STELLA-EXCEPTION (THE-STRING-READER STREAM-001))))))
...
(CL:DEFUN PRINT-EXPLANATION-TEXT (SELF STREAM MAPPING)
  (CL:LET*
   ((INTRODUCTION "") (INFERENCE STELLA::NULL-STRING) (AMPLIFICATION "")
    (MODIFIERS NIL) (MODIFIERS+ (CONS KWD-EXPLANATIONS-AMPLIFICATION NIL)))
   (CL:DECLARE
   ...
   (CL:COND
    ((FAILED-GOAL-JUSTIFICATION? SELF)
     (CL:SETQ INTRODUCTION
      (LOOKUP-EXPLANATION-PHRASE KWD-EXPLANATIONS-FAILED MODIFIERS NULL)))
    ((ISA? SELF SGT-EXPLANATIONS-LOGIC-CLASH-JUSTIFICATION)
     (CL:SETQ INTRODUCTION
      (LOOKUP-EXPLANATION-PHRASE KWD-EXPLANATIONS-INCONSISTENT MODIFIERS
       NULL)))
    (CL:T
     (CL:SETQ INTRODUCTION
      (LOOKUP-EXPLANATION-PHRASE KWD-EXPLANATIONS-FOLLOWS MODIFIERS NULL))))
   (CL:COND
    ((CL:EQ (%INFERENCE-RULE SELF) KWD-EXPLANATIONS-PRIMITIVE-STRATEGY)
     ...
     (CL:WHEN (CL:EQ INFERENCE STELLA::NULL-STRING)
      (CL:SETQ INFERENCE
       (LOOKUP-EXPLANATION-PHRASE (INFERENCE-STRATEGY SELF) MODIFIERS NULL))))
    (CL:T
     (CL:SETQ INFERENCE
   ...
   ((SATELLITE (%PROPOSITION SELF))
    (MASTER
     (DYNAMIC-SLOT-VALUE (%DYNAMIC-SLOTS SATELLITE)
      SYM-EXPLANATIONS-LOGIC-MASTER-PROPOSITION NULL))
    (HEAD
     (CL:AREF (CL:THE CL:SIMPLE-VECTOR (%THE-ARRAY (%ARGUMENTS SATELLITE)))
      1))
    (TAIL
     (CL:AREF (CL:THE CL:SIMPLE-VECTOR (%THE-ARRAY (%ARGUMENTS SATELLITE)))
      0))
    ...
    (CL:WHEN (EQL? (VALUE-OF VAR) VAR)
     ...
     (CL:COND
      ((CL:AND (CL:NOT (CL:EQ VALUE NULL))
       ...
       (%%PRINT-STREAM (%NATIVE-STREAM STREAM) "{")
       (CL:LET*
        ((BINDING NULL) (ITER-000 (ALLOCATE-ITERATOR (%BINDINGS VALUE))))
     ...
     (CL:WHEN (EQL? (VALUE-OF VAR) VAR)
      ...
      (CL:COND
       ((CL:AND (CL:NOT (CL:EQ VALUE NULL))
        ...
        (CL:LET*
         ((BINDING NULL) (ITER-001 (ALLOCATE-ITERATOR (%BINDINGS VALUE))))
    ...
    (CL:WHEN (CL:NOT (CL:EQ SUBSTITUTION NULL))
     ...
     (CL:LET*
      ...
      (CL:LOOP WHILE
       ...
       DO (CL:SETQ VAR (%KEY ITER-000)) (CL:SETQ VALUE (%VALUE ITER-000))
  ...
  (CL:LET*
   ...
   (CL:LET*
    ...
    (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-001 NIL)) DO
     ...
     (CL:WHEN
      (CL:NOT
       (CL:OR (%EXPLAINED? INFO) (MARK-AS-EXPLICIT-ASSERTION? ANTECEDENT)
        (MARK-AS-FAILED-GOAL? ANTECEDENT)
     ...
     (CL:COND
      ((CL:EQ *EXPLANATION-FORMAT* KWD-EXPLANATIONS-ASCII)
       ...
       (CL:LET*
        ...
        (CL:LOOP WHILE (CL:OR UNBOUNDED?-000 (CL:<= ITER-003 UPPER-BOUND-000))
      ...
      ((CL:EQ *EXPLANATION-FORMAT* KWD-EXPLANATIONS-HTML)
       (%%PRINT-STREAM (%NATIVE-STREAM STREAM) "<TR>" EOL)
       (CL:PROGN
        (%%PRINT-STREAM (%NATIVE-STREAM STREAM) "<TD align=right valign=top>")
        (%%PRINT-STREAM (%NATIVE-STREAM STREAM)
         (CL:IF (CL:= I 1) "since&nbsp;" "and&nbsp;"))
        (PRINT-EXPLANATION-LABEL STREAM LABEL CL:NIL)
        (CL:PROGN
      ...
      (CL:IF HAVEMARKEDANTECEDENT?
       (CL:+ PROPOSITIONSTARTPOSITION
        (CL:1+
         (CL:THE CL:FIXNUM
          (CL:LENGTH
           (CL:THE CL:SIMPLE-STRING (EXPLANATION-TRUTH-MARKER ANTECEDENT))))))
   ...
   (CL:LET* ((ANTECEDENT NULL) (ITER-004 NEWANTECEDENTS))
    (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-004 NIL)) DO
     (CL:SETQ ANTECEDENT (%%VALUE ITER-004)) (PUSH UNEXPLAINED ANTECEDENT)
      ...
      (CL:COND
       ((CL:EQ TEST-VALUE-000 KWD-EXPLANATIONS-AND-INTRODUCTION)
        (CL:IF (CL:EQ *EXPLANATION-STYLE* KWD-EXPLANATIONS-BRIEF)
         (CL:LET*
          ((SUBANTECEDENT NULL)
           (ITER-001 (%THE-CONS-LIST (VISIBLE-ANTECEDENTS ANTECEDENT))))
          (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-001 NIL)) DO
       ...
       ((CL:EQ TEST-VALUE-000 KWD-EXPLANATIONS-PRIMITIVE-STRATEGY)
        (CL:COND
         ((CL:EQ (%STRATEGY ANTECEDENT) KWD-EXPLANATIONS-EQUIVALENCE)
          (CL:WHEN
           (CL:NOT
            (AUXILIARY-EQUIVALENCE-PROPOSITION? (%PROPOSITION ANTECEDENT)))
           (PUSH VISIBLEANTECEDENTS ANTECEDENT)))
...
(CL:DEFUN EXPLAIN-WHY (LABEL STYLE MAXDEPTH STREAM)
  ...
  (CL:HANDLER-CASE
   (CL:LET* ((JUSTIFICATION (GET-WHY-JUSTIFICATION LABEL)))
    (CL:LET*
     ((*EXPLANATION-STYLE*
       (CL:IF (CL:NOT (CL:EQ STYLE NULL)) STYLE KWD-EXPLANATIONS-BRIEF)))
   ...
   (CL:LET* ((JUSTIFICATIONS (FORWARD-JUSTIFICATIONS PROP)))
    (CL:WHEN (CL:NOT (CL:EQ JUSTIFICATIONS NULL))
     (CL:LET*
      ...
      (CL:DECLARE
       (CL:SPECIAL *EXPLANATION-STYLE* *MOST-RECENT-EXPLANATION-MAPPING*))
      (CL:LET*
       ((JUSTIFICATION NULL) (ITER-000 (%THE-CONS-LIST JUSTIFICATIONS)))
       (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-000 NIL)) DO
        (CL:SETQ JUSTIFICATION (%%VALUE ITER-000))
        (CL:SETQ *MOST-RECENT-EXPLANATION-MAPPING* NULL)
        (PRINT-EXPLANATION JUSTIFICATION STREAM
         *MOST-RECENT-EXPLANATION-MAPPING* MAXDEPTH *EXPLANATION-AUDIENCE*)
        (CL:SETQ ITER-000 (%%REST ITER-000)))))))
   (EXPLAIN-EXCEPTION (EE)
    (%%PRINT-STREAM (%NATIVE-STREAM STANDARD-OUTPUT) (EXCEPTION-MESSAGE EE)))))
...
following subtypes of EXPLAIN-EXCEPTION:
  ...
  (CL:CHECK-TYPE LABEL CL:SIMPLE-STRING)
  (CL:LET*
   ((QUERY *MOST-RECENT-QUERY*) (PARTIALQUERY? CL:NIL) (JUSTIFICATION NULL))
   (CL:WHEN (CL:EQ QUERY NULL)
    (CL:ERROR
     (NEW-EXPLAIN-NO-QUERY-EXCEPTION "There is nothing to explain.")))
   (CL:SETQ PARTIALQUERY?
    (CL:NOT (CL:EQ (%PARTIAL-MATCH-STRATEGY *MOST-RECENT-QUERY*) NULL)))
   ...
   (CL:COND
    ((CL:EQ JUSTIFICATION NULL)
     (CL:COND
      ((NON-EMPTY? (%SOLUTIONS QUERY))
       (CL:IF (%EXHAUSTED? QUERY)
        (CL:LET* ((STREAM-000 (NEW-OUTPUT-STRING-STREAM)))
         ...
         (CL:ERROR
          (NEW-EXPLAIN-NO-SOLUTION-EXCEPTION (THE-STRING-READER STREAM-000))))
        (CL:LET* ((STREAM-001 (NEW-OUTPUT-STRING-STREAM)))
         (%%PRINT-STREAM (%NATIVE-STREAM STREAM-001)
          "No justifications available.  You have to enable justifications"
          EOL "   with `(set-feature justifications)' and rerun the query in"
      ...
      (CL:T
       (CL:ERROR
        (NEW-EXPLAIN-NO-SOLUTION-EXCEPTION "There is no solution yet.")))))
  ...
  (CL:LET* ((TEST-VALUE-000 (SAFE-PRIMARY-TYPE ARG)))
   (CL:COND
    ...
    ((SUBTYPE-OF-STRING? TEST-VALUE-000)
     (CL:PROGN (STRING-EQL? (STRING-UPCASE (%WRAPPER-VALUE ARG)) OPTION)))
    (CL:T CL:NIL))))
   ...
   (CL:WHEN (CL:NOT (CL:EQ FIRSTARG NULL))
    ...
    (CL:LET* ((ARG NULL) (ITER-000 ARGS) (I NULL-INTEGER) (ITER-001 0))
     ...
     (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-000 NIL)) DO
      ...
      (CL:WHEN (COMMAND-OPTION-EQL? ARG "ALL") (CL:SETQ DEPTH NULL-INTEGER))
      (CL:SETQ ITER-000 (%%REST ITER-000))
      (CL:SETQ ITER-001 (CL:1+ ITER-001)))))
...
(CL:DEFUN HELP-STARTUP-EXPLANATIONS1 ()
  (CL:PROGN
   ...
   (CL:SETQ SYM-EXPLANATIONS-STELLA-LABEL
    (INTERN-RIGID-SYMBOL-WRT-MODULE "LABEL" (GET-STELLA-MODULE "/STELLA" CL:T)
     0))
   (CL:SETQ SYM-EXPLANATIONS-STELLA-DEPTH
    (INTERN-RIGID-SYMBOL-WRT-MODULE "DEPTH" (GET-STELLA-MODULE "/STELLA" CL:T)
     0))
...
following subtypes of EXPLAIN-EXCEPTION:
   ...
   (CL:LET*
    ((FUNCTION (LOOKUP-FUNCTION SYM-EXPLANATIONS-LOGIC-STARTUP-EXPLANATIONS)))
...
proposition will be printed on the same line.\")")
    ...
    (DEFINE-EXPLANATION-PHRASE KWD-EXPLANATIONS-FOLLOWS KWD-EXPLANATIONS-LAY
     "is true")
    (DEFINE-EXPLANATION-PHRASE KWD-EXPLANATIONS-FOLLOWS
     KWD-EXPLANATIONS-TECHNICAL "is partially true" KWD-EXPLANATIONS-PARTIAL)
    (DEFINE-EXPLANATION-PHRASE KWD-EXPLANATIONS-FOLLOWS KWD-EXPLANATIONS-LAY
     "is true to some part" KWD-EXPLANATIONS-PARTIAL)
    (DEFINE-EXPLANATION-PHRASE KWD-EXPLANATIONS-HOLDS
     KWD-EXPLANATIONS-TECHNICAL "holds")
    (DEFINE-EXPLANATION-PHRASE KWD-EXPLANATIONS-HOLDS KWD-EXPLANATIONS-LAY
     "is true")
    ...
    (DEFINE-EXPLANATION-PHRASE KWD-EXPLANATIONS-FAILED KWD-EXPLANATIONS-LAY
     "could not be proven")
    ...
    (DEFINE-EXPLANATION-PHRASE KWD-EXPLANATIONS-CLASH
     KWD-EXPLANATIONS-TECHNICAL "because it and its negation were inferred")
    (DEFINE-EXPLANATION-PHRASE KWD-EXPLANATIONS-CLASH KWD-EXPLANATIONS-LAY
     "because opposite conclusions were reached")
