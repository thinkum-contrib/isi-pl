...
(CL:DEFVAR SYM-OPTIMIZE-LOGIC-EQUIVALENT-VALUE NULL)
...
(CL:DEFVAR KWD-OPTIMIZE-PRESUME-TRUE NULL)
(CL:DEFVAR KWD-OPTIMIZE-ASSERT-TRUE NULL)
...
(CL:DECLAIM
 (CL:SPECIAL *STARTUP-TIME-PHASE* *COLLECTFORWARDPROPOSITIONS*
  DEFAULT-TRUE-TRUTH-VALUE TRUE-TRUTH-VALUE ZERO-VARIABLES-VECTOR *PRINTMODE*
  TRUE-PROPOSITION *QUERY-OPTIMIZATION-STRATEGY* NULL-FLOAT-WRAPPER
  *TRACED-KEYWORDS* STANDARD-OUTPUT EOL TRUE-WRAPPER FALSE-WRAPPER NULL-FLOAT
  *MODULE* NIL ONE-WRAPPER ZERO-WRAPPER NIL-LIST NULL-INTEGER
  *REVERSEPOLARITY?* *CONTEXT* TRUE *QUERYITERATOR* FALSE))
        ...
        (CL:LET* ((ALWAYS?-001 TRUE))
         (CL:LET*
          ...
          (CL:LOOP WHILE (CL:< INDEX-001 LENGTH-001) DO
           ...
           (CL:WHEN (CL:NOT (ARGUMENT-BOUND? V)) (CL:SETQ ALWAYS?-001 FALSE)
            (CL:RETURN))))
  ...
  (CL:LET* ((DESCRIPTION (GET-DESCRIPTION (%OPERATOR GOAL))))
   (CL:AND (CL:NOT (CL:EQ DESCRIPTION NULL))
    (CL:OR (COMPUTED-TERM? DESCRIPTION)
     (MEMBER?
      (GET-QUOTED-TREE
       "((/PL-KERNEL-KB/@LISTOF /PL-KERNEL-KB/@SETOF) \"/LOGIC\")" "/LOGIC")
     ...
     (CL:EQ
      (ACCESS-IN-CONTEXT
       (DYNAMIC-SLOT-VALUE (%DYNAMIC-SLOTS SELF)
        SYM-OPTIMIZE-LOGIC-EQUIVALENT-VALUE NULL)
     ...
     (CL:PROGN
      (CL:LET* ((BOUNDTOVALUE (ARGUMENT-BOUND-TO COLLECTION)))
       (CL:COND
        ...
        ((CL:NOT (CL:EQ (%DEFINING-PROPOSITION COLLECTION) NULL)) TRUE)
        (CL:T FALSE)))))
...
(CL:DEFVAR *DISTRIBUTEDOPENGOAL?* FALSE
...
(CL:DEFUN DISTRIBUTE-OPEN-GOAL (GOAL)
  (CL:LET* ((*DISTRIBUTEDOPENGOAL?* FALSE))
     ...
     ((CL:EQ TEST-VALUE-000 KWD-OPTIMIZE-IMPLIES)
      (CL:LET*
       ...
       (CL:LOOP WHILE (CL:< INDEX-002 LENGTH-002) DO
        ...
        (HELP-DISTRIBUTE-GOAL ARG GOAL TRUE))))
     (CL:T)))
...
(CL:DEFUN ESTIMATE-CARDINALITY-OF-EXTENSION (DESCRIPTION)
  ...
  (CL:LET* ((ESTIMATE (ACCESS-OBSERVED-CARDINALITY DESCRIPTION)))
   ...
   (CL:WHEN
    (CL:AND (NULL? ESTIMATE) (CL:NOT (CL:EQ (%EXTENSION DESCRIPTION) NULL)))
...
(CL:DEFUN ESTIMATE-PREDICATE-GOAL-FANOUT (GOAL)
  ...
  (CL:LET*
   ...
   (CL:LET* ((TEST-VALUE-000 FALSE))
    (CL:LET* ((FOUND?-000 FALSE))
     (CL:LET*
      ((IBIT NULL) (GBIT NULL) (VECTOR-000 GOALVECTOR) (INDEX-000 0)
       (LENGTH-000 (LENGTH VECTOR-000))
   ...
   (CL:LET* ((ALLBITSMATCH? FALSE))
    (CL:LET*
     ((UNIQUENESSKEY NULL)
      (ITER-000 (%THE-CONS-LIST (GET-UNIQUENESS-VECTORS DESCRIPTION))))
     (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-000 NIL)) DO
      (CL:PROGN (CL:SETQ UNIQUENESSKEY (%%VALUE ITER-000))
       (CL:SETQ ITER-000 (%%REST ITER-000)))
      (CL:SETQ ALLBITSMATCH? TRUE)
      (CL:LET*
       ((GBIT NULL) (UBIT NULL) (VECTOR-002 UNIQUENESSKEY) (INDEX-002 0)
        (LENGTH-002 (LENGTH VECTOR-002)) (VECTOR-003 GOALVECTOR) (INDEX-003 0)
       ...
       (CL:LOOP WHILE
        ...
        (CL:WHEN (CL:AND (CL:EQ UBIT TRUE-WRAPPER) (CL:EQ GBIT FALSE-WRAPPER))
         (CL:SETQ ALLBITSMATCH? FALSE) (CL:RETURN))))
...
(CL:DEFUN EXTRACT-OPEN-GOAL-CLUSTERS (OPENGOALS OPENGOALCLUSTERS)
  (CL:LET*
   ((ALLGOALS (COPY-CONS-LIST (%THE-CONS-LIST OPENGOALS)))
    ...
    (CURRENTCLUSTERVARSGREW? FALSE) (UNBOUNDGOALVARS (NEW-LIST)))
   (CL:LOOP (CLEAR CURRENTCLUSTERVARS)
    ...
    (CL:SETQ REMAININGGOALS (%%REST REMAININGGOALS))
    (CL:LOOP (CL:SETQ CURRENTCLUSTERVARSGREW? FALSE)
        ...
        (CL:LET* ((VAR NULL) (ITER-000 (%THE-CONS-LIST UNBOUNDGOALVARS)))
         (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-000 NIL)) DO
          (CL:PROGN (CL:SETQ VAR (%%VALUE ITER-000))
           (CL:SETQ ITER-000 (%%REST ITER-000)))
          (CL:WHEN (MEMBER? CURRENTCLUSTERVARS VAR) (CL:SETQ FOUND?-000 TRUE)
           (CL:RETURN))))
         ...
         (CL:LET* ((VAR NULL) (ITER-001 (%THE-CONS-LIST UNBOUNDGOALVARS)))
          (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-001 NIL)) DO
           ...
           (CL:WHEN (CL:NOT (MEMBER? CURRENTCLUSTERVARS VAR))
            ...
            (CL:SETQ CURRENTCLUSTERVARSGREW? TRUE)))))))
    ...
    ((CL:>= (LENGTH CLUSTERS) 2) (CLEAR OPENGOALS)
     ...
     (CL:LET*
      ...
      (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-002 NIL)) DO
       (CL:PROGN (CL:SETQ CLUSTER (%%VALUE ITER-002))
...
(CL:DEFUN COMPUTE-OPEN-GOAL-ORDERING (ANDPROPOSITION OPENGOALS GOALSEQUENCE)
  (CL:LET*
    ...
    (CL:LET* ((*EVALUATIONMODE* KWD-OPTIMIZE-DESCRIPTION))
     ...
     (CL:LET*
      ((CLUSTER NULL) (ITER-000 (%THE-CONS-LIST OPENGOALCLUSTERS))
       (COLLECT-000 NULL))
      (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-000 NIL)) DO
       (CL:PROGN (CL:SETQ CLUSTER (%%VALUE ITER-000))
        (CL:SETQ ITER-000 (%%REST ITER-000)))
       (CL:IF (CL:EQ COLLECT-000 NULL)
        (CL:PROGN
         (CL:SETQ COLLECT-000
   ...
   (CL:LET* ((GOAL NULL) (ITER-002 (%THE-CONS-LIST OPENGOALS)))
    (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-002 NIL)) DO
     (CL:PROGN (CL:SETQ GOAL (%%VALUE ITER-002))
      (CL:SETQ ITER-002 (%%REST ITER-002)))
   ...
   (CL:LET*
    ...
    (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-003 NIL)) DO
     (CL:PROGN (CL:SETQ PROP (%%VALUE ITER-003))
        ...
        (CL:PROGN
         (CL:SETQ ARG
          (CL:AREF (CL:THE CL:SIMPLE-VECTOR (%THE-ARRAY VECTOR-001))
           INDEX-001))
         (CL:SETQ INDEX-001 (CL:1+ INDEX-001)))
        (CL:WHEN (ARGUMENT-BOUND? ARG) (CL:SETQ FOUND?-000 TRUE)
         (CL:RETURN))))
      (CL:WHEN FOUND?-000
       (PROPAGATE-SINGLE-VALUED-CONSTRAINTS G GOALSEQUENCE)))))
...
(CL:DEFUN REORDER-GOALS (ANDPROPOSITION INITIALLYCLOSEDGOALS GOALSEQUENCE RESIDUEGOALS)
  (CL:LET*
   ...
   (CL:LET* ((G NULL) (ITER-002 (%THE-CONS-LIST RESIDUEGOALS)))
    (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-002 NIL)) DO
     (CL:PROGN (CL:SETQ G (%%VALUE ITER-002))
      (CL:SETQ ITER-002 (%%REST ITER-002)))
     (CL:LET ((SELF (%THE-ARRAY ARGUMENTS)) (VALUE G) (POSITION INDEX))
      (CL:DECLARE (CL:TYPE CL:SIMPLE-VECTOR SELF)
       (CL:TYPE CL:FIXNUM POSITION))
   ...
   (CL:WHEN (CL:< INDEX ORIGINALNUMBEROFARGUMENTS)
    ...
    (CL:LET*
     ...
     (CL:DECLARE
      (CL:TYPE CL:FIXNUM INDEX-000 LENGTH-000 ITER-003 UPPER-BOUND-000 I))
     (CL:LOOP WHILE
...
(CL:DEFUN SIMULATE-GOAL-EVALUATION (GOAL)
  (CL:LET* ((ARGUMENTS (%ARGUMENTS GOAL)) (OK? FALSE))
   (CL:LET* ((TEST-VALUE-000 (%KIND GOAL)))
    (CL:COND
     ((CL:EQ TEST-VALUE-000 KWD-OPTIMIZE-FUNCTION)
     ...
     ((CL:EQ TEST-VALUE-000 KWD-OPTIMIZE-ISA) (CL:SETQ OK? TRUE))
     ((CL:EQ TEST-VALUE-000 KWD-OPTIMIZE-EQUIVALENT)
      (CL:SETQ OK?
       (CL:OR
        (ARGUMENT-BOUND?
...
(CL:DEFUN OPTIMIZE-QUERY (DESCRIPTION BOOLEANVECTOR PARENTFRAME)
  (CL:LET*
   ...
   (CL:LET*
    ((INITIALLYBOUND? NULL) (IOVAR NULL)
     (VECTOR-000 (%IO-VARIABLES DESCRIPTION)) (INDEX-000 0)
     (LENGTH-000 (LENGTH VECTOR-000)) (VECTOR-001 BOOLEANVECTOR) (INDEX-001 0)
     (LENGTH-001 (LENGTH VECTOR-001)))
...
(CL:DEFUN SELECT-OPTIMAL-QUERY-PATTERN (DESCRIPTION BOOLEANVECTOR PARENTFRAME)
  (CL:LET* ((PATTERN NULL) (QUERYPATTERNS (%QUERY-PATTERNS DESCRIPTION)))
   ...
   (CL:LET* ((*BOUNDTOOFFSETCOUNTER* 0))
    ...
    (CL:SETQ PATTERN (COPY-DESCRIPTION DESCRIPTION NULL TRUE)))
   ...
   (SIMPLIFY-DESCRIPTION PATTERN TRUE) PATTERN))
    ...
    (CL:T
     (CL:LET*
      ((PATTERNARGS NIL) (RELATION (%OPERATOR GOAL))
       ...
       (UNBOUNDARGINDEX NULL-INTEGER) (KEY NULL) (RELATIONEXTENSION? TRUE)
        ...
        (CL:COND
         ((CL:NOT (CL:EQ KEY NULL))
          (CL:WHEN (INSTANCE-HAS-BACKLINKS? KEY)
           (CL:SETQ RELATIONEXTENSION? FALSE)))
...
(CL:DEFUN DYNAMICALLY-ESTIMATE-EXTENSION-SIZE (DESCRIPTION)
  ...
  (CL:LET* ((ESTIMATE NULL-FLOAT))
   ...
   (CL:WHEN (CL:= ESTIMATE NULL-FLOAT)
    (CL:SETQ ESTIMATE
     (CL:FLOAT (ESTIMATED-LENGTH (GET-DESCRIPTION-EXTENSION DESCRIPTION TRUE))
      0.0d0)))
   ESTIMATE))
(CL:DECLAIM
 (CL:FTYPE (CL:FUNCTION (CL:T) CL:DOUBLE-FLOAT)
     ...
     (CL:LET* ((PENALTY NULL-FLOAT) (MINPENALTY NULL-FLOAT))
      ...
      (CL:LET*
       ...
       (CL:LOOP WHILE (CL:< INDEX-000 LENGTH-000) DO
        ...
        (CL:WHEN (CL:< PENALTY MINPENALTY) (CL:SETQ MINPENALTY PENALTY))))
      MINPENALTY))
    ((CL:EQ TEST-VALUE-000 KWD-OPTIMIZE-OR)
...
(CL:DEFUN COPY-LIST-TO-ARGUMENTS-VECTOR (ARGUMENTS)
  (CL:LET* ((VECTOR (NEW-VECTOR (LENGTH ARGUMENTS))))
   (CL:LET*
    ((I NULL-INTEGER) (ARG NULL) (ITER-000 (%THE-CONS-LIST ARGUMENTS))
     (ITER-001 0))
       ...
       (CL:WHEN TEST-VALUE-001 (CL:SETQ TEST-VALUE-001 (TYPE? INTYPE))
        (CL:WHEN TEST-VALUE-001
         ...
         (CL:WHEN TEST-VALUE-001
          (CL:LET* ((FOUND?-000 FALSE))
           (CL:LET*
            ((ARGTYPE NULL) (ARG NULL) (VECTOR-000 (%ARGUMENTS OTHERCONJUNCT))
             ...
             (CL:PROGN
              (CL:SETQ ARG
               (CL:AREF (CL:THE CL:SIMPLE-VECTOR (%THE-ARRAY VECTOR-000))
                INDEX-000))
              (CL:SETQ INDEX-000 (CL:1+ INDEX-000)))
             (CL:PROGN (CL:SETQ ARGTYPE (%%VALUE ITER-000))
              (CL:SETQ ITER-000 (%%REST ITER-000)))
             (CL:WHEN
      ...
      (CL:COND
       ...
       ((CL:EQ TEST-VALUE-000 KWD-OPTIMIZE-ISA)
        (CL:LET* ((VALUE-000 NULL))
         (CL:LET*
          ((I NULL-INTEGER) (OTHERCONJ NULL)
           (ITER-000 (%THE-CONS-LIST CONJUNCTSLIST)) (ITER-001 0))
          (CL:DECLARE (CL:TYPE CL:FIXNUM ITER-001 I))
          (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-000 NIL)) DO
           (CL:PROGN (CL:SETQ OTHERCONJ (%%VALUE ITER-000))
            (CL:SETQ ITER-000 (%%REST ITER-000)))
           (CL:PROGN (CL:SETQ I ITER-001) (CL:SETQ ITER-001 (CL:1+ ITER-001)))
           (CL:WHEN
...
(CL:DEFUN COPY-DESCRIPTION (SELF PARENTMAPPING ADDBACKLINKS?)
  (CL:LET*
   ...
   (CL:DECLARE (CL:SPECIAL *CONTEXT* *MODULE*))
   (CL:LET*
    ((COPY (CREATE-DESCRIPTION NULL-INTEGER FALSE))
     (MAPPING (NEW-KEY-VALUE-LIST)))
    (CL:WHEN (CL:NOT (CL:EQ PARENTMAPPING NULL))
     (CL:LET* ((V NULL) (K NULL) (ITER-000 (%THE-KV-LIST PARENTMAPPING)))
      ...
      ((EXTERNALVARSCOPY
        (COPY-VARIABLES-VECTOR
         (DYNAMIC-SLOT-VALUE (%DYNAMIC-SLOTS SELF)
          SYM-OPTIMIZE-LOGIC-EXTERNAL-VARIABLES NULL)
         MAPPING))
       (REALEXTERNALVARS NIL))
      (CL:LET* ((FOUND?-000 FALSE))
       (CL:LET*
        ((COPY NULL) (VECTOR-000 EXTERNALVARSCOPY) (INDEX-000 0)
         (LENGTH-000 (LENGTH VECTOR-000)))
        (CL:DECLARE (CL:TYPE CL:FIXNUM INDEX-000 LENGTH-000))
        (CL:LOOP WHILE (CL:< INDEX-000 LENGTH-000) DO
         (CL:PROGN
          (CL:SETQ COPY
           (CL:AREF (CL:THE CL:SIMPLE-VECTOR (%THE-ARRAY VECTOR-000))
            INDEX-000))
          (CL:SETQ INDEX-000 (CL:1+ INDEX-000)))
         (CL:WHEN (CL:NOT (VARIABLE? COPY)) (CL:SETQ FOUND?-000 TRUE)
          (CL:RETURN))))
       (CL:WHEN FOUND?-000
        (CL:LET*
         ((COPY NULL) (VECTOR-001 EXTERNALVARSCOPY) (INDEX-001 0)
          ...
          (CL:PROGN
           (CL:SETQ COPY
            (CL:AREF (CL:THE CL:SIMPLE-VECTOR (%THE-ARRAY VECTOR-001))
             INDEX-001))
           (CL:SETQ INDEX-001 (CL:1+ INDEX-001)))
          (CL:WHEN (VARIABLE? COPY)
           (CL:IF (CL:EQ COLLECT-000 NULL)
            (CL:PROGN (CL:SETQ COLLECT-000 (CONS COPY NIL))
             (CL:IF (CL:EQ REALEXTERNALVARS NIL)
              (CL:SETQ REALEXTERNALVARS COLLECT-000)
              (ADD-CONS-TO-END-OF-CONS-LIST REALEXTERNALVARS COLLECT-000)))
            (CL:PROGN (CL:SETF (%%REST COLLECT-000) (CONS COPY NIL))
             (CL:SETQ COLLECT-000 (%%REST COLLECT-000)))))))
        (CL:IF (CL:NOT (CL:EQ REALEXTERNALVARS NIL))
         (CL:SETQ EXTERNALVARSCOPY
          (COPY-CONS-LIST-TO-VARIABLES-VECTOR REALEXTERNALVARS))
         (CL:SETQ EXTERNALVARSCOPY NULL))))
...
(CL:DEFUN COPY-VARIABLE (SELF MAPPING)
  (CL:LET* ((COPY (LOOKUP MAPPING SELF)))
   ...
   (CL:SETQ COPY
    (CREATE-VARIABLE (%SKOLEM-TYPE SELF) (%SKOLEM-NAME SELF) FALSE))
   (CL:COND
   ...
   (CL:WHEN
    (%WRAPPER-VALUE
     (DYNAMIC-SLOT-VALUE (%DYNAMIC-SLOTS SELF) SYM-OPTIMIZE-LOGIC-DESCRIPTIVE?
      FALSE-WRAPPER))
    (SET-DYNAMIC-SLOT-VALUE (%DYNAMIC-SLOTS COPY)
     SYM-OPTIMIZE-LOGIC-DESCRIPTIVE? (CL:IF TRUE TRUE-WRAPPER FALSE-WRAPPER)
     FALSE-WRAPPER))
   (CL:WHEN
    (%WRAPPER-VALUE
     (DYNAMIC-SLOT-VALUE (%DYNAMIC-SLOTS SELF)
      SYM-OPTIMIZE-LOGIC-DONT-OPTIMIZE? FALSE-WRAPPER))
    (SET-DYNAMIC-SLOT-VALUE (%DYNAMIC-SLOTS COPY)
     SYM-OPTIMIZE-LOGIC-DONT-OPTIMIZE? (CL:IF TRUE TRUE-WRAPPER FALSE-WRAPPER)
     FALSE-WRAPPER))
   (CL:WHEN
    (CL:NOT
     (CL:EQ
        ...
        (CL:NOT
         (CL:EQ
          (DYNAMIC-SLOT-VALUE (%DYNAMIC-SLOTS SELF)
           SYM-OPTIMIZE-LOGIC-EXTERNAL-VARIABLES NULL)
          NULL))
        (CL:LET* ((COPY (COPY-DESCRIPTION SELF MAPPING TRUE)))
         (INSERT-AT MAPPING SELF COPY) COPY)
        SELF)))
     ((SUBTYPE-OF? TEST-VALUE-001 SGT-OPTIMIZE-LOGIC-PATTERN-VARIABLE)
      (CL:PROGN
...
(CL:DEFUN INHERIT-FUNCTION-PROPOSITION (SELF MAPPING)
  (CL:LET*
   ...
   (CL:LET*
    ((I NULL-INTEGER) (ARG NULL) (VECTOR-000 (%ARGUMENTS SELF)) (INDEX-000 0)
     (LENGTH-000 (LENGTH VECTOR-000)) (ITER-000 1) (COLLECT-000 NULL))
    (CL:DECLARE (CL:TYPE CL:FIXNUM INDEX-000 LENGTH-000 ITER-000 I))
    (CL:LOOP WHILE (CL:< INDEX-000 LENGTH-000) DO
     (CL:PROGN
      (CL:SETQ ARG
     ...
     (CL:WHEN (CL:<= I NOFINPUTARGS)
      (CL:SETQ ARGMAPSTO (MAPPED-VALUE-OF ARG MAPPING FALSE))
      ...
      (CL:IF (CL:EQ COLLECT-000 NULL)
       ...
       (CL:PROGN (CL:SETF (%%REST COLLECT-000) (CONS ARGMAPSTO NIL))
        (CL:SETQ COLLECT-000 (%%REST COLLECT-000)))))))
   (CL:SETQ COPY (CREATE-FUNCTION-PROPOSITION (%OPERATOR SELF) INPUTARGS))
   COPY))
  ...
  (CL:LET*
   ((INHERITEDVALUE
     (CL:IF (CL:NOT (CL:EQ MAPPING NULL))
      (MAPPED-VALUE-OF INHERITEDARG MAPPING FALSE) INHERITEDARG))
    (BASEVALUE (VALUE-OF BASEARG)))
   (CL:WHEN (EQL? INHERITEDVALUE BASEVALUE)
    (CL:RETURN-FROM EQUAL-UP-TO-SKOLEM-IDENTITY? TRUE))
   FALSE))
...
(CL:DEFUN FIND-SIMILAR-PROPOSITION (PROPOSITION MAPPING)
  ...
  (CL:LET*
   ((KIND (%KIND PROPOSITION)) (OPERATOR (%OPERATOR PROPOSITION))
    (ARGMAPSTO NULL) (DEPENDENTSLIST NULL) (HASDISCOURAGEDARGUMENT? FALSE))
   (CL:LET*
    ((ARG NULL) (VECTOR-000 (%ARGUMENTS PROPOSITION)) (INDEX-000 0)
     (LENGTH-000 (LENGTH VECTOR-000)))
    (CL:DECLARE (CL:TYPE CL:FIXNUM INDEX-000 LENGTH-000))
    (CL:LOOP WHILE (CL:< INDEX-000 LENGTH-000) DO
     (CL:PROGN
      ...
      (CL:SETQ INDEX-000 (CL:1+ INDEX-000)))
     (CL:TAGBODY
      (CL:WHEN FALSE (CL:SETQ HASDISCOURAGEDARGUMENT? TRUE) (CL:GO :CONTINUE))
      (CL:LET* ((MAPSTO (MAPPED-VALUE-OF ARG MAPPING FALSE)))
       (CL:WHEN
           ...
           (CL:LET* ((TEST-VALUE-001 FALSE))
            ...
            (CL:WHEN TEST-VALUE-001
             ...
             (CL:WHEN TEST-VALUE-001
              (CL:LET* ((ALWAYS?-001 TRUE))
               (CL:LET*
                ((ARG2 NULL) (ARG1 NULL) (VECTOR-002 (%ARGUMENTS PROPOSITION))
    ...
    ((SUBTYPE-OF? TEST-VALUE-000 SGT-OPTIMIZE-LOGIC-DESCRIPTION)
     (CL:PROGN
      (CL:IF (NAMED-DESCRIPTION? ARGUMENT) ARGUMENT
       (COPY-DESCRIPTION ARGUMENT MAPPING TRUE))))
    ((SUBTYPE-OF? TEST-VALUE-000 SGT-OPTIMIZE-LOGIC-PATTERN-VARIABLE)
     (CL:PROGN (MAPPED-VALUE-OF ARGUMENT MAPPING TRUE)))
    ((SUBTYPE-OF-SURROGATE? TEST-VALUE-000)
     (CL:PROGN
      (CL:IF
       ...
       ARGUMENT (%SURROGATE-VALUE ARGUMENT))))
    (CL:T ARGUMENT))))
...
(CL:DEFUN INHERIT-PROPOSITION (SELF MAPPING)
  ...
  (CL:LET* ((MATCHINGPROPOSITION (LOOKUP MAPPING SELF)))
   ...
   (CL:SETQ MATCHINGPROPOSITION (FIND-SIMILAR-PROPOSITION SELF MAPPING))
   (CL:WHEN (CL:NOT (CL:EQ MATCHINGPROPOSITION NULL))
...
(CL:DEFUN INHERIT-AS-TOP-LEVEL-PROPOSITION (PROPOSITION MAPPING)
  (CL:LET* ((RESULTLIST NIL))
   (CL:WHEN (CL:EQ MAPPING NULL) (CL:SETQ MAPPING (NEW-KEY-VALUE-LIST)))
   (CL:LET* ((TEST-VALUE-000 (%KIND PROPOSITION)))
    (CL:COND
     ((CL:EQ TEST-VALUE-000 KWD-OPTIMIZE-AND)
      (CL:LET*
   ...
   (CL:LET* ((P NULL) (ITER-000 RESULTLIST))
    (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-000 NIL)) DO
     (CL:PROGN (CL:SETQ P (%%VALUE ITER-000))
      (CL:SETQ ITER-000 (%%REST ITER-000)))
     (NORMALIZE-PROPOSITION P)))
   RESULTLIST))

;;; (DEFUN MAP-AND-ENQUEUE-VARIABLE ...)
   ...
   ((SUBTYPE-OF? (SAFE-PRIMARY-TYPE VARIABLE)
    ...
    (CL:PROGN
     (CL:LET* ((MAPSTOVALUE (LOOKUP MAPPING VARIABLE)))
      ...
      (CL:COND ((CL:NOT (CL:EQ MAPSTOVALUE NULL)))
       ...
       (CL:T
        (CL:LET*
         ...
         (INSERT-AT MAPPING VARIABLE SKOLEM) (PUSH QUEUE VARIABLE)))))))
   (CL:T)))
...
(CL:DEFUN INHERIT-DESCRIPTION-PROPOSITIONS (ARGUMENTS DESCRIPTION)
  (CL:LET*
   ...
   (CL:LET*
    ((ARG NULL) (V NULL) (VECTOR-000 (%IO-VARIABLES DESCRIPTION))
     (INDEX-000 0) (LENGTH-000 (LENGTH VECTOR-000)) (VECTOR-001 ARGUMENTS)
     (INDEX-001 0) (LENGTH-001 (LENGTH VECTOR-001)))
    (CL:DECLARE (CL:TYPE CL:FIXNUM INDEX-000 LENGTH-000 INDEX-001 LENGTH-001))
    (CL:LOOP WHILE
     (CL:AND (CL:< INDEX-000 LENGTH-000) (CL:< INDEX-001 LENGTH-001)) DO
     ...
     (CL:PROGN
      (CL:SETQ ARG
       (CL:AREF (CL:THE CL:SIMPLE-VECTOR (%THE-ARRAY VECTOR-001)) INDEX-001))
      (CL:SETQ INDEX-001 (CL:1+ INDEX-001)))
     (MAP-AND-ENQUEUE-VARIABLE V ARG MAPPING VARIABLEQUEUE)))
   (CL:LET*
    ((V NULL) (VECTOR-002 (%INTERNAL-VARIABLES DESCRIPTION)) (INDEX-002 0)
     (LENGTH-002 (LENGTH VECTOR-002)) (COLLECT-000 NULL))
    (CL:DECLARE (CL:TYPE CL:FIXNUM INDEX-002 LENGTH-002))
    (CL:LOOP WHILE (CL:< INDEX-002 LENGTH-002) DO
     (CL:PROGN
      (CL:SETQ V
     ...
     (CL:IF (CL:EQ COLLECT-000 NULL)
      (CL:PROGN (CL:SETQ COLLECT-000 (CONS V NIL))
       (CL:IF (CL:EQ (%THE-CONS-LIST VARIABLEQUEUE) NIL)
        (CL:SETF (%THE-CONS-LIST VARIABLEQUEUE) COLLECT-000)
        (ADD-CONS-TO-END-OF-CONS-LIST (%THE-CONS-LIST VARIABLEQUEUE)
         COLLECT-000)))
      (CL:PROGN (CL:SETF (%%REST COLLECT-000) (CONS V NIL))
       (CL:SETQ COLLECT-000 (%%REST COLLECT-000))))))
   (COLLECT-STRUCTURAL-FUNCTIONS (%PROPOSITION DESCRIPTION)
    STRUCTURALFUNCTIONS)
     ...
     (CL:LET*
      ...
      (CL:LOOP WHILE (NEXT? ITER-000) DO (CL:SETQ P (%VALUE ITER-000))
       (CL:WHEN (MEMBER? STRUCTURALFUNCTIONS P)
        (MAP-FUNCTIONAL-VALUE P MAPPING VARIABLEQUEUE))))))
   (CL:LET*
    ((PROPOSITIONS
       ...
       (CL:LOOP WHILE (CL:< INDEX-000 LENGTH-000) DO
        ...
        (CL:IF (CL:EQ COLLECT-000 NULL)
         (CL:PROGN (CL:SETQ COLLECT-000 (CONS ARG NIL))
          (CL:IF (CL:EQ ARGSLIST NIL) (CL:SETQ ARGSLIST COLLECT-000)
           (ADD-CONS-TO-END-OF-CONS-LIST ARGSLIST COLLECT-000)))
         (CL:PROGN (CL:SETF (%%REST COLLECT-000) (CONS ARG NIL))
          (CL:SETQ COLLECT-000 (%%REST COLLECT-000))))))
      (UPDATE-TUPLE (%SURROGATE-VALUE-INVERSE DESCRIPTION) ARGSLIST
       (CL:IF DEFAULTTRUE? KWD-OPTIMIZE-PRESUME-TRUE
        KWD-OPTIMIZE-ASSERT-TRUE)))))
  ...
  (CL:PROGN
   ...
   (CL:SETQ SGT-OPTIMIZE-PL-KERNEL-KB-ABSTRACT
    (INTERN-RIGID-SYMBOL-WRT-MODULE "ABSTRACT"
     (GET-STELLA-MODULE "/PL-KERNEL-KB" TRUE) 1))
   (CL:SETQ SYM-OPTIMIZE-LOGIC-EQUIVALENT-VALUE
  ...
  (CL:PROGN
   ...
   (CL:SETQ SGT-OPTIMIZE-STELLA-VECTOR
    (INTERN-RIGID-SYMBOL-WRT-MODULE "VECTOR"
     (GET-STELLA-MODULE "/STELLA" TRUE) 1))
   (CL:SETQ KWD-OPTIMIZE-PRESUME-TRUE
    (INTERN-RIGID-SYMBOL-WRT-MODULE "PRESUME-TRUE" NULL 2))
   (CL:SETQ KWD-OPTIMIZE-ASSERT-TRUE
...
(CL:DEFUN HELP-STARTUP-OPTIMIZE3 ()
  (CL:PROGN (CL:SETQ *DISTRIBUTEDOPENGOAL?* FALSE)
   (CL:SETQ V-0-0
   ...
   (CL:SETQ *POSTOPTIMIZATION?* FALSE)))
...
(CL:DEFUN HELP-STARTUP-OPTIMIZE5 ()
  (CL:PROGN
   ...
   (DEFINE-FUNCTION-OBJECT "MAP-AND-ENQUEUE-VARIABLE"
    "(DEFUN MAP-AND-ENQUEUE-VARIABLE ((VARIABLE OBJECT) (LOCALVALUE OBJECT) (MAPPING ENTITY-MAPPING) (QUEUE LIST)))"
   ...
   (DEFINE-FUNCTION-OBJECT "MAP-FUNCTIONAL-VALUE"
    "(DEFUN MAP-FUNCTIONAL-VALUE ((PROPOSITION PROPOSITION) (MAPPING ENTITY-MAPPING) (QUEUE LIST)))"
   ...
   (CL:LET* ((FUNCTION (LOOKUP-FUNCTION SYM-OPTIMIZE-LOGIC-STARTUP-OPTIMIZE)))
    (SET-DYNAMIC-SLOT-VALUE (%DYNAMIC-SLOTS FUNCTION)
     ...
     (WRAP-STRING "_Startup-Optimize") NULL-STRING-WRAPPER))))
