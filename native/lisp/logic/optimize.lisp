...
(CL:DECLAIM
  ...
  *QUERY-OPTIMIZATION-STRATEGY* NULL-FLOAT-WRAPPER *TRACED-KEYWORDS*
  ...
  ONE-WRAPPER ZERO-WRAPPER NIL-LIST NULL-INTEGER *REVERSEPOLARITY?*
  *CONTEXT* NIL *QUERYITERATOR*))
...
(CL:DEFUN HAS-INVERSIONS? (GOAL)
  (CL:NOT
   (CL:EQ
    (DYNAMIC-SLOT-VALUE
     (%DYNAMIC-SLOTS (GET-DESCRIPTION (%OPERATOR GOAL)))
   ...
   (CL:WHEN (CL:EQ OPERATOR SGT-OPTIMIZE-PL-KERNEL-KB-HOLDS)
    (CL:LET*
     ((RELATIONARG
       (ARGUMENT-BOUND-TO
        (CL:AREF
         (CL:THE CL:SIMPLE-VECTOR (%THE-ARRAY (%ARGUMENTS GOAL))) 0))))
     (CL:COND
...
(CL:DEFUN RELATION-SUPPORTS-EXTENSION? (SELF)
  (CL:AND
   ...
   (CL:NOT
    (LOGICAL-SUBTYPE-OF-LITERAL? (%SURROGATE-VALUE-INVERSE SELF)))))
  ...
  (CL:LET*
   ...
   (CL:LET*
    ...
    (CL:LOOP WHILE (CL:<= ITER-000 UPPER-BOUND-000) DO
     ...
     (CL:LET*
      ((GOALRECORD
        (CL:AREF (CL:THE CL:SIMPLE-VECTOR (%THE-ARRAY STACK)) I)))
      (CL:WHEN (CL:EQ GOALRECORD NULL)
       (CL:SETQ GOALRECORD (NEW-GOAL-RECORD))
       (CL:LET
        ((SELF (%THE-ARRAY STACK)) (VALUE GOALRECORD) (POSITION I))
...
(CL:DEFUN ESTIMATE-PREDICATE-GOAL-FANOUT (GOAL)
  ...
  (CL:LET*
   ((DESCRIPTION (GET-DESCRIPTION (%OPERATOR GOAL)))
    (GOALVECTOR
     (ARGUMENTS-VECTOR-TO-BOOLEAN-VECTOR (%ARGUMENTS GOAL))))
   (CL:WHEN (CL:EQ DESCRIPTION NULL)
    ...
    ((CL:EQ TEST-VALUE-000 KWD-OPTIMIZE-EQUIVALENT)
     (CL:IF
      (CL:OR
       ...
       (ARGUMENT-BOUND?
        (CL:AREF
         (CL:THE CL:SIMPLE-VECTOR (%THE-ARRAY (%ARGUMENTS GOAL))) 1)))
      1.0d0 NULL-FLOAT))
    ((CL:OR (CL:EQ TEST-VALUE-000 KWD-OPTIMIZE-NOT)
      (CL:EQ TEST-VALUE-000 KWD-OPTIMIZE-FAIL))
     NULL-FLOAT)
...
(CL:DEFUN CHEAPEST-GENERATOR-GOAL (VARIABLE)
  (CL:WHEN
   ...
   (%%PRINT-STREAM (%NATIVE-STREAM STANDARD-OUTPUT) EOL "CHEAPEST: "
    VARIABLE " GENERATORS: " (%GENERATOR-GOALS (GOAL-RECORD VARIABLE))
    EOL))
  (CL:LET*
   ...
   (CL:LET*
    ((GOAL NULL)
     (ITER-000
      (%THE-CONS-LIST (%GENERATOR-GOALS (GOAL-RECORD VARIABLE)))))
    (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-000 NIL)) DO
   ...
   (CL:IF (CL:NOT (CL:= BESTFANOUT NULL-FLOAT))
    (CL:PROGN
     (CL:WHEN
      (CL:AND (CL:NOT (CL:EQ *TRACED-KEYWORDS* NULL))
       (MEMB? *TRACED-KEYWORDS* KWD-OPTIMIZE-OPTIMIZER))
      (%%PRINT-STREAM (%NATIVE-STREAM STANDARD-OUTPUT) "  SELECTED: "
       BESTGOAL "  " BESTCOST "  " BESTFANOUT EOL))
...
(CL:DEFUN SIMULATE-BIND-VARIABLE-AND-PROPAGATE-CONSTRAINTS (VARIABLE GOALSEQUENCE)
  (CL:LET* ((GOALRECORD (GOAL-RECORD VARIABLE)))
   ...
   (CL:LET*
    ((G NULL)
     (ITER-000 (%THE-CONS-LIST (%GENERATOR-GOALS GOALRECORD))))
    (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-000 NIL)) DO
     (CL:SETQ G (%%VALUE ITER-000))
     (PROPAGATE-SINGLE-VALUED-CONSTRAINTS G GOALSEQUENCE)
     (CL:SETQ ITER-000 (%%REST ITER-000))))
   (CL:LET*
    ((G NULL) (ITER-001 (%THE-CONS-LIST (%OTHER-GOALS GOALRECORD))))
...
(CL:DEFUN COMPUTE-GREEDY-OPEN-GOAL-ORDERING (OPTIMIZERVARIABLES NUMBEROFOPENGOALS GOALSEQUENCE PRIORCOST PRIORFANOUT)
  ...
  (CL:LET*
   ...
   (CL:LOOP (CL:SETQ BESTGENERATORGOAL NULL)
    ...
    (CL:LET*
     ((VBL NULL) (ITER-000 (%THE-CONS-LIST OPTIMIZERVARIABLES)))
     (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-000 NIL)) DO
      (CL:SETQ VBL (%%VALUE ITER-000))
      (CL:TAGBODY
       (CL:WHEN (CL:NOT (VARIABLE-BOUND? VBL))
    ...
    (CL:LOOP (CL:SETQ CURRENTCLUSTERVARSGREW? CL:NIL)
     ...
     (CL:LOOP WHILE (CL:NOT (CL:EQ CURSOR NIL)) DO
      ...
      (CL:WHEN (CL:NOT (CL:EQ GOAL NULL)) (CLEAR UNBOUNDGOALVARS)
       ...
       (CL:LET* ((FOUND?-000 CL:NIL))
        (CL:LET*
         ((VAR NULL) (ITER-000 (%THE-CONS-LIST UNBOUNDGOALVARS)))
         (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-000 NIL)) DO
        ...
        (CL:WHEN FOUND?-000 (PUSH CURRENTCLUSTER GOAL)
         ...
         (CL:LET*
          ((VAR NULL) (ITER-001 (%THE-CONS-LIST UNBOUNDGOALVARS)))
          (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-001 NIL)) DO
        ...
        (CL:PROGN (CL:SETQ COLLECT-000 (CONS CLUSTER NIL))
         (CL:IF (CL:EQ (%THE-CONS-LIST OPENGOALCLUSTERS) NIL)
          ...
          (ADD-CONS-TO-END-OF-CONS-LIST
           (%THE-CONS-LIST OPENGOALCLUSTERS) COLLECT-000)))
       ...
       (CL:IF (CL:EQ COLLECT-000 NULL)
        (CL:PROGN
         ...
         (CL:IF (CL:EQ (%THE-CONS-LIST CLUSTERPROPOSITIONS) NIL)
          ...
          (ADD-CONS-TO-END-OF-CONS-LIST
           (%THE-CONS-LIST CLUSTERPROPOSITIONS) COLLECT-000)))
        (CL:PROGN
         (CL:SETF (%%REST COLLECT-000)
          (CONS
           (CL:IF (CL:> (LENGTH CLUSTER) 1)
    ...
    (CL:LOOP WHILE (CL:< INDEX-000 LENGTH-000) DO
     ...
     (CL:COND
      ...
      ((CL:OR (HAS-DISJUNCTION? G)
        (CL:EQ (%KIND G) KWD-OPTIMIZE-FORALL))
  ...
  (CL:LET* ((ARGUMENTS (%ARGUMENTS GOAL)) (OK? CL:NIL))
   (CL:LET* ((TEST-VALUE-000 (%KIND GOAL)))
    (CL:COND
     ...
     ((CL:EQ TEST-VALUE-000 KWD-OPTIMIZE-PREDICATE)
      (CL:IF
       (CL:EQ (%OPERATOR GOAL) SGT-OPTIMIZE-PL-KERNEL-KB-MEMBER-OF)
       (CL:SETQ OK?
        (ARGUMENT-BOUND?
         (CL:AREF (CL:THE CL:SIMPLE-VECTOR (%THE-ARRAY ARGUMENTS)) 1)))
...
(CL:DEFUN SIMULATE-AND-OPTIMIZE-QUERY (PROPOSITION)
  (CL:LET*
   ((ARGUMENTS (%ARGUMENTS PROPOSITION)) (KIND (%KIND PROPOSITION)))
...
(CL:DEFUN OPTIMIZE-QUERY (DESCRIPTION BOOLEANVECTOR PARENTFRAME)
  (CL:LET*
   ...
   (CL:SETF (%STATE FRAME) KWD-OPTIMIZE-PATTERN)
...
(CL:DEFUN SELECT-OPTIMAL-QUERY-PATTERN (DESCRIPTION BOOLEANVECTOR PARENTFRAME)
  (CL:LET*
   ((PATTERN NULL) (QUERYPATTERNS (%QUERY-PATTERNS DESCRIPTION)))
...
(CL:DEFUN DYNAMICALLY-ESTIMATE-INFERENCE-COST (SELF)
  (CL:LET*
   ...
   (CL:COND
    ...
    (CL:T
     (CL:SETQ MEMOIZED-VALUE-000
      (WRAP-INTEGER
       (LENGTH
        (APPLICABLE-RULES-OF-DESCRIPTION SELF KWD-OPTIMIZE-BACKWARD
         CL:T))))
     (CL:WHEN *MEMOIZATION-ENABLED?*
   ...
   (CL:LET* ((NOFRULES MEMOIZED-VALUE-000))
    (MAX (CL:* INFERABLE-PENALTY-COST (%WRAPPER-VALUE NOFRULES))
     1.0d0))))
    ...
    (CL:T
     (CL:LET*
      ((PATTERNARGS NIL) (RELATION (%OPERATOR GOAL))
       (ARGUMENTS (%ARGUMENTS GOAL)) (FIRSTARGINDEX 0)
...
(CL:DECLAIM
 (CL:FTYPE (CL:FUNCTION (CL:T) CL:FIXNUM) COUNT-BOUND-ARGUMENTS))
    ...
    ((CL:EQ TEST-VALUE-000 KWD-OPTIMIZE-ISA)
     (CL:AND
      (EQL?
       (CL:AREF
        (CL:THE CL:SIMPLE-VECTOR
         (%THE-ARRAY (%ARGUMENTS OTHERCONJUNCT)))
        0)
       (CL:AREF
        (CL:THE CL:SIMPLE-VECTOR (%THE-ARRAY (%ARGUMENTS ISACONJUNCT)))
        0))
    ...
    ((CL:OR (CL:EQ TEST-VALUE-000 KWD-OPTIMIZE-FUNCTION)
     ...
     (CL:LET*
      ((INMEMBER
        (CL:AREF
         (CL:THE CL:SIMPLE-VECTOR
          (%THE-ARRAY (%ARGUMENTS ISACONJUNCT)))
         0))
       ...
       (CL:WHEN TEST-VALUE-001 (CL:SETQ TEST-VALUE-001 (TYPE? INTYPE))
        (CL:WHEN TEST-VALUE-001
         (CL:SETQ TEST-VALUE-001
          (SURROGATE? (%OPERATOR OTHERCONJUNCT)))
         (CL:WHEN TEST-VALUE-001
          (CL:LET* ((FOUND?-000 CL:NIL))
           (CL:LET*
            ((ARG NULL) (VECTOR-000 (%ARGUMENTS OTHERCONJUNCT))
             (INDEX-000 0) (LENGTH-000 (LENGTH VECTOR-000))
             (ARGTYPE NULL)
             (ITER-000
              (%THE-CONS-LIST
       ...
       ((CL:EQ TEST-VALUE-000 KWD-OPTIMIZE-ISA)
        (CL:LET* ((VALUE-000 NULL))
         ...
         (CL:LET* ((DOMINATINGCONJUNCT VALUE-000))
          (CL:WHEN
           (CL:OR
            (CL:EQ (%OPERATOR CONJUNCT) SGT-OPTIMIZE-STELLA-THING)
            (CL:NOT (CL:EQ DOMINATINGCONJUNCT NULL)))
           (CL:WHEN (CL:NOT (CL:EQ CONJUNCT DOMINATINGCONJUNCT))
            (CL:LET*
             ((ARG NULL) (VECTOR-002 (%ARGUMENTS CONJUNCT))
              (INDEX-002 0) (LENGTH-002 (LENGTH VECTOR-002)))
             (CL:DECLARE (CL:TYPE CL:FIXNUM INDEX-002 LENGTH-002))
             (CL:LOOP WHILE (CL:< INDEX-002 LENGTH-002) DO
              (CL:SETQ ARG
   ...
   (CL:WHEN (MEMBER? CONJUNCTSLIST TRUE-PROPOSITION)
    ...
    (CL:CASE (LENGTH CONJUNCTSLIST)
     ...
     (1 (OVERLAY-PROPOSITION ANDPROPOSITION (FIRST CONJUNCTSLIST))
      (CL:LET*
       ((ARG NULL) (VECTOR-003 (%ARGUMENTS ANDPROPOSITION))
  ...
  (CL:LET*
   ...
   (CL:LET*
    ...
    (CL:WHEN (CL:NOT (CL:EQ PARENTMAPPING NULL))
     (CL:LET*
      ((K NULL) (V NULL) (ITER-000 (ALLOCATE-ITERATOR PARENTMAPPING)))
   ...
   (CL:COND
    ...
    (CL:T
     (CL:LET*
      ((COPYNAME
        (CONCATENATE "?CP_"
         (SUBSEQUENCE (%SYMBOL-NAME (%SKOLEM-NAME SELF)) 1
          NULL-INTEGER))))
...
(CL:DEFUN COPY-PROPOSITION (SELF MAPPING)
  (CL:LET* ((COPY (LOOKUP MAPPING SELF)))
   ...
   (CL:SETF (%HOME-CONTEXT COPY) *MODULE*)
   (CL:SETF (%KIND COPY) (%KIND SELF))
  ...
  (CL:LET* ((VALUE-000 NULL))
   (CL:LET*
    ...
    (CL:LOOP WHILE (NEXT? ITER-000) DO (CL:SETQ P (%VALUE ITER-000))
     (CL:WHEN
      (CL:AND
       (CL:EQ (%OPERATOR P) SGT-OPTIMIZE-PL-KERNEL-KB-EQUIVALENT)
       (CL:OR
        (EQL?
    ...
    (CL:LOOP WHILE (CL:< INDEX-000 LENGTH-000) DO
     ...
     (CL:WHEN (CL:<= I NOFINPUTARGS)
      ...
      (CL:IF (CL:EQ COLLECT-000 NULL)
       (CL:PROGN
        (CL:SETQ COLLECT-000
         (CONS (INHERIT-PROPOSITION-ARGUMENT ARGMAPSTO SELF MAPPING)
          NIL))
...
(CL:DEFUN OLD-FIND-SIMILAR-PROPOSITION (PROPOSITION MAPPING)
  ...
  (CL:LET*
   ((KIND (%KIND PROPOSITION)) (OPERATOR (%OPERATOR PROPOSITION))
    (ARGMAPSTO NULL) (DEPENDENTSLIST NULL)
            ...
            (CL:WHEN TEST-VALUE-000
             ...
             (CL:WHEN TEST-VALUE-000
              (CL:LET* ((ALWAYS?-000 CL:T))
               (CL:LET*
                ((ARG1 NULL)
                 (ITER-001 (BUT-LAST (%ARGUMENTS PROPOSITION)))
              ...
              (CL:LET* ((ALWAYS?-001 CL:T))
               (CL:LET*
                ((ARG1 NULL) (VECTOR-002 (%ARGUMENTS PROPOSITION))
                 (INDEX-002 0) (LENGTH-002 (LENGTH VECTOR-002))
                 (ARG2 NULL) (VECTOR-003 (%ARGUMENTS P)) (INDEX-003 0)
                 (LENGTH-003 (LENGTH VECTOR-003)))
                (CL:DECLARE
                ...
                (CL:LOOP WHILE
                 ...
                 (CL:SETQ ARG2
                  (CL:AREF
                   (CL:THE CL:SIMPLE-VECTOR (%THE-ARRAY VECTOR-003))
                   INDEX-003))
                 (CL:WHEN
                  (CL:NOT
                   (EQUAL-UP-TO-SKOLEM-IDENTITY? ARG1 ARG2 MAPPING))
...
(CL:DEFUN NEW-FIND-SIMILAR-PROPOSITION (PROPOSITION MAPPING)
  ...
  (CL:LET*
   ((INDEX
     (WRAP-INTEGER
      (PROPOSITION-HASH-INDEX PROPOSITION MAPPING CL:NIL)))
   ...
   (CL:LET*
    ((OPERATOR (%OPERATOR PROPOSITION))
     (ARGUMENTS (%ARGUMENTS PROPOSITION)) (ARITY (LENGTH ARGUMENTS)))
...
(CL:DEFUN FIND-SIMILAR-PROPOSITION (PROPOSITION MAPPING)
  (CL:LET*
   ((RESULT (NEW-FIND-SIMILAR-PROPOSITION PROPOSITION MAPPING))) RESULT))
    ...
    (CL:WHEN (CL:NOT (CL:EQ DUPLICATE NULL))
     (CL:LET*
      ...
      (CL:LOOP WHILE (CL:< INDEX-000 LENGTH-000) DO
       ...
       (CL:SETQ I ITER-000)
       (CL:LET
        ((SELF (%THE-ARRAY (%ARGUMENTS DUPLICATE))) (VALUE ARG)
         (POSITION I))
        (CL:DECLARE (CL:TYPE CL:SIMPLE-VECTOR SELF)
         (CL:TYPE CL:FIXNUM POSITION))
        (CL:SETF (CL:AREF SELF POSITION) VALUE))
...
(CL:DEFUN INHERIT-PROPOSITION (SELF MAPPING)
    ...
    ((CL:EQ TEST-VALUE-000 KWD-OPTIMIZE-FUNCTION)
     (CL:LET*
      ...
      (CL:IF
       (EQL?
        (CL:AREF
         (CL:THE CL:SIMPLE-VECTOR (%THE-ARRAY (%ARGUMENTS COPY)))
  ...
  (CL:LET*
   ...
   (CL:SETF (%KIND COPY) (%KIND SELF))
   (CL:SETF (%OPERATOR COPY) OPERATOR)
   (CL:SETF (%ARGUMENTS COPY)
      ...
      ((CL:EQ TEST-VALUE-000 KWD-OPTIMIZE-AND)
       ...
       (CL:LET*
        ((SKOLEM NULL)
         (ITER-000
          (%THE-CONS-LIST
           (LOOKUP MAPPING KWD-OPTIMIZE-CREATED-SKOLEMS))))
        (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-000 NIL)) DO
         (CL:SETQ SKOLEM (%%VALUE ITER-000))
         (INSERT CREATEDSKOLEMS SKOLEM)
         (CL:SETQ ITER-000 (%%REST ITER-000))))
       (CL:LET*
        ((IPROP NULL) (ITER-001 INHERITEDPROPS)
         (IPROPINDEX NULL-INTEGER) (ITER-002 0) (DPROP NULL)
         (VECTOR-000 (%ARGUMENTS (%PROPOSITION DESCRIPTION)))
         (INDEX-000 0) (LENGTH-000 (LENGTH VECTOR-000))
         (COLLECT-000 NULL))
        (CL:DECLARE
        ...
        (CL:LOOP WHILE
         ...
         DO (CL:SETQ IPROP (%%VALUE ITER-001))
         (CL:SETQ IPROPINDEX ITER-002)
         (CL:SETQ DPROP
          (CL:AREF (CL:THE CL:SIMPLE-VECTOR (%THE-ARRAY VECTOR-000))
           INDEX-000))
         (CL:TAGBODY
       ...
       (CL:WHEN (CL:NOT (CL:EQ FILTEREDPROPSINDICES NIL))
        (CL:LET* ((SELF-001 (NEW-DESCRIPTION)))
         ...
         (CL:SETF (%PROPOSITION SELF-001)
          (CONJOIN-PROPOSITIONS SKOLEMPROPS))
...
(CL:DEFUN FILTER-IMPLIED-SKOLEM-PROPOSITIONS (INHERITEDPROPS DESCRIPTION ARGUMENTS MAPPING)
  (CL:LET*
   ((CREATEDSKOLEMS
    ...
    (FILTEREDPROPS INHERITEDPROPS) (FILTEREDPROPSINDICES NIL)
   ...
   (CL:WHEN (CL:NOT (CL:EQ CREATEDSKOLEMS NULL))
    (CL:LET*
     ...
     (CL:COND
      ...
      (CL:T
       (CL:SETQ MEMOIZED-VALUE-000
        (CREATE-SKOLEM-PROPOSITIONS-QUERY INHERITEDPROPS DESCRIPTION
         MAPPING))
       (CL:WHEN *MEMOIZATION-ENABLED?*
        (CL:SETF (%%VALUE MEMOIZED-ENTRY-000)
         (CL:IF (CL:EQ MEMOIZED-VALUE-000 NULL) MEMOIZED-NULL-VALUE
    ...
    (CL:LET*
     ((*TYPE-CHECK-STRATEGY* KWD-OPTIMIZE-NONE) (*QUERYITERATOR* QUERY)
      ...
      (*INFERENCELEVEL* SUBSUMPTION-INFERENCE)
      (*GENERATE-ALL-PROOFS?* CL:NIL))
     (CL:DECLARE
      (CL:SPECIAL *TYPE-CHECK-STRATEGY* *QUERYITERATOR*
       *REVERSEPOLARITY?* *INFERENCELEVEL* *GENERATE-ALL-PROOFS?*))
     (RESET QUERY)
     (CL:WHEN (NEXT? QUERY) (CL:SETQ FILTEREDPROPS NIL)
      (CL:LET*
       ((I NULL) (ITER-001 FILTEREDPROPSINDICES) (COLLECT-000 NULL))
       (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-001 NIL)) DO
        ...
        (CL:IF (CL:EQ COLLECT-000 NULL)
         (CL:PROGN
          ...
          (CL:IF (CL:EQ FILTEREDPROPS NIL)
           (CL:SETQ FILTEREDPROPS COLLECT-000)
...
(CL:DEFUN COLLECT-STRUCTURAL-FUNCTIONS (PROPOSITION STRUCTURALFUNCTIONS)
  (CL:LET* ((TEST-VALUE-000 (%KIND PROPOSITION)))
   (CL:COND
    ...
    ((CL:EQ TEST-VALUE-000 KWD-OPTIMIZE-AND)
     (CL:LET*
      ((CONJUNCT NULL) (VECTOR-000 (%ARGUMENTS PROPOSITION))
       (INDEX-000 0) (LENGTH-000 (LENGTH VECTOR-000)))
      (CL:DECLARE (CL:TYPE CL:FIXNUM INDEX-000 LENGTH-000))
      (CL:LOOP WHILE (CL:< INDEX-000 LENGTH-000) DO
       (CL:SETQ CONJUNCT
...
(CL:DEFUN COMPUTE-STRUCTURAL-FUNCTION-EVALUATION-ORDER (SELF)
  (CL:LET*
   ((STRUCTURALFUNCTIONS (NEW-LIST)) (IOVARIABLES (%IO-VARIABLES SELF))
    (INTERNALVARIABLES (%INTERNAL-VARIABLES SELF))
    (CANDIDATES (NEW-HASH-SET)) (UNBOUNDINTERNALS (NEW-HASH-SET))
    (SORTEDFUNCTIONS (NEW-LIST)) (PROGRESS? CL:T))
   (COLLECT-STRUCTURAL-FUNCTIONS (%PROPOSITION SELF)
    STRUCTURALFUNCTIONS)
   (CL:LET*
    ((FUNCTION NULL) (ITER-000 (%THE-CONS-LIST STRUCTURALFUNCTIONS)))
    (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-000 NIL)) DO
     ...
     (CL:WHEN
      (CL:OR
       (MEMBER? IOVARIABLES
        (CL:AREF
         (CL:THE CL:SIMPLE-VECTOR (%THE-ARRAY (%ARGUMENTS FUNCTION)))
   ...
   (CL:LET*
    ...
    (CL:LOOP WHILE (CL:< INDEX-000 LENGTH-000) DO
     (CL:SETQ VAR
      (CL:AREF (CL:THE CL:SIMPLE-VECTOR (%THE-ARRAY VECTOR-000))
       INDEX-000))
     (INSERT UNBOUNDINTERNALS VAR)
     (CL:SETQ INDEX-000 (CL:1+ INDEX-000))))
   (CL:LOOP WHILE PROGRESS? DO (CL:SETQ PROGRESS? CL:NIL)
    (CL:LET*
     ((CANDIDATE NULL) (ITER-001 (ALLOCATE-ITERATOR CANDIDATES)))
     (CL:LOOP WHILE (NEXT? ITER-001) DO
      (CL:SETQ CANDIDATE (%VALUE ITER-001))
      (CL:LET* ((TEST-VALUE-000 CL:NIL))
       (CL:SETQ TEST-VALUE-000
        (CL:NOT
         (MEMBER? UNBOUNDINTERNALS
          (CL:AREF
           (CL:THE CL:SIMPLE-VECTOR
            (%THE-ARRAY (%ARGUMENTS CANDIDATE)))
           (CL:THE CL:FIXNUM
            (CL:1- (LENGTH (%ARGUMENTS CANDIDATE))))))))
       (CL:WHEN TEST-VALUE-000
        (CL:LET* ((ALWAYS?-000 CL:T))
         (CL:LET*
    ...
    (CL:LET*
     ((CANDIDATE NULL) (ITER-003 (ALLOCATE-ITERATOR CANDIDATES)))
     (CL:LOOP WHILE (NEXT? ITER-003) DO
      (CL:SETQ CANDIDATE (%VALUE ITER-003))
      (CL:LET* ((ALWAYS?-001 CL:T))
       (CL:LET*
        ...
        (CL:DECLARE
         (CL:TYPE CL:FIXNUM INDEX-002 LENGTH-002 I ITER-004
          UPPER-BOUND-001))
        (CL:LOOP WHILE
         (CL:AND (CL:< INDEX-002 LENGTH-002)
          (CL:<= ITER-004 UPPER-BOUND-001))
         DO
         (CL:SETQ ARG
          (CL:AREF (CL:THE CL:SIMPLE-VECTOR (%THE-ARRAY VECTOR-002))
           INDEX-002))
...
(CL:DEFUN GET-STRUCTURAL-FUNCTION-EVALUATION-ORDER (SELF)
  (CL:LET*
   ((EVALUATIONORDER (STRUCTURAL-FUNCTION-EVALUATION-ORDER SELF)))
   (CL:WHEN (NULL-LIST? EVALUATIONORDER)
    (CL:SETQ EVALUATIONORDER
     (COMPUTE-STRUCTURAL-FUNCTION-EVALUATION-ORDER SELF))
    (SET-DYNAMIC-SLOT-VALUE (%DYNAMIC-SLOTS SELF)
     SYM-OPTIMIZE-LOGIC-STRUCTURAL-FUNCTION-EVALUATION-ORDER
...
(CL:DEFUN MAP-FUNCTIONAL-VALUE? (PROPOSITION MAPPING)
  (CL:LET* ((COPY (FIND-SIMILAR-PROPOSITION PROPOSITION MAPPING)))
   (CL:WHEN
    ...
    (CL:SETQ COPY
     (INHERIT-FUNCTION-PROPOSITION PROPOSITION MAPPING CL:NIL)))
   (CL:WHEN (CL:NOT (CL:EQ COPY NULL))
    (CL:LET*
...
(CL:DEFUN INHERIT-DESCRIPTION-PROPOSITIONS (ARGUMENTS DESCRIPTION)
  (CL:LET* ((MAPPING (NEW-KEY-VALUE-MAP)))
   (CL:LET*
    ...
    (CL:LOOP WHILE
     ...
     (CL:WHEN (CL:NOT (MAP-AND-ENQUEUE-VARIABLE? V ARG MAPPING))
      (CL:RETURN-FROM INHERIT-DESCRIPTION-PROPOSITIONS
       (CL:VALUES NIL NULL)))
     (CL:SETQ INDEX-000 (CL:1+ INDEX-000))
     (CL:SETQ INDEX-001 (CL:1+ INDEX-001))))
   (CL:LET*
   ...
   (CL:LET*
    ((PROPOSITIONS
      (INHERIT-AS-TOP-LEVEL-PROPOSITION (%PROPOSITION DESCRIPTION)
       MAPPING)))
...
(CL:DEFUN VECTOR.INHERIT-UNNAMED-DESCRIPTION (ARGUMENTS DESCRIPTION DEFAULTTRUE?)
  (CL:LET* ((PROPOSITIONS NULL) (MAPPING NULL))
   ...
   (CL:LET*
    ((PROP NULL)
     (ITER-000
      (FILTER-IMPLIED-SKOLEM-PROPOSITIONS PROPOSITIONS DESCRIPTION
       ARGUMENTS MAPPING))
     (COLLECT-000 NULL))
    (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-000 NIL)) DO
...
(CL:DEFUN HELP-STARTUP-OPTIMIZE2 ()
  (CL:PROGN
   ...
   (CL:SETQ SYM-OPTIMIZE-LOGIC-STRUCTURAL-FUNCTION-EVALUATION-ORDER
    (INTERN-RIGID-SYMBOL-WRT-MODULE
     "STRUCTURAL-FUNCTION-EVALUATION-ORDER" NULL 0))
