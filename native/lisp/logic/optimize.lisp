...
(CL:DECLAIM
 (CL:SPECIAL *STARTUP-TIME-PHASE* *COLLECTFORWARDPROPOSITIONS*
  DEFAULT-TRUE-TRUTH-VALUE TRUE-TRUTH-VALUE SUBSUMPTION-INFERENCE
  *STRUCTURED-OBJECTS-INDEX* ZERO-VARIABLES-VECTOR *PRINTMODE*
  TRUE-PROPOSITION *MEMOIZATION-ENABLED?* MEMOIZED-NULL-VALUE
  *QUERY-OPTIMIZATION-STRATEGY* NULL-FLOAT-WRAPPER *TRACED-KEYWORDS*
  STANDARD-OUTPUT EOL TRUE-WRAPPER FALSE-WRAPPER NULL-FLOAT *MODULE*
  ONE-WRAPPER ZERO-WRAPPER NIL-LIST NULL-INTEGER *REVERSEPOLARITY?* *CONTEXT*
  NIL *QUERYITERATOR*))
...
(CL:DEFUN NEW-GOAL-RECORD ()
  (CL:LET* ((SELF NULL))
   ...
   (CL:SETF (%OTHER-GOALS SELF) (NEW-LIST))
   (CL:SETF (%GENERATOR-GOALS SELF) (NEW-LIST)) SELF))
...
(CL:DEFUN ACCESS-GOAL-RECORD-SLOT-VALUE (SELF SLOTNAME VALUE SETVALUE?)
  (CL:COND
   ((CL:EQ SLOTNAME SYM-OPTIMIZE-LOGIC-GENERATOR-GOALS)
    (CL:IF SETVALUE? (CL:SETF (%GENERATOR-GOALS SELF) VALUE)
     (CL:SETQ VALUE (%GENERATOR-GOALS SELF))))
   ((CL:EQ SLOTNAME SYM-OPTIMIZE-LOGIC-OTHER-GOALS)
    (CL:IF SETVALUE? (CL:SETF (%OTHER-GOALS SELF) VALUE)
     (CL:SETQ VALUE (%OTHER-GOALS SELF))))
   (CL:T
     ...
     (CL:PROGN
      (CL:IF
       ...
       (CL:LET* ((ALWAYS?-000 CL:T))
        (CL:LET*
         ((ARG NULL) (VECTOR-000 (%ARGUMENTS ARGUMENT)) (INDEX-000 0)
         ...
         (CL:LOOP WHILE (CL:< INDEX-000 LENGTH-000) DO
          (CL:SETQ ARG
           (CL:AREF (CL:THE CL:SIMPLE-VECTOR (%THE-ARRAY VECTOR-000))
            INDEX-000))
          (CL:WHEN (CL:NOT (ARGUMENT-BOUND? ARG)) (CL:SETQ ALWAYS?-000 CL:NIL)
           (CL:RETURN))
          ...
          (CL:LOOP WHILE (CL:< INDEX-001 LENGTH-001) DO
           (CL:SETQ V
            (CL:AREF (CL:THE CL:SIMPLE-VECTOR (%THE-ARRAY VECTOR-001))
             INDEX-001))
           (CL:WHEN (CL:NOT (ARGUMENT-BOUND? V)) (CL:SETQ ALWAYS?-001 CL:NIL)
            (CL:RETURN))
...
(CL:DEFUN QUANTIFIED-ARGUMENT-BOUND? (ARGUMENT QUANTIFIEDVARS)
  ...
  (CL:LET* ((TEST-VALUE-001 (SAFE-PRIMARY-TYPE ARGUMENT)))
   (CL:COND
    ((SUBTYPE-OF? TEST-VALUE-001 SGT-OPTIMIZE-LOGIC-PATTERN-VARIABLE)
     (CL:PROGN
      (CL:OR (VARIABLE-BOUND? ARGUMENT) (MEMB? QUANTIFIEDVARS ARGUMENT))))
    ((SUBTYPE-OF? TEST-VALUE-001 SGT-OPTIMIZE-LOGIC-PROPOSITION)
     (CL:PROGN
      (CL:LET*
       ((IOVARS
       ...
       (CL:LET* ((ALWAYS?-000 CL:T))
        (CL:LET*
         ((ARG NULL) (VECTOR-001 (%ARGUMENTS ARGUMENT)) (INDEX-001 0)
         ...
         (CL:LOOP WHILE (CL:< INDEX-001 LENGTH-001) DO
          (CL:SETQ ARG
           (CL:AREF (CL:THE CL:SIMPLE-VECTOR (%THE-ARRAY VECTOR-001))
            INDEX-001))
          (CL:WHEN (CL:NOT (QUANTIFIED-ARGUMENT-BOUND? ARG QUANTIFIEDVARS))
          ...
          (CL:LOOP WHILE (CL:< INDEX-002 LENGTH-002) DO
           (CL:SETQ V
            (CL:AREF (CL:THE CL:SIMPLE-VECTOR (%THE-ARRAY VECTOR-002))
             INDEX-002))
           (CL:WHEN (CL:NOT (QUANTIFIED-ARGUMENT-BOUND? V QUANTIFIEDVARS))
...
(CL:DEFUN HAS-DISJUNCTION? (GOAL)
  (CL:WHEN (CL:EQ (%KIND GOAL) KWD-OPTIMIZE-OR)
...
(CL:DEFUN HAS-INVERSIONS? (GOAL)
  (CL:NOT
   (CL:EQ
    (DYNAMIC-SLOT-VALUE (%DYNAMIC-SLOTS (GET-DESCRIPTION (%OPERATOR GOAL)))
...
(CL:DEFUN COMPUTED-CONSTRAINT? (SELF)
  (CL:AND (TEST-PROPERTY? SELF SGT-OPTIMIZE-PL-KERNEL-KB-COMPUTED)
   (CL:NOT
    (CL:EQ
     (ACCESS-BINARY-VALUE SELF SGT-OPTIMIZE-PL-KERNEL-KB-RELATION-CONSTRAINT)
     NULL))))
...
(CL:DEFUN COMPUTED-PREDICATE? (GOAL)
  (CL:LET* ((OPERATOR (%OPERATOR GOAL)) (DESCRIPTION NULL))
     ...
     ((RELATIONARG
       (ARGUMENT-BOUND-TO
        (CL:AREF (CL:THE CL:SIMPLE-VECTOR (%THE-ARRAY (%ARGUMENTS GOAL)))
         0))))
     (CL:COND
      ((CL:AND (CL:NOT (CL:EQ RELATIONARG NULL))
        (ISA? RELATIONARG SGT-OPTIMIZE-LOGIC-DESCRIPTION))
       (CL:SETQ DESCRIPTION RELATIONARG)
   ...
   (CL:WHEN (CL:EQ DESCRIPTION NULL)
    (CL:SETQ DESCRIPTION (GET-DESCRIPTION OPERATOR)))
   (CL:AND (CL:NOT (CL:EQ DESCRIPTION NULL))
    (CL:OR (COMPUTED-TERM? DESCRIPTION)
     (CL:EQ OPERATOR SGT-OPTIMIZE-PL-KERNEL-KB-SETOF)
...
(CL:DEFUN SIMULATE-CREATE-CHOICE-POINT ()
  (CL:1+
   (%TOP-UNBINDING-STACK-OFFSET (%CURRENT-PATTERN-RECORD *QUERYITERATOR*))))
...
(CL:DEFUN GENERATOR-COLLECTION? (COLLECTION)
  (CL:WHEN (CL:AND *REVERSEPOLARITY?* (CL:NOT (CLOSED-TERM? COLLECTION)))
     ...
     (CL:PROGN
      (CL:LET* ((BOUNDTOVALUE (ARGUMENT-BOUND-TO COLLECTION)))
       (CL:COND
        ...
        ((CL:NOT (CL:EQ (%DEFINING-PROPOSITION COLLECTION) NULL)) CL:T)
        (CL:T CL:NIL)))))
    ((SUBTYPE-OF-SURROGATE? TEST-VALUE-000)
     (CL:PROGN (RELATION-SUPPORTS-EXTENSION? (GET-DESCRIPTION COLLECTION))))
    (CL:T CL:T))))
  ...
  (CL:LET*
   ...
   (CL:LET* ((I NULL-INTEGER) (ITER-000 0) (UPPER-BOUND-000 (CL:1- SIZE)))
    ...
    (CL:LOOP WHILE (CL:<= ITER-000 UPPER-BOUND-000) DO (CL:SETQ I ITER-000)
     (CL:LET*
      ((GOALRECORD (CL:AREF (CL:THE CL:SIMPLE-VECTOR (%THE-ARRAY STACK)) I)))
    ...
    ((SUBTYPE-OF? TEST-VALUE-000 SGT-OPTIMIZE-LOGIC-PATTERN-VARIABLE)
     (CL:PROGN
      ...
      (CL:LET* ((GOALRECORD (GOAL-RECORD ARGUMENT)))
       (CL:WHEN
        (CL:OR (MEMBER? (%GENERATOR-GOALS GOALRECORD) PARENTGOAL)
    ...
    (CL:COND
     ...
     ((CL:EQ TEST-VALUE-000 KWD-OPTIMIZE-ISA)
      (HELP-DISTRIBUTE-GOAL
       ...
       GOAL (GENERATOR-COLLECTION? (GET-DESCRIPTION (%OPERATOR GOAL)))))
     ((CL:EQ TEST-VALUE-000 KWD-OPTIMIZE-PREDICATE)
      (CL:LET*
       ((ARG NULL) (VECTOR-001 (%ARGUMENTS GOAL)) (INDEX-001 0)
        (LENGTH-001 (LENGTH VECTOR-001)))
       (CL:DECLARE (CL:TYPE CL:FIXNUM INDEX-001 LENGTH-001))
       (CL:LOOP WHILE (CL:< INDEX-001 LENGTH-001) DO
        (CL:SETQ ARG
     ...
     ((CL:EQ TEST-VALUE-000 KWD-OPTIMIZE-IMPLIES)
      (CL:LET*
       ((ARG NULL) (VECTOR-002 (%ARGUMENTS GOAL)) (INDEX-002 0)
...
(CL:DEFUN GET-INDEXING-VECTOR (SELF)
  (CL:WHEN (CL:= (ARITY SELF) 2)
   (CL:RETURN-FROM GET-INDEXING-VECTOR (GET-BINARY-INDEXING-VECTOR SELF)))
  (CL:LET*
   ((CACHEDVECTOR
     (DYNAMIC-SLOT-VALUE (%DYNAMIC-SLOTS SELF)
     ...
     (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-000 NIL)) DO
      ...
      (CL:IF (CL:EQ COLLECT-000 NULL)
       (CL:PROGN
        (CL:SETQ COLLECT-000
         (CONS
          (CL:IF (TYPE-HAS-BACKLINKS? (ENSURE-DEFERRED-DESCRIPTION TYPE))
           ONE-WRAPPER ZERO-WRAPPER)
          NIL))
        (CL:IF (CL:EQ (%THE-CONS-LIST ZEROONELIST) NIL)
         (CL:SETF (%THE-CONS-LIST ZEROONELIST) COLLECT-000)
         (ADD-CONS-TO-END-OF-CONS-LIST (%THE-CONS-LIST ZEROONELIST)
          COLLECT-000)))
       (CL:PROGN
...
(CL:DEFUN UPDATE-OBSERVED-CARDINALITY (SELF CARDINALITY)
  ...
  (CL:LET* ((*CONTEXT* *MODULE*) (*MODULE* (%BASE-MODULE *CONTEXT*)))
  ...
  (CL:LET* ((*CONTEXT* *MODULE*) (*MODULE* (%BASE-MODULE *CONTEXT*)))
   ...
   (CL:LET*
    ...
    (CL:IF
     ...
     (%WRAPPER-VALUE VALUE) NULL-INTEGER))))
...
(CL:DEFUN ESTIMATE-CARDINALITY-OF-EXTENSION (DESCRIPTION)
  ...
  (CL:LET* ((ESTIMATE (ACCESS-OBSERVED-CARDINALITY DESCRIPTION)))
   ...
   (CL:WHEN
    (CL:AND (CL:= ESTIMATE NULL-INTEGER)
     (CL:NOT (CL:EQ (%EXTENSION DESCRIPTION) NULL)))
...
(CL:DEFUN ESTIMATE-MEMBER-OF-GOAL-FANOUT (GOAL)
  (CL:LET*
   ((MEMBERVALUE
    ...
    (COLLECTIONVALUE
     (ARGUMENT-BOUND-TO
      (CL:AREF (CL:THE CL:SIMPLE-VECTOR (%THE-ARRAY (%ARGUMENTS GOAL))) 1))))
   (CL:COND
    ((CL:NOT (CL:EQ MEMBERVALUE NULL)) ESTIMATED-CARDINALITY-OF-MEMBER-OF)
  ...
  (CL:LET*
   ...
   (CL:LET* ((TEST-VALUE-000 CL:NIL))
    (CL:LET* ((FOUND?-000 CL:NIL))
     (CL:LET*
      ...
      (CL:LOOP WHILE
       ...
       (CL:WHEN (CL:AND (CL:EQ IBIT TRUE-WRAPPER) (CL:EQ GBIT TRUE-WRAPPER))
        (CL:SETQ FOUND?-000 CL:T) (CL:RETURN))
       (CL:SETQ INDEX-000 (CL:1+ INDEX-000))
       (CL:SETQ INDEX-001 (CL:1+ INDEX-001))))
    ...
    (CL:WHEN TEST-VALUE-000
     (CL:RETURN-FROM ESTIMATE-PREDICATE-GOAL-FANOUT
      (ESTIMATE-CARDINALITY-OF-EXTENSION
       (GET-DESCRIPTION (%OPERATOR GOAL))))))
   (CL:LET* ((ALLBITSMATCH? CL:NIL))
    (CL:LET*
     ((UNIQUENESSKEY NULL)
      (ITER-000 (%THE-CONS-LIST (GET-UNIQUENESS-VECTORS DESCRIPTION))))
     (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-000 NIL)) DO
      (CL:SETQ UNIQUENESSKEY (%%VALUE ITER-000)) (CL:SETQ ALLBITSMATCH? CL:T)
      (CL:LET*
       ((UBIT NULL) (VECTOR-002 UNIQUENESSKEY) (INDEX-002 0)
        (LENGTH-002 (LENGTH VECTOR-002)) (GBIT NULL) (VECTOR-003 GOALVECTOR)
       ...
       (CL:LOOP WHILE
        ...
        (CL:SETQ GBIT
         (CL:AREF (CL:THE CL:SIMPLE-VECTOR (%THE-ARRAY VECTOR-003))
          INDEX-003))
        (CL:WHEN (CL:AND (CL:EQ UBIT TRUE-WRAPPER) (CL:EQ GBIT FALSE-WRAPPER))
   ...
   (CL:COND
    ((CL:OR (CL:EQ TEST-VALUE-000 KWD-OPTIMIZE-ISA)
     ...
     (CL:LET* ((DESCRIPTION (GET-DESCRIPTION (%OPERATOR GOAL))))
      (CL:IF
       (CL:OR (CL:EQ DESCRIPTION NULL) (CL:NOT (INFERABLE? DESCRIPTION)))
       1.0d0 INFERABLE-PENALTY-COST)))
    ((CL:EQ TEST-VALUE-000 KWD-OPTIMIZE-IMPLIES) SUBSET-OF-PENALTY-COST)
    (CL:T 1.0d0))))
...
(CL:DEFUN CHEAPEST-GENERATOR-GOAL (VARIABLE)
  (CL:WHEN
   ...
   (%%PRINT-STREAM (%NATIVE-STREAM STANDARD-OUTPUT) EOL "CHEAPEST: " VARIABLE
  ...
  (CL:LET*
   ...
   (CL:LET*
    ((GOAL NULL)
     (ITER-000 (%THE-CONS-LIST (%GENERATOR-GOALS (GOAL-RECORD VARIABLE)))))
    (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-000 NIL)) DO
   ...
   (CL:IF (CL:NOT (CL:= BESTFANOUT NULL-FLOAT))
    (CL:PROGN
     (CL:WHEN
      (CL:AND (CL:NOT (CL:EQ *TRACED-KEYWORDS* NULL))
       (MEMB? *TRACED-KEYWORDS* KWD-OPTIMIZE-OPTIMIZER))
      (%%PRINT-STREAM (%NATIVE-STREAM STANDARD-OUTPUT) "  SELECTED: " BESTGOAL
       "  " BESTCOST "  " BESTFANOUT EOL))
       ...
       (CL:LET* ((TEST-VALUE-001 CL:NIL))
        ...
        (CL:IF TEST-VALUE-001
         (CL:PROGN
          ...
          (SIMULATE-BIND-VARIABLE-AND-PROPAGATE-CONSTRAINTS (LAST ARGUMENTS)
           GOALSEQUENCE))
         (CL:PROGN)))))
     ((CL:OR (CL:EQ TEST-VALUE-000 KWD-OPTIMIZE-ISA)
       (CL:EQ TEST-VALUE-000 KWD-OPTIMIZE-IMPLIES)))
...
(CL:DEFUN COLLECT-CLOSED-GOALS (GOALS GOALSEQUENCE)
  (CL:LET* ((G NULL) (ITER-000 (%THE-CONS-LIST GOALS)))
   (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-000 NIL)) DO
    ...
    (CL:WHEN
     (CL:AND (ALL-ARGUMENTS-BOUND? G) (CL:NOT (MEMBER? GOALSEQUENCE G)))
     (PUSH GOALSEQUENCE G))
    (CL:SETQ ITER-000 (%%REST ITER-000)))))
...
(CL:DEFUN SIMULATE-BIND-VARIABLE-AND-PROPAGATE-CONSTRAINTS (VARIABLE GOALSEQUENCE)
  (CL:LET* ((GOALRECORD (GOAL-RECORD VARIABLE)))
   ...
   (CL:LET*
    ((G NULL) (ITER-000 (%THE-CONS-LIST (%GENERATOR-GOALS GOALRECORD))))
    (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-000 NIL)) DO
     (CL:SETQ G (%%VALUE ITER-000))
...
(CL:DEFUN COMPUTE-OPTIMAL-OPEN-GOAL-ORDERING (OPTIMIZERVARIABLES NUMBEROFOPENGOALS GOALSEQUENCE PRIORCOST PRIORFANOUT)
  ...
  (CL:LET*
   ((GOALSEQUENCECHECKPOINT NULL) (CHOICEPOINTUNBINDINGOFFSET NULL-INTEGER)
   ...
   (CL:IF
    (CL:>= *OPTIMALGOALORDERINGRECURSIONS* *OPTIMAL-GOAL-ORDERING-CUTOFF*)
     ...
     (CL:TAGBODY
      (CL:WHEN (CL:NOT (VARIABLE-BOUND? VBL))
       (CL:LET*
        ...
        (CL:MULTIPLE-VALUE-SETQ (GENERATORGOAL GENERATORCOST GENERATORFANOUT)
       ...
       (CL:IF (CL:= (LENGTH GOALSEQUENCE) NUMBEROFOPENGOALS)
        (CL:WHEN
         ...
         (SET-DYNAMIC-SLOT-VALUE (%DYNAMIC-SLOTS *QUERYITERATOR*)
          ...
          NULL-FLOAT-WRAPPER)
         (SET-DYNAMIC-SLOT-VALUE (%DYNAMIC-SLOTS *QUERYITERATOR*)
          SYM-OPTIMIZE-LOGIC-BEST-GOAL-SEQUENCE (COPY GOALSEQUENCE) NULL))
        (COMPUTE-OPTIMAL-OPEN-GOAL-ORDERING OPTIMIZERVARIABLES
         NUMBEROFOPENGOALS GOALSEQUENCE CUMULATIVECOST CUMULATIVEFANOUT))
       (CL:SETF (%THE-CONS-LIST GOALSEQUENCE) GOALSEQUENCECHECKPOINT)
       (UNBIND-VARIABLES-BEGINNING-AT
        (%CURRENT-PATTERN-RECORD *QUERYITERATOR*) CHOICEPOINTUNBINDINGOFFSET))
      :CONTINUE)
     (CL:SETQ ITER-000 (%%REST ITER-000))))))
...
(CL:DEFUN COMPUTE-GREEDY-OPEN-GOAL-ORDERING (OPTIMIZERVARIABLES NUMBEROFOPENGOALS GOALSEQUENCE PRIORCOST PRIORFANOUT)
  ...
  (CL:LET*
   ((GOALSEQUENCECHECKPOINT NULL) (CHOICEPOINTUNBINDINGOFFSET NULL-INTEGER)
    (BESTGENERATORGOAL NULL) (BESTGENERATORFANOUT NULL-FLOAT)
    (BESTCOMBINEDCOST NULL-FLOAT) (OPENGOALREDUCTION NULL-INTEGER))
   (CL:DECLARE
   ...
   (CL:LOOP (CL:SETQ BESTGENERATORGOAL NULL)
         ...
         (CL:SETQ OPENGOALREDUCTION
          (CEILING
           (CL:*
            (CL:/
             (CL:FLOAT
              (CL:- (LENGTH GOALSEQUENCE) (LENGTH GOALSEQUENCECHECKPOINT))
              0.0d0)
             NUMBEROFOPENGOALS)
            100)))
         (CL:LET*
          ((COMBINEDCOST
            (CL:- (CL:+ GENERATORFANOUT GENERATORCOST) OPENGOALREDUCTION)))
    ...
    (CL:WHEN (CL:EQ BESTGENERATORGOAL NULL)
     (CL:WHEN (CL:= (LENGTH GOALSEQUENCE) NUMBEROFOPENGOALS)
      (SET-DYNAMIC-SLOT-VALUE (%DYNAMIC-SLOTS *QUERYITERATOR*)
       SYM-OPTIMIZE-LOGIC-BEST-COST (WRAP-FLOAT PRIORCOST) NULL-FLOAT-WRAPPER)
      (SET-DYNAMIC-SLOT-VALUE (%DYNAMIC-SLOTS *QUERYITERATOR*)
       SYM-OPTIMIZE-LOGIC-BEST-GOAL-SEQUENCE GOALSEQUENCE NULL))
     (CL:RETURN-FROM COMPUTE-GREEDY-OPEN-GOAL-ORDERING))
   ...
   (CL:LOOP WHILE (CL:< INDEX-000 LENGTH-000) DO
    ...
    (CL:LET* ((TEST-VALUE-001 (SAFE-PRIMARY-TYPE ARG)))
     (CL:COND
      ((SUBTYPE-OF? TEST-VALUE-001 SGT-OPTIMIZE-LOGIC-PATTERN-VARIABLE)
       (CL:PROGN
        (CL:WHEN (UNBOUND-VARIABLE? ARG) (INSERT-NEW UNBOUNDVARIABLES ARG))))
      ((SUBTYPE-OF? TEST-VALUE-001 SGT-OPTIMIZE-LOGIC-PROPOSITION)
...
(CL:DEFUN EXTRACT-OPEN-GOAL-CLUSTERS (OPENGOALS OPENGOALCLUSTERS)
  (CL:LET*
   ((ALLGOALS (COPY-CONS-LIST (%THE-CONS-LIST OPENGOALS)))
    (REMAININGGOALS ALLGOALS) (CURSOR NULL) (GOAL NULL) (CLUSTERS (NEW-LIST))
    (CURRENTCLUSTER NULL) (CURRENTCLUSTERVARS (NEW-LIST))
    (CURRENTCLUSTERVARSGREW? CL:NIL) (UNBOUNDGOALVARS (NEW-LIST)))
       ...
       (CL:LET* ((FOUND?-000 CL:NIL))
        (CL:LET* ((VAR NULL) (ITER-000 (%THE-CONS-LIST UNBOUNDGOALVARS)))
         (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-000 NIL)) DO
          ...
          (CL:WHEN (MEMBER? CURRENTCLUSTERVARS VAR) (CL:SETQ FOUND?-000 CL:T)
           (CL:RETURN))
          (CL:SETQ ITER-000 (%%REST ITER-000))))
   ...
   (CL:COND
    ((CL:>= (LENGTH CLUSTERS) 2) (CLEAR OPENGOALS)
     (CL:SETF (%THE-CONS-LIST OPENGOALS) (REMOVE ALLGOALS NULL))
     (CL:LET*
      ((CLUSTER NULL) (ITER-002 (%THE-CONS-LIST (REVERSE CLUSTERS)))
       (COLLECT-000 NULL))
      (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-002 NIL)) DO
       (CL:SETQ CLUSTER (%%VALUE ITER-002))
       (CL:IF (CL:EQ COLLECT-000 NULL)
        (CL:PROGN (CL:SETQ COLLECT-000 (CONS CLUSTER NIL))
         (CL:IF (CL:EQ (%THE-CONS-LIST OPENGOALCLUSTERS) NIL)
          (CL:SETF (%THE-CONS-LIST OPENGOALCLUSTERS) COLLECT-000)
          (ADD-CONS-TO-END-OF-CONS-LIST (%THE-CONS-LIST OPENGOALCLUSTERS)
           COLLECT-000)))
        (CL:PROGN (CL:SETF (%%REST COLLECT-000) (CONS CLUSTER NIL))
         (CL:SETQ COLLECT-000 (%%REST COLLECT-000))))
       (CL:SETQ ITER-002 (%%REST ITER-002)))))
    (CL:T
     (CL:WHEN (CL:NOT (CL:EQ CURRENTCLUSTER NULL)) (FREE CURRENTCLUSTER))))
   (FREE CLUSTERS)))
        ...
        (CL:LET* ((VARIABLE ARG))
         (CL:COND
          ((CL:NOT (CL:EQ VARIABLE (INNERMOST-OF VARIABLE)))
           (SIMULATE-BIND-VARIABLE-TO-VALUE VARIABLE))
          ((CL:AND (CL:EQ (%DEFINING-PROPOSITION VARIABLE) NULL)
  ...
  (CL:LET*
   ...
   (CL:WHEN (NON-EMPTY? OPENGOALCLUSTERS)
    ...
    (CL:LET* ((*EVALUATIONMODE* KWD-OPTIMIZE-DESCRIPTION))
     ...
     (CL:LET*
      ((CLUSTER NULL) (ITER-000 (%THE-CONS-LIST OPENGOALCLUSTERS))
       (COLLECT-000 NULL))
      (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-000 NIL)) DO
          ...
          (CONS
           (CL:IF (CL:> (LENGTH CLUSTER) 1)
            (FASTEN-DOWN-ONE-PROPOSITION
             (CONJOIN-PROPOSITIONS (%THE-CONS-LIST CLUSTER)) CL:T)
            (FIRST CLUSTER))
           NIL))
         (CL:IF (CL:EQ (%THE-CONS-LIST CLUSTERPROPOSITIONS) NIL)
          (CL:SETF (%THE-CONS-LIST CLUSTERPROPOSITIONS) COLLECT-000)
          (ADD-CONS-TO-END-OF-CONS-LIST (%THE-CONS-LIST CLUSTERPROPOSITIONS)
           COLLECT-000)))
        (CL:PROGN
         (CL:SETF (%%REST COLLECT-000)
          (CONS
       ...
       (CL:SETQ ITER-000 (%%REST ITER-000)))))
    (CL:LET*
     ((PROP NULL) (ITER-001 (%THE-CONS-LIST CLUSTERPROPOSITIONS))
      (COLLECT-001 NULL))
     (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-001 NIL)) DO
      ...
      (CL:WHEN (CL:NOT (CL:EQ (%KIND PROP) KWD-OPTIMIZE-AND))
       (CL:IF (CL:EQ COLLECT-001 NULL)
        (CL:PROGN (CL:SETQ COLLECT-001 (CONS PROP NIL))
         (CL:IF (CL:EQ (%THE-CONS-LIST OPENGOALS) NIL)
          (CL:SETF (%THE-CONS-LIST OPENGOALS) COLLECT-001)
          (ADD-CONS-TO-END-OF-CONS-LIST (%THE-CONS-LIST OPENGOALS)
           COLLECT-001)))
    ...
    (CL:LET* ((IT (ALLOCATE-ITERATOR GOALSEQUENCE)))
     (CL:LOOP WHILE (NEXT? IT) DO
      (CL:WHEN (CL:NOT (MEMBER? OPENGOALS (%VALUE IT)))
       (VALUE-SETTER IT NULL))))
    (REMOVE GOALSEQUENCE NULL))
   (FREE OPENGOALCLUSTERS)
   (CL:SETQ INITIALGOALSEQUENCE (%THE-CONS-LIST GOALSEQUENCE))
   (CL:SETQ INITIALRESIDUEGOALS
    (%THE-CONS-LIST (RESIDUE-GOALS *QUERYITERATOR*)))
   ...
   (CL:LET* ((*OPTIMALGOALORDERINGRECURSIONS* 0))
    ...
    (COMPUTE-OPTIMAL-OPEN-GOAL-ORDERING OPTIMIZERVARIABLES (LENGTH OPENGOALS)
     GOALSEQUENCE 1.0d0 1.0d0)
    (CL:WHEN
     (CL:>= *OPTIMALGOALORDERINGRECURSIONS* *OPTIMAL-GOAL-ORDERING-CUTOFF*)
     (CL:SETF (%THE-CONS-LIST GOALSEQUENCE) INITIALGOALSEQUENCE)
     (CL:SETF (%THE-CONS-LIST (RESIDUE-GOALS *QUERYITERATOR*))
      INITIALRESIDUEGOALS)
     (CLEAR (BEST-GOAL-SEQUENCE *QUERYITERATOR*))
     (SET-DYNAMIC-SLOT-VALUE (%DYNAMIC-SLOTS *QUERYITERATOR*)
      SYM-OPTIMIZE-LOGIC-BEST-COST (WRAP-FLOAT NULL-FLOAT) NULL-FLOAT-WRAPPER)
     (COMPUTE-GREEDY-OPEN-GOAL-ORDERING OPTIMIZERVARIABLES (LENGTH OPENGOALS)
      GOALSEQUENCE 1.0d0 1.0d0)))
   (CL:WHEN
    ...
    (CL:WHEN
     ...
     (%%PRINT-STREAM (%NATIVE-STREAM STANDARD-OUTPUT)
      "Using backup goal ordering:" EOL "Original Goal: " ANDPROPOSITION
      EOL)))
   (CL:LET*
    ((PROP NULL)
     (ITER-003
    ...
    (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-003 NIL)) DO
     ...
     (CL:WHEN (CL:EQ (%KIND PROP) KWD-OPTIMIZE-AND)
...
(CL:DEFUN OPTIMIZE-ORDERING-OF-CONJUNCTS (ANDPROPOSITION)
  (CL:LET*
   ...
   (CL:LET*
    ((G NULL) (VECTOR-000 (%ARGUMENTS ANDPROPOSITION)) (INDEX-000 0)
     (LENGTH-000 (LENGTH VECTOR-000)))
    (CL:DECLARE (CL:TYPE CL:FIXNUM INDEX-000 LENGTH-000))
    (CL:LOOP WHILE (CL:< INDEX-000 LENGTH-000) DO
     (CL:SETQ G
     ...
     (CL:COND ((ALL-ARGUMENTS-BOUND? G) (INSERT INITIALLYCLOSEDGOALS G))
      ((CL:OR (HAS-DISJUNCTION? G) (CL:EQ (%KIND G) KWD-OPTIMIZE-FORALL))
   ...
   (CL:LET* ((G NULL) (ITER-001 (%THE-CONS-LIST OPENGOALS)))
    (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-001 NIL)) DO
     ...
     (CL:LET* ((FOUND?-000 CL:NIL))
      (CL:LET*
       ((ARG NULL) (VECTOR-001 (%ARGUMENTS G)) (INDEX-001 0)
        (LENGTH-001 (LENGTH VECTOR-001)))
       (CL:DECLARE (CL:TYPE CL:FIXNUM INDEX-001 LENGTH-001))
       (CL:LOOP WHILE (CL:< INDEX-001 LENGTH-001) DO
        (CL:SETQ ARG
         (CL:AREF (CL:THE CL:SIMPLE-VECTOR (%THE-ARRAY VECTOR-001))
          INDEX-001))
        (CL:WHEN (ARGUMENT-BOUND? ARG) (CL:SETQ FOUND?-000 CL:T) (CL:RETURN))
        (CL:SETQ INDEX-001 (CL:1+ INDEX-001))))
      (CL:WHEN FOUND?-000
       (PROPAGATE-SINGLE-VALUED-CONSTRAINTS G GOALSEQUENCE)))
     (CL:SETQ ITER-001 (%%REST ITER-001))))
   ...
   (CL:WHEN
    (CL:AND (CL:NOT (CL:EQ *TRACED-KEYWORDS* NULL))
     (MEMB? *TRACED-KEYWORDS* KWD-OPTIMIZE-OPTIMIZER))
    (%%PRINT-STREAM (%NATIVE-STREAM STANDARD-OUTPUT) "Optimized goal: "
     ANDPROPOSITION EOL))))
...
(CL:DEFUN REORDER-GOALS (ANDPROPOSITION INITIALLYCLOSEDGOALS GOALSEQUENCE RESIDUEGOALS)
  (CL:LET*
   ((ARGUMENTS (%ARGUMENTS ANDPROPOSITION))
   ...
   (CL:WHEN (CL:< INDEX ORIGINALNUMBEROFARGUMENTS)
    (CL:SETF (%ARGUMENTS ANDPROPOSITION) (NEW-VECTOR INDEX))
    (CL:LET*
     ...
     (CL:DECLARE
      (CL:TYPE CL:FIXNUM INDEX-000 LENGTH-000 I ITER-003 UPPER-BOUND-000))
     (CL:LOOP WHILE
      (CL:AND (CL:< INDEX-000 LENGTH-000) (CL:<= ITER-003 UPPER-BOUND-000)) DO
      (CL:SETQ ARG
       (CL:AREF (CL:THE CL:SIMPLE-VECTOR (%THE-ARRAY VECTOR-000)) INDEX-000))
      (CL:SETQ I ITER-003)
      (CL:LET
       ((SELF (%THE-ARRAY (%ARGUMENTS ANDPROPOSITION))) (VALUE ARG)
        (POSITION I))
       (CL:DECLARE (CL:TYPE CL:SIMPLE-VECTOR SELF)
        (CL:TYPE CL:FIXNUM POSITION))
       (CL:SETF (CL:AREF SELF POSITION) VALUE))
  ...
  (CL:LET* ((ARGUMENTS (%ARGUMENTS PROPOSITION)) (KIND (%KIND PROPOSITION)))
   (CL:WHEN *REVERSEPOLARITY?*
    (CL:COND ((CL:EQ KIND KWD-OPTIMIZE-AND) (CL:SETQ KIND KWD-OPTIMIZE-OR))
     ...
     (CL:T)))
   (CL:COND
    ((CL:OR (CL:EQ KIND KWD-OPTIMIZE-ISA) (CL:EQ KIND KWD-OPTIMIZE-PREDICATE)
      (CL:EQ KIND KWD-OPTIMIZE-FUNCTION) (CL:EQ KIND KWD-OPTIMIZE-EQUIVALENT))
...
(CL:DEFUN OPTIMIZE-QUERY (DESCRIPTION BOOLEANVECTOR PARENTFRAME)
  (CL:LET*
   ((FRAME (CREATE-DOWN-FRAME PARENTFRAME NULL))
    (VARIABLESCOUNT
     (CL:+ (LENGTH (%IO-VARIABLES DESCRIPTION))
...
(CL:DEFUN SELECT-OPTIMAL-QUERY-PATTERN (DESCRIPTION BOOLEANVECTOR PARENTFRAME)
  (CL:LET* ((PATTERN NULL) (QUERYPATTERNS (%QUERY-PATTERNS DESCRIPTION)))
   ...
   (CL:WHEN (CL:EQ QUERYPATTERNS NULL)
    (CL:SETF (%QUERY-PATTERNS DESCRIPTION) (NEW-KEY-VALUE-LIST)))
    ...
    (CL:NOT
     (CL:OR
      ...
      (%WRAPPER-VALUE
       (DYNAMIC-SLOT-VALUE (%DYNAMIC-SLOTS DESCRIPTION)
        SYM-OPTIMIZE-LOGIC-DONT-OPTIMIZE? FALSE-WRAPPER))
      (CONTAINS-OPERATOR? (%PROPOSITION DESCRIPTION)
  ...
  (CL:LET*
   ...
   (CL:WHEN *MEMOIZATION-ENABLED?*
    (CL:SETQ MEMO-TABLE-000
     (%SURROGATE-VALUE
      SGT-OPTIMIZE-LOGIC-F-DYNAMICALLY-ESTIMATE-INFERENCE-COST-MEMO-TABLE-000))
   ...
   (CL:COND
    ...
    (CL:T
     (CL:SETQ MEMOIZED-VALUE-000
      (WRAP-INTEGER
       (LENGTH
        (APPLICABLE-RULES-OF-DESCRIPTION SELF KWD-OPTIMIZE-BACKWARD CL:T))))
     (CL:WHEN *MEMOIZATION-ENABLED?*
      (CL:SETF (%%VALUE MEMOIZED-ENTRY-000)
       (CL:IF (CL:EQ MEMOIZED-VALUE-000 NULL) MEMOIZED-NULL-VALUE
        MEMOIZED-VALUE-000)))))
   (CL:LET* ((NOFRULES MEMOIZED-VALUE-000))
    (MAX (CL:* INFERABLE-PENALTY-COST (%WRAPPER-VALUE NOFRULES)) 1.0d0))))
  ...
  (CL:LET* ((TEST-VALUE-000 (%KIND GOAL)))
   (CL:COND
    ((CL:OR (CL:EQ TEST-VALUE-000 KWD-OPTIMIZE-ISA)
      ...
      (CL:EQ TEST-VALUE-000 KWD-OPTIMIZE-PREDICATE))
     (CL:LET*
      ((OPERATOR (%OPERATOR GOAL)) (DESCRIPTION (GET-DESCRIPTION OPERATOR))
       (FIRSTARGVALUE NULL))
      (CL:WHEN (CL:EQ OPERATOR SGT-OPTIMIZE-PL-KERNEL-KB-HOLDS)
       ...
       (CL:IF (CL:NOT (CL:EQ FIRSTARGVALUE NULL))
        (CL:IF (ISA? FIRSTARGVALUE SGT-OPTIMIZE-LOGIC-NAMED-DESCRIPTION)
         (CL:SETQ DESCRIPTION FIRSTARGVALUE) (CL:SETQ DESCRIPTION NULL))
        (CL:RETURN-FROM DYNAMICALLY-ESTIMATE-GOAL-COST
         INFERABLE-PENALTY-COST)))
      (CL:IF
       (CL:OR (CL:EQ DESCRIPTION NULL) (CL:NOT (INFERABLE? DESCRIPTION)))
       1.0d0 (DYNAMICALLY-ESTIMATE-INFERENCE-COST DESCRIPTION))))
    ((CL:EQ TEST-VALUE-000 KWD-OPTIMIZE-IMPLIES) SUBSET-OF-PENALTY-COST)
    (CL:T 1.0d0))))
...
(CL:DEFUN DYNAMICALLY-ESTIMATE-GOAL-FANOUT (GOAL)
  ...
  (CL:LET* ((TEST-VALUE-000 (%KIND GOAL)))
   (CL:COND
    ((CL:EQ TEST-VALUE-000 KWD-OPTIMIZE-ISA)
     (DYNAMICALLY-ESTIMATE-EXTENSION-SIZE (GET-DESCRIPTION (%OPERATOR GOAL))))
    ((CL:OR (CL:EQ TEST-VALUE-000 KWD-OPTIMIZE-FUNCTION)
      (CL:EQ TEST-VALUE-000 KWD-OPTIMIZE-PREDICATE))
     ...
     (CL:LET* ((FANOUT NULL-FLOAT) (MINFANOUT NULL-FLOAT))
      ...
      (CL:LET*
       ...
       (CL:LOOP WHILE (CL:< INDEX-000 LENGTH-000) DO
        ...
        (CL:WHEN (CL:OR (CL:= MINFANOUT NULL-FLOAT) (CL:< FANOUT MINFANOUT))
      ...
      (CL:LET*
       ...
       (CL:LOOP WHILE (CL:< INDEX-001 LENGTH-001) DO
        ...
        (CL:WHEN (CL:NOT (CL:= FANOUT NULL-FLOAT))
         (CL:WHEN (CL:= TOTALFANOUT NULL-FLOAT) (CL:SETQ TOTALFANOUT 0.0d0))
...
(CL:DEFUN DYNAMICALLY-ESTIMATE-PREDICATE-GOAL-FANOUT (GOAL)
  (CL:LET* ((TEST-VALUE-000 (%OPERATOR GOAL)))
   (CL:COND
    ...
    (CL:T
     (CL:LET*
      ((PATTERNARGS NIL) (RELATION (%OPERATOR GOAL))
       (ARGUMENTS (%ARGUMENTS GOAL)) (FIRSTARGINDEX 0) (NOFUNBOUNDARGS 0)
       (UNBOUNDARGINDEX NULL-INTEGER) (KEY NULL) (RELATIONEXTENSION? CL:T)
       (DESCRIPTION (GET-DESCRIPTION RELATION)))
      (CL:DECLARE
       (CL:TYPE CL:FIXNUM FIRSTARGINDEX NOFUNBOUNDARGS UNBOUNDARGINDEX))
      ...
      (CL:LET*
       ((I NULL-INTEGER) (ITER-000 FIRSTARGINDEX)
        (UPPER-BOUND-000 (CL:1- (LENGTH ARGUMENTS))) (COLLECT-000 NULL))
       (CL:DECLARE (CL:TYPE CL:FIXNUM I ITER-000 UPPER-BOUND-000))
       (CL:LOOP WHILE (CL:<= ITER-000 UPPER-BOUND-000) DO (CL:SETQ I ITER-000)
        (CL:SETQ KEY
         (ARGUMENT-BOUND-TO
      ...
      (CL:WHEN (COMPUTED-TERM? DESCRIPTION)
       ...
       (CL:RETURN-FROM DYNAMICALLY-ESTIMATE-PREDICATE-GOAL-FANOUT NULL-FLOAT))
      (CL:WHEN
       (CL:AND (TEST-PROPERTY? DESCRIPTION SGT-OPTIMIZE-PL-KERNEL-KB-TOTAL)
        (CL:> NOFUNBOUNDARGS 1)
        (CL:= UNBOUNDARGINDEX (CL:1- (LENGTH ARGUMENTS))))
       (CL:RETURN-FROM DYNAMICALLY-ESTIMATE-PREDICATE-GOAL-FANOUT NULL-FLOAT))
...
(CL:DEFUN DYNAMICALLY-ESTIMATE-EXTENSION-SIZE (DESCRIPTION)
  ...
  (CL:LET* ((ESTIMATE NULL-FLOAT))
   ...
   (CL:WHEN (CL:= ESTIMATE NULL-FLOAT)
    (CL:SETQ ESTIMATE
     (CL:FLOAT (ESTIMATED-LENGTH (GET-DESCRIPTION-EXTENSION DESCRIPTION CL:T))
      0.0d0)))
   ESTIMATE))
     ...
     ((CL:OR (CL:EQ TEST-VALUE-000 KWD-OPTIMIZE-NOT)
      ...
      (CL:RETURN-FROM COUNT-BOUND-ARGUMENTS
       (COUNT-BOUND-ARGUMENTS
        (CL:AREF (CL:THE CL:SIMPLE-VECTOR (%THE-ARRAY (%ARGUMENTS GOAL)))
         0))))
     ((CL:OR (CL:EQ TEST-VALUE-000 KWD-OPTIMIZE-AND)
       (CL:EQ TEST-VALUE-000 KWD-OPTIMIZE-OR))
      (CL:LET*
       ((ARG NULL) (VECTOR-000 (%ARGUMENTS GOAL)) (INDEX-000 0)
        (LENGTH-000 (LENGTH VECTOR-000)))
       ...
       (CL:LOOP WHILE (CL:< INDEX-000 LENGTH-000) DO
        (CL:SETQ ARG
         (CL:AREF (CL:THE CL:SIMPLE-VECTOR (%THE-ARRAY VECTOR-000))
          INDEX-000))
        (CL:SETQ COUNT (CL:+ COUNT (COUNT-BOUND-ARGUMENTS ARG)))
        (CL:SETQ INDEX-000 (CL:1+ INDEX-000)))))
     ((CL:OR (CL:EQ TEST-VALUE-000 KWD-OPTIMIZE-FUNCTION)
       (CL:EQ TEST-VALUE-000 KWD-OPTIMIZE-PREDICATE)
       (CL:EQ TEST-VALUE-000 KWD-OPTIMIZE-EQUIVALENT)
      ...
      (CL:LET*
       ((ARG NULL) (VECTOR-001 (%ARGUMENTS GOAL)) (INDEX-001 0)
        (LENGTH-001 (LENGTH VECTOR-001)) (I NULL-INTEGER) (ITER-000 0))
       ...
       (CL:LOOP WHILE (CL:< INDEX-001 LENGTH-001) DO
        ...
        (CL:TAGBODY
         (CL:WHEN
          (CL:AND (CL:= I 0)
           (CL:EQ (%OPERATOR GOAL) SGT-OPTIMIZE-PL-KERNEL-KB-HOLDS))
          (CL:GO :CONTINUE))
         (CL:WHEN (CL:NOT (UNBOUND-VARIABLE? ARG))
      ...
      ((ARGUMENTS (%ARGUMENTS GOAL)) (OPERATOR (%OPERATOR GOAL))
       ...
       (NOFUNBOUNDVARS
        (CL:IF
         ...
         10 0)))
      (CL:DECLARE
       (CL:TYPE CL:FIXNUM FIRSTKEYARGINDEX LASTKEYARGINDEX NOFUNBOUNDVARS))
...
(CL:DEFUN DYNAMICALLY-REOPTIMIZE-ARGUMENTS (ARGUMENTS CURSOR)
  ...
  (CL:LET*
   ((LASTARGINDEX (CL:1- (LENGTH ARGUMENTS))) (CHEAPESTARGINDEX CURSOR)
    ...
    (NOFBOUNDARGS 0) (BESTCOST NULL-FLOAT) (BESTNOFBOUNDARGS 0)
    (ARGUMENT NULL))
   (CL:DECLARE
    (CL:TYPE CL:FIXNUM LASTARGINDEX CHEAPESTARGINDEX NOFBOUNDARGS
     BESTNOFBOUNDARGS)
   ...
   (CL:LET*
    ...
    (CL:LOOP WHILE (CL:OR UNBOUNDED?-000 (CL:<= ITER-000 UPPER-BOUND-000)) DO
     ...
     (CL:TAGBODY
      ...
      (CL:COND
       ((CL:= UNBOUND 1.0d0) (CL:SETQ FANOUT 1.0d0)
        (CL:SETQ NOFBOUNDARGS (LENGTH (%ARGUMENTS ARGUMENT))))
      ...
      (CL:WHEN
       (CL:OR (CL:= BESTCOST NULL-FLOAT)
        (CL:AND (CL:< COST BESTCOST)
         (CL:OR (CL:= BESTNOFBOUNDARGS 0) (CL:NOT (CL:= NOFBOUNDARGS 0))))
        (CL:AND (CL:>= COST BESTCOST) (CL:= BESTNOFBOUNDARGS 0)
         (CL:NOT (CL:= NOFBOUNDARGS 0))))
       (CL:SETQ BESTCOST COST) (CL:SETQ BESTNOFBOUNDARGS NOFBOUNDARGS)
       (CL:SETQ CHEAPESTARGINDEX I)
   ...
   (CL:WHEN (CL:> CHEAPESTARGINDEX CURSOR)
    ...
    (CL:LET
     ...
     (CL:SETF (CL:AREF SELF POSITION) VALUE))
    (CL:LET
     ((SELF (%THE-ARRAY ARGUMENTS)) (VALUE ARGUMENT)
...
(CL:DEFUN SIMPLIFY-DESCRIPTION (DESCRIPTION POSTOPTIMIZATION?)
  (CL:WHEN (CL:EQ (%PROPOSITION DESCRIPTION) NULL)
...
(CL:DEFUN COPY-LIST-TO-ARGUMENTS-VECTOR (ARGUMENTS)
  (CL:LET* ((VECTOR (NEW-VECTOR (LENGTH ARGUMENTS))))
   (CL:LET*
    ((ARG NULL) (ITER-000 (%THE-CONS-LIST ARGUMENTS)) (I NULL-INTEGER)
     (ITER-001 0))
   ...
   (CL:COND
    ((CL:EQ TEST-VALUE-000 KWD-OPTIMIZE-ISA)
     (CL:AND
      (EQL?
       (CL:AREF
        (CL:THE CL:SIMPLE-VECTOR (%THE-ARRAY (%ARGUMENTS OTHERCONJUNCT))) 0)
       (CL:AREF
        (CL:THE CL:SIMPLE-VECTOR (%THE-ARRAY (%ARGUMENTS ISACONJUNCT))) 0))
      (CL:IF *POSTOPTIMIZATION?*
       (RELATIONREF-SPECIALIZES-RELATIONREF? (%OPERATOR OTHERCONJUNCT)
        (%OPERATOR ISACONJUNCT))
     ...
     (CL:LET*
      ...
      (CL:LET* ((TEST-VALUE-001 CL:NIL))
       ...
       (CL:WHEN TEST-VALUE-001 (CL:SETQ TEST-VALUE-001 (TYPE? INTYPE))
        (CL:WHEN TEST-VALUE-001
         (CL:SETQ TEST-VALUE-001 (SURROGATE? (%OPERATOR OTHERCONJUNCT)))
         (CL:WHEN TEST-VALUE-001
          (CL:LET* ((FOUND?-000 CL:NIL))
           (CL:LET*
            ((ARG NULL) (VECTOR-000 (%ARGUMENTS OTHERCONJUNCT)) (INDEX-000 0)
             (LENGTH-000 (LENGTH VECTOR-000)) (ARGTYPE NULL)
             (ITER-000
              (%THE-CONS-LIST
               (%IO-VARIABLE-TYPES
                (GET-DESCRIPTION (%OPERATOR OTHERCONJUNCT))))))
            (CL:DECLARE (CL:TYPE CL:FIXNUM INDEX-000 LENGTH-000))
            (CL:LOOP WHILE
...
(CL:DEFUN SIMPLIFY-CONJUNCTION (ANDPROPOSITION)
  (CL:LET* ((CONJUNCTSLIST (NEW-LIST)) (CURSOR NULL) (CURSORPOS 0))
   ...
   (CL:LET*
    ((ARG NULL) (VECTOR-000 (%ARGUMENTS ANDPROPOSITION)) (INDEX-000 0)
     (LENGTH-000 (LENGTH VECTOR-000)))
    (CL:DECLARE (CL:TYPE CL:FIXNUM INDEX-000 LENGTH-000))
    (CL:LOOP WHILE (CL:< INDEX-000 LENGTH-000) DO
     (CL:SETQ ARG
      ...
      (CL:COND
        ...
        (CL:WHEN
         (CL:OR
          (EQL?
           ...
           (CL:AREF
            (CL:THE CL:SIMPLE-VECTOR (%THE-ARRAY (%ARGUMENTS CONJUNCT))) 1))
          (CL:AND
           (EQL?
            (VALUE-OF
             (CL:AREF
            ...
            (VALUE-OF
             (CL:AREF
              (CL:THE CL:SIMPLE-VECTOR (%THE-ARRAY (%ARGUMENTS CONJUNCT)))
              1)))
           (ISA?
            (CL:AREF
             (CL:THE CL:SIMPLE-VECTOR (%THE-ARRAY (%ARGUMENTS CONJUNCT))) 0)
           ...
           (ISA?
            ...
            SGT-OPTIMIZE-LOGIC-PATTERN-VARIABLE)))
         (CL:LET*
          ((ARG NULL) (VECTOR-001 (%ARGUMENTS CONJUNCT)) (INDEX-001 0)
           (LENGTH-001 (LENGTH VECTOR-001)))
          (CL:DECLARE (CL:TYPE CL:FIXNUM INDEX-001 LENGTH-001))
          (CL:LOOP WHILE (CL:< INDEX-001 LENGTH-001) DO
           (CL:SETQ ARG
       ...
       ((CL:EQ TEST-VALUE-000 KWD-OPTIMIZE-ISA)
        (CL:LET* ((VALUE-000 NULL))
         (CL:LET*
          ((OTHERCONJ NULL) (ITER-000 (%THE-CONS-LIST CONJUNCTSLIST))
         ...
         (CL:LET* ((DOMINATINGCONJUNCT VALUE-000))
          (CL:WHEN
           (CL:OR (CL:EQ (%OPERATOR CONJUNCT) SGT-OPTIMIZE-STELLA-THING)
            (CL:NOT (CL:EQ DOMINATINGCONJUNCT NULL)))
           (CL:WHEN (CL:NOT (CL:EQ CONJUNCT DOMINATINGCONJUNCT))
            (CL:LET*
             ((ARG NULL) (VECTOR-002 (%ARGUMENTS CONJUNCT)) (INDEX-002 0)
              (LENGTH-002 (LENGTH VECTOR-002)))
             (CL:DECLARE (CL:TYPE CL:FIXNUM INDEX-002 LENGTH-002))
             (CL:LOOP WHILE (CL:< INDEX-002 LENGTH-002) DO
              (CL:SETQ ARG
   ...
   (CL:WHEN (MEMBER? CONJUNCTSLIST TRUE-PROPOSITION)
    ...
    (CL:CASE (LENGTH CONJUNCTSLIST)
     (0 (OVERLAY-WITH-CONSTANT-PROPOSITION ANDPROPOSITION TRUE-PROPOSITION))
     (1 (OVERLAY-PROPOSITION ANDPROPOSITION (FIRST CONJUNCTSLIST))
      (CL:LET*
       ((ARG NULL) (VECTOR-003 (%ARGUMENTS ANDPROPOSITION)) (INDEX-003 0)
        (LENGTH-003 (LENGTH VECTOR-003)))
       (CL:DECLARE (CL:TYPE CL:FIXNUM INDEX-003 LENGTH-003))
       (CL:LOOP WHILE (CL:< INDEX-003 LENGTH-003) DO
        (CL:SETQ ARG
        ...
        (CL:SETQ INDEX-003 (CL:1+ INDEX-003)))))
     (CL:OTHERWISE
      (CL:SETF (%ARGUMENTS ANDPROPOSITION)
...
(CL:DEFUN COPY-DESCRIPTION (SELF PARENTMAPPING ADDBACKLINKS?)
  (CL:LET*
   ((*CONTEXT* (%HOME-CONTEXT SELF)) (*MODULE* (%BASE-MODULE *CONTEXT*)))
   (CL:DECLARE (CL:SPECIAL *CONTEXT* *MODULE*))
   (CL:LET*
      ...
      (CL:LET* ((REALEXTERNALVARS VALUE-000) (EXTERNALVARSCOPY NULL))
       (CL:IF
        ...
        (CL:WHEN (CL:NOT (CL:EQ REALEXTERNALVARS NIL))
         (CL:SETQ EXTERNALVARSCOPY
          (COPY-VARIABLES-VECTOR
           (COPY-CONS-LIST-TO-VARIABLES-VECTOR REALEXTERNALVARS) MAPPING))))
      ...
      (CL:SETF (%PROPOSITION COPY)
       (CL:IF ADDBACKLINKS?
        (RECURSIVELY-FASTEN-DOWN-PROPOSITIONS
         (COPY-PROPOSITION (%PROPOSITION SELF) MAPPING) CL:NIL)
    ...
    (CL:WHEN
     (%WRAPPER-VALUE
      (DYNAMIC-SLOT-VALUE (%DYNAMIC-SLOTS SELF)
       SYM-OPTIMIZE-LOGIC-DONT-OPTIMIZE? FALSE-WRAPPER))
     (SET-DYNAMIC-SLOT-VALUE (%DYNAMIC-SLOTS COPY)
      SYM-OPTIMIZE-LOGIC-DONT-OPTIMIZE? TRUE-WRAPPER FALSE-WRAPPER))
    (FREE MAPPING) COPY)))
...
(CL:DEFUN COPY-VARIABLE (SELF MAPPING)
  (CL:LET* ((COPY (LOOKUP MAPPING SELF)))
   ...
   (CL:SETQ COPY
    (CREATE-VARIABLE (%SKOLEM-TYPE SELF) (%SKOLEM-NAME SELF) CL:NIL))
   (CL:COND
    ...
    (CL:T
     (CL:LET*
      ((COPYNAME
        (CONCATENATE "?CP_"
         (SUBSEQUENCE (%SYMBOL-NAME (%SKOLEM-NAME SELF)) 1 NULL-INTEGER))))
   ...
   (CL:WHEN
    (CL:NOT
     (CL:EQ
      (ACCESS-IN-CONTEXT (%VARIABLE-VALUE SELF) (%HOME-CONTEXT SELF) CL:NIL)
      NULL))
    (CL:LET*
     ((OBJECT-000 COPY)
      (VALUE-000
      ...
      (NEW-VALUE-000
       (UPDATE-IN-CONTEXT OLD-VALUE-002 VALUE-000 (%HOME-CONTEXT OBJECT-000)
        CL:NIL)))
     (CL:WHEN
      (CL:NOT
       (CL:AND (CL:NOT (CL:EQ OLD-VALUE-002 NULL))
        (CL:EQ (PRIMARY-TYPE OLD-VALUE-002) SGT-OPTIMIZE-STELLA-CS-VALUE)))
...
(CL:DEFUN COPY-PROPOSITION (SELF MAPPING)
  (CL:LET* ((COPY (LOOKUP MAPPING SELF)))
    ...
    (CL:WHEN
     (CL:NOT
      (CL:AND (CL:NOT (CL:EQ OLD-VALUE-001 NULL))
       (CL:EQ (PRIMARY-TYPE OLD-VALUE-001) SGT-OPTIMIZE-STELLA-CS-VALUE)))
     (CL:SETF (%TRUTH-VALUE OBJECT-000) NEW-VALUE-000)))
   (CL:WHEN
    (CL:NOT
     (CL:=
      (%WRAPPER-VALUE
       (DYNAMIC-SLOT-VALUE (%DYNAMIC-SLOTS SELF) SYM-OPTIMIZE-LOGIC-WEIGHT
        NULL-FLOAT-WRAPPER))
      NULL-FLOAT))
   ...
   (CL:WHEN
    (%WRAPPER-VALUE
     (DYNAMIC-SLOT-VALUE (%DYNAMIC-SLOTS SELF) SYM-OPTIMIZE-LOGIC-DESCRIPTIVE?
      FALSE-WRAPPER))
    (SET-DYNAMIC-SLOT-VALUE (%DYNAMIC-SLOTS COPY)
     SYM-OPTIMIZE-LOGIC-DESCRIPTIVE? TRUE-WRAPPER FALSE-WRAPPER))
   (CL:WHEN
    (%WRAPPER-VALUE
     (DYNAMIC-SLOT-VALUE (%DYNAMIC-SLOTS SELF)
      SYM-OPTIMIZE-LOGIC-DONT-OPTIMIZE? FALSE-WRAPPER))
   ...
   (CL:WHEN
    (CL:NOT
     (CL:EQ
      (DYNAMIC-SLOT-VALUE (%DYNAMIC-SLOTS SELF) SYM-OPTIMIZE-LOGIC-ANNOTATIONS
       NULL)
      NULL))
    (SET-DYNAMIC-SLOT-VALUE (%DYNAMIC-SLOTS COPY)
  ...
  (CL:LET* ((COPY (LOOKUP MAPPING SELF)))
   ...
   (CL:LET* ((TEST-VALUE-001 (SAFE-PRIMARY-TYPE SELF)))
    (CL:COND
     ...
     ((SUBTYPE-OF? TEST-VALUE-001 SGT-OPTIMIZE-LOGIC-PATTERN-VARIABLE)
      (CL:PROGN
       (CL:ERROR (NEW-STELLA-EXCEPTION "OOPS -- BUG IN 'copy-description'"))))
     (CL:T SELF)))))
...
(CL:DEFUN MAPPED-VALUE-OF (SELF MAPPING CREATESKOLEM?)
  (CL:LET*
   ((VALUE (CL:IF (CL:NOT (CL:EQ MAPPING NULL)) (LOOKUP MAPPING SELF) NULL)))
   ...
   (CL:WHEN (CL:AND (CL:NOT (CL:EQ MAPPING NULL)) (CL:NOT (CL:EQ VALUE NULL)))
    ...
    (CL:RETURN-FROM MAPPED-VALUE-OF VALUE))
   (CL:IF CREATESKOLEM? (CREATE-SKOLEM-FOR-UNMAPPED-VARIABLE SELF MAPPING)
    NULL)))
  ...
  (CL:LET* ((VALUE-000 NULL))
   ...
   (CL:LET* ((EQUIVALENTPROP VALUE-000))
    (CL:WHEN (CL:EQ EQUIVALENTPROP NULL)
     ...
     (CL:LET
      ((SELF (%THE-ARRAY (%ARGUMENTS EQUIVALENTPROP))) (VALUE SKOLEM)
       (POSITION 0))
      (CL:DECLARE (CL:TYPE CL:SIMPLE-VECTOR SELF)
       (CL:TYPE CL:FIXNUM POSITION))
      (CL:SETF (CL:AREF SELF POSITION) VALUE))
     (CL:LET
      ((SELF (%THE-ARRAY (%ARGUMENTS EQUIVALENTPROP))) (VALUE VALUE)
       (POSITION 1))
      (CL:DECLARE (CL:TYPE CL:SIMPLE-VECTOR SELF)
       (CL:TYPE CL:FIXNUM POSITION))
      (CL:SETF (CL:AREF SELF POSITION) VALUE)))
...
(CL:DEFUN INHERIT-FUNCTION-PROPOSITION (SELF MAPPING CREATESKOLEM?)
  (CL:LET*
   ((COPY NULL) (INPUTARGS NIL)
    (NOFINPUTARGS (CL:1- (LENGTH (%ARGUMENTS SELF)))) (ARGMAPSTO NULL))
   ...
   (CL:LET*
    ...
    (CL:LOOP WHILE (CL:< INDEX-000 LENGTH-000) DO
     ...
     (CL:WHEN (CL:<= I NOFINPUTARGS)
      (CL:SETQ ARGMAPSTO (MAPPED-VALUE-OF ARG MAPPING CREATESKOLEM?))
      (CL:WHEN (CL:EQ ARGMAPSTO NULL)
       (CL:RETURN-FROM INHERIT-FUNCTION-PROPOSITION NULL))
      (CL:IF (CL:EQ COLLECT-000 NULL)
       (CL:PROGN
        (CL:SETQ COLLECT-000
         (CONS (INHERIT-PROPOSITION-ARGUMENT ARGMAPSTO SELF MAPPING) NIL))
     ...
     (CL:SETQ ITER-000 (CL:1+ ITER-000))))
   (CL:SETQ COPY
    (FIND-OR-CREATE-FUNCTION-PROPOSITION (%OPERATOR SELF) INPUTARGS))
   COPY))
...
(CL:DEFUN OLD-FIND-SIMILAR-PROPOSITION (PROPOSITION MAPPING)
  (CL:WHEN (CL:EQ (%KIND PROPOSITION) KWD-OPTIMIZE-CONSTANT)
   (CL:RETURN-FROM OLD-FIND-SIMILAR-PROPOSITION NULL))
  (CL:LET*
   ((KIND (%KIND PROPOSITION)) (OPERATOR (%OPERATOR PROPOSITION))
    (ARGMAPSTO NULL) (DEPENDENTSLIST NULL) (HASDISCOURAGEDARGUMENT? CL:NIL))
   (CL:LET*
    ((ARG NULL) (VECTOR-000 (%ARGUMENTS PROPOSITION)) (INDEX-000 0)
     (LENGTH-000 (LENGTH VECTOR-000)))
    (CL:DECLARE (CL:TYPE CL:FIXNUM INDEX-000 LENGTH-000))
    (CL:LOOP WHILE (CL:< INDEX-000 LENGTH-000) DO
     ...
     (CL:TAGBODY
      ...
      (CL:LET* ((MAPSTO (MAPPED-VALUE-OF ARG MAPPING CL:NIL)))
       (CL:WHEN
        (CL:AND (CL:NOT (CL:EQ MAPSTO NULL)) (INSTANCE-HAS-BACKLINKS? MAPSTO))
       ...
       ((CL:EQ KIND KWD-OPTIMIZE-FUNCTION)
        (CL:LET* ((VALUE-000 NULL))
         (CL:LET* ((P NULL) (ITER-000 (ALLOCATE-ITERATOR DEPENDENTSLIST)))
          (CL:LOOP WHILE (NEXT? ITER-000) DO (CL:SETQ P (%VALUE ITER-000))
           (CL:LET* ((TEST-VALUE-000 CL:NIL))
            (CL:SETQ TEST-VALUE-000 (CL:EQ (%KIND P) KIND))
            (CL:WHEN TEST-VALUE-000
             (CL:SETQ TEST-VALUE-000 (CL:EQ (%OPERATOR P) OPERATOR))
             (CL:WHEN TEST-VALUE-000
              (CL:LET* ((ALWAYS?-000 CL:T))
               (CL:LET*
                ((ARG1 NULL) (ITER-001 (BUT-LAST (%ARGUMENTS PROPOSITION)))
                 (ARG2 NULL) (ITER-002 (BUT-LAST (%ARGUMENTS P))))
                (CL:LOOP WHILE (CL:AND (NEXT? ITER-001) (NEXT? ITER-002)) DO
                 (CL:SETQ ARG1 (%VALUE ITER-001))
                 (CL:SETQ ARG2 (%VALUE ITER-002))
                 (CL:WHEN
                  (CL:NOT (EQUAL-UP-TO-SKOLEM-IDENTITY? ARG1 ARG2 MAPPING))
                  (CL:SETQ ALWAYS?-000 CL:NIL) (CL:RETURN))))
               (CL:SETQ TEST-VALUE-000 ALWAYS?-000))))
            (CL:WHEN TEST-VALUE-000 (CL:SETQ VALUE-000 P) (CL:RETURN)))))
         (CL:LET* ((VALUE-001 VALUE-000))
          (CL:RETURN-FROM OLD-FIND-SIMILAR-PROPOSITION VALUE-001))))
       (CL:T
        (CL:LET* ((VALUE-002 NULL))
         (CL:LET* ((P NULL) (ITER-003 (ALLOCATE-ITERATOR DEPENDENTSLIST)))
          (CL:LOOP WHILE (NEXT? ITER-003) DO (CL:SETQ P (%VALUE ITER-003))
           (CL:LET* ((TEST-VALUE-001 CL:NIL))
            (CL:SETQ TEST-VALUE-001 (CL:EQ (%KIND P) KIND))
            (CL:WHEN TEST-VALUE-001
             (CL:SETQ TEST-VALUE-001 (CL:EQ (%OPERATOR P) OPERATOR))
             (CL:WHEN TEST-VALUE-001
              (CL:LET* ((ALWAYS?-001 CL:T))
               (CL:LET*
                ((ARG1 NULL) (VECTOR-002 (%ARGUMENTS PROPOSITION))
                 (INDEX-002 0) (LENGTH-002 (LENGTH VECTOR-002)) (ARG2 NULL)
                 (VECTOR-003 (%ARGUMENTS P)) (INDEX-003 0)
                 (LENGTH-003 (LENGTH VECTOR-003)))
                (CL:DECLARE
         ...
         (CL:LET* ((VALUE-003 VALUE-002))
          (CL:RETURN-FROM OLD-FIND-SIMILAR-PROPOSITION VALUE-003)))))))
    (CL:T))
   NULL))
...
(CL:DEFUN NEW-FIND-SIMILAR-PROPOSITION (PROPOSITION MAPPING)
  (CL:WHEN (CL:EQ (%KIND PROPOSITION) KWD-OPTIMIZE-CONSTANT)
   (CL:RETURN-FROM NEW-FIND-SIMILAR-PROPOSITION NULL))
  (CL:LET*
   ...
   (CL:WHEN (CL:EQ BUCKET NULL)
    (CL:RETURN-FROM NEW-FIND-SIMILAR-PROPOSITION NULL))
   (CL:LET*
    ((OPERATOR (%OPERATOR PROPOSITION)) (ARGUMENTS (%ARGUMENTS PROPOSITION))
       ...
       ((SUBTYPE-OF? (SAFE-PRIMARY-TYPE P) SGT-OPTIMIZE-LOGIC-PROPOSITION)
        (CL:PROGN
         (CL:LET* ((TEST-VALUE-000 CL:NIL))
          ...
          (CL:WHEN TEST-VALUE-000
           (CL:SETQ TEST-VALUE-000 (CL:= ARITY (LENGTH (%ARGUMENTS P))))
             ...
             (CL:LET* ((ALWAYS?-000 CL:T))
              (CL:LET*
               ((ARG1 NULL) (VECTOR-000 ARGUMENTS) (INDEX-000 0)
                ...
                (LENGTH-001 (LENGTH VECTOR-001)) (I NULL-INTEGER) (ITER-001 2)
                (UPPER-BOUND-000 ARITY)
                (UNBOUNDED?-000 (CL:= UPPER-BOUND-000 NULL-INTEGER)))
               (CL:DECLARE
                (CL:TYPE CL:FIXNUM INDEX-000 LENGTH-000 INDEX-001 LENGTH-001 I
                 ITER-001 UPPER-BOUND-000))
               (CL:LOOP WHILE
                (CL:AND (CL:< INDEX-000 LENGTH-000)
                ...
                (CL:WHEN
                 (CL:NOT
                  (EQL? (MAPPED-VALUE-OF ARG1 MAPPING CL:NIL)
                   (VALUE-OF ARG2)))
                 (CL:SETQ ALWAYS?-000 CL:NIL) (CL:RETURN))
                (CL:SETQ INDEX-000 (CL:1+ INDEX-000))
                (CL:SETQ INDEX-001 (CL:1+ INDEX-001))
            ...
            (CL:WHEN (CL:NOT TEST-VALUE-000)
             (CL:SETQ TEST-VALUE-000
              (CL:AND (CL:NOT FUNCTION?)
               (EQUIVALENT-PROPOSITIONS? PROPOSITION P MAPPING))))
            (CL:WHEN TEST-VALUE-000
             (CL:SETQ TEST-VALUE-000
              (SUBCONTEXT? *MODULE* (%BASE-MODULE (%HOME-CONTEXT P)))))))
          (CL:WHEN TEST-VALUE-000
           (CL:RETURN-FROM NEW-FIND-SIMILAR-PROPOSITION P)))))
       (CL:T))
      (CL:SETQ ITER-000 (%%REST ITER-000))))
    NULL)))
...
(CL:DEFUN FIND-SIMILAR-PROPOSITION (PROPOSITION MAPPING)
  (CL:LET* ((RESULT (NEW-FIND-SIMILAR-PROPOSITION PROPOSITION MAPPING)))
   RESULT))
     ...
     (CL:PROGN
      (CL:IF
       (CL:OR (DESCRIPTION-MODE?)
        (CL:AND (CL:EQ (%KIND PARENT) KWD-OPTIMIZE-ISA)
         (CL:EQ (%OPERATOR PARENT) ARGUMENT)))
       ARGUMENT
    ...
    (CL:WHEN (CL:NOT (CL:EQ DUPLICATE NULL))
     (CL:LET*
      ...
      (CL:LOOP WHILE (CL:< INDEX-000 LENGTH-000) DO
       ...
       (CL:SETQ I ITER-000)
       (CL:LET
        ((SELF (%THE-ARRAY (%ARGUMENTS DUPLICATE))) (VALUE ARG) (POSITION I))
        (CL:DECLARE (CL:TYPE CL:SIMPLE-VECTOR SELF)
         (CL:TYPE CL:FIXNUM POSITION))
        (CL:SETF (CL:AREF SELF POSITION) VALUE))
       (CL:SETQ INDEX-000 (CL:1+ INDEX-000))
...
(CL:DEFUN INHERIT-PROPOSITION (SELF MAPPING)
    ...
    ((CL:EQ TEST-VALUE-000 KWD-OPTIMIZE-FUNCTION)
     (CL:LET*
      ...
      (CL:WHEN (CL:EQ COPY NULL)
       (CL:SETQ COPY (INHERIT-FUNCTION-PROPOSITION SELF MAPPING CL:T))
  ...
  (CL:LET* ((MATCHINGPROPOSITION (LOOKUP MAPPING SELF)))
   ...
   (CL:WHEN (CL:NOT (CL:EQ MATCHINGPROPOSITION NULL))
    ...
    (CL:RETURN-FROM INHERIT-PROPOSITION MATCHINGPROPOSITION)))
  (CL:LET*
   ((OPERATOR (%OPERATOR SELF)) (ARGUMENTSMAPTO (NEW-LIST)) (COPY NULL)
    (ARGMAPSTO NULL))
   (CL:LET*
    ((ARG NULL) (VECTOR-000 (%ARGUMENTS SELF)) (INDEX-000 0)
    ...
    (CL:LOOP WHILE (CL:< INDEX-000 LENGTH-000) DO
     ...
     (CL:IF (CL:EQ COLLECT-000 NULL)
      (CL:PROGN (CL:SETQ COLLECT-000 (CONS ARGMAPSTO NIL))
       (CL:IF (CL:EQ (%THE-CONS-LIST ARGUMENTSMAPTO) NIL)
        (CL:SETF (%THE-CONS-LIST ARGUMENTSMAPTO) COLLECT-000)
        (ADD-CONS-TO-END-OF-CONS-LIST (%THE-CONS-LIST ARGUMENTSMAPTO)
         COLLECT-000)))
      (CL:PROGN (CL:SETF (%%REST COLLECT-000) (CONS ARGMAPSTO NIL))
       (CL:SETQ COLLECT-000 (%%REST COLLECT-000))))
     (CL:SETQ INDEX-000 (CL:1+ INDEX-000))))
   (CL:SETQ COPY (CREATE-PROPOSITION SYM-OPTIMIZE-LOGIC-CONSTANT 0))
   (CL:SETF (%KIND COPY) (%KIND SELF)) (CL:SETF (%OPERATOR COPY) OPERATOR)
...
(CL:DEFUN CREATE-SKOLEM-FOR-UNMAPPED-VARIABLE (VARIABLE MAPPING)
  (CL:LET*
   ((SKOLEM (LOOKUP MAPPING VARIABLE))
    (CREATEDSKOLEMS (LOOKUP MAPPING KWD-OPTIMIZE-CREATED-SKOLEMS)))
   (CL:WHEN (CL:NOT (CL:EQ SKOLEM NULL))
    (CL:RETURN-FROM CREATE-SKOLEM-FOR-UNMAPPED-VARIABLE SKOLEM))
   (CL:SETQ SKOLEM (CREATE-VARIABLE-OR-SKOLEM (%SKOLEM-TYPE VARIABLE) NULL))
...
(CL:DEFUN INHERIT-AS-TOP-LEVEL-PROPOSITION (PROPOSITION MAPPING)
  (CL:LET* ((RESULTLIST NIL))
   ...
   (CL:LET* ((P NULL) (ITER-000 RESULTLIST))
    (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-000 NIL)) DO
     (CL:SETQ P (%%VALUE ITER-000)) (NORMALIZE-TOP-LEVEL-PROPOSITION P)
     (CL:SETQ ITER-000 (%%REST ITER-000))))
   (REVERSE RESULTLIST)))
...
(CL:DEFUN CREATE-SKOLEM-PROPOSITIONS-QUERY (INHERITEDPROPS DESCRIPTION MAPPING)
  (CL:LET*
   ((CREATEDSKOLEMS NULL) (SKOLEMPROPS NIL) (FILTEREDPROPSINDICES NIL))
   (CL:LET* ((*MODULE* *MODULE*) (*CONTEXT* *MODULE*))
    (CL:DECLARE (CL:SPECIAL *MODULE* *CONTEXT*))
    (CL:LET* ((TEST-VALUE-000 (%KIND (%PROPOSITION DESCRIPTION))))
     (CL:COND
      ((CL:EQ TEST-VALUE-000 KWD-OPTIMIZE-AND)
       (CL:SETQ CREATEDSKOLEMS (NEW-HASH-SET))
       (CL:LET*
        ((SKOLEM NULL)
         (ITER-000
          (%THE-CONS-LIST (LOOKUP MAPPING KWD-OPTIMIZE-CREATED-SKOLEMS))))
        (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-000 NIL)) DO
         (CL:SETQ SKOLEM (%%VALUE ITER-000)) (INSERT CREATEDSKOLEMS SKOLEM)
         (CL:SETQ ITER-000 (%%REST ITER-000))))
       (CL:LET*
        ((IPROP NULL) (ITER-001 INHERITEDPROPS) (IPROPINDEX NULL-INTEGER)
         (ITER-002 0) (DPROP NULL)
         (VECTOR-000 (%ARGUMENTS (%PROPOSITION DESCRIPTION))) (INDEX-000 0)
         (LENGTH-000 (LENGTH VECTOR-000)) (COLLECT-000 NULL))
        (CL:DECLARE
         (CL:TYPE CL:FIXNUM IPROPINDEX ITER-002 INDEX-000 LENGTH-000))
        (CL:LOOP WHILE
         ...
         (CL:TAGBODY
          (CL:WHEN
           (CL:NOT (PROPOSITION-REFERENCES-TERMS? IPROP CREATEDSKOLEMS))
           (CL:SETQ FILTEREDPROPSINDICES
            (CONS (WRAP-INTEGER IPROPINDEX) FILTEREDPROPSINDICES))
           (CL:GO :CONTINUE))
          (CL:IF (CL:EQ COLLECT-000 NULL)
           ...
           (CL:PROGN (CL:SETF (%%REST COLLECT-000) (CONS DPROP NIL))
            (CL:SETQ COLLECT-000 (%%REST COLLECT-000))))
          :CONTINUE)
         (CL:SETQ ITER-001 (%%REST ITER-001))
       ...
       (CL:WHEN (CL:NOT (CL:EQ FILTEREDPROPSINDICES NIL))
        (CL:LET* ((SELF-001 (NEW-DESCRIPTION)))
         (CL:SETF (%IO-VARIABLES SELF-001) (%IO-VARIABLES DESCRIPTION))
         (CL:SETF (%PROPOSITION SELF-001) (CONJOIN-PROPOSITIONS SKOLEMPROPS))
         (CL:SETQ DESCRIPTION SELF-001))
    ...
    (CONS-LIST
     (INITIALIZE-QUERY-ITERATOR (ALLOCATE-QUERY-ITERATOR) DESCRIPTION
      (NEW-VECTOR (ARITY DESCRIPTION)) "Skolem")
...
(CL:DEFUN FILTER-IMPLIED-SKOLEM-PROPOSITIONS (INHERITEDPROPS DESCRIPTION ARGUMENTS MAPPING)
  (CL:LET*
   ((CREATEDSKOLEMS
     (CL:IF (CL:NOT (CL:EQ MAPPING NULL))
      (LOOKUP MAPPING KWD-OPTIMIZE-CREATED-SKOLEMS) NULL))
    (FILTEREDPROPS INHERITEDPROPS) (FILTEREDPROPSINDICES NIL) (QUERY NULL)
    (CACHEDQUERYRECORD NIL))
   (CL:WHEN (CL:NOT (CL:EQ CREATEDSKOLEMS NULL))
    (CL:LET*
     ...
     (CL:WHEN *MEMOIZATION-ENABLED?*
      (CL:SETQ MEMO-TABLE-000
       (%SURROGATE-VALUE
        SGT-OPTIMIZE-LOGIC-F-FILTER-IMPLIED-SKOLEM-PROPOSITIONS-MEMO-TABLE-000))
      (CL:WHEN (CL:EQ MEMO-TABLE-000 NULL)
       (INITIALIZE-MEMOIZATION-TABLE
        SGT-OPTIMIZE-LOGIC-F-FILTER-IMPLIED-SKOLEM-PROPOSITIONS-MEMO-TABLE-000
       ...
       (CL:SETQ MEMO-TABLE-000
        (%SURROGATE-VALUE
         SGT-OPTIMIZE-LOGIC-F-FILTER-IMPLIED-SKOLEM-PROPOSITIONS-MEMO-TABLE-000)))
      (CL:SETQ MEMOIZED-ENTRY-000
       (LOOKUP-MRU-MEMOIZED-VALUE MEMO-TABLE-000 DESCRIPTION
     ...
     (CL:COND
      ...
      (CL:T
       (CL:SETQ MEMOIZED-VALUE-000
        (CREATE-SKOLEM-PROPOSITIONS-QUERY INHERITEDPROPS DESCRIPTION MAPPING))
       (CL:WHEN *MEMOIZATION-ENABLED?*
        (CL:SETF (%%VALUE MEMOIZED-ENTRY-000)
         (CL:IF (CL:EQ MEMOIZED-VALUE-000 NULL) MEMOIZED-NULL-VALUE
          MEMOIZED-VALUE-000)))))
     (CL:SETQ CACHEDQUERYRECORD MEMOIZED-VALUE-000))
    (CL:SETQ QUERY (%%VALUE CACHEDQUERYRECORD))
    (CL:SETQ FILTEREDPROPSINDICES (%%VALUE (%%REST CACHEDQUERYRECORD)))
    (CL:LET*
     ((ARG NULL) (VECTOR-000 ARGUMENTS) (INDEX-000 0)
      (LENGTH-000 (LENGTH VECTOR-000)) (I NULL-INTEGER) (ITER-000 0))
     (CL:DECLARE (CL:TYPE CL:FIXNUM INDEX-000 LENGTH-000 I ITER-000))
     (CL:LOOP WHILE (CL:< INDEX-000 LENGTH-000) DO
       ...
       ((SELF
         (%THE-ARRAY
          (DYNAMIC-SLOT-VALUE (%DYNAMIC-SLOTS QUERY)
           SYM-OPTIMIZE-LOGIC-INITIAL-BINDINGS NULL)))
      ...
      (CL:SETQ ITER-000 (CL:1+ ITER-000))))
    (CL:LET*
     ((*TYPE-CHECK-STRATEGY* KWD-OPTIMIZE-NONE) (*QUERYITERATOR* QUERY)
      (*REVERSEPOLARITY?* CL:NIL) (*INFERENCELEVEL* SUBSUMPTION-INFERENCE)
      (*GENERATE-ALL-PROOFS?* CL:NIL))
     (CL:DECLARE
      (CL:SPECIAL *TYPE-CHECK-STRATEGY* *QUERYITERATOR* *REVERSEPOLARITY?*
      ...
      (CL:LET* ((I NULL) (ITER-001 FILTEREDPROPSINDICES) (COLLECT-000 NULL))
       (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-001 NIL)) DO
        ...
        (CL:IF (CL:EQ COLLECT-000 NULL)
         (CL:PROGN
          (CL:SETQ COLLECT-000
           (CONS (NTH INHERITEDPROPS (%WRAPPER-VALUE I)) NIL))
    ...
    (CL:PROGN
     (CL:LET* ((MAPSTOVALUE (LOOKUP MAPPING VARIABLE)))
      ...
      (CL:COND
       ...
       (CL:T
        (CL:LET*
         ((SKOLEM (CREATE-VARIABLE-OR-SKOLEM (%SKOLEM-TYPE VARIABLE) NULL)))
         (INSERT-AT MAPPING VARIABLE SKOLEM)))))))
   (CL:T))
  CL:T)
...
(CL:DEFUN COLLECT-STRUCTURAL-FUNCTIONS (PROPOSITION STRUCTURALFUNCTIONS)
  (CL:LET* ((TEST-VALUE-000 (%KIND PROPOSITION)))
   (CL:COND
    ...
    ((CL:EQ TEST-VALUE-000 KWD-OPTIMIZE-AND)
     (CL:LET*
      ((CONJUNCT NULL) (VECTOR-000 (%ARGUMENTS PROPOSITION)) (INDEX-000 0)
       (LENGTH-000 (LENGTH VECTOR-000)))
      (CL:DECLARE (CL:TYPE CL:FIXNUM INDEX-000 LENGTH-000))
      (CL:LOOP WHILE (CL:< INDEX-000 LENGTH-000) DO
       (CL:SETQ CONJUNCT
...
(CL:DEFUN COMPUTE-STRUCTURAL-FUNCTION-EVALUATION-ORDER (SELF)
  (CL:LET*
   ((STRUCTURALFUNCTIONS (NEW-LIST)) (IOVARIABLES (%IO-VARIABLES SELF))
    (INTERNALVARIABLES (%INTERNAL-VARIABLES SELF)) (CANDIDATES (NEW-HASH-SET))
    (UNBOUNDINTERNALS (NEW-HASH-SET)) (SORTEDFUNCTIONS (NEW-LIST))
    (PROGRESS? CL:T))
   ...
   (CL:LET* ((FUNCTION NULL) (ITER-000 (%THE-CONS-LIST STRUCTURALFUNCTIONS)))
    (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-000 NIL)) DO
     ...
     (CL:SETQ ITER-000 (%%REST ITER-000))))
   (CL:LET*
    ((VAR NULL) (VECTOR-000 INTERNALVARIABLES) (INDEX-000 0)
     (LENGTH-000 (LENGTH VECTOR-000)))
    (CL:DECLARE (CL:TYPE CL:FIXNUM INDEX-000 LENGTH-000))
    (CL:LOOP WHILE (CL:< INDEX-000 LENGTH-000) DO
     (CL:SETQ VAR
      (CL:AREF (CL:THE CL:SIMPLE-VECTOR (%THE-ARRAY VECTOR-000)) INDEX-000))
     (INSERT UNBOUNDINTERNALS VAR) (CL:SETQ INDEX-000 (CL:1+ INDEX-000))))
   (CL:LOOP WHILE PROGRESS? DO (CL:SETQ PROGRESS? CL:NIL)
       ...
       (CL:SETQ TEST-VALUE-000
        (CL:NOT
         (MEMBER? UNBOUNDINTERNALS
          (CL:AREF
           (CL:THE CL:SIMPLE-VECTOR (%THE-ARRAY (%ARGUMENTS CANDIDATE)))
           (CL:THE CL:FIXNUM (CL:1- (LENGTH (%ARGUMENTS CANDIDATE))))))))
       (CL:WHEN TEST-VALUE-000
        (CL:LET* ((ALWAYS?-000 CL:T))
         (CL:LET*
          ((ARG NULL) (VECTOR-001 (%ARGUMENTS CANDIDATE)) (INDEX-001 0)
           (LENGTH-001 (LENGTH VECTOR-001)) (I NULL-INTEGER) (ITER-002 2)
           (UPPER-BOUND-000 (LENGTH (%ARGUMENTS CANDIDATE))))
          (CL:DECLARE
           (CL:TYPE CL:FIXNUM INDEX-001 LENGTH-001 I ITER-002
            UPPER-BOUND-000))
          (CL:LOOP WHILE
           ...
           (CL:SETQ ARG
            (CL:AREF (CL:THE CL:SIMPLE-VECTOR (%THE-ARRAY VECTOR-001))
             INDEX-001))
           (CL:SETQ I ITER-002)
           (CL:WHEN (MEMBER? UNBOUNDINTERNALS ARG)
            (CL:SETQ ALWAYS?-000 CL:NIL) (CL:RETURN))
           (CL:SETQ INDEX-001 (CL:1+ INDEX-001))
           (CL:SETQ ITER-002 (CL:1+ ITER-002))))
         (CL:SETQ TEST-VALUE-000 ALWAYS?-000)))
       (CL:WHEN TEST-VALUE-000 (PUSH SORTEDFUNCTIONS CANDIDATE)
        (REMOVE CANDIDATES CANDIDATE) (CL:SETQ PROGRESS? CL:T)))))
    (CL:LET* ((CANDIDATE NULL) (ITER-003 (ALLOCATE-ITERATOR CANDIDATES)))
     (CL:LOOP WHILE (NEXT? ITER-003) DO (CL:SETQ CANDIDATE (%VALUE ITER-003))
      (CL:LET* ((ALWAYS?-001 CL:T))
       (CL:LET*
        ((ARG NULL) (VECTOR-002 (%ARGUMENTS CANDIDATE)) (INDEX-002 0)
         (LENGTH-002 (LENGTH VECTOR-002)) (I NULL-INTEGER) (ITER-004 2)
         (UPPER-BOUND-001 (LENGTH (%ARGUMENTS CANDIDATE))))
        (CL:DECLARE
         (CL:TYPE CL:FIXNUM INDEX-002 LENGTH-002 I ITER-004 UPPER-BOUND-001))
        (CL:LOOP WHILE
         (CL:AND (CL:< INDEX-002 LENGTH-002) (CL:<= ITER-004 UPPER-BOUND-001))
         DO
         (CL:SETQ ARG
          (CL:AREF (CL:THE CL:SIMPLE-VECTOR (%THE-ARRAY VECTOR-002))
           INDEX-002))
         (CL:SETQ I ITER-004)
         (CL:WHEN (MEMBER? UNBOUNDINTERNALS ARG) (CL:SETQ ALWAYS?-001 CL:NIL)
          (CL:RETURN))
         (CL:SETQ INDEX-002 (CL:1+ INDEX-002))
         (CL:SETQ ITER-004 (CL:1+ ITER-004))))
       (CL:WHEN ALWAYS?-001 (PUSH SORTEDFUNCTIONS CANDIDATE)
...
(CL:DEFMETHOD STRUCTURAL-FUNCTION-EVALUATION-ORDER ((SELF DESCRIPTION))
  (CL:LET*
   ((ANSWER
     (DYNAMIC-SLOT-VALUE (%DYNAMIC-SLOTS SELF)
      SYM-OPTIMIZE-LOGIC-STRUCTURAL-FUNCTION-EVALUATION-ORDER NULL)))
   (CL:IF (CL:EQ ANSWER NULL) NIL-LIST ANSWER)))
...
(CL:DEFUN GET-STRUCTURAL-FUNCTION-EVALUATION-ORDER (SELF)
  (CL:LET* ((EVALUATIONORDER (STRUCTURAL-FUNCTION-EVALUATION-ORDER SELF)))
   (CL:WHEN (NULL-LIST? EVALUATIONORDER)
    (CL:SETQ EVALUATIONORDER
     (COMPUTE-STRUCTURAL-FUNCTION-EVALUATION-ORDER SELF))
    (SET-DYNAMIC-SLOT-VALUE (%DYNAMIC-SLOTS SELF)
     SYM-OPTIMIZE-LOGIC-STRUCTURAL-FUNCTION-EVALUATION-ORDER EVALUATIONORDER
     NULL))
   EVALUATIONORDER))
  ...
  (CL:LET* ((COPY (FIND-SIMILAR-PROPOSITION PROPOSITION MAPPING)))
   (CL:WHEN
    (CL:AND (CL:EQ COPY NULL)
     (CL:EQ (%KIND PROPOSITION) KWD-OPTIMIZE-FUNCTION))
  ...
  (CL:LET* ((MAPPING (NEW-KEY-VALUE-MAP)))
   (CL:LET*
    ((V NULL) (VECTOR-000 (%IO-VARIABLES DESCRIPTION)) (INDEX-000 0)
     (LENGTH-000 (LENGTH VECTOR-000)) (ARG NULL) (VECTOR-001 ARGUMENTS)
     (INDEX-001 0) (LENGTH-001 (LENGTH VECTOR-001)))
    (CL:DECLARE (CL:TYPE CL:FIXNUM INDEX-000 LENGTH-000 INDEX-001 LENGTH-001))
    (CL:LOOP WHILE
     (CL:AND (CL:< INDEX-000 LENGTH-000) (CL:< INDEX-001 LENGTH-001)) DO
   ...
   (CL:LET*
    ((P NULL)
     (ITER-000
      (%THE-CONS-LIST
       (GET-STRUCTURAL-FUNCTION-EVALUATION-ORDER DESCRIPTION))))
    (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-000 NIL)) DO
     (CL:SETQ P (%%VALUE ITER-000))
   ...
   (CL:LET*
    ((PROPOSITIONS
      (INHERIT-AS-TOP-LEVEL-PROPOSITION (%PROPOSITION DESCRIPTION) MAPPING)))
    (CL:LET* ((IT (ALLOCATE-ITERATOR PROPOSITIONS)))
     (CL:LOOP WHILE (NEXT? IT) DO
      (VALUE-SETTER IT
       (RECURSIVELY-FASTEN-DOWN-PROPOSITIONS (%VALUE IT) CL:NIL))))
  ...
  (CL:LET* ((TEST-VALUE-000 (SAFE-PRIMARY-TYPE SELF)))
   (CL:COND
    ((SUBTYPE-OF? TEST-VALUE-000 SGT-OPTIMIZE-STELLA-VECTOR)
     (CL:PROGN
      (VECTOR.INHERIT-UNNAMED-DESCRIPTION SELF DESCRIPTION DEFAULTTRUE?)))
    ((SUBTYPE-OF? TEST-VALUE-000 SGT-OPTIMIZE-LOGIC-LOGIC-OBJECT)
     (CL:PROGN
...
(CL:DEFUN VECTOR.INHERIT-UNNAMED-DESCRIPTION (ARGUMENTS DESCRIPTION DEFAULTTRUE?)
  (CL:LET* ((PROPOSITIONS NULL) (MAPPING NULL))
   (CL:MULTIPLE-VALUE-SETQ (PROPOSITIONS MAPPING)
    (INHERIT-DESCRIPTION-PROPOSITIONS ARGUMENTS DESCRIPTION))
   (CL:LET*
    ((PROP NULL)
     (ITER-000
      (FILTER-IMPLIED-SKOLEM-PROPOSITIONS PROPOSITIONS DESCRIPTION ARGUMENTS
       MAPPING))
     (COLLECT-000 NULL))
    (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-000 NIL)) DO
  ...
  (CL:PROGN
   ...
   (CL:SETQ SGT-OPTIMIZE-PL-KERNEL-KB-BOUND-VARIABLES
    (INTERN-RIGID-SYMBOL-WRT-MODULE "BOUND-VARIABLES"
     (GET-STELLA-MODULE "/PL-KERNEL-KB" CL:T) 1))
   (CL:SETQ KWD-OPTIMIZE-BACKWARD
    (INTERN-RIGID-SYMBOL-WRT-MODULE "BACKWARD" NULL 2))
   (CL:SETQ
    SGT-OPTIMIZE-LOGIC-F-DYNAMICALLY-ESTIMATE-INFERENCE-COST-MEMO-TABLE-000
    (INTERN-RIGID-SYMBOL-WRT-MODULE
     "F-DYNAMICALLY-ESTIMATE-INFERENCE-COST-MEMO-TABLE-000" NULL 1))
...
(CL:DEFUN HELP-STARTUP-OPTIMIZE2 ()
  (CL:PROGN
   ...
   (CL:SETQ KWD-OPTIMIZE-CREATED-SKOLEMS
    (INTERN-RIGID-SYMBOL-WRT-MODULE "CREATED-SKOLEMS" NULL 2))
   (CL:SETQ SGT-OPTIMIZE-LOGIC-SKOLEM
    (INTERN-RIGID-SYMBOL-WRT-MODULE "SKOLEM" NULL 1))
   (CL:SETQ
    SGT-OPTIMIZE-LOGIC-F-FILTER-IMPLIED-SKOLEM-PROPOSITIONS-MEMO-TABLE-000
    (INTERN-RIGID-SYMBOL-WRT-MODULE
     "F-FILTER-IMPLIED-SKOLEM-PROPOSITIONS-MEMO-TABLE-000" NULL 1))
   (CL:SETQ SYM-OPTIMIZE-LOGIC-INITIAL-BINDINGS
    (INTERN-RIGID-SYMBOL-WRT-MODULE "INITIAL-BINDINGS" NULL 0))
   (CL:SETQ SYM-OPTIMIZE-LOGIC-STRUCTURAL-FUNCTION-EVALUATION-ORDER
    (INTERN-RIGID-SYMBOL-WRT-MODULE "STRUCTURAL-FUNCTION-EVALUATION-ORDER"
     NULL 0))
...
(CL:DEFUN HELP-STARTUP-OPTIMIZE3 ()
  (CL:PROGN
   ...
   (CL:SETQ *OPTIMALGOALORDERINGRECURSIONS* NULL-INTEGER)
   (CL:SETQ *BOUNDTOOFFSETCOUNTER* NULL-INTEGER)
...
(CL:DEFUN HELP-STARTUP-OPTIMIZE5 ()
  (CL:PROGN
   ...
   (DEFINE-FUNCTION-OBJECT "COUNT-BOUND-ARGUMENTS"
    "(DEFUN (COUNT-BOUND-ARGUMENTS INTEGER) ((GOAL PROPOSITION)))"
   ...
   (DEFINE-FUNCTION-OBJECT "STARTUP-OPTIMIZE"
    "(DEFUN STARTUP-OPTIMIZE () :PUBLIC? TRUE)" (CL:FUNCTION STARTUP-OPTIMIZE)
    NULL)
