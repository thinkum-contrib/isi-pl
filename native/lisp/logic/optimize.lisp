...
(CL:DEFVAR SGT-OPTIMIZE-STELLA-LITERAL NULL)
...
(CL:DEFVAR SYM-OPTIMIZE-LOGIC-INDEX-ON-VALUES? NULL)
...
(CL:DECLAIM
  ...
  *PRINTMODE* TRUE-PROPOSITION *TRACED-KEYWORDS* STANDARD-OUTPUT EOL
  TRUE-WRAPPER *MODULE* ONE-WRAPPER ZERO-WRAPPER FALSE-WRAPPER NIL-LIST
  *REVERSEPOLARITY?* *CONTEXT* *QUERYITERATOR*))
...
(CL:DEFUN RELATION-SUPPORTS-EXTENSION? (SELF)
  (CL:AND
   ...
   (CL:OR (CL:NOT (CLASS-DESCRIPTION? SELF))
    (CL:NOT
     (LOGICAL-SUBTYPE-OF? (%SURROGATE-VALUE-INVERSE SELF)
      SGT-OPTIMIZE-STELLA-LITERAL)))
   (CL:OR TRUE
    (CL:NOT
     (CL:EQ
...
(CL:DEFUN INITIALIZE-OPTIMIZER-GOAL-RECORDS (SIZE)
  ...
  (CL:LET* ((STACK (%OPTIMIZER-GOAL-RECORDS *QUERYITERATOR*)))
   (CL:WHEN (CL:EQ STACK NULL) (CL:SETQ STACK (NEW-EXTENSIBLE-VECTOR 20))
    (CL:SETF (%OPTIMIZER-GOAL-RECORDS *QUERYITERATOR*) STACK))
...
(CL:DEFUN GOAL-RECORD (VARIABLE)
  (CL:AREF
   (CL:THE CL:SIMPLE-VECTOR
    (%THE-ARRAY (%OPTIMIZER-GOAL-RECORDS *QUERYITERATOR*)))
   (CL:THE CL:FIXNUM (%BOUND-TO-OFFSET VARIABLE))))
...
(CL:DEFUN GET-BINARY-INDEXING-VECTOR (SELF)
  (CL:LET*
   ((BITONE?
     (CL:OR (TYPE-HAS-BACKLINKS? (NTH (%IO-VARIABLE-TYPES SELF) 0))
      (CL:AND
       (CL:NOT
        (CL:EQ
         (DYNAMIC-SLOT-VALUE (%DYNAMIC-SLOTS SELF)
       ...
       (%WRAPPER-VALUE
        (DYNAMIC-SLOT-VALUE
         (%DYNAMIC-SLOTS
          (DYNAMIC-SLOT-VALUE (%DYNAMIC-SLOTS SELF)
           SYM-OPTIMIZE-LOGIC-INVERSE-DESCRIPTION NULL))
         SYM-OPTIMIZE-LOGIC-INDEX-ON-VALUES? FALSE-WRAPPER)))))
    (BITTWO?
     (CL:OR (TYPE-HAS-BACKLINKS? (NTH (%IO-VARIABLE-TYPES SELF) 1))
      (%WRAPPER-VALUE
       (DYNAMIC-SLOT-VALUE (%DYNAMIC-SLOTS SELF)
        SYM-OPTIMIZE-LOGIC-INDEX-ON-VALUES? FALSE-WRAPPER)))))
    ...
    (CL:LET*
     ...
     (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-000 NIL)) DO
      ...
      (CL:IF (CL:EQ COLLECT-000 NULL)
       (CL:PROGN
        (CL:SETQ COLLECT-000
         (CONS (CL:IF (TYPE-HAS-BACKLINKS? TYPE) ONE-WRAPPER ZERO-WRAPPER)
          NIL))
...
(CL:PROGN (CL:DEFVAR ESTIMATED-SLOT-VALUE-COLLECTION-SIZE 4.0d0 "Estimate of the average size of a collection
representing the fillers of a slot.") (CL:DECLAIM (CL:TYPE CL:DOUBLE-FLOAT ESTIMATED-SLOT-VALUE-COLLECTION-SIZE)))

;;; (DEFCONSTANT ESTIMATED-NUMBER-OF-PREDICATE-BINDINGS ...)

(CL:PROGN (CL:DEFVAR ESTIMATED-NUMBER-OF-PREDICATE-BINDINGS 6.0d0 "Very crude estimate of the number of stored propositions
that will match a predicate at least one of whose arguments are bound.
Chosen to be larger than ESTIMATED-SLOT-VALUE-COLLECTION-SIZE.") (CL:DECLAIM (CL:TYPE CL:DOUBLE-FLOAT ESTIMATED-NUMBER-OF-PREDICATE-BINDINGS)))

;;; (DEFCONSTANT ESTIMATED-SIZE-OF-CLASS-EXTENSION ...)

(CL:PROGN (CL:DEFVAR ESTIMATED-SIZE-OF-CLASS-EXTENSION 11.0d0 "Must be greater than ESTIMATED-NUMBER-OF-PREDICATE-BINDINGS
...
for no particularly valid reason.") (CL:DECLAIM (CL:TYPE CL:DOUBLE-FLOAT ESTIMATED-SIZE-OF-CLASS-EXTENSION)))

;;; (DEFCONSTANT ESTIMATED-CARDINALITY-OF-DESCRIPTION ...)

(CL:PROGN (CL:DEFVAR ESTIMATED-CARDINALITY-OF-DESCRIPTION 20.0d0 "Indefensible estimate of the number instances
generable by an arbitrary unnamed description.") (CL:DECLAIM (CL:TYPE CL:DOUBLE-FLOAT ESTIMATED-CARDINALITY-OF-DESCRIPTION)))

;;; (DEFCONSTANT ESTIMATED-CARDINALITY-OF-MEMBER-OF ...)

(CL:PROGN (CL:DEFVAR ESTIMATED-CARDINALITY-OF-MEMBER-OF 30.0d0 "Even more indefensible estimate of the number instances
generable by a 'member-of' predicate.  CAUTION: Must be set
less than 'ESTIMATED-CARDINALITY-OF-SUBSET-OF'.") (CL:DECLAIM (CL:TYPE CL:DOUBLE-FLOAT ESTIMATED-CARDINALITY-OF-MEMBER-OF)))

;;; (DEFCONSTANT ESTIMATED-CARDINALITY-OF-SUBSET-OF ...)

(CL:PROGN (CL:DEFVAR ESTIMATED-CARDINALITY-OF-SUBSET-OF 40.0d0 "Egregiously indefensible estimate of the number instances
...
incompleteness.") (CL:DECLAIM (CL:TYPE CL:DOUBLE-FLOAT ESTIMATED-CARDINALITY-OF-SUBSET-OF)))
...
(CL:DEFUN ESTIMATE-CARDINALITY-OF-EXTENSION (DESCRIPTION)
  ...
  (CL:LET* ((ESTIMATE (ACCESS-OBSERVED-CARDINALITY DESCRIPTION)))
   ...
   (CL:WHEN (NULL? ESTIMATE) (CL:SETQ ESTIMATE (CL:TRUNCATE 0.0d0)))
   (CL:FLOAT
    (MAX ESTIMATE
     ...
     (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-000 NIL)) DO
      ...
      (CL:LET*
       ((GBIT NULL) (UBIT NULL) (VECTOR-002 UNIQUENESSKEY) (INDEX-002 0)
        (LENGTH-002 (LENGTH VECTOR-002)) (VECTOR-003 GOALVECTOR)
...
(CL:PROGN (CL:DEFVAR INFERABLE-PENALTY-COST 7.0d0 "Amount of penalty for using inferable relations as goals.") (CL:DECLAIM (CL:TYPE CL:DOUBLE-FLOAT INFERABLE-PENALTY-COST)))

;;; (DEFCONSTANT SUBSET-OF-PENALTY-COST ...)

(CL:PROGN (CL:DEFVAR SUBSET-OF-PENALTY-COST 20.0d0 "Amount of penalty for using 'subset-of' as a goal.") (CL:DECLAIM (CL:TYPE CL:DOUBLE-FLOAT SUBSET-OF-PENALTY-COST)))
...
(CL:PROGN (CL:DEFVAR *OPTIMALGOALORDERINGRECURSIONS* NULL-INTEGER) (CL:DECLAIM (CL:TYPE CL:FIXNUM *OPTIMALGOALORDERINGRECURSIONS*)))

;;; (DEFGLOBAL *OPTIMAL-GOAL-ORDERING-CUTOFF* ...)

(CL:PROGN (CL:DEFVAR *OPTIMAL-GOAL-ORDERING-CUTOFF* 100) (CL:DECLAIM (CL:TYPE CL:FIXNUM *OPTIMAL-GOAL-ORDERING-CUTOFF*)))
...
(CL:DEFUN COMPUTE-OPTIMAL-OPEN-GOAL-ORDERING (OPTIMIZERVARIABLES NUMBEROFOPENGOALS GOALSEQUENCE PRIORCOST PRIORFANOUT)
  ...
  (CL:LET*
   ((GOALSEQUENCECHECKPOINT NULL)
    (CHOICEPOINTUNBINDINGOFFSET NULL-INTEGER) (CUMULATIVECOST NULL-FLOAT)
   ...
   (CL:WHEN (EMPTY? OPTIMIZERVARIABLES)
    (CL:SETF (%BEST-GOAL-SEQUENCE *QUERYITERATOR*) GOALSEQUENCE)
    (CL:RETURN-FROM COMPUTE-OPTIMAL-OPEN-GOAL-ORDERING))
      ...
      (CL:WHEN (CL:NOT (VARIABLE-BOUND? VBL))
       (CL:LET*
        ...
        (CL:WHEN
         ...
         (CL:GO :CONTINUE))
        (CL:WHEN
         (CL:AND (CL:NOT (CL:= (%BEST-COST *QUERYITERATOR*) NULL-FLOAT))
          (CL:>= CUMULATIVECOST (%BEST-COST *QUERYITERATOR*)))
         (CL:GO :CONTINUE))
       ...
       (CL:IF (CL:= (LENGTH GOALSEQUENCE) NUMBEROFOPENGOALS)
        (CL:WHEN
         (CL:OR (CL:= (%BEST-COST *QUERYITERATOR*) NULL-FLOAT)
          (CL:< CUMULATIVECOST (%BEST-COST *QUERYITERATOR*)))
         (CL:SETF (%BEST-COST *QUERYITERATOR*) CUMULATIVECOST)
         (CL:SETF (%BEST-GOAL-SEQUENCE *QUERYITERATOR*)
          (COPY GOALSEQUENCE)))
...
(CL:DEFUN COMPUTE-GREEDY-OPEN-GOAL-ORDERING (OPTIMIZERVARIABLES NUMBEROFOPENGOALS GOALSEQUENCE PRIORCOST PRIORFANOUT)
  ...
  (CL:LET*
   ((GOALSEQUENCECHECKPOINT NULL)
    ...
    (BESTGENERATORGOALCOST NULL-FLOAT) (BESTGENERATORFANOUT NULL-FLOAT)
    (BESTCOMBINEDCOST NULL-FLOAT) (OPENGOALREDUCTION NULL-INTEGER))
   (CL:DECLARE
    (CL:TYPE CL:FIXNUM CHOICEPOINTUNBINDINGOFFSET OPENGOALREDUCTION)
    (CL:TYPE CL:DOUBLE-FLOAT BESTGENERATORGOALCOST BESTGENERATORFANOUT
     BESTCOMBINEDCOST))
   (CL:WHEN (EMPTY? OPTIMIZERVARIABLES)
    (CL:SETF (%BEST-GOAL-SEQUENCE *QUERYITERATOR*) GOALSEQUENCE)
    (CL:RETURN-FROM COMPUTE-GREEDY-OPEN-GOAL-ORDERING))
   (CL:LOOP
    (CL:TAGBODY (CL:SETQ BESTGENERATORGOAL NULL)
     (CL:SETQ BESTGENERATORGOALCOST NULL-FLOAT)
     ...
     (CL:WHEN (CL:EQ BESTGENERATORGOAL NULL)
      (CL:WHEN (CL:= (LENGTH GOALSEQUENCE) NUMBEROFOPENGOALS)
       (CL:SETF (%BEST-COST *QUERYITERATOR*) PRIORCOST)
       (CL:SETF (%BEST-GOAL-SEQUENCE *QUERYITERATOR*) GOALSEQUENCE))
      (CL:RETURN-FROM COMPUTE-GREEDY-OPEN-GOAL-ORDERING))
...
(CL:DEFUN EXTRACT-OPEN-GOAL-CLUSTERS (OPENGOALS OPENGOALCLUSTERS)
  (CL:LET*
   ((ALLGOALS (COPY-CONS-LIST (%THE-CONS-LIST OPENGOALS)))
    ...
    (CURRENTCLUSTERVARS (NEW-LIST)) (CURRENTCLUSTERVARSGREW? FALSE)
...
;;; (DEFGLOBAL *CONJUNCTION-CLUSTERING-ENABLED?* ...)

(CL:DEFVAR *CONJUNCTION-CLUSTERING-ENABLED?* TRUE)
...
(CL:DEFUN COMPUTE-OPEN-GOAL-ORDERING (ANDPROPOSITION OPENGOALS GOALSEQUENCE)
  (CL:LET*
   ...
   (CL:WHEN *CONJUNCTION-CLUSTERING-ENABLED?*
   ...
   (CL:LET* ((*OPTIMALGOALORDERINGRECURSIONS* 0))
    ...
    (CL:WHEN
     ...
     (CL:SETF (%BEST-COST *QUERYITERATOR*) NULL-FLOAT)
          ...
          (CL:LOOP WHILE (CL:< INDEX-000 LENGTH-000) DO
           ...
           (CL:WHEN
            (CL:AND (ARGUMENT-BOUND? ARG)
             (TYPE-HAS-BACKLINKS? (LOGICAL-TYPE ARG)))
            (CL:SETQ FOUND?-000 TRUE) (CL:RETURN))))
...
(CL:DEFUN INITIALIZE-OPTIMIZER-MEMORY (STACKSIZE)
  ...
  (CL:WHEN
   (CL:AND (CL:<= STACKSIZE 0)
    (CL:NOT (CL:EQ (%OPTIMIZER-GOAL-RECORDS *QUERYITERATOR*) NULL)))
   (CL:SETQ STACKSIZE (LENGTH (%OPTIMIZER-GOAL-RECORDS *QUERYITERATOR*))))
  (INITIALIZE-OPTIMIZER-GOAL-RECORDS STACKSIZE)
  (CLEAR (%RESIDUE-GOALS *QUERYITERATOR*))
  (CLEAR (%BEST-GOAL-SEQUENCE *QUERYITERATOR*))
  (CL:SETF (%BEST-COST *QUERYITERATOR*) NULL-FLOAT))
...
(CL:PROGN (CL:DEFVAR *BOUNDTOOFFSETCOUNTER* NULL-INTEGER "Enables 'select-optimal-query-pattern' to tell
'copy-variables-vector' that it should initialize the 'bound-to-offset'
slot of each variable in the copy operation.") (CL:DECLAIM (CL:TYPE CL:FIXNUM *BOUNDTOOFFSETCOUNTER*)))

;;; (DEFGLOBAL *USE-QUERY-OPTIMIZER?* ...)

(CL:DEFVAR *USE-QUERY-OPTIMIZER?* TRUE
  "If TRUE, the query optimizer will be used to optimize
query descriptions.")
...
(CL:DEFUN SELECT-OPTIMAL-QUERY-PATTERN (DESCRIPTION BOOLEANVECTOR PARENTFRAME)
  (CL:LET* ((PATTERN NULL) (QUERYPATTERNS (%QUERY-PATTERNS DESCRIPTION)))
   ...
   (CL:WHEN
    (CL:NOT
     (CL:OR (CL:NOT *USE-QUERY-OPTIMIZER?*)
      (%WRAPPER-VALUE
       (DYNAMIC-SLOT-VALUE (%DYNAMIC-SLOTS DESCRIPTION)
   ...
   (CL:COND
    ((CL:EQ TEST-VALUE-000 KWD-OPTIMIZE-ISA)
     (CL:AND
      (EQL?
       (CL:AREF
        (CL:THE CL:SIMPLE-VECTOR (%THE-ARRAY (%ARGUMENTS OTHERCONJUNCT)))
        0)
       (CL:AREF
       ...
       (CL:WHEN TEST-VALUE-001 (CL:SETQ TEST-VALUE-001 (TYPE? INTYPE))
        (CL:WHEN TEST-VALUE-001
         ...
         (CL:WHEN TEST-VALUE-001
          (CL:LET* ((FOUND?-000 FALSE))
           (CL:LET*
            ((ARGTYPE NULL) (ARG NULL)
             (VECTOR-000 (%ARGUMENTS OTHERCONJUNCT)) (INDEX-000 0)
             (LENGTH-000 (LENGTH VECTOR-000))
             (ITER-000
              (%THE-CONS-LIST
               (%IO-VARIABLE-TYPES
...
(CL:DEFUN SIMPLIFY-PROPOSITION (PROPOSITION)
  (CL:COND
   ((CL:EQ (%KIND PROPOSITION) KWD-OPTIMIZE-AND)
           ...
           (CL:IF (CL:EQ COLLECT-000 NULL)
            (CL:PROGN (CL:SETQ COLLECT-000 (CONS COPY NIL))
             (CL:IF (CL:EQ REALEXTERNALVARS NIL)
              ...
              (ADD-CONS-TO-END-OF-CONS-LIST REALEXTERNALVARS
               COLLECT-000)))
...
(CL:DEFUN COPY-VARIABLE (SELF MAPPING)
  (CL:LET* ((COPY (LOOKUP MAPPING SELF)))
   ...
   (CL:SETQ COPY
    (CREATE-VARIABLE (%ROOT-TYPE SELF) (%SKOLEM-NAME SELF) FALSE))
   (CL:COND
   ...
   (CL:SETF (%ROOT-TYPE COPY) (%ROOT-TYPE SELF))
   (CL:WHEN
    (CL:NOT
     (CL:EQ
...
(CL:DEFUN COPY-PROPOSITION (SELF MAPPING)
  (CL:LET* ((COPY (LOOKUP MAPPING SELF)))
   ...
   (CL:LET* ((*MODULE* (%HOME-CONTEXT SELF)) (*CONTEXT* *MODULE*))
    ...
    (CL:WHEN (CL:NOT (CL:= (%WEIGHT SELF) NULL-FLOAT))
     (CL:SETF (%WEIGHT COPY) (%WEIGHT SELF)))
   ...
   (CL:LET*
    ...
    (CL:LOOP WHILE (CL:< INDEX-000 LENGTH-000) DO
     (CL:PROGN
      ...
      (CL:SETQ INDEX-000 (CL:1+ INDEX-000)))
     (CL:TAGBODY
      (CL:WHEN (ISA? ARG SGT-OPTIMIZE-LOGIC-NAMED-DESCRIPTION)
       (CL:SETQ HASDISCOURAGEDARGUMENT? TRUE) (CL:GO :CONTINUE))
    ...
    ((SUBTYPE-OF? (SAFE-PRIMARY-TYPE ARGMAPSTO)
     ...
     (CL:PROGN
      (CL:SETQ DEPENDENTSLIST
       (UNFILTERED-DEPENDENT-PROPOSITIONS ARGMAPSTO NULL))
      (CL:COND
       ((CL:EQ KIND KWD-OPTIMIZE-FUNCTION)
        (CL:LET* ((VALUE-000 NULL))
             ...
             (CL:WHEN TEST-VALUE-000
              (CL:LET* ((ALWAYS?-000 TRUE))
               (CL:LET*
                ...
                (CL:LOOP WHILE (CL:AND (NEXT? ITER-001) (NEXT? ITER-002))
            ...
            (CL:WHEN TEST-VALUE-001
             ...
             (CL:WHEN TEST-VALUE-001
              (CL:LET* ((ALWAYS?-001 TRUE))
               (CL:LET*
                ((ARG2 NULL) (ARG1 NULL)
                 (VECTOR-002 (%ARGUMENTS PROPOSITION)) (INDEX-002 0)
                 (LENGTH-002 (LENGTH VECTOR-002))
...
(CL:DEFUN CREATE-SKOLEM-FOR-UNMAPPED-VARIABLE (VARIABLE MAPPING)
  (CL:LET* ((SKOLEM (LOOKUP MAPPING VARIABLE)))
   ...
   (CL:SETQ SKOLEM (CREATE-VARIABLE-OR-SKOLEM (%ROOT-TYPE VARIABLE) NULL))
    ...
    (CL:PROGN
     (CL:LET* ((MAPSTOVALUE (LOOKUP MAPPING VARIABLE)))
      ...
      (CL:COND ((CL:NOT (CL:EQ MAPSTOVALUE NULL)))
       ...
       (CL:T
        (CL:LET*
         ((SKOLEM (CREATE-VARIABLE-OR-SKOLEM (%ROOT-TYPE VARIABLE) NULL)))
  ...
  (CL:PROGN
   ...
   (CL:SETQ SGT-OPTIMIZE-PL-KERNEL-KB-ABSTRACT
    (INTERN-RIGID-SYMBOL-WRT-MODULE "ABSTRACT"
     (GET-STELLA-MODULE "/PL-KERNEL-KB" TRUE) 1))
   (CL:SETQ SGT-OPTIMIZE-STELLA-LITERAL
   ...
   (CL:SETQ SYM-OPTIMIZE-LOGIC-INDEX-ON-VALUES?
...
(CL:DEFUN STARTUP-OPTIMIZE ()
  (CL:LET*
   ...
   (CL:WHEN (CURRENT-STARTUP-TIME-PHASE? 4) (HELP-STARTUP-OPTIMIZE2))
   ...
   (CL:WHEN (CURRENT-STARTUP-TIME-PHASE? 7) (HELP-STARTUP-OPTIMIZE3)
    ...
    (CL:LET*
     ...
     (SET-DYNAMIC-SLOT-VALUE (%DYNAMIC-SLOTS FUNCTION)
      ...
      (WRAP-STRING "Startup-Optimize") NULL-STRING-WRAPPER)))
...
incompleteness.\")")
    ...
    (DEFINE-STELLA-GLOBAL-VARIABLE-FROM-STRINGIFIED-SOURCE
     "(DEFGLOBAL *CONJUNCTION-CLUSTERING-ENABLED?* BOOLEAN TRUE)")
    (DEFINE-STELLA-GLOBAL-VARIABLE-FROM-STRINGIFIED-SOURCE
...
slot of each variable in the copy operation.\")")
    (DEFINE-STELLA-GLOBAL-VARIABLE-FROM-STRINGIFIED-SOURCE
     "(DEFGLOBAL *USE-QUERY-OPTIMIZER?* BOOLEAN TRUE :DOCUMENTATION \"If TRUE, the query optimizer will be used to optimize
query descriptions.\")")
    (DEFINE-STELLA-GLOBAL-VARIABLE-FROM-STRINGIFIED-SOURCE
