...
(CL:DECLAIM
  ...
  *PRINTMODE* TRUE-PROPOSITION *QUERY-OPTIMIZATION-STRATEGY*
  ...
  FALSE-WRAPPER NULL-FLOAT *MODULE* NIL ONE-WRAPPER ZERO-WRAPPER
  NIL-LIST NULL-INTEGER *REVERSEPOLARITY?* *CONTEXT* TRUE
  *QUERYITERATOR* FALSE))
   ...
   (CL:LET* ((ALLBITSMATCH? FALSE))
    (CL:LET*
     ...
     (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-000 NIL)) DO
      ...
      (CL:LET*
       ((GBIT NULL) (UBIT NULL) (VECTOR-002 UNIQUENESSKEY)
  ...
  (CL:LET*
   ...
   (CL:LET*
    ...
    (CL:WHEN (CL:NOT (CL:EQ PARENTMAPPING NULL))
     (CL:LET*
      ((V NULL) (K NULL) (ITER-000 (%THE-KV-LIST PARENTMAPPING)))
     ...
     (CL:WHEN (CL:<= I NOFINPUTARGS)
      ...
      (CL:IF (CL:EQ COLLECT-000 NULL)
       ...
       (CL:PROGN (CL:SETF (%%REST COLLECT-000) (CONS ARGMAPSTO NIL))
        (CL:SETQ COLLECT-000 (%%REST COLLECT-000)))))))
   (CL:SETQ COPY
    (CREATE-FUNCTION-PROPOSITION (%OPERATOR SELF) INPUTARGS))
   COPY))
   ...
   (CL:LET*
    ...
    (CL:LOOP WHILE (CL:< INDEX-000 LENGTH-000) DO
     (CL:PROGN
      ...
      (CL:SETQ INDEX-000 (CL:1+ INDEX-000)))
     (CL:TAGBODY
      (CL:WHEN FALSE (CL:SETQ HASDISCOURAGEDARGUMENT? TRUE)
       (CL:GO :CONTINUE))
...
(CL:DEFUN INHERIT-PROPOSITION (SELF MAPPING)
  ...
  (CL:LET* ((MATCHINGPROPOSITION (LOOKUP MAPPING SELF)))
   ...
   (CL:SETQ MATCHINGPROPOSITION
    (FIND-SIMILAR-PROPOSITION SELF MAPPING))
   (CL:WHEN (CL:NOT (CL:EQ MATCHINGPROPOSITION NULL))
...
(CL:DEFUN INHERIT-DESCRIPTION-PROPOSITIONS (ARGUMENTS DESCRIPTION)
  (CL:LET*
   ...
   (CL:LET*
    ((V NULL) (VECTOR-002 (%INTERNAL-VARIABLES DESCRIPTION))
