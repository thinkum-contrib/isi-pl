...
(CL:DECLAIM (CL:SPECIAL *STARTUP-TIME-PHASE* *MODULE* NULL-INTEGER NIL FALSE))
...
(CL:DEFUN NEW-LOGIC-EXCEPTION (MESSAGE)
  ...
  (CL:LET* ((SELF NULL))
   (CL:SETQ SELF
    (CL:MAKE-CONDITION (CL:QUOTE LOGIC-EXCEPTION) *CONDITION-MESSAGE-KEYWORD*
     MESSAGE))
   SELF))
...
(CL:DEFUN NEW-PARSING-ERROR (MESSAGE)
  ...
  (CL:LET* ((SELF NULL))
   (CL:SETQ SELF
    (CL:MAKE-CONDITION (CL:QUOTE PARSING-ERROR) *CONDITION-MESSAGE-KEYWORD*
     MESSAGE))
   SELF))
...
(CL:DEFUN NEW-CLASH (MESSAGE)
  ...
  (CL:LET* ((SELF NULL))
   (CL:SETQ SELF
    (CL:MAKE-CONDITION (CL:QUOTE CLASH) *CONDITION-MESSAGE-KEYWORD* MESSAGE))
   SELF))
...
(CL:DEFUN NEW-FAIL-EXCEPTION (MESSAGE)
  ...
  (CL:LET* ((SELF NULL))
   (CL:SETQ SELF
    (CL:MAKE-CONDITION (CL:QUOTE FAIL-EXCEPTION) *CONDITION-MESSAGE-KEYWORD*
     MESSAGE))
   SELF))
...
(CL:DEFVAR *SUPPRESSNONLOGICOBJECTWARNING?* FALSE)
  ...
  (CL:LET* ((STREAMVAR (LOCAL-GENSYM "STREAM")))
   ...
   (LIST* SYM-LOGIC-MACROS-STELLA-LET
    ...
    (LIST* SYM-LOGIC-MACROS-STELLA-SPECIAL
     ...
     (LIST* SYM-LOGIC-MACROS-LOGIC-HELP-SIGNAL-PROPOSITION-ERROR STREAMVAR
      (CONS KWD-LOGIC-MACROS-ERROR NIL))
     NIL)
    (LIST* SYM-LOGIC-MACROS-STELLA-SIGNAL-EXCEPTION
     (LIST* SYM-LOGIC-MACROS-STELLA-NEW SYM-LOGIC-MACROS-LOGIC-PARSING-ERROR
      KWD-LOGIC-MACROS-MESSAGE
...
(CL:DEFUN SIGNAL-PROPOSITION-WARNING (MESSAGE)
  (LIST* SYM-LOGIC-MACROS-STELLA-SPECIAL
   ...
   (LIST* SYM-LOGIC-MACROS-LOGIC-HELP-SIGNAL-PROPOSITION-ERROR
    SYM-LOGIC-MACROS-STELLA-STANDARD-WARNING KWD-LOGIC-MACROS-WARNING NIL)
   NIL))
     ...
     (CL:SETQ PRINTCLAUSES
      (APPEND
       (CONS (WRAP-STRING (%SYMBOL-NAME G))
        (LIST* (WRAP-STRING " =  ") G (CONS SYM-LOGIC-MACROS-STELLA-EOL NIL)))
       PRINTCLAUSES))))
   (LIST* SYM-LOGIC-MACROS-STELLA-DEFUN
    (CONS DISPLAYFUNCTIONNAME (CONS SYM-LOGIC-MACROS-STELLA-STRING NIL)) NIL
...
(CL:DEFUN MOVE-IN-PLACE ()
  (LIST* SYM-LOGIC-MACROS-STELLA-PROGN
   (LIST* SYM-LOGIC-MACROS-STELLA-SETF
    (LIST* SYM-LOGIC-MACROS-LOGIC-TRUTH-VALUE SYM-LOGIC-MACROS-LOGIC-FRAME
     NIL)
    SYM-LOGIC-MACROS-STELLA-NULL NIL)
   (LIST* SYM-LOGIC-MACROS-STELLA-SETF
    (LIST* SYM-LOGIC-MACROS-LOGIC-JUSTIFICATION SYM-LOGIC-MACROS-LOGIC-FRAME
     NIL)
    SYM-LOGIC-MACROS-STELLA-NULL NIL)
   ...
   (LIST* SYM-LOGIC-MACROS-STELLA-COND
    (LIST* SYM-LOGIC-MACROS-LOGIC-CHECKFORMOVEOUT?
     (LIST* SYM-LOGIC-MACROS-STELLA-LET
      ...
      (LIST* SYM-LOGIC-MACROS-STELLA--- SYM-LOGIC-MACROS-LOGIC-AVAILABLETICKS
       NIL)
      (LIST* SYM-LOGIC-MACROS-STELLA-SETF
       (LIST* SYM-LOGIC-MACROS-LOGIC-ALLOTTED-CLOCK-TICKS
        SYM-LOGIC-MACROS-LOGIC-FRAME NIL)
      ...
      (LIST* SYM-LOGIC-MACROS-STELLA-WHEN
       ...
       (LIST* SYM-LOGIC-MACROS-STELLA-MV-SETQ
        (LIST* SYM-LOGIC-MACROS-LOGIC-FRAME SYM-LOGIC-MACROS-LOGIC-DEPTH NIL)
    ...
    (LIST* SYM-LOGIC-MACROS-STELLA-OTHERWISE
     (LIST* SYM-LOGIC-MACROS-STELLA-SETF
      (LIST* SYM-LOGIC-MACROS-LOGIC-CURRENT-CLOCK-TICKS
       SYM-LOGIC-MACROS-LOGIC-QUERY NIL)
      (LIST* SYM-LOGIC-MACROS-STELLA-++ SYM-LOGIC-MACROS-LOGIC-CLOCKTICKS NIL)
      NIL)
     (LIST* SYM-LOGIC-MACROS-STELLA-SETF
      (LIST* SYM-LOGIC-MACROS-LOGIC-STARTING-CLOCK-TICKS
       SYM-LOGIC-MACROS-LOGIC-FRAME NIL)
...
(CL:DEFUN MOVE-DOWN ()
  (LIST* SYM-LOGIC-MACROS-STELLA-LET
   (LIST*
    (LIST* SYM-LOGIC-MACROS-LOGIC-UPFRAME SYM-LOGIC-MACROS-LOGIC-FRAME NIL)
    (LIST* SYM-LOGIC-MACROS-LOGIC-DOWNFRAME
     (LIST* SYM-LOGIC-MACROS-LOGIC-DOWN SYM-LOGIC-MACROS-LOGIC-FRAME NIL) NIL)
    NIL)
   (LIST* SYM-LOGIC-MACROS-STELLA-SETQ SYM-LOGIC-MACROS-LOGIC-DEPTH
    (LIST* SYM-LOGIC-MACROS-STELLA-1+ SYM-LOGIC-MACROS-LOGIC-DEPTH NIL) NIL)
   (LIST* SYM-LOGIC-MACROS-STELLA-SETF
    (LIST* SYM-LOGIC-MACROS-LOGIC-CURRENT-CLOCK-TICKS
     SYM-LOGIC-MACROS-LOGIC-QUERY NIL)
    (LIST* SYM-LOGIC-MACROS-STELLA-++ SYM-LOGIC-MACROS-LOGIC-CLOCKTICKS NIL)
   ...
   (LIST* SYM-LOGIC-MACROS-STELLA-COND
    (LIST*
     (LIST* SYM-LOGIC-MACROS-STELLA-DEFINED? SYM-LOGIC-MACROS-LOGIC-DOWNFRAME
      NIL)
     ...
     (LIST* SYM-LOGIC-MACROS-STELLA-LET
      ...
      (LIST* SYM-LOGIC-MACROS-STELLA-SETQ SYM-LOGIC-MACROS-LOGIC-DOWNFRAME
       (LIST* SYM-LOGIC-MACROS-LOGIC-CREATE-DOWN-FRAME
        SYM-LOGIC-MACROS-LOGIC-UPFRAME SYM-LOGIC-MACROS-LOGIC-PROPOSITION NIL)
       NIL)
      (LIST* SYM-LOGIC-MACROS-STELLA-SETQ SYM-LOGIC-MACROS-LOGIC-FRAME
       SYM-LOGIC-MACROS-LOGIC-DOWNFRAME NIL)
      (LIST* SYM-LOGIC-MACROS-STELLA-SETF
   ...
   (LIST* SYM-LOGIC-MACROS-STELLA-WHEN
    (LIST* SYM-LOGIC-MACROS-STELLA-AND
     ...
     (LIST* SYM-LOGIC-MACROS-STELLA-EQL?
      (LIST* SYM-LOGIC-MACROS-STELLA-STATE SYM-LOGIC-MACROS-LOGIC-UPFRAME NIL)
    ...
    (LIST* SYM-LOGIC-MACROS-STELLA-WHEN
     (LIST* SYM-LOGIC-MACROS-STELLA-AND
      ...
      (LIST* SYM-LOGIC-MACROS-STELLA-NOT
       (LIST* SYM-LOGIC-MACROS-STELLA-EQL? SYM-LOGIC-MACROS-LOGIC-LASTMOVE
        KWD-LOGIC-MACROS-UP-FAIL NIL)
       NIL)
      NIL)
     (LIST* SYM-LOGIC-MACROS-LOGIC-POP-FRAMES-UP-TO
...
(CL:DEFUN MOVE-UP (SUCCESS? KEEPFRAME?)
  (CL:LET* ((LASTMOVE NULL))
   ...
   (LIST* SYM-LOGIC-MACROS-STELLA-LET
    (CONS
     (LIST* SYM-LOGIC-MACROS-LOGIC-PARENT
      (LIST* SYM-LOGIC-MACROS-LOGIC-UP SYM-LOGIC-MACROS-LOGIC-FRAME NIL) NIL)
     NIL)
    (LIST* SYM-LOGIC-MACROS-STELLA-WHEN
     (LIST* SYM-LOGIC-MACROS-STELLA-DEFINED? SYM-LOGIC-MACROS-LOGIC-PARENT
      NIL)
     (LIST* SYM-LOGIC-MACROS-STELLA-SETF
      (LIST* SYM-LOGIC-MACROS-STELLA-RESULT SYM-LOGIC-MACROS-LOGIC-PARENT NIL)
      SYM-LOGIC-MACROS-LOGIC-FRAME NIL)
     (LIST* SYM-LOGIC-MACROS-STELLA-IF
      (CONS SYM-LOGIC-MACROS-LOGIC-CACHE-QUERY-RESULTS? NIL)
      (LIST* SYM-LOGIC-MACROS-LOGIC-CACHE-GOAL SYM-LOGIC-MACROS-LOGIC-FRAME
       SUCCESS?
       (CONS
    ...
    (LIST* SYM-LOGIC-MACROS-STELLA-SETQ SYM-LOGIC-MACROS-LOGIC-FRAME
     SYM-LOGIC-MACROS-LOGIC-PARENT NIL)
    (LIST* SYM-LOGIC-MACROS-STELLA-WHEN
     (LIST* SYM-LOGIC-MACROS-STELLA-NULL? SYM-LOGIC-MACROS-LOGIC-FRAME NIL)
     (LIST* SYM-LOGIC-MACROS-STELLA-SETQ SYM-LOGIC-MACROS-LOGIC-SUCCESS?
      SUCCESS? NIL)
  ...
  (CL:LET* ((GENSYMNAME (GENSYM "QUERY")))
   (LIST* SYM-LOGIC-MACROS-LOGIC-APPLY-CACHED-RETRIEVE
    ...
    (CONS SYM-LOGIC-MACROS-STELLA-CONS-LIST
     (CONCATENATE
      (CAST (%%VALUE (%%REST (%%REST BODY))) SGT-LOGIC-MACROS-STELLA-CONS)
      NIL))
    (CONS SYM-LOGIC-MACROS-STELLA-CONS-LIST
...
(CL:defpackage "PLI"
     ...
     (:export ASSERTION-ENV TAXONOMIC-ENV INFERENCE-ENV
	      PL-ITERATOR LISTIFY CONSIFY NEXT? EMPTY? VALUE
	      GET-OBJECT S-GET-OBJECT GET-CONCEPT S-GET-CONCEPT
	      GET-RELATION S-GET-RELATION GET-NAME
	      OBJECT-TO-STRING OBJECT-TO-INTEGER OBJECT-TO-FLOAT 
	      OBJECT-TO-PARSABLE-STRING STRING-TO-OBJECT
	      GET-PROPOSITION S-GET-PROPOSITION GET-PROPOSITIONS S-GET-PROPOSITIONS
	      ...
	      GET-PROPOSITIONS-OF S-GET-PROPOSITIONS-OF GET-PROPOSITIONS-IN-MODULE
	      ...
	      GET-MODULE  GET-MODULES GET-HOME-MODULE
	      ...
	      CREATE-CONCEPT S-CREATE-CONCEPT
              CREATE-RELATION S-CREATE-RELATION CREATE-FUNCTION S-CREATE-FUNCTION
	      ...
	      LOAD SAVE-MODULE S-SAVE-MODULE
	      GET-PREDICATE GET-COLUMN-COUNT GET-NTH-VALUE
	      GET-NTH-STRING GET-NTH-INTEGER GET-NTH-FLOAT GET-NTH-LOGIC-OBJECT
	      ...
	      IS-TRUE IS-FALSE IS-UNKNOWN IS-STRICT IS-DEFAULT
    ...
    (LIST* SYM-LOGIC-MACROS-STELLA-LET
     ...
     (LIST* SYM-LOGIC-MACROS-STELLA-CASE
      ...
      (CONCATENATE VALUECOMPUTATIONCODE
       (CONS
        (LIST* SYM-LOGIC-MACROS-STELLA-OTHERWISE SYM-LOGIC-MACROS-STELLA-NULL
         NIL)
        NIL)))
...
actually passed in."
  (LIST* SYM-LOGIC-MACROS-STELLA-DEFUN
   ...
   (LIST*
    (LIST* SYM-LOGIC-MACROS-STELLA-X SYM-LOGIC-MACROS-STELLA-NUMBER-WRAPPER
     NIL)
    (LIST* SYM-LOGIC-MACROS-STELLA-Y SYM-LOGIC-MACROS-STELLA-NUMBER-WRAPPER
     NIL)
    NIL)
...
the output will be a wrapped float, etc."
  (LIST* SYM-LOGIC-MACROS-STELLA-DEFUN
   ...
   (LIST* SYM-LOGIC-MACROS-STELLA-LET
    (CONS
     (LIST* SYM-LOGIC-MACROS-LOGIC-FLOATRESULT SYM-LOGIC-MACROS-STELLA-FLOAT
      SYM-LOGIC-MACROS-STELLA-NULL NIL)
     NIL)
    (LIST* SYM-LOGIC-MACROS-STELLA-TYPECASE SYM-LOGIC-MACROS-STELLA-X
     (LIST* SYM-LOGIC-MACROS-STELLA-INTEGER-WRAPPER
...
`*module*' and `*context*' and shield the outer bindings from changes."
  (CL:LET*
   ...
   (LIST* SYM-LOGIC-MACROS-STELLA-LET
    (LIST*
     (CONS MODULEVAR (LIST* SYM-LOGIC-MACROS-STELLA-MODULE MODULEFORM NIL))
     (CONS CONTEXTVAR (LIST* SYM-LOGIC-MACROS-STELLA-CONTEXT MODULEVAR NIL))
     NIL)
    (LIST* SYM-LOGIC-MACROS-STELLA-WHEN
    ...
    (LIST* SYM-LOGIC-MACROS-STELLA-SPECIAL
     ...
     (LIST* SYM-LOGIC-MACROS-STELLA-IGNORE ENVIRONMENT NIL)
...
(CL:DEFVAR *CYC-KLUDGES-ENABLED?* FALSE)
...
(CL:DEFUN HELP-STARTUP-LOGIC-MACROS1 ()
  (CL:PROGN (INTERN-SURROGATE-IN-MODULE "PROPOSITION.IF" *STELLA-MODULE* TRUE)
   (CL:SETQ SYM-LOGIC-MACROS-STELLA-LET
    (INTERN-RIGID-SYMBOL-WRT-MODULE "LET" (GET-STELLA-MODULE "/STELLA" TRUE)
     0))
   (CL:SETQ SYM-LOGIC-MACROS-STELLA-NEW
    (INTERN-RIGID-SYMBOL-WRT-MODULE "NEW" (GET-STELLA-MODULE "/STELLA" TRUE)
     0))
   ...
   (CL:SETQ SYM-LOGIC-MACROS-STELLA-EOL
    (INTERN-RIGID-SYMBOL-WRT-MODULE "EOL" (GET-STELLA-MODULE "/STELLA" TRUE)
     0))
   ...
   (CL:SETQ SYM-LOGIC-MACROS-STELLA-PRINT
    (INTERN-RIGID-SYMBOL-WRT-MODULE "PRINT" (GET-STELLA-MODULE "/STELLA" TRUE)
     0))
   ...
   (CL:SETQ SYM-LOGIC-MACROS-STELLA-PROGN
    (INTERN-RIGID-SYMBOL-WRT-MODULE "PROGN" (GET-STELLA-MODULE "/STELLA" TRUE)
     0))
   (CL:SETQ SYM-LOGIC-MACROS-STELLA-SETF
    (INTERN-RIGID-SYMBOL-WRT-MODULE "SETF" (GET-STELLA-MODULE "/STELLA" TRUE)
     0))
   ...
   (CL:SETQ SYM-LOGIC-MACROS-STELLA-WHEN
    (INTERN-RIGID-SYMBOL-WRT-MODULE "WHEN" (GET-STELLA-MODULE "/STELLA" TRUE)
     0))
   ...
   (CL:SETQ SYM-LOGIC-MACROS-STELLA-SETQ
    (INTERN-RIGID-SYMBOL-WRT-MODULE "SETQ" (GET-STELLA-MODULE "/STELLA" TRUE)
     0))
   ...
   (CL:SETQ SYM-LOGIC-MACROS-STELLA-COND
    (INTERN-RIGID-SYMBOL-WRT-MODULE "COND" (GET-STELLA-MODULE "/STELLA" TRUE)
     0))
   ...
   (CL:SETQ SYM-LOGIC-MACROS-STELLA-1+
    (INTERN-RIGID-SYMBOL-WRT-MODULE "1+" (GET-STELLA-MODULE "/STELLA" TRUE)
     0))
...
(CL:DEFUN HELP-STARTUP-LOGIC-MACROS2 ()
  (CL:PROGN
   ...
   (CL:SETQ SYM-LOGIC-MACROS-STELLA-NTH
    (INTERN-RIGID-SYMBOL-WRT-MODULE "NTH" (GET-STELLA-MODULE "/STELLA" TRUE)
     0))
   ...
   (CL:SETQ SYM-LOGIC-MACROS-STELLA-EQL?
    (INTERN-RIGID-SYMBOL-WRT-MODULE "EQL?" (GET-STELLA-MODULE "/STELLA" TRUE)
     0))
   ...
   (CL:SETQ SYM-LOGIC-MACROS-STELLA-IF
    (INTERN-RIGID-SYMBOL-WRT-MODULE "IF" (GET-STELLA-MODULE "/STELLA" TRUE)
     0))
   ...
   (CL:SETQ SYM-LOGIC-MACROS-STELLA-BREAK
    (INTERN-RIGID-SYMBOL-WRT-MODULE "BREAK" (GET-STELLA-MODULE "/STELLA" TRUE)
     0))
   ...
   (CL:SETQ SYM-LOGIC-MACROS-STELLA-QUOTE
    (INTERN-RIGID-SYMBOL-WRT-MODULE "QUOTE" (GET-STELLA-MODULE "/STELLA" TRUE)
     0))
   ...
   (CL:SETQ SYM-LOGIC-MACROS-STELLA-CASE
    (INTERN-RIGID-SYMBOL-WRT-MODULE "CASE" (GET-STELLA-MODULE "/STELLA" TRUE)
     0))
   ...
   (CL:SETQ SYM-LOGIC-MACROS-STELLA-X
    (INTERN-RIGID-SYMBOL-WRT-MODULE "X" (GET-STELLA-MODULE "/STELLA" TRUE) 0))
   ...
   (CL:SETQ SYM-LOGIC-MACROS-STELLA-Y
    (INTERN-RIGID-SYMBOL-WRT-MODULE "Y" (GET-STELLA-MODULE "/STELLA" TRUE) 0))
   ...
   (CL:SETQ SYM-LOGIC-MACROS-STELLA-CAST
    (INTERN-RIGID-SYMBOL-WRT-MODULE "CAST" (GET-STELLA-MODULE "/STELLA" TRUE)
     0))
...
(CL:DEFUN STARTUP-LOGIC-MACROS ()
  (CL:LET*
   ...
   (CL:WHEN (CURRENT-STARTUP-TIME-PHASE? 4)
    (CL:SETQ *SUPPRESSNONLOGICOBJECTWARNING?* TRUE)
    (CL:SETQ *CYC-KLUDGES-ENABLED?* FALSE))
   ...
   (CL:WHEN (CURRENT-STARTUP-TIME-PHASE? 7)
    ...
    (DEFINE-FUNCTION-OBJECT "MOVE-DOWN"
     "(DEFUN MOVE-DOWN () :TYPE OBJECT :MACRO? TRUE)" (CL:FUNCTION MOVE-DOWN)
     NULL)
...
classification session and inference world.\")"
    ...
    (DEFINE-FUNCTION-OBJECT "DEFINE-COMPUTED-CONSTRAINT"
     "(DEFUN DEFINE-COMPUTED-CONSTRAINT ((NAME SYMBOL) (VAR-LIST CONS) (CONSTRAINT-TEST CONS) |&BODY| (POSITION-COMPUTATIONS CONS)) :TYPE OBJECT :MACRO? TRUE :PUBLIC? TRUE :DOCUMENTATION \"Defines `name' to be a constraint computation which uses `constraint-test'
to determine if a fully bound set of variables satisfies the constraint.  The forms in
`position-computations' are used to compute the value for each of the positions. All such
computations must set the variable `value' to be the result computed for the missing position.
Setting `value' to `null' for any such computation means that that particular argument cannot be
...
whether the constraint is satisified or not.
  If more than one input value is `null', then this constraint code will not be called.\")"
     (CL:FUNCTION DEFINE-COMPUTED-CONSTRAINT) NULL)
...
test `test-name'.  It will take two wrapped number parameters and return a `boolean'.
The code will use the appropriate test for the specific subtype of wrapped number
actually passed in.\")" (CL:FUNCTION DEFINE-ARITHMETIC-TEST-ON-WRAPPERS) NULL)
...
`*module*' and `*context*' and shield the outer bindings from changes.\" :PUBLIC? TRUE)"
    ...
    (CL:LET*
     ...
     (SET-DYNAMIC-SLOT-VALUE (%DYNAMIC-SLOTS FUNCTION)
      ...
      (WRAP-STRING "_Startup-Logic-Macros") NULL-STRING-WRAPPER)))
