     ...
     (LIST* SYM-LOGIC-MACROS-STELLA-LET
      ...
      (LIST* SYM-LOGIC-MACROS-STELLA-WHEN
       ...
       (LIST* SYM-LOGIC-MACROS-STELLA-MV-SETQ
        (LIST* SYM-LOGIC-MACROS-LOGIC-FRAME SYM-LOGIC-MACROS-STELLA-DEPTH NIL)
...
code will not be called."
  (CL:LET* ((VALUECOMPUTATIONCODE NIL) (VALUESYMBOL (INTERN-SYMBOL "VALUE")))
   (CL:LET*
    ((COMPUTATION NULL) (ITER-000 POSITION-COMPUTATIONS) (I NULL-INTEGER)
...
(CL:DEFUN HELP-STARTUP-LOGIC-MACROS1 ()
  (CL:PROGN (INTERN-SURROGATE-IN-MODULE "PROPOSITION.IF" *STELLA-MODULE* CL:T)
   (CL:SETQ SYM-LOGIC-MACROS-STELLA-LET
    (INTERN-RIGID-SYMBOL-WRT-MODULE "LET" (GET-STELLA-MODULE "/STELLA" CL:T)
     0))
   (CL:SETQ SYM-LOGIC-MACROS-STELLA-NEW
    (INTERN-RIGID-SYMBOL-WRT-MODULE "NEW" (GET-STELLA-MODULE "/STELLA" CL:T)
     0))
   ...
   (CL:SETQ SYM-LOGIC-MACROS-STELLA-EOL
    (INTERN-RIGID-SYMBOL-WRT-MODULE "EOL" (GET-STELLA-MODULE "/STELLA" CL:T)
     0))
   ...
   (CL:SETQ SYM-LOGIC-MACROS-STELLA-PRINT
    (INTERN-RIGID-SYMBOL-WRT-MODULE "PRINT" (GET-STELLA-MODULE "/STELLA" CL:T)
     0))
   ...
   (CL:SETQ SYM-LOGIC-MACROS-STELLA-SETF
    (INTERN-RIGID-SYMBOL-WRT-MODULE "SETF" (GET-STELLA-MODULE "/STELLA" CL:T)
     0))
   ...
   (CL:SETQ SYM-LOGIC-MACROS-STELLA-WHEN
    (INTERN-RIGID-SYMBOL-WRT-MODULE "WHEN" (GET-STELLA-MODULE "/STELLA" CL:T)
     0))
   ...
   (CL:SETQ SYM-LOGIC-MACROS-STELLA-SETQ
    (INTERN-RIGID-SYMBOL-WRT-MODULE "SETQ" (GET-STELLA-MODULE "/STELLA" CL:T)
     0))
   ...
   (CL:SETQ SYM-LOGIC-MACROS-STELLA-1+
    (INTERN-RIGID-SYMBOL-WRT-MODULE "1+" (GET-STELLA-MODULE "/STELLA" CL:T)
     0))
...
(CL:DEFUN HELP-STARTUP-LOGIC-MACROS2 ()
  (CL:PROGN
   ...
   (CL:SETQ SYM-LOGIC-MACROS-STELLA-NTH
    (INTERN-RIGID-SYMBOL-WRT-MODULE "NTH" (GET-STELLA-MODULE "/STELLA" CL:T)
     0))
   ...
   (CL:SETQ SYM-LOGIC-MACROS-STELLA-EQL?
    (INTERN-RIGID-SYMBOL-WRT-MODULE "EQL?" (GET-STELLA-MODULE "/STELLA" CL:T)
     0))
   ...
   (CL:SETQ SYM-LOGIC-MACROS-STELLA-BREAK
    (INTERN-RIGID-SYMBOL-WRT-MODULE "BREAK" (GET-STELLA-MODULE "/STELLA" CL:T)
     0))
   ...
   (CL:SETQ SYM-LOGIC-MACROS-STELLA-CASE
    (INTERN-RIGID-SYMBOL-WRT-MODULE "CASE" (GET-STELLA-MODULE "/STELLA" CL:T)
     0))
   ...
   (CL:SETQ SYM-LOGIC-MACROS-STELLA-X
    (INTERN-RIGID-SYMBOL-WRT-MODULE "X" (GET-STELLA-MODULE "/STELLA" CL:T) 0))
   ...
   (CL:SETQ SYM-LOGIC-MACROS-STELLA-Y
    (INTERN-RIGID-SYMBOL-WRT-MODULE "Y" (GET-STELLA-MODULE "/STELLA" CL:T) 0))
   ...
   (CL:SETQ SYM-LOGIC-MACROS-STELLA-CAST
    (INTERN-RIGID-SYMBOL-WRT-MODULE "CAST" (GET-STELLA-MODULE "/STELLA" CL:T)
     0))
...
the output will be a wrapped integer.  If the inputs are a
wrapped integer and a wrapped float then the output will be a
wrapped float, etc.\")" (CL:FUNCTION DEFINE-ARITHMETIC-OPERATION-ON-WRAPPERS)
     NULL)
