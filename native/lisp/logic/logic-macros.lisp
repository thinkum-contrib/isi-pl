...
(CL:DEFUN SIGNAL-PARSING-ERROR (MESSAGE)
  (CL:LET* ((STREAMVAR (LOCAL-GENSYM "STREAM"))) (CL:SETQ MESSAGE (FORMAT-MESSAGE-ARGUMENTS MESSAGE CL:NIL))
   (LIST* SYM-LOGIC-MACROS-STELLA-LET
    (CONS
     (CONS STREAMVAR (CONS (LIST* SYM-LOGIC-MACROS-STELLA-NEW SYM-LOGIC-MACROS-STELLA-OUTPUT-STRING-STREAM NIL) NIL))
     NIL)
    (LIST* SYM-LOGIC-MACROS-STELLA-SPECIAL
     (CONS (LIST* SYM-LOGIC-MACROS-STELLA-*PRINTREADABLY?* SYM-LOGIC-MACROS-STELLA-TRUE NIL) NIL)
     (LIST* SYM-LOGIC-MACROS-STELLA-PRINT-STREAM STREAMVAR
      (CONS (WRAP-STRING "PARSING ERROR: ")
       (CONCATENATE MESSAGE (LIST* (WRAP-STRING ".") SYM-LOGIC-MACROS-STELLA-EOL NIL))))
    ...
    (LIST* SYM-LOGIC-MACROS-STELLA-SIGNAL-EXCEPTION
     (LIST* SYM-LOGIC-MACROS-STELLA-NEW SYM-LOGIC-MACROS-LOGIC-PARSING-ERROR KWD-LOGIC-MACROS-MESSAGE
  ...
  (CL:LET* ((STREAMVAR (LOCAL-GENSYM "STREAM"))) (CL:SETQ MESSAGE (FORMAT-MESSAGE-ARGUMENTS MESSAGE CL:NIL))
   (LIST* SYM-LOGIC-MACROS-STELLA-LET
    ...
    (LIST* SYM-LOGIC-MACROS-STELLA-SPECIAL
     ...
     (LIST* SYM-LOGIC-MACROS-LOGIC-HELP-SIGNAL-PROPOSITION-ERROR STREAMVAR (CONS KWD-LOGIC-MACROS-ERROR NIL)) NIL)
    (LIST* SYM-LOGIC-MACROS-STELLA-SIGNAL-EXCEPTION
     (LIST* SYM-LOGIC-MACROS-STELLA-NEW SYM-LOGIC-MACROS-LOGIC-PROPOSITION-ERROR KWD-LOGIC-MACROS-MESSAGE
      (LIST* SYM-LOGIC-MACROS-STELLA-THE-STRING STREAMVAR NIL) NIL)
     NIL)
    NIL)))
...
(CL:DEFUN SIGNAL-PROPOSITION-WARNING (MESSAGE)
  (LIST* SYM-LOGIC-MACROS-STELLA-SPECIAL
   ...
   (LIST* SYM-LOGIC-MACROS-LOGIC-HELP-SIGNAL-PROPOSITION-ERROR SYM-LOGIC-MACROS-STELLA-STANDARD-WARNING
    KWD-LOGIC-MACROS-WARNING NIL)
   NIL))
   ...
   (CL:LET* ((G NULL) (ITER-000 (REVERSE GLOBALVARIABLENAMES)))
    (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-000 NIL)) DO (CL:SETQ G (%%VALUE ITER-000))
     (CL:SETQ PRINTCLAUSES
      (APPEND
       (CONS (WRAP-STRING (%SYMBOL-NAME G)) (LIST* (WRAP-STRING " =  ") G (CONS SYM-LOGIC-MACROS-STELLA-EOL NIL)))
       PRINTCLAUSES))
...
(CL:DEFUN MOVE-IN-PLACE ()
  (LIST* SYM-LOGIC-MACROS-STELLA-PROGN
   (LIST* SYM-LOGIC-MACROS-STELLA-SETF (LIST* SYM-LOGIC-MACROS-LOGIC-TRUTH-VALUE SYM-LOGIC-MACROS-LOGIC-FRAME NIL)
    SYM-LOGIC-MACROS-STELLA-NULL NIL)
   (LIST* SYM-LOGIC-MACROS-STELLA-SETF (LIST* SYM-LOGIC-MACROS-LOGIC-JUSTIFICATION SYM-LOGIC-MACROS-LOGIC-FRAME NIL)
    SYM-LOGIC-MACROS-STELLA-NULL NIL)
   (LIST* SYM-LOGIC-MACROS-STELLA-WHEN
    (LIST* SYM-LOGIC-MACROS-STELLA-DEFINED?
     (LIST* SYM-LOGIC-MACROS-LOGIC-PARTIAL-MATCH-FRAME SYM-LOGIC-MACROS-LOGIC-FRAME NIL) NIL)
   ...
   (LIST* SYM-LOGIC-MACROS-STELLA-COND
    (LIST* SYM-LOGIC-MACROS-LOGIC-CHECKFORMOVEOUT?
     (LIST* SYM-LOGIC-MACROS-STELLA-LET
      (LIST*
       (LIST* SYM-LOGIC-MACROS-LOGIC-PARENT (LIST* SYM-LOGIC-MACROS-LOGIC-UP SYM-LOGIC-MACROS-LOGIC-FRAME NIL) NIL)
       (LIST* SYM-LOGIC-MACROS-LOGIC-STARTTICKS
        (LIST* SYM-LOGIC-MACROS-LOGIC-STARTING-CLOCK-TICKS SYM-LOGIC-MACROS-LOGIC-FRAME NIL) NIL)
       (LIST* SYM-LOGIC-MACROS-LOGIC-AVAILABLETICKS
        (LIST* SYM-LOGIC-MACROS-STELLA--
         (LIST* SYM-LOGIC-MACROS-LOGIC-ALLOTTED-CLOCK-TICKS SYM-LOGIC-MACROS-LOGIC-PARENT NIL)
         (LIST* SYM-LOGIC-MACROS-STELLA-- SYM-LOGIC-MACROS-LOGIC-CLOCKTICKS SYM-LOGIC-MACROS-LOGIC-STARTTICKS NIL)
         (WRAP-INTEGER 1) NIL)
        NIL)
       NIL)
      ...
      (LIST* SYM-LOGIC-MACROS-STELLA-SETF
       (LIST* SYM-LOGIC-MACROS-LOGIC-ALLOTTED-CLOCK-TICKS SYM-LOGIC-MACROS-LOGIC-FRAME NIL)
       SYM-LOGIC-MACROS-LOGIC-AVAILABLETICKS NIL)
      (LIST* SYM-LOGIC-MACROS-STELLA-SETF
       (LIST* SYM-LOGIC-MACROS-LOGIC-CURRENT-CLOCK-TICKS SYM-LOGIC-MACROS-LOGIC-QUERY NIL)
       (LIST* SYM-LOGIC-MACROS-STELLA-++ SYM-LOGIC-MACROS-LOGIC-CLOCKTICKS NIL) NIL)
      (LIST* SYM-LOGIC-MACROS-STELLA-SETF
       (LIST* SYM-LOGIC-MACROS-LOGIC-STARTING-CLOCK-TICKS SYM-LOGIC-MACROS-LOGIC-FRAME NIL)
       SYM-LOGIC-MACROS-LOGIC-CLOCKTICKS NIL)
      (LIST* SYM-LOGIC-MACROS-STELLA-WHEN
       (LIST* SYM-LOGIC-MACROS-STELLA-<= SYM-LOGIC-MACROS-LOGIC-AVAILABLETICKS (WRAP-INTEGER 0) NIL)
       ...
       (LIST* SYM-LOGIC-MACROS-STELLA-MV-SETQ (LIST* SYM-LOGIC-MACROS-LOGIC-FRAME SYM-LOGIC-MACROS-STELLA-DEPTH NIL)
        (LIST* SYM-LOGIC-MACROS-LOGIC-HANDLE-TIMEOUT SYM-LOGIC-MACROS-LOGIC-FRAME SYM-LOGIC-MACROS-STELLA-DEPTH NIL)
        NIL)
       ...
       (LIST* SYM-LOGIC-MACROS-STELLA---
        ...
        (LIST* SYM-LOGIC-MACROS-STELLA-1+
         (LIST* SYM-LOGIC-MACROS-STELLA-- SYM-LOGIC-MACROS-LOGIC-CLOCKTICKS SYM-LOGIC-MACROS-LOGIC-STARTTICKS NIL) NIL)
        NIL)
       NIL)
      NIL)
     NIL)
...
(CL:DEFUN MOVE-DOWN ()
  (LIST* SYM-LOGIC-MACROS-STELLA-LET
   (LIST* (LIST* SYM-LOGIC-MACROS-LOGIC-UPFRAME SYM-LOGIC-MACROS-LOGIC-FRAME NIL)
    (LIST* SYM-LOGIC-MACROS-LOGIC-DOWNFRAME (LIST* SYM-LOGIC-MACROS-LOGIC-DOWN SYM-LOGIC-MACROS-LOGIC-FRAME NIL) NIL)
    NIL)
   (LIST* SYM-LOGIC-MACROS-STELLA-SETQ SYM-LOGIC-MACROS-STELLA-DEPTH
    (LIST* SYM-LOGIC-MACROS-STELLA-1+ SYM-LOGIC-MACROS-STELLA-DEPTH NIL) NIL)
   (LIST* SYM-LOGIC-MACROS-STELLA-SETF
    (LIST* SYM-LOGIC-MACROS-LOGIC-CURRENT-CLOCK-TICKS SYM-LOGIC-MACROS-LOGIC-QUERY NIL)
    (LIST* SYM-LOGIC-MACROS-STELLA-++ SYM-LOGIC-MACROS-LOGIC-CLOCKTICKS NIL) NIL)
   (LIST* SYM-LOGIC-MACROS-STELLA-COND
     ...
     (LIST* SYM-LOGIC-MACROS-STELLA-WHEN
      (LIST* SYM-LOGIC-MACROS-STELLA-AND SYM-LOGIC-MACROS-LOGIC-CHECKFORMOVEOUT?
       (LIST* SYM-LOGIC-MACROS-STELLA-NULL?
        (LIST* SYM-LOGIC-MACROS-LOGIC-ALLOTTED-CLOCK-TICKS SYM-LOGIC-MACROS-LOGIC-FRAME NIL) NIL)
       NIL)
      (LIST* SYM-LOGIC-MACROS-STELLA-SETF
       (LIST* SYM-LOGIC-MACROS-LOGIC-ALLOTTED-CLOCK-TICKS SYM-LOGIC-MACROS-LOGIC-FRAME NIL)
       (LIST* SYM-LOGIC-MACROS-STELLA-1-
        (LIST* SYM-LOGIC-MACROS-LOGIC-ALLOTTED-CLOCK-TICKS SYM-LOGIC-MACROS-LOGIC-UPFRAME NIL) NIL)
       NIL)
      NIL)
     (LIST* SYM-LOGIC-MACROS-STELLA-SETF (LIST* SYM-LOGIC-MACROS-LOGIC-TRUTH-VALUE SYM-LOGIC-MACROS-LOGIC-FRAME NIL)
      SYM-LOGIC-MACROS-STELLA-NULL NIL)
    ...
    (LIST* SYM-LOGIC-MACROS-STELLA-OTHERWISE
     (LIST* SYM-LOGIC-MACROS-STELLA-LET
        ...
        (LIST* SYM-LOGIC-MACROS-LOGIC-ARGUMENT-BOUND-TO
         (LIST* SYM-LOGIC-MACROS-STELLA-NTH
          (LIST* SYM-LOGIC-MACROS-STELLA-ARGUMENTS
           (LIST* SYM-LOGIC-MACROS-LOGIC-PROPOSITION SYM-LOGIC-MACROS-LOGIC-UPFRAME NIL) NIL)
      ...
      (LIST* SYM-LOGIC-MACROS-STELLA-SETQ SYM-LOGIC-MACROS-LOGIC-DOWNFRAME
       (LIST* SYM-LOGIC-MACROS-LOGIC-CREATE-DOWN-FRAME SYM-LOGIC-MACROS-LOGIC-UPFRAME
   ...
   (LIST* SYM-LOGIC-MACROS-STELLA-WHEN
    (LIST* SYM-LOGIC-MACROS-STELLA-AND
     (LIST* SYM-LOGIC-MACROS-STELLA-> SYM-LOGIC-MACROS-STELLA-DEPTH
      (LIST* SYM-LOGIC-MACROS-LOGIC-CURRENT-DEPTH-CUTOFF SYM-LOGIC-MACROS-LOGIC-QUERY NIL) NIL)
     (LIST* SYM-LOGIC-MACROS-STELLA-EQL? (LIST* SYM-LOGIC-MACROS-STELLA-STATE SYM-LOGIC-MACROS-LOGIC-UPFRAME NIL)
      KWD-LOGIC-MACROS-PATTERN NIL)
     NIL)
    (LIST* SYM-LOGIC-MACROS-LOGIC-POP-FRAMES-UP-TO SYM-LOGIC-MACROS-LOGIC-FRAME NIL)
    (LIST* SYM-LOGIC-MACROS-STELLA-MV-SETQ (LIST* SYM-LOGIC-MACROS-LOGIC-FRAME SYM-LOGIC-MACROS-STELLA-DEPTH NIL)
     (LIST* SYM-LOGIC-MACROS-LOGIC-HANDLE-DEPTH-VIOLATION SYM-LOGIC-MACROS-LOGIC-FRAME SYM-LOGIC-MACROS-STELLA-DEPTH
      NIL)
     NIL)
   ...
   (LIST* SYM-LOGIC-MACROS-STELLA-WHEN SYM-LOGIC-MACROS-LOGIC-CHECKFORMOVEOUT?
    (LIST* SYM-LOGIC-MACROS-STELLA-WHEN
     (LIST* SYM-LOGIC-MACROS-STELLA-AND
      (LIST* SYM-LOGIC-MACROS-STELLA-<=
       (LIST* SYM-LOGIC-MACROS-LOGIC-ALLOTTED-CLOCK-TICKS SYM-LOGIC-MACROS-LOGIC-FRAME NIL) (WRAP-INTEGER 0) NIL)
      (LIST* SYM-LOGIC-MACROS-STELLA-NOT
       (LIST* SYM-LOGIC-MACROS-STELLA-EQL? SYM-LOGIC-MACROS-LOGIC-LASTMOVE KWD-LOGIC-MACROS-UP-FAIL NIL) NIL)
      NIL)
     (LIST* SYM-LOGIC-MACROS-LOGIC-POP-FRAMES-UP-TO SYM-LOGIC-MACROS-LOGIC-FRAME NIL)
     (LIST* SYM-LOGIC-MACROS-STELLA-MV-SETQ (LIST* SYM-LOGIC-MACROS-LOGIC-FRAME SYM-LOGIC-MACROS-STELLA-DEPTH NIL)
     ...
     (LIST* SYM-LOGIC-MACROS-STELLA-SETQ SYM-LOGIC-MACROS-LOGIC-LASTMOVE KWD-LOGIC-MACROS-UP-FAIL NIL) NIL)
    (LIST* SYM-LOGIC-MACROS-STELLA-WHEN
     (LIST* SYM-LOGIC-MACROS-STELLA-EQL? SYM-LOGIC-MACROS-LOGIC-LASTMOVE KWD-LOGIC-MACROS-UP-FAIL NIL)
     (LIST* SYM-LOGIC-MACROS-STELLA---
      (LIST* SYM-LOGIC-MACROS-LOGIC-ALLOTTED-CLOCK-TICKS SYM-LOGIC-MACROS-LOGIC-FRAME NIL)
      (LIST* SYM-LOGIC-MACROS-STELLA-1+
       (LIST* SYM-LOGIC-MACROS-STELLA-- SYM-LOGIC-MACROS-LOGIC-CLOCKTICKS
        (LIST* SYM-LOGIC-MACROS-LOGIC-STARTING-CLOCK-TICKS SYM-LOGIC-MACROS-LOGIC-DOWNFRAME NIL) NIL)
       NIL)
      NIL)
     NIL)
    NIL)
...
(CL:DEFUN MOVE-UP (SUCCESS? KEEPFRAME?)
  (CL:LET* ((LASTMOVE NULL))
   (CL:COND ((CL:EQ SUCCESS? SYM-LOGIC-MACROS-STELLA-TRUE) (CL:SETQ LASTMOVE KWD-LOGIC-MACROS-UP-TRUE))
    ((CL:EQ SUCCESS? SYM-LOGIC-MACROS-LOGIC-FAIL) (CL:SETQ LASTMOVE KWD-LOGIC-MACROS-UP-FAIL)
     (CL:SETQ SUCCESS? SYM-LOGIC-MACROS-STELLA-FALSE))
    (CL:T
     (CL:LET* ((STREAM-000 (NEW-OUTPUT-STRING-STREAM)))
      (%%PRINT-STREAM (%NATIVE-STREAM STREAM-000) "`" SUCCESS? "' is not a valid case option")
      (CL:ERROR (NEW-STELLA-EXCEPTION (THE-STRING-READER STREAM-000))))))
   (LIST* SYM-LOGIC-MACROS-STELLA-LET
    (CONS (LIST* SYM-LOGIC-MACROS-LOGIC-PARENT (LIST* SYM-LOGIC-MACROS-LOGIC-UP SYM-LOGIC-MACROS-LOGIC-FRAME NIL) NIL)
     NIL)
    (LIST* SYM-LOGIC-MACROS-STELLA-WHEN (LIST* SYM-LOGIC-MACROS-STELLA-DEFINED? SYM-LOGIC-MACROS-LOGIC-PARENT NIL)
     (LIST* SYM-LOGIC-MACROS-STELLA-SETF (LIST* SYM-LOGIC-MACROS-STELLA-RESULT SYM-LOGIC-MACROS-LOGIC-PARENT NIL)
     ...
     (LIST* SYM-LOGIC-MACROS-STELLA-IF (CONS SYM-LOGIC-MACROS-LOGIC-CACHE-QUERY-RESULTS? NIL)
      (LIST* SYM-LOGIC-MACROS-LOGIC-CACHE-GOAL SYM-LOGIC-MACROS-LOGIC-FRAME SUCCESS?
       (CONS
        (CL:IF (CL:EQ KEEPFRAME? SYM-LOGIC-MACROS-LOGIC-KEEP-FRAME) SYM-LOGIC-MACROS-STELLA-TRUE
         SYM-LOGIC-MACROS-STELLA-FALSE)
    ...
    (LIST* SYM-LOGIC-MACROS-STELLA-WHEN SYM-LOGIC-MACROS-LOGIC-CHECKFORMOVEOUT?
     (LIST* SYM-LOGIC-MACROS-STELLA-SETF
      (LIST* SYM-LOGIC-MACROS-LOGIC-ALLOTTED-CLOCK-TICKS SYM-LOGIC-MACROS-LOGIC-FRAME NIL) SYM-LOGIC-MACROS-STELLA-NULL
      NIL)
     (LIST* SYM-LOGIC-MACROS-STELLA-WHEN (LIST* SYM-LOGIC-MACROS-STELLA-DEFINED? SYM-LOGIC-MACROS-LOGIC-PARENT NIL)
      (LIST* SYM-LOGIC-MACROS-STELLA-SETF
       (LIST* SYM-LOGIC-MACROS-LOGIC-ALLOTTED-CLOCK-TICKS SYM-LOGIC-MACROS-LOGIC-PARENT NIL)
    ...
    (LIST* SYM-LOGIC-MACROS-STELLA-WHEN (LIST* SYM-LOGIC-MACROS-STELLA-NULL? SYM-LOGIC-MACROS-LOGIC-FRAME NIL)
     (LIST* SYM-LOGIC-MACROS-STELLA-SETQ SYM-LOGIC-MACROS-LOGIC-SUCCESS? SUCCESS? NIL)
     (CONS SYM-LOGIC-MACROS-STELLA-BREAK NIL) NIL)
    (CONCATENATE
     (CL:IF (CL:EQ KEEPFRAME? SYM-LOGIC-MACROS-LOGIC-KEEP-FRAME) NIL
      (CONS (LIST* SYM-LOGIC-MACROS-LOGIC-POP-DOWN-FRAME SYM-LOGIC-MACROS-LOGIC-FRAME NIL) NIL))
     (LIST* (LIST* SYM-LOGIC-MACROS-STELLA-SETQ SYM-LOGIC-MACROS-LOGIC-LASTMOVE LASTMOVE NIL)
...
to FALSE always returns a list of lists.  Example call:
  ...
  (CL:LET* ((GENSYMNAME (METHOD-GENSYM "QUERY")))
   (LIST* SYM-LOGIC-MACROS-LOGIC-APPLY-CACHED-RETRIEVE (LIST* SYM-LOGIC-MACROS-STELLA-BQUOTE (%%VALUE BODY) NIL)
    ...
    (CONS SYM-LOGIC-MACROS-STELLA-CONS-LIST (CONCATENATE (%%VALUE (%%REST (%%REST BODY))) NIL))
    (CONS SYM-LOGIC-MACROS-STELLA-CONS-LIST (CONCATENATE (NTH-REST BODY 3) NIL))
  ...
  (LIST* SYM-LOGIC-MACROS-STELLA-SPECIAL
   (CONS
    (LIST* SYM-LOGIC-MACROS-STELLA-*CONTEXT*
     (LIST* SYM-LOGIC-MACROS-LOGIC-GET-INFERENCE-CACHE SYM-LOGIC-MACROS-STELLA-*MODULE* KWD-LOGIC-MACROS-META NIL) NIL)
    NIL)
  ...
  (LIST* SYM-LOGIC-MACROS-STELLA-SPECIAL
   (LIST*
    (LIST* SYM-LOGIC-MACROS-LOGIC-*CLASSIFICATIONSESSION*
     (LIST* SYM-LOGIC-MACROS-LOGIC-GET-CLASSIFICATION-SESSION DESCRIPTIONORINSTANCE NIL) NIL)
    (LIST* SYM-LOGIC-MACROS-STELLA-*CONTEXT*
     (LIST* SYM-LOGIC-MACROS-LOGIC-CLASSIFICATION-WORLD SYM-LOGIC-MACROS-LOGIC-*CLASSIFICATIONSESSION* NIL) NIL)
    NIL)
   (CONCATENATE BODY NIL)))
...
code will not be called."
  (CL:LET* ((VALUECOMPUTATIONCODE NIL) (VALUESYMBOL (INTERN-SYMBOL "VALUE")))
   (CL:LET* ((COMPUTATION NULL) (ITER-000 POSITION-COMPUTATIONS) (I NULL-INTEGER) (ITER-001 0) (COLLECT-000 NULL))
    ...
    (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-000 NIL)) DO (CL:SETQ COMPUTATION (%%VALUE ITER-000)) (CL:SETQ I ITER-001)
     (CL:IF (CL:EQ COLLECT-000 NULL)
      (CL:PROGN (CL:SETQ COLLECT-000 (CONS (CONS (WRAP-INTEGER I) (CONS COMPUTATION NIL)) NIL))
       (CL:IF (CL:EQ VALUECOMPUTATIONCODE NIL) (CL:SETQ VALUECOMPUTATIONCODE COLLECT-000)
        (ADD-CONS-TO-END-OF-CONS-LIST VALUECOMPUTATIONCODE COLLECT-000)))
      (CL:PROGN (CL:SETF (%%REST COLLECT-000) (CONS (CONS (WRAP-INTEGER I) (CONS COMPUTATION NIL)) NIL))
   ...
   (LIST* SYM-LOGIC-MACROS-STELLA-DEFUN (CONS NAME (CONS SYM-LOGIC-MACROS-STELLA-OBJECT NIL))
    (CONS (LIST* SYM-LOGIC-MACROS-LOGIC-MISSING-ARGUMENT SYM-LOGIC-MACROS-STELLA-INTEGER-WRAPPER NIL)
     (CONCATENATE VAR-LIST NIL))
    (LIST* SYM-LOGIC-MACROS-STELLA-LET
     (CONS (CONS VALUESYMBOL (LIST* SYM-LOGIC-MACROS-STELLA-OBJECT SYM-LOGIC-MACROS-STELLA-NULL NIL)) NIL)
     (LIST* SYM-LOGIC-MACROS-STELLA-CASE
      (LIST* SYM-LOGIC-MACROS-STELLA-WRAPPER-VALUE SYM-LOGIC-MACROS-LOGIC-MISSING-ARGUMENT NIL)
      (LIST* (WRAP-INTEGER -1) CONSTRAINT-TEST NIL)
      (CONCATENATE VALUECOMPUTATIONCODE
       (CONS (LIST* SYM-LOGIC-MACROS-STELLA-OTHERWISE SYM-LOGIC-MACROS-STELLA-NULL NIL) NIL)))
...
the specific subtype of wrapped number actually passed in."
  (LIST* SYM-LOGIC-MACROS-STELLA-DEFUN (CONS NAME (CONS SYM-LOGIC-MACROS-STELLA-BOOLEAN NIL))
   (LIST* (LIST* SYM-LOGIC-MACROS-STELLA-X SYM-LOGIC-MACROS-STELLA-NUMBER-WRAPPER NIL)
    (LIST* SYM-LOGIC-MACROS-STELLA-Y SYM-LOGIC-MACROS-STELLA-NUMBER-WRAPPER NIL) NIL)
        ...
        (CONS TEST-NAME
         (LIST*
          (LIST* SYM-LOGIC-MACROS-STELLA-CAST
           (LIST* SYM-LOGIC-MACROS-STELLA-WRAPPER-VALUE SYM-LOGIC-MACROS-STELLA-X NIL) SYM-LOGIC-MACROS-STELLA-FLOAT
           NIL)
          (LIST* SYM-LOGIC-MACROS-STELLA-WRAPPER-VALUE SYM-LOGIC-MACROS-STELLA-Y NIL) NIL))
        NIL)
       NIL)
      ...
      (LIST* SYM-LOGIC-MACROS-STELLA-INTEGER-WRAPPER
       (LIST* SYM-LOGIC-MACROS-STELLA-RETURN
        (CONS TEST-NAME
         (LIST* (LIST* SYM-LOGIC-MACROS-STELLA-WRAPPER-VALUE SYM-LOGIC-MACROS-STELLA-X NIL)
          (LIST* SYM-LOGIC-MACROS-STELLA-CAST
           (LIST* SYM-LOGIC-MACROS-STELLA-WRAPPER-VALUE SYM-LOGIC-MACROS-STELLA-Y NIL) SYM-LOGIC-MACROS-STELLA-FLOAT
           NIL)
          NIL))
        NIL)
       NIL)
...
wrapped float, etc."
  (LIST* SYM-LOGIC-MACROS-STELLA-DEFUN (CONS NAME (CONS SYM-LOGIC-MACROS-STELLA-NUMBER-WRAPPER NIL))
   ...
   KWD-LOGIC-MACROS-PUBLIC? SYM-LOGIC-MACROS-STELLA-TRUE
   (LIST* SYM-LOGIC-MACROS-STELLA-LET
    (CONS (LIST* SYM-LOGIC-MACROS-LOGIC-FLOATRESULT SYM-LOGIC-MACROS-STELLA-FLOAT SYM-LOGIC-MACROS-STELLA-NULL NIL)
     NIL)
    (LIST* SYM-LOGIC-MACROS-STELLA-TYPECASE SYM-LOGIC-MACROS-STELLA-X
     (LIST* SYM-LOGIC-MACROS-STELLA-INTEGER-WRAPPER
      (LIST* SYM-LOGIC-MACROS-STELLA-TYPECASE SYM-LOGIC-MACROS-STELLA-Y
     ...
     NIL)
    (LIST* SYM-LOGIC-MACROS-STELLA-RETURN
     (LIST* SYM-LOGIC-MACROS-STELLA-WRAP-LITERAL SYM-LOGIC-MACROS-LOGIC-FLOATRESULT NIL) NIL)
    NIL)
   NIL))
...
`*module*' and `*context*' and shield the outer bindings from changes."
  (CL:LET* ((MODULEVAR (LOCAL-GENSYM "MDL")) (CONTEXTVAR (LOCAL-GENSYM "CXT")))
   (LIST* SYM-LOGIC-MACROS-STELLA-LET
    (LIST* (CONS MODULEVAR (LIST* SYM-LOGIC-MACROS-STELLA-MODULE MODULEFORM NIL))
     (CONS CONTEXTVAR (LIST* SYM-LOGIC-MACROS-STELLA-CONTEXT MODULEVAR NIL)) NIL)
    ...
    (LIST* SYM-LOGIC-MACROS-STELLA-SPECIAL
     ...
     (CONCATENATE
      (CL:IF (CL:AND (SYMBOL? ENVIRONMENT) (CL:NOT (CL:EQ ENVIRONMENT SYM-LOGIC-MACROS-STELLA-NULL)))
       (CONS (LIST* SYM-LOGIC-MACROS-STELLA-IGNORE ENVIRONMENT NIL) NIL) NIL)
      (CONS
       (LIST* SYM-LOGIC-MACROS-STELLA-WITH-PROCESS-LOCK SYM-LOGIC-MACROS-LOGIC-*POWERLOOM-LOCK* (CONCATENATE BODY NIL))
       NIL)))
    NIL)))
...
(CL:DEFUN HELP-STARTUP-LOGIC-MACROS1 ()
  (CL:PROGN (INTERN-SURROGATE-IN-MODULE "PROPOSITION.IF" *STELLA-MODULE* CL:T)
   ...
   (CL:SETQ SYM-LOGIC-MACROS-STELLA-OUTPUT-STRING-STREAM
    (INTERN-RIGID-SYMBOL-WRT-MODULE "OUTPUT-STRING-STREAM" (GET-STELLA-MODULE "/STELLA" CL:T) 0))
   (CL:SETQ SYM-LOGIC-MACROS-STELLA-SPECIAL
    (INTERN-RIGID-SYMBOL-WRT-MODULE "SPECIAL" (GET-STELLA-MODULE "/STELLA" CL:T) 0))
   (CL:SETQ SYM-LOGIC-MACROS-STELLA-*PRINTREADABLY?*
    (INTERN-RIGID-SYMBOL-WRT-MODULE "*PRINTREADABLY?*" (GET-STELLA-MODULE "/STELLA" CL:T) 0))
   ...
   (CL:SETQ SYM-LOGIC-MACROS-STELLA-PRINT-STREAM
    (INTERN-RIGID-SYMBOL-WRT-MODULE "PRINT-STREAM" (GET-STELLA-MODULE "/STELLA" CL:T) 0))
   ...
   (CL:SETQ SYM-LOGIC-MACROS-LOGIC-HELP-SIGNAL-PROPOSITION-ERROR
    (INTERN-RIGID-SYMBOL-WRT-MODULE "HELP-SIGNAL-PROPOSITION-ERROR" NULL 0))
   ...
   (CL:SETQ SYM-LOGIC-MACROS-STELLA-SIGNAL-EXCEPTION
    (INTERN-RIGID-SYMBOL-WRT-MODULE "SIGNAL-EXCEPTION" (GET-STELLA-MODULE "/STELLA" CL:T) 0))
   ...
   (CL:SETQ SYM-LOGIC-MACROS-STELLA-THE-STRING
    (INTERN-RIGID-SYMBOL-WRT-MODULE "THE-STRING" (GET-STELLA-MODULE "/STELLA" CL:T) 0))
   ...
   (CL:SETQ SYM-LOGIC-MACROS-STELLA-STANDARD-WARNING
    (INTERN-RIGID-SYMBOL-WRT-MODULE "STANDARD-WARNING" (GET-STELLA-MODULE "/STELLA" CL:T) 0))
   (CL:SETQ KWD-LOGIC-MACROS-WARNING (INTERN-RIGID-SYMBOL-WRT-MODULE "WARNING" NULL 2))
   (CL:SETQ SYM-LOGIC-MACROS-STELLA-DEFUN
    (INTERN-RIGID-SYMBOL-WRT-MODULE "DEFUN" (GET-STELLA-MODULE "/STELLA" CL:T) 0))
   (CL:SETQ SYM-LOGIC-MACROS-STELLA-STRING
    (INTERN-RIGID-SYMBOL-WRT-MODULE "STRING" (GET-STELLA-MODULE "/STELLA" CL:T) 0))
   (CL:SETQ SYM-LOGIC-MACROS-STELLA-PRINT
    (INTERN-RIGID-SYMBOL-WRT-MODULE "PRINT" (GET-STELLA-MODULE "/STELLA" CL:T) 0))
   (CL:SETQ SYM-LOGIC-MACROS-STELLA-RETURN
    (INTERN-RIGID-SYMBOL-WRT-MODULE "RETURN" (GET-STELLA-MODULE "/STELLA" CL:T) 0))
   ...
   (CL:SETQ SYM-LOGIC-MACROS-STELLA-PROGN
    (INTERN-RIGID-SYMBOL-WRT-MODULE "PROGN" (GET-STELLA-MODULE "/STELLA" CL:T) 0))
   ...
   (CL:SETQ SYM-LOGIC-MACROS-STELLA-DEFINED?
    (INTERN-RIGID-SYMBOL-WRT-MODULE "DEFINED?" (GET-STELLA-MODULE "/STELLA" CL:T) 0))
   ...
   (CL:SETQ SYM-LOGIC-MACROS-LOGIC-CLEAR-FRAME-PARTIAL-TRUTH
    (INTERN-RIGID-SYMBOL-WRT-MODULE "CLEAR-FRAME-PARTIAL-TRUTH" NULL 0))
   ...
   (CL:SETQ SYM-LOGIC-MACROS-STELLA-MV-SETQ
    (INTERN-RIGID-SYMBOL-WRT-MODULE "MV-SETQ" (GET-STELLA-MODULE "/STELLA" CL:T) 0))
   ...
   (CL:SETQ SYM-LOGIC-MACROS-STELLA-OTHERWISE
    (INTERN-RIGID-SYMBOL-WRT-MODULE "OTHERWISE" (GET-STELLA-MODULE "/STELLA" CL:T) 0))))
...
(CL:DEFUN HELP-STARTUP-LOGIC-MACROS2 ()
  (CL:PROGN (CL:SETQ SYM-LOGIC-MACROS-LOGIC-UPFRAME (INTERN-RIGID-SYMBOL-WRT-MODULE "UPFRAME" NULL 0))
   ...
   (CL:SETQ SYM-LOGIC-MACROS-STELLA-NULL?
    (INTERN-RIGID-SYMBOL-WRT-MODULE "NULL?" (GET-STELLA-MODULE "/STELLA" CL:T) 0))
   (CL:SETQ SYM-LOGIC-MACROS-STELLA-1- (INTERN-RIGID-SYMBOL-WRT-MODULE "1-" (GET-STELLA-MODULE "/STELLA" CL:T) 0))
   ...
   (CL:SETQ SYM-LOGIC-MACROS-STELLA-STATE
    (INTERN-RIGID-SYMBOL-WRT-MODULE "STATE" (GET-STELLA-MODULE "/STELLA" CL:T) 0))
   ...
   (CL:SETQ SYM-LOGIC-MACROS-STELLA-RESULT
    (INTERN-RIGID-SYMBOL-WRT-MODULE "RESULT" (GET-STELLA-MODULE "/STELLA" CL:T) 0))
   ...
   (CL:SETQ SYM-LOGIC-MACROS-STELLA-BREAK
    (INTERN-RIGID-SYMBOL-WRT-MODULE "BREAK" (GET-STELLA-MODULE "/STELLA" CL:T) 0))
   ...
   (CL:SETQ SYM-LOGIC-MACROS-STELLA-BQUOTE
    (INTERN-RIGID-SYMBOL-WRT-MODULE "BQUOTE" (GET-STELLA-MODULE "/STELLA" CL:T) 0))
   (CL:SETQ SYM-LOGIC-MACROS-STELLA-CONS-LIST
    (INTERN-RIGID-SYMBOL-WRT-MODULE "CONS-LIST" (GET-STELLA-MODULE "/STELLA" CL:T) 0))
   (CL:SETQ SYM-LOGIC-MACROS-STELLA-QUOTE
    (INTERN-RIGID-SYMBOL-WRT-MODULE "QUOTE" (GET-STELLA-MODULE "/STELLA" CL:T) 0))
   ...
   (CL:SETQ SYM-LOGIC-MACROS-STELLA-OBJECT
    (INTERN-RIGID-SYMBOL-WRT-MODULE "OBJECT" (GET-STELLA-MODULE "/STELLA" CL:T) 0))
   ...
   (CL:SETQ SYM-LOGIC-MACROS-STELLA-INTEGER-WRAPPER
    (INTERN-RIGID-SYMBOL-WRT-MODULE "INTEGER-WRAPPER" (GET-STELLA-MODULE "/STELLA" CL:T) 0))
   ...
   (CL:SETQ SYM-LOGIC-MACROS-STELLA-BOOLEAN
    (INTERN-RIGID-SYMBOL-WRT-MODULE "BOOLEAN" (GET-STELLA-MODULE "/STELLA" CL:T) 0))
   ...
   (CL:SETQ SYM-LOGIC-MACROS-STELLA-NUMBER-WRAPPER
    (INTERN-RIGID-SYMBOL-WRT-MODULE "NUMBER-WRAPPER" (GET-STELLA-MODULE "/STELLA" CL:T) 0))
   ...
   (CL:SETQ SYM-LOGIC-MACROS-STELLA-TYPECASE
    (INTERN-RIGID-SYMBOL-WRT-MODULE "TYPECASE" (GET-STELLA-MODULE "/STELLA" CL:T) 0))
   (CL:SETQ SYM-LOGIC-MACROS-STELLA-FLOAT-WRAPPER
    (INTERN-RIGID-SYMBOL-WRT-MODULE "FLOAT-WRAPPER" (GET-STELLA-MODULE "/STELLA" CL:T) 0))
   ...
   (CL:SETQ SYM-LOGIC-MACROS-STELLA-FLOAT
    (INTERN-RIGID-SYMBOL-WRT-MODULE "FLOAT" (GET-STELLA-MODULE "/STELLA" CL:T) 0))
   ...
   (CL:SETQ SYM-LOGIC-MACROS-STELLA-WRAP-LITERAL
    (INTERN-RIGID-SYMBOL-WRT-MODULE "WRAP-LITERAL" (GET-STELLA-MODULE "/STELLA" CL:T) 0))
   (CL:SETQ SYM-LOGIC-MACROS-STELLA-SAFE-CAST
    (INTERN-RIGID-SYMBOL-WRT-MODULE "SAFE-CAST" (GET-STELLA-MODULE "/STELLA" CL:T) 0))))
  ...
  (CL:LET* ((*MODULE* (GET-STELLA-MODULE "/LOGIC" (> *STARTUP-TIME-PHASE* 1))) (*CONTEXT* *MODULE*))
   ...
   (CL:WHEN (CURRENT-STARTUP-TIME-PHASE? 2) (HELP-STARTUP-LOGIC-MACROS1) (HELP-STARTUP-LOGIC-MACROS2)
    (CL:SETQ SYM-LOGIC-MACROS-STELLA-INTEGER
     (INTERN-RIGID-SYMBOL-WRT-MODULE "INTEGER" (GET-STELLA-MODULE "/STELLA" CL:T) 0))
    (CL:SETQ SYM-LOGIC-MACROS-STELLA-MODULE
     (INTERN-RIGID-SYMBOL-WRT-MODULE "MODULE" (GET-STELLA-MODULE "/STELLA" CL:T) 0))
    (CL:SETQ SYM-LOGIC-MACROS-STELLA-CONTEXT
     (INTERN-RIGID-SYMBOL-WRT-MODULE "CONTEXT" (GET-STELLA-MODULE "/STELLA" CL:T) 0))
    (CL:SETQ SYM-LOGIC-MACROS-STELLA-WITH-PROCESS-LOCK
     (INTERN-RIGID-SYMBOL-WRT-MODULE "WITH-PROCESS-LOCK" (GET-STELLA-MODULE "/STELLA" CL:T) 0))
    ...
    (CL:SETQ SYM-LOGIC-MACROS-STELLA-IGNORE
     (INTERN-RIGID-SYMBOL-WRT-MODULE "IGNORE" (GET-STELLA-MODULE "/STELLA" CL:T) 0))
   ...
   (CL:WHEN (CURRENT-STARTUP-TIME-PHASE? 7)
    ...
    (DEFINE-FUNCTION-OBJECT "MOVE-IN-PLACE" "(DEFUN MOVE-IN-PLACE () :TYPE OBJECT :MACRO? TRUE)"
    ...
    (DEFINE-FUNCTION-OBJECT "MOVE-UP"
     "(DEFUN MOVE-UP ((SUCCESS? SYMBOL) (KEEPFRAME? SYMBOL)) :TYPE OBJECT :MACRO? TRUE)" (CL:FUNCTION MOVE-UP) NULL)
...
`*module*' and `*context*' and shield the outer bindings from changes.\" :PUBLIC? TRUE)"
    ...
    (DEFINE-FUNCTION-OBJECT "STARTUP-LOGIC-MACROS" "(DEFUN STARTUP-LOGIC-MACROS () :PUBLIC? TRUE)"
     (CL:FUNCTION STARTUP-LOGIC-MACROS) NULL)
    (CL:LET* ((FUNCTION (LOOKUP-FUNCTION SYM-LOGIC-MACROS-LOGIC-STARTUP-LOGIC-MACROS)))
     (SET-DYNAMIC-SLOT-VALUE (%DYNAMIC-SLOTS FUNCTION) SYM-LOGIC-MACROS-STELLA-METHOD-STARTUP-CLASSNAME
   ...
   (CL:WHEN (CURRENT-STARTUP-TIME-PHASE? 9) (%IN-MODULE (COPY-CONS-TREE (WRAP-STRING "LOGIC")))
    ...
    (REGISTER-NATIVE-NAME SYM-LOGIC-MACROS-LOGIC-DEF-DISPLAY-GLOBALS KWD-LOGIC-MACROS-COMMON-LISP
     KWD-LOGIC-MACROS-FUNCTION)
