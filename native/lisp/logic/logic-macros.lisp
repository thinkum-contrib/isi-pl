...
(CL:DECLAIM
 (CL:SPECIAL *STARTUP-TIME-PHASE* *MODULE* NULL-INTEGER NIL FALSE))
  ...
  (CL:LET* ((LASTMOVE NULL))
   ...
   (LIST* SYM-LOGIC-MACROS-STELLA-LET
    ...
    (LIST* SYM-LOGIC-MACROS-STELLA-WHEN
     ...
     NIL)
    (LIST* SYM-LOGIC-MACROS-STELLA-SETQ SYM-LOGIC-MACROS-LOGIC-DEPTH
     (LIST* SYM-LOGIC-MACROS-STELLA-1- SYM-LOGIC-MACROS-LOGIC-DEPTH
      NIL)
     NIL)
    (LIST* SYM-LOGIC-MACROS-STELLA-WHEN
     SYM-LOGIC-MACROS-LOGIC-CHECKFORMOVEOUT?
  ...
  (CL:LET* ((GENSYMNAME (METHOD-GENSYM "QUERY")))
   (LIST* SYM-LOGIC-MACROS-LOGIC-APPLY-CACHED-RETRIEVE
    ...
    (CONS SYM-LOGIC-MACROS-STELLA-CONS-LIST
     (CONCATENATE
      (CAST (%%VALUE (%%REST (%%REST BODY)))
       SGT-LOGIC-MACROS-STELLA-CONS)
      NIL))
    (CONS SYM-LOGIC-MACROS-STELLA-CONS-LIST
...
(CL:defpackage "PLI"
     ...
     (:export INITIALIZE ASSERTION-ENV TAXONOMIC-ENV INFERENCE-ENV
	      ...
	      LOAD LOAD-STREAM LOAD-NATIVE-STREAM SAVE-MODULE S-SAVE-MODULE
...
whether the constraint is satisified or not.
  ...
  (CL:LET*
   ...
   (CL:LET*
    ((I NULL-INTEGER) (COMPUTATION NULL)
     (ITER-000 POSITION-COMPUTATIONS) (ITER-001 0) (COLLECT-000 NULL))
