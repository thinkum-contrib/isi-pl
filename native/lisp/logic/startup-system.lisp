  ...
  (WITH-PROCESS-LOCK *BOOTSTRAP-LOCK*
   ...
   (CL:WHEN (CURRENT-STARTUP-TIME-PHASE? 1)
    ...
    (DEFINE-MODULE-FROM-STRINGIFIED-SOURCE "/PL-KERNEL-KB"
     "(:DOCUMENTATION \"Defines foundation classes and relations for PowerLoom.\" :CPP-PACKAGE \"pl_kernel_kb\" :JAVA-PACKAGE \"edu.isi.powerloom.pl_kernel_kb\" :USES (\"LOGIC\" \"STELLA\") :SHADOW (COLLECTION SET RELATION FUNCTION CLASS LIST VALUE ARITY INVERSE NAME QUANTITY) :NICKNAME \"PL-KERNEL\" :PROTECT-SURROGATES? TRUE)")
...
Ontolingua conventions.\" :USES (\"LOGIC\" \"STELLA\"))")
   ...
   (CL:LET*
    ...
    (CL:WHEN (CURRENT-STARTUP-TIME-PHASE? 9)
     ...
     (CL:LET* ((PHASE NULL-INTEGER) (ITER-063 0) (UPPER-BOUND-064 9))
      (CL:DECLARE (CL:TYPE CL:FIXNUM PHASE ITER-063 UPPER-BOUND-064))
      (CL:LOOP WHILE (CL:<= ITER-063 UPPER-BOUND-064) DO
       (CL:SETQ PHASE ITER-063) (CL:SETQ *STARTUP-TIME-PHASE* PHASE)
       (STARTUP-LOGIC-MACROS) (STARTUP-SEQUENCE-INDICES) (STARTUP-KIF-IN)
       (STARTUP-PROPOSITIONS) (STARTUP-BACKLINKS) (STARTUP-PROPAGATE)
       (STARTUP-INFERENCE-CACHES) (STARTUP-DESCRIPTIONS) (STARTUP-NORMALIZE)
       (STARTUP-RULES) (STARTUP-QUERY) (STARTUP-PARTIAL-MATCH)
       (STARTUP-MACHINE-LEARNING) (STARTUP-RULE-INDUCTION)
       (STARTUP-NEURAL-NETWORK) (STARTUP-CASE-BASED) (STARTUP-GOAL-CACHES)
       (STARTUP-STRATEGIES) (STARTUP-JUSTIFICATIONS) (STARTUP-EXPLANATIONS)
       (STARTUP-WHYNOT) (STARTUP-KIF-OUT) (STARTUP-PRINT) (STARTUP-GENERATE)
       ...
       (STARTUP-TOOLS) (CL:SETQ ITER-063 (CL:1+ ITER-063))))
