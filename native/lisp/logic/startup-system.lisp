...
(CL:DEFUN STARTUP-LOGIC-SYSTEM ()
  (WITH-PROCESS-LOCK *BOOTSTRAP-LOCK* (CL:WHEN (CURRENT-STARTUP-TIME-PHASE? 0) (CL:WHEN (CL:NOT (SYSTEM-STARTED-UP? "stella" "/STELLA")) (STARTUP-STELLA-SYSTEM)))
...
Ontolingua conventions.\" :USES (\"LOGIC\" \"STELLA\"))")
   ...
   (CL:LET* ((*MODULE* (GET-STELLA-MODULE "/LOGIC" (> *STARTUP-TIME-PHASE* 1))) (*CONTEXT* *MODULE*)) (CL:DECLARE (CL:SPECIAL *MODULE* *CONTEXT*))
    (CL:WHEN (CURRENT-STARTUP-TIME-PHASE? 2) (CL:SETQ SYM-STARTUP-SYSTEM-LOGIC-STARTUP-LOGIC-SYSTEM (INTERN-RIGID-SYMBOL-WRT-MODULE "STARTUP-LOGIC-SYSTEM" NULL 0))
    ...
    (CL:WHEN (CURRENT-STARTUP-TIME-PHASE? 7)
     (DEFINE-FUNCTION-OBJECT "STARTUP-LOGIC-SYSTEM" "(DEFUN STARTUP-LOGIC-SYSTEM () :PUBLIC? TRUE)" (CL:FUNCTION STARTUP-LOGIC-SYSTEM) NULL)
     (CL:LET* ((FUNCTION (LOOKUP-FUNCTION SYM-STARTUP-SYSTEM-LOGIC-STARTUP-LOGIC-SYSTEM)))
      (SET-DYNAMIC-SLOT-VALUE (%DYNAMIC-SLOTS FUNCTION) SYM-STARTUP-SYSTEM-STELLA-METHOD-STARTUP-CLASSNAME (WRAP-STRING "StartupLogicSystem") NULL-STRING-WRAPPER)))
    ...
    (CL:WHEN (CURRENT-STARTUP-TIME-PHASE? 9) (%IN-MODULE (COPY-CONS-TREE (WRAP-STRING "/LOGIC")))
     (CL:LET* ((PHASE NULL-INTEGER) (ITER-064 0) (UPPER-BOUND-065 9)) (CL:DECLARE (CL:TYPE CL:FIXNUM PHASE ITER-064 UPPER-BOUND-065))
      (CL:LOOP WHILE (CL:<= ITER-064 UPPER-BOUND-065) DO (CL:SETQ PHASE ITER-064) (CL:SETQ *STARTUP-TIME-PHASE* PHASE) (STARTUP-LOGIC-MACROS) (STARTUP-SEQUENCE-INDICES)
       (STARTUP-KIF-IN) (STARTUP-PROPOSITIONS) (STARTUP-BACKLINKS) (STARTUP-PROPAGATE) (STARTUP-INFERENCE-CACHES) (STARTUP-DESCRIPTIONS) (STARTUP-NORMALIZE)
       (STARTUP-RULES) (STARTUP-QUERY) (STARTUP-PARTIAL-MATCH) (STARTUP-MACHINE-LEARNING) (STARTUP-RULE-INDUCTION) (STARTUP-NEURAL-NETWORK) (STARTUP-CASE-BASED)
       (STARTUP-GOAL-CACHES) (STARTUP-STRATEGIES) (STARTUP-JUSTIFICATIONS) (STARTUP-EXPLANATIONS) (STARTUP-WHYNOT) (STARTUP-KIF-OUT) (STARTUP-PRINT) (STARTUP-GENERATE)
       (STARTUP-SPECIALISTS) (STARTUP-SPECIALIZE) (STARTUP-OPTIMIZE) (STARTUP-CLASSIFY) (STARTUP-LOGIC-IN) (|/PL-KERNEL-KB/STARTUP-PL-KERNEL-KB|)
       (|/PL-KERNEL-KB/STARTUP-ARITHMETIC|) (STARTUP-FRAME-SUPPORT) (LOOM-API::STARTUP-LOOM-SUPPORT) (STARTUP-LOOM-TO-KIF) (STARTUP-API-SUPPORT) (PLI::STARTUP-PLI)
       (STARTUP-POWERLOOM) (STARTUP-TOOLS) (CL:SETQ ITER-064 (CL:1+ ITER-064))))
