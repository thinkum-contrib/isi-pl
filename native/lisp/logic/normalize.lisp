...
(CL:DECLAIM
 (CL:SPECIAL *STARTUP-TIME-PHASE* STANDARD-OUTPUT EOL *MODULE*
  FALSE-PROPOSITION TRUE-PROPOSITION FALSE-WRAPPER TRUE-WRAPPER))
  ...
  (CL:LET* ((FOUND?-000 FALSE))
   (CL:LET* ((PROP NULL) (ITER-000 (%THE-CONS-LIST FLATCONJUNCTS)))
    (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-000 NIL)) DO
     ...
     (CL:WHEN (EQUIVALENT-PROPOSITIONS? PROP SELF NULL)
    ...
    ((OBJECT-000 OVERLAY)
     (VALUE-000
      (ACCESS-IN-CONTEXT (%TRUTH-VALUE CONSTANTPROPOSITION)
       (%HOME-CONTEXT CONSTANTPROPOSITION) FALSE))
...
(CL:DEFUN CONJOIN-TWO-PROPOSITIONS (PROP1 PROP2)
  (CL:COND ((CL:EQ PROP1 NULL) PROP2) ((CL:EQ PROP2 NULL) PROP1)
   ((EQUIVALENT-PROPOSITIONS? PROP1 PROP2 NULL) PROP1)
   (CL:T
    (CL:LET*
...
(CL:DEFUN DISJOIN-PROPOSITIONS (DISJUNCTS)
  ...
  (CL:LET* ((FLATDISJUNCTS (NEW-LIST)) (RESULT NULL))
   ...
   (CL:WHEN (CL:= (LENGTH FLATDISJUNCTS) 1)
    (CL:RETURN-FROM DISJOIN-PROPOSITIONS (FIRST FLATDISJUNCTS)))
   (CL:SETQ RESULT
...
(CL:DEFUN RENAME-LOGIC-VARIABLE-APART (VARIABLE DESTRUCTIVE?)
  (CL:LET* ((*MODULE* (HOME-MODULE VARIABLE)) (*CONTEXT* *MODULE*))
   ...
   (CL:LET*
    ((NEWNAME (LOCAL-GENSYM (%SYMBOL-NAME (%SKOLEM-NAME VARIABLE)))))
...
(CL:DEFUN OVERLAY-PROPOSITION (SELF OVERLAYINGPROP)
  ...
  (CL:LET*
   ((OBJECT-000 SELF)
    (VALUE-000
     (ACCESS-IN-CONTEXT (%TRUTH-VALUE OVERLAYINGPROP)
      (%HOME-CONTEXT OVERLAYINGPROP) FALSE))
    (OLD-VALUE-001 (%TRUTH-VALUE OBJECT-000))
    (NEW-VALUE-000
   ...
   (CL:WHEN
    ...
    (CL:SETF (%TRUTH-VALUE OBJECT-000) NEW-VALUE-000)))
  (CL:WHEN (CL:NOT (CL:= (%WEIGHT OVERLAYINGPROP) NULL-FLOAT))
   (CL:SETF (%WEIGHT SELF) (%WEIGHT OVERLAYINGPROP)))
  (CL:LET* ((ARGCOUNT (LENGTH (%ARGUMENTS OVERLAYINGPROP))))
   (CL:DECLARE (CL:TYPE CL:FIXNUM ARGCOUNT))
   (CL:SETF (%ARGUMENTS SELF) (NEW-VECTOR ARGCOUNT))
   (CL:LET*
    ((I NULL-INTEGER) (ITER-000 0) (UPPER-BOUND-000 (CL:1- ARGCOUNT)))
       ...
       (VALUE
        (CL:AREF
         (CL:THE CL:SIMPLE-VECTOR
          (%THE-ARRAY (%ARGUMENTS OVERLAYINGPROP)))
         I))
       (POSITION I))
      (CL:DECLARE (CL:TYPE CL:SIMPLE-VECTOR SELF)
       (CL:TYPE CL:FIXNUM POSITION))
  ...
  (CL:LET*
   ((IOVARSVECTOR
    ...
    (IOVARSVECTORCOPY IOVARSVECTOR))
   (CL:WHEN (CL:NOT (CL:EQ IOVARSVECTOR NULL))
    (CL:SETQ IOVARSVECTORCOPY (NEW-VECTOR (LENGTH IOVARSVECTOR)))
    (CL:LET*
     ((I NULL-INTEGER) (ITER-001 0)
      (UPPER-BOUND-001 (CL:1- (LENGTH IOVARSVECTOR))))
     ...
     (CL:LOOP WHILE (CL:<= ITER-001 UPPER-BOUND-001) DO
      ...
      (CL:LET
       ((SELF (%THE-ARRAY IOVARSVECTORCOPY))
        (VALUE
         (CL:AREF (CL:THE CL:SIMPLE-VECTOR (%THE-ARRAY IOVARSVECTOR)) I))
        (POSITION I))
       (CL:DECLARE (CL:TYPE CL:SIMPLE-VECTOR SELF)
        (CL:TYPE CL:FIXNUM POSITION))
       (CL:SETF (CL:AREF SELF POSITION) VALUE))))
    (SET-DYNAMIC-SLOT-VALUE (%DYNAMIC-SLOTS SELF)
     SYM-NORMALIZE-LOGIC-IO-VARIABLES IOVARSVECTORCOPY NULL)))
  (CL:WHEN
  ...
  (CL:WHEN
   ...
   (CL:WHEN
    ...
    (%%PRINT-STREAM (%NATIVE-STREAM STANDARD-OUTPUT)
     "OVERLAYING NON-DESCRIPTIVE PROPOSITION WITH DESCRIPTIVE ONE." EOL
     "   BOB SHOULD CHECK IT OUT:" EOL))
   (SET-DYNAMIC-SLOT-VALUE (%DYNAMIC-SLOTS SELF)
    SYM-NORMALIZE-LOGIC-DESCRIPTIVE?
    (CL:IF TRUE TRUE-WRAPPER FALSE-WRAPPER) FALSE-WRAPPER)))
  ...
  (CL:LET*
   ...
   (CL:WHEN (CL:EQ (%KIND WHEREPROPOSITION) KWD-NORMALIZE-EXISTS)
    (CL:LET* ((COMBINEDARGS NIL))
     ...
     (DELETED?-SETTER WHEREPROPOSITION TRUE)))))
...
(CL:DEFUN MIGRATE-CONSEQUENT-GOALS-TO-ANTECEDENT? (SELF)
  (CL:LET*
   ...
   (CL:WHEN (CL:NOT (CL:EQ (%KIND CONSEQUENT) KWD-NORMALIZE-OR))
    (CL:RETURN-FROM MIGRATE-CONSEQUENT-GOALS-TO-ANTECEDENT? FALSE))
   (CL:LET*
     ...
     (CL:LET* ((DISJUNCT ARG))
      (CL:IF (CL:EQ (%KIND DISJUNCT) KWD-NORMALIZE-NOT)
       (CL:SETQ NEGATEDGOALS
        (CONS
         (CL:AREF
          (CL:THE CL:SIMPLE-VECTOR (%THE-ARRAY (%ARGUMENTS DISJUNCT))) 0)
         NEGATEDGOALS))
   ...
   (CL:WHEN
    ...
    (CL:LET
     ((SELF (%THE-ARRAY (%ARGUMENTS SELF))) (VALUE ANTECEDENT)
      (POSITION 0))
     (CL:DECLARE (CL:TYPE CL:SIMPLE-VECTOR SELF)
      (CL:TYPE CL:FIXNUM POSITION))
     (CL:SETF (CL:AREF SELF POSITION) VALUE))
    (CL:LET
     ((SELF (%THE-ARRAY (%ARGUMENTS SELF))) (VALUE CONSEQUENT)
      (POSITION 1))
     (CL:DECLARE (CL:TYPE CL:SIMPLE-VECTOR SELF)
      (CL:TYPE CL:FIXNUM POSITION))
     (CL:SETF (CL:AREF SELF POSITION) VALUE))
    (CL:RETURN-FROM MIGRATE-CONSEQUENT-GOALS-TO-ANTECEDENT? TRUE))
   FALSE))
...
(CL:DEFUN FLATTEN-NESTED-FORALL-PROPOSITION (SELF)
  (CL:LET*
   ((IOVARIABLES NIL)
    ...
    (INNERANTECEDENT
     (CL:AREF
      (CL:THE CL:SIMPLE-VECTOR (%THE-ARRAY (%ARGUMENTS NESTEDFORALL))) 0))
    (INNERCONSEQUENT
     (CL:AREF
      (CL:THE CL:SIMPLE-VECTOR (%THE-ARRAY (%ARGUMENTS NESTEDFORALL)))
      1)))
   (CL:LET*
    ((V NULL)
     (VECTOR-000
       ...
       (CL:COND
        ...
        (CL:T
         (CL:LET* ((STREAM-001 (NEW-OUTPUT-STRING-STREAM)))
          (%%PRINT-STREAM (%NATIVE-STREAM STREAM-001) "`" TEST-VALUE-002
           "' is not a valid case option")
          (CL:ERROR
...
(CL:DEFUN NORMALIZE-AND-PROPOSITION (SELF)
  (CL:LET* ((OTHERPROPS NIL) (CONJOIN? FALSE) (EXISTSVARIABLES NIL))
   (CL:LET*
    ((ARG NULL) (VECTOR-000 (%ARGUMENTS SELF)) (INDEX-000 0)
     (LENGTH-000 (LENGTH VECTOR-000)))
    (CL:DECLARE (CL:TYPE CL:FIXNUM INDEX-000 LENGTH-000))
            ...
            (CL:LET* ((VAR NULL) (ITER-000 EXISTSVARIABLES))
             (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-000 NIL)) DO
              ...
              (CL:WHEN (VARIABLE-EQL? (%SKOLEM-NAME VAR) (%SKOLEM-NAME V))
               (CL:SETQ FOUND?-000 TRUE) (CL:RETURN))))
            (CL:WHEN FOUND?-000 (RENAME-LOGIC-VARIABLE-APART V TRUE)))
           (CL:IF (CL:EQ COLLECT-000 NULL)
           ...
           (CL:LET* ((FOUND?-001 FALSE))
            (CL:LET* ((PROP NULL) (ITER-001 OTHERPROPS))
             (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-001 NIL)) DO
              ...
              (CL:WHEN (EQUIVALENT-PROPOSITIONS? PROP CONJUNCT NULL)
               (CL:SETQ FOUND?-001 TRUE) (CL:RETURN))))
            (CL:SETQ TEST-VALUE-001 FOUND?-001)))
          (CL:IF TEST-VALUE-001 (CL:SETQ CONJOIN? TRUE)
           (CL:SETQ OTHERPROPS (CONS CONJUNCT OTHERPROPS))))))))))
...
(CL:DEFUN NORMALIZE-OR-PROPOSITION (SELF)
  (CL:LET* ((PROPOSITIONS NIL) (DISJOIN? FALSE))
   (CL:LET*
    ((ARG NULL) (VECTOR-000 (%ARGUMENTS SELF)) (INDEX-000 0)
     (LENGTH-000 (LENGTH VECTOR-000)))
    (CL:DECLARE (CL:TYPE CL:FIXNUM INDEX-000 LENGTH-000))
       ...
       (CL:COND
        ...
        ((CL:EQ TEST-VALUE-000 KWD-NORMALIZE-CONSTANT)
         (CL:COND
          ...
          (CL:T
           (CL:IF (MEMBER? PROPOSITIONS DISJUNCT) (CL:SETQ DISJOIN? TRUE)
            (CL:SETQ PROPOSITIONS (CONS DISJUNCT PROPOSITIONS))))))
        (CL:T
         (CL:LET* ((TEST-VALUE-001 FALSE))
           ...
           (CL:LET* ((FOUND?-000 FALSE))
            (CL:LET* ((PROP NULL) (ITER-000 PROPOSITIONS))
             (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-000 NIL)) DO
              (CL:PROGN (CL:SETQ PROP (%%VALUE ITER-000))
               (CL:SETQ ITER-000 (%%REST ITER-000)))
              (CL:WHEN (EQUIVALENT-PROPOSITIONS? PROP DISJUNCT NULL)
               (CL:SETQ FOUND?-000 TRUE) (CL:RETURN))))
            (CL:SETQ TEST-VALUE-001 FOUND?-000)))
          (CL:IF TEST-VALUE-001 (CL:SETQ DISJOIN? TRUE)
           (CL:SETQ PROPOSITIONS (CONS DISJUNCT PROPOSITIONS))))))))))
   (CL:WHEN DISJOIN?
...
(CL:DEFUN HELP-NORMALIZE-PREDICATE-PROPOSITION (SELF RELATIONREF PREDICATEARGUMENTS)
  (CL:LET*
   ...
   (CL:LET*
    ((ARG NULL) (ITER-000 (BUT-LAST PREDICATEARGUMENTS))
     (COLLECT-000 NULL))
    ...
    ((HOLDSARGUMENTS (%ARGUMENTS SELF))
     (SURROGATE
      (EVALUATE-RELATION-TERM
       ...
       SELF))
     (PREDICATEARGUMENTS (NEW-LIST)) (DESCRIPTION NULL))
    (CL:WHEN (CL:NOT (CL:EQ SURROGATE NULL))
     ...
     (CL:LET*
      ((I NULL-INTEGER) (ITER-000 1)
       (UPPER-BOUND-000 (CL:1- (LENGTH HOLDSARGUMENTS)))
       (COLLECT-000 NULL))
      (CL:DECLARE (CL:TYPE CL:FIXNUM ITER-000 UPPER-BOUND-000 I))
      (CL:LOOP WHILE (CL:<= ITER-000 UPPER-BOUND-000) DO
       (CL:PROGN (CL:SETQ I ITER-000) (CL:SETQ ITER-000 (CL:1+ ITER-000)))
         ...
         (CL:SETQ COLLECT-000
          (CONS
           (CL:AREF (CL:THE CL:SIMPLE-VECTOR (%THE-ARRAY HOLDSARGUMENTS))
            I)
           NIL))
         (CL:IF (CL:EQ (%THE-CONS-LIST PREDICATEARGUMENTS) NIL)
          (CL:SETF (%THE-CONS-LIST PREDICATEARGUMENTS) COLLECT-000)
          (ADD-CONS-TO-END-OF-CONS-LIST
           (%THE-CONS-LIST PREDICATEARGUMENTS) COLLECT-000)))
        (CL:PROGN
         ...
         (CL:SETQ COLLECT-000 (%%REST COLLECT-000))))))
     (CL:COND
      ((CLASS? DESCRIPTION) (CL:SETF (%KIND SELF) KWD-NORMALIZE-ISA))
     ...
     (CL:SETF (%ARGUMENTS SELF)
      (COPY-LIST-TO-ARGUMENTS-VECTOR PREDICATEARGUMENTS))
...
(CL:DEFUN INVERT-EXISTS-PROPOSITION (SELF)
  (CL:LET*
   ...
   (CL:LET
    ((SELF (%THE-ARRAY NEWARGUMENTS)) (VALUE TRUE-PROPOSITION)
     (POSITION 0))
    (CL:DECLARE (CL:TYPE CL:SIMPLE-VECTOR SELF)
     (CL:TYPE CL:FIXNUM POSITION))
    (CL:SETF (CL:AREF SELF POSITION) VALUE))
   (CL:LET
    ((SELF (%THE-ARRAY NEWARGUMENTS)) (VALUE WHEREPROPOSITION)
     (POSITION 1))
    (CL:DECLARE (CL:TYPE CL:SIMPLE-VECTOR SELF)
     (CL:TYPE CL:FIXNUM POSITION))
    (CL:SETF (CL:AREF SELF POSITION) VALUE))
...
(CL:DEFUN EXTRACT-PROPOSITION (SELF MAPPING)
  (CL:LET*
   ...
   (CL:WHEN (CL:NOT (CL:EQ EXISTSPROPOSITION NULL))
    (SET-DYNAMIC-SLOT-VALUE (%DYNAMIC-SLOTS EXISTSPROPOSITION)
     SYM-NORMALIZE-LOGIC-IO-VARIABLES
     (COPY-VARIABLES-VECTOR (%INTERNAL-VARIABLES SELF) MAPPING) NULL))
  ...
  (CL:LET*
   ...
   (CL:LET*
    ...
    (SET-DYNAMIC-SLOT-VALUE (%DYNAMIC-SLOTS SUPERSETPROP)
     SYM-NORMALIZE-LOGIC-VARIABLE-TYPE? FALSE-WRAPPER NULL)
    ...
    (CL:LET
     ...
     (CL:DECLARE (CL:TYPE CL:SIMPLE-VECTOR SELF)
      (CL:TYPE CL:FIXNUM POSITION))
     (CL:SETF (CL:AREF SELF POSITION) VALUE))
    (FREE (%ARGUMENTS SELF)) (FREE MAPPING)
    (CL:SETF (%ARGUMENTS SELF) NEWARGUMENTS) (NORMALIZE-PROPOSITION SELF))))
        ...
        ((SELF (%THE-ARRAY (%ARGUMENTS SELF)))
         (VALUE
          (SAFELY-INVERT-PROPOSITION
           (CL:AREF
            (CL:THE CL:SIMPLE-VECTOR (%THE-ARRAY (%ARGUMENTS SELF))) I)))
         (POSITION I))
        (CL:DECLARE (CL:TYPE CL:SIMPLE-VECTOR SELF)
         (CL:TYPE CL:FIXNUM POSITION))
        (CL:SETF (CL:AREF SELF POSITION) VALUE)))))
  ...
  (CL:LET*
   ...
   (CL:WHEN (CURRENT-STARTUP-TIME-PHASE? 7)
    ...
    (DEFINE-FUNCTION-OBJECT "HELP-NORMALIZE-PREDICATE-PROPOSITION"
     "(DEFUN HELP-NORMALIZE-PREDICATE-PROPOSITION ((SELF PROPOSITION) (RELATIONREF SURROGATE) (PREDICATEARGUMENTS LIST)))"
    ...
    (CL:LET*
     ...
     (SET-DYNAMIC-SLOT-VALUE (%DYNAMIC-SLOTS FUNCTION)
      ...
      (WRAP-STRING "Startup-Normalize") NULL-STRING-WRAPPER)))
