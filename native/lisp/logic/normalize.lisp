     ...
     (CL:IF (CL:EQ COLLECT-000 NULL)
      (CL:PROGN
       (CL:SETQ COLLECT-000
        (CONS
         (CL:AREF
          (CL:THE CL:SIMPLE-VECTOR (%THE-ARRAY PREDICATEARGUMENTS)) I)
         NIL))
...
(CL:DEFUN NORMALIZE-PREDICATE-PROPOSITION (SELF)
  (CL:WHEN (CL:EQ (%OPERATOR SELF) SGT-NORMALIZE-PL-KERNEL-KB-HOLDS)
   ...
   (CL:WHEN
    (CL:NOT (CL:EQ (%OPERATOR SELF) SGT-NORMALIZE-PL-KERNEL-KB-HOLDS))
...
(CL:DEFUN NORMALIZE-DESCRIPTIVE-PROPOSITION (SELF IOVARIABLES KIND)
  (CL:LET* ((*EVALUATIONMODE* KWD-NORMALIZE-DESCRIPTION))
   (CL:DECLARE (CL:SPECIAL *EVALUATIONMODE*))
   (CL:HANDLER-CASE
    (EQUATE-TOP-LEVEL-EQUIVALENCES SELF IOVARIABLES KIND)
    (CLASH (E)
...
(CL:DEFUN HELP-STARTUP-NORMALIZE1 ()
  (CL:PROGN
   ...
   (CL:SETQ KWD-NORMALIZE-TAIL
    (INTERN-RIGID-SYMBOL-WRT-MODULE "TAIL" NULL 2))
   (CL:SETQ KWD-NORMALIZE-HEAD
