...
(CL:DECLAIM
 (CL:SPECIAL *STARTUP-TIME-PHASE* NULL-INTEGER EOL NULL-FLOAT-WRAPPER *MODULE*
  FALSE-PROPOSITION TRUE-PROPOSITION FALSE-WRAPPER TRUE-WRAPPER NIL TRUE
  FALSE))
  ...
  (CL:LET* ((FLATCONJUNCTS (NEW-LIST)) (RESULT NULL))
   ...
   (CL:WHEN
    ...
    (SET-DYNAMIC-SLOT-VALUE (%DYNAMIC-SLOTS RESULT)
     SYM-NORMALIZE-LOGIC-DESCRIPTIVE? (CL:IF TRUE TRUE-WRAPPER FALSE-WRAPPER)
     FALSE-WRAPPER))
   RESULT))
...
(CL:DEFUN HELP-NORMALIZE-PREDICATE-PROPOSITION (SELF RELATIONREF PREDICATEARGUMENTS)
  (CL:LET*
   ...
   (CL:LET*
    ((ARG NULL) (ITER-000 (BUT-LAST PREDICATEARGUMENTS)) (COLLECT-000 NULL))
    ...
    (CL:WHEN (CL:NOT (CL:EQ SURROGATE NULL))
     ...
     (CL:LET*
      ((I NULL-INTEGER) (ITER-000 1)
       (UPPER-BOUND-000 (CL:1- (LENGTH HOLDSARGUMENTS))) (COLLECT-000 NULL))
       ...
       (CL:IF (CL:EQ COLLECT-000 NULL)
        (CL:PROGN
         ...
         (CL:IF (CL:EQ (%THE-CONS-LIST PREDICATEARGUMENTS) NIL)
          ...
          (ADD-CONS-TO-END-OF-CONS-LIST (%THE-CONS-LIST PREDICATEARGUMENTS)
           COLLECT-000)))
        (CL:PROGN
