...
(CL:DECLAIM
  ...
  *JUST-IN-TIME-FORWARD-INFERENCE?* TRUE-WRAPPER FALSE-WRAPPER))
   ...
   (CL:COND
    ...
    ((CL:EQ KIND KWD-INFERENCE-CACHES-META)
     ...
     (SET-DYNAMIC-SLOT-VALUE (%DYNAMIC-SLOTS WORLD)
      ...
      (CL:IF
       (CL:NOT (NEXT? (ALL-PROPOSITIONS (%BASE-MODULE CONTEXT) TRUE)))
...
(CL:DEFUN META-PROPOSITION? (PROPOSITION)
  (CL:WHEN (CL:EQ PROPOSITION NULL)
   (CL:RETURN-FROM META-PROPOSITION? FALSE))
...
(CL:DEFUN HANDLE-OUT-OF-DATE-INFERENCE-CACHE (ASSERTORRETRACT PROPOSITION)
  (CL:WHEN (WORLD-STATE? *CONTEXT*)
   (CL:WHEN
    (CL:OR
     (CL:EQ (LOOKUP-INFERENCE-CACHE *CONTEXT* KWD-INFERENCE-CACHES-META)
      NULL)
   ...
   (CL:COND
    ...
    (*JUST-IN-TIME-FORWARD-INFERENCE?*
     (CL:WHEN
      ...
      (DESTROY-INFERENCE-CACHE *CONTEXT*
...
updates to the module similar to `propagate-constraints'.\")"
    ...
    (CL:LET*
     ...
     (SET-DYNAMIC-SLOT-VALUE (%DYNAMIC-SLOTS FUNCTION)
      ...
      (WRAP-STRING "Startup-Inference-Caches") NULL-STRING-WRAPPER)))
