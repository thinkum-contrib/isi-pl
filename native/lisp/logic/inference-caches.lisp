     ...
     (PARSE-OPTIONS
      (CL:IF (KEYWORD? (%%VALUE OPTIONSLIST)) OPTIONSLIST
       (CONS-LIST KWD-INFERENCE-CACHES-MODULE (%%VALUE OPTIONSLIST)
        ...
        (CL:IF
         (CL:EQ (%%VALUE (%%REST OPTIONSLIST)) KWD-INFERENCE-CACHES-FORCE)
         TRUE-WRAPPER FALSE-WRAPPER)))
      (LIST* KWD-INFERENCE-CACHES-MODULE SGT-INFERENCE-CACHES-STELLA-MODULE
       KWD-INFERENCE-CACHES-FORCE? SGT-INFERENCE-CACHES-STELLA-BOOLEAN NIL)
      CL:T CL:NIL))
    (THEMODULE
     (LOOKUP-WITH-DEFAULT THEOPTIONS KWD-INFERENCE-CACHES-MODULE *MODULE*))
    (FORCE?
