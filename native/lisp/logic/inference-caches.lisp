...
(CL:DECLAIM
 (CL:SPECIAL *STARTUP-TIME-PHASE* *MODULE* STANDARD-ERROR *QUERYITERATOR* *TRACED-KEYWORDS* STANDARD-OUTPUT EOL
  *JUST-IN-TIME-FORWARD-INFERENCE?* *CONTEXT* NIL TRUE-WRAPPER FALSE-WRAPPER))
   ...
   ((SUBTYPE-OF? (SAFE-PRIMARY-TYPE SELF) SGT-INFERENCE-CACHES-STELLA-WORLD)
    (CL:PROGN
     (CL:AND (CL:EQ (DYNAMIC-SLOT-VALUE (%DYNAMIC-SLOTS SELF) SYM-INFERENCE-CACHES-LOGIC-INFERENCE-CACHE-OF NULL) NULL)
      (CL:NOT
       (%WRAPPER-VALUE
        (DYNAMIC-SLOT-VALUE (%DYNAMIC-SLOTS SELF) SYM-INFERENCE-CACHES-LOGIC-MONOTONIC? FALSE-WRAPPER))))))
   (CL:T CL:T)))
  ...
  (CL:LET* ((CACHEWORLD NULL))
   (CL:COND
    ((CL:EQ KIND KWD-INFERENCE-CACHES-JUST-IN-TIME)
     (CL:SETQ CACHEWORLD
      (DYNAMIC-SLOT-VALUE (%DYNAMIC-SLOTS CONTEXT) SYM-INFERENCE-CACHES-LOGIC-JUST-IN-TIME-INFERENCE-CACHE NULL)))
    ((CL:EQ KIND KWD-INFERENCE-CACHES-META)
     (CL:SETQ CACHEWORLD
      (DYNAMIC-SLOT-VALUE (%DYNAMIC-SLOTS CONTEXT) SYM-INFERENCE-CACHES-LOGIC-META-INFERENCE-CACHE NULL)))
    ((CL:EQ KIND KWD-INFERENCE-CACHES-TMS)
     (CL:SETQ CACHEWORLD
      (DYNAMIC-SLOT-VALUE (%DYNAMIC-SLOTS CONTEXT) SYM-INFERENCE-CACHES-LOGIC-TRUTH-MAINTAINED-INFERENCE-CACHE NULL)))
    (CL:T
...
(CL:DEFUN CREATE-INFERENCE-CACHE (CONTEXT KIND)
  (CL:LET*
   ((WORLD
     (CREATE-WORLD
      (CL:IF (MEMBER? (GET-QUOTED-TREE "((:JUST-IN-TIME :TMS) \"/LOGIC\")" "/LOGIC") KIND)
       (GET-INFERENCE-CACHE CONTEXT KWD-INFERENCE-CACHES-META) CONTEXT)
      STELLA::NULL-STRING)))
   (CL:COND
    ((CL:EQ KIND KWD-INFERENCE-CACHES-JUST-IN-TIME)
     (SET-DYNAMIC-SLOT-VALUE (%DYNAMIC-SLOTS CONTEXT) SYM-INFERENCE-CACHES-LOGIC-JUST-IN-TIME-INFERENCE-CACHE WORLD
      NULL))
    ((CL:EQ KIND KWD-INFERENCE-CACHES-META)
     (SET-DYNAMIC-SLOT-VALUE (%DYNAMIC-SLOTS WORLD) SYM-INFERENCE-CACHES-LOGIC-MONOTONIC? TRUE-WRAPPER FALSE-WRAPPER)
    ...
    ((CL:EQ KIND KWD-INFERENCE-CACHES-TMS)
     (SET-DYNAMIC-SLOT-VALUE (%DYNAMIC-SLOTS CONTEXT) SYM-INFERENCE-CACHES-LOGIC-TRUTH-MAINTAINED-INFERENCE-CACHE WORLD
      NULL))
    (CL:T
     (CL:LET* ((STREAM-000 (NEW-OUTPUT-STRING-STREAM)))
      (%%PRINT-STREAM (%NATIVE-STREAM STREAM-000) "`" KIND "' is not a valid case option")
      (CL:ERROR (NEW-STELLA-EXCEPTION (THE-STRING-READER STREAM-000))))))
   (SET-DYNAMIC-SLOT-VALUE (%DYNAMIC-SLOTS WORLD) SYM-INFERENCE-CACHES-LOGIC-INFERENCE-CACHE-OF CONTEXT NULL)
...
(CL:DEFUN GET-INFERENCE-CACHE (CONTEXT KIND)
  ...
  (CL:LET* ((WORLD (LOOKUP-INFERENCE-CACHE CONTEXT KIND)))
   (CL:WHEN (CL:NOT (CL:EQ WORLD NULL)) (CL:RETURN-FROM GET-INFERENCE-CACHE WORLD)) (PROCESS-CHECK-TYPES-AGENDA)
    ...
    ((CL:OR (CL:EQ KIND KWD-INFERENCE-CACHES-META) (CL:EQ KIND KWD-INFERENCE-CACHES-TMS))
     (CL:LET* ((PARENTMODULE NULL) (ITER-000 (%THE-CONS-LIST (%PARENT-MODULES (%BASE-MODULE CONTEXT)))))
      (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-000 NIL)) DO (CL:SETQ PARENTMODULE (%%VALUE ITER-000))
       (INHERIT-CACHED-INFERENCES (LOOKUP-INFERENCE-CACHE PARENTMODULE KIND) WORLD)
  ...
  (CL:LET* ((CACHE NULL))
   (CL:COND
    ((CL:EQ KIND KWD-INFERENCE-CACHES-JUST-IN-TIME)
     (CL:SETQ CACHE
      (DYNAMIC-SLOT-VALUE (%DYNAMIC-SLOTS CONTEXT) SYM-INFERENCE-CACHES-LOGIC-JUST-IN-TIME-INFERENCE-CACHE NULL))
     (SET-DYNAMIC-SLOT-VALUE (%DYNAMIC-SLOTS CONTEXT) SYM-INFERENCE-CACHES-LOGIC-JUST-IN-TIME-INFERENCE-CACHE NULL
      NULL))
    ((CL:EQ KIND KWD-INFERENCE-CACHES-META)
     (CL:SETQ CACHE (DYNAMIC-SLOT-VALUE (%DYNAMIC-SLOTS CONTEXT) SYM-INFERENCE-CACHES-LOGIC-META-INFERENCE-CACHE NULL))
     (SET-DYNAMIC-SLOT-VALUE (%DYNAMIC-SLOTS CONTEXT) SYM-INFERENCE-CACHES-LOGIC-META-INFERENCE-CACHE NULL NULL))
    ((CL:EQ KIND KWD-INFERENCE-CACHES-TMS)
     (CL:SETQ CACHE
      (DYNAMIC-SLOT-VALUE (%DYNAMIC-SLOTS CONTEXT) SYM-INFERENCE-CACHES-LOGIC-TRUTH-MAINTAINED-INFERENCE-CACHE NULL))
     (SET-DYNAMIC-SLOT-VALUE (%DYNAMIC-SLOTS CONTEXT) SYM-INFERENCE-CACHES-LOGIC-TRUTH-MAINTAINED-INFERENCE-CACHE NULL
      NULL))
    (CL:T
     (CL:LET* ((STREAM-000 (NEW-OUTPUT-STRING-STREAM)))
      (%%PRINT-STREAM (%NATIVE-STREAM STREAM-000) "`" KIND "' is not a valid case option")
...
(CL:DEFUN UNLINK-INFERENCE-CACHE (SELF)
  (CL:WHEN
   (CL:NOT (CL:EQ (DYNAMIC-SLOT-VALUE (%DYNAMIC-SLOTS SELF) SYM-INFERENCE-CACHES-LOGIC-INFERENCE-CACHE-OF NULL) NULL))
   (CL:LET*
    ((WORLDSTATE (DYNAMIC-SLOT-VALUE (%DYNAMIC-SLOTS SELF) SYM-INFERENCE-CACHES-LOGIC-INFERENCE-CACHE-OF NULL)))
    (CL:COND
     ((CL:EQ SELF
       (DYNAMIC-SLOT-VALUE (%DYNAMIC-SLOTS WORLDSTATE) SYM-INFERENCE-CACHES-LOGIC-JUST-IN-TIME-INFERENCE-CACHE NULL))
      (SET-DYNAMIC-SLOT-VALUE (%DYNAMIC-SLOTS WORLDSTATE) SYM-INFERENCE-CACHES-LOGIC-JUST-IN-TIME-INFERENCE-CACHE NULL
       NULL))
     ((CL:EQ SELF
       (DYNAMIC-SLOT-VALUE (%DYNAMIC-SLOTS WORLDSTATE) SYM-INFERENCE-CACHES-LOGIC-META-INFERENCE-CACHE NULL))
      (SET-DYNAMIC-SLOT-VALUE (%DYNAMIC-SLOTS WORLDSTATE) SYM-INFERENCE-CACHES-LOGIC-META-INFERENCE-CACHE NULL NULL))
     ((CL:EQ SELF
       (DYNAMIC-SLOT-VALUE (%DYNAMIC-SLOTS WORLDSTATE) SYM-INFERENCE-CACHES-LOGIC-TRUTH-MAINTAINED-INFERENCE-CACHE
        NULL))
      (SET-DYNAMIC-SLOT-VALUE (%DYNAMIC-SLOTS WORLDSTATE) SYM-INFERENCE-CACHES-LOGIC-TRUTH-MAINTAINED-INFERENCE-CACHE
       NULL NULL)))
...
(CL:DEFUN HANDLE-OUT-OF-DATE-INFERENCE-CACHE (ASSERTORRETRACT PROPOSITION)
  (CL:WHEN (WORLD-STATE? *CONTEXT*)
   (CL:WHEN
    (CL:OR (CL:EQ (LOOKUP-INFERENCE-CACHE *CONTEXT* KWD-INFERENCE-CACHES-META) NULL)
     (CL:NOT (CL:EQ *QUERYITERATOR* NULL)) (DESCRIPTION-MODE?) *INVISIBLEASSERTION?*)
   ...
   (CL:LET* ((DESCRIPTION (CL:IF (CL:NOT (CL:EQ PROPOSITION NULL)) (GET-DESCRIPTION (%OPERATOR PROPOSITION)) NULL)))
    (CL:WHEN
     (CL:AND (CL:NOT (CL:EQ DESCRIPTION NULL))
      (TEST-PROPERTY? DESCRIPTION SGT-INFERENCE-CACHES-PL-KERNEL-KB-HIDDEN-RELATION))
     (CL:RETURN-FROM HANDLE-OUT-OF-DATE-INFERENCE-CACHE)))
   (CL:COND
    ((CL:AND (META-PROPOSITION? PROPOSITION) (CL:EQ ASSERTORRETRACT KWD-INFERENCE-CACHES-RETRACT)
      (CL:NOT
       (%WRAPPER-VALUE
        (DYNAMIC-SLOT-VALUE (%DYNAMIC-SLOTS (LOOKUP-INFERENCE-CACHE *CONTEXT* KWD-INFERENCE-CACHES-META))
         SYM-INFERENCE-CACHES-LOGIC-TRUTH-MAINTAINED? FALSE-WRAPPER))))
     (CL:WHEN
      (CL:AND (CL:NOT (CL:EQ *TRACED-KEYWORDS* NULL)) (MEMB? *TRACED-KEYWORDS* KWD-INFERENCE-CACHES-PERFORMANCE-CLUES))
     ...
     (CL:LET* ((CACHE (LOOKUP-INFERENCE-CACHE *CONTEXT* KWD-INFERENCE-CACHES-TMS)))
      (CL:WHEN
       (CL:AND (CL:NOT (CL:EQ CACHE NULL))
        (CL:NOT
         (%WRAPPER-VALUE
          (DYNAMIC-SLOT-VALUE (%DYNAMIC-SLOTS CACHE) SYM-INFERENCE-CACHES-LOGIC-TRUTH-MAINTAINED? FALSE-WRAPPER))))
       (DESTROY-INFERENCE-CACHE *CONTEXT* KWD-INFERENCE-CACHES-TMS)))))
   (CL:RETURN-FROM HANDLE-OUT-OF-DATE-INFERENCE-CACHE))
  (CL:LET* ((WORLD *CONTEXT*))
   (CL:WHEN
    (CL:AND
     (%WRAPPER-VALUE (DYNAMIC-SLOT-VALUE (%DYNAMIC-SLOTS WORLD) SYM-INFERENCE-CACHES-LOGIC-MONOTONIC? FALSE-WRAPPER))
     (CL:EQ ASSERTORRETRACT KWD-INFERENCE-CACHES-RETRACT))
    (CL:IF (CL:NOT (CL:EQ PROPOSITION NULL))
     (CL:WARN "Retraction of `~A' occurred in world `~A' which is marked monotonic." PROPOSITION WORLD)
     (CL:WARN "Retraction occurred in world `~A' which is marked monotonic." WORLD)))
   (CL:WHEN
    (CL:NOT
     (%WRAPPER-VALUE
      (DYNAMIC-SLOT-VALUE (%DYNAMIC-SLOTS WORLD) SYM-INFERENCE-CACHES-LOGIC-TRUTH-MAINTAINED? FALSE-WRAPPER)))
    (SET-DYNAMIC-SLOT-VALUE (%DYNAMIC-SLOTS WORLD) SYM-INFERENCE-CACHES-LOGIC-UP-TO-DATE-INFERENCES? FALSE-WRAPPER
     FALSE-WRAPPER))))
...
(CL:DEFUN BEST-INFERENCE-CACHE (CONTEXT)
  (CL:WHEN *JUST-IN-TIME-FORWARD-INFERENCE?*
   (CL:RETURN-FROM BEST-INFERENCE-CACHE (GET-INFERENCE-CACHE CONTEXT KWD-INFERENCE-CACHES-JUST-IN-TIME)))
  (CL:LET* ((CACHE (LOOKUP-INFERENCE-CACHE CONTEXT KWD-INFERENCE-CACHES-TMS)))
...
in the module or world `context'."
  (CL:LET*
   ((WORLDSTATE (GET-WORLD-STATE CONTEXT))
    (PROPAGATIONWORLD (GET-INFERENCE-CACHE WORLDSTATE KWD-INFERENCE-CACHES-META)))
   (CL:WHEN
    (%WRAPPER-VALUE
     (DYNAMIC-SLOT-VALUE (%DYNAMIC-SLOTS PROPAGATIONWORLD) SYM-INFERENCE-CACHES-LOGIC-UP-TO-DATE-INFERENCES?
      FALSE-WRAPPER))
   ...
   (CL:HANDLER-CASE
    ...
    (CLASH (E) (%%PRINT-STREAM (%NATIVE-STREAM STANDARD-ERROR) (EXCEPTION-MESSAGE E) EOL)
     (%%PRINT-STREAM (%NATIVE-STREAM STANDARD-ERROR) "One or more facts need to be retracted to eliminate" EOL
      "   the inconsistency." EOL)))
   (SET-DYNAMIC-SLOT-VALUE (%DYNAMIC-SLOTS PROPAGATIONWORLD) SYM-INFERENCE-CACHES-LOGIC-UP-TO-DATE-INFERENCES?
...
updates to the module similar to `propagate-constraints'."
  (PROCESS-CHECK-TYPES-AGENDA)
  (CL:LET* ((OPTIONALNAME NAME) (CONTEXT (COERCE-TO-MODULE (%%VALUE OPTIONALNAME) CL:T)))
   (CL:WHEN (CL:EQ CONTEXT NULL) (CL:SETQ CONTEXT *CONTEXT*)) (DESTROY-INFERENCE-CACHES CONTEXT)
   ...
   ((OPTIONSLIST OPTIONS)
    (THEOPTIONS
     (PARSE-OPTIONS
      ...
      (LIST* KWD-INFERENCE-CACHES-MODULE SGT-INFERENCE-CACHES-STELLA-MODULE KWD-INFERENCE-CACHES-FORCE?
       SGT-INFERENCE-CACHES-STELLA-BOOLEAN NIL)
      CL:T CL:NIL))
    (THEMODULE (LOOKUP-WITH-DEFAULT THEOPTIONS KWD-INFERENCE-CACHES-MODULE *MODULE*))
    (FORCE?
     (COERCE-WRAPPED-BOOLEAN-TO-BOOLEAN (LOOKUP-WITH-DEFAULT THEOPTIONS KWD-INFERENCE-CACHES-FORCE? FALSE-WRAPPER))))
   (CL:HANDLER-CASE (CALL-RUN-FORWARD-RULES THEMODULE FORCE?)
    (CLASH (E) (%%PRINT-STREAM (%NATIVE-STREAM STANDARD-ERROR) (EXCEPTION-MESSAGE E))
     (%%PRINT-STREAM (%NATIVE-STREAM STANDARD-OUTPUT)
      "   One or more facts need to be retracted to eliminate the inconsistency." EOL)))))
...
(CL:DEFUN HELP-STARTUP-INFERENCE-CACHES1 ()
  (CL:PROGN
   (CL:SETQ SYM-INFERENCE-CACHES-LOGIC-INFERENCE-CACHE-OF (INTERN-RIGID-SYMBOL-WRT-MODULE "INFERENCE-CACHE-OF" NULL 0))
   ...
   (CL:SETQ SYM-INFERENCE-CACHES-STELLA-RUN-FORWARD-RULES
    (INTERN-RIGID-SYMBOL-WRT-MODULE "RUN-FORWARD-RULES" (GET-STELLA-MODULE "/STELLA" CL:T) 0))
...
(CL:DEFUN STARTUP-INFERENCE-CACHES ()
  (CL:LET* ((*MODULE* (GET-STELLA-MODULE "/LOGIC" (> *STARTUP-TIME-PHASE* 1))) (*CONTEXT* *MODULE*))
   ...
   (CL:WHEN (CURRENT-STARTUP-TIME-PHASE? 7)
    (DEFINE-FUNCTION-OBJECT "WORLD-STATE?" "(DEFUN (WORLD-STATE? BOOLEAN) ((SELF CONTEXT)) :PUBLIC? TRUE)"
     (CL:FUNCTION WORLD-STATE?) NULL)
    (DEFINE-FUNCTION-OBJECT "GET-WORLD-STATE" "(DEFUN (GET-WORLD-STATE CONTEXT) ((SELF CONTEXT)) :PUBLIC? TRUE)"
    ...
    (DEFINE-FUNCTION-OBJECT "INITIALIZE-INFERENCE-WORLD" "(DEFUN INITIALIZE-INFERENCE-WORLD ((WORLD WORLD)))"
    ...
    (DEFINE-FUNCTION-OBJECT "UNLINK-INFERENCE-CACHE" "(DEFUN UNLINK-INFERENCE-CACHE ((SELF WORLD)))"
     (CL:FUNCTION UNLINK-INFERENCE-CACHE) NULL)
    (DEFINE-FUNCTION-OBJECT "DESTROY-INFERENCE-CACHES"
     "(DEFUN DESTROY-INFERENCE-CACHES ((CONTEXT CONTEXT)) :PUBLIC? TRUE)" (CL:FUNCTION DESTROY-INFERENCE-CACHES) NULL)
    (DEFINE-FUNCTION-OBJECT "META-PROPOSITION?"
     "(DEFUN (META-PROPOSITION? BOOLEAN) ((PROPOSITION PROPOSITION)) :PUBLIC? TRUE)" (CL:FUNCTION META-PROPOSITION?)
     NULL)
    ...
    (DEFINE-FUNCTION-OBJECT "BEST-INFERENCE-CACHE" "(DEFUN (BEST-INFERENCE-CACHE WORLD) ((CONTEXT CONTEXT)))"
     (CL:FUNCTION BEST-INFERENCE-CACHE) NULL)
    (DEFINE-FUNCTION-OBJECT "GET-QUERY-CONTEXT" "(DEFUN (GET-QUERY-CONTEXT CONTEXT) () :PUBLIC? TRUE)"
     (CL:FUNCTION GET-QUERY-CONTEXT) NULL)
    (DEFINE-FUNCTION-OBJECT "GET-PROPERTY-TEST-CONTEXT" "(DEFUN (GET-PROPERTY-TEST-CONTEXT CONTEXT) ())"
     (CL:FUNCTION GET-PROPERTY-TEST-CONTEXT) NULL)
    (DEFINE-FUNCTION-OBJECT "GET-INFERABLE-TEST-CONTEXT" "(DEFUN (GET-INFERABLE-TEST-CONTEXT CONTEXT) ())"
     (CL:FUNCTION GET-INFERABLE-TEST-CONTEXT) NULL)
    (DEFINE-FUNCTION-OBJECT "GET-TOP-LEVEL-UPDATE-CONTEXT" "(DEFUN (GET-TOP-LEVEL-UPDATE-CONTEXT CONTEXT) ())"
    ...
    (DEFINE-FUNCTION-OBJECT "INHERIT-CACHED-INFERENCES"
     "(DEFUN INHERIT-CACHED-INFERENCES ((FROMWORLD WORLD) (TOWORLD WORLD)))" (CL:FUNCTION INHERIT-CACHED-INFERENCES)
     NULL)
...
module `name'.  If no `name' is supplied, the current module will be used.
This also enables incremental constraint propagation for future monotonic
updates to the module similar to `propagate-constraints'.\")" (CL:FUNCTION %REPROPAGATE-CONSTRAINTS)
...
and forward inferencing will be disabled until this function is called again.\" :PUBLIC? TRUE :COMMAND? TRUE :EVALUATE-ARGUMENTS? FALSE)"
    ...
    (DEFINE-FUNCTION-OBJECT "STARTUP-INFERENCE-CACHES" "(DEFUN STARTUP-INFERENCE-CACHES () :PUBLIC? TRUE)"
    ...
    (CL:LET* ((FUNCTION (LOOKUP-FUNCTION SYM-INFERENCE-CACHES-LOGIC-STARTUP-INFERENCE-CACHES)))
     (SET-DYNAMIC-SLOT-VALUE (%DYNAMIC-SLOTS FUNCTION) SYM-INFERENCE-CACHES-STELLA-METHOD-STARTUP-CLASSNAME
...
blow away inference caches.\")")
    (REGISTER-NATIVE-NAME SYM-INFERENCE-CACHES-LOGIC-PROPAGATE-CONSTRAINTS KWD-INFERENCE-CACHES-COMMON-LISP
     KWD-INFERENCE-CACHES-FUNCTION)
    (REGISTER-NATIVE-NAME SYM-INFERENCE-CACHES-LOGIC-REPROPAGATE-CONSTRAINTS KWD-INFERENCE-CACHES-COMMON-LISP
     KWD-INFERENCE-CACHES-FUNCTION)
    (REGISTER-NATIVE-NAME SYM-INFERENCE-CACHES-STELLA-RUN-FORWARD-RULES KWD-INFERENCE-CACHES-COMMON-LISP
     KWD-INFERENCE-CACHES-FUNCTION))))
