...
(CL:DEFVAR SGT-DESCRIPTIONS-PL-KERNEL-KB-CLASS NULL)
...
(CL:DEFVAR SGT-DESCRIPTIONS-STELLA-COLLECTION NULL)
(CL:DEFVAR SGT-DESCRIPTIONS-STELLA-ITERATOR NULL)
...
(CL:DECLAIM
  ...
  *VARIABLEIDCOUNTER* STANDARD-ERROR *QUERYITERATOR* ZERO-VARIABLES-VECTOR
  TRUE-WRAPPER STANDARD-WARNING *SUPPRESSNONLOGICOBJECTWARNING?*
  STANDARD-OUTPUT *STELLA-MODULE* *LOGIC-MODULE* *PL-KERNEL-MODULE*
  NIL-LIST EOL *MODULE* *UNFINALIZED-RELATIONS* TRUE-PROPOSITION))
...
(CL:DEFUN MATERIALIZE-PRIMITIVE-DESCRIPTION-BODY (DESCRIPTION)
  (CL:LET*
   ((NATIVE? (CL:NOT (CL:EQ (NATIVE-RELATION DESCRIPTION) NULL)))
    (NAME
     (CL:IF NATIVE? (INTERN-SYMBOL (NAME (NATIVE-RELATION DESCRIPTION)))
   ...
   (CL:LET*
    ...
    (CL:DECLARE
      ...
      *TERMUNDERCONSTRUCTION* *EVALUATIONMODE*))
    (CL:LET*
  ...
  (CL:LET* ((*MODULE* MODULE) (*CONTEXT* *MODULE*))
   ...
   (CL:LET* ((*FILLINGCONSTRAINTPROPAGATIONQUEUES?* FALSE))
    ...
    (CL:LET* ((DESCRIPTION (CREATE-DESCRIPTION NULL-INTEGER TRUE)))
     ...
     (CL:COND
      (CLASS?
       (ASSERT-ISA-PROPOSITION DESCRIPTION
        SGT-DESCRIPTIONS-PL-KERNEL-KB-CLASS))
      (FUNCTION?
       (ASSERT-ISA-PROPOSITION DESCRIPTION
     ...
     (PUSH *UNFINALIZED-RELATIONS* DESCRIPTION) DESCRIPTION))))
...
(CL:DEFUN CREATE-DESCRIPTION-FOR-STELLA-RELATION (SELF)
  ...
  (CL:LET* ((DESCRIPTION NULL) (HOMEMODULE NULL))
   ...
   (CL:WHEN
    (CL:OR (CL:EQ HOMEMODULE *STELLA-MODULE*)
     (CL:EQ HOMEMODULE *LOGIC-MODULE*))
      ...
      (CL:PROGN
       ...
       (CL:SETQ DESCRIPTION
        (CREATE-PRIMITIVE-DESCRIPTION NIL-LIST
         (LIST (CLASS-LOGICAL-TYPE SELF)) FALSE TRUE FALSE HOMEMODULE))))
    ...
    (CL:LET* ((TEST-VALUE-000 (SAFE-PRIMARY-TYPE VALUE)))
     (CL:COND
      ((SUBTYPE-OF? TEST-VALUE-000
       ...
       (CL:PROGN (CL:RETURN-FROM SURROGATE.GET-DESCRIPTION VALUE)))
         ...
         ((CL:NOT
           (CL:EQ
            (DYNAMIC-SLOT-VALUE (%DYNAMIC-SLOTS VALUE)
             SYM-DESCRIPTIONS-LOGIC-DESCRIPTION NULL)
            NULL))
          (CL:RETURN-FROM SURROGATE.GET-DESCRIPTION
           (DYNAMIC-SLOT-VALUE (%DYNAMIC-SLOTS VALUE)
            SYM-DESCRIPTIONS-LOGIC-DESCRIPTION NULL)))
         (CL:T
          (CL:RETURN-FROM SURROGATE.GET-DESCRIPTION
           (CREATE-DESCRIPTION-FOR-STELLA-RELATION VALUE))))))
      (CL:T (CL:RETURN-FROM SURROGATE.GET-DESCRIPTION NULL)))))
   NULL))
...
(CL:DEFUN STRING.GET-DESCRIPTION (SELF)
  ...
  (CL:LET* ((SURROGATE (LOOKUP-SURROGATE SELF)))
   (CL:IF (CL:NOT (CL:EQ SURROGATE NULL)) (GET-DESCRIPTION SURROGATE)
    NULL)))
...
(CL:DEFUN VARIABLE-ARITY-DOMAIN-TYPES-NEXT? (SELF)
  (CL:LET* ((NESTEDITERATOR (%ITERATOR-NESTED-ITERATOR SELF)))
   (CL:IF
    (CL:AND (CL:NOT (CL:EQ NESTEDITERATOR NULL)) (NEXT? NESTEDITERATOR))
...
(CL:DEFUN DESCRIPTION-OWNER-TYPE (DESCRIPTION)
  (CL:LET* ((OWNER (NATIVE-RELATION DESCRIPTION)))
   (CL:WHEN (CL:NOT (CL:EQ OWNER NULL))
    (CL:COND
     ((SUBTYPE-OF-CLASS? (SAFE-PRIMARY-TYPE OWNER))
      (CL:PROGN
       (CL:RETURN-FROM DESCRIPTION-OWNER-TYPE
        (CLASS-LOGICAL-TYPE OWNER))))
     (CL:T)))
   NULL))
...
(CL:DEFUN LOGIC-OBJECT.MEMBER-TYPE-FROM-COLLECTION (SELF)
  (CL:LET* ((TYPE NULL))
   (CL:LET* ((SUPERSET NULL) (ITER-000 (ALL-SUPERCOLLECTIONS SELF)))
    (CL:LOOP WHILE (NEXT? ITER-000) DO
     (CL:SETQ SUPERSET (%VALUE ITER-000))
     (CL:LET* () (CL:SETQ TYPE (MEMBER-TYPE-FROM-COLLECTION SUPERSET))
      (CL:WHEN (CL:NOT (CL:EQ TYPE NULL))
       (CL:RETURN-FROM LOGIC-OBJECT.MEMBER-TYPE-FROM-COLLECTION TYPE)))))
   (MEMBER-TYPE-FROM-COLLECTION (%SURROGATE-VALUE (LOGICAL-TYPE SELF)))))

;;; (DEFUN (DESCRIPTION.MEMBER-TYPE-FROM-COLLECTION TYPE) ...)

(CL:DEFUN DESCRIPTION.MEMBER-TYPE-FROM-COLLECTION (SELF)
  (CL:LET* ((OWNERTYPE (DESCRIPTION-OWNER-TYPE SELF)))
   (CL:COND ((CL:NOT (CL:EQ OWNERTYPE NULL)) OWNERTYPE)
...
(CL:DEFUN MEMBER-TYPE-FROM-COLLECTION (SELF)
  (CL:LET* ((TEST-VALUE-000 (SAFE-PRIMARY-TYPE SELF)))
   (CL:COND
    ((SUBTYPE-OF-SURROGATE? TEST-VALUE-000)
     (CL:PROGN
      (CL:IF (ISA? (%SURROGATE-VALUE SELF) SGT-DESCRIPTIONS-STELLA-CLASS)
       SELF NULL)))
    ((SUBTYPE-OF-CLASS? TEST-VALUE-000)
     (CL:PROGN (CLASS-LOGICAL-TYPE SELF)))
    ((SUBTYPE-OF? TEST-VALUE-000 SGT-DESCRIPTIONS-LOGIC-DESCRIPTION)
     (CL:PROGN (DESCRIPTION.MEMBER-TYPE-FROM-COLLECTION SELF)))
    ((SUBTYPE-OF? TEST-VALUE-000 SGT-DESCRIPTIONS-LOGIC-LOGIC-OBJECT)
     (CL:PROGN (LOGIC-OBJECT.MEMBER-TYPE-FROM-COLLECTION SELF)))
    ((SUBTYPE-OF? TEST-VALUE-000 SGT-DESCRIPTIONS-STELLA-COLLECTION)
     (CL:PROGN
      (CL:LET*
    ...
    ((SUBTYPE-OF? TEST-VALUE-000 SGT-DESCRIPTIONS-STELLA-ITERATOR)
     (CL:PROGN
      (CL:LET*
       ((COLLECTIONTYPE (PRIMARY-TYPE SELF))
        (SLOT
...
(CL:DEFUN PARSE-ONE-VARIABLE-DECLARATION (VDEC LOCALDECLARATIONS)
  (CL:LET* ((VARIABLENAME NULL) (ISATREE NULL) (VARIABLE NULL))
   ...
   (CL:WHEN (CL:NOT (CL:EQ ISATREE NULL))
    (CL:LET* ((PROPOSITION (BUILD-TOP-LEVEL-PROPOSITION ISATREE FALSE)))
...
(CL:DEFUN HELP-BUILD-QUANTIFIED-PROPOSITION (TREE CONVERTTYPESTOCONSTRAINTS?)
  (CL:LET* ((*VARIABLETYPEPROPOSITIONS* NIL))
   ...
   (CL:LET*
    ...
    (CL:WHEN
     (CL:OR CONVERTTYPESTOCONSTRAINTS?
      (CL:AND (CL:EQ QUANTIFIER SYM-DESCRIPTIONS-LOGIC-KAPPA)
       (CL:EQ ANTECEDENTPROPOSITION TRUE-PROPOSITION)))
...
(CL:DEFUN COPY-CONS-LIST-TO-VARIABLES-VECTOR (CONSLIST)
  ...
  (CL:LET* ((VECTOR (NEW-VECTOR (LENGTH CONSLIST))))
   (CL:LET* ((I NULL-INTEGER) (T NULL) (ITER-000 CONSLIST) (ITER-001 0))
    ...
    (CL:WHEN TEST-VALUE-000
     (CL:LET* ((ALWAYS?-000 TRUE))
      (CL:LET*
       ...
       (CL:DECLARE (CL:TYPE CL:FIXNUM ITER-000 INDEX-000 LENGTH-000 I1))
       (CL:LOOP WHILE (CL:< INDEX-000 LENGTH-000) DO
        ...
        (CL:WHEN
         (CL:NOT
          (EQUIVALENT-FORMULAE?
           (CL:AREF
            (CL:THE CL:SIMPLE-VECTOR (%THE-ARRAY (%ARGUMENTS SELF))) I1)
           ARG2 MAPPING))
...
(CL:DEFUN EQUIVALENT-PROPOSITIONS? (SELF OTHER MAPPING)
  ...
  (CL:LET* ((TEST-VALUE-000 (%KIND SELF)))
   (CL:COND
    ...
    (CL:T
     (CL:LET* ((TEST-VALUE-001 FALSE))
      (CL:SETQ TEST-VALUE-001 (CL:EQ (%OPERATOR SELF) (%OPERATOR OTHER)))
      (CL:WHEN TEST-VALUE-001
       (CL:LET* ((ALWAYS?-000 TRUE))
        (CL:LET*
         ((ARG2 NULL) (ARG1 NULL) (VECTOR-000 (%ARGUMENTS SELF))
          (INDEX-000 0) (LENGTH-000 (LENGTH VECTOR-000))
          (VECTOR-001 (%ARGUMENTS OTHER)) (INDEX-001 0)
          (LENGTH-001 (LENGTH VECTOR-001)))
         (CL:DECLARE
...
(CL:DEFUN EQUIVALENT-DESCRIPTIONS? (SELF OTHER MAPPING)
  ...
  (CL:COND ((NAMED-DESCRIPTION? SELF) FALSE)
   (CL:T
    ...
    (CL:LET*
     ((V2 NULL) (V1 NULL) (VECTOR-000 (%IO-VARIABLES SELF)) (INDEX-000 0)
      (LENGTH-000 (LENGTH VECTOR-000)) (VECTOR-001 (%IO-VARIABLES OTHER))
        ...
        (CL:LET* ((ALWAYS?-000 TRUE))
         (CL:LET* ((M NULL) (ITER-000 (ALLOCATE-ITERATOR SELF)))
          (CL:LOOP WHILE (NEXT? ITER-000) DO (CL:SETQ M (%VALUE ITER-000))
           (CL:WHEN (CL:NOT (MEMBER? OTHER M)) (CL:SETQ ALWAYS?-000 FALSE)
            (CL:RETURN))))
         (CL:SETQ TEST-VALUE-000 ALWAYS?-000)))
       (CL:LET* ((VALUE-000 TEST-VALUE-000)) VALUE-000))))
        ...
        (CL:LET* ((ALWAYS?-001 TRUE))
         (CL:LET* ((M NULL) (ITER-001 (%THE-CONS-LIST SELF)))
          (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-001 NIL)) DO
           ...
           (CL:WHEN (CL:NOT (MEMBER? OTHER M)) (CL:SETQ ALWAYS?-001 FALSE)
            (CL:RETURN))))
...
(CL:DEFUN SAME-ARGUMENTS? (VARIABLES ARGUMENTS)
  (CL:LET* ((TEST-VALUE-000 FALSE))
   (CL:LET* ((ALWAYS?-000 TRUE))
    ...
    (CL:SETQ TEST-VALUE-000 ALWAYS?-000))
   (CL:WHEN TEST-VALUE-000
    (CL:SETQ TEST-VALUE-000 (CL:= (LENGTH VARIABLES) (LENGTH ARGUMENTS))))
   (CL:LET* ((VALUE-000 TEST-VALUE-000)) VALUE-000)))
        ...
        (CL:AND (CL:NOT (CL:EQ ONLYGOAL NULL))
         (SAME-ARGUMENTS? (%IO-VARIABLES SELF)
          (CL:IF (CL:EQ (%KIND ONLYGOAL) KWD-DESCRIPTIONS-NOT)
           (%ARGUMENTS
            (CL:AREF
             (CL:THE CL:SIMPLE-VECTOR (%THE-ARRAY (%ARGUMENTS ONLYGOAL)))
             0))
           (%ARGUMENTS ONLYGOAL))))
    ...
    (CL:LOOP WHILE (CL:< INDEX-000 LENGTH-000) DO
     ...
     (CL:WHEN
      ...
      (SET-DYNAMIC-SLOT-VALUE (%DYNAMIC-SLOTS V)
       SYM-DESCRIPTIONS-LOGIC-ORIGINAL-SKOLEM-NAME (%SKOLEM-NAME V) NULL)
     ...
     ((CL:EQ TEST-VALUE-000 SGT-DESCRIPTIONS-STELLA-CONS)
      (CL:PROGN
       (CL:LET* ((CONS2 TREE2))
        ...
        (CL:LET* ((V2 NULL) (V1 NULL) (ITER-000 TREE1) (ITER-001 CONS2))
         (CL:LOOP WHILE
     ...
     (CL:LET* ((TEST-VALUE-000 (%%VALUE TREE)))
      (CL:COND
       ((CL:OR (CL:EQ TEST-VALUE-000 SYM-DESCRIPTIONS-STELLA-AND)
        ...
        (CL:SETF (%%REST TREE) (SORT-PROPOSITION-CLAUSES (%%REST TREE))))
       ...
       ((CL:EQ TEST-VALUE-000 SYM-DESCRIPTIONS-STELLA-FORALL)
        ...
        (CL:WHEN (CL:NOT (CL:EQ (FOURTH TREE) NULL))
         (FOURTH-SETTER TREE (UNIQUIFY-PROPOSITION-TREE (FOURTH TREE)))))
       (CL:T)))))
   (CL:T))
  TREE)
   ...
   (CL:LET* ((D NULL) (ITER-000 (%THE-CONS-LIST BUCKET)))
    (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-000 NIL)) DO
     (CL:PROGN (CL:SETQ D (%%VALUE ITER-000))
      (CL:SETQ ITER-000 (%%REST ITER-000)))
     (CL:WHEN (EQUIVALENT-DESCRIPTIONS? SELF D NULL)
...
(CL:DEFUN HELP-COLLECT-CONSTANT-REFERENCES (SELF COLLECTION STOPATONE?)
  (CL:LET* ((TEST-VALUE-000 (SAFE-PRIMARY-TYPE SELF)))
   (CL:COND
    ...
    ((SUBTYPE-OF-SURROGATE? TEST-VALUE-000)
     (CL:PROGN
      (HELP-COLLECT-CONSTANT-REFERENCES (%SURROGATE-VALUE SELF) COLLECTION
       STOPATONE?)))
    ...
    (CL:LET* ((MAPPING NULL))
     (CL:WHEN
      ...
      (CL:WHEN (CL:EQ *QUERYITERATOR* NULL)
       (CL:RETURN-FROM FIND-DUPLICATE-DESCRIPTION-WITH-CONSTANT-REFERENCE
        NULL))
      (CL:LET*
       ((V NULL)
        (VECTOR-000
...
(CL:DEFUN COLLAPSE-VALUE-OF-CHAINS (DESCRIPTION)
  ...
  (COLLAPSE-VALUE-OF-CHAINS-FOR-IO-VARIABLES (%IO-VARIABLES DESCRIPTION))
  (CL:LET* ((VALUE NULL))
   (CL:LET*
     ...
     (CL:WHEN
      ...
      (CL:SETQ VALUE
       (ACCESS-IN-CONTEXT (%VARIABLE-VALUE VBL) (%HOME-CONTEXT VBL)
        FALSE))
      (CL:LET
       ((SELF (%THE-ARRAY (%INTERNAL-VARIABLES DESCRIPTION))) (VALUE NULL)
        (POSITION I))
       (CL:DECLARE (CL:TYPE CL:SIMPLE-VECTOR SELF)
        (CL:TYPE CL:FIXNUM POSITION))
       (CL:SETF (CL:AREF SELF POSITION) VALUE))
   ...
   (CL:SETF (%INTERNAL-VARIABLES DESCRIPTION)
    (REMOVE-NULLS-IN-VARIABLES-VECTOR (%INTERNAL-VARIABLES DESCRIPTION)))))
...
(CL:DEFUN FINISH-BUILDING-DESCRIPTION (DESCRIPTION CHECKFORDUPLICATE?)
  ...
  (CL:WHEN CHECKFORDUPLICATE?
   (CL:LET*
    ...
    (CL:WHEN (CL:NOT (CL:EQ DUPLICATEDESCRIPTION NULL)) (FREE DESCRIPTION)
     (CL:RETURN-FROM FINISH-BUILDING-DESCRIPTION DUPLICATEDESCRIPTION))))
  DESCRIPTION)
   ...
   (CL:COND
    ((CL:EQ (%%VALUE TERM) SYM-DESCRIPTIONS-LOGIC-THE-ONLY)
     (SET-DYNAMIC-SLOT-VALUE (%DYNAMIC-SLOTS DESCRIPTION)
      SYM-DESCRIPTIONS-LOGIC-IOTA? (CL:IF TRUE TRUE-WRAPPER FALSE-WRAPPER)
      FALSE-WRAPPER))
    (CL:T))
   (CL:LET*
    ...
    (CL:LET* ((IOVARS NULL) (PROPOSITION NULL) (UNUSED NULL))
     (CL:MULTIPLE-VALUE-SETQ (IOVARS PROPOSITION UNUSED)
      (BUILD-QUANTIFIED-PROPOSITION TERM FALSE))
...
(CL:DEFUN GET-COMPLEMENT-OF-GOAL-DESCRIPTION (SELF)
  (CL:LET*
   ...
   (CL:LET* ((DECLARATIONS NIL) (VARIABLES NIL) (CLAUSES NIL))
    (CL:LET*
     ((TYPE NULL) (V NULL) (VECTOR-000 (%IO-VARIABLES SELF)) (INDEX-000 0)
      (LENGTH-000 (LENGTH VECTOR-000))
    ...
    (CL:WHEN (CLASS-DESCRIPTION? SELF)
     (CL:LET* ((P NULL) (ITER-001 (ALL-DIRECT-SUPERRELATIONS SELF TRUE)))
      (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-001 NIL)) DO
       ...
       (CL:LET* ((TYPE NULL) (ITER-000 (%THE-CONS-LIST TYPES)))
        (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-000 NIL)) DO
         ...
         (CL:WHEN
          ...
          (CL:WHEN
           (LOGICAL-SUBTYPE-OF? TYPE SGT-DESCRIPTIONS-STELLA-LITERAL)
...
;;; (DEFGLOBAL *UNDEFINED-RELATIONS* ...)

(CL:DEFVAR *UNDEFINED-RELATIONS* NULL
  "Contains a list of (dummy) relations created by the
system.")
...
(CL:DEFUN CREATE-DUMMY-RELATION (WAYWARDPROPOSITION)
  (CL:LET*
   ...
   (BIND-DESCRIPTION-TO-SURROGATE? SYMBOLREF DESCRIPTION "")
   (SET-DYNAMIC-SLOT-VALUE (%DYNAMIC-SLOTS DESCRIPTION)
    SYM-DESCRIPTIONS-LOGIC-UNDECLARED?
    (CL:IF TRUE TRUE-WRAPPER FALSE-WRAPPER) FALSE-WRAPPER)
   (INSERT *UNDEFINED-RELATIONS* DESCRIPTION)))
...
;;; (DEFUN (LIST-UNDEFINED-RELATIONS (LIST OF NAMED-DESCRIPTION)) ...)

(CL:DEFUN LIST-UNDEFINED-RELATIONS ()
  "Return a list of relations created by the system
because references to them were not defined by the user."
  (REMOVE-IF *UNDEFINED-RELATIONS* (CL:FUNCTION DELETED-LOGIC-OBJECT?)))

;;; (DEFUN (LIST-UNDECLARED-RELATIONS (LIST OF NAMED-DESCRIPTION)) ...)

(CL:DEFUN LIST-UNDECLARED-RELATIONS ()
  "Return a list of relations created by the system
because references to them were not defined by the user."
...
(CL:DEFUN HELP-STARTUP-DESCRIPTIONS2 ()
  (CL:PROGN
   ...
   (CL:SETQ SGT-DESCRIPTIONS-PL-KERNEL-KB-CLASS
...
(CL:DEFUN HELP-STARTUP-DESCRIPTIONS3 ()
  (CL:PROGN
   ...
   (CL:SETQ SGT-DESCRIPTIONS-STELLA-COLLECTION
    (INTERN-RIGID-SYMBOL-WRT-MODULE "COLLECTION"
     (GET-STELLA-MODULE "/STELLA" TRUE) 1))
   (CL:SETQ SGT-DESCRIPTIONS-STELLA-ITERATOR
...
primitive description.\" :ALLOCATION :DYNAMIC)")
   ...
   (DEFINE-METHOD-OBJECT
    "(DEFMETHOD (DESCRIPTION-NAME SYMBOL) ((SELF DESCRIPTION)) :PUBLIC? TRUE)"
    (CL:FUNCTION DESCRIPTION-NAME) NULL)
   (DEFINE-METHOD-OBJECT
    "(DEFMETHOD (DESCRIPTION-NAME SYMBOL) ((SELF NAMED-DESCRIPTION)) :PUBLIC? TRUE)"
    (CL:FUNCTION DESCRIPTION-NAME) NULL)
...
the logic system. Also return true for literal classes.\")"
   ...
   (DEFINE-FUNCTION-OBJECT "DESCRIPTION-OWNER-TYPE"
    "(DEFUN (DESCRIPTION-OWNER-TYPE TYPE) ((DESCRIPTION DESCRIPTION)))"
    (CL:FUNCTION DESCRIPTION-OWNER-TYPE) NULL)
   (DEFINE-FUNCTION-OBJECT "LOGIC-OBJECT.MEMBER-TYPE-FROM-COLLECTION"
    "(DEFUN (LOGIC-OBJECT.MEMBER-TYPE-FROM-COLLECTION TYPE) ((SELF LOGIC-OBJECT)))"
    (CL:FUNCTION LOGIC-OBJECT.MEMBER-TYPE-FROM-COLLECTION) NULL)
   (DEFINE-FUNCTION-OBJECT "DESCRIPTION.MEMBER-TYPE-FROM-COLLECTION"
    "(DEFUN (DESCRIPTION.MEMBER-TYPE-FROM-COLLECTION TYPE) ((SELF DESCRIPTION)))"
    (CL:FUNCTION DESCRIPTION.MEMBER-TYPE-FROM-COLLECTION) NULL)
   (DEFINE-FUNCTION-OBJECT "MEMBER-TYPE-FROM-COLLECTION"
    "(DEFUN (MEMBER-TYPE-FROM-COLLECTION TYPE) ((SELF OBJECT)))"
    (CL:FUNCTION MEMBER-TYPE-FROM-COLLECTION) NULL)
   ...
   (DEFINE-FUNCTION-OBJECT
    ...
    (CL:FUNCTION FIND-DUPLICATE-DESCRIPTION-WITH-CONSTANT-REFERENCE) NULL)
...
(CL:DEFUN STARTUP-DESCRIPTIONS ()
  (CL:LET*
   ...
   (CL:WHEN (CURRENT-STARTUP-TIME-PHASE? 4)
    ...
    (CL:SETQ *UNDEFINED-RELATIONS* (NEW-LIST)))
...
and propositions within a 'copy-description' procedure.\")")
   ...
   (CL:WHEN (CURRENT-STARTUP-TIME-PHASE? 7) (HELP-STARTUP-DESCRIPTIONS4)
    ...
    (DEFINE-FUNCTION-OBJECT "LIST-UNDEFINED-RELATIONS"
     "(DEFUN (LIST-UNDEFINED-RELATIONS (LIST OF NAMED-DESCRIPTION)) () :DOCUMENTATION \"Return a list of relations created by the system
because references to them were not defined by the user.\" :PUBLIC? TRUE)"
     (CL:FUNCTION LIST-UNDEFINED-RELATIONS) NULL)
    (DEFINE-FUNCTION-OBJECT "LIST-UNDECLARED-RELATIONS"
     "(DEFUN (LIST-UNDECLARED-RELATIONS (LIST OF NAMED-DESCRIPTION)) () :DOCUMENTATION \"Return a list of relations created by the system
because references to them were not defined by the user.\" :PUBLIC? TRUE)"
     (CL:FUNCTION LIST-UNDECLARED-RELATIONS) NULL)
...
If 'module' is null, return all named descriptions interned everywhere.\" :PUBLIC? TRUE)"
    ...
    (CL:LET*
     ...
     (SET-DYNAMIC-SLOT-VALUE (%DYNAMIC-SLOTS FUNCTION)
      ...
      (WRAP-STRING "Startup-Descriptions") NULL-STRING-WRAPPER)))
...
are referenced.\")")
    ...
    (DEFINE-STELLA-GLOBAL-VARIABLE-FROM-STRINGIFIED-SOURCE
     "(DEFGLOBAL *UNDEFINED-RELATIONS* (LIST OF NAMED-DESCRIPTION) (NEW LIST) :DOCUMENTATION \"Contains a list of (dummy) relations created by the
system.\")"))))
