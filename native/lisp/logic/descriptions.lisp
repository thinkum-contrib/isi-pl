  ...
  (CL:LET* ((*MODULE* MODULE) (*CONTEXT* *MODULE*))
   ...
   (CL:LET* ((DESCRIPTION (CREATE-DESCRIPTION NULL-INTEGER CL:T)))
    ...
    (CL:LET*
     ...
     (CL:SETF (%SURROGATE-VALUE-INVERSE DESCRIPTION) NULL)
     DESCRIPTION))))
    ...
    (CL:T
     (CL:LET* ((TEST-VALUE-001 (%KIND SELF)))
      (CL:COND
       ...
       (CL:T)))
     (CL:LET*
      ((SELFARGS (%ARGUMENTS SELF)) (OTHERARGS (%ARGUMENTS OTHER)))
        ...
        (CL:LET* ((ALWAYS?-000 CL:T))
         (CL:LET*
          ((ARG1 NULL) (VECTOR-002 SELFARGS) (INDEX-002 0)
           ...
           (VECTOR-003 OTHERARGS) (INDEX-003 0)
  ...
  (CL:COND ((NAMED-DESCRIPTION? SELF) CL:NIL)
   (CL:T
    ...
    (CL:LET*
     ...
     (CL:LOOP WHILE
      (CL:AND (CL:< INDEX-004 LENGTH-004) (CL:< INDEX-005 LENGTH-005))
      DO
      (CL:SETQ V1
...
(CL:DEFUN FIND-DUPLICATE-COMPLEX-DESCRIPTION (SELF)
  (CL:LET*
   ((INDEX
     (WRAP-INTEGER
      (PROPOSITION-HASH-INDEX (%PROPOSITION SELF) NULL CL:NIL)))
...
(CL:DEFUN FINISH-BUILDING-DESCRIPTION (DESCRIPTION CHECKFORDUPLICATE? KIND)
  (CL:LET* ((PROPOSITION (%PROPOSITION DESCRIPTION)))
   ...
   (NORMALIZE-DESCRIPTIVE-PROPOSITION PROPOSITION
    (%IO-VARIABLES DESCRIPTION) KIND)
