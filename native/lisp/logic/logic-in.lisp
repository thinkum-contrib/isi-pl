...
(CL:DECLAIM
 (CL:SPECIAL *STARTUP-TIME-PHASE* NULL-STRING-WRAPPER *WARNIFREDEFINE?* *STELLA-VERSION-STRING*
  *POWERLOOM-VERSION-STRING* *SKOLEM-ID-COUNTER* FALSE-WRAPPER *CHARACTER-UPCASE-TABLE* NULL-CHARACTER
  *CHARACTER-TYPE-TABLE* NULL-INTEGER *LOGIC-DIALECT* *CURRENTFILE* TRUE-WRAPPER *TRANSLATIONUNITS* *POWERLOOM-LOCK*
  *TRANSLATIONPHASE* STANDARD-INPUT *CONTEXT* *MODULE* NIL STANDARD-ERROR *ITERATIVE-DEEPENING-MODE?*
  *RECORD-JUSTIFICATIONS?* *JUST-IN-TIME-FORWARD-INFERENCE?* *EMIT-THINKING-DOTS?* STANDARD-OUTPUT EOL))
...
(CL:DEFUN PRINT-FEATURES ()
  ...
  (%%PRINT-STREAM (%NATIVE-STREAM STANDARD-OUTPUT) "Currently enabled PowerLoom features:" EOL "   "
   *CURRENT-POWERLOOM-FEATURES* EOL EOL "Available PowerLoom features:" EOL "   " *AVAILABLE-POWERLOOM-FEATURES* EOL))
...
(CL:DEFUN SET-POWERLOOM-FEATURE (FEATURE)
  ...
  (CL:WHEN (CL:NOT (MEMBER? *CURRENT-POWERLOOM-FEATURES* FEATURE))
   (CL:COND
    ((CL:EQ FEATURE KWD-LOGIC-IN-TRACE-SUBGOALS) (CLEAR-CACHES) (%ADD-TRACE (CONS-LIST KWD-LOGIC-IN-GOAL-TREE)))
    ...
    ((CL:EQ FEATURE KWD-LOGIC-IN-ITERATIVE-DEEPENING) (CL:SETQ *ITERATIVE-DEEPENING-MODE?* CL:T))
    ...
    (CL:T (CL:WARN "No such PowerLoom environment feature: `~A'" FEATURE) (PRINT-FEATURES)
...
"
  (CL:HANDLER-CASE
   (CL:LET* ((FEATURENAME NULL) (ITER-000 FEATURES))
    (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-000 NIL)) DO (CL:SETQ FEATURENAME (%%VALUE ITER-000))
     (SET-POWERLOOM-FEATURE (KEYWORDIFY (COERCE-TO-STRING FEATURENAME))) (CL:SETQ ITER-000 (%%REST ITER-000))))
...
(CL:DEFUN UNSET-POWERLOOM-FEATURE (FEATURE)
  ...
  (CL:IF (MEMBER? *CURRENT-POWERLOOM-FEATURES* FEATURE)
   (CL:COND ((CL:EQ FEATURE KWD-LOGIC-IN-TRACE-SUBGOALS) (%DROP-TRACE (CONS-LIST KWD-LOGIC-IN-GOAL-TREE)))
    ...
    ((CL:EQ FEATURE KWD-LOGIC-IN-TRACE-CLASSIFIER) (%DROP-TRACE (CONS-LIST KWD-LOGIC-IN-CLASSIFIER-INFERENCES)))
    ((CL:EQ FEATURE KWD-LOGIC-IN-CLOSED-WORLD))
    ...
    (CL:T
     (CL:LET* ((STREAM-000 (NEW-OUTPUT-STRING-STREAM)))
      (%%PRINT-STREAM (%NATIVE-STREAM STREAM-000) "`" FEATURE "' is not a valid case option")
      (CL:ERROR (NEW-STELLA-EXCEPTION (THE-STRING-READER STREAM-000))))))
   (CL:WHEN (CL:NOT (MEMBER? *AVAILABLE-POWERLOOM-FEATURES* FEATURE))
    (CL:WARN "No such PowerLoom environment feature: `~A'" FEATURE) (PRINT-FEATURES)))
...
See `set-feature' for a description of supported features."
  (CL:HANDLER-CASE
   (CL:LET* ((FEATURENAME NULL) (ITER-000 FEATURES))
    (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-000 NIL)) DO (CL:SETQ FEATURENAME (%%VALUE ITER-000))
     (UNSET-POWERLOOM-FEATURE (KEYWORDIFY (COERCE-TO-STRING FEATURENAME))) (CL:SETQ ITER-000 (%%REST ITER-000))))
   (LOGIC-EXCEPTION (E) (%%PRINT-STREAM (%NATIVE-STREAM STANDARD-ERROR) (EXCEPTION-MESSAGE E))))
  *CURRENT-POWERLOOM-FEATURES*)
...
(CL:DEFUN RESET-FEATURES ()
  ...
  (CL:LET* ((F NULL) (ITER-000 (%THE-CONS-LIST (COPY *CURRENT-POWERLOOM-FEATURES*))))
   (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-000 NIL)) DO (CL:SETQ F (%%VALUE ITER-000))
    (CL:WHEN (CL:NOT (MEMBER? *DEFAULT-POWERLOOM-FEATURES* F)) (UNSET-POWERLOOM-FEATURE F))
  ...
  (CL:LET* ((F NULL) (ITER-001 (%THE-CONS-LIST *DEFAULT-POWERLOOM-FEATURES*)))
   (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-001 NIL)) DO (CL:SETQ F (%%VALUE ITER-001))
    (CL:WHEN (CL:NOT (MEMBER? *CURRENT-POWERLOOM-FEATURES* F)) (SET-POWERLOOM-FEATURE F))
   ...
   (CL:LET* ((PRINTCONTEXT (CL:IF (CL:NOT (CL:EQ TEMP-000 NULL)) TEMP-000 *CONTEXT*)))
    (CL:LET* ((*PRINTMODE* KWD-LOGIC-IN-REALISTIC) (*PRETTYPRINTLOGICALFORMS?* CL:T) (*CONTEXT* PRINTCONTEXT))
     ...
     (CL:WHEN (CL:NOT (CL:EQ RESULT NULL))
      (%%PRINT-STREAM (%NATIVE-STREAM STANDARD-OUTPUT) *LOGIC-COMMAND-RESULT-INDENT* RESULT EOL))))))
   ...
   (CL:LET* ((TEST-VALUE-001 (SAFE-PRIMARY-TYPE COMMAND)))
    (CL:COND
     ((SUBTYPE-OF-KEYWORD? TEST-VALUE-001)
      (CL:PROGN
       (CL:COND
        ((CL:OR (CL:EQ COMMAND KWD-LOGIC-IN-BYE) (CL:EQ COMMAND KWD-LOGIC-IN-EXIT) (CL:EQ COMMAND KWD-LOGIC-IN-HALT)
     ...
     ((SUBTYPE-OF-SYMBOL? TEST-VALUE-001)
      (CL:PROGN
       (CL:LET* ((TEST-VALUE-000 (%SYMBOL-NAME COMMAND))) (CL:DECLARE (CL:TYPE CL:SIMPLE-STRING TEST-VALUE-000))
        (CL:COND
         ((CL:OR (STRING-EQL? TEST-VALUE-000 "BYE") (STRING-EQL? TEST-VALUE-000 "EXIT")
           (STRING-EQL? TEST-VALUE-000 "HALT") (STRING-EQL? TEST-VALUE-000 "QUIT") (STRING-EQL? TEST-VALUE-000 "STOP")
           (STRING-EQL? TEST-VALUE-000 "bye") (STRING-EQL? TEST-VALUE-000 "exit") (STRING-EQL? TEST-VALUE-000 "halt")
...
(CL:DEFUN LOGIC-COMMAND-LOOP (MODULE)
  (CL:LET* ((COMMAND NULL) (RESULT NULL) (EOF? CL:NIL) (EXIT? CL:NIL) (EXITCOMMAND? CL:NIL))
   (CL:LET* ((*MODULE* (CL:IF (CL:NOT (CL:EQ MODULE NULL)) MODULE *MODULE*)) (*CONTEXT* *MODULE*))
    (CL:DECLARE (CL:SPECIAL *MODULE* *CONTEXT*))
    (CL:LOOP
     (CL:TAGBODY
      (CL:HANDLER-CASE
       (CL:PROGN (%%PRINT-STREAM (%NATIVE-STREAM STANDARD-OUTPUT) EOL) (PRINT-LOGIC-PROMPT)
        (CL:MULTIPLE-VALUE-SETQ (COMMAND EOF?) (READ-S-EXPRESSION STANDARD-INPUT))
        (CL:WHEN EOF? (%%PRINT-STREAM (%NATIVE-STREAM STANDARD-OUTPUT) "End of File encountered.  Exiting." EOL)
         (CL:RETURN))
        (%%PRINT-STREAM (%NATIVE-STREAM STANDARD-OUTPUT) EOL)
        (CL:MULTIPLE-VALUE-SETQ (EXIT? EXITCOMMAND?) (LOGIC-COMMAND-LOOP-EXIT? COMMAND)) (CL:WHEN EXIT? (CL:RETURN))
        (CL:WHEN EXITCOMMAND? (CL:GO :CONTINUE)) (CL:SETQ RESULT (EVALUATE-LOGIC-COMMAND COMMAND CL:NIL))
        (PRINT-LOGIC-COMMAND-RESULT RESULT))
       (LOGIC-EXCEPTION (LE) (%%PRINT-STREAM (%NATIVE-STREAM STANDARD-ERROR) ">> Error: " (EXCEPTION-MESSAGE LE)))
       (STELLA-EXCEPTION (E)
        (%%PRINT-STREAM (%NATIVE-STREAM STANDARD-ERROR) ">> Internal Error: " (EXCEPTION-MESSAGE E))
...
(CL:DEFUN EVALUATE-LOGIC-COMMAND (COMMAND FINALIZE?)
  (CL:LET*
   ((*TRANSLATIONERRORS* 0) (*TRANSLATIONWARNINGS* 0) (*IGNORETRANSLATIONERRORS?* CL:NIL) (*TRANSLATIONUNITS* NULL)
    (*TRANSLATIONPHASE* KWD-LOGIC-IN-DEFINE) (*EVALUATIONTREE* NULL))
   (CL:DECLARE
    (CL:SPECIAL *TRANSLATIONERRORS* *TRANSLATIONWARNINGS* *IGNORETRANSLATIONERRORS?* *TRANSLATIONUNITS*
   ...
   (CL:LET* ((OPERATOR NULL) (OPERATORNAME STELLA::NULL-STRING) (RESULT NULL))
    ...
    (CL:LET* ((TEST-VALUE-000 (SAFE-PRIMARY-TYPE COMMAND)))
     (CL:COND
        ...
        (CL:COND
         ((SUBTYPE-OF-SYMBOL? (SAFE-PRIMARY-TYPE OPERATOR))
          (CL:PROGN (CL:SETQ OPERATORNAME (%SYMBOL-NAME OPERATOR))
           (CL:WHEN (STRING-EQUAL? OPERATORNAME "DEFMODULE") (CL:SETQ OPERATOR SYM-LOGIC-IN-STELLA-DEFMODULE)
            (CL:SETF (%%VALUE COMMAND) OPERATOR))
           (CL:COND ((STRING-EQUAL? OPERATORNAME "IN-MODULE") (HANDLE-IN-MODULE-TREE COMMAND CL:NIL CL:NIL))
            ...
            ((DECLARATION-TREE? COMMAND) (CL:SETQ *TRANSLATIONUNITS* (LIST)) (WALK-TOP-LEVEL-TREE COMMAND CL:NIL)
             (CL:CASE (LENGTH (REVERSE *TRANSLATIONUNITS*))
              (0
               (CL:LET* ((STREAM-000 (NEW-OUTPUT-STRING-STREAM)))
                (%%PRINT-STREAM (%NATIVE-STREAM STREAM-000) "Translation failed: `" COMMAND "'")
      ...
      ((SUBTYPE-OF-SURROGATE? TEST-VALUE-000) (CL:PROGN (CL:SETQ RESULT COMMAND)))
      (CL:T (WITH-PROCESS-LOCK *POWERLOOM-LOCK* (CL:SETQ RESULT (%EVALUATE COMMAND))))))
    (CL:WHEN (CL:AND (CL:NOT (TRANSLATION-ERRORS?)) FINALIZE?) (CL:SETQ *TRANSLATIONPHASE* KWD-LOGIC-IN-FINALIZE)
     (FINALIZE-OBJECTS))
    RESULT)))
...
then an error will be signaled."
  ...
  (CL:LET* ((TEMP-000 (FIND-FILE-IN-LOAD-PATH FILE *POWERLOOM-KB-FILE-EXTENSIONS*)))
  ...
  (CL:LET*
   ((THEOPTIONS
     (PARSE-LOGIC-COMMAND-OPTIONS OPTIONS
      (LIST* KWD-LOGIC-IN-CHECK-DUPLICATES? SGT-LOGIC-IN-STELLA-BOOLEAN KWD-LOGIC-IN-MODULE SGT-LOGIC-IN-STELLA-MODULE
       NIL)
      CL:T CL:NIL))
      ...
      (*DONT-CHECK-FOR-DUPLICATE-PROPOSITIONS?*
       (CL:NOT
        (COERCE-WRAPPED-BOOLEAN-TO-BOOLEAN
         (LOOKUP-WITH-DEFAULT THEOPTIONS KWD-LOGIC-IN-CHECK-DUPLICATES? TRUE-WRAPPER)))))
     (CL:DECLARE (CL:SPECIAL *CURRENTFILE* *DONT-CHECK-FOR-DUPLICATE-PROPOSITIONS?*))
     (CL:DECLARE (CL:TYPE CL:SIMPLE-STRING *CURRENTFILE*)) (CL:SETQ INPUTSTREAM (NEW-INPUT-FILE-STREAM FILE))
     (LOAD-STREAM-IN-MODULE INPUTSTREAM (LOOKUP THEOPTIONS KWD-LOGIC-IN-MODULE)))
...
not have an `in-module' form, an error is signaled."
  (CL:LET*
   ((CURRENTDIALECT *LOGIC-DIALECT*) (SKIPCOMMAND? CL:NIL) (SEENINMODULE? (CL:NOT (CL:EQ DEFAULT-MODULE NULL)))
    (COMMANDS NIL) (LOAD-MODULE (CL:IF SEENINMODULE? DEFAULT-MODULE *MODULE*)))
       ...
       (CL:TAGBODY
        (CL:COND
         ((CL:EQ (SAFE-PRIMARY-TYPE TREE) SGT-LOGIC-IN-STELLA-CONS)
          (CL:PROGN
           (CL:MULTIPLE-VALUE-SETQ (SKIPCOMMAND? SEENINMODULE?) (HANDLE-IN-MODULE-TREE TREE SEENINMODULE? CL:NIL))
              ...
              (CL:PROGN
               (CL:COND
                ((CL:OR (CL:EQ OPERATOR SYM-LOGIC-IN-STELLA-DEFMODULE)
                  (CL:EQ OPERATOR SYM-LOGIC-IN-STELLA-CLEAR-MODULE) (CL:EQ OPERATOR SYM-LOGIC-IN-STELLA-DEFCLASS)
                  (CL:EQ OPERATOR SYM-LOGIC-IN-STELLA-DEFSLOT) (CL:EQ OPERATOR SYM-LOGIC-IN-STELLA-DEFUN)
                  (CL:EQ OPERATOR SYM-LOGIC-IN-STELLA-DEFMETHOD) (CL:EQ OPERATOR SYM-LOGIC-IN-LOGIC-DEFCONCEPT)
                  (CL:EQ OPERATOR SYM-LOGIC-IN-LOGIC-DEFFUNCTION) (CL:EQ OPERATOR SYM-LOGIC-IN-LOGIC-DEFRELATION)
                ...
                ((CL:EQ OPERATOR SYM-LOGIC-IN-LOGIC-IN-DIALECT) (EVALUATE-LOGIC-COMMAND TREE CL:NIL)
                 (CL:SETQ COMMANDS (CONS TREE COMMANDS)))
                (CL:T
                 (CL:IF (CL:AND (CL:NOT (DEFINITION-NAME? OPERATOR)) (CL:NOT (CL:EQ (LOOKUP-COMMAND OPERATOR) NULL)))
                  (CL:SETQ COMMANDS (CONS TREE COMMANDS)) (EVALUATE-LOGIC-COMMAND TREE CL:NIL))))))
             (CL:T (EVALUATE-LOGIC-COMMAND TREE CL:NIL))))))
         (CL:T (EVALUATE-LOGIC-COMMAND TREE CL:NIL)))
        :CONTINUE)))
     (CL:LET* ((*TRANSLATIONPHASE* KWD-LOGIC-IN-FINALIZE)) (CL:DECLARE (CL:SPECIAL *TRANSLATIONPHASE*))
      (FINALIZE-OBJECTS))
     (CL:LET* ((TREE NULL) (ITER-001 (REVERSE COMMANDS)))
      (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-001 NIL)) DO (CL:SETQ TREE (%%VALUE ITER-001))
       (EVALUATE-LOGIC-COMMAND TREE CL:T) (CL:SETQ ITER-001 (%%REST ITER-001)))))
...
(CL:DEFUN %LOAD-DIRECTORY (DIRECTORY)
  ...
  (PL-LOG KWD-LOGIC-IN-LOW (WRAP-STRING "Loading PowerLoom files from directory ") (WRAP-STRING DIRECTORY)
   (WRAP-STRING "..."))
  (BUMP-LOG-INDENT)
    ...
    (CL:LET* ((FOUND?-000 CL:NIL))
     (CL:LET* ((EXT NULL) (ITER-001 *POWERLOOM-KB-FILE-EXTENSIONS*))
      (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-001 NIL)) DO (CL:SETQ EXT (%%VALUE ITER-001))
       (CL:WHEN (ENDS-WITH? (%WRAPPER-VALUE FILE) (%WRAPPER-VALUE EXT) NULL-INTEGER) (CL:SETQ FOUND?-000 CL:T)
        (CL:RETURN))
       (CL:SETQ ITER-001 (%%REST ITER-001))))
     (CL:WHEN FOUND?-000 (PL-LOG KWD-LOGIC-IN-MEDIUM (WRAP-STRING "Loading file ") FILE)
...
starts with a `-' character."
  (CL:LET* ((UNPROCESSEDARGS (UNPROCESSED-COMMAND-LINE-ARGUMENTS)) (FILE STELLA::NULL-STRING))
   (CL:DECLARE (CL:TYPE CL:SIMPLE-STRING FILE))
   (CL:WHEN (CL:NOT (CL:EQ UNPROCESSEDARGS NULL))
    (CL:SETQ UNPROCESSEDARGS (REVERSE (COPY-CONS-LIST (UNPROCESSED-COMMAND-LINE-ARGUMENTS))))
    (CL:LET* ((ARG NULL) (ITER-000 UNPROCESSEDARGS) (I NULL-INTEGER) (ITER-001 0))
     ...
     (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-000 NIL)) DO (CL:SETQ ARG (%%VALUE ITER-000)) (CL:SETQ I ITER-001)
      (CL:WHEN (STARTS-WITH? (%WRAPPER-VALUE ARG) "-" NULL-INTEGER)
       (CL:IF (CL:= I 0) (CL:SETQ UNPROCESSEDARGS NIL) (NTH-REST-SETTER UNPROCESSEDARGS NIL I)) (CL:RETURN))
      ...
      (CL:LET* ((FOUND?-000 CL:NIL))
       (CL:LET* ((EXT NULL) (ITER-003 *POWERLOOM-KB-FILE-EXTENSIONS*))
        (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-003 NIL)) DO (CL:SETQ EXT (%%VALUE ITER-003))
         (CL:WHEN (ENDS-WITH? (%WRAPPER-VALUE ARG) (%WRAPPER-VALUE EXT) NULL-INTEGER) (CL:SETQ FOUND?-000 CL:T)
          (CL:RETURN))
         (CL:SETQ ITER-003 (%%REST ITER-003))))
       (CL:IF FOUND?-000
        (CL:PROGN
         (CL:LET* ((TEMP-000 (FIND-FILE-IN-LOAD-PATH (%WRAPPER-VALUE ARG) NULL)))
          (CL:DECLARE (CL:TYPE CL:SIMPLE-STRING TEMP-000))
...
(CL:DEFUN DEMO-SKIP-TO-COMMAND (STREAM)
  (CL:LET* ((CH NULL-CHARACTER) (EOF? CL:NIL) (ECHO? CL:NIL) (ECHOSTREAM (%ECHO-STREAM STREAM)))
   (CL:LOOP (CL:SETF (%ECHO-STREAM STREAM) NULL) (CL:MULTIPLE-VALUE-SETQ (CH EOF?) (READ-CHARACTER STREAM))
    ...
    (CL:COND
     ...
     ((CL:EQL CH #\;) (CL:SETQ ECHO? CL:T) (CL:SETF (%ECHO-STREAM STREAM) ECHOSTREAM)
...
(CL:DEFUN DEMO-PAUSE? (PAUSE?)
  (CL:LET* ((EXIT? CL:NIL) (INPUT STELLA::NULL-STRING)) (CL:DECLARE (CL:TYPE CL:SIMPLE-STRING INPUT))
   (CL:COND
    (PAUSE? (%%PRINT-STREAM (%NATIVE-STREAM STANDARD-OUTPUT) "------ pause ------")
     (CL:SETQ INPUT (READ-LINE STANDARD-INPUT)) (%%PRINT-STREAM (%NATIVE-STREAM STANDARD-OUTPUT) EOL)
     (CL:WHEN (CL:> (CL:THE CL:FIXNUM (CL:LENGTH INPUT)) 0)
      (CL:CASE
       ...
       (#\Q (CL:WHEN (Y-OR-N? "Really exit demo? (y or n) ") (CL:SETQ PAUSE? CL:NIL) (CL:SETQ EXIT? CL:T)))
       ((#\H #\?)
        (%%PRINT-STREAM (%NATIVE-STREAM STANDARD-OUTPUT) "Type `c' to continue without pausing," EOL
         "     `q' to quit from this demo," EOL "     `?' or `h' to get this message," EOL
...
(CL:DEFUN DEMO-FILE (FILE PAUSE?)
  ...
  (CL:LET* ((CURRENTLEVEL *DEMO-LEVEL*) (COMMAND NULL) (RESULT NULL) (EXIT? CL:NIL))
    ...
    (CL:UNWIND-PROTECT
     (CL:PROGN (CL:SETQ INPUTSTREAM (OPEN-INPUT-FILE FILE))
      (CL:LET* ((*CAREFUL-LOGIC-COMMAND-LOOP-EXIT*? CL:NIL) (*DEMO-LEVEL* (CL:1+ CURRENTLEVEL)))
       (CL:DECLARE (CL:SPECIAL *CAREFUL-LOGIC-COMMAND-LOOP-EXIT*? *DEMO-LEVEL*))
       (CL:DECLARE (CL:TYPE CL:FIXNUM *DEMO-LEVEL*)) (CL:SETF (%ECHO-STREAM INPUTSTREAM) STANDARD-OUTPUT)
       (CL:LET* ((*MODULE* *MODULE*) (*CONTEXT* *MODULE*)) (CL:DECLARE (CL:SPECIAL *MODULE* *CONTEXT*))
        (CL:WHEN PAUSE?
         (%%PRINT-STREAM (%NATIVE-STREAM STANDARD-OUTPUT) "Now reading from `" FILE "'." EOL
          "Type `?' at the pause prompt for a list of available commands." EOL))
        (CL:LOOP
         (CL:HANDLER-CASE
          (CL:PROGN (%%PRINT-STREAM (%NATIVE-STREAM STANDARD-OUTPUT) EOL)
           (CL:SETQ EXIT? (DEMO-SKIP-TO-COMMAND INPUTSTREAM)) (PRINT-DEMO-PROMPT)
           ...
           (CL:MULTIPLE-VALUE-SETQ (PAUSE? EXIT?) (DEMO-PAUSE? PAUSE?)) (CL:WHEN EXIT? (CL:RETURN))
           (CL:SETQ RESULT (EVALUATE-LOGIC-COMMAND COMMAND CL:NIL)) (PRINT-LOGIC-COMMAND-RESULT RESULT))
          (EVALUATION-EXCEPTION (E)
           (%%PRINT-STREAM (%NATIVE-STREAM STANDARD-ERROR) ">> Error: " (EXCEPTION-MESSAGE E)))))
        (%%PRINT-STREAM (%NATIVE-STREAM STANDARD-OUTPUT) EOL EOL *LOGIC-COMMAND-RESULT-INDENT* "Finished demo `" FILE
         "'." EOL))))
...
(CL:DEFUN DEMO-ENTRY-FILE (DEMOENTRY)
  (CL:LET* ((DEMOBASEFILE (%WRAPPER-VALUE (%%VALUE DEMOENTRY)))) (CL:DECLARE (CL:TYPE CL:SIMPLE-STRING DEMOBASEFILE))
   (CL:LET* ((TEMP-000 (FIND-FILE-IN-LOAD-PATH DEMOBASEFILE *POWERLOOM-KB-FILE-EXTENSIONS*)))
    (CL:DECLARE (CL:TYPE CL:SIMPLE-STRING TEMP-000))
    (CL:LET* ((VALUE-000 (CL:IF (CL:NOT (CL:EQ TEMP-000 STELLA::NULL-STRING)) TEMP-000 DEMOBASEFILE)))
...
(CL:DEFUN DEMO-ENTRY-DESCRIPTION (DEMOENTRY)
  (CL:IF (CL:NOT (CL:EQ (%%VALUE (%%REST DEMOENTRY)) NULL)) (%WRAPPER-VALUE (%%VALUE (%%REST DEMOENTRY)))
...
(CL:DEFUN DEMO-ENTRY-TEST-SUITE? (DEMOENTRY)
  (CL:AND (STRING? (%%VALUE (%%REST (%%REST DEMOENTRY))))
   (STRING-EQL? (%WRAPPER-VALUE (%%VALUE (%%REST (%%REST DEMOENTRY)))) "test-suite")))
...
(CL:DEFUN SELECT-EXAMPLE-DEMO (INDEX)
  ...
  (CL:LET* ((ENTRY (NTH *DEMO-FILES* (CL:1- INDEX))))
   (CL:IF (CL:NOT (CL:EQ ENTRY NULL)) (DEMO-ENTRY-FILE ENTRY) STELLA::NULL-STRING)))
...
(CL:DEFUN SELECT-EXAMPLE-DEMO-FROM-MENU ()
  ...
  (CL:LET* ((ENTRY NULL) (ITER-000 *DEMO-FILES*) (I NULL-INTEGER) (ITER-001 1))
   (CL:DECLARE (CL:TYPE CL:FIXNUM I ITER-001))
   (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-000 NIL)) DO (CL:SETQ ENTRY (%%VALUE ITER-000)) (CL:SETQ I ITER-001)
    ...
    (CL:WHEN (CL:< I 10) (%%PRINT-STREAM (%NATIVE-STREAM STANDARD-OUTPUT) " "))
    (%%PRINT-STREAM (%NATIVE-STREAM STANDARD-OUTPUT) (DEMO-ENTRY-DESCRIPTION ENTRY) EOL)
    (CL:SETQ ITER-000 (%%REST ITER-000)) (CL:SETQ ITER-001 (CL:1+ ITER-001))))
  (%%PRINT-STREAM (%NATIVE-STREAM STANDARD-OUTPUT) "       Q.   Quit demoing" EOL)
  (%%PRINT-STREAM (%NATIVE-STREAM STANDARD-OUTPUT) "Your choice: ")
  (CL:LET* ((SELECTION (READ-S-EXPRESSION STANDARD-INPUT)) (FILE STELLA::NULL-STRING))
   (CL:DECLARE (CL:TYPE CL:SIMPLE-STRING FILE))
   (CL:COND
   ...
   (%%PRINT-STREAM (%NATIVE-STREAM STANDARD-OUTPUT) ">> ERROR: Illegal choice `" SELECTION
...
(CL:DEFUN DEMO-EXAMPLE-DEMOS ()
  (CL:LET* ((FILE STELLA::NULL-STRING)) (CL:DECLARE (CL:TYPE CL:SIMPLE-STRING FILE))
   (CL:LOOP (%%PRINT-STREAM (%NATIVE-STREAM STANDARD-OUTPUT) EOL) (CL:SETQ FILE (SELECT-EXAMPLE-DEMO-FROM-MENU))
    (CL:WHEN (CL:EQ FILE STELLA::NULL-STRING) (CL:RETURN-FROM DEMO-EXAMPLE-DEMOS))
    (%%PRINT-STREAM (%NATIVE-STREAM STANDARD-OUTPUT) EOL) (DEMO-FILE FILE CL:T))))
...
Typing `?' at the pause prompt prints a list of available commands."
  (CL:LET*
   ((THEFILEANDPAUSE FILEANDPAUSE) (FILESPEC (%%VALUE THEFILEANDPAUSE))
    (PAUSE? (CL:NOT (EQL? (%%VALUE (%%REST THEFILEANDPAUSE)) FALSE-WRAPPER))) (FILE STELLA::NULL-STRING))
   (CL:DECLARE (CL:TYPE CL:SIMPLE-STRING FILE))
   ...
   (CL:IF (CL:EQ FILESPEC NULL) (DEMO-EXAMPLE-DEMOS)
    (CL:COND
     ((SUBTYPE-OF-STRING? (SAFE-PRIMARY-TYPE FILESPEC)) (CL:PROGN (DEMO-FILE (%WRAPPER-VALUE FILESPEC) PAUSE?)))
...
(CL:DEFUN TEST-LOGIC-FILE (FILE)
  ...
  (CL:LET*
   ((CURRENTLEVEL *DEMO-LEVEL*) (COMMAND NULL) (RESULT NULL) (EXIT? CL:NIL) (INPUTSTREAM (NEW-INPUT-FILE-STREAM FILE))
    (FILEBASENAME (FILE-NAME-WITHOUT-DIRECTORY FILE)))
   (CL:DECLARE (CL:TYPE CL:FIXNUM CURRENTLEVEL))
   (CL:LET*
    ((*CAREFUL-LOGIC-COMMAND-LOOP-EXIT*? CL:NIL) (*DEMO-LEVEL* (CL:1+ CURRENTLEVEL)) (*PRINTREADABLY?* CL:T)
     (*PRINTPRETTY?* CL:NIL))
    (CL:DECLARE (CL:SPECIAL *CAREFUL-LOGIC-COMMAND-LOOP-EXIT*? *DEMO-LEVEL* *PRINTREADABLY?* *PRINTPRETTY?*))
    ...
    (CL:LET* ((*MODULE* *MODULE*) (*CONTEXT* *MODULE*)) (CL:DECLARE (CL:SPECIAL *MODULE* *CONTEXT*))
     ...
     (FREE INPUTSTREAM)
     (%%PRINT-STREAM (%NATIVE-STREAM STANDARD-OUTPUT) EOL EOL *LOGIC-COMMAND-RESULT-INDENT* "Finished testing file `"
      FILEBASENAME "'." EOL)))))
...
be diffed with previously validated runs to find deviations."
  (CL:LET*
   ...
   (%%PRINT-STREAM (%NATIVE-STREAM STANDARD-OUTPUT) "RUNNING POWERLOOM TEST SUITE" EOL "============================"
    EOL EOL)
   (%%PRINT-STREAM (%NATIVE-STREAM STANDARD-OUTPUT) "STELLA version:    " *STELLA-VERSION-STRING* EOL
    "PowerLoom version: " *POWERLOOM-VERSION-STRING* EOL "Start time:        "
    (CALENDAR-DATE-TO-STRING START-TIME (GET-LOCAL-TIME-ZONE) CL:NIL CL:T) EOL EOL)
   (CLEAR-CONTEXT PLUSER)
   (CL:LET* ((CHILD NULL) (ITER-000 (%THE-CONS-LIST (COPY (%CHILD-CONTEXTS PLUSER)))))
    (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-000 NIL)) DO (CL:SETQ CHILD (%%VALUE ITER-000)) (DESTROY-CONTEXT CHILD)
     (CL:SETQ ITER-000 (%%REST ITER-000))))
   ...
   (CL:LET* ((ENTRY NULL) (ITER-001 *DEMO-FILES*))
    (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-001 NIL)) DO (CL:SETQ ENTRY (%%VALUE ITER-001))
     (CL:WHEN (DEMO-ENTRY-TEST-SUITE? ENTRY) (TEST-LOGIC-FILE (DEMO-ENTRY-FILE ENTRY)))
     (CL:SETQ ITER-001 (%%REST ITER-001))))
   (CL:SETQ FINISH-TIME (MAKE-CURRENT-DATE-TIME))
   (%%PRINT-STREAM (%NATIVE-STREAM STANDARD-OUTPUT) EOL "FINISHED RUNNING POWERLOOM TEST SUITE" EOL
    "=====================================" EOL "Finish time:   "
    (CALENDAR-DATE-TO-STRING FINISH-TIME (GET-LOCAL-TIME-ZONE) CL:NIL CL:T) EOL "Elapsed time:  "
...
needed for its execution, and then return its result."
  (CL:LET*
   ...
   (CL:WHEN (CL:> (%DAYS ELAPSEDTIME) 0)
    (%%PRINT-STREAM (%NATIVE-STREAM STANDARD-OUTPUT) (%DAYS ELAPSEDTIME) " days, "))
...
the required support systems in Lisp and Java if necessary (C++ is not yet supported)."
  (CL:LET*
   ((THEOPTIONS
     (PARSE-LOGIC-COMMAND-OPTIONS OPTIONS (LIST* KWD-LOGIC-IN-PORT SGT-LOGIC-IN-STELLA-INTEGER NIL) CL:T CL:NIL))
    (PORT (%WRAPPER-VALUE (LOOKUP-WITH-DEFAULT THEOPTIONS KWD-LOGIC-IN-PORT (WRAP-INTEGER 0))))
   ...
   (PL-LOG KWD-LOGIC-IN-LOW (WRAP-STRING "Started Ontosaurus, point your browser to `") (WRAP-STRING ADDRESS)
    (WRAP-STRING "ploom/ontosaurus/'"))))
...
the required support systems in Lisp and Java if necessary (C++ is not yet supported)."
  (CL:LET*
   ...
   (CL:SETQ ADDRESS (CL:FUNCALL (AUTOLOAD "HTTP/START-HTTP-SERVER" (GET-HTTP-SERVER-SYSTEM) NULL CL:T) PORT))
   (PL-LOG KWD-LOGIC-IN-LOW (WRAP-STRING "Started PowerLoom server at `") (WRAP-STRING ADDRESS)
...
an HTTP server (currently Lisp and Java)."
  (CL:LET*
   ((THEOPTIONS
     (PARSE-LOGIC-COMMAND-OPTIONS OPTIONS
      (LIST* KWD-LOGIC-IN-HOST SGT-LOGIC-IN-STELLA-STRING KWD-LOGIC-IN-PORT SGT-LOGIC-IN-STELLA-INTEGER
    ...
    (DEBUGLEVEL (%WRAPPER-VALUE (LOOKUP-WITH-DEFAULT THEOPTIONS KWD-LOGIC-IN-DEBUG-LEVEL (WRAP-INTEGER 1))))
    (GUICLASS "edu.isi.powerloom.gui.components.PowerloomApp") (GUIFN NULL) (GUIFNARGS (CL:MAKE-ARRAY 6)))
   (CL:DECLARE (CL:TYPE CL:SIMPLE-STRING HOST GUICLASS) (CL:TYPE CL:FIXNUM PORT DEBUGLEVEL)
    (CL:TYPE CL:SIMPLE-VECTOR GUIFNARGS))
   (CL:PROGN
    (CL:PROGN (CL:SETQ HOST HOST) (CL:SETQ PORT PORT) (CL:SETQ DEBUGLEVEL DEBUGLEVEL) (CL:SETQ GUICLASS GUICLASS)
...
This is a no-op if the GUI is not running or if it is not supported."
  (CL:LET* ((GUICLASS "edu.isi.powerloom.gui.components.PowerloomApp") (EXITFN NULL))
   (CL:DECLARE (CL:TYPE CL:SIMPLE-STRING GUICLASS)) (CL:SETQ GUICLASS GUICLASS)
...
(CL:DEFUN PRINT-FORMULA-CONTAINING-ERROR (SELF STREAM)
  (CL:LET* ((TEMP (NEW-OUTPUT-STRING-STREAM)) (EXPRESSIONSTRING STELLA::NULL-STRING))
   (CL:DECLARE (CL:TYPE CL:SIMPLE-STRING EXPRESSIONSTRING)) (%%PRINT-STREAM (%NATIVE-STREAM TEMP) SELF)
...
(CL:DEFUN HELP-SIGNAL-PROPOSITION-ERROR (STREAM WARNINGORERROR)
  (CL:LET*
   ((BESTOUTPUTOBJECT *TERMUNDERCONSTRUCTION*)
    (TYPENAME (CL:IF (CL:NOT (CL:EQ BESTOUTPUTOBJECT NULL)) "proposition" "relation")))
   (CL:DECLARE (CL:TYPE CL:SIMPLE-STRING TYPENAME))
   (CL:WHEN (CL:EQ BESTOUTPUTOBJECT NULL) (CL:SETQ BESTOUTPUTOBJECT *DESCRIPTIONUNDERCONSTRUCTION*))
   ...
   (CL:WHEN (CL:NOT (CL:EQ BESTOUTPUTOBJECT NULL)) (%%PRINT-STREAM (%NATIVE-STREAM STREAM) "   ")
    (CL:COND ((CL:EQ WARNINGORERROR KWD-LOGIC-IN-ERROR) (%%PRINT-STREAM (%NATIVE-STREAM STREAM) "Error"))
     ...
     (CL:T
      (CL:LET* ((STREAM-000 (NEW-OUTPUT-STRING-STREAM)))
       (%%PRINT-STREAM (%NATIVE-STREAM STREAM-000) "`" WARNINGORERROR "' is not a valid case option")
       (CL:ERROR (NEW-STELLA-EXCEPTION (THE-STRING-READER STREAM-000))))))
    ...
    (CL:LET* ((TEST-VALUE-000 (SAFE-PRIMARY-TYPE BESTOUTPUTOBJECT)))
     (CL:COND
      ((SUBTYPE-OF? TEST-VALUE-000 SGT-LOGIC-IN-LOGIC-NAMED-DESCRIPTION)
       (CL:PROGN (%%PRINT-STREAM (%NATIVE-STREAM STREAM) (RELATION-NAME BESTOUTPUTOBJECT) EOL)
      ...
      ((SUBTYPE-OF-STRING? TEST-VALUE-000)
       (CL:PROGN (%%PRINT-STREAM (%NATIVE-STREAM STREAM) EOL)
        (CL:LET* ((SEXPRESSION (READ-S-EXPRESSION-FROM-STRING (%WRAPPER-VALUE BESTOUTPUTOBJECT))))
...
(CL:DEFUN LOOKUP-LOGIC-OBJECT-SURROGATE (NAME DEFINITIONMODULE)
  ...
  (CL:IF (EXPLICITLY-QUALIFIED-LOGIC-OBJECT-NAME? NAME DEFINITIONMODULE)
   (LOOKUP-SURROGATE-IN-MODULE (%SYMBOL-NAME NAME) (%HOME-CONTEXT NAME) CL:T) (LOOKUP-SURROGATE (%SYMBOL-NAME NAME))))
  ...
  (CL:WHEN (CL:NOT (CLEARABLE? *MODULE*))
   (CL:LET* ((STREAM-000 (NEW-OUTPUT-STRING-STREAM)))
    (CL:LET* ((*PRINTREADABLY?* CL:T)) (CL:DECLARE (CL:SPECIAL *PRINTREADABLY?*))
     (%%PRINT-STREAM (%NATIVE-STREAM STREAM-000) "ERROR: Can't define the term `" NAME "' in the unclearable module `"
  ...
  (CL:LET*
   ...
   (CL:WHEN (CL:AND (CL:NOT (CL:EQ OLDVALUE NULL)) (CL:NOT (CL:EQ OLDMODULE *MODULE*)))
    (CL:WHEN *WARNIFREDEFINE?*
     (%%PRINT-STREAM (%NATIVE-STREAM STANDARD-OUTPUT) "Defining `" NAME "' would cause a term with the same name" EOL
      "   of type `" (NAME-OBJECT-METACLASS OLDVALUE) "' in module `" (%MODULE-FULL-NAME OLDMODULE) "' to be shadowed."
      EOL)
     (%%PRINT-STREAM (%NATIVE-STREAM STANDARD-OUTPUT) "CAUTION: Automatic shadowing can be dangerous, because forward "
      EOL "   references to a shadowed object may be bound to the now shadowed " EOL
     ...
     (CL:WHEN (CL:NOT (YES-OR-NO? "Do it anyway? "))
      (CL:LET* ((STREAM-001 (NEW-OUTPUT-STRING-STREAM)))
       (CL:LET* ((*PRINTREADABLY?* CL:T)) (CL:DECLARE (CL:SPECIAL *PRINTREADABLY?*))
        (%%PRINT-STREAM (%NATIVE-STREAM STREAM-001) "ERROR: Couldn't shadow name `" NAME "' in `"
         (%MODULE-FULL-NAME *MODULE*) "'." EOL)
   ...
   (CL:IF (EXPLICITLY-QUALIFIED-LOGIC-OBJECT-NAME? NAME *MODULE*)
    (CL:LET* ((*MODULE* (%HOME-CONTEXT NAME)) (*CONTEXT* *MODULE*)) (CL:DECLARE (CL:SPECIAL *MODULE* *CONTEXT*))
...
(CL:DEFUN NAME-OBJECT-METACLASS (SELF)
  (CL:LET* ((TEST-VALUE-000 (SAFE-PRIMARY-TYPE SELF)))
   (CL:COND
    ((SUBTYPE-OF? TEST-VALUE-000 SGT-LOGIC-IN-LOGIC-DESCRIPTION)
     (CL:PROGN (CL:COND ((CLASS? SELF) "concept") ((FUNCTION? SELF) "function") (CL:T "relation"))))
    ((SUBTYPE-OF? TEST-VALUE-000 SGT-LOGIC-IN-LOGIC-LOGIC-OBJECT) (CL:PROGN "logic object"))
...
(CL:DEFUN LOGIC-OBJECT-DEFINITION-TYPE (NAME OLDOBJECT NEWOBJECT)
  ...
  (CL:LET* ((OLDKIND (NAME-OBJECT-METACLASS OLDOBJECT)) (NEWKIND (NAME-OBJECT-METACLASS NEWOBJECT)))
     ...
     ((SUBTYPE-OF? TEST-VALUE-001 SGT-LOGIC-IN-LOGIC-NAMED-DESCRIPTION)
      (CL:PROGN
       (CL:WHEN (CL:NOT (STRING-EQL? OLDKIND NEWKIND))
        (CL:LET* ((STREAM-000 (NEW-OUTPUT-STRING-STREAM)))
         (CL:LET* ((*PRINTREADABLY?* CL:T)) (CL:DECLARE (CL:SPECIAL *PRINTREADABLY?*))
          (%%PRINT-STREAM (%NATIVE-STREAM STREAM-000) "ERROR: Can't redefine `" OLDKIND "' `" NAME "' with a `" NEWKIND
           "'." EOL "   Explicitly destroy the old object first before you redefine it." EOL)
          (HELP-SIGNAL-PROPOSITION-ERROR STREAM-000 KWD-LOGIC-IN-ERROR))
         (CL:ERROR (NEW-PROPOSITION-ERROR (THE-STRING-READER STREAM-000)))))
       (CL:WHEN
        (CL:NOT
        ...
        (CL:LET* ((STREAM-001 (NEW-OUTPUT-STRING-STREAM)))
         (CL:LET* ((*PRINTREADABLY?* CL:T)) (CL:DECLARE (CL:SPECIAL *PRINTREADABLY?*))
          (%%PRINT-STREAM (%NATIVE-STREAM STREAM-001) "ERROR: Can't redefine `" OLDKIND "' `" NAME
           "' with a different arity." EOL "   Explicitly destroy the old object first before you redefine it." EOL)
          (HELP-SIGNAL-PROPOSITION-ERROR STREAM-001 KWD-LOGIC-IN-ERROR))
         (CL:ERROR (NEW-PROPOSITION-ERROR (THE-STRING-READER STREAM-001)))))
     ...
     ((SUBTYPE-OF? TEST-VALUE-001 SGT-LOGIC-IN-LOGIC-LOGIC-OBJECT)
      (CL:PROGN
       (CL:LET* ((TEST-VALUE-000 (SAFE-PRIMARY-TYPE NEWOBJECT)))
        (CL:COND
         ((SUBTYPE-OF? TEST-VALUE-000 SGT-LOGIC-IN-LOGIC-NAMED-DESCRIPTION)
          (CL:PROGN (CL:RETURN-FROM LOGIC-OBJECT-DEFINITION-TYPE KWD-LOGIC-IN-PROPER-DEFINITION)))
         ((SUBTYPE-OF? TEST-VALUE-000 SGT-LOGIC-IN-LOGIC-LOGIC-OBJECT)
          (CL:PROGN (CL:RETURN-FROM LOGIC-OBJECT-DEFINITION-TYPE KWD-LOGIC-IN-REDEFINITION)))
         (CL:T)))))
     (CL:T
   ...
   (CL:LET* ((STREAM-002 (NEW-OUTPUT-STRING-STREAM)))
    (CL:LET* ((*PRINTREADABLY?* CL:T)) (CL:DECLARE (CL:SPECIAL *PRINTREADABLY?*))
     (%%PRINT-STREAM (%NATIVE-STREAM STREAM-002) "ERROR: Can't redefine `" OLDKIND "' `" NAME "' with a `" NEWKIND "'."
      EOL "   Explicitly destroy the old object first before you redefine it." EOL)
...
(CL:DEFUN BIND-LOGIC-OBJECT-TO-SURROGATE (NAME OBJECT)
  (CL:LET* ((TEST-VALUE-000 (SAFE-PRIMARY-TYPE OBJECT)))
   (CL:COND ((SUBTYPE-OF? TEST-VALUE-000 SGT-LOGIC-IN-LOGIC-LOGIC-OBJECT) (CL:PROGN))
    ((SUBTYPE-OF? TEST-VALUE-000 SGT-LOGIC-IN-LOGIC-PROPOSITION) (CL:PROGN))
    (CL:T
     (CL:LET* ((STREAM-000 (NEW-OUTPUT-STRING-STREAM)))
      (%%PRINT-STREAM (%NATIVE-STREAM STREAM-000) "INTERNAL ERROR: Can't yet define logic objects of type `"
       (PRIMARY-TYPE OBJECT) "'")
      (CL:ERROR (NEW-STELLA-EXCEPTION (THE-STRING-READER STREAM-000)))))))
  (CL:LET*
   ((NAMESURROGATE (INTERN-LOGIC-OBJECT-SURROGATE NAME)) (OBJECTSURROGATE (OBJECT-SURROGATE OBJECT))
    (OLDOBJECT (%SURROGATE-VALUE NAMESURROGATE)) (DEFINITIONTYPE NULL))
   (CL:WHEN (CL:AND (CL:NOT (CL:EQ OLDOBJECT NULL)) (DELETED? OLDOBJECT)) (CL:SETQ OLDOBJECT NULL)
    (CL:SETF (%SURROGATE-VALUE NAMESURROGATE) NULL))
   (CL:WHEN
    (CL:AND *WARNIFREDEFINE?* (CL:NOT (CL:EQ OBJECTSURROGATE NULL)) (CL:NOT (CL:EQ OBJECTSURROGATE NAMESURROGATE)))
    (%%PRINT-STREAM (%NATIVE-STREAM STANDARD-OUTPUT) "The `" (NAME-OBJECT-METACLASS OBJECT) "' now named `" NAME
     "' used to be named `"
     (INTERN-SYMBOL-IN-MODULE (%SYMBOL-NAME OBJECTSURROGATE) (%HOME-CONTEXT OBJECTSURROGATE) CL:NIL) "'." EOL
     "    Unlinking it from its old name." EOL)
    (CL:SETF (%SURROGATE-VALUE OBJECTSURROGATE) NULL))
   (OBJECT-SURROGATE-SETTER OBJECT NAMESURROGATE)
   (CL:SETQ DEFINITIONTYPE (LOGIC-OBJECT-DEFINITION-TYPE NAME OLDOBJECT OBJECT))
   (CL:SETF (%SURROGATE-VALUE NAMESURROGATE) OBJECT)
   (CL:WHEN (CL:AND (CL:NOT (CL:EQ OLDOBJECT NULL)) (CL:NOT (EQL? OLDOBJECT OBJECT)))
   ...
   (CL:COND ((CL:EQ DEFINITIONTYPE KWD-LOGIC-IN-DEFINITION))
    ((CL:EQ DEFINITIONTYPE KWD-LOGIC-IN-PROPER-DEFINITION) (TRANSFER-PROPOSITIONS-AND-BACKLINKS OLDOBJECT OBJECT)
     (CL:LET* ((TEST-VALUE-001 (SAFE-PRIMARY-TYPE OLDOBJECT)))
      (CL:COND
       ((SUBTYPE-OF? TEST-VALUE-001 SGT-LOGIC-IN-LOGIC-LOGIC-OBJECT) (CL:PROGN (DELETED?-SETTER OLDOBJECT CL:T)))
    ...
    (CL:T
     (CL:LET* ((STREAM-002 (NEW-OUTPUT-STRING-STREAM)))
      (%%PRINT-STREAM (%NATIVE-STREAM STREAM-002) "`" DEFINITIONTYPE "' is not a valid case option")
...
(CL:DEFUN REDEFINE-LOGIC-OBJECT (NAME OLDOBJECT NEWOBJECT)
  (CL:LET*
   ((ORIGINATEDPROPS (REMOVE-DELETED-MEMBERS (ORIGINATED-PROPOSITIONS OLDOBJECT)))
    ...
    (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-000 NIL)) DO (CL:SETQ PROP (%%VALUE ITER-000))
     (CL:LET* ((SATELLITE NULL) (ITER-001 (%THE-CONS-LIST (SATELLITE-PROPOSITIONS PROP))))
      (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-001 NIL)) DO (CL:SETQ SATELLITE (%%VALUE ITER-001))
       (INSERT-NEW EXCEPTPROPS SATELLITE) (CL:SETQ ITER-001 (%%REST ITER-001))))
     (CL:SETQ ITER-000 (%%REST ITER-000))))
   (CL:WHEN
    (CL:AND *WARNIFREDEFINE?* (CL:NOT (STRING-EQL? (STRINGIFIED-SOURCE OLDOBJECT) (STRINGIFIED-SOURCE NEWOBJECT))))
    (PL-LOG KWD-LOGIC-IN-LOW (WRAP-STRING "Redefining the ") (WRAP-STRING (NAME-OBJECT-METACLASS OLDOBJECT))
   ...
   (CL:LET* ((PROP NULL) (ITER-002 (%THE-CONS-LIST ORIGINATEDPROPS)))
    (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-002 NIL)) DO (CL:SETQ PROP (%%VALUE ITER-002)) (DESTROY-PROPOSITION PROP)
     (CL:SETQ ITER-002 (%%REST ITER-002))))
    ...
    (CL:COND ((SUBTYPE-OF-SURROGATE? TEST-VALUE-000) (CL:PROGN (CL:SETQ SURROGATE SELF)))
     ...
     (CL:T
      (CL:LET* ((STREAM-000 (NEW-OUTPUT-STRING-STREAM)))
       (%%PRINT-STREAM (%NATIVE-STREAM STREAM-000) "`" TEST-VALUE-000 "' is not a valid case option")
       (CL:ERROR (NEW-STELLA-EXCEPTION (THE-STRING-READER STREAM-000)))))))
   (CL:WHEN (CL:AND (CL:NOT (CL:EQ SURROGATE NULL)) (CL:NOT (CL:EQ (%SURROGATE-VALUE SURROGATE) NULL)))
...
(CL:DEFUN AXIOMS (SELF)
  (CL:LET* ((TEST-VALUE-000 (SAFE-PRIMARY-TYPE SELF)))
   (CL:COND
    ((SUBTYPE-OF? TEST-VALUE-000 SGT-LOGIC-IN-LOGIC-LOGIC-OBJECT)
     (CL:PROGN (DYNAMIC-SLOT-VALUE (%DYNAMIC-SLOTS SELF) SYM-LOGIC-IN-LOGIC-OBJECT-AXIOMS NULL)))
    ((SUBTYPE-OF? TEST-VALUE-000 SGT-LOGIC-IN-LOGIC-PROPOSITION)
     (CL:PROGN (DYNAMIC-SLOT-VALUE (%DYNAMIC-SLOTS SELF) SYM-LOGIC-IN-LOGIC-PROPOSITION-AXIOMS NULL)))
    (CL:T
     (CL:LET* ((STREAM-000 (NEW-OUTPUT-STRING-STREAM)))
      (%%PRINT-STREAM (%NATIVE-STREAM STREAM-000) "`" TEST-VALUE-000 "' is not a valid case option")
      (CL:ERROR (NEW-STELLA-EXCEPTION (THE-STRING-READER STREAM-000))))))))
...
(CL:DEFUN AXIOMS-SETTER (SELF AXIOMS)
  (CL:LET* ((TEST-VALUE-000 (SAFE-PRIMARY-TYPE SELF)))
   (CL:COND
    ((SUBTYPE-OF? TEST-VALUE-000 SGT-LOGIC-IN-LOGIC-LOGIC-OBJECT)
     (CL:PROGN (SET-DYNAMIC-SLOT-VALUE (%DYNAMIC-SLOTS SELF) SYM-LOGIC-IN-LOGIC-OBJECT-AXIOMS AXIOMS NULL)))
    ((SUBTYPE-OF? TEST-VALUE-000 SGT-LOGIC-IN-LOGIC-PROPOSITION)
...
(CL:DEFUN DEFINITION-AXIOMS-HANDLER (SELF SLOT THEAXIOMS)
  ...
  (CL:WHEN (STRING? THEAXIOMS)
   (CL:SETQ THEAXIOMS (UNSTRINGIFY-IN-MODULE (%WRAPPER-VALUE THEAXIOMS) (HOME-MODULE SELF))))
...
(CL:DEFUN DEFINITION-HALF-RULE-HANDLER (SELF SLOT BODY)
  (CL:LET*
   ((KEYWORD (DYNAMIC-SLOT-VALUE (%DYNAMIC-SLOTS SLOT) SYM-LOGIC-IN-STELLA-SLOT-OPTION-KEYWORD NULL))
    (ARROW (INTERN-SYMBOL-IN-MODULE (%SYMBOL-NAME KEYWORD) (GET-STELLA-MODULE "PL-KERNEL-KB" CL:T) CL:NIL))
    (NEWRULE NULL))
   (CL:WHEN (CL:EQ BODY NULL)
    (CL:LET* ((STREAM-000 (NEW-OUTPUT-STRING-STREAM)))
     (CL:LET* ((*PRINTREADABLY?* CL:T)) (CL:DECLARE (CL:SPECIAL *PRINTREADABLY?*))
      (%%PRINT-STREAM (%NATIVE-STREAM STREAM-000) "ERROR: Missing value for arrow keyword." EOL)
      (HELP-SIGNAL-PROPOSITION-ERROR STREAM-000 KWD-LOGIC-IN-ERROR))
     (CL:ERROR (NEW-PROPOSITION-ERROR (THE-STRING-READER STREAM-000)))))
   (CL:WHEN (STRING? BODY) (CL:SETQ BODY (UNSTRINGIFY-IN-MODULE (%WRAPPER-VALUE BODY) (HOME-MODULE SELF))))
      ...
      (CL:LET* ((ALWAYS?-000 CL:T))
       (CL:LET* ((ELT NULL) (ITER-000 NEWAXIOMS))
        (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-000 NIL)) DO (CL:SETQ ELT (%%VALUE ITER-000))
         (CL:WHEN (CL:NOT (CONS? ELT)) (CL:SETQ ALWAYS?-000 CL:NIL) (CL:RETURN)) (CL:SETQ ITER-000 (%%REST ITER-000))))
...
(CL:DEFUN YIELD-RELATION-PARAMETERS-TREE (SELF DROPFUNCTIONPARAMETER? TYPED?)
  (CL:LET* ((PARAMETERLIST NIL) (PARAMETER NULL))
   (CL:LET*
    ((PNAME NULL) (ITER-000 (%THE-CONS-LIST (%IO-VARIABLE-NAMES SELF))) (PTYPE NULL)
     (ITER-001 (%THE-CONS-LIST (%IO-VARIABLE-TYPES SELF))))
    (CL:LOOP WHILE (CL:AND (CL:NOT (CL:EQ ITER-000 NIL)) (CL:NOT (CL:EQ ITER-001 NIL))) DO
     (CL:SETQ PNAME (%%VALUE ITER-000)) (CL:SETQ PTYPE (%%VALUE ITER-001)) (CL:SETQ PARAMETER PNAME)
     (CL:WHEN (CL:AND TYPED? (CL:NOT (CL:EQ PTYPE SGT-LOGIC-IN-STELLA-THING)))
      (CL:SETQ PARAMETER
       (CONS PARAMETER (CONS (INTERN-SYMBOL-IN-MODULE (%SYMBOL-NAME PTYPE) (%HOME-CONTEXT PTYPE) CL:T) NIL))))
     (CL:SETQ PARAMETERLIST (CONS PARAMETER PARAMETERLIST)) (CL:SETQ ITER-000 (%%REST ITER-000))
     (CL:SETQ ITER-001 (%%REST ITER-001))))
...
(CL:DEFUN COMPLETE-RULE-DEFINITION (SELF BODY ARROW)
  (CL:LET* ((PARAMETERS (YIELD-RELATION-PARAMETERS-TREE SELF CL:NIL CL:NIL)))
   (LIST* SYM-LOGIC-IN-STELLA-FORALL PARAMETERS
    (CONS
     (CONS ARROW
      (LIST* (CONS (DESCRIPTION-NAME SELF) (CONCATENATE PARAMETERS NIL)) (WRAP-KIF-WITH-FORALL BODY PARAMETERS) NIL))
     NIL))))
  ...
  (CL:LET* ((AXIOMS NIL) (RELATIONNAME (INTERN-SYMBOL (%SYMBOL-NAME KEY))))
   (CL:COND
    ...
    ((CL:AND (SYMBOL? VALUE) (STRING-EQUAL? (%SYMBOL-NAME VALUE) "FALSE"))
     (CL:SETQ AXIOMS (LIST* SYM-LOGIC-IN-STELLA-NOT (CONS RELATIONNAME (CONS SELFNAME NIL)) NIL)))
     ...
     (CL:LET* ((VAL NULL) (ITER-000 VALUE) (COLLECT-000 NULL))
      (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-000 NIL)) DO (CL:SETQ VAL (%%VALUE ITER-000))
       (CL:IF (CL:EQ COLLECT-000 NULL)
        ...
        (CL:PROGN (CL:SETF (%%REST COLLECT-000) (CONS (CONS RELATIONNAME (CONS SELFNAME (CONS VAL NIL))) NIL))
         (CL:SETQ COLLECT-000 (%%REST COLLECT-000))))
       (CL:SETQ ITER-000 (%%REST ITER-000)))))
       ...
       (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-001 NIL)) DO (CL:SETQ P (%%VALUE ITER-001))
        (CL:LET* ((TEST-VALUE-000 (SAFE-PRIMARY-TYPE SELF)))
         (CL:COND
          ...
          ((SUBTYPE-OF? TEST-VALUE-000 SGT-LOGIC-IN-LOGIC-PROPOSITION) (CL:PROGN (LINK-ORIGINATED-PROPOSITION SELF P)))
          (CL:T)))
        (CL:SETQ ITER-001 (%%REST ITER-001))))))
    (CL:SETQ ITER-000 (%%REST ITER-000)))))
...
(CL:DEFUN REGISTER-UNFINALIZED-OBJECT (OBJECT)
  (CL:LET* ((TEST-VALUE-000 (SAFE-PRIMARY-TYPE OBJECT)))
   (CL:COND
    ((SUBTYPE-OF? TEST-VALUE-000 SGT-LOGIC-IN-LOGIC-LOGIC-OBJECT) (CL:PROGN (PUSH *UNFINALIZED-OBJECTS* OBJECT)))
    ((SUBTYPE-OF? TEST-VALUE-000 SGT-LOGIC-IN-LOGIC-PROPOSITION) (CL:PROGN (PUSH *UNFINALIZED-OBJECTS* OBJECT)))
    (CL:T
     (CL:LET* ((STREAM-000 (NEW-OUTPUT-STRING-STREAM)))
      (%%PRINT-STREAM (%NATIVE-STREAM STREAM-000) "INTERNAL ERROR: can't register objects of type `"
        ...
        ((CL:EQ TEST-VALUE-000 SGT-LOGIC-IN-STELLA-CONS)
         (CL:PROGN
          (CL:LET* ((R NULL) (ITER-001 RESULT))
           (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-001 NIL)) DO (CL:SETQ R (%%VALUE ITER-001))
            (CL:SETQ PROPOSITIONS (CONS R PROPOSITIONS)) (CL:SETQ ITER-001 (%%REST ITER-001))))))
        ((SUBTYPE-OF? TEST-VALUE-000 SGT-LOGIC-IN-LOGIC-PROPOSITION)
...
(CL:DEFUN FINALIZE-OBJECT-AXIOMS (SELF)
  (CL:LET* ((*TERMSOURCEBEINGPARSED* STELLA::NULL-STRING) (*LOGIC-DIALECT* KWD-LOGIC-IN-KIF))
     ...
     (CL:COND
      ((SUBTYPE-OF? TEST-VALUE-000 SGT-LOGIC-IN-LOGIC-LOGIC-OBJECT)
       (CL:PROGN (CL:SETQ *TERMSOURCEBEINGPARSED* (STRINGIFIED-SOURCE SELF))
        (CL:WHEN (CL:EQ (AXIOMS SELF) NULL) (CL:RETURN-FROM FINALIZE-OBJECT-AXIOMS))
         ...
         (CL:IF (CL:EQ THEAXIOMS NIL) (CL:RETURN-FROM FINALIZE-OBJECT-AXIOMS)
          (CL:LET* ((P NULL) (ITER-000 THEAXIOMS))
           (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-000 NIL)) DO (CL:SETQ P (%%VALUE ITER-000))
            (LINK-ORIGINATED-PROPOSITION SELF P) (CL:SETQ ITER-000 (%%REST ITER-000))))))
        ...
        (CL:LET* ((THEAXIOMS (HELP-FINALIZE-OBJECT-AXIOMS (AXIOMS SELF))))
         (CL:IF (CL:EQ THEAXIOMS NIL) (CL:RETURN-FROM FINALIZE-OBJECT-AXIOMS)
          (CL:LET* ((P NULL) (ITER-001 THEAXIOMS))
           (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-001 NIL)) DO (CL:SETQ P (%%VALUE ITER-001))
            (LINK-ORIGINATED-PROPOSITION SELF P) (CL:SETQ ITER-001 (%%REST ITER-001))))))
        (AXIOMS-SETTER SELF NULL) (SET-DYNAMIC-SLOT-VALUE (%DYNAMIC-SLOTS SELF) SYM-LOGIC-IN-STELLA-BAD? NULL NULL)))
      (CL:T
       (CL:LET* ((STREAM-000 (NEW-OUTPUT-STRING-STREAM)))
        (%%PRINT-STREAM (%NATIVE-STREAM STREAM-000) "`" TEST-VALUE-000 "' is not a valid case option")
    ...
    (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-000 NIL)) DO (CL:SETQ TYPE (%%VALUE ITER-000))
     (CL:LET* ((CLASS (GET-DESCRIPTION TYPE)))
      (CL:WHEN (CL:EQ CLASS NULL)
       (CL:LET* ((STREAM-000 (NEW-OUTPUT-STRING-STREAM)))
        (CL:LET* ((*PRINTREADABLY?* CL:T)) (CL:DECLARE (CL:SPECIAL *PRINTREADABLY?*))
         (%%PRINT-STREAM (%NATIVE-STREAM STREAM-000) "ERROR: Undefined class `" (%SYMBOL-NAME TYPE)
          "' appears as argument type" EOL "   in the definition of relation `" (DESCRIPTION-NAME SELF) "'." EOL "."
          EOL)
         (HELP-SIGNAL-PROPOSITION-ERROR STREAM-000 KWD-LOGIC-IN-ERROR))
        (CL:ERROR (NEW-PROPOSITION-ERROR (THE-STRING-READER STREAM-000)))))
      (CL:WHEN (CL:NOT (CLASS-DESCRIPTION? CLASS))
       (%%PRINT-STREAM (%NATIVE-STREAM STANDARD-OUTPUT) "Non-class `" (%SYMBOL-NAME TYPE) "' appears as argument type"
        EOL "in the definition of relation `" (DESCRIPTION-NAME SELF) "'." EOL EOL)))
     (CL:SETQ ITER-000 (%%REST ITER-000))))))
  ...
  (CL:HANDLER-CASE
   (CL:LET* ((TEST-VALUE-001 (SAFE-PRIMARY-TYPE SELF)))
    (CL:COND
       ...
       (CL:LET* ((TEST-VALUE-000 CL:NIL))
        (CL:IF (COERCE-WRAPPED-BOOLEAN-TO-BOOLEAN (BAD? SELF)) (CL:SETQ TEST-VALUE-000 CL:T)
         (CL:LET* ((FOUND?-000 CL:NIL))
          (CL:LET* ((TYPE NULL) (ITER-000 (%THE-CONS-LIST (%IO-VARIABLE-TYPES SELF))))
           (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-000 NIL)) DO (CL:SETQ TYPE (%%VALUE ITER-000))
            (CL:WHEN (CL:= (%SYMBOL-ID TYPE) -1) (CL:SETQ FOUND?-000 CL:T) (CL:RETURN))
            (CL:SETQ ITER-000 (%%REST ITER-000))))
     ...
     ((SUBTYPE-OF? TEST-VALUE-001 SGT-LOGIC-IN-LOGIC-LOGIC-OBJECT)
      (CL:PROGN (CL:WHEN (COERCE-WRAPPED-BOOLEAN-TO-BOOLEAN (BAD? SELF)) (CL:RETURN-FROM FINALIZE-OBJECT))
...
The user-level entry point for this is `(process-definitions)'."
  (CL:WHEN
   (CL:OR *INHIBITOBJECTFINALIZATION?* (CL:EQ (%THE-CONS-LIST *UNFINALIZED-OBJECTS*) NIL)
    (CL:NOT (WORLD-STATE? *CONTEXT*)))
   (CL:RETURN-FROM FINALIZE-OBJECTS))
  (CL:LET*
   ((*INHIBITOBJECTFINALIZATION?* CL:T) (*TERMSOURCEBEINGPARSED* STELLA::NULL-STRING)
    (*DESCRIPTIONUNDERCONSTRUCTION* NULL) (*TERMUNDERCONSTRUCTION* NULL))
   (CL:DECLARE
    (CL:SPECIAL *INHIBITOBJECTFINALIZATION?* *TERMSOURCEBEINGPARSED* *DESCRIPTIONUNDERCONSTRUCTION*
   ...
   (CL:LET* ((OBJECT NULL) (ITER-000 (%THE-CONS-LIST (REVERSE *UNFINALIZED-OBJECTS*))))
    (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-000 NIL)) DO (CL:SETQ OBJECT (%%VALUE ITER-000)) (FINALIZE-OBJECT OBJECT)
     (CL:SETQ ITER-000 (%%REST ITER-000))))
...
(CL:DEFUN HELP-DEFINE-RELATION-FROM-PARSE-TREE (TREE STRINGIFIEDSOURCE)
  ...
  (CL:LET*
   ((OPERATOR (%%VALUE TREE)) (NAME (%%VALUE (%%REST TREE))) (PARAMETERS (%%VALUE (%%REST (%%REST TREE))))
    (OPTIONS (NTH-REST TREE 3)) (CLASS? (CL:EQ OPERATOR SYM-LOGIC-IN-LOGIC-DEFCONCEPT))
    (FUNCTION? (CL:EQ OPERATOR SYM-LOGIC-IN-LOGIC-DEFFUNCTION)) (DESCRIPTION NULL))
   ...
   (CL:LET* ((PARAMETERNAMES NULL) (PARAMETERTYPES NULL) (VARIABLEARITY? CL:NIL))
    ...
    (CL:SETQ DESCRIPTION
     (CREATE-PRIMITIVE-DESCRIPTION PARAMETERNAMES PARAMETERTYPES VARIABLEARITY? CLASS? FUNCTION? *MODULE*))
    (CL:SETQ *DESCRIPTIONUNDERCONSTRUCTION* DESCRIPTION) (STRINGIFIED-SOURCE-SETTER DESCRIPTION STRINGIFIEDSOURCE)
    (SET-DYNAMIC-SLOT-VALUE (%DYNAMIC-SLOTS DESCRIPTION) SYM-LOGIC-IN-STELLA-BAD? TRUE-WRAPPER NULL)
    (BIND-LOGIC-OBJECT-TO-SURROGATE NAME DESCRIPTION) (ENSURE-DESCRIPTION-BODY DESCRIPTION)
    (PROCESS-DEFINITION-OPTIONS DESCRIPTION OPTIONS)
    (SET-DYNAMIC-SLOT-VALUE (%DYNAMIC-SLOTS DESCRIPTION) SYM-LOGIC-IN-STELLA-BAD? NULL NULL)
...
(CL:DEFUN PARSE-RELATION-PARAMETERS-TREE (PARAMETERS)
  (CL:WHEN (CL:EQ PARAMETERS NULL)
   (CL:LET* ((STREAM-000 (NEW-OUTPUT-STRING-STREAM)))
    (CL:LET* ((*PRINTREADABLY?* CL:T)) (CL:DECLARE (CL:SPECIAL *PRINTREADABLY?*))
     (%%PRINT-STREAM (%NATIVE-STREAM STREAM-000) "ERROR: Missing concept or relation parameters." EOL)
     (HELP-SIGNAL-PROPOSITION-ERROR STREAM-000 KWD-LOGIC-IN-ERROR))
    (CL:ERROR (NEW-PROPOSITION-ERROR (THE-STRING-READER STREAM-000)))))
  (CL:LET* ((NAME NULL) (TYPE NULL) (PARAMETERNAMES (NEW-LIST)) (PARAMETERTYPES (NEW-LIST)) (VARIABLEARITY? CL:NIL))
   (CL:LET* ((P NULL) (ITER-000 PARAMETERS))
    (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-000 NIL)) DO (CL:SETQ P (%%VALUE ITER-000))
      ...
      (CL:COND
       ((CL:EQ TEST-VALUE-000 SGT-LOGIC-IN-STELLA-CONS)
        (CL:PROGN
         (CL:WHEN (CL:NOT (CL:AND (CL:= (LENGTH P) 2) (SYMBOL? (%%VALUE P)) (SYMBOL? (%%VALUE (%%REST P)))))
          (CL:LET* ((STREAM-001 (NEW-OUTPUT-STRING-STREAM)))
           (CL:LET* ((*PRINTREADABLY?* CL:T)) (CL:DECLARE (CL:SPECIAL *PRINTREADABLY?*))
            (%%PRINT-STREAM (%NATIVE-STREAM STREAM-001) "ERROR: Illegal parameter: `" P "'." EOL)
            (HELP-SIGNAL-PROPOSITION-ERROR STREAM-001 KWD-LOGIC-IN-ERROR))
           (CL:ERROR (NEW-PROPOSITION-ERROR (THE-STRING-READER STREAM-001)))))
       ...
       (CL:T
        (CL:LET* ((STREAM-004 (NEW-OUTPUT-STRING-STREAM)))
         (CL:LET* ((*PRINTREADABLY?* CL:T)) (CL:DECLARE (CL:SPECIAL *PRINTREADABLY?*))
          (%%PRINT-STREAM (%NATIVE-STREAM STREAM-004) "ERROR: Illegal parameter: `" P "'." EOL)
     ...
     (PUSH PARAMETERNAMES NAME) (PUSH PARAMETERTYPES (COERCE-TO-BOUND-OR-LOCAL-SURROGATE TYPE))
     (CL:WHEN VARIABLEARITY? (CL:RETURN)) (CL:SETQ ITER-000 (%%REST ITER-000))))
   (CL:WHEN (CL:EQ PARAMETERTYPES NULL)
    (CL:LET* ((STREAM-006 (NEW-OUTPUT-STRING-STREAM)))
     (CL:LET* ((*PRINTREADABLY?* CL:T)) (CL:DECLARE (CL:SPECIAL *PRINTREADABLY?*))
      (%%PRINT-STREAM (%NATIVE-STREAM STREAM-006) "ERROR: Missing relation parameter list." EOL)
   ...
   (CL:WHEN (EMPTY? PARAMETERTYPES)
    (CL:LET* ((STREAM-007 (NEW-OUTPUT-STRING-STREAM)))
     (CL:LET* ((*PRINTREADABLY?* CL:T)) (CL:DECLARE (CL:SPECIAL *PRINTREADABLY?*))
      (%%PRINT-STREAM (%NATIVE-STREAM STREAM-007) "ERROR: Empty relation parameter list." EOL)
...
(CL:DEFUN GET-IDENTICAL-RELATION (NAME STRINGIFIEDSOURCE)
  ...
  (CL:LET*
   ((SURROGATE (LOOKUP-LOGIC-OBJECT-SURROGATE NAME *MODULE*))
    (SURROGATEVALUE (CL:IF (CL:NOT (CL:EQ SURROGATE NULL)) (%SURROGATE-VALUE SURROGATE) NULL)) (DESCRIPTION NULL))
   (CL:WHEN (CL:AND (CL:NOT (CL:EQ SURROGATEVALUE NULL)) (ISA? SURROGATEVALUE SGT-LOGIC-IN-LOGIC-NAMED-DESCRIPTION))
  ...
  (CL:LET* ((KEY NULL) (VALUE NULL) (ITER-000 (%THE-PLIST (VET-OPTIONS OPTIONS NULL))))
   (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-000 NIL)) DO (CL:SETQ KEY (%%VALUE ITER-000))
    ...
    (CL:WHEN (CL:NOT (RUN-OPTION-HANDLER? SELF KEY VALUE))
     (DEFINITION-KEYWORD-AXIOMS-HANDLER SELF (DESCRIPTION-NAME SELF) KEY VALUE))
    (CL:SETQ ITER-000 (%%REST (%%REST ITER-000)))))
  (CL:WHEN (CL:NOT (CLASS? SELF))
   (CL:LET*
    ((NAME (DESCRIPTION-NAME SELF)) (IOVARIABLES (%IO-VARIABLES SELF)) (IOVARIABLETYPES (%IO-VARIABLE-TYPES SELF))
     (THEAXIOMS (AXIOMS SELF)) (TYPEDARGUMENTS NIL) (OPERATOR NULL) (FIRSTARG NULL) (ARGUMENTTYPEAXIOMS NIL))
       ...
       (CL:COND
        ((CL:EQ (SAFE-PRIMARY-TYPE AXIOM) SGT-LOGIC-IN-STELLA-CONS)
         (CL:PROGN (CL:SETQ OPERATOR (%%VALUE AXIOM)) (CL:SETQ FIRSTARG (%%VALUE (%%REST AXIOM)))
          (CL:COND
           ((CL:AND (CL:EQ OPERATOR SYM-LOGIC-IN-PL-KERNEL-KB-NTH-DOMAIN) (CL:EQ FIRSTARG NAME)
             (INTEGER? (%%VALUE (%%REST (%%REST AXIOM)))))
            (CL:SETQ TYPEDARGUMENTS
             (CONS
              (CL:AREF (CL:THE CL:SIMPLE-VECTOR (%THE-ARRAY IOVARIABLES))
               (CL:THE CL:FIXNUM (%WRAPPER-VALUE (%%VALUE (%%REST (%%REST AXIOM))))))
              TYPEDARGUMENTS)))
           ((CL:AND (CL:EQ OPERATOR SYM-LOGIC-IN-PL-KERNEL-KB-DOMAIN) (CL:EQ FIRSTARG NAME))
            (CL:SETQ TYPEDARGUMENTS
             (CONS (CL:AREF (CL:THE CL:SIMPLE-VECTOR (%THE-ARRAY IOVARIABLES)) 0) TYPEDARGUMENTS)))
           ((CL:AND (CL:EQ OPERATOR SYM-LOGIC-IN-PL-KERNEL-KB-RANGE) (CL:EQ FIRSTARG NAME))
            (CL:SETQ TYPEDARGUMENTS (CONS (LAST IOVARIABLES) TYPEDARGUMENTS))))))
        (CL:T))
       (CL:SETQ ITER-001 (%%REST ITER-001)))))
    (CL:LET*
     ((TYPE NULL) (ITER-002 (%THE-CONS-LIST IOVARIABLETYPES)) (VAR NULL) (VECTOR-000 IOVARIABLES) (INDEX-000 0)
      (LENGTH-000 (LENGTH VECTOR-000)) (I NULL-INTEGER) (ITER-003 0) (COLLECT-000 NULL))
     (CL:DECLARE (CL:TYPE CL:FIXNUM INDEX-000 LENGTH-000 I ITER-003))
     (CL:LOOP WHILE (CL:AND (CL:NOT (CL:EQ ITER-002 NIL)) (CL:< INDEX-000 LENGTH-000)) DO
      ...
      (CL:WHEN
       (CL:AND (CL:NOT (CL:EQ TYPE NULL))
        (CL:OR (CL:NOT (CL:EQ TYPE SGT-LOGIC-IN-STELLA-THING)) (CL:NOT (MEMB? TYPEDARGUMENTS VAR))))
       (CL:IF (CL:EQ COLLECT-000 NULL)
        (CL:PROGN
         (CL:SETQ COLLECT-000
          (CONS
           (LIST* SYM-LOGIC-IN-PL-KERNEL-KB-NTH-DOMAIN NAME
            (CONS (WRAP-INTEGER I)
             (CONS (INTERN-SYMBOL-IN-MODULE (%SYMBOL-NAME TYPE) (%HOME-CONTEXT TYPE) CL:NIL) NIL)))
           NIL))
         (CL:IF (CL:EQ ARGUMENTTYPEAXIOMS NIL) (CL:SETQ ARGUMENTTYPEAXIOMS COLLECT-000)
...
Expects the same arguments as `deffunction' but supplied as a list."
  (CL:LET* ((DEFINITION (CONS SYM-LOGIC-IN-LOGIC-DEFFUNCTION (CONCATENATE ARGUMENTS NIL))))
   (CL:LET* ((*TERMSOURCEBEINGPARSED* (STRINGIFY DEFINITION)) (*DESCRIPTIONUNDERCONSTRUCTION* NULL))
    (CL:DECLARE (CL:SPECIAL *TERMSOURCEBEINGPARSED* *DESCRIPTIONUNDERCONSTRUCTION*))
    (CL:DECLARE (CL:TYPE CL:SIMPLE-STRING *TERMSOURCEBEINGPARSED*))
...
(CL:DEFUN NORMALIZE-DEFFUNCTION-ARGUMENTS (ARGUMENTS)
  (CL:LET* ((NAME (%%VALUE ARGUMENTS)) (PARAMETERS (%%VALUE (%%REST ARGUMENTS))) (OPTIONS (%%REST (%%REST ARGUMENTS))))
   (CL:WHEN (CL:NOT (SYMBOL? NAME))
    (CL:LET* ((STREAM-000 (NEW-OUTPUT-STRING-STREAM)))
     (CL:LET* ((*PRINTREADABLY?* CL:T)) (CL:DECLARE (CL:SPECIAL *PRINTREADABLY?*))
      (%%PRINT-STREAM (%NATIVE-STREAM STREAM-000) "ERROR: Illegal function name where symbol expected: `" NAME "'."
       EOL)
      (HELP-SIGNAL-PROPOSITION-ERROR STREAM-000 KWD-LOGIC-IN-ERROR))
     (CL:ERROR (NEW-PROPOSITION-ERROR (THE-STRING-READER STREAM-000)))))
   (CL:COND
     ...
     (CL:PROGN
      (CL:LOOP WHILE (CL:NOT (CL:EQ OPTIONS NIL)) DO
       (CL:WHEN (CL:AND (CL:EQ (%%VALUE OPTIONS) KWD-LOGIC-IN-->) (CL:NOT (CL:EQ (%%VALUE (%%REST OPTIONS)) NULL)))
        (CL:SETQ PARAMETERS (CONCATENATE PARAMETERS (CONS (%%VALUE (%%REST OPTIONS)) NIL)))
        (SECOND-SETTER ARGUMENTS PARAMETERS) (FIRST-SETTER OPTIONS NULL) (SECOND-SETTER OPTIONS NULL)
        (CL:SETQ OPTIONS (REMOVE (%%REST (%%REST ARGUMENTS)) NULL)) (CL:SETF (%%REST (%%REST ARGUMENTS)) OPTIONS)
        (CL:RETURN))
       (CL:SETQ OPTIONS (%%REST (%%REST OPTIONS))))
      (CL:WHEN (CL:EQ PARAMETERS NIL)
       (CL:LET* ((STREAM-001 (NEW-OUTPUT-STRING-STREAM)))
        (CL:LET* ((*PRINTREADABLY?* CL:T)) (CL:DECLARE (CL:SPECIAL *PRINTREADABLY?*))
         (%%PRINT-STREAM (%NATIVE-STREAM STREAM-001) "ERROR: Cannot have 0-arity functions." EOL)
         (HELP-SIGNAL-PROPOSITION-ERROR STREAM-001 KWD-LOGIC-IN-ERROR))
        (CL:ERROR (NEW-PROPOSITION-ERROR (THE-STRING-READER STREAM-001)))))))
    (CL:T
     (CL:LET* ((STREAM-002 (NEW-OUTPUT-STRING-STREAM)))
      (CL:LET* ((*PRINTREADABLY?* CL:T)) (CL:DECLARE (CL:SPECIAL *PRINTREADABLY?*))
       (%%PRINT-STREAM (%NATIVE-STREAM STREAM-002) "ERROR: Illegal parameter list: `" PARAMETERS "'." EOL)
       (HELP-SIGNAL-PROPOSITION-ERROR STREAM-002 KWD-LOGIC-IN-ERROR))
      (CL:ERROR (NEW-PROPOSITION-ERROR (THE-STRING-READER STREAM-002))))))
   ARGUMENTS))
...
(CL:DEFUN NORMALIZE-DEFRELATION-ARGUMENTS (ARGUMENTS)
  (CL:LET* ((NAME (%%VALUE ARGUMENTS)) (PARAMETERS (%%VALUE (%%REST ARGUMENTS))) (OPTIONS (%%REST (%%REST ARGUMENTS))))
   (CL:WHEN (CL:NOT (SYMBOL? NAME))
    (CL:LET* ((STREAM-000 (NEW-OUTPUT-STRING-STREAM)))
     (CL:LET* ((*PRINTREADABLY?* CL:T)) (CL:DECLARE (CL:SPECIAL *PRINTREADABLY?*))
      (%%PRINT-STREAM (%NATIVE-STREAM STREAM-000) "ERROR: Illegal relation name where symbol expected: `" NAME "'."
       EOL)
      (HELP-SIGNAL-PROPOSITION-ERROR STREAM-000 KWD-LOGIC-IN-ERROR))
     (CL:ERROR (NEW-PROPOSITION-ERROR (THE-STRING-READER STREAM-000)))))
   (CL:WHEN (CL:NOT (CONS? PARAMETERS))
    (CL:LET* ((STREAM-001 (NEW-OUTPUT-STRING-STREAM)))
     (CL:LET* ((*PRINTREADABLY?* CL:T)) (CL:DECLARE (CL:SPECIAL *PRINTREADABLY?*))
      (%%PRINT-STREAM (%NATIVE-STREAM STREAM-001) "ERROR: Illegal parameter list: `" PARAMETERS "'." EOL)
      (HELP-SIGNAL-PROPOSITION-ERROR STREAM-001 KWD-LOGIC-IN-ERROR))
     (CL:ERROR (NEW-PROPOSITION-ERROR (THE-STRING-READER STREAM-001)))))
   (CL:WHEN (CL:EQ PARAMETERS NIL)
    (CL:LET* ((STREAM-002 (NEW-OUTPUT-STRING-STREAM)))
     (CL:LET* ((*PRINTREADABLY?* CL:T)) (CL:DECLARE (CL:SPECIAL *PRINTREADABLY?*))
      (%%PRINT-STREAM (%NATIVE-STREAM STREAM-002) "ERROR: Cannot have 0-arity relations." EOL)
      (HELP-SIGNAL-PROPOSITION-ERROR STREAM-002 KWD-LOGIC-IN-ERROR))
     (CL:ERROR (NEW-PROPOSITION-ERROR (THE-STRING-READER STREAM-002)))))
   (CL:WHEN (MEMBER? OPTIONS KWD-LOGIC-IN-->)
    (CL:LET* ((STREAM-003 (NEW-OUTPUT-STRING-STREAM)))
     (CL:LET* ((*PRINTREADABLY?* CL:T)) (CL:DECLARE (CL:SPECIAL *PRINTREADABLY?*))
      (%%PRINT-STREAM (%NATIVE-STREAM STREAM-003) "ERROR: 'defrelation' does not allow a return value (':->') clause."
       EOL)
      (HELP-SIGNAL-PROPOSITION-ERROR STREAM-003 KWD-LOGIC-IN-ERROR))
     (CL:ERROR (NEW-PROPOSITION-ERROR (THE-STRING-READER STREAM-003)))))
   ARGUMENTS))
...
(CL:DEFUN NORMALIZE-DEFCONCEPT-ARGUMENTS (ARGUMENTS)
  (CL:LET*
   ((NAME (%%VALUE ARGUMENTS)) (PARAMETERS NULL) (SELFVARIABLE SYM-LOGIC-IN-LOGIC-?SELF) (SUPERS NIL)
    (IMPLIESRULES NIL))
   (CL:WHEN (CL:NOT (SYMBOL? NAME))
    (CL:LET* ((STREAM-000 (NEW-OUTPUT-STRING-STREAM)))
     (CL:LET* ((*PRINTREADABLY?* CL:T)) (CL:DECLARE (CL:SPECIAL *PRINTREADABLY?*))
   ...
   (CL:COND
    ((CL:NOT (CL:EQ PARAMETERS NULL)) (CL:WHEN (CONS? (%%VALUE PARAMETERS)) (CL:SETQ PARAMETERS (%%VALUE PARAMETERS)))
     (CL:COND ((CL:EQ PARAMETERS NIL) (CL:SETQ SUPERS NIL))
      ((QUESTION-MARK-SYMBOL? (%%VALUE PARAMETERS)) (CL:SETQ SELFVARIABLE (%%VALUE PARAMETERS))
       (CL:SETQ SUPERS (%%REST PARAMETERS)))
      ((SYMBOL? (%%VALUE PARAMETERS)) (CL:SETQ SUPERS PARAMETERS))
      (CL:T
       (CL:LET* ((STREAM-001 (NEW-OUTPUT-STRING-STREAM)))
        (CL:LET* ((*PRINTREADABLY?* CL:T)) (CL:DECLARE (CL:SPECIAL *PRINTREADABLY?*))
         (%%PRINT-STREAM (%NATIVE-STREAM STREAM-001) "ERROR: Illegal parameter list: `" (%%VALUE (%%REST ARGUMENTS))
          "'." EOL)
         (HELP-SIGNAL-PROPOSITION-ERROR STREAM-001 KWD-LOGIC-IN-ERROR))
        (CL:ERROR (NEW-PROPOSITION-ERROR (THE-STRING-READER STREAM-001))))))
     (CL:LET* ((SUPER NULL) (ITER-000 SUPERS))
      (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-000 NIL)) DO (CL:SETQ SUPER (%%VALUE ITER-000))
       ...
       (CL:SETQ IMPLIESRULES (CONS (CONS SUPER (CONS SELFVARIABLE NIL)) IMPLIESRULES))
       (CL:SETQ ITER-000 (%%REST ITER-000))))
     (CL:SETQ IMPLIESRULES (REVERSE IMPLIESRULES))
     (CL:SETF (%%REST ARGUMENTS)
      (CONS (CONS (CONS SELFVARIABLE (CONS NAME NIL)) NIL)
       (CONCATENATE IMPLIESRULES (CONCATENATE (%%REST (%%REST ARGUMENTS)) NIL)))))
    ((CL:EQ (%%REST ARGUMENTS) NIL)
     (CL:SETF (%%REST ARGUMENTS) (CONS (CONS (CONS SELFVARIABLE (CONS NAME NIL)) NIL) NIL)))
    ((KEYWORD? (%%VALUE (%%REST ARGUMENTS)))
     (CL:SETF (%%REST (%%REST ARGUMENTS))
      (CONS (%%VALUE (%%REST ARGUMENTS)) (CONCATENATE (%%REST (%%REST ARGUMENTS)) NIL)))
...
Expects the same arguments as `defobject' but supplied as a list."
  (CL:LET*
   ((DEFINITION (CONS SYM-LOGIC-IN-LOGIC-DEFOBJECT (CONCATENATE ARGUMENTS NIL))) (NAME NULL) (OPTIONS NIL) (TERM NULL))
   (CL:LET* ((*TERMSOURCEBEINGPARSED* (STRINGIFY DEFINITION))) (CL:DECLARE (CL:SPECIAL *TERMSOURCEBEINGPARSED*))
    (CL:DECLARE (CL:TYPE CL:SIMPLE-STRING *TERMSOURCEBEINGPARSED*))
    (CL:SETQ ARGUMENTS (NORMALIZE-DEFOBJECT-ARGUMENTS ARGUMENTS)) (CL:SETQ OPTIONS (%%REST ARGUMENTS))
    (CL:COND
     ((CONS? (%%VALUE ARGUMENTS)) (CL:SETQ NAME (INTERN-SYMBOL (STRINGIFY (%%VALUE ARGUMENTS))))
      ...
      (CL:WHEN (CL:EQ TERM NULL)
       (CL:LET* ((STREAM-000 (NEW-OUTPUT-STRING-STREAM)))
        (CL:LET* ((*PRINTREADABLY?* CL:T)) (CL:DECLARE (CL:SPECIAL *PRINTREADABLY?*))
         ...
         (HELP-SIGNAL-PROPOSITION-ERROR STREAM-000 KWD-LOGIC-IN-ERROR))
        (CL:ERROR (NEW-PROPOSITION-ERROR (THE-STRING-READER STREAM-000))))))
     (CL:T (CL:SETQ NAME (%%VALUE ARGUMENTS)) (INTERN-LOGIC-OBJECT-SURROGATE NAME)
      (CL:SETQ TERM (CREATE-LOGIC-INSTANCE NULL NULL))))
    (CL:COND
     ((SUBTYPE-OF? (SAFE-PRIMARY-TYPE TERM) SGT-LOGIC-IN-LOGIC-LOGIC-OBJECT)
      (CL:PROGN (STRINGIFIED-SOURCE-SETTER TERM *TERMSOURCEBEINGPARSED*) (BIND-LOGIC-OBJECT-TO-SURROGATE NAME TERM)
       (PROCESS-DEFINITION-OPTIONS TERM OPTIONS) (REGISTER-UNFINALIZED-OBJECT TERM)))
     (CL:T (BIND-LOGIC-OBJECT-TO-SURROGATE NAME TERM)
      (CL:LET* ((KEY NULL) (VALUE NULL) (ITER-000 (%THE-PLIST (VET-OPTIONS OPTIONS NULL))))
       (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-000 NIL)) DO (CL:SETQ KEY (%%VALUE ITER-000))
        (CL:SETQ VALUE (%%VALUE (%%REST ITER-000))) (ASSERT-KEYWORD-AXIOM TERM NAME KEY VALUE)
        (CL:SETQ ITER-000 (%%REST (%%REST ITER-000)))))))
    TERM)))
    ...
    (CL:LET* ((STREAM-000 (NEW-OUTPUT-STRING-STREAM)))
     (CL:LET* ((*PRINTREADABLY?* CL:T)) (CL:DECLARE (CL:SPECIAL *PRINTREADABLY?*))
      (%%PRINT-STREAM (%NATIVE-STREAM STREAM-000)
       "ERROR: Illegal object name where symbol or function term expected: `" NAME "'." EOL)
      (HELP-SIGNAL-PROPOSITION-ERROR STREAM-000 KWD-LOGIC-IN-ERROR))
     (CL:ERROR (NEW-PROPOSITION-ERROR (THE-STRING-READER STREAM-000)))))
...
Expects the same arguments as `defproposition' but supplied as a list."
  (CL:LET*
   ((DEFINITION (CONS SYM-LOGIC-IN-LOGIC-DEFPROPOSITION (CONCATENATE ARGUMENTS NIL))) (NAME NULL) (OPTIONS NIL)
    (CONCEPTION NULL) (PROPOSITION NULL) (OLDTRUTHVALUE NULL))
   (CL:LET* ((*TERMSOURCEBEINGPARSED* (STRINGIFY DEFINITION))) (CL:DECLARE (CL:SPECIAL *TERMSOURCEBEINGPARSED*))
    (CL:DECLARE (CL:TYPE CL:SIMPLE-STRING *TERMSOURCEBEINGPARSED*))
    (CL:SETQ ARGUMENTS (NORMALIZE-DEFPROPOSITION-ARGUMENTS ARGUMENTS)) (CL:SETQ NAME (%%VALUE ARGUMENTS))
    (INTERN-LOGIC-OBJECT-SURROGATE NAME)
    (CL:SETQ CONCEPTION (SMART-UPDATE-PROPOSITION (%%VALUE (%%REST ARGUMENTS)) KWD-LOGIC-IN-CONCEIVE))
    (CL:COND ((CL:EQ CONCEPTION NULL) (CL:RETURN-FROM CALL-DEFPROPOSITION NULL))
     ((CONS? CONCEPTION) (CL:SETQ PROPOSITION (CONJOIN-PROPOSITIONS CONCEPTION))
    ...
    (SET-DYNAMIC-SLOT-VALUE (%DYNAMIC-SLOTS PROPOSITION) SYM-LOGIC-IN-STELLA-BAD? TRUE-WRAPPER NULL)
    (BIND-LOGIC-OBJECT-TO-SURROGATE NAME PROPOSITION) (PROCESS-DEFINITION-OPTIONS PROPOSITION OPTIONS)
    (CL:WHEN (CL:EQ (%KIND PROPOSITION) KWD-LOGIC-IN-FORALL)
     (CL:LET* ((SATELLITE NULL) (ITER-000 (%THE-CONS-LIST (SATELLITE-PROPOSITIONS PROPOSITION))))
      (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-000 NIL)) DO (CL:SETQ SATELLITE (%%VALUE ITER-000))
       (DESTROY-PROPOSITION SATELLITE) (CL:SETQ ITER-000 (%%REST ITER-000))))
    ...
    (CL:COND
     ((CL:EQ (LOOKUP-ANNOTATION PROPOSITION KWD-LOGIC-IN-CONFIDENCE-LEVEL) KWD-LOGIC-IN-DEFAULT)
    ...
    (CL:WHEN (CL:EQ OLDTRUTHVALUE (ACCESS-IN-CONTEXT (%TRUTH-VALUE PROPOSITION) (%HOME-CONTEXT PROPOSITION) CL:NIL))
     (RUN-GOES-TRUE-DEMONS PROPOSITION))
    (SET-DYNAMIC-SLOT-VALUE (%DYNAMIC-SLOTS PROPOSITION) SYM-LOGIC-IN-STELLA-BAD? NULL NULL)
...
(CL:DEFUN NORMALIZE-DEFPROPOSITION-ARGUMENTS (ARGUMENTS)
  (CL:LET*
   ((NAME (%%VALUE ARGUMENTS)) (PROPOSITION (%%VALUE (%%REST ARGUMENTS))) (OPTIONS NULL) (VALUE NULL)
    (ANNOTATIONS NIL))
   (CL:LET* ((TEST-VALUE-000 (SAFE-PRIMARY-TYPE (%%VALUE ARGUMENTS))))
    (CL:COND ((SUBTYPE-OF-SYMBOL? TEST-VALUE-000))
     ((SUBTYPE-OF-STRING? TEST-VALUE-000) (CL:SETQ NAME (INTERN-SYMBOL (%WRAPPER-VALUE (%%VALUE ARGUMENTS))))
      (FIRST-SETTER ARGUMENTS NAME))
     (CL:T
      (CL:LET* ((STREAM-000 (NEW-OUTPUT-STRING-STREAM)))
       (CL:LET* ((*PRINTREADABLY?* CL:T)) (CL:DECLARE (CL:SPECIAL *PRINTREADABLY?*))
        (%%PRINT-STREAM (%NATIVE-STREAM STREAM-000)
         "ERROR: Illegal proposition name where symbol or string expected: `" NAME "'." EOL)
        (HELP-SIGNAL-PROPOSITION-ERROR STREAM-000 KWD-LOGIC-IN-ERROR))
       (CL:ERROR (NEW-PROPOSITION-ERROR (THE-STRING-READER STREAM-000)))))))
   (CL:SETQ OPTIONS (VET-OPTIONS (%%REST (%%REST ARGUMENTS)) NULL))
   (CL:SETQ VALUE (LOOKUP OPTIONS KWD-LOGIC-IN-FORWARD?))
   (CL:WHEN (CL:NOT (CL:EQ VALUE NULL)) (REMOVE-AT OPTIONS KWD-LOGIC-IN-FORWARD?)
    (INSERT-AT OPTIONS KWD-LOGIC-IN-FORWARD-ONLY? VALUE))
   (CL:SETQ VALUE (LOOKUP OPTIONS KWD-LOGIC-IN-BACKWARD?))
   (CL:WHEN (CL:NOT (CL:EQ VALUE NULL)) (REMOVE-AT OPTIONS KWD-LOGIC-IN-BACKWARD?)
   ...
   (CL:WHEN (CL:NOT (CL:EQ VALUE NULL))
    (CL:SETQ ANNOTATIONS (CONCATENATE ANNOTATIONS (LIST* KWD-LOGIC-IN-CONFIDENCE-LEVEL VALUE NIL)))
    (REMOVE-AT OPTIONS KWD-LOGIC-IN-CONFIDENCE-LEVEL))
   (CL:SETQ VALUE (LOOKUP OPTIONS KWD-LOGIC-IN-WEIGHT))
   (CL:WHEN (CL:NOT (CL:EQ VALUE NULL))
    (CL:SETQ ANNOTATIONS (CONCATENATE ANNOTATIONS (LIST* KWD-LOGIC-IN-WEIGHT VALUE NIL)))
    (REMOVE-AT OPTIONS KWD-LOGIC-IN-WEIGHT))
   (CL:WHEN (CL:NOT (CL:EQ ANNOTATIONS NIL))
    (SECOND-SETTER ARGUMENTS (LIST* SYM-LOGIC-IN-LOGIC-ABOUT PROPOSITION (CONCATENATE ANNOTATIONS NIL))))
   ...
   (CL:LET* ((FUNCTION NULL) (ITER-000 (ALL-FUNCTIONS (GET-STELLA-MODULE "/LOGIC" CL:T) CL:T)) (COLLECT-000 NULL))
    (CL:LOOP WHILE (NEXT? ITER-000) DO (CL:SETQ FUNCTION (%VALUE ITER-000))
     (CL:WHEN
      (CL:AND
       (%WRAPPER-VALUE
        (DYNAMIC-SLOT-VALUE (%DYNAMIC-SLOTS FUNCTION) SYM-LOGIC-IN-STELLA-METHOD-COMMAND? FALSE-WRAPPER))
       (PUBLIC? FUNCTION))
      (CL:IF (CL:EQ COLLECT-000 NULL)
   ...
   (CL:LET* ((STELLACOMMAND NULL) (ITER-001 *LOGIC-RELEVANT-STELLA-COMMANDS*) (COLLECT-001 NULL))
    (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-001 NIL)) DO (CL:SETQ STELLACOMMAND (%%VALUE ITER-001))
     (CL:IF (CL:EQ COLLECT-001 NULL)
      ...
      (CL:PROGN (CL:SETF (%%REST COLLECT-001) (CONS (LOOKUP-COMMAND STELLACOMMAND) NIL))
  ...
  (CL:LET* ((THECOMMANDS COMMANDS))
   (CL:COND
    ((CL:EQ THECOMMANDS NIL)
     (%%PRINT-STREAM (%NATIVE-STREAM STANDARD-OUTPUT) "The following commands are available (type `(help <command>+)'"
       ...
       (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-000 NIL)) DO (CL:SETQ COMMAND (%%VALUE ITER-000))
        (CL:WHEN
         (CL:NOT
          (CL:EQ
           (%WRAPPER-VALUE
            (DYNAMIC-SLOT-VALUE (%DYNAMIC-SLOTS COMMAND) SYM-LOGIC-IN-STELLA-DOCUMENTATION NULL-STRING-WRAPPER))
           STELLA::NULL-STRING))
...
(CL:DEFUN HELP-STARTUP-LOGIC-IN1 ()
  (CL:PROGN (CL:SETQ KWD-LOGIC-IN-TRACE-SUBGOALS (INTERN-RIGID-SYMBOL-WRT-MODULE "TRACE-SUBGOALS" NULL 2))
   ...
   (CL:SETQ KWD-LOGIC-IN-REALISTIC (INTERN-RIGID-SYMBOL-WRT-MODULE "REALISTIC" NULL 2))
   ...
   (CL:SETQ SYM-LOGIC-IN-STELLA-DEFMODULE
    (INTERN-RIGID-SYMBOL-WRT-MODULE "DEFMODULE" (GET-STELLA-MODULE "/STELLA" CL:T) 0))
   ...
   (CL:SETQ SYM-LOGIC-IN-STELLA-CLEAR-MODULE
    (INTERN-RIGID-SYMBOL-WRT-MODULE "CLEAR-MODULE" (GET-STELLA-MODULE "/STELLA" CL:T) 0))
   (CL:SETQ SYM-LOGIC-IN-STELLA-DEFCLASS
    (INTERN-RIGID-SYMBOL-WRT-MODULE "DEFCLASS" (GET-STELLA-MODULE "/STELLA" CL:T) 0))
   (CL:SETQ SYM-LOGIC-IN-STELLA-DEFSLOT
    (INTERN-RIGID-SYMBOL-WRT-MODULE "DEFSLOT" (GET-STELLA-MODULE "/STELLA" CL:T) 0))
   ...
   (CL:SETQ SYM-LOGIC-IN-STELLA-DEFMETHOD
    (INTERN-RIGID-SYMBOL-WRT-MODULE "DEFMETHOD" (GET-STELLA-MODULE "/STELLA" CL:T) 0))
   ...
   (CL:SETQ SYM-LOGIC-IN-LOGIC-IN-DIALECT (INTERN-RIGID-SYMBOL-WRT-MODULE "IN-DIALECT" NULL 0))
   ...
   (CL:SETQ SYM-LOGIC-IN-LOGIC-DEMO (INTERN-RIGID-SYMBOL-WRT-MODULE "DEMO" NULL 0))
   (CL:SETQ KWD-LOGIC-IN-LEVEL (INTERN-RIGID-SYMBOL-WRT-MODULE "LEVEL" NULL 2))
   ...
   (CL:SETQ KWD-LOGIC-IN-ERROR (INTERN-RIGID-SYMBOL-WRT-MODULE "ERROR" NULL 2))
   (CL:SETQ KWD-LOGIC-IN-WARNING (INTERN-RIGID-SYMBOL-WRT-MODULE "WARNING" NULL 2))
...
(CL:DEFUN HELP-STARTUP-LOGIC-IN2 ()
  (CL:PROGN (CL:SETQ SGT-LOGIC-IN-LOGIC-DESCRIPTION (INTERN-RIGID-SYMBOL-WRT-MODULE "DESCRIPTION" NULL 1))
   ...
   (CL:SETQ SYM-LOGIC-IN-STELLA-SLOT-OPTION-KEYWORD
    (INTERN-RIGID-SYMBOL-WRT-MODULE "SLOT-OPTION-KEYWORD" (GET-STELLA-MODULE "/STELLA" CL:T) 0))
   ...
   (CL:SETQ SYM-LOGIC-IN-PL-KERNEL-KB-NTH-DOMAIN
    (INTERN-RIGID-SYMBOL-WRT-MODULE "NTH-DOMAIN" (GET-STELLA-MODULE "/PL-KERNEL-KB" CL:T) 0))
   (CL:SETQ SYM-LOGIC-IN-PL-KERNEL-KB-DOMAIN
    (INTERN-RIGID-SYMBOL-WRT-MODULE "DOMAIN" (GET-STELLA-MODULE "/PL-KERNEL-KB" CL:T) 0))
   (CL:SETQ SYM-LOGIC-IN-PL-KERNEL-KB-RANGE
    (INTERN-RIGID-SYMBOL-WRT-MODULE "RANGE" (GET-STELLA-MODULE "/PL-KERNEL-KB" CL:T) 0))
   (CL:SETQ KWD-LOGIC-IN--> (INTERN-RIGID-SYMBOL-WRT-MODULE "->" NULL 2))
   (CL:SETQ SYM-LOGIC-IN-LOGIC-?SELF (INTERN-RIGID-SYMBOL-WRT-MODULE "?SELF" NULL 0))
   (CL:SETQ KWD-LOGIC-IN-=> (INTERN-RIGID-SYMBOL-WRT-MODULE "=>" NULL 2))
   ...
   (CL:SETQ KWD-LOGIC-IN-CONCEIVE (INTERN-RIGID-SYMBOL-WRT-MODULE "CONCEIVE" NULL 2))
   (CL:SETQ KWD-LOGIC-IN-FORALL (INTERN-RIGID-SYMBOL-WRT-MODULE "FORALL" NULL 2))
   ...
   (CL:SETQ KWD-LOGIC-IN-WEIGHT (INTERN-RIGID-SYMBOL-WRT-MODULE "WEIGHT" NULL 2))
   (CL:SETQ SYM-LOGIC-IN-LOGIC-ABOUT (INTERN-RIGID-SYMBOL-WRT-MODULE "ABOUT" NULL 0))
   ...
   (CL:SETQ SYM-LOGIC-IN-STELLA-IN-MODULE
    (INTERN-RIGID-SYMBOL-WRT-MODULE "IN-MODULE" (GET-STELLA-MODULE "/STELLA" CL:T) 0))
   (CL:SETQ SYM-LOGIC-IN-STELLA-LIST-MODULES
    (INTERN-RIGID-SYMBOL-WRT-MODULE "LIST-MODULES" (GET-STELLA-MODULE "/STELLA" CL:T) 0))
   (CL:SETQ SYM-LOGIC-IN-STELLA-METHOD-COMMAND?
    (INTERN-RIGID-SYMBOL-WRT-MODULE "METHOD-COMMAND?" (GET-STELLA-MODULE "/STELLA" CL:T) 0))
   (CL:SETQ SYM-LOGIC-IN-STELLA-DOCUMENTATION
    (INTERN-RIGID-SYMBOL-WRT-MODULE "DOCUMENTATION" (GET-STELLA-MODULE "/STELLA" CL:T) 0))
...
(CL:DEFUN HELP-STARTUP-LOGIC-IN3 ()
  (CL:PROGN
   (CL:SETQ *AVAILABLE-POWERLOOM-FEATURES*
    (LIST KWD-LOGIC-IN-TRACE-SUBGOALS KWD-LOGIC-IN-TRACE-SOLUTIONS KWD-LOGIC-IN-TRACE-CLASSIFIER
     KWD-LOGIC-IN-ITERATIVE-DEEPENING KWD-LOGIC-IN-JUSTIFICATIONS KWD-LOGIC-IN-JUST-IN-TIME-INFERENCE
     KWD-LOGIC-IN-EMIT-THINKING-DOTS))
   (CL:SETQ *CURRENT-POWERLOOM-FEATURES* (LIST))
   (CL:SETQ *DEFAULT-POWERLOOM-FEATURES* (LIST KWD-LOGIC-IN-JUST-IN-TIME-INFERENCE KWD-LOGIC-IN-EMIT-THINKING-DOTS))
   (RESET-FEATURES)
   (CL:SETQ *POWERLOOM-KB-FILE-EXTENSIONS* (GET-QUOTED-TREE "((\".plm\" \".ploom\") \"/LOGIC\")" "/LOGIC"))
   (CL:SETQ *DEMO-FILES*
    (LIST* (LIST* (WRAP-STRING "basics") (WRAP-STRING "Basic PowerLoom commands") (WRAP-STRING "test-suite") NIL)
     ...
     (LIST* (WRAP-STRING "family") (WRAP-STRING "Subsumption reasoning within a family ontology")
      (WRAP-STRING "test-suite") NIL)
     (LIST* (WRAP-STRING "relation-hierarchy") (WRAP-STRING "Finding sub, super and equivalent concepts and relations")
      (WRAP-STRING "test-suite") NIL)
     (LIST* (WRAP-STRING "defaults") (WRAP-STRING "Default reasoning with Tweety and friends")
      (WRAP-STRING "test-suite") NIL)
     ...
     (LIST* (WRAP-STRING "definition-syntax")
      (WRAP-STRING "The whole scoop on relation definition, funny arrows, etc.") (WRAP-STRING "test-suite") NIL)
     (LIST* (WRAP-STRING "meta-relations") (WRAP-STRING "Using meta-properties and relations")
      (WRAP-STRING "test-suite") NIL)
     (LIST* (WRAP-STRING "partial-match") (WRAP-STRING "Reasoning with partial information") (WRAP-STRING "test-suite")
      NIL)
     (LIST* (WRAP-STRING "probability-learning") (WRAP-STRING "Learning to answer probabilistic queries")
      (WRAP-STRING "test-suite") NIL)
   ...
   (CL:SETQ *LOGIC-RELEVANT-STELLA-COMMANDS*
    (LIST* SYM-LOGIC-IN-STELLA-CC SYM-LOGIC-IN-STELLA-CLEAR-MODULE SYM-LOGIC-IN-STELLA-DEFMODULE
     SYM-LOGIC-IN-STELLA-IN-MODULE SYM-LOGIC-IN-STELLA-LIST-MODULES NIL))))
...
Return the list of enabled features.  Calling `unset-feature' without any
arguments can be used to display the currently enabled features.
See `set-feature' for a description of supported features.\")" (CL:FUNCTION %UNSET-FEATURE)
   ...
   (DEFINE-FUNCTION-OBJECT "PRINT-LOGIC-COMMAND-RESULT" "(DEFUN PRINT-LOGIC-COMMAND-RESULT ((RESULT OBJECT)))"
    (CL:FUNCTION PRINT-LOGIC-COMMAND-RESULT) NULL)
   (DEFINE-FUNCTION-OBJECT "LOGIC-COMMAND-LOOP-EXIT?"
    "(DEFUN (LOGIC-COMMAND-LOOP-EXIT? BOOLEAN BOOLEAN) ((COMMAND OBJECT)))" (CL:FUNCTION LOGIC-COMMAND-LOOP-EXIT?)
    NULL)
   (DEFINE-FUNCTION-OBJECT "LOGIC-COMMAND-LOOP" "(DEFUN LOGIC-COMMAND-LOOP ((MODULE MODULE)))"
...
that do NOT have an `in-module' declaration as part of the file.
If this is not set, and no `in-module' declaration is in the file,
then an error will be signaled.\" :COMMAND? TRUE :PUBLIC? TRUE)" (CL:FUNCTION %LOAD)
    (CL:FUNCTION LOAD-EVALUATOR-WRAPPER))
   (DEFINE-FUNCTION-OBJECT "DEFINITION-NAME?" "(DEFUN (DEFINITION-NAME? BOOLEAN) ((NAME SYMBOL)) :PUBLIC? FALSE)"
...
starts with a `-' character.\" :PUBLIC? TRUE :COMMAND? TRUE)" (CL:FUNCTION LOAD-CMD-LINE-FILES) NULL)
   ...
   (DEFINE-FUNCTION-OBJECT "DEMO-SKIP-TO-COMMAND" "(DEFUN (DEMO-SKIP-TO-COMMAND BOOLEAN) ((STREAM INPUT-STREAM)))"
    (CL:FUNCTION DEMO-SKIP-TO-COMMAND) NULL)
   (DEFINE-FUNCTION-OBJECT "DEMO-PAUSE?" "(DEFUN (DEMO-PAUSE? BOOLEAN BOOLEAN) ((PAUSE? BOOLEAN)))"
    (CL:FUNCTION DEMO-PAUSE?) NULL)
   (DEFINE-FUNCTION-OBJECT "DEMO-FILE" "(DEFUN DEMO-FILE ((FILE FILE-NAME) (PAUSE? BOOLEAN)))" (CL:FUNCTION DEMO-FILE)
    NULL)
   (DEFINE-FUNCTION-OBJECT "DEMO-ENTRY-FILE" "(DEFUN (DEMO-ENTRY-FILE STRING) ((DEMOENTRY (CONS OF STRING-WRAPPER))))"
   ...
   (DEFINE-FUNCTION-OBJECT "SELECT-EXAMPLE-DEMO" "(DEFUN (SELECT-EXAMPLE-DEMO STRING) ((INDEX INTEGER)))"
    (CL:FUNCTION SELECT-EXAMPLE-DEMO) NULL)
   (DEFINE-FUNCTION-OBJECT "SELECT-EXAMPLE-DEMO-FROM-MENU" "(DEFUN (SELECT-EXAMPLE-DEMO-FROM-MENU STRING) ())"
...
before it is evaluated.  Pausing can be turned off by suppling FALSE
as the optional second argument, or by typing `c' at the pause prompt.
Typing `?' at the pause prompt prints a list of available commands.\")" (CL:FUNCTION %DEMO)
    (CL:FUNCTION DEMO-EVALUATOR-WRAPPER))
   (DEFINE-FUNCTION-OBJECT "TEST-LOGIC-FILE" "(DEFUN TEST-LOGIC-FILE ((FILE FILE-NAME)))" (CL:FUNCTION TEST-LOGIC-FILE)
    NULL)
   (DEFINE-FUNCTION-OBJECT "GET-FORMATTED-DATE-AND-TIME" "(DEFUN (GET-FORMATTED-DATE-AND-TIME STRING) ())"
...
needed for its execution, and then return its result.\" :COMMAND? TRUE :PUBLIC? TRUE :EVALUATE-ARGUMENTS? FALSE)"
   ...
   (DEFINE-FUNCTION-OBJECT "GET-HTTP-SERVER-SYSTEM" "(DEFUN (GET-HTTP-SERVER-SYSTEM STRING) ())"
...
the required support systems in Lisp and Java if necessary (C++ is not yet supported).\" :COMMAND? TRUE :PUBLIC? TRUE)"
    (CL:FUNCTION %START-ONTOSAURUS) (CL:FUNCTION START-ONTOSAURUS-EVALUATOR-WRAPPER))
...
the required support systems in Lisp and Java if necessary (C++ is not yet supported).\" :COMMAND? TRUE :PUBLIC? TRUE)"
    (CL:FUNCTION %START-POWERLOOM-SERVER) (CL:FUNCTION START-POWERLOOM-SERVER-EVALUATOR-WRAPPER))
...
Embedded calls to the GUI are currently only supported in Java; however, when the GUI is
run in standalone mode, it can communicate with any PowerLoom installation that supports
an HTTP server (currently Lisp and Java).\" :COMMAND? TRUE :PUBLIC? TRUE)" (CL:FUNCTION %START-POWERLOOM-GUI)
...
This is a no-op if the GUI is not running or if it is not supported.\" :COMMAND? TRUE :PUBLIC? TRUE)"
   ...
   (DEFINE-FUNCTION-OBJECT "LOGIC-DIALECT" "(DEFUN (LOGIC-DIALECT KEYWORD) ((SELF OBJECT)))"
   ...
   (DEFINE-FUNCTION-OBJECT "INTERN-LOGIC-OBJECT-SURROGATE"
    "(DEFUN (INTERN-LOGIC-OBJECT-SURROGATE SURROGATE) ((NAME SYMBOL)))" (CL:FUNCTION INTERN-LOGIC-OBJECT-SURROGATE)
    NULL)
   (DEFINE-FUNCTION-OBJECT "NAME-OBJECT-METACLASS" "(DEFUN (NAME-OBJECT-METACLASS STRING) ((SELF OBJECT)))"
...
(CL:DEFUN HELP-STARTUP-LOGIC-IN5 ()
  (CL:PROGN (DEFINE-FUNCTION-OBJECT "AXIOMS" "(DEFUN (AXIOMS CONS) ((SELF OBJECT)))" (CL:FUNCTION AXIOMS) NULL)
   (DEFINE-FUNCTION-OBJECT "AXIOMS-SETTER" "(DEFUN (AXIOMS-SETTER OBJECT) ((SELF OBJECT) (AXIOMS CONS)))"
   ...
   (DEFINE-FUNCTION-OBJECT "COMBINE-AXIOM-LISTS"
    "(DEFUN (COMBINE-AXIOM-LISTS CONS) ((OLDAXIOMS CONS) (NEWAXIOMS OBJECT)))" (CL:FUNCTION COMBINE-AXIOM-LISTS) NULL)
   ...
   (DEFINE-FUNCTION-OBJECT "REGISTER-UNFINALIZED-OBJECT" "(DEFUN REGISTER-UNFINALIZED-OBJECT ((OBJECT OBJECT)))"
    (CL:FUNCTION REGISTER-UNFINALIZED-OBJECT) NULL)
   (DEFINE-FUNCTION-OBJECT "CLEANUP-UNFINALIZED-OBJECTS" "(DEFUN CLEANUP-UNFINALIZED-OBJECTS ())"
   ...
   (DEFINE-FUNCTION-OBJECT "FINALIZE-OBJECT-AXIOMS" "(DEFUN FINALIZE-OBJECT-AXIOMS ((SELF OBJECT)))"
   ...
   (DEFINE-FUNCTION-OBJECT "FINALIZE-OBJECT" "(DEFUN FINALIZE-OBJECT ((SELF OBJECT)))" (CL:FUNCTION FINALIZE-OBJECT)
    NULL)
   (DEFINE-FUNCTION-OBJECT "FINALIZED-OBJECT?" "(DEFUN (FINALIZED-OBJECT? BOOLEAN) ((SELF OBJECT)))"
...
The user-level entry point for this is `(process-definitions)'.\" :PUBLIC? TRUE)" (CL:FUNCTION FINALIZE-OBJECTS) NULL)
   ...
   (DEFINE-METHOD-OBJECT "(DEFMETHOD PROCESS-DEFINITION-OPTIONS ((SELF NAMED-DESCRIPTION) (OPTIONS OBJECT)))"
...
Expects the same arguments as `deffunction' but supplied as a list.\" :PUBLIC? TRUE)" (CL:FUNCTION CALL-DEFFUNCTION)
    NULL)
   (DEFINE-FUNCTION-OBJECT "NORMALIZE-DEFFUNCTION-ARGUMENTS"
    "(DEFUN (NORMALIZE-DEFFUNCTION-ARGUMENTS CONS) ((ARGUMENTS CONS)))" (CL:FUNCTION NORMALIZE-DEFFUNCTION-ARGUMENTS)
    NULL)
...
Expects the same arguments as `defrelation' but supplied as a list.\" :PUBLIC? TRUE)" (CL:FUNCTION CALL-DEFRELATION)
    NULL)
   (DEFINE-FUNCTION-OBJECT "NORMALIZE-DEFRELATION-ARGUMENTS"
    "(DEFUN (NORMALIZE-DEFRELATION-ARGUMENTS CONS) ((ARGUMENTS CONS)))" (CL:FUNCTION NORMALIZE-DEFRELATION-ARGUMENTS)
    NULL)
...
Expects the same arguments as `defconcept' but supplied as a list.\" :PUBLIC? TRUE)" (CL:FUNCTION CALL-DEFCONCEPT)
    NULL)
   (DEFINE-FUNCTION-OBJECT "NORMALIZE-DEFCONCEPT-ARGUMENTS"
    "(DEFUN (NORMALIZE-DEFCONCEPT-ARGUMENTS CONS) ((ARGUMENTS CONS)))" (CL:FUNCTION NORMALIZE-DEFCONCEPT-ARGUMENTS)
    NULL)
...
Expects the same arguments as `defobject' but supplied as a list.\" :PUBLIC? TRUE)" (CL:FUNCTION CALL-DEFOBJECT) NULL)
   (DEFINE-FUNCTION-OBJECT "NORMALIZE-DEFOBJECT-ARGUMENTS"
    "(DEFUN (NORMALIZE-DEFOBJECT-ARGUMENTS CONS) ((ARGUMENTS CONS)))" (CL:FUNCTION NORMALIZE-DEFOBJECT-ARGUMENTS) NULL)
   (DEFINE-METHOD-OBJECT "(DEFMETHOD PROCESS-DEFINITION-OPTIONS ((SELF LOGIC-OBJECT) (OPTIONS OBJECT)))"
    (CL:FUNCTION PROCESS-DEFINITION-OPTIONS) NULL)
...
Expects the same arguments as `defproposition' but supplied as a list.\" :PUBLIC? TRUE)"
   ...
   (DEFINE-METHOD-OBJECT "(DEFMETHOD PROCESS-DEFINITION-OPTIONS ((SELF PROPOSITION) (OPTIONS OBJECT)))"
    (CL:FUNCTION PROCESS-DEFINITION-OPTIONS) NULL)))

(CL:DEFUN STARTUP-LOGIC-IN ()
  (CL:LET* ((*MODULE* (GET-STELLA-MODULE "/LOGIC" (> *STARTUP-TIME-PHASE* 1))) (*CONTEXT* *MODULE*))
   (CL:DECLARE (CL:SPECIAL *MODULE* *CONTEXT*))
   (CL:WHEN (CURRENT-STARTUP-TIME-PHASE? 2) (HELP-STARTUP-LOGIC-IN1) (HELP-STARTUP-LOGIC-IN2))
   ...
   (CL:WHEN (CURRENT-STARTUP-TIME-PHASE? 7) (HELP-STARTUP-LOGIC-IN4) (HELP-STARTUP-LOGIC-IN5)
    (DEFINE-FUNCTION-OBJECT "COMMAND<" "(DEFUN (COMMAND< BOOLEAN) ((COMMAND1 METHOD-SLOT) (COMMAND2 METHOD-SLOT)))"
     (CL:FUNCTION COMMAND<) NULL)
    (DEFINE-FUNCTION-OBJECT "LIST-LOGIC-COMMANDS" "(DEFUN (LIST-LOGIC-COMMANDS (LIST OF METHOD-SLOT)) ())"
    ...
    (DEFINE-FUNCTION-OBJECT "STARTUP-LOGIC-IN" "(DEFUN STARTUP-LOGIC-IN () :PUBLIC? TRUE)"
     (CL:FUNCTION STARTUP-LOGIC-IN) NULL)
    (CL:LET* ((FUNCTION (LOOKUP-FUNCTION SYM-LOGIC-IN-LOGIC-STARTUP-LOGIC-IN)))
     (SET-DYNAMIC-SLOT-VALUE (%DYNAMIC-SLOTS FUNCTION) SYM-LOGIC-IN-STELLA-METHOD-STARTUP-CLASSNAME
...
`load' or `demo' command, try to find it with one of these extensions.\" :PUBLIC? TRUE)")
    ...
    (REGISTER-NATIVE-NAME SYM-LOGIC-IN-STELLA-LOAD KWD-LOGIC-IN-COMMON-LISP KWD-LOGIC-IN-FUNCTION)
    (REGISTER-NATIVE-NAME SYM-LOGIC-IN-LOGIC-LOAD-DIRECTORY KWD-LOGIC-IN-COMMON-LISP KWD-LOGIC-IN-FUNCTION)
    (DEFINE-STELLA-GLOBAL-VARIABLE-FROM-STRINGIFIED-SOURCE "(DEFSPECIAL *DEMO-LEVEL* INTEGER 0)")
