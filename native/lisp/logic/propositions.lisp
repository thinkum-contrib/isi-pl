...
(CL:DECLAIM
  ...
  *REDEFINE-RELATION-HOOKS* *REVERSEPOLARITY?* *INHIBITOBJECTFINALIZATION?*
  *DESCRIPTIONUNDERCONSTRUCTION* *LOGICVARIABLETABLE* *INTEGER-MSB-MASK*
  STANDARD-ERROR *BACKLINK-ALL-PROPOSITION-ARGUMENTS?* *TERMUNDERCONSTRUCTION*
  ...
  *PRINTREADABLY?* NULL-FLOAT-WRAPPER NIL-NON-PAGING-INDEX NULL-FLOAT NIL-LIST
  NULL-INTEGER *LOADINGREGENERABLEOBJECTS?* *CONTEXT* TRUE-WRAPPER
  FALSE-WRAPPER NIL *MODULE*))
...
(CL:DEFMETHOD VARIABLE-VALUE-INVERSE ((SELF LOGIC-OBJECT))
  (CL:LET*
   ((ANSWER
     (ACCESS-IN-CONTEXT (%VARIABLE-VALUE-INVERSE SELF) (%HOME-CONTEXT SELF)
      CL:NIL)))
...
(CL:DEFMETHOD BAD? ((SELF LOGIC-OBJECT))
  (CL:LET*
   ((ANSWER
     (DYNAMIC-SLOT-VALUE (%DYNAMIC-SLOTS SELF) SYM-PROPOSITIONS-STELLA-BAD?
      NULL)))
...
(CL:DEFUN NEW-SKOLEM ()
  (CL:LET* ((SELF NULL)) (CL:SETQ SELF (CL:MAKE-INSTANCE (CL:QUOTE SKOLEM)))
   ...
   (CL:SETF (%VARIABLE-VALUE SELF) NULL) (CL:SETF (%SKOLEM-NAME SELF) NULL)
...
(CL:DEFUN NEW-PATTERN-VARIABLE ()
  (CL:LET* ((SELF NULL))
   ...
   (CL:SETF (%HOME-CONTEXT SELF) *MODULE*)
   (CL:SETF (%DEFINING-PROPOSITION SELF) NULL)
   (CL:SETF (%VARIABLE-VALUE SELF) NULL) (CL:SETF (%SKOLEM-TYPE SELF) NULL)
...
equivalent to its top-level implicit existential variables." :ALLOCATION
    :INSTANCE :ACCESSOR %INTERNAL-VARIABLES)
...
(CL:DEFUN NEW-NAMED-DESCRIPTION ()
  (CL:LET* ((SELF NULL))
   ...
   (CL:SETF (%EXTENSION SELF) NULL) (CL:SETF (%IO-VARIABLE-TYPES SELF) NULL)
...
(CL:DEFCLASS TRUTH-VALUE (LOGIC-OBJECT)
  ((POLARITY :DOCUMENTATION "One of :TRUE, :FALSE, :UNKNOWN or :INCONSISTENT."
    :ALLOCATION :INSTANCE :ACCESSOR %POLARITY)
   (STRENGTH :DOCUMENTATION "Either NULL, :STRICT or :DEFAULT." :ALLOCATION
    :INSTANCE :ACCESSOR %STRENGTH)
   (POSITIVE-SCORE :TYPE CL:DOUBLE-FLOAT :INITFORM NULL-FLOAT :ALLOCATION
...
(CL:DEFUN NEW-TRUTH-VALUE ()
  (CL:LET* ((SELF NULL))
   ...
   (CL:SETF (%VARIABLE-VALUE-INVERSE SELF) NULL)
   (CL:SETF (%HOME-CONTEXT SELF) *MODULE*)
   (CL:SETF (%POSITIVE-SCORE SELF) 0.0d0) (CL:SETF (%STRENGTH SELF) NULL)
   (CL:SETF (%POLARITY SELF) KWD-PROPOSITIONS-UNKNOWN) (LOG-LOGIC-OBJECT SELF)
   SELF))
...
(CL:DEFCLASS PARTIAL-SUPPORT (STANDARD-OBJECT)
  ((FACT :ALLOCATION :INSTANCE :ACCESSOR %FACT)
   ...
   (SCORE :TYPE CL:DOUBLE-FLOAT :INITFORM NULL-FLOAT :ALLOCATION :INSTANCE
    :ACCESSOR %SCORE)
   (ID :TYPE CL:FIXNUM :INITFORM NULL-INTEGER :ALLOCATION :INSTANCE :ACCESSOR
    %ID)
...
(CL:DEFUN NEW-PARTIAL-SUPPORT ()
  (CL:LET* ((SELF NULL))
   ...
   (CL:SETF (%ARGUMENT-SCORES SELF) NULL) (CL:SETF (%ID SELF) NULL-INTEGER)
   (CL:SETF (%SCORE SELF) NULL-FLOAT) (CL:SETF (%AXIOM SELF) NULL)
   (CL:SETF (%FACT SELF) NULL) SELF))
...
(CL:DEFMETHOD SUPPORT ((SELF PROPOSITION))
  (CL:LET*
   ((ANSWER
     (DYNAMIC-SLOT-VALUE (%DYNAMIC-SLOTS SELF) SYM-PROPOSITIONS-LOGIC-SUPPORT
      NULL)))
   (CL:IF (CL:EQ ANSWER NULL) NIL ANSWER)))
...
(CL:DEFUN ACCESS-PROPOSITION-SLOT-VALUE (SELF SLOTNAME VALUE SETVALUE?)
  (CL:COND
   ...
   ((CL:EQ SLOTNAME SYM-PROPOSITIONS-LOGIC-WEIGHT-DELTA)
    (CL:IF SETVALUE?
     (SET-DYNAMIC-SLOT-VALUE (%DYNAMIC-SLOTS SELF)
      SYM-PROPOSITIONS-LOGIC-WEIGHT-DELTA (WRAP-FLOAT (%WRAPPER-VALUE VALUE))
      NULL-FLOAT-WRAPPER)
  ...
  (CL:LET* ((TEST-VALUE-000 (SAFE-PRIMARY-TYPE SELF)))
   (CL:COND
    ...
    ((SUBTYPE-OF? TEST-VALUE-000 SGT-PROPOSITIONS-LOGIC-LOGIC-OBJECT)
     (CL:PROGN
      (SET-DYNAMIC-SLOT-VALUE (%DYNAMIC-SLOTS SELF)
       SYM-PROPOSITIONS-LOGIC-OBJECT-STRINGIFIED-SOURCE (WRAP-STRING VALUE)
       NULL-STRING-WRAPPER)))
    ((SUBTYPE-OF? TEST-VALUE-000 SGT-PROPOSITIONS-LOGIC-PROPOSITION)
     (CL:PROGN
      (SET-DYNAMIC-SLOT-VALUE (%DYNAMIC-SLOTS SELF)
    ...
    (CL:COND
     ...
     ((SUBTYPE-OF? TEST-VALUE-000 SGT-PROPOSITIONS-LOGIC-PROPOSITION)
      (CL:PROGN
       (CL:SETQ VALUE
        (DYNAMIC-SLOT-VALUE (%DYNAMIC-SLOTS SELF)
         SYM-PROPOSITIONS-LOGIC-PROPOSITION-ORIGINATED-PROPOSITIONS NULL))))
     (CL:T
      (CL:LET* ((STREAM-000 (NEW-OUTPUT-STRING-STREAM)))
       (%%PRINT-STREAM (%NATIVE-STREAM STREAM-000) "`" TEST-VALUE-000
        "' is not a valid case option")
  ...
  (CL:LET* ((TEST-VALUE-000 (SAFE-PRIMARY-TYPE SELF)))
   (CL:COND
    ...
    ((SUBTYPE-OF? TEST-VALUE-000 SGT-PROPOSITIONS-LOGIC-LOGIC-OBJECT)
     (CL:PROGN
      (SET-DYNAMIC-SLOT-VALUE (%DYNAMIC-SLOTS SELF)
       SYM-PROPOSITIONS-LOGIC-OBJECT-ORIGINATED-PROPOSITIONS VALUE NULL)))
    ((SUBTYPE-OF? TEST-VALUE-000 SGT-PROPOSITIONS-LOGIC-PROPOSITION)
     (CL:PROGN
      (SET-DYNAMIC-SLOT-VALUE (%DYNAMIC-SLOTS SELF)
   ...
   (CL:LET* ((STREAM-000 (NEW-OUTPUT-STRING-STREAM)))
    (CL:LET* ((*PRINTREADABLY?* CL:T))
     ...
     (%%PRINT-STREAM (%NATIVE-STREAM STREAM-000)
      "ERROR: Can't create a relation, instance or proposition in module:" EOL
     ...
     (CL:LET* ((FOUND?-000 CL:NIL))
      (CL:LET* ((M NULL) (ITER-000 (%THE-CONS-LIST (%PARENT-MODULES SELF))))
       (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-000 NIL)) DO
        ...
        (CL:WHEN (LOGIC-MODULE? M) (CL:SETQ FOUND?-000 CL:T) (CL:RETURN))
      ...
      (CL:LET* ((FOUND?-001 CL:NIL))
       (CL:LET* ((M NULL) (ITER-001 (%THE-CONS-LIST (%USES SELF))))
        (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-001 NIL)) DO
         ...
         (CL:WHEN (LOGIC-MODULE? M) (CL:SETQ FOUND?-001 CL:T) (CL:RETURN))
...
(CL:DEFUN LOCALLY-CONCEIVED-PROPOSITIONS (SELF)
  (CL:LET*
   ((PROPOSITIONS
     (DYNAMIC-SLOT-VALUE (%DYNAMIC-SLOTS SELF)
      SYM-PROPOSITIONS-LOGIC-LOCALLY-CONCEIVED-PROPOSITIONS-INTERNAL NULL)))
...
(CL:DEFUN LOCALLY-CONCEIVED-PROPOSITIONS-SETTER (SELF VALUE)
  (SET-DYNAMIC-SLOT-VALUE (%DYNAMIC-SLOTS SELF)
   SYM-PROPOSITIONS-LOGIC-LOCALLY-CONCEIVED-PROPOSITIONS-INTERNAL VALUE NULL))
...
(CL:DEFUN LOGICAL-SUBTYPE-OF-LITERAL? (TYPE)
  (CL:LET*
   ((DESC (SURROGATE-TO-DESCRIPTION TYPE))
    (LITERALCLASS (SURROGATE-TO-DESCRIPTION SGT-PROPOSITIONS-STELLA-LITERAL))
    (LITERALSUBS NIL))
   (CL:COND
    ((CL:EQ DESC NULL) (CL:RETURN-FROM LOGICAL-SUBTYPE-OF-LITERAL? CL:NIL))
   ...
   (CL:WHEN TEST-VALUE-000
    (CL:LET* ((*PRINTREADABLY?* CL:T))
     ...
     (%%PRINT-STREAM (%NATIVE-STREAM STANDARD-WARNING)
      "WARNING: LOGGED QUESTIONABLE CONCEPTION: " EOL "   " PROPOSITION EOL)
    ...
    (DESCRIPTION
     (CL:IF (FUNCTION-OUTPUT-SKOLEM? TERM1)
      ...
      (CL:IF (FUNCTION-OUTPUT-SKOLEM? TERM2)
       (GET-DESCRIPTION (%OPERATOR (%DEFINING-PROPOSITION TERM2))) NULL)))
    (DEMONCOMPUTATION
...
(CL:DEFUN ASSIGN-TRUTH-VALUE (SELF TRUTHVALUE)
  (CL:LET*
   ((OLDTRUTHVALUE
    ...
    (NEWTRUTHVALUE NULL))
   (CL:COND
    ((CL:EQ TRUTHVALUE TRUE-WRAPPER) (CL:SETQ NEWTRUTHVALUE TRUE-TRUTH-VALUE))
      ...
      ((CL:EQ NEWTRUTHVALUE DEFAULT-TRUE-TRUTH-VALUE)
       (CL:COND
        (*DEFERINGDEFAULTFORWARDINFERENCES?*
         (DEFER-DEFAULT-PROPOSITION (GET-PROPAGATION-ENVIRONMENT *CONTEXT*)
          SELF)
         NULL)
    ...
    ((CL:EQ NEWTRUTHVALUE INCONSISTENT-TRUTH-VALUE)
     (CL:LET*
      ((OBJECT-003 SELF) (VALUE-003 NEWTRUTHVALUE)
       ...
       (NEW-VALUE-003
        (UPDATE-IN-CONTEXT OLD-VALUE-004 VALUE-003 (%HOME-CONTEXT OBJECT-003)
         CL:NIL)))
      (CL:WHEN
       (CL:NOT
    ...
    (CL:T
     (CL:LET*
      ((OBJECT-004 SELF) (VALUE-004 NEWTRUTHVALUE)
       ...
       (NEW-VALUE-004
        (UPDATE-IN-CONTEXT OLD-VALUE-005 VALUE-004 (%HOME-CONTEXT OBJECT-004)
         CL:NIL)))
      (CL:WHEN
       (CL:NOT
...
(CL:DEFUN ASSIGN-PROPOSITION-WEIGHT (SELF WEIGHT)
  ...
  (CL:LET*
   ((TV (ACCESS-IN-CONTEXT (%TRUTH-VALUE SELF) (%HOME-CONTEXT SELF) CL:NIL)))
...
(CL:DEFUN TICKLE-CONTEXT ()
  (CL:LET*
   ...
   (UPDATE-PROPERTY DESCRIPTION SGT-PROPOSITIONS-PL-KERNEL-KB-HIDDEN-RELATION
...
(CL:DEFUN TICKLE-INSTANCES ()
  (CL:LET* ((TEMP-000 (GET-INSTANCE (WRAP-STRING "HIDDEN-INSTANCE"))))
   (CL:LET*
    ...
    (UPDATE-PROPERTY INSTANCE SGT-PROPOSITIONS-PL-KERNEL-KB-HIDDEN-RELATION
     KWD-PROPOSITIONS-RETRACT-TRUE)
    *CONTEXT*)))
  ...
  (CL:LET* ((PROPOSITION (%DEFINING-PROPOSITION SKOLEM)))
   (CL:WHEN (CL:AND TOPLEVELUPDATE? (NATIVE-SLOT-PROPOSITION? PROPOSITION))
    (CL:LET*
     ...
     (CL:IF (CL:NOT (CL:EQ NEWVALUE NULL))
      (ASSIGN-NATIVE-SLOT-VALUE PROPOSITION NATIVEFIRSTARGVALUE SLOT NEWVALUE)
   ...
   (CL:WHEN (CL:NOT (EQL? OLDVALUE NEWVALUE))
    ...
    (CL:WHEN (CL:NOT (CL:EQ OLDVALUE NULL))
     (UPDATE-LINKS-AND-TIMESTAMPS PROPOSITION KWD-PROPOSITIONS-RETRACT-TRUE))
    (CL:WHEN (CL:NOT (CL:EQ NEWVALUE NULL))
     (UPDATE-LINKS-AND-TIMESTAMPS PROPOSITION KWD-PROPOSITIONS-ASSERT-TRUE)))))
  ...
  (CL:LET* ((ARGUMENTS (%ARGUMENTS SELF)))
   ...
   (CL:LET*
    ((FIRSTARG
      (CL:IF
       (CL:NOT
        (CL:EQ (CL:AREF (CL:THE CL:SIMPLE-VECTOR (%THE-ARRAY ARGUMENTS)) 0)
         NULL))
       (VALUE-OF (CL:AREF (CL:THE CL:SIMPLE-VECTOR (%THE-ARRAY ARGUMENTS)) 0))
       NULL)))
    (CL:WHEN
     ...
     ((SUBTYPE-OF? (SAFE-PRIMARY-TYPE TERM)
      ...
      (CL:PROGN
       (CL:LET*
        ((PROP NULL)
         (ITER-000
          (ALLOCATE-ITERATOR (UNFILTERED-DEPENDENT-ISA-PROPOSITIONS TERM))))
...
(CL:DEFUN UNBOUND? (SKOLEM)
  (CL:EQ
   (ACCESS-IN-CONTEXT (%VARIABLE-VALUE SKOLEM) (%HOME-CONTEXT SKOLEM) CL:NIL)
   NULL))
  ...
  (CL:LET*
   ...
   (INTERN-SYMBOL
    (CONCATENATE (CL:IF VARIABLE? "?V" "SK")
     (CL:IF (CL:= (CL:THE CL:FIXNUM (CL:LENGTH SUFFIX)) 1) "0" "") SUFFIX))))
...
(CL:DEFUN INCONSISTENT? (SELF)
  ...
  (CL:EQ (ACCESS-IN-CONTEXT (%TRUTH-VALUE SELF) (%HOME-CONTEXT SELF) CL:NIL)
...
(CL:DEFUN CONJOIN-TRUTH-VALUES (TV1 TV2)
  ...
  (CL:COND
   ...
   ((CL:AND (CL:EQ TV1 DEFAULT-TRUE-TRUTH-VALUE)
    ...
    UNKNOWN-TRUTH-VALUE)
   ((CL:OR (CL:EQ TV1 NULL) (CL:EQ TV1 UNKNOWN-TRUTH-VALUE) (CL:EQ TV2 NULL)
     (CL:EQ TV2 UNKNOWN-TRUTH-VALUE))
    UNKNOWN-TRUTH-VALUE)
...
Truth values at the same level are equal in strength."
  (CL:COND ((CL:EQ TV1 TV2) CL:NIL)
   ...
   (CL:T
    (CL:LET* ((STREAM-000 (NEW-OUTPUT-STRING-STREAM)))
     (%%PRINT-STREAM (%NATIVE-STREAM STREAM-000)
      "Internal Error: STRONGER-TRUTH-VALUE?: Shouldn't get here. tv1=`" TV1
      "' tv2=`" TV2 "'")
...
using merge to come up with an answer."
  (CL:COND ((CL:EQ TV1 TV2) TV1)
   ...
   (CL:T
    (CL:LET* ((STREAM-000 (NEW-OUTPUT-STRING-STREAM)))
     (%%PRINT-STREAM (%NATIVE-STREAM STREAM-000)
      "Internal Error: MERGE-TRUTH-VALUES: Shouldn't get here. tv1=`" TV1
      "' tv2=`" TV2 "'")
     (CL:ERROR (NEW-LOGIC-EXCEPTION (THE-STRING-READER STREAM-000)))))))
...
its value!) and return the result.  Otherwise, return `tv1' unmodified."
  (CL:COND
   ...
   ((CL:OR (CL:EQ TV2 DEFAULT-TRUE-TRUTH-VALUE)
     (CL:EQ TV2 DEFAULT-FALSE-TRUTH-VALUE))
    (CL:WHEN
     (CL:OR (CL:EQ TV1 TRUE-TRUTH-VALUE) (CL:EQ TV1 DEFAULT-TRUE-TRUTH-VALUE))
...
(CL:DECLAIM
 (CL:FTYPE (CL:FUNCTION (CL:T CL:T) CL:SIMPLE-STRING) TRUTH-VALUE-TO-STRING))
...
(CL:DEFUN SIGNAL-UNIFICATION-CLASH (PROP TERM1 TERM2)
  (CL:LET* ((MESSAGE "Unification clash.") (CLASH-OBJECT NULL))
   ...
   (CL:SETF (%VALUE2 CLASH-OBJECT) TERM2) (CL:ERROR CLASH-OBJECT)))
...
" "   " "`" (STRINGIFY VALUE1) "'" " and " "`" (STRINGIFY VALUE2) "'" ".")))
   ...
   (CL:SETF (%SKOLEM EXCEPTION) SKOLEM) (CL:SETF (%VALUE1 EXCEPTION) VALUE1)
   (CL:SETF (%VALUE2 EXCEPTION) VALUE2) (CL:ERROR EXCEPTION)))
...
(CL:DEFUN SIGNAL-TRUTH-VALUE-CLASH (PROPOSITION)
  (CL:WHEN
   ...
   (CL:WHEN *RECORD-JUSTIFICATIONS?*
    (CL:LET*
     ((NEGATED-PROPOSITION
       (FASTEN-DOWN-ONE-PROPOSITION (SAFELY-INVERT-PROPOSITION PROPOSITION)
        CL:T))
      (ANTECEDENTS NIL))
     (CL:IF
      (CL:AND
       (CL:NOT (CL:EQ (FORWARD-JUSTIFICATIONS NEGATED-PROPOSITION) NULL))
     ...
     (ADD-FORWARD-JUSTIFICATIONS NEGATED-PROPOSITION
      (CREATE-CLASH-JUSTIFICATION NEGATED-PROPOSITION
       (REVERSE (COPY-CONS-LIST ANTECEDENTS)) KWD-PROPOSITIONS-FORWARD)))))
  (CL:LET*
...
" "   Clash occurred in the world " "`" (STRINGIFY *CONTEXT*) "'"
   ...
   (CL:SETF (%CONTEXT EXCEPTION) EXCEPTION-CONTEXT) (CL:ERROR EXCEPTION)))
...
(CL:DEFUN LOGICAL-TYPE (SELF)
  (CL:LET* ((TEST-VALUE-000 (SAFE-PRIMARY-TYPE SELF)))
   (CL:COND
     ...
     (CL:PROGN
      (CL:COND
       ((CL:AND (MONADIC? SELF)
        ...
        (%SKOLEM-TYPE
         (CL:AREF (CL:THE CL:SIMPLE-VECTOR (%THE-ARRAY (%IO-VARIABLES SELF)))
          0)))
    ...
    ((SUBTYPE-OF? TEST-VALUE-000 SGT-PROPOSITIONS-LOGIC-SKOLEM)
     (CL:PROGN
      (CL:IF (CL:NOT (CL:EQ (%SKOLEM-TYPE SELF) NULL)) (%SKOLEM-TYPE SELF)
       SGT-PROPOSITIONS-STELLA-THING)))
    ((SUBTYPE-OF? TEST-VALUE-000 SGT-PROPOSITIONS-LOGIC-LOGIC-OBJECT)
...
(CL:DEFUN SAFE-LOGICAL-TYPE (SELF)
  (CL:LET* ((*SUPPRESSUNTYPEDTYPEERROR?* CL:T))
   (CL:DECLARE (CL:SPECIAL *SUPPRESSUNTYPEDTYPEERROR?*)) (LOGICAL-TYPE SELF)))
   ...
   (CL:COND
    ((SUBTYPE-OF? TEST-VALUE-000 SGT-PROPOSITIONS-LOGIC-SKOLEM)
     (CL:PROGN
      (CL:LET*
       ((EQUIVALENTSKOLEM
         (ACCESS-IN-CONTEXT (%VARIABLE-VALUE TOVALUE) (%HOME-CONTEXT TOVALUE)
          CL:NIL)))
      ...
      (CL:LET*
       ((OBJECT-002 TOVALUE)
        ...
        (NEW-VALUE-002
         (UPDATE-IN-CONTEXT OLD-VALUE-004 VALUE-002 (%HOME-CONTEXT OBJECT-002)
          CL:NIL)))
       (CL:WHEN
        (CL:NOT
         (CL:AND (CL:NOT (CL:EQ OLD-VALUE-004 NULL))
     ...
     (CL:PROGN
      (CL:LET*
       ((OBJECT-003 TOVALUE)
        ...
        (NEW-VALUE-003
         (UPDATE-IN-CONTEXT OLD-VALUE-005 VALUE-003 (%HOME-CONTEXT OBJECT-003)
          CL:NIL)))
       (CL:WHEN
        (CL:NOT
         (CL:AND (CL:NOT (CL:EQ OLD-VALUE-005 NULL))
...
(CL:DEFUN UNBIND-SKOLEM-VALUE (SKOLEM TOPLEVELUPDATE?)
  (CL:LET*
   ((OLDVALUE (VALUE-OF SKOLEM)) (DEFININGPROP (%DEFINING-PROPOSITION SKOLEM))
    (EQUATINGPROP NULL))
  ...
  (CL:LET* ((COPY1 NIL) (COPY2 NIL))
   ...
   (CL:WHEN (CL:= (LENGTH COPY2) 1)
    (CL:LET* ((ITEM1 (%%VALUE COPY1)) (ITEM2 (%%VALUE COPY2)))
     (EQUATE-VALUES PROP ITEM1 ITEM2) (CL:RETURN-FROM CONSTRAIN-AS-SUBSET)))
...
(CL:DEFUN EQUATE-COLLECTIONS (PROP COL1 COL2)
  ...
  (CL:WHEN (CL:AND (NO-DUPLICATES? COL1) (NO-DUPLICATES? COL2))
   (CONSTRAIN-AS-SUBSET PROP COL1 COL2) (CONSTRAIN-AS-SUBSET PROP COL2 COL1)))
     ...
     (CL:LET* ((SKOLEM SECONDARG))
      (CL:LET*
       ((OBJECT-001 SKOLEM) (VALUE-001 NULL)
        (OLD-VALUE-002 (%VARIABLE-VALUE OBJECT-001))
        (NEW-VALUE-001
         (UPDATE-IN-CONTEXT OLD-VALUE-002 VALUE-001 (%HOME-CONTEXT OBJECT-001)
          CL:NIL)))
       (CL:WHEN
        (CL:NOT
         (CL:AND (CL:NOT (CL:EQ OLD-VALUE-002 NULL))
      ...
      ((OBJECT-001 SELF) (VALUE-001 NULL)
       (OLD-VALUE-001
        (DYNAMIC-SLOT-VALUE (%DYNAMIC-SLOTS OBJECT-001)
         SYM-PROPOSITIONS-LOGIC-EQUIVALENT-VALUE NULL))
       (NEW-VALUE-001
        (UPDATE-IN-CONTEXT OLD-VALUE-001 VALUE-001 (%HOME-CONTEXT OBJECT-001)
         CL:NIL)))
      (CL:WHEN
       (CL:NOT
        (CL:AND (CL:NOT (CL:EQ OLD-VALUE-001 NULL))
...
(CL:DECLAIM
 (CL:FTYPE (CL:FUNCTION (CL:T) CL:FIXNUM) EQUIVALENT-COLLECTION-PRIORITY))
...
(CL:DEFUN EVALUATE-TERM (SELF)
  (CL:LET* ((TEST-VALUE-001 (SAFE-PRIMARY-TYPE SELF)))
   (CL:COND
    ...
    (CL:T
     (CL:LET* ((STREAM-000 (NEW-OUTPUT-STRING-STREAM)))
      (%%PRINT-STREAM (%NATIVE-STREAM STREAM-000) "Can't evaluate the term `"
       SELF "'")
      (CL:ERROR (NEW-STELLA-EXCEPTION (THE-STRING-READER STREAM-000))))))))
...
(CL:DEFUN EVALUATE-AUTOMATIC-INSTANCE (NAME)
  (CL:WHEN (CL:EQ *AUTOMATICINSTANCETABLE* *MISSING-KEY-VALUE-LIST*)
   (CL:LET* ((STREAM-000 (NEW-OUTPUT-STRING-STREAM)))
    (CL:LET* ((*PRINTREADABLY?* CL:T))
     (CL:DECLARE (CL:SPECIAL *PRINTREADABLY?*))
     (%%PRINT-STREAM (%NATIVE-STREAM STREAM-000) "ERROR: Automatic instance `"
      NAME "' found outside" EOL "   the scope of an assertion.." EOL)
     (HELP-SIGNAL-PROPOSITION-ERROR STREAM-000 KWD-PROPOSITIONS-ERROR))
    (CL:ERROR (NEW-PROPOSITION-ERROR (THE-STRING-READER STREAM-000)))))
  (CL:LET*
   ((INSTANCE
...
(CL:DEFUN EVALUATE-CREATE-TERM (TERM)
  (CL:LET*
   ((NAMESYMBOL (%%VALUE (%%REST TERM)))
    (NAME
     (CL:IF (CL:NOT (CL:EQ NAMESYMBOL NULL)) (SYMBOL-TO-SURROGATE NAMESYMBOL)
      NULL))
    (TYPESYMBOL (%%VALUE (%%REST (%%REST TERM))))
    (TYPE
     (CL:IF (CL:NOT (CL:EQ TYPESYMBOL NULL)) (SYMBOL-TO-SURROGATE TYPESYMBOL)
      NULL))
    (TERM NULL))
...
(CL:DEFUN UPDATE-SKOLEM-TYPE (SELF TYPE)
  (CL:LET* ((OLDTYPE (%SKOLEM-TYPE SELF)))
   (CL:WHEN (CL:OR (CL:EQ OLDTYPE NULL) (LOGICAL-SUBTYPE-OF? TYPE OLDTYPE))
  ...
  (CL:LET* ((DESCRIPTIONS (NEW-LIST)) (SIZE STELLA::NULL-STRING))
   ...
   (CL:LET* ((DESC NULL) (ITER-001 (%THE-CONS-LIST (REVERSE DESCRIPTIONS))))
    (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-001 NIL)) DO
     ...
     (CL:SETQ SIZE
      (INTEGER-TO-STRING (CL:TRUNCATE (ESTIMATED-LENGTH (%EXTENSION DESC)))))
     (CL:SETQ SIZE
      (CONCATENATE
       (MAKE-STRING (CL:- 8 (CL:THE CL:FIXNUM (CL:LENGTH SIZE))) #\ ) SIZE))
...
(CL:DEFUN RETRACT-RELATION-AXIOMS (OLDRELATION)
  (CL:LET* ((ORIGINATEDPROPOSITIONS (ORIGINATED-PROPOSITIONS OLDRELATION)))
   (CL:WHEN (CL:NOT (CL:EQ ORIGINATEDPROPOSITIONS NULL))
    (CL:LET*
     ((PROPOSITION NULL) (ITER-000 (%THE-CONS-LIST ORIGINATEDPROPOSITIONS)))
     (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-000 NIL)) DO
...
(CL:DEFUN ASSERT-IMPLIES-LINK-BETWEEN-RELATIONS (SUB SUPER)
  (CL:LET*
   ((IMPLIESPROP (ASSERT-DESCRIPTION-IMPLIES-DESCRIPTION SUB SUPER CL:T)))
   (SET-DYNAMIC-SLOT-VALUE (%DYNAMIC-SLOTS IMPLIESPROP)
    SYM-PROPOSITIONS-LOGIC-SUBRELATION-LINK? TRUE-WRAPPER FALSE-WRAPPER)
   (UPDATE-PROPOSITION-TRUTH-VALUE IMPLIESPROP KWD-PROPOSITIONS-ASSERT-TRUE)
...
(CL:DEFUN RETRACT-ISA-PROPOSITION (SELF TYPE)
  (CL:IF (CL:NOT (CL:EQ TYPE NULL))
   (UPDATE-ISA-PROPOSITION SELF TYPE KWD-PROPOSITIONS-RETRACT-TRUE) NULL))
...
(CL:DEFUN UPDATE-PROPERTY (SELF SURROGATE UPDATEMODE)
  (CL:LET* ((VALUE-000 NULL))
   (CL:LET*
    ((P NULL)
     (ITER-000
      (ALLOCATE-ITERATOR (UNFILTERED-DEPENDENT-PROPOSITIONS SELF SURROGATE))))
    (CL:LOOP WHILE (NEXT? ITER-000) DO (CL:SETQ P (%VALUE ITER-000))
     (CL:WHEN
   ...
   (CL:LET* ((PROPERTYPROPOSITION VALUE-000))
    (CL:WHEN
     (CL:OR (CL:EQ SURROGATE NULL) (CL:EQ (%SURROGATE-VALUE SURROGATE) NULL))
...
(CL:DEFUN UPDATE-TUPLE (RELATION ARGUMENTS UPDATEMODE)
  ...
  (CL:LET*
   ((HOLDS? (CL:EQ RELATION SGT-PROPOSITIONS-PL-KERNEL-KB-HOLDS))
    ...
    (PROPOSITION NULL))
   (CL:WHEN HOLDS? (CL:SETQ RELATION (%SURROGATE-VALUE-INVERSE DESCRIPTION))
    ...
    (CL:PROGN
     (CL:WHEN (CL:NOT (CLASS-DESCRIPTION? DESCRIPTION))
      (CL:LET* ((STREAM-001 (NEW-OUTPUT-STRING-STREAM)))
       ...
       (CL:ERROR
        (NEW-OBJECT-NOT-CLASS-EXCEPTION (THE-STRING-READER STREAM-001)))))
     ...
     (CL:COND
      ...
      ((SUBTYPE-OF? (%CLASS-TYPE NATIVECLASS) SGT-PROPOSITIONS-STELLA-THING)
  ...
  (CL:HANDLER-CASE
   ...
   (OBJECT-ALREADY-EXISTS-EXCEPTION (EXISTS)
    (%%PRINT-STREAM (%NATIVE-STREAM STANDARD-OUTPUT)
     ...
     (%SYMBOL-NAME NAME) " will cause the existing" EOL "   object named "
...
(CL:DEFUN CLEANUP-STRUCTURED-OBJECTS-INDEX (CLEARMODULE)
  (CL:LET*
   ...
   (CL:LOOP WHILE (NEXT? ITER-000) DO (CL:SETQ KEY (%KEY ITER-000))
    ...
    (CL:WHEN (EMPTY? BUCKET) (REMOVE-AT *STRUCTURED-OBJECTS-INDEX* KEY)))))

;;; (DEFUN (PROPOSITION-HASH-INDEX INTEGER) ...)

(CL:DECLAIM
 (CL:FTYPE (CL:FUNCTION (CL:T CL:T CL:T) CL:FIXNUM) PROPOSITION-HASH-INDEX))
(CL:DEFUN PROPOSITION-HASH-INDEX (SELF MAPPING DEREFSURROGATES?)
  (CL:LET*
   ((MAPPED? (CL:NOT (CL:EQ MAPPING NULL)))
    ...
    (FUNCTIONOUTPUT
     (CL:IF (CL:AND MAPPED? (CL:EQ (%KIND SELF) KWD-PROPOSITIONS-FUNCTION))
      (LAST ARGUMENTS) NULL))
    ...
    (CL:LOOP WHILE (CL:< INDEX-000 LENGTH-000) DO
     ...
     (CL:WHEN (CL:AND (CL:NOT (CL:EQ *QUERYITERATOR* NULL)) (VARIABLE? ARG))
      (CL:LET* ((TEMP-000 (SAFE-BOUND-TO ARG)))
       (CL:SETQ ARG (CL:IF (CL:NOT (CL:EQ TEMP-000 NULL)) TEMP-000 ARG))))
         ...
         (CL:PROGN
          (CL:LET* ((DEFININGPROP (%DEFINING-PROPOSITION ARG)))
           (CL:IF
            ...
            (CL:SETQ ARGCODE
             (PROPOSITION-HASH-INDEX DEFININGPROP MAPPING DEREFSURROGATES?))
            (CL:SETQ ARGCODE
             (CL:LET ((SELF SGT-PROPOSITIONS-LOGIC-SKOLEM))
              (CL:THE CL:FIXNUM (STELLA::%%OBJECT-HASH-CODE SELF))))))))
        ((SUBTYPE-OF-SURROGATE? TEST-VALUE-001)
         (CL:PROGN
          (CL:WHEN DEREFSURROGATES? (CL:SETQ ARG (%SURROGATE-VALUE ARG)))
        ...
        (CL:T
         (CL:SETQ ARGCODE
          (CL:LET ((SELF ARG))
           (CL:THE CL:FIXNUM (STELLA::%%OBJECT-HASH-CODE SELF))))))))
     (CL:WHEN
      (CL:OR (CL:EQ PRIORARG NULL) (CL:NOT COMMUTATIVE?) (EQL? ARG PRIORARG))
      (CL:SETQ CODE
...
(CL:DEFUN FIND-DUPLICATE-COMPLEX-PROPOSITION (SELF)
  (CL:LET*
   ((INDEX (WRAP-INTEGER (PROPOSITION-HASH-INDEX SELF NULL CL:NIL)))
    (BUCKET (LOOKUP *STRUCTURED-OBJECTS-INDEX* INDEX)) (DUPLICATE NULL))
...
(CL:DEFUN FASTEN-DOWN-ONE-PROPOSITION (SELF DONTCHECKFORDUPLICATES?)
  ...
  (CL:LET* ((DUPLICATE NULL))
   (CL:WHEN
    (CL:NOT
     (CL:OR DONTCHECKFORDUPLICATES? *DONT-CHECK-FOR-DUPLICATE-PROPOSITIONS?*
   ...
   (CL:IF (CL:NOT (CL:EQ DUPLICATE NULL))
    ...
    (CL:PROGN
     ...
     (FINALIZE-PROPOSITION-ANNOTATIONS SELF) (EVALUATE-NEW-PROPOSITION SELF)
     SELF))))
         ...
         (CL:WHEN (COERCE-WRAPPED-BOOLEAN-TO-BOOLEAN (UNFASTENED? ARG))
          (CL:LET
           ((SELF (%THE-ARRAY (%ARGUMENTS SELF)))
            (VALUE
             (HELP-FASTEN-DOWN-PROPOSITIONS ARG DONTCHECKARGSFORDUPLICATES?))
            (POSITION I))
           (CL:DECLARE (CL:TYPE CL:SIMPLE-VECTOR SELF)
            (CL:TYPE CL:FIXNUM POSITION))
           (CL:SETF (CL:AREF SELF POSITION) VALUE)))))
         ...
         (CL:LET* ((DEFININGPROP (%DEFINING-PROPOSITION ARG)))
          (CL:WHEN
           (CL:AND (CL:NOT (CL:EQ DEFININGPROP NULL))
            ...
            (CL:NOT
             (MEMBER? *VISITEDUNFASTENEDDEFININGPROPOSITIONS* DEFININGPROP)))
  ...
  (CL:WHEN (ISA? TREE SGT-PROPOSITIONS-STELLA-STRING-WRAPPER)
   (CL:RETURN-FROM BUILD-TOP-LEVEL-PROPOSITION
    (BUILD-TOP-LEVEL-PROPOSITION
     (READ-S-EXPRESSION-FROM-STRING (%WRAPPER-VALUE TREE)) TRUEASSERTION?)))
  (CL:LET* ((PROPOSITION NULL) (LOGICVARIABLETABLE *LOGICVARIABLETABLE*))
   (CL:LET*
    ...
    (CL:WHEN (CL:NOT (CL:EQ PROPOSITION NULL))
     ...
     (CL:WHEN
      (CL:NOT (CL:EQ (COLLECT-UNRESOLVED-SLOT-REFERENCES PROPOSITION) NIL))
...
(CL:DEFUN SYMBOL.BUILD-PROPOSITION (SYMBOL)
  (CL:LET* ((PROPOSITION NULL))
   (CL:COND
    ...
    (CL:T
     (CL:RETURN-FROM SYMBOL.BUILD-PROPOSITION (EVALUATE-SYMBOL-TERM SYMBOL))))
   PROPOSITION))
...
(CL:DEFUN BUILD-ISA-PROPOSITION (TREE)
  ...
  (CL:LET*
   ...
   (CL:LET* ((TEST-VALUE-000 (SAFE-PRIMARY-TYPE SYMBOL)))
    (CL:COND
     ((SUBTYPE-OF-SURROGATE? TEST-VALUE-000) (CL:PROGN (CL:SETQ TYPE SYMBOL)))
     ((SUBTYPE-OF-SYMBOL? TEST-VALUE-000)
    ...
    (CL:WHEN (CL:EQ CLASS NULL)
     (CL:LET* ((STREAM-001 (NEW-OUTPUT-STRING-STREAM)))
      (CL:LET* ((*PRINTREADABLY?* CL:T))
       (CL:DECLARE (CL:SPECIAL *PRINTREADABLY?*))
       (%%PRINT-STREAM (%NATIVE-STREAM STREAM-001)
        "ERROR: No class is associated with the term `" (%SYMBOL-NAME TYPE)
        "'." EOL)
       (HELP-SIGNAL-PROPOSITION-ERROR STREAM-001 KWD-PROPOSITIONS-ERROR))
      (CL:ERROR (NEW-PROPOSITION-ERROR (THE-STRING-READER STREAM-001)))))
...
(CL:DEFUN REMOVE-ANNOTATION (PROPOSITION KEY)
  (CL:LET*
   ((ANNOTATIONS
     (DYNAMIC-SLOT-VALUE (%DYNAMIC-SLOTS PROPOSITION)
      SYM-PROPOSITIONS-LOGIC-ANNOTATIONS NULL)))
   (CL:WHEN (CL:EQ ANNOTATIONS NULL) (CL:RETURN-FROM REMOVE-ANNOTATION))
    ...
    (CL:LET* ((OPTION NULL) (VALUE NULL) (ITER-000 (%THE-PLIST ANNOTATIONS)))
     (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-000 NIL)) DO
      ...
      (CL:COND
             ...
             (CL:T (REMOVE-AT ANNOTATIONS OPTION)
              (CL:LET* ((STREAM-000 (NEW-OUTPUT-STRING-STREAM)))
               (CL:LET* ((*PRINTREADABLY?* CL:T))
                (CL:DECLARE (CL:SPECIAL *PRINTREADABLY?*))
                (%%PRINT-STREAM (%NATIVE-STREAM STREAM-000)
                 "PARSING ERROR: Illegal value for :direction option: `" VALUE
                 "'." EOL)
        ...
        (CL:LET* ((TEST-VALUE-001 (SAFE-PRIMARY-TYPE VALUE)))
         (CL:COND
          ...
          ((SUBTYPE-OF-FLOAT? TEST-VALUE-001)
           (CL:PROGN
            (SET-DYNAMIC-SLOT-VALUE (%DYNAMIC-SLOTS PROPOSITION)
             SYM-PROPOSITIONS-LOGIC-WEIGHT (WRAP-FLOAT (%WRAPPER-VALUE VALUE))
             NULL-FLOAT-WRAPPER)))
          (CL:T (REMOVE-AT ANNOTATIONS OPTION)
           (CL:LET* ((STREAM-002 (NEW-OUTPUT-STRING-STREAM)))
            (CL:LET* ((*PRINTREADABLY?* CL:T))
             (CL:DECLARE (CL:SPECIAL *PRINTREADABLY?*))
             (%%PRINT-STREAM (%NATIVE-STREAM STREAM-002)
              "PARSING ERROR: Illegal value for :weight option: `" VALUE "'."
              EOL)
       ...
       (CL:T
        (CL:WHEN (CL:NOT (RUN-OPTION-HANDLER? PROPOSITION OPTION VALUE))
     ...
     (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-000 NIL)) DO
      ...
      (CL:COND
       ((CL:EQ OPTION KWD-PROPOSITIONS-DIRECTION)
        ...
        (SET-DYNAMIC-SLOT-VALUE (%DYNAMIC-SLOTS PROPOSITION)
         SYM-PROPOSITIONS-LOGIC-BACKWARD-ONLY? FALSE-WRAPPER FALSE-WRAPPER))
       ((CL:EQ OPTION KWD-PROPOSITIONS-WEIGHT)
        (SET-DYNAMIC-SLOT-VALUE (%DYNAMIC-SLOTS PROPOSITION)
   ...
   (CL:LET*
    ((ARG NULL)
     (VECTOR-000
      (%ARGUMENTS
       (CL:AREF
        (CL:THE CL:SIMPLE-VECTOR (%THE-ARRAY (%ARGUMENTS EXISTSPROPOSITION)))
        0)))
...
(CL:DEFUN BUILD-AND-OR-NOT-PROPOSITION (TREE)
  (CL:LET*
   ...
   (CL:LET* ((ARG NULL) (ITER-001 ARGUMENTS) (I NULL-INTEGER) (ITER-002 0))
...
(CL:DEFUN BUILD-COLLECT-INTO-PROPOSITION (TREE)
  (CL:LET*
   ...
   (CL:LET
    ((SELF (%THE-ARRAY ARGUMENTSVECTOR))
     (VALUE (EVALUATE-TERM (%%VALUE (%%REST (%%REST TREE))))) (POSITION 1))
    (CL:DECLARE (CL:TYPE CL:SIMPLE-VECTOR SELF) (CL:TYPE CL:FIXNUM POSITION))
    (CL:SETF (CL:AREF SELF POSITION) VALUE))
   PROPOSITION))
...
(CL:DEFUN BUILD-HOLDS-PROPOSITION (TREE)
  (CL:LET*
   ...
   (CL:WHEN EXPLICITHOLDS?
    (CL:LET*
     ((ARG NULL) (ITER-000 (%%REST TREE)) (I NULL-INTEGER) (ITER-001 0))
     (CL:DECLARE (CL:TYPE CL:FIXNUM I ITER-001))
     (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-000 NIL)) DO
      (CL:SETQ ARG (%%VALUE ITER-000)) (CL:SETQ I ITER-001)
      (CL:LET
       ((SELF (%THE-ARRAY (%ARGUMENTS PROPOSITION)))
        (VALUE
         (CL:IF (CL:= I 0)
          (EVALUATE-FIRST-ARGUMENT ARG SYM-PROPOSITIONS-PL-KERNEL-KB-HOLDS)
          (EVALUATE-TERM ARG)))
        (POSITION I))
       (CL:DECLARE (CL:TYPE CL:SIMPLE-VECTOR SELF)
        (CL:TYPE CL:FIXNUM POSITION))
   ...
   (CL:LET* ((OPERATOR NULL))
    ...
    (CL:LET
     ...
     (CL:SETF (CL:AREF SELF POSITION) VALUE))
    (CL:LET*
     ((ARG NULL) (ITER-002 (%%REST TREE)) (I NULL-INTEGER) (ITER-003 1))
...
(CL:DEFUN NON-POLYMORPHIC-PREDICATE? (SELF)
  (CL:LET* ((TEST-VALUE-000 (SAFE-PRIMARY-TYPE SELF)))
   (CL:COND
    ...
    ((SUBTYPE-OF? TEST-VALUE-000 SGT-PROPOSITIONS-LOGIC-LOGIC-OBJECT)
     (CL:PROGN
      (CL:NOT (TEST-ISA? SELF SGT-PROPOSITIONS-PL-KERNEL-KB-POLYMORPHIC))))
    (CL:T
     (CL:LET* ((STREAM-000 (NEW-OUTPUT-STRING-STREAM)))
      (%%PRINT-STREAM (%NATIVE-STREAM STREAM-000) "`" TEST-VALUE-000
       "' is not a valid case option")
...
(CL:DEFUN PROPOSITIONAL-ARGUMENT? (ARGUMENT)
  (CL:COND
   ((CL:EQ (SAFE-PRIMARY-TYPE ARGUMENT) SGT-PROPOSITIONS-STELLA-CONS)
    (CL:PROGN
     (CL:LET*
      ((OPERATOR (%%VALUE ARGUMENT)) (FIRSTARG (%%VALUE (%%REST ARGUMENT))))
      (CL:WHEN
       (CL:AND (CL:NOT (CL:EQ OPERATOR SYM-PROPOSITIONS-PL-KERNEL-KB-VALUE))
      ...
      (CL:WHEN (SYMBOL? OPERATOR)
       (CL:LET* ((TEST-VALUE-000 OPERATOR))
        (CL:COND
         ...
         (CL:T
          (CL:LET*
           ((PREDICATE (EVALUATE-PREDICATE OPERATOR FIRSTARG)) (ARITY 0))
    ...
    ((CL:EQ TEST-VALUE-000 SGT-PROPOSITIONS-STELLA-CONS)
     (CL:PROGN
      (CL:LET* ((PREDICATE NULL) (FIRSTARGUMENT NULL))
       ...
       (CL:IF
        (CL:AND (FUNCTION? PREDICATE) (CL:= (ARITY PREDICATE) (LENGTH TREE)))
          ...
          (CL:LET*
           ...
           (CL:LOOP WHILE (CL:<= ITER-000 UPPER-BOUND-000) DO
            ...
            (CL:WHEN
             (VARIABLE?
              (CL:AREF
               (CL:THE CL:SIMPLE-VECTOR (%THE-ARRAY (%ARGUMENTS FNPROP))) I))
             (CL:SETQ FOUND?-000 CL:T) (CL:RETURN))
            (CL:SETQ ITER-000 (CL:1+ ITER-000))))
          (CL:SETQ TEST-VALUE-000 FOUND?-000))
         (CL:SETQ TEST-VALUE-000 (CL:NOT TEST-VALUE-000)))
        ...
        (CL:LET* ((ARG HEAD-000))
         (CL:WHEN (CL:NOT (CL:EQ ARG NULL))
          (CL:SETQ EVALUATEDARGUMENTS
           (CONS (EVALUATE-TYPED-ARGUMENT ARG TYPE) EVALUATEDARGUMENTS)))))
       (CL:SETQ ITER-000 (%%REST ITER-000))))
...
(CL:DEFUN BUILD-PREDICATE-PROPOSITION (TREE)
  ...
  (CL:WHEN (HOLDS-OPERATOR? (%%VALUE TREE))
   (CL:RETURN-FROM BUILD-PREDICATE-PROPOSITION (BUILD-HOLDS-PROPOSITION TREE)))
  (CL:LET*
   ...
   (CL:WHEN (CL:NOT (CL:EQ FIRSTARGUMENT NULL))
    ...
    (CL:LET
     ...
     (CL:SETF (CL:AREF SELF POSITION) VALUE)))
   (CL:WHEN
    (CL:AND (CL:NOT (CL:EQ PREDICATEVALUE NULL)) (FUNCTION? PREDICATEVALUE))
    (CL:IF (DESCRIPTION-MODE?)
     ...
     (CL:LET*
      ...
      (NTH-SETTER TREE NULL LASTARGINDEX) (CL:SETQ TREE (REMOVE TREE NULL))
      (CL:RETURN-FROM BUILD-PREDICATE-PROPOSITION
       (BUILD-PROPOSITION
        (LIST* SYM-PROPOSITIONS-STELLA-= TREE (CONS RESULTARGUMENT NIL)))))))
   (CL:LET*
    ((ARG NULL)
     (ITER-000
    ...
    (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-000 NIL)) DO
     (CL:SETQ ARG (%%VALUE ITER-000)) (CL:SETQ I ITER-001)
     (CL:LET
      ((SELF (%THE-ARRAY (%ARGUMENTS PROPOSITION))) (VALUE ARG) (POSITION I))
      (CL:DECLARE (CL:TYPE CL:SIMPLE-VECTOR SELF)
       (CL:TYPE CL:FIXNUM POSITION))
      (CL:SETF (CL:AREF SELF POSITION) VALUE))
     (CL:SETQ ITER-000 (%%REST ITER-000))
  ...
  (CL:LET* ((TEST-VALUE-000 (SAFE-PRIMARY-TYPE SELF)))
   (CL:COND
    ...
    ((SUBTYPE-OF? TEST-VALUE-000 SGT-PROPOSITIONS-STELLA-LITERAL-WRAPPER)
     (CL:PROGN
      (CL:WHEN
       (CL:AND (ISA? (%SURROGATE-VALUE TYPE) SGT-PROPOSITIONS-STELLA-CLASS)
     ...
     ((SUBTYPE-OF-FLOAT? TEST-VALUE-000)
      (CL:PROGN
       (CL:WHEN (CL:EQ TYPE SGT-PROPOSITIONS-STELLA-INTEGER)
        (CL:LET*
         ((FLOATVALUE (%WRAPPER-VALUE VALUE)) (INTVALUE (FLOOR FLOATVALUE)))
...
(CL:DEFUN VERIFY-ONE-ARGUMENT-TYPE (ARG TYPE PROPOSITION DESCRIPTION)
  (CL:WHEN
   (CL:OR (CL:EQ *TYPECHECKMODE* KWD-PROPOSITIONS-IGNORE-TYPE-VIOLATIONS)
    (CL:EQ (%SURROGATE-VALUE TYPE) NULL))
   (CL:RETURN-FROM VERIFY-ONE-ARGUMENT-TYPE))
  (CL:LET*
   ((ARGVALUE (VALUE-OF ARG)) (TYPEISOK? CL:NIL) (SUBSTITUTEVALUE NULL))
   ...
   (CL:COND
    ((CL:NOT (EQL? ARGVALUE SUBSTITUTEVALUE))
     (CL:LET*
      ((ARGTOO NULL) (VECTOR-000 (%ARGUMENTS PROPOSITION)) (INDEX-000 0)
       (LENGTH-000 (LENGTH VECTOR-000)) (T NULL)
      ...
      (CL:LOOP WHILE
       ...
       (CL:WHEN (CL:AND (EQL? ARGTOO ARG) (CL:EQ T TYPE))
        (CL:LET
         ((SELF (%THE-ARRAY (%ARGUMENTS PROPOSITION))) (VALUE SUBSTITUTEVALUE)
          (POSITION I))
         (CL:DECLARE (CL:TYPE CL:SIMPLE-VECTOR SELF)
          (CL:TYPE CL:FIXNUM POSITION))
         (CL:SETF (CL:AREF SELF POSITION) VALUE)))
    ...
    (CL:COND
     ((CL:OR (CL:EQ TEST-VALUE-000 KWD-PROPOSITIONS-PREDICATE)
      ...
      (CL:LET*
       ...
       (CL:DECLARE (CL:TYPE CL:FIXNUM ARITY))
       (CL:WHEN
        (CL:AND (CL:NOT VARIABLEARITY?) (CL:NOT (CL:= ARGUMENTCOUNT ARITY)))
       ...
       (CL:LET*
        ...
        (CL:DECLARE (CL:TYPE CL:FIXNUM INDEX-000 LENGTH-000))
        (CL:LOOP WHILE
         (CL:AND (CL:< INDEX-000 LENGTH-000) (NEXT? I) (NEXT? ITER-000)) DO
         (CL:SETQ ARG
          (CL:AREF (CL:THE CL:SIMPLE-VECTOR (%THE-ARRAY VECTOR-000))
           INDEX-000))
         (CL:SETQ TYPE (%VALUE ITER-000))
       ...
       (CL:WHEN FUNCTION?
        (VERIFY-ONE-ARGUMENT-TYPE (LAST (%ARGUMENTS PROPOSITION))
         (LAST (%IO-VARIABLE-TYPES DESCRIPTION)) PROPOSITION DESCRIPTION))))
     ((CL:EQ TEST-VALUE-000 KWD-PROPOSITIONS-EQUIVALENT)
      (CL:LET*
       ((ARG1
         (CL:AREF
  ...
  (CL:COND
   ...
   ((CL:EQ *TYPECHECKMODE* KWD-PROPOSITIONS-REPORT-TYPE-VIOLATIONS)
    (CL:LET* ((*PRINTREADABLY?* CL:T))
     (CL:DECLARE (CL:SPECIAL *PRINTREADABLY?*))
     (%%PRINT-STREAM (%NATIVE-STREAM STANDARD-WARNING)
      "WARNING: Type check violation on argument `" ARG "' in proposition" EOL
      "   " PROPOSITION "." EOL "   Argument must have type `"
   ...
   ((CL:EQ *TYPECHECKMODE* KWD-PROPOSITIONS-SIGNAL-TYPE-VIOLATIONS)
    (CL:LET* ((STREAM-000 (NEW-OUTPUT-STRING-STREAM)))
     (CL:LET* ((*PRINTREADABLY?* CL:T))
      (CL:DECLARE (CL:SPECIAL *PRINTREADABLY?*))
      (%%PRINT-STREAM (%NATIVE-STREAM STREAM-000)
       "ERROR: Type check violation on argument ``" ARG "'' in proposition"
    ...
    (CL:LET* ((STREAM-000 (NEW-OUTPUT-STRING-STREAM)))
     (CL:LET* ((*PRINTREADABLY?* CL:T))
      ...
      (%%PRINT-STREAM (%NATIVE-STREAM STREAM-000) "ERROR: Too `"
       (CL:IF (CL:> (LENGTH (%ARGUMENTS PROPOSITION)) REQUIREDARITY) "many"
        "few")
       "' arguments in the proposition" EOL "   `" (GENERATE-TERM PROPOSITION)
       "'" EOL "   Expected `" REQUIREDARITY "' argument(s).." EOL)
      (HELP-SIGNAL-PROPOSITION-ERROR STREAM-000 KWD-PROPOSITIONS-ERROR))
     (CL:ERROR (NEW-PROPOSITION-ERROR (THE-STRING-READER STREAM-000)))))
   (CL:T
    (CL:LET* ((STREAM-001 (NEW-OUTPUT-STRING-STREAM)))
...
(CL:DEFUN POST-TO-CHECK-TYPES-AGENDA (SELF)
  (CL:LET* ((LENGTH (%SEQUENCE-LENGTH *CHECK-TYPES-AGENDA*)))
   ...
   (CL:WHEN
    (CL:OR (CL:= LENGTH 0)
     (CL:NOT
      (CL:EQ SELF
       (%PROPOSITION
        (CL:AREF (CL:THE CL:SIMPLE-VECTOR (%THE-ARRAY *CHECK-TYPES-AGENDA*))
   ...
   (CL:WHEN (CL:= (MOD LENGTH 100000) 0)
    (CL:LET* ((*PRINTREADABLY?* CL:T))
     (CL:DECLARE (CL:SPECIAL *PRINTREADABLY?*))
     (%%PRINT-STREAM (%NATIVE-STREAM STANDARD-WARNING) "WARNING: Queued "
      LENGTH " type violations, consider running `(process-definitions)'" EOL)
     (HELP-SIGNAL-PROPOSITION-ERROR STANDARD-WARNING
      KWD-PROPOSITIONS-WARNING)))))
...
(CL:DEFUN HELP-COLLECT-SKOLEMIZED-EXISTS-VARIABLES? (PROPOSITION RESULT)
  (CL:LET*
   ((ARGUMENTS (%ARGUMENTS PROPOSITION)) (ARGUMENTCOUNT (LENGTH ARGUMENTS)))
   (CL:DECLARE (CL:TYPE CL:FIXNUM ARGUMENTCOUNT))
        ...
        (CL:PROGN
         (CL:LET* ((FOUND?-000 CL:NIL))
          (CL:LET*
           ((PROP NULL)
            (ITER-001
             (ALLOCATE-ITERATOR (UNFILTERED-DEPENDENT-ISA-PROPOSITIONS ARG))))
   ...
   (CL:LET* ((VARIABLES NULL) (ANTECEDENT NULL) (CONSEQUENT NULL))
    ...
    (CL:LET
     ((SELF (%THE-ARRAY (%ARGUMENTS FORALLPROP)))
      (VALUE
       (CL:IF (CL:NOT (CL:EQ ANTECEDENT NULL)) ANTECEDENT TRUE-PROPOSITION))
      (POSITION 0))
     (CL:DECLARE (CL:TYPE CL:SIMPLE-VECTOR SELF) (CL:TYPE CL:FIXNUM POSITION))
     (CL:SETF (CL:AREF SELF POSITION) VALUE))
    (CL:LET
       ...
       (CL:LET*
        ...
        (CL:LET* ((*PRINTREADABLY?* CL:T))
         ...
         (%%PRINT-STREAM (%NATIVE-STREAM STANDARD-WARNING)
          ...
          EOL "   are not restricted/used by the antecedent: " EOL PROPOSITION
          EOL)
         (HELP-SIGNAL-PROPOSITION-ERROR STANDARD-WARNING
          KWD-PROPOSITIONS-WARNING))))))
    ((CL:EQ TEST-VALUE-000 KWD-PROPOSITIONS-AND)
...
(CL:DEFUN BEGIN-CREATING-FUNCTION-PROPOSITION (SURROGATE INPUTARGUMENTS)
  (CL:LET*
   ...
   (CL:LET*
    ((ARG NULL) (ITER-000 INPUTARGUMENTS) (I NULL-INTEGER) (ITER-001 0))
    (CL:DECLARE (CL:TYPE CL:FIXNUM I ITER-001))
    (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-000 NIL)) DO
     (CL:SETQ ARG (%%VALUE ITER-000)) (CL:SETQ I ITER-001)
     (CL:LET
      ...
      (CL:LET*
       ...
       (CL:LOOP WHILE (CL:<= ITER-000 UPPER-BOUND-000) DO (CL:SETQ I ITER-000)
        (CL:WHEN
         (VARIABLE?
          (CL:AREF
           (CL:THE CL:SIMPLE-VECTOR (%THE-ARRAY (%ARGUMENTS PROPOSITION))) I))
         (CL:SETQ ALWAYS?-000 CL:NIL) (CL:RETURN))
        (CL:SETQ ITER-000 (CL:1+ ITER-000))))
...
(CL:DEFUN EVALUATE-FUNCTION-TERM (TREE)
  (CL:WHEN
   (CL:NOT (ISA? (%%VALUE TREE) SGT-PROPOSITIONS-STELLA-GENERALIZED-SYMBOL))
   (CL:LET* ((STREAM-000 (NEW-OUTPUT-STRING-STREAM)))
    (CL:LET* ((*PRINTREADABLY?* CL:T))
     (CL:DECLARE (CL:SPECIAL *PRINTREADABLY?*))
     (%%PRINT-STREAM (%NATIVE-STREAM STREAM-000)
  ...
  (CL:LET*
    ...
    (CL:LET* ((STREAM-001 (NEW-OUTPUT-STRING-STREAM)))
     (CL:LET* ((*PRINTREADABLY?* CL:T))
      ...
      (%%PRINT-STREAM (%NATIVE-STREAM STREAM-001) "ERROR: Relation `"
       (DESCRIPTION-NAME PREDICATEVALUE) "' found in function position.." EOL)
      (HELP-SIGNAL-PROPOSITION-ERROR STREAM-001 KWD-PROPOSITIONS-ERROR))
     (CL:ERROR (NEW-PROPOSITION-ERROR (THE-STRING-READER STREAM-001)))))
   ...
   (CL:LET*
    ...
    (CL:AREF
     (CL:THE CL:SIMPLE-VECTOR (%THE-ARRAY (%ARGUMENTS FUNCTIONPROPOSITION)))
      ...
      (CL:LET* ((FOUND?-001 CL:NIL))
       (CL:LET* ((SK NULL) (ITER-001 (VARIABLE-VALUE-INVERSE INDIVIDUAL)))
        (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-001 NIL)) DO
         ...
         (CL:WHEN (EXTENSIONAL-INDIVIDUAL? SK) (CL:SETQ FOUND?-001 CL:T)
          (CL:RETURN))
         (CL:SETQ ITER-001 (%%REST ITER-001))))
      ...
      (CL:PROGN
       (CL:WHEN
        (CL:AND (CL:NOT (CL:EQ (%SKOLEM-TYPE LASTARGUMENT) NULL))
         (CL:NOT
          (CL:EQ (%SKOLEM-TYPE LASTARGUMENT) SGT-PROPOSITIONS-STELLA-THING)))
        (CL:LET*
         ((*EVALUATIONMODE* KWD-PROPOSITIONS-EXTENSIONAL-ASSERTION)
...
(CL:DEFUN CREATE-ENUMERATED-SET (SET)
  (CL:LET*
   ((SETELEMENTS (NORMALIZE-SETOF-ARGUMENTS (%THE-CONS-LIST SET)))
    (SETPROP
     (BEGIN-CREATING-FUNCTION-PROPOSITION SGT-PROPOSITIONS-PL-KERNEL-KB-SETOF
      SETELEMENTS))
    (DUPLICATE
     (CL:IF (CL:NOT (DESCRIPTION-MODE?))
...
(CL:DEFUN CREATE-LOGICAL-LIST (LIST)
  (CL:LET*
   ((LISTPROP
     (BEGIN-CREATING-FUNCTION-PROPOSITION SGT-PROPOSITIONS-PL-KERNEL-KB-LISTOF
      (%THE-CONS-LIST LIST)))
    (DUPLICATE
     (CL:IF (CL:NOT (DESCRIPTION-MODE?))
  ...
  (CL:LET*
   ...
   (CL:WHEN
    ...
    (CL:RETURN-FROM UPDATE-EQUIVALENCE-PROPOSITION
     (CL:IF (DELETED? PROPOSITION) NULL (%DEFINING-PROPOSITION TERM1))))
   (CL:WHEN
    (CL:AND (FUNCTION-OUTPUT-SKOLEM? TERM2)
     (CL:NOT (FUNCTION-OUTPUT-SKOLEM? TERM1)))
    (RUN-UPDATE-PROPOSITION-DEMON PROPOSITION UPDATEMODE)
    (CL:RETURN-FROM UPDATE-EQUIVALENCE-PROPOSITION
     (CL:IF (DELETED? PROPOSITION) NULL (%DEFINING-PROPOSITION TERM2))))
   NULL))
...
(CL:DEFUN HELP-UPDATE-TOP-LEVEL-PROPOSITION (PROPOSITION UPDATEMODE)
  ...
  (CL:WHEN
   (CL:EQ (LOOKUP-ANNOTATION PROPOSITION KWD-PROPOSITIONS-CONFIDENCE-LEVEL)
      ...
      (CL:LET*
       ...
       (CL:COND
        ((CL:OR (CL:EQ UPDATEMODE KWD-PROPOSITIONS-ASSERT-TRUE)
         ...
         (DESTROY-REDUNDANT-PROPOSITION PROPOSITION)
         (CL:IF
          (CL:AND (CL:NOT (CL:EQ ARGUMENT NULL)) (CL:NOT (DELETED? ARGUMENT)))
          (CL:RETURN-FROM HELP-UPDATE-TOP-LEVEL-PROPOSITION
           (CONS-LIST ARGUMENT))
          (CL:RETURN-FROM HELP-UPDATE-TOP-LEVEL-PROPOSITION NIL)))
        (CL:T))))
    ...
    (CL:COND
     ((CL:EQ (SAFE-PRIMARY-TYPE TREE) SGT-PROPOSITIONS-STELLA-CONS)
      (CL:PROGN
       (CL:WHEN
        (MEMBER?
         (GET-QUOTED-TREE "((FORALL EXISTS IMPLIES AND OR NOT) \"/LOGIC\")"
          "/LOGIC")
         (%%VALUE TREE))
...
newly-conceived) term representing the internalized representation of that term."
  (CL:HANDLER-CASE
   (CL:LET*
    ((STANDARDIZEDTREE (STANDARDIZE-PROPOSITION-TREE TREE)) (OPERATOR NULL)
     (TERM NULL))
  ...
  (CL:LET* ((TEST-VALUE-001 (SAFE-PRIMARY-TYPE TREE)))
   (CL:COND
    ...
    ((SUBTYPE-OF-SURROGATE? TEST-VALUE-001)
     (CL:PROGN
      (CONCEIVE-TERM
       (INTERN-SYMBOL-IN-MODULE (%SYMBOL-NAME TREE) (%HOME-CONTEXT TREE)
        CL:T))))
...
already be defined."
  (CL:LET*
   ((PARSEDPROPS (UPDATE-PROPOSITION PROPOSITION KWD-PROPOSITIONS-CONCEIVE))
    (RESULT NIL))
   ...
   (CL:LET* ((EQUIVALENCE? (CL:EQ (%KIND SELF) KWD-PROPOSITIONS-EQUIVALENT)))
    (CL:COND
     ...
     ((INCONSISTENT? SELF)
      (CL:COND
       (EQUIVALENCE?
        (DEASSIGN-TRUTH-VALUE SELF KWD-PROPOSITIONS-RETRACT-INCONSISTENT)
        (UPDATE-EQUIVALENCE-PROPOSITION SELF KWD-PROPOSITIONS-RETRACT-TRUE)
        (UPDATE-EQUIVALENCE-PROPOSITION SELF KWD-PROPOSITIONS-RETRACT-FALSE))
...
Also, destroy all satellite propositions of 'proposition'."
  ...
  (CL:LET*
   ...
   (CL:LOOP WHILE (CL:< INDEX-000 LENGTH-000) DO
    ...
    (CL:WHEN (CL:AND (CL:NOT (CL:EQ ARG NULL)) (CL:NOT (DELETED? ARG)))
     (CL:WHEN
      (CL:AND (SKOLEM? ARG) (CL:EQ (%DEFINING-PROPOSITION ARG) PROPOSITION))
      (DESTROY-TERM ARG))
     (REMOVE-DEPENDENT-PROPOSITION-LINK ARG PROPOSITION))
    (CL:SETQ INDEX-000 (CL:1+ INDEX-000))))
  (CL:LET*
  ...
  (CL:LET*
   ((SATELLITE NULL)
    (ITER-001 (%THE-CONS-LIST (COPY (SATELLITE-PROPOSITIONS PROPOSITION)))))
   (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-001 NIL)) DO
    (CL:SETQ SATELLITE (%%VALUE ITER-001)) (DESTROY-PROPOSITION SATELLITE)
    (CL:SETQ ITER-001 (%%REST ITER-001))))
  (CL:WHEN
   (CL:NOT
    (CL:EQ
    ...
    (CL:PROGN (UNLINK-EQUIVALENT-VALUE SELF)
     ...
     (CL:LET*
      ((OBJECT-002 SELF) (VALUE-002 NULL)
       (OLD-VALUE-002 (%VARIABLE-VALUE-INVERSE OBJECT-002))
       (NEW-VALUE-002
        (UPDATE-IN-CONTEXT OLD-VALUE-002 VALUE-002 (%HOME-CONTEXT OBJECT-002)
         CL:NIL)))
      (CL:WHEN
       (CL:NOT
        (CL:AND (CL:NOT (CL:EQ OLD-VALUE-002 NULL))
  ...
  (CL:COND
   ((SUBTYPE-OF? (SAFE-PRIMARY-TYPE SELF) SGT-PROPOSITIONS-LOGIC-DESCRIPTION)
    (CL:PROGN
     ...
     (CL:SETF (%PROPOSITION SELF) NULL) (CL:SETF (%HOME-CONTEXT SELF) NULL)))
   (CL:T))
...
(CL:DEFUN CLEAR-LOGIC-MODULE-HOOK (MODULE)
  (CL:LET* ((*MODULE* MODULE) (*CONTEXT* *MODULE*))
   ...
   (CL:LET* ((PROPOSITION NULL) (ITER-001 (ALL-PROPOSITIONS MODULE CL:T)))
    (CL:LOOP WHILE (NEXT? ITER-001) DO (CL:SETQ PROPOSITION (%VALUE ITER-001))
     (DESTROY-PROPOSITION PROPOSITION)))
...
(CL:DEFUN DO-CLEAR-INSTANCES (MODULE)
  ...
  (CL:LET* ((*MODULE* MODULE) (*CONTEXT* *MODULE*))
   ...
   (CL:LET* ((INSTANCE NULL) (ITER-001 (ALL-INSTANCES MODULE CL:T)))
    (CL:LOOP WHILE (NEXT? ITER-001) DO (CL:SETQ INSTANCE (%VALUE ITER-001))
    ...
    (CL:LET* ((MOD NULL) (ITER-000 (%THE-CONS-LIST MODULES)))
     (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-000 NIL)) DO
      ...
      (SET-DYNAMIC-SLOT-VALUE (%DYNAMIC-SLOTS MOD)
       ...
       FALSE-WRAPPER)
      (CL:LET*
       ((SUB NULL) (ITER-001 (ALL-SUBCONTEXTS MOD KWD-PROPOSITIONS-PREORDER)))
...
(CL:DEFUN CONS-LESS-THAN? (O1 O2)
  (CL:LET* ((I1 NULL) (ITER-000 O1) (I2 NULL) (ITER-001 O2))
   (CL:LOOP WHILE
    ...
    (CL:WHEN (LOGIC-FORM-LESS? I2 I1) (CL:RETURN-FROM CONS-LESS-THAN? CL:NIL))
...
(CL:DEFUN SAFE-QUANTITY-GREATER-EQUAL? (Q1 O2)
  (CL:COND
   ((CL:AND (CL:NOT (CL:EQ Q1 NULL)) (CL:NOT (CL:EQ O2 NULL)))
    (CL:HANDLER-CASE
     (CL:RETURN-FROM SAFE-QUANTITY-GREATER-EQUAL? (GREATER-EQUAL? Q1 O2))
     (INCOMPATIBLE-QUANTITY-EXCEPTION () CL:NIL)))
   ((CL:NOT (CL:EQ O2 NULL)) CL:NIL) (CL:T CL:T)))
...
(CL:DEFUN PROPOSITION-LESS-THAN? (P1 P2)
  (CL:LET*
   ((OPERATOR1 (%SYMBOL-NAME (%OPERATOR P1)))
    (OPERATOR2 (%SYMBOL-NAME (%OPERATOR P2))) (ARGUMENTS1 (%ARGUMENTS P1))
    (ARGUMENTS2 (%ARGUMENTS P2)) (END1 (CL:1- (LENGTH ARGUMENTS1)))
   ...
   (CL:WHEN (STRING-LESS? OPERATOR1 OPERATOR2)
    (CL:RETURN-FROM PROPOSITION-LESS-THAN? CL:T))
   (CL:WHEN (STRING-LESS? OPERATOR2 OPERATOR1)
    (CL:RETURN-FROM PROPOSITION-LESS-THAN? CL:NIL))
   (CL:LET*
    ((I1 NULL-INTEGER) (ITER-000 0) (UPPER-BOUND-000 END1)
     (UNBOUNDED?-000 (CL:= UPPER-BOUND-000 NULL-INTEGER)) (I2 NULL-INTEGER)
     (ITER-001 0) (UPPER-BOUND-001 END2)
    ...
    (CL:LOOP WHILE
     ...
     (CL:WHEN
      (CL:AND (CL:= I1 END1) (CL:= I2 END2) (FUNCTION-OUTPUT-SKOLEM? A1)
       (FUNCTION-OUTPUT-SKOLEM? A2) (CL:EQ (%DEFINING-PROPOSITION A1) P1)
...
(CL:DECLAIM
 (CL:FTYPE (CL:FUNCTION (CL:T) CL:SIMPLE-STRING) PROPOSITION-HEAD-SORT-STRING))
(CL:DEFUN PROPOSITION-HEAD-SORT-STRING (P)
  (CL:COND
   ((CL:EQ (%KIND P) KWD-PROPOSITIONS-IMPLIES)
    (CL:IF
     (CL:AND
      (ISA? (CL:AREF (CL:THE CL:SIMPLE-VECTOR (%THE-ARRAY (%ARGUMENTS P))) 0)
       SGT-PROPOSITIONS-LOGIC-DESCRIPTION)
      (ISA? (CL:AREF (CL:THE CL:SIMPLE-VECTOR (%THE-ARRAY (%ARGUMENTS P))) 1)
       SGT-PROPOSITIONS-LOGIC-DESCRIPTION))
     "FORALL" "SUBSET-OF"))
...
(CL:DEFUN OBJECT-SORT-STRING (O)
  ...
  (CL:LET* ((TEST-VALUE-000 (SAFE-PRIMARY-TYPE O)))
   (CL:COND ((SUBTYPE-OF-INTEGER? TEST-VALUE-000) (CL:PROGN (STRINGIFY O)))
    ...
    ((SUBTYPE-OF? TEST-VALUE-000 SGT-PROPOSITIONS-STELLA-GENERALIZED-SYMBOL)
     (CL:PROGN (%SYMBOL-NAME O)))
    ((SUBTYPE-OF? TEST-VALUE-000 SGT-PROPOSITIONS-LOGIC-SKOLEM)
     (CL:PROGN
      (CL:LET*
       ((VAL
         (ACCESS-IN-CONTEXT (%VARIABLE-VALUE O) (%HOME-CONTEXT O) CL:NIL)))
    ...
    (CL:T
     (CL:WHEN (CL:EQ (HOME-MODULE (PRIMARY-TYPE O)) *LOGIC-MODULE*)
      (CL:WARN
       "OBJECT-SORT-STRING: Doesn't specifically handle object `~A' yet!" O))
     (STRINGIFY O)))))
...
`null' follows all other values."
  ...
  (CL:WHEN (ISA? O1 SGT-PROPOSITIONS-LOGIC-SKOLEM)
   (CL:LET*
    ((VALUE
      (ACCESS-IN-CONTEXT (%VARIABLE-VALUE O1) (%HOME-CONTEXT O1) CL:NIL)))
    (CL:COND ((CL:NOT (CL:EQ VALUE NULL)) (CL:SETQ O1 VALUE))
     ((FUNCTION-OUTPUT-SKOLEM? O1) (CL:SETQ O1 (%DEFINING-PROPOSITION O1)))
     (CL:T (CL:SETQ O1 (%SKOLEM-NAME O1))))))
  (CL:WHEN (ISA? O2 SGT-PROPOSITIONS-LOGIC-SKOLEM)
   (CL:LET*
    ((VALUE
      (ACCESS-IN-CONTEXT (%VARIABLE-VALUE O2) (%HOME-CONTEXT O2) CL:NIL)))
    (CL:COND ((CL:NOT (CL:EQ VALUE NULL)) (CL:SETQ O2 VALUE))
     ((FUNCTION-OUTPUT-SKOLEM? O2) (CL:SETQ O2 (%DEFINING-PROPOSITION O2)))
      ...
      (CL:LET* ((TEST-VALUE-000 (SAFE-PRIMARY-TYPE O2)))
       (CL:COND
        ...
        ((SUBTYPE-OF? TEST-VALUE-000
          SGT-PROPOSITIONS-LOGIC-QUANTITY-LOGIC-WRAPPER)
         (CL:PROGN
          (CL:NOT (SAFE-QUANTITY-GREATER-EQUAL? (%WRAPPER-VALUE O2) O1))))
        (CL:T CL:T)))))
      ...
      (CL:LET* ((TEST-VALUE-002 (SAFE-PRIMARY-TYPE O2)))
       (CL:COND
        ((SUBTYPE-OF? TEST-VALUE-002
          SGT-PROPOSITIONS-LOGIC-QUANTITY-LOGIC-WRAPPER)
         (CL:PROGN
          (SAFE-QUANTITY-LESS? (%WRAPPER-VALUE O1) (%WRAPPER-VALUE O2))))
    ...
    ((SUBTYPE-OF? TEST-VALUE-005 SGT-PROPOSITIONS-LOGIC-PROPOSITION)
     (CL:PROGN
      (CL:LET* ((TEST-VALUE-003 (SAFE-PRIMARY-TYPE O2)))
       (CL:COND
        ((SUBTYPE-OF? TEST-VALUE-003 SGT-PROPOSITIONS-LOGIC-PROPOSITION)
      ...
      (CL:LET* ((TEST-VALUE-004 (SAFE-PRIMARY-TYPE O2)))
       (CL:COND
        ...
        ((SUBTYPE-OF? TEST-VALUE-004 SGT-PROPOSITIONS-LOGIC-NAMED-DESCRIPTION)
         (CL:PROGN
          (STRING-LESS? (OBJECT-SORT-STRING O1) (OBJECT-SORT-STRING O2))))
...
(CL:DEFUN HELP-STARTUP-PROPOSITIONS2 ()
  (CL:PROGN
   ...
   (CL:SETQ SYM-PROPOSITIONS-LOGIC-PROPOSITION-ORIGINATED-PROPOSITIONS
    (INTERN-RIGID-SYMBOL-WRT-MODULE "PROPOSITION-ORIGINATED-PROPOSITIONS" NULL
     0))
   ...
   (CL:SETQ SYM-PROPOSITIONS-LOGIC-LOCALLY-CONCEIVED-PROPOSITIONS-INTERNAL
    (INTERN-RIGID-SYMBOL-WRT-MODULE "LOCALLY-CONCEIVED-PROPOSITIONS-INTERNAL"
     NULL 0))
...
(CL:DEFUN HELP-STARTUP-PROPOSITIONS4 ()
  (CL:PROGN
   ...
   (CL:SETQ SGT-PROPOSITIONS-STELLA-TABLE
    (INTERN-RIGID-SYMBOL-WRT-MODULE "TABLE" (GET-STELLA-MODULE "/STELLA" CL:T)
     1))
   ...
   (CL:SETQ SGT-PROPOSITIONS-STELLA-FLOAT
    (INTERN-RIGID-SYMBOL-WRT-MODULE "FLOAT" (GET-STELLA-MODULE "/STELLA" CL:T)
     1))
   ...
   (CL:SETQ KWD-PROPOSITIONS-AUTOMATICALLY-FIX-TYPE-VIOLATIONS
    (INTERN-RIGID-SYMBOL-WRT-MODULE "AUTOMATICALLY-FIX-TYPE-VIOLATIONS" NULL
     2))
   ...
   (CL:LET* ((SELF-003 (NEW-PROPERTY-LIST)))
    (CL:SETF (%THE-PLIST SELF-003)
     (LIST* KWD-PROPOSITIONS-AND SGT-PROPOSITIONS-PL-KERNEL-KB-AND
      ...
      KWD-PROPOSITIONS-COLLECT-INTO SGT-PROPOSITIONS-PL-KERNEL-KB-COLLECT-INTO
   ...
   (CL:LET* ((SELF-010 (NEW-PROPOSITION)))
    ...
    (CL:LET*
     ((OBJECT-012 SELF-010) (VALUE-013 TRUE-TRUTH-VALUE)
      ...
      (NEW-VALUE-015
       (UPDATE-IN-CONTEXT OLD-VALUE-014 VALUE-013 (%HOME-CONTEXT OBJECT-012)
        CL:NIL)))
     (CL:WHEN
      (CL:NOT
   ...
   (CL:LET* ((SELF-016 (NEW-PROPOSITION)))
    ...
    (CL:LET*
     ((OBJECT-018 SELF-016) (VALUE-019 FALSE-TRUTH-VALUE)
      ...
      (NEW-VALUE-021
       (UPDATE-IN-CONTEXT OLD-VALUE-020 VALUE-019 (%HOME-CONTEXT OBJECT-018)
        CL:NIL)))
     (CL:WHEN
      (CL:NOT
...
(CL:DEFUN HELP-STARTUP-PROPOSITIONS8 ()
  (CL:PROGN
   ...
   (DEFINE-FUNCTION-OBJECT "ENFORCE-CODE-ONLY" "(DEFUN ENFORCE-CODE-ONLY ())"
    (CL:FUNCTION ENFORCE-CODE-ONLY) NULL)
...
is a logic module iff it inherits the module 'PL-KERNEL'.\")"
   ...
   (DEFINE-FUNCTION-OBJECT "INCREMENT-NOW-TIMESTAMP"
    "(DEFUN INCREMENT-NOW-TIMESTAMP ())" (CL:FUNCTION INCREMENT-NOW-TIMESTAMP)
    NULL)
   (DEFINE-FUNCTION-OBJECT "GET-NOW-TIMESTAMP"
    "(DEFUN (GET-NOW-TIMESTAMP TIMESTAMP) ())" (CL:FUNCTION GET-NOW-TIMESTAMP)
    NULL)
...
a more normal powerloom object.\" :PUBLIC? TRUE)"
   ...
   (DEFINE-FUNCTION-OBJECT "DESCRIPTION-MODE?"
    "(DEFUN (DESCRIPTION-MODE? BOOLEAN) ())" (CL:FUNCTION DESCRIPTION-MODE?)
    NULL)
...
deduction semantics.\")" (CL:FUNCTION NATURAL-DEDUCTION-MODE?) NULL)
   ...
   (DEFINE-FUNCTION-OBJECT "TICKLE-CONTEXT"
    "(DEFUN (TICKLE-CONTEXT CONTEXT) ())" (CL:FUNCTION TICKLE-CONTEXT) NULL)
...
in a module.\" :PUBLIC? TRUE :COMMAND? TRUE :EVALUATE-ARGUMENTS? FALSE)"
   ...
   (DEFINE-FUNCTION-OBJECT "INNERMOST-OF"
    "(DEFUN (INNERMOST-OF OBJECT) ((SELF OBJECT)))" (CL:FUNCTION INNERMOST-OF)
    NULL)
...
either TRUE or FALSE, but not UNKNOWN, INCONSISTENT, etc.\")"
   ...
   (DEFINE-FUNCTION-OBJECT "LOGICAL-TYPE"
    "(DEFUN (LOGICAL-TYPE TYPE) ((SELF OBJECT)))" (CL:FUNCTION LOGICAL-TYPE)
    NULL)
...
already be defined.\" :PUBLIC? TRUE :COMMAND? TRUE :EVALUATE-ARGUMENTS? FALSE)"
   ...
   (DEFINE-METHOD-OBJECT "(DEFMETHOD (DELETED? BOOLEAN) ((SELF PROPOSITION)))"
    (CL:FUNCTION DELETED?) NULL)
   (DEFINE-METHOD-OBJECT
...
propositions that reference 'self' and mark it as 'deleted?' (thereby
making it invisible within class extensions).\")" (CL:FUNCTION DESTROY-OBJECT)
    NULL)
...
`null' follows all other values.\")" (CL:FUNCTION LOGIC-FORM-LESS?) NULL)
   ...
   (CL:LET*
    ((FUNCTION (LOOKUP-FUNCTION SYM-PROPOSITIONS-LOGIC-STARTUP-PROPOSITIONS)))
...
(CL:DEFUN STARTUP-PROPOSITIONS ()
  (CL:LET*
   ...
   (CL:WHEN (CURRENT-STARTUP-TIME-PHASE? 2) (HELP-STARTUP-PROPOSITIONS1)
    ...
    (HELP-STARTUP-PROPOSITIONS4) (HELP-STARTUP-PROPOSITIONS5))
   ...
   (CL:WHEN (CURRENT-STARTUP-TIME-PHASE? 7) (HELP-STARTUP-PROPOSITIONS8)
    (HELP-STARTUP-PROPOSITIONS9) (HELP-STARTUP-PROPOSITIONS10)
    (HELP-STARTUP-PROPOSITIONS11) (HELP-STARTUP-PROPOSITIONS12)
...
but might pass once finalization is complete.\")")
    ...
    (REGISTER-NATIVE-NAME SYM-PROPOSITIONS-LOGIC-PRESUME
     KWD-PROPOSITIONS-COMMON-LISP KWD-PROPOSITIONS-FUNCTION)
    (REGISTER-NATIVE-NAME SYM-PROPOSITIONS-STELLA-ASSERT KWD-PROPOSITIONS-CPP
