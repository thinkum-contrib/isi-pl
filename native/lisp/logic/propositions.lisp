...
(CL:DEFVAR SGT-PROPOSITIONS-LOGIC-LOGICAL-SUBTYPE-OF-LITERAL?-MEMO-TABLE-000 NULL)
...
(CL:DEFVAR SYM-PROPOSITIONS-LOGIC-? NULL)
...
(CL:DECLAIM
  ...
  *KIF-SENTENCE-OPERATORS* *REVERSEPOLARITY?* *INHIBITOBJECTFINALIZATION?*
  *DESCRIPTIONUNDERCONSTRUCTION* *LOGICVARIABLETABLE* STANDARD-ERROR
  *TERMUNDERCONSTRUCTION* *DONTUSEDEFAULTKNOWLEDGE?* *QUERYITERATOR*
  STANDARD-WARNING *SUPPRESSNONLOGICOBJECTWARNING?* TRUE-TRUTH-VALUE
  FALSE-TRUTH-VALUE DEFAULT-TRUE-TRUTH-VALUE DEFAULT-FALSE-TRUTH-VALUE
  *DEFERINGDEFAULTFORWARDINFERENCES?* STANDARD-OUTPUT *MEMOIZATION-ENABLED?*
  MEMOIZED-NULL-VALUE *INVISIBLEASSERTION?* *MODULE* EOL TRUE
  NULL-STRING-WRAPPER *PRINTREADABLY?* NULL-FLOAT-WRAPPER NIL-NON-PAGING-INDEX
  NULL-FLOAT NULL-INTEGER *LOADINGREGENERABLEOBJECTS?* TRUE-WRAPPER
  FALSE-WRAPPER FALSE NIL NIL-LIST *CONTEXT*))
...
(CL:DEFUN NEW-LOGIC-OBJECT ()
  (CL:LET* ((SELF NULL))
   ...
   (CL:SETF (%VARIABLE-VALUE-INVERSE SELF) NULL) (LOG-LOGIC-OBJECT SELF) SELF))
  ...
  (CL:COND
   ...
   ((CL:EQ SLOTNAME SYM-PROPOSITIONS-LOGIC-VARIABLE-VALUE)
    (CL:IF SETVALUE?
     ...
     (CL:SETQ VALUE
      (ACCESS-IN-CONTEXT (%VARIABLE-VALUE SELF) (%HOME-CONTEXT SELF) FALSE))))
...
(CL:DEFUN NEW-TRUTH-VALUE ()
  (CL:LET* ((SELF NULL))
   ...
   (CL:SETF (%SURROGATE-VALUE-INVERSE SELF) NULL)
   (CL:SETF (%VARIABLE-VALUE-INVERSE SELF) NULL)
   (CL:SETF (%POSITIVE-SCORE SELF) 0.0d0) (LOG-LOGIC-OBJECT SELF) SELF))
     ...
     (CL:LET* ((FOUND?-000 FALSE))
      (CL:LET* ((M NULL) (ITER-000 (%THE-CONS-LIST (%PARENT-MODULES SELF))))
       (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-000 NIL)) DO
        ...
        (CL:WHEN (LOGIC-MODULE? M) (CL:SETQ FOUND?-000 TRUE) (CL:RETURN))))
      ...
      (CL:LET* ((FOUND?-001 FALSE))
       (CL:LET* ((M NULL) (ITER-001 (%THE-CONS-LIST (%USES SELF))))
        (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-001 NIL)) DO
         ...
         (CL:WHEN (LOGIC-MODULE? M) (CL:SETQ FOUND?-001 TRUE) (CL:RETURN))))
...
(CL:DEFUN LOGICAL-SUBTYPE-OF-LITERAL? (TYPE)
  (CL:LET*
   ((DESC (SURROGATE-TO-DESCRIPTION TYPE))
    ...
    (LITERALSUBS NIL))
   (CL:COND
    ((CL:EQ DESC NULL) (CL:RETURN-FROM LOGICAL-SUBTYPE-OF-LITERAL? FALSE))
    ((CL:EQ DESC LITERALCLASS)
     (CL:RETURN-FROM LOGICAL-SUBTYPE-OF-LITERAL? TRUE))
    (CL:T
     (CL:LET*
      ...
      (CL:LET*
       ((MEMO-TABLE-000
         (%SURROGATE-VALUE
          SGT-PROPOSITIONS-LOGIC-LOGICAL-SUBTYPE-OF-LITERAL?-MEMO-TABLE-000))
...
(CL:DEFUN RUN-TRUTH-CHANGE-DEMON (PROPOSITION TRUTHCHANGERELATION)
  (CL:LET*
   ((DESCRIPTION (GET-DESCRIPTION (%OPERATOR PROPOSITION)))
    (DEMONCOMPUTATION (ACCESS-BINARY-VALUE DESCRIPTION TRUTHCHANGERELATION)))
...
(CL:DEFUN ASSIGN-PROPOSITION-WEIGHT (SELF WEIGHT)
  ...
  (CL:LET*
   ((TV (ACCESS-IN-CONTEXT (%TRUTH-VALUE SELF) (%HOME-CONTEXT SELF) FALSE)))
...
(CL:DEFUN UNBOUND? (SKOLEM)
  (CL:EQ
   (ACCESS-IN-CONTEXT (%VARIABLE-VALUE SKOLEM) (%HOME-CONTEXT SKOLEM) FALSE)
   NULL))
  ...
  (CL:LET* ((TEST-VALUE-000 (SAFE-PRIMARY-TYPE SELF)))
   (CL:COND
    ((SUBTYPE-OF? TEST-VALUE-000 SGT-PROPOSITIONS-LOGIC-PATTERN-VARIABLE)
     (CL:PROGN
      (CL:LET* ((VALUE NULL))
       (CL:WHEN (CL:AND (DEFINED? (%BOUND-TO-OFFSET SELF)) *COMPUTEDQUERY?*)
        (CL:SETQ VALUE
         (CL:AREF
...
(CL:DEFMETHOD OBJECT-EQUAL? ((SELF SKOLEM) OTHER)
  (CL:IF (CL:EQ SELF OTHER) (CL:RETURN-FROM OBJECT-EQUAL? TRUE)
...
(CL:DEFUN TRUE? (SELF)
  (CL:LET*
   ((TRUTHVALUE
     (ACCESS-IN-CONTEXT (%TRUTH-VALUE SELF) (%HOME-CONTEXT SELF) FALSE)))
   (CL:COND ((CL:EQ TRUTHVALUE TRUE-TRUTH-VALUE) (CL:RETURN-FROM TRUE? TRUE))
...
(CL:DEFUN DEFAULT-TRUE? (SELF)
  (CL:EQ (ACCESS-IN-CONTEXT (%TRUTH-VALUE SELF) (%HOME-CONTEXT SELF) FALSE)
...
(CL:DEFUN PRINT-TRUTH-VALUE (SELF STREAM)
  (CL:COND
   ...
   (CL:T (%%PRINT-STREAM (%NATIVE-STREAM STREAM) "|i|" (PRIMARY-TYPE SELF)))))
...
(CL:DEFUN SIGNAL-UNIFICATION-CLASH (TERM1 TERM2)
  (CL:IF (CL:AND (CL:NOT (CL:EQ TERM1 NULL)) (CL:NOT (CL:EQ TERM2 NULL)))
   (CL:LET* ((STREAM-000 (NEW-OUTPUT-STRING-STREAM)))
    (%%PRINT-STREAM (%NATIVE-STREAM STREAM-000) "`" TERM1 "' clashes with `"
     TERM2 "'")
...
(CL:DEFUN SIGNAL-VARIABLE-VALUE-CLASH (SKOLEM VALUE1 VALUE2)
  (CL:IF (CL:AND (CL:NOT (CL:EQ VALUE1 NULL)) (CL:NOT (CL:EQ VALUE2 NULL)))
   (CL:LET* ((STREAM-000 (NEW-OUTPUT-STRING-STREAM)))
    (%%PRINT-STREAM (%NATIVE-STREAM STREAM-000) "Skolem `" SKOLEM
     "' is equated with multiple values:" EOL "   `" VALUE1 "' and `" VALUE2
     "'.")
    (CL:ERROR (NEW-CLASH (THE-STRING-READER STREAM-000))))
   ...
   ((CL:EQ *CONTEXT*
    ...
    (CL:LET* ((STREAM-000 (NEW-OUTPUT-STRING-STREAM)))
     (%%PRINT-STREAM (%NATIVE-STREAM STREAM-000)
      ...
      "   Clash occurred in the meta inference cache for module `" *MODULE*
      "'.")
     (CL:ERROR (NEW-CLASH (THE-STRING-READER STREAM-000)))))
   ((CL:EQ *CONTEXT*
     (DYNAMIC-SLOT-VALUE (%DYNAMIC-SLOTS *MODULE*)
    ...
    (CL:LET* ((STREAM-001 (NEW-OUTPUT-STRING-STREAM)))
     (%%PRINT-STREAM (%NATIVE-STREAM STREAM-001)
      "Derived both TRUE and FALSE for the proposition `" PROPOSITION "'." EOL
      "   Clash occurred in the default inference cache for module `" *MODULE*
      "'.")
   ...
   (CL:T
    (CL:LET* ((STREAM-003 (NEW-OUTPUT-STRING-STREAM)))
     (%%PRINT-STREAM (%NATIVE-STREAM STREAM-003)
      "Derived both TRUE and FALSE for the proposition `" PROPOSITION "'." EOL
      "   Clash occurred in the world `" *CONTEXT* "' in module `" *MODULE*
      "'.")
       ...
       ((CL:AND (MONADIC? SELF)
        ...
        (%SKOLEM-TYPE
         (CL:AREF (CL:THE CL:SIMPLE-VECTOR (%THE-ARRAY (%IO-VARIABLES SELF)))
          0)))
       ((CL:AND (MONADIC? SELF) (CL:> (%ARRAY-SIZE (%IO-VARIABLES SELF)) 0)
         (CL:NOT
          (CL:EQ
           (%SKOLEM-TYPE
            (CL:AREF
...
(CL:DEFUN BIND-SKOLEM-TO-VALUE (FROMSKOLEM TOVALUE TOPLEVELUPDATE?)
  (CL:LET*
   ((TYPEISOK? FALSE) (TYPE (%SKOLEM-TYPE FROMSKOLEM))
  ...
  (CL:COND
   ((SUBTYPE-OF? (SAFE-PRIMARY-TYPE TERM1) SGT-PROPOSITIONS-LOGIC-SKOLEM)
    (CL:PROGN
     (CL:WHEN
      (EQL?
       (ACCESS-IN-CONTEXT (%VARIABLE-VALUE TERM1) (%HOME-CONTEXT TERM1) FALSE)
       TERM2)
...
(CL:DEFVAR *EQUIVALENCE-COLLECTIONS?* FALSE
   ...
   (CL:COND
    ...
    ((CL:OR
      (CL:AND (ISA? ARG1 SGT-PROPOSITIONS-LOGIC-SKOLEM)
       (CL:NOT
        (CL:EQ
         (ACCESS-IN-CONTEXT (%VARIABLE-VALUE ARG1) (%HOME-CONTEXT ARG1) FALSE)
         NULL)))
      (CL:AND (ISA? ARG2 SGT-PROPOSITIONS-LOGIC-SKOLEM)
       (CL:NOT
        (CL:EQ
         (ACCESS-IN-CONTEXT (%VARIABLE-VALUE ARG2) (%HOME-CONTEXT ARG2) FALSE)
         NULL))))
     (%%PRINT-STREAM (%NATIVE-STREAM STANDARD-OUTPUT)
      "DIDN'T FINISH 'revise-equivalences' YET. DON'T KNOW HOW" EOL
      "   TO REMOVE AN 'equivalent-value' LINK" EOL)))))
...
(CL:DEFUN FIND-EQUATING-PROPOSITION (DIRECTOBJECT INDIRECTOBJECT)
  (CL:LET*
   ...
   (CL:WHEN
    ...
    (CL:LOOP WHILE
     (CL:NOT (EQL? (VALUE-OF BACKLINKEDINDIRECTOBJECT) INDIRECTOBJECTVALUE))
     DO
     (CL:SETQ BACKLINKEDINDIRECTOBJECT (VALUE-OF BACKLINKEDINDIRECTOBJECT))))
      ...
      (CL:LET* ((TEST-VALUE-000 (%%VALUE SELF)))
       (CL:COND
        ((CL:OR (CL:EQ TEST-VALUE-000 SYM-PROPOSITIONS-LOGIC-SETOFALL)
         ...
         (EVALUATE-LOGIC-OBJECT-TERM (EVALUATE-DESCRIPTION-TERM SELF TRUE)))
...
(CL:DEFUN DESCRIPTION-EXTENSION< (DESC1 DESC2)
  (< (ESTIMATED-LENGTH (GET-DESCRIPTION-EXTENSION DESC1 TRUE))
   ...
   (CL:LET* ((DESC NULL) (ITER-001 (%THE-CONS-LIST (REVERSE DESCRIPTIONS))))
    (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-001 NIL)) DO
     (CL:PROGN (CL:SETQ DESC (%%VALUE ITER-001))
      (CL:SETQ ITER-001 (%%REST ITER-001)))
     (CL:SETQ SIZE (INTEGER-TO-STRING (ESTIMATED-LENGTH (%EXTENSION DESC))))
     (CL:SETQ SIZE
      (CONCATENATE
  ...
  (CL:LET* ((DESCRIPTION (GET-DESCRIPTION RELATION)) (PROPOSITION NULL))
   (CL:COND
    ...
    (CL:T
     ...
     (CL:LET* ((I NULL-INTEGER) (ARG NULL) (ITER-000 ARGUMENTS) (ITER-001 0))
       ...
       (CL:COND
        ((CL:EQ UPDATEMODE KWD-PROPOSITIONS-ASSERT-TRUE)
         (CL:COND ((CLIP-VALUE? SKOLEMOUTPUT VALUE))
          (CL:T (EQUATE-VALUES (VALUE-OF SKOLEMOUTPUT) (VALUE-OF VALUE)))))
        ((CL:EQ UPDATEMODE KWD-PROPOSITIONS-RETRACT-TRUE)
     ...
     (CL:COND
      ...
      (CL:T
       (%%PRINT-STREAM (%NATIVE-STREAM STANDARD-OUTPUT)
        ...
        "   because it doesn't inherit the class 'THING'." EOL)
       (CL:RETURN-FROM CREATE-LOGIC-INSTANCE NULL)))))
   (CL:WHEN (CL:NOT (CL:EQ NAME NULL))
    (CL:WHEN (CL:NOT (CL:EQ (%SURROGATE-VALUE NAME) NULL))
     (%%PRINT-STREAM (%NATIVE-STREAM STANDARD-OUTPUT)
      "Redefining the surrogate " (%SYMBOL-NAME NAME)
      " will cause the existing" EOL "   object named " (%SYMBOL-NAME NAME)
      " to be destroyed. ")
...
(CL:DEFUN FIND-EXACT-DUPLICATE-PROPOSITION (SELF)
  (CL:LET*
   ...
   (CL:WHEN (CL:EQ BUCKET NULL)
    (INSERT-AT *STRINGIFIED-PROPOSITION-INDEX* STRINGIFICATION (LIST SELF))
     ...
     (CL:WHEN
      (CL:AND (EQUIVALENT-PROPOSITIONS? SELF P NULL)
       (CL:OR (CL:EQ (%HOME-CONTEXT SELF) (%HOME-CONTEXT P))
        (MEMB? (%ALL-SUPER-CONTEXTS (%HOME-CONTEXT SELF)) (%HOME-CONTEXT P))))
...
(CL:DEFUN FIND-DUPLICATE-PROPOSITION (SELF)
  ...
  (CL:LET* ((VALUE-000 NULL))
   (CL:LET*
    ((P NULL) (ITER-000 (ALLOCATE-ITERATOR (FIND-SIMILAR-PROPOSITIONS SELF))))
    (CL:LOOP WHILE (NEXT? ITER-000) DO (CL:SETQ P (%VALUE ITER-000))
     (CL:WHEN
      (CL:AND (EQUIVALENT-PROPOSITIONS? SELF P NULL)
       (CL:OR (CL:EQ (%HOME-CONTEXT SELF) (%HOME-CONTEXT P))
...
(CL:DEFVAR *DONT-CHECK-FOR-DUPLICATE-PROPOSITIONS?* FALSE
...
(CL:DEFUN HELP-FASTEN-DOWN-PROPOSITIONS (SELF DONTCHECKFORDUPLICATES?)
  (CL:LET*
   ((I NULL-INTEGER) (ARG NULL) (VECTOR-000 (%ARGUMENTS SELF)) (INDEX-000 0)
        ...
        (CL:WHEN (COERCE-WRAPPED-BOOLEAN-TO-BOOLEAN (UNFASTENED? ARG))
         (CL:LET
          ((SELF (%THE-ARRAY (%ARGUMENTS SELF)))
           (VALUE (HELP-FASTEN-DOWN-PROPOSITIONS ARG DONTCHECKFORDUPLICATES?))
           (POSITION I))
          (CL:DECLARE (CL:TYPE CL:SIMPLE-VECTOR SELF)
           (CL:TYPE CL:FIXNUM POSITION))
          (CL:SETF (CL:AREF SELF POSITION) VALUE)))))
  ...
  (CL:LET* ((COLLECTIONREF (%%VALUE (%%REST (%%REST TREE)))))
   (CL:LET* ((TEST-VALUE-000 (SAFE-PRIMARY-TYPE COLLECTIONREF)))
    (CL:COND
     ((SUBTYPE-OF-SURROGATE? TEST-VALUE-000)
      (CL:PROGN
       (CL:WHEN (CL:NOT (CL:EQ (GET-STELLA-CLASS COLLECTIONREF FALSE) NULL))
...
(CL:DEFUN FINALIZE-PROPOSITION-ANNOTATIONS (PROPOSITION)
  (CL:LET*
   ...
   (CL:WHEN (CL:NOT (CL:EQ ANNOTATIONS NULL))
    (CL:LET* ((VALUE NULL) (OPTION NULL) (ITER-000 (%THE-PLIST ANNOTATIONS)))
     (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-000 NIL)) DO
       ...
       (CL:LET*
        ...
        (CL:LOOP WHILE (CL:< INDEX-000 LENGTH-000) DO
         ...
         (CL:LET* ((TEST-VALUE-000 FALSE))
          ...
          (CL:WHEN TEST-VALUE-000 (CL:SETQ ALWAYS?-000 FALSE) (CL:RETURN)))))
       (CL:WHEN ALWAYS?-000
        (CL:LET*
...
(CL:DEFUN BUILD-AND-OR-NOT-PROPOSITION (TREE)
  (CL:LET*
   ...
   (CL:LET* ((I NULL-INTEGER) (ARG NULL) (ITER-001 ARGUMENTS) (ITER-002 0))
...
(CL:DEFVAR *AUTO-COERCE-PROPOSITIONAL-ARGUMENTS?* FALSE
    ...
    (CL:PROGN
     (CL:LET*
      ...
      (CL:WHEN
       ...
       (CL:RETURN-FROM PROPOSITIONAL-ARGUMENT? TRUE))
               ...
               (CL:COND
                ((FUNCTION? PREDICATE) (CL:SETQ ARITY (ARITY PREDICATE))
                 (CL:IF (CL:OR (CL:= ARITY -1) (CL:= ARITY (LENGTH ARGUMENT)))
                  (CL:RETURN-FROM PROPOSITIONAL-ARGUMENT? FALSE)
                  (CL:RETURN-FROM PROPOSITIONAL-ARGUMENT? TRUE)))
                (CL:T (CL:RETURN-FROM PROPOSITIONAL-ARGUMENT? TRUE)))))
             (CL:T)))))))))))
   (CL:T))
  FALSE)
    ...
    (CL:T
     ...
     (CL:LET
      ...
      (CL:DECLARE (CL:TYPE CL:SIMPLE-VECTOR SELF)
       (CL:TYPE CL:FIXNUM POSITION))
      (CL:SETF (CL:AREF SELF POSITION) VALUE))))
   (CL:SETQ PREDICATEVALUE (EVALUATE-PREDICATE PREDICATENAME FIRSTARGUMENT))
   (CL:WHEN
...
(CL:DEFUN PROCESS-CHECK-TYPES-AGENDA ()
  (CL:WHEN (CL:OR (EMPTY? *CHECK-TYPES-AGENDA*) *INHIBITOBJECTFINALIZATION?*)
  ...
  (CL:LET*
   ...
   (CL:LET*
    ((I NULL-INTEGER) (ARG NULL) (VECTOR-000 ARGUMENTS) (INDEX-000 0)
     ...
     (UPPER-BOUND-000 ARGUMENTCOUNT) (UNBOUNDED?-000 (NULL? UPPER-BOUND-000)))
    (CL:DECLARE
      ...
      (CL:WHEN (CL:NOT (CL:AND (NON-EMPTY? CQVARS) (SUBSET? CQVARS ANTVARS)))
       (CL:LET* ((STREAM-000 (NEW-OUTPUT-STRING-STREAM)))
        (CL:LET* ((*PRINTREADABLY?* TRUE))
         (CL:DECLARE (CL:SPECIAL *PRINTREADABLY?*))
         (%%PRINT-STREAM (%NATIVE-STREAM STREAM-000)
          "ERROR: Illegal implication rule, consequent has variables" EOL
          "   that are not restricted by the antecedent: " EOL "   `"
          PROPOSITION "'." EOL)
         (HELP-SIGNAL-PROPOSITION-ERROR STREAM-000 KWD-PROPOSITIONS-ERROR))
        (CL:ERROR (NEW-PROPOSITION-ERROR (THE-STRING-READER STREAM-000)))))))
    ((CL:EQ TEST-VALUE-000 KWD-PROPOSITIONS-AND)
...
(CL:DEFUN FIND-DUPLICATE-FUNCTION-PROPOSITION (PROPOSITION)
  ...
  (CL:LET*
   ((SURROGATE (%OPERATOR PROPOSITION)) (ARGUMENTS (%ARGUMENTS PROPOSITION)))
   (CL:WHEN (CL:NOT (ISA? SURROGATE SGT-PROPOSITIONS-STELLA-SURROGATE))
    (CL:RETURN-FROM FIND-DUPLICATE-FUNCTION-PROPOSITION NULL))
   (CL:LET* ((VALUE-000 NULL))
    (CL:LET*
     ((P NULL)
      (ITER-000 (ALLOCATE-ITERATOR (FIND-SIMILAR-PROPOSITIONS PROPOSITION))))
     (CL:LOOP WHILE (NEXT? ITER-000) DO (CL:SETQ P (%VALUE ITER-000))
      (CL:LET* ((TEST-VALUE-000 FALSE))
        ...
        (CL:LET* ((ALWAYS?-000 TRUE))
         (CL:LET*
          ((ARG2 NULL) (ARG1 NULL) (ITER-001 (BUT-LAST ARGUMENTS))
           ...
           (LENGTH-000 (LENGTH VECTOR-000)))
          (CL:DECLARE (CL:TYPE CL:FIXNUM INDEX-000 LENGTH-000))
          (CL:LOOP WHILE (CL:AND (NEXT? ITER-001) (CL:< INDEX-000 LENGTH-000))
        ...
        (CL:LET*
         ...
         (CL:LOOP WHILE (NEXT? ITER-000) DO (CL:SETQ PROP (%VALUE ITER-000))
          (CL:WHEN
           ...
           (CL:SETQ FOUND?-000 TRUE) (CL:RETURN))))
        (CL:WHEN FOUND?-000 (CL:RETURN-FROM EXTENSIONAL-INDIVIDUAL? TRUE))))
      (CL:LET* ((FOUND?-001 FALSE))
    ...
    (CL:LET* ((FOUND?-000 FALSE))
     (CL:LET* ((ARG NULL) (ITER-000 (%%REST TREE)))
      (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-000 NIL)) DO
       (CL:PROGN (CL:SETQ ARG (%%VALUE ITER-000))
        (CL:SETQ ITER-000 (%%REST ITER-000)))
       (CL:WHEN (CL:OR (CL:EQ ARG T) (CL:EQ ARG F)) (CL:SETQ FOUND?-000 TRUE)
        (CL:RETURN))))
     (CL:SETQ TEST-VALUE-000 FOUND?-000))
    (CL:SETQ TEST-VALUE-000 (CL:NOT TEST-VALUE-000))
    (CL:WHEN TEST-VALUE-000
...
(CL:DEFUN CANONICALIZE-NEGATION-TREE (TREE)
  (CL:LET*
   ((ARGUMENT (%%VALUE (%%REST TREE))) (NESTEDOPERATOR (%%VALUE ARGUMENT)))
   (CL:COND
    ...
    ((CL:OR (CL:EQ NESTEDOPERATOR SYM-PROPOSITIONS-STELLA-AND)
     ...
     (CL:LET* ((IT (ALLOCATE-ITERATOR (%%REST ARGUMENT))))
      (CL:LOOP WHILE (NEXT? IT) DO
       (VALUE-SETTER IT (LIST* SYM-PROPOSITIONS-STELLA-NOT (%VALUE IT) NIL))))
     (CL:COND
        ...
        (LIST* SYM-PROPOSITIONS-STELLA-EXISTS (%%VALUE (%%REST ARGUMENT))
         (CONS
          (LIST* SYM-PROPOSITIONS-STELLA-AND WHERECLAUSE
           (CONS (LIST* SYM-PROPOSITIONS-STELLA-NOT ALWAYSCLAUSE NIL) NIL))
          NIL))))))
...
(CL:DEFUN ALL-VARIABLES-GOAL? (TREE)
  (CL:WHEN (CL:NOT (CONS? TREE)) (CL:RETURN-FROM ALL-VARIABLES-GOAL? FALSE))
...
(CL:DEFUN EXPLODE-FORALL-TREE (TREE)
  (CL:LET*
   ((ANTECEDENT (%%VALUE (%%REST (%%REST TREE)))) (CONSEQUENT (FOURTH TREE)))
   (CL:WHEN
       ...
       (CL:WHEN
        ...
        (CL:IF (CL:EQ COLLECT-000 NULL)
         (CL:PROGN (CL:SETQ COLLECT-000 (CONS GOAL NIL))
          (CL:IF (CL:EQ V-025 NIL) (CL:SETQ V-025 COLLECT-000)
           (ADD-CONS-TO-END-OF-CONS-LIST V-025 COLLECT-000)))
         (CL:PROGN (CL:SETF (%%REST COLLECT-000) (CONS GOAL NIL))
          (CL:SETQ COLLECT-000 (%%REST COLLECT-000)))))))
     (CL:LET*
      ((MATCHINGGOALS V-025) (OTHERGOALS (DIFFERENCE CONJUNCTS MATCHINGGOALS))
       (RULES NIL))
       ...
       (CL:SETQ RULES
        (CONS
         (LIST* SYM-PROPOSITIONS-STELLA-FORALL (%%VALUE (%%REST TREE))
          (CONS ANTECEDENTGOAL
           (CONS
            (CONS SYM-PROPOSITIONS-STELLA-AND (CONCATENATE OTHERGOALS NIL))
            NIL)))
         RULES)))
      (CANONICALIZE-PROPOSITION-TREE
   ...
   (CL:COND
    ...
    ((CL:EQ OPERATOR SYM-PROPOSITIONS-STELLA-NOT)
     (CL:LET* ((ARG (%%VALUE (%%REST TREE))))
      ...
      (CL:COND
       ((CL:EQ ARG SGT-PROPOSITIONS-STELLA-TRUE)
        (CL:RETURN-FROM CONS.CANONICALIZE-PROPOSITION-TREE
         SGT-PROPOSITIONS-STELLA-FALSE))
       ((CL:EQ ARG SGT-PROPOSITIONS-STELLA-FALSE)
        (CL:RETURN-FROM CONS.CANONICALIZE-PROPOSITION-TREE
...
(CL:DEFUN UPDATE-PROPOSITION (TREE UPDATEMODE)
  (CL:HANDLER-CASE
   (CL:LET* ((*INHIBITOBJECTFINALIZATION?* TRUE))
...
(CL:DEFUN DELETED-PROPOSITION? (SELF)
  ...
  (CL:WHEN
   ...
   (CL:SETF (%KIND SELF) KWD-PROPOSITIONS-DELETED)
   (CL:RETURN-FROM DELETED-PROPOSITION? TRUE))
  FALSE)
...
(CL:DEFUN DESTROY-LOGIC-CONTEXT-HOOK (SELF)
  (SET-DYNAMIC-SLOT-VALUE (%DYNAMIC-SLOTS SELF)
   SYM-PROPOSITIONS-LOGIC-MONOTONIC? (CL:IF FALSE TRUE-WRAPPER FALSE-WRAPPER)
   FALSE-WRAPPER)
...
(CL:DEFUN CONS-LESS-THAN? (O1 O2)
  (CL:LET* ((I2 NULL) (I1 NULL) (ITER-000 O1) (ITER-001 O2))
   (CL:LOOP WHILE
    (CL:AND (CL:NOT (CL:EQ ITER-000 NIL)) (CL:NOT (CL:EQ ITER-001 NIL))) DO
    (CL:PROGN (CL:SETQ I1 (%%VALUE ITER-000))
     (CL:SETQ ITER-000 (%%REST ITER-000)))
    (CL:PROGN (CL:SETQ I2 (%%VALUE ITER-001))
     (CL:SETQ ITER-001 (%%REST ITER-001)))
    (CL:WHEN (LOGIC-FORM-LESS? I1 I2) (CL:RETURN-FROM CONS-LESS-THAN? TRUE))
    (CL:WHEN (LOGIC-FORM-LESS? I2 I1) (CL:RETURN-FROM CONS-LESS-THAN? FALSE))))
  (< (LENGTH O1) (LENGTH O2)))
...
(CL:DEFUN SAFE-STRING-LESS? (S1 S2)
  ...
  (CL:COND
   ((CL:AND (CL:NOT (CL:EQ S1 STELLA::NULL-STRING))
    ...
    (STRING-LESS? S1 S2))
   ((CL:NOT (CL:EQ S2 STELLA::NULL-STRING)) FALSE) (CL:T TRUE)))
...
(CL:DEFUN PROPOSITION-LESS-THAN? (P1 P2)
  (CL:WHEN
   (STRING-LESS? (%SYMBOL-NAME (%OPERATOR P1)) (%SYMBOL-NAME (%OPERATOR P2)))
   (CL:RETURN-FROM PROPOSITION-LESS-THAN? TRUE))
  (CL:WHEN
   (STRING-LESS? (%SYMBOL-NAME (%OPERATOR P2)) (%SYMBOL-NAME (%OPERATOR P1)))
   (CL:RETURN-FROM PROPOSITION-LESS-THAN? FALSE))
  (CL:LET*
   ((A2 NULL) (A1 NULL) (VECTOR-000 (%ARGUMENTS P1)) (INDEX-000 0)
    (LENGTH-000 (LENGTH VECTOR-000)) (VECTOR-001 (%ARGUMENTS P2))
...
(CL:DEFUN OBJECT-SORT-STRING (O)
  ...
  (CL:LET* ((TEST-VALUE-000 (SAFE-PRIMARY-TYPE O)))
   (CL:COND ((SUBTYPE-OF-INTEGER? TEST-VALUE-000) (CL:PROGN (STRINGIFY O)))
    ...
    ((SUBTYPE-OF? TEST-VALUE-000 SGT-PROPOSITIONS-LOGIC-SKOLEM)
     (CL:PROGN
      (%%PRINT-STREAM (%NATIVE-STREAM STANDARD-OUTPUT) "Skolem " O " value = "
       (ACCESS-IN-CONTEXT (%VARIABLE-VALUE O) (%HOME-CONTEXT O) FALSE))
      (OBJECT-SORT-STRING
       (ACCESS-IN-CONTEXT (%VARIABLE-VALUE O) (%HOME-CONTEXT O) FALSE))))
    ((SUBTYPE-OF? TEST-VALUE-000 SGT-PROPOSITIONS-LOGIC-LOGIC-OBJECT)
...
`null' follows all other values."
  (CL:WHEN (ISA? O1 SGT-PROPOSITIONS-LOGIC-SKOLEM)
   (CL:SETQ O1
    (ACCESS-IN-CONTEXT (%VARIABLE-VALUE O1) (%HOME-CONTEXT O1) FALSE)))
  (CL:WHEN (ISA? O2 SGT-PROPOSITIONS-LOGIC-SKOLEM)
   (CL:SETQ O2
    (ACCESS-IN-CONTEXT (%VARIABLE-VALUE O2) (%HOME-CONTEXT O2) FALSE)))
  (CL:WHEN (CL:EQ O1 NULL) (CL:RETURN-FROM LOGIC-FORM-LESS? FALSE))
  (CL:WHEN (CL:EQ O2 NULL) (CL:RETURN-FROM LOGIC-FORM-LESS? TRUE))
  (CL:LET* ((TEST-VALUE-004 (SAFE-PRIMARY-TYPE O1)))
   (CL:COND
    ...
    ((SUBTYPE-OF? TEST-VALUE-004 SGT-PROPOSITIONS-LOGIC-PROPOSITION)
     (CL:PROGN
      (CL:LET* ((TEST-VALUE-002 (SAFE-PRIMARY-TYPE O2)))
       (CL:COND
        ((SUBTYPE-OF? TEST-VALUE-002 SGT-PROPOSITIONS-LOGIC-PROPOSITION)
         (CL:PROGN (PROPOSITION-LESS-THAN? O1 O2)))
        ((SUBTYPE-OF? TEST-VALUE-002 SGT-PROPOSITIONS-LOGIC-NAMED-DESCRIPTION)
         (CL:PROGN
          (STRING-LESS? (PROPOSITION-HEAD-SORT-STRING O1)
           (OBJECT-SORT-STRING O2))))
        ((SUBTYPE-OF? TEST-VALUE-002 SGT-PROPOSITIONS-LOGIC-DESCRIPTION)
    ...
    (CL:T
     (CL:LET* ((TEST-VALUE-005 (SAFE-PRIMARY-TYPE O2)))
      (CL:COND
...
(CL:DEFUN HELP-STARTUP-PROPOSITIONS2 ()
  (CL:PROGN
   ...
   (CL:SETQ SYM-PROPOSITIONS-STELLA-ISA
    (INTERN-RIGID-SYMBOL-WRT-MODULE "ISA" (GET-STELLA-MODULE "/STELLA" TRUE)
     0))
   ...
   (CL:SETQ SGT-PROPOSITIONS-STELLA-LITERAL
    (INTERN-RIGID-SYMBOL-WRT-MODULE "LITERAL"
     (GET-STELLA-MODULE "/STELLA" TRUE) 1))
   (CL:SETQ SGT-PROPOSITIONS-LOGIC-LOGICAL-SUBTYPE-OF-LITERAL?-MEMO-TABLE-000
    (INTERN-RIGID-SYMBOL-WRT-MODULE
     "LOGICAL-SUBTYPE-OF-LITERAL?-MEMO-TABLE-000" NULL 1))
   (CL:SETQ SGT-PROPOSITIONS-STELLA-CLASS
    (INTERN-RIGID-SYMBOL-WRT-MODULE "CLASS" (GET-STELLA-MODULE "/STELLA" TRUE)
     1))
   ...
   (CL:SETQ SGT-PROPOSITIONS-STELLA-THING
    (INTERN-RIGID-SYMBOL-WRT-MODULE "THING" (GET-STELLA-MODULE "/STELLA" TRUE)
     1))
...
(CL:DEFUN HELP-STARTUP-PROPOSITIONS3 ()
  (CL:PROGN
   ...
   (CL:SETQ SGT-PROPOSITIONS-STELLA-SET
    (INTERN-RIGID-SYMBOL-WRT-MODULE "SET" (GET-STELLA-MODULE "/STELLA" TRUE)
     1))
   ...
   (CL:SETQ SGT-PROPOSITIONS-STELLA-FALSE
    (INTERN-RIGID-SYMBOL-WRT-MODULE "FALSE" (GET-STELLA-MODULE "/STELLA" TRUE)
     1))
   ...
   (CL:SETQ SYM-PROPOSITIONS-LOGIC-?
   ...
   (CL:SETQ SYM-PROPOSITIONS-STELLA-=
    (INTERN-RIGID-SYMBOL-WRT-MODULE "=" (GET-STELLA-MODULE "/STELLA" TRUE) 0))
...
(CL:DEFUN HELP-STARTUP-PROPOSITIONS4 ()
  (CL:PROGN
   (CL:SETQ SYM-PROPOSITIONS-STELLA-NOT
    (INTERN-RIGID-SYMBOL-WRT-MODULE "NOT" (GET-STELLA-MODULE "/STELLA" TRUE)
     0))
   ...
   (CL:SETQ SGT-PROPOSITIONS-STELLA-SLOT
    (INTERN-RIGID-SYMBOL-WRT-MODULE "SLOT" (GET-STELLA-MODULE "/STELLA" TRUE)
     1))
   ...
   (CL:SETQ SYM-PROPOSITIONS-STELLA-SETOF
    (INTERN-RIGID-SYMBOL-WRT-MODULE "SETOF" (GET-STELLA-MODULE "/STELLA" TRUE)
     0))
   ...
   (CL:SETQ SGT-PROPOSITIONS-STELLA-TABLE
    (INTERN-RIGID-SYMBOL-WRT-MODULE "TABLE" (GET-STELLA-MODULE "/STELLA" TRUE)
     1))
   ...
   (CL:SETQ SGT-PROPOSITIONS-STELLA-FLOAT
    (INTERN-RIGID-SYMBOL-WRT-MODULE "FLOAT" (GET-STELLA-MODULE "/STELLA" TRUE)
     1))
   ...
   (CL:SETQ SYM-PROPOSITIONS-STELLA-SOME
    (INTERN-RIGID-SYMBOL-WRT-MODULE "SOME" (GET-STELLA-MODULE "/STELLA" TRUE)
     0))
...
(CL:DEFUN HELP-STARTUP-PROPOSITIONS5 ()
  (CL:PROGN
   ...
   (CL:SETQ SGT-PROPOSITIONS-STELLA-WORLD
    (INTERN-RIGID-SYMBOL-WRT-MODULE "WORLD" (GET-STELLA-MODULE "/STELLA" TRUE)
     1))
...
(CL:DEFUN HELP-STARTUP-PROPOSITIONS6 ()
  (CL:PROGN (CL:SETQ ZERO-VARIABLES-VECTOR (NEW-VECTOR 0))
   (CL:LET* ((SELF-004 (NEW-PROPERTY-LIST)))
    ...
    (CL:SETQ *OPERATOR-NAME-TO-SURROGATE-TABLE* SELF-004))
   ...
   (CL:SETQ *CLIPPINGENABLED?* TRUE) (CL:SETQ *NATURALDEDUCTIONMODE?* TRUE)
   (CL:SETQ *CONTEXT-DEPENDENT-SEARCH-MODE?* FALSE)
   (CL:SETQ *COMPUTEDQUERY?* FALSE)
   ...
   (CL:SETQ UNKNOWN-TRUTH-VALUE (NEW-TRUTH-VALUE))
   (CL:SETQ *SUPPRESSUNTYPEDTYPEERROR?* FALSE)
   (CL:SETQ *EQUIVALENCE-COLLECTIONS?* TRUE)
   ...
   (CL:SETQ ANONYMOUS-VARIABLE-NAME SYM-PROPOSITIONS-LOGIC-?)
   (CL:SETQ *MISSING-KEY-VALUE-LIST* (NEW-KEY-VALUE-LIST))
   (CL:SETQ *AUTOMATICINSTANCETABLE* *MISSING-KEY-VALUE-LIST*)
   (CL:SETQ *STRINGIFIED-PROPOSITION-INDEX* (NEW-STRING-HASH-TABLE))
   (CL:SETQ *DONT-CHECK-FOR-DUPLICATE-PROPOSITIONS?* FALSE)
   (CL:SETQ *AUTO-COERCE-PROPOSITIONAL-ARGUMENTS?* FALSE)
   ...
   (CL:LET*
    ((CLASS
      (DEFINE-CLASS-FROM-STRINGIFIED-SOURCE "STRING-LOGIC-WRAPPER"
       "(DEFCLASS STRING-LOGIC-WRAPPER (STRING-WRAPPER BACKLINKS-MIXIN) :PRINT-FORM (IF *PRINTREADABLY?* (PRINT-NATIVE-STREAM STREAM (WRAPPER-VALUE SELF)) (PRINT-NATIVE-STREAM STREAM \"|W|\" (WRAPPER-VALUE SELF))))")))
    (CL:SETF (%CLASS-CONSTRUCTOR-CODE CLASS)
...
is a logic module iff it inherits the module 'PL-KERNEL'.\")"
   ...
   (DEFINE-FUNCTION-OBJECT "OBJECT-SURROGATE"
    "(DEFUN (OBJECT-SURROGATE SURROGATE) ((SELF OBJECT)) :DOCUMENTATION \"Return the surrogate naming the logic object `self'.\" :PUBLIC? TRUE)"
...
`null' follows all other values.\")" (CL:FUNCTION LOGIC-FORM-LESS?) NULL)
   ...
   (CL:LET*
    ...
    (SET-DYNAMIC-SLOT-VALUE (%DYNAMIC-SLOTS FUNCTION)
     ...
     (WRAP-STRING "_Startup-Propositions") NULL-STRING-WRAPPER))))
...
call 'bound-to' safely.\")")
    ...
    (DEFINE-STELLA-GLOBAL-VARIABLE-FROM-STRINGIFIED-SOURCE
     "(DEFCONSTANT UNKNOWN-TRUTH-VALUE TRUTH-VALUE (NEW TRUTH-VALUE) :DOCUMENTATION \"Value representing UNKNOWN.  Needed for those cases
where we need a non-NULL truth value to represents UNKNOWN.\")")
    (CL:SETF (%POSITIVE-SCORE TRUE-TRUTH-VALUE) 1.0d0)
    (CL:SETF (%POSITIVE-SCORE FALSE-TRUTH-VALUE) -1.0d0)
    (CL:SETF (%POSITIVE-SCORE DEFAULT-TRUE-TRUTH-VALUE) 0.8d0)
    (CL:SETF (%POSITIVE-SCORE DEFAULT-FALSE-TRUTH-VALUE) -0.8d0)
    (DEFINE-STELLA-GLOBAL-VARIABLE-FROM-STRINGIFIED-SOURCE
