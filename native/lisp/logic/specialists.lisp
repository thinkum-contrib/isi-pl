...
(CL:DEFVAR SYM-SPECIALISTS-LOGIC-QUERY-069 NULL)
...
(CL:DECLAIM
  ...
  *CYC-KLUDGES-ENABLED?* *MEMOIZATION-ENABLED?* MEMOIZED-NULL-VALUE *CONTEXT*
  FALSE-WRAPPER *TRACED-KEYWORDS* *RECORD-JUSTIFICATIONS?* NIL-LIST
  EMPTY-PROPOSITIONS-ITERATOR TRUE-TRUTH-VALUE FALSE-TRUTH-VALUE NIL
  ...
  NULL-METHOD-CODE-WRAPPER *QUERYITERATOR* *REVERSEPOLARITY?* TRUE FALSE
  STANDARD-OUTPUT EOL))
    ...
    (CL:WHEN (CL:EQ PROCEDURENAME NULL)
     (CL:SETQ PROCEDURENAME
      (INTERN-SYMBOL-IN-MODULE
       ...
       (%HOME-CONTEXT (%SURROGATE-VALUE-INVERSE PROCEDURE)) TRUE))
     ...
     (CL:LET*
      ((KERNELNAME
        (LOOKUP-SYMBOL-IN-MODULE (%SYMBOL-NAME PROCEDURENAME)
         (GET-STELLA-MODULE "PL-KERNEL" TRUE) FALSE)))
  ...
  (CL:WHEN
   ...
   (CL:IF SUCCESS?
    (SET-BASE-PARTIAL-MATCH-TRUTH (%PARTIAL-MATCH-STRATEGY *QUERYITERATOR*)
     PROPOSITION KWD-SPECIALISTS-TRUE)
    (SET-BASE-PARTIAL-MATCH-TRUTH (%PARTIAL-MATCH-STRATEGY *QUERYITERATOR*)
     PROPOSITION KWD-SPECIALISTS-FAIL)))
  ...
  (CL:LET*
   ...
   (CL:IF (DEFINED? P1)
    (CL:PROGN
     ...
     (CL:SETF (%START IT) (CL:1+ P1)) TRUE)
    (CL:PROGN (CL:SETF (%VALUE IT) NULL) FALSE))))
...
(CL:DEFUN /PL-KERNEL-KB/COMPUTATION-SPECIALIST (FRAME LASTMOVE)
  (CL:LET*
    ...
    ((FUNCTION-DESCRIPTION? DESCRIPTION)
     (CL:LET*
      ...
      (CL:LOOP WHILE
       ...
       (CL:SETQ I I) (CL:SETQ VALUE (ARGUMENT-BOUND-TO ARG))
   ...
   (CL:IF SUCCESS? (SET-FRAME-TRUTH-VALUE FRAME TRUE-TRUTH-VALUE)
  ...
  (CL:LET*
   ...
   (CL:CASE NULLCOUNT
    (0
     ...
     (CL:IF (COERCE-WRAPPED-BOOLEAN-TO-BOOLEAN VALUE)
      (SET-FRAME-TRUTH-VALUE FRAME TRUE-TRUTH-VALUE)
      (SET-FRAME-TRUTH-VALUE FRAME FALSE-TRUTH-VALUE))
     (REPORT-COMPUTED-RESULT (COERCE-WRAPPED-BOOLEAN-TO-BOOLEAN VALUE)
      PROPOSITION))
    (1
     (CL:SETQ VALUE
      (APPLY COMPUTATIONCODE
...
(CL:DEFUN /PL-KERNEL-KB/SQUARE-ROOT-SPECIALIST (FRAME LASTMOVE)
  (CL:LET*
       ...
       (CL:RETURN-FROM /PL-KERNEL-KB/SQUARE-ROOT-SPECIALIST
        (SELECT-PROOF-RESULT
         (BIND-ARGUMENT-TO-VALUE? MAINARG
          (/PL-KERNEL-KB/TIMES-COMPUTATION ROOTARGVALUE ROOTARGVALUE) TRUE)
         FALSE TRUE))
       (CL:RETURN-FROM /PL-KERNEL-KB/SQUARE-ROOT-SPECIALIST
        KWD-SPECIALISTS-TERMINAL-FAILURE)))
   ...
   (CL:WHEN (CL:NOT (CL:EQ ROOTARGVALUE NULL))
    (CL:IF
     (CL:OR
      (/PL-KERNEL-KB/ARITHMETIC-EQUAL-TEST ROOTARGVALUE (%%VALUE COLLECTION))
  ...
  (CL:LET*
   ...
   (CL:LOOP WHILE (NEXT? ITERATOR) DO
    (CL:IF (CL:EQ COLLECTION NULL)
     ...
     (CL:WHEN
      (BIND-VARIABLE-TO-VALUE? MEMBERARG (VALUE-OF (%VALUE ITERATOR)) TRUE)
      (CL:RETURN-FROM /PL-KERNEL-KB/MEMBER-OF-SPECIALIST
       KWD-SPECIALISTS-CONTINUING-SUCCESS))))
   KWD-SPECIALISTS-FAILURE))
...
(CL:DEFUN /PL-KERNEL-KB/MEMBER-OF-EVALUATOR (SELF)
  (CL:LET*
   ...
   (CL:WHEN
    (CL:AND (ISA? VALUE2 SGT-SPECIALISTS-LOGIC-DESCRIPTION)
     (ISA? VALUE1 SGT-SPECIALISTS-LOGIC-LOGIC-OBJECT)
   ...
   (CL:WHEN (CL:EQ ITERATOR NULL)
    (CL:COND
     ((CL:AND (CL:NOT (CL:EQ SUBCOLLECTION NULL))
      ...
      (CL:IF (COLLECTION-IMPLIES-COLLECTION? SUBCOLLECTION SUPERCOLLECTION)
    ...
    (CL:LOOP WHILE (CL:< INDEX-000 LENGTH-000) DO
     (CL:PROGN
      (CL:SETQ ARG
       (CL:AREF (CL:THE CL:SIMPLE-VECTOR (%THE-ARRAY VECTOR-000)) INDEX-000))
      (CL:SETQ INDEX-000 (CL:1+ INDEX-000)))
     (CL:WHEN (CL:EQ (ARGUMENT-BOUND-TO ARG) NULL) (CL:SETQ ALWAYS?-000 FALSE)
      (CL:RETURN))))
   (CL:LET* ((ALLBOUND? ALWAYS?-000)) (CL:SETQ LASTMOVE LASTMOVE)
    (CL:WHEN *REVERSEPOLARITY?* (CL:SETQ ALLBOUND? (CL:NOT ALLBOUND?)))
    (CL:COND
     (ALLBOUND? (SET-FRAME-TRUTH-VALUE FRAME TRUE-TRUTH-VALUE)
      KWD-SPECIALISTS-FINAL-SUCCESS)
...
(CL:DEFUN /PL-KERNEL-KB/FORK-SPECIALIST (FRAME LASTMOVE)
  (CL:COND ((CL:EQ LASTMOVE KWD-SPECIALISTS-DOWN) KWD-SPECIALISTS-MOVE-DOWN)
   ((CL:EQ LASTMOVE KWD-SPECIALISTS-UP-TRUE)
    ...
    (CL:COND
     ((CL:EQ KEY KWD-SPECIALISTS-INHERIT)
      (CL:WHEN
       ...
       (CL:LET*
        ((PVALUE NULL) (PKEY NULL) (ITER-000 (%THE-PLIST PARENTOPTIONS)))
        (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-000 NIL)) DO
         (CL:SETQ PKEY (%%VALUE ITER-000))
         (CL:PROGN (CL:SETQ PVALUE (%%VALUE (%%REST ITER-000)))
...
(CL:DEFUN CREATE-QUERY-SPECIALIST-ITERATOR (FRAME)
  (CL:LET* ((PROPOSITION NULL) (SUBQUERYOPTIONS NULL))
   ...
   (CL:LET*
    ...
    (CL:SETQ TRUEFALSEQUERY? TRUE)
    (CL:LET*
     ((I NULL-INTEGER) (VAR NULL) (ITER-000 (%THE-CONS-LIST IOVARIABLES))
      (ITER-001 0))
...
(CL:DEFUN /PL-KERNEL-KB/QUERY-SPECIALIST (FRAME LASTMOVE)
  (CL:LET*
   ((SUBQUERYITERATOR
     (DYNAMIC-SLOT-VALUE (%DYNAMIC-SLOTS FRAME)
      SYM-SPECIALISTS-STELLA-ITERATOR NULL))
    (TRUEFALSEQUERY? FALSE) (PARTIALQUERY? FALSE) (SUCCESS? FALSE)
    (RESULT NULL))
   (CL:SETQ LASTMOVE LASTMOVE)
   (CL:COND
   ...
   (CL:LOOP
    (CL:TAGBODY
     (CL:COND
      (PARTIALQUERY? (CL:SETQ SUCCESS? (QUERY-SUCCEEDED? SUBQUERYITERATOR))
       (CL:WHEN SUCCESS?
       ...
       (CL:LET*
        ...
        (CL:LET* ((HOWMANY (LOOKUP-HOW-MANY-SOLUTIONS SUBQUERYITERATOR)))
         ...
         (CL:COND ((NULL? HOWMANY))
          ((CL:<= HOWMANY 1) (CL:SETF (%EXHAUSTED? SUBQUERYITERATOR) TRUE))
          (CL:T
     ...
     (CL:WHEN SUCCESS?
      (CL:LET*
       ((VALUE NULL) (VAR NULL)
        ...
        (VECTOR-000 (%BINDINGS (%VALUE SUBQUERYITERATOR))) (INDEX-000 0)
        (LENGTH-000 (LENGTH VECTOR-000)))
       (CL:DECLARE (CL:TYPE CL:FIXNUM INDEX-000 LENGTH-000))
       (CL:LOOP WHILE
        ...
        (CL:PROGN
         (CL:SETQ VALUE
          (CL:AREF (CL:THE CL:SIMPLE-VECTOR (%THE-ARRAY VECTOR-000))
           INDEX-000))
         (CL:SETQ INDEX-000 (CL:1+ INDEX-000)))
        (CL:WHEN (CL:NOT (BIND-VARIABLE-TO-VALUE? VAR VALUE TRUE))
     ...
     (CL:IF (ISA? CLASS SGT-SPECIALISTS-LOGIC-NAMED-DESCRIPTION)
      ...
      (CL:SETQ NAME
       (CONCATENATE "PROTOTYPE"
        (INTEGER-TO-STRING
         (CL:SETQ *PROTOTYPE-ID-COUNTER* (CL:1+ *PROTOTYPE-ID-COUNTER*))))))
     (CL:LET*
      ...
      (CL:OR
       ...
       (CL:AND
        ...
        (HELP-CLOSED-TERM?
         ...
         ACTIVETERMS)))))
    ((SUBTYPE-OF? TEST-VALUE-000 SGT-SPECIALISTS-LOGIC-DESCRIPTION)
     (CL:PROGN (HELP-CLOSED-PROPOSITION? (%PROPOSITION SELF) ACTIVETERMS)))
     ...
     (CL:T
      (CL:LET* ((TEST-VALUE-000 FALSE))
       (CL:IF (NON-RECURSIVE-SINGLE-VALUED-TERM? SELF)
        (CL:SETQ TEST-VALUE-000 TRUE)
        (CL:PROGN (CL:SETQ TEST-VALUE-000 (CL:NOT (CLASS? SELF)))
         (CL:WHEN TEST-VALUE-000
          (CL:LET* ((FOUND?-000 FALSE))
       ...
       (CL:PROGN
        (CL:LET*
         ...
         (CL:WHEN (CL:EQ MEMBERS NULL)
          (CL:RETURN-FROM /PL-KERNEL-KB/COLLECT-INTO-SET-SPECIALIST
           KWD-SPECIALISTS-TERMINAL-FAILURE))
         (BIND-ARGUMENT-TO-VALUE? LISTARG (CREATE-ENUMERATED-SET MEMBERS)
          TRUE)
         (CL:RETURN-FROM /PL-KERNEL-KB/COLLECT-INTO-SET-SPECIALIST
          KWD-SPECIALISTS-FINAL-SUCCESS))))
  ...
  (CL:LET*
   ...
   (CL:WHEN
    ...
    (CL:RETURN-FROM /PL-KERNEL-KB/LENGTH-OF-LIST-SPECIALIST
     KWD-SPECIALISTS-TERMINAL-FAILURE))
   (CL:LET*
    ((LISTVALUE (ASSERTED-COLLECTION-MEMBERS LISTSKOLEM TRUE))
     (LEN NULL-INTEGER))
    ...
    (CL:IF (BIND-ARGUMENT-TO-VALUE? LENGTHARG (WRAP-INTEGER LEN) TRUE)
     (CL:PROGN (SET-FRAME-TRUTH-VALUE FRAME TRUE-TRUTH-VALUE)
      KWD-SPECIALISTS-FINAL-SUCCESS)
     (CL:PROGN (SET-FRAME-TRUTH-VALUE FRAME FALSE-TRUTH-VALUE)
      KWD-SPECIALISTS-TERMINAL-FAILURE)))))
    ...
    (CL:WHEN MISSINGNUMBERS?
     (CL:IF
      ...
      (CL:PROGN (SET-FRAME-TRUTH-VALUE FRAME UNKNOWN-TRUTH-VALUE)
       (CL:RETURN-FROM /PL-KERNEL-KB/MINIMUM-OF-NUMBERS-SPECIALIST
        KWD-SPECIALISTS-FAILURE))))
    (CL:IF (BIND-ARGUMENT-TO-VALUE? MINARG MINIMUM TRUE)
     (CL:PROGN (SET-FRAME-TRUTH-VALUE FRAME TRUE-TRUTH-VALUE)
      KWD-SPECIALISTS-FINAL-SUCCESS)
     (CL:PROGN (SET-FRAME-TRUTH-VALUE FRAME FALSE-TRUTH-VALUE)
      KWD-SPECIALISTS-TERMINAL-FAILURE)))))
    ...
    (CL:WHEN MISSINGNUMBERS?
     (CL:IF
      ...
      (CL:PROGN (SET-FRAME-TRUTH-VALUE FRAME UNKNOWN-TRUTH-VALUE)
       (CL:RETURN-FROM /PL-KERNEL-KB/MAXIMUM-OF-NUMBERS-SPECIALIST
        KWD-SPECIALISTS-FAILURE))))
    (CL:IF (BIND-ARGUMENT-TO-VALUE? MAXARG MAXIMUM TRUE)
     (CL:PROGN (SET-FRAME-TRUTH-VALUE FRAME TRUE-TRUTH-VALUE)
      KWD-SPECIALISTS-FINAL-SUCCESS)
     (CL:PROGN (SET-FRAME-TRUTH-VALUE FRAME FALSE-TRUTH-VALUE)
      KWD-SPECIALISTS-TERMINAL-FAILURE)))))
  ...
  (CL:LET*
   ...
   (CL:LET* ((LISTVALUE (ASSERTED-COLLECTION-MEMBERS LISTSKOLEM TRUE)))
    ...
    (CL:WHEN (CL:EQ SUM NULL)
     (CL:RETURN-FROM /PL-KERNEL-KB/SUM-OF-NUMBERS-SPECIALIST
      KWD-SPECIALISTS-TERMINAL-FAILURE))
    (CL:IF (BIND-ARGUMENT-TO-VALUE? SUMARG SUM TRUE)
     (CL:PROGN (SET-FRAME-TRUTH-VALUE FRAME TRUE-TRUTH-VALUE)
      KWD-SPECIALISTS-FINAL-SUCCESS)
     (CL:PROGN (SET-FRAME-TRUTH-VALUE FRAME FALSE-TRUTH-VALUE)
      KWD-SPECIALISTS-TERMINAL-FAILURE)))))
   ...
   (CL:LET* ((LISTVALUE (ASSERTED-COLLECTION-MEMBERS LISTSKOLEM TRUE)))
    ...
    (CL:IF
     (BIND-ARGUMENT-TO-VALUE? MEANARG
      (/PL-KERNEL-KB/DIVIDE-COMPUTATION SUM (WRAP-INTEGER NUMBERCOUNT)) TRUE)
     (CL:PROGN (SET-FRAME-TRUTH-VALUE FRAME TRUE-TRUTH-VALUE)
      KWD-SPECIALISTS-FINAL-SUCCESS)
     (CL:PROGN (SET-FRAME-TRUTH-VALUE FRAME FALSE-TRUTH-VALUE)
      KWD-SPECIALISTS-TERMINAL-FAILURE)))))
    ...
    (CL:IF (CL:LOGBITP 0 NUMBERCOUNT)
     ...
     (CL:SETQ RESULT
      (/PL-KERNEL-KB/DIVIDE-COMPUTATION
       ...
       (WRAP-INTEGER 2))))
    (CL:IF (BIND-ARGUMENT-TO-VALUE? MEDIANARG RESULT TRUE)
     (CL:PROGN (SET-FRAME-TRUTH-VALUE FRAME TRUE-TRUTH-VALUE)
      KWD-SPECIALISTS-FINAL-SUCCESS)
     (CL:PROGN (SET-FRAME-TRUTH-VALUE FRAME FALSE-TRUTH-VALUE)
      KWD-SPECIALISTS-TERMINAL-FAILURE)))))
  ...
  (CL:LET*
   ...
   (CL:LET* ((LISTVALUE (ASSERTED-COLLECTION-MEMBERS LISTSKOLEM TRUE)))
    ...
    (CL:CASE NUMBERCOUNT (0 KWD-SPECIALISTS-TERMINAL-FAILURE)
     (1
      (CL:IF (BIND-ARGUMENT-TO-VALUE? RESULTARGG (WRAP-FLOAT 0.0d0) TRUE)
       (CL:PROGN (SET-FRAME-TRUTH-VALUE FRAME TRUE-TRUTH-VALUE)
        KWD-SPECIALISTS-FINAL-SUCCESS)
       (CL:PROGN (SET-FRAME-TRUTH-VALUE FRAME FALSE-TRUTH-VALUE)
        KWD-SPECIALISTS-TERMINAL-FAILURE)))
     (CL:OTHERWISE
      ...
      (CL:IF (BIND-ARGUMENT-TO-VALUE? RESULTARGG (WRAP-FLOAT X) TRUE)
       (CL:PROGN (SET-FRAME-TRUTH-VALUE FRAME TRUE-TRUTH-VALUE)
        KWD-SPECIALISTS-FINAL-SUCCESS)
       (CL:PROGN (SET-FRAME-TRUTH-VALUE FRAME FALSE-TRUTH-VALUE)
        KWD-SPECIALISTS-TERMINAL-FAILURE)))))))
     ...
     (APPLY-CACHED-RETRIEVE
      ...
      (LIST* SYM-SPECIALISTS-STELLA-AND
       ...
       (LIST* SYM-SPECIALISTS-LOGIC-MUTUALLY-DISJOINT-COLLECTION
        SYM-SPECIALISTS-LOGIC-?MDC NIL)
       NIL)
      (CONS-LIST SUPER NULL) (CONS-LIST) SYM-SPECIALISTS-LOGIC-QUERY-069)))
   (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-000 NIL)) DO
       ...
       (%%VALUE
        (CONSIFY
         (ALL-TRUE-DEPENDENT-PROPOSITIONS MC
          SGT-SPECIALISTS-PL-KERNEL-KB-MUTUALLY-DISJOINT-COLLECTION FALSE)))))
     (PUSH TUPLES
...
(CL:DEFUN EXPENSIVE-EMPTY-TERM? (SELF)
  (CL:LET* ((SUPER1 NULL) (ITER-000 (ALL-DIRECT-SUPERCOLLECTIONS SELF FALSE)))
...
(CL:DEFVAR *ACCELERATE-FRAME-COMPUTATIONS?* FALSE
     ...
     (CL:LET* ((LB NULL) (ITER-001 (%%REST MINCARDS)))
      (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-001 NIL)) DO
       ...
       (CL:WHEN (CL:NOT (CL:EQ LB NULL))
        (CL:SETQ MAXMIN
         (WRAP-INTEGER (MAX (%WRAPPER-VALUE LB) (%WRAPPER-VALUE MAXMIN)))))))
    ...
    (CL:WHEN (CLOSED-TERM? RELATION)
     (CL:SETQ MAXCARDS
      (CONS (WRAP-INTEGER (COMPUTE-MINIMUM-CARDINALITY RELATION INSTANCE))
       MAXCARDS)))
    (CL:LET* ((SUPERR NULL) (ITER-000 (ALL-SUPERRELATIONS RELATION FALSE)))
     (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-000 NIL)) DO
     ...
     (CL:LET* ((UB NULL) (ITER-001 (%%REST MAXCARDS)))
      (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-001 NIL)) DO
       ...
       (CL:WHEN (CL:NOT (CL:EQ UB NULL))
        (CL:SETQ MINMAX
         (WRAP-INTEGER (MIN (%WRAPPER-VALUE UB) (%WRAPPER-VALUE MINMAX)))))))
          ...
          (CL:LET*
           ...
           (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-000 NIL)) DO
            ...
            (CL:WHEN (CL:NOT (TEST-TYPE-ON-INSTANCE? FILLER VALUESURROGATE))
             (CL:SETQ ALWAYS?-000 FALSE) (CL:RETURN))))
          (CL:SETQ TEST-VALUE-000 ALWAYS?-000))))))
     (CL:WHEN TEST-VALUE-000 (CL:RETURN-FROM TEST-RANGE-TYPE? TRUE))))
    ...
    (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-001 NIL)) DO
     ...
     (CL:LET* ((SUPERROLESET (GET-ROLESET-OF SUPERR INSTANCE)))
      (CL:WHEN
       ...
       (CL:RETURN-FROM TEST-RANGE-TYPE? TRUE)))))
   FALSE))
...
(CL:DEFUN /PL-KERNEL-KB/RANGE-TYPE-SPECIALIST (FRAME LASTMOVE)
  (CL:LET*
   ...
   (CL:WHEN
    ...
    (CL:RETURN-FROM /PL-KERNEL-KB/RANGE-TYPE-SPECIALIST
     KWD-SPECIALISTS-FAILURE))
   (SELECT-PROOF-RESULT (TEST-RANGE-TYPE? RELATION INSTANCE VALUETYPEVALUE)
    FALSE TRUE)))
   ...
   (CL:LET*
    ...
    (CL:WHEN (CL:EQ LIST NULL)
     (CL:RETURN-FROM /PL-KERNEL-KB/PROJECT-COLUMN-SPECIALIST
      KWD-SPECIALISTS-TERMINAL-FAILURE))
    (SELECT-PROOF-RESULT
     (BIND-ARGUMENT-TO-VALUE? LISTARG (CREATE-LOGICAL-LIST LIST) TRUE) FALSE
     TRUE))))
    ...
    ((PROP NULL)
     (ITER-000
      (ALL-TRUE-DEPENDENT-PROPOSITIONS TERM
       SGT-SPECIALISTS-PL-KERNEL-KB-SYNONYM FALSE)))
    (CL:LOOP WHILE (NEXT? ITER-000) DO (CL:SETQ PROP (%VALUE ITER-000))
     (CL:SETQ SYNONYM
      (VALUE-OF
...
(CL:DEFUN /PL-KERNEL-KB/DIFFERENT-SPECIALIST (FRAME LASTMOVE)
  (CL:LET*
   ((ARGUMENTS (%ARGUMENTS (%PROPOSITION FRAME)))
    (NOFARGUMENTS (LENGTH ARGUMENTS)) (ARGUMENTVALUES NIL)
    (NOFBOUNDARGUMENTS 0) (NOFUNIQUEARGUMENTS 0) (VALUE NULL))
   (CL:DECLARE
    (CL:TYPE CL:FIXNUM NOFARGUMENTS NOFBOUNDARGUMENTS NOFUNIQUEARGUMENTS))
   (CL:SETQ LASTMOVE LASTMOVE)
   (CL:LET*
    ...
    (CL:LOOP WHILE (CL:< INDEX-000 LENGTH-000) DO
     ...
     (CL:TAGBODY (CL:SETQ VALUE (ARGUMENT-BOUND-TO ARG))
      (CL:IF (CL:OR (CL:EQ VALUE NULL) (SKOLEM? VALUE)) (CL:GO :CONTINUE)
       (CL:SETQ NOFBOUNDARGUMENTS (CL:1+ NOFBOUNDARGUMENTS)))
      (CL:IF (CL:EQ COLLECT-000 NULL)
       (CL:PROGN (CL:SETQ COLLECT-000 (CONS VALUE NIL))
        (CL:IF (CL:EQ ARGUMENTVALUES NIL) (CL:SETQ ARGUMENTVALUES COLLECT-000)
         (ADD-CONS-TO-END-OF-CONS-LIST ARGUMENTVALUES COLLECT-000)))
       (CL:PROGN (CL:SETF (%%REST COLLECT-000) (CONS VALUE NIL))
        (CL:SETQ COLLECT-000 (%%REST COLLECT-000))))
      :CONTINUE)))
   (CL:SETQ NOFUNIQUEARGUMENTS (LENGTH (REMOVE-DUPLICATES ARGUMENTVALUES)))
   (CL:COND
    ((CL:AND (CL:= NOFBOUNDARGUMENTS NOFARGUMENTS)
      (CL:= NOFBOUNDARGUMENTS NOFUNIQUEARGUMENTS))
     (SET-FRAME-TRUTH-VALUE FRAME TRUE-TRUTH-VALUE)
     KWD-SPECIALISTS-FINAL-SUCCESS)
    ((CL:= NOFBOUNDARGUMENTS NOFUNIQUEARGUMENTS) KWD-SPECIALISTS-FAILURE)
    (CL:T (SET-FRAME-TRUTH-VALUE FRAME FALSE-TRUTH-VALUE)
     KWD-SPECIALISTS-TERMINAL-FAILURE))))
...
(CL:DEFUN HELP-STARTUP-SPECIALISTS1 ()
  (CL:PROGN
   ...
   (CL:SETQ SYM-SPECIALISTS-STELLA-START
    (INTERN-RIGID-SYMBOL-WRT-MODULE "START" (GET-STELLA-MODULE "/STELLA" TRUE)
     0))
   ...
   (CL:SETQ SYM-SPECIALISTS-STELLA-DUMMY
    (INTERN-RIGID-SYMBOL-WRT-MODULE "DUMMY" (GET-STELLA-MODULE "/STELLA" TRUE)
     0))
...
(CL:DEFUN HELP-STARTUP-SPECIALISTS2 ()
  (CL:PROGN
   (CL:SETQ SGT-SPECIALISTS-LOGIC-CLOSED-PROPOSITION?-MEMO-TABLE-000
    (INTERN-RIGID-SYMBOL-WRT-MODULE "CLOSED-PROPOSITION?-MEMO-TABLE-000" NULL
     1))
   ...
   (CL:SETQ SGT-SPECIALISTS-LOGIC-SINGLE-VALUED-TERM?-MEMO-TABLE-000
    (INTERN-RIGID-SYMBOL-WRT-MODULE "SINGLE-VALUED-TERM?-MEMO-TABLE-000" NULL
     1))
   ...
   (CL:SETQ SYM-SPECIALISTS-LOGIC-QUERY-069
    (INTERN-RIGID-SYMBOL-WRT-MODULE "QUERY-069" NULL 0))
...
(CL:DEFUN STARTUP-SPECIALISTS ()
  (CL:LET*
   ...
   (CL:WHEN (CURRENT-STARTUP-TIME-PHASE? 4)
    (CL:SETQ *ACCELERATE-FRAME-COMPUTATIONS?* TRUE))
   ...
   (CL:WHEN (CURRENT-STARTUP-TIME-PHASE? 7) (HELP-STARTUP-SPECIALISTS3)
    ...
    (CL:LET*
     ...
     (SET-DYNAMIC-SLOT-VALUE (%DYNAMIC-SLOTS FUNCTION)
      ...
      (WRAP-STRING "_Startup-Specialists") NULL-STRING-WRAPPER)))
