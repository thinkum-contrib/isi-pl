...
(CL:DECLAIM
  ...
  *QUERY-OPTIMIZATION-STRATEGY* STANDARD-ERROR *MOST-RECENT-QUERY*
  FALSE-TRUTH-VALUE INCONSISTENT-TRUTH-VALUE *PRINTLENGTH*
  *DEBUG-MODE?* *PRINTREADABLY?* *CYC-KLUDGES-ENABLED?*
  *MEMOIZATION-ENABLED?* MEMOIZED-NULL-VALUE TRUE-TRUTH-VALUE
  ZERO-WRAPPER *RECORD-JUSTIFICATIONS?* UNKNOWN-TRUTH-VALUE
  ...
  *CURRENT-POWERLOOM-FEATURES* NULL-INTEGER EOL *QUERYITERATOR*
  *MODULE*))
...
(CL:DEFUN NEW-ASSERTION-INFERENCE-LEVEL ()
  (CL:LET* ((SELF NULL))
   (CL:SETQ SELF
    (CL:MAKE-INSTANCE (CL:QUOTE ASSERTION-INFERENCE-LEVEL)))
   (CL:SETF (%KEYWORD SELF) NULL) SELF))
...
(CL:DEFUN NEW-REFUTATION-INFERENCE-LEVEL ()
  (CL:LET* ((SELF NULL))
   (CL:SETQ SELF
    (CL:MAKE-INSTANCE (CL:QUOTE REFUTATION-INFERENCE-LEVEL)))
   (CL:SETF (%KEYWORD SELF) NULL) SELF))
...
the appropriate truth-value and justification support." :ALLOCATION
    :INSTANCE :ACCESSOR %SOLUTIONS)
   (DEBUG-ID :TYPE CL:SIMPLE-STRING :INITFORM STELLA::NULL-STRING
    :ALLOCATION :INSTANCE :ACCESSOR %DEBUG-ID)
   ...
   (CURRENT-DEPTH-CUTOFF :TYPE CL:FIXNUM :INITFORM NULL-INTEGER
    :ALLOCATION :INSTANCE :ACCESSOR %CURRENT-DEPTH-CUTOFF)
   (MAXIMUM-DEPTH :TYPE CL:FIXNUM :INITFORM NULL-INTEGER :ALLOCATION
    :INSTANCE :ACCESSOR %MAXIMUM-DEPTH)
   (ALLOTTED-TIME :TYPE CL:DOUBLE-FLOAT :INITFORM NULL-FLOAT
    :DOCUMENTATION "If defined, timeout after that many seconds."
    :ALLOCATION :INSTANCE :ACCESSOR %ALLOTTED-TIME)
   (ALLOTTED-CLOCK-TICKS :TYPE CL:FIXNUM :INITFORM NULL-INTEGER
    :DOCUMENTATION "If defined, timeout after that many :DOWN moves."
    :ALLOCATION :INSTANCE :ACCESSOR %ALLOTTED-CLOCK-TICKS)
   (CURRENT-CLOCK-TICKS :TYPE CL:FIXNUM :INITFORM NULL-INTEGER
    :ALLOCATION :INSTANCE :ACCESSOR %CURRENT-CLOCK-TICKS)
   (TIMEOUT? :DOCUMENTATION "Set to TRUE if query times out."
    :ALLOCATION :INSTANCE :ACCESSOR %TIMEOUT?)
   (DEPTH-CUTOFFS? :DOCUMENTATION
    "Set to TRUE if one or more depth cutoffs occurred." :ALLOCATION
    :INSTANCE :ACCESSOR %DEPTH-CUTOFFS?)
...
(CL:DEFUN NEW-QUERY-ITERATOR ()
  (CL:LET* ((SELF NULL))
   ...
   (CL:SETF (%DEPTH-CUTOFFS? SELF) CL:NIL)
   (CL:SETF (%TIMEOUT? SELF) CL:NIL)
...
(CL:DEFUN ACCESS-QUERY-ITERATOR-SLOT-VALUE (SELF SLOTNAME VALUE SETVALUE?)
  (CL:COND
   ...
   ((CL:EQ SLOTNAME SYM-QUERY-LOGIC-CONTROL-FRAME-PRIORITY-QUEUE)
    (CL:IF SETVALUE?
     (CL:SETF (%CONTROL-FRAME-PRIORITY-QUEUE SELF) VALUE)
   ...
   ((CL:EQ SLOTNAME SYM-QUERY-LOGIC-AUGMENTED-GOAL-CACHE?)
    (CL:IF SETVALUE?
     (CL:SETF (%AUGMENTED-GOAL-CACHE? SELF)
      (COERCE-WRAPPED-BOOLEAN-TO-BOOLEAN VALUE))
     (CL:SETQ VALUE
      (CL:IF (%AUGMENTED-GOAL-CACHE? SELF) TRUE-WRAPPER
       FALSE-WRAPPER))))
   ...
   ((CL:EQ SLOTNAME SYM-QUERY-LOGIC-TIMEOUT?)
    (CL:IF SETVALUE?
     (CL:SETF (%TIMEOUT? SELF)
      (COERCE-WRAPPED-BOOLEAN-TO-BOOLEAN VALUE))
     (CL:SETQ VALUE
      (CL:IF (%TIMEOUT? SELF) TRUE-WRAPPER FALSE-WRAPPER))))
...
(CL:DEFCLASS CONTROL-FRAME (STANDARD-OBJECT)
  ((STATE :ALLOCATION :INSTANCE :ACCESSOR %STATE)
   ...
   (REVERSE-POLARITY? :ALLOCATION :INSTANCE :ACCESSOR
    %REVERSE-POLARITY?)
   (STARTING-CLOCK-TICKS :TYPE CL:FIXNUM :INITFORM NULL-INTEGER
    :DOCUMENTATION "Clock ticks at last :DOWN move." :ALLOCATION
    :INSTANCE :ACCESSOR %STARTING-CLOCK-TICKS)
   (ALLOTTED-CLOCK-TICKS :TYPE CL:FIXNUM :INITFORM NULL-INTEGER
   ...
   (CHOICE-POINT-UNBINDING-OFFSET :TYPE CL:FIXNUM :INITFORM
   ...
   (CACHED-GOAL-RESULT? :ALLOCATION :INSTANCE :ACCESSOR
    %CACHED-GOAL-RESULT?)
...
(CL:DEFUN NEW-CONTROL-FRAME ()
  (CL:LET* ((SELF NULL))
   ...
   (CL:SETF (%ARGUMENT-CURSOR SELF) 0) (CL:SETF (%RESULT SELF) NULL)
   (CL:SETF (%DOWN SELF) NULL) (CL:SETF (%UP SELF) NULL)
   (CL:SETF (%ALLOTTED-CLOCK-TICKS SELF) NULL-INTEGER)
...
(CL:DEFCLASS PARALLEL-THREAD (STANDARD-OBJECT)
  ((TOP-CONTROL-FRAME :ALLOCATION :INSTANCE :ACCESSOR
    %TOP-CONTROL-FRAME)
   (HYPOTHETICAL-WORLD :ALLOCATION :INSTANCE :ACCESSOR
    %HYPOTHETICAL-WORLD)
   (VARIABLE-BINDINGS :ALLOCATION :INSTANCE :ACCESSOR
    %VARIABLE-BINDINGS)
   ...
   (PRIORITY :TYPE CL:FIXNUM :INITFORM NULL-INTEGER :ALLOCATION
    :INSTANCE :ACCESSOR %PRIORITY)
...
(CL:DEFUN NEW-PARALLEL-THREAD ()
  (CL:LET* ((SELF NULL))
   ...
   (CL:SETF (%STATUS SELF) NULL)
   (CL:SETF (%PRIORITY SELF) NULL-INTEGER)
...
(CL:DEFUN ACCESS-PARALLEL-THREAD-SLOT-VALUE (SELF SLOTNAME VALUE SETVALUE?)
  (CL:COND
   ...
   ((CL:EQ SLOTNAME SYM-QUERY-LOGIC-TOP-UNBINDING-STACK-OFFSET)
    (CL:IF SETVALUE?
     (CL:SETF (%TOP-UNBINDING-STACK-OFFSET SELF)
      (%WRAPPER-VALUE VALUE))
     (CL:SETQ VALUE
      (WRAP-INTEGER (%TOP-UNBINDING-STACK-OFFSET SELF)))))
...
(CL:DEFUN ACCESS-PARALLEL-CONTROL-FRAME-SLOT-VALUE (SELF SLOTNAME VALUE SETVALUE?)
  (CL:COND
   ...
   ((CL:EQ SLOTNAME SYM-QUERY-LOGIC-SAVED-PARENT-PARALLEL-THREAD)
    (CL:IF SETVALUE?
     (CL:SETF (%SAVED-PARENT-PARALLEL-THREAD SELF) VALUE)
...
(CL:DEFUN NEW-BOOLEAN-VECTOR-INDEX-NODE ()
  (CL:LET* ((SELF NULL))
   (CL:SETQ SELF
    (CL:MAKE-INSTANCE (CL:QUOTE BOOLEAN-VECTOR-INDEX-NODE)))
       ...
       (VALUE
        (CL:AREF
         (CL:THE CL:SIMPLE-VECTOR
          (%THE-ARRAY (%THE-VECTOR PARENTNODE)))
         I))
       (POSITION I))
...
(CL:DEFUN SET-PATTERN-VARIABLE-BINDING (VARIABLE VALUE)
  ...
  (CL:LET*
   ...
   (CL:LET
    ((SELF (%THE-ARRAY (%VARIABLE-BINDINGS PATTERNRECORD)))
  ...
  (CL:LET* ((PATTERNRECORD (%INHERITED-PATTERN-RECORD FRAME)))
   (CL:WHEN
    ...
    (%%PRINT-STREAM (%NATIVE-STREAM STANDARD-OUTPUT)
     ...
     (%CHOICE-POINT-UNBINDING-OFFSET FRAME) " NEWCP= "
   ...
   (CL:LET*
    ...
    (CL:WHEN
     (CL:AND (CL:NOT (CL:EQ BINDINGS NULL))
      (CL:NOT (CL:= OFFSET NULL-INTEGER))
      (CL:< OFFSET (LENGTH BINDINGS)))
     (CL:RETURN-FROM SAFE-BOUND-TO
      (CL:AREF (CL:THE CL:SIMPLE-VECTOR (%THE-ARRAY BINDINGS))
       OFFSET)))))
  NULL)
...
(CL:DEFUN BOUND-TO-IN-RECORD (SELF RECORD)
  (CL:AREF
   (CL:THE CL:SIMPLE-VECTOR (%THE-ARRAY (%VARIABLE-BINDINGS RECORD)))
   (CL:THE CL:FIXNUM (%BOUND-TO-OFFSET SELF))))
      ...
      (CL:LET*
       ...
       (CL:WHEN
        (CL:AND (CL:EQ VALUE NULL)
         (CL:NOT
          (CL:EQ
           (ACCESS-IN-CONTEXT (%VARIABLE-VALUE SELF)
   ...
   ((CL:EQ *TYPE-CHECK-STRATEGY* KWD-QUERY-LOOKUP)
    (CL:LET* ((TYPEISOK? CL:NIL))
     ...
     (CL:WHEN
      (CL:AND (CL:NOT TYPEISOK?)
       (NON-INFERABLE?
        (SURROGATE-TO-DESCRIPTION (%SKOLEM-TYPE VARIABLE))))
      (CL:WHEN
       (CL:AND (CL:NOT (CL:EQ *TRACED-KEYWORDS* NULL))
        ...
        (CL:LET* ((TEST-VALUE-000 CL:NIL))
         ...
         (CL:WHEN TEST-VALUE-000
          (CL:LET* ((ALWAYS?-000 CL:T))
           (CL:LET*
            ((VAR NULL) (VAL NULL)
             (ITER-000 (ALLOCATE-ITERATOR MAPPING)))
     ...
     (CL:LET* ((CHOOSE-VALUE-001 NULL))
      (CL:IF REVERSEPOLARITY?
       (CL:SETQ CHOOSE-VALUE-001
        (CL:AREF
         (CL:THE CL:SIMPLE-VECTOR
          (%THE-ARRAY (%ARGUMENTS IMPLIESPROP)))
         0))
   ...
   (CL:LET* ((INVERT? (%REVERSE-POLARITY? FRAME)))
    ...
    (CL:LET*
     ...
     (PRINT-UNFORMATTED-LOGICAL-FORM (%PROPOSITION FRAME)
      STANDARD-OUTPUT)
     (CL:WHEN
      (CL:NOT (CL:= (%ALLOTTED-CLOCK-TICKS FRAME) NULL-INTEGER))
...
(CL:DEFUN TRACE-GOAL-TREE (FRAME DEPTH LASTMOVE)
   ...
   (CL:COND
    ...
    (CL:T
     (%%PRINT-STREAM (%NATIVE-STREAM STANDARD-OUTPUT) "F"
      (DEBUG-FRAME-ID FRAME))))
   (CL:IF
    (CL:NOT (CL:= (%CHOICE-POINT-UNBINDING-OFFSET FRAME) NULL-INTEGER))
    (%%PRINT-STREAM (%NATIVE-STREAM STANDARD-OUTPUT) ","
     (%CHOICE-POINT-UNBINDING-OFFSET FRAME) " ")
    (%%PRINT-STREAM (%NATIVE-STREAM STANDARD-OUTPUT) "   "))
   (%%PRINT-STREAM (%NATIVE-STREAM STANDARD-OUTPUT)
  ...
  (CL:WHEN (TRACE-KEYWORD? KWD-QUERY-STATE-MACHINE)
   (%%PRINT-STREAM (%NATIVE-STREAM STANDARD-OUTPUT) " state= "
    (%STATE FRAME) "  lastMove= " LASTMOVE " depth= " DEPTH
    ...
    (CL:LET*
     ...
     (CL:WHEN (CL:NOT (CL:EQ (%UNBOUND-VARS PMF) NIL))
      ...
      (CL:LOOP
       ...
       (CL:SETQ I (CL:1+ I))
       (CL:SETF (%ARGUMENT-CURSOR FRAME)
        (CL:1+ (%ARGUMENT-CURSOR FRAME)))
       (RECORD-LATEST-PARTIAL-MATCH-SCORE FRAME))
...
(CL:DEFMETHOD CONTINUE-PARTIAL-AND-PROOF ((SELF CONTROL-FRAME) FRAME LASTMOVE)
  (CL:LET* ((PMF (%PARTIAL-MATCH-FRAME SELF)))
   ...
   (CONTINUE-PARTIAL-AND-PROOF (%PARTIAL-MATCH-FRAME SELF) FRAME
    LASTMOVE)))
...
(CL:DEFMETHOD CONTINUE-PARTIAL-STRATEGIES-PROOFS ((SELF CONTROL-FRAME) LASTMOVE)
  ...
  (CL:LET* ((PMF (%PARTIAL-MATCH-FRAME SELF)))
   ...
   (CONTINUE-PARTIAL-STRATEGIES-PROOFS (%PARTIAL-MATCH-FRAME SELF)
    LASTMOVE)))
...
(CL:DEFUN CREATE-DOWN-FRAME (UPFRAME DOWNPROPOSITION)
  (CL:LET* ((DOWNFRAME (NEW-CONTROL-FRAME)))
   (CL:SETF (%DOWN UPFRAME) DOWNFRAME)
   (CL:SETF (%UP DOWNFRAME) UPFRAME)
   ...
   (CL:SETF (%TRUTH-VALUE DOWNFRAME) NULL)
...
(CL:DEFUN PROPAGATE-FRAME-TRUTH-VALUE (SOURCE TARGET)
  (CL:SETF (%TRUTH-VALUE TARGET)
   (CL:IF
    (CL:NOT
     (CL:EQ (%REVERSE-POLARITY? SOURCE) (%REVERSE-POLARITY? TARGET)))
...
(CL:DEFUN COPY-FRAME-STATE (FROMFRAME TOFRAME)
  ...
  (CL:SETF (%PARTIAL-MATCH-FRAME TOFRAME)
   (%PARTIAL-MATCH-FRAME FROMFRAME))
  ...
  (CL:WHEN (CL:NOT (CL:EQ (%SAVED-PARENT-CONTEXT PFRAME) NULL))
   (CL:IF
    (CL:AND (CL:EQ (%DOWN PFRAME) NULL)
     (CL:NOT
      (CL:EQ (%HYPOTHETICAL-WORLD (%CURRENT-CHILD-THREAD PFRAME))
       NULL)))
    (CL:PROGN (POP-WORLD))
...
(CL:DEFUN EXECUTE-BACKWARD-CHAINING-PROOF? (QUERY)
  ...
  (CL:LET* ((*QUERYITERATOR* QUERY))
   ...
   (CL:LET*
    ((FRAME (%BASE-CONTROL-FRAME QUERY)) (DEPTH 0)
         ...
         (CL:WHEN (CL:EQ LASTMOVE KWD-QUERY-UP-FAIL)
          (CL:SETF (%ALLOTTED-CLOCK-TICKS FRAME)
           (CL:- (%ALLOTTED-CLOCK-TICKS FRAME)
            (CL:1+
             (CL:- CLOCKTICKS (%STARTING-CLOCK-TICKS DOWNFRAME))))))))
         ...
         (CL:IF
          (CL:AND
           ...
           (CL:NOT
            (CL:AND (CL:NOT (CL:EQ *QUERYITERATOR* NULL))
             (CL:NOT
              (CL:EQ (%PARTIAL-MATCH-STRATEGY *QUERYITERATOR*)
               NULL)))))
    ...
    (CL:WHEN CHECKFORMOVEOUT?
     ...
     (CL:WHEN (CL:NOT TIMEOUT?)
      (CL:SETF (%TIMEOUT? QUERY)
       (CL:= (%ALLOTTED-CLOCK-TICKS QUERY) 0))))
    SUCCESS?)))
     ...
     (CL:COND
      ...
      (CL:T
       ...
       (CL:WHEN (CL:EQ CONJUNCTS NULL)
        (CL:SETQ CONJUNCTS
         (NEW-VECTOR (LENGTH (%ARGUMENTS PROPOSITION))))
        (SET-DYNAMIC-SLOT-VALUE (%DYNAMIC-SLOTS FRAME)
   ...
   (CL:COND
    ...
    ((CL:EQ LASTMOVE KWD-QUERY-UP-FAIL)
     ...
     (CL:IF
      ...
      (CL:COND
       ((CL:EQ (%KEYWORD (CURRENT-INFERENCE-LEVEL))
...
(CL:DEFUN OVERLAY-WITH-FAIL-FRAME (FRAME PROPOSITION)
  (CL:LET*
   ...
   (CL:LET
    ((SELF (%THE-ARRAY (%ARGUMENTS FAILPROPOSITION)))
...
(CL:DEFUN ALL-ARGUMENTS-BOUND? (GOAL)
  (CL:IF
   (CL:NOT
    (CL:EQ
     (DYNAMIC-SLOT-VALUE (%DYNAMIC-SLOTS GOAL)
      ...
      (CL:LOOP WHILE (CL:<= ITER-001 UPPER-BOUND-001) DO
       ...
       (CL:WHEN
        (CL:NOT
         (ARGUMENT-BOUND?
          (CL:AREF
           (CL:THE CL:SIMPLE-VECTOR (%THE-ARRAY (%ARGUMENTS GOAL)))
           I)))
   ...
   (CL:WHEN (CL:NOT (CL:EQ DESCRIPTION NULL))
    ...
    (CL:IF (CL:NOT (CL:EQ EXTERNALARGUMENTS NULL))
     (CL:LET*
      ...
      (CL:SETF (%EXTERNAL-ARGUMENTS PATTERNRECORD)
       EXTERNALARGUMENTSCOPY)
    ...
    (CL:LOOP WHILE (CL:< INDEX-000 LENGTH-000) DO
     ...
     (CL:IF (CL:EQ COLLECT-000 NULL)
      (CL:PROGN
       (CL:SETQ COLLECT-000
        (CONS
         (INSTANTIATE-EXTERNAL-BINDINGS (SAFE-ARGUMENT-BOUND-TO ARG))
         NIL))
    ...
    (CL:LET* ((DESCRIPTION (NEW-DESCRIPTION)))
     (CL:LET*
      ((VAR NULL) (BINDING NULL)
       (ITER-000 (ALLOCATE-ITERATOR BINDINGS)))
  ...
  (CL:LET* ((IOVARIABLES NIL) (BOUNDVARIABLES NIL))
   ...
   (CL:LET*
    ...
    (CL:LOOP WHILE
     ...
     (CL:SETQ ITER-000 (%%REST ITER-000))
     (CL:SETQ ITER-001 (%%REST ITER-001))))
   (SINGLE-VALUED-GOAL? (%PROPOSITION PATTERN) IOVARIABLES
    BOUNDVARIABLES)))
...
(CL:DEFUN OVERLAY-WITH-PATTERN-FRAME? (FRAME DESCRIPTION IOARGUMENTS)
  (CL:LET*
   ...
   (CL:LET*
    ((IOVAR NULL) (VECTOR-000 (%IO-VARIABLES OPTIMALPATTERN))
         ...
         (CL:IF
          (CL:NOT
           (COERCE-WRAPPED-BOOLEAN-TO-BOOLEAN
            (CL:AREF
             (CL:THE CL:SIMPLE-VECTOR (%THE-ARRAY BOOLEANVECTOR)) I)))
          (CL:AREF
           (CL:THE CL:SIMPLE-VECTOR
            (%THE-ARRAY
             (%VARIABLE-BINDINGS
           ...
           (CL:THE CL:FIXNUM
            (%BOUND-TO-OFFSET
             (CL:AREF
              (CL:THE CL:SIMPLE-VECTOR (%THE-ARRAY IOVARIABLES)) I))))
          NULL)
         NIL))
  ...
  (CL:LET*
   ...
   (CL:CASE (LENGTH IOVARIABLEVALUES)
    (1
     ...
     (PUSH (%COLLECTION-LIST PATTERNRECORD)
...
(CL:DEFUN DISJOINT-TERMS? (D1 D2)
  ...
  (CL:WHEN
   (CL:EQ
    (%SURROGATE-VALUE SGT-QUERY-PL-KERNEL-KB-PARTITION-MEMBERSHIP)
    NULL)
     ...
     (CL:COND
      ...
      (CL:T
       (CL:SETQ MEMOIZED-VALUE-000
        (CL:IF
         (APPLY-CACHED-ASK
          (LIST* SYM-QUERY-LOGIC-?D1 SYM-QUERY-LOGIC-?D2 NIL)
...
(CL:DEFUN MEMBER-OF-COLLECTION? (MEMBER COLLECTION)
  ...
  (CL:WARN
   ...
   (%SYMBOL-NAME (WRAPPED-TYPE-TO-TYPE (PRIMARY-TYPE COLLECTION)))
   MEMBER COLLECTION)
  CL:NIL)
        ...
        (CL:LET* ((COL NULL) (ITER-002 ENUMERATEDCOLLECTIONS))
         (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-002 NIL)) DO
          ...
          (CL:LET*
           ((ARG NULL) (VECTOR-000 (%ARGUMENTS COL)) (INDEX-000 0)
            (LENGTH-000 (LENGTH VECTOR-000)) (I NULL-INTEGER)
            (ITER-003 2) (UPPER-BOUND-000 (LENGTH (%ARGUMENTS COL)))
            (COLLECT-002 NULL))
           (CL:DECLARE
   ...
   ((CL:EQ SLOTNAME SYM-QUERY-LOGIC-REMOVING-DUPLICATES?)
    (CL:IF SETVALUE?
     (CL:SETF (%REMOVING-DUPLICATES? SELF)
      (COERCE-WRAPPED-BOOLEAN-TO-BOOLEAN VALUE))
     (CL:SETQ VALUE
      (CL:IF (%REMOVING-DUPLICATES? SELF) TRUE-WRAPPER
       FALSE-WRAPPER))))
   ((CL:EQ SLOTNAME SYM-QUERY-LOGIC-TRUTH-VALUE)
    (CL:IF SETVALUE? (CL:SETF (%TRUTH-VALUE SELF) VALUE)
     (CL:SETQ VALUE (%TRUTH-VALUE SELF))))
...
(CL:DEFUN ALL-TRUE-EXTENSION-MEMBERS (SELF SPECIALIZE?)
  (CL:LET* ((ITERATOR (NEW-DESCRIPTION-EXTENSION-ITERATOR)))
   ...
   (CL:SETF (%EXTENSION-ITERATOR ITERATOR)
...
(CL:DEFMETHOD NEXT? ((SELF DESCRIPTION-EXTENSION-ITERATOR))
  (CL:LET*
   ((WITHINQUERY? (CL:NOT (CL:EQ *QUERYITERATOR* NULL)))
    (PATTERNRECORD
     (CL:IF WITHINQUERY? (%CURRENT-PATTERN-RECORD *QUERYITERATOR*)
      NULL))
    (UBSTACKOFFSET
     (CL:IF WITHINQUERY?
      (CL:1+ (%TOP-UNBINDING-STACK-OFFSET PATTERNRECORD))
     ...
     (CL:TAGBODY
      ...
      (CL:LET* ((VALUE (%VALUE (%EXTENSION-ITERATOR SELF))))
       ...
       (CL:LET*
        ((INSTANCE
          (CL:AREF
           (CL:THE CL:SIMPLE-VECTOR (%THE-ARRAY (%ARGUMENTS VALUE)))
           0)))
        (CL:WHEN
        ...
        (CL:IF (CL:NOT (CL:EQ (%ALREADY-GENERATED-TABLE SELF) NULL))
         (CL:WHEN
          (CL:EQ (LOOKUP (%ALREADY-GENERATED-TABLE SELF) INSTANCE)
           NULL)
      ...
      :CONTINUE))
    (CL:LET*
     ((SUBCOLLECTIONS (%SUBCOLLECTIONS SELF)) (SUBCOLLECTION NULL))
...
(CL:DEFUN HELP-FIND-DUPLICATED-GOAL (GOALFRAME)
  (CL:LET*
   ((ATOMICGOAL (%PROPOSITION GOALFRAME))
    (BINDINGS (%GOAL-BINDINGS GOALFRAME)) (DEPTH 1)
...
(CL:DEFUN HANDLE-TIMEOUT (FRAME DEPTH)
  ...
  (CL:WHEN
   (CL:AND (CL:NOT (CL:EQ *TRACED-KEYWORDS* NULL))
    (MEMB? *TRACED-KEYWORDS* KWD-QUERY-GOAL-TREE))
   (%%PRINT-STREAM (%NATIVE-STREAM STANDARD-OUTPUT)
    "*** Timeout: start=" (%STARTING-CLOCK-TICKS FRAME) " depth=" DEPTH
    EOL))
  (CL:WHEN
   (CL:AND (CL:OR *CACHE-SUCCEEDED-GOALS?* *CACHE-FAILED-GOALS?*)
    (CL:EQ *DUPLICATE-SUBGOAL-STRATEGY* KWD-QUERY-DUPLICATE-GOALS)
...
(CL:DEFUN NEW-QUERY-SOLUTION-TABLE ()
  (CL:LET* ((SELF NULL))
   ...
   (CL:LET* ((SELF-000 (NEW-KEY-VALUE-MAP)))
    (CL:SETF (%EQUAL-TEST? SELF-000) CL:T)
    (CL:SETF (%THE-MAP SELF) SELF-000))
   SELF))
...
(CL:DEFUN NEW-QUERY-SOLUTION ()
  (CL:LET* ((SELF NULL))
   ...
   (CL:SETF (%ALL-JUSTIFICATIONS SELF) NULL)
   (CL:SETF (%JUSTIFICATION SELF) NULL)
   (CL:SETF (%MATCH-SCORE SELF) NULL-FLOAT)
   (CL:SETF (%TRUTH-VALUE SELF) NULL) (CL:SETF (%BINDINGS SELF) NULL)
   SELF))
...
(CL:DEFUN ACCESS-QUERY-SOLUTION-SLOT-VALUE (SELF SLOTNAME VALUE SETVALUE?)
  (CL:COND
   ...
   ((CL:EQ SLOTNAME SYM-QUERY-LOGIC-MATCH-SCORE)
    (CL:IF SETVALUE?
     (CL:SETF (%MATCH-SCORE SELF) (%WRAPPER-VALUE VALUE))
  ...
  (CL:LET* ((MAP (%THE-MAP SELF)) (DUPLICATE (LOOKUP MAP KEY)))
   (CL:COND
    ((CL:NOT (CL:EQ DUPLICATE NULL))
     ...
     (CL:SETF (%ALL-JUSTIFICATIONS DUPLICATE)
      (%ALL-JUSTIFICATIONS VALUE)))
...
result will be in ascending order."
  (CL:LET*
   ((THEPREDICATE
    ...
    (SOLUTIONS (SORT (CONSIFY SELF) THEPREDICATE)) (CURRENT NULL)
    (NEXT NULL))
...
(CL:DEFUN QUERY-SOLUTION-LESS-THAN? (X Y)
  (CL:LET*
   ((XBINDING NULL) (VECTOR-000 (%BINDINGS X)) (INDEX-000 0)
    ...
    (VECTOR-001 (%BINDINGS Y)) (INDEX-001 0)
    (LENGTH-001 (LENGTH VECTOR-001)))
   (CL:DECLARE
    (CL:TYPE CL:FIXNUM INDEX-000 LENGTH-000 INDEX-001 LENGTH-001))
   (CL:LOOP WHILE
...
(CL:DEFUN NEW-QUERY-SOLUTION-TABLE-ITERATOR ()
  (CL:LET* ((SELF NULL))
   (CL:SETQ SELF
    (CL:MAKE-INSTANCE (CL:QUOTE QUERY-SOLUTION-TABLE-ITERATOR)))
   (CL:SETF (%FIRST-ITERATION? SELF) CL:T) (CL:SETF (%VALUE SELF) NULL)
...
(CL:DEFMETHOD NEXT? ((SELF QUERY-SOLUTION-TABLE-ITERATOR))
  (CL:LET*
   ((TABLE (%THE-TABLE SELF)) (CURSOR (%CURSOR SELF))
    (PREVIOUS CURSOR))
   (CL:COND
   ...
   (CL:COND
    ((CL:NOT (CL:EQ CURSOR NULL))
     ...
     (CL:SETF (%KEY SELF) (%BINDINGS CURSOR))
     (CL:SETF (%VALUE SELF) CURSOR) (CL:RETURN-FROM NEXT? CL:T))
...
(CL:DEFUN PRINT-CONTROL-FRAME (SELF STREAM)
  ...
  (CL:IF
   (CL:NOT (CL:= (%CHOICE-POINT-UNBINDING-OFFSET SELF) NULL-INTEGER))
  ...
  (CL:LET* ((*PRINTINFRAME* SELF))
   ...
   (CL:LET*
    ((PRINTTIMES?
      (CL:NOT (CL:= (%ALLOTTED-CLOCK-TICKS SELF) NULL-INTEGER))))
    (%%PRINT-STREAM STREAM " " (%STATE SELF) " "
    ...
    (CL:WHEN PRINTTIMES?
     (%%PRINT-STREAM STREAM " CLOCK: "
      (%CURRENT-CLOCK-TICKS *QUERYITERATOR*) " START: "
      (%STARTING-CLOCK-TICKS SELF) " TICKS: "
...
(CL:DEFUN PRINT-QUERY-ITERATOR (SELF STREAM)
  (CL:WHEN *DEBUG-MODE?*
   (%%PRINT-STREAM STREAM "[" (%DEBUG-ID SELF) "] "))
...
(CL:DEFUN PRINT-QUERY-ITERATOR-SOLUTION-ORNATELY (SELF SOLUTION SOLUTIONNUMBER STREAM)
  ...
  (CL:WHEN (CL:= SOLUTIONNUMBER NULL-INTEGER)
   (CL:SETQ SOLUTIONNUMBER 0)
   (CL:LET*
    ((SOLUTION NULL) (ITER-000 (ALLOCATE-ITERATOR (%SOLUTIONS SELF))))
    (CL:LOOP WHILE (NEXT? ITER-000) DO
     (CL:SETQ SOLUTION (%VALUE ITER-000))
...
(CL:DEFUN ALLOCATE-QUERY-ITERATOR ()
  (CL:LET* ((QUERYITERATOR (NEW-QUERY-ITERATOR)))
   ...
   (CL:SETF (%TIMESTAMP QUERYITERATOR) (GET-NOW-TIMESTAMP))
   QUERYITERATOR))
...
(CL:DEFUN ALLOCATE-COLLECTION-VARIABLES (FRAME DESCRIPTION)
  (CL:LET*
   ...
   (CL:DECLARE (CL:TYPE CL:FIXNUM VARIABLESCOUNT))
   (CL:LET*
    ((IOVAR NULL) (VECTOR-000 (%IO-VARIABLES DESCRIPTION))
    ...
    (CL:LOOP WHILE (CL:< INDEX-000 LENGTH-000) DO
     ...
     (CL:LET
      ((SELF (%THE-ARRAY EXTERNALVARIABLES))
       (VALUE
        (CREATE-VARIABLE (%SKOLEM-TYPE IOVAR) (%SKOLEM-NAME IOVAR)
         CL:NIL))
       (POSITION I))
      (CL:DECLARE (CL:TYPE CL:SIMPLE-VECTOR SELF)
       (CL:TYPE CL:FIXNUM POSITION))
     ...
     (CL:SETF
      (%BOUND-TO-OFFSET
       (CL:AREF
        (CL:THE CL:SIMPLE-VECTOR (%THE-ARRAY EXTERNALVARIABLES)) I))
      I)
     (CL:SETQ INDEX-000 (CL:1+ INDEX-000))
     (CL:SETQ ITER-000 (CL:1+ ITER-000))))
   ...
   (CL:LET*
    ...
    (CL:WHEN
     ...
     (SET-DYNAMIC-SLOT-VALUE
      (%DYNAMIC-SLOTS (%PROPOSITION DESCRIPTION))
      SYM-QUERY-LOGIC-DONT-OPTIMIZE? TRUE-WRAPPER FALSE-WRAPPER))
    ...
    (CL:SETF (%PROPOSITION BASECONTROLFRAME)
      ...
      (CL:LET*
       ...
       (CL:LOOP WHILE
        ...
        (CL:WHEN
         ...
         (CL:LET* ((STREAM-001 (NEW-OUTPUT-STRING-STREAM)))
          (%%PRINT-STREAM (%NATIVE-STREAM STREAM-001) "Binding of `"
           ARG "' to `" VALUE "' failed.")
          (CL:ERROR
    ...
    (CL:WHEN (CL:= (%MAXIMUM-DEPTH QUERYITERATOR) NULL-INTEGER)
     (CL:SETF (%MAXIMUM-DEPTH QUERYITERATOR)
...
(CL:DEFMETHOD QUERY-IS-TRUE-FALSE? ((SELF QUERY-ITERATOR))
  ...
  (CL:LET*
   ((PATTERNRECORD (%PATTERN-RECORD (%BASE-CONTROL-FRAME SELF))))
   (CL:LET* ((ALWAYS?-000 CL:T))
    (CL:LET*
     ((IGNORED-ARG NULL)
      (VECTOR-000 (%EXTERNAL-ARGUMENTS PATTERNRECORD)) (INDEX-000 0)
      (LENGTH-000 (LENGTH VECTOR-000)) (BOUND? NULL)
       ...
       (CL:LOOP
        (CL:TAGBODY (CLEAR (%BINDINGS SOLUTION))
         ...
         (CL:WHEN (CL:NOT (EXECUTE-BACKWARD-CHAINING-PROOF? SELF))
          (CL:RETURN))
         (CL:LET*
          ((EV NULL) (VECTOR-000 (%EXTERNAL-VARIABLES SELF))
           (INDEX-000 0) (LENGTH-000 (LENGTH VECTOR-000))
           (I NULL-INTEGER) (ITER-000 0))
          (CL:DECLARE
           (CL:TYPE CL:FIXNUM INDEX-000 LENGTH-000 I ITER-000))
         ...
         (CL:WHEN
          ...
          (CL:SETF (%MATCH-SCORE SOLUTION)
           (CL:IF
            (CL:AND
             (CL:NOT (CL:EQ (%PARTIAL-MATCH-FRAME BASEFRAME) NULL))
             (CL:OR
              (CL:NOT
            ...
            (%WRAPPER-VALUE
             (DYNAMIC-SLOT-VALUE (%DYNAMIC-SLOTS SELF)
              ...
              NULL-FLOAT-WRAPPER)))))
         (CL:SETQ DUPLICATE
          (LOOKUP (%SOLUTIONS SELF) (%BINDINGS SOLUTION)))
         (CL:WHEN
         ...
         (CL:WHEN
          (CL:AND
           (CL:OR
            (CL:EQ (%TRUTH-VALUE BASEFRAME) DEFAULT-TRUE-TRUTH-VALUE)
              ...
              (CL:WHEN *RECORD-JUSTIFICATIONS?*
               (CL:SETF (%JUSTIFICATION SOLUTION)
                (CREATE-CLASH-JUSTIFICATION (%PROPOSITION BASEFRAME)
                 (CONS-LIST (%JUSTIFICATION SOLUTION)
                  NEGATIVE-JUSTIFICATION)
                 KWD-QUERY-BACKWARD)))
              (CL:SETF (%TRUTH-VALUE BASEFRAME)
               INCONSISTENT-TRUTH-VALUE)
              (SET-DYNAMIC-SLOT-VALUE (%DYNAMIC-SLOTS BASEFRAME)
               SYM-QUERY-LOGIC-JUSTIFICATION (%JUSTIFICATION SOLUTION)
               NULL)
              (INSERT-AT (%SOLUTIONS SELF) (%BINDINGS SOLUTION)
               SOLUTION)
              (CL:SETF (%EXHAUSTED? SELF) CL:NIL)
              (CL:SETF (%VALUE SELF) SOLUTION)
              (CL:RETURN-FROM NEXT? CL:T))
     ...
     (CL:WHEN
      (CL:EQ SELF
       (DYNAMIC-SLOT-VALUE (%DYNAMIC-SLOTS NEGATEDQUERY)
        SYM-QUERY-LOGIC-AUXILIARY-QUERY NULL))
      (CL:RETURN-FROM TRY-TO-DEFEAT-LAST-ANSWER?
       (CL:VALUES CL:NIL NULL)))
     (SET-DYNAMIC-SLOT-VALUE (%DYNAMIC-SLOTS NEGATEDQUERY)
      SYM-QUERY-LOGIC-INITIAL-BINDINGS (%BINDINGS (%VALUE SELF))
      NULL)))
   (SET-DYNAMIC-SLOT-VALUE (%DYNAMIC-SLOTS SELF)
   ...
   (CL:WHEN (NEXT? NEGATEDQUERY) (RESET NEGATEDQUERY)
    (CL:LET* ((*DONTUSEDEFAULTKNOWLEDGE?* CL:T))
     ...
     (CL:SETQ NEGATIVEJUSTIFICATION
      (DYNAMIC-SLOT-VALUE
       (%DYNAMIC-SLOTS (%BASE-CONTROL-FRAME NEGATEDQUERY))
       SYM-QUERY-LOGIC-JUSTIFICATION NULL)))
    (CL:SETF (%REVERSE-POLARITY? (%BASE-CONTROL-FRAME NEGATEDQUERY))
     CL:NIL)
    (RESET NEGATEDQUERY)
     ...
     (CL:WHEN
      (CL:NOT
       (CL:EQ
        ...
        NULL))
      (CL:LET*
       ((ARG NULL) (VECTOR-000 (%EXTERNAL-VARIABLES SELF))
  ...
  (CL:LET*
   ...
   (CL:LET*
    ...
    (CL:DECLARE
      ...
      *TERMUNDERCONSTRUCTION* *QUERYITERATOR*))
...
(CL:DEFUN PARSE-QUERY-AND-OPTIONS (|QUERY&OPTIONS|)
  ...
  (CL:LET*
   ((FIRSTARG (%%VALUE |QUERY&OPTIONS|)) (VARIABLES NULL)
    ...
    (HANDLENONMATCHINGVARIABLES? CL:NIL) (FREEVARIABLES NULL)
   ...
   (CL:WHEN (CONS? PROPOSITION) (CL:SETQ FREEVARIABLES (NEW-LIST))
    ...
    (CL:COND
     ...
     ((CL:NOT
       (EQUIVALENT-SETS? (%THE-CONS-LIST FREEVARIABLES)
        DECLAREDVARIABLES))
...
(CL:DEFUN PROCESS-QUERY-OPTIONS (QUERY OPTIONS)
  (CL:LET*
   ...
   (CL:LET*
    ((KEY NULL) (VALUE NULL) (ITER-000 (%THE-PLIST THEOPTIONS)))
    (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-000 NIL)) DO
      ...
      (CL:COND
          ...
          ((SUBTYPE-OF-INTEGER? TEST-VALUE-001)
           (CL:PROGN
            ...
            (INSERT-AT THEOPTIONS KEY
             (WRAP-FLOAT (%ALLOTTED-TIME QUERY)))))
       ...
       ((CL:EQ TEST-VALUE-000 KWD-QUERY-ITERATIVE-DEEPENING?)
        ...
        (CL:WHEN (EQL? VALUE TRUE-WRAPPER)
         (SET-DYNAMIC-SLOT-VALUE (%DYNAMIC-SLOTS QUERY)
          SYM-QUERY-LOGIC-ITERATIVE-DEEPENING? TRUE-WRAPPER
          FALSE-WRAPPER)))
...
queries and logical expressions."
  (CL:LET*
   ...
   (CL:LET*
    ...
    (NEXT? *QUERYITERATOR*)
    (CL:LET*
     ((TEMP-000 (%TRUTH-VALUE (%BASE-CONTROL-FRAME *QUERYITERATOR*))))
     (CL:SETQ TRUTH-VALUE
      (CL:IF (CL:NOT (CL:EQ TEMP-000 NULL)) TEMP-000
       UNKNOWN-TRUTH-VALUE)))
    (CL:WHEN
     (CL:AND
      (CL:OR (CL:EQ TRUTH-VALUE UNKNOWN-TRUTH-VALUE)
       (CL:EQ TRUTH-VALUE NULL))
      (CL:OR THREEVALUEDASK? FOURVALUEDASK?))
     (CL:SETF
      (%REVERSE-POLARITY? (%BASE-CONTROL-FRAME *QUERYITERATOR*)) CL:T)
   ...
   (CL:LET*
    ...
    (CL:LET*
     ((I NULL-INTEGER) (ITER-000 1)
      ...
      (UNBOUNDED?-000 (CL:= UPPER-BOUND-000 NULL-INTEGER))
      (SOLUTION NULL) (ITER-001 *QUERYITERATOR*))
     (CL:DECLARE (CL:TYPE CL:FIXNUM I ITER-000 UPPER-BOUND-000))
     (CL:LOOP WHILE
      ...
      (CL:SETQ ITER-000 (CL:1+ ITER-000))))
    (CL:LET*
     ((SORTOPTION (LOOKUP-QUERY-OPTION THEQUERY KWD-QUERY-SORT-BY)))
     (CL:COND
     ...
     (CL:HANDLER-CASE
      (CL:SETQ QUERYITERATOR
       (MAKE-QUERY (COPY-CONS-LIST VARIABLES)
        (COPY-CONS-TREE QUERYBODY) INPUTBINDINGS OPTIONS "Cached"))
      (LOGIC-EXCEPTION (E)
       (%%PRINT-STREAM (%NATIVE-STREAM STANDARD-ERROR)
        (EXCEPTION-MESSAGE E))
       (CL:RETURN-FROM MAKE-CACHED-QUERY NULL))))
...
(CL:DEFUN APPLY-CACHED-RETRIEVE (VARIABLES QUERYBODY INPUTBINDINGS OPTIONS CACHEID)
  (CL:LET*
   ((QUERYITERATOR NULL) (BINDINGSCOUNT 0) (OUTPUTBINDINGS NIL)
    (TRUTHVALUES NIL) (JUSTIFICATIONS NIL)
   ...
   (CL:WHEN
    (CL:OR
     (EQL? (LOOKUP (%OPTIONS QUERYITERATOR) KWD-QUERY-SINGLETONS?)
      FALSE-WRAPPER)
     (EQL?
      (LOOKUP (%OPTIONS QUERYITERATOR) KWD-QUERY-ATOMIC-SINGLETONS?)
      FALSE-WRAPPER))
     ...
     (CL:LOOP WHILE (NEXT? ITER-000) DO (CL:SETQ S (%VALUE ITER-000))
       ...
       (CL:LET* ((VALUES NIL))
        (CL:LET*
         ((V NULL) (VECTOR-001 (%BINDINGS S)) (INDEX-001 0)
          (LENGTH-001 (LENGTH VECTOR-001)) (B NULL)
      ...
      (CL:WHEN *RECORD-JUSTIFICATIONS?*
       (CL:SETQ JUSTIFICATIONS
        (CONS (%JUSTIFICATION S) JUSTIFICATIONS))))))
  ...
  (CL:LET*
   ...
   (CL:HANDLER-CASE
    (CL:PROGN (INHERIT-DESCRIPTION SKOLEMSVECTOR SUB CL:NIL)
     (CL:SETQ RESULT
      (CALL-ASK
       (CREATE-QUERY-ITERATOR SUPER SKOLEMSVECTOR "d-specialize"))))
    (LOGIC-EXCEPTION (E)
     (%%PRINT-STREAM (%NATIVE-STREAM STANDARD-ERROR)
      (EXCEPTION-MESSAGE E))))
   (POP-WORLD)
   ...
   (CL:LET* ((ALWAYS?-000 CL:T))
    ...
    (CL:WHEN ALWAYS?-000
     (CL:RETURN-FROM VECTOR-SATISFIES-DESCRIPTION?
      (CALL-ASK
       (CREATE-QUERY-ITERATOR DESCRIPTION VECTOR "v-specialize")))))
   (LOGIC-EXCEPTION (E)
    (%%PRINT-STREAM (%NATIVE-STREAM STANDARD-ERROR)
     (EXCEPTION-MESSAGE E))))
  UNKNOWN-TRUTH-VALUE)
  ...
  (CL:LET* ((TEST-VALUE-000 (SAFE-PRIMARY-TYPE SELF)))
   (CL:COND
    ...
    ((SUBTYPE-OF-SURROGATE? TEST-VALUE-000)
     (CL:PROGN
      (COERCE-TO-DESCRIPTION (%SURROGATE-VALUE SELF) ORIGINAL)))
    ((SUBTYPE-OF-SYMBOL? TEST-VALUE-000)
     (CL:PROGN
...
literal (e.g., string or number) that can't be coerced."
  ...
  (CL:LET* ((TEST-VALUE-000 (SAFE-PRIMARY-TYPE SELF)))
   (CL:COND
    ...
    ((SUBTYPE-OF-SURROGATE? TEST-VALUE-000)
     (CL:PROGN
      (COERCE-TO-INSTANCE-OR-LITERAL (%SURROGATE-VALUE SELF)
       ORIGINAL)))
    ((SUBTYPE-OF-SYMBOL? TEST-VALUE-000)
     (CL:PROGN
...
(CL:DEFUN UPDATE-PROPOSITIONS-FROM-QUERY (QUERY DESCRIPTION MODULE UPDATEMODE RECORDJUSTIFICATIONS?)
  ...
  (CL:LET*
   ...
   (CL:WHEN
    ...
    (CL:SETQ PROPOSITION (SHALLOW-COPY-PROPOSITION PROPOSITION))
    (CL:SETF (%ARGUMENTS PROPOSITION)
     (COPY (%IO-VARIABLES QUERYDESCRIPTION)))
   ...
   (CL:LET* ((*MODULE* MODULE) (*CONTEXT* *MODULE*))
    ...
    (CL:LET*
     ...
     (CL:LOOP WHILE (NEXT? ITER-000) DO
      ...
      (CL:LET*
       ((VAR NULL) (VECTOR-000 (%IO-VARIABLES DESCRIPTION))
        (INDEX-000 0) (LENGTH-000 (LENGTH VECTOR-000)) (BINDING NULL)
      ...
      (CL:LET*
       ...
       (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-002 NIL)) DO
        ...
        (CL:LET*
         ...
         (CL:WHEN PARTIAL?
          (SET-DYNAMIC-SLOT-VALUE (%DYNAMIC-SLOTS PROP)
           SYM-QUERY-LOGIC-WEIGHT (WRAP-FLOAT (%MATCH-SCORE SOLUTION))
           NULL-FLOAT-WRAPPER))
         (VERIFY-ARGUMENT-TYPES-AND-COUNT PROP)
         (CL:WHEN
          (CL:AND RECORDJUSTIFICATIONS?
           (CL:NOT (CL:EQ JUSTIFICATION NULL)))
          (CL:LET* ((SELF-007 (NEW-JUSTIFICATION)))
           (CL:SETF (%INFERENCE-RULE SELF-007)
            KWD-QUERY-ASSERT-FROM-QUERY)
  ...
  (CL:LET* ((QUERYITERATOR (EVALUATE-LOGIC-COMMAND QUERY CL:T)))
   (CL:WHEN
    (CL:AND
     ...
     (SYMBOL? (%%VALUE QUERY))
     (STRING-EQUAL? (SUBSEQUENCE (%SYMBOL-NAME (%%VALUE QUERY)) 0 3)
      "ASK"))
    ...
    ((THEOPTIONS
      (PARSE-LOGIC-COMMAND-OPTIONS OPTIONS
       (LIST* KWD-QUERY-MODULE SGT-QUERY-STELLA-MODULE
        KWD-QUERY-RELATION SGT-QUERY-STELLA-SYMBOL KWD-QUERY-PATTERN
        SGT-QUERY-STELLA-CONS KWD-QUERY-RECORD-JUSTIFICATIONS?
        SGT-QUERY-STELLA-BOOLEAN NIL)
       CL:T CL:NIL))
     (PATTERN NULL)
...
(CL:DEFUN HELP-STARTUP-QUERY4 ()
  (CL:PROGN
   ...
   (CL:SETQ SGT-QUERY-LOGIC-F-DISJOINT-TERMS?-MEMO-TABLE-000
    (INTERN-RIGID-SYMBOL-WRT-MODULE "F-DISJOINT-TERMS?-MEMO-TABLE-000"
     NULL 1))
   (CL:SETQ SYM-QUERY-LOGIC-F-DISJOINT-TERMS?-QUERY-001
    (INTERN-RIGID-SYMBOL-WRT-MODULE "F-DISJOINT-TERMS?-QUERY-001" NULL
     0))
...
(CL:DEFUN HELP-STARTUP-QUERY5 ()
  (CL:PROGN
   ...
   (CL:SETQ KWD-QUERY-VALUES
    (INTERN-RIGID-SYMBOL-WRT-MODULE "VALUES" NULL 2))
...
be reparsed and reoptimized each time they are invoked.\" :THREAD-LOCAL? TRUE)")
    ...
    (DEFINE-EXPLANATION-PHRASE KWD-QUERY-ASSERT-FROM-QUERY
     KWD-QUERY-TECHNICAL "because it was asserted from a query")
    (DEFINE-EXPLANATION-PHRASE KWD-QUERY-ASSERT-FROM-QUERY
     KWD-QUERY-LAY "because it was asserted from a query")
