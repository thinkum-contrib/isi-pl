...
(CL:DEFVAR SYM-QUERY-LOGIC-QUERY-047 NULL)
...
(CL:DEFVAR SYM-QUERY-LOGIC-QUERY-048 NULL)
...
(CL:DEFVAR SYM-QUERY-LOGIC-QUERY-050 NULL)
...
(CL:DECLAIM
  ...
  *CLASSIFY-FROM-NON-INFERABLE-PARENTS-ONLY?* STANDARD-ERROR
  *MOST-RECENT-QUERY* *PRINTREADABLY?* *CYC-KLUDGES-ENABLED?* ZERO-WRAPPER
  *RECORD-JUSTIFICATIONS?* *CACHE-SUCCEEDED-GOALS?* *CACHE-FAILED-GOALS?*
  *CONTEXT* NULL-INTEGER-WRAPPER *PARTIAL-SUPPORT-COUNTER* NULL-FLOAT-WRAPPER
  *FAIL-UNBOUND-CLAUSES?* TRUE-TRUTH-VALUE FALSE-TRUTH-VALUE
  UNKNOWN-TRUTH-VALUE STANDARD-WARNING ONE-WRAPPER STANDARD-OUTPUT
  DEFAULT-TRUE-TRUTH-VALUE DEFAULT-FALSE-TRUTH-VALUE NIL TRUE-WRAPPER
  FALSE-WRAPPER NIL-LIST NULL-FLOAT *TRACED-KEYWORDS*
  *CURRENT-POWERLOOM-FEATURES* NULL-INTEGER FALSE TRUE EOL *QUERYITERATOR*
  *MODULE*))
...
by 'levelKeyword'.  If `module' is NULL, set the level globally."
  (CL:LET*
   ((THEMODULE (COERCE-TO-MODULE MODULE TRUE))
...
(CL:DEFUN NEW-QUERY-ITERATOR ()
  (CL:LET* ((SELF NULL))
   ...
   (CL:SETF (%TIMEOUT? SELF) FALSE) (CL:SETF (%CURRENT-CLOCK-TICKS SELF) 0)
...
(CL:DEFMETHOD BAD? ((SELF QUERY-ITERATOR))
  (CL:LET*
   ...
   (CL:IF (CL:EQ ANSWER NULL) (CL:IF FALSE TRUE-WRAPPER FALSE-WRAPPER) ANSWER)))
...
(CL:DEFUN NEW-CONTROL-FRAME ()
  (CL:LET* ((SELF NULL))
   ...
   (CL:SETF (%CACHED-GOAL-RESULT? SELF) FALSE)
...
(CL:DEFVAR *EMIT-THINKING-DOTS?* FALSE
...
(CL:DEFUN FAILS-UNIFICATION-TYPE-CHECK? (V1 I2)
  (CL:COND ((CL:EQ *TYPE-CHECK-STRATEGY* KWD-QUERY-NONE) FALSE)
   ((CL:EQ *TYPE-CHECK-STRATEGY* KWD-QUERY-LOOKUP)
    (CL:LET* ((TYPE (%SKOLEM-TYPE V1)) (TYPEISOK? (CHECK-TYPE? I2 TYPE TRUE)))
     (CL:IF
   ...
   ((CL:EQ *TYPE-CHECK-STRATEGY* KWD-QUERY-LOOKUP)
    (CL:LET* ((TYPEISOK? FALSE))
     (CL:MULTIPLE-VALUE-SETQ (TYPEISOK? VALUE)
      (CHECK-TYPE? VALUE (%SKOLEM-TYPE VARIABLE) TRUE))
     (CL:WHEN
      (CL:AND (CL:NOT TYPEISOK?)
...
(CL:DEFUN BIND-VARIABLE-TO-VALUE? (VARIABLE VALUE AUTOCLEANUP?)
  (CL:WHEN (CL:EQ VALUE NULL)
   (CL:WHEN
    ...
    (CL:RETURN-FROM BIND-VARIABLE-TO-VALUE? TRUE))
   ...
   (CL:RETURN-FROM BIND-VARIABLE-TO-VALUE? FALSE))
  (CL:IF AUTOCLEANUP?
   (CL:LET*
    ((PATTERNRECORD (%CURRENT-PATTERN-RECORD *QUERYITERATOR*))
   ...
   (CL:WHEN
    (CL:AND
     (CL:AND (CL:NOT (CL:EQ *QUERYITERATOR* NULL))
      (CL:NOT (CL:EQ (%PARTIAL-MATCH-STRATEGY *QUERYITERATOR*) NULL)))
     (ALLOW-UNBOUND-VARIABLES? (%PARTIAL-MATCH-STRATEGY *QUERYITERATOR*)))
    (CL:RETURN-FROM BIND-ARGUMENT-TO-VALUE? TRUE))
   (CL:LET* ((*PRINTREADABLY?* TRUE))
    (CL:DECLARE (CL:SPECIAL *PRINTREADABLY?*))
    (%%PRINT-STREAM (%NATIVE-STREAM STANDARD-WARNING)
        ...
        (CL:LET* ((TEST-VALUE-000 FALSE))
         ...
         (CL:WHEN TEST-VALUE-000
          (CL:LET* ((ALWAYS?-000 TRUE))
           (CL:LET* ((VAL NULL) (VAR NULL) (ITER-000 (%THE-KV-LIST MAPPING)))
            (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-000 NULL)) DO
             (CL:SETQ VAR (%KEY ITER-000))
       ...
       (CL:WHEN (CL:NOT (CL:EQ TRUTHVALUE NULL))
        ...
        (CL:COND
         ...
         ((CL:OR (CL:EQ TRUTHVALUE UNKNOWN-TRUTH-VALUE)
          ...
          (%%PRINT-STREAM (%NATIVE-STREAM STANDARD-OUTPUT) "U"))
      ...
      (CL:COND
       ...
       ((CL:OR (CL:EQ TRUTHVALUE FALSE-TRUTH-VALUE)
        ...
        (CL:IF
         ...
         (%%PRINT-STREAM (%NATIVE-STREAM STANDARD-OUTPUT) "f")
         (%%PRINT-STREAM (%NATIVE-STREAM STANDARD-OUTPUT) "F")))
       ((CL:OR (CL:EQ TRUTHVALUE UNKNOWN-TRUTH-VALUE) (CL:EQ TRUTHVALUE NULL))
        (%%PRINT-STREAM (%NATIVE-STREAM STANDARD-OUTPUT) "U"))
       (CL:T (%%PRINT-STREAM (%NATIVE-STREAM STANDARD-OUTPUT) "?"))))))
   (CL:T (%%PRINT-STREAM (%NATIVE-STREAM STANDARD-OUTPUT) "????: ")))
  (CL:WHEN (TRACE-KEYWORD? KWD-QUERY-STATE-MACHINE)
  ...
  (CL:LET* ((*QUERYITERATOR* QUERY)) (CL:DECLARE (CL:SPECIAL *QUERYITERATOR*))
   (CL:LET*
    ((FRAME (%BASE-CONTROL-FRAME QUERY)) (DEPTH 0) (LASTMOVE KWD-QUERY-DOWN)
     ...
     (TRACESUBGOALS? (TRACE-KEYWORD? KWD-QUERY-GOAL-TREE)) (TIMEOUT? FALSE)
     (SUCCESS? FALSE))
    ...
    (CL:LOOP (CL:SETF (%CURRENT-CONTROL-FRAME QUERY) FRAME)
     ...
     (CL:WHEN
      ...
      (CL:LET*
       ...
       (CL:WHEN (CL:<= ALLOTTEDTIME 0.0d0) (CL:SETQ TIMEOUT? TRUE))))
     ...
     (CL:COND
       ...
       (CL:LET* ((UPFRAME FRAME) (DOWNFRAME (%DOWN FRAME)))
        ...
        (CL:COND
         ((CL:NOT (CL:EQ DOWNFRAME NULL)) (CL:SETQ FRAME DOWNFRAME)
          (CL:SETF (%STARTING-CLOCK-TICKS FRAME) CLOCKTICKS)
          (CL:WHEN
           (CL:AND CHECKFORMOVEOUT? (NULL? (%ALLOTTED-CLOCK-TICKS FRAME)))
      ...
      ((CL:EQ RESULTOFNEXTMOVE KWD-QUERY-FINAL-SUCCESS)
       (CL:LET* ((PARENT (%UP FRAME)))
        ...
        (CL:WHEN (CL:EQ FRAME NULL) (CL:SETQ SUCCESS? TRUE) (CL:RETURN))
         ...
         (CL:WHEN (CL:NOT (CL:EQ PARENT NULL))
          (CL:SETF (%ALLOTTED-CLOCK-TICKS PARENT)
           (CL:- (%ALLOTTED-CLOCK-TICKS PARENT)
            (CL:- CLOCKTICKS (%STARTING-CLOCK-TICKS FRAME)) 1))))
        (CL:SETQ FRAME PARENT)
        (CL:WHEN (CL:EQ FRAME NULL) (CL:SETQ SUCCESS? FALSE) (CL:RETURN))
    ...
    (CL:LOOP WHILE (CL:< INDEX-000 LENGTH-000) DO
     (CL:PROGN
      (CL:SETQ CONJUNCT
       (CL:AREF (CL:THE CL:SIMPLE-VECTOR (%THE-ARRAY VECTOR-000)) INDEX-000))
      (CL:SETQ INDEX-000 (CL:1+ INDEX-000)))
     (CL:WHEN (CL:EQ (%KIND CONJUNCT) KWD-QUERY-AND) (CL:SETQ FOUND?-000 TRUE)
      (CL:RETURN))))
  ...
  (CL:LET* ((PROPOSITION (%PROPOSITION FRAME)) (CONJUNCTS NULL))
   (CL:COND
    ...
    ((CL:EQ LASTMOVE KWD-QUERY-UP-TRUE)
     ...
     (CL:COND
      ((CL:= (%ARGUMENT-CURSOR FRAME) (CL:1- (LENGTH CONJUNCTS)))
       (CL:SETF (%DOWN FRAME) NULL)
       (CL:LET*
        ((I NULL-INTEGER) (CONJUNCT NULL) (VECTOR-000 CONJUNCTS) (INDEX-000 0)
    ...
    ((CL:EQ LASTMOVE KWD-QUERY-UP-FAIL)
     ...
     (CL:SETF (%DOWN FRAME) NULL)
     (CL:LET*
      ((I NULL-INTEGER) (CONJUNCT NULL) (VECTOR-001 CONJUNCTS) (INDEX-001 0)
     ...
     (CL:COND ((CL:NOT (CL:EQ (%DOWN FRAME) NULL)) KWD-QUERY-MOVE-DOWN)
      (CL:T (CL:SETF (%TRUTH-VALUE FRAME) UNKNOWN-TRUTH-VALUE)
       (CL:LET
        ((SELF (%THE-ARRAY CONJUNCTS)) (VALUE (%RESULT FRAME))
         (POSITION (%ARGUMENT-CURSOR FRAME)))
        (CL:DECLARE (CL:TYPE CL:SIMPLE-VECTOR SELF)
        ...
        (CL:SETF (CL:AREF SELF POSITION) VALUE))
       (CL:LET*
        ((I NULL-INTEGER) (CONJUNCT NULL) (VECTOR-002 CONJUNCTS) (INDEX-002 0)
         (LENGTH-002 (LENGTH VECTOR-002)) (ITER-002 0)
         (UPPER-BOUND-000 (%ARGUMENT-CURSOR FRAME))
         (UNBOUNDED?-000 (NULL? UPPER-BOUND-000)))
        (CL:DECLARE
         (CL:TYPE CL:FIXNUM INDEX-002 LENGTH-002 ITER-002 UPPER-BOUND-000 I))
        (CL:LOOP WHILE
...
(CL:DEFUN CONTINUE-OR-PROOF (FRAME LASTMOVE)
  (CL:LET* ((PROPOSITION (%PROPOSITION FRAME)))
   (CL:COND
    ...
    ((CL:EQ LASTMOVE KWD-QUERY-UP-FAIL)
     (CL:SETF (%TRUTH-VALUE FRAME)
      (CL:IF (CL:EQ (%TRUTH-VALUE FRAME) NULL) (%TRUTH-VALUE (%RESULT FRAME))
...
(CL:DEFUN CHECK-FOR-DUPLICATE-GOAL? (FRAME)
  ...
  (CL:LET*
   ...
   (CL:LET*
    ...
    (CL:LOOP WHILE (CL:OR UNBOUNDED?-000 (CL:<= ITER-000 UPPER-BOUND-000)) DO
     (CL:PROGN (CL:SETQ I ITER-000) (CL:SETQ ITER-000 (CL:1+ ITER-000)))
     (CL:SETQ I I) (CL:WHEN (CL:EQ PREVIOUSFRAME NULL) (CL:RETURN))
     (CL:LET* ((TEST-VALUE-000 FALSE))
...
(CL:DEFUN INITIATE-ATOMIC-GOAL-PROOFS (FRAME)
  (CL:LET* ((*REVERSEPOLARITY?* (%REVERSE-POLARITY? FRAME)))
   ...
   (CL:LET*
    ...
    (CL:SETF (%STATE FRAME) KWD-QUERY-ATOMIC-GOAL) KWD-QUERY-MOVE-IN-PLACE)))
   ...
   (CL:LET*
    ...
    (CL:LOOP WHILE (CL:< INDEX-000 LENGTH-000) DO
     ...
     (CL:IF (CL:EQ COLLECT-000 NULL)
      (CL:PROGN
       (CL:SETQ COLLECT-000
        (CONS (INSTANTIATE-EXTERNAL-BINDINGS (ARGUMENT-BOUND-TO ARG)) NIL))
    ...
    (CL:LOOP WHILE (CL:< INDEX-000 LENGTH-000) DO
     ...
     (CL:IF (CL:EQ COLLECT-000 NULL)
      ...
      (CL:PROGN (CL:SETF (%%REST COLLECT-000) (CONS VBL NIL))
       (CL:SETQ COLLECT-000 (%%REST COLLECT-000))))))
   (CL:LET* ((V2 NULL) (V1 NULL) (ITER-000 IOVARIABLES) (ITER-001 IOBINDINGS))
    (CL:LOOP WHILE
...
(CL:DEFUN OVERLAY-WITH-PATTERN-FRAME? (FRAME DESCRIPTION IOARGUMENTS)
  (CL:LET*
   ...
   (CL:LET*
    ((BINDING NULL) (IOVAR NULL) (VECTOR-000 (%IO-VARIABLES OPTIMALPATTERN))
     (INDEX-000 0) (LENGTH-000 (LENGTH VECTOR-000)) (ITER-000 IOBINDINGS))
    (CL:DECLARE (CL:TYPE CL:FIXNUM INDEX-000 LENGTH-000))
    (CL:LOOP WHILE
     (CL:AND (CL:< INDEX-000 LENGTH-000) (CL:NOT (CL:EQ ITER-000 NIL))) DO
     (CL:PROGN
   ...
   (ELABORATE-SURROGATES-IN-PROPOSITION (%PROPOSITION OPTIMALPATTERN)) TRUE))
   ...
   (CL:LET* ((PARENTPATTERNRECORD (%CURRENT-PATTERN-RECORD *QUERYITERATOR*)))
    ...
    (CL:LET*
     ((INITIALLYBOUND? NULL) (EXTERNALARG NULL) (VALUE NULL)
      (ITER-001 IOVARIABLEVALUES) (VECTOR-000 EXTERNALARGUMENTS) (INDEX-000 0)
      (LENGTH-000 (LENGTH VECTOR-000)) (VECTOR-001 BOOLEANVECTOR)
      (INDEX-001 0) (LENGTH-001 (LENGTH VECTOR-001)))
     (CL:DECLARE
     ...
     (CL:SETF (%TRUTH-VALUE FRAME)
      (WEAKEN-TRUTH-VALUE (PROPAGATE-FRAME-TRUTH-VALUE RESULT FRAME)
       (CL:IF (CL:NOT (CL:EQ RULE NULL))
        (ACCESS-IN-CONTEXT (%TRUTH-VALUE RULE) (%HOME-CONTEXT RULE) FALSE)
        TRUE-TRUTH-VALUE)))
...
(CL:DEFUN DISJOINT-TERMS? (D1 D2)
  ...
  (APPLY-CACHED-ASK (LIST* SYM-QUERY-LOGIC-?D1 SYM-QUERY-LOGIC-?D2 NIL)
   (LIST* SYM-QUERY-LOGIC-DISJOINT SYM-QUERY-LOGIC-?D1 SYM-QUERY-LOGIC-?D2
    NIL)
   (CONS-LIST D1 D2) (CONS-LIST) SYM-QUERY-LOGIC-QUERY-047))
  ...
  (APPLY-CACHED-ASK (LIST* SYM-QUERY-LOGIC-?D1 SYM-QUERY-LOGIC-?D2 NIL)
   (LIST* SYM-QUERY-STELLA-OR
    ...
    (LIST* SYM-QUERY-STELLA-AND
     ...
     NIL)
    NIL)
   (CONS-LIST D1 D2) (CONS-LIST) SYM-QUERY-LOGIC-QUERY-048))
      ...
      (CL:LET* ((FOUND?-000 FALSE))
       (CL:LET* ((M NULL) (ITER-000 (ALLOCATE-ITERATOR COLLECTION)))
        (CL:LOOP WHILE (NEXT? ITER-000) DO (CL:SETQ M (%VALUE ITER-000))
         (CL:WHEN (EQL? (VALUE-OF M) MEMBER) (CL:SETQ FOUND?-000 TRUE)
          (CL:RETURN))))
        ...
        ((CL:NOT (CL:EQ ENUMERATEDCOLLECTIONS NIL))
         (CL:LET* ((COL NULL) (ITER-001 ENUMERATEDCOLLECTIONS))
          (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-001 NIL)) DO
           (CL:PROGN (CL:SETQ COL (%%VALUE ITER-001))
            (CL:SETQ ITER-001 (%%REST ITER-001)))
           (CL:LET*
            ((I NULL-INTEGER) (ARG NULL) (VECTOR-000 (%ARGUMENTS COL))
             (INDEX-000 0) (LENGTH-000 (LENGTH VECTOR-000)) (ITER-002 2)
             (UPPER-BOUND-000 (LENGTH (%ARGUMENTS COL))))
            (CL:DECLARE
             (CL:TYPE CL:FIXNUM INDEX-000 LENGTH-000 ITER-002 UPPER-BOUND-000
              I))
            (CL:LOOP WHILE
         ...
         (CL:IF *REVERSEPOLARITY?* (CL:NOT SUCCESS?) SUCCESS?))
        (CL:T
         (CL:LET*
          ((P NULL)
           (ITER-003
       ...
       (CL:IF (CL:NOT (CL:EQ ENUMERATEDCOLLECTIONS NIL))
        (CL:LET* ((COL NULL) (ITER-002 ENUMERATEDCOLLECTIONS))
         (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-002 NIL)) DO
          (CL:PROGN (CL:SETQ COL (%%VALUE ITER-002))
           (CL:SETQ ITER-002 (%%REST ITER-002)))
          (CL:LET*
           ((I NULL-INTEGER) (ARG NULL) (VECTOR-000 (%ARGUMENTS COL))
            (INDEX-000 0) (LENGTH-000 (LENGTH VECTOR-000)) (ITER-003 2)
            (UPPER-BOUND-000 (LENGTH (%ARGUMENTS COL))) (COLLECT-002 NULL))
           (CL:DECLARE
            (CL:TYPE CL:FIXNUM INDEX-000 LENGTH-000 ITER-003 UPPER-BOUND-000
             I))
           (CL:LOOP WHILE
            (CL:AND (CL:< INDEX-000 LENGTH-000)
   ...
   (CL:LOOP
    ...
    (CL:LET* ((SUBCOLLECTIONS (%SUBCOLLECTIONS SELF)) (SUBCOLLECTION NULL))
     ...
     (CL:LOOP WHILE (CL:NOT (CL:EQ SUBCOLLECTIONS NIL)) DO
      ...
      (CL:IF (CL:NOT (EMPTY? (GET-DESCRIPTION-EXTENSION SUBCOLLECTION TRUE)))
...
(CL:DEFUN NEW-QUERY-SOLUTION-TABLE ()
  (CL:LET* ((SELF NULL))
   ...
   (CL:LET* ((SELF-000 (NEW-KEY-VALUE-MAP)))
    (CL:SETF (%EQUAL-TEST? SELF-000) TRUE) (CL:SETF (%THE-MAP SELF) SELF-000))
   SELF))
...
result will be in ascending order."
  (CL:LET*
   ((SOLUTIONS (SORT (CONSIFY SELF) PREDICATE)) (CURRENT NULL) (NEXT NULL))
  ...
  (CL:LET*
   ...
   (CL:COND
    ((%FIRST-ITERATION? SELF) (CL:SETQ PREVIOUS NULL)
     (CL:SETQ CURSOR (%FIRST TABLE)) (CL:SETF (%FIRST-ITERATION? SELF) FALSE))
...
(CL:DEFUN PRINT-CONTROL-FRAME (SELF STREAM)
  ...
  (CL:LET* ((*PRINTINFRAME* SELF)) (CL:DECLARE (CL:SPECIAL *PRINTINFRAME*))
   (CL:LET* ((PRINTTIMES? (DEFINED? (%ALLOTTED-CLOCK-TICKS SELF))))
    (%%PRINT-STREAM STREAM " " (%STATE SELF) " " (%CURRENT-STRATEGY SELF)
     "  UP: "
     (CL:IF (CL:NOT (CL:EQ (%UP SELF) NULL)) (DEBUG-FRAME-ID (%UP SELF))
      NULL-INTEGER)
     "  DOWN: "
     (CL:IF (CL:NOT (CL:EQ (%DOWN SELF) NULL)) (DEBUG-FRAME-ID (%DOWN SELF))
      NULL-INTEGER)
     "  DEPTH: " (COMPUTE-FRAME-DEPTH SELF))
    (CL:WHEN PRINTTIMES?
    ...
    (%%PRINT-STREAM STREAM " " (%PROPOSITION SELF) "]"))))
...
(CL:DEFUN PRINT-QUERY-ITERATOR-ORNATELY (SELF STREAM)
  (CL:LET*
   ...
   (CL:LET* ((*PRINTREADABLY?* TRUE))
    (CL:DECLARE (CL:SPECIAL *PRINTREADABLY?*))
    (CL:LET*
     ((I NULL-INTEGER) (SOLUTION NULL)
      (ITER-000 (ALLOCATE-ITERATOR SOLUTIONS)) (ITER-001 1))
...
(CL:DEFUN PRINT-QUERY-ITERATOR-SOLUTION-ORNATELY (SELF SOLUTION SOLUTIONNUMBER STREAM)
  ...
  (CL:LET* ((*PRINTREADABLY?* TRUE))
   ...
   (CL:LET*
    ((VI NULL-INTEGER) (VARIABLE NULL) (VALUE NULL)
     (VECTOR-000 (%BINDINGS SOLUTION)) (INDEX-000 0)
     (LENGTH-000 (LENGTH VECTOR-000)) (VECTOR-001 (%EXTERNAL-VARIABLES SELF))
     (INDEX-001 0) (LENGTH-001 (LENGTH VECTOR-001)) (ITER-001 0))
    (CL:DECLARE
     (CL:TYPE CL:FIXNUM INDEX-000 LENGTH-000 INDEX-001 LENGTH-001 ITER-001
      VI))
    (CL:LOOP WHILE
     ...
     (CL:PROGN
      (CL:SETQ VARIABLE
       (CL:AREF (CL:THE CL:SIMPLE-VECTOR (%THE-ARRAY VECTOR-001)) INDEX-001))
      (CL:SETQ INDEX-001 (CL:1+ INDEX-001)))
     (CL:PROGN (CL:SETQ VI ITER-001) (CL:SETQ ITER-001 (CL:1+ ITER-001)))
...
(CL:DEFUN TRACE-SOLUTION (SELF SOLUTION SOLUTIONNUMBER)
  ...
  (CL:WHEN (TRACE-KEYWORD? KWD-QUERY-TRACE-SOLUTIONS)
   ...
   (PRINT-QUERY-ITERATOR-SOLUTION-ORNATELY *QUERYITERATOR* SOLUTION
    SOLUTIONNUMBER (%NATIVE-STREAM STANDARD-OUTPUT))
   (%%PRINT-STREAM (%NATIVE-STREAM STANDARD-OUTPUT) EOL)))
...
(CL:DEFUN PRINT-QUERY-ITERATOR-READABLY (SELF STREAM)
  (CL:LET*
   ...
   (%%PRINT-STREAM STREAM "(")
   (CL:LET* ((SOLUTION NULL) (ITER-000 (ALLOCATE-ITERATOR SOLUTIONS)))
    (CL:LOOP WHILE (NEXT? ITER-000) DO (CL:SETQ SOLUTION (%VALUE ITER-000))
     ...
     (CL:LET*
      ((VI NULL-INTEGER) (VALUE NULL) (VECTOR-000 (%BINDINGS SOLUTION))
       (INDEX-000 0) (LENGTH-000 (LENGTH VECTOR-000)) (ITER-001 0))
      (CL:DECLARE (CL:TYPE CL:FIXNUM INDEX-000 LENGTH-000 ITER-001 VI))
      (CL:LOOP WHILE (CL:< INDEX-000 LENGTH-000) DO
       (CL:PROGN
        (CL:SETQ VALUE
         (CL:AREF (CL:THE CL:SIMPLE-VECTOR (%THE-ARRAY VECTOR-000))
...
(CL:DEFUN ALLOCATE-COLLECTION-VARIABLES (FRAME DESCRIPTION)
  (CL:LET*
   ...
   (CL:DECLARE (CL:TYPE CL:FIXNUM VARIABLESCOUNT))
   (CL:LET*
    ((I NULL-INTEGER) (IOVAR NULL) (VECTOR-000 (%IO-VARIABLES DESCRIPTION))
    ...
    (CL:LOOP WHILE (CL:< INDEX-000 LENGTH-000) DO
     ...
     (CL:LET
      ((SELF (%THE-ARRAY EXTERNALVARIABLES))
       (VALUE
        (CREATE-VARIABLE (%SKOLEM-TYPE IOVAR) (%SKOLEM-NAME IOVAR) FALSE))
       (POSITION I))
      (CL:DECLARE (CL:TYPE CL:SIMPLE-VECTOR SELF)
       (CL:TYPE CL:FIXNUM POSITION))
      (CL:SETF (CL:AREF SELF POSITION) VALUE))
   ...
   (CL:LET*
    ...
    (CL:WHEN (TEST-QUERY-OPTION? QUERYITERATOR KWD-QUERY-DONT-OPTIMIZE?)
     (SET-DYNAMIC-SLOT-VALUE (%DYNAMIC-SLOTS DESCRIPTION)
      SYM-QUERY-LOGIC-DONT-OPTIMIZE? (CL:IF TRUE TRUE-WRAPPER FALSE-WRAPPER)
      FALSE-WRAPPER)
     ...
     (CL:WHEN (CL:NOT (CL:EQ OUTSIDEBINDINGS NULL))
      (CL:WHEN (CL:> (LENGTH OUTSIDEBINDINGS) (LENGTH EXTERNALVARIABLES))
       (CL:LET* ((STREAM-000 (NEW-OUTPUT-STRING-STREAM)))
        ...
        (CL:ERROR (NEW-FAIL-EXCEPTION (THE-STRING-READER STREAM-000)))))
      (CL:LET*
       ((VALUE NULL) (ARG NULL) (VECTOR-000 EXTERNALVARIABLES) (INDEX-000 0)
        (LENGTH-000 (LENGTH VECTOR-000)) (VECTOR-001 OUTSIDEBINDINGS)
        (INDEX-001 0) (LENGTH-001 (LENGTH VECTOR-001)))
       (CL:DECLARE
        (CL:TYPE CL:FIXNUM INDEX-000 LENGTH-000 INDEX-001 LENGTH-001))
       (CL:LOOP WHILE
    ...
    (CL:WHEN (NULL? (%MAXIMUM-DEPTH QUERYITERATOR))
...
(CL:DEFMETHOD QUERY-IS-TRUE-FALSE? ((SELF QUERY-ITERATOR))
  (CL:WHEN (CL:= (%ARRAY-SIZE (%EXTERNAL-VARIABLES SELF)) 0)
   (CL:RETURN-FROM QUERY-IS-TRUE-FALSE? TRUE))
  (CL:LET* ((PATTERNRECORD (%PATTERN-RECORD (%BASE-CONTROL-FRAME SELF))))
   (CL:LET* ((ALWAYS?-000 TRUE))
    (CL:LET*
     ((BOUND? NULL) (ARG NULL)
      (VECTOR-000 (%EXTERNAL-ARGUMENTS PATTERNRECORD)) (INDEX-000 0)
      (LENGTH-000 (LENGTH VECTOR-000))
...
(CL:DEFMETHOD QUERY-IS-PARTIAL? ((SELF QUERY-ITERATOR))
  (CL:WHEN (CL:NOT (CL:EQ (%PARTIAL-MATCH-STRATEGY SELF) NULL))
   (CL:RETURN-FROM QUERY-IS-PARTIAL? TRUE))
       ...
       (CL:LOOP
        (CL:TAGBODY (CLEAR (%BINDINGS SOLUTION))
         ...
         (CL:WHEN (CL:NOT (EXECUTE-BACKWARD-CHAINING-PROOF? SELF))
          (CL:RETURN))
         (CL:LET*
          ((I NULL-INTEGER) (EV NULL) (VECTOR-000 (%EXTERNAL-VARIABLES SELF))
           (INDEX-000 0) (LENGTH-000 (LENGTH VECTOR-000)) (ITER-000 0))
          (CL:DECLARE (CL:TYPE CL:FIXNUM INDEX-000 LENGTH-000 ITER-000 I))
          (CL:LOOP WHILE (CL:< INDEX-000 LENGTH-000) DO
           (CL:PROGN
         ...
         (CL:WHEN
          ...
          (CL:GO :CONTINUE))
         (CL:SETF (%TRUTH-VALUE BASEFRAME) (%TRUTH-VALUE SOLUTION))
...
(CL:DEFUN TRY-TO-DEFEAT-LAST-ANSWER? (SELF)
  (CL:LET*
   ...
   (CL:WHEN (NEXT? NEGATEDQUERY) (RESET NEGATEDQUERY)
    ...
    (CL:SETF (%REVERSE-POLARITY? (%BASE-CONTROL-FRAME NEGATEDQUERY)) FALSE)
    (RESET NEGATEDQUERY)
    (CL:LET* ((*DONTUSEDEFAULTKNOWLEDGE?* TRUE))
     (CL:DECLARE (CL:SPECIAL *DONTUSEDEFAULTKNOWLEDGE?*))
     (CL:WHEN
...
(CL:DEFMETHOD RESET ((SELF QUERY-ITERATOR))
  ...
  (CL:LET* ((INITIALFRAME (%BASE-CONTROL-FRAME SELF)))
   ...
   (CLEAR (%SOLUTIONS SELF)) (CL:SETF (%TRUTH-VALUE INITIALFRAME) NULL)
   (CL:SETF (%AUGMENTED-GOAL-CACHE? SELF) FALSE)
   (CL:SETF (%TRIGGERED-DEPTH-CUTOFF? SELF) FALSE)))
  ...
  (CL:LET*
   ...
   (CL:LET*
    ...
    (CL:LET* ((*MODULE* *MODULE*) (*CONTEXT* *MODULE*))
     ...
     (CL:SETQ DESCRIPTION (EVALUATE-DESCRIPTION-TERM PREFIXQUERYTREE FALSE))))
   (PROCESS-CHECK-TYPES-AGENDA)
...
(CL:DEFUN PROCESS-QUERY-OPTIONS (QUERY OPTIONS)
  (CL:LET* ((THEOPTIONS (VET-OPTIONS OPTIONS NULL)) (DEFERREDOPTIONS NULL))
   ...
   (CL:LET* ((VALUE NULL) (KEY NULL) (ITER-000 (%THE-PLIST THEOPTIONS)))
    (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-000 NIL)) DO
  ...
  (CL:LET*
   ...
   (CL:WHEN (CL:NOT (CL:EQ DEFERREDOPTIONS NULL))
    ...
    (CL:IF (CL:EQ VALUE NULL) (CL:SETQ VALUE (LOOKUP OPTIONS KEY))
     (CL:SETQ PROCESSEDDEFERREDOPTION? TRUE))
...
(CL:DEFUN RUN-YES-OR-NO-QUERY? (QUERY)
  (CL:LET* ((TRUTHVALUE (CALL-ASK QUERY)))
   (CL:COND
    ...
    ((CL:OR (CL:EQ TRUTHVALUE FALSE-TRUTH-VALUE)
      (CL:EQ TRUTHVALUE DEFAULT-FALSE-TRUTH-VALUE))
     (CL:IF FALSE TRUE-WRAPPER FALSE-WRAPPER))
    (CL:T NULL))))
...
(CL:DEFUN COERCE-TO-STRING (SELF)
  (CL:LET* ((TEST-VALUE-000 (SAFE-PRIMARY-TYPE SELF)))
   (CL:COND
    ...
    ((SUBTYPE-OF-SURROGATE? TEST-VALUE-000) (CL:PROGN (%SYMBOL-NAME SELF)))
    (CL:T
     (CL:LET* ((STREAM-000 (NEW-OUTPUT-STRING-STREAM)))
      (CL:LET* ((*PRINTREADABLY?* TRUE))
       (CL:DECLARE (CL:SPECIAL *PRINTREADABLY?*))
...
queries and logical expressions."
  (CL:LET*
   ((*QUERYITERATOR* (CREATE-ASK-QUERY QUERY)) (*REVERSEPOLARITY?* FALSE)
    (*INFERENCELEVEL* (CURRENT-INFERENCE-LEVEL))
    (*GENERATE-ALL-PROOFS?* FALSE))
   (CL:DECLARE
    (CL:SPECIAL *QUERYITERATOR* *REVERSEPOLARITY?* *INFERENCELEVEL*
     *GENERATE-ALL-PROOFS?*))
   (CL:LET* ((TRUTHVALUE NULL))
    (CL:WHEN (CL:EQ *MOST-RECENT-QUERY* NULL)
     (CL:SETQ *MOST-RECENT-QUERY* *QUERYITERATOR*))
    (NEXT? *QUERYITERATOR*)
    (CL:SETQ TRUTHVALUE (%TRUTH-VALUE (%BASE-CONTROL-FRAME *QUERYITERATOR*)))
    (CL:WHEN (CL:EQ TRUTHVALUE NULL) (CL:SETQ TRUTHVALUE UNKNOWN-TRUTH-VALUE))
    TRUTHVALUE)))
...
queries and logical expressions."
  (CL:LET*
   ...
   (CL:LET*
    ((*QUERYITERATOR* THEQUERY) (*REVERSEPOLARITY?* FALSE)
     (*INFERENCELEVEL* (CURRENT-INFERENCE-LEVEL))
     (*GENERATE-ALL-PROOFS?* FALSE))
    (CL:DECLARE
     (CL:SPECIAL *QUERYITERATOR* *REVERSEPOLARITY?* *INFERENCELEVEL*
    ...
    (CL:LET*
     ((SOLUTION NULL) (I NULL-INTEGER) (ITER-000 1)
      ...
      (UNBOUNDED?-000 (NULL? UPPER-BOUND-000)) (ITER-001 *QUERYITERATOR*))
     (CL:DECLARE (CL:TYPE CL:FIXNUM ITER-000 UPPER-BOUND-000 I))
     (CL:LOOP WHILE
...
list of lists for tuples of arity=1."
  (CL:WHEN (CL:EQ SELF NULL) (CL:RETURN-FROM CONSIFY-CURRENT-SOLUTIONS NIL))
  (CL:LET*
...
(CL:DEFUN MAKE-CACHED-QUERY (VARIABLES QUERYBODY INPUTBINDINGS OPTIONS CACHEID)
  (CL:LET* ((QUERYITERATOR (LOOKUP *QUERY-CACHE* CACHEID)) (BINDINGSCOUNT 0))
   ...
   (CL:WHEN (CL:NOT (CL:EQ QUERYITERATOR NULL))
    (CL:LET*
     ((NEWB NULL) (OLDB NULL)
      (VECTOR-000
       (%VARIABLE-BINDINGS (%CURRENT-PATTERN-RECORD QUERYITERATOR)))
      (INDEX-000 0) (LENGTH-000 (LENGTH VECTOR-000)) (ITER-000 INPUTBINDINGS))
     (CL:DECLARE (CL:TYPE CL:FIXNUM INDEX-000 LENGTH-000))
     (CL:LOOP WHILE
      (CL:AND (CL:< INDEX-000 LENGTH-000) (CL:NOT (CL:EQ ITER-000 NIL))) DO
      (CL:PROGN
   ...
   (CL:IF (CL:EQ QUERYITERATOR NULL)
    ...
    (CL:LET* ((*QUERYITERATOR* QUERYITERATOR) (*CONTEXT* (GET-QUERY-CONTEXT)))
     (CL:DECLARE (CL:SPECIAL *QUERYITERATOR* *CONTEXT*)) (RESET QUERYITERATOR)
     (UNBIND-VARIABLES-BEGINNING-AT (%CURRENT-PATTERN-RECORD QUERYITERATOR) 0)
     (CL:WHEN (CL:> BINDINGSCOUNT 0)
      (CL:LET* ((EXTERNALVARIABLES (%EXTERNAL-VARIABLES QUERYITERATOR)))
       (CL:LET*
        ((VALUE NULL) (ARG NULL) (VECTOR-001 EXTERNALVARIABLES) (INDEX-001 0)
         (LENGTH-001 (LENGTH VECTOR-001)) (ITER-001 INPUTBINDINGS))
        (CL:DECLARE (CL:TYPE CL:FIXNUM INDEX-001 LENGTH-001))
        (CL:LOOP WHILE
         (CL:AND (CL:< INDEX-001 LENGTH-001) (CL:NOT (CL:EQ ITER-001 NIL))) DO
         (CL:PROGN
...
(CL:DEFUN APPLY-CACHED-RETRIEVE (VARIABLES QUERYBODY INPUTBINDINGS OPTIONS CACHEID)
  (CL:LET*
   ((QUERYITERATOR NULL) (BINDINGSCOUNT 0) (OUTPUTBINDINGS NIL)
    (TRUTHVALUES NIL) (FORCESINGLETONS? FALSE))
   (CL:DECLARE (CL:TYPE CL:FIXNUM BINDINGSCOUNT))
   (CL:LET* ((IT (ALLOCATE-ITERATOR INPUTBINDINGS)))
    (CL:LOOP WHILE (NEXT? IT) DO
     (CL:WHEN (CL:NOT (CL:EQ (%VALUE IT) NULL))
    ...
    (CL:LET*
     ...
     (CL:LOOP WHILE (NEXT? ITER-000) DO (CL:SETQ S (%VALUE ITER-000))
      (CL:IF ATOMICSINGLETONS?
       (CL:LET*
        ((B NULL) (V NULL) (VECTOR-000 (%BINDINGS S)) (INDEX-000 0)
         (LENGTH-000 (LENGTH VECTOR-000)) (ITER-001 INPUTBINDINGS))
        (CL:DECLARE (CL:TYPE CL:FIXNUM INDEX-000 LENGTH-000))
        (CL:LOOP WHILE
         ...
         (CL:PROGN
          (CL:SETQ V
           (CL:AREF (CL:THE CL:SIMPLE-VECTOR (%THE-ARRAY VECTOR-000))
            INDEX-000))
          (CL:SETQ INDEX-000 (CL:1+ INDEX-000)))
         (CL:PROGN (CL:SETQ B (%%VALUE ITER-001))
          (CL:SETQ ITER-001 (%%REST ITER-001)))
         (CL:WHEN (CL:EQ B NULL) (CL:SETQ TUPLE V))))
       (CL:LET* ((VALUES NIL))
        (CL:LET*
         ((B NULL) (V NULL) (VECTOR-001 (%BINDINGS S)) (INDEX-001 0)
          (LENGTH-001 (LENGTH VECTOR-001)) (ITER-002 INPUTBINDINGS)
          (COLLECT-000 NULL))
         (CL:DECLARE (CL:TYPE CL:FIXNUM INDEX-001 LENGTH-001))
         (CL:LOOP WHILE
    ...
    (CL:SETQ PROTOTYPE
     (%%VALUE
      (APPLY-CACHED-RETRIEVE (LIST* SYM-QUERY-LOGIC-?C SYM-QUERY-LOGIC-?P NIL)
       ...
       (CONS-LIST DESCRIPTION NULL) (CONS-LIST) SYM-QUERY-LOGIC-QUERY-050))))
   (CL:LET*
  ...
  (CL:LET* ((RESULT UNKNOWN-TRUTH-VALUE))
   (CL:HANDLER-CASE
    (CL:LET* ((*CONTEXT* (GET-INFERENCE-CACHE *MODULE* KWD-QUERY-META)))
     ...
     (CL:SETQ RESULT
      (CALL-ASK (CREATE-QUERY-ITERATOR SUPER (VECTOR (GET-PROTOTYPE SUB))))))
    (LOGIC-EXCEPTION (E)
     (%%PRINT-STREAM (%NATIVE-STREAM STANDARD-ERROR) (EXCEPTION-MESSAGE E))))
   (CL:WHEN
    (CL:AND (CL:NOT (CL:EQ *TRACED-KEYWORDS* NULL))
    ...
    (CL:LOOP WHILE (CL:<= ITER-000 UPPER-BOUND-000) DO
     ...
     (CL:LET
      ((SELF (%THE-ARRAY SKOLEMSVECTOR))
       (VALUE (CREATE-HYPOTHESIZED-SKOLEM "ANONYMOUS")) (POSITION I))
      (CL:DECLARE (CL:TYPE CL:SIMPLE-VECTOR SELF)
       (CL:TYPE CL:FIXNUM POSITION))
      (CL:SETF (CL:AREF SELF POSITION) VALUE))))
   (CL:HANDLER-CASE
    (CL:PROGN (INHERIT-DESCRIPTION SKOLEMSVECTOR SUB FALSE)
        ...
        (CL:PROGN
         (CL:SETQ VALUE
          (CL:AREF (CL:THE CL:SIMPLE-VECTOR (%THE-ARRAY VECTOR-000))
           INDEX-000))
         (CL:SETQ INDEX-000 (CL:1+ INDEX-000)))
        (CL:WHEN (CL:EQ VALUE NULL) (CL:SETQ ALWAYS?-000 FALSE) (CL:RETURN))))
      (CL:SETQ TEST-VALUE-000 ALWAYS?-000)))
    (CL:WHEN TEST-VALUE-000
...
(CL:DEFUN UPDATE-PROPOSITIONS-FROM-QUERY (QUERY DESCRIPTION MODULE UPDATEMODE)
  ...
  (CL:LET*
   ((QUERYDESCRIPTION (QUERY-DESCRIPTION QUERY))
    ...
    (MAPPING (NEW-KEY-VALUE-LIST)) (DONTCHECKDUPLICATES? FALSE)
    (PROPOSITION NULL) (PROPOSITIONS NIL))
   (CL:COND
   ...
   (CL:LET* ((*MODULE* MODULE) (*CONTEXT* *MODULE*))
    ...
    (CL:LET* ((SOLUTION NULL) (ITER-000 (ALLOCATE-ITERATOR SOLUTIONS)))
     (CL:LOOP WHILE (NEXT? ITER-000) DO (CL:SETQ SOLUTION (%VALUE ITER-000))
      (CLEAR MAPPING)
      (CL:LET*
       ((BINDING NULL) (VAR NULL) (VECTOR-000 (%IO-VARIABLES DESCRIPTION))
        (INDEX-000 0) (LENGTH-000 (LENGTH VECTOR-000))
      ...
      (CL:LET*
       ((PROP NULL)
        (ITER-001 (INHERIT-AS-TOP-LEVEL-PROPOSITION PROPOSITION MAPPING)))
       (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-001 NIL)) DO
        (CL:PROGN (CL:SETQ PROP (%%VALUE ITER-001))
         (CL:SETQ ITER-001 (%%REST ITER-001)))
        (SET-DYNAMIC-SLOT-VALUE (%DYNAMIC-SLOTS PROP)
         SYM-QUERY-LOGIC-DESCRIPTIVE? (CL:IF FALSE TRUE-WRAPPER FALSE-WRAPPER)
         FALSE-WRAPPER)
        (CL:SETQ PROP
...
(CL:DEFUN GET-QUERY-ITERATOR-FROM-COMMAND (QUERY)
  (CL:LET* ((QUERYITERATOR (EVALUATE-LOGIC-COMMAND QUERY TRUE)))
   (CL:WHEN
    ...
    ((THEOPTIONS
      (PARSE-LOGIC-COMMAND-OPTIONS OPTIONS
       (LIST* KWD-QUERY-MODULE SGT-QUERY-STELLA-MODULE KWD-QUERY-RELATION
        SGT-QUERY-LOGIC-NAMED-DESCRIPTION KWD-QUERY-PATTERN
...
(CL:DEFUN HELP-STARTUP-QUERY1 ()
  (CL:PROGN
   ...
   (CL:SETQ SYM-QUERY-STELLA-BAD?
    (INTERN-RIGID-SYMBOL-WRT-MODULE "BAD?" (GET-STELLA-MODULE "/STELLA" TRUE)
     0))
   ...
   (CL:SETQ SYM-QUERY-STELLA-STATE
    (INTERN-RIGID-SYMBOL-WRT-MODULE "STATE" (GET-STELLA-MODULE "/STELLA" TRUE)
     0))
...
(CL:DEFUN HELP-STARTUP-QUERY3 ()
  (CL:PROGN
   ...
   (CL:SETQ SYM-QUERY-STELLA-NULL
    (INTERN-RIGID-SYMBOL-WRT-MODULE "NULL" (GET-STELLA-MODULE "/STELLA" TRUE)
     0))
   (CL:SETQ SGT-QUERY-STELLA-LIST
    (INTERN-RIGID-SYMBOL-WRT-MODULE "LIST" (GET-STELLA-MODULE "/STELLA" TRUE)
     1))
...
(CL:DEFUN HELP-STARTUP-QUERY4 ()
  (CL:PROGN
   ...
   (CL:SETQ SYM-QUERY-LOGIC-QUERY-047
    (INTERN-RIGID-SYMBOL-WRT-MODULE "QUERY-047" NULL 0))
   (CL:SETQ SYM-QUERY-STELLA-OR
    (INTERN-RIGID-SYMBOL-WRT-MODULE "OR" (GET-STELLA-MODULE "/STELLA" TRUE)
     0))
   (CL:SETQ SYM-QUERY-STELLA-AND
    (INTERN-RIGID-SYMBOL-WRT-MODULE "AND" (GET-STELLA-MODULE "/STELLA" TRUE)
     0))
   ...
   (CL:SETQ SYM-QUERY-LOGIC-QUERY-048
    (INTERN-RIGID-SYMBOL-WRT-MODULE "QUERY-048" NULL 0))
   ...
   (CL:SETQ SYM-QUERY-STELLA-FIRST
    (INTERN-RIGID-SYMBOL-WRT-MODULE "FIRST" (GET-STELLA-MODULE "/STELLA" TRUE)
     0))
   (CL:SETQ SYM-QUERY-STELLA-LAST
    (INTERN-RIGID-SYMBOL-WRT-MODULE "LAST" (GET-STELLA-MODULE "/STELLA" TRUE)
     0))
   ...
   (CL:SETQ SYM-QUERY-STELLA-NEXT
    (INTERN-RIGID-SYMBOL-WRT-MODULE "NEXT" (GET-STELLA-MODULE "/STELLA" TRUE)
     0))
   ...
   (CL:SETQ SYM-QUERY-STELLA-TRUE
    (INTERN-RIGID-SYMBOL-WRT-MODULE "TRUE" (GET-STELLA-MODULE "/STELLA" TRUE)
     0))
...
(CL:DEFUN HELP-STARTUP-QUERY5 ()
  (CL:PROGN
   ...
   (CL:SETQ SYM-QUERY-STELLA-ASK
    (INTERN-RIGID-SYMBOL-WRT-MODULE "ASK" (GET-STELLA-MODULE "/STELLA" TRUE)
     0))
   ...
   (CL:SETQ SYM-QUERY-PL-KERNEL-KB-CONCEPT-PROTOTYPE
    (INTERN-RIGID-SYMBOL-WRT-MODULE "CONCEPT-PROTOTYPE"
     (GET-STELLA-MODULE "/PL-KERNEL-KB" TRUE) 0))
   (CL:SETQ SYM-QUERY-LOGIC-QUERY-050
    (INTERN-RIGID-SYMBOL-WRT-MODULE "QUERY-050" NULL 0))
...
(CL:DEFUN HELP-STARTUP-QUERY6 ()
  (CL:PROGN
   (CL:LET* ((SELF-038 (NEW-NORMAL-INFERENCE-LEVEL)))
    (CL:SETF (%KEYWORD SELF-038) KWD-QUERY-NORMAL)
    (CL:SETQ NORMAL-INFERENCE SELF-038))
   (CL:LET* ((SELF-039 (NEW-BACKTRACKING-INFERENCE-LEVEL)))
    (CL:SETF (%KEYWORD SELF-039) KWD-QUERY-BACKTRACKING)
    (CL:SETQ BACKTRACKING-INFERENCE SELF-039))
   (CL:LET* ((SELF-040 (NEW-SUBSUMPTION-INFERENCE-LEVEL)))
    (CL:SETF (%KEYWORD SELF-040) KWD-QUERY-SUBSUMPTION)
    (CL:SETQ SUBSUMPTION-INFERENCE SELF-040))
   (CL:LET* ((SELF-041 (NEW-SHALLOW-INFERENCE-LEVEL)))
    (CL:SETF (%KEYWORD SELF-041) KWD-QUERY-SHALLOW)
    (CL:SETQ SHALLOW-INFERENCE SELF-041))
   (CL:LET* ((SELF-042 (NEW-ASSERTION-INFERENCE-LEVEL)))
    (CL:SETF (%KEYWORD SELF-042) KWD-QUERY-ASSERTION)
    (CL:SETQ ASSERTION-INFERENCE SELF-042))
   (CL:LET* ((SELF-043 (NEW-REFUTATION-INFERENCE-LEVEL)))
    (CL:SETF (%KEYWORD SELF-043) KWD-QUERY-REFUTATION)
    (CL:SETQ REFUTATION-INFERENCE SELF-043))
   (CL:SETQ *INFERENCELEVEL* NORMAL-INFERENCE)
   (CL:SETQ *DONTUSEDEFAULTKNOWLEDGE?* FALSE)
   ...
   (CL:SETQ *GLOBALLY-CLOSED-COLLECTIONS?* FALSE)
   (CL:SETQ *GENERATE-ALL-PROOFS?* FALSE)
   (CL:SETQ *ITERATIVE-DEEPENING-MODE?* FALSE)
   (CL:SETQ *EMIT-THINKING-DOTS?* TRUE)
   (CL:LET* ((SELF-044 (NEW-PROPERTY-LIST)))
    (CL:SETF (%THE-PLIST SELF-044)
    ...
    (CL:SETQ *THINKING-DOT-TABLE* SELF-044))
   (CL:LET* ((SELF-045 (NEW-BOOLEAN-VECTOR-INDEX-NODE)))
    (CL:SETF (%THE-VECTOR SELF-045) (NEW-BOOLEAN-VECTOR 0))
    (CL:SETQ *BOOLEAN-VECTOR-INDEX* SELF-045))
   (CL:SETQ *REVERSEPOLARITY?* FALSE) (CL:SETQ *QUERY-CACHE* (NEW-HASH-TABLE))))
...
The argument to `:DONT-OPTIMIZE?' is the constant TRUE, which tells
PowerLoom not to optimize the query before evaluating it.\")"
    (CL:FUNCTION %ASK) (CL:FUNCTION ASK-EVALUATOR-WRAPPER))
...
available command options.\" :PUBLIC? TRUE :COMMAND? TRUE :EVALUATE-ARGUMENTS? FALSE)"
    ...
    (CL:LET* ((FUNCTION (LOOKUP-FUNCTION SYM-QUERY-LOGIC-STARTUP-QUERY)))
     (SET-DYNAMIC-SLOT-VALUE (%DYNAMIC-SLOTS FUNCTION)
      SYM-QUERY-STELLA-METHOD-STARTUP-CLASSNAME (WRAP-STRING "_Startup-Query")
      NULL-STRING-WRAPPER)))
