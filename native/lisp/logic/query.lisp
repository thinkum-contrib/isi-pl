...
(CL:DECLAIM
  ...
  *MOST-RECENT-QUERY* *PRINTLENGTH* *PRINTREADABLY?*
  *CYC-KLUDGES-ENABLED?* ZERO-WRAPPER *RECORD-JUSTIFICATIONS?*
  ...
  *CURRENT-POWERLOOM-FEATURES* NULL-INTEGER FALSE TRUE EOL
  *QUERYITERATOR* *MODULE*))
     ...
     (CL:IF BOUND?
      (CL:PROGN (CL:SETQ NEXTNODE (%TRUE-LINK NODE))
       (CL:WHEN (CL:EQ NEXTNODE NULL)
        (CL:SETQ NEXTNODE
         (CREATE-BOOLEAN-VECTOR-INDEX-NODE NODE TRUE))))
...
(CL:DEFUN FAILS-UNIFICATION-TYPE-CHECK? (V1 I2)
  (CL:COND ((CL:EQ *TYPE-CHECK-STRATEGY* KWD-QUERY-NONE) FALSE)
   ((CL:EQ *TYPE-CHECK-STRATEGY* KWD-QUERY-LOOKUP)
    (CL:LET*
     ((TYPE (%SKOLEM-TYPE V1)) (TYPEISOK? (CHECK-TYPE? I2 TYPE TRUE)))
     (CL:IF
        ...
        (CL:LET* ((TEST-VALUE-000 FALSE))
         ...
         (CL:WHEN TEST-VALUE-000
          (CL:LET* ((ALWAYS?-000 TRUE))
           (CL:LET*
            ((VAL NULL) (VAR NULL) (ITER-000 (%THE-KV-LIST MAPPING)))
     ...
     (CL:COND
      ...
      ((CL:EQ RESULTOFNEXTMOVE KWD-QUERY-FINAL-SUCCESS)
       (CL:LET* ((PARENT (%UP FRAME)))
        ...
        (CL:WHEN (CL:EQ FRAME NULL) (CL:SETQ SUCCESS? TRUE)
         (CL:RETURN))
         ...
         (CL:WHEN (CL:NOT (CL:EQ PARENT NULL))
          (CL:SETF (%ALLOTTED-CLOCK-TICKS PARENT)
           (CL:- (%ALLOTTED-CLOCK-TICKS PARENT)
            (CL:- CLOCKTICKS (%STARTING-CLOCK-TICKS FRAME)) 1))))
        (CL:SETQ FRAME PARENT)
        (CL:WHEN (CL:EQ FRAME NULL) (CL:SETQ SUCCESS? FALSE)
         (CL:RETURN))
  ...
  (CL:LET* ((PROPOSITION (%PROPOSITION FRAME)) (CONJUNCTS NULL))
   (CL:COND
    ...
    ((CL:EQ LASTMOVE KWD-QUERY-UP-TRUE)
     ...
     (CL:COND
      ((CL:= (%ARGUMENT-CURSOR FRAME) (CL:1- (LENGTH CONJUNCTS)))
       (CL:SETF (%DOWN FRAME) NULL)
       (CL:LET*
        ((I NULL-INTEGER) (CONJUNCT NULL) (VECTOR-000 CONJUNCTS)
    ...
    ((CL:EQ LASTMOVE KWD-QUERY-UP-FAIL)
     ...
     (CL:SETF (%DOWN FRAME) NULL)
     (CL:LET*
      ((I NULL-INTEGER) (CONJUNCT NULL) (VECTOR-001 CONJUNCTS)
     ...
     (CL:COND ((CL:NOT (CL:EQ (%DOWN FRAME) NULL)) KWD-QUERY-MOVE-DOWN)
      (CL:T (CL:SETF (%TRUTH-VALUE FRAME) UNKNOWN-TRUTH-VALUE)
       (CL:LET
        ...
        (CL:SETF (CL:AREF SELF POSITION) VALUE))
       (CL:LET*
        ((I NULL-INTEGER) (CONJUNCT NULL) (VECTOR-002 CONJUNCTS)
         (INDEX-002 0) (LENGTH-002 (LENGTH VECTOR-002)) (ITER-002 0)
         (UPPER-BOUND-000 (%ARGUMENT-CURSOR FRAME))
         (UNBOUNDED?-000 (NULL? UPPER-BOUND-000)))
        (CL:DECLARE
         (CL:TYPE CL:FIXNUM INDEX-002 LENGTH-002 ITER-002
          UPPER-BOUND-000 I))
        (CL:LOOP WHILE
    ...
    (CL:LET*
     ...
     (CL:LOOP WHILE
      ...
      (CL:WHEN
       ...
       (CL:WHEN
        (CL:NOT (BIND-ARGUMENT-TO-VALUE? EXTERNALARG VALUE FALSE))
        (CL:WHEN
         (CL:AND (CL:NOT (CL:EQ *TRACED-KEYWORDS* NULL))
          (MEMB? *TRACED-KEYWORDS* KWD-QUERY-QUERY-STACKS))
         (%%PRINT-STREAM (%NATIVE-STREAM STANDARD-OUTPUT)
         ...
         (CL:LET* ((COL NULL) (ITER-001 ENUMERATEDCOLLECTIONS))
          (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-001 NIL)) DO
           ...
           (CL:LET*
            ...
            (CL:DECLARE
             (CL:TYPE CL:FIXNUM INDEX-000 LENGTH-000 ITER-002
              UPPER-BOUND-000 I))
            (CL:LOOP WHILE
             (CL:AND (CL:< INDEX-000 LENGTH-000)
         ...
         (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-002 NIL)) DO
          ...
          (CL:LET*
           ((I NULL-INTEGER) (ARG NULL) (VECTOR-000 (%ARGUMENTS COL))
            ...
            (COLLECT-002 NULL))
           (CL:DECLARE
            (CL:TYPE CL:FIXNUM INDEX-000 LENGTH-000 ITER-003
             UPPER-BOUND-000 I))
           (CL:LOOP WHILE
            (CL:AND (CL:< INDEX-000 LENGTH-000)
   ...
   (CL:LOOP
    ...
    (CL:LET*
     ...
     (CL:LOOP WHILE (CL:NOT (CL:EQ SUBCOLLECTIONS NIL)) DO
      ...
      (CL:IF
       (CL:NOT (EMPTY? (GET-DESCRIPTION-EXTENSION SUBCOLLECTION TRUE)))
...
(CL:DEFUN NEW-QUERY-SOLUTION-TABLE ()
  (CL:LET* ((SELF NULL))
   ...
   (CL:LET* ((SELF-000 (NEW-KEY-VALUE-MAP)))
    (CL:SETF (%EQUAL-TEST? SELF-000) TRUE)
  ...
  (CL:LET*
   ...
   (CL:COND
    ((CL:NOT (CL:EQ CURSOR NULL))
     ...
     (CL:SETF (%VALUE SELF) CURSOR) (CL:RETURN-FROM NEXT? TRUE))
  ...
  (CL:LET* ((*PRINTINFRAME* SELF))
   ...
   (CL:LET* ((PRINTTIMES? (DEFINED? (%ALLOTTED-CLOCK-TICKS SELF))))
    (%%PRINT-STREAM STREAM " " (%STATE SELF) " "
     (%CURRENT-STRATEGY SELF) "  UP: "
     (CL:IF (CL:NOT (CL:EQ (%UP SELF) NULL))
      (DEBUG-FRAME-ID (%UP SELF)) NULL-INTEGER)
     "  DOWN: "
   ...
   (CL:LET* ((*PRINTREADABLY?* TRUE))
    ...
    (CL:LET*
     ...
     (CL:LOOP WHILE
      ...
      DO (CL:SETQ SOLUTION (%VALUE ITER-000))
      (CL:PROGN (CL:SETQ I ITER-001)
       (CL:SETQ ITER-001 (CL:1+ ITER-001)))
    ...
    (CL:LOOP WHILE
     ...
     (CL:LET*
      ((VI NULL-INTEGER) (VALUE NULL) (VECTOR-000 (%BINDINGS SOLUTION))
       (INDEX-000 0) (LENGTH-000 (LENGTH VECTOR-000)) (ITER-002 0))
...
(CL:DEFUN PROCESS-QUERY-OPTIONS (QUERY OPTIONS)
  (CL:LET*
   ...
   (CL:LET*
    ((VALUE NULL) (KEY NULL) (ITER-000 (%THE-PLIST THEOPTIONS)))
    (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-000 NIL)) DO
...
(CL:DEFUN LOOKUP-DEFERRED-QUERY-OPTION (QUERYOROPTIONS KEY COERCETOTYPE)
  (CL:LET*
   ((OPTIONS NULL) (DEFERREDOPTIONS NULL) (VALUE NULL)
    (COERCEDVALUE NULL) (PROCESSEDDEFERREDOPTION? FALSE))
   (CL:LET* ((TEST-VALUE-000 (SAFE-PRIMARY-TYPE QUERYOROPTIONS)))
    (CL:COND
     ((SUBTYPE-OF? TEST-VALUE-000 SGT-QUERY-STELLA-PROPERTY-LIST)
      (CL:PROGN (CL:SETQ OPTIONS QUERYOROPTIONS)))
...
queries and logical expressions."
  (CL:LET*
   ...
   (CL:LET* ((TRUTHVALUE NULL))
    ...
    (NEXT? *QUERYITERATOR*)
    (CL:SETQ TRUTHVALUE
     (%TRUTH-VALUE (%BASE-CONTROL-FRAME *QUERYITERATOR*)))
    (CL:WHEN (CL:EQ TRUTHVALUE NULL)
     (CL:SETQ TRUTHVALUE UNKNOWN-TRUTH-VALUE))
    TRUTHVALUE)))
...
(CL:DEFUN MAKE-CACHED-QUERY (VARIABLES QUERYBODY INPUTBINDINGS OPTIONS CACHEID)
  (CL:LET*
   ...
   (CL:WHEN (CL:NOT (CL:= (LENGTH VARIABLES) (LENGTH INPUTBINDINGS)))
    (%%PRINT-STREAM (%NATIVE-STREAM STANDARD-OUTPUT)
     "Number of variables does not equal number of input bindings."
     EOL)
   ...
   (CL:IF (CL:EQ QUERYITERATOR NULL)
    ...
    (CL:LET*
     ...
     (CL:WHEN (CL:> BINDINGSCOUNT 0)
      (CL:LET*
       ((EXTERNALVARIABLES (%EXTERNAL-VARIABLES QUERYITERATOR)))
       (CL:LET*
        ...
        (CL:LOOP WHILE
         ...
         (CL:WHEN (CL:NOT (CL:EQ VALUE NULL))
          (CL:WHEN (CL:NOT (BIND-ARGUMENT-TO-VALUE? ARG VALUE FALSE))
           (%%PRINT-STREAM (%NATIVE-STREAM STANDARD-OUTPUT)
            "Query failure: Can't bind `" VALUE "' to `" ARG "'." EOL
            EOL)
           (CL:RETURN-FROM MAKE-CACHED-QUERY NULL)))))))))
   (CL:WHEN (CL:NOT (CL:EQ OPTIONS NULL))
...
(CL:DEFUN APPLY-CACHED-RETRIEVE (VARIABLES QUERYBODY INPUTBINDINGS OPTIONS CACHEID)
  (CL:LET*
   ...
   (CL:LET*
    ((*QUERYITERATOR* QUERYITERATOR) (*REVERSEPOLARITY?* FALSE))
    (CL:DECLARE (CL:SPECIAL *QUERYITERATOR* *REVERSEPOLARITY?*))
   ...
   (CL:LET* ((TEST-VALUE-000 (SAFE-PRIMARY-TYPE SELF)))
    (CL:COND
     ...
     ((CL:EQ TEST-VALUE-000 SGT-QUERY-STELLA-CONS)
      (CL:PROGN (CL:SETQ VECTOR (NEW-VECTOR (LENGTH SELF)))
       (CL:LET*
        ((I NULL-INTEGER) (M NULL) (ITER-003 SELF) (ITER-004 0))
...
(CL:DEFUN UPDATE-PROPOSITIONS-FROM-QUERY (QUERY DESCRIPTION MODULE UPDATEMODE)
  ...
  (CL:LET*
   ...
   (CL:LET* ((*MODULE* MODULE) (*CONTEXT* *MODULE*))
    ...
    (CL:LET*
     ((I NULL-INTEGER) (SOLUTION NULL)
      (ITER-000 (ALLOCATE-ITERATOR SOLUTIONS)) (ITER-001 0))
       ...
       ((CL:= (MOD I 1000) 999)
        (CL:WHEN
         (CL:AND (CL:NOT (CL:EQ *TRACED-KEYWORDS* NULL))
          (MEMB? *TRACED-KEYWORDS* KWD-QUERY-UPDATE-FROM-QUERY))
         (%%PRINT-STREAM (%NATIVE-STREAM STANDARD-OUTPUT) "."))
        (FLUSH-OUTPUT STANDARD-OUTPUT) (CL:SETQ TERMINATELINE? TRUE)))
      (CL:LET*
       ((BINDING NULL) (VAR NULL)
        (VECTOR-000 (%IO-VARIABLES DESCRIPTION)) (INDEX-000 0)
        (LENGTH-000 (LENGTH VECTOR-000))
...
available command options.\" :PUBLIC? TRUE :COMMAND? TRUE :EVALUATE-ARGUMENTS? FALSE)"
    ...
    (CL:LET*
     ...
     (SET-DYNAMIC-SLOT-VALUE (%DYNAMIC-SLOTS FUNCTION)
      ...
      (WRAP-STRING "_Startup-Query") NULL-STRING-WRAPPER)))
