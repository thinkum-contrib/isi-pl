...
(CL:DECLAIM
 (CL:SPECIAL *STARTUP-TIME-PHASE* *LAZY-SATELLITE-RULES?* *CACHE-GOAL-QUANTUM*
  *CACHE-INFERABLE-SUBCOLLECTIONS?*
  *CLASSIFY-FROM-NON-INFERABLE-PARENTS-ONLY?* *QUERY-OPTIMIZATION-STRATEGY*
  STANDARD-ERROR *MOST-RECENT-QUERY* FALSE-TRUTH-VALUE
  INCONSISTENT-TRUTH-VALUE *PRINTLENGTH* *DEBUG-MODE?* *PRINTREADABLY?*
  *CYC-KLUDGES-ENABLED?* *MEMOIZATION-ENABLED?* MEMOIZED-NULL-VALUE
  TRUE-TRUTH-VALUE ZERO-WRAPPER *RECORD-JUSTIFICATIONS?* UNKNOWN-TRUTH-VALUE
  *CACHE-SUCCEEDED-GOALS?* *CACHE-FAILED-GOALS?* *CONTEXT*
  NULL-INTEGER-WRAPPER *PARTIAL-SUPPORT-COUNTER* NULL-FLOAT-WRAPPER
  *FAIL-UNBOUND-CLAUSES?* STANDARD-WARNING ONE-WRAPPER STANDARD-OUTPUT
  DEFAULT-TRUE-TRUTH-VALUE DEFAULT-FALSE-TRUTH-VALUE NIL TRUE-WRAPPER
  FALSE-WRAPPER NIL-LIST NULL-FLOAT *TRACED-KEYWORDS*
...
(CL:DEFUN NEW-BACKTRACKING-INFERENCE-LEVEL ()
  (CL:LET* ((SELF NULL))
   (CL:SETQ SELF (CL:MAKE-INSTANCE (CL:QUOTE BACKTRACKING-INFERENCE-LEVEL)))
   (CL:SETF (%KEYWORD SELF) NULL) SELF))
...
(CL:DEFUN NEW-SUBSUMPTION-INFERENCE-LEVEL ()
  (CL:LET* ((SELF NULL))
   (CL:SETQ SELF (CL:MAKE-INSTANCE (CL:QUOTE SUBSUMPTION-INFERENCE-LEVEL)))
   (CL:SETF (%KEYWORD SELF) NULL) SELF))
  ...
  (CL:LET* ((LEVEL (GET-INFERENCE-LEVEL LEVELKEYWORD)))
   (CL:COND
    ...
    ((CL:NOT (CL:EQ *QUERYITERATOR* NULL))
     (CL:SETF (%INFERENCE-LEVEL *QUERYITERATOR*) LEVEL))
...
(CL:DEFUN TOGGLE-TRACE-SUBGOALS ()
  (CL:IF (MEMBER? *CURRENT-POWERLOOM-FEATURES* KWD-QUERY-TRACE-SUBGOALS)
   ...
   (CL:PROGN (%SET-FEATURE (CONS-LIST KWD-QUERY-TRACE-SUBGOALS))
    (%ADD-TRACE (CONS-LIST KWD-QUERY-STRATEGIES)) "Subgoal tracing enabled.")))
...
the appropriate truth-value and justification support." :ALLOCATION :INSTANCE
    :ACCESSOR %SOLUTIONS)
   (DEBUG-ID :TYPE CL:SIMPLE-STRING :INITFORM STELLA::NULL-STRING :ALLOCATION
    :INSTANCE :ACCESSOR %DEBUG-ID)
   ...
   (TIMESTAMP :TYPE CL:FIXNUM :INITFORM NULL-INTEGER :ALLOCATION :INSTANCE
    :ACCESSOR %TIMESTAMP)
   ...
   (CURRENT-DEPTH-CUTOFF :TYPE CL:FIXNUM :INITFORM NULL-INTEGER :ALLOCATION
    :INSTANCE :ACCESSOR %CURRENT-DEPTH-CUTOFF)
   (MAXIMUM-DEPTH :TYPE CL:FIXNUM :INITFORM NULL-INTEGER :ALLOCATION :INSTANCE
    :ACCESSOR %MAXIMUM-DEPTH)
   (ALLOTTED-TIME :TYPE CL:DOUBLE-FLOAT :INITFORM NULL-FLOAT :DOCUMENTATION
    "If defined, timeout after that many seconds." :ALLOCATION :INSTANCE
    :ACCESSOR %ALLOTTED-TIME)
   (ALLOTTED-CLOCK-TICKS :TYPE CL:FIXNUM :INITFORM NULL-INTEGER :DOCUMENTATION
    "If defined, timeout after that many :DOWN moves." :ALLOCATION :INSTANCE
    :ACCESSOR %ALLOTTED-CLOCK-TICKS)
   (CURRENT-CLOCK-TICKS :TYPE CL:FIXNUM :INITFORM NULL-INTEGER :ALLOCATION
    :INSTANCE :ACCESSOR %CURRENT-CLOCK-TICKS)
   (TIMEOUT? :DOCUMENTATION "Set to TRUE if query times out." :ALLOCATION
    :INSTANCE :ACCESSOR %TIMEOUT?)
   (DEPTH-CUTOFFS? :DOCUMENTATION
    "Set to TRUE if one or more depth cutoffs occurred." :ALLOCATION :INSTANCE
    :ACCESSOR %DEPTH-CUTOFFS?)
...
(CL:DEFUN NEW-QUERY-ITERATOR ()
  (CL:LET* ((SELF NULL))
   ...
   (CL:SETF (%DEPTH-CUTOFFS? SELF) CL:NIL) (CL:SETF (%TIMEOUT? SELF) CL:NIL)
   (CL:SETF (%CURRENT-CLOCK-TICKS SELF) 0)
   (CL:SETF (%ALLOTTED-CLOCK-TICKS SELF) NULL-INTEGER)
   ...
   (CL:SETF (%INFERENCE-LEVEL SELF) NULL)
   (CL:SETF (%PARTIAL-MATCH-STRATEGY SELF) NULL)
   (CL:SETF (%TIMESTAMP SELF) NULL-INTEGER)
   (CL:SETF (%FOUND-AT-LEAST-ONE-SOLUTION? SELF) CL:NIL)
   (CL:SETF (%FAILED-TO-FIND-DUPLICATE-SUBGOAL? SELF) CL:NIL)
   (CL:SETF (%TRIGGERED-DEPTH-CUTOFF? SELF) CL:NIL)
   (CL:SETF (%ACTIVE-GOAL-CACHES SELF) (NEW-LIST))
   (CL:SETF (%AUGMENTED-GOAL-CACHE? SELF) CL:NIL)
   ...
   (CL:SETF (%QUERY-CONTEXT SELF) NULL) (CL:SETF (%DEBUG-ID SELF) "Top")
   (CL:SETF (%SOLUTIONS SELF) (NEW-QUERY-SOLUTION-TABLE))
   (CL:SETF (%OPTIONS SELF) (NEW-PROPERTY-LIST))
   (CL:SETF (%EXHAUSTED? SELF) CL:NIL)
...
(CL:DEFMETHOD RESIDUE-GOALS ((SELF QUERY-ITERATOR))
  (CL:LET*
   ((ANSWER
     (DYNAMIC-SLOT-VALUE (%DYNAMIC-SLOTS SELF) SYM-QUERY-LOGIC-RESIDUE-GOALS
      NULL)))
...
(CL:DEFMETHOD BAD? ((SELF QUERY-ITERATOR))
  (CL:LET*
   ((ANSWER
     (DYNAMIC-SLOT-VALUE (%DYNAMIC-SLOTS SELF) SYM-QUERY-STELLA-BAD? NULL)))
...
(CL:DEFUN ACCESS-QUERY-ITERATOR-SLOT-VALUE (SELF SLOTNAME VALUE SETVALUE?)
  (CL:COND
   ...
   ((CL:EQ SLOTNAME SYM-QUERY-LOGIC-EXHAUSTED?)
    (CL:IF SETVALUE?
     (CL:SETF (%EXHAUSTED? SELF) (COERCE-WRAPPED-BOOLEAN-TO-BOOLEAN VALUE))
     (CL:SETQ VALUE (CL:IF (%EXHAUSTED? SELF) TRUE-WRAPPER FALSE-WRAPPER))))
   ((CL:EQ SLOTNAME SYM-QUERY-STELLA-OPTIONS)
    (CL:IF SETVALUE? (CL:SETF (%OPTIONS SELF) VALUE)
     (CL:SETQ VALUE (%OPTIONS SELF))))
   ((CL:EQ SLOTNAME SYM-QUERY-LOGIC-SOLUTIONS)
    (CL:IF SETVALUE? (CL:SETF (%SOLUTIONS SELF) VALUE)
     (CL:SETQ VALUE (%SOLUTIONS SELF))))
   ((CL:EQ SLOTNAME SYM-QUERY-LOGIC-DEBUG-ID)
    (CL:IF SETVALUE? (CL:SETF (%DEBUG-ID SELF) (%WRAPPER-VALUE VALUE))
     (CL:SETQ VALUE (WRAP-STRING (%DEBUG-ID SELF)))))
   ...
   ((CL:EQ SLOTNAME SYM-QUERY-LOGIC-TRIGGERED-DEPTH-CUTOFF?)
    (CL:IF SETVALUE?
     (CL:SETF (%TRIGGERED-DEPTH-CUTOFF? SELF)
      (COERCE-WRAPPED-BOOLEAN-TO-BOOLEAN VALUE))
     (CL:SETQ VALUE
      (CL:IF (%TRIGGERED-DEPTH-CUTOFF? SELF) TRUE-WRAPPER FALSE-WRAPPER))))
   ...
   ((CL:EQ SLOTNAME SYM-QUERY-LOGIC-ALLOTTED-CLOCK-TICKS)
    (CL:IF SETVALUE?
     (CL:SETF (%ALLOTTED-CLOCK-TICKS SELF) (%WRAPPER-VALUE VALUE))
     (CL:SETQ VALUE (WRAP-INTEGER (%ALLOTTED-CLOCK-TICKS SELF)))))
   ((CL:EQ SLOTNAME SYM-QUERY-LOGIC-CURRENT-CLOCK-TICKS)
    (CL:IF SETVALUE?
     (CL:SETF (%CURRENT-CLOCK-TICKS SELF) (%WRAPPER-VALUE VALUE))
   ...
   ((CL:EQ SLOTNAME SYM-QUERY-LOGIC-DEPTH-CUTOFFS?)
    (CL:IF SETVALUE?
     (CL:SETF (%DEPTH-CUTOFFS? SELF)
      (COERCE-WRAPPED-BOOLEAN-TO-BOOLEAN VALUE))
     (CL:SETQ VALUE
      (CL:IF (%DEPTH-CUTOFFS? SELF) TRUE-WRAPPER FALSE-WRAPPER))))
   (CL:T
    (CL:COND
...
(CL:DEFMETHOD DELETED?-SETTER ((SELF QUERY-ITERATOR) VALUE)
  (SET-DYNAMIC-SLOT-VALUE (%DYNAMIC-SLOTS SELF)
   SYM-QUERY-STELLA-DELETED-OBJECT? (CL:IF VALUE TRUE-WRAPPER FALSE-WRAPPER)
   NULL)
  VALUE)
...
(CL:DEFCLASS CONTROL-FRAME (STANDARD-OBJECT)
  ((STATE :ALLOCATION :INSTANCE :ACCESSOR %STATE)
   ...
   (STARTING-CLOCK-TICKS :TYPE CL:FIXNUM :INITFORM NULL-INTEGER :DOCUMENTATION
    "Clock ticks at last :DOWN move." :ALLOCATION :INSTANCE :ACCESSOR
    %STARTING-CLOCK-TICKS)
   (ALLOTTED-CLOCK-TICKS :TYPE CL:FIXNUM :INITFORM NULL-INTEGER :DOCUMENTATION
    "Total clock ticks allotted to prove this goal." :ALLOCATION :INSTANCE
    :ACCESSOR %ALLOTTED-CLOCK-TICKS)
   (UP :ALLOCATION :INSTANCE :ACCESSOR %UP)
   (DOWN :ALLOCATION :INSTANCE :ACCESSOR %DOWN)
   (RESULT :ALLOCATION :INSTANCE :ACCESSOR %RESULT)
   (ARGUMENT-CURSOR :TYPE CL:FIXNUM :INITFORM NULL-INTEGER :ALLOCATION
    :INSTANCE :ACCESSOR %ARGUMENT-CURSOR)
   ...
   (CHOICE-POINT-UNBINDING-OFFSET :TYPE CL:FIXNUM :INITFORM NULL-INTEGER
    :ALLOCATION :INSTANCE :ACCESSOR %CHOICE-POINT-UNBINDING-OFFSET)
...
(CL:DEFUN NEW-CONTROL-FRAME ()
  (CL:LET* ((SELF NULL))
   ...
   (CL:SETF (%DYNAMIC-SLOTS SELF) (NEW-KEY-VALUE-LIST))
   (CL:SETF (%DONT-CACHE-GOAL-FAILURE? SELF) CL:NIL)
   (CL:SETF (%CACHED-GOAL-RESULT? SELF) CL:NIL)
   (CL:SETF (%GOAL-BINDINGS SELF) NULL)
   ...
   (CL:SETF (%PATTERN-RECORD SELF) NULL) (CL:SETF (%ARGUMENT-CURSOR SELF) 0)
   (CL:SETF (%RESULT SELF) NULL) (CL:SETF (%DOWN SELF) NULL)
   (CL:SETF (%UP SELF) NULL)
   (CL:SETF (%ALLOTTED-CLOCK-TICKS SELF) NULL-INTEGER)
   (CL:SETF (%STARTING-CLOCK-TICKS SELF) NULL-INTEGER)
   (CL:SETF (%REVERSE-POLARITY? SELF) CL:NIL)
   (CL:SETF (%TRUTH-VALUE SELF) NULL) (CL:SETF (%PROPOSITION SELF) NULL)
   (CL:SETF (%STATE SELF) NULL) SELF))
...
(CL:DEFMETHOD HOLDS-BY-DEFAULT? ((SELF CONTROL-FRAME))
  (CL:OR (CL:EQ (%TRUTH-VALUE SELF) DEFAULT-TRUE-TRUTH-VALUE)
   (CL:EQ (%TRUTH-VALUE SELF) DEFAULT-FALSE-TRUTH-VALUE)))
...
(CL:DEFUN ACCESS-CONTROL-FRAME-SLOT-VALUE (SELF SLOTNAME VALUE SETVALUE?)
  (CL:COND
   ...
   ((CL:EQ SLOTNAME SYM-QUERY-LOGIC-UP)
    (CL:IF SETVALUE? (CL:SETF (%UP SELF) VALUE) (CL:SETQ VALUE (%UP SELF))))
   ...
   ((CL:EQ SLOTNAME SYM-QUERY-STELLA-RESULT)
    (CL:IF SETVALUE? (CL:SETF (%RESULT SELF) VALUE)
     (CL:SETQ VALUE (%RESULT SELF))))
   ...
   ((CL:EQ SLOTNAME SYM-QUERY-LOGIC-CHOICE-POINT-UNBINDING-OFFSET)
    (CL:IF SETVALUE?
     (CL:SETF (%CHOICE-POINT-UNBINDING-OFFSET SELF) (%WRAPPER-VALUE VALUE))
   ...
   ((CL:EQ SLOTNAME SYM-QUERY-LOGIC-CACHED-GOAL-RESULT?)
    (CL:IF SETVALUE?
     (CL:SETF (%CACHED-GOAL-RESULT? SELF)
      (COERCE-WRAPPED-BOOLEAN-TO-BOOLEAN VALUE))
     (CL:SETQ VALUE
      (CL:IF (%CACHED-GOAL-RESULT? SELF) TRUE-WRAPPER FALSE-WRAPPER))))
   ((CL:EQ SLOTNAME SYM-QUERY-LOGIC-DONT-CACHE-GOAL-FAILURE?)
    (CL:IF SETVALUE?
     (CL:SETF (%DONT-CACHE-GOAL-FAILURE? SELF)
      (COERCE-WRAPPED-BOOLEAN-TO-BOOLEAN VALUE))
     (CL:SETQ VALUE
      (CL:IF (%DONT-CACHE-GOAL-FAILURE? SELF) TRUE-WRAPPER FALSE-WRAPPER))))
   (CL:T
    (CL:IF SETVALUE?
     (SET-DYNAMIC-SLOT-VALUE (%DYNAMIC-SLOTS SELF) SLOTNAME VALUE NULL)
     (CL:SETQ VALUE (LOOKUP (%DYNAMIC-SLOTS SELF) SLOTNAME)))))
...
(CL:DEFCLASS PARALLEL-THREAD (STANDARD-OBJECT)
  ((TOP-CONTROL-FRAME :ALLOCATION :INSTANCE :ACCESSOR %TOP-CONTROL-FRAME)
   ...
   (TOP-UNBINDING-STACK-OFFSET :TYPE CL:FIXNUM :INITFORM NULL-INTEGER
    :ALLOCATION :INSTANCE :ACCESSOR %TOP-UNBINDING-STACK-OFFSET)
   (PRIORITY :TYPE CL:FIXNUM :INITFORM NULL-INTEGER :ALLOCATION :INSTANCE
    :ACCESSOR %PRIORITY)
...
(CL:DEFUN NEW-PARALLEL-CONTROL-FRAME ()
  (CL:LET* ((SELF NULL))
   ...
   (CL:SETF (%UNBOUND-VARIABLES? SELF) CL:NIL)
...
(CL:DEFUN NEW-CONTROL-FRAME-PRIORITY-QUEUE ()
  (CL:LET* ((SELF NULL))
   (CL:SETQ SELF (CL:MAKE-INSTANCE (CL:QUOTE CONTROL-FRAME-PRIORITY-QUEUE)))
...
(CL:DEFUN NEW-PATTERN-RECORD ()
  (CL:LET* ((SELF NULL))
   (CL:SETQ SELF (CL:MAKE-INSTANCE (CL:QUOTE PATTERN-RECORD)))
...
(CL:DEFUN CREATE-BOOLEAN-VECTOR-INDEX-NODE (PARENTNODE LASTVALUE)
  (CL:LET*
   ...
   (CL:LET*
    ((I NULL-INTEGER) (ITER-000 0) (UPPER-BOUND-000 (CL:- VECTORLENGTH 2)))
    ...
    (CL:LOOP WHILE (CL:<= ITER-000 UPPER-BOUND-000) DO (CL:SETQ I ITER-000)
     (CL:LET
      ((SELF (%THE-ARRAY VECTOR))
       (VALUE
        (CL:AREF
         (CL:THE CL:SIMPLE-VECTOR (%THE-ARRAY (%THE-VECTOR PARENTNODE))) I))
       (POSITION I))
     ...
     (CL:IF BOUND?
      (CL:PROGN (CL:SETQ NEXTNODE (%TRUE-LINK NODE))
       (CL:WHEN (CL:EQ NEXTNODE NULL)
        (CL:SETQ NEXTNODE (CREATE-BOOLEAN-VECTOR-INDEX-NODE NODE CL:T))))
      (CL:PROGN (CL:SETQ NEXTNODE (%FALSE-LINK NODE))
       (CL:WHEN (CL:EQ NEXTNODE NULL)
        (CL:SETQ NEXTNODE (CREATE-BOOLEAN-VECTOR-INDEX-NODE NODE CL:NIL)))))
...
(CL:DEFUN ACTIVATE-PATTERN-RECORD (PATTERNRECORD VARIABLECOUNT)
  ...
  (CL:LET*
   ...
   (CL:IF
    ...
    (CL:LET*
     ((I NULL-INTEGER) (ITER-000 0) (UPPER-BOUND-000 (CL:1- VARIABLECOUNT)))
     (CL:DECLARE (CL:TYPE CL:FIXNUM I ITER-000 UPPER-BOUND-000))
     (CL:LOOP WHILE (CL:<= ITER-000 UPPER-BOUND-000) DO (CL:SETQ I ITER-000)
      ...
      (CL:SETQ ITER-000 (CL:1+ ITER-000))))
    (CL:PROGN
     (CL:SETF (%VARIABLE-BINDINGS PATTERNRECORD) (NEW-VECTOR VARIABLECOUNT))
...
(CL:DEFUN PRINT-ENVIRONMENT-STACKS ()
  (CL:LET*
   ...
   (%%PRINT-STREAM (%NATIVE-STREAM STANDARD-OUTPUT)
    "-------------------------" EOL)
   (%%PRINT-STREAM (%NATIVE-STREAM STANDARD-OUTPUT) "current-control-frame "
    FRAME EOL)
   (%%PRINT-STREAM (%NATIVE-STREAM STANDARD-OUTPUT) "    ")
   (CL:LET*
...
(CL:DEFUN CHANGE-PATTERN-VARIABLE-BINDING (VARIABLE NEWVALUE)
  (CL:LET*
   ...
   (CL:LET
    ((SELF (%THE-ARRAY (%VARIABLE-BINDINGS PATTERNRECORD))) (VALUE NEWVALUE)
     (POSITION VBOFFSET))
    (CL:DECLARE (CL:TYPE CL:SIMPLE-VECTOR SELF) (CL:TYPE CL:FIXNUM POSITION))
    (CL:SETF (CL:AREF SELF POSITION) VALUE))))
  ...
  (CL:LET*
   ...
   (CL:WHEN
    ...
    (%%PRINT-STREAM (%NATIVE-STREAM STANDARD-OUTPUT)
     ...
     (CL:1+ (CL:- (%TOP-UNBINDING-STACK-OFFSET PATTERNRECORD) UBSTACKOFFSET))
     EOL))
   (CL:LET*
    ...
    (CL:LOOP WHILE (CL:OR UNBOUNDED?-000 (CL:<= ITER-000 UPPER-BOUND-000)) DO
     ...
     (CL:LET
      ((SELF (%THE-ARRAY VARIABLEBINDINGSVECTOR)) (VALUE NULL)
       (POSITION
        (%WRAPPER-VALUE
         (CL:AREF (CL:THE CL:SIMPLE-VECTOR (%THE-ARRAY UNBINDINGSTACK)) I))))
      (CL:DECLARE (CL:TYPE CL:SIMPLE-VECTOR SELF)
       (CL:TYPE CL:FIXNUM POSITION))
      (CL:SETF (CL:AREF SELF POSITION) VALUE))
...
(CL:DEFUN CREATE-CHOICE-POINT (FRAME)
  (CL:LET* ((PATTERNRECORD (%INHERITED-PATTERN-RECORD FRAME)))
   (CL:WHEN
    (CL:AND (CL:NOT (CL:EQ *TRACED-KEYWORDS* NULL))
     (MEMB? *TRACED-KEYWORDS* KWD-QUERY-QUERY-STACKS))
    (%%PRINT-STREAM (%NATIVE-STREAM STANDARD-OUTPUT) "create-choice-point: F "
     (DEBUG-FRAME-ID FRAME) " CP= " (%CHOICE-POINT-UNBINDING-OFFSET FRAME)
...
(CL:DEFUN SAFE-BOUND-TO (SELF)
  (CL:WHEN (CL:NOT (CL:EQ *QUERYITERATOR* NULL))
   (CL:LET*
    ((BINDINGS (%VARIABLE-BINDINGS (%CURRENT-PATTERN-RECORD *QUERYITERATOR*)))
     (OFFSET (%BOUND-TO-OFFSET SELF)))
    (CL:DECLARE (CL:TYPE CL:FIXNUM OFFSET))
    (CL:WHEN
     (CL:AND (CL:NOT (CL:EQ BINDINGS NULL))
      (CL:NOT (CL:= OFFSET NULL-INTEGER)) (CL:< OFFSET (LENGTH BINDINGS)))
     (CL:RETURN-FROM SAFE-BOUND-TO
      (CL:AREF (CL:THE CL:SIMPLE-VECTOR (%THE-ARRAY BINDINGS)) OFFSET)))))
  NULL)
...
(CL:DEFUN BOUND-TO-IN-FRAME (SELF FRAME)
  (CL:LET*
   ((BINDINGS (%VARIABLE-BINDINGS (OPERATIVE-PATTERN-RECORD FRAME)))
    (OFFSET (%BOUND-TO-OFFSET SELF)))
   (CL:DECLARE (CL:TYPE CL:FIXNUM OFFSET))
   (CL:IF
    (CL:AND (CL:NOT (CL:EQ BINDINGS NULL)) (CL:NOT (CL:= OFFSET NULL-INTEGER))
     ...
     (CL:PROGN
      (CL:WHEN
       ...
       (CL:LET* ((TEMP-000 (FIND-DUPLICATE-DESCRIPTION SELF)))
        (CL:LET*
         ((VALUE-000 (CL:IF (CL:NOT (CL:EQ TEMP-000 NULL)) TEMP-000 SELF)))
     ...
     (CL:LET* ((VALUE NULL))
      (CL:WHEN
       (CL:AND (CL:NOT (CL:EQ *QUERYITERATOR* NULL))
        (CL:NOT (CL:= (%BOUND-TO-OFFSET SELF) NULL-INTEGER)))
       (CL:SETQ VALUE
        (CL:AREF
         (CL:THE CL:SIMPLE-VECTOR
          (%THE-ARRAY
      ...
      ((SUBTYPE-OF? (SAFE-PRIMARY-TYPE I2) SGT-QUERY-LOGIC-LOGIC-OBJECT)
       (CL:PROGN
        (CL:LET*
         ((P NULL)
          (ITER-001
           (ALLOCATE-ITERATOR (UNFILTERED-DEPENDENT-ISA-PROPOSITIONS I2))))
...
(CL:DEFUN HELP-BIND-VARIABLE-TO-VALUE? (VARIABLE VALUE)
   ...
   ((CL:EQ *TYPE-CHECK-STRATEGY* KWD-QUERY-LOOKUP)
    (CL:LET* ((TYPEISOK? CL:NIL))
     (CL:MULTIPLE-VALUE-SETQ (TYPEISOK? VALUE)
      (CHECK-COERCED-TYPE? VALUE (%SKOLEM-TYPE VARIABLE) CL:T))
     (CL:WHEN
      (CL:AND (CL:NOT TYPEISOK?)
  ...
  (CL:LET*
   ((BOUNDTOVALUE
    ...
    (VARIABLEVALUE
     (ACCESS-IN-CONTEXT (%VARIABLE-VALUE VARIABLE) (%HOME-CONTEXT VARIABLE)
      CL:NIL)))
     ...
     (CL:PROGN
      (CL:WHEN (ISA? VALUE SGT-QUERY-LOGIC-PROPOSITION)
       (CL:LET* ((MAPPING (NEW-KEY-VALUE-MAP)))
        (CL:LET* ((TEST-VALUE-000 CL:NIL))
         (CL:SETQ TEST-VALUE-000 (UNIFY-PROPOSITIONS? ARGUMENT VALUE MAPPING))
         (CL:WHEN TEST-VALUE-000
          (CL:LET* ((ALWAYS?-000 CL:T))
           (CL:LET*
            ((VAR NULL) (VAL NULL) (ITER-000 (ALLOCATE-ITERATOR MAPPING)))
            (CL:LOOP WHILE (NEXT? ITER-000) DO (CL:SETQ VAR (%KEY ITER-000))
             (CL:SETQ VAL (%VALUE ITER-000))
             (CL:WHEN (CL:NOT (BIND-VARIABLE-TO-VALUE? VAR VAL AUTOCLEANUP?))
  ...
  (CL:LET*
   ((PATTERNRECORD (%CURRENT-PATTERN-RECORD *QUERYITERATOR*))
    (OFFSET
     (%WRAPPER-VALUE
      (CL:AREF
       (CL:THE CL:SIMPLE-VECTOR (%THE-ARRAY (%UNBINDING-STACK PATTERNRECORD)))
       UBOFFSET))))
   (CL:DECLARE (CL:TYPE CL:FIXNUM OFFSET))
   (CL:LET*
    ...
    (CL:LOOP WHILE (CL:< INDEX-000 LENGTH-000) DO
     ...
     (CL:SETQ INDEX-000 (CL:1+ INDEX-000))))
   (CL:LET*
    ((VBL NULL) (VECTOR-001 (%INTERNAL-VARIABLES DESCRIPTION)) (INDEX-001 0)
   ...
   (CL:LET*
    ((VALUE
      (CL:IF (CL:NOT (CL:EQ *PRINTINFRAME* NULL))
       (BOUND-TO-IN-FRAME VARIABLE *PRINTINFRAME*) (SAFE-BOUND-TO VARIABLE))))
...
(CL:DEFUN PRINT-VARIABLE-BINDINGS (FRAME)
  (CL:LET*
   ((PATTERNRECORD (OPERATIVE-PATTERN-RECORD FRAME)) (DESCRIPTION NULL))
    ...
    (CL:WHEN (CL:EQ (%STATE FRAME) KWD-QUERY-CONTAINED-BY)
     (CL:LET*
      ((MEMBERPROPOSITION
       ...
       (MEMBER
        (CL:AREF
         (CL:THE CL:SIMPLE-VECTOR (%THE-ARRAY (%ARGUMENTS MEMBERPROPOSITION)))
         0)))
        ...
        ((SUBTYPE-OF? TEST-VALUE-000 SGT-QUERY-STELLA-LIST)
         (CL:PROGN
          (CL:LET* ((M NULL) (ITER-000 (%THE-CONS-LIST MEMBER)))
           (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-000 NIL)) DO
            (CL:SETQ M (%%VALUE ITER-000)) (PRINT-ONE-VARIABLE-BINDING M)
            (CL:SETQ ITER-000 (%%REST ITER-000))))))
        (CL:T
         (CL:LET* ((STREAM-000 (NEW-OUTPUT-STRING-STREAM)))
       ...
       (CL:WHEN
        (CL:NOT
         (CL:EQ
          (CL:AREF
           (CL:THE CL:SIMPLE-VECTOR
            (%THE-ARRAY (%VARIABLE-BINDINGS PATTERNRECORD)))
  ...
  (CL:LET*
   ...
   (CL:LET*
    ...
    (CL:WHEN (CL:NOT (CL:EQ RULENAME NULL))
     (%%PRINT-STREAM (%NATIVE-STREAM STANDARD-OUTPUT) (%SYMBOL-NAME RULENAME)
      EOL)
     (PRINT-INDENT STANDARD-OUTPUT (CL:+ (CL:* 2 DEPTH) 6))))
   (CL:LET*
    ((*PRINTMODE* KWD-QUERY-FLAT) (*PRINTLOGICALFORMSTREAM* STANDARD-OUTPUT)
   ...
   (CL:LET* ((INVERT? (%REVERSE-POLARITY? FRAME)))
    ...
    (CL:LET*
     ...
     (CL:WHEN (CL:NOT (CL:= (%ALLOTTED-CLOCK-TICKS FRAME) NULL-INTEGER))
      (%%PRINT-STREAM (%NATIVE-STREAM STANDARD-OUTPUT) " ticks="
...
(CL:DEFUN COMPUTE-FRAME-DEPTH (FRAME)
  (CL:LET*
   ((DEPTH 0)
    (CURSOR
     (CL:IF (CL:NOT (CL:EQ *QUERYITERATOR* NULL))
      (%BASE-CONTROL-FRAME *QUERYITERATOR*) NULL)))
   (CL:DECLARE (CL:TYPE CL:FIXNUM DEPTH))
   (CL:LOOP WHILE (CL:NOT (CL:EQ CURSOR NULL)) DO
    (CL:WHEN (CL:EQ CURSOR FRAME) (CL:RETURN)) (CL:SETQ CURSOR (%DOWN CURSOR))
...
(CL:DEFUN UNWIND-TO-CHOICE-POINTS-BELOW-FRAME (FRAME)
  (CL:LOOP WHILE (CL:NOT (CL:EQ (%DOWN FRAME) NULL)) DO
...
(CL:DEFUN TRACE-GOAL-TREE (FRAME DEPTH LASTMOVE)
        ...
        (CL:IF
         ...
         (CL:PROGN
          ...
          (CL:LET* ((FIRSTTIME? CL:T))
           (CL:LET*
            ((TV NULL) (VECTOR-000 (%BOOLEAN-VECTOR (%PATTERN-RECORD FRAME)))
             (INDEX-000 0) (LENGTH-000 (LENGTH VECTOR-000)))
            (CL:DECLARE (CL:TYPE CL:FIXNUM INDEX-000 LENGTH-000))
            (CL:LOOP WHILE (CL:< INDEX-000 LENGTH-000) DO
             (CL:SETQ TV
     ...
     (CL:T (%%PRINT-STREAM (%NATIVE-STREAM STANDARD-OUTPUT) "| SUCC: ")
      ...
      (CL:LET* ((TRUTHVALUE (%TRUTH-VALUE FRAME)))
       (CL:WHEN (CL:NOT (CL:EQ TRUTHVALUE NULL))
        (%%PRINT-STREAM (%NATIVE-STREAM STANDARD-OUTPUT) "truth="
         (TRUTH-VALUE-TO-STRING TRUTHVALUE CL:T)))))))
  ...
  (CL:WHEN (TRACE-KEYWORD? KWD-QUERY-STATE-MACHINE)
   (%%PRINT-STREAM (%NATIVE-STREAM STANDARD-OUTPUT) " state= " (%STATE FRAME)
    "  lastMove= " LASTMOVE " depth= " DEPTH " revPty?= "
   ...
   (CL:T (%%PRINT-STREAM (%NATIVE-STREAM STANDARD-OUTPUT) " ")
    (CL:COND
     ((CL:OR (CL:EQ LASTMOVE KWD-QUERY-DOWN)
       (CL:EQ LASTMOVE KWD-QUERY-UP-TRUE) (CL:EQ LASTMOVE KWD-QUERY-UP-FAIL))
      (TRACE-FRAME-PARTIAL-TRUTH (%PARTIAL-MATCH-FRAME FRAME) LASTMOVE
       STANDARD-OUTPUT)
      (%%PRINT-STREAM (%NATIVE-STREAM STANDARD-OUTPUT) EOL))
     (CL:T)))))
   ...
   ((CL:OR (CL:EQ LASTMOVE KWD-QUERY-UP-TRUE)
    ...
    (CL:LET*
     ((PMF (%PARTIAL-MATCH-FRAME FRAME))
      (ARITY (LENGTH (%ARGUMENTS (%PROPOSITION FRAME)))) (I 0))
     (CL:DECLARE (CL:TYPE CL:FIXNUM ARITY I))
     (CL:SETF (%SUCCESS? PMF) (CL:EQ LASTMOVE KWD-QUERY-UP-TRUE))
     ...
     (CL:WHEN (CL:NOT (CL:EQ (%UNBOUND-VARS PMF) NIL))
      ...
      (CL:LOOP
       (CL:LET* ((TEST-VALUE-000 CL:NIL))
        (CL:SETQ TEST-VALUE-000 (< (CL:1+ (%ARGUMENT-CURSOR FRAME)) ARITY))
        (CL:WHEN TEST-VALUE-000
         (CL:LET* ((FOUND?-000 CL:NIL))
          (CL:LET*
           ((VAR NULL)
      ...
      (CL:WHEN (TRACE-KEYWORD? KWD-QUERY-GOAL-TREE)
       (%%PRINT-STREAM (%NATIVE-STREAM STANDARD-OUTPUT) "   *** Skipping " I
        " propositions . . ." EOL)))
   ...
   ((CL:OR (CL:EQ LASTMOVE KWD-QUERY-UP-TRUE)
    ...
    (CL:WHEN
     ...
     (CL:COND
      ...
      ((CL:AND
        (EMPTY?
         (DYNAMIC-SLOT-VALUE (%DYNAMIC-SLOTS FRAME) SYM-QUERY-STELLA-ITERATOR
          NULL))
        (CL:NOT (UNBOUND-VARIABLES-IN-FRAME? FRAME))
        (COMPUTE-PARTIAL-MATCH-SCORE? FRAME))
       (CL:SETQ LASTMOVE KWD-QUERY-UP-TRUE))
...
(CL:DEFUN ATTACH-SUPPORT (FRAME LASTMOVE)
  (CL:IF
   ...
   (CL:LET*
    ...
    (CL:SETF (%ID SUPPORT)
     (CL:SETQ *PARTIAL-SUPPORT-COUNTER* (CL:1+ *PARTIAL-SUPPORT-COUNTER*)))
    ...
    (CL:IF (CL:NOT (CL:EQ (SUPPORT (%PROPOSITION FRAME)) NULL))
     (SET-DYNAMIC-SLOT-VALUE (%DYNAMIC-SLOTS (%PROPOSITION FRAME))
      SYM-QUERY-LOGIC-SUPPORT (CONS SUPPORT (SUPPORT (%PROPOSITION FRAME)))
      NULL)
     (SET-DYNAMIC-SLOT-VALUE (%DYNAMIC-SLOTS (%PROPOSITION FRAME))
...
(CL:DEFUN OPERATIVE-PATTERN-RECORD (FRAME)
  (CL:IF (CL:NOT (CL:EQ (%PATTERN-RECORD FRAME) NULL)) (%PATTERN-RECORD FRAME)
   (%INHERITED-PATTERN-RECORD FRAME)))
...
(CL:DEFUN CREATE-DOWN-FRAME (UPFRAME DOWNPROPOSITION)
  (CL:LET* ((DOWNFRAME (NEW-CONTROL-FRAME)))
   ...
   (CL:SETF (%TRUTH-VALUE DOWNFRAME) NULL) (CLEAR (%JUSTIFICATIONS DOWNFRAME))
...
(CL:DEFUN SET-FRAME-TRUTH-VALUE (FRAME TRUTHVALUE)
  (CL:SETF (%TRUTH-VALUE FRAME)
   (CL:IF (%REVERSE-POLARITY? FRAME) (INVERT-TRUTH-VALUE TRUTHVALUE)
    TRUTHVALUE)))
...
(CL:DEFUN PROPAGATE-FRAME-TRUTH-VALUE (SOURCE TARGET)
  (CL:SETF (%TRUTH-VALUE TARGET)
   (CL:IF
    (CL:NOT (CL:EQ (%REVERSE-POLARITY? SOURCE) (%REVERSE-POLARITY? TARGET)))
...
(CL:DEFUN COPY-FRAME-STATE (FROMFRAME TOFRAME)
  ...
  (SET-DYNAMIC-SLOT-VALUE (%DYNAMIC-SLOTS TOFRAME) SYM-QUERY-LOGIC-DESCRIPTION
   (DYNAMIC-SLOT-VALUE (%DYNAMIC-SLOTS FROMFRAME) SYM-QUERY-LOGIC-DESCRIPTION
    NULL)
   NULL)
  ...
  (SET-DYNAMIC-SLOT-VALUE (%DYNAMIC-SLOTS TOFRAME) SYM-QUERY-LOGIC-GOAL-CACHE
   (DYNAMIC-SLOT-VALUE (%DYNAMIC-SLOTS FROMFRAME) SYM-QUERY-LOGIC-GOAL-CACHE
    NULL)
   NULL))
...
(CL:DEFUN PARALLELIZE-CONTROL-FRAME (FRAME)
  ...
  (CL:LET* ((PARALLELPARENT (NEW-PARALLEL-CONTROL-FRAME)))
   ...
   (SET-DYNAMIC-SLOT-VALUE (%DYNAMIC-SLOTS FRAME)
    SYM-QUERY-LOGIC-CACHED-BINDINGS-ITERATOR NULL NULL)
   (SET-DYNAMIC-SLOT-VALUE (%DYNAMIC-SLOTS FRAME) SYM-QUERY-LOGIC-GOAL-CACHE
    NULL NULL)
...
(CL:DEFUN EXECUTE-BACKWARD-CHAINING-PROOF? (QUERY)
  (CL:WHEN (CL:EQ (%DOWN (%BASE-CONTROL-FRAME QUERY)) NULL)
   (CL:RETURN-FROM EXECUTE-BACKWARD-CHAINING-PROOF? CL:NIL))
  (CL:LET* ((*QUERYITERATOR* QUERY)) (CL:DECLARE (CL:SPECIAL *QUERYITERATOR*))
   (CL:LET*
    ((FRAME (%BASE-CONTROL-FRAME QUERY)) (DEPTH 0) (LASTMOVE KWD-QUERY-DOWN)
     (RESULTOFNEXTMOVE NULL) (CLOCKTICKS (%CURRENT-CLOCK-TICKS QUERY))
     ...
     (TRACESUBGOALS? (TRACE-KEYWORD? KWD-QUERY-GOAL-TREE)) (TIMEOUT? CL:NIL)
     (SUCCESS? CL:NIL))
    (CL:DECLARE (CL:TYPE CL:FIXNUM DEPTH CLOCKTICKS STARTTICKS ALLOTTEDTICKS)
    ...
    (CL:WHEN CHECKFORMOVEOUT?
     (CL:SETF (%ALLOTTED-CLOCK-TICKS FRAME) ALLOTTEDTICKS))
    ...
    (CL:LOOP (CL:SETF (%CURRENT-CONTROL-FRAME QUERY) FRAME)
     ...
     (CL:COND
      ((CL:EQ RESULTOFNEXTMOVE KWD-QUERY-MOVE-DOWN)
       (CL:LET* ((UPFRAME FRAME) (DOWNFRAME (%DOWN FRAME)))
        (CL:SETQ DEPTH (CL:1+ DEPTH))
        (CL:SETF (%CURRENT-CLOCK-TICKS QUERY)
        ...
        (CL:COND
         ((CL:NOT (CL:EQ DOWNFRAME NULL)) (CL:SETQ FRAME DOWNFRAME)
          ...
          (CL:WHEN
           (CL:AND CHECKFORMOVEOUT?
            (CL:= (%ALLOTTED-CLOCK-TICKS FRAME) NULL-INTEGER))
           (CL:SETF (%ALLOTTED-CLOCK-TICKS FRAME)
            (CL:1- (%ALLOTTED-CLOCK-TICKS UPFRAME))))
          (CL:SETF (%TRUTH-VALUE FRAME) NULL)
          (SET-DYNAMIC-SLOT-VALUE (%DYNAMIC-SLOTS FRAME)
           SYM-QUERY-LOGIC-JUSTIFICATION NULL NULL)
         ...
         (CL:T
          (CL:LET*
           ...
           (CL:SETQ LASTMOVE KWD-QUERY-DOWN))))
        (CL:WHEN
         (CL:AND (CL:> DEPTH (%CURRENT-DEPTH-CUTOFF QUERY))
          (CL:EQ (%STATE UPFRAME) KWD-QUERY-PATTERN))
        ...
        (CL:WHEN CHECKFORMOVEOUT?
         (CL:WHEN
          (CL:AND (CL:<= (%ALLOTTED-CLOCK-TICKS FRAME) 0)
           (CL:NOT (CL:EQ LASTMOVE KWD-QUERY-UP-FAIL)))
          (POP-FRAMES-UP-TO FRAME)
          (CL:MULTIPLE-VALUE-SETQ (FRAME DEPTH) (HANDLE-TIMEOUT FRAME DEPTH))
          (CL:SETQ LASTMOVE KWD-QUERY-UP-FAIL))
         (CL:WHEN (CL:EQ LASTMOVE KWD-QUERY-UP-FAIL)
          (CL:SETF (%ALLOTTED-CLOCK-TICKS FRAME)
           (CL:- (%ALLOTTED-CLOCK-TICKS FRAME)
            (CL:1+ (CL:- CLOCKTICKS (%STARTING-CLOCK-TICKS DOWNFRAME))))))))
      ...
      ((CL:EQ RESULTOFNEXTMOVE KWD-QUERY-FINAL-SUCCESS)
       (CL:LET* ((PARENT (%UP FRAME)))
        ...
        (CL:SETQ DEPTH (CL:1- DEPTH))
        (CL:WHEN CHECKFORMOVEOUT?
         (CL:SETF (%ALLOTTED-CLOCK-TICKS FRAME) NULL-INTEGER)
         (CL:WHEN (CL:NOT (CL:EQ PARENT NULL))
          (CL:SETF (%ALLOTTED-CLOCK-TICKS PARENT)
           (CL:- (%ALLOTTED-CLOCK-TICKS PARENT)
            (CL:- CLOCKTICKS (%STARTING-CLOCK-TICKS FRAME)) 1))))
        (CL:SETQ FRAME PARENT)
        (CL:WHEN (CL:EQ FRAME NULL) (CL:SETQ SUCCESS? CL:T) (CL:RETURN))
         ...
         (CL:WHEN (CL:NOT (CL:EQ PARENT NULL))
          (CL:SETF (%ALLOTTED-CLOCK-TICKS PARENT)
           (CL:- (%ALLOTTED-CLOCK-TICKS PARENT)
            (CL:- CLOCKTICKS (%STARTING-CLOCK-TICKS FRAME)) 1))))
        (CL:SETQ FRAME PARENT)
        (CL:WHEN (CL:EQ FRAME NULL) (CL:SETQ SUCCESS? CL:NIL) (CL:RETURN))
         ...
         (CHECKFORMOVEOUT?
          (CL:LET*
           ((PARENT (%UP FRAME)) (STARTTICKS (%STARTING-CLOCK-TICKS FRAME))
            (AVAILABLETICKS
             (CL:- (%ALLOTTED-CLOCK-TICKS PARENT) (CL:- CLOCKTICKS STARTTICKS)
              1)))
           (CL:DECLARE (CL:TYPE CL:FIXNUM STARTTICKS AVAILABLETICKS))
           (CL:SETF (%ALLOTTED-CLOCK-TICKS PARENT) AVAILABLETICKS)
      ...
      (CL:T
       (CL:LET* ((STREAM-000 (NEW-OUTPUT-STRING-STREAM)))
        (%%PRINT-STREAM (%NATIVE-STREAM STREAM-000) "`" RESULTOFNEXTMOVE
         "' is not a valid case option")
        (CL:ERROR (NEW-STELLA-EXCEPTION (THE-STRING-READER STREAM-000)))))))
    (CL:SETF (%ALLOTTED-TIME QUERY) ALLOTTEDTIME)
    (CL:SETF (%TIMEOUT? QUERY) TIMEOUT?)
    (CL:WHEN CHECKFORMOVEOUT?
     (CL:SETF (%ALLOTTED-CLOCK-TICKS QUERY)
      (MAX (CL:- ALLOTTEDTICKS (CL:- CLOCKTICKS STARTTICKS)) 0))
     (CL:WHEN (CL:NOT TIMEOUT?)
      (CL:SETF (%TIMEOUT? QUERY) (CL:= (%ALLOTTED-CLOCK-TICKS QUERY) 0))))
    SUCCESS?)))
  ...
  (CL:LET* ((FOUND?-000 CL:NIL))
   (CL:LET*
    ...
    (CL:LOOP WHILE (CL:< INDEX-000 LENGTH-000) DO
     (CL:SETQ CONJUNCT
      (CL:AREF (CL:THE CL:SIMPLE-VECTOR (%THE-ARRAY VECTOR-000)) INDEX-000))
     (CL:WHEN (CL:EQ (%KIND CONJUNCT) KWD-QUERY-AND) (CL:SETQ FOUND?-000 CL:T)
      (CL:RETURN))
     (CL:SETQ INDEX-000 (CL:1+ INDEX-000))))
   ...
   (CL:COND
    ((CL:EQ LASTMOVE KWD-QUERY-DOWN)
     (CL:COND
      ...
      (CL:T
       (CL:SETQ CONJUNCTS
        (DYNAMIC-SLOT-VALUE (%DYNAMIC-SLOTS FRAME) SYM-QUERY-STELLA-ARGUMENTS
         NULL))
       (CL:WHEN (CL:EQ CONJUNCTS NULL)
        (CL:SETQ CONJUNCTS (NEW-VECTOR (LENGTH (%ARGUMENTS PROPOSITION))))
        (SET-DYNAMIC-SLOT-VALUE (%DYNAMIC-SLOTS FRAME)
       ...
       (CL:WHEN
        ...
        (DYNAMICALLY-REOPTIMIZE-ARGUMENTS (%ARGUMENTS PROPOSITION)
         (%ARGUMENT-CURSOR FRAME)))
       KWD-QUERY-MOVE-DOWN)))
    ((CL:EQ LASTMOVE KWD-QUERY-UP-TRUE)
     (CL:SETQ CONJUNCTS
      (DYNAMIC-SLOT-VALUE (%DYNAMIC-SLOTS FRAME) SYM-QUERY-STELLA-ARGUMENTS
       NULL))
     (CL:LET
      ((SELF (%THE-ARRAY CONJUNCTS)) (VALUE (%RESULT FRAME))
       (POSITION (%ARGUMENT-CURSOR FRAME)))
      (CL:DECLARE (CL:TYPE CL:SIMPLE-VECTOR SELF)
       (CL:TYPE CL:FIXNUM POSITION))
      (CL:SETF (CL:AREF SELF POSITION) VALUE))
     (CL:COND
      ((CL:= (%ARGUMENT-CURSOR FRAME) (CL:1- (LENGTH CONJUNCTS)))
       (CL:SETF (%DOWN FRAME) NULL)
       (CL:LET*
        ...
        (CL:LOOP WHILE (CL:< INDEX-000 LENGTH-000) DO
         ...
         (CL:SETF (%TRUTH-VALUE FRAME)
          (CL:IF (CL:= I 0) (%TRUTH-VALUE CONJUNCT)
           (CONJOIN-TRUTH-VALUES (%TRUTH-VALUE FRAME)
            (%TRUTH-VALUE CONJUNCT))))
         (CL:WHEN (CL:NOT (CL:EQ (%STATE CONJUNCT) KWD-QUERY-POPPED))
          (CL:SETF (%ARGUMENT-CURSOR FRAME) I)
          (CL:SETF (%DOWN FRAME) CONJUNCT))
         (CL:SETQ INDEX-000 (CL:1+ INDEX-000))
         (CL:SETQ ITER-000 (CL:1+ ITER-000))))
       (CL:WHEN *RECORD-JUSTIFICATIONS?*
        (RECORD-AND-INTRODUCTION-JUSTIFICATION FRAME LASTMOVE))
       (CL:IF (CL:NOT (CL:EQ (%DOWN FRAME) NULL)) KWD-QUERY-CONTINUING-SUCCESS
        KWD-QUERY-FINAL-SUCCESS))
      (CL:T (CL:SETF (%DOWN FRAME) NULL)
       (CL:SETF (%ARGUMENT-CURSOR FRAME) (CL:1+ (%ARGUMENT-CURSOR FRAME)))
       (CL:WHEN (DYNAMICALLY-OPTIMIZE-PROPOSITION? PROPOSITION)
        (DYNAMICALLY-REOPTIMIZE-ARGUMENTS (%ARGUMENTS PROPOSITION)
         (%ARGUMENT-CURSOR FRAME)))
    ...
    ((CL:EQ LASTMOVE KWD-QUERY-UP-FAIL)
     ...
     (CL:LET*
      ...
      (CL:LOOP WHILE (CL:< INDEX-001 LENGTH-001) DO
       ...
       (CL:WHEN (CL:NOT (CL:EQ (%STATE CONJUNCT) KWD-QUERY-POPPED))
        (CL:SETF (%ARGUMENT-CURSOR FRAME) I) (CL:SETF (%DOWN FRAME) CONJUNCT))
       (CL:SETQ INDEX-001 (CL:1+ INDEX-001))
      ...
      (CL:T (PROPAGATE-FRAME-TRUTH-VALUE (%RESULT FRAME) FRAME)
       ...
       (CL:LET*
        ((CONJUNCT NULL) (VECTOR-002 CONJUNCTS) (INDEX-002 0)
         ...
         (UPPER-BOUND-000 (%ARGUMENT-CURSOR FRAME))
         (UNBOUNDED?-000 (CL:= UPPER-BOUND-000 NULL-INTEGER)))
        (CL:DECLARE
         (CL:TYPE CL:FIXNUM INDEX-002 LENGTH-002 I ITER-002 UPPER-BOUND-000))
        (CL:LOOP WHILE
    ...
    ((CL:EQ LASTMOVE KWD-QUERY-DOWN)
     (CL:WHEN
      ...
      (CL:RETURN-FROM CONTINUE-OR-PROOF
       (OVERLAY-WITH-FAIL-FRAME FRAME PROPOSITION)))
     (CL:WHEN (CL:EQ (%DOWN FRAME) NULL) (CREATE-CHOICE-POINT FRAME))
     KWD-QUERY-MOVE-DOWN)
    ((CL:EQ LASTMOVE KWD-QUERY-UP-TRUE)
     (CL:SETF (%TRUTH-VALUE FRAME) (%TRUTH-VALUE (%RESULT FRAME)))
     (CL:WHEN *RECORD-JUSTIFICATIONS?*
     ...
     (CL:LET* ((CHOOSE-VALUE-000 NULL))
      (CL:IF (CL:EQ (%TRUTH-VALUE FRAME) NULL)
       (CL:LET* ((TEMP-000 (%TRUTH-VALUE (%RESULT FRAME))))
        (CL:SETQ CHOOSE-VALUE-000
         (CL:IF (CL:NOT (CL:EQ TEMP-000 NULL)) TEMP-000 UNKNOWN-TRUTH-VALUE)))
       (CL:SETQ CHOOSE-VALUE-000
        (DISJOIN-TRUTH-VALUES (%TRUTH-VALUE FRAME)
         (%TRUTH-VALUE (%RESULT FRAME)))))
  ...
  (CL:LET* ((*REVERSEPOLARITY?* (%REVERSE-POLARITY? FRAME)))
   ...
   (CL:LET*
    ((PROPOSITION (%PROPOSITION FRAME))
     (INFERENCELEVEL (%KEYWORD (CURRENT-INFERENCE-LEVEL))) (STRATEGIES NULL))
    ...
    (CL:SETF (%STATE FRAME) KWD-QUERY-ATOMIC-GOAL) (CREATE-CHOICE-POINT FRAME)
    KWD-QUERY-MOVE-IN-PLACE)))
...
(CL:DEFUN ALL-ARGUMENTS-BOUND? (GOAL)
  (CL:IF
   (CL:NOT
    (CL:EQ
     (DYNAMIC-SLOT-VALUE (%DYNAMIC-SLOTS GOAL) SYM-QUERY-LOGIC-IO-VARIABLES
      NULL)
     NULL))
       ...
       (CL:WHEN
        (CL:NOT
         (QUANTIFIED-ARGUMENT-BOUND?
          (CL:AREF (CL:THE CL:SIMPLE-VECTOR (%THE-ARRAY (%ARGUMENTS GOAL))) I)
          NULL))
        (CL:SETQ ALWAYS?-000 CL:NIL) (CL:RETURN))
       (CL:SETQ ITER-000 (CL:1+ ITER-000))))
    ...
    (CL:LET* ((ALWAYS?-001 CL:T))
     (CL:LET*
      ((I NULL-INTEGER) (ITER-001 0)
       (UPPER-BOUND-001 (CL:- (LENGTH (%ARGUMENTS GOAL)) 2)))
...
(CL:DEFUN COPY-PATTERN-ARGUMENTS (ARGUMENTS DESCRIPTION)
  ...
  (CL:LET* ((ARGUMENTCOUNT (ARITY DESCRIPTION)) (COPIEDARGUMENTS NULL))
   (CL:DECLARE (CL:TYPE CL:FIXNUM ARGUMENTCOUNT))
   (CL:WHEN (CL:= ARGUMENTCOUNT -1)
    (CL:SETQ ARGUMENTCOUNT (LENGTH ARGUMENTS)))
   (CL:SETQ COPIEDARGUMENTS (NEW-VECTOR ARGUMENTCOUNT))
   (CL:LET*
    ((I NULL-INTEGER) (ITER-000 0) (UPPER-BOUND-000 (CL:1- ARGUMENTCOUNT)))
    (CL:DECLARE (CL:TYPE CL:FIXNUM I ITER-000 UPPER-BOUND-000))
    (CL:LOOP WHILE (CL:<= ITER-000 UPPER-BOUND-000) DO (CL:SETQ I ITER-000)
     (CL:LET
      ((SELF (%THE-ARRAY COPIEDARGUMENTS))
       (VALUE (CL:AREF (CL:THE CL:SIMPLE-VECTOR (%THE-ARRAY ARGUMENTS)) I))
       (POSITION I))
      (CL:DECLARE (CL:TYPE CL:SIMPLE-VECTOR SELF)
       (CL:TYPE CL:FIXNUM POSITION))
      (CL:SETF (CL:AREF SELF POSITION) VALUE))
   ...
   (CL:LET*
    ...
    (CL:LOOP WHILE (CL:< INDEX-000 LENGTH-000) DO
     ...
     (CL:IF (CL:EQ COLLECT-000 NULL)
      (CL:PROGN
       (CL:SETQ COLLECT-000
        (CONS (INSTANTIATE-EXTERNAL-BINDINGS (SAFE-ARGUMENT-BOUND-TO ARG))
         NIL))
  ...
  (CL:WHEN (CL:NOT (EMPTY? BINDINGS))
   (CL:LET* ((*EVALUATIONMODE* KWD-QUERY-DESCRIPTION) (*QUERYITERATOR* NULL))
    ...
    (CL:LET* ((DESCRIPTION (NEW-DESCRIPTION)))
     (CL:LET*
      ((VAR NULL) (BINDING NULL) (ITER-000 (ALLOCATE-ITERATOR BINDINGS)))
      (CL:LOOP WHILE (NEXT? ITER-000) DO (CL:SETQ VAR (%KEY ITER-000))
     ...
     (CL:LET*
      ((VAR NULL) (VECTOR-000 (%IO-VARIABLES SELF)) (INDEX-000 0)
       (LENGTH-000 (LENGTH VECTOR-000)))
      (CL:DECLARE (CL:TYPE CL:FIXNUM INDEX-000 LENGTH-000))
      (CL:LOOP WHILE (CL:< INDEX-000 LENGTH-000) DO
       (CL:SETQ VAR
        (CL:AREF (CL:THE CL:SIMPLE-VECTOR (%THE-ARRAY VECTOR-000)) INDEX-000))
       (INSERT-AT BINDINGS VAR VAR) (CL:SETQ INDEX-000 (CL:1+ INDEX-000))))
     (CL:LET*
      ((VAR NULL)
       (VECTOR-001
        (DYNAMIC-SLOT-VALUE (%DYNAMIC-SLOTS SELF)
      ...
      (CL:LOOP WHILE (CL:< INDEX-001 LENGTH-001) DO
       ...
       (CL:SETQ INDEX-001 (CL:1+ INDEX-001))))
     (CL:LET*
      ((VAR NULL) (VECTOR-002 (%INTERNAL-VARIABLES SELF)) (INDEX-002 0)
      ...
      (CL:LOOP WHILE (CL:< INDEX-002 LENGTH-002) DO
       ...
       (INSERT-AT BINDINGS VAR VAR) (CL:SETQ INDEX-002 (CL:1+ INDEX-002))))
...
(CL:DEFUN OVERLAY-WITH-PATTERN-FRAME? (FRAME DESCRIPTION IOARGUMENTS)
  (CL:LET*
   ...
   (CL:WHEN (CL:EQ IOARGUMENTS NULL)
    (CL:LET*
     ((V (ALLOCATE-ITERATOR (%IO-VARIABLES DESCRIPTION))) (COLLECT-000 NULL))
     (CL:LOOP WHILE (NEXT? V) DO
      (CL:IF (CL:EQ COLLECT-000 NULL)
   ...
   (CL:SETQ OPTIMALPATTERN
    (SELECT-OPTIMAL-QUERY-PATTERN DESCRIPTION (%BOOLEAN-VECTOR PATTERNRECORD)
     FRAME))
   (CL:SETF (%OPTIMAL-PATTERN PATTERNRECORD) OPTIMALPATTERN)
   (CL:WHEN (CHECK-FOR-SINGLE-VALUED-GOAL? OPTIMALPATTERN IOBINDINGS)
    (SET-DYNAMIC-SLOT-VALUE (%DYNAMIC-SLOTS FRAME)
     SYM-QUERY-LOGIC-CACHED-SINGLE-VALUED? TRUE-WRAPPER FALSE-WRAPPER))
   (CL:SETF (%PROPOSITION FRAME) (%PROPOSITION OPTIMALPATTERN))
   (CL:LET*
    ((VARIABLESCOUNT
      (CL:+ (LENGTH IOBINDINGS) (LENGTH (%INTERNAL-VARIABLES OPTIMALPATTERN))
       (LENGTH EXTERNALBINDINGS))))
    (CL:DECLARE (CL:TYPE CL:FIXNUM VARIABLESCOUNT))
    (ACTIVATE-PATTERN-RECORD PATTERNRECORD VARIABLESCOUNT))
   (CL:LET*
    ((IOVAR NULL) (VECTOR-000 (%IO-VARIABLES OPTIMALPATTERN)) (INDEX-000 0)
     (LENGTH-000 (LENGTH VECTOR-000)) (BINDING NULL) (ITER-000 IOBINDINGS))
    (CL:DECLARE (CL:TYPE CL:FIXNUM INDEX-000 LENGTH-000))
    (CL:LOOP WHILE
     (CL:AND (CL:< INDEX-000 LENGTH-000) (CL:NOT (CL:EQ ITER-000 NIL))) DO
     (CL:SETQ IOVAR
   ...
   (CL:WHEN (CL:NOT (CL:EQ EXTERNALBINDINGS NIL))
    (CL:LET*
     ...
     (CL:DECLARE (CL:TYPE CL:FIXNUM INDEX-001 LENGTH-001))
     (CL:LOOP WHILE
      (CL:AND (CL:< INDEX-001 LENGTH-001) (CL:NOT (CL:EQ ITER-001 NIL))) DO
      (CL:SETQ EXTERNALVAR
       (CL:AREF (CL:THE CL:SIMPLE-VECTOR (%THE-ARRAY VECTOR-001)) INDEX-001))
         ...
         (CL:IF
          (CL:NOT
           (COERCE-WRAPPED-BOOLEAN-TO-BOOLEAN
            (CL:AREF (CL:THE CL:SIMPLE-VECTOR (%THE-ARRAY BOOLEANVECTOR)) I)))
          (CL:AREF
           (CL:THE CL:SIMPLE-VECTOR
            (%THE-ARRAY
             (%VARIABLE-BINDINGS (%CURRENT-PATTERN-RECORD *QUERYITERATOR*))))
           (CL:THE CL:FIXNUM
            (%BOUND-TO-OFFSET
             (CL:AREF (CL:THE CL:SIMPLE-VECTOR (%THE-ARRAY IOVARIABLES)) I))))
          NULL)
         NIL))
      ...
      (CL:WHEN (CL:NOT (COERCE-WRAPPED-BOOLEAN-TO-BOOLEAN INITIALLYBOUND?))
       (CL:WHEN (CL:NOT (BIND-ARGUMENT-TO-VALUE? EXTERNALARG VALUE CL:NIL))
        (CL:WHEN
         (CL:AND (CL:NOT (CL:EQ *TRACED-KEYWORDS* NULL))
          (MEMB? *TRACED-KEYWORDS* KWD-QUERY-QUERY-STACKS))
         (%%PRINT-STREAM (%NATIVE-STREAM STANDARD-OUTPUT) "TRANSFER FAILS! "
          EOL))
   ...
   (CL:LET* ((PARENT (%UP FRAME)))
    (CL:WHEN (CL:NOT (CL:EQ PARENT NULL))
     (CL:RETURN-FROM GET-RULE-OF-ANTECEDENT-FRAME
      (DYNAMIC-SLOT-VALUE (%DYNAMIC-SLOTS PARENT)
       SYM-QUERY-LOGIC-ANTECEDENTS-RULE NULL)))))
  NULL)
...
(CL:DEFUN CONTINUE-PATTERN-PROOF (FRAME LASTMOVE)
  (CL:COND
   ((CL:EQ LASTMOVE KWD-QUERY-DOWN)
    (RESET-CURRENT-PATTERN-RECORD FRAME KWD-QUERY-LOCAL) KWD-QUERY-MOVE-DOWN)
   ((CL:EQ LASTMOVE KWD-QUERY-UP-TRUE)
    (CL:LET*
     ((FUTUREBINDINGS? (CL:NOT (CL:EQ (%DOWN FRAME) NULL)))
      (RESULT (%RESULT FRAME)) (RULE (GET-RULE-OF-ANTECEDENT-FRAME FRAME)))
     (CL:SETF (%TRUTH-VALUE FRAME)
...
(CL:DEFUN DISJOINT-TERMS? (D1 D2)
  ...
  (CL:WHEN
   (CL:EQ (%SURROGATE-VALUE SGT-QUERY-PL-KERNEL-KB-PARTITION-MEMBERSHIP) NULL)
    ...
    (CL:RETURN-FROM DISJOINT-TERMS?
     (TRUE-TRUTH-VALUE?
      (EVALUATE-SELECTION-PATTERN
       (MAKE-RELATION-PATTERN-2 SGT-QUERY-PL-KERNEL-KB-DISJOINT D1 D2))))))
  (CL:LET* ((TRACEDKEYWORDS *TRACED-KEYWORDS*) (DISJOINT? CL:NIL))
   (CL:WHEN (CL:NOT *TRACE-DISJOINTNESS-SUBGOALS?*)
    (CL:SETQ *TRACED-KEYWORDS* NULL))
   (CL:LET* ((*EVALUATIONMODE* KWD-QUERY-EXTENSIONAL-ASSERTION))
    ...
    (CL:LET*
     ...
     (CL:WHEN *MEMOIZATION-ENABLED?*
      (CL:SETQ MEMO-TABLE-000
       (%SURROGATE-VALUE SGT-QUERY-LOGIC-F-DISJOINT-TERMS?-MEMO-TABLE-000))
      (CL:WHEN (CL:EQ MEMO-TABLE-000 NULL)
       (INITIALIZE-MEMOIZATION-TABLE
        SGT-QUERY-LOGIC-F-DISJOINT-TERMS?-MEMO-TABLE-000
        "(:MAX-VALUES 10000 :TIMESTAMPS (:META-KB-UPDATE))")
       (CL:SETQ MEMO-TABLE-000
        (%SURROGATE-VALUE SGT-QUERY-LOGIC-F-DISJOINT-TERMS?-MEMO-TABLE-000)))
      (CL:SETQ MEMOIZED-ENTRY-000
       (LOOKUP-MRU-MEMOIZED-VALUE MEMO-TABLE-000 D1 D2 *CONTEXT*
...
(CL:DEFUN MEMBER-OF-COLLECTION? (MEMBER COLLECTION)
  (CL:LET* ((TEST-VALUE-000 (SAFE-PRIMARY-TYPE COLLECTION)))
   (CL:COND
      ...
      (CL:RETURN-FROM MEMBER-OF-COLLECTION?
       (NEXT?
        (ALL-TRUE-DEPENDENT-PROPOSITIONS MEMBER
         (%SURROGATE-VALUE-INVERSE COLLECTION) CL:T)))))
        ...
        ((CL:NOT (CL:EQ ENUMERATEDCOLLECTIONS NIL))
         (CL:LET* ((COL NULL) (ITER-001 ENUMERATEDCOLLECTIONS))
          (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-001 NIL)) DO
           ...
           (CL:LET*
            ((ARG NULL) (VECTOR-000 (%ARGUMENTS COL)) (INDEX-000 0)
             (LENGTH-000 (LENGTH VECTOR-000)) (I NULL-INTEGER) (ITER-002 2)
    ...
    ((SUBTYPE-OF? TEST-VALUE-000 SGT-QUERY-LOGIC-LOGIC-OBJECT)
     (CL:PROGN
      (CL:LET*
       ((EQUIVALENTSKOLEM (%%VALUE (VARIABLE-VALUE-INVERSE COLLECTION))))
  ...
  (CL:WARN
   ...
   (%SYMBOL-NAME (WRAPPED-TYPE-TO-TYPE (PRIMARY-TYPE COLLECTION))) MEMBER
   COLLECTION)
  CL:NIL)
    ...
    ((SUBTYPE-OF? TEST-VALUE-000 SGT-QUERY-LOGIC-SKOLEM)
     (CL:PROGN
      (CL:LET*
       ((MEMBERS (NEW-LIST))
        (ENUMERATEDCOLLECTIONS
         (ALL-DEFINING-PROPOSITIONS SELF SGT-QUERY-PL-KERNEL-KB-COLLECTIONOF
          CL:T)))
       (CL:IF (CL:NOT (CL:EQ ENUMERATEDCOLLECTIONS NIL))
        (CL:LET* ((COL NULL) (ITER-002 ENUMERATEDCOLLECTIONS))
         (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-002 NIL)) DO
          ...
          (CL:LET*
           ((ARG NULL) (VECTOR-000 (%ARGUMENTS COL)) (INDEX-000 0)
            (LENGTH-000 (LENGTH VECTOR-000)) (I NULL-INTEGER) (ITER-003 2)
...
(CL:DEFUN NEW-DESCRIPTION-EXTENSION-ITERATOR ()
  (CL:LET* ((SELF NULL))
   ...
   (CL:SETF (%REMOVING-DUPLICATES? SELF) CL:NIL)
   ...
   (CL:SETF (%EXTENSION-ITERATOR SELF) NULL)
   (CL:SETF (%SUBCOLLECTIONS SELF) NULL)
...
(CL:DEFUN ACCESS-DESCRIPTION-EXTENSION-ITERATOR-SLOT-VALUE (SELF SLOTNAME VALUE SETVALUE?)
  (CL:COND
   ((CL:EQ SLOTNAME SYM-QUERY-LOGIC-ROOT-DESCRIPTION)
    (CL:IF SETVALUE? (CL:SETF (%ROOT-DESCRIPTION SELF) VALUE)
     (CL:SETQ VALUE (%ROOT-DESCRIPTION SELF))))
   ((CL:EQ SLOTNAME SYM-QUERY-LOGIC-SUBCOLLECTIONS)
    (CL:IF SETVALUE? (CL:SETF (%SUBCOLLECTIONS SELF) VALUE)
     (CL:SETQ VALUE (%SUBCOLLECTIONS SELF))))
...
(CL:DEFUN ALL-TRUE-EXTENSION-MEMBERS (SELF SPECIALIZE?)
  (CL:LET* ((ITERATOR (NEW-DESCRIPTION-EXTENSION-ITERATOR)))
   (CL:SETF (%ROOT-DESCRIPTION ITERATOR) SELF)
   (CL:SETF (%EXTENSION-ITERATOR ITERATOR) (ALL-EXTENSION-MEMBERS SELF))
   (CL:IF SPECIALIZE? (CL:SETF (%SUBCOLLECTIONS ITERATOR) NULL)
    (CL:SETF (%SUBCOLLECTIONS ITERATOR) NIL))
...
(CL:DEFUN ALL-MATCHING-EXTENSION-MEMBERS (SELF SPECIALIZE?)
  (CL:LET*
   ((ITERATOR
     (ALL-TRUE-EXTENSION-MEMBERS (SURROGATE-TO-DESCRIPTION (%OPERATOR SELF))
      SPECIALIZE?)))
...
(CL:DEFMETHOD NEXT? ((SELF DESCRIPTION-EXTENSION-ITERATOR))
  (CL:LET*
   ((WITHINQUERY? (CL:NOT (CL:EQ *QUERYITERATOR* NULL)))
    (PATTERNRECORD
     (CL:IF WITHINQUERY? (%CURRENT-PATTERN-RECORD *QUERYITERATOR*) NULL))
    (UBSTACKOFFSET
     (CL:IF WITHINQUERY? (CL:1+ (%TOP-UNBINDING-STACK-OFFSET PATTERNRECORD))
      NULL-INTEGER)))
   (CL:DECLARE (CL:TYPE CL:FIXNUM UBSTACKOFFSET))
   (CL:LOOP
    (CL:LOOP
     (CL:TAGBODY
      ...
      (CL:LET* ((VALUE (%VALUE (%EXTENSION-ITERATOR SELF))))
         ...
         (CL:AND
          (CL:AND (CL:NOT (DELETED? VALUE))
           (CL:IF *REVERSEPOLARITY?* (FALSE? VALUE)
            (CL:OR (TRUE? VALUE) (FUNCTION-WITH-DEFINED-VALUE? VALUE))))
       ...
       (CL:SETF (%TRUTH-VALUE SELF) (PROPOSITION-TRUTH-VALUE VALUE))
       (CL:WHEN
        (CL:AND (CL:NOT (CL:EQ (%SUBCOLLECTIONS SELF) NULL))
         (CL:NOT (CL:EQ (%SUBCOLLECTIONS SELF) NIL)))
        (CL:SETF (%TRUTH-VALUE SELF)
         (CONJOIN-TRUTH-VALUES (%TRUTH-VALUE SELF)
          (%%VALUE (%%REST (%%VALUE (%SUBCOLLECTIONS SELF)))))))
       (CL:WHEN (CL:NOT (%REMOVING-DUPLICATES? SELF))
        (CL:RETURN-FROM NEXT? CL:T))
       (CL:LET*
        ((INSTANCE
          (CL:AREF (CL:THE CL:SIMPLE-VECTOR (%THE-ARRAY (%ARGUMENTS VALUE)))
           0)))
        (CL:WHEN
    ...
    (CL:LET* ((SUBCOLLECTIONS (%SUBCOLLECTIONS SELF)) (SUBCOLLECTION NULL))
     ...
     (CL:LOOP WHILE (CL:NOT (CL:EQ SUBCOLLECTIONS NIL)) DO
      ...
      (CL:IF (CL:NOT (EMPTY? (GET-DESCRIPTION-EXTENSION SUBCOLLECTION CL:T)))
   ...
   (CL:LOOP (CL:SETQ TESTGOAL (%PROPOSITION TESTFRAME))
    (CL:LET* ((TEST-VALUE-000 CL:NIL))
     ...
     (CL:WHEN TEST-VALUE-000
      ...
      (CL:WHEN TEST-VALUE-000
       (CL:SETQ TEST-VALUE-000
        (CL:EQ (%REVERSE-POLARITY? TESTFRAME) (%REVERSE-POLARITY? GOALFRAME)))
       (CL:WHEN TEST-VALUE-000
        (CL:IF
...
(CL:DEFUN FIND-DUPLICATED-GOAL (FRAME)
  (CL:LET*
   ...
   (CL:SETF (%FAILED-TO-FIND-DUPLICATE-SUBGOAL? *QUERYITERATOR*) CL:T)
   (CL:VALUES NULL NULL NULL-INTEGER)))
  ...
  (CL:COND
   ((CL:OR (CL:EQ *DUPLICATE-SUBGOAL-STRATEGY* KWD-QUERY-DUPLICATE-GOALS)
    ...
    (CL:WHEN
     ...
     (SET-FRAME-PARTIAL-TRUTH (%PARTIAL-MATCH-FRAME FRAME) NULL 0.0d0
      NULL-FLOAT CL:T))
    (CL:WHEN *RECORD-JUSTIFICATIONS?*
     (CL:LET* ((SELF-000 (NEW-PRIMITIVE-STRATEGY)))
      (CL:SETF (%INFERENCE-RULE SELF-000) KWD-QUERY-DEPTH-CUTOFF)
      (CL:SETF (%STRATEGY SELF-000) KWD-QUERY-FAILURE)
      (RECORD-GOAL-JUSTIFICATION FRAME SELF-000)))
    (CL:SETF (%STATE FRAME) KWD-QUERY-POPPED)
    (CL:SETF (%RESULT (%UP FRAME)) FRAME) (CL:SETQ FRAME (%UP FRAME))
    (CL:SETQ DEPTH (CL:1- DEPTH)))
   (CL:T
    (CL:LET*
     ((GOALFRAME NULL) (RESTARTFRAME NULL) (RESTARTDEPTH NULL-INTEGER))
...
(CL:DEFUN HANDLE-TIMEOUT (FRAME DEPTH)
  ...
  (CL:WHEN
   (CL:AND (CL:NOT (CL:EQ *TRACED-KEYWORDS* NULL))
    (MEMB? *TRACED-KEYWORDS* KWD-QUERY-GOAL-TREE))
   (%%PRINT-STREAM (%NATIVE-STREAM STANDARD-OUTPUT) "*** Timeout: start="
    (%STARTING-CLOCK-TICKS FRAME) " depth=" DEPTH EOL))
  (CL:WHEN
   (CL:AND (CL:OR *CACHE-SUCCEEDED-GOALS?* *CACHE-FAILED-GOALS?*)
    (CL:EQ *DUPLICATE-SUBGOAL-STRATEGY* KWD-QUERY-DUPLICATE-GOALS)
    (CL:NOT
  ...
  (CL:WHEN
   ...
   (CL:WHEN (CL:EQ (%PARTIAL-MATCH-FRAME FRAME) NULL)
    (CREATE-AND-LINK-PARTIAL-MATCH-FRAME FRAME NULL))
   (SET-FRAME-PARTIAL-TRUTH (%PARTIAL-MATCH-FRAME FRAME) NULL 0.0d0 NULL-FLOAT
    CL:T))
  (CL:WHEN *RECORD-JUSTIFICATIONS?*
   (CL:LET* ((SELF-000 (NEW-PRIMITIVE-STRATEGY)))
    (CL:SETF (%INFERENCE-RULE SELF-000) KWD-QUERY-TIMEOUT)
    (CL:SETF (%STRATEGY SELF-000) KWD-QUERY-FAILURE)
    (RECORD-GOAL-JUSTIFICATION FRAME SELF-000)))
  (CL:SETF (%STATE FRAME) KWD-QUERY-POPPED)
...
(CL:DEFCLASS QUERY-SOLUTION-TABLE (DICTIONARY)
  ((THE-MAP :ALLOCATION :INSTANCE :ACCESSOR %THE-MAP)
   (QUERY :ALLOCATION :INSTANCE :ACCESSOR %QUERY)
   (FIRST :ALLOCATION :INSTANCE :ACCESSOR %FIRST)
...
(CL:DEFUN NEW-QUERY-SOLUTION-TABLE ()
  (CL:LET* ((SELF NULL))
   (CL:SETQ SELF (CL:MAKE-INSTANCE (CL:QUOTE QUERY-SOLUTION-TABLE)))
   (CL:SETF (%LAST SELF) NULL) (CL:SETF (%FIRST SELF) NULL)
   (CL:SETF (%QUERY SELF) NULL)
   (CL:LET* ((SELF-000 (NEW-KEY-VALUE-MAP)))
    (CL:SETF (%EQUAL-TEST? SELF-000) CL:T) (CL:SETF (%THE-MAP SELF) SELF-000))
   SELF))
...
(CL:DEFUN ACCESS-QUERY-SOLUTION-TABLE-SLOT-VALUE (SELF SLOTNAME VALUE SETVALUE?)
  (CL:COND
   ...
   ((CL:EQ SLOTNAME SYM-QUERY-LOGIC-QUERY)
    (CL:IF SETVALUE? (CL:SETF (%QUERY SELF) VALUE)
     (CL:SETQ VALUE (%QUERY SELF))))
   ((CL:EQ SLOTNAME SYM-QUERY-STELLA-FIRST)
    (CL:IF SETVALUE? (CL:SETF (%FIRST SELF) VALUE)
     (CL:SETQ VALUE (%FIRST SELF))))
   ((CL:EQ SLOTNAME SYM-QUERY-STELLA-LAST)
    (CL:IF SETVALUE? (CL:SETF (%LAST SELF) VALUE)
     (CL:SETQ VALUE (%LAST SELF))))
   (CL:T
    (CL:LET* ((STREAM-000 (NEW-OUTPUT-STRING-STREAM)))
     (%%PRINT-STREAM (%NATIVE-STREAM STREAM-000) "`" SLOTNAME
      "' is not a valid case option")
...
(CL:DEFCLASS QUERY-SOLUTION (STANDARD-OBJECT)
  ((BINDINGS :ALLOCATION :INSTANCE :ACCESSOR %BINDINGS)
   (TRUTH-VALUE :ALLOCATION :INSTANCE :ACCESSOR %TRUTH-VALUE)
   (MATCH-SCORE :TYPE CL:DOUBLE-FLOAT :INITFORM NULL-FLOAT :ALLOCATION
    :INSTANCE :ACCESSOR %MATCH-SCORE)
...
this solution in case we have multiple ones from a partial match operation."
    :ALLOCATION :INSTANCE :ACCESSOR %ALL-JUSTIFICATIONS)
   (NEXT :ALLOCATION :INSTANCE :ACCESSOR %NEXT)))

(CL:DEFUN NEW-QUERY-SOLUTION ()
  (CL:LET* ((SELF NULL))
   (CL:SETQ SELF (CL:MAKE-INSTANCE (CL:QUOTE QUERY-SOLUTION)))
   (CL:SETF (%NEXT SELF) NULL) (CL:SETF (%ALL-JUSTIFICATIONS SELF) NULL)
   (CL:SETF (%JUSTIFICATION SELF) NULL)
   (CL:SETF (%MATCH-SCORE SELF) NULL-FLOAT) (CL:SETF (%TRUTH-VALUE SELF) NULL)
   (CL:SETF (%BINDINGS SELF) NULL) SELF))
...
(CL:DEFUN ACCESS-QUERY-SOLUTION-SLOT-VALUE (SELF SLOTNAME VALUE SETVALUE?)
  (CL:COND
   ...
   ((CL:EQ SLOTNAME SYM-QUERY-LOGIC-ALL-JUSTIFICATIONS)
    (CL:IF SETVALUE? (CL:SETF (%ALL-JUSTIFICATIONS SELF) VALUE)
     (CL:SETQ VALUE (%ALL-JUSTIFICATIONS SELF))))
  ...
  (CL:LET* ((MAP (%THE-MAP SELF)) (DUPLICATE (LOOKUP MAP KEY)))
   (CL:COND
    ((CL:NOT (CL:EQ DUPLICATE NULL))
     (CL:SETF (%TRUTH-VALUE DUPLICATE) (%TRUTH-VALUE VALUE))
    ...
    (CL:T (INSERT-AT MAP KEY VALUE)
     (CL:COND
      ((CL:EQ (%FIRST SELF) NULL) (CL:SETF (%FIRST SELF) VALUE)
       (CL:SETF (%LAST SELF) VALUE))
      (CL:T (CL:SETF (%NEXT (%LAST SELF)) VALUE)
       (CL:SETF (%LAST SELF) VALUE)))))))
...
(CL:DEFMETHOD DELETED?-SETTER ((SELF QUERY-SOLUTION) VALUE)
  (CL:IF VALUE (CL:SETF (%BINDINGS SELF) NULL)
   (CL:SETF (%BINDINGS SELF) (VECTOR)))
  VALUE)
...
if the table is empty."
  (CL:LET* ((FIRST (%FIRST SELF)))
   (CL:WHEN (CL:NOT (CL:EQ FIRST NULL)) (CL:SETF (%FIRST SELF) (%NEXT FIRST))
    (CL:WHEN (CL:EQ FIRST (%LAST SELF)) (CL:SETF (%LAST SELF) NULL))
...
(CL:DEFMETHOD CONSIFY ((SELF QUERY-SOLUTION-TABLE))
  ...
  (CL:LET* ((RESULT NIL))
   (CL:LET*
    ((SOLUTION NULL) (ITER-000 (ALLOCATE-ITERATOR SELF)) (COLLECT-000 NULL))
    (CL:LOOP WHILE (NEXT? ITER-000) DO (CL:SETQ SOLUTION (%VALUE ITER-000))
     (CL:IF (CL:EQ COLLECT-000 NULL)
...
result will be in ascending order."
  (CL:LET*
   ((THEPREDICATE
     (CL:IF (CL:NOT (CL:EQ PREDICATE NULL)) PREDICATE
      (CL:FUNCTION QUERY-SOLUTION-LESS-THAN?)))
    (SOLUTIONS (SORT (CONSIFY SELF) THEPREDICATE)) (CURRENT NULL) (NEXT NULL))
   (CL:SETF (%FIRST SELF) (%%VALUE SOLUTIONS))
   (CL:SETF (%LAST SELF) (%%VALUE SOLUTIONS))
   (CL:LOOP (CL:SETQ CURRENT (%%VALUE SOLUTIONS))
    (CL:COND
     ((CL:NOT (CL:EQ CURRENT NULL))
      (CL:SETQ NEXT (%%VALUE (%%REST SOLUTIONS)))
      (CL:SETF (%NEXT CURRENT) NEXT)
      (CL:WHEN (CL:EQ NEXT NULL) (CL:SETF (%LAST SELF) CURRENT))
...
(CL:DEFUN QUERY-SOLUTION-LESS-THAN? (X Y)
  (CL:LET*
   ((XBINDING NULL) (VECTOR-000 (%BINDINGS X)) (INDEX-000 0)
    (LENGTH-000 (LENGTH VECTOR-000)) (YBINDING NULL)
    ...
    (CL:TAGBODY
     (CL:COND ((EQL? XBINDING YBINDING) (CL:GO :CONTINUE))
      ((LOGIC-FORM-LESS? XBINDING YBINDING)
       (CL:RETURN-FROM QUERY-SOLUTION-LESS-THAN? CL:T))
...
(CL:DEFCLASS QUERY-SOLUTION-TABLE-ITERATOR (DICTIONARY-ITERATOR)
  ((THE-TABLE :ALLOCATION :INSTANCE :ACCESSOR %THE-TABLE)
   (CURSOR :ALLOCATION :INSTANCE :ACCESSOR %CURSOR)))

(CL:DEFUN NEW-QUERY-SOLUTION-TABLE-ITERATOR ()
  (CL:LET* ((SELF NULL))
   (CL:SETQ SELF (CL:MAKE-INSTANCE (CL:QUOTE QUERY-SOLUTION-TABLE-ITERATOR)))
   (CL:SETF (%FIRST-ITERATION? SELF) CL:T) (CL:SETF (%VALUE SELF) NULL)
   (CL:SETF (%KEY SELF) NULL) (CL:SETF (%CURSOR SELF) NULL)
   (CL:SETF (%THE-TABLE SELF) NULL) SELF))
...
(CL:DEFUN ACCESS-QUERY-SOLUTION-TABLE-ITERATOR-SLOT-VALUE (SELF SLOTNAME VALUE SETVALUE?)
  (CL:COND
   ((CL:EQ SLOTNAME SYM-QUERY-STELLA-THE-TABLE)
    (CL:IF SETVALUE? (CL:SETF (%THE-TABLE SELF) VALUE)
     (CL:SETQ VALUE (%THE-TABLE SELF))))
...
(CL:DEFMETHOD ALLOCATE-ITERATOR ((SELF QUERY-SOLUTION-TABLE))
  (CL:LET* ((SELF-000 (NEW-QUERY-SOLUTION-TABLE-ITERATOR)))
   (CL:SETF (%THE-TABLE SELF-000) SELF)
...
(CL:DEFMETHOD NEXT? ((SELF QUERY-SOLUTION-TABLE-ITERATOR))
  (CL:LET*
   ((TABLE (%THE-TABLE SELF)) (CURSOR (%CURSOR SELF)) (PREVIOUS CURSOR))
   (CL:COND
    ((%FIRST-ITERATION? SELF) (CL:SETQ PREVIOUS NULL)
     (CL:SETQ CURSOR (%FIRST TABLE))
     (CL:SETF (%FIRST-ITERATION? SELF) CL:NIL))
    (CL:T (CL:SETQ PREVIOUS CURSOR) (CL:SETQ CURSOR (%NEXT CURSOR))))
   (CL:LOOP WHILE (CL:AND (CL:NOT (CL:EQ CURSOR NULL)) (DELETED? CURSOR)) DO
    (CL:SETQ CURSOR (%NEXT CURSOR)))
   (CL:SETF (%CURSOR SELF) CURSOR)
   (CL:COND
    ((CL:NOT (CL:EQ CURSOR NULL))
     (CL:IF (CL:EQ PREVIOUS NULL) (CL:SETF (%FIRST TABLE) CURSOR)
      (CL:SETF (%NEXT PREVIOUS) CURSOR))
     (CL:SETF (%KEY SELF) (%BINDINGS CURSOR)) (CL:SETF (%VALUE SELF) CURSOR)
     (CL:RETURN-FROM NEXT? CL:T))
    ((CL:NOT (CL:EQ PREVIOUS NULL)) (CL:SETF (%NEXT PREVIOUS) NULL)
     (CL:SETF (%LAST TABLE) PREVIOUS)))
   CL:NIL))
...
(CL:DEFUN PRINT-CONTROL-FRAME (SELF STREAM)
  ...
  (CL:LET* ((*PRINTINFRAME* SELF)) (CL:DECLARE (CL:SPECIAL *PRINTINFRAME*))
   (CL:LET*
    ((PRINTTIMES? (CL:NOT (CL:= (%ALLOTTED-CLOCK-TICKS SELF) NULL-INTEGER))))
    (%%PRINT-STREAM STREAM " " (%STATE SELF) " " (%CURRENT-STRATEGY SELF))
    (CL:IF (CL:NOT (CL:EQ (%UP SELF) NULL))
     (%%PRINT-STREAM STREAM "  UP: " (DEBUG-FRAME-ID (%UP SELF)))
     (%%PRINT-STREAM STREAM "  UP: -"))
    (CL:IF (CL:NOT (CL:EQ (%DOWN SELF) NULL))
     (%%PRINT-STREAM STREAM "  DOWN: " (DEBUG-FRAME-ID (%DOWN SELF)))
     (%%PRINT-STREAM STREAM "  DOWN: -"))
    (%%PRINT-STREAM STREAM "  DEPTH: " (COMPUTE-FRAME-DEPTH SELF))
    (CL:WHEN
     (CL:NOT
      (CL:EQ
       (DYNAMIC-SLOT-VALUE (%DYNAMIC-SLOTS SELF) SYM-QUERY-LOGIC-DESCRIPTION
        NULL)
       NULL))
     (%%PRINT-STREAM STREAM " DESC: "
      (DYNAMIC-SLOT-VALUE (%DYNAMIC-SLOTS SELF) SYM-QUERY-LOGIC-DESCRIPTION
       NULL)))
    (CL:WHEN PRINTTIMES?
     (%%PRINT-STREAM STREAM " CLOCK: " (%CURRENT-CLOCK-TICKS *QUERYITERATOR*)
      " START: " (%STARTING-CLOCK-TICKS SELF) " TICKS: "
      (%ALLOTTED-CLOCK-TICKS SELF)))
    (%%PRINT-STREAM STREAM (CL:IF (%REVERSE-POLARITY? SELF) " ~" " ")
     (%PROPOSITION SELF) "]"))))
...
(CL:DEFUN PRINT-QUERY-ITERATOR (SELF STREAM)
  (CL:WHEN *DEBUG-MODE?* (%%PRINT-STREAM STREAM "[" (%DEBUG-ID SELF) "] "))
...
(CL:DEFUN PRINT-QUERY-ITERATOR-ORNATELY (SELF STREAM)
  (CL:LET*
   ...
   (CL:WHEN (CL:OR (%TIMEOUT? SELF) (%DEPTH-CUTOFFS? SELF))
    (%%PRINT-STREAM STREAM " (")
    (CL:WHEN (%TIMEOUT? SELF) (%%PRINT-STREAM STREAM "timeout")
     (CL:WHEN (%DEPTH-CUTOFFS? SELF) (%%PRINT-STREAM STREAM ", ")))
    (CL:WHEN (%DEPTH-CUTOFFS? SELF) (%%PRINT-STREAM STREAM "depth cutoffs"))
    (%%PRINT-STREAM STREAM ")"))
   ...
   (CL:LET* ((*PRINTREADABLY?* CL:T))
    ...
    (CL:LET*
     ...
     (CL:LOOP WHILE
      ...
      DO (CL:SETQ SOLUTION (%VALUE ITER-000)) (CL:SETQ I ITER-001)
...
(CL:DEFUN PRINT-QUERY-ITERATOR-SOLUTION-ORNATELY (SELF SOLUTION SOLUTIONNUMBER STREAM)
  ...
  (CL:WHEN (CL:= SOLUTIONNUMBER NULL-INTEGER) (CL:SETQ SOLUTIONNUMBER 0)
   (CL:LET* ((SOLUTION NULL) (ITER-000 (ALLOCATE-ITERATOR (%SOLUTIONS SELF))))
    (CL:LOOP WHILE (NEXT? ITER-000) DO (CL:SETQ SOLUTION (%VALUE ITER-000))
     (CL:WHEN (CL:NOT (EQUAL? (%BINDINGS SOLUTION) SOLUTION))
      (CL:SETQ SOLUTIONNUMBER (CL:1+ SOLUTIONNUMBER))))))
  (CL:LET* ((*PRINTREADABLY?* CL:T))
   (CL:DECLARE (CL:SPECIAL *PRINTREADABLY?*))
   (%%PRINT-STREAM STREAM "  #" SOLUTIONNUMBER ": ")
   (CL:LET*
    ((VALUE NULL) (VECTOR-000 (%BINDINGS SOLUTION)) (INDEX-000 0)
     (LENGTH-000 (LENGTH VECTOR-000)) (VARIABLE NULL)
     (VECTOR-001 (%EXTERNAL-VARIABLES SELF)) (INDEX-001 0)
     (LENGTH-001 (LENGTH VECTOR-001)) (VI NULL-INTEGER) (ITER-001 0))
    (CL:DECLARE
    ...
    (CL:LOOP WHILE
     ...
     (%%PRINT-STREAM STREAM (CL:IF (CL:= VI 0) "" ", ")
      (%SKOLEM-NAME VARIABLE) "=" VALUE)
     (CL:SETQ INDEX-000 (CL:1+ INDEX-000))
     (CL:SETQ INDEX-001 (CL:1+ INDEX-001))
     (CL:SETQ ITER-001 (CL:1+ ITER-001))))
   (CL:WHEN
    (CL:AND (CL:NOT (CL:EQ (%PARTIAL-MATCH-STRATEGY SELF) NULL))
     (CL:NOT (CL:= (%MATCH-SCORE SOLUTION) NULL-FLOAT)))
...
(CL:DEFUN TRACE-SOLUTION (SELF SOLUTION SOLUTIONNUMBER)
  ...
  (CL:WHEN (TRACE-KEYWORD? KWD-QUERY-TRACE-SOLUTIONS)
   (%%PRINT-STREAM (%NATIVE-STREAM STANDARD-OUTPUT) "SOLUTION ")
   (PRINT-QUERY-ITERATOR-SOLUTION-ORNATELY SELF SOLUTION SOLUTIONNUMBER
    (%NATIVE-STREAM STANDARD-OUTPUT))
   (%%PRINT-STREAM (%NATIVE-STREAM STANDARD-OUTPUT) EOL)))
...
(CL:DEFUN PRINT-QUERY-ITERATOR-READABLY (SELF STREAM)
  (CL:LET*
   ...
   (%%PRINT-STREAM STREAM "(")
   (CL:LET*
    ((SOLUTION NULL) (ITER-000 (ALLOCATE-ITERATOR SOLUTIONS)) (I NULL-INTEGER)
     (ITER-001 1) (UPPER-BOUND-000 *PRINTLENGTH*)
     (UNBOUNDED?-000 (CL:= UPPER-BOUND-000 NULL-INTEGER)))
    (CL:DECLARE (CL:TYPE CL:FIXNUM I ITER-001 UPPER-BOUND-000))
    (CL:LOOP WHILE
     (CL:AND (NEXT? ITER-000)
     ...
     (CL:LET*
      ((VALUE NULL) (VECTOR-000 (%BINDINGS SOLUTION)) (INDEX-000 0)
       (LENGTH-000 (LENGTH VECTOR-000)) (VI NULL-INTEGER) (ITER-002 0))
      ...
      (CL:LOOP WHILE (CL:< INDEX-000 LENGTH-000) DO
       ...
       (CL:SETQ ITER-002 (CL:1+ ITER-002))))
     (CL:WHEN (CL:NOT ATOMICSINGLETONS?) (%%PRINT-STREAM STREAM ")"))
     (CL:WHEN (CL:AND (CL:= I *PRINTLENGTH*) (CL:< I (LENGTH SOLUTIONS)))
      (%%PRINT-STREAM STREAM " ..."))
     (CL:SETQ ITER-001 (CL:1+ ITER-001))))
   (%%PRINT-STREAM STREAM ")" EOL)))
...
(CL:DEFUN ALLOCATE-COLLECTION-VARIABLES (FRAME DESCRIPTION)
  (CL:LET*
   ...
   (CL:DECLARE (CL:TYPE CL:FIXNUM VARIABLESCOUNT))
   (CL:LET*
    ((IOVAR NULL) (VECTOR-000 (%IO-VARIABLES DESCRIPTION)) (INDEX-000 0)
     (LENGTH-000 (LENGTH VECTOR-000)) (I NULL-INTEGER) (ITER-000 0))
    (CL:DECLARE (CL:TYPE CL:FIXNUM INDEX-000 LENGTH-000 I ITER-000))
    (CL:LOOP WHILE (CL:< INDEX-000 LENGTH-000) DO
     (CL:SETQ IOVAR
     ...
     (CL:LET
      ((SELF (%THE-ARRAY EXTERNALVARIABLES))
       (VALUE
        (CREATE-VARIABLE (%SKOLEM-TYPE IOVAR) (%SKOLEM-NAME IOVAR) CL:NIL))
       (POSITION I))
      (CL:DECLARE (CL:TYPE CL:SIMPLE-VECTOR SELF)
       (CL:TYPE CL:FIXNUM POSITION))
      (CL:SETF (CL:AREF SELF POSITION) VALUE))
     (CL:SETF
      (%BOUND-TO-OFFSET
       (CL:AREF (CL:THE CL:SIMPLE-VECTOR (%THE-ARRAY EXTERNALVARIABLES)) I))
      I)
     (CL:SETQ INDEX-000 (CL:1+ INDEX-000))
     (CL:SETQ ITER-000 (CL:1+ ITER-000))))
...
(CL:DEFUN CREATE-QUERY-ITERATOR (DESCRIPTION OUTSIDEBINDINGS DEBUGID)
  (CL:DECLARE (CL:TYPE CL:SIMPLE-STRING DEBUGID))
  #+MCL
  (CL:CHECK-TYPE DEBUGID CL:SIMPLE-STRING)
  (INITIALIZE-QUERY-ITERATOR (ALLOCATE-QUERY-ITERATOR) DESCRIPTION
   OUTSIDEBINDINGS DEBUGID))

;;; (DEFUN (INITIALIZE-QUERY-ITERATOR QUERY-ITERATOR) ...)

(CL:DEFUN INITIALIZE-QUERY-ITERATOR (QUERYITERATOR DESCRIPTION OUTSIDEBINDINGS DEBUGID)
  (CL:DECLARE (CL:TYPE CL:SIMPLE-STRING DEBUGID))
  #+MCL
  (CL:CHECK-TYPE DEBUGID CL:SIMPLE-STRING)
  (CL:LET* ((BASECONTROLFRAME (NEW-CONTROL-FRAME)) (EXTERNALVARIABLES NULL))
   (CL:LET*
    ((*QUERYITERATOR* QUERYITERATOR) (*EVALUATIONMODE* KWD-QUERY-DESCRIPTION))
    ...
    (CL:WHEN (TEST-QUERY-OPTION? QUERYITERATOR KWD-QUERY-DONT-OPTIMIZE?)
     (SET-DYNAMIC-SLOT-VALUE (%DYNAMIC-SLOTS DESCRIPTION)
      SYM-QUERY-LOGIC-DONT-OPTIMIZE? TRUE-WRAPPER FALSE-WRAPPER)
     (SET-DYNAMIC-SLOT-VALUE (%DYNAMIC-SLOTS (%PROPOSITION DESCRIPTION))
      SYM-QUERY-LOGIC-DONT-OPTIMIZE? TRUE-WRAPPER FALSE-WRAPPER))
    ...
    (CL:SETF (%AUGMENTED-GOAL-CACHE? QUERYITERATOR) CL:NIL)
    (CLEAR (%ACTIVE-GOAL-CACHES QUERYITERATOR))
    (CL:WHEN
     (CL:AND *ITERATIVE-DEEPENING-MODE?*
      (CL:NOT
       (TEST-QUERY-OPTION? QUERYITERATOR KWD-QUERY-ITERATIVE-DEEPENING?)))
     (SET-DYNAMIC-SLOT-VALUE (%DYNAMIC-SLOTS QUERYITERATOR)
      SYM-QUERY-LOGIC-ITERATIVE-DEEPENING? TRUE-WRAPPER FALSE-WRAPPER))
...
(CL:DEFMETHOD NEXT? ((SELF QUERY-ITERATOR))
  ...
  (CL:LET* ((BASEFRAME (%BASE-CONTROL-FRAME SELF)))
   (CL:LET* ((SELF-000 (NEW-QUERY-SOLUTION)))
    (CL:SETF (%BINDINGS SELF-000)
     (NEW-VECTOR (LENGTH (%EXTERNAL-VARIABLES SELF))))
    (CL:SETF (%TRUTH-VALUE SELF-000) UNKNOWN-TRUTH-VALUE)
    (CL:LET* ((SOLUTION SELF-000) (DUPLICATE NULL))
     (CL:SETF (%VALUE SELF) SOLUTION)
     ...
     (CL:LOOP
      (CL:LET*
       ...
       (CL:DECLARE (CL:SPECIAL *CONTEXT* *MODULE*))
       (CL:LOOP
        (CL:TAGBODY (CLEAR (%BINDINGS SOLUTION))
         (CL:SETF (%TRUTH-VALUE SOLUTION) UNKNOWN-TRUTH-VALUE)
         (CL:SETF (%JUSTIFICATION SOLUTION) NULL)
         (CL:SETF (%MATCH-SCORE SOLUTION) NULL-FLOAT)
         (CL:WHEN (CL:NOT (EXECUTE-BACKWARD-CHAINING-PROOF? SELF))
          (CL:RETURN))
         (CL:LET*
          ((EV NULL) (VECTOR-000 (%EXTERNAL-VARIABLES SELF)) (INDEX-000 0)
           (LENGTH-000 (LENGTH VECTOR-000)) (I NULL-INTEGER) (ITER-000 0))
          (CL:DECLARE (CL:TYPE CL:FIXNUM INDEX-000 LENGTH-000 I ITER-000))
          (CL:LOOP WHILE (CL:< INDEX-000 LENGTH-000) DO
           (CL:SETQ EV
          ...
          (CL:SETF (%MATCH-SCORE SOLUTION)
           (CL:IF
            (CL:AND (CL:NOT (CL:EQ (%PARTIAL-MATCH-FRAME BASEFRAME) NULL))
             (CL:OR
              (CL:NOT
               (CL:= (%POSITIVE-SCORE (%PARTIAL-MATCH-FRAME BASEFRAME))
                NULL-FLOAT))
              (CL:NOT
               (CL:= (%NEGATIVE-SCORE (%PARTIAL-MATCH-FRAME BASEFRAME))
                NULL-FLOAT))))
         ...
         (CL:WHEN (TEST-QUERY-OPTION? *QUERYITERATOR* KWD-QUERY-FOUR-VALUED?)
          (CL:LET* ((ANSWER CL:NIL) (NEGATIVE-JUSTIFICATION NULL))
           (CL:MULTIPLE-VALUE-SETQ (ANSWER NEGATIVE-JUSTIFICATION)
            (TRY-TO-DEFEAT-LAST-ANSWER? SELF))
           (CL:WHEN ANSWER
            (CL:IF (QUERY-IS-TRUE-FALSE? SELF)
             (CL:PROGN
              (CL:SETF (%TRUTH-VALUE SOLUTION) INCONSISTENT-TRUTH-VALUE)
              (CL:WHEN *RECORD-JUSTIFICATIONS?*
               (CL:SETF (%JUSTIFICATION SOLUTION)
                (CREATE-CLASH-JUSTIFICATION (%PROPOSITION BASEFRAME)
                 (CONS-LIST (%JUSTIFICATION SOLUTION) NEGATIVE-JUSTIFICATION)
                 KWD-QUERY-BACKWARD)))
              (CL:SETF (%TRUTH-VALUE BASEFRAME) INCONSISTENT-TRUTH-VALUE)
              (SET-DYNAMIC-SLOT-VALUE (%DYNAMIC-SLOTS BASEFRAME)
               SYM-QUERY-LOGIC-JUSTIFICATION (%JUSTIFICATION SOLUTION) NULL)
         ...
         (SET-DYNAMIC-SLOT-VALUE (%DYNAMIC-SLOTS BASEFRAME)
          SYM-QUERY-LOGIC-JUSTIFICATION (%JUSTIFICATION SOLUTION) NULL)
         (INSERT-AT (%SOLUTIONS SELF) (%BINDINGS SOLUTION) SOLUTION)
         (CL:SETF (%VALUE SELF) SOLUTION) (CL:SETF (%EXHAUSTED? SELF) CL:NIL)
         (CL:RETURN-FROM NEXT? CL:T) :CONTINUE)))
      (CL:COND ((%TIMEOUT? SELF) (CL:RETURN-FROM NEXT? CL:NIL))
...
(CL:DEFUN TRY-TO-DEFEAT-LAST-ANSWER? (SELF)
  (CL:LET*
   ((NEGATEDQUERY
    ...
    (QUERYCONTEXT (%QUERY-CONTEXT SELF)) (STRICTPOSITIVEANSWER? CL:NIL)
    (STRICTNEGATIVEANSWER? CL:NIL) (DEFEATED? CL:NIL)
    (NEGATIVEJUSTIFICATION NULL))
   (CL:COND
    ((CL:EQ NEGATEDQUERY NULL)
     (CL:SETQ NEGATEDQUERY
      (CREATE-QUERY-ITERATOR (QUERY-DESCRIPTION SELF)
       (%BINDINGS (%VALUE SELF)) "negatedQuery"))
     (CL:SETF (%QUERY-CONTEXT NEGATEDQUERY) QUERYCONTEXT))
    (CL:T
     (CL:WHEN
      (CL:EQ SELF
       (DYNAMIC-SLOT-VALUE (%DYNAMIC-SLOTS NEGATEDQUERY)
        SYM-QUERY-LOGIC-AUXILIARY-QUERY NULL))
      (CL:RETURN-FROM TRY-TO-DEFEAT-LAST-ANSWER? (CL:VALUES CL:NIL NULL)))
     (SET-DYNAMIC-SLOT-VALUE (%DYNAMIC-SLOTS NEGATEDQUERY)
      SYM-QUERY-LOGIC-INITIAL-BINDINGS (%BINDINGS (%VALUE SELF)) NULL)))
   (SET-DYNAMIC-SLOT-VALUE (%DYNAMIC-SLOTS SELF)
    SYM-QUERY-LOGIC-AUXILIARY-QUERY NEGATEDQUERY NULL)
   (SET-DYNAMIC-SLOT-VALUE (%DYNAMIC-SLOTS NEGATEDQUERY)
    SYM-QUERY-LOGIC-AUXILIARY-QUERY SELF NULL)
   (CL:SETF (%REVERSE-POLARITY? (%BASE-CONTROL-FRAME NEGATEDQUERY)) CL:T)
   (RESET NEGATEDQUERY)
   (CL:WHEN
    (CL:AND (CL:NOT (CL:EQ *TRACED-KEYWORDS* NULL))
     (MEMB? *TRACED-KEYWORDS* KWD-QUERY-GOAL-TREE))
   ...
   (CL:WHEN (NEXT? NEGATEDQUERY) (RESET NEGATEDQUERY)
    (CL:LET* ((*DONTUSEDEFAULTKNOWLEDGE?* CL:T))
     ...
     (CL:SETQ NEGATIVEJUSTIFICATION
      (DYNAMIC-SLOT-VALUE (%DYNAMIC-SLOTS (%BASE-CONTROL-FRAME NEGATEDQUERY))
       SYM-QUERY-LOGIC-JUSTIFICATION NULL)))
    (CL:SETF (%REVERSE-POLARITY? (%BASE-CONTROL-FRAME NEGATEDQUERY)) CL:NIL)
    (RESET NEGATEDQUERY)
    (CL:LET* ((*DONTUSEDEFAULTKNOWLEDGE?* CL:T))
     (CL:DECLARE (CL:SPECIAL *DONTUSEDEFAULTKNOWLEDGE?*))
     (CL:WHEN
    ...
    (CL:IF STRICTPOSITIVEANSWER?
     (CL:IF STRICTNEGATIVEANSWER?
      (CL:LET* ((*QUERYITERATOR* NEGATEDQUERY))
       (CL:DECLARE (CL:SPECIAL *QUERYITERATOR*)) (CL:SETQ DEFEATED? CL:T))
...
(CL:DEFMETHOD RESET ((SELF QUERY-ITERATOR))
  ...
  (CL:LET* ((INITIALFRAME (%BASE-CONTROL-FRAME SELF)))
   ...
   (CL:LET* ((PATTERNRECORD (%PATTERN-RECORD INITIALFRAME)))
    (CL:SETF (%CURRENT-PATTERN-RECORD SELF) PATTERNRECORD)
     ...
     (CL:WHEN
      (CL:NOT
       (CL:EQ
        ...
        NULL))
      (CL:LET*
       ((ARG NULL) (VECTOR-000 (%EXTERNAL-VARIABLES SELF)) (INDEX-000 0)
        (LENGTH-000 (LENGTH VECTOR-000)) (VALUE NULL)
        (VECTOR-001
         (DYNAMIC-SLOT-VALUE (%DYNAMIC-SLOTS SELF)
          SYM-QUERY-LOGIC-INITIAL-BINDINGS NULL))
       ...
       (CL:LOOP WHILE
        ...
        (CL:WHEN (CL:NOT (CL:EQ VALUE NULL))
         (CL:WHEN (CL:NOT (BIND-ARGUMENT-TO-VALUE? ARG VALUE CL:NIL))
          (CL:LET* ((STREAM-000 (NEW-OUTPUT-STRING-STREAM)))
           (%%PRINT-STREAM (%NATIVE-STREAM STREAM-000) "reset: binding of `"
            ARG "' to `" VALUE "' failed.")
           (CL:ERROR (NEW-FAIL-EXCEPTION (THE-STRING-READER STREAM-000))))))
        (CL:SETQ INDEX-000 (CL:1+ INDEX-000))
        (CL:SETQ INDEX-001 (CL:1+ INDEX-001)))))
     (OVERLAY-WITH-PATTERN-FRAME? INITIALFRAME (%DESCRIPTION PATTERNRECORD)
      (%EXTERNAL-ARGUMENTS PATTERNRECORD))))
   (CL:SETF (%EXHAUSTED? SELF) CL:NIL) (CL:SETF (%TIMEOUT? SELF) CL:NIL)
   (CL:SETF (%DEPTH-CUTOFFS? SELF) CL:NIL) (CLEAR (%SOLUTIONS SELF))
   (CL:SETF (%TRUTH-VALUE INITIALFRAME) NULL)
   (CL:SETF (%AUGMENTED-GOAL-CACHE? SELF) CL:NIL)
   (CL:SETF (%TRIGGERED-DEPTH-CUTOFF? SELF) CL:NIL)))
...
(CL:DEFUN MAKE-QUERY (IOVARIABLES QUERYTREE EXTERNALBINDINGS OPTIONS DEBUGID)
  (CL:DECLARE (CL:TYPE CL:SIMPLE-STRING DEBUGID))
  #+MCL
  (CL:CHECK-TYPE DEBUGID CL:SIMPLE-STRING)
  (FINALIZE-OBJECTS)
  ...
  (CL:LET*
   ...
   (CL:WHEN
    ...
    (SET-DYNAMIC-SLOT-VALUE (%DYNAMIC-SLOTS QUERY)
     SYM-QUERY-LOGIC-ATOMIC-SINGLETONS? TRUE-WRAPPER FALSE-WRAPPER))
   (CL:LET*
    ((*EVALUATIONMODE* KWD-QUERY-DESCRIPTION) (*LOGICVARIABLETABLE* NIL)
     (*TERMUNDERCONSTRUCTION* PREFIXQUERYTREE) (*QUERYITERATOR* NULL))
    (CL:DECLARE
     (CL:SPECIAL *EVALUATIONMODE* *LOGICVARIABLETABLE* *TERMUNDERCONSTRUCTION*
      *QUERYITERATOR*))
   ...
   (INITIALIZE-QUERY-ITERATOR QUERY DESCRIPTION EXTERNALVECTOR DEBUGID)))
...
(CL:DEFUN PARSE-QUERY-AND-OPTIONS (|QUERY&OPTIONS|)
  ...
  (CL:LET*
   ((FIRSTARG (%%VALUE |QUERY&OPTIONS|)) (VARIABLES NULL) (PROPOSITION NULL)
    (OPTIONS (NEW-PROPERTY-LIST)) (HANDLENONMATCHINGVARIABLES? CL:NIL)
    (FREEVARIABLES NULL) (DECLAREDVARIABLES NULL))
   ...
   (CL:WHEN (CONS? PROPOSITION) (CL:SETQ FREEVARIABLES (NEW-LIST))
    ...
    (CL:COND
     ...
     ((CL:NOT
       (EQUIVALENT-SETS? (%THE-CONS-LIST FREEVARIABLES) DECLAREDVARIABLES))
    ...
    (CL:WHEN (CL:NOT (KEYWORD? (%%VALUE |QUERY&OPTIONS|)))
     (CL:LET* ((STREAM-000 (NEW-OUTPUT-STRING-STREAM)))
      (CL:LET* ((*PRINTREADABLY?* CL:T))
       (CL:DECLARE (CL:SPECIAL *PRINTREADABLY?*))
       (%%PRINT-STREAM (%NATIVE-STREAM STREAM-000)
        "PARSING ERROR: Illegal query option: `" (%%VALUE |QUERY&OPTIONS|)
        "'." EOL)
       (HELP-SIGNAL-PROPOSITION-ERROR STREAM-000 KWD-QUERY-ERROR))
      (CL:ERROR (NEW-PARSING-ERROR (THE-STRING-READER STREAM-000)))))
     ...
     (CL:LET* ((STREAM-001 (NEW-OUTPUT-STRING-STREAM)))
      (CL:LET* ((*PRINTREADABLY?* CL:T))
       ...
       (%%PRINT-STREAM (%NATIVE-STREAM STREAM-001)
        "PARSING ERROR: Missing value for option `" (%%VALUE |QUERY&OPTIONS|)
        "'." EOL)
   ...
   (CL:WHEN HANDLENONMATCHINGVARIABLES?
    (CL:LET* ((TEMP-000 (LOOKUP OPTIONS KWD-QUERY-CHECK-VARIABLES?)))
     (CL:IF
      (COERCE-WRAPPED-BOOLEAN-TO-BOOLEAN
       (COERCE-TO-BOOLEAN
        (CL:IF (CL:NOT (CL:EQ TEMP-000 NULL)) TEMP-000 FALSE-WRAPPER)))
      (CL:LET* ((STREAM-002 (NEW-OUTPUT-STRING-STREAM)))
       (CL:LET* ((*PRINTREADABLY?* CL:T))
        ...
        (%%PRINT-STREAM (%NATIVE-STREAM STREAM-002)
         ...
         (%THE-CONS-LIST FREEVARIABLES) "' referenced in the query body." EOL
         "   To simply use the free variables, omit the declaration." EOL)
        (HELP-SIGNAL-PROPOSITION-ERROR STREAM-002 KWD-QUERY-ERROR))
       (CL:ERROR (NEW-PARSING-ERROR (THE-STRING-READER STREAM-002))))
      (CL:SETQ PROPOSITION
       (LIST* SYM-QUERY-STELLA-EXISTS
        (DIFFERENCE (%THE-CONS-LIST FREEVARIABLES) DECLAREDVARIABLES)
...
(CL:DEFUN PROCESS-QUERY-OPTIONS (QUERY OPTIONS)
  (CL:LET* ((THEOPTIONS (VET-OPTIONS OPTIONS NULL)) (DEFERREDOPTIONS NULL))
   (CL:SETF (%OPTIONS QUERY) THEOPTIONS)
    ...
    (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-000 NIL)) DO
     ...
     (CL:LET* ((TEST-VALUE-000 KEY))
      (CL:COND
        ...
        (CL:LET* ((TEST-VALUE-001 (SAFE-PRIMARY-TYPE VALUE)))
         (CL:COND
          ((SUBTYPE-OF-INTEGER? TEST-VALUE-001)
           (CL:PROGN
            (CL:SETF (%ALLOTTED-TIME QUERY) (NUMBER-WRAPPER-TO-FLOAT VALUE))
        ...
        (CL:LET* ((TEST-VALUE-002 (SAFE-PRIMARY-TYPE VALUE)))
         (CL:COND
          ((SUBTYPE-OF-INTEGER? TEST-VALUE-002)
           (CL:PROGN
            (CL:SETF (%ALLOTTED-CLOCK-TICKS QUERY)
             (FLOOR (%WRAPPER-VALUE VALUE)))
            (INSERT-AT THEOPTIONS KEY
             (WRAP-INTEGER (FLOOR (%WRAPPER-VALUE VALUE))))))
          ...
          (CL:T
           (CL:LET* ((STREAM-001 (NEW-OUTPUT-STRING-STREAM)))
            (CL:LET* ((*PRINTREADABLY?* CL:T))
             (CL:DECLARE (CL:SPECIAL *PRINTREADABLY?*))
             (%%PRINT-STREAM (%NATIVE-STREAM STREAM-001)
              "PARSING ERROR: Illegal :MOVEOUT value: `" VALUE "'." EOL)
             (HELP-SIGNAL-PROPOSITION-ERROR STREAM-001 KWD-QUERY-ERROR))
            (CL:ERROR (NEW-PARSING-ERROR (THE-STRING-READER STREAM-001))))))))
          ...
          (CL:T
           (CL:LET* ((STREAM-002 (NEW-OUTPUT-STRING-STREAM)))
            (CL:LET* ((*PRINTREADABLY?* CL:T))
             (CL:DECLARE (CL:SPECIAL *PRINTREADABLY?*))
             (%%PRINT-STREAM (%NATIVE-STREAM STREAM-002)
              "PARSING ERROR: Illegal :MAXIMUM-DEPTH value: `" VALUE "'." EOL)
             (HELP-SIGNAL-PROPOSITION-ERROR STREAM-002 KWD-QUERY-ERROR))
            (CL:ERROR (NEW-PARSING-ERROR (THE-STRING-READER STREAM-002))))))))
        ...
        (CL:LET* ((TEST-VALUE-004 (SAFE-PRIMARY-TYPE VALUE)))
         (CL:COND
          ((SUBTYPE-OF? TEST-VALUE-004 SGT-QUERY-STELLA-GENERALIZED-SYMBOL)
           (CL:PROGN
            (INSERT-AT THEOPTIONS KEY (KEYWORDIFY (COERCE-TO-STRING VALUE)))
       ...
       ((CL:EQ TEST-VALUE-000 KWD-QUERY-FOUR-VALUED?)
        (CL:SETQ VALUE (COERCE-TO-BOOLEAN VALUE))
        (INSERT-AT THEOPTIONS KEY VALUE))
       ((CL:EQ TEST-VALUE-000 KWD-QUERY-ITERATIVE-DEEPENING?)
        ...
        (CL:WHEN (EQL? VALUE TRUE-WRAPPER)
         (SET-DYNAMIC-SLOT-VALUE (%DYNAMIC-SLOTS QUERY)
          SYM-QUERY-LOGIC-ITERATIVE-DEEPENING? TRUE-WRAPPER FALSE-WRAPPER)))
       ((CL:OR (CL:EQ TEST-VALUE-000 KWD-QUERY-SINGLETONS?)
         (CL:EQ TEST-VALUE-000 KWD-QUERY-ATOMIC-SINGLETONS?))
       ...
       ((CL:EQ TEST-VALUE-000 KWD-QUERY-DONT-OPTIMIZE?)
        (CL:SETQ VALUE (COERCE-TO-BOOLEAN VALUE))
        (INSERT-AT THEOPTIONS KEY VALUE))
       ((CL:EQ TEST-VALUE-000 KWD-QUERY-ALL-PROOFS?)
        (CL:SETQ VALUE (COERCE-TO-BOOLEAN VALUE))
        (INSERT-AT THEOPTIONS KEY VALUE))
       ((CL:EQ TEST-VALUE-000 KWD-QUERY-CHECK-VARIABLES?)
        (CL:SETQ VALUE (COERCE-TO-BOOLEAN VALUE))
        (INSERT-AT THEOPTIONS KEY VALUE))
              ...
              (CL:LET* ((STREAM-004 (NEW-OUTPUT-STRING-STREAM)))
               (CL:LET* ((*PRINTREADABLY?* CL:T))
                ...
                (%%PRINT-STREAM (%NATIVE-STREAM STREAM-004)
                 "PARSING ERROR: Illegal :HOW-MANY value: `" VALUE "'." EOL)
                (HELP-SIGNAL-PROPOSITION-ERROR STREAM-004 KWD-QUERY-ERROR))
               (CL:ERROR
                (NEW-PARSING-ERROR (THE-STRING-READER STREAM-004))))))))
          (CL:T
          ...
          (CL:PROGN
           (CL:COND
            ...
            ((STRING-EQL? (%SYMBOL-NAME VALUE) "VALUES")
             (INSERT-AT THEOPTIONS KEY KWD-QUERY-VALUES))
         ...
         (CL:COND
          ...
          (CL:T
           (CL:LET* ((STREAM-008 (NEW-OUTPUT-STRING-STREAM)))
            (CL:LET* ((*PRINTREADABLY?* CL:T))
             (CL:DECLARE (CL:SPECIAL *PRINTREADABLY?*))
             (%%PRINT-STREAM (%NATIVE-STREAM STREAM-008)
              "PARSING ERROR: Illegal :MATCH-MODE value: `" VALUE "'." EOL)
        ...
        (CL:LET* ((TEST-VALUE-007 (SAFE-PRIMARY-TYPE VALUE)))
         (CL:COND
          ((SUBTYPE-OF-INTEGER? TEST-VALUE-007)
           (CL:PROGN
            (INSERT-AT THEOPTIONS KEY
             (WRAP-FLOAT (CL:FLOAT (%WRAPPER-VALUE VALUE) 0.0d0)))))
          ((SUBTYPE-OF-FLOAT? TEST-VALUE-007) (CL:PROGN))
          (CL:T
           (CL:LET* ((STREAM-009 (NEW-OUTPUT-STRING-STREAM)))
            (CL:LET* ((*PRINTREADABLY?* CL:T))
             (CL:DECLARE (CL:SPECIAL *PRINTREADABLY?*))
             (%%PRINT-STREAM (%NATIVE-STREAM STREAM-009)
              "PARSING ERROR: Illegal :MINIMUM-SCORE value: `" VALUE "'." EOL)
        ...
        (CL:LET* ((TEST-VALUE-008 (SAFE-PRIMARY-TYPE VALUE)))
         (CL:COND ((SUBTYPE-OF-INTEGER? TEST-VALUE-008) (CL:PROGN))
          ((SUBTYPE-OF-FLOAT? TEST-VALUE-008)
           (CL:PROGN
            (INSERT-AT THEOPTIONS KEY
             (WRAP-INTEGER (CL:TRUNCATE (%WRAPPER-VALUE VALUE))))))
          (CL:T
           (CL:LET* ((STREAM-010 (NEW-OUTPUT-STRING-STREAM)))
            (CL:LET* ((*PRINTREADABLY?* CL:T))
             (CL:DECLARE (CL:SPECIAL *PRINTREADABLY?*))
             (%%PRINT-STREAM (%NATIVE-STREAM STREAM-010)
...
(CL:DEFUN LOOKUP-DEFERRED-QUERY-OPTION (QUERYOROPTIONS KEY COERCETOTYPE)
  (CL:LET*
   ((OPTIONS NULL) (DEFERREDOPTIONS NULL) (VALUE NULL) (COERCEDVALUE NULL)
    (PROCESSEDDEFERREDOPTION? CL:NIL))
   (CL:LET* ((TEST-VALUE-000 (SAFE-PRIMARY-TYPE QUERYOROPTIONS)))
    (CL:COND
     ((SUBTYPE-OF? TEST-VALUE-000 SGT-QUERY-STELLA-PROPERTY-LIST)
      (CL:PROGN (CL:SETQ OPTIONS QUERYOROPTIONS)))
    ...
    ((CL:EQ TEST-VALUE-000 SGT-QUERY-STELLA-CONS)
     (CL:PROGN
      (CL:LET* ((IOVARIABLES NULL) (PROPOSITION NULL) (OPTIONS NULL))
       ...
       (CL:IF
        (CL:AND (CL:EQ IOVARIABLES NULL) (CL:NOT (CL:EQ PROPOSITION NULL)))
        (MAKE-QUERY NIL PROPOSITION NIL OPTIONS "Ask")
        (CL:LET* ((STREAM-000 (NEW-OUTPUT-STRING-STREAM)))
         (CL:LET* ((*PRINTREADABLY?* CL:T))
          (CL:DECLARE (CL:SPECIAL *PRINTREADABLY?*))
          (%%PRINT-STREAM (%NATIVE-STREAM STREAM-000)
...
queries and logical expressions."
  (CL:LET*
   ((*QUERYITERATOR* (CREATE-ASK-QUERY QUERY)) (*REVERSEPOLARITY?* CL:NIL)
   ...
   (CL:LET*
    ((TRUTH-VALUE NULL)
     ...
     (FOURVALUEDASK?
      (TEST-QUERY-OPTION? *QUERYITERATOR* KWD-QUERY-FOUR-VALUED?)))
    ...
    (CL:WHEN
     (CL:AND
      (CL:OR (CL:EQ TRUTH-VALUE UNKNOWN-TRUTH-VALUE) (CL:EQ TRUTH-VALUE NULL))
      (CL:OR THREEVALUEDASK? FOURVALUEDASK?))
     (CL:SETF (%REVERSE-POLARITY? (%BASE-CONTROL-FRAME *QUERYITERATOR*)) CL:T)
     (RESET *QUERYITERATOR*) (NEXT? *QUERYITERATOR*)
     (CL:LET*
      ((TEMP-001 (%TRUTH-VALUE (%BASE-CONTROL-FRAME *QUERYITERATOR*))))
      (CL:SETQ TRUTH-VALUE
       (CL:IF (CL:NOT (CL:EQ TEMP-001 NULL)) TEMP-001 UNKNOWN-TRUTH-VALUE))))
    TRUTH-VALUE)))
      ...
      (CL:PROGN
       (CL:SETQ THEQUERY
        (MAKE-QUERY (%%VALUE QUERY) (%%VALUE (%%REST QUERY)) NIL
         (%%REST (%%REST QUERY)) "Obsolete"))))
     (CL:T
      (CL:LET* ((STREAM-000 (NEW-OUTPUT-STRING-STREAM)))
       (%%PRINT-STREAM (%NATIVE-STREAM STREAM-000) "`" TEST-VALUE-000
        "' is not a valid case option")
       (CL:ERROR (NEW-STELLA-EXCEPTION (THE-STRING-READER STREAM-000)))))))
   (INSERT-AT (%OPTIONS THEQUERY) KWD-QUERY-HOW-MANY
       ...
       (CL:COND
        ...
        ((CL:EQ IOVARIABLES NULL)
         (CL:LET* ((STREAM-001 (NEW-OUTPUT-STRING-STREAM)))
          ...
          (CL:ERROR (NEW-PARSING-ERROR (THE-STRING-READER STREAM-001)))))
        (CL:T
         (MAKE-QUERY IOVARIABLES QUERYPROPOSITION NIL OPTIONS "Retrieve"))))))
    (CL:T
     (CL:LET* ((STREAM-002 (NEW-OUTPUT-STRING-STREAM)))
      (CL:LET* ((*PRINTREADABLY?* CL:T))
       (CL:DECLARE (CL:SPECIAL *PRINTREADABLY?*))
  ...
  (CL:LET*
   ...
   (CL:LET*
    ((*QUERYITERATOR* THEQUERY) (*REVERSEPOLARITY?* CL:NIL)
     (*INFERENCELEVEL* (CURRENT-INFERENCE-LEVEL))
     (*GENERATE-ALL-PROOFS?*
      (TEST-QUERY-OPTION? THEQUERY KWD-QUERY-ALL-PROOFS?)))
    (CL:DECLARE
     (CL:SPECIAL *QUERYITERATOR* *REVERSEPOLARITY?* *INFERENCELEVEL*
      *GENERATE-ALL-PROOFS?*))
    (CL:LET*
    ...
    (CL:LET* ((SORTOPTION (LOOKUP-QUERY-OPTION THEQUERY KWD-QUERY-SORT-BY)))
     (CL:COND
      ((CL:OR (CL:EQ SORTOPTION KWD-QUERY-VALUES)
        (CL:EQ SORTOPTION KWD-QUERY-VALUES-ASCENDING))
      ...
      ((CL:EQ SORTOPTION KWD-QUERY-VALUES-DESCENDING)
       (SORT (%SOLUTIONS THEQUERY)
        (CL:FUNCTION QUERY-SOLUTION-GREATER-THAN?)))
      (CL:T)))
    *QUERYITERATOR*)))
...
list of lists for tuples of arity=1."
  (CL:LET*
   ((SOLUTIONS (%SOLUTIONS SELF)) (LISTIFIEDSOLUTIONS NIL)
...
(CL:DEFMETHOD LISTIFY ((SELF QUERY-ITERATOR))
  ...
  (CL:LET* ((SELF-000 (NEW-LIST)))
   (CL:SETF (%THE-CONS-LIST SELF-000) (CONSIFY SELF))
   (CL:LET* ((VALUE-000 SELF-000)) VALUE-000)))
...
(CL:DEFUN FIND-CACHED-QUERY (QUERYID)
  (CL:LET* ((QUERIES (LOOKUP *INLINE-QUERY-CACHE* QUERYID)))
   (CL:IF (CL:NOT (CL:EQ QUERIES NULL)) (POP QUERIES) NULL)))
...
(CL:DEFUN FREE-CACHED-QUERY (QUERY QUERYID)
  (CL:LET* ((QUERIES (LOOKUP *INLINE-QUERY-CACHE* QUERYID)))
   (CL:WHEN (CL:EQ QUERIES NULL) (CL:SETQ QUERIES (NEW-LIST))
    (INSERT-AT *INLINE-QUERY-CACHE* QUERYID QUERIES))
   (CL:WHEN (CL:< (LENGTH QUERIES) *MAX-CACHED-QUERIES-PER-ID*)
    (PUSH QUERIES QUERY))))
...
(CL:DEFUN MAKE-CACHED-QUERY (VARIABLES QUERYBODY INPUTBINDINGS OPTIONS CACHEID)
  (CL:LET*
   ((QUERYITERATOR (FIND-CACHED-QUERY CACHEID)) (CURSOR INPUTBINDINGS))
    ...
    (CL:PROGN
     (CL:HANDLER-CASE
      (CL:SETQ QUERYITERATOR
       (MAKE-QUERY (COPY-CONS-LIST VARIABLES) (COPY-CONS-TREE QUERYBODY)
        INPUTBINDINGS OPTIONS "Cached"))
      (LOGIC-EXCEPTION (E)
       (%%PRINT-STREAM (%NATIVE-STREAM STANDARD-ERROR) (EXCEPTION-MESSAGE E))
       (CL:RETURN-FROM MAKE-CACHED-QUERY NULL))))
    (CL:PROGN
     (CL:LET*
      ((NEWB NULL) (ITER-001 INPUTBINDINGS) (I NULL-INTEGER) (ITER-002 0))
...
(CL:DEFUN APPLY-CACHED-RETRIEVE (VARIABLES QUERYBODY INPUTBINDINGS OPTIONS CACHEID)
  (CL:LET*
   ((QUERYITERATOR NULL) (BINDINGSCOUNT 0) (OUTPUTBINDINGS NIL)
    (TRUTHVALUES NIL) (JUSTIFICATIONS NIL) (FORCESINGLETONTUPLES? CL:NIL))
   ...
   (CL:WHEN (CL:EQ QUERYITERATOR NULL)
    (CL:RETURN-FROM APPLY-CACHED-RETRIEVE (CL:VALUES NIL NIL NIL)))
   (CL:WHEN
    (CL:OR
     (EQL? (LOOKUP (%OPTIONS QUERYITERATOR) KWD-QUERY-SINGLETONS?)
      FALSE-WRAPPER)
     (EQL? (LOOKUP (%OPTIONS QUERYITERATOR) KWD-QUERY-ATOMIC-SINGLETONS?)
      FALSE-WRAPPER))
    (CL:SETQ FORCESINGLETONTUPLES? CL:T))
   (CL:LET* ((*QUERYITERATOR* QUERYITERATOR) (*REVERSEPOLARITY?* CL:NIL))
    (CL:DECLARE (CL:SPECIAL *QUERYITERATOR* *REVERSEPOLARITY?*))
    ...
    ((TUPLE NULL)
     (ATOMICSINGLETONS?
      (CL:AND (CL:= (LENGTH INPUTBINDINGS) (CL:1+ BINDINGSCOUNT))
       (CL:NOT FORCESINGLETONTUPLES?))))
    (CL:LET*
     ((S NULL) (ITER-000 (ALLOCATE-ITERATOR (%SOLUTIONS QUERYITERATOR))))
     (CL:LOOP WHILE (NEXT? ITER-000) DO (CL:SETQ S (%VALUE ITER-000))
      (CL:IF ATOMICSINGLETONS?
       (CL:LET*
        ((V NULL) (VECTOR-000 (%BINDINGS S)) (INDEX-000 0)
         (LENGTH-000 (LENGTH VECTOR-000)) (B NULL) (ITER-001 INPUTBINDINGS))
        (CL:DECLARE (CL:TYPE CL:FIXNUM INDEX-000 LENGTH-000))
        (CL:LOOP WHILE
         (CL:AND (CL:< INDEX-000 LENGTH-000) (CL:NOT (CL:EQ ITER-001 NIL))) DO
         (CL:SETQ V
          (CL:AREF (CL:THE CL:SIMPLE-VECTOR (%THE-ARRAY VECTOR-000))
           INDEX-000))
       ...
       (CL:LET* ((VALUES NIL))
        (CL:LET*
         ((V NULL) (VECTOR-001 (%BINDINGS S)) (INDEX-001 0)
          (LENGTH-001 (LENGTH VECTOR-001)) (B NULL) (ITER-002 INPUTBINDINGS)
          (COLLECT-000 NULL))
         (CL:DECLARE (CL:TYPE CL:FIXNUM INDEX-001 LENGTH-001))
         (CL:LOOP WHILE
          (CL:AND (CL:< INDEX-001 LENGTH-001) (CL:NOT (CL:EQ ITER-002 NIL)))
          DO
          (CL:SETQ V
           (CL:AREF (CL:THE CL:SIMPLE-VECTOR (%THE-ARRAY VECTOR-001))
            INDEX-001))
      ...
      (CL:SETQ TRUTHVALUES (CONS (%TRUTH-VALUE S) TRUTHVALUES))
      (CL:WHEN *RECORD-JUSTIFICATIONS?*
       (CL:SETQ JUSTIFICATIONS (CONS (%JUSTIFICATION S) JUSTIFICATIONS))))))
   (FREE-CACHED-QUERY QUERYITERATOR CACHEID)
   (CL:VALUES (REVERSE OUTPUTBINDINGS) (REVERSE TRUTHVALUES)
    (REVERSE JUSTIFICATIONS))))
...
(CL:DEFUN APPLY-CACHED-ASK (INPUTVARIABLES QUERYBODY INPUTBINDINGS OPTIONS CACHEID)
  (CL:LET*
   ...
   (CL:COND
    ((CL:NOT (CL:EQ QUERYITERATOR NULL))
     (CL:LET* ((TRUTHVALUE (CALL-ASK QUERYITERATOR)))
      (FREE-CACHED-QUERY QUERYITERATOR CACHEID)
      (CL:VALUES
       (CL:OR (CL:EQ TRUTHVALUE TRUE-TRUTH-VALUE)
        (CL:EQ TRUTHVALUE DEFAULT-TRUE-TRUTH-VALUE))
    ...
    (CL:SETQ PROTOTYPE
     (%%VALUE
      (APPLY-CACHED-RETRIEVE (LIST* SYM-QUERY-LOGIC-?C SYM-QUERY-LOGIC-?P NIL)
       (LIST* SYM-QUERY-PL-KERNEL-KB-CONCEPT-PROTOTYPE SYM-QUERY-LOGIC-?C
  ...
  (CL:LET* ((*PRINTREADABLY?* CL:T))
   ...
   (CL:WHEN
    (CL:AND (CL:NOT (CL:EQ *TRACED-KEYWORDS* NULL))
     (MEMB? *TRACED-KEYWORDS* KWD-QUERY-GOAL-TREE))
    (%%PRINT-STREAM (%NATIVE-STREAM STANDARD-OUTPUT) EOL
     "Prototype Subsumption Test:" EOL "   sub=" SUB EOL "   super=" SUPER
     EOL)))
...
(CL:DEFUN DESCRIPTION-SPECIALIZES-DESCRIPTION? (SUB SUPER)
  ...
  (CL:WHEN *REVERSEPOLARITY?*
   (CL:RETURN-FROM DESCRIPTION-SPECIALIZES-DESCRIPTION? UNKNOWN-TRUTH-VALUE))
  (CL:WHEN (COLLECTION-IMPLIES-COLLECTION? SUB SUPER)
   (CL:RETURN-FROM DESCRIPTION-SPECIALIZES-DESCRIPTION? TRUE-TRUTH-VALUE))
  ...
  (CL:LET* ((*PRINTREADABLY?* CL:T))
   ...
   (CL:WHEN
    (CL:AND (CL:NOT (CL:EQ *TRACED-KEYWORDS* NULL))
     (MEMB? *TRACED-KEYWORDS* KWD-QUERY-GOAL-TREE))
    (%%PRINT-STREAM (%NATIVE-STREAM STANDARD-OUTPUT) EOL "Subsumption Test:"
     EOL "   sub=" SUB EOL "   super=" SUPER EOL)))
  (CL:LET*
   ((SKOLEMSVECTOR (NEW-VECTOR (LENGTH (%IO-VARIABLES SUB))))
   ...
   (CL:HANDLER-CASE
    (CL:PROGN (INHERIT-DESCRIPTION SKOLEMSVECTOR SUB CL:NIL)
     (CL:SETQ RESULT
      (CALL-ASK (CREATE-QUERY-ITERATOR SUPER SKOLEMSVECTOR "d-specialize"))))
    (LOGIC-EXCEPTION (E)
     (%%PRINT-STREAM (%NATIVE-STREAM STANDARD-ERROR) (EXCEPTION-MESSAGE E))))
   (POP-WORLD)
   (CL:WHEN
   ...
   (CL:LET* ((ALWAYS?-000 CL:T))
    (CL:LET*
     ...
     (CL:LOOP WHILE (CL:< INDEX-000 LENGTH-000) DO
      (CL:SETQ VALUE
       (CL:AREF (CL:THE CL:SIMPLE-VECTOR (%THE-ARRAY VECTOR-000)) INDEX-000))
      (CL:WHEN (CL:EQ VALUE NULL) (CL:SETQ ALWAYS?-000 CL:NIL) (CL:RETURN))
      (CL:SETQ INDEX-000 (CL:1+ INDEX-000))))
    (CL:WHEN ALWAYS?-000
     (CL:RETURN-FROM VECTOR-SATISFIES-DESCRIPTION?
      (CALL-ASK (CREATE-QUERY-ITERATOR DESCRIPTION VECTOR "v-specialize")))))
   (LOGIC-EXCEPTION (E)
    (%%PRINT-STREAM (%NATIVE-STREAM STANDARD-ERROR) (EXCEPTION-MESSAGE E))))
  UNKNOWN-TRUTH-VALUE)
...
(CL:DEFUN COERCE-TO-DESCRIPTION (SELF ORIGINAL)
  ...
  (CL:LET* ((TEST-VALUE-000 (SAFE-PRIMARY-TYPE SELF)))
   (CL:COND
    ((SUBTYPE-OF? TEST-VALUE-000 SGT-QUERY-LOGIC-DESCRIPTION) (CL:PROGN SELF))
...
(CL:DEFUN COERCE-TO-INSTANCE (SELF ORIGINAL)
  ...
  (CL:LET* ((TEST-VALUE-000 (SAFE-PRIMARY-TYPE SELF)))
   (CL:COND
    ...
    ((SUBTYPE-OF-SYMBOL? TEST-VALUE-000)
     (CL:PROGN (COERCE-TO-INSTANCE (SYMBOL-TO-SURROGATE SELF) ORIGINAL)))
    ((SUBTYPE-OF-KEYWORD? TEST-VALUE-000)
     (CL:PROGN
    ...
    ((CL:EQ TEST-VALUE-000 SGT-QUERY-STELLA-CONS)
     (CL:PROGN (COERCE-TO-INSTANCE (EVALUATE-TERM SELF) ORIGINAL)))
...
literal (e.g., string or number) that can't be coerced."
  ...
  (CL:LET* ((TEST-VALUE-000 (SAFE-PRIMARY-TYPE SELF)))
   (CL:COND
    ...
    ((SUBTYPE-OF-SURROGATE? TEST-VALUE-000)
     (CL:PROGN
      (COERCE-TO-INSTANCE-OR-LITERAL (%SURROGATE-VALUE SELF) ORIGINAL)))
    ((SUBTYPE-OF-SYMBOL? TEST-VALUE-000)
     (CL:PROGN
      (COERCE-TO-INSTANCE-OR-LITERAL (SYMBOL-TO-SURROGATE SELF) ORIGINAL)))
    ((SUBTYPE-OF-KEYWORD? TEST-VALUE-000)
     (CL:PROGN
      (COERCE-TO-INSTANCE-OR-LITERAL (LOOKUP-SURROGATE (%SYMBOL-NAME SELF))
       ORIGINAL)))
    ((SUBTYPE-OF-STRING? TEST-VALUE-000)
     (CL:PROGN
      (COERCE-TO-INSTANCE-OR-LITERAL (LOOKUP-SURROGATE (%WRAPPER-VALUE SELF))
       ORIGINAL)))
    ...
    (CL:COND
     ...
     ((SUBTYPE-OF? TEST-VALUE-000 SGT-QUERY-STELLA-LIST)
      (CL:PROGN (CL:SETQ VECTOR (NEW-VECTOR (LENGTH SELF)))
       (CL:LET*
        ((M NULL) (ITER-001 (%THE-CONS-LIST SELF)) (I NULL-INTEGER)
         (ITER-002 0))
        (CL:DECLARE (CL:TYPE CL:FIXNUM I ITER-002))
        (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-001 NIL)) DO
     ...
     ((CL:EQ TEST-VALUE-000 SGT-QUERY-STELLA-CONS)
      (CL:PROGN (CL:SETQ VECTOR (NEW-VECTOR (LENGTH SELF)))
       (CL:LET* ((M NULL) (ITER-003 SELF) (I NULL-INTEGER) (ITER-004 0))
...
'apply-kappa?'."
  (CL:HANDLER-CASE (INHERIT-UNNAMED-DESCRIPTION VECTOR DESCRIPTION CL:NIL)
   (CLASH (E)
    (%%PRINT-STREAM (%NATIVE-STREAM STANDARD-ERROR) (EXCEPTION-MESSAGE E) EOL)
  ...
  (CL:WHEN (QUERY-IS-TRUE-FALSE? QUERY)
   (CL:LET* ((STREAM-000 (NEW-OUTPUT-STRING-STREAM)))
    (CL:LET* ((*PRINTREADABLY?* CL:T))
     (CL:DECLARE (CL:SPECIAL *PRINTREADABLY?*))
     (%%PRINT-STREAM (%NATIVE-STREAM STREAM-000)
      "ERROR: Can't yet assert/retract the result of a true/false query." EOL)
     (HELP-SIGNAL-PROPOSITION-ERROR STREAM-000 KWD-QUERY-ERROR))
    (CL:ERROR (NEW-PROPOSITION-ERROR (THE-STRING-READER STREAM-000)))))
  (CL:LET*
   ((QUERYDESCRIPTION (QUERY-DESCRIPTION QUERY))
    (PARTIAL? (QUERY-IS-PARTIAL? QUERY)) (SOLUTIONS (%SOLUTIONS QUERY))
    (MAPPING (NEW-KEY-VALUE-MAP)) (DONTCHECKDUPLICATES? CL:NIL)
     ...
     (CL:WHEN
      ...
      (CL:LET* ((STREAM-001 (NEW-OUTPUT-STRING-STREAM)))
       (CL:LET* ((*PRINTREADABLY?* CL:T))
        (CL:DECLARE (CL:SPECIAL *PRINTREADABLY?*))
        (%%PRINT-STREAM (%NATIVE-STREAM STREAM-001)
         "ERROR: Arity mismatch between query proposition and `" DESCRIPTION
         "'." EOL)
        (HELP-SIGNAL-PROPOSITION-ERROR STREAM-001 KWD-QUERY-ERROR))
   ...
   (CL:SETQ PROPOSITION (%PROPOSITION DESCRIPTION))
   (CL:WHEN
    (CL:AND (VARIABLE-ARITY? DESCRIPTION)
     (CL:> (ARITY QUERYDESCRIPTION) (LENGTH (%IO-VARIABLES DESCRIPTION))))
    (CL:WHEN
     (CL:NOT
      (CL:OR (CL:EQ (%KIND PROPOSITION) KWD-QUERY-FUNCTION)
       (CL:EQ (%KIND PROPOSITION) KWD-QUERY-PREDICATE)))
     (CL:LET* ((STREAM-002 (NEW-OUTPUT-STRING-STREAM)))
      (CL:LET* ((*PRINTREADABLY?* CL:T))
       (CL:DECLARE (CL:SPECIAL *PRINTREADABLY?*))
       (%%PRINT-STREAM (%NATIVE-STREAM STREAM-002)
    ...
    (CL:SETQ PROPOSITION (SHALLOW-COPY-PROPOSITION PROPOSITION))
    (CL:SETF (%ARGUMENTS PROPOSITION) (COPY (%IO-VARIABLES QUERYDESCRIPTION)))
     ...
     (CL:LOOP WHILE (NEXT? ITER-000) DO (CL:SETQ SOLUTION (%VALUE ITER-000))
      ...
      (CL:LET*
       ((VAR NULL) (VECTOR-000 (%IO-VARIABLES DESCRIPTION)) (INDEX-000 0)
        (LENGTH-000 (LENGTH VECTOR-000)) (BINDING NULL)
        (VECTOR-001 (%BINDINGS SOLUTION)) (INDEX-001 0)
        (LENGTH-001 (LENGTH VECTOR-001)))
       (CL:DECLARE
        (CL:TYPE CL:FIXNUM INDEX-000 LENGTH-000 INDEX-001 LENGTH-001))
       (CL:LOOP WHILE
        ...
        (CL:SETQ BINDING
         (CL:AREF (CL:THE CL:SIMPLE-VECTOR (%THE-ARRAY VECTOR-001))
          INDEX-001))
        (INSERT-AT MAPPING VAR BINDING) (CL:SETQ INDEX-000 (CL:1+ INDEX-000))
        (CL:SETQ INDEX-001 (CL:1+ INDEX-001))))
      (CL:LET*
       ((PROP NULL)
        (ITER-002 (INHERIT-AS-TOP-LEVEL-PROPOSITION PROPOSITION MAPPING)))
       (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-002 NIL)) DO
        (CL:SETQ PROP (%%VALUE ITER-002))
        (SET-DYNAMIC-SLOT-VALUE (%DYNAMIC-SLOTS PROP)
         SYM-QUERY-LOGIC-DESCRIPTIVE? FALSE-WRAPPER FALSE-WRAPPER)
        (CL:SETQ PROP
         (RECURSIVELY-FASTEN-DOWN-PROPOSITIONS PROP DONTCHECKDUPLICATES?))
        (CL:LET*
         ((THISUPDATEMODE UPDATEMODE) (TRUTHVALUE (%TRUTH-VALUE SOLUTION))
         ...
         (CL:WHEN PARTIAL?
          (SET-DYNAMIC-SLOT-VALUE (%DYNAMIC-SLOTS PROP) SYM-QUERY-LOGIC-WEIGHT
           (WRAP-FLOAT (%MATCH-SCORE SOLUTION)) NULL-FLOAT-WRAPPER))
         (VERIFY-ARGUMENT-TYPES-AND-COUNT PROP)
         (CL:WHEN
          (CL:AND RECORDJUSTIFICATIONS? (CL:NOT (CL:EQ JUSTIFICATION NULL)))
          (CL:LET* ((SELF-007 (NEW-JUSTIFICATION)))
           (CL:SETF (%INFERENCE-RULE SELF-007) KWD-QUERY-ASSERT-FROM-QUERY)
           (CL:SETF (%PROPOSITION SELF-007) PROP)
           (CL:SETF (%ANTECEDENTS SELF-007) (CONS JUSTIFICATION NIL))
           (CL:SETF (%SUBSTITUTION SELF-007) (COPY MAPPING))
           (CL:SETF (%TRUTH-VALUE SELF-007) TRUTHVALUE)
           (CL:LET* ((RESULTJUSTIFICATION SELF-007))
...
(CL:DEFUN GET-QUERY-ITERATOR-FROM-COMMAND (QUERY)
  (CL:LET* ((QUERYITERATOR (EVALUATE-LOGIC-COMMAND QUERY CL:T)))
   (CL:WHEN
    (CL:AND (CL:NOT (ISA? QUERYITERATOR SGT-QUERY-LOGIC-QUERY-ITERATOR))
     (SYMBOL? (%%VALUE QUERY))
   ...
   (CL:LET*
    ((THEOPTIONS
      (PARSE-LOGIC-COMMAND-OPTIONS OPTIONS
       (LIST* KWD-QUERY-MODULE SGT-QUERY-STELLA-MODULE KWD-QUERY-RELATION
        SGT-QUERY-STELLA-SYMBOL KWD-QUERY-PATTERN SGT-QUERY-STELLA-CONS
        KWD-QUERY-RECORD-JUSTIFICATIONS? SGT-QUERY-STELLA-BOOLEAN NIL)
       CL:T CL:NIL))
     (PATTERN NULL)
     (RECORDJUSTIFICATIONS?
      (LOOKUP-WITH-DEFAULT THEOPTIONS KWD-QUERY-RECORD-JUSTIFICATIONS?
       FALSE-WRAPPER)))
  ...
  (CL:HANDLER-CASE
   (CL:LET*
    ((THEOPTIONS
      (PARSE-LOGIC-COMMAND-OPTIONS OPTIONS
       (LIST* KWD-QUERY-MODULE SGT-QUERY-STELLA-MODULE KWD-QUERY-RELATION
        SGT-QUERY-STELLA-SYMBOL KWD-QUERY-PATTERN SGT-QUERY-STELLA-CONS NIL)
       CL:T CL:NIL))
...
(CL:DEFUN DISPLAY-SETTINGS ()
  (%%PRINT-STREAM (%NATIVE-STREAM STANDARD-OUTPUT) EOL
   ...
   "*CACHE-INFERABLE-SUBCOLLECTIONS?* =  " *CACHE-INFERABLE-SUBCOLLECTIONS?*
   EOL "*INFERENCELEVEL* =  " *INFERENCELEVEL* EOL
   "*MAXIMUM-BACKTRACKING-DEPTH* =  " *MAXIMUM-BACKTRACKING-DEPTH* EOL
   "*TYPE-CHECK-STRATEGY* =  " *TYPE-CHECK-STRATEGY* EOL
   "*DUPLICATE-SUBGOAL-STRATEGY* =  " *DUPLICATE-SUBGOAL-STRATEGY* EOL
   "*DUPLICATE-GOAL-SEARCH-DEPTH* =  " *DUPLICATE-GOAL-SEARCH-DEPTH* EOL
   "*DUPLICATE-RULE-SEARCH-DEPTH* =  " *DUPLICATE-RULE-SEARCH-DEPTH* EOL
   "*GLOBALLY-CLOSED-COLLECTIONS?* =  " *GLOBALLY-CLOSED-COLLECTIONS?* EOL
   "*DEFAULT-MAXIMUM-DEPTH* =  " *DEFAULT-MAXIMUM-DEPTH* EOL
   "*INITIAL-BACKTRACKING-DEPTH* =  " *INITIAL-BACKTRACKING-DEPTH* EOL
   "*ITERATIVE-DEEPENING-MODE?* =  " *ITERATIVE-DEEPENING-MODE?* EOL
   "*DUPLICATEINSTANCESCACHECROSSOVERPOINT* =  "
...
(CL:DEFUN HELP-STARTUP-QUERY1 ()
  (CL:PROGN
   ...
   (CL:SETQ SYM-QUERY-LOGIC-DEBUG-ID
    (INTERN-RIGID-SYMBOL-WRT-MODULE "DEBUG-ID" NULL 0))
   ...
   (CL:SETQ SYM-QUERY-LOGIC-FAILED-TO-FIND-DUPLICATE-SUBGOAL?
    (INTERN-RIGID-SYMBOL-WRT-MODULE "FAILED-TO-FIND-DUPLICATE-SUBGOAL?" NULL
     0))
   ...
   (CL:SETQ SYM-QUERY-LOGIC-DEPTH-CUTOFFS?
    (INTERN-RIGID-SYMBOL-WRT-MODULE "DEPTH-CUTOFFS?" NULL 0))
...
(CL:DEFUN HELP-STARTUP-QUERY2 ()
  (CL:PROGN
   (CL:SETQ SYM-QUERY-STELLA-STATE
    (INTERN-RIGID-SYMBOL-WRT-MODULE "STATE" (GET-STELLA-MODULE "/STELLA" CL:T)
     0))
...
(CL:DEFUN HELP-STARTUP-QUERY4 ()
  (CL:PROGN
   ...
   (CL:SETQ SGT-QUERY-LOGIC-F-DISJOINT-TERMS?-MEMO-TABLE-000
    (INTERN-RIGID-SYMBOL-WRT-MODULE "F-DISJOINT-TERMS?-MEMO-TABLE-000" NULL
     1))
   ...
   (CL:SETQ SYM-QUERY-LOGIC-F-EXPENSIVE-DISJOINT-TERMS?-QUERY-000
    (INTERN-RIGID-SYMBOL-WRT-MODULE "F-EXPENSIVE-DISJOINT-TERMS?-QUERY-000"
     NULL 0))
   ...
   (CL:SETQ SYM-QUERY-STELLA-FIRST
    (INTERN-RIGID-SYMBOL-WRT-MODULE "FIRST" (GET-STELLA-MODULE "/STELLA" CL:T)
     0))
   (CL:SETQ SYM-QUERY-STELLA-LAST
    (INTERN-RIGID-SYMBOL-WRT-MODULE "LAST" (GET-STELLA-MODULE "/STELLA" CL:T)
     0))
   ...
   (CL:SETQ SYM-QUERY-STELLA-NEXT
    (INTERN-RIGID-SYMBOL-WRT-MODULE "NEXT" (GET-STELLA-MODULE "/STELLA" CL:T)
     0))
   ...
   (CL:SETQ KWD-QUERY-FOUR-VALUED?
    (INTERN-RIGID-SYMBOL-WRT-MODULE "FOUR-VALUED?" NULL 2))
   (CL:SETQ KWD-QUERY-BACKWARD
...
(CL:DEFUN HELP-STARTUP-QUERY5 ()
  (CL:PROGN
   ...
   (CL:SETQ KWD-QUERY-CHECK-VARIABLES?
    (INTERN-RIGID-SYMBOL-WRT-MODULE "CHECK-VARIABLES?" NULL 2))
   ...
   (CL:SETQ KWD-QUERY-ATOMIC-SINGLETONS?
    (INTERN-RIGID-SYMBOL-WRT-MODULE "ATOMIC-SINGLETONS?" NULL 2))
   (CL:SETQ KWD-QUERY-ALL-PROOFS?
    (INTERN-RIGID-SYMBOL-WRT-MODULE "ALL-PROOFS?" NULL 2))
   (CL:SETQ KWD-QUERY-VALUES (INTERN-RIGID-SYMBOL-WRT-MODULE "VALUES" NULL 2))
   (CL:SETQ KWD-QUERY-VALUES-DESCENDING
    (INTERN-RIGID-SYMBOL-WRT-MODULE "VALUES-DESCENDING" NULL 2))
   (CL:SETQ KWD-QUERY-VALUES-ASCENDING
    (INTERN-RIGID-SYMBOL-WRT-MODULE "VALUES-ASCENDING" NULL 2))
   ...
   (CL:SETQ KWD-QUERY-ASSERT-FROM-QUERY
    (INTERN-RIGID-SYMBOL-WRT-MODULE "ASSERT-FROM-QUERY" NULL 2))
   ...
   (CL:SETQ SGT-QUERY-STELLA-SYMBOL
    (INTERN-RIGID-SYMBOL-WRT-MODULE "SYMBOL"
     (GET-STELLA-MODULE "/STELLA" CL:T) 1))
   (CL:SETQ KWD-QUERY-RECORD-JUSTIFICATIONS?
    (INTERN-RIGID-SYMBOL-WRT-MODULE "RECORD-JUSTIFICATIONS?" NULL 2))
   (CL:SETQ SGT-QUERY-STELLA-BOOLEAN
...
(CL:DEFUN HELP-STARTUP-QUERY6 ()
  (CL:PROGN
   (CL:LET* ((SELF-030 (NEW-NORMAL-INFERENCE-LEVEL)))
    (CL:SETF (%KEYWORD SELF-030) KWD-QUERY-NORMAL)
    (CL:SETQ NORMAL-INFERENCE SELF-030))
   (CL:LET* ((SELF-031 (NEW-BACKTRACKING-INFERENCE-LEVEL)))
    (CL:SETF (%KEYWORD SELF-031) KWD-QUERY-BACKTRACKING)
    (CL:SETQ BACKTRACKING-INFERENCE SELF-031))
   (CL:LET* ((SELF-032 (NEW-SUBSUMPTION-INFERENCE-LEVEL)))
    (CL:SETF (%KEYWORD SELF-032) KWD-QUERY-SUBSUMPTION)
    (CL:SETQ SUBSUMPTION-INFERENCE SELF-032))
   (CL:LET* ((SELF-033 (NEW-SHALLOW-INFERENCE-LEVEL)))
    (CL:SETF (%KEYWORD SELF-033) KWD-QUERY-SHALLOW)
    (CL:SETQ SHALLOW-INFERENCE SELF-033))
   (CL:LET* ((SELF-034 (NEW-ASSERTION-INFERENCE-LEVEL)))
    (CL:SETF (%KEYWORD SELF-034) KWD-QUERY-ASSERTION)
    (CL:SETQ ASSERTION-INFERENCE SELF-034))
   (CL:LET* ((SELF-035 (NEW-REFUTATION-INFERENCE-LEVEL)))
    (CL:SETF (%KEYWORD SELF-035) KWD-QUERY-REFUTATION)
   ...
   (CL:SETQ *DUPLICATE-GOAL-SEARCH-DEPTH* NULL-INTEGER)
   ...
   (CL:LET* ((SELF-037 (NEW-BOOLEAN-VECTOR-INDEX-NODE)))
    (CL:SETF (%THE-VECTOR SELF-037) (NEW-BOOLEAN-VECTOR 0))
    (CL:SETQ *BOOLEAN-VECTOR-INDEX* SELF-037))
   (CL:SETQ *INLINE-QUERY-CACHE* (NEW-KEY-VALUE-MAP))))
...
level of the current query iterator.  Otherwise, set the level globally.\" :PUBLIC? TRUE)"
   ...
   (DEFINE-FUNCTION-OBJECT "UNTRACE-SUBGOALS" "(DEFUN UNTRACE-SUBGOALS ())"
    (CL:FUNCTION UNTRACE-SUBGOALS) NULL)
   ...
   (DEFINE-FUNCTION-OBJECT "TOGGLE-TRACE-RULES"
    "(DEFUN (TOGGLE-TRACE-RULES STRING) ())" (CL:FUNCTION TOGGLE-TRACE-RULES)
    NULL)
   ...
   (DEFINE-FUNCTION-OBJECT "SAFE-ARGUMENT-BOUND-TO"
...
(CL:DEFUN HELP-STARTUP-QUERY10 ()
  (CL:PROGN
   ...
   (DEFINE-METHOD-OBJECT "(DEFMETHOD CLEAR ((SELF QUERY-SOLUTION-TABLE)))"
...
with a full stack of control frames.\")" (CL:FUNCTION PRINT-GOAL-STACK) NULL)
   ...
   (DEFINE-FUNCTION-OBJECT "CREATE-QUERY-ITERATOR"
    "(DEFUN (CREATE-QUERY-ITERATOR QUERY-ITERATOR) ((DESCRIPTION DESCRIPTION) (OUTSIDEBINDINGS VECTOR) (DEBUGID STRING)))"
    (CL:FUNCTION CREATE-QUERY-ITERATOR) NULL)
   (DEFINE-FUNCTION-OBJECT "INITIALIZE-QUERY-ITERATOR"
    "(DEFUN (INITIALIZE-QUERY-ITERATOR QUERY-ITERATOR) ((QUERYITERATOR QUERY-ITERATOR) (DESCRIPTION DESCRIPTION) (OUTSIDEBINDINGS VECTOR) (DEBUGID STRING)))"
   ...
   (DEFINE-METHOD-OBJECT "(DEFMETHOD (NEXT? BOOLEAN) ((SELF QUERY-ITERATOR)))"
    (CL:FUNCTION NEXT?) NULL)
   ...
   (DEFINE-FUNCTION-OBJECT "MAKE-QUERY"
    "(DEFUN (MAKE-QUERY QUERY-ITERATOR) ((IOVARIABLES OBJECT) (QUERYTREE OBJECT) (EXTERNALBINDINGS CONS) (OPTIONS OBJECT) (DEBUGID STRING)))"
...
specified by a query iterator, or specified as a CONS-list of arguments as they
would be supplied to `ask'.  Raises LOGIC-EXCEPTIONs in case of illegal
queries and logical expressions.\" :PUBLIC? TRUE)" (CL:FUNCTION CALL-ASK)
    NULL)
...
specified by a query iterator, or specified as a CONS-list of arguments as they
would be supplied to `retrieve'.  Raises LOGIC-EXCEPTIONs in case of illegal
queries and logical expressions.\" :PUBLIC? TRUE)" (CL:FUNCTION CALL-RETRIEVE)
    NULL)
...
of result tuples.  If `:SINGLETONS? TRUE', collect a list of atoms rather than a
list of lists for tuples of arity=1.\" :PUBLIC? TRUE)" (CL:FUNCTION CONSIFY)
    NULL)
...
available command options.\" :PUBLIC? TRUE :COMMAND? TRUE :EVALUATE-ARGUMENTS? FALSE)"
   ...
   (DEFINE-FUNCTION-OBJECT "STARTUP-QUERY"
    "(DEFUN STARTUP-QUERY () :PUBLIC? TRUE)" (CL:FUNCTION STARTUP-QUERY) NULL)
   (CL:LET* ((FUNCTION (LOOKUP-FUNCTION SYM-QUERY-LOGIC-STARTUP-QUERY)))
    (SET-DYNAMIC-SLOT-VALUE (%DYNAMIC-SLOTS FUNCTION)
     SYM-QUERY-STELLA-METHOD-STARTUP-CLASSNAME (WRAP-STRING "_StartupQuery")
     NULL-STRING-WRAPPER))))
...
(CL:DEFUN STARTUP-QUERY ()
  (CL:LET*
   ...
   (CL:WHEN (CURRENT-STARTUP-TIME-PHASE? 7) (HELP-STARTUP-QUERY8)
    (HELP-STARTUP-QUERY9) (HELP-STARTUP-QUERY10) (HELP-STARTUP-QUERY11))
...
description extension iterator is switched from a list to a hash table\")")
    (DEFINE-EXPLANATION-PHRASE KWD-QUERY-DEPTH-CUTOFF KWD-QUERY-TECHNICAL
    ...
    (REGISTER-NATIVE-NAME SYM-QUERY-STELLA-RETRIEVE KWD-QUERY-COMMON-LISP
     KWD-QUERY-FUNCTION)
    (DEFINE-STELLA-GLOBAL-VARIABLE-FROM-STRINGIFIED-SOURCE
...
be reparsed and reoptimized each time they are invoked.\" :THREAD-LOCAL? TRUE)")
    ...
    (DEFINE-EXPLANATION-PHRASE KWD-QUERY-ASSERT-FROM-QUERY KWD-QUERY-TECHNICAL
     "because it was asserted from a query")
    (DEFINE-EXPLANATION-PHRASE KWD-QUERY-ASSERT-FROM-QUERY KWD-QUERY-LAY
     "because it was asserted from a query")
