...
(CL:DECLAIM
  ...
  *MEASURE-INSTANCE-TABLE* STANDARD-OUTPUT EOL UNKNOWN-TRUTH-VALUE
  TRUE-TRUTH-VALUE FALSE-TRUTH-VALUE TRUE-WRAPPER FALSE-WRAPPER NULL-FLOAT
  NULL-INTEGER NIL *PRINTREADABLY?*))
...
(CL:DEFUN NEW-DIM-NUMBER-LOGIC-WRAPPER (WRAPPER-VALUE)
  (CL:LET* ((SELF NULL))
   (CL:SETQ SELF (CL:MAKE-INSTANCE (CL:QUOTE DIM-NUMBER-LOGIC-WRAPPER)))
     ...
     (CL:PROGN
      (CL:LET* ((VALUE (%WRAPPER-VALUE ITEM)))
       (CL:LET* ((TEST-VALUE-000 (SAFE-PRIMARY-TYPE VALUE)))
        (CL:COND
         ((SUBTYPE-OF? TEST-VALUE-000 SGT-UNIT-SUPPORT-STELLA-CALENDAR-DATE)
          (CL:PROGN NULL))
         ((SUBTYPE-OF? TEST-VALUE-000 SGT-UNIT-SUPPORT-STELLA-TIME-DURATION)
          (CL:PROGN
           (NEW-DIM-NUMBER-LOGIC-WRAPPER (TIME-DURATION-TO-DIM VALUE))))
         (CL:T
    ...
    ((SUBTYPE-OF? TEST-VALUE-002 SGT-UNIT-SUPPORT-LOGIC-PATTERN-VARIABLE)
     (CL:PROGN
      (CL:LET* ((VALUE (SAFE-BOUND-TO ITEM)))
       (CL:IF (CL:NOT (CL:EQ VALUE NULL)) (HELP-GET-DIM-NUMBER VALUE) NULL))))
        ...
        (CL:COND
         ...
         ((SUBTYPE-OF? TEST-VALUE-001 SGT-UNIT-SUPPORT-LOGIC-SKOLEM)
          (CL:PROGN
           (CL:WHEN
            (CL:EQ
             (ACCESS-IN-CONTEXT (%VARIABLE-VALUE VALUE) (%HOME-CONTEXT VALUE)
              CL:NIL)
             NULL)
       ...
       (CL:COND
        ...
        ((SUBTYPE-OF? TEST-VALUE-001 SGT-UNIT-SUPPORT-LOGIC-SKOLEM)
         (CL:PROGN
          (CL:LET*
           ((UNIT-VALUE
             (ACCESS-IN-CONTEXT (%VARIABLE-VALUE UNITS) (%HOME-CONTEXT UNITS)
              CL:NIL)))
    ...
    ((SUBTYPE-OF? TEST-VALUE-004 SGT-UNIT-SUPPORT-LOGIC-PATTERN-VARIABLE)
     (CL:PROGN
      (CL:LET* ((VALUE (SAFE-BOUND-TO MAGNITUDE)))
       (CL:IF (CL:NOT (CL:EQ VALUE NULL)) (HELP-GET-UNIT-VALUE VALUE UNITS)
        NULL))))
...
(CL:DEFUN UNITS-EVALUATOR (SELF)
  (CL:LET*
   ((MAGNITUDE
    ...
    (DIM-NUMBER
     (VALUE-OF
      (CL:AREF (CL:THE CL:SIMPLE-VECTOR (%THE-ARRAY (%ARGUMENTS SELF))) 2)))
    ...
    (CL:LET* ((TEST-VALUE-000 (SAFE-PRIMARY-TYPE DIM-NUMBER)))
     (CL:COND
      ...
      ((SUBTYPE-OF? TEST-VALUE-000
       ...
       (CL:PROGN
        (CL:WHEN
         (CL:NOT (EQL? (%WRAPPER-VALUE VALUE1) (%WRAPPER-VALUE DIM-NUMBER)))
     ...
     (CL:LET* ((TEST-VALUE-000 (SAFE-PRIMARY-TYPE DIM)))
      (CL:COND
       ((SUBTYPE-OF? TEST-VALUE-000 SGT-UNIT-SUPPORT-LOGIC-PATTERN-VARIABLE)
        (CL:PROGN
         (SELECT-PROOF-RESULT (BIND-VARIABLE-TO-VALUE? DIM THE-VALUE CL:T)
          CL:NIL CL:T)))
       ((SUBTYPE-OF? TEST-VALUE-000 SGT-UNIT-SUPPORT-LOGIC-SKOLEM)
        (CL:PROGN
         (CL:LET*
       ...
       ((SUBTYPE-OF? TEST-VALUE-000
        ...
        (CL:PROGN
         (SELECT-PROOF-RESULT
          (OBJECT-EQL? (%WRAPPER-VALUE THE-VALUE) (%WRAPPER-VALUE DIM)) CL:NIL
          CL:T)))
       ((SUBTYPE-OF? TEST-VALUE-000
         SGT-UNIT-SUPPORT-TIMEPOINT-SUPPORT-DATE-TIME-LOGIC-WRAPPER)
        (CL:PROGN
         (CL:LET* ((THE-DIM (HELP-GET-DIM-NUMBER DIM)))
          (CL:IF (CL:EQ THE-DIM NULL) KWD-UNIT-SUPPORT-TERMINAL-FAILURE
           (SELECT-PROOF-RESULT
            (OBJECT-EQL? (%WRAPPER-VALUE THE-VALUE) (%WRAPPER-VALUE THE-DIM))
            CL:NIL CL:T)))))
       (CL:T
        (CL:LET* ((STREAM-000 (NEW-OUTPUT-STRING-STREAM)))
         (%%PRINT-STREAM (%NATIVE-STREAM STREAM-000) "`" TEST-VALUE-000
          ...
          (CL:COND
           ((SUBTYPE-OF? TEST-VALUE-001
            ...
            (CL:PROGN
             (SELECT-PROOF-RESULT
              (CL:AND
               (BIND-VARIABLE-TO-VALUE? UNITS (WRAP-STRING UNIT-STRING) CL:T)
             ...
             (CL:LET* ((RETURN-VALUE KWD-UNIT-SUPPORT-FAILURE))
              (CL:HANDLER-CASE
               ...
               (INCOMPATIBLE-UNITS-EXCEPTION ()
                (CL:SETQ RETURN-VALUE KWD-UNIT-SUPPORT-TERMINAL-FAILURE))
               (STELLA-EXCEPTION () NULL))
              RETURN-VALUE)))
           ((SUBTYPE-OF? TEST-VALUE-001 SGT-UNIT-SUPPORT-LOGIC-SKOLEM)
            (CL:PROGN
          ...
          (CL:LET* ((TEST-VALUE-003 (SAFE-PRIMARY-TYPE UNITS)))
           (CL:COND
            ...
            ((SUBTYPE-OF? TEST-VALUE-003 SGT-UNIT-SUPPORT-LOGIC-SKOLEM)
             (CL:PROGN
              (CL:LET*
               ((OBJECT-006 UNITS) (VALUE-006 (WRAP-STRING UNIT-STRING))
          ...
          (CL:LET* ((TEST-VALUE-004 (SAFE-PRIMARY-TYPE UNITS)))
           (CL:COND
            ...
            ((SUBTYPE-OF? TEST-VALUE-004 SGT-UNIT-SUPPORT-LOGIC-SKOLEM)
             (CL:PROGN
              (CL:LET*
               ((OBJECT-007 UNITS) (VALUE-007 (WRAP-STRING UNIT-STRING))
  ...
  (CL:LET* ((VALUE NULL))
   (CL:CASE (%WRAPPER-VALUE MISSING-ARGUMENT)
    ...
    (0
     (CL:SETQ VALUE
      (CL:IF
       (OBJECT-EQL? (%PID (%WRAPPER-VALUE X3)) (%PID (%WRAPPER-VALUE X2)))
       (WRAP-DIM-NUMBER (SUBTRACT (%WRAPPER-VALUE X3) (%WRAPPER-VALUE X2)))
       NULL)))
    (1
     (CL:SETQ VALUE
      (CL:IF
       (OBJECT-EQL? (%PID (%WRAPPER-VALUE X3)) (%PID (%WRAPPER-VALUE X1)))
       (WRAP-DIM-NUMBER (SUBTRACT (%WRAPPER-VALUE X3) (%WRAPPER-VALUE X1)))
       NULL)))
    (2
     (CL:SETQ VALUE
      (CL:IF
       (OBJECT-EQL? (%PID (%WRAPPER-VALUE X1)) (%PID (%WRAPPER-VALUE X2)))
   ...
   (CL:CASE (%WRAPPER-VALUE MISSING-ARGUMENT)
    ...
    (1
     (CL:SETQ VALUE
      (CL:IF
       (OBJECT-EQL? (%PID (%WRAPPER-VALUE X3)) (%PID (%WRAPPER-VALUE X1)))
       (WRAP-DIM-NUMBER (SUBTRACT (%WRAPPER-VALUE X1) (%WRAPPER-VALUE X3)))
       NULL)))
    (2
     (CL:SETQ VALUE
      (CL:IF
       (OBJECT-EQL? (%PID (%WRAPPER-VALUE X1)) (%PID (%WRAPPER-VALUE X2)))
       (WRAP-DIM-NUMBER (SUBTRACT (%WRAPPER-VALUE X1) (%WRAPPER-VALUE X2)))
       NULL)))
    (CL:OTHERWISE))
   VALUE))
...
(CL:DEFUN U-TIMES-CONSTRAINT (MISSING-ARGUMENT X1 X2 X3)
  (CL:LET* ((VALUE NULL))
   (CL:CASE (%WRAPPER-VALUE MISSING-ARGUMENT)
    ...
    (2
     (CL:SETQ VALUE
      (WRAP-DIM-NUMBER (MULTIPLY (%WRAPPER-VALUE X1) (%WRAPPER-VALUE X2)))))
    (CL:OTHERWISE))
   VALUE))
...
(CL:DEFUN U-DIVIDE-CONSTRAINT (MISSING-ARGUMENT X1 X2 X3)
  (CL:LET* ((VALUE NULL))
   (CL:CASE (%WRAPPER-VALUE MISSING-ARGUMENT)
    ...
    (0
     (CL:SETQ VALUE
      (WRAP-DIM-NUMBER (MULTIPLY (%WRAPPER-VALUE X2) (%WRAPPER-VALUE X3)))))
    (1
     (CL:SETQ VALUE
...
(CL:DEFUN U-ABS-SPECIALIST (FRAME LASTMOVE)
  (CL:LET*
   ((PROPOSITION (%PROPOSITION FRAME))
    ...
    (ABSARGDIM
     (CL:IF (CL:EQ ABSARGVALUE NULL) NULL (HELP-GET-DIM-NUMBER ABSARGVALUE)))
    (ITERATOR
       ...
       (CL:RETURN-FROM U-ABS-SPECIALIST
        (SELECT-PROOF-RESULT
         (BIND-ARGUMENT-TO-VALUE? ABSARG
          (WRAP-DIM-NUMBER (ABSOLUTE-VALUE (%WRAPPER-VALUE MAINARGDIM))) CL:T)
         CL:NIL CL:T))
       (CL:RETURN-FROM U-ABS-SPECIALIST KWD-UNIT-SUPPORT-TERMINAL-FAILURE)))
  ...
  (CL:LET*
   ...
   (CL:IF (CL:EQ MAINARGVALUE NULL) KWD-UNIT-SUPPORT-FAILURE
    (CL:IF (CL:EQ SIGNUMARGVALUE NULL)
     ...
     (CL:IF
      (CL:AND (ISA? SIGNUMARGVALUE SGT-UNIT-SUPPORT-STELLA-INTEGER-WRAPPER)
  ...
  (CL:LET*
   ...
   (CL:WHEN
    ...
    (%%PRINT-STREAM (%NATIVE-STREAM STANDARD-OUTPUT) EOL
     "Non list appears in second argument to 'MINIMUM-OF-UNITS'" EOL EOL)
    ...
    (CL:LET* ((V NULL) (ITER-000 (%THE-CONS-LIST LISTVALUE)))
     (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-000 NIL)) DO
      ...
      (CL:IF (CL:NOT (CL:EQ DIMVALUE NULL))
       (CL:WHEN
        (CL:OR (CL:EQ MINIMUM NULL) (LESS? (%WRAPPER-VALUE DIMVALUE) MINIMUM))
  ...
  (CL:LET*
   ...
   (CL:WHEN
    (CL:AND (CL:NOT (CL:EQ LISTSKOLEM NULL))
     (CL:NOT (LOGICAL-COLLECTION? LISTSKOLEM)))
    (%%PRINT-STREAM (%NATIVE-STREAM STANDARD-OUTPUT) EOL
     "Non list appears in second argument to 'MAXIMUM-OF-UNITS'" EOL EOL)
     ...
     (CL:IF
      ...
      (CL:LET*
       ...
       (CL:IF (CL:NOT (CL:EQ MEASURE-INSTANCE NULL))
        (SELECT-PROOF-RESULT
         (BIND-ARGUMENT-TO-VALUE? MEASUREARG MEASURE-INSTANCE CL:T) CL:NIL
         CL:T)
        KWD-UNIT-SUPPORT-FAILURE))
      KWD-UNIT-SUPPORT-TERMINAL-FAILURE)
     (CL:IF
     ...
     (CL:PROGN
      (CL:LET*
       ((PROP (%DEFINING-PROPOSITION ARGUMENT))
        (ARGS (CL:IF (CL:NOT (CL:EQ PROP NULL)) (%ARGUMENTS PROP) NULL))
       ...
       (CL:COND ((CL:EQ ARGS NULL) CL:NIL)
        ((CL:= (LENGTH ARGS) (CL:1+ LIST-LENGTH))
         (CL:LET*
          ((ITEM NULL) (ITER-000 (%THE-CONS-LIST THE-LIST)) (I NULL-INTEGER)
           (ITER-001 0))
  ...
  (CL:LET*
   ...
   (CL:LET*
    ...
    (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-000 NIL)) DO
     ...
     (CL:IF (CL:EQ COLLECT-000 NULL)
      (CL:PROGN
       (CL:SETQ COLLECT-000 (CONS (LOOKUP *MEASURE-INSTANCE-TABLE* M) NIL))
   ...
   (CL:COND
    ((CL:EQ LISTARGVALUE NULL)
     (SELECT-PROOF-RESULT
      (BIND-ARGUMENT-TO-VALUE? LISTARG (CREATE-LOGICAL-LIST MEASURESLIST)
       CL:T)
      CL:NIL CL:T))
...
(CL:DEFUN GET-OBJECT-PID (OBJ)
  (CL:LET* ((TEST-VALUE-000 (SAFE-PRIMARY-TYPE OBJ)))
   (CL:COND
    ...
    ((SUBTYPE-OF? TEST-VALUE-000 SGT-UNIT-SUPPORT-STELLA-NUMBER-WRAPPER)
     (CL:PROGN *RATIO-ONE*))
    (CL:T NULL))))
   ...
   (CL:IF (CL:OR (CL:EQ ARG1-VALUE NULL) (CL:EQ ARG2-VALUE NULL))
    ...
    (CL:HANDLER-CASE
     (CL:LET*
      ...
      (CL:IF
       (CL:AND (CL:NOT (CL:EQ ARG1-PID NULL)) (CL:NOT (CL:EQ ARG2-PID NULL)))
       (CL:RETURN-FROM COMENSURATE-UNITS-SPECIALIST
        (SELECT-TEST-RESULT (OBJECT-EQL? ARG1-PID ARG2-PID) CL:T FRAME))
       (CL:RETURN-FROM COMENSURATE-UNITS-SPECIALIST
        KWD-UNIT-SUPPORT-FAILURE)))
    ...
    (CL:LET* ((M NULL) (ITER-000 *ALL-MEASURES*))
     (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-000 NIL)) DO
      ...
      (CL:WHEN (CL:EQ I NULL)
       (CL:SETQ I (PLI::CREATE-CONCEPT MEASURE-NAME MEASURE NULL NULL)))
...
that all logic-wrapped DIM-NUMBERs are the same object.\")"
    ...
    (CL:LET*
     ((FUNCTION
       (LOOKUP-FUNCTION SYM-UNIT-SUPPORT-UNIT-SUPPORT-STARTUP-UNIT-SUPPORT)))
