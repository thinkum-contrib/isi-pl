  ...
  (CL:LET* ((*MODULE* (GET-STELLA-MODULE "/UNIT-SUPPORT" (> *STARTUP-TIME-PHASE* 1))) (*CONTEXT* *MODULE*))
   ...
   (CL:WHEN (CURRENT-STARTUP-TIME-PHASE? 2)
    (CL:SETQ SYM-UNIT-KB-UNIT-KB-MEASURE
     (INTERN-RIGID-SYMBOL-WRT-MODULE "MEASURE" (GET-STELLA-MODULE "/UNIT-KB" CL:T) 0))
    ...
    (CL:SETQ SYM-UNIT-KB-UNIT-KB-BASE-MEASURE
     (INTERN-RIGID-SYMBOL-WRT-MODULE "BASE-MEASURE" (GET-STELLA-MODULE "/UNIT-KB" CL:T) 0))
    (CL:SETQ KWD-UNIT-KB-AXIOMS (INTERN-RIGID-SYMBOL-WRT-MODULE "AXIOMS" NULL 2))
    (CL:SETQ SYM-UNIT-KB-UNIT-KB-MEASURE-UNIT
     (INTERN-RIGID-SYMBOL-WRT-MODULE "MEASURE-UNIT" (GET-STELLA-MODULE "/UNIT-KB" CL:T) 0))
    (CL:SETQ SYM-UNIT-KB-UNIT-KB-VALUE-MEASURE
     (INTERN-RIGID-SYMBOL-WRT-MODULE "VALUE-MEASURE" (GET-STELLA-MODULE "/UNIT-KB" CL:T) 0))
    (CL:SETQ SYM-UNIT-KB-UNIT-KB-NUMERATOR-MEASURES
     (INTERN-RIGID-SYMBOL-WRT-MODULE "NUMERATOR-MEASURES" (GET-STELLA-MODULE "/UNIT-KB" CL:T) 0))
    (CL:SETQ SYM-UNIT-KB-UNIT-KB-DENOMINATOR-MEASURES
     (INTERN-RIGID-SYMBOL-WRT-MODULE "DENOMINATOR-MEASURES" (GET-STELLA-MODULE "/UNIT-KB" CL:T) 0))
    (CL:SETQ SYM-UNIT-KB-UNIT-KB-COMENSURATE-UNITS
     (INTERN-RIGID-SYMBOL-WRT-MODULE "COMENSURATE-UNITS" (GET-STELLA-MODULE "/UNIT-KB" CL:T) 0))
    ...
    (CL:SETQ SYM-UNIT-KB-UNIT-SUPPORT-?DIM (INTERN-RIGID-SYMBOL-WRT-MODULE "?DIM" NULL 0))
    ...
    (CL:SETQ SYM-UNIT-KB-UNIT-KB-U-SIGNUM
     (INTERN-RIGID-SYMBOL-WRT-MODULE "U-SIGNUM" (GET-STELLA-MODULE "/UNIT-KB" CL:T) 0))
    (CL:SETQ SYM-UNIT-KB-UNIT-KB-U-WITHIN-DELTA
     (INTERN-RIGID-SYMBOL-WRT-MODULE "U-WITHIN-DELTA" (GET-STELLA-MODULE "/UNIT-KB" CL:T) 0))
    (CL:SETQ KWD-UNIT-KB-=> (INTERN-RIGID-SYMBOL-WRT-MODULE "=>" NULL 2))
    (CL:SETQ KWD-UNIT-KB-<= (INTERN-RIGID-SYMBOL-WRT-MODULE "<=" NULL 2))
    (CL:SETQ SYM-UNIT-KB-UNIT-KB-U-WITHIN-FACTOR
     (INTERN-RIGID-SYMBOL-WRT-MODULE "U-WITHIN-FACTOR" (GET-STELLA-MODULE "/UNIT-KB" CL:T) 0))
    (CL:SETQ SYM-UNIT-KB-UNIT-KB-U-MINIMUM-VALUE
     (INTERN-RIGID-SYMBOL-WRT-MODULE "U-MINIMUM-VALUE" (GET-STELLA-MODULE "/UNIT-KB" CL:T) 0))
    (CL:SETQ SYM-UNIT-KB-UNIT-KB-U-MAXIMUM-VALUE
     (INTERN-RIGID-SYMBOL-WRT-MODULE "U-MAXIMUM-VALUE" (GET-STELLA-MODULE "/UNIT-KB" CL:T) 0))
   ...
   (CL:WHEN (CURRENT-STARTUP-TIME-PHASE? 7)
    (DEFINE-FUNCTION-OBJECT "STARTUP-UNIT-KB" "(DEFUN STARTUP-UNIT-KB () :PUBLIC? TRUE)" (CL:FUNCTION STARTUP-UNIT-KB)
     NULL)
    (CL:LET* ((FUNCTION (LOOKUP-FUNCTION SYM-UNIT-KB-UNIT-SUPPORT-STARTUP-UNIT-KB)))
     (SET-DYNAMIC-SLOT-VALUE (%DYNAMIC-SLOTS FUNCTION) SYM-UNIT-KB-STELLA-METHOD-STARTUP-CLASSNAME
    ...
    (CL:LET* ((*MODULE* (GET-STELLA-MODULE "PL-KERNEL-KB" CL:T)) (*CONTEXT* *MODULE*))
     ...
     (%DEFCONCEPT
      (CONS-LIST (COPY-CONS-TREE SYM-UNIT-KB-UNIT-KB-BASE-MEASURE)
       (COPY-CONS-TREE (GET-QUOTED-TREE "((?M /UNIT-KB/MEASURE) \"/UNIT-SUPPORT\")" "/UNIT-SUPPORT"))
...
are not composed of any other units."))
       KWD-UNIT-KB-AXIOMS
       (COPY-CONS-TREE (GET-QUOTED-TREE "((CLOSED /UNIT-KB/BASE-MEASURE) \"/UNIT-SUPPORT\")" "/UNIT-SUPPORT"))))
     (%DEFRELATION
      (CONS-LIST (COPY-CONS-TREE SYM-UNIT-KB-UNIT-KB-MEASURE-UNIT)
       (COPY-CONS-TREE (GET-QUOTED-TREE "(((?M /UNIT-KB/MEASURE) (?U STRING)) \"/UNIT-SUPPORT\")" "/UNIT-SUPPORT"))
       KWD-UNIT-KB-DOCUMENTATION
       (COPY-CONS-TREE
        (WRAP-STRING "A mapping between a Measure and the unit names that belong
to that measure."))
       KWD-UNIT-KB-AXIOMS
       (COPY-CONS-TREE (GET-QUOTED-TREE "((CLOSED /UNIT-KB/MEASURE-UNIT) \"/UNIT-SUPPORT\")" "/UNIT-SUPPORT"))))
     (%DEFFUNCTION
      (CONS-LIST (COPY-CONS-TREE SYM-UNIT-KB-UNIT-KB-VALUE-MEASURE)
       (COPY-CONS-TREE (GET-QUOTED-TREE "((?DIM (?M /UNIT-KB/MEASURE)) \"/UNIT-SUPPORT\")" "/UNIT-SUPPORT"))
       KWD-UNIT-KB-DOCUMENTATION
       (COPY-CONS-TREE
...
combinations of units or by arithmetic manipulations of dimensions."))
     ...
     (%DEFFUNCTION
      (CONS-LIST (COPY-CONS-TREE SYM-UNIT-KB-UNIT-KB-NUMERATOR-MEASURES)
       (COPY-CONS-TREE (GET-QUOTED-TREE "((?DIM (?M /PL-KERNEL-KB/LIST)) \"/UNIT-SUPPORT\")" "/UNIT-SUPPORT"))
       KWD-UNIT-KB-DOCUMENTATION
       (COPY-CONS-TREE
...
The measures will be in a canonical order."))
     ...
     (%DEFRELATION
      (CONS-LIST (COPY-CONS-TREE SYM-UNIT-KB-UNIT-KB-COMENSURATE-UNITS)
       (COPY-CONS-TREE (GET-QUOTED-TREE "((?X ?Y) \"/UNIT-SUPPORT\")" "/UNIT-SUPPORT")) KWD-UNIT-KB-DOCUMENTATION
       (COPY-CONS-TREE
...
unit expressions (strings)"))
     ...
     (%DEFFUNCTION
      (CONS-LIST (COPY-CONS-TREE SYM-UNIT-KB-UNIT-KB-UNITS)
       (COPY-CONS-TREE (GET-QUOTED-TREE "(((?M NUMBER) (?U STRING)) \"/UNIT-SUPPORT\")" "/UNIT-SUPPORT"))
...
internal representation."))
     ...
     (%DEFFUNCTION
      (CONS-LIST (COPY-CONS-TREE SYM-UNIT-KB-UNIT-KB-U+)
       (COPY-CONS-TREE (GET-QUOTED-TREE "((?X ?Y) \"/UNIT-SUPPORT\")" "/UNIT-SUPPORT")) KWD-UNIT-KB-->
       (COPY-CONS-TREE SYM-UNIT-KB-LOGIC-?Z) KWD-UNIT-KB-DOCUMENTATION
       (COPY-CONS-TREE (WRAP-STRING "Function that adds two dim numbers.")) KWD-UNIT-KB-AXIOMS
       (COPY-CONS-TREE
        (GET-QUOTED-TREE
     ...
     (%DEFFUNCTION
      (CONS-LIST (COPY-CONS-TREE SYM-UNIT-KB-UNIT-KB-U-)
       (COPY-CONS-TREE (GET-QUOTED-TREE "((?X ?Y) \"/UNIT-SUPPORT\")" "/UNIT-SUPPORT")) KWD-UNIT-KB-->
       (COPY-CONS-TREE SYM-UNIT-KB-LOGIC-?Z) KWD-UNIT-KB-DOCUMENTATION
       (COPY-CONS-TREE (WRAP-STRING "Function that subtracts two dim numbers.")) KWD-UNIT-KB-AXIOMS
       (COPY-CONS-TREE
        (GET-QUOTED-TREE
     ...
     (%DEFFUNCTION
      (CONS-LIST (COPY-CONS-TREE SYM-UNIT-KB-UNIT-KB-U*)
       (COPY-CONS-TREE (GET-QUOTED-TREE "((?X ?Y) \"/UNIT-SUPPORT\")" "/UNIT-SUPPORT")) KWD-UNIT-KB-->
       (COPY-CONS-TREE SYM-UNIT-KB-LOGIC-?Z) KWD-UNIT-KB-DOCUMENTATION
       (COPY-CONS-TREE (WRAP-STRING "Function that multiplies two dim numbers.")) KWD-UNIT-KB-AXIOMS
       (COPY-CONS-TREE
        (GET-QUOTED-TREE
     ...
     (%DEFFUNCTION
      (CONS-LIST (COPY-CONS-TREE SYM-UNIT-KB-UNIT-KB-U-DIV)
       (COPY-CONS-TREE (GET-QUOTED-TREE "((?X ?Y) \"/UNIT-SUPPORT\")" "/UNIT-SUPPORT")) KWD-UNIT-KB-->
       (COPY-CONS-TREE SYM-UNIT-KB-LOGIC-?Z) KWD-UNIT-KB-DOCUMENTATION
       (COPY-CONS-TREE (WRAP-STRING "Function that divides two dim numbers.")) KWD-UNIT-KB-AXIOMS
       (COPY-CONS-TREE
        (GET-QUOTED-TREE
     ...
     (%DEFFUNCTION
      (CONS-LIST (COPY-CONS-TREE SYM-UNIT-KB-UNIT-KB-U-ABS)
       (COPY-CONS-TREE (GET-QUOTED-TREE "((?X) \"/UNIT-SUPPORT\")" "/UNIT-SUPPORT")) KWD-UNIT-KB-->
       (COPY-CONS-TREE SYM-UNIT-KB-LOGIC-?Z) KWD-UNIT-KB-DOCUMENTATION
       (COPY-CONS-TREE (WRAP-STRING "Absolute value of dim number.")) KWD-UNIT-KB-AXIOMS
       (COPY-CONS-TREE
        (GET-QUOTED-TREE
     ...
     (%DEFRELATION
      (CONS-LIST (COPY-CONS-TREE SYM-UNIT-KB-UNIT-KB-U-WITHIN-DELTA)
       (COPY-CONS-TREE (GET-QUOTED-TREE "((?X ?Y ?Z) \"/UNIT-SUPPORT\")" "/UNIT-SUPPORT")) KWD-UNIT-KB-DOCUMENTATION
       (COPY-CONS-TREE
...
that prevent a straight equality test from succeeding."))
       KWD-UNIT-KB-=>
       (COPY-CONS-TREE (GET-QUOTED-TREE "((>= (/UNIT-KB/U-SIGNUM ?Z) 0) \"/UNIT-SUPPORT\")" "/UNIT-SUPPORT"))
       KWD-UNIT-KB-<=
       (COPY-CONS-TREE
        (GET-QUOTED-TREE "((=< (/UNIT-KB/U-ABS (/UNIT-KB/U- ?X ?Y)) ?Z) \"/UNIT-SUPPORT\")" "/UNIT-SUPPORT"))))
     (%DEFRELATION
...
is not (100km is not in the range 30km-90km)."))
     ...
     (%DEFRELATION
      (CONS-LIST (COPY-CONS-TREE SYM-UNIT-KB-UNIT-KB-U-MINIMUM-VALUE)
       (COPY-CONS-TREE (GET-QUOTED-TREE "(((?L /PL-KERNEL-KB/COLLECTION) ?MIN) \"/UNIT-SUPPORT\")" "/UNIT-SUPPORT"))
       KWD-UNIT-KB-DOCUMENTATION
       (COPY-CONS-TREE (WRAP-STRING "Binds ?min to the minimum of the dimensioned numbers in the list ?l."))
       KWD-UNIT-KB-AXIOMS
       (COPY-CONS-TREE
        (GET-QUOTED-TREE
     ...
     (%DEFRELATION
      (CONS-LIST (COPY-CONS-TREE SYM-UNIT-KB-UNIT-KB-U-MAXIMUM-VALUE)
       (COPY-CONS-TREE (GET-QUOTED-TREE "(((?L /PL-KERNEL-KB/COLLECTION) ?MAX) \"/UNIT-SUPPORT\")" "/UNIT-SUPPORT"))
       KWD-UNIT-KB-DOCUMENTATION
       (COPY-CONS-TREE (WRAP-STRING "Binds ?max to the maximum of the dimensioned numbers in the list ?l."))
       KWD-UNIT-KB-AXIOMS
       (COPY-CONS-TREE
        (GET-QUOTED-TREE
     ...
     (%DEFRELATION
      (CONS-LIST (COPY-CONS-TREE SYM-UNIT-KB-UNIT-KB-U-SUM)
       (COPY-CONS-TREE (GET-QUOTED-TREE "(((?L /PL-KERNEL-KB/COLLECTION) ?SUM) \"/UNIT-SUPPORT\")" "/UNIT-SUPPORT"))
       KWD-UNIT-KB-DOCUMENTATION
       (COPY-CONS-TREE (WRAP-STRING "Binds ?sum to the sum of the dimensioned numbers in the list ?l."))
       KWD-UNIT-KB-AXIOMS
       (COPY-CONS-TREE
        (GET-QUOTED-TREE
