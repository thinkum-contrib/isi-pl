...
(CL:DEFUN STARTUP-UNIT-KB ()
  (CL:LET*
   ((*MODULE* (GET-STELLA-MODULE "/UNIT-SUPPORT" (> *STARTUP-TIME-PHASE* 1)))
    (*CONTEXT* *MODULE*))
   ...
   (CL:WHEN (CURRENT-STARTUP-TIME-PHASE? 2)
    ...
    (CL:SETQ SYM-UNIT-KB-UNIT-KB-UNITS
     (INTERN-RIGID-SYMBOL-WRT-MODULE "UNITS"
      (GET-STELLA-MODULE "/UNIT-KB" CL:T) 0))
    (CL:SETQ KWD-UNIT-KB--> (INTERN-RIGID-SYMBOL-WRT-MODULE "->" NULL 2))
    (CL:SETQ SYM-UNIT-KB-UNIT-SUPPORT-?DIM
     (INTERN-RIGID-SYMBOL-WRT-MODULE "?DIM" NULL 0))
    (CL:SETQ SYM-UNIT-KB-UNIT-KB-U+
     (INTERN-RIGID-SYMBOL-WRT-MODULE "U+" (GET-STELLA-MODULE "/UNIT-KB" CL:T)
      0))
    (CL:SETQ SYM-UNIT-KB-LOGIC-?Z
     (INTERN-RIGID-SYMBOL-WRT-MODULE "?Z" (GET-STELLA-MODULE "/LOGIC" CL:T)
      0))
    (CL:SETQ SYM-UNIT-KB-UNIT-KB-U-
     (INTERN-RIGID-SYMBOL-WRT-MODULE "U-" (GET-STELLA-MODULE "/UNIT-KB" CL:T)
      0))
   ...
   (CL:WHEN (CURRENT-STARTUP-TIME-PHASE? 7)
    (DEFINE-FUNCTION-OBJECT "STARTUP-UNIT-KB"
     "(DEFUN STARTUP-UNIT-KB () :PUBLIC? TRUE)" (CL:FUNCTION STARTUP-UNIT-KB)
     NULL)
    (CL:LET*
     ((FUNCTION (LOOKUP-FUNCTION SYM-UNIT-KB-UNIT-SUPPORT-STARTUP-UNIT-KB)))
    ...
    (CL:LET*
     ...
     (%DEFCONCEPT
      (CONS-LIST (COPY-CONS-TREE SYM-UNIT-KB-UNIT-KB-MEASURE)
       ...
       (COPY-CONS-TREE
        (WRAP-STRING "A (pre-defined) measure of some physical quantity."))))
     (%DEFCONCEPT
      (CONS-LIST (COPY-CONS-TREE SYM-UNIT-KB-UNIT-KB-BASE-MEASURE)
       ...
       (COPY-CONS-TREE
        (WRAP-STRING "A base measure.  One that defines fundamental units which
are not composed of any other units."))
       KWD-UNIT-KB-AXIOMS
       (COPY-CONS-TREE
        (GET-QUOTED-TREE "((CLOSED /UNIT-KB/BASE-MEASURE) \"/UNIT-SUPPORT\")"
         "/UNIT-SUPPORT"))))
     (%DEFRELATION
...
to that measure."))
       KWD-UNIT-KB-AXIOMS
       (COPY-CONS-TREE
        (GET-QUOTED-TREE "((CLOSED /UNIT-KB/MEASURE-UNIT) \"/UNIT-SUPPORT\")"
         "/UNIT-SUPPORT"))))
     (%DEFFUNCTION
      (CONS-LIST (COPY-CONS-TREE SYM-UNIT-KB-UNIT-KB-VALUE-MEASURE)
       (COPY-CONS-TREE
        (GET-QUOTED-TREE "((?DIM (?M /UNIT-KB/MEASURE)) \"/UNIT-SUPPORT\")"
         "/UNIT-SUPPORT"))
       KWD-UNIT-KB-DOCUMENTATION
       (COPY-CONS-TREE
        (WRAP-STRING
...
combinations of units or by arithmetic manipulations of dimensions."))
       ...
       (COPY-CONS-TREE
        (GET-QUOTED-TREE
         ...
         "/UNIT-SUPPORT"))))
     (%DEFFUNCTION
      (CONS-LIST (COPY-CONS-TREE SYM-UNIT-KB-UNIT-KB-NUMERATOR-MEASURES)
       (COPY-CONS-TREE
        (GET-QUOTED-TREE "((?DIM (?M /PL-KERNEL-KB/LIST)) \"/UNIT-SUPPORT\")"
         "/UNIT-SUPPORT"))
       KWD-UNIT-KB-DOCUMENTATION
       (COPY-CONS-TREE
...
The measures will be in a canonical order."))
       ...
       (COPY-CONS-TREE
        (GET-QUOTED-TREE
         ...
         "/UNIT-SUPPORT"))))
     (%DEFFUNCTION
      (CONS-LIST (COPY-CONS-TREE SYM-UNIT-KB-UNIT-KB-DENOMINATOR-MEASURES)
       (COPY-CONS-TREE
        (GET-QUOTED-TREE "((?DIM (?M /PL-KERNEL-KB/LIST)) \"/UNIT-SUPPORT\")"
         "/UNIT-SUPPORT"))
       KWD-UNIT-KB-DOCUMENTATION
...
The measures will be in a canonical order."))
     ...
     (%DEFRELATION
      (CONS-LIST (COPY-CONS-TREE SYM-UNIT-KB-UNIT-KB-COMENSURATE-UNITS)
       (COPY-CONS-TREE
        (GET-QUOTED-TREE "((?X ?Y) \"/UNIT-SUPPORT\")" "/UNIT-SUPPORT"))
       KWD-UNIT-KB-DOCUMENTATION
       (COPY-CONS-TREE
        (WRAP-STRING "A (computed) relation between units expressions that are
...
unit expressions (strings)"))
     ...
     (%DEFFUNCTION
      (CONS-LIST (COPY-CONS-TREE SYM-UNIT-KB-UNIT-KB-UNITS)
       (COPY-CONS-TREE
        (GET-QUOTED-TREE "(((?M NUMBER) (?U STRING)) \"/UNIT-SUPPORT\")"
         "/UNIT-SUPPORT"))
...
internal representation."))
     ...
     (%DEFFUNCTION
      (CONS-LIST (COPY-CONS-TREE SYM-UNIT-KB-UNIT-KB-U+)
       ...
       KWD-UNIT-KB-DOCUMENTATION
       (COPY-CONS-TREE (WRAP-STRING "Function that adds two dim numbers."))
       KWD-UNIT-KB-AXIOMS
       (COPY-CONS-TREE
        (GET-QUOTED-TREE
     ...
     (%DEFFUNCTION
      (CONS-LIST (COPY-CONS-TREE SYM-UNIT-KB-UNIT-KB-U-DIV)
       ...
       KWD-UNIT-KB--> (COPY-CONS-TREE SYM-UNIT-KB-LOGIC-?Z)
       KWD-UNIT-KB-DOCUMENTATION
       (COPY-CONS-TREE (WRAP-STRING "Function that divides two dim numbers."))
       KWD-UNIT-KB-AXIOMS
       (COPY-CONS-TREE
        (GET-QUOTED-TREE
     ...
     (%DEFFUNCTION
      (CONS-LIST (COPY-CONS-TREE SYM-UNIT-KB-UNIT-KB-U-SIGNUM)
       ...
       KWD-UNIT-KB-->
       (COPY-CONS-TREE
        (GET-QUOTED-TREE "((?Z INTEGER) \"/UNIT-SUPPORT\")" "/UNIT-SUPPORT"))
       KWD-UNIT-KB-DOCUMENTATION
     ...
     (%DEFRELATION
      (CONS-LIST (COPY-CONS-TREE SYM-UNIT-KB-UNIT-KB-U-WITHIN-DELTA)
       (COPY-CONS-TREE
        (GET-QUOTED-TREE "((?X ?Y ?Z) \"/UNIT-SUPPORT\")" "/UNIT-SUPPORT"))
       KWD-UNIT-KB-DOCUMENTATION
       (COPY-CONS-TREE
...
that prevent a straight equality test from succeeding."))
       KWD-UNIT-KB-=>
       (COPY-CONS-TREE
        (GET-QUOTED-TREE "((>= (/UNIT-KB/U-SIGNUM ?Z) 0) \"/UNIT-SUPPORT\")"
         "/UNIT-SUPPORT"))
       KWD-UNIT-KB-<=
       (COPY-CONS-TREE
        (GET-QUOTED-TREE
