  ...
  (CL:LET* ((*MODULE* (GET-STELLA-MODULE "/TIMEPOINT-SUPPORT" (> *STARTUP-TIME-PHASE* 1))) (*CONTEXT* *MODULE*))
   ...
   (CL:WHEN (CURRENT-STARTUP-TIME-PHASE? 2)
    (CL:SETQ SYM-TIMEPOINT-KB-TIMEPOINT-KB-TIMEPOINT
     (INTERN-RIGID-SYMBOL-WRT-MODULE "TIMEPOINT" (GET-STELLA-MODULE "/TIMEPOINT-KB" CL:T) 0))
    (CL:SETQ SYM-TIMEPOINT-KB-TIMEPOINT-KB-DAY-OF-WEEK
     (INTERN-RIGID-SYMBOL-WRT-MODULE "DAY-OF-WEEK" (GET-STELLA-MODULE "/TIMEPOINT-KB" CL:T) 0))
    ...
    (CL:SETQ SYM-TIMEPOINT-KB-TIMEPOINT-KB-TIMEPOINT-OF
     (INTERN-RIGID-SYMBOL-WRT-MODULE "TIMEPOINT-OF" (GET-STELLA-MODULE "/TIMEPOINT-KB" CL:T) 0))
    ...
    (CL:SETQ SYM-TIMEPOINT-KB-TIMEPOINT-SUPPORT-TIMEPOINT-OF-CONSTRAINT
     (INTERN-RIGID-SYMBOL-WRT-MODULE "TIMEPOINT-OF-CONSTRAINT" NULL 0))
    (CL:SETQ KWD-TIMEPOINT-KB-RELATION-SPECIALIST (INTERN-RIGID-SYMBOL-WRT-MODULE "RELATION-SPECIALIST" NULL 2))
    (CL:SETQ SYM-TIMEPOINT-KB-PL-KERNEL-KB-CONSTRAINT-SPECIALIST
     (INTERN-RIGID-SYMBOL-WRT-MODULE "CONSTRAINT-SPECIALIST" (GET-STELLA-MODULE "/PL-KERNEL-KB" CL:T) 0))
    (CL:SETQ SYM-TIMEPOINT-KB-TIMEPOINT-KB-DURATION-OF
     (INTERN-RIGID-SYMBOL-WRT-MODULE "DURATION-OF" (GET-STELLA-MODULE "/TIMEPOINT-KB" CL:T) 0))
    (CL:SETQ SYM-TIMEPOINT-KB-TIMEPOINT-SUPPORT-DURATION-OF-CONSTRAINT
     (INTERN-RIGID-SYMBOL-WRT-MODULE "DURATION-OF-CONSTRAINT" NULL 0))
    (CL:SETQ SYM-TIMEPOINT-KB-TIMEPOINT-KB-TIME-
     (INTERN-RIGID-SYMBOL-WRT-MODULE "TIME-" (GET-STELLA-MODULE "/TIMEPOINT-KB" CL:T) 0))
    (CL:SETQ SYM-TIMEPOINT-KB-TIMEPOINT-SUPPORT-TIME-MINUS-CONSTRAINT
     (INTERN-RIGID-SYMBOL-WRT-MODULE "TIME-MINUS-CONSTRAINT" NULL 0))
    (CL:SETQ SYM-TIMEPOINT-KB-TIMEPOINT-KB-TIME+
     (INTERN-RIGID-SYMBOL-WRT-MODULE "TIME+" (GET-STELLA-MODULE "/TIMEPOINT-KB" CL:T) 0))
    (CL:SETQ SYM-TIMEPOINT-KB-TIMEPOINT-SUPPORT-TIME-PLUS-CONSTRAINT
     (INTERN-RIGID-SYMBOL-WRT-MODULE "TIME-PLUS-CONSTRAINT" NULL 0))
    (CL:SETQ SYM-TIMEPOINT-KB-TIMEPOINT-KB-TIMEPOINT-OF*
     (INTERN-RIGID-SYMBOL-WRT-MODULE "TIMEPOINT-OF*" (GET-STELLA-MODULE "/TIMEPOINT-KB" CL:T) 0))
    (CL:SETQ KWD-TIMEPOINT-KB-RELATION-EVALUATOR (INTERN-RIGID-SYMBOL-WRT-MODULE "RELATION-EVALUATOR" NULL 2))
    (CL:SETQ SYM-TIMEPOINT-KB-TIMEPOINT-SUPPORT-TIMEPOINT-OF*-EVALUATOR
     (INTERN-RIGID-SYMBOL-WRT-MODULE "TIMEPOINT-OF*-EVALUATOR" NULL 0))
    (CL:SETQ SYM-TIMEPOINT-KB-TIMEPOINT-SUPPORT-TIMEPOINT-OF*-SPECIALIST
     (INTERN-RIGID-SYMBOL-WRT-MODULE "TIMEPOINT-OF*-SPECIALIST" NULL 0))
    (CL:SETQ SYM-TIMEPOINT-KB-TIMEPOINT-KB-TIMEPOINT-YEAR
     (INTERN-RIGID-SYMBOL-WRT-MODULE "TIMEPOINT-YEAR" (GET-STELLA-MODULE "/TIMEPOINT-KB" CL:T) 0))
    (CL:SETQ KWD-TIMEPOINT-KB-RELATION-COMPUTATION (INTERN-RIGID-SYMBOL-WRT-MODULE "RELATION-COMPUTATION" NULL 2))
    (CL:SETQ SYM-TIMEPOINT-KB-TIMEPOINT-SUPPORT-TIMEPOINT-YEAR-COMPUTATION
     (INTERN-RIGID-SYMBOL-WRT-MODULE "TIMEPOINT-YEAR-COMPUTATION" NULL 0))
    (CL:SETQ SYM-TIMEPOINT-KB-PL-KERNEL-KB-COMPUTATION-SPECIALIST
     (INTERN-RIGID-SYMBOL-WRT-MODULE "COMPUTATION-SPECIALIST" (GET-STELLA-MODULE "/PL-KERNEL-KB" CL:T) 0))
    (CL:SETQ SYM-TIMEPOINT-KB-TIMEPOINT-KB-TIMEPOINT-MONTH
     (INTERN-RIGID-SYMBOL-WRT-MODULE "TIMEPOINT-MONTH" (GET-STELLA-MODULE "/TIMEPOINT-KB" CL:T) 0))
    (CL:SETQ SYM-TIMEPOINT-KB-TIMEPOINT-SUPPORT-TIMEPOINT-MONTH-COMPUTATION
     (INTERN-RIGID-SYMBOL-WRT-MODULE "TIMEPOINT-MONTH-COMPUTATION" NULL 0))
    (CL:SETQ SYM-TIMEPOINT-KB-TIMEPOINT-KB-TIMEPOINT-DAY
     (INTERN-RIGID-SYMBOL-WRT-MODULE "TIMEPOINT-DAY" (GET-STELLA-MODULE "/TIMEPOINT-KB" CL:T) 0))
    (CL:SETQ SYM-TIMEPOINT-KB-TIMEPOINT-SUPPORT-TIMEPOINT-DAY-COMPUTATION
     (INTERN-RIGID-SYMBOL-WRT-MODULE "TIMEPOINT-DAY-COMPUTATION" NULL 0))
    (CL:SETQ SYM-TIMEPOINT-KB-TIMEPOINT-KB-TIMEPOINT-DAY-OF-WEEK
     (INTERN-RIGID-SYMBOL-WRT-MODULE "TIMEPOINT-DAY-OF-WEEK" (GET-STELLA-MODULE "/TIMEPOINT-KB" CL:T) 0))
    (CL:SETQ SYM-TIMEPOINT-KB-TIMEPOINT-SUPPORT-TIMEPOINT-DAY-OF-WEEK-COMPUTATION
     (INTERN-RIGID-SYMBOL-WRT-MODULE "TIMEPOINT-DAY-OF-WEEK-COMPUTATION" NULL 0))
    (CL:SETQ SYM-TIMEPOINT-KB-TIMEPOINT-KB-TIMEPOINT-HOUR
     (INTERN-RIGID-SYMBOL-WRT-MODULE "TIMEPOINT-HOUR" (GET-STELLA-MODULE "/TIMEPOINT-KB" CL:T) 0))
    (CL:SETQ SYM-TIMEPOINT-KB-TIMEPOINT-SUPPORT-TIMEPOINT-HOUR-COMPUTATION
     (INTERN-RIGID-SYMBOL-WRT-MODULE "TIMEPOINT-HOUR-COMPUTATION" NULL 0))
    (CL:SETQ SYM-TIMEPOINT-KB-TIMEPOINT-KB-TIMEPOINT-MINUTE
     (INTERN-RIGID-SYMBOL-WRT-MODULE "TIMEPOINT-MINUTE" (GET-STELLA-MODULE "/TIMEPOINT-KB" CL:T) 0))
    (CL:SETQ SYM-TIMEPOINT-KB-TIMEPOINT-SUPPORT-TIMEPOINT-MINUTE-COMPUTATION
     (INTERN-RIGID-SYMBOL-WRT-MODULE "TIMEPOINT-MINUTE-COMPUTATION" NULL 0))
    (CL:SETQ SYM-TIMEPOINT-KB-TIMEPOINT-KB-TIMEPOINT-SECOND
     (INTERN-RIGID-SYMBOL-WRT-MODULE "TIMEPOINT-SECOND" (GET-STELLA-MODULE "/TIMEPOINT-KB" CL:T) 0))
    (CL:SETQ SYM-TIMEPOINT-KB-TIMEPOINT-SUPPORT-TIMEPOINT-SECOND-COMPUTATION
     (INTERN-RIGID-SYMBOL-WRT-MODULE "TIMEPOINT-SECOND-COMPUTATION" NULL 0))
    (CL:SETQ SYM-TIMEPOINT-KB-TIMEPOINT-KB-TIMEPOINT-DATE
     (INTERN-RIGID-SYMBOL-WRT-MODULE "TIMEPOINT-DATE" (GET-STELLA-MODULE "/TIMEPOINT-KB" CL:T) 0))
    (CL:SETQ SYM-TIMEPOINT-KB-TIMEPOINT-SUPPORT-TIMEPOINT-DATE-COMPUTATION
     (INTERN-RIGID-SYMBOL-WRT-MODULE "TIMEPOINT-DATE-COMPUTATION" NULL 0))
    (CL:SETQ SYM-TIMEPOINT-KB-TIMEPOINT-KB-TIMEPOINT-TIME
     (INTERN-RIGID-SYMBOL-WRT-MODULE "TIMEPOINT-TIME" (GET-STELLA-MODULE "/TIMEPOINT-KB" CL:T) 0))
    (CL:SETQ SYM-TIMEPOINT-KB-TIMEPOINT-SUPPORT-TIMEPOINT-TIME-COMPUTATION
     (INTERN-RIGID-SYMBOL-WRT-MODULE "TIMEPOINT-TIME-COMPUTATION" NULL 0))
   ...
   (CL:WHEN (CURRENT-STARTUP-TIME-PHASE? 7)
    (DEFINE-FUNCTION-OBJECT "STARTUP-TIMEPOINT-KB" "(DEFUN STARTUP-TIMEPOINT-KB () :PUBLIC? TRUE)"
    ...
    (CL:LET* ((FUNCTION (LOOKUP-FUNCTION SYM-TIMEPOINT-KB-TIMEPOINT-SUPPORT-STARTUP-TIMEPOINT-KB)))
     (SET-DYNAMIC-SLOT-VALUE (%DYNAMIC-SLOTS FUNCTION) SYM-TIMEPOINT-KB-STELLA-METHOD-STARTUP-CLASSNAME
   ...
   (CL:WHEN (CURRENT-STARTUP-TIME-PHASE? 9) (%IN-MODULE (COPY-CONS-TREE (WRAP-STRING "TIMEPOINT-SUPPORT")))
    (CL:LET* ((*MODULE* (GET-STELLA-MODULE "PL-KERNEL-KB" CL:T)) (*CONTEXT* *MODULE*))
     ...
     (%DEFCONCEPT
      (CONS-LIST (COPY-CONS-TREE SYM-TIMEPOINT-KB-TIMEPOINT-KB-DAY-OF-WEEK) (COPY-CONS-TREE NIL)
       KWD-TIMEPOINT-KB-CLOSED (COPY-CONS-TREE SYM-TIMEPOINT-KB-STELLA-TRUE) KWD-TIMEPOINT-KB-AXIOMS
       (COPY-CONS-TREE
        (GET-QUOTED-TREE
     ...
     (%DEFFUNCTION
      (CONS-LIST (COPY-CONS-TREE SYM-TIMEPOINT-KB-TIMEPOINT-KB-TIMEPOINT-OF)
       (COPY-CONS-TREE (GET-QUOTED-TREE "(((?X STRING)) \"/TIMEPOINT-SUPPORT\")" "/TIMEPOINT-SUPPORT"))
       KWD-TIMEPOINT-KB--> (COPY-CONS-TREE SYM-TIMEPOINT-KB-TIMEPOINT-SUPPORT-?TP) KWD-TIMEPOINT-KB-DOCUMENTATION
       (COPY-CONS-TREE
...
milliseconds."))
     ...
     (%DEFFUNCTION
      (CONS-LIST (COPY-CONS-TREE SYM-TIMEPOINT-KB-TIMEPOINT-KB-TIME-)
       (COPY-CONS-TREE (GET-QUOTED-TREE "((?T1 ?T2 ?T3) \"/TIMEPOINT-SUPPORT\")" "/TIMEPOINT-SUPPORT"))
...
that time zone."))
       KWD-TIMEPOINT-KB-RELATION-EVALUATOR (COPY-CONS-TREE SYM-TIMEPOINT-KB-TIMEPOINT-SUPPORT-TIMEPOINT-OF*-EVALUATOR)
       KWD-TIMEPOINT-KB-RELATION-SPECIALIST
     ...
     (%DEFFUNCTION
      (CONS-LIST (COPY-CONS-TREE SYM-TIMEPOINT-KB-TIMEPOINT-KB-TIMEPOINT-YEAR)
       (COPY-CONS-TREE (GET-QUOTED-TREE "((?TP ?ZONE (?YEAR INTEGER)) \"/TIMEPOINT-SUPPORT\")" "/TIMEPOINT-SUPPORT"))
       KWD-TIMEPOINT-KB-DOCUMENTATION
       (COPY-CONS-TREE
...
As a ?zone input value common strings are also recognized."))
       ...
       (COPY-CONS-TREE SYM-TIMEPOINT-KB-TIMEPOINT-SUPPORT-TIMEPOINT-YEAR-COMPUTATION)
       KWD-TIMEPOINT-KB-RELATION-SPECIALIST (COPY-CONS-TREE SYM-TIMEPOINT-KB-PL-KERNEL-KB-COMPUTATION-SPECIALIST)))
     (%DEFFUNCTION
      (CONS-LIST (COPY-CONS-TREE SYM-TIMEPOINT-KB-TIMEPOINT-KB-TIMEPOINT-MONTH)
       (COPY-CONS-TREE (GET-QUOTED-TREE "((?TP ?ZONE (?MONTH INTEGER)) \"/TIMEPOINT-SUPPORT\")" "/TIMEPOINT-SUPPORT"))
       KWD-TIMEPOINT-KB-DOCUMENTATION
       (COPY-CONS-TREE
...
As a ?zone input value common strings are also recognized."))
       KWD-TIMEPOINT-KB-COMPUTED (COPY-CONS-TREE SYM-TIMEPOINT-KB-STELLA-TRUE) KWD-TIMEPOINT-KB-RELATION-COMPUTATION
       (COPY-CONS-TREE SYM-TIMEPOINT-KB-TIMEPOINT-SUPPORT-TIMEPOINT-MONTH-COMPUTATION)
       KWD-TIMEPOINT-KB-RELATION-SPECIALIST (COPY-CONS-TREE SYM-TIMEPOINT-KB-PL-KERNEL-KB-COMPUTATION-SPECIALIST)))
     (%DEFFUNCTION
      (CONS-LIST (COPY-CONS-TREE SYM-TIMEPOINT-KB-TIMEPOINT-KB-TIMEPOINT-DAY)
       (COPY-CONS-TREE (GET-QUOTED-TREE "((?TP ?ZONE (?DAY INTEGER)) \"/TIMEPOINT-SUPPORT\")" "/TIMEPOINT-SUPPORT"))
       KWD-TIMEPOINT-KB-DOCUMENTATION
       (COPY-CONS-TREE
...
As a ?zone input value common strings are also recognized."))
       KWD-TIMEPOINT-KB-COMPUTED (COPY-CONS-TREE SYM-TIMEPOINT-KB-STELLA-TRUE) KWD-TIMEPOINT-KB-RELATION-COMPUTATION
       (COPY-CONS-TREE SYM-TIMEPOINT-KB-TIMEPOINT-SUPPORT-TIMEPOINT-DAY-COMPUTATION)
       KWD-TIMEPOINT-KB-RELATION-SPECIALIST (COPY-CONS-TREE SYM-TIMEPOINT-KB-PL-KERNEL-KB-COMPUTATION-SPECIALIST)))
     (%DEFFUNCTION
      (CONS-LIST (COPY-CONS-TREE SYM-TIMEPOINT-KB-TIMEPOINT-KB-TIMEPOINT-DAY-OF-WEEK)
       (COPY-CONS-TREE
        (GET-QUOTED-TREE "((?TP ?ZONE (?DOW /TIMEPOINT-KB/DAY-OF-WEEK)) \"/TIMEPOINT-SUPPORT\")" "/TIMEPOINT-SUPPORT"))
       KWD-TIMEPOINT-KB-DOCUMENTATION
       (COPY-CONS-TREE
...
As a ?zone input value common strings are also recognized."))
       KWD-TIMEPOINT-KB-COMPUTED (COPY-CONS-TREE SYM-TIMEPOINT-KB-STELLA-TRUE) KWD-TIMEPOINT-KB-RELATION-COMPUTATION
       (COPY-CONS-TREE SYM-TIMEPOINT-KB-TIMEPOINT-SUPPORT-TIMEPOINT-DAY-OF-WEEK-COMPUTATION)
       KWD-TIMEPOINT-KB-RELATION-SPECIALIST (COPY-CONS-TREE SYM-TIMEPOINT-KB-PL-KERNEL-KB-COMPUTATION-SPECIALIST)))
     (%DEFFUNCTION
      (CONS-LIST (COPY-CONS-TREE SYM-TIMEPOINT-KB-TIMEPOINT-KB-TIMEPOINT-HOUR)
       (COPY-CONS-TREE (GET-QUOTED-TREE "((?TP ?ZONE (?HOUR INTEGER)) \"/TIMEPOINT-SUPPORT\")" "/TIMEPOINT-SUPPORT"))
       KWD-TIMEPOINT-KB-DOCUMENTATION
       (COPY-CONS-TREE
...
As a ?zone input value common strings are also recognized."))
       KWD-TIMEPOINT-KB-COMPUTED (COPY-CONS-TREE SYM-TIMEPOINT-KB-STELLA-TRUE) KWD-TIMEPOINT-KB-RELATION-COMPUTATION
       (COPY-CONS-TREE SYM-TIMEPOINT-KB-TIMEPOINT-SUPPORT-TIMEPOINT-HOUR-COMPUTATION)
       KWD-TIMEPOINT-KB-RELATION-SPECIALIST (COPY-CONS-TREE SYM-TIMEPOINT-KB-PL-KERNEL-KB-COMPUTATION-SPECIALIST)))
     (%DEFFUNCTION
      (CONS-LIST (COPY-CONS-TREE SYM-TIMEPOINT-KB-TIMEPOINT-KB-TIMEPOINT-MINUTE)
       (COPY-CONS-TREE (GET-QUOTED-TREE "((?TP ?ZONE (?MINUTE INTEGER)) \"/TIMEPOINT-SUPPORT\")" "/TIMEPOINT-SUPPORT"))
       KWD-TIMEPOINT-KB-DOCUMENTATION
       (COPY-CONS-TREE
...
As a ?zone input value common strings are also recognized."))
       KWD-TIMEPOINT-KB-COMPUTED (COPY-CONS-TREE SYM-TIMEPOINT-KB-STELLA-TRUE) KWD-TIMEPOINT-KB-RELATION-COMPUTATION
       (COPY-CONS-TREE SYM-TIMEPOINT-KB-TIMEPOINT-SUPPORT-TIMEPOINT-MINUTE-COMPUTATION)
       KWD-TIMEPOINT-KB-RELATION-SPECIALIST (COPY-CONS-TREE SYM-TIMEPOINT-KB-PL-KERNEL-KB-COMPUTATION-SPECIALIST)))
     (%DEFFUNCTION
      (CONS-LIST (COPY-CONS-TREE SYM-TIMEPOINT-KB-TIMEPOINT-KB-TIMEPOINT-SECOND)
       (COPY-CONS-TREE (GET-QUOTED-TREE "((?TP ?ZONE (?SECOND NUMBER)) \"/TIMEPOINT-SUPPORT\")" "/TIMEPOINT-SUPPORT"))
       KWD-TIMEPOINT-KB-DOCUMENTATION
       (COPY-CONS-TREE
...
As a ?zone input value common strings are also recognized."))
       KWD-TIMEPOINT-KB-COMPUTED (COPY-CONS-TREE SYM-TIMEPOINT-KB-STELLA-TRUE) KWD-TIMEPOINT-KB-RELATION-COMPUTATION
       (COPY-CONS-TREE SYM-TIMEPOINT-KB-TIMEPOINT-SUPPORT-TIMEPOINT-SECOND-COMPUTATION)
       KWD-TIMEPOINT-KB-RELATION-SPECIALIST (COPY-CONS-TREE SYM-TIMEPOINT-KB-PL-KERNEL-KB-COMPUTATION-SPECIALIST)))
     (%DEFFUNCTION
      (CONS-LIST (COPY-CONS-TREE SYM-TIMEPOINT-KB-TIMEPOINT-KB-TIMEPOINT-DATE)
       (COPY-CONS-TREE (GET-QUOTED-TREE "((?TP ?ZONE (?DATE STRING)) \"/TIMEPOINT-SUPPORT\")" "/TIMEPOINT-SUPPORT"))
       KWD-TIMEPOINT-KB-DOCUMENTATION
       (COPY-CONS-TREE
...
As a ?zone input value common strings are also recognized."))
       KWD-TIMEPOINT-KB-COMPUTED (COPY-CONS-TREE SYM-TIMEPOINT-KB-STELLA-TRUE) KWD-TIMEPOINT-KB-RELATION-COMPUTATION
       (COPY-CONS-TREE SYM-TIMEPOINT-KB-TIMEPOINT-SUPPORT-TIMEPOINT-DATE-COMPUTATION)
       KWD-TIMEPOINT-KB-RELATION-SPECIALIST (COPY-CONS-TREE SYM-TIMEPOINT-KB-PL-KERNEL-KB-COMPUTATION-SPECIALIST)))
     (%DEFFUNCTION
      (CONS-LIST (COPY-CONS-TREE SYM-TIMEPOINT-KB-TIMEPOINT-KB-TIMEPOINT-TIME)
       (COPY-CONS-TREE (GET-QUOTED-TREE "((?TP ?ZONE (?TIME STRING)) \"/TIMEPOINT-SUPPORT\")" "/TIMEPOINT-SUPPORT"))
       KWD-TIMEPOINT-KB-DOCUMENTATION
       (COPY-CONS-TREE
...
As a ?zone input value common strings are also recognized."))
       KWD-TIMEPOINT-KB-COMPUTED (COPY-CONS-TREE SYM-TIMEPOINT-KB-STELLA-TRUE) KWD-TIMEPOINT-KB-RELATION-COMPUTATION
       (COPY-CONS-TREE SYM-TIMEPOINT-KB-TIMEPOINT-SUPPORT-TIMEPOINT-TIME-COMPUTATION)
       KWD-TIMEPOINT-KB-RELATION-SPECIALIST (COPY-CONS-TREE SYM-TIMEPOINT-KB-PL-KERNEL-KB-COMPUTATION-SPECIALIST)))
     (PROCESS-DEFINITIONS)))))
