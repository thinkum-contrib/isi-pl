  ...
  (CL:LET*
   ...
   (CL:WHEN (CURRENT-STARTUP-TIME-PHASE? 2)
    ...
    (CL:SETQ SYM-TIMEPOINT-KB-TIMEPOINT-KB-DAY-OF-WEEK
     (INTERN-RIGID-SYMBOL-WRT-MODULE "DAY-OF-WEEK"
      (GET-STELLA-MODULE "/TIMEPOINT-KB" CL:T) 0))
    (CL:SETQ KWD-TIMEPOINT-KB-CLOSED
     (INTERN-RIGID-SYMBOL-WRT-MODULE "CLOSED" NULL 2))
    (CL:SETQ SYM-TIMEPOINT-KB-STELLA-TRUE
    ...
    (CL:SETQ KWD-TIMEPOINT-KB-COMPUTED
     (INTERN-RIGID-SYMBOL-WRT-MODULE "COMPUTED" NULL 2))
    (CL:SETQ KWD-TIMEPOINT-KB-RELATION-CONSTRAINT
     (INTERN-RIGID-SYMBOL-WRT-MODULE "RELATION-CONSTRAINT" NULL 2))
    ...
    (CL:SETQ SYM-TIMEPOINT-KB-TIMEPOINT-KB-TIMEPOINT-OF*
     (INTERN-RIGID-SYMBOL-WRT-MODULE "TIMEPOINT-OF*"
      (GET-STELLA-MODULE "/TIMEPOINT-KB" CL:T) 0))
    (CL:SETQ KWD-TIMEPOINT-KB-RELATION-EVALUATOR
     (INTERN-RIGID-SYMBOL-WRT-MODULE "RELATION-EVALUATOR" NULL 2))
    ...
    (CL:SETQ SYM-TIMEPOINT-KB-TIMEPOINT-KB-TIMEPOINT-YEAR
     (INTERN-RIGID-SYMBOL-WRT-MODULE "TIMEPOINT-YEAR"
      (GET-STELLA-MODULE "/TIMEPOINT-KB" CL:T) 0))
    (CL:SETQ KWD-TIMEPOINT-KB-RELATION-COMPUTATION
     (INTERN-RIGID-SYMBOL-WRT-MODULE "RELATION-COMPUTATION" NULL 2))
    ...
    (CL:SETQ SYM-TIMEPOINT-KB-PL-KERNEL-KB-COMPUTATION-SPECIALIST
     (INTERN-RIGID-SYMBOL-WRT-MODULE "COMPUTATION-SPECIALIST"
      (GET-STELLA-MODULE "/PL-KERNEL-KB" CL:T) 0))
    ...
    (CL:SETQ SYM-TIMEPOINT-KB-TIMEPOINT-KB-TIMEPOINT-DAY-OF-WEEK
     (INTERN-RIGID-SYMBOL-WRT-MODULE "TIMEPOINT-DAY-OF-WEEK"
      (GET-STELLA-MODULE "/TIMEPOINT-KB" CL:T) 0))
    (CL:SETQ
     SYM-TIMEPOINT-KB-TIMEPOINT-SUPPORT-TIMEPOINT-DAY-OF-WEEK-COMPUTATION
     (INTERN-RIGID-SYMBOL-WRT-MODULE "TIMEPOINT-DAY-OF-WEEK-COMPUTATION" NULL
      0))
   ...
   (CL:WHEN (CURRENT-STARTUP-TIME-PHASE? 9)
    ...
    (CL:LET*
     ...
     (CL:DECLARE (CL:SPECIAL *MODULE* *CONTEXT*))
     (%DEFCONCEPT
      (CONS-LIST (COPY-CONS-TREE SYM-TIMEPOINT-KB-TIMEPOINT-KB-TIMEPOINT)))
     (%DEFCONCEPT
      (CONS-LIST (COPY-CONS-TREE SYM-TIMEPOINT-KB-TIMEPOINT-KB-DAY-OF-WEEK)
       (COPY-CONS-TREE NIL) KWD-TIMEPOINT-KB-CLOSED
       (COPY-CONS-TREE SYM-TIMEPOINT-KB-STELLA-TRUE) KWD-TIMEPOINT-KB-AXIOMS
       (COPY-CONS-TREE
        (GET-QUOTED-TREE
     ...
     (%DEFFUNCTION
      (CONS-LIST (COPY-CONS-TREE SYM-TIMEPOINT-KB-TIMEPOINT-KB-TIMEPOINT-OF)
       ...
       (COPY-CONS-TREE
        (WRAP-STRING
         "Connects a STRING representation ?x of a time point to the actual
...
timepoints.ste."))
       KWD-TIMEPOINT-KB-COMPUTED (COPY-CONS-TREE SYM-TIMEPOINT-KB-STELLA-TRUE)
       KWD-TIMEPOINT-KB-RELATION-CONSTRAINT
       (COPY-CONS-TREE
        SYM-TIMEPOINT-KB-TIMEPOINT-SUPPORT-TIMEPOINT-OF-CONSTRAINT)
     ...
     (%DEFFUNCTION
      (CONS-LIST (COPY-CONS-TREE SYM-TIMEPOINT-KB-TIMEPOINT-KB-DURATION-OF)
       ...
       (COPY-CONS-TREE
        (WRAP-STRING
         "Connects a STRING representation ?x of a time duration to the
...
milliseconds."))
       ...
       KWD-TIMEPOINT-KB-RELATION-CONSTRAINT
       (COPY-CONS-TREE
        SYM-TIMEPOINT-KB-TIMEPOINT-SUPPORT-DURATION-OF-CONSTRAINT)
       KWD-TIMEPOINT-KB-RELATION-SPECIALIST
       (COPY-CONS-TREE SYM-TIMEPOINT-KB-PL-KERNEL-KB-CONSTRAINT-SPECIALIST)))
     (%DEFFUNCTION
...
which means it can also do addition."))
       ...
       KWD-TIMEPOINT-KB-RELATION-CONSTRAINT
       (COPY-CONS-TREE
        SYM-TIMEPOINT-KB-TIMEPOINT-SUPPORT-TIME-MINUS-CONSTRAINT)
       KWD-TIMEPOINT-KB-RELATION-SPECIALIST
       (COPY-CONS-TREE SYM-TIMEPOINT-KB-PL-KERNEL-KB-CONSTRAINT-SPECIALIST)))
     (%DEFFUNCTION
      (CONS-LIST (COPY-CONS-TREE SYM-TIMEPOINT-KB-TIMEPOINT-KB-TIME+)
...
generate any argument from the other two, which means it can also do subtraction."))
       ...
       KWD-TIMEPOINT-KB-RELATION-CONSTRAINT
       (COPY-CONS-TREE
        SYM-TIMEPOINT-KB-TIMEPOINT-SUPPORT-TIME-PLUS-CONSTRAINT)
       KWD-TIMEPOINT-KB-RELATION-SPECIALIST
       (COPY-CONS-TREE SYM-TIMEPOINT-KB-PL-KERNEL-KB-CONSTRAINT-SPECIALIST)))
     (%DEFFUNCTION
      (CONS-LIST (COPY-CONS-TREE SYM-TIMEPOINT-KB-TIMEPOINT-KB-TIMEPOINT-OF*)
...
that time zone."))
       KWD-TIMEPOINT-KB-RELATION-EVALUATOR
       (COPY-CONS-TREE
        SYM-TIMEPOINT-KB-TIMEPOINT-SUPPORT-TIMEPOINT-OF*-EVALUATOR)
       KWD-TIMEPOINT-KB-RELATION-SPECIALIST
       (COPY-CONS-TREE
        SYM-TIMEPOINT-KB-TIMEPOINT-SUPPORT-TIMEPOINT-OF*-SPECIALIST)))
     (%DEFFUNCTION
      (CONS-LIST (COPY-CONS-TREE SYM-TIMEPOINT-KB-TIMEPOINT-KB-TIMEPOINT-YEAR)
       (COPY-CONS-TREE
        (GET-QUOTED-TREE
         "((?TP ?ZONE (?YEAR INTEGER)) \"/TIMEPOINT-SUPPORT\")"
         "/TIMEPOINT-SUPPORT"))
       KWD-TIMEPOINT-KB-DOCUMENTATION
       (COPY-CONS-TREE
...
As a ?zone input value common strings are also recognized."))
       KWD-TIMEPOINT-KB-COMPUTED (COPY-CONS-TREE SYM-TIMEPOINT-KB-STELLA-TRUE)
       KWD-TIMEPOINT-KB-RELATION-COMPUTATION
       (COPY-CONS-TREE
        SYM-TIMEPOINT-KB-TIMEPOINT-SUPPORT-TIMEPOINT-YEAR-COMPUTATION)
       KWD-TIMEPOINT-KB-RELATION-SPECIALIST
...
As a ?zone input value common strings are also recognized."))
       ...
       KWD-TIMEPOINT-KB-RELATION-COMPUTATION
       (COPY-CONS-TREE
        SYM-TIMEPOINT-KB-TIMEPOINT-SUPPORT-TIMEPOINT-MONTH-COMPUTATION)
       KWD-TIMEPOINT-KB-RELATION-SPECIALIST
       (COPY-CONS-TREE SYM-TIMEPOINT-KB-PL-KERNEL-KB-COMPUTATION-SPECIALIST)))
     (%DEFFUNCTION
      (CONS-LIST (COPY-CONS-TREE SYM-TIMEPOINT-KB-TIMEPOINT-KB-TIMEPOINT-DAY)
       (COPY-CONS-TREE
        (GET-QUOTED-TREE "((?TP ?ZONE (?DAY INTEGER)) \"/TIMEPOINT-SUPPORT\")"
         "/TIMEPOINT-SUPPORT"))
       KWD-TIMEPOINT-KB-DOCUMENTATION
       (COPY-CONS-TREE
...
As a ?zone input value common strings are also recognized."))
       ...
       KWD-TIMEPOINT-KB-RELATION-COMPUTATION
       (COPY-CONS-TREE
        SYM-TIMEPOINT-KB-TIMEPOINT-SUPPORT-TIMEPOINT-DAY-COMPUTATION)
       KWD-TIMEPOINT-KB-RELATION-SPECIALIST
       (COPY-CONS-TREE SYM-TIMEPOINT-KB-PL-KERNEL-KB-COMPUTATION-SPECIALIST)))
     (%DEFFUNCTION
      (CONS-LIST
       (COPY-CONS-TREE SYM-TIMEPOINT-KB-TIMEPOINT-KB-TIMEPOINT-DAY-OF-WEEK)
       (COPY-CONS-TREE
        (GET-QUOTED-TREE
...
As a ?zone input value common strings are also recognized."))
       ...
       KWD-TIMEPOINT-KB-RELATION-COMPUTATION
       (COPY-CONS-TREE
        SYM-TIMEPOINT-KB-TIMEPOINT-SUPPORT-TIMEPOINT-HOUR-COMPUTATION)
       KWD-TIMEPOINT-KB-RELATION-SPECIALIST
       (COPY-CONS-TREE SYM-TIMEPOINT-KB-PL-KERNEL-KB-COMPUTATION-SPECIALIST)))
     (%DEFFUNCTION
      (CONS-LIST
...
As a ?zone input value common strings are also recognized."))
       ...
       KWD-TIMEPOINT-KB-RELATION-COMPUTATION
       (COPY-CONS-TREE
        SYM-TIMEPOINT-KB-TIMEPOINT-SUPPORT-TIMEPOINT-MINUTE-COMPUTATION)
       KWD-TIMEPOINT-KB-RELATION-SPECIALIST
       (COPY-CONS-TREE SYM-TIMEPOINT-KB-PL-KERNEL-KB-COMPUTATION-SPECIALIST)))
     (%DEFFUNCTION
      (CONS-LIST
...
As a ?zone input value common strings are also recognized."))
       ...
       KWD-TIMEPOINT-KB-RELATION-COMPUTATION
       (COPY-CONS-TREE
        SYM-TIMEPOINT-KB-TIMEPOINT-SUPPORT-TIMEPOINT-SECOND-COMPUTATION)
       KWD-TIMEPOINT-KB-RELATION-SPECIALIST
       (COPY-CONS-TREE SYM-TIMEPOINT-KB-PL-KERNEL-KB-COMPUTATION-SPECIALIST)))
     (%DEFFUNCTION
      (CONS-LIST (COPY-CONS-TREE SYM-TIMEPOINT-KB-TIMEPOINT-KB-TIMEPOINT-DATE)
       (COPY-CONS-TREE
        (GET-QUOTED-TREE "((?TP ?ZONE (?DATE STRING)) \"/TIMEPOINT-SUPPORT\")"
         "/TIMEPOINT-SUPPORT"))
       KWD-TIMEPOINT-KB-DOCUMENTATION
       (COPY-CONS-TREE
...
As a ?zone input value common strings are also recognized."))
       ...
       KWD-TIMEPOINT-KB-RELATION-COMPUTATION
       (COPY-CONS-TREE
        SYM-TIMEPOINT-KB-TIMEPOINT-SUPPORT-TIMEPOINT-DATE-COMPUTATION)
       KWD-TIMEPOINT-KB-RELATION-SPECIALIST
       (COPY-CONS-TREE SYM-TIMEPOINT-KB-PL-KERNEL-KB-COMPUTATION-SPECIALIST)))
     (%DEFFUNCTION
      (CONS-LIST (COPY-CONS-TREE SYM-TIMEPOINT-KB-TIMEPOINT-KB-TIMEPOINT-TIME)
       (COPY-CONS-TREE
        (GET-QUOTED-TREE "((?TP ?ZONE (?TIME STRING)) \"/TIMEPOINT-SUPPORT\")"
         "/TIMEPOINT-SUPPORT"))
       KWD-TIMEPOINT-KB-DOCUMENTATION
       (COPY-CONS-TREE
...
As a ?zone input value common strings are also recognized."))
       ...
       KWD-TIMEPOINT-KB-RELATION-COMPUTATION
       (COPY-CONS-TREE
        SYM-TIMEPOINT-KB-TIMEPOINT-SUPPORT-TIMEPOINT-TIME-COMPUTATION)
       KWD-TIMEPOINT-KB-RELATION-SPECIALIST
       (COPY-CONS-TREE SYM-TIMEPOINT-KB-PL-KERNEL-KB-COMPUTATION-SPECIALIST)))
     (PROCESS-DEFINITIONS)))))
