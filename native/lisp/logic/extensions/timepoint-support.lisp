...
(CL:DECLAIM
 (CL:SPECIAL *STARTUP-TIME-PHASE* *MODULE* *ZONE-STRINGS* TRUE-WRAPPER FALSE-WRAPPER NULL-FLOAT NULL-INTEGER NIL
  *PRINTREADABLY?*))
...
(CL:DEFUN NEW-DATE-TIME-LOGIC-WRAPPER (WRAPPER-VALUE)
  (CL:LET* ((SELF NULL)) (CL:SETQ SELF (CL:MAKE-INSTANCE (CL:QUOTE DATE-TIME-LOGIC-WRAPPER)))
     ...
     (CL:LET* ((TEST-VALUE-000 (SAFE-PRIMARY-TYPE DATETIME)))
      (CL:COND
       ((SUBTYPE-OF? TEST-VALUE-000 SGT-TIMEPOINT-SUPPORT-STELLA-CALENDAR-DATE)
        (CL:PROGN
         (CL:SETQ TERM
          (CONS (GENERATE-TERM SGT-TIMEPOINT-SUPPORT-TIMEPOINT-KB-TIMEPOINT-OF)
           (CONS (WRAP-STRING (CALENDAR-DATE-TO-STRING DATETIME 0.0d0 CL:NIL CL:T)) NIL)))))
...
that all logic-wrapped DATE-TIME-OBJECTs are the same object."
  (CL:LET* ((WRAPPER (LOOKUP *DATE-TIME-HASH-TABLE* VALUE)))
   (CL:WHEN (CL:EQ WRAPPER NULL) (CL:SETQ WRAPPER (NEW-DATE-TIME-LOGIC-WRAPPER VALUE))
  ...
  (CL:LET* ((TEST-VALUE-001 (SAFE-PRIMARY-TYPE ITEM)))
   (CL:COND
    ((SUBTYPE-OF-STRING? TEST-VALUE-001)
     (CL:PROGN
      (CL:LET* ((VALUE (STRING-TO-CALENDAR-DATE (%WRAPPER-VALUE ITEM))))
    ...
    ((SUBTYPE-OF? TEST-VALUE-001 SGT-TIMEPOINT-SUPPORT-LOGIC-PATTERN-VARIABLE)
     (CL:PROGN
      (CL:LET* ((VALUE (SAFE-BOUND-TO ITEM)))
       (CL:IF (CL:NOT (CL:EQ VALUE NULL)) (HELP-GET-CALENDAR-TIME VALUE) NULL))))
    ...
    ((SUBTYPE-OF? TEST-VALUE-001 SGT-TIMEPOINT-SUPPORT-LOGIC-SKOLEM)
     (CL:PROGN
      (CL:LET* ((VALUE (ACCESS-IN-CONTEXT (%VARIABLE-VALUE ITEM) (%HOME-CONTEXT ITEM) CL:NIL)))
       (CL:WHEN (CL:EQ VALUE NULL) (CL:RETURN-FROM HELP-GET-CALENDAR-TIME NULL))
       (CL:LET* ((TEST-VALUE-000 (SAFE-PRIMARY-TYPE VALUE)))
        (CL:COND
         ((SUBTYPE-OF? TEST-VALUE-000 SGT-TIMEPOINT-SUPPORT-TIMEPOINT-SUPPORT-DATE-TIME-LOGIC-WRAPPER)
          (CL:PROGN VALUE))
         ((SUBTYPE-OF? TEST-VALUE-000 SGT-TIMEPOINT-SUPPORT-LOGIC-SKOLEM)
          (CL:PROGN
           (CL:IF
            ...
            NULL (HELP-GET-CALENDAR-TIME (ACCESS-IN-CONTEXT (%VARIABLE-VALUE VALUE) (%HOME-CONTEXT VALUE) CL:NIL)))))
         (CL:T
          (CL:IF
           (ISA? (ACCESS-IN-CONTEXT (%VARIABLE-VALUE ITEM) (%HOME-CONTEXT ITEM) CL:NIL)
            SGT-TIMEPOINT-SUPPORT-LOGIC-SKOLEM)
           NULL (HELP-GET-CALENDAR-TIME (ACCESS-IN-CONTEXT (%VARIABLE-VALUE ITEM) (%HOME-CONTEXT ITEM) CL:NIL)))))))))
    (CL:T NULL))))
...
(CL:DEFUN HELP-GET-TIME-DURATION (ITEM)
  (CL:LET* ((TEST-VALUE-001 (SAFE-PRIMARY-TYPE ITEM)))
   (CL:COND
    ((SUBTYPE-OF-STRING? TEST-VALUE-001)
     (CL:PROGN
      (CL:LET* ((VALUE (STRING-TO-TIME-DURATION (%WRAPPER-VALUE ITEM))))
       (CL:IF (CL:NOT (CL:EQ VALUE NULL)) (WRAP-DATE-TIME VALUE) NULL))))
    ((SUBTYPE-OF? TEST-VALUE-001 SGT-TIMEPOINT-SUPPORT-LOGIC-PATTERN-VARIABLE)
     (CL:PROGN
      (CL:LET* ((VALUE (SAFE-BOUND-TO ITEM)))
       (CL:IF (CL:NOT (CL:EQ VALUE NULL)) (HELP-GET-TIME-DURATION VALUE) NULL))))
    ((SUBTYPE-OF? TEST-VALUE-001 SGT-TIMEPOINT-SUPPORT-TIMEPOINT-SUPPORT-DATE-TIME-LOGIC-WRAPPER) (CL:PROGN ITEM))
    ((SUBTYPE-OF? TEST-VALUE-001 SGT-TIMEPOINT-SUPPORT-UNIT-SUPPORT-DIM-NUMBER-LOGIC-WRAPPER)
     (CL:PROGN
      (CL:HANDLER-CASE
       (CL:RETURN-FROM HELP-GET-TIME-DURATION (WRAP-DATE-TIME (DIM-TO-TIME-DURATION (%WRAPPER-VALUE ITEM))))
       (INCOMPATIBLE-UNITS-EXCEPTION () NULL))))
    ((SUBTYPE-OF? TEST-VALUE-001 SGT-TIMEPOINT-SUPPORT-LOGIC-SKOLEM)
     (CL:PROGN
      (CL:LET* ((VALUE (ACCESS-IN-CONTEXT (%VARIABLE-VALUE ITEM) (%HOME-CONTEXT ITEM) CL:NIL)))
       (CL:WHEN (CL:EQ VALUE NULL) (CL:RETURN-FROM HELP-GET-TIME-DURATION NULL))
       (CL:LET* ((TEST-VALUE-000 (SAFE-PRIMARY-TYPE VALUE)))
        (CL:COND
         ((SUBTYPE-OF? TEST-VALUE-000 SGT-TIMEPOINT-SUPPORT-TIMEPOINT-SUPPORT-DATE-TIME-LOGIC-WRAPPER)
          (CL:PROGN VALUE))
         ((SUBTYPE-OF? TEST-VALUE-000 SGT-TIMEPOINT-SUPPORT-LOGIC-SKOLEM)
          (CL:PROGN
           (CL:IF
            (ISA? (ACCESS-IN-CONTEXT (%VARIABLE-VALUE VALUE) (%HOME-CONTEXT VALUE) CL:NIL)
             SGT-TIMEPOINT-SUPPORT-LOGIC-SKOLEM)
            NULL (HELP-GET-TIME-DURATION (ACCESS-IN-CONTEXT (%VARIABLE-VALUE VALUE) (%HOME-CONTEXT VALUE) CL:NIL)))))
         (CL:T
          (CL:IF
           (ISA? (ACCESS-IN-CONTEXT (%VARIABLE-VALUE ITEM) (%HOME-CONTEXT ITEM) CL:NIL)
            SGT-TIMEPOINT-SUPPORT-LOGIC-SKOLEM)
           NULL (HELP-GET-TIME-DURATION (ACCESS-IN-CONTEXT (%VARIABLE-VALUE ITEM) (%HOME-CONTEXT ITEM) CL:NIL)))))))))
    (CL:T NULL))))
  ...
  (CL:LET* ((TEST-VALUE-001 (SAFE-PRIMARY-TYPE ITEM)))
   (CL:COND
    ((SUBTYPE-OF-STRING? TEST-VALUE-001)
     (CL:PROGN
      (CL:LET* ((VALUE (STRING-TO-CALENDAR-DATE (%WRAPPER-VALUE ITEM))))
       (CL:WHEN (CL:EQ VALUE NULL) (CL:SETQ VALUE (STRING-TO-TIME-DURATION (%WRAPPER-VALUE ITEM))))
       (CL:IF (CL:NOT (CL:EQ VALUE NULL)) (WRAP-DATE-TIME VALUE) NULL))))
    ((SUBTYPE-OF? TEST-VALUE-001 SGT-TIMEPOINT-SUPPORT-LOGIC-PATTERN-VARIABLE)
     (CL:PROGN
      (CL:LET* ((VALUE (SAFE-BOUND-TO ITEM))) (CL:IF (CL:NOT (CL:EQ VALUE NULL)) (HELP-GET-TIME-OBJECT VALUE) NULL))))
    ((SUBTYPE-OF? TEST-VALUE-001 SGT-TIMEPOINT-SUPPORT-TIMEPOINT-SUPPORT-DATE-TIME-LOGIC-WRAPPER) (CL:PROGN ITEM))
    ((SUBTYPE-OF? TEST-VALUE-001 SGT-TIMEPOINT-SUPPORT-UNIT-SUPPORT-DIM-NUMBER-LOGIC-WRAPPER)
     (CL:PROGN
      (CL:HANDLER-CASE
       (CL:RETURN-FROM HELP-GET-TIME-OBJECT (WRAP-DATE-TIME (DIM-TO-TIME-DURATION (%WRAPPER-VALUE ITEM))))
       (INCOMPATIBLE-UNITS-EXCEPTION () NULL))))
    ((SUBTYPE-OF? TEST-VALUE-001 SGT-TIMEPOINT-SUPPORT-LOGIC-SKOLEM)
     (CL:PROGN
      (CL:LET* ((VALUE (ACCESS-IN-CONTEXT (%VARIABLE-VALUE ITEM) (%HOME-CONTEXT ITEM) CL:NIL)))
         ...
         ((SUBTYPE-OF? TEST-VALUE-000 SGT-TIMEPOINT-SUPPORT-LOGIC-SKOLEM)
          (CL:PROGN
           (CL:IF
            (ISA? (ACCESS-IN-CONTEXT (%VARIABLE-VALUE VALUE) (%HOME-CONTEXT VALUE) CL:NIL)
             SGT-TIMEPOINT-SUPPORT-LOGIC-SKOLEM)
            NULL (HELP-GET-TIME-OBJECT (ACCESS-IN-CONTEXT (%VARIABLE-VALUE VALUE) (%HOME-CONTEXT VALUE) CL:NIL)))))
         (CL:T
          (CL:IF
           (ISA? (ACCESS-IN-CONTEXT (%VARIABLE-VALUE ITEM) (%HOME-CONTEXT ITEM) CL:NIL)
            SGT-TIMEPOINT-SUPPORT-LOGIC-SKOLEM)
           NULL (HELP-GET-TIME-OBJECT (ACCESS-IN-CONTEXT (%VARIABLE-VALUE ITEM) (%HOME-CONTEXT ITEM) CL:NIL)))))))))
    (CL:T NULL))))
   ...
   (CL:LET* ((TEST-VALUE-000 (SAFE-PRIMARY-TYPE OBJ)))
    (CL:COND
     ((SUBTYPE-OF-FLOAT? TEST-VALUE-000)
      (CL:PROGN (CL:IF (INTEGER-VALUED? (%WRAPPER-VALUE OBJ)) (FLOOR (%WRAPPER-VALUE OBJ)) NULL-INTEGER)))
...
(CL:DEFUN HELP-GET-FLOAT (OBJ)
  (CL:IF (CL:EQ OBJ NULL) NULL-FLOAT
   (CL:LET* ((TEST-VALUE-000 (SAFE-PRIMARY-TYPE OBJ)))
    (CL:COND ((SUBTYPE-OF-FLOAT? TEST-VALUE-000) (CL:PROGN (%WRAPPER-VALUE OBJ)))
     ((SUBTYPE-OF-INTEGER? TEST-VALUE-000) (CL:PROGN (CL:FLOAT (%WRAPPER-VALUE OBJ) 0.0d0))) (CL:T NULL-FLOAT)))))
...
(CL:DEFUN HELP-GET-TIMEZONE (OBJ)
  (CL:IF (CL:EQ OBJ NULL) NULL-FLOAT
   (CL:LET* ((TEST-VALUE-000 (SAFE-PRIMARY-TYPE OBJ)))
    (CL:COND ((SUBTYPE-OF-FLOAT? TEST-VALUE-000) (CL:PROGN (%WRAPPER-VALUE OBJ)))
     ((SUBTYPE-OF-INTEGER? TEST-VALUE-000) (CL:PROGN (CL:FLOAT (%WRAPPER-VALUE OBJ) 0.0d0)))
     ((SUBTYPE-OF-STRING? TEST-VALUE-000)
      (CL:PROGN
       (CL:LET* ((DECODED-ZONE (ZONE (WRAP-STRING (STRING-DOWNCASE (%WRAPPER-VALUE OBJ))))))
        (CL:IF (CL:NOT (CL:EQ DECODED-ZONE NULL)) (%WRAPPER-VALUE DECODED-ZONE) NULL-FLOAT))))
     (CL:T NULL-FLOAT)))))
         ...
         (CL:WHEN
          (CL:NOT
           (CL:AND (CL:NOT (CL:EQ OLD-VALUE-000 NULL))
            (CL:EQ (PRIMARY-TYPE OLD-VALUE-000) SGT-TIMEPOINT-SUPPORT-STELLA-CS-VALUE)))
...
(CL:DEFUN TIMEPOINT-OF-CONSTRAINT (MISSING-ARGUMENT X1 X2)
  (CL:LET* ((VALUE NULL))
   (CL:CASE (%WRAPPER-VALUE MISSING-ARGUMENT)
    (-1
     (CL:SETQ VALUE
      (CL:IF (OBJECT-EQL? (%WRAPPER-VALUE (HELP-GET-CALENDAR-TIME X1)) (%WRAPPER-VALUE X2)) TRUE-WRAPPER
       FALSE-WRAPPER)))
    (0
...
(CL:DEFUN TIMEPOINT-OF*-COMPUTATION (YY MM DD HR MIN SEC TZ)
  (CL:LET*
   ((YY-VALUE (VALUE-OF YY)) (MM-VALUE (VALUE-OF MM)) (DD-VALUE (VALUE-OF DD)) (HR-VALUE (VALUE-OF HR))
    (MIN-VALUE (VALUE-OF MIN)) (SEC-VALUE (VALUE-OF SEC)) (TZ-VALUE (VALUE-OF TZ)) (YEAR (HELP-GET-INTEGER YY-VALUE))
    (MONTH (HELP-GET-INTEGER MM-VALUE)) (DAY (HELP-GET-INTEGER DD-VALUE)) (HOUR (HELP-GET-INTEGER HR-VALUE))
    (MINUTE (HELP-GET-INTEGER MIN-VALUE)) (SECOND-FLOAT (HELP-GET-FLOAT SEC-VALUE)) (ZONE (HELP-GET-TIMEZONE TZ-VALUE))
    (SECOND 0) (TP NULL))
   (CL:DECLARE (CL:TYPE CL:FIXNUM YEAR MONTH DAY HOUR MINUTE SECOND) (CL:TYPE CL:DOUBLE-FLOAT SECOND-FLOAT ZONE))
   (CL:WHEN
    (CL:AND (CL:NOT (CL:= YEAR NULL-INTEGER)) (CL:NOT (CL:= MONTH NULL-INTEGER)) (CL:NOT (CL:= DAY NULL-INTEGER))
     (CL:NOT (CL:= HOUR NULL-INTEGER)) (CL:NOT (CL:= MINUTE NULL-INTEGER)) (CL:NOT (CL:= SECOND-FLOAT NULL-FLOAT))
     (CL:NOT (CL:= ZONE NULL-FLOAT)))
    (CL:SETQ SECOND (FLOOR SECOND-FLOAT))
    (CL:SETQ TP
     (WRAP-DATE-TIME
      (MAKE-DATE-TIME YEAR MONTH DAY HOUR MINUTE SECOND (FLOOR (CL:* 1000 (CL:- SECOND-FLOAT SECOND))) ZONE))))
   TP))
...
(CL:DEFUN TIMEPOINT-OF*-EVALUATOR (SELF)
  ...
  (CL:LET*
   ((STOREDVALUE (VALUE-OF (CL:AREF (CL:THE CL:SIMPLE-VECTOR (%THE-ARRAY (%ARGUMENTS SELF))) 7)))
    (COMPUTATION (LOOKUP-FUNCTION SYM-TIMEPOINT-SUPPORT-TIMEPOINT-SUPPORT-TIMEPOINT-OF*-COMPUTATION))
    (COMPUTEDVALUE (COMPUTE-RELATION-VALUE SELF COMPUTATION CL:NIL)))
   (CL:WHEN (CL:AND (CL:NOT (CL:EQ COMPUTEDVALUE NULL)) (CL:NOT (EQL? COMPUTEDVALUE STOREDVALUE)))
...
(CL:DEFUN TIMEPOINT-OF*-SPECIALIST (FRAME LASTMOVE)
  (CL:LET*
   ((PROPOSITION (%PROPOSITION FRAME)) (ARGS (%ARGUMENTS PROPOSITION))
    ...
    (SECOND-FLOAT (HELP-GET-FLOAT (ARGUMENT-BOUND-TO (CL:AREF (CL:THE CL:SIMPLE-VECTOR (%THE-ARRAY ARGS)) 5))))
    (SECOND 0) (ZONE (HELP-GET-TIMEZONE (ARGUMENT-BOUND-TO (CL:AREF (CL:THE CL:SIMPLE-VECTOR (%THE-ARRAY ARGS)) 6))))
    (TP (ARGUMENT-BOUND-TO (CL:AREF (CL:THE CL:SIMPLE-VECTOR (%THE-ARRAY ARGS)) 7))) (THE-TIME NULL)
    (CALENDAR-DATE NULL))
   (CL:DECLARE (CL:TYPE CL:FIXNUM YEAR MONTH DAY HOUR MINUTE SECOND) (CL:TYPE CL:DOUBLE-FLOAT SECOND-FLOAT ZONE))
   ...
   (CL:COND
    ((CL:AND (CL:NOT (CL:= YEAR NULL-INTEGER)) (CL:NOT (CL:= MONTH NULL-INTEGER)) (CL:NOT (CL:= DAY NULL-INTEGER))
     ...
     (CL:SETQ THE-TIME
      (WRAP-DATE-TIME
       (MAKE-DATE-TIME YEAR MONTH DAY HOUR MINUTE SECOND (FLOOR (CL:* 1000 (CL:- SECOND-FLOAT SECOND))) ZONE)))
     (SELECT-PROOF-RESULT
      (BIND-ARGUMENT-TO-VALUE? (CL:AREF (CL:THE CL:SIMPLE-VECTOR (%THE-ARRAY ARGS)) 7) THE-TIME CL:T) CL:NIL CL:T))
    ((CL:NOT (CL:EQ TP NULL)) (CL:SETQ THE-TIME (HELP-GET-CALENDAR-TIME TP))
     ...
     (CL:WHEN (CL:= ZONE NULL-FLOAT) (CL:SETQ ZONE 0.0d0)
      (CL:WHEN
       (CL:NOT
        (BIND-ARGUMENT-TO-VALUE? (CL:AREF (CL:THE CL:SIMPLE-VECTOR (%THE-ARRAY ARGS)) 6) (WRAP-FLOAT ZONE) CL:T))
       (CL:RETURN-FROM TIMEPOINT-OF*-SPECIALIST KWD-TIMEPOINT-SUPPORT-FAILURE)))
     (CL:IF (CL:NOT (CL:EQ THE-TIME NULL))
      (CL:LET* ((YY NULL-INTEGER) (MM NULL-INTEGER) (DD NULL-INTEGER) (DOW NULL))
       ...
       (CL:LET* ((H NULL-INTEGER) (M NULL-INTEGER) (S NULL-INTEGER) (MILLI NULL-INTEGER))
        (CL:DECLARE (CL:TYPE CL:FIXNUM H M S MILLI))
        (CL:MULTIPLE-VALUE-SETQ (H M S MILLI) (GET-TIME CALENDAR-DATE ZONE))
        (SELECT-PROOF-RESULT
         (CAN-BIND-ALL?
          (CONS-LIST (CL:AREF (CL:THE CL:SIMPLE-VECTOR (%THE-ARRAY ARGS)) 0)
...
(CL:DEFUN DURATION-OF-CONSTRAINT (MISSING-ARGUMENT X1 X2)
  (CL:LET* ((VALUE NULL))
   (CL:CASE (%WRAPPER-VALUE MISSING-ARGUMENT)
    (-1
     (CL:SETQ VALUE
      (CL:IF (OBJECT-EQL? (%WRAPPER-VALUE (HELP-GET-TIME-DURATION X1)) (%WRAPPER-VALUE X2)) TRUE-WRAPPER
       FALSE-WRAPPER)))
    (0
     (CL:LET* ((DURATIONWRAPPER (HELP-GET-TIME-DURATION X2)))
      (CL:SETQ VALUE (WRAP-STRING (TIME-DURATION-TO-STRING (%WRAPPER-VALUE DURATIONWRAPPER))))))
    (1
...
(CL:DEFUN TIME-MINUS-CONSTRAINT (MISSING-ARGUMENT X1 X2 X3)
  (CL:LET* ((VALUE NULL))
   (CL:CASE (%WRAPPER-VALUE MISSING-ARGUMENT)
    (-1
     (CL:SETQ VALUE
      (CL:IF (OBJECT-EQL? (TIME-SUBTRACT (%WRAPPER-VALUE X1) (%WRAPPER-VALUE X2)) (%WRAPPER-VALUE X3)) TRUE-WRAPPER
       FALSE-WRAPPER)))
...
(CL:DEFUN TIME-PLUS-CONSTRAINT (MISSING-ARGUMENT X1 X2 X3)
  (CL:LET* ((VALUE NULL))
   (CL:CASE (%WRAPPER-VALUE MISSING-ARGUMENT)
    (-1
     (CL:SETQ VALUE
      (CL:IF (OBJECT-EQL? (TIME-ADD (%WRAPPER-VALUE X1) (%WRAPPER-VALUE X2)) (%WRAPPER-VALUE X3)) TRUE-WRAPPER
       FALSE-WRAPPER)))
...
(CL:DEFUN HELP-GET-TIME-ZONE (TIME-ZONE-SPECIFIER)
  (CL:WHEN (CL:EQ TIME-ZONE-SPECIFIER NULL) (CL:RETURN-FROM HELP-GET-TIME-ZONE NULL-FLOAT))
  (CL:LET* ((TEST-VALUE-000 (SAFE-PRIMARY-TYPE TIME-ZONE-SPECIFIER)))
   (CL:COND
    ((SUBTYPE-OF-STRING? TEST-VALUE-000)
     (CL:PROGN
      (CL:LET* ((ZONE (LOOKUP *ZONE-STRINGS* (STRING-DOWNCASE (%WRAPPER-VALUE TIME-ZONE-SPECIFIER)))))
       (CL:IF (CL:EQ ZONE NULL) NULL-FLOAT (%WRAPPER-VALUE ZONE)))))
    ((SUBTYPE-OF-INTEGER? TEST-VALUE-000) (CL:PROGN (CL:FLOAT (%WRAPPER-VALUE TIME-ZONE-SPECIFIER) 0.0d0)))
    ((SUBTYPE-OF-FLOAT? TEST-VALUE-000) (CL:PROGN (%WRAPPER-VALUE TIME-ZONE-SPECIFIER))) (CL:T NULL-FLOAT))))
...
(CL:DEFUN DOW-KEYWORD-TO-INSTANCE (DOW)
  (CL:COND ((CL:EQ DOW KWD-TIMEPOINT-SUPPORT-MONDAY) (%SURROGATE-VALUE SGT-TIMEPOINT-SUPPORT-TIMEPOINT-KB-MONDAY))
   ...
   (CL:T
    (CL:LET* ((STREAM-000 (NEW-OUTPUT-STRING-STREAM)))
     (%%PRINT-STREAM (%NATIVE-STREAM STREAM-000) "`" DOW "' is not a valid case option")
     (CL:ERROR (NEW-STELLA-EXCEPTION (THE-STRING-READER STREAM-000)))))))
  ...
  (CL:IF (CL:NOT (CL:EQ TIMEZONE NULL))
   (CL:LET* ((YEAR NULL-INTEGER) (MONTH NULL-INTEGER) (DAY NULL-INTEGER) (DOW NULL))
    ...
    (CL:MULTIPLE-VALUE-SETQ (YEAR MONTH DAY DOW)
     (GET-CALENDAR-DATE (%WRAPPER-VALUE TIMEPOINT) (%WRAPPER-VALUE TIMEZONE)))
...
(CL:DEFUN TIMEPOINT-HOUR-COMPUTATION (TIMEPOINT TIMEZONE)
  (CL:SETQ TIMEZONE (WRAP-FLOAT (HELP-GET-TIME-ZONE TIMEZONE)))
  (CL:IF (CL:NOT (CL:EQ TIMEZONE NULL))
   (CL:LET* ((HOUR NULL-INTEGER) (MINUTE NULL-INTEGER) (SECOND NULL-INTEGER) (MILLISECOND NULL-INTEGER))
    (CL:DECLARE (CL:TYPE CL:FIXNUM HOUR MINUTE SECOND MILLISECOND))
    (CL:MULTIPLE-VALUE-SETQ (HOUR MINUTE SECOND MILLISECOND)
     (GET-TIME (%WRAPPER-VALUE TIMEPOINT) (%WRAPPER-VALUE TIMEZONE)))
...
(CL:DEFUN TIMEPOINT-SECOND-COMPUTATION (TIMEPOINT TIMEZONE)
  ...
  (CL:IF (CL:NOT (CL:EQ TIMEZONE NULL))
   (CL:LET* ((HOUR NULL-INTEGER) (MINUTE NULL-INTEGER) (SECOND NULL-INTEGER) (MILLISECOND NULL-INTEGER))
    ...
    (CL:IF (CL:= MILLISECOND 0) (WRAP-INTEGER SECOND) (WRAP-FLOAT (CL:+ SECOND (CL:* MILLISECOND 0.001d0)))))
   NULL))
...
(CL:DEFUN TIMEPOINT-DATE-COMPUTATION (TIMEPOINT TIMEZONE)
  (CL:SETQ TIMEZONE (WRAP-FLOAT (HELP-GET-TIME-ZONE TIMEZONE)))
  (CL:IF (CL:NOT (CL:EQ TIMEZONE NULL))
   (WRAP-STRING (CALENDAR-DATE-TO-DATE-STRING (%WRAPPER-VALUE TIMEPOINT) (%WRAPPER-VALUE TIMEZONE) CL:NIL)) NULL))
...
(CL:DEFUN TIMEPOINT-TIME-COMPUTATION (TIMEPOINT TIMEZONE)
  (CL:SETQ TIMEZONE (WRAP-FLOAT (HELP-GET-TIME-ZONE TIMEZONE)))
  (CL:IF (CL:NOT (CL:EQ TIMEZONE NULL))
   (WRAP-STRING (CALENDAR-DATE-TO-TIME-STRING (%WRAPPER-VALUE TIMEPOINT) (%WRAPPER-VALUE TIMEZONE) CL:T CL:T CL:T))
   NULL))
...
(CL:DEFUN HELP-STARTUP-TIMEPOINT-SUPPORT1 ()
  (CL:PROGN
   ...
   (CL:SETQ SGT-TIMEPOINT-SUPPORT-TIMEPOINT-KB-TIMEPOINT-OF
    (INTERN-RIGID-SYMBOL-WRT-MODULE "TIMEPOINT-OF" (GET-STELLA-MODULE "/TIMEPOINT-KB" CL:T) 1))
   (CL:SETQ SGT-TIMEPOINT-SUPPORT-TIMEPOINT-KB-DURATION-OF
    (INTERN-RIGID-SYMBOL-WRT-MODULE "DURATION-OF" (GET-STELLA-MODULE "/TIMEPOINT-KB" CL:T) 1))
   ...
   (CL:SETQ SGT-TIMEPOINT-SUPPORT-TIMEPOINT-KB-MONDAY
    (INTERN-RIGID-SYMBOL-WRT-MODULE "MONDAY" (GET-STELLA-MODULE "/TIMEPOINT-KB" CL:T) 1))
   ...
   (CL:SETQ SGT-TIMEPOINT-SUPPORT-TIMEPOINT-KB-TUESDAY
    (INTERN-RIGID-SYMBOL-WRT-MODULE "TUESDAY" (GET-STELLA-MODULE "/TIMEPOINT-KB" CL:T) 1))
   ...
   (CL:SETQ SGT-TIMEPOINT-SUPPORT-TIMEPOINT-KB-WEDNESDAY
    (INTERN-RIGID-SYMBOL-WRT-MODULE "WEDNESDAY" (GET-STELLA-MODULE "/TIMEPOINT-KB" CL:T) 1))
   ...
   (CL:SETQ SGT-TIMEPOINT-SUPPORT-TIMEPOINT-KB-THURSDAY
    (INTERN-RIGID-SYMBOL-WRT-MODULE "THURSDAY" (GET-STELLA-MODULE "/TIMEPOINT-KB" CL:T) 1))
   ...
   (CL:SETQ SGT-TIMEPOINT-SUPPORT-TIMEPOINT-KB-FRIDAY
    (INTERN-RIGID-SYMBOL-WRT-MODULE "FRIDAY" (GET-STELLA-MODULE "/TIMEPOINT-KB" CL:T) 1))
   ...
   (CL:SETQ SGT-TIMEPOINT-SUPPORT-TIMEPOINT-KB-SATURDAY
    (INTERN-RIGID-SYMBOL-WRT-MODULE "SATURDAY" (GET-STELLA-MODULE "/TIMEPOINT-KB" CL:T) 1))
   ...
   (CL:SETQ SGT-TIMEPOINT-SUPPORT-TIMEPOINT-KB-SUNDAY
    (INTERN-RIGID-SYMBOL-WRT-MODULE "SUNDAY" (GET-STELLA-MODULE "/TIMEPOINT-KB" CL:T) 1))
...
(CL:DEFUN STARTUP-TIMEPOINT-SUPPORT ()
  (CL:LET* ((*MODULE* (GET-STELLA-MODULE "/TIMEPOINT-SUPPORT" (> *STARTUP-TIME-PHASE* 1))) (*CONTEXT* *MODULE*))
   ...
   (CL:WHEN (CURRENT-STARTUP-TIME-PHASE? 7)
    (DEFINE-METHOD-OBJECT "(DEFMETHOD (GENERATE-SPECIALIZED-TERM OBJECT) ((SELF DATE-TIME-LOGIC-WRAPPER)))"
     (CL:FUNCTION GENERATE-SPECIALIZED-TERM) NULL)
    (DEFINE-METHOD-OBJECT "(DEFMETHOD (HASH-CODE INTEGER) ((SELF DATE-TIME-LOGIC-WRAPPER)))" (CL:FUNCTION HASH-CODE)
     NULL)
    (DEFINE-METHOD-OBJECT "(DEFMETHOD (OBJECT-EQL? BOOLEAN) ((SELF DATE-TIME-LOGIC-WRAPPER) (X OBJECT)))"
...
that all logic-wrapped DATE-TIME-OBJECTs are the same object.\")" (CL:FUNCTION WRAP-DATE-TIME) NULL)
    (DEFINE-FUNCTION-OBJECT "HELP-GET-CALENDAR-TIME"
     "(DEFUN (HELP-GET-CALENDAR-TIME DATE-TIME-LOGIC-WRAPPER) ((ITEM OBJECT)))" (CL:FUNCTION HELP-GET-CALENDAR-TIME)
     NULL)
    (DEFINE-FUNCTION-OBJECT "HELP-GET-TIME-DURATION"
     "(DEFUN (HELP-GET-TIME-DURATION DATE-TIME-LOGIC-WRAPPER) ((ITEM OBJECT)))" (CL:FUNCTION HELP-GET-TIME-DURATION)
     NULL)
    (DEFINE-FUNCTION-OBJECT "HELP-GET-TIME-OBJECT"
     "(DEFUN (HELP-GET-TIME-OBJECT DATE-TIME-LOGIC-WRAPPER) ((ITEM OBJECT)))" (CL:FUNCTION HELP-GET-TIME-OBJECT) NULL)
    (DEFINE-FUNCTION-OBJECT "HELP-GET-INTEGER" "(DEFUN (HELP-GET-INTEGER INTEGER) ((OBJ OBJECT)))"
     (CL:FUNCTION HELP-GET-INTEGER) NULL)
    (DEFINE-FUNCTION-OBJECT "HELP-GET-FLOAT" "(DEFUN (HELP-GET-FLOAT FLOAT) ((OBJ OBJECT)))"
     (CL:FUNCTION HELP-GET-FLOAT) NULL)
    (DEFINE-FUNCTION-OBJECT "HELP-GET-TIMEZONE" "(DEFUN (HELP-GET-TIMEZONE FLOAT) ((OBJ OBJECT)))"
     (CL:FUNCTION HELP-GET-TIMEZONE) NULL)
    (DEFINE-FUNCTION-OBJECT "CAN-BIND-ALL?" "(DEFUN (CAN-BIND-ALL? BOOLEAN) ((PL-OBJECTS CONS) (VALUES CONS)))"
    ...
    (DEFINE-FUNCTION-OBJECT "TIMEPOINT-OF*-EVALUATOR" "(DEFUN TIMEPOINT-OF*-EVALUATOR ((SELF PROPOSITION)))"
    ...
    (DEFINE-FUNCTION-OBJECT "HELP-GET-TIME-ZONE" "(DEFUN (HELP-GET-TIME-ZONE FLOAT) ((TIME-ZONE-SPECIFIER OBJECT)))"
     (CL:FUNCTION HELP-GET-TIME-ZONE) NULL)
    (DEFINE-FUNCTION-OBJECT "DOW-KEYWORD-TO-INSTANCE" "(DEFUN (DOW-KEYWORD-TO-INSTANCE LOGIC-OBJECT) ((DOW KEYWORD)))"
    ...
    (DEFINE-FUNCTION-OBJECT "STARTUP-TIMEPOINT-SUPPORT" "(DEFUN STARTUP-TIMEPOINT-SUPPORT () :PUBLIC? TRUE)"
    ...
    (CL:LET* ((FUNCTION (LOOKUP-FUNCTION SYM-TIMEPOINT-SUPPORT-TIMEPOINT-SUPPORT-STARTUP-TIMEPOINT-SUPPORT)))
     (SET-DYNAMIC-SLOT-VALUE (%DYNAMIC-SLOTS FUNCTION) SYM-TIMEPOINT-SUPPORT-STELLA-METHOD-STARTUP-CLASSNAME
