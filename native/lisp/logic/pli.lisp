...
(CL:DECLAIM
 (CL:SPECIAL STELLA::*STARTUP-TIME-PHASE* STELLA::INCONSISTENT-TRUTH-VALUE STELLA::UNKNOWN-TRUTH-VALUE
  STELLA::FALSE-TRUTH-VALUE STELLA::DEFAULT-FALSE-TRUTH-VALUE STELLA::STANDARD-OUTPUT STELLA::EOL STELLA::KEYWORD-SYM
  STELLA::TRUE-TRUTH-VALUE STELLA::DEFAULT-TRUE-TRUTH-VALUE STELLA::*REVERSEPOLARITY?* STELLA::*ROOT-MODULE*
  STELLA::*LOGIC-MODULE* STELLA::*CONTEXT* STELLA::*KIF-SENTENCE-OPERATORS* STELLA::*KIF-TERM-OPERATORS*
  STELLA::NULL-INTEGER STELLA::*MODULE* STELLA::NIL STELLA::*POWERLOOM-LOCK* STELLA::*BOOTSTRAP-LOCK*))
...
is called more than once, every call after the first one is a no-op."
  (STELLA::WITH-PROCESS-LOCK STELLA::*BOOTSTRAP-LOCK*
   (CL:WHEN (CL:NOT *POWERLOOM-INITIALIZED?*) (STELLA::STARTUP-LOGIC-SYSTEM))))
...
(CL:DEFUN NEW-ENVIRONMENT ()
  (CL:LET* ((SELF STELLA::NULL)) (CL:SETQ SELF (CL:MAKE-INSTANCE (CL:QUOTE ENVIRONMENT)))
...
(CL:DEFUN ACCESS-ENVIRONMENT-SLOT-VALUE (SELF SLOTNAME VALUE SETVALUE?)
  (CL:COND
   ((CL:EQ SLOTNAME SYM-PLI-LOGIC-LEVEL)
    (CL:IF SETVALUE? (CL:SETF (STELLA::%LEVEL SELF) (STELLA::%WRAPPER-VALUE VALUE))
...
(CL:DEFUN NEW-PL-ITERATOR ()
  (CL:LET* ((SELF STELLA::NULL)) (CL:SETQ SELF (CL:MAKE-INSTANCE (CL:QUOTE PL-ITERATOR)))
   (CL:SETF (STELLA::%FIRST-ITERATION? SELF) CL:T) (CL:SETF (STELLA::%VALUE SELF) STELLA::NULL)
...
(CL:DEFUN ACCESS-PL-ITERATOR-SLOT-VALUE (SELF SLOTNAME VALUE SETVALUE?)
  (CL:COND
   ((CL:EQ SLOTNAME SYM-PLI-STELLA-CURSOR)
    (CL:IF SETVALUE? (CL:SETF (STELLA::%CURSOR SELF) VALUE) (CL:SETQ VALUE (STELLA::%CURSOR SELF))))
   (CL:T
    (CL:LET* ((STREAM-000 (STELLA::NEW-OUTPUT-STRING-STREAM)))
     (STELLA::%%PRINT-STREAM (STELLA::%NATIVE-STREAM STREAM-000) "`" SLOTNAME "' is not a valid case option")
     (CL:ERROR (STELLA::NEW-STELLA-EXCEPTION (STELLA::THE-STRING-READER STREAM-000))))))
...
elements are available, `false' otherwise."
  (CL:LET* ((CURSOR (STELLA::%CURSOR SELF)))
   (CL:WHEN (CL:EQ CURSOR STELLA::NIL) (CL:SETF (STELLA::%VALUE SELF) STELLA::NULL)
    (CL:RETURN-FROM STELLA::NEXT? CL:NIL))
   (CL:SETF (STELLA::%VALUE SELF) (STELLA::%%VALUE CURSOR)) (CL:SETF (STELLA::%CURSOR SELF) (STELLA::%%REST CURSOR))
   CL:T))
...
(CL:DEFUN CONS-TO-PL-ITERATOR (SELF)
  ...
  (CL:IF (CL:EQ SELF STELLA::NIL) EMPTY-PL-ITERATOR
   (CL:LET* ((SELF-000 (NEW-PL-ITERATOR))) (CL:SETF (STELLA::%CURSOR SELF-000) SELF)
     ...
     (CL:LOOP WHILE (STELLA::NEXT? ITER-000) DO (CL:SETQ X (STELLA::%VALUE ITER-000))
      (CL:IF (CL:EQ COLLECT-000 STELLA::NULL)
       (CL:PROGN (CL:SETQ COLLECT-000 (STELLA::CONS X STELLA::NIL))
        (CL:IF (CL:EQ VALUE-001 STELLA::NIL) (CL:SETQ VALUE-001 COLLECT-000)
         (STELLA::ADD-CONS-TO-END-OF-CONS-LIST VALUE-001 COLLECT-000)))
       (CL:PROGN (CL:SETF (STELLA::%%REST COLLECT-000) (STELLA::CONS X STELLA::NIL))
  ...
  (CL:LET* ((VALUE-000 STELLA::NIL))
   (CL:LET* ((X STELLA::NULL) (ITER-000 SELF) (COLLECT-000 STELLA::NULL))
    (CL:LOOP WHILE (STELLA::NEXT? ITER-000) DO (CL:SETQ X (STELLA::%VALUE ITER-000))
     (CL:IF (CL:EQ COLLECT-000 STELLA::NULL)
      (CL:PROGN (CL:SETQ COLLECT-000 (STELLA::CONS X STELLA::NIL))
       (CL:IF (CL:EQ VALUE-000 STELLA::NIL) (CL:SETQ VALUE-000 COLLECT-000)
...
(CL:DEFUN SAFELY-GET-OBJECT (NAME MODULE ENVIRONMENT)
  ...
  (CL:LET* ((OBJECT (GET-OBJECT NAME MODULE ENVIRONMENT)))
   (CL:IF (CL:EQ OBJECT STELLA::NULL)
    (CL:LET* ((STREAM-000 (STELLA::NEW-OUTPUT-STRING-STREAM)))
     (STELLA::%%PRINT-STREAM (STELLA::%NATIVE-STREAM STREAM-000) "Can't find an object named `" NAME "'")
...
(CL:DEFUN SAFELY-GET-CONCEPT (NAME MODULE ENVIRONMENT)
  ...
  (CL:LET* ((OBJECT (GET-CONCEPT NAME MODULE ENVIRONMENT)))
   (CL:IF (CL:EQ OBJECT STELLA::NULL)
    (CL:LET* ((STREAM-000 (STELLA::NEW-OUTPUT-STRING-STREAM)))
     (STELLA::%%PRINT-STREAM (STELLA::%NATIVE-STREAM STREAM-000) "Can't find a concept named `" NAME "'")
     (CL:ERROR (STELLA::NEW-NO-SUCH-OBJECT-EXCEPTION (STELLA::THE-STRING-READER STREAM-000))))
    OBJECT)))
...
(CL:DEFUN SAFELY-GET-RELATION (NAME MODULE ENVIRONMENT)
  ...
  (CL:LET* ((OBJECT (GET-RELATION NAME MODULE ENVIRONMENT)))
   (CL:IF (CL:EQ OBJECT STELLA::NULL)
    (CL:LET* ((STREAM-000 (STELLA::NEW-OUTPUT-STRING-STREAM)))
     (STELLA::%%PRINT-STREAM (STELLA::%NATIVE-STREAM STREAM-000) "Can't find a relation named `" NAME "'")
     (CL:ERROR (STELLA::NEW-NO-SUCH-OBJECT-EXCEPTION (STELLA::THE-STRING-READER STREAM-000))))
    OBJECT)))
...
(CL:DEFUN SAFELY-GET-MODULE (NAME ENVIRONMENT)
  ...
  (CL:WHEN (CL:OR (CL:EQ NAME STELLA::NULL-STRING) (STELLA::STRING-EQL? NAME ""))
...
(CL:DEFUN SAFELY-GET-OBJECT-OR-NULL (NAME MODULE ENVIRONMENT)
  ...
  (CL:CHECK-TYPE NAME CL:SIMPLE-STRING)
  (CL:WHEN
   (CL:OR (CL:EQ MODULE STELLA::NULL) (CL:EQ NAME STELLA::NULL-STRING) (STELLA::STRING-EQL? NAME "")
    (STELLA::STRING-EQUAL? NAME "null"))
   (CL:RETURN-FROM SAFELY-GET-OBJECT-OR-NULL STELLA::NULL))
  (CL:HANDLER-CASE (CL:RETURN-FROM SAFELY-GET-OBJECT-OR-NULL (GET-OBJECT NAME MODULE ENVIRONMENT))
...
(CL:DEFUN SEQUENCE-TO-CONS-LIST (SEQUENCE)
  (CL:LET* ((TEST-VALUE-000 (STELLA::SAFE-PRIMARY-TYPE SEQUENCE)))
   (CL:COND ((CL:EQ TEST-VALUE-000 SGT-PLI-STELLA-CONS) (CL:PROGN SEQUENCE))
    ...
    ((STELLA::SUBTYPE-OF? TEST-VALUE-000 SGT-PLI-STELLA-VECTOR)
     (CL:PROGN
      (CL:LET* ((RESULT STELLA::NIL))
       (CL:LET*
        ((I STELLA::NULL-INTEGER) (ITER-000 0) (UPPER-BOUND-000 (STELLA::LENGTH SEQUENCE)) (COLLECT-000 STELLA::NULL))
        (CL:DECLARE (CL:TYPE CL:FIXNUM I ITER-000 UPPER-BOUND-000))
        (CL:LOOP WHILE (CL:<= ITER-000 UPPER-BOUND-000) DO (CL:SETQ I ITER-000)
         (CL:IF (CL:EQ COLLECT-000 STELLA::NULL)
          (CL:PROGN
           (CL:SETQ COLLECT-000
            (STELLA::CONS (CL:AREF (CL:THE CL:SIMPLE-VECTOR (STELLA::%THE-ARRAY SEQUENCE)) I) STELLA::NIL))
    ...
    (CL:T
     (CL:LET* ((STREAM-000 (STELLA::NEW-OUTPUT-STRING-STREAM)))
      (STELLA::%%PRINT-STREAM (STELLA::%NATIVE-STREAM STREAM-000) "Don't know how to convert object of type `"
...
(CL:DEFUN EXPLODE-STRING-LIST (STRINGLIST MODULE)
  ...
  (CL:LET* ((STELLA::*MODULE* MODULE) (STELLA::*CONTEXT* STELLA::*MODULE*))
     ...
     (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-000 STELLA::NIL)) DO (CL:SETQ REF (STELLA::%%VALUE ITER-000))
      ...
      (CL:IF (CL:EQ COLLECT-000 STELLA::NULL)
       (CL:PROGN (CL:SETQ COLLECT-000 (STELLA::CONS TERM STELLA::NIL))
        (CL:IF (CL:EQ RESULT STELLA::NIL) (CL:SETQ RESULT COLLECT-000)
         (STELLA::ADD-CONS-TO-END-OF-CONS-LIST RESULT COLLECT-000)))
       (CL:PROGN (CL:SETF (STELLA::%%REST COLLECT-000) (STELLA::CONS TERM STELLA::NIL))
        (CL:SETQ COLLECT-000 (STELLA::%%REST COLLECT-000))))
...
(CL:DEFUN LEGAL-OPERATOR? (OPERATOR)
  (CL:OR (STELLA::MEMBER? STELLA::*KIF-SENTENCE-OPERATORS* OPERATOR)
   ...
   (STELLA::MEMBER?
    (STELLA::GET-QUOTED-TREE "((<=>> <<=> <<=>> <~> <~>> <<~> <<~>> ABOUT <<= =>> <~ ~> <<~ ~>>) \"/PLI\")" "/PLI")
    OPERATOR)))
...
exists.  `name' is ALWAYS treated case sensitively."
  ...
  (CL:LET* ((MDL-000 MODULE) (CXT-000 MDL-000))
   ...
   (CL:LET* ((STELLA::*MODULE* MDL-000) (STELLA::*CONTEXT* CXT-000))
    (CL:DECLARE (CL:SPECIAL STELLA::*MODULE* STELLA::*CONTEXT*)) (CL:SETQ ENVIRONMENT ENVIRONMENT)
...
If no such operator exists then a `no-such-object' exception is thrown."
  ...
  (CL:LET* ((OPERATOR (STELLA::LOOKUP-SYMBOL-IN-MODULE NAME STELLA::*LOGIC-MODULE* CL:NIL)))
   (CL:IF (CL:AND (CL:NOT (CL:EQ OPERATOR STELLA::NULL)) (LEGAL-OPERATOR? OPERATOR)) OPERATOR
    (CL:LET* ((STREAM-000 (STELLA::NEW-OUTPUT-STRING-STREAM)))
     (STELLA::%%PRINT-STREAM (STELLA::%NATIVE-STREAM STREAM-000) "No operator named `" NAME "'")
     (CL:ERROR (STELLA::NEW-NO-SUCH-OBJECT-EXCEPTION (STELLA::THE-STRING-READER STREAM-000)))))))
  ...
  (CL:LET* ((MDL-000 MODULE) (CXT-000 MDL-000))
   ...
   (CL:LET* ((STELLA::*MODULE* MDL-000) (STELLA::*CONTEXT* CXT-000))
    ...
    (STELLA::WITH-PROCESS-LOCK STELLA::*POWERLOOM-LOCK*
     (CONS-TO-PL-ITERATOR (STELLA::CALL-LIST-UNDEFINED-RELATIONS MODULE CL:NIL))))))
    ...
    (STELLA::WITH-PROCESS-LOCK STELLA::*POWERLOOM-LOCK*
     (CL:LET* ((TEST-VALUE-000 (STELLA::SAFE-PRIMARY-TYPE OBJ)))
      (CL:COND ((STELLA::SUBTYPE-OF? TEST-VALUE-000 SGT-PLI-LOGIC-SKOLEM) (CL:PROGN STELLA::NULL-STRING))
       ...
       ((STELLA::SUBTYPE-OF? TEST-VALUE-000 SGT-PLI-LOGIC-COMPUTED-PROCEDURE)
        (CL:PROGN (STELLA::STRINGIFY (STELLA::%SURROGATE-VALUE-INVERSE OBJ))))
...
(CL:DEFUN GET-SHORT-NAME (OBJ)
  ...
  (CL:LET* ((TEST-VALUE-000 (STELLA::SAFE-PRIMARY-TYPE OBJ)))
   (CL:COND ((STELLA::SUBTYPE-OF? TEST-VALUE-000 SGT-PLI-LOGIC-SKOLEM) (CL:PROGN STELLA::NULL-STRING))
    ...
    ((STELLA::SUBTYPE-OF? TEST-VALUE-000 SGT-PLI-STELLA-CONTEXT) (CL:PROGN (STELLA::CONTEXT-NAME OBJ)))
    ((STELLA::SUBTYPE-OF? TEST-VALUE-000 SGT-PLI-LOGIC-COMPUTED-PROCEDURE)
     (CL:PROGN (STELLA::%SYMBOL-NAME (STELLA::%SURROGATE-VALUE-INVERSE OBJ))))
    (CL:T STELLA::NULL-STRING))))
      ...
      ((STELLA::SUBTYPE-OF? TEST-VALUE-000 SGT-PLI-LOGIC-SKOLEM)
       (CL:PROGN
        (CL:LET* ((VALUE (STELLA::VALUE-OF SELF)))
         (CL:IF (CL:EQ VALUE SELF) (STELLA::STRINGIFY SELF) (OBJECT-TO-STRING VALUE)))))
   ...
   (CL:COND
     ...
     (CL:PROGN
      (CL:LET* ((VALUE (STELLA::VALUE-OF SELF)))
       (CL:IF (CL:EQ VALUE SELF)
        (CL:LET* ((STREAM-000 (STELLA::NEW-OUTPUT-STRING-STREAM)))
         (STELLA::%%PRINT-STREAM (STELLA::%NATIVE-STREAM STREAM-000) "Can't coerce `" SELF "' to an integer.")
         (CL:ERROR (STELLA::NEW-STELLA-EXCEPTION (STELLA::THE-STRING-READER STREAM-000))))
    ...
    (CL:T
     (CL:LET* ((STREAM-001 (STELLA::NEW-OUTPUT-STRING-STREAM)))
      (STELLA::%%PRINT-STREAM (STELLA::%NATIVE-STREAM STREAM-001) "Can't coerce `" SELF "' to an integer.")
...
(CL:DEFUN OBJECT-TO-FLOAT (SELF)
  ...
  (CL:LET* ((TEST-VALUE-000 (STELLA::SAFE-PRIMARY-TYPE SELF)))
   (CL:COND
    ((STELLA::SUBTYPE-OF? TEST-VALUE-000 SGT-PLI-LOGIC-SKOLEM)
     (CL:PROGN
      (CL:LET* ((VALUE (STELLA::VALUE-OF SELF)))
       (CL:IF (CL:EQ VALUE SELF)
        (CL:LET* ((STREAM-000 (STELLA::NEW-OUTPUT-STRING-STREAM)))
         (STELLA::%%PRINT-STREAM (STELLA::%NATIVE-STREAM STREAM-000) "Can't coerce `" SELF "' to a float.")
         (CL:ERROR (STELLA::NEW-STELLA-EXCEPTION (STELLA::THE-STRING-READER STREAM-000))))
    ...
    (CL:T
     (CL:LET* ((STREAM-001 (STELLA::NEW-OUTPUT-STRING-STREAM)))
      (STELLA::%%PRINT-STREAM (STELLA::%NATIVE-STREAM STREAM-001) "Can't coerce `" SELF "' to a float.")
      (CL:ERROR (STELLA::NEW-STELLA-EXCEPTION (STELLA::THE-STRING-READER STREAM-001))))))))
...
escaped double quotes around strings."
  (CL:COND
   ((STELLA::SUBTYPE-OF-STRING? (STELLA::SAFE-PRIMARY-TYPE SELF))
    (CL:PROGN (STELLA::CONCATENATE "\"" (STELLA::%WRAPPER-VALUE SELF) "\"")))
           ...
           ((STELLA::SUBTYPE-OF-STRING? TEST-VALUE-000)
            (CL:PROGN
             (CL:IF (STELLA::SUBRELATION-OF? TYPE *STRING-CONCEPT*) OBJ
              (CL:LET* ((STREAM-000 (STELLA::NEW-OUTPUT-STRING-STREAM)))
               (STELLA::%%PRINT-STREAM (STELLA::%NATIVE-STREAM STREAM-000) "String argument found, but `" TYPE
            ...
            (CL:PROGN
             (CL:COND ((STELLA::SUBRELATION-OF? TYPE *INTEGER-CONCEPT*) OBJ)
              ((STELLA::SUBRELATION-OF? TYPE *FLOAT-CONCEPT*)
               (STELLA::WRAP-FLOAT (CL:FLOAT (STELLA::%WRAPPER-VALUE OBJ) 0.0d0)))
              (CL:T (GET-OBJECT STRING MODULE ENVIRONMENT)))))
           ((STELLA::SUBTYPE-OF-FLOAT? TEST-VALUE-000)
            (CL:PROGN
             (CL:COND ((STELLA::SUBRELATION-OF? TYPE *FLOAT-CONCEPT*) OBJ)
              (CL:T (GET-OBJECT STRING MODULE ENVIRONMENT)))))
           (CL:T
            (CL:LET* ((STREAM-001 (STELLA::NEW-OUTPUT-STRING-STREAM)))
             (STELLA::%%PRINT-STREAM (STELLA::%NATIVE-STREAM STREAM-001) "`" TEST-VALUE-000
              "' is not a valid case option")
             (CL:ERROR (STELLA::NEW-STELLA-EXCEPTION (STELLA::THE-STRING-READER STREAM-001)))))))))
       (CL:T
        (CL:COND ((CL:EQ TYPE STELLA::NULL) (GET-OBJECT STRING MODULE ENVIRONMENT))
         ((STELLA::SUBRELATION-OF? TYPE *STRING-CONCEPT*) (STELLA::WRAP-STRING STRING))
         ((STELLA::SUBRELATION-OF? TYPE *LITERAL-CONCEPT*)
          (CL:LET* ((STREAM-002 (STELLA::NEW-OUTPUT-STRING-STREAM)))
           (STELLA::%%PRINT-STREAM (STELLA::%NATIVE-STREAM STREAM-002) "`" STRING "' is a non-literal, but `" TYPE
     ...
     (CL:WHEN
      (CL:AND (CL:NOT (STELLA::DELETED? P))
       (CL:IF STELLA::*REVERSEPOLARITY?* (STELLA::FALSE? P)
        (CL:OR (STELLA::TRUE? P) (STELLA::FUNCTION-WITH-DEFINED-VALUE? P))))
      (CL:IF (CL:EQ COLLECT-000 STELLA::NULL)
       (CL:PROGN (CL:SETQ COLLECT-000 (STELLA::CONS P STELLA::NIL))
        (CL:IF (CL:EQ VALUE-000 STELLA::NIL) (CL:SETQ VALUE-000 COLLECT-000)
         (STELLA::ADD-CONS-TO-END-OF-CONS-LIST VALUE-000 COLLECT-000)))
       (CL:PROGN (CL:SETF (STELLA::%%REST COLLECT-000) (STELLA::CONS P STELLA::NIL))
        (CL:SETQ COLLECT-000 (STELLA::%%REST COLLECT-000)))))))
      ...
      (CL:LET* ((VALUE-000 STELLA::NULL))
       (CL:LET* ((ARG STELLA::NULL) (ITER-000 ARGUMENTS))
        (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-000 STELLA::NIL)) DO (CL:SETQ ARG (STELLA::%%VALUE ITER-000))
         (CL:WHEN (CL:AND (CL:NOT (CL:EQ ARG STELLA::NULL)) (STELLA::ISA? ARG SGT-PLI-LOGIC-LOGIC-OBJECT))
        ...
        ((ARGUMENTWITHBACKLINKS VALUE-000)
         (ITERATOR
          (CL:IF (CL:NOT (CL:EQ ARGUMENTWITHBACKLINKS STELLA::NULL))
           (STELLA::ALL-TRUE-DEPENDENT-PROPOSITIONS ARGUMENTWITHBACKLINKS (STELLA::%SURROGATE-VALUE-INVERSE RELATION)
            SPECIALIZE?)
         ...
         (CL:LOOP WHILE (STELLA::NEXT? ITER-001) DO (CL:SETQ P (STELLA::%VALUE ITER-001))
          (CL:LET* ((TEST-VALUE-000 CL:NIL))
           (CL:LET* ((ALWAYS?-000 CL:T))
            (CL:LET*
             ((INPUTARG STELLA::NULL) (ITER-002 ARGUMENTS) (ARG2 STELLA::NULL) (VECTOR-000 (STELLA::%ARGUMENTS P))
              (INDEX-000 0) (LENGTH-000 (STELLA::LENGTH VECTOR-000)))
             (CL:DECLARE (CL:TYPE CL:FIXNUM INDEX-000 LENGTH-000))
             (CL:LOOP WHILE (CL:AND (CL:NOT (CL:EQ ITER-002 STELLA::NIL)) (CL:< INDEX-000 LENGTH-000)) DO
              (CL:SETQ INPUTARG (STELLA::%%VALUE ITER-002))
              (CL:SETQ ARG2 (CL:AREF (CL:THE CL:SIMPLE-VECTOR (STELLA::%THE-ARRAY VECTOR-000)) INDEX-000))
              (CL:WHEN (CL:NOT (CL:OR (CL:EQ INPUTARG STELLA::NULL) (STELLA::EQL? INPUTARG (STELLA::VALUE-OF ARG2))))
               (CL:SETQ ALWAYS?-000 CL:NIL) (CL:RETURN))
              (CL:SETQ ITER-002 (STELLA::%%REST ITER-002)) (CL:SETQ INDEX-000 (CL:1+ INDEX-000))))
            (CL:SETQ TEST-VALUE-000 ALWAYS?-000))
           (CL:WHEN TEST-VALUE-000
            (CL:SETQ TEST-VALUE-000 (CL:= (STELLA::LENGTH ARGUMENTS) (STELLA::LENGTH (STELLA::%ARGUMENTS P)))))
           (CL:WHEN TEST-VALUE-000 (CL:SETQ RESULTS (STELLA::CONS P RESULTS)) (CL:SETQ LIMIT (CL:1- LIMIT))
...
relations or functions."
  (CL:LET*
   ((LIST (SEQUENCE-TO-CONS-LIST RELATION-AND-ARGUMENTS)) (RELATION (STELLA::%%VALUE LIST))
...
with the name `module-name', then a Stella `no-such-context-exception' is thrown."
  ...
  (CL:CHECK-TYPE MODULE-NAME CL:SIMPLE-STRING)
  (CL:LET*
   ((MODULE (SAFELY-GET-MODULE MODULE-NAME ENVIRONMENT)) (ELEMENTS (EXPLODE-STRING-LIST RELATION-AND-ARGUMENTS MODULE))
    (RELATION (STELLA::%%VALUE ELEMENTS)) (ARGUMENTS (STELLA::%%REST ELEMENTS)))
   (STELLA::%%VALUE (HELP-GET-PROPOSITIONS RELATION ARGUMENTS 1 MODULE ENVIRONMENT))))
...
(CL:DEFUN GET-INCONSISTENT-PROPOSITIONS (MODULE ENVIRONMENT)
  ...
  (CL:LET* ((MDL-000 MODULE) (CXT-000 MDL-000))
   ...
   (CL:LET* ((STELLA::*MODULE* MDL-000) (STELLA::*CONTEXT* CXT-000))
    (CL:DECLARE (CL:SPECIAL STELLA::*MODULE* STELLA::*CONTEXT*)) (CL:SETQ ENVIRONMENT ENVIRONMENT)
    (STELLA::WITH-PROCESS-LOCK STELLA::*POWERLOOM-LOCK*
     (ITERATOR-TO-PL-ITERATOR (STELLA::ALL-INCONSISTENT-PROPOSITIONS MODULE CL:NIL))))))
   ...
   (CL:LET* ((STELLA::*MODULE* MDL-000) (STELLA::*CONTEXT* CXT-000))
    ...
    (STELLA::WITH-PROCESS-LOCK STELLA::*POWERLOOM-LOCK*
     (CL:LET* ((ARGUMENTWITHBACKLINKS STELLA::NULL))
      (CL:COND
       ((CL:AND (CL:NOT (CL:EQ ARG1 STELLA::NULL)) (STELLA::ISA? ARG1 SGT-PLI-LOGIC-LOGIC-OBJECT))
        (CL:SETQ ARGUMENTWITHBACKLINKS ARG1))
       ((CL:AND (CL:NOT (CL:EQ ARG2 STELLA::NULL)) (STELLA::ISA? ARG2 SGT-PLI-LOGIC-LOGIC-OBJECT))
         ...
         (CL:WHEN
          (CL:AND
           (CL:OR (CL:EQ ARG1 STELLA::NULL)
            (STELLA::EQL? ARG1
             (STELLA::VALUE-OF (CL:AREF (CL:THE CL:SIMPLE-VECTOR (STELLA::%THE-ARRAY (STELLA::%ARGUMENTS P))) 0))))
           (CL:OR (CL:EQ ARG2 STELLA::NULL)
            (STELLA::EQL? ARG2
             (STELLA::VALUE-OF (CL:AREF (CL:THE CL:SIMPLE-VECTOR (STELLA::%THE-ARRAY (STELLA::%ARGUMENTS P))) 1)))))
          (CL:RETURN-FROM GET-BINARY-PROPOSITION P))))
       (CL:RETURN-FROM GET-BINARY-PROPOSITION
        (STELLA::%%VALUE (HELP-GET-PROPOSITIONS RELATION (STELLA::CONS-LIST ARG1 ARG2) 1 MODULE ENVIRONMENT))))
      STELLA::NULL)))))
    ...
    (STELLA::WITH-PROCESS-LOCK STELLA::*POWERLOOM-LOCK*
     (CONS-TO-PL-ITERATOR
      (STELLA::APPLY-CACHED-RETRIEVE (STELLA::LIST* SYM-PLI-PLI-?R SYM-PLI-PLI-?I SYM-PLI-PLI-?V STELLA::NIL)
       (STELLA::LIST* SYM-PLI-PLI-?R SYM-PLI-PLI-?I SYM-PLI-PLI-?V STELLA::NIL)
       (STELLA::CONS-LIST RELATION ARG STELLA::NULL) (STELLA::CONS-LIST)
...
and that are TRUE in the scope of the module `module'."
  (CL:LET* ((MDL-000 MODULE) (CXT-000 MDL-000))
   ...
   (CL:LET* ((STELLA::*MODULE* MDL-000) (STELLA::*CONTEXT* CXT-000))
    (CL:DECLARE (CL:SPECIAL STELLA::*MODULE* STELLA::*CONTEXT*)) (CL:SETQ ENVIRONMENT ENVIRONMENT)
    (STELLA::WITH-PROCESS-LOCK STELLA::*POWERLOOM-LOCK*
     (LIST-TO-PL-ITERATOR (STELLA::ALL-FACTS-OF-INSTANCE OBJECT CL:NIL CL:NIL))))))
...
`no-such-context-exception' is thrown."
  ...
  (CL:CHECK-TYPE MODULE-NAME CL:SIMPLE-STRING)
  (CL:LET*
   ((MODULE (SAFELY-GET-MODULE MODULE-NAME ENVIRONMENT)) (OBJECT (SAFELY-GET-OBJECT OBJECT-NAME MODULE ENVIRONMENT)))
...
the module `module'."
  (CL:LET* ((MDL-000 MODULE) (CXT-000 MDL-000))
   ...
   (CL:LET* ((STELLA::*MODULE* MDL-000) (STELLA::*CONTEXT* CXT-000))
    (CL:DECLARE (CL:SPECIAL STELLA::*MODULE* STELLA::*CONTEXT*)) (CL:SETQ ENVIRONMENT ENVIRONMENT)
    (STELLA::WITH-PROCESS-LOCK STELLA::*POWERLOOM-LOCK*
     (CONS-TO-PL-ITERATOR (STELLA::CONSIFY (STELLA::ALL-PROPOSITIONS STELLA::*MODULE* CL:T)))))))
    ...
    (STELLA::WITH-PROCESS-LOCK STELLA::*POWERLOOM-LOCK*
     (CL:AND (CL:NOT (STELLA::DELETED? PROPOSITION))
      (CL:IF STELLA::*REVERSEPOLARITY?* (STELLA::FALSE? PROPOSITION)
       (CL:OR (STELLA::TRUE? PROPOSITION) (STELLA::FUNCTION-WITH-DEFINED-VALUE? PROPOSITION))))))))
...
(CL:DEFUN IS-SUBRELATION (SUB SUPER MODULE ENVIRONMENT)
  ...
  (CL:LET* ((MDL-000 MODULE) (CXT-000 MDL-000))
   ...
   (CL:LET* ((STELLA::*MODULE* MDL-000) (STELLA::*CONTEXT* CXT-000))
    (CL:DECLARE (CL:SPECIAL STELLA::*MODULE* STELLA::*CONTEXT*)) (CL:SETQ ENVIRONMENT ENVIRONMENT)
    (STELLA::WITH-PROCESS-LOCK STELLA::*POWERLOOM-LOCK*
     (STELLA::TRUE-TRUTH-VALUE? (STELLA::DESCRIPTION-SPECIALIZES-DESCRIPTION? SUB SUPER))))))
...
Non-reflexive."
  (CL:LET* ((MDL-000 MODULE) (CXT-000 MDL-000))
   ...
   (CL:LET* ((STELLA::*MODULE* MDL-000) (STELLA::*CONTEXT* CXT-000))
    (CL:DECLARE (CL:SPECIAL STELLA::*MODULE* STELLA::*CONTEXT*)) (CL:SETQ ENVIRONMENT ENVIRONMENT)
    (STELLA::WITH-PROCESS-LOCK STELLA::*POWERLOOM-LOCK*
     (CONS-TO-PL-ITERATOR (STELLA::ALL-DIRECT-SUBRELATIONS RELATION CL:T))))))
...
Non-reflexive."
  (CL:LET* ((MDL-000 MODULE) (CXT-000 MDL-000))
   ...
   (CL:LET* ((STELLA::*MODULE* MDL-000) (STELLA::*CONTEXT* CXT-000))
    (CL:DECLARE (CL:SPECIAL STELLA::*MODULE* STELLA::*CONTEXT*)) (CL:SETQ ENVIRONMENT ENVIRONMENT)
    (STELLA::WITH-PROCESS-LOCK STELLA::*POWERLOOM-LOCK*
     (CONS-TO-PL-ITERATOR (STELLA::ALL-DIRECT-SUPERRELATIONS RELATION CL:T))))))
...
(CL:DEFUN IS-A (OBJECT CONCEPT MODULE ENVIRONMENT)
  ...
  (CL:LET* ((MDL-000 MODULE) (CXT-000 MDL-000))
   ...
   (CL:LET* ((STELLA::*MODULE* MDL-000) (STELLA::*CONTEXT* CXT-000))
    (CL:DECLARE (CL:SPECIAL STELLA::*MODULE* STELLA::*CONTEXT*)) (CL:SETQ ENVIRONMENT ENVIRONMENT)
    (STELLA::WITH-PROCESS-LOCK STELLA::*POWERLOOM-LOCK*
     (STELLA::TEST-ISA? OBJECT (STELLA::%SURROGATE-VALUE-INVERSE CONCEPT))))))
     ...
     (CL:IF
      ...
      (RETRIEVE
       (STELLA::LIST* SYM-PLI-LOGIC-ALL SYM-PLI-LOGIC-?X
        (STELLA::CONS (STELLA::OBJECT-NAME CONCEPT) (STELLA::CONS SYM-PLI-LOGIC-?X STELLA::NIL)) STELLA::NIL)
       MODULE ENVIRONMENT))))))
      ...
      (RETRIEVE
       (STELLA::LIST* SYM-PLI-LOGIC-ALL SYM-PLI-LOGIC-?X
        (STELLA::LIST* SYM-PLI-STELLA-AND
         (STELLA::CONS (STELLA::OBJECT-NAME CONCEPT) (STELLA::CONS SYM-PLI-LOGIC-?X STELLA::NIL))
         (STELLA::LIST* SYM-PLI-LOGIC-FAIL
          (STELLA::LIST* SYM-PLI-STELLA-EXISTS (STELLA::CONS SYM-PLI-LOGIC-?Y STELLA::NIL)
           (STELLA::LIST* SYM-PLI-STELLA-AND
            (STELLA::LIST* SYM-PLI-PLI-PROPER-SUBRELATION (STELLA::OBJECT-NAME CONCEPT)
...
`no-such-context-exception' is thrown."
  ...
  (CL:LET*
   ((MODULE (SAFELY-GET-MODULE MODULE-NAME ENVIRONMENT))
    (CONCEPT (SAFELY-GET-CONCEPT CONCEPT-NAME MODULE ENVIRONMENT)))
   (CL:IF (CL:NOT (CL:EQ CONCEPT STELLA::NULL)) (GET-DIRECT-CONCEPT-INSTANCES CONCEPT MODULE ENVIRONMENT)
    EMPTY-PL-ITERATOR)))
     ...
     (CL:LET* ((INSTANCES (GET-CONCEPT-INSTANCES CONCEPT MODULE ENVIRONMENT)) (ANSWERS STELLA::NIL))
      (CL:LET* ((I STELLA::NULL) (ITER-000 INSTANCES))
       (CL:LOOP WHILE (STELLA::NEXT? ITER-000) DO (CL:SETQ I (STELLA::%VALUE ITER-000))
        (CL:WHEN (IS-TRUE-BINARY-PROPOSITION RELATION I VALUE MODULE ENVIRONMENT)
     ...
     (CL:LET* ((DERIVABLETYPES STELLA::NIL))
      (CL:COND
       ((CL:OR (CL:EQ ENVIRONMENT STELLA::NULL)
         (CL:AND (CL:NOT (CL:EQ ENVIRONMENT STELLA::NULL))
          (STELLA::STRING-EQL? (STELLA::%LEVEL ENVIRONMENT) "INFERENCE")))
        (CL:SETQ DERIVABLETYPES (STELLA::ALL-TYPES OBJECT)))
       ((CL:AND (CL:NOT (CL:EQ ENVIRONMENT STELLA::NULL))
         (STELLA::STRING-EQL? (STELLA::%LEVEL ENVIRONMENT) "ASSERTION"))
        (CL:SETQ DERIVABLETYPES (STELLA::ALL-ASSERTED-TYPES OBJECT)))
       ((CL:AND (CL:NOT (CL:EQ ENVIRONMENT STELLA::NULL))
         (STELLA::STRING-EQL? (STELLA::%LEVEL ENVIRONMENT) "TAXONOMIC"))
...
`relation-name'.  Include propositions that satisfy subrelations of the relation."
  ...
  (CL:LET* ((RELATION (SAFELY-GET-RELATION RELATION-NAME MODULE ENVIRONMENT)))
   (CL:IF (CL:NOT (CL:EQ RELATION STELLA::NULL)) (GET-RELATION-EXTENSION RELATION MODULE ENVIRONMENT)
    EMPTY-PL-ITERATOR)))
...
case sensitive or not."
  ...
  (CL:LET*
   ((FULL-NAME
     (CL:IF (CL:NOT (CL:EQ PARENT STELLA::NULL)) (STELLA::CONCATENATE (STELLA::%MODULE-FULL-NAME PARENT) "/" NAME)
      NAME))
   ...
   (STELLA::DEFINE-MODULE FULL-NAME (STELLA::LIST* KWD-PLI-CASE-SENSITIVE? CASE-SENSITIVE-SYMBOL STELLA::NIL))))
...
named `name' exists, a Stella `no-such-context-exception' is thrown."
  ...
  #+MCL
  (CL:CHECK-TYPE NAME CL:SIMPLE-STRING)
  (CL:LET* ((MODULE (SAFELY-GET-MODULE NAME ENVIRONMENT))) (STELLA::CALL-CLEAR-MODULE (STELLA::CONS-LIST MODULE))
   MODULE))
...
(CL:DEFUN GET-CHILD-MODULES (MODULE)
  ...
  (CL:LET* ((DIRECTSUBMODULES STELLA::NIL))
   (CL:LET*
    ((CHILD STELLA::NULL) (ITER-000 (STELLA::%THE-CONS-LIST (STELLA::%CHILD-CONTEXTS MODULE)))
     ...
     (CL:WHEN (STELLA::ISA? CHILD SGT-PLI-STELLA-MODULE)
      (CL:IF (CL:EQ COLLECT-000 STELLA::NULL)
       (CL:PROGN (CL:SETQ COLLECT-000 (STELLA::CONS CHILD STELLA::NIL))
        (CL:IF (CL:EQ DIRECTSUBMODULES STELLA::NIL) (CL:SETQ DIRECTSUBMODULES COLLECT-000)
         (STELLA::ADD-CONS-TO-END-OF-CONS-LIST DIRECTSUBMODULES COLLECT-000)))
       (CL:PROGN (CL:SETF (STELLA::%%REST COLLECT-000) (STELLA::CONS CHILD STELLA::NIL))
        (CL:SETQ COLLECT-000 (STELLA::%%REST COLLECT-000)))))
     (CL:SETQ ITER-000 (STELLA::%%REST ITER-000))))
...
name will be all upper case (This latter feature may change!)"
  ...
  (CL:LET* ((MDL-000 MODULE) (CXT-000 MDL-000))
   ...
   (CL:LET* ((STELLA::*MODULE* MDL-000) (STELLA::*CONTEXT* CXT-000))
    (CL:DECLARE (CL:SPECIAL STELLA::*MODULE* STELLA::*CONTEXT*)) (CL:SETQ ENVIRONMENT ENVIRONMENT)
    (STELLA::WITH-PROCESS-LOCK STELLA::*POWERLOOM-LOCK*
     (CL:WHEN (CL:NOT (CL:OR (STELLA::%CASE-SENSITIVE? STELLA::*MODULE*) (STELLA::ALL-UPPER-CASE-STRING? PREFIX)))
       ...
       ((CL:NOT (CL:EQ CONCEPT STELLA::NULL)) (CL:SETQ NAME-SYMBOL (STELLA::INTERN-SYMBOL (GET-SHORT-NAME CONCEPT)))
        (CL:SETQ NAME-SYMBOL
         (STELLA::INTERN-SYMBOL-IN-MODULE
          (GENERATE-UNIQUE-NAME (STELLA::%SYMBOL-NAME NAME-SYMBOL) (STELLA::%HOME-CONTEXT NAME-SYMBOL) STELLA::NULL)
          (STELLA::%HOME-CONTEXT NAME-SYMBOL) CL:T)))
       (CL:T
        (CL:SETQ NAME-SYMBOL
         (STELLA::INTERN-SYMBOL-IN-MODULE (GENERATE-UNIQUE-NAME "I" STELLA::NULL STELLA::NULL) STELLA::*MODULE*
          CL:T))))
      (CL:SETQ OBJECT-SURROGATE
       (STELLA::LOOKUP-SURROGATE-IN-MODULE (STELLA::%SYMBOL-NAME NAME-SYMBOL) (STELLA::%HOME-CONTEXT NAME-SYMBOL)
        CL:NIL))
      (CL:WHEN (CL:EQ OBJECT-SURROGATE STELLA::NULL)
       (CL:SETQ OBJECT-SURROGATE
        (STELLA::INTERN-SURROGATE-IN-MODULE (STELLA::%SYMBOL-NAME NAME-SYMBOL) (STELLA::%HOME-CONTEXT NAME-SYMBOL)
         CL:NIL)))
      (CL:SETQ OBJECT (STELLA::HELP-CREATE-LOGIC-INSTANCE OBJECT-SURROGATE STELLA::NULL))
      (CL:WHEN (CL:NOT (CL:EQ CONCEPT STELLA::NULL))
       (CL:IF (CL:NOT (CL:EQ (ASSERT-UNARY-PROPOSITION CONCEPT OBJECT MODULE ENVIRONMENT) STELLA::NULL))
        (CL:RETURN-FROM CREATE-OBJECT OBJECT) (CL:RETURN-FROM CREATE-OBJECT STELLA::NULL)))
      OBJECT)))))
...
Return the object."
  ...
  (CL:LET* ((MODULE (SAFELY-GET-MODULE MODULE-NAME ENVIRONMENT)))
   (CREATE-OBJECT NAME (SAFELY-GET-CONCEPT CONCEPT-NAME MODULE ENVIRONMENT) MODULE ENVIRONMENT)))
      ...
      (STELLA::CONS (STELLA::INTERN-STELLA-NAME NAME)
       (STELLA::CONCATENATE
        (CL:IF (CL:NOT (CL:EQ PARENT STELLA::NULL))
         (STELLA::LIST* KWD-PLI-SUBSET-OF (STELLA::OBJECT-NAME PARENT) STELLA::NIL) STELLA::NIL)
        STELLA::NIL)))))))
...
the name of the returned object may not match `name' exactly."
  ...
  (CL:CHECK-TYPE MODULE-NAME CL:SIMPLE-STRING)
  (CL:LET* ((MODULE (SAFELY-GET-MODULE MODULE-NAME ENVIRONMENT)))
   (CREATE-CONCEPT NAME (SAFELY-GET-CONCEPT PARENT-NAME MODULE ENVIRONMENT) MODULE ENVIRONMENT)))
      ...
      (CL:LET* ((I STELLA::NULL-INTEGER) (ITER-000 0) (UPPER-BOUND-000 (CL:1- ARITY)) (COLLECT-000 STELLA::NULL))
       ...
       (CL:LOOP WHILE (CL:<= ITER-000 UPPER-BOUND-000) DO (CL:SETQ I ITER-000)
        (CL:IF (CL:EQ COLLECT-000 STELLA::NULL)
         (CL:PROGN
          (CL:SETQ COLLECT-000
           (STELLA::CONS (STELLA::YIELD-SYSTEM-DEFINED-PARAMETER-NAME I STELLA::*MODULE*) STELLA::NIL))
...
programming language.  The following type mappings are used:
  ...
  (CL:LET* ((MDL-000 MODULE) (CXT-000 MDL-000))
   ...
   (CL:LET* ((STELLA::*MODULE* MDL-000) (STELLA::*CONTEXT* CXT-000))
    (CL:DECLARE (CL:SPECIAL STELLA::*MODULE* STELLA::*CONTEXT*)) (CL:SETQ ENVIRONMENT ENVIRONMENT)
    (STELLA::WITH-PROCESS-LOCK STELLA::*POWERLOOM-LOCK*
     (STELLA::REGISTER-COMPUTATION-FUNCTION NAME FUNCTION-REFERENCE ARITY)))))
...
Arity specifies the number of arguments the computation accepts."
  ...
  (CL:LET* ((MDL-000 (SAFELY-GET-MODULE MODULE-NAME ENVIRONMENT)) (CXT-000 MDL-000))
   ...
   (CL:LET* ((STELLA::*MODULE* MDL-000) (STELLA::*CONTEXT* CXT-000))
    (CL:DECLARE (CL:SPECIAL STELLA::*MODULE* STELLA::*CONTEXT*)) (CL:SETQ ENVIRONMENT ENVIRONMENT)
    (STELLA::WITH-PROCESS-LOCK STELLA::*POWERLOOM-LOCK*
     (STELLA::%REGISTER-COMPUTATION-FUNCTION-NAME NAME NATIVE-NAME ARITY)))))
...
in `module'.  Return the asserted proposition."
  (CL:LET* ((MDL-000 MODULE) (CXT-000 MDL-000))
   ...
   (CL:LET* ((STELLA::*MODULE* MDL-000) (STELLA::*CONTEXT* CXT-000))
    (CL:DECLARE (CL:SPECIAL STELLA::*MODULE* STELLA::*CONTEXT*)) (CL:SETQ ENVIRONMENT ENVIRONMENT)
    (STELLA::WITH-PROCESS-LOCK STELLA::*POWERLOOM-LOCK*
     (STELLA::ASSERT-BINARY-VALUE (STELLA::%SURROGATE-VALUE-INVERSE RELATION) ARG VALUE)))))
...
the relation `relation'."
  (CL:LET*
   ((LIST (SEQUENCE-TO-CONS-LIST RELATION-AND-ARGUMENTS)) (RELATION (STELLA::%%VALUE LIST))
    (RELATIONSURROGATE (STELLA::%SURROGATE-VALUE-INVERSE RELATION)) (ARGUMENTS (STELLA::%%REST LIST)))
   (CL:LET* ((MDL-000 MODULE) (CXT-000 MDL-000))
    (CL:WHEN (CL:EQ MDL-000 STELLA::NULL) (CL:SETQ MDL-000 STELLA::*MODULE*) (CL:SETQ CXT-000 STELLA::*CONTEXT*))
    (CL:LET* ((STELLA::*MODULE* MDL-000) (STELLA::*CONTEXT* CXT-000))
     (CL:DECLARE (CL:SPECIAL STELLA::*MODULE* STELLA::*CONTEXT*)) (CL:SETQ ENVIRONMENT ENVIRONMENT)
...
in `module'.  Return the asserted proposition."
  (CL:LET* ((MDL-000 MODULE) (CXT-000 MDL-000))
   ...
   (CL:LET* ((STELLA::*MODULE* MDL-000) (STELLA::*CONTEXT* CXT-000))
    (CL:DECLARE (CL:SPECIAL STELLA::*MODULE* STELLA::*CONTEXT*)) (CL:SETQ ENVIRONMENT ENVIRONMENT)
    (STELLA::WITH-PROCESS-LOCK STELLA::*POWERLOOM-LOCK*
     (STELLA::RETRACT-BINARY-VALUE (STELLA::%SURROGATE-VALUE-INVERSE RELATION) ARG VALUE)))))
  ...
  (CL:LET*
   ...
   (CL:LET* ((MDL-000 MODULE) (CXT-000 MDL-000))
    ...
    (CL:LET* ((STELLA::*MODULE* MDL-000) (STELLA::*CONTEXT* CXT-000))
     (CL:DECLARE (CL:SPECIAL STELLA::*MODULE* STELLA::*CONTEXT*)) (CL:SETQ ENVIRONMENT ENVIRONMENT)
     (STELLA::WITH-PROCESS-LOCK STELLA::*POWERLOOM-LOCK*
      (STELLA::UPDATE-TUPLE RELATIONSURROGATE ARGUMENTS KWD-PLI-RETRACT-TRUE))))))
...
Return the asserted proposition."
  (CL:LET* ((MDL-000 MODULE) (CXT-000 MDL-000))
   ...
   (CL:LET* ((STELLA::*MODULE* MDL-000) (STELLA::*CONTEXT* CXT-000))
    (CL:DECLARE (CL:SPECIAL STELLA::*MODULE* STELLA::*CONTEXT*)) (CL:SETQ ENVIRONMENT ENVIRONMENT)
    (STELLA::WITH-PROCESS-LOCK STELLA::*POWERLOOM-LOCK*
     (STELLA::HELP-UPDATE-TOP-LEVEL-PROPOSITION PROPOSITION KWD-PLI-ASSERT-TRUE) PROPOSITION))))
...
Return an iterator of the propositions resulting from sentence."
  ...
  (CL:CHECK-TYPE MODULE-NAME CL:SIMPLE-STRING)
  (CL:LET*
   ((MODULE (SAFELY-GET-MODULE MODULE-NAME ENVIRONMENT)) (PROPOSITIONS STELLA::NULL) (RETURN-VALUE STELLA::NULL))
   (CL:LET* ((MDL-000 MODULE) (CXT-000 MDL-000))
    (CL:WHEN (CL:EQ MDL-000 STELLA::NULL) (CL:SETQ MDL-000 STELLA::*MODULE*) (CL:SETQ CXT-000 STELLA::*CONTEXT*))
    (CL:LET* ((STELLA::*MODULE* MDL-000) (STELLA::*CONTEXT* CXT-000))
     (CL:DECLARE (CL:SPECIAL STELLA::*MODULE* STELLA::*CONTEXT*)) (CL:SETQ ENVIRONMENT ENVIRONMENT)
     (STELLA::WITH-PROCESS-LOCK STELLA::*POWERLOOM-LOCK*
      (CL:SETQ PROPOSITIONS (S-CONCEIVE SENTENCE MODULE-NAME ENVIRONMENT))
...
Return the retracted proposition."
  (CL:LET* ((MDL-000 MODULE) (CXT-000 MDL-000))
   ...
   (CL:LET* ((STELLA::*MODULE* MDL-000) (STELLA::*CONTEXT* CXT-000))
    (CL:DECLARE (CL:SPECIAL STELLA::*MODULE* STELLA::*CONTEXT*)) (CL:SETQ ENVIRONMENT ENVIRONMENT)
    (STELLA::WITH-PROCESS-LOCK STELLA::*POWERLOOM-LOCK*
     (STELLA::HELP-UPDATE-TOP-LEVEL-PROPOSITION PROPOSITION KWD-PLI-RETRACT-TRUE) PROPOSITION))))
       ...
       (CL:LET* ((TEST-VALUE-000 (STELLA::SAFE-PRIMARY-TYPE PROPOSITIONS)))
        (CL:COND
         ((STELLA::SUBTYPE-OF? TEST-VALUE-000 SGT-PLI-LOGIC-PROPOSITION)
          (CL:PROGN (CONS-TO-PL-ITERATOR (STELLA::CONS PROPOSITIONS STELLA::NIL))))
         ((CL:EQ TEST-VALUE-000 SGT-PLI-STELLA-CONS) (CL:PROGN (CONS-TO-PL-ITERATOR PROPOSITIONS)))
         (CL:T
          (CL:LET* ((STREAM-001 (STELLA::NEW-OUTPUT-STRING-STREAM)))
           (CL:LET* ((STELLA::*PRINTREADABLY?* CL:T)) (CL:DECLARE (CL:SPECIAL STELLA::*PRINTREADABLY?*))
            (STELLA::%%PRINT-STREAM (STELLA::%NATIVE-STREAM STREAM-001) "ERROR: Formula is not a sentence: `" SENTENCE
             "'." EOL)
  ...
  (CL:LET* ((MODULE (SAFELY-GET-MODULE MODULE-NAME ENVIRONMENT)))
   (CL:LET* ((MDL-000 MODULE) (CXT-000 MDL-000))
    ...
    (CL:LET* ((STELLA::*MODULE* MDL-000) (STELLA::*CONTEXT* CXT-000))
     (CL:DECLARE (CL:SPECIAL STELLA::*MODULE* STELLA::*CONTEXT*)) (CL:SETQ ENVIRONMENT ENVIRONMENT)
     (STELLA::WITH-PROCESS-LOCK STELLA::*POWERLOOM-LOCK*
      (CONCEIVE (STELLA::READ-S-EXPRESSION-FROM-STRING SENTENCE) MODULE ENVIRONMENT))))))
...
then a Stella `no-such-context-exception' is thrown."
  ...
  (CL:LET* ((RULE STELLA::NULL) (ITER-000 (S-GET-RULES NAME MODULE-NAME ENVIRONMENT)))
   (CL:LOOP WHILE (STELLA::NEXT? ITER-000) DO (CL:SETQ RULE (STELLA::%VALUE ITER-000))
    (STELLA::PRINT-LOGICAL-FORM RULE STREAM) (STELLA::%%PRINT-STREAM (STELLA::%NATIVE-STREAM STREAM) EOL EOL))))
       ...
       ((DOMAINPROP
         (STELLA::%%VALUE
          (HELP-GET-PROPOSITIONS (STELLA::%SURROGATE-VALUE SGT-PLI-PL-KERNEL-KB-NTH-DOMAIN)
           (STELLA::CONS RELATION (STELLA::CONS (STELLA::WRAP-INTEGER N) (STELLA::CONS STELLA::NULL STELLA::NIL))) 1
           STELLA::NULL STELLA::NULL))))
...
`evaluate' to each of them."
  (CL:LET* ((MDL-000 STELLA::*MODULE*) (CXT-000 MDL-000))
   ...
   (CL:LET* ((STELLA::*MODULE* MDL-000) (STELLA::*CONTEXT* CXT-000))
    (CL:DECLARE (CL:SPECIAL STELLA::*MODULE* STELLA::*CONTEXT*)) (CL:SETQ ENVIRONMENT ENVIRONMENT)
    (STELLA::WITH-PROCESS-LOCK STELLA::*POWERLOOM-LOCK*
     (CL:LET* ((SELF-000 (STELLA::NEW-INPUT-STREAM))) (CL:SETF (STELLA::%NATIVE-STREAM SELF-000) STREAM)
...
`evaluate' to each of them."
  (CL:LET* ((MDL-000 MODULE) (CXT-000 MDL-000))
   ...
   (CL:LET* ((STELLA::*MODULE* MDL-000) (STELLA::*CONTEXT* CXT-000))
    ...
    (STELLA::WITH-PROCESS-LOCK STELLA::*POWERLOOM-LOCK*
     (CL:LET* ((SELF-000 (STELLA::NEW-INPUT-STREAM))) (CL:SETF (STELLA::%NATIVE-STREAM SELF-000) STREAM)
      (STELLA::LOAD-STREAM-IN-MODULE SELF-000 MODULE))))))
  ...
  (CL:LET* ((EXISTS? (STELLA::PROBE-FILE? FILENAME)))
   (CL:COND ((CL:OR (CL:NOT EXISTS?) (STELLA::STRING-EQUAL? IFEXISTS "REPLACE")))
    ((STELLA::STRING-EQUAL? IFEXISTS "ASK")
     (CL:WHEN
      (CL:NOT
       (STELLA::YES-OR-NO? (STELLA::CONCATENATE "File `" FILENAME "' already exists.  Overwrite it? (yes or no) ")))
...
the proposition `prop'."
  (CL:LET* ((RELATION (STELLA::GET-DESCRIPTION (STELLA::%OPERATOR PROP))))
   (CL:WHEN (CL:EQ RELATION STELLA::NULL) (CL:SETQ RELATION (STELLA::%SURROGATE-VALUE (STELLA::%OPERATOR PROP))))
   RELATION))
    ...
    ((STELLA::SUBTYPE-OF? TEST-VALUE-000 SGT-PLI-LOGIC-PROPOSITION)
     (CL:PROGN
      (CL:IF (CL:= N 0) (GET-PREDICATE SEQUENCE)
       (CL:LET*
        ((VALUE
          (CL:AREF (CL:THE CL:SIMPLE-VECTOR (STELLA::%THE-ARRAY (STELLA::%ARGUMENTS SEQUENCE)))
         ...
         ((STELLA::SUBTYPE-OF? (STELLA::SAFE-PRIMARY-TYPE VALUE) SGT-PLI-LOGIC-SKOLEM)
          (CL:PROGN
           (CL:LET* ((MDL-000 MODULE) (CXT-000 MDL-000))
            ...
            (CL:LET* ((STELLA::*MODULE* MDL-000) (STELLA::*CONTEXT* CXT-000))
             (CL:DECLARE (CL:SPECIAL STELLA::*MODULE* STELLA::*CONTEXT*)) (CL:SETQ ENVIRONMENT ENVIRONMENT)
             (STELLA::WITH-PROCESS-LOCK STELLA::*POWERLOOM-LOCK* (STELLA::VALUE-OF VALUE))))))
         (CL:T VALUE))))))
    ((STELLA::SUBTYPE-OF? TEST-VALUE-000 SGT-PLI-PLI-PL-ITERATOR)
     (CL:PROGN (GET-NTH-VALUE (STELLA::%VALUE SEQUENCE) N MODULE ENVIRONMENT)))
    ((CL:EQ TEST-VALUE-000 SGT-PLI-STELLA-CONS) (CL:PROGN (STELLA::NTH SEQUENCE N)))
    ((STELLA::SUBTYPE-OF? TEST-VALUE-000 SGT-PLI-STELLA-VECTOR)
     (CL:PROGN (CL:AREF (CL:THE CL:SIMPLE-VECTOR (STELLA::%THE-ARRAY SEQUENCE)) N)))
    (CL:T SEQUENCE))))
...
If `sequence' is not a LOGIC-OBJECT, an exception is thrown."
  ...
  (CL:LET* ((VALUE (GET-NTH-VALUE SEQUENCE N MODULE ENVIRONMENT)))
   (CL:IF (STELLA::ISA? VALUE SGT-PLI-LOGIC-LOGIC-OBJECT) VALUE
    (CL:LET* ((STREAM-000 (STELLA::NEW-OUTPUT-STRING-STREAM)))
     (STELLA::%%PRINT-STREAM (STELLA::%NATIVE-STREAM STREAM-000) "Can't coerce `" VALUE "' to a LOGIC-OBJECT.")
     (CL:ERROR (STELLA::NEW-STELLA-EXCEPTION (STELLA::THE-STRING-READER STREAM-000)))))))
  ...
  (CL:LET* ((MODULE (SAFELY-GET-MODULE MODULE-NAME ENVIRONMENT)))
   (CL:LET* ((MDL-000 MODULE) (CXT-000 MDL-000))
    ...
    (CL:LET* ((STELLA::*MODULE* MDL-000) (STELLA::*CONTEXT* CXT-000))
     (CL:DECLARE (CL:SPECIAL STELLA::*MODULE* STELLA::*CONTEXT*)) (CL:SETQ ENVIRONMENT ENVIRONMENT)
     (STELLA::WITH-PROCESS-LOCK STELLA::*POWERLOOM-LOCK*
      (EVALUATE (STELLA::READ-S-EXPRESSION-FROM-STRING COMMAND) MODULE ENVIRONMENT))))))
  ...
  (CL:LET* ((MDL-000 MODULE) (CXT-000 MDL-000))
   ...
   (CL:LET* ((STELLA::*MODULE* MDL-000) (STELLA::*CONTEXT* CXT-000))
    ...
    (STELLA::WITH-PROCESS-LOCK STELLA::*POWERLOOM-LOCK* (CL:SETQ QUERY (STELLA::DEOBJECTIFY-TREE QUERY))
     (CL:WHEN (STELLA::SYMBOL? (STELLA::%%VALUE QUERY)) (CL:SETQ QUERY (STELLA::CONS QUERY STELLA::NIL)))
  ...
  (CL:LET* ((QUERYFORM STELLA::NIL) (MODULE (SAFELY-GET-MODULE MODULE-NAME ENVIRONMENT)))
   (CL:LET* ((MDL-000 MODULE) (CXT-000 MDL-000))
    ...
    (CL:LET* ((STELLA::*MODULE* MDL-000) (STELLA::*CONTEXT* CXT-000))
     ...
     (STELLA::WITH-PROCESS-LOCK STELLA::*POWERLOOM-LOCK*
      (CL:LET*
       ((SEXP STELLA::NULL) (ITER-000 (STELLA::S-EXPRESSIONS (STELLA::NEW-INPUT-STRING-STREAM QUERY)))
        (COLLECT-000 STELLA::NULL))
       (CL:LOOP WHILE (STELLA::NEXT? ITER-000) DO (CL:SETQ SEXP (STELLA::%VALUE ITER-000))
        (CL:IF (CL:EQ COLLECT-000 STELLA::NULL)
         (CL:PROGN (CL:SETQ COLLECT-000 (STELLA::CONS SEXP STELLA::NIL))
          (CL:IF (CL:EQ QUERYFORM STELLA::NIL) (CL:SETQ QUERYFORM COLLECT-000)
           (STELLA::ADD-CONS-TO-END-OF-CONS-LIST QUERYFORM COLLECT-000)))
...
(CL:DEFUN HELP-STARTUP-PLI1 ()
  (CL:PROGN (CL:SETQ SGT-PLI-PLI-ENVIRONMENT (STELLA::INTERN-RIGID-SYMBOL-WRT-MODULE "ENVIRONMENT" STELLA::NULL 1))
   (CL:SETQ SYM-PLI-LOGIC-LEVEL
    (STELLA::INTERN-RIGID-SYMBOL-WRT-MODULE "LEVEL" (STELLA::GET-STELLA-MODULE "/LOGIC" CL:T) 0))
   ...
   (CL:SETQ SYM-PLI-STELLA-CURSOR
    (STELLA::INTERN-RIGID-SYMBOL-WRT-MODULE "CURSOR" (STELLA::GET-STELLA-MODULE "/STELLA" CL:T) 0))
   ...
   (CL:SETQ SGT-PLI-STELLA-LIST
    (STELLA::INTERN-RIGID-SYMBOL-WRT-MODULE "LIST" (STELLA::GET-STELLA-MODULE "/STELLA" CL:T) 1))
   (CL:SETQ SGT-PLI-STELLA-VECTOR
    (STELLA::INTERN-RIGID-SYMBOL-WRT-MODULE "VECTOR" (STELLA::GET-STELLA-MODULE "/STELLA" CL:T) 1))
   (CL:SETQ SYM-PLI-STELLA-NULL
    (STELLA::INTERN-RIGID-SYMBOL-WRT-MODULE "NULL" (STELLA::GET-STELLA-MODULE "/STELLA" CL:T) 0))
   (CL:SETQ SGT-PLI-LOGIC-SKOLEM
    (STELLA::INTERN-RIGID-SYMBOL-WRT-MODULE "SKOLEM" (STELLA::GET-STELLA-MODULE "/LOGIC" CL:T) 1))
   (CL:SETQ SGT-PLI-LOGIC-LOGIC-OBJECT
    (STELLA::INTERN-RIGID-SYMBOL-WRT-MODULE "LOGIC-OBJECT" (STELLA::GET-STELLA-MODULE "/LOGIC" CL:T) 1))
   (CL:SETQ SGT-PLI-STELLA-GENERALIZED-SYMBOL
    (STELLA::INTERN-RIGID-SYMBOL-WRT-MODULE "GENERALIZED-SYMBOL" (STELLA::GET-STELLA-MODULE "/STELLA" CL:T) 1))
   (CL:SETQ SGT-PLI-STELLA-MODULE
    (STELLA::INTERN-RIGID-SYMBOL-WRT-MODULE "MODULE" (STELLA::GET-STELLA-MODULE "/STELLA" CL:T) 1))
   (CL:SETQ SGT-PLI-STELLA-CONTEXT
    (STELLA::INTERN-RIGID-SYMBOL-WRT-MODULE "CONTEXT" (STELLA::GET-STELLA-MODULE "/STELLA" CL:T) 1))
   (CL:SETQ SGT-PLI-LOGIC-COMPUTED-PROCEDURE
    (STELLA::INTERN-RIGID-SYMBOL-WRT-MODULE "COMPUTED-PROCEDURE" (STELLA::GET-STELLA-MODULE "/LOGIC" CL:T) 1))
   (CL:SETQ SGT-PLI-STELLA-LITERAL-WRAPPER
    (STELLA::INTERN-RIGID-SYMBOL-WRT-MODULE "LITERAL-WRAPPER" (STELLA::GET-STELLA-MODULE "/STELLA" CL:T) 1))
   (CL:SETQ SGT-PLI-LOGIC-NAMED-DESCRIPTION
    (STELLA::INTERN-RIGID-SYMBOL-WRT-MODULE "NAMED-DESCRIPTION" (STELLA::GET-STELLA-MODULE "/LOGIC" CL:T) 1))
   ...
   (CL:SETQ SYM-PLI-LOGIC-ALL
    (STELLA::INTERN-RIGID-SYMBOL-WRT-MODULE "ALL" (STELLA::GET-STELLA-MODULE "/LOGIC" CL:T) 0))
   ...
   (CL:SETQ SYM-PLI-STELLA-AND
    (STELLA::INTERN-RIGID-SYMBOL-WRT-MODULE "AND" (STELLA::GET-STELLA-MODULE "/STELLA" CL:T) 0))
   (CL:SETQ SYM-PLI-LOGIC-FAIL
    (STELLA::INTERN-RIGID-SYMBOL-WRT-MODULE "FAIL" (STELLA::GET-STELLA-MODULE "/LOGIC" CL:T) 0))
   (CL:SETQ SYM-PLI-STELLA-EXISTS
    (STELLA::INTERN-RIGID-SYMBOL-WRT-MODULE "EXISTS" (STELLA::GET-STELLA-MODULE "/STELLA" CL:T) 0))
   ...
   (CL:SETQ SYM-PLI-PLI-PROPER-SUBRELATION
    (STELLA::INTERN-RIGID-SYMBOL-WRT-MODULE "PROPER-SUBRELATION" STELLA::NULL 0))
   (CL:SETQ SYM-PLI-STELLA-TRUE
    (STELLA::INTERN-RIGID-SYMBOL-WRT-MODULE "TRUE" (STELLA::GET-STELLA-MODULE "/STELLA" CL:T) 0))
   (CL:SETQ SYM-PLI-STELLA-FALSE
    (STELLA::INTERN-RIGID-SYMBOL-WRT-MODULE "FALSE" (STELLA::GET-STELLA-MODULE "/STELLA" CL:T) 0))
   ...
   (CL:SETQ SGT-PLI-LOGIC-PROPOSITION
    (STELLA::INTERN-RIGID-SYMBOL-WRT-MODULE "PROPOSITION" (STELLA::GET-STELLA-MODULE "/LOGIC" CL:T) 1))
   (CL:SETQ SGT-PLI-PL-KERNEL-KB-NTH-DOMAIN
    (STELLA::INTERN-RIGID-SYMBOL-WRT-MODULE "NTH-DOMAIN" (STELLA::GET-STELLA-MODULE "/PL-KERNEL-KB" CL:T) 1))
   (CL:SETQ KWD-PLI-MODULE (STELLA::INTERN-RIGID-SYMBOL-WRT-MODULE "MODULE" STELLA::NULL 2))
   (CL:SETQ SGT-PLI-STELLA-INTEGER-WRAPPER
    (STELLA::INTERN-RIGID-SYMBOL-WRT-MODULE "INTEGER-WRAPPER" (STELLA::GET-STELLA-MODULE "/STELLA" CL:T) 1))
   (CL:SETQ SGT-PLI-STELLA-FLOAT-WRAPPER
    (STELLA::INTERN-RIGID-SYMBOL-WRT-MODULE "FLOAT-WRAPPER" (STELLA::GET-STELLA-MODULE "/STELLA" CL:T) 1))
   (CL:SETQ SGT-PLI-STELLA-NUMBER-WRAPPER
    (STELLA::INTERN-RIGID-SYMBOL-WRT-MODULE "NUMBER-WRAPPER" (STELLA::GET-STELLA-MODULE "/STELLA" CL:T) 1))
   (CL:SETQ SGT-PLI-STELLA-STRING-WRAPPER
    (STELLA::INTERN-RIGID-SYMBOL-WRT-MODULE "STRING-WRAPPER" (STELLA::GET-STELLA-MODULE "/STELLA" CL:T) 1))
...
needs to be called by all applications before using PowerLoom.  If it
is called more than once, every call after the first one is a no-op.\" :PUBLIC? TRUE)" (CL:FUNCTION INITIALIZE)
    STELLA::NULL)
...
elements are available, `false' otherwise.\")" (CL:FUNCTION STELLA::NEXT?) STELLA::NULL)
   ...
   (STELLA::DEFINE-FUNCTION-OBJECT "SEQUENCE-TO-CONS-LIST"
    "(DEFUN (SEQUENCE-TO-CONS-LIST CONS) ((SEQUENCE OBJECT)) :PUBLIC? FALSE)" (CL:FUNCTION SEQUENCE-TO-CONS-LIST)
    STELLA::NULL)
   ...
   (STELLA::DEFINE-FUNCTION-OBJECT "LEGAL-OPERATOR?"
    "(DEFUN (LEGAL-OPERATOR? BOOLEAN) ((OPERATOR SYMBOL)) :PUBLIC? FALSE)" (CL:FUNCTION LEGAL-OPERATOR?) STELLA::NULL)
...
or visible from the module `module-name'.  A module name of `null' or the
empty string refers to the current module.  If no module can be found
with the name `module-name', then a Stella `no-such-context-exception' is thrown.\")" (CL:FUNCTION S-GET-OBJECT)
    STELLA::NULL)
...
or visible from the module `module-name'.  A module name of `null' or the
empty string refers to the current module.  If no module can be found
with the name `module-name', then a Stella `no-such-context-exception' is thrown.\")" (CL:FUNCTION S-GET-CONCEPT)
    STELLA::NULL)
...
or visible from the module `module-name'.  A module name of `null' or the
empty string refers to the current module.  If no module can be found
with the name `module-name', then a Stella `no-such-context-exception' is thrown.\")" (CL:FUNCTION S-GET-RELATION)
    STELLA::NULL)
...
Currently `type' only has an effect on the interpretation of literal types.\")" (CL:FUNCTION STRING-TO-OBJECT)
    STELLA::NULL)
...
A module name of `null' or the
empty string refers to the current module.  If no module can be found
with the name `module-name', then a Stella `no-such-context-exception' is thrown.\")" (CL:FUNCTION S-GET-PROPOSITION)
    STELLA::NULL)
...
A module name of `null' or the
empty string refers to the current module.  If no module can be found
with the name `module-name', then a Stella `no-such-context-exception' is thrown.\")" (CL:FUNCTION S-GET-PROPOSITIONS)
    STELLA::NULL)
...
language.  The following type mappings are used:
  ...
  Common Lisp:  The native-name is read by READ-FROM-STRING and then
         ...
         Java:  A fully package-qualified name is required.  It is
                looked up using the Reflection tools.
The function found must conform to the signature for computation functions.
Arity specifies the number of arguments the computation accepts.\")" (CL:FUNCTION S-REGISTER-COMPUTATION-FUNCTION)
    STELLA::NULL)
...
Return an iterator of the retracted propositions resulting from sentence.\")" (CL:FUNCTION S-RETRACT-PROPOSITION)
    STELLA::NULL)
...
relation `relation'.  Counting starts at zero.  NOTE: if there are multiple
`nth-domain' propositions for `relation', this arbitrarily returns one of them;
it does not look for the most specific one (which might have to be created).\")" (CL:FUNCTION GET-NTH-DOMAIN)
    STELLA::NULL)
...
As a special case, a column number of zero will also return `sequence' itself
if it is not one of the types enumerated above.  This is done to allow the
use of `get-nth-value' on PL-iterators with only a single return variable.\")" (CL:FUNCTION GET-NTH-VALUE)
    STELLA::NULL)
...
As a special case, a column number of zero will also return `sequence' itself
as a string if it is not one of the types enumerated above.  This is done to 
allow the use of `get-nth-string' on PL-iterators with only a single return variable.\")" (CL:FUNCTION GET-NTH-STRING)
    STELLA::NULL)
...
global variables is supported.  Commands are simple to program in Common Lisp,
since they are built into the language, and relatively awkward in Java and C++.
Users of either of those languages are more likely to want to call `s-evaluate'.\")" (CL:FUNCTION EVALUATE)
    STELLA::NULL)
...
`no-such-context-exception' is thrown.\" :PUBLIC? TRUE)" (CL:FUNCTION S-RETRIEVE) STELLA::NULL)
   ...
   (STELLA::DEFINE-FUNCTION-OBJECT "STARTUP-PLI" "(DEFUN STARTUP-PLI () :PUBLIC? TRUE)" (CL:FUNCTION STARTUP-PLI)
    STELLA::NULL)
   (CL:LET* ((FUNCTION (STELLA::LOOKUP-FUNCTION SYM-PLI-PLI-STARTUP-PLI)))
    (STELLA::SET-DYNAMIC-SLOT-VALUE (STELLA::%DYNAMIC-SLOTS FUNCTION) SYM-PLI-STELLA-METHOD-STARTUP-CLASSNAME
     (STELLA::WRAP-STRING "_StartupPli") STELLA::NULL-STRING-WRAPPER))))

(CL:DEFUN STARTUP-PLI ()
  (CL:LET*
   ((STELLA::*MODULE* (STELLA::GET-STELLA-MODULE "/PLI" (STELLA::> STELLA::*STARTUP-TIME-PHASE* 1)))
    (STELLA::*CONTEXT* STELLA::*MODULE*))
   (CL:DECLARE (CL:SPECIAL STELLA::*MODULE* STELLA::*CONTEXT*))
   (CL:WHEN (STELLA::CURRENT-STARTUP-TIME-PHASE? 2) (HELP-STARTUP-PLI1))
   (CL:WHEN (STELLA::CURRENT-STARTUP-TIME-PHASE? 4)
    (CL:LET* ((SELF-060 (NEW-ENVIRONMENT))) (CL:SETF (STELLA::%LEVEL SELF-060) "ASSERTION")
     (CL:SETQ ASSERTION-ENV SELF-060))
    (CL:LET* ((SELF-061 (NEW-ENVIRONMENT))) (CL:SETF (STELLA::%LEVEL SELF-061) "TAXONOMIC")
     (CL:SETQ TAXONOMIC-ENV SELF-061))
    (CL:LET* ((SELF-062 (NEW-ENVIRONMENT))) (CL:SETF (STELLA::%LEVEL SELF-062) "INFERENCE")
     (CL:SETQ INFERENCE-ENV SELF-062))
    (CL:LET* ((SELF-063 (NEW-PL-ITERATOR))) (CL:SETF (STELLA::%CURSOR SELF-063) STELLA::NIL)
     (CL:SETQ EMPTY-PL-ITERATOR SELF-063)))
   ...
   (CL:WHEN (STELLA::CURRENT-STARTUP-TIME-PHASE? 9)
    (STELLA::%IN-MODULE (STELLA::COPY-CONS-TREE (STELLA::WRAP-STRING "PLI")))
    ...
    (CL:SETQ *LITERAL-CONCEPT* (S-GET-CONCEPT "LITERAL" "PL-USER" STELLA::NULL))
    (CL:SETQ *STRING-CONCEPT* (S-GET-CONCEPT "STRING" "PL-USER" STELLA::NULL))
    (CL:SETQ *INTEGER-CONCEPT* (S-GET-CONCEPT "INTEGER" "PL-USER" STELLA::NULL))
    (CL:SETQ *FLOAT-CONCEPT* (S-GET-CONCEPT "FLOAT" "PL-USER" STELLA::NULL)))))
