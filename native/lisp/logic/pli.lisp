...
(CL:DECLAIM
 (CL:SPECIAL STELLA::*STARTUP-TIME-PHASE* STELLA::INCONSISTENT-TRUTH-VALUE STELLA::UNKNOWN-TRUTH-VALUE STELLA::FALSE-TRUTH-VALUE STELLA::DEFAULT-FALSE-TRUTH-VALUE
  STELLA::STANDARD-OUTPUT STELLA::EOL STELLA::KEYWORD-SYM STELLA::TRUE-TRUTH-VALUE STELLA::DEFAULT-TRUE-TRUTH-VALUE STELLA::*REVERSEPOLARITY?* STELLA::*ROOT-MODULE*
  STELLA::*LOGIC-MODULE* STELLA::*CONTEXT* STELLA::*KIF-SENTENCE-OPERATORS* STELLA::*KIF-TERM-OPERATORS* STELLA::NULL-INTEGER STELLA::*MODULE* STELLA::NIL
...
is called more than once, every call after the first one is a no-op."
  (STELLA::WITH-PROCESS-LOCK STELLA::*BOOTSTRAP-LOCK* (CL:WHEN (CL:NOT *POWERLOOM-INITIALIZED?*) (STELLA::STARTUP-LOGIC-SYSTEM))))
...
loaded STELLA systems if they do reference PowerLoom symbols in their code."
  (STELLA::WITH-PROCESS-LOCK STELLA::*POWERLOOM-LOCK* (STELLA::RESET-POWERLOOM)))

;;; (DEFUN CLEAR-CACHES ...)

(CL:DEFUN CLEAR-CACHES ()
  "Clear all query and memoization caches."
  (STELLA::WITH-PROCESS-LOCK STELLA::*POWERLOOM-LOCK* (STELLA::CLEAR-CACHES)))

;;; (DEFCLASS ENVIRONMENT ...)

(CL:DEFCLASS ENVIRONMENT (STELLA::STANDARD-OBJECT)
  ((STELLA::LEVEL :TYPE CL:SIMPLE-STRING :INITFORM STELLA::NULL-STRING :ALLOCATION :INSTANCE :ACCESSOR STELLA::%LEVEL)))

(CL:DEFUN NEW-ENVIRONMENT ()
  (CL:LET* ((SELF STELLA::NULL)) (CL:SETQ SELF (CL:MAKE-INSTANCE (CL:QUOTE ENVIRONMENT))) (CL:SETF (STELLA::%LEVEL SELF) STELLA::NULL-STRING) SELF))
...
(CL:DEFUN ACCESS-ENVIRONMENT-SLOT-VALUE (SELF SLOTNAME VALUE SETVALUE?)
  (CL:COND
   ((CL:EQ SLOTNAME SYM-PLI-LOGIC-LEVEL)
    (CL:IF SETVALUE? (CL:SETF (STELLA::%LEVEL SELF) (STELLA::%WRAPPER-VALUE VALUE)) (CL:SETQ VALUE (STELLA::WRAP-STRING (STELLA::%LEVEL SELF)))))
   (CL:T
    (CL:LET* ((STREAM-000 (STELLA::NEW-OUTPUT-STRING-STREAM))) (STELLA::%%PRINT-STREAM (STELLA::%NATIVE-STREAM STREAM-000) "`" SLOTNAME "' is not a valid case option")
...
(CL:DEFUN NEW-PL-ITERATOR ()
  (CL:LET* ((SELF STELLA::NULL)) (CL:SETQ SELF (CL:MAKE-INSTANCE (CL:QUOTE PL-ITERATOR))) (CL:SETF (STELLA::%FIRST-ITERATION? SELF) CL:T)
   (CL:SETF (STELLA::%VALUE SELF) STELLA::NULL) (CL:SETF (STELLA::%CURSOR SELF) STELLA::NULL) SELF))
...
(CL:DEFUN ACCESS-PL-ITERATOR-SLOT-VALUE (SELF SLOTNAME VALUE SETVALUE?)
  (CL:COND ((CL:EQ SLOTNAME SYM-PLI-STELLA-CURSOR) (CL:IF SETVALUE? (CL:SETF (STELLA::%CURSOR SELF) VALUE) (CL:SETQ VALUE (STELLA::%CURSOR SELF))))
   (CL:T
    (CL:LET* ((STREAM-000 (STELLA::NEW-OUTPUT-STRING-STREAM))) (STELLA::%%PRINT-STREAM (STELLA::%NATIVE-STREAM STREAM-000) "`" SLOTNAME "' is not a valid case option")
     (CL:ERROR (STELLA::NEW-STELLA-EXCEPTION (STELLA::THE-STRING-READER STREAM-000))))))
  VALUE)
...
elements are available, `false' otherwise."
  (CL:LET* ((CURSOR (STELLA::%CURSOR SELF))) (CL:WHEN (CL:EQ CURSOR STELLA::NIL) (CL:SETF (STELLA::%VALUE SELF) STELLA::NULL) (CL:RETURN-FROM STELLA::NEXT? CL:NIL))
   (CL:SETF (STELLA::%VALUE SELF) (STELLA::%%VALUE CURSOR)) (CL:SETF (STELLA::%CURSOR SELF) (STELLA::%%REST CURSOR)) CL:T))
...
(CL:DEFUN CONS-TO-PL-ITERATOR (SELF)
  ...
  (CL:IF (CL:EQ SELF STELLA::NIL) EMPTY-PL-ITERATOR
   (CL:LET* ((SELF-000 (NEW-PL-ITERATOR))) (CL:SETF (STELLA::%CURSOR SELF-000) SELF) (CL:LET* ((VALUE-000 SELF-000)) VALUE-000))))

;;; (DEFUN (LIST-TO-PL-ITERATOR PL-ITERATOR) ...)

(CL:DEFUN LIST-TO-PL-ITERATOR (SELF)
  "Convert a Stella list into an API iterator."
  (CL:IF (STELLA::EMPTY? SELF) EMPTY-PL-ITERATOR (CONS-TO-PL-ITERATOR (STELLA::%THE-CONS-LIST SELF))))
...
(CL:DEFMETHOD STELLA::LISTIFY ((SELF PL-ITERATOR))
  ...
  (CL:LET* ((SELF-000 (STELLA::NEW-LIST)))
   (CL:LET* ((VALUE-001 STELLA::NIL))
    (CL:LET* ((X STELLA::NULL) (ITER-000 SELF) (COLLECT-000 STELLA::NULL))
     (CL:LOOP WHILE (STELLA::NEXT? ITER-000) DO (CL:SETQ X (STELLA::%VALUE ITER-000))
      (CL:IF (CL:EQ COLLECT-000 STELLA::NULL)
       (CL:PROGN (CL:SETQ COLLECT-000 (STELLA::CONS X STELLA::NIL))
        (CL:IF (CL:EQ VALUE-001 STELLA::NIL) (CL:SETQ VALUE-001 COLLECT-000) (STELLA::ADD-CONS-TO-END-OF-CONS-LIST VALUE-001 COLLECT-000)))
       (CL:PROGN (CL:SETF (STELLA::%%REST COLLECT-000) (STELLA::CONS X STELLA::NIL)) (CL:SETQ COLLECT-000 (STELLA::%%REST COLLECT-000))))))
  ...
  (CL:LET* ((VALUE-000 STELLA::NIL))
   (CL:LET* ((X STELLA::NULL) (ITER-000 SELF) (COLLECT-000 STELLA::NULL))
    (CL:LOOP WHILE (STELLA::NEXT? ITER-000) DO (CL:SETQ X (STELLA::%VALUE ITER-000))
     (CL:IF (CL:EQ COLLECT-000 STELLA::NULL)
      (CL:PROGN (CL:SETQ COLLECT-000 (STELLA::CONS X STELLA::NIL))
       (CL:IF (CL:EQ VALUE-000 STELLA::NIL) (CL:SETQ VALUE-000 COLLECT-000) (STELLA::ADD-CONS-TO-END-OF-CONS-LIST VALUE-000 COLLECT-000)))
      (CL:PROGN (CL:SETF (STELLA::%%REST COLLECT-000) (STELLA::CONS X STELLA::NIL)) (CL:SETQ COLLECT-000 (STELLA::%%REST COLLECT-000))))))
...
(CL:DEFUN SAFELY-GET-OBJECT (NAME MODULE ENVIRONMENT)
  ...
  (CL:LET* ((OBJECT (GET-OBJECT NAME MODULE ENVIRONMENT)))
   (CL:IF (CL:EQ OBJECT STELLA::NULL)
    (CL:LET* ((STREAM-000 (STELLA::NEW-OUTPUT-STRING-STREAM))) (STELLA::%%PRINT-STREAM (STELLA::%NATIVE-STREAM STREAM-000) "Can't find an object named `" NAME "'")
     (CL:ERROR (STELLA::NEW-NO-SUCH-OBJECT-EXCEPTION (STELLA::THE-STRING-READER STREAM-000))))
    OBJECT)))
...
(CL:DEFUN SAFELY-GET-CONCEPT (NAME MODULE ENVIRONMENT)
  ...
  (CL:LET* ((OBJECT (GET-CONCEPT NAME MODULE ENVIRONMENT)))
   (CL:IF (CL:EQ OBJECT STELLA::NULL)
    (CL:LET* ((STREAM-000 (STELLA::NEW-OUTPUT-STRING-STREAM))) (STELLA::%%PRINT-STREAM (STELLA::%NATIVE-STREAM STREAM-000) "Can't find a concept named `" NAME "'")
     (CL:ERROR (STELLA::NEW-NO-SUCH-OBJECT-EXCEPTION (STELLA::THE-STRING-READER STREAM-000))))
    OBJECT)))
...
(CL:DEFUN SAFELY-GET-RELATION (NAME MODULE ENVIRONMENT)
  ...
  (CL:LET* ((OBJECT (GET-RELATION NAME MODULE ENVIRONMENT)))
   (CL:IF (CL:EQ OBJECT STELLA::NULL)
    (CL:LET* ((STREAM-000 (STELLA::NEW-OUTPUT-STRING-STREAM))) (STELLA::%%PRINT-STREAM (STELLA::%NATIVE-STREAM STREAM-000) "Can't find a relation named `" NAME "'")
     (CL:ERROR (STELLA::NEW-NO-SUCH-OBJECT-EXCEPTION (STELLA::THE-STRING-READER STREAM-000))))
    OBJECT)))
...
(CL:DEFUN SAFELY-GET-OBJECT-OR-NULL (NAME MODULE ENVIRONMENT)
  ...
  (CL:HANDLER-CASE (CL:RETURN-FROM SAFELY-GET-OBJECT-OR-NULL (GET-OBJECT NAME MODULE ENVIRONMENT)) (STELLA::NO-SUCH-OBJECT-EXCEPTION () STELLA::NULL)))
...
(CL:DEFUN SEQUENCE-TO-CONS-LIST (SEQUENCE)
  (CL:LET* ((TEST-VALUE-000 (STELLA::SAFE-PRIMARY-TYPE SEQUENCE)))
   (CL:COND ((CL:EQ TEST-VALUE-000 SGT-PLI-STELLA-CONS) (CL:PROGN SEQUENCE))
    ((STELLA::SUBTYPE-OF? TEST-VALUE-000 SGT-PLI-STELLA-LIST) (CL:PROGN (STELLA::%THE-CONS-LIST SEQUENCE)))
    ((STELLA::SUBTYPE-OF? TEST-VALUE-000 SGT-PLI-STELLA-VECTOR)
     (CL:PROGN
      (CL:LET* ((RESULT STELLA::NIL))
       (CL:LET* ((I STELLA::NULL-INTEGER) (ITER-000 0) (UPPER-BOUND-000 (STELLA::LENGTH SEQUENCE)) (COLLECT-000 STELLA::NULL))
        (CL:DECLARE (CL:TYPE CL:FIXNUM I ITER-000 UPPER-BOUND-000))
        (CL:LOOP WHILE (CL:<= ITER-000 UPPER-BOUND-000) DO (CL:SETQ I ITER-000)
         (CL:IF (CL:EQ COLLECT-000 STELLA::NULL)
          (CL:PROGN (CL:SETQ COLLECT-000 (STELLA::CONS (CL:AREF (CL:THE CL:SIMPLE-VECTOR (STELLA::%THE-ARRAY SEQUENCE)) I) STELLA::NIL))
           (CL:IF (CL:EQ RESULT STELLA::NIL) (CL:SETQ RESULT COLLECT-000) (STELLA::ADD-CONS-TO-END-OF-CONS-LIST RESULT COLLECT-000)))
          (CL:PROGN (CL:SETF (STELLA::%%REST COLLECT-000) (STELLA::CONS (CL:AREF (CL:THE CL:SIMPLE-VECTOR (STELLA::%THE-ARRAY SEQUENCE)) I) STELLA::NIL))
           (CL:SETQ COLLECT-000 (STELLA::%%REST COLLECT-000))))
         (CL:SETQ ITER-000 (CL:1+ ITER-000))))
       RESULT)))
    (CL:T
     (CL:LET* ((STREAM-000 (STELLA::NEW-OUTPUT-STRING-STREAM)))
      (STELLA::%%PRINT-STREAM (STELLA::%NATIVE-STREAM STREAM-000) "Don't know how to convert object of type `" (STELLA::PRIMARY-TYPE SEQUENCE) "' into a cons list.")
      (CL:ERROR (STELLA::NEW-STELLA-EXCEPTION (STELLA::THE-STRING-READER STREAM-000))))))))
...
(CL:DEFUN EXPLODE-STRING-LIST (STRINGLIST MODULE)
  ...
  (CL:LET* ((STELLA::*MODULE* MODULE) (STELLA::*CONTEXT* STELLA::*MODULE*)) (CL:DECLARE (CL:SPECIAL STELLA::*MODULE* STELLA::*CONTEXT*))
   (CL:LET* ((EXPRESSION (STELLA::READ-S-EXPRESSION-FROM-STRING STRINGLIST)) (TERM STELLA::NULL) (RESULT STELLA::NIL))
    (CL:LET* ((REF STELLA::NULL) (ITER-000 EXPRESSION) (COLLECT-000 STELLA::NULL))
     (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-000 STELLA::NIL)) DO (CL:SETQ REF (STELLA::%%VALUE ITER-000))
      (CL:SETQ TERM (CL:IF (CL:EQ REF SYM-PLI-STELLA-NULL) STELLA::NULL (STELLA::EVALUATE-TERM REF)))
      (CL:IF (CL:EQ COLLECT-000 STELLA::NULL)
       (CL:PROGN (CL:SETQ COLLECT-000 (STELLA::CONS TERM STELLA::NIL))
        (CL:IF (CL:EQ RESULT STELLA::NIL) (CL:SETQ RESULT COLLECT-000) (STELLA::ADD-CONS-TO-END-OF-CONS-LIST RESULT COLLECT-000)))
       (CL:PROGN (CL:SETF (STELLA::%%REST COLLECT-000) (STELLA::CONS TERM STELLA::NIL)) (CL:SETQ COLLECT-000 (STELLA::%%REST COLLECT-000))))
...
(CL:DEFUN LEGAL-OPERATOR? (OPERATOR)
  (CL:OR (STELLA::MEMBER? STELLA::*KIF-SENTENCE-OPERATORS* OPERATOR) (STELLA::MEMBER? STELLA::*KIF-TERM-OPERATORS* OPERATOR)
   (STELLA::MEMBER? (STELLA::GET-QUOTED-TREE "((<=>> <<=> <<=>> <~> <~>> <<~> <<~>> ABOUT <<= =>> <~ ~> <<~ ~>>) \"/PLI\")" "/PLI") OPERATOR)))
...
exists.  `name' is ALWAYS treated case sensitively."
  ...
  (CL:LET* ((MDL-000 MODULE) (CXT-000 MDL-000)) (CL:WHEN (CL:EQ MDL-000 STELLA::NULL) (CL:SETQ MDL-000 STELLA::*MODULE*) (CL:SETQ CXT-000 STELLA::*CONTEXT*))
   (CL:LET* ((STELLA::*MODULE* MDL-000) (STELLA::*CONTEXT* CXT-000)) (CL:DECLARE (CL:SPECIAL STELLA::*MODULE* STELLA::*CONTEXT*)) (CL:SETQ ENVIRONMENT ENVIRONMENT)
    (STELLA::WITH-PROCESS-LOCK STELLA::*POWERLOOM-LOCK* (STELLA::LOOKUP-SYMBOL NAME)))))
...
If no such operator exists then a `no-such-object' exception is thrown."
  ...
  (CL:LET* ((OPERATOR (STELLA::LOOKUP-SYMBOL-IN-MODULE NAME STELLA::*LOGIC-MODULE* CL:NIL)))
   (CL:IF (CL:AND (CL:NOT (CL:EQ OPERATOR STELLA::NULL)) (LEGAL-OPERATOR? OPERATOR)) OPERATOR
    (CL:LET* ((STREAM-000 (STELLA::NEW-OUTPUT-STRING-STREAM))) (STELLA::%%PRINT-STREAM (STELLA::%NATIVE-STREAM STREAM-000) "No operator named `" NAME "'")
     (CL:ERROR (STELLA::NEW-NO-SUCH-OBJECT-EXCEPTION (STELLA::THE-STRING-READER STREAM-000)))))))
...
or visible from the module `module'."
  ...
  (CL:LET* ((MDL-000 MODULE) (CXT-000 MDL-000)) (CL:WHEN (CL:EQ MDL-000 STELLA::NULL) (CL:SETQ MDL-000 STELLA::*MODULE*) (CL:SETQ CXT-000 STELLA::*CONTEXT*))
   (CL:LET* ((STELLA::*MODULE* MDL-000) (STELLA::*CONTEXT* CXT-000)) (CL:DECLARE (CL:SPECIAL STELLA::*MODULE* STELLA::*CONTEXT*)) (CL:SETQ ENVIRONMENT ENVIRONMENT)
    (STELLA::WITH-PROCESS-LOCK STELLA::*POWERLOOM-LOCK* (STELLA::GET-INSTANCE (STELLA::INTERN-STELLA-NAME NAME))))))
...
or visible from the module `module'."
  ...
  (CL:LET* ((MDL-000 MODULE) (CXT-000 MDL-000)) (CL:WHEN (CL:EQ MDL-000 STELLA::NULL) (CL:SETQ MDL-000 STELLA::*MODULE*) (CL:SETQ CXT-000 STELLA::*CONTEXT*))
   (CL:LET* ((STELLA::*MODULE* MDL-000) (STELLA::*CONTEXT* CXT-000)) (CL:DECLARE (CL:SPECIAL STELLA::*MODULE* STELLA::*CONTEXT*)) (CL:SETQ ENVIRONMENT ENVIRONMENT)
    (STELLA::WITH-PROCESS-LOCK STELLA::*POWERLOOM-LOCK* (STELLA::GET-CLASS (STELLA::INTERN-STELLA-NAME NAME))))))
...
or visible from the module `module'."
  ...
  (CL:LET* ((MDL-000 MODULE) (CXT-000 MDL-000)) (CL:WHEN (CL:EQ MDL-000 STELLA::NULL) (CL:SETQ MDL-000 STELLA::*MODULE*) (CL:SETQ CXT-000 STELLA::*CONTEXT*))
   (CL:LET* ((STELLA::*MODULE* MDL-000) (STELLA::*CONTEXT* CXT-000)) (CL:DECLARE (CL:SPECIAL STELLA::*MODULE* STELLA::*CONTEXT*)) (CL:SETQ ENVIRONMENT ENVIRONMENT)
    (STELLA::WITH-PROCESS-LOCK STELLA::*POWERLOOM-LOCK* (STELLA::GET-RELATION (STELLA::INTERN-STELLA-NAME NAME))))))
...
(CL:DEFUN GET-UNDEFINED-RELATIONS (MODULE ENVIRONMENT)
  ...
  (CL:LET* ((MDL-000 MODULE) (CXT-000 MDL-000)) (CL:WHEN (CL:EQ MDL-000 STELLA::NULL) (CL:SETQ MDL-000 STELLA::*MODULE*) (CL:SETQ CXT-000 STELLA::*CONTEXT*))
   (CL:LET* ((STELLA::*MODULE* MDL-000) (STELLA::*CONTEXT* CXT-000)) (CL:DECLARE (CL:SPECIAL STELLA::*MODULE* STELLA::*CONTEXT*)) (CL:SETQ ENVIRONMENT ENVIRONMENT)
    (STELLA::WITH-PROCESS-LOCK STELLA::*POWERLOOM-LOCK* (CONS-TO-PL-ITERATOR (STELLA::CALL-LIST-UNDEFINED-RELATIONS MODULE CL:NIL))))))

;;; (DEFUN (GET-NAME-IN-MODULE STRING) ...)

(CL:DECLAIM (CL:FTYPE (CL:FUNCTION (CL:T CL:T CL:T) CL:SIMPLE-STRING) GET-NAME-IN-MODULE))
   ...
   (CL:LET* ((STELLA::*MODULE* MDL-000) (STELLA::*CONTEXT* CXT-000)) (CL:DECLARE (CL:SPECIAL STELLA::*MODULE* STELLA::*CONTEXT*)) (CL:SETQ ENVIRONMENT ENVIRONMENT)
    (STELLA::WITH-PROCESS-LOCK STELLA::*POWERLOOM-LOCK*
     (CL:LET* ((TEST-VALUE-000 (STELLA::SAFE-PRIMARY-TYPE OBJ)))
      (CL:COND ((STELLA::SUBTYPE-OF? TEST-VALUE-000 SGT-PLI-LOGIC-SKOLEM) (CL:PROGN STELLA::NULL-STRING))
       ((STELLA::SUBTYPE-OF? TEST-VALUE-000 SGT-PLI-LOGIC-LOGIC-OBJECT) (CL:PROGN (STELLA::STRINGIFY (STELLA::OBJECT-NAME OBJ))))
       ((STELLA::SUBTYPE-OF? TEST-VALUE-000 SGT-PLI-STELLA-GENERALIZED-SYMBOL) (CL:PROGN (STELLA::STRINGIFY OBJ)))
       ((STELLA::SUBTYPE-OF? TEST-VALUE-000 SGT-PLI-STELLA-MODULE) (CL:PROGN (STELLA::%MODULE-FULL-NAME OBJ)))
       ((STELLA::SUBTYPE-OF? TEST-VALUE-000 SGT-PLI-STELLA-CONTEXT) (CL:PROGN (STELLA::CONTEXT-NAME OBJ)))
       ((STELLA::SUBTYPE-OF? TEST-VALUE-000 SGT-PLI-LOGIC-COMPUTED-PROCEDURE) (CL:PROGN (STELLA::STRINGIFY (STELLA::%SURROGATE-VALUE-INVERSE OBJ))))
...
(CL:DECLAIM (CL:FTYPE (CL:FUNCTION (CL:T) CL:SIMPLE-STRING) GET-SHORT-NAME))
(CL:DEFUN GET-SHORT-NAME (OBJ)
  "Return the short name of `obj', if it has one.  Otherwise return `null'."
  (CL:LET* ((TEST-VALUE-000 (STELLA::SAFE-PRIMARY-TYPE OBJ)))
   (CL:COND ((STELLA::SUBTYPE-OF? TEST-VALUE-000 SGT-PLI-LOGIC-SKOLEM) (CL:PROGN STELLA::NULL-STRING))
    ((STELLA::SUBTYPE-OF? TEST-VALUE-000 SGT-PLI-LOGIC-LOGIC-OBJECT) (CL:PROGN (STELLA::OBJECT-NAME-STRING OBJ)))
    ((STELLA::SUBTYPE-OF-KEYWORD? TEST-VALUE-000) (CL:PROGN (STELLA::CONCATENATE ":" (STELLA::%SYMBOL-NAME OBJ))))
    ((STELLA::SUBTYPE-OF? TEST-VALUE-000 SGT-PLI-STELLA-GENERALIZED-SYMBOL) (CL:PROGN (STELLA::%SYMBOL-NAME OBJ)))
    ((STELLA::SUBTYPE-OF? TEST-VALUE-000 SGT-PLI-STELLA-CONTEXT) (CL:PROGN (STELLA::CONTEXT-NAME OBJ)))
    ((STELLA::SUBTYPE-OF? TEST-VALUE-000 SGT-PLI-LOGIC-COMPUTED-PROCEDURE) (CL:PROGN (STELLA::%SYMBOL-NAME (STELLA::%SURROGATE-VALUE-INVERSE OBJ))))
    (CL:T STELLA::NULL-STRING))))

;;; (DEFUN (OBJECT-TO-STRING STRING) ...)

(CL:DECLAIM (CL:FTYPE (CL:FUNCTION (CL:T) CL:SIMPLE-STRING) OBJECT-TO-STRING))
(CL:DEFUN OBJECT-TO-STRING (SELF)
  ...
  (CL:IF (CL:EQ SELF STELLA::NULL) STELLA::NULL-STRING
   (CL:LET* ((STELLA::*PRINTREADABLY?* CL:T)) (CL:DECLARE (CL:SPECIAL STELLA::*PRINTREADABLY?*))
    (CL:LET* ((TEST-VALUE-000 (STELLA::SAFE-PRIMARY-TYPE SELF)))
     (CL:COND ((STELLA::SUBTYPE-OF-STRING? TEST-VALUE-000) (CL:PROGN (STELLA::%WRAPPER-VALUE SELF)))
      ((STELLA::SUBTYPE-OF? TEST-VALUE-000 SGT-PLI-LOGIC-SKOLEM)
       (CL:PROGN (CL:LET* ((VALUE (STELLA::VALUE-OF SELF))) (CL:IF (CL:EQ VALUE SELF) (STELLA::STRINGIFY SELF) (OBJECT-TO-STRING VALUE)))))
      ((STELLA::SUBTYPE-OF? TEST-VALUE-000 SGT-PLI-PLI-PL-ITERATOR) (CL:PROGN (STELLA::STRINGIFY (STELLA::CONSIFY SELF)))) (CL:T (STELLA::STRINGIFY SELF)))))))
     ...
     (CL:PROGN
      (CL:LET* ((VALUE (STELLA::VALUE-OF SELF)))
       (CL:IF (CL:EQ VALUE SELF)
        (CL:LET* ((STREAM-000 (STELLA::NEW-OUTPUT-STRING-STREAM))) (STELLA::%%PRINT-STREAM (STELLA::%NATIVE-STREAM STREAM-000) "Can't coerce `" SELF "' to an integer.")
         (CL:ERROR (STELLA::NEW-STELLA-EXCEPTION (STELLA::THE-STRING-READER STREAM-000))))
        (OBJECT-TO-INTEGER VALUE)))))
    ((STELLA::SUBTYPE-OF-INTEGER? TEST-VALUE-000) (CL:PROGN (STELLA::%WRAPPER-VALUE SELF)))
    ((STELLA::SUBTYPE-OF-FLOAT? TEST-VALUE-000) (CL:PROGN (STELLA::ROUND (STELLA::%WRAPPER-VALUE SELF))))
    (CL:T
     (CL:LET* ((STREAM-001 (STELLA::NEW-OUTPUT-STRING-STREAM))) (STELLA::%%PRINT-STREAM (STELLA::%NATIVE-STREAM STREAM-001) "Can't coerce `" SELF "' to an integer.")
      (CL:ERROR (STELLA::NEW-STELLA-EXCEPTION (STELLA::THE-STRING-READER STREAM-001))))))))

;;; (DEFUN (OBJECT-TO-FLOAT FLOAT) ...)

(CL:DECLAIM (CL:FTYPE (CL:FUNCTION (CL:T) CL:DOUBLE-FLOAT) OBJECT-TO-FLOAT))
   ...
   (CL:COND
    ((STELLA::SUBTYPE-OF? TEST-VALUE-000 SGT-PLI-LOGIC-SKOLEM)
     (CL:PROGN
      (CL:LET* ((VALUE (STELLA::VALUE-OF SELF)))
       (CL:IF (CL:EQ VALUE SELF)
        (CL:LET* ((STREAM-000 (STELLA::NEW-OUTPUT-STRING-STREAM))) (STELLA::%%PRINT-STREAM (STELLA::%NATIVE-STREAM STREAM-000) "Can't coerce `" SELF "' to a float.")
         (CL:ERROR (STELLA::NEW-STELLA-EXCEPTION (STELLA::THE-STRING-READER STREAM-000))))
        (OBJECT-TO-FLOAT VALUE)))))
    ((STELLA::SUBTYPE-OF-INTEGER? TEST-VALUE-000) (CL:PROGN (STELLA::NUMBER-WRAPPER-TO-FLOAT SELF)))
    ((STELLA::SUBTYPE-OF-FLOAT? TEST-VALUE-000) (CL:PROGN (STELLA::%WRAPPER-VALUE SELF)))
    (CL:T
     (CL:LET* ((STREAM-001 (STELLA::NEW-OUTPUT-STRING-STREAM))) (STELLA::%%PRINT-STREAM (STELLA::%NATIVE-STREAM STREAM-001) "Can't coerce `" SELF "' to a float.")
      (CL:ERROR (STELLA::NEW-STELLA-EXCEPTION (STELLA::THE-STRING-READER STREAM-001))))))))

;;; (DEFUN (OBJECT-TO-PARSABLE-STRING STRING) ...)

(CL:DECLAIM (CL:FTYPE (CL:FUNCTION (CL:T) CL:SIMPLE-STRING) OBJECT-TO-PARSABLE-STRING))
...
escaped double quotes around strings."
  (CL:COND ((STELLA::SUBTYPE-OF-STRING? (STELLA::SAFE-PRIMARY-TYPE SELF)) (CL:PROGN (STELLA::CONCATENATE "\"" (STELLA::%WRAPPER-VALUE SELF) "\"")))
   ...
   (CL:LET* ((STELLA::*MODULE* MDL-000) (STELLA::*CONTEXT* CXT-000)) (CL:DECLARE (CL:SPECIAL STELLA::*MODULE* STELLA::*CONTEXT*)) (CL:SETQ ENVIRONMENT ENVIRONMENT)
    (STELLA::WITH-PROCESS-LOCK STELLA::*POWERLOOM-LOCK*
     (CL:LET* ((OBJ (STELLA::READ-S-EXPRESSION-FROM-STRING STRING)))
      (CL:COND
       ((STELLA::SUBTYPE-OF? (STELLA::SAFE-PRIMARY-TYPE OBJ) SGT-PLI-STELLA-LITERAL-WRAPPER)
        (CL:PROGN (CL:WHEN (CL:EQ TYPE STELLA::NULL) (CL:RETURN-FROM STRING-TO-OBJECT OBJ))
         (CL:LET* ((TEST-VALUE-000 (STELLA::SAFE-PRIMARY-TYPE OBJ)))
          (CL:COND
           ((STELLA::SUBTYPE-OF-STRING? TEST-VALUE-000)
            (CL:PROGN
             (CL:IF (STELLA::SUBRELATION-OF? TYPE *STRING-CONCEPT*) OBJ
              (CL:LET* ((STREAM-000 (STELLA::NEW-OUTPUT-STRING-STREAM)))
               (STELLA::%%PRINT-STREAM (STELLA::%NATIVE-STREAM STREAM-000) "String argument found, but `" TYPE "' is not a subconcept of `" *STRING-CONCEPT* "'")
               (CL:ERROR (STELLA::NEW-PARSING-ERROR (STELLA::THE-STRING-READER STREAM-000)))))))
           ((STELLA::SUBTYPE-OF-INTEGER? TEST-VALUE-000)
            (CL:PROGN
             (CL:COND ((STELLA::SUBRELATION-OF? TYPE *INTEGER-CONCEPT*) OBJ)
              ((STELLA::SUBRELATION-OF? TYPE *FLOAT-CONCEPT*) (STELLA::WRAP-FLOAT (CL:FLOAT (STELLA::%WRAPPER-VALUE OBJ) 0.0d0)))
              (CL:T (GET-OBJECT STRING MODULE ENVIRONMENT)))))
           ((STELLA::SUBTYPE-OF-FLOAT? TEST-VALUE-000)
            (CL:PROGN (CL:COND ((STELLA::SUBRELATION-OF? TYPE *FLOAT-CONCEPT*) OBJ) (CL:T (GET-OBJECT STRING MODULE ENVIRONMENT)))))
           (CL:T
            (CL:LET* ((STREAM-001 (STELLA::NEW-OUTPUT-STRING-STREAM)))
             (STELLA::%%PRINT-STREAM (STELLA::%NATIVE-STREAM STREAM-001) "`" TEST-VALUE-000 "' is not a valid case option")
             (CL:ERROR (STELLA::NEW-STELLA-EXCEPTION (STELLA::THE-STRING-READER STREAM-001)))))))))
       (CL:T
        (CL:COND ((CL:EQ TYPE STELLA::NULL) (GET-OBJECT STRING MODULE ENVIRONMENT)) ((STELLA::SUBRELATION-OF? TYPE *STRING-CONCEPT*) (STELLA::WRAP-STRING STRING))
         ((STELLA::SUBRELATION-OF? TYPE *LITERAL-CONCEPT*)
          (CL:LET* ((STREAM-002 (STELLA::NEW-OUTPUT-STRING-STREAM)))
           (STELLA::%%PRINT-STREAM (STELLA::%NATIVE-STREAM STREAM-002) "`" STRING "' is a non-literal, but `" TYPE "' is a subconcept of `" *LITERAL-CONCEPT* "'")
           (CL:ERROR (STELLA::NEW-PARSING-ERROR (STELLA::THE-STRING-READER STREAM-002)))))
         (CL:T (GET-OBJECT STRING MODULE ENVIRONMENT))))))))))
...
(CL:DEFUN HELP-GET-TRUE-EXTENSION-MEMBERS (RELATION SPECIALIZE?)
  (CL:LET* ((VALUE-000 STELLA::NIL))
   (CL:LET* ((P STELLA::NULL) (ITER-000 (STELLA::ALL-EXTENSION-MEMBERS RELATION)) (COLLECT-000 STELLA::NULL))
    (CL:LOOP WHILE (STELLA::NEXT? ITER-000) DO (CL:SETQ P (STELLA::%VALUE ITER-000))
     (CL:WHEN
      (CL:AND (CL:NOT (STELLA::DELETED? P)) (CL:IF STELLA::*REVERSEPOLARITY?* (STELLA::FALSE? P) (CL:OR (STELLA::TRUE? P) (STELLA::FUNCTION-WITH-DEFINED-VALUE? P))))
      (CL:IF (CL:EQ COLLECT-000 STELLA::NULL)
       (CL:PROGN (CL:SETQ COLLECT-000 (STELLA::CONS P STELLA::NIL))
        (CL:IF (CL:EQ VALUE-000 STELLA::NIL) (CL:SETQ VALUE-000 COLLECT-000) (STELLA::ADD-CONS-TO-END-OF-CONS-LIST VALUE-000 COLLECT-000)))
       (CL:PROGN (CL:SETF (STELLA::%%REST COLLECT-000) (STELLA::CONS P STELLA::NIL)) (CL:SETQ COLLECT-000 (STELLA::%%REST COLLECT-000)))))))
   (CL:LET* ((RESULT VALUE-000))
    (CL:WHEN SPECIALIZE?
     (CL:LET* ((SUB STELLA::NULL) (ITER-001 (STELLA::ALL-SUBCOLLECTIONS RELATION)))
      (CL:LOOP WHILE (STELLA::NEXT? ITER-001) DO (CL:SETQ SUB (STELLA::%VALUE ITER-001))
       (CL:WHEN (STELLA::ISA? SUB SGT-PLI-LOGIC-NAMED-DESCRIPTION)
        (CL:LET* ((P STELLA::NULL) (ITER-002 (STELLA::ALL-EXTENSION-MEMBERS SUB)))
         (CL:LOOP WHILE (STELLA::NEXT? ITER-002) DO (CL:SETQ P (STELLA::%VALUE ITER-002))
          (CL:WHEN
           (CL:AND (CL:NOT (STELLA::DELETED? P))
            (CL:IF STELLA::*REVERSEPOLARITY?* (STELLA::FALSE? P) (CL:OR (STELLA::TRUE? P) (STELLA::FUNCTION-WITH-DEFINED-VALUE? P))))
           (CL:SETQ RESULT (STELLA::CONS P RESULT))))))))
     (CL:RETURN-FROM HELP-GET-TRUE-EXTENSION-MEMBERS (STELLA::REMOVE-DUPLICATES RESULT)))
    RESULT)))
...
(CL:DEFUN HELP-GET-PROPOSITIONS (RELATION ARGUMENTS LIMIT MODULE ENVIRONMENT)
  ...
  (CL:LET* ((MDL-000 MODULE) (CXT-000 MDL-000)) (CL:WHEN (CL:EQ MDL-000 STELLA::NULL) (CL:SETQ MDL-000 STELLA::*MODULE*) (CL:SETQ CXT-000 STELLA::*CONTEXT*))
   (CL:LET* ((STELLA::*MODULE* MDL-000) (STELLA::*CONTEXT* CXT-000)) (CL:DECLARE (CL:SPECIAL STELLA::*MODULE* STELLA::*CONTEXT*)) (CL:SETQ ENVIRONMENT ENVIRONMENT)
    (STELLA::WITH-PROCESS-LOCK STELLA::*POWERLOOM-LOCK*
     (CL:LET*
      ((ASSERTIONSONLY? (CL:AND (CL:NOT (CL:EQ ENVIRONMENT STELLA::NULL)) (STELLA::STRING-EQL? (STELLA::%LEVEL ENVIRONMENT) "ASSERTION")))
       (SPECIALIZE? (CL:NOT ASSERTIONSONLY?)))
      (CL:LET* ((VALUE-000 STELLA::NULL))
       (CL:LET* ((ARG STELLA::NULL) (ITER-000 ARGUMENTS))
        (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-000 STELLA::NIL)) DO (CL:SETQ ARG (STELLA::%%VALUE ITER-000))
         (CL:WHEN (CL:AND (CL:NOT (CL:EQ ARG STELLA::NULL)) (STELLA::ISA? ARG SGT-PLI-LOGIC-LOGIC-OBJECT)) (CL:SETQ VALUE-000 ARG) (CL:RETURN))
         (CL:SETQ ITER-000 (STELLA::%%REST ITER-000))))
       (CL:LET*
        ((ARGUMENTWITHBACKLINKS VALUE-000)
         (ITERATOR
          (CL:IF (CL:NOT (CL:EQ ARGUMENTWITHBACKLINKS STELLA::NULL))
           (STELLA::ALL-TRUE-DEPENDENT-PROPOSITIONS ARGUMENTWITHBACKLINKS (STELLA::%SURROGATE-VALUE-INVERSE RELATION) SPECIALIZE?)
           (STELLA::ALLOCATE-ITERATOR (HELP-GET-TRUE-EXTENSION-MEMBERS RELATION SPECIALIZE?))))
         (RESULTS STELLA::NIL))
        (CL:WHEN (CL:NOT ASSERTIONSONLY?) (CL:SETQ STELLA::*CONTEXT* (STELLA::GET-PROPERTY-TEST-CONTEXT)))
        (CL:LET* ((P STELLA::NULL) (ITER-001 ITERATOR))
         (CL:LOOP WHILE (STELLA::NEXT? ITER-001) DO (CL:SETQ P (STELLA::%VALUE ITER-001))
          (CL:LET* ((TEST-VALUE-000 CL:NIL))
           (CL:LET* ((ALWAYS?-000 CL:T))
            (CL:LET*
             ((INPUTARG STELLA::NULL) (ITER-002 ARGUMENTS) (ARG2 STELLA::NULL) (VECTOR-000 (STELLA::%ARGUMENTS P)) (INDEX-000 0)
              (LENGTH-000 (STELLA::LENGTH VECTOR-000)))
             (CL:DECLARE (CL:TYPE CL:FIXNUM INDEX-000 LENGTH-000))
             (CL:LOOP WHILE (CL:AND (CL:NOT (CL:EQ ITER-002 STELLA::NIL)) (CL:< INDEX-000 LENGTH-000)) DO (CL:SETQ INPUTARG (STELLA::%%VALUE ITER-002))
              (CL:SETQ ARG2 (CL:AREF (CL:THE CL:SIMPLE-VECTOR (STELLA::%THE-ARRAY VECTOR-000)) INDEX-000))
              (CL:WHEN (CL:NOT (CL:OR (CL:EQ INPUTARG STELLA::NULL) (STELLA::EQL? INPUTARG (STELLA::VALUE-OF ARG2)))) (CL:SETQ ALWAYS?-000 CL:NIL) (CL:RETURN))
              (CL:SETQ ITER-002 (STELLA::%%REST ITER-002)) (CL:SETQ INDEX-000 (CL:1+ INDEX-000))))
            (CL:SETQ TEST-VALUE-000 ALWAYS?-000))
           (CL:WHEN TEST-VALUE-000 (CL:SETQ TEST-VALUE-000 (CL:= (STELLA::LENGTH ARGUMENTS) (STELLA::LENGTH (STELLA::%ARGUMENTS P)))))
           (CL:WHEN TEST-VALUE-000 (CL:SETQ RESULTS (STELLA::CONS P RESULTS)) (CL:SETQ LIMIT (CL:1- LIMIT)) (CL:WHEN (CL:= LIMIT 0) (CL:RETURN))))))
        RESULTS)))))))
...
relations or functions."
  (CL:LET* ((LIST (SEQUENCE-TO-CONS-LIST RELATION-AND-ARGUMENTS)) (RELATION (STELLA::%%VALUE LIST)) (ARGUMENTS (STELLA::%%REST LIST)))
   (STELLA::%%VALUE (HELP-GET-PROPOSITIONS RELATION ARGUMENTS 1 MODULE ENVIRONMENT))))
...
name of a relation.  A null value acts like a wild card."
  (CL:LET* ((LIST (SEQUENCE-TO-CONS-LIST RELATION-AND-ARGUMENTS)) (RELATION (STELLA::%%VALUE LIST)) (ARGUMENTS (STELLA::%%REST LIST)))
   (CONS-TO-PL-ITERATOR (HELP-GET-PROPOSITIONS RELATION ARGUMENTS 0 MODULE ENVIRONMENT))))
...
(CL:DEFUN GET-INCONSISTENT-PROPOSITIONS (MODULE ENVIRONMENT)
  ...
  (CL:LET* ((MDL-000 MODULE) (CXT-000 MDL-000)) (CL:WHEN (CL:EQ MDL-000 STELLA::NULL) (CL:SETQ MDL-000 STELLA::*MODULE*) (CL:SETQ CXT-000 STELLA::*CONTEXT*))
   (CL:LET* ((STELLA::*MODULE* MDL-000) (STELLA::*CONTEXT* CXT-000)) (CL:DECLARE (CL:SPECIAL STELLA::*MODULE* STELLA::*CONTEXT*)) (CL:SETQ ENVIRONMENT ENVIRONMENT)
    (STELLA::WITH-PROCESS-LOCK STELLA::*POWERLOOM-LOCK* (ITERATOR-TO-PL-ITERATOR (STELLA::ALL-INCONSISTENT-PROPOSITIONS MODULE CL:NIL))))))
   ...
   (CL:LET* ((STELLA::*MODULE* MDL-000) (STELLA::*CONTEXT* CXT-000)) (CL:DECLARE (CL:SPECIAL STELLA::*MODULE* STELLA::*CONTEXT*)) (CL:SETQ ENVIRONMENT ENVIRONMENT)
    (STELLA::WITH-PROCESS-LOCK STELLA::*POWERLOOM-LOCK*
     (CL:LET* ((ARGUMENTWITHBACKLINKS STELLA::NULL))
      (CL:COND ((CL:AND (CL:NOT (CL:EQ ARG1 STELLA::NULL)) (STELLA::ISA? ARG1 SGT-PLI-LOGIC-LOGIC-OBJECT)) (CL:SETQ ARGUMENTWITHBACKLINKS ARG1))
       ((CL:AND (CL:NOT (CL:EQ ARG2 STELLA::NULL)) (STELLA::ISA? ARG2 SGT-PLI-LOGIC-LOGIC-OBJECT)) (CL:SETQ ARGUMENTWITHBACKLINKS ARG2)))
      (CL:IF (CL:NOT (CL:EQ ARGUMENTWITHBACKLINKS STELLA::NULL))
       (CL:LET* ((P STELLA::NULL) (ITER-000 (STELLA::ALL-TRUE-DEPENDENT-PROPOSITIONS ARGUMENTWITHBACKLINKS (STELLA::%SURROGATE-VALUE-INVERSE RELATION) CL:NIL)))
        (CL:LOOP WHILE (STELLA::NEXT? ITER-000) DO (CL:SETQ P (STELLA::%VALUE ITER-000))
         (CL:WHEN
          (CL:AND
           (CL:OR (CL:EQ ARG1 STELLA::NULL) (STELLA::EQL? ARG1 (STELLA::VALUE-OF (CL:AREF (CL:THE CL:SIMPLE-VECTOR (STELLA::%THE-ARRAY (STELLA::%ARGUMENTS P))) 0))))
           (CL:OR (CL:EQ ARG2 STELLA::NULL) (STELLA::EQL? ARG2 (STELLA::VALUE-OF (CL:AREF (CL:THE CL:SIMPLE-VECTOR (STELLA::%THE-ARRAY (STELLA::%ARGUMENTS P))) 1)))))
          (CL:RETURN-FROM GET-BINARY-PROPOSITION P))))
       (CL:RETURN-FROM GET-BINARY-PROPOSITION (STELLA::%%VALUE (HELP-GET-PROPOSITIONS RELATION (STELLA::CONS-LIST ARG1 ARG2) 1 MODULE ENVIRONMENT))))
      STELLA::NULL)))))
...
may be set to NULL, which is interpreted as a wildcard."
  (CONS-TO-PL-ITERATOR (HELP-GET-PROPOSITIONS RELATION (STELLA::CONS-LIST ARG1 ARG2) 0 MODULE ENVIRONMENT)))
...
has been asserted or can be inferred."
  (CL:LET* ((MDL-000 MODULE) (CXT-000 MDL-000)) (CL:WHEN (CL:EQ MDL-000 STELLA::NULL) (CL:SETQ MDL-000 STELLA::*MODULE*) (CL:SETQ CXT-000 STELLA::*CONTEXT*))
   (CL:LET* ((STELLA::*MODULE* MDL-000) (STELLA::*CONTEXT* CXT-000)) (CL:DECLARE (CL:SPECIAL STELLA::*MODULE* STELLA::*CONTEXT*)) (CL:SETQ ENVIRONMENT ENVIRONMENT)
    (STELLA::WITH-PROCESS-LOCK STELLA::*POWERLOOM-LOCK*
     (CONS-TO-PL-ITERATOR
      (STELLA::APPLY-CACHED-RETRIEVE (STELLA::LIST* SYM-PLI-PLI-?R SYM-PLI-PLI-?I SYM-PLI-PLI-?V STELLA::NIL)
       (STELLA::LIST* SYM-PLI-PLI-?R SYM-PLI-PLI-?I SYM-PLI-PLI-?V STELLA::NIL) (STELLA::CONS-LIST RELATION ARG STELLA::NULL) (STELLA::CONS-LIST)
...
`no-such-context-exception' is thrown."
  ...
  (CL:LET*
   ...
   (CL:IF (CL:AND (CL:NOT (CL:EQ OBJECT STELLA::NULL)) (CL:NOT (CL:EQ RELATION STELLA::NULL)))
    (GET-INFERRED-BINARY-PROPOSITION-VALUES RELATION OBJECT MODULE ENVIRONMENT) EMPTY-PL-ITERATOR)))
...
and that are TRUE in the scope of the module `module'."
  (CL:LET* ((MDL-000 MODULE) (CXT-000 MDL-000)) (CL:WHEN (CL:EQ MDL-000 STELLA::NULL) (CL:SETQ MDL-000 STELLA::*MODULE*) (CL:SETQ CXT-000 STELLA::*CONTEXT*))
   (CL:LET* ((STELLA::*MODULE* MDL-000) (STELLA::*CONTEXT* CXT-000)) (CL:DECLARE (CL:SPECIAL STELLA::*MODULE* STELLA::*CONTEXT*)) (CL:SETQ ENVIRONMENT ENVIRONMENT)
    (STELLA::WITH-PROCESS-LOCK STELLA::*POWERLOOM-LOCK* (LIST-TO-PL-ITERATOR (STELLA::ALL-FACTS-OF-INSTANCE OBJECT CL:NIL CL:NIL))))))
...
the module `module'."
  (CL:LET* ((MDL-000 MODULE) (CXT-000 MDL-000)) (CL:WHEN (CL:EQ MDL-000 STELLA::NULL) (CL:SETQ MDL-000 STELLA::*MODULE*) (CL:SETQ CXT-000 STELLA::*CONTEXT*))
   (CL:LET* ((STELLA::*MODULE* MDL-000) (STELLA::*CONTEXT* CXT-000)) (CL:DECLARE (CL:SPECIAL STELLA::*MODULE* STELLA::*CONTEXT*)) (CL:SETQ ENVIRONMENT ENVIRONMENT)
    (STELLA::WITH-PROCESS-LOCK STELLA::*POWERLOOM-LOCK* (CONS-TO-PL-ITERATOR (STELLA::CONSIFY (STELLA::ALL-PROPOSITIONS STELLA::*MODULE* CL:T)))))))
...
been asserted (or inferred by forward chaining)."
  (CL:NOT (CL:EQ (HELP-GET-PROPOSITIONS RELATION (STELLA::CONS-LIST ARG) 1 MODULE ENVIRONMENT) STELLA::NULL)))
...
been asserted (or inferred by forward chaining)."
  (CL:NOT (CL:EQ (GET-BINARY-PROPOSITION RELATION ARG VALUE MODULE ENVIRONMENT) STELLA::NULL)))
...
been asserted (or inferred by forward chaining)."
  (CL:LET* ((LIST (SEQUENCE-TO-CONS-LIST RELATION-AND-ARGUMENTS)) (RELATION (STELLA::%%VALUE LIST)) (ARGUMENTS (STELLA::%%REST LIST)))
   (CL:NOT (CL:EQ (HELP-GET-PROPOSITIONS RELATION ARGUMENTS 1 MODULE ENVIRONMENT) STELLA::NULL))))
   ...
   (CL:LET* ((STELLA::*MODULE* MDL-000) (STELLA::*CONTEXT* CXT-000)) (CL:DECLARE (CL:SPECIAL STELLA::*MODULE* STELLA::*CONTEXT*)) (CL:SETQ ENVIRONMENT ENVIRONMENT)
    (STELLA::WITH-PROCESS-LOCK STELLA::*POWERLOOM-LOCK*
     (CL:AND (CL:NOT (STELLA::DELETED? PROPOSITION))
      (CL:IF STELLA::*REVERSEPOLARITY?* (STELLA::FALSE? PROPOSITION) (CL:OR (STELLA::TRUE? PROPOSITION) (STELLA::FUNCTION-WITH-DEFINED-VALUE? PROPOSITION))))))))
...
(CL:DEFUN IS-SUBRELATION (SUB SUPER MODULE ENVIRONMENT)
  ...
  (CL:WHEN (CL:OR (CL:EQ SUB STELLA::NULL) (CL:EQ SUPER STELLA::NULL)) (CL:RETURN-FROM IS-SUBRELATION CL:NIL))
  (CL:LET* ((MDL-000 MODULE) (CXT-000 MDL-000)) (CL:WHEN (CL:EQ MDL-000 STELLA::NULL) (CL:SETQ MDL-000 STELLA::*MODULE*) (CL:SETQ CXT-000 STELLA::*CONTEXT*))
   (CL:LET* ((STELLA::*MODULE* MDL-000) (STELLA::*CONTEXT* CXT-000)) (CL:DECLARE (CL:SPECIAL STELLA::*MODULE* STELLA::*CONTEXT*)) (CL:SETQ ENVIRONMENT ENVIRONMENT)
    (STELLA::WITH-PROCESS-LOCK STELLA::*POWERLOOM-LOCK* (STELLA::TRUE-TRUTH-VALUE? (STELLA::DESCRIPTION-SPECIALIZES-DESCRIPTION? SUB SUPER))))))
...
Non-reflexive."
  (CL:LET* ((MDL-000 MODULE) (CXT-000 MDL-000)) (CL:WHEN (CL:EQ MDL-000 STELLA::NULL) (CL:SETQ MDL-000 STELLA::*MODULE*) (CL:SETQ CXT-000 STELLA::*CONTEXT*))
   (CL:LET* ((STELLA::*MODULE* MDL-000) (STELLA::*CONTEXT* CXT-000)) (CL:DECLARE (CL:SPECIAL STELLA::*MODULE* STELLA::*CONTEXT*)) (CL:SETQ ENVIRONMENT ENVIRONMENT)
    (STELLA::WITH-PROCESS-LOCK STELLA::*POWERLOOM-LOCK* (CONS-TO-PL-ITERATOR (STELLA::ALL-SUBRELATIONS RELATION CL:T))))))
...
Non-reflexive."
  (CL:LET* ((MDL-000 MODULE) (CXT-000 MDL-000)) (CL:WHEN (CL:EQ MDL-000 STELLA::NULL) (CL:SETQ MDL-000 STELLA::*MODULE*) (CL:SETQ CXT-000 STELLA::*CONTEXT*))
   (CL:LET* ((STELLA::*MODULE* MDL-000) (STELLA::*CONTEXT* CXT-000)) (CL:DECLARE (CL:SPECIAL STELLA::*MODULE* STELLA::*CONTEXT*)) (CL:SETQ ENVIRONMENT ENVIRONMENT)
    (STELLA::WITH-PROCESS-LOCK STELLA::*POWERLOOM-LOCK* (CONS-TO-PL-ITERATOR (STELLA::ALL-DIRECT-SUBRELATIONS RELATION CL:T))))))
...
Non-reflexive."
  (CL:LET* ((MDL-000 MODULE) (CXT-000 MDL-000)) (CL:WHEN (CL:EQ MDL-000 STELLA::NULL) (CL:SETQ MDL-000 STELLA::*MODULE*) (CL:SETQ CXT-000 STELLA::*CONTEXT*))
   (CL:LET* ((STELLA::*MODULE* MDL-000) (STELLA::*CONTEXT* CXT-000)) (CL:DECLARE (CL:SPECIAL STELLA::*MODULE* STELLA::*CONTEXT*)) (CL:SETQ ENVIRONMENT ENVIRONMENT)
    (STELLA::WITH-PROCESS-LOCK STELLA::*POWERLOOM-LOCK* (CONS-TO-PL-ITERATOR (STELLA::ALL-SUPERRELATIONS RELATION CL:T))))))
...
Non-reflexive."
  (CL:LET* ((MDL-000 MODULE) (CXT-000 MDL-000)) (CL:WHEN (CL:EQ MDL-000 STELLA::NULL) (CL:SETQ MDL-000 STELLA::*MODULE*) (CL:SETQ CXT-000 STELLA::*CONTEXT*))
   (CL:LET* ((STELLA::*MODULE* MDL-000) (STELLA::*CONTEXT* CXT-000)) (CL:DECLARE (CL:SPECIAL STELLA::*MODULE* STELLA::*CONTEXT*)) (CL:SETQ ENVIRONMENT ENVIRONMENT)
    (STELLA::WITH-PROCESS-LOCK STELLA::*POWERLOOM-LOCK* (CONS-TO-PL-ITERATOR (STELLA::ALL-DIRECT-SUPERRELATIONS RELATION CL:T))))))
...
(CL:DEFUN IS-A (OBJECT CONCEPT MODULE ENVIRONMENT)
  ...
  (CL:LET* ((MDL-000 MODULE) (CXT-000 MDL-000)) (CL:WHEN (CL:EQ MDL-000 STELLA::NULL) (CL:SETQ MDL-000 STELLA::*MODULE*) (CL:SETQ CXT-000 STELLA::*CONTEXT*))
   (CL:LET* ((STELLA::*MODULE* MDL-000) (STELLA::*CONTEXT* CXT-000)) (CL:DECLARE (CL:SPECIAL STELLA::*MODULE* STELLA::*CONTEXT*)) (CL:SETQ ENVIRONMENT ENVIRONMENT)
    (STELLA::WITH-PROCESS-LOCK STELLA::*POWERLOOM-LOCK* (STELLA::TEST-ISA? OBJECT (STELLA::%SURROGATE-VALUE-INVERSE CONCEPT))))))
...
the return values could be (wrapped) literals."
  (CL:LET* ((MDL-000 MODULE) (CXT-000 MDL-000)) (CL:WHEN (CL:EQ MDL-000 STELLA::NULL) (CL:SETQ MDL-000 STELLA::*MODULE*) (CL:SETQ CXT-000 STELLA::*CONTEXT*))
   (CL:LET* ((STELLA::*MODULE* MDL-000) (STELLA::*CONTEXT* CXT-000)) (CL:DECLARE (CL:SPECIAL STELLA::*MODULE* STELLA::*CONTEXT*)) (CL:SETQ ENVIRONMENT ENVIRONMENT)
    (STELLA::WITH-PROCESS-LOCK STELLA::*POWERLOOM-LOCK*
     (CL:IF (CL:AND (CL:NOT (CL:EQ ENVIRONMENT STELLA::NULL)) (STELLA::STRING-EQL? (STELLA::%LEVEL ENVIRONMENT) "ASSERTION"))
      (LIST-TO-PL-ITERATOR (STELLA::REMOVE-DELETED-MEMBERS (STELLA::ASSERTED-COLLECTION-MEMBERS CONCEPT CL:NIL)))
      (RETRIEVE (STELLA::LIST* SYM-PLI-LOGIC-ALL SYM-PLI-LOGIC-?X (STELLA::CONS (STELLA::OBJECT-NAME CONCEPT) (STELLA::CONS SYM-PLI-LOGIC-?X STELLA::NIL)) STELLA::NIL)
       MODULE ENVIRONMENT))))))
...
the return values could be (wrapped) literals."
  (CL:LET* ((MDL-000 MODULE) (CXT-000 MDL-000)) (CL:WHEN (CL:EQ MDL-000 STELLA::NULL) (CL:SETQ MDL-000 STELLA::*MODULE*) (CL:SETQ CXT-000 STELLA::*CONTEXT*))
   (CL:LET* ((STELLA::*MODULE* MDL-000) (STELLA::*CONTEXT* CXT-000)) (CL:DECLARE (CL:SPECIAL STELLA::*MODULE* STELLA::*CONTEXT*)) (CL:SETQ ENVIRONMENT ENVIRONMENT)
    (STELLA::WITH-PROCESS-LOCK STELLA::*POWERLOOM-LOCK*
     (CL:IF (CL:AND (CL:NOT (CL:EQ ENVIRONMENT STELLA::NULL)) (STELLA::STRING-EQL? (STELLA::%LEVEL ENVIRONMENT) "ASSERTION"))
      (LIST-TO-PL-ITERATOR (STELLA::REMOVE-DELETED-MEMBERS (STELLA::ASSERTED-COLLECTION-MEMBERS CONCEPT CL:T)))
      (RETRIEVE
       (STELLA::LIST* SYM-PLI-LOGIC-ALL SYM-PLI-LOGIC-?X
        (STELLA::LIST* SYM-PLI-STELLA-AND (STELLA::CONS (STELLA::OBJECT-NAME CONCEPT) (STELLA::CONS SYM-PLI-LOGIC-?X STELLA::NIL))
         (STELLA::LIST* SYM-PLI-LOGIC-FAIL
          (STELLA::LIST* SYM-PLI-STELLA-EXISTS (STELLA::CONS SYM-PLI-LOGIC-?Y STELLA::NIL)
           (STELLA::LIST* SYM-PLI-STELLA-AND (STELLA::LIST* SYM-PLI-PLI-PROPER-SUBRELATION (STELLA::OBJECT-NAME CONCEPT) (STELLA::CONS SYM-PLI-LOGIC-?Y STELLA::NIL))
            (STELLA::LIST* SYM-PLI-LOGIC-?Y SYM-PLI-LOGIC-?X STELLA::NIL) STELLA::NIL)
           STELLA::NIL)
          STELLA::NIL)
         STELLA::NIL)
        STELLA::NIL)
...
`(relation <result> value)' holds."
  (CL:LET* ((MDL-000 MODULE) (CXT-000 MDL-000)) (CL:WHEN (CL:EQ MDL-000 STELLA::NULL) (CL:SETQ MDL-000 STELLA::*MODULE*) (CL:SETQ CXT-000 STELLA::*CONTEXT*))
   (CL:LET* ((STELLA::*MODULE* MDL-000) (STELLA::*CONTEXT* CXT-000)) (CL:DECLARE (CL:SPECIAL STELLA::*MODULE* STELLA::*CONTEXT*)) (CL:SETQ ENVIRONMENT ENVIRONMENT)
    (STELLA::WITH-PROCESS-LOCK STELLA::*POWERLOOM-LOCK*
     (CL:LET* ((INSTANCES (GET-CONCEPT-INSTANCES CONCEPT MODULE ENVIRONMENT)) (ANSWERS STELLA::NIL))
      (CL:LET* ((I STELLA::NULL) (ITER-000 INSTANCES))
       (CL:LOOP WHILE (STELLA::NEXT? ITER-000) DO (CL:SETQ I (STELLA::%VALUE ITER-000))
        (CL:WHEN (IS-TRUE-BINARY-PROPOSITION RELATION I VALUE MODULE ENVIRONMENT) (CL:SETQ ANSWERS (STELLA::CONS I ANSWERS)))))
...
`(relation <result> value)' holds."
  (CL:LET* ((MDL-000 MODULE) (CXT-000 MDL-000)) (CL:WHEN (CL:EQ MDL-000 STELLA::NULL) (CL:SETQ MDL-000 STELLA::*MODULE*) (CL:SETQ CXT-000 STELLA::*CONTEXT*))
   (CL:LET* ((STELLA::*MODULE* MDL-000) (STELLA::*CONTEXT* CXT-000)) (CL:DECLARE (CL:SPECIAL STELLA::*MODULE* STELLA::*CONTEXT*)) (CL:SETQ ENVIRONMENT ENVIRONMENT)
    (STELLA::WITH-PROCESS-LOCK STELLA::*POWERLOOM-LOCK*
     (CL:LET* ((INSTANCES (GET-CONCEPT-INSTANCES CONCEPT MODULE ENVIRONMENT)))
      (CL:LET* ((I STELLA::NULL) (ITER-000 INSTANCES))
       (CL:LOOP WHILE (STELLA::NEXT? ITER-000) DO (CL:SETQ I (STELLA::%VALUE ITER-000))
        (CL:WHEN (IS-TRUE-BINARY-PROPOSITION RELATION I VALUE MODULE ENVIRONMENT) (CL:RETURN-FROM GET-CONCEPT-INSTANCE-MATCHING-VALUE I))))
      STELLA::NULL)))))
   ...
   (CL:LET* ((STELLA::*MODULE* MDL-000) (STELLA::*CONTEXT* CXT-000)) (CL:DECLARE (CL:SPECIAL STELLA::*MODULE* STELLA::*CONTEXT*)) (CL:SETQ ENVIRONMENT ENVIRONMENT)
    (STELLA::WITH-PROCESS-LOCK STELLA::*POWERLOOM-LOCK*
     (CL:LET* ((DERIVABLETYPES STELLA::NIL))
      (CL:COND
       ((CL:OR (CL:EQ ENVIRONMENT STELLA::NULL) (CL:AND (CL:NOT (CL:EQ ENVIRONMENT STELLA::NULL)) (STELLA::STRING-EQL? (STELLA::%LEVEL ENVIRONMENT) "INFERENCE")))
        (CL:SETQ DERIVABLETYPES (STELLA::ALL-TYPES OBJECT)))
       ((CL:AND (CL:NOT (CL:EQ ENVIRONMENT STELLA::NULL)) (STELLA::STRING-EQL? (STELLA::%LEVEL ENVIRONMENT) "ASSERTION"))
        (CL:SETQ DERIVABLETYPES (STELLA::ALL-ASSERTED-TYPES OBJECT)))
       ((CL:AND (CL:NOT (CL:EQ ENVIRONMENT STELLA::NULL)) (STELLA::STRING-EQL? (STELLA::%LEVEL ENVIRONMENT) "TAXONOMIC"))
...
(CL:DEFUN GET-DIRECT-TYPES (OBJECT MODULE ENVIRONMENT)
  ...
  (CONS-TO-PL-ITERATOR (STELLA::MOST-SPECIFIC-NAMED-DESCRIPTIONS (HELP-GET-TYPES OBJECT MODULE ENVIRONMENT))))
    ...
    (STELLA::WITH-PROCESS-LOCK STELLA::*POWERLOOM-LOCK*
     (CONS-TO-PL-ITERATOR
      (HELP-GET-TRUE-EXTENSION-MEMBERS RELATION
       (CL:NOT (CL:AND (CL:NOT (CL:EQ ENVIRONMENT STELLA::NULL)) (STELLA::STRING-EQL? (STELLA::%LEVEL ENVIRONMENT) "ASSERTION")))))))))
...
case sensitive or not."
  ...
  (CL:LET*
   ((FULL-NAME (CL:IF (CL:NOT (CL:EQ PARENT STELLA::NULL)) (STELLA::CONCATENATE (STELLA::%MODULE-FULL-NAME PARENT) "/" NAME) NAME))
    (CASE-SENSITIVE-SYMBOL (CL:IF CASE-SENSITIVE? SYM-PLI-STELLA-TRUE SYM-PLI-STELLA-FALSE)))
   (CL:DECLARE (CL:TYPE CL:SIMPLE-STRING FULL-NAME)) (STELLA::DEFINE-MODULE FULL-NAME (STELLA::LIST* KWD-PLI-CASE-SENSITIVE? CASE-SENSITIVE-SYMBOL STELLA::NIL))))
...
module is returned."
  (CL:WHEN (CL:EQ MODULE STELLA::NULL) (CL:RETURN-FROM CHANGE-MODULE STELLA::*MODULE*))
...
(CL:DEFUN GET-CHILD-MODULES (MODULE)
  ...
  (CL:LET* ((DIRECTSUBMODULES STELLA::NIL))
   (CL:LET* ((CHILD STELLA::NULL) (ITER-000 (STELLA::%THE-CONS-LIST (STELLA::%CHILD-CONTEXTS MODULE))) (COLLECT-000 STELLA::NULL))
    (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-000 STELLA::NIL)) DO (CL:SETQ CHILD (STELLA::%%VALUE ITER-000))
     (CL:WHEN (STELLA::ISA? CHILD SGT-PLI-STELLA-MODULE)
      (CL:IF (CL:EQ COLLECT-000 STELLA::NULL)
       (CL:PROGN (CL:SETQ COLLECT-000 (STELLA::CONS CHILD STELLA::NIL))
        (CL:IF (CL:EQ DIRECTSUBMODULES STELLA::NIL) (CL:SETQ DIRECTSUBMODULES COLLECT-000) (STELLA::ADD-CONS-TO-END-OF-CONS-LIST DIRECTSUBMODULES COLLECT-000)))
       (CL:PROGN (CL:SETF (STELLA::%%REST COLLECT-000) (STELLA::CONS CHILD STELLA::NIL)) (CL:SETQ COLLECT-000 (STELLA::%%REST COLLECT-000)))))
     (CL:SETQ ITER-000 (STELLA::%%REST ITER-000))))
...
(CL:DECLAIM (CL:FTYPE (CL:FUNCTION (CL:SIMPLE-STRING CL:T CL:T) CL:SIMPLE-STRING) GENERATE-UNIQUE-NAME))
...
name will be all upper case (This latter feature may change!)"
  ...
  (CL:LET* ((MDL-000 MODULE) (CXT-000 MDL-000)) (CL:WHEN (CL:EQ MDL-000 STELLA::NULL) (CL:SETQ MDL-000 STELLA::*MODULE*) (CL:SETQ CXT-000 STELLA::*CONTEXT*))
   (CL:LET* ((STELLA::*MODULE* MDL-000) (STELLA::*CONTEXT* CXT-000)) (CL:DECLARE (CL:SPECIAL STELLA::*MODULE* STELLA::*CONTEXT*)) (CL:SETQ ENVIRONMENT ENVIRONMENT)
    (STELLA::WITH-PROCESS-LOCK STELLA::*POWERLOOM-LOCK*
     (CL:WHEN (CL:NOT (CL:OR (STELLA::%CASE-SENSITIVE? STELLA::*MODULE*) (STELLA::ALL-UPPER-CASE-STRING? PREFIX))) (CL:SETQ PREFIX (STELLA::STRING-UPCASE PREFIX)))
...
necessary to do."
  ...
  (CL:LET* ((MDL-000 MODULE) (CXT-000 MDL-000)) (CL:WHEN (CL:EQ MDL-000 STELLA::NULL) (CL:SETQ MDL-000 STELLA::*MODULE*) (CL:SETQ CXT-000 STELLA::*CONTEXT*))
   (CL:LET* ((STELLA::*MODULE* MDL-000) (STELLA::*CONTEXT* CXT-000)) (CL:DECLARE (CL:SPECIAL STELLA::*MODULE* STELLA::*CONTEXT*)) (CL:SETQ ENVIRONMENT ENVIRONMENT)
    (STELLA::WITH-PROCESS-LOCK STELLA::*POWERLOOM-LOCK* (STELLA::INTERN-SYMBOL-IN-MODULE NAME STELLA::*MODULE* CL:NIL)))))
...
Return the object."
  ...
  (CL:LET* ((MDL-000 MODULE) (CXT-000 MDL-000)) (CL:WHEN (CL:EQ MDL-000 STELLA::NULL) (CL:SETQ MDL-000 STELLA::*MODULE*) (CL:SETQ CXT-000 STELLA::*CONTEXT*))
   (CL:LET* ((STELLA::*MODULE* MDL-000) (STELLA::*CONTEXT* CXT-000)) (CL:DECLARE (CL:SPECIAL STELLA::*MODULE* STELLA::*CONTEXT*)) (CL:SETQ ENVIRONMENT ENVIRONMENT)
    (STELLA::WITH-PROCESS-LOCK STELLA::*POWERLOOM-LOCK*
     (CL:LET* ((OBJECT STELLA::NULL) (NAME-SYMBOL STELLA::NULL) (OBJECT-SURROGATE STELLA::NULL))
      (CL:COND ((CL:NOT (CL:EQ NAME STELLA::NULL-STRING)) (CL:SETQ NAME-SYMBOL (STELLA::INTERN-STELLA-NAME NAME)))
       ((CL:NOT (CL:EQ CONCEPT STELLA::NULL)) (CL:SETQ NAME-SYMBOL (STELLA::INTERN-SYMBOL (GET-SHORT-NAME CONCEPT)))
        (CL:SETQ NAME-SYMBOL
         (STELLA::INTERN-SYMBOL-IN-MODULE (GENERATE-UNIQUE-NAME (STELLA::%SYMBOL-NAME NAME-SYMBOL) (STELLA::%HOME-CONTEXT NAME-SYMBOL) STELLA::NULL)
          (STELLA::%HOME-CONTEXT NAME-SYMBOL) CL:T)))
       (CL:T (CL:SETQ NAME-SYMBOL (STELLA::INTERN-SYMBOL-IN-MODULE (GENERATE-UNIQUE-NAME "I" STELLA::NULL STELLA::NULL) STELLA::*MODULE* CL:T))))
      (CL:SETQ OBJECT-SURROGATE (STELLA::LOOKUP-SURROGATE-IN-MODULE (STELLA::%SYMBOL-NAME NAME-SYMBOL) (STELLA::%HOME-CONTEXT NAME-SYMBOL) CL:NIL))
      (CL:WHEN (CL:EQ OBJECT-SURROGATE STELLA::NULL)
       (CL:SETQ OBJECT-SURROGATE (STELLA::INTERN-SURROGATE-IN-MODULE (STELLA::%SYMBOL-NAME NAME-SYMBOL) (STELLA::%HOME-CONTEXT NAME-SYMBOL) CL:NIL)))
      (CL:SETQ OBJECT (STELLA::HELP-CREATE-LOGIC-INSTANCE OBJECT-SURROGATE STELLA::NULL))
      (CL:WHEN (CL:NOT (CL:EQ CONCEPT STELLA::NULL))
       (CL:IF (CL:NOT (CL:EQ (ASSERT-UNARY-PROPOSITION CONCEPT OBJECT MODULE ENVIRONMENT) STELLA::NULL)) (CL:RETURN-FROM CREATE-OBJECT OBJECT)
    ...
    (STELLA::WITH-PROCESS-LOCK STELLA::*POWERLOOM-LOCK*
     (STELLA::CALL-DEFCONCEPT
      (STELLA::CONS (STELLA::INTERN-STELLA-NAME NAME)
       (STELLA::CONCATENATE (CL:IF (CL:NOT (CL:EQ PARENT STELLA::NULL)) (STELLA::LIST* KWD-PLI-SUBSET-OF (STELLA::OBJECT-NAME PARENT) STELLA::NIL) STELLA::NIL)
        STELLA::NIL)))))))
...
the name of the returned object may not match `name' exactly."
  ...
  (CL:WHEN (CL:<= ARITY 0)
   (CL:LET* ((STREAM-000 (STELLA::NEW-OUTPUT-STRING-STREAM)))
    (CL:LET* ((STELLA::*PRINTREADABLY?* CL:T)) (CL:DECLARE (CL:SPECIAL STELLA::*PRINTREADABLY?*))
     (STELLA::%%PRINT-STREAM (STELLA::%NATIVE-STREAM STREAM-000) "PARSING ERROR: Relations must have arity of at least 1." EOL)
  ...
  (CL:LET* ((ARGS STELLA::NIL))
   (CL:LET* ((MDL-000 MODULE) (CXT-000 MDL-000)) (CL:WHEN (CL:EQ MDL-000 STELLA::NULL) (CL:SETQ MDL-000 STELLA::*MODULE*) (CL:SETQ CXT-000 STELLA::*CONTEXT*))
    (CL:LET* ((STELLA::*MODULE* MDL-000) (STELLA::*CONTEXT* CXT-000)) (CL:DECLARE (CL:SPECIAL STELLA::*MODULE* STELLA::*CONTEXT*)) (CL:SETQ ENVIRONMENT ENVIRONMENT)
     (STELLA::WITH-PROCESS-LOCK STELLA::*POWERLOOM-LOCK*
      (CL:LET* ((I STELLA::NULL-INTEGER) (ITER-000 0) (UPPER-BOUND-000 (CL:1- ARITY)) (COLLECT-000 STELLA::NULL))
       (CL:DECLARE (CL:TYPE CL:FIXNUM I ITER-000 UPPER-BOUND-000))
       (CL:LOOP WHILE (CL:<= ITER-000 UPPER-BOUND-000) DO (CL:SETQ I ITER-000)
        (CL:IF (CL:EQ COLLECT-000 STELLA::NULL)
         (CL:PROGN (CL:SETQ COLLECT-000 (STELLA::CONS (STELLA::YIELD-SYSTEM-DEFINED-PARAMETER-NAME I STELLA::*MODULE*) STELLA::NIL))
          (CL:IF (CL:EQ ARGS STELLA::NIL) (CL:SETQ ARGS COLLECT-000) (STELLA::ADD-CONS-TO-END-OF-CONS-LIST ARGS COLLECT-000)))
         (CL:PROGN (CL:SETF (STELLA::%%REST COLLECT-000) (STELLA::CONS (STELLA::YIELD-SYSTEM-DEFINED-PARAMETER-NAME I STELLA::*MODULE*) STELLA::NIL))
          (CL:SETQ COLLECT-000 (STELLA::%%REST COLLECT-000))))
        (CL:SETQ ITER-000 (CL:1+ ITER-000))))
      (STELLA::CALL-DEFRELATION (STELLA::CONS (STELLA::INTERN-STELLA-NAME NAME) (STELLA::CONS ARGS STELLA::NIL))))))))
...
the name of the returned object may not match `name' exactly."
  ...
  (CL:WHEN (CL:<= ARITY 0)
   (CL:LET* ((STREAM-000 (STELLA::NEW-OUTPUT-STRING-STREAM)))
    (CL:LET* ((STELLA::*PRINTREADABLY?* CL:T)) (CL:DECLARE (CL:SPECIAL STELLA::*PRINTREADABLY?*))
     (STELLA::%%PRINT-STREAM (STELLA::%NATIVE-STREAM STREAM-000) "PARSING ERROR: Functions must have arity of at least 1." EOL)
     (STELLA::HELP-SIGNAL-PROPOSITION-ERROR STREAM-000 KWD-PLI-ERROR))
    (CL:ERROR (STELLA::NEW-PARSING-ERROR (STELLA::THE-STRING-READER STREAM-000)))))
  (CL:LET* ((ARGS STELLA::NIL))
   (CL:LET* ((MDL-000 MODULE) (CXT-000 MDL-000)) (CL:WHEN (CL:EQ MDL-000 STELLA::NULL) (CL:SETQ MDL-000 STELLA::*MODULE*) (CL:SETQ CXT-000 STELLA::*CONTEXT*))
       ...
       (CL:LOOP WHILE (CL:<= ITER-000 UPPER-BOUND-000) DO (CL:SETQ I ITER-000)
        (CL:IF (CL:EQ COLLECT-000 STELLA::NULL)
         ...
         (CL:PROGN (CL:SETF (STELLA::%%REST COLLECT-000) (STELLA::CONS (STELLA::YIELD-SYSTEM-DEFINED-PARAMETER-NAME I STELLA::*MODULE*) STELLA::NIL))
          (CL:SETQ COLLECT-000 (STELLA::%%REST COLLECT-000))))
        (CL:SETQ ITER-000 (CL:1+ ITER-000))))
      (STELLA::CALL-DEFFUNCTION (STELLA::CONS (STELLA::INTERN-STELLA-NAME NAME) (STELLA::CONS ARGS STELLA::NIL))))))))
...
programming language.  The following type mappings are used:
  ...
  (CL:LET* ((MDL-000 MODULE) (CXT-000 MDL-000)) (CL:WHEN (CL:EQ MDL-000 STELLA::NULL) (CL:SETQ MDL-000 STELLA::*MODULE*) (CL:SETQ CXT-000 STELLA::*CONTEXT*))
   (CL:LET* ((STELLA::*MODULE* MDL-000) (STELLA::*CONTEXT* CXT-000)) (CL:DECLARE (CL:SPECIAL STELLA::*MODULE* STELLA::*CONTEXT*)) (CL:SETQ ENVIRONMENT ENVIRONMENT)
    (STELLA::WITH-PROCESS-LOCK STELLA::*POWERLOOM-LOCK* (STELLA::REGISTER-SPECIALIST-FUNCTION NAME FUNCTION-REFERENCE)))))
...
The function found must conform to the signature for specialist functions."
  ...
  (CL:LET* ((MDL-000 (SAFELY-GET-MODULE MODULE-NAME ENVIRONMENT)) (CXT-000 MDL-000))
   ...
   (CL:LET* ((STELLA::*MODULE* MDL-000) (STELLA::*CONTEXT* CXT-000)) (CL:DECLARE (CL:SPECIAL STELLA::*MODULE* STELLA::*CONTEXT*)) (CL:SETQ ENVIRONMENT ENVIRONMENT)
    (STELLA::WITH-PROCESS-LOCK STELLA::*POWERLOOM-LOCK* (STELLA::%REGISTER-SPECIALIST-FUNCTION-NAME NAME NATIVE-NAME)))))
...
programming language.  The following type mappings are used:
  ...
  (CL:LET* ((MDL-000 MODULE) (CXT-000 MDL-000)) (CL:WHEN (CL:EQ MDL-000 STELLA::NULL) (CL:SETQ MDL-000 STELLA::*MODULE*) (CL:SETQ CXT-000 STELLA::*CONTEXT*))
   (CL:LET* ((STELLA::*MODULE* MDL-000) (STELLA::*CONTEXT* CXT-000)) (CL:DECLARE (CL:SPECIAL STELLA::*MODULE* STELLA::*CONTEXT*)) (CL:SETQ ENVIRONMENT ENVIRONMENT)
    (STELLA::WITH-PROCESS-LOCK STELLA::*POWERLOOM-LOCK* (STELLA::REGISTER-COMPUTATION-FUNCTION NAME FUNCTION-REFERENCE ARITY)))))
...
Arity specifies the number of arguments the computation accepts."
  ...
  (CL:LET* ((MDL-000 (SAFELY-GET-MODULE MODULE-NAME ENVIRONMENT)) (CXT-000 MDL-000))
   (CL:WHEN (CL:EQ MDL-000 STELLA::NULL) (CL:SETQ MDL-000 STELLA::*MODULE*) (CL:SETQ CXT-000 STELLA::*CONTEXT*))
   (CL:LET* ((STELLA::*MODULE* MDL-000) (STELLA::*CONTEXT* CXT-000)) (CL:DECLARE (CL:SPECIAL STELLA::*MODULE* STELLA::*CONTEXT*)) (CL:SETQ ENVIRONMENT ENVIRONMENT)
    (STELLA::WITH-PROCESS-LOCK STELLA::*POWERLOOM-LOCK* (STELLA::%REGISTER-COMPUTATION-FUNCTION-NAME NAME NATIVE-NAME ARITY)))))
...
to parameterized queries."
  (CL:LET* ((MDL-000 MODULE) (CXT-000 MDL-000)) (CL:WHEN (CL:EQ MDL-000 STELLA::NULL) (CL:SETQ MDL-000 STELLA::*MODULE*) (CL:SETQ CXT-000 STELLA::*CONTEXT*))
   (CL:LET* ((STELLA::*MODULE* MDL-000) (STELLA::*CONTEXT* CXT-000)) (CL:DECLARE (CL:SPECIAL STELLA::*MODULE* STELLA::*CONTEXT*)) (CL:SETQ ENVIRONMENT ENVIRONMENT)
    (STELLA::WITH-PROCESS-LOCK STELLA::*POWERLOOM-LOCK*
     (CL:LET* ((SELF-000 (STELLA::NEW-LIST))) (CL:SETF (STELLA::%THE-CONS-LIST SELF-000) MEMBERS)
      (CL:LET* ((VALUE-000 (STELLA::CREATE-LOGICAL-LIST SELF-000))) VALUE-000))))))
...
in `module' using `environment'."
  (CL:LET* ((MDL-000 MODULE) (CXT-000 MDL-000)) (CL:WHEN (CL:EQ MDL-000 STELLA::NULL) (CL:SETQ MDL-000 STELLA::*MODULE*) (CL:SETQ CXT-000 STELLA::*CONTEXT*))
   (CL:LET* ((STELLA::*MODULE* MDL-000) (STELLA::*CONTEXT* CXT-000)) (CL:DECLARE (CL:SPECIAL STELLA::*MODULE* STELLA::*CONTEXT*)) (CL:SETQ ENVIRONMENT ENVIRONMENT)
    (STELLA::WITH-PROCESS-LOCK STELLA::*POWERLOOM-LOCK*
     (CL:LET* ((SELF-000 (STELLA::NEW-LIST))) (CL:SETF (STELLA::%THE-CONS-LIST SELF-000) MEMBERS)
      (CL:LET* ((VALUE-000 (STELLA::CREATE-ENUMERATED-SET SELF-000))) VALUE-000))))))

;;; (DEFUN DESTROY-OBJECT ...)

(CL:DEFUN DESTROY-OBJECT (OBJECT)
  "Delete the object `object', retracting all facts attached to it."
  (STELLA::WITH-PROCESS-LOCK STELLA::*POWERLOOM-LOCK* (STELLA::DESTROY-OBJECT OBJECT)))
...
(CL:DEFUN ASSERT-UNARY-PROPOSITION (RELATION ARG MODULE ENVIRONMENT)
  ...
  (CL:LET* ((MDL-000 MODULE) (CXT-000 MDL-000)) (CL:WHEN (CL:EQ MDL-000 STELLA::NULL) (CL:SETQ MDL-000 STELLA::*MODULE*) (CL:SETQ CXT-000 STELLA::*CONTEXT*))
   (CL:LET* ((STELLA::*MODULE* MDL-000) (STELLA::*CONTEXT* CXT-000)) (CL:DECLARE (CL:SPECIAL STELLA::*MODULE* STELLA::*CONTEXT*)) (CL:SETQ ENVIRONMENT ENVIRONMENT)
    (STELLA::WITH-PROCESS-LOCK STELLA::*POWERLOOM-LOCK*
     (CL:IF (STELLA::CLASS? RELATION) (STELLA::ASSERT-ISA-PROPOSITION ARG (STELLA::%SURROGATE-VALUE-INVERSE RELATION))
      (STELLA::ASSERT-PROPERTY ARG (STELLA::%SURROGATE-VALUE-INVERSE RELATION)))))))
...
in `module'.  Return the asserted proposition."
  (CL:LET* ((MDL-000 MODULE) (CXT-000 MDL-000)) (CL:WHEN (CL:EQ MDL-000 STELLA::NULL) (CL:SETQ MDL-000 STELLA::*MODULE*) (CL:SETQ CXT-000 STELLA::*CONTEXT*))
   (CL:LET* ((STELLA::*MODULE* MDL-000) (STELLA::*CONTEXT* CXT-000)) (CL:DECLARE (CL:SPECIAL STELLA::*MODULE* STELLA::*CONTEXT*)) (CL:SETQ ENVIRONMENT ENVIRONMENT)
    (STELLA::WITH-PROCESS-LOCK STELLA::*POWERLOOM-LOCK* (STELLA::ASSERT-BINARY-VALUE (STELLA::%SURROGATE-VALUE-INVERSE RELATION) ARG VALUE)))))
...
the relation `relation'."
  (CL:LET*
   ((LIST (SEQUENCE-TO-CONS-LIST RELATION-AND-ARGUMENTS)) (RELATION (STELLA::%%VALUE LIST)) (RELATIONSURROGATE (STELLA::%SURROGATE-VALUE-INVERSE RELATION))
    (ARGUMENTS (STELLA::%%REST LIST)))
   (CL:LET* ((MDL-000 MODULE) (CXT-000 MDL-000)) (CL:WHEN (CL:EQ MDL-000 STELLA::NULL) (CL:SETQ MDL-000 STELLA::*MODULE*) (CL:SETQ CXT-000 STELLA::*CONTEXT*))
    (CL:LET* ((STELLA::*MODULE* MDL-000) (STELLA::*CONTEXT* CXT-000)) (CL:DECLARE (CL:SPECIAL STELLA::*MODULE* STELLA::*CONTEXT*)) (CL:SETQ ENVIRONMENT ENVIRONMENT)
     (STELLA::WITH-PROCESS-LOCK STELLA::*POWERLOOM-LOCK* (STELLA::ASSERT-TUPLE RELATIONSURROGATE ARGUMENTS))))))
...
(CL:DEFUN RETRACT-UNARY-PROPOSITION (RELATION ARG MODULE ENVIRONMENT)
  ...
  (CL:LET* ((MDL-000 MODULE) (CXT-000 MDL-000)) (CL:WHEN (CL:EQ MDL-000 STELLA::NULL) (CL:SETQ MDL-000 STELLA::*MODULE*) (CL:SETQ CXT-000 STELLA::*CONTEXT*))
   (CL:LET* ((STELLA::*MODULE* MDL-000) (STELLA::*CONTEXT* CXT-000)) (CL:DECLARE (CL:SPECIAL STELLA::*MODULE* STELLA::*CONTEXT*)) (CL:SETQ ENVIRONMENT ENVIRONMENT)
    (STELLA::WITH-PROCESS-LOCK STELLA::*POWERLOOM-LOCK*
     (CL:IF (STELLA::CLASS? RELATION) (STELLA::RETRACT-ISA-PROPOSITION ARG (STELLA::%SURROGATE-VALUE-INVERSE RELATION))
      (STELLA::RETRACT-PROPERTY ARG (STELLA::%SURROGATE-VALUE-INVERSE RELATION)))))))
...
in `module'.  Return the asserted proposition."
  (CL:LET* ((MDL-000 MODULE) (CXT-000 MDL-000)) (CL:WHEN (CL:EQ MDL-000 STELLA::NULL) (CL:SETQ MDL-000 STELLA::*MODULE*) (CL:SETQ CXT-000 STELLA::*CONTEXT*))
   (CL:LET* ((STELLA::*MODULE* MDL-000) (STELLA::*CONTEXT* CXT-000)) (CL:DECLARE (CL:SPECIAL STELLA::*MODULE* STELLA::*CONTEXT*)) (CL:SETQ ENVIRONMENT ENVIRONMENT)
    (STELLA::WITH-PROCESS-LOCK STELLA::*POWERLOOM-LOCK* (STELLA::RETRACT-BINARY-VALUE (STELLA::%SURROGATE-VALUE-INVERSE RELATION) ARG VALUE)))))
...
the relation `relation'."
  (CL:LET*
   ...
   (CL:LET* ((MDL-000 MODULE) (CXT-000 MDL-000)) (CL:WHEN (CL:EQ MDL-000 STELLA::NULL) (CL:SETQ MDL-000 STELLA::*MODULE*) (CL:SETQ CXT-000 STELLA::*CONTEXT*))
    (CL:LET* ((STELLA::*MODULE* MDL-000) (STELLA::*CONTEXT* CXT-000)) (CL:DECLARE (CL:SPECIAL STELLA::*MODULE* STELLA::*CONTEXT*)) (CL:SETQ ENVIRONMENT ENVIRONMENT)
     (STELLA::WITH-PROCESS-LOCK STELLA::*POWERLOOM-LOCK* (STELLA::UPDATE-TUPLE RELATIONSURROGATE ARGUMENTS KWD-PLI-RETRACT-TRUE))))))
...
Return the asserted proposition."
  (CL:LET* ((MDL-000 MODULE) (CXT-000 MDL-000)) (CL:WHEN (CL:EQ MDL-000 STELLA::NULL) (CL:SETQ MDL-000 STELLA::*MODULE*) (CL:SETQ CXT-000 STELLA::*CONTEXT*))
   (CL:LET* ((STELLA::*MODULE* MDL-000) (STELLA::*CONTEXT* CXT-000)) (CL:DECLARE (CL:SPECIAL STELLA::*MODULE* STELLA::*CONTEXT*)) (CL:SETQ ENVIRONMENT ENVIRONMENT)
    (STELLA::WITH-PROCESS-LOCK STELLA::*POWERLOOM-LOCK* (STELLA::HELP-UPDATE-TOP-LEVEL-PROPOSITION PROPOSITION KWD-PLI-ASSERT-TRUE) PROPOSITION))))
...
Return an iterator of the propositions resulting from sentence."
  ...
  (CL:LET* ((MODULE (SAFELY-GET-MODULE MODULE-NAME ENVIRONMENT)) (PROPOSITIONS STELLA::NULL) (RETURN-VALUE STELLA::NULL))
   (CL:LET* ((MDL-000 MODULE) (CXT-000 MDL-000)) (CL:WHEN (CL:EQ MDL-000 STELLA::NULL) (CL:SETQ MDL-000 STELLA::*MODULE*) (CL:SETQ CXT-000 STELLA::*CONTEXT*))
    (CL:LET* ((STELLA::*MODULE* MDL-000) (STELLA::*CONTEXT* CXT-000)) (CL:DECLARE (CL:SPECIAL STELLA::*MODULE* STELLA::*CONTEXT*)) (CL:SETQ ENVIRONMENT ENVIRONMENT)
     (STELLA::WITH-PROCESS-LOCK STELLA::*POWERLOOM-LOCK* (CL:SETQ PROPOSITIONS (S-CONCEIVE SENTENCE MODULE-NAME ENVIRONMENT))
      (CL:SETQ RETURN-VALUE (CONS-TO-PL-ITERATOR (STELLA::%CURSOR PROPOSITIONS)))
      (CL:LET* ((PROPOSITION STELLA::NULL) (ITER-000 PROPOSITIONS))
       (CL:LOOP WHILE (STELLA::NEXT? ITER-000) DO (CL:SETQ PROPOSITION (STELLA::%VALUE ITER-000))
        (STELLA::HELP-UPDATE-TOP-LEVEL-PROPOSITION PROPOSITION KWD-PLI-ASSERT-TRUE)))
      RETURN-VALUE)))))
...
Return the retracted proposition."
  (CL:LET* ((MDL-000 MODULE) (CXT-000 MDL-000)) (CL:WHEN (CL:EQ MDL-000 STELLA::NULL) (CL:SETQ MDL-000 STELLA::*MODULE*) (CL:SETQ CXT-000 STELLA::*CONTEXT*))
   (CL:LET* ((STELLA::*MODULE* MDL-000) (STELLA::*CONTEXT* CXT-000)) (CL:DECLARE (CL:SPECIAL STELLA::*MODULE* STELLA::*CONTEXT*)) (CL:SETQ ENVIRONMENT ENVIRONMENT)
    (STELLA::WITH-PROCESS-LOCK STELLA::*POWERLOOM-LOCK* (STELLA::HELP-UPDATE-TOP-LEVEL-PROPOSITION PROPOSITION KWD-PLI-RETRACT-TRUE) PROPOSITION))))
   ...
   (CL:LET* ((MDL-000 MODULE) (CXT-000 MDL-000)) (CL:WHEN (CL:EQ MDL-000 STELLA::NULL) (CL:SETQ MDL-000 STELLA::*MODULE*) (CL:SETQ CXT-000 STELLA::*CONTEXT*))
    (CL:LET* ((STELLA::*MODULE* MDL-000) (STELLA::*CONTEXT* CXT-000)) (CL:DECLARE (CL:SPECIAL STELLA::*MODULE* STELLA::*CONTEXT*)) (CL:SETQ ENVIRONMENT ENVIRONMENT)
     (STELLA::WITH-PROCESS-LOCK STELLA::*POWERLOOM-LOCK* (CL:SETQ PROPOSITIONS (S-CONCEIVE SENTENCE MODULE-NAME ENVIRONMENT))
      ...
      (CL:LET* ((PROPOSITION STELLA::NULL) (ITER-000 PROPOSITIONS))
       (CL:LOOP WHILE (STELLA::NEXT? ITER-000) DO (CL:SETQ PROPOSITION (STELLA::%VALUE ITER-000))
        (STELLA::HELP-UPDATE-TOP-LEVEL-PROPOSITION PROPOSITION KWD-PLI-RETRACT-TRUE)))
      RETURN-VALUE)))))
     ...
     (STELLA::WITH-PROCESS-LOCK STELLA::*POWERLOOM-LOCK*
      (CL:LET* ((PROPOSITIONS (STELLA::CONCEIVE-FORMULA SENTENCE)))
       (CL:WHEN (CL:EQ PROPOSITIONS STELLA::NULL)
        (CL:LET* ((STREAM-000 (STELLA::NEW-OUTPUT-STRING-STREAM)))
         (CL:LET* ((STELLA::*PRINTREADABLY?* CL:T)) (CL:DECLARE (CL:SPECIAL STELLA::*PRINTREADABLY?*))
          (STELLA::%%PRINT-STREAM (STELLA::%NATIVE-STREAM STREAM-000) "ERROR: Failed to conceive `" SENTENCE "'." EOL)
          (STELLA::HELP-SIGNAL-PROPOSITION-ERROR STREAM-000 KWD-PLI-ERROR))
         (CL:ERROR (STELLA::NEW-PROPOSITION-ERROR (STELLA::THE-STRING-READER STREAM-000)))))
       (CL:LET* ((TEST-VALUE-000 (STELLA::SAFE-PRIMARY-TYPE PROPOSITIONS)))
        (CL:COND ((STELLA::SUBTYPE-OF? TEST-VALUE-000 SGT-PLI-LOGIC-PROPOSITION) (CL:PROGN (CONS-TO-PL-ITERATOR (STELLA::CONS PROPOSITIONS STELLA::NIL))))
         ((CL:EQ TEST-VALUE-000 SGT-PLI-STELLA-CONS) (CL:PROGN (CONS-TO-PL-ITERATOR PROPOSITIONS)))
         (CL:T
          (CL:LET* ((STREAM-001 (STELLA::NEW-OUTPUT-STRING-STREAM)))
           (CL:LET* ((STELLA::*PRINTREADABLY?* CL:T)) (CL:DECLARE (CL:SPECIAL STELLA::*PRINTREADABLY?*))
            (STELLA::%%PRINT-STREAM (STELLA::%NATIVE-STREAM STREAM-001) "ERROR: Formula is not a sentence: `" SENTENCE "'." EOL)
            (STELLA::HELP-SIGNAL-PROPOSITION-ERROR STREAM-001 KWD-PLI-ERROR))
           (CL:ERROR (STELLA::NEW-PROPOSITION-ERROR (STELLA::THE-STRING-READER STREAM-001)))))))))))))
...
Signals a `Proposition-Error' if PowerLoom could not conceive `sentence'."
  ...
  (CL:LET* ((MODULE (SAFELY-GET-MODULE MODULE-NAME ENVIRONMENT)))
   (CL:LET* ((MDL-000 MODULE) (CXT-000 MDL-000)) (CL:WHEN (CL:EQ MDL-000 STELLA::NULL) (CL:SETQ MDL-000 STELLA::*MODULE*) (CL:SETQ CXT-000 STELLA::*CONTEXT*))
    (CL:LET* ((STELLA::*MODULE* MDL-000) (STELLA::*CONTEXT* CXT-000)) (CL:DECLARE (CL:SPECIAL STELLA::*MODULE* STELLA::*CONTEXT*)) (CL:SETQ ENVIRONMENT ENVIRONMENT)
     (STELLA::WITH-PROCESS-LOCK STELLA::*POWERLOOM-LOCK* (CONCEIVE (STELLA::READ-S-EXPRESSION-FROM-STRING SENTENCE) MODULE ENVIRONMENT))))))
...
in either antecedent or consequent position."
  (CL:IF (CL:EQ RELATION STELLA::NULL) EMPTY-PL-ITERATOR
   (CL:LET* ((MDL-000 MODULE) (CXT-000 MDL-000)) (CL:WHEN (CL:EQ MDL-000 STELLA::NULL) (CL:SETQ MDL-000 STELLA::*MODULE*) (CL:SETQ CXT-000 STELLA::*CONTEXT*))
    (CL:LET* ((STELLA::*MODULE* MDL-000) (STELLA::*CONTEXT* CXT-000)) (CL:DECLARE (CL:SPECIAL STELLA::*MODULE* STELLA::*CONTEXT*)) (CL:SETQ ENVIRONMENT ENVIRONMENT)
     (STELLA::WITH-PROCESS-LOCK STELLA::*POWERLOOM-LOCK* (CONS-TO-PL-ITERATOR (STELLA::CALL-GET-RULES RELATION)))))))
...
then a Stella `no-such-context-exception' is thrown."
  ...
  (CL:LET* ((RULE STELLA::NULL) (ITER-000 (S-GET-RULES NAME MODULE-NAME ENVIRONMENT)))
   (CL:LOOP WHILE (STELLA::NEXT? ITER-000) DO (CL:SETQ RULE (STELLA::%VALUE ITER-000)) (STELLA::PRINT-LOGICAL-FORM RULE STREAM)
...
called again."
  (CL:WHEN (CL:EQ MODULE STELLA::NULL) (CL:SETQ MODULE STELLA::*MODULE*))
  (CL:WHEN (CL:NOT (CL:EQ MODULE STELLA::NULL)) (STELLA::CALL-RUN-FORWARD-RULES MODULE FORCE?)))
...
(CL:DEFUN GET-ARITY (RELATION)
  ...
  (CL:COND ((STELLA::SUBTYPE-OF? (STELLA::SAFE-PRIMARY-TYPE RELATION) SGT-PLI-LOGIC-NAMED-DESCRIPTION) (CL:PROGN (STELLA::ARITY RELATION))) (CL:T 0)))

;;; (DEFUN (S-GET-ARITY INTEGER) ...)

(CL:DECLAIM (CL:FTYPE (CL:FUNCTION (CL:SIMPLE-STRING CL:SIMPLE-STRING CL:T) CL:FIXNUM) S-GET-ARITY))
...
relation `relation'."
  (CL:COND ((STELLA::SUBTYPE-OF? (STELLA::SAFE-PRIMARY-TYPE RELATION) SGT-PLI-LOGIC-NAMED-DESCRIPTION) (CL:PROGN (GET-NTH-DOMAIN RELATION 0))) (CL:T STELLA::NULL)))
...
`relation'."
  (CL:COND ((STELLA::SUBTYPE-OF? (STELLA::SAFE-PRIMARY-TYPE RELATION) SGT-PLI-LOGIC-NAMED-DESCRIPTION) (CL:PROGN (GET-NTH-DOMAIN RELATION 1))) (CL:T STELLA::NULL)))
...
it does not look for the most specific one (which might have to be created)."
  ...
  (CL:COND
   ((STELLA::SUBTYPE-OF? (STELLA::SAFE-PRIMARY-TYPE RELATION) SGT-PLI-LOGIC-NAMED-DESCRIPTION)
    (CL:PROGN
     (CL:WHEN (CL:AND (CL:>= N 0) (CL:< N (STELLA::LENGTH (STELLA::%IO-VARIABLE-TYPES RELATION))))
      (CL:LET*
       ((DOMAINPROP
         (STELLA::%%VALUE
          (HELP-GET-PROPOSITIONS (STELLA::%SURROGATE-VALUE SGT-PLI-PL-KERNEL-KB-NTH-DOMAIN)
           (STELLA::CONS RELATION (STELLA::CONS (STELLA::WRAP-INTEGER N) (STELLA::CONS STELLA::NULL STELLA::NIL))) 1 STELLA::NULL STELLA::NULL))))
       (CL:WHEN (CL:NOT (CL:EQ DOMAINPROP STELLA::NULL))
        (CL:RETURN-FROM GET-NTH-DOMAIN
         (CL:AREF (CL:THE CL:SIMPLE-VECTOR (STELLA::%THE-ARRAY (STELLA::%ARGUMENTS DOMAINPROP)))
          (CL:THE CL:FIXNUM (CL:1- (STELLA::LENGTH (STELLA::%ARGUMENTS DOMAINPROP)))))))))))
   (CL:T))
  STELLA::NULL)
...
are evaluated one-by-one, applying the function `evaluate' to each of them."
  ...
  (CL:LET* ((MDL-000 STELLA::*MODULE*) (CXT-000 MDL-000)) (CL:WHEN (CL:EQ MDL-000 STELLA::NULL) (CL:SETQ MDL-000 STELLA::*MODULE*) (CL:SETQ CXT-000 STELLA::*CONTEXT*))
   (CL:LET* ((STELLA::*MODULE* MDL-000) (STELLA::*CONTEXT* CXT-000)) (CL:DECLARE (CL:SPECIAL STELLA::*MODULE* STELLA::*CONTEXT*)) (CL:SETQ ENVIRONMENT ENVIRONMENT)
    (STELLA::WITH-PROCESS-LOCK STELLA::*POWERLOOM-LOCK* (STELLA::%LOAD FILENAME STELLA::NIL)))))
...
`evaluate' to each of them."
  ...
  (CL:LET* ((MDL-000 MODULE) (CXT-000 MDL-000)) (CL:WHEN (CL:EQ MDL-000 STELLA::NULL) (CL:SETQ MDL-000 STELLA::*MODULE*) (CL:SETQ CXT-000 STELLA::*CONTEXT*))
   (CL:LET* ((STELLA::*MODULE* MDL-000) (STELLA::*CONTEXT* CXT-000)) (CL:DECLARE (CL:SPECIAL STELLA::*MODULE* STELLA::*CONTEXT*)) (CL:SETQ ENVIRONMENT ENVIRONMENT)
    (STELLA::WITH-PROCESS-LOCK STELLA::*POWERLOOM-LOCK* (STELLA::%LOAD FILENAME (STELLA::CONS-LIST KWD-PLI-MODULE MODULE))))))
...
`evaluate' to each of them."
  (CL:LET* ((MDL-000 STELLA::*MODULE*) (CXT-000 MDL-000)) (CL:WHEN (CL:EQ MDL-000 STELLA::NULL) (CL:SETQ MDL-000 STELLA::*MODULE*) (CL:SETQ CXT-000 STELLA::*CONTEXT*))
   (CL:LET* ((STELLA::*MODULE* MDL-000) (STELLA::*CONTEXT* CXT-000)) (CL:DECLARE (CL:SPECIAL STELLA::*MODULE* STELLA::*CONTEXT*)) (CL:SETQ ENVIRONMENT ENVIRONMENT)
    (STELLA::WITH-PROCESS-LOCK STELLA::*POWERLOOM-LOCK* (STELLA::LOAD-STREAM STREAM)))))
...
`evaluate' to each of them."
  (CL:LET* ((MDL-000 MODULE) (CXT-000 MDL-000)) (CL:WHEN (CL:EQ MDL-000 STELLA::NULL) (CL:SETQ MDL-000 STELLA::*MODULE*) (CL:SETQ CXT-000 STELLA::*CONTEXT*))
   (CL:LET* ((STELLA::*MODULE* MDL-000) (STELLA::*CONTEXT* CXT-000)) (CL:DECLARE (CL:SPECIAL STELLA::*MODULE* STELLA::*CONTEXT*)) (CL:SETQ ENVIRONMENT ENVIRONMENT)
    (STELLA::WITH-PROCESS-LOCK STELLA::*POWERLOOM-LOCK* (STELLA::LOAD-STREAM-IN-MODULE STREAM MODULE)))))
...
`evaluate' to each of them."
  (CL:LET* ((MDL-000 STELLA::*MODULE*) (CXT-000 MDL-000)) (CL:WHEN (CL:EQ MDL-000 STELLA::NULL) (CL:SETQ MDL-000 STELLA::*MODULE*) (CL:SETQ CXT-000 STELLA::*CONTEXT*))
   (CL:LET* ((STELLA::*MODULE* MDL-000) (STELLA::*CONTEXT* CXT-000)) (CL:DECLARE (CL:SPECIAL STELLA::*MODULE* STELLA::*CONTEXT*)) (CL:SETQ ENVIRONMENT ENVIRONMENT)
    (STELLA::WITH-PROCESS-LOCK STELLA::*POWERLOOM-LOCK*
     (CL:LET* ((SELF-000 (STELLA::NEW-INPUT-STREAM))) (CL:SETF (STELLA::%NATIVE-STREAM SELF-000) STREAM) (STELLA::LOAD-STREAM SELF-000))))))
...
`evaluate' to each of them."
  (CL:LET* ((MDL-000 MODULE) (CXT-000 MDL-000)) (CL:WHEN (CL:EQ MDL-000 STELLA::NULL) (CL:SETQ MDL-000 STELLA::*MODULE*) (CL:SETQ CXT-000 STELLA::*CONTEXT*))
   (CL:LET* ((STELLA::*MODULE* MDL-000) (STELLA::*CONTEXT* CXT-000)) (CL:DECLARE (CL:SPECIAL STELLA::*MODULE* STELLA::*CONTEXT*)) (CL:SETQ ENVIRONMENT ENVIRONMENT)
    (STELLA::WITH-PROCESS-LOCK STELLA::*POWERLOOM-LOCK*
     (CL:LET* ((SELF-000 (STELLA::NEW-INPUT-STREAM))) (CL:SETF (STELLA::%NATIVE-STREAM SELF-000) STREAM) (STELLA::LOAD-STREAM-IN-MODULE SELF-000 MODULE))))))
  ...
  (CL:LET* ((EXISTS? (STELLA::PROBE-FILE? FILENAME)))
   (CL:COND ((CL:OR (CL:NOT EXISTS?) (STELLA::STRING-EQUAL? IFEXISTS "REPLACE")))
    ((STELLA::STRING-EQUAL? IFEXISTS "ASK")
     (CL:WHEN (CL:NOT (STELLA::YES-OR-NO? (STELLA::CONCATENATE "File `" FILENAME "' already exists.  Overwrite it? (yes or no) ")))
      (STELLA::ENSURE-FILE-DOES-NOT-EXIST FILENAME "save-module")))
    ((STELLA::STRING-EQUAL? IFEXISTS "WARN") (CL:WARN "File `~A' already exists, overwriting." FILENAME))
    ((STELLA::STRING-EQUAL? IFEXISTS "ERROR") (STELLA::ENSURE-FILE-DOES-NOT-EXIST FILENAME "save-module"))
    (CL:T
     (CL:LET* ((STREAM-000 (STELLA::NEW-OUTPUT-STRING-STREAM)))
      (STELLA::%%PRINT-STREAM (STELLA::%NATIVE-STREAM STREAM-000) "Unrecognized ifexists option `" IFEXISTS "'")
      (CL:ERROR (STELLA::NEW-BAD-ARGUMENT-EXCEPTION (STELLA::THE-STRING-READER STREAM-000))))))
   (CL:LET* ((MDL-000 MODULE) (CXT-000 MDL-000)) (CL:WHEN (CL:EQ MDL-000 STELLA::NULL) (CL:SETQ MDL-000 STELLA::*MODULE*) (CL:SETQ CXT-000 STELLA::*CONTEXT*))
    (CL:LET* ((STELLA::*MODULE* MDL-000) (STELLA::*CONTEXT* CXT-000)) (CL:DECLARE (CL:SPECIAL STELLA::*MODULE* STELLA::*CONTEXT*)) (CL:SETQ ENVIRONMENT ENVIRONMENT)
     (STELLA::WITH-PROCESS-LOCK STELLA::*POWERLOOM-LOCK*
      (CL:LET* ((STREAM STELLA::NULL))
       (CL:UNWIND-PROTECT (CL:PROGN (CL:SETQ STREAM (STELLA::OPEN-OUTPUT-FILE FILENAME)) (STELLA::DO-SAVE-MODULE STELLA::*MODULE* STREAM))
        (CL:WHEN (CL:NOT (CL:EQ STREAM STELLA::NULL)) (STELLA::FREE STREAM)))))))))
...
the proposition `prop'."
  (CL:LET* ((RELATION (STELLA::GET-DESCRIPTION (STELLA::%OPERATOR PROP))))
   (CL:WHEN (CL:EQ RELATION STELLA::NULL) (CL:SETQ RELATION (STELLA::%SURROGATE-VALUE (STELLA::%OPERATOR PROP)))) RELATION))
...
For non sequence objects, the column count is one."
  ...
  (CL:LET* ((TEST-VALUE-000 (STELLA::SAFE-PRIMARY-TYPE OBJ)))
   (CL:COND ((STELLA::SUBTYPE-OF? TEST-VALUE-000 SGT-PLI-LOGIC-PROPOSITION) (CL:PROGN (CL:1+ (STELLA::LENGTH (STELLA::%ARGUMENTS OBJ)))))
    ((STELLA::SUBTYPE-OF? TEST-VALUE-000 SGT-PLI-PLI-PL-ITERATOR) (CL:PROGN (GET-COLUMN-COUNT (STELLA::%VALUE OBJ))))
    ((CL:EQ TEST-VALUE-000 SGT-PLI-STELLA-CONS) (CL:PROGN (STELLA::LENGTH OBJ)))
    ((STELLA::SUBTYPE-OF? TEST-VALUE-000 SGT-PLI-STELLA-VECTOR) (CL:PROGN (STELLA::LENGTH OBJ))) (CL:T 1))))
...
use of `get-nth-value' on PL-iterators with only a single return variable."
  ...
  (CL:WHEN (CL:OR (CL:>= N (GET-COLUMN-COUNT SEQUENCE)) (CL:< N 0))
   (CL:LET* ((STREAM-000 (STELLA::NEW-OUTPUT-STRING-STREAM)))
    (STELLA::%%PRINT-STREAM (STELLA::%NATIVE-STREAM STREAM-000) "Column index `" N "' is out of range for `" SEQUENCE "'")
    (CL:ERROR (STELLA::NEW-LOGIC-EXCEPTION (STELLA::THE-STRING-READER STREAM-000)))))
  (CL:LET* ((TEST-VALUE-000 (STELLA::SAFE-PRIMARY-TYPE SEQUENCE)))
   (CL:COND
    ((STELLA::SUBTYPE-OF? TEST-VALUE-000 SGT-PLI-LOGIC-PROPOSITION)
     (CL:PROGN
      (CL:IF (CL:= N 0) (GET-PREDICATE SEQUENCE)
       (CL:LET* ((VALUE (CL:AREF (CL:THE CL:SIMPLE-VECTOR (STELLA::%THE-ARRAY (STELLA::%ARGUMENTS SEQUENCE))) (CL:THE CL:FIXNUM (CL:1- N)))))
        (CL:COND
         ((STELLA::SUBTYPE-OF? (STELLA::SAFE-PRIMARY-TYPE VALUE) SGT-PLI-LOGIC-SKOLEM)
          (CL:PROGN
           (CL:LET* ((MDL-000 MODULE) (CXT-000 MDL-000)) (CL:WHEN (CL:EQ MDL-000 STELLA::NULL) (CL:SETQ MDL-000 STELLA::*MODULE*) (CL:SETQ CXT-000 STELLA::*CONTEXT*))
            (CL:LET* ((STELLA::*MODULE* MDL-000) (STELLA::*CONTEXT* CXT-000)) (CL:DECLARE (CL:SPECIAL STELLA::*MODULE* STELLA::*CONTEXT*))
             (CL:SETQ ENVIRONMENT ENVIRONMENT) (STELLA::WITH-PROCESS-LOCK STELLA::*POWERLOOM-LOCK* (STELLA::VALUE-OF VALUE))))))
         (CL:T VALUE))))))
    ((STELLA::SUBTYPE-OF? TEST-VALUE-000 SGT-PLI-PLI-PL-ITERATOR) (CL:PROGN (GET-NTH-VALUE (STELLA::%VALUE SEQUENCE) N MODULE ENVIRONMENT)))
    ((CL:EQ TEST-VALUE-000 SGT-PLI-STELLA-CONS) (CL:PROGN (STELLA::NTH SEQUENCE N)))
    ((STELLA::SUBTYPE-OF? TEST-VALUE-000 SGT-PLI-STELLA-VECTOR) (CL:PROGN (CL:AREF (CL:THE CL:SIMPLE-VECTOR (STELLA::%THE-ARRAY SEQUENCE)) N))) (CL:T SEQUENCE))))

;;; (DEFUN (GET-NTH-STRING STRING) ...)

(CL:DECLAIM (CL:FTYPE (CL:FUNCTION (CL:T CL:FIXNUM CL:T CL:T) CL:SIMPLE-STRING) GET-NTH-STRING))
...
(CL:DECLAIM (CL:FTYPE (CL:FUNCTION (CL:T CL:FIXNUM CL:T CL:T) CL:FIXNUM) GET-NTH-INTEGER))
...
(CL:DECLAIM (CL:FTYPE (CL:FUNCTION (CL:T CL:FIXNUM CL:T CL:T) CL:DOUBLE-FLOAT) GET-NTH-FLOAT))
...
If `sequence' is not a LOGIC-OBJECT, an exception is thrown."
  ...
  (CL:LET* ((VALUE (GET-NTH-VALUE SEQUENCE N MODULE ENVIRONMENT)))
   (CL:IF (STELLA::ISA? VALUE SGT-PLI-LOGIC-LOGIC-OBJECT) VALUE
    (CL:LET* ((STREAM-000 (STELLA::NEW-OUTPUT-STRING-STREAM))) (STELLA::%%PRINT-STREAM (STELLA::%NATIVE-STREAM STREAM-000) "Can't coerce `" VALUE "' to a LOGIC-OBJECT.")
     (CL:ERROR (STELLA::NEW-STELLA-EXCEPTION (STELLA::THE-STRING-READER STREAM-000)))))))
...
of collection, i.e., sets and lists"
  (CL:LET* ((MDL-000 MODULE) (CXT-000 MDL-000)) (CL:WHEN (CL:EQ MDL-000 STELLA::NULL) (CL:SETQ MDL-000 STELLA::*MODULE*) (CL:SETQ CXT-000 STELLA::*CONTEXT*))
   (CL:LET* ((STELLA::*MODULE* MDL-000) (STELLA::*CONTEXT* CXT-000)) (CL:DECLARE (CL:SPECIAL STELLA::*MODULE* STELLA::*CONTEXT*)) (CL:SETQ ENVIRONMENT ENVIRONMENT)
    (STELLA::WITH-PROCESS-LOCK STELLA::*POWERLOOM-LOCK*
     (CL:LET* ((MEMBERS (STELLA::ASSERTED-COLLECTION-MEMBERS COLLECTION CL:T)))
      (CL:IF (CL:NOT (CL:EQ MEMBERS STELLA::NULL)) (STELLA::%THE-CONS-LIST MEMBERS) STELLA::NULL))))))
...
Users of either of those languages are more likely to want to call `s-evaluate'."
  (CL:WHEN (CL:NOT (CL:EQ COMMAND STELLA::NULL))
   (CL:LET* ((MDL-000 MODULE) (CXT-000 MDL-000)) (CL:WHEN (CL:EQ MDL-000 STELLA::NULL) (CL:SETQ MDL-000 STELLA::*MODULE*) (CL:SETQ CXT-000 STELLA::*CONTEXT*))
    (CL:LET* ((STELLA::*MODULE* MDL-000) (STELLA::*CONTEXT* CXT-000)) (CL:DECLARE (CL:SPECIAL STELLA::*MODULE* STELLA::*CONTEXT*)) (CL:SETQ ENVIRONMENT ENVIRONMENT)
     (STELLA::WITH-PROCESS-LOCK STELLA::*POWERLOOM-LOCK* (CL:RETURN-FROM EVALUATE (STELLA::%EVALUATE COMMAND))))))
  STELLA::NULL)
...
then a Stella `no-such-context-exception' is thrown."
  ...
  (CL:LET* ((MODULE (SAFELY-GET-MODULE MODULE-NAME ENVIRONMENT)))
   (CL:LET* ((MDL-000 MODULE) (CXT-000 MDL-000)) (CL:WHEN (CL:EQ MDL-000 STELLA::NULL) (CL:SETQ MDL-000 STELLA::*MODULE*) (CL:SETQ CXT-000 STELLA::*CONTEXT*))
    (CL:LET* ((STELLA::*MODULE* MDL-000) (STELLA::*CONTEXT* CXT-000)) (CL:DECLARE (CL:SPECIAL STELLA::*MODULE* STELLA::*CONTEXT*)) (CL:SETQ ENVIRONMENT ENVIRONMENT)
     (STELLA::WITH-PROCESS-LOCK STELLA::*POWERLOOM-LOCK* (EVALUATE (STELLA::READ-S-EXPRESSION-FROM-STRING COMMAND) MODULE ENVIRONMENT))))))
...
either absolutely or by default."
  (CL:OR (CL:EQ TV STELLA::TRUE-TRUTH-VALUE) (CL:EQ TV STELLA::DEFAULT-TRUE-TRUTH-VALUE)))
...
either absolutely or by default."
  (CL:OR (CL:EQ TV STELLA::FALSE-TRUTH-VALUE) (CL:EQ TV STELLA::DEFAULT-FALSE-TRUTH-VALUE)))
...
(CL:DEFUN IS-STRICT (TV)
  ...
  (CL:OR (CL:EQ TV STELLA::TRUE-TRUTH-VALUE) (CL:EQ TV STELLA::FALSE-TRUTH-VALUE)))

;;; (DEFUN (IS-DEFAULT BOOLEAN) ...)

(CL:DEFUN IS-DEFAULT (TV)
  "Tests whether `tv' is a default truth value."
  (CL:OR (CL:EQ TV STELLA::DEFAULT-TRUE-TRUTH-VALUE) (CL:EQ TV STELLA::DEFAULT-FALSE-TRUTH-VALUE)))
...
`is-false' and `is-unknown' (which see)."
  (CL:LET* ((MDL-000 MODULE) (CXT-000 MDL-000)) (CL:WHEN (CL:EQ MDL-000 STELLA::NULL) (CL:SETQ MDL-000 STELLA::*MODULE*) (CL:SETQ CXT-000 STELLA::*CONTEXT*))
   (CL:LET* ((STELLA::*MODULE* MDL-000) (STELLA::*CONTEXT* CXT-000)) (CL:DECLARE (CL:SPECIAL STELLA::*MODULE* STELLA::*CONTEXT*)) (CL:SETQ ENVIRONMENT ENVIRONMENT)
    (STELLA::WITH-PROCESS-LOCK STELLA::*POWERLOOM-LOCK* (CL:SETQ QUERY (STELLA::DEOBJECTIFY-TREE QUERY))
     (CL:WHEN (STELLA::SYMBOL? (STELLA::%%VALUE QUERY)) (CL:SETQ QUERY (STELLA::CONS QUERY STELLA::NIL))) (STELLA::CALL-ASK QUERY)))))
...
`is-false' and `is-unknown' (which see)."
  ...
  (CL:LET* ((QUERYFORM STELLA::NIL) (MODULE (SAFELY-GET-MODULE MODULE-NAME ENVIRONMENT)))
   (CL:LET* ((MDL-000 MODULE) (CXT-000 MDL-000)) (CL:WHEN (CL:EQ MDL-000 STELLA::NULL) (CL:SETQ MDL-000 STELLA::*MODULE*) (CL:SETQ CXT-000 STELLA::*CONTEXT*))
    (CL:LET* ((STELLA::*MODULE* MDL-000) (STELLA::*CONTEXT* CXT-000)) (CL:DECLARE (CL:SPECIAL STELLA::*MODULE* STELLA::*CONTEXT*)) (CL:SETQ ENVIRONMENT ENVIRONMENT)
     (STELLA::WITH-PROCESS-LOCK STELLA::*POWERLOOM-LOCK*
      (CL:LET* ((SEXP STELLA::NULL) (ITER-000 (STELLA::S-EXPRESSIONS (STELLA::NEW-INPUT-STRING-STREAM QUERY))) (COLLECT-000 STELLA::NULL))
       (CL:LOOP WHILE (STELLA::NEXT? ITER-000) DO (CL:SETQ SEXP (STELLA::%VALUE ITER-000))
        (CL:IF (CL:EQ COLLECT-000 STELLA::NULL)
         (CL:PROGN (CL:SETQ COLLECT-000 (STELLA::CONS SEXP STELLA::NIL))
          (CL:IF (CL:EQ QUERYFORM STELLA::NIL) (CL:SETQ QUERYFORM COLLECT-000) (STELLA::ADD-CONS-TO-END-OF-CONS-LIST QUERYFORM COLLECT-000)))
         (CL:PROGN (CL:SETF (STELLA::%%REST COLLECT-000) (STELLA::CONS SEXP STELLA::NIL)) (CL:SETQ COLLECT-000 (STELLA::%%REST COLLECT-000)))))))))
   (ASK QUERYFORM (SAFELY-GET-MODULE MODULE-NAME ENVIRONMENT) ENVIRONMENT)))
...
by declaring the set of output variables."
  (CL:LET* ((MDL-000 MODULE) (CXT-000 MDL-000)) (CL:WHEN (CL:EQ MDL-000 STELLA::NULL) (CL:SETQ MDL-000 STELLA::*MODULE*) (CL:SETQ CXT-000 STELLA::*CONTEXT*))
   (CL:LET* ((STELLA::*MODULE* MDL-000) (STELLA::*CONTEXT* CXT-000)) (CL:DECLARE (CL:SPECIAL STELLA::*MODULE* STELLA::*CONTEXT*)) (CL:SETQ ENVIRONMENT ENVIRONMENT)
    (STELLA::WITH-PROCESS-LOCK STELLA::*POWERLOOM-LOCK* (CL:SETQ QUERY (STELLA::DEOBJECTIFY-TREE QUERY))
     (CONS-TO-PL-ITERATOR (STELLA::CONSIFY-CURRENT-SOLUTIONS (STELLA::CALL-RETRIEVE QUERY)))))))
...
(CL:DEFUN MAIN ()
  (STELLA::%%PRINT-STREAM (STELLA::%NATIVE-STREAM STELLA::STANDARD-OUTPUT) "Initializing STELLA..." EOL)
  (STELLA::STARTUP-STELLA-SYSTEM)
  (STELLA::%%PRINT-STREAM (STELLA::%NATIVE-STREAM STELLA::STANDARD-OUTPUT) "Initializing PowerLoom..." EOL)
  (STELLA::STARTUP-LOGIC-SYSTEM)
  (STELLA::CHANGE-MODULE "PL-USER")
  (STELLA::POWERLOOM))

(CL:DEFUN HELP-STARTUP-PLI1 ()
  (CL:PROGN (CL:SETQ SGT-PLI-PLI-ENVIRONMENT (STELLA::INTERN-RIGID-SYMBOL-WRT-MODULE "ENVIRONMENT" STELLA::NULL 1))
   (CL:SETQ SYM-PLI-LOGIC-LEVEL (STELLA::INTERN-RIGID-SYMBOL-WRT-MODULE "LEVEL" (STELLA::GET-STELLA-MODULE "/LOGIC" CL:T) 0))
   (CL:SETQ SGT-PLI-PLI-PL-ITERATOR (STELLA::INTERN-RIGID-SYMBOL-WRT-MODULE "PL-ITERATOR" STELLA::NULL 1))
   (CL:SETQ SYM-PLI-STELLA-CURSOR (STELLA::INTERN-RIGID-SYMBOL-WRT-MODULE "CURSOR" (STELLA::GET-STELLA-MODULE "/STELLA" CL:T) 0))
   (CL:SETQ SGT-PLI-STELLA-CONS (STELLA::INTERN-RIGID-SYMBOL-WRT-MODULE "CONS" (STELLA::GET-STELLA-MODULE "/STELLA" CL:T) 1))
   (CL:SETQ SGT-PLI-STELLA-LIST (STELLA::INTERN-RIGID-SYMBOL-WRT-MODULE "LIST" (STELLA::GET-STELLA-MODULE "/STELLA" CL:T) 1))
   (CL:SETQ SGT-PLI-STELLA-VECTOR (STELLA::INTERN-RIGID-SYMBOL-WRT-MODULE "VECTOR" (STELLA::GET-STELLA-MODULE "/STELLA" CL:T) 1))
   (CL:SETQ SYM-PLI-STELLA-NULL (STELLA::INTERN-RIGID-SYMBOL-WRT-MODULE "NULL" (STELLA::GET-STELLA-MODULE "/STELLA" CL:T) 0))
   (CL:SETQ SGT-PLI-LOGIC-SKOLEM (STELLA::INTERN-RIGID-SYMBOL-WRT-MODULE "SKOLEM" (STELLA::GET-STELLA-MODULE "/LOGIC" CL:T) 1))
   (CL:SETQ SGT-PLI-LOGIC-LOGIC-OBJECT (STELLA::INTERN-RIGID-SYMBOL-WRT-MODULE "LOGIC-OBJECT" (STELLA::GET-STELLA-MODULE "/LOGIC" CL:T) 1))
   (CL:SETQ SGT-PLI-STELLA-GENERALIZED-SYMBOL (STELLA::INTERN-RIGID-SYMBOL-WRT-MODULE "GENERALIZED-SYMBOL" (STELLA::GET-STELLA-MODULE "/STELLA" CL:T) 1))
   (CL:SETQ SGT-PLI-STELLA-MODULE (STELLA::INTERN-RIGID-SYMBOL-WRT-MODULE "MODULE" (STELLA::GET-STELLA-MODULE "/STELLA" CL:T) 1))
   (CL:SETQ SGT-PLI-STELLA-CONTEXT (STELLA::INTERN-RIGID-SYMBOL-WRT-MODULE "CONTEXT" (STELLA::GET-STELLA-MODULE "/STELLA" CL:T) 1))
   (CL:SETQ SGT-PLI-LOGIC-COMPUTED-PROCEDURE (STELLA::INTERN-RIGID-SYMBOL-WRT-MODULE "COMPUTED-PROCEDURE" (STELLA::GET-STELLA-MODULE "/LOGIC" CL:T) 1))
   (CL:SETQ SGT-PLI-STELLA-LITERAL-WRAPPER (STELLA::INTERN-RIGID-SYMBOL-WRT-MODULE "LITERAL-WRAPPER" (STELLA::GET-STELLA-MODULE "/STELLA" CL:T) 1))
   (CL:SETQ SGT-PLI-LOGIC-NAMED-DESCRIPTION (STELLA::INTERN-RIGID-SYMBOL-WRT-MODULE "NAMED-DESCRIPTION" (STELLA::GET-STELLA-MODULE "/LOGIC" CL:T) 1))
   (CL:SETQ SYM-PLI-PLI-?R (STELLA::INTERN-RIGID-SYMBOL-WRT-MODULE "?R" STELLA::NULL 0))
   (CL:SETQ SYM-PLI-PLI-?I (STELLA::INTERN-RIGID-SYMBOL-WRT-MODULE "?I" STELLA::NULL 0))
   (CL:SETQ SYM-PLI-PLI-?V (STELLA::INTERN-RIGID-SYMBOL-WRT-MODULE "?V" STELLA::NULL 0))
   (CL:SETQ SYM-PLI-PLI-F-GET-INFERRED-BINARY-PROPOSITION-VALUES-QUERY-000
    (STELLA::INTERN-RIGID-SYMBOL-WRT-MODULE "F-GET-INFERRED-BINARY-PROPOSITION-VALUES-QUERY-000" STELLA::NULL 0))
   (CL:SETQ SYM-PLI-LOGIC-ALL (STELLA::INTERN-RIGID-SYMBOL-WRT-MODULE "ALL" (STELLA::GET-STELLA-MODULE "/LOGIC" CL:T) 0))
   (CL:SETQ SYM-PLI-LOGIC-?X (STELLA::INTERN-RIGID-SYMBOL-WRT-MODULE "?X" (STELLA::GET-STELLA-MODULE "/LOGIC" CL:T) 0))
   (CL:SETQ SYM-PLI-STELLA-AND (STELLA::INTERN-RIGID-SYMBOL-WRT-MODULE "AND" (STELLA::GET-STELLA-MODULE "/STELLA" CL:T) 0))
   (CL:SETQ SYM-PLI-LOGIC-FAIL (STELLA::INTERN-RIGID-SYMBOL-WRT-MODULE "FAIL" (STELLA::GET-STELLA-MODULE "/LOGIC" CL:T) 0))
   (CL:SETQ SYM-PLI-STELLA-EXISTS (STELLA::INTERN-RIGID-SYMBOL-WRT-MODULE "EXISTS" (STELLA::GET-STELLA-MODULE "/STELLA" CL:T) 0))
   (CL:SETQ SYM-PLI-LOGIC-?Y (STELLA::INTERN-RIGID-SYMBOL-WRT-MODULE "?Y" (STELLA::GET-STELLA-MODULE "/LOGIC" CL:T) 0))
   (CL:SETQ SYM-PLI-PLI-PROPER-SUBRELATION (STELLA::INTERN-RIGID-SYMBOL-WRT-MODULE "PROPER-SUBRELATION" STELLA::NULL 0))
   (CL:SETQ SYM-PLI-STELLA-TRUE (STELLA::INTERN-RIGID-SYMBOL-WRT-MODULE "TRUE" (STELLA::GET-STELLA-MODULE "/STELLA" CL:T) 0))
   (CL:SETQ SYM-PLI-STELLA-FALSE (STELLA::INTERN-RIGID-SYMBOL-WRT-MODULE "FALSE" (STELLA::GET-STELLA-MODULE "/STELLA" CL:T) 0))
   (CL:SETQ KWD-PLI-CASE-SENSITIVE? (STELLA::INTERN-RIGID-SYMBOL-WRT-MODULE "CASE-SENSITIVE?" STELLA::NULL 2))
   (CL:SETQ KWD-PLI-SUBSET-OF (STELLA::INTERN-RIGID-SYMBOL-WRT-MODULE "SUBSET-OF" STELLA::NULL 2))
   (CL:SETQ KWD-PLI-ERROR (STELLA::INTERN-RIGID-SYMBOL-WRT-MODULE "ERROR" STELLA::NULL 2))
   (CL:SETQ KWD-PLI-RETRACT-TRUE (STELLA::INTERN-RIGID-SYMBOL-WRT-MODULE "RETRACT-TRUE" STELLA::NULL 2))
   (CL:SETQ KWD-PLI-ASSERT-TRUE (STELLA::INTERN-RIGID-SYMBOL-WRT-MODULE "ASSERT-TRUE" STELLA::NULL 2))
   (CL:SETQ SGT-PLI-LOGIC-PROPOSITION (STELLA::INTERN-RIGID-SYMBOL-WRT-MODULE "PROPOSITION" (STELLA::GET-STELLA-MODULE "/LOGIC" CL:T) 1))
   (CL:SETQ SGT-PLI-PL-KERNEL-KB-NTH-DOMAIN (STELLA::INTERN-RIGID-SYMBOL-WRT-MODULE "NTH-DOMAIN" (STELLA::GET-STELLA-MODULE "/PL-KERNEL-KB" CL:T) 1))
   (CL:SETQ KWD-PLI-MODULE (STELLA::INTERN-RIGID-SYMBOL-WRT-MODULE "MODULE" STELLA::NULL 2))
   (CL:SETQ SGT-PLI-STELLA-INTEGER-WRAPPER (STELLA::INTERN-RIGID-SYMBOL-WRT-MODULE "INTEGER-WRAPPER" (STELLA::GET-STELLA-MODULE "/STELLA" CL:T) 1))
   (CL:SETQ SGT-PLI-STELLA-FLOAT-WRAPPER (STELLA::INTERN-RIGID-SYMBOL-WRT-MODULE "FLOAT-WRAPPER" (STELLA::GET-STELLA-MODULE "/STELLA" CL:T) 1))
   (CL:SETQ SGT-PLI-STELLA-NUMBER-WRAPPER (STELLA::INTERN-RIGID-SYMBOL-WRT-MODULE "NUMBER-WRAPPER" (STELLA::GET-STELLA-MODULE "/STELLA" CL:T) 1))
   (CL:SETQ SGT-PLI-STELLA-STRING-WRAPPER (STELLA::INTERN-RIGID-SYMBOL-WRT-MODULE "STRING-WRAPPER" (STELLA::GET-STELLA-MODULE "/STELLA" CL:T) 1))
   (CL:SETQ KWD-PLI-DOCUMENTATION (STELLA::INTERN-RIGID-SYMBOL-WRT-MODULE "DOCUMENTATION" STELLA::NULL 2))
   (CL:SETQ SYM-PLI-PLI-STARTUP-PLI (STELLA::INTERN-RIGID-SYMBOL-WRT-MODULE "STARTUP-PLI" STELLA::NULL 0))
   (CL:SETQ SYM-PLI-STELLA-METHOD-STARTUP-CLASSNAME (STELLA::INTERN-RIGID-SYMBOL-WRT-MODULE "METHOD-STARTUP-CLASSNAME" (STELLA::GET-STELLA-MODULE "/STELLA" CL:T) 0))))

(CL:DEFUN HELP-STARTUP-PLI2 ()
  (CL:PROGN
   (STELLA::DEFINE-FUNCTION-OBJECT "INITIALIZE" "(DEFUN INITIALIZE () :DOCUMENTATION \"Initialize the PowerLoom logic system.  This function
needs to be called by all applications before using PowerLoom.  If it
is called more than once, every call after the first one is a no-op.\" :PUBLIC? TRUE)" (CL:FUNCTION INITIALIZE) STELLA::NULL)
   (STELLA::DEFINE-FUNCTION-OBJECT "RESET-POWERLOOM" "(DEFUN RESET-POWERLOOM () :DOCUMENTATION \"Reset PowerLoom to its initial state.
CAUTION: This will destroy all loaded knowledge bases and might break other
loaded STELLA systems if they do reference PowerLoom symbols in their code.\" :PUBLIC? TRUE)" (CL:FUNCTION RESET-POWERLOOM) STELLA::NULL)
   (STELLA::DEFINE-FUNCTION-OBJECT "CLEAR-CACHES" "(DEFUN CLEAR-CACHES () :DOCUMENTATION \"Clear all query and memoization caches.\" :PUBLIC? TRUE)"
   ...
   (STELLA::DEFINE-METHOD-OBJECT "(DEFMETHOD (NEXT? BOOLEAN) ((SELF PL-ITERATOR)) :PUBLIC? TRUE :DOCUMENTATION \"Advance the PL-Iterator `self' and return `true' if more
elements are available, `false' otherwise.\")" (CL:FUNCTION STELLA::NEXT?) STELLA::NULL)
   ...
   (STELLA::DEFINE-METHOD-OBJECT "(DEFMETHOD (LISTIFY LIST) ((SELF PL-ITERATOR)) :PUBLIC? TRUE :DOCUMENTATION \"Convert `self' into a Stella LIST.\")"
    (CL:FUNCTION STELLA::LISTIFY) STELLA::NULL)
   (STELLA::DEFINE-METHOD-OBJECT "(DEFMETHOD (CONSIFY CONS) ((SELF PL-ITERATOR)) :PUBLIC? TRUE :DOCUMENTATION \"Convert `self' into a Stella CONS.\")"
    (CL:FUNCTION STELLA::CONSIFY) STELLA::NULL)
   (STELLA::DEFINE-FUNCTION-OBJECT "SAFELY-GET-OBJECT" "(DEFUN (SAFELY-GET-OBJECT OBJECT) ((NAME STRING) (MODULE MODULE) (ENVIRONMENT ENVIRONMENT)) :PUBLIC? FALSE)"
    (CL:FUNCTION SAFELY-GET-OBJECT) STELLA::NULL)
   (STELLA::DEFINE-FUNCTION-OBJECT "SAFELY-GET-CONCEPT" "(DEFUN (SAFELY-GET-CONCEPT OBJECT) ((NAME STRING) (MODULE MODULE) (ENVIRONMENT ENVIRONMENT)) :PUBLIC? FALSE)"
    (CL:FUNCTION SAFELY-GET-CONCEPT) STELLA::NULL)
   (STELLA::DEFINE-FUNCTION-OBJECT "SAFELY-GET-RELATION" "(DEFUN (SAFELY-GET-RELATION OBJECT) ((NAME STRING) (MODULE MODULE) (ENVIRONMENT ENVIRONMENT)) :PUBLIC? FALSE)"
    (CL:FUNCTION SAFELY-GET-RELATION) STELLA::NULL)
   (STELLA::DEFINE-FUNCTION-OBJECT "SAFELY-GET-MODULE" "(DEFUN (SAFELY-GET-MODULE CONTEXT) ((NAME STRING) (ENVIRONMENT ENVIRONMENT)) :PUBLIC? FALSE)"
    (CL:FUNCTION SAFELY-GET-MODULE) STELLA::NULL)
   (STELLA::DEFINE-FUNCTION-OBJECT "SAFELY-GET-OBJECT-OR-NULL"
    "(DEFUN (SAFELY-GET-OBJECT-OR-NULL OBJECT) ((NAME STRING) (MODULE MODULE) (ENVIRONMENT ENVIRONMENT)) :PUBLIC? FALSE)" (CL:FUNCTION SAFELY-GET-OBJECT-OR-NULL)
    STELLA::NULL)
   (STELLA::DEFINE-FUNCTION-OBJECT "SEQUENCE-TO-CONS-LIST" "(DEFUN (SEQUENCE-TO-CONS-LIST CONS) ((SEQUENCE OBJECT)) :PUBLIC? FALSE)" (CL:FUNCTION SEQUENCE-TO-CONS-LIST)
    STELLA::NULL)
   (STELLA::DEFINE-FUNCTION-OBJECT "EXPLODE-STRING-LIST" "(DEFUN (EXPLODE-STRING-LIST CONS) ((STRINGLIST STRING) (MODULE MODULE)) :PUBLIC? FALSE)"
    (CL:FUNCTION EXPLODE-STRING-LIST) STELLA::NULL)
   (STELLA::DEFINE-FUNCTION-OBJECT "LEGAL-OPERATOR?" "(DEFUN (LEGAL-OPERATOR? BOOLEAN) ((OPERATOR SYMBOL)) :PUBLIC? FALSE)" (CL:FUNCTION LEGAL-OPERATOR?) STELLA::NULL)
...
exists.  `name' is ALWAYS treated case sensitively.\")" (CL:FUNCTION GET-SYMBOL) STELLA::NULL)
...
If no such operator exists then a `no-such-object' exception is thrown.\")" (CL:FUNCTION GET-OPERATOR) STELLA::NULL)
...
or visible from the module `module'.\")" (CL:FUNCTION GET-OBJECT) STELLA::NULL)
...
or visible from the module `module-name'.  A module name of `null' or the
empty string refers to the current module.  If no module can be found
with the name `module-name', then a Stella `no-such-context-exception' is thrown.\")" (CL:FUNCTION S-GET-OBJECT) STELLA::NULL)
...
or visible from the module `module'.\")" (CL:FUNCTION GET-CONCEPT) STELLA::NULL)
...
or visible from the module `module-name'.  A module name of `null' or the
empty string refers to the current module.  If no module can be found
with the name `module-name', then a Stella `no-such-context-exception' is thrown.\")" (CL:FUNCTION S-GET-CONCEPT) STELLA::NULL)
...
or visible from the module `module'.\")" (CL:FUNCTION GET-RELATION) STELLA::NULL)
...
or visible from the module `module-name'.  A module name of `null' or the
empty string refers to the current module.  If no module can be found
with the name `module-name', then a Stella `no-such-context-exception' is thrown.\")" (CL:FUNCTION S-GET-RELATION) STELLA::NULL)
   (STELLA::DEFINE-FUNCTION-OBJECT "GET-UNDEFINED-RELATIONS"
    "(DEFUN (GET-UNDEFINED-RELATIONS (PL-ITERATOR OF LOGIC-OBJECT)) ((MODULE MODULE) (ENVIRONMENT ENVIRONMENT)) :PUBLIC? TRUE :DOCUMENTATION \"Return relations that have been referenced but not defined in `module'.\")"
...
`module'.  If there is no name for the object return `null'.\")" (CL:FUNCTION GET-NAME-IN-MODULE) STELLA::NULL)
...
Floating point values will be coerced by rounding.\")" (CL:FUNCTION OBJECT-TO-INTEGER) STELLA::NULL)
...
representation of the object `self'.  Like `object-to-string', but puts
escaped double quotes around strings.\")" (CL:FUNCTION OBJECT-TO-PARSABLE-STRING) STELLA::NULL)
...
Currently `type' only has an effect on the interpretation of literal types.\")" (CL:FUNCTION STRING-TO-OBJECT) STELLA::NULL)
...
A module name of `null' or the
empty string refers to the current module.  If no module can be found
with the name `module-name', then a Stella `no-such-context-exception' is thrown.\")" (CL:FUNCTION S-GET-PROPOSITION) STELLA::NULL)
...
have been asserted (or inferred by forward chaining).  `relation-and-arguments'
is a sequence containing objects and nulls.  The first argument must be the
name of a relation.  A null value acts like a wild card.\")" (CL:FUNCTION GET-PROPOSITIONS) STELLA::NULL)
...
A module name of `null' or the
empty string refers to the current module.  If no module can be found
with the name `module-name', then a Stella `no-such-context-exception' is thrown.\")" (CL:FUNCTION S-GET-PROPOSITIONS) STELLA::NULL)
   (STELLA::DEFINE-FUNCTION-OBJECT "GET-INCONSISTENT-PROPOSITIONS"
    "(DEFUN (GET-INCONSISTENT-PROPOSITIONS (PL-ITERATOR OF PROPOSITION)) ((MODULE MODULE) (ENVIRONMENT ENVIRONMENT)) :PUBLIC? TRUE :DOCUMENTATION \"Return inconsistent propositions visible in `module'.\")"
...
as a wildcard. If more than one proposition matches the input criteria,
the selection is arbitrary.  This procedure is normally applied to single-valued
relations or functions.\")" (CL:FUNCTION GET-BINARY-PROPOSITION) STELLA::NULL)
...
is true.  The `relation' argument
must be bound to a relation.  One or both of the `arg1' and `arg2' arguments
may be set to NULL, which is interpreted as a wildcard.\")" (CL:FUNCTION GET-BINARY-PROPOSITIONS) STELLA::NULL)
   (STELLA::DEFINE-FUNCTION-OBJECT "GET-INFERRED-BINARY-PROPOSITION-VALUES"
...
has been asserted or can be inferred.\")" (CL:FUNCTION GET-INFERRED-BINARY-PROPOSITION-VALUES) STELLA::NULL)
   (STELLA::DEFINE-FUNCTION-OBJECT "S-GET-INFERRED-BINARY-PROPOSITION-VALUES"
...
A module name of `null' or the empty string refers to the current module. 
If no module can be found with the name `module-name', then a Stella 
`no-such-context-exception' is thrown.\")" (CL:FUNCTION S-GET-INFERRED-BINARY-PROPOSITION-VALUES) STELLA::NULL)
...
and that are TRUE in the scope of the module `module'.\")" (CL:FUNCTION GET-PROPOSITIONS-OF) STELLA::NULL)
...
A module name of `null' or the empty string refers to the current module. 
If no module can be found with the name `module-name', then a Stella 
`no-such-context-exception' is thrown.\")" (CL:FUNCTION S-GET-PROPOSITIONS-OF) STELLA::NULL)
...
the module `module'.\")" (CL:FUNCTION GET-PROPOSITIONS-IN-MODULE) STELLA::NULL)
...
been asserted (or inferred by forward chaining).\")" (CL:FUNCTION IS-TRUE-UNARY-PROPOSITION) STELLA::NULL)
...
been asserted (or inferred by forward chaining).\")" (CL:FUNCTION IS-TRUE-BINARY-PROPOSITION) STELLA::NULL)
...
been asserted (or inferred by forward chaining).\")" (CL:FUNCTION IS-TRUE-PROPOSITION1) STELLA::NULL)
...
A module name of `null' or the empty string refers to the current module. 
If no module can be found with the name `module-name', then a Stella 
`no-such-context-exception' is thrown.\")" (CL:FUNCTION S-IS-TRUE-PROPOSITION) STELLA::NULL)
...
Non-reflexive.\")" (CL:FUNCTION GET-PROPER-SUPERRELATIONS) STELLA::NULL)
...
Non-reflexive.\")" (CL:FUNCTION GET-DIRECT-SUPERRELATIONS) STELLA::NULL)
...
Include instances of subconcepts of `concept'.  Depending on `concept',
the return values could be (wrapped) literals.\")" (CL:FUNCTION GET-CONCEPT-INSTANCES) STELLA::NULL)
...
A module name of `null' or the empty string refers to the current module. 
If no module can be found with the name `module-name', then a Stella 
`no-such-context-exception' is thrown.\")" (CL:FUNCTION S-GET-CONCEPT-INSTANCES) STELLA::NULL)
...
Exclude instances of subconcepts of `concept'.  Depending on `concept',
the return values could be (wrapped) literals.\")" (CL:FUNCTION GET-DIRECT-CONCEPT-INSTANCES) STELLA::NULL)
...
A module name of `null' or the empty string refers to the current module. 
If no module can be found with the name `module-name', then a Stella 
`no-such-context-exception' is thrown.\")" (CL:FUNCTION S-GET-DIRECT-CONCEPT-INSTANCES) STELLA::NULL)
   (STELLA::DEFINE-FUNCTION-OBJECT "GET-CONCEPT-INSTANCES-MATCHING-VALUE"
...
have an attribute matching `value' for the binary relation `relation', i.e.,
`(relation <result> value)' holds.\")" (CL:FUNCTION GET-CONCEPT-INSTANCES-MATCHING-VALUE) STELLA::NULL)
   (STELLA::DEFINE-FUNCTION-OBJECT "GET-CONCEPT-INSTANCE-MATCHING-VALUE"
...
has an attribute matching `value' for the binary relation `relation', i.e.,
`(relation <result> value)' holds.\")" (CL:FUNCTION GET-CONCEPT-INSTANCE-MATCHING-VALUE) STELLA::NULL)
   (STELLA::DEFINE-FUNCTION-OBJECT "HELP-GET-TYPES"
    "(DEFUN (HELP-GET-TYPES (CONS OF LOGIC-OBJECT)) ((OBJECT LOGIC-OBJECT) (MODULE MODULE) (ENVIRONMENT ENVIRONMENT)) :PUBLIC? FALSE)" (CL:FUNCTION HELP-GET-TYPES)
    STELLA::NULL)
...
Include propositions that satisfy subrelations of `relation'.\")" (CL:FUNCTION GET-RELATION-EXTENSION) STELLA::NULL)
...
`relation-name'.  Include propositions that satisfy subrelations of the relation.\")" (CL:FUNCTION S-GET-RELATION-EXTENSION) STELLA::NULL)
   (STELLA::DEFINE-FUNCTION-OBJECT "GET-MODULE"
    "(DEFUN (GET-MODULE MODULE) ((NAME STRING) (ENVIRONMENT ENVIRONMENT)) :PUBLIC? TRUE :DOCUMENTATION \"Return a module named `name'.\")" (CL:FUNCTION GET-MODULE)
    STELLA::NULL)
   (STELLA::DEFINE-FUNCTION-OBJECT "GET-CURRENT-MODULE"
    "(DEFUN (GET-CURRENT-MODULE MODULE) ((ENVIRONMENT ENVIRONMENT)) :PUBLIC? TRUE :DOCUMENTATION \"Return the currently set module\")" (CL:FUNCTION GET-CURRENT-MODULE)
    STELLA::NULL)
...
the contents of all of its children, recursively.\")" (CL:FUNCTION CLEAR-MODULE) STELLA::NULL)
...
well as the contents of all of its children, recursively.  If no module
named `name' exists, a Stella `no-such-context-exception' is thrown.\")" (CL:FUNCTION S-CLEAR-MODULE) STELLA::NULL)
...
is not currently in use in `module.'  In a non-case-sensitive module, the returned
name will be all upper case (This latter feature may change!)\")" (CL:FUNCTION GENERATE-UNIQUE-NAME) STELLA::NULL)
...
necessary.  `name' is treated case-sensitively.  This should
generally not be necessary to do.\")" (CL:FUNCTION CREATE-KEYWORD) STELLA::NULL)
...
Note that because names in modules that are not case-sensitive are canonicalized,
the name of the returned object may not match `name' exactly.\")" (CL:FUNCTION CREATE-CONCEPT) STELLA::NULL)
...
Note that because names in modules that are not case-sensitive are canonicalized,
the name of the returned object may not match `name' exactly.\")" (CL:FUNCTION S-CREATE-CONCEPT) STELLA::NULL)
...
Note that because names in modules that are not case-sensitive are canonicalized,
the name of the returned object may not match `name' exactly.\")" (CL:FUNCTION CREATE-RELATION) STELLA::NULL)
...
Note that because names in modules that are not case-sensitive are canonicalized,
the name of the returned object may not match `name' exactly.\")" (CL:FUNCTION S-CREATE-RELATION) STELLA::NULL)
...
Note that because names in modules that are not case-sensitive are canonicalized,
the name of the returned object may not match `name' exactly.\")" (CL:FUNCTION CREATE-FUNCTION) STELLA::NULL)
...
Note that because names in modules that are not case-sensitive are canonicalized,
the name of the returned object may not match `name' exactly.\")" (CL:FUNCTION S-CREATE-FUNCTION) STELLA::NULL)
...
programming language.  The following type mappings are used:
          C++:  
  Common Lisp:  FUNCTION   (result of #' or (FUNCTION ...))
         Java:  java.lang.reflect.Method\")" (CL:FUNCTION REGISTER-SPECIALIST-FUNCTION) STELLA::NULL)
...
language.  The following type mappings are used:
  ...
  Common Lisp:  The native-name is read by READ-FROM-STRING and then
         ...
         Java:  A fully package-qualified name is required.  It is
                looked up using the Reflection tools.
The function found must conform to the signature for specialist functions.\")" (CL:FUNCTION S-REGISTER-SPECIALIST-FUNCTION) STELLA::NULL)
   (STELLA::DEFINE-FUNCTION-OBJECT "REGISTER-COMPUTATION-FUNCTION"
    "(DEFUN REGISTER-COMPUTATION-FUNCTION ((NAME STRING) (FUNCTION-REFERENCE FUNCTION-CODE) (ARITY INTEGER) (MODULE MODULE) (ENVIRONMENT ENVIRONMENT)) :PUBLIC? TRUE :DOCUMENTATION \"Register `name' as a function name in `module' which will invoke the
native code procedure described by `function-reference.'  The `name'
is a fully-qualified name which will be interpreted by the normal
rules for reading names in PowerLoom.  The function must conform
to the signature for computation functions used by the computation
...
programming language.  The following type mappings are used:
          C++:  cpp_function_code (a pointer to the function code)
  Common Lisp:  FUNCTION   (result of #' or (FUNCTION ...))
         Java:  java.lang.reflect.Method\")" (CL:FUNCTION REGISTER-COMPUTATION-FUNCTION) STELLA::NULL)
   (STELLA::DEFINE-FUNCTION-OBJECT "S-REGISTER-COMPUTATION-FUNCTION"
    "(DEFUN S-REGISTER-COMPUTATION-FUNCTION ((NAME STRING) (NATIVE-NAME STRING) (ARITY INTEGER) (MODULE-NAME STRING) (ENVIRONMENT ENVIRONMENT)) :PUBLIC? TRUE :DOCUMENTATION \"Register `name' as a function name in the module named `module-name'.
This function will the native code named `native-name'.  The `name'
is a fully-qualified name which will be interpreted by the normal
rules for reading names in PowerLoom.  The `native-name' will be
processed in a manner that depends on the underlying programming
language.  The following type mappings are used:
  ...
  Common Lisp:  The native-name is read by READ-FROM-STRING and then
         ...
         Java:  A fully package-qualified name is required.  It is
                looked up using the Reflection tools.
The function found must conform to the signature for computation functions.
Arity specifies the number of arguments the computation accepts.\")" (CL:FUNCTION S-REGISTER-COMPUTATION-FUNCTION) STELLA::NULL)
...
`module' using `environment'.  Useful for passing lists as arguments
to parameterized queries.\")" (CL:FUNCTION CREATE-ENUMERATED-LIST) STELLA::NULL)
...
in `module' using `environment'.\")" (CL:FUNCTION CREATE-ENUMERATED-SET) STELLA::NULL)
   (STELLA::DEFINE-FUNCTION-OBJECT "DESTROY-OBJECT"
    "(DEFUN DESTROY-OBJECT ((OBJECT OBJECT)) :PUBLIC? TRUE :DOCUMENTATION \"Delete the object `object', retracting all facts attached to it.\")"
...
A module name of `null' or the empty string refers to the current module. 
If no module can be found with the name `module-name', then a Stella 
`no-such-context-exception' is thrown.\")" (CL:FUNCTION S-DESTROY-OBJECT) STELLA::NULL)
...
in `module'.  Return the asserted proposition.\")" (CL:FUNCTION ASSERT-BINARY-PROPOSITION) STELLA::NULL)
...
the relation `relation'.\")" (CL:FUNCTION ASSERT-NARY-PROPOSITION) STELLA::NULL)
...
in `module'.  Return the asserted proposition.\")" (CL:FUNCTION RETRACT-BINARY-PROPOSITION) STELLA::NULL)
...
the relation `relation'.\")" (CL:FUNCTION RETRACT-NARY-PROPOSITION) STELLA::NULL)
...
Return the asserted proposition.\")" (CL:FUNCTION ASSERT-PROPOSITION) STELLA::NULL)
...
Return an iterator of the propositions resulting from sentence.\")" (CL:FUNCTION S-ASSERT-PROPOSITION) STELLA::NULL)
...
Return the retracted proposition.\")" (CL:FUNCTION RETRACT-PROPOSITION) STELLA::NULL)
...
Return an iterator of the retracted propositions resulting from sentence.\")" (CL:FUNCTION S-RETRACT-PROPOSITION) STELLA::NULL)
...
Signals a `Proposition-Error' if PowerLoom could not conceive `sentence'.\")" (CL:FUNCTION CONCEIVE) STELLA::NULL)
...
Signals a `Proposition-Error' if PowerLoom could not conceive `sentence'.\")" (CL:FUNCTION S-CONCEIVE) STELLA::NULL)
...
in either antecedent or consequent position.\")" (CL:FUNCTION GET-RULES) STELLA::NULL)))
...
A module name of `null' or the empty string refers to the current module.
If no module can be found with the name `module-name', then a Stella
`No-Such-Context-Exception' is thrown.\")" (CL:FUNCTION S-GET-RULES) STELLA::NULL)
...
A module name of `null' or the empty string refers to the
current module.  If no module can be found with the name `module-name',
then a Stella `no-such-context-exception' is thrown.\" :PUBLIC? TRUE)" (CL:FUNCTION S-PRINT-RULES) STELLA::NULL)
...
called again.\")" (CL:FUNCTION RUN-FORWARD-RULES) STELLA::NULL)
   (STELLA::DEFINE-FUNCTION-OBJECT "GET-ARITY"
    "(DEFUN (GET-ARITY INTEGER) ((RELATION LOGIC-OBJECT)) :PUBLIC? TRUE :DOCUMENTATION \"Return the arity of the relation `relation'.\")" (CL:FUNCTION GET-ARITY)
    STELLA::NULL)
 ...
 A module name of `null' or the empty string refers to the
current module.  If no module can be found with the name `module-name',
then a Stella `no-such-context-exception' is thrown.\")" (CL:FUNCTION S-GET-ARITY) STELLA::NULL)
...
A module name of `null' or the empty string refers to the
current module.  If no module can be found with the name `module-name',
then a Stella `no-such-context-exception' is thrown.\")" (CL:FUNCTION S-GET-DOMAIN) STELLA::NULL)
...
A module name of `null' or the empty string refers to the
current module.  If no module can be found with the name `module-name',
then a Stella `no-such-context-exception' is thrown.\")" (CL:FUNCTION S-GET-RANGE) STELLA::NULL)
...
relation `relation'.  Counting starts at zero.  NOTE: if there are multiple
`nth-domain' propositions for `relation', this arbitrarily returns one of them;
it does not look for the most specific one (which might have to be created).\")" (CL:FUNCTION GET-NTH-DOMAIN) STELLA::NULL)
...
A module name of `null' or the empty string refers to the
current module.  If no module can be found with the name `module-name',
then a Stella `no-such-context-exception' is thrown.\")" (CL:FUNCTION S-GET-NTH-DOMAIN) STELLA::NULL)
...
The file should contain an `in-module' declaration that specifies the module
within which all remaining commands are to be evaluated.  The remaining commands
are evaluated one-by-one, applying the function `evaluate' to each of them.\")" (CL:FUNCTION LOAD) STELLA::NULL)
   (STELLA::DEFINE-FUNCTION-OBJECT "LOAD-IN-MODULE"
    "(DEFUN LOAD-IN-MODULE ((FILENAME STRING) (MODULE MODULE) (ENVIRONMENT ENVIRONMENT)) :PUBLIC? TRUE :DOCUMENTATION \"Read logic commands from the file named `filename' and evaluate them.
If the file does not have an `in-module' declaration that specifies the module
within which all remaining commands are to be evaluated, it will be loaded
in the `module' specified.  If no `module' is specified and the file does
not contain an `in-module' declaration, an error will be signaled.
The remaining commands are evaluated one-by-one, applying the function
`evaluate' to each of them.\")" (CL:FUNCTION LOAD-IN-MODULE) STELLA::NULL)
...
`evaluate' to each of them.\")" (CL:FUNCTION LOAD-STREAM) STELLA::NULL)
   (STELLA::DEFINE-FUNCTION-OBJECT "LOAD-STREAM-IN-MODULE"
    "(DEFUN LOAD-STREAM-IN-MODULE ((STREAM INPUT-STREAM) (MODULE MODULE) (ENVIRONMENT ENVIRONMENT)) :PUBLIC? TRUE :DOCUMENTATION \"Read logic commands from the STELLA stream `stream' and evaluate them.
If the stream does not supply an `in-module' declaration that specifies the
module within which all remaining commands are to be evaluated, it will be
loaded in the `module' specified.  If no `module' is specified and the file 
does not supply an `in-module' declaration, an error will be signaled.
The remaining commands are evaluated one-by-one, applying the function
`evaluate' to each of them.\")" (CL:FUNCTION LOAD-STREAM-IN-MODULE) STELLA::NULL)
...
the module within which all remaining commands are to be evaluated
The remaining commands are evaluated one-by-one, applying the function
`evaluate' to each of them.\")" (CL:FUNCTION LOAD-NATIVE-STREAM) STELLA::NULL)
   (STELLA::DEFINE-FUNCTION-OBJECT "LOAD-NATIVE-STREAM-IN-MODULE"
    "(DEFUN LOAD-NATIVE-STREAM-IN-MODULE ((STREAM NATIVE-INPUT-STREAM) (MODULE MODULE) (ENVIRONMENT ENVIRONMENT)) :PUBLIC? TRUE :DOCUMENTATION \"Read logic commands from the native input stream `stream' and evaluate them.
Assumes `stream' is a line-buffered stream which is a safe compromise but does
not generate the best efficiency for block-buffered streams such as files.
If the stream does not supply an `in-module' declaration that specifies the
module within which all remaining commands are to be evaluated, it will be
...
does not supply an `in-module' declaration, an error will be signaled.
The remaining commands are evaluated one-by-one, applying the function
`evaluate' to each of them.\")" (CL:FUNCTION LOAD-NATIVE-STREAM-IN-MODULE) STELLA::NULL)
...
value of `ifexists'.  Possible values are \\\"ASK\\\", \\\"REPLACE\\\", \\\"WARN\\\" and \\\"ERROR\\\":
  ...
  ERROR   => Means don't overwrite, signal an error instead.
  ASK     => Ask the user whether to overwrite or not.  If not overwritten, an 
             exception is thrown.\")" (CL:FUNCTION SAVE-MODULE) STELLA::NULL)
...
A module name of `null' or the empty string refers to the
current module.  If no module can be found with the name `module-name',
then a Stella `no-such-context-exception' is thrown.\")" (CL:FUNCTION S-SAVE-MODULE) STELLA::NULL)
...
For a null item, the column count is zero.
For non sequence objects, the column count is one.\")" (CL:FUNCTION GET-COLUMN-COUNT) STELLA::NULL)
...
As a special case, a column number of zero will also return `sequence' itself
if it is not one of the types enumerated above.  This is done to allow the
use of `get-nth-value' on PL-iterators with only a single return variable.\")" (CL:FUNCTION GET-NTH-VALUE) STELLA::NULL)
...
As a special case, a column number of zero will also return `sequence' itself
as a string if it is not one of the types enumerated above.  This is done to 
allow the use of `get-nth-string' on PL-iterators with only a single return variable.\")" (CL:FUNCTION GET-NTH-STRING) STELLA::NULL)
...
above.   This allows the use of `get-nth-integer' on PL-iterators with
only a single return variable.  If  `sequence' cannot be turned into an
integer, an exception will be thrown.\")" (CL:FUNCTION GET-NTH-INTEGER) STELLA::NULL)
...
above.  This allows the use of `get-nth-float' on PL-iterators with only
a single return variable.    If  `sequence' cannot be turned into a floating
point value, an exception will be thrown.\")" (CL:FUNCTION GET-NTH-FLOAT) STELLA::NULL)
...
if it is not one of the types enumerated above.  This is done to allow the
use of `get-nth-value' on PL-iterators with only a single return variable.
If `sequence' is not a LOGIC-OBJECT, an exception is thrown.\")" (CL:FUNCTION GET-NTH-LOGIC-OBJECT) STELLA::NULL)
...
of collection, i.e., sets and lists\")" (CL:FUNCTION GET-ENUMERATED-COLLECTION-MEMBERS) STELLA::NULL)
...
global variables is supported.  Commands are simple to program in Common Lisp,
since they are built into the language, and relatively awkward in Java and C++.
Users of either of those languages are more likely to want to call `s-evaluate'.\")" (CL:FUNCTION EVALUATE) STELLA::NULL)
...
global variables is supported.
 ...
 A module name of `null' or the empty string refers to the
current module.  If no module can be found with the name `module-name',
then a Stella `no-such-context-exception' is thrown.\")" (CL:FUNCTION S-EVALUATE) STELLA::NULL)
   (STELLA::DEFINE-FUNCTION-OBJECT "IS-LOGIC-OBJECT"
    "(DEFUN (IS-LOGIC-OBJECT BOOLEAN) ((OBJ OBJECT)) :PUBLIC? TRUE :DOCUMENTATION \"Test whether `obj' is of type LOGIC-OBJECT\")" (CL:FUNCTION IS-LOGIC-OBJECT)
    STELLA::NULL)
   (STELLA::DEFINE-FUNCTION-OBJECT "IS-INTEGER" "(DEFUN (IS-INTEGER BOOLEAN) ((OBJ OBJECT)) :PUBLIC? TRUE :DOCUMENTATION \"Test whether `obj' is of type INTEGER\")"
    (CL:FUNCTION IS-INTEGER) STELLA::NULL)
   (STELLA::DEFINE-FUNCTION-OBJECT "IS-FLOAT" "(DEFUN (IS-FLOAT BOOLEAN) ((OBJ OBJECT)) :PUBLIC? TRUE :DOCUMENTATION \"Test whether `obj' is of type FLOAT (double)\")"
    (CL:FUNCTION IS-FLOAT) STELLA::NULL)
   (STELLA::DEFINE-FUNCTION-OBJECT "IS-NUMBER" "(DEFUN (IS-NUMBER BOOLEAN) ((OBJ OBJECT)) :PUBLIC? TRUE :DOCUMENTATION \"Test whether `obj' is of type NUMBER.  This can
be either an integer or a floating point number.  One key characteristic
is that 'object-to-integer' and `object-to-float' will both work on it.\")" (CL:FUNCTION IS-NUMBER) STELLA::NULL)
   (STELLA::DEFINE-FUNCTION-OBJECT "IS-STRING" "(DEFUN (IS-STRING BOOLEAN) ((OBJ OBJECT)) :PUBLIC? TRUE :DOCUMENTATION \"Test whether `obj' is of type STRING\")"
...
subsumes both sets and lists.\")" (CL:FUNCTION IS-ENUMERATED-COLLECTION) STELLA::NULL)
   (STELLA::DEFINE-FUNCTION-OBJECT "IS-ENUMERATED-SET"
    "(DEFUN (IS-ENUMERATED-SET BOOLEAN) ((OBJ OBJECT)) :PUBLIC? TRUE :DOCUMENTATION \"Test whether `obj' is an enumerated set.\")" (CL:FUNCTION IS-ENUMERATED-SET)
    STELLA::NULL)
   (STELLA::DEFINE-FUNCTION-OBJECT "IS-ENUMERATED-LIST"
    "(DEFUN (IS-ENUMERATED-LIST BOOLEAN) ((OBJ OBJECT)) :PUBLIC? TRUE :DOCUMENTATION \"Test whether `obj' is an enumerated list\")" (CL:FUNCTION IS-ENUMERATED-LIST)
    STELLA::NULL)
...
either absolutely or by default.\")" (CL:FUNCTION IS-TRUE) STELLA::NULL)
...
either absolutely or by default.\")" (CL:FUNCTION IS-FALSE) STELLA::NULL)
   (STELLA::DEFINE-FUNCTION-OBJECT "IS-UNKNOWN"
    "(DEFUN (IS-UNKNOWN BOOLEAN) ((TV TRUTH-VALUE)) :PUBLIC? TRUE :DOCUMENTATION \"Tests whether `tv' is an unknown truth value.\")" (CL:FUNCTION IS-UNKNOWN)
    STELLA::NULL)
   (STELLA::DEFINE-FUNCTION-OBJECT "IS-KNOWN"
    "(DEFUN (IS-KNOWN BOOLEAN) ((TV TRUTH-VALUE)) :PUBLIC? TRUE :DOCUMENTATION \"Tests whether `tv' is a known truth value (i.e., true or false).\")"
   ...
   (STELLA::DEFINE-FUNCTION-OBJECT "IS-STRICT"
    "(DEFUN (IS-STRICT BOOLEAN) ((TV TRUTH-VALUE)) :PUBLIC? TRUE :DOCUMENTATION \"Tests whether `tv' is a strict (non-default) truth value.\")" (CL:FUNCTION IS-STRICT)
    STELLA::NULL)
   (STELLA::DEFINE-FUNCTION-OBJECT "IS-DEFAULT"
    "(DEFUN (IS-DEFAULT BOOLEAN) ((TV TRUTH-VALUE)) :PUBLIC? TRUE :DOCUMENTATION \"Tests whether `tv' is a default truth value.\")" (CL:FUNCTION IS-DEFAULT)
    STELLA::NULL)
...
The returned truth value represents the logical truth of the queried sentence
as determined by PowerLoom.  It can be be tested via the functions `is-true',
`is-false' and `is-unknown' (which see).\" :PUBLIC? TRUE)" (CL:FUNCTION ASK) STELLA::NULL)
...
The returned truth value represents the logical truth of the queried sentence
as determined by PowerLoom.  It can be be tested via the functions `is-true',
`is-false' and `is-unknown' (which see).\" :PUBLIC? TRUE)" (CL:FUNCTION S-ASK) STELLA::NULL)
...
in the query proposition in the order in which they were encountered.  If
order does matter or should be different from its default, it can be forced
by declaring the set of output variables.\" :PUBLIC? TRUE)" (CL:FUNCTION RETRIEVE) STELLA::NULL)
...
A null `module-name' or the empty string refers to the current module.
If no module can be found with the name `module-name', then a STELLA
`no-such-context-exception' is thrown.\" :PUBLIC? TRUE)" (CL:FUNCTION S-RETRIEVE) STELLA::NULL)
   (STELLA::DEFINE-FUNCTION-OBJECT "MAIN" "(DEFUN MAIN () :PUBLIC? TRUE)" (CL:FUNCTION MAIN) STELLA::NULL)
   (STELLA::DEFINE-FUNCTION-OBJECT "STARTUP-PLI" "(DEFUN STARTUP-PLI () :PUBLIC? TRUE)" (CL:FUNCTION STARTUP-PLI) STELLA::NULL)
   (CL:LET* ((FUNCTION (STELLA::LOOKUP-FUNCTION SYM-PLI-PLI-STARTUP-PLI)))
    (STELLA::SET-DYNAMIC-SLOT-VALUE (STELLA::%DYNAMIC-SLOTS FUNCTION) SYM-PLI-STELLA-METHOD-STARTUP-CLASSNAME (STELLA::WRAP-STRING "_StartupPli")
     STELLA::NULL-STRING-WRAPPER))))

(CL:DEFUN STARTUP-PLI ()
  (CL:LET* ((STELLA::*MODULE* (STELLA::GET-STELLA-MODULE "/PLI" (STELLA::> STELLA::*STARTUP-TIME-PHASE* 1))) (STELLA::*CONTEXT* STELLA::*MODULE*))
   (CL:DECLARE (CL:SPECIAL STELLA::*MODULE* STELLA::*CONTEXT*)) (CL:WHEN (STELLA::CURRENT-STARTUP-TIME-PHASE? 2) (HELP-STARTUP-PLI1))
   (CL:WHEN (STELLA::CURRENT-STARTUP-TIME-PHASE? 4)
    (CL:LET* ((SELF-060 (NEW-ENVIRONMENT))) (CL:SETF (STELLA::%LEVEL SELF-060) "ASSERTION") (CL:SETQ ASSERTION-ENV SELF-060))
    (CL:LET* ((SELF-061 (NEW-ENVIRONMENT))) (CL:SETF (STELLA::%LEVEL SELF-061) "TAXONOMIC") (CL:SETQ TAXONOMIC-ENV SELF-061))
    (CL:LET* ((SELF-062 (NEW-ENVIRONMENT))) (CL:SETF (STELLA::%LEVEL SELF-062) "INFERENCE") (CL:SETQ INFERENCE-ENV SELF-062))
    (CL:LET* ((SELF-063 (NEW-PL-ITERATOR))) (CL:SETF (STELLA::%CURSOR SELF-063) STELLA::NIL) (CL:SETQ EMPTY-PL-ITERATOR SELF-063)))
   (CL:WHEN (STELLA::CURRENT-STARTUP-TIME-PHASE? 5)
    (CL:LET*
     ...
     (CL:SETF (STELLA::%CLASS-CONSTRUCTOR-CODE CLASS) (CL:FUNCTION NEW-ENVIRONMENT))
     (CL:SETF (STELLA::%CLASS-SLOT-ACCESSOR-CODE CLASS) (CL:FUNCTION ACCESS-ENVIRONMENT-SLOT-VALUE)))
    (CL:LET*
     ((CLASS
     ...
     (CL:SETF (STELLA::%CLASS-CONSTRUCTOR-CODE CLASS) (CL:FUNCTION NEW-PL-ITERATOR))
     (CL:SETF (STELLA::%CLASS-SLOT-ACCESSOR-CODE CLASS) (CL:FUNCTION ACCESS-PL-ITERATOR-SLOT-VALUE))))
   (CL:WHEN (STELLA::CURRENT-STARTUP-TIME-PHASE? 6) (STELLA::FINALIZE-CLASSES))
   (CL:WHEN (STELLA::CURRENT-STARTUP-TIME-PHASE? 7) (HELP-STARTUP-PLI2) (HELP-STARTUP-PLI3) (HELP-STARTUP-PLI4))
   (CL:WHEN (STELLA::CURRENT-STARTUP-TIME-PHASE? 8) (STELLA::FINALIZE-SLOTS) (STELLA::CLEANUP-UNFINALIZED-CLASSES))
   (CL:WHEN (STELLA::CURRENT-STARTUP-TIME-PHASE? 9) (STELLA::%IN-MODULE (STELLA::COPY-CONS-TREE (STELLA::WRAP-STRING "PLI")))
    (STELLA::DEFINE-STELLA-GLOBAL-VARIABLE-FROM-STRINGIFIED-SOURCE "(DEFGLOBAL *POWERLOOM-INITIALIZED?* BOOLEAN FALSE)") (CL:SETQ *POWERLOOM-INITIALIZED?* CL:T)
    (STELLA::DEFINE-STELLA-GLOBAL-VARIABLE-FROM-STRINGIFIED-SOURCE "(DEFCONSTANT ASSERTION-ENV ENVIRONMENT (NEW ENVIRONMENT :LEVEL \"ASSERTION\") :PUBLIC? TRUE)")
    (STELLA::DEFINE-STELLA-GLOBAL-VARIABLE-FROM-STRINGIFIED-SOURCE "(DEFCONSTANT TAXONOMIC-ENV ENVIRONMENT (NEW ENVIRONMENT :LEVEL \"TAXONOMIC\") :PUBLIC? TRUE)")
    (STELLA::DEFINE-STELLA-GLOBAL-VARIABLE-FROM-STRINGIFIED-SOURCE "(DEFCONSTANT INFERENCE-ENV ENVIRONMENT (NEW ENVIRONMENT :LEVEL \"INFERENCE\") :PUBLIC? TRUE)")
    ...
    (STELLA::DEFINE-STELLA-GLOBAL-VARIABLE-FROM-STRINGIFIED-SOURCE "(DEFGLOBAL *LITERAL-CONCEPT* NAMED-DESCRIPTION NULL :PUBLIC? FALSE)")
    (STELLA::DEFINE-STELLA-GLOBAL-VARIABLE-FROM-STRINGIFIED-SOURCE "(DEFGLOBAL *STRING-CONCEPT* NAMED-DESCRIPTION NULL :PUBLIC? FALSE)")
    (STELLA::DEFINE-STELLA-GLOBAL-VARIABLE-FROM-STRINGIFIED-SOURCE "(DEFGLOBAL *INTEGER-CONCEPT* NAMED-DESCRIPTION NULL :PUBLIC? FALSE)")
    (STELLA::DEFINE-STELLA-GLOBAL-VARIABLE-FROM-STRINGIFIED-SOURCE "(DEFGLOBAL *FLOAT-CONCEPT* NAMED-DESCRIPTION NULL :PUBLIC? FALSE)")
    (CL:SETQ *LITERAL-CONCEPT* (S-GET-CONCEPT "LITERAL" "PL-USER" STELLA::NULL)) (CL:SETQ *STRING-CONCEPT* (S-GET-CONCEPT "STRING" "PL-USER" STELLA::NULL))
    (CL:SETQ *INTEGER-CONCEPT* (S-GET-CONCEPT "INTEGER" "PL-USER" STELLA::NULL)) (CL:SETQ *FLOAT-CONCEPT* (S-GET-CONCEPT "FLOAT" "PL-USER" STELLA::NULL)))))
