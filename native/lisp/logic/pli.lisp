...
(CL:DEFVAR SYM-PLI-PLI-QUERY-089 STELLA::NULL)
...
(CL:DEFVAR SGT-PLI-STELLA-SYMBOL STELLA::NULL)
...
(CL:DECLAIM
 (CL:SPECIAL STELLA::*STARTUP-TIME-PHASE* STELLA::UNKNOWN-TRUTH-VALUE
  STELLA::FALSE-TRUTH-VALUE STELLA::DEFAULT-FALSE-TRUTH-VALUE
  STELLA::STANDARD-OUTPUT STELLA::EOL STELLA::TRUE-TRUTH-VALUE
  STELLA::DEFAULT-TRUE-TRUTH-VALUE STELLA::*REVERSEPOLARITY?*
  STELLA::*CONTEXT* STELLA::*POWERLOOM-LOCK* STELLA::NULL-INTEGER
  STELLA::*MODULE* STELLA::NIL STELLA::FALSE STELLA::TRUE))
...
(CL:DEFUN NEW-PL-ITERATOR ()
  (CL:LET* ((SELF STELLA::NULL))
   ...
   (CL:SETF (STELLA::%FIRST-ITERATION? SELF) STELLA::TRUE)
...
elements are available, `false' otherwise."
  (CL:LET* ((CURSOR (STELLA::%CURSOR SELF)))
   (CL:WHEN (CL:EQ CURSOR STELLA::NIL)
    (CL:SETF (STELLA::%VALUE SELF) STELLA::NULL)
    (CL:RETURN-FROM STELLA::NEXT? STELLA::FALSE))
   (CL:SETF (STELLA::%VALUE SELF) (STELLA::%%VALUE CURSOR))
   (CL:SETF (STELLA::%CURSOR SELF) (STELLA::%%REST CURSOR)) STELLA::TRUE))
     ...
     (CL:LOOP WHILE (STELLA::NEXT? ITER-000) DO
      ...
      (CL:IF (CL:EQ COLLECT-000 STELLA::NULL)
       (CL:PROGN (CL:SETQ COLLECT-000 (STELLA::CONS X STELLA::NIL))
        (CL:IF (CL:EQ V-086 STELLA::NIL) (CL:SETQ V-086 COLLECT-000)
         (STELLA::ADD-CONS-TO-END-OF-CONS-LIST V-086 COLLECT-000)))
       (CL:PROGN
        (CL:SETF (STELLA::%%REST COLLECT-000) (STELLA::CONS X STELLA::NIL))
        (CL:SETQ COLLECT-000 (STELLA::%%REST COLLECT-000))))))
    (CL:SETF (STELLA::%THE-CONS-LIST SELF-000) V-086))
   (CL:LET* ((VALUE-000 SELF-000)) VALUE-000)))

;;; (DEFMETHOD (CONSIFY CONS) ...)

(CL:DEFMETHOD STELLA::CONSIFY ((SELF PL-ITERATOR))
  (CL:LET* ((V-087 STELLA::NIL))
   (CL:LET* ((X STELLA::NULL) (ITER-000 SELF) (COLLECT-000 STELLA::NULL))
    (CL:LOOP WHILE (STELLA::NEXT? ITER-000) DO
     (CL:SETQ X (STELLA::%VALUE ITER-000))
     (CL:IF (CL:EQ COLLECT-000 STELLA::NULL)
      (CL:PROGN (CL:SETQ COLLECT-000 (STELLA::CONS X STELLA::NIL))
       (CL:IF (CL:EQ V-087 STELLA::NIL) (CL:SETQ V-087 COLLECT-000)
        (STELLA::ADD-CONS-TO-END-OF-CONS-LIST V-087 COLLECT-000)))
      (CL:PROGN
       (CL:SETF (STELLA::%%REST COLLECT-000) (STELLA::CONS X STELLA::NIL))
       (CL:SETQ COLLECT-000 (STELLA::%%REST COLLECT-000))))))
   (CL:LET* ((VALUE-000 V-087)) VALUE-000)))
...
(CL:DEFUN SAFELY-GET-MODULE (NAME ENVIRONMENT)
  ...
  (CL:WHEN
   (CL:OR (CL:EQ NAME STELLA::NULL-STRING) (STELLA::STRING-EQL? NAME ""))
   (CL:RETURN-FROM SAFELY-GET-MODULE STELLA::*MODULE*))
  (STELLA::GET-STELLA-MODULE NAME STELLA::TRUE))
...
(CL:DEFUN EXPLODE-STRING-LIST (STRINGLIST MODULE)
  ...
  (CL:LET* ((STELLA::*MODULE* MODULE) (STELLA::*CONTEXT* STELLA::*MODULE*))
   ...
   (CL:LET*
    ...
    (CL:LET*
     ((REF STELLA::NULL) (ITER-000 EXPRESSION) (COLLECT-000 STELLA::NULL))
     (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-000 STELLA::NIL)) DO
      (CL:PROGN (CL:SETQ REF (STELLA::%%VALUE ITER-000))
      ...
      (CL:IF (CL:EQ COLLECT-000 STELLA::NULL)
       (CL:PROGN (CL:SETQ COLLECT-000 (STELLA::CONS TERM STELLA::NIL))
        (CL:IF (CL:EQ RESULT STELLA::NIL) (CL:SETQ RESULT COLLECT-000)
         (STELLA::ADD-CONS-TO-END-OF-CONS-LIST RESULT COLLECT-000)))
       (CL:PROGN
        (CL:SETF (STELLA::%%REST COLLECT-000) (STELLA::CONS TERM STELLA::NIL))
        (CL:SETQ COLLECT-000 (STELLA::%%REST COLLECT-000))))))
    RESULT)))
...
or visible from the module `module'."
  ...
  (CL:LET*
   ((CURRENTMODULE
     (CL:IF (CL:NOT (CL:EQ MODULE STELLA::NULL)) MODULE STELLA::*MODULE*)))
   (CL:WHEN
    (CL:NOT
     (CL:OR (STELLA::%CASE-SENSITIVE? CURRENTMODULE)
      (STELLA::ALL-UPPER-CASE-STRING? NAME)))
  ...
  (CL:LET* ((MDL-000 MODULE) (CXT-000 MDL-000))
   ...
   (CL:LET* ((STELLA::*MODULE* MDL-000) (STELLA::*CONTEXT* CXT-000))
    ...
    (STELLA::WITH-PROCESS-LOCK STELLA::*POWERLOOM-LOCK*
     (STELLA::GET-INSTANCE (STELLA::WRAP-STRING NAME))))))
...
or visible from the module `module'."
  ...
  (CL:LET* ((MDL-000 MODULE) (CXT-000 MDL-000))
   ...
   (CL:LET* ((STELLA::*MODULE* MDL-000) (STELLA::*CONTEXT* CXT-000))
    ...
    (CL:SETQ ENVIRONMENT ENVIRONMENT)
    (STELLA::WITH-PROCESS-LOCK STELLA::*POWERLOOM-LOCK*
     (STELLA::GET-CLASS (STELLA::WRAP-STRING NAME))))))
...
or visible from the module `module'."
  ...
  (CL:LET* ((MDL-000 MODULE) (CXT-000 MDL-000))
   ...
   (CL:LET* ((STELLA::*MODULE* MDL-000) (STELLA::*CONTEXT* CXT-000))
    ...
    (CL:SETQ ENVIRONMENT ENVIRONMENT)
    (STELLA::WITH-PROCESS-LOCK STELLA::*POWERLOOM-LOCK*
     (STELLA::GET-RELATION (STELLA::WRAP-STRING NAME))))))
...
(CL:DEFUN GET-NAME (OBJ)
  ...
  (CL:LET* ((TEST-VALUE-000 (STELLA::SAFE-PRIMARY-TYPE OBJ)))
   (CL:COND
    ...
    ((STELLA::SUBTYPE-OF? TEST-VALUE-000 SGT-PLI-STELLA-GENERALIZED-SYMBOL)
...
(CL:DEFUN OBJECT-TO-STRING (SELF)
  ...
  (CL:IF (CL:EQ SELF STELLA::NULL) STELLA::NULL-STRING
   (CL:LET* ((STELLA::*PRINTREADABLY?* STELLA::TRUE))
...
(CL:DECLAIM
 (CL:FTYPE (CL:FUNCTION (CL:T) CL:SIMPLE-STRING) OBJECT-TO-PARSABLE-STRING))
    ...
    (STELLA::WITH-PROCESS-LOCK STELLA::*POWERLOOM-LOCK*
     (CL:LET* ((OBJ (STELLA::READ-S-EXPRESSION-FROM-STRING STRING)))
      (CL:COND
       ...
       (CL:T
        (CL:COND
         ((CL:EQ TYPE STELLA::NULL) (GET-OBJECT STRING MODULE ENVIRONMENT))
         ...
         ((STELLA::SUBRELATION-OF? TYPE *LITERAL-CONCEPT*)
          (CL:LET* ((STREAM-002 (STELLA::NEW-OUTPUT-STRING-STREAM)))
           (STELLA::%%PRINT-STREAM (STELLA::%NATIVE-STREAM STREAM-002) "`"
            STRING "' is a non-literal, but `" TYPE "' is a subconcept of `"
            *LITERAL-CONCEPT* "'")
           (CL:ERROR
            (STELLA::NEW-PARSING-ERROR
...
(CL:DEFUN HELP-GET-TRUE-EXTENSION-MEMBERS (RELATION SPECIALIZE?)
  (CL:LET* ((V-088 STELLA::NIL))
   (CL:LET*
    ((P STELLA::NULL) (ITER-000 (STELLA::ALL-EXTENSION-MEMBERS RELATION))
     (COLLECT-000 STELLA::NULL))
    (CL:LOOP WHILE (STELLA::NEXT? ITER-000) DO
     ...
     (CL:WHEN
      ...
      (CL:IF (CL:EQ COLLECT-000 STELLA::NULL)
       (CL:PROGN (CL:SETQ COLLECT-000 (STELLA::CONS P STELLA::NIL))
        (CL:IF (CL:EQ V-088 STELLA::NIL) (CL:SETQ V-088 COLLECT-000)
         (STELLA::ADD-CONS-TO-END-OF-CONS-LIST V-088 COLLECT-000)))
       (CL:PROGN
        (CL:SETF (STELLA::%%REST COLLECT-000) (STELLA::CONS P STELLA::NIL))
        (CL:SETQ COLLECT-000 (STELLA::%%REST COLLECT-000)))))))
   (CL:LET* ((RESULT V-088))
    (CL:WHEN SPECIALIZE?
     (CL:LET*
      ((SUB STELLA::NULL) (ITER-001 (STELLA::ALL-SUBCOLLECTIONS RELATION)))
      (CL:LOOP WHILE (STELLA::NEXT? ITER-001) DO
       ...
       (CL:WHEN (STELLA::ISA? SUB SGT-PLI-LOGIC-NAMED-DESCRIPTION)
        (CL:LET*
         ((P STELLA::NULL) (ITER-002 (STELLA::ALL-EXTENSION-MEMBERS SUB)))
...
(CL:DEFUN HELP-GET-PROPOSITIONS (RELATION ARGUMENTS LIMIT MODULE ENVIRONMENT)
  ...
  (CL:LET* ((MDL-000 MODULE) (CXT-000 MDL-000))
   ...
   (CL:LET* ((STELLA::*MODULE* MDL-000) (STELLA::*CONTEXT* CXT-000))
    ...
    (CL:SETQ ENVIRONMENT ENVIRONMENT)
    (STELLA::WITH-PROCESS-LOCK STELLA::*POWERLOOM-LOCK*
     (CL:LET* ((SPECIALIZE? (CL:NOT (CL:EQ ENVIRONMENT ASSERTION-ENV))))
      (CL:LET* ((VALUE-000 STELLA::NULL))
       (CL:LET* ((ARG STELLA::NULL) (ITER-000 ARGUMENTS))
        (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-000 STELLA::NIL)) DO
         (CL:PROGN (CL:SETQ ARG (STELLA::%%VALUE ITER-000))
          (CL:SETQ ITER-000 (STELLA::%%REST ITER-000)))
         (CL:WHEN
       ...
       (CL:LET*
        ((ARGUMENTWITHBACKLINKS VALUE-000)
         (ITERATOR
          (CL:IF (CL:NOT (CL:EQ ARGUMENTWITHBACKLINKS STELLA::NULL))
           (STELLA::ALL-TRUE-DEPENDENT-PROPOSITIONS ARGUMENTWITHBACKLINKS
        ...
        (CL:LET* ((P STELLA::NULL) (ITER-001 ITERATOR))
         (CL:LOOP WHILE (STELLA::NEXT? ITER-001) DO
          ...
          (CL:LET* ((TEST-VALUE-000 STELLA::FALSE))
           (CL:LET* ((ALWAYS?-000 STELLA::TRUE))
            (CL:LET*
             ((ARG2 STELLA::NULL) (INPUTARG STELLA::NULL) (ITER-002 ARGUMENTS)
              (VECTOR-000 (STELLA::%ARGUMENTS P)) (INDEX-000 0)
             ...
             (CL:LOOP WHILE
              ...
              DO
              (CL:PROGN (CL:SETQ INPUTARG (STELLA::%%VALUE ITER-002))
               (CL:SETQ ITER-002 (STELLA::%%REST ITER-002)))
              (CL:PROGN
               (CL:SETQ ARG2
                (CL:AREF
                 (CL:THE CL:SIMPLE-VECTOR (STELLA::%THE-ARRAY VECTOR-000))
                 INDEX-000))
              ...
              (CL:WHEN
               ...
               (CL:SETQ ALWAYS?-000 STELLA::FALSE) (CL:RETURN))))
            (CL:SETQ TEST-VALUE-000 ALWAYS?-000))
           (CL:WHEN TEST-VALUE-000
            (CL:SETQ TEST-VALUE-000
             (CL:= (STELLA::LENGTH ARGUMENTS)
              (STELLA::LENGTH (STELLA::%ARGUMENTS P)))))
           (CL:WHEN TEST-VALUE-000 (CL:SETQ RESULTS (STELLA::CONS P RESULTS))
...
relations or functions."
  (CL:LET*
   ((LIST (SEQUENCE-TO-CONS-LIST RELATION-AND-ARGUMENTS))
    (RELATION (STELLA::%%VALUE LIST)) (ARGUMENTS (STELLA::%%REST LIST)))
   (STELLA::%%VALUE
      ...
      (CL:IF (CL:NOT (CL:EQ ARGUMENTWITHBACKLINKS STELLA::NULL))
       (CL:LET*
        ((P STELLA::NULL)
         (ITER-000
          (STELLA::ALL-TRUE-DEPENDENT-PROPOSITIONS ARGUMENTWITHBACKLINKS
           (STELLA::%SURROGATE-VALUE-INVERSE RELATION) STELLA::FALSE)))
        (CL:LOOP WHILE (STELLA::NEXT? ITER-000) DO
         (CL:SETQ P (STELLA::%VALUE ITER-000))
         (CL:WHEN
          (CL:AND
...
may be set to NULL, which is interpreted as a wildcard."
  (CONS-TO-PL-ITERATOR
   (HELP-GET-PROPOSITIONS RELATION (STELLA::CONS-LIST ARG1 ARG2) 0 MODULE
    ENVIRONMENT)))
...
and that are TRUE in the scope of the module `module'."
  (CL:LET* ((MDL-000 MODULE) (CXT-000 MDL-000))
   ...
   (CL:LET* ((STELLA::*MODULE* MDL-000) (STELLA::*CONTEXT* CXT-000))
    ...
    (STELLA::WITH-PROCESS-LOCK STELLA::*POWERLOOM-LOCK*
     (LIST-TO-PL-ITERATOR
      (STELLA::ALL-FACTS-OF-INSTANCE OBJECT STELLA::FALSE STELLA::FALSE))))))
  ...
  (CL:LET* ((MDL-000 MODULE) (CXT-000 MDL-000))
   ...
   (CL:LET* ((STELLA::*MODULE* MDL-000) (STELLA::*CONTEXT* CXT-000))
    ...
    (STELLA::WITH-PROCESS-LOCK STELLA::*POWERLOOM-LOCK*
     (CONS-TO-PL-ITERATOR
      (STELLA::CONSIFY
       (STELLA::ALL-PROPOSITIONS STELLA::*MODULE* STELLA::TRUE)))))))
...
been asserted (or inferred by forward chaining)."
  (CL:NOT
   (CL:EQ (GET-BINARY-PROPOSITION RELATION ARG VALUE MODULE ENVIRONMENT)
    STELLA::NULL)))
...
been asserted (or inferred by forward chaining)."
  (CL:LET*
   ((LIST (SEQUENCE-TO-CONS-LIST RELATION-AND-ARGUMENTS))
    (RELATION (STELLA::%%VALUE LIST)) (ARGUMENTS (STELLA::%%REST LIST)))
   (CL:NOT
    (CL:EQ (HELP-GET-PROPOSITIONS RELATION ARGUMENTS 1 MODULE ENVIRONMENT)
     STELLA::NULL))))
...
`relation-and-arguments' is true in the module named `module-name'."
  ...
  (CL:CHECK-TYPE MODULE-NAME CL:SIMPLE-STRING)
  (CL:NOT
   (CL:EQ (S-GET-PROPOSITION RELATION-AND-ARGUMENTS MODULE-NAME ENVIRONMENT)
    STELLA::NULL)))
...
(CL:DEFUN IS-SUBRELATION (SUB SUPER MODULE ENVIRONMENT)
  ...
  (CL:WHEN (CL:OR (CL:EQ SUB STELLA::NULL) (CL:EQ SUPER STELLA::NULL))
   (CL:RETURN-FROM IS-SUBRELATION STELLA::FALSE))
  (CL:LET* ((MDL-000 MODULE) (CXT-000 MDL-000))
   (CL:WHEN (CL:EQ MDL-000 STELLA::NULL) (CL:SETQ MDL-000 STELLA::*MODULE*)
    (CL:SETQ CXT-000 STELLA::*CONTEXT*))
   (CL:LET* ((STELLA::*MODULE* MDL-000) (STELLA::*CONTEXT* CXT-000))
...
Non-reflexive."
  (CL:LET* ((MDL-000 MODULE) (CXT-000 MDL-000))
   ...
   (CL:LET* ((STELLA::*MODULE* MDL-000) (STELLA::*CONTEXT* CXT-000))
    ...
    (CL:SETQ ENVIRONMENT ENVIRONMENT)
    (STELLA::WITH-PROCESS-LOCK STELLA::*POWERLOOM-LOCK*
     (CONS-TO-PL-ITERATOR (STELLA::ALL-SUBRELATIONS RELATION STELLA::TRUE))))))
...
Non-reflexive."
  (CL:LET* ((MDL-000 MODULE) (CXT-000 MDL-000))
   ...
   (CL:LET* ((STELLA::*MODULE* MDL-000) (STELLA::*CONTEXT* CXT-000))
    ...
    (STELLA::WITH-PROCESS-LOCK STELLA::*POWERLOOM-LOCK*
     (CONS-TO-PL-ITERATOR
      (STELLA::ALL-DIRECT-SUBRELATIONS RELATION STELLA::TRUE))))))
...
Non-reflexive."
  (CL:LET* ((MDL-000 MODULE) (CXT-000 MDL-000))
   ...
   (CL:LET* ((STELLA::*MODULE* MDL-000) (STELLA::*CONTEXT* CXT-000))
    ...
    (STELLA::WITH-PROCESS-LOCK STELLA::*POWERLOOM-LOCK*
     (CONS-TO-PL-ITERATOR
      (STELLA::ALL-SUPERRELATIONS RELATION STELLA::TRUE))))))
...
Non-reflexive."
  (CL:LET* ((MDL-000 MODULE) (CXT-000 MDL-000))
   ...
   (CL:LET* ((STELLA::*MODULE* MDL-000) (STELLA::*CONTEXT* CXT-000))
    ...
    (STELLA::WITH-PROCESS-LOCK STELLA::*POWERLOOM-LOCK*
     (CONS-TO-PL-ITERATOR
      (STELLA::ALL-DIRECT-SUPERRELATIONS RELATION STELLA::TRUE))))))
    ...
    (STELLA::WITH-PROCESS-LOCK STELLA::*POWERLOOM-LOCK*
     (LIST-TO-PL-ITERATOR
      (STELLA::REMOVE-DELETED-MEMBERS
       (STELLA::ASSERTED-COLLECTION-MEMBERS CONCEPT STELLA::FALSE)))))))
...
the return values could be (wrapped) literals."
  ...
  (CL:LET*
   ...
   (CL:IF (CL:NOT (CL:EQ CONCEPT STELLA::NULL))
    (GET-CONCEPT-INSTANCES CONCEPT MODULE ENVIRONMENT) EMPTY-PL-ITERATOR)))
...
the return values could be (wrapped) literals."
  (CL:LET* ((MDL-000 MODULE) (CXT-000 MDL-000))
   ...
   (CL:LET* ((STELLA::*MODULE* MDL-000) (STELLA::*CONTEXT* CXT-000))
    ...
    (STELLA::WITH-PROCESS-LOCK STELLA::*POWERLOOM-LOCK*
     (LIST-TO-PL-ITERATOR
      (STELLA::ASSERTED-COLLECTION-MEMBERS CONCEPT STELLA::TRUE))))))
     ...
     (CL:LET*
      ...
      (CL:LET* ((I STELLA::NULL) (ITER-000 INSTANCES))
       (CL:LOOP WHILE (STELLA::NEXT? ITER-000) DO
        ...
        (CL:WHEN
         (IS-TRUE-BINARY-PROPOSITION RELATION I VALUE MODULE ENVIRONMENT)
  ...
  (CL:LET*
   ...
   (CL:LET* ((D STELLA::NULL) (ITER-000 DIRECTTYPES))
    (CL:LOOP WHILE (STELLA::NEXT? ITER-000) DO
     ...
     (CL:LET* ((C STELLA::NULL) (ITER-001 (STELLA::ALL-SUPERCOLLECTIONS D)))
      (CL:LOOP WHILE (STELLA::NEXT? ITER-001) DO
       ...
       (CL:LOOP WHILE (STELLA::NEXT? ITER-000) DO
        ...
        (CL:WHEN (CL:EQ (STELLA::%KIND PROP) KWD-PLI-ISA)
         (CL:SETQ DERIVABLETYPES
          (STELLA::CONS (GET-NTH-VALUE PROP 0) DERIVABLETYPES)))))
      (CONS-TO-PL-ITERATOR
...
Include propositions that satisfy subrelations of `relation'."
  (CL:LET* ((MDL-000 MODULE) (CXT-000 MDL-000))
   ...
   (CL:LET* ((STELLA::*MODULE* MDL-000) (STELLA::*CONTEXT* CXT-000))
    ...
    (STELLA::WITH-PROCESS-LOCK STELLA::*POWERLOOM-LOCK*
     (CONS-TO-PL-ITERATOR
      (HELP-GET-TRUE-EXTENSION-MEMBERS RELATION STELLA::TRUE))))))
...
`relation-name'.  Include propositions that satisfy subrelations of the relation."
  ...
  (CL:LET* ((RELATION (SAFELY-GET-RELATION RELATION-NAME MODULE ENVIRONMENT)))
   (CL:IF (CL:NOT (CL:EQ RELATION STELLA::NULL))
    (GET-RELATION-EXTENSION RELATION MODULE ENVIRONMENT) EMPTY-PL-ITERATOR)))
...
(CL:DEFUN GET-MODULE (NAME ENVIRONMENT)
  ...
  (CL:CHECK-TYPE NAME CL:SIMPLE-STRING)
  (CL:SETQ ENVIRONMENT ENVIRONMENT)
  (STELLA::GET-STELLA-MODULE NAME STELLA::FALSE))
...
the current module is returned."
  ...
  (STELLA::CHANGE-CONTEXT MODULE))

;;; (DEFUN (S-CHANGE-MODULE OBJECT) ...)
...
cannot be performed, in which case the current module is returned."
  ...
  (CL:LET* ((MODULE (SAFELY-GET-MODULE NAME ENVIRONMENT)))
   (CL:IF (CL:NOT (CL:EQ MODULE STELLA::NULL)) (STELLA::CHANGE-CONTEXT MODULE)
    STELLA::*MODULE*)))
...
(CL:DEFUN GET-CHILD-MODULES (MODULE)
  ...
  (CL:LET* ((DIRECTSUBMODULES STELLA::NIL))
   (CL:LET*
    ((CHILD STELLA::NULL)
     (ITER-000 (STELLA::%THE-CONS-LIST (STELLA::%CHILD-CONTEXTS MODULE)))
     (COLLECT-000 STELLA::NULL))
    (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-000 STELLA::NIL)) DO
     (CL:PROGN (CL:SETQ CHILD (STELLA::%%VALUE ITER-000))
      (CL:SETQ ITER-000 (STELLA::%%REST ITER-000)))
...
(CL:DEFUN GET-MODULES ()
  "Return all modules currently loaded into PowerLoom."
  (CL:LET* ((V-090 STELLA::NIL))
   (CL:LET*
    ((M STELLA::NULL) (ITER-000 (STELLA::ALL-MODULES))
     (COLLECT-000 STELLA::NULL))
    (CL:LOOP WHILE (STELLA::NEXT? ITER-000) DO
     (CL:SETQ M (STELLA::%VALUE ITER-000))
     (CL:IF (CL:EQ COLLECT-000 STELLA::NULL)
      (CL:PROGN (CL:SETQ COLLECT-000 (STELLA::CONS M STELLA::NIL))
       (CL:IF (CL:EQ V-090 STELLA::NIL) (CL:SETQ V-090 COLLECT-000)
        (STELLA::ADD-CONS-TO-END-OF-CONS-LIST V-090 COLLECT-000)))
      (CL:PROGN
       (CL:SETF (STELLA::%%REST COLLECT-000) (STELLA::CONS M STELLA::NIL))
       (CL:SETQ COLLECT-000 (STELLA::%%REST COLLECT-000))))))
   (CL:LET* ((MODULES V-090)) (CONS-TO-PL-ITERATOR MODULES))))
...
Return the object."
  ...
  (CL:LET* ((MDL-000 MODULE) (CXT-000 MDL-000))
   ...
   (CL:LET* ((STELLA::*MODULE* MDL-000) (STELLA::*CONTEXT* CXT-000))
    ...
    (CL:SETQ ENVIRONMENT ENVIRONMENT)
    (STELLA::WITH-PROCESS-LOCK STELLA::*POWERLOOM-LOCK*
     (CL:LET* ((OBJECT STELLA::NULL))
      (CL:COND
       ((CL:NOT (CL:EQ NAME STELLA::NULL-STRING))
        (CL:SETQ OBJECT
         (STELLA::CREATE-LOGIC-INSTANCE (STELLA::INTERN-SURROGATE NAME)
          STELLA::NULL)))
       ((CL:NOT (CL:EQ CONCEPT STELLA::NULL))
        (CL:SETQ OBJECT
         (STELLA::CREATE-LOGIC-INSTANCE
          (STELLA::INTERN-SURROGATE
           (GENERATE-UNIQUE-NAME (GET-NAME CONCEPT) STELLA::NULL
            STELLA::NULL))
          STELLA::NULL)))
       (CL:T
        (CL:SETQ OBJECT
      ...
      (CL:WHEN (CL:NOT (CL:EQ CONCEPT STELLA::NULL))
       (CL:IF
        (CL:NOT
         (CL:EQ (ASSERT-UNARY-PROPOSITION CONCEPT OBJECT MODULE ENVIRONMENT)
          STELLA::NULL))
...
Return the object."
  ...
  (CL:LET* ((MODULE (SAFELY-GET-MODULE MODULE-NAME ENVIRONMENT)))
   (CREATE-OBJECT NAME (SAFELY-GET-CONCEPT CONCEPT-NAME MODULE ENVIRONMENT)
    MODULE ENVIRONMENT)))
   ...
   (CL:LET* ((STELLA::*MODULE* MDL-000) (STELLA::*CONTEXT* CXT-000))
    ...
    (STELLA::WITH-PROCESS-LOCK STELLA::*POWERLOOM-LOCK*
     (STELLA::CALL-DEFCONCEPT
      (STELLA::CONS (STELLA::INTERN-SYMBOL NAME)
       (STELLA::CONCATENATE
...
created separately."
  ...
  (CL:CHECK-TYPE MODULE-NAME CL:SIMPLE-STRING)
  (CL:LET* ((MODULE (SAFELY-GET-MODULE MODULE-NAME ENVIRONMENT)))
   (CREATE-CONCEPT NAME (SAFELY-GET-CONCEPT PARENT-NAME MODULE ENVIRONMENT)
    MODULE ENVIRONMENT)))
...
of `nth-domain' (or `domain' and `range') relations."
  ...
  (CL:WHEN (CL:<= ARITY 0)
   (CL:LET* ((STREAM-000 (STELLA::NEW-OUTPUT-STRING-STREAM)))
    ...
    (CL:ERROR
     (STELLA::NEW-PARSING-ERROR (STELLA::THE-STRING-READER STREAM-000)))))
  (CL:LET* ((ARGS STELLA::NIL))
   (CL:LET* ((MDL-000 MODULE) (CXT-000 MDL-000))
    ...
    (CL:LET* ((STELLA::*MODULE* MDL-000) (STELLA::*CONTEXT* CXT-000))
     ...
     (STELLA::WITH-PROCESS-LOCK STELLA::*POWERLOOM-LOCK*
      (CL:LET*
       ((I STELLA::NULL-INTEGER) (ITER-000 0) (UPPER-BOUND-000 (CL:1- ARITY))
        (COLLECT-000 STELLA::NULL))
       (CL:DECLARE (CL:TYPE CL:FIXNUM ITER-000 UPPER-BOUND-000 I))
       (CL:LOOP WHILE (CL:<= ITER-000 UPPER-BOUND-000) DO
        (CL:PROGN (CL:SETQ I ITER-000) (CL:SETQ ITER-000 (CL:1+ ITER-000)))
        (CL:IF (CL:EQ COLLECT-000 STELLA::NULL)
         (CL:PROGN
          (CL:SETQ COLLECT-000
           (STELLA::CONS
            (STELLA::YIELD-SYSTEM-DEFINED-PARAMETER-NAME I STELLA::*MODULE*)
            STELLA::NIL))
...
of `nth-domain' (or `domain' and `range') relations."
  ...
  #+MCL
  (CL:CHECK-TYPE MODULE-NAME CL:SIMPLE-STRING)
  (CREATE-RELATION NAME ARITY (SAFELY-GET-MODULE MODULE-NAME ENVIRONMENT)
   ENVIRONMENT))
...
`domain', `nth-domain' and `range' relations."
  ...
  #+MCL
  (CL:CHECK-TYPE MODULE-NAME CL:SIMPLE-STRING)
  (CREATE-FUNCTION NAME ARITY (SAFELY-GET-MODULE MODULE-NAME ENVIRONMENT)
   ENVIRONMENT))

;;; (DEFUN (CREATE-ENUMERATED-LIST LOGIC-OBJECT) ...)

(CL:DEFUN CREATE-ENUMERATED-LIST (MEMBERS)
...
(CL:DEFUN CREATE-ENUMERATED-SET (MEMBERS)
...
in `module'.  Return the asserted proposition."
  (CL:LET* ((MDL-000 MODULE) (CXT-000 MDL-000))
   ...
   (CL:LET* ((STELLA::*MODULE* MDL-000) (STELLA::*CONTEXT* CXT-000))
    ...
    (CL:SETQ ENVIRONMENT ENVIRONMENT)
    (STELLA::WITH-PROCESS-LOCK STELLA::*POWERLOOM-LOCK*
     (STELLA::ASSERT-BINARY-VALUE (STELLA::%SURROGATE-VALUE-INVERSE RELATION)
      ARG VALUE)))))
...
in `module'.  Return the asserted proposition."
  (CL:LET* ((MDL-000 MODULE) (CXT-000 MDL-000))
   ...
   (CL:LET* ((STELLA::*MODULE* MDL-000) (STELLA::*CONTEXT* CXT-000))
    ...
    (CL:SETQ ENVIRONMENT ENVIRONMENT)
    (STELLA::WITH-PROCESS-LOCK STELLA::*POWERLOOM-LOCK*
     (STELLA::RETRACT-BINARY-VALUE (STELLA::%SURROGATE-VALUE-INVERSE RELATION)
      ARG VALUE)))))
...
Return the retracted proposition."
  (CL:LET* ((MDL-000 MODULE) (CXT-000 MDL-000))
   ...
   (CL:LET* ((STELLA::*MODULE* MDL-000) (STELLA::*CONTEXT* CXT-000))
    ...
    (CL:SETQ ENVIRONMENT ENVIRONMENT)
    (STELLA::WITH-PROCESS-LOCK STELLA::*POWERLOOM-LOCK*
     (STELLA::UPDATE-PROPOSITION-TRUTH-VALUE PROPOSITION KWD-PLI-RETRACT-TRUE)
     PROPOSITION))))
    ...
    (CL:LET* ((STELLA::*MODULE* MDL-000) (STELLA::*CONTEXT* CXT-000))
     ...
     (STELLA::WITH-PROCESS-LOCK STELLA::*POWERLOOM-LOCK*
      ...
      (CL:LET* ((PROPOSITION STELLA::NULL) (ITER-000 PROPOSITIONS))
       (CL:LOOP WHILE (STELLA::NEXT? ITER-000) DO
        (CL:SETQ PROPOSITION (STELLA::%VALUE ITER-000))
        (STELLA::UPDATE-PROPOSITION-TRUTH-VALUE PROPOSITION
         KWD-PLI-RETRACT-TRUE)))
      RETURN-VALUE)))))
       ...
       (CL:LET* ((TEST-VALUE-000 (STELLA::SAFE-PRIMARY-TYPE PROPOSITIONS)))
        (CL:COND
         ((STELLA::SUBTYPE-OF? TEST-VALUE-000 SGT-PLI-LOGIC-PROPOSITION)
          (CL:PROGN
           (CONS-TO-PL-ITERATOR (STELLA::CONS PROPOSITIONS STELLA::NIL))))
...
(CL:DEFUN S-PRINT-RULES (NAME STREAM MODULE-NAME ENVIRONMENT)
  ...
  (CL:LET*
   ((RULE STELLA::NULL) (ITER-000 (S-GET-RULES NAME MODULE-NAME ENVIRONMENT)))
   (CL:LOOP WHILE (STELLA::NEXT? ITER-000) DO
...
relation `relation'.  Counting starts at zero."
  ...
  (CL:IF (STELLA::CLASS? RELATION) (CL:IF (CL:= N 0) RELATION STELLA::NULL)
   (CL:COND
    ((STELLA::SUBTYPE-OF? (STELLA::SAFE-PRIMARY-TYPE RELATION)
      SGT-PLI-LOGIC-NAMED-DESCRIPTION)
     (CL:PROGN
      (CL:IF
       (CL:AND (CL:>= N 0)
        (CL:< N (STELLA::LENGTH (STELLA::%IO-VARIABLE-TYPES RELATION))))
       (CL:LET*
        ((TYPE
...
named `relation-name'.  Counting starts at zero."
  ...
  (CL:LET*
   ((MODULE (SAFELY-GET-MODULE MODULE-NAME ENVIRONMENT))
    (RELATION (SAFELY-GET-RELATION RELATION-NAME MODULE ENVIRONMENT)))
   (CL:IF (CL:NOT (CL:EQ RELATION STELLA::NULL)) (GET-NTH-DOMAIN RELATION N)
    STELLA::NULL)))

;;; (DEFUN LOAD ...)

(CL:DEFUN LOAD (FILENAME)
...
value of `ifexists'.  Possible values are \"ASK\", \"REPLACE\", \"WARN\" and \"ERROR\":
  ...
  (CL:LET* ((EXISTS? (STELLA::PROBE-FILE? FILENAME)))
   (CL:COND
    ((CL:OR (CL:NOT EXISTS?) (STELLA::STRING-EQUAL? IFEXISTS "REPLACE")))
    ((STELLA::STRING-EQUAL? IFEXISTS "ASK")
     (CL:WHEN
      ...
      (CL:LET* ((STREAM-000 (STELLA::NEW-OUTPUT-STRING-STREAM)))
       (STELLA::%%PRINT-STREAM (STELLA::%NATIVE-STREAM STREAM-000) "File `"
    ...
    ((STELLA::STRING-EQUAL? IFEXISTS "ERROR")
     (CL:LET* ((STREAM-001 (STELLA::NEW-OUTPUT-STRING-STREAM)))
      (STELLA::%%PRINT-STREAM (STELLA::%NATIVE-STREAM STREAM-001) "File `"
       FILENAME "' already exists.")
      (CL:ERROR
       (STELLA::NEW-STELLA-EXCEPTION
        (STELLA::THE-STRING-READER STREAM-001)))))
    ...
    (CL:LET* ((STELLA::*MODULE* MDL-000) (STELLA::*CONTEXT* CXT-000))
     ...
     (STELLA::WITH-PROCESS-LOCK STELLA::*POWERLOOM-LOCK*
      (CL:LET* ((STREAM STELLA::NULL))
       (CL:UNWIND-PROTECT
        (CL:PROGN (CL:SETQ STREAM (STELLA::NEW-OUTPUT-FILE-STREAM FILENAME))
...
value of `ifexists'.  Possible values are \"ASK\", \"REPLACE\", \"WARN\" and \"ERROR\":
  ...
  #+MCL
  (CL:CHECK-TYPE IFEXISTS CL:SIMPLE-STRING)
  (SAVE-MODULE (SAFELY-GET-MODULE MODULE-NAME ENVIRONMENT) FILENAME IFEXISTS
   ENVIRONMENT))
...
the proposition `prop'."
  (CL:LET* ((RELATION (STELLA::GET-DESCRIPTION (STELLA::%OPERATOR PROP))))
   (CL:WHEN (CL:EQ RELATION STELLA::NULL)
    (CL:SETQ RELATION (STELLA::%SURROGATE-VALUE (STELLA::%OPERATOR PROP))))
   RELATION))
...
(CL:DEFUN GET-NTH-VALUE (SEQUENCE N)
...
is for the current value of the iterator."
  ...
  (CL:WHEN (CL:OR (CL:>= N (GET-COLUMN-COUNT SEQUENCE)) (CL:< N 0))
   (CL:LET* ((STREAM-000 (STELLA::NEW-OUTPUT-STRING-STREAM)))
    ...
    (CL:ERROR
     (STELLA::NEW-LOGIC-EXCEPTION (STELLA::THE-STRING-READER STREAM-000)))))
  (CL:LET* ((TEST-VALUE-000 (STELLA::SAFE-PRIMARY-TYPE SEQUENCE)))
   (CL:COND
    ((STELLA::SUBTYPE-OF? TEST-VALUE-000 SGT-PLI-LOGIC-PROPOSITION)
     (CL:PROGN
    ...
    ((STELLA::SUBTYPE-OF? TEST-VALUE-000 SGT-PLI-PLI-PL-ITERATOR)
     (CL:PROGN (GET-NTH-VALUE (STELLA::%VALUE SEQUENCE) N)))
    ((CL:EQ TEST-VALUE-000 SGT-PLI-STELLA-CONS)
     (CL:PROGN (STELLA::NTH SEQUENCE N)))
    ((STELLA::SUBTYPE-OF? TEST-VALUE-000 SGT-PLI-STELLA-VECTOR)
     (CL:PROGN
      (CL:AREF (CL:THE CL:SIMPLE-VECTOR (STELLA::%THE-ARRAY SEQUENCE)) N)))
    (CL:T
     (CL:LET* ((STREAM-001 (STELLA::NEW-OUTPUT-STRING-STREAM)))
      (STELLA::%%PRINT-STREAM (STELLA::%NATIVE-STREAM STREAM-001) "`"
       TEST-VALUE-000 "' is not a valid case option")
...
(CL:DEFUN GET-NTH-STRING (SEQUENCE N)
...
string reprensentation will be returned."
  ...
  #+MCL
  (CL:CHECK-TYPE N CL:FIXNUM)
  (OBJECT-TO-STRING (GET-NTH-VALUE SEQUENCE N)))
(CL:DECLAIM
 (CL:FTYPE (CL:FUNCTION (CL:T CL:FIXNUM) CL:SIMPLE-STRING) GET-NTH-STRING))

;;; (DEFUN (GET-NTH-INTEGER INTEGER) ...)

(CL:DEFUN GET-NTH-INTEGER (SEQUENCE N)
...
an integer value, then NULL-INTEGER will be returned."
  ...
  #+MCL
  (CL:CHECK-TYPE N CL:FIXNUM)
  (OBJECT-TO-INTEGER (GET-NTH-VALUE SEQUENCE N)))
(CL:DECLAIM
 (CL:FTYPE (CL:FUNCTION (CL:T CL:FIXNUM) CL:FIXNUM) GET-NTH-INTEGER))

;;; (DEFUN (GET-NTH-FLOAT FLOAT) ...)

(CL:DEFUN GET-NTH-FLOAT (SEQUENCE N)
...
a floating point value, then NULL-FLOAT will be returned."
  ...
  #+MCL
  (CL:CHECK-TYPE N CL:FIXNUM)
  (OBJECT-TO-FLOAT (GET-NTH-VALUE SEQUENCE N)))
(CL:DECLAIM
 (CL:FTYPE (CL:FUNCTION (CL:T CL:FIXNUM) CL:DOUBLE-FLOAT) GET-NTH-FLOAT))

;;; (DEFUN (GET-NTH-LOGIC-OBJECT LOGIC-OBJECT) ...)

(CL:DEFUN GET-NTH-LOGIC-OBJECT (SEQUENCE N)
...
returns the proposition's relational predicate."
  ...
  #+MCL
  (CL:CHECK-TYPE N CL:FIXNUM)
  (CL:LET* ((VALUE (GET-NTH-VALUE SEQUENCE N)))
   (CL:IF (STELLA::ISA? VALUE SGT-PLI-LOGIC-LOGIC-OBJECT) VALUE STELLA::NULL)))

;;; (DEFUN (GET-ENUMERATED-COLLECTION-MEMBERS CONS) ...)

(CL:DEFUN GET-ENUMERATED-COLLECTION-MEMBERS (COLLECTION)
...
of collection, i.e., sets and lists"
  (STELLA::%THE-CONS-LIST
   (STELLA::ASSERTED-COLLECTION-MEMBERS COLLECTION STELLA::TRUE)))
...
helping functions `is-true', `is-false' , `is-unknown'."
  (CL:LET* ((MDL-000 MODULE) (CXT-000 MDL-000))
   ...
   (CL:LET* ((STELLA::*MODULE* MDL-000) (STELLA::*CONTEXT* CXT-000))
    ...
    (CL:SETQ ENVIRONMENT ENVIRONMENT)
    (STELLA::WITH-PROCESS-LOCK STELLA::*POWERLOOM-LOCK*
     (CL:WHEN (STELLA::ISA? (STELLA::%%VALUE QUERY) SGT-PLI-STELLA-SYMBOL)
...
helping functions `is-true', `is-false' , `is-unknown'."
  ...
  #+MCL
  (CL:CHECK-TYPE MODULE-NAME CL:SIMPLE-STRING)
  (CL:LET* ((QUERYFORM STELLA::NIL))
   (CL:LET*
    ((SEXP STELLA::NULL)
     (ITER-000
      (STELLA::S-EXPRESSIONS (STELLA::NEW-INPUT-STRING-STREAM QUERY)))
     (COLLECT-000 STELLA::NULL))
    (CL:LOOP WHILE (STELLA::NEXT? ITER-000) DO
     ...
     (CL:IF (CL:EQ COLLECT-000 STELLA::NULL)
      ...
      (CL:PROGN
       (CL:SETF (STELLA::%%REST COLLECT-000) (STELLA::CONS SEXP STELLA::NIL))
       (CL:SETQ COLLECT-000 (STELLA::%%REST COLLECT-000))))))
   (CL:WHEN
    (CL:AND
     (CL:OR (CL:EQ (STELLA::%%REST QUERYFORM) STELLA::NULL)
      (CL:EQ (STELLA::%%REST QUERYFORM) STELLA::NIL))
     (CL:NOT
      (STELLA::ISA? (STELLA::%%VALUE (STELLA::%%VALUE QUERYFORM))
       SGT-PLI-STELLA-SYMBOL)))
    (CL:SETQ QUERYFORM (STELLA::%%VALUE QUERYFORM)))
...
using the `get-nth-'... functions."
  (CL:LET* ((MDL-000 MODULE) (CXT-000 MDL-000))
   ...
   (CL:LET* ((STELLA::*MODULE* MDL-000) (STELLA::*CONTEXT* CXT-000))
    ...
    (STELLA::WITH-PROCESS-LOCK STELLA::*POWERLOOM-LOCK*
     (CONS-TO-PL-ITERATOR
      (STELLA::CONSIFY-CURRENT-SOLUTIONS (STELLA::CALL-RETRIEVE QUERY)))))))
  ...
  (CL:LET* ((QUERYFORM STELLA::NIL))
   ...
   (CL:WHEN
    (CL:OR (CL:EQ (STELLA::%%REST QUERYFORM) STELLA::NULL)
     (CL:EQ (STELLA::%%REST QUERYFORM) STELLA::NIL))
    (CL:SETQ QUERYFORM (STELLA::%%VALUE QUERYFORM)))
   (RETRIEVE QUERYFORM (SAFELY-GET-MODULE MODULE-NAME ENVIRONMENT)
    ENVIRONMENT)))

;;; (DEFUN MAIN ...)

(CL:DEFUN STELLA::MAIN ()
...
(CL:DEFUN HELP-STARTUP-PLI1 ()
  (CL:PROGN
   (CL:SETQ SGT-PLI-PLI-ENVIRONMENT
    (STELLA::INTERN-RIGID-SYMBOL-WRT-MODULE "ENVIRONMENT" STELLA::NULL 1))
   (CL:SETQ SYM-PLI-LOGIC-LEVEL
    (STELLA::INTERN-RIGID-SYMBOL-WRT-MODULE "LEVEL"
     (STELLA::GET-STELLA-MODULE "/LOGIC" STELLA::TRUE) 0))
   (CL:SETQ SGT-PLI-PLI-PL-ITERATOR
    (STELLA::INTERN-RIGID-SYMBOL-WRT-MODULE "PL-ITERATOR" STELLA::NULL 1))
   (CL:SETQ SYM-PLI-STELLA-CURSOR
    (STELLA::INTERN-RIGID-SYMBOL-WRT-MODULE "CURSOR"
     (STELLA::GET-STELLA-MODULE "/STELLA" STELLA::TRUE) 0))
   (CL:SETQ SGT-PLI-STELLA-CONS
    (STELLA::INTERN-RIGID-SYMBOL-WRT-MODULE "CONS"
     (STELLA::GET-STELLA-MODULE "/STELLA" STELLA::TRUE) 1))
   ...
   (CL:SETQ SGT-PLI-LOGIC-SKOLEM
    (STELLA::INTERN-RIGID-SYMBOL-WRT-MODULE "SKOLEM"
     (STELLA::GET-STELLA-MODULE "/LOGIC" STELLA::TRUE) 1))
   ...
   (CL:SETQ SYM-PLI-PLI-QUERY-089
    (STELLA::INTERN-RIGID-SYMBOL-WRT-MODULE "QUERY-089" STELLA::NULL 0))
   (CL:SETQ KWD-PLI-ISA
   ...
   (CL:SETQ KWD-PLI-SUBSET-OF
    (STELLA::INTERN-RIGID-SYMBOL-WRT-MODULE "SUBSET-OF" STELLA::NULL 2))
   (CL:SETQ KWD-PLI-ERROR
    (STELLA::INTERN-RIGID-SYMBOL-WRT-MODULE "ERROR" STELLA::NULL 2))
   (CL:SETQ KWD-PLI-RETRACT-TRUE
    (STELLA::INTERN-RIGID-SYMBOL-WRT-MODULE "RETRACT-TRUE" STELLA::NULL 2))
   (CL:SETQ KWD-PLI-ASSERT-TRUE
    (STELLA::INTERN-RIGID-SYMBOL-WRT-MODULE "ASSERT-TRUE" STELLA::NULL 2))
   ...
   (CL:SETQ SGT-PLI-STELLA-STRING-WRAPPER
    (STELLA::INTERN-RIGID-SYMBOL-WRT-MODULE "STRING-WRAPPER"
     (STELLA::GET-STELLA-MODULE "/STELLA" STELLA::TRUE) 1))
   (CL:SETQ SGT-PLI-STELLA-SYMBOL
    (STELLA::INTERN-RIGID-SYMBOL-WRT-MODULE "SYMBOL"
     (STELLA::GET-STELLA-MODULE "/STELLA" STELLA::TRUE) 1))
   (CL:SETQ SYM-PLI-PLI-STARTUP-PLI
    (STELLA::INTERN-RIGID-SYMBOL-WRT-MODULE "STARTUP-PLI" STELLA::NULL 0))
...
(CL:DEFUN HELP-STARTUP-PLI2 ()
  (CL:PROGN
   (STELLA::DEFINE-FUNCTION-OBJECT "INITIALIZE"
    "(DEFUN INITIALIZE () :DOCUMENTATION \"Initialize the PowerLoom logic system.  This needs to
be called by all applications before using PowerLoom.\" :PUBLIC? TRUE)"
    (CL:FUNCTION INITIALIZE) STELLA::NULL)
   (STELLA::DEFINE-METHOD-OBJECT
    "(DEFMETHOD (NEXT? BOOLEAN) ((SELF PL-ITERATOR)) :DOCUMENTATION \"Advance the PL-Iterator `self' and return `true' if more
elements are available, `false' otherwise.\")" (CL:FUNCTION STELLA::NEXT?)
    STELLA::NULL)
   (STELLA::DEFINE-METHOD-OBJECT
    "(DEFMETHOD (EMPTY? BOOLEAN) ((SELF PL-ITERATOR)) :DOCUMENTATION \"Return TRUE if the iterator `self' has no more elements.\" :PUBLIC? TRUE)"
    (CL:FUNCTION STELLA::EMPTY?) STELLA::NULL)
   (STELLA::DEFINE-METHOD-OBJECT
    "(DEFMETHOD (LENGTH INTEGER) ((SELF PL-ITERATOR)) :DOCUMENTATION \"Number of items in `self'.\" :PUBLIC? TRUE)"
    (CL:FUNCTION STELLA::LENGTH) STELLA::NULL)
   (STELLA::DEFINE-FUNCTION-OBJECT "CONS-TO-PL-ITERATOR"
    "(DEFUN (CONS-TO-PL-ITERATOR PL-ITERATOR) ((SELF CONS)) :DOCUMENTATION \"Convert a Stella cons list into an API iterator.\")"
    (CL:FUNCTION CONS-TO-PL-ITERATOR) STELLA::NULL)
   (STELLA::DEFINE-FUNCTION-OBJECT "LIST-TO-PL-ITERATOR"
    "(DEFUN (LIST-TO-PL-ITERATOR PL-ITERATOR) ((SELF LIST)) :DOCUMENTATION \"Convert a Stella list into an API iterator.\")"
   ...
   (STELLA::DEFINE-FUNCTION-OBJECT "SAFELY-GET-OBJECT"
    "(DEFUN (SAFELY-GET-OBJECT OBJECT) ((NAME STRING) (MODULE MODULE) (ENVIRONMENT OBJECT)))"
    (CL:FUNCTION SAFELY-GET-OBJECT) STELLA::NULL)
   (STELLA::DEFINE-FUNCTION-OBJECT "SAFELY-GET-CONCEPT"
    "(DEFUN (SAFELY-GET-CONCEPT OBJECT) ((NAME STRING) (MODULE MODULE) (ENVIRONMENT OBJECT)))"
    (CL:FUNCTION SAFELY-GET-CONCEPT) STELLA::NULL)
   (STELLA::DEFINE-FUNCTION-OBJECT "SAFELY-GET-RELATION"
    "(DEFUN (SAFELY-GET-RELATION OBJECT) ((NAME STRING) (MODULE MODULE) (ENVIRONMENT OBJECT)))"
   ...
   (STELLA::DEFINE-FUNCTION-OBJECT "SAFELY-GET-OBJECT-OR-NULL"
    "(DEFUN (SAFELY-GET-OBJECT-OR-NULL OBJECT) ((NAME STRING) (MODULE MODULE) (ENVIRONMENT OBJECT)))"
   ...
   (STELLA::DEFINE-FUNCTION-OBJECT "GET-OBJECT"
    "(DEFUN (GET-OBJECT OBJECT) ((NAME STRING) (MODULE MODULE) (ENVIRONMENT OBJECT)) :DOCUMENTATION \"Look for an object named `name' that is local to
or visible from the module `module'.\" :PUBLIC? TRUE)"
    (CL:FUNCTION GET-OBJECT) STELLA::NULL)
   (STELLA::DEFINE-FUNCTION-OBJECT "S-GET-OBJECT"
    "(DEFUN (S-GET-OBJECT OBJECT) ((NAME STRING) (MODULE-NAME STRING) (ENVIRONMENT OBJECT)) :DOCUMENTATION \"Look for an object named `name' that is local to
or visible from the module `module-name'.\" :PUBLIC? TRUE)"
    (CL:FUNCTION S-GET-OBJECT) STELLA::NULL)
   (STELLA::DEFINE-FUNCTION-OBJECT "GET-CONCEPT"
    "(DEFUN (GET-CONCEPT LOGIC-OBJECT) ((NAME STRING) (MODULE MODULE) (ENVIRONMENT OBJECT)) :DOCUMENTATION \"Return a class/concept named `name' that is local to
or visible from the module `module'.\" :PUBLIC? TRUE)"
    (CL:FUNCTION GET-CONCEPT) STELLA::NULL)
   (STELLA::DEFINE-FUNCTION-OBJECT "S-GET-CONCEPT"
    "(DEFUN (S-GET-CONCEPT LOGIC-OBJECT) ((NAME STRING) (MODULE-NAME STRING) (ENVIRONMENT OBJECT)) :DOCUMENTATION \"Return a class/concept named `name' that is local to
or visible from the module `module-name'.\" :PUBLIC? TRUE)"
    (CL:FUNCTION S-GET-CONCEPT) STELLA::NULL)
   (STELLA::DEFINE-FUNCTION-OBJECT "GET-RELATION"
    "(DEFUN (GET-RELATION LOGIC-OBJECT) ((NAME STRING) (MODULE MODULE) (ENVIRONMENT OBJECT)) :DOCUMENTATION \"Return a concept or relation named `name' that is local to
or visible from the module `module'.\" :PUBLIC? TRUE)"
    (CL:FUNCTION GET-RELATION) STELLA::NULL)
   (STELLA::DEFINE-FUNCTION-OBJECT "S-GET-RELATION"
    "(DEFUN (S-GET-RELATION LOGIC-OBJECT) ((NAME STRING) (MODULE-NAME STRING) (ENVIRONMENT OBJECT)) :DOCUMENTATION \"Return a concept or relation named `name' that is local to
or visible from the module `module-name'.\" :PUBLIC? TRUE)"
    (CL:FUNCTION S-GET-RELATION) STELLA::NULL)
   (STELLA::DEFINE-FUNCTION-OBJECT "GET-NAME"
    "(DEFUN (GET-NAME STRING) ((OBJ OBJECT)) :DOCUMENTATION \"Return the name of `obj', if it has one.  Otherwise return `null'.\" :PUBLIC? TRUE)"
    (CL:FUNCTION GET-NAME) STELLA::NULL)
   (STELLA::DEFINE-FUNCTION-OBJECT "OBJECT-TO-STRING"
    "(DEFUN (OBJECT-TO-STRING STRING) ((SELF OBJECT)) :DOCUMENTATION \"Return a printed representation of the term `self' as a string.\" :PUBLIC? TRUE)"
    (CL:FUNCTION OBJECT-TO-STRING) STELLA::NULL)
   (STELLA::DEFINE-FUNCTION-OBJECT "OBJECT-TO-INTEGER"
    "(DEFUN (OBJECT-TO-INTEGER INTEGER) ((SELF OBJECT)) :DOCUMENTATION \"Coerce `self' to an integer, or throw a Stella Exception if the coersion is not feasible.\" :PUBLIC? TRUE)"
    (CL:FUNCTION OBJECT-TO-INTEGER) STELLA::NULL)
   (STELLA::DEFINE-FUNCTION-OBJECT "OBJECT-TO-FLOAT"
    "(DEFUN (OBJECT-TO-FLOAT FLOAT) ((SELF OBJECT)) :DOCUMENTATION \"Coerce `self' to a float, or throw a Stella Exception if the coersion is not feasible.\" :PUBLIC? TRUE)"
    (CL:FUNCTION OBJECT-TO-FLOAT) STELLA::NULL)
   (STELLA::DEFINE-FUNCTION-OBJECT "OBJECT-TO-PARSABLE-STRING"
    "(DEFUN (OBJECT-TO-PARSABLE-STRING STRING) ((SELF OBJECT)) :DOCUMENTATION \"Return a string representing a printed
representation of the object `self'.  Like `object-to-string', but puts
escaped double quotes around strings.\" :PUBLIC? TRUE)"
    (CL:FUNCTION OBJECT-TO-PARSABLE-STRING) STELLA::NULL)
   (STELLA::DEFINE-FUNCTION-OBJECT "STRING-TO-OBJECT"
    "(DEFUN (STRING-TO-OBJECT OBJECT) ((STRING STRING) (TYPE LOGIC-OBJECT) (MODULE MODULE) (ENVIRONMENT OBJECT)) :DOCUMENTATION \"Evaluate `string' with respect to `module' and `environment'
and return the corresponding logical term.  `type' is a concept used to assist the
correct interpretation of `string'.

Currently `type' only has an effect on the interpretation of literal types.\" :PUBLIC? TRUE)"
   ...
   (STELLA::DEFINE-FUNCTION-OBJECT "HELP-GET-PROPOSITIONS"
    "(DEFUN (HELP-GET-PROPOSITIONS (CONS OF PROPOSITION)) ((RELATION LOGIC-OBJECT) (ARGUMENTS CONS) (LIMIT INTEGER) (MODULE MODULE) (ENVIRONMENT OBJECT)) :PUBLIC? FALSE)"
    (CL:FUNCTION HELP-GET-PROPOSITIONS) STELLA::NULL)
   (STELLA::DEFINE-FUNCTION-OBJECT "GET-PROPOSITION"
    "(DEFUN (GET-PROPOSITION PROPOSITION) ((RELATION-AND-ARGUMENTS OBJECT) (MODULE MODULE) (ENVIRONMENT OBJECT)) :DOCUMENTATION \"Return a proposition matching `relation-and-arguments' that
has been asserted (or inferred by forward chaining).  `relation-and-arguments'
is a sequence containing objects and nulls.  The first argument must be the
name of a relation.  A null value acts like a wild card.  If more than one 
proposition matches the input criteria, the selection among satisficing
...
relations or functions.\")" (CL:FUNCTION GET-PROPOSITION) STELLA::NULL)
   (STELLA::DEFINE-FUNCTION-OBJECT "S-GET-PROPOSITION"
    "(DEFUN (S-GET-PROPOSITION PROPOSITION) ((RELATION-AND-ARGUMENTS STRING) (MODULE-NAME STRING) (ENVIRONMENT OBJECT)) :DOCUMENTATION \"Return a proposition matching `relation-and-arguments' that
has been asserted (or inferred by forward chaining).  `relation-and-arguments'
is a string that begins with a left parenthesis, followed by a relation name, 
one or more argument identifiers, and terminated by a right parenthesis.  Each
argument identifier can be the name of a logical constant, a literal
...
If more than one proposition matches the input criteria, the selection among
satisficing propositions is arbitrary.  This procedure is normally applied to
single-valued relations or functions.\")" (CL:FUNCTION S-GET-PROPOSITION)
    STELLA::NULL)
   (STELLA::DEFINE-FUNCTION-OBJECT "GET-PROPOSITIONS"
    "(DEFUN (GET-PROPOSITIONS (PL-ITERATOR OF PROPOSITION)) ((RELATION-AND-ARGUMENTS OBJECT) (MODULE MODULE) (ENVIRONMENT OBJECT)) :DOCUMENTATION \"Return propositions matching `relation-and-arguments' that
have been asserted (or inferred by forward chaining).  `relation-and-arguments'
is a sequence containing objects and nulls.  The first argument must be the
name of a relation.  A null value acts like a wild card.\")"
    (CL:FUNCTION GET-PROPOSITIONS) STELLA::NULL)
   (STELLA::DEFINE-FUNCTION-OBJECT "S-GET-PROPOSITIONS"
    "(DEFUN (S-GET-PROPOSITIONS (PL-ITERATOR OF PROPOSITION)) ((RELATION-AND-ARGUMENTS STRING) (MODULE-NAME STRING) (ENVIRONMENT OBJECT)) :DOCUMENTATION \"Return propositions matching `relation-and-arguments' that
have been asserted (or inferred by forward chaining).  `relation-and-arguments'
is a string that begins with a left parenthesis, followed by a relation name, 
one or more argument identifiers, and terminated by a right parenthesis.  Each
argument identifier can be the name of a logical constant, a literal 
...
with a question mark). Each occurrence of a null or a variable acts like a wild card.\")"
   ...
   (STELLA::DEFINE-FUNCTION-OBJECT "GET-BINARY-PROPOSITION"
    "(DEFUN (GET-BINARY-PROPOSITION PROPOSITION) ((RELATION LOGIC-OBJECT) (ARG1 OBJECT) (ARG2 OBJECT) (MODULE MODULE) (ENVIRONMENT OBJECT)) :DOCUMENTATION \"Return a proposition such that (`relation' `arg1' `arg2')
is true.  The `relation' argument must be bound to a relation.  One or both
of the `arg1' and `arg2' arguments may be set to NULL, which is interpreted
as a wildcard. If more than one proposition matches the input criteria,
the selection is arbitrary.  This procedure is normally applied to single-valued
relations or functions.\")" (CL:FUNCTION GET-BINARY-PROPOSITION) STELLA::NULL)
   (STELLA::DEFINE-FUNCTION-OBJECT "GET-BINARY-PROPOSITIONS"
    "(DEFUN (GET-BINARY-PROPOSITIONS (PL-ITERATOR OF PROPOSITION)) ((RELATION LOGIC-OBJECT) (ARG1 OBJECT) (ARG2 OBJECT) (MODULE MODULE) (ENVIRONMENT OBJECT)) :DOCUMENTATION \"Return propositions such that (`relation' `arg1' `arg2')
is true.  The `relation' argument
must be bound to a relation.  One or both of the `arg1' and `arg2' arguments
may be set to NULL, which is interpreted as a wildcard.\")"
    (CL:FUNCTION GET-BINARY-PROPOSITIONS) STELLA::NULL)
   (STELLA::DEFINE-FUNCTION-OBJECT "GET-INFERRED-BINARY-PROPOSITION-VALUES"
    "(DEFUN (GET-INFERRED-BINARY-PROPOSITION-VALUES PL-ITERATOR) ((RELATION LOGIC-OBJECT) (ARG OBJECT) (MODULE MODULE) (ENVIRONMENT OBJECT)) :DOCUMENTATION \"Return all values `v' such that (`relation' `arg' `v')
has been asserted or can be inferred.\")"
   ...
   (STELLA::DEFINE-FUNCTION-OBJECT "S-GET-INFERRED-BINARY-PROPOSITION-VALUES"
    "(DEFUN (S-GET-INFERRED-BINARY-PROPOSITION-VALUES PL-ITERATOR) ((RELATION-NAME STRING) (ARG-NAME STRING) (MODULE-NAME STRING) (ENVIRONMENT OBJECT)) :DOCUMENTATION \"Return all values `v' such that (`relation-name' `arg-name' `v')
has been asserted or can be inferred.\")"
    (CL:FUNCTION S-GET-INFERRED-BINARY-PROPOSITION-VALUES) STELLA::NULL)
   (STELLA::DEFINE-FUNCTION-OBJECT "GET-PROPOSITIONS-OF"
    "(DEFUN (GET-PROPOSITIONS-OF (PL-ITERATOR OF PROPOSITION)) ((OBJECT LOGIC-OBJECT) (MODULE MODULE) (ENVIRONMENT OBJECT)) :DOCUMENTATION \"Return all propositions that have `object' among their arguments,
and that are TRUE in the scope of the module `module'.\")"
    (CL:FUNCTION GET-PROPOSITIONS-OF) STELLA::NULL)
   (STELLA::DEFINE-FUNCTION-OBJECT "S-GET-PROPOSITIONS-OF"
    "(DEFUN (S-GET-PROPOSITIONS-OF (PL-ITERATOR OF PROPOSITION)) ((OBJECT-NAME STRING) (MODULE-NAME STRING) (ENVIRONMENT OBJECT)) :DOCUMENTATION \"Return all propositions that have the object named `object-name' among
their arguments, and that are TRUE in the scope of the module `module'.\")"
    (CL:FUNCTION S-GET-PROPOSITIONS-OF) STELLA::NULL)
   (STELLA::DEFINE-FUNCTION-OBJECT "GET-PROPOSITIONS-IN-MODULE"
    "(DEFUN (GET-PROPOSITIONS-IN-MODULE (PL-ITERATOR OF PROPOSITION)) ((MODULE MODULE) (ENVIRONMENT OBJECT)) :DOCUMENTATION \"Return propositions that have been conceived in
the module `module'.\")" (CL:FUNCTION GET-PROPOSITIONS-IN-MODULE)
    STELLA::NULL)
   (STELLA::DEFINE-FUNCTION-OBJECT "IS-TRUE-UNARY-PROPOSITION"
    "(DEFUN (IS-TRUE-UNARY-PROPOSITION BOOLEAN) ((RELATION LOGIC-OBJECT) (ARG OBJECT) (MODULE MODULE) (ENVIRONMENT OBJECT)) :DOCUMENTATION \"Return TRUE if the proposition (`relation' `arg') has
been asserted (or inferred by forward chaining).\")"
    (CL:FUNCTION IS-TRUE-UNARY-PROPOSITION) STELLA::NULL)
   (STELLA::DEFINE-FUNCTION-OBJECT "IS-TRUE-BINARY-PROPOSITION"
    "(DEFUN (IS-TRUE-BINARY-PROPOSITION BOOLEAN) ((RELATION LOGIC-OBJECT) (ARG OBJECT) (VALUE OBJECT) (MODULE MODULE) (ENVIRONMENT OBJECT)) :DOCUMENTATION \"Return TRUE if the proposition (`relation' `arg' `value') has
been asserted (or inferred by forward chaining).\")"
    (CL:FUNCTION IS-TRUE-BINARY-PROPOSITION) STELLA::NULL)
   (STELLA::DEFINE-FUNCTION-OBJECT "IS-TRUE-PROPOSITION1"
    "(DEFUN (IS-TRUE-PROPOSITION1 BOOLEAN) ((RELATION-AND-ARGUMENTS OBJECT) (MODULE MODULE) (ENVIRONMENT OBJECT)) :DOCUMENTATION \"Return TRUE if a proposition (`relation' `args') has
been asserted (or inferred by forward chaining).\")"
    (CL:FUNCTION IS-TRUE-PROPOSITION1) STELLA::NULL)
   (STELLA::DEFINE-FUNCTION-OBJECT "IS-TRUE-PROPOSITION"
    "(DEFUN (IS-TRUE-PROPOSITION BOOLEAN) ((PROPOSITION PROPOSITION) (MODULE MODULE) (ENVIRONMENT OBJECT)) :DOCUMENTATION \"Return TRUE if `proposition' is  TRUE in the module `module'.\")"
    (CL:FUNCTION IS-TRUE-PROPOSITION) STELLA::NULL)
   (STELLA::DEFINE-FUNCTION-OBJECT "S-IS-TRUE-PROPOSITION"
    "(DEFUN (S-IS-TRUE-PROPOSITION BOOLEAN) ((RELATION-AND-ARGUMENTS STRING) (MODULE-NAME STRING) (ENVIRONMENT OBJECT)) :DOCUMENTATION \"Return TRUE if a proposition that prints as the string
`relation-and-arguments' is true in the module named `module-name'.\")"
    (CL:FUNCTION S-IS-TRUE-PROPOSITION) STELLA::NULL)
   (STELLA::DEFINE-FUNCTION-OBJECT "IS-SUBRELATION"
    "(DEFUN (IS-SUBRELATION BOOLEAN) ((SUB LOGIC-OBJECT) (SUPER LOGIC-OBJECT) (MODULE MODULE) (ENVIRONMENT OBJECT)) :DOCUMENTATION \"Return TRUE if `sub' is a subconcept/subrelation of `super'.\")"
    (CL:FUNCTION IS-SUBRELATION) STELLA::NULL)
   (STELLA::DEFINE-FUNCTION-OBJECT "GET-PROPER-SUBRELATIONS"
    "(DEFUN (GET-PROPER-SUBRELATIONS (PL-ITERATOR OF LOGIC-OBJECT)) ((RELATION LOGIC-OBJECT) (MODULE MODULE) (ENVIRONMENT OBJECT)) :DOCUMENTATION \"Return relations that specialize `relation'.
Non-reflexive.\")" (CL:FUNCTION GET-PROPER-SUBRELATIONS) STELLA::NULL)
   (STELLA::DEFINE-FUNCTION-OBJECT "GET-DIRECT-SUBRELATIONS"
    "(DEFUN (GET-DIRECT-SUBRELATIONS (PL-ITERATOR OF LOGIC-OBJECT)) ((RELATION LOGIC-OBJECT) (MODULE MODULE) (ENVIRONMENT OBJECT)) :DOCUMENTATION \"Return relations that directly specialize `relation'.
Non-reflexive.\")" (CL:FUNCTION GET-DIRECT-SUBRELATIONS) STELLA::NULL)
   (STELLA::DEFINE-FUNCTION-OBJECT "GET-PROPER-SUPERRELATIONS"
    "(DEFUN (GET-PROPER-SUPERRELATIONS (PL-ITERATOR OF LOGIC-OBJECT)) ((RELATION LOGIC-OBJECT) (MODULE MODULE) (ENVIRONMENT OBJECT)) :DOCUMENTATION \"Return relations that generalize `relation'.
Non-reflexive.\")" (CL:FUNCTION GET-PROPER-SUPERRELATIONS) STELLA::NULL)
   (STELLA::DEFINE-FUNCTION-OBJECT "GET-DIRECT-SUPERRELATIONS"
    "(DEFUN (GET-DIRECT-SUPERRELATIONS (PL-ITERATOR OF LOGIC-OBJECT)) ((RELATION LOGIC-OBJECT) (MODULE MODULE) (ENVIRONMENT OBJECT)) :DOCUMENTATION \"Return relations that directly generalize `relation'.
Non-reflexive.\")" (CL:FUNCTION GET-DIRECT-SUPERRELATIONS) STELLA::NULL)
   (STELLA::DEFINE-FUNCTION-OBJECT "IS-A"
    "(DEFUN (IS-A BOOLEAN) ((OBJECT OBJECT) (CONCEPT LOGIC-OBJECT) (MODULE MODULE) (ENVIRONMENT OBJECT)) :DOCUMENTATION \"Return TRUE if `object' is a member of the concept `concept'.\")"
    (CL:FUNCTION IS-A) STELLA::NULL)
   (STELLA::DEFINE-FUNCTION-OBJECT "GET-CONCEPT-INSTANCES"
    "(DEFUN (GET-CONCEPT-INSTANCES PL-ITERATOR) ((CONCEPT LOGIC-OBJECT) (MODULE MODULE) (ENVIRONMENT OBJECT)) :DOCUMENTATION \"Return instances of the concept `concept'.
Include instances of subconcepts of `concept'.  Depending on `concept',
the return values could be (wrapped) literals.\")"
    (CL:FUNCTION GET-CONCEPT-INSTANCES) STELLA::NULL)
   (STELLA::DEFINE-FUNCTION-OBJECT "S-GET-CONCEPT-INSTANCES"
    "(DEFUN (S-GET-CONCEPT-INSTANCES PL-ITERATOR) ((CONCEPT-NAME STRING) (MODULE-NAME STRING) (ENVIRONMENT OBJECT)) :DOCUMENTATION \"Return instances of concept `concept-name'.
Include instances of subconcepts of `concept-name'.  Depending on `concept-name',
the return values could be (wrapped) literals.\")"
    (CL:FUNCTION S-GET-CONCEPT-INSTANCES) STELLA::NULL)
   (STELLA::DEFINE-FUNCTION-OBJECT "GET-DIRECT-CONCEPT-INSTANCES"
    "(DEFUN (GET-DIRECT-CONCEPT-INSTANCES PL-ITERATOR) ((CONCEPT LOGIC-OBJECT) (MODULE MODULE) (ENVIRONMENT OBJECT)) :DOCUMENTATION \"Return instances of concept `concept'.
Exclude instances of subconcepts of `concept'.  Depending on `concept',
the return values could be (wrapped) literals.\")"
    (CL:FUNCTION GET-DIRECT-CONCEPT-INSTANCES) STELLA::NULL)
   (STELLA::DEFINE-FUNCTION-OBJECT "S-GET-DIRECT-CONCEPT-INSTANCES"
    "(DEFUN (S-GET-DIRECT-CONCEPT-INSTANCES PL-ITERATOR) ((CONCEPT-NAME STRING) (MODULE-NAME STRING) (ENVIRONMENT OBJECT)) :DOCUMENTATION \"Return instances of concept `concept-name'.
Exclude instances of subconcepts of `concept-name'.  Depending on `concept-name',
the return values could be (wrapped) literals.\")"
    (CL:FUNCTION S-GET-DIRECT-CONCEPT-INSTANCES) STELLA::NULL)
   (STELLA::DEFINE-FUNCTION-OBJECT "GET-CONCEPT-INSTANCES-MATCHING-VALUE"
    "(DEFUN (GET-CONCEPT-INSTANCES-MATCHING-VALUE PL-ITERATOR) ((CONCEPT LOGIC-OBJECT) (RELATION LOGIC-OBJECT) (VALUE OBJECT) (MODULE MODULE) (ENVIRONMENT OBJECT)) :DOCUMENTATION \"Return members of concept `concept' that
have an attribute matching `value' for the binary relation `relation', i.e.,
`(relation <result> value)' holds.\")"
   ...
   (STELLA::DEFINE-FUNCTION-OBJECT "GET-CONCEPT-INSTANCE-MATCHING-VALUE"
    "(DEFUN (GET-CONCEPT-INSTANCE-MATCHING-VALUE OBJECT) ((CONCEPT LOGIC-OBJECT) (RELATION LOGIC-OBJECT) (VALUE OBJECT) (MODULE MODULE) (ENVIRONMENT OBJECT)) :DOCUMENTATION \"Return a member of concept `concept' that
has an attribute matching `value' for the binary relation `relation', i.e.,
`(relation <result> value)' holds.\")"
    (CL:FUNCTION GET-CONCEPT-INSTANCE-MATCHING-VALUE) STELLA::NULL)
   (STELLA::DEFINE-FUNCTION-OBJECT "GET-TYPES"
    "(DEFUN (GET-TYPES (PL-ITERATOR OF LOGIC-OBJECT)) ((OBJECT LOGIC-OBJECT) (MODULE MODULE) (ENVIRONMENT OBJECT)) :DOCUMENTATION \"Return all named concepts that `object' belongs to.\")"
    (CL:FUNCTION GET-TYPES) STELLA::NULL)
   (STELLA::DEFINE-FUNCTION-OBJECT "GET-DIRECT-TYPES"
    "(DEFUN (GET-DIRECT-TYPES (PL-ITERATOR OF LOGIC-OBJECT)) ((OBJECT LOGIC-OBJECT) (MODULE MODULE) (ENVIRONMENT OBJECT)) :DOCUMENTATION \"Return most specific concepts that `object' belongs to.\")"
    (CL:FUNCTION GET-DIRECT-TYPES) STELLA::NULL)))

(CL:DEFUN HELP-STARTUP-PLI3 ()
  (CL:PROGN
   (STELLA::DEFINE-FUNCTION-OBJECT "GET-RELATION-EXTENSION"
    "(DEFUN (GET-RELATION-EXTENSION (PL-ITERATOR OF PROPOSITION)) ((RELATION LOGIC-OBJECT) (MODULE MODULE) (ENVIRONMENT OBJECT)) :DOCUMENTATION \"Return propositions that satisfy `relation'.
Include propositions that satisfy subrelations of `relation'.\")"
    (CL:FUNCTION GET-RELATION-EXTENSION) STELLA::NULL)
   (STELLA::DEFINE-FUNCTION-OBJECT "S-GET-RELATION-EXTENSION"
    "(DEFUN (S-GET-RELATION-EXTENSION (PL-ITERATOR OF PROPOSITION)) ((RELATION-NAME STRING) (MODULE MODULE) (ENVIRONMENT OBJECT)) :DOCUMENTATION \"Return propositions that satisfy the relation named
`relation-name'.  Include propositions that satisfy subrelations of the relation.\")"
    (CL:FUNCTION S-GET-RELATION-EXTENSION) STELLA::NULL)
   (STELLA::DEFINE-FUNCTION-OBJECT "GET-MODULE"
    "(DEFUN (GET-MODULE MODULE) ((NAME STRING) (ENVIRONMENT OBJECT)) :DOCUMENTATION \"Return a module named `name'.\" :PUBLIC? TRUE)"
    (CL:FUNCTION GET-MODULE) STELLA::NULL)
   (STELLA::DEFINE-FUNCTION-OBJECT "GET-HOME-MODULE"
    "(DEFUN (GET-HOME-MODULE MODULE) ((OBJECT LOGIC-OBJECT)) :DOCUMENTATION \"Return the module in which `object' was created.\")"
    (CL:FUNCTION GET-HOME-MODULE) STELLA::NULL)
   (STELLA::DEFINE-FUNCTION-OBJECT "CHANGE-MODULE"
    "(DEFUN (CHANGE-MODULE OBJECT) ((MODULE MODULE)) :DOCUMENTATION \"Set the current module to `module'.  The return value
is `module' unless the context switch cannot be performed, in which case
the current module is returned.\")" (CL:FUNCTION CHANGE-MODULE) STELLA::NULL)
   (STELLA::DEFINE-FUNCTION-OBJECT "S-CHANGE-MODULE"
    "(DEFUN (S-CHANGE-MODULE OBJECT) ((NAME STRING) (ENVIRONMENT OBJECT)) :DOCUMENTATION \"Set the current module to the module named `name'.  
The return value is the module named `name' unless the context switch
cannot be performed, in which case the current module is returned.\")"
    (CL:FUNCTION S-CHANGE-MODULE) STELLA::NULL)
   (STELLA::DEFINE-FUNCTION-OBJECT "CLEAR-MODULE"
    "(DEFUN (CLEAR-MODULE MODULE) ((MODULE MODULE)) :DOCUMENTATION \"Destroy the contents of the module `module' as well as
the contents of all of its children, recursively.\" :PUBLIC? TRUE)"
    (CL:FUNCTION CLEAR-MODULE) STELLA::NULL)
   (STELLA::DEFINE-FUNCTION-OBJECT "S-CLEAR-MODULE"
    "(DEFUN (S-CLEAR-MODULE MODULE) ((NAME STRING) (ENVIRONMENT OBJECT)) :DOCUMENTATION \"Destroy the contents of the module named `name', as
well as the contents of all of its children, recursively.\" :PUBLIC? TRUE)"
    (CL:FUNCTION S-CLEAR-MODULE) STELLA::NULL)
   (STELLA::DEFINE-FUNCTION-OBJECT "GET-CHILD-MODULES"
    "(DEFUN (GET-CHILD-MODULES (PL-ITERATOR OF MODULE)) ((MODULE MODULE)) :DOCUMENTATION \"Return the modules that are immediate children of `module'.\" :PUBLIC? TRUE)"
    (CL:FUNCTION GET-CHILD-MODULES) STELLA::NULL)
   (STELLA::DEFINE-FUNCTION-OBJECT "S-GET-CHILD-MODULES"
    "(DEFUN (S-GET-CHILD-MODULES (PL-ITERATOR OF MODULE)) ((NAME STRING) (ENVIRONMENT OBJECT)) :DOCUMENTATION \"Return the modules that are immediate children of module `name'.\" :PUBLIC? TRUE)"
    (CL:FUNCTION S-GET-CHILD-MODULES) STELLA::NULL)
   (STELLA::DEFINE-FUNCTION-OBJECT "GET-PARENT-MODULES"
    "(DEFUN (GET-PARENT-MODULES (PL-ITERATOR OF MODULE)) ((MODULE MODULE)) :DOCUMENTATION \"Return the modules that are immediate parents of `module'.\" :PUBLIC? TRUE)"
    (CL:FUNCTION GET-PARENT-MODULES) STELLA::NULL)
   (STELLA::DEFINE-FUNCTION-OBJECT "S-GET-PARENT-MODULES"
    "(DEFUN (S-GET-PARENT-MODULES (PL-ITERATOR OF MODULE)) ((NAME STRING) (ENVIRONMENT OBJECT)) :DOCUMENTATION \"Return the modules that are immediate parents of module `name'.\" :PUBLIC? TRUE)"
    (CL:FUNCTION S-GET-PARENT-MODULES) STELLA::NULL)
   (STELLA::DEFINE-FUNCTION-OBJECT "GET-MODULES"
    "(DEFUN (GET-MODULES (PL-ITERATOR OF MODULE)) () :DOCUMENTATION \"Return all modules currently loaded into PowerLoom.\" :PUBLIC? TRUE)"
    (CL:FUNCTION GET-MODULES) STELLA::NULL)
   (STELLA::DEFINE-FUNCTION-OBJECT "GENERATE-UNIQUE-NAME"
    "(DEFUN (GENERATE-UNIQUE-NAME STRING) ((PREFIX STRING) (MODULE MODULE) (ENVIRONMENT OBJECT)) :DOCUMENTATION \"Generates a name based on `prefix' with a number appended that
is not currently in use in the knowledge base.\" :PUBLIC? TRUE)"
    (CL:FUNCTION GENERATE-UNIQUE-NAME) STELLA::NULL)
   (STELLA::DEFINE-FUNCTION-OBJECT "CREATE-OBJECT"
    "(DEFUN (CREATE-OBJECT LOGIC-OBJECT) ((NAME STRING) (CONCEPT LOGIC-OBJECT) (MODULE MODULE) (ENVIRONMENT OBJECT)) :DOCUMENTATION \"Create an object named `name' of type `concept' in the designated
module.  Both `name' and `concept' can be `null'.  If `name' is `null' then an object
will be created with a new, non-conflicting name based on the name of `concept', or
system-generated if no concept is specified.  If `concept' is `null', then the object
will be of type THING.
...
Return the object.\")" (CL:FUNCTION CREATE-OBJECT) STELLA::NULL)
   (STELLA::DEFINE-FUNCTION-OBJECT "S-CREATE-OBJECT"
    "(DEFUN (S-CREATE-OBJECT LOGIC-OBJECT) ((NAME STRING) (CONCEPT-NAME STRING) (MODULE-NAME STRING) (ENVIRONMENT OBJECT)) :DOCUMENTATION \"Create an object named `name' of type `concept-name' in the designated
module.  Both `name' and `concept-name' can be null strings.  If `name' is a null string
then an object will be created with a new, non-conflicting name based on `concept-name', or
system-generated if no concept nameis specified.  If `concept-name' is the null string, then
the object will be of type THING.
...
Return the object.\")" (CL:FUNCTION S-CREATE-OBJECT) STELLA::NULL)
   (STELLA::DEFINE-FUNCTION-OBJECT "CREATE-CONCEPT"
    "(DEFUN (CREATE-CONCEPT LOGIC-OBJECT) ((NAME STRING) (PARENT LOGIC-OBJECT) (MODULE MODULE) (ENVIRONMENT OBJECT)) :DOCUMENTATION \"Create a concept named `name' in the designated `module', with the
designated `parent' superconcept (which can be left undefined).  Additional
superconcepts can be added via assertions of the `subset-of' relation.  Note
that a specified `parent' concept needs to be created separately.\")"
    (CL:FUNCTION CREATE-CONCEPT) STELLA::NULL)
   (STELLA::DEFINE-FUNCTION-OBJECT "S-CREATE-CONCEPT"
    "(DEFUN (S-CREATE-CONCEPT LOGIC-OBJECT) ((NAME STRING) (PARENT-NAME STRING) (MODULE-NAME STRING) (ENVIRONMENT OBJECT)) :DOCUMENTATION \"Create a concept named `name' in the designated module, with
with the concept named `parent-name' as superconcept (which can be left
undefined).  Additional superconcepts can be added via assertions of the
`subset-of' relation.  Note that a specified parent concept needs to be
created separately.\")" (CL:FUNCTION S-CREATE-CONCEPT) STELLA::NULL)
   (STELLA::DEFINE-FUNCTION-OBJECT "CREATE-RELATION"
    "(DEFUN (CREATE-RELATION LOGIC-OBJECT) ((NAME STRING) (ARITY INTEGER) (MODULE MODULE) (ENVIRONMENT OBJECT)) :DOCUMENTATION \"Create a relation named `name' with arity `arity' in the
designated module.  Domain and range information can be added via assertions
of `nth-domain' (or `domain' and `range') relations.\")"
    (CL:FUNCTION CREATE-RELATION) STELLA::NULL)
   (STELLA::DEFINE-FUNCTION-OBJECT "S-CREATE-RELATION"
    "(DEFUN (S-CREATE-RELATION LOGIC-OBJECT) ((NAME STRING) (ARITY INTEGER) (MODULE-NAME STRING) (ENVIRONMENT OBJECT)) :DOCUMENTATION \"Create a relation named `name' with arity `arity' in the
designated module.  Domain and range information can be added via assertions
of `nth-domain' (or `domain' and `range') relations.\")"
    (CL:FUNCTION S-CREATE-RELATION) STELLA::NULL)
   (STELLA::DEFINE-FUNCTION-OBJECT "CREATE-FUNCTION"
    "(DEFUN (CREATE-FUNCTION LOGIC-OBJECT) ((NAME STRING) (ARITY INTEGER) (MODULE MODULE) (ENVIRONMENT OBJECT)) :DOCUMENTATION \"Create a function named `name' with arity `arity'  in the designated 
`module'.  Domain and range information can be added via assertions of
`nth-domain' (or `domain' and `range') relations.\")"
    (CL:FUNCTION CREATE-FUNCTION) STELLA::NULL)
   (STELLA::DEFINE-FUNCTION-OBJECT "S-CREATE-FUNCTION"
    "(DEFUN (S-CREATE-FUNCTION LOGIC-OBJECT) ((NAME STRING) (ARITY INTEGER) (MODULE-NAME STRING) (ENVIRONMENT OBJECT)) :DOCUMENTATION \"Create a function named `name' with arity `arity' in the designated 
module.  Domain and range information can be added via assertions of
`domain', `nth-domain' and `range' relations.\")"
    (CL:FUNCTION S-CREATE-FUNCTION) STELLA::NULL)
   (STELLA::DEFINE-FUNCTION-OBJECT "CREATE-ENUMERATED-LIST"
    "(DEFUN (CREATE-ENUMERATED-LIST LOGIC-OBJECT) ((MEMBERS CONS)) :DOCUMENTATION \"Create a logical term that denotes a list containing `members'.
Useful for passing lists as arguments to parameterized queries.\" :PUBLIC? TRUE)"
    (CL:FUNCTION CREATE-ENUMERATED-LIST) STELLA::NULL)
   (STELLA::DEFINE-FUNCTION-OBJECT "CREATE-ENUMERATED-SET"
    "(DEFUN (CREATE-ENUMERATED-SET LOGIC-OBJECT) ((MEMBERS CONS)) :DOCUMENTATION \"Create a logical term that denotes the enumerated set containing `members'.\" :PUBLIC? TRUE)"
    (CL:FUNCTION CREATE-ENUMERATED-SET) STELLA::NULL)
   (STELLA::DEFINE-FUNCTION-OBJECT "DESTROY-OBJECT"
    "(DEFUN DESTROY-OBJECT ((OBJECT LOGIC-OBJECT)) :DOCUMENTATION \"Delete the object `object', retracting all facts attached to it.\")"
    (CL:FUNCTION DESTROY-OBJECT) STELLA::NULL)
   (STELLA::DEFINE-FUNCTION-OBJECT "S-DESTROY-OBJECT"
    "(DEFUN S-DESTROY-OBJECT ((OBJECT-NAME STRING) (MODULE-NAME STRING) (ENVIRONMENT OBJECT)) :DOCUMENTATION \"Delete the object named `object-name', retracting all facts
attached to it.\")" (CL:FUNCTION S-DESTROY-OBJECT) STELLA::NULL)
   (STELLA::DEFINE-FUNCTION-OBJECT "ASSERT-UNARY-PROPOSITION"
    "(DEFUN (ASSERT-UNARY-PROPOSITION PROPOSITION) ((RELATION LOGIC-OBJECT) (ARG OBJECT) (MODULE MODULE) (ENVIRONMENT OBJECT)) :DOCUMENTATION \"Assert that the proposition (`relation' `arg') is TRUE in `module'.  Return the asserted proposition.\")"
    (CL:FUNCTION ASSERT-UNARY-PROPOSITION) STELLA::NULL)
   (STELLA::DEFINE-FUNCTION-OBJECT "ASSERT-BINARY-PROPOSITION"
    "(DEFUN (ASSERT-BINARY-PROPOSITION PROPOSITION) ((RELATION LOGIC-OBJECT) (ARG OBJECT) (VALUE OBJECT) (MODULE MODULE) (ENVIRONMENT OBJECT)) :DOCUMENTATION \"Assert that the proposition (`relation' `arg' `value') is TRUE
in `module'.  Return the asserted proposition.\")"
    (CL:FUNCTION ASSERT-BINARY-PROPOSITION) STELLA::NULL)
   (STELLA::DEFINE-FUNCTION-OBJECT "ASSERT-NARY-PROPOSITION"
    "(DEFUN (ASSERT-NARY-PROPOSITION PROPOSITION) ((RELATION-AND-ARGUMENTS OBJECT) (MODULE MODULE) (ENVIRONMENT OBJECT)) :DOCUMENTATION \"Assert that the proposition represented by the list `arguments' satisfies
the relation `relation'.\")" (CL:FUNCTION ASSERT-NARY-PROPOSITION)
    STELLA::NULL)
   (STELLA::DEFINE-FUNCTION-OBJECT "RETRACT-UNARY-PROPOSITION"
    "(DEFUN (RETRACT-UNARY-PROPOSITION PROPOSITION) ((RELATION LOGIC-OBJECT) (ARG OBJECT) (MODULE MODULE) (ENVIRONMENT OBJECT)) :DOCUMENTATION \"Retract that the proposition (`relation' `arg') is TRUE in `module'.  Return the asserted proposition.\")"
    (CL:FUNCTION RETRACT-UNARY-PROPOSITION) STELLA::NULL)
   (STELLA::DEFINE-FUNCTION-OBJECT "RETRACT-BINARY-PROPOSITION"
    "(DEFUN (RETRACT-BINARY-PROPOSITION PROPOSITION) ((RELATION LOGIC-OBJECT) (ARG OBJECT) (VALUE OBJECT) (MODULE MODULE) (ENVIRONMENT OBJECT)) :DOCUMENTATION \"Retract that the proposition (`relation' `arg' `value') is TRUE
in `module'.  Return the asserted proposition.\")"
    (CL:FUNCTION RETRACT-BINARY-PROPOSITION) STELLA::NULL)
   (STELLA::DEFINE-FUNCTION-OBJECT "RETRACT-NARY-PROPOSITION"
    "(DEFUN (RETRACT-NARY-PROPOSITION PROPOSITION) ((RELATION-AND-ARGUMENTS OBJECT) (MODULE MODULE) (ENVIRONMENT OBJECT)) :DOCUMENTATION \"Retract the proposition that `arguments' satisfies
the relation `relation'.\")" (CL:FUNCTION RETRACT-NARY-PROPOSITION)
    STELLA::NULL)
   (STELLA::DEFINE-FUNCTION-OBJECT "ASSERT-PROPOSITION"
    "(DEFUN (ASSERT-PROPOSITION PROPOSITION) ((PROPOSITION PROPOSITION) (MODULE MODULE) (ENVIRONMENT OBJECT)) :DOCUMENTATION \"Assert that the proposition `proposition' is true in `module'.
Return the asserted proposition.\")" (CL:FUNCTION ASSERT-PROPOSITION)
    STELLA::NULL)
   (STELLA::DEFINE-FUNCTION-OBJECT "S-ASSERT-PROPOSITION"
    "(DEFUN (S-ASSERT-PROPOSITION (PL-ITERATOR OF PROPOSITION)) ((SENTENCE STRING) (MODULE-NAME STRING) (ENVIRONMENT OBJECT)) :DOCUMENTATION \"Assert that the logical sentence `sentence' is true in the module
named `module-name'. Return an iterator of the propositions resulting
from sentence.\")" (CL:FUNCTION S-ASSERT-PROPOSITION) STELLA::NULL)
   (STELLA::DEFINE-FUNCTION-OBJECT "RETRACT-PROPOSITION"
    "(DEFUN (RETRACT-PROPOSITION PROPOSITION) ((PROPOSITION PROPOSITION) (MODULE MODULE) (ENVIRONMENT OBJECT)) :DOCUMENTATION \"Retract the truth of the proposition `proposition' in `module'.
Return the retracted proposition.\")" (CL:FUNCTION RETRACT-PROPOSITION)
    STELLA::NULL)
   (STELLA::DEFINE-FUNCTION-OBJECT "S-RETRACT-PROPOSITION"
    "(DEFUN (S-RETRACT-PROPOSITION (PL-ITERATOR OF PROPOSITION)) ((SENTENCE STRING) (MODULE-NAME STRING) (ENVIRONMENT OBJECT)) :DOCUMENTATION \"Retract the truth of the logical sentence `sentence' in the module named
`module-name'.  Return an iterator of the retracted propositions resulting
from sentence.\")" (CL:FUNCTION S-RETRACT-PROPOSITION) STELLA::NULL)
   (STELLA::DEFINE-FUNCTION-OBJECT "CONCEIVE"
    "(DEFUN (CONCEIVE (PL-ITERATOR OF PROPOSITION)) ((SENTENCE OBJECT) (MODULE MODULE) (ENVIRONMENT OBJECT)) :DOCUMENTATION \"Create one or more proposition objects from the sentence `sentence'
in the  module `module'.  Return an iterator of the propositions.
If any of the new propositions has the same structure as an already existing
proposition, an automatic check for duplicates will return the pre-existing
proposition.  Multiple propositions may be returned for a single sentence
...
Signals a `Proposition-Error' if PowerLoom could not conceive `sentence'.\")"
   ...
   (STELLA::DEFINE-FUNCTION-OBJECT "S-CONCEIVE"
    "(DEFUN (S-CONCEIVE (PL-ITERATOR OF PROPOSITION)) ((SENTENCE STRING) (MODULE-NAME STRING) (ENVIRONMENT OBJECT)) :DOCUMENTATION \"Create one or more proposition objects from the sentence `sentence'
in the  module named `module-name'.  Return an iterator of the propositions.
If any of the new propositions has the same structure as an already existing
proposition, an automatic check for duplicates will return the pre-existing
proposition.  Multiple propositions may be returned for a single sentence
...
Signals a `Proposition-Error' if PowerLoom could not conceive `sentence'.\")"
   ...
   (STELLA::DEFINE-FUNCTION-OBJECT "GET-RULES"
    "(DEFUN (GET-RULES (PL-ITERATOR OF PROPOSITION)) ((RELATION LOGIC-OBJECT) (MODULE MODULE) (ENVIRONMENT OBJECT)) :DOCUMENTATION \"Return rules attached to the concept/relation `relation'
in either antecedent or consequent position.\" :PUBLIC? TRUE)"
    (CL:FUNCTION GET-RULES) STELLA::NULL)
   (STELLA::DEFINE-FUNCTION-OBJECT "S-GET-RULES"
    "(DEFUN (S-GET-RULES (PL-ITERATOR OF PROPOSITION)) ((RELATION-NAME STRING) (MODULE-NAME STRING) (ENVIRONMENT OBJECT)) :DOCUMENTATION \"Return rules attached to the concept/relation named
`relation-name' found in the module named `module-name'.\" :PUBLIC? TRUE)"
    (CL:FUNCTION S-GET-RULES) STELLA::NULL)
   (STELLA::DEFINE-FUNCTION-OBJECT "S-PRINT-RULES"
    "(DEFUN S-PRINT-RULES ((NAME STRING) (STREAM OUTPUT-STREAM) (MODULE-NAME STRING) (ENVIRONMENT OBJECT)) :DOCUMENTATION \"Print rules attached to the concept/relation named `name'.\" :PUBLIC? TRUE)"
    (CL:FUNCTION S-PRINT-RULES) STELLA::NULL)
   (STELLA::DEFINE-FUNCTION-OBJECT "RUN-FORWARD-RULES"
    "(DEFUN RUN-FORWARD-RULES ((MODULE OBJECT) (FORCE? BOOLEAN)) :DOCUMENTATION \"Run forward inference rules in module `module'.
If `module' is NULL, the
current module will be used.  If forward inferencing is already up-to-date
in the designated module, no additional inferencing will occur, unless `force'
is set to TRUE, in which case all forward rules are run or rerun.
...
called again.\")" (CL:FUNCTION RUN-FORWARD-RULES) STELLA::NULL)
   (STELLA::DEFINE-FUNCTION-OBJECT "GET-ARITY"
    "(DEFUN (GET-ARITY INTEGER) ((RELATION LOGIC-OBJECT)) :DOCUMENTATION \"Return the arity of the relation `relation'.\")"
    (CL:FUNCTION GET-ARITY) STELLA::NULL)
   (STELLA::DEFINE-FUNCTION-OBJECT "S-GET-ARITY"
    "(DEFUN (S-GET-ARITY INTEGER) ((RELATION-NAME STRING) (MODULE-NAME STRING) (ENVIRONMENT OBJECT)) :DOCUMENTATION \"Return the arity of the relation named `relation-name'.\")"
    (CL:FUNCTION S-GET-ARITY) STELLA::NULL)
   (STELLA::DEFINE-FUNCTION-OBJECT "GET-DOMAIN"
    "(DEFUN (GET-DOMAIN LOGIC-OBJECT) ((RELATION LOGIC-OBJECT)) :DOCUMENTATION \"Return the type (a concept) for the first argument to the binary
relation `relation'.\")" (CL:FUNCTION GET-DOMAIN) STELLA::NULL)
   (STELLA::DEFINE-FUNCTION-OBJECT "S-GET-DOMAIN"
    "(DEFUN (S-GET-DOMAIN LOGIC-OBJECT) ((RELATION-NAME STRING) (MODULE-NAME STRING) (ENVIRONMENT OBJECT)) :DOCUMENTATION \"Return the type (concept) for the first argument to the binary
relation `relation-name'.\")" (CL:FUNCTION S-GET-DOMAIN) STELLA::NULL)
   (STELLA::DEFINE-FUNCTION-OBJECT "GET-RANGE"
    "(DEFUN (GET-RANGE LOGIC-OBJECT) ((RELATION LOGIC-OBJECT)) :DOCUMENTATION \"Return the type (a concept) for fillers of the binary relation
`relation'.\")" (CL:FUNCTION GET-RANGE) STELLA::NULL)
   (STELLA::DEFINE-FUNCTION-OBJECT "S-GET-RANGE"
    "(DEFUN (S-GET-RANGE LOGIC-OBJECT) ((RELATION-NAME STRING) (MODULE-NAME STRING) (ENVIRONMENT OBJECT)) :DOCUMENTATION \"Return the type (a concept) for fillers of the binary relation
`relation-name'.\")" (CL:FUNCTION S-GET-RANGE) STELLA::NULL)
   (STELLA::DEFINE-FUNCTION-OBJECT "GET-NTH-DOMAIN"
    "(DEFUN (GET-NTH-DOMAIN LOGIC-OBJECT) ((RELATION LOGIC-OBJECT) (N INTEGER)) :DOCUMENTATION \"Return the type (a concept) for the the nth argument of the
relation `relation'.  Counting starts at zero.\")"
    (CL:FUNCTION GET-NTH-DOMAIN) STELLA::NULL)
   (STELLA::DEFINE-FUNCTION-OBJECT "S-GET-NTH-DOMAIN"
    "(DEFUN (S-GET-NTH-DOMAIN LOGIC-OBJECT) ((RELATION-NAME STRING) (N INTEGER) (MODULE-NAME STRING) (ENVIRONMENT OBJECT)) :DOCUMENTATION \"Return the type (a concept) for the nth argument of the relation
named `relation-name'.  Counting starts at zero.\")"
    (CL:FUNCTION S-GET-NTH-DOMAIN) STELLA::NULL)
   (STELLA::DEFINE-FUNCTION-OBJECT "LOAD"
    "(DEFUN LOAD ((FILENAME STRING)) :DOCUMENTATION \"Read logic commands from the file named `filename' and evaluate them.
The file should begin with an `in-module' declaration that specifies
the module within which all remaining commands are to be evaluated
The remaining commands are evaluated one-by-one, applying the function
`evaluate' to each of them.\" :PUBLIC? TRUE)" (CL:FUNCTION LOAD) STELLA::NULL)
   (STELLA::DEFINE-FUNCTION-OBJECT "SAVE-MODULE"
    "(DEFUN SAVE-MODULE ((MODULE MODULE) (FILENAME STRING) (IFEXISTS STRING) (ENVIRONMENT OBJECT)) :DOCUMENTATION \"Save the contents of the module `mod' into a file named `filename'.
If a file named `filename' already exists, then the action taken depends on the
value of `ifexists'.  Possible values are \\\"ASK\\\", \\\"REPLACE\\\", \\\"WARN\\\" and \\\"ERROR\\\":
  ...
  ERROR   => Means don't overwrite, signal an error instead.
  ASK     => Ask the user whether to overwrite or not.  If not overwritten, an
             exception is thrown.\" :PUBLIC? TRUE)" (CL:FUNCTION SAVE-MODULE)
    STELLA::NULL)
   (STELLA::DEFINE-FUNCTION-OBJECT "S-SAVE-MODULE"
    "(DEFUN S-SAVE-MODULE ((MODULE-NAME STRING) (FILENAME STRING) (IFEXISTS STRING) (ENVIRONMENT OBJECT)) :DOCUMENTATION \"Save the contents of the module `module-name' into a file named `filename'.
If a file named `filename' already exists, then the action taken depends on the
value of `ifexists'.  Possible values are \\\"ASK\\\", \\\"REPLACE\\\", \\\"WARN\\\" and \\\"ERROR\\\":
  ...
  ERROR   => Means don't overwrite, signal an error instead.
  ASK     => Ask the user whether to overwrite or not.  If not overwritten, an
             exception is thrown.\" :PUBLIC? TRUE)"
    (CL:FUNCTION S-SAVE-MODULE) STELLA::NULL)
   (STELLA::DEFINE-FUNCTION-OBJECT "GET-PREDICATE"
    "(DEFUN (GET-PREDICATE LOGIC-OBJECT) ((PROP PROPOSITION)) :DOCUMENTATION \"Return the concept or relation predicate for
the proposition `prop'.\" :PUBLIC? TRUE)" (CL:FUNCTION GET-PREDICATE)
    STELLA::NULL)
   (STELLA::DEFINE-FUNCTION-OBJECT "GET-COLUMN-COUNT"
    "(DEFUN (GET-COLUMN-COUNT INTEGER) ((OBJ OBJECT)) :DOCUMENTATION \"Return the number of columns in `obj', which must
be of type proposition, cons, vector or PL-iterator.  For a proposition,
the number includes both the predidate and arguments. For the PL-iterator
case,the number of columns is for the current value of the iterator.\" :PUBLIC? TRUE)"
    (CL:FUNCTION GET-COLUMN-COUNT) STELLA::NULL)
   (STELLA::DEFINE-FUNCTION-OBJECT "GET-NTH-VALUE"
    "(DEFUN (GET-NTH-VALUE OBJECT) ((SEQUENCE OBJECT) (N INTEGER)) :DOCUMENTATION \"Return the value in the `nth' column of `sequence'.
Counting starts at zero.  `sequence' must be of type proposition, cons,
vector or PL-iterator.  A zero column number returns a proposition's 
relational predicate.  For the PL-iterator case, the number of columns
is for the current value of the iterator.\" :PUBLIC? TRUE)"
    (CL:FUNCTION GET-NTH-VALUE) STELLA::NULL)
   (STELLA::DEFINE-FUNCTION-OBJECT "GET-NTH-STRING"
    "(DEFUN (GET-NTH-STRING STRING) ((SEQUENCE OBJECT) (N INTEGER)) :DOCUMENTATION \"Return a string representation of the value in the `nth' column of
`sequence'. Counting starts at zero.  `sequence' must be of type
proposition, cons, vector or PL-iterator.  A zero column number returns
a proposition's relational predicate.  For the PL-iterator case, the
the current value pointed to by the iterator is used.  This will always
succeed, even if the `nth' value is not a string object.  In that case, a
string reprensentation will be returned.\" :PUBLIC? TRUE)"
    (CL:FUNCTION GET-NTH-STRING) STELLA::NULL)
   (STELLA::DEFINE-FUNCTION-OBJECT "GET-NTH-INTEGER"
    "(DEFUN (GET-NTH-INTEGER INTEGER) ((SEQUENCE OBJECT) (N INTEGER)) :DOCUMENTATION \"Return an integer representation of the value in the `nth' column of
`sequence'. Counting starts at zero.  `sequence' must be of type
proposition, cons, vector or PL-iterator.  A zero column number returns
a proposition's relational predicate.  For the PL-iterator case, the
the current value pointed to by the iterator is used.  If this is not
an integer value, then NULL-INTEGER will be returned.\" :PUBLIC? TRUE)"
    (CL:FUNCTION GET-NTH-INTEGER) STELLA::NULL)
   (STELLA::DEFINE-FUNCTION-OBJECT "GET-NTH-FLOAT"
    "(DEFUN (GET-NTH-FLOAT FLOAT) ((SEQUENCE OBJECT) (N INTEGER)) :DOCUMENTATION \"Return the floating point value in the `nth' column of
`sequence'. Counting starts at zero.  `sequence' must be of type
proposition, cons, vector or PL-iterator.  A zero column number returns
a proposition's relational predicate.  For the PL-iterator case, the
the current value pointed to by the iterator is used.  If this is not
a floating point value, then NULL-FLOAT will be returned.\" :PUBLIC? TRUE)"
    (CL:FUNCTION GET-NTH-FLOAT) STELLA::NULL)
   (STELLA::DEFINE-FUNCTION-OBJECT "GET-NTH-LOGIC-OBJECT"
    "(DEFUN (GET-NTH-LOGIC-OBJECT LOGIC-OBJECT) ((SEQUENCE OBJECT) (N INTEGER)) :DOCUMENTATION \"Return a logic object representation of the value in the `nth' column
of `sequence'.  Counting starts at zero.  `sequence' must be of type
proposition, cons, vector or PL-iterator.  A zero column number returns
a proposition's relational predicate.  For the PL-iterator case, the
the current value pointed to by the iterator is used.  A zero column number
returns the proposition's relational predicate.\" :PUBLIC? TRUE)"
...
(CL:DEFUN STARTUP-PLI ()
  (CL:LET*
   ...
   (CL:WHEN (STELLA::CURRENT-STARTUP-TIME-PHASE? 4)
    (CL:LET* ((SELF-082 (NEW-ENVIRONMENT)))
     (CL:SETF (STELLA::%LEVEL SELF-082) "ASSERTION")
     (CL:SETQ ASSERTION-ENV SELF-082))
    (CL:LET* ((SELF-083 (NEW-ENVIRONMENT)))
     (CL:SETF (STELLA::%LEVEL SELF-083) "TAXONOMIC")
     (CL:SETQ TAXONOMIC-ENV SELF-083))
    (CL:LET* ((SELF-084 (NEW-ENVIRONMENT)))
     (CL:SETF (STELLA::%LEVEL SELF-084) "INFERENCE")
     (CL:SETQ INFERENCE-ENV SELF-084))
    (CL:LET* ((SELF-085 (NEW-PL-ITERATOR)))
     (CL:SETF (STELLA::%CURSOR SELF-085) STELLA::NIL)
     (CL:SETQ EMPTY-PL-ITERATOR SELF-085)))
   (CL:WHEN (STELLA::CURRENT-STARTUP-TIME-PHASE? 5)
    (CL:LET*
     ((CLASS
       (STELLA::DEFINE-CLASS-FROM-STRINGIFIED-SOURCE "ENVIRONMENT"
        "(DEFCLASS ENVIRONMENT (STANDARD-OBJECT) :SLOTS ((LEVEL :TYPE STRING)) :PRINT-FORM (PRINT-NATIVE-STREAM STREAM \"|ENV|\" (LEVEL SELF)))")))
    ...
    (CL:LET*
     ((CLASS
       (STELLA::DEFINE-CLASS-FROM-STRINGIFIED-SOURCE "PL-ITERATOR"
        "(DEFCLASS PL-ITERATOR (ITERATOR) :PARAMETERS ((ANY-VALUE :TYPE OBJECT)) :SLOTS ((CURSOR :TYPE CONS)))")))
     (CL:SETF (STELLA::%CLASS-CONSTRUCTOR-CODE CLASS)
   ...
   (CL:WHEN (STELLA::CURRENT-STARTUP-TIME-PHASE? 7) (HELP-STARTUP-PLI2)
    ...
    (STELLA::DEFINE-FUNCTION-OBJECT "GET-ENUMERATED-COLLECTION-MEMBERS"
     "(DEFUN (GET-ENUMERATED-COLLECTION-MEMBERS CONS) ((COLLECTION OBJECT)) :DOCUMENTATION \"Returns the members of an enumerated collection.  This works on all types
of collection, i.e., sets and lists\" :PUBLIC? TRUE)"
     (CL:FUNCTION GET-ENUMERATED-COLLECTION-MEMBERS) STELLA::NULL)
    (STELLA::DEFINE-FUNCTION-OBJECT "EVALUATE"
     "(DEFUN (EVALUATE OBJECT) ((COMMAND OBJECT) (MODULE MODULE) (ENVIRONMENT OBJECT)) :DOCUMENTATION \"Evaluate the command `command' within `module' and return
the result. Currently, only the evaluation of (possibly nested) commands and
global variables is supported.  Commands are simple to program in Common Lisp,
since they are built into the language, and relatively awkward in Java and C++.
Users of either of those languages are more likely to want to call `s-evaluate'.\" :PUBLIC? TRUE)"
     (CL:FUNCTION EVALUATE) STELLA::NULL)
    (STELLA::DEFINE-FUNCTION-OBJECT "S-EVALUATE"
     "(DEFUN (S-EVALUATE OBJECT) ((COMMAND STRING) (MODULE-NAME STRING) (ENVIRONMENT OBJECT)) :DOCUMENTATION \"Evaluate the command represented by the string `command' within `module' and
return the result.  Currently, only the evaluation of (possibly nested) commands and
global variables is supported.\" :PUBLIC? TRUE)" (CL:FUNCTION S-EVALUATE)
     STELLA::NULL)
    (STELLA::DEFINE-FUNCTION-OBJECT "IS-LOGIC-OBJECT"
     "(DEFUN (IS-LOGIC-OBJECT BOOLEAN) ((OBJ OBJECT)) :DOCUMENTATION \"Test whether `obj' is of type LOGIC-OBJECT\" :PUBLIC? TRUE)"
     (CL:FUNCTION IS-LOGIC-OBJECT) STELLA::NULL)
    (STELLA::DEFINE-FUNCTION-OBJECT "IS-INTEGER"
     "(DEFUN (IS-INTEGER BOOLEAN) ((OBJ OBJECT)) :DOCUMENTATION \"Test whether `obj' is of type INTEGER\" :PUBLIC? TRUE)"
     (CL:FUNCTION IS-INTEGER) STELLA::NULL)
    (STELLA::DEFINE-FUNCTION-OBJECT "IS-FLOAT"
     "(DEFUN (IS-FLOAT BOOLEAN) ((OBJ OBJECT)) :DOCUMENTATION \"Test whether `obj' is of type FLOAT (double)\" :PUBLIC? TRUE)"
     (CL:FUNCTION IS-FLOAT) STELLA::NULL)
    (STELLA::DEFINE-FUNCTION-OBJECT "IS-NUMBER"
     "(DEFUN (IS-NUMBER BOOLEAN) ((OBJ OBJECT)) :DOCUMENTATION \"Test whether `obj' is of type NUMBER.  This can
be either an integer or a floating point number.  One key characteristic
is that 'object-to-integer' and `object-to-float' will both work on it.\" :PUBLIC? TRUE)"
     (CL:FUNCTION IS-NUMBER) STELLA::NULL)
    (STELLA::DEFINE-FUNCTION-OBJECT "IS-STRING"
     "(DEFUN (IS-STRING BOOLEAN) ((OBJ OBJECT)) :DOCUMENTATION \"Test whether `obj' is of type STRING\" :PUBLIC? TRUE)"
     (CL:FUNCTION IS-STRING) STELLA::NULL)
    (STELLA::DEFINE-FUNCTION-OBJECT "IS-ENUMERATED-COLLECTION"
     "(DEFUN (IS-ENUMERATED-COLLECTION BOOLEAN) ((OBJ OBJECT)) :DOCUMENTATION \"Test whether `obj' is an enumerated collection.  This
subsumes both sets and lists.\" :PUBLIC? TRUE)"
     (CL:FUNCTION IS-ENUMERATED-COLLECTION) STELLA::NULL)
    (STELLA::DEFINE-FUNCTION-OBJECT "IS-ENUMERATED-SET"
     "(DEFUN (IS-ENUMERATED-SET BOOLEAN) ((OBJ OBJECT)) :DOCUMENTATION \"Test whether `obj' is an enumerated set.\" :PUBLIC? TRUE)"
     (CL:FUNCTION IS-ENUMERATED-SET) STELLA::NULL)
    (STELLA::DEFINE-FUNCTION-OBJECT "IS-ENUMERATED-LIST"
     "(DEFUN (IS-ENUMERATED-LIST BOOLEAN) ((OBJ OBJECT)) :DOCUMENTATION \"Test whether `obj' is an enumerated list\" :PUBLIC? TRUE)"
     (CL:FUNCTION IS-ENUMERATED-LIST) STELLA::NULL)
    (STELLA::DEFINE-FUNCTION-OBJECT "IS-TRUE"
     "(DEFUN (IS-TRUE BOOLEAN) ((TV TRUTH-VALUE)) :DOCUMENTATION \"Tests whether `tv' is a true truth value.  It can be true
either absolutely or by default.\" :PUBLIC? TRUE)" (CL:FUNCTION IS-TRUE)
     STELLA::NULL)
    (STELLA::DEFINE-FUNCTION-OBJECT "IS-FALSE"
     "(DEFUN (IS-FALSE BOOLEAN) ((TV TRUTH-VALUE)) :DOCUMENTATION \"Tests whether `tv' is a false truth value.  It can be false
either absolutely or by default.\" :PUBLIC? TRUE)" (CL:FUNCTION IS-FALSE)
     STELLA::NULL)
    (STELLA::DEFINE-FUNCTION-OBJECT "IS-UNKNOWN"
     "(DEFUN (IS-UNKNOWN BOOLEAN) ((TV TRUTH-VALUE)) :DOCUMENTATION \"Tests whether `tv' is an unknown truth value.\" :PUBLIC? TRUE)"
     (CL:FUNCTION IS-UNKNOWN) STELLA::NULL)
    (STELLA::DEFINE-FUNCTION-OBJECT "IS-STRICT"
     "(DEFUN (IS-STRICT BOOLEAN) ((TV TRUTH-VALUE)) :DOCUMENTATION \"Tests whether `tv' is a strict (non-default) truth value.\" :PUBLIC? TRUE)"
     (CL:FUNCTION IS-STRICT) STELLA::NULL)
    (STELLA::DEFINE-FUNCTION-OBJECT "IS-DEFAULT"
     "(DEFUN (IS-DEFAULT BOOLEAN) ((TV TRUTH-VALUE)) :DOCUMENTATION \"Tests whether `tv' is a default truth value.\" :PUBLIC? TRUE)"
     (CL:FUNCTION IS-DEFAULT) STELLA::NULL)
    (STELLA::DEFINE-FUNCTION-OBJECT "ASK"
     "(DEFUN (ASK TRUTH-VALUE) ((QUERY CONS) (MODULE MODULE) (ENVIRONMENT OBJECT)) :DOCUMENTATION \"Returns a truth value for the `query' in `module' and `environment'.
The truth value represents the degree of belief in the answer.  See also the
helping functions `is-true', `is-false' , `is-unknown'.\" :PUBLIC? TRUE)"
     (CL:FUNCTION ASK) STELLA::NULL)
    (STELLA::DEFINE-FUNCTION-OBJECT "S-ASK"
     "(DEFUN (S-ASK TRUTH-VALUE) ((QUERY STRING) (MODULE-NAME STRING) (ENVIRONMENT OBJECT)) :DOCUMENTATION \"Returns a truth value for the `query' in `module-name' and `environment'.
The truth value represents the degree of belief in the answer.  See also the
helping functions `is-true', `is-false' , `is-unknown'.\" :PUBLIC? TRUE)"
     (CL:FUNCTION S-ASK) STELLA::NULL)
    (STELLA::DEFINE-FUNCTION-OBJECT "RETRIEVE"
     "(DEFUN (RETRIEVE PL-ITERATOR) ((QUERY CONS) (MODULE MODULE) (ENVIRONMENT OBJECT)) :DOCUMENTATION \"Returns an iterator for variables that satisfy `query' in `module-name'
and `environment'.  This uses the normal PowerLoom query syntax:
...
iterator will be a value binding.  If a list (even of one variable name)
is provided, then each element in the returned iterator can be accessed
using the `get-nth-'... functions.\" :PUBLIC? TRUE)" (CL:FUNCTION RETRIEVE)
     STELLA::NULL)
    (STELLA::DEFINE-FUNCTION-OBJECT "S-RETRIEVE"
     "(DEFUN (S-RETRIEVE PL-ITERATOR) ((QUERY STRING) (MODULE-NAME STRING) (ENVIRONMENT OBJECT)) :DOCUMENTATION \"Returns an iterator for variables that satisfy `query' in `module-name'
and `environment'.  This uses the normal PowerLoom query syntax:
...
iterator will be a value binding.  If a list (even of one variable name)
is provided, then each element in the returned iterator can be accessed
using the `get-nth-'... functions.\" :PUBLIC? TRUE)" (CL:FUNCTION S-RETRIEVE)
     STELLA::NULL)
    ...
    (CL:LET* ((FUNCTION (STELLA::LOOKUP-FUNCTION SYM-PLI-PLI-STARTUP-PLI)))
     (STELLA::SET-DYNAMIC-SLOT-VALUE (STELLA::%DYNAMIC-SLOTS FUNCTION)
      ...
      (STELLA::WRAP-STRING "_Startup-Pli") STELLA::NULL-STRING-WRAPPER)))
   ...
   (CL:WHEN (STELLA::CURRENT-STARTUP-TIME-PHASE? 9)
    ...
    (STELLA::DEFINE-STELLA-GLOBAL-VARIABLE-FROM-STRINGIFIED-SOURCE
     "(DEFGLOBAL EMPTY-PL-ITERATOR PL-ITERATOR (NEW PL-ITERATOR :CURSOR NIL) :DOCUMENTATION \"Iterator that generates no values.\")")
    (STELLA::DEFINE-STELLA-GLOBAL-VARIABLE-FROM-STRINGIFIED-SOURCE
