...
(CL:DECLAIM
  ...
  *FAIL-UNBOUND-CLAUSES?* NIL TRUE *TABOO-OPERATORS*
...
(CL:DEFCLASS DECISION-TREE (STANDARD-OBJECT)
  ((FEATURE :ALLOCATION :INSTANCE :ACCESSOR %FEATURE)
   (FEATURE-INDEX :TYPE CL:FIXNUM :INITFORM NULL-INTEGER :ALLOCATION
    :INSTANCE :ACCESSOR %FEATURE-INDEX)
...
(CL:DEFUN NEW-DECISION-TREE ()
  (CL:LET* ((SELF NULL))
   ...
   (CL:SETF (%FALSE-BRANCH SELF) NULL)
   (CL:SETF (%TRUE-BRANCH SELF) NULL) (CL:SETF (%CONCEPT SELF) NULL)
   (CL:SETF (%TRUTH-VALUE SELF) FALSE)
...
(CL:DEFUN %INDUCE-INFERENCE-RULES (RELATION-NAME CLASS-NAME)
  ...
  (CL:LET*
   ((CLASS (%SURROGATE-VALUE-INVERSE (GET-DESCRIPTION CLASS-NAME)))
    (RELATION
     (%SURROGATE-VALUE-INVERSE (GET-DESCRIPTION RELATION-NAME)))
   ...
   (CL:COND
    ((CL:EQ *RULE-INDUCTION-STRATEGY* KWD-RULE-INDUCTION-TOP-DOWN)
     ...
     (CL:LET*
      ...
      (CL:LET*
       ((I NULL-INTEGER) (CLAUSE NULL)
        (ITER-002 (%THE-CONS-LIST CLAUSES)) (ITER-003 0))
  ...
  (CL:LET*
   ...
   (CL:COND
    ((CL:EQ *RULE-INDUCTION-STRATEGY* KWD-RULE-INDUCTION-TOP-DOWN)
     ...
     (CL:SETQ *ENABLE-USER-THING* TRUE)
     (CL:LET*
      ((J NULL-INTEGER) (MODULE NULL)
       (ITER-000 (%THE-CONS-LIST MODULES)) (ITER-001 0))
       ...
       (CL:LET*
        ...
        (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-002 NIL)) DO
         ...
         (CL:LET
          ...
          (CL:SETF (CL:AREF SELF POSITION) VALUE))))
       (CL:LET
        ((SELF (%THE-ARRAY INSTANCE-VEC)) (VALUE INSTANCES)
         (POSITION J))
        (CL:DECLARE (CL:TYPE CL:SIMPLE-VECTOR SELF)
         (CL:TYPE CL:FIXNUM POSITION))
        (CL:SETF (CL:AREF SELF POSITION) VALUE))
     ...
     (CL:LET*
      ...
      (CL:LET*
       ((I NULL-INTEGER) (CLAUSE NULL)
        (ITER-004 (%THE-CONS-LIST CLAUSES)) (ITER-005 0))
   ...
   (CL:LET* ((EXAMPLE NULL) (ITER-001 (%THE-CONS-LIST POSITIVE)))
    (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-001 NIL)) DO
     ...
     (CL:SETF (%FACTS EXAMPLE)
      (SUBSTITUTE-CONS-TREE (%FACTS EXAMPLE)
       SYM-RULE-INDUCTION-LOGIC-?Y (%NAME EXAMPLE)))))
   (%%PRINT-STREAM (%NATIVE-STREAM STANDARD-OUTPUT)
...
(CL:DEFUN REMOVE-SIGNATURE-COVERED-EXAMPLES (INDICES EXAMPLES)
  (CL:LET* ((REMOVED (NEW-LIST)))
   (CL:LET*
    ((EXAMPLE NULL) (ITER-000 (%THE-CONS-LIST (COPY EXAMPLES))))
    (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-000 NIL)) DO
     (CL:PROGN (CL:SETQ EXAMPLE (%%VALUE ITER-000))
      (CL:SETQ ITER-000 (%%REST ITER-000)))
    ...
    (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-000 NIL)) DO
     ...
     (CL:IF (CL:> (%WRAPPER-VALUE INDEX) 0)
      (CL:WHEN
       (EQL?
        (CL:AREF
         (CL:THE CL:SIMPLE-VECTOR (%THE-ARRAY (%INPUT EXAMPLE)))
         ACTUAL)
        ZERO-WRAPPER)
...
(CL:DEFUN %TOP-DOWN-RULE-INDUCTION (EXAMPLES)
  (CL:LET*
   ((POSITIVE (NEW-LIST)) (ALL-POSITIVES (NEW-LIST))
    ...
    (CONCEPT (%CONCEPT (FIRST EXAMPLES))) (NUM-RULES 0) (LOOP-CHECK 0)
   ...
   (CL:LET*
    ...
    (CL:LOOP WHILE
     ...
     (CL:PROGN (CL:SETQ PROP (%%VALUE ITER-001))
      (CL:SETQ ITER-001 (%%REST ITER-001)))
     (CL:LET
      ((SELF (%THE-ARRAY PROPOSITION-VECTOR)) (VALUE PROP)
       (POSITION I))
      (CL:DECLARE (CL:TYPE CL:SIMPLE-VECTOR SELF)
       (CL:TYPE CL:FIXNUM POSITION))
      (CL:SETF (CL:AREF SELF POSITION) VALUE))
     (CL:LET
      ((SELF (%THE-ARRAY CONS-PROPS))
      ...
      (CL:T
       (CL:LET* ((STREAM-000 (NEW-OUTPUT-STRING-STREAM)))
        ...
        (CL:ERROR
         (NEW-STELLA-EXCEPTION (THE-STRING-READER STREAM-000)))))))
    (CL:LET*
     ((ANT NULL) (ITER-006 (%THE-CONS-LIST LINKED-ANTECEDENTS)))
     (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-006 NIL)) DO
        ...
        (CL:WHEN (CL:> (LENGTH COVERED) 0)
         (PUSH *INDUCED-DECISION-RULES*
          (LIST* SYM-RULE-INDUCTION-STELLA-=>
           ...
           (CONS CONCEPT (CONS SYM-RULE-INDUCTION-LOGIC-?Y NIL)) NIL))
         (%%PRINT-STREAM (%NATIVE-STREAM STANDARD-OUTPUT)
          "Adding rule to cover " (LENGTH COVERED) " examples"
          EOL))))))
          ...
          (CL:LET*
           ((ELE NULL)
            (ITER-004
             (%THE-CONS-LIST
              (CL:AREF
               (CL:THE CL:SIMPLE-VECTOR (%THE-ARRAY VARIABLE-TABLE))
               I))))
           (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-004 NIL)) DO
   ...
   (CL:LET* ((EXAMPLE NULL) (ITER-000 (%THE-CONS-LIST EXAMPLES)))
    (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-000 NIL)) DO
     ...
     (CL:COND
      ...
      ((EQL?
        (CL:AREF
         (CL:THE CL:SIMPLE-VECTOR (%THE-ARRAY (%INPUT EXAMPLE))) INDEX)
        MATCH-VALUE)
  ...
  (CL:LET*
   ...
   (CL:LOOP WHILE (CL:NOT (EMPTY? COVERED-NEGS)) DO
    (%%PRINT-STREAM (%NATIVE-STREAM STANDARD-OUTPUT) "   Covers "
     (LENGTH COVERED-NEGS) " negs, and " (LENGTH COVERED-POS) " pos"
     EOL)
    (CL:SETQ CURRENT_UTILITY
       ...
       (CL:WHEN FOUND?-000
        (CL:IF (CL:> (%WRAPPER-VALUE I) 0)
         (CL:SETQ GAIN
          (QUERY-FOIL-GAIN
           (CONS
            (CL:AREF
             (CL:THE CL:SIMPLE-VECTOR (%THE-ARRAY PROPOSITIONS))
        ...
        (CL:WHEN (CL:> GAIN MAX)
         (%%PRINT-STREAM (%NATIVE-STREAM STANDARD-OUTPUT)
          ...
          ": " GAIN)
         (CL:IF (CL:< (%WRAPPER-VALUE I) 0)
          (%%PRINT-STREAM (%NATIVE-STREAM STANDARD-OUTPUT) " Negated"
           EOL)
          (%%PRINT-STREAM (%NATIVE-STREAM STANDARD-OUTPUT) EOL))
...
(CL:DEFUN REMOVE-EXCLUDED-EXAMPLES (RULE COVERED-POS COVERED-NEG)
  (CL:LET*
   ((EXAMPLE NULL) (ITER-000 (%THE-CONS-LIST (COPY COVERED-NEG))))
   (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-000 NIL)) DO
    (CL:PROGN (CL:SETQ EXAMPLE (%%VALUE ITER-000))
     (CL:SETQ ITER-000 (%%REST ITER-000)))
  ...
  (CL:LET*
   ((EXAMPLE NULL) (ITER-001 (%THE-CONS-LIST (COPY COVERED-POS))))
   (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-001 NIL)) DO
    (CL:PROGN (CL:SETQ EXAMPLE (%%VALUE ITER-001))
     (CL:SETQ ITER-001 (%%REST ITER-001)))
    (CL:WHEN (CL:NOT (RULE-COVERS-EXAMPLE? RULE EXAMPLE))
  ...
  (CL:LET*
   ...
   (CL:LET* ((EXAMPLE NULL) (ITER-000 (%THE-CONS-LIST EXAMPLES)))
    (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-000 NIL)) DO
     ...
     (CL:LOOP WHILE (CL:NOT (EMPTY? UNLINKED)) DO
      ...
      (CL:LET*
       ((I NULL-INTEGER) (PROP NULL) (VECTOR-000 CONS-PROPS)
   ...
   (CL:LET* ((IT (ALLOCATE-ITERATOR NEW-RULES)))
    (CL:LOOP WHILE (NEXT? IT) DO
     (VALUE-SETTER IT (REVERSE (%VALUE IT)))))
   NEW-RULES))
...
(CL:DEFUN BUILD-DECISION-TREE (EXAMPLES FEATURES FEATURE-STACK)
  (CL:LET*
   ...
   (CL:LET*
    ((I NULL-INTEGER) (FEATURE NULL)
     (ITER-001 (%THE-CONS-LIST FEATURES)) (ITER-002 0))
   ...
   (CL:LET*
    ...
    (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-000 NIL)) DO
     ...
     (CL:IF *LOG-INDUCED-RULES*
      ...
      (%%PRINT-STREAM (%NATIVE-STREAM STANDARD-OUTPUT) "Asserting "
       NAME EOL))
...
(CL:DEFUN HELP-STARTUP-RULE-INDUCTION2 ()
  (CL:PROGN
   ...
   (CL:SETQ *ENABLE-USER-THING* TRUE)
   (CL:SETQ *OPTIMIZE-INDUCED-QUERIES* TRUE)
   (CL:SETQ *SIMPLIFY-RULE-ANTECEDENT?* FALSE)
   (CL:SETQ *TRACE-ID3* FALSE) (CL:SETQ *TRACE-FOIL* FALSE)
   (CL:SETQ *INDUCE-RULES-FROM-SIGNATURES* TRUE)
