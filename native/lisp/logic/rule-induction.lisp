...
(CL:DECLAIM
  ...
  *FAIL-UNBOUND-CLAUSES?* NIL TRUE *TABOO-OPERATORS* *CASE-ANTECEDENT-TABLE*
...
(CL:DEFVAR *ENABLE-USER-THING* FALSE)

;;; (DEFGLOBAL *OPTIMIZE-INDUCED-QUERIES* ...)

(CL:DEFVAR *OPTIMIZE-INDUCED-QUERIES* FALSE)

;;; (DEFGLOBAL *SIMPLIFY-RULE-ANTECEDENT?* ...)

(CL:DEFVAR *SIMPLIFY-RULE-ANTECEDENT?* FALSE
...
(CL:DEFVAR *INDUCE-RULES-FROM-SIGNATURES* FALSE)
...
(CL:DEFVAR *ALLOW-RECURSIVE-DECISION-NODES* FALSE)
...
(CL:DEFUN MODULAR-INDUCE-INFERENCE-RULES (RELATION-NAME CLASS-NAME MODULES)
  ...
  (CL:LET*
   ((CLASS (%SURROGATE-VALUE-INVERSE (GET-DESCRIPTION CLASS-NAME)))
    ...
    (INSTANCES NULL))
   (CL:DECLARE (CL:TYPE CL:FIXNUM NUM)) (CL:SETQ *FAIL-UNBOUND-CLAUSES?* TRUE)
   (CL:WHEN (CL:NOT *ALLOW-RECURSIVE-DECISION-NODES*)
    (INSERT-NEW *TABOO-OPERATORS* RELATION))
   (CL:COND
    ((CL:EQ *RULE-INDUCTION-STRATEGY* KWD-RULE-INDUCTION-TOP-DOWN)
   ...
   (CL:LOOP WHILE
    ...
    (CL:LET*
     ...
     (CL:LOOP WHILE (CL:OR UNBOUNDED?-000 (CL:<= ITER-000 UPPER-BOUND-000)) DO
      ...
      (CL:SETQ I I) (CL:SETQ INDEX1 (RANDOM (LENGTH POSITIVE)))
      ...
      ((SUBTYPE-OF-SYMBOL? TEST-VALUE-000)
       (CL:PROGN
        (CL:WHEN (MEMBER? OUTPUT-VARIABLES TERM)
         (CL:RETURN-FROM CONTAINS-OUTPUT-VARIABLE? TRUE))))
   ...
   (CL:LET* ((CLAUSE NULL) (ITER-004 (COPY-CONS-TREE CLAUSE1)))
    (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-004 NIL)) DO
     ...
     (CL:IF (CL:EQ (%%VALUE CLAUSE) SYM-RULE-INDUCTION-STELLA-NOT)
      (CL:PROGN (CL:SETQ NOT? TRUE) (CL:SETQ PROBE (%%VALUE (%%REST CLAUSE))))
       ...
       (CL:LET* ((TEST-VALUE-000 OPERATOR))
        (CL:COND
         ((CL:OR (CL:EQ TEST-VALUE-000 SYM-RULE-INDUCTION-STELLA->)
          ...
          (CL:SETQ NEW-CLAUSE
           (CONS
            (WRAP-INTEGER (MIN (%WRAPPER-VALUE ARG1) (%WRAPPER-VALUE ARG2)))
            NEW-CLAUSE)))
         ((CL:OR (CL:EQ TEST-VALUE-000 SYM-RULE-INDUCTION-STELLA-<)
           (CL:EQ TEST-VALUE-000 SYM-RULE-INDUCTION-STELLA-=<))
          (CL:SETQ NEW-CLAUSE
           (CONS
            (WRAP-INTEGER (MAX (%WRAPPER-VALUE ARG1) (%WRAPPER-VALUE ARG2)))
            NEW-CLAUSE)))
         (CL:T
          (%%PRINT-STREAM (%NATIVE-STREAM STANDARD-OUTPUT)
        ...
        (CL:LET* ((CLAUSE2 NULL) (ITER-004 (%THE-CONS-LIST ENTRIES)))
         (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-004 NIL)) DO
          (CL:PROGN (CL:SETQ CLAUSE2 (%%VALUE ITER-004))
           (CL:SETQ ITER-004 (%%REST ITER-004)))
          (CL:WHEN (CL:NOT (CL:EQ CLAUSE1 CLAUSE2)) (CL:SETQ SUBSUMED? TRUE)
           (CL:LET*
...
(CL:DEFUN LEARN-ONE-RULE-BOTTOM-UP-FROM-SIGNATURES (POSITIVE NEGATIVE COVERED CONS-PROPS)
  (CL:LET*
   ((TEMP-POSITIVE (COPY POSITIVE)) (MAX 0) (COVER 0) (INDEX1 0) (INDEX2 0)
    ...
    (BEST-INDICES (NEW-LIST)) (LGG NULL) (SIG1 NULL) (SIG2 NULL) (STOP FALSE)
   ...
   (CL:LOOP WHILE (CL:OR (CL:> MAX 0) (CL:EQ LGG NULL)) DO
    ...
    (CL:LET*
     ...
     (CL:LOOP WHILE (CL:OR UNBOUNDED?-000 (CL:<= ITER-001 UPPER-BOUND-000)) DO
      (CL:PROGN (CL:SETQ I ITER-001) (CL:SETQ ITER-001 (CL:1+ ITER-001)))
      (CL:SETQ I I) (CL:SETQ INDEX1 (RANDOM (LENGTH TEMP-POSITIVE)))
    ...
    (CL:LET* ((INDEX NULL) (ITER-004 (%THE-CONS-LIST (COPY BEST-INDICES))))
     (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-004 NIL)) DO
      ...
      (CL:WHEN
       ...
       (%%PRINT-STREAM (%NATIVE-STREAM STANDARD-OUTPUT) "     Removing clause"
        EOL)
       (CL:SETQ BEST-INDICES (REMOVE BEST-INDICES INDEX)) (CL:SETQ STOP FALSE)
       (CL:RETURN)))))
   ...
   (CL:LET* ((CLAUSE NULL) (ITER-004 RULE))
    (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-004 NIL)) DO
     (CL:PROGN (CL:SETQ CLAUSE (%%VALUE ITER-004))
      (CL:SETQ ITER-004 (%%REST ITER-004)))
     (CL:LET*
      ((I NULL-INTEGER) (PROP NULL) (VECTOR-000 PROPOSITIONS) (INDEX-000 0)
       (LENGTH-000 (LENGTH VECTOR-000)) (ITER-005 1))
       ...
       (CL:LET*
        ...
        (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-007 NIL)) DO
         (CL:PROGN (CL:SETQ ELE (%%VALUE ITER-007))
          (CL:SETQ ITER-007 (%%REST ITER-007)))
         (CL:WHEN (MEMBER? VARS ELE) (CL:SETQ FOUND?-000 TRUE) (CL:RETURN))))
       (CL:WHEN FOUND?-000
...
(CL:DEFUN RULE-COVERS-EXAMPLE? (REVERSE-RULE EXAMPLE)
  (CL:WHEN (CL:EQ REVERSE-RULE NIL) (CL:RETURN-FROM RULE-COVERS-EXAMPLE? TRUE))
  (CL:LET*
          ...
          (CL:LET* ((ELE NULL) (ITER-003 TEMP-RULE))
           (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-003 NIL)) DO
            (CL:PROGN (CL:SETQ ELE (%%VALUE ITER-003))
             (CL:SETQ ITER-003 (%%REST ITER-003)))
            (CL:WHEN (EQUAL-CONS-TREES? ELE PROP) (CL:SETQ FOUND?-000 TRUE)
             (CL:RETURN))))
      ...
      (CL:LET* ((FOUND?-001 FALSE))
       (CL:LET* ((ELE NULL) (ITER-005 (%THE-CONS-LIST NEW-RULES)))
        (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-005 NIL)) DO
         (CL:PROGN (CL:SETQ ELE (%%VALUE ITER-005))
          (CL:SETQ ITER-005 (%%REST ITER-005)))
         (CL:WHEN (EQUAL-CONS-TREES? ELE TEMP-RULE) (CL:SETQ FOUND?-001 TRUE)
          (CL:RETURN))))
...
(CL:DEFUN %EVALUATE-RULE-INDUCTION (RELATION-NAME CLASS-NAME NUM-TRIALS CURVE-SPLITS)
  ...
  (CL:LET*
   ...
   (CL:LET*
    ...
    (CL:LOOP WHILE (CL:<= ITER-003 UPPER-BOUND-001) DO
     (CL:PROGN (CL:SETQ SPLIT ITER-003) (CL:SETQ ITER-003 (CL:1+ ITER-003)))
      ...
      (CL:LOOP WHILE (CL:<= ITER-004 UPPER-BOUND-002) DO
       ...
       (CL:LET*
        ...
        (CL:LOOP WHILE (CL:<= ITER-005 UPPER-BOUND-003) DO
         (CL:PROGN (CL:SETQ J ITER-005) (CL:SETQ ITER-005 (CL:1+ ITER-005)))
         (CL:LET
        ...
        (CL:LET*
         ...
         (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-006 NIL)) DO
          (CL:PROGN (CL:SETQ EXAMPLE (%%VALUE ITER-006))
           (CL:SETQ ITER-006 (%%REST ITER-006)))
          (CL:PROGN (CL:SETQ J ITER-007) (CL:SETQ ITER-007 (CL:1+ ITER-007)))
...
(CL:DEFUN HELP-PRINT-DECISION-TREE (TREE LEVEL STREAM)
  ...
  (CL:LET*
   ...
   (CL:LOOP WHILE (CL:OR UNBOUNDED?-000 (CL:<= ITER-000 UPPER-BOUND-000)) DO
    (CL:PROGN (CL:SETQ I ITER-000) (CL:SETQ ITER-000 (CL:1+ ITER-000)))
    (CL:SETQ I I) (%%PRINT-STREAM STREAM "|   ")))
...
(CL:DEFUN HELP-STARTUP-RULE-INDUCTION2 ()
  (CL:PROGN (CL:SETQ *RULE-INDUCTION-STRATEGY* KWD-RULE-INDUCTION-TOP-DOWN)
   (CL:SETQ *SIGNATURE-STRATEGY* KWD-RULE-INDUCTION-TOP-DOWN)
   (CL:SETQ *ENABLE-USER-THING* TRUE)
   (CL:SETQ *OPTIMIZE-INDUCED-QUERIES* TRUE)
   (CL:SETQ *SIMPLIFY-RULE-ANTECEDENT?* FALSE) (CL:SETQ *TRACE-ID3* FALSE)
   (CL:SETQ *TRACE-FOIL* FALSE) (CL:SETQ *INDUCE-RULES-FROM-SIGNATURES* TRUE)
   (CL:SETQ *ENFORCE-LINKED-VARIABLES* FALSE)
   (CL:SETQ *LOG-INDUCED-RULES* FALSE)
   (CL:SETQ *ALLOW-RECURSIVE-DECISION-NODES* TRUE)
   (CL:SETQ *LOG-DECISION-RULE-CONSTRUCTION* FALSE)))

(CL:DEFUN HELP-STARTUP-RULE-INDUCTION3 ()
  (CL:PROGN
...
(CL:DEFUN STARTUP-RULE-INDUCTION ()
  (CL:LET*
   ...
   (CL:WHEN (CURRENT-STARTUP-TIME-PHASE? 4) (HELP-STARTUP-RULE-INDUCTION2))
   ...
   (CL:WHEN (CURRENT-STARTUP-TIME-PHASE? 7) (HELP-STARTUP-RULE-INDUCTION3)
    ...
    (CL:LET*
     ...
     (SET-DYNAMIC-SLOT-VALUE (%DYNAMIC-SLOTS FUNCTION)
      ...
      (WRAP-STRING "_Startup-Rule-Induction") NULL-STRING-WRAPPER)))
