...
(CL:DEFCLASS DECISION-TREE (STANDARD-OBJECT)
  ((FEATURE :ALLOCATION :INSTANCE :ACCESSOR %FEATURE)
   (FEATURE-INDEX :TYPE CL:FIXNUM :INITFORM NULL-INTEGER :ALLOCATION :INSTANCE
    :ACCESSOR %FEATURE-INDEX)
...
(CL:DEFUN NEW-DECISION-TREE ()
  (CL:LET* ((SELF NULL))
   ...
   (CL:SETF (%CONCEPT SELF) NULL) (CL:SETF (%TRUTH-VALUE SELF) CL:NIL)
   (CL:SETF (%PROPOSITION SELF) NULL)
   (CL:SETF (%FEATURE-INDEX SELF) NULL-INTEGER) (CL:SETF (%FEATURE SELF) NULL)
   SELF))
...
(CL:DEFUN ACCESS-DECISION-TREE-SLOT-VALUE (SELF SLOTNAME VALUE SETVALUE?)
  (CL:COND
   ...
   ((CL:EQ SLOTNAME SYM-RULE-INDUCTION-LOGIC-TRUTH-VALUE)
    (CL:IF SETVALUE?
     (CL:SETF (%TRUTH-VALUE SELF) (COERCE-WRAPPED-BOOLEAN-TO-BOOLEAN VALUE))
...
(CL:DEFUN %INDUCE-INFERENCE-RULES (RELATION-NAME CLASS-NAME)
  ...
  (CL:LET*
   ...
   (CL:LET*
    ((INSTANCE NULL) (ITER-000 (%THE-CONS-LIST ILIST)) (I NULL-INTEGER)
     (ITER-001 0))
   ...
   (CL:COND
    ((CL:EQ *RULE-INDUCTION-STRATEGY* KWD-RULE-INDUCTION-TOP-DOWN)
     ...
     (CL:LET*
      ...
      (CL:LET*
       ((CLAUSE NULL) (ITER-002 (%THE-CONS-LIST CLAUSES)) (I NULL-INTEGER)
        (ITER-003 0))
       (CL:DECLARE (CL:TYPE CL:FIXNUM I ITER-003))
       (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-002 NIL)) DO
        (CL:SETQ CLAUSE (%%VALUE ITER-002)) (CL:SETQ I ITER-003)
        (CL:LET
         ((SELF (%THE-ARRAY *CANDIDATE-CLAUSES*)) (VALUE CLAUSE) (POSITION I))
         (CL:DECLARE (CL:TYPE CL:SIMPLE-VECTOR SELF)
          (CL:TYPE CL:FIXNUM POSITION))
         (CL:SETF (CL:AREF SELF POSITION) VALUE))
...
(CL:DEFUN MODULAR-INDUCE-INFERENCE-RULES (RELATION-NAME CLASS-NAME MODULES)
  ...
  (CL:LET*
   ((CLASS (%SURROGATE-VALUE-INVERSE (GET-DESCRIPTION CLASS-NAME)))
    (RELATION (%SURROGATE-VALUE-INVERSE (GET-DESCRIPTION RELATION-NAME)))
    (ILIST (NEW-LIST)) (HOME *MODULE*) (FAIL-UNBOUND *FAIL-UNBOUND-CLAUSES?*)
    (NUM (LENGTH ILIST)) (INSTANCE-VEC (NEW-VECTOR (LENGTH MODULES)))
    (INSTANCES NULL))
   ...
   (CL:COND
    ((CL:EQ *RULE-INDUCTION-STRATEGY* KWD-RULE-INDUCTION-TOP-DOWN)
     ...
     (CL:SETQ *ENABLE-USER-THING* CL:T)
     (CL:LET*
      ((MODULE NULL) (ITER-000 (%THE-CONS-LIST MODULES)) (J NULL-INTEGER)
       (ITER-001 0))
      ...
      (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-000 NIL)) DO
       ...
       (CL:LET*
        ((INSTANCE NULL) (ITER-002 (%THE-CONS-LIST ILIST)) (I NULL-INTEGER)
         (ITER-003 0))
        (CL:DECLARE (CL:TYPE CL:FIXNUM I ITER-003))
        (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-002 NIL)) DO
     ...
     (CL:LET*
      ...
      (CL:SETQ *CANDIDATE-CLAUSES* (NEW-VECTOR (LENGTH CLAUSES)))
      (CL:LET*
       ((CLAUSE NULL) (ITER-004 (%THE-CONS-LIST CLAUSES)) (I NULL-INTEGER)
        (ITER-005 0))
     ...
     (%%PRINT-STREAM (%NATIVE-STREAM STANDARD-OUTPUT)
      "Generating Training Examples" EOL)
     (CL:LET*
      ((MODULE NULL) (ITER-006 (%THE-CONS-LIST MODULES)) (VEC NULL)
       (VECTOR-000 INSTANCE-VEC) (INDEX-000 0)
       (LENGTH-000 (LENGTH VECTOR-000)))
      (CL:DECLARE (CL:TYPE CL:FIXNUM INDEX-000 LENGTH-000))
      (CL:LOOP WHILE
       (CL:AND (CL:NOT (CL:EQ ITER-006 NIL)) (CL:< INDEX-000 LENGTH-000)) DO
    ...
    ((CL:EQ *RULE-INDUCTION-STRATEGY* KWD-RULE-INDUCTION-BOTTOM-UP)
     (CL:SETQ *ENABLE-USER-THING* CL:NIL)
     (CL:LET*
      ((MODULE NULL) (ITER-007 (%THE-CONS-LIST MODULES)) (VEC NULL)
       (VECTOR-001 INSTANCE-VEC) (INDEX-001 0)
       (LENGTH-001 (LENGTH VECTOR-001)))
      (CL:DECLARE (CL:TYPE CL:FIXNUM INDEX-001 LENGTH-001))
      (CL:LOOP WHILE
       (CL:AND (CL:NOT (CL:EQ ITER-007 NIL)) (CL:< INDEX-001 LENGTH-001)) DO
...
(CL:DEFUN %BOTTOM-UP-RULE-INDUCTION (EXAMPLES SIMPLIFY-RULE?)
  (CL:LET*
   ...
   (CL:SETQ ALL-NEGATIVE (COPY NEGATIVE)) (COLLECT-FACTS-IN-EXAMPLES POSITIVE)
...
(CL:DEFUN LEARN-ONE-RULE-BOTTOM-UP (POSITIVE NEGATIVE)
  (CL:LET*
   ((LGG NIL) (RULE NIL) (SCORE 0) (NUM-POSITIVE (LENGTH POSITIVE)) (INDEX1 0)
    (INDEX2 0) (FACTS1 NIL) (FACTS2 NIL) (MAX 0) (COVER 0)
    (NUM-LGGS (CL:* (LENGTH POSITIVE) 5)) (BEST-LGG NIL))
   (CL:DECLARE
    (CL:TYPE CL:FIXNUM SCORE NUM-POSITIVE INDEX1 INDEX2 MAX COVER NUM-LGGS))
   (%%PRINT-STREAM (%NATIVE-STREAM STANDARD-OUTPUT)
   ...
   (CL:LOOP WHILE
    (CL:AND (NON-EMPTY? POSITIVE) (CL:OR (CL:> MAX 0) (CL:EQ RULE NIL))) DO
    (CL:SETQ COVER (CL:+ MAX COVER)) (CL:SETQ MAX 0)
    (%%PRINT-STREAM (%NATIVE-STREAM STANDARD-OUTPUT) "   Current rule covers "
     COVER " positive examples" EOL)
    (%%PRINT-STREAM (%NATIVE-STREAM STANDARD-OUTPUT) "           rule is "
     RULE EOL)
...
(CL:DEFUN SIMPLIFY-ANTECEDENT (ANTECEDENT OUTPUT-VARIABLES POSITIVE NEGATIVE)
  (CL:LET*
   ((NEW-ANTECEDENT NIL) (CANDIDATE NIL) (DISCARDED-POTENTIAL-GENERATORS NIL)
    (COVERED-EXAMPLES 0) (PREVIOUS-COVERED-EXAMPLES 0)
    (SCORE (NUM-EXAMPLES-COVERED ANTECEDENT POSITIVE)))
   (CL:DECLARE
    (CL:TYPE CL:FIXNUM COVERED-EXAMPLES PREVIOUS-COVERED-EXAMPLES SCORE))
   (CL:LOOP WHILE (CL:NOT (CL:EQ ANTECEDENT NIL)) DO
    (CL:LET* ((HEAD-000 (%%VALUE ANTECEDENT)))
     (CL:SETQ ANTECEDENT (%%REST ANTECEDENT)) (CL:SETQ CANDIDATE HEAD-000))
    (CL:IF
     (RULE-COVERS-ANY-EXAMPLE? (APPEND NEW-ANTECEDENT ANTECEDENT) NEGATIVE)
     (CL:SETQ NEW-ANTECEDENT (CONS CANDIDATE NEW-ANTECEDENT))
     (CL:PROGN
      (%%PRINT-STREAM (%NATIVE-STREAM STANDARD-OUTPUT) "Removing clause "
       CANDIDATE EOL)
   ...
   (CL:LOOP WHILE
    ...
    (CL:WHEN (CL:> COVERED-EXAMPLES PREVIOUS-COVERED-EXAMPLES)
     (%%PRINT-STREAM (%NATIVE-STREAM STANDARD-OUTPUT) "Reinserting clause "
      CANDIDATE EOL)
     (CL:SETQ NEW-ANTECEDENT (CONS CANDIDATE NEW-ANTECEDENT))))
   NEW-ANTECEDENT))
...
(CL:DEFUN LEAST-GENERAL-GENERALIZATION (CLAUSE1 CLAUSE2)
  (CL:LET*
   ...
   (CL:LET*
    ((VAR NULL) (ITER-000 (%THE-CONS-LIST VARS1)) (I NULL-INTEGER)
     (ITER-001 0))
    (CL:DECLARE (CL:TYPE CL:FIXNUM I ITER-001))
    (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-000 NIL)) DO
     ...
     (CL:SETQ ITER-001 (CL:1+ ITER-001))))
   (CL:LET*
    ((VAR NULL) (ITER-002 (%THE-CONS-LIST VARS2)) (I NULL-INTEGER)
     (ITER-003 0))
    (CL:DECLARE (CL:TYPE CL:FIXNUM I ITER-003))
    (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-002 NIL)) DO
     ...
     (CL:WHEN (CL:NOT (CL:EQ VAR SYM-RULE-INDUCTION-LOGIC-?Y))
      (CL:SETQ CLAUSE2
       (SUBSTITUTE-CONS-TREE CLAUSE1 VAR
        (INTERN-SYMBOL (CONCATENATE "?B" (STRINGIFY (WRAP-INTEGER I)))))))
     (CL:SETQ ITER-002 (%%REST ITER-002))
     (CL:SETQ ITER-003 (CL:1+ ITER-003))))
...
(CL:DEFUN GENERALIZE-INEQUALITY (PROBE MATCH BINDINGS)
  (CL:LET*
   ((OPERATOR (%%VALUE PROBE)) (NEW-CLAUSE (CONS-LIST OPERATOR)) (VAR NULL))
   (CL:LET*
...
(CL:DEFUN REMOVE-REDUNDANT-CLAUSES (CLAUSES)
  (CL:LET*
   ((RESULT NIL) (TRUE-TABLE (NEW-HASH-TABLE)) (NOT-TABLE (NEW-HASH-TABLE))
    (ENTRIES NULL) (SHARED-VARIABLES (NEW-LIST)) (KNOWN-VARIABLES (NEW-LIST))
       ...
       (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-003 NIL)) DO
        ...
        (CL:LET* ((CLAUSE2 NULL) (ITER-004 (%THE-CONS-LIST ENTRIES)))
         (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-004 NIL)) DO
            ...
            (CL:LOOP WHILE
             ...
             (CL:WHEN
              (CL:AND (CL:NOT (EQUAL-CONS-TREES? ARG1 ARG2))
               (CL:OR (CL:AND (SYMBOL? ARG1) (MEMBER? SHARED-VARIABLES ARG1))
                (CONS? ARG1)))
          ...
          (CL:SETQ ITER-004 (%%REST ITER-004))))
        (CL:WHEN (CL:NOT SUBSUMED?) (CL:SETQ RESULT (CONS CLAUSE1 RESULT)))
      ...
      (CL:LET* ((CLAUSE1 NULL) (ITER-007 (%THE-CONS-LIST ENTRIES)))
       (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-007 NIL)) DO
        ...
        (CL:WHEN (CL:NOT SUBSUMED?)
         (CL:SETQ RESULT
          (CONS (LIST* SYM-RULE-INDUCTION-STELLA-NOT CLAUSE1 NIL) RESULT)))
        (CL:SETQ ITER-007 (%%REST ITER-007)))))
     (CL:SETQ ITER-002 (%%REST ITER-002))))
   RESULT))
...
(CL:DEFUN LEARN-ONE-RULE-BOTTOM-UP-FROM-SIGNATURES (POSITIVE NEGATIVE COVERED CONS-PROPS)
  (CL:LET*
   ((TEMP-POSITIVE (COPY POSITIVE)) (MAX 0) (COVER 0) (INDEX1 0) (INDEX2 0)
    (VEC-SIZE (LENGTH (%INPUT (FIRST NEGATIVE)))) (INDICES NULL)
    (BEST-INDICES (NEW-LIST)) (LGG NULL) (SIG1 NULL) (SIG2 NULL) (STOP CL:NIL)
    (RESULT NIL) (SCORE 0) (NUM-LGGS 0))
   (CL:DECLARE
...
(CL:DEFUN INTERSECT-SIGNATURES (SIG1 SIG2)
  (CL:LET* ((RESULT (NEW-LIST)))
   (CL:LET*
    ((I NULL-INTEGER) (ITER-000 0) (UPPER-BOUND-000 (CL:1- (LENGTH SIG1))))
    (CL:DECLARE (CL:TYPE CL:FIXNUM I ITER-000 UPPER-BOUND-000))
   ...
   (CL:LET* ((EXAMPLE NULL) (ITER-000 (%THE-CONS-LIST (COPY EXAMPLES))))
    (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-000 NIL)) DO
     ...
     (CL:WHEN (SIGNATURE-INDICES-COVER-EXAMPLE? INDICES EXAMPLE)
      (PUSH REMOVED EXAMPLE) (CL:SETQ EXAMPLES (REMOVE EXAMPLES EXAMPLE)))
     (CL:SETQ ITER-000 (%%REST ITER-000))))
   REMOVED))
...
(CL:DECLAIM
 (CL:FTYPE (CL:FUNCTION (CL:T CL:T) CL:FIXNUM) NUM-SIGNATURE-INDICES-COVERED))
...
(CL:DEFUN %TOP-DOWN-RULE-INDUCTION (EXAMPLES)
  (CL:LET*
   ((POSITIVE (NEW-LIST)) (ALL-POSITIVES (NEW-LIST)) (NEGATIVE (NEW-LIST))
    ...
    (NUM-RULES 0) (LOOP-CHECK 0) (SIGNATURES? *INDUCE-RULES-FROM-SIGNATURES*)
    (CONS-PROPS NULL) (PROPS (NEW-LIST)) (PROPOSITION-VECTOR NULL))
   ...
   (CL:LET*
    ((I NULL-INTEGER) (ITER-000 0) (UPPER-BOUND-000 (CL:1- (LENGTH PROPS)))
     (PROP NULL) (ITER-001 (%THE-CONS-LIST PROPS)))
    (CL:DECLARE (CL:TYPE CL:FIXNUM I ITER-000 UPPER-BOUND-000))
    (CL:LOOP WHILE
    ...
    (CL:WHEN *INDUCE-RULES-FROM-SIGNATURES*
     (CL:COND
      ((CL:EQ *SIGNATURE-STRATEGY* KWD-RULE-INDUCTION-BOTTOM-UP)
       (CL:SETQ ANTECEDENT
        (LEARN-ONE-RULE-BOTTOM-UP-FROM-SIGNATURES POSITIVE NEGATIVE COVERED
         CONS-PROPS))
          ...
          (CL:IF (CL:EQ COLLECT-000 NULL)
           (CL:PROGN (CL:SETQ COLLECT-000 (CONS (%%REST TREE-RULE) NIL))
            (CL:IF (CL:EQ (%THE-CONS-LIST LINKED-ANTECEDENTS) NIL)
             ...
             (ADD-CONS-TO-END-OF-CONS-LIST (%THE-CONS-LIST LINKED-ANTECEDENTS)
              COLLECT-000)))
           (CL:PROGN
      ...
      (CL:T
       (CL:LET* ((STREAM-000 (NEW-OUTPUT-STRING-STREAM)))
        (%%PRINT-STREAM (%NATIVE-STREAM STREAM-000) "`" *SIGNATURE-STRATEGY*
         "' is not a valid case option")
        (CL:ERROR (NEW-STELLA-EXCEPTION (THE-STRING-READER STREAM-000)))))))
...
(CL:DEFUN LEARN-ONE-RULE-TOP-DOWN-FROM-SIGNATURES (POSITIVE NEGATIVE COVERED_POS CONS-PROPS)
  (CL:LET*
   ((CURRENT_UTILITY 0.0d0) (RULE (NEW-LIST)) (GAIN 0.0d0) (MAX_GAIN 0.0d0)
    (USED_FEATURES (NEW-LIST)) (NUM_FEATURES 0) (VARS (NEW-LIST))
    (VARIABLE-TABLE NULL) (FEATURE_INDEX 0) (COVERED_NEG (NEW-LIST)))
   ...
   (CL:LET*
    ((EXAMPLE NULL) (ITER-001 (%THE-CONS-LIST NEGATIVE)) (COLLECT-000 NULL))
    (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-001 NIL)) DO
     (CL:SETQ EXAMPLE (%%VALUE ITER-001))
     (CL:IF (CL:EQ COLLECT-000 NULL)
     ...
     (CL:SETQ ITER-001 (%%REST ITER-001))))
   (CL:LET*
    ((EXAMPLE NULL) (ITER-002 (%THE-CONS-LIST POSITIVE)) (COLLECT-001 NULL))
    (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-002 NIL)) DO
     (CL:SETQ EXAMPLE (%%VALUE ITER-002))
   ...
   (CL:LOOP WHILE (CL:NOT (EMPTY? COVERED_NEG)) DO
    ...
    (CL:LET*
     ...
     (CL:LOOP WHILE (CL:OR UNBOUNDED?-001 (CL:<= ITER-003 UPPER-BOUND-001)) DO
      (CL:SETQ I ITER-003)
         ...
         (CL:LET* ((FOUND?-000 CL:NIL))
          (CL:LET*
           ...
           (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-004 NIL)) DO
            ...
            (CL:WHEN (MEMBER? VARS ELE) (CL:SETQ FOUND?-000 CL:T) (CL:RETURN))
            (CL:SETQ ITER-004 (%%REST ITER-004))))
    ...
    (PUSH USED_FEATURES
     (WRAP-INTEGER
      (CL:IF (CL:< FEATURE_INDEX 0) (CL:- 0 FEATURE_INDEX) FEATURE_INDEX)))
    ...
    (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-000 NIL)) DO
     ...
     (CL:COND
      ((CL:<= (LENGTH (%INPUT EXAMPLE)) INDEX)
       (CL:WARN "Bad training example, not enough features.  Needs `~A'~%`~A'"
        (CL:1+ INDEX) (%QUERY EXAMPLE)))
      ((EQL?
        (CL:AREF (CL:THE CL:SIMPLE-VECTOR (%THE-ARRAY (%INPUT EXAMPLE)))
         INDEX)
        MATCH-VALUE)
...
(CL:DECLAIM
 (CL:FTYPE (CL:FUNCTION (CL:FIXNUM CL:DOUBLE-FLOAT CL:T CL:T) CL:DOUBLE-FLOAT)
  FOIL-GAIN))
(CL:DEFUN FOIL-GAIN (FEATURE-INDEX UTILITY COVERED-POS COVERED-NEG)
  ...
  (CL:LET*
   ((MATCH-VALUE (CL:IF (CL:< FEATURE-INDEX 0) ZERO-WRAPPER ONE-WRAPPER))
    (INDEX
     (CL:1-
      (CL:IF (CL:< FEATURE-INDEX 0) (CL:- 0 FEATURE-INDEX) FEATURE-INDEX)))
...
(CL:DECLAIM
 (CL:FTYPE (CL:FUNCTION (CL:FIXNUM CL:FIXNUM) CL:DOUBLE-FLOAT) FOIL-UTILITY))
(CL:DEFUN FOIL-UTILITY (P N)
  ...
  (CL:/
   (CL:THE CL:DOUBLE-FLOAT
    (CL:LOG (CL:THE CL:DOUBLE-FLOAT (CL:/ (CL:FLOAT P 0.0d0) (CL:+ P N)))))
   LOG_2))
...
(CL:DEFUN SPECIALIZE-RULE (RULE PROPOSITIONS POSITIVE NEGATIVE)
  ...
  (CL:LET*
   ((CANDIDATES (NEW-LIST)) (COVERED-NEGS (NEW-LIST)) (COVERED-POS (NEW-LIST))
    (CURRENT_UTILITY 0.0d0) (FEATURE-INDEX 0) (NEW-CLAUSE NIL)
    (VARS (GET-VARIABLES-FROM-CONS-PROPOSITIONS RULE)) (VARIABLE-TABLE NULL)
   ...
   (CL:LET* ((EXAMPLE NULL) (ITER-000 (%THE-CONS-LIST NEGATIVE)))
    (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-000 NIL)) DO
     (CL:SETQ EXAMPLE (%%VALUE ITER-000))
     (CL:WHEN (RULE-COVERS-EXAMPLE? RULE EXAMPLE) (PUSH COVERED-NEGS EXAMPLE))
     (CL:SETQ ITER-000 (%%REST ITER-000))))
   (CL:LET* ((EXAMPLE NULL) (ITER-001 (%THE-CONS-LIST POSITIVE)))
    (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-001 NIL)) DO
     (CL:SETQ EXAMPLE (%%VALUE ITER-001))
     (CL:WHEN (RULE-COVERS-EXAMPLE? RULE EXAMPLE) (PUSH COVERED-POS EXAMPLE))
     (CL:SETQ ITER-001 (%%REST ITER-001))))
   (CL:WHEN (EMPTY? COVERED-NEGS)
    (%%PRINT-STREAM (%NATIVE-STREAM STANDARD-OUTPUT) " No covered negatives"
     EOL)
   ...
   (CL:LET*
    ((I NULL-INTEGER) (ITER-002 1) (UPPER-BOUND-000 (LENGTH PROPOSITIONS)))
    ...
    (CL:LOOP WHILE (CL:<= ITER-002 UPPER-BOUND-000) DO (CL:SETQ I ITER-002)
     ...
     (CL:SETQ ITER-002 (CL:1+ ITER-002))))
   (CL:LET*
    ((I NULL-INTEGER) (ITER-003 1) (UPPER-BOUND-001 (LENGTH PROPOSITIONS)))
    (CL:DECLARE (CL:TYPE CL:FIXNUM I ITER-003 UPPER-BOUND-001))
    (CL:LOOP WHILE (CL:<= ITER-003 UPPER-BOUND-001) DO (CL:SETQ I ITER-003)
     ...
     (CL:LET*
      ...
      (CL:LOOP WHILE (CL:< INDEX-000 LENGTH-000) DO
       ...
       (CL:WHEN (EQUAL-CONS-TREES? PROP CLAUSE)
        (CL:SETQ CANDIDATES (REMOVE CANDIDATES (WRAP-INTEGER I))) (CL:RETURN))
       (CL:WHEN
    ...
    (CL:WHEN (CL:= MAX 0.0d0)
     ...
     (CL:LET* ((POS NULL) (ITER-008 (%THE-CONS-LIST COVERED-POS)))
      (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-008 NIL)) DO
       ...
       (%%PRINT-STREAM (%NATIVE-STREAM STANDARD-OUTPUT) "     " (%NAME POS)
        EOL)
       (CL:SETQ ITER-008 (%%REST ITER-008))))
     ...
     (CL:LET* ((NEG NULL) (ITER-009 (%THE-CONS-LIST COVERED-NEGS)))
      (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-009 NIL)) DO
       ...
       (%%PRINT-STREAM (%NATIVE-STREAM STANDARD-OUTPUT) "     " (%NAME NEG)
        EOL)
       (CL:SETQ ITER-009 (%%REST ITER-009))))
...
(CL:DECLAIM
 (CL:FTYPE (CL:FUNCTION (CL:T CL:DOUBLE-FLOAT CL:T CL:T) CL:DOUBLE-FLOAT)
  QUERY-FOIL-GAIN))
...
(CL:DEFUN GET-COVERED-EXAMPLES (RULE UNCOVERED)
  (CL:LET* ((COVERED (NEW-LIST)))
   (CL:LET*
    ((EXAMPLE NULL) (ITER-000 (%THE-CONS-LIST UNCOVERED)) (COLLECT-000 NULL))
    (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-000 NIL)) DO
     (CL:SETQ EXAMPLE (%%VALUE ITER-000))
     (CL:WHEN (RULE-COVERS-EXAMPLE? RULE EXAMPLE)
      (CL:IF (CL:EQ COLLECT-000 NULL)
...
(CL:DEFUN RULE-COVERS-EXAMPLE? (REVERSE-RULE EXAMPLE)
  ...
  (CL:LET*
   ...
   (CL:SETQ CONS-QUERY
    (CONS SYM-RULE-INDUCTION-STELLA-AND
     (SUBSTITUTE-CONS-TREE RULE (%NAME EXAMPLE) SYM-RULE-INDUCTION-LOGIC-?Y)))
   (CL:WHEN (CL:NOT (EMPTY? VARS))
    (CL:LET* ((VAR NULL) (ITER-000 (%THE-CONS-LIST VARS)))
     (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-000 NIL)) DO
      ...
      (CL:SETQ ITER-000 (%%REST ITER-000))))
    (CL:SETQ CONS-QUERY
     (LIST* SYM-RULE-INDUCTION-STELLA-EXISTS TYPES (CONS CONS-QUERY NIL))))
    ...
    (CL:SETQ QUERY
     (MAKE-QUERY NIL CONS-QUERY NIL
      (LIST* KWD-RULE-INDUCTION-TIMEOUT (WRAP-INTEGER 300)
       KWD-RULE-INDUCTION-DONT-OPTIMIZE? SYM-RULE-INDUCTION-STELLA-TRUE NIL)
      "Rule")))
  ...
  (CL:LET*
   ...
   (CL:LET* ((EXAMPLE NULL) (ITER-000 (%THE-CONS-LIST EXAMPLES)))
    (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-000 NIL)) DO
     ...
     (CL:SETQ TEMP-RULE (COPY-CONS-TREE RULE)) (CL:SETQ UNLINKED (NEW-LIST))
     (CL:SETQ LINKED (NEW-LIST))
         ...
         (CL:LET* ((FOUND?-000 CL:NIL))
          (CL:LET* ((ELE NULL) (ITER-003 TEMP-RULE))
           (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-003 NIL)) DO
            ...
            (CL:WHEN (EQUAL-CONS-TREES? ELE PROP) (CL:SETQ FOUND?-000 CL:T)
             (CL:RETURN))
            (CL:SETQ ITER-003 (%%REST ITER-003))))
          (CL:WHEN FOUND?-000 (PUSH LINKED VAR) (CL:RETURN)))
         (CL:WHEN
          (EQL?
           (CL:AREF (CL:THE CL:SIMPLE-VECTOR (%THE-ARRAY (%INPUT EXAMPLE))) I)
           ONE-WRAPPER)
          (CL:SETQ TEMP-RULE
     ...
     (CL:LET* ((TEST-VALUE-000 CL:NIL))
      (CL:LET* ((FOUND?-001 CL:NIL))
       (CL:LET* ((ELE NULL) (ITER-005 (%THE-CONS-LIST NEW-RULES)))
        (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-005 NIL)) DO
         (CL:SETQ ELE (%%VALUE ITER-005))
         (CL:WHEN (EQUAL-CONS-TREES? ELE TEMP-RULE) (CL:SETQ FOUND?-001 CL:T)
          (CL:RETURN))
         (CL:SETQ ITER-005 (%%REST ITER-005))))
...
(CL:DEFUN %EVALUATE-RULE-INDUCTION (RELATION-NAME CLASS-NAME NUM-TRIALS CURVE-SPLITS)
  ...
  (CL:LET*
   ((CLASS (%SURROGATE-VALUE-INVERSE (GET-DESCRIPTION CLASS-NAME)))
    ...
    (TRAINING-INSTANCES NULL) (INSTANCES (NEW-VECTOR NUM)) (RESULT 0.0d0)
   ...
   (CL:LET*
    ...
    (CL:LOOP WHILE (CL:<= ITER-002 UPPER-BOUND-000) DO (CL:SETQ I ITER-002)
     (CL:LET
      ((SELF (%THE-ARRAY RESULTS)) (VALUE (WRAP-FLOAT 0.0d0)) (POSITION I))
      (CL:DECLARE (CL:TYPE CL:SIMPLE-VECTOR SELF)
       (CL:TYPE CL:FIXNUM POSITION))
      (CL:SETF (CL:AREF SELF POSITION) VALUE))
     (CL:SETQ ITER-002 (CL:1+ ITER-002))))
   (CL:LET*
    ((SPLIT NULL-INTEGER) (ITER-003 0) (UPPER-BOUND-001 (CL:1- CURVE-SPLITS)))
    ...
    (CL:LOOP WHILE (CL:<= ITER-003 UPPER-BOUND-001) DO
     ...
     (CL:LET*
      ...
      (CL:LOOP WHILE (CL:<= ITER-004 UPPER-BOUND-002) DO (CL:SETQ I ITER-004)
       ...
       (CL:SETQ TRAINING-INSTANCES (NEW-VECTOR (CL:TRUNCATE CURRENT-SPLIT)))
       (CL:LET*
       ...
       (CL:LET* ((TRAIN-SET (NEW-LIST)) (TEST-SET (NEW-LIST)))
        (CL:LET*
         ((EXAMPLE NULL) (ITER-006 (%THE-CONS-LIST *TRAINING-EXAMPLES*))
         ...
         ((SELF (%THE-ARRAY RESULTS))
          (VALUE
           (WRAP-FLOAT
            (CL:+
             (%WRAPPER-VALUE
              (CL:AREF (CL:THE CL:SIMPLE-VECTOR (%THE-ARRAY RESULTS)) SPLIT))
             RESULT)))
          (POSITION SPLIT))
         (CL:DECLARE (CL:TYPE CL:SIMPLE-VECTOR SELF)
          (CL:TYPE CL:FIXNUM POSITION))
...
(CL:DEFUN TRAIN-AND-TEST-RULE-INDUCTION (TRAIN-SET TEST-SET)
  (CL:LET*
   ((HOME-MODULE *CONTEXT*)
    ...
    (RESULT 0.0d0))
   (CL:DECLARE (CL:TYPE CL:DOUBLE-FLOAT RESULT)) (CHANGE-MODULE TEST-MODULE)
    ...
    (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-000 NIL)) DO
     ...
     (CL:LET ((SELF (%THE-ARRAY INSTANCE-VEC)) (VALUE INSTANCES) (POSITION J))
      (CL:DECLARE (CL:TYPE CL:SIMPLE-VECTOR SELF)
       (CL:TYPE CL:FIXNUM POSITION))
      (CL:SETF (CL:AREF SELF POSITION) VALUE))
     (GENERATE-CLASSIFICATION-RULE INSTANCES RELATION-NAME CLASS-NAME CL:NIL)
     (CL:SETQ ITER-000 (%%REST ITER-000))
     (CL:SETQ ITER-001 (CL:1+ ITER-001))))
   (CHANGE-MODULE HOME) (BUILD-CLASSIFICATION-RULE RELATION-NAME CLASS-NAME)
   (%%PRINT-STREAM (%NATIVE-STREAM STANDARD-OUTPUT)
    "Generating Training Examples" EOL)
   (CL:LET*
    ((MODULE NULL) (ITER-004 (%THE-CONS-LIST MODULES)) (VEC NULL)
     (VECTOR-000 INSTANCE-VEC) (INDEX-000 0) (LENGTH-000 (LENGTH VECTOR-000)))
    (CL:DECLARE (CL:TYPE CL:FIXNUM INDEX-000 LENGTH-000))
    (CL:LOOP WHILE
     ...
     (CL:SETQ ITER-004 (%%REST ITER-004))
     (CL:SETQ INDEX-000 (CL:1+ INDEX-000))))
   (%%PRINT-STREAM (%NATIVE-STREAM STANDARD-OUTPUT) "Inducing Decision Tree"
    EOL)
   (CL:SETQ TREE (%INDUCE-DECISION-TREE *TRAINING-EXAMPLES*))
   (CL:SETF (%CONCEPT TREE) RELATION-NAME)
   (CL:WHEN (CL:NOT (CL:EQ (%MODULE (FIRST *TRAINING-EXAMPLES*)) NULL))
  ...
  (CL:LET*
   ...
   (CL:LET* ((EXAMPLE NULL) (ITER-000 (%THE-CONS-LIST EXAMPLES)))
    (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-000 NIL)) DO
     ...
     (CL:SETQ ITER-000 (%%REST ITER-000))))
   (CL:IF (CL:> P N) (CL:SETF (%TRUTH-VALUE TREE) CL:T)
    (CL:SETF (%TRUTH-VALUE TREE) CL:NIL))
   (CL:WHEN (CL:OR (CL:= P 0) (CL:= N 0))
    (CL:RETURN-FROM BUILD-DECISION-TREE TREE))
   (CL:SETQ CURRENT-ENTROPY (ENTROPY P N))
   (CL:LET*
    ((FEATURE NULL) (ITER-001 (%THE-CONS-LIST FEATURES)) (I NULL-INTEGER)
     (ITER-002 0))
    ...
    (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-001 NIL)) DO
     ...
     (CL:SETQ ITER-002 (CL:1+ ITER-002))))
   (CL:WHEN *TRACE-ID3*
    (%%PRINT-STREAM (%NATIVE-STREAM STANDARD-OUTPUT) "Splitting on feature "
     SPLIT-FEATURE EOL))
...
(CL:DECLAIM
 (CL:FTYPE (CL:FUNCTION (CL:FIXNUM CL:T) CL:DOUBLE-FLOAT) EXPECTED-ENTROPY))
...
(CL:DEFUN HELP-PRINT-DECISION-TREE (TREE LEVEL STREAM)
  ...
  (CL:WHEN (CL:EQ (%FEATURE TREE) NULL)
   (CL:IF (%TRUTH-VALUE TREE) (%%PRINT-STREAM STREAM "True" EOL)
   ...
   (CL:LET* ((PROP NULL) (ITER-000 (%THE-CONS-LIST PROPS)) (COLLECT-000 NULL))
    (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-000 NIL)) DO
     ...
     (CL:IF (CL:EQ COLLECT-000 NULL)
      ...
      (CL:PROGN
       (CL:SETF (%%REST COLLECT-000) (CONS (PROPOSITION-TO-CONS PROP) NIL))
       (CL:SETQ COLLECT-000 (%%REST COLLECT-000))))
     (CL:SETQ ITER-000 (%%REST ITER-000))))
   (CL:SETQ *INDUCED-DECISION-RULES* (NEW-LIST))
...
(CL:DEFUN EXTRACT-PATHS-FROM-TREE (TREE ANTECEDENT-STACK ANTECEDENT)
  ...
  (CL:LET* ((PROP (PROPOSITION-TO-CONS (%PROPOSITION TREE))))
   (EXTRACT-PATHS-FROM-TREE (%TRUE-BRANCH TREE) (CONS PROP ANTECEDENT-STACK)
    ANTECEDENT)
...
(CL:DEFUN SET-CANDIDATE-CLAUSES (CLASS-NAME)
  (CL:LET*
   ...
   (CL:SETQ *CANDIDATE-CLAUSES* (NEW-VECTOR (LENGTH CLAUSES)))
   (CL:LET*
    ((CLAUSE NULL) (ITER-000 (%THE-CONS-LIST CLAUSES)) (K NULL-INTEGER)
     (ITER-001 0))
    (CL:DECLARE (CL:TYPE CL:FIXNUM K ITER-001))
    (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-000 NIL)) DO
     (CL:SETQ CLAUSE (%%VALUE ITER-000)) (CL:SETQ K ITER-001)
     (CL:LET
      ((SELF (%THE-ARRAY *CANDIDATE-CLAUSES*)) (VALUE CLAUSE) (POSITION K))
      (CL:DECLARE (CL:TYPE CL:SIMPLE-VECTOR SELF)
       (CL:TYPE CL:FIXNUM POSITION))
      (CL:SETF (CL:AREF SELF POSITION) VALUE))
     (CL:SETQ ITER-000 (%%REST ITER-000))
          ...
          (CL:LET* ((TEST-VALUE-001 (SAFE-PRIMARY-TYPE ARG)))
           (CL:COND
            ...
            ((SUBTYPE-OF-SURROGATE? TEST-VALUE-001)
             (CL:PROGN (CL:SETQ VARIABLE (INTERN-SYMBOL (%SYMBOL-NAME ARG)))))
...
(CL:DEFUN HELP-STARTUP-RULE-INDUCTION2 ()
  (CL:PROGN
   ...
   (DEFINE-FUNCTION-OBJECT "ENTROPY"
    "(DEFUN (ENTROPY FLOAT) ((P INTEGER) (N INTEGER)))" (CL:FUNCTION ENTROPY)
    NULL)
...
TRUE if we want to have final rules as general as possible.\" :PUBLIC? TRUE)")
    ...
    (REGISTER-NATIVE-NAME SYM-RULE-INDUCTION-LOGIC-SET-RULE-INDUCTION-STRATEGY
     KWD-RULE-INDUCTION-COMMON-LISP KWD-RULE-INDUCTION-FUNCTION)
    ...
    (REGISTER-NATIVE-NAME SYM-RULE-INDUCTION-LOGIC-INDUCE-INFERENCE-RULES
     KWD-RULE-INDUCTION-COMMON-LISP KWD-RULE-INDUCTION-FUNCTION)
    (REGISTER-NATIVE-NAME SYM-RULE-INDUCTION-LOGIC-BOTTOM-UP-RULE-INDUCTION
     KWD-RULE-INDUCTION-COMMON-LISP KWD-RULE-INDUCTION-FUNCTION)
    (DEFINE-STELLA-GLOBAL-VARIABLE-FROM-STRINGIFIED-SOURCE
