...
(CL:DEFVAR SYM-LOOM-TO-KIF-PL-KERNEL-KB-CARDINALITY-LOWER-BOUND NULL)
(CL:DEFVAR SYM-LOOM-TO-KIF-PL-KERNEL-KB-CARDINALITY-UPPER-BOUND NULL)
(CL:DEFVAR SYM-LOOM-TO-KIF-LOGIC-CARDINALITY NULL)
...
(CL:DEFVAR SYM-LOOM-TO-KIF-LOGIC-VALUE-TYPE NULL)
...
(CL:DEFVAR SYM-LOOM-TO-KIF-LOGIC-RETRACT NULL)
(CL:DEFVAR SYM-LOOM-TO-KIF-LOGIC-ASSERT NULL)
(CL:DEFVAR KWD-LOOM-TO-KIF-3-VALUED-P NULL)
(CL:DEFVAR SYM-LOOM-TO-KIF-LOGIC-ASK NULL)
(CL:DEFVAR SYM-LOOM-TO-KIF-STELLA-NULL NULL)
(CL:DEFVAR SYM-LOOM-TO-KIF-LOGIC-CONSIFY-QUERY NULL)
(CL:DEFVAR SYM-LOOM-TO-KIF-LOGIC-RETRIEVE NULL)
...
(CL:DECLAIM
 (CL:SPECIAL *STARTUP-TIME-PHASE* *MODULE* STANDARD-ERROR *LOGIC-MODULE*
  STANDARD-OUTPUT EOL SYSTEM-DEFINED-ARGUMENT-NAMES))
...
(CL:DEFUN LOOM-ARGUMENT-DESCRIPTION-TO-KIF (TREE ARITY)
  (CL:COND
   ((CL:EQ (SAFE-PRIMARY-TYPE TREE) SGT-LOOM-TO-KIF-STELLA-CONS)
    (CL:PROGN
     (CL:WHEN (CL:EQ (%%VALUE TREE) SYM-LOOM-TO-KIF-STELLA-INVERSE)
    ...
    ((CL:OR (CL:EQ OPERATOR SYM-LOOM-TO-KIF-LOGIC-AT-LEAST)
     ...
     (CL:COND
      ((CL:EQ OPERATOR SYM-LOOM-TO-KIF-LOGIC-AT-LEAST)
       (CL:SETQ OPERATOR
        SYM-LOOM-TO-KIF-PL-KERNEL-KB-CARDINALITY-LOWER-BOUND))
      ((CL:EQ OPERATOR SYM-LOOM-TO-KIF-LOGIC-AT-MOST)
       (CL:SETQ OPERATOR
        SYM-LOOM-TO-KIF-PL-KERNEL-KB-CARDINALITY-UPPER-BOUND))
      ((CL:EQ OPERATOR SYM-LOOM-TO-KIF-LOGIC-EXACTLY)
       (CL:SETQ OPERATOR SYM-LOOM-TO-KIF-LOGIC-CARDINALITY))
      (CL:T
      ...
      (CONS (LOOM-ARGUMENT-DESCRIPTION-TO-KIF ROLE KWD-LOOM-TO-KIF-BINARY)
       (CONS IMPLICITVARIABLE
        (CONS (%%VALUE (%%REST TREE))
         (CONCATENATE
          (CL:IF (CL:NOT (CL:EQ (FOURTH TREE) NULL))
           (CONS-LIST
            (LOOM-ARGUMENT-DESCRIPTION-TO-KIF (FOURTH TREE)
       ...
       (LIST* SYM-LOOM-TO-KIF-STELLA-EXISTS (CONS EXISTSVARIABLE NIL)
        (LIST* SYM-LOOM-TO-KIF-STELLA-=>
         (LIST* SYM-LOOM-TO-KIF-STELLA-AND
          ...
          NIL)
         (CONS
          (LOOM-ARGUMENT-DESCRIPTION-TO-KIF
           (%%VALUE (%%REST (%%REST TREE))) KWD-LOOM-TO-KIF-UNARY)
          (CONS (NTH SYSTEM-DEFINED-ARGUMENT-NAMES 0) NIL))
         NIL)
        NIL))
      (LIST* SYM-LOOM-TO-KIF-LOGIC-VALUE-TYPE
       (LOOM-ARGUMENT-DESCRIPTION-TO-KIF ROLE KWD-LOOM-TO-KIF-BINARY)
       (CONS IMPLICITVARIABLE
        (CONS
         (LOOM-ARGUMENT-DESCRIPTION-TO-KIF
    ...
    ((CL:EQ OPERATOR SYM-LOOM-TO-KIF-LOGIC-THE)
     (LOOM-DESCRIPTION-TO-KIF
      (LIST* SYM-LOOM-TO-KIF-STELLA-AND
       ...
       (LIST* SYM-LOOM-TO-KIF-LOGIC-ALL ROLE
        (CONS (%%VALUE (%%REST (%%REST TREE))) NIL))
       NIL)
     ...
     (CL:LET*
      ...
      (CL:LET*
       ...
       (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-001 NIL)) DO
        (CL:PROGN (CL:SETQ FILLER (%%VALUE ITER-001))
...
(CL:DEFUN LOOM-RELATES-TO-KIF (TREE IMPLICITVARIABLES)
  ...
  (CL:LET*
   ...
   (CL:LET*
    ((V NULL) (ARG NULL) (ITER-001 (%%REST TREE))
...
(CL:DEFUN LOOM-SATISFIES-TO-KIF (TREE IMPLICITVARIABLES)
  (CL:LET*
   ...
   (CL:LET*
    ((V2 NULL) (V1 NULL) (ITER-000 IOVARIABLES)
         ...
         (CL:LET* ((SELFVARIABLE (%%VALUE IMPLICITVARIABLES)) (Y NULL))
          ...
          (CL:LET*
           ...
           (LIST* SYM-LOOM-TO-KIF-STELLA-EXISTS Y
            (CONS
             (CONS SYM-LOOM-TO-KIF-STELLA-AND (CONCATENATE CLAUSES NIL))
             NIL)))))
    ...
    (CL:COND
     ((CL:EQ TREE SYM-LOOM-TO-KIF-LOGIC-<>)
      (LIST* SYM-LOOM-TO-KIF-STELLA-NOT
       ...
       NIL))
     (CL:T
      (CONS TREE (CONCATENATE (COPY-CONS-LIST IMPLICITVARIABLES) NIL)))))))
             ...
             (CL:LET* ((EXPRESSION CLAUSE))
              (CL:SETQ ABOUTCLAUSES
               (CONS
                ...
                ABOUTCLAUSES)))))))
         (CONJOIN-SENTENCES ABOUTCLAUSES)))
       ((CL:EQ TEST-VALUE-000 SYM-LOOM-TO-KIF-LOGIC-CREATE)
        (CONS (%%VALUE (%%REST (%%REST TREE)))
         (CONS (%%VALUE (%%REST TREE)) NIL)))
       (CL:T TREE)))))
   (CL:T TREE)))
    ...
    ((SUBTYPE-OF-KEYWORD? TEST-VALUE-000)
     (CL:PROGN
      (CL:RETURN-FROM ELIMINATE-LOOM-KEYWORDS
       (INTERN-SYMBOL-IN-MODULE (%SYMBOL-NAME TREE) *LOGIC-MODULE*
        FALSE))))
...
(CL:DEFUN TRANSLATE-LOOM-ASSERTIONS (TREE RETRACT?)
  ...
  (CL:LET*
   ((VERB
     (CL:IF RETRACT? SYM-LOOM-TO-KIF-LOGIC-RETRACT
      SYM-LOOM-TO-KIF-LOGIC-ASSERT))
  ...
  (CL:LET*
   ...
   (CL:LET* ((SELF-000 (NEW-PROPERTY-LIST)))
    ...
    (CL:LET* ((OPTIONS SELF-000))
     (CL:LET*
      ((VALUE NULL) (KEYWORD NULL) (ITER-000 (%THE-PLIST OPTIONS)))
      (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-000 NIL)) DO
     ...
     (CL:IF (CL:NOT (CL:EQ SENTENCE NULL))
      (LIST* SYM-LOOM-TO-KIF-LOGIC-ASK SENTENCE NIL) NULL)))))
  ...
  (CL:LET*
   ...
   (CL:LET* ((SELF-000 (NEW-PROPERTY-LIST)))
    ...
    (CL:LET* ((OPTIONS SELF-000) (NULLS NIL))
     ...
     (LIST* SYM-LOOM-TO-KIF-LOGIC-CONSIFY-QUERY
      (LIST* SYM-LOOM-TO-KIF-LOGIC-RETRIEVE SYM-LOOM-TO-KIF-LOGIC-ALL
...
(CL:DEFUN TRANSLATE-LOOM-STATEMENT (TREE)
  (CL:LET* ((TEST-VALUE-000 (%%VALUE TREE)))
   (CL:COND
    ((CL:EQ TEST-VALUE-000 SYM-LOOM-TO-KIF-LOGIC-ASK)
     (TRANSLATE-LOOM-ASK TREE))
    ((CL:EQ TEST-VALUE-000 SYM-LOOM-TO-KIF-LOGIC-RETRIEVE)
     (TRANSLATE-LOOM-RETRIEVE TREE))
    ((CL:EQ TEST-VALUE-000 SYM-LOOM-TO-KIF-LOGIC-TELL)
     (TRANSLATE-LOOM-ASSERTIONS (%%REST TREE) FALSE))
    ((CL:EQ TEST-VALUE-000 SYM-LOOM-TO-KIF-LOGIC-FORGET)
     (TRANSLATE-LOOM-ASSERTIONS (%%REST TREE) TRUE))
    (CL:T
     (CL:LET* ((STREAM-000 (NEW-OUTPUT-STRING-STREAM)))
      (%%PRINT-STREAM (%NATIVE-STREAM STREAM-000) "`" TEST-VALUE-000
       "' is not a valid case option")
       ...
       (CL:SETQ LOCALAXIOMS
        (CONS
         (LIST* SYM-LOOM-TO-KIF-STELLA-= NAME
          (CONS
           (CONS SYM-LOOM-TO-KIF-STELLA-SETOF (CONCATENATE CONCEPTS NIL))
           NIL))
         LOCALAXIOMS)))
      (CL:WHEN EXHAUSTIVE?
       (CL:SETQ LOCALAXIOMS
...
(CL:DEFUN TRANSLATE-LOOM-CHARACTERISTICS (CHARACTERISTICS NAME)
  (CL:LET* ((AXIOMS NIL))
   ...
   (CL:LET* ((CH NULL) (ITER-000 CHARACTERISTICS))
    (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-000 NIL)) DO
     (CL:PROGN (CL:SETQ CH (%%VALUE ITER-000))
      (CL:SETQ ITER-000 (%%REST ITER-000)))
...
(CL:DEFUN TRANSLATE-LOOM-DEFINITION (TREE)
  (CL:LET*
   ((OPERATOR (%%VALUE TREE)) (NAME (%%VALUE (%%REST TREE)))
    ...
    (CONSTRAINTS NIL) (AXIOMS NIL) (KIFDEFINITION NULL)
   ...
   (CL:WHEN (CL:EQ OPERATOR SYM-LOOM-TO-KIF-LOGIC-DEFPROPERTY)
    ...
    (CL:SETQ ARITY 1))
   (CL:LET* ((VALUE NULL) (KEYWORD NULL) (ITER-000 (%THE-PLIST OPTIONS)))
    (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-000 NIL)) DO
     (CL:SETQ KEYWORD (%%VALUE ITER-000))
     (CL:PROGN (CL:SETQ VALUE (%%VALUE (%%REST ITER-000)))
      (CL:SETQ ITER-000 (%%REST (%%REST ITER-000))))
...
(CL:DEFUN HELP-STARTUP-LOOM-TO-KIF1 ()
  (CL:PROGN
   ...
   (CL:SETQ SYM-LOOM-TO-KIF-PL-KERNEL-KB-CARDINALITY-LOWER-BOUND
    (INTERN-RIGID-SYMBOL-WRT-MODULE "CARDINALITY-LOWER-BOUND"
     (GET-STELLA-MODULE "/PL-KERNEL-KB" TRUE) 0))
   (CL:SETQ SYM-LOOM-TO-KIF-PL-KERNEL-KB-CARDINALITY-UPPER-BOUND
    (INTERN-RIGID-SYMBOL-WRT-MODULE "CARDINALITY-UPPER-BOUND"
     (GET-STELLA-MODULE "/PL-KERNEL-KB" TRUE) 0))
   (CL:SETQ SYM-LOOM-TO-KIF-LOGIC-CARDINALITY
    (INTERN-RIGID-SYMBOL-WRT-MODULE "CARDINALITY" NULL 0))
   ...
   (CL:SETQ SYM-LOOM-TO-KIF-STELLA-AND
    (INTERN-RIGID-SYMBOL-WRT-MODULE "AND"
     (GET-STELLA-MODULE "/STELLA" TRUE) 0))
   (CL:SETQ SYM-LOOM-TO-KIF-LOGIC-VALUE-TYPE
   ...
   (CL:SETQ SYM-LOOM-TO-KIF-STELLA-QUOTE
    (INTERN-RIGID-SYMBOL-WRT-MODULE "QUOTE"
     (GET-STELLA-MODULE "/STELLA" TRUE) 0))
   (CL:SETQ SYM-LOOM-TO-KIF-LOGIC-RETRACT
    (INTERN-RIGID-SYMBOL-WRT-MODULE "RETRACT" NULL 0))
   (CL:SETQ SYM-LOOM-TO-KIF-LOGIC-ASSERT
   ...
   (CL:SETQ SYM-LOOM-TO-KIF-LOGIC-ASK
...
(CL:DEFUN HELP-STARTUP-LOOM-TO-KIF2 ()
  (CL:PROGN
   (CL:SETQ SYM-LOOM-TO-KIF-LOGIC-CONSIFY-QUERY
    (INTERN-RIGID-SYMBOL-WRT-MODULE "CONSIFY-QUERY" NULL 0))
   (CL:SETQ SYM-LOOM-TO-KIF-LOGIC-RETRIEVE
   ...
   (CL:WHEN (CURRENT-STARTUP-TIME-PHASE? 7)
    ...
    (CL:LET*
     ...
     (SET-DYNAMIC-SLOT-VALUE (%DYNAMIC-SLOTS FUNCTION)
      ...
      (WRAP-STRING "Startup-Loom-To-Kif") NULL-STRING-WRAPPER)))
