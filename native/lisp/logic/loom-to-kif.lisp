  ...
  (CL:LET*
   ...
   (CL:LET* ((SELF-000 (NEW-PROPERTY-LIST)))
    ...
    (CL:LET* ((OPTIONS SELF-000))
     (CL:LET*
      ((KEYWORD NULL) (VALUE NULL) (ITER-000 (%THE-PLIST OPTIONS)))
      (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-000 NIL)) DO
    ...
    (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-001 NIL)) DO
     ...
     (CL:LET*
      ...
      (CL:SETQ LOCALAXIOMS
       (CONS
        (LIST*
         SYM-LOOM-TO-KIF-PL-KERNEL-KB-MUTUALLY-DISJOINT-COLLECTION NAME
         NIL)
        LOCALAXIOMS))
     ...
     (CL:LET* ((TEST-VALUE-000 CH))
      (CL:COND ((CL:EQ TEST-VALUE-000 KWD-LOOM-TO-KIF-SINGLE-VALUED))
       ((CL:EQ TEST-VALUE-000 KWD-LOOM-TO-KIF-CLOSED-WORLD)
        (CL:SETQ AXIOMS
         (CONS (LIST* SYM-LOOM-TO-KIF-PL-KERNEL-KB-CLOSED NAME NIL)
          AXIOMS)))
       ((CL:EQ TEST-VALUE-000 KWD-LOOM-TO-KIF-COMMUTATIVE)
        (CL:SETQ AXIOMS
         (CONS
          (LIST* SYM-LOOM-TO-KIF-PL-KERNEL-KB-COMMUTATIVE NAME NIL)
          AXIOMS)))
     ...
     (CL:LET* ((TEST-VALUE-000 KEYWORD))
      (CL:COND
       ...
       ((CL:EQ TEST-VALUE-000 KWD-LOOM-TO-KIF-IN-PARTITION)
        (CL:SETQ AXIOMS
         (CONS
          (LIST* SYM-LOOM-TO-KIF-PL-KERNEL-KB-MEMBER-OF NAME
           (CONS VALUE NIL))
          AXIOMS)))
