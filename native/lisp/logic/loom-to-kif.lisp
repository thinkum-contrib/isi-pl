...
(CL:DECLAIM
 (CL:SPECIAL *STARTUP-TIME-PHASE* *MODULE* STANDARD-ERROR *LOGIC-MODULE* FALSE
  TRUE STANDARD-OUTPUT EOL NIL SYSTEM-DEFINED-ARGUMENT-NAMES))
       ...
       (LIST* SYM-LOOM-TO-KIF-STELLA-EXISTS (CONS EXISTSVARIABLE NIL)
        (LIST* SYM-LOOM-TO-KIF-STELLA-=>
         (LIST* SYM-LOOM-TO-KIF-STELLA-AND
          ...
          NIL)
         (CONS
          (LOOM-ARGUMENT-DESCRIPTION-TO-KIF (%%VALUE (%%REST (%%REST TREE)))
           KWD-LOOM-TO-KIF-UNARY)
...
(CL:DEFUN LOOM-RELATES-TO-KIF (TREE IMPLICITVARIABLES)
  ...
  (CL:LET*
   ...
   (CL:LET*
    ((V NULL) (ARG NULL) (ITER-001 (%%REST TREE)) (ITER-002 SKOLEMVARIABLES)
     (COLLECT-000 NULL))
    (CL:LOOP WHILE
...
(CL:DEFUN LOOM-SATISFIES-TO-KIF (TREE IMPLICITVARIABLES)
  (CL:LET*
   ...
   (CL:LET*
    ((V2 NULL) (V1 NULL) (ITER-000 IOVARIABLES) (ITER-001 IMPLICITVARIABLES))
    (CL:LOOP WHILE
         ...
         (CL:LET*
          ...
          (CL:LET* ((FUNCTION NULL) (ITER-005 (%%REST (%%REST TREE))))
           (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-005 NIL)) DO
            (CL:PROGN (CL:SETQ FUNCTION (%%VALUE ITER-005))
    ...
    ((SUBTYPE-OF-KEYWORD? TEST-VALUE-000)
     (CL:PROGN
      (CL:RETURN-FROM ELIMINATE-LOOM-KEYWORDS
       (INTERN-SYMBOL-IN-MODULE (%SYMBOL-NAME TREE) *LOGIC-MODULE* FALSE))))
...
(CL:DEFUN YIELD-IMPLICIT-VARIABLES (ARITY)
  ...
  (CL:LET* ((VARIABLES NIL))
   (CL:LET*
    ((V NULL) (I (INTERVAL 1 ARITY)) (ITER-000 SYSTEM-DEFINED-ARGUMENT-NAMES)
     (COLLECT-000 NULL))
     ...
     (CL:LET* ((TEST-VALUE-000 (%%VALUE TREE)))
      (CL:COND
           ...
           (CL:WHEN (CL:NOT (CL:EQ TRANSLATION NULL))
            (CL:IF (ISA? (%%VALUE TRANSLATION) SGT-LOOM-TO-KIF-STELLA-CONS)
             (CL:LET* ((SUBFORM NULL) (ITER-001 TRANSLATION))
              (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-001 NIL)) DO
               (CL:PROGN (CL:SETQ SUBFORM (%%VALUE ITER-001))
                (CL:SETQ ITER-001 (%%REST ITER-001)))
       ...
       ((CL:OR (CL:EQ TEST-VALUE-000 SYM-LOOM-TO-KIF-LOGIC-CREATE)
         ...
         (CL:EQ TEST-VALUE-000 SYM-LOOM-TO-KIF-LOGIC-DEFCONTEXT)
...
(CL:DEFUN TRANSLATE-LOOM-FILE (INPUT OUTPUT)
  (CL:LET* ((*PRINTREADABLY?* TRUE) (*PRINTPRETTY?* TRUE))
   ...
   (CL:LET* ((IN NULL))
    (CL:UNWIND-PROTECT
     (CL:PROGN (CL:SETQ IN (NEW-INPUT-FILE-STREAM INPUT))
      (CL:LET* ((OUT NULL))
       (CL:UNWIND-PROTECT
        (CL:PROGN (CL:SETQ OUT (NEW-OUTPUT-FILE-STREAM OUTPUT))
         (CL:LET*
           ...
           (CL:COND ((CL:EQ TRANSLATION NULL)) ((CL:EQ TRANSLATION NIL))
            ((ISA? (%%VALUE TRANSLATION) SGT-LOOM-TO-KIF-STELLA-CONS)
             (CL:LET* ((SUBFORM NULL) (ITER-000 TRANSLATION))
              (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-000 NIL)) DO
               (CL:PROGN (CL:SETQ SUBFORM (%%VALUE ITER-000))
                (CL:SETQ ITER-000 (%%REST ITER-000)))
               (%%PRINT-STREAM (%NATIVE-STREAM OUT) SUBFORM EOL EOL))))
            (CL:T (%%PRINT-STREAM (%NATIVE-STREAM OUT) TRANSLATION EOL EOL)))
   ...
   (CL:LET* ((CLAUSE NULL) (ITER-001 PARTITION-LIST))
    (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-001 NIL)) DO
     ...
     (CL:LET*
      ...
      (CL:SETQ LOCALAXIOMS
       (CONS
        (LIST* SYM-LOOM-TO-KIF-LOGIC-MUTUALLY-DISJOINT-COLLECTION NAME NIL)
        LOCALAXIOMS))
      (CL:WHEN (CL:NOT (CL:EQ CONCEPTS NULL))
       (CL:SETQ LOCALAXIOMS
        (CONS
         (LIST* SYM-LOOM-TO-KIF-STELLA-= NAME
          (CONS (CONS SYM-LOOM-TO-KIF-STELLA-SETOF (CONCATENATE CONCEPTS NIL))
           NIL))
         LOCALAXIOMS)))
      (CL:WHEN EXHAUSTIVE?
       (CL:SETQ LOCALAXIOMS
        (CONS
         (LIST* SYM-LOOM-TO-KIF-LOGIC-COVERING NAME (CONS PARENTCONCEPT NIL))
         LOCALAXIOMS)))
      (CL:SETQ AXIOMS
     ...
     (CL:LET* ((TEST-VALUE-000 CH))
      (CL:COND ((CL:EQ TEST-VALUE-000 KWD-LOOM-TO-KIF-SINGLE-VALUED))
       ...
       ((CL:EQ TEST-VALUE-000 KWD-LOOM-TO-KIF-COMMUTATIVE)
        (CL:SETQ AXIOMS
         (CONS (LIST* SYM-LOOM-TO-KIF-LOGIC-COMMUTATIVE NAME NIL) AXIOMS)))
       ((CL:EQ TEST-VALUE-000 KWD-LOOM-TO-KIF-SYMMETRIC)
        (CL:SETQ AXIOMS
         (CONS (LIST* SYM-LOOM-TO-KIF-LOGIC-SYMMETRIC NAME NIL) AXIOMS)))
  ...
  (CL:LET*
     ...
     (CL:LET* ((TEST-VALUE-000 KEYWORD))
      (CL:COND
       ...
       ((CL:EQ TEST-VALUE-000 KWD-LOOM-TO-KIF-IN-PARTITION)
        (CL:SETQ AXIOMS
         (CONS (LIST* SYM-LOOM-TO-KIF-LOGIC-MEMBER-OF NAME (CONS VALUE NIL))
          AXIOMS)))
   ...
   (CL:LET*
    ...
    (CL:LET* ((DEFAULT NULL) (ITER-002 DEFAULTS))
     (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-002 NIL)) DO
      (CL:PROGN (CL:SETQ DEFAULT (%%VALUE ITER-002))
       (CL:SETQ ITER-002 (%%REST ITER-002)))
      (CL:SETQ AXIOMS
  ...
  (CL:LET* ((CONTEXTFORM (%%VALUE (%%REST TREE))))
   (CL:LET* ((TEST-VALUE-000 (SAFE-PRIMARY-TYPE CONTEXTFORM)))
    (CL:COND
     ...
     ((CL:EQ TEST-VALUE-000 SGT-LOOM-TO-KIF-STELLA-CONS)
      (CL:PROGN (TRANSLATE-LOOM-CONTEXT-CHANGE CONTEXTFORM FALSE)))
     (CL:T
      (CL:LET* ((STREAM-000 (NEW-OUTPUT-STRING-STREAM)))
       (%%PRINT-STREAM (%NATIVE-STREAM STREAM-000) "`" TEST-VALUE-000
        "' is not a valid case option")
  ...
  (CL:LET*
   ...
   (CL:WHEN (CURRENT-STARTUP-TIME-PHASE? 7)
    ...
    (DEFINE-FUNCTION-OBJECT "TRANSLATE-LOOM-FILE"
     ...
     (CL:FUNCTION TRANSLATE-LOOM-FILE) NULL)
    ...
    (CL:LET*
     ...
     (SET-DYNAMIC-SLOT-VALUE (%DYNAMIC-SLOTS FUNCTION)
      ...
      (WRAP-STRING "_Startup-Loom-To-Kif") NULL-STRING-WRAPPER)))
