...
(CL:DECLAIM
  ...
  *LOGIC-MODULE* FALSE TRUE STANDARD-OUTPUT EOL NIL
         ...
         (CL:LET*
          ...
          (CL:LOOP WHILE (CL:NOT (CL:EQ FORM NULL)) DO
           ...
           (CL:COND ((CL:EQ TRANSLATION NULL))
            ...
            (CL:T
             (%%PRINT-STREAM (%NATIVE-STREAM OUT) TRANSLATION EOL
              EOL)))
    ...
    (CL:LET* ((CLAUSE NULL) (ITER-000 PARTITIONS))
     (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-000 NIL)) DO
      (CL:PROGN (CL:SETQ CLAUSE (%%VALUE ITER-000))
       (CL:SETQ ITER-000 (%%REST ITER-000)))
      (CL:SETQ PARTITION-LIST
       (CONS (CONS-LIST CLAUSE) PARTITION-LIST)))))
      ...
      (CL:PROGN
       (CL:IF NEEDSQUOTE?
        (CL:PROGN
         (CL:WHEN
          (CL:NOT
           (STRING-EQL? (%SYMBOL-NAME CONTEXTFORM) "SAVEDCONTEXT"))
