...
(CL:DECLAIM
 (CL:SPECIAL *STARTUP-TIME-PHASE* *MODULE* UNKNOWN-TRUTH-VALUE TRUE-WRAPPER
  *CYC-KLUDGES-ENABLED?* *CONTEXT* *DUPLICATE-RULE-SEARCH-DEPTH* NULL-INTEGER
  EMPTY-PROPOSITIONS-ITERATOR *REVERSEPOLARITY?* NULL-FLOAT-WRAPPER
  *DONTUSEDEFAULTKNOWLEDGE?* FALSE-TRUTH-VALUE FALSE-WRAPPER
  *CACHE-SUCCEEDED-GOALS?* *CACHE-FAILED-GOALS?* *DUPLICATE-SUBGOAL-STRATEGY*
  *GENERATE-ALL-PROOFS?* *TRACED-KEYWORDS* TRUE NIL DEFAULT-TRUE-TRUTH-VALUE
  DEFAULT-FALSE-TRUTH-VALUE STANDARD-OUTPUT TRUE-TRUTH-VALUE EOL
  *QUERYITERATOR* NULL-FLOAT FALSE *RECORD-JUSTIFICATIONS?*))
  ...
  (CL:LET*
   ...
   (CL:LOOP WHILE (NEXT? ITERATOR) DO (CL:SETQ CACHEDGOAL (%VALUE ITERATOR))
    (CL:LET* ((ALWAYS?-000 TRUE))
     (CL:LET*
      ((CACHEDBINDING NULL) (ARG NULL) (VECTOR-000 (%ARGUMENTS PROPOSITION))
...
(CL:DEFUN FINISH-CACHED-GOAL-PROCESSING (CACHEDGOAL FRAME SUCCESSORFAILURE CONTINUING?)
  ...
  (CL:WHEN (CL:NOT (CL:EQ (%PARTIAL-MATCH-FRAME FRAME) NULL))
   (SET-FRAME-PARTIAL-TRUTH (%PARTIAL-MATCH-FRAME FRAME)
    (%TRUTH-VALUE CACHEDGOAL) (%POSITIVE-SCORE CACHEDGOAL) NULL-FLOAT TRUE))
  (CL:WHEN
   (CL:AND *RECORD-JUSTIFICATIONS?*
  ...
  (CL:LET*
   ...
   (CL:WHEN
    (CL:AND (CL:EQ RESULT KWD-STRATEGIES-FAILURE) (%REVERSE-POLARITY? FRAME)
     (CL:EQ (%KIND PROPOSITION) KWD-STRATEGIES-FUNCTION)
      ...
      (CL:LET* ((VALUE NULL) (ITER-000 (%%REST ARGUMENTVALUES)))
       (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-000 NIL)) DO
        (CL:PROGN (CL:SETQ VALUE (%%VALUE ITER-000))
         (CL:SETQ ITER-000 (%%REST ITER-000)))
        (CL:WHEN (CL:EQ VALUE NULL) (CL:SETQ FOUND?-000 TRUE) (CL:RETURN))))
     ...
     (CL:LET*
      ...
      (CL:SETF (%TRUTH-VALUE FRAME)
       (WEAKEN-TRUTH-VALUE (PROPAGATE-FRAME-TRUTH-VALUE (%RESULT FRAME) FRAME)
        (ACCESS-IN-CONTEXT OLD-VALUE-000 (%HOME-CONTEXT OBJECT-000) FALSE))))
...
(CL:DEFUN ALLOCATE-ANTECEDENTS-ITERATOR (GOALDESCRIPTION EXTERNALARGUMENTS REVERSEPOLARITY?)
  (CL:LET*
   ((ANTECEDENTS NIL) (ANTECEDENT NULL) (INCOMPATIBLEARGUMENTS? FALSE))
   (CL:LET*
    ((PROP NULL)
     (ITER-000
    ...
    (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-000 NIL)) DO
     ...
     (CL:TAGBODY
      (CL:WHEN
       ...
       (CL:LET*
        ((ARG NULL) (V NULL) (VECTOR-000 (%IO-VARIABLES ANTECEDENT))
         (INDEX-000 0) (LENGTH-000 (LENGTH VECTOR-000))
      ...
      (CL:SETF (%TRUTH-VALUE FRAME)
       (WEAKEN-TRUTH-VALUE (PROPAGATE-FRAME-TRUTH-VALUE (%RESULT FRAME) FRAME)
        (ACCESS-IN-CONTEXT (%TRUTH-VALUE PROVABLERULE)
         (%HOME-CONTEXT PROVABLERULE) FALSE)))
      (CL:RETURN-FROM CONTINUE-CONDITIONAL-ANTECEDENT-PROOF
       (SELECT-PROOF-RESULT TRUE (CL:NOT (CL:EQ (%DOWN FRAME) NULL)) FALSE)))
  ...
  (CL:LET*
   ...
   (CL:WHEN *CYC-KLUDGES-ENABLED?*
    (CL:WHEN (CL:NOT *REVERSEPOLARITY?*)
     (CL:SETQ SCANISAPROPOSITIONS? FALSE)))
   (CL:COND ((CL:EQ MEMBER NULL) (TRY-SCAN-COLLECTION-PROOF FRAME))
    ...
    (SCANISAPROPOSITIONS? (TRY-SCAN-PROPOSITIONS-PROOF FRAME))
    (CL:T
       ...
       (CL:COND
        ...
        (CL:T
         ...
         (CL:SETF (%OPERATOR PROPOSITION)
          (%SURROGATE-VALUE-INVERSE COLLECTION))
         (CL:LET*
          ((I NULL-INTEGER) (ARG NULL) (ITER-000 (%THE-CONS-LIST BRIDGEARGS))
           (ITER-001 0))
       ...
       (CL:PROGN
        (CL:SETQ VAR
         (CL:AREF (CL:THE CL:SIMPLE-VECTOR (%THE-ARRAY VECTOR-000))
          INDEX-000))
        (CL:SETQ INDEX-000 (CL:1+ INDEX-000)))
       (CL:WHEN (CL:NOT (ARGUMENT-BOUND? VAR)) (CL:SETQ FOUND?-000 TRUE)
        (CL:RETURN))))
     (CL:IF FOUND?-000
      (CL:RETURN-FROM TRY-SUBSUMPTION-TEST KWD-STRATEGIES-FAILURE)
       ...
       (CL:PROGN
        (CL:SETQ VAR
         (CL:AREF (CL:THE CL:SIMPLE-VECTOR (%THE-ARRAY VECTOR-001))
          INDEX-001))
        (CL:SETQ INDEX-001 (CL:1+ INDEX-001)))
       (CL:WHEN (CL:NOT (ARGUMENT-BOUND? VAR)) (CL:SETQ FOUND?-001 TRUE)
        (CL:RETURN))))
     (CL:IF FOUND?-001
      (CL:RETURN-FROM TRY-SUBSUMPTION-TEST KWD-STRATEGIES-FAILURE)
  ...
  (CL:LET*
   ...
   (CL:IF (CL:NOT (CL:EQ FIRSTVALUE NULL))
    (CL:IF (CL:NOT (CL:EQ SECONDVALUE NULL))
     ...
     (CL:SETQ SUCCESS? (BIND-VARIABLE-TO-VALUE? SECONDARG FIRSTVALUE TRUE)))
    (CL:IF (CL:NOT (CL:EQ SECONDVALUE NULL))
     (CL:SETQ SUCCESS? (BIND-VARIABLE-TO-VALUE? FIRSTARG SECONDVALUE TRUE))
...
(CL:DEFUN PUSH-MONOTONIC-WORLD ()
  (CL:LET* ((WORLD (PUSH-WORLD)))
   (SET-DYNAMIC-SLOT-VALUE (%DYNAMIC-SLOTS WORLD)
    SYM-STRATEGIES-LOGIC-MONOTONIC? (CL:IF TRUE TRUE-WRAPPER FALSE-WRAPPER)
    FALSE-WRAPPER)
   WORLD))
          ...
          (RECURSIVELY-FASTEN-DOWN-PROPOSITIONS
           (CL:IF (CL:NOT NEGATEDTRUTHVALUE?)
            ...
            (CONJOIN-PROPOSITIONS
             (INHERIT-AS-TOP-LEVEL-PROPOSITION DISJ (NEW-KEY-VALUE-LIST))))
           FALSE))
         (CL:WHEN
          (CL:AND (CL:NOT (CL:EQ *TRACED-KEYWORDS* NULL))
...
(CL:DEFUN HELP-STARTUP-STRATEGIES2 ()
  (CL:PROGN
   ...
   (CL:SETQ SYM-STRATEGIES-STELLA-PHASE
    (INTERN-RIGID-SYMBOL-WRT-MODULE "PHASE" (GET-STELLA-MODULE "/STELLA" TRUE)
     0))
   ...
   (CL:WHEN (CURRENT-STARTUP-TIME-PHASE? 7) (HELP-STARTUP-STRATEGIES3)
    ...
    (CL:LET*
     ...
     (SET-DYNAMIC-SLOT-VALUE (%DYNAMIC-SLOTS FUNCTION)
      ...
      (WRAP-STRING "_Startup-Strategies") NULL-STRING-WRAPPER)))
