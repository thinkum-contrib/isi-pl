...
(CL:DECLAIM
 (CL:SPECIAL *STARTUP-TIME-PHASE* *MODULE* INCONSISTENT-TRUTH-VALUE
  ...
  NULL-FLOAT-WRAPPER *DONTUSEDEFAULTKNOWLEDGE?* *POWERLOOM-EXECUTION-MODE*
  FALSE-WRAPPER *CACHE-SUCCEEDED-GOALS?* *CACHE-FAILED-GOALS?*
  *DUPLICATE-SUBGOAL-STRATEGY* *GENERATE-ALL-PROOFS?* *TRACED-KEYWORDS*
  DEFAULT-TRUE-TRUTH-VALUE DEFAULT-FALSE-TRUTH-VALUE STANDARD-OUTPUT EOL
  TRUE-TRUTH-VALUE *QUERYITERATOR* NULL-FLOAT *RECORD-JUSTIFICATIONS?*
        ...
        (CL:WHEN (TRACE-KEYWORD? KWD-STRATEGIES-GOAL-TREE)
         (CL:LET*
          ...
          (%%PRINT-STREAM (%NATIVE-STREAM STANDARD-OUTPUT) "CLSH: truth="
           (TRUTH-VALUE-TO-STRING TRUTHVALUE CL:T) EOL)))
