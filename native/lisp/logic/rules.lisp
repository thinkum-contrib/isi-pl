...
(CL:DEFVAR SYM-RULES-LOGIC-GET-RULES NULL)
(CL:DEFVAR KWD-RULES-COMMON-LISP NULL)
(CL:DEFVAR SYM-RULES-LOGIC-DELETE-RULES NULL)
(CL:DEFVAR SYM-RULES-LOGIC-PRINT-RULES NULL)
...
(CL:DEFVAR SYM-RULES-STELLA-SURROGATE-VALUE-INVERSE NULL)
(CL:DEFVAR SYM-RULES-LOGIC-TERM-STRINGIFIED-SOURCE NULL)
(CL:DEFVAR KWD-RULES-FORWARD? NULL)
(CL:DEFVAR KWD-RULES-BACKWARD? NULL)
(CL:DEFVAR KWD-RULES-DONT-OPTIMIZE? NULL)
(CL:DEFVAR KWD-RULES-CONCEIVE NULL)
(CL:DEFVAR KWD-RULES-WARNING NULL)
(CL:DEFVAR SYM-RULES-LOGIC-DEFRULE NULL)
...
(CL:DECLAIM
 (CL:SPECIAL *STARTUP-TIME-PHASE* *MODULE* STANDARD-WARNING
  *MOST-RECENT-QUERY* STANDARD-OUTPUT NIL-LIST *CONTEXT* STANDARD-ERROR
  TRUE-WRAPPER FALSE-WRAPPER FALSE-PROPOSITION TRUE-PROPOSITION EOL))
      ...
      (CL:LET* ((TEST-VALUE-000 (%KIND PROPOSITION)))
       (CL:COND
        ((CL:EQ TEST-VALUE-000 KWD-RULES-AND)
         (CL:LET*
          ((G NULL) (VECTOR-001 (%ARGUMENTS PROPOSITION)) (INDEX-001 0)
        ...
        ((CL:EQ TEST-VALUE-000 KWD-RULES-EXISTS)
         (CL:LET*
          ...
          (CL:WHEN (CL:EQ (%KIND EXISTSBODY) KWD-RULES-AND)
           (CL:LET*
            ((G NULL) (VECTOR-002 (%ARGUMENTS EXISTSBODY)) (INDEX-002 0)
     ...
     (CL:COND
      ...
      (CL:T
       (CL:LET* ((STREAM-000 (NEW-OUTPUT-STRING-STREAM)))
        (%%PRINT-STREAM (%NATIVE-STREAM STREAM-000) "`" HEADORTAIL
     ...
     (CL:COND
      ...
      (CL:T
       (CL:LET* ((STREAM-001 (NEW-OUTPUT-STRING-STREAM)))
        (%%PRINT-STREAM (%NATIVE-STREAM STREAM-001) "`" HEADORTAIL
         "' is not a valid case option")
        (CL:ERROR
     ...
     (CL:COND
      ...
      (CL:T
       (CL:LET* ((STREAM-002 (NEW-OUTPUT-STRING-STREAM)))
        (%%PRINT-STREAM (%NATIVE-STREAM STREAM-002) "`" HEADORTAIL
         "' is not a valid case option")
        (CL:ERROR
     ...
     (CL:LET* ((TEST-VALUE-001 FALSE))
      (CL:LET* ((ALWAYS?-000 TRUE))
       (CL:LET* ((A NULL) (ITER-000 (EXTRACT-GOAL-ARGUMENTS PROPOSITION)))
        (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-000 NIL)) DO
         (CL:PROGN (CL:SETQ A (%%VALUE ITER-000))
      ...
      (CL:WHEN TEST-VALUE-001
       (CL:SETQ TEST-VALUE-001
        (CL:AND
         (CL:NOT
          (CL:EQ (EXTRACT-GOAL-DESCRIPTION PROPOSITION HEADORTAIL) NULL))
         (CL:NOT
          (CL:EQ (%OPERATOR PROPOSITION) SGT-RULES-PL-KERNEL-KB-HOLDS)))))
...
(CL:DEFUN ATOMIC-FORALL-ARGUMENT? (FORALLPROP HEADORTAIL)
  (ATOMIC-GOAL-PROPOSITION?
   (CL:IF (CL:EQ HEADORTAIL KWD-RULES-HEAD)
    (CL:AREF
     (CL:THE CL:SIMPLE-VECTOR (%THE-ARRAY (%ARGUMENTS FORALLPROP))) 1)
    (CL:AREF
     (CL:THE CL:SIMPLE-VECTOR (%THE-ARRAY (%ARGUMENTS FORALLPROP))) 0))))
      ...
      (CL:LET*
       ...
       (CL:LOOP WHILE (CL:< INDEX-000 LENGTH-000) DO
        (CL:PROGN
         ...
         (CL:SETQ INDEX-000 (CL:1+ INDEX-000)))
        (CL:IF
         (CL:AND (CL:NOT (CL:EQ (%KIND CONJUNCT) KWD-RULES-AND))
          (ATOMIC-GOAL-PROPOSITION? CONJUNCT))
         (CL:SETQ COUNT (CL:1+ COUNT))
         (CL:RETURN-FROM ATOMIC-GOAL-PROPOSITION? FALSE))))
      (CL:= COUNT 1)))
    (CL:T FALSE))))
...
(CL:DEFUN ATOMIC-GOAL-DESCRIPTION? (DESCRIPTION)
  (CL:WHEN (NAMED-DESCRIPTION? DESCRIPTION)
   (CL:RETURN-FROM ATOMIC-GOAL-DESCRIPTION? TRUE))
  (CL:LET*
   ((COMPLEMENT
   ...
   (CL:IF
    ...
    TRUE (ATOMIC-GOAL-PROPOSITION? (%PROPOSITION DESCRIPTION)))))
...
(CL:DEFUN CHAINABLE-RELATION? (DESCRIPTION HEADORTAIL)
  (CL:WHEN (CL:EQ HEADORTAIL NULL)
   (CL:RETURN-FROM CHAINABLE-RELATION? TRUE))
  ...
  (CL:LET*
   ...
   (CL:LOOP WHILE (CL:< INDEX-000 LENGTH-000) DO
    ...
    (CL:COND
     ((CL:EQ ARG OUTPROP)
      (CL:LET
       ((SELF (%THE-ARRAY (%ARGUMENTS PROPOSITION))) (VALUE INPROP)
        (POSITION I))
...
(CL:DEFUN INVERT-FORALL-AROUND-GOAL (FORALLPROP GOAL HEADORTAIL CONTRAPOSITIVE?)
  (CL:LET*
   ((MAPPING (NEW-KEY-VALUE-LIST))
    ...
    (OLDHEAD
     (CL:AREF
      (CL:THE CL:SIMPLE-VECTOR (%THE-ARRAY (%ARGUMENTS INVERTEDFORALL)))
      1))
    (OLDTAIL
     (CL:AREF
      (CL:THE CL:SIMPLE-VECTOR (%THE-ARRAY (%ARGUMENTS INVERTEDFORALL)))
    ...
    (NEWGOALARGUMENTS (EXTRACT-GOAL-ARGUMENTS NEWGOAL)) (HEADPRIME NULL)
   ...
   (CL:WHEN CONTRAPOSITIVE? (CL:SETQ OLDHEAD (INVERT-PROPOSITION OLDHEAD))
    ...
    (CL:SETQ NEWGOAL
     (EXTRACT-INVERTED-GOAL
      (CL:IF (CL:EQ HEADORTAIL KWD-RULES-HEAD) OLDHEAD OLDTAIL) NEWGOAL))
    (CL:LET
     ((SELF (%THE-ARRAY (%ARGUMENTS INVERTEDFORALL))) (VALUE OLDHEAD)
      (POSITION 0))
     (CL:DECLARE (CL:TYPE CL:SIMPLE-VECTOR SELF)
      (CL:TYPE CL:FIXNUM POSITION))
     (CL:SETF (CL:AREF SELF POSITION) VALUE))
    (CL:LET
     ((SELF (%THE-ARRAY (%ARGUMENTS INVERTEDFORALL))) (VALUE OLDTAIL)
      (POSITION 1))
     (CL:DECLARE (CL:TYPE CL:SIMPLE-VECTOR SELF)
      (CL:TYPE CL:FIXNUM POSITION))
     (CL:SETF (CL:AREF SELF POSITION) VALUE))
   ...
   (CL:LET* ((TEST-VALUE-000 FALSE))
    ...
    (CL:WHEN TEST-VALUE-000
     (CL:LET* ((ALWAYS?-000 TRUE))
      (CL:LET*
       ((V NULL) (ARG NULL) (ITER-000 NEWGOALARGUMENTS)
        (VECTOR-000
         (DYNAMIC-SLOT-VALUE (%DYNAMIC-SLOTS INVERTEDFORALL)
          SYM-RULES-LOGIC-IO-VARIABLES NULL))
        (INDEX-000 0) (LENGTH-000 (LENGTH VECTOR-000)))
       (CL:DECLARE (CL:TYPE CL:FIXNUM INDEX-000 LENGTH-000))
       (CL:LOOP WHILE
        ...
        (CL:PROGN
         (CL:SETQ V
          (CL:AREF (CL:THE CL:SIMPLE-VECTOR (%THE-ARRAY VECTOR-000))
           INDEX-000))
         (CL:SETQ INDEX-000 (CL:1+ INDEX-000)))
        (CL:WHEN (CL:NOT (CL:EQ ARG V)) (CL:SETQ ALWAYS?-000 FALSE)
         (CL:RETURN))))
   ...
   (CL:COND
    ((CL:EQ HEADORTAIL KWD-RULES-HEAD)
     ...
     (CL:IF (CL:EQ (%OPERATOR HEADPRIME) SGT-RULES-STELLA-FALSE)
     ...
     (CL:LET
      ((SELF (%THE-ARRAY (%ARGUMENTS INVERTEDFORALL))) (VALUE NEWTAIL)
       (POSITION 0))
      (CL:DECLARE (CL:TYPE CL:SIMPLE-VECTOR SELF)
       (CL:TYPE CL:FIXNUM POSITION))
      (CL:SETF (CL:AREF SELF POSITION) VALUE))
     (CL:LET
      ((SELF (%THE-ARRAY (%ARGUMENTS INVERTEDFORALL))) (VALUE NEWGOAL)
       (POSITION 1))
      (CL:DECLARE (CL:TYPE CL:SIMPLE-VECTOR SELF)
       (CL:TYPE CL:FIXNUM POSITION))
      (CL:SETF (CL:AREF SELF POSITION) VALUE)))
    ((CL:EQ HEADORTAIL KWD-RULES-TAIL)
     ...
     (CL:IF (CL:EQ (%OPERATOR TAILPRIME) SGT-RULES-STELLA-TRUE)
      ...
      (CL:LET* ((RESIDUEVARIABLES NIL))
       ...
       (CL:WHEN (CL:NOT (CL:EQ RESIDUEVARIABLES NIL))
        (CL:LET*
         ((NESTEDFORALL (CREATE-PROPOSITION SYM-RULES-STELLA-FORALL 2)))
         (SET-DYNAMIC-SLOT-VALUE (%DYNAMIC-SLOTS NESTEDFORALL)
          SYM-RULES-LOGIC-IO-VARIABLES
          (COPY-CONS-LIST-TO-VARIABLES-VECTOR RESIDUEVARIABLES) NULL)
         (CL:LET
          ((SELF (%THE-ARRAY (%ARGUMENTS NESTEDFORALL)))
           (VALUE TRUE-PROPOSITION) (POSITION 0))
          (CL:DECLARE (CL:TYPE CL:SIMPLE-VECTOR SELF)
           (CL:TYPE CL:FIXNUM POSITION))
          (CL:SETF (CL:AREF SELF POSITION) VALUE))
         (CL:LET
          ((SELF (%THE-ARRAY (%ARGUMENTS NESTEDFORALL))) (VALUE NEWHEAD)
           (POSITION 1))
          (CL:DECLARE (CL:TYPE CL:SIMPLE-VECTOR SELF)
           (CL:TYPE CL:FIXNUM POSITION))
          (CL:SETF (CL:AREF SELF POSITION) VALUE))
     ...
     (CL:LET
      ...
      (CL:SETF (CL:AREF SELF POSITION) VALUE))
     (CL:LET
      ((SELF (%THE-ARRAY (%ARGUMENTS INVERTEDFORALL))) (VALUE NEWHEAD)
       (POSITION 1))
      (CL:DECLARE (CL:TYPE CL:SIMPLE-VECTOR SELF)
       (CL:TYPE CL:FIXNUM POSITION))
      (CL:SETF (CL:AREF SELF POSITION) VALUE)))
   ...
   (CL:LET* ((NEWVARIABLES (EXTRACT-GOAL-ARGUMENTS NEWGOAL)))
    (CL:LET*
     ((I NULL-INTEGER) (V NULL) (ITER-001 NEWVARIABLES) (ITER-002 0))
     ...
     (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-001 NIL)) DO
      ...
      (CL:WHEN (CL:NOT (ISA? V SGT-RULES-LOGIC-PATTERN-VARIABLE))
       (CL:LET* ((CONSTANTVBL (CREATE-VARIABLE NULL NULL FALSE)))
           ...
           ((SELF (%THE-ARRAY (%ARGUMENTS INVERTEDFORALL)))
            (VALUE
             (CONJOIN-TWO-PROPOSITIONS
              ...
              (CL:AREF
               (CL:THE CL:SIMPLE-VECTOR
                (%THE-ARRAY (%ARGUMENTS INVERTEDFORALL)))
               0)))
            (POSITION 0))
           (CL:DECLARE (CL:TYPE CL:SIMPLE-VECTOR SELF)
            (CL:TYPE CL:FIXNUM POSITION))
        ...
        (NORMALIZE-PROPOSITION
         (CL:AREF
          (CL:THE CL:SIMPLE-VECTOR
           (%THE-ARRAY (%ARGUMENTS INVERTEDFORALL)))
          0))))))
    (SET-DYNAMIC-SLOT-VALUE (%DYNAMIC-SLOTS INVERTEDFORALL)
     SYM-RULES-LOGIC-IO-VARIABLES
  ...
  (CL:LET*
   ((DESCRIPTION (NEW-DESCRIPTION))
    (FORALLVARIABLES
     (DYNAMIC-SLOT-VALUE (%DYNAMIC-SLOTS FORALLPROP)
      SYM-RULES-LOGIC-IO-VARIABLES NULL))
    (IOVARIABLES (NEW-VECTOR (LENGTH FORALLVARIABLES))))
   (CL:SETF (%PROPOSITION DESCRIPTION)
    (CL:AREF
     (CL:THE CL:SIMPLE-VECTOR (%THE-ARRAY (%ARGUMENTS FORALLPROP)))
     (CL:THE CL:FIXNUM (CL:IF (CL:EQ HEADORTAIL KWD-RULES-HEAD) 1 0))))
   (CL:LET*
    ((I NULL-INTEGER) (V NULL) (VECTOR-000 FORALLVARIABLES) (INDEX-000 0)
    ...
    (CL:LOOP WHILE (CL:< INDEX-000 LENGTH-000) DO
     (CL:PROGN
      ...
      (CL:SETQ INDEX-000 (CL:1+ INDEX-000)))
     (CL:PROGN (CL:SETQ I ITER-000) (CL:SETQ ITER-000 (CL:1+ ITER-000)))
     (CL:LET ((SELF (%THE-ARRAY IOVARIABLES)) (VALUE V) (POSITION I))
      (CL:DECLARE (CL:TYPE CL:SIMPLE-VECTOR SELF)
       (CL:TYPE CL:FIXNUM POSITION))
      (CL:SETF (CL:AREF SELF POSITION) VALUE))))
   (CL:SETF (%IO-VARIABLES DESCRIPTION) IOVARIABLES)
  ...
  (CL:LET*
   ...
   (CL:WHEN
    ...
    (SET-DYNAMIC-SLOT-VALUE (%DYNAMIC-SLOTS IMPLIESPROP)
     SYM-RULES-LOGIC-FORWARD-ONLY? (CL:IF TRUE TRUE-WRAPPER FALSE-WRAPPER)
     FALSE-WRAPPER))))
...
(CL:DEFUN DERIVE-ONE-SATELLITE-RULE (MASTERFORALL GOAL HEADORTAIL CONTRAPOSITIVE?)
  (CL:LET*
    ...
    (CL:AND (CL:EQ HEADORTAIL KWD-RULES-TAIL)
     (CL:OR
      (CL:NOT
       (ATOMIC-GOAL-PROPOSITION?
        (CL:AREF
         (CL:THE CL:SIMPLE-VECTOR (%THE-ARRAY (%ARGUMENTS MASTERFORALL)))
         0)))
   ...
   (CL:WHEN
    (CL:AND
     (%WRAPPER-VALUE
      (DYNAMIC-SLOT-VALUE (%DYNAMIC-SLOTS MASTERFORALL)
   ...
   (CL:LET* ((IMPLIESPROP (CREATE-IMPLIES-PROPOSITION TAIL HEAD)))
    ...
    (CL:WHEN (EMPTY? (SATELLITE-PROPOSITIONS MASTERFORALL))
     (SET-DYNAMIC-SLOT-VALUE (%DYNAMIC-SLOTS MASTERFORALL)
    ...
    (CL:WHEN
     ...
     (CL:WHEN (CL:EQ (NATIVE-RELATION TAIL) NULL)
      (SET-DYNAMIC-SLOT-VALUE (%DYNAMIC-SLOTS TAIL)
       SYM-RULES-LOGIC-DONT-OPTIMIZE?
       (CL:IF TRUE TRUE-WRAPPER FALSE-WRAPPER) FALSE-WRAPPER))
     (CL:SETQ HEAD
      (CL:AREF
     ...
     (CL:WHEN (CL:EQ (NATIVE-RELATION HEAD) NULL)
      (SET-DYNAMIC-SLOT-VALUE (%DYNAMIC-SLOTS HEAD)
       SYM-RULES-LOGIC-DONT-OPTIMIZE?
       (CL:IF TRUE TRUE-WRAPPER FALSE-WRAPPER) FALSE-WRAPPER))))))

;;; (DEFUN EQUATE-AND-SIMPLIFY-FORALL-ARGUMENT ...)

(CL:DEFUN EQUATE-AND-SIMPLIFY-FORALL-ARGUMENT (PROPOSITION)
  (CL:LET* ((*EVALUATIONMODE* KWD-RULES-DESCRIPTION))
   (CL:DECLARE (CL:SPECIAL *EVALUATIONMODE*))
   (CL:HANDLER-CASE (EQUATE-TOP-LEVEL-EQUIVALENCES PROPOSITION)
    (CLASH (E)
     (%%PRINT-STREAM (%NATIVE-STREAM STANDARD-ERROR)
      (EXCEPTION-MESSAGE E))))
   (TIGHTEN-ARGUMENT-BINDINGS PROPOSITION NULL)
   (SIMPLIFY-PROPOSITION PROPOSITION)))

;;; (DEFGLOBAL *LAZY-SATELLITE-RULES?* ...)

(CL:DEFVAR *LAZY-SATELLITE-RULES?* TRUE
   ...
   (CL:LET*
    ...
    (CL:LET*
     ...
     (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-000 NIL)) DO
      ...
      (CL:WHEN
       ...
       (CL:SETQ CREATEDSATELLITES? TRUE)
       (CL:COND
        (LAZYSATELLITES?
         ...
         (CL:WHEN
          (CL:EQ
           (DYNAMIC-SLOT-VALUE (%DYNAMIC-SLOTS GOALDESC)
            SYM-RULES-LOGIC-RULES-WITH-DEFERRED-SATELLITES NULL)
           NULL)
          (SET-DYNAMIC-SLOT-VALUE (%DYNAMIC-SLOTS GOALDESC)
       ...
       (CL:WHEN
        ...
        (CL:COND
         (LAZYSATELLITES?
          (SET-DYNAMIC-SLOT-VALUE (%DYNAMIC-SLOTS GOALDESC)
           SYM-RULES-LOGIC-DEFERRED-CONTRAPOSITIVES? TRUE-WRAPPER NULL))
         (CL:T
          (DERIVE-ONE-SATELLITE-RULE FORALLPROP GOAL KWD-RULES-HEAD
           TRUE)))))))
    (CL:WHEN
     ...
     (CL:LET*
      ...
      (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-001 NIL)) DO
       (CL:PROGN (CL:SETQ GOAL (%%VALUE ITER-001))
        (CL:SETQ ITER-001 (%%REST ITER-001)))
       (CL:WHEN
        (CL:OR (CL:EQ GOALDESCRIPTION NULL)
         (CL:EQ GOALDESCRIPTION
    ...
    (CL:WHEN
     (CL:AND CREATEDSATELLITES?
      (CL:NOT
       (CL:EQ
        (ACCESS-IN-CONTEXT (%TRUTH-VALUE FORALLPROP)
         (%HOME-CONTEXT FORALLPROP) FALSE)
        NULL)))
     (CL:LET*
      ((*CONTEXT* (%HOME-CONTEXT FORALLPROP))
       (*MODULE* (%BASE-MODULE *CONTEXT*)))
      ...
      (CL:LET* ((*INVISIBLEASSERTION?* TRUE))
       ...
       (CL:LET*
        ((SATELLITE NULL)
         (ITER-002 (%THE-CONS-LIST (SATELLITE-PROPOSITIONS FORALLPROP))))
        (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-002 NIL)) DO
         (CL:PROGN (CL:SETQ SATELLITE (%%VALUE ITER-002))
...
(CL:DEFUN DERIVE-SATELLITE-RULES (FORALLPROP)
  (EQUATE-AND-SIMPLIFY-FORALL-ARGUMENT
   ...
   (CL:LET*
    ...
    (CL:WHEN (CL:NOT (CL:EQ QUEUEDRULES NULL))
     (CL:LET*
      ...
      (CL:LOOP WHILE (NEXT? ITER-000) DO
       (CL:SETQ FORALLPROP (%VALUE ITER-000))
    ...
    (CL:WHEN
     (CL:AND (CL:NOT (CL:EQ COMPLEMENT NULL))
      (CL:NOT
       (CL:EQ
        (DYNAMIC-SLOT-VALUE (%DYNAMIC-SLOTS COMPLEMENT)
         SYM-RULES-LOGIC-RULES-WITH-DEFERRED-SATELLITES NULL)
        NULL)))
...
(CL:DEFUN DERIVE-DEFERRED-CONTRAPOSITIVE-SATELLITE-RULES (SELF)
  (CL:WHEN *LAZY-SATELLITE-RULES?*
   (CL:WHEN
    (COERCE-WRAPPED-BOOLEAN-TO-BOOLEAN (DEFERRED-CONTRAPOSITIVES? SELF))
    (CL:LET* ((MASTERPROPOSITION NULL) (QUEUEDRULES (NEW-LIST)))
     ...
     (CL:LET* ((FORALLPROP NULL) (ITER-001 (%THE-CONS-LIST QUEUEDRULES)))
      (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-001 NIL)) DO
       (CL:PROGN (CL:SETQ FORALLPROP (%%VALUE ITER-001))
        (CL:SETQ ITER-001 (%%REST ITER-001)))
       (DERIVE-SATELLITE-RULES-FOR-GOAL? FORALLPROP SELF
        KWD-RULES-CONTRAPOSITIVE FALSE)))))))
   ...
   (CL:LET* ((TEST-VALUE-000 FALSE))
    ...
    (CL:WHEN TEST-VALUE-000
     ...
     (CL:WHEN TEST-VALUE-000
      (CL:LET* ((ALWAYS?-000 TRUE))
       (CL:LET*
        ((TV NULL) (HV NULL) (VECTOR-000 (%ARGUMENTS HEADGOAL))
         (INDEX-000 0) (LENGTH-000 (LENGTH VECTOR-000))
         (VECTOR-001 (%ARGUMENTS TAILGOAL)) (INDEX-001 0)
         (LENGTH-001 (LENGTH VECTOR-001)))
        (CL:DECLARE
      ...
      (CL:WHEN TEST-VALUE-000
       (CL:SETQ TEST-VALUE-000
        (CL:= (LENGTH (%ARGUMENTS HEADGOAL))
         (LENGTH (%ARGUMENTS TAILGOAL))))
       (CL:WHEN TEST-VALUE-000
        ...
        (CL:WHEN TEST-VALUE-000
         (CL:IF (CL:EQ (FIRST TAILS) TAILPROPOSITION)
          ...
          (CL:PROGN
           (CL:SETQ TEST-VALUE-000
            (CL:EQ (%KIND TAILPROPOSITION) KWD-RULES-AND))
           (CL:WHEN TEST-VALUE-000
            (CL:LET* ((ALWAYS?-001 TRUE))
             (CL:LET*
              ((ARG NULL) (VECTOR-002 (%ARGUMENTS TAILPROPOSITION))
    ...
    (CL:IF TEST-VALUE-000
     (CREATE-IMPLIES-PROPOSITION (EXTRACT-GOAL-DESCRIPTION TAILGOAL NULL)
...
;;; (DEFUN (REMOVE-EXISTS-VARIABLE CONS) ...)

(CL:DEFUN REMOVE-EXISTS-VARIABLE (EXISTSPROPOSITION VARIABLE)
  (CL:WHEN
   (CL:NOT (CL:EQ (%%VALUE EXISTSPROPOSITION) SYM-RULES-STELLA-EXISTS))
   (CL:WARN "Weird FORALL body: `~A'" EXISTSPROPOSITION)
   (CL:RETURN-FROM REMOVE-EXISTS-VARIABLE EXISTSPROPOSITION))
  (CL:LET*
   ((EXISTSVARIABLES (%%VALUE (%%REST EXISTSPROPOSITION)))
    (EXISTSBODY (%%VALUE (%%REST (%%REST EXISTSPROPOSITION)))))
   (SECOND-SETTER EXISTSPROPOSITION (REMOVE EXISTSVARIABLES VARIABLE))
   (CL:IF (CL:EQ (%%VALUE (%%REST EXISTSPROPOSITION)) NIL) EXISTSBODY
    EXISTSPROPOSITION)))
...
(CL:DEFUN CREATE-FORWARD-CHAINING-INDEX (GOAL MASTERFORALL)
  (CL:LET*
   ...
   (CL:LET*
    ((IOVARIABLENAMES NULL) (QUERYBODY NULL) (CONSEQUENTTREE NULL)
     (REVERSEGOALVBLNAMES NIL) (INPUTBINDINGS NIL))
    (CL:LET* ((VALUE-000 NULL) (VALUE-001 NULL) (VALUE-002 NULL))
     ...
     (CL:PROGN (CL:SETQ IOVARIABLENAMES VALUE-000)
      (CL:SETQ QUERYBODY VALUE-001) (CL:SETQ CONSEQUENTTREE VALUE-002)))
    (CL:LET* ((V NULL) (ITER-000 IOVARIABLENAMES))
     (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-000 NIL)) DO
      (CL:PROGN (CL:SETQ V (%%VALUE ITER-000))
       (CL:SETQ ITER-000 (%%REST ITER-000)))
      (CL:WHEN (CL:NOT (SEARCH-CONS-TREE? CONSEQUENTTREE V))
       (CL:SETQ IOVARIABLENAMES (REMOVE IOVARIABLENAMES V))
       (CL:SETQ QUERYBODY
        (LIST* SYM-RULES-STELLA-EXISTS (CONS V NIL) QUERYBODY NIL)))))
    (CL:SETF (%CONSEQUENT INDEX)
     (VALUE-OF
      (CONCEIVE-TERM
    ...
    (CL:LET*
     ...
     (CL:LOOP WHILE (CL:< INDEX-000 LENGTH-000) DO
      ...
      (CL:WHEN (VARIABLE? ARG)
       (CL:SETQ REVERSEGOALVBLNAMES
        (CONS (%SKOLEM-NAME ARG) REVERSEGOALVBLNAMES)))))
    (CL:LET* ((V NULL) (ITER-001 REVERSEGOALVBLNAMES))
     (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-001 NIL)) DO
      (CL:PROGN (CL:SETQ V (%%VALUE ITER-001))
       (CL:SETQ ITER-001 (%%REST ITER-001)))
      (CL:WHEN (CL:NOT (MEMBER? IOVARIABLENAMES V))
       (CL:SETQ QUERYBODY (REMOVE-EXISTS-VARIABLE QUERYBODY V)))))
    (CL:LET* ((V NULL) (ITER-002 REVERSEGOALVBLNAMES))
     (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-002 NIL)) DO
      (CL:PROGN (CL:SETQ V (%%VALUE ITER-002))
       (CL:SETQ ITER-002 (%%REST ITER-002)))
      (CL:SETQ IOVARIABLENAMES (CONS V IOVARIABLENAMES))))
    (CL:SETF (%IO-VARIABLES INDEX) IOVARIABLENAMES)
    (CL:SETF (%QUERY-BODY INDEX) QUERYBODY)
    (CL:LET* ((V NULL) (ITER-003 IOVARIABLENAMES))
     (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-003 NIL)) DO
      (CL:PROGN (CL:SETQ V (%%VALUE ITER-003))
       (CL:SETQ ITER-003 (%%REST ITER-003)))
      (CL:SETQ INPUTBINDINGS (CONS NULL INPUTBINDINGS))))
    (CL:SETF (%INPUT-BINDINGS INDEX) INPUTBINDINGS))
   (CL:SETF (%FORWARD-GOAL INDEX) GOAL)
   (CL:SETF (%MASTER-RULE INDEX) MASTERFORALL)
...
(CL:DEFUN DERIVE-COMPLEX-FORWARD-RULE (GOAL MASTERFORALL)
  (CL:LET*
   ...
   (CL:LET*
    ((IDX NULL)
     (ITER-000
      (%THE-CONS-LIST (FORWARD-CHAINING-INDICES GOALDESCRIPTION))))
    (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-000 NIL)) DO
     (CL:PROGN (CL:SETQ IDX (%%VALUE ITER-000))
      (CL:SETQ ITER-000 (%%REST ITER-000)))
     (CL:WHEN (CL:EQ GOAL (%FORWARD-GOAL IDX)) (CL:SETQ DUPLICATE IDX))))
...
;;; (DEFUN HELP-GET-FORWARD-CHAINING-RULES ...)

(CL:DEFUN HELP-GET-FORWARD-CHAINING-RULES (DESCRIPTION RULES)
  (CL:LET*
   ((IDX NULL)
   ...
   (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-000 NIL)) DO
    ...
    (CL:WHEN (CL:NOT (DELETED? (%MASTER-RULE IDX)))
     (INSERT RULES (%MASTER-RULE IDX))))))

;;; (DEFUN (CALL-GET-RULES (LIST OF PROPOSITION)) ...)

(CL:DEFUN CALL-GET-RULES (RELATIONREF)
  (CL:LET* ((DESCRIPTION (GET-RELATION RELATIONREF)) (RULES (LIST)))
   (CL:WHEN (CL:EQ DESCRIPTION NULL)
    (%%PRINT-STREAM (%NATIVE-STREAM STANDARD-OUTPUT)
     "Can't find a relation named " RELATIONREF EOL)
    (CL:RETURN-FROM CALL-GET-RULES NULL))
   (CL:COND
     ...
     (CL:PROGN
      (CL:LET*
       ((P NULL)
        (ITER-000
         (ALLOCATE-ITERATOR
          (UNFILTERED-DEPENDENT-IMPLIES-PROPOSITIONS DESCRIPTION))))
       (CL:LOOP WHILE (NEXT? ITER-000) DO (CL:SETQ P (%VALUE ITER-000))
        (CL:WHEN
         (CL:AND (CL:EQ (%KIND P) KWD-RULES-IMPLIES)
          (CL:NOT (DELETED? P)))
         (PUSH RULES P))))
      (HELP-GET-FORWARD-CHAINING-RULES DESCRIPTION RULES)
      (CL:LET*
       ((COMPLEMENT
         (DYNAMIC-SLOT-VALUE (%DYNAMIC-SLOTS DESCRIPTION)
          SYM-RULES-LOGIC-COMPLEMENT-DESCRIPTION NULL)))
       (CL:WHEN (CL:NOT (CL:EQ COMPLEMENT NULL))
        (CL:LET*
         ((P NULL)
          (ITER-001
           (ALLOCATE-ITERATOR
            (UNFILTERED-DEPENDENT-IMPLIES-PROPOSITIONS COMPLEMENT))))
         (CL:LOOP WHILE (NEXT? ITER-001) DO (CL:SETQ P (%VALUE ITER-001))
          (CL:WHEN
           (CL:AND (CL:EQ (%KIND P) KWD-RULES-IMPLIES)
            (CL:NOT (DELETED? P)))
           (PUSH RULES P))))
        (HELP-GET-FORWARD-CHAINING-RULES COMPLEMENT RULES)))
      RULES))
    (CL:T NIL-LIST))))
...
(CL:DEFUN %GET-RULES (RELATION)
  ...
  (%THE-CONS-LIST (CALL-GET-RULES RELATION)))
...
(CL:SETF (CL:MACRO-FUNCTION (CL:QUOTE /LOGIC/GET-RULES)) (CL:MACRO-FUNCTION (CL:QUOTE GET-RULES)))
...
(CL:DEFUN %DELETE-RULES (RELATION)
  ...
  (CL:LET*
   ((R NULL) (ITER-000 (%THE-CONS-LIST (CALL-GET-RULES RELATION))))
   (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-000 NIL)) DO
...
(CL:DEFUN %PRINT-RULES (RELATION)
  ...
  (CL:LET*
   ((RULE NULL) (ITER-000 (%THE-CONS-LIST (CALL-GET-RULES RELATION))))
   (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-000 NIL)) DO
    (CL:PROGN (CL:SETQ RULE (%%VALUE ITER-000))
     (CL:SETQ ITER-000 (%%REST ITER-000)))
    (PRINT-LOGICAL-FORM RULE STANDARD-OUTPUT)
...
(CL:SETF (CL:MACRO-FUNCTION (CL:QUOTE /LOGIC/PRINT-RULES)) (CL:MACRO-FUNCTION (CL:QUOTE PRINT-RULES)))
...
(CL:DEFUN PRINT-SATELLITES (FORALLPROP)
  (CL:LET*
   ((RULE NULL)
    (ITER-000 (%THE-CONS-LIST (SATELLITE-PROPOSITIONS FORALLPROP))))
   (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-000 NIL)) DO
    (CL:PROGN (CL:SETQ RULE (%%VALUE ITER-000))
     (CL:SETQ ITER-000 (%%REST ITER-000)))
...
(CL:DEFUN %ASSERT-RULE (RULENAME)
  ...
  (CL:LET* ((PROPOSITION (%GET-RULE RULENAME)))
   (CL:WHEN (CL:EQ PROPOSITION NULL) (CL:RETURN-FROM %ASSERT-RULE NULL))
...
'ruleName' to UNKNOWN."
  (CL:LET* ((PROPOSITION (%GET-RULE RULENAME)))
   (CL:WHEN (CL:EQ PROPOSITION NULL) (CL:RETURN-FROM %RETRACT-RULE NULL))
...
;;; (DEFUN (HELP-DEFINE-RULE PROPOSITION) ...)

(CL:DEFUN HELP-DEFINE-RULE (NAME RULE PLIST STRINGIFIEDSOURCE)
  (CL:DECLARE (CL:TYPE CL:SIMPLE-STRING NAME STRINGIFIEDSOURCE))
  (CL:WHEN (CL:NOT (CL:EQ (%KIND RULE) KWD-RULES-FORALL))
   (CL:SETQ RULE
    (%%VALUE
     (HELP-UPDATE-TOP-LEVEL-PROPOSITION RULE KWD-RULES-ASSERT-TRUE))))
  (CL:LET* ((SUCCESS? FALSE) (OLDRULE NULL) (SURROGATE NULL))
   (CL:MULTIPLE-VALUE-SETQ (SUCCESS? OLDRULE SURROGATE)
    (BIND-TO-SURROGATE? RULE NAME TRUE TRUE))
   (CL:WHEN (CL:NOT SUCCESS?) (DESTROY-PROPOSITION RULE)
    (CL:RETURN-FROM HELP-DEFINE-RULE NULL))
   (SET-DYNAMIC-SLOT-VALUE (%DYNAMIC-SLOTS RULE)
    SYM-RULES-STELLA-SURROGATE-VALUE-INVERSE SURROGATE NULL)
   (SET-DYNAMIC-SLOT-VALUE (%DYNAMIC-SLOTS RULE)
    SYM-RULES-LOGIC-TERM-STRINGIFIED-SOURCE
    (WRAP-STRING STRINGIFIEDSOURCE) NULL)
   (CL:WHEN (CL:NOT (CL:EQ OLDRULE NULL))
    (CL:COND
     ((SUBTYPE-OF? (SAFE-PRIMARY-TYPE OLDRULE)
       SGT-RULES-LOGIC-PROPOSITION)
      (CL:PROGN
       (SET-DYNAMIC-SLOT-VALUE (%DYNAMIC-SLOTS OLDRULE)
        SYM-RULES-STELLA-SURROGATE-VALUE-INVERSE NULL NULL)
       (DESTROY-PROPOSITION OLDRULE)))
     (CL:T (DESTROY-PROPOSITION RULE)
      (CL:LET* ((STREAM-000 (NEW-OUTPUT-STRING-STREAM)))
       (CL:LET* ((*PRINTREADABLY?* TRUE))
        (CL:DECLARE (CL:SPECIAL *PRINTREADABLY?*))
        (%%PRINT-STREAM (%NATIVE-STREAM STREAM-000)
         "ERROR: Can't define a rule named `" NAME
         "' because another object of type" EOL "   `"
         (PRIMARY-TYPE OLDRULE) "' already has that name." EOL "." EOL)
        (HELP-SIGNAL-PROPOSITION-ERROR STREAM-000 KWD-RULES-ERROR))
       (CL:ERROR
        (NEW-PROPOSITION-ERROR (THE-STRING-READER STREAM-000))))))))
  (CL:LET* ((VALUE NULL) (KEY NULL) (ITER-000 (%THE-PLIST PLIST)))
   (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-000 NIL)) DO
    ...
    (CL:LET* ((TEST-VALUE-000 KEY))
     (CL:COND
      ((CL:EQ TEST-VALUE-000 KWD-RULES-FORWARD?)
       (SET-DYNAMIC-SLOT-VALUE (%DYNAMIC-SLOTS RULE)
        SYM-RULES-LOGIC-FORWARD-ONLY?
        (CL:IF (CL:EQ VALUE SYM-RULES-STELLA-TRUE) TRUE-WRAPPER
         FALSE-WRAPPER)
        FALSE-WRAPPER))
      ((CL:EQ TEST-VALUE-000 KWD-RULES-BACKWARD?)
       (SET-DYNAMIC-SLOT-VALUE (%DYNAMIC-SLOTS RULE)
        SYM-RULES-LOGIC-BACKWARD-ONLY?
        (CL:IF (CL:EQ VALUE SYM-RULES-STELLA-TRUE) TRUE-WRAPPER
         FALSE-WRAPPER)
        FALSE-WRAPPER))
      ((CL:EQ TEST-VALUE-000 KWD-RULES-DONT-OPTIMIZE?)
       (SET-DYNAMIC-SLOT-VALUE (%DYNAMIC-SLOTS RULE)
        SYM-RULES-LOGIC-DONT-OPTIMIZE?
        (CL:IF (CL:EQ VALUE SYM-RULES-STELLA-TRUE) TRUE-WRAPPER
         FALSE-WRAPPER)
        FALSE-WRAPPER))
      (CL:T (ASSERT-KEYWORD-AXIOM RULE KEY VALUE))))))
  (CL:WHEN (CL:EQ (%KIND RULE) KWD-RULES-FORALL)
   (CL:SETQ RULE
    (%%VALUE
     (HELP-UPDATE-TOP-LEVEL-PROPOSITION RULE KWD-RULES-ASSERT-TRUE))))
  RULE)

;;; (DEFUN (DEFINE-RULE OBJECT) ...)

(CL:DEFUN DEFINE-RULE (NAME RULETREE OPTIONS STRINGIFIEDSOURCE)
  (CL:DECLARE (CL:TYPE CL:SIMPLE-STRING NAME STRINGIFIEDSOURCE))
  (CL:HANDLER-CASE
   (CL:LET* ((PLIST (VET-OPTIONS OPTIONS NULL)) (RULEZ NULL))
    (CL:SETQ RULEZ (SMART-UPDATE-PROPOSITION RULETREE KWD-RULES-CONCEIVE))
    (CL:COND
     ((CL:EQ RULEZ NULL)
      (CL:LET* ((*PRINTREADABLY?* TRUE))
       (CL:DECLARE (CL:SPECIAL *PRINTREADABLY?*))
       (%%PRINT-STREAM (%NATIVE-STREAM STANDARD-WARNING)
        "WARNING: Failed to define the rule named " NAME "." EOL)
     ...
     ((CONS? RULEZ)
      (CL:LET* ((RULES NIL))
       (CL:LET* ((*PRINTREADABLY?* TRUE))
        (CL:DECLARE (CL:SPECIAL *PRINTREADABLY?*))
        (%%PRINT-STREAM (%NATIVE-STREAM STANDARD-WARNING)
         "WARNING: PowerLoom can't handle rules in 'defrule' that expand into
           multiple propositions." EOL)
        (HELP-SIGNAL-PROPOSITION-ERROR STANDARD-WARNING
         KWD-RULES-WARNING))
       (CL:RETURN-FROM DEFINE-RULE NULL)))
     ((ISA? RULEZ SGT-RULES-LOGIC-PROPOSITION)
      (CL:LET*
       ((OLDSURROGATE (LOOKUP-SURROGATE NAME))
        (OLDRULE
         (CL:IF (CL:NOT (CL:EQ OLDSURROGATE NULL))
          (%SURROGATE-VALUE OLDSURROGATE) NULL))
        (OLDSTRINGIFIEDSOURCE NULL))
       (CL:LET* ((TEST-VALUE-000 FALSE))
        (CL:SETQ TEST-VALUE-000 (CL:NOT (CL:EQ OLDRULE NULL)))
        (CL:WHEN TEST-VALUE-000
         (CL:SETQ TEST-VALUE-000
          (ISA? OLDRULE SGT-RULES-LOGIC-PROPOSITION))
         (CL:WHEN TEST-VALUE-000
          (CL:LET* ()
           (CL:SETQ OLDSTRINGIFIEDSOURCE
            (DYNAMIC-SLOT-VALUE (%DYNAMIC-SLOTS OLDRULE)
             SYM-RULES-LOGIC-TERM-STRINGIFIED-SOURCE NULL))
           (CL:SETQ TEST-VALUE-000
            (CL:NOT (CL:EQ OLDSTRINGIFIEDSOURCE NULL))))
          (CL:WHEN TEST-VALUE-000
           (CL:SETQ TEST-VALUE-000
            (STRING-EQL? (%WRAPPER-VALUE OLDSTRINGIFIEDSOURCE)
             STRINGIFIEDSOURCE)))))
        (CL:LET* ((DONTWARNIFREDEFINE? TEST-VALUE-000))
         (CL:LET* ((*WARNIFREDEFINE?* (CL:NOT DONTWARNIFREDEFINE?)))
          (CL:DECLARE (CL:SPECIAL *WARNIFREDEFINE?*))
          (CL:RETURN-FROM DEFINE-RULE
           (HELP-DEFINE-RULE NAME RULEZ PLIST STRINGIFIEDSOURCE)))))))
     (CL:T
      (CL:LET* ((*PRINTREADABLY?* TRUE))
       (CL:DECLARE (CL:SPECIAL *PRINTREADABLY?*))
       (%%PRINT-STREAM (%NATIVE-STREAM STANDARD-WARNING)
        "WARNING: Illegal axiom in rule named " NAME "." EOL)
       (HELP-SIGNAL-PROPOSITION-ERROR STANDARD-WARNING
        KWD-RULES-WARNING)))))
   (LOGIC-EXCEPTION (E)
    (%%PRINT-STREAM (%NATIVE-STREAM STANDARD-ERROR) (EXCEPTION-MESSAGE E))
    (CL:RETURN-FROM DEFINE-RULE (CL:SETQ *MOST-RECENT-QUERY* NULL))))
  NULL)

;;; (DEFUN (DEFINE-RULE-FROM-PARSE-TREE PROPOSITION) ...)

(CL:DEFUN DEFINE-RULE-FROM-PARSE-TREE (TREE)
  (CL:LET* ((STRINGIFIEDSOURCE (STRINGIFY TREE)))
   (CL:DECLARE (CL:TYPE CL:SIMPLE-STRING STRINGIFIEDSOURCE))
   (CL:SETQ TREE (%%REST TREE))
   (CL:LET* ((*TERMSOURCEBEINGPARSED* STRINGIFIEDSOURCE))
    (CL:DECLARE (CL:SPECIAL *TERMSOURCEBEINGPARSED*))
    (CL:DECLARE (CL:TYPE CL:SIMPLE-STRING *TERMSOURCEBEINGPARSED*))
    (CL:HANDLER-CASE
     (CL:LET*
      ((NAME (COERCE-TO-STRING (%%VALUE TREE)))
       (RULETREE (%%VALUE (%%REST TREE)))
       (OPTIONS (%%REST (%%REST TREE))))
      (CL:DECLARE (CL:TYPE CL:SIMPLE-STRING NAME))
      (CL:RETURN-FROM DEFINE-RULE-FROM-PARSE-TREE
       (DEFINE-RULE NAME RULETREE OPTIONS STRINGIFIEDSOURCE)))
     (LOGIC-EXCEPTION (E)
      (%%PRINT-STREAM (%NATIVE-STREAM STANDARD-ERROR)
       (EXCEPTION-MESSAGE E))
      NULL)))))
...
axiom 'ruleTree'.  Boolean options are :forward?, :backward?, and :dont-optimize?.
By default, a rule can be interpreted in the forward or backward
direction.  The :forward? and :backward? options override that default.
The :dont-optimize? tells the interpreter to evaluate the clauses of
a rule in their original order. Other options are :documentation,
:comment, and :issues."
  (DEFINE-RULE-FROM-PARSE-TREE
   (CONS SYM-RULES-LOGIC-DEFRULE (CONCATENATE ARGS NIL))))
  ...
  (CL:LET*
   ...
   (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-000 NIL)) DO
    (CL:PROGN (CL:SETQ RULE (%%VALUE ITER-000))
     (CL:SETQ ITER-000 (%%REST ITER-000)))
    (CL:LET*
     ((ARG NULL) (VECTOR-000 (%ARGUMENTS RULE)) (INDEX-000 0)
      (LENGTH-000 (LENGTH VECTOR-000)))
     (CL:DECLARE (CL:TYPE CL:FIXNUM INDEX-000 LENGTH-000))
     (CL:LOOP WHILE (CL:< INDEX-000 LENGTH-000) DO
      (CL:PROGN
      ...
      (CL:WHEN (CL:NOT (CL:EQ (%QUERY-PATTERNS ARG) NULL))
       (CL:LET* ((IT (ALLOCATE-ITERATOR (%QUERY-PATTERNS ARG))))
...
so that it will reoptimize subgoal queries upon next invocation."
  (CL:LET* ((SLOT NULL) (ITER-000 (ALL-SLOTS NULL TRUE)))
  ...
  (CL:LET*
   ((DESCRIPTION NULL) (ITER-001 (ALL-NAMED-DESCRIPTIONS NULL TRUE)))
   (CL:LOOP WHILE (NEXT? ITER-001) DO
    (CL:SETQ DESCRIPTION (%VALUE ITER-001))
...
(CL:DEFUN HELP-STARTUP-RULES1 ()
  (CL:PROGN
   ...
   (CL:SETQ SYM-RULES-LOGIC-RULES-WITH-DEFERRED-SATELLITES
    (INTERN-RIGID-SYMBOL-WRT-MODULE "RULES-WITH-DEFERRED-SATELLITES" NULL
     0))
   ...
   (CL:SETQ SYM-RULES-LOGIC-GET-RULES
    (INTERN-RIGID-SYMBOL-WRT-MODULE "GET-RULES" NULL 0))
   ...
   (CL:SETQ SYM-RULES-LOGIC-PRINT-RULES
    (INTERN-RIGID-SYMBOL-WRT-MODULE "PRINT-RULES" NULL 0))
   ...
   (CL:SETQ SYM-RULES-STELLA-SURROGATE-VALUE-INVERSE
    (INTERN-RIGID-SYMBOL-WRT-MODULE "SURROGATE-VALUE-INVERSE"
     (GET-STELLA-MODULE "/STELLA" TRUE) 0))
   (CL:SETQ SYM-RULES-LOGIC-TERM-STRINGIFIED-SOURCE
...
(CL:DEFUN STARTUP-RULES ()
  (CL:LET*
   ...
   (CL:WHEN (CURRENT-STARTUP-TIME-PHASE? 7)
    ...
    (DEFINE-FUNCTION-OBJECT "EQUATE-AND-SIMPLIFY-FORALL-ARGUMENT"
     "(DEFUN EQUATE-AND-SIMPLIFY-FORALL-ARGUMENT ((PROPOSITION PROPOSITION)))"
     (CL:FUNCTION EQUATE-AND-SIMPLIFY-FORALL-ARGUMENT) NULL)
    ...
    (DEFINE-FUNCTION-OBJECT "REMOVE-EXISTS-VARIABLE"
     "(DEFUN (REMOVE-EXISTS-VARIABLE CONS) ((EXISTSPROPOSITION CONS) (VARIABLE SYMBOL)))"
     (CL:FUNCTION REMOVE-EXISTS-VARIABLE) NULL)
    ...
    (DEFINE-FUNCTION-OBJECT "HELP-GET-FORWARD-CHAINING-RULES"
     "(DEFUN HELP-GET-FORWARD-CHAINING-RULES ((DESCRIPTION DESCRIPTION) (RULES LIST)))"
     (CL:FUNCTION HELP-GET-FORWARD-CHAINING-RULES) NULL)
    (DEFINE-FUNCTION-OBJECT "CALL-GET-RULES"
     "(DEFUN (CALL-GET-RULES (LIST OF PROPOSITION)) ((RELATIONREF OBJECT)))"
    ...
    (DEFINE-FUNCTION-OBJECT "DELETE-RULES"
     "(DEFUN DELETE-RULES ((RELATION NAME)) :DOCUMENTATION \"Delete the list of rules associated with `relation'.\" :PUBLIC? TRUE :COMMAND? TRUE :EVALUATE-ARGUMENTS? FALSE)"
     (CL:FUNCTION %DELETE-RULES) NULL)
    (DEFINE-FUNCTION-OBJECT "PRINT-RULES"
     "(DEFUN PRINT-RULES ((RELATION OBJECT)) :DOCUMENTATION \"Print the list of rules associated with `relation'.\" :PUBLIC? TRUE :COMMAND? TRUE :EVALUATE-ARGUMENTS? FALSE)"
...
but 'find-rule' implicity quotes its input argument.\")"
    ...
    (DEFINE-FUNCTION-OBJECT "ASSERT-RULE"
     "(DEFUN (ASSERT-RULE PROPOSITION) ((RULENAME NAME)) :COMMAND? TRUE :PUBLIC? TRUE :EVALUATE-ARGUMENTS? FALSE :DOCUMENTATION \"Set the truth value of the rule named 'ruleName' to TRUE\")"
     (CL:FUNCTION %ASSERT-RULE) NULL)
    (DEFINE-FUNCTION-OBJECT "RETRACT-RULE"
     "(DEFUN (RETRACT-RULE PROPOSITION) ((RULENAME NAME)) :COMMAND? TRUE :PUBLIC? TRUE :EVALUATE-ARGUMENTS? FALSE :DOCUMENTATION \"If it is currently true, set the truth value of the rule named
'ruleName' to UNKNOWN.\")" (CL:FUNCTION %RETRACT-RULE) NULL)
    (DEFINE-FUNCTION-OBJECT "HELP-DEFINE-RULE"
     "(DEFUN (HELP-DEFINE-RULE PROPOSITION) ((NAME STRING) (RULE PROPOSITION) (PLIST PROPERTY-LIST) (STRINGIFIEDSOURCE STRING)))"
     (CL:FUNCTION HELP-DEFINE-RULE) NULL)
    (DEFINE-FUNCTION-OBJECT "DEFINE-RULE"
     "(DEFUN (DEFINE-RULE OBJECT) ((NAME STRING) (RULETREE OBJECT) (OPTIONS CONS) (STRINGIFIEDSOURCE STRING)))"
     (CL:FUNCTION DEFINE-RULE) NULL)
    (DEFINE-FUNCTION-OBJECT "DEFINE-RULE-FROM-PARSE-TREE"
     "(DEFUN (DEFINE-RULE-FROM-PARSE-TREE PROPOSITION) ((TREE CONS)))"
     (CL:FUNCTION DEFINE-RULE-FROM-PARSE-TREE) NULL)
    (DEFINE-FUNCTION-OBJECT "DEFRULE"
     "(DEFUN (DEFRULE PROPOSITION) (|&REST| (ARGS OBJECT)) :DOCUMENTATION \"Define (or redefine) a rule (any axiom) named `ruleName'.
If an axiom with that name already exists, replace it with the new
axiom 'ruleTree'.  Boolean options are :forward?, :backward?, and :dont-optimize?.
By default, a rule can be interpreted in the forward or backward
direction.  The :forward? and :backward? options override that default.
The :dont-optimize? tells the interpreter to evaluate the clauses of
a rule in their original order. Other options are :documentation,
:comment, and :issues.\" :COMMAND? TRUE :PUBLIC? TRUE :EVALUATE-ARGUMENTS? FALSE)"
     (CL:FUNCTION %DEFRULE) (CL:FUNCTION DEFRULE-EVALUATOR-WRAPPER))
...
so that it will reoptimize subgoal queries upon next invocation.\")"
    ...
    (DEFINE-FUNCTION-OBJECT "STARTUP-RULES"
     "(DEFUN STARTUP-RULES () :PUBLIC? TRUE)" (CL:FUNCTION STARTUP-RULES)
     NULL)
    (CL:LET* ((FUNCTION (LOOKUP-FUNCTION SYM-RULES-LOGIC-STARTUP-RULES)))
     (SET-DYNAMIC-SLOT-VALUE (%DYNAMIC-SLOTS FUNCTION)
      SYM-RULES-STELLA-METHOD-STARTUP-CLASSNAME
      (WRAP-STRING "Startup-Rules") NULL-STRING-WRAPPER)))
   (CL:WHEN (CURRENT-STARTUP-TIME-PHASE? 8) (FINALIZE-SLOTS)
    (CLEANUP-UNFINALIZED-CLASSES))
   (CL:WHEN (CURRENT-STARTUP-TIME-PHASE? 9)
    (DEFINE-STELLA-GLOBAL-VARIABLE-FROM-STRINGIFIED-SOURCE
     "(DEFGLOBAL *LAZY-SATELLITE-RULES?* BOOLEAN TRUE :DOCUMENTATION \"If true, inversion of forall propositions happens lazily.
I.e., satellite rules are generated on-demand during inference only if they
are actually needed.\" :PUBLIC? TRUE)")
    (REGISTER-NATIVE-NAME SYM-RULES-LOGIC-GET-RULES KWD-RULES-COMMON-LISP
     KWD-RULES-FUNCTION)
    (REGISTER-NATIVE-NAME SYM-RULES-LOGIC-DELETE-RULES
     KWD-RULES-COMMON-LISP KWD-RULES-FUNCTION)
    (REGISTER-NATIVE-NAME SYM-RULES-LOGIC-PRINT-RULES
     KWD-RULES-COMMON-LISP KWD-RULES-FUNCTION)
    (REGISTER-NATIVE-NAME SYM-RULES-LOGIC-GET-RULE KWD-RULES-COMMON-LISP
     KWD-RULES-FUNCTION)
    (REGISTER-NATIVE-NAME SYM-RULES-LOGIC-FIND-RULE KWD-RULES-COMMON-LISP
     KWD-RULES-FUNCTION)
    (REGISTER-NATIVE-NAME SYM-RULES-LOGIC-ASSERT-RULE
     KWD-RULES-COMMON-LISP KWD-RULES-FUNCTION)
    (REGISTER-NATIVE-NAME SYM-RULES-LOGIC-RETRACT-RULE
     KWD-RULES-COMMON-LISP KWD-RULES-FUNCTION)
    (REGISTER-NATIVE-NAME SYM-RULES-LOGIC-DEFRULE KWD-RULES-COMMON-LISP
     KWD-RULES-FUNCTION))))
