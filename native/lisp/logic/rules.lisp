...
(CL:DECLAIM
 (CL:SPECIAL *STARTUP-TIME-PHASE* *MODULE* STANDARD-OUTPUT NIL-LIST
  *CYC-KLUDGES-ENABLED?* *CONTEXT* STANDARD-ERROR TRUE-WRAPPER FALSE-WRAPPER
  FALSE-PROPOSITION TRUE-PROPOSITION NULL-INTEGER EOL FALSE TRUE NIL))
...
(CL:DEFUN ATOMIC-FORALL-ARGUMENT? (FORALLPROP HEADORTAIL)
  (ATOMIC-GOAL-PROPOSITION?
   (CL:IF (CL:EQ HEADORTAIL KWD-RULES-HEAD)
    (CL:AREF (CL:THE CL:SIMPLE-VECTOR (%THE-ARRAY (%ARGUMENTS FORALLPROP))) 1)
    (CL:AREF (CL:THE CL:SIMPLE-VECTOR (%THE-ARRAY (%ARGUMENTS FORALLPROP)))
     0))))
...
(CL:DEFUN ATOMIC-GOAL-DESCRIPTION? (DESCRIPTION)
  ...
  (CL:LET*
   ...
   (CL:IF
    (CL:AND (CL:NOT (CL:EQ COMPLEMENT NULL)) (NAMED-DESCRIPTION? COMPLEMENT))
...
(CL:DEFUN CHAINABLE-RELATION? (DESCRIPTION HEADORTAIL)
  (CL:WHEN (CL:EQ HEADORTAIL NULL) (CL:RETURN-FROM CHAINABLE-RELATION? TRUE))
   ...
   (CL:COND
    ...
    (CL:T
     (CL:LET* ((STREAM-000 (NEW-OUTPUT-STRING-STREAM)))
      ...
      (CL:ERROR (NEW-STELLA-EXCEPTION (THE-STRING-READER STREAM-000))))))
   (CL:NOT
    (MEMBER? NONPERMITTEDPREDICATES (%SURROGATE-VALUE-INVERSE DESCRIPTION)))))
...
(CL:DEFUN INVERT-FORALL-AROUND-GOAL (FORALLPROP GOAL HEADORTAIL CONTRAPOSITIVE?)
  (CL:LET*
   ((MAPPING (NEW-KEY-VALUE-LIST))
    ...
    (OLDHEAD
     (CL:AREF
      (CL:THE CL:SIMPLE-VECTOR (%THE-ARRAY (%ARGUMENTS INVERTEDFORALL))) 1))
    (OLDTAIL
     (CL:AREF
      (CL:THE CL:SIMPLE-VECTOR (%THE-ARRAY (%ARGUMENTS INVERTEDFORALL))) 0))
   ...
   (CL:WHEN CONTRAPOSITIVE? (CL:SETQ OLDHEAD (INVERT-PROPOSITION OLDHEAD))
    ...
    (CL:SETQ OLDTAIL
     (CL:AREF
      (CL:THE CL:SIMPLE-VECTOR (%THE-ARRAY (%ARGUMENTS INVERTEDFORALL))) 0))
    (CL:SETQ HEADORTAIL
     (CL:IF (CL:EQ HEADORTAIL KWD-RULES-HEAD) KWD-RULES-TAIL KWD-RULES-HEAD)))
   ...
   (CL:LET* ((NEWVARIABLES (EXTRACT-GOAL-ARGUMENTS NEWGOAL)))
    (CL:LET* ((I NULL-INTEGER) (V NULL) (ITER-001 NEWVARIABLES) (ITER-002 0))
   ...
   (RECURSIVELY-FASTEN-DOWN-PROPOSITIONS INVERTEDFORALL FALSE) INVERTEDFORALL))
...
(CL:DEFUN MARK-AS-FORWARD-RULE (IMPLIESPROP)
  (CL:LET*
   ((HEAD
     (CL:AREF (CL:THE CL:SIMPLE-VECTOR (%THE-ARRAY (%ARGUMENTS IMPLIESPROP)))
      1)))
   (CL:WHEN
...
(CL:DEFUN DERIVE-ONE-SATELLITE-RULE (MASTERFORALL GOAL HEADORTAIL CONTRAPOSITIVE?)
  (CL:LET*
    ...
    (CL:AND (CL:EQ HEADORTAIL KWD-RULES-TAIL)
     (CL:OR
      (CL:NOT
       (ATOMIC-GOAL-PROPOSITION?
        (CL:AREF
         (CL:THE CL:SIMPLE-VECTOR (%THE-ARRAY (%ARGUMENTS MASTERFORALL))) 0)))
   ...
   (CL:WHEN CONTRAPOSITIVE?
    (CL:COND
     ((CL:EQ HEADORTAIL KWD-RULES-HEAD) (CL:SETQ HEADORTAIL KWD-RULES-TAIL))
   ...
   (CL:LET* ((IMPLIESPROP (CREATE-IMPLIES-PROPOSITION TAIL HEAD)))
    (CL:LET* ((*EVALUATIONMODE* KWD-RULES-EXTENSIONAL-ASSERTION))
     (CL:DECLARE (CL:SPECIAL *EVALUATIONMODE*))
     (CL:LET*
      ((DUPLICATE (RECURSIVELY-FASTEN-DOWN-PROPOSITIONS IMPLIESPROP FALSE)))
      (CL:COND
    ...
    (CL:WHEN
     ...
     (CL:IF CONTRAPOSITIVE?
      (SET-DYNAMIC-SLOT-VALUE (%DYNAMIC-SLOTS IMPLIESPROP)
       SYM-RULES-LOGIC-BACKWARD-ONLY? (CL:IF TRUE TRUE-WRAPPER FALSE-WRAPPER)
       FALSE-WRAPPER)
      (SET-DYNAMIC-SLOT-VALUE (%DYNAMIC-SLOTS IMPLIESPROP)
       SYM-RULES-LOGIC-FORWARD-ONLY? (CL:IF TRUE TRUE-WRAPPER FALSE-WRAPPER)
       FALSE-WRAPPER)))
    ...
    (CL:WHEN
     ...
     (SET-DYNAMIC-SLOT-VALUE (%DYNAMIC-SLOTS IMPLIESPROP)
      SYM-RULES-LOGIC-DONT-OPTIMIZE? (CL:IF TRUE TRUE-WRAPPER FALSE-WRAPPER)
      FALSE-WRAPPER)
     (CL:SETQ TAIL
      (CL:AREF (CL:THE CL:SIMPLE-VECTOR (%THE-ARRAY (%ARGUMENTS IMPLIESPROP)))
       0))
...
(CL:DEFVAR *LAZY-SATELLITE-RULES?* FALSE
   ...
   (CL:LET*
       ...
       (CL:COND
        (LAZYSATELLITES?
         (CL:IF (CL:EQ GOALDESCRIPTION NULL)
          (CL:SETQ GOALDESC (EXTRACT-GOAL-DESCRIPTION GOAL KWD-RULES-HEAD))
        ...
        ((CL:NOT CONTRAPOSITIVEONLY?)
         (DERIVE-ONE-SATELLITE-RULE FORALLPROP GOAL KWD-RULES-HEAD FALSE)))
       (CL:WHEN
    ...
    (CL:WHEN
     ...
     (CL:LET*
      ((GOAL NULL)
       (ITER-001
        (%THE-CONS-LIST (FIND-MATCHABLE-GOALS FORALLPROP KWD-RULES-TAIL))))
      (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-001 NIL)) DO
       ...
       (CL:WHEN
        ...
        (CL:COND
         (LAZYSATELLITES?
          (CL:IF (CL:EQ GOALDESCRIPTION NULL)
           (CL:SETQ GOALDESC (EXTRACT-GOAL-DESCRIPTION GOAL KWD-RULES-TAIL))
           (CL:SETQ GOALDESC GOALDESCRIPTION))
          (CL:WHEN
           (CL:EQ
            (DYNAMIC-SLOT-VALUE (%DYNAMIC-SLOTS GOALDESC)
          ...
          (INSERT
           ...
           FORALLPROP))
         ((CL:NOT CONTRAPOSITIVEONLY?)
          (DERIVE-ONE-SATELLITE-RULE FORALLPROP GOAL KWD-RULES-TAIL FALSE)))
        (CL:WHEN
         (CL:AND (CL:NOT POSITIVEONLY?)
          (CL:NOT
           (%WRAPPER-VALUE
   ...
   (CL:WHEN
    ...
    (CL:LET* ((MASTERPROPOSITION NULL) (QUEUEDRULES (NEW-LIST)))
     (CL:LET*
      ((PROP NULL)
       (ITER-000
        (ALLOCATE-ITERATOR (UNFILTERED-DEPENDENT-IMPLIES-PROPOSITIONS SELF))))
   ...
   (CL:LET* ((TEST-VALUE-000 FALSE))
    ...
    (CL:WHEN TEST-VALUE-000 (CL:SETQ TEST-VALUE-000 (CL:= (LENGTH TAILS) 1))
     (CL:WHEN TEST-VALUE-000
      (CL:LET* ((ALWAYS?-000 TRUE))
       (CL:LET*
        ((TV NULL) (HV NULL) (VECTOR-000 (%ARGUMENTS HEADGOAL)) (INDEX-000 0)
         (LENGTH-000 (LENGTH VECTOR-000)) (VECTOR-001 (%ARGUMENTS TAILGOAL))
        ...
        (CL:LOOP WHILE
         ...
         (CL:WHEN
          (CL:NOT
           (CL:AND (EQL? HV TV) (ISA? HV SGT-RULES-LOGIC-PATTERN-VARIABLE)))
          (CL:SETQ ALWAYS?-000 FALSE) (CL:RETURN))))
       (CL:SETQ TEST-VALUE-000 ALWAYS?-000))
      (CL:WHEN TEST-VALUE-000
       (CL:SETQ TEST-VALUE-000
        (CL:= (LENGTH (%ARGUMENTS HEADGOAL)) (LENGTH (%ARGUMENTS TAILGOAL))))
       (CL:WHEN TEST-VALUE-000
   ...
   (CL:LET*
    ...
    (CL:LET* ((V NULL) (ITER-003 IOVARIABLENAMES))
     (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-003 NIL)) DO
      ...
      (CL:SETQ V V) (CL:SETQ INPUTBINDINGS (CONS NULL INPUTBINDINGS))))
...
(CL:DEFUN DERIVE-COMPLEX-FORWARD-RULE (GOAL MASTERFORALL)
  (CL:LET*
   ...
   (CL:LET*
    ((IDX NULL)
     (ITER-000 (%THE-CONS-LIST (FORWARD-CHAINING-INDICES GOALDESCRIPTION))))
    (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-000 NIL)) DO
   ...
   (CL:COND
    ((SUBTYPE-OF? (SAFE-PRIMARY-TYPE DESCRIPTION)
     ...
     (CL:PROGN
      (CL:SETQ RULES
       (CONCATENATE
        (APPLICABLE-RULES-OF-DESCRIPTION DESCRIPTION KWD-RULES-FORWARD FALSE)
        (APPLICABLE-RULES-OF-DESCRIPTION DESCRIPTION KWD-RULES-BACKWARD FALSE)
      ...
      (CL:LET*
       ...
       (CL:WHEN (CL:NOT (CL:EQ COMPLEMENT NULL))
        (CL:SETQ RULES
         (CONCATENATE RULES
          (APPLICABLE-RULES-OF-DESCRIPTION COMPLEMENT KWD-RULES-FORWARD FALSE)
          (APPLICABLE-RULES-OF-DESCRIPTION COMPLEMENT KWD-RULES-BACKWARD
           FALSE)
  ...
  (CL:LET* ((SLOT NULL) (ITER-000 (ALL-SLOTS NULL TRUE)))
   (CL:LOOP WHILE (NEXT? ITER-000) DO (CL:SETQ SLOT (%VALUE ITER-000))
    (CL:WHEN
     (CL:NOT
      (CL:EQ
       (DYNAMIC-SLOT-VALUE (%DYNAMIC-SLOTS SLOT) SYM-RULES-LOGIC-DESCRIPTION
        NULL)
       NULL))
     (DELETE-RULE-CACHES-ON-RELATION SLOT))))
  (CL:LET* ((DESCRIPTION NULL) (ITER-001 (ALL-NAMED-DESCRIPTIONS NULL TRUE)))
...
(CL:DEFUN STARTUP-RULES ()
  (CL:LET*
   ...
   (CL:WHEN (CURRENT-STARTUP-TIME-PHASE? 4)
    (CL:SETQ *LAZY-SATELLITE-RULES?* TRUE))
...
TRUE.  The proposition having the name 'ruleName' may be
any arbitrary proposition, although we expect that it is probably
a material implication.  (See `retract-rule').\")" (CL:FUNCTION %ASSERT-RULE)
     NULL)
...
so that it will reoptimize subgoal queries upon next invocation.\")"
    ...
    (CL:LET* ((FUNCTION (LOOKUP-FUNCTION SYM-RULES-LOGIC-STARTUP-RULES)))
     (SET-DYNAMIC-SLOT-VALUE (%DYNAMIC-SLOTS FUNCTION)
      SYM-RULES-STELLA-METHOD-STARTUP-CLASSNAME (WRAP-STRING "_Startup-Rules")
      NULL-STRING-WRAPPER)))
...
are actually needed.\" :PUBLIC? TRUE)")
    ...
    (REGISTER-NATIVE-NAME SYM-RULES-STELLA-GET-RULES KWD-RULES-COMMON-LISP
     KWD-RULES-FUNCTION)
    (REGISTER-NATIVE-NAME SYM-RULES-LOGIC-DELETE-RULES KWD-RULES-COMMON-LISP
     KWD-RULES-FUNCTION)
    (REGISTER-NATIVE-NAME SYM-RULES-STELLA-PRINT-RULES KWD-RULES-COMMON-LISP
     KWD-RULES-FUNCTION)
    ...
    (REGISTER-NATIVE-NAME SYM-RULES-LOGIC-FIND-RULE KWD-RULES-COMMON-LISP
     KWD-RULES-FUNCTION)
    (REGISTER-NATIVE-NAME SYM-RULES-LOGIC-ASSERT-RULE KWD-RULES-COMMON-LISP
     KWD-RULES-FUNCTION)
    (REGISTER-NATIVE-NAME SYM-RULES-LOGIC-RETRACT-RULE KWD-RULES-COMMON-LISP
     KWD-RULES-FUNCTION))))
