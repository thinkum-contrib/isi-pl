...
(CL:DECLAIM
  ...
  *TRACED-KEYWORDS* *CONTEXT* *QUERYITERATOR* NIL STANDARD-OUTPUT
  *REVERSEPOLARITY?* EOL TRUE-WRAPPER FALSE-WRAPPER NULL-INTEGER))
      ...
      (CL:LET* ((OLDBINDINGS NULL) (ITER-000 (%THE-CONS-LIST CACHEDBINDINGS)))
       (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-000 NIL)) DO
        ...
        (CL:LET* ((ALWAYS?-000 CL:T))
         (CL:LET*
          ((V1 NULL) (ITER-001 BINDINGS) (V2 NULL) (ITER-002 OLDBINDINGS))
          (CL:LOOP WHILE
           (CL:AND (CL:NOT (CL:EQ ITER-001 NIL))
            (CL:NOT (CL:EQ ITER-002 NIL)))
           DO (CL:SETQ V1 (%%VALUE ITER-001)) (CL:SETQ V2 (%%VALUE ITER-002))
...
(CL:DEFUN PRINT-ATOMIC-GOAL-CACHE (SELF STREAM)
  ...
  (CL:LET*
   ...
   (CL:LET*
    ((ARG NULL) (VECTOR-000 (%ARGUMENTS (%PROPOSITION SELF))) (INDEX-000 0)
         ...
         (CL:LET* ((FOUND?-001 CL:NIL))
          (CL:LET*
           ((ARG NULL) (VECTOR-003 (%ARGUMENTS (%PROPOSITION CACHE)))
            (INDEX-003 0) (LENGTH-003 (LENGTH VECTOR-003)) (BINDING NULL)
            (ITER-003 (%BINDINGS CACHE)))
