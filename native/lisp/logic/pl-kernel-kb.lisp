...
(CL:DEFUN /PL-KERNEL-KB/INITIALIZE-KERNEL-KB ()
  ...
  (CL:LET*
   ...
   (CL:LET* ((*WARNIFREDEFINE?* FALSE))
    ...
    (CL:LET*
     ((*MODULE* (GET-STELLA-MODULE "PL-KERNEL-KB" TRUE)) (*CONTEXT* *MODULE*))
...
the proposition, or by generating other assertions.\" :AXIOMS (SINGLE-VALUED RELATION-EVALUATOR)) (DEFRELATION RELATION-COMPUTATION ((?R RELATION) (?COMPUTATION COMPUTED-PROCEDURE)) :DOCUMENTATION \"Names a 'computation' (a function) that evaluates an (atomic) relation
