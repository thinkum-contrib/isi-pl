...
(CL:DEFVAR SGT-WHYNOT-LOGIC-NUMBER-OF-FAILED-SUBGOALS-MEMO-TABLE-000 NULL)
...
(CL:DECLAIM
  ...
  *SIMILAR-WHYNOT-PROOF-CUTOFF* NIL-LIST UNKNOWN-TRUTH-VALUE *TRACED-KEYWORDS*
  NULL-INTEGER-WRAPPER FALSE-TRUTH-VALUE DEFAULT-FALSE-TRUTH-VALUE
  TRUE-TRUTH-VALUE *MINIMUM-SCORE-CUTOFF* NULL-FLOAT-WRAPPER TRUE
  STANDARD-OUTPUT EOL *MEMOIZATION-ENABLED?* MEMOIZED-NULL-VALUE
  *QUERYITERATOR* FALSE NIL NULL-FLOAT NULL-INTEGER))

;;; (DEFCLASS WHYNOT-PARTIAL-MATCH ...)

(CL:DEFCLASS WHYNOT-PARTIAL-MATCH (INCREMENTAL-PARTIAL-MATCH)
  ((UNKNOWN-GOAL-CUTOFF :TYPE CL:FIXNUM :INITFORM NULL-INTEGER :ALLOCATION
    :INSTANCE :ACCESSOR %UNKNOWN-GOAL-CUTOFF))
  (:DOCUMENTATION
...
(CL:DEFUN NEW-WHYNOT-PARTIAL-MATCH (KIND CONTROL-FRAME)
  (CL:LET* ((SELF NULL))
   ...
   (CL:SETF (%KIND SELF) KIND) (CL:SETF (%CONTROL-FRAME SELF) CONTROL-FRAME)
   (CL:SETF (%SUCCESS? SELF) FALSE) (CL:SETF (%UNBOUND-VARS SELF) NIL)
   ...
   (CL:SETF (%ACCUMULATED-SCORE SELF) 0.0d0) (CL:SETF (%CHILD SELF) NULL)
   (CL:SETF (%PARENT SELF) NULL)
...
(CL:DEFUN NEW-WHYNOT-DEEP-PARTIAL-MATCH (KIND CONTROL-FRAME)
  (CL:LET* ((SELF NULL))
   (CL:SETQ SELF (CL:MAKE-INSTANCE (CL:QUOTE WHYNOT-DEEP-PARTIAL-MATCH)))
   (CL:SETF (%KIND SELF) KIND) (CL:SETF (%CONTROL-FRAME SELF) CONTROL-FRAME)
   (CL:SETF (%SUCCESS? SELF) FALSE) (CL:SETF (%UNBOUND-VARS SELF) NIL)
   (CL:SETF (%ARGUMENT-WEIGHTS SELF) NIL)
   (CL:SETF (%ARGUMENT-SCORES SELF) NIL)
...
(CL:DEFMETHOD COMPUTE-UNKNOWN-GOAL-CUTOFF ((SELF WHYNOT-PARTIAL-MATCH))
  (CL:LET*
   ((PARENT (%PARENT SELF)) (PARENTCUTOFF NULL-INTEGER) (CUTOFF NULL-INTEGER))
...
(CL:DEFMETHOD NUMBER-OF-FAILED-SUBGOALS ((SELF WHYNOT-PARTIAL-MATCH))
  (CL:LET*
   ...
   (CL:LET*
    ((MEMO-TABLE-000
      (%SURROGATE-VALUE
       SGT-WHYNOT-LOGIC-NUMBER-OF-FAILED-SUBGOALS-MEMO-TABLE-000))
    ...
    (CL:WHEN *MEMOIZATION-ENABLED?*
     (CL:SETQ MEMOIZED-ENTRY-000
      (LOOKUP-MRU-MEMOIZED-VALUE MEMO-TABLE-000 PROOF MEMOIZED-NULL-VALUE NULL
       NULL -1))
...
(CL:DEFUN COMPUTE-NUMBER-OF-FAILED-SUBGOALS (PROOF)
  (CL:LET* ((LIST NULL))
   ...
   0))
(CL:DECLAIM
 (CL:FTYPE (CL:FUNCTION (CL:T) CL:FIXNUM) COMPUTE-NUMBER-OF-FAILED-SUBGOALS))
...
(CL:DEFMETHOD CUTOFF-PARTIAL-MATCH? ((SELF WHYNOT-PARTIAL-MATCH) TRACE?)
  (CL:LET*
   ((SCORE (%POSITIVE-SCORE SELF)) (SCORECUTOFF (%DYNAMIC-CUTOFF SELF))
    (UNKNOWNGOALCUTOFF (%UNKNOWN-GOAL-CUTOFF SELF)) (CUTOFF? FALSE))
...
(CL:DEFUN AUXILIARY-EQUIVALENCE-PROPOSITION? (PROPOSITION)
  (CL:LET* ((TEST-VALUE-000 FALSE))
   (CL:SETQ TEST-VALUE-000 (CL:EQ (%KIND PROPOSITION) KWD-WHYNOT-EQUIVALENT))
  ...
  (CL:COND ((CL:EQ PROPOSITION NULL) 1.0d0)
   ...
   ((CL:NOT
     (CL:=
      ...
      NULL-FLOAT))
    (%WRAPPER-VALUE
     (DYNAMIC-SLOT-VALUE (%DYNAMIC-SLOTS PROPOSITION) SYM-WHYNOT-LOGIC-WEIGHT
      NULL-FLOAT-WRAPPER)))
   ((CL:NOT
     (CL:EQ
    ...
    ((CL:OR (CL:EQ LASTMOVE KWD-WHYNOT-UP-TRUE)
     ...
     (CL:LET*
      ((SUCCESS? (CL:EQ LASTMOVE KWD-WHYNOT-UP-TRUE))
       (ANDPROPOSITION (%PROPOSITION FRAME)) (CONJUNCTFRAME (%RESULT FRAME))
       ...
       (CL:T
        (CL:WHEN
         ...
         (CL:IF
          ...
          (CL:SETQ LASTMOVE KWD-WHYNOT-UP-FAIL)
          (SET-FRAME-PARTIAL-TRUTH SELF NULL SCORE NULL-FLOAT FALSE)))))))
    (CL:T
     (CL:LET* ((STREAM-000 (NEW-OUTPUT-STRING-STREAM)))
   ...
   (CL:LET* ((RESULT (CONTINUE-AND-PROOF FRAME LASTMOVE)))
    (CL:COND
     ...
     ((CL:EQ RESULT KWD-WHYNOT-FAILURE)
      (SET-FRAME-PARTIAL-TRUTH SELF (%TRUTH-VALUE FRAME) NULL-FLOAT NULL-FLOAT
       FALSE))
     (CL:T))
    RESULT)))
  ...
  (CL:COND
   ...
   (CL:T
    (CL:LET* ((STREAM-000 (NEW-OUTPUT-STRING-STREAM)))
     ...
     (CL:ERROR (NEW-STELLA-EXCEPTION (THE-STRING-READER STREAM-000)))))))
(CL:DECLAIM
 (CL:FTYPE (CL:FUNCTION (CL:T) CL:FIXNUM) NUMBER-OF-REMAINING-ANTECEDENTS))
...
(CL:DEFMETHOD CONTINUE-PARTIAL-ANTECEDENTS-PROOF ((SELF WHYNOT-PARTIAL-MATCH) LASTMOVE)
  (CL:LET*
   ((FRAME (%CONTROL-FRAME SELF))
    (ITERATOR
     (DYNAMIC-SLOT-VALUE (%DYNAMIC-SLOTS FRAME) SYM-WHYNOT-STELLA-ITERATOR
      NULL))
   ...
   (CL:COND
    ...
    ((CL:OR (CL:EQ LASTMOVE KWD-WHYNOT-UP-TRUE)
     ...
     (CL:WHEN
      ...
      (SET-FRAME-PARTIAL-TRUTH SELF UNKNOWN-TRUTH-VALUE 0.0d0 NULL-FLOAT TRUE)
      (CL:SETQ LASTMOVE KWD-WHYNOT-UP-FAIL)))
    (CL:T
     (CL:LET* ((STREAM-000 (NEW-OUTPUT-STRING-STREAM)))
      (%%PRINT-STREAM (%NATIVE-STREAM STREAM-000) "`" LASTMOVE
   ...
   (CL:WHEN
    (CL:NOT
     (CL:OR (CL:EQ LASTMOVE KWD-WHYNOT-UP-TRUE) (NULL? ALLOTTEDCLOCKTICKS)))
    (CL:SETF (%ALLOTTED-CLOCK-TICKS FRAME)
     (CL:TRUNCATE
      (CL:/
       (CL:FLOAT
        (CL:-
         (%WRAPPER-VALUE
          (DYNAMIC-SLOT-VALUE (%DYNAMIC-SLOTS FRAME)
           SYM-WHYNOT-LOGIC-REAL-ALLOTTED-CLOCK-TICKS NULL-INTEGER-WRAPPER))
    ...
    (CL:WHEN
     ...
     (SET-DYNAMIC-SLOT-VALUE (%DYNAMIC-SLOTS FRAME) SYM-WHYNOT-STELLA-ITERATOR
      (ALLOCATE-ITERATOR NIL) NULL)))
...
(CL:DEFMETHOD SKIP-AND-CLAUSE? ((SELF WHYNOT-PARTIAL-MATCH) FRAME FORBIDDENVARS)
  (CL:LET*
   ...
   (CL:LET* ((TEST-VALUE-000 FALSE)) (CL:SETQ TEST-VALUE-000 FORBIDDENVARS?)
    (CL:WHEN TEST-VALUE-000
     (CL:LET* ((FOUND?-000 FALSE))
      (CL:LET* ((VAR NULL) (ITER-000 (GET-UNBOUND-VARIABLES CONJUNCT)))
       (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-000 NIL)) DO
        ...
        (CL:WHEN (MEMBER? FORBIDDENVARS VAR) (CL:SETQ FOUND?-000 TRUE)
         (CL:RETURN))))
      (CL:SETQ TEST-VALUE-000 FOUND?-000)))
    ...
    (CL:WHEN TEST-VALUE-000
     (CL:LET* ((RESULT (CREATE-DOWN-FRAME FRAME CONJUNCT)))
      ...
      (SET-FRAME-PARTIAL-TRUTH (%PARTIAL-MATCH-FRAME RESULT)
       UNKNOWN-TRUTH-VALUE 0.0d0 NULL-FLOAT TRUE)
      ...
      (CL:WHEN (TRACE-KEYWORD? KWD-WHYNOT-GOAL-TREE)
       (%%PRINT-STREAM (%NATIVE-STREAM STANDARD-OUTPUT) "*** Skipping clause "
        CONJUNCT EOL))
      (CL:RETURN-FROM SKIP-AND-CLAUSE? TRUE))))
   FALSE))
...
(CL:DEFMETHOD INITIALIZE-PARTIAL-MATCH-STRATEGY ((SELF WHYNOT-PARTIAL-MATCH) QUERY)
  (CL:LET*
   ...
   (CL:SETF (%DYNAMIC-CUTOFF SELF)
    (CL:IF (CL:NOT (CL:EQ MINIMUMSCORE NULL)) (%WRAPPER-VALUE MINIMUMSCORE)
     EPSILON))
  ...
  (CL:LET*
   ...
   (CL:SETF (%DYNAMIC-CUTOFF PARTIALMATCHFRAME)
    (CL:IF (CL:NOT (CL:EQ MINIMUMSCORE NULL)) (%WRAPPER-VALUE MINIMUMSCORE)
     0.3d0))
   (CL:LET*
    ((*QUERYITERATOR* QUERY) (*GENERATE-ALL-PROOFS?* TRUE)
     (*RECORD-JUSTIFICATIONS?* TRUE) (*INFERENCELEVEL* INITIALINFERENCELEVEL)
    ...
    (CL:LOOP (CL:WHEN (CL:NOT (NEXT? QUERY)) (CL:RETURN))
     ...
     (CL:WHEN (CUTOFF-PARTIAL-MATCH? PARTIALMATCHFRAME FALSE) (CL:RETURN))
     (CL:WHEN
      (CL:=
       (LENGTH
   ...
   (CL:LET*
    ...
    (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-000 NIL)) DO
     ...
     (CL:IF (CL:EQ COLLECT-000 NULL)
      ...
      (CL:PROGN
       (CL:SETF (%%REST COLLECT-000) (CONS (%REPRESENTATIVE CLASS) NIL))
       (CL:SETQ COLLECT-000 (%%REST COLLECT-000))))))
   (SET-DYNAMIC-SLOT-VALUE (%DYNAMIC-SLOTS BASEFRAME)
    SYM-WHYNOT-LOGIC-JUSTIFICATION (FIRST (ALL-JUSTIFICATIONS BASEFRAME))
    NULL)
   (CL:IF
    (CL:NOT
     (CL:EQ
  ...
  (CL:LET* ((FOUNDDEVIATIONS 0) (SUBDEVIATIONS 0))
   ...
   (CL:WHEN
    (CL:AND (CL:EQ (%INFERENCE-RULE PROOF1) (%INFERENCE-RULE PROOF2))
     ...
     (EQUIVALENT-PROPOSITIONS? (%PROPOSITION PROOF1) (%PROPOSITION PROOF2)
      NULL))
    (CL:WHEN (CL:EQ (%INFERENCE-RULE PROOF1) KWD-WHYNOT-PATTERN)
     (CL:LET*
      ((VALUE2 NULL) (VAR2 NULL) (VALUE1 NULL) (VAR1 NULL)
       (ITER-000 (%THE-KV-LIST (%SUBSTITUTION PROOF1)))
       (ITER-001 (%THE-KV-LIST (%SUBSTITUTION PROOF2))))
      (CL:LOOP WHILE
       (CL:AND (CL:NOT (CL:EQ ITER-000 NULL)) (CL:NOT (CL:EQ ITER-001 NULL)))
       DO (CL:SETQ VAR1 (%KEY ITER-000))
       (CL:PROGN (CL:SETQ VALUE1 (%VALUE ITER-000))
        (CL:SETQ ITER-000 (%REST ITER-000)))
       (CL:SETQ VAR2 (%KEY ITER-001))
       (CL:PROGN (CL:SETQ VALUE2 (%VALUE ITER-001))
    ...
    (CL:LET*
     ((ANT2 NULL) (ANT1 NULL) (ITER-002 (%ANTECEDENTS PROOF1))
      (ITER-003 (%ANTECEDENTS PROOF2)))
     (CL:LOOP WHILE
      (CL:AND (CL:NOT (CL:EQ ITER-002 NIL)) (CL:NOT (CL:EQ ITER-003 NIL))) DO
      (CL:PROGN (CL:SETQ ANT1 (%%VALUE ITER-002))
       (CL:SETQ ITER-002 (%%REST ITER-002)))
      (CL:PROGN (CL:SETQ ANT2 (%%VALUE ITER-003))
       (CL:SETQ ITER-003 (%%REST ITER-003)))
      (CL:SETQ SUBDEVIATIONS
       (COMPUTE-PROOF-DEVIATION ANT1 ANT2 (CL:- MAXDEVIATIONS FOUNDDEVIATIONS)
        DEVIATIONS))
...
(CL:DEFUN INSERT-WHYNOT-PROOF-TO-CLASS? (CLASS PROOF)
  (CL:WHEN (EMPTY? CLASS)
   ...
   (CL:RETURN-FROM INSERT-WHYNOT-PROOF-TO-CLASS? TRUE))
  (CL:LET*
   ...
   (CL:WHEN (DEFINED? FOUNDDEVIATIONS)
    (CL:LET*
     ((REPDEV NULL) (NEWDEV NULL) (ITER-000 (%THE-KV-LIST DEVIATIONS)))
     (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-000 NULL)) DO
      (CL:SETQ NEWDEV (%KEY ITER-000))
      (CL:PROGN (CL:SETQ REPDEV (%VALUE ITER-000))
       (CL:SETQ ITER-000 (%REST ITER-000)))
      ...
      (CL:LET*
       ((REPVALUE NULL) (REPVAR NULL) (NEWVALUE NULL) (NEWVAR NULL)
        (ITER-001 (%THE-KV-LIST (%SUBSTITUTION NEWDEV)))
        (ITER-002 (%THE-KV-LIST (%SUBSTITUTION (%DEVIATING-PATTERN CLASS)))))
       (CL:LOOP WHILE
        (CL:AND (CL:NOT (CL:EQ ITER-001 NULL)) (CL:NOT (CL:EQ ITER-002 NULL)))
        DO (CL:SETQ NEWVAR (%KEY ITER-001))
        (CL:PROGN (CL:SETQ NEWVALUE (%VALUE ITER-001))
         (CL:SETQ ITER-001 (%REST ITER-001)))
        (CL:SETQ REPVAR (%KEY ITER-002))
        (CL:PROGN (CL:SETQ REPVALUE (%VALUE ITER-002))
         (CL:SETQ ITER-002 (%REST ITER-002)))
        (CL:WHEN (CL:NOT (EQL? NEWVALUE REPVALUE)) (CL:SETQ REPVAR REPVAR)
         (CL:COND
          ...
          ((CL:NOT (CL:EQ NEWVAR (%DEVIATING-VARIABLE CLASS)))
           (CL:RETURN-FROM INSERT-WHYNOT-PROOF-TO-CLASS? FALSE))
...
(CL:DEFUN NEW-ALTERNATIVE-BINDINGS-SET ()
  (CL:LET* ((SELF NULL))
   (CL:SETQ SELF (CL:MAKE-INSTANCE (CL:QUOTE ALTERNATIVE-BINDINGS-SET)))
   ...
   (CL:SETF (%BINDINGS SELF) (NEW-SET)) (CL:SETF (%THE-VARIABLE SELF) NULL)
   SELF))
...
(CL:DEFUN CUTOFF-SIMILAR-WHYNOT-PROOFS (QUERY)
  (CL:LET* ((CONTINUATIONFRAME (%BASE-CONTROL-FRAME QUERY)))
   ...
   (CL:WHEN
    ...
    (CL:WHEN (TRACE-KEYWORD? KWD-WHYNOT-GOAL-TREE)
     (CL:LET*
      ((*PRINTINFRAME* CONTINUATIONFRAME) (*PRINTMODE* KWD-WHYNOT-REALISTIC)
       (*PRINTLOGICALFORMSTREAM* STANDARD-OUTPUT) (*QUERYITERATOR* QUERY))
      (CL:DECLARE
...
(CL:DEFMETHOD RETRIEVE-PARTIAL-SOLUTIONS ((SELF WHYNOT-PARTIAL-MATCH) QUERY)
  (CL:LET*
   ((BASEFRAME (%BASE-CONTROL-FRAME QUERY))
    ...
    (TOPNPARTIALPROOFS TOPN) (HAVEENOUGHPARTIALPROOFS? FALSE)
   ...
   (CL:LET*
    ...
    (CL:LOOP
     (CL:TAGBODY (CLEAR (%SOLUTIONS QUERY))
      (CL:WHEN
       (CL:OR (CL:= (LENGTH STRICTPROOFS) HOWMANY) (CL:NOT (NEXT? QUERY)))
       (CL:RETURN))
      (CL:SETQ *INFERENCELEVEL* INITIALINFERENCELEVEL)
      (CL:WHEN (CUTOFF-PARTIAL-MATCH? PARTIALMATCHFRAME FALSE) (CL:RETURN))
        ...
        (CL:LET* ((PROOF NULL) (ITER-000 (%THE-CONS-LIST STRICTPROOFS)))
         (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-000 NIL)) DO
          (CL:PROGN (CL:SETQ PROOF (%%VALUE ITER-000))
           (CL:SETQ ITER-000 (%%REST ITER-000)))
          (CL:WHEN
           (EQUAL? (RETRIEVAL-PROOF-SOLUTION PROOF QUERY) CURRENTSOLUTION)
           (CL:SETQ FOUND?-000 TRUE) (CL:RETURN))))
        (CL:SETQ TEST-VALUE-000 FOUND?-000))
      ...
      (CL:WHEN
       (CL:= (LENGTH (INSERT-WHYNOT-PROOF PARTIALPROOFCLASSES CURRENTPROOF))
        *SIMILAR-WHYNOT-PROOF-CUTOFF*)
       (CUTOFF-SIMILAR-WHYNOT-PROOFS QUERY))
      ...
      (CL:WHEN
       ...
       (CL:SETQ HAVEENOUGHPARTIALPROOFS? TRUE)
   ...
   (CL:WHEN (CL:NOT (CL:= (LENGTH STRICTPROOFS) HOWMANY))
    ...
    (CL:LET*
     ((I NULL-INTEGER) (CLASS NULL)
      (ITER-001 (%THE-CONS-LIST PARTIALPROOFCLASSES)) (ITER-002 1)
      (UPPER-BOUND-000 TOPNPARTIALPROOFS)
   ...
   (CL:LET*
    ((PROOF NULL) (ITER-003 (%THE-CONS-LIST (ALL-JUSTIFICATIONS BASEFRAME))))
    (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-003 NIL)) DO
     (CL:PROGN (CL:SETQ PROOF (%%VALUE ITER-003))
      (CL:SETQ ITER-003 (%%REST ITER-003)))
...
(CL:DEFUN RETRIEVAL-PROOF-SOLUTION (PROOF QUERY)
  (CL:LET* ((SOLUTION NIL) (SUBSTITUTION (%SUBSTITUTION PROOF)))
   (CL:LET*
    ((EXTVAR NULL) (VECTOR-000 (%EXTERNAL-VARIABLES QUERY)) (INDEX-000 0)
     (LENGTH-000 (LENGTH VECTOR-000)))
    (CL:DECLARE (CL:TYPE CL:FIXNUM INDEX-000 LENGTH-000))
    (CL:LOOP WHILE (CL:< INDEX-000 LENGTH-000) DO
     (CL:PROGN
      ...
      (CL:SETQ INDEX-000 (CL:1+ INDEX-000)))
     (CL:LET* ((VALUE NULL) (VAR NULL) (ITER-000 (%THE-KV-LIST SUBSTITUTION)))
      (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-000 NULL)) DO
   ...
   (CL:LET* ((VARIABLES (NEW-LIST)))
    ...
    (CL:WHEN (NON-EMPTY? VARIABLES)
     (CL:LET* ((ANTECEDENT NULL) (ITER-001 (%ANTECEDENTS PROOF)))
      (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-001 NIL)) DO
       (CL:PROGN (CL:SETQ ANTECEDENT (%%VALUE ITER-001))
        (CL:SETQ ITER-001 (%%REST ITER-001)))
       (CL:LET* ((TEST-VALUE-000 FALSE))
        (CL:IF (FAILED-GOAL-JUSTIFICATION? ANTECEDENT)
         ...
         (CL:LET* ((FOUND?-000 FALSE))
          (CL:LET*
           ((ARG NULL) (VECTOR-001 (%ARGUMENTS (%PROPOSITION ANTECEDENT)))
           ...
           (CL:LOOP WHILE (CL:< INDEX-001 LENGTH-001) DO
            ...
            (CL:WHEN (MEMBER? VARIABLES ARG) (CL:SETQ FOUND?-000 TRUE)
             (CL:RETURN))))
          (CL:SETQ TEST-VALUE-000 FOUND?-000)))
...
(CL:DEFUN EXPLAIN-WHYNOT (LABEL STYLE MAXDEPTH SUMMARY? STREAM)
  ...
  (CL:HANDLER-CASE
   (CL:LET* ((MAPPINGS NIL))
    (CL:LET*
     ((I NULL-INTEGER) (JUSTIFICATION NULL)
      (ITER-000
       (%THE-CONS-LIST
     ...
     (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-000 NIL)) DO
      (CL:PROGN (CL:SETQ JUSTIFICATION (%%VALUE ITER-000))
       (CL:SETQ ITER-000 (%%REST ITER-000)))
...
`maxDepth' and `style'.  Print a summary only if `summary?' is TRUE."
  ...
  (CL:LET*
   ...
   (CL:COND
    ((CL:EQ JUSTIFICATION NULL)
     (CL:WHEN (CL:NOT (CL:EQ *MOST-RECENT-QUERY* NULL))
      ...
      (%%PRINT-STREAM (%NATIVE-STREAM STREAM) EOL "  "
       (LOOKUP-EXPLANATION-PHRASE KWD-WHYNOT-NOT-ASSERTED NIL NULL) " and "
       EOL "  " (LOOKUP-EXPLANATION-PHRASE KWD-WHYNOT-NO-RULES NIL NULL) "."
       EOL)))
    (SUMMARY?
     (CL:LET* ((FAILURES (NEW-LIST)))
      ...
      (CL:LET*
       ((I NULL-INTEGER) (FAILURE NULL) (ITER-000 (%THE-CONS-LIST FAILURES))
        (ITER-001 1))
       (CL:DECLARE (CL:TYPE CL:FIXNUM ITER-001 I))
       (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-000 NIL)) DO
        (CL:PROGN (CL:SETQ FAILURE (%%VALUE ITER-000))
         (CL:SETQ ITER-000 (%%REST ITER-000)))
        (CL:PROGN (CL:SETQ I ITER-001) (CL:SETQ ITER-001 (CL:1+ ITER-001)))
    ...
    (CL:T
     (PRINT-EXPLANATION JUSTIFICATION STREAM *MOST-RECENT-EXPLANATION-MAPPING*
      MAXDEPTH *EXPLANATION-AUDIENCE*)))))
  ...
  (CL:LET* ((JUSTIFICATIONS NULL))
   ...
   (CL:WHEN (CL:NOT (CL:EQ LABEL STELLA::NULL-STRING))
    (CL:WHEN (CL:NOT (CL:EQ MAPPING NULL))
     (CL:SETQ JUSTIFICATIONS (LIST (LOOKUP-JUSTIFICATION MAPPING LABEL))))
...
(CL:DEFUN HELP-STARTUP-WHYNOT1 ()
  (CL:PROGN
   ...
   (CL:SETQ SGT-WHYNOT-LOGIC-NUMBER-OF-FAILED-SUBGOALS-MEMO-TABLE-000
    (INTERN-RIGID-SYMBOL-WRT-MODULE "NUMBER-OF-FAILED-SUBGOALS-MEMO-TABLE-000"
     NULL 1))
...
lookup its justification relative to `mapping' and return the result.\")"
   ...
   (CL:WHEN (CURRENT-STARTUP-TIME-PHASE? 9)
    ...
    (REGISTER-NATIVE-NAME SYM-WHYNOT-LOGIC-WHYNOT KWD-WHYNOT-COMMON-LISP
     KWD-WHYNOT-FUNCTION))))
