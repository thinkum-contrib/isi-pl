...
(CL:DECLAIM
  ...
  *TRACED-KEYWORDS* NULL-INTEGER-WRAPPER FALSE-TRUTH-VALUE
  ...
  NULL-FLOAT-WRAPPER TRUE STANDARD-OUTPUT EOL *MEMOIZATION-ENABLED?*
  MEMOIZED-NULL-VALUE *QUERYITERATOR* FALSE NIL NULL-FLOAT
  NULL-INTEGER))
  ...
  (CL:LET*
   ...
   (CL:LET*
    ...
    (CL:LOOP (CL:WHEN (CL:NOT (NEXT? QUERY)) (CL:RETURN))
     ...
     (CL:WHEN (CUTOFF-PARTIAL-MATCH? PARTIALMATCHFRAME FALSE)
      (CL:RETURN))
     (CL:WHEN
      (CL:=
       (LENGTH
   ...
   (CL:LET*
    ...
    (CL:LOOP WHILE (CL:< INDEX-000 LENGTH-000) DO
     (CL:PROGN
      ...
      (CL:SETQ INDEX-000 (CL:1+ INDEX-000)))
     (CL:LET*
      ((VALUE NULL) (VAR NULL) (ITER-000 (%THE-KV-LIST SUBSTITUTION)))
      (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-000 NULL)) DO
     ...
     (CL:LET* ((FAILURES (NEW-LIST)))
      ...
      (CL:LET*
       ((I NULL-INTEGER) (FAILURE NULL)
        (ITER-000 (%THE-CONS-LIST FAILURES)) (ITER-001 1))
       (CL:DECLARE (CL:TYPE CL:FIXNUM ITER-001 I))
       (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-000 NIL)) DO
