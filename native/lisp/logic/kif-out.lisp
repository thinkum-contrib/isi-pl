...
(CL:DECLAIM
 (CL:SPECIAL *STARTUP-TIME-PHASE* DEFAULT-TRUE-TRUTH-VALUE
  DEFAULT-FALSE-TRUTH-VALUE UNKNOWN-TRUTH-VALUE NIL TRUE-WRAPPER
  ZERO-VARIABLES-VECTOR FALSE-WRAPPER *PRINTFUNCTIONSASRELATIONS?*
  *PRINTREADABLY?* EOL *CURRENTJUSTIFICATION* *PRINTMODE* STANDARD-OUTPUT
  *LOGIC-DIALECT* NULL-INTEGER *MODULE*))
...
(CL:DECLAIM
 (CL:FTYPE (CL:FUNCTION (CL:SIMPLE-STRING) CL:SIMPLE-STRING) MAYBE-DOWNCASE))
(CL:DEFUN MAYBE-DOWNCASE (STRING)
  ...
  (CL:WHEN (CL:NOT (%CASE-SENSITIVE? *MODULE*))
   ...
   (CL:COND
    ((STRING-EQL? STRING "FORALL") (CL:RETURN-FROM MAYBE-DOWNCASE "forall"))
   ...
   (CL:T
    (CL:LET* ((FN (LOOKUP *LOGIC-DIALECT-PRINT-FUNCTIONS* DIALECT)))
     (CL:IF (CL:NOT (CL:EQ FN NULL))
      (CL:FUNCALL (%WRAPPER-VALUE FN) SELF STREAM)
...
(CL:DEFUN PRINT-AS-KIF (SELF STREAM)
  (CL:LET* ((CURRENTINDENTCOUNTER *INDENTCOUNTER*))
   ...
   (CL:LET*
    ...
    (CL:DECLARE
     (CL:SPECIAL *INDENTCOUNTER* *PRINTLOGICALFORMSTREAM* *PRETTYPRINTKIF?*))
    (CL:DECLARE (CL:TYPE CL:FIXNUM *INDENTCOUNTER*))
...
(CL:DEFUN PRINT-AS-KIF-INTERNAL (SELF)
  (CL:LET* ((STREAM *PRINTLOGICALFORMSTREAM*))
   (CL:WHEN (CL:EQ SELF NULL) (%%PRINT-STREAM (%NATIVE-STREAM STREAM) "NULL")
    (CL:RETURN-FROM PRINT-AS-KIF-INTERNAL))
   (CL:WHEN (DELETED? SELF) (%%PRINT-STREAM (%NATIVE-STREAM STREAM) "DeLeTeD")
    (CL:RETURN-FROM PRINT-AS-KIF-INTERNAL))
   (CL:LET* ((TEST-VALUE-000 (SAFE-PRIMARY-TYPE SELF)))
    (CL:COND
     ...
     ((SUBTYPE-OF-SURROGATE? TEST-VALUE-000)
      (CL:PROGN
       (%%PRINT-STREAM (%NATIVE-STREAM STREAM) (STRINGIFIED-SURROGATE SELF))))
     ((SUBTYPE-OF-KEYWORD? TEST-VALUE-000)
      (CL:PROGN (%%PRINT-STREAM (%NATIVE-STREAM STREAM) SELF)))
     ...
     ((SUBTYPE-OF? TEST-VALUE-000 SGT-KIF-OUT-LOGIC-LOGIC-THING)
      (CL:PROGN
       (%%PRINT-STREAM (%NATIVE-STREAM STREAM) (GENERATE-TERM SELF))))
     ((SUBTYPE-OF? TEST-VALUE-000 SGT-KIF-OUT-STELLA-THING)
      (CL:PROGN (%%PRINT-STREAM (%NATIVE-STREAM STREAM) SELF)))
     (CL:T
      (%%PRINT-STREAM (%NATIVE-STREAM STREAM) "|Illegal Logical Form|: "
       SELF))))))
...
(CL:DEFUN VISIBLE-ARGUMENT? (SELF)
  ...
  (CL:COND
   ((SUBTYPE-OF? (SAFE-PRIMARY-TYPE SELF) SGT-KIF-OUT-LOGIC-PROPOSITION)
    (CL:PROGN
     (CL:WHEN
      (CL:AND (CL:EQ (%KIND SELF) KWD-KIF-OUT-ISA)
...
(CL:DEFUN STRINGIFIED-SURROGATE (OPERATOR)
  (CL:LET*
   ((DESCRIPTION (GET-DESCRIPTION OPERATOR)) (STRING STELLA::NULL-STRING)
    (VISIBLE?
     (CL:EQ OPERATOR
      (LOOKUP-SURROGATE-IN-MODULE (%SYMBOL-NAME OPERATOR) *MODULE* CL:NIL))))
   (CL:DECLARE (CL:TYPE CL:SIMPLE-STRING STRING))
   ...
   (CL:WHEN
    ...
    (CL:LET*
     ((TEST-VALUE-000
       (COMPUTE-SYMBOL-ESCAPE-CODE STRING (%CASE-SENSITIVE? *MODULE*))))
     (CL:COND
      ((CL:EQ TEST-VALUE-000 KWD-KIF-OUT-UNESCAPED)
       (CL:WHEN VISIBLE? (CL:SETQ STRING (MAYBE-DOWNCASE STRING))))
...
(CL:DECLAIM
 (CL:FTYPE (CL:FUNCTION (CL:T) CL:SIMPLE-STRING) STRINGIFIED-KIF-OPERATOR))
...
(CL:DEFUN PRINT-KIF-PROPOSITION (SELF)
  ...
  (CL:LET*
   ...
   (CL:LET* ((*TOPLEVELPRINTKIFPROPOSITION?* CL:NIL))
    ...
    (CL:WHEN PRINTEXPLICITNEGATION?
     (%%PRINT-STREAM (%NATIVE-STREAM STREAM) ")") (DECREASE-INDENT 5)))))
...
(CL:DEFUN HELP-PRINT-KIF-PROPOSITION (SELF)
  (CL:LET*
   ...
   (CL:LET* ((TEST-VALUE-000 (%KIND SELF)))
    (CL:COND
     ((CL:OR (CL:EQ TEST-VALUE-000 KWD-KIF-OUT-AND)
      ...
      (CL:WHEN (CL:= (VISIBLE-ARGUMENTS-COUNT (%ARGUMENTS SELF)) 1)
       (CL:COND
        ((CL:OR (CL:EQ *PRINTMODE* KWD-KIF-OUT-REALISTIC)
          (CL:EQ *PRINTMODE* KWD-KIF-OUT-ORIGINAL))
         (PRINT-KIF-ARGUMENTS (%ARGUMENTS SELF) CL:NIL CL:NIL)
         (CL:RETURN-FROM HELP-PRINT-KIF-PROPOSITION))
        (CL:T))))
     ((CL:EQ TEST-VALUE-000 KWD-KIF-OUT-NOT)
      (CL:SETQ OPERATOR (STRINGIFIED-SURROGATE SGT-KIF-OUT-PL-KERNEL-KB-NOT)))
     ...
     ((CL:OR (CL:EQ TEST-VALUE-000 KWD-KIF-OUT-ISA)
      ...
      (CL:WHEN (CL:EQ (%OPERATOR SELF) SGT-KIF-OUT-PL-KERNEL-KB-FORK)
       (CL:SETQ SEPARATELINES? CL:T)))
   ...
   (PRINT-KIF-OPERATOR-WITH-ARGUMENTS OPERATOR (%ARGUMENTS SELF)
    SEPARATELINES? CL:NIL)))
...
(CL:DEFUN PRINT-KIF-FUNCTION-PROPOSITION (SELF)
  (CL:LET*
   ...
   (CL:WHEN (CL:NOT PRINTASRELATION?)
    (%%PRINT-STREAM (%NATIVE-STREAM STREAM) "(= "))
...
(CL:DEFUN PRINT-KIF-FUNCTION-EXPRESSION (SELF)
  (CL:LET* ((DOWNCASEDNAME (STRINGIFIED-KIF-OPERATOR SELF)))
   (CL:DECLARE (CL:TYPE CL:SIMPLE-STRING DOWNCASEDNAME))
   (PRINT-KIF-OPERATOR-WITH-ARGUMENTS DOWNCASEDNAME (%ARGUMENTS SELF) CL:NIL
    CL:T)))
  ...
  (CL:LET*
   ...
   (CL:IF
    ...
    (PRINT-KIF-OPERATOR-WITH-ARGUMENTS
     (STRINGIFIED-SURROGATE SGT-KIF-OUT-PL-KERNEL-KB-SUBSET-OF)
     (%ARGUMENTS SELF) CL:T CL:NIL))))
  ...
  (CL:LET*
   ((STREAM *PRINTLOGICALFORMSTREAM*)
    (TAIL
     (CL:AREF (CL:THE CL:SIMPLE-VECTOR (%THE-ARRAY (%ARGUMENTS SELF))) 0))
    (HEAD
     (CL:IF (CL:= (LENGTH (%ARGUMENTS SELF)) 2)
      (CL:AREF (CL:THE CL:SIMPLE-VECTOR (%THE-ARRAY (%ARGUMENTS SELF))) 1)
      NULL))
   ...
   (PRINT-KIF-QUANTIFIED-VARIABLES
    (DYNAMIC-SLOT-VALUE (%DYNAMIC-SLOTS SELF) SYM-KIF-OUT-LOGIC-IO-VARIABLES
     NULL)
    CL:NIL)
   (%%PRINT-STREAM (%NATIVE-STREAM STREAM) EOL) (INCREASE-INDENT NULL-INTEGER)
   (PRINT-INDENT STREAM NULL-INTEGER)
   (CL:WHEN IMPLICATION?
    (%%PRINT-STREAM (%NATIVE-STREAM STREAM) "("
    ...
    (INCREASE-INDENT
     (CL:+
      (CL:THE CL:FIXNUM
       (CL:LENGTH
        (CL:THE CL:SIMPLE-STRING (%SYMBOL-NAME IMPLICATIONOPERATOR))))
      2))
    (PRINT-KIF-PROPOSITION HEAD) (%%PRINT-STREAM (%NATIVE-STREAM STREAM) EOL)
    (PRINT-INDENT STREAM NULL-INTEGER))
     ...
     (CL:+
      (CL:THE CL:FIXNUM
       (CL:LENGTH
        (CL:THE CL:SIMPLE-STRING (%SYMBOL-NAME IMPLICATIONOPERATOR))))
      2)))
   (DECREASE-INDENT NULL-INTEGER) (%%PRINT-STREAM (%NATIVE-STREAM STREAM) ")")))
...
(CL:DEFUN PRINT-KIF-TOP-LEVEL-EXISTS-PROPOSITION (SELF)
  (CL:LET* ((STREAM *PRINTLOGICALFORMSTREAM*))
   ...
   (PRINT-KIF-QUANTIFIED-VARIABLES (COLLECT-SKOLEMIZED-EXISTS-VARIABLES SELF)
    CL:NIL)
   (%%PRINT-STREAM (%NATIVE-STREAM STREAM) EOL) (INCREASE-INDENT NULL-INTEGER)
   (PRINT-INDENT STREAM NULL-INTEGER) (PRINT-KIF-PROPOSITION SELF)
   (DECREASE-INDENT NULL-INTEGER) (%%PRINT-STREAM (%NATIVE-STREAM STREAM) ")")))
   ...
   (CL:LET* ((TEST-VALUE-000 (SAFE-PRIMARY-TYPE SELF)))
    (CL:COND
     ((SUBTYPE-OF-INTEGER? TEST-VALUE-000)
      (CL:PROGN
       (%%PRINT-STREAM (%NATIVE-STREAM STREAM) (%WRAPPER-VALUE SELF))))
...
(CL:DEFUN PRINT-KIF-SKOLEM (SELF SUPPRESSDEFININGPROPOSITION?)
  (CL:LET* ((STREAM *PRINTLOGICALFORMSTREAM*))
   (CL:COND (SUPPRESSDEFININGPROPOSITION? (PRINT-SKOLEM SELF STREAM CL:NIL))
  ...
  (CL:LET* ((STREAM *PRINTLOGICALFORMSTREAM*))
   ...
   (CL:LET* ((M NULL) (ITER-000 (ALLOCATE-ITERATOR SELF)))
    (CL:LOOP WHILE (NEXT? ITER-000) DO (CL:SETQ M (%VALUE ITER-000))
     (%%PRINT-STREAM (%NATIVE-STREAM STREAM) " ") (PRINT-AS-KIF-INTERNAL M)))
   (%%PRINT-STREAM (%NATIVE-STREAM STREAM) ")")))

;;; (DEFUN PRINT-KIF-DESCRIPTION ...)

(CL:DEFUN PRINT-KIF-DESCRIPTION (SELF)
  (CL:LET* ((*QUERYITERATOR* NULL)) (CL:DECLARE (CL:SPECIAL *QUERYITERATOR*))
   (CL:LET*
    ((STREAM *PRINTLOGICALFORMSTREAM*)
     (COMPLEMENT
      (DYNAMIC-SLOT-VALUE (%DYNAMIC-SLOTS SELF)
    ...
    (CL:COND
     ...
     ((CL:AND (CL:NOT (CL:EQ COMPLEMENT NULL))
       (CL:NOT (CL:EQ (%SURROGATE-VALUE-INVERSE COMPLEMENT) NULL))
       (CL:NOT
        (CL:OR (CL:EQ *PRINTMODE* KWD-KIF-OUT-REALISTIC)
         (CL:EQ *PRINTMODE* KWD-KIF-OUT-ORIGINAL))))
      (%%PRINT-STREAM (%NATIVE-STREAM STREAM) "not-"
       (STRINGIFIED-SURROGATE (%SURROGATE-VALUE-INVERSE COMPLEMENT))))
     (CL:T
      (%%PRINT-STREAM (%NATIVE-STREAM STREAM) "("
       (STRINGIFIED-SURROGATE SGT-KIF-OUT-PL-KERNEL-KB-KAPPA) " ")
      (PRINT-KIF-QUANTIFIED-VARIABLES (%IO-VARIABLES SELF) CL:T)
      (%%PRINT-STREAM (%NATIVE-STREAM STREAM) " ")
...
(CL:DEFUN PRINT-KIF-DESCRIPTION-PROPOSITION (SELF INVERT?)
  (CL:LET*
   ...
   (CL:WHEN INVERT? (%%PRINT-STREAM (%NATIVE-STREAM STREAM) ")")
    (DECREASE-INDENT 4))))
  ...
  (CL:LET*
   ...
   (CL:WHEN
    ...
    (CL:COND
     ...
     (CL:T
      (CL:LET* ((STREAM-000 (NEW-OUTPUT-STRING-STREAM)))
       (%%PRINT-STREAM (%NATIVE-STREAM STREAM-000) "`" OPERATORPREFIX
        "' is not a valid case option")
       (CL:ERROR (NEW-STELLA-EXCEPTION (THE-STRING-READER STREAM-000)))))))
   OPERATORPREFIX))
  ...
  (CL:LET* ((MAPPING NULL))
   (CL:LET*
    ((OLDVAR NULL) (VECTOR-000 OLDVARS) (INDEX-000 0)
     (LENGTH-000 (LENGTH VECTOR-000)) (NEWVAR NULL) (VECTOR-001 NEWVARS)
  ...
  (CL:LET*
   ((STREAM *PRINTLOGICALFORMSTREAM*)
    ...
    (OPERATORPREFIXINDENT
     (CL:+ 2
      (CL:THE CL:FIXNUM
       (CL:LENGTH (CL:THE CL:SIMPLE-STRING (%SYMBOL-NAME OPERATORPREFIX))))))
    (MAPHEADVARIABLES? (NAMED-DESCRIPTION? HEAD))
    (RULE-VARIABLES
     (DYNAMIC-SLOT-VALUE (%DYNAMIC-SLOTS RULE) SYM-KIF-OUT-LOGIC-IO-VARIABLES
      NULL))
   ...
   (CL:COND
    ((CL:NOT (CL:EQ RULE-VARIABLES NULL))
     (CL:SETQ HEADVARIABLEMAPPING
      (CREATE-SKOLEM-MAPPING-TABLE (%IO-VARIABLES HEAD) RULE-VARIABLES))
     (CL:SETQ TAILVARIABLEMAPPING
      (CREATE-SKOLEM-MAPPING-TABLE (%IO-VARIABLES TAIL) RULE-VARIABLES)))
...
(CL:DEFUN EXCLUDE-ORIGINATED-PROPOSITIONS ()
  (CL:LET* ((D NULL) (ITER-000 (ALL-NAMED-DESCRIPTIONS NULL CL:NIL)))
   (CL:LOOP WHILE (NEXT? ITER-000) DO (CL:SETQ D (%VALUE ITER-000))
    (CL:LET*
     ((PROP NULL) (ITER-001 (%THE-CONS-LIST (ORIGINATED-PROPOSITIONS D))))
  ...
  (CL:LET*
   ((P NULL)
    (ITER-002 (ALLOCATE-ITERATOR (LOCALLY-CONCEIVED-PROPOSITIONS *MODULE*))))
   (CL:LOOP WHILE (NEXT? ITER-002) DO (CL:SETQ P (%VALUE ITER-002))
    (CL:WHEN (CL:NOT (CL:EQ (OBJECT-SURROGATE P) NULL))
     (CL:LET*
      ((PROP NULL) (ITER-003 (%THE-CONS-LIST (ORIGINATED-PROPOSITIONS P))))
...
(CL:DEFUN HIDDEN-RELATION? (RELATION-REF)
  (NEXT?
   (ALL-TRUE-DEPENDENT-PROPOSITIONS (%SURROGATE-VALUE RELATION-REF)
...
(CL:DEFUN EXCLUDED-PROPOSITION? (PROPOSITION MODULE)
  (CL:WHEN
   (CL:AND (UNKNOWN? PROPOSITION) (CL:EQ (HOME-MODULE PROPOSITION) MODULE))
    ...
    ((CL:EQ TEST-VALUE-000 KWD-KIF-OUT-FUNCTION)
     (CL:LET* ((LASTARG (LAST (%ARGUMENTS PROPOSITION))))
      (CL:WHEN
       ...
       (CL:RETURN-FROM EXCLUDED-PROPOSITION? CL:T))))
    ((CL:EQ TEST-VALUE-000 KWD-KIF-OUT-PREDICATE)
     (CL:WHEN (HIDDEN-RELATION? (%OPERATOR PROPOSITION))
      (CL:RETURN-FROM EXCLUDED-PROPOSITION? CL:T)))
    (CL:T)))
  CL:NIL)
  ...
  (CL:LET* ((TEST-VALUE-000 (SAFE-PRIMARY-TYPE SELF)))
   (CL:COND
    ((SUBTYPE-OF-CLASS? TEST-VALUE-000)
     (CL:PROGN (%CLASS-STRINGIFIED-SOURCE SELF)))
    ((SUBTYPE-OF-METHOD-SLOT? TEST-VALUE-000)
     (CL:PROGN (%METHOD-STRINGIFIED-SOURCE SELF)))
   ...
   (CL:LET* ((VALUE-000 NULL))
    (CL:LET* ((ELEMENT NULL) (ITER-000 TREE))
     (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-000 NIL)) DO
      ...
      (CL:WHEN (KEYWORD? ELEMENT) (CL:SETQ VALUE-000 ELEMENT) (CL:RETURN))
    ...
    (CL:LET* ((NOFHEADERELEMENTS (POSITION TREE VALUE-000 0)))
     ...
     (CL:LET* ((SELF-000 (NEW-PROPERTY-LIST)))
      ...
      (CL:LET* ((OPTIONS SELF-000) (KEYLENGTH NULL-INTEGER))
       ...
       (CL:WHEN (CL:= NOFHEADERELEMENTS NULL-INTEGER)
       ...
       (CL:LET*
        ...
        (CL:LOOP WHILE
         ...
         (%%PRINT-STREAM (%NATIVE-STREAM STREAM) ELEMENT)
         (CL:SETQ ITER-001 (%%REST ITER-001))
         (CL:SETQ ITER-002 (CL:1+ ITER-002))))
       (CL:LET*
        ((KEY NULL) (VALUE NULL) (ITER-003 (%THE-PLIST OPTIONS))
         ...
         (CL:COND
          ((CL:AND (CL:= I 1) (CL:NOT FORCEFIRSTKEYONSEPARATELINE?))
           (CL:WHEN (CL:> NOFHEADERELEMENTS 0)
            (%%PRINT-STREAM (%NATIVE-STREAM STREAM) " ")))
          (CL:T (%%PRINT-STREAM (%NATIVE-STREAM STREAM) EOL)
          ...
          ((SUBTYPE-OF-KEYWORD? (SAFE-PRIMARY-TYPE KEY))
           (CL:PROGN
            (CL:SETQ KEYLENGTH
             (CL:1+
              (CL:THE CL:FIXNUM
               (CL:LENGTH (CL:THE CL:SIMPLE-STRING (%SYMBOL-NAME KEY))))))
            (%%PRINT-STREAM (%NATIVE-STREAM STREAM) ":" (%SYMBOL-NAME KEY))))
          (CL:T (CL:SETQ KEYLENGTH 4)
           (%%PRINT-STREAM (%NATIVE-STREAM STREAM) KEY)))
         (%%PRINT-STREAM (%NATIVE-STREAM STREAM) " ")
         (CL:COND
          ((CL:AND
           ...
           (%%PRINT-STREAM (%NATIVE-STREAM STREAM) "(")
           (CL:LET*
            ((ELEMENT NULL) (ITER-005 VALUE) (I NULL-INTEGER) (ITER-006 1))
   ...
   ((OPERATOR SYM-KIF-OUT-STELLA-ASSERT)
    ...
    (TRUTHVALUE
     (ACCESS-IN-CONTEXT (%TRUTH-VALUE PROPOSITION) (%HOME-CONTEXT PROPOSITION)
      CL:NIL)))
   (CL:WHEN (CL:NOT (CL:EQ NAME NULL)) (PRETTY-PRINT-NAMED-RULE NAME STREAM)
...
(CL:DEFUN PRETTY-PRINT-NAMED-RULE (RULENAME STREAM)
  (CL:LET*
   ((OPERATOR SYM-KIF-OUT-LOGIC-DEFRULE)
    (PROPOSITION (%SURROGATE-VALUE RULENAME)))
   (CL:LET*
    ((*PRINTMODE* KWD-KIF-OUT-ORIGINAL) (*PRINTLOGICALFORMSTREAM* STREAM)
     (*INDENTCOUNTER* 2))
    (CL:DECLARE
    ...
    (CL:DECLARE (CL:TYPE CL:FIXNUM *INDENTCOUNTER*))
    (%%PRINT-STREAM (%NATIVE-STREAM STREAM) "(" OPERATOR " "
     (INTERN-SYMBOL-IN-MODULE (%SYMBOL-NAME RULENAME) (%HOME-CONTEXT RULENAME)
      CL:T)
     EOL)
    (PRINT-INDENT STREAM NULL-INTEGER)
    (PRETTY-PRINT-LOGICAL-FORM PROPOSITION STREAM)
    (CL:LET*
     ((PROP NULL)
      (ITER-000 (%THE-CONS-LIST (ORIGINATED-PROPOSITIONS PROPOSITION))))
     (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-000 NIL)) DO
        ...
        (CL:COND
         ((CL:OR (CL:EQ TEST-VALUE-000 KWD-KIF-OUT-PREDICATE)
          ...
          (CL:WHEN
           ...
           (CL:GO :CONTINUE)))
         (CL:T)))
       (%%PRINT-STREAM (%NATIVE-STREAM STREAM) EOL "  :AXIOMS ")
...
(CL:DEFUN PRINT-MODULE-FILE-HEADER (MODULE STREAM)
  ...
  (CL:WHEN
   (CL:NOT (MEMBER? *BUILT-IN-MODULE-NAMES* (WRAP-STRING (NAME MODULE))))
   (PRINT-DEFINITION MODULE STREAM))
  (%%PRINT-STREAM (%NATIVE-STREAM STREAM) EOL)
  (%%PRINT-STREAM (%NATIVE-STREAM STREAM) "(IN-MODULE \""
   (%MODULE-FULL-NAME MODULE) "\")" EOL EOL "(" SYM-KIF-OUT-LOGIC-IN-DIALECT
   " " *LOGIC-DIALECT* ")" EOL EOL))
     ...
     (CL:COND
      ...
      (CL:T
       (CL:LET* ((STREAM-000 (NEW-OUTPUT-STRING-STREAM)))
        ...
        (CL:ERROR (NEW-STELLA-EXCEPTION (THE-STRING-READER STREAM-000)))))))
    (CL:LET*
     ((DESCRIPTION NULL) (ITER-000 (ALL-NAMED-DESCRIPTIONS MODULE CL:T)))
     ...
     (CL:LET* ((REVERSEDPROPOSITIONS NIL))
      (CL:LET* ((P NULL) (ITER-003 (ALL-PROPOSITIONS MODULE CL:NIL)))
       (CL:LOOP WHILE (NEXT? ITER-003) DO (CL:SETQ P (%VALUE ITER-003))
        (CL:WHEN
         (CL:AND (LOCALLY-MODIFIED-PROPOSITION? P MODULE)
          (CL:NOT (EXCLUDED-PROPOSITION? P MODULE)))
...
(CL:DEFUN HELP-STARTUP-KIF-OUT2 ()
  (CL:PROGN
   ...
   (CL:SETQ SYM-KIF-OUT-STELLA-RETRACT
...
Any return values will be ignored.\" :PUBLIC? TRUE)"
   ...
   (DEFINE-FUNCTION-OBJECT "INCREASE-INDENT"
    "(DEFUN INCREASE-INDENT ((INDENT INTEGER)))" (CL:FUNCTION INCREASE-INDENT)
    NULL)
   (DEFINE-FUNCTION-OBJECT "DECREASE-INDENT"
    "(DEFUN DECREASE-INDENT ((INDENT INTEGER)))" (CL:FUNCTION DECREASE-INDENT)
    NULL)
...
either be an output stream or a persistent OBJECT-STORE.\" :PUBLIC? TRUE)"
   ...
   (DEFINE-FUNCTION-OBJECT "SAVE-MODULE"
    "(DEFUN SAVE-MODULE ((NAME NAME) (FILE STRING)) :COMMAND? TRUE :PUBLIC? TRUE :DOCUMENTATION \"Save all definitions and assertions of module `name' to `file'.\")"
    (CL:FUNCTION %SAVE-MODULE) (CL:FUNCTION SAVE-MODULE-EVALUATOR-WRAPPER))
   (DEFINE-FUNCTION-OBJECT "STARTUP-KIF-OUT"
    "(DEFUN STARTUP-KIF-OUT () :PUBLIC? TRUE)" (CL:FUNCTION STARTUP-KIF-OUT)
    NULL)
