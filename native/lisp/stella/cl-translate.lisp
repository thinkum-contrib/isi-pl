...
(CL:DECLAIM
 (CL:SPECIAL *STELLA-MODULE* FALSE-WRAPPER ONE-WRAPPER
  *CURRENTTRANSLATIONUNIT* *SAFETY* *STARTUP-TIME-PHASE*
  *UNFINALIZED-CLASSES* STANDARD-ERROR EOL NULL-STRING-WRAPPER
  *COMMON-LISP-MODULE* *MODULE* *CURRENT-ENVIRONMENT-FEATURES*))
...
(CL:DEFUN CL-TRANSLATE-LOCAL-SYMBOL (SYMBOL)
  (CL:LET* ((SYMBOLMODULE (%HOME-CONTEXT SYMBOL)))
   (CL:IF (CL:OR (CL:EQ SYMBOLMODULE NULL) (CL:EQ SYMBOLMODULE *MODULE*))
     ...
     (CL:RETURN-FROM YIELD-SLOT-VALUE-READER-TREE
      (CONS
       ...
       (CONS (WRAP-INTEGER (CL-STRUCT-SLOT-OFFSET SLOTNAME OBJECTTYPE))
        (CONS (CL-TRANSLATE-GLOBAL-SYMBOL (TYPE-TO-SYMBOL OBJECTTYPE))
...
(CL:DEFUN CL-TRANSLATE-FOREACH-TREE (TREE)
  (CL:LET*
   ((ITERATORBINDINGS (%%VALUE (%%REST TREE)))
    ...
    (DECLARATIONS NIL) (NEXTASSIGNMENTS NIL) (TYPEDECLARATIONS NIL)
   ...
   (CL:RETURN-FROM CL-TRANSLATE-FOREACH-TREE
    (LIST* (INTERN-COMMON-LISP-SYMBOL "LET*") DECLARATIONS
     (CONCATENATE (CL-YIELD-DECLARE-TREE TYPEDECLARATIONS)
      (CONS
...
(CL:DEFUN MAYBE-WRAP-WITH-CONTINUE-LABEL (TRANSLATEDLOOPBODY)
  (CL:IF (SEARCH-CONS-TREE? TRANSLATEDLOOPBODY KWD-CL-TRANSLATE-CONTINUE)
...
(CL:DEFUN CL-TRANSLATE-SPECIAL-TREE (TREE)
  (CL:LET*
   ((TRANSLATEDTREE (CL-TRANSLATE-LET-TREE TREE TRUE)) (SPECIALVARS NIL))
   (CL:LET*
...
(CL:DEFUN CL-TRANSLATE-STARTUP-TIME-PROGN-TREE (TREE)
  ...
  (CL:RETURN-FROM CL-TRANSLATE-STARTUP-TIME-PROGN-TREE
   (LIST* (INTERN-COMMON-LISP-SYMBOL "EVAL-WHEN")
    (LIST* (INTERN-COMMON-LISP-SYMBOL "LOAD")
     (INTERN-COMMON-LISP-SYMBOL "EVAL") NIL)
    TREE NIL)))
  ...
  (CL:LET*
   ...
   (CL:WHEN
    (CL:OR (CL:< *SAFETY* 2)
     ...
     (CL:EQ
      (SAFE-LOOKUP-SLOT (TYPE-TO-CLASS TYPE)
          ...
          ((CL:OR (CL:EQ OWNER SGT-CL-TRANSLATE-STELLA-OBJECT)
           ...
           (CL:SETQ TREE
            (LIST* (INTERN-COMMON-LISP-SYMBOL "EQ")
             (CL-TRANSLATE-A-TREE (%%VALUE ARGUMENTS))
             (CONS
              (CL-TRANSLATE-A-TREE (TYPE-TO-WALKED-NULL-VALUE-TREE OWNER))
              NIL)))
           (CL:COND
            ((CL:EQ OWNER SGT-CL-TRANSLATE-STELLA-FLOAT)
    ...
    ((EXCEPTION-CLASS? CLASS)
     (CL:SETQ OTREE
      (LIST* (INTERN-COMMON-LISP-SYMBOL "MAKE-CONDITION")
       ...
       (CL-TRANSLATE-A-TREE (%%VALUE (%%REST (%%REST TREE)))) NIL)))
    ((CL:OR
      (CL:NOT
       (MEMB? *CURRENT-ENVIRONMENT-FEATURES*
        KWD-CL-TRANSLATE-USE-COMMON-LISP-STRUCTS))
     ...
     (CL:COND
      ((STRING? ARG)
       (CL:SETQ FORMATSTRING
        (CONCATENATE (%WRAPPER-VALUE ARG) FORMATSTRING)))
      ((CL:EQ ARG EOL)
...
(CL:DEFUN YIELD-PRINT-TREE (TREE)
  (CL:LET*
   ...
   (CL:RETURN-FROM YIELD-PRINT-TREE
    (CONS
     (CL-TRANSLATE-GLOBAL-SYMBOL SYM-CL-TRANSLATE-STELLA-%%PRINT-STREAM)
  ...
  (CL:LET*
    ...
    ((CL:EQ (SAFE-PRIMARY-TYPE BODY) SGT-CL-TRANSLATE-STELLA-CONS)
     (CL:PROGN
      (CL:LET* ((ALWAYS?-000 TRUE))
       ...
       (CL:WHEN ALWAYS?-000 (CL:SETQ OTREE (CONS (%%VALUE BODY) NIL))
        (CL:LET* ((BARG NULL) (ITER-001 (%%REST BODY)))
         (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-001 NIL)) DO
          ...
          (CL:COND
           ...
           (CL:T (CL:SETQ OTREE (CONS BARG OTREE))))))
   ...
   (CL:LET*
    ...
    (CL:LOOP WHILE
     ...
     (CL:IF (CL:EQ COLLECT-000 NULL)
      (CL:PROGN (CL:SETQ COLLECT-000 (CONS (CONS PAR (CONS ARG NIL)) NIL))
       (CL:IF (CL:EQ OTREE NIL) (CL:SETQ OTREE COLLECT-000)
        (ADD-CONS-TO-END-OF-CONS-LIST OTREE COLLECT-000)))
      (CL:PROGN
       (CL:SETF (%%REST COLLECT-000) (CONS (CONS PAR (CONS ARG NIL)) NIL))
       (CL:SETQ COLLECT-000 (%%REST COLLECT-000))))))
   (CL:RETURN-FROM CL-TRANSLATE-INLINE-CALL-TREE
    (LIST* (INTERN-COMMON-LISP-SYMBOL "LET") OTREE
     (CONCATENATE
      ...
      (CONS
       (CL-YIELD-TYPED-EXPRESSION-TREE (COPY-CONS-TREE BODY)
        (TYPE METHOD))
       NIL))))))
...
;;; (DEFUN (CL-YIELD-TYPED-EXPRESSION-TREE CONS) ...)
...
(CL:DEFUN CL-YIELD-GLOBAL-VARIABLE-TYPE-DECLARATION-TREE (GLOBAL)
  (CL:LET*
   ((CLTYPE (LOOKUP-CL-TYPE-FROM-STELLA-TYPE (%VARIABLE-TYPE GLOBAL))))
...
(CL:DEFUN CL-YIELD-DECLARE-TREE (DECLARATIONS)
  (CL:WHEN (CL:EQ DECLARATIONS NIL)
   (CL:RETURN-FROM CL-YIELD-DECLARE-TREE NIL))
  (CL:LET* ((OTHERDECLARATIONS (%%REST DECLARATIONS)))
   (CL:LET* ((DECL NULL) (ITER-000 DECLARATIONS))
    (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-000 NIL)) DO
     ...
     (CL:WHEN
      ...
      (CL:LET* ((OTHERDECL NULL) (ITER-001 OTHERDECLARATIONS))
       (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-001 NIL)) DO
        (CL:PROGN (CL:SETQ OTHERDECL (%%VALUE ITER-001))
         (CL:SETQ ITER-001 (%%REST ITER-001)))
        (CL:WHEN
       ...
       (CL:LET*
        ...
        (CL:COND
         ((CL:EQ TEST-VALUE-000 SYM-CL-TRANSLATE-STELLA-OBJECT-METHOD)
          (CL:SETQ OTREE
           (CONS
            (LIST* SYM-CL-TRANSLATE-STELLA-CLSYS-SELF FIRSTPARAMETERTYPE
             NIL)
            OTREE))
...
(CL:DEFUN CL-TRANSLATE-DEFINE-METHOD-UNIT (UNIT)
  (CL:LET*
   ((METHOD (%THE-OBJECT UNIT)) (METHODNAME (%SLOT-NAME METHOD))
    ...
    (BODYTREE (%CODE-REGISTER UNIT)) (DECLARATIONS NIL) (OTREE NIL))
   ...
   (CL:SETQ OTREE
    (CONS
     (CL:IF FUNCTION? (INTERN-COMMON-LISP-SYMBOL "DEFUN")
      (CL:IF (USE-DEFCONSMETHOD? METHOD)
     ...
     (CONS
      ...
      (CONS (CL-TRANSLATE-METHOD-PARAMETERS METHOD)
       (CONCATENATE
        ...
        (CONCATENATE (CL-YIELD-DECLARE-TREE DECLARATIONS)
...
(CL:DEFUN COMPUTE-CL-STRUCT-SLOTS (CLASS)
  (CL:LET* ((VALUE-000 NULL))
   ...
   (CL:LET*
    ...
    (CL:LET* ((SUPER NULL) (ITER-001 (CLASS-NATIVE-SUPERS CLASS)))
...
(CL:DEFUN CL-STRUCT-SLOT-OFFSET (SLOTNAME CLASSTYPE)
  (CL:LET*
   ((SLOTS (CL-STRUCT-SLOTS (%SURROGATE-VALUE CLASSTYPE))) (OFFSET 1))
     ...
     (CL:TAGBODY
      ...
      (CL:IF (CL:EQ COLLECT-000 NULL)
       (CL:PROGN
        (CL:SETQ COLLECT-000
         (CONS
          (CONS (%SLOT-NAME SLOT) (CONS SYM-CL-TRANSLATE-STELLA-NULL NIL))
          NIL))
       ...
       (CONS
        ...
        (CONCATENATE
         (CL:IF (CL:NOT (CL:EQ TRANSLATEDSUPER NULL))
          (CONS (LIST* KWD-CL-TRANSLATE-INCLUDE TRANSLATEDSUPER NIL) NIL)
          NIL)
         (LIST*
...
(CL:DEFUN CL-ALWAYS-TRANSLATE-TO-CLOS-CLASS? (CLASS)
  (CL:LET* ((TEST-VALUE-000 FALSE))
   (CL:SETQ TEST-VALUE-000
    (CL:NOT
     (SUBTYPE-OF? (%CLASS-TYPE CLASS) SGT-CL-TRANSLATE-STELLA-OBJECT)))
...
(CL:DEFUN CL-TRANSLATE-DEFPRINT-UNIT (UNIT)
  (CL:LET*
   ((CLASS (%THE-OBJECT UNIT)) (BODY (%CODE-REGISTER UNIT))
    (EXTRATREES NIL))
   (CL:COND
    ((CL:EQ
      (METHOD-CALL-TYPE-FOR-VECTOR-STRUCTS
       SYM-CL-TRANSLATE-STELLA-PRINT-OBJECT (%CLASS-TYPE CLASS) FALSE)
      SYM-CL-TRANSLATE-STELLA-PRINT-OBJECT)
     (CL:SETQ EXTRATREES
      (CONS
       (LIST* SYM-CL-TRANSLATE-STELLA-SETQ SYM-CL-TRANSLATE-STELLA-SELF
...
(CL:DEFUN HELP-STARTUP-CL-TRANSLATE4 ()
  (CL:PROGN
   ...
   (DEFINE-FUNCTION-OBJECT "USE-CL-CONSES?"
    "(DEFUN (USE-CL-CONSES? BOOLEAN) () :GLOBALLY-INLINE? TRUE (RETURN (MEMB? *CURRENT-ENVIRONMENT-FEATURES* :USE-COMMON-LISP-CONSES)))"
   ...
   (DEFINE-FUNCTION-OBJECT "USE-CL-STRUCTS?"
    "(DEFUN (USE-CL-STRUCTS? BOOLEAN) () :GLOBALLY-INLINE? TRUE (RETURN (MEMB? *CURRENT-ENVIRONMENT-FEATURES* :USE-COMMON-LISP-STRUCTS)))"
    (CL:FUNCTION USE-CL-STRUCTS?) NULL)
   (DEFINE-FUNCTION-OBJECT "USE-VECTOR-STRUCTS?"
    "(DEFUN (USE-VECTOR-STRUCTS? BOOLEAN) () :GLOBALLY-INLINE? TRUE (RETURN (MEMB? *CURRENT-ENVIRONMENT-FEATURES* :USE-COMMON-LISP-VECTOR-STRUCTS)))"
   ...
   (CL:WHEN (CLSYS-USE-VECTOR-STRUCTS-P)
    (CL:DEFMETHOD CL:PRINT-OBJECT :AROUND ((SELF CL:VECTOR) STREAM)
     (CL:IF (CLSYS-VECTOR-STRUCT-P SELF)
      (CLSYS-PRINT-VECTOR-STRUCT SELF STREAM) (CL:CALL-NEXT-METHOD)))))
  (CL:LET* ((*MODULE* *STELLA-MODULE*) (*CONTEXT* *MODULE*))
   ...
   (CL:WHEN (CURRENT-STARTUP-TIME-PHASE? 7) (HELP-STARTUP-CL-TRANSLATE4)
    ...
    (DEFINE-FUNCTION-OBJECT "CL-YIELD-TYPED-EXPRESSION-TREE"
     "(DEFUN (CL-YIELD-TYPED-EXPRESSION-TREE CONS) ((TREE CONS) (TYPE TYPE-SPEC)))"
    ...
    (CL:LET*
     ...
     (SET-DYNAMIC-SLOT-VALUE (%DYNAMIC-SLOTS FUNCTION)
      ...
      (WRAP-STRING "Startup-Cl-Translate") NULL-STRING-WRAPPER)))
   ...
   (CL:WHEN (CURRENT-STARTUP-TIME-PHASE? 9)
    ...
    (CL:SETQ *CL-OPERATOR-TABLE*
     (DICTIONARY SGT-CL-TRANSLATE-STELLA-KEY-VALUE-LIST
      ...
      SYM-CL-TRANSLATE-STELLA-!= (INTERN-COMMON-LISP-SYMBOL "/=")))
    (CL:PROGN
     (CL:WHEN (CLSYS-USE-STRUCTS-P)
      (ENABLE-ENVIRONMENT-FEATURE
       (INTERN-KEYWORD "USE-COMMON-LISP-STRUCTS"))
      (CL:WHEN (CLSYS-USE-VECTOR-STRUCTS-P)
       (ENABLE-ENVIRONMENT-FEATURE
        (INTERN-KEYWORD "USE-COMMON-LISP-VECTOR-STRUCTS"))))
     (CL:WHEN (CL:LISTP NIL)
      (ENABLE-ENVIRONMENT-FEATURE
       (INTERN-KEYWORD "USE-COMMON-LISP-CONSES"))))
    (DEFINE-STELLA-GLOBAL-VARIABLE-FROM-STRINGIFIED-SOURCE
