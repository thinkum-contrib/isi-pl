...
(CL:DEFVAR SGT-CL-TRANSLATE-STELLA-INTEGER-WRAPPER NULL)
(CL:DEFVAR SGT-CL-TRANSLATE-STELLA-FLOAT-WRAPPER NULL)
...
(CL:DECLAIM
 (CL:SPECIAL *STELLA-MODULE* FALSE-WRAPPER NULL-INTEGER NIL-LIST ONE-WRAPPER
  *CURRENTTRANSLATIONUNIT* *SAFETY* *STARTUP-TIME-PHASE* *UNFINALIZED-CLASSES*
  STANDARD-ERROR EOL NULL-STRING-WRAPPER *COMMON-LISP-MODULE* *MODULE* NIL TRUE
  FALSE *CURRENT-STELLA-FEATURES*))
  ...
  (CL:LET* ((TEST-VALUE-000 (%%VALUE TREE)))
   (CL:COND
    ...
    ((CL:EQ TEST-VALUE-000 SYM-CL-TRANSLATE-STELLA-SYS-CALL-METHOD)
     (CL:RETURN-FROM DESTRUCTURE-CALL-TREE
      (CL:VALUES (%%VALUE (%%REST (%%REST TREE))) (%%VALUE (%%REST TREE))
       (%%REST (%%REST (%%REST TREE))))))
    (CL:T
     (CL:RETURN-FROM DESTRUCTURE-CALL-TREE
   ...
   (CL:LET* ((TEST-VALUE-000 (%SLOT-OWNER METHOD)))
    (CL:COND
     ((CL:EQ TEST-VALUE-000 SGT-CL-TRANSLATE-STELLA-CONS)
      (CL:RETURN-FROM USE-DEFCONSMETHOD? TRUE))
     ((CL:EQ TEST-VALUE-000 SGT-CL-TRANSLATE-STELLA-STANDARD-OBJECT)
      (CL:COND
       ((CL:EQ
         (%SLOT-OWNER
          (LOOKUP-SLOT (%SURROGATE-VALUE SGT-CL-TRANSLATE-STELLA-CONS)
           (%SLOT-NAME METHOD)))
         SGT-CL-TRANSLATE-STELLA-CONS)
        (CL:RETURN-FROM USE-DEFCONSMETHOD? FALSE))
       (CL:T (CL:RETURN-FROM USE-DEFCONSMETHOD? TRUE))))
...
(CL:DEFUN USE-CL-STRUCTS? ()
  (CL:RETURN-FROM USE-CL-STRUCTS?
   (MEMB? *CURRENT-STELLA-FEATURES* KWD-CL-TRANSLATE-USE-COMMON-LISP-STRUCTS)))
...
(CL:DEFVAR *NEEDEXPLICITRETURN?* FALSE)
...
(CL:DEFUN CL-TRANSLATE-LIST-OF-TREES (TREES)
  (CL:LET* ((CURSOR TREES))
   (CL:LOOP WHILE (CL:NOT (CL:EQ CURSOR NIL)) DO
    (CL:LET*
     ((*NEEDEXPLICITRETURN?*
       (CL:OR *NEEDEXPLICITRETURN?* (CL:NOT (CL:EQ (%%REST CURSOR) NIL)))))
...
(CL:DEFUN HELP-CL-TRANSLATE-A-TREE (TREE)
  ...
  (CL:COND
   ((CL:EQ (SAFE-PRIMARY-TYPE TREE) SGT-CL-TRANSLATE-STELLA-CONS)
    (CL:PROGN
     (CL:WHEN (CL:EQ TREE NIL) (CL:RETURN-FROM HELP-CL-TRANSLATE-A-TREE TREE))
     (CL:LET* ((TEST-VALUE-000 (%%VALUE TREE)))
      (CL:COND
       ...
       ((CL:EQ TEST-VALUE-000 SYM-CL-TRANSLATE-STELLA-WITH-PROCESS-LOCK)
        (CL:SETF (%%VALUE TREE)
         (CL-TRANSLATE-GLOBAL-SYMBOL SYM-CL-TRANSLATE-STELLA-WITH-PROCESS-LOCK))
       ...
       ((CL:EQ TEST-VALUE-000 SYM-CL-TRANSLATE-STELLA-LOOP)
        (CL:LET* ((*NEEDEXPLICITRETURN?* TRUE))
         (CL:DECLARE (CL:SPECIAL *NEEDEXPLICITRETURN?*))
       ...
       ((CL:EQ TEST-VALUE-000 SYM-CL-TRANSLATE-STELLA-LET)
        (CL:RETURN-FROM HELP-CL-TRANSLATE-A-TREE
         (CL-TRANSLATE-LET-TREE TREE FALSE)))
       ...
       ((CL:EQ TEST-VALUE-000 SYM-CL-TRANSLATE-STELLA-QUOTE)
        ...
        (CL:RETURN-FROM HELP-CL-TRANSLATE-A-TREE TREE))
       ((CL:OR
         (CL:EQ TEST-VALUE-000 SYM-CL-TRANSLATE-STELLA-SYS-CALL-FUNCTION-CODE)
   ...
   (CL:T
    (CL:RETURN-FROM HELP-CL-TRANSLATE-A-TREE (CL-TRANSLATE-ATOMIC-TREE TREE)))))
...
(CL:DEFMETHOD CL-TRANSLATE-ATOMIC-TREE ((TREE SYMBOL))
  (CL:IF (CL:NOT (CL:EQ (LOOKUP-GLOBAL-VARIABLE TREE) NULL))
   (CL:RETURN-FROM CL-TRANSLATE-ATOMIC-TREE (CL-TRANSLATE-GLOBAL-SYMBOL TREE))
   (CL:RETURN-FROM CL-TRANSLATE-ATOMIC-TREE (CL-TRANSLATE-LOCAL-SYMBOL TREE))))
...
(CL:DEFUN CL-TRANSLATE-GLOBAL-SYMBOL (SYMBOL)
  (CL:LET* ((SYMBOLMODULE (%HOME-CONTEXT SYMBOL)))
   ...
   (CL:RETURN-FROM CL-TRANSLATE-GLOBAL-SYMBOL
    (YIELD-GLOBAL-LISP-SYMBOL SYMBOLMODULE (%SYMBOL-NAME SYMBOL)))))
    ...
    (LISPSYMBOLNAME
     (CL:IF
      (CL:NOT
       (CL:EQ
        (%WRAPPER-VALUE
         (DYNAMIC-SLOT-VALUE (%DYNAMIC-SLOTS SYMBOLMODULE)
          SYM-CL-TRANSLATE-STELLA-MODULE-LISP-PACKAGE NULL-STRING-WRAPPER))
        STELLA::NULL-STRING))
      SYMBOLNAME (COMPUTE-FULL-NAME SYMBOLNAME SYMBOLMODULE))))
   (CL:DECLARE (CL:TYPE CL:SIMPLE-STRING LISPSYMBOLPACKAGE LISPSYMBOLNAME))
   (CL:WHEN (%CASE-SENSITIVE? SYMBOLMODULE)
...
(CL:DEFUN CL-TRANSLATE-LOCAL-SYMBOL (SYMBOL)
  (CL:LET* ((SYMBOLMODULE (%HOME-CONTEXT SYMBOL)))
   (CL:COND
    ((CL:AND (CL:NOT (%CASE-SENSITIVE? *MODULE*))
      (CL:OR (CL:EQ SYMBOLMODULE NULL) (CL:EQ SYMBOLMODULE *MODULE*)))
     (CL:RETURN-FROM CL-TRANSLATE-LOCAL-SYMBOL SYMBOL))
    ((%CASE-SENSITIVE? *MODULE*)
     (CL:RETURN-FROM CL-TRANSLATE-LOCAL-SYMBOL
      (NEW-VERBATIM-STRING-WRAPPER (CONCATENATE "|" (%SYMBOL-NAME SYMBOL) "|"))))
    (CL:T
     (CL:RETURN-FROM CL-TRANSLATE-LOCAL-SYMBOL
      (NEW-VERBATIM-STRING-WRAPPER (%SYMBOL-NAME SYMBOL)))))))
...
(CL:DEFUN YIELD-CLOS-SLOT-ACCESSOR-NAME (SLOTNAME)
  (CL:RETURN-FROM YIELD-CLOS-SLOT-ACCESSOR-NAME
   (YIELD-GLOBAL-LISP-SYMBOL (%HOME-CONTEXT SLOTNAME)
    (CONCATENATE "%" (%SYMBOL-NAME SLOTNAME)))))
   ...
   (CL:COND
    ((CL:EQ SLOTNAME SYM-CL-TRANSLATE-STELLA-VALUE)
     (CL:RETURN-FROM YIELD-SLOT-VALUE-READER-TREE
      (CONS (CL-TRANSLATE-GLOBAL-SYMBOL SYM-CL-TRANSLATE-STELLA-%%VALUE)
       (CONS OBJECTREF NIL))))
       ...
       (CONS (WRAP-INTEGER (CL-STRUCT-SLOT-OFFSET SLOTNAME OBJECTTYPE))
        (CONS
         (CL-TRANSLATE-GLOBAL-SYMBOL
          (INTERN-SYMBOL-IN-MODULE (%SYMBOL-NAME OBJECTTYPE)
           (%HOME-CONTEXT OBJECTTYPE) TRUE))
...
(CL:DEFUN TRUE-SLOT-NAME (SLOTNAME TYPE)
  (CL:RETURN-FROM TRUE-SLOT-NAME
   (%SLOT-NAME (CANONICAL-SLOT (LOOKUP-SLOT (%SURROGATE-VALUE TYPE) SLOTNAME)))))
...
(CL:DEFUN CL-TRANSLATE-FIXED-SLOT-VALUE-TREE (TREE)
  (CL:LET*
   ((OBJTYPE (%%VALUE (%%REST TREE)))
    (SLOTNAME (TRUE-SLOT-NAME (%%VALUE (%%REST (%%REST TREE))) OBJTYPE))
  ...
  (CL:LET* ((OPERATOR NULL) (OWNER NULL) (ARGUMENTS NULL))
   ...
   (CL:COND
    ...
    ((CL:OR (CL:EQ OPERATOR SYM-CL-TRANSLATE-STELLA-NULL?)
     ...
     (CL:RETURN-FROM CL-TRANSLATE-CALL-METHOD-TREE
      (CL-TRANSLATE-PLAIN-BOOLEAN-TEST TREE FALSE)))
    (CL:T))
   (CL:WHEN
  ...
  (CL:IF
   (CL:OR
    (CL:AND (CL:NOT (SUBTYPE-OF? OWNER SGT-CL-TRANSLATE-STELLA-OBJECT))
     (CL:NOT (%MIXIN? (%SURROGATE-VALUE OWNER))))
...
(CL:DEFUN CL-TRANSLATE-NORMAL-CALL-METHOD-TREE (OPERATOR OWNER ARGUMENTS)
  (CL:LET*
   ((TRANSLATEDOPERATOR
     (CL-TRANSLATE-GLOBAL-SYMBOL
      (YIELD-RENAMED-NAME-IF-NATIVE OPERATOR KWD-CL-TRANSLATE-COMMON-LISP
       KWD-CL-TRANSLATE-FUNCTION))))
   (CL:LET*
    ((TEST-VALUE-000
      (METHOD-CALL-TYPE-FOR-VECTOR-STRUCTS OPERATOR OWNER (CL:EQ OWNER NULL))))
    (CL:COND
       ...
       (CONS TRANSLATEDOPERATOR
        (CONS (CL-TRANSLATE-A-TREE (%%VALUE ARGUMENTS))
         (CONS SYM-CL-TRANSLATE-STELLA-NULL
          (CONCATENATE (CL-TRANSLATE-LIST-OF-TREES (%%REST ARGUMENTS)) NIL))))))
     (CL:T
      (CL:RETURN-FROM CL-TRANSLATE-NORMAL-CALL-METHOD-TREE
       (CONS TRANSLATEDOPERATOR
        (CONCATENATE (CL-TRANSLATE-LIST-OF-TREES ARGUMENTS) NIL))))))))
    ...
    ((CL:EQ OWNER SGT-CL-TRANSLATE-STELLA-ARRAY)
     (CL:LET*
      ((SETTER? (CL:EQ OPERATOR SYM-CL-TRANSLATE-STELLA-AREF-SETTER))
       (ARRAY (%%VALUE ARGUMENTS)) (ARRAYTYPE (WALKED-EXPRESSION-TYPE ARRAY))
      ...
      (CL:WHEN (GENERATE-CL-TYPE-DECLARATIONS?)
       (CL:WHEN (CONS? ARRAY)
        (CL:SETQ ARRAY (CL-YIELD-TYPED-EXPRESSION-TREE ARRAY ARRAYTYPE)))
       (CL:LET* ((IT (ALLOCATE-ITERATOR INDICES)))
        (CL:LOOP WHILE (NEXT? IT) DO
         (CL:WHEN (CONS? (%VALUE IT))
          (VALUE-SETTER IT
           (CL-YIELD-TYPED-EXPRESSION-TREE (%VALUE IT)
  ...
  (CL:LET* ((FOUND?-000 FALSE))
   (CL:LET* ((IB NULL) (ITER-000 ITERATORBINDINGS))
    (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-000 NIL)) DO
     (CL:PROGN (CL:SETQ IB (%%VALUE ITER-000))
      (CL:SETQ ITER-000 (%%REST ITER-000)))
     (CL:WHEN (CL:EQ (%%VALUE IB) VARIABLE) (CL:SETQ FOUND?-000 TRUE)
      (CL:RETURN))))
...
(CL:DEFUN CL-TRANSLATE-FOREACH-TREE (TREE)
  (CL:LET*
   ((ITERATORBINDINGS (%%VALUE (%%REST TREE)))
    ...
    (BODY (CL-TRANSLATE-LIST-OF-TREES (NTH-REST TREE 4))) (DECLARATIONS NIL)
   ...
   (CL:WHEN (GENERATE-CL-TYPE-DECLARATIONS?)
    (CL:SETQ TYPEDECLARATIONS
     (CONCATENATE TYPEDECLARATIONS
      (CL-YIELD-LET-VARIABLE-TYPE-DECLARATION-TREES CURSORBINDINGS))))
   (CL:LET* ((BINDING NULL) (ITER-001 CURSORBINDINGS))
    (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-001 NIL)) DO
     (CL:PROGN (CL:SETQ BINDING (%%VALUE ITER-001))
      (CL:SETQ ITER-001 (%%REST ITER-001)))
     (CL:SETQ NEXTASSIGNMENTS
      (CONS (CL-TRANSLATE-A-TREE (%%VALUE (%%REST (%%REST BINDING))))
       NEXTASSIGNMENTS))
     (THIRD-SETTER BINDING NULL)
     (CL:WHEN
      (CL:NOT (DUPLICATE-CURSOR-VARIABLE? (%%VALUE BINDING) ITERATORBINDINGS))
   ...
   (CL:RETURN-FROM CL-TRANSLATE-FOREACH-TREE
    (LIST* (INTERN-COMMON-LISP-SYMBOL "LET*") DECLARATIONS
     (CONCATENATE (CL-YIELD-DECLARE-TREE TYPEDECLARATIONS FALSE)
      (CONS
       (LIST* (INTERN-COMMON-LISP-SYMBOL "LOOP") SYM-CL-TRANSLATE-STELLA-WHILE
        CONTINUATIONTEST
        (CONS SYM-CL-TRANSLATE-STELLA-DO
         (CONCATENATE (REVERSE NEXTASSIGNMENTS)
   ...
   ((ODECLARATIONS NIL)
    (TYPEDECLARATIONS
     (CL:IF (GENERATE-CL-TYPE-DECLARATIONS?)
      (CL-YIELD-LET-VARIABLE-TYPE-DECLARATION-TREES (%%VALUE (%%REST TREE)))
      NIL)))
...
(CL:DEFUN CL-TRANSLATE-SPECIAL-TREE (TREE)
  (CL:LET* ((TRANSLATEDTREE (CL-TRANSLATE-LET-TREE TREE TRUE)) (SPECIALVARS NIL))
   (CL:LET* ((DECL NULL) (ITER-000 (%%VALUE (%%REST TREE))) (COLLECT-000 NULL))
    (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-000 NIL)) DO
     ...
     (CL:IF (CL:EQ COLLECT-000 NULL)
      ...
      (CL:PROGN (CL:SETF (%%REST COLLECT-000) (CONS (%%VALUE DECL) NIL))
       (CL:SETQ COLLECT-000 (%%REST COLLECT-000))))))
   (CL:SETF (%%REST (%%REST TRANSLATEDTREE))
    (CONS
     (LIST* (INTERN-COMMON-LISP-SYMBOL "DECLARE")
      (CONS (INTERN-COMMON-LISP-SYMBOL "SPECIAL") (CONCATENATE SPECIALVARS NIL))
      NIL)
...
(CL:DEFUN CL-TRANSLATE-STARTUP-TIME-PROGN-TREE (TREE)
  ...
  (CL:RETURN-FROM CL-TRANSLATE-STARTUP-TIME-PROGN-TREE
   (LIST* (INTERN-COMMON-LISP-SYMBOL "EVAL-WHEN")
    (LIST* (INTERN-COMMON-LISP-SYMBOL "LOAD") (INTERN-COMMON-LISP-SYMBOL "EVAL")
     NIL)
    TREE NIL)))
...
(CL:DEFUN CL-TRANSLATE-HANDLE-EXCEPTION-TREE (TREE)
  (CL:LET*
   ...
   (CL:SETF (%%VALUE TREE)
    (CL-TRANSLATE-CLASS-NAME (TYPE-TO-CLASS (TYPE-SPEC-TO-BASE-TYPE TYPE))))
...
(CL:DEFUN CL-TRANSLATE-CAST-TREE (TREE)
  (CL:LET*
   ...
   (CL:WHEN (SUBTYPE-OF? TYPE SGT-CL-TRANSLATE-STELLA-FLOAT)
    (CL:IF (ISA? EXPRESSION SGT-CL-TRANSLATE-STELLA-INTEGER-WRAPPER)
   ...
   (CL:WHEN (SUBTYPE-OF? TYPE SGT-CL-TRANSLATE-STELLA-INTEGER)
    (CL:IF (ISA? EXPRESSION SGT-CL-TRANSLATE-STELLA-FLOAT-WRAPPER)
     (CL:RETURN-FROM CL-TRANSLATE-CAST-TREE
      (WRAP-INTEGER (CL:TRUNCATE (%WRAPPER-VALUE EXPRESSION))))
     (CL:RETURN-FROM CL-TRANSLATE-CAST-TREE
      (LIST* (INTERN-COMMON-LISP-SYMBOL "TRUNCATE") (%%VALUE (%%REST TREE))
       NIL))))
   (CL:WHEN
    (CL:OR (CL:< *SAFETY* 2)
     (CL:EQ (%%VALUE TREE) SYM-CL-TRANSLATE-STELLA-SAFE-CAST)
     (CL:EQ
      (LOOKUP-SLOT (TYPE-TO-CLASS TYPE) SYM-CL-TRANSLATE-STELLA-PRIMARY-TYPE)
      NULL))
  ...
  (CL:LET* ((RETURNVALUES (CL-TRANSLATE-LIST-OF-TREES (%%REST TREE))))
   (CL:WHEN (CL:NOT (CL:EQ (%%REST RETURNVALUES) NIL))
    (CL:SETQ RETURNVALUES
     (CONS
      (CONS (INTERN-COMMON-LISP-SYMBOL "VALUES") (CONCATENATE RETURNVALUES NIL))
      NIL)))
     ...
     (LIST* (INTERN-COMMON-LISP-SYMBOL "RETURN-FROM")
      (CL-TRANSLATE-GLOBAL-SYMBOL
       (YIELD-RENAMED-NAME-IF-NATIVE
        (%SLOT-NAME (%THE-OBJECT *CURRENTTRANSLATIONUNIT*))
        ...
        (CL:WHEN (METHOD-CALL-INLINING-ENABLED?)
         (CL:COND
          ((CL:OR (CL:EQ OWNER SGT-CL-TRANSLATE-STELLA-OBJECT)
           ...
           (CL:SETQ TREE
            (LIST* (INTERN-COMMON-LISP-SYMBOL "EQ")
             (CL-TRANSLATE-A-TREE (%%VALUE ARGUMENTS))
             (CONS (CL-TRANSLATE-A-TREE (TYPE-TO-WALKED-NULL-VALUE-TREE OWNER))
              NIL)))
           (CL:COND
            ((CL:EQ OWNER SGT-CL-TRANSLATE-STELLA-FLOAT)
           ...
           (CL:IF
            (CL:OR
             (CL:AND INVERT? (CL:EQ OPERATOR SYM-CL-TRANSLATE-STELLA-NULL?))
...
(CL:DEFUN CL-TRANSLATE-WHILE-TREE (TREE)
  (CL:LET*
   ((TEST (CL-TRANSLATE-BOOLEAN-TEST (%%VALUE (%%REST TREE)) FALSE))
...
(CL:DEFUN CL-TRANSLATE-COND-TREE (TREE)
  (CL:LET* ((CONDITION NULL) (ITER-000 (%%REST TREE)))
   (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-000 NIL)) DO
    ...
    (CL:SETF (%%REST CONDITION) (CL-TRANSLATE-LIST-OF-TREES (%%REST CONDITION)))))
...
(CL:DEFUN CL-TRANSLATE-BOOLEAN-TREE (TREE)
  (CL:RETURN-FROM CL-TRANSLATE-BOOLEAN-TREE
   (CL-TRANSLATE-BOOLEAN-TEST TREE FALSE)))
     ...
     (CL:EQ
      (%WRAPPER-VALUE
       (DYNAMIC-SLOT-VALUE (%DYNAMIC-SLOTS CLASS)
        SYM-CL-TRANSLATE-STELLA-CLASS-CL-NATIVE-TYPE NULL-STRING-WRAPPER))
      STELLA::NULL-STRING))
    (CL:LET*
     ((NATIVETYPE
       (%WRAPPER-VALUE
     ...
     (CL:WHEN (CL:NOT (DEFINED? (POSITION NATIVETYPE #\: 0)))
...
(CL:DEFUN CL-TRANSLATE-MAKE-TREE (TREE)
  (CL:LET*
   ((CLASS (%SURROGATE-VALUE (TYPIFY (%%VALUE (%%REST TREE)))))
   ...
   (CL:WHEN
    ...
    (CL:RETURN-FROM CL-TRANSLATE-MAKE-TREE
     (LIST* (INTERN-COMMON-LISP-SYMBOL "CONS") (INTERN-COMMON-LISP-SYMBOL "NIL")
    ...
    ((EXCEPTION-CLASS? CLASS)
     (CL:SETQ OTREE
      (LIST* (INTERN-COMMON-LISP-SYMBOL "MAKE-CONDITION")
       ...
       (CONS (CL-TRANSLATE-A-TREE (%%VALUE (%%REST (%%REST TREE)))) NIL))))
    ((CL:OR
      (CL:NOT
       (MEMB? *CURRENT-STELLA-FEATURES*
        KWD-CL-TRANSLATE-USE-COMMON-LISP-STRUCTS))
     ...
     (CL:SETQ OTREE
      (LIST* (INTERN-COMMON-LISP-SYMBOL "MAKE-INSTANCE")
       (LIST* (INTERN-COMMON-LISP-SYMBOL "QUOTE") CLASSSYMBOL NIL) NIL)))
    ((MEMB? *CURRENT-STELLA-FEATURES*
      KWD-CL-TRANSLATE-USE-COMMON-LISP-VECTOR-STRUCTS)
     (CL:SETQ OTREE
      (CONS (CL-TRANSLATE-GLOBAL-SYMBOL SYM-CL-TRANSLATE-STELLA-CLSYS-MAKE)
       (CONS CLASSSYMBOL
        (CONS (WRAP-INTEGER (CL:1+ (LENGTH (CL-STRUCT-SLOTS CLASS)))) NIL)))))
    ...
    (CONSTRUCTORNAME
     (CL-TRANSLATE-GLOBAL-SYMBOL
      (YIELD-CONSTRUCTOR-NAME
       (GET-STELLA-CLASS
        (CL:IF (TYPE? TYPESPEC) TYPESPEC (%SPECIFIER-BASE-TYPE TYPESPEC))
        TRUE))))
...
(CL:DEFUN CL-TRANSLATE-OPERATOR-TREE (TREE)
  (CL:LET* ((OPERATOR NULL) (OWNER NULL) (ARGUMENTS NULL))
   ...
   (CL:COND
    ((CL:EQ OPERATOR SYM-CL-TRANSLATE-STELLA-+)
     (CL:WHEN
      (CL:AND (CL:= (LENGTH ARGUMENTS) 2) (MEMBER? ARGUMENTS ONE-WRAPPER))
      (CL:IF (EQL? (%%VALUE ARGUMENTS) ONE-WRAPPER)
       (CL:SETQ ARGUMENTS (%%REST ARGUMENTS)) (CL:SETF (%%REST ARGUMENTS) NIL))
  ...
  (CL:LET* ((FORMATSTRING "") (FORMATARGUMENTS NIL))
   ...
   (CL:LET* ((ARG NULL) (ITER-000 (%%REST (%%REST TREE))))
    (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-000 NIL)) DO
     ...
     (CL:COND
      ((STRING? ARG)
       (CL:SETQ FORMATSTRING (CONCATENATE (%WRAPPER-VALUE ARG) FORMATSTRING)))
          ...
          (CL:PROGN
           (CL:WHEN (CL:NOT (CL:EQ COMPOUNDEDSTRING STELLA::NULL-STRING))
            (CL:SETQ COMPOUNDEDSTRING
             (CONCATENATE COMPOUNDEDSTRING (%WRAPPER-VALUE ARG)))
...
(CL:DEFUN CL-TRANSLATE-CALL-FUNCTION-CODE-TREE (TREE)
  (CL:LET*
   ((METHODCODE?
     (CL:EQ (%%VALUE TREE) SYM-CL-TRANSLATE-STELLA-SYS-CALL-METHOD-CODE))
    (OTREE (%%REST TREE)))
...
(CL:DEFUN CL-TRANSLATE-INLINE-CALL-TREE (TREE)
  (CL:LET*
   ((CALLTREE (%%VALUE (%%REST TREE)))
    ...
    (ARGS
     (CL:IF (CL:EQ (%%VALUE CALLTREE) SYM-CL-TRANSLATE-STELLA-SYS-CALL-FUNCTION)
      (NTH-REST CALLTREE 2) (NTH-REST CALLTREE 3)))
    (TRANSLATEDARGS (CL-TRANSLATE-LIST-OF-TREES ARGS)) (USEDCOMPLEXARGS NIL)
    (ARGUMENT NULL)
    (BODY
     (LOOKUP-VERBATIM-TREE (WALK-VERBATIM-TREE (INLINABLE-METHOD-BODY METHOD))
      NULL))
    (PARAMETERS (METHOD-PARAMETER-NAMES METHOD))
    (PARAMETERTYPES (METHOD-PARAMETER-TYPE-SPECIFIERS METHOD)) (PARINDEX 0)
    (OTREE NIL))
   ...
   (CL:COND
       ...
       (CL:LET* ((ELT NULL) (ITER-000 BODY))
        (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-000 NIL)) DO
         (CL:PROGN (CL:SETQ ELT (%%VALUE ITER-000))
          (CL:SETQ ITER-000 (%%REST ITER-000)))
         (CL:WHEN (CONS? ELT) (CL:SETQ ALWAYS?-000 FALSE) (CL:RETURN))))
       (CL:WHEN ALWAYS?-000
        (CL:SETQ OTREE
         (CONS (CL-TRANSLATE-VERBATIM-BODY-SYMBOLS (%%VALUE BODY) NIL-LIST) NIL))
        (CL:LET* ((BARG NULL) (ITER-001 (%%REST BODY)))
         (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-001 NIL)) DO
          (CL:PROGN (CL:SETQ BARG (%%VALUE ITER-001))
           (CL:SETQ ITER-001 (%%REST ITER-001)))
          (CL:COND
           ((MEMBER? PARAMETERS BARG)
            (CL:SETQ PARINDEX (POSITION PARAMETERS BARG 0))
            (CL:SETQ ARGUMENT (NTH TRANSLATEDARGS PARINDEX))
            (CL:WHEN (MEMBER? USEDCOMPLEXARGS ARGUMENT) (CL:SETQ OTREE NIL)
             (CL:RETURN))
           ...
           (CL:T
            (CL:SETQ OTREE
             (CONS (CL-TRANSLATE-VERBATIM-BODY-SYMBOLS BARG NIL-LIST) OTREE))))))
    ...
    (CL:T))
   (CL:LET*
    ((ARG NULL) (PAR NULL) (ITER-002 (%THE-CONS-LIST PARAMETERS))
     (ITER-003 TRANSLATEDARGS) (COLLECT-000 NULL))
    (CL:LOOP WHILE
     (CL:AND (CL:NOT (CL:EQ ITER-002 NIL)) (CL:NOT (CL:EQ ITER-003 NIL))) DO
     (CL:PROGN (CL:SETQ PAR (%%VALUE ITER-002))
      (CL:SETQ ITER-002 (%%REST ITER-002)))
     (CL:PROGN (CL:SETQ ARG (%%VALUE ITER-003))
      (CL:SETQ ITER-003 (%%REST ITER-003)))
     (CL:IF (CL:EQ COLLECT-000 NULL)
      (CL:PROGN
       (CL:SETQ COLLECT-000
        (CONS (CONS (CL-TRANSLATE-LOCAL-SYMBOL PAR) (CONS ARG NIL)) NIL))
    ...
    (LIST* (INTERN-COMMON-LISP-SYMBOL "LET") OTREE
     (CONCATENATE
      (CL-YIELD-DECLARE-TREE
       (CL-YIELD-METHOD-PARAMETER-TYPE-DECLARATION-TREES METHOD) FALSE)
      (CONS
       (CL-YIELD-TYPED-EXPRESSION-TREE
        (CL-TRANSLATE-VERBATIM-BODY-SYMBOLS (COPY-CONS-TREE BODY) PARAMETERS)
        (TYPE METHOD))
       NIL))))))
...
(CL:DEFUN CL-TRANSLATE-INLINE-TREE (TREE)
  (CL:LET*
   ((OPERATOR (%%VALUE TREE)) (BODY (CL-TRANSLATE-LIST-OF-TREES (%%REST TREE))))
   (CL:LET* ((TEST-VALUE-000 OPERATOR))
    (CL:COND
      ...
      (CL:CASE (ARRAY-TYPE-RANK TYPE)
       (1
        (CL:RETURN-FROM LOOKUP-CL-TYPE-FROM-STELLA-TYPE
         (INTERN-COMMON-LISP-SYMBOL "SIMPLE-VECTOR")))
       (CL:OTHERWISE
        (CL:LET* ((DIMENSIONS NIL))
         (CL:LET*
          ((DIM NULL) (ITER-000 (%THE-CONS-LIST (ARRAY-TYPE-DIMENSIONS TYPE)))
           (COLLECT-000 NULL))
          (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-000 NIL)) DO
           ...
           (CL:IF (CL:EQ COLLECT-000 NULL)
            (CL:PROGN
             (CL:SETQ COLLECT-000
              (CONS (CL:IF (CL:EQ DIM NULL) (INTERN-COMMON-LISP-SYMBOL "*") DIM)
               NIL))
    ...
    ((CL:NOT (CL:EQ CLTYPE NULL))
     (CL:COND
      ((CL:EQ (SAFE-PRIMARY-TYPE TREE) SGT-CL-TRANSLATE-STELLA-CONS)
       (CL:PROGN
        (CL:WHEN
         (CL:AND (CL:EQ (%%VALUE TREE) (INTERN-COMMON-LISP-SYMBOL "THE"))
     ...
     (CL:RETURN-FROM CL-YIELD-TYPED-EXPRESSION-TREE
      (LIST* (INTERN-COMMON-LISP-SYMBOL "THE") CLTYPE (CONS TREE NIL))))
   ...
   (CL:LET*
    ...
    (CL:LOOP WHILE
     ...
     (CL:PROGN (CL:SETQ TSPEC (%%VALUE ITER-000))
      (CL:SETQ ITER-000 (%%REST ITER-000)))
     (CL:PROGN (CL:SETQ PNAME (%%VALUE ITER-001))
      (CL:SETQ ITER-001 (%%REST ITER-001)))
     (CL:SETQ CLTYPE
...
(CL:DEFUN CL-YIELD-GLOBAL-VARIABLE-TYPE-DECLARATION-TREE (GLOBAL)
  (CL:LET*
   ((CLTYPE
     (LOOKUP-CL-TYPE-FROM-STELLA-TYPE (GLOBAL-VARIABLE-TYPE-SPEC GLOBAL))))
...
(CL:DEFUN CL-YIELD-METHOD-RETURN-TYPE-DECLARATION (METHOD)
  (CL:LET* ((TYPES NIL) (CLTYPE NULL))
   ...
   (CL:IF (CL:EQ (%%REST TYPES) NIL)
    (CL:RETURN-FROM CL-YIELD-METHOD-RETURN-TYPE-DECLARATION (%%VALUE TYPES))
   ...
   (CL:IF (CL:NOT (CL:EQ CLTYPE NULL))
    (CL:RETURN-FROM CL-YIELD-METHOD-TYPE-DECLARATION-TREE
     (LIST* (INTERN-COMMON-LISP-SYMBOL "FTYPE")
      ...
      (CL-TRANSLATE-GLOBAL-SYMBOL (%SLOT-NAME METHOD)) NIL))
    (CL:RETURN-FROM CL-YIELD-METHOD-TYPE-DECLARATION-TREE NULL))))
      ...
      (CL:SETQ TYPECHECKS
       (CONS
        (LIST* (INTERN-COMMON-LISP-SYMBOL "CHECK-TYPE")
         (%%VALUE (%%REST (%%REST DECL))) (CONS (%%VALUE (%%REST DECL)) NIL))
        TYPECHECKS))))
    (CL:SETQ TYPECHECKS (REVERSE TYPECHECKS)))
   (CL:LET* ((DECL NULL) (ITER-001 DECLARATIONS))
    (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-001 NIL)) DO
     (CL:PROGN (CL:SETQ DECL (%%VALUE ITER-001))
      (CL:SETQ ITER-001 (%%REST ITER-001)))
     (CL:WHEN
      ...
      (CL:LET* ((OTHERDECL NULL) (ITER-002 OTHERDECLARATIONS))
       (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-002 NIL)) DO
        (CL:PROGN (CL:SETQ OTHERDECL (%%VALUE ITER-002))
         (CL:SETQ ITER-002 (%%REST ITER-002)))
        (CL:WHEN
         (CL:AND (CL:NOT (CL:EQ OTHERDECL NULL))
          (CL:EQ (%%VALUE OTHERDECL) (INTERN-COMMON-LISP-SYMBOL "TYPE"))
  ...
  (CL:LET* ((TEST-VALUE-000 (%CATEGORY UNIT)))
   (CL:COND
    ...
    ((CL:EQ TEST-VALUE-000 SYM-CL-TRANSLATE-STELLA-TYPE)
     (CL:SETF (%CATEGORY UNIT) NULL) (CL:RETURN-FROM CL-TRANSLATE-UNIT NIL))
    (CL:T
     (CL:LET* ((STREAM-000 (NEW-OUTPUT-STRING-STREAM)))
      (%%PRINT-STREAM (%NATIVE-STREAM STREAM-000) "`" TEST-VALUE-000
       "' is not a valid case option")
...
(CL:DEFUN CL-TRANSLATE-METHOD-PARAMETERS (METHOD)
  (CL:LET*
   ((FUNCTION? (%METHOD-FUNCTION? METHOD)) (OTREE NIL) (OPARAMETER NULL)
    (FIRSTPARAMETERTYPE NULL))
   (CL:LET*
    ((I NULL-INTEGER) (PTYPE NULL) (PARAMETER NULL)
    ...
    (CL:LOOP WHILE
     ...
     (CL:COND
      ((CL:AND (CL:NOT FUNCTION?) (CL:= I 1))
       (CL:SETQ FIRSTPARAMETERTYPE
        (CL-TRANSLATE-CLASS-NAME (TYPE-TO-CLASS (TYPE-SPEC-TO-BASE-TYPE PTYPE))))
       (CL:LET*
        ((TEST-VALUE-000
          (METHOD-CALL-TYPE-FOR-VECTOR-STRUCTS (%SLOT-NAME METHOD)
           (%SLOT-OWNER METHOD) FUNCTION?)))
        (CL:COND
         ((CL:EQ TEST-VALUE-000 SYM-CL-TRANSLATE-STELLA-OBJECT-METHOD)
          (CL:SETQ OTREE
           (CONS
            (LIST* SYM-CL-TRANSLATE-STELLA-CLSYS-SELF FIRSTPARAMETERTYPE NIL)
            OTREE))
          (CL:SETQ OTREE (CONS OPARAMETER OTREE)))
         ((CL:EQ TEST-VALUE-000 SYM-CL-TRANSLATE-STELLA-NON-OBJECT-METHOD)
          (CL:SETQ OTREE
           (CONS (CONS OPARAMETER (CONS FIRSTPARAMETERTYPE NIL)) OTREE))
    ...
    (CL:AND
     (%WRAPPER-VALUE
      (DYNAMIC-SLOT-VALUE (%DYNAMIC-SLOTS METHOD)
       SYM-CL-TRANSLATE-STELLA-METHOD-VARIABLE-ARGUMENTS? FALSE-WRAPPER))
...
(CL:DEFUN CL-TRANSLATE-DEFINE-METHOD-UNIT (UNIT)
  (CL:LET*
   ((METHOD (%THE-OBJECT UNIT)) (METHODNAME (%SLOT-NAME METHOD))
    ...
    (FUNCTION? (%METHOD-FUNCTION? METHOD)) (BODYTREE (%CODE-REGISTER UNIT))
   ...
   (CL:LET*
    ((TEST-VALUE-000
      (METHOD-CALL-TYPE-FOR-VECTOR-STRUCTS METHODNAME (%SLOT-OWNER METHOD)
       FUNCTION?)))
    (CL:COND
     ((CL:EQ TEST-VALUE-000 SYM-CL-TRANSLATE-STELLA-PRINT-OBJECT)
      (CL:SETQ BODYTREE
   ...
   (CL:SETQ OTREE
    (CONS
     (CL:IF FUNCTION? (INTERN-COMMON-LISP-SYMBOL "DEFUN")
      (CL:IF (USE-DEFCONSMETHOD? METHOD) SYM-CL-TRANSLATE-STELLA-%%DEFCONSMETHOD
       (INTERN-COMMON-LISP-SYMBOL "DEFMETHOD")))
     (CONS
      (CL-TRANSLATE-GLOBAL-SYMBOL
       (YIELD-RENAMED-NAME-IF-NATIVE METHODNAME KWD-CL-TRANSLATE-COMMON-LISP
        KWD-CL-TRANSLATE-FUNCTION))
      (CONS (CL-TRANSLATE-METHOD-PARAMETERS METHOD)
       (CONCATENATE
        ...
        (CONCATENATE (CL-YIELD-DECLARE-TREE DECLARATIONS TRUE)
   ...
   (CL:WHEN (CL:NOT (CL:EQ METHODDECLARATION NULL))
    (CL:SETQ OTREE
     (LIST* (INTERN-COMMON-LISP-SYMBOL "PROGN") OTREE
      (CONS (LIST* (INTERN-COMMON-LISP-SYMBOL "DECLAIM") METHODDECLARATION NIL)
       NIL))))
  ...
  (CL:LET* ((CLTYPE (LOOKUP-CL-TYPE-FROM-STELLA-TYPE (%SLOT-BASE-TYPE SLOT))))
   (CL:IF (CL:NOT (CL:EQ CLTYPE NULL))
    (CL:RETURN-FROM YIELD-CLOS-SLOT-TYPE-TREE
     (LIST* KWD-CL-TRANSLATE-TYPE CLTYPE
      (LIST* KWD-CL-TRANSLATE-INITFORM
       (CL-TRANSLATE-A-TREE
        (TYPE-TO-WALKED-NULL-VALUE-TREE (%SLOT-BASE-TYPE SLOT)))
       NIL)))
...
(CL:DEFUN YIELD-CLOS-SLOT-TREE (SLOT)
  (CL:LET*
   ((SLOTNAME (TRUE-SLOT-NAME (%SLOT-NAME SLOT) (%SLOT-OWNER SLOT)))
   ...
   (CL:WHEN (CL:NOT (CL:EQ DOCUMENTATION STELLA::NULL-STRING))
    (CL:SETQ DOCUMENTATIONFORM
     (LIST* KWD-CL-TRANSLATE-DOCUMENTATION (WRAP-STRING DOCUMENTATION) NIL)))
     ...
     (CONCATENATE (YIELD-CLOS-SLOT-TYPE-TREE SLOT)
      (CONCATENATE DOCUMENTATIONFORM
       (CONCATENATE ALLOCATIONFORM
        (LIST* KWD-CL-TRANSLATE-ACCESSOR (YIELD-CLOS-SLOT-ACCESSOR-NAME SLOTNAME)
         NIL))))))))
...
(CL:DEFUN YIELD-CLOS-CLASS-TREE (CLASS)
  (CL:LET*
   ...
   (CL:DECLARE (CL:TYPE CL:SIMPLE-STRING DOCUMENTATION))
   (CL:LET*
    ((SUPER NULL) (ITER-000 (%THE-CONS-LIST (CLASS-NATIVE-SUPERS CLASS)))
     (COLLECT-000 NULL))
    (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-000 NIL)) DO
   ...
   (CL:WHEN (CL:EQ DIRECTSUPERS NIL)
    (CL:SETQ DIRECTSUPERS
     (CONS (CL-TRANSLATE-GLOBAL-SYMBOL SYM-CL-TRANSLATE-STELLA-CLSYS-ROOT-OBJECT)
      DIRECTSUPERS)))
     ...
     (CL:TAGBODY
      (CL:WHEN (CL:AND (STORAGE-SLOT? SLOT) (NATIVE-SLOT? SLOT))
       (CL:WHEN (CL:NOT (CL:EQ (NATIVE-SLOT-HOME SLOT CLASS) CLASS))
        (CL:WHEN
         (CL:AND (CL:NOT (CL:EQ (%SLOT-BASE-TYPE SLOT) NULL))
          (CL:EQ (%SURROGATE-VALUE (%SLOT-BASE-TYPE SLOT)) NULL))
         (CL:WARN
       ...
       (CL:IF (CL:EQ COLLECT-001 NULL)
        ...
        (CL:PROGN
         (CL:SETF (%%REST COLLECT-001) (CONS (YIELD-CLOS-SLOT-TREE SLOT) NIL))
    ...
    ((REALSUPER VALUE-000)
     (RESULT
      (CL:IF (CL:NOT (CL:EQ REALSUPER NULL))
       (COMPUTE-CL-STRUCT-SLOTS (%SURROGATE-VALUE REALSUPER)) NULL)))
    (CL:WHEN (CL:EQ RESULT NULL) (CL:SETQ RESULT (NEW-LIST)))
    (CL:LET*
     ((SUPER NULL) (ITER-001 (%THE-CONS-LIST (CLASS-NATIVE-SUPERS CLASS))))
     (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-001 NIL)) DO
...
(CL:DEFUN CL-STRUCT-SLOT-OFFSET (SLOTNAME CLASSTYPE)
  (CL:LET* ((SLOTS (CL-STRUCT-SLOTS (%SURROGATE-VALUE CLASSTYPE))) (OFFSET 1))
   ...
   (CL:LET* ((*PRINTREADABLY?* TRUE)) (CL:DECLARE (CL:SPECIAL *PRINTREADABLY?*))
    ...
    (CL:WHEN (CL:NOT (SUPPRESS-WARNINGS?))
     (PRINT-ERROR-CONTEXT ">> ERROR: " STANDARD-ERROR)
     (%%PRINT-STREAM (%NATIVE-STREAM STANDARD-ERROR) EOL " Can't find slot `"
      (DE-UGLIFY-PARSE-TREE SLOTNAME) "' on CL-struct class `"
    ...
    (CL:RETURN-FROM YIELD-STRUCT-SLOT-TREE
     (CONS (CL-TRANSLATE-LOCAL-SYMBOL (%SLOT-NAME SLOT))
      (CONS
       (CL-TRANSLATE-A-TREE
        (TYPE-TO-WALKED-NULL-VALUE-TREE (%SLOT-BASE-TYPE SLOT)))
       (LIST* KWD-CL-TRANSLATE-TYPE CLTYPE NIL))))
    (CL:RETURN-FROM YIELD-STRUCT-SLOT-TREE
     (CONS (CL-TRANSLATE-LOCAL-SYMBOL (%SLOT-NAME SLOT))
...
(CL:DEFUN YIELD-STRUCT-SLOT-TREES (CLASS)
  (CL:LET* ((STRUCTSLOTDEFS NIL))
   (CL:LET*
    ((SLOT NULL) (ITER-000 (%THE-CONS-LIST (CL-STRUCT-SLOTS CLASS)))
     (COLLECT-000 NULL))
    (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-000 NIL)) DO
     (CL:PROGN (CL:SETQ SLOT (%%VALUE ITER-000))
      (CL:SETQ ITER-000 (%%REST ITER-000)))
     (CL:TAGBODY
      ...
      (CL:IF (CL:EQ COLLECT-000 NULL)
       ...
       (CL:PROGN
        (CL:SETF (%%REST COLLECT-000) (CONS (YIELD-STRUCT-SLOT-TREE SLOT) NIL))
        (CL:SETQ COLLECT-000 (%%REST COLLECT-000))))
      :CONTINUE)))
   ...
   (CL:LET*
    ...
    (CL:IF (CL:NOT (CL:EQ SUPER NULL))
     (CL:SETQ TRANSLATEDSUPER
      (CL-TRANSLATE-GLOBAL-SYMBOL
       (INTERN-SYMBOL-IN-MODULE (%SYMBOL-NAME SUPER) (%HOME-CONTEXT SUPER)
        TRUE)))
     (CL:SETQ TRANSLATEDSUPER
      (CL-TRANSLATE-GLOBAL-SYMBOL SYM-CL-TRANSLATE-STELLA-CLSYS-ROOT-STRUCT)))
      ...
      (CONS (CL-TRANSLATE-GLOBAL-SYMBOL (CLASS-SYMBOL CLASS))
       (CONS
        (LIST* KWD-CL-TRANSLATE-CONC-NAME
         (YIELD-STRUCT-SLOT-ACCESSOR-NAME (%CLASS-TYPE CLASS)
          SYM-CL-TRANSLATE-STELLA-)
         NIL)
        (CONCATENATE
         (CL:IF (CL:NOT (CL:EQ TRANSLATEDSUPER NULL))
          (CONS (LIST* KWD-CL-TRANSLATE-INCLUDE TRANSLATEDSUPER NIL) NIL) NIL)
         (LIST*
...
(CL:DEFUN CL-ALWAYS-TRANSLATE-TO-CLOS-CLASS? (CLASS)
  (CL:LET* ((TEST-VALUE-000 FALSE))
   (CL:SETQ TEST-VALUE-000
    (CL:NOT (SUBTYPE-OF? (%CLASS-TYPE CLASS) SGT-CL-TRANSLATE-STELLA-OBJECT)))
     ...
     (CL:LET* ((FOUND?-000 FALSE))
      (CL:LET* ((SUPER NULL) (ITER-000 (%CLASS-ALL-SUPER-CLASSES CLASS)))
       (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-000 NIL)) DO
        (CL:PROGN (CL:SETQ SUPER (%%VALUE ITER-000))
         (CL:SETQ ITER-000 (%%REST ITER-000)))
        (CL:WHEN (CL:NOT (CREATE-NATIVE-CLASS? SUPER)) (CL:SETQ FOUND?-000 TRUE)
         (CL:RETURN))))
...
(CL:DEFUN CL-TRANSLATE-DEFINE-GLOBAL-VARIABLE-UNIT (UNIT)
  (CL:LET*
   ((GLOBAL (%THE-OBJECT UNIT))
    ...
    (UNBOUNDSPECIAL?
     (CL:AND (%VARIABLE-SPECIAL? GLOBAL)
      (CL:EQ (%CODE-REGISTER UNIT) KWD-CL-TRANSLATE-UNBOUND-SPECIAL-VARIABLE)))
   ...
   (CL:DECLARE (CL:TYPE CL:SIMPLE-STRING DOCUMENTATION))
   (CL:WHEN (CL:AND (%VARIABLE-CONSTANT? GLOBAL) FALSE)
   ...
   (CL:WHEN (CL:NOT (CL:EQ TYPEDECLARATIONTREE NULL))
    (CL:SETQ OTREE
     (LIST* (INTERN-COMMON-LISP-SYMBOL "PROGN") OTREE
      (CONS (LIST* (INTERN-COMMON-LISP-SYMBOL "DECLAIM") TYPEDECLARATIONTREE NIL)
       NIL))))
...
(CL:DEFUN CL-TRANSLATE-DEFPRINT-UNIT (UNIT)
  (CL:LET*
   ((CLASS (%THE-OBJECT UNIT)) (BODY (%CODE-REGISTER UNIT)) (EXTRATREES NIL))
   (CL:COND
    ((CL:EQ
      (METHOD-CALL-TYPE-FOR-VECTOR-STRUCTS SYM-CL-TRANSLATE-STELLA-PRINT-OBJECT
       (%CLASS-TYPE CLASS) FALSE)
      SYM-CL-TRANSLATE-STELLA-PRINT-OBJECT)
     (CL:SETQ EXTRATREES
      (CONS
       (LIST* SYM-CL-TRANSLATE-STELLA-SETQ SYM-CL-TRANSLATE-STELLA-SELF
   ...
   (CL:RETURN-FROM CL-TRANSLATE-DEFPRINT-UNIT
    (LIST* (INTERN-COMMON-LISP-SYMBOL "DEFMETHOD")
     ...
     (LIST* (LIST* SYM-CL-TRANSLATE-STELLA-SELF (CLASS-SYMBOL CLASS) NIL)
...
(CL:DEFUN HELP-STARTUP-CL-TRANSLATE2 ()
  (CL:PROGN
   ...
   (CL:SETQ SGT-CL-TRANSLATE-STELLA-INTEGER-WRAPPER
    (INTERN-RIGID-SYMBOL-WRT-MODULE "INTEGER-WRAPPER" NULL 1))
   (CL:SETQ SGT-CL-TRANSLATE-STELLA-FLOAT-WRAPPER
  ...
  (CL:WHEN (CURRENT-STARTUP-TIME-PHASE? 0)
   (CL:WHEN (CLSYS-USE-VECTOR-STRUCTS-P)
    (CL:DEFMETHOD CL:PRINT-OBJECT :AROUND ((SELF CL:VECTOR) STREAM)
     (CL:IF (CLSYS-VECTOR-STRUCT-P SELF) (CLSYS-PRINT-VECTOR-STRUCT SELF STREAM)
      (CL:CALL-NEXT-METHOD)))))
  (CL:LET* ((*MODULE* *STELLA-MODULE*) (*CONTEXT* *MODULE*))
   (CL:DECLARE (CL:SPECIAL *MODULE* *CONTEXT*))
   (CL:WHEN (CURRENT-STARTUP-TIME-PHASE? 2) (HELP-STARTUP-CL-TRANSLATE1)
    (HELP-STARTUP-CL-TRANSLATE2) (HELP-STARTUP-CL-TRANSLATE3))
   (CL:WHEN (CURRENT-STARTUP-TIME-PHASE? 4)
    (CL:SETQ *NEEDEXPLICITRETURN?* FALSE))
   ...
   (CL:WHEN (CURRENT-STARTUP-TIME-PHASE? 7) (HELP-STARTUP-CL-TRANSLATE4)
    ...
    (CL:LET*
     ((FUNCTION (LOOKUP-FUNCTION SYM-CL-TRANSLATE-STELLA-STARTUP-CL-TRANSLATE)))
     (SET-DYNAMIC-SLOT-VALUE (%DYNAMIC-SLOTS FUNCTION)
      SYM-CL-TRANSLATE-STELLA-METHOD-STARTUP-CLASSNAME
      (WRAP-STRING "_Startup-Cl-Translate") NULL-STRING-WRAPPER)))
   ...
   (CL:WHEN (CURRENT-STARTUP-TIME-PHASE? 9)
    ...
    (CL:SETQ *CL-OPERATOR-TABLE*
     (DICTIONARY SGT-CL-TRANSLATE-STELLA-KEY-VALUE-LIST SYM-CL-TRANSLATE-STELLA-+
      (INTERN-COMMON-LISP-SYMBOL "+") SYM-CL-TRANSLATE-STELLA--
      (INTERN-COMMON-LISP-SYMBOL "-") SYM-CL-TRANSLATE-STELLA-*
      (INTERN-COMMON-LISP-SYMBOL "*") SYM-CL-TRANSLATE-STELLA-/
      (INTERN-COMMON-LISP-SYMBOL "/") SYM-CL-TRANSLATE-STELLA-EQ?
      (INTERN-COMMON-LISP-SYMBOL "EQL") SYM-CL-TRANSLATE-STELLA-<
      (INTERN-COMMON-LISP-SYMBOL "<") SYM-CL-TRANSLATE-STELLA-<=
      (INTERN-COMMON-LISP-SYMBOL "<=") SYM-CL-TRANSLATE-STELLA->=
      (INTERN-COMMON-LISP-SYMBOL ">=") SYM-CL-TRANSLATE-STELLA->
      (INTERN-COMMON-LISP-SYMBOL ">") SYM-CL-TRANSLATE-STELLA-=
    ...
    (CL:LET*
     ...
     (CL:WHEN USESTRUCTS?
      (%SET-STELLA-FEATURE (CONS-LIST KWD-CL-TRANSLATE-USE-COMMON-LISP-STRUCTS)))
     (CL:WHEN USEVECTORSTRUCTS?
      (%SET-STELLA-FEATURE
       (CONS-LIST KWD-CL-TRANSLATE-USE-COMMON-LISP-VECTOR-STRUCTS)))
     (CL:WHEN USECLCONSES?
      (%SET-STELLA-FEATURE (CONS-LIST KWD-CL-TRANSLATE-USE-COMMON-LISP-CONSES))))
    (DEFINE-STELLA-GLOBAL-VARIABLE-FROM-STRINGIFIED-SOURCE
