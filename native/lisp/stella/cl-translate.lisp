...
(CL:DECLAIM
 (CL:SPECIAL *STELLA-MODULE* FALSE-WRAPPER NIL-LIST ONE-WRAPPER NULL-INTEGER
  *CURRENTTRANSLATIONUNIT* *SAFETY* *STARTUP-TIME-PHASE* *UNFINALIZED-CLASSES*
  STANDARD-ERROR EOL NULL-STRING-WRAPPER *COMMON-LISP-MODULE* *MODULE* NIL
     ...
     (CL:LET* ((TEST-VALUE-000 (%%VALUE TREE)))
      (CL:COND
       ...
       ((CL:EQ TEST-VALUE-000 SYM-CL-TRANSLATE-STELLA-CONTINUE)
        (CL:RETURN-FROM HELP-CL-TRANSLATE-A-TREE
         (LIST* (INTERN-COMMON-LISP-SYMBOL "GO") KWD-CL-TRANSLATE-CONTINUE
          NIL)))
...
(CL:DEFMETHOD CL-TRANSLATE-ATOMIC-TREE ((TREE SYMBOL))
  (CL:COND
   ...
   ((CL:EQ TREE SYM-CL-TRANSLATE-STELLA-FALSE)
    (CL:RETURN-FROM CL-TRANSLATE-ATOMIC-TREE *CL-FALSE-STRING-WRAPPER*))
...
(CL:DEFUN YIELD-READABLE-SYMBOL-NAME (SYMBOLMODULE SYMBOLNAME LOCAL?)
  ...
  (CL:LET*
   ...
   (CL:LET*
    ((TEST-VALUE-000 (COMPUTE-SYMBOL-ESCAPE-CODE LISPSYMBOLNAME CL:NIL)))
    (CL:COND ((CL:EQ TEST-VALUE-000 KWD-CL-TRANSLATE-UNESCAPED))
     ...
     ((CL:EQ TEST-VALUE-000 KWD-CL-TRANSLATE-COMPLEX-ESCAPED)
      (CL:LET* ((S (NEW-OUTPUT-STRING-STREAM)))
       (PRINT-SYMBOL-NAME-READABLY LISPSYMBOLNAME (%NATIVE-STREAM S) CL:NIL)
...
(CL:DEFUN CL-TRANSLATE-LOCAL-SYMBOL (SYMBOL)
  (CL:RETURN-FROM CL-TRANSLATE-LOCAL-SYMBOL
   (NEW-VERBATIM-STRING-WRAPPER
    (YIELD-READABLE-SYMBOL-NAME (%HOME-CONTEXT SYMBOL) (%SYMBOL-NAME SYMBOL)
     CL:T))))
...
(CL:DEFUN TRUE-SLOT-NAME (SLOTNAME TYPE)
  (CL:RETURN-FROM TRUE-SLOT-NAME
   (%SLOT-NAME
    (CANONICAL-SLOT (LOOKUP-SLOT (%SURROGATE-VALUE TYPE) SLOTNAME)))))
...
(CL:DEFUN CL-TRANSLATE-FOREACH-TREE (TREE)
  (CL:LET*
   ((ITERATORBINDINGS (%%VALUE (%%REST TREE)))
    ...
    (BODY (CL-TRANSLATE-LIST-OF-TREES (NTH-REST TREE 5))) (DECLARATIONS NIL)
    (VALUEASSIGNMENTS NIL) (NEXTASSIGNMENTS NIL) (TYPEDECLARATIONS NIL)
   ...
   (CL:LET* ((TREE NULL) (ITER-001 VALUETREES) (COLLECT-001 NULL))
    (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-001 NIL)) DO
     ...
     (CL:IF (CL:EQ COLLECT-001 NULL)
      ...
      (CL:PROGN
       (CL:SETF (%%REST COLLECT-001) (CONS (CL-TRANSLATE-A-TREE TREE) NIL))
   ...
   (CL:LET* ((TREE NULL) (ITER-002 NEXTTREES) (COLLECT-002 NULL))
    (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-002 NIL)) DO
     ...
     (CL:IF (CL:EQ COLLECT-002 NULL)
      ...
      (CL:PROGN
       (CL:SETF (%%REST COLLECT-002) (CONS (CL-TRANSLATE-A-TREE TREE) NIL))
...
(CL:DEFUN CL-TRANSLATE-SPECIAL-TREE (TREE)
  (CL:LET*
   ((TRANSLATEDTREE (CL-TRANSLATE-LET-TREE TREE CL:T)) (SPECIALVARS NIL))
   (CL:LET*
     ...
     (CL:PROGN
      (CL:COND
       ...
       ((SUBTYPE-OF? TYPE SGT-CL-TRANSLATE-STELLA-LONG-INTEGER)
        (CL:RETURN-FROM COERCE-NUMERIC-CONSTANT
         (WRAP-LONG-INTEGER (CL:TRUNCATE (%WRAPPER-VALUE CONSTANT))))))))
    ((SUBTYPE-OF-LONG-INTEGER? TEST-VALUE-000)
     (CL:PROGN
      (CL:COND
       ...
       ((SUBTYPE-OF? TYPE SGT-CL-TRANSLATE-STELLA-INTEGER)
        (CL:RETURN-FROM COERCE-NUMERIC-CONSTANT
         (WRAP-INTEGER (CL:TRUNCATE (%WRAPPER-VALUE CONSTANT)))))
       ((SUBTYPE-OF? TYPE SGT-CL-TRANSLATE-STELLA-LONG-INTEGER)
        (CL:RETURN-FROM COERCE-NUMERIC-CONSTANT CONSTANT)))))
   ...
   (CL:COND
    ((CL:AND (SUBTYPE-OF? TYPE SGT-CL-TRANSLATE-STELLA-NUMBER)
     ...
     (CL:RETURN-FROM CL-TRANSLATE-CAST-TREE
      (CL-TRANSLATE-ATOMIC-TREE (COERCE-NUMERIC-CONSTANT EXPRESSION TYPE))))
    ((SUBTYPE-OF? TYPE SGT-CL-TRANSLATE-STELLA-FLOAT)
     (CL:RETURN-FROM CL-TRANSLATE-CAST-TREE
       ...
       ((CL:EQ OPERATOR SYM-CL-TRANSLATE-STELLA-EQ?)
        (CL:WHEN (OPTIMIZE-BOOLEAN-TESTS?)
         (CL:LET*
          ...
          (CL:IF
           (CL:AND
            (SUB-TYPE-SPEC-OF? ARGTYPE1 SGT-CL-TRANSLATE-STELLA-LITERAL)
         ...
         (CL:COND
          ((CL:OR (CL:EQ OWNER SGT-CL-TRANSLATE-STELLA-OBJECT)
           ...
           (CL:IF (CL:EQ OWNER SGT-CL-TRANSLATE-STELLA-ARRAY)
            (CL:SETQ TREE
             (CONS
              (CL-TRANSLATE-GLOBAL-SYMBOL SYM-CL-TRANSLATE-STELLA-NULL-ARRAY?)
   ...
   (CL:WHEN
    ...
    (CL:RETURN-FROM CL-TRANSLATE-MAKE-TREE
     (LIST* (INTERN-COMMON-LISP-SYMBOL "CONS")
      (INTERN-COMMON-LISP-SYMBOL "NIL") (INTERN-COMMON-LISP-SYMBOL "NIL")
      NIL)))
   (CL:COND
        ...
        (CL:COND
         ((CL:EQ
           (METHOD-CALL-TYPE-FOR-VECTOR-STRUCTS PRINTOPERATOR ARGUMENTTYPE
            (CL:NOT
             (CL:EQ PRINTOPERATOR SYM-CL-TRANSLATE-STELLA-PRINT-OBJECT)))
           SYM-CL-TRANSLATE-STELLA-PRINT-OBJECT)
...
(CL:DEFUN CL-TRANSLATE-INLINE-CALL-TREE (TREE)
  (CL:LET*
   ((CALLTREE (%%VALUE (%%REST TREE)))
    ...
    (ARGS
     (CL:IF
      (CL:EQ (%%VALUE CALLTREE) SYM-CL-TRANSLATE-STELLA-SYS-CALL-FUNCTION)
   ...
   (CL:COND
    ((CL:EQ (SAFE-PRIMARY-TYPE BODY) SGT-CL-TRANSLATE-STELLA-CONS)
     (CL:PROGN
      (CL:LET* ((ALWAYS?-000 CL:T))
       ...
       (CL:WHEN ALWAYS?-000
        (CL:SETQ OTREE
         (CONS (CL-TRANSLATE-VERBATIM-BODY-SYMBOLS (%%VALUE BODY) NIL-LIST)
          NIL))
    ...
    (CL:T))
   (CL:LET*
    ((PAR NULL) (ITER-002 (%THE-CONS-LIST PARAMETERS)) (ARG NULL)
    ...
    (LIST* (INTERN-COMMON-LISP-SYMBOL "LET") OTREE
     (CONCATENATE
      (CL-YIELD-DECLARE-TREE
       (CL-YIELD-METHOD-PARAMETER-TYPE-DECLARATION-TREES METHOD) CL:NIL)
      (CONS
       ...
       (CL:OTHERWISE
        (CL:LET* ((RANK (ARRAY-TYPE-RANK TYPE)) (DIMENSIONS NIL))
         ...
         (CL:WHEN (CL:<= RANK 5)
          (CL:LET*
           ((DIM NULL)
            (ITER-000 (%THE-CONS-LIST (ARRAY-TYPE-DIMENSIONS TYPE)))
            (COLLECT-000 NULL))
           (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-000 NIL)) DO
            ...
            (CL:IF (CL:EQ COLLECT-000 NULL)
             (CL:PROGN
              (CL:SETQ COLLECT-000
               (CONS
                (CL:IF (CL:EQ DIM NULL) (INTERN-COMMON-LISP-SYMBOL "*") DIM)
                NIL))
  ...
  (CL:LET* ((TYPES NIL) (CLTYPE NULL))
   (CL:LET*
    ((TSPEC NULL)
     ...
     (PNAME NULL) (ITER-001 (%THE-CONS-LIST (METHOD-PARAMETER-NAMES METHOD))))
    (CL:LOOP WHILE
...
(CL:DEFUN CL-YIELD-METHOD-TYPE-DECLARATION-TREE (METHOD)
  ...
  (CL:LET*
   ((CLTYPE (LOOKUP-CL-TYPE-FROM-STELLA-TYPE (%SLOT-BASE-TYPE METHOD))))
   (CL:IF (CL:NOT (CL:EQ CLTYPE NULL))
    (CL:RETURN-FROM CL-YIELD-METHOD-TYPE-DECLARATION-TREE
     (CL-CONDITIONALIZE-TYPE-DECLARATION-TREE
      (LIST* (INTERN-COMMON-LISP-SYMBOL "FTYPE")
       ...
       (CL-TRANSLATE-GLOBAL-SYMBOL
        (YIELD-RENAMED-NAME-IF-NATIVE (%SLOT-NAME METHOD)
         KWD-CL-TRANSLATE-COMMON-LISP KWD-CL-TRANSLATE-FUNCTION))
       NIL)))
    (CL:RETURN-FROM CL-YIELD-METHOD-TYPE-DECLARATION-TREE NULL))))
  ...
  (CL:LET* ((TEST-VALUE-000 (%CATEGORY UNIT)))
   (CL:COND
    ...
    ((CL:OR (CL:EQ TEST-VALUE-000 SYM-CL-TRANSLATE-STELLA-STARTUP-TIME-PROGN)
      (CL:EQ TEST-VALUE-000 SYM-CL-TRANSLATE-STELLA-VERBATIM))
     (CL:RETURN-FROM CL-TRANSLATE-UNIT
      (CL-TRANSLATE-A-TREE (%THE-OBJECT UNIT))))
...
(CL:DEFUN CL-TRANSLATE-METHOD-PARAMETERS (METHOD)
  (CL:LET*
   ((FUNCTION? (%METHOD-FUNCTION? METHOD)) (ABSTRACT? (%ABSTRACT? METHOD))
    (OTREE NIL) (OPARAMETER NULL) (FIRSTPARAMETERTYPE NULL))
   (CL:LET*
    ((PARAMETER NULL)
     (ITER-000 (%THE-CONS-LIST (METHOD-PARAMETER-NAMES METHOD))) (PTYPE NULL)
    ...
    (CL:LOOP WHILE
     (CL:AND (CL:NOT (CL:EQ ITER-000 NIL)) (CL:NOT (CL:EQ ITER-001 NIL))) DO
     (CL:SETQ PARAMETER (%%VALUE ITER-000)) (CL:SETQ PTYPE (%%VALUE ITER-001))
     (CL:SETQ I ITER-002)
      ...
      (CL:SETQ BODYTREE
       (CONS
        (LIST* SYM-CL-TRANSLATE-STELLA-SETQ SYM-CL-TRANSLATE-STELLA-SELF
         (CL-TRANSLATE-GLOBAL-SYMBOL SYM-CL-TRANSLATE-STELLA-*CLSYS-SELF*)
         NIL)
        BODYTREE)))
     ((CL:EQ TEST-VALUE-000 SYM-CL-TRANSLATE-STELLA-NON-OBJECT-METHOD)
   ...
   (CL:WHEN (CL:NOT (CL:EQ METHODDECLARATION NULL))
    (CL:SETQ OTREE
     (LIST* (INTERN-COMMON-LISP-SYMBOL "PROGN")
      (LIST* (INTERN-COMMON-LISP-SYMBOL "DECLAIM") METHODDECLARATION NIL)
      OTREE NIL)))
  ...
  (CL:LET*
   ...
   (CL:WHEN (CL:EQ DIRECTSUPERS NIL)
    (CL:SETQ DIRECTSUPERS
     (CONS
      (CL-TRANSLATE-GLOBAL-SYMBOL SYM-CL-TRANSLATE-STELLA-CLSYS-ROOT-OBJECT)
      DIRECTSUPERS)))
   ...
   (CL:WHEN (CL:NOT (CL:EQ TYPEDECLARATIONTREE NULL))
    (CL:SETQ OTREE
     (LIST* (INTERN-COMMON-LISP-SYMBOL "PROGN") OTREE
      (CONS
       (LIST* (INTERN-COMMON-LISP-SYMBOL "DECLAIM") TYPEDECLARATIONTREE NIL)
       NIL))))
   ...
   (CL:COND
    ((CL:EQ
      (METHOD-CALL-TYPE-FOR-VECTOR-STRUCTS
       SYM-CL-TRANSLATE-STELLA-PRINT-OBJECT (%CLASS-TYPE CLASS) CL:NIL)
      SYM-CL-TRANSLATE-STELLA-PRINT-OBJECT)
     (CL:SETQ EXTRATREES
      (CONS
       (LIST* SYM-CL-TRANSLATE-STELLA-SETQ SYM-CL-TRANSLATE-STELLA-SELF
...
(CL:DEFUN STARTUP-CL-TRANSLATE ()
  ...
  (CL:LET* ((*MODULE* *STELLA-MODULE*) (*CONTEXT* *MODULE*))
   ...
   (CL:WHEN (CURRENT-STARTUP-TIME-PHASE? 4)
    (CL:SETQ *CL-TRUE-STRING-WRAPPER* (NEW-VERBATIM-STRING-WRAPPER "CL:T"))
