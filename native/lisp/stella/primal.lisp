...
(CL:DECLAIM
 (CL:SPECIAL *STELLA-MODULE* *MODULE* *TOKENIZER-INITIAL-BUFFER-SIZE* *USE-STELLA-HASH-TABLES?* NIL *CHARACTER-TYPE-TABLE* *CHARACTER-UPCASE-TABLE*
  *CHARACTER-DOWNCASE-TABLE* STANDARD-OUTPUT EOL *INTEGER-MSB-MASK* *INTEGER-UNSIGNED-BITS-MASK* *LONG-INTEGER-MSB-MASK* *LONG-INTEGER-UNSIGNED-BITS-MASK*
...
(CL:DEFUN LISP-NULL-ARRAY-SYMBOL-STRING (RANK)
  ...
  (CL:CASE RANK (1 (CL:RETURN-FROM LISP-NULL-ARRAY-SYMBOL-STRING "STELLA::NULL-1D-ARRAY")) (2 (CL:RETURN-FROM LISP-NULL-ARRAY-SYMBOL-STRING "STELLA::NULL-2D-ARRAY"))
   ...
   (5 (CL:RETURN-FROM LISP-NULL-ARRAY-SYMBOL-STRING "STELLA::NULL-5D-ARRAY")) (CL:OTHERWISE (CL:RETURN-FROM LISP-NULL-ARRAY-SYMBOL-STRING "STELLA::NULL"))))
...
(CL:DEFCONSTANT MOST-NEGATIVE-FLOAT
  #-(or cmucl sbcl ccl)
...
(CL:DEFUN PRINT-NUMERIC-CONSTANTS ()
  (%%PRINT-STREAM (%NATIVE-STREAM STANDARD-OUTPUT) "MOST-POSITIVE-INTEGER:             " MOST-POSITIVE-INTEGER EOL "MOST-NEGATIVE-INTEGER:            "
   MOST-NEGATIVE-INTEGER EOL "NULL-INTEGER:                     " NULL-INTEGER EOL "MOST-POSITIVE-LONG-INTEGER:        " MOST-POSITIVE-LONG-INTEGER EOL
   "MOST-NEGATIVE-LONG-INTEGER:       " MOST-NEGATIVE-LONG-INTEGER EOL "NULL-LONG-INTEGER:                " NULL-LONG-INTEGER EOL "MOST-POSITIVE-FLOAT:               "
   MOST-POSITIVE-FLOAT EOL "MOST-NEGATIVE-FLOAT:              " MOST-NEGATIVE-FLOAT EOL "LEAST-POSITIVE-FLOAT:              " LEAST-POSITIVE-FLOAT EOL
   "LEAST-NEGATIVE-FLOAT:             " LEAST-NEGATIVE-FLOAT EOL "NULL-FLOAT:                       " NULL-FLOAT EOL "*INTEGER-MSB-MASK*:                "
   *INTEGER-MSB-MASK* EOL "*INTEGER-UNSIGNED-BITS-MASK*:      " *INTEGER-UNSIGNED-BITS-MASK* EOL "*LONG-INTEGER-MSB-MASK*:           " *LONG-INTEGER-MSB-MASK* EOL
   "*LONG-INTEGER-UNSIGNED-BITS-MASK*: " *LONG-INTEGER-UNSIGNED-BITS-MASK* EOL "LONG-INTEGER-BIT-WIDTH:            " LONG-INTEGER-BIT-WIDTH EOL
   "il(MOST-POSITIVE-INTEGER):         " (INTEGER-LENGTH (CL:TRUNCATE MOST-POSITIVE-INTEGER)) EOL "il(MOST-POSITIVE-LONG-INTEGER):    "
   (INTEGER-LENGTH MOST-POSITIVE-LONG-INTEGER) EOL "il(MOST-NEGATIVE-INTEGER):         " (INTEGER-LENGTH (CL:TRUNCATE MOST-NEGATIVE-INTEGER)) EOL
   "il(MOST-NEGATIVE-LONG-INTEGER):    " (INTEGER-LENGTH MOST-NEGATIVE-LONG-INTEGER) EOL)
  :VOID)
...
substitutes the faster `eq?' test inline."
  (CL:RETURN-FROM EQL? (CL:IF (CL:EQ X NULL) (CL:EQ Y NULL) (CL:OR (CL:EQ X Y) (OBJECT-EQL? X Y)))))
...
method."
  (CL:RETURN-FROM EQUAL? (CL:IF (CL:EQ X NULL) (CL:EQ Y NULL) (CL:OR (CL:EQ X Y) (OBJECT-EQUAL? X Y)))))
...
(CL:DECLAIM (CL:FTYPE (CL:FUNCTION (CL:DOUBLE-FLOAT CL:DOUBLE-FLOAT) CL:DOUBLE-FLOAT) FREM))
(CL:DEFUN FREM (X Y)
...
(CL:DECLAIM (CL:FTYPE (CL:FUNCTION (CL:DOUBLE-FLOAT CL:DOUBLE-FLOAT) CL:DOUBLE-FLOAT) FMOD))
...
(CL:DEFUN GCD (X Y)
  ...
  (CL:LET* ((TEMP 0)) (CL:LOOP WHILE (CL:NOT (CL:= Y 0)) DO (CL:SETQ TEMP (CL:REM X Y)) (CL:SETQ X Y) (CL:SETQ Y TEMP)) (CL:RETURN-FROM GCD X)))
...
(CL:DEFUN REGULAR-INTEGER-VALUED? (X)
  ...
  (CL:RETURN-FROM REGULAR-INTEGER-VALUED? (CL:AND (CL:>= X NULL-INTEGER) (CL:<= X MOST-POSITIVE-INTEGER))))
...
or from decimal hours to Hour-Minute-Second format."
  ...
  (CL:LET* ((DEGREE (FLOOR X)) (MINUTE (FLOOR (CL:* (CL:- X DEGREE) 60.0d0))) (FSECOND (CL:- (CL:* X 3600.0d0) (CL:* DEGREE 3600.0d0) (CL:* MINUTE 60.0d0))))
   ...
   (CL:IF ALL-INTEGERS? (CL:RETURN-FROM FLOAT-TO-BASE60 (CONS-LIST (WRAP-INTEGER DEGREE) (WRAP-INTEGER MINUTE) (WRAP-INTEGER (ROUND FSECOND))))
    (CL:RETURN-FROM FLOAT-TO-BASE60 (CONS-LIST (WRAP-INTEGER DEGREE) (WRAP-INTEGER MINUTE) (WRAP-FLOAT FSECOND))))))

;;; (DEFUN (BASE60-TO-FLOAT FLOAT) ...)

(CL:DECLAIM (CL:FTYPE (CL:FUNCTION (CL:T) CL:DOUBLE-FLOAT) BASE60-TO-FLOAT))
...
or from Hour-Minute-Second format to decimal hours."
  (CL:LET* ((DVALUE (%%VALUE L)) (MVALUE (%%VALUE (%%REST L))) (SVALUE (%%VALUE (%%REST (%%REST L)))) (D 0.0d0)) (CL:DECLARE (CL:TYPE CL:DOUBLE-FLOAT D))
   (CL:LET* ((TEST-VALUE-000 (SAFE-PRIMARY-TYPE DVALUE)))
    (CL:COND ((SUBTYPE-OF-FLOAT? TEST-VALUE-000) (CL:PROGN (CL:SETQ D (%WRAPPER-VALUE DVALUE))))
     ((SUBTYPE-OF-INTEGER? TEST-VALUE-000) (CL:PROGN (CL:SETQ D (NUMBER-WRAPPER-TO-FLOAT DVALUE))))
     (CL:T
   ...
   (CL:LET* ((TEST-VALUE-001 (SAFE-PRIMARY-TYPE MVALUE)))
    (CL:COND ((SUBTYPE-OF-FLOAT? TEST-VALUE-001) (CL:PROGN (CL:SETQ D (CL:+ D (CL:/ (%WRAPPER-VALUE MVALUE) 60.0d0)))))
     ((SUBTYPE-OF-INTEGER? TEST-VALUE-001) (CL:PROGN (CL:SETQ D (CL:+ D (CL:/ (%WRAPPER-VALUE MVALUE) 60.0d0)))))
     (CL:T
      (CL:LET* ((STREAM-001 (NEW-OUTPUT-STRING-STREAM))) (%%PRINT-STREAM (%NATIVE-STREAM STREAM-001) "`" TEST-VALUE-001 "' is not a valid case option")
       (CL:ERROR (NEW-STELLA-EXCEPTION (THE-STRING-READER STREAM-001)))))))
   (CL:LET* ((TEST-VALUE-002 (SAFE-PRIMARY-TYPE SVALUE)))
    (CL:COND ((SUBTYPE-OF-FLOAT? TEST-VALUE-002) (CL:PROGN (CL:SETQ D (CL:+ D (CL:/ (%WRAPPER-VALUE SVALUE) 3600.0d0)))))
     ((SUBTYPE-OF-INTEGER? TEST-VALUE-002) (CL:PROGN (CL:SETQ D (CL:+ D (CL:/ (%WRAPPER-VALUE SVALUE) 3600.0d0)))))
     (CL:T
      (CL:LET* ((STREAM-002 (NEW-OUTPUT-STRING-STREAM))) (%%PRINT-STREAM (%NATIVE-STREAM STREAM-002) "`" TEST-VALUE-002 "' is not a valid case option")
...
(CL:DECLAIM (CL:FTYPE (CL:FUNCTION (CL:DOUBLE-FLOAT) CL:DOUBLE-FLOAT) SQRT))
(CL:DEFUN SQRT (N)
...
(CL:DECLAIM (CL:FTYPE (CL:FUNCTION (CL:DOUBLE-FLOAT) CL:DOUBLE-FLOAT) COS))
(CL:DEFUN COS (N)
...
(CL:DECLAIM (CL:FTYPE (CL:FUNCTION (CL:DOUBLE-FLOAT) CL:DOUBLE-FLOAT) SIN))
(CL:DEFUN SIN (N)
...
(CL:DECLAIM (CL:FTYPE (CL:FUNCTION (CL:DOUBLE-FLOAT) CL:DOUBLE-FLOAT) TAN))
(CL:DEFUN TAN (N)
...
(CL:DECLAIM (CL:FTYPE (CL:FUNCTION (CL:DOUBLE-FLOAT) CL:DOUBLE-FLOAT) ACOS))
(CL:DEFUN ACOS (N)
...
(CL:DECLAIM (CL:FTYPE (CL:FUNCTION (CL:DOUBLE-FLOAT) CL:DOUBLE-FLOAT) ASIN))
(CL:DEFUN ASIN (N)
...
(CL:DECLAIM (CL:FTYPE (CL:FUNCTION (CL:DOUBLE-FLOAT) CL:DOUBLE-FLOAT) ATAN))
(CL:DEFUN ATAN (N)
...
(CL:DECLAIM (CL:FTYPE (CL:FUNCTION (CL:DOUBLE-FLOAT CL:DOUBLE-FLOAT) CL:DOUBLE-FLOAT) ATAN2))
(CL:DEFUN ATAN2 (X Y)
...
(CL:DECLAIM (CL:FTYPE (CL:FUNCTION (CL:DOUBLE-FLOAT) CL:DOUBLE-FLOAT) LOG))
(CL:DEFUN LOG (N)
...
(CL:DECLAIM (CL:FTYPE (CL:FUNCTION (CL:DOUBLE-FLOAT) CL:DOUBLE-FLOAT) LOG2))
(CL:DEFUN LOG2 (N)
...
(CL:DECLAIM (CL:FTYPE (CL:FUNCTION (CL:DOUBLE-FLOAT) CL:DOUBLE-FLOAT) LOG10))
(CL:DEFUN LOG10 (N)
...
(CL:DECLAIM (CL:FTYPE (CL:FUNCTION (CL:DOUBLE-FLOAT) CL:DOUBLE-FLOAT) EXP))
(CL:DEFUN EXP (N)
...
(CL:DECLAIM (CL:FTYPE (CL:FUNCTION (CL:DOUBLE-FLOAT CL:DOUBLE-FLOAT) CL:DOUBLE-FLOAT) EXPT))
(CL:DEFUN EXPT (X Y)
  "Return `x' ^ `y'."
  (CL:DECLARE (CL:TYPE CL:DOUBLE-FLOAT X Y))
  #+MCL
...
(%%DEFINTEGERMETHOD MIN ((X CL:INTEGER) Y)
  "Return the minimum of `x' and `y'.  If either is NULL, return the other."
  (CL:RETURN-FROM MIN (CL:IF (CL:> X Y) (CL:IF (CL:= Y NULL-LONG-INTEGER) X Y) (CL:IF (CL:= X NULL-LONG-INTEGER) Y X))))
      ...
      (CL:LET* ((TEST-VALUE-000 (SAFE-PRIMARY-TYPE Y)))
       (CL:COND
        ((SUBTYPE-OF-INTEGER? TEST-VALUE-000)
         (CL:PROGN (CL:IF (CL:OR (CL:EQ Y NULL) (CL:<= (%WRAPPER-VALUE X) (%WRAPPER-VALUE Y))) (CL:RETURN-FROM MIN X) (CL:RETURN-FROM MIN Y))))
     ...
     (CL:PROGN
      (CL:LET* ((TEST-VALUE-002 (SAFE-PRIMARY-TYPE Y)))
       (CL:COND
        ...
        (CL:T (CL:RETURN-FROM MIN X))))))
    (CL:T
     (CL:LET* ((STREAM-000 (NEW-OUTPUT-STRING-STREAM))) (%%PRINT-STREAM (%NATIVE-STREAM STREAM-000) "`" TEST-VALUE-003 "' is not a valid case option")
      (CL:ERROR (NEW-STELLA-EXCEPTION (THE-STRING-READER STREAM-000))))))))
    ...
    ((SUBTYPE-OF-INTEGER? TEST-VALUE-003)
     (CL:PROGN
      (CL:LET* ((TEST-VALUE-000 (SAFE-PRIMARY-TYPE Y)))
       (CL:COND
        ((SUBTYPE-OF-INTEGER? TEST-VALUE-000)
         (CL:PROGN (CL:IF (CL:OR (CL:EQ Y NULL) (CL:>= (%WRAPPER-VALUE X) (%WRAPPER-VALUE Y))) (CL:RETURN-FROM MAX X) (CL:RETURN-FROM MAX Y))))
        ((SUBTYPE-OF-LONG-INTEGER? TEST-VALUE-000)
         (CL:PROGN (CL:IF (CL:OR (CL:EQ Y NULL) (CL:>= (%WRAPPER-VALUE X) (%WRAPPER-VALUE Y))) (CL:RETURN-FROM MAX X) (CL:RETURN-FROM MAX Y))))
        ((SUBTYPE-OF-FLOAT? TEST-VALUE-000)
         (CL:PROGN (CL:IF (CL:OR (CL:EQ Y NULL) (CL:>= (%WRAPPER-VALUE X) (%WRAPPER-VALUE Y))) (CL:RETURN-FROM MAX X) (CL:RETURN-FROM MAX Y))))
...
otherwise, return 'ch' unmodified."
  (CL:RETURN-FROM CHARACTER-DOWNCASE
   (CL:LET ((SELF *CHARACTER-DOWNCASE-TABLE*) (POSITION (CL:THE CL:FIXNUM (CL:CHAR-CODE CH)))) (CL:DECLARE (CL:TYPE CL:SIMPLE-STRING SELF) (CL:TYPE CL:FIXNUM POSITION))
...
should be used instead."
  (CL:RETURN-FROM CHARACTER-UPCASE
   (CL:LET ((SELF *CHARACTER-UPCASE-TABLE*) (POSITION (CL:THE CL:FIXNUM (CL:CHAR-CODE CH)))) (CL:DECLARE (CL:TYPE CL:SIMPLE-STRING SELF) (CL:TYPE CL:FIXNUM POSITION))
    (CL:SCHAR (CL:THE CL:SIMPLE-STRING SELF) (CL:THE CL:FIXNUM POSITION)))))
...
(CL:DECLAIM (CL:FTYPE (CL:FUNCTION (CL:SIMPLE-STRING CL:SIMPLE-STRING CL:T) CL:FIXNUM) STRING-COMPARE))
...
(CL:DEFMETHOD NON-EMPTY? ((X STRING-WRAPPER))
  ...
  (CL:RETURN-FROM NON-EMPTY? (CL:NOT (STRING-EQL? (%WRAPPER-VALUE X) ""))))
   ...
   (CL:IF (CL:EQ STRING STELLA::NULL-STRING) (CL:SETQ TEST-VALUE-000 CL:T)
    (CL:IF (STRING-EQL? STRING "") (CL:SETQ TEST-VALUE-000 CL:T)
     (CL:LET* ((ALWAYS?-000 CL:T))
      (CL:LET* ((CHAR NULL-CHARACTER) (VECTOR-000 STRING) (INDEX-000 0) (LENGTH-000 (CL:THE CL:FIXNUM (CL:LENGTH VECTOR-000))))
       ...
       (CL:LOOP WHILE (CL:< INDEX-000 LENGTH-000) DO
        (CL:SETQ CHAR
         (CL:LET ((SELF VECTOR-000) (POSITION INDEX-000)) (CL:DECLARE (CL:TYPE CL:SIMPLE-STRING SELF) (CL:TYPE CL:FIXNUM POSITION))
          (CL:SCHAR (CL:THE CL:SIMPLE-STRING SELF) (CL:THE CL:FIXNUM POSITION))))
        (CL:WHEN (CL:NOT (CL:EQ (CL:AREF *CHARACTER-TYPE-TABLE* (CL:THE CL:FIXNUM (CL:CHAR-CODE CHAR))) KWD-PRIMAL-WHITE-SPACE)) (CL:SETQ ALWAYS?-000 CL:NIL)
         (CL:RETURN))
        (CL:SETQ INDEX-000 (CL:1+ INDEX-000))))
      (CL:SETQ TEST-VALUE-000 ALWAYS?-000))))
   (CL:LET* ((VALUE-000 TEST-VALUE-000)) (CL:RETURN-FROM BLANK-STRING? VALUE-000))))
...
(CL:DECLAIM (CL:FTYPE (CL:FUNCTION (CL:SIMPLE-STRING CL:SIMPLE-STRING) CL:FIXNUM) STRING-COMPARE-CASE-NORMALIZED))
...
similar to using a Java Collator for Locale.US with strength set to TERTIARY (which see)."
  ...
  (CL:LET* ((XLENGTH (CL:THE CL:FIXNUM (CL:LENGTH X))) (YLENGTH (CL:THE CL:FIXNUM (CL:LENGTH Y))) (XCH NULL-CHARACTER) (YCH NULL-CHARACTER))
   ...
   (CL:LET* ((I NULL-INTEGER) (ITER-000 0) (UPPER-BOUND-000 (CL:1- (MIN XLENGTH YLENGTH)))) (CL:DECLARE (CL:TYPE CL:FIXNUM I ITER-000 UPPER-BOUND-000))
    (CL:LOOP WHILE (CL:<= ITER-000 UPPER-BOUND-000) DO (CL:SETQ I ITER-000)
     (CL:SETQ XCH
      (CL:LET ((SELF X) (POSITION I)) (CL:DECLARE (CL:TYPE CL:SIMPLE-STRING SELF) (CL:TYPE CL:FIXNUM POSITION))
       (CL:SCHAR (CL:THE CL:SIMPLE-STRING SELF) (CL:THE CL:FIXNUM POSITION))))
     (CL:SETQ YCH
      (CL:LET ((SELF Y) (POSITION I)) (CL:DECLARE (CL:TYPE CL:SIMPLE-STRING SELF) (CL:TYPE CL:FIXNUM POSITION))
       (CL:SCHAR (CL:THE CL:SIMPLE-STRING SELF) (CL:THE CL:FIXNUM POSITION))))
     (CL:WHEN (CL:NOT (CL:EQL XCH YCH))
      (CL:LET*
       ((XCHDOWN
         (CL:LET ((SELF *CHARACTER-DOWNCASE-TABLE*) (POSITION (CL:THE CL:FIXNUM (CL:CHAR-CODE XCH))))
          (CL:DECLARE (CL:TYPE CL:SIMPLE-STRING SELF) (CL:TYPE CL:FIXNUM POSITION)) (CL:SCHAR (CL:THE CL:SIMPLE-STRING SELF) (CL:THE CL:FIXNUM POSITION))))
        (YCHDOWN
         (CL:LET ((SELF *CHARACTER-DOWNCASE-TABLE*) (POSITION (CL:THE CL:FIXNUM (CL:CHAR-CODE YCH))))
          (CL:DECLARE (CL:TYPE CL:SIMPLE-STRING SELF) (CL:TYPE CL:FIXNUM POSITION)) (CL:SCHAR (CL:THE CL:SIMPLE-STRING SELF) (CL:THE CL:FIXNUM POSITION)))))
       (CL:IF (CL:EQL XCHDOWN YCHDOWN)
        (CL:IF (CL:< (CL:THE CL:FIXNUM (CL:CHAR-CODE XCH)) (CL:THE CL:FIXNUM (CL:CHAR-CODE YCH))) (CL:RETURN-FROM STRING-COMPARE-CASE-NORMALIZED 1)
         (CL:RETURN-FROM STRING-COMPARE-CASE-NORMALIZED -1))
        (CL:IF (CL:< (CL:THE CL:FIXNUM (CL:CHAR-CODE XCHDOWN)) (CL:THE CL:FIXNUM (CL:CHAR-CODE YCHDOWN))) (CL:RETURN-FROM STRING-COMPARE-CASE-NORMALIZED -1)
         (CL:RETURN-FROM STRING-COMPARE-CASE-NORMALIZED 1)))))
     (CL:SETQ ITER-000 (CL:1+ ITER-000))))
   (CL:COND ((CL:= XLENGTH YLENGTH) (CL:RETURN-FROM STRING-COMPARE-CASE-NORMALIZED 0)) ((CL:< XLENGTH YLENGTH) (CL:RETURN-FROM STRING-COMPARE-CASE-NORMALIZED -1))
    (CL:T (CL:RETURN-FROM STRING-COMPARE-CASE-NORMALIZED 1)))))

;;; (DEFUN (COMPARE-STRINGS INTEGER) ...)

(CL:DECLAIM (CL:FTYPE (CL:FUNCTION (CL:SIMPLE-STRING CL:SIMPLE-STRING CL:T) CL:FIXNUM) COMPARE-STRINGS))
...
`string-compare-case-normalized' (which see)."
  ...
  (CL:COND ((CL:EQ COLLATION KWD-PRIMAL-ASCII-CASE-SENSITIVE) (CL:RETURN-FROM COMPARE-STRINGS (STRING-COMPARE X Y CL:T)))
   ...
   ((CL:EQ COLLATION KWD-PRIMAL-ASCII-CASE-NORMALIZED) (CL:RETURN-FROM COMPARE-STRINGS (STRING-COMPARE-CASE-NORMALIZED X Y)))
   (CL:T
    (CL:LET* ((STREAM-000 (NEW-OUTPUT-STRING-STREAM))) (%%PRINT-STREAM (%NATIVE-STREAM STREAM-000) "compare-strings: unsupported collation: `" COLLATION "'")
     (CL:ERROR (NEW-STELLA-EXCEPTION (THE-STRING-READER STREAM-000)))))))

;;; (DEFUN (SAFE-COMPARE-STRINGS INTEGER) ...)

(CL:DECLAIM (CL:FTYPE (CL:FUNCTION (CL:SIMPLE-STRING CL:SIMPLE-STRING CL:T) CL:FIXNUM) SAFE-COMPARE-STRINGS))
...
(CL:DECLAIM (CL:FTYPE (CL:FUNCTION (CL:FIXNUM CL:T) CL:SIMPLE-STRING) MAKE-MUTABLE-STRING))
...
(CL:DECLAIM (CL:FTYPE (CL:FUNCTION (CL:FIXNUM) CL:SIMPLE-STRING) MAKE-RAW-MUTABLE-STRING))
...
less efficient variable arguments mechanism."
  ...
  (CL:LET* ((RESULT STELLA::NULL-STRING) (LENGTH (CL:+ (CL:THE CL:FIXNUM (CL:LENGTH STRING1)) (CL:THE CL:FIXNUM (CL:LENGTH STRING2)))) (INDEX 0))
   (CL:DECLARE (CL:TYPE CL:SIMPLE-STRING RESULT) (CL:TYPE CL:FIXNUM LENGTH INDEX))
   (CL:LET* ((STRING STELLA::NULL-STRING) (ITER-000 OTHERSTRINGS)) (CL:DECLARE (CL:TYPE CL:SIMPLE-STRING STRING))
    (CL:LOOP WHILE ITER-000 DO (CL:SETQ STRING (CL:POP ITER-000)) (CL:SETQ LENGTH (CL:+ LENGTH (CL:THE CL:FIXNUM (CL:LENGTH STRING))))))
   (CL:SETQ RESULT (MAKE-RAW-MUTABLE-STRING LENGTH))
   (CL:LET* ((CH NULL-CHARACTER) (VECTOR-000 STRING1) (INDEX-000 0) (LENGTH-000 (CL:THE CL:FIXNUM (CL:LENGTH VECTOR-000))))
    (CL:DECLARE (CL:TYPE CL:SIMPLE-STRING VECTOR-000) (CL:TYPE CL:FIXNUM INDEX-000 LENGTH-000))
    (CL:LOOP WHILE (CL:< INDEX-000 LENGTH-000) DO
     (CL:SETQ CH
      (CL:LET ((SELF VECTOR-000) (POSITION INDEX-000)) (CL:DECLARE (CL:TYPE CL:SIMPLE-STRING SELF) (CL:TYPE CL:FIXNUM POSITION))
       (CL:SCHAR (CL:THE CL:SIMPLE-STRING SELF) (CL:THE CL:FIXNUM POSITION))))
     (CL:LET ((SELF RESULT) (CH CH) (POSITION INDEX)) (CL:DECLARE (CL:TYPE CL:SIMPLE-STRING SELF) (CL:TYPE CL:FIXNUM POSITION))
      (SETF (CL:SCHAR (CL:THE CL:SIMPLE-STRING SELF) (CL:THE CL:FIXNUM POSITION)) (CL:THE CL:CHARACTER CH)))
     (CL:SETQ INDEX (CL:1+ INDEX)) (CL:SETQ INDEX-000 (CL:1+ INDEX-000))))
   (CL:LET* ((CH NULL-CHARACTER) (VECTOR-001 STRING2) (INDEX-001 0) (LENGTH-001 (CL:THE CL:FIXNUM (CL:LENGTH VECTOR-001))))
    (CL:DECLARE (CL:TYPE CL:SIMPLE-STRING VECTOR-001) (CL:TYPE CL:FIXNUM INDEX-001 LENGTH-001))
    (CL:LOOP WHILE (CL:< INDEX-001 LENGTH-001) DO
     (CL:SETQ CH
      (CL:LET ((SELF VECTOR-001) (POSITION INDEX-001)) (CL:DECLARE (CL:TYPE CL:SIMPLE-STRING SELF) (CL:TYPE CL:FIXNUM POSITION))
       (CL:SCHAR (CL:THE CL:SIMPLE-STRING SELF) (CL:THE CL:FIXNUM POSITION))))
     (CL:LET ((SELF RESULT) (CH CH) (POSITION INDEX)) (CL:DECLARE (CL:TYPE CL:SIMPLE-STRING SELF) (CL:TYPE CL:FIXNUM POSITION))
      (SETF (CL:SCHAR (CL:THE CL:SIMPLE-STRING SELF) (CL:THE CL:FIXNUM POSITION)) (CL:THE CL:CHARACTER CH)))
     (CL:SETQ INDEX (CL:1+ INDEX)) (CL:SETQ INDEX-001 (CL:1+ INDEX-001))))
   (CL:LET* ((STRING STELLA::NULL-STRING) (ITER-001 OTHERSTRINGS)) (CL:DECLARE (CL:TYPE CL:SIMPLE-STRING STRING))
    (CL:LOOP WHILE ITER-001 DO (CL:SETQ STRING (CL:POP ITER-001))
     (CL:LET* ((CH NULL-CHARACTER) (VECTOR-002 STRING) (INDEX-002 0) (LENGTH-002 (CL:THE CL:FIXNUM (CL:LENGTH VECTOR-002))))
      (CL:DECLARE (CL:TYPE CL:SIMPLE-STRING VECTOR-002) (CL:TYPE CL:FIXNUM INDEX-002 LENGTH-002))
      (CL:LOOP WHILE (CL:< INDEX-002 LENGTH-002) DO
       (CL:SETQ CH
        (CL:LET ((SELF VECTOR-002) (POSITION INDEX-002)) (CL:DECLARE (CL:TYPE CL:SIMPLE-STRING SELF) (CL:TYPE CL:FIXNUM POSITION))
         (CL:SCHAR (CL:THE CL:SIMPLE-STRING SELF) (CL:THE CL:FIXNUM POSITION))))
       (CL:LET ((SELF RESULT) (CH CH) (POSITION INDEX)) (CL:DECLARE (CL:TYPE CL:SIMPLE-STRING SELF) (CL:TYPE CL:FIXNUM POSITION))
        (SETF (CL:SCHAR (CL:THE CL:SIMPLE-STRING SELF) (CL:THE CL:FIXNUM POSITION)) (CL:THE CL:CHARACTER CH)))
       (CL:SETQ INDEX (CL:1+ INDEX)) (CL:SETQ INDEX-002 (CL:1+ INDEX-002))))))
   (CL:RETURN-FROM CONCATENATE (CL:LET ((S RESULT)) (CL:DECLARE (CL:TYPE CL:SIMPLE-STRING S)) (CL:THE CL:SIMPLE-STRING S)))))
  ...
  (CL:LET* ((POS NULL-INTEGER)) (CL:DECLARE (CL:TYPE CL:FIXNUM POS))
   (CL:LET* ((I NULL-INTEGER) (ITER-000 0) (UPPER-BOUND-000 (CL:1- (CL:THE CL:FIXNUM (CL:LENGTH SELF))))) (CL:DECLARE (CL:TYPE CL:FIXNUM I ITER-000 UPPER-BOUND-000))
    (CL:LOOP WHILE (CL:<= ITER-000 UPPER-BOUND-000) DO (CL:SETQ I ITER-000)
     (CL:SETQ POS
      (POSITION OLD-CHARS
       (CL:LET ((SELF SELF) (POSITION I)) (CL:DECLARE (CL:TYPE CL:SIMPLE-STRING SELF) (CL:TYPE CL:FIXNUM POSITION))
        (CL:SCHAR (CL:THE CL:SIMPLE-STRING SELF) (CL:THE CL:FIXNUM POSITION)))
       0))
     (CL:WHEN (CL:NOT (CL:= POS NULL-INTEGER))
      (CL:LET
       ((SELF SELF)
        (CH
         (CL:LET ((SELF NEW-CHARS) (POSITION POS)) (CL:DECLARE (CL:TYPE CL:SIMPLE-STRING SELF) (CL:TYPE CL:FIXNUM POSITION))
          (CL:SCHAR (CL:THE CL:SIMPLE-STRING SELF) (CL:THE CL:FIXNUM POSITION))))
        (POSITION I))
...
(CL:DECLAIM (CL:FTYPE (CL:FUNCTION (CL:SIMPLE-STRING CL:SIMPLE-STRING CL:SIMPLE-STRING) CL:SIMPLE-STRING) REPLACE-SUBSTRINGS))
(CL:DEFUN REPLACE-SUBSTRINGS (STRING NEW OLD)
  ...
  (CL:LET*
   ...
   (CL:DECLARE (CL:TYPE CL:FIXNUM STRINGLENGTH OLDLENGTH NEWLENGTH NOFOCCURRENCES OLDSTART CURSOR RESULTCURSOR) (CL:TYPE CL:SIMPLE-STRING RESULT))
   (CL:LOOP WHILE (CL:NOT (CL:= (CL:SETQ OLDSTART (STRING-SEARCH STRING OLD CURSOR)) NULL-INTEGER)) DO (CL:SETQ NOFOCCURRENCES (CL:1+ NOFOCCURRENCES))
    (CL:SETQ CURSOR (CL:+ OLDSTART OLDLENGTH)))
   (CL:WHEN (CL:= NOFOCCURRENCES 0) (CL:RETURN-FROM REPLACE-SUBSTRINGS STRING))
   (CL:SETQ RESULT (MAKE-RAW-MUTABLE-STRING (CL:+ STRINGLENGTH (CL:* NOFOCCURRENCES (CL:- NEWLENGTH OLDLENGTH))))) (CL:SETQ CURSOR 0)
   (CL:LOOP WHILE (CL:NOT (CL:= (CL:SETQ OLDSTART (STRING-SEARCH STRING OLD CURSOR)) NULL-INTEGER)) DO
    (CL:LET* ((I NULL-INTEGER) (ITER-000 CURSOR) (UPPER-BOUND-000 (CL:1- OLDSTART))) (CL:DECLARE (CL:TYPE CL:FIXNUM I ITER-000 UPPER-BOUND-000))
     (CL:LOOP WHILE (CL:<= ITER-000 UPPER-BOUND-000) DO (CL:SETQ I ITER-000)
      (CL:LET
       ((SELF RESULT)
        (CH
         (CL:LET ((SELF STRING) (POSITION I)) (CL:DECLARE (CL:TYPE CL:SIMPLE-STRING SELF) (CL:TYPE CL:FIXNUM POSITION))
          (CL:SCHAR (CL:THE CL:SIMPLE-STRING SELF) (CL:THE CL:FIXNUM POSITION))))
        (POSITION RESULTCURSOR))
       (CL:DECLARE (CL:TYPE CL:SIMPLE-STRING SELF) (CL:TYPE CL:FIXNUM POSITION))
       (SETF (CL:SCHAR (CL:THE CL:SIMPLE-STRING SELF) (CL:THE CL:FIXNUM POSITION)) (CL:THE CL:CHARACTER CH)))
      (CL:SETQ RESULTCURSOR (CL:1+ RESULTCURSOR)) (CL:SETQ ITER-000 (CL:1+ ITER-000))))
    (CL:LET* ((CHAR NULL-CHARACTER) (VECTOR-000 NEW) (INDEX-000 0) (LENGTH-000 (CL:THE CL:FIXNUM (CL:LENGTH VECTOR-000))))
     (CL:DECLARE (CL:TYPE CL:SIMPLE-STRING VECTOR-000) (CL:TYPE CL:FIXNUM INDEX-000 LENGTH-000))
     (CL:LOOP WHILE (CL:< INDEX-000 LENGTH-000) DO
      (CL:SETQ CHAR
       (CL:LET ((SELF VECTOR-000) (POSITION INDEX-000)) (CL:DECLARE (CL:TYPE CL:SIMPLE-STRING SELF) (CL:TYPE CL:FIXNUM POSITION))
        (CL:SCHAR (CL:THE CL:SIMPLE-STRING SELF) (CL:THE CL:FIXNUM POSITION))))
      (CL:LET ((SELF RESULT) (CH CHAR) (POSITION RESULTCURSOR)) (CL:DECLARE (CL:TYPE CL:SIMPLE-STRING SELF) (CL:TYPE CL:FIXNUM POSITION))
       (SETF (CL:SCHAR (CL:THE CL:SIMPLE-STRING SELF) (CL:THE CL:FIXNUM POSITION)) (CL:THE CL:CHARACTER CH)))
      (CL:SETQ RESULTCURSOR (CL:1+ RESULTCURSOR)) (CL:SETQ INDEX-000 (CL:1+ INDEX-000))))
    (CL:SETQ CURSOR (CL:+ OLDSTART OLDLENGTH)))
   (CL:LET* ((I NULL-INTEGER) (ITER-001 CURSOR) (UPPER-BOUND-001 (CL:1- STRINGLENGTH))) (CL:DECLARE (CL:TYPE CL:FIXNUM I ITER-001 UPPER-BOUND-001))
    (CL:LOOP WHILE (CL:<= ITER-001 UPPER-BOUND-001) DO (CL:SETQ I ITER-001)
     (CL:LET
      ...
      (CL:DECLARE (CL:TYPE CL:SIMPLE-STRING SELF) (CL:TYPE CL:FIXNUM POSITION))
      (SETF (CL:SCHAR (CL:THE CL:SIMPLE-STRING SELF) (CL:THE CL:FIXNUM POSITION)) (CL:THE CL:CHARACTER CH)))
     (CL:SETQ RESULTCURSOR (CL:1+ RESULTCURSOR)) (CL:SETQ ITER-001 (CL:1+ ITER-001))))
   (CL:RETURN-FROM REPLACE-SUBSTRINGS (CL:LET ((S RESULT)) (CL:DECLARE (CL:TYPE CL:SIMPLE-STRING S)) (CL:THE CL:SIMPLE-STRING S)))))

;;; (DEFUN (INSTANTIATE-STRING-TEMPLATE STRING) ...)

(CL:DECLAIM (CL:FTYPE (CL:FUNCTION (CL:SIMPLE-STRING CL:&REST CL:T) CL:SIMPLE-STRING) INSTANTIATE-STRING-TEMPLATE))
  ...
  (CL:LET* ((VAR STELLA::NULL-STRING)) (CL:DECLARE (CL:TYPE CL:SIMPLE-STRING VAR))
   (CL:LET* ((ITEM STELLA::NULL-STRING) (ITER-000 |VARS&VALUES|)) (CL:DECLARE (CL:TYPE CL:SIMPLE-STRING ITEM))
    (CL:LOOP WHILE ITER-000 DO (CL:SETQ ITEM (CL:POP ITER-000))
     (CL:COND ((CL:NOT (CL:EQ VAR STELLA::NULL-STRING)) (CL:SETQ TEMPLATE (REPLACE-SUBSTRINGS TEMPLATE ITEM VAR)) (CL:SETQ VAR STELLA::NULL-STRING))
      (CL:T (CL:SETQ VAR ITEM)))))
   (CL:RETURN-FROM INSTANTIATE-STRING-TEMPLATE TEMPLATE)))

;;; (DEFUN (INSERT-STRING INTEGER) ...)

(CL:DECLAIM (CL:FTYPE (CL:FUNCTION (CL:SIMPLE-STRING CL:FIXNUM CL:FIXNUM CL:SIMPLE-STRING CL:FIXNUM CL:T) CL:FIXNUM) INSERT-STRING))
...
The final value of target-index is returned."
  ...
  (CL:COND
   ((CL:EQ CASE-CONVERSION KWD-PRIMAL-UPCASE)
    (CL:LET* ((J NULL-INTEGER) (ITER-000 START) (UPPER-BOUND-000 END) (UNBOUNDED?-000 (CL:= UPPER-BOUND-000 NULL-INTEGER)))
     (CL:DECLARE (CL:TYPE CL:FIXNUM J ITER-000 UPPER-BOUND-000))
     (CL:LOOP WHILE (CL:OR UNBOUNDED?-000 (CL:<= ITER-000 UPPER-BOUND-000)) DO (CL:SETQ J ITER-000)
      (CL:LET
       ((SELF TARGET)
        (CH
         (CL:LET
          ((SELF *CHARACTER-UPCASE-TABLE*)
           (POSITION
            (CL:THE CL:FIXNUM
             (CL:CHAR-CODE
              (CL:LET ((SELF SOURCE) (POSITION J)) (CL:DECLARE (CL:TYPE CL:SIMPLE-STRING SELF) (CL:TYPE CL:FIXNUM POSITION))
               (CL:SCHAR (CL:THE CL:SIMPLE-STRING SELF) (CL:THE CL:FIXNUM POSITION)))))))
          (CL:DECLARE (CL:TYPE CL:SIMPLE-STRING SELF) (CL:TYPE CL:FIXNUM POSITION)) (CL:SCHAR (CL:THE CL:SIMPLE-STRING SELF) (CL:THE CL:FIXNUM POSITION))))
        (POSITION TARGET-INDEX))
       (CL:DECLARE (CL:TYPE CL:SIMPLE-STRING SELF) (CL:TYPE CL:FIXNUM POSITION))
       (SETF (CL:SCHAR (CL:THE CL:SIMPLE-STRING SELF) (CL:THE CL:FIXNUM POSITION)) (CL:THE CL:CHARACTER CH)))
      (CL:SETQ TARGET-INDEX (CL:1+ TARGET-INDEX)) (CL:SETQ ITER-000 (CL:1+ ITER-000)))))
   ((CL:EQ CASE-CONVERSION KWD-PRIMAL-DOWNCASE)
    (CL:LET* ((J NULL-INTEGER) (ITER-001 START) (UPPER-BOUND-001 END) (UNBOUNDED?-001 (CL:= UPPER-BOUND-001 NULL-INTEGER)))
     (CL:DECLARE (CL:TYPE CL:FIXNUM J ITER-001 UPPER-BOUND-001))
     (CL:LOOP WHILE (CL:OR UNBOUNDED?-001 (CL:<= ITER-001 UPPER-BOUND-001)) DO (CL:SETQ J ITER-001)
      (CL:LET
       ((SELF TARGET)
        (CH
         (CL:LET
       ...
       (CL:DECLARE (CL:TYPE CL:SIMPLE-STRING SELF) (CL:TYPE CL:FIXNUM POSITION))
       (SETF (CL:SCHAR (CL:THE CL:SIMPLE-STRING SELF) (CL:THE CL:FIXNUM POSITION)) (CL:THE CL:CHARACTER CH)))
      (CL:SETQ TARGET-INDEX (CL:1+ TARGET-INDEX)) (CL:SETQ ITER-001 (CL:1+ ITER-001)))))
   ((CL:EQ CASE-CONVERSION KWD-PRIMAL-CAPITALIZE)
       ...
       (CL:LET
        ((SELF *CHARACTER-UPCASE-TABLE*)
         (POSITION
          (CL:THE CL:FIXNUM
           (CL:CHAR-CODE
            (CL:LET ((SELF SOURCE) (POSITION START)) (CL:DECLARE (CL:TYPE CL:SIMPLE-STRING SELF) (CL:TYPE CL:FIXNUM POSITION))
             (CL:SCHAR (CL:THE CL:SIMPLE-STRING SELF) (CL:THE CL:FIXNUM POSITION)))))))
        (CL:DECLARE (CL:TYPE CL:SIMPLE-STRING SELF) (CL:TYPE CL:FIXNUM POSITION)) (CL:SCHAR (CL:THE CL:SIMPLE-STRING SELF) (CL:THE CL:FIXNUM POSITION))))
      (POSITION TARGET-INDEX))
     (CL:DECLARE (CL:TYPE CL:SIMPLE-STRING SELF) (CL:TYPE CL:FIXNUM POSITION))
    ...
    (CL:LET* ((J NULL-INTEGER) (ITER-002 (CL:1+ START)) (UPPER-BOUND-002 END) (UNBOUNDED?-002 (CL:= UPPER-BOUND-002 NULL-INTEGER)))
     (CL:DECLARE (CL:TYPE CL:FIXNUM J ITER-002 UPPER-BOUND-002))
     (CL:LOOP WHILE (CL:OR UNBOUNDED?-002 (CL:<= ITER-002 UPPER-BOUND-002)) DO (CL:SETQ J ITER-002)
      (CL:LET
       ((SELF TARGET)
        (CH
         (CL:LET
       ...
       (CL:DECLARE (CL:TYPE CL:SIMPLE-STRING SELF) (CL:TYPE CL:FIXNUM POSITION))
       (SETF (CL:SCHAR (CL:THE CL:SIMPLE-STRING SELF) (CL:THE CL:FIXNUM POSITION)) (CL:THE CL:CHARACTER CH)))
      (CL:SETQ TARGET-INDEX (CL:1+ TARGET-INDEX)) (CL:SETQ ITER-002 (CL:1+ ITER-002)))))
   ((CL:EQ CASE-CONVERSION KWD-PRIMAL-PRESERVE)
    (CL:LET* ((J NULL-INTEGER) (ITER-003 START) (UPPER-BOUND-003 END) (UNBOUNDED?-003 (CL:= UPPER-BOUND-003 NULL-INTEGER)))
     (CL:DECLARE (CL:TYPE CL:FIXNUM J ITER-003 UPPER-BOUND-003))
     (CL:LOOP WHILE (CL:OR UNBOUNDED?-003 (CL:<= ITER-003 UPPER-BOUND-003)) DO (CL:SETQ J ITER-003)
      (CL:LET
       ((SELF TARGET)
        (CH
         (CL:LET ((SELF SOURCE) (POSITION J)) (CL:DECLARE (CL:TYPE CL:SIMPLE-STRING SELF) (CL:TYPE CL:FIXNUM POSITION))
       ...
       (CL:DECLARE (CL:TYPE CL:SIMPLE-STRING SELF) (CL:TYPE CL:FIXNUM POSITION))
       (SETF (CL:SCHAR (CL:THE CL:SIMPLE-STRING SELF) (CL:THE CL:FIXNUM POSITION)) (CL:THE CL:CHARACTER CH)))
      (CL:SETQ TARGET-INDEX (CL:1+ TARGET-INDEX)) (CL:SETQ ITER-003 (CL:1+ ITER-003)))))
   (CL:T
    (CL:LET* ((STREAM-000 (NEW-OUTPUT-STRING-STREAM))) (%%PRINT-STREAM (%NATIVE-STREAM STREAM-000) "`" CASE-CONVERSION "' is not a valid case option")
     (CL:ERROR (NEW-STELLA-EXCEPTION (THE-STRING-READER STREAM-000))))))
  (CL:RETURN-FROM INSERT-STRING TARGET-INDEX))

;;; (DEFUN (STRING-TRIM STRING) ...)

(CL:DECLAIM (CL:FTYPE (CL:FUNCTION (CL:SIMPLE-STRING) CL:SIMPLE-STRING) STRING-TRIM))
    ...
    (CL:AND (CL:<= START END)
     (CL:EQ
      (CL:AREF *CHARACTER-TYPE-TABLE*
       (CL:THE CL:FIXNUM
        (CL:CHAR-CODE
         (CL:LET ((SELF STRING) (POSITION START)) (CL:DECLARE (CL:TYPE CL:SIMPLE-STRING SELF) (CL:TYPE CL:FIXNUM POSITION))
          (CL:SCHAR (CL:THE CL:SIMPLE-STRING SELF) (CL:THE CL:FIXNUM POSITION))))))
    ...
    (CL:AND (CL:> END START)
     (CL:EQ
      (CL:AREF *CHARACTER-TYPE-TABLE*
       (CL:THE CL:FIXNUM
        (CL:CHAR-CODE
         (CL:LET ((SELF STRING) (POSITION END)) (CL:DECLARE (CL:TYPE CL:SIMPLE-STRING SELF) (CL:TYPE CL:FIXNUM POSITION))
          (CL:SCHAR (CL:THE CL:SIMPLE-STRING SELF) (CL:THE CL:FIXNUM POSITION))))))
      KWD-PRIMAL-WHITE-SPACE))
    DO (CL:SETQ END (CL:1- END)))
   (CL:IF (CL:OR (CL:> START 0) (CL:< END LAST)) (CL:RETURN-FROM STRING-TRIM (SUBSEQUENCE STRING START (CL:1+ END))) (CL:RETURN-FROM STRING-TRIM STRING))))

;;; (DEFUN (INT-TO-STRING STRING) ...)

(CL:DECLAIM (CL:FTYPE (CL:FUNCTION (CL:FIXNUM) CL:SIMPLE-STRING) INT-TO-STRING))
...
(CL:DECLAIM (CL:FTYPE (CL:FUNCTION (CL:T) CL:SIMPLE-STRING) CHARACTER-TO-STRING))
...
(CL:DECLAIM (CL:FTYPE (CL:FUNCTION (CL:T CL:FIXNUM) CL:SIMPLE-STRING) STELLA-INTEGER-TO-STRING-IN-BASE))
...
the C++ version we have but slower than the native Java version."
  ...
  (CL:LET* ((OFFSET (CL:IF (CL:< INTEGER 0) 1 0))) (CL:DECLARE (CL:TYPE CL:FIXNUM OFFSET)) (CL:WHEN (CL:= OFFSET 1) (CL:SETQ INTEGER (CL:- 0 INTEGER)))
   (CL:LET*
    ((INTEGERBITS (INTEGER-LENGTH INTEGER)) (BASEBITS (INTEGER-LENGTH (CL:TRUNCATE BASE)))
     (BUFFERLENGTH (CL:+ OFFSET (CL:LET ((X INTEGERBITS) (Y (CL:1- BASEBITS))) (CL:DECLARE (CL:TYPE CL:FIXNUM X Y)) (CL:THE CL:FIXNUM (CL:VALUES (CL:TRUNCATE X Y)))) 1))
     (BUFFER (MAKE-RAW-MUTABLE-STRING BUFFERLENGTH)) (INDEX BUFFERLENGTH) (TABLE "0123456789ABCDEFGHIJKLMNOPQRSTUVWXYZ") (REMAINDER 0) (DIGIT 0) (BASE-1 (CL:1- BASE)))
    (CL:DECLARE (CL:TYPE CL:FIXNUM INTEGERBITS BASEBITS BUFFERLENGTH INDEX DIGIT BASE-1) (CL:TYPE CL:SIMPLE-STRING BUFFER TABLE))
    (CL:COND
     ((CL:= (CL:THE CL:FIXNUM (CL:LOGAND BASE BASE-1)) 0) (CL:SETQ BASEBITS (CL:1- BASEBITS))
      (CL:LOOP WHILE (CL:> INTEGER 0) DO (CL:SETQ INDEX (CL:1- INDEX)) (CL:SETQ DIGIT (CL:TRUNCATE (CL:LOGAND INTEGER (CL:TRUNCATE BASE-1))))
       (CL:SETQ INTEGER (CL:LET ((ARG INTEGER) (COUNT BASEBITS)) (CL:DECLARE (CL:TYPE CL:FIXNUM COUNT)) (CL:ASH ARG (CL:THE CL:FIXNUM (CL:- COUNT)))))
       (CL:LET
        ((SELF BUFFER)
         (CH
          (CL:LET ((SELF TABLE) (POSITION DIGIT)) (CL:DECLARE (CL:TYPE CL:SIMPLE-STRING SELF) (CL:TYPE CL:FIXNUM POSITION))
           (CL:SCHAR (CL:THE CL:SIMPLE-STRING SELF) (CL:THE CL:FIXNUM POSITION))))
         (POSITION INDEX))
        (CL:DECLARE (CL:TYPE CL:SIMPLE-STRING SELF) (CL:TYPE CL:FIXNUM POSITION))
        (SETF (CL:SCHAR (CL:THE CL:SIMPLE-STRING SELF) (CL:THE CL:FIXNUM POSITION)) (CL:THE CL:CHARACTER CH)))))
     (CL:T
      (CL:LOOP WHILE (CL:> INTEGER 0) DO (CL:SETQ INDEX (CL:1- INDEX)) (CL:SETQ REMAINDER (CL:LET ((X INTEGER) (Y (CL:TRUNCATE BASE))) (CL:VALUES (CL:TRUNCATE X Y))))
       (CL:SETQ DIGIT (CL:TRUNCATE (CL:- INTEGER (CL:* REMAINDER BASE)))) (CL:SETQ INTEGER REMAINDER)
       (CL:LET
        ((SELF BUFFER)
         (CH
          (CL:LET ((SELF TABLE) (POSITION DIGIT)) (CL:DECLARE (CL:TYPE CL:SIMPLE-STRING SELF) (CL:TYPE CL:FIXNUM POSITION))
    ...
    (CL:WHEN (CL:= OFFSET 1) (CL:SETQ INDEX (CL:1- INDEX))
     (CL:LET ((SELF BUFFER) (CH #\-) (POSITION INDEX)) (CL:DECLARE (CL:TYPE CL:SIMPLE-STRING SELF) (CL:TYPE CL:FIXNUM POSITION))
      (SETF (CL:SCHAR (CL:THE CL:SIMPLE-STRING SELF) (CL:THE CL:FIXNUM POSITION)) (CL:THE CL:CHARACTER CH))))
    (CL:IF (CL:= INDEX 0) (CL:RETURN-FROM STELLA-INTEGER-TO-STRING-IN-BASE BUFFER)
     (CL:RETURN-FROM STELLA-INTEGER-TO-STRING-IN-BASE (SUBSEQUENCE BUFFER INDEX BUFFERLENGTH))))))

;;; (DEFUN (STRING-TO-INT INTEGER) ...)

(CL:DECLAIM (CL:FTYPE (CL:FUNCTION (CL:SIMPLE-STRING) CL:FIXNUM) STRING-TO-INT))
...
(CL:DECLAIM (CL:FTYPE (CL:FUNCTION (CL:SIMPLE-STRING CL:FIXNUM CL:T CL:T CL:T) CL:SIMPLE-STRING) FORMAT-WITH-PADDING))
...
the truncation direction."
  ...
  (CL:LET* ((LEN (CL:THE CL:FIXNUM (CL:LENGTH INPUT)))) (CL:DECLARE (CL:TYPE CL:FIXNUM LEN))
   (CL:COND ((CL:= LEN LENGTH) (CL:RETURN-FROM FORMAT-WITH-PADDING INPUT))
    ((CL:> LEN LENGTH)
     (CL:IF TRUNCATE?
      (CL:COND ((CL:EQ ALIGN KWD-PRIMAL-LEFT) (CL:RETURN-FROM FORMAT-WITH-PADDING (SUBSEQUENCE INPUT (CL:- LEN LENGTH) LEN)))
       ((CL:EQ ALIGN KWD-PRIMAL-RIGHT) (CL:RETURN-FROM FORMAT-WITH-PADDING (SUBSEQUENCE INPUT 0 (CL:- LEN LENGTH))))
       ((CL:EQ ALIGN KWD-PRIMAL-CENTER)
        (CL:LET* ((LEFT (CL:TRUNCATE (CL:/ (CL:- LEN LENGTH) 2.0d0)))) (CL:DECLARE (CL:TYPE CL:FIXNUM LEFT))
         (CL:RETURN-FROM FORMAT-WITH-PADDING (SUBSEQUENCE INPUT LEFT (CL:+ LEFT LENGTH)))))
       (CL:T
        (CL:LET* ((STREAM-000 (NEW-OUTPUT-STRING-STREAM))) (%%PRINT-STREAM (%NATIVE-STREAM STREAM-000) "`" ALIGN "' is not a valid case option")
         (CL:ERROR (NEW-STELLA-EXCEPTION (THE-STRING-READER STREAM-000))))))
      (CL:RETURN-FROM FORMAT-WITH-PADDING INPUT)))
    (CL:T
     (CL:COND ((CL:EQ ALIGN KWD-PRIMAL-LEFT) (CL:RETURN-FROM FORMAT-WITH-PADDING (CONCATENATE INPUT (MAKE-STRING (CL:- LENGTH LEN) PADCHAR))))
      ((CL:EQ ALIGN KWD-PRIMAL-RIGHT) (CL:RETURN-FROM FORMAT-WITH-PADDING (CONCATENATE (MAKE-STRING (CL:- LENGTH LEN) PADCHAR) INPUT)))
      ((CL:EQ ALIGN KWD-PRIMAL-CENTER)
       (CL:LET* ((LEFT (CL:TRUNCATE (CL:/ (CL:- LENGTH LEN) 2.0d0)))) (CL:DECLARE (CL:TYPE CL:FIXNUM LEFT))
        (CL:RETURN-FROM FORMAT-WITH-PADDING (CONCATENATE (MAKE-STRING LEFT PADCHAR) INPUT (MAKE-STRING (CL:- LENGTH LEN LEFT) PADCHAR)))))
      (CL:T
       (CL:LET* ((STREAM-001 (NEW-OUTPUT-STRING-STREAM))) (%%PRINT-STREAM (%NATIVE-STREAM STREAM-001) "`" ALIGN "' is not a valid case option")
        (CL:ERROR (NEW-STELLA-EXCEPTION (THE-STRING-READER STREAM-001))))))))))

;;; (DEFUN (ZERO-PAD-INTEGER STRING) ...)

(CL:DECLAIM (CL:FTYPE (CL:FUNCTION (CL:FIXNUM CL:FIXNUM) CL:SIMPLE-STRING) ZERO-PAD-INTEGER))
...
(CL:DECLAIM (CL:FTYPE (CL:FUNCTION (CL:SIMPLE-STRING CL:SIMPLE-STRING CL:FIXNUM) CL:FIXNUM) STRING-SEARCH-IGNORE-CASE))
...
`start' (which defaults to 0 if it is supplied as NULL)."
  ...
  (CL:LET* ((PREFIXLENGTH (CL:THE CL:FIXNUM (CL:LENGTH PREFIX)))) (CL:DECLARE (CL:TYPE CL:FIXNUM PREFIXLENGTH))
   (CL:IF (CL:> (CL:+ START PREFIXLENGTH) (CL:THE CL:FIXNUM (CL:LENGTH STRING))) (CL:RETURN-FROM STARTS-WITH? CL:NIL)
    (CL:LET* ((ALWAYS?-000 CL:T))
     (CL:LET* ((I NULL-INTEGER) (ITER-000 0) (UPPER-BOUND-000 (CL:1- PREFIXLENGTH)) (J NULL-INTEGER) (ITER-001 START))
      (CL:DECLARE (CL:TYPE CL:FIXNUM I ITER-000 UPPER-BOUND-000 J ITER-001))
      (CL:LOOP WHILE (CL:<= ITER-000 UPPER-BOUND-000) DO (CL:SETQ I ITER-000) (CL:SETQ J ITER-001)
       (CL:WHEN
        (CL:NOT
         (CL:EQL
          (CL:LET ((SELF PREFIX) (POSITION I)) (CL:DECLARE (CL:TYPE CL:SIMPLE-STRING SELF) (CL:TYPE CL:FIXNUM POSITION))
           (CL:SCHAR (CL:THE CL:SIMPLE-STRING SELF) (CL:THE CL:FIXNUM POSITION)))
          (CL:LET ((SELF STRING) (POSITION J)) (CL:DECLARE (CL:TYPE CL:SIMPLE-STRING SELF) (CL:TYPE CL:FIXNUM POSITION))
           (CL:SCHAR (CL:THE CL:SIMPLE-STRING SELF) (CL:THE CL:FIXNUM POSITION)))))
        (CL:SETQ ALWAYS?-000 CL:NIL) (CL:RETURN))
       (CL:SETQ ITER-000 (CL:1+ ITER-000)) (CL:SETQ ITER-001 (CL:1+ ITER-001))))
     (CL:LET* ((VALUE-000 ALWAYS?-000)) (CL:RETURN-FROM STARTS-WITH? VALUE-000))))))
...
ends with `suffix'.  If `end' is NULL it defaults to the length of `string'."
  ...
  (CL:LET* ((SUFFIXLENGTH (CL:THE CL:FIXNUM (CL:LENGTH SUFFIX))) (START (CL:- END SUFFIXLENGTH))) (CL:DECLARE (CL:TYPE CL:FIXNUM SUFFIXLENGTH START))
   (CL:IF (CL:< START 0) (CL:RETURN-FROM ENDS-WITH? CL:NIL)
    (CL:LET* ((ALWAYS?-000 CL:T))
     (CL:LET* ((I NULL-INTEGER) (ITER-000 0) (UPPER-BOUND-000 (CL:1- SUFFIXLENGTH)) (J NULL-INTEGER) (ITER-001 START))
      (CL:DECLARE (CL:TYPE CL:FIXNUM I ITER-000 UPPER-BOUND-000 J ITER-001))
      (CL:LOOP WHILE (CL:<= ITER-000 UPPER-BOUND-000) DO (CL:SETQ I ITER-000) (CL:SETQ J ITER-001)
       (CL:WHEN
        (CL:NOT
         (CL:EQL
          (CL:LET ((SELF SUFFIX) (POSITION I)) (CL:DECLARE (CL:TYPE CL:SIMPLE-STRING SELF) (CL:TYPE CL:FIXNUM POSITION))
           (CL:SCHAR (CL:THE CL:SIMPLE-STRING SELF) (CL:THE CL:FIXNUM POSITION)))
          (CL:LET ((SELF STRING) (POSITION J)) (CL:DECLARE (CL:TYPE CL:SIMPLE-STRING SELF) (CL:TYPE CL:FIXNUM POSITION))
           (CL:SCHAR (CL:THE CL:SIMPLE-STRING SELF) (CL:THE CL:FIXNUM POSITION)))))
        (CL:SETQ ALWAYS?-000 CL:NIL) (CL:RETURN))
       (CL:SETQ ITER-000 (CL:1+ ITER-000)) (CL:SETQ ITER-001 (CL:1+ ITER-001))))
     (CL:LET* ((VALUE-000 ALWAYS?-000)) (CL:RETURN-FROM ENDS-WITH? VALUE-000))))))

;;; (DEFUN (HELP-FIND-MATCHING-PREFIX-LENGTH INTEGER) ...)

(CL:DECLAIM (CL:FTYPE (CL:FUNCTION (CL:SIMPLE-STRING CL:FIXNUM CL:FIXNUM CL:SIMPLE-STRING CL:FIXNUM CL:FIXNUM) CL:FIXNUM) HELP-FIND-MATCHING-PREFIX-LENGTH))
  ...
  (CL:LET* ((I1 START1) (I2 START2)) (CL:DECLARE (CL:TYPE CL:FIXNUM I1 I2))
   (CL:LOOP WHILE
    (CL:AND (CL:< I1 END1) (CL:< I2 END2)
     (CL:EQL
      (CL:LET ((SELF STRING1) (POSITION I1)) (CL:DECLARE (CL:TYPE CL:SIMPLE-STRING SELF) (CL:TYPE CL:FIXNUM POSITION))
       (CL:SCHAR (CL:THE CL:SIMPLE-STRING SELF) (CL:THE CL:FIXNUM POSITION)))
      (CL:LET ((SELF STRING2) (POSITION I2)) (CL:DECLARE (CL:TYPE CL:SIMPLE-STRING SELF) (CL:TYPE CL:FIXNUM POSITION))
       (CL:SCHAR (CL:THE CL:SIMPLE-STRING SELF) (CL:THE CL:FIXNUM POSITION)))))
...
(CL:DECLAIM (CL:FTYPE (CL:FUNCTION (CL:SIMPLE-STRING CL:FIXNUM CL:FIXNUM CL:SIMPLE-STRING CL:FIXNUM CL:FIXNUM) CL:FIXNUM) FIND-MATCHING-PREFIX-LENGTH))
...
strings."
  ...
  (CL:RETURN-FROM FIND-MATCHING-PREFIX-LENGTH (HELP-FIND-MATCHING-PREFIX-LENGTH STRING1 START1 END1 STRING2 START2 END2)))

;;; (DEFUN (FIND-MISMATCH INTEGER INTEGER) ...)

(CL:DECLAIM (CL:FTYPE (CL:FUNCTION (CL:SIMPLE-STRING CL:FIXNUM CL:FIXNUM CL:SIMPLE-STRING CL:FIXNUM CL:FIXNUM) (CL:VALUES CL:FIXNUM CL:FIXNUM)) FIND-MISMATCH))
...
strings.  If there is no mismatch, then `null' values are returned."
  ...
  (CL:WHEN (CL:= END1 NULL-INTEGER) (CL:SETQ END1 (CL:THE CL:FIXNUM (CL:LENGTH STRING1))))
  (CL:WHEN (CL:= END2 NULL-INTEGER) (CL:SETQ END2 (CL:THE CL:FIXNUM (CL:LENGTH STRING2))))
  (CL:LET* ((LEN (HELP-FIND-MATCHING-PREFIX-LENGTH STRING1 START1 END1 STRING2 START2 END2))) (CL:DECLARE (CL:TYPE CL:FIXNUM LEN)) (CL:SETQ START1 (CL:+ START1 LEN))
   (CL:SETQ START2 (CL:+ START2 LEN))
   (CL:IF (CL:AND (CL:= START1 END1) (CL:= START2 END2)) (CL:RETURN-FROM FIND-MISMATCH (CL:VALUES NULL-INTEGER NULL-INTEGER))
    (CL:RETURN-FROM FIND-MISMATCH (CL:VALUES START1 START2)))))

;;; (DEFUN (NON-MATCHING-POSITION-HELPER INTEGER) ...)

(CL:DECLAIM (CL:FTYPE (CL:FUNCTION (CL:SIMPLE-STRING CL:FIXNUM CL:FIXNUM CL:SIMPLE-STRING) CL:FIXNUM) NON-MATCHING-POSITION-HELPER))
...
(CL:DECLAIM (CL:FTYPE (CL:FUNCTION (CL:SIMPLE-STRING CL:FIXNUM CL:SIMPLE-STRING) CL:FIXNUM) NON-MATCHING-POSITION))
...
(CL:DECLAIM (CL:FTYPE (CL:FUNCTION (CL:SIMPLE-STRING CL:FIXNUM CL:FIXNUM) CL:FIXNUM) HELP-ADVANCE-PAST-WHITESPACE))
...
(CL:DECLAIM (CL:FTYPE (CL:FUNCTION (CL:SIMPLE-STRING CL:FIXNUM) CL:FIXNUM) ADVANCE-PAST-WHITESPACE))
...
trailing whitespace is also not considered."
  ...
  (CL:LET* ((LEN1 (CL:THE CL:FIXNUM (CL:LENGTH S1))) (LEN2 (CL:THE CL:FIXNUM (CL:LENGTH S2))) (I1 0) (I2 0)) (CL:DECLARE (CL:TYPE CL:FIXNUM LEN1 LEN2 I1 I2))
    ...
    (CL:COND
     ((CL:EQ
       (CL:AREF *CHARACTER-TYPE-TABLE*
        (CL:THE CL:FIXNUM
         (CL:CHAR-CODE
          (CL:LET ((SELF S1) (POSITION I1)) (CL:DECLARE (CL:TYPE CL:SIMPLE-STRING SELF) (CL:TYPE CL:FIXNUM POSITION))
           (CL:SCHAR (CL:THE CL:SIMPLE-STRING SELF) (CL:THE CL:FIXNUM POSITION))))))
       KWD-PRIMAL-WHITE-SPACE)
      (CL:IF
       (CL:EQ
        (CL:AREF *CHARACTER-TYPE-TABLE*
         (CL:THE CL:FIXNUM
          (CL:CHAR-CODE
           (CL:LET ((SELF S2) (POSITION I2)) (CL:DECLARE (CL:TYPE CL:SIMPLE-STRING SELF) (CL:TYPE CL:FIXNUM POSITION))
            (CL:SCHAR (CL:THE CL:SIMPLE-STRING SELF) (CL:THE CL:FIXNUM POSITION))))))
        KWD-PRIMAL-WHITE-SPACE)
       (CL:PROGN
        (CL:LOOP WHILE
   ...
   (CL:LOOP WHILE
    (CL:AND (CL:< I2 LEN2)
     (CL:EQ
      ...
      KWD-PRIMAL-WHITE-SPACE))
    DO (CL:SETQ I2 (CL:1+ I2)))
   (CL:RETURN-FROM EQL-EXCEPT-IN-WHITESPACE? (CL:AND (CL:= I1 LEN1) (CL:= I2 LEN2)))))
...
(CL:DEFUN SPLIT-STRING (INPUT SEPARATOR)
  ...
  (CL:LET* ((LENGTH (CL:THE CL:FIXNUM (CL:LENGTH INPUT))) (START 0) (END 0) (STRINGS NIL)) (CL:DECLARE (CL:TYPE CL:FIXNUM LENGTH START END))
   (CL:LOOP (CL:SETQ END (POSITION INPUT SEPARATOR START)) (CL:SETQ STRINGS (CONS (WRAP-STRING (SUBSEQUENCE INPUT START END)) STRINGS))
    (CL:IF (CL:AND (CL:NOT (CL:= END NULL-INTEGER)) (CL:< END (CL:1- LENGTH))) (CL:SETQ START (CL:1+ END)) (CL:RETURN)))
...
(CL:DEFMETHOD FREE-HASH-TABLE-VALUES ((SELF ABSTRACT-HASH-TABLE))
  ...
  (CL:WHEN *USE-STELLA-HASH-TABLES?* (CL:RETURN-FROM FREE-HASH-TABLE-VALUES))
  (CL:LET* ((NATIVE-TABLE (%THE-HASH-TABLE SELF))) (CL:maphash #'(CL:lambda (key value)
...
(CL:DEFMETHOD INITIALIZE-HASH-TABLE ((SELF ABSTRACT-HASH-TABLE))
  ...
  (CL:WHEN *USE-STELLA-HASH-TABLES?* (CL:SETF (%THE-STELLA-HASH-TABLE SELF) (NEW-STELLA-HASH-TABLE)) (CL:RETURN-FROM INITIALIZE-HASH-TABLE))
...
(CL:DEFMETHOD LOOKUP ((SELF HASH-TABLE) KEY)
  (CL:WHEN *USE-STELLA-HASH-TABLES?* (CL:RETURN-FROM LOOKUP (STELLA-HASH-TABLE-LOOKUP (%THE-STELLA-HASH-TABLE SELF) KEY)))
...
(CL:DEFMETHOD INSERT-AT ((SELF HASH-TABLE) KEY VALUE)
  (CL:WHEN *USE-STELLA-HASH-TABLES?* (STELLA-HASH-TABLE-INSERT-AT (%THE-STELLA-HASH-TABLE SELF) KEY VALUE) (CL:RETURN-FROM INSERT-AT))
...
(CL:DEFMETHOD REMOVE-AT ((SELF HASH-TABLE) KEY)
  (CL:WHEN *USE-STELLA-HASH-TABLES?* (STELLA-HASH-TABLE-REMOVE-AT (%THE-STELLA-HASH-TABLE SELF) KEY) (CL:RETURN-FROM REMOVE-AT))
...
(CL:DEFMETHOD LOOKUP ((SELF STRING-TO-INTEGER-HASH-TABLE) KEY)
  ...
  (CL:LET* ((NATIVE-TABLE (%THE-HASH-TABLE SELF)) (RESULT NULL-INTEGER)) (CL:DECLARE (CL:TYPE CL:FIXNUM RESULT))
   (CL:SETQ RESULT (CL:OR (CL:GETHASH KEY NATIVE-TABLE) NULL-INTEGER)) (CL:RETURN-FROM LOOKUP RESULT)))
...
(CL:DECLAIM (CL:FTYPE (CL:FUNCTION (CL:FIXNUM CL:FIXNUM) CL:FIXNUM) HASHMOD))
...
(CL:DECLAIM (CL:FTYPE (CL:FUNCTION (CL:FIXNUM) CL:FIXNUM) ROTATE-HASH-CODE))
...
code should take the sequential order of elements into account (e.g., lists)."
  ...
  (CL:RETURN-FROM ROTATE-HASH-CODE
   (CL:IF (CL:= (CL:THE CL:FIXNUM (CL:LOGAND ARG 1)) 0)
    (CL:LET ((ARG ARG)) (CL:DECLARE (CL:TYPE CL:FIXNUM ARG)) (CL:THE CL:FIXNUM (CL:LOGAND (CL:THE CL:FIXNUM (CL:ASH ARG -1)) *INTEGER-UNSIGNED-BITS-MASK*)))
    (CL:THE CL:FIXNUM
     (CL:LOGIOR
      (CL:THE CL:FIXNUM (CL:LET ((ARG ARG) (COUNT 1)) (CL:DECLARE (CL:TYPE CL:FIXNUM ARG COUNT)) (CL:THE CL:FIXNUM (CL:ASH ARG (CL:THE CL:FIXNUM (CL:- COUNT))))))
      *INTEGER-MSB-MASK*)))))
...
do not necessarily generate different hash codes."
  (CL:RETURN-FROM HASH-CODE (CL:LET ((SELF SELF)) (CL:THE CL:FIXNUM (STELLA::%%OBJECT-HASH-CODE SELF)))))
...
- which see, but also works for NULL."
  (CL:IF (CL:EQ SELF NULL) (CL:RETURN-FROM SAFE-HASH-CODE 63842277) (CL:RETURN-FROM SAFE-HASH-CODE (HASH-CODE SELF))))
...
(CL:DEFMETHOD HASH-CODE ((SELF WRAPPER))
  (CL:LET* ((STREAM-000 (NEW-OUTPUT-STRING-STREAM))) (%%PRINT-STREAM (%NATIVE-STREAM STREAM-000) "WRAPPER.hash-code: Don't know how to hash on `" SELF "'")
   (CL:ERROR (NEW-STELLA-EXCEPTION (THE-STRING-READER STREAM-000)))))

;;; (DEFMETHOD (HASH-CODE INTEGER) ...)

(CL:DEFMETHOD HASH-CODE ((SELF STRING-WRAPPER))
  (CL:RETURN-FROM HASH-CODE (CL:THE CL:FIXNUM (CL:SXHASH (CL:THE CL:SIMPLE-STRING (%WRAPPER-VALUE SELF))))))
   ...
   (CL:TRUNCATE
    (CL:LOGAND
     (CL:LOGXOR (%WRAPPER-VALUE SELF)
      (CL:LET ((ARG (%WRAPPER-VALUE SELF)) (COUNT 32)) (CL:DECLARE (CL:TYPE CL:FIXNUM COUNT)) (CL:ASH ARG (CL:THE CL:FIXNUM (CL:- COUNT)))))
     (CL:TRUNCATE MOST-POSITIVE-INTEGER)))))

;;; (DEFMETHOD (HASH-CODE INTEGER) ...)

(CL:DEFMETHOD HASH-CODE ((SELF FLOAT-WRAPPER))
  (CL:RETURN-FROM HASH-CODE (CL:THE CL:FIXNUM (CL:SXHASH (CL:THE CL:DOUBLE-FLOAT (%WRAPPER-VALUE SELF))))))

;;; (DEFMETHOD (HASH-CODE INTEGER) ...)

(CL:DEFMETHOD HASH-CODE ((SELF CHARACTER-WRAPPER))
  (CL:RETURN-FROM HASH-CODE
   (CL:THE CL:FIXNUM (CL:LOGXOR (CL:THE CL:FIXNUM (CL:AREF *HASH-BYTE-RANDOM-TABLE* (CL:THE CL:FIXNUM (CL:CHAR-CODE (%WRAPPER-VALUE SELF))))) 15119378))))

;;; (DEFMETHOD (HASH-CODE INTEGER) ...)

(CL:DEFMETHOD HASH-CODE ((SELF BOOLEAN-WRAPPER))
  (CL:RETURN-FROM HASH-CODE (CL:IF (%WRAPPER-VALUE SELF) 7333705 1891526)))
...
(%%DEFINTEGERMETHOD HASH-CODE ((SELF CL:INTEGER))
  (CL:RETURN-FROM HASH-CODE
   (CL:TRUNCATE
    (CL:LOGAND (CL:LOGXOR SELF (CL:LET ((ARG SELF) (COUNT 32)) (CL:DECLARE (CL:TYPE CL:FIXNUM COUNT)) (CL:ASH ARG (CL:THE CL:FIXNUM (CL:- COUNT)))))
     (CL:TRUNCATE MOST-POSITIVE-INTEGER)))))
...
(CL:DEFMETHOD HASH-CODE ((SELF CL:CHARACTER))
  (CL:RETURN-FROM HASH-CODE (CL:THE CL:FIXNUM (CL:LOGXOR (CL:THE CL:FIXNUM (CL:AREF *HASH-BYTE-RANDOM-TABLE* (CL:THE CL:FIXNUM (CL:CHAR-CODE SELF)))) 15119378))))
...
(CL:DECLAIM (CL:FTYPE (CL:FUNCTION (CL:T) CL:FIXNUM) SAFE-EQUAL-HASH-CODE))
...
handle NULL components should use this function for recursive calls."
  (CL:IF (CL:EQ SELF NULL) (CL:RETURN-FROM SAFE-EQUAL-HASH-CODE 16569644) (CL:RETURN-FROM SAFE-EQUAL-HASH-CODE (EQUAL-HASH-CODE SELF))))

;;; (DEFUN (HASH-STRING INTEGER) ...)

(CL:DECLAIM (CL:FTYPE (CL:FUNCTION (CL:SIMPLE-STRING CL:FIXNUM) CL:FIXNUM) HASH-STRING))
      ...
      (CL:LOGXOR CODE
       (CL:THE CL:FIXNUM
        (CL:AREF *HASH-BYTE-RANDOM-TABLE*
         (CL:THE CL:FIXNUM
          (CL:CHAR-CODE
           (CL:LET ((SELF STRING) (POSITION CURSOR)) (CL:DECLARE (CL:TYPE CL:SIMPLE-STRING SELF) (CL:TYPE CL:FIXNUM POSITION))
            (CL:SCHAR (CL:THE CL:SIMPLE-STRING SELF) (CL:THE CL:FIXNUM POSITION))))))))))
    (CL:IF (CL:= CURSOR 0) (CL:RETURN) (CL:SETQ CURSOR (CL:1- CURSOR)))
    (CL:SETQ CODE
     (CL:IF (CL:= (CL:THE CL:FIXNUM (CL:LOGAND CODE 1)) 0)
      (CL:LET ((ARG CODE)) (CL:DECLARE (CL:TYPE CL:FIXNUM ARG)) (CL:THE CL:FIXNUM (CL:LOGAND (CL:THE CL:FIXNUM (CL:ASH ARG -1)) *INTEGER-UNSIGNED-BITS-MASK*)))
      (CL:THE CL:FIXNUM
       (CL:LOGIOR
        (CL:THE CL:FIXNUM (CL:LET ((ARG CODE) (COUNT 1)) (CL:DECLARE (CL:TYPE CL:FIXNUM ARG COUNT)) (CL:THE CL:FIXNUM (CL:ASH ARG (CL:THE CL:FIXNUM (CL:- COUNT))))))
        *INTEGER-MSB-MASK*)))))
...
(CL:DECLAIM (CL:FTYPE (CL:FUNCTION (CL:FIXNUM) CL:FIXNUM) PICK-HASH-TABLE-SIZE-PRIME))
(CL:DEFUN PICK-HASH-TABLE-SIZE-PRIME (MINSIZE)
  ...
  (CL:LET* ((PRIME NULL) (VECTOR-000 *HASH-TABLE-SIZE-PRIMES*) (INDEX-000 0) (LENGTH-000 (LENGTH VECTOR-000))) (CL:DECLARE (CL:TYPE CL:FIXNUM INDEX-000 LENGTH-000))
   (CL:LOOP WHILE (CL:< INDEX-000 LENGTH-000) DO (CL:SETQ PRIME (CL:AREF (CL:THE CL:SIMPLE-VECTOR (%THE-ARRAY VECTOR-000)) INDEX-000))
    (CL:WHEN (CL:>= (%WRAPPER-VALUE PRIME) MINSIZE) (CL:RETURN-FROM PICK-HASH-TABLE-SIZE-PRIME (%WRAPPER-VALUE PRIME))) (CL:SETQ INDEX-000 (CL:1+ INDEX-000))))
  (CL:ERROR (NEW-STELLA-EXCEPTION "pick-hash-table-size-prime: minimum size is too large")))

;;; (DEFMETHOD INITIALIZE-VECTOR ...)

(CL:DEFMETHOD INITIALIZE-VECTOR ((SELF VECTOR))
  (CL:LET* ((SIZE (%ARRAY-SIZE SELF))) (CL:DECLARE (CL:TYPE CL:FIXNUM SIZE)) (CL:SETF (%THE-ARRAY SELF) (CL:MAKE-ARRAY SIZE :INITIAL-ELEMENT NULL)) (setq size size))
  :VOID)
...
will be initialized to NULL."
  ...
  (CL:LET* ((OLD_SIZE (%ARRAY-SIZE SELF)) (I OLD_SIZE) (OLD_ARRAY (%THE-ARRAY SELF)) (NEW_ARRAY OLD_ARRAY))
   ...
   (CL:SETQ NEW_ARRAY (CL:MAKE-ARRAY SIZE :INITIAL-ELEMENT NULL)) (CL:WHEN (CL:< SIZE OLD_SIZE) (CL:SETQ OLD_SIZE SIZE) (CL:SETQ I OLD_SIZE))
   (CL:LOOP WHILE (CL:>= (CL:SETQ I (CL:1- I)) 0) DO
    (CL:LET ((SELF NEW_ARRAY) (VALUE (CL:AREF OLD_ARRAY I)) (POSITION I)) (CL:DECLARE (CL:TYPE CL:SIMPLE-VECTOR SELF) (CL:TYPE CL:FIXNUM POSITION))
     (CL:SETF (CL:AREF SELF POSITION) VALUE)))
   (setq i i) (CL:SETF (%THE-ARRAY SELF) NEW_ARRAY) (CL:SETF (%ARRAY-SIZE SELF) SIZE))
  :VOID)
...
This does not handle any necessary pathname translations or error conditions."
  (CL:LET* ((RESULT CL:NIL)) (CL:SETQ RESULT (PROBE-FILE? (FILE-NAME-AS-DIRECTORY FILENAME))) (CL:RETURN-FROM NATIVE-PROBE-DIRECTORY? RESULT)))
...
whether a directory exists."
  (CL:RETURN-FROM PROBE-FILE? (NATIVE-PROBE-FILE? (TRANSLATE-LOGICAL-PATHNAME FILENAME))))
...
(CL:DEFUN PROBE-DIRECTORY? (FILENAME)
  "Return true if file `fileName' exists and is a directory.
Note that this does not necessarily mean that the directory can also be read."
  (CL:RETURN-FROM PROBE-DIRECTORY? (NATIVE-PROBE-DIRECTORY? (TRANSLATE-LOGICAL-PATHNAME FILENAME))))
...
NULL if that cannot be determined."
  (CL:LET* ((TRUEFILE (TRANSLATE-LOGICAL-PATHNAME FILENAME))) (CL:DECLARE (CL:TYPE CL:SIMPLE-STRING TRUEFILE))
   (CL:WHEN (CL:NOT (NATIVE-PROBE-FILE? TRUEFILE)) (ENSURE-FILE-EXISTS FILENAME "file-write-date")) (CL:RETURN-FROM FILE-WRITE-DATE (NATIVE-FILE-WRITE-DATE TRUEFILE))))
...
cannot be determined."
  (CL:LET* ((TRUEFILE (TRANSLATE-LOGICAL-PATHNAME FILENAME))) (CL:DECLARE (CL:TYPE CL:SIMPLE-STRING TRUEFILE))
   (CL:WHEN (CL:NOT (NATIVE-PROBE-FILE? TRUEFILE)) (ENSURE-FILE-EXISTS FILENAME "file-length")) (CL:RETURN-FROM FILE-LENGTH (NATIVE-FILE-LENGTH TRUEFILE))))
...
(CL:DEFUN DELETE-FILE (FILENAME)
  ...
  (CL:LET* ((TRUEFILE (TRANSLATE-LOGICAL-PATHNAME FILENAME))) (CL:DECLARE (CL:TYPE CL:SIMPLE-STRING TRUEFILE))
   (CL:WHEN (CL:NOT (NATIVE-PROBE-FILE? TRUEFILE)) (ENSURE-FILE-EXISTS FILENAME "delete-file")) (NATIVE-DELETE-FILE TRUEFILE))
  :VOID)
...
(CL:DEFUN RENAME-FILE (FROMFILE TOFILE)
  ...
  (CL:LET* ((TRUEFROM (TRANSLATE-LOGICAL-PATHNAME FROMFILE)) (TRUETO (TRANSLATE-LOGICAL-PATHNAME TOFILE))) (CL:DECLARE (CL:TYPE CL:SIMPLE-STRING TRUEFROM TRUETO))
   (CL:WHEN (CL:NOT (NATIVE-PROBE-FILE? TRUEFROM)) (ENSURE-FILE-EXISTS FROMFILE "rename-file"))
   (CL:WHEN (NATIVE-PROBE-FILE? TRUETO) (ENSURE-FILE-DOES-NOT-EXIST TOFILE "rename-file")) (NATIVE-RENAME-FILE TRUEFROM TRUETO))
  :VOID)
...
(CL:DEFUN COPY-STREAM-TO-STREAM (IN OUT)
  ...
  (CL:LET* ((BUFFER (CL:MAKE-STRING *TOKENIZER-INITIAL-BUFFER-SIZE*)) (BYTESREAD 0)) (CL:DECLARE (CL:TYPE CL:FIXNUM BYTESREAD))
   (CL:LOOP (CL:SETQ BYTESREAD (NATIVE-BYTE-ARRAY-READ-SEQUENCE BUFFER (%NATIVE-STREAM IN) 0 *TOKENIZER-INITIAL-BUFFER-SIZE*))
    (CL:COND ((CL:> BYTESREAD 0) (NATIVE-BYTE-ARRAY-WRITE-SEQUENCE BUFFER (%NATIVE-STREAM OUT) 0 BYTESREAD)) (CL:T (FLUSH-OUTPUT OUT) (CL:RETURN)))))
  :VOID)
  ...
  (CL:LET* ((FROM NULL))
   (CL:UNWIND-PROTECT
    (CL:PROGN (CL:SETQ FROM (OPEN-INPUT-FILE FROMFILE))
     (CL:LET* ((TO NULL))
      (CL:UNWIND-PROTECT (CL:PROGN (CL:SETQ TO (OPEN-OUTPUT-FILE TOFILE)) (COPY-STREAM-TO-STREAM FROM TO)) (CL:WHEN (CL:NOT (CL:EQ TO NULL)) (FREE TO)))))
    (CL:WHEN (CL:NOT (CL:EQ FROM NULL)) (FREE FROM))))
  :VOID)

;;; (DEFUN (GET-TEMP-DIRECTORY STRING) ...)

(CL:DECLAIM (CL:FTYPE (CL:FUNCTION () CL:SIMPLE-STRING) GET-TEMP-DIRECTORY))
...
will use a suitable OS-specific default.  The returned directory will
  ...
  (CL:LET* ((DIR (%GET-PROPERTY (WRAP-STRING "stella.tempDirectory") NIL)))
   (CL:COND
    ((CL:EQ DIR NULL)
     (CL:LET* ((TEST-VALUE-000 (OPERATING-SYSTEM)))
      (CL:COND ((CL:OR (CL:EQ TEST-VALUE-000 KWD-PRIMAL-UNIX) (CL:EQ TEST-VALUE-000 KWD-PRIMAL-MAC)) (CL:SETQ DIR (WRAP-STRING "/tmp/")))
       ((CL:EQ TEST-VALUE-000 KWD-PRIMAL-WINDOWS) (CL:SETQ DIR (WRAP-STRING "C:\\WINDOWS\\TEMP\\")))
       (CL:T
        (CL:LET* ((STREAM-000 (NEW-OUTPUT-STRING-STREAM))) (%%PRINT-STREAM (%NATIVE-STREAM STREAM-000) "`" TEST-VALUE-000 "' is not a valid case option")
         (CL:ERROR (NEW-STELLA-EXCEPTION (THE-STRING-READER STREAM-000))))))))
    (CL:T (CL:SETQ DIR (WRAP-STRING (FILE-NAME-AS-DIRECTORY (%WRAPPER-VALUE DIR))))))
   (CL:RETURN-FROM GET-TEMP-DIRECTORY (%WRAPPER-VALUE DIR))))

;;; (DEFUN (MAKE-TEMPORARY-FILE-NAME STRING) ...)

(CL:DECLAIM (CL:FTYPE (CL:FUNCTION (CL:SIMPLE-STRING CL:SIMPLE-STRING) CL:SIMPLE-STRING) MAKE-TEMPORARY-FILE-NAME))
...
or OS process.  If necessary, this case can be handled by the caller."
  ...
  (CL:LET* ((I NULL-INTEGER) (ITER-000 0) (UPPER-BOUND-000 100)) (CL:DECLARE (CL:TYPE CL:FIXNUM I ITER-000 UPPER-BOUND-000))
   (CL:LOOP WHILE (CL:<= ITER-000 UPPER-BOUND-000) DO (CL:SETQ I ITER-000) (CL:SETQ I I)
    (CL:LET*
     ((UNIQUIFIER (FORMAT-WITH-PADDING (INTEGER-TO-STRING (CL:TRUNCATE (RANDOM 1000000))) 6 #\0 KWD-PRIMAL-RIGHT CL:NIL))
      (TEMPFILENAME (CONCATENATE PREFIX UNIQUIFIER SUFFIX)))
     (CL:DECLARE (CL:TYPE CL:SIMPLE-STRING UNIQUIFIER TEMPFILENAME))
     (CL:WHEN (CL:NOT (PROBE-FILE? TEMPFILENAME)) (CL:RETURN-FROM MAKE-TEMPORARY-FILE-NAME TEMPFILENAME)))
    (CL:SETQ ITER-000 (CL:1+ ITER-000))))
  (CL:RETURN-FROM MAKE-TEMPORARY-FILE-NAME STELLA::NULL-STRING))

;;; (DEFUN (MAKE-TEMPORARY-FILE STRING) ...)

(CL:DECLAIM (CL:FTYPE (CL:FUNCTION (CL:SIMPLE-STRING CL:SIMPLE-STRING) CL:SIMPLE-STRING) MAKE-TEMPORARY-FILE))
...
but maybe a bit better in avoiding collisions."
  ...
  (CL:LET* ((I NULL-INTEGER) (ITER-000 0) (UPPER-BOUND-000 100)) (CL:DECLARE (CL:TYPE CL:FIXNUM I ITER-000 UPPER-BOUND-000))
   (CL:LOOP WHILE (CL:<= ITER-000 UPPER-BOUND-000) DO (CL:SETQ I ITER-000) (CL:SETQ I I)
    (CL:HANDLER-CASE
     (CL:LET* ((TEMPFILENAME (MAKE-TEMPORARY-FILE-NAME PREFIX SUFFIX))) (CL:DECLARE (CL:TYPE CL:SIMPLE-STRING TEMPFILENAME))
      (CL:LET* ((TEMP NULL))
       (CL:UNWIND-PROTECT (CL:PROGN (CL:SETQ TEMP (OPEN-OUTPUT-FILE TEMPFILENAME KWD-PRIMAL-IF-EXISTS KWD-PRIMAL-ERROR)) (CLOSE-STREAM TEMP))
...
(CL:DEFUN CL-LIST-DIRECTORY-FILES (DIRECTORY)
  ...
  (CL:LET* ((FILES NULL) (DIRSEP (DIRECTORY-SEPARATOR-STRING)) (CHECKDUPLICATES? CL:NIL) (NORMFILE STELLA::NULL-STRING) (NORMALIZEDFILES NIL))
   ...
   (CL:WHEN (CL:EQ FILES NULL) (CL:SETQ CHECKDUPLICATES? CL:T) (setq files (cl:append (cl:directory (string-concatenate directory "*"))
                                (cl:directory (string-concatenate directory "*.*")))))
   (setq files (stellify (cl:mapcar #'cl:namestring files))) (CL:WHEN CHECKDUPLICATES? (CL:SETQ NORMALIZEDFILES (REMOVE-DUPLICATES-EQUAL NORMALIZEDFILES)))
   (CL:LET* ((FILE NULL) (ITER-000 FILES) (COLLECT-000 NULL))
    (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-000 NIL)) DO (CL:SETQ FILE (%%VALUE ITER-000))
     (CL:TAGBODY (CL:SETQ NORMFILE (%WRAPPER-VALUE FILE))
      (CL:WHEN (ENDS-WITH? NORMFILE DIRSEP NULL-INTEGER)
       (CL:SETQ NORMFILE (SUBSEQUENCE NORMFILE 0 (CL:- (CL:THE CL:FIXNUM (CL:LENGTH NORMFILE)) (CL:THE CL:FIXNUM (CL:LENGTH DIRSEP))))))
      (CL:SETQ NORMFILE (FILE-NAME-WITHOUT-DIRECTORY NORMFILE)) (CL:WHEN (CL:OR (STRING-EQL? NORMFILE ".") (STRING-EQL? NORMFILE "..")) (CL:GO :CONTINUE))
      (CL:IF (CL:EQ COLLECT-000 NULL)
       (CL:PROGN (CL:SETQ COLLECT-000 (CONS (WRAP-STRING NORMFILE) NIL))
        (CL:IF (CL:EQ NORMALIZEDFILES NIL) (CL:SETQ NORMALIZEDFILES COLLECT-000) (ADD-CONS-TO-END-OF-CONS-LIST NORMALIZEDFILES COLLECT-000)))
       (CL:PROGN (CL:SETF (%%REST COLLECT-000) (CONS (WRAP-STRING NORMFILE) NIL)) (CL:SETQ COLLECT-000 (%%REST COLLECT-000))))
      :CONTINUE)
...
(CL:DEFUN CPP-LIST-DIRECTORY-FILES (DIRECTORY)
  ...
  (CL:LET* ((FILES NIL))
   (CL:WHEN (CL:EQ FILES NULL)
    (CL:LET* ((STREAM-000 (NEW-OUTPUT-STRING-STREAM))) (%%PRINT-STREAM (%NATIVE-STREAM STREAM-000) "list-directory-files: error reading `" DIRECTORY "'")
     (CL:ERROR (NEW-STELLA-EXCEPTION (THE-STRING-READER STREAM-000)))))
...
e.g., Lisp will convert . or .. into absolute pathnames."
  ...
  (CL:LET* ((FILES (CL-LIST-DIRECTORY-FILES DIRECTORY))) (CL:RETURN-FROM %LIST-DIRECTORY-FILES (SORT FILES NULL))))

(CL:DEFUN LIST-DIRECTORY-FILES-EVALUATOR-WRAPPER (ARGUMENTS)
  (CL:RETURN-FROM LIST-DIRECTORY-FILES-EVALUATOR-WRAPPER (%LIST-DIRECTORY-FILES (%WRAPPER-VALUE (%%VALUE ARGUMENTS)))))
...
within directories which results in a depth-first presentation order of files."
  ...
  (CL:LET* ((FILES NIL))
   (CL:LET* ((FILE NULL) (ITER-000 (%LIST-DIRECTORY-FILES DIRECTORY)))
    (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-000 NIL)) DO (CL:SETQ FILE (%%VALUE ITER-000))
     (CL:COND
      ((PROBE-DIRECTORY? (CONCATENATE DIRECTORY (%WRAPPER-VALUE FILE))) (CL:SETQ FILE (WRAP-STRING (FILE-NAME-AS-DIRECTORY (%WRAPPER-VALUE FILE))))
       (CL:LET* ((SUBFILE NULL) (ITER-001 (%LIST-DIRECTORY-FILES-RECURSIVELY (CONCATENATE DIRECTORY (%WRAPPER-VALUE FILE)))))
        (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-001 NIL)) DO (CL:SETQ SUBFILE (%%VALUE ITER-001))
         (CL:SETQ FILES (CONS (WRAP-STRING (CONCATENATE (UNWRAP-STRING FILE) (%WRAPPER-VALUE SUBFILE))) FILES)) (CL:SETQ ITER-001 (%%REST ITER-001)))))
...
(CL:DEFUN LIST-DIRECTORY-FILES-RECURSIVELY-EVALUATOR-WRAPPER (ARGUMENTS)
  (CL:RETURN-FROM LIST-DIRECTORY-FILES-RECURSIVELY-EVALUATOR-WRAPPER (%LIST-DIRECTORY-FILES-RECURSIVELY (%WRAPPER-VALUE (%%VALUE ARGUMENTS)))))
...
If `x' is negative, we only count the value bits, not the sign."
  ...
  (CL:LET* ((BOT 0) (TOP (CL:1- LONG-INTEGER-BIT-WIDTH)) (SPLIT 0) (REM 0)) (CL:DECLARE (CL:TYPE CL:FIXNUM BOT TOP SPLIT))
   (CL:LOOP
    (CL:SETQ SPLIT (CL:LET ((ARG (CL:+ BOT TOP)) (COUNT 1)) (CL:DECLARE (CL:TYPE CL:FIXNUM ARG COUNT)) (CL:THE CL:FIXNUM (CL:ASH ARG (CL:THE CL:FIXNUM (CL:- COUNT))))))
    (CL:SETQ REM (CL:LET ((ARG X) (COUNT SPLIT)) (CL:DECLARE (CL:TYPE CL:FIXNUM COUNT)) (CL:ASH ARG (CL:THE CL:FIXNUM (CL:- COUNT)))))
    (CL:WHEN (CL:= REM 1) (CL:RETURN-FROM INTEGER-LENGTH (CL:1+ SPLIT))) (CL:IF (CL:= REM 0) (CL:SETQ TOP (CL:1- SPLIT)) (CL:SETQ BOT (CL:1+ SPLIT))))))
...
of base-10 digits to represent `x', with the exception of x=0."
  ...
  (CL:LET* ((LEN 0) (COMP 1)) (CL:DECLARE (CL:TYPE CL:FIXNUM LEN COMP))
   (CL:LOOP
    (CL:COND ((CL:>= X 1000000000) (CL:SETQ X (CL:LET ((X X) (Y 1000000000)) (CL:VALUES (CL:TRUNCATE X Y)))) (CL:SETQ LEN (CL:+ LEN 9)))
     ((CL:>= X 10000) (CL:SETQ X (CL:LET ((X X) (Y 10000)) (CL:VALUES (CL:TRUNCATE X Y)))) (CL:SETQ LEN (CL:+ LEN 4)))
     ((CL:>= X 100) (CL:SETQ X (CL:LET ((X X) (Y 100)) (CL:VALUES (CL:TRUNCATE X Y)))) (CL:SETQ LEN (CL:+ LEN 2))) (CL:T (CL:RETURN))))
   (CL:LOOP WHILE (CL:<= COMP X) DO (CL:SETQ COMP (CL:* COMP 10)) (CL:SETQ LEN (CL:1+ LEN))) (CL:RETURN-FROM INTEGER-LENGTH10 LEN)))
...
the sign-bit just like a regular bit.  In Common-Lisp we can't do that
directly and need to do some extra masking."
  (CL:RETURN-FROM UNSIGNED-SHIFT-RIGHT-BY-1 (CL:LOGAND (CL:ASH ARG -1) *LONG-INTEGER-UNSIGNED-BITS-MASK*)))

;;; (DEFUN (GENERATE-UUID STRING) ...)

(CL:DECLAIM (CL:FTYPE (CL:FUNCTION (CL:T) CL:SIMPLE-STRING) GENERATE-UUID))
...
UUID types.  Currently supported are:
  ...
  (CL:COND ((CL:OR (CL:EQ UUID-TYPE KWD-PRIMAL-TYPE-4) (CL:EQ UUID-TYPE KWD-PRIMAL-RANDOM)) (CL:RETURN-FROM GENERATE-UUID (GENERATE-RANDOM-UUID)))
   (CL:T
    (CL:LET* ((STREAM-000 (NEW-OUTPUT-STRING-STREAM))) (%%PRINT-STREAM (%NATIVE-STREAM STREAM-000) "UUIDs of type `" UUID-TYPE "' are not supported.")
     (CL:ERROR (NEW-STELLA-EXCEPTION (THE-STRING-READER STREAM-000)))))))

;;; (DEFUN (GENERATE-RANDOM-UUID STRING) ...)

(CL:DECLAIM (CL:FTYPE (CL:FUNCTION () CL:SIMPLE-STRING) GENERATE-RANDOM-UUID))
...
bytes 7 and 8, - bytes 9 and 10, - then followed by bytes 11-16."
  (CL:RETURN-FROM GENERATE-RANDOM-UUID
   (CONCATENATE (ZERO-PAD-STRING (INTEGER-TO-HEX-STRING (CL:TRUNCATE (RANDOM 65536))) 4) (ZERO-PAD-STRING (INTEGER-TO-HEX-STRING (CL:TRUNCATE (RANDOM 65536))) 4) "-"
    (ZERO-PAD-STRING (INTEGER-TO-HEX-STRING (CL:TRUNCATE (RANDOM 65536))) 4) "-" (INTEGER-TO-HEX-STRING (CL:TRUNCATE (CL:+ 16384 (RANDOM 4096)))) "-"
    (INTEGER-TO-HEX-STRING (CL:TRUNCATE (CL:+ 32768 (RANDOM 16384)))) "-" (ZERO-PAD-STRING (INTEGER-TO-HEX-STRING (CL:TRUNCATE (RANDOM 16777216))) 6)
    (ZERO-PAD-STRING (INTEGER-TO-HEX-STRING (CL:TRUNCATE (RANDOM 16777216))) 6))))
...
(CL:DEFUN STELLIFY (SELF)
  ...
  (CL:LET* ((RESULT SELF)) (CL:typecase self
        ...
        (CL:t (CL:error "Can't stellify: ~s" self))) (CL:RETURN-FROM STELLIFY RESULT)))

;;; (DEFUN (STELLA-OBJECT? BOOLEAN) ...)

(CL:DEFUN STELLA-OBJECT? (SELF)
  "Return true if `self' is a member of the STELLA class `OBJECT'."
  (CL:LET* ((RESULT? CL:T)) (CL:setq result? (CL:or (CL:typep self 'STELLA::OBJECT)
                               (CL:listp self))) (CL:RETURN-FROM STELLA-OBJECT? RESULT?)))

;;; (DEFUN (RUNNING-AS-LISP? BOOLEAN) ...)

(CL:DEFUN RUNNING-AS-LISP? ()
  "Return true if the executable code is a Common Lisp application."
  (CL:LET* ((RESULT? CL:NIL)) (cl:setq result? TRUE) (CL:RETURN-FROM RUNNING-AS-LISP? RESULT?)))
...
(CL:DECLAIM (CL:FTYPE (CL:FUNCTION () CL:SIMPLE-STRING) RUNNING-SYSTEM-INFORMATION))
(CL:DEFUN RUNNING-SYSTEM-INFORMATION ()
  ...
  (CL:LET* ((INFO "")) (CL:DECLARE (CL:TYPE CL:SIMPLE-STRING INFO))
   (cl:setq info (cl:format cl:nil "~%    Lisp: ~@[~A~] ~@[~A~]~%      OS: ~@[~A~] ~@[~A~]~%Hardware: ~@[~A~] ~@[~A~]"
             ...
             (cl:software-version)
             (cl:machine-type)
             (cl:machine-version))) (CL:RETURN-FROM RUNNING-SYSTEM-INFORMATION INFO)))
...
(CL:DECLAIM (CL:FTYPE (CL:FUNCTION (CL:T) CL:SIMPLE-STRING) EXCEPTION-MESSAGE))
...
exception `e'.  For example, in Java it prints a stack trace.  In Lisp, it is vendor dependent."
  (CL:LET* ((S (%NATIVE-STREAM STREAM))) (%%PRINT-EXCEPTION-CONTEXT E S))
  :VOID)

;;; (DEFUN (EXCEPTION-CONTEXT STRING) ...)

(CL:DECLAIM (CL:FTYPE (CL:FUNCTION (CL:T) CL:SIMPLE-STRING) EXCEPTION-CONTEXT))
(CL:DEFUN EXCEPTION-CONTEXT (E)
  "Print the exception context of `e' to a string and return the result."
  (CL:LET* ((OUT (NEW-OUTPUT-STRING-STREAM))) (PRINT-EXCEPTION-CONTEXT E OUT) (CL:RETURN-FROM EXCEPTION-CONTEXT (THE-STRING-READER OUT))))
...
(CL:DEFUN HELP-STARTUP-PRIMAL1 ()
  (CL:PROGN (CL:SETQ SYM-PRIMAL-STELLA-FLOOR (INTERN-RIGID-SYMBOL-WRT-MODULE "FLOOR" NULL 0)) (CL:SETQ KWD-PRIMAL-CPP (INTERN-RIGID-SYMBOL-WRT-MODULE "CPP" NULL 2))
   (CL:SETQ KWD-PRIMAL-FUNCTION (INTERN-RIGID-SYMBOL-WRT-MODULE "FUNCTION" NULL 2)) (CL:SETQ SYM-PRIMAL-STELLA-ROUND (INTERN-RIGID-SYMBOL-WRT-MODULE "ROUND" NULL 0))
   (CL:SETQ SYM-PRIMAL-STELLA-FMOD (INTERN-RIGID-SYMBOL-WRT-MODULE "FMOD" NULL 0)) (CL:SETQ SYM-PRIMAL-STELLA-RANDOM (INTERN-RIGID-SYMBOL-WRT-MODULE "RANDOM" NULL 0))
   (CL:SETQ SYM-PRIMAL-STELLA-SQRT (INTERN-RIGID-SYMBOL-WRT-MODULE "SQRT" NULL 0)) (CL:SETQ SYM-PRIMAL-STELLA-COS (INTERN-RIGID-SYMBOL-WRT-MODULE "COS" NULL 0))
   (CL:SETQ SYM-PRIMAL-STELLA-SIN (INTERN-RIGID-SYMBOL-WRT-MODULE "SIN" NULL 0)) (CL:SETQ SYM-PRIMAL-STELLA-TAN (INTERN-RIGID-SYMBOL-WRT-MODULE "TAN" NULL 0))
   (CL:SETQ SYM-PRIMAL-STELLA-ACOS (INTERN-RIGID-SYMBOL-WRT-MODULE "ACOS" NULL 0)) (CL:SETQ SYM-PRIMAL-STELLA-ASIN (INTERN-RIGID-SYMBOL-WRT-MODULE "ASIN" NULL 0))
   (CL:SETQ SYM-PRIMAL-STELLA-ATAN (INTERN-RIGID-SYMBOL-WRT-MODULE "ATAN" NULL 0)) (CL:SETQ SYM-PRIMAL-STELLA-ATAN2 (INTERN-RIGID-SYMBOL-WRT-MODULE "ATAN2" NULL 0))
   (CL:SETQ SYM-PRIMAL-STELLA-EXP (INTERN-RIGID-SYMBOL-WRT-MODULE "EXP" NULL 0)) (CL:SETQ SYM-PRIMAL-STELLA-LOG (INTERN-RIGID-SYMBOL-WRT-MODULE "LOG" NULL 0))
   (CL:SETQ SYM-PRIMAL-STELLA-MIN (INTERN-RIGID-SYMBOL-WRT-MODULE "MIN" NULL 0)) (CL:SETQ SYM-PRIMAL-STELLA-MAX (INTERN-RIGID-SYMBOL-WRT-MODULE "MAX" NULL 0))
   (CL:SETQ KWD-PRIMAL-WHITE-SPACE (INTERN-RIGID-SYMBOL-WRT-MODULE "WHITE-SPACE" NULL 2))
   (CL:SETQ KWD-PRIMAL-ASCII-CASE-SENSITIVE (INTERN-RIGID-SYMBOL-WRT-MODULE "ASCII-CASE-SENSITIVE" NULL 2))
   (CL:SETQ KWD-PRIMAL-ASCII-CASE-INSENSITIVE (INTERN-RIGID-SYMBOL-WRT-MODULE "ASCII-CASE-INSENSITIVE" NULL 2))
   (CL:SETQ KWD-PRIMAL-ASCII-CASE-NORMALIZED (INTERN-RIGID-SYMBOL-WRT-MODULE "ASCII-CASE-NORMALIZED" NULL 2))
   (CL:SETQ KWD-PRIMAL-UPCASE (INTERN-RIGID-SYMBOL-WRT-MODULE "UPCASE" NULL 2)) (CL:SETQ KWD-PRIMAL-DOWNCASE (INTERN-RIGID-SYMBOL-WRT-MODULE "DOWNCASE" NULL 2))
   (CL:SETQ KWD-PRIMAL-CAPITALIZE (INTERN-RIGID-SYMBOL-WRT-MODULE "CAPITALIZE" NULL 2)) (CL:SETQ KWD-PRIMAL-PRESERVE (INTERN-RIGID-SYMBOL-WRT-MODULE "PRESERVE" NULL 2))
   (CL:SETQ KWD-PRIMAL-LEFT (INTERN-RIGID-SYMBOL-WRT-MODULE "LEFT" NULL 2)) (CL:SETQ KWD-PRIMAL-RIGHT (INTERN-RIGID-SYMBOL-WRT-MODULE "RIGHT" NULL 2))
   (CL:SETQ KWD-PRIMAL-CENTER (INTERN-RIGID-SYMBOL-WRT-MODULE "CENTER" NULL 2)) (CL:SETQ SYM-PRIMAL-STELLA-HASH-CODE (INTERN-RIGID-SYMBOL-WRT-MODULE "HASH-CODE" NULL 0))
   (CL:SETQ KWD-PRIMAL-JAVA (INTERN-RIGID-SYMBOL-WRT-MODULE "JAVA" NULL 2)) (CL:SETQ KWD-PRIMAL-UNIX (INTERN-RIGID-SYMBOL-WRT-MODULE "UNIX" NULL 2))
   (CL:SETQ KWD-PRIMAL-MAC (INTERN-RIGID-SYMBOL-WRT-MODULE "MAC" NULL 2)) (CL:SETQ KWD-PRIMAL-WINDOWS (INTERN-RIGID-SYMBOL-WRT-MODULE "WINDOWS" NULL 2))
   (CL:SETQ KWD-PRIMAL-IF-EXISTS (INTERN-RIGID-SYMBOL-WRT-MODULE "IF-EXISTS" NULL 2)) (CL:SETQ KWD-PRIMAL-ERROR (INTERN-RIGID-SYMBOL-WRT-MODULE "ERROR" NULL 2))
   (CL:SETQ SYM-PRIMAL-STELLA-LIST-DIRECTORY-FILES (INTERN-RIGID-SYMBOL-WRT-MODULE "LIST-DIRECTORY-FILES" NULL 0))
   (CL:SETQ KWD-PRIMAL-COMMON-LISP (INTERN-RIGID-SYMBOL-WRT-MODULE "COMMON-LISP" NULL 2))
   (CL:SETQ SYM-PRIMAL-STELLA-LIST-DIRECTORY-FILES-RECURSIVELY (INTERN-RIGID-SYMBOL-WRT-MODULE "LIST-DIRECTORY-FILES-RECURSIVELY" NULL 0))
   (CL:SETQ KWD-PRIMAL-TYPE-4 (INTERN-RIGID-SYMBOL-WRT-MODULE "TYPE-4" NULL 2)) (CL:SETQ KWD-PRIMAL-RANDOM (INTERN-RIGID-SYMBOL-WRT-MODULE "RANDOM" NULL 2))
   (CL:SETQ SYM-PRIMAL-STELLA-SLEEP (INTERN-RIGID-SYMBOL-WRT-MODULE "SLEEP" NULL 0))
   (CL:SETQ SYM-PRIMAL-STELLA-STARTUP-PRIMAL (INTERN-RIGID-SYMBOL-WRT-MODULE "STARTUP-PRIMAL" NULL 0))
   (CL:SETQ SYM-PRIMAL-STELLA-METHOD-STARTUP-CLASSNAME (INTERN-RIGID-SYMBOL-WRT-MODULE "METHOD-STARTUP-CLASSNAME" NULL 0)))
  :VOID)

(CL:DEFUN HELP-STARTUP-PRIMAL2 ()
  (CL:PROGN
   (DEFINE-FUNCTION-OBJECT "LISP-NULL-ARRAY-SYMBOL-STRING" "(DEFUN (LISP-NULL-ARRAY-SYMBOL-STRING STRING) ((RANK INTEGER)))" (CL:FUNCTION LISP-NULL-ARRAY-SYMBOL-STRING)
    NULL)
   (DEFINE-FUNCTION-OBJECT "PRINT-NUMERIC-CONSTANTS" "(DEFUN PRINT-NUMERIC-CONSTANTS () :COMMAND? TRUE)" (CL:FUNCTION PRINT-NUMERIC-CONSTANTS) NULL)
   ...
   (DEFINE-METHOD-OBJECT
    ...
    NULL NULL)
   (DEFINE-METHOD-OBJECT
    "(DEFMETHOD (NULL? BOOLEAN) ((X ARRAY)) :DOCUMENTATION \"Return true if `x' is undefined (handled specially by all translators).\" :PUBLIC? TRUE :NATIVE? TRUE)" NULL
    NULL)
   (DEFINE-METHOD-OBJECT
   ...
   (DEFINE-METHOD-OBJECT
    ...
    NULL NULL)
   (DEFINE-METHOD-OBJECT
    "(DEFMETHOD (NULL? BOOLEAN) ((X CODE)) :DOCUMENTATION \"Return true if `x' is undefined (handled specially by all translators).\" :PUBLIC? TRUE :NATIVE? TRUE)" NULL
    NULL)
   (DEFINE-METHOD-OBJECT
   ...
   (DEFINE-METHOD-OBJECT
    ...
    NULL NULL)
   (DEFINE-METHOD-OBJECT
    "(DEFMETHOD (NULL? BOOLEAN) ((X FLOAT)) :DOCUMENTATION \"Return true if `x' is undefined (handled specially by all translators).\" :PUBLIC? TRUE :NATIVE? TRUE)" NULL
    NULL)
   (DEFINE-METHOD-OBJECT
   ...
   (DEFINE-METHOD-OBJECT
    ...
    NULL NULL)
   (DEFINE-METHOD-OBJECT
    "(DEFMETHOD (DEFINED? BOOLEAN) ((X CODE)) :DOCUMENTATION \"Return true if `x' is defined (handled specially by all translators).\" :PUBLIC? TRUE :NATIVE? TRUE)" NULL
    NULL)
   (DEFINE-METHOD-OBJECT
   ...
   (DEFINE-METHOD-OBJECT
    ...
    NULL NULL)
   (DEFINE-FUNCTION-OBJECT "EQ?" "(DEFUN (EQ? BOOLEAN) ((X UNKNOWN) (Y UNKNOWN)) :DOCUMENTATION \"Return true if `x' and `y' are literally the same object (or
simple number).  Analogue to the Common Lisp EQL and C++ and Java's ==.\" :PUBLIC? TRUE :NATIVE? TRUE)" NULL NULL)
   (DEFINE-FUNCTION-OBJECT "="
    ...
    NULL NULL)
   (DEFINE-FUNCTION-OBJECT "EQL?" "(DEFUN (EQL? BOOLEAN) ((X OBJECT) (Y OBJECT)) :DOCUMENTATION \"Return true if `x' and `y' are `eq?' or equivalent literals
such as strings that also might be wrapped in non-identical wrappers.  For
the case where `x' or `y' are plain literals such as strings or integers, the
STELLA translator substitutes the equality test appropriate for the particular
target language and does not actually call this function.  For cases where
`x' or `y' are known to be of type STANDARD-OBJECT, the STELLA translator
substitutes the faster `eq?' test inline.\" :PUBLIC? TRUE)" (CL:FUNCTION EQL?) NULL)
   (DEFINE-FUNCTION-OBJECT "EQUAL?" "(DEFUN (EQUAL? BOOLEAN) ((X OBJECT) (Y OBJECT)) :DOCUMENTATION \"Return true if `x' and `y' are `eql?' or considered equal
by a user-defined `object-equal?' method.  This implements a fully extensible
equality test similar to Java's `equals' method.  Note that writers of custom
`object-equal?' methods must also implement a corresponding `equal-hash-code'
method.\" :PUBLIC? TRUE)" (CL:FUNCTION EQUAL?) NULL)
   (DEFINE-METHOD-OBJECT "(DEFMETHOD (OBJECT-EQUAL? BOOLEAN) ((X OBJECT) (Y OBJECT)) :DOCUMENTATION \"Return true if `x' and `y' are `eq?'.\" :PUBLIC? TRUE)"
    (CL:FUNCTION OBJECT-EQUAL?) NULL)
   (DEFINE-METHOD-OBJECT "(DEFMETHOD (OBJECT-EQUAL? BOOLEAN) ((X WRAPPER) (Y OBJECT)) :DOCUMENTATION \"Return true if `x' and `y' are literal wrappers whose
literals are considered `eql?'.\" :PUBLIC? TRUE)" (CL:FUNCTION OBJECT-EQUAL?) NULL)
   (DEFINE-FUNCTION-OBJECT ">" "(DEFUN (> BOOLEAN) ((X NUMBER) (Y NUMBER)) :DOCUMENTATION \"Return true if `x' is greater than `y'.\" :PUBLIC? TRUE :NATIVE? TRUE)" NULL
    NULL)
   (DEFINE-FUNCTION-OBJECT ">="
    "(DEFUN (>= BOOLEAN) ((X NUMBER) (Y NUMBER)) :DOCUMENTATION \"Return true if `x' is greater than or equal to `y'.\" :PUBLIC? TRUE :NATIVE? TRUE)" NULL NULL)
   (DEFINE-FUNCTION-OBJECT "<" "(DEFUN (< BOOLEAN) ((X NUMBER) (Y NUMBER)) :DOCUMENTATION \"Return true if `x' is less than `y'.\" :PUBLIC? TRUE :NATIVE? TRUE)" NULL
    NULL)
   (DEFINE-FUNCTION-OBJECT "<="
    "(DEFUN (<= BOOLEAN) ((X NUMBER) (Y NUMBER)) :DOCUMENTATION \"Return true if `x' is less than or equal to `y'.\" :PUBLIC? TRUE :NATIVE? TRUE)" NULL NULL)
   (DEFINE-FUNCTION-OBJECT "+" "(DEFUN (+ NUMBER) (|&REST| (ARGUMENTS NUMBER)) :DOCUMENTATION \"Return the sum of all `arguments'.\" :PUBLIC? TRUE :NATIVE? TRUE)" NULL
    NULL)
   (DEFINE-FUNCTION-OBJECT "-" "(DEFUN (- NUMBER) ((X NUMBER) |&REST| (ARGUMENTS NUMBER)) :DOCUMENTATION \"If only `x' was supplied return the result of 0 - `x'.
Otherwise, return the result of (...((`x' - arg1) - arg2) - ... - argN).\" :PUBLIC? TRUE :NATIVE? TRUE)" NULL NULL)
   (DEFINE-FUNCTION-OBJECT "*" "(DEFUN (* NUMBER) (|&REST| (ARGUMENTS NUMBER)) :DOCUMENTATION \"Return the product of all `arguments'.\" :PUBLIC? TRUE :NATIVE? TRUE)"
    NULL NULL)
   (DEFINE-FUNCTION-OBJECT "/" "(DEFUN (/ NUMBER) ((X NUMBER) |&REST| (ARGUMENTS NUMBER)) :DOCUMENTATION \"If only `x' was supplied return the result of 1 / `x'.
Otherwise, return the result of (...((`x' / arg1) / arg2 ) / ... / argN).\" :PUBLIC? TRUE :NATIVE? TRUE)" NULL NULL)
   (DEFINE-METHOD-OBJECT
   ...
   (DEFINE-METHOD-OBJECT
    ...
    (CL:FUNCTION DIV) NULL)
   (DEFINE-METHOD-OBJECT "(DEFMETHOD (REM INTEGER) ((X INTEGER) (Y INTEGER)) :DOCUMENTATION \"Return the remainder from dividing `x' by `y'.  The
sign of the result is always the same as the sign of `x'.  This has slightly
different behavior than the `mod' function, and has less overhead in C++ and
Java, which don't have direct support for a true modulus function.\" :PUBLIC? TRUE :GLOBALLY-INLINE? TRUE (RETURN (VERBATIM :COMMON-LISP (CL:REM X Y) :CPP \"(x % y)\" :JAVA \"(x % y)\")))"
   ...
   (DEFINE-METHOD-OBJECT "(DEFMETHOD (REM LONG-INTEGER) ((X LONG-INTEGER) (Y LONG-INTEGER)) :DOCUMENTATION \"Return the remainder from dividing `x' by `y'.  The
sign of the result is always the same as the sign of `x'.  This has slightly
different behavior than the `mod' function, and has less overhead in C++ and
Java, which don't have direct support for a true modulus function.\" :PUBLIC? TRUE :GLOBALLY-INLINE? TRUE (RETURN (VERBATIM :COMMON-LISP (CL:REM X Y) :CPP \"(x % y)\" :JAVA \"(x % y)\")))"
    (CL:FUNCTION REM) NULL)
   (DEFINE-FUNCTION-OBJECT "FREM" "(DEFUN (FREM FLOAT) ((X FLOAT) (Y FLOAT)) :DOCUMENTATION \"Return the floating point remainder from dividing `x' by `y'.  The
sign of the result is always the same as the sign of `x'.  This has slightly
different behavior than the `mod' function, and has less overhead in C++ and
Java, which don't have direct support for a true modulus function.\" :PUBLIC? TRUE :GLOBALLY-INLINE? TRUE (RETURN (VERBATIM :COMMON-LISP (CL:REM X Y) :CPP \"fmod(x, y)\" :JAVA \"(x % y)\")))"
   ...
   (DEFINE-METHOD-OBJECT "(DEFMETHOD (MOD INTEGER) ((X INTEGER) (MODULUS INTEGER)) :DOCUMENTATION \"True modulus.  Return the result of `x' mod `modulo'.
Note: In C++ and Java, `mod' has more overhead than the similar
function `rem'.  The  answers returned by `mod' and `rem' are only
different when the signs of `x' and `modulo' are different.\" :PUBLIC? TRUE)" (CL:FUNCTION MOD) NULL)
   (DEFINE-METHOD-OBJECT "(DEFMETHOD (MOD LONG-INTEGER) ((X LONG-INTEGER) (MODULUS LONG-INTEGER)) :DOCUMENTATION \"True modulus.  Return the result of `x' mod `modulo'.
Note: In C++ and Java, `mod' has more overhead than the similar
function `rem'.  The  answers returned by `mod' and `rem' are only
different when the signs of `x' and `modulo' are different.\" :PUBLIC? TRUE)" (CL:FUNCTION MOD) NULL)
   (DEFINE-FUNCTION-OBJECT "FMOD" "(DEFUN (FMOD FLOAT) ((X FLOAT) (MODULUS FLOAT)) :DOCUMENTATION \"True modulus for floats.  Return the result of `x' mod `modulo'.
Note: In C++ and Java, `mod' has more overhead than the similar
function `rem'.  The  answers returned by `mod' and `rem' are only
different when the signs of `x' and `modulo' are different.\" :PUBLIC? TRUE)" (CL:FUNCTION FMOD) NULL)
   ...
   (DEFINE-FUNCTION-OBJECT "CEILING" "(DEFUN (CEILING INTEGER) ((N NUMBER)) :DOCUMENTATION \"Return the smallest integer >= `n'.\" :NATIVE? TRUE :PUBLIC? TRUE)" NULL
    NULL)
   (DEFINE-FUNCTION-OBJECT "FLOOR" "(DEFUN (FLOOR INTEGER) ((N NUMBER)) :DOCUMENTATION \"Return the biggest integer <= `n'.\" :NATIVE? TRUE :PUBLIC? TRUE)" NULL NULL)
   (DEFINE-FUNCTION-OBJECT "ROUND"
    "(DEFUN (ROUND INTEGER) ((N NUMBER)) :DOCUMENTATION \"Round `n' to the closest integer and return the result.\" :NATIVE? TRUE :PUBLIC? TRUE)" NULL NULL))
  :VOID)

(CL:DEFUN HELP-STARTUP-PRIMAL3 ()
  (CL:PROGN
   (DEFINE-FUNCTION-OBJECT "TRUNCATE"
    "(DEFUN (TRUNCATE INTEGER) ((N NUMBER)) :DOCUMENTATION \"Truncate `n' toward zero and return the result.\" :NATIVE? TRUE :PUBLIC? TRUE)" NULL NULL)
...
is `true', then the last value will be rounded to an integer.
This can be used to convert from decimal degree values to Degree-Minute-Second
or from decimal hours to Hour-Minute-Second format.\" :PUBLIC? TRUE)" (CL:FUNCTION FLOAT-TO-BASE60) NULL)
...
is x + y/60 + z/3600.
This can be used to convert from Degree-Minute-Second to decimal degrees
or from Hour-Minute-Second format to decimal hours.\")" (CL:FUNCTION BASE60-TO-FLOAT) NULL)
   (DEFINE-FUNCTION-OBJECT "RANDOM" "(DEFUN (RANDOM INTEGER) ((N INTEGER)) :PUBLIC? TRUE :DOCUMENTATION \"Generate a random integer in the interval [0..n-1].
The random number generator is seeded based on the current time every
time STELLA starts up; however, your mileage may vary depending on
...
otherwise, return 'ch' unmodified.\" :PUBLIC? TRUE :GLOBALLY-INLINE? TRUE (RETURN (DOWNCASE-CHARACTER CH)))" (CL:FUNCTION CHARACTER-DOWNCASE) NULL)
   (DEFINE-FUNCTION-OBJECT "CHARACTER-UPCASE" "(DEFUN (CHARACTER-UPCASE CHARACTER) ((CH CHARACTER)) :DOCUMENTATION \"If `ch' is uppercase, return its lowercase version,
otherwise, return 'ch' unmodified.  If only the first character of
a sequence of characters is to be capitalized, `character-capitalize'
should be used instead.\" :PUBLIC? TRUE :GLOBALLY-INLINE? TRUE (RETURN (UPCASE-CHARACTER CH)))" (CL:FUNCTION CHARACTER-UPCASE) NULL)
...
or 1, depending on whether `x' is less than, equal, or greater than `y'.
If `case-sensitive?' is true, then case does matter for the comparison\")" (CL:FUNCTION STRING-COMPARE) NULL)
   (DEFINE-METHOD-OBJECT
   ...
   (DEFINE-METHOD-OBJECT
    ...
    (CL:FUNCTION NON-EMPTY?) NULL)
   (DEFINE-FUNCTION-OBJECT "BLANK-STRING?" "(DEFUN (BLANK-STRING? BOOLEAN) ((STRING STRING)) :DOCUMENTATION \"Return true if `string' is either NULL, empty, or only
contains white space characters.\" :PUBLIC? TRUE)" (CL:FUNCTION BLANK-STRING?) NULL)
...
collation.  In this collation `a < A < b' which gives strings that only differ in case a
definite order while otherwise behaving identically to :ascii-case-insensitive.  This is
similar to using a Java Collator for Locale.US with strength set to TERTIARY (which see).\" :PUBLIC? TRUE)" (CL:FUNCTION STRING-COMPARE-CASE-NORMALIZED) NULL)
...
:ascii-case-normalized.  The first two correspond to `string-compare' called with
the appropriate third argument.  :ascii-case-normalized calls the function
`string-compare-case-normalized' (which see).\" :PUBLIC? TRUE)" (CL:FUNCTION COMPARE-STRINGS) NULL)
...
NULL sorts after everything else in any collation.\" :PUBLIC? TRUE)" (CL:FUNCTION SAFE-COMPARE-STRINGS) NULL)
...
of `string1', `string2', and `otherStrings'.  The two mandatory parameters
allow us to optimize the common binary case by not relying on the somewhat
less efficient variable arguments mechanism.\")" (CL:FUNCTION CONCATENATE) NULL))
  :VOID)

(CL:DEFUN HELP-STARTUP-PRIMAL4 ()
  (CL:PROGN
   (DEFINE-FUNCTION-OBJECT "STRING-UPCASE"
    "(DEFUN (STRING-UPCASE STRING) ((STRING STRING)) :DOCUMENTATION \"Return an upper-case copy of `string'.\" :NATIVE? TRUE :PUBLIC? TRUE)" NULL NULL)
   (DEFINE-FUNCTION-OBJECT "STRING-DOWNCASE"
    "(DEFUN (STRING-DOWNCASE STRING) ((STRING STRING)) :DOCUMENTATION \"Return a lower-case copy of `string'.\" :NATIVE? TRUE :PUBLIC? TRUE)" NULL NULL)
   (DEFINE-FUNCTION-OBJECT "STRING-CAPITALIZE"
    "(DEFUN (STRING-CAPITALIZE STRING) ((STRING STRING)) :DOCUMENTATION \"Return a capitalized version of `string'.\" :NATIVE? TRUE :PUBLIC? TRUE)" NULL NULL)
   (DEFINE-METHOD-OBJECT "(DEFMETHOD (COPY STRING) ((STRING STRING)) :DOCUMENTATION \"Return a copy of `string'.\" :NATIVE? TRUE)" NULL NULL)
   (DEFINE-METHOD-OBJECT
...
corresponding member of `new-chars' in the string `self'.  IMPORTANT:  The return
value should be used instead of relying on destructive substitution, since the
substitution will not be destructive in all translated languages.\" :PUBLIC? TRUE)" (CL:FUNCTION SUBSTITUTE-CHARACTERS) NULL)
   (DEFINE-METHOD-OBJECT
...
corresponding member of `new-chars' in the string `self'.  Returns a new string.\" :PUBLIC? TRUE)" (CL:FUNCTION SUBSTITUTE-CHARACTERS) NULL)
...
with its corresponding <value> string.  Replacement is done in sequence which
means (part of) a value might be replaced further with a later <var> and <value>.\" :PUBLIC? TRUE)" (CL:FUNCTION INSTANTIATE-STRING-TEMPLATE) NULL)
...
The final value of target-index is returned.\")" (CL:FUNCTION INSERT-STRING) NULL)
   (DEFINE-FUNCTION-OBJECT "STRING-TRIM" "(DEFUN (STRING-TRIM STRING) ((STRING STRING)) :DOCUMENTATION \"Remove any leading and trailing white space from `string'
and return a copy of the trimmed substring (which might be empty if we had
all white space).  If no white space was removed, `string' is returned
unmodified and uncopied.\" :PUBLIC? TRUE)" (CL:FUNCTION STRING-TRIM) NULL)
 ...
 This is more efficient than using a string stream.\" :NATIVE? TRUE :PUBLIC? TRUE)" NULL NULL)
   (DEFINE-FUNCTION-OBJECT "INT-TO-STRING" "(DEFUN (INT-TO-STRING STRING) ((I INTEGER)) :DOCUMENTATION \"Convert `i' to its string representation and return the result.
This is a convenience function that expects regular integers as opposed to longs
...
the C++ version we have but slower than the native Java version.\" :PUBLIC? TRUE)" (CL:FUNCTION STELLA-INTEGER-TO-STRING-IN-BASE) NULL)
...
Use `parse-long-integer' if the syntax of `string' needs to be checked for errors.\" :NATIVE? TRUE :PUBLIC? TRUE)" NULL NULL)
...
This is a convenience function that ensures a regular integer return value.  If
`string' represents a long integer, the behavior is undefined.  Use `parse-integer'
if the syntax of `string' needs to be checked for errors.\" :GLOBALLY-INLINE? TRUE :PUBLIC? TRUE (RETURN (STRING-TO-INTEGER STRING)))" (CL:FUNCTION STRING-TO-INT) NULL)
   (DEFINE-FUNCTION-OBJECT "STRING-TO-FLOAT" "(DEFUN (STRING-TO-FLOAT FLOAT) ((STRING STRING)) :DOCUMENTATION \"Convert a `string' representation of a float into a float.
Use `parse-float' if the syntax of `string' needs to be checked for errors.\" :NATIVE? TRUE :PUBLIC? TRUE)" NULL NULL)
...
'size', padded if necessary with 0 characters.\")" (CL:FUNCTION ZERO-PAD-INTEGER) NULL)
   (DEFINE-FUNCTION-OBJECT "ZERO-PAD-STRING" "(DEFUN (ZERO-PAD-STRING STRING) ((INPUT STRING) (SIZE INTEGER)) :PUBLIC? FALSE)" (CL:FUNCTION ZERO-PAD-STRING) NULL)
   (DEFINE-METHOD-OBJECT "(DEFMETHOD (MEMBER? BOOLEAN) ((SELF STRING) (CHAR CHARACTER)) :NATIVE? TRUE :PUBLIC? TRUE)" NULL NULL)
   (DEFINE-METHOD-OBJECT
   ...
   (DEFINE-METHOD-OBJECT "(DEFMETHOD (REST STRING) ((SELF STRING)) :NATIVE? TRUE :PUBLIC? TRUE)" NULL NULL)
   (DEFINE-METHOD-OBJECT
...
always be relative to the entire string.\" :NATIVE? TRUE :PUBLIC? TRUE)" NULL NULL)
...
`substring' in `string', beginning from `start'.  Return NULL if it is not
a substring.  The comparison ignores differences in letter case.\" :PUBLIC? TRUE)" (CL:FUNCTION STRING-SEARCH-IGNORE-CASE) NULL)
...
`start' (which defaults to 0 if it is supplied as NULL).\" :PUBLIC? TRUE)" (CL:FUNCTION STARTS-WITH?) NULL)
...
ends with `suffix'.  If `end' is NULL it defaults to the length of `string'.\" :PUBLIC? TRUE)" (CL:FUNCTION ENDS-WITH?) NULL)
...
The search will end when `end1' or `end2' is reached.  If either `end1'
or `end2' is null, then they will be set to the length of their respective
strings.  If there is no mismatch, then `null' values are returned.\")" (CL:FUNCTION FIND-MISMATCH) NULL)
...
character that is not included in `match'.\")" (CL:FUNCTION NON-MATCHING-POSITION) NULL))
  :VOID)
...
the first character that is not white space.\")" (CL:FUNCTION ADVANCE-PAST-WHITESPACE) NULL)
...
trailing whitespace is also not considered.\")" (CL:FUNCTION EQL-EXCEPT-IN-WHITESPACE?) NULL)
   (DEFINE-METHOD-OBJECT
...
`end' value of NULL stands for the rest of the string.\" :NATIVE? TRUE :PUBLIC? TRUE)" NULL NULL)
   (DEFINE-METHOD-OBJECT
...
`end' value of NULL stands for the rest of the string.\" :NATIVE? TRUE :PUBLIC? TRUE)" NULL NULL)
   ...
   (DEFINE-FUNCTION-OBJECT "STRINGIFY" "(DEFUN (STRINGIFY STRING) ((EXPRESSION OBJECT)) :DOCUMENTATION \"Print `expression' onto a string and return the result.
Printing is done with `*printReadably?*' set to true and with `*printPretty?*'
set to false.\" :NATIVE? TRUE :PUBLIC? TRUE)" NULL NULL)
   (DEFINE-FUNCTION-OBJECT "UNSTRINGIFY" "(DEFUN (UNSTRINGIFY OBJECT) ((STRING STRING)) :DOCUMENTATION \"Read a STELLA expression from `string' and return the result.
This is identical to `read-s-expression-from-string'.\" :PUBLIC? TRUE :GLOBALLY-INLINE? TRUE (RETURN (READ-S-EXPRESSION-FROM-STRING STRING)))" (CL:FUNCTION UNSTRINGIFY)
    NULL)
   (DEFINE-METHOD-OBJECT "(DEFMETHOD FREE-HASH-TABLE-VALUES ((SELF ABSTRACT-HASH-TABLE)) :DOCUMENTATION \"Call free on each value in the hash table `self'.\")"
    (CL:FUNCTION FREE-HASH-TABLE-VALUES) NULL)
   (DEFINE-METHOD-OBJECT "(DEFMETHOD INITIALIZE-HASH-TABLE ((SELF ABSTRACT-HASH-TABLE)) :DOCUMENTATION \"Insert a newly-created native hash table into `self'.\")"
    (CL:FUNCTION INITIALIZE-HASH-TABLE) NULL)
   (DEFINE-METHOD-OBJECT "(DEFMETHOD (LOOKUP (LIKE (ANY-VALUE SELF))) ((SELF HASH-TABLE) (KEY (LIKE (ANY-KEY SELF)))) :PUBLIC? TRUE)" (CL:FUNCTION LOOKUP) NULL)
   (DEFINE-METHOD-OBJECT "(DEFMETHOD INSERT-AT ((SELF HASH-TABLE) (KEY (LIKE (ANY-KEY SELF))) (VALUE (LIKE (ANY-VALUE SELF)))) :PUBLIC? TRUE)" (CL:FUNCTION INSERT-AT)
    NULL)
   (DEFINE-METHOD-OBJECT "(DEFMETHOD REMOVE-AT ((SELF HASH-TABLE) (KEY (LIKE (ANY-KEY SELF)))) :PUBLIC? TRUE)" (CL:FUNCTION REMOVE-AT) NULL)
   (DEFINE-METHOD-OBJECT "(DEFMETHOD INITIALIZE-HASH-TABLE ((SELF INTEGER-HASH-TABLE)) :DOCUMENTATION \"Insert a newly-created native hash table into `self'.\")"
    (CL:FUNCTION INITIALIZE-HASH-TABLE) NULL)
   (DEFINE-METHOD-OBJECT "(DEFMETHOD (LOOKUP (LIKE (ANY-VALUE SELF))) ((SELF INTEGER-HASH-TABLE) (KEY INTEGER)) :PUBLIC? TRUE)" (CL:FUNCTION LOOKUP) NULL)
   (DEFINE-METHOD-OBJECT "(DEFMETHOD INSERT-AT ((SELF INTEGER-HASH-TABLE) (KEY INTEGER) (VALUE OBJECT)) :PUBLIC? TRUE)" (CL:FUNCTION INSERT-AT) NULL)
   (DEFINE-METHOD-OBJECT "(DEFMETHOD REMOVE-AT ((SELF INTEGER-HASH-TABLE) (KEY (LIKE (ANY-KEY SELF)))))" (CL:FUNCTION REMOVE-AT) NULL)
   (DEFINE-METHOD-OBJECT "(DEFMETHOD INITIALIZE-HASH-TABLE ((SELF FLOAT-HASH-TABLE)) :DOCUMENTATION \"Insert a newly-created native hash table into `self'.\")"
    (CL:FUNCTION INITIALIZE-HASH-TABLE) NULL)
   (DEFINE-METHOD-OBJECT "(DEFMETHOD (LOOKUP (LIKE (ANY-VALUE SELF))) ((SELF FLOAT-HASH-TABLE) (KEY FLOAT)) :PUBLIC? TRUE)" (CL:FUNCTION LOOKUP) NULL)
   (DEFINE-METHOD-OBJECT "(DEFMETHOD INSERT-AT ((SELF FLOAT-HASH-TABLE) (KEY FLOAT) (VALUE OBJECT)) :PUBLIC? TRUE)" (CL:FUNCTION INSERT-AT) NULL)
   (DEFINE-METHOD-OBJECT "(DEFMETHOD REMOVE-AT ((SELF FLOAT-HASH-TABLE) (KEY (LIKE (ANY-KEY SELF)))))" (CL:FUNCTION REMOVE-AT) NULL)
   (DEFINE-METHOD-OBJECT "(DEFMETHOD INITIALIZE-HASH-TABLE ((SELF STRING-HASH-TABLE)) :DOCUMENTATION \"Insert a newly-created native hash table into `self'.\")"
    (CL:FUNCTION INITIALIZE-HASH-TABLE) NULL)
   (DEFINE-METHOD-OBJECT "(DEFMETHOD (LOOKUP (LIKE (ANY-VALUE SELF))) ((SELF STRING-HASH-TABLE) (KEY STRING)) :PUBLIC? TRUE)" (CL:FUNCTION LOOKUP) NULL)
   (DEFINE-METHOD-OBJECT "(DEFMETHOD INSERT-AT ((SELF STRING-HASH-TABLE) (KEY STRING) (VALUE OBJECT)) :PUBLIC? TRUE)" (CL:FUNCTION INSERT-AT) NULL)
   (DEFINE-METHOD-OBJECT "(DEFMETHOD REMOVE-AT ((SELF STRING-HASH-TABLE) (KEY STRING)) :PUBLIC? TRUE)" (CL:FUNCTION REMOVE-AT) NULL)
   (DEFINE-METHOD-OBJECT
    ...
    (CL:FUNCTION INITIALIZE-HASH-TABLE) NULL)
   (DEFINE-METHOD-OBJECT "(DEFMETHOD (LOOKUP INTEGER) ((SELF STRING-TO-INTEGER-HASH-TABLE) (KEY STRING)) :PUBLIC? TRUE)" (CL:FUNCTION LOOKUP) NULL)
   (DEFINE-METHOD-OBJECT "(DEFMETHOD INSERT-AT ((SELF STRING-TO-INTEGER-HASH-TABLE) (KEY STRING) (VALUE INTEGER)) :PUBLIC? TRUE)" (CL:FUNCTION INSERT-AT) NULL)
   (DEFINE-METHOD-OBJECT "(DEFMETHOD REMOVE-AT ((SELF STRING-TO-INTEGER-HASH-TABLE) (KEY STRING)) :PUBLIC? TRUE)" (CL:FUNCTION REMOVE-AT) NULL)
...
always hashes on the address of `self' even if it is a wrapper.\" :PUBLIC? TRUE :GLOBALLY-INLINE? TRUE (RETURN (VERBATIM :COMMON-LISP \"(STELLA::%%OBJECT-HASH-CODE SELF)\" :CPP \"(size_t)self\" :JAVA \"self.hashCode()\")))"
   ...
   (DEFINE-METHOD-OBJECT "(DEFMETHOD (HASH-CODE INTEGER) ((SELF OBJECT)) :DOCUMENTATION \"Return a hash code for `self' (can be negative).  Two objects that are `eql?'
are guaranteed to generate the same hash code.  Two objects that are not `eql?'
do not necessarily generate different hash codes.\" :PUBLIC? TRUE)" (CL:FUNCTION HASH-CODE) NULL)
   (DEFINE-FUNCTION-OBJECT "SAFE-HASH-CODE" "(DEFUN (SAFE-HASH-CODE INTEGER) ((SELF OBJECT)) :DOCUMENTATION \"Return a hash code for `self'.  Just like `hash-code'
- which see, but also works for NULL.\" :PUBLIC? TRUE)" (CL:FUNCTION SAFE-HASH-CODE) NULL)
   (DEFINE-METHOD-OBJECT "(DEFMETHOD (HASH-CODE INTEGER) ((SELF STANDARD-OBJECT)) :PUBLIC? TRUE :GLOBALLY-INLINE? TRUE (RETURN (OBJECT-HASH-CODE SELF)))"
    (CL:FUNCTION HASH-CODE) NULL)
   (DEFINE-METHOD-OBJECT "(DEFMETHOD (HASH-CODE INTEGER) ((SELF WRAPPER)) :PUBLIC? TRUE)" (CL:FUNCTION HASH-CODE) NULL)
   (DEFINE-METHOD-OBJECT "(DEFMETHOD (HASH-CODE INTEGER) ((SELF STRING-WRAPPER)) :PUBLIC? TRUE :GLOBALLY-INLINE? TRUE (RETURN (HASH-CODE (WRAPPER-VALUE SELF))))"
    (CL:FUNCTION HASH-CODE) NULL)
   (DEFINE-METHOD-OBJECT "(DEFMETHOD (HASH-CODE INTEGER) ((SELF INTEGER-WRAPPER)) :PUBLIC? TRUE :GLOBALLY-INLINE? TRUE (RETURN (HASH-CODE (WRAPPER-VALUE SELF))))"
    (CL:FUNCTION HASH-CODE) NULL)
   (DEFINE-METHOD-OBJECT "(DEFMETHOD (HASH-CODE INTEGER) ((SELF LONG-INTEGER-WRAPPER)) :PUBLIC? TRUE :GLOBALLY-INLINE? TRUE (RETURN (HASH-CODE (WRAPPER-VALUE SELF))))"
    (CL:FUNCTION HASH-CODE) NULL)
   (DEFINE-METHOD-OBJECT "(DEFMETHOD (HASH-CODE INTEGER) ((SELF FLOAT-WRAPPER)) :PUBLIC? TRUE :GLOBALLY-INLINE? TRUE (RETURN (HASH-CODE (WRAPPER-VALUE SELF))))"
    (CL:FUNCTION HASH-CODE) NULL)
   (DEFINE-METHOD-OBJECT "(DEFMETHOD (HASH-CODE INTEGER) ((SELF CHARACTER-WRAPPER)) :PUBLIC? TRUE :GLOBALLY-INLINE? TRUE (RETURN (HASH-CODE (WRAPPER-VALUE SELF))))"
    (CL:FUNCTION HASH-CODE) NULL)
   (DEFINE-METHOD-OBJECT
   ...
   (DEFINE-METHOD-OBJECT
    ...
    (CL:FUNCTION HASH-CODE) NULL)
   (DEFINE-METHOD-OBJECT "(DEFMETHOD (HASH-CODE INTEGER) ((SELF INTEGER)) :PUBLIC? TRUE :GLOBALLY-INLINE? TRUE (RETURN SELF))" (CL:FUNCTION HASH-CODE) NULL)
   (DEFINE-METHOD-OBJECT
...
- which see, but also works for NULL.  `equal-hash-code' methods that expect to
handle NULL components should use this function for recursive calls.\" :PUBLIC? TRUE)" (CL:FUNCTION SAFE-EQUAL-HASH-CODE) NULL)
...
having to concatenate them.\" (LET ((CODE SEEDCODE) (CURSOR (LENGTH STRING))) (IF (= CURSOR 0) (RETURN 4303803) (-- CURSOR)) (LOOP (SETQ CODE (LOGXOR CODE (AREF *HASH-BYTE-RANDOM-TABLE* (CHARACTER-CODE (NTH STRING CURSOR))))) (IF (= CURSOR 0) (BREAK) (-- CURSOR)) (SETQ CODE (ROTATE-HASH-CODE CODE))) (RETURN CODE)))"
   ...
   (DEFINE-METHOD-OBJECT "(DEFMETHOD INITIALIZE-VECTOR ((SELF VECTOR)))" (CL:FUNCTION INITIALIZE-VECTOR) NULL)
...
than the current size of `self' the vector will be truncated.  Otherwise, 
the internal array of `self' will be grown to `size' and unused elements
will be initialized to NULL.\" :PUBLIC? TRUE)" (CL:FUNCTION RESIZE-VECTOR) NULL)
   (DEFINE-METHOD-OBJECT
   ...
   (DEFINE-METHOD-OBJECT
    ...
    (CL:FUNCTION NTH-SETTER) NULL)
   (DEFINE-FUNCTION-OBJECT "UNMAKE" "(DEFUN UNMAKE ((SELF OBJECT)))" (CL:FUNCTION UNMAKE) NULL)
...
Note that this does not necessarily mean that the directory can also be read.
This does not handle any necessary pathname translations or error conditions.\" :PUBLIC? TRUE)" (CL:FUNCTION NATIVE-PROBE-DIRECTORY?) NULL)
   (DEFINE-FUNCTION-OBJECT "PROBE-FILE?" "(DEFUN (PROBE-FILE? BOOLEAN) ((FILENAME FILE-NAME)) :DOCUMENTATION \"Return true if file `fileName' exists.  Note that this does
not necessarily mean that the file can also be read.
IMPORTANT Java idiosyncrasy: if file `foo/bar' exists and is not a directory,
Java will also say `foo/bar/' exists, which is different behavior than in Lisp
and C++.  For this reason, make sure to always use `probe-directory?' to test
whether a directory exists.\" :PUBLIC? TRUE)" (CL:FUNCTION PROBE-FILE?) NULL)
...
Note that this does not necessarily mean that the directory can also be read.\" :PUBLIC? TRUE)" (CL:FUNCTION PROBE-DIRECTORY?) NULL))
  :VOID)
...
NULL if that cannot be determined.\" :PUBLIC? TRUE)" (CL:FUNCTION FILE-WRITE-DATE) NULL)
...
pathname translations or error conditions.\" :NATIVE? TRUE :PUBLIC? TRUE)" NULL NULL)
   (DEFINE-FUNCTION-OBJECT "DELETE-FILE" "(DEFUN DELETE-FILE ((FILENAME FILE-NAME)) :DOCUMENTATION \"Delete the file `fileName'.\" :PUBLIC? TRUE)"
...
any necessary pathname translations or error conditions.\" :NATIVE? TRUE :PUBLIC? TRUE)" NULL NULL)
   (DEFINE-FUNCTION-OBJECT "RENAME-FILE"
    "(DEFUN RENAME-FILE ((FROMFILE FILE-NAME) (TOFILE FILE-NAME)) :DOCUMENTATION \"Rename the file `fromFile' to `toFile'.\" :PUBLIC? TRUE)" (CL:FUNCTION RENAME-FILE)
    NULL)
   ...
   (DEFINE-FUNCTION-OBJECT "COPY-FILE" "(DEFUN COPY-FILE ((FROMFILE FILE-NAME) (TOFILE FILE-NAME)) :DOCUMENTATION \"Copy file `fromFile' to file `toFile', clobbering
any data already in `toFile'.\" :PUBLIC? TRUE)" (CL:FUNCTION COPY-FILE) NULL)
   (DEFINE-FUNCTION-OBJECT "GET-TEMP-DIRECTORY" "(DEFUN (GET-TEMP-DIRECTORY STRING) () :DOCUMENTATION \"Return a suitable directory for temporary files.
Uses the value of `stella.tempDirectory' if defined; otherwise, it
will use a suitable OS-specific default.  The returned directory will
end in a separator for immediate concatenation with a physical filename.\" :PUBLIC? TRUE)" (CL:FUNCTION GET-TEMP-DIRECTORY) NULL)
...
NULL will be returned.  Note that it is possible due to multi-threading
or processing that the generated filename becomes used by another thread
or OS process.  If necessary, this case can be handled by the caller.\" :PUBLIC? TRUE)" (CL:FUNCTION MAKE-TEMPORARY-FILE-NAME) NULL)
...
allocates the file to prevent other processes from using that name.
This is still not fully thread safe - for that we would need a file lock -
but maybe a bit better in avoiding collisions.\" :PUBLIC? TRUE)" (CL:FUNCTION MAKE-TEMPORARY-FILE) NULL)
   (DEFINE-FUNCTION-OBJECT "CL-LIST-DIRECTORY-FILES" "(DEFUN (CL-LIST-DIRECTORY-FILES (CONS OF STRING-WRAPPER)) ((DIRECTORY STRING)))"
    (CL:FUNCTION CL-LIST-DIRECTORY-FILES) NULL)
   (DEFINE-FUNCTION-OBJECT "CPP-LIST-DIRECTORY-FILES" "(DEFUN (CPP-LIST-DIRECTORY-FILES (CONS OF STRING-WRAPPER)) ((DIRECTORY STRING)))"
    (CL:FUNCTION CPP-LIST-DIRECTORY-FILES) NULL)
   (DEFINE-FUNCTION-OBJECT "JAVA-LIST-DIRECTORY-FILES" "(DEFUN (JAVA-LIST-DIRECTORY-FILES (CONS OF STRING-WRAPPER)) ((DIRECTORY STRING)))"
...
directories.  Handles logical pathnames but resulting files will always use physical pathname
syntax.  This is mostly consistent across native languages, but some differences still exist -
e.g., Lisp will convert . or .. into absolute pathnames.\" :PUBLIC? TRUE :COMMAND? TRUE)" (CL:FUNCTION %LIST-DIRECTORY-FILES)
...
a `directory' component.  Files in subdirectories will be prefixed with the relative
subdirectory path starting right below `directory'.  The sort order is lexicographic
within directories which results in a depth-first presentation order of files.\" :PUBLIC? TRUE :COMMAND? TRUE)" (CL:FUNCTION %LIST-DIRECTORY-FILES-RECURSIVELY)
   ...
   (DEFINE-METHOD-OBJECT
    ...
    (CL:FUNCTION LOGXOR) NULL)
   (DEFINE-FUNCTION-OBJECT "INTEGER-LENGTH" "(DEFUN (INTEGER-LENGTH INTEGER) ((X LONG-INTEGER)) :DOCUMENTATION \"Return the 1-based position of the left-most bit in `x'.
If `x' is negative, we only count the value bits, not the sign.\" :PUBLIC? TRUE)" (CL:FUNCTION INTEGER-LENGTH) NULL)
...
in the base-10 representation of `x'.  If `x' is negative, we only consider
its absolute value, not the sign.  This effectively computes the minimum number
of base-10 digits to represent `x', with the exception of x=0.\" :PUBLIC? TRUE)" (CL:FUNCTION INTEGER-LENGTH10) NULL)
   (DEFINE-METHOD-OBJECT
   ...
   (DEFINE-METHOD-OBJECT
    ...
    (CL:FUNCTION SHIFT-LEFT) NULL)
   (DEFINE-METHOD-OBJECT "(DEFMETHOD (SHIFT-RIGHT INTEGER) ((ARG INTEGER) (COUNT INTEGER)) :DOCUMENTATION \"Shift `arg' to the right by `count' positions and
0-extend from the left if `arg' is positive or 1-extend if it is
negative.  This is an arithmetic shift that preserve the sign of `arg'
and is equivalent to dividing `arg' by 2** `count'.\" :GLOBALLY-INLINE? TRUE :PUBLIC? TRUE (RETURN (VERBATIM :COMMON-LISP (CL:ASH ARG (CL:THE CL:FIXNUM (CL:- COUNT))) :CPP \"(arg >> count)\" :JAVA \"(arg >> count)\")))"
   ...
   (DEFINE-METHOD-OBJECT "(DEFMETHOD (SHIFT-RIGHT LONG-INTEGER) ((ARG LONG-INTEGER) (COUNT INTEGER)) :DOCUMENTATION \"Shift `arg' to the right by `count' positions and
0-extend from the left if `arg' is positive or 1-extend if it is
negative.  This is an arithmetic shift that preserve the sign of `arg'
and is equivalent to dividing `arg' by 2** `count'.\" :GLOBALLY-INLINE? TRUE :PUBLIC? TRUE (RETURN (VERBATIM :COMMON-LISP (CL:ASH ARG (CL:THE CL:FIXNUM (CL:- COUNT))) :CPP \"(arg >> count)\" :JAVA \"(arg >> count)\")))"
    (CL:FUNCTION SHIFT-RIGHT) NULL)
   (DEFINE-METHOD-OBJECT "(DEFMETHOD (UNSIGNED-SHIFT-RIGHT-BY-1 INTEGER) ((ARG INTEGER)) :DOCUMENTATION \"Shift `arg' to the right by 1 position and 0-extend
from the left.  This does not preserve the sign of `arg' and shifts
the sign-bit just like a regular bit.  In Common-Lisp we can't do that
directly and need to do some extra masking.\" :GLOBALLY-INLINE? TRUE :PUBLIC? TRUE (RETURN (VERBATIM :COMMON-LISP (CL:LOGAND (CL:THE CL:FIXNUM (CL:ASH ARG -1)) *INTEGER-UNSIGNED-BITS-MASK*) :CPP \"((unsigned int)arg >> 1)\" :JAVA \"(arg >>> 1)\")))"
   ...
   (DEFINE-METHOD-OBJECT "(DEFMETHOD (UNSIGNED-SHIFT-RIGHT-BY-1 LONG-INTEGER) ((ARG LONG-INTEGER)) :DOCUMENTATION \"Shift `arg' to the right by 1 position and 0-extend
from the left.  This does not preserve the sign of `arg' and shifts
the sign-bit just like a regular bit.  In Common-Lisp we can't do that
...
a subset of the IETF RFC 4122 (see http://www.ietf.org/rfc/rfc4122.txt )
UUID types.  Currently supported are:
    :TYPE-4  :RANDOM       A type-4 (random) UUID.  These are synonyms.\")" (CL:FUNCTION GENERATE-UUID) NULL)
...
To make the string representation, take the hexadecimal presentation of bytes 1-4
   (without 0x in front of it) let them follow by a -, then take bytes 5 and 6, - 
bytes 7 and 8, - bytes 9 and 10, - then followed by bytes 11-16.\")" (CL:FUNCTION GENERATE-RANDOM-UUID) NULL)
   (DEFINE-FUNCTION-OBJECT "STELLIFY" "(DEFUN (STELLIFY OBJECT) ((SELF OBJECT)) :DOCUMENTATION \"Convert a Lisp object into a STELLA object.\" :PUBLIC? TRUE)"
    (CL:FUNCTION STELLIFY) NULL)
   (DEFINE-FUNCTION-OBJECT "STELLA-OBJECT?"
    "(DEFUN (STELLA-OBJECT? BOOLEAN) ((SELF OBJECT)) :DOCUMENTATION \"Return true if `self' is a member of the STELLA class `OBJECT'.\")" (CL:FUNCTION STELLA-OBJECT?)
    NULL)
   ...
   (DEFINE-FUNCTION-OBJECT "GET-TICKTOCK" "(DEFUN (GET-TICKTOCK TICKTOCK) () :DOCUMENTATION \"Return the current CPU time.  If the current OS/Language
...
normally be some fractional value of a second.\" :PUBLIC? TRUE :NATIVE? TRUE)" NULL NULL)
   (DEFINE-FUNCTION-OBJECT "TICKTOCK-RESOLUTION" "(DEFUN (TICKTOCK-RESOLUTION FLOAT) () :DOCUMENTATION \"The minimum theoretically detectable resolution of the
...
be larger than this resolution.\" :PUBLIC? TRUE :NATIVE? TRUE)" NULL NULL)
   (DEFINE-FUNCTION-OBJECT "SLEEP" "(DEFUN SLEEP ((SECONDS FLOAT)) :DOCUMENTATION \"The program will sleep for the indicated number of seconds.
Fractional values are allowed, but the results are implementation dependent:
Common Lisp uses the fractions natively, Java with a resolution of 0.001,
...
exception `e'.  For example, in Java it prints a stack trace.  In Lisp, it is vendor dependent.\" :PUBLIC? TRUE)" (CL:FUNCTION PRINT-EXCEPTION-CONTEXT) NULL)
   ...
   (DEFINE-FUNCTION-OBJECT "MAKE-PROCESS-LOCK" "(DEFUN (MAKE-PROCESS-LOCK PROCESS-LOCK-OBJECT) () :PUBLIC? TRUE)" (CL:FUNCTION MAKE-PROCESS-LOCK) NULL)
   (DEFINE-FUNCTION-OBJECT "STARTUP-PRIMAL" "(DEFUN STARTUP-PRIMAL () :PUBLIC? TRUE)" (CL:FUNCTION STARTUP-PRIMAL) NULL)
   (CL:LET* ((FUNCTION (LOOKUP-FUNCTION SYM-PRIMAL-STELLA-STARTUP-PRIMAL)))
    (SET-DYNAMIC-SLOT-VALUE (%DYNAMIC-SLOTS FUNCTION) SYM-PRIMAL-STELLA-METHOD-STARTUP-CLASSNAME (WRAP-STRING "_StartupPrimal") NULL-STRING-WRAPPER)))
  :VOID)

(CL:DEFUN STARTUP-PRIMAL ()
  (CL:WHEN (CURRENT-STARTUP-TIME-PHASE? 0) (CL:SETQ *HASH-BYTE-RANDOM-TABLE* (CL:MAKE-ARRAY 256))
   (CL:LET* ((I NULL-INTEGER) (ITER-005 0) (UPPER-BOUND-006 255)) (CL:DECLARE (CL:TYPE CL:FIXNUM I ITER-005 UPPER-BOUND-006))
    (CL:LOOP WHILE (CL:<= ITER-005 UPPER-BOUND-006) DO (CL:SETQ I ITER-005) (CL:SETF (CL:AREF *HASH-BYTE-RANDOM-TABLE* I) 0) (CL:SETQ ITER-005 (CL:1+ ITER-005))))
   (CL:LET*
    ((BIT NULL-INTEGER) (ITER-007 0) (UPPER-BOUND-008 #.(cl:1- (cl:integer-length cl:most-positive-fixnum))) (UNBOUNDED?-009 (CL:= UPPER-BOUND-008 NULL-INTEGER)))
    (CL:DECLARE (CL:TYPE CL:FIXNUM BIT ITER-007 UPPER-BOUND-008))
    (CL:LOOP WHILE (CL:OR UNBOUNDED?-009 (CL:<= ITER-007 UPPER-BOUND-008)) DO (CL:SETQ BIT ITER-007)
     (CL:LET* ((I NULL-INTEGER) (ITER-010 0) (UPPER-BOUND-011 255)) (CL:DECLARE (CL:TYPE CL:FIXNUM I ITER-010 UPPER-BOUND-011))
      (CL:LOOP WHILE (CL:<= ITER-010 UPPER-BOUND-011) DO (CL:SETQ I ITER-010)
       (CL:SETF (CL:AREF *HASH-BYTE-RANDOM-TABLE* I)
        (CL:THE CL:FIXNUM (CL:LOGIOR (CL:THE CL:FIXNUM (CL:AREF *HASH-BYTE-RANDOM-TABLE* I)) (CL:THE CL:FIXNUM (CL:ASH (CL:THE CL:FIXNUM (RANDOM 2)) BIT)))))
       (CL:SETQ ITER-010 (CL:1+ ITER-010))))
     (CL:SETQ ITER-007 (CL:1+ ITER-007))))
   (CL:SETQ *HASH-TABLE-SIZE-PRIME-STRINGS*
    (VECTOR (WRAP-STRING "29") (WRAP-STRING "53") (WRAP-STRING "97") (WRAP-STRING "193") (WRAP-STRING "389") (WRAP-STRING "769") (WRAP-STRING "1543")
     (WRAP-STRING "3079") (WRAP-STRING "6151") (WRAP-STRING "12289") (WRAP-STRING "24593") (WRAP-STRING "49157") (WRAP-STRING "98317") (WRAP-STRING "196613")
     (WRAP-STRING "393241") (WRAP-STRING "786433") (WRAP-STRING "1572869") (WRAP-STRING "3145739") (WRAP-STRING "6291469") (WRAP-STRING "12582917")
     (WRAP-STRING "25165843") (WRAP-STRING "50331653") (WRAP-STRING "100663319") (WRAP-STRING "201326611") (WRAP-STRING "402653189") (WRAP-STRING "805306457")
  ...
  (CL:LET* ((*MODULE* *STELLA-MODULE*) (*CONTEXT* *MODULE*)) (CL:DECLARE (CL:SPECIAL *MODULE* *CONTEXT*))
   ...
   (CL:WHEN (CURRENT-STARTUP-TIME-PHASE? 4) (CL:SETQ MOST-NEGATIVE-INTEGER (CL:1+ NULL-INTEGER)) (CL:SETQ MOST-NEGATIVE-LONG-INTEGER (CL:1+ NULL-LONG-INTEGER))
    (CL:SETQ LEAST-NEGATIVE-FLOAT (CL:- 0 LEAST-POSITIVE-FLOAT)) (CL:SETQ RECIPROCAL-NL2 (CL:/ 1.0d0 (CL:THE CL:DOUBLE-FLOAT (CL:LOG 2.0d0))))
    (CL:SETQ RECIPROCAL-NL10 (CL:/ 1.0d0 (CL:THE CL:DOUBLE-FLOAT (CL:LOG 10.0d0))))
    (CL:SETQ LONG-INTEGER-BIT-WIDTH
     (ROUND (CL:/ (CL:THE CL:DOUBLE-FLOAT (CL:LOG (CL:THE CL:DOUBLE-FLOAT (CL:* MOST-POSITIVE-LONG-INTEGER 2.0d0)))) (CL:THE CL:DOUBLE-FLOAT (CL:LOG 2.0d0))))))
   (CL:WHEN (CURRENT-STARTUP-TIME-PHASE? 6) (FINALIZE-CLASSES))
   (CL:WHEN (CURRENT-STARTUP-TIME-PHASE? 7) (HELP-STARTUP-PRIMAL2) (HELP-STARTUP-PRIMAL3) (HELP-STARTUP-PRIMAL4) (HELP-STARTUP-PRIMAL5) (HELP-STARTUP-PRIMAL6))
   ...
   (CL:WHEN (CURRENT-STARTUP-TIME-PHASE? 9) (%IN-MODULE (COPY-CONS-TREE (WRAP-STRING "/STELLA")))
    ...
    (DEFINE-STELLA-GLOBAL-VARIABLE-FROM-STRINGIFIED-SOURCE "(defconstant NULL UNKNOWN NULL
       :public? TRUE
       :documentation
...
type.  For example, NULL-INTEGER represents the undefined INTEGER value.\")")
    ...
    (DEFINE-STELLA-GLOBAL-VARIABLE-FROM-STRINGIFIED-SOURCE "(DEFCONSTANT NULL-BYTE BYTE (VERBATIM :COMMON-LISP \"255\" :CPP \"255\" :JAVA \"-128\") :PUBLIC? TRUE)")
    (DEFINE-STELLA-GLOBAL-VARIABLE-FROM-STRINGIFIED-SOURCE "(DEFCONSTANT NULL-OCTET OCTET (VERBATIM :COMMON-LISP \"255\" :CPP \"255\" :JAVA \"-128\") :PUBLIC? TRUE)")
    (DEFINE-STELLA-GLOBAL-VARIABLE-FROM-STRINGIFIED-SOURCE
    ...
    (DEFINE-STELLA-GLOBAL-VARIABLE-FROM-STRINGIFIED-SOURCE "(DEFCONSTANT MOST-NEGATIVE-INTEGER INTEGER (1+ NULL-INTEGER) :PUBLIC? TRUE)")
    (DEFINE-STELLA-GLOBAL-VARIABLE-FROM-STRINGIFIED-SOURCE
    ...
    (DEFINE-STELLA-GLOBAL-VARIABLE-FROM-STRINGIFIED-SOURCE "(DEFCONSTANT MOST-NEGATIVE-LONG-INTEGER LONG-INTEGER (1+ NULL-LONG-INTEGER) :PUBLIC? TRUE)")
    (DEFINE-STELLA-GLOBAL-VARIABLE-FROM-STRINGIFIED-SOURCE
    ...
    (DEFINE-STELLA-GLOBAL-VARIABLE-FROM-STRINGIFIED-SOURCE "(DEFCONSTANT MOST-NEGATIVE-FLOAT FLOAT (VERBATIM :COMMON-LISP \"(cl:multiple-value-bind (signif expon)
                (cl:integer-decode-float cl:most-positive-double-float)
    ...
    (DEFINE-STELLA-GLOBAL-VARIABLE-FROM-STRINGIFIED-SOURCE "(DEFCONSTANT LEAST-NEGATIVE-FLOAT FLOAT (- LEAST-POSITIVE-FLOAT) :PUBLIC? TRUE)")
...
Used for log 10 conversions.\")")
    (REGISTER-NATIVE-NAME SYM-PRIMAL-STELLA-FLOOR KWD-PRIMAL-CPP KWD-PRIMAL-FUNCTION) (REGISTER-NATIVE-NAME SYM-PRIMAL-STELLA-ROUND KWD-PRIMAL-CPP KWD-PRIMAL-FUNCTION)
    (REGISTER-NATIVE-NAME SYM-PRIMAL-STELLA-FMOD KWD-PRIMAL-CPP KWD-PRIMAL-FUNCTION) (REGISTER-NATIVE-NAME SYM-PRIMAL-STELLA-RANDOM KWD-PRIMAL-CPP KWD-PRIMAL-FUNCTION)
    (REGISTER-NATIVE-NAME SYM-PRIMAL-STELLA-SQRT KWD-PRIMAL-CPP KWD-PRIMAL-FUNCTION) (REGISTER-NATIVE-NAME SYM-PRIMAL-STELLA-COS KWD-PRIMAL-CPP KWD-PRIMAL-FUNCTION)
    (REGISTER-NATIVE-NAME SYM-PRIMAL-STELLA-SIN KWD-PRIMAL-CPP KWD-PRIMAL-FUNCTION) (REGISTER-NATIVE-NAME SYM-PRIMAL-STELLA-TAN KWD-PRIMAL-CPP KWD-PRIMAL-FUNCTION)
    (REGISTER-NATIVE-NAME SYM-PRIMAL-STELLA-ACOS KWD-PRIMAL-CPP KWD-PRIMAL-FUNCTION) (REGISTER-NATIVE-NAME SYM-PRIMAL-STELLA-ASIN KWD-PRIMAL-CPP KWD-PRIMAL-FUNCTION)
    (REGISTER-NATIVE-NAME SYM-PRIMAL-STELLA-ATAN KWD-PRIMAL-CPP KWD-PRIMAL-FUNCTION) (REGISTER-NATIVE-NAME SYM-PRIMAL-STELLA-ATAN2 KWD-PRIMAL-CPP KWD-PRIMAL-FUNCTION)
    (REGISTER-NATIVE-NAME SYM-PRIMAL-STELLA-EXP KWD-PRIMAL-CPP KWD-PRIMAL-FUNCTION) (REGISTER-NATIVE-NAME SYM-PRIMAL-STELLA-LOG KWD-PRIMAL-CPP KWD-PRIMAL-FUNCTION)
    (REGISTER-NATIVE-NAME SYM-PRIMAL-STELLA-MIN KWD-PRIMAL-CPP KWD-PRIMAL-FUNCTION) (REGISTER-NATIVE-NAME SYM-PRIMAL-STELLA-MAX KWD-PRIMAL-CPP KWD-PRIMAL-FUNCTION)
    (DEFINE-STELLA-GLOBAL-VARIABLE-FROM-STRINGIFIED-SOURCE "(DEFSPECIAL *TRANSIENTOBJECTS?* BOOLEAN FALSE :PUBLIC? TRUE)")
    (REGISTER-NATIVE-NAME SYM-PRIMAL-STELLA-HASH-CODE KWD-PRIMAL-JAVA KWD-PRIMAL-FUNCTION)
    (DEFINE-STELLA-GLOBAL-VARIABLE-FROM-STRINGIFIED-SOURCE
...
that are suitable to be used as hash table sizes.\" :PUBLIC? TRUE)")
    (REGISTER-NATIVE-NAME SYM-PRIMAL-STELLA-LIST-DIRECTORY-FILES KWD-PRIMAL-COMMON-LISP KWD-PRIMAL-FUNCTION)
    (REGISTER-NATIVE-NAME SYM-PRIMAL-STELLA-LIST-DIRECTORY-FILES-RECURSIVELY KWD-PRIMAL-COMMON-LISP KWD-PRIMAL-FUNCTION)
    (DEFINE-STELLA-GLOBAL-VARIABLE-FROM-STRINGIFIED-SOURCE
    ...
    (REGISTER-NATIVE-NAME SYM-PRIMAL-STELLA-SLEEP KWD-PRIMAL-CPP KWD-PRIMAL-FUNCTION)
    (DEFINE-STELLA-GLOBAL-VARIABLE-FROM-STRINGIFIED-SOURCE
