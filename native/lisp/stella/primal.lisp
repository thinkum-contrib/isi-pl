...
(CL:DECLAIM
 (CL:SPECIAL *STELLA-MODULE* *MODULE* *TOKENIZER-INITIAL-BUFFER-SIZE* *USE-STELLA-HASH-TABLES?* NIL
  *CHARACTER-TYPE-TABLE* *CHARACTER-UPCASE-TABLE* *CHARACTER-DOWNCASE-TABLE* STANDARD-OUTPUT EOL *INTEGER-MSB-MASK*
  *INTEGER-UNSIGNED-BITS-MASK* *LONG-INTEGER-MSB-MASK* *LONG-INTEGER-UNSIGNED-BITS-MASK* LONG-INTEGER-BIT-WIDTH))
...
(CL:DEFUN LISP-NULL-ARRAY-SYMBOL-STRING (RANK)
  ...
  (CL:CASE RANK (1 (CL:RETURN-FROM LISP-NULL-ARRAY-SYMBOL-STRING "STELLA::NULL-1D-ARRAY"))
   (2 (CL:RETURN-FROM LISP-NULL-ARRAY-SYMBOL-STRING "STELLA::NULL-2D-ARRAY"))
   (3 (CL:RETURN-FROM LISP-NULL-ARRAY-SYMBOL-STRING "STELLA::NULL-3D-ARRAY"))
   (4 (CL:RETURN-FROM LISP-NULL-ARRAY-SYMBOL-STRING "STELLA::NULL-4D-ARRAY"))
   (5 (CL:RETURN-FROM LISP-NULL-ARRAY-SYMBOL-STRING "STELLA::NULL-5D-ARRAY"))
   (CL:OTHERWISE (CL:RETURN-FROM LISP-NULL-ARRAY-SYMBOL-STRING "STELLA::NULL"))))
...
(CL:DEFUN PRINT-NUMERIC-CONSTANTS ()
  (%%PRINT-STREAM (%NATIVE-STREAM STANDARD-OUTPUT) "MOST-POSITIVE-INTEGER:             " MOST-POSITIVE-INTEGER EOL
   "MOST-NEGATIVE-INTEGER:            " MOST-NEGATIVE-INTEGER EOL "NULL-INTEGER:                     " NULL-INTEGER EOL
   "MOST-POSITIVE-LONG-INTEGER:        " MOST-POSITIVE-LONG-INTEGER EOL "MOST-NEGATIVE-LONG-INTEGER:       "
   MOST-NEGATIVE-LONG-INTEGER EOL "NULL-LONG-INTEGER:                " NULL-LONG-INTEGER EOL
   "MOST-POSITIVE-FLOAT:               " MOST-POSITIVE-FLOAT EOL "MOST-NEGATIVE-FLOAT:              "
   MOST-NEGATIVE-FLOAT EOL "LEAST-POSITIVE-FLOAT:              " LEAST-POSITIVE-FLOAT EOL
   "LEAST-NEGATIVE-FLOAT:             " LEAST-NEGATIVE-FLOAT EOL "NULL-FLOAT:                       " NULL-FLOAT EOL
   "*INTEGER-MSB-MASK*:                " *INTEGER-MSB-MASK* EOL "*INTEGER-UNSIGNED-BITS-MASK*:      "
   *INTEGER-UNSIGNED-BITS-MASK* EOL "*LONG-INTEGER-MSB-MASK*:           " *LONG-INTEGER-MSB-MASK* EOL
   "*LONG-INTEGER-UNSIGNED-BITS-MASK*: " *LONG-INTEGER-UNSIGNED-BITS-MASK* EOL "LONG-INTEGER-BIT-WIDTH:            "
   LONG-INTEGER-BIT-WIDTH EOL "il(MOST-POSITIVE-INTEGER):         "
   (INTEGER-LENGTH (CL:TRUNCATE MOST-POSITIVE-INTEGER)) EOL "il(MOST-POSITIVE-LONG-INTEGER):    "
   (INTEGER-LENGTH MOST-POSITIVE-LONG-INTEGER) EOL "il(MOST-NEGATIVE-INTEGER):         "
   (INTEGER-LENGTH (CL:TRUNCATE MOST-NEGATIVE-INTEGER)) EOL "il(MOST-NEGATIVE-LONG-INTEGER):    "
...
(CL:DEFUN GCD (X Y)
  ...
  (CL:LET* ((TEMP 0)) (CL:LOOP WHILE (CL:NOT (CL:= Y 0)) DO (CL:SETQ TEMP (CL:REM X Y)) (CL:SETQ X Y) (CL:SETQ Y TEMP))
...
or from decimal hours to Hour-Minute-Second format."
  ...
  (CL:LET*
   ((DEGREE (FLOOR X)) (MINUTE (FLOOR (CL:* (CL:- X DEGREE) 60.0d0)))
    (FSECOND (CL:- (CL:* X 3600.0d0) (CL:* DEGREE 3600.0d0) (CL:* MINUTE 60.0d0))))
   (CL:DECLARE (CL:TYPE CL:FIXNUM DEGREE MINUTE) (CL:TYPE CL:DOUBLE-FLOAT FSECOND))
   (CL:IF ALL-INTEGERS?
    (CL:RETURN-FROM FLOAT-TO-BASE60
     (CONS-LIST (WRAP-INTEGER DEGREE) (WRAP-INTEGER MINUTE) (WRAP-INTEGER (ROUND FSECOND))))
...
or from Hour-Minute-Second format to decimal hours."
  (CL:LET* ((DVALUE (%%VALUE L)) (MVALUE (%%VALUE (%%REST L))) (SVALUE (%%VALUE (%%REST (%%REST L)))) (D 0.0d0))
    ...
    (CL:COND ((SUBTYPE-OF-FLOAT? TEST-VALUE-001) (CL:PROGN (CL:SETQ D (CL:+ D (CL:/ (%WRAPPER-VALUE MVALUE) 60.0d0)))))
     ...
     (CL:T
      (CL:LET* ((STREAM-001 (NEW-OUTPUT-STRING-STREAM)))
       (%%PRINT-STREAM (%NATIVE-STREAM STREAM-001) "`" TEST-VALUE-001 "' is not a valid case option")
       (CL:ERROR (NEW-STELLA-EXCEPTION (THE-STRING-READER STREAM-001)))))))
   (CL:LET* ((TEST-VALUE-002 (SAFE-PRIMARY-TYPE SVALUE)))
    (CL:COND
     ((SUBTYPE-OF-FLOAT? TEST-VALUE-002) (CL:PROGN (CL:SETQ D (CL:+ D (CL:/ (%WRAPPER-VALUE SVALUE) 3600.0d0)))))
     ((SUBTYPE-OF-INTEGER? TEST-VALUE-002) (CL:PROGN (CL:SETQ D (CL:+ D (CL:/ (%WRAPPER-VALUE SVALUE) 3600.0d0)))))
     (CL:T
      (CL:LET* ((STREAM-002 (NEW-OUTPUT-STRING-STREAM)))
       (%%PRINT-STREAM (%NATIVE-STREAM STREAM-002) "`" TEST-VALUE-002 "' is not a valid case option")
...
(CL:DEFMETHOD MIN ((X NUMBER-WRAPPER) Y)
  ...
  (CL:LET* ((TEST-VALUE-003 (SAFE-PRIMARY-TYPE X)))
   (CL:COND
      ...
      (CL:LET* ((TEST-VALUE-000 (SAFE-PRIMARY-TYPE Y)))
       (CL:COND
        ((SUBTYPE-OF-INTEGER? TEST-VALUE-000)
         (CL:PROGN
          (CL:IF (CL:OR (CL:EQ Y NULL) (CL:<= (%WRAPPER-VALUE X) (%WRAPPER-VALUE Y))) (CL:RETURN-FROM MIN X)
           (CL:RETURN-FROM MIN Y))))
    ...
    (CL:T
     (CL:LET* ((STREAM-000 (NEW-OUTPUT-STRING-STREAM)))
      (%%PRINT-STREAM (%NATIVE-STREAM STREAM-000) "`" TEST-VALUE-003 "' is not a valid case option")
      (CL:ERROR (NEW-STELLA-EXCEPTION (THE-STRING-READER STREAM-000))))))))
     ...
     (CL:PROGN
      (CL:LET* ((TEST-VALUE-000 (SAFE-PRIMARY-TYPE Y)))
       (CL:COND
        ((SUBTYPE-OF-INTEGER? TEST-VALUE-000)
         (CL:PROGN
          (CL:IF (CL:OR (CL:EQ Y NULL) (CL:>= (%WRAPPER-VALUE X) (%WRAPPER-VALUE Y))) (CL:RETURN-FROM MAX X)
           (CL:RETURN-FROM MAX Y))))
        ((SUBTYPE-OF-LONG-INTEGER? TEST-VALUE-000)
         (CL:PROGN
          (CL:IF (CL:OR (CL:EQ Y NULL) (CL:>= (%WRAPPER-VALUE X) (%WRAPPER-VALUE Y))) (CL:RETURN-FROM MAX X)
           (CL:RETURN-FROM MAX Y))))
...
otherwise, return 'ch' unmodified."
  (CL:RETURN-FROM CHARACTER-DOWNCASE
   (CL:LET ((SELF *CHARACTER-DOWNCASE-TABLE*) (POSITION (CL:THE CL:FIXNUM (CL:CHAR-CODE CH))))
...
should be used instead."
  (CL:RETURN-FROM CHARACTER-UPCASE
   (CL:LET ((SELF *CHARACTER-UPCASE-TABLE*) (POSITION (CL:THE CL:FIXNUM (CL:CHAR-CODE CH))))
    (CL:DECLARE (CL:TYPE CL:SIMPLE-STRING SELF) (CL:TYPE CL:FIXNUM POSITION))
    (CL:SCHAR (CL:THE CL:SIMPLE-STRING SELF) (CL:THE CL:FIXNUM POSITION)))))
   ...
   (CL:IF (CL:EQ STRING STELLA::NULL-STRING) (CL:SETQ TEST-VALUE-000 CL:T)
    (CL:IF (STRING-EQL? STRING "") (CL:SETQ TEST-VALUE-000 CL:T)
     (CL:LET* ((ALWAYS?-000 CL:T))
      (CL:LET*
       ((CHAR NULL-CHARACTER) (VECTOR-000 STRING) (INDEX-000 0) (LENGTH-000 (CL:THE CL:FIXNUM (CL:LENGTH VECTOR-000))))
       ...
       (CL:LOOP WHILE (CL:< INDEX-000 LENGTH-000) DO
        ...
        (CL:WHEN
         (CL:NOT
          (CL:EQ (CL:AREF *CHARACTER-TYPE-TABLE* (CL:THE CL:FIXNUM (CL:CHAR-CODE CHAR))) KWD-PRIMAL-WHITE-SPACE))
...
similar to using a Java Collator for Locale.US with strength set to TERTIARY (which see)."
  ...
  (CL:CHECK-TYPE Y CL:SIMPLE-STRING)
  (CL:LET*
   ((XLENGTH (CL:THE CL:FIXNUM (CL:LENGTH X))) (YLENGTH (CL:THE CL:FIXNUM (CL:LENGTH Y))) (XCH NULL-CHARACTER)
    (YCH NULL-CHARACTER))
   (CL:DECLARE (CL:TYPE CL:FIXNUM XLENGTH YLENGTH))
   (CL:LET* ((I NULL-INTEGER) (ITER-000 0) (UPPER-BOUND-000 (CL:1- (MIN XLENGTH YLENGTH))))
     ...
     (CL:WHEN (CL:NOT (CL:EQL XCH YCH))
      (CL:LET*
       ...
       (CL:IF (CL:EQL XCHDOWN YCHDOWN)
        (CL:IF (CL:< (CL:THE CL:FIXNUM (CL:CHAR-CODE XCH)) (CL:THE CL:FIXNUM (CL:CHAR-CODE YCH)))
         (CL:RETURN-FROM STRING-COMPARE-CASE-NORMALIZED 1) (CL:RETURN-FROM STRING-COMPARE-CASE-NORMALIZED -1))
        (CL:IF (CL:< (CL:THE CL:FIXNUM (CL:CHAR-CODE XCHDOWN)) (CL:THE CL:FIXNUM (CL:CHAR-CODE YCHDOWN)))
         (CL:RETURN-FROM STRING-COMPARE-CASE-NORMALIZED -1) (CL:RETURN-FROM STRING-COMPARE-CASE-NORMALIZED 1)))))
     (CL:SETQ ITER-000 (CL:1+ ITER-000))))
   (CL:COND ((CL:= XLENGTH YLENGTH) (CL:RETURN-FROM STRING-COMPARE-CASE-NORMALIZED 0))
    ((CL:< XLENGTH YLENGTH) (CL:RETURN-FROM STRING-COMPARE-CASE-NORMALIZED -1))
...
`string-compare-case-normalized' (which see)."
  ...
  (CL:CHECK-TYPE Y CL:SIMPLE-STRING)
  (CL:COND
   ((CL:EQ COLLATION KWD-PRIMAL-ASCII-CASE-SENSITIVE) (CL:RETURN-FROM COMPARE-STRINGS (STRING-COMPARE X Y CL:T)))
   ...
   ((CL:EQ COLLATION KWD-PRIMAL-ASCII-CASE-NORMALIZED)
    (CL:RETURN-FROM COMPARE-STRINGS (STRING-COMPARE-CASE-NORMALIZED X Y)))
   (CL:T
    (CL:LET* ((STREAM-000 (NEW-OUTPUT-STRING-STREAM)))
     (%%PRINT-STREAM (%NATIVE-STREAM STREAM-000) "compare-strings: unsupported collation: `" COLLATION "'")
     (CL:ERROR (NEW-STELLA-EXCEPTION (THE-STRING-READER STREAM-000)))))))
...
NULL sorts after everything else in any collation."
  ...
  (CL:COND
   ((CL:EQ X STELLA::NULL-STRING)
    (CL:IF (CL:EQ Y STELLA::NULL-STRING) (CL:RETURN-FROM SAFE-COMPARE-STRINGS 0)
     (CL:RETURN-FROM SAFE-COMPARE-STRINGS 1)))
   ((CL:EQ Y STELLA::NULL-STRING) (CL:RETURN-FROM SAFE-COMPARE-STRINGS -1))
   (CL:T (CL:RETURN-FROM SAFE-COMPARE-STRINGS (COMPARE-STRINGS X Y COLLATION)))))
...
(CL:DEFUN MAKE-RAW-MUTABLE-STRING (SIZE)
  ...
  #+MCL
  (CL:CHECK-TYPE SIZE CL:FIXNUM)
  (CL:LET* ((S STELLA::NULL-STRING)) (CL:DECLARE (CL:TYPE CL:SIMPLE-STRING S)) (SETQ S (CL:MAKE-STRING SIZE))
...
less efficient variable arguments mechanism."
  ...
  (CL:LET*
   ((RESULT STELLA::NULL-STRING)
    (LENGTH (CL:+ (CL:THE CL:FIXNUM (CL:LENGTH STRING1)) (CL:THE CL:FIXNUM (CL:LENGTH STRING2)))) (INDEX 0))
   ...
   (CL:LET*
    ((CH NULL-CHARACTER) (VECTOR-000 STRING1) (INDEX-000 0) (LENGTH-000 (CL:THE CL:FIXNUM (CL:LENGTH VECTOR-000))))
    (CL:DECLARE (CL:TYPE CL:SIMPLE-STRING VECTOR-000) (CL:TYPE CL:FIXNUM INDEX-000 LENGTH-000))
    (CL:LOOP WHILE (CL:< INDEX-000 LENGTH-000) DO
     (CL:SETQ CH
      (CL:LET ((SELF VECTOR-000) (POSITION INDEX-000))
   ...
   (CL:LET*
    ((CH NULL-CHARACTER) (VECTOR-001 STRING2) (INDEX-001 0) (LENGTH-001 (CL:THE CL:FIXNUM (CL:LENGTH VECTOR-001))))
   ...
   (CL:LET* ((STRING STELLA::NULL-STRING) (ITER-001 OTHERSTRINGS)) (CL:DECLARE (CL:TYPE CL:SIMPLE-STRING STRING))
    (CL:LOOP WHILE ITER-001 DO (CL:SETQ STRING (CL:POP ITER-001))
     (CL:LET*
      ((CH NULL-CHARACTER) (VECTOR-002 STRING) (INDEX-002 0) (LENGTH-002 (CL:THE CL:FIXNUM (CL:LENGTH VECTOR-002))))
   ...
   (CL:RETURN-FROM CONCATENATE
    (CL:LET ((S RESULT)) (CL:DECLARE (CL:TYPE CL:SIMPLE-STRING S)) (CL:THE CL:SIMPLE-STRING S)))))

;;; (DEFUN (HELP-SUBSTITUTE-CHARACTERS MUTABLE-STRING) ...)

(CL:DECLAIM
 (CL:FTYPE (CL:FUNCTION (CL:SIMPLE-STRING CL:SIMPLE-STRING CL:SIMPLE-STRING) CL:SIMPLE-STRING)
...
(CL:DEFUN HELP-SUBSTITUTE-CHARACTERS (SELF NEW-CHARS OLD-CHARS)
  ...
  (CL:LET* ((POS NULL-INTEGER)) (CL:DECLARE (CL:TYPE CL:FIXNUM POS))
   (CL:LET* ((I NULL-INTEGER) (ITER-000 0) (UPPER-BOUND-000 (CL:1- (CL:THE CL:FIXNUM (CL:LENGTH SELF)))))
    (CL:DECLARE (CL:TYPE CL:FIXNUM I ITER-000 UPPER-BOUND-000))
    (CL:LOOP WHILE (CL:<= ITER-000 UPPER-BOUND-000) DO (CL:SETQ I ITER-000)
     (CL:SETQ POS
      (POSITION OLD-CHARS
...
corresponding member of `new-chars' in the string `self'.  Returns a new string."
  ...
  (CL:RETURN-FROM SUBSTITUTE-CHARACTERS
   (CL:LET ((S (HELP-SUBSTITUTE-CHARACTERS (CL:THE CL:SIMPLE-STRING (CL:COPY-SEQ SELF)) NEW-CHARS OLD-CHARS)))
    (CL:DECLARE (CL:TYPE CL:SIMPLE-STRING S)) (CL:THE CL:SIMPLE-STRING S))))

;;; (DEFUN (REPLACE-SUBSTRINGS STRING) ...)

(CL:DECLAIM
 (CL:FTYPE (CL:FUNCTION (CL:SIMPLE-STRING CL:SIMPLE-STRING CL:SIMPLE-STRING) CL:SIMPLE-STRING) REPLACE-SUBSTRINGS))
(CL:DEFUN REPLACE-SUBSTRINGS (STRING NEW OLD)
  ...
  (CL:LET*
   ((STRINGLENGTH (CL:THE CL:FIXNUM (CL:LENGTH STRING))) (OLDLENGTH (CL:THE CL:FIXNUM (CL:LENGTH OLD)))
    (NEWLENGTH (CL:THE CL:FIXNUM (CL:LENGTH NEW))) (NOFOCCURRENCES 0) (OLDSTART 0) (CURSOR 0) (RESULTCURSOR 0)
    (RESULT STELLA::NULL-STRING))
   (CL:DECLARE (CL:TYPE CL:FIXNUM STRINGLENGTH OLDLENGTH NEWLENGTH NOFOCCURRENCES OLDSTART CURSOR RESULTCURSOR)
    (CL:TYPE CL:SIMPLE-STRING RESULT))
   (CL:LOOP WHILE (CL:NOT (CL:= (CL:SETQ OLDSTART (STRING-SEARCH STRING OLD CURSOR)) NULL-INTEGER)) DO
    (CL:SETQ NOFOCCURRENCES (CL:1+ NOFOCCURRENCES)) (CL:SETQ CURSOR (CL:+ OLDSTART OLDLENGTH)))
   (CL:WHEN (CL:= NOFOCCURRENCES 0) (CL:RETURN-FROM REPLACE-SUBSTRINGS STRING))
   (CL:SETQ RESULT (MAKE-RAW-MUTABLE-STRING (CL:+ STRINGLENGTH (CL:* NOFOCCURRENCES (CL:- NEWLENGTH OLDLENGTH)))))
   (CL:SETQ CURSOR 0)
   (CL:LOOP WHILE (CL:NOT (CL:= (CL:SETQ OLDSTART (STRING-SEARCH STRING OLD CURSOR)) NULL-INTEGER)) DO
    (CL:LET* ((I NULL-INTEGER) (ITER-000 CURSOR) (UPPER-BOUND-000 (CL:1- OLDSTART)))
     (CL:DECLARE (CL:TYPE CL:FIXNUM I ITER-000 UPPER-BOUND-000))
     (CL:LOOP WHILE (CL:<= ITER-000 UPPER-BOUND-000) DO (CL:SETQ I ITER-000)
      (CL:LET
       ((SELF RESULT)
    ...
    (CL:LET*
     ((CHAR NULL-CHARACTER) (VECTOR-000 NEW) (INDEX-000 0) (LENGTH-000 (CL:THE CL:FIXNUM (CL:LENGTH VECTOR-000))))
     (CL:DECLARE (CL:TYPE CL:SIMPLE-STRING VECTOR-000) (CL:TYPE CL:FIXNUM INDEX-000 LENGTH-000))
     (CL:LOOP WHILE (CL:< INDEX-000 LENGTH-000) DO
      (CL:SETQ CHAR
       (CL:LET ((SELF VECTOR-000) (POSITION INDEX-000))
   ...
   (CL:LET* ((I NULL-INTEGER) (ITER-001 CURSOR) (UPPER-BOUND-001 (CL:1- STRINGLENGTH)))
  ...
  (CL:LET* ((VAR STELLA::NULL-STRING)) (CL:DECLARE (CL:TYPE CL:SIMPLE-STRING VAR))
   (CL:LET* ((ITEM STELLA::NULL-STRING) (ITER-000 |VARS&VALUES|)) (CL:DECLARE (CL:TYPE CL:SIMPLE-STRING ITEM))
    (CL:LOOP WHILE ITER-000 DO (CL:SETQ ITEM (CL:POP ITER-000))
     (CL:COND
      ((CL:NOT (CL:EQ VAR STELLA::NULL-STRING)) (CL:SETQ TEMPLATE (REPLACE-SUBSTRINGS TEMPLATE ITEM VAR))
...
(CL:DECLAIM
 (CL:FTYPE (CL:FUNCTION (CL:SIMPLE-STRING CL:FIXNUM CL:FIXNUM CL:SIMPLE-STRING CL:FIXNUM CL:T) CL:FIXNUM)
  INSERT-STRING))
...
The final value of target-index is returned."
  ...
  (CL:COND
   ((CL:EQ CASE-CONVERSION KWD-PRIMAL-UPCASE)
    (CL:LET*
     ((J NULL-INTEGER) (ITER-000 START) (UPPER-BOUND-000 END) (UNBOUNDED?-000 (CL:= UPPER-BOUND-000 NULL-INTEGER)))
   ...
   ((CL:EQ CASE-CONVERSION KWD-PRIMAL-DOWNCASE)
    (CL:LET*
     ((J NULL-INTEGER) (ITER-001 START) (UPPER-BOUND-001 END) (UNBOUNDED?-001 (CL:= UPPER-BOUND-001 NULL-INTEGER)))
   ...
   ((CL:EQ CASE-CONVERSION KWD-PRIMAL-PRESERVE)
    (CL:LET*
     ((J NULL-INTEGER) (ITER-003 START) (UPPER-BOUND-003 END) (UNBOUNDED?-003 (CL:= UPPER-BOUND-003 NULL-INTEGER)))
   ...
   (CL:T
    (CL:LET* ((STREAM-000 (NEW-OUTPUT-STRING-STREAM)))
     (%%PRINT-STREAM (%NATIVE-STREAM STREAM-000) "`" CASE-CONVERSION "' is not a valid case option")
     (CL:ERROR (NEW-STELLA-EXCEPTION (THE-STRING-READER STREAM-000))))))
...
unmodified and uncopied."
  ...
  #+MCL
  (CL:CHECK-TYPE STRING CL:SIMPLE-STRING)
  (CL:LET* ((START 0) (LAST (CL:1- (CL:THE CL:FIXNUM (CL:LENGTH STRING)))) (END LAST))
   ...
   (CL:IF (CL:OR (CL:> START 0) (CL:< END LAST)) (CL:RETURN-FROM STRING-TRIM (SUBSEQUENCE STRING START (CL:1+ END)))
...
the C++ version we have but slower than the native Java version."
  ...
  (CL:WHEN (CL:NOT (CL:AND (CL:>= BASE 2) (CL:<= BASE 36)))
   (CL:ERROR "Safety violation: integer-to-string-in-base: illegal base: `~A'" BASE))
  (CL:WHEN (CL:= INTEGER 0) (CL:RETURN-FROM STELLA-INTEGER-TO-STRING-IN-BASE "0"))
  (CL:LET* ((OFFSET (CL:IF (CL:< INTEGER 0) 1 0))) (CL:DECLARE (CL:TYPE CL:FIXNUM OFFSET))
   ...
   (CL:LET*
    ((INTEGERBITS (INTEGER-LENGTH INTEGER)) (BASEBITS (INTEGER-LENGTH (CL:TRUNCATE BASE)))
     (BUFFERLENGTH
      (CL:+ OFFSET
       (CL:LET ((X INTEGERBITS) (Y (CL:1- BASEBITS))) (CL:DECLARE (CL:TYPE CL:FIXNUM X Y))
        (CL:THE CL:FIXNUM (CL:VALUES (CL:TRUNCATE X Y))))
       1))
     (BUFFER (MAKE-RAW-MUTABLE-STRING BUFFERLENGTH)) (INDEX BUFFERLENGTH)
     (TABLE "0123456789ABCDEFGHIJKLMNOPQRSTUVWXYZ") (REMAINDER 0) (DIGIT 0) (BASE-1 (CL:1- BASE)))
    (CL:DECLARE (CL:TYPE CL:FIXNUM INTEGERBITS BASEBITS BUFFERLENGTH INDEX DIGIT BASE-1)
    ...
    (CL:COND
     ((CL:= (CL:THE CL:FIXNUM (CL:LOGAND BASE BASE-1)) 0) (CL:SETQ BASEBITS (CL:1- BASEBITS))
      (CL:LOOP WHILE (CL:> INTEGER 0) DO (CL:SETQ INDEX (CL:1- INDEX))
       (CL:SETQ DIGIT (CL:TRUNCATE (CL:LOGAND INTEGER (CL:TRUNCATE BASE-1))))
       (CL:SETQ INTEGER
        (CL:LET ((ARG INTEGER) (COUNT BASEBITS)) (CL:DECLARE (CL:TYPE CL:FIXNUM COUNT))
     ...
     (CL:T
      (CL:LOOP WHILE (CL:> INTEGER 0) DO (CL:SETQ INDEX (CL:1- INDEX))
       (CL:SETQ REMAINDER (CL:LET ((X INTEGER) (Y (CL:TRUNCATE BASE))) (CL:VALUES (CL:TRUNCATE X Y))))
  ...
  (CL:LET* ((LEN (CL:THE CL:FIXNUM (CL:LENGTH INPUT)))) (CL:DECLARE (CL:TYPE CL:FIXNUM LEN))
   (CL:COND ((CL:= LEN LENGTH) (CL:RETURN-FROM FORMAT-WITH-PADDING INPUT))
    ((CL:> LEN LENGTH)
     (CL:IF TRUNCATE?
      (CL:COND
       ((CL:EQ ALIGN KWD-PRIMAL-LEFT) (CL:RETURN-FROM FORMAT-WITH-PADDING (SUBSEQUENCE INPUT (CL:- LEN LENGTH) LEN)))
       ...
       (CL:T
        (CL:LET* ((STREAM-000 (NEW-OUTPUT-STRING-STREAM)))
         (%%PRINT-STREAM (%NATIVE-STREAM STREAM-000) "`" ALIGN "' is not a valid case option")
         (CL:ERROR (NEW-STELLA-EXCEPTION (THE-STRING-READER STREAM-000))))))
      (CL:RETURN-FROM FORMAT-WITH-PADDING INPUT)))
    (CL:T
     (CL:COND
      ((CL:EQ ALIGN KWD-PRIMAL-LEFT)
       (CL:RETURN-FROM FORMAT-WITH-PADDING (CONCATENATE INPUT (MAKE-STRING (CL:- LENGTH LEN) PADCHAR))))
      ((CL:EQ ALIGN KWD-PRIMAL-RIGHT)
       (CL:RETURN-FROM FORMAT-WITH-PADDING (CONCATENATE (MAKE-STRING (CL:- LENGTH LEN) PADCHAR) INPUT)))
      ((CL:EQ ALIGN KWD-PRIMAL-CENTER)
       (CL:LET* ((LEFT (CL:TRUNCATE (CL:/ (CL:- LENGTH LEN) 2.0d0)))) (CL:DECLARE (CL:TYPE CL:FIXNUM LEFT))
        (CL:RETURN-FROM FORMAT-WITH-PADDING
         (CONCATENATE (MAKE-STRING LEFT PADCHAR) INPUT (MAKE-STRING (CL:- LENGTH LEN LEFT) PADCHAR)))))
      (CL:T
       (CL:LET* ((STREAM-001 (NEW-OUTPUT-STRING-STREAM)))
        (%%PRINT-STREAM (%NATIVE-STREAM STREAM-001) "`" ALIGN "' is not a valid case option")
        (CL:ERROR (NEW-STELLA-EXCEPTION (THE-STRING-READER STREAM-001))))))))))
...
ends with `suffix'.  If `end' is NULL it defaults to the length of `string'."
  ...
  (CL:LET* ((SUFFIXLENGTH (CL:THE CL:FIXNUM (CL:LENGTH SUFFIX))) (START (CL:- END SUFFIXLENGTH)))
...
(CL:DECLAIM
 (CL:FTYPE (CL:FUNCTION (CL:SIMPLE-STRING CL:FIXNUM CL:FIXNUM CL:SIMPLE-STRING CL:FIXNUM CL:FIXNUM) CL:FIXNUM)
...
strings."
  ...
  (CL:RETURN-FROM FIND-MATCHING-PREFIX-LENGTH
   (HELP-FIND-MATCHING-PREFIX-LENGTH STRING1 START1 END1 STRING2 START2 END2)))

;;; (DEFUN (FIND-MISMATCH INTEGER INTEGER) ...)

(CL:DECLAIM
 (CL:FTYPE
  (CL:FUNCTION (CL:SIMPLE-STRING CL:FIXNUM CL:FIXNUM CL:SIMPLE-STRING CL:FIXNUM CL:FIXNUM)
...
strings.  If there is no mismatch, then `null' values are returned."
  ...
  (CL:WHEN (CL:= END1 NULL-INTEGER) (CL:SETQ END1 (CL:THE CL:FIXNUM (CL:LENGTH STRING1))))
  (CL:WHEN (CL:= END2 NULL-INTEGER) (CL:SETQ END2 (CL:THE CL:FIXNUM (CL:LENGTH STRING2))))
  (CL:LET* ((LEN (HELP-FIND-MATCHING-PREFIX-LENGTH STRING1 START1 END1 STRING2 START2 END2)))
   (CL:DECLARE (CL:TYPE CL:FIXNUM LEN)) (CL:SETQ START1 (CL:+ START1 LEN)) (CL:SETQ START2 (CL:+ START2 LEN))
   (CL:IF (CL:AND (CL:= START1 END1) (CL:= START2 END2))
    (CL:RETURN-FROM FIND-MISMATCH (CL:VALUES NULL-INTEGER NULL-INTEGER))
    (CL:RETURN-FROM FIND-MISMATCH (CL:VALUES START1 START2)))))

;;; (DEFUN (NON-MATCHING-POSITION-HELPER INTEGER) ...)

(CL:DECLAIM
 (CL:FTYPE (CL:FUNCTION (CL:SIMPLE-STRING CL:FIXNUM CL:FIXNUM CL:SIMPLE-STRING) CL:FIXNUM)
...
character that is not included in `match'."
  ...
  (CL:RETURN-FROM NON-MATCHING-POSITION
   (NON-MATCHING-POSITION-HELPER SOURCE START (CL:THE CL:FIXNUM (CL:LENGTH SOURCE)) MATCH)))
...
the first character that is not white space."
  ...
  (CL:RETURN-FROM ADVANCE-PAST-WHITESPACE
   (HELP-ADVANCE-PAST-WHITESPACE SOURCE START (CL:THE CL:FIXNUM (CL:LENGTH SOURCE)))))
...
trailing whitespace is also not considered."
  ...
  (CL:COND ((CL:EQ S1 STELLA::NULL-STRING) (CL:RETURN-FROM EQL-EXCEPT-IN-WHITESPACE? (CL:EQ S2 STELLA::NULL-STRING)))
   ((CL:EQ S2 STELLA::NULL-STRING) (CL:RETURN-FROM EQL-EXCEPT-IN-WHITESPACE? CL:NIL))
   ((STRING-EQL? S1 S2) (CL:RETURN-FROM EQL-EXCEPT-IN-WHITESPACE? CL:T)))
  (CL:LET* ((LEN1 (CL:THE CL:FIXNUM (CL:LENGTH S1))) (LEN2 (CL:THE CL:FIXNUM (CL:LENGTH S2))) (I1 0) (I2 0))
...
(CL:DEFUN SPLIT-STRING (INPUT SEPARATOR)
  ...
  #+MCL
  (CL:CHECK-TYPE INPUT CL:SIMPLE-STRING)
  (CL:LET* ((LENGTH (CL:THE CL:FIXNUM (CL:LENGTH INPUT))) (START 0) (END 0) (STRINGS NIL))
   (CL:DECLARE (CL:TYPE CL:FIXNUM LENGTH START END))
   (CL:LOOP (CL:SETQ END (POSITION INPUT SEPARATOR START))
    (CL:SETQ STRINGS (CONS (WRAP-STRING (SUBSEQUENCE INPUT START END)) STRINGS))
    (CL:IF (CL:AND (CL:NOT (CL:= END NULL-INTEGER)) (CL:< END (CL:1- LENGTH))) (CL:SETQ START (CL:1+ END))
     (CL:RETURN)))
...
(CL:DEFMETHOD INITIALIZE-HASH-TABLE ((SELF ABSTRACT-HASH-TABLE))
  ...
  (CL:WHEN *USE-STELLA-HASH-TABLES?* (CL:SETF (%THE-STELLA-HASH-TABLE SELF) (NEW-STELLA-HASH-TABLE))
...
(CL:DEFMETHOD LOOKUP ((SELF HASH-TABLE) KEY)
  (CL:WHEN *USE-STELLA-HASH-TABLES?*
   (CL:RETURN-FROM LOOKUP (STELLA-HASH-TABLE-LOOKUP (%THE-STELLA-HASH-TABLE SELF) KEY)))
...
(CL:DEFMETHOD INSERT-AT ((SELF HASH-TABLE) KEY VALUE)
  (CL:WHEN *USE-STELLA-HASH-TABLES?* (STELLA-HASH-TABLE-INSERT-AT (%THE-STELLA-HASH-TABLE SELF) KEY VALUE)
...
(CL:DEFMETHOD REMOVE-AT ((SELF HASH-TABLE) KEY)
  (CL:WHEN *USE-STELLA-HASH-TABLES?* (STELLA-HASH-TABLE-REMOVE-AT (%THE-STELLA-HASH-TABLE SELF) KEY)
...
(CL:DEFMETHOD LOOKUP ((SELF INTEGER-HASH-TABLE) KEY)
  ...
  (CL:WHEN *USE-STELLA-HASH-TABLES?*
   (CL:RETURN-FROM LOOKUP (STELLA-HASH-TABLE-LOOKUP (%THE-STELLA-HASH-TABLE SELF) (WRAP-INTEGER KEY))))
  (CL:LET* ((NATIVE-TABLE (%THE-HASH-TABLE SELF))) (CL:RETURN-FROM LOOKUP (CL:OR (CL:GETHASH KEY NATIVE-TABLE) NULL))))
...
(CL:DEFMETHOD INSERT-AT ((SELF INTEGER-HASH-TABLE) KEY VALUE)
  ...
  (CL:CHECK-TYPE KEY CL:FIXNUM)
  (CL:WHEN *USE-STELLA-HASH-TABLES?*
   (STELLA-HASH-TABLE-INSERT-AT (%THE-STELLA-HASH-TABLE SELF) (WRAP-INTEGER KEY) VALUE) (CL:RETURN-FROM INSERT-AT))
  (CL:LET* ((NATIVE-TABLE (%THE-HASH-TABLE SELF))) (CL:DECLARE (CL:FIXNUM KEY))
...
(CL:DEFMETHOD REMOVE-AT ((SELF INTEGER-HASH-TABLE) KEY)
  ...
  #+MCL
  (CL:CHECK-TYPE KEY CL:FIXNUM)
  (CL:WHEN *USE-STELLA-HASH-TABLES?* (STELLA-HASH-TABLE-REMOVE-AT (%THE-STELLA-HASH-TABLE SELF) (WRAP-INTEGER KEY))
   (CL:RETURN-FROM REMOVE-AT))
  (CL:LET* ((NATIVE-TABLE (%THE-HASH-TABLE SELF))) (CL:REMHASH KEY NATIVE-TABLE))
  :VOID)
...
(CL:DEFMETHOD LOOKUP ((SELF FLOAT-HASH-TABLE) KEY)
  ...
  (CL:WHEN *USE-STELLA-HASH-TABLES?*
   (CL:RETURN-FROM LOOKUP (STELLA-HASH-TABLE-LOOKUP (%THE-STELLA-HASH-TABLE SELF) (WRAP-FLOAT KEY))))
  (CL:LET* ((NATIVE-TABLE (%THE-HASH-TABLE SELF))) (CL:RETURN-FROM LOOKUP (CL:OR (CL:GETHASH KEY NATIVE-TABLE) NULL))))
...
(CL:DEFMETHOD INSERT-AT ((SELF FLOAT-HASH-TABLE) KEY VALUE)
  ...
  #+MCL
  (CL:CHECK-TYPE KEY CL:DOUBLE-FLOAT)
  (CL:WHEN *USE-STELLA-HASH-TABLES?* (STELLA-HASH-TABLE-INSERT-AT (%THE-STELLA-HASH-TABLE SELF) (WRAP-FLOAT KEY) VALUE)
   (CL:RETURN-FROM INSERT-AT))
  (CL:LET* ((NATIVE-TABLE (%THE-HASH-TABLE SELF))) (CL:SETF (CL:GETHASH KEY NATIVE-TABLE) VALUE))
  :VOID)
...
(CL:DEFMETHOD REMOVE-AT ((SELF FLOAT-HASH-TABLE) KEY)
  ...
  #+MCL
  (CL:CHECK-TYPE KEY CL:DOUBLE-FLOAT)
  (CL:WHEN *USE-STELLA-HASH-TABLES?* (STELLA-HASH-TABLE-REMOVE-AT (%THE-STELLA-HASH-TABLE SELF) (WRAP-FLOAT KEY))
   (CL:RETURN-FROM REMOVE-AT))
  (CL:LET* ((NATIVE-TABLE (%THE-HASH-TABLE SELF))) (CL:REMHASH KEY NATIVE-TABLE))
  :VOID)
...
(CL:DEFMETHOD LOOKUP ((SELF STRING-HASH-TABLE) KEY)
  ...
  (CL:WHEN *USE-STELLA-HASH-TABLES?*
   (CL:RETURN-FROM LOOKUP (STELLA-STRING-HASH-TABLE-LOOKUP (%THE-STELLA-HASH-TABLE SELF) KEY)))
  (CL:LET* ((NATIVE-TABLE (%THE-HASH-TABLE SELF))) (CL:RETURN-FROM LOOKUP (CL:OR (CL:GETHASH KEY NATIVE-TABLE) NULL))))
...
(CL:DEFMETHOD INSERT-AT ((SELF STRING-HASH-TABLE) KEY VALUE)
  ...
  (CL:CHECK-TYPE KEY CL:SIMPLE-STRING)
  (CL:WHEN *USE-STELLA-HASH-TABLES?*
   (STELLA-HASH-TABLE-INSERT-AT (%THE-STELLA-HASH-TABLE SELF) (WRAP-STRING KEY) VALUE) (CL:RETURN-FROM INSERT-AT))
  (CL:LET* ((NATIVE-TABLE (%THE-HASH-TABLE SELF))) (CL:SETF (CL:GETHASH KEY NATIVE-TABLE) VALUE))
  :VOID)
...
(CL:DEFMETHOD REMOVE-AT ((SELF STRING-HASH-TABLE) KEY)
  ...
  #+MCL
  (CL:CHECK-TYPE KEY CL:SIMPLE-STRING)
  (CL:WHEN *USE-STELLA-HASH-TABLES?* (STELLA-HASH-TABLE-REMOVE-AT (%THE-STELLA-HASH-TABLE SELF) (WRAP-STRING KEY))
   (CL:RETURN-FROM REMOVE-AT))
  (CL:LET* ((NATIVE-TABLE (%THE-HASH-TABLE SELF))) (CL:REMHASH KEY NATIVE-TABLE))
  :VOID)
...
(CL:DEFMETHOD LOOKUP ((SELF STRING-TO-INTEGER-HASH-TABLE) KEY)
  ...
  (CL:CHECK-TYPE KEY CL:SIMPLE-STRING)
  (CL:WHEN *USE-STELLA-HASH-TABLES?*
   (CL:RETURN-FROM LOOKUP (UNWRAP-INTEGER (STELLA-STRING-HASH-TABLE-LOOKUP (%THE-STELLA-HASH-TABLE SELF) KEY))))
...
(CL:DEFMETHOD INSERT-AT ((SELF STRING-TO-INTEGER-HASH-TABLE) KEY VALUE)
  ...
  (CL:CHECK-TYPE VALUE CL:FIXNUM)
  (CL:WHEN *USE-STELLA-HASH-TABLES?*
   (STELLA-HASH-TABLE-INSERT-AT (%THE-STELLA-HASH-TABLE SELF) (WRAP-STRING KEY) (WRAP-INTEGER VALUE))
   (CL:RETURN-FROM INSERT-AT))
  (CL:LET* ((NATIVE-TABLE (%THE-HASH-TABLE SELF))) (CL:SETF (CL:GETHASH KEY NATIVE-TABLE) VALUE))
  :VOID)
  ...
  (CL:RETURN-FROM ROTATE-HASH-CODE
   (CL:IF (CL:= (CL:THE CL:FIXNUM (CL:LOGAND ARG 1)) 0)
    (CL:LET ((ARG ARG)) (CL:DECLARE (CL:TYPE CL:FIXNUM ARG))
     (CL:THE CL:FIXNUM (CL:LOGAND (CL:THE CL:FIXNUM (CL:ASH ARG -1)) *INTEGER-UNSIGNED-BITS-MASK*)))
    (CL:THE CL:FIXNUM
     (CL:LOGIOR
      (CL:THE CL:FIXNUM
       (CL:LET ((ARG ARG) (COUNT 1)) (CL:DECLARE (CL:TYPE CL:FIXNUM ARG COUNT))
...
(CL:DEFMETHOD HASH-CODE ((SELF WRAPPER))
  (CL:LET* ((STREAM-000 (NEW-OUTPUT-STRING-STREAM)))
   (%%PRINT-STREAM (%NATIVE-STREAM STREAM-000) "WRAPPER.hash-code: Don't know how to hash on `" SELF "'")
   (CL:ERROR (NEW-STELLA-EXCEPTION (THE-STRING-READER STREAM-000)))))
   ...
   (CL:TRUNCATE
    (CL:LOGAND
     (CL:LOGXOR (%WRAPPER-VALUE SELF)
      (CL:LET ((ARG (%WRAPPER-VALUE SELF)) (COUNT 32)) (CL:DECLARE (CL:TYPE CL:FIXNUM COUNT))
       (CL:ASH ARG (CL:THE CL:FIXNUM (CL:- COUNT)))))
...
(CL:DEFMETHOD HASH-CODE ((SELF CHARACTER-WRAPPER))
  (CL:RETURN-FROM HASH-CODE
   (CL:THE CL:FIXNUM
    (CL:LOGXOR
     (CL:THE CL:FIXNUM (CL:AREF *HASH-BYTE-RANDOM-TABLE* (CL:THE CL:FIXNUM (CL:CHAR-CODE (%WRAPPER-VALUE SELF)))))
     15119378))))
...
(%%DEFINTEGERMETHOD HASH-CODE ((SELF CL:INTEGER))
  (CL:RETURN-FROM HASH-CODE
   (CL:TRUNCATE
    (CL:LOGAND
     (CL:LOGXOR SELF
      (CL:LET ((ARG SELF) (COUNT 32)) (CL:DECLARE (CL:TYPE CL:FIXNUM COUNT))
       (CL:ASH ARG (CL:THE CL:FIXNUM (CL:- COUNT)))))
     (CL:TRUNCATE MOST-POSITIVE-INTEGER)))))
...
(CL:DEFMETHOD HASH-CODE ((SELF CL:CHARACTER))
  (CL:RETURN-FROM HASH-CODE
   (CL:THE CL:FIXNUM
    (CL:LOGXOR (CL:THE CL:FIXNUM (CL:AREF *HASH-BYTE-RANDOM-TABLE* (CL:THE CL:FIXNUM (CL:CHAR-CODE SELF)))) 15119378))))
...
handle NULL components should use this function for recursive calls."
  (CL:IF (CL:EQ SELF NULL) (CL:RETURN-FROM SAFE-EQUAL-HASH-CODE 16569644)
...
having to concatenate them."
  ...
  (CL:LET* ((CODE SEEDCODE) (CURSOR (CL:THE CL:FIXNUM (CL:LENGTH STRING))))
    ...
    (CL:SETQ CODE
     (CL:IF (CL:= (CL:THE CL:FIXNUM (CL:LOGAND CODE 1)) 0)
      ...
      (CL:THE CL:FIXNUM
       (CL:LOGIOR
        (CL:THE CL:FIXNUM
         (CL:LET ((ARG CODE) (COUNT 1)) (CL:DECLARE (CL:TYPE CL:FIXNUM ARG COUNT))
          (CL:THE CL:FIXNUM (CL:ASH ARG (CL:THE CL:FIXNUM (CL:- COUNT))))))
        *INTEGER-MSB-MASK*)))))
...
(CL:DEFUN PICK-HASH-TABLE-SIZE-PRIME (MINSIZE)
  ...
  (CL:LET* ((PRIME NULL) (VECTOR-000 *HASH-TABLE-SIZE-PRIMES*) (INDEX-000 0) (LENGTH-000 (LENGTH VECTOR-000)))
   (CL:DECLARE (CL:TYPE CL:FIXNUM INDEX-000 LENGTH-000))
   (CL:LOOP WHILE (CL:< INDEX-000 LENGTH-000) DO
    (CL:SETQ PRIME (CL:AREF (CL:THE CL:SIMPLE-VECTOR (%THE-ARRAY VECTOR-000)) INDEX-000))
    (CL:WHEN (CL:>= (%WRAPPER-VALUE PRIME) MINSIZE) (CL:RETURN-FROM PICK-HASH-TABLE-SIZE-PRIME (%WRAPPER-VALUE PRIME)))
    (CL:SETQ INDEX-000 (CL:1+ INDEX-000))))
...
(CL:DEFMETHOD INITIALIZE-VECTOR ((SELF VECTOR))
  (CL:LET* ((SIZE (%ARRAY-SIZE SELF))) (CL:DECLARE (CL:TYPE CL:FIXNUM SIZE))
   (CL:SETF (%THE-ARRAY SELF) (CL:MAKE-ARRAY SIZE :INITIAL-ELEMENT NULL)) (setq size size))
  :VOID)
...
will be initialized to NULL."
  ...
  (CL:LET* ((OLD_SIZE (%ARRAY-SIZE SELF)) (I OLD_SIZE) (OLD_ARRAY (%THE-ARRAY SELF)) (NEW_ARRAY OLD_ARRAY))
   (CL:DECLARE (CL:TYPE CL:FIXNUM OLD_SIZE I) (CL:TYPE CL:SIMPLE-VECTOR OLD_ARRAY NEW_ARRAY))
   (CL:WHEN (CL:= SIZE OLD_SIZE) (CL:RETURN-FROM RESIZE-VECTOR))
   (CL:SETQ NEW_ARRAY (CL:MAKE-ARRAY SIZE :INITIAL-ELEMENT NULL))
   (CL:WHEN (CL:< SIZE OLD_SIZE) (CL:SETQ OLD_SIZE SIZE) (CL:SETQ I OLD_SIZE))
...
This does not handle any necessary pathname translations or error conditions."
  (CL:LET* ((RESULT CL:NIL)) (CL:SETQ RESULT (PROBE-FILE? (FILE-NAME-AS-DIRECTORY FILENAME)))
...
NULL if that cannot be determined."
  (CL:LET* ((TRUEFILE (TRANSLATE-LOGICAL-PATHNAME FILENAME))) (CL:DECLARE (CL:TYPE CL:SIMPLE-STRING TRUEFILE))
   (CL:WHEN (CL:NOT (NATIVE-PROBE-FILE? TRUEFILE)) (ENSURE-FILE-EXISTS FILENAME "file-write-date"))
...
cannot be determined."
  (CL:LET* ((TRUEFILE (TRANSLATE-LOGICAL-PATHNAME FILENAME))) (CL:DECLARE (CL:TYPE CL:SIMPLE-STRING TRUEFILE))
   (CL:WHEN (CL:NOT (NATIVE-PROBE-FILE? TRUEFILE)) (ENSURE-FILE-EXISTS FILENAME "file-length"))
...
(CL:DEFUN DELETE-FILE (FILENAME)
  ...
  (CL:LET* ((TRUEFILE (TRANSLATE-LOGICAL-PATHNAME FILENAME))) (CL:DECLARE (CL:TYPE CL:SIMPLE-STRING TRUEFILE))
   (CL:WHEN (CL:NOT (NATIVE-PROBE-FILE? TRUEFILE)) (ENSURE-FILE-EXISTS FILENAME "delete-file"))
...
(CL:DEFUN RENAME-FILE (FROMFILE TOFILE)
  ...
  (CL:LET* ((TRUEFROM (TRANSLATE-LOGICAL-PATHNAME FROMFILE)) (TRUETO (TRANSLATE-LOGICAL-PATHNAME TOFILE)))
   ...
   (CL:WHEN (NATIVE-PROBE-FILE? TRUETO) (ENSURE-FILE-DOES-NOT-EXIST TOFILE "rename-file"))
...
(CL:DEFUN COPY-STREAM-TO-STREAM (IN OUT)
  ...
  (CL:LET* ((BUFFER (CL:MAKE-STRING *TOKENIZER-INITIAL-BUFFER-SIZE*)) (BYTESREAD 0))
   (CL:DECLARE (CL:TYPE CL:FIXNUM BYTESREAD))
   (CL:LOOP
    (CL:SETQ BYTESREAD (NATIVE-BYTE-ARRAY-READ-SEQUENCE BUFFER (%NATIVE-STREAM IN) 0 *TOKENIZER-INITIAL-BUFFER-SIZE*))
    (CL:COND ((CL:> BYTESREAD 0) (NATIVE-BYTE-ARRAY-WRITE-SEQUENCE BUFFER (%NATIVE-STREAM OUT) 0 BYTESREAD))
  ...
  (CL:LET* ((FROM NULL))
   (CL:UNWIND-PROTECT
    (CL:PROGN (CL:SETQ FROM (OPEN-INPUT-FILE FROMFILE))
     (CL:LET* ((TO NULL))
      (CL:UNWIND-PROTECT (CL:PROGN (CL:SETQ TO (OPEN-OUTPUT-FILE TOFILE)) (COPY-STREAM-TO-STREAM FROM TO))
  ...
  (CL:LET* ((DIR (%GET-PROPERTY (WRAP-STRING "stella.tempDirectory") NIL)))
   (CL:WHEN (CL:EQ DIR NULL)
    (CL:LET* ((TEST-VALUE-000 (OPERATING-SYSTEM)))
     (CL:COND
      ((CL:OR (CL:EQ TEST-VALUE-000 KWD-PRIMAL-UNIX) (CL:EQ TEST-VALUE-000 KWD-PRIMAL-MAC))
...
or OS process.  If necessary, this case can be handled by the caller."
  ...
  (CL:LET* ((I NULL-INTEGER) (ITER-000 0) (UPPER-BOUND-000 100))
   ...
   (CL:LOOP WHILE (CL:<= ITER-000 UPPER-BOUND-000) DO (CL:SETQ I ITER-000) (CL:SETQ I I)
    (CL:LET*
     ((UNIQUIFIER
       (FORMAT-WITH-PADDING (INTEGER-TO-STRING (CL:TRUNCATE (RANDOM 1000000))) 6 #\0 KWD-PRIMAL-RIGHT CL:NIL))
...
(CL:DEFUN CL-LIST-DIRECTORY-FILES (DIRECTORY)
  ...
  (CL:LET*
   ((FILES NULL) (DIRSEP (DIRECTORY-SEPARATOR-STRING)) (CHECKDUPLICATES? CL:NIL) (NORMFILE STELLA::NULL-STRING)
    (NORMALIZEDFILES NIL))
   ...
   (CL:WHEN CHECKDUPLICATES? (CL:SETQ NORMALIZEDFILES (REMOVE-DUPLICATES-EQUAL NORMALIZEDFILES)))
    ...
    (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-000 NIL)) DO (CL:SETQ FILE (%%VALUE ITER-000))
     (CL:TAGBODY (CL:SETQ NORMFILE (%WRAPPER-VALUE FILE))
      (CL:WHEN (ENDS-WITH? NORMFILE DIRSEP NULL-INTEGER)
       (CL:SETQ NORMFILE
        (SUBSEQUENCE NORMFILE 0 (CL:- (CL:THE CL:FIXNUM (CL:LENGTH NORMFILE)) (CL:THE CL:FIXNUM (CL:LENGTH DIRSEP))))))
      (CL:SETQ NORMFILE (FILE-NAME-WITHOUT-DIRECTORY NORMFILE))
      (CL:WHEN (CL:OR (STRING-EQL? NORMFILE ".") (STRING-EQL? NORMFILE "..")) (CL:GO :CONTINUE))
      (CL:IF (CL:EQ COLLECT-000 NULL)
       (CL:PROGN (CL:SETQ COLLECT-000 (CONS (WRAP-STRING NORMFILE) NIL))
        (CL:IF (CL:EQ NORMALIZEDFILES NIL) (CL:SETQ NORMALIZEDFILES COLLECT-000)
         (ADD-CONS-TO-END-OF-CONS-LIST NORMALIZEDFILES COLLECT-000)))
       (CL:PROGN (CL:SETF (%%REST COLLECT-000) (CONS (WRAP-STRING NORMFILE) NIL))
...
(CL:DEFUN CPP-LIST-DIRECTORY-FILES (DIRECTORY)
  ...
  (CL:LET* ((FILES NIL))
   (CL:WHEN (CL:EQ FILES NULL)
    (CL:LET* ((STREAM-000 (NEW-OUTPUT-STRING-STREAM)))
     (%%PRINT-STREAM (%NATIVE-STREAM STREAM-000) "list-directory-files: error reading `" DIRECTORY "'")
     (CL:ERROR (NEW-STELLA-EXCEPTION (THE-STRING-READER STREAM-000)))))
    ...
    (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-000 NIL)) DO (CL:SETQ FILE (%%VALUE ITER-000))
     (CL:COND
      ((PROBE-DIRECTORY? (CONCATENATE DIRECTORY (%WRAPPER-VALUE FILE)))
       (CL:SETQ FILE (WRAP-STRING (FILE-NAME-AS-DIRECTORY (%WRAPPER-VALUE FILE))))
       (CL:LET*
        ((SUBFILE NULL) (ITER-001 (%LIST-DIRECTORY-FILES-RECURSIVELY (CONCATENATE DIRECTORY (%WRAPPER-VALUE FILE)))))
        (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-001 NIL)) DO (CL:SETQ SUBFILE (%%VALUE ITER-001))
         (CL:SETQ FILES (CONS (WRAP-STRING (CONCATENATE (UNWRAP-STRING FILE) (%WRAPPER-VALUE SUBFILE))) FILES))
...
(CL:DEFUN LIST-DIRECTORY-FILES-RECURSIVELY-EVALUATOR-WRAPPER (ARGUMENTS)
  (CL:RETURN-FROM LIST-DIRECTORY-FILES-RECURSIVELY-EVALUATOR-WRAPPER
   (%LIST-DIRECTORY-FILES-RECURSIVELY (%WRAPPER-VALUE (%%VALUE ARGUMENTS)))))
...
If `x' is negative, we only count the value bits, not the sign."
  ...
  (CL:LET* ((BOT 0) (TOP (CL:1- LONG-INTEGER-BIT-WIDTH)) (SPLIT 0) (REM 0))
   (CL:DECLARE (CL:TYPE CL:FIXNUM BOT TOP SPLIT))
   (CL:LOOP
    (CL:SETQ SPLIT
     (CL:LET ((ARG (CL:+ BOT TOP)) (COUNT 1)) (CL:DECLARE (CL:TYPE CL:FIXNUM ARG COUNT))
      (CL:THE CL:FIXNUM (CL:ASH ARG (CL:THE CL:FIXNUM (CL:- COUNT))))))
    (CL:SETQ REM
     (CL:LET ((ARG X) (COUNT SPLIT)) (CL:DECLARE (CL:TYPE CL:FIXNUM COUNT))
      (CL:ASH ARG (CL:THE CL:FIXNUM (CL:- COUNT)))))
    (CL:WHEN (CL:= REM 1) (CL:RETURN-FROM INTEGER-LENGTH (CL:1+ SPLIT)))
    (CL:IF (CL:= REM 0) (CL:SETQ TOP (CL:1- SPLIT)) (CL:SETQ BOT (CL:1+ SPLIT))))))
...
UUID types.  Currently supported are:
  ...
  (CL:COND
   ((CL:OR (CL:EQ UUID-TYPE KWD-PRIMAL-TYPE-4) (CL:EQ UUID-TYPE KWD-PRIMAL-RANDOM))
    (CL:RETURN-FROM GENERATE-UUID (GENERATE-RANDOM-UUID)))
   (CL:T
    (CL:LET* ((STREAM-000 (NEW-OUTPUT-STRING-STREAM)))
     (%%PRINT-STREAM (%NATIVE-STREAM STREAM-000) "UUIDs of type `" UUID-TYPE "' are not supported.")
     (CL:ERROR (NEW-STELLA-EXCEPTION (THE-STRING-READER STREAM-000)))))))
...
bytes 7 and 8, - bytes 9 and 10, - then followed by bytes 11-16."
  (CL:RETURN-FROM GENERATE-RANDOM-UUID
   (CONCATENATE (ZERO-PAD-STRING (INTEGER-TO-HEX-STRING (CL:TRUNCATE (RANDOM 65536))) 4)
    (ZERO-PAD-STRING (INTEGER-TO-HEX-STRING (CL:TRUNCATE (RANDOM 65536))) 4) "-"
    (ZERO-PAD-STRING (INTEGER-TO-HEX-STRING (CL:TRUNCATE (RANDOM 65536))) 4) "-"
...
(CL:DEFUN HELP-STARTUP-PRIMAL1 ()
  (CL:PROGN (CL:SETQ SYM-PRIMAL-STELLA-FLOOR (INTERN-RIGID-SYMBOL-WRT-MODULE "FLOOR" NULL 0))
   (CL:SETQ KWD-PRIMAL-CPP (INTERN-RIGID-SYMBOL-WRT-MODULE "CPP" NULL 2))
   (CL:SETQ KWD-PRIMAL-FUNCTION (INTERN-RIGID-SYMBOL-WRT-MODULE "FUNCTION" NULL 2))
   (CL:SETQ SYM-PRIMAL-STELLA-ROUND (INTERN-RIGID-SYMBOL-WRT-MODULE "ROUND" NULL 0))
   (CL:SETQ SYM-PRIMAL-STELLA-FMOD (INTERN-RIGID-SYMBOL-WRT-MODULE "FMOD" NULL 0))
   (CL:SETQ SYM-PRIMAL-STELLA-RANDOM (INTERN-RIGID-SYMBOL-WRT-MODULE "RANDOM" NULL 0))
   (CL:SETQ SYM-PRIMAL-STELLA-SQRT (INTERN-RIGID-SYMBOL-WRT-MODULE "SQRT" NULL 0))
   (CL:SETQ SYM-PRIMAL-STELLA-COS (INTERN-RIGID-SYMBOL-WRT-MODULE "COS" NULL 0))
   (CL:SETQ SYM-PRIMAL-STELLA-SIN (INTERN-RIGID-SYMBOL-WRT-MODULE "SIN" NULL 0))
   (CL:SETQ SYM-PRIMAL-STELLA-TAN (INTERN-RIGID-SYMBOL-WRT-MODULE "TAN" NULL 0))
   (CL:SETQ SYM-PRIMAL-STELLA-ACOS (INTERN-RIGID-SYMBOL-WRT-MODULE "ACOS" NULL 0))
   (CL:SETQ SYM-PRIMAL-STELLA-ASIN (INTERN-RIGID-SYMBOL-WRT-MODULE "ASIN" NULL 0))
   (CL:SETQ SYM-PRIMAL-STELLA-ATAN (INTERN-RIGID-SYMBOL-WRT-MODULE "ATAN" NULL 0))
   (CL:SETQ SYM-PRIMAL-STELLA-ATAN2 (INTERN-RIGID-SYMBOL-WRT-MODULE "ATAN2" NULL 0))
   (CL:SETQ SYM-PRIMAL-STELLA-EXP (INTERN-RIGID-SYMBOL-WRT-MODULE "EXP" NULL 0))
   (CL:SETQ SYM-PRIMAL-STELLA-LOG (INTERN-RIGID-SYMBOL-WRT-MODULE "LOG" NULL 0))
   (CL:SETQ SYM-PRIMAL-STELLA-MIN (INTERN-RIGID-SYMBOL-WRT-MODULE "MIN" NULL 0))
   (CL:SETQ SYM-PRIMAL-STELLA-MAX (INTERN-RIGID-SYMBOL-WRT-MODULE "MAX" NULL 0))
   ...
   (CL:SETQ KWD-PRIMAL-UPCASE (INTERN-RIGID-SYMBOL-WRT-MODULE "UPCASE" NULL 2))
   (CL:SETQ KWD-PRIMAL-DOWNCASE (INTERN-RIGID-SYMBOL-WRT-MODULE "DOWNCASE" NULL 2))
   (CL:SETQ KWD-PRIMAL-CAPITALIZE (INTERN-RIGID-SYMBOL-WRT-MODULE "CAPITALIZE" NULL 2))
   (CL:SETQ KWD-PRIMAL-PRESERVE (INTERN-RIGID-SYMBOL-WRT-MODULE "PRESERVE" NULL 2))
   (CL:SETQ KWD-PRIMAL-LEFT (INTERN-RIGID-SYMBOL-WRT-MODULE "LEFT" NULL 2))
   (CL:SETQ KWD-PRIMAL-RIGHT (INTERN-RIGID-SYMBOL-WRT-MODULE "RIGHT" NULL 2))
   (CL:SETQ KWD-PRIMAL-CENTER (INTERN-RIGID-SYMBOL-WRT-MODULE "CENTER" NULL 2))
   (CL:SETQ SYM-PRIMAL-STELLA-HASH-CODE (INTERN-RIGID-SYMBOL-WRT-MODULE "HASH-CODE" NULL 0))
   (CL:SETQ KWD-PRIMAL-JAVA (INTERN-RIGID-SYMBOL-WRT-MODULE "JAVA" NULL 2))
   (CL:SETQ KWD-PRIMAL-UNIX (INTERN-RIGID-SYMBOL-WRT-MODULE "UNIX" NULL 2))
   (CL:SETQ KWD-PRIMAL-MAC (INTERN-RIGID-SYMBOL-WRT-MODULE "MAC" NULL 2))
   (CL:SETQ KWD-PRIMAL-WINDOWS (INTERN-RIGID-SYMBOL-WRT-MODULE "WINDOWS" NULL 2))
   ...
   (CL:SETQ SYM-PRIMAL-STELLA-LIST-DIRECTORY-FILES-RECURSIVELY
    (INTERN-RIGID-SYMBOL-WRT-MODULE "LIST-DIRECTORY-FILES-RECURSIVELY" NULL 0))
   (CL:SETQ KWD-PRIMAL-TYPE-4 (INTERN-RIGID-SYMBOL-WRT-MODULE "TYPE-4" NULL 2))
   (CL:SETQ KWD-PRIMAL-RANDOM (INTERN-RIGID-SYMBOL-WRT-MODULE "RANDOM" NULL 2))
...
(CL:DEFUN HELP-STARTUP-PRIMAL2 ()
  (CL:PROGN
   (DEFINE-FUNCTION-OBJECT "LISP-NULL-ARRAY-SYMBOL-STRING"
    "(DEFUN (LISP-NULL-ARRAY-SYMBOL-STRING STRING) ((RANK INTEGER)))" (CL:FUNCTION LISP-NULL-ARRAY-SYMBOL-STRING) NULL)
   (DEFINE-FUNCTION-OBJECT "PRINT-NUMERIC-CONSTANTS" "(DEFUN PRINT-NUMERIC-CONSTANTS () :COMMAND? TRUE)"
...
(CL:DEFUN HELP-STARTUP-PRIMAL4 ()
  (CL:PROGN
   ...
   (DEFINE-FUNCTION-OBJECT "STRING-CAPITALIZE"
    ...
    NULL NULL)
   (DEFINE-METHOD-OBJECT
    "(DEFMETHOD (COPY STRING) ((STRING STRING)) :DOCUMENTATION \"Return a copy of `string'.\" :NATIVE? TRUE)" NULL
    NULL)
   (DEFINE-METHOD-OBJECT
...
corresponding member of `new-chars' in the string `self'.  IMPORTANT:  The return
value should be used instead of relying on destructive substitution, since the
substitution will not be destructive in all translated languages.\" :PUBLIC? TRUE)" (CL:FUNCTION SUBSTITUTE-CHARACTERS)
    NULL)
   (DEFINE-METHOD-OBJECT
...
'size', padded if necessary with 0 characters.\")" (CL:FUNCTION ZERO-PAD-INTEGER) NULL)
   (DEFINE-FUNCTION-OBJECT "ZERO-PAD-STRING"
    "(DEFUN (ZERO-PAD-STRING STRING) ((INPUT STRING) (SIZE INTEGER)) :PUBLIC? FALSE)" (CL:FUNCTION ZERO-PAD-STRING)
    NULL)
   (DEFINE-METHOD-OBJECT "(DEFMETHOD (MEMBER? BOOLEAN) ((SELF STRING) (CHAR CHARACTER)) :NATIVE? TRUE :PUBLIC? TRUE)"
    NULL NULL)
   (DEFINE-METHOD-OBJECT
...
ends with `suffix'.  If `end' is NULL it defaults to the length of `string'.\" :PUBLIC? TRUE)" (CL:FUNCTION ENDS-WITH?)
    NULL)
...
This is identical to `read-s-expression-from-string'.\" :PUBLIC? TRUE :GLOBALLY-INLINE? TRUE (RETURN (READ-S-EXPRESSION-FROM-STRING STRING)))"
   ...
   (DEFINE-METHOD-OBJECT "(DEFMETHOD REMOVE-AT ((SELF HASH-TABLE) (KEY (LIKE (ANY-KEY SELF)))) :PUBLIC? TRUE)"
   ...
   (DEFINE-METHOD-OBJECT
    ...
    (CL:FUNCTION LOOKUP) NULL)
   (DEFINE-METHOD-OBJECT "(DEFMETHOD INSERT-AT ((SELF INTEGER-HASH-TABLE) (KEY INTEGER) (VALUE OBJECT)) :PUBLIC? TRUE)"
    (CL:FUNCTION INSERT-AT) NULL)
   (DEFINE-METHOD-OBJECT "(DEFMETHOD REMOVE-AT ((SELF INTEGER-HASH-TABLE) (KEY (LIKE (ANY-KEY SELF)))))"
    (CL:FUNCTION REMOVE-AT) NULL)
   (DEFINE-METHOD-OBJECT
   ...
   (DEFINE-METHOD-OBJECT
    ...
    (CL:FUNCTION LOOKUP) NULL)
   (DEFINE-METHOD-OBJECT "(DEFMETHOD INSERT-AT ((SELF FLOAT-HASH-TABLE) (KEY FLOAT) (VALUE OBJECT)) :PUBLIC? TRUE)"
    (CL:FUNCTION INSERT-AT) NULL)
   (DEFINE-METHOD-OBJECT "(DEFMETHOD REMOVE-AT ((SELF FLOAT-HASH-TABLE) (KEY (LIKE (ANY-KEY SELF)))))"
    (CL:FUNCTION REMOVE-AT) NULL)
   (DEFINE-METHOD-OBJECT
   ...
   (DEFINE-METHOD-OBJECT
    ...
    (CL:FUNCTION LOOKUP) NULL)
   (DEFINE-METHOD-OBJECT "(DEFMETHOD INSERT-AT ((SELF STRING-HASH-TABLE) (KEY STRING) (VALUE OBJECT)) :PUBLIC? TRUE)"
    (CL:FUNCTION INSERT-AT) NULL)
   (DEFINE-METHOD-OBJECT "(DEFMETHOD REMOVE-AT ((SELF STRING-HASH-TABLE) (KEY STRING)) :PUBLIC? TRUE)"
    (CL:FUNCTION REMOVE-AT) NULL)
   (DEFINE-METHOD-OBJECT
   ...
   (DEFINE-METHOD-OBJECT
    ...
    (CL:FUNCTION INSERT-AT) NULL)
   (DEFINE-METHOD-OBJECT "(DEFMETHOD REMOVE-AT ((SELF STRING-TO-INTEGER-HASH-TABLE) (KEY STRING)) :PUBLIC? TRUE)"
    (CL:FUNCTION REMOVE-AT) NULL)
...
e.g., Lisp will convert . or .. into absolute pathnames.\" :PUBLIC? TRUE :COMMAND? TRUE)"
    (CL:FUNCTION %LIST-DIRECTORY-FILES) (CL:FUNCTION LIST-DIRECTORY-FILES-EVALUATOR-WRAPPER))
...
within directories which results in a depth-first presentation order of files.\" :PUBLIC? TRUE :COMMAND? TRUE)"
    (CL:FUNCTION %LIST-DIRECTORY-FILES-RECURSIVELY) (CL:FUNCTION LIST-DIRECTORY-FILES-RECURSIVELY-EVALUATOR-WRAPPER))
   (DEFINE-METHOD-OBJECT
...
exception.  For example, in Java it prints a stack trace.  In Lisp, it is vendor dependent.\")"
   ...
   (DEFINE-FUNCTION-OBJECT "MAKE-PROCESS-LOCK" "(DEFUN (MAKE-PROCESS-LOCK PROCESS-LOCK-OBJECT) () :PUBLIC? TRUE)"
    (CL:FUNCTION MAKE-PROCESS-LOCK) NULL)
   (DEFINE-FUNCTION-OBJECT "STARTUP-PRIMAL" "(DEFUN STARTUP-PRIMAL () :PUBLIC? TRUE)" (CL:FUNCTION STARTUP-PRIMAL)
    NULL)
   (CL:LET* ((FUNCTION (LOOKUP-FUNCTION SYM-PRIMAL-STELLA-STARTUP-PRIMAL)))
    (SET-DYNAMIC-SLOT-VALUE (%DYNAMIC-SLOTS FUNCTION) SYM-PRIMAL-STELLA-METHOD-STARTUP-CLASSNAME
...
(CL:DEFUN STARTUP-PRIMAL ()
  (CL:WHEN (CURRENT-STARTUP-TIME-PHASE? 0) (CL:SETQ *HASH-BYTE-RANDOM-TABLE* (CL:MAKE-ARRAY 256))
   (CL:LET* ((I NULL-INTEGER) (ITER-008 0) (UPPER-BOUND-009 255))
    ...
    (CL:LOOP WHILE (CL:<= ITER-008 UPPER-BOUND-009) DO (CL:SETQ I ITER-008)
     (CL:SETF (CL:AREF *HASH-BYTE-RANDOM-TABLE* I) 0) (CL:SETQ ITER-008 (CL:1+ ITER-008))))
   (CL:LET*
    ((BIT NULL-INTEGER) (ITER-010 0) (UPPER-BOUND-011 #.(cl:1- (cl:integer-length cl:most-positive-fixnum)))
     (UNBOUNDED?-012 (CL:= UPPER-BOUND-011 NULL-INTEGER)))
    (CL:DECLARE (CL:TYPE CL:FIXNUM BIT ITER-010 UPPER-BOUND-011))
    (CL:LOOP WHILE (CL:OR UNBOUNDED?-012 (CL:<= ITER-010 UPPER-BOUND-011)) DO (CL:SETQ BIT ITER-010)
     (CL:LET* ((I NULL-INTEGER) (ITER-013 0) (UPPER-BOUND-014 255))
      (CL:DECLARE (CL:TYPE CL:FIXNUM I ITER-013 UPPER-BOUND-014))
      (CL:LOOP WHILE (CL:<= ITER-013 UPPER-BOUND-014) DO (CL:SETQ I ITER-013)
       (CL:SETF (CL:AREF *HASH-BYTE-RANDOM-TABLE* I)
        (CL:THE CL:FIXNUM
         (CL:LOGIOR (CL:THE CL:FIXNUM (CL:AREF *HASH-BYTE-RANDOM-TABLE* I))
          (CL:THE CL:FIXNUM (CL:ASH (CL:THE CL:FIXNUM (RANDOM 2)) BIT)))))
       (CL:SETQ ITER-013 (CL:1+ ITER-013))))
     (CL:SETQ ITER-010 (CL:1+ ITER-010))))
   (CL:SETQ *HASH-TABLE-SIZE-PRIME-STRINGS*
    (VECTOR (WRAP-STRING "29") (WRAP-STRING "53") (WRAP-STRING "97") (WRAP-STRING "193") (WRAP-STRING "389")
     (WRAP-STRING "769") (WRAP-STRING "1543") (WRAP-STRING "3079") (WRAP-STRING "6151") (WRAP-STRING "12289")
     (WRAP-STRING "24593") (WRAP-STRING "49157") (WRAP-STRING "98317") (WRAP-STRING "196613") (WRAP-STRING "393241")
     (WRAP-STRING "786433") (WRAP-STRING "1572869") (WRAP-STRING "3145739") (WRAP-STRING "6291469")
     (WRAP-STRING "12582917") (WRAP-STRING "25165843") (WRAP-STRING "50331653") (WRAP-STRING "100663319")
     (WRAP-STRING "201326611") (WRAP-STRING "402653189") (WRAP-STRING "805306457") (WRAP-STRING "1610612741")))
  ...
  (CL:LET* ((*MODULE* *STELLA-MODULE*) (*CONTEXT* *MODULE*)) (CL:DECLARE (CL:SPECIAL *MODULE* *CONTEXT*))
   ...
   (CL:WHEN (CURRENT-STARTUP-TIME-PHASE? 4) (CL:SETQ MOST-NEGATIVE-INTEGER (CL:1+ NULL-INTEGER))
    (CL:SETQ MOST-NEGATIVE-LONG-INTEGER (CL:1+ NULL-LONG-INTEGER))
    (CL:SETQ LEAST-NEGATIVE-FLOAT (CL:- 0 LEAST-POSITIVE-FLOAT))
    (CL:SETQ RECIPROCAL-NL2 (CL:/ 1.0d0 (CL:THE CL:DOUBLE-FLOAT (CL:LOG 2.0d0))))
    (CL:SETQ RECIPROCAL-NL10 (CL:/ 1.0d0 (CL:THE CL:DOUBLE-FLOAT (CL:LOG 10.0d0))))
    (CL:SETQ LONG-INTEGER-BIT-WIDTH
     (ROUND
      (CL:/ (CL:THE CL:DOUBLE-FLOAT (CL:LOG (CL:THE CL:DOUBLE-FLOAT (CL:* MOST-POSITIVE-LONG-INTEGER 2.0d0))))
       (CL:THE CL:DOUBLE-FLOAT (CL:LOG 2.0d0))))))
   (CL:WHEN (CURRENT-STARTUP-TIME-PHASE? 6) (FINALIZE-CLASSES))
   (CL:WHEN (CURRENT-STARTUP-TIME-PHASE? 7) (HELP-STARTUP-PRIMAL2) (HELP-STARTUP-PRIMAL3) (HELP-STARTUP-PRIMAL4)
...
Used for log 10 conversions.\")")
    (REGISTER-NATIVE-NAME SYM-PRIMAL-STELLA-FLOOR KWD-PRIMAL-CPP KWD-PRIMAL-FUNCTION)
    (REGISTER-NATIVE-NAME SYM-PRIMAL-STELLA-ROUND KWD-PRIMAL-CPP KWD-PRIMAL-FUNCTION)
    (REGISTER-NATIVE-NAME SYM-PRIMAL-STELLA-FMOD KWD-PRIMAL-CPP KWD-PRIMAL-FUNCTION)
    (REGISTER-NATIVE-NAME SYM-PRIMAL-STELLA-RANDOM KWD-PRIMAL-CPP KWD-PRIMAL-FUNCTION)
    (REGISTER-NATIVE-NAME SYM-PRIMAL-STELLA-SQRT KWD-PRIMAL-CPP KWD-PRIMAL-FUNCTION)
    (REGISTER-NATIVE-NAME SYM-PRIMAL-STELLA-COS KWD-PRIMAL-CPP KWD-PRIMAL-FUNCTION)
    (REGISTER-NATIVE-NAME SYM-PRIMAL-STELLA-SIN KWD-PRIMAL-CPP KWD-PRIMAL-FUNCTION)
    (REGISTER-NATIVE-NAME SYM-PRIMAL-STELLA-TAN KWD-PRIMAL-CPP KWD-PRIMAL-FUNCTION)
    (REGISTER-NATIVE-NAME SYM-PRIMAL-STELLA-ACOS KWD-PRIMAL-CPP KWD-PRIMAL-FUNCTION)
    (REGISTER-NATIVE-NAME SYM-PRIMAL-STELLA-ASIN KWD-PRIMAL-CPP KWD-PRIMAL-FUNCTION)
    (REGISTER-NATIVE-NAME SYM-PRIMAL-STELLA-ATAN KWD-PRIMAL-CPP KWD-PRIMAL-FUNCTION)
    (REGISTER-NATIVE-NAME SYM-PRIMAL-STELLA-ATAN2 KWD-PRIMAL-CPP KWD-PRIMAL-FUNCTION)
    (REGISTER-NATIVE-NAME SYM-PRIMAL-STELLA-EXP KWD-PRIMAL-CPP KWD-PRIMAL-FUNCTION)
    (REGISTER-NATIVE-NAME SYM-PRIMAL-STELLA-LOG KWD-PRIMAL-CPP KWD-PRIMAL-FUNCTION)
    (REGISTER-NATIVE-NAME SYM-PRIMAL-STELLA-MIN KWD-PRIMAL-CPP KWD-PRIMAL-FUNCTION)
    (REGISTER-NATIVE-NAME SYM-PRIMAL-STELLA-MAX KWD-PRIMAL-CPP KWD-PRIMAL-FUNCTION)
    (DEFINE-STELLA-GLOBAL-VARIABLE-FROM-STRINGIFIED-SOURCE
...
that are suitable to be used as hash table sizes.\" :PUBLIC? TRUE)")
    ...
    (REGISTER-NATIVE-NAME SYM-PRIMAL-STELLA-LIST-DIRECTORY-FILES-RECURSIVELY KWD-PRIMAL-COMMON-LISP
     KWD-PRIMAL-FUNCTION)
    (DEFINE-STELLA-GLOBAL-VARIABLE-FROM-STRINGIFIED-SOURCE
