    ...
    ((CL:< EQVECTOR 0)
     (CL:LOOP WHILE (CL:NOT (CL:EQ ENTRIES NIL)) DO
      (CL:LET* ((ALWAYS?-000 CL:T))
       (CL:LET*
        ((ENTRYARG NULL) (ITER-000 (%%REST (%%VALUE ENTRIES))) (INPUTARG NULL)
         (ITER-001 TUPLE))
        (CL:LOOP WHILE
   ...
   (CL:WHEN (CL:NOT (CL:EQ BUCKET NULL))
    (CL:COND
     ((CL:EQ (%%VALUE BUCKET) TIMESTAMP)
      (CL:SETQ ENTRY
       (FIND-MEMOIZED-VALUE-ENTRY BUCKET ARG1 ARG2 ARG3 ARG4 EQVECTOR CL:NIL))
...
(CL:DEFUN LOOKUP-MEMOIZED-VALUEN (MEMOTABLE ARGS EQVECTOR)
  ...
  (CL:LET*
   ...
   (CL:WHEN (CL:NOT (CL:EQ BUCKET NULL))
    (CL:COND
     ((CL:EQ (%%VALUE BUCKET) TIMESTAMP)
      (CL:SETQ ENTRY (FIND-MEMOIZED-VALUE-ENTRYN BUCKET ARGS EQVECTOR CL:NIL))
      (CL:WHEN (CL:NOT (CL:EQ ENTRY NULL))
...
(CL:DEFUN LOOKUP-MRU-MEMOIZED-VALUE (MEMOTABLE ARG1 ARG2 ARG3 ARG4 EQVECTOR)
  ...
  (CL:LET*
   ((MRUBUCKETS (%MRU-BUCKETS MEMOTABLE))
    (LRUBUCKETS STELLA::NULL-NATIVE-VECTOR) (MRUBUCKET NIL) (LRUBUCKET NIL)
   ...
   (CL:WHEN (CL:NOT (CL:EQ MRUBUCKET NULL))
    (CL:COND
     ((CL:EQ (%%VALUE MRUBUCKET) MRUTIMESTAMP)
      (CL:SETQ ENTRY
       (FIND-MEMOIZED-VALUE-ENTRY MRUBUCKET ARG1 ARG2 ARG3 ARG4 EQVECTOR
        CL:NIL))
      (CL:WHEN (CL:NOT (CL:EQ ENTRY NULL))
   ...
   (CL:WHEN (CL:NOT (CL:EQ LRUBUCKET NULL))
    (CL:COND
     ((CL:EQ (%%VALUE LRUBUCKET) (%LRU-TIMESTAMP MEMOTABLE))
      (CL:SETQ ENTRY
       (FIND-MEMOIZED-VALUE-ENTRY LRUBUCKET ARG1 ARG2 ARG3 ARG4 EQVECTOR
        CL:T)))
   ...
   (CL:WHEN
    (CL:=
     (CL:SETF (%FREE-ENTRIES MEMOTABLE) (CL:1- (%FREE-ENTRIES MEMOTABLE))) 0)
         ...
         (CL:LET* ((TEST-VALUE-001 CL:NIL))
          (CL:LET* ((ALWAYS?-000 CL:T))
           (CL:LET* ((TS NULL) (ITER-001 VALUE))
            (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-001 NIL)) DO
             (CL:SETQ TS (%%VALUE ITER-001))
             (CL:WHEN (CL:NOT (KEYWORD? TS)) (CL:SETQ ALWAYS?-000 CL:NIL)
              (CL:RETURN))
             (CL:SETQ ITER-001 (%%REST ITER-001))))
...
wrapped literals (with the exception of BOOLEANs)."
  (CL:LET*
   ...
   (CL:LET*
    ((IT (ALLOCATE-ITERATOR INPUTARGS)) (INDEX NULL-INTEGER) (ITER-000 0))
   ...
   (CL:RETURN-FROM MEMOIZE
    (LIST* SYM-MEMOIZE-STELLA-VRLET
     (LIST*
      (CONS MEMOTABLEVAR
       (LIST* SYM-MEMOIZE-STELLA-MEMOIZATION-TABLE SYM-MEMOIZE-STELLA-NULL
        NIL))
      (CONS MEMOENTRYVAR
...
generating and saving the next value of the `base-iterator'."
  (CL:LET* ((ITERATOR NULL) (CURSOR (%CURSOR SELF)) (VALUES (%%REST CURSOR)))
   (CL:WHEN (CL:NOT (CL:EQ VALUES NIL))
    (CL:SETF (%VALUE SELF) (%%VALUE VALUES)) (CL:SETF (%CURSOR SELF) VALUES)
   ...
   (CL:WHEN (CL:NOT (CL:EQ ITERATOR NULL))
    (CL:WHEN (NEXT? ITERATOR) (CL:SETF (%VALUE SELF) (%VALUE ITERATOR))
     ...
     (CL:SETF (%CURSOR SELF) (%%REST CURSOR)) (CL:RETURN-FROM NEXT? CL:T))
