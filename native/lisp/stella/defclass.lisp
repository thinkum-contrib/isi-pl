...
(CL:DECLAIM
  ...
  *RECYCLE-LISTS-MAINTENANCE-TIMER* *RECYCLE-LISTS-MAINTENANCE-INTERVAL*
  TRUE-WRAPPER FALSE-WRAPPER NULL-INTEGER *CURRENT-STELLA-FEATURES*
  *TRANSLATE-WITH-RECYCLE-LIST-DEBUGGING?* *CURRENTLY-RECYCLED-ITEMS* TRUE
  STANDARD-ERROR EOL *TRANSLATOROUTPUTLANGUAGE* NULL-STRING-WRAPPER NIL FALSE))
...
(CL:DEFUN YIELD-CONS-LIST-FROM-SEQUENCE (SEQUENCE)
  (CL:LET* ((LIST NIL))
   (CL:LET*
    ((ITEM NULL) (ITER-000 (ALLOCATE-ITERATOR SEQUENCE)) (COLLECT-000 NULL))
...
(CL:DEFUN CREATE-NATIVE-CLASS? (CLASS)
  (CL:LET* ((CLASSNATIVETYPE STELLA::NULL-STRING))
     ...
     (CL:SETQ CLASSNATIVETYPE
      (%WRAPPER-VALUE
       (DYNAMIC-SLOT-VALUE (%DYNAMIC-SLOTS CLASS)
        SYM-DEFCLASS-STELLA-CLASS-CL-NATIVE-TYPE NULL-STRING-WRAPPER))))
    ((CL:EQ *TRANSLATOROUTPUTLANGUAGE* KWD-DEFCLASS-IDL)
     (CL:SETQ CLASSNATIVETYPE
      (%WRAPPER-VALUE
       (DYNAMIC-SLOT-VALUE (%DYNAMIC-SLOTS CLASS)
        SYM-DEFCLASS-STELLA-CLASS-IDL-NATIVE-TYPE NULL-STRING-WRAPPER))))
    ((CL:EQ *TRANSLATOROUTPUTLANGUAGE* KWD-DEFCLASS-JAVA)
     (CL:SETQ CLASSNATIVETYPE
      (%WRAPPER-VALUE
       (DYNAMIC-SLOT-VALUE (%DYNAMIC-SLOTS CLASS)
        SYM-DEFCLASS-STELLA-CLASS-JAVA-NATIVE-TYPE NULL-STRING-WRAPPER))))
    ((CL:OR (CL:EQ *TRANSLATOROUTPUTLANGUAGE* KWD-DEFCLASS-CPP)
      (CL:EQ *TRANSLATOROUTPUTLANGUAGE* KWD-DEFCLASS-CPP-STANDALONE))
     (CL:SETQ CLASSNATIVETYPE
      (%WRAPPER-VALUE
       (DYNAMIC-SLOT-VALUE (%DYNAMIC-SLOTS CLASS)
        SYM-DEFCLASS-STELLA-CLASS-CPP-NATIVE-TYPE NULL-STRING-WRAPPER))))
    (CL:T
   ...
   (CL:RETURN-FROM CREATE-NATIVE-CLASS?
    (CL:NOT
     (CL:OR
      (SUBTYPE-OF? (%CLASS-TYPE CLASS) SGT-DEFCLASS-STELLA-SECOND-CLASS-OBJECT)
...
(CL:DEFUN EXCEPTION-CLASS? (CLASS)
  (CL:RETURN-FROM EXCEPTION-CLASS?
   (SUBTYPE-OF? (%CLASS-TYPE CLASS) SGT-DEFCLASS-STELLA-NATIVE-EXCEPTION)))
      ...
      (CL:WHEN (CL:> (CL:- NOFSUPERS NOFMIXINSUPERS) 1)
       (CL:LET* ((*PRINTREADABLY?* TRUE))
        ...
        (CL:WHEN (CL:NOT (SUPPRESS-WARNINGS?))
         ...
         (%%PRINT-STREAM (%NATIVE-STREAM STANDARD-ERROR) EOL " Class `"
          (CLASS-NAME CLASS) "' illegally inherits `"
      ...
      (CL:LET* ((FOUND?-000 FALSE))
       (CL:LET* ((OTHERSUPER NULL) (ITER-001 (%THE-CONS-LIST DIRECTSUPERS)))
        (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-001 NIL)) DO
         (CL:PROGN (CL:SETQ OTHERSUPER (%%VALUE ITER-001))
        ...
        (CL:LET* ((*PRINTREADABLY?* TRUE))
         ...
         (CL:WHEN (CL:NOT (SUPPRESS-WARNINGS?))
          ...
          (%%PRINT-STREAM (%NATIVE-STREAM STANDARD-ERROR) EOL
           " Bad list of supers defined for class `" (CLASS-NAME CLASS) "'." EOL
           " The class `" (%SYMBOL-NAME SUPER) "' is not a direct superclass."
           EOL)))
  ...
  (CL:LET* ((EQUIVSLOT (%SLOT-DIRECT-EQUIVALENT SLOT)))
   (CL:RETURN-FROM REDUNDANT-SLOT?
    (CL:AND (CL:NOT (CL:EQ EQUIVSLOT NULL))
     (CL:EQ
      (DYNAMIC-SLOT-VALUE (%DYNAMIC-SLOTS SLOT) SYM-DEFCLASS-STELLA-SLOT-RENAMES
       NULL)
      (%SLOT-NAME EQUIVSLOT))))))
...
(CL:DEFUN NATIVE-SLOT? (SLOT)
  (CL:RETURN-FROM NATIVE-SLOT?
   (CL:AND (CL:NOT (%ABSTRACT? SLOT)) (CL:NOT (%SLOT-HARDWIRED? SLOT))
    (CL:NOT (SPACE-SAVER-SLOT-ALLOCATION? SLOT)) (CL:NOT (REDUNDANT-SLOT? SLOT)))))

;;; (DEFUN (NATIVE-METHOD? BOOLEAN) ...)

(CL:DEFUN NATIVE-METHOD? (SLOT)
  (CL:RETURN-FROM NATIVE-METHOD?
   (CL:AND (CL:NOT (%ABSTRACT? SLOT))
  ...
  (CL:LET* ((OWNER (%SLOT-OWNER SELF)))
   (CL:RETURN-FROM MIXIN-SLOT?
    (CL:AND (STORAGE-SLOT? SELF) (CL:NOT (CL:EQ OWNER NULL))
     (CL:NOT (CL:EQ (%SURROGATE-VALUE OWNER) NULL))
...
(CL:DEFUN MIXIN-METHOD? (SELF)
  (CL:LET* ((OWNER (%SLOT-OWNER SELF)))
   (CL:RETURN-FROM MIXIN-METHOD?
    (CL:AND (METHOD-SLOT? SELF) (CL:NOT (%METHOD-FUNCTION? SELF))
     (CL:NOT (CL:EQ OWNER NULL)) (CL:NOT (CL:EQ (%SURROGATE-VALUE OWNER) NULL))
     (%MIXIN? (%SURROGATE-VALUE OWNER))))))
   ...
   (CL:LOOP WHILE
    (CL:AND (CL:NOT (CL:EQ (%SLOT-DIRECT-EQUIVALENT CANONICALSLOT) NULL))
     (CL:EQ (%SLOT-NAME (%SLOT-DIRECT-EQUIVALENT CANONICALSLOT))
      (DYNAMIC-SLOT-VALUE (%DYNAMIC-SLOTS CANONICALSLOT)
...
(CL:DEFUN SLOT-HAS-UNKNOWN-TYPE? (SLOT CLASS)
  (CL:RETURN-FROM SLOT-HAS-UNKNOWN-TYPE?
   (UNKNOWN-TYPE?
    (TYPE-SPEC-TO-BASE-TYPE (COMPUTE-RETURN-TYPE-SPEC SLOT (%CLASS-TYPE CLASS))))))
   ...
   (CL:LET* ((SUPER NULL) (ITER-000 (%CLASS-ALL-SUPER-CLASSES CLASS)))
    (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-000 NIL)) DO
     ...
     (CL:IF (SLOT-HAS-UNKNOWN-TYPE? SLOT SUPER)
      (CL:RETURN-FROM NATIVE-STORAGE-SLOT-HOME CLASS) (CL:SETQ CLASS SUPER))))
   (CL:RETURN-FROM NATIVE-STORAGE-SLOT-HOME CLASS)))
  ...
  (CL:LET*
   ((NATIVESLOTHOME
     (CL:IF (STORAGE-SLOT? SLOT) (NATIVE-STORAGE-SLOT-HOME SLOT CLASS)
      (%SURROGATE-VALUE (%SLOT-OWNER SLOT))))
   ...
   (CL:LET* ((SUPERCLASS NULL) (ITER-000 (%CLASS-ALL-SUPER-CLASSES CLASS)))
    (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-000 NIL)) DO
     (CL:PROGN (CL:SETQ SUPERCLASS (%%VALUE ITER-000))
      (CL:SETQ ITER-000 (%%REST ITER-000)))
     (CL:WHEN
      (CL:AND (CL:NOT (%MIXIN? SUPERCLASS))
       (MEMBER? (%CLASS-ALL-SUPER-CLASSES SUPERCLASS) NATIVESLOTHOME))
   ...
   (CL:LET*
    ...
    (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-000 NIL)) DO
     ...
     (CL:WHEN
      ...
      (CL:SETQ FOUND?-000 TRUE) (CL:RETURN))))
   (CL:WHEN FOUND?-000 (CL:RETURN-FROM METHOD-CONTAINS-UNKNOWN-TYPE? TRUE)))
  (CL:LET*
   ((PTYPE NULL)
   ...
   (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-001 NIL)) DO
    ...
    (CL:WHEN
     ...
     (CL:RETURN-FROM METHOD-CONTAINS-UNKNOWN-TYPE? TRUE))))
  (CL:RETURN-FROM METHOD-CONTAINS-UNKNOWN-TYPE? FALSE))
      ...
      ((SUBTYPE-OF-STORAGE-SLOT? (SAFE-PRIMARY-TYPE SLOT))
       (CL:PROGN
        (CL:WHEN
         (CL:AND
          (CL:NOT
           (CL:EQ (%SLOT-NAME SLOT) SYM-DEFCLASS-STELLA-NEXT-SWEEP-LIST-OBJECT))
          (NATIVE-SLOT? SLOT))
         (CL:WHEN (CL:EQ INSTANCETYPE (%SLOT-BASE-TYPE SLOT))
   ...
   (CL:WHEN (CL:NOT (CL:EQ CLASS NULL))
    (CL:COND
     ((CL:EQ *TRANSLATOROUTPUTLANGUAGE* KWD-DEFCLASS-COMMON-LISP)
      (CL:COND
       ((CL:OR
         (MEMB? *CURRENT-STELLA-FEATURES* KWD-DEFCLASS-USE-COMMON-LISP-STRUCTS)
    ...
    (CL:WHEN (CL:AND (USE-FREE-LIST? CLASS) (CL:EQ (RECYCLE-SLOT CLASS) NULL))
...
(CL:DEFUN YIELD-CREATION-TREES (CLASS)
  (CL:COND
   ...
   ((DECIDED-TO-RECYCLE? CLASS)
    (CL:RETURN-FROM YIELD-CREATION-TREES (YIELD-CREATION-OR-REUSE-TREES CLASS)))
  ...
  (CL:LET* ((TREES NIL) (TERMINATOR (TERMINATOR CLASS)))
   (CL:LET* ((SLOT NULL) (ITER-000 (CLASS-SLOTS CLASS)))
    (CL:LOOP WHILE (NEXT? ITER-000) DO (CL:SETQ SLOT (%VALUE ITER-000))
     (CL:COND
      ...
      (CL:T))))
   (CL:WHEN
    (CL:NOT (CL:EQ (LOOKUP-SLOT CLASS SYM-DEFCLASS-STELLA-DYNAMIC-SLOTS) NULL))
    (CL:SETQ TREES
     (CONS
      (LIST* SYM-DEFCLASS-STELLA-CLEAR
       (LIST* SYM-DEFCLASS-STELLA-DYNAMIC-SLOTS SYM-DEFCLASS-STELLA-SELF NIL)
       NIL)
      TREES)))
   (CL:WHEN (CL:NOT (CL:EQ TERMINATOR NULL))
    (CL:IF (USE-SWEEP-LIST? CLASS)
     (CL:SETQ TREES
      (CONS (CONS TERMINATOR (CONS SYM-DEFCLASS-STELLA-SELF NIL)) TREES))
     (CL:SETQ TREES
      (CONS
   ...
   (CL:RETURN-FROM YIELD-TERMINATE-OBJECT-TREES
    (CONCATENATE (REVERSE TREES)
     (YIELD-INITIAL-VALUE-ASSIGNMENTS CLASS KWD-DEFCLASS-FORCE-NULL-VALUE)))))
   ...
   ((RECYCLESLOT (RECYCLE-SLOT CLASS))
    (RECYCLESLOTRESETTREE
     (CL:IF (CL:NOT (CL:EQ RECYCLESLOT NULL))
      (YIELD-INITIAL-VALUE-ASSIGNMENT RECYCLESLOT KWD-DEFCLASS-NULL-VALUE-ONLY)
      NULL))
      ...
      (LIST* SYM-DEFCLASS-STELLA-SETQ SYM-DEFCLASS-STELLA-SELF
       (CL:IF (CL:NOT (CL:EQ RECYCLESLOT NULL))
        ...
        (LIST* SYM-DEFCLASS-STELLA-POP
         (LIST* SYM-DEFCLASS-STELLA-LIST-OF-RECYCLED-ITEMS RECYCLELIST NIL) NIL))
       NIL)
      NIL)
        ...
        (CONCATENATE
         ...
         (CONS
          (LIST* SYM-DEFCLASS-STELLA---
           (LIST* SYM-DEFCLASS-STELLA-CURRENT-LENGTH RECYCLELIST NIL) NIL)
          (CONCATENATE (YIELD-UNREGISTER-RECYCLED-ITEM-TREES) NIL)))))
      (CONS SYM-DEFCLASS-STELLA-OTHERWISE
       (CONCATENATE (YIELD-MAKE-TREES CLASS)
        (CONCATENATE
         (YIELD-INITIAL-VALUE-ASSIGNMENTS CLASS KWD-DEFCLASS-NULL-VALUE-ONLY)
         NIL)))
      NIL)
     NIL))))
          ...
          (CONCATENATE
           ...
           (LIST*
            ...
            (LIST* SYM-DEFCLASS-STELLA-WHEN
             (LIST* SYM-DEFCLASS-STELLA-=
              (LIST* SYM-DEFCLASS-STELLA---
               SYM-DEFCLASS-STELLA-*RECYCLE-LISTS-MAINTENANCE-TIMER* NIL)
              (WRAP-INTEGER 0) NIL)
      ...
      (LIST*
       ...
       (LIST* SYM-DEFCLASS-STELLA-SETQ SYM-DEFCLASS-STELLA-SELF
        (CL:IF (CL:NOT (CL:EQ RECYCLESLOT NULL))
         (LIST* SYM-DEFCLASS-STELLA-RECYCLED-ITEMS RECYCLELIST NIL)
         (LIST* SYM-DEFCLASS-STELLA-POP
          (LIST* SYM-DEFCLASS-STELLA-LIST-OF-RECYCLED-ITEMS RECYCLELIST NIL)
          NIL))
        NIL)
       (LIST* SYM-DEFCLASS-STELLA-COND
        (CONS (LIST* SYM-DEFCLASS-STELLA-DEFINED? SYM-DEFCLASS-STELLA-SELF NIL)
        ...
        (LIST* SYM-DEFCLASS-STELLA-OTHERWISE
         ...
         (LIST* SYM-DEFCLASS-STELLA-COND
          (LIST*
           (LIST* SYM-DEFCLASS-STELLA-DEFINED? SYM-DEFCLASS-STELLA-SELF NIL)
           (LIST* SYM-DEFCLASS-STELLA-SETF
            (LIST* SYM-DEFCLASS-STELLA-UNUSED-ITEMS RECYCLELIST NIL)
            (LIST* SYM-DEFCLASS-STELLA-NEXT-SWEEP-LIST-OBJECT
             (LIST* SYM-DEFCLASS-STELLA-UNUSED-ITEMS RECYCLELIST NIL) NIL)
...
(CL:DEFUN MARK-DIRECT-EQUIVALENT-SLOT (SLOT)
  (CL:LET* ((DIRECTEQUIVALENT (%SLOT-DIRECT-EQUIVALENT SLOT)))
   (CL:WHEN (CL:NOT (CL:EQ DIRECTEQUIVALENT NULL))
    (CL:IF (%SLOT-MARKED? DIRECTEQUIVALENT) (CL:SETF (%SLOT-MARKED? SLOT) TRUE)
     (CL:SETF (%SLOT-MARKED? DIRECTEQUIVALENT) TRUE))))
  :VOID)
    ...
    (CL:COND
     ((CL:EQ MODE KWD-DEFCLASS-NULL-VALUE-ONLY)
      (CL:WHEN
       (CL:OR REQUIREDSLOT?
        (CL:NOT
         (EQUAL-CONS-TREES? (TYPE-TO-NULL-VALUE-TREE (TYPE SLOT))
     ...
     ((CL:EQ MODE KWD-DEFCLASS-FORCE-NULL-VALUE)
      (CL:SETQ INITIALVALUEEXPRESSION (TYPE-TO-NULL-VALUE-TREE (TYPE SLOT))))
    ...
    (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-002 NIL)) DO
     ...
     (CL:WHEN (CL:AND (CL:NOT (%SLOT-MARKED? SLOT)) (STORAGE-SLOT? SLOT))
      (CL:SETQ INITIALVALUEASSIGNMENT
       (YIELD-INITIAL-VALUE-ASSIGNMENT SLOT KWD-DEFCLASS-ANY-INITIAL-VALUE))
      (CL:WHEN (CL:NOT (CL:EQ INITIALVALUEASSIGNMENT NULL))
       (CL:SETQ ASSIGNMENTS (CONS INITIALVALUEASSIGNMENT ASSIGNMENTS))))))
  ...
  (CL:LET*
   ((INITIALVALUEASSIGNMENTS
     (YIELD-INITIAL-VALUE-ASSIGNMENTS CLASS
      (CL:IF (DECIDED-TO-RECYCLE? CLASS) KWD-DEFCLASS-INITIAL-VALUE-ONLY
       KWD-DEFCLASS-ANY-INITIAL-VALUE))))
   (CL:WHEN
    (CL:AND (CL:EQ INITIALVALUEASSIGNMENTS NIL) (CL:EQ REQUIREDASSIGNMENTS NIL)
     (CL:EQ (INITIALIZER CLASS) NULL) (CL:NOT (ACTIVE? CLASS))
...
(CL:DEFUN YIELD-CONSTRUCTOR-DEFINITION (CLASS)
  ...
  (CL:LET* ((REQUIREDPARAMETERS NIL) (ASSIGNMENTS NIL) (SLOT NULL))
   (CL:LET*
    ((SLOTNAME NULL)
     (ITER-000 (%THE-CONS-LIST (CLASS-REQUIRED-SLOT-NAMES CLASS)))
     (COLLECT-000 NULL))
    (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-000 NIL)) DO
     (CL:PROGN (CL:SETQ SLOTNAME (%%VALUE ITER-000))
      (CL:SETQ ITER-000 (%%REST ITER-000)))
     (CL:SETQ ASSIGNMENTS
      (CONS
       (LIST* SYM-DEFCLASS-STELLA-SETF
        (CONS SLOTNAME (CONS SYM-DEFCLASS-STELLA-SELF NIL)) SLOTNAME NIL)
       ASSIGNMENTS))
     ...
     (CONS
      (LIST* SYM-DEFCLASS-STELLA-LET
       ...
       (CONCATENATE (YIELD-CONSTRUCTOR-BODY CLASS (REVERSE ASSIGNMENTS))
        (CONS (LIST* SYM-DEFCLASS-STELLA-RETURN SYM-DEFCLASS-STELLA-SELF NIL)
         NIL)))
      NIL)))))
             ...
             (LIST* SYM-DEFCLASS-STELLA-LET
              ...
              (LIST* SYM-DEFCLASS-STELLA-WHILE
               (LIST* SYM-DEFCLASS-STELLA-NOT
                (LIST* SYM-DEFCLASS-STELLA-EQL? SYM-DEFCLASS-STELLA-SELF
                 SYM-DEFCLASS-STELLA-UNUSED NIL)
                NIL)
               (CONCATENATE (YIELD-TERMINATE-OBJECT-TREES CLASS)
                (CONS
                 (LIST* SYM-DEFCLASS-STELLA-SETQ SYM-DEFCLASS-STELLA-SELF
...
(CL:DEFUN CREATE-CONSTRUCTOR-AND-DESTRUCTOR-UNITS (CLASS)
  (CL:WHEN (CL:EQ *TRANSLATOROUTPUTLANGUAGE* KWD-DEFCLASS-CPP-STANDALONE)
   (CREATE-CPP-CONSTRUCTOR-UNIT CLASS)
   (CL:RETURN-FROM CREATE-CONSTRUCTOR-AND-DESTRUCTOR-UNITS))
  (CL:WHEN
   (CL:NOT
    (CL:OR (%ABSTRACT? CLASS)
     (SUBTYPE-OF? (%CLASS-TYPE CLASS) SGT-DEFCLASS-STELLA-LITERAL)))
   ...
   (CL:LET* ((DESTRUCTOR NULL) (ITER-001 (YIELD-DESTRUCTOR-DEFINITIONS CLASS)))
    (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-001 NIL)) DO
     (CL:PROGN (CL:SETQ DESTRUCTOR (%%VALUE ITER-001))
      (CL:SETQ ITER-001 (%%REST ITER-001)))
...
(CL:DEFUN CLASS-WITH-INITIALIZER? (CLASS)
  (CL:LET* ((FOUND?-000 FALSE))
   (CL:LET* ((SLOT NULL) (ITER-000 (CLASS-SLOTS CLASS)))
    (CL:LOOP WHILE (NEXT? ITER-000) DO (CL:SETQ SLOT (%VALUE ITER-000))
     (CL:WHEN (STORAGE-SLOT? SLOT) (CL:SETQ FOUND?-000 TRUE) (CL:RETURN))))
  ...
  (CL:LET* ((PARENTINITFORMS NIL))
     ...
     (CL:WHEN (CLASS-WITH-INITIALIZER? (%SURROGATE-VALUE SUPER))
      (CL:IF (CL:EQ COLLECT-000 NULL)
       (CL:PROGN
        (CL:SETQ COLLECT-000
         (CONS
          (CONS (YIELD-INITIALIZER-NAME (%SURROGATE-VALUE SUPER))
   ...
   (CL:RETURN-FROM YIELD-INITIALIZER-DEFINITION
    (LIST* SYM-DEFCLASS-STELLA-DEFUN (YIELD-INITIALIZER-NAME CLASS)
     (CONS
      (CONS
       (LIST* SYM-DEFCLASS-STELLA-SELF (YIELD-TYPE-SPEC-TREE (%CLASS-TYPE CLASS))
        NIL)
       NIL)
...
(CL:DEFUN CREATE-CPP-CONSTRUCTOR-UNIT (CLASS)
  (CL:WHEN (CL:NOT (PARAMETERIZED-CLASS? CLASS))
   (CL:LET*
    ((CLASSNAME (YIELD-TYPE-SPEC-TREE (%CLASS-TYPE CLASS)))
    ...
    (HELP-WALK-AUXILIARY-TREE
     (LIST* SYM-DEFCLASS-STELLA-DEFMETHOD CLASSNAME
      (LIST* (CONS (LIST* SYM-DEFCLASS-STELLA-SELF CLASSNAME NIL) NIL)
       KWD-DEFCLASS-PUBLIC? (CL:IF (PUBLIC? CLASS) TRUE-WRAPPER FALSE-WRAPPER)
       (CONCATENATE
...
(CL:DEFVAR *RECYCLING-ENABLED?* FALSE
  ...
  (CL:LET* ((LIST (NEW-RECYCLE-LIST)))
   (CL:LET* ((VALUE-000 NULL))
    (CL:LET* ((LIST NULL) (ITER-000 (%THE-CONS-LIST *ALL-RECYCLE-LISTS*)))
     (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-000 NIL)) DO
      (CL:PROGN (CL:SETQ LIST (%%VALUE ITER-000))
       (CL:SETQ ITER-000 (%%REST ITER-000)))
      (CL:WHEN (CL:EQ (%RECYCLE-LIST-OF LIST) CLASSTYPE) (CL:SETQ VALUE-000 LIST)
       (CL:RETURN))))
    (CL:LET* ((OLDLIST VALUE-000))
     (CL:WHEN (CL:NOT (CL:EQ OLDLIST NULL)) (CLEAR-RECYCLE-LIST OLDLIST)
      (REMOVE *ALL-RECYCLE-LISTS* OLDLIST))
     (PUSH *ALL-RECYCLE-LISTS* LIST) (CL:SETF (%RECYCLE-LIST-OF LIST) CLASSTYPE)
     (CL:SETF (%ITEM-SIZE LIST) ITEMSIZE)
...
(CL:DEFUN PRINT-RECYCLE-LISTS ()
  ...
  (CL:LET* ((LIST NULL) (ITER-000 (%THE-CONS-LIST *ALL-RECYCLE-LISTS*)))
   (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-000 NIL)) DO
    (CL:PROGN (CL:SETQ LIST (%%VALUE ITER-000))
     (CL:SETQ ITER-000 (%%REST ITER-000)))
    (%%PRINT-STREAM (%NATIVE-STREAM STANDARD-OUTPUT) LIST EOL)))
  :VOID)
...
(CL:DEFUN MAINTAIN-RECYCLE-LISTS ()
  ...
  (CL:LET*
   ((TOTALSIZE (TOTAL-RECYCLE-LISTS-SIZE))
    ...
    (LISTSIZE NULL-INTEGER) (CLASSREDEFINITION? FALSE))
   ...
   (CL:LET* ((LIST NULL) (ITER-000 (%THE-CONS-LIST *ALL-RECYCLE-LISTS*)))
    (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-000 NIL)) DO
     ...
     (CL:WHEN
      ...
      (CL:SETQ CLASSREDEFINITION? TRUE) (CLEAR-RECYCLE-LIST LIST)
      (DELETED?-SETTER LIST TRUE))))
   ...
   (CL:WHEN (CL:> TOTALSIZE MAXSIZE)
    ...
    (CL:LOOP WHILE (CL:> TOTALSIZE MAXSIZE) DO
     (CL:LET* ((LIST NULL) (ITER-001 (%THE-CONS-LIST *ALL-RECYCLE-LISTS*)))
      (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-001 NIL)) DO
       (CL:PROGN (CL:SETQ LIST (%%VALUE ITER-001))
        (CL:SETQ ITER-001 (%%REST ITER-001)))
       (CL:TAGBODY (CL:WHEN (CL:<= TOTALSIZE MAXSIZE) (CL:RETURN))
        (CL:SETQ LISTSIZE (CL:* (%ITEM-SIZE LIST) (%CURRENT-LENGTH LIST)))
        (CL:IF (CL:> LISTSIZE 0) (CL:SETQ TOTALSIZE (CL:- TOTALSIZE LISTSIZE))
         (CL:GO :CONTINUE))
        (REDUCE-RECYCLE-LIST-SIZE LIST 0.5d0)
        (CL:SETQ TOTALSIZE
         (CL:+ TOTALSIZE (CL:* (%ITEM-SIZE LIST) (%CURRENT-LENGTH LIST))))
        :CONTINUE))))))
  :VOID)
...
(CL:DEFMETHOD DELETED?-SETTER ((SELF RECYCLE-LIST) VALUE)
  (CL:IF VALUE (CL:SETF (%RECYCLE-LIST-OF SELF) NULL)
   (CL:WHEN (CL:EQ (%RECYCLE-LIST-OF SELF) NULL)
    (CL:SETF (%RECYCLE-LIST-OF SELF) SGT-DEFCLASS-STELLA-UNKNOWN)))
...
(CL:DEFUN RECYCLE-LIST-SIZE (LIST)
  (CL:RETURN-FROM RECYCLE-LIST-SIZE
   (CL:* (%ITEM-SIZE LIST) (%CURRENT-LENGTH LIST))))
  ...
  (CL:LET* ((SIZE 0)) (CL:DECLARE (CL:TYPE CL:FIXNUM SIZE))
   (CL:LET* ((LIST NULL) (ITER-000 (%THE-CONS-LIST *ALL-RECYCLE-LISTS*)))
    (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-000 NIL)) DO
     (CL:PROGN (CL:SETQ LIST (%%VALUE ITER-000))
      (CL:SETQ ITER-000 (%%REST ITER-000)))
     (CL:SETQ SIZE (CL:+ SIZE (CL:* (%ITEM-SIZE LIST) (%CURRENT-LENGTH LIST))))))
...
(CL:DEFUN RECYCLE-LIST-SIZE< (LIST1 LIST2)
  (CL:RETURN-FROM RECYCLE-LIST-SIZE<
   (< (CL:* (%ITEM-SIZE LIST1) (%CURRENT-LENGTH LIST1))
    (CL:* (%ITEM-SIZE LIST2) (%CURRENT-LENGTH LIST2)))))
...
(CL:DEFUN REDUCE-RECYCLE-LIST-SIZE (LIST FRACTION)
  ...
  (CL:LET*
   ((LENGTH (%CURRENT-LENGTH LIST))
    (REDUCEDLENGTH (FLOOR (CL:* LENGTH FRACTION)))
    (ITEMTYPE (%RECYCLE-LIST-OF LIST)) (CURSOR NULL) (TRAILINGCURSOR NULL)
    (UNUSED NULL) (NEXTSLOT NULL))
   (CL:DECLARE (CL:TYPE CL:FIXNUM LENGTH REDUCEDLENGTH))
   (CL:WHEN
    (CL:AND
     (CL:OR (CL:NOT (CL:EQ (%ALL-ITEMS LIST) NULL))
   ...
   (CL:SETQ *RECYCLING-ENABLED?* FALSE)
   (CL:WHEN (CL:NOT (CL:EQ (%ALL-ITEMS LIST) NULL))
    (CL:SETQ CURSOR (%ALL-ITEMS LIST)) (CL:SETQ UNUSED (%UNUSED-ITEMS LIST))
    (CL:SETQ NEXTSLOT
     (LOOKUP-SLOT (%SURROGATE-VALUE ITEMTYPE)
   ...
   (CL:COND
    ...
    ((CL:NOT (CL:EQ (%RECYCLED-ITEMS LIST) NULL))
     (CL:COND
      ((CL:NOT (CL:EQ (%ALL-ITEMS LIST) NULL))
       (CL:SETF (%RECYCLED-ITEMS LIST) NULL))
      (CL:T (CL:SETQ CURSOR (%RECYCLED-ITEMS LIST))
       (CL:SETQ NEXTSLOT (RECYCLE-SLOT (%SURROGATE-VALUE ITEMTYPE)))
       (CL:LET*
   ...
   (CL:SETF (%CURRENT-LENGTH LIST) REDUCEDLENGTH)
   (CL:SETQ *RECYCLING-ENABLED?* TRUE))
  :VOID)
...
(CL:DEFUN SWEEP-TRANSIENTS ()
  (CL:LET* ((RECYCLELIST NULL) (ITER-000 (%THE-CONS-LIST *ALL-RECYCLE-LISTS*)))
   (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-000 NIL)) DO
    (CL:PROGN (CL:SETQ RECYCLELIST (%%VALUE ITER-000))
     (CL:SETQ ITER-000 (%%REST ITER-000)))
    (CL:WHEN
...
(CL:DEFUN MAKE-NON-RECYCLED-LIST ()
  (CL:LET* ((LIST (CL:MAKE-INSTANCE (CL:QUOTE LIST))))
   (CL:SETF (%THE-CONS-LIST LIST) NIL)
...
(CL:DEFVAR *TRANSLATE-WITH-RECYCLE-LIST-DEBUGGING?* FALSE)
   ...
   (CL:RETURN-FROM YIELD-REGISTER-RECYCLED-ITEM-TREES
    (CONS
     (LIST* SYM-DEFCLASS-STELLA-WHEN
      ...
      (LIST* SYM-DEFCLASS-STELLA-REGISTER-RECYCLED-ITEM SYM-DEFCLASS-STELLA-SELF
       NIL)
      NIL)
     NIL))
  ...
  (CL:RETURN-FROM YIELD-HARDWIRED-SLOT-VARIABLE
   (INTERN-DERIVED-SYMBOL (%SLOT-NAME SLOT)
    (CONCATENATE "*HARDWIRED-"
     (CONCATENATE (%SYMBOL-NAME (%SLOT-NAME SLOT))
      (CONCATENATE "-ON-" (CONCATENATE (%SYMBOL-NAME (%SLOT-OWNER SLOT)) "*")))))))
...
(CL:DEFUN YIELD-HARDWIRED-SLOT-READER-BODY (SLOT)
  (CL:LET*
   ((SLOTVARIABLE (YIELD-HARDWIRED-SLOT-VARIABLE SLOT))
    (SLOTTYPEDESC
     (YIELD-TYPE-SPEC-TREE (COMPUTE-RETURN-TYPE-SPEC SLOT (%SLOT-OWNER SLOT)))))
  ...
  (CL:WHEN
   ...
   (CL:SETF (%SLOT-BASE-TYPE METHOD)
    (VALIDATE-TYPE-SPECIFIER
     (DYNAMIC-SLOT-VALUE (%DYNAMIC-SLOTS METHOD)
      SYM-DEFCLASS-STELLA-SLOT-TYPE-SPECIFIER NULL)
     (%SURROGATE-VALUE (%SLOT-OWNER METHOD)) FALSE)))
  :VOID)
      ...
      (CL:RETURN-FROM WRAP-WITH-DEFAULT-VALUE-AND-RETURN-CODE
       (LIST* SYM-DEFCLASS-STELLA-LET
        ...
        (LIST* SYM-DEFCLASS-STELLA-IF
         (LIST* SYM-DEFCLASS-STELLA-NULL? SYM-DEFCLASS-STELLA-ANSWER NIL)
         (LIST* SYM-DEFCLASS-STELLA-RETURN (COPY-CONS-TREE DEFAULTEXPRESSION)
          NIL)
...
(CL:DEFUN YIELD-SLOT-READER-TREE (SLOT CLASS)
  (CL:LET*
   ((PARAMETERS
    ...
    (DEFAULTEXPRESSION
     (CL:IF (HAS-NON-NULL-DEFAULT-VALUE? SLOT) (SYSTEM-DEFAULT-VALUE SLOT) NULL))
     ...
     (CL:SETQ READCODE
      (LIST* SYM-DEFCLASS-STELLA-PROGN
       (LIST* SYM-DEFCLASS-STELLA-ERROR (WRAP-STRING "Slot '")
        (WRAP-STRING (%SYMBOL-NAME (%SLOT-NAME SLOT)))
        (LIST* (WRAP-STRING "' does not exist on ") SYM-DEFCLASS-STELLA-SELF
         NIL))
       (LIST* SYM-DEFCLASS-STELLA-RETURN SYM-DEFCLASS-STELLA-NULL NIL) NIL)))
    ((ACTIVE? SLOT)
     (CL:SETQ READCODE (YIELD-ACTIVE-SLOT-READER-BODY SLOT DEFAULTEXPRESSION)))
    ((%SLOT-HARDWIRED? SLOT)
     (CL:MULTIPLE-VALUE-SETQ (READCODE AUXILIARYCODE)
      (YIELD-HARDWIRED-SLOT-READER-BODY SLOT))
     (CL:WHEN (CL:EQ (%CLASS-TYPE CLASS) (%SLOT-OWNER SLOT))
   ...
   (CL:RETURN-FROM YIELD-SLOT-READER-TREE
    (LIST* SYM-DEFCLASS-STELLA-DEFMETHOD
     (CONS (%SLOT-NAME SLOT) (CONS TYPETREE NIL)) PARAMETERS
...
(CL:DEFUN YIELD-SLOT-WRITER-TREE (SLOT CLASS)
  (CL:LET*
   ...
   (CL:RETURN-FROM YIELD-SLOT-WRITER-TREE
    (LIST* SYM-DEFCLASS-STELLA-DEFMETHOD
     (CONS (YIELD-SETTER-METHOD-NAME (%SLOT-NAME SLOT))
      (CONS (COPY-CONS-TREE TYPETREE) NIL))
     PARAMETERS
     (LIST* KWD-DEFCLASS-AUXILIARY? SYM-DEFCLASS-STELLA-TRUE
      (CONCATENATE
       (CL:IF SLOTVISIBLE? NIL
        (CONS (LIST* SYM-DEFCLASS-STELLA-IGNORE SYM-DEFCLASS-STELLA-VALUE NIL)
         NIL))
       (CONS WRITECODE NIL)))))))
  ...
  (CL:RETURN-FROM GENERICALLY-ACCESSIBLE-TYPE?
   (CL:OR (SUBTYPE-OF? TYPE SGT-DEFCLASS-STELLA-OBJECT)
    (CL:AND (SUBTYPE-OF? TYPE SGT-DEFCLASS-STELLA-LITERAL)
     (CL:NOT
      (CL:EQ (LOOKUP-LITERAL-TYPE-INFO TYPE KWD-DEFCLASS-WRAP-FUNCTION) NULL))))))
...
(CL:DEFUN GENERIC-SLOT-READER? (SLOT)
  (CL:LET* ((TYPE (CANONICAL-TYPE (TYPE SLOT))))
   (CL:RETURN-FROM GENERIC-SLOT-READER?
    (CL:AND (CL:NOT (%ABSTRACT? SLOT))
     (SUBTYPE-OF? (%SLOT-OWNER SLOT) SGT-DEFCLASS-STELLA-OBJECT)
     (CL:NOT (CL:EQ (%SURROGATE-VALUE TYPE) NULL))
...
(CL:DEFUN GENERIC-SLOT-WRITER? (SLOT)
  (CL:RETURN-FROM GENERIC-SLOT-WRITER?
   (CL:AND (CL:NOT (%SLOT-HARDWIRED? SLOT)) (GENERIC-SLOT-READER? SLOT))))

;;; (DEFUN (SLOT-ACCESS-METHOD? BOOLEAN) ...)

(CL:DEFUN SLOT-ACCESS-METHOD? (SLOT)
  (CL:RETURN-FROM SLOT-ACCESS-METHOD?
   (CL:OR (CL:NOT (CL:EQ (READER SLOT) NULL)) (SYSTEM-DEFINED-SLOT-READER? SLOT)
    (CL:NOT (CL:EQ (WRITER SLOT) NULL)) (SYSTEM-DEFINED-SLOT-WRITER? SLOT))))
...
(CL:DEFUN YIELD-GENERIC-SLOT-ACCESSOR-NAME (CLASS)
  (CL:RETURN-FROM YIELD-GENERIC-SLOT-ACCESSOR-NAME
   (INTERN-DERIVED-SYMBOL (%CLASS-TYPE CLASS)
    (CONCATENATE "ACCESS-"
     (CONCATENATE (%SYMBOL-NAME (%CLASS-TYPE CLASS)) "-SLOT-VALUE")))))
...
(CL:DEFUN YIELD-GENERIC-SLOT-ACCESSOR-DEFINITION (CLASS)
  (CL:LET* ((CLAUSES NIL) (ACCESSTREE NIL) (VALUETREE NULL) (SLOTTYPE NULL))
   (CL:WHEN
    (CL:NOT (SUBCLASS-OF? CLASS (%SURROGATE-VALUE SGT-DEFCLASS-STELLA-OBJECT)))
       ...
       (CL:WHEN (CL:NOT (%SLOT-HARDWIRED? SLOT))
        ...
        (CL:WHEN
         (CL:AND (SUBTYPE-OF? SLOTTYPE SGT-DEFCLASS-STELLA-LITERAL)
          (CL:NOT
           (CL:EQ (LOOKUP-LITERAL-TYPE-INFO SLOTTYPE KWD-DEFCLASS-WRAP-FUNCTION)
            NULL)))
         (CL:SETQ VALUETREE
        ...
        (CL:SETQ ACCESSTREE
         (LIST* SYM-DEFCLASS-STELLA-IF SYM-DEFCLASS-STELLA-SETVALUE?
          (LIST* SYM-DEFCLASS-STELLA-SETF
           (CONS (%SLOT-NAME SLOT) (CONS SYM-DEFCLASS-STELLA-SELF NIL)) VALUETREE
           NIL)
          ACCESSTREE NIL)))
       (CL:SETQ CLAUSES
        (CONS (CONS (%SLOT-NAME SLOT) (CONS ACCESSTREE NIL)) CLAUSES)))
      :CONTINUE)))
   (CL:WHEN
    (SUBCLASS-OF? CLASS
     (%SURROGATE-VALUE SGT-DEFCLASS-STELLA-DYNAMIC-SLOTS-MIXIN))
     ...
     (CL:LET*
      ...
      (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-001 NIL)) DO
       (CL:PROGN (CL:SETQ SLOT (%%VALUE ITER-001))
        (CL:SETQ ITER-001 (%%REST ITER-001)))
       (CL:WHEN
        (CL:AND (STORAGE-SLOT? SLOT) (CL:NOT (%SLOT-EXTERNAL? SLOT))
         (SPACE-SAVER-SLOT-ALLOCATION? SLOT) (CL:NOT (SLOT-ACCESS-METHOD? SLOT))
             ...
             (CONS
              (LIST* SYM-DEFCLASS-STELLA-SETQ SYM-DEFCLASS-STELLA-SLOTNAME
               (LIST* SYM-DEFCLASS-STELLA-QUOTE
                (%SLOT-NAME (CANONICAL-SLOT SLOT)) NIL)
               NIL)
              NIL))
            NIL))
       ...
       (CONS
        (LIST* SYM-DEFCLASS-STELLA-CASE SYM-DEFCLASS-STELLA-SLOTNAME
         (CONCATENATE RENAMECLAUSES
          (CONS
           (LIST* SYM-DEFCLASS-STELLA-OTHERWISE SYM-DEFCLASS-STELLA-NULL NIL)
           NIL)))
        NIL)))
     (CL:SETQ CLAUSES
      (CONS
         ...
         (CONS
          (LIST* SYM-DEFCLASS-STELLA-IF SYM-DEFCLASS-STELLA-SETVALUE?
           (LIST* SYM-DEFCLASS-STELLA-SET-DYNAMIC-SLOT-VALUE
            (LIST* SYM-DEFCLASS-STELLA-DYNAMIC-SLOTS SYM-DEFCLASS-STELLA-SELF
             NIL)
  ...
  (CL:LET* ((FOUND?-000 FALSE))
   ...
   (CL:IF FOUND?-000
    (CL:RETURN-FROM YIELD-GENERIC-SLOT-ACCESSOR-ATTACHMENT
     (CONS
      (LIST* SYM-DEFCLASS-STELLA-SETF
       (LIST* SYM-DEFCLASS-STELLA-CLASS-SLOT-ACCESSOR-CODE CLASSREF NIL)
...
(CL:DEFUN YIELD-MIXIN-CLASS-USERS-TREE (CLASS)
  (CL:LET* ((RESULT NIL))
   (CL:LET*
    ((SUB NULL) (ITER-000 (%THE-CONS-LIST (%CLASS-DIRECT-SUBS CLASS)))
     (COLLECT-000 NULL))
    (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-000 NIL)) DO
     ...
     (CL:WHEN (CL:NOT (%MIXIN? (TYPE-TO-CLASS SUB)))
      (CL:IF (CL:EQ COLLECT-000 NULL)
       (CL:PROGN
        (CL:SETQ COLLECT-000
         (CONS
          (INTERN-SYMBOL-IN-MODULE (%SYMBOL-NAME SUB) (%HOME-CONTEXT SUB) TRUE)
          NIL))
...
(CL:DEFUN YIELD-MIXIN-SLOT-READER-NAME (SLOT)
  (CL:RETURN-FROM YIELD-MIXIN-SLOT-READER-NAME
   (INTERN-DERIVED-SYMBOL (%SLOT-NAME SLOT)
    (CONCATENATE (%SYMBOL-NAME (%SLOT-NAME SLOT))
     (CONCATENATE "-ON-" (%SYMBOL-NAME (%SLOT-OWNER SLOT)))))))
  ...
  (CL:LET*
   ...
   (CL:RETURN-FROM YIELD-MIXIN-SLOT-READER-TREE
    (LIST* SYM-DEFCLASS-STELLA-DEFUN (CONS READERNAME (CONS TYPETREE NIL))
     (CONS (LIST* SYM-DEFCLASS-STELLA-SELF SYM-DEFCLASS-STELLA-OBJECT NIL) NIL)
     ...
     (LIST* SYM-DEFCLASS-STELLA-TYPECASE SYM-DEFCLASS-STELLA-SELF
      (CONS (YIELD-MIXIN-CLASS-USERS-TREE (%SURROGATE-VALUE (%SLOT-OWNER SLOT)))
       (CONS
        (LIST* SYM-DEFCLASS-STELLA-RETURN
         (LIST* SYM-DEFCLASS-STELLA-SETF
          (CONS (%SLOT-NAME SLOT) (CONS SYM-DEFCLASS-STELLA-SELF NIL))
          SYM-DEFCLASS-STELLA-VALUE NIL)
         NIL)
        NIL))
      (LIST* SYM-DEFCLASS-STELLA-OTHERWISE
...
(CL:DEFUN YIELD-NATIVE-SLOT-READER-NAME (SLOT)
  (CL:RETURN-FROM YIELD-NATIVE-SLOT-READER-NAME
   (INTERN-DERIVED-SYMBOL (%SLOT-NAME SLOT)
    (CONCATENATE (%SYMBOL-NAME (%SLOT-NAME SLOT)) "-NATIVE-VALUE"))))
  ...
  (CL:LET*
   ...
   (CL:RETURN-FROM YIELD-NATIVE-SLOT-READER-TREE
    (LIST* SYM-DEFCLASS-STELLA-DEFMETHOD (CONS READERNAME (CONS TYPETREE NIL))
     (CONS (LIST* SYM-DEFCLASS-STELLA-SELF (CLASS-SYMBOL CLASS) NIL) NIL)
     KWD-DEFCLASS-AUXILIARY? SYM-DEFCLASS-STELLA-TRUE
     (CONCATENATE
      (CL:IF SLOTVISIBLE?
       (CONS
...
(CL:DEFUN CREATE-KEYED-EQUALITY-METHOD-UNIT (CLASS)
  (CL:LET* ((TESTTREES NIL))
   (CL:LET*
    ((SLOTNAME NULL) (ITER-000 (%THE-CONS-LIST (CLASS-KEY CLASS)))
     (COLLECT-000 NULL))
    (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-000 NIL)) DO
     (CL:PROGN (CL:SETQ SLOTNAME (%%VALUE ITER-000))
      (CL:SETQ ITER-000 (%%REST ITER-000)))
...
(CL:DEFUN HELP-STARTUP-DEFCLASS1 ()
  (CL:PROGN
   ...
   (CL:SETQ SYM-DEFCLASS-STELLA-DEFINE-CLASS-FROM-STRINGIFIED-SOURCE
    (INTERN-RIGID-SYMBOL-WRT-MODULE "DEFINE-CLASS-FROM-STRINGIFIED-SOURCE" NULL
     0))
...
(CL:DEFUN HELP-STARTUP-DEFCLASS3 ()
  (CL:PROGN
   ...
   (DEFINE-FUNCTION-OBJECT "TYPE-TO-WALKED-NULL-VALUE-TREE"
    "(DEFUN (TYPE-TO-WALKED-NULL-VALUE-TREE OBJECT) ((TYPE TYPE)))"
...
a Stella class object.\")" (CL:FUNCTION YIELD-DEFINE-STELLA-CLASS) NULL)
   ...
   (DEFINE-FUNCTION-OBJECT "MIXIN-SLOT?"
    "(DEFUN (MIXIN-SLOT? BOOLEAN) ((SELF SLOT)))" (CL:FUNCTION MIXIN-SLOT?) NULL)
   (DEFINE-FUNCTION-OBJECT "MIXIN-METHOD?"
    "(DEFUN (MIXIN-METHOD? BOOLEAN) ((SELF SLOT)))" (CL:FUNCTION MIXIN-METHOD?)
    NULL)
   ...
   (DEFINE-FUNCTION-OBJECT "UNKNOWN-TYPE?"
    "(DEFUN (UNKNOWN-TYPE? BOOLEAN) ((TYPE TYPE)))" (CL:FUNCTION UNKNOWN-TYPE?)
    NULL)
...
(CL:DEFUN HELP-STARTUP-DEFCLASS4 ()
  (CL:PROGN
   ...
   (DEFINE-METHOD-OBJECT "(DEFMETHOD (DELETED? BOOLEAN) ((SELF RECYCLE-LIST)))"
   ...
   (DEFINE-FUNCTION-OBJECT "SWEEP-TRANSIENTS"
    "(DEFUN SWEEP-TRANSIENTS () :PUBLIC? TRUE)" (CL:FUNCTION SWEEP-TRANSIENTS)
    NULL)
   ...
   (DEFINE-FUNCTION-OBJECT "STARTUP-DEFCLASS"
    "(DEFUN STARTUP-DEFCLASS () :PUBLIC? TRUE)" (CL:FUNCTION STARTUP-DEFCLASS)
    NULL)
   (CL:LET* ((FUNCTION (LOOKUP-FUNCTION SYM-DEFCLASS-STELLA-STARTUP-DEFCLASS)))
    (SET-DYNAMIC-SLOT-VALUE (%DYNAMIC-SLOTS FUNCTION)
     ...
     (WRAP-STRING "_Startup-Defclass") NULL-STRING-WRAPPER)))
  :VOID)
...
(CL:DEFUN STARTUP-DEFCLASS ()
  ...
  (CL:LET* ((*MODULE* *STELLA-MODULE*) (*CONTEXT* *MODULE*))
   ...
   (CL:WHEN (CURRENT-STARTUP-TIME-PHASE? 4) (CL:SETQ *RECYCLING-ENABLED?* TRUE)
    (CL:SETQ *RECYCLE-LISTS-MAINTENANCE-TIMER*
     *RECYCLE-LISTS-MAINTENANCE-INTERVAL*)
    (CL:SETQ *TRANSLATE-WITH-RECYCLE-LIST-DEBUGGING?* FALSE))
