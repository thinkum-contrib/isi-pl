...
(CL:DECLAIM
  ...
  *TRANSLATE-WITH-RECYCLE-LIST-DEBUGGING?* *CURRENTLY-RECYCLED-ITEMS*
  STANDARD-ERROR EOL NULL-STRING-WRAPPER *TRANSLATOROUTPUTLANGUAGE* NIL))
...
(CL:DEFUN TYPE-TO-WALKED-NULL-VALUE-TREE (TYPESPEC TYPE)
  (CL:LET* ((NULLVALUE (TYPE-TO-NULL-VALUE-TREE TYPE)))
   (CL:WHEN (CL:NOT (CL:EQ NULLVALUE SYM-DEFCLASS-STELLA-NULL))
    (CL:SETQ NULLVALUE
     (WALK-EXPRESSION-TREE NULLVALUE TYPE SYM-DEFCLASS-STELLA-NULL CL:NIL)))
   (CL:IF
        ...
        (CL:LET* ((*PRINTREADABLY?* CL:T))
         ...
         (CL:WHEN (CL:NOT (SUPPRESS-WARNINGS?))
          ...
          (%%PRINT-STREAM (%NATIVE-STREAM STANDARD-ERROR) EOL
           " Bad list of supers defined for class `" (CLASS-NAME CLASS) "'."
           EOL " The class `" (%SYMBOL-NAME SUPER)
...
(CL:DEFUN PARAMETER-SLOT? (SLOT)
  (CL:LET* ((OWNER (%SLOT-OWNER SLOT)))
   (CL:RETURN-FROM PARAMETER-SLOT?
    (CL:AND (%ABSTRACT? SLOT) (CL:NOT (CL:EQ OWNER NULL))
  ...
  (CL:LET* ((NAME (%SLOT-NAME SLOT)) (NAME-STRING (%SYMBOL-NAME NAME)))
   ...
   (CL:LET* ((SUPERCLASS NULL) (ITER-001 (%CLASS-ALL-SUPER-CLASSES CLASS)))
    (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-001 NIL)) DO
     ...
     (CL:LET*
      ((SUPERSLOT NULL)
       (ITER-002 (%THE-CONS-LIST (%CLASS-LOCAL-SLOTS SUPERCLASS))))
...
(CL:DEFUN YIELD-TERMINATE-OBJECT-TREES (CLASS)
  (CL:LET* ((TREES NIL) (TERMINATOR (TERMINATOR CLASS)))
   ...
   (CL:WHEN
    (CL:NOT
     (CL:EQ (LOOKUP-SLOT CLASS SYM-DEFCLASS-STELLA-DYNAMIC-SLOTS) NULL))
    (CL:SETQ TREES
     (CONS
...
(CL:DEFUN MARK-DIRECT-EQUIVALENT-SLOT (SLOT)
  (CL:LET* ((DIRECTEQUIVALENT (%SLOT-DIRECT-EQUIVALENT SLOT)))
   (CL:WHEN (CL:NOT (CL:EQ DIRECTEQUIVALENT NULL))
    (CL:IF (%SLOT-MARKED? DIRECTEQUIVALENT)
     (CL:SETF (%SLOT-MARKED? SLOT) CL:T)
       ...
       (LIST* SYM-DEFCLASS-STELLA-SLOT-VALUE SYM-DEFCLASS-STELLA-SELF
        ...
        (CONCATENATE
         (CL:IF (IS-CONTEXT-SENSITIVE-SLOT? SLOT)
          (LIST* KWD-DEFCLASS-CONTEXT-SENSITIVE? SYM-DEFCLASS-STELLA-FALSE
           NIL)
          NIL)
         NIL))
...
(CL:DEFUN YIELD-LOCAL-INITIAL-VALUE-ASSIGNMENTS (CLASS)
  (CL:LET* ((ASSIGNMENTS NIL) (INITIALVALUEASSIGNMENT NULL))
   (CL:LET*
    ...
    (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-000 NIL)) DO
     (CL:SETQ SLOT (%%VALUE ITER-000)) (CL:SETF (%SLOT-MARKED? SLOT) CL:NIL)
     (CL:SETQ ITER-000 (%%REST ITER-000))))
   (CL:LET*
    ((SLOT NULL) (ITER-001 (%THE-CONS-LIST (%CLASS-LOCAL-SLOTS CLASS))))
    (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-001 NIL)) DO
     (CL:SETQ SLOT (%%VALUE ITER-001)) (MARK-DIRECT-EQUIVALENT-SLOT SLOT)
     (CL:SETQ ITER-001 (%%REST ITER-001))))
   (CL:LET*
               ...
               (LIST*
                (LIST* SYM-DEFCLASS-STELLA-SETF
                 (LIST* SYM-DEFCLASS-STELLA-SLOT-VALUE
                  SYM-DEFCLASS-STELLA-SELF (%SLOT-NAME RECYCLESLOT) NIL)
                 (LIST* SYM-DEFCLASS-STELLA-RECYCLED-ITEMS RECYCLELIST NIL)
                 NIL)
                (LIST* SYM-DEFCLASS-STELLA-SETF
                 (LIST* SYM-DEFCLASS-STELLA-RECYCLED-ITEMS RECYCLELIST NIL)
...
(CL:DEFUN CREATE-CONSTRUCTOR-AND-DESTRUCTOR-UNITS (CLASS)
  ...
  (CL:WHEN
   ...
   (CL:LET*
    ((DEFINITION NULL) (ITER-000 (YIELD-RECYCLE-LIST-DEFINITIONS CLASS)))
    (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-000 NIL)) DO
     (CL:SETQ DEFINITION (%%VALUE ITER-000)) (WALK-AUXILIARY-TREE DEFINITION)
     (CL:SETQ ITER-000 (%%REST ITER-000))))
   (WALK-AUXILIARY-TREE (YIELD-CONSTRUCTOR-DEFINITION CLASS))
   (CL:LET*
    ((DESTRUCTOR NULL) (ITER-001 (YIELD-DESTRUCTOR-DEFINITIONS CLASS)))
    (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-001 NIL)) DO
     (CL:SETQ DESTRUCTOR (%%VALUE ITER-001)) (WALK-AUXILIARY-TREE DESTRUCTOR)
     (CL:SETQ ITER-001 (%%REST ITER-001)))))
  :VOID)
...
(CL:DEFUN YIELD-INITIALIZER-NAME (CLASS)
  (CL:LET*
   ((BASE-NAME (CLASS-NAME CLASS))
    (PREFIX
     (CL:IF (ALL-UPPER-CASE-STRING? BASE-NAME) "INITIALIZE-" "initialize-")))
   (CL:DECLARE (CL:TYPE CL:SIMPLE-STRING BASE-NAME PREFIX))
     ...
     (CONS
      (CONS
       (LIST* SYM-DEFCLASS-STELLA-SELF
        (YIELD-TYPE-SPEC-TREE (%CLASS-TYPE CLASS)) NIL)
       NIL)
   ...
   (CL:LET* ((VALUE-000 NULL))
    (CL:LET* ((LIST NULL) (ITER-000 (%THE-CONS-LIST *ALL-RECYCLE-LISTS*)))
     (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-000 NIL)) DO
      ...
      (CL:WHEN (CL:EQ (%RECYCLE-LIST-OF LIST) CLASSTYPE)
    ...
    (CL:LET* ((OLDLIST VALUE-000))
     ...
     (CL:SETF (%RECYCLE-LIST-OF LIST) CLASSTYPE)
    ...
    (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-000 NIL)) DO
     ...
     (CL:WHEN
      (CL:AND (CL:NOT (CL:EQ (%SURROGATE-VALUE (%RECYCLE-LIST-OF LIST)) NULL))
       (CL:NOT
        (DECIDED-TO-RECYCLE? (%SURROGATE-VALUE (%RECYCLE-LIST-OF LIST)))))
  ...
  (CL:LET* ((SIZE 0)) (CL:DECLARE (CL:TYPE CL:FIXNUM SIZE))
   (CL:LET* ((LIST NULL) (ITER-000 (%THE-CONS-LIST *ALL-RECYCLE-LISTS*)))
    (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-000 NIL)) DO
     (CL:SETQ LIST (%%VALUE ITER-000))
     (CL:SETQ SIZE
      (CL:+ SIZE (CL:* (%ITEM-SIZE LIST) (%CURRENT-LENGTH LIST))))
     (CL:SETQ ITER-000 (%%REST ITER-000))))
  ...
  (CL:LET*
   ...
   (CL:COND
    ((NON-EMPTY? (%LIST-OF-RECYCLED-ITEMS LIST))
     (CL:SETQ CURSOR
      (NTH-REST (%THE-CONS-LIST (%LIST-OF-RECYCLED-ITEMS LIST))
       REDUCEDLENGTH))
     ...
     (CL:COND
      ...
      (CL:T (CL:SETQ CURSOR (%RECYCLED-ITEMS LIST))
       ...
       (CL:LET*
        ...
        (CL:LOOP WHILE (CL:OR UNBOUNDED?-000 (CL:<= ITER-001 UPPER-BOUND-001))
...
(CL:DEFUN SWEEP-TRANSIENTS ()
  (CL:LET*
   ((RECYCLELIST NULL) (ITER-000 (%THE-CONS-LIST *ALL-RECYCLE-LISTS*)))
   (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-000 NIL)) DO
       ...
       (LIST* SYM-DEFCLASS-STELLA-LET
        ...
        (LIST* SYM-DEFCLASS-STELLA-IF
         ...
         (LIST* SYM-DEFCLASS-STELLA-RETURN (COPY-CONS-TREE DEFAULTEXPRESSION)
          NIL)
         (LIST* SYM-DEFCLASS-STELLA-RETURN SYM-DEFCLASS-STELLA-ANSWER NIL)
         NIL)
        NIL))))
    (CL:RETURN-FROM WRAP-WITH-DEFAULT-VALUE-AND-RETURN-CODE
     (LIST* SYM-DEFCLASS-STELLA-RETURN READCODE NIL)))))
...
(CL:DEFUN YIELD-SLOT-READER-TREE (SLOT CLASS)
  (CL:LET*
   ((PARAMETERS
    ...
    (DEFAULTEXPRESSION
     (CL:IF (HAS-NON-NULL-DEFAULT-VALUE? SLOT) (SYSTEM-DEFAULT-VALUE SLOT)
      NULL))
...
(CL:DEFUN SLOT-ACCESS-METHOD? (SLOT)
  (CL:RETURN-FROM SLOT-ACCESS-METHOD?
   (CL:OR (CL:NOT (CL:EQ (READER SLOT) NULL))
    (SYSTEM-DEFINED-SLOT-READER? SLOT) (CL:NOT (CL:EQ (WRITER SLOT) NULL))
...
(CL:DEFUN YIELD-GENERIC-SLOT-ACCESSOR-NAME (CLASS)
  (CL:LET*
   ((BASE-NAME (%SYMBOL-NAME (%CLASS-TYPE CLASS)))
    ...
    (SUFFIX
     (CL:IF (ALL-UPPER-CASE-STRING? BASE-NAME) "-SLOT-VALUE" "-Slot-Value")))
...
(CL:DEFUN YIELD-GENERIC-SLOT-ACCESSOR-DEFINITION (CLASS)
  (CL:LET* ((CLAUSES NIL) (ACCESSTREE NIL) (VALUETREE NULL) (SLOTTYPE NULL))
   (CL:WHEN
    (CL:NOT
     (SUBCLASS-OF? CLASS (%SURROGATE-VALUE SGT-DEFCLASS-STELLA-OBJECT)))
    ...
    (CL:RETURN-FROM YIELD-GENERIC-SLOT-ACCESSOR-DEFINITION
     (LIST* SYM-DEFCLASS-STELLA-DEFUN
      ...
      (LIST* (LIST* SYM-DEFCLASS-STELLA-SELF (%CLASS-TYPE CLASS) NIL)
       ...
       (LIST* SYM-DEFCLASS-STELLA-SETVALUE? SYM-DEFCLASS-STELLA-BOOLEAN NIL)
       NIL)
      (LIST* SYM-DEFCLASS-STELLA-CASE SYM-DEFCLASS-STELLA-SLOTNAME
     ...
     (CL:WHEN (CL:NOT (%MIXIN? (TYPE-TO-CLASS SUB)))
      (CL:IF (CL:EQ COLLECT-000 NULL)
       (CL:PROGN
        (CL:SETQ COLLECT-000
         (CONS
          (INTERN-SYMBOL-IN-MODULE (%SYMBOL-NAME SUB) (%HOME-CONTEXT SUB)
           CL:T)
          NIL))
...
(CL:DEFUN YIELD-MIXIN-SLOT-READER-NAME (SLOT)
  (CL:LET*
   ((PRE-NAME (%SYMBOL-NAME (%SLOT-NAME SLOT)))
  ...
  (CL:LET*
   ...
   (CL:RETURN-FROM YIELD-MIXIN-SLOT-READER-TREE
    (LIST* SYM-DEFCLASS-STELLA-DEFUN (CONS READERNAME (CONS TYPETREE NIL))
     (CONS (LIST* SYM-DEFCLASS-STELLA-SELF SYM-DEFCLASS-STELLA-OBJECT NIL)
      NIL)
     KWD-DEFCLASS-AUXILIARY? SYM-DEFCLASS-STELLA-TRUE
     (LIST* SYM-DEFCLASS-STELLA-TYPECASE SYM-DEFCLASS-STELLA-SELF
      (CONS
       (YIELD-MIXIN-CLASS-USERS-TREE (%SURROGATE-VALUE (%SLOT-OWNER SLOT)))
       (CONS
        (LIST* SYM-DEFCLASS-STELLA-RETURN
         (CONS (%SLOT-NAME SLOT) (CONS SYM-DEFCLASS-STELLA-SELF NIL)) NIL)
        NIL))
...
(CL:DEFUN HELP-STARTUP-DEFCLASS1 ()
  (CL:PROGN
   ...
   (CL:SETQ SYM-DEFCLASS-STELLA-DEFINE-CLASS-FROM-STRINGIFIED-SOURCE
    (INTERN-RIGID-SYMBOL-WRT-MODULE "DEFINE-CLASS-FROM-STRINGIFIED-SOURCE"
     NULL 0))
...
(CL:DEFUN HELP-STARTUP-DEFCLASS2 ()
  (CL:PROGN
   ...
   (CL:SETQ SYM-DEFCLASS-STELLA-*RECYCLE-LISTS-MAINTENANCE-TIMER*
    (INTERN-RIGID-SYMBOL-WRT-MODULE "*RECYCLE-LISTS-MAINTENANCE-TIMER*" NULL
     0))
...
a Stella class object.\")" (CL:FUNCTION YIELD-DEFINE-STELLA-CLASS) NULL)
   ...
   (DEFINE-FUNCTION-OBJECT "MIXIN-SLOT?"
    "(DEFUN (MIXIN-SLOT? BOOLEAN) ((SELF SLOT)))" (CL:FUNCTION MIXIN-SLOT?)
    NULL)
