          ...
          (CL:LET* ((TEST-VALUE-001 CL:NIL))
           (CL:LET* ((FOUND?-000 CL:NIL))
            (CL:LET* ((ELTY NULL) (ITER-001 (ALLOCATE-ITERATOR Y)))
             (CL:LOOP WHILE (NEXT? ITER-001) DO (CL:SETQ ELTY (%VALUE ITER-001))
              (CL:WHEN (EQUAL? ELTX ELTY) (CL:SETQ FOUND?-000 CL:T) (CL:RETURN))))
...
is O(N) in the number of elements of `self'."
  (CL:LET* ((CURSOR (%THE-CONS-LIST SELF)) (CODE 95880665)) (CL:DECLARE (CL:TYPE CL:FIXNUM CODE))
   (CL:LOOP (CL:WHEN (CL:EQ CURSOR NIL) (CL:RETURN))
    (CL:SETQ CODE (CL:THE CL:FIXNUM (CL:LOGXOR CODE (CL:THE CL:FIXNUM (SAFE-EQUAL-HASH-CODE (%%VALUE CURSOR))))))
     ...
     (CL:WHEN (CL:NOT (MEMBER? SET V))
      (CL:IF (CL:EQ COLLECT-000 NULL)
       (CL:PROGN (CL:SETQ COLLECT-000 (CONS V NIL))
        (CL:IF (CL:EQ (%THE-CONS-LIST SET) NIL) (CL:SETF (%THE-CONS-LIST SET) COLLECT-000)
...
(CL:DEFMETHOD PRINT-VECTOR ((SELF VECTOR) STREAM)
  (CL:IF (CL:= (LENGTH SELF) 0) (%%PRINT-STREAM STREAM "|i|[]")
   (CL:LET* ((I 0) (LIMIT 9)) (CL:DECLARE (CL:TYPE CL:FIXNUM I LIMIT)) (%%PRINT-STREAM STREAM "|i|[")
    (CL:LET* ((ELEMENT NULL) (VECTOR-000 SELF) (INDEX-000 0) (LENGTH-000 (LENGTH VECTOR-000)))
     (CL:DECLARE (CL:TYPE CL:FIXNUM INDEX-000 LENGTH-000))
     (CL:LOOP WHILE (CL:< INDEX-000 LENGTH-000) DO
      (CL:SETQ ELEMENT (CL:AREF (CL:THE CL:SIMPLE-VECTOR (%THE-ARRAY VECTOR-000)) INDEX-000))
      (%%PRINT-STREAM STREAM ELEMENT) (CL:SETQ I (CL:1+ I)) (CL:WHEN (CL:> I LIMIT) (CL:RETURN))
      (CL:WHEN (CL:< I (LENGTH SELF)) (%%PRINT-STREAM STREAM " ")) (CL:SETQ INDEX-000 (CL:1+ INDEX-000))))
...
(CL:DEFMETHOD LAST ((SELF VECTOR))
  ...
  (CL:RETURN-FROM LAST
   (CL:AREF (CL:THE CL:SIMPLE-VECTOR (%THE-ARRAY SELF)) (CL:THE CL:FIXNUM (CL:1- (%ARRAY-SIZE SELF))))))
...
(CL:DEFMETHOD LAST-SETTER ((SELF VECTOR) VALUE)
  (CL:RETURN-FROM LAST-SETTER
   (CL:LET ((SELF (%THE-ARRAY SELF)) (VALUE VALUE) (POSITION (CL:1- (%ARRAY-SIZE SELF))))
    (CL:DECLARE (CL:TYPE CL:SIMPLE-VECTOR SELF) (CL:TYPE CL:FIXNUM POSITION)) (CL:SETF (CL:AREF SELF POSITION) VALUE))))
...
(CL:DEFMETHOD MEMBER? ((SELF VECTOR) OBJECT)
  (CL:LET* ((ARRAY (%THE-ARRAY SELF))) (CL:DECLARE (CL:TYPE CL:SIMPLE-VECTOR ARRAY))
   (CL:LET* ((I NULL-INTEGER) (ITER-000 0) (UPPER-BOUND-000 (CL:1- (LENGTH SELF))))
    (CL:DECLARE (CL:TYPE CL:FIXNUM I ITER-000 UPPER-BOUND-000))
    (CL:LOOP WHILE (CL:<= ITER-000 UPPER-BOUND-000) DO (CL:SETQ I ITER-000)
     (CL:WHEN (EQL? (CL:AREF ARRAY I) OBJECT) (CL:RETURN-FROM MEMBER? CL:T)) (CL:SETQ ITER-000 (CL:1+ ITER-000))))
   (CL:RETURN-FROM MEMBER? CL:NIL)))
...
will always be relative to the entire vector."
  ...
  (CL:LET* ((I NULL-INTEGER) (ITER-000 START) (UPPER-BOUND-000 (CL:1- (LENGTH SELF))))
   (CL:DECLARE (CL:TYPE CL:FIXNUM I ITER-000 UPPER-BOUND-000))
   (CL:LOOP WHILE (CL:<= ITER-000 UPPER-BOUND-000) DO (CL:SETQ I ITER-000)
    (CL:WHEN (EQL? (CL:AREF (CL:THE CL:SIMPLE-VECTOR (%THE-ARRAY SELF)) I) OBJECT) (CL:RETURN-FROM POSITION I))
...
(CL:DEFMETHOD COPY ((SELF VECTOR))
  ...
  (CL:LET*
   ((SIZE (%ARRAY-SIZE SELF)) (SOURCEARRAY (%THE-ARRAY SELF)) (COPY (NEW-VECTOR SIZE)) (COPYARRAY (%THE-ARRAY COPY)))
   ...
   ((SUBTYPE-OF? (SAFE-PRIMARY-TYPE Y) SGT-COLLECTIONS-STELLA-VECTOR)
    (CL:PROGN
     (CL:WHEN (CL:= (%ARRAY-SIZE X) (%ARRAY-SIZE Y))
      (CL:LET*
       ((ELTX NULL) (VECTOR-000 X) (INDEX-000 0) (LENGTH-000 (LENGTH VECTOR-000)) (ELTY NULL) (VECTOR-001 Y)
       ...
       (CL:LOOP WHILE (CL:AND (CL:< INDEX-000 LENGTH-000) (CL:< INDEX-001 LENGTH-001)) DO
        ...
        (CL:SETQ ELTY (CL:AREF (CL:THE CL:SIMPLE-VECTOR (%THE-ARRAY VECTOR-001)) INDEX-001))
        (CL:WHEN (CL:NOT (EQUAL? ELTX ELTY)) (CL:RETURN-FROM OBJECT-EQUAL? CL:NIL))
  ...
  (CL:LET* ((CURSOR (LENGTH SELF)) (CODE 66435053)) (CL:DECLARE (CL:TYPE CL:FIXNUM CURSOR CODE))
   (CL:LOOP (CL:IF (CL:= CURSOR 0) (CL:RETURN) (CL:SETQ CURSOR (CL:1- CURSOR)))
    (CL:SETQ CODE
     (CL:THE CL:FIXNUM
      (CL:LOGXOR CODE
       (CL:THE CL:FIXNUM (SAFE-EQUAL-HASH-CODE (CL:AREF (CL:THE CL:SIMPLE-VECTOR (%THE-ARRAY SELF)) CURSOR))))))
    (CL:SETQ CODE
...
(CL:DEFMETHOD INSERT-AT ((SELF EXTENSIBLE-VECTOR) OFFSET VALUE)
  ...
  (CL:WHEN (CL:>= OFFSET (%ARRAY-SIZE SELF))
   (CL:LET* ((SIZE (%ARRAY-SIZE SELF))) (CL:DECLARE (CL:TYPE CL:FIXNUM SIZE))
    (CL:LOOP WHILE (CL:>= OFFSET SIZE) DO (CL:SETQ SIZE (CL:* 2 SIZE))) (RESIZE-VECTOR SELF SIZE)))
  (CL:LET ((SELF (%THE-ARRAY SELF)) (VALUE VALUE) (POSITION OFFSET))
   (CL:DECLARE (CL:TYPE CL:SIMPLE-VECTOR SELF) (CL:TYPE CL:FIXNUM POSITION)) (CL:SETF (CL:AREF SELF POSITION) VALUE))
  :VOID)
...
(CL:DEFMETHOD LAST ((SELF VECTOR-SEQUENCE))
  "Return the last item in the vector `self'."
  (CL:RETURN-FROM LAST
   (CL:AREF (CL:THE CL:SIMPLE-VECTOR (%THE-ARRAY SELF)) (CL:THE CL:FIXNUM (CL:1- (%SEQUENCE-LENGTH SELF))))))

;;; (DEFMETHOD (LAST-SETTER (LIKE (ANY-VALUE SELF))) ...)

(CL:DEFMETHOD LAST-SETTER ((SELF VECTOR-SEQUENCE) VALUE)
  (CL:RETURN-FROM LAST-SETTER
   (CL:LET ((SELF (%THE-ARRAY SELF)) (VALUE VALUE) (POSITION (CL:1- (%SEQUENCE-LENGTH SELF))))
    (CL:DECLARE (CL:TYPE CL:SIMPLE-VECTOR SELF) (CL:TYPE CL:FIXNUM POSITION)) (CL:SETF (CL:AREF SELF POSITION) VALUE))))
...
Resize the array if necessary."
  (CL:LET* ((OLDLENGTH (%SEQUENCE-LENGTH SELF))) (CL:DECLARE (CL:TYPE CL:FIXNUM OLDLENGTH))
   (CL:WHEN (CL:= OLDLENGTH (%ARRAY-SIZE SELF))
    (CL:WHEN (CL:<= (%RESIZE-FACTOR SELF) 1.0d0)
     (CL:ERROR "Safety violation: CUSTOM-VECTOR-SEQUENCE.insert: resize factor needs to be > 1"))
...
the values after it to close the gap."
  (CL:LET* ((ARRAY (%THE-ARRAY SELF)) (LENGTH (%SEQUENCE-LENGTH SELF)) (NHITS 0))
   (CL:DECLARE (CL:TYPE CL:SIMPLE-VECTOR ARRAY) (CL:TYPE CL:FIXNUM LENGTH NHITS))
   (CL:LET* ((I NULL-INTEGER) (ITER-000 0) (UPPER-BOUND-000 (CL:1- LENGTH)))
    (CL:DECLARE (CL:TYPE CL:FIXNUM I ITER-000 UPPER-BOUND-000))
    (CL:LOOP WHILE (CL:<= ITER-000 UPPER-BOUND-000) DO (CL:SETQ I ITER-000)
     (CL:COND ((EQL? (CL:AREF ARRAY I) VALUE) (CL:SETQ NHITS (CL:1+ NHITS)))
      ((CL:> NHITS 0)
       (CL:LET ((SELF ARRAY) (VALUE (CL:AREF ARRAY I)) (POSITION (CL:- I NHITS)))
        (CL:DECLARE (CL:TYPE CL:SIMPLE-VECTOR SELF) (CL:TYPE CL:FIXNUM POSITION))
        (CL:SETF (CL:AREF SELF POSITION) VALUE))))
     (CL:SETQ ITER-000 (CL:1+ ITER-000))))
   (CL:SETF (%SEQUENCE-LENGTH SELF) (CL:- LENGTH NHITS))
   (CL:LET* ((I NULL-INTEGER) (ITER-001 (%SEQUENCE-LENGTH SELF)) (UPPER-BOUND-001 (CL:1- LENGTH)))
...
(CL:DEFMETHOD REVERSE ((SELF VECTOR-SEQUENCE))
  ...
  (CL:LET* ((ARRAY (%THE-ARRAY SELF)) (BOTTOM 0) (TOP (CL:1- (%SEQUENCE-LENGTH SELF))) (ELT NULL))
   ...
   (CL:LOOP WHILE (CL:< BOTTOM TOP) DO (CL:SETQ ELT (CL:AREF ARRAY BOTTOM))
    (CL:LET ((SELF ARRAY) (VALUE (CL:AREF ARRAY TOP)) (POSITION BOTTOM))
     (CL:DECLARE (CL:TYPE CL:SIMPLE-VECTOR SELF) (CL:TYPE CL:FIXNUM POSITION)) (CL:SETF (CL:AREF SELF POSITION) VALUE))
...
(CL:DEFUN COPY-VECTOR-SEQUENCE (SOURCE COPY)
  (CL:LET* ((SOURCEARRAY (%THE-ARRAY SOURCE)) (COPYARRAY (%THE-ARRAY COPY)) (LENGTH (%SEQUENCE-LENGTH SOURCE)))
   (CL:DECLARE (CL:TYPE CL:SIMPLE-VECTOR SOURCEARRAY COPYARRAY) (CL:TYPE CL:FIXNUM LENGTH))
   (CL:SETF (%SEQUENCE-LENGTH COPY) LENGTH)
   (CL:LET* ((I NULL-INTEGER) (ITER-000 0) (UPPER-BOUND-000 (CL:1- LENGTH)))
    (CL:DECLARE (CL:TYPE CL:FIXNUM I ITER-000 UPPER-BOUND-000))
    (CL:LOOP WHILE (CL:<= ITER-000 UPPER-BOUND-000) DO (CL:SETQ I ITER-000)
     (CL:LET ((SELF COPYARRAY) (VALUE (CL:AREF SOURCEARRAY I)) (POSITION I))
...
(CL:DEFMETHOD COPY ((SELF VECTOR-SEQUENCE))
  ...
  (CL:LET* ((COPY (NEW-VECTOR-SEQUENCE (%ARRAY-SIZE SELF)))) (COPY-VECTOR-SEQUENCE SELF COPY)
   (CL:RETURN-FROM COPY COPY)))
...
(CL:DEFMETHOD COPY ((SELF CUSTOM-VECTOR-SEQUENCE))
  "Return a copy of the vector sequence `self'."
  (CL:LET* ((COPY (NEW-CUSTOM-VECTOR-SEQUENCE (%ARRAY-SIZE SELF))))
   (CL:SETF (%RESIZE-FACTOR COPY) (%RESIZE-FACTOR SELF)) (COPY-VECTOR-SEQUENCE SELF COPY) (CL:RETURN-FROM COPY COPY)))
   ...
   ((SUBTYPE-OF? (SAFE-PRIMARY-TYPE Y) SGT-COLLECTIONS-STELLA-VECTOR-SEQUENCE)
    (CL:PROGN
     (CL:WHEN (CL:= (%SEQUENCE-LENGTH X) (%SEQUENCE-LENGTH Y))
      (CL:LET*
       ((ELTX NULL) (VECTOR-000 X) (INDEX-000 0) (LENGTH-000 (%SEQUENCE-LENGTH VECTOR-000)) (ELTY NULL) (VECTOR-001 Y)
        (INDEX-001 0) (LENGTH-001 (%SEQUENCE-LENGTH VECTOR-001)))
       (CL:DECLARE (CL:TYPE CL:FIXNUM INDEX-000 LENGTH-000 INDEX-001 LENGTH-001))
       (CL:LOOP WHILE (CL:AND (CL:< INDEX-000 LENGTH-000) (CL:< INDEX-001 LENGTH-001)) DO
        (CL:SETQ ELTX (CL:AREF (CL:THE CL:SIMPLE-VECTOR (%THE-ARRAY VECTOR-000)) INDEX-000))
        (CL:SETQ ELTY (CL:AREF (CL:THE CL:SIMPLE-VECTOR (%THE-ARRAY VECTOR-001)) INDEX-001))
...
(CL:DEFMETHOD ALLOCATE-ITERATOR ((SELF VECTOR))
  (CL:LET* ((ITERATOR (NEW-ALL-PURPOSE-ITERATOR))) (CL:SETF (%ITERATOR-OBJECT ITERATOR) SELF)
   (CL:SETF (%ITERATOR-INTEGER ITERATOR) 0) (CL:SETF (%ITERATOR-SECOND-INTEGER ITERATOR) (LENGTH SELF))
   (CL:SETF (%ITERATOR-NEXT-CODE ITERATOR) (CL:FUNCTION VECTOR-NEXT?)) (CL:RETURN-FROM ALLOCATE-ITERATOR ITERATOR)))
...
(CL:DEFUN VECTOR-NEXT? (SELF)
  (CL:LET* ((CURSOR (%ITERATOR-INTEGER SELF))) (CL:DECLARE (CL:TYPE CL:FIXNUM CURSOR))
   (CL:WHEN (CL:< CURSOR (%ITERATOR-SECOND-INTEGER SELF))
    (CL:SETF (%VALUE SELF) (CL:AREF (CL:THE CL:SIMPLE-VECTOR (%THE-ARRAY (%ITERATOR-OBJECT SELF))) CURSOR))
...
(CL:DEFMETHOD BUT-LAST ((SELF VECTOR))
  ...
  (CL:LET* ((ITERATOR (NEW-ALL-PURPOSE-ITERATOR))) (CL:SETF (%ITERATOR-OBJECT ITERATOR) SELF)
   (CL:SETF (%ITERATOR-INTEGER ITERATOR) 0) (CL:SETF (%ITERATOR-SECOND-INTEGER ITERATOR) (CL:1- (%ARRAY-SIZE SELF)))
   (CL:SETF (%ITERATOR-NEXT-CODE ITERATOR) (CL:FUNCTION VECTOR-NEXT?)) (CL:RETURN-FROM BUT-LAST ITERATOR)))
  ...
  (CL:LET* ((LENGTH (LENGTH SELF))) (CL:DECLARE (CL:TYPE CL:FIXNUM LENGTH))
   (CL:COND ((CL:= LENGTH 0) (CL:RETURN-FROM SORT SELF))
    ((CL:EQ PREDICATE NULL)
     (CL:SETQ PREDICATE (CHOOSE-SORT-PREDICATE (CL:AREF (CL:THE CL:SIMPLE-VECTOR (%THE-ARRAY SELF)) 0)))))
...
whose `n'-th element (0-based) will be used for comparison."
  ...
  (CL:LET* ((LENGTH (LENGTH SELF))) (CL:DECLARE (CL:TYPE CL:FIXNUM LENGTH))
   (CL:COND ((CL:= LENGTH 0) (CL:RETURN-FROM SORT-TUPLES SELF))
    ((CL:EQ PREDICATE NULL)
     (CL:SETQ PREDICATE (CHOOSE-SORT-PREDICATE (NTH (CL:AREF (CL:THE CL:SIMPLE-VECTOR (%THE-ARRAY SELF)) 0) N)))))
   (CL:LET* ((*SORT-TUPLE-COMPARE-PREDICATE* PREDICATE) (*SORT-TUPLE-COMPARE-INDEX* N))
    ...
    (HEAP-SORT-NATIVE-VECTOR (%THE-ARRAY SELF) (LENGTH SELF) (CL:FUNCTION SORT-TUPLE-COMPARE?))
...
it will cause value wrapping everytime `slot' is read."
  (CL:LET* ((LENGTH (LENGTH SELF))) (CL:DECLARE (CL:TYPE CL:FIXNUM LENGTH))
   (CL:COND ((CL:= LENGTH 0) (CL:RETURN-FROM SORT-OBJECTS SELF))
    ((CL:EQ PREDICATE NULL)
     (CL:SETQ PREDICATE
      (CHOOSE-SORT-PREDICATE (READ-SLOT-VALUE (CL:AREF (CL:THE CL:SIMPLE-VECTOR (%THE-ARRAY SELF)) 0) SLOT)))))
   (CL:LET* ((*SORT-TUPLE-COMPARE-PREDICATE* PREDICATE) (*SORT-OBJECTS-COMPARE-SLOT* SLOT))
    ...
    (HEAP-SORT-NATIVE-VECTOR (%THE-ARRAY SELF) (LENGTH SELF) (CL:FUNCTION SORT-OBJECTS-COMPARE?))
...
(CL:DEFUN HEAP-SORT-HEAPIFY (VECTOR SIZE PREDICATE)
  ...
  (CL:LET*
   ((START
     (CL:1-
      (CL:LET ((ARG SIZE) (COUNT 1)) (CL:DECLARE (CL:TYPE CL:FIXNUM ARG COUNT))
       (CL:THE CL:FIXNUM (CL:ASH ARG (CL:THE CL:FIXNUM (CL:- COUNT))))))))
   (CL:DECLARE (CL:TYPE CL:FIXNUM START))
   (CL:LOOP WHILE (CL:>= START 0) DO (HEAP-SORT-SIFT-DOWN VECTOR START (CL:1- SIZE) PREDICATE)
...
(CL:DEFUN HEAP-SORT-SIFT-DOWN (VECTOR START END PREDICATE)
  ...
  (CL:LET* ((ROOT START) (CHILD 0) (AUX NULL)) (CL:DECLARE (CL:TYPE CL:FIXNUM ROOT CHILD))
   (CL:LOOP (CL:SETQ CHILD (CL:1+ (CL:THE CL:FIXNUM (CL:ASH ROOT 1)))) (CL:WHEN (CL:> CHILD END) (CL:RETURN))
    (CL:WHEN
     (CL:AND (CL:< CHILD END)
      (CL:FUNCALL PREDICATE (CL:AREF VECTOR CHILD) (CL:AREF VECTOR (CL:THE CL:FIXNUM (CL:1+ CHILD)))))
     (CL:SETQ CHILD (CL:1+ CHILD)))
    (CL:COND
     ((CL:FUNCALL PREDICATE (CL:AREF VECTOR ROOT) (CL:AREF VECTOR CHILD)) (CL:SETQ AUX (CL:AREF VECTOR ROOT))
      (CL:LET ((SELF VECTOR) (VALUE (CL:AREF VECTOR CHILD)) (POSITION ROOT))
       (CL:DECLARE (CL:TYPE CL:SIMPLE-VECTOR SELF) (CL:TYPE CL:FIXNUM POSITION))
       (CL:SETF (CL:AREF SELF POSITION) VALUE))
  ...
  (CL:LOOP
   (CL:LET* ((LENGTH (CL:- END START)) (SPLITELEMENT NULL) (ELEMENT NULL) (LOWCURSOR START) (HIGHCURSOR END))
    ...
    (CL:COND ((CL:<= LENGTH 1) (CL:RETURN-FROM QUICK-SORT-NATIVE-VECTOR))
     ((CL:>= LENGTH 10) (CL:SETQ SPLITELEMENT (QUICK-SORT-PICK-SPLIT-ELEMENT VECTOR START END PREDICATE)))
     (CL:T (CL:SETQ SPLITELEMENT (CL:AREF VECTOR START))))
    (CL:LOOP WHILE (CL:< LOWCURSOR HIGHCURSOR) DO
     (CL:LOOP WHILE (CL:< LOWCURSOR HIGHCURSOR) DO (CL:SETQ HIGHCURSOR (CL:1- HIGHCURSOR))
      ...
      (CL:WHEN (CL:FUNCALL PREDICATE ELEMENT SPLITELEMENT)
       (CL:LET ((SELF VECTOR) (VALUE ELEMENT) (POSITION LOWCURSOR))
        ...
        (CL:SETF (CL:AREF SELF POSITION) VALUE))
       (CL:RETURN)))
     (CL:LOOP WHILE (CL:< LOWCURSOR HIGHCURSOR) DO (CL:SETQ LOWCURSOR (CL:1+ LOWCURSOR))
...
(CL:DEFCLASS HEAP (VECTOR)
  ((PREDICATE :ALLOCATION :INSTANCE :ACCESSOR %PREDICATE)
   (FILL-POINTER :TYPE CL:FIXNUM :INITFORM NULL-INTEGER :ALLOCATION :INSTANCE :ACCESSOR %FILL-POINTER))
...
(CL:DEFUN NEW-HEAP (PREDICATE ARRAY-SIZE)
  ...
  (CL:LET* ((SELF NULL)) (CL:SETQ SELF (CL:MAKE-INSTANCE (CL:QUOTE HEAP))) (CL:SETF (%PREDICATE SELF) PREDICATE)
   (CL:SETF (%ARRAY-SIZE SELF) ARRAY-SIZE) (CL:SETF (%THE-ARRAY SELF) STELLA::NULL-NATIVE-VECTOR)
   (CL:SETF (%FILL-POINTER SELF) 0) (INITIALIZE-VECTOR SELF) (INITIALIZE-HEAP SELF) (CL:RETURN-FROM NEW-HEAP SELF)))
...
(CL:DEFUN ACCESS-HEAP-SLOT-VALUE (SELF SLOTNAME VALUE SETVALUE?)
  (CL:COND
   ((CL:EQ SLOTNAME SYM-COLLECTIONS-STELLA-PREDICATE)
    (CL:IF SETVALUE? (CL:SETF (%PREDICATE SELF) (%WRAPPER-VALUE VALUE))
     (CL:SETQ VALUE (WRAP-FUNCTION-CODE (%PREDICATE SELF)))))
   ((CL:EQ SLOTNAME SYM-COLLECTIONS-STELLA-FILL-POINTER)
    (CL:IF SETVALUE? (CL:SETF (%FILL-POINTER SELF) (%WRAPPER-VALUE VALUE))
     (CL:SETQ VALUE (WRAP-INTEGER (%FILL-POINTER SELF)))))
   (CL:T
...
(CL:DEFMETHOD INITIALIZE-HEAP ((SELF HEAP))
  (CL:LET* ((SIZE (%ARRAY-SIZE SELF))) (CL:DECLARE (CL:TYPE CL:FIXNUM SIZE))
   (CL:WHEN (CL:<= SIZE 0) (CL:ERROR "Safety violation: Trying to create an empty heap")))
  :VOID)
...
(CL:DEFMETHOD COPY ((SELF HEAP))
  ...
  (CL:LET* ((LENGTH (%FILL-POINTER SELF))) (CL:DECLARE (CL:TYPE CL:FIXNUM LENGTH))
   (CL:LET* ((SELF-000 (NEW-HEAP (%PREDICATE SELF) (%ARRAY-SIZE SELF)))) (CL:SETF (%FILL-POINTER SELF-000) LENGTH)
    (CL:LET* ((COPY SELF-000) (SOURCEARRAY (%THE-ARRAY SELF)) (COPYARRAY (%THE-ARRAY COPY)))
  ...
  (CL:LET* ((PARENT NULL-INTEGER) (CHILD END)) (CL:DECLARE (CL:TYPE CL:FIXNUM PARENT CHILD))
   ...
   (CL:LOOP WHILE (CL:> CHILD START) DO
    (CL:IF (CL:= (CL:THE CL:FIXNUM (CL:LOGAND CHILD 1)) 0)
     (CL:SETQ PARENT
      (CL:LET ((ARG (CL:- CHILD 2)) (COUNT 1)) (CL:DECLARE (CL:TYPE CL:FIXNUM ARG COUNT))
       (CL:THE CL:FIXNUM (CL:ASH ARG (CL:THE CL:FIXNUM (CL:- COUNT))))))
     (CL:SETQ PARENT
      (CL:LET ((ARG (CL:1- CHILD)) (COUNT 1)) (CL:DECLARE (CL:TYPE CL:FIXNUM ARG COUNT))
       (CL:THE CL:FIXNUM (CL:ASH ARG (CL:THE CL:FIXNUM (CL:- COUNT)))))))
    (CL:COND
     ((CL:FUNCALL PREDICATE VALUE (CL:AREF HEAP PARENT))
      (CL:LET ((SELF HEAP) (VALUE (CL:AREF HEAP PARENT)) (POSITION CHILD))
       (CL:DECLARE (CL:TYPE CL:SIMPLE-VECTOR SELF) (CL:TYPE CL:FIXNUM POSITION))
       (CL:SETF (CL:AREF SELF POSITION) VALUE))
...
(CL:DEFUN HEAP-SIFT-DOWN (HEAP START END VALUE PREDICATE)
  ...
  #+MCL
  (CL:CHECK-TYPE END CL:FIXNUM)
  (CL:LET* ((PARENT START) (CHILD NULL-INTEGER) (LEFTCHILD NULL) (RIGHTCHILD NULL))
   ...
   (CL:LOOP (CL:SETQ CHILD (CL:1+ (CL:THE CL:FIXNUM (CL:ASH PARENT 1))))
    (CL:COND ((CL:> CHILD END) (CL:RETURN))
     ((CL:= CHILD END) (CL:WHEN (CL:NOT (CL:FUNCALL PREDICATE (CL:AREF HEAP CHILD) VALUE)) (CL:RETURN)))
     (CL:T (CL:SETQ LEFTCHILD (CL:AREF HEAP CHILD))
      (CL:SETQ RIGHTCHILD (CL:AREF HEAP (CL:THE CL:FIXNUM (CL:1+ CHILD))))
      (CL:COND
       ((CL:FUNCALL PREDICATE LEFTCHILD VALUE)
        (CL:WHEN (CL:AND (CL:FUNCALL PREDICATE RIGHTCHILD VALUE) (CL:FUNCALL PREDICATE RIGHTCHILD LEFTCHILD))
         (CL:SETQ CHILD (CL:1+ CHILD))))
       ((CL:FUNCALL PREDICATE RIGHTCHILD VALUE) (CL:SETQ CHILD (CL:1+ CHILD))) (CL:T (CL:RETURN)))))
    (CL:LET ((SELF HEAP) (VALUE (CL:AREF HEAP CHILD)) (POSITION PARENT))
     (CL:DECLARE (CL:TYPE CL:SIMPLE-VECTOR SELF) (CL:TYPE CL:FIXNUM POSITION)) (CL:SETF (CL:AREF SELF POSITION) VALUE))
...
a Min-heap if `self's `predicate' has `<' semantics; otherwise as a Max-heap."
  (CL:LET* ((VALUES (%THE-ARRAY SELF)) (FILLPOINTER (%FILL-POINTER SELF)) (PREDICATE (%PREDICATE SELF)))
   ...
   (CL:COND
    ((CL:< FILLPOINTER (%ARRAY-SIZE SELF)) (HEAP-SIFT-UP VALUES 0 FILLPOINTER VALUE PREDICATE)
     (CL:SETF (%FILL-POINTER SELF) (CL:1+ FILLPOINTER)))
    (CL:T
     (CL:LET* ((STREAM-000 (NEW-OUTPUT-STRING-STREAM)))
      (%%PRINT-STREAM (%NATIVE-STREAM STREAM-000) "HEAP.insert: heap overflow, can't insert new value: `" VALUE "'")
      (CL:ERROR (NEW-STELLA-EXCEPTION (THE-STRING-READER STREAM-000)))))))
  :VOID)
...
a Min-heap if `self's `predicate' has `<' semantics; otherwise as a Max-heap."
  (CL:LET* ((VALUES (%THE-ARRAY SELF)) (FILLPOINTER (%FILL-POINTER SELF)) (PREDICATE (%PREDICATE SELF)))
   ...
   (CL:IF (CL:= FILLPOINTER 0)
    (CL:ERROR (NEW-STELLA-EXCEPTION "HEAP.replace-heap-root: can't replace root of an empty heap"))
  ...
  (CL:LET* ((VALUES (%THE-ARRAY SELF)) (FILLPOINTER (%FILL-POINTER SELF)) (PREDICATE (%PREDICATE SELF)))
   ...
   (CL:COND
    ((CL:= FILLPOINTER (%ARRAY-SIZE SELF))
     (CL:WHEN (CL:FUNCALL PREDICATE (CL:AREF (CL:THE CL:SIMPLE-VECTOR (%THE-ARRAY SELF)) 0) VALUE)
      (HEAP-SIFT-DOWN VALUES 0 FILLPOINTER VALUE PREDICATE)))
...
insertion of values or if `predicate' has been changed."
  (CL:LET* ((VALUES (%THE-ARRAY SELF)) (FILLPOINTER (%FILL-POINTER SELF)) (PREDICATE (%PREDICATE SELF)))
   (CL:DECLARE (CL:TYPE CL:SIMPLE-VECTOR VALUES) (CL:TYPE CL:FIXNUM FILLPOINTER))
   (CL:LET* ((I NULL-INTEGER) (ITER-000 0) (UPPER-BOUND-000 (CL:1- FILLPOINTER)))
    (CL:DECLARE (CL:TYPE CL:FIXNUM I ITER-000 UPPER-BOUND-000))
    (CL:LOOP WHILE (CL:<= ITER-000 UPPER-BOUND-000) DO (CL:SETQ I ITER-000)
     (HEAP-SIFT-UP VALUES 0 I (CL:AREF VALUES I) PREDICATE) (CL:SETQ ITER-000 (CL:1+ ITER-000)))))
  :VOID)
...
the same."
  (CL:LET* ((VALUES (%THE-ARRAY SELF)) (CURSOR (%FILL-POINTER SELF)) (VALUE NULL))
   (CL:DECLARE (CL:TYPE CL:SIMPLE-VECTOR VALUES) (CL:TYPE CL:FIXNUM CURSOR))
   ...
   (CL:LOOP WHILE (CL:> CURSOR 0) DO (CL:SETQ CURSOR (CL:1- CURSOR)) (CL:SETQ VALUE (CL:AREF VALUES CURSOR))
    (CL:LET ((SELF VALUES) (VALUE (CL:AREF VALUES 0)) (POSITION CURSOR))
     (CL:DECLARE (CL:TYPE CL:SIMPLE-VECTOR SELF) (CL:TYPE CL:FIXNUM POSITION)) (CL:SETF (CL:AREF SELF POSITION) VALUE))
   ...
   (CL:LET* ((I NULL-INTEGER) (ITER-000 0)) (CL:DECLARE (CL:TYPE CL:FIXNUM I ITER-000))
    (CL:LOOP WHILE CL:T DO (CL:SETQ I ITER-000) (CL:SETQ CURSOR (CL:1- CURSOR)) (CL:WHEN (CL:>= I CURSOR) (CL:RETURN))
     (CL:SETQ VALUE (CL:AREF VALUES I))
     (CL:LET ((SELF VALUES) (VALUE (CL:AREF VALUES CURSOR)) (POSITION I))
      (CL:DECLARE (CL:TYPE CL:SIMPLE-VECTOR SELF) (CL:TYPE CL:FIXNUM POSITION))
      (CL:SETF (CL:AREF SELF POSITION) VALUE))
...
(CL:DEFCLASS STELLA-HASH-TABLE (ABSTRACT-HASH-TABLE)
  ((THE-TABLE :ALLOCATION :INSTANCE :ACCESSOR %THE-TABLE)
   (SIZE :TYPE CL:FIXNUM :INITFORM NULL-INTEGER :ALLOCATION :INSTANCE :ACCESSOR %SIZE)
...
(CL:DEFUN NEW-STELLA-HASH-TABLE ()
  (CL:LET* ((SELF NULL)) (CL:SETQ SELF (CL:MAKE-INSTANCE (CL:QUOTE STELLA-HASH-TABLE)))
   (CL:SETF (%THE-STELLA-HASH-TABLE SELF) NULL) (CL:SETF (%THE-HASH-TABLE SELF) NULL)
   (CL:SETF (%EQUAL-TEST? SELF) CL:NIL) (CL:SETF (%FREE-ELEMENTS SELF) NULL-INTEGER) (CL:SETF (%INITIAL-SIZE SELF) 50)
   (CL:SETF (%SIZE SELF) NULL-INTEGER) (CL:SETF (%THE-TABLE SELF) STELLA::NULL-1D-ARRAY) (INITIALIZE-HASH-TABLE SELF)
...
(CL:DEFUN ACCESS-STELLA-HASH-TABLE-SLOT-VALUE (SELF SLOTNAME VALUE SETVALUE?)
  (CL:COND
   ((CL:EQ SLOTNAME SYM-COLLECTIONS-STELLA-SIZE)
    (CL:IF SETVALUE? (CL:SETF (%SIZE SELF) (%WRAPPER-VALUE VALUE)) (CL:SETQ VALUE (WRAP-INTEGER (%SIZE SELF)))))
   ...
   ((CL:EQ SLOTNAME SYM-COLLECTIONS-STELLA-EQUAL-TEST?)
    (CL:IF SETVALUE? (CL:SETF (%EQUAL-TEST? SELF) (COERCE-WRAPPED-BOOLEAN-TO-BOOLEAN VALUE))
...
(CL:DEFUN INITIALIZE-STELLA-HASH-TABLE (SELF)
  (CL:LET*
   ((SIZE (PICK-HASH-TABLE-SIZE-PRIME (FLOOR (CL:/ (%INITIAL-SIZE SELF) *STELLA-HASH-TABLE-AVG-BUCKET-LENGTH*))))
    (TABLE (CL:MAKE-ARRAY SIZE)))
   (CL:DECLARE (CL:TYPE CL:FIXNUM SIZE) (CL:TYPE CL:SIMPLE-VECTOR TABLE))
   (CL:LET* ((I NULL-INTEGER) (ITER-000 0) (UPPER-BOUND-000 (CL:1- SIZE)))
    (CL:DECLARE (CL:TYPE CL:FIXNUM I ITER-000 UPPER-BOUND-000))
    (CL:LOOP WHILE (CL:<= ITER-000 UPPER-BOUND-000) DO (CL:SETQ I ITER-000) (CL:SETF (CL:AREF TABLE I) NULL)
     (CL:SETQ ITER-000 (CL:1+ ITER-000))))
   (CL:SETF (%THE-TABLE SELF) TABLE) (CL:SETF (%SIZE SELF) SIZE)
   (CL:SETF (%FREE-ELEMENTS SELF) (FLOOR (CL:* SIZE *STELLA-HASH-TABLE-AVG-BUCKET-LENGTH*))))
  :VOID)
...
(CL:DEFUN REHASH-STELLA-HASH-TABLE (SELF NEWSIZE)
  ...
  (CL:LET*
   ((SIZE (%SIZE SELF)) (TABLE (%THE-TABLE SELF)) (NEWTABLE (CL:MAKE-ARRAY NEWSIZE)) (NEWBUCKETINDEX 0)
    (NEWBUCKET NULL) (CURSOR NULL) (CURRENT NULL) (EQUALTEST? (%EQUAL-TEST? SELF)))
   ...
   (CL:LET* ((I NULL-INTEGER) (ITER-000 0) (UPPER-BOUND-000 (CL:1- NEWSIZE)))
    (CL:DECLARE (CL:TYPE CL:FIXNUM I ITER-000 UPPER-BOUND-000))
    (CL:LOOP WHILE (CL:<= ITER-000 UPPER-BOUND-000) DO (CL:SETQ I ITER-000) (CL:SETF (CL:AREF NEWTABLE I) NULL)
     (CL:SETQ ITER-000 (CL:1+ ITER-000))))
   (CL:LET* ((I NULL-INTEGER) (ITER-001 0) (UPPER-BOUND-001 (CL:1- SIZE)))
    ...
    (CL:LOOP WHILE (CL:<= ITER-001 UPPER-BOUND-001) DO (CL:SETQ I ITER-001) (CL:SETQ CURSOR (CL:AREF TABLE I))
     (CL:LOOP WHILE (CL:NOT (CL:EQ CURSOR NULL)) DO
      ...
      (CL:COND
       ((CL:NOT (CL:EQ NEWBUCKET NULL)) (CL:SETF (%REST CURRENT) (%REST NEWBUCKET))
   ...
   (CL:SETF (%FREE-ELEMENTS SELF)
    (MAX (CL:+ (%FREE-ELEMENTS SELF) (FLOOR (CL:* (CL:- NEWSIZE SIZE) *STELLA-HASH-TABLE-AVG-BUCKET-LENGTH*))) 0)))
  :VOID)
...
(CL:DEFUN STELLA-HASH-TABLE-INSERT-AT (SELF KEY VALUE)
  (CL:LET*
   ((TABLE (%THE-TABLE SELF)) (FREE (%FREE-ELEMENTS SELF)) (BUCKETINDEX 0) (BUCKET NULL)
    (EQUALTEST? (%EQUAL-TEST? SELF)))
   (CL:DECLARE (CL:TYPE CL:SIMPLE-VECTOR TABLE) (CL:TYPE CL:FIXNUM FREE BUCKETINDEX))
   (CL:WHEN (NULL-ARRAY? TABLE) (INITIALIZE-STELLA-HASH-TABLE SELF) (CL:SETQ TABLE (%THE-TABLE SELF))
    (CL:SETQ FREE (%FREE-ELEMENTS SELF)))
   (CL:WHEN (CL:= FREE 0) (REHASH-STELLA-HASH-TABLE SELF (PICK-HASH-TABLE-SIZE-PRIME (CL:1+ (%SIZE SELF))))
   ...
   (CL:COND
    ((CL:EQ BUCKET NULL)
     (CL:LET* ((SELF-000 (NEW-KV-CONS))) (CL:SETF (%KEY SELF-000) KEY) (CL:SETF (%VALUE SELF-000) VALUE)
    ...
    (CL:T
     (CL:LET* ((CURSOR BUCKET))
      (CL:COND
       (EQUALTEST?
        (CL:LOOP WHILE (CL:AND (CL:NOT (CL:EQ CURSOR NULL)) (CL:NOT (EQUAL? (%KEY CURSOR) KEY))) DO
         (CL:SETQ CURSOR (%REST CURSOR))))
       (CL:T
        (CL:LOOP WHILE (CL:AND (CL:NOT (CL:EQ CURSOR NULL)) (CL:NOT (EQL? (%KEY CURSOR) KEY))) DO
         (CL:SETQ CURSOR (%REST CURSOR)))))
      (CL:COND ((CL:NOT (CL:EQ CURSOR NULL)) (CL:SETF (%VALUE CURSOR) VALUE))
       (CL:T
        (CL:LET* ((SELF-001 (NEW-KV-CONS))) (CL:SETF (%KEY SELF-001) KEY) (CL:SETF (%VALUE SELF-001) VALUE)
         (CL:SETF (%REST SELF-001) (%REST BUCKET)) (CL:SETF (%REST BUCKET) SELF-001))
        (CL:SETF (%FREE-ELEMENTS SELF) (CL:1- FREE))))))))
  :VOID)
...
(CL:DEFUN STELLA-HASH-TABLE-REMOVE-AT (SELF KEY)
  (CL:LET* ((TABLE (%THE-TABLE SELF)) (BUCKETINDEX 0) (BUCKET NULL) (EQUALTEST? (%EQUAL-TEST? SELF)))
   (CL:DECLARE (CL:TYPE CL:SIMPLE-VECTOR TABLE) (CL:TYPE CL:FIXNUM BUCKETINDEX))
   ...
   (CL:COND ((CL:EQ BUCKET NULL) (CL:RETURN-FROM STELLA-HASH-TABLE-REMOVE-AT))
    ...
    ((CL:AND EQUALTEST? (EQUAL? (%KEY BUCKET) KEY)) (CL:SETF (CL:AREF TABLE BUCKETINDEX) (%REST BUCKET))
     (CL:SETF (%FREE-ELEMENTS SELF) (CL:1+ (%FREE-ELEMENTS SELF))) (CL:RETURN-FROM STELLA-HASH-TABLE-REMOVE-AT))
    (CL:T
     (CL:LET* ((TRAILER BUCKET)) (CL:SETQ BUCKET (%REST BUCKET))
      (CL:LOOP WHILE (CL:NOT (CL:EQ BUCKET NULL)) DO
       (CL:COND
        ((CL:AND (CL:NOT EQUALTEST?) (EQL? (%KEY BUCKET) KEY)) (CL:SETF (%REST TRAILER) (%REST BUCKET))
         (CL:SETF (%FREE-ELEMENTS SELF) (CL:1+ (%FREE-ELEMENTS SELF))) (CL:RETURN-FROM STELLA-HASH-TABLE-REMOVE-AT))
        ((CL:AND EQUALTEST? (EQUAL? (%KEY BUCKET) KEY)) (CL:SETF (%REST TRAILER) (%REST BUCKET))
         (CL:SETF (%FREE-ELEMENTS SELF) (CL:1+ (%FREE-ELEMENTS SELF))) (CL:RETURN-FROM STELLA-HASH-TABLE-REMOVE-AT))
      ...
      (CL:AREF TABLE
       (CL:THE CL:FIXNUM
        (CL:LET ((CODE (EQUAL-HASH-CODE KEY)) (SIZE (%SIZE SELF))) (CL:DECLARE (CL:TYPE CL:FIXNUM CODE SIZE))
         (CL:THE CL:FIXNUM (CL:REM (CL:THE CL:FIXNUM (CL:LOGAND CODE *INTEGER-UNSIGNED-BITS-MASK*)) SIZE))))))
     (CL:LOOP WHILE (CL:NOT (CL:EQ BUCKET NULL)) DO
      (CL:IF (EQUAL? (%KEY BUCKET) KEY) (CL:RETURN-FROM STELLA-HASH-TABLE-LOOKUP (%VALUE BUCKET))
      ...
      (CL:AREF TABLE
       (CL:THE CL:FIXNUM
        (CL:LET ((CODE (HASH-CODE KEY)) (SIZE (%SIZE SELF))) (CL:DECLARE (CL:TYPE CL:FIXNUM CODE SIZE))
         (CL:THE CL:FIXNUM (CL:REM (CL:THE CL:FIXNUM (CL:LOGAND CODE *INTEGER-UNSIGNED-BITS-MASK*)) SIZE))))))
     (CL:LOOP WHILE (CL:NOT (CL:EQ BUCKET NULL)) DO
      (CL:IF (EQL? (%KEY BUCKET) KEY) (CL:RETURN-FROM STELLA-HASH-TABLE-LOOKUP (%VALUE BUCKET))
       (CL:SETQ BUCKET (%REST BUCKET))))))
  ...
  (CL:LET* ((TABLE (%THE-TABLE SELF)) (BUCKET NULL)) (CL:DECLARE (CL:TYPE CL:SIMPLE-VECTOR TABLE))
   ...
   (CL:LOOP WHILE (CL:NOT (CL:EQ BUCKET NULL)) DO
    (CL:IF (STRING-EQL? (%WRAPPER-VALUE (%KEY BUCKET)) KEY)
     (CL:RETURN-FROM STELLA-STRING-HASH-TABLE-LOOKUP (%VALUE BUCKET)) (CL:SETQ BUCKET (%REST BUCKET))))
...
are not copied themselves (similar to what we do for lists, etc.)."
  (CL:LET* ((SIZE (%SIZE SELF))) (CL:DECLARE (CL:TYPE CL:FIXNUM SIZE))
   (CL:LET* ((SELF-000 (NEW-STELLA-HASH-TABLE))) (CL:SETF (%SIZE SELF-000) SIZE)
    (CL:SETF (%INITIAL-SIZE SELF-000) (%INITIAL-SIZE SELF)) (CL:SETF (%FREE-ELEMENTS SELF-000) (%FREE-ELEMENTS SELF))
    (CL:SETF (%EQUAL-TEST? SELF-000) (%EQUAL-TEST? SELF))
    (CL:LET* ((COPY SELF-000) (TABLE (%THE-TABLE SELF)) (TABLECOPY TABLE) (BUCKET NULL))
     (CL:DECLARE (CL:TYPE CL:SIMPLE-VECTOR TABLE TABLECOPY))
     (CL:WHEN (CL:NOT (NULL-ARRAY? TABLE)) (CL:SETQ TABLECOPY (CL:MAKE-ARRAY SIZE))
      ...
      (CL:LET* ((I NULL-INTEGER) (ITER-000 0) (UPPER-BOUND-000 (CL:1- SIZE)))
       ...
       (CL:LOOP WHILE (CL:<= ITER-000 UPPER-BOUND-000) DO (CL:SETQ I ITER-000) (CL:SETQ BUCKET (CL:AREF TABLE I))
        (CL:IF (CL:NOT (CL:EQ BUCKET NULL)) (CL:SETF (CL:AREF TABLECOPY I) (COPY-KV-CONS-LIST BUCKET))
   ...
   (CL:LET* ((KEY NULL) (VALUE NULL) (ITER-000 (ALLOCATE-ITERATOR SELF)) (COLLECT-000 NULL))
    (CL:LOOP WHILE (NEXT? ITER-000) DO (CL:SETQ KEY (%KEY ITER-000)) (CL:SETQ VALUE (%VALUE ITER-000))
     (CL:IF (CL:EQ COLLECT-000 NULL)
      ...
      (CL:PROGN (CL:SETF (%%REST COLLECT-000) (CONS (CONS KEY (CONS VALUE NIL)) NIL))
...
(CL:DEFCLASS STELLA-HASH-TABLE-ITERATOR (DICTIONARY-ITERATOR)
  ((SIZE :TYPE CL:FIXNUM :INITFORM NULL-INTEGER :ALLOCATION :INSTANCE :ACCESSOR %SIZE)
   ...
   (BUCKET-INDEX :TYPE CL:FIXNUM :INITFORM NULL-INTEGER :ALLOCATION :INSTANCE :ACCESSOR %BUCKET-INDEX)
...
(CL:DEFUN NEW-STELLA-HASH-TABLE-ITERATOR ()
  (CL:LET* ((SELF NULL)) (CL:SETQ SELF (CL:MAKE-INSTANCE (CL:QUOTE STELLA-HASH-TABLE-ITERATOR)))
   (CL:SETF (%FIRST-ITERATION? SELF) CL:T) (CL:SETF (%VALUE SELF) NULL) (CL:SETF (%KEY SELF) NULL)
   (CL:SETF (%BUCKET-CURSOR SELF) NULL) (CL:SETF (%BUCKET-INDEX SELF) 0)
   (CL:SETF (%BUCKET-TABLE SELF) STELLA::NULL-1D-ARRAY) (CL:SETF (%SIZE SELF) NULL-INTEGER)
...
(CL:DEFUN ACCESS-STELLA-HASH-TABLE-ITERATOR-SLOT-VALUE (SELF SLOTNAME VALUE SETVALUE?)
  (CL:COND
   ...
   ((CL:EQ SLOTNAME SYM-COLLECTIONS-STELLA-BUCKET-CURSOR)
    (CL:IF SETVALUE? (CL:SETF (%BUCKET-CURSOR SELF) VALUE) (CL:SETQ VALUE (%BUCKET-CURSOR SELF))))
   (CL:T
    (CL:LET* ((STREAM-000 (NEW-OUTPUT-STRING-STREAM)))
     (%%PRINT-STREAM (%NATIVE-STREAM STREAM-000) "`" SLOTNAME "' is not a valid case option")
     (CL:ERROR (NEW-STELLA-EXCEPTION (THE-STRING-READER STREAM-000))))))
...
(CL:DEFMETHOD ALLOCATE-ITERATOR ((SELF STELLA-HASH-TABLE))
  ...
  (CL:LET* ((SELF-000 (NEW-STELLA-HASH-TABLE-ITERATOR))) (CL:SETF (%SIZE SELF-000) (%SIZE SELF))
   (CL:SETF (%BUCKET-TABLE SELF-000) (%THE-TABLE SELF)) (CL:SETF (%BUCKET-INDEX SELF-000) 0)
   (CL:SETF (%BUCKET-CURSOR SELF-000) NULL)
   (CL:LET* ((VALUE-000 SELF-000)) (CL:RETURN-FROM ALLOCATE-ITERATOR VALUE-000))))

;;; (DEFMETHOD (NEXT? BOOLEAN) ...)

(CL:DEFMETHOD NEXT? ((SELF STELLA-HASH-TABLE-ITERATOR))
  (CL:LET* ((CURSOR (%BUCKET-CURSOR SELF)))
   (CL:COND ((%FIRST-ITERATION? SELF) (CL:SETF (%FIRST-ITERATION? SELF) CL:NIL))
    ((CL:NOT (CL:EQ CURSOR NULL)) (CL:SETQ CURSOR (%REST CURSOR))))
   (CL:WHEN (CL:EQ CURSOR NULL)
    (CL:LET* ((TABLE (%BUCKET-TABLE SELF)) (INDEX (%BUCKET-INDEX SELF)) (SIZE (%SIZE SELF)))
     (CL:DECLARE (CL:TYPE CL:SIMPLE-VECTOR TABLE) (CL:TYPE CL:FIXNUM INDEX SIZE))
     (CL:WHEN (NULL-ARRAY? TABLE) (CL:RETURN-FROM NEXT? CL:NIL))
     (CL:LOOP WHILE (CL:AND (CL:EQ CURSOR NULL) (CL:< INDEX SIZE)) DO (CL:SETQ CURSOR (CL:AREF TABLE INDEX))
      (CL:SETQ INDEX (CL:1+ INDEX)))
     (CL:SETF (%BUCKET-INDEX SELF) INDEX) (CL:SETF (%BUCKET-CURSOR SELF) CURSOR)))
   (CL:COND
    ((CL:NOT (CL:EQ CURSOR NULL)) (CL:SETF (%KEY SELF) (%KEY CURSOR)) (CL:SETF (%VALUE SELF) (%VALUE CURSOR))
...
(CL:DEFMETHOD VALUE-SETTER ((SELF STELLA-HASH-TABLE-ITERATOR) VALUE)
  (CL:LET* ((CURSOR (%BUCKET-CURSOR SELF))) (CL:WHEN (CL:NOT (CL:EQ CURSOR NULL)) (CL:SETF (%VALUE CURSOR) VALUE))
...
(CL:DEFUN NEW-KEY-VALUE-MAP ()
  (CL:LET* ((SELF NULL)) (CL:SETQ SELF (CL:MAKE-INSTANCE (CL:QUOTE KEY-VALUE-MAP)))
   (CL:SETF (%CROSSOVER-POINT SELF) *KEY-VALUE-MAP-CROSSOVER-POINT*)
   (CL:SETF (%INITIAL-SIZE SELF) *KEY-VALUE-MAP-CROSSOVER-POINT*) (CL:SETF (%EQUAL-TEST? SELF) CL:NIL)
   (CL:SETF (%THE-MAP SELF) NULL) (CL:RETURN-FROM NEW-KEY-VALUE-MAP SELF)))
    ...
    (CL:T
     (CL:LET* ((CURSOR MAP))
      (CL:IF (%EQUAL-TEST? SELF)
       (CL:LOOP WHILE (CL:NOT (CL:EQ CURSOR NULL)) DO
        (CL:WHEN (EQUAL? (%KEY CURSOR) KEY) (CL:RETURN-FROM LOOKUP (%VALUE CURSOR))) (CL:SETQ CURSOR (%REST CURSOR)))
       (CL:LOOP WHILE (CL:NOT (CL:EQ CURSOR NULL)) DO
   ...
   (CL:WHEN (CL:EQ MAP NULL)
    (CL:COND
     ((CL:> (%INITIAL-SIZE SELF) *KEY-VALUE-MAP-CROSSOVER-POINT*)
      (CL:LET* ((SELF-000 (NEW-STELLA-HASH-TABLE))) (CL:SETF (%INITIAL-SIZE SELF-000) (%INITIAL-SIZE SELF))
       (CL:SETF (%EQUAL-TEST? SELF-000) (%EQUAL-TEST? SELF)) (CL:SETQ MAP SELF-000))
   ...
   (CL:COND ((CL:= CROSSOVER 0) (STELLA-HASH-TABLE-INSERT-AT MAP KEY VALUE))
    (CL:T
     (CL:LET* ((CURSOR MAP))
      (CL:IF (%EQUAL-TEST? SELF)
       (CL:LOOP WHILE (CL:NOT (CL:EQ CURSOR NULL)) DO
        (CL:WHEN (EQUAL? (%KEY CURSOR) KEY) (CL:SETF (%VALUE CURSOR) VALUE) (CL:RETURN-FROM INSERT-AT))
        (CL:SETQ CURSOR (%REST CURSOR)))
       (CL:LOOP WHILE (CL:NOT (CL:EQ CURSOR NULL)) DO
        (CL:WHEN (EQL? (%KEY CURSOR) KEY) (CL:SETF (%VALUE CURSOR) VALUE) (CL:RETURN-FROM INSERT-AT))
        (CL:SETQ CURSOR (%REST CURSOR))))
      (CL:SETQ CURSOR (KV-CONS KEY VALUE MAP)) (CL:SETF (%THE-MAP SELF) CURSOR) (CL:SETQ CROSSOVER (CL:1- CROSSOVER))
      (CL:SETF (%CROSSOVER-POINT SELF) CROSSOVER)
      (CL:WHEN (CL:= CROSSOVER 0)
       (CL:LET* ((SELF-001 (NEW-STELLA-HASH-TABLE))) (CL:SETF (%EQUAL-TEST? SELF-001) (%EQUAL-TEST? SELF))
       ...
       (CL:LET* ((KEY NULL) (VALUE NULL) (ITER-000 CURSOR))
        (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-000 NULL)) DO (CL:SETQ KEY (%KEY ITER-000))
         (CL:SETQ VALUE (%VALUE ITER-000)) (STELLA-HASH-TABLE-INSERT-AT MAP KEY VALUE)
         (CL:SETQ ITER-000 (%REST ITER-000)))))))))
  :VOID)
   ...
   (CL:COND ((CL:= CROSSOVER 0) (STELLA-HASH-TABLE-REMOVE-AT MAP KEY))
    (CL:T
     (CL:LET* ((CURSOR MAP) (TRAILER MAP))
      (CL:IF (%EQUAL-TEST? SELF)
       (CL:LOOP WHILE (CL:NOT (CL:EQ CURSOR NULL)) DO (CL:WHEN (EQUAL? (%KEY CURSOR) KEY) (CL:RETURN))
        (CL:SETQ TRAILER CURSOR) (CL:SETQ CURSOR (%REST CURSOR)))
       (CL:LOOP WHILE (CL:NOT (CL:EQ CURSOR NULL)) DO (CL:WHEN (EQL? (%KEY CURSOR) KEY) (CL:RETURN))
        (CL:SETQ TRAILER CURSOR) (CL:SETQ CURSOR (%REST CURSOR))))
...
(CL:DEFMETHOD EMPTY? ((SELF KEY-VALUE-MAP))
  ...
  (CL:LET* ((MAP (%THE-MAP SELF)))
   (CL:COND ((CL:EQ MAP NULL) (CL:RETURN-FROM EMPTY? CL:T))
    ((CL:= (%CROSSOVER-POINT SELF) 0) (CL:RETURN-FROM EMPTY? (CL:= (LENGTH MAP) 0)))
...
(CL:DEFMETHOD NON-EMPTY? ((SELF KEY-VALUE-MAP))
  ...
  (CL:LET* ((MAP (%THE-MAP SELF)))
   (CL:COND ((CL:EQ MAP NULL) (CL:RETURN-FROM NON-EMPTY? CL:NIL))
    ((CL:= (%CROSSOVER-POINT SELF) 0) (CL:RETURN-FROM NON-EMPTY? (> (LENGTH MAP) 0)))
...
allocated, however, the keys and values of entries are not copied themselves
 (similar to what we do for lists, etc.)."
  (CL:LET* ((SELF-000 (NEW-KEY-VALUE-MAP))) (CL:SETF (%EQUAL-TEST? SELF-000) (%EQUAL-TEST? SELF))
   ...
   (CL:LET* ((COPY SELF-000) (MAP (%THE-MAP SELF)))
    (CL:IF (CL:= (%CROSSOVER-POINT SELF) 0) (CL:SETF (%THE-MAP COPY) (COPY MAP))
...
(CL:DEFUN NEW-HASH-SET ()
  (CL:LET* ((SELF NULL)) (CL:SETQ SELF (CL:MAKE-INSTANCE (CL:QUOTE HASH-SET)))
   (CL:SETF (%CROSSOVER-POINT SELF) *KEY-VALUE-MAP-CROSSOVER-POINT*)
   (CL:SETF (%INITIAL-SIZE SELF) *KEY-VALUE-MAP-CROSSOVER-POINT*) (CL:SETF (%EQUAL-TEST? SELF) CL:NIL)
   (CL:SETF (%THE-MAP SELF) NULL) (CL:RETURN-FROM NEW-HASH-SET SELF)))
...
(CL:DEFUN HASH-SET (CL:&REST VALUES)
  ...
  (CL:LET* ((SET (NEW-HASH-SET)))
   (CL:LET* ((V NULL) (ITER-000 VALUES)) (CL:LOOP WHILE ITER-000 DO (CL:SETQ V (CL:POP ITER-000)) (INSERT-AT SET V V)))
...
already is a HASH-SET)."
  (CL:LET* ((CHOOSE-VALUE-000 NULL))
   (CL:IF (ISA? SELF SGT-COLLECTIONS-STELLA-HASH-SET) (CL:SETQ CHOOSE-VALUE-000 SELF)
    (CL:LET* ((SELF-000 (NEW-HASH-SET))) (CL:SETF (%EQUAL-TEST? SELF-000) EQUALTEST?)
      ...
      ((CL:EQ TEST-VALUE-000 SGT-COLLECTIONS-STELLA-CONS)
       (CL:PROGN
        (CL:LET* ((ELT NULL) (ITER-000 SELF))
         (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-000 NIL)) DO (CL:SETQ ELT (%%VALUE ITER-000)) (INSERT-AT THESET ELT ELT)
          (CL:SETQ ITER-000 (%%REST ITER-000))))))
      ((SUBTYPE-OF? TEST-VALUE-000 SGT-COLLECTIONS-STELLA-LIST)
       (CL:PROGN
        (CL:LET* ((ELT NULL) (ITER-001 (%THE-CONS-LIST SELF)))
         (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-001 NIL)) DO (CL:SETQ ELT (%%VALUE ITER-001)) (INSERT-AT THESET ELT ELT)
          (CL:SETQ ITER-001 (%%REST ITER-001))))))
      ((SUBTYPE-OF? TEST-VALUE-000 SGT-COLLECTIONS-STELLA-VECTOR)
       (CL:PROGN
        (CL:LET* ((ELT NULL) (VECTOR-000 SELF) (INDEX-000 0) (LENGTH-000 (LENGTH VECTOR-000)))
         (CL:DECLARE (CL:TYPE CL:FIXNUM INDEX-000 LENGTH-000))
         (CL:LOOP WHILE (CL:< INDEX-000 LENGTH-000) DO
          (CL:SETQ ELT (CL:AREF (CL:THE CL:SIMPLE-VECTOR (%THE-ARRAY VECTOR-000)) INDEX-000))
          (INSERT-AT THESET ELT ELT) (CL:SETQ INDEX-000 (CL:1+ INDEX-000))))))
      ((SUBTYPE-OF? TEST-VALUE-000 SGT-COLLECTIONS-STELLA-COLLECTION)
       (CL:PROGN
        (CL:LET* ((ELT NULL) (ITER-002 (ALLOCATE-ITERATOR SELF)))
         (CL:LOOP WHILE (NEXT? ITER-002) DO (CL:SETQ ELT (%VALUE ITER-002)) (INSERT-AT THESET ELT ELT)))))
      (CL:T
       (CL:LET* ((STREAM-000 (NEW-OUTPUT-STRING-STREAM)))
        (%%PRINT-STREAM (%NATIVE-STREAM STREAM-000) "coerce-to-hash-set: don't know how to coerce a `"
     ...
     ((CL:= (%CROSSOVER-POINT SELF) 0)
      (CL:LET* ((MAP SETMAP) (TABLE (%THE-TABLE MAP)) (BUCKET NULL)) (CL:DECLARE (CL:TYPE CL:SIMPLE-VECTOR TABLE))
       (CL:WHEN (CL:NOT (NULL-ARRAY? TABLE))
        (CL:LET* ((I NULL-INTEGER) (ITER-000 0) (UPPER-BOUND-000 (CL:1- (%SIZE MAP))))
         (CL:DECLARE (CL:TYPE CL:FIXNUM I ITER-000 UPPER-BOUND-000))
         (CL:LOOP WHILE (CL:<= ITER-000 UPPER-BOUND-000) DO (CL:SETQ I ITER-000) (CL:SETQ BUCKET (CL:AREF TABLE I))
          (CL:WHEN (CL:NOT (CL:EQ BUCKET NULL)) (CL:SETQ ELEMENT (%KEY BUCKET)) (CL:RETURN))
          (CL:SETQ ITER-000 (CL:1+ ITER-000)))))))
    ...
    (CL:LET* ((ALWAYS?-000 CL:T))
     (CL:LET* ((ELT NULL) (ITER-000 (ALLOCATE-ITERATOR SELF)))
      (CL:LOOP WHILE (NEXT? ITER-000) DO (CL:SETQ ELT (%VALUE ITER-000))
       (CL:WHEN (CL:EQ (LOOKUP OTHERSET ELT) NULL) (CL:SETQ ALWAYS?-000 CL:NIL) (CL:RETURN))))
     (CL:SETQ TEST-VALUE-000 ALWAYS?-000)))
...
Uses an `eql?' test by default or `equal?' if `equal-test?' of `self' is TRUE."
  (CL:LET* ((SELF-000 (NEW-HASH-SET))) (CL:SETF (%EQUAL-TEST? SELF-000) (%EQUAL-TEST? SELF))
   (CL:LET* ((RESULT SELF-000) (AUX SELF))
    (CL:WHEN (CL:> (LENGTH SELF) (LENGTH OTHERSET)) (CL:SETQ SELF OTHERSET) (CL:SETQ OTHERSET AUX))
    (CL:LET* ((ELT NULL) (ITER-000 (ALLOCATE-ITERATOR SELF)))
     (CL:LOOP WHILE (NEXT? ITER-000) DO (CL:SETQ ELT (%VALUE ITER-000))
      (CL:WHEN (CL:NOT (CL:EQ (LOOKUP OTHERSET ELT) NULL)) (INSERT-AT RESULT ELT ELT))))
...
Uses an `eql?' test by default or `equal?' if `equal-test?' of `self' is TRUE."
  (CL:LET* ((RESULT NULL) (AUX SELF))
   ...
   (CL:LET* ((ELT NULL) (ITER-000 (ALLOCATE-ITERATOR OTHERSET)))
    (CL:LOOP WHILE (NEXT? ITER-000) DO (CL:SETQ ELT (%VALUE ITER-000)) (INSERT-AT RESULT ELT ELT)))
  ...
  (CL:LET* ((RESULT NULL))
   (CL:COND
    ((CL:> (LENGTH SELF) (CL:* (LENGTH OTHERSET) 2)) (CL:SETQ RESULT (COPY SELF))
     (CL:LET* ((ELT NULL) (ITER-000 (ALLOCATE-ITERATOR OTHERSET)))
      (CL:LOOP WHILE (NEXT? ITER-000) DO (CL:SETQ ELT (%VALUE ITER-000))
       (CL:WHEN (CL:NOT (CL:EQ (LOOKUP RESULT ELT) NULL)) (REMOVE-AT RESULT ELT)))))
    (CL:T
     (CL:LET* ((SELF-000 (NEW-HASH-SET))) (CL:SETF (%EQUAL-TEST? SELF-000) (%EQUAL-TEST? SELF))
     ...
     (CL:LET* ((ELT NULL) (ITER-001 (ALLOCATE-ITERATOR SELF)))
      (CL:LOOP WHILE (NEXT? ITER-001) DO (CL:SETQ ELT (%VALUE ITER-001))
       (CL:WHEN (CL:EQ (LOOKUP OTHERSET ELT) NULL) (INSERT-AT RESULT ELT ELT))))))
...
test by default or `equal?' if `equal-test?' of `self' is TRUE."
  (CL:LET* ((ELT NULL) (ITER-000 (ALLOCATE-ITERATOR SELF)))
   (CL:LOOP WHILE (NEXT? ITER-000) DO (CL:SETQ ELT (%VALUE ITER-000))
    (CL:WHEN (CL:NOT (CL:EQ (LOOKUP OTHERSET ELT) NULL)) (REMOVE-AT SELF ELT))))
...
is O(N) in the number of elements of `self'."
  (CL:LET* ((CODE 7971569)) (CL:DECLARE (CL:TYPE CL:FIXNUM CODE))
   (CL:LET* ((ELT NULL) (ITER-000 (ALLOCATE-ITERATOR SELF)))
    (CL:LOOP WHILE (NEXT? ITER-000) DO (CL:SETQ ELT (%VALUE ITER-000))
     (CL:SETQ CODE (CL:THE CL:FIXNUM (CL:LOGXOR CODE (CL:THE CL:FIXNUM (EQUAL-HASH-CODE ELT)))))))
   (CL:RETURN-FROM EQUAL-HASH-CODE CODE)))
...
(CL:DEFCLASS 1D-ARRAY (ABSTRACT-DIMENSIONAL-ARRAY)
  ((DIM1 :TYPE CL:FIXNUM :INITFORM NULL-INTEGER :ALLOCATION :INSTANCE :ACCESSOR %DIM1)
...
(CL:DEFUN NEW-1D-ARRAY (DIM1)
  ...
  (CL:LET* ((SELF NULL)) (CL:SETQ SELF (CL:MAKE-INSTANCE (CL:QUOTE 1D-ARRAY))) (CL:SETF (%DIM1 SELF) DIM1)
   (CL:SETF (%THE-ARRAY SELF) STELLA::NULL-1D-ARRAY) (INITIALIZE-DIMENSIONAL-ARRAY SELF)
...
(CL:DEFMETHOD INITIALIZE-ARRAY ((SELF 1D-ARRAY) INITIALVALUE)
  ...
  (CL:LET* ((ARRAY (%THE-ARRAY SELF))) (CL:DECLARE (CL:TYPE CL:SIMPLE-VECTOR ARRAY))
   (CL:LET* ((I NULL-INTEGER) (ITER-000 0) (UPPER-BOUND-000 (CL:1- (LENGTH SELF))))
    (CL:DECLARE (CL:TYPE CL:FIXNUM I ITER-000 UPPER-BOUND-000))
    (CL:LOOP WHILE (CL:<= ITER-000 UPPER-BOUND-000) DO (CL:SETQ I ITER-000) (CL:SETF (CL:AREF ARRAY I) INITIALVALUE)
     (CL:SETQ ITER-000 (CL:1+ ITER-000)))))
  :VOID)
...
(CL:DEFUN NEW-1D-FLOAT-ARRAY (DIM1)
  ...
  #+MCL
  (CL:CHECK-TYPE DIM1 CL:FIXNUM)
  (CL:LET* ((SELF NULL)) (CL:SETQ SELF (CL:MAKE-INSTANCE (CL:QUOTE 1D-FLOAT-ARRAY))) (CL:SETF (%DIM1 SELF) DIM1)
   (CL:SETF (%THE-ARRAY SELF) STELLA::NULL-1D-ARRAY) (INITIALIZE-DIMENSIONAL-ARRAY SELF)
...
(CL:DEFUN NEW-2D-ARRAY (DIM2 DIM1)
  ...
  #+MCL
  (CL:CHECK-TYPE DIM1 CL:FIXNUM)
  (CL:LET* ((SELF NULL)) (CL:SETQ SELF (CL:MAKE-INSTANCE (CL:QUOTE 2D-ARRAY))) (CL:SETF (%DIM2 SELF) DIM2)
   (CL:SETF (%DIM1 SELF) DIM1) (CL:SETF (%THE-ARRAY SELF) STELLA::NULL-1D-ARRAY) (INITIALIZE-DIMENSIONAL-ARRAY SELF)
...
and return the result."
  ...
  (CL:RETURN-FROM 2D-AREF-SETTER
   (CL:SETF (CL:AREF (CL:THE CL:SIMPLE-VECTOR (%THE-ARRAY SELF)) (CL:THE CL:FIXNUM (CL:+ (CL:* I (%DIM2 SELF)) J)))
    VALUE)))
...
(CL:DEFMETHOD 2D-AREF ((SELF 2D-ARRAY) I J)
  ...
  (CL:RETURN-FROM 2D-AREF
   (CL:AREF (CL:THE CL:SIMPLE-VECTOR (%THE-ARRAY SELF)) (CL:THE CL:FIXNUM (CL:+ (CL:* I (%DIM2 SELF)) J)))))
...
(CL:DEFUN NEW-2D-FLOAT-ARRAY (DIM2 DIM1)
  ...
  #+MCL
  (CL:CHECK-TYPE DIM1 CL:FIXNUM)
  (CL:LET* ((SELF NULL)) (CL:SETQ SELF (CL:MAKE-INSTANCE (CL:QUOTE 2D-FLOAT-ARRAY))) (CL:SETF (%DIM2 SELF) DIM2)
   (CL:SETF (%DIM1 SELF) DIM1) (CL:SETF (%THE-ARRAY SELF) STELLA::NULL-1D-ARRAY) (INITIALIZE-DIMENSIONAL-ARRAY SELF)
...
(CL:DEFUN HELP-STARTUP-COLLECTIONS1 ()
  (CL:PROGN (CL:SETQ SGT-COLLECTIONS-STELLA-COLLECTION (INTERN-RIGID-SYMBOL-WRT-MODULE "COLLECTION" NULL 1))
   ...
   (CL:SETQ SYM-COLLECTIONS-STELLA-VECTOR (INTERN-RIGID-SYMBOL-WRT-MODULE "VECTOR" NULL 0))
...
really maintained or accessible until we sort the heap.\" :PUBLIC? TRUE :PARAMETERS ((ANY-VALUE :TYPE OBJECT)) :SLOTS ((PREDICATE :TYPE FUNCTION-CODE :REQUIRED? TRUE) (FILL-POINTER :TYPE INTEGER :INITIALLY 0)) :INITIALIZER INITIALIZE-HEAP)")))
    (CL:SETF (%CLASS-CONSTRUCTOR-CODE CLASS) (CL:FUNCTION NEW-HEAP))
    (CL:SETF (%CLASS-SLOT-ACCESSOR-CODE CLASS) (CL:FUNCTION ACCESS-HEAP-SLOT-VALUE)))
   (CL:LET*
    ((CLASS
...
will be sized to hold at least that many elements.\") (CROSSOVER-POINT :TYPE INTEGER :INITIALLY *KEY-VALUE-MAP-CROSSOVER-POINT*)))")))
    ...
    (CL:SETF (%CLASS-SLOT-ACCESSOR-CODE CLASS) (CL:FUNCTION ACCESS-KEY-VALUE-MAP-SLOT-VALUE)))
   (CL:LET*
    ((CLASS
...
original order of the remaining members.\" :PUBLIC? TRUE :ABSTRACT? TRUE)" NULL NULL)
   ...
   (DEFINE-METHOD-OBJECT "(DEFMETHOD (NO-DUPLICATES? BOOLEAN) ((SELF SET)) :PUBLIC? TRUE)" (CL:FUNCTION NO-DUPLICATES?)
    NULL)
   (DEFINE-METHOD-OBJECT
   ...
   (DEFINE-METHOD-OBJECT "(DEFMETHOD (REMOVE-DUPLICATES (LIKE SELF)) ((SELF SET)))" (CL:FUNCTION REMOVE-DUPLICATES)
    NULL)
   (DEFINE-METHOD-OBJECT
...
is O(N) in the number of elements of `self'.\" :PUBLIC? TRUE)" (CL:FUNCTION EQUAL-HASH-CODE) NULL)
   ...
   (DEFINE-METHOD-OBJECT "(DEFMETHOD PRINT-VECTOR ((SELF VECTOR) (STREAM NATIVE-OUTPUT-STREAM)))"
   ...
   (DEFINE-METHOD-OBJECT "(DEFMETHOD (MEMBER? BOOLEAN) ((SELF VECTOR) (OBJECT OBJECT)) :PUBLIC? TRUE)"
    (CL:FUNCTION MEMBER?) NULL)
   (DEFINE-METHOD-OBJECT
...
will always be relative to the entire vector.\" :PUBLIC? TRUE)" (CL:FUNCTION LAST-POSITION) NULL)
   (DEFINE-METHOD-OBJECT "(DEFMETHOD INSERT-AT ((SELF VECTOR) (OFFSET INTEGER) (VALUE (LIKE (ANY-VALUE SELF)))))"
...
the values after it to close the gap.\" :PUBLIC? TRUE)" (CL:FUNCTION REMOVE) NULL)
   ...
   (DEFINE-FUNCTION-OBJECT "COPY-VECTOR-SEQUENCE"
    "(DEFUN COPY-VECTOR-SEQUENCE ((SOURCE VECTOR-SEQUENCE) (COPY VECTOR-SEQUENCE)))" (CL:FUNCTION COPY-VECTOR-SEQUENCE)
    NULL)
   (DEFINE-METHOD-OBJECT
...
(CL:DEFUN HELP-STARTUP-COLLECTIONS4 ()
  (CL:PROGN
   (DEFINE-METHOD-OBJECT "(DEFMETHOD (ALLOCATE-ITERATOR (ITERATOR OF (LIKE (ANY-VALUE SELF)))) ((SELF VECTOR)))"
    (CL:FUNCTION ALLOCATE-ITERATOR) NULL)
   (DEFINE-FUNCTION-OBJECT "VECTOR-NEXT?" "(DEFUN (VECTOR-NEXT? BOOLEAN) ((SELF ALL-PURPOSE-ITERATOR)))"
...
Signal an error if there is no more room in `self'.  Maintains `self' as
a Min-heap if `self's `predicate' has `<' semantics; otherwise as a Max-heap.\" :PUBLIC? TRUE)" (CL:FUNCTION INSERT)
    NULL)
   (DEFINE-METHOD-OBJECT
...
a Min-heap if `self's `predicate' has `<' semantics; otherwise as a Max-heap.\" :PUBLIC? TRUE)"
    (CL:FUNCTION REPLACE-HEAP-ROOT) NULL)
   (DEFINE-METHOD-OBJECT
...
the same.\" :PUBLIC? TRUE)" (CL:FUNCTION SORT) NULL)
   (DEFINE-FUNCTION-OBJECT "INITIALIZE-STELLA-HASH-TABLE"
    "(DEFUN INITIALIZE-STELLA-HASH-TABLE ((SELF STELLA-HASH-TABLE)))" (CL:FUNCTION INITIALIZE-STELLA-HASH-TABLE) NULL)
   (DEFINE-METHOD-OBJECT
...
(CL:DEFUN STARTUP-COLLECTIONS ()
  (CL:LET* ((*MODULE* *STELLA-MODULE*) (*CONTEXT* *MODULE*)) (CL:DECLARE (CL:SPECIAL *MODULE* *CONTEXT*))
   ...
   (CL:WHEN (CURRENT-STARTUP-TIME-PHASE? 4)
    (CL:SETQ *KEY-VALUE-MAP-CROSSOVER-POINT* *REMOVE-DUPLICATES-CROSSOVER-POINT*))
   (CL:WHEN (CURRENT-STARTUP-TIME-PHASE? 5) (HELP-STARTUP-COLLECTIONS2))
...
Uses an `eql?' test by default or `equal?' if `equal-test?' of `self' is TRUE.\" :PUBLIC? TRUE)" (CL:FUNCTION MEMBER?)
     NULL)
    (DEFINE-METHOD-OBJECT
...
Uses an `eql?' test by default or `equal?' if `equal-test?' of `self' is TRUE.\" :PUBLIC? TRUE)" (CL:FUNCTION INSERT)
     NULL)
    (DEFINE-METHOD-OBJECT
...
Uses an `eql?' test by default or `equal?' if `equal-test?' of `self' is TRUE.\" :PUBLIC? TRUE)" (CL:FUNCTION SUBSET?)
     NULL)
    (DEFINE-METHOD-OBJECT
...
Uses an `eql?' test by default or `equal?' if `equal-test?' of `self' is TRUE.\" :PUBLIC? TRUE)" (CL:FUNCTION UNION)
     NULL)
    (DEFINE-METHOD-OBJECT
...
and return the result.\" :PUBLIC? TRUE :GLOBALLY-INLINE? TRUE (RETURN (SETF (AREF (THE-ARRAY SELF) I) VALUE)))" NULL
     NULL)
    (DEFINE-METHOD-OBJECT
...
This is useful for fast element-wise iteration that doesn't need arithmetic.\" :PUBLIC? TRUE :GLOBALLY-INLINE? TRUE (RETURN (+ (* I (DIM2 SELF)) J)))"
     NULL NULL)
    (DEFINE-FUNCTION-OBJECT "STARTUP-COLLECTIONS" "(DEFUN STARTUP-COLLECTIONS () :PUBLIC? TRUE)"
     (CL:FUNCTION STARTUP-COLLECTIONS) NULL)
    (CL:LET* ((FUNCTION (LOOKUP-FUNCTION SYM-COLLECTIONS-STELLA-STARTUP-COLLECTIONS)))
     (SET-DYNAMIC-SLOT-VALUE (%DYNAMIC-SLOTS FUNCTION) SYM-COLLECTIONS-STELLA-METHOD-STARTUP-CLASSNAME
