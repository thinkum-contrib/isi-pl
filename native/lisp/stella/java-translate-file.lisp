...
(CL:DECLAIM
  ...
  *JAVA-STELLA-PACKAGE-MAPPING* *TRANSLATIONUNITS* NULL-STRING-WRAPPER
  FALSE-WRAPPER *CONTEXT* *STELLA-MODULE* *CURRENT-STELLA-FEATURES*
  *MODULE* FALSE EOL *TRANSLATIONVERBOSITYLEVEL* *CURRENT-STREAM* NIL
  TRUE *TRANSLATOROUTPUTLANGUAGE* STANDARD-OUTPUT))
    ...
    (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-001 NIL)) DO
     ...
     (CL:IF (JAVA-CLASS-UNIT-DEFINES-FLOTSAM-CLASS? CLASSUNIT)
      (CL:LET*
       ...
       (CL:WHEN (CL:EQ FUNCTIONS NULL) (CL:SETQ FUNCTIONS NIL))
       (JAVA-OUTPUT-FLOTSAM-UNITS-TO-FILE-FOR-MODULE MODULE CLASSUNIT
        GLOBALS FUNCTIONS)
   ...
   (CL:WHEN (CURRENT-STARTUP-TIME-PHASE? 7)
    ...
    (CL:LET*
     ...
     (SET-DYNAMIC-SLOT-VALUE (%DYNAMIC-SLOTS FUNCTION)
      SYM-JAVA-TRANSLATE-FILE-STELLA-METHOD-STARTUP-CLASSNAME
      (WRAP-STRING "_Startup-Java-Translate-File")
      NULL-STRING-WRAPPER)))
