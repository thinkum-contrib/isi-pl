  ...
  (CL:LET* ((TEST-VALUE-000 (%CATEGORY UNIT)))
   (CL:COND
    ...
    ((CL:EQ TEST-VALUE-000 SYM-IDL-TRANSLATE-STELLA-PRINT-METHOD)
     (CL:RETURN-FROM IDL-TRANSLATE-UNIT NULL))
    ((CL:OR
      (CL:EQ TEST-VALUE-000 SYM-IDL-TRANSLATE-STELLA-STARTUP-TIME-PROGN)
...
(CL:PROGN (CL:DEFVAR *IDL-CHARACTER-SUBSTITUTION-TABLE* STELLA::NULL-STRING) (CL:DECLAIM (CL:TYPE CL:SIMPLE-STRING *IDL-CHARACTER-SUBSTITUTION-TABLE*)))
    ...
    ((WORD NULL)
     (ITER-000
      (LIST* SYM-IDL-TRANSLATE-STELLA-ASM SYM-IDL-TRANSLATE-STELLA-AUTO
       ...
       SYM-IDL-TRANSLATE-STELLA-WHILE SYM-IDL-TRANSLATE-STELLA-TYPENAME
       NIL)))
...
(CL:DEFUN IDL-LOOKUP-RESERVED-WORD-TABLE (WORD)
  (CL:LET*
   ((ENTRY (LOOKUP *IDL-RESERVED-WORD-TABLE* (%SYMBOL-NAME WORD))))
...
(CL:DEFUN IDL-TRANSLATE-FUNCTION-NAME (FUNCTION)
  (CL:LET*
   ...
   (CL:SETQ TRANSLATEDNAME
    (%WRAPPER-VALUE (IDL-TRANSLATE-NAME FUNCTIONNAME)))
   ...
   (CL:WHEN (CURRENT-STARTUP-TIME-PHASE? 7)
    ...
    (CL:LET*
     ...
     (SET-DYNAMIC-SLOT-VALUE (%DYNAMIC-SLOTS FUNCTION)
      ...
      (WRAP-STRING "Startup-Idl-Translate") NULL-STRING-WRAPPER)))
