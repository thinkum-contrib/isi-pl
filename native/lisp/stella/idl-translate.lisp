...
(CL:DECLAIM
 (CL:SPECIAL *STELLA-MODULE* *MODULE* NULL-CHARACTER *CHARACTER-DOWNCASE-TABLE*
  *CHARACTER-UPCASE-TABLE* NULL-INTEGER NULL-STRING-WRAPPER TRUE NIL))
...
(CL:DEFUN IDL-TRANSLATE-DEFTYPE-UNIT (UNIT)
  (CL:RETURN-FROM IDL-TRANSLATE-DEFTYPE-UNIT
   (LIST* SYM-IDL-TRANSLATE-STELLA-IDL_TYPEDEF
    (IDL-TRANSLATE-NAME (%%VALUE (%%REST (%CODE-REGISTER UNIT))))
...
(CL:DEFMETHOD IDL-TRANSLATE-ATOMIC-TREE ((TREE SYMBOL))
  (CL:RETURN-FROM IDL-TRANSLATE-ATOMIC-TREE
   (LIST* SYM-IDL-TRANSLATE-STELLA-IDL_IDENT (IDL-TRANSLATE-NAME TREE) NIL)))
     ...
     (CL:PROGN
      (CL:RETURN-FROM IDL-TRANSLATE-TYPE-SPEC
       (WRAP-STRING
        (CONCATENATE
         (%WRAPPER-VALUE
          (IDL-TRANSLATE-TYPE-SPEC (%SPECIFIER-BASE-TYPE TYPESPEC)))
         (CONCATENATE "<"
          (CONCATENATE
           (%WRAPPER-VALUE
  ...
  (CL:RETURN-FROM IDL-TRANSLATE-CLASS-NAME
   (WRAP-STRING
    (IDL-SUBSTITUTE-FORBIDDEN-CHARACTERS
     (IDL-CHANGE-CASE (%CLASS-TYPE (%SURROGATE-VALUE (SURROGATIFY NAMESYMBOL)))
    ...
    ((WORD NULL)
     (ITER-000
      (LIST* SYM-IDL-TRANSLATE-STELLA-ASM SYM-IDL-TRANSLATE-STELLA-AUTO
       ...
       SYM-IDL-TRANSLATE-STELLA-CONTINUE SYM-IDL-TRANSLATE-STELLA-DEFAULT
       SYM-IDL-TRANSLATE-STELLA-DELETE SYM-IDL-TRANSLATE-STELLA-DO
       SYM-IDL-TRANSLATE-STELLA-DOUBLE SYM-IDL-TRANSLATE-STELLA-ELSE
       SYM-IDL-TRANSLATE-STELLA-ENUM SYM-IDL-TRANSLATE-STELLA-EXTERN
       SYM-IDL-TRANSLATE-STELLA-FLOAT SYM-IDL-TRANSLATE-STELLA-FOR
       SYM-IDL-TRANSLATE-STELLA-FRIEND SYM-IDL-TRANSLATE-STELLA-GOTO
       SYM-IDL-TRANSLATE-STELLA-IF SYM-IDL-TRANSLATE-STELLA-INLINE
       SYM-IDL-TRANSLATE-STELLA-INT SYM-IDL-TRANSLATE-STELLA-LONG
       SYM-IDL-TRANSLATE-STELLA-NEW SYM-IDL-TRANSLATE-STELLA-OPERATOR
       SYM-IDL-TRANSLATE-STELLA-PRIVATE SYM-IDL-TRANSLATE-STELLA-PROTECTED
       SYM-IDL-TRANSLATE-STELLA-PUBLIC SYM-IDL-TRANSLATE-STELLA-REGISTER
       ...
       SYM-IDL-TRANSLATE-STELLA-SWITCH SYM-IDL-TRANSLATE-STELLA-TEMPLATE
       SYM-IDL-TRANSLATE-STELLA-THROW SYM-IDL-TRANSLATE-STELLA-TRY
       SYM-IDL-TRANSLATE-STELLA-TYPEDEF SYM-IDL-TRANSLATE-STELLA-UNION
       SYM-IDL-TRANSLATE-STELLA-UNSIGNED SYM-IDL-TRANSLATE-STELLA-VIRTUAL
       SYM-IDL-TRANSLATE-STELLA-VOID SYM-IDL-TRANSLATE-STELLA-VOLATILE
       SYM-IDL-TRANSLATE-STELLA-WHILE SYM-IDL-TRANSLATE-STELLA-TYPENAME NIL)))
...
(CL:DEFUN IDL-TRANSLATE-FUNCTION-NAME (FUNCTION)
  (CL:LET*
   ((FUNCTIONNAME (%SLOT-NAME FUNCTION)) (TRANSLATEDNAME STELLA::NULL-STRING))
   ...
   (CL:WHEN (IDL-METHOD-OBJECT-IS-OVERLOADED-FUNCTION? FUNCTION)
    (CL:SETQ FUNCTIONNAME
     (IDL-CREATE-OVERLOADED-FUNCTION-NAME FUNCTIONNAME (%SLOT-OWNER FUNCTION))))
...
(CL:DEFUN IDL-TRANSLATE-METHOD-PARAMETER (NAME TYPE DIRECTION)
  (CL:RETURN-FROM IDL-TRANSLATE-METHOD-PARAMETER
   (CONS (IDL-TRANSLATE-NAME DIRECTION)
    (CONS (IDL-TRANSLATE-TYPE-SPEC TYPE) (CONS (IDL-TRANSLATE-NAME NAME) NIL)))))
    ...
    (CL:LET*
     ...
     (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-000 NIL)) DO
      ...
      (CL:IF (CL:EQ COLLECT-000 NULL)
       ...
       (CL:PROGN
        (CL:SETF (%%REST COLLECT-000) (CONS SYM-IDL-TRANSLATE-STELLA-IN NIL))
        (CL:SETQ COLLECT-000 (%%REST COLLECT-000))))))
    (CL:SETQ DIRECTIONS (REST (METHOD-PARAMETER-DIRECTIONS METHOD))))
   (CL:LET*
    ((DIRECTION NULL) (TYPE NULL) (NAME NULL)
     (ITER-001 (REST (METHOD-PARAMETER-NAMES METHOD)))
    ...
    (CL:LOOP WHILE
     ...
     DO
     (CL:PROGN (CL:SETQ NAME (%%VALUE ITER-001))
      (CL:SETQ ITER-001 (%%REST ITER-001)))
     (CL:PROGN (CL:SETQ TYPE (%%VALUE ITER-002))
      (CL:SETQ ITER-002 (%%REST ITER-002)))
     (CL:PROGN (CL:SETQ DIRECTION (%%VALUE ITER-003))
      (CL:SETQ ITER-003 (%%REST ITER-003)))
     (CL:IF (CL:EQ COLLECT-001 NULL)
      (CL:PROGN
       (CL:SETQ COLLECT-001
        (CONS (IDL-TRANSLATE-METHOD-PARAMETER NAME TYPE DIRECTION) NIL))
...
(CL:DEFUN IDL-TRANSLATE-CONSTRUCTOR-NAME (CONSTRUCTOR)
  (CL:RETURN-FROM IDL-TRANSLATE-CONSTRUCTOR-NAME
   (IDL-TRANSLATE-CLASS-NAME (%SLOT-NAME CONSTRUCTOR))))
  ...
  (CL:LET* ((*MODULE* *STELLA-MODULE*) (*CONTEXT* *MODULE*))
   ...
   (CL:WHEN (CURRENT-STARTUP-TIME-PHASE? 7)
    ...
    (DEFINE-FUNCTION-OBJECT "IDL-TRANSLATE-NULL"
     "(DEFUN (IDL-TRANSLATE-NULL CONS) ())" (CL:FUNCTION IDL-TRANSLATE-NULL)
     NULL)
    ...
    (CL:LET*
     ((FUNCTION
       (LOOKUP-FUNCTION SYM-IDL-TRANSLATE-STELLA-STARTUP-IDL-TRANSLATE)))
     (SET-DYNAMIC-SLOT-VALUE (%DYNAMIC-SLOTS FUNCTION)
      SYM-IDL-TRANSLATE-STELLA-METHOD-STARTUP-CLASSNAME
      (WRAP-STRING "_Startup-Idl-Translate") NULL-STRING-WRAPPER)))
