...
(CL:DECLAIM
  ...
  *CURRENTSYSTEMDEFINITION* *MODULE* FALSE *TRANSLATIONVERBOSITYLEVEL*
  *TRANSLATIONUNITS* *CURRENT-STELLA-FEATURES* EOL *TRANSLATOROUTPUTLANGUAGE*
  TRUE NIL STANDARD-OUTPUT NULL-INTEGER))
   ...
   (CL:LET*
    ...
    (CL:COND
     ((CL:AND DECLARATION? (CONS? TRANSLATION)
      ...
      (CL:LET*
       ((I NULL-INTEGER) (ELT NULL) (ITER-000 (%%REST TRANSLATION)) (ITER-001 1))
...
(CL:DEFUN CL-OUTPUT-ALL-UNITS-TO-FILE (SOURCEFILE)
  (CL:LET*
   ((OUTPUTFILE (MAKE-FILE-NAME SOURCEFILE KWD-CL-TRANSLATE-FILE-LISP FALSE))
...
(CL:DEFUN CL-OUTPUT-ENSURE-PACKAGE-DEFINITION (STREAM PACKAGE)
  ...
  (%%PRINT-STREAM (%NATIVE-STREAM STREAM)
   ...
   "  (CL:UNLESS (CL:FIND-PACKAGE \"" PACKAGE "\")" EOL "     (CL:DEFPACKAGE \""
   PACKAGE "\" (:USE))))" EOL)
  :VOID)
    ...
    (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-001 NIL)) DO
     ...
     (CL:WHEN (CL:NOT (AUXILIARY-VARIABLE-UNIT? UNIT))
      (CL:WHEN
       ...
       (PUSH DEFINEDVARIABLES (%THE-OBJECT UNIT)))
      (CL:LET*
       ((VARIABLE NULL) (ITER-002 (%THE-CONS-LIST (%REFERENCED-GLOBALS UNIT))))
       (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-002 NIL)) DO
    ...
    (PRINT-STELLA-DEFINITION
     (LIST* (INTERN-COMMON-LISP-SYMBOL "DECLAIM")
      (CONS (INTERN-COMMON-LISP-SYMBOL "SPECIAL")
       (CONCATENATE
        (CL-TRANSLATE-LIST-OF-TREES (%THE-CONS-LIST FORWARDREFERENCEDVARIABLES))
        NIL))
      NIL)
     STREAM))
...
(CL:DEFUN SORT-CL-STRUCT-CLASSES (UNSORTEDCLASSES)
  (CL:LET* ((CLASSTABLE (NEW-HASH-TABLE)) (ROOTS (LIST)) (SORTEDCLASSES (LIST)))
   ...
   (CL:LET*
    ((CLASS NULL) (ITER-001 (%THE-CONS-LIST UNSORTEDCLASSES)) (COLLECT-000 NULL))
    (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-001 NIL)) DO
     ...
     (CL:LET* ((TEST-VALUE-000 FALSE))
      (CL:LET* ((FOUND?-000 FALSE))
       (CL:LET*
        ((SUPER NULL) (ITER-002 (%THE-CONS-LIST (%CLASS-DIRECT-SUPERS CLASS))))
        (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-002 NIL)) DO
    ...
    (CL:LET*
     ...
     (CL:LOOP WHILE
      ...
      (CL:WHEN (CL:NOT (CL:EQ *MODULE* CURRENTMODULE))
       (CL:SETQ CURRENTMODULE *MODULE*) (CL:SETQ PACKAGE (LISP-PACKAGE *MODULE*))
...
(CL:DEFUN CL-COMPILE-AND-LOAD-FILES (FILES RELATIVE? FORCERECOMPILATION?)
  (CL:LET*
   ((LISPKEY KWD-CL-TRANSLATE-FILE-LISP)
    (BINARYKEY KWD-CL-TRANSLATE-FILE-LISP-BINARY) (TRANSLATEDFILE? FALSE))
  ...
  (CL:LET* ((*MODULE* *STELLA-MODULE*) (*CONTEXT* *MODULE*))
   ...
   (CL:WHEN (CURRENT-STARTUP-TIME-PHASE? 7)
    ...
    (DEFINE-FUNCTION-OBJECT "HELP-LPTRANS"
     "(DEFUN HELP-LPTRANS ((STATEMENT OBJECT)))" (CL:FUNCTION HELP-LPTRANS) NULL)
...
`relative?', concatenate root directory to `file'.\" :PUBLIC? TRUE)"
    ...
    (CL:LET*
     ((FUNCTION
       (LOOKUP-FUNCTION SYM-CL-TRANSLATE-FILE-STELLA-STARTUP-CL-TRANSLATE-FILE)))
     (SET-DYNAMIC-SLOT-VALUE (%DYNAMIC-SLOTS FUNCTION)
      SYM-CL-TRANSLATE-FILE-STELLA-METHOD-STARTUP-CLASSNAME
      (WRAP-STRING "_Startup-Cl-Translate-File") NULL-STRING-WRAPPER)))
