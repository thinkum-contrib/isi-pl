...
(CL:DECLAIM
 (CL:SPECIAL *STELLA-MODULE* *MODULE* *TRANSLATOROUTPUTLANGUAGE* FALSE
  *METHODBEINGWALKED* TRUE NIL NULL-STRING-WRAPPER))
...
(CL:DEFUN CPP-YIELD-MEMBER-VAR-TREE (SLOT CLASS)
  (CL:LET*
   ...
   (CL:COND
    ((CL:EQ ALLOCATION KWD-CPP-CLASS-OUT-EMBEDDED) (CL:SETQ ALLOCATIONFORM NIL))
  ...
  (CL:LET*
   ...
   (CL:RETURN-FROM CPP-YIELD-PARAMETERIZED-MEMBER-VAR-TREE
    (LIST*
     (CONCATENATE ALLOCATIONFORM
      (CONS
       (CPP-TRANSLATE-CLASS-PARAMETER-NAME (GET-SLOT-CLASS-PARAMETER-NAME SLOT))
       NIL))
...
(CL:DEFUN CPP-YIELD-STATIC-MEMBER-ALLOCATION-TREE (SLOT CLASS)
  (CL:LET*
   ((SLOTNAME (%SLOT-NAME SLOT)) (ALLOCATIONFORM NIL) (MOSTGENERALSLOT NULL))
   ...
   (CL:LET* ((SUPER VALUE-000))
    (CL:RETURN-FROM CPP-YIELD-EXCEPTION-CONSTRUCTOR-DEFINITION
     (LIST* SYM-CPP-CLASS-OUT-STELLA-CPP_FUNCTION NIL
      ...
      (LIST*
       (CONS (LIST* (WRAP-STRING "const std::string&") (WRAP-STRING "msg") NIL)
        NIL)
       NIL
       (CONS
        (LIST* SYM-CPP-CLASS-OUT-STELLA-CPP_FUNCTION_CALL
         ...
         (LIST* SYM-CPP-CLASS-OUT-STELLA-CPP_ACTUALS
          (LIST* SYM-CPP-CLASS-OUT-STELLA-CPP_IDENT (WRAP-STRING "msg") NIL) NIL)
         NIL)
        NIL)
       NIL))))))
     ...
     (CL:WHEN
      ...
      (CL:IF (%SLOT-PUBLIC? SLOT)
       ...
       (CL:SETQ PROTECTEDMEMBERVARDEFS
        (CONS (CPP-YIELD-MEMBER-VAR-TREE SLOT CLASS) PROTECTEDMEMBERVARDEFS))))))
   ...
   (CL:LET* ((SLOT NULL) (ITER-000 (%THE-CONS-LIST (%CLASS-LOCAL-SLOTS CLASS))))
    (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-000 NIL)) DO
     ...
     (CL:COND
       ...
       (CL:PROGN
        (CL:WHEN
         (CL:AND (CL:NOT (%SLOT-MARKED? SLOT)) (NATIVE-METHOD? SLOT)
          (CL:NOT (CPP-CONSTRUCTOR? SLOT)) (CL:NOT (CPP-NATIVE-METHOD? SLOT)))
         (CL:IF (%SLOT-PUBLIC? SLOT)
      ...
      (CL:T))))
   (CL:LET*
    ((METHOD NULL) (ITER-001 (%THE-CONS-LIST (CLASS-AUXILIARY-METHODS CLASS))))
    (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-001 NIL)) DO
     (CL:PROGN (CL:SETQ METHOD (%%VALUE ITER-001))
      (CL:SETQ ITER-001 (%%REST ITER-001)))
     (CL:IF (%SLOT-PUBLIC? METHOD)
      (CL:SETQ PUBLICMEMBERFUNCDEFS
       (CONS (CPP-YIELD-MEMBER-FUNC-SIGNATURE-TREE METHOD) PUBLICMEMBERFUNCDEFS))
      (CL:SETQ PROTECTEDMEMBERFUNCDEFS
   ...
   (CL:LOOP WHILE (NEXT? ITER-001) DO (CL:SETQ SLOT (%VALUE ITER-001))
    (CL:WHEN (CL:NOT (%SLOT-MARKED? SLOT))
     (CL:WHEN
      ...
      (MARK-DIRECT-EQUIVALENT-SLOT SLOT) (CL:SETF (%SLOT-MARKED? SLOT) FALSE)))))
  :VOID)
       ...
       (CL:EQ
        (%WRAPPER-VALUE
         (DYNAMIC-SLOT-VALUE (%DYNAMIC-SLOTS SUPER)
          SYM-CPP-CLASS-OUT-STELLA-CLASS-CPP-NATIVE-TYPE NULL-STRING-WRAPPER))
        STELLA::NULL-STRING))
...
(CL:DEFUN CPP-TRANSLATE-DEFINE-NATIVE-CLASS-UNIT (UNIT)
  (CL:LET*
   ((CLASS (%THE-OBJECT UNIT)) (BASECLASSES NIL) (PARAMETERIZEDMEMBERVARDEFS NIL)
    (PUBLICMEMBERVARDEFS NIL) (PROTECTEDMEMBERVARDEFS NIL)
    (PUBLICMEMBERFUNCDEFS NIL) (PROTECTEDMEMBERFUNCDEFS NIL)
    (CONSTRUCTORDEFS NIL) (PARAMETERS NIL) (STATICMEMBERVARDEFS NIL))
   (CL:LET*
    ((SUPER NULL) (ITER-000 (%THE-CONS-LIST (CLASS-NATIVE-SUPERS CLASS)))
     (COLLECT-000 NULL))
    (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-000 NIL)) DO
     ...
     (CL:WHEN
      ...
      (CL:IF (CL:EQ COLLECT-000 NULL)
       (CL:PROGN
        (CL:SETQ COLLECT-000 (CONS (CPP-TRANSLATE-CLASS-NAME SUPER) NIL))
   ...
   (CL:WHEN
    (CL:AND
     (CL:OR (CL:EQ BASECLASSES NIL) (CPP-CLASS-HAS-ONLY-NATIVE-PARENTS? CLASS))
     (CL:NOT (%MIXIN? CLASS))
              ...
              (CL:IF (EXCEPTION-CLASS? CLASS)
               (CONS
                (LIST* SYM-CPP-CLASS-OUT-STELLA-CPP_DEFINITIONS
                 ...
                 (CONS (CPP-YIELD-EXCEPTION-CONSTRUCTOR-DEFINITION CLASS) NIL)
                 NIL)
                NIL)
               NIL)
              (CONCATENATE
   ...
   (CL:WHEN (CURRENT-STARTUP-TIME-PHASE? 7)
    ...
    (CL:LET*
     ...
     (SET-DYNAMIC-SLOT-VALUE (%DYNAMIC-SLOTS FUNCTION)
      ...
      (WRAP-STRING "_Startup-Cpp-Class-Out") NULL-STRING-WRAPPER)))
