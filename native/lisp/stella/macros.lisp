...
(CL:DECLAIM
 (CL:SPECIAL *STELLA-MODULE* *MODULE* *CURRENTSYSTEMDEFINITION* *METHODBEINGWALKED* *CURRENT-STELLA-FEATURES*
...
(CL:DEFUN PUSHQ (VARIABLE VALUE)
  ...
  (CL:RETURN-FROM PUSHQ
   (LIST* SYM-MACROS-STELLA-SETQ VARIABLE (CONS (LIST* SYM-MACROS-STELLA-CONS VALUE (CONS VARIABLE NIL)) NIL))))
...
(CL:DEFUN PUSHF (PLACE VALUE)
  ...
  (CL:LET* ((PLACECOPY (COPY-CONS-TREE PLACE)))
   (CL:RETURN-FROM PUSHF
    (LIST* SYM-MACROS-STELLA-SETF PLACE (CONS (LIST* SYM-MACROS-STELLA-CONS VALUE (CONS PLACECOPY NIL)) NIL)))))
  ...
  (CL:LET* ((INCR (%%VALUE INCREMENT)))
   (CL:WHEN (CL:NOT (CL:OR (SYMBOL? PLACE) (CONS? PLACE)))
    (CL:IF (CL:EQ PLACE NULL)
     ...
     (CL:LET* ((*PRINTREADABLY?* CL:T)) (CL:DECLARE (CL:SPECIAL *PRINTREADABLY?*)) (SIGNAL-TRANSLATION-ERROR)
      (CL:WHEN (CL:NOT (SUPPRESS-WARNINGS?)) (PRINT-ERROR-CONTEXT ">> ERROR: " STANDARD-ERROR)
       (%%PRINT-STREAM (%NATIVE-STREAM STANDARD-ERROR) EOL " Illegal place in `++' expression: `"
        (DE-UGLIFY-PARSE-TREE PLACE) "'." EOL))))
    (CL:RETURN-FROM ++ NIL))
   (CL:WHEN (CL:EQ INCR NULL) (CL:SETQ INCR ONE-WRAPPER))
   (CL:RETURN-FROM ++
    (CL:IF (SYMBOL? PLACE)
     (LIST* SYM-MACROS-STELLA-SETQ PLACE (CONS (LIST* SYM-MACROS-STELLA-+ PLACE (CONS INCR NIL)) NIL))
     (LIST* SYM-MACROS-STELLA-SETF PLACE
      (CONS (LIST* SYM-MACROS-STELLA-+ (COPY-CONS-TREE PLACE) (CONS INCR NIL)) NIL))))))
...
the optional `decrement' (which can be a float) or 1 otherwise."
  (CL:LET* ((DECR (%%VALUE DECREMENT)))
   ...
   (CL:RETURN-FROM --
    (CL:IF (SYMBOL? PLACE)
     (LIST* SYM-MACROS-STELLA-SETQ PLACE (CONS (LIST* SYM-MACROS-STELLA-- PLACE (CONS DECR NIL)) NIL))
     (LIST* SYM-MACROS-STELLA-SETF PLACE
      (CONS (LIST* SYM-MACROS-STELLA-- (COPY-CONS-TREE PLACE) (CONS DECR NIL)) NIL))))))
...
and return TRUE if 'expression' is not NULL else return FALSE."
  (CL:RETURN-FROM SETQ?
   (LIST* SYM-MACROS-STELLA-VRLET NIL (LIST* SYM-MACROS-STELLA-SETQ VARIABLE (CONS EXPRESSION NIL))
...
or NULL otherwise."
  (CL:CASE (LENGTH FORMS) (0 (CL:RETURN-FROM FIRST-DEFINED SYM-MACROS-STELLA-NULL))
   (1 (CL:RETURN-FROM FIRST-DEFINED (%%VALUE FORMS)))
   (2
    (CL:IF (SYMBOL? (%%VALUE FORMS))
     (CL:RETURN-FROM FIRST-DEFINED
      (LIST* SYM-MACROS-STELLA-CHOOSE (LIST* SYM-MACROS-STELLA-DEFINED? (%%VALUE FORMS) NIL) (%%VALUE FORMS)
     ...
     (CL:LET* ((LETVARIABLE (LOCAL-GENSYM "TEMP")))
      (CL:RETURN-FROM FIRST-DEFINED
       (LIST* SYM-MACROS-STELLA-VRLET (CONS (CONS LETVARIABLE (CONS (%%VALUE FORMS) NIL)) NIL)
        (LIST* SYM-MACROS-STELLA-CHOOSE (LIST* SYM-MACROS-STELLA-DEFINED? LETVARIABLE NIL) LETVARIABLE
         (CONS (%%VALUE (%%REST FORMS)) NIL))
        NIL)))))
   (CL:OTHERWISE
    (CL:RETURN-FROM FIRST-DEFINED
     (LIST* SYM-MACROS-STELLA-FIRST-DEFINED (%%VALUE FORMS)
      (CONS (CONS SYM-MACROS-STELLA-FIRST-DEFINED (CONCATENATE (%%REST FORMS) NIL)) NIL))))))
     ...
     (CL:LET* ((F NULL) (ITER-000 FORMS) (COLLECT-000 NULL))
      (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-000 NIL)) DO (CL:SETQ F (%%VALUE ITER-000))
       (CL:IF (CL:EQ COLLECT-000 NULL)
        ...
        (CL:PROGN (CL:SETF (%%REST COLLECT-000) (CONS (LIST* SYM-MACROS-STELLA-DEFINED? F NIL) NIL))
     ...
     (LIST* SYM-MACROS-STELLA-VRLET (CONS (CONS COLLECTION (CONS SYM-MACROS-STELLA-NIL NIL)) NIL)
      (CONS SYM-MACROS-STELLA-FOREACH
       (CONCATENATE (%%REST (%%REST BODY))
        (LIST* SYM-MACROS-STELLA-COLLECT (%%VALUE BODY) (LIST* SYM-MACROS-STELLA-INTO COLLECTION NIL))))
      COLLECTION NIL))
    (CL:RETURN-FROM COLLECT
     (LIST* SYM-MACROS-STELLA-VRLET (CONS (CONS COLLECTION (CONS SYM-MACROS-STELLA-NIL NIL)) NIL)
...
objects within the scope of this declaration."
  (CL:RETURN-FROM WITH-PERMANENT-OBJECTS
   (LIST* SYM-MACROS-STELLA-SPECIAL
    (CONS (LIST* SYM-MACROS-STELLA-*TRANSIENTOBJECTS?* SYM-MACROS-STELLA-FALSE NIL) NIL) (CONCATENATE BODY NIL))))
...
account for transient objects will continue to work correctly."
  (CL:RETURN-FROM WITH-TRANSIENT-OBJECTS
   (LIST* SYM-MACROS-STELLA-SPECIAL (CONS (LIST* SYM-MACROS-STELLA-*TRANSIENTOBJECTS?* SYM-MACROS-STELLA-TRUE NIL) NIL)
   ...
   (CL:LET* ((VARIABLE NULL) (ITER-000 VARIABLES) (COLLECT-000 NULL))
    (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-000 NIL)) DO (CL:SETQ VARIABLE (%%VALUE ITER-000))
     (CL:IF (CL:EQ COLLECT-000 NULL)
      ...
      (CL:PROGN (CL:SETF (%%REST COLLECT-000) (CONS (LIST* SYM-MACROS-STELLA-SETQ VARIABLE (CONS VARIABLE NIL)) NIL))
       (CL:SETQ COLLECT-000 (%%REST COLLECT-000))))
     (CL:SETQ ITER-000 (%%REST ITER-000))))
...
be used to conditionally translate Stella code."
  (CL:IF (CL:EQ LANGUAGE *TRANSLATOROUTPUTLANGUAGE*)
   (CL:RETURN-FROM IF-OUTPUT-LANGUAGE (CL:IF (CL:EQ THENFORM SYM-MACROS-STELLA-NULL) NULL THENFORM))
...
be used to conditionally translate Stella code."
  (CL:IF (MEMB? *CURRENT-STELLA-FEATURES* FEATURE)
   (CL:RETURN-FROM IF-STELLA-FEATURE (CL:IF (CL:EQ THENFORM SYM-MACROS-STELLA-NULL) NULL THENFORM))
    ...
    (LIST* SYM-MACROS-STELLA-SAFETY (WRAP-INTEGER 3)
     (LIST* SYM-MACROS-STELLA-EQL?
      (LIST* SYM-MACROS-STELLA-BASE-MODULE
       (LIST* SYM-MACROS-STELLA-CAST SYM-MACROS-STELLA-*CONTEXT* SYM-MACROS-STELLA-WORLD NIL) NIL)
      SYM-MACROS-STELLA-*MODULE* NIL)
     (WRAP-STRING "within-world: The base module of world ") SYM-MACROS-STELLA-*CONTEXT*
  ...
  (CL:RETURN-FROM WITHIN-MODULE
   (LIST* SYM-MACROS-STELLA-SPECIAL
    (LIST* (LIST* SYM-MACROS-STELLA-*MODULE* MODULEFORM NIL)
     (LIST* SYM-MACROS-STELLA-*CONTEXT* SYM-MACROS-STELLA-*MODULE* NIL) NIL)
    (CONCATENATE BODY NIL))))
...
`restVariable' already is a CONS due to argument listification, this is a no-op."
  (CL:IF (PASS-VARIABLE-ARGUMENTS-AS-LIST? *METHODBEINGWALKED*)
   (CL:RETURN-FROM |COERCE-&REST-TO-CONS|
    (SYS-TREE (WALK-WITHOUT-TYPE-TREE RESTVARIABLE) (YIELD-LISTIFIED-VARIABLE-ARGUMENTS-TYPE *METHODBEINGWALKED*)))
   (CL:LET* ((ARGVAR (LOCAL-GENSYM "ARG")) (LISTVAR (LOCAL-GENSYM "ARGLIST")))
    (CL:RETURN-FROM |COERCE-&REST-TO-CONS|
     (LIST* SYM-MACROS-STELLA-VRLET
      (CONS
       (CONS LISTVAR
        (CONS (YIELD-LISTIFIED-VARIABLE-ARGUMENTS-TYPE *METHODBEINGWALKED*) (CONS SYM-MACROS-STELLA-NIL NIL)))
       NIL)
      (LIST* SYM-MACROS-STELLA-FOREACH ARGVAR
       (LIST* SYM-MACROS-STELLA-IN RESTVARIABLE
        (LIST* SYM-MACROS-STELLA-COLLECT ARGVAR (LIST* SYM-MACROS-STELLA-INTO LISTVAR NIL))))
      LISTVAR NIL)))))
   ...
   (LIST* SYM-MACROS-STELLA-SPECIAL
    (LIST*
     (LIST* SYM-MACROS-STELLA-*CURRENTSYSTEMDEFINITION*
      (LIST* SYM-MACROS-STELLA-GET-SYSTEM-DEFINITION SYSTEMNAMEEXPRESSION NIL) NIL)
     (LIST* SYM-MACROS-STELLA-*CURRENTSYSTEMDEFINITIONSUBDIRECTORY*
      (LIST* SYM-MACROS-STELLA-ONLY-IF
       (LIST* SYM-MACROS-STELLA-DEFINED? SYM-MACROS-STELLA-*CURRENTSYSTEMDEFINITION* NIL)
       (LIST* SYM-MACROS-STELLA-DIRECTORY SYM-MACROS-STELLA-*CURRENTSYSTEMDEFINITION* NIL) NIL)
      NIL)
     NIL)
    (LIST* SYM-MACROS-STELLA-IF (LIST* SYM-MACROS-STELLA-DEFINED? SYM-MACROS-STELLA-*CURRENTSYSTEMDEFINITION* NIL)
     (CONS SYM-MACROS-STELLA-PROGN (CONCATENATE BODY NIL))
     (LIST* SYM-MACROS-STELLA-WARN (WRAP-STRING "Can't find a system named ") SYSTEMNAMEEXPRESSION
  ...
  (CL:LET*
   ...
   (CL:LET* ((SELF-000 (NEW-PROPERTY-LIST))) (CL:SETF (%THE-PLIST SELF-000) (EXTRACT-OPTIONS BODYWITHHEADER NULL))
    (CL:LET*
      ...
      (STARTUPFUNCTIONCALL
       (CL:IF
        (CL:AND (CL:NOT (CL:EQ *CURRENTSYSTEMDEFINITION* NULL))
         (CL:NOT (CL:EQ (LOOKUP OPTIONS KWD-MACROS-STARTUP-SYSTEM?) SYM-MACROS-STELLA-FALSE)))
     ...
     (REMOVE-AT OPTIONS KWD-MACROS-STARTUP-SYSTEM?) (REMOVE-AT OPTIONS KWD-MACROS-PUBLIC?)
     (CL:SETQ BODY (CONCATENATE (%THE-PLIST OPTIONS) (%%REST BODYWITHHEADER)))
     (CL:COND
      ((CL:NOT PROCESSCMDLINEARGS?)
       (CL:COND
        ...
        ((CL:OR (CL:EQ *TRANSLATOROUTPUTLANGUAGE* KWD-MACROS-CPP)
         ...
         (CL:RETURN-FROM %DEFMAIN
          (LIST* SYM-MACROS-STELLA-DEFUN (CONS MAINNAME (CONS SYM-MACROS-STELLA-INTEGER NIL)) NIL KWD-MACROS-PUBLIC?
           SYM-MACROS-STELLA-TRUE
           (CONCATENATE STARTUPFUNCTIONCALL
            (CONCATENATE BODY (CONS (LIST* SYM-MACROS-STELLA-RETURN (WRAP-INTEGER 1) NIL) NIL))))))
           ...
           (LIST*
            (CONS
             (CONS (LOCAL-GENSYM "ARGV")
              (CONS (LIST* SYM-MACROS-STELLA-ARRAY NIL SYM-MACROS-STELLA-OF SYM-MACROS-STELLA-STRING NIL) NIL))
             NIL)
      ...
      (CL:T
       (CL:COND
        ((CL:EQ *TRANSLATOROUTPUTLANGUAGE* KWD-MACROS-COMMON-LISP)
         (CL:RETURN-FROM %DEFMAIN
          (LIST* SYM-MACROS-STELLA-DEFUN MAINNAME
           (LIST* (LIST* |SYM-MACROS-STELLA-&REST| (LIST* SYM-MACROS-STELLA-%%ARGS SYM-MACROS-STELLA-STRING NIL) NIL)
              ...
              (CONS V1NAME
               (LIST* SYM-MACROS-STELLA-INTEGER
                (LIST* SYM-MACROS-STELLA-VERBATIM KWD-MACROS-COMMON-LISP
                 (LIST* (INTERN-COMMON-LISP-SYMBOL "LENGTH") SYM-MACROS-STELLA-%%ARGS NIL) NIL)
                NIL))
              (CONS V2NAME
               (LIST* (LIST* SYM-MACROS-STELLA-ARRAY NIL SYM-MACROS-STELLA-OF SYM-MACROS-STELLA-STRING NIL)
                (LIST* SYM-MACROS-STELLA-VERBATIM KWD-MACROS-COMMON-LISP
                 (LIST* (INTERN-COMMON-LISP-SYMBOL "MAKE-ARRAY")
                  (LIST* (INTERN-COMMON-LISP-SYMBOL "LENGTH") SYM-MACROS-STELLA-%%ARGS NIL) KWD-MACROS-INITIAL-CONTENTS
              ...
              (CONS V1NAME
               (LIST* SYM-MACROS-STELLA-INTEGER
                (LIST* SYM-MACROS-STELLA-VERBATIM KWD-MACROS-JAVA
                 (WRAP-STRING (CONCATENATE (%WRAPPER-VALUE (JAVA-TRANSLATE-NAME V2NAME)) ".length")) NIL)
                NIL))
              NIL)
             (CONCATENATE STARTUPFUNCTIONCALL (CONCATENATE BODY NIL)))
            NIL))))
     ...
     (CL:LET* ((*PRINTREADABLY?* CL:T)) (CL:DECLARE (CL:SPECIAL *PRINTREADABLY?*)) (SIGNAL-TRANSLATION-ERROR)
      (CL:WHEN (CL:NOT (SUPPRESS-WARNINGS?)) (PRINT-ERROR-CONTEXT ">> ERROR: " STANDARD-ERROR)
       (%%PRINT-STREAM (%NATIVE-STREAM STANDARD-ERROR) EOL " `defmain' is not supported for `"
...
(CL:DEFUN HELP-STARTUP-MACROS1 ()
  (CL:PROGN (CL:SETQ SYM-MACROS-STELLA-SETQ (INTERN-RIGID-SYMBOL-WRT-MODULE "SETQ" NULL 0))
   (CL:SETQ SYM-MACROS-STELLA-CONS (INTERN-RIGID-SYMBOL-WRT-MODULE "CONS" NULL 0))
   (CL:SETQ SYM-MACROS-STELLA-VRLET (INTERN-RIGID-SYMBOL-WRT-MODULE "VRLET" NULL 0))
   (CL:SETQ SYM-MACROS-STELLA-VALUE (INTERN-RIGID-SYMBOL-WRT-MODULE "VALUE" NULL 0))
   (CL:SETQ SYM-MACROS-STELLA-REST (INTERN-RIGID-SYMBOL-WRT-MODULE "REST" NULL 0))
   (CL:SETQ SYM-MACROS-STELLA-SETF (INTERN-RIGID-SYMBOL-WRT-MODULE "SETF" NULL 0))
   (CL:SETQ SYM-MACROS-STELLA-CHOOSE (INTERN-RIGID-SYMBOL-WRT-MODULE "CHOOSE" NULL 0))
   (CL:SETQ SYM-MACROS-STELLA-MEMBER? (INTERN-RIGID-SYMBOL-WRT-MODULE "MEMBER?" NULL 0))
   (CL:SETQ SYM-MACROS-STELLA-+ (INTERN-RIGID-SYMBOL-WRT-MODULE "+" NULL 0))
   (CL:SETQ SYM-MACROS-STELLA--- (INTERN-RIGID-SYMBOL-WRT-MODULE "--" NULL 0))
   (CL:SETQ KWD-MACROS-JAVA (INTERN-RIGID-SYMBOL-WRT-MODULE "JAVA" NULL 2))
   (CL:SETQ KWD-MACROS-FUNCTION (INTERN-RIGID-SYMBOL-WRT-MODULE "FUNCTION" NULL 2))
   (CL:SETQ SYM-MACROS-STELLA-- (INTERN-RIGID-SYMBOL-WRT-MODULE "-" NULL 0))
   ...
   (CL:SETQ SYM-MACROS-STELLA-TRUE (INTERN-RIGID-SYMBOL-WRT-MODULE "TRUE" NULL 0))
   (CL:SETQ SYM-MACROS-STELLA-AND (INTERN-RIGID-SYMBOL-WRT-MODULE "AND" NULL 0))
   (CL:SETQ SYM-MACROS-STELLA-FOREACH (INTERN-RIGID-SYMBOL-WRT-MODULE "FOREACH" NULL 0))
   (CL:SETQ SYM-MACROS-STELLA-NIL (INTERN-RIGID-SYMBOL-WRT-MODULE "NIL" NULL 0))
   (CL:SETQ SYM-MACROS-STELLA-COLLECT (INTERN-RIGID-SYMBOL-WRT-MODULE "COLLECT" NULL 0))
   (CL:SETQ SYM-MACROS-STELLA-INTO (INTERN-RIGID-SYMBOL-WRT-MODULE "INTO" NULL 0))
   ...
   (CL:SETQ SYM-MACROS-STELLA-SAFETY (INTERN-RIGID-SYMBOL-WRT-MODULE "SAFETY" NULL 0))
   (CL:SETQ SYM-MACROS-STELLA-EQL? (INTERN-RIGID-SYMBOL-WRT-MODULE "EQL?" NULL 0))
   (CL:SETQ SYM-MACROS-STELLA-BASE-MODULE (INTERN-RIGID-SYMBOL-WRT-MODULE "BASE-MODULE" NULL 0))
   (CL:SETQ SYM-MACROS-STELLA-CAST (INTERN-RIGID-SYMBOL-WRT-MODULE "CAST" NULL 0))
   (CL:SETQ SYM-MACROS-STELLA-WORLD (INTERN-RIGID-SYMBOL-WRT-MODULE "WORLD" NULL 0))
   (CL:SETQ SYM-MACROS-STELLA-*MODULE* (INTERN-RIGID-SYMBOL-WRT-MODULE "*MODULE*" NULL 0))
   (CL:SETQ SYM-MACROS-STELLA-IN (INTERN-RIGID-SYMBOL-WRT-MODULE "IN" NULL 0))
   ...
   (CL:SETQ SYM-MACROS-STELLA-*CURRENTSYSTEMDEFINITIONSUBDIRECTORY*
    (INTERN-RIGID-SYMBOL-WRT-MODULE "*CURRENTSYSTEMDEFINITIONSUBDIRECTORY*" NULL 0))
   (CL:SETQ SYM-MACROS-STELLA-ONLY-IF (INTERN-RIGID-SYMBOL-WRT-MODULE "ONLY-IF" NULL 0))
   (CL:SETQ SYM-MACROS-STELLA-DIRECTORY (INTERN-RIGID-SYMBOL-WRT-MODULE "DIRECTORY" NULL 0))
   (CL:SETQ SYM-MACROS-STELLA-IF (INTERN-RIGID-SYMBOL-WRT-MODULE "IF" NULL 0))
   (CL:SETQ SYM-MACROS-STELLA-PROGN (INTERN-RIGID-SYMBOL-WRT-MODULE "PROGN" NULL 0))
   (CL:SETQ SYM-MACROS-STELLA-WARN (INTERN-RIGID-SYMBOL-WRT-MODULE "WARN" NULL 0))
   ...
   (CL:SETQ SYM-MACROS-STELLA-VERBATIM (INTERN-RIGID-SYMBOL-WRT-MODULE "VERBATIM" NULL 0))
   (CL:SETQ KWD-MACROS-CPP (INTERN-RIGID-SYMBOL-WRT-MODULE "CPP" NULL 2))
   (CL:SETQ KWD-MACROS-OTHERWISE (INTERN-RIGID-SYMBOL-WRT-MODULE "OTHERWISE" NULL 2))
   (CL:SETQ KWD-MACROS-PUBLIC? (INTERN-RIGID-SYMBOL-WRT-MODULE "PUBLIC?" NULL 2))
   ...
   (CL:SETQ KWD-MACROS-CPP-STANDALONE (INTERN-RIGID-SYMBOL-WRT-MODULE "CPP-STANDALONE" NULL 2))
   ...
   (CL:SETQ SYM-MACROS-STELLA-RETURN (INTERN-RIGID-SYMBOL-WRT-MODULE "RETURN" NULL 0))
   (CL:SETQ SYM-MACROS-STELLA-ARRAY (INTERN-RIGID-SYMBOL-WRT-MODULE "ARRAY" NULL 0))
   (CL:SETQ SYM-MACROS-STELLA-OF (INTERN-RIGID-SYMBOL-WRT-MODULE "OF" NULL 0))
   (CL:SETQ SYM-MACROS-STELLA-STRING (INTERN-RIGID-SYMBOL-WRT-MODULE "STRING" NULL 0))
   (CL:SETQ |SYM-MACROS-STELLA-&REST| (INTERN-RIGID-SYMBOL-WRT-MODULE "&REST" NULL 0))
...
(CL:DEFUN STARTUP-MACROS ()
  (CL:LET* ((*MODULE* *STELLA-MODULE*) (*CONTEXT* *MODULE*)) (CL:DECLARE (CL:SPECIAL *MODULE* *CONTEXT*))
   (CL:WHEN (CURRENT-STARTUP-TIME-PHASE? 2) (HELP-STARTUP-MACROS1)
    (CL:SETQ SYM-MACROS-STELLA-LET (INTERN-RIGID-SYMBOL-WRT-MODULE "LET" NULL 0))
...
The scope of `with-transient-objects' should be as small as possible, and
the user has to make sure that code that wasn't explicitly written to
account for transient objects will continue to work correctly.\" :PUBLIC? TRUE)" (CL:FUNCTION WITH-TRANSIENT-OBJECTS)
     NULL)
...
`*module*' is an acceptable `moduleForm'.  It will locally rebind 
`*module*' and `*context*' and shield the outer bindings from changes.\" :PUBLIC? TRUE)" (CL:FUNCTION WITHIN-MODULE)
     NULL)
...
FALSE.  There can only be one DEFMAIN per module.\" :PUBLIC? TRUE :LISP-MACRO? TRUE)" (CL:FUNCTION %DEFMAIN) NULL)
    (DEFINE-FUNCTION-OBJECT "STARTUP-MACROS" "(DEFUN STARTUP-MACROS () :PUBLIC? TRUE)" (CL:FUNCTION STARTUP-MACROS)
     NULL)
    (CL:LET* ((FUNCTION (LOOKUP-FUNCTION SYM-MACROS-STELLA-STARTUP-MACROS)))
     (SET-DYNAMIC-SLOT-VALUE (%DYNAMIC-SLOTS FUNCTION) SYM-MACROS-STELLA-METHOD-STARTUP-CLASSNAME
