...
(CL:DECLAIM
 (CL:SPECIAL *STELLA-MODULE* *MODULE* NULL-LONG-INTEGER *PRINTREADABLY?* *HARDWIRED-CLASS-ARITY-ON-CLASS*
  *JAVA-STELLA-PACKAGE-MAPPING* NULL-STRING-WRAPPER NIL-LIST *HARDWIRED-TRANSIENT?-ON-TRANSIENT-MIXIN* *CONTEXT*
  NULL-FLOAT NULL-CHARACTER NIL TRUE-WRAPPER FALSE-WRAPPER NULL-INTEGER))
...
(CL:DEFUN ACCESS-REFERENCE-COUNT-OBJECT-SLOT-VALUE (SELF SLOTNAME VALUE SETVALUE?)
  (CL:COND
   ((CL:EQ SLOTNAME SYM-HIERARCHY-STELLA-REFERENCE-COUNT)
    (CL:IF SETVALUE? (CL:SETF (%REFERENCE-COUNT SELF) (%WRAPPER-VALUE VALUE))
...
(CL:DEFMETHOD HOME-MODULE ((SELF CONTEXT-SENSITIVE-OBJECT))
  (CL:LET* ((CONTEXT (%HOME-CONTEXT SELF)))
   (CL:IF (CL:NOT (CL:EQ CONTEXT NULL)) (CL:RETURN-FROM HOME-MODULE (%BASE-MODULE CONTEXT))
    (CL:RETURN-FROM HOME-MODULE NULL))))
...
(CL:DEFMETHOD DELETED? ((SELF ACTIVE-OBJECT))
  (CL:LET* ((DELETED? (DYNAMIC-SLOT-VALUE (%DYNAMIC-SLOTS SELF) SYM-HIERARCHY-STELLA-DELETED-OBJECT? NULL)))
   (CL:IF (CL:NOT (CL:EQ DELETED? NULL)) (CL:RETURN-FROM DELETED? (COERCE-WRAPPED-BOOLEAN-TO-BOOLEAN DELETED?))
    (CL:RETURN-FROM DELETED? CL:NIL))))

(CL:DEFMETHOD DELETED?-SETTER ((SELF ACTIVE-OBJECT) VALUE)
  (SET-DYNAMIC-SLOT-VALUE (%DYNAMIC-SLOTS SELF) SYM-HIERARCHY-STELLA-DELETED-OBJECT?
...
(CL:DEFUN NEW-CONS-ITERATOR ()
  (CL:LET* ((SELF NULL)) (CL:SETQ SELF (CL:MAKE-INSTANCE (CL:QUOTE CONS-ITERATOR)))
   (CL:SETF (%FIRST-ITERATION? SELF) CL:T) (CL:SETF (%VALUE SELF) NULL) (CL:SETF (%CONS-ITERATOR-CURSOR SELF) NULL)
...
(CL:DEFCLASS LIST-ITERATOR (ITERATOR)
  ((LIST-ITERATOR-CURSOR :ALLOCATION :INSTANCE :ACCESSOR %LIST-ITERATOR-CURSOR)
   (LIST-ITERATOR-COLLECTION :ALLOCATION :INSTANCE :ACCESSOR %LIST-ITERATOR-COLLECTION))
  (:DOCUMENTATION "Iterator class for the collection LIST."))

(CL:DEFUN NEW-LIST-ITERATOR ()
  (CL:LET* ((SELF NULL)) (CL:SETQ SELF (CL:MAKE-INSTANCE (CL:QUOTE LIST-ITERATOR)))
   (CL:SETF (%FIRST-ITERATION? SELF) CL:T) (CL:SETF (%VALUE SELF) NULL) (CL:SETF (%LIST-ITERATOR-COLLECTION SELF) NULL)
   (CL:SETF (%LIST-ITERATOR-CURSOR SELF) NULL) (CL:RETURN-FROM NEW-LIST-ITERATOR SELF)))
...
(CL:DEFUN NEW-DESTRUCTIVE-LIST-ITERATOR ()
  (CL:LET* ((SELF NULL)) (CL:SETQ SELF (CL:MAKE-INSTANCE (CL:QUOTE DESTRUCTIVE-LIST-ITERATOR)))
   (CL:SETF (%FIRST-ITERATION? SELF) CL:T) (CL:SETF (%VALUE SELF) NULL) (CL:SETF (%LIST-ITERATOR-CURSOR SELF) NULL)
   (CL:SETF (%THE-CONS-LIST SELF) NIL) (CL:RETURN-FROM NEW-DESTRUCTIVE-LIST-ITERATOR SELF)))
...
(CL:DEFUN ACCESS-DESTRUCTIVE-LIST-ITERATOR-SLOT-VALUE (SELF SLOTNAME VALUE SETVALUE?)
  (CL:COND
   ((CL:EQ SLOTNAME SYM-HIERARCHY-STELLA-THE-CONS-LIST)
    (CL:IF SETVALUE? (CL:SETF (%THE-CONS-LIST SELF) VALUE) (CL:SETQ VALUE (%THE-CONS-LIST SELF))))
   ((CL:EQ SLOTNAME SYM-HIERARCHY-STELLA-LIST-ITERATOR-CURSOR)
    (CL:IF SETVALUE? (CL:SETF (%LIST-ITERATOR-CURSOR SELF) VALUE) (CL:SETQ VALUE (%LIST-ITERATOR-CURSOR SELF))))
   (CL:T
    (CL:LET* ((STREAM-000 (NEW-OUTPUT-STRING-STREAM)))
...
(CL:DEFCLASS ALL-PURPOSE-ITERATOR (ITERATOR)
  ((KEY :ALLOCATION :INSTANCE :ACCESSOR %KEY) (ITERATOR-NEXT-CODE :ALLOCATION :INSTANCE :ACCESSOR %ITERATOR-NEXT-CODE)
   (ITERATOR-FILTER-CODE :ALLOCATION :INSTANCE :ACCESSOR %ITERATOR-FILTER-CODE)
   (ITERATOR-EMPTY-CODE :ALLOCATION :INSTANCE :ACCESSOR %ITERATOR-EMPTY-CODE)
   (ITERATOR-NESTED-ITERATOR :ALLOCATION :INSTANCE :ACCESSOR %ITERATOR-NESTED-ITERATOR)
   (ITERATOR-CONS-LIST :ALLOCATION :INSTANCE :ACCESSOR %ITERATOR-CONS-LIST)
   (ITERATOR-OBJECT :ALLOCATION :INSTANCE :ACCESSOR %ITERATOR-OBJECT)
   (ITERATOR-SECOND-OBJECT :ALLOCATION :INSTANCE :ACCESSOR %ITERATOR-SECOND-OBJECT)
   (ITERATOR-INTEGER :TYPE CL:FIXNUM :INITFORM NULL-INTEGER :ALLOCATION :INSTANCE :ACCESSOR %ITERATOR-INTEGER)
   (ITERATOR-SECOND-INTEGER :TYPE CL:FIXNUM :INITFORM NULL-INTEGER :ALLOCATION :INSTANCE :ACCESSOR
...
(CL:DEFUN NEW-ALL-PURPOSE-ITERATOR ()
  (CL:LET* ((SELF NULL)) (CL:SETQ SELF (CL:MAKE-INSTANCE (CL:QUOTE ALL-PURPOSE-ITERATOR)))
   (CL:SETF (%FIRST-ITERATION? SELF) CL:T) (CL:SETF (%VALUE SELF) NULL)
   (CL:SETF (%ITERATOR-SECOND-INTEGER SELF) NULL-INTEGER) (CL:SETF (%ITERATOR-INTEGER SELF) NULL-INTEGER)
   (CL:SETF (%ITERATOR-SECOND-OBJECT SELF) NULL) (CL:SETF (%ITERATOR-OBJECT SELF) NULL)
   (CL:SETF (%ITERATOR-CONS-LIST SELF) NULL) (CL:SETF (%ITERATOR-NESTED-ITERATOR SELF) NULL)
   (CL:SETF (%ITERATOR-EMPTY-CODE SELF) NULL) (CL:SETF (%ITERATOR-FILTER-CODE SELF) NULL)
   (CL:SETF (%ITERATOR-NEXT-CODE SELF) NULL) (CL:SETF (%KEY SELF) NULL) (CL:RETURN-FROM NEW-ALL-PURPOSE-ITERATOR SELF)))
...
(CL:DEFUN ACCESS-ALL-PURPOSE-ITERATOR-SLOT-VALUE (SELF SLOTNAME VALUE SETVALUE?)
  (CL:COND
   ...
   ((CL:EQ SLOTNAME SYM-HIERARCHY-STELLA-ITERATOR-NEXT-CODE)
    (CL:IF SETVALUE? (CL:SETF (%ITERATOR-NEXT-CODE SELF) (%WRAPPER-VALUE VALUE))
     (CL:SETQ VALUE (WRAP-FUNCTION-CODE (%ITERATOR-NEXT-CODE SELF)))))
   ((CL:EQ SLOTNAME SYM-HIERARCHY-STELLA-ITERATOR-FILTER-CODE)
    (CL:IF SETVALUE? (CL:SETF (%ITERATOR-FILTER-CODE SELF) (%WRAPPER-VALUE VALUE))
     (CL:SETQ VALUE (WRAP-FUNCTION-CODE (%ITERATOR-FILTER-CODE SELF)))))
   ((CL:EQ SLOTNAME SYM-HIERARCHY-STELLA-ITERATOR-EMPTY-CODE)
    (CL:IF SETVALUE? (CL:SETF (%ITERATOR-EMPTY-CODE SELF) (%WRAPPER-VALUE VALUE))
   ...
   ((CL:EQ SLOTNAME SYM-HIERARCHY-STELLA-ITERATOR-CONS-LIST)
    (CL:IF SETVALUE? (CL:SETF (%ITERATOR-CONS-LIST SELF) VALUE) (CL:SETQ VALUE (%ITERATOR-CONS-LIST SELF))))
   ((CL:EQ SLOTNAME SYM-HIERARCHY-STELLA-ITERATOR-OBJECT)
    (CL:IF SETVALUE? (CL:SETF (%ITERATOR-OBJECT SELF) VALUE) (CL:SETQ VALUE (%ITERATOR-OBJECT SELF))))
   ...
   ((CL:EQ SLOTNAME SYM-HIERARCHY-STELLA-ITERATOR-INTEGER)
    (CL:IF SETVALUE? (CL:SETF (%ITERATOR-INTEGER SELF) (%WRAPPER-VALUE VALUE))
     (CL:SETQ VALUE (WRAP-INTEGER (%ITERATOR-INTEGER SELF)))))
   ((CL:EQ SLOTNAME SYM-HIERARCHY-STELLA-ITERATOR-SECOND-INTEGER)
    (CL:IF SETVALUE? (CL:SETF (%ITERATOR-SECOND-INTEGER SELF) (%WRAPPER-VALUE VALUE))
...
(CL:DEFUN NEW-TYPES-TO-CLASSES-ITERATOR (ITERATOR-CURSOR)
  (CL:LET* ((SELF NULL)) (CL:SETQ SELF (CL:MAKE-INSTANCE (CL:QUOTE TYPES-TO-CLASSES-ITERATOR)))
   (CL:SETF (%ITERATOR-CURSOR SELF) ITERATOR-CURSOR) (CL:SETF (%FIRST-ITERATION? SELF) CL:T)
   (CL:SETF (%VALUE SELF) NULL) (CL:RETURN-FROM NEW-TYPES-TO-CLASSES-ITERATOR SELF)))
...
(CL:DEFMETHOD NEXT? ((SELF TYPES-TO-CLASSES-ITERATOR))
  ...
  (CL:COND
   ((CL:NOT (CL:EQ (%ITERATOR-CURSOR SELF) NIL))
    (CL:SETF (%VALUE SELF) (%SURROGATE-VALUE (%%VALUE (%ITERATOR-CURSOR SELF)))) (CL:RETURN-FROM NEXT? CL:T))
...
(CL:DEFUN ACCESS-TYPES-TO-CLASSES-ITERATOR-SLOT-VALUE (SELF SLOTNAME VALUE SETVALUE?)
  (CL:COND
   ((CL:EQ SLOTNAME SYM-HIERARCHY-STELLA-ITERATOR-CURSOR)
    (CL:IF SETVALUE? (CL:SETF (%ITERATOR-CURSOR SELF) VALUE) (CL:SETQ VALUE (%ITERATOR-CURSOR SELF))))
   (CL:T
    (CL:LET* ((STREAM-000 (NEW-OUTPUT-STRING-STREAM)))
     (%%PRINT-STREAM (%NATIVE-STREAM STREAM-000) "`" SLOTNAME "' is not a valid case option")
     (CL:ERROR (NEW-STELLA-EXCEPTION (THE-STRING-READER STREAM-000))))))
...
(CL:DEFMETHOD VALUE-SETTER ((SELF DICTIONARY-ITERATOR) VALUE)
  (CL:LET* ((STREAM-000 (NEW-OUTPUT-STRING-STREAM)))
   (%%PRINT-STREAM (%NATIVE-STREAM STREAM-000) "DICTIONARY-ITERATOR.value-setter not implemented on `" SELF "'")
   (CL:ERROR (NEW-STELLA-EXCEPTION (THE-STRING-READER STREAM-000)))))

(CL:DEFMETHOD KEY-SETTER ((SELF DICTIONARY-ITERATOR) KEY)
  (CL:LET* ((STREAM-000 (NEW-OUTPUT-STRING-STREAM)))
   (%%PRINT-STREAM (%NATIVE-STREAM STREAM-000) "DICTIONARY-ITERATOR.key-setter not implemented on `" SELF "'")
   (CL:ERROR (NEW-STELLA-EXCEPTION (THE-STRING-READER STREAM-000)))))

;;; (DEFCLASS PROPERTY-LIST-ITERATOR ...)

(CL:DEFCLASS PROPERTY-LIST-ITERATOR (DICTIONARY-ITERATOR)
  ((PLIST-ITERATOR-CURSOR :ALLOCATION :INSTANCE :ACCESSOR %PLIST-ITERATOR-CURSOR)
   (PLIST-ITERATOR-COLLECTION :ALLOCATION :INSTANCE :ACCESSOR %PLIST-ITERATOR-COLLECTION))
  (:DOCUMENTATION "Iterator class for the collection PROPERTY-LIST."))

(CL:DEFUN NEW-PROPERTY-LIST-ITERATOR ()
  (CL:LET* ((SELF NULL)) (CL:SETQ SELF (CL:MAKE-INSTANCE (CL:QUOTE PROPERTY-LIST-ITERATOR)))
   (CL:SETF (%FIRST-ITERATION? SELF) CL:T) (CL:SETF (%VALUE SELF) NULL) (CL:SETF (%KEY SELF) NULL)
   (CL:SETF (%PLIST-ITERATOR-COLLECTION SELF) NULL) (CL:SETF (%PLIST-ITERATOR-CURSOR SELF) NULL)
...
(CL:DEFCLASS KV-LIST-ITERATOR (DICTIONARY-ITERATOR)
  ((THE-KV-LIST :ALLOCATION :INSTANCE :ACCESSOR %THE-KV-LIST)
   (KV-LIST-ITERATOR-CURSOR :ALLOCATION :INSTANCE :ACCESSOR %KV-LIST-ITERATOR-CURSOR)))

(CL:DEFUN NEW-KV-LIST-ITERATOR ()
  (CL:LET* ((SELF NULL)) (CL:SETQ SELF (CL:MAKE-INSTANCE (CL:QUOTE KV-LIST-ITERATOR)))
   (CL:SETF (%FIRST-ITERATION? SELF) CL:T) (CL:SETF (%VALUE SELF) NULL) (CL:SETF (%KEY SELF) NULL)
   (CL:SETF (%KV-LIST-ITERATOR-CURSOR SELF) NULL) (CL:SETF (%THE-KV-LIST SELF) NULL)
...
(CL:DEFUN ACCESS-KV-LIST-ITERATOR-SLOT-VALUE (SELF SLOTNAME VALUE SETVALUE?)
  (CL:COND
   ((CL:EQ SLOTNAME SYM-HIERARCHY-STELLA-THE-KV-LIST)
    (CL:IF SETVALUE? (CL:SETF (%THE-KV-LIST SELF) VALUE) (CL:SETQ VALUE (%THE-KV-LIST SELF))))
...
(CL:DEFUN NEW-INTEGER-INTERVAL-ITERATOR (LOWER-BOUND UPPER-BOUND)
  ...
  (CL:LET* ((SELF NULL)) (CL:SETQ SELF (CL:MAKE-INSTANCE (CL:QUOTE INTEGER-INTERVAL-ITERATOR)))
   (CL:SETF (%LOWER-BOUND SELF) LOWER-BOUND) (CL:SETF (%UPPER-BOUND SELF) UPPER-BOUND)
   (CL:SETF (%FIRST-ITERATION? SELF) CL:T) (CL:SETF (%VALUE SELF) NULL-INTEGER)
   (CL:SETF (%INTERVAL-CURSOR SELF) NULL-INTEGER) (INITIALIZE-INTEGER-INTERVAL-ITERATOR SELF)
...
(CL:DEFUN NEW-REVERSE-INTEGER-INTERVAL-ITERATOR (LOWER-BOUND UPPER-BOUND)
  ...
  #+MCL
  (CL:CHECK-TYPE UPPER-BOUND CL:FIXNUM)
  (CL:LET* ((SELF NULL)) (CL:SETQ SELF (CL:MAKE-INSTANCE (CL:QUOTE REVERSE-INTEGER-INTERVAL-ITERATOR)))
   (CL:SETF (%LOWER-BOUND SELF) LOWER-BOUND) (CL:SETF (%UPPER-BOUND SELF) UPPER-BOUND)
   (CL:SETF (%FIRST-ITERATION? SELF) CL:T) (CL:SETF (%VALUE SELF) NULL-INTEGER)
   (CL:SETF (%INTERVAL-CURSOR SELF) NULL-INTEGER) (INITIALIZE-REVERSE-INTEGER-INTERVAL-ITERATOR SELF)
...
(CL:DEFUN NEW-STRING-ITERATOR ()
  (CL:LET* ((SELF NULL)) (CL:SETQ SELF (CL:MAKE-INSTANCE (CL:QUOTE STRING-ITERATOR)))
   (CL:SETF (%FIRST-ITERATION? SELF) CL:T) (CL:SETF (%VALUE SELF) NULL-CHARACTER) (CL:SETF (%END SELF) NULL-INTEGER)
   (CL:SETF (%CURSOR SELF) NULL-INTEGER) (CL:SETF (%THE-STRING SELF) STELLA::NULL-STRING)
...
(CL:DEFUN ACCESS-STRING-ITERATOR-SLOT-VALUE (SELF SLOTNAME VALUE SETVALUE?)
  (CL:COND
   ((CL:EQ SLOTNAME SYM-HIERARCHY-STELLA-THE-STRING)
    (CL:IF SETVALUE? (CL:SETF (%THE-STRING SELF) (%WRAPPER-VALUE VALUE))
     (CL:SETQ VALUE (WRAP-STRING (%THE-STRING SELF)))))
   ((CL:EQ SLOTNAME SYM-HIERARCHY-STELLA-CURSOR)
    (CL:IF SETVALUE? (CL:SETF (%CURSOR SELF) (%WRAPPER-VALUE VALUE)) (CL:SETQ VALUE (WRAP-INTEGER (%CURSOR SELF)))))
   ((CL:EQ SLOTNAME SYM-HIERARCHY-STELLA-END)
    (CL:IF SETVALUE? (CL:SETF (%END SELF) (%WRAPPER-VALUE VALUE)) (CL:SETQ VALUE (WRAP-INTEGER (%END SELF)))))
   (CL:T
    (CL:LET* ((STREAM-000 (NEW-OUTPUT-STRING-STREAM)))
     (%%PRINT-STREAM (%NATIVE-STREAM STREAM-000) "`" SLOTNAME "' is not a valid case option")
     (CL:ERROR (NEW-STELLA-EXCEPTION (THE-STRING-READER STREAM-000))))))
...
(CL:DEFUN NEW-LIST ()
  (CL:LET* ((SELF NULL)) (CL:SETQ SELF (CL:MAKE-INSTANCE (CL:QUOTE LIST))) (CL:SETF (%THE-CONS-LIST SELF) NIL)
...
(CL:DEFUN NEW-SET ()
  (CL:LET* ((SELF NULL)) (CL:SETQ SELF (CL:MAKE-INSTANCE (CL:QUOTE SET))) (CL:SETF (%THE-CONS-LIST SELF) NIL)
...
(CL:DEFUN NEW-CLASS-EXTENSION ()
  (CL:LET* ((SELF NULL)) (CL:SETQ SELF (CL:MAKE-INSTANCE (CL:QUOTE CLASS-EXTENSION)))
   (CL:SETF (%THE-CONS-LIST SELF) NIL) (CL:RETURN-FROM NEW-CLASS-EXTENSION SELF)))
...
(CL:DEFUN NEW-CONS ()
  (CL:LET* ((SELF NULL)) (CL:SETQ SELF (CL:CONS CL:NIL CL:NIL)) (CL:SETF (%%REST SELF) NIL)
   (CL:SETF (%%VALUE SELF) NULL) (CL:RETURN-FROM NEW-CONS SELF)))
...
(CL:DEFUN ACCESS-CONS-SLOT-VALUE (SELF SLOTNAME VALUE SETVALUE?)
  (CL:COND
   ((CL:EQ SLOTNAME SYM-HIERARCHY-STELLA-VALUE)
    (CL:IF SETVALUE? (CL:SETF (%%VALUE SELF) VALUE) (CL:SETQ VALUE (%%VALUE SELF))))
   ((CL:EQ SLOTNAME SYM-HIERARCHY-STELLA-REST)
    (CL:IF SETVALUE? (CL:SETF (%%REST SELF) VALUE) (CL:SETQ VALUE (%%REST SELF))))
   (CL:T
    (CL:LET* ((STREAM-000 (NEW-OUTPUT-STRING-STREAM)))
     (%%PRINT-STREAM (%NATIVE-STREAM STREAM-000) "`" SLOTNAME "' is not a valid case option")
     (CL:ERROR (NEW-STELLA-EXCEPTION (THE-STRING-READER STREAM-000))))))
...
(CL:DEFUN NEW-PROPERTY-LIST ()
  (CL:LET* ((SELF NULL)) (CL:SETQ SELF (CL:MAKE-INSTANCE (CL:QUOTE PROPERTY-LIST))) (CL:SETF (%THE-PLIST SELF) NIL)
...
(CL:DEFUN ACCESS-PROPERTY-LIST-SLOT-VALUE (SELF SLOTNAME VALUE SETVALUE?)
  (CL:COND
   ((CL:EQ SLOTNAME SYM-HIERARCHY-STELLA-THE-PLIST)
    (CL:IF SETVALUE? (CL:SETF (%THE-PLIST SELF) VALUE) (CL:SETQ VALUE (%THE-PLIST SELF))))
   (CL:T
    (CL:LET* ((STREAM-000 (NEW-OUTPUT-STRING-STREAM)))
     (%%PRINT-STREAM (%NATIVE-STREAM STREAM-000) "`" SLOTNAME "' is not a valid case option")
     (CL:ERROR (NEW-STELLA-EXCEPTION (THE-STRING-READER STREAM-000))))))
...
(CL:DEFCLASS KV-CONS (STANDARD-OBJECT)
  ((KEY :ALLOCATION :INSTANCE :ACCESSOR %KEY) (VALUE :ALLOCATION :INSTANCE :ACCESSOR %VALUE)
   (REST :ALLOCATION :INSTANCE :ACCESSOR %REST)))

(CL:DEFUN NEW-KV-CONS ()
  (CL:LET* ((SELF NULL)) (CL:SETQ SELF (CL:MAKE-INSTANCE (CL:QUOTE KV-CONS))) (CL:SETF (%REST SELF) NULL)
   (CL:SETF (%VALUE SELF) NULL) (CL:SETF (%KEY SELF) NULL) (CL:RETURN-FROM NEW-KV-CONS SELF)))
...
(CL:DEFUN NEW-KEY-VALUE-LIST ()
  (CL:LET* ((SELF NULL)) (CL:SETQ SELF (CL:MAKE-INSTANCE (CL:QUOTE KEY-VALUE-LIST))) (CL:SETF (%THE-KV-LIST SELF) NULL)
...
(CL:DEFCLASS RECYCLE-LIST (SEQUENCE)
  ((RECYCLE-LIST-OF :ALLOCATION :INSTANCE :ACCESSOR %RECYCLE-LIST-OF)
   ...
   (LIST-OF-RECYCLED-ITEMS :ALLOCATION :INSTANCE :ACCESSOR %LIST-OF-RECYCLED-ITEMS)
   (ALL-ITEMS :ALLOCATION :INSTANCE :ACCESSOR %ALL-ITEMS) (UNUSED-ITEMS :ALLOCATION :INSTANCE :ACCESSOR %UNUSED-ITEMS)
   (CURRENT-LENGTH :TYPE CL:FIXNUM :INITFORM NULL-INTEGER :ALLOCATION :INSTANCE :ACCESSOR %CURRENT-LENGTH)
   (ITEM-SIZE :TYPE CL:FIXNUM :INITFORM NULL-INTEGER :ALLOCATION :INSTANCE :ACCESSOR %ITEM-SIZE)))

(CL:DEFUN NEW-RECYCLE-LIST ()
  (CL:LET* ((SELF NULL)) (CL:SETQ SELF (CL:MAKE-INSTANCE (CL:QUOTE RECYCLE-LIST)))
   (CL:SETF (%ITEM-SIZE SELF) NULL-INTEGER) (CL:SETF (%CURRENT-LENGTH SELF) 0) (CL:SETF (%UNUSED-ITEMS SELF) NULL)
   (CL:SETF (%ALL-ITEMS SELF) NULL) (CL:SETF (%LIST-OF-RECYCLED-ITEMS SELF) (MAKE-NON-RECYCLED-LIST))
...
(CL:DEFUN ACCESS-RECYCLE-LIST-SLOT-VALUE (SELF SLOTNAME VALUE SETVALUE?)
  (CL:COND
   ((CL:EQ SLOTNAME SYM-HIERARCHY-STELLA-RECYCLE-LIST-OF)
    (CL:IF SETVALUE? (CL:SETF (%RECYCLE-LIST-OF SELF) VALUE) (CL:SETQ VALUE (%RECYCLE-LIST-OF SELF))))
   ((CL:EQ SLOTNAME SYM-HIERARCHY-STELLA-RECYCLED-ITEMS)
    (CL:IF SETVALUE? (CL:SETF (%RECYCLED-ITEMS SELF) VALUE) (CL:SETQ VALUE (%RECYCLED-ITEMS SELF))))
   ...
   ((CL:EQ SLOTNAME SYM-HIERARCHY-STELLA-ALL-ITEMS)
    (CL:IF SETVALUE? (CL:SETF (%ALL-ITEMS SELF) VALUE) (CL:SETQ VALUE (%ALL-ITEMS SELF))))
   ((CL:EQ SLOTNAME SYM-HIERARCHY-STELLA-UNUSED-ITEMS)
    (CL:IF SETVALUE? (CL:SETF (%UNUSED-ITEMS SELF) VALUE) (CL:SETQ VALUE (%UNUSED-ITEMS SELF))))
   ((CL:EQ SLOTNAME SYM-HIERARCHY-STELLA-CURRENT-LENGTH)
    (CL:IF SETVALUE? (CL:SETF (%CURRENT-LENGTH SELF) (%WRAPPER-VALUE VALUE))
...
(CL:DEFMETHOD PRINT-OBJECT ((SELF RECYCLE-LIST) STREAM)
  (CL:IF (CL:NOT (CL:EQ (%RECYCLE-LIST-OF SELF) NULL))
   (%%PRINT-STREAM STREAM "|i|[RECYCLE-LIST OF " (%CURRENT-LENGTH SELF) " " (%RECYCLE-LIST-OF SELF) "'s]")
...
(CL:DEFCLASS ABSTRACT-HASH-TABLE (ABSTRACT-DICTIONARY)
  ((THE-HASH-TABLE :ALLOCATION :INSTANCE :ACCESSOR %THE-HASH-TABLE)
   (THE-STELLA-HASH-TABLE :ALLOCATION :INSTANCE :ACCESSOR %THE-STELLA-HASH-TABLE)))
...
(CL:DEFUN NEW-HASH-TABLE ()
  (CL:LET* ((SELF NULL)) (CL:SETQ SELF (CL:MAKE-INSTANCE (CL:QUOTE HASH-TABLE)))
   (CL:SETF (%THE-STELLA-HASH-TABLE SELF) NULL) (CL:SETF (%THE-HASH-TABLE SELF) NULL) (INITIALIZE-HASH-TABLE SELF)
...
(CL:DEFUN NEW-INTEGER-HASH-TABLE ()
  (CL:LET* ((SELF NULL)) (CL:SETQ SELF (CL:MAKE-INSTANCE (CL:QUOTE INTEGER-HASH-TABLE)))
   (CL:SETF (%THE-STELLA-HASH-TABLE SELF) NULL) (CL:SETF (%THE-HASH-TABLE SELF) NULL) (INITIALIZE-HASH-TABLE SELF)
...
(CL:DEFUN NEW-FLOAT-HASH-TABLE ()
  (CL:LET* ((SELF NULL)) (CL:SETQ SELF (CL:MAKE-INSTANCE (CL:QUOTE FLOAT-HASH-TABLE)))
   (CL:SETF (%THE-STELLA-HASH-TABLE SELF) NULL) (CL:SETF (%THE-HASH-TABLE SELF) NULL) (INITIALIZE-HASH-TABLE SELF)
...
(CL:DEFUN NEW-STRING-HASH-TABLE ()
  (CL:LET* ((SELF NULL)) (CL:SETQ SELF (CL:MAKE-INSTANCE (CL:QUOTE STRING-HASH-TABLE)))
   (CL:SETF (%THE-STELLA-HASH-TABLE SELF) NULL) (CL:SETF (%THE-HASH-TABLE SELF) NULL) (INITIALIZE-HASH-TABLE SELF)
...
(CL:DEFUN NEW-STRING-TO-INTEGER-HASH-TABLE ()
  (CL:LET* ((SELF NULL)) (CL:SETQ SELF (CL:MAKE-INSTANCE (CL:QUOTE STRING-TO-INTEGER-HASH-TABLE)))
   (CL:SETF (%THE-STELLA-HASH-TABLE SELF) NULL) (CL:SETF (%THE-HASH-TABLE SELF) NULL) (INITIALIZE-HASH-TABLE SELF)
...
(CL:DEFUN NEW-EXTENSIBLE-VECTOR (ARRAY-SIZE)
  ...
  #+MCL
  (CL:CHECK-TYPE ARRAY-SIZE CL:FIXNUM)
  (CL:LET* ((SELF NULL)) (CL:SETQ SELF (CL:MAKE-INSTANCE (CL:QUOTE EXTENSIBLE-VECTOR)))
   (CL:SETF (%ARRAY-SIZE SELF) ARRAY-SIZE) (CL:SETF (%THE-ARRAY SELF) STELLA::NULL-NATIVE-VECTOR)
...
(CL:DEFCLASS EXTENSIBLE-SYMBOL-ARRAY (EXTENSIBLE-VECTOR)
  ((TOP-SYMBOL-OFFSET :TYPE CL:FIXNUM :INITFORM NULL-INTEGER :ALLOCATION :INSTANCE :ACCESSOR %TOP-SYMBOL-OFFSET)
   (POTENTIAL-FREE-SYMBOL-OFFSET :TYPE CL:FIXNUM :INITFORM NULL-INTEGER :ALLOCATION :INSTANCE :ACCESSOR
...
(CL:DEFUN NEW-EXTENSIBLE-SYMBOL-ARRAY (ARRAY-SIZE)
  ...
  #+MCL
  (CL:CHECK-TYPE ARRAY-SIZE CL:FIXNUM)
  (CL:LET* ((SELF NULL)) (CL:SETQ SELF (CL:MAKE-INSTANCE (CL:QUOTE EXTENSIBLE-SYMBOL-ARRAY)))
   (CL:SETF (%ARRAY-SIZE SELF) ARRAY-SIZE) (CL:SETF (%THE-ARRAY SELF) STELLA::NULL-NATIVE-VECTOR)
   (CL:SETF (%POTENTIAL-FREE-SYMBOL-OFFSET SELF) 0) (CL:SETF (%TOP-SYMBOL-OFFSET SELF) -1) (INITIALIZE-VECTOR SELF)
...
(CL:DEFUN ACCESS-EXTENSIBLE-SYMBOL-ARRAY-SLOT-VALUE (SELF SLOTNAME VALUE SETVALUE?)
  (CL:COND
   ((CL:EQ SLOTNAME SYM-HIERARCHY-STELLA-TOP-SYMBOL-OFFSET)
    (CL:IF SETVALUE? (CL:SETF (%TOP-SYMBOL-OFFSET SELF) (%WRAPPER-VALUE VALUE))
     (CL:SETQ VALUE (WRAP-INTEGER (%TOP-SYMBOL-OFFSET SELF)))))
   ((CL:EQ SLOTNAME SYM-HIERARCHY-STELLA-POTENTIAL-FREE-SYMBOL-OFFSET)
    (CL:IF SETVALUE? (CL:SETF (%POTENTIAL-FREE-SYMBOL-OFFSET SELF) (%WRAPPER-VALUE VALUE))
     (CL:SETQ VALUE (WRAP-INTEGER (%POTENTIAL-FREE-SYMBOL-OFFSET SELF)))))
   (CL:T
    (CL:LET* ((STREAM-000 (NEW-OUTPUT-STRING-STREAM)))
     (%%PRINT-STREAM (%NATIVE-STREAM STREAM-000) "`" SLOTNAME "' is not a valid case option")
     (CL:ERROR (NEW-STELLA-EXCEPTION (THE-STRING-READER STREAM-000))))))
...
(CL:DEFUN NEW-VECTOR-SEQUENCE (ARRAY-SIZE)
  ...
  #+MCL
  (CL:CHECK-TYPE ARRAY-SIZE CL:FIXNUM)
  (CL:LET* ((SELF NULL)) (CL:SETQ SELF (CL:MAKE-INSTANCE (CL:QUOTE VECTOR-SEQUENCE)))
   (CL:SETF (%ARRAY-SIZE SELF) ARRAY-SIZE) (CL:SETF (%THE-ARRAY SELF) STELLA::NULL-NATIVE-VECTOR)
   (CL:SETF (%SEQUENCE-LENGTH SELF) 0) (INITIALIZE-VECTOR SELF) (CL:RETURN-FROM NEW-VECTOR-SEQUENCE SELF)))
...
(CL:DEFUN ACCESS-VECTOR-SEQUENCE-SLOT-VALUE (SELF SLOTNAME VALUE SETVALUE?)
  (CL:COND
   ((CL:EQ SLOTNAME SYM-HIERARCHY-STELLA-SEQUENCE-LENGTH)
    (CL:IF SETVALUE? (CL:SETF (%SEQUENCE-LENGTH SELF) (%WRAPPER-VALUE VALUE))
...
(CL:DEFUN NEW-CUSTOM-VECTOR-SEQUENCE (ARRAY-SIZE)
  ...
  #+MCL
  (CL:CHECK-TYPE ARRAY-SIZE CL:FIXNUM)
  (CL:LET* ((SELF NULL)) (CL:SETQ SELF (CL:MAKE-INSTANCE (CL:QUOTE CUSTOM-VECTOR-SEQUENCE)))
   (CL:SETF (%ARRAY-SIZE SELF) ARRAY-SIZE) (CL:SETF (%THE-ARRAY SELF) STELLA::NULL-NATIVE-VECTOR)
   (CL:SETF (%SEQUENCE-LENGTH SELF) 0) (CL:SETF (%RESIZE-FACTOR SELF) 2.0d0) (INITIALIZE-VECTOR SELF)
...
(CL:DEFUN ACCESS-CUSTOM-VECTOR-SEQUENCE-SLOT-VALUE (SELF SLOTNAME VALUE SETVALUE?)
  (CL:COND
   ((CL:EQ SLOTNAME SYM-HIERARCHY-STELLA-RESIZE-FACTOR)
    (CL:IF SETVALUE? (CL:SETF (%RESIZE-FACTOR SELF) (%WRAPPER-VALUE VALUE))
...
(CL:DEFUN NEW-BOOLEAN-VECTOR (ARRAY-SIZE)
  ...
  #+MCL
  (CL:CHECK-TYPE ARRAY-SIZE CL:FIXNUM)
  (CL:LET* ((SELF NULL)) (CL:SETQ SELF (CL:MAKE-INSTANCE (CL:QUOTE BOOLEAN-VECTOR)))
   (CL:SETF (%ARRAY-SIZE SELF) ARRAY-SIZE) (CL:SETF (%THE-ARRAY SELF) STELLA::NULL-NATIVE-VECTOR)
...
(CL:DEFUN NEW-INTEGER-VECTOR (ARRAY-SIZE)
  ...
  #+MCL
  (CL:CHECK-TYPE ARRAY-SIZE CL:FIXNUM)
  (CL:LET* ((SELF NULL)) (CL:SETQ SELF (CL:MAKE-INSTANCE (CL:QUOTE INTEGER-VECTOR)))
   (CL:SETF (%ARRAY-SIZE SELF) ARRAY-SIZE) (CL:SETF (%THE-ARRAY SELF) STELLA::NULL-NATIVE-VECTOR)
...
(CL:DEFUN NEW-ACTIVE-LIST ()
  (CL:LET* ((SELF NULL)) (CL:SETQ SELF (CL:MAKE-INSTANCE (CL:QUOTE ACTIVE-LIST))) (CL:SETF (%OWNER-INSTANCE SELF) NULL)
   (CL:SETF (%ACTIVE-SLOT SELF) NULL) (CL:SETF (%THE-CONS-LIST SELF) NIL) (CL:RETURN-FROM NEW-ACTIVE-LIST SELF)))
...
(CL:DEFUN NEW-ACTIVE-SET ()
  (CL:LET* ((SELF NULL)) (CL:SETQ SELF (CL:MAKE-INSTANCE (CL:QUOTE ACTIVE-SET))) (CL:SETF (%OWNER-INSTANCE SELF) NULL)
   (CL:SETF (%ACTIVE-SLOT SELF) NULL) (CL:SETF (%THE-CONS-LIST SELF) NIL) (CL:RETURN-FROM NEW-ACTIVE-SET SELF)))
...
(CL:DEFCLASS DEMON (STANDARD-OBJECT)
  ((DEMON-NAME :TYPE CL:SIMPLE-STRING :INITFORM STELLA::NULL-STRING :ALLOCATION :INSTANCE :ACCESSOR %DEMON-NAME)
   ...
   (DEMON-DOCUMENTATION :TYPE CL:SIMPLE-STRING :INITFORM STELLA::NULL-STRING :ALLOCATION :INSTANCE :ACCESSOR
    %DEMON-DOCUMENTATION)
...
(CL:DEFUN NEW-DEMON ()
  (CL:LET* ((SELF NULL)) (CL:SETQ SELF (CL:MAKE-INSTANCE (CL:QUOTE DEMON))) (CL:SETF (%DEMON-INHERIT? SELF) CL:NIL)
   (CL:SETF (%DEMON-ALL? SELF) CL:NIL) (CL:SETF (%DEMON-GUARD? SELF) CL:NIL)
   (CL:SETF (%DEMON-DOCUMENTATION SELF) STELLA::NULL-STRING) (CL:SETF (%DEMON-METHOD SELF) NULL)
   (CL:SETF (%DEMON-CODE SELF) NULL) (CL:SETF (%DEMON-SLOT-REFS SELF) (NEW-LIST))
   (CL:SETF (%DEMON-CLASS-REFS SELF) (NEW-LIST)) (CL:SETF (%DEMON-ACTION SELF) NULL)
...
(CL:DEFUN ACCESS-DEMON-SLOT-VALUE (SELF SLOTNAME VALUE SETVALUE?)
  (CL:COND
   ((CL:EQ SLOTNAME SYM-HIERARCHY-STELLA-DEMON-NAME)
    (CL:IF SETVALUE? (CL:SETF (%DEMON-NAME SELF) (%WRAPPER-VALUE VALUE))
     (CL:SETQ VALUE (WRAP-STRING (%DEMON-NAME SELF)))))
   ((CL:EQ SLOTNAME SYM-HIERARCHY-STELLA-DEMON-ACTION)
    (CL:IF SETVALUE? (CL:SETF (%DEMON-ACTION SELF) VALUE) (CL:SETQ VALUE (%DEMON-ACTION SELF))))
   ((CL:EQ SLOTNAME SYM-HIERARCHY-STELLA-DEMON-CLASS-REFS)
    (CL:IF SETVALUE? (CL:SETF (%DEMON-CLASS-REFS SELF) VALUE) (CL:SETQ VALUE (%DEMON-CLASS-REFS SELF))))
   ((CL:EQ SLOTNAME SYM-HIERARCHY-STELLA-DEMON-SLOT-REFS)
    (CL:IF SETVALUE? (CL:SETF (%DEMON-SLOT-REFS SELF) VALUE) (CL:SETQ VALUE (%DEMON-SLOT-REFS SELF))))
   ((CL:EQ SLOTNAME SYM-HIERARCHY-STELLA-DEMON-CODE)
    (CL:IF SETVALUE? (CL:SETF (%DEMON-CODE SELF) (%WRAPPER-VALUE VALUE))
     (CL:SETQ VALUE (WRAP-FUNCTION-CODE (%DEMON-CODE SELF)))))
   ((CL:EQ SLOTNAME SYM-HIERARCHY-STELLA-DEMON-METHOD)
    (CL:IF SETVALUE? (CL:SETF (%DEMON-METHOD SELF) VALUE) (CL:SETQ VALUE (%DEMON-METHOD SELF))))
   ((CL:EQ SLOTNAME SYM-HIERARCHY-STELLA-DEMON-DOCUMENTATION)
    (CL:IF SETVALUE? (CL:SETF (%DEMON-DOCUMENTATION SELF) (%WRAPPER-VALUE VALUE))
     (CL:SETQ VALUE (WRAP-STRING (%DEMON-DOCUMENTATION SELF)))))
   ((CL:EQ SLOTNAME SYM-HIERARCHY-STELLA-DEMON-GUARD?)
    (CL:IF SETVALUE? (CL:SETF (%DEMON-GUARD? SELF) (COERCE-WRAPPED-BOOLEAN-TO-BOOLEAN VALUE))
     (CL:SETQ VALUE (CL:IF (%DEMON-GUARD? SELF) TRUE-WRAPPER FALSE-WRAPPER))))
   ((CL:EQ SLOTNAME SYM-HIERARCHY-STELLA-DEMON-ALL?)
    (CL:IF SETVALUE? (CL:SETF (%DEMON-ALL? SELF) (COERCE-WRAPPED-BOOLEAN-TO-BOOLEAN VALUE))
     (CL:SETQ VALUE (CL:IF (%DEMON-ALL? SELF) TRUE-WRAPPER FALSE-WRAPPER))))
...
(CL:DEFUN NEW-KEYWORD-KEY-VALUE-LIST ()
  (CL:LET* ((SELF NULL)) (CL:SETQ SELF (CL:MAKE-INSTANCE (CL:QUOTE KEYWORD-KEY-VALUE-LIST)))
   (CL:SETF (%THE-KV-LIST SELF) NULL) (CL:RETURN-FROM NEW-KEYWORD-KEY-VALUE-LIST SELF)))
...
(CL:DEFUN ACCESS-GENERALIZED-SYMBOL-SLOT-VALUE (SELF SLOTNAME VALUE SETVALUE?)
  (CL:COND
   ((CL:EQ SLOTNAME SYM-HIERARCHY-STELLA-SYMBOL-NAME)
    (CL:IF SETVALUE? (CL:SETF (%SYMBOL-NAME SELF) (%WRAPPER-VALUE VALUE))
...
(CL:DEFUN NEW-SYMBOL (SYMBOL-NAME)
  ...
  (CL:LET* ((SELF NULL)) (CL:SETQ SELF (CL:MAKE-INSTANCE (CL:QUOTE SYMBOL))) (CL:SETF (%SYMBOL-NAME SELF) SYMBOL-NAME)
   (CL:SETF (%HOME-CONTEXT SELF) *CONTEXT*) (CL:SETF (%SYMBOL-ID SELF) NULL-INTEGER)
   (CL:SETF (%SYMBOL-VALUE-AND-PLIST SELF) NIL) (CL:SETF (%SYMBOL-SLOT-OFFSET SELF) NULL-INTEGER)
...
(CL:DEFUN ACCESS-SYMBOL-SLOT-VALUE (SELF SLOTNAME VALUE SETVALUE?)
  (CL:COND
   ((CL:EQ SLOTNAME SYM-HIERARCHY-STELLA-SYMBOL-SLOT-OFFSET)
    (CL:IF SETVALUE? (CL:SETF (%SYMBOL-SLOT-OFFSET SELF) (%WRAPPER-VALUE VALUE))
...
(CL:DEFUN NEW-SURROGATE (SYMBOL-NAME)
  ...
  #+MCL
  (CL:CHECK-TYPE SYMBOL-NAME CL:SIMPLE-STRING)
  (CL:LET* ((SELF NULL)) (CL:SETQ SELF (CL:MAKE-INSTANCE (CL:QUOTE SURROGATE)))
   (CL:SETF (%SYMBOL-NAME SELF) SYMBOL-NAME) (CL:SETF (%HOME-CONTEXT SELF) *CONTEXT*)
...
(CL:DEFUN ACCESS-SURROGATE-SLOT-VALUE (SELF SLOTNAME VALUE SETVALUE?)
  (CL:COND
   ((CL:EQ SLOTNAME SYM-HIERARCHY-STELLA-SURROGATE-VALUE)
    (CL:IF SETVALUE? (CL:SETF (%SURROGATE-VALUE SELF) VALUE) (CL:SETQ VALUE (%SURROGATE-VALUE SELF))))
...
(CL:DEFUN NEW-KEYWORD (SYMBOL-NAME)
  ...
  #+MCL
  (CL:CHECK-TYPE SYMBOL-NAME CL:SIMPLE-STRING)
  (CL:LET* ((SELF NULL)) (CL:SETQ SELF (CL:MAKE-INSTANCE (CL:QUOTE KEYWORD))) (CL:SETF (%SYMBOL-NAME SELF) SYMBOL-NAME)
   (CL:SETF (%HOME-CONTEXT SELF) *CONTEXT*) (CL:SETF (%SYMBOL-ID SELF) NULL-INTEGER) (CL:RETURN-FROM NEW-KEYWORD SELF)))
...
(CL:DEFUN NEW-TRANSIENT-SYMBOL (SYMBOL-NAME)
  ...
  #+MCL
  (CL:CHECK-TYPE SYMBOL-NAME CL:SIMPLE-STRING)
  (CL:LET* ((SELF NULL)) (CL:SETQ SELF (CL:MAKE-INSTANCE (CL:QUOTE TRANSIENT-SYMBOL)))
   (CL:SETF (%SYMBOL-NAME SELF) SYMBOL-NAME) (CL:SETF (%HOME-CONTEXT SELF) *CONTEXT*)
   (CL:SETF (%SYMBOL-ID SELF) NULL-INTEGER) (CL:SETF (%SYMBOL-VALUE-AND-PLIST SELF) NIL)
   (CL:SETF (%SYMBOL-SLOT-OFFSET SELF) NULL-INTEGER) (CL:RETURN-FROM NEW-TRANSIENT-SYMBOL SELF)))
...
(CL:DEFUN ACCESS-MAPPABLE-OBJECT-SLOT-VALUE (SELF SLOTNAME VALUE SETVALUE?)
  (CL:COND
   ((CL:EQ SLOTNAME SYM-HIERARCHY-STELLA-PROJECTS-ONTO)
    (CL:IF SETVALUE? (SET-DYNAMIC-SLOT-VALUE (%DYNAMIC-SLOTS SELF) SYM-HIERARCHY-STELLA-PROJECTS-ONTO VALUE NULL)
     (CL:SETQ VALUE (PROJECTS-ONTO SELF))))
   ((CL:EQ SLOTNAME SYM-HIERARCHY-STELLA-PROJECTED-FROM)
    (CL:IF SETVALUE? (SET-DYNAMIC-SLOT-VALUE (%DYNAMIC-SLOTS SELF) SYM-HIERARCHY-STELLA-PROJECTED-FROM VALUE NULL)
...
(CL:DEFUN ACCESS-RELATION-SLOT-VALUE (SELF SLOTNAME VALUE SETVALUE?)
  (CL:COND
   ((CL:EQ SLOTNAME SYM-HIERARCHY-STELLA-ABSTRACT?)
    (CL:IF SETVALUE? (CL:SETF (%ABSTRACT? SELF) (COERCE-WRAPPED-BOOLEAN-TO-BOOLEAN VALUE))
     (CL:SETQ VALUE (CL:IF (%ABSTRACT? SELF) TRUE-WRAPPER FALSE-WRAPPER))))
   ((CL:EQ SLOTNAME SYM-HIERARCHY-STELLA-PROPERTIES)
    (CL:IF SETVALUE? (SET-DYNAMIC-SLOT-VALUE (%DYNAMIC-SLOTS SELF) SYM-HIERARCHY-STELLA-PROPERTIES VALUE NULL)
...
(CL:DEFCLASS CLASS (RELATION)
  ((CL-STRUCT? :ALLOCATION :INSTANCE :ACCESSOR %CL-STRUCT?) (MIXIN? :ALLOCATION :INSTANCE :ACCESSOR %MIXIN?)
   (CLASS-TYPE :ALLOCATION :INSTANCE :ACCESSOR %CLASS-TYPE)
   (CLASS-DIRECT-SUPERS :ALLOCATION :INSTANCE :ACCESSOR %CLASS-DIRECT-SUPERS)
   (CLASS-DIRECT-SUBS :ALLOCATION :INSTANCE :ACCESSOR %CLASS-DIRECT-SUBS)
   (CLASS-ALL-SUPER-CLASSES :ALLOCATION :INSTANCE :ACCESSOR %CLASS-ALL-SUPER-CLASSES)
   (CLASS-ALL-SLOTS :ALLOCATION :INSTANCE :ACCESSOR %CLASS-ALL-SLOTS)
   (CLASS-LOCAL-SLOTS :ALLOCATION :INSTANCE :ACCESSOR %CLASS-LOCAL-SLOTS)
   (CLASS-SLOT-AND-METHOD-CACHE :ALLOCATION :INSTANCE :ACCESSOR %CLASS-SLOT-AND-METHOD-CACHE)
   (CLASS-COLLECTION? :ALLOCATION :INSTANCE :ACCESSOR %CLASS-COLLECTION?)
   (CLASS-PUBLIC? :ALLOCATION :INSTANCE :ACCESSOR %CLASS-PUBLIC?)
   (CLASS-FINALIZED? :ALLOCATION :INSTANCE :ACCESSOR %CLASS-FINALIZED?)
   (CLASS-SLOTS-FINALIZED? :ALLOCATION :INSTANCE :ACCESSOR %CLASS-SLOTS-FINALIZED?)
   (CLASS-STRINGIFIED-SOURCE :TYPE CL:SIMPLE-STRING :INITFORM STELLA::NULL-STRING :ALLOCATION :INSTANCE :ACCESSOR
    %CLASS-STRINGIFIED-SOURCE)
   (CLASS-CONSTRUCTOR-CODE :ALLOCATION :INSTANCE :ACCESSOR %CLASS-CONSTRUCTOR-CODE)
   (CLASS-SLOT-ACCESSOR-CODE :ALLOCATION :INSTANCE :ACCESSOR %CLASS-SLOT-ACCESSOR-CODE)
   (CLASS-MARKED? :ALLOCATION :INSTANCE :ACCESSOR %CLASS-MARKED?)
   (CLASS-TAXONOMY-NODE :ALLOCATION :INSTANCE :ACCESSOR %CLASS-TAXONOMY-NODE)))

(CL:DEFUN NEW-CLASS ()
  (CL:LET* ((SELF NULL)) (CL:SETQ SELF (CL:MAKE-INSTANCE (CL:QUOTE CLASS)))
   (CL:SETF (%DYNAMIC-SLOTS SELF) (NEW-KEY-VALUE-LIST)) (CL:SETF (%CLASS-TAXONOMY-NODE SELF) NULL)
   (CL:SETF (%CLASS-MARKED? SELF) CL:NIL) (CL:SETF (%CLASS-SLOT-ACCESSOR-CODE SELF) NULL)
   (CL:SETF (%CLASS-CONSTRUCTOR-CODE SELF) NULL) (CL:SETF (%CLASS-STRINGIFIED-SOURCE SELF) STELLA::NULL-STRING)
   (CL:SETF (%CLASS-SLOTS-FINALIZED? SELF) CL:NIL) (CL:SETF (%CLASS-FINALIZED? SELF) CL:NIL)
   (CL:SETF (%CLASS-PUBLIC? SELF) CL:T) (CL:SETF (%CL-STRUCT? SELF) CL:NIL) (CL:SETF (%CLASS-COLLECTION? SELF) CL:NIL)
   (CL:SETF (%MIXIN? SELF) CL:NIL) (CL:SETF (%ABSTRACT? SELF) CL:NIL)
   (CL:SETF (%CLASS-SLOT-AND-METHOD-CACHE SELF) NULL) (CL:SETF (%CLASS-LOCAL-SLOTS SELF) NULL)
   (CL:SETF (%CLASS-ALL-SLOTS SELF) NULL) (CL:SETF (%CLASS-ALL-SUPER-CLASSES SELF) NIL)
   (CL:SETF (%CLASS-DIRECT-SUBS SELF) (NEW-LIST)) (CL:SETF (%CLASS-DIRECT-SUPERS SELF) (NEW-LIST))
   ...
   (CL:OR
    (CL:AND (CL:NOT (CL:EQ (DYNAMIC-SLOT-VALUE (%DYNAMIC-SLOTS SELF) SYM-HIERARCHY-STELLA-STORED-ACTIVE? NULL) NULL))
     (COERCE-WRAPPED-BOOLEAN-TO-BOOLEAN
      (DYNAMIC-SLOT-VALUE (%DYNAMIC-SLOTS SELF) SYM-HIERARCHY-STELLA-STORED-ACTIVE? NULL)))
...
(CL:DEFMETHOD INITIALIZER ((SELF CLASS))
  (CL:LET*
   ((CURSOR SELF) (VALUE (DYNAMIC-SLOT-VALUE (%DYNAMIC-SLOTS CURSOR) SYM-HIERARCHY-STELLA-CLASS-INITIALIZER NULL)))
   (CL:LOOP (CL:WHEN (CL:NOT (CL:EQ VALUE NULL)) (CL:RETURN-FROM INITIALIZER VALUE))
    (CL:SETQ CURSOR (%%VALUE (%CLASS-ALL-SUPER-CLASSES CURSOR)))
    (CL:IF (CL:NOT (CL:EQ CURSOR NULL))
     (CL:SETQ VALUE (DYNAMIC-SLOT-VALUE (%DYNAMIC-SLOTS CURSOR) SYM-HIERARCHY-STELLA-CLASS-INITIALIZER NULL))
     (CL:RETURN-FROM INITIALIZER NULL)))))

(CL:DEFMETHOD TERMINATOR ((SELF CLASS))
  (CL:LET*
   ((CURSOR SELF) (VALUE (DYNAMIC-SLOT-VALUE (%DYNAMIC-SLOTS CURSOR) SYM-HIERARCHY-STELLA-CLASS-TERMINATOR NULL)))
   (CL:LOOP (CL:WHEN (CL:NOT (CL:EQ VALUE NULL)) (CL:RETURN-FROM TERMINATOR VALUE))
    (CL:SETQ CURSOR (%%VALUE (%CLASS-ALL-SUPER-CLASSES CURSOR)))
    (CL:IF (CL:NOT (CL:EQ CURSOR NULL))
     (CL:SETQ VALUE (DYNAMIC-SLOT-VALUE (%DYNAMIC-SLOTS CURSOR) SYM-HIERARCHY-STELLA-CLASS-TERMINATOR NULL))
...
(CL:DEFMETHOD PARAMETERS ((SELF CLASS))
  ...
  (CL:LET*
   ((CURSOR SELF) (VALUE (DYNAMIC-SLOT-VALUE (%DYNAMIC-SLOTS CURSOR) SYM-HIERARCHY-STELLA-CLASS-PARAMETERS NULL)))
   (CL:LOOP (CL:WHEN (CL:NOT (CL:EQ VALUE NULL)) (CL:RETURN-FROM PARAMETERS VALUE))
    (CL:SETQ CURSOR (%%VALUE (%CLASS-ALL-SUPER-CLASSES CURSOR)))
    (CL:IF (CL:NOT (CL:EQ CURSOR NULL))
     (CL:SETQ VALUE (DYNAMIC-SLOT-VALUE (%DYNAMIC-SLOTS CURSOR) SYM-HIERARCHY-STELLA-CLASS-PARAMETERS NULL))
     (CL:RETURN-FROM PARAMETERS NIL-LIST)))))

(CL:DEFMETHOD INITIAL-VALUE ((SELF CLASS))
  "Return an initial value for the class `self'."
  (CL:LET*
   ((CURSOR SELF) (VALUE (DYNAMIC-SLOT-VALUE (%DYNAMIC-SLOTS CURSOR) SYM-HIERARCHY-STELLA-CLASS-INITIAL-VALUE NULL)))
   (CL:LOOP (CL:WHEN (CL:NOT (CL:EQ VALUE NULL)) (CL:RETURN-FROM INITIAL-VALUE VALUE))
    (CL:SETQ CURSOR (%%VALUE (%CLASS-ALL-SUPER-CLASSES CURSOR)))
    (CL:IF (CL:NOT (CL:EQ CURSOR NULL))
     (CL:SETQ VALUE (DYNAMIC-SLOT-VALUE (%DYNAMIC-SLOTS CURSOR) SYM-HIERARCHY-STELLA-CLASS-INITIAL-VALUE NULL))
...
of the class `self'."
  (CL:LET*
   ((CURSOR SELF) (VALUE (DYNAMIC-SLOT-VALUE (%DYNAMIC-SLOTS CURSOR) SYM-HIERARCHY-STELLA-CLASS-EXTENSION NULL)))
   (CL:LOOP (CL:WHEN (CL:NOT (CL:EQ VALUE NULL)) (CL:RETURN-FROM EXTENSION VALUE))
    (CL:SETQ CURSOR (%%VALUE (%CLASS-ALL-SUPER-CLASSES CURSOR)))
    (CL:IF (CL:NOT (CL:EQ CURSOR NULL))
     (CL:SETQ VALUE (DYNAMIC-SLOT-VALUE (%DYNAMIC-SLOTS CURSOR) SYM-HIERARCHY-STELLA-CLASS-EXTENSION NULL))
     (CL:RETURN-FROM EXTENSION NULL)))))

(CL:DEFMETHOD CL-NATIVE-TYPE ((SELF CLASS))
  (CL:RETURN-FROM CL-NATIVE-TYPE
   (%WRAPPER-VALUE
    (DYNAMIC-SLOT-VALUE (%DYNAMIC-SLOTS SELF) SYM-HIERARCHY-STELLA-CLASS-CL-NATIVE-TYPE NULL-STRING-WRAPPER))))

(CL:DEFMETHOD CPP-NATIVE-TYPE ((SELF CLASS))
  (CL:RETURN-FROM CPP-NATIVE-TYPE
   (%WRAPPER-VALUE
    (DYNAMIC-SLOT-VALUE (%DYNAMIC-SLOTS SELF) SYM-HIERARCHY-STELLA-CLASS-CPP-NATIVE-TYPE NULL-STRING-WRAPPER))))
...
(CL:DEFMETHOD JAVA-NATIVE-TYPE ((SELF CLASS))
  (CL:LET*
   ((NATIVETYPE
     (%WRAPPER-VALUE
      (DYNAMIC-SLOT-VALUE (%DYNAMIC-SLOTS SELF) SYM-HIERARCHY-STELLA-CLASS-JAVA-NATIVE-TYPE NULL-STRING-WRAPPER))))
   ...
   (CL:IF (CL:NOT (CL:EQ NATIVETYPE STELLA::NULL-STRING))
    (CL:RETURN-FROM JAVA-NATIVE-TYPE
     (SUBSTITUTE-TEMPLATE-VARIABLES-IN-STRING NATIVETYPE *JAVA-STELLA-PACKAGE-MAPPING*))
...
(CL:DEFMETHOD CLASS-CL-STRUCT-SLOTS ((SELF CLASS))
  (CL:LET* ((ANSWER (DYNAMIC-SLOT-VALUE (%DYNAMIC-SLOTS SELF) SYM-HIERARCHY-STELLA-CLASS-CL-STRUCT-SLOTS NULL)))
   (CL:IF (CL:EQ ANSWER NULL) (CL:RETURN-FROM CLASS-CL-STRUCT-SLOTS NIL-LIST)
...
(CL:DEFMETHOD CLASS-RECYCLE-METHOD ((SELF CLASS))
  (CL:LET* ((ANSWER (DYNAMIC-SLOT-VALUE (%DYNAMIC-SLOTS SELF) SYM-HIERARCHY-STELLA-CLASS-RECYCLE-METHOD NULL)))
   (CL:IF (CL:EQ ANSWER NULL) (CL:RETURN-FROM CLASS-RECYCLE-METHOD KWD-HIERARCHY-NONE)
...
(CL:DEFMETHOD CLASS-REQUIRED-SLOT-NAMES ((SELF CLASS))
  (CL:LET* ((ANSWER (DYNAMIC-SLOT-VALUE (%DYNAMIC-SLOTS SELF) SYM-HIERARCHY-STELLA-CLASS-REQUIRED-SLOT-NAMES NULL)))
   (CL:IF (CL:EQ ANSWER NULL) (CL:RETURN-FROM CLASS-REQUIRED-SLOT-NAMES NIL-LIST)
    (CL:RETURN-FROM CLASS-REQUIRED-SLOT-NAMES ANSWER))))

(CL:DEFMETHOD CLASS-GUARD-CONSTRUCTOR-DEMONS ((SELF CLASS))
  (CL:LET*
   ((ANSWER (DYNAMIC-SLOT-VALUE (%DYNAMIC-SLOTS SELF) SYM-HIERARCHY-STELLA-CLASS-GUARD-CONSTRUCTOR-DEMONS NULL)))
   (CL:IF (CL:EQ ANSWER NULL) (CL:RETURN-FROM CLASS-GUARD-CONSTRUCTOR-DEMONS NIL-LIST)
...
(CL:DEFMETHOD CLASS-CONSTRUCTOR-DEMONS ((SELF CLASS))
  (CL:LET* ((ANSWER (DYNAMIC-SLOT-VALUE (%DYNAMIC-SLOTS SELF) SYM-HIERARCHY-STELLA-CLASS-CONSTRUCTOR-DEMONS NULL)))
   (CL:IF (CL:EQ ANSWER NULL) (CL:RETURN-FROM CLASS-CONSTRUCTOR-DEMONS NIL-LIST)
    (CL:RETURN-FROM CLASS-CONSTRUCTOR-DEMONS ANSWER))))

(CL:DEFMETHOD CLASS-GUARD-DESTRUCTOR-DEMONS ((SELF CLASS))
  (CL:LET*
   ((ANSWER (DYNAMIC-SLOT-VALUE (%DYNAMIC-SLOTS SELF) SYM-HIERARCHY-STELLA-CLASS-GUARD-DESTRUCTOR-DEMONS NULL)))
   (CL:IF (CL:EQ ANSWER NULL) (CL:RETURN-FROM CLASS-GUARD-DESTRUCTOR-DEMONS NIL-LIST)
...
(CL:DEFMETHOD CLASS-DESTRUCTOR-DEMONS ((SELF CLASS))
  (CL:LET* ((ANSWER (DYNAMIC-SLOT-VALUE (%DYNAMIC-SLOTS SELF) SYM-HIERARCHY-STELLA-CLASS-DESTRUCTOR-DEMONS NULL)))
   (CL:IF (CL:EQ ANSWER NULL) (CL:RETURN-FROM CLASS-DESTRUCTOR-DEMONS NIL-LIST)
...
(CL:DEFUN ACCESS-CLASS-SLOT-VALUE (SELF SLOTNAME VALUE SETVALUE?)
  (CL:COND
   ((CL:EQ SLOTNAME SYM-HIERARCHY-STELLA-CL-STRUCT?)
    (CL:IF SETVALUE? (CL:SETF (%CL-STRUCT? SELF) (COERCE-WRAPPED-BOOLEAN-TO-BOOLEAN VALUE))
     (CL:SETQ VALUE (CL:IF (%CL-STRUCT? SELF) TRUE-WRAPPER FALSE-WRAPPER))))
   ((CL:EQ SLOTNAME SYM-HIERARCHY-STELLA-MIXIN?)
    (CL:IF SETVALUE? (CL:SETF (%MIXIN? SELF) (COERCE-WRAPPED-BOOLEAN-TO-BOOLEAN VALUE))
     (CL:SETQ VALUE (CL:IF (%MIXIN? SELF) TRUE-WRAPPER FALSE-WRAPPER))))
   ((CL:EQ SLOTNAME SYM-HIERARCHY-STELLA-CLASS-TYPE)
    (CL:IF SETVALUE? (CL:SETF (%CLASS-TYPE SELF) VALUE) (CL:SETQ VALUE (%CLASS-TYPE SELF))))
   ...
   ((CL:EQ SLOTNAME SYM-HIERARCHY-STELLA-CLASS-DIRECT-SUPERS)
    (CL:IF SETVALUE? (CL:SETF (%CLASS-DIRECT-SUPERS SELF) VALUE) (CL:SETQ VALUE (%CLASS-DIRECT-SUPERS SELF))))
   ((CL:EQ SLOTNAME SYM-HIERARCHY-STELLA-CLASS-DIRECT-SUBS)
    (CL:IF SETVALUE? (CL:SETF (%CLASS-DIRECT-SUBS SELF) VALUE) (CL:SETQ VALUE (%CLASS-DIRECT-SUBS SELF))))
   ...
   ((CL:EQ SLOTNAME SYM-HIERARCHY-STELLA-CLASS-ALL-SLOTS)
    (CL:IF SETVALUE? (CL:SETF (%CLASS-ALL-SLOTS SELF) VALUE) (CL:SETQ VALUE (%CLASS-ALL-SLOTS SELF))))
   ((CL:EQ SLOTNAME SYM-HIERARCHY-STELLA-CLASS-LOCAL-SLOTS)
    (CL:IF SETVALUE? (CL:SETF (%CLASS-LOCAL-SLOTS SELF) VALUE) (CL:SETQ VALUE (%CLASS-LOCAL-SLOTS SELF))))
   ((CL:EQ SLOTNAME SYM-HIERARCHY-STELLA-CLASS-SLOT-AND-METHOD-CACHE)
    (CL:IF SETVALUE? (CL:SETF (%CLASS-SLOT-AND-METHOD-CACHE SELF) VALUE)
   ...
   ((CL:EQ SLOTNAME SYM-HIERARCHY-STELLA-CLASS-CL-STRUCT-SLOTS)
    (CL:IF SETVALUE?
     (SET-DYNAMIC-SLOT-VALUE (%DYNAMIC-SLOTS SELF) SYM-HIERARCHY-STELLA-CLASS-CL-STRUCT-SLOTS VALUE NULL)
     (CL:SETQ VALUE (CLASS-CL-STRUCT-SLOTS SELF))))
   ((CL:EQ SLOTNAME SYM-HIERARCHY-STELLA-CLASS-PUBLIC?)
    (CL:IF SETVALUE? (CL:SETF (%CLASS-PUBLIC? SELF) (COERCE-WRAPPED-BOOLEAN-TO-BOOLEAN VALUE))
     (CL:SETQ VALUE (CL:IF (%CLASS-PUBLIC? SELF) TRUE-WRAPPER FALSE-WRAPPER))))
   ((CL:EQ SLOTNAME SYM-HIERARCHY-STELLA-CLASS-RECYCLE-METHOD)
    (CL:IF SETVALUE?
     (SET-DYNAMIC-SLOT-VALUE (%DYNAMIC-SLOTS SELF) SYM-HIERARCHY-STELLA-CLASS-RECYCLE-METHOD VALUE NULL)
   ...
   ((CL:EQ SLOTNAME SYM-HIERARCHY-STELLA-CLASS-STRINGIFIED-SOURCE)
    (CL:IF SETVALUE? (CL:SETF (%CLASS-STRINGIFIED-SOURCE SELF) (%WRAPPER-VALUE VALUE))
     (CL:SETQ VALUE (WRAP-STRING (%CLASS-STRINGIFIED-SOURCE SELF)))))
   ((CL:EQ SLOTNAME SYM-HIERARCHY-STELLA-CLASS-PARAMETERS)
    (CL:IF SETVALUE? (SET-DYNAMIC-SLOT-VALUE (%DYNAMIC-SLOTS SELF) SYM-HIERARCHY-STELLA-CLASS-PARAMETERS VALUE NULL)
     (CL:SETQ VALUE (CLASS-PARAMETERS SELF))))
   ((CL:EQ SLOTNAME SYM-HIERARCHY-STELLA-CLASS-CONSTRUCTOR-CODE)
    (CL:IF SETVALUE? (CL:SETF (%CLASS-CONSTRUCTOR-CODE SELF) (%WRAPPER-VALUE VALUE))
     (CL:SETQ VALUE (WRAP-FUNCTION-CODE (%CLASS-CONSTRUCTOR-CODE SELF)))))
   ((CL:EQ SLOTNAME SYM-HIERARCHY-STELLA-CLASS-SLOT-ACCESSOR-CODE)
    (CL:IF SETVALUE? (CL:SETF (%CLASS-SLOT-ACCESSOR-CODE SELF) (%WRAPPER-VALUE VALUE))
     (CL:SETQ VALUE (WRAP-FUNCTION-CODE (%CLASS-SLOT-ACCESSOR-CODE SELF)))))
   ((CL:EQ SLOTNAME SYM-HIERARCHY-STELLA-CLASS-REQUIRED-SLOT-NAMES)
    (CL:IF SETVALUE?
     (SET-DYNAMIC-SLOT-VALUE (%DYNAMIC-SLOTS SELF) SYM-HIERARCHY-STELLA-CLASS-REQUIRED-SLOT-NAMES VALUE NULL)
     (CL:SETQ VALUE (CLASS-REQUIRED-SLOT-NAMES SELF))))
   ((CL:EQ SLOTNAME SYM-HIERARCHY-STELLA-CLASS-GUARD-CONSTRUCTOR-DEMONS)
    (CL:IF SETVALUE?
     (SET-DYNAMIC-SLOT-VALUE (%DYNAMIC-SLOTS SELF) SYM-HIERARCHY-STELLA-CLASS-GUARD-CONSTRUCTOR-DEMONS VALUE NULL)
     (CL:SETQ VALUE (CLASS-GUARD-CONSTRUCTOR-DEMONS SELF))))
   ((CL:EQ SLOTNAME SYM-HIERARCHY-STELLA-CLASS-CONSTRUCTOR-DEMONS)
    (CL:IF SETVALUE?
     (SET-DYNAMIC-SLOT-VALUE (%DYNAMIC-SLOTS SELF) SYM-HIERARCHY-STELLA-CLASS-CONSTRUCTOR-DEMONS VALUE NULL)
     (CL:SETQ VALUE (CLASS-CONSTRUCTOR-DEMONS SELF))))
   ((CL:EQ SLOTNAME SYM-HIERARCHY-STELLA-CLASS-GUARD-DESTRUCTOR-DEMONS)
    (CL:IF SETVALUE?
     (SET-DYNAMIC-SLOT-VALUE (%DYNAMIC-SLOTS SELF) SYM-HIERARCHY-STELLA-CLASS-GUARD-DESTRUCTOR-DEMONS VALUE NULL)
     (CL:SETQ VALUE (CLASS-GUARD-DESTRUCTOR-DEMONS SELF))))
   ((CL:EQ SLOTNAME SYM-HIERARCHY-STELLA-CLASS-DESTRUCTOR-DEMONS)
    (CL:IF SETVALUE?
     (SET-DYNAMIC-SLOT-VALUE (%DYNAMIC-SLOTS SELF) SYM-HIERARCHY-STELLA-CLASS-DESTRUCTOR-DEMONS VALUE NULL)
     (CL:SETQ VALUE (CLASS-DESTRUCTOR-DEMONS SELF))))
   ((CL:EQ SLOTNAME SYM-HIERARCHY-STELLA-CLASS-KEY)
    (CL:IF SETVALUE? (SET-DYNAMIC-SLOT-VALUE (%DYNAMIC-SLOTS SELF) SYM-HIERARCHY-STELLA-CLASS-KEY VALUE NULL)
     (CL:SETQ VALUE (CLASS-KEY SELF))))
   ((CL:EQ SLOTNAME SYM-HIERARCHY-STELLA-CLASS-SYNONYMS)
    (CL:IF SETVALUE? (SET-DYNAMIC-SLOT-VALUE (%DYNAMIC-SLOTS SELF) SYM-HIERARCHY-STELLA-CLASS-SYNONYMS VALUE NULL)
     (CL:SETQ VALUE (CLASS-SYNONYMS SELF))))
   ((CL:EQ SLOTNAME SYM-HIERARCHY-STELLA-CLASS-MARKED?)
    (CL:IF SETVALUE? (CL:SETF (%CLASS-MARKED? SELF) (COERCE-WRAPPED-BOOLEAN-TO-BOOLEAN VALUE))
     (CL:SETQ VALUE (CL:IF (%CLASS-MARKED? SELF) TRUE-WRAPPER FALSE-WRAPPER))))
   ((CL:EQ SLOTNAME SYM-HIERARCHY-STELLA-CLASS-TAXONOMY-NODE)
    (CL:IF SETVALUE? (CL:SETF (%CLASS-TAXONOMY-NODE SELF) VALUE) (CL:SETQ VALUE (%CLASS-TAXONOMY-NODE SELF))))
   (CL:T
    (CL:COND
     ((CL:EQ SLOTNAME SYM-HIERARCHY-STELLA-CLASS-DOCUMENTATION) (CL:SETQ SLOTNAME SYM-HIERARCHY-STELLA-DOCUMENTATION))
     ((CL:EQ SLOTNAME SYM-HIERARCHY-STELLA-CLASS-PRINT-FORM) (CL:SETQ SLOTNAME SYM-HIERARCHY-STELLA-PRINT-FORM))
     (CL:T))
    (CL:IF SETVALUE? (SET-DYNAMIC-SLOT-VALUE (%DYNAMIC-SLOTS SELF) SLOTNAME VALUE NULL)
     (CL:SETQ VALUE (LOOKUP (%DYNAMIC-SLOTS SELF) SLOTNAME)))))
...
(CL:DEFMETHOD PRINT-OBJECT ((SELF CLASS) STREAM)
  (%%PRINT-STREAM STREAM "|C|"
   (CL:IF (CL:NOT (CL:EQ (%CLASS-TYPE SELF) NULL)) (RELATIVE-NAME (CLASS-SYMBOL SELF) CL:NIL) "??"))
  :VOID)
...
(CL:DEFMETHOD ACTIVE? ((SELF POLYMORPHIC-RELATION))
  ...
  (CL:LET*
   ((CURSOR SELF) (VALUE (DYNAMIC-SLOT-VALUE (%DYNAMIC-SLOTS CURSOR) SYM-HIERARCHY-STELLA-STORED-ACTIVE? NULL)))
   (CL:LOOP (CL:WHEN (CL:NOT (CL:EQ VALUE NULL)) (CL:RETURN-FROM ACTIVE? (COERCE-WRAPPED-BOOLEAN-TO-BOOLEAN VALUE)))
    (CL:SETQ CURSOR (%SLOT-DIRECT-EQUIVALENT CURSOR))
    (CL:IF (CL:NOT (CL:EQ CURSOR NULL))
     (CL:SETQ VALUE (DYNAMIC-SLOT-VALUE (%DYNAMIC-SLOTS CURSOR) SYM-HIERARCHY-STELLA-STORED-ACTIVE? NULL))
...
(CL:DEFMETHOD TYPE ((SELF SLOT))
  ...
  (CL:LET* ((CURSOR SELF) (VALUE (%SLOT-BASE-TYPE CURSOR)))
   (CL:LOOP (CL:WHEN (CL:NOT (CL:EQ VALUE NULL)) (CL:RETURN-FROM TYPE VALUE))
    (CL:SETQ CURSOR (%SLOT-DIRECT-EQUIVALENT CURSOR))
...
(CL:DEFMETHOD HOME-MODULE ((SELF SLOT))
  (CL:LET* ((MODULE (DYNAMIC-SLOT-VALUE (%DYNAMIC-SLOTS SELF) SYM-HIERARCHY-STELLA-SLOT-HOME-MODULE NULL)))
   (CL:IF (CL:NOT (CL:EQ MODULE NULL)) (CL:RETURN-FROM HOME-MODULE MODULE)
...
(CL:DEFMETHOD CLOSURE-ASSUMPTION ((SELF SLOT))
  (CL:LET*
   ((CURSOR SELF)
    (VALUE (DYNAMIC-SLOT-VALUE (%DYNAMIC-SLOTS CURSOR) SYM-HIERARCHY-STELLA-SLOT-CLOSURE-ASSUMPTION NULL)))
   (CL:LOOP (CL:WHEN (CL:NOT (CL:EQ VALUE NULL)) (CL:RETURN-FROM CLOSURE-ASSUMPTION VALUE))
    (CL:SETQ CURSOR (%SLOT-DIRECT-EQUIVALENT CURSOR))
    (CL:IF (CL:NOT (CL:EQ CURSOR NULL))
     (CL:SETQ VALUE (DYNAMIC-SLOT-VALUE (%DYNAMIC-SLOTS CURSOR) SYM-HIERARCHY-STELLA-SLOT-CLOSURE-ASSUMPTION NULL))
...
(CL:DEFUN ACCESS-SLOT-SLOT-VALUE (SELF SLOTNAME VALUE SETVALUE?)
  (CL:COND
   ((CL:EQ SLOTNAME SYM-HIERARCHY-STELLA-SLOT-NAME)
    (CL:IF SETVALUE? (CL:SETF (%SLOT-NAME SELF) VALUE) (CL:SETQ VALUE (%SLOT-NAME SELF))))
   ((CL:EQ SLOTNAME SYM-HIERARCHY-STELLA-SLOT-OWNER)
    (CL:IF SETVALUE? (CL:SETF (%SLOT-OWNER SELF) VALUE) (CL:SETQ VALUE (%SLOT-OWNER SELF))))
   ((CL:EQ SLOTNAME SYM-HIERARCHY-STELLA-SLOT-BASE-TYPE)
    (CL:IF SETVALUE? (CL:SETF (%SLOT-BASE-TYPE SELF) VALUE) (CL:SETQ VALUE (%SLOT-BASE-TYPE SELF))))
   ((CL:EQ SLOTNAME SYM-HIERARCHY-STELLA-SLOT-SLOTREF)
    (CL:IF SETVALUE? (CL:SETF (%SLOT-SLOTREF SELF) VALUE) (CL:SETQ VALUE (%SLOT-SLOTREF SELF))))
   ((CL:EQ SLOTNAME SYM-HIERARCHY-STELLA-SLOT-DIRECT-SUPERS)
    (CL:IF SETVALUE? (SET-DYNAMIC-SLOT-VALUE (%DYNAMIC-SLOTS SELF) SYM-HIERARCHY-STELLA-SLOT-DIRECT-SUPERS VALUE NULL)
     (CL:SETQ VALUE (SLOT-DIRECT-SUPERS SELF))))
   ((CL:EQ SLOTNAME SYM-HIERARCHY-STELLA-SLOT-DIRECT-SUBS)
    (CL:IF SETVALUE? (SET-DYNAMIC-SLOT-VALUE (%DYNAMIC-SLOTS SELF) SYM-HIERARCHY-STELLA-SLOT-DIRECT-SUBS VALUE NULL)
     (CL:SETQ VALUE (SLOT-DIRECT-SUBS SELF))))
   ((CL:EQ SLOTNAME SYM-HIERARCHY-STELLA-SLOT-PUBLIC?)
    (CL:IF SETVALUE? (CL:SETF (%SLOT-PUBLIC? SELF) (COERCE-WRAPPED-BOOLEAN-TO-BOOLEAN VALUE))
     (CL:SETQ VALUE (CL:IF (%SLOT-PUBLIC? SELF) TRUE-WRAPPER FALSE-WRAPPER))))
   ((CL:EQ SLOTNAME SYM-HIERARCHY-STELLA-SLOT-RENAMED?)
    (CL:IF SETVALUE? (CL:SETF (%SLOT-RENAMED? SELF) (COERCE-WRAPPED-BOOLEAN-TO-BOOLEAN VALUE))
     (CL:SETQ VALUE (CL:IF (%SLOT-RENAMED? SELF) TRUE-WRAPPER FALSE-WRAPPER))))
   ...
   ((CL:EQ SLOTNAME SYM-HIERARCHY-STELLA-SLOT-MARKED?)
    (CL:IF SETVALUE? (CL:SETF (%SLOT-MARKED? SELF) (COERCE-WRAPPED-BOOLEAN-TO-BOOLEAN VALUE))
     (CL:SETQ VALUE (CL:IF (%SLOT-MARKED? SELF) TRUE-WRAPPER FALSE-WRAPPER))))
   (CL:T
    (CL:COND
     ((CL:EQ SLOTNAME SYM-HIERARCHY-STELLA-SLOT-DOCUMENTATION) (CL:SETQ SLOTNAME SYM-HIERARCHY-STELLA-DOCUMENTATION))
     (CL:T))
    (CL:IF SETVALUE? (SET-DYNAMIC-SLOT-VALUE (%DYNAMIC-SLOTS SELF) SLOTNAME VALUE NULL)
     (CL:SETQ VALUE (LOOKUP (%DYNAMIC-SLOTS SELF) SLOTNAME)))))
...
(CL:DEFUN NEW-STORAGE-SLOT ()
  (CL:LET* ((SELF NULL)) (CL:SETQ SELF (CL:MAKE-INSTANCE (CL:QUOTE STORAGE-SLOT)))
   (CL:SETF (%DYNAMIC-SLOTS SELF) (NEW-KEY-VALUE-LIST)) (CL:SETF (%ABSTRACT? SELF) CL:NIL)
   (CL:SETF (%SLOT-DIRECT-EQUIVALENT SELF) NULL) (CL:SETF (%SLOT-MARKED? SELF) CL:NIL)
   (CL:SETF (%SLOT-EXTERNAL? SELF) CL:NIL) (CL:SETF (%SLOT-RENAMED? SELF) CL:NIL) (CL:SETF (%SLOT-PUBLIC? SELF) CL:T)
   (CL:SETF (%SLOT-SLOTREF SELF) NULL) (CL:SETF (%SLOT-BASE-TYPE SELF) NULL) (CL:SETF (%SLOT-OWNER SELF) NULL)
   (CL:SETF (%SLOT-NAME SELF) NULL) (CL:SETF (%SLOT-CONTEXT-SENSITIVE? SELF) CL:NIL)
   (CL:SETF (%SLOT-HARDWIRED? SELF) CL:NIL) (CL:SETF (%SLOT-READ-ONLY? SELF) CL:NIL)
   (CL:SETF (%SLOT-COMPONENT? SELF) CL:NIL) (CL:SETF (%SLOT-REQUIRED? SELF) CL:NIL)
...
:instance if all inherited values are NULL."
  (CL:LET*
   ((CURSOR SELF) (VALUE (DYNAMIC-SLOT-VALUE (%DYNAMIC-SLOTS CURSOR) SYM-HIERARCHY-STELLA-SLOT-ALLOCATION NULL)))
   (CL:LOOP (CL:WHEN (CL:NOT (CL:EQ VALUE NULL)) (CL:RETURN-FROM ALLOCATION VALUE))
    (CL:SETQ CURSOR (%SLOT-DIRECT-EQUIVALENT CURSOR))
    (CL:IF (CL:NOT (CL:EQ CURSOR NULL))
     (CL:SETQ VALUE (DYNAMIC-SLOT-VALUE (%DYNAMIC-SLOTS CURSOR) SYM-HIERARCHY-STELLA-SLOT-ALLOCATION NULL))
...
slot has not been assigned a value."
  (CL:LET*
   ((CURSOR SELF)
    (VALUE (DYNAMIC-SLOT-VALUE (%DYNAMIC-SLOTS CURSOR) SYM-HIERARCHY-STELLA-SLOT-DEFAULT-EXPRESSION NULL)))
   (CL:LOOP (CL:WHEN (CL:NOT (CL:EQ VALUE NULL)) (CL:RETURN-FROM DEFAULT-FORM VALUE))
    (CL:SETQ CURSOR (%SLOT-DIRECT-EQUIVALENT CURSOR))
    (CL:IF (CL:NOT (CL:EQ CURSOR NULL))
     (CL:SETQ VALUE (DYNAMIC-SLOT-VALUE (%DYNAMIC-SLOTS CURSOR) SYM-HIERARCHY-STELLA-SLOT-DEFAULT-EXPRESSION NULL))
...
`self'."
  (CL:LET* ((CURSOR SELF) (VALUE (DYNAMIC-SLOT-VALUE (%DYNAMIC-SLOTS CURSOR) SYM-HIERARCHY-STELLA-SLOT-READER NULL)))
   (CL:LOOP (CL:WHEN (CL:NOT (CL:EQ VALUE NULL)) (CL:RETURN-FROM READER VALUE))
    (CL:SETQ CURSOR (%SLOT-DIRECT-EQUIVALENT CURSOR))
    (CL:IF (CL:NOT (CL:EQ CURSOR NULL))
     (CL:SETQ VALUE (DYNAMIC-SLOT-VALUE (%DYNAMIC-SLOTS CURSOR) SYM-HIERARCHY-STELLA-SLOT-READER NULL))
...
`self'."
  (CL:LET* ((CURSOR SELF) (VALUE (DYNAMIC-SLOT-VALUE (%DYNAMIC-SLOTS CURSOR) SYM-HIERARCHY-STELLA-SLOT-WRITER NULL)))
   (CL:LOOP (CL:WHEN (CL:NOT (CL:EQ VALUE NULL)) (CL:RETURN-FROM WRITER VALUE))
    (CL:SETQ CURSOR (%SLOT-DIRECT-EQUIVALENT CURSOR))
    (CL:IF (CL:NOT (CL:EQ CURSOR NULL))
     (CL:SETQ VALUE (DYNAMIC-SLOT-VALUE (%DYNAMIC-SLOTS CURSOR) SYM-HIERARCHY-STELLA-SLOT-WRITER NULL))
...
(CL:DEFMETHOD SLOT-ALLOCATION ((SELF STORAGE-SLOT))
  (CL:LET* ((ANSWER (DYNAMIC-SLOT-VALUE (%DYNAMIC-SLOTS SELF) SYM-HIERARCHY-STELLA-SLOT-ALLOCATION NULL)))
   (CL:IF (CL:EQ ANSWER NULL) (CL:RETURN-FROM SLOT-ALLOCATION KWD-HIERARCHY-INSTANCE)
...
(CL:DEFUN ACCESS-STORAGE-SLOT-SLOT-VALUE (SELF SLOTNAME VALUE SETVALUE?)
  (CL:COND
   ((CL:EQ SLOTNAME SYM-HIERARCHY-STELLA-SLOT-ALLOCATION)
    (CL:IF SETVALUE? (SET-DYNAMIC-SLOT-VALUE (%DYNAMIC-SLOTS SELF) SYM-HIERARCHY-STELLA-SLOT-ALLOCATION VALUE NULL)
     (CL:SETQ VALUE (SLOT-ALLOCATION SELF))))
   ((CL:EQ SLOTNAME SYM-HIERARCHY-STELLA-SLOT-GUARD-DEMONS)
    (CL:IF SETVALUE? (SET-DYNAMIC-SLOT-VALUE (%DYNAMIC-SLOTS SELF) SYM-HIERARCHY-STELLA-SLOT-GUARD-DEMONS VALUE NULL)
     (CL:SETQ VALUE (SLOT-GUARD-DEMONS SELF))))
   ((CL:EQ SLOTNAME SYM-HIERARCHY-STELLA-SLOT-DEMONS)
    (CL:IF SETVALUE? (SET-DYNAMIC-SLOT-VALUE (%DYNAMIC-SLOTS SELF) SYM-HIERARCHY-STELLA-SLOT-DEMONS VALUE NULL)
...
(CL:DEFCLASS METHOD-SLOT (SLOT)
  ((METHOD-SETTER? :ALLOCATION :INSTANCE :ACCESSOR %METHOD-SETTER?)
   (METHOD-PARAMETER-NAMES :ALLOCATION :INSTANCE :ACCESSOR %METHOD-PARAMETER-NAMES)
   ...
   (METHOD-STRINGIFIED-SOURCE :TYPE CL:SIMPLE-STRING :INITFORM STELLA::NULL-STRING :ALLOCATION :INSTANCE :ACCESSOR
...
(CL:DEFUN NEW-METHOD-SLOT ()
  (CL:LET* ((SELF NULL)) (CL:SETQ SELF (CL:MAKE-INSTANCE (CL:QUOTE METHOD-SLOT)))
   (CL:SETF (%DYNAMIC-SLOTS SELF) (NEW-KEY-VALUE-LIST)) (CL:SETF (%ABSTRACT? SELF) CL:NIL)
   (CL:SETF (%SLOT-DIRECT-EQUIVALENT SELF) NULL) (CL:SETF (%SLOT-MARKED? SELF) CL:NIL)
   (CL:SETF (%SLOT-EXTERNAL? SELF) CL:NIL) (CL:SETF (%SLOT-RENAMED? SELF) CL:NIL) (CL:SETF (%SLOT-PUBLIC? SELF) CL:T)
   (CL:SETF (%SLOT-SLOTREF SELF) NULL) (CL:SETF (%SLOT-BASE-TYPE SELF) NULL) (CL:SETF (%SLOT-OWNER SELF) NULL)
   (CL:SETF (%SLOT-NAME SELF) NULL) (CL:SETF (%METHOD-FUNCTION? SELF) CL:NIL) (CL:SETF (%FUNCTION-CODE SELF) NULL)
   (CL:SETF (%METHOD-CODE SELF) NULL) (CL:SETF (%METHOD-STRINGIFIED-SOURCE SELF) STELLA::NULL-STRING)
   (CL:SETF (%METHOD-RETURN-TYPE-SPECIFIERS SELF) NULL) (CL:SETF (%METHOD-PARAMETER-TYPE-SPECIFIERS SELF) NULL)
   (CL:SETF (%METHOD-PARAMETER-NAMES SELF) NULL) (CL:SETF (%METHOD-SETTER? SELF) CL:NIL)
...
(CL:DEFMETHOD METHOD-PARAMETER-NAMES ((SELF METHOD-SLOT))
  (CL:LET* ((ANSWER (%METHOD-PARAMETER-NAMES SELF)))
   (CL:IF (CL:EQ ANSWER NULL) (CL:RETURN-FROM METHOD-PARAMETER-NAMES NIL-LIST)
...
(CL:DEFMETHOD METHOD-PARAMETER-TYPE-SPECIFIERS ((SELF METHOD-SLOT))
  (CL:LET* ((ANSWER (%METHOD-PARAMETER-TYPE-SPECIFIERS SELF)))
   (CL:IF (CL:EQ ANSWER NULL) (CL:RETURN-FROM METHOD-PARAMETER-TYPE-SPECIFIERS NIL-LIST)
...
(CL:DEFMETHOD METHOD-PARAMETER-DIRECTIONS ((SELF METHOD-SLOT))
  (CL:LET* ((ANSWER (DYNAMIC-SLOT-VALUE (%DYNAMIC-SLOTS SELF) SYM-HIERARCHY-STELLA-METHOD-PARAMETER-DIRECTIONS NULL)))
   (CL:IF (CL:EQ ANSWER NULL) (CL:RETURN-FROM METHOD-PARAMETER-DIRECTIONS NIL-LIST)
...
(CL:DEFMETHOD METHOD-RETURN-TYPE-SPECIFIERS ((SELF METHOD-SLOT))
  (CL:LET* ((ANSWER (%METHOD-RETURN-TYPE-SPECIFIERS SELF)))
   (CL:IF (CL:EQ ANSWER NULL) (CL:RETURN-FROM METHOD-RETURN-TYPE-SPECIFIERS NIL-LIST)
...
(CL:DEFMETHOD METHOD-INLINED-FUNCTIONS ((SELF METHOD-SLOT))
  (CL:LET* ((ANSWER (DYNAMIC-SLOT-VALUE (%DYNAMIC-SLOTS SELF) SYM-HIERARCHY-STELLA-METHOD-INLINED-FUNCTIONS NULL)))
   (CL:IF (CL:EQ ANSWER NULL) (CL:RETURN-FROM METHOD-INLINED-FUNCTIONS NIL-LIST)
...
(CL:DEFMETHOD METHOD-EVALUATE-ARGUMENTS? ((SELF METHOD-SLOT))
  (CL:RETURN-FROM METHOD-EVALUATE-ARGUMENTS?
   (%WRAPPER-VALUE
    (DYNAMIC-SLOT-VALUE (%DYNAMIC-SLOTS SELF) SYM-HIERARCHY-STELLA-METHOD-EVALUATE-ARGUMENTS? TRUE-WRAPPER))))
...
(CL:DEFUN ACCESS-METHOD-SLOT-SLOT-VALUE (SELF SLOTNAME VALUE SETVALUE?)
  (CL:COND
   ...
   ((CL:EQ SLOTNAME SYM-HIERARCHY-STELLA-METHOD-INLINED-FUNCTIONS)
    (CL:IF SETVALUE?
     (SET-DYNAMIC-SLOT-VALUE (%DYNAMIC-SLOTS SELF) SYM-HIERARCHY-STELLA-METHOD-INLINED-FUNCTIONS VALUE NULL)
   ...
   (CL:T
    (CL:COND
     ((CL:EQ SLOTNAME SYM-HIERARCHY-STELLA-METHOD-DOCUMENTATION) (CL:SETQ SLOTNAME SYM-HIERARCHY-STELLA-DOCUMENTATION))
     ((CL:EQ SLOTNAME SYM-HIERARCHY-STELLA-METHOD-AUXILIARY?) (CL:SETQ SLOTNAME SYM-HIERARCHY-STELLA-SLOT-AUXILIARY?))
     ((CL:EQ SLOTNAME SYM-HIERARCHY-STELLA-METHOD-STORAGE-SLOT) (CL:SETQ SLOTNAME SYM-HIERARCHY-STELLA-STORAGE-SLOT))
     (CL:T))
    (CL:IF SETVALUE? (SET-DYNAMIC-SLOT-VALUE (%DYNAMIC-SLOTS SELF) SLOTNAME VALUE NULL)
     (CL:SETQ VALUE (LOOKUP (%DYNAMIC-SLOTS SELF) SLOTNAME)))))
...
(CL:DEFCLASS PARAMETRIC-TYPE-SPECIFIER (COMPOUND-TYPE-SPECIFIER)
  ((SPECIFIER-BASE-TYPE :ALLOCATION :INSTANCE :ACCESSOR %SPECIFIER-BASE-TYPE)
   (SPECIFIER-PARAMETER-TYPES :ALLOCATION :INSTANCE :ACCESSOR %SPECIFIER-PARAMETER-TYPES)
   (SPECIFIER-DIMENSIONS :ALLOCATION :INSTANCE :ACCESSOR %SPECIFIER-DIMENSIONS)))

(CL:DEFUN NEW-PARAMETRIC-TYPE-SPECIFIER ()
  (CL:LET* ((SELF NULL)) (CL:SETQ SELF (CL:MAKE-INSTANCE (CL:QUOTE PARAMETRIC-TYPE-SPECIFIER)))
   (CL:SETF (%SPECIFIER-DIMENSIONS SELF) NULL) (CL:SETF (%SPECIFIER-PARAMETER-TYPES SELF) (NEW-LIST))
   (CL:SETF (%SPECIFIER-BASE-TYPE SELF) NULL) (CL:RETURN-FROM NEW-PARAMETRIC-TYPE-SPECIFIER SELF)))
...
(CL:DEFUN ACCESS-PARAMETRIC-TYPE-SPECIFIER-SLOT-VALUE (SELF SLOTNAME VALUE SETVALUE?)
  (CL:COND
   ((CL:EQ SLOTNAME SYM-HIERARCHY-STELLA-SPECIFIER-BASE-TYPE)
    (CL:IF SETVALUE? (CL:SETF (%SPECIFIER-BASE-TYPE SELF) VALUE) (CL:SETQ VALUE (%SPECIFIER-BASE-TYPE SELF))))
...
(CL:DEFUN NEW-ANCHORED-TYPE-SPECIFIER ()
  (CL:LET* ((SELF NULL)) (CL:SETQ SELF (CL:MAKE-INSTANCE (CL:QUOTE ANCHORED-TYPE-SPECIFIER)))
   (CL:SETF (%SPECIFIER-PARAMETER-NAME SELF) NULL) (CL:RETURN-FROM NEW-ANCHORED-TYPE-SPECIFIER SELF)))
...
(CL:DEFUN NEW-TABLE ()
  (CL:LET* ((SELF NULL)) (CL:SETQ SELF (CL:MAKE-INSTANCE (CL:QUOTE TABLE)))
   (CL:SETF (%DYNAMIC-SLOTS SELF) (NEW-KEY-VALUE-LIST)) (CL:SETF (%ABSTRACT? SELF) CL:NIL)
   (CL:SETF (%SLOT-DIRECT-EQUIVALENT SELF) NULL) (CL:SETF (%SLOT-MARKED? SELF) CL:NIL)
   (CL:SETF (%SLOT-EXTERNAL? SELF) CL:NIL) (CL:SETF (%SLOT-RENAMED? SELF) CL:NIL) (CL:SETF (%SLOT-PUBLIC? SELF) CL:T)
   (CL:SETF (%SLOT-SLOTREF SELF) NULL) (CL:SETF (%SLOT-BASE-TYPE SELF) NULL) (CL:SETF (%SLOT-OWNER SELF) NULL)
...
(CL:DEFUN ACCESS-TABLE-SLOT-VALUE (SELF SLOTNAME VALUE SETVALUE?)
  (CL:COND
   ((CL:EQ SLOTNAME SYM-HIERARCHY-STELLA-TUPLE-DOMAINS)
    (CL:IF SETVALUE? (CL:SETF (%TUPLE-DOMAINS SELF) VALUE) (CL:SETQ VALUE (%TUPLE-DOMAINS SELF))))
   (CL:T
    (CL:IF SETVALUE? (SET-DYNAMIC-SLOT-VALUE (%DYNAMIC-SLOTS SELF) SLOTNAME VALUE NULL)
     (CL:SETQ VALUE (LOOKUP (%DYNAMIC-SLOTS SELF) SLOTNAME)))))
...
(CL:DEFCLASS GLOBAL-VARIABLE (MAPPABLE-OBJECT)
  ((DOCUMENTATION :TYPE CL:SIMPLE-STRING :INITFORM STELLA::NULL-STRING :ALLOCATION :INSTANCE :ACCESSOR %DOCUMENTATION)
   ...
   (VARIABLE-SPECIAL? :ALLOCATION :INSTANCE :ACCESSOR %VARIABLE-SPECIAL?)
   (VARIABLE-CONSTANT? :ALLOCATION :INSTANCE :ACCESSOR %VARIABLE-CONSTANT?)
   (VARIABLE-PUBLIC? :ALLOCATION :INSTANCE :ACCESSOR %VARIABLE-PUBLIC?)
   (VARIABLE-AUXILIARY? :ALLOCATION :INSTANCE :ACCESSOR %VARIABLE-AUXILIARY?)
   (VARIABLE-GET-VALUE-CODE :ALLOCATION :INSTANCE :ACCESSOR %VARIABLE-GET-VALUE-CODE)
   (VARIABLE-SET-VALUE-CODE :ALLOCATION :INSTANCE :ACCESSOR %VARIABLE-SET-VALUE-CODE)
   (VARIABLE-VALUE-STACK :ALLOCATION :INSTANCE :ACCESSOR %VARIABLE-VALUE-STACK)
   (VARIABLE-STRINGIFIED-SOURCE :TYPE CL:SIMPLE-STRING :INITFORM STELLA::NULL-STRING :ALLOCATION :INSTANCE :ACCESSOR
    %VARIABLE-STRINGIFIED-SOURCE)))

(CL:DEFUN NEW-GLOBAL-VARIABLE ()
  (CL:LET* ((SELF NULL)) (CL:SETQ SELF (CL:MAKE-INSTANCE (CL:QUOTE GLOBAL-VARIABLE)))
   (CL:SETF (%DYNAMIC-SLOTS SELF) (NEW-KEY-VALUE-LIST))
   (CL:SETF (%VARIABLE-STRINGIFIED-SOURCE SELF) STELLA::NULL-STRING)
   (CL:SETF (%DOCUMENTATION SELF) STELLA::NULL-STRING) (CL:SETF (%VARIABLE-VALUE-STACK SELF) NULL)
   (CL:SETF (%VARIABLE-SET-VALUE-CODE SELF) NULL) (CL:SETF (%VARIABLE-GET-VALUE-CODE SELF) NULL)
   (CL:SETF (%VARIABLE-AUXILIARY? SELF) CL:NIL) (CL:SETF (%VARIABLE-PUBLIC? SELF) CL:T)
   (CL:SETF (%VARIABLE-CONSTANT? SELF) CL:NIL) (CL:SETF (%VARIABLE-SPECIAL? SELF) CL:NIL)
   (CL:SETF (%VARIABLE-TYPE SELF) NULL) (CL:SETF (%VARIABLE-NAME SELF) NULL) (CL:RETURN-FROM NEW-GLOBAL-VARIABLE SELF)))
...
(CL:DEFUN ACCESS-GLOBAL-VARIABLE-SLOT-VALUE (SELF SLOTNAME VALUE SETVALUE?)
  (CL:COND
   ...
   ((CL:EQ SLOTNAME SYM-HIERARCHY-STELLA-VARIABLE-NAME)
    (CL:IF SETVALUE? (CL:SETF (%VARIABLE-NAME SELF) VALUE) (CL:SETQ VALUE (%VARIABLE-NAME SELF))))
   ((CL:EQ SLOTNAME SYM-HIERARCHY-STELLA-VARIABLE-TYPE)
    (CL:IF SETVALUE? (CL:SETF (%VARIABLE-TYPE SELF) VALUE) (CL:SETQ VALUE (%VARIABLE-TYPE SELF))))
   ...
   ((CL:EQ SLOTNAME SYM-HIERARCHY-STELLA-VARIABLE-GET-VALUE-CODE)
    (CL:IF SETVALUE? (CL:SETF (%VARIABLE-GET-VALUE-CODE SELF) (%WRAPPER-VALUE VALUE))
     (CL:SETQ VALUE (WRAP-FUNCTION-CODE (%VARIABLE-GET-VALUE-CODE SELF)))))
   ((CL:EQ SLOTNAME SYM-HIERARCHY-STELLA-VARIABLE-SET-VALUE-CODE)
    (CL:IF SETVALUE? (CL:SETF (%VARIABLE-SET-VALUE-CODE SELF) (%WRAPPER-VALUE VALUE))
     (CL:SETQ VALUE (WRAP-FUNCTION-CODE (%VARIABLE-SET-VALUE-CODE SELF)))))
   ...
   ((CL:EQ SLOTNAME SYM-HIERARCHY-STELLA-VARIABLE-STRINGIFIED-SOURCE)
    (CL:IF SETVALUE? (CL:SETF (%VARIABLE-STRINGIFIED-SOURCE SELF) (%WRAPPER-VALUE VALUE))
     (CL:SETQ VALUE (WRAP-STRING (%VARIABLE-STRINGIFIED-SOURCE SELF)))))
   (CL:T
    (CL:IF SETVALUE? (SET-DYNAMIC-SLOT-VALUE (%DYNAMIC-SLOTS SELF) SLOTNAME VALUE NULL)
     (CL:SETQ VALUE (LOOKUP (%DYNAMIC-SLOTS SELF) SLOTNAME)))))
...
(CL:DEFCLASS QUOTED-EXPRESSION (STANDARD-OBJECT)
  ((QUOTATION-TABLE-OFFSET :TYPE CL:FIXNUM :INITFORM NULL-INTEGER :ALLOCATION :INSTANCE :ACCESSOR
    %QUOTATION-TABLE-OFFSET)))

(CL:DEFUN NEW-QUOTED-EXPRESSION ()
  (CL:LET* ((SELF NULL)) (CL:SETQ SELF (CL:MAKE-INSTANCE (CL:QUOTE QUOTED-EXPRESSION)))
   (CL:SETF (%QUOTATION-TABLE-OFFSET SELF) NULL-INTEGER) (CL:RETURN-FROM NEW-QUOTED-EXPRESSION SELF)))
...
(CL:DEFUN ACCESS-QUOTED-EXPRESSION-SLOT-VALUE (SELF SLOTNAME VALUE SETVALUE?)
  (CL:COND
   ((CL:EQ SLOTNAME SYM-HIERARCHY-STELLA-QUOTATION-TABLE-OFFSET)
    (CL:IF SETVALUE? (CL:SETF (%QUOTATION-TABLE-OFFSET SELF) (%WRAPPER-VALUE VALUE))
...
(CL:DEFMETHOD PRINT-OBJECT ((SELF THING) STREAM)
  (CL:IF (CL:NOT (CL:EQ (%SURROGATE-VALUE-INVERSE SELF) NULL))
   (%%PRINT-STREAM STREAM "|i|" (%SYMBOL-NAME (%SURROGATE-VALUE-INVERSE SELF)))
   (%%PRINT-STREAM STREAM "|i|" (PRIMARY-TYPE SELF)))
  :VOID)
     ...
     ((SUBTYPE-OF? TEST-VALUE-000 SGT-HIERARCHY-STELLA-WORLD)
      (CL:PROGN
       (CL:RETURN-FROM CONTEXT-NAME
        (%WRAPPER-VALUE
         (DYNAMIC-SLOT-VALUE (%DYNAMIC-SLOTS AUX) SYM-HIERARCHY-STELLA-WORLD-NAME NULL-STRING-WRAPPER)))))
     (CL:T
      (CL:LET* ((STREAM-000 (NEW-OUTPUT-STRING-STREAM)))
...
(CL:DEFUN ACCESS-CONTEXT-SLOT-VALUE (SELF SLOTNAME VALUE SETVALUE?)
  (CL:COND
   ((CL:EQ SLOTNAME SYM-HIERARCHY-STELLA-CHILD-CONTEXTS)
    (CL:IF SETVALUE? (CL:SETF (%CHILD-CONTEXTS SELF) VALUE) (CL:SETQ VALUE (%CHILD-CONTEXTS SELF))))
   ((CL:EQ SLOTNAME SYM-HIERARCHY-STELLA-BASE-MODULE)
    (CL:IF SETVALUE? (CL:SETF (%BASE-MODULE SELF) VALUE) (CL:SETQ VALUE (%BASE-MODULE SELF))))
   ((CL:EQ SLOTNAME SYM-HIERARCHY-STELLA-ALL-SUPER-CONTEXTS)
    (CL:IF SETVALUE? (CL:SETF (%ALL-SUPER-CONTEXTS SELF) VALUE) (CL:SETQ VALUE (%ALL-SUPER-CONTEXTS SELF))))
   ((CL:EQ SLOTNAME SYM-HIERARCHY-STELLA-CONTEXT-NUMBER)
    (CL:IF SETVALUE? (CL:SETF (%CONTEXT-NUMBER SELF) (%WRAPPER-VALUE VALUE))
...
(CL:DEFCLASS MODULE (CONTEXT)
  ((PARENT-MODULES :ALLOCATION :INSTANCE :ACCESSOR %PARENT-MODULES)
   (DOCUMENTATION :TYPE CL:SIMPLE-STRING :INITFORM STELLA::NULL-STRING :ALLOCATION :INSTANCE :ACCESSOR %DOCUMENTATION)
   (NICKNAMES :ALLOCATION :INSTANCE :ACCESSOR %NICKNAMES) (USES :ALLOCATION :INSTANCE :ACCESSOR %USES)
   (USED-BY :ALLOCATION :INSTANCE :ACCESSOR %USED-BY) (REQUIRES :ALLOCATION :INSTANCE :ACCESSOR %REQUIRES)
   (CASE-SENSITIVE? :ALLOCATION :INSTANCE :ACCESSOR %CASE-SENSITIVE?)
   (MODULE-FULL-NAME :TYPE CL:SIMPLE-STRING :INITFORM STELLA::NULL-STRING :ALLOCATION :INSTANCE :ACCESSOR
    %MODULE-FULL-NAME)
   (MODULE-NAME :TYPE CL:SIMPLE-STRING :INITFORM STELLA::NULL-STRING :ALLOCATION :INSTANCE :ACCESSOR %MODULE-NAME)
   (MODULE-STRINGIFIED-SOURCE :TYPE CL:SIMPLE-STRING :INITFORM STELLA::NULL-STRING :ALLOCATION :INSTANCE :ACCESSOR
    %MODULE-STRINGIFIED-SOURCE)
   (STRINGIFIED-OPTIONS :TYPE CL:SIMPLE-STRING :INITFORM STELLA::NULL-STRING :ALLOCATION :INSTANCE :ACCESSOR
    %STRINGIFIED-OPTIONS)
   (CARDINAL-MODULE :ALLOCATION :INSTANCE :ACCESSOR %CARDINAL-MODULE)
   (SYMBOL-OFFSET-TABLE :ALLOCATION :INSTANCE :ACCESSOR %SYMBOL-OFFSET-TABLE)
   (SURROGATE-OFFSET-TABLE :ALLOCATION :INSTANCE :ACCESSOR %SURROGATE-OFFSET-TABLE)
   (STRICT-INFERENCE-CACHE :ALLOCATION :INSTANCE :ACCESSOR %STRICT-INFERENCE-CACHE)
...
(CL:DEFUN NEW-MODULE ()
  (CL:LET* ((SELF NULL)) (CL:SETQ SELF (CL:MAKE-INSTANCE (CL:QUOTE MODULE)))
   (CL:SETF (%DYNAMIC-SLOTS SELF) (NEW-KEY-VALUE-LIST)) (CL:SETF (%SURROGATE-VALUE-INVERSE SELF) NULL)
   (CL:SETF (%CONTEXT-NUMBER SELF) NULL-INTEGER) (CL:SETF (%ALL-SUPER-CONTEXTS SELF) NULL)
   (CL:SETF (%BASE-MODULE SELF) NULL) (CL:SETF (%CHILD-CONTEXTS SELF) (NEW-LIST))
   (CL:SETF (%PROTOTYPE-INFERENCE-CACHE SELF) NULL) (CL:SETF (%DEFAULT-INFERENCE-CACHE SELF) NULL)
   (CL:SETF (%STRICT-INFERENCE-CACHE SELF) NULL) (CL:SETF (%SURROGATE-OFFSET-TABLE SELF) NULL)
   (CL:SETF (%SYMBOL-OFFSET-TABLE SELF) NULL) (CL:SETF (%CARDINAL-MODULE SELF) NULL)
   ...
   (CL:SETF (%MODULE-FULL-NAME SELF) STELLA::NULL-STRING) (CL:SETF (%CASE-SENSITIVE? SELF) CL:NIL)
   (CL:SETF (%REQUIRES SELF) NULL) (CL:SETF (%USED-BY SELF) (NEW-LIST)) (CL:SETF (%USES SELF) (NEW-LIST))
   (CL:SETF (%NICKNAMES SELF) NULL) (CL:SETF (%DOCUMENTATION SELF) STELLA::NULL-STRING)
   (CL:SETF (%PARENT-MODULES SELF) (NEW-LIST)) (CL:RETURN-FROM NEW-MODULE SELF)))
...
(CL:DEFMETHOD LISP-PACKAGE ((SELF MODULE))
  (CL:LET*
   ((CURSOR SELF)
    (VALUE
     (%WRAPPER-VALUE
      (DYNAMIC-SLOT-VALUE (%DYNAMIC-SLOTS CURSOR) SYM-HIERARCHY-STELLA-MODULE-LISP-PACKAGE NULL-STRING-WRAPPER))))
   (CL:DECLARE (CL:TYPE CL:SIMPLE-STRING VALUE))
   (CL:LOOP (CL:WHEN (CL:NOT (CL:EQ VALUE STELLA::NULL-STRING)) (CL:RETURN-FROM LISP-PACKAGE VALUE))
...
(CL:DEFMETHOD CPP-PACKAGE ((SELF MODULE))
  (CL:LET*
   ((CURSOR SELF)
    (VALUE
     (%WRAPPER-VALUE
      (DYNAMIC-SLOT-VALUE (%DYNAMIC-SLOTS CURSOR) SYM-HIERARCHY-STELLA-MODULE-CPP-PACKAGE NULL-STRING-WRAPPER))))
   (CL:DECLARE (CL:TYPE CL:SIMPLE-STRING VALUE))
   (CL:LOOP (CL:WHEN (CL:NOT (CL:EQ VALUE STELLA::NULL-STRING)) (CL:RETURN-FROM CPP-PACKAGE VALUE))
    (CL:SETQ CURSOR (FIRST (%PARENT-MODULES CURSOR)))
    (CL:IF (CL:NOT (CL:EQ CURSOR NULL))
     (CL:SETQ VALUE
      (%WRAPPER-VALUE
...
(CL:DEFMETHOD SHADOWED-SURROGATES ((SELF MODULE))
  (CL:LET* ((ANSWER (DYNAMIC-SLOT-VALUE (%DYNAMIC-SLOTS SELF) SYM-HIERARCHY-STELLA-SHADOWED-SURROGATES NULL)))
   (CL:IF (CL:EQ ANSWER NULL) (CL:RETURN-FROM SHADOWED-SURROGATES NIL-LIST)
...
(CL:DEFMETHOD MODULE-LISP-PACKAGE ((SELF MODULE))
  (CL:LET*
   ((ANSWER
     (%WRAPPER-VALUE
      (DYNAMIC-SLOT-VALUE (%DYNAMIC-SLOTS SELF) SYM-HIERARCHY-STELLA-MODULE-LISP-PACKAGE NULL-STRING-WRAPPER))))
   (CL:DECLARE (CL:TYPE CL:SIMPLE-STRING ANSWER))
   (CL:IF (CL:EQ ANSWER STELLA::NULL-STRING) (CL:RETURN-FROM MODULE-LISP-PACKAGE "STELLA")
...
(CL:DEFMETHOD MODULE-CPP-PACKAGE ((SELF MODULE))
  (CL:LET*
   ((ANSWER
     (%WRAPPER-VALUE
      (DYNAMIC-SLOT-VALUE (%DYNAMIC-SLOTS SELF) SYM-HIERARCHY-STELLA-MODULE-CPP-PACKAGE NULL-STRING-WRAPPER))))
   (CL:DECLARE (CL:TYPE CL:SIMPLE-STRING ANSWER))
   (CL:IF (CL:EQ ANSWER STELLA::NULL-STRING) (CL:RETURN-FROM MODULE-CPP-PACKAGE "stella")
...
(CL:DEFMETHOD JAVA-PACKAGE ((SELF MODULE))
  (CL:LET*
   ((ANSWER
     (%WRAPPER-VALUE
      (DYNAMIC-SLOT-VALUE (%DYNAMIC-SLOTS SELF) SYM-HIERARCHY-STELLA-JAVA-PACKAGE NULL-STRING-WRAPPER))))
   (CL:DECLARE (CL:TYPE CL:SIMPLE-STRING ANSWER))
   (CL:IF (CL:EQ ANSWER STELLA::NULL-STRING) (CL:RETURN-FROM JAVA-PACKAGE STELLA::NULL-STRING)
    (CL:RETURN-FROM JAVA-PACKAGE ANSWER))))

(CL:DEFMETHOD CLEARABLE? ((SELF MODULE))
  (CL:RETURN-FROM CLEARABLE?
   (%WRAPPER-VALUE (DYNAMIC-SLOT-VALUE (%DYNAMIC-SLOTS SELF) SYM-HIERARCHY-STELLA-CLEARABLE? TRUE-WRAPPER))))

(CL:DEFMETHOD PROTECT-SURROGATES? ((SELF MODULE))
  (CL:RETURN-FROM PROTECT-SURROGATES?
   (%WRAPPER-VALUE (DYNAMIC-SLOT-VALUE (%DYNAMIC-SLOTS SELF) SYM-HIERARCHY-STELLA-PROTECT-SURROGATES? TRUE-WRAPPER))))

(CL:DEFUN ACCESS-MODULE-SLOT-VALUE (SELF SLOTNAME VALUE SETVALUE?)
  (CL:COND
   ((CL:EQ SLOTNAME SYM-HIERARCHY-STELLA-PARENT-MODULES)
    (CL:IF SETVALUE? (CL:SETF (%PARENT-MODULES SELF) VALUE) (CL:SETQ VALUE (%PARENT-MODULES SELF))))
   ((CL:EQ SLOTNAME SYM-HIERARCHY-STELLA-DOCUMENTATION)
    (CL:IF SETVALUE? (CL:SETF (%DOCUMENTATION SELF) (%WRAPPER-VALUE VALUE))
     (CL:SETQ VALUE (WRAP-STRING (%DOCUMENTATION SELF)))))
   ((CL:EQ SLOTNAME SYM-HIERARCHY-STELLA-NICKNAMES)
    (CL:IF SETVALUE? (CL:SETF (%NICKNAMES SELF) VALUE) (CL:SETQ VALUE (%NICKNAMES SELF))))
   ((CL:EQ SLOTNAME SYM-HIERARCHY-STELLA-USES)
    (CL:IF SETVALUE? (CL:SETF (%USES SELF) VALUE) (CL:SETQ VALUE (%USES SELF))))
   ((CL:EQ SLOTNAME SYM-HIERARCHY-STELLA-USED-BY)
    (CL:IF SETVALUE? (CL:SETF (%USED-BY SELF) VALUE) (CL:SETQ VALUE (%USED-BY SELF))))
   ((CL:EQ SLOTNAME SYM-HIERARCHY-STELLA-SHADOWED-SURROGATES)
    (CL:IF SETVALUE? (SET-DYNAMIC-SLOT-VALUE (%DYNAMIC-SLOTS SELF) SYM-HIERARCHY-STELLA-SHADOWED-SURROGATES VALUE NULL)
     (CL:SETQ VALUE (SHADOWED-SURROGATES SELF))))
   ((CL:EQ SLOTNAME SYM-HIERARCHY-STELLA-REQUIRES)
    (CL:IF SETVALUE? (CL:SETF (%REQUIRES SELF) VALUE) (CL:SETQ VALUE (%REQUIRES SELF))))
   ((CL:EQ SLOTNAME SYM-HIERARCHY-STELLA-MODULE-LISP-PACKAGE)
    (CL:IF SETVALUE?
     (SET-DYNAMIC-SLOT-VALUE (%DYNAMIC-SLOTS SELF) SYM-HIERARCHY-STELLA-MODULE-LISP-PACKAGE
   ...
   ((CL:EQ SLOTNAME SYM-HIERARCHY-STELLA-MODULE-CPP-PACKAGE)
    (CL:IF SETVALUE?
     (SET-DYNAMIC-SLOT-VALUE (%DYNAMIC-SLOTS SELF) SYM-HIERARCHY-STELLA-MODULE-CPP-PACKAGE
      (WRAP-STRING (%WRAPPER-VALUE VALUE)) NULL-STRING-WRAPPER)
     (CL:SETQ VALUE (WRAP-STRING (MODULE-CPP-PACKAGE SELF)))))
   ((CL:EQ SLOTNAME SYM-HIERARCHY-STELLA-JAVA-PACKAGE)
    (CL:IF SETVALUE?
     (SET-DYNAMIC-SLOT-VALUE (%DYNAMIC-SLOTS SELF) SYM-HIERARCHY-STELLA-JAVA-PACKAGE
      (WRAP-STRING (%WRAPPER-VALUE VALUE)) NULL-STRING-WRAPPER)
   ...
   ((CL:EQ SLOTNAME SYM-HIERARCHY-STELLA-CLEARABLE?)
    (CL:IF SETVALUE?
     (SET-DYNAMIC-SLOT-VALUE (%DYNAMIC-SLOTS SELF) SYM-HIERARCHY-STELLA-CLEARABLE?
      (CL:IF (COERCE-WRAPPED-BOOLEAN-TO-BOOLEAN VALUE) TRUE-WRAPPER FALSE-WRAPPER) FALSE-WRAPPER)
     (CL:SETQ VALUE (CL:IF (CLEARABLE? SELF) TRUE-WRAPPER FALSE-WRAPPER))))
   ((CL:EQ SLOTNAME SYM-HIERARCHY-STELLA-PROTECT-SURROGATES?)
    (CL:IF SETVALUE?
     (SET-DYNAMIC-SLOT-VALUE (%DYNAMIC-SLOTS SELF) SYM-HIERARCHY-STELLA-PROTECT-SURROGATES?
      (CL:IF (COERCE-WRAPPED-BOOLEAN-TO-BOOLEAN VALUE) TRUE-WRAPPER FALSE-WRAPPER) FALSE-WRAPPER)
   ...
   ((CL:EQ SLOTNAME SYM-HIERARCHY-STELLA-MODULE-FULL-NAME)
    (CL:IF SETVALUE? (CL:SETF (%MODULE-FULL-NAME SELF) (%WRAPPER-VALUE VALUE))
   ...
   ((CL:EQ SLOTNAME SYM-HIERARCHY-STELLA-MODULE-STRINGIFIED-SOURCE)
    (CL:IF SETVALUE? (CL:SETF (%MODULE-STRINGIFIED-SOURCE SELF) (%WRAPPER-VALUE VALUE))
     (CL:SETQ VALUE (WRAP-STRING (%MODULE-STRINGIFIED-SOURCE SELF)))))
   ((CL:EQ SLOTNAME SYM-HIERARCHY-STELLA-STRINGIFIED-OPTIONS)
    (CL:IF SETVALUE? (CL:SETF (%STRINGIFIED-OPTIONS SELF) (%WRAPPER-VALUE VALUE))
     (CL:SETQ VALUE (WRAP-STRING (%STRINGIFIED-OPTIONS SELF)))))
   ((CL:EQ SLOTNAME SYM-HIERARCHY-STELLA-CARDINAL-MODULE)
    (CL:IF SETVALUE? (CL:SETF (%CARDINAL-MODULE SELF) VALUE) (CL:SETQ VALUE (%CARDINAL-MODULE SELF))))
   ((CL:EQ SLOTNAME SYM-HIERARCHY-STELLA-SYMBOL-OFFSET-TABLE)
    (CL:IF SETVALUE? (CL:SETF (%SYMBOL-OFFSET-TABLE SELF) VALUE) (CL:SETQ VALUE (%SYMBOL-OFFSET-TABLE SELF))))
...
(CL:DEFUN NEW-WORLD ()
  (CL:LET* ((SELF NULL)) (CL:SETQ SELF (CL:MAKE-INSTANCE (CL:QUOTE WORLD)))
   (CL:SETF (%DYNAMIC-SLOTS SELF) (NEW-KEY-VALUE-LIST)) (CL:SETF (%SURROGATE-VALUE-INVERSE SELF) NULL)
   (CL:SETF (%CONTEXT-NUMBER SELF) NULL-INTEGER) (CL:SETF (%ALL-SUPER-CONTEXTS SELF) NULL)
   (CL:SETF (%BASE-MODULE SELF) NULL) (CL:SETF (%CHILD-CONTEXTS SELF) (NEW-LIST)) (CL:SETF (%PARENT-CONTEXT SELF) NULL)
...
(CL:DEFUN ACCESS-WORLD-SLOT-VALUE (SELF SLOTNAME VALUE SETVALUE?)
  (CL:COND
   ((CL:EQ SLOTNAME SYM-HIERARCHY-STELLA-PARENT-CONTEXT)
    (CL:IF SETVALUE? (CL:SETF (%PARENT-CONTEXT SELF) VALUE) (CL:SETQ VALUE (%PARENT-CONTEXT SELF))))
   ((CL:EQ SLOTNAME SYM-HIERARCHY-STELLA-CHILD-CONTEXTS)
    (CL:IF SETVALUE? (CL:SETF (%CHILD-CONTEXTS SELF) VALUE) (CL:SETQ VALUE (%CHILD-CONTEXTS SELF))))
   (CL:T
    (CL:IF SETVALUE? (SET-DYNAMIC-SLOT-VALUE (%DYNAMIC-SLOTS SELF) SLOTNAME VALUE NULL)
...
(CL:DEFUN NEW-CS-VALUE ()
  (CL:LET* ((SELF NULL)) (CL:SETQ SELF (CL:MAKE-INSTANCE (CL:QUOTE CS-VALUE))) (CL:SETF (%THE-KV-LIST SELF) NULL)
...
(CL:DEFUN NEW-INTERVAL ()
  (CL:LET* ((SELF NULL)) (CL:SETQ SELF (CL:MAKE-INSTANCE (CL:QUOTE INTERVAL)))
   (CL:SETF (%UPPER-BOUND SELF) NULL-INTEGER) (CL:SETF (%LOWER-BOUND SELF) NULL-INTEGER)
...
(CL:DEFCLASS TAXONOMY-NODE (STANDARD-OBJECT)
  ((NATIVE-OBJECT :ALLOCATION :INSTANCE :ACCESSOR %NATIVE-OBJECT)
   (LABEL :TYPE CL:FIXNUM :INITFORM NULL-INTEGER :ALLOCATION :INSTANCE :ACCESSOR %LABEL)
   (INTERVALS :ALLOCATION :INSTANCE :ACCESSOR %INTERVALS)
   (INITIAL-INTERVAL :ALLOCATION :INSTANCE :ACCESSOR %INITIAL-INTERVAL)
   (FIRST-INTERVAL-LOWER-BOUND :TYPE CL:FIXNUM :INITFORM NULL-INTEGER :ALLOCATION :INSTANCE :ACCESSOR
    %FIRST-INTERVAL-LOWER-BOUND)
   (FIRST-INTERVAL-UPPER-BOUND :TYPE CL:FIXNUM :INITFORM NULL-INTEGER :ALLOCATION :INSTANCE :ACCESSOR
...
(CL:DEFUN NEW-TAXONOMY-NODE ()
  (CL:LET* ((SELF NULL)) (CL:SETQ SELF (CL:MAKE-INSTANCE (CL:QUOTE TAXONOMY-NODE))) (CL:SETF (%MARKER SELF) NULL)
   (CL:SETF (%TREE-CHILDREN SELF) NIL) (CL:SETF (%TOTAL-ANCESTORS SELF) 1) (CL:SETF (%CHILDREN SELF) NIL)
   (CL:SETF (%PARENTS SELF) NIL) (CL:SETF (%FIRST-INTERVAL-UPPER-BOUND SELF) -1)
   (CL:SETF (%FIRST-INTERVAL-LOWER-BOUND SELF) -1) (CL:SETF (%INITIAL-INTERVAL SELF) NULL)
   (CL:SETF (%INTERVALS SELF) NIL) (CL:SETF (%LABEL SELF) NULL-INTEGER) (CL:SETF (%NATIVE-OBJECT SELF) NULL)
...
(CL:DEFUN ACCESS-TAXONOMY-NODE-SLOT-VALUE (SELF SLOTNAME VALUE SETVALUE?)
  (CL:COND
   ((CL:EQ SLOTNAME SYM-HIERARCHY-STELLA-NATIVE-OBJECT)
    (CL:IF SETVALUE? (CL:SETF (%NATIVE-OBJECT SELF) VALUE) (CL:SETQ VALUE (%NATIVE-OBJECT SELF))))
   ((CL:EQ SLOTNAME SYM-HIERARCHY-STELLA-LABEL)
    (CL:IF SETVALUE? (CL:SETF (%LABEL SELF) (%WRAPPER-VALUE VALUE)) (CL:SETQ VALUE (WRAP-INTEGER (%LABEL SELF)))))
   ((CL:EQ SLOTNAME SYM-HIERARCHY-STELLA-INTERVALS)
    (CL:IF SETVALUE? (CL:SETF (%INTERVALS SELF) VALUE) (CL:SETQ VALUE (%INTERVALS SELF))))
   ((CL:EQ SLOTNAME SYM-HIERARCHY-STELLA-INITIAL-INTERVAL)
    (CL:IF SETVALUE? (CL:SETF (%INITIAL-INTERVAL SELF) VALUE) (CL:SETQ VALUE (%INITIAL-INTERVAL SELF))))
   ((CL:EQ SLOTNAME SYM-HIERARCHY-STELLA-FIRST-INTERVAL-LOWER-BOUND)
    (CL:IF SETVALUE? (CL:SETF (%FIRST-INTERVAL-LOWER-BOUND SELF) (%WRAPPER-VALUE VALUE))
     (CL:SETQ VALUE (WRAP-INTEGER (%FIRST-INTERVAL-LOWER-BOUND SELF)))))
   ((CL:EQ SLOTNAME SYM-HIERARCHY-STELLA-FIRST-INTERVAL-UPPER-BOUND)
    (CL:IF SETVALUE? (CL:SETF (%FIRST-INTERVAL-UPPER-BOUND SELF) (%WRAPPER-VALUE VALUE))
     (CL:SETQ VALUE (WRAP-INTEGER (%FIRST-INTERVAL-UPPER-BOUND SELF)))))
   ...
   ((CL:EQ SLOTNAME SYM-HIERARCHY-STELLA-CHILDREN)
    (CL:IF SETVALUE? (CL:SETF (%CHILDREN SELF) VALUE) (CL:SETQ VALUE (%CHILDREN SELF))))
   ((CL:EQ SLOTNAME SYM-HIERARCHY-STELLA-TOTAL-ANCESTORS)
    (CL:IF SETVALUE? (CL:SETF (%TOTAL-ANCESTORS SELF) (%WRAPPER-VALUE VALUE))
     (CL:SETQ VALUE (WRAP-INTEGER (%TOTAL-ANCESTORS SELF)))))
   ((CL:EQ SLOTNAME SYM-HIERARCHY-STELLA-TREE-CHILDREN)
    (CL:IF SETVALUE? (CL:SETF (%TREE-CHILDREN SELF) VALUE) (CL:SETQ VALUE (%TREE-CHILDREN SELF))))
   ((CL:EQ SLOTNAME SYM-HIERARCHY-STELLA-MARKER)
    (CL:IF SETVALUE? (CL:SETF (%MARKER SELF) VALUE) (CL:SETQ VALUE (%MARKER SELF))))
   (CL:T
    (CL:LET* ((STREAM-000 (NEW-OUTPUT-STRING-STREAM)))
     (%%PRINT-STREAM (%NATIVE-STREAM STREAM-000) "`" SLOTNAME "' is not a valid case option")
     (CL:ERROR (NEW-STELLA-EXCEPTION (THE-STRING-READER STREAM-000))))))
...
propagate it." :ALLOCATION :INSTANCE :ACCESSOR %RENUMBER-IF-OUT-OF-NUMBERS?)
   (RENUMBER-RATIO :TYPE CL:DOUBLE-FLOAT :INITFORM NULL-FLOAT :DOCUMENTATION
...
the whole graph non-incrementally." :ALLOCATION :INSTANCE :ACCESSOR %RENUMBER-RATIO)
   ...
   (LARGEST-POSTORDER-NUMBER :TYPE CL:FIXNUM :INITFORM NULL-INTEGER :ALLOCATION :INSTANCE :ACCESSOR
   ...
   (NUMBER-OF-FOREIGN-INTERVAL-NODES :TYPE CL:FIXNUM :INITFORM NULL-INTEGER :ALLOCATION :INSTANCE :ACCESSOR
    %NUMBER-OF-FOREIGN-INTERVAL-NODES)
   (ROOTS :ALLOCATION :INSTANCE :ACCESSOR %ROOTS) (BROKEN-LINKS :ALLOCATION :INSTANCE :ACCESSOR %BROKEN-LINKS)
...
(CL:DEFUN NEW-TAXONOMY-GRAPH ()
  (CL:LET* ((SELF NULL)) (CL:SETQ SELF (CL:MAKE-INSTANCE (CL:QUOTE TAXONOMY-GRAPH)))
   (CL:SETF (%REMOVED-LINKS SELF) NULL) (CL:SETF (%ADDED-LINKS SELF) NULL) (CL:SETF (%BROKEN-LINKS SELF) NULL)
   (CL:SETF (%ROOTS SELF) NULL) (CL:SETF (%NUMBER-OF-FOREIGN-INTERVAL-NODES SELF) NULL-INTEGER)
   (CL:SETF (%NUMBER-OF-NODES SELF) NULL-INTEGER) (CL:SETF (%LARGEST-POSTORDER-NUMBER SELF) NULL-INTEGER)
   (CL:SETF (%INCREMENTAL-MODE? SELF) CL:NIL) (CL:SETF (%RENUMBER-RATIO SELF) 0.1d0)
   (CL:SETF (%RENUMBER-IF-OUT-OF-NUMBERS? SELF) CL:NIL) (INITIALIZE-TAXONOMY-GRAPH SELF)
...
(CL:DEFUN ACCESS-TAXONOMY-GRAPH-SLOT-VALUE (SELF SLOTNAME VALUE SETVALUE?)
  (CL:COND
   ...
   ((CL:EQ SLOTNAME SYM-HIERARCHY-STELLA-RENUMBER-RATIO)
    (CL:IF SETVALUE? (CL:SETF (%RENUMBER-RATIO SELF) (%WRAPPER-VALUE VALUE))
   ...
   ((CL:EQ SLOTNAME SYM-HIERARCHY-STELLA-LARGEST-POSTORDER-NUMBER)
    (CL:IF SETVALUE? (CL:SETF (%LARGEST-POSTORDER-NUMBER SELF) (%WRAPPER-VALUE VALUE))
     (CL:SETQ VALUE (WRAP-INTEGER (%LARGEST-POSTORDER-NUMBER SELF)))))
   ((CL:EQ SLOTNAME SYM-HIERARCHY-STELLA-NUMBER-OF-NODES)
    (CL:IF SETVALUE? (CL:SETF (%NUMBER-OF-NODES SELF) (%WRAPPER-VALUE VALUE))
     (CL:SETQ VALUE (WRAP-INTEGER (%NUMBER-OF-NODES SELF)))))
   ((CL:EQ SLOTNAME SYM-HIERARCHY-STELLA-NUMBER-OF-FOREIGN-INTERVAL-NODES)
    (CL:IF SETVALUE? (CL:SETF (%NUMBER-OF-FOREIGN-INTERVAL-NODES SELF) (%WRAPPER-VALUE VALUE))
     (CL:SETQ VALUE (WRAP-INTEGER (%NUMBER-OF-FOREIGN-INTERVAL-NODES SELF)))))
   ((CL:EQ SLOTNAME SYM-HIERARCHY-STELLA-ROOTS)
    (CL:IF SETVALUE? (CL:SETF (%ROOTS SELF) VALUE) (CL:SETQ VALUE (%ROOTS SELF))))
   ((CL:EQ SLOTNAME SYM-HIERARCHY-STELLA-BROKEN-LINKS)
    (CL:IF SETVALUE? (CL:SETF (%BROKEN-LINKS SELF) VALUE) (CL:SETQ VALUE (%BROKEN-LINKS SELF))))
   ((CL:EQ SLOTNAME SYM-HIERARCHY-STELLA-ADDED-LINKS)
    (CL:IF SETVALUE? (CL:SETF (%ADDED-LINKS SELF) VALUE) (CL:SETQ VALUE (%ADDED-LINKS SELF))))
   ((CL:EQ SLOTNAME SYM-HIERARCHY-STELLA-REMOVED-LINKS)
    (CL:IF SETVALUE? (CL:SETF (%REMOVED-LINKS SELF) VALUE) (CL:SETQ VALUE (%REMOVED-LINKS SELF))))
   (CL:T
    (CL:LET* ((STREAM-000 (NEW-OUTPUT-STRING-STREAM)))
     (%%PRINT-STREAM (%NATIVE-STREAM STREAM-000) "`" SLOTNAME "' is not a valid case option")
     (CL:ERROR (NEW-STELLA-EXCEPTION (THE-STRING-READER STREAM-000))))))
...
(CL:DEFUN NEW-STELLA-EXCEPTION (MESSAGE)
  ...
  (CL:LET* ((SELF NULL))
   (CL:SETQ SELF
    (CL:MAKE-CONDITION (CL:QUOTE STELLA-EXCEPTION) *CONDITION-MESSAGE-KEYWORD* (REPLACE-SUBSTRINGS MESSAGE "~~" "~")))
...
(CL:DEFUN NEW-INPUT-OUTPUT-EXCEPTION (MESSAGE)
  ...
  (CL:LET* ((SELF NULL))
   (CL:SETQ SELF
    (CL:MAKE-CONDITION (CL:QUOTE INPUT-OUTPUT-EXCEPTION) *CONDITION-MESSAGE-KEYWORD*
...
(CL:DEFUN NEW-READ-EXCEPTION (MESSAGE)
  ...
  (CL:LET* ((SELF NULL))
   (CL:SETQ SELF
    (CL:MAKE-CONDITION (CL:QUOTE READ-EXCEPTION) *CONDITION-MESSAGE-KEYWORD* (REPLACE-SUBSTRINGS MESSAGE "~~" "~")))
...
(CL:DEFUN NEW-END-OF-FILE-EXCEPTION (MESSAGE)
  ...
  (CL:LET* ((SELF NULL))
   (CL:SETQ SELF
    (CL:MAKE-CONDITION (CL:QUOTE END-OF-FILE-EXCEPTION) *CONDITION-MESSAGE-KEYWORD*
     (REPLACE-SUBSTRINGS MESSAGE "~~" "~")))
...
(CL:DEFUN NEW-NO-SUCH-FILE-EXCEPTION (MESSAGE)
  ...
  (CL:LET* ((SELF NULL))
   (CL:SETQ SELF
    (CL:MAKE-CONDITION (CL:QUOTE NO-SUCH-FILE-EXCEPTION) *CONDITION-MESSAGE-KEYWORD*
     (REPLACE-SUBSTRINGS MESSAGE "~~" "~")))
...
(CL:DEFUN NEW-FILE-ALREADY-EXISTS-EXCEPTION (MESSAGE)
  ...
  (CL:LET* ((SELF NULL))
   (CL:SETQ SELF
    (CL:MAKE-CONDITION (CL:QUOTE FILE-ALREADY-EXISTS-EXCEPTION) *CONDITION-MESSAGE-KEYWORD*
     (REPLACE-SUBSTRINGS MESSAGE "~~" "~")))
...
(CL:DEFUN NEW-UNHANDLED-EXCEPTION (MESSAGE)
  ...
  (CL:LET* ((SELF NULL))
   (CL:SETQ SELF
    (CL:MAKE-CONDITION (CL:QUOTE UNHANDLED-EXCEPTION) *CONDITION-MESSAGE-KEYWORD*
     (REPLACE-SUBSTRINGS MESSAGE "~~" "~")))
...
(CL:DEFUN NEW-EVALUATION-EXCEPTION (MESSAGE)
  ...
  (CL:LET* ((SELF NULL))
   (CL:SETQ SELF
    (CL:MAKE-CONDITION (CL:QUOTE EVALUATION-EXCEPTION) *CONDITION-MESSAGE-KEYWORD*
     (REPLACE-SUBSTRINGS MESSAGE "~~" "~")))
...
(CL:DEFUN NEW-NO-SUCH-OBJECT-EXCEPTION (MESSAGE)
  ...
  (CL:LET* ((SELF NULL))
   (CL:SETQ SELF
    (CL:MAKE-CONDITION (CL:QUOTE NO-SUCH-OBJECT-EXCEPTION) *CONDITION-MESSAGE-KEYWORD*
     (REPLACE-SUBSTRINGS MESSAGE "~~" "~")))
...
(CL:DEFUN NEW-NO-SUCH-CONTEXT-EXCEPTION (MESSAGE)
  ...
  (CL:LET* ((SELF NULL))
   (CL:SETQ SELF
    (CL:MAKE-CONDITION (CL:QUOTE NO-SUCH-CONTEXT-EXCEPTION) *CONDITION-MESSAGE-KEYWORD*
     (REPLACE-SUBSTRINGS MESSAGE "~~" "~")))
...
(CL:DEFUN NEW-UNDEFINED-CLASS-EXCEPTION (MESSAGE)
  ...
  (CL:LET* ((SELF NULL))
   (CL:SETQ SELF
    (CL:MAKE-CONDITION (CL:QUOTE UNDEFINED-CLASS-EXCEPTION) *CONDITION-MESSAGE-KEYWORD*
     (REPLACE-SUBSTRINGS MESSAGE "~~" "~")))
...
(CL:DEFUN NEW-BAD-ARGUMENT-EXCEPTION (MESSAGE)
  ...
  (CL:LET* ((SELF NULL))
   (CL:SETQ SELF
    (CL:MAKE-CONDITION (CL:QUOTE BAD-ARGUMENT-EXCEPTION) *CONDITION-MESSAGE-KEYWORD*
     (REPLACE-SUBSTRINGS MESSAGE "~~" "~")))
...
(CL:DEFUN NEW-OBJECT-NOT-CLASS-EXCEPTION (MESSAGE)
  ...
  (CL:LET* ((SELF NULL))
   (CL:SETQ SELF
    (CL:MAKE-CONDITION (CL:QUOTE OBJECT-NOT-CLASS-EXCEPTION) *CONDITION-MESSAGE-KEYWORD*
     (REPLACE-SUBSTRINGS MESSAGE "~~" "~")))
...
(CL:DEFUN NEW-INCOMPATIBLE-QUANTITY-EXCEPTION (MESSAGE)
  ...
  (CL:LET* ((SELF NULL))
   (CL:SETQ SELF
    (CL:MAKE-CONDITION (CL:QUOTE INCOMPATIBLE-QUANTITY-EXCEPTION) *CONDITION-MESSAGE-KEYWORD*
     (REPLACE-SUBSTRINGS MESSAGE "~~" "~")))
...
(CL:DEFUN NEW-TIMEOUT-EXCEPTION (MESSAGE)
  ...
  (CL:LET* ((SELF NULL))
   (CL:SETQ SELF
    (CL:MAKE-CONDITION (CL:QUOTE TIMEOUT-EXCEPTION) *CONDITION-MESSAGE-KEYWORD* (REPLACE-SUBSTRINGS MESSAGE "~~" "~")))
...
(CL:DEFUN NEW-INTEGER-WRAPPER (WRAPPER-VALUE)
  ...
  (CL:LET* ((SELF NULL)) (CL:SETQ SELF (CL:MAKE-INSTANCE (CL:QUOTE INTEGER-WRAPPER)))
   (CL:SETF (%WRAPPER-VALUE SELF) WRAPPER-VALUE) (CL:RETURN-FROM NEW-INTEGER-WRAPPER SELF)))
...
(CL:DEFUN ACCESS-INTEGER-WRAPPER-SLOT-VALUE (SELF SLOTNAME VALUE SETVALUE?)
  (CL:COND
   ((CL:EQ SLOTNAME SYM-HIERARCHY-STELLA-WRAPPER-VALUE)
    (CL:IF SETVALUE? (CL:SETF (%WRAPPER-VALUE SELF) (%WRAPPER-VALUE VALUE))
...
(CL:DEFMETHOD PRINT-OBJECT ((SELF INTEGER-WRAPPER) STREAM)
  (CL:LET* ((VALUE (%WRAPPER-VALUE SELF))) (CL:DECLARE (CL:TYPE CL:FIXNUM VALUE))
   (CL:IF (CL:= VALUE NULL-INTEGER)
    (CL:IF *PRINTREADABLY?* (%%PRINT-STREAM STREAM SYM-HIERARCHY-STELLA-NULL-INTEGER)
...
(CL:DEFUN NEW-LONG-INTEGER-WRAPPER (WRAPPER-VALUE)
  (CL:LET* ((SELF NULL)) (CL:SETQ SELF (CL:MAKE-INSTANCE (CL:QUOTE LONG-INTEGER-WRAPPER)))
   (CL:SETF (%WRAPPER-VALUE SELF) WRAPPER-VALUE) (CL:RETURN-FROM NEW-LONG-INTEGER-WRAPPER SELF)))
...
(CL:DEFMETHOD PRINT-OBJECT ((SELF LONG-INTEGER-WRAPPER) STREAM)
  (CL:LET* ((VALUE (%WRAPPER-VALUE SELF)))
   (CL:IF (CL:= VALUE NULL-LONG-INTEGER)
    (CL:IF *PRINTREADABLY?* (%%PRINT-STREAM STREAM SYM-HIERARCHY-STELLA-NULL-LONG-INTEGER)
...
(CL:DEFUN NEW-FLOAT-WRAPPER (WRAPPER-VALUE)
  ...
  (CL:LET* ((SELF NULL)) (CL:SETQ SELF (CL:MAKE-INSTANCE (CL:QUOTE FLOAT-WRAPPER)))
   (CL:SETF (%WRAPPER-VALUE SELF) WRAPPER-VALUE) (CL:RETURN-FROM NEW-FLOAT-WRAPPER SELF)))
...
(CL:DEFMETHOD PRINT-OBJECT ((SELF FLOAT-WRAPPER) STREAM)
  (CL:LET* ((VALUE (%WRAPPER-VALUE SELF))) (CL:DECLARE (CL:TYPE CL:DOUBLE-FLOAT VALUE))
   (CL:IF (CL:= VALUE NULL-FLOAT)
    (CL:IF *PRINTREADABLY?* (%%PRINT-STREAM STREAM SYM-HIERARCHY-STELLA-NULL-FLOAT)
...
(CL:DEFUN NEW-STRING-WRAPPER (WRAPPER-VALUE)
  ...
  (CL:LET* ((SELF NULL)) (CL:SETQ SELF (CL:MAKE-INSTANCE (CL:QUOTE STRING-WRAPPER)))
   (CL:SETF (%WRAPPER-VALUE SELF) WRAPPER-VALUE) (CL:RETURN-FROM NEW-STRING-WRAPPER SELF)))
...
(CL:DEFMETHOD PRINT-OBJECT ((SELF STRING-WRAPPER) STREAM)
  (CL:LET* ((VALUE (%WRAPPER-VALUE SELF))) (CL:DECLARE (CL:TYPE CL:SIMPLE-STRING VALUE))
   (CL:IF (CL:EQ VALUE STELLA::NULL-STRING)
    (CL:IF *PRINTREADABLY?* (%%PRINT-STREAM STREAM SYM-HIERARCHY-STELLA-NULL-STRING)
...
(CL:DEFUN NEW-MUTABLE-STRING-WRAPPER (WRAPPER-VALUE)
  ...
  #+MCL
  (CL:CHECK-TYPE WRAPPER-VALUE CL:SIMPLE-STRING)
  (CL:LET* ((SELF NULL)) (CL:SETQ SELF (CL:MAKE-INSTANCE (CL:QUOTE MUTABLE-STRING-WRAPPER)))
   (CL:SETF (%WRAPPER-VALUE SELF) WRAPPER-VALUE) (CL:RETURN-FROM NEW-MUTABLE-STRING-WRAPPER SELF)))
...
(CL:DEFMETHOD PRINT-OBJECT ((SELF MUTABLE-STRING-WRAPPER) STREAM)
  (CL:LET* ((VALUE (%WRAPPER-VALUE SELF))) (CL:DECLARE (CL:TYPE CL:SIMPLE-STRING VALUE))
   (CL:IF (NULL? VALUE)
    (CL:IF *PRINTREADABLY?* (%%PRINT-STREAM STREAM SYM-HIERARCHY-STELLA-NULL-MUTABLE-STRING)
     (%%PRINT-STREAM STREAM "|L|NULL-MUTABLE-STRING"))
    (CL:IF *PRINTREADABLY?*
     (PRINT-STRING-READABLY (CL:LET ((S VALUE)) (CL:DECLARE (CL:TYPE CL:SIMPLE-STRING S)) (CL:THE CL:SIMPLE-STRING S))
      STREAM)
     (%%PRINT-STREAM STREAM "|L|\""
      (CL:LET ((S VALUE)) (CL:DECLARE (CL:TYPE CL:SIMPLE-STRING S)) (CL:THE CL:SIMPLE-STRING S)) "\""))))
  :VOID)
...
(CL:DEFUN NEW-CHARACTER-WRAPPER (WRAPPER-VALUE)
  (CL:LET* ((SELF NULL)) (CL:SETQ SELF (CL:MAKE-INSTANCE (CL:QUOTE CHARACTER-WRAPPER)))
   (CL:SETF (%WRAPPER-VALUE SELF) WRAPPER-VALUE) (CL:RETURN-FROM NEW-CHARACTER-WRAPPER SELF)))
...
(CL:DEFMETHOD PRINT-OBJECT ((SELF CHARACTER-WRAPPER) STREAM)
  (CL:LET* ((VALUE (%WRAPPER-VALUE SELF)))
   (CL:IF (NULL? VALUE)
    (CL:IF *PRINTREADABLY?* (%%PRINT-STREAM STREAM SYM-HIERARCHY-STELLA-NULL-CHARACTER)
...
(CL:DEFUN NEW-BOOLEAN-WRAPPER (WRAPPER-VALUE)
  (CL:LET* ((SELF NULL)) (CL:SETQ SELF (CL:MAKE-INSTANCE (CL:QUOTE BOOLEAN-WRAPPER)))
   (CL:SETF (%WRAPPER-VALUE SELF) WRAPPER-VALUE) (CL:RETURN-FROM NEW-BOOLEAN-WRAPPER SELF)))
...
(CL:DEFUN ACCESS-BOOLEAN-WRAPPER-SLOT-VALUE (SELF SLOTNAME VALUE SETVALUE?)
  (CL:COND
   ((CL:EQ SLOTNAME SYM-HIERARCHY-STELLA-WRAPPER-VALUE)
    (CL:IF SETVALUE? (CL:SETF (%WRAPPER-VALUE SELF) (COERCE-WRAPPED-BOOLEAN-TO-BOOLEAN VALUE))
     (CL:SETQ VALUE (CL:IF (%WRAPPER-VALUE SELF) TRUE-WRAPPER FALSE-WRAPPER))))
   (CL:T
    (CL:LET* ((STREAM-000 (NEW-OUTPUT-STRING-STREAM)))
     (%%PRINT-STREAM (%NATIVE-STREAM STREAM-000) "`" SLOTNAME "' is not a valid case option")
     (CL:ERROR (NEW-STELLA-EXCEPTION (THE-STRING-READER STREAM-000))))))
...
(CL:DEFMETHOD PRINT-OBJECT ((SELF BOOLEAN-WRAPPER) STREAM)
  (CL:PROGN (CL:WHEN (CL:NOT *PRINTREADABLY?*) (%%PRINT-STREAM STREAM "|L|"))
   (CL:IF (%WRAPPER-VALUE SELF) (%%PRINT-STREAM STREAM SYM-HIERARCHY-STELLA-TRUE)
...
(CL:DEFUN NEW-FUNCTION-CODE-WRAPPER (WRAPPER-VALUE)
  (CL:LET* ((SELF NULL)) (CL:SETQ SELF (CL:MAKE-INSTANCE (CL:QUOTE FUNCTION-CODE-WRAPPER)))
   (CL:SETF (%WRAPPER-VALUE SELF) WRAPPER-VALUE) (CL:RETURN-FROM NEW-FUNCTION-CODE-WRAPPER SELF)))
...
(CL:DEFUN NEW-METHOD-CODE-WRAPPER (WRAPPER-VALUE)
  (CL:LET* ((SELF NULL)) (CL:SETQ SELF (CL:MAKE-INSTANCE (CL:QUOTE METHOD-CODE-WRAPPER)))
   (CL:SETF (%WRAPPER-VALUE SELF) WRAPPER-VALUE) (CL:RETURN-FROM NEW-METHOD-CODE-WRAPPER SELF)))
...
(CL:DEFUN NEW-VERBATIM-STRING-WRAPPER (WRAPPER-VALUE)
  ...
  #+MCL
  (CL:CHECK-TYPE WRAPPER-VALUE CL:SIMPLE-STRING)
  (CL:LET* ((SELF NULL)) (CL:SETQ SELF (CL:MAKE-INSTANCE (CL:QUOTE VERBATIM-STRING-WRAPPER)))
   (CL:SETF (%WRAPPER-VALUE SELF) WRAPPER-VALUE) (CL:RETURN-FROM NEW-VERBATIM-STRING-WRAPPER SELF)))
...
(CL:DEFCLASS SYSTEM-DEFINITION (STANDARD-OBJECT)
  ((NAME :TYPE CL:SIMPLE-STRING :INITFORM STELLA::NULL-STRING :ALLOCATION :INSTANCE :ACCESSOR %NAME)
   (DIRECTORY :ALLOCATION :INSTANCE :ACCESSOR %DIRECTORY) (FILES :ALLOCATION :INSTANCE :ACCESSOR %FILES)
   ...
   (PREPROCESSED-FILES :ALLOCATION :INSTANCE :ACCESSOR %PREPROCESSED-FILES)
   (REQUIRED-SYSTEMS :ALLOCATION :INSTANCE :ACCESSOR %REQUIRED-SYSTEMS)
   (LOADED? :ALLOCATION :INSTANCE :ACCESSOR %LOADED?) (UP-TO-DATE? :ALLOCATION :INSTANCE :ACCESSOR %UP-TO-DATE?)
   (CARDINAL-MODULE :TYPE CL:SIMPLE-STRING :INITFORM STELLA::NULL-STRING :ALLOCATION :INSTANCE :ACCESSOR
    %CARDINAL-MODULE)
   (SOURCE-ROOT-DIRECTORY :ALLOCATION :INSTANCE :ACCESSOR %SOURCE-ROOT-DIRECTORY)
   (NATIVE-ROOT-DIRECTORY :ALLOCATION :INSTANCE :ACCESSOR %NATIVE-ROOT-DIRECTORY)
   ...
   (PRODUCTION-SETTINGS :ALLOCATION :INSTANCE :ACCESSOR %PRODUCTION-SETTINGS)
   (DEVELOPMENT-SETTINGS :ALLOCATION :INSTANCE :ACCESSOR %DEVELOPMENT-SETTINGS)
...
(CL:DEFUN NEW-SYSTEM-DEFINITION ()
  (CL:LET* ((SELF NULL)) (CL:SETQ SELF (CL:MAKE-INSTANCE (CL:QUOTE SYSTEM-DEFINITION)))
   (CL:SETF (%FINALIZATION-FUNCTION SELF) NULL) (CL:SETF (%DEVELOPMENT-SETTINGS SELF) NULL)
   (CL:SETF (%PRODUCTION-SETTINGS SELF) NULL) (CL:SETF (%BANNER SELF) STELLA::NULL-STRING)
   (CL:SETF (%BINARY-ROOT-DIRECTORY SELF) STELLA::NULL-STRING)
   (CL:SETF (%NATIVE-ROOT-DIRECTORY SELF) STELLA::NULL-STRING)
   (CL:SETF (%SOURCE-ROOT-DIRECTORY SELF) STELLA::NULL-STRING) (CL:SETF (%CARDINAL-MODULE SELF) STELLA::NULL-STRING)
   (CL:SETF (%UP-TO-DATE? SELF) CL:NIL) (CL:SETF (%LOADED? SELF) CL:NIL) (CL:SETF (%REQUIRED-SYSTEMS SELF) NULL)
   (CL:SETF (%PREPROCESSED-FILES SELF) NULL) (CL:SETF (%DATA-FILES SELF) NULL) (CL:SETF (%JAVA-ONLY-FILES SELF) NULL)
   (CL:SETF (%CPP-ONLY-FILES SELF) NULL) (CL:SETF (%LISP-ONLY-FILES SELF) NULL) (CL:SETF (%FILES SELF) NULL)
   (CL:SETF (%DIRECTORY SELF) STELLA::NULL-STRING) (CL:SETF (%NAME SELF) STELLA::NULL-STRING)
...
(CL:DEFUN ACCESS-SYSTEM-DEFINITION-SLOT-VALUE (SELF SLOTNAME VALUE SETVALUE?)
  (CL:COND
   ...
   ((CL:EQ SLOTNAME SYM-HIERARCHY-STELLA-FILES)
    (CL:IF SETVALUE? (CL:SETF (%FILES SELF) VALUE) (CL:SETQ VALUE (%FILES SELF))))
   ((CL:EQ SLOTNAME SYM-HIERARCHY-STELLA-LISP-ONLY-FILES)
    (CL:IF SETVALUE? (CL:SETF (%LISP-ONLY-FILES SELF) VALUE) (CL:SETQ VALUE (%LISP-ONLY-FILES SELF))))
   ((CL:EQ SLOTNAME SYM-HIERARCHY-STELLA-CPP-ONLY-FILES)
    (CL:IF SETVALUE? (CL:SETF (%CPP-ONLY-FILES SELF) VALUE) (CL:SETQ VALUE (%CPP-ONLY-FILES SELF))))
   ((CL:EQ SLOTNAME SYM-HIERARCHY-STELLA-JAVA-ONLY-FILES)
    (CL:IF SETVALUE? (CL:SETF (%JAVA-ONLY-FILES SELF) VALUE) (CL:SETQ VALUE (%JAVA-ONLY-FILES SELF))))
   ((CL:EQ SLOTNAME SYM-HIERARCHY-STELLA-DATA-FILES)
    (CL:IF SETVALUE? (CL:SETF (%DATA-FILES SELF) VALUE) (CL:SETQ VALUE (%DATA-FILES SELF))))
   ((CL:EQ SLOTNAME SYM-HIERARCHY-STELLA-PREPROCESSED-FILES)
    (CL:IF SETVALUE? (CL:SETF (%PREPROCESSED-FILES SELF) VALUE) (CL:SETQ VALUE (%PREPROCESSED-FILES SELF))))
   ((CL:EQ SLOTNAME SYM-HIERARCHY-STELLA-REQUIRED-SYSTEMS)
    (CL:IF SETVALUE? (CL:SETF (%REQUIRED-SYSTEMS SELF) VALUE) (CL:SETQ VALUE (%REQUIRED-SYSTEMS SELF))))
   ((CL:EQ SLOTNAME SYM-HIERARCHY-STELLA-LOADED?)
    (CL:IF SETVALUE? (CL:SETF (%LOADED? SELF) (COERCE-WRAPPED-BOOLEAN-TO-BOOLEAN VALUE))
     (CL:SETQ VALUE (CL:IF (%LOADED? SELF) TRUE-WRAPPER FALSE-WRAPPER))))
   ((CL:EQ SLOTNAME SYM-HIERARCHY-STELLA-UP-TO-DATE?)
    (CL:IF SETVALUE? (CL:SETF (%UP-TO-DATE? SELF) (COERCE-WRAPPED-BOOLEAN-TO-BOOLEAN VALUE))
     (CL:SETQ VALUE (CL:IF (%UP-TO-DATE? SELF) TRUE-WRAPPER FALSE-WRAPPER))))
   ((CL:EQ SLOTNAME SYM-HIERARCHY-STELLA-CARDINAL-MODULE)
    (CL:IF SETVALUE? (CL:SETF (%CARDINAL-MODULE SELF) (%WRAPPER-VALUE VALUE))
     (CL:SETQ VALUE (WRAP-STRING (%CARDINAL-MODULE SELF)))))
   ((CL:EQ SLOTNAME SYM-HIERARCHY-STELLA-SOURCE-ROOT-DIRECTORY)
    (CL:IF SETVALUE? (CL:SETF (%SOURCE-ROOT-DIRECTORY SELF) (%WRAPPER-VALUE VALUE))
     (CL:SETQ VALUE (WRAP-STRING (%SOURCE-ROOT-DIRECTORY SELF)))))
   ((CL:EQ SLOTNAME SYM-HIERARCHY-STELLA-NATIVE-ROOT-DIRECTORY)
    (CL:IF SETVALUE? (CL:SETF (%NATIVE-ROOT-DIRECTORY SELF) (%WRAPPER-VALUE VALUE))
     (CL:SETQ VALUE (WRAP-STRING (%NATIVE-ROOT-DIRECTORY SELF)))))
   ((CL:EQ SLOTNAME SYM-HIERARCHY-STELLA-BINARY-ROOT-DIRECTORY)
    (CL:IF SETVALUE? (CL:SETF (%BINARY-ROOT-DIRECTORY SELF) (%WRAPPER-VALUE VALUE))
   ...
   ((CL:EQ SLOTNAME SYM-HIERARCHY-STELLA-PRODUCTION-SETTINGS)
    (CL:IF SETVALUE? (CL:SETF (%PRODUCTION-SETTINGS SELF) VALUE) (CL:SETQ VALUE (%PRODUCTION-SETTINGS SELF))))
...
(CL:DEFUN NEW-OUTPUT-STREAM ()
  (CL:LET* ((SELF NULL)) (CL:SETQ SELF (CL:MAKE-INSTANCE (CL:QUOTE OUTPUT-STREAM))) (CL:SETF (%STATE SELF) NULL)
   (CL:SETF (%NATIVE-STREAM SELF) NULL) (CL:RETURN-FROM NEW-OUTPUT-STREAM SELF)))
...
(CL:DEFUN NEW-INPUT-STREAM ()
  (CL:LET* ((SELF NULL)) (CL:SETQ SELF (CL:MAKE-INSTANCE (CL:QUOTE INPUT-STREAM))) (CL:SETF (%STATE SELF) NULL)
   (CL:SETF (%BUFFERING-SCHEME SELF) KWD-HIERARCHY-LINE) (CL:SETF (%TOKENIZER-STATE SELF) NULL)
   (CL:SETF (%ECHO-STREAM SELF) NULL) (CL:SETF (%NATIVE-STREAM SELF) NULL) (CL:RETURN-FROM NEW-INPUT-STREAM SELF)))
...
(CL:DEFUN ACCESS-INPUT-STREAM-SLOT-VALUE (SELF SLOTNAME VALUE SETVALUE?)
  (CL:COND
   ((CL:EQ SLOTNAME SYM-HIERARCHY-STELLA-ECHO-STREAM)
    (CL:IF SETVALUE? (CL:SETF (%ECHO-STREAM SELF) VALUE) (CL:SETQ VALUE (%ECHO-STREAM SELF))))
   ((CL:EQ SLOTNAME SYM-HIERARCHY-STELLA-TOKENIZER-STATE)
    (CL:IF SETVALUE? (CL:SETF (%TOKENIZER-STATE SELF) VALUE) (CL:SETQ VALUE (%TOKENIZER-STATE SELF))))
   ((CL:EQ SLOTNAME SYM-HIERARCHY-STELLA-BUFFERING-SCHEME)
    (CL:IF SETVALUE? (CL:SETF (%BUFFERING-SCHEME SELF) VALUE) (CL:SETQ VALUE (%BUFFERING-SCHEME SELF))))
   (CL:T
    (CL:LET* ((STREAM-000 (NEW-OUTPUT-STRING-STREAM)))
     (%%PRINT-STREAM (%NATIVE-STREAM STREAM-000) "`" SLOTNAME "' is not a valid case option")
     (CL:ERROR (NEW-STELLA-EXCEPTION (THE-STRING-READER STREAM-000))))))
...
(CL:DEFUN NEW-OUTPUT-FILE-STREAM (FILENAME)
  ...
  (CL:LET* ((SELF NULL)) (CL:SETQ SELF (CL:MAKE-INSTANCE (CL:QUOTE OUTPUT-FILE-STREAM)))
   (CL:SETF (%FILENAME SELF) FILENAME) (CL:SETF (%STATE SELF) NULL) (CL:SETF (%NATIVE-STREAM SELF) NULL)
   (CL:SETF (%IF-NOT-EXISTS-ACTION SELF) KWD-HIERARCHY-CREATE)
   (CL:SETF (%IF-EXISTS-ACTION SELF) KWD-HIERARCHY-SUPERSEDE) (INITIALIZE-FILE-OUTPUT-STREAM SELF)
...
(CL:DEFUN ACCESS-OUTPUT-FILE-STREAM-SLOT-VALUE (SELF SLOTNAME VALUE SETVALUE?)
  (CL:COND
   ((CL:EQ SLOTNAME SYM-HIERARCHY-STELLA-FILENAME)
    (CL:IF SETVALUE? (CL:SETF (%FILENAME SELF) (%WRAPPER-VALUE VALUE)) (CL:SETQ VALUE (WRAP-STRING (%FILENAME SELF)))))
   ((CL:EQ SLOTNAME SYM-HIERARCHY-STELLA-IF-EXISTS-ACTION)
    (CL:IF SETVALUE? (CL:SETF (%IF-EXISTS-ACTION SELF) VALUE) (CL:SETQ VALUE (%IF-EXISTS-ACTION SELF))))
...
(CL:DEFUN NEW-INPUT-FILE-STREAM (FILENAME)
  ...
  #+MCL
  (CL:CHECK-TYPE FILENAME CL:SIMPLE-STRING)
  (CL:LET* ((SELF NULL)) (CL:SETQ SELF (CL:MAKE-INSTANCE (CL:QUOTE INPUT-FILE-STREAM)))
   (CL:SETF (%FILENAME SELF) FILENAME) (CL:SETF (%STATE SELF) NULL) (CL:SETF (%TOKENIZER-STATE SELF) NULL)
   (CL:SETF (%ECHO-STREAM SELF) NULL) (CL:SETF (%NATIVE-STREAM SELF) NULL)
   (CL:SETF (%BUFFERING-SCHEME SELF) KWD-HIERARCHY-BLOCK) (CL:SETF (%IF-NOT-EXISTS-ACTION SELF) KWD-HIERARCHY-ERROR)
   (INITIALIZE-FILE-INPUT-STREAM SELF) (CL:RETURN-FROM NEW-INPUT-FILE-STREAM SELF)))
...
(CL:DEFUN NEW-OUTPUT-STRING-STREAM ()
  (CL:LET* ((SELF NULL)) (CL:SETQ SELF (CL:MAKE-INSTANCE (CL:QUOTE OUTPUT-STRING-STREAM))) (CL:SETF (%STATE SELF) NULL)
   (CL:SETF (%NATIVE-STREAM SELF) NULL) (CL:SETF (%THE-STRING SELF) STELLA::NULL-STRING)
   (INITIALIZE-STRING-OUTPUT-STREAM SELF) (CL:RETURN-FROM NEW-OUTPUT-STRING-STREAM SELF)))
...
(CL:DEFUN NEW-INPUT-STRING-STREAM (THE-STRING)
  ...
  (CL:LET* ((SELF NULL)) (CL:SETQ SELF (CL:MAKE-INSTANCE (CL:QUOTE INPUT-STRING-STREAM)))
   (CL:SETF (%THE-STRING SELF) THE-STRING) (CL:SETF (%STATE SELF) NULL) (CL:SETF (%TOKENIZER-STATE SELF) NULL)
   (CL:SETF (%ECHO-STREAM SELF) NULL) (CL:SETF (%NATIVE-STREAM SELF) NULL)
   (CL:SETF (%BUFFERING-SCHEME SELF) KWD-HIERARCHY-BLOCK) (INITIALIZE-STRING-INPUT-STREAM SELF)
...
(CL:DEFUN HELP-STARTUP-HIERARCHY1 ()
  (CL:PROGN (CL:SETQ SYM-HIERARCHY-STELLA-TYPE-SPEC (INTERN-RIGID-SYMBOL-WRT-MODULE "TYPE-SPEC" NULL 0))
   ...
   (CL:SETQ SGT-HIERARCHY-STELLA-REVERSE-INTEGER-INTERVAL-ITERATOR
    (INTERN-RIGID-SYMBOL-WRT-MODULE "REVERSE-INTEGER-INTERVAL-ITERATOR" NULL 1))
   ...
   (CL:SETQ SGT-HIERARCHY-STELLA-LIST (INTERN-RIGID-SYMBOL-WRT-MODULE "LIST" NULL 1))
   (CL:SETQ SGT-HIERARCHY-STELLA-SET (INTERN-RIGID-SYMBOL-WRT-MODULE "SET" NULL 1))
...
(CL:DEFUN HELP-STARTUP-HIERARCHY4 ()
  (CL:PROGN (CL:SETQ SYM-HIERARCHY-STELLA-SLOT-EXTERNAL? (INTERN-RIGID-SYMBOL-WRT-MODULE "SLOT-EXTERNAL?" NULL 0))
   ...
   (CL:SETQ SYM-HIERARCHY-STELLA-METHOD-PARAMETER-TYPE-SPECIFIERS
    (INTERN-RIGID-SYMBOL-WRT-MODULE "METHOD-PARAMETER-TYPE-SPECIFIERS" NULL 0))
...
(CL:DEFUN HELP-STARTUP-HIERARCHY5 ()
  (CL:PROGN (CL:SETQ SGT-HIERARCHY-STELLA-WORLD (INTERN-RIGID-SYMBOL-WRT-MODULE "WORLD" NULL 1))
   ...
   (CL:SETQ SYM-HIERARCHY-STELLA-PROTOTYPE-INFERENCE-CACHE
    (INTERN-RIGID-SYMBOL-WRT-MODULE "PROTOTYPE-INFERENCE-CACHE" NULL 0))
   ...
   (CL:SETQ SYM-HIERARCHY-STELLA-NUMBER-OF-FOREIGN-INTERVAL-NODES
    (INTERN-RIGID-SYMBOL-WRT-MODULE "NUMBER-OF-FOREIGN-INTERVAL-NODES" NULL 0))
...
(CL:DEFUN HELP-STARTUP-HIERARCHY6 ()
  (CL:PROGN (CL:SETQ SYM-HIERARCHY-STELLA-NULL-FLOAT (INTERN-RIGID-SYMBOL-WRT-MODULE "NULL-FLOAT" NULL 0))
   ...
   (CL:SETQ KWD-HIERARCHY-CREATE (INTERN-RIGID-SYMBOL-WRT-MODULE "CREATE" NULL 2))
   (CL:SETQ KWD-HIERARCHY-SUPERSEDE (INTERN-RIGID-SYMBOL-WRT-MODULE "SUPERSEDE" NULL 2))
   ...
   (CL:SETQ KWD-HIERARCHY-BLOCK (INTERN-RIGID-SYMBOL-WRT-MODULE "BLOCK" NULL 2))
   (CL:SETQ KWD-HIERARCHY-ERROR (INTERN-RIGID-SYMBOL-WRT-MODULE "ERROR" NULL 2))
...
collections of OBJECTs.\" :PARAMETERS ((ANY-VALUE :TYPE OBJECT)) :SYNONYMS (OBJECT-ITERATOR))")
   (CL:LET*
    ...
    (CL:SETF (%CLASS-CONSTRUCTOR-CODE CLASS) (CL:FUNCTION NEW-CONS-ITERATOR))
    (CL:SETF (%CLASS-SLOT-ACCESSOR-CODE CLASS) (CL:FUNCTION ACCESS-CONS-ITERATOR-SLOT-VALUE)))
   (CL:LET*
    ((CLASS
    ...
    (CL:SETF (%CLASS-CONSTRUCTOR-CODE CLASS) (CL:FUNCTION NEW-LIST-ITERATOR))
    (CL:SETF (%CLASS-SLOT-ACCESSOR-CODE CLASS) (CL:FUNCTION ACCESS-LIST-ITERATOR-SLOT-VALUE)))
   (CL:LET*
    ((CLASS
...
the method `insert'.\" :PARAMETERS ((ANY-VALUE :TYPE OBJECT)) :MIXIN? TRUE)")
   ...
   (CL:LET*
    ...
    (CL:SETF (%CLASS-SLOT-ACCESSOR-CODE CLASS) (CL:FUNCTION ACCESS-LIST-SLOT-VALUE)))
   (CL:LET*
    ((CLASS
   ...
   (CL:LET*
    ...
    (CL:SETF (%CLASS-SLOT-ACCESSOR-CODE CLASS) (CL:FUNCTION ACCESS-CONS-SLOT-VALUE)))
   ...
   (CL:LET*
    ...
    (CL:SETF (%CLASS-CONSTRUCTOR-CODE CLASS) (CL:FUNCTION NEW-PROPERTY-LIST))
    (CL:SETF (%CLASS-SLOT-ACCESSOR-CODE CLASS) (CL:FUNCTION ACCESS-PROPERTY-LIST-SLOT-VALUE)))
   (CL:LET*
    ((CLASS
    ...
    (CL:SETF (%CLASS-SLOT-ACCESSOR-CODE CLASS) (CL:FUNCTION ACCESS-KV-CONS-SLOT-VALUE)))
   (CL:LET*
    ((CLASS
   ...
   (CL:LET*
    ...
    (CL:SETF (%CLASS-CONSTRUCTOR-CODE CLASS) (CL:FUNCTION NEW-RECYCLE-LIST))
    (CL:SETF (%CLASS-SLOT-ACCESSOR-CODE CLASS) (CL:FUNCTION ACCESS-RECYCLE-LIST-SLOT-VALUE)))
   (CL:LET*
    ((CLASS
   ...
   (CL:LET*
    ...
    (CL:SETF (%CLASS-SLOT-ACCESSOR-CODE CLASS) (CL:FUNCTION ACCESS-VECTOR-SLOT-VALUE)))
   (CL:LET*
    ((CLASS
...
backpointer to the instance slot they belong to.\" :MIXIN? TRUE :PUBLIC-SLOTS ((ACTIVE-SLOT :TYPE STORAGE-SLOT) (OWNER-INSTANCE :TYPE STANDARD-OBJECT)))")
   (CL:LET*
    ((CLASS
      (DEFINE-CLASS-FROM-STRINGIFIED-SOURCE "ACTIVE-LIST" "(DEFCLASS ACTIVE-LIST (LIST ACTIVE-COLLECTION-MIXIN))")))
   ...
   (CL:LET*
    ...
    (CL:SETF (%CLASS-SLOT-ACCESSOR-CODE CLASS) (CL:FUNCTION ACCESS-DEMON-SLOT-VALUE))))
  :VOID)
...
(CL:DEFUN HELP-STARTUP-HIERARCHY8 ()
  (CL:PROGN
   ...
   (CL:LET*
    ...
    (CL:SETF (%CLASS-SLOT-ACCESSOR-CODE CLASS) (CL:FUNCTION ACCESS-SYMBOL-SLOT-VALUE)))
   (CL:LET*
    ((CLASS
    ...
    (CL:SETF (%CLASS-CONSTRUCTOR-CODE CLASS) (CL:FUNCTION NEW-SURROGATE))
    (CL:SETF (%CLASS-SLOT-ACCESSOR-CODE CLASS) (CL:FUNCTION ACCESS-SURROGATE-SLOT-VALUE)))
   (CL:LET*
    ((CLASS
    ...
    (CL:SETF (%CLASS-SLOT-ACCESSOR-CODE CLASS) (CL:FUNCTION ACCESS-KEYWORD-SLOT-VALUE)))
   (CL:LET*
    ((CLASS
      (DEFINE-CLASS-FROM-STRINGIFIED-SOURCE "TRANSIENT-SYMBOL"
       "(DEFCLASS TRANSIENT-SYMBOL (SYMBOL TRANSIENT-MIXIN))")))
    (CL:SETQ *HARDWIRED-TRANSIENT?-ON-TRANSIENT-MIXIN* CL:T)
    (CL:SETF (%CLASS-CONSTRUCTOR-CODE CLASS) (CL:FUNCTION NEW-TRANSIENT-SYMBOL)))
   (CL:LET*
    ((CLASS
...
`self'.\")) :PUBLIC-SLOTS ((SLOT-INITIAL-VALUE :TYPE OBJECT :ALLOCATION :DYNAMIC :OPTION-KEYWORD :INITIALLY) (SLOT-ALLOCATION :TYPE KEYWORD :ALLOCATION :DYNAMIC :DEFAULT :INSTANCE :OPTION-KEYWORD :ALLOCATION) (SLOT-DEFAULT-EXPRESSION :TYPE OBJECT :ALLOCATION :DYNAMIC :OPTION-KEYWORD :DEFAULT) (SLOT-GUARD-DEMONS :TYPE (LIST OF DEMON) :ALLOCATION :DYNAMIC) (SLOT-DEMONS :TYPE (LIST OF DEMON) :ALLOCATION :DYNAMIC) (SLOT-REQUIRED? :TYPE BOOLEAN :OPTION-KEYWORD :REQUIRED?) (SLOT-COMPONENT? :TYPE BOOLEAN :OPTION-KEYWORD :COMPONENT?) (SLOT-READ-ONLY? :TYPE BOOLEAN :OPTION-KEYWORD :READ-ONLY?) (SLOT-HARDWIRED? :TYPE BOOLEAN :OPTION-KEYWORD :HARDWIRED?) (SLOT-CONTEXT-SENSITIVE? :TYPE BOOLEAN :OPTION-KEYWORD :CONTEXT-SENSITIVE?) (SLOT-READER :TYPE SYMBOL :ALLOCATION :DYNAMIC :OPTION-KEYWORD :READER) (SLOT-WRITER :TYPE SYMBOL :ALLOCATION :DYNAMIC :OPTION-KEYWORD :WRITER) (SLOT-OPTION-KEYWORD :TYPE KEYWORD :ALLOCATION :DYNAMIC :OPTION-KEYWORD :OPTION-KEYWORD) (SLOT-OPTION-HANDLER :TYPE SYMBOL :ALLOCATION :DYNAMIC :OPTION-KEYWORD :OPTION-HANDLER)))")))
    (CL:SETF (%CLASS-CONSTRUCTOR-CODE CLASS) (CL:FUNCTION NEW-STORAGE-SLOT))
    (CL:SETF (%CLASS-SLOT-ACCESSOR-CODE CLASS) (CL:FUNCTION ACCESS-STORAGE-SLOT-SLOT-VALUE)))
   (CL:LET*
    ((CLASS
    ...
    (CL:SETF (%CLASS-CONSTRUCTOR-CODE CLASS) (CL:FUNCTION NEW-METHOD-SLOT))
    (CL:SETF (%CLASS-SLOT-ACCESSOR-CODE CLASS) (CL:FUNCTION ACCESS-METHOD-SLOT-SLOT-VALUE)))
   ...
   (CL:LET*
    ...
    (CL:SETF (%CLASS-SLOT-ACCESSOR-CODE CLASS) (CL:FUNCTION ACCESS-TABLE-SLOT-VALUE)))
   (CL:LET*
    ((CLASS
...
class that participates in the PowerLoom side of things.\" :PUBLIC-SLOTS ((SURROGATE-VALUE-INVERSE :TYPE SURROGATE)) :PRINT-FORM (IF (DEFINED? (SURROGATE-VALUE-INVERSE SELF)) (PRINT-NATIVE-STREAM STREAM \"|i|\" (SYMBOL-NAME (SURROGATE-VALUE-INVERSE SELF))) (PRINT-NATIVE-STREAM STREAM \"|i|\" (PRIMARY-TYPE SELF))))")))
   ...
   (CL:LET*
    ...
    (CL:SETF (%CLASS-SLOT-ACCESSOR-CODE CLASS) (CL:FUNCTION ACCESS-MODULE-SLOT-VALUE)))
   (CL:LET*
    ((CLASS
    ...
    (CL:SETF (%CLASS-SLOT-ACCESSOR-CODE CLASS) (CL:FUNCTION ACCESS-WORLD-SLOT-VALUE)))
   (CL:LET*
    ((CLASS
...
appear first.\" :PARAMETERS ((ANY-KEY :TYPE CONTEXT) (ANY-VALUE :TYPE OBJECT)))")))
   ...
   (CL:LET*
    ...
    (CL:SETF (%CLASS-CONSTRUCTOR-CODE CLASS) (CL:FUNCTION NEW-INTERVAL))
    (CL:SETF (%CLASS-SLOT-ACCESSOR-CODE CLASS) (CL:FUNCTION ACCESS-INTERVAL-SLOT-VALUE)))
   (CL:LET*
    ((CLASS
    ...
    (CL:SETF (%CLASS-CONSTRUCTOR-CODE CLASS) (CL:FUNCTION NEW-TAXONOMY-NODE))
    (CL:SETF (%CLASS-SLOT-ACCESSOR-CODE CLASS) (CL:FUNCTION ACCESS-TAXONOMY-NODE-SLOT-VALUE)))
   (CL:LET*
    ((CLASS
...
the whole graph non-incrementally.\" :TYPE FLOAT :INITIALLY 0.1)) :SLOTS ((INCREMENTAL-MODE? :TYPE BOOLEAN) (LARGEST-POSTORDER-NUMBER :TYPE INTEGER) (NUMBER-OF-NODES :TYPE INTEGER) (NUMBER-OF-FOREIGN-INTERVAL-NODES :TYPE INTEGER) (ROOTS :TYPE (LIST OF TAXONOMY-NODE)) (BROKEN-LINKS :TYPE (LIST OF (CONS OF TAXONOMY-NODE))) (ADDED-LINKS :TYPE (LIST OF (CONS OF TAXONOMY-NODE))) (REMOVED-LINKS :TYPE (LIST OF (CONS OF TAXONOMY-NODE)))) :INITIALIZER INITIALIZE-TAXONOMY-GRAPH :PRINT-FORM (PRINT-NATIVE-STREAM STREAM \"|TG|\" (ROOTS SELF)))")))
   ...
   (CL:LET*
    ((CLASS
      (DEFINE-CLASS-FROM-STRINGIFIED-SOURCE "OBJECT-NOT-CLASS-EXCEPTION"
...
(CL:DEFUN STARTUP-HIERARCHY ()
  (CL:LET* ((*MODULE* *STELLA-MODULE*) (*CONTEXT* *MODULE*)) (CL:DECLARE (CL:SPECIAL *MODULE* *CONTEXT*))
   (CL:WHEN (CURRENT-STARTUP-TIME-PHASE? 2) (HELP-STARTUP-HIERARCHY1) (HELP-STARTUP-HIERARCHY2)
    (HELP-STARTUP-HIERARCHY3) (HELP-STARTUP-HIERARCHY4) (HELP-STARTUP-HIERARCHY5) (HELP-STARTUP-HIERARCHY6))
   (CL:WHEN (CURRENT-STARTUP-TIME-PHASE? 4) (CL:SETQ *HARDWIRED-TRANSIENT?-ON-TRANSIENT-MIXIN* CL:NIL)
   ...
   (CL:WHEN (CURRENT-STARTUP-TIME-PHASE? 5) (HELP-STARTUP-HIERARCHY7) (HELP-STARTUP-HIERARCHY8)
    ...
    (CL:LET*
     ...
     (CL:SETF (%CLASS-CONSTRUCTOR-CODE CLASS) (CL:FUNCTION NEW-FLOAT-WRAPPER))
     (CL:SETF (%CLASS-SLOT-ACCESSOR-CODE CLASS) (CL:FUNCTION ACCESS-FLOAT-WRAPPER-SLOT-VALUE)))
    (CL:LET*
     ((CLASS
...
for tokenization.\")) :TERMINATOR TERMINATE-INPUT-STREAM?)")))
     (CL:SETF (%CLASS-CONSTRUCTOR-CODE CLASS) (CL:FUNCTION NEW-INPUT-STREAM))
     (CL:SETF (%CLASS-SLOT-ACCESSOR-CODE CLASS) (CL:FUNCTION ACCESS-INPUT-STREAM-SLOT-VALUE)))
    (CL:LET*
     ((CLASS
   ...
   (CL:WHEN (CURRENT-STARTUP-TIME-PHASE? 7)
    ...
    (DEFINE-METHOD-OBJECT
     ...
     NULL NULL)
    (DEFINE-FUNCTION-OBJECT "STARTUP-HIERARCHY" "(DEFUN STARTUP-HIERARCHY () :PUBLIC? TRUE)"
     (CL:FUNCTION STARTUP-HIERARCHY) NULL)
    (CL:LET* ((FUNCTION (LOOKUP-FUNCTION SYM-HIERARCHY-STELLA-STARTUP-HIERARCHY)))
     (SET-DYNAMIC-SLOT-VALUE (%DYNAMIC-SLOTS FUNCTION) SYM-HIERARCHY-STELLA-METHOD-STARTUP-CLASSNAME
