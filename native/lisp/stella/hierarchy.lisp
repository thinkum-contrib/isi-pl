...
(CL:DECLAIM (CL:TYPE CL:FIXNUM *HARDWIRED-RESIZE-INCREMENT-ON-VECTOR-SEQUENCE*))
(CL:DEFVAR SYM-HIERARCHY-STELLA-RESIZE-INCREMENT NULL)
(CL:DEFVAR SYM-HIERARCHY-STELLA-SEQUENCE-LENGTH NULL)
(CL:DEFVAR SYM-HIERARCHY-STELLA-VSEQ NULL)
(CL:DEFVAR SGT-HIERARCHY-STELLA-SHORT-VECTOR-SEQUENCE NULL)
(CL:DEFVAR *HARDWIRED-RESIZE-INCREMENT-ON-SHORT-VECTOR-SEQUENCE* NULL-INTEGER)
(CL:DECLAIM
 (CL:TYPE CL:FIXNUM *HARDWIRED-RESIZE-INCREMENT-ON-SHORT-VECTOR-SEQUENCE*))
(CL:DEFVAR SYM-HIERARCHY-STELLA-SVSEQ NULL)
...
(CL:DECLAIM
 (CL:SPECIAL *STELLA-MODULE* *MODULE* *PRINTREADABLY?* NULL-FLOAT
  *HARDWIRED-CLASS-ARITY-ON-CLASS* *JAVA-STELLA-PACKAGE-MAPPING*
  NULL-STRING-WRAPPER NIL-LIST *HARDWIRED-TRANSIENT?-ON-TRANSIENT-MIXIN*
  *CONTEXT* *HARDWIRED-RESIZE-INCREMENT-ON-SHORT-VECTOR-SEQUENCE*
  *HARDWIRED-RESIZE-INCREMENT-ON-VECTOR-SEQUENCE* NULL-CHARACTER NIL TRUE
  TRUE-WRAPPER FALSE-WRAPPER NULL-INTEGER FALSE))
...
(CL:DEFCLASS REFERENCE-COUNT-OBJECT (OBJECT)
  ((REFERENCE-COUNT :TYPE CL:FIXNUM :INITFORM NULL-INTEGER :ALLOCATION :INSTANCE
    :ACCESSOR %REFERENCE-COUNT))
...
(CL:DEFMETHOD BAD? ((SELF ACTIVE-OBJECT))
  (CL:LET*
   ((ANSWER
     (DYNAMIC-SLOT-VALUE (%DYNAMIC-SLOTS SELF) SYM-HIERARCHY-STELLA-BAD? NULL)))
   (CL:IF (CL:EQ ANSWER NULL)
    (CL:RETURN-FROM BAD? (CL:IF FALSE TRUE-WRAPPER FALSE-WRAPPER))
...
(CL:DEFMETHOD DELETED? ((SELF ACTIVE-OBJECT))
  (CL:LET*
   ...
   (CL:IF (CL:NOT (CL:EQ DELETED? NULL))
    (CL:RETURN-FROM DELETED? (COERCE-WRAPPED-BOOLEAN-TO-BOOLEAN DELETED?))
    (CL:RETURN-FROM DELETED? FALSE))))

(CL:DEFMETHOD DELETED?-SETTER ((SELF ACTIVE-OBJECT) VALUE)
  (SET-DYNAMIC-SLOT-VALUE (%DYNAMIC-SLOTS SELF)
   SYM-HIERARCHY-STELLA-DELETED-OBJECT? (CL:IF VALUE TRUE-WRAPPER FALSE-WRAPPER)
   NULL)
...
(CL:DEFUN ACCESS-ABSTRACT-ITERATOR-SLOT-VALUE (SELF SLOTNAME VALUE SETVALUE?)
  (CL:COND
   ((CL:EQ SLOTNAME SYM-HIERARCHY-STELLA-FIRST-ITERATION?)
    (CL:IF SETVALUE?
     (CL:SETF (%FIRST-ITERATION? SELF) (COERCE-WRAPPED-BOOLEAN-TO-BOOLEAN VALUE))
     (CL:SETQ VALUE
...
(CL:DEFCLASS ITERATOR (ABSTRACT-ITERATOR)
  ((VALUE :DOCUMENTATION "The current value of this iterator" :ALLOCATION
...
(CL:DEFCLASS ALL-PURPOSE-ITERATOR (ITERATOR)
  ((KEY :ALLOCATION :INSTANCE :ACCESSOR %KEY)
   (ITERATOR-NEXT-CODE :ALLOCATION :INSTANCE :ACCESSOR %ITERATOR-NEXT-CODE)
   ...
   (ITERATOR-INTEGER :TYPE CL:FIXNUM :INITFORM NULL-INTEGER :ALLOCATION :INSTANCE
    :ACCESSOR %ITERATOR-INTEGER)
   (ITERATOR-SECOND-INTEGER :TYPE CL:FIXNUM :INITFORM NULL-INTEGER :ALLOCATION
    :INSTANCE :ACCESSOR %ITERATOR-SECOND-INTEGER))
...
(CL:DEFMETHOD NEXT? ((SELF TYPES-TO-CLASSES-ITERATOR))
  ...
  (CL:COND
   ((CL:NOT (CL:EQ (%ITERATOR-CURSOR SELF) NIL))
    (CL:SETF (%VALUE SELF) (%SURROGATE-VALUE (%%VALUE (%ITERATOR-CURSOR SELF))))
...
(CL:DEFUN NEW-PROPERTY-LIST-ITERATOR ()
  (CL:LET* ((SELF NULL))
   ...
   (CL:SETF (%FIRST-ITERATION? SELF) TRUE) (CL:SETF (%VALUE SELF) NULL)
   (CL:SETF (%KEY SELF) NULL) (CL:SETF (%PLIST-ITERATOR-COLLECTION SELF) NULL)
...
(CL:DEFUN NEW-KV-LIST-ITERATOR ()
  (CL:LET* ((SELF NULL))
   ...
   (CL:SETF (%FIRST-ITERATION? SELF) TRUE) (CL:SETF (%VALUE SELF) NULL)
   (CL:SETF (%KEY SELF) NULL) (CL:SETF (%KV-LIST-ITERATOR-CURSOR SELF) NULL)
   (CL:SETF (%THE-KV-LIST SELF) NULL) (CL:RETURN-FROM NEW-KV-LIST-ITERATOR SELF)))
...
(CL:DEFCLASS INTEGER-INTERVAL-ITERATOR (INTERVAL-ITERATOR)
  ((INTERVAL-CURSOR :TYPE CL:FIXNUM :INITFORM NULL-INTEGER :ALLOCATION :INSTANCE
    :ACCESSOR %INTERVAL-CURSOR)
   (LOWER-BOUND :TYPE CL:FIXNUM :INITFORM NULL-INTEGER :ALLOCATION :INSTANCE
    :ACCESSOR %LOWER-BOUND)
   (UPPER-BOUND :TYPE CL:FIXNUM :INITFORM NULL-INTEGER :ALLOCATION :INSTANCE
...
(CL:DEFUN NEW-INTEGER-INTERVAL-ITERATOR (LOWER-BOUND UPPER-BOUND)
  ...
  (CL:LET* ((SELF NULL))
   ...
   (CL:SETF (%FIRST-ITERATION? SELF) TRUE) (CL:SETF (%VALUE SELF) NULL-INTEGER)
...
(CL:DEFUN NEW-REVERSE-INTEGER-INTERVAL-ITERATOR (LOWER-BOUND UPPER-BOUND)
  ...
  (CL:CHECK-TYPE UPPER-BOUND CL:FIXNUM)
  (CL:LET* ((SELF NULL))
   (CL:SETQ SELF (CL:MAKE-INSTANCE (CL:QUOTE REVERSE-INTEGER-INTERVAL-ITERATOR)))
   (CL:SETF (%LOWER-BOUND SELF) LOWER-BOUND)
   (CL:SETF (%UPPER-BOUND SELF) UPPER-BOUND)
   (CL:SETF (%FIRST-ITERATION? SELF) TRUE) (CL:SETF (%VALUE SELF) NULL-INTEGER)
   (CL:SETF (%INTERVAL-CURSOR SELF) NULL-INTEGER)
...
(CL:DEFCLASS STRING-ITERATOR (ABSTRACT-ITERATOR)
  ((THE-STRING :TYPE CL:SIMPLE-STRING :INITFORM STELLA::NULL-STRING :ALLOCATION
    :INSTANCE :ACCESSOR %THE-STRING)
...
(CL:DEFUN NEW-STRING-ITERATOR ()
  (CL:LET* ((SELF NULL))
   ...
   (CL:SETF (%FIRST-ITERATION? SELF) TRUE) (CL:SETF (%VALUE SELF) NULL-CHARACTER)
   (CL:SETF (%END SELF) NULL-INTEGER) (CL:SETF (%CURSOR SELF) NULL-INTEGER)
...
(CL:DEFUN NEW-LIST ()
  (CL:LET* ((SELF NULL)) (CL:SETQ SELF (CL:MAKE-INSTANCE (CL:QUOTE LIST)))
...
(CL:DEFUN NEW-SET ()
  (CL:LET* ((SELF NULL)) (CL:SETQ SELF (CL:MAKE-INSTANCE (CL:QUOTE SET)))
...
(CL:DEFUN NEW-PROPERTY-LIST ()
  (CL:LET* ((SELF NULL))
   ...
   (CL:SETF (%THE-PLIST SELF) NIL) (CL:RETURN-FROM NEW-PROPERTY-LIST SELF)))
...
(CL:DEFUN NEW-KV-CONS ()
  (CL:LET* ((SELF NULL)) (CL:SETQ SELF (CL:MAKE-INSTANCE (CL:QUOTE KV-CONS)))
...
(CL:DEFUN NEW-KEY-VALUE-LIST ()
  (CL:LET* ((SELF NULL))
   ...
   (CL:SETF (%THE-KV-LIST SELF) NULL) (CL:RETURN-FROM NEW-KEY-VALUE-LIST SELF)))
...
(CL:DEFCLASS RECYCLE-LIST (SEQUENCE)
  ((RECYCLE-LIST-OF :ALLOCATION :INSTANCE :ACCESSOR %RECYCLE-LIST-OF)
   ...
   (CURRENT-LENGTH :TYPE CL:FIXNUM :INITFORM NULL-INTEGER :ALLOCATION :INSTANCE
    :ACCESSOR %CURRENT-LENGTH)
   (ITEM-SIZE :TYPE CL:FIXNUM :INITFORM NULL-INTEGER :ALLOCATION :INSTANCE
    :ACCESSOR %ITEM-SIZE)))

(CL:DEFUN NEW-RECYCLE-LIST ()
  (CL:LET* ((SELF NULL))
   (CL:SETQ SELF (CL:MAKE-INSTANCE (CL:QUOTE RECYCLE-LIST)))
   (CL:SETF (%ITEM-SIZE SELF) NULL-INTEGER) (CL:SETF (%CURRENT-LENGTH SELF) 0)
   (CL:SETF (%UNUSED-ITEMS SELF) NULL) (CL:SETF (%ALL-ITEMS SELF) NULL)
   (CL:SETF (%LIST-OF-RECYCLED-ITEMS SELF) (MAKE-NON-RECYCLED-LIST))
   (CL:SETF (%RECYCLED-ITEMS SELF) NULL) (CL:SETF (%RECYCLE-LIST-OF SELF) NULL)
...
(CL:DEFUN NEW-VECTOR (ARRAY-SIZE)
  ...
  (CL:LET* ((SELF NULL)) (CL:SETQ SELF (CL:MAKE-INSTANCE (CL:QUOTE VECTOR)))
...
(CL:DEFCLASS EXTENSIBLE-SYMBOL-ARRAY (EXTENSIBLE-VECTOR)
  ((TOP-SYMBOL-OFFSET :TYPE CL:FIXNUM :INITFORM NULL-INTEGER :ALLOCATION
    :INSTANCE :ACCESSOR %TOP-SYMBOL-OFFSET)
...
(CL:DEFUN ACCESS-EXTENSIBLE-SYMBOL-ARRAY-SLOT-VALUE (SELF SLOTNAME VALUE SETVALUE?)
  (CL:COND
   ...
   ((CL:EQ SLOTNAME SYM-HIERARCHY-STELLA-POTENTIAL-FREE-SYMBOL-OFFSET)
    (CL:IF SETVALUE?
     (CL:SETF (%POTENTIAL-FREE-SYMBOL-OFFSET SELF) (%WRAPPER-VALUE VALUE))
...
(CL:DEFCLASS VECTOR-SEQUENCE (VECTOR)
  ((SEQUENCE-LENGTH :TYPE CL:FIXNUM :INITFORM NULL-INTEGER :ALLOCATION :INSTANCE
    :ACCESSOR %SEQUENCE-LENGTH)))

(CL:DEFMETHOD RESIZE-INCREMENT ((SELF VECTOR-SEQUENCE))
  (CL:RETURN-FROM RESIZE-INCREMENT
   *HARDWIRED-RESIZE-INCREMENT-ON-VECTOR-SEQUENCE*))

(CL:DEFUN ACCESS-VECTOR-SEQUENCE-SLOT-VALUE (SELF SLOTNAME VALUE SETVALUE?)
  (CL:COND
   ((CL:EQ SLOTNAME SYM-HIERARCHY-STELLA-RESIZE-INCREMENT)
    (CL:SETQ VALUE (WRAP-INTEGER (RESIZE-INCREMENT SELF))))
...
(CL:DEFMETHOD PRIMARY-TYPE ((SELF SHORT-VECTOR-SEQUENCE))
  (CL:RETURN-FROM PRIMARY-TYPE SGT-HIERARCHY-STELLA-SHORT-VECTOR-SEQUENCE))
...
(CL:DEFUN NEW-ACTIVE-LIST ()
  (CL:LET* ((SELF NULL)) (CL:SETQ SELF (CL:MAKE-INSTANCE (CL:QUOTE ACTIVE-LIST)))
   (CL:SETF (%OWNER-INSTANCE SELF) NULL) (CL:SETF (%ACTIVE-SLOT SELF) NULL)
...
(CL:DEFUN NEW-ACTIVE-SET ()
  (CL:LET* ((SELF NULL)) (CL:SETQ SELF (CL:MAKE-INSTANCE (CL:QUOTE ACTIVE-SET)))
   (CL:SETF (%OWNER-INSTANCE SELF) NULL) (CL:SETF (%ACTIVE-SLOT SELF) NULL)
...
(CL:DEFCLASS DEMON (STANDARD-OBJECT)
  ((DEMON-NAME :TYPE CL:SIMPLE-STRING :INITFORM STELLA::NULL-STRING :ALLOCATION
    :INSTANCE :ACCESSOR %DEMON-NAME)
   ...
   (DEMON-DOCUMENTATION :TYPE CL:SIMPLE-STRING :INITFORM STELLA::NULL-STRING
    :ALLOCATION :INSTANCE :ACCESSOR %DEMON-DOCUMENTATION)
...
(CL:DEFUN NEW-DEMON ()
  (CL:LET* ((SELF NULL)) (CL:SETQ SELF (CL:MAKE-INSTANCE (CL:QUOTE DEMON)))
   (CL:SETF (%DEMON-INHERIT? SELF) FALSE) (CL:SETF (%DEMON-ALL? SELF) FALSE)
   (CL:SETF (%DEMON-GUARD? SELF) FALSE)
   (CL:SETF (%DEMON-DOCUMENTATION SELF) STELLA::NULL-STRING)
   (CL:SETF (%DEMON-METHOD SELF) NULL) (CL:SETF (%DEMON-CODE SELF) NULL)
...
(CL:DEFCLASS GENERALIZED-SYMBOL (CONTEXT-SENSITIVE-OBJECT)
  ((SYMBOL-NAME :TYPE CL:SIMPLE-STRING :INITFORM STELLA::NULL-STRING :ALLOCATION
    :INSTANCE :ACCESSOR %SYMBOL-NAME)
   (SYMBOL-ID :TYPE CL:FIXNUM :INITFORM NULL-INTEGER :ALLOCATION :INSTANCE
    :ACCESSOR %SYMBOL-ID)))
...
(CL:DEFCLASS SYMBOL (GENERALIZED-SYMBOL)
  ((SYMBOL-SLOT-OFFSET :TYPE CL:FIXNUM :INITFORM NULL-INTEGER :ALLOCATION
    :INSTANCE :ACCESSOR %SYMBOL-SLOT-OFFSET)
...
(CL:DEFUN NEW-SYMBOL (SYMBOL-NAME)
  ...
  (CL:LET* ((SELF NULL)) (CL:SETQ SELF (CL:MAKE-INSTANCE (CL:QUOTE SYMBOL)))
...
(CL:DEFUN NEW-SURROGATE (SYMBOL-NAME)
  ...
  (CL:LET* ((SELF NULL)) (CL:SETQ SELF (CL:MAKE-INSTANCE (CL:QUOTE SURROGATE)))
   ...
   (CL:SETF (%HOME-CONTEXT SELF) *CONTEXT*)
   (CL:SETF (%SYMBOL-ID SELF) NULL-INTEGER)
   (CL:SETF (%SURROGATE-VALUE SELF) NULL) (CL:RETURN-FROM NEW-SURROGATE SELF)))
...
(CL:DEFUN NEW-KEYWORD (SYMBOL-NAME)
  ...
  #+MCL
  (CL:CHECK-TYPE SYMBOL-NAME CL:SIMPLE-STRING)
  (CL:LET* ((SELF NULL)) (CL:SETQ SELF (CL:MAKE-INSTANCE (CL:QUOTE KEYWORD)))
   (CL:SETF (%SYMBOL-NAME SELF) SYMBOL-NAME)
   (CL:SETF (%HOME-CONTEXT SELF) *CONTEXT*)
...
(CL:DEFMETHOD PROJECTS-ONTO ((SELF MAPPABLE-OBJECT))
  (CL:LET*
   ((ANSWER
     (DYNAMIC-SLOT-VALUE (%DYNAMIC-SLOTS SELF) SYM-HIERARCHY-STELLA-PROJECTS-ONTO
      NULL)))
...
(CL:DEFMETHOD PROPERTIES ((SELF RELATION))
  (CL:LET*
   ((ANSWER
     (DYNAMIC-SLOT-VALUE (%DYNAMIC-SLOTS SELF) SYM-HIERARCHY-STELLA-PROPERTIES
      NULL)))
...
(CL:DEFUN ACCESS-RELATION-SLOT-VALUE (SELF SLOTNAME VALUE SETVALUE?)
  (CL:COND
   ((CL:EQ SLOTNAME SYM-HIERARCHY-STELLA-ABSTRACT?)
    (CL:IF SETVALUE?
     (CL:SETF (%ABSTRACT? SELF) (COERCE-WRAPPED-BOOLEAN-TO-BOOLEAN VALUE))
...
(CL:DEFCLASS CLASS (RELATION)
  ((CL-STRUCT? :ALLOCATION :INSTANCE :ACCESSOR %CL-STRUCT?)
   ...
   (CLASS-STRINGIFIED-SOURCE :TYPE CL:SIMPLE-STRING :INITFORM STELLA::NULL-STRING
    :ALLOCATION :INSTANCE :ACCESSOR %CLASS-STRINGIFIED-SOURCE)
...
(CL:DEFUN NEW-CLASS ()
  (CL:LET* ((SELF NULL)) (CL:SETQ SELF (CL:MAKE-INSTANCE (CL:QUOTE CLASS)))
   ...
   (CL:SETF (%CLASS-MARKED? SELF) FALSE)
   ...
   (CL:SETF (%CLASS-SLOTS-FINALIZED? SELF) FALSE)
   (CL:SETF (%CLASS-FINALIZED? SELF) FALSE) (CL:SETF (%CLASS-PUBLIC? SELF) TRUE)
   (CL:SETF (%CL-STRUCT? SELF) FALSE) (CL:SETF (%CLASS-COLLECTION? SELF) FALSE)
   (CL:SETF (%MIXIN? SELF) FALSE) (CL:SETF (%ABSTRACT? SELF) FALSE)
...
(CL:DEFMETHOD CREATOR ((SELF CLASS))
  (CL:RETURN-FROM CREATOR
   (DYNAMIC-SLOT-VALUE (%DYNAMIC-SLOTS SELF) SYM-HIERARCHY-STELLA-CLASS-CREATOR
    NULL)))
...
(CL:DEFMETHOD JAVA-NATIVE-TYPE ((SELF CLASS))
  (CL:LET*
   ((NATIVETYPE
     (%WRAPPER-VALUE
      (DYNAMIC-SLOT-VALUE (%DYNAMIC-SLOTS SELF)
       SYM-HIERARCHY-STELLA-CLASS-JAVA-NATIVE-TYPE NULL-STRING-WRAPPER))))
...
(CL:DEFMETHOD CLASS-PARAMETERS ((SELF CLASS))
  (CL:LET*
   ((ANSWER
     (DYNAMIC-SLOT-VALUE (%DYNAMIC-SLOTS SELF)
      SYM-HIERARCHY-STELLA-CLASS-PARAMETERS NULL)))
   (CL:IF (CL:EQ ANSWER NULL) (CL:RETURN-FROM CLASS-PARAMETERS NIL-LIST)
...
(CL:DEFMETHOD CLASS-KEY ((SELF CLASS))
  (CL:LET*
   ((ANSWER
     (DYNAMIC-SLOT-VALUE (%DYNAMIC-SLOTS SELF) SYM-HIERARCHY-STELLA-CLASS-KEY
      NULL)))
...
(CL:DEFUN ACCESS-CLASS-SLOT-VALUE (SELF SLOTNAME VALUE SETVALUE?)
  (CL:COND
   ((CL:EQ SLOTNAME SYM-HIERARCHY-STELLA-CL-STRUCT?)
    (CL:IF SETVALUE?
     (CL:SETF (%CL-STRUCT? SELF) (COERCE-WRAPPED-BOOLEAN-TO-BOOLEAN VALUE))
   ...
   ((CL:EQ SLOTNAME SYM-HIERARCHY-STELLA-CLASS-PUBLIC?)
    (CL:IF SETVALUE?
     (CL:SETF (%CLASS-PUBLIC? SELF) (COERCE-WRAPPED-BOOLEAN-TO-BOOLEAN VALUE))
   ...
   ((CL:EQ SLOTNAME SYM-HIERARCHY-STELLA-CLASS-FINALIZED?)
    (CL:IF SETVALUE?
     (CL:SETF (%CLASS-FINALIZED? SELF) (COERCE-WRAPPED-BOOLEAN-TO-BOOLEAN VALUE))
     (CL:SETQ VALUE
   ...
   ((CL:EQ SLOTNAME SYM-HIERARCHY-STELLA-CLASS-SLOTS-FINALIZED?)
    (CL:IF SETVALUE?
     (CL:SETF (%CLASS-SLOTS-FINALIZED? SELF)
      (COERCE-WRAPPED-BOOLEAN-TO-BOOLEAN VALUE))
     (CL:SETQ VALUE
      (CL:IF (%CLASS-SLOTS-FINALIZED? SELF) TRUE-WRAPPER FALSE-WRAPPER))))
   ...
   ((CL:EQ SLOTNAME SYM-HIERARCHY-STELLA-CLASS-KEY)
    (CL:IF SETVALUE?
     (SET-DYNAMIC-SLOT-VALUE (%DYNAMIC-SLOTS SELF) SYM-HIERARCHY-STELLA-CLASS-KEY
      VALUE NULL)
   ...
   ((CL:EQ SLOTNAME SYM-HIERARCHY-STELLA-CLASS-MARKED?)
    (CL:IF SETVALUE?
     (CL:SETF (%CLASS-MARKED? SELF) (COERCE-WRAPPED-BOOLEAN-TO-BOOLEAN VALUE))
  ...
  (CL:LET*
   ...
   (CL:LOOP
    (CL:WHEN (CL:NOT (CL:EQ VALUE NULL))
     (CL:RETURN-FROM ACTIVE? (COERCE-WRAPPED-BOOLEAN-TO-BOOLEAN VALUE)))
    (CL:SETQ CURSOR (%SLOT-DIRECT-EQUIVALENT CURSOR))
    (CL:IF (CL:NOT (CL:EQ CURSOR NULL))
     (CL:SETQ VALUE
      (DYNAMIC-SLOT-VALUE (%DYNAMIC-SLOTS CURSOR)
       SYM-HIERARCHY-STELLA-STORED-ACTIVE? NULL))
     (CL:RETURN-FROM ACTIVE? FALSE)))))
...
(CL:DEFMETHOD TYPE ((SELF SLOT))
  ...
  (CL:LET* ((CURSOR SELF) (VALUE (%SLOT-BASE-TYPE CURSOR)))
   (CL:LOOP (CL:WHEN (CL:NOT (CL:EQ VALUE NULL)) (CL:RETURN-FROM TYPE VALUE))
    (CL:SETQ CURSOR (%SLOT-DIRECT-EQUIVALENT CURSOR))
    (CL:IF (CL:NOT (CL:EQ CURSOR NULL)) (CL:SETQ VALUE (%SLOT-BASE-TYPE CURSOR))
...
(CL:DEFMETHOD RENAMES ((SELF SLOT))
  (CL:RETURN-FROM RENAMES
   (DYNAMIC-SLOT-VALUE (%DYNAMIC-SLOTS SELF) SYM-HIERARCHY-STELLA-SLOT-RENAMES
    NULL)))
...
(CL:DEFMETHOD SLOT-DIRECT-SUPERS ((SELF SLOT))
  (CL:LET*
   ...
   (CL:IF (CL:EQ ANSWER NULL) (CL:RETURN-FROM SLOT-DIRECT-SUPERS NIL-LIST)
...
(CL:DEFMETHOD SLOT-DIRECT-SUBS ((SELF SLOT))
  (CL:LET*
   ...
   (CL:IF (CL:EQ ANSWER NULL) (CL:RETURN-FROM SLOT-DIRECT-SUBS NIL-LIST)
...
(CL:DEFUN NEW-STORAGE-SLOT ()
  (CL:LET* ((SELF NULL))
   ...
   (CL:SETF (%DYNAMIC-SLOTS SELF) (NEW-KEY-VALUE-LIST))
   (CL:SETF (%ABSTRACT? SELF) FALSE)
   (CL:SETF (%SLOT-DIRECT-EQUIVALENT SELF) NULL)
   (CL:SETF (%SLOT-MARKED? SELF) FALSE) (CL:SETF (%SLOT-EXTERNAL? SELF) FALSE)
   (CL:SETF (%SLOT-RENAMED? SELF) FALSE) (CL:SETF (%SLOT-PUBLIC? SELF) TRUE)
   (CL:SETF (%SLOT-SLOTREF SELF) NULL) (CL:SETF (%SLOT-BASE-TYPE SELF) NULL)
   (CL:SETF (%SLOT-OWNER SELF) NULL) (CL:SETF (%SLOT-NAME SELF) NULL)
   (CL:SETF (%SLOT-CONTEXT-SENSITIVE? SELF) FALSE)
   (CL:SETF (%SLOT-HARDWIRED? SELF) FALSE)
   (CL:SETF (%SLOT-READ-ONLY? SELF) FALSE)
   (CL:SETF (%SLOT-COMPONENT? SELF) FALSE) (CL:SETF (%SLOT-REQUIRED? SELF) FALSE)
...
creation time."
  (CL:LET* ((CURSOR SELF) (VALUE (%SLOT-REQUIRED? CURSOR)))
   (CL:LOOP (CL:WHEN VALUE (CL:RETURN-FROM REQUIRED? VALUE))
    (CL:SETQ CURSOR (%SLOT-DIRECT-EQUIVALENT CURSOR))
    (CL:IF (CL:NOT (CL:EQ CURSOR NULL)) (CL:SETQ VALUE (%SLOT-REQUIRED? CURSOR))
...
owner slot, and therefore should be deleted if the owner is deleted."
  (CL:LET* ((CURSOR SELF) (VALUE (%SLOT-COMPONENT? CURSOR)))
   (CL:LOOP (CL:WHEN VALUE (CL:RETURN-FROM COMPONENT? VALUE))
    (CL:SETQ CURSOR (%SLOT-DIRECT-EQUIVALENT CURSOR))
    (CL:IF (CL:NOT (CL:EQ CURSOR NULL)) (CL:SETQ VALUE (%SLOT-COMPONENT? CURSOR))
...
`self'."
  (CL:LET*
   ((CURSOR SELF)
    (VALUE
     (DYNAMIC-SLOT-VALUE (%DYNAMIC-SLOTS CURSOR) SYM-HIERARCHY-STELLA-SLOT-READER
      NULL)))
...
`self'."
  (CL:LET*
   ((CURSOR SELF)
    (VALUE
     (DYNAMIC-SLOT-VALUE (%DYNAMIC-SLOTS CURSOR) SYM-HIERARCHY-STELLA-SLOT-WRITER
      NULL)))
...
(CL:DEFMETHOD SLOT-GUARD-DEMONS ((SELF STORAGE-SLOT))
  (CL:LET*
   ...
   (CL:IF (CL:EQ ANSWER NULL) (CL:RETURN-FROM SLOT-GUARD-DEMONS NIL-LIST)
    (CL:RETURN-FROM SLOT-GUARD-DEMONS ANSWER))))

(CL:DEFMETHOD SLOT-DEMONS ((SELF STORAGE-SLOT))
  (CL:LET*
   ((ANSWER
     (DYNAMIC-SLOT-VALUE (%DYNAMIC-SLOTS SELF) SYM-HIERARCHY-STELLA-SLOT-DEMONS
      NULL)))
   ...
   ((CL:EQ SLOTNAME SYM-HIERARCHY-STELLA-SLOT-CONTEXT-SENSITIVE?)
    (CL:IF SETVALUE?
     (CL:SETF (%SLOT-CONTEXT-SENSITIVE? SELF)
      (COERCE-WRAPPED-BOOLEAN-TO-BOOLEAN VALUE))
     (CL:SETQ VALUE
      (CL:IF (%SLOT-CONTEXT-SENSITIVE? SELF) TRUE-WRAPPER FALSE-WRAPPER))))
   (CL:T
    (CL:IF SETVALUE?
     (SET-DYNAMIC-SLOT-VALUE (%DYNAMIC-SLOTS SELF) SLOTNAME VALUE NULL)
     (CL:SETQ VALUE (LOOKUP (%DYNAMIC-SLOTS SELF) SLOTNAME)))))
...
(CL:DEFUN NEW-METHOD-SLOT ()
  (CL:LET* ((SELF NULL)) (CL:SETQ SELF (CL:MAKE-INSTANCE (CL:QUOTE METHOD-SLOT)))
   ...
   (CL:SETF (%SLOT-SLOTREF SELF) NULL) (CL:SETF (%SLOT-BASE-TYPE SELF) NULL)
   (CL:SETF (%SLOT-OWNER SELF) NULL) (CL:SETF (%SLOT-NAME SELF) NULL)
   (CL:SETF (%METHOD-FUNCTION? SELF) FALSE) (CL:SETF (%FUNCTION-CODE SELF) NULL)
   ...
   (CL:SETF (%METHOD-SETTER? SELF) FALSE) (CL:RETURN-FROM NEW-METHOD-SLOT SELF)))
...
(CL:DEFUN ACCESS-METHOD-SLOT-SLOT-VALUE (SELF SLOTNAME VALUE SETVALUE?)
  (CL:COND
   ((CL:EQ SLOTNAME SYM-HIERARCHY-STELLA-METHOD-SETTER?)
    (CL:IF SETVALUE?
     (CL:SETF (%METHOD-SETTER? SELF) (COERCE-WRAPPED-BOOLEAN-TO-BOOLEAN VALUE))
   ...
   ((CL:EQ SLOTNAME SYM-HIERARCHY-STELLA-METHOD-FUNCTION?)
    (CL:IF SETVALUE?
     (CL:SETF (%METHOD-FUNCTION? SELF) (COERCE-WRAPPED-BOOLEAN-TO-BOOLEAN VALUE))
     (CL:SETQ VALUE
   ...
   ((CL:EQ SLOTNAME SYM-HIERARCHY-STELLA-METHOD-EVALUATE-ARGUMENTS?)
    (CL:IF SETVALUE?
     (SET-DYNAMIC-SLOT-VALUE (%DYNAMIC-SLOTS SELF)
      ...
      FALSE-WRAPPER)
     (CL:SETQ VALUE
      (CL:IF (METHOD-EVALUATE-ARGUMENTS? SELF) TRUE-WRAPPER FALSE-WRAPPER))))
   (CL:T
    (CL:COND
...
(CL:DEFUN NEW-PARAMETRIC-TYPE-SPECIFIER ()
  (CL:LET* ((SELF NULL))
   (CL:SETQ SELF (CL:MAKE-INSTANCE (CL:QUOTE PARAMETRIC-TYPE-SPECIFIER)))
...
(CL:DEFUN NEW-GLOBAL-VARIABLE ()
  (CL:LET* ((SELF NULL))
   ...
   (CL:SETF (%VARIABLE-AUXILIARY? SELF) FALSE)
   (CL:SETF (%VARIABLE-PUBLIC? SELF) TRUE)
   (CL:SETF (%VARIABLE-CONSTANT? SELF) FALSE)
   (CL:SETF (%VARIABLE-SPECIAL? SELF) FALSE) (CL:SETF (%VARIABLE-TYPE SELF) NULL)
...
(CL:DEFUN ACCESS-GLOBAL-VARIABLE-SLOT-VALUE (SELF SLOTNAME VALUE SETVALUE?)
  (CL:COND
   ...
   ((CL:EQ SLOTNAME SYM-HIERARCHY-STELLA-VARIABLE-PUBLIC?)
    (CL:IF SETVALUE?
     (CL:SETF (%VARIABLE-PUBLIC? SELF) (COERCE-WRAPPED-BOOLEAN-TO-BOOLEAN VALUE))
     (CL:SETQ VALUE
   ...
   ((CL:EQ SLOTNAME SYM-HIERARCHY-STELLA-VARIABLE-STRINGIFIED-SOURCE)
    (CL:IF SETVALUE?
     (CL:SETF (%VARIABLE-STRINGIFIED-SOURCE SELF) (%WRAPPER-VALUE VALUE))
...
(CL:DEFCLASS QUOTED-EXPRESSION (STANDARD-OBJECT)
  ((QUOTATION-TABLE-OFFSET :TYPE CL:FIXNUM :INITFORM NULL-INTEGER :ALLOCATION
    :INSTANCE :ACCESSOR %QUOTATION-TABLE-OFFSET)))
...
(CL:DEFCLASS CONTEXT (THING)
  ((CHILD-CONTEXTS :ALLOCATION :INSTANCE :ACCESSOR %CHILD-CONTEXTS)
   ...
   (CONTEXT-NUMBER :TYPE CL:FIXNUM :INITFORM NULL-INTEGER :ALLOCATION :INSTANCE
    :ACCESSOR %CONTEXT-NUMBER)))
     ...
     ((SUBTYPE-OF? TEST-VALUE-000 SGT-HIERARCHY-STELLA-WORLD)
      (CL:PROGN
       (CL:RETURN-FROM CONTEXT-NAME
        (%WRAPPER-VALUE
         (DYNAMIC-SLOT-VALUE (%DYNAMIC-SLOTS AUX) SYM-HIERARCHY-STELLA-WORLD-NAME
          NULL-STRING-WRAPPER)))))
     (CL:T
      (CL:LET* ((STREAM-000 (NEW-OUTPUT-STRING-STREAM)))
...
(CL:DEFCLASS MODULE (CONTEXT)
  ((PARENT-MODULES :ALLOCATION :INSTANCE :ACCESSOR %PARENT-MODULES)
   ...
   (MODULE-FULL-NAME :TYPE CL:SIMPLE-STRING :INITFORM STELLA::NULL-STRING
    :ALLOCATION :INSTANCE :ACCESSOR %MODULE-FULL-NAME)
   (MODULE-NAME :TYPE CL:SIMPLE-STRING :INITFORM STELLA::NULL-STRING :ALLOCATION
    :INSTANCE :ACCESSOR %MODULE-NAME)
   (MODULE-STRINGIFIED-SOURCE :TYPE CL:SIMPLE-STRING :INITFORM
    STELLA::NULL-STRING :ALLOCATION :INSTANCE :ACCESSOR
    %MODULE-STRINGIFIED-SOURCE)
   (STRINGIFIED-OPTIONS :TYPE CL:SIMPLE-STRING :INITFORM STELLA::NULL-STRING
    :ALLOCATION :INSTANCE :ACCESSOR %STRINGIFIED-OPTIONS)
...
(CL:DEFUN NEW-MODULE ()
  (CL:LET* ((SELF NULL)) (CL:SETQ SELF (CL:MAKE-INSTANCE (CL:QUOTE MODULE)))
   ...
   (CL:SETF (%ALL-SUPER-CONTEXTS SELF) NULL) (CL:SETF (%BASE-MODULE SELF) NULL)
   ...
   (CL:SETF (%CASE-SENSITIVE? SELF) FALSE) (CL:SETF (%REQUIRES SELF) NULL)
   (CL:SETF (%USED-BY SELF) (NEW-LIST)) (CL:SETF (%USES SELF) (NEW-LIST))
   (CL:SETF (%NICKNAMES SELF) NULL)
   (CL:SETF (%DOCUMENTATION SELF) STELLA::NULL-STRING)
...
(CL:DEFMETHOD JAVA-PACKAGE ((SELF MODULE))
  (CL:LET*
   ((ANSWER
     (%WRAPPER-VALUE
      (DYNAMIC-SLOT-VALUE (%DYNAMIC-SLOTS SELF) SYM-HIERARCHY-STELLA-JAVA-PACKAGE
       NULL-STRING-WRAPPER))))
   (CL:DECLARE (CL:TYPE CL:SIMPLE-STRING ANSWER))
   (CL:IF (CL:EQ ANSWER STELLA::NULL-STRING)
...
(CL:DEFMETHOD CLEARABLE? ((SELF MODULE))
  (CL:RETURN-FROM CLEARABLE?
   (%WRAPPER-VALUE
    (DYNAMIC-SLOT-VALUE (%DYNAMIC-SLOTS SELF) SYM-HIERARCHY-STELLA-CLEARABLE?
     TRUE-WRAPPER))))
...
(CL:DEFUN ACCESS-MODULE-SLOT-VALUE (SELF SLOTNAME VALUE SETVALUE?)
  (CL:COND
   ...
   ((CL:EQ SLOTNAME SYM-HIERARCHY-STELLA-JAVA-PACKAGE)
    (CL:IF SETVALUE?
     (SET-DYNAMIC-SLOT-VALUE (%DYNAMIC-SLOTS SELF)
      SYM-HIERARCHY-STELLA-JAVA-PACKAGE (WRAP-STRING (%WRAPPER-VALUE VALUE))
      NULL-STRING-WRAPPER)
     (CL:SETQ VALUE (WRAP-STRING (JAVA-PACKAGE SELF)))))
   ((CL:EQ SLOTNAME SYM-HIERARCHY-STELLA-CASE-SENSITIVE?)
    (CL:IF SETVALUE?
     (CL:SETF (%CASE-SENSITIVE? SELF) (COERCE-WRAPPED-BOOLEAN-TO-BOOLEAN VALUE))
...
(CL:DEFUN NEW-WORLD ()
  (CL:LET* ((SELF NULL)) (CL:SETQ SELF (CL:MAKE-INSTANCE (CL:QUOTE WORLD)))
   ...
   (CL:SETF (%ALL-SUPER-CONTEXTS SELF) NULL) (CL:SETF (%BASE-MODULE SELF) NULL)
   (CL:SETF (%CHILD-CONTEXTS SELF) (NEW-LIST))
   (CL:SETF (%PARENT-CONTEXT SELF) NULL) (CL:RETURN-FROM NEW-WORLD SELF)))
...
(CL:DEFUN NEW-CS-VALUE ()
  (CL:LET* ((SELF NULL)) (CL:SETQ SELF (CL:MAKE-INSTANCE (CL:QUOTE CS-VALUE)))
   (CL:SETF (%THE-KV-LIST SELF) NULL) (CL:RETURN-FROM NEW-CS-VALUE SELF)))
...
(CL:DEFUN NEW-INTERVAL ()
  (CL:LET* ((SELF NULL)) (CL:SETQ SELF (CL:MAKE-INSTANCE (CL:QUOTE INTERVAL)))
   ...
   (CL:SETF (%LOWER-BOUND SELF) NULL-INTEGER) (CL:RETURN-FROM NEW-INTERVAL SELF)))
...
(CL:DEFCLASS TAXONOMY-NODE (STANDARD-OBJECT)
  ((NATIVE-OBJECT :ALLOCATION :INSTANCE :ACCESSOR %NATIVE-OBJECT)
   (LABEL :TYPE CL:FIXNUM :INITFORM NULL-INTEGER :ALLOCATION :INSTANCE :ACCESSOR
    %LABEL)
   (INTERVALS :ALLOCATION :INSTANCE :ACCESSOR %INTERVALS)
   (INITIAL-INTERVAL :ALLOCATION :INSTANCE :ACCESSOR %INITIAL-INTERVAL)
   (FIRST-INTERVAL-LOWER-BOUND :TYPE CL:FIXNUM :INITFORM NULL-INTEGER :ALLOCATION
    :INSTANCE :ACCESSOR %FIRST-INTERVAL-LOWER-BOUND)
   (FIRST-INTERVAL-UPPER-BOUND :TYPE CL:FIXNUM :INITFORM NULL-INTEGER :ALLOCATION
    :INSTANCE :ACCESSOR %FIRST-INTERVAL-UPPER-BOUND)
   (PARENTS :ALLOCATION :INSTANCE :ACCESSOR %PARENTS)
   (CHILDREN :ALLOCATION :INSTANCE :ACCESSOR %CHILDREN)
   (TOTAL-ANCESTORS :TYPE CL:FIXNUM :INITFORM NULL-INTEGER :ALLOCATION :INSTANCE
    :ACCESSOR %TOTAL-ANCESTORS)
...
(CL:DEFUN NEW-TAXONOMY-NODE ()
  (CL:LET* ((SELF NULL))
   ...
   (CL:SETF (%INITIAL-INTERVAL SELF) NULL) (CL:SETF (%INTERVALS SELF) NIL)
   (CL:SETF (%LABEL SELF) NULL-INTEGER) (CL:SETF (%NATIVE-OBJECT SELF) NULL)
...
the whole graph non-incrementally." :ALLOCATION :INSTANCE :ACCESSOR
   ...
   (LARGEST-POSTORDER-NUMBER :TYPE CL:FIXNUM :INITFORM NULL-INTEGER :ALLOCATION
    :INSTANCE :ACCESSOR %LARGEST-POSTORDER-NUMBER)
   (NUMBER-OF-NODES :TYPE CL:FIXNUM :INITFORM NULL-INTEGER :ALLOCATION :INSTANCE
    :ACCESSOR %NUMBER-OF-NODES)
   (NUMBER-OF-FOREIGN-INTERVAL-NODES :TYPE CL:FIXNUM :INITFORM NULL-INTEGER
    :ALLOCATION :INSTANCE :ACCESSOR %NUMBER-OF-FOREIGN-INTERVAL-NODES)
...
(CL:DEFUN NEW-TAXONOMY-GRAPH ()
  (CL:LET* ((SELF NULL))
   ...
   (CL:SETF (%REMOVED-LINKS SELF) NULL) (CL:SETF (%ADDED-LINKS SELF) NULL)
   ...
   (CL:SETF (%INCREMENTAL-MODE? SELF) FALSE)
   (CL:SETF (%RENUMBER-RATIO SELF) 0.1d0)
   (CL:SETF (%RENUMBER-IF-OUT-OF-NUMBERS? SELF) FALSE)
   (INITIALIZE-TAXONOMY-GRAPH SELF) (CL:RETURN-FROM NEW-TAXONOMY-GRAPH SELF)))
...
(CL:DEFUN ACCESS-TAXONOMY-GRAPH-SLOT-VALUE (SELF SLOTNAME VALUE SETVALUE?)
  (CL:COND
   ((CL:EQ SLOTNAME SYM-HIERARCHY-STELLA-RENUMBER-IF-OUT-OF-NUMBERS?)
    (CL:IF SETVALUE?
     (CL:SETF (%RENUMBER-IF-OUT-OF-NUMBERS? SELF)
      (COERCE-WRAPPED-BOOLEAN-TO-BOOLEAN VALUE))
     (CL:SETQ VALUE
      (CL:IF (%RENUMBER-IF-OUT-OF-NUMBERS? SELF) TRUE-WRAPPER FALSE-WRAPPER))))
   ...
   ((CL:EQ SLOTNAME SYM-HIERARCHY-STELLA-NUMBER-OF-FOREIGN-INTERVAL-NODES)
    (CL:IF SETVALUE?
     (CL:SETF (%NUMBER-OF-FOREIGN-INTERVAL-NODES SELF) (%WRAPPER-VALUE VALUE))
...
(CL:DEFUN NEW-STELLA-EXCEPTION (MESSAGE)
  ...
  (CL:LET* ((SELF NULL))
   (CL:SETQ SELF
    (CL:MAKE-CONDITION (CL:QUOTE STELLA-EXCEPTION) *CONDITION-MESSAGE-KEYWORD*
     MESSAGE))
...
(CL:DEFUN NEW-READ-EXCEPTION (MESSAGE)
  ...
  (CL:LET* ((SELF NULL))
   (CL:SETQ SELF
    (CL:MAKE-CONDITION (CL:QUOTE READ-EXCEPTION) *CONDITION-MESSAGE-KEYWORD*
     MESSAGE))
...
(CL:DEFCLASS INTEGER-WRAPPER (NUMBER-WRAPPER)
  ((WRAPPER-VALUE :TYPE CL:FIXNUM :INITFORM NULL-INTEGER :ALLOCATION :INSTANCE
...
(CL:DEFMETHOD PRINT-OBJECT ((SELF INTEGER-WRAPPER) STREAM)
  (CL:IF *PRINTREADABLY?* (%%PRINT-STREAM STREAM (%WRAPPER-VALUE SELF))
   (%%PRINT-STREAM STREAM "|L|" (%WRAPPER-VALUE SELF)))
  :VOID)

;;; (DEFCLASS FLOAT-WRAPPER ...)

(CL:DEFCLASS FLOAT-WRAPPER (NUMBER-WRAPPER)
  ((WRAPPER-VALUE :TYPE CL:DOUBLE-FLOAT :INITFORM NULL-FLOAT :ALLOCATION
...
(CL:DEFMETHOD PRINT-OBJECT ((SELF CHARACTER-WRAPPER) STREAM)
  (CL:IF *PRINTREADABLY?* (PRINT-CHARACTER (%WRAPPER-VALUE SELF) STREAM)
   (CL:PROGN (%%PRINT-STREAM STREAM "|L|")
...
(CL:DEFUN ACCESS-BOOLEAN-WRAPPER-SLOT-VALUE (SELF SLOTNAME VALUE SETVALUE?)
  (CL:COND
   ((CL:EQ SLOTNAME SYM-HIERARCHY-STELLA-WRAPPER-VALUE)
    (CL:IF SETVALUE?
     (CL:SETF (%WRAPPER-VALUE SELF) (COERCE-WRAPPED-BOOLEAN-TO-BOOLEAN VALUE))
...
(CL:DEFMETHOD PRINT-OBJECT ((SELF BOOLEAN-WRAPPER) STREAM)
  (%%PRINT-STREAM STREAM (CL:IF *PRINTREADABLY?* "" "|L|")
   (CL:IF (%WRAPPER-VALUE SELF) SYM-HIERARCHY-STELLA-TRUE
    SYM-HIERARCHY-STELLA-FALSE))
  :VOID)
...
(CL:DEFCLASS SYSTEM-DEFINITION (STANDARD-OBJECT)
  ((NAME :TYPE CL:SIMPLE-STRING :INITFORM STELLA::NULL-STRING :ALLOCATION
   ...
   (CARDINAL-MODULE :TYPE CL:SIMPLE-STRING :INITFORM STELLA::NULL-STRING
    :ALLOCATION :INSTANCE :ACCESSOR %CARDINAL-MODULE)
   ...
   (BANNER :TYPE CL:SIMPLE-STRING :INITFORM STELLA::NULL-STRING :ALLOCATION
    :INSTANCE :ACCESSOR %BANNER)
...
(CL:DEFUN NEW-SYSTEM-DEFINITION ()
  (CL:LET* ((SELF NULL))
   ...
   (CL:SETF (%UP-TO-DATE? SELF) FALSE) (CL:SETF (%LOADED? SELF) FALSE)
   (CL:SETF (%REQUIRED-SYSTEMS SELF) NULL)
   (CL:SETF (%PREPROCESSED-FILES SELF) NULL)
   (CL:SETF (%JAVA-ONLY-FILES SELF) NULL) (CL:SETF (%CPP-ONLY-FILES SELF) NULL)
...
(CL:DEFUN ACCESS-SYSTEM-DEFINITION-SLOT-VALUE (SELF SLOTNAME VALUE SETVALUE?)
  (CL:COND
   ...
   ((CL:EQ SLOTNAME SYM-HIERARCHY-STELLA-LOADED?)
    (CL:IF SETVALUE?
     (CL:SETF (%LOADED? SELF) (COERCE-WRAPPED-BOOLEAN-TO-BOOLEAN VALUE))
     (CL:SETQ VALUE (CL:IF (%LOADED? SELF) TRUE-WRAPPER FALSE-WRAPPER))))
   ((CL:EQ SLOTNAME SYM-HIERARCHY-STELLA-UP-TO-DATE?)
    (CL:IF SETVALUE?
     (CL:SETF (%UP-TO-DATE? SELF) (COERCE-WRAPPED-BOOLEAN-TO-BOOLEAN VALUE))
...
(CL:DEFUN NEW-INPUT-STREAM ()
  (CL:LET* ((SELF NULL))
   ...
   (CL:SETF (%TOKENIZER-STATE SELF) NULL) (CL:SETF (%ECHO-STREAM SELF) NULL)
   (CL:SETF (%NATIVE-STREAM SELF) NULL) (CL:RETURN-FROM NEW-INPUT-STREAM SELF)))
...
(CL:DEFCLASS OUTPUT-FILE-STREAM (OUTPUT-STREAM)
  ((FILENAME :TYPE CL:SIMPLE-STRING :INITFORM STELLA::NULL-STRING :ALLOCATION
    :INSTANCE :ACCESSOR %FILENAME)
...
(CL:DEFUN HELP-STARTUP-HIERARCHY2 ()
  (CL:PROGN
   ...
   (CL:SETQ SYM-HIERARCHY-STELLA-RESIZE-INCREMENT
   ...
   (CL:SETQ SYM-HIERARCHY-STELLA-VSEQ
    (INTERN-RIGID-SYMBOL-WRT-MODULE "VSEQ" NULL 0))
   (CL:SETQ SGT-HIERARCHY-STELLA-SHORT-VECTOR-SEQUENCE
    (INTERN-RIGID-SYMBOL-WRT-MODULE "SHORT-VECTOR-SEQUENCE" NULL 1))
   (CL:SETQ SYM-HIERARCHY-STELLA-SVSEQ
   ...
   (CL:LET*
    ((CLASS
      (DEFINE-CLASS-FROM-STRINGIFIED-SOURCE "VECTOR-SEQUENCE"
       "(DEFCLASS VECTOR-SEQUENCE (VECTOR) :ABSTRACT? TRUE :PUBLIC-SLOTS ((RESIZE-INCREMENT :TYPE INTEGER :HARDWIRED? TRUE :INITIALLY 100) (SEQUENCE-LENGTH :TYPE INTEGER)) :INITIALIZER INITIALIZE-VECTOR :SYNONYMS (VSEQ))")))
    (CL:SETQ *HARDWIRED-RESIZE-INCREMENT-ON-VECTOR-SEQUENCE* 100)
    (CL:SETF (%CLASS-SLOT-ACCESSOR-CODE CLASS)
     (CL:FUNCTION ACCESS-VECTOR-SEQUENCE-SLOT-VALUE)))
   (CL:LET*
    ((CLASS
      (DEFINE-CLASS-FROM-STRINGIFIED-SOURCE "SHORT-VECTOR-SEQUENCE"
       "(DEFCLASS SHORT-VECTOR-SEQUENCE (VECTOR-SEQUENCE) :PUBLIC-SLOTS ((RESIZE-INCREMENT :TYPE INTEGER :HARDWIRED? TRUE :INITIALLY 4) (SEQUENCE-LENGTH :TYPE INTEGER :INITIALLY 0)) :INITIALIZER INITIALIZE-VECTOR :SYNONYMS (SVSEQ))")))
    (CL:SETQ *HARDWIRED-RESIZE-INCREMENT-ON-VECTOR-SEQUENCE* 100)
...
the whole graph non-incrementally.\" :TYPE FLOAT :INITIALLY 0.1)) :SLOTS ((INCREMENTAL-MODE? :TYPE BOOLEAN) (LARGEST-POSTORDER-NUMBER :TYPE INTEGER) (NUMBER-OF-NODES :TYPE INTEGER) (NUMBER-OF-FOREIGN-INTERVAL-NODES :TYPE INTEGER) (ROOTS :TYPE (LIST OF TAXONOMY-NODE)) (BROKEN-LINKS :TYPE (LIST OF (CONS OF TAXONOMY-NODE))) (ADDED-LINKS :TYPE (LIST OF (CONS OF TAXONOMY-NODE))) (REMOVED-LINKS :TYPE (LIST OF (CONS OF TAXONOMY-NODE)))) :INITIALIZER INITIALIZE-TAXONOMY-GRAPH :PRINT-FORM (PRINT-NATIVE-STREAM STREAM \"|TG|\" (ROOTS SELF)))")))
   ...
   (DEFINE-CLASS-FROM-STRINGIFIED-SOURCE "SHORT-INTEGER"
    "(DEFCLASS SHORT-INTEGER (INTEGER) :CL-NATIVE-TYPE \"INTEGER\" :CPP-NATIVE-TYPE \"short int\" :IDL-NATIVE-TYPE \"short int\" :JAVA-NATIVE-TYPE \"short\" :INITIAL-VALUE NULL-SHORT-INTEGER :EQUALITY-TEST EQL?)")
   (DEFINE-CLASS-FROM-STRINGIFIED-SOURCE "LONG-INTEGER"
    "(DEFCLASS LONG-INTEGER (INTEGER) :CL-NATIVE-TYPE \"INTEGER\" :CPP-NATIVE-TYPE \"long int\" :IDL-NATIVE-TYPE \"long int\" :JAVA-NATIVE-TYPE \"long\" :INITIAL-VALUE NULL-LONG-INTEGER :EQUALITY-TEST EQL?)")
   (DEFINE-CLASS-FROM-STRINGIFIED-SOURCE "UNSIGNED-SHORT-INTEGER"
    "(DEFCLASS UNSIGNED-SHORT-INTEGER (INTEGER) :CL-NATIVE-TYPE \"INTEGER\" :CPP-NATIVE-TYPE \"unsigned short int\" :IDL-NATIVE-TYPE \"unsigned short int\" :JAVA-NATIVE-TYPE \"short\" :INITIAL-VALUE NULL-UNSIGNED-SHORT-INTEGER :EQUALITY-TEST EQL?)")
   (DEFINE-CLASS-FROM-STRINGIFIED-SOURCE "UNSIGNED-LONG-INTEGER"
    "(DEFCLASS UNSIGNED-LONG-INTEGER (INTEGER) :CL-NATIVE-TYPE \"INTEGER\" :IDL-NATIVE-TYPE \"unsigned long int\" :CPP-NATIVE-TYPE \"unsigned long int\" :JAVA-NATIVE-TYPE \"long\" :INITIAL-VALUE NULL-UNSIGNED-LONG-INTEGER :EQUALITY-TEST EQL?)")
   ...
   (CL:LET*
    ((CLASS
      (DEFINE-CLASS-FROM-STRINGIFIED-SOURCE "INTEGER-WRAPPER"
       "(DEFCLASS INTEGER-WRAPPER (NUMBER-WRAPPER) :PUBLIC-SLOTS ((WRAPPER-VALUE :TYPE INTEGER)) :PRINT-FORM (IF *PRINTREADABLY?* (PRINT-NATIVE-STREAM STREAM (WRAPPER-VALUE SELF)) (PRINT-NATIVE-STREAM STREAM \"|L|\" (WRAPPER-VALUE SELF))))")))
   ...
   (CL:LET*
    ((CLASS
      (DEFINE-CLASS-FROM-STRINGIFIED-SOURCE "FLOAT-WRAPPER"
       "(DEFCLASS FLOAT-WRAPPER (NUMBER-WRAPPER) :PUBLIC-SLOTS ((WRAPPER-VALUE :TYPE FLOAT)) :PRINT-FORM (IF *PRINTREADABLY?* (PRINT-NATIVE-STREAM STREAM (WRAPPER-VALUE SELF)) (PRINT-NATIVE-STREAM STREAM \"|L|\" (WRAPPER-VALUE SELF))))")))
   ...
   (CL:LET*
    ((CLASS
      (DEFINE-CLASS-FROM-STRINGIFIED-SOURCE "STRING-WRAPPER"
       "(DEFCLASS STRING-WRAPPER (LITERAL-WRAPPER) :PUBLIC-SLOTS ((WRAPPER-VALUE :TYPE STRING)) :PRINT-FORM (LET ((VALUE (WRAPPER-VALUE SELF))) (IF *PRINTREADABLY?* (PRINT-STRING-READABLY VALUE STREAM) (IF (DEFINED? VALUE) (PRINT-NATIVE-STREAM STREAM \"|L|\" #\\\" VALUE #\\\") (PRINT-NATIVE-STREAM STREAM \"|L|\" \"NULL-STRING\")))))")))
   ...
   (CL:LET*
    ((CLASS
      (DEFINE-CLASS-FROM-STRINGIFIED-SOURCE "CHARACTER-WRAPPER"
       "(DEFCLASS CHARACTER-WRAPPER (LITERAL-WRAPPER) :PUBLIC-SLOTS ((WRAPPER-VALUE :TYPE CHARACTER)) :PRINT-FORM (IF *PRINTREADABLY?* (PRINT-CHARACTER (WRAPPER-VALUE SELF) STREAM) (PROGN (PRINT-NATIVE-STREAM STREAM \"|L|\") (PRINT-CHARACTER (WRAPPER-VALUE SELF) STREAM))))")))
...
(CL:DEFUN STARTUP-HIERARCHY ()
  (CL:LET* ((*MODULE* *STELLA-MODULE*) (*CONTEXT* *MODULE*))
   ...
   (CL:WHEN (CURRENT-STARTUP-TIME-PHASE? 2) (HELP-STARTUP-HIERARCHY1)
    (HELP-STARTUP-HIERARCHY2) (HELP-STARTUP-HIERARCHY3) (HELP-STARTUP-HIERARCHY4)
...
for tokenization.\")) :TERMINATOR TERMINATE-INPUT-STREAM?)")))
    ...
    (CL:LET*
     ((CLASS
       (DEFINE-CLASS-FROM-STRINGIFIED-SOURCE "OUTPUT-STRING-STREAM"
        "(DEFCLASS OUTPUT-STRING-STREAM (OUTPUT-STREAM) :SYNONYMS (STRING-OUTPUT-STREAM) :PUBLIC-SLOTS ((THE-STRING :TYPE STRING :PUBLIC? TRUE :READER THE-STRING-READER)) :INITIALIZER INITIALIZE-STRING-OUTPUT-STREAM)")))
     (CL:SETF (%CLASS-CONSTRUCTOR-CODE CLASS)
    ...
    (CL:LET*
     ((CLASS
       (DEFINE-CLASS-FROM-STRINGIFIED-SOURCE "INPUT-STRING-STREAM"
        "(DEFCLASS INPUT-STRING-STREAM (INPUT-STREAM) :SYNONYMS (STRING-INPUT-STREAM) :PUBLIC-SLOTS ((THE-STRING :TYPE STRING :REQUIRED? TRUE :PUBLIC? TRUE) (BUFFERING-SCHEME :INITIALLY :BLOCK)) :INITIALIZER INITIALIZE-STRING-INPUT-STREAM)")))
     (CL:SETF (%CLASS-CONSTRUCTOR-CODE CLASS)
   ...
   (CL:WHEN (CURRENT-STARTUP-TIME-PHASE? 7)
    (DEFINE-FUNCTION-OBJECT "STARTUP-HIERARCHY"
     "(DEFUN STARTUP-HIERARCHY () :PUBLIC? TRUE)" (CL:FUNCTION STARTUP-HIERARCHY)
     NULL)
    (CL:LET*
     ((FUNCTION (LOOKUP-FUNCTION SYM-HIERARCHY-STELLA-STARTUP-HIERARCHY)))
     (SET-DYNAMIC-SLOT-VALUE (%DYNAMIC-SLOTS FUNCTION)
      SYM-HIERARCHY-STELLA-METHOD-STARTUP-CLASSNAME
      (WRAP-STRING "_Startup-Hierarchy") NULL-STRING-WRAPPER)))
