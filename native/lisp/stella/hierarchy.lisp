...
(CL:DEFVAR SYM-HIERARCHY-STELLA-HOME-CONTEXT NULL)
...
(CL:DEFVAR SGT-HIERARCHY-STELLA-SET-ITERATOR NULL)
(CL:DEFVAR SYM-HIERARCHY-STELLA-SET-ITERATOR-CURSOR NULL)
(CL:DEFVAR SYM-HIERARCHY-STELLA-SET-ITERATOR-COLLECTION NULL)
...
(CL:PROGN (CL:DEFVAR *HARDWIRED-RESIZE-INCREMENT-ON-VECTOR-SEQUENCE* NULL-INTEGER) (CL:DECLAIM (CL:TYPE CL:FIXNUM *HARDWIRED-RESIZE-INCREMENT-ON-VECTOR-SEQUENCE*)))
...
(CL:PROGN (CL:DEFVAR *HARDWIRED-RESIZE-INCREMENT-ON-SHORT-VECTOR-SEQUENCE* NULL-INTEGER) (CL:DECLAIM (CL:TYPE CL:FIXNUM *HARDWIRED-RESIZE-INCREMENT-ON-SHORT-VECTOR-SEQUENCE*)))
...
(CL:PROGN (CL:DEFVAR *HARDWIRED-CLASS-ARITY-ON-CLASS* NULL-INTEGER) (CL:DECLAIM (CL:TYPE CL:FIXNUM *HARDWIRED-CLASS-ARITY-ON-CLASS*)))
...
(CL:DECLAIM
 (CL:SPECIAL *STELLA-MODULE* *MODULE* *PRINTREADABLY?*
  *HARDWIRED-CLASS-ARITY-ON-CLASS* NULL-STRING-WRAPPER NIL-LIST
  *HARDWIRED-TRANSIENT?-ON-TRANSIENT-MIXIN* *CONTEXT*
  *HARDWIRED-RESIZE-INCREMENT-ON-SHORT-VECTOR-SEQUENCE*
  *HARDWIRED-RESIZE-INCREMENT-ON-VECTOR-SEQUENCE* NULL-CHARACTER
...
(CL:DEFCLASS REFERENCE-COUNT-OBJECT (OBJECT)
  ((REFERENCE-COUNT :ALLOCATION :INSTANCE :ACCESSOR %REFERENCE-COUNT))
  (:DOCUMENTATION
...
(CL:DEFMETHOD HOME-MODULE ((SELF CONTEXT-SENSITIVE-OBJECT))
  (CL:RETURN-FROM HOME-MODULE (%BASE-MODULE (%HOME-CONTEXT SELF))))

(CL:DEFUN ACCESS-CONTEXT-SENSITIVE-OBJECT-SLOT-VALUE (SELF SLOTNAME VALUE SETVALUE?)
  (CL:COND
   ((CL:EQ SLOTNAME SYM-HIERARCHY-STELLA-HOME-CONTEXT)
...
(CL:DEFMETHOD BAD? ((SELF ACTIVE-OBJECT))
  (CL:LET*
   ((ANSWER
     (DYNAMIC-SLOT-VALUE (%DYNAMIC-SLOTS SELF) SYM-HIERARCHY-STELLA-BAD?
      NULL)))
...
(CL:DEFCLASS SET-ITERATOR (ITERATOR)
  ((SET-ITERATOR-CURSOR :ALLOCATION :INSTANCE :ACCESSOR
    %SET-ITERATOR-CURSOR)
   (SET-ITERATOR-COLLECTION :ALLOCATION :INSTANCE :ACCESSOR
...
(CL:DEFUN NEW-SET-ITERATOR ()
  (CL:LET* ((SELF NULL))
   ...
   (CL:SETF (%SET-ITERATOR-CURSOR SELF) NULL)
   (CL:RETURN-FROM NEW-SET-ITERATOR SELF)))

(CL:DEFMETHOD FREE ((SELF SET-ITERATOR))
  (CL:WHEN (TERMINATE-SET-ITERATOR? SELF) (UNMAKE SELF))
  :VOID)

(CL:DEFMETHOD PRIMARY-TYPE ((SELF SET-ITERATOR))
  (CL:RETURN-FROM PRIMARY-TYPE SGT-HIERARCHY-STELLA-SET-ITERATOR))

(CL:DEFUN ACCESS-SET-ITERATOR-SLOT-VALUE (SELF SLOTNAME VALUE SETVALUE?)
  (CL:COND
   ((CL:EQ SLOTNAME SYM-HIERARCHY-STELLA-SET-ITERATOR-CURSOR)
    (CL:IF SETVALUE? (CL:SETF (%SET-ITERATOR-CURSOR SELF) VALUE)
     (CL:SETQ VALUE (%SET-ITERATOR-CURSOR SELF))))
   ((CL:EQ SLOTNAME SYM-HIERARCHY-STELLA-SET-ITERATOR-COLLECTION)
    (CL:IF SETVALUE? (CL:SETF (%SET-ITERATOR-COLLECTION SELF) VALUE)
     (CL:SETQ VALUE (%SET-ITERATOR-COLLECTION SELF))))
   (CL:T
    (CL:LET* ((STREAM-000 (NEW-OUTPUT-STRING-STREAM)))
     (%%PRINT-STREAM (%NATIVE-STREAM STREAM-000) "`" SLOTNAME
      "' is not a valid case option")
...
(CL:DEFCLASS ALL-PURPOSE-ITERATOR (ITERATOR)
  ((KEY :ALLOCATION :INSTANCE :ACCESSOR %KEY)
   ...
   (ITERATOR-INTEGER :ALLOCATION :INSTANCE :ACCESSOR %ITERATOR-INTEGER)
   (ITERATOR-SECOND-INTEGER :ALLOCATION :INSTANCE :ACCESSOR
...
(CL:DEFCLASS INTEGER-INTERVAL-ITERATOR (INTERVAL-ITERATOR)
  ((INTERVAL-CURSOR :ALLOCATION :INSTANCE :ACCESSOR %INTERVAL-CURSOR)
...
(CL:DEFUN NEW-INTEGER-INTERVAL-ITERATOR (LOWER-BOUND UPPER-BOUND)
  ...
  (CL:LET* ((SELF NULL))
   ...
   (CL:SETF (%FIRST-ITERATION? SELF) TRUE)
...
(CL:DEFCLASS STRING-ITERATOR (ABSTRACT-ITERATOR)
  ((THE-STRING :ALLOCATION :INSTANCE :ACCESSOR %THE-STRING)
   ...
   (CL:T
    (CL:LET* ((STREAM-000 (NEW-OUTPUT-STRING-STREAM)))
     (%%PRINT-STREAM (%NATIVE-STREAM STREAM-000) "`" SLOTNAME
      "' is not a valid case option")
     (CL:ERROR (NEW-STELLA-EXCEPTION (THE-STRING-READER STREAM-000))))))
  (CL:RETURN-FROM ACCESS-SET-SLOT-VALUE VALUE))
...
(CL:DEFMETHOD PRINT-OBJECT ((SELF PROPERTY-LIST) STREAM)
  (PRINT-CONS-LIST (%THE-PLIST SELF) STREAM)
  :VOID)
...
(CL:DEFCLASS RECYCLE-LIST (SEQUENCE)
  ((RECYCLE-LIST-OF :ALLOCATION :INSTANCE :ACCESSOR %RECYCLE-LIST-OF)
   ...
   (CURRENT-LENGTH :ALLOCATION :INSTANCE :ACCESSOR %CURRENT-LENGTH)
   (ITEM-SIZE :ALLOCATION :INSTANCE :ACCESSOR %ITEM-SIZE)))

(CL:DEFUN NEW-RECYCLE-LIST ()
  (CL:LET* ((SELF NULL))
   (CL:SETQ SELF (CL:MAKE-INSTANCE (CL:QUOTE RECYCLE-LIST)))
   (CL:SETF (%ITEM-SIZE SELF) NULL-INTEGER)
   (CL:SETF (%CURRENT-LENGTH SELF) 0) (CL:SETF (%UNUSED-ITEMS SELF) NULL)
   (CL:SETF (%ALL-ITEMS SELF) NULL)
...
(CL:DEFCLASS VECTOR (SEQUENCE)
  ((ARRAY-SIZE :ALLOCATION :INSTANCE :ACCESSOR %ARRAY-SIZE)
...
(CL:DEFUN NEW-VECTOR (ARRAY-SIZE)
  ...
  (CL:LET* ((SELF NULL))
   ...
   (CL:SETF (%ARRAY-SIZE SELF) ARRAY-SIZE) (INITIALIZE-VECTOR SELF)
...
(CL:DEFCLASS EXTENSIBLE-SYMBOL-ARRAY (EXTENSIBLE-VECTOR)
  ((TOP-SYMBOL-OFFSET :ALLOCATION :INSTANCE :ACCESSOR %TOP-SYMBOL-OFFSET)
   (POTENTIAL-FREE-SYMBOL-OFFSET :ALLOCATION :INSTANCE :ACCESSOR
...
(CL:DEFUN NEW-EXTENSIBLE-SYMBOL-ARRAY (ARRAY-SIZE)
  ...
  (CL:LET* ((SELF NULL))
   ...
   (CL:SETF (%TOP-SYMBOL-OFFSET SELF) -1)
   (CL:SETF (%ARRAY-SIZE SELF) ARRAY-SIZE) (INITIALIZE-VECTOR SELF)
   (INITIALIZE-VECTOR SELF) (INITIALIZE-VECTOR SELF)
...
(CL:DEFUN NEW-ACTIVE-LIST ()
  (CL:LET* ((SELF NULL))
   ...
   (CL:SETF (%ACTIVE-SLOT SELF) NULL) (CL:SETF (%THE-CONS-LIST SELF) NIL)
...
(CL:DEFCLASS DEMON (STANDARD-OBJECT)
  ((DEMON-NAME :ALLOCATION :INSTANCE :ACCESSOR %DEMON-NAME)
   ...
   (DEMON-DOCUMENTATION :ALLOCATION :INSTANCE :ACCESSOR
    %DEMON-DOCUMENTATION)
...
(CL:DEFUN NEW-DEMON ()
  (CL:LET* ((SELF NULL))
   ...
   (CL:SETF (%DEMON-INHERIT? SELF) FALSE)
   (CL:SETF (%DEMON-ALL? SELF) FALSE) (CL:SETF (%DEMON-GUARD? SELF) FALSE)
...
(CL:DEFCLASS GENERALIZED-SYMBOL (CONTEXT-SENSITIVE-OBJECT)
  ((SYMBOL-NAME :ALLOCATION :INSTANCE :ACCESSOR %SYMBOL-NAME)
   (SYMBOL-ID :ALLOCATION :INSTANCE :ACCESSOR %SYMBOL-ID)))
...
(CL:DEFCLASS SYMBOL (GENERALIZED-SYMBOL)
  ((SYMBOL-SLOT-OFFSET :ALLOCATION :INSTANCE :ACCESSOR
    %SYMBOL-SLOT-OFFSET)
...
(CL:DEFCLASS CLASS (RELATION)
  ((CL-STRUCT? :ALLOCATION :INSTANCE :ACCESSOR %CL-STRUCT?)
   ...
   (CLASS-STRINGIFIED-SOURCE :ALLOCATION :INSTANCE :ACCESSOR
...
(CL:DEFUN NEW-CLASS ()
  (CL:LET* ((SELF NULL))
   ...
   (CL:SETF (%CLASS-FINALIZED? SELF) FALSE)
   (CL:SETF (%CLASS-PUBLIC? SELF) TRUE) (CL:SETF (%CL-STRUCT? SELF) FALSE)
   (CL:SETF (%CLASS-COLLECTION? SELF) FALSE)
...
(CL:DEFMETHOD HOME-MODULE ((SELF SLOT))
  (CL:IF (%SLOT-EXTERNAL? SELF)
   ...
   (CL:RETURN-FROM HOME-MODULE (%HOME-CONTEXT (%SLOT-OWNER SELF)))))
...
(CL:DEFMETHOD TYPE ((SELF SLOT))
  ...
  (CL:LET* ((CURSOR SELF) (VALUE (%SLOT-BASE-TYPE CURSOR)))
   (CL:LOOP
    ...
    (CL:SETQ CURSOR (%SLOT-DIRECT-EQUIVALENT CURSOR))
    (CL:IF (CL:NOT (CL:EQ CURSOR NULL))
     (CL:SETQ VALUE (%SLOT-BASE-TYPE CURSOR)) (CL:RETURN-FROM TYPE NULL)))))
...
(CL:DEFUN NEW-STORAGE-SLOT ()
  (CL:LET* ((SELF NULL))
   ...
   (CL:SETF (%SLOT-MARKED? SELF) FALSE)
   (CL:SETF (%SLOT-EXTERNAL? SELF) FALSE)
   (CL:SETF (%SLOT-RENAMED? SELF) FALSE)
   (CL:SETF (%SLOT-PUBLIC? SELF) TRUE) (CL:SETF (%SLOT-SLOTREF SELF) NULL)
   (CL:SETF (%SLOT-BASE-TYPE SELF) NULL) (CL:SETF (%SLOT-OWNER SELF) NULL)
   (CL:SETF (%SLOT-NAME SELF) NULL)
   (CL:SETF (%SLOT-CONTEXT-SENSITIVE? SELF) FALSE)
   (CL:SETF (%SLOT-HARDWIRED? SELF) FALSE)
   (CL:SETF (%SLOT-READ-ONLY? SELF) FALSE)
   (CL:SETF (%SLOT-COMPONENT? SELF) FALSE)
   (CL:SETF (%SLOT-REQUIRED? SELF) FALSE)
...
(CL:DEFCLASS METHOD-SLOT (SLOT)
  ((METHOD-SETTER? :ALLOCATION :INSTANCE :ACCESSOR %METHOD-SETTER?)
   ...
   (METHOD-STRINGIFIED-SOURCE :ALLOCATION :INSTANCE :ACCESSOR
...
(CL:DEFUN NEW-METHOD-SLOT ()
  (CL:LET* ((SELF NULL))
   ...
   (CL:SETF (%SLOT-BASE-TYPE SELF) NULL) (CL:SETF (%SLOT-OWNER SELF) NULL)
   (CL:SETF (%SLOT-NAME SELF) NULL)
   (CL:SETF (%METHOD-FUNCTION? SELF) FALSE)
   (CL:SETF (%FUNCTION-CODE SELF) NULL) (CL:SETF (%METHOD-CODE SELF) NULL)
   ...
   (CL:SETF (%METHOD-SETTER? SELF) FALSE)
...
(CL:DEFUN NEW-TABLE ()
  (CL:LET* ((SELF NULL))
   ...
   (CL:SETF (%SLOT-PUBLIC? SELF) TRUE) (CL:SETF (%SLOT-SLOTREF SELF) NULL)
   (CL:SETF (%SLOT-BASE-TYPE SELF) NULL) (CL:SETF (%SLOT-OWNER SELF) NULL)
   (CL:SETF (%SLOT-NAME SELF) NULL) (CL:SETF (%TUPLE-DOMAINS SELF) NULL)
...
(CL:DEFCLASS GLOBAL-VARIABLE (MAPPABLE-OBJECT)
  ((DOCUMENTATION :ALLOCATION :INSTANCE :ACCESSOR %DOCUMENTATION)
   ...
   (VARIABLE-STRINGIFIED-SOURCE :ALLOCATION :INSTANCE :ACCESSOR
...
(CL:DEFUN NEW-GLOBAL-VARIABLE ()
  (CL:LET* ((SELF NULL))
   ...
   (CL:SETF (%VARIABLE-SPECIAL? SELF) FALSE)
...
(CL:DEFCLASS QUOTED-EXPRESSION (STANDARD-OBJECT)
  ((QUOTATION-TABLE-OFFSET :ALLOCATION :INSTANCE :ACCESSOR
...
(CL:DEFCLASS CONTEXT (THING)
  ((CHILD-CONTEXTS :ALLOCATION :INSTANCE :ACCESSOR %CHILD-CONTEXTS)
   ...
   (ALL-SUPER-CONTEXTS :ALLOCATION :INSTANCE :ACCESSOR
    %ALL-SUPER-CONTEXTS)
   (CONTEXT-NUMBER :ALLOCATION :INSTANCE :ACCESSOR %CONTEXT-NUMBER)))
...
(CL:DEFCLASS MODULE (CONTEXT)
  ((PARENT-MODULES :ALLOCATION :INSTANCE :ACCESSOR %PARENT-MODULES)
   ...
   (MODULE-FULL-NAME :ALLOCATION :INSTANCE :ACCESSOR %MODULE-FULL-NAME)
   (MODULE-NAME :ALLOCATION :INSTANCE :ACCESSOR %MODULE-NAME)
   (MODULE-STRINGIFIED-SOURCE :ALLOCATION :INSTANCE :ACCESSOR
    %MODULE-STRINGIFIED-SOURCE)
   (STRINGIFIED-OPTIONS :ALLOCATION :INSTANCE :ACCESSOR
    %STRINGIFIED-OPTIONS)
...
the whole graph non-incrementally." :ALLOCATION :INSTANCE :ACCESSOR
   ...
   (LARGEST-POSTORDER-NUMBER :ALLOCATION :INSTANCE :ACCESSOR
    %LARGEST-POSTORDER-NUMBER)
   (NUMBER-OF-NODES :ALLOCATION :INSTANCE :ACCESSOR %NUMBER-OF-NODES)
   (NUMBER-OF-FOREIGN-INTERVAL-NODES :ALLOCATION :INSTANCE :ACCESSOR
...
(CL:DEFCLASS SYSTEM-DEFINITION (STANDARD-OBJECT)
  ((NAME :ALLOCATION :INSTANCE :ACCESSOR %NAME)
   ...
   (BANNER :ALLOCATION :INSTANCE :ACCESSOR %BANNER)
...
(CL:DEFUN NEW-INPUT-STREAM ()
  (CL:LET* ((SELF NULL))
   ...
   (CL:SETF (%STATE SELF) NULL) (CL:SETF (%TOKENIZER-STATE SELF) NULL)
...
(CL:DEFCLASS OUTPUT-FILE-STREAM (OUTPUT-STREAM)
  ((FILENAME :ALLOCATION :INSTANCE :ACCESSOR %FILENAME)
...
(CL:DEFUN NEW-OUTPUT-FILE-STREAM (FILENAME)
  ...
  (CL:LET* ((SELF NULL))
   ...
   (CL:SETF (%FILENAME SELF) FILENAME)
...
(CL:DEFUN NEW-INPUT-FILE-STREAM (FILENAME)
  ...
  (CL:LET* ((SELF NULL))
   ...
   (CL:SETF (%FILENAME SELF) FILENAME) (INITIALIZE-FILE-INPUT-STREAM SELF)
...
(CL:DEFUN NEW-INPUT-STRING-STREAM (THE-STRING)
  ...
  (CL:LET* ((SELF NULL))
   ...
   (CL:SETF (%STATE SELF) NULL) (CL:SETF (%TOKENIZER-STATE SELF) NULL)
   (CL:SETF (%ECHO-STREAM SELF) NULL) (CL:SETF (%NATIVE-STREAM SELF) NULL)
   (CL:SETF (%THE-STRING SELF) THE-STRING)
...
(CL:DEFUN HELP-STARTUP-HIERARCHY1 ()
  (CL:PROGN
   ...
   (CL:SETQ SYM-HIERARCHY-STELLA-HOME-CONTEXT
   ...
   (CL:SETQ SGT-HIERARCHY-STELLA-SET-ITERATOR
    (INTERN-RIGID-SYMBOL-WRT-MODULE "SET-ITERATOR" NULL 1))
   (CL:SETQ SYM-HIERARCHY-STELLA-SET-ITERATOR-CURSOR
    (INTERN-RIGID-SYMBOL-WRT-MODULE "SET-ITERATOR-CURSOR" NULL 0))
   (CL:SETQ SYM-HIERARCHY-STELLA-SET-ITERATOR-COLLECTION
...
(CL:DEFUN HELP-STARTUP-HIERARCHY4 ()
  (CL:PROGN
   ...
   (CL:SETQ SYM-HIERARCHY-STELLA-METHOD-RETURN-TYPE-SPECIFIERS
    (INTERN-RIGID-SYMBOL-WRT-MODULE "METHOD-RETURN-TYPE-SPECIFIERS" NULL
     0))
...
that enables context-dependent access machinery to determine the
visibility of objects from modules.\" :ABSTRACT? TRUE :PUBLIC-SLOTS ((HOME-CONTEXT :TYPE CONTEXT :INITIALLY *CONTEXT*)) :METHODS ((HOME-MODULE ((SELF CONTEXT-SENSITIVE-OBJECT)) :TYPE MODULE :PUBLIC? TRUE (RETURN (BASE-MODULE (HOME-CONTEXT SELF))))))")))
    (CL:SETF (%CLASS-SLOT-ACCESSOR-CODE CLASS)
...
slot 'home-context'.\" :MIXIN? TRUE :PUBLIC-SLOTS ((HOME-CONTEXT :TYPE CONTEXT :INITIALLY *MODULE*)) :PUBLIC-METHODS ((HOME-MODULE ((SELF CONTEXT-SENSITIVE-MIXIN)) :TYPE MODULE (RETURN (BASE-MODULE (HOME-CONTEXT SELF))))))")
   ...
   (CL:LET*
    ((CLASS
      (DEFINE-CLASS-FROM-STRINGIFIED-SOURCE "ABSTRACT-ITERATOR"
       "(DEFCLASS ABSTRACT-ITERATOR (STANDARD-OBJECT) :ABSTRACT? TRUE :DOCUMENTATION \"Instances of ABSTRACT-ITERATOR support iteration over collections.\" :PARAMETERS ((ANY-VALUE :TYPE UNKNOWN)) :PUBLIC-SLOTS ((VALUE :TYPE (LIKE (ANY-VALUE SELF))) (FIRST-ITERATION? :TYPE BOOLEAN :INITIALLY TRUE)) :PUBLIC-METHODS ((NEXT? ((SELF ABSTRACT-ITERATOR)) :TYPE BOOLEAN (RETURN NULL)) (LENGTH ((SELF ABSTRACT-ITERATOR)) :TYPE INTEGER)))")))
    (CL:SETF (%CLASS-SLOT-ACCESSOR-CODE CLASS)
...
the stored list, and destroys it when the iterator is free'd.\" :PARAMETERS ((ANY-VALUE :TYPE OBJECT)) :PUBLIC-SLOTS ((THE-CONS-LIST :TYPE CONS :INITIALLY NIL) (LIST-ITERATOR-CURSOR :TYPE CONS)) :TERMINATOR TERMINATE-DESTRUCTIVE-LIST-ITERATOR?)")))
   ...
   (CL:LET*
    ((CLASS
      (DEFINE-CLASS-FROM-STRINGIFIED-SOURCE "SET-ITERATOR"
       "(DEFCLASS SET-ITERATOR (ITERATOR) :DOCUMENTATION \"Iterator class for the collection SET.\" :PARAMETERS ((ANY-VALUE :TYPE OBJECT)) :PUBLIC-SLOTS ((SET-ITERATOR-CURSOR :TYPE CONS) (SET-ITERATOR-COLLECTION :TYPE SET)) :TERMINATOR TERMINATE-SET-ITERATOR?)")))
    (CL:SETF (%CLASS-CONSTRUCTOR-CODE CLASS)
...
the method 'insert'.\" :PARAMETERS ((ANY-VALUE :TYPE OBJECT)) :MIXIN? TRUE)")
   ...
   (CL:LET*
    ((CLASS
      (DEFINE-CLASS-FROM-STRINGIFIED-SOURCE "LIST"
       "(DEFCLASS LIST (SEQUENCE) :PARAMETERS ((ANY-VALUE :TYPE OBJECT)) :PUBLIC-SLOTS ((THE-CONS-LIST :TYPE (CONS OF (LIKE (ANY-VALUE SELF))) :INITIALLY NIL :PUBLIC? TRUE)) :INITIAL-VALUE NIL-LIST :PRINT-FORM (PRINT-CONS-LIST (THE-CONS-LIST SELF) STREAM))")))
   ...
   (CL:LET*
    ((CLASS
      (DEFINE-CLASS-FROM-STRINGIFIED-SOURCE "SET"
       "(DEFCLASS SET (COLLECTION SET-MIXIN) :PARAMETERS ((ANY-VALUE :TYPE OBJECT)) :PUBLIC-SLOTS ((THE-CONS-LIST :TYPE (CONS OF (LIKE (ANY-VALUE SELF))) :INITIALLY NIL :PUBLIC? TRUE)) :PRINT-FORM (PRINT-CONS-LIST (THE-CONS-LIST SELF) STREAM))")))
   ...
   (CL:LET*
    ((CLASS
      (DEFINE-CLASS-FROM-STRINGIFIED-SOURCE "PROPERTY-LIST"
       "(DEFCLASS PROPERTY-LIST (DICTIONARY) :PARAMETERS ((ANY-KEY :TYPE OBJECT) (ANY-VALUE :TYPE OBJECT)) :PUBLIC-SLOTS ((THE-PLIST :TYPE CONS :INITIALLY NIL)) :PRINT-FORM (PRINT-CONS-LIST (THE-PLIST SELF) STREAM))")))
    (CL:SETF (%CLASS-CONSTRUCTOR-CODE CLASS)
   ...
   (DEFINE-CLASS-FROM-STRINGIFIED-SOURCE "ABSTRACT-HASH-TABLE"
    "(DEFCLASS ABSTRACT-HASH-TABLE (ABSTRACT-DICTIONARY) :PARAMETERS ((ANY-KEY :TYPE UNKNOWN) (ANY-VALUE :TYPE UNKNOWN)) :PUBLIC-SLOTS ((THE-HASH-TABLE :TYPE NATIVE-HASH-TABLE)) :INITIALIZER INITIALIZE-HASH-TABLE :ABSTRACT? TRUE)")
   (CL:LET*
    ((CLASS
...
accessing symbols within it.\" :PUBLIC-SLOTS ((TOP-SYMBOL-OFFSET :TYPE INTEGER :INITIALLY -1) (POTENTIAL-FREE-SYMBOL-OFFSET :TYPE INTEGER :INITIALLY 0)) :INITIALIZER INITIALIZE-VECTOR)")))
   ...
   (DEFINE-CLASS-FROM-STRINGIFIED-SOURCE "NATIVE-VECTOR"
    "(DEFCLASS NATIVE-VECTOR (SECOND-CLASS-OBJECT) :PARAMETERS ((ANY-VALUE :TYPE OBJECT)) :CPP-NATIVE-TYPE \"Object**\" :CL-NATIVE-TYPE \"VECTOR\" :JAVA-NATIVE-TYPE \"stella.Stella_Object[]\" :INITIAL-VALUE (VERBATIM :COMMON-LISP \"STELLA::NULL-NATIVE-VECTOR\" :JAVA \"null\" :CPP \"NULL\"))")
...
of the class 'self'.\" :STORAGE-SLOT CLASS-EXTENSION :INHERITS-THROUGH SUPER-CLASSES) (CL-NATIVE-TYPE ((SELF CLASS)) :TYPE STRING :STORAGE-SLOT CLASS-CL-NATIVE-TYPE (RETURN (CLASS-CL-NATIVE-TYPE SELF))) (CPP-NATIVE-TYPE ((SELF CLASS)) :TYPE STRING :STORAGE-SLOT CLASS-CPP-NATIVE-TYPE (RETURN (CLASS-CPP-NATIVE-TYPE SELF))) (IDL-NATIVE-TYPE ((SELF CLASS)) :TYPE STRING :STORAGE-SLOT CLASS-IDL-NATIVE-TYPE (RETURN (CLASS-CPP-NATIVE-TYPE SELF))) (JAVA-NATIVE-TYPE ((SELF CLASS)) :TYPE STRING :STORAGE-SLOT CLASS-JAVA-NATIVE-TYPE (RETURN (CLASS-JAVA-NATIVE-TYPE SELF)))) :PRINT-FORM (PRINT-NATIVE-STREAM STREAM \"|C|\" (CHOOSE (DEFINED? (CLASS-TYPE SELF)) (RELATIVE-NAME (CLASS-SYMBOL SELF)) \"??\")))"))))
   ...
   (CL:LET*
    ((CLASS
      (DEFINE-CLASS-FROM-STRINGIFIED-SOURCE "GLOBAL-VARIABLE"
       "(DEFCLASS GLOBAL-VARIABLE (MAPPABLE-OBJECT) :PUBLIC-SLOTS ((DOCUMENTATION :TYPE STRING)) :PUBLIC-METHODS ((NAME ((SELF GLOBAL-VARIABLE)) :TYPE STRING (RETURN (SYMBOL-NAME (VARIABLE-NAME SELF)))) (TYPE ((SELF GLOBAL-VARIABLE)) :TYPE TYPE :STORAGE-SLOT VARIABLE-TYPE (RETURN (VARIABLE-TYPE SELF))) (HOME-MODULE ((SELF GLOBAL-VARIABLE)) :TYPE MODULE (RETURN (INTERNED-IN (VARIABLE-NAME SELF))))) :PUBLIC-SLOTS ((VARIABLE-NAME :TYPE SYMBOL) (VARIABLE-TYPE :TYPE TYPE) (VARIABLE-TYPE-SPECIFIER :TYPE TYPE-SPEC :ALLOCATION :DYNAMIC) (VARIABLE-SPECIAL? :TYPE BOOLEAN) (VARIABLE-CONSTANT? :TYPE BOOLEAN) (VARIABLE-PUBLIC? :TYPE BOOLEAN :INITIALLY TRUE) (VARIABLE-AUXILIARY? :TYPE BOOLEAN) (VARIABLE-GET-VALUE-CODE :TYPE FUNCTION-CODE) (VARIABLE-SET-VALUE-CODE :TYPE FUNCTION-CODE) (VARIABLE-VALUE-STACK :TYPE LIST) (VARIABLE-DOCUMENTATION :TYPE STRING :RENAMES DOCUMENTATION) (VARIABLE-STRINGIFIED-SOURCE :TYPE STRING)))")))
    (CL:SETF (%CLASS-CONSTRUCTOR-CODE CLASS)
...
the whole graph non-incrementally.\" :TYPE FLOAT :INITIALLY 0.1)) :SLOTS ((INCREMENTAL-MODE? :TYPE BOOLEAN) (LARGEST-POSTORDER-NUMBER :TYPE INTEGER) (NUMBER-OF-NODES :TYPE INTEGER) (NUMBER-OF-FOREIGN-INTERVAL-NODES :TYPE INTEGER) (ROOTS :TYPE (LIST OF TAXONOMY-NODE)) (BROKEN-LINKS :TYPE (LIST OF (CONS OF TAXONOMY-NODE))) (ADDED-LINKS :TYPE (LIST OF (CONS OF TAXONOMY-NODE))) (REMOVED-LINKS :TYPE (LIST OF (CONS OF TAXONOMY-NODE)))) :INITIALIZER INITIALIZE-TAXONOMY-GRAPH :PRINT-FORM (PRINT-NATIVE-STREAM STREAM \"|TG|\" (ROOTS SELF)))")))
   ...
   (DEFINE-CLASS-FROM-STRINGIFIED-SOURCE "NATIVE-EXCEPTION"
    "(DEFCLASS NATIVE-EXCEPTION () :JAVA-NATIVE-TYPE \"java.lang.Exception\" :CL-NATIVE-TYPE \"CONDITION\" :CPP-NATIVE-TYPE \"Exception\")")
   (DEFINE-CLASS-FROM-STRINGIFIED-SOURCE "STELLA-ROOT-EXCEPTION"
    "(DEFCLASS STELLA-ROOT-EXCEPTION (NATIVE-EXCEPTION) :PUBLIC-SLOTS ((MESSAGE :TYPE STRING :READER EXCEPTION-MESSAGE :REQUIRED? TRUE :ABSTRACT? TRUE)) :ABSTRACT? TRUE :JAVA-NATIVE-TYPE \"java.lang.RuntimeException\" :CL-NATIVE-TYPE \"SIMPLE-ERROR\")")
   (CL:LET*
    ((CLASS
...
that constitute Stella applications.\" :SLOTS ((NAME :TYPE STRING) (DIRECTORY :TYPE FILE-NAME) (FILES :TYPE (CONS OF STRING-WRAPPER)) (LISP-ONLY-FILES :TYPE (CONS OF STRING-WRAPPER)) (CPP-ONLY-FILES :TYPE (CONS OF STRING-WRAPPER)) (JAVA-ONLY-FILES :TYPE (CONS OF STRING-WRAPPER)) (PREPROCESSED-FILES :TYPE (CONS OF STRING-WRAPPER)) (REQUIRED-SYSTEMS :TYPE (CONS OF STRING-WRAPPER)) (LOADED? :TYPE BOOLEAN) (UP-TO-DATE? :TYPE BOOLEAN) (CARDINAL-MODULE :TYPE STRING) (SOURCE-ROOT-DIRECTORY :TYPE FILE-NAME) (NATIVE-ROOT-DIRECTORY :TYPE FILE-NAME) (BINARY-ROOT-DIRECTORY :TYPE FILE-NAME) (BANNER :TYPE STRING) (COPYRIGHT-HEADER :RENAMES BANNER) (PRODUCTION-SETTINGS :TYPE (CONS OF INTEGER-WRAPPER)) (DEVELOPMENT-SETTINGS :TYPE (CONS OF INTEGER-WRAPPER)) (FINALIZATION-FUNCTION :TYPE SYMBOL)) :PRINT-FORM (PRINT-NATIVE-STREAM STREAM \"|SYSTEM|\" (NAME SELF)))")))
    ...
    (DEFINE-CLASS-FROM-STRINGIFIED-SOURCE "NATIVE-STREAM"
     "(DEFCLASS NATIVE-STREAM () :ABSTRACT? TRUE :CPP-NATIVE-TYPE \"ios*\" :JAVA-NATIVE-TYPE \"Object\" :CL-NATIVE-TYPE \"STREAM\")")
    (DEFINE-CLASS-FROM-STRINGIFIED-SOURCE "NATIVE-OUTPUT-STREAM"
     "(DEFCLASS NATIVE-OUTPUT-STREAM (NATIVE-STREAM) :ABSTRACT? TRUE :CPP-NATIVE-TYPE \"ostream*\" :JAVA-NATIVE-TYPE \"java.io.PrintStream\" :CL-NATIVE-TYPE \"STREAM\")")
    (DEFINE-CLASS-FROM-STRINGIFIED-SOURCE "NATIVE-INPUT-STREAM"
     "(DEFCLASS NATIVE-INPUT-STREAM (NATIVE-STREAM) :ABSTRACT? TRUE :CPP-NATIVE-TYPE \"istream*\" :JAVA-NATIVE-TYPE \"java.io.PushbackInputStream\" :CL-NATIVE-TYPE \"STREAM\")")
    (CL:LET*
     ((CLASS
    ...
    (CL:LET*
     ((CLASS
       (DEFINE-CLASS-FROM-STRINGIFIED-SOURCE "OUTPUT-STREAM"
        "(DEFCLASS OUTPUT-STREAM (STREAM) :PUBLIC-SLOTS ((NATIVE-STREAM :TYPE NATIVE-OUTPUT-STREAM :PUBLIC? TRUE) (NATIVE-OUTPUT-STREAM :RENAMES NATIVE-STREAM)))")))
     (CL:SETF (%CLASS-CONSTRUCTOR-CODE CLASS)
      (CL:FUNCTION NEW-OUTPUT-STREAM)))
    (CL:LET*
     ((CLASS
       (DEFINE-CLASS-FROM-STRINGIFIED-SOURCE "INPUT-STREAM"
        "(DEFCLASS INPUT-STREAM (STREAM) :PUBLIC-SLOTS ((NATIVE-STREAM :TYPE NATIVE-INPUT-STREAM :PUBLIC? TRUE) (NATIVE-INPUT-STREAM :RENAMES NATIVE-STREAM) (ECHO-STREAM :TYPE OUTPUT-STREAM) (TOKENIZER-STATE :TYPE TOKENIZER-STREAM-STATE)))")))
     (CL:SETF (%CLASS-CONSTRUCTOR-CODE CLASS)
    ...
    (CL:LET*
     ((CLASS
       (DEFINE-CLASS-FROM-STRINGIFIED-SOURCE "INPUT-STRING-STREAM"
        "(DEFCLASS INPUT-STRING-STREAM (INPUT-STREAM) :SYNONYMS (STRING-INPUT-STREAM) :PUBLIC-SLOTS ((THE-STRING :TYPE STRING :REQUIRED? TRUE :PUBLIC? TRUE)) :INITIALIZER INITIALIZE-STRING-INPUT-STREAM)")))
     (CL:SETF (%CLASS-CONSTRUCTOR-CODE CLASS)
   ...
   (CL:WHEN (CURRENT-STARTUP-TIME-PHASE? 7)
    ...
    (CL:LET*
     ...
     (SET-DYNAMIC-SLOT-VALUE (%DYNAMIC-SLOTS FUNCTION)
      ...
      (WRAP-STRING "Startup-Hierarchy") NULL-STRING-WRAPPER)))
