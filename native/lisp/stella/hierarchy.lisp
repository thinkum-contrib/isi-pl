...
(CL:DECLAIM
 (CL:SPECIAL *STELLA-MODULE* *MODULE* NULL-LONG-INTEGER *PRINTREADABLY?*
  ...
  *CONTEXT* NULL-FLOAT NULL-CHARACTER NIL TRUE-WRAPPER FALSE-WRAPPER
  NULL-INTEGER))
...
(CL:DEFUN NEW-STRING-ITERATOR ()
  (CL:LET* ((SELF NULL))
   ...
   (CL:SETF (%FIRST-ITERATION? SELF) CL:T)
   (CL:SETF (%VALUE SELF) NULL-CHARACTER) (CL:SETF (%END SELF) NULL-INTEGER)
...
(CL:DEFCLASS CUSTOM-VECTOR-SEQUENCE (VECTOR-SEQUENCE)
  ((RESIZE-FACTOR :TYPE CL:DOUBLE-FLOAT :INITFORM NULL-FLOAT :ALLOCATION
    :INSTANCE :ACCESSOR %RESIZE-FACTOR))
  (:DOCUMENTATION
...
(CL:DEFUN NEW-CUSTOM-VECTOR-SEQUENCE (ARRAY-SIZE)
  ...
  (CL:LET* ((SELF NULL))
   ...
   (CL:SETF (%ARRAY-SIZE SELF) ARRAY-SIZE)
   (CL:SETF (%THE-ARRAY SELF) STELLA::NULL-NATIVE-VECTOR)
   (CL:SETF (%SEQUENCE-LENGTH SELF) 0) (CL:SETF (%RESIZE-FACTOR SELF) 2.0d0)
   (INITIALIZE-VECTOR SELF) (CL:RETURN-FROM NEW-CUSTOM-VECTOR-SEQUENCE SELF)))
...
(CL:DEFUN NEW-DEMON ()
  (CL:LET* ((SELF NULL)) (CL:SETQ SELF (CL:MAKE-INSTANCE (CL:QUOTE DEMON)))
   (CL:SETF (%DEMON-INHERIT? SELF) CL:NIL) (CL:SETF (%DEMON-ALL? SELF) CL:NIL)
...
(CL:DEFUN NEW-CLASS ()
  (CL:LET* ((SELF NULL)) (CL:SETQ SELF (CL:MAKE-INSTANCE (CL:QUOTE CLASS)))
   ...
   (CL:SETF (%CLASS-PUBLIC? SELF) CL:T) (CL:SETF (%CL-STRUCT? SELF) CL:NIL)
   (CL:SETF (%CLASS-COLLECTION? SELF) CL:NIL) (CL:SETF (%MIXIN? SELF) CL:NIL)
...
(CL:DEFUN NEW-STORAGE-SLOT ()
  (CL:LET* ((SELF NULL))
   ...
   (CL:SETF (%SLOT-RENAMED? SELF) CL:NIL) (CL:SETF (%SLOT-PUBLIC? SELF) CL:T)
...
(CL:DEFUN NEW-GLOBAL-VARIABLE ()
  (CL:LET* ((SELF NULL))
   ...
   (CL:SETF (%VARIABLE-TYPE SELF) NULL) (CL:SETF (%VARIABLE-NAME SELF) NULL)
...
(CL:DEFUN NEW-MODULE ()
  (CL:LET* ((SELF NULL)) (CL:SETQ SELF (CL:MAKE-INSTANCE (CL:QUOTE MODULE)))
   ...
   (CL:SETF (%CASE-SENSITIVE? SELF) CL:NIL) (CL:SETF (%REQUIRES SELF) NULL)
...
(CL:DEFMETHOD COERCE-TO ((SELF QUANTITY) OTHER)
  (CL:IF (ISA? OTHER (PRIMARY-TYPE SELF)) (CL:RETURN-FROM COERCE-TO OTHER)
   (CL:RETURN-FROM COERCE-TO NULL)))
...
(CL:DEFUN NEW-SYSTEM-DEFINITION ()
  (CL:LET* ((SELF NULL))
   ...
   (CL:SETF (%UP-TO-DATE? SELF) CL:NIL) (CL:SETF (%LOADED? SELF) CL:NIL)
   (CL:SETF (%REQUIRED-SYSTEMS SELF) NULL)
   (CL:SETF (%PREPROCESSED-FILES SELF) NULL) (CL:SETF (%DATA-FILES SELF) NULL)
...
(CL:DEFUN HELP-STARTUP-HIERARCHY1 ()
  (CL:PROGN
   ...
   (CL:SETQ SGT-HIERARCHY-STELLA-REVERSE-INTEGER-INTERVAL-ITERATOR
    (INTERN-RIGID-SYMBOL-WRT-MODULE "REVERSE-INTEGER-INTERVAL-ITERATOR" NULL
     1))
...
(CL:DEFUN HELP-STARTUP-HIERARCHY4 ()
  (CL:PROGN
   ...
   (CL:SETQ SYM-HIERARCHY-STELLA-METHOD-PARAMETER-TYPE-SPECIFIERS
    (INTERN-RIGID-SYMBOL-WRT-MODULE "METHOD-PARAMETER-TYPE-SPECIFIERS" NULL
     0))
...
(CL:DEFUN HELP-STARTUP-HIERARCHY5 ()
  (CL:PROGN
   ...
   (CL:SETQ SYM-HIERARCHY-STELLA-NUMBER-OF-FOREIGN-INTERVAL-NODES
    (INTERN-RIGID-SYMBOL-WRT-MODULE "NUMBER-OF-FOREIGN-INTERVAL-NODES" NULL
     0))
