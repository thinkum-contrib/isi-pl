...
(CL:DECLAIM
 (CL:SPECIAL *STELLA-MODULE* *MODULE* NULL-STRING-WRAPPER NULL-CHARACTER
  FALSE-WRAPPER TRUE-WRAPPER ELIPSIS TRUE NULL-INTEGER FALSE STANDARD-OUTPUT EOL
  NIL))
...
(CL:DEFUN STRING-SEARCH-FOR-OBJECT (STRING CLASSTYPE)
  ...
  (CL:LET* ((OBJECT NULL))
   (CL:LET*
    ((FN NULL) (TYPE NULL)
     (ITER-000 (%THE-KV-LIST *STRING-TO-OBJECT-FUNCTIONS*)))
    (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-000 NULL)) DO
     (CL:SETQ TYPE (%KEY ITER-000))
     (CL:PROGN (CL:SETQ FN (%VALUE ITER-000))
      ...
      (CL:COND
       ...
       (CL:T
        (CL:LET* ((STREAM-000 (NEW-OUTPUT-STRING-STREAM)))
         (%%PRINT-STREAM (%NATIVE-STREAM STREAM-000) "`" (SAFE-PRIMARY-TYPE FN)
  ...
  (CL:LET* ((CLASSTYPE NULL))
   (CL:WHEN (CL:NOT (CL:EQ TYPEREF NULL))
    (CL:LET* ((TEST-VALUE-000 (SAFE-PRIMARY-TYPE TYPEREF)))
     (CL:COND
      ((SUBTYPE-OF-SYMBOL? TEST-VALUE-000)
       (CL:PROGN
        (CL:SETQ CLASSTYPE
         (LOOKUP-SURROGATE-IN-MODULE (%SYMBOL-NAME TYPEREF)
          (%HOME-CONTEXT TYPEREF) FALSE))))
      ((SUBTYPE-OF-SURROGATE? TEST-VALUE-000)
       (CL:PROGN (CL:SETQ CLASSTYPE TYPEREF)))
      ((SUBTYPE-OF-STRING? TEST-VALUE-000)
       (CL:PROGN
        (CL:SETQ CLASSTYPE (LOOKUP-SURROGATE (%WRAPPER-VALUE TYPEREF)))))
      ((SUBTYPE-OF-CLASS? TEST-VALUE-000)
       (CL:PROGN (CL:SETQ CLASSTYPE (%CLASS-TYPE TYPEREF))))
      (CL:T
    ...
    (CL:WHEN
     ...
     (%%PRINT-STREAM (%NATIVE-STREAM STANDARD-OUTPUT)
      "No class exists with name: `" (%SYMBOL-NAME CLASSTYPE) "'" EOL)
   ...
   (CL:LET* ((TEST-VALUE-001 (SAFE-PRIMARY-TYPE SELF)))
    (CL:COND
     ((SUBTYPE-OF-STRING? TEST-VALUE-001)
      (CL:PROGN
       (CL:LET*
        ((STRING (%WRAPPER-VALUE SELF))
         (OBJECT (STRING-SEARCH-FOR-OBJECT STRING CLASSTYPE)) (MODULE NULL))
        (CL:DECLARE (CL:TYPE CL:SIMPLE-STRING STRING))
        (CL:WHEN (CL:AND (CL:EQ OBJECT NULL) (QUALIFIED-NAME? STRING))
     ...
     ((SUBTYPE-OF-SYMBOL? TEST-VALUE-001)
      (CL:PROGN
       (CL:RETURN-FROM SEARCH-FOR-OBJECT
        (SEARCH-FOR-OBJECT (WRAP-STRING (%SYMBOL-NAME SELF)) CLASSTYPE))))
     ((SUBTYPE-OF-INTEGER? TEST-VALUE-001)
      (CL:PROGN
       (CL:LET* ((INTEGER (%WRAPPER-VALUE SELF)) (OBJECT NULL))
        (CL:DECLARE (CL:TYPE CL:FIXNUM INTEGER))
        (CL:LET*
         ((FN NULL) (ITER-000 (%THE-CONS-LIST *INTEGER-TO-OBJECT-FUNCTIONS*)))
   ...
   (CL:RETURN-FROM FILTER-STRING-TO-CLASS?
    (DEFINED?
     (STRING-SEARCH (CLASS-NAME SELF)
      (%WRAPPER-VALUE (%ITERATOR-OBJECT ITERATOR)) 0)))))
...
(CL:DEFUN STRING-TO-CLASSES (STRING EXACT?)
  ...
  (CL:LET* ((ITERATOR (NEW-ALL-PURPOSE-ITERATOR)))
   (CL:SETF (%ITERATOR-NESTED-ITERATOR ITERATOR) (ALL-CLASSES NULL FALSE))
   ...
   (CL:SETF (%ITERATOR-OBJECT ITERATOR) (WRAP-STRING STRING))
   (CL:SETF (%ITERATOR-INTEGER ITERATOR) (CL:IF EXACT? 1 0))
...
(CL:DEFUN STRING-TO-CLASS (STRING)
  ...
  #+MCL
  (CL:CHECK-TYPE STRING CL:SIMPLE-STRING)
  (CL:RETURN-FROM STRING-TO-CLASS (GET-STELLA-CLASS STRING FALSE)))
...
(CL:DEFUN STRING-TO-CONTEXT (STRING)
  ...
  (CL:CHECK-TYPE STRING CL:SIMPLE-STRING)
  (CL:HANDLER-CASE
   (CL:RETURN-FROM STRING-TO-CONTEXT (GET-STELLA-CONTEXT-SLOWLY STRING))
...
(CL:DECLAIM
 (CL:FTYPE
  (CL:FUNCTION (CL:SIMPLE-STRING) (CL:VALUES CL:SIMPLE-STRING CL:SIMPLE-STRING))
...
(CL:DEFUN STRING-TO-SLOT (STRING)
  ...
  (CL:IF (DOTTED-STRING? STRING)
   (CL:LET* ((CLASSSTRING STELLA::NULL-STRING) (SLOTSTRING STELLA::NULL-STRING))
    ...
    (CL:LET* ((CLASS (GET-STELLA-CLASS CLASSSTRING FALSE)) (SLOTNAME NULL))
  ...
  (CL:LET*
   ...
   (CL:COND
    ((SUBTYPE-OF? (SAFE-PRIMARY-TYPE MODESPEC)
     ...
     (CL:PROGN
      (CL:LET* ((TEST-VALUE-000 (%SYMBOL-NAME MODESPEC)))
   ...
   (CL:COND
     ...
     (CL:PROGN
      (CL:LET* ((CONS (ALLOCATE-ITERATOR TREE)))
       (CL:LOOP WHILE (NEXT? CONS) DO
        (VALUE-SETTER CONS (CONSIFY-LISTS-AND-ITERATORS (%VALUE CONS)))))
      (CL:RETURN-FROM CONSIFY-LISTS-AND-ITERATORS TREE)))
    ((SUBTYPE-OF? TEST-VALUE-000 SGT-DESCRIBE-STELLA-LIST)
     (CL:PROGN
      (CL:LET* ((CONSLIST NIL))
       (CL:LET*
        ((I NULL-INTEGER) (ITEM NULL) (ITER-000 (%THE-CONS-LIST TREE))
         (ITER-001 0) (UPPER-BOUND-000 *PRETTY-PRINT-LIST-CUTOFF*)
        ...
        (CL:LOOP WHILE
         ...
         (CL:IF (CL:EQ COLLECT-000 NULL)
          (CL:PROGN
           (CL:SETQ COLLECT-000
            (CONS (CL:IF (CL:= I *PRETTY-PRINT-LIST-CUTOFF*) ELIPSIS ITEM) NIL))
    ...
    ((SUBTYPE-OF? TEST-VALUE-000 SGT-DESCRIBE-STELLA-ITERATOR)
     (CL:PROGN
      (CL:LET* ((CONSLIST NIL))
       (CL:LET*
        ((I NULL-INTEGER) (ITEM NULL) (ITER-002 TREE) (ITER-003 0)
         (UPPER-BOUND-001 *PRETTY-PRINT-LIST-CUTOFF*)
         (UNBOUNDED?-001 (NULL? UPPER-BOUND-001)) (COLLECT-001 NULL))
        ...
        (CL:LOOP WHILE
         ...
         DO (CL:SETQ ITEM (%VALUE ITER-002))
...
(CL:DEFMETHOD PRINT-DEFINITION ((SELF MODULE) STREAM)
  (CL:LET*
   ((OPTIONS (READ-S-EXPRESSION-FROM-STRING (%STRINGIFIED-OPTIONS SELF))))
   (CL:LET* ((*PRINTREADABLY?* TRUE)) (CL:DECLARE (CL:SPECIAL *PRINTREADABLY?*))
    (%%PRINT-STREAM (%NATIVE-STREAM STREAM) "(DEFMODULE \""
     (%MODULE-FULL-NAME SELF) "\"")
    (CL:LOOP WHILE (CL:NOT (CL:EQ OPTIONS NIL)) DO
     (%%PRINT-STREAM (%NATIVE-STREAM STREAM) EOL "  " (%%VALUE OPTIONS) " "
      (%%VALUE (%%REST OPTIONS)))
...
(CL:DEFUN PRINT-CLASS-LIST (SELF STREAM)
  ...
  (CL:WHEN (NEXT? SELF)
   (%%PRINT-STREAM (%NATIVE-STREAM STREAM)
    (%SYMBOL-NAME (%CLASS-TYPE (%VALUE SELF)))))
...
(CL:DEFUN GET-CLASS-OPTIONS ()
  (CL:LET* ((RESULT NIL))
   (CL:LET*
    ((SLOT NULL)
     (ITER-000
      (PRIVATE-CLASS-STORAGE-SLOTS (%SURROGATE-VALUE SGT-DESCRIBE-STELLA-CLASS)))
     (COLLECT-000 NULL))
   ...
   (CL:LET*
    ((SLOT NULL)
     (ITER-001
      (PUBLIC-CLASS-STORAGE-SLOTS (%SURROGATE-VALUE SGT-DESCRIBE-STELLA-CLASS)))
     (COLLECT-001 NULL))
    ...
    ((SLOT NULL)
     (ITER-002
      (PRIVATE-CLASS-STORAGE-SLOTS
       (%SURROGATE-VALUE SGT-DESCRIBE-STELLA-RELATION)))
     (COLLECT-002 NULL))
  ...
  (CL:LET* ((RESULT NIL))
   (CL:LET*
    ((SLOT NULL)
     (ITER-000
      (PRIVATE-CLASS-STORAGE-SLOTS
       (%SURROGATE-VALUE SGT-DESCRIBE-STELLA-STORAGE-SLOT)))
     (COLLECT-000 NULL))
    (CL:LOOP WHILE (NEXT? ITER-000) DO (CL:SETQ SLOT (%VALUE ITER-000))
     (CL:WHEN
      (CL:NOT
...
(CL:DEFUN LITERAL-EQL? (X Y)
  (CL:WHEN
   (CL:OR
    (CL:AND (CL:NOT (CL:EQ X NULL)) (ISA? X SGT-DESCRIBE-STELLA-BOOLEAN-WRAPPER))
   ...
   (CL:RETURN-FROM LITERAL-EQL?
    (CL:OR (CL:AND (CL:EQ X NULL) (CL:NOT (COERCE-WRAPPED-BOOLEAN-TO-BOOLEAN Y)))
     (CL:AND (CL:EQ Y NULL) (CL:NOT (COERCE-WRAPPED-BOOLEAN-TO-BOOLEAN X)))
     (EQL? X Y))))
...
(CL:DEFUN PRETTY-PRINT-CLASS-OPTIONS (CLASS STREAM)
  (CL:LET* ((OPTIONVALUE NULL))
   (CL:LET* ((OPTIONSLOT NULL) (ITER-000 *CLASSOPTIONSLOTS*))
    (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-000 NIL)) DO
     (CL:PROGN (CL:SETQ OPTIONSLOT (%%VALUE ITER-000))
      (CL:SETQ ITER-000 (%%REST ITER-000)))
          ...
          (CL:WHEN
           (CL:NOT
            (CL:OR
             (LITERAL-EQL?
              (CONVERT-TO-LITERAL
               (DYNAMIC-SLOT-VALUE (%DYNAMIC-SLOTS OPTIONSLOT)
                SYM-DESCRIBE-STELLA-SLOT-INITIAL-VALUE NULL))
              OPTIONVALUE)
             (LITERAL-EQL? (CONVERT-TO-LITERAL (DEFAULT-FORM OPTIONSLOT))
              OPTIONVALUE)))
           (%%PRINT-STREAM (%NATIVE-STREAM STREAM) EOL "  :"
            (STRING-DOWNCASE
             (%SYMBOL-NAME
...
(CL:DEFMETHOD PRETTY-PRINT-OBJECT ((SELF STORAGE-SLOT) STREAM)
  (%%PRINT-STREAM (%NATIVE-STREAM STREAM) "("
   (STRING-DOWNCASE (%SYMBOL-NAME (%SLOT-NAME SELF))) " :type ")
  (%%PRINT-STREAM (%NATIVE-STREAM STREAM)
   (CL:IF
    (CL:NOT
     (CL:EQ
...
(CL:DEFUN PRETTY-PRINT-METHOD-PARAMETERS (STREAM METHOD)
  (CL:LET*
   ...
   (CL:LET* ((*PRINTREADABLY?* TRUE)) (CL:DECLARE (CL:SPECIAL *PRINTREADABLY?*))
    (%%PRINT-STREAM (%NATIVE-STREAM STREAM) "(")
    (CL:LET*
     ((I NULL-INTEGER) (TSPEC NULL) (PARAMETER NULL)
     ...
     (CL:LOOP WHILE
      ...
      (CL:WHEN (CL:= I LASTARGINDEX)
       (%%PRINT-STREAM (%NATIVE-STREAM STREAM) "&rest ")
...
(CL:DEFMETHOD PRETTY-PRINT-OBJECT ((SELF METHOD-SLOT) STREAM)
  (%%PRINT-STREAM (%NATIVE-STREAM STREAM) "("
   (STRING-DOWNCASE (%SYMBOL-NAME (%SLOT-NAME SELF))) " ")
...
(CL:DEFUN PRETTY-PRINT-SLOT-BLOCK (STREAM ITERATOR SLOTGROUP)
  ...
  (CL:IF (NEXT? ITERATOR)
   (CL:LET* ((SLOT (%VALUE ITERATOR)))
    (%%PRINT-STREAM (%NATIVE-STREAM STREAM) EOL "  " SLOTGROUP EOL "  (")
...
(CL:DEFMETHOD PRETTY-PRINT-OBJECT ((SELF CLASS) STREAM)
  (CL:LET*
   ...
   (%%PRINT-STREAM (%NATIVE-STREAM STREAM) "(defclass "
    (%SYMBOL-NAME (%CLASS-TYPE SELF)) " ")
   (PRINT-CLASS-LIST
   ...
   (CL:WHEN (NEXT? (CLASS-TABLES SELF NIL))
    ...
    (CL:LET* ((TABLE NULL) (ITER-000 (CLASS-TABLES SELF NIL)))
     (CL:LOOP WHILE (NEXT? ITER-000) DO (CL:SETQ TABLE (%VALUE ITER-000))
  ...
  (CL:COND
   ((CL:EQ MODE KWD-DESCRIBE-SOURCE)
    (PRETTY-PRINT-DEFINITION-TREE
     (READ-S-EXPRESSION-FROM-STRING (%CLASS-STRINGIFIED-SOURCE SELF)) STREAM))
   ((CL:EQ MODE KWD-DESCRIBE-TERSE) (DESCRIBE-TERSELY SELF STREAM))
   ((CL:EQ MODE KWD-DESCRIBE-VERBOSE)
    (%%PRINT-STREAM (%NATIVE-STREAM STREAM) "SOURCE mode:" EOL)
...
(CL:DEFMETHOD DESCRIBE-OBJECT ((SELF STORAGE-SLOT) STREAM MODE)
  (CL:COND
   ((CL:EQ MODE KWD-DESCRIBE-SOURCE)
    (%%PRINT-STREAM (%NATIVE-STREAM STREAM) "TERSE mode:" EOL)
  ...
  (CL:COND
   ((CL:EQ MODE KWD-DESCRIBE-SOURCE)
    (PRETTY-PRINT-STELLA-TREE
     (READ-S-EXPRESSION-FROM-STRING (XMODULE-STRINGIFIED-SOURCE SELF)) STREAM))
   ((CL:EQ MODE KWD-DESCRIBE-TERSE) (DESCRIBE-TERSELY SELF STREAM))
   ((CL:EQ MODE KWD-DESCRIBE-VERBOSE)
    (PRETTY-PRINT-DEFINITION-TREE
      ...
      (LIST* KWD-DESCRIBE-INCLUDES (%PARENT-MODULES SELF)
       (LIST* KWD-DESCRIBE-USES (%USES SELF)
        (LIST* KWD-DESCRIBE-SHADOWS (SHADOWED-SURROGATES SELF)
         (LIST* SYM-DESCRIBE-STELLA->>_INFERRED_SLOTS KWD-DESCRIBE-CHILDREN
          (%CHILD-CONTEXTS SELF)
...
(CL:DEFUN XMODULE-STRINGIFIED-SOURCE (SELF)
  (CL:RETURN-FROM XMODULE-STRINGIFIED-SOURCE
   (CONCATENATE "(defmodule "
    (CONCATENATE (%MODULE-NAME SELF)
     (CONCATENATE " " (CONCATENATE (%STRINGIFIED-OPTIONS SELF) ")"))))))
(CL:DECLAIM
 (CL:FTYPE (CL:FUNCTION (CL:T) CL:SIMPLE-STRING) XMODULE-STRINGIFIED-SOURCE))
...
(CL:DEFUN SHORT-DOCUMENTATION (DOCUMENTATION)
  ...
  (CL:LET* ((LINEEND NULL-INTEGER) (SENTENCEEND NULL-INTEGER))
   ...
   (CL:WHEN (NULL? LINEEND)
    (CL:SETQ LINEEND (POSITION DOCUMENTATION #\Linefeed 0)))
   (CL:WHEN (NULL? LINEEND) (CL:RETURN-FROM SHORT-DOCUMENTATION DOCUMENTATION))
   (CL:WHEN
    (MEMBER? ".!"
   ...
   (CL:IF (CL:AND (DEFINED? SENTENCEEND) (CL:<= SENTENCEEND 155))
    (CL:RETURN-FROM SHORT-DOCUMENTATION
     (SUBSEQUENCE DOCUMENTATION 0 (CL:1+ SENTENCEEND)))
    (CL:RETURN-FROM SHORT-DOCUMENTATION (SUBSEQUENCE DOCUMENTATION 0 LINEEND)))))
(CL:DECLAIM
 (CL:FTYPE (CL:FUNCTION (CL:SIMPLE-STRING) CL:SIMPLE-STRING) SHORT-DOCUMENTATION))
...
(CL:DEFUN PRINT-DOCUMENTATION-STRING (STRING INDENT STREAM)
  ...
  (CL:LET* ((FRESHLINE? TRUE)) (CL:WHEN (NULL? INDENT) (CL:SETQ INDENT 0))
   (CL:LET*
    ...
    (CL:LOOP WHILE (CL:< INDEX-000 LENGTH-000) DO
     ...
     (%%PRINT-STREAM (%NATIVE-STREAM STREAM) CHAR)
     (CL:WHEN (CL:EQL CHAR #\Linefeed) (CL:SETQ FRESHLINE? TRUE))))
   (%%PRINT-STREAM (%NATIVE-STREAM STREAM) EOL))
  :VOID)
...
(CL:DEFMETHOD PRINT-DOCUMENTATION ((SELF METHOD-SLOT) STREAM SHORT?)
  ...
  (CL:LET*
   ((DOCUMENTATION
     (%WRAPPER-VALUE
      (DYNAMIC-SLOT-VALUE (%DYNAMIC-SLOTS SELF) SYM-DESCRIBE-STELLA-DOCUMENTATION
       NULL-STRING-WRAPPER))))
   (CL:DECLARE (CL:TYPE CL:SIMPLE-STRING DOCUMENTATION))
   (%%PRINT-STREAM (%NATIVE-STREAM STREAM) (%SLOT-NAME SELF))
   (CL:WHEN (CL:NOT SHORT?) (%%PRINT-STREAM (%NATIVE-STREAM STREAM) " ")
    (PRETTY-PRINT-METHOD-PARAMETERS STREAM SELF))
   (%%PRINT-STREAM (%NATIVE-STREAM STREAM) ":" EOL)
   (PRINT-DOCUMENTATION-STRING
    (CL:IF SHORT? (SHORT-DOCUMENTATION DOCUMENTATION) DOCUMENTATION) 2 STREAM))
  :VOID)
...
to the standard print function.\")" (CL:FUNCTION DESCRIBE-OBJECT) NULL)
   ...
   (DEFINE-FUNCTION-OBJECT "STARTUP-DESCRIBE"
    "(DEFUN STARTUP-DESCRIBE () :PUBLIC? TRUE)" (CL:FUNCTION STARTUP-DESCRIBE)
    NULL)
   (CL:LET* ((FUNCTION (LOOKUP-FUNCTION SYM-DESCRIBE-STELLA-STARTUP-DESCRIBE)))
    (SET-DYNAMIC-SLOT-VALUE (%DYNAMIC-SLOTS FUNCTION)
     ...
     (WRAP-STRING "_Startup-Describe") NULL-STRING-WRAPPER)))
  :VOID)
...
(CL:DEFUN STARTUP-DESCRIBE ()
  (CL:LET* ((*MODULE* *STELLA-MODULE*) (*CONTEXT* *MODULE*))
   ...
   (CL:WHEN (CURRENT-STARTUP-TIME-PHASE? 9)
    (REGISTER-NATIVE-NAME SYM-DESCRIBE-STELLA-GET KWD-DESCRIBE-COMMON-LISP
     KWD-DESCRIBE-FUNCTION)
...
argument is given.\")")
    (REGISTER-NATIVE-NAME SYM-DESCRIBE-STELLA-DESCRIBE KWD-DESCRIBE-COMMON-LISP
     KWD-DESCRIBE-FUNCTION)
    (DEFINE-STELLA-GLOBAL-VARIABLE-FROM-STRINGIFIED-SOURCE
