...
node if `root?' is `true'.  Return the node."
  (CL:COND
   ((CL:EQ NODE NULL)
    (CL:LET* ((SELF-000 (NEW-TAXONOMY-NODE))) (CL:SETF (%NATIVE-OBJECT SELF-000) NATIVEOBJECT)
  ...
  (CL:LET* ((PARENTSCOPY (COPY-CONS-LIST (%PARENTS NODE))) (CHILDRENCOPY (COPY-CONS-LIST (%CHILDREN NODE))))
   (CL:LET* ((PARENT NULL) (ITER-000 PARENTSCOPY))
    (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-000 NIL)) DO (CL:SETQ PARENT (%%VALUE ITER-000))
     (UNLINK-TAXONOMY-NODES GRAPH PARENT NODE) (CL:SETQ ITER-000 (%%REST ITER-000))))
   (CL:LET* ((CHILD NULL) (ITER-001 CHILDRENCOPY))
    (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-001 NIL)) DO (CL:SETQ CHILD (%%VALUE ITER-001))
     (UNLINK-TAXONOMY-NODES GRAPH NODE CHILD) (CL:SETQ ITER-001 (%%REST ITER-001))))
   (CL:SETF (%INTERVALS NODE) NIL) (CL:SETF (%NATIVE-OBJECT NODE) NULL) (DELETED?-SETTER NODE CL:T)
   (REMOVE-TAXONOMY-ROOT GRAPH NODE) (CL:SETF (%NUMBER-OF-NODES GRAPH) (CL:1- (%NUMBER-OF-NODES GRAPH))))
  :VOID)
...
with the arguments reversed."
  ...
  (CL:IF (%INCREMENTAL-MODE? GRAPH) (PUSH (%ADDED-LINKS GRAPH) (CONS PARENT (CONS CHILD NIL)))
...
(CL:DEFUN INCREMENTALLY-LINK-TAXONOMY-NODES (GRAPH PARENT CHILD)
  ...
  (CREATE-TAXONOMY-LINK GRAPH PARENT CHILD)
  (CL:LET*
   ((INTERVAL NULL) (PARENTEXISTS? (CL:NOT (CL:EQ (%INITIAL-INTERVAL PARENT) NULL)))
    (CHILDEXISTS? (CL:NOT (CL:EQ (%INITIAL-INTERVAL CHILD) NULL))))
   (CL:COND
    (CHILDEXISTS?
     (CL:WHEN (CL:NOT PARENTEXISTS?) (CL:SETQ INTERVAL (CREATE-NEXT-POSTORDER-INTERVAL GRAPH))
      (CL:SETF (%INITIAL-INTERVAL PARENT) INTERVAL) (CL:SETF (%LABEL PARENT) (%UPPER-BOUND INTERVAL))
     ...
     (CL:LET* ((INTERVAL NULL) (ITER-000 (%INTERVALS CHILD)))
      (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-000 NIL)) DO (CL:SETQ INTERVAL (%%VALUE ITER-000))
       (PROPAGATE-FOREIGN-INTERVAL PARENT INTERVAL) (CL:SETQ ITER-000 (%%REST ITER-000)))))
    (CL:T
     (CL:WHEN (CL:NOT PARENTEXISTS?) (CL:SETQ INTERVAL (CREATE-NEXT-POSTORDER-INTERVAL GRAPH))
      (CL:SETF (%INITIAL-INTERVAL PARENT) INTERVAL) (CL:SETF (%LABEL PARENT) (%UPPER-BOUND INTERVAL))
      (ADD-TAXONOMY-NODE-INTERVAL PARENT INTERVAL))
     ...
     (CL:WHEN (CL:EQ INTERVAL NULL)
      (CL:WHEN (%RENUMBER-IF-OUT-OF-NUMBERS? GRAPH) (FINALIZE-TAXONOMY-GRAPH-NONINCREMENTALLY GRAPH)
       (CL:RETURN-FROM INCREMENTALLY-LINK-TAXONOMY-NODES))
      (CL:SETQ INTERVAL (CREATE-NEXT-POSTORDER-INTERVAL GRAPH)))
     (CL:SETF (%INITIAL-INTERVAL CHILD) INTERVAL) (CL:SETF (%LABEL CHILD) (%UPPER-BOUND INTERVAL))
     (ADD-TAXONOMY-NODE-INTERVAL CHILD INTERVAL)
     (CL:SETF (%TREE-CHILDREN PARENT) (CONCATENATE (%TREE-CHILDREN PARENT) (CONS CHILD NIL)))
...
(CL:DEFUN CREATE-NEXT-POSTORDER-INTERVAL (GRAPH)
  ...
  (CL:LET* ((NEWINTERVAL (NEW-INTERVAL)))
   (CL:SETF (%LOWER-BOUND NEWINTERVAL) (CL:1+ (%LARGEST-POSTORDER-NUMBER GRAPH)))
   (CL:SETF (%UPPER-BOUND NEWINTERVAL) (CL:+ (%LARGEST-POSTORDER-NUMBER GRAPH) *NUMBERING-INTERVAL*))
   (CL:SETF (%LARGEST-POSTORDER-NUMBER GRAPH) (%UPPER-BOUND NEWINTERVAL))
...
(CL:DEFUN ALLOCATE-INTERVAL-FOR-NEW-LEAF-NODE (PARENT)
  (CL:LET* ((PARENTINTERVAL (%INITIAL-INTERVAL PARENT)))
   (CL:WHEN (CL:EQ (%TREE-CHILDREN PARENT) NIL)
    (CL:WHEN (CL:= (%LOWER-BOUND PARENTINTERVAL) (%UPPER-BOUND PARENTINTERVAL))
    ...
    (CL:LET* ((SELF-000 (NEW-INTERVAL))) (CL:SETF (%LOWER-BOUND SELF-000) (%LOWER-BOUND PARENTINTERVAL))
     (CL:SETF (%UPPER-BOUND SELF-000)
      (FLOOR (CL:/ (CL:+ (%LOWER-BOUND PARENTINTERVAL) (%UPPER-BOUND PARENTINTERVAL)) 2.0d0)))
   ...
   (CL:LET* ((RIGHTCHILD (LAST (%TREE-CHILDREN PARENT))) (RIGHTCHILDINTERVAL (%INITIAL-INTERVAL RIGHTCHILD)))
    (CL:WHEN (CL:>= (%UPPER-BOUND RIGHTCHILDINTERVAL) (CL:1- (%UPPER-BOUND PARENTINTERVAL)))
     (CL:RETURN-FROM ALLOCATE-INTERVAL-FOR-NEW-LEAF-NODE NULL))
    (CL:LET* ((SELF-001 (NEW-INTERVAL))) (CL:SETF (%LOWER-BOUND SELF-001) (CL:1+ (%UPPER-BOUND RIGHTCHILDINTERVAL)))
     (CL:SETF (%UPPER-BOUND SELF-001)
      (CEILING (CL:/ (CL:+ (%UPPER-BOUND PARENTINTERVAL) (%UPPER-BOUND RIGHTCHILDINTERVAL)) 2.0d0)))
...
return an iterator that generates all the graph's nodes."
  (CL:LET* ((SELF-000 (NEW-ALL-PURPOSE-ITERATOR))) (CL:SETF (%ITERATOR-OBJECT SELF-000) (COPY (%ROOTS GRAPH)))
   (CL:SETF (%ITERATOR-NEXT-CODE SELF-000) (CL:FUNCTION ALL-TAXONOMY-NODES-NEXT?))
   (CL:LET* ((VALUE-000 SELF-000)) (CL:RETURN-FROM ALL-TAXONOMY-NODES VALUE-000))))

;;; (DEFUN (ALL-TAXONOMY-NODES-NEXT? BOOLEAN) ...)

(CL:DEFUN ALL-TAXONOMY-NODES-NEXT? (SELF)
  (CL:LET* ((ROOTS (%ITERATOR-OBJECT SELF))) (CL:WHEN (EMPTY? ROOTS) (CL:RETURN-FROM ALL-TAXONOMY-NODES-NEXT? CL:NIL))
   (CL:SETF (%VALUE SELF) (POP ROOTS))
   (CL:LET* ((CHILD NULL) (ITER-000 (%TREE-CHILDREN (%VALUE SELF))))
    (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-000 NIL)) DO (CL:SETQ CHILD (%%VALUE ITER-000)) (PUSH ROOTS CHILD)
...
(CL:DEFUN FIND-TAXONOMY-NODE (GRAPH LABEL)
  ...
  (CL:LET* ((NODE NULL) (ITER-000 (ALL-TAXONOMY-NODES GRAPH)))
   (CL:LOOP WHILE (NEXT? ITER-000) DO (CL:SETQ NODE (%VALUE ITER-000))
    (CL:WHEN (CL:= (%LABEL NODE) LABEL) (CL:RETURN-FROM FIND-TAXONOMY-NODE NODE))))
  ...
  (CL:WHEN (CL:NOT (CL:= (%LABEL NODE) NULL-INTEGER)) (CLEAR-TAXONOMY-NODE NODE)
   (CL:LET* ((CHILD NULL) (ITER-000 (%CHILDREN NODE)))
    (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-000 NIL)) DO (CL:SETQ CHILD (%%VALUE ITER-000))
     (HELP-CLEAR-TAXONOMY-GRAPH CHILD) (CL:SETQ ITER-000 (%%REST ITER-000)))))
  :VOID)
...
but retain information about the native network and associated links."
  (CL:LET* ((ROOT NULL) (ITER-000 (%THE-CONS-LIST (REMOVE-DELETED-MEMBERS (%ROOTS GRAPH)))))
   (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-000 NIL)) DO (CL:SETQ ROOT (%%VALUE ITER-000)) (HELP-CLEAR-TAXONOMY-GRAPH ROOT)
    (CL:SETQ ITER-000 (%%REST ITER-000))))
...
(CL:DEFUN HELP-CREATE-TAXONOMY-TREE-INTERVALS (SELF)
  (CL:LET* ((MINCHILDLABEL NULL-INTEGER) (MYLABEL NULL-INTEGER) (PREVPOSTNUMBER *TAXONOMY-POSTORDER-NUMBER*))
   ...
   (CL:WHEN (CL:NOT (CL:EQ (%TREE-CHILDREN SELF) NIL))
    (CL:SETQ MINCHILDLABEL (HELP-CREATE-TAXONOMY-TREE-INTERVALS (%%VALUE (%TREE-CHILDREN SELF)))))
   (CL:LET* ((CHILD NULL) (ITER-000 (%%REST (%TREE-CHILDREN SELF))))
    (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-000 NIL)) DO (CL:SETQ CHILD (%%VALUE ITER-000))
     (HELP-CREATE-TAXONOMY-TREE-INTERVALS CHILD) (CL:SETQ ITER-000 (%%REST ITER-000))))
   (CL:SETQ *TAXONOMY-POSTORDER-NUMBER* (CL:+ *TAXONOMY-POSTORDER-NUMBER* *NUMBERING-INTERVAL*))
   (CL:SETQ MYLABEL *TAXONOMY-POSTORDER-NUMBER*)
   (CL:WHEN (CL:EQ (%TREE-CHILDREN SELF) NIL) (CL:SETQ MINCHILDLABEL (CL:1+ PREVPOSTNUMBER)))
   (CL:SETF (%INITIAL-INTERVAL SELF) (INTERN-TAXONOMY-NODE-INTERVAL SELF MINCHILDLABEL MYLABEL))
   (CL:SETF (%LABEL SELF) MYLABEL) (CL:RETURN-FROM HELP-CREATE-TAXONOMY-TREE-INTERVALS MINCHILDLABEL)))

;;; (DEFUN CREATE-TAXONOMY-TREE-INTERVALS ...)

(CL:DEFUN CREATE-TAXONOMY-TREE-INTERVALS (GRAPH)
  (CL:LET* ((*TAXONOMY-POSTORDER-NUMBER* 0)) (CL:DECLARE (CL:SPECIAL *TAXONOMY-POSTORDER-NUMBER*))
   (CL:DECLARE (CL:TYPE CL:FIXNUM *TAXONOMY-POSTORDER-NUMBER*))
   (CL:LET* ((ROOT NULL) (ITER-000 (%THE-CONS-LIST (%ROOTS GRAPH))))
    (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-000 NIL)) DO (CL:SETQ ROOT (%%VALUE ITER-000))
     (HELP-CREATE-TAXONOMY-TREE-INTERVALS ROOT) (CL:SETQ ITER-000 (%%REST ITER-000))))
...
(CL:DEFUN SUBINTERVAL-OF? (SUBINTERVAL SUPERINTERVAL)
  (CL:RETURN-FROM SUBINTERVAL-OF?
   (CL:AND (CL:<= (%UPPER-BOUND SUBINTERVAL) (%UPPER-BOUND SUPERINTERVAL))
...
(CL:DEFUN MERGE-INTERVALS (LEFTINTERVAL RIGHTINTERVAL)
  (CL:LET* ((SELF-000 (NEW-INTERVAL))) (CL:SETF (%LOWER-BOUND SELF-000) (%LOWER-BOUND LEFTINTERVAL))
...
(CL:DEFUN INTERN-TAXONOMY-NODE-INTERVAL (NODE LOWERBOUND UPPERBOUND)
  ...
  (CL:LET* ((SELF-000 (NEW-INTERVAL))) (CL:SETF (%LOWER-BOUND SELF-000) LOWERBOUND)
   (CL:SETF (%UPPER-BOUND SELF-000) UPPERBOUND)
   (CL:LET* ((INTERVAL SELF-000)) (ADD-TAXONOMY-NODE-INTERVAL NODE INTERVAL)
...
(CL:DEFUN REMOVE-TAXONOMY-NODE-INTERVAL (NODE INTERVAL)
  (CL:LET* ((INTERVALS (%INTERVALS NODE))) (CL:SETQ INTERVALS (CL:SETF (%INTERVALS NODE) (REMOVE INTERVALS INTERVAL)))
   (CL:COND
    ((CL:EQ INTERVALS NIL) (CL:SETF (%FIRST-INTERVAL-LOWER-BOUND NODE) -1)
     (CL:SETF (%FIRST-INTERVAL-UPPER-BOUND NODE) -1))
     ...
     (CL:IF (CL:< (%LOWER-BOUND INT) (%LOWER-BOUND INTERVAL))
      (CL:IF (CL:>= (%UPPER-BOUND INT) (%UPPER-BOUND INTERVAL)) (CL:RETURN-FROM ADJOIN-TAXONOMY-NODE-INTERVAL? CL:NIL)
       (CL:WHEN (CL:<= (%LOWER-BOUND INTERVAL) (CL:1+ (%UPPER-BOUND INT))) (REMOVE-TAXONOMY-NODE-INTERVAL NODE INT)
        (ADJOIN-TAXONOMY-NODE-INTERVAL? NODE (MERGE-INTERVALS INT INTERVAL))
      ...
      (CL:IF (CL:>= (%UPPER-BOUND INTERVAL) (%UPPER-BOUND INT))
       ...
       (CL:WHEN (CL:<= (%LOWER-BOUND INT) (CL:1+ (%UPPER-BOUND INTERVAL))) (REMOVE-TAXONOMY-NODE-INTERVAL NODE INT)
        (ADJOIN-TAXONOMY-NODE-INTERVAL? NODE (MERGE-INTERVALS INTERVAL INT))
        (CL:RETURN-FROM ADJOIN-TAXONOMY-NODE-INTERVAL? CL:T))))
     (CL:SETQ ITER-000 (%%REST ITER-000))))
   (CL:LET* ((INT NULL) (ITER-001 INTERVALSTOREMOVE))
    (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-001 NIL)) DO (CL:SETQ INT (%%VALUE ITER-001))
     (REMOVE-TAXONOMY-NODE-INTERVAL NODE INT) (CL:SETQ ITER-001 (%%REST ITER-001))))
...
(CL:DEFUN UNCOMPUTE-TOTAL-ANCESTORS (NODE)
  ...
  (CL:SETF (%TOTAL-ANCESTORS NODE) -1)
  (CL:LET* ((CHILD NULL) (ITER-000 (%CHILDREN NODE)))
   (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-000 NIL)) DO (CL:SETQ CHILD (%%VALUE ITER-000)) (UNCOMPUTE-TOTAL-ANCESTORS CHILD)
    (CL:SETQ ITER-000 (%%REST ITER-000))))
  :VOID)
  ...
  (CL:LET* ((TOTALANCESTORS 0) (PARENTANCESTORS 0)) (CL:DECLARE (CL:TYPE CL:FIXNUM TOTALANCESTORS PARENTANCESTORS))
   (CL:LET* ((PARENT NULL) (ITER-000 (%PARENTS NODE)))
    (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-000 NIL)) DO (CL:SETQ PARENT (%%VALUE ITER-000))
     ...
     (CL:WHEN (CL:< PARENTANCESTORS 0) (CL:RETURN-FROM HELP-COMPUTE-TOTAL-ANCESTORS))
     (CL:SETQ TOTALANCESTORS (CL:+ TOTALANCESTORS PARENTANCESTORS)) (CL:SETQ ITER-000 (%%REST ITER-000))))
   (CL:SETF (%TOTAL-ANCESTORS NODE) (CL:1+ TOTALANCESTORS))
   (CL:LET* ((CHILD NULL) (ITER-001 (%CHILDREN NODE)))
    (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-001 NIL)) DO (CL:SETQ CHILD (%%VALUE ITER-001))
     (HELP-COMPUTE-TOTAL-ANCESTORS CHILD) (CL:SETQ ITER-001 (%%REST ITER-001)))))
  :VOID)
...
(CL:DEFUN CREATE-TAXONOMY-SPANNING-TREE (GRAPH NODE)
  ...
  (CL:LET* ((MAXPARENT NULL) (MAXPARENTVALUE NULL-INTEGER)) (CL:DECLARE (CL:TYPE CL:FIXNUM MAXPARENTVALUE))
   (CL:LET* ((PARENT NULL) (ITER-000 (%PARENTS NODE)))
    (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-000 NIL)) DO (CL:SETQ PARENT (%%VALUE ITER-000))
     (CL:WHEN (CL:OR (CL:= MAXPARENTVALUE NULL-INTEGER) (CL:> (%TOTAL-ANCESTORS PARENT) MAXPARENTVALUE))
      (CL:SETQ MAXPARENT PARENT) (CL:SETQ MAXPARENTVALUE (%TOTAL-ANCESTORS PARENT)))
     (CL:SETQ ITER-000 (%%REST ITER-000))))
   (CL:LET* ((PARENT NULL) (ITER-001 (%PARENTS NODE)))
    (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-001 NIL)) DO (CL:SETQ PARENT (%%VALUE ITER-001))
     (CL:IF (CL:EQ PARENT MAXPARENT) (CL:SETF (%TREE-CHILDREN PARENT) (CONS NODE (%TREE-CHILDREN PARENT)))
   ...
   (CL:LET* ((CHILD NULL) (ITER-002 (%CHILDREN NODE)))
    (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-002 NIL)) DO (CL:SETQ CHILD (%%VALUE ITER-002))
     (CREATE-TAXONOMY-SPANNING-TREE GRAPH CHILD) (CL:SETQ ITER-002 (%%REST ITER-002)))))
  :VOID)
...
(CL:DEFUN CREATE-TAXONOMY-SPANNING-FOREST (GRAPH)
  ...
  (CL:SETF (%INCREMENTAL-MODE? GRAPH) CL:NIL)
  (CL:LET* ((ROOT NULL) (ITER-000 (%THE-CONS-LIST (%ROOTS GRAPH))))
   (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-000 NIL)) DO (CL:SETQ ROOT (%%VALUE ITER-000)) (COMPUTE-TOTAL-ANCESTORS ROOT)
    (CREATE-TAXONOMY-SPANNING-TREE GRAPH ROOT) (CL:SETQ ITER-000 (%%REST ITER-000))))
  ...
  (CL:LET* ((LINK NULL) (ITER-001 (%THE-CONS-LIST (%BROKEN-LINKS GRAPH))))
   (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-001 NIL)) DO (CL:SETQ LINK (%%VALUE ITER-001))
    (PROPAGATE-FOREIGN-INTERVAL (%%VALUE LINK) (%INITIAL-INTERVAL (%%VALUE (%%REST LINK))))
    (CL:SETQ ITER-001 (%%REST ITER-001))))
  (CLEAR (%BROKEN-LINKS GRAPH))
...
(CL:DEFUN FINALIZE-TAXONOMY-GRAPH (GRAPH)
  ...
  (CL:COND
   ((CL:AND (%INCREMENTAL-MODE? GRAPH) (CL:> (%NUMBER-OF-NODES GRAPH) 0)
     (CL:<
      (CL:/ (CL:FLOAT (MAX (%NUMBER-OF-FOREIGN-INTERVAL-NODES GRAPH) (LENGTH (%ADDED-LINKS GRAPH))) 0.0d0)
       (%NUMBER-OF-NODES GRAPH))
      (%RENUMBER-RATIO GRAPH)))
    (CL:LET* ((LINK NULL) (ITER-000 (%THE-CONS-LIST (%ADDED-LINKS GRAPH))))
     (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-000 NIL)) DO (CL:SETQ LINK (%%VALUE ITER-000))
      (INCREMENTALLY-LINK-TAXONOMY-NODES GRAPH (%%VALUE LINK) (%%VALUE (%%REST LINK)))
      (CL:SETQ ITER-000 (%%REST ITER-000))))
   ...
   (CL:T (CL:SETF (%INCREMENTAL-MODE? GRAPH) CL:NIL)
    (CL:LET* ((LINK NULL) (ITER-001 (%THE-CONS-LIST (%ADDED-LINKS GRAPH))))
     (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-001 NIL)) DO (CL:SETQ LINK (%%VALUE ITER-001))
      (LINK-TAXONOMY-NODES GRAPH (%%VALUE LINK) (%%VALUE (%%REST LINK))) (CL:SETQ ITER-001 (%%REST ITER-001))))
...
(CL:DEFUN TAXONOMY-SUBNODE-OF? (SUB-NODE SUPER-NODE)
  ...
  (CL:LET* ((SUB-NODE-LABEL (%LABEL SUB-NODE))) (CL:DECLARE (CL:TYPE CL:FIXNUM SUB-NODE-LABEL))
   (CL:LET* ((INTERVAL NULL) (ITER-000 (%INTERVALS SUPER-NODE)))
    (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-000 NIL)) DO (CL:SETQ INTERVAL (%%VALUE ITER-000))
     (CL:WHEN (CL:AND (CL:>= SUB-NODE-LABEL (%LOWER-BOUND INTERVAL)) (CL:<= SUB-NODE-LABEL (%UPPER-BOUND INTERVAL)))
...
(CL:DEFUN SLOW-TAXONOMY-SUBNODE-OF? (SUBNODE SUPERNODE)
  ...
  (CL:LET* ((PARENT NULL) (ITER-000 (%PARENTS SUBNODE)))
   (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-000 NIL)) DO (CL:SETQ PARENT (%%VALUE ITER-000))
    (CL:WHEN (SLOW-TAXONOMY-SUBNODE-OF? PARENT SUPERNODE) (CL:RETURN-FROM SLOW-TAXONOMY-SUBNODE-OF? CL:T))
    (CL:SETQ ITER-000 (%%REST ITER-000))))
...
(CL:DEFUN PRINT-TAXONOMY-TREE (NODE INDENT STREAM)
  ...
  (CL:LET* ((CHILD NULL) (ITER-001 (%CHILDREN NODE)))
   (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-001 NIL)) DO (CL:SETQ CHILD (%%VALUE ITER-001))
    (PRINT-TAXONOMY-TREE CHILD (CL:+ INDENT 2) STREAM) (CL:SETQ ITER-001 (%%REST ITER-001))))
  :VOID)
...
(CL:DEFUN PRINT-TAXONOMY-GRAPH (GRAPH STREAM)
  (CL:LET* ((ROOT NULL) (ITER-000 (%THE-CONS-LIST (%ROOTS GRAPH))))
   (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-000 NIL)) DO (CL:SETQ ROOT (%%VALUE ITER-000))
    (PRINT-TAXONOMY-TREE ROOT 0 STREAM) (%%PRINT-STREAM (%NATIVE-STREAM STREAM) EOL)
    (CL:SETQ ITER-000 (%%REST ITER-000))))
  :VOID)
...
(CL:DEFUN PRINT-TAXONOMY-SPANNING-TREE (NODE INDENT STREAM)
  ...
  (CL:LET* ((CHILD NULL) (ITER-001 (%TREE-CHILDREN NODE)))
   (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-001 NIL)) DO (CL:SETQ CHILD (%%VALUE ITER-001))
    (PRINT-TAXONOMY-SPANNING-TREE CHILD (CL:+ INDENT 2) STREAM) (CL:SETQ ITER-001 (%%REST ITER-001))))
  :VOID)
...
(CL:DEFUN PRINT-TAXONOMY-SPANNING-FOREST (GRAPH STREAM)
  (CL:LET* ((ROOT NULL) (ITER-000 (%THE-CONS-LIST (%ROOTS GRAPH))))
   (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-000 NIL)) DO (CL:SETQ ROOT (%%VALUE ITER-000))
    (PRINT-TAXONOMY-SPANNING-TREE ROOT 0 STREAM) (%%PRINT-STREAM (%NATIVE-STREAM STREAM) EOL)
    (CL:SETQ ITER-000 (%%REST ITER-000))))
  :VOID)
...
(CL:DEFUN STARTUP-TAXONOMIES ()
  (CL:LET* ((*MODULE* *STELLA-MODULE*) (*CONTEXT* *MODULE*)) (CL:DECLARE (CL:SPECIAL *MODULE* *CONTEXT*))
   (CL:WHEN (CURRENT-STARTUP-TIME-PHASE? 2)
    (CL:SETQ SYM-TAXONOMIES-STELLA-STARTUP-TAXONOMIES (INTERN-RIGID-SYMBOL-WRT-MODULE "STARTUP-TAXONOMIES" NULL 0))
    (CL:SETQ SYM-TAXONOMIES-STELLA-METHOD-STARTUP-CLASSNAME
     (INTERN-RIGID-SYMBOL-WRT-MODULE "METHOD-STARTUP-CLASSNAME" NULL 0)))
   (CL:WHEN (CURRENT-STARTUP-TIME-PHASE? 4) (CL:SETQ *TAXONOMY-POSTORDER-NUMBER* NULL-INTEGER))
...
`root' does not have any parents and is not a `graph' root already.\" :PUBLIC? TRUE)" (CL:FUNCTION ADD-TAXONOMY-ROOT)
     NULL)
...
return an iterator that generates all the graph's nodes.\" :PUBLIC? TRUE)" (CL:FUNCTION ALL-TAXONOMY-NODES) NULL)
    ...
    (DEFINE-METHOD-OBJECT "(DEFMETHOD (DELETED?-SETTER BOOLEAN) ((SELF TAXONOMY-NODE) (VALUE BOOLEAN)))"
...
but retain information about the native object and associated links.\" :PUBLIC? TRUE)"
    ...
    (DEFINE-FUNCTION-OBJECT "HELP-CLEAR-TAXONOMY-GRAPH" "(DEFUN HELP-CLEAR-TAXONOMY-GRAPH ((NODE TAXONOMY-NODE)))"
...
to be reused, they have to be cleared with `initialize-taxonomy-node'.\" :PUBLIC? TRUE)"
    ...
    (DEFINE-FUNCTION-OBJECT "CREATE-TAXONOMY-TREE-INTERVALS"
     "(DEFUN CREATE-TAXONOMY-TREE-INTERVALS ((GRAPH TAXONOMY-GRAPH)))" (CL:FUNCTION CREATE-TAXONOMY-TREE-INTERVALS)
     NULL)
    (DEFINE-METHOD-OBJECT
    ...
    (DEFINE-FUNCTION-OBJECT "UNCOMPUTE-TOTAL-ANCESTORS" "(DEFUN UNCOMPUTE-TOTAL-ANCESTORS ((NODE TAXONOMY-NODE)))"
     (CL:FUNCTION UNCOMPUTE-TOTAL-ANCESTORS) NULL)
    (DEFINE-FUNCTION-OBJECT "HELP-COMPUTE-TOTAL-ANCESTORS"
     "(DEFUN HELP-COMPUTE-TOTAL-ANCESTORS ((NODE TAXONOMY-NODE)))" (CL:FUNCTION HELP-COMPUTE-TOTAL-ANCESTORS) NULL)
    (DEFINE-FUNCTION-OBJECT "COMPUTE-TOTAL-ANCESTORS" "(DEFUN COMPUTE-TOTAL-ANCESTORS ((NODE TAXONOMY-NODE)))"
    ...
    (DEFINE-FUNCTION-OBJECT "CREATE-TAXONOMY-SPANNING-FOREST"
     "(DEFUN CREATE-TAXONOMY-SPANNING-FOREST ((GRAPH TAXONOMY-GRAPH)))" (CL:FUNCTION CREATE-TAXONOMY-SPANNING-FOREST)
     NULL)
    ...
    (DEFINE-FUNCTION-OBJECT "PRINT-TAXONOMY-GRAPH"
     "(DEFUN PRINT-TAXONOMY-GRAPH ((GRAPH TAXONOMY-GRAPH) (STREAM OUTPUT-STREAM)))" (CL:FUNCTION PRINT-TAXONOMY-GRAPH)
     NULL)
    ...
    (DEFINE-FUNCTION-OBJECT "STARTUP-TAXONOMIES" "(DEFUN STARTUP-TAXONOMIES () :PUBLIC? TRUE)"
     (CL:FUNCTION STARTUP-TAXONOMIES) NULL)
    (CL:LET* ((FUNCTION (LOOKUP-FUNCTION SYM-TAXONOMIES-STELLA-STARTUP-TAXONOMIES)))
     (SET-DYNAMIC-SLOT-VALUE (%DYNAMIC-SLOTS FUNCTION) SYM-TAXONOMIES-STELLA-METHOD-STARTUP-CLASSNAME
