...
(CL:DECLAIM
 (CL:SPECIAL NULL-INTEGER-WRAPPER NULL-FLOAT-WRAPPER
  NULL-FUNCTION-CODE-WRAPPER *CURRENTSYSTEMDEFINITION*
  NULL-STRING-WRAPPER *STELLA-MODULE* *STARTUP-TIME-PHASES* NIL-LIST
  *INLININGMETHODCALL?* KEYWORD-SYM SURROGATE-SYM SYMBOL-SYM
  *MIXIN-IMPLEMENTATION-STYLE* NULL-INTEGER *CURRENTFILE*
  *IGNORETRANSLATIONERRORS?* STANDARD-WARNING TRUE-WRAPPER
  FALSE-WRAPPER *MODULE* FALSE TRUE STANDARD-ERROR
  *TRANSLATOROUTPUTLANGUAGE* STANDARD-OUTPUT EOL NIL))
...
(CL:DEFUN PRINT-STELLA-FEATURES ()
  ...
  (CL:LET*
   ((FEATURE NULL)
    (ITER-000 (%THE-CONS-LIST *CURRENT-STELLA-FEATURES*)))
  ...
  (CL:LET*
   ((FEATURE NULL)
    (ITER-001 (%THE-CONS-LIST *AVAILABLE-STELLA-FEATURES*)))
      ...
      (CL:T
       (CL:IF (MEMBER? *AVAILABLE-STELLA-FEATURES* F)
        (CL:LET* ((STREAM-000 (NEW-OUTPUT-STRING-STREAM)))
         (%%PRINT-STREAM (%NATIVE-STREAM STREAM-000) "STELLA feature `"
          F "' is valid but not yet implemented")
         (CL:ERROR
...
(CL:DEFUN RESET-STELLA-FEATURES ()
  ...
  (CL:LET*
   ((F NULL) (ITER-000 (%THE-CONS-LIST *CURRENT-STELLA-FEATURES*)))
   (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-000 NIL)) DO
    (CL:PROGN (CL:SETQ F (%%VALUE ITER-000))
     (CL:SETQ ITER-000 (%%REST ITER-000)))
  ...
  (CL:LET*
   ((F NULL) (ITER-001 (%THE-CONS-LIST *DEFAULT-STELLA-FEATURES*)))
   (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-001 NIL)) DO
...
(CL:DEFUN ACCESS-TRANSLATION-UNIT-SLOT-VALUE (SELF SLOTNAME VALUE SETVALUE?)
  (CL:COND
   ...
   ((CL:EQ SLOTNAME SYM-WALK-STELLA-ANNOTATION)
    (CL:IF SETVALUE?
     (CL:SETF (%ANNOTATION SELF) (%WRAPPER-VALUE VALUE))
...
(CL:DEFUN TRANSLATE-TO-SINGLE-INHERITANCE-LANGUAGE? ()
  (CL:COND
   ...
   (CL:T
    (CL:RETURN-FROM TRANSLATE-TO-SINGLE-INHERITANCE-LANGUAGE? FALSE))))
    ...
    (CL:PROGN (CL:SETQ METHOD (%THE-OBJECT UNIT))
     (CL:COND
      ...
      (CL:T
       (CL:LET*
        ((OTHER-UNIT NULL)
         (ITER-001 (%THE-CONS-LIST *TRANSLATIONUNITS*)))
        (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-001 NIL)) DO
...
(CL:DEFUN PRINT-ERROR-CONTEXT (PREFIX STREAM)
  ...
  (CL:COND
   ...
   (CL:T
    (%%PRINT-STREAM (%NATIVE-STREAM STREAM) "top-level statement")))
  (%%PRINT-STREAM (%NATIVE-STREAM STREAM) ":")
  :VOID)
            ...
            (CL:WHEN (CL:NOT TEST-VALUE-001)
             ...
             (CL:WHEN (CL:NOT TEST-VALUE-001)
              (CL:SETQ TEST-VALUE-001
               (CL:AND
                (CL:NOT (CL:EQ *CURRENTFILE* STELLA::NULL-STRING))
                (CL:OR
...
(CL:DEFUN LOG-FUNCTION-CALL (NAME)
  ...
  (CL:WHEN (CL:NOT (CL:EQ *FUNCTION-CALL-LOG-STREAM* NULL))
   (%%PRINT-STREAM (%NATIVE-STREAM *FUNCTION-CALL-LOG-STREAM*) NAME
    EOL))
...
(CL:DEFUN METHOD-GENSYM (PREFIX)
  ...
  #+MCL
  (CL:CHECK-TYPE PREFIX CL:SIMPLE-STRING)
  (CL:LET* ((METHOD *METHODBEINGWALKED*) (LOCAL? FALSE))
...
(CL:DEFUN MAYBE-RENAME-LOCAL-VARIABLE (VARIABLE)
  (CL:WHEN (CL:EQ *TRANSLATOROUTPUTLANGUAGE* KWD-WALK-JAVA)
   (CL:LET*
    ((CURSOR (%THE-KV-LIST *LOCALVARIABLETYPETABLE*)) (LEVEL -1))
    (CL:DECLARE (CL:TYPE CL:FIXNUM LEVEL))
    (CL:LOOP WHILE (CL:NOT (CL:EQ CURSOR NULL)) DO
     (CL:WHEN (VARIABLE-EQL? (%KEY CURSOR) VARIABLE)
...
(CL:DEFUN HELP-COERCE-A-TREE (TREE SOURCETYPE TARGETTYPE TESTONLY?)
  (CL:LET*
   ...
   (CL:WHEN (CL:EQ TARGETTYPE SGT-WALK-STELLA-UNKNOWN)
    (CL:RETURN-FROM HELP-COERCE-A-TREE
     (CL:VALUES TREE SOURCETYPE TRUE)))
      ...
      (CL:WHEN (CL:NOT (CL:EQ WRAPPERTYPE NULL))
       ...
       (CL:WHEN (CL:NOT (CL:EQ COERSIONFUNCTION NULL))
        ...
        (CL:RETURN-FROM HELP-COERCE-A-TREE
         (CL:VALUES TREE TARGETTYPE TRUE)))))))
   (CL:RETURN-FROM HELP-COERCE-A-TREE
    (CL:VALUES TREE SOURCETYPE FALSE))))
...
(CL:DEFUN COMPUTE-MOST-GENERAL-RETURN-TYPE (METHOD RETURNTYPE)
  (CL:LET*
   ...
   (CL:LOOP WHILE
    ...
    (CL:WHEN
     (CL:NOT
      (CL:EQ (%SLOT-BASE-TYPE MOSTGENERALMETHOD)
       SGT-WALK-STELLA-UNKNOWN))
...
(CL:DEFUN WALK-VARIABLE-DECLARATIONS (DECLARATIONS)
  (CL:LET*
   ((ODECLARATIONS NIL) (VARIABLE NULL) (VRLETENCOUNTERED? FALSE))
    ...
    (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-001 NIL)) DO
     ...
     (CL:WHEN
      (CL:OR (CL:EQ VARIABLE NULL)
       (CL:NOT (%VARIABLE-SPECIAL? VARIABLE)))
      (CL:LET* ((*PRINTREADABLY?* TRUE))
       (CL:DECLARE (CL:SPECIAL *PRINTREADABLY?*))
       (SIGNAL-TRANSLATION-ERROR)
       (CL:WHEN (CL:NOT (SUPPRESS-WARNINGS?))
  ...
  (CL:LET*
   ...
   (SECOND-SETTER TREE
    (WALK-EXPRESSION-TREE (%%VALUE (%%REST TREE))
     SGT-WALK-STELLA-UNKNOWN SYM-WALK-STELLA-CAST TRUE))
      ...
      (CL:WHEN
       (CL:OR (CONS? (%VALUE IT))
        (CL:AND (SYMBOL? (%VALUE IT))
         (CL:NOT
          (CL:EQ (LOOKUP-OLD-VALUE-VARIABLE (%VALUE IT)) NULL))))
       (CL:SETQ VALUEBINDINGS
        (CONS
         (CONS (LOCAL-GENSYM "RETURN-VALUE") (CONS (%VALUE IT) NIL))
         VALUEBINDINGS))
...
(CL:DEFUN WALK-CONDITIONAL-TREE (TREE)
  (CL:LET*
   ((OPERATOR (%%VALUE TREE))
    (TEST
     (WALK-EXPRESSION-TREE (%%VALUE (%%REST TREE))
      SGT-WALK-STELLA-BOOLEAN OPERATOR TRUE)))
   (SECOND-SETTER TREE TEST)
   (CL:WHEN (PROCEDURAL-EXPRESSION? TEST)
       ...
       (CL:WHEN
        ...
        (CL:SETF (%%VALUE CONDITION)
         (WALK-EXPRESSION-TREE (%%VALUE CONDITION)
          SGT-WALK-STELLA-BOOLEAN SYM-WALK-STELLA-COND TRUE))
             ...
             (CL:LET* ((IT (ALLOCATE-ITERATOR TYPETREE)))
              (CL:LOOP WHILE (NEXT? IT) DO
               ...
               (VERIFY-TYPECASE-CLAUSE-TYPE TESTEXPRESSIONTYPE
                (%VALUE IT) PRECEDINGCLAUSETYPES CASETREE)))))
           (CL:T
            (CL:LET* ((*PRINTREADABLY?* TRUE))
             (CL:DECLARE (CL:SPECIAL *PRINTREADABLY?*))
             (SIGNAL-TRANSLATION-ERROR)
      ...
      (CL:LET* ((*PRINTREADABLY?* TRUE))
       ...
       (CL:WHEN (CL:NOT (SUPPRESS-WARNINGS?))
        ...
        (%%PRINT-STREAM (%NATIVE-STREAM STANDARD-WARNING) EOL " Type `"
         (DE-UGLIFY-PARSE-TREE CLAUSETYPE) "' of `typecase' clause "
         EOL "    `" (DE-UGLIFY-PARSE-TREE CLAUSE) "'" EOL
        ...
        (CL:LET* ((VALUE-002 NULL) (VALUE-003 NULL))
         (CL:MULTIPLE-VALUE-SETQ (VALUE-002 VALUE-003)
          (WALK-EXPRESSION-TREE (%%VALUE OPERANDS)
           SGT-WALK-STELLA-NUMBER OPERATOR FALSE))
         (CL:RETURN-FROM WALK-ARITHMETIC-TREE
          (CL:VALUES VALUE-002 VALUE-003))))
       ((CL:OR (CL:EQ TEST-VALUE-001 SYM-WALK-STELLA--)
         (CL:EQ TEST-VALUE-001 SYM-WALK-STELLA-/))
...
(CL:DEFUN WALK-PRINT-STREAM-TREE (TREE)
  ...
  (CL:LET*
   ...
   (CL:LET* ((IT (ALLOCATE-ITERATOR (%%REST (%%REST TREE)))))
    (CL:LOOP WHILE (NEXT? IT) DO
     (CL:MULTIPLE-VALUE-SETQ (OTREE OTYPE)
      (WALK-EXPRESSION-TREE (%VALUE IT) SGT-WALK-STELLA-UNKNOWN
       OPERATOR FALSE))
     (VALUE-SETTER IT OTREE)
    ...
    (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-000 NIL)) DO
     ...
     (CL:WHEN (CL:NOT (CL:EQ (%SURROGATE-VALUE SUB) NULL))
      (CL:IF (%ABSTRACT? (%SURROGATE-VALUE SUB))
       ...
       (CL:SETQ METHOD
        (LOOKUP-SLOT (%SURROGATE-VALUE SUB) METHODNAME)))
      (CL:WHEN
...
(CL:DEFMETHOD FINISH-WALKING-CALL-SLOT-TREE ((SELF METHOD-SLOT) TREE FIRSTARGTYPE)
  (CL:LET*
   ...
   (CL:LET*
    ...
    (CL:LET*
     ((PINDEX NULL-INTEGER) (TARGETTS NULL)
      (ITER-000 (REST PTYPESPECS)) (ITER-001 2)
     ...
     (CL:LOOP WHILE
      ...
      (CL:WHEN
       ...
       (NTH-REST-SETTER TREE (WALK-VARIABLE-ARGUMENTS CURSOR SELF)
        PINDEX)
       (CL:RETURN))
      (CL:SETF (%%VALUE CURSOR)
...
(CL:DEFUN WALK-FIRST-ARGUMENT-TO-FUNCTION (FNSLOT TREE)
  (CL:LET*
   ...
   (CL:WHEN
    ...
    (CL:SETF (%%REST TREE)
     (WALK-VARIABLE-ARGUMENTS (%%REST TREE) FNSLOT))
       ...
       (CL:LET* ((TEST-VALUE-000 (%SLOT-NAME FNSLOT)))
        (CL:COND
         ((CL:EQ TEST-VALUE-000 SYM-WALK-STELLA-GET-SYM)
          (REGISTER-SYMBOL
           (GET-SYM-FROM-OFFSET (%WRAPPER-VALUE OTREE))))
         ((CL:EQ TEST-VALUE-000 SYM-WALK-STELLA-GET-SGT)
          (REGISTER-SYMBOL
           (GET-SGT-FROM-OFFSET (%WRAPPER-VALUE OTREE))))
         ((CL:EQ TEST-VALUE-000 SYM-WALK-STELLA-GET-KWD)
          (REGISTER-SYMBOL
           (GET-KWD-FROM-OFFSET (%WRAPPER-VALUE OTREE))))
         (CL:T)))))
     (CL:T))
  ...
  (CL:LET* ((TEST-VALUE-000 FALSE))
   ...
   (CL:WHEN TEST-VALUE-000
    (CL:LET* ((ALWAYS?-000 TRUE))
     (CL:LET*
      ((SUB NULL)
       (ITER-001 (%THE-CONS-LIST (%CLASS-DIRECT-SUBS CLASS))))
      (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-001 NIL)) DO
   ...
   (CL:LET* ((*INLININGMETHODCALL?* TRUE) (*METHODBEINGWALKED* METHOD))
    ...
    (CL:SETQ BODY
     (WALK-EXPRESSION-TREE BODY (TYPE METHOD)
      SYM-WALK-STELLA-INLINE-CALL TRUE)))
         ...
         (CL:LET* ((ARG NULL) (ITER-000 (%%REST TREE)))
          (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-000 NIL)) DO
           (CL:PROGN (CL:SETQ ARG (%%VALUE ITER-000))
            (CL:SETQ ITER-000 (%%REST ITER-000)))
           (CL:SETQ COST
            (CL:+ COST (ESTIMATED-EVALUATION-COST ARG))))))
        (CL:T)))))
    (CL:T))
    ...
    (CL:WHEN (CL:NOT (CL:EQ BODY NIL))
     ...
     (CL:WHEN
      (CL:AND (CL:NOT (VOID? (TYPE METHOD)))
       (CL:NOT (%ABSTRACT? METHOD)) (CL:NOT *FOUNDRETURN?*))
      (CL:LET* ((*PRINTREADABLY?* TRUE))
       (CL:DECLARE (CL:SPECIAL *PRINTREADABLY?*))
       (SIGNAL-TRANSLATION-ERROR)
       (CL:WHEN (CL:NOT (SUPPRESS-WARNINGS?))
  ...
  (CL:LET* ((METHOD NULL))
   ...
   (CL:COND
    ...
    (CL:T (CL:SETF (%THE-OBJECT *CURRENTTRANSLATIONUNIT*) METHOD)
     (CL:SETF (%CODE-REGISTER *CURRENTTRANSLATIONUNIT*)
      (NTH-REST TREE 3))
...
(CL:DEFUN YIELD-CONSTRUCTOR-ATTACHMENT (CLASS CLASSREF)
  (CL:IF
   (CL:AND (CL:NOT (%ABSTRACT? CLASS)) (CREATE-NATIVE-CLASS? CLASS))
   (CL:LET*
    ((CONSTRUCTORFNCODE
...
(CL:DEFUN CLEANUP-AUXILIARY-METHODS (CLASS)
  (CL:LET*
   ...
   (CL:LET*
    ((METHOD NULL) (ITER-000 (%THE-CONS-LIST AUXILIARYMETHODS)))
    (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-000 NIL)) DO
  ...
  (CL:WHEN (CL:NOT (CL:EQ METHOD NULL))
   (CL:LET*
    ...
    (CL:WHEN (CL:NOT (CL:EQ CLASS NULL))
     ...
     (CL:LET* ((VALUE-000 NULL))
      (CL:LET*
       ((AUX NULL) (ITER-000 (%THE-CONS-LIST AUXILIARYMETHODS)))
       (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-000 NIL)) DO
...
(CL:DEFUN CREATE-SLOT-ACCESSOR-UNITS (CLASS)
  (CL:LET*
   ((SLOT NULL) (ITER-000 (%THE-CONS-LIST (LOCAL-SLOTS CLASS))))
   (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-000 NIL)) DO
    (CL:PROGN (CL:SETQ SLOT (%%VALUE ITER-000))
     (CL:SETQ ITER-000 (%%REST ITER-000)))
    (CL:COND
  ...
  (CL:COND
   ...
   (CL:T
    (CL:LET* ((MIXINMETHODS (NEW-LIST)))
     (CL:LET*
      ...
      (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-001 NIL)) DO
       ...
       (CL:WHEN (%MIXIN? (%SURROGATE-VALUE SUPER))
        (CL:LET*
         ((SLOT NULL)
          (ITER-002 (CLASS-SLOTS (%SURROGATE-VALUE SUPER))))
         (CL:LOOP WHILE (NEXT? ITER-002) DO
          (CL:SETQ SLOT (%VALUE ITER-002))
          (CL:WHEN
     ...
     (CL:LET*
      ((METHOD NULL)
       (ITER-003 (%THE-CONS-LIST (REVERSE MIXINMETHODS))))
      (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-003 NIL)) DO
       ...
       (REGISTER-AUXILIARY-METHOD
        (%THE-OBJECT
         (HELP-WALK-AUXILIARY-TREE
          (YIELD-MIXIN-METHOD-TREE METHOD CLASS) TRUE))
        METHOD))))))
  :VOID)
  ...
  (CL:WHEN
   ...
   (CL:LET* ((TEST-VALUE-000 FALSE))
    ...
    (CL:WHEN TEST-VALUE-000
     (CL:LET* ((FOUND?-000 FALSE))
      (CL:LET*
       ((SUPER NULL) (ITER-000 (%CLASS-ALL-SUPER-CLASSES CLASS)))
       (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-000 NIL)) DO
   ...
   (CL:LET* ((TEST-VALUE-001 FALSE))
    ...
    (CL:WHEN TEST-VALUE-001
     (CL:LET* ((FOUND?-001 FALSE))
      (CL:LET*
       ((SUPER NULL) (ITER-001 (%CLASS-ALL-SUPER-CLASSES CLASS)))
       (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-001 NIL)) DO
        (CL:PROGN (CL:SETQ SUPER (%%VALUE ITER-001))
         (CL:SETQ ITER-001 (%%REST ITER-001)))
        (CL:WHEN
   ...
   (CL:LET*
    ...
    (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-001 NIL)) DO
     (CL:PROGN (CL:SETQ SYNONYM (%%VALUE ITER-001))
      (CL:SETQ ITER-001 (%%REST ITER-001)))
     (REGISTER-SYMBOL
      (INTERN-SYMBOL-IN-MODULE (%SYMBOL-NAME SYNONYM)
       (%HOME-CONTEXT SYNONYM) TRUE)))))
  :VOID)
     ...
     (CL:WHEN (CL:NOT (SYMBOL? NAME))
      (CL:LET* ((*PRINTREADABLY?* TRUE))
       ...
       (CL:WHEN (CL:NOT (SUPPRESS-WARNINGS?))
        (PRINT-ERROR-CONTEXT ">> ERROR: " STANDARD-ERROR)
        (%%PRINT-STREAM (%NATIVE-STREAM STANDARD-ERROR) EOL
         " Illegal macro name: `" (DE-UGLIFY-PARSE-TREE NAME) "'."
         EOL)))
      (CL:RETURN-FROM WALK-DEFMACRO-TREE))
      ...
      (CL:WHEN (CL:> (METHOD-ARGUMENT-COUNT METHOD) 5)
       (CL:LET* ((*PRINTREADABLY?* TRUE))
        ...
        (CL:WHEN (CL:NOT (SUPPRESS-WARNINGS?))
         (PRINT-ERROR-CONTEXT ">> ERROR: " STANDARD-ERROR)
         (%%PRINT-STREAM (%NATIVE-STREAM STANDARD-ERROR) EOL
          " Too many arguments in macro definition, maximum is 5."
          EOL)))
       (CL:SETQ *CURRENTTRANSLATIONUNIT* NULL))))))
  :VOID)
   ...
   (CL:LOOP WHILE (CL:NOT (CL:EQ CURSOR NIL)) DO
    (CL:TAGBODY (CL:SETQ UNITPHASE (%CODE-REGISTER (%%VALUE CURSOR)))
     ...
     (CL:LET*
      ...
      (CL:LET*
       ((I NULL-INTEGER) (IT (ALLOCATE-ITERATOR PHASESTART))
  ...
  (CL:LET*
   ...
   (CL:COND
    ...
    ((CL:NOT (CL:EQ STARTUPFNNAME NULL))
     ...
     (SET-DYNAMIC-SLOT-VALUE
      (%DYNAMIC-SLOTS
       (%THE-OBJECT (HELP-WALK-AUXILIARY-TREE TREE TRUE)))
      SYM-WALK-STELLA-METHOD-STARTUP-CLASSNAME
      (WRAP-STRING (YIELD-STARTUP-FUNCTION-CLASSNAME STARTUPFNNAME))
      NULL-STRING-WRAPPER))
    (CL:T
    ...
    (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-000 NIL)) DO
     ...
     (CL:LET*
      ((VALUEREF NULL) (SLOT NULL)
       (ITER-001 (%THE-PLIST SLOTSANDVALUES)))
      (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-001 NIL)) DO
       ...
       (CL:WHEN (CL:NOT (KEYWORD? (%KEY IT)))
        (CL:LET* ((*PRINTREADABLY?* TRUE))
         ...
         (CL:WHEN (CL:NOT (SUPPRESS-WARNINGS?))
          (PRINT-ERROR-CONTEXT ">> ERROR: " STANDARD-ERROR)
          (%%PRINT-STREAM (%NATIVE-STREAM STANDARD-ERROR) EOL
           " Illegal slot keyword `" (%KEY IT) "' in NEW expression."
           EOL)))
        (CL:RETURN-FROM YIELD-NEW-ARGUMENTS-TREE (CL:VALUES NIL NIL)))
       (CL:SETQ SLOTNAME
       ...
       (CL:IF (CL:EQ COLLECT-000 NULL)
        (CL:PROGN
         (CL:SETQ COLLECT-000
          (CONS
           (LIST* SYM-WALK-STELLA-SETF
            (CONS (%SLOT-NAME SLOT) (CONS SELFVARIABLE NIL)) VALUEREF
            NIL)
           NIL))
...
(CL:DEFUN WALK-MAKE-TREE (TREE)
  (CL:LET*
   ...
   (CL:SETQ CLASS (%SURROGATE-VALUE TYPE))
   (CL:WHEN (CL:EQ CLASS NULL)
    (CL:LET* ((*PRINTREADABLY?* TRUE))
     (CL:DECLARE (CL:SPECIAL *PRINTREADABLY?*))
     (SIGNAL-TRANSLATION-ERROR)
       ...
       ((CL:OR (CL:EQ *TRANSLATOROUTPUTLANGUAGE* KWD-WALK-CPP)
        ...
        (CL:LET* ((*PRINTREADABLY?* TRUE))
         ...
         (CL:WHEN (CL:NOT (SUPPRESS-WARNINGS?))
          (PRINT-ERROR-CONTEXT ">> ERROR: " STANDARD-ERROR)
          (%%PRINT-STREAM (%NATIVE-STREAM STANDARD-ERROR) EOL
           " Cannot generate a function pointer to `main' in C++."
           EOL)))
        (CL:RETURN-FROM WALK-THE-CODE-TREE
         (WALK-DONT-CALL-ME-TREE TREE SGT-WALK-STELLA-FUNCTION-CODE)))
       (CL:T
   ...
   (CL:IF (CL:<= INDEX LIMIT)
    (CL:LET*
     ...
     (CL:LOOP WHILE
      ...
      (CL:SETQ I I)
      (CL:SETQ ACCESSTREE
       (LIST* SYM-WALK-STELLA-REST ACCESSTREE NIL))))
    (CL:SETQ ACCESSTREE
...
confirmation with the user.\" :PUBLIC? TRUE)"
    (CL:FUNCTION BREAK-PROGRAM) NULL)
...
evaluation strategies.\" :PUBLIC? TRUE)" (CL:FUNCTION TRY-TO-EVALUATE)
   ...
   (CL:LET* ((FUNCTION (LOOKUP-FUNCTION SYM-WALK-STELLA-STARTUP-WALK)))
    (SET-DYNAMIC-SLOT-VALUE (%DYNAMIC-SLOTS FUNCTION)
     SYM-WALK-STELLA-METHOD-STARTUP-CLASSNAME
     (WRAP-STRING "_Startup-Walk") NULL-STRING-WRAPPER)))
  :VOID)
