...
(CL:DECLAIM
 (CL:SPECIAL NULL-INTEGER-WRAPPER NULL-LONG-INTEGER-WRAPPER NULL-FLOAT-WRAPPER
  NULL-FUNCTION-CODE-WRAPPER *CURRENTSYSTEMDEFINITION* *STELLA-MODULE*
  *STARTUP-TIME-PHASES* NIL-LIST NULL-STRING-WRAPPER *INLININGMETHODCALL?*
  KEYWORD-SYM SURROGATE-SYM SYMBOL-SYM *MIXIN-IMPLEMENTATION-STYLE*
  *CURRENTFILE* *IGNORETRANSLATIONERRORS?* STANDARD-WARNING TRUE-WRAPPER
  FALSE-WRAPPER *MEMOIZATION-ENABLED?* MEMOIZED-NULL-VALUE *MODULE*
  NULL-INTEGER STANDARD-ERROR *TRANSLATOROUTPUTLANGUAGE* STANDARD-OUTPUT EOL
  NIL))
...
(CL:DEFUN PRINT-STELLA-FEATURES ()
  ...
  (%%PRINT-STREAM (%NATIVE-STREAM STANDARD-OUTPUT) "Enabled STELLA features:"
   EOL)
  (CL:LET*
   ((FEATURE NULL) (ITER-000 (%THE-CONS-LIST *CURRENT-STELLA-FEATURES*)))
   ...
   (CL:RETURN-FROM TRACE-IF
    (LIST* SYM-WALK-STELLA-WHEN
     (LIST* SYM-WALK-STELLA-AND
      (LIST* SYM-WALK-STELLA-DEFINED? SYM-WALK-STELLA-*TRACED-KEYWORDS* NIL)
      TEST NIL)
     ...
     (CONCATENATE
      (CL:IF
       ...
       NIL
       (CONS
        (LIST* SYM-WALK-STELLA-FLUSH-OUTPUT SYM-WALK-STELLA-STANDARD-OUTPUT
         NIL)
        NIL))
      NIL)))))
     ...
     (CL:IF (CONS? KEYWORD)
      (CL:LET* ((FOUND?-000 CL:NIL))
       (CL:LET* ((KWD NULL) (ITER-000 KEYWORD))
        (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-000 NIL)) DO
         (CL:SETQ KWD (%%VALUE ITER-000))
         (CL:WHEN (MEMB? *TRACED-KEYWORDS* KWD) (CL:SETQ FOUND?-000 CL:T)
          (CL:RETURN))
         (CL:SETQ ITER-000 (%%REST ITER-000))))
...
`speed', and `space'."
  ...
  (CL:WHEN
   (CL:AND (CL:NOT (CL:= DEBUG NULL-INTEGER)) (CL:>= DEBUG 0) (CL:<= DEBUG 3))
   (CL:SETQ *DEBUGLEVEL* DEBUG))
  (CL:WHEN
   (CL:AND (CL:NOT (CL:= SPEED NULL-INTEGER)) (CL:>= SPEED 0) (CL:<= SPEED 3))
   (CL:SETQ *OPTIMIZESPEEDLEVEL* SPEED))
  (CL:WHEN
   (CL:AND (CL:NOT (CL:= SPACE NULL-INTEGER)) (CL:>= SPACE 0) (CL:<= SPACE 3))
...
(CL:DEFUN NAME-QUOTED-TREE (TREE)
  (CL:LET*
   ((NAMETREE
     (CONS TREE (CONS (WRAP-STRING (%MODULE-FULL-NAME *MODULE*)) NIL)))
  ...
  (CL:LET*
   ...
   (CL:WHEN *MEMOIZATION-ENABLED?*
    (CL:SETQ MEMO-TABLE-000
     (%SURROGATE-VALUE SGT-WALK-STELLA-F-GET-QUOTED-TREE-MEMO-TABLE-000))
...
(CL:DEFCLASS TRANSLATION-UNIT (STANDARD-OBJECT)
  ((TU-HOME-MODULE :ALLOCATION :INSTANCE :ACCESSOR %TU-HOME-MODULE)
   ...
   (ANNOTATION :TYPE CL:SIMPLE-STRING :INITFORM STELLA::NULL-STRING
    :ALLOCATION :INSTANCE :ACCESSOR %ANNOTATION)
...
(CL:DEFUN HELP-WALK-AUXILIARY-TREE (TREE FINALIZE?)
  ...
  (CL:LET* ((UNIT (POP *TRANSLATIONUNITS*))) (CL:SETF (%AUXILIARY? UNIT) CL:T)
     ...
     (CL:LET*
      ...
      (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-000 NIL)) DO
       ...
       (CL:IF (CL:EQ COLLECT-000 NULL)
        ...
        (CL:PROGN
         (CL:SETF (%%REST COLLECT-000) (CONS (%TRANSLATION UNIT) NIL))
         (CL:SETQ COLLECT-000 (%%REST COLLECT-000))))
       (CL:SETQ ITER-000 (%%REST ITER-000)))))
    ((CL:OR (CL:EQ *TRANSLATOROUTPUTLANGUAGE* KWD-WALK-JAVA)
      (CL:EQ *TRANSLATOROUTPUTLANGUAGE* KWD-WALK-JAVA-STANDALONE))
      ...
      (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-001 NIL)) DO
       ...
       (CL:WHEN (CL:NOT (UNIT-INCLUDED-IN-OTHER-UNITS? UNIT))
        (CL:IF (CL:EQ COLLECT-001 NULL)
         ...
         (CL:PROGN
          (CL:SETF (%%REST COLLECT-001) (CONS (%TRANSLATION UNIT) NIL))
...
(CL:DEFUN SUMMARIZE-TRANSLATION-ERRORS ()
  (CL:WHEN (CL:> *TRANSLATIONERRORS* 0)
   (%%PRINT-STREAM (%NATIVE-STREAM STANDARD-OUTPUT) *TRANSLATIONERRORS*
    " error")
  ...
  (CL:WHEN (CL:> *TRANSLATIONNOTES* 0)
   (CL:WHEN
    ...
    (%%PRINT-STREAM (%NATIVE-STREAM STANDARD-OUTPUT) ", "))
   (%%PRINT-STREAM (%NATIVE-STREAM STANDARD-OUTPUT) *TRANSLATIONNOTES*
    " note")
             ...
             (CL:WHEN (CL:NOT TEST-VALUE-001)
              (CL:SETQ TEST-VALUE-001
               (CL:AND (CL:NOT (CL:EQ *CURRENTFILE* STELLA::NULL-STRING))
                (CL:OR
                 (CL:NOT
                  (CL:= (STRING-SEARCH *CURRENTFILE* "cl-primal" 0)
                   NULL-INTEGER))
                 (CL:NOT
                  (CL:= (STRING-SEARCH *CURRENTFILE* "stella-to-cl" 0)
                   NULL-INTEGER))))))))))))
     ...
     (CL:PROGN
      (CL:RETURN-FROM APPLY-COERCION-METHOD
       (WALK-EXPRESSION-TREE (CONS COERCIONMETHOD (CONS EXPRESSION NIL))
        TARGETTYPE COERCIONMETHOD CL:NIL))))
    ((CL:EQ TEST-VALUE-000 SGT-WALK-STELLA-CONS)
     (CL:PROGN
      (CL:RETURN-FROM APPLY-COERCION-METHOD
...
(CL:DEFUN VERIFY-TYPE (SELF)
  (CL:WHEN
   ...
   (CL:SETF (%SURROGATE-VALUE SELF)
    (%SURROGATE-VALUE SGT-WALK-STELLA-UNKNOWN)))
  (CL:WHEN
   (CL:AND (TRANSLATING-CODE?)
    (CL:OR (CL:EQ (%SURROGATE-VALUE SELF) NULL)
     (CL:EQ (%SURROGATE-VALUE SELF)
      (%SURROGATE-VALUE SGT-WALK-STELLA-UNKNOWN))))
   (CL:LET* ((*PRINTREADABLY?* CL:T))
   ...
   (CL:WHEN (CL:EQ SOURCETYPE SGT-WALK-STELLA-UNKNOWN)
    ...
    (CL:IF
     ...
     (CL:RETURN-FROM HELP-COERCE-A-TREE
      (CL:VALUES (TYPE-TO-WALKED-NULL-VALUE-TREE TARGETTYPE TARGETBASETYPE)
       TARGETTYPE CL:T))
   ...
   ((WALKEDTREE
     (WALK-A-TREE
      (LIST* SYM-WALK-STELLA-LET
       (CONS (LIST* SYM-WALK-STELLA-X (COPY-CONS-TREE EXPRESSION) NIL) NIL)
       NIL)))
...
(CL:DEFUN COMPUTE-MOST-GENERAL-RETURN-TYPE (METHOD RETURNTYPE)
  (CL:LET* ((MOSTGENERALRETURNTYPE RETURNTYPE) (MOSTGENERALMETHOD METHOD))
   (CL:LOOP WHILE
    ...
    (CL:WHEN
     (CL:NOT
      (CL:EQ (%SLOT-BASE-TYPE MOSTGENERALMETHOD) SGT-WALK-STELLA-UNKNOWN))
       ...
       (CL:LET* ((FOUND?-000 CL:NIL))
        (CL:LET*
         ...
         (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-000 NIL)) DO
          ...
          (CL:WHEN (ANCHORED-TYPE-SPECIFIER? TS) (CL:SETQ FOUND?-000 CL:T)
           (CL:RETURN))
          (CL:SETQ ITER-000 (%%REST ITER-000))))
        (CL:SETQ TEST-VALUE-001 FOUND?-000))))
     (CL:WHEN TEST-VALUE-001
...
(CL:DEFUN YIELD-SYMBOL-CONSTANT-NAME (SYMBOL)
  (CL:RETURN-FROM YIELD-SYMBOL-CONSTANT-NAME
   (INTERN-SYMBOL-IN-MODULE
    (CONSTRUCT-SYMBOL-CONSTANT-NAME (PERMANENTIFY SYMBOL)) *MODULE* CL:T)))
...
(CL:DEFUN CLEAR-SYMBOL-REGISTRY ()
  (CL:LET* ((SYMBOL NULL) (ITER-000 (%THE-CONS-LIST *SYMBOL-SET*)))
   (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-000 NIL)) DO
    (CL:SETQ SYMBOL (%%VALUE ITER-000)) (REMOVE-AT *SYMBOL-REGISTRY* SYMBOL)
    (CL:SETQ ITER-000 (%%REST ITER-000))))
  (CLEAR *SYMBOL-SET*)
  :VOID)
...
(CL:DEFUN YIELD-HARDCODED-INTERN-REGISTERED-SYMBOLS-TREE ()
  (CL:LET*
   ...
   (CL:LET*
    ((SYMBOL NULL) (ITER-000 (%THE-CONS-LIST *SYMBOL-SET*))
     (COLLECT-000 NULL))
    (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-000 NIL)) DO
     ...
     (CL:LET* ((FOUND?-000 CL:NIL))
      (CL:LET* ((TERM NULL) (ITER-000 (%%REST TREE)))
       (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-000 NIL)) DO
        ...
        (CL:WHEN (PROCEDURAL-EXPRESSION? TERM) (CL:SETQ FOUND?-000 CL:T)
         (CL:RETURN))
        (CL:SETQ ITER-000 (%%REST ITER-000))))
...
(CL:DEFUN HELP-TRANSFORM-BOOLEAN-PROCEDURAL-EXPRESSION (EXPRESSION TESTVARIABLE)
  (CL:WHEN
   ...
   (CL:RETURN-FROM HELP-TRANSFORM-BOOLEAN-PROCEDURAL-EXPRESSION
    (CONS (LIST* SYM-WALK-STELLA-SETQ TESTVARIABLE (CONS EXPRESSION NIL))
     NIL)))
  (CL:LET*
   ((EXP EXPRESSION) (OPERATOR (%%VALUE EXP))
    (FIRSTARG (%%VALUE (%%REST EXP))) (OTHERARGS (%%REST (%%REST EXP))))
...
(CL:DEFUN WALK-SETQ-TREE (TREE)
  ...
  (CL:LET*
   ((VARIABLE (%%VALUE (%%REST TREE)))
    (VALUE (%%VALUE (%%REST (%%REST TREE)))) (VARIABLETYPE NULL) (OVALUE NULL)
    (OTYPE NULL))
   ...
   (CL:MULTIPLE-VALUE-SETQ (OVALUE OTYPE)
    (WALK-EXPRESSION-TREE VALUE VARIABLETYPE SYM-WALK-STELLA-SETQ CL:T))
        ...
        (CL:PROGN
         (CL:WHEN
          (CL:OR (CL:NOT (CL:EQ (WRITER SLOT) NULL))
           (CL:NOT
            (CL:EQ
             (LOOKUP-SLOT OBJECTCLASS (YIELD-SETTER-METHOD-NAME SLOTNAME))
             NULL)))
          (CL:RETURN-FROM WALK-SETF-TREE
           (WALK-A-CONS-TREE
            (CONS
        ...
        (LIST* SYM-WALK-STELLA-WHEN
         ...
         (LIST* SYM-WALK-STELLA-SETF
          ...
          (LIST* SYM-WALK-STELLA-KV-CONS
           ...
           (CONS
            (LIST* SYM-WALK-STELLA-THE-KV-LIST SYM-WALK-STELLA-DYNAMICSLOTS
             NIL)
            NIL))
          NIL)
         NIL)
...
(CL:DEFUN WALK-AREF-TREE (TREE)
  (CL:LET*
     ...
     (CL:LET* ((ALWAYS?-000 CL:T))
      (CL:LET*
       ...
       (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-000 NIL)) DO
        ...
        (CL:WHEN (CL:EQ DIM NULL) (CL:SETQ ALWAYS?-000 CL:NIL) (CL:RETURN))
        (CL:SETQ ITER-000 (%%REST ITER-000))))
   ...
   (CL:WHEN (CL:EQ OPERATOR SYM-WALK-STELLA-AREF-SETTER)
    (CL:MULTIPLE-VALUE-SETQ (OTREE OTYPE)
     (WALK-EXPRESSION-TREE (%%VALUE ARGUMENTS) ELEMENTTYPE OPERATOR CL:T))
        ...
        (CL:PROGN
         (CL:COND
          ...
          (CL:T (CL:SETQ VARIABLE (%%VALUE DECL))
           (CL:WHEN
            (CL:OR (CL:NOT (CL:EQ (LOOKUP-GLOBAL-VARIABLE VARIABLE) NULL))
         ...
         (CL:CASE (LENGTH DECL)
          ...
          (2
           ...
           (CL:SETQ ODECLARATIONS
            (CONS
             (WALK-A-DECLARATION VARIABLE NULL (%%VALUE (%%REST DECL)) CL:NIL)
             ODECLARATIONS)))
          (3
           (CL:SETQ ODECLARATIONS
            (CONS
...
(CL:DEFUN WALK-LET-TREE (TREE)
  ...
  (CL:LET*
   ((ORIGINALDECLARATIONS (%%VALUE (%%REST TREE))) (LEADINGDECLARATIONS NIL)
    (TRAILINGDECLARATIONS NIL) (LEADING? CL:T))
...
(CL:DEFUN SPECIAL-IMPLEMENTATION-STYLE ()
  (CL:COND
   ...
   ((CL:EQ *TRANSLATOROUTPUTLANGUAGE* KWD-WALK-JAVA)
    (CL:RETURN-FROM SPECIAL-IMPLEMENTATION-STYLE KWD-WALK-COMMON-LISP))
   (CL:T
    (CL:RETURN-FROM SPECIAL-IMPLEMENTATION-STYLE KWD-WALK-UNWIND-PROTECT))))
     ...
     (CL:LET*
      ...
      (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-000 NULL)) DO
       ...
       (CL:WHEN (CL:>= (CL:SETQ NOFBINDINGS (CL:1- NOFBINDINGS)) 0)
        ...
        (CL:SETQ OTREE
         (CONS
          (LIST* SYM-WALK-STELLA-SETQ VARIABLE (CONS OLDVALUEVARIABLE NIL))
          OTREE)))
       (CL:SETQ ITER-000 (%REST ITER-000))))
...
(CL:DEFUN WALK-UNWIND-PROTECT-SPECIAL-TREE (TREE)
  (CL:LET*
   ...
   (CL:LET* ((BINDING NULL) (ITER-000 BINDINGS))
    (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-000 NIL)) DO
     (CL:SETQ BINDING (%%VALUE ITER-000)) (CL:SETQ VARIABLE (%%VALUE BINDING))
     (CL:SETQ BINDTREES
      (CONS
...
(CL:DEFUN COERCE-MV-TREE (TREE OPERATOR SOURCETYPES TARGETTYPES)
  (CL:LET*
   ((VALUESTREE? (VALUES-TREE? TREE)) (VALUESTREE NIL)
    (NEEDTEMPORARIES? CL:NIL) (SUCCESS? CL:NIL) (OTREE NULL) (OTYPE NULL)
    ...
    (CL:T (CL:SETQ VALUESTREE (CONS SYM-WALK-STELLA-VALUES NIL))
     (CL:LET*
      ...
      (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-000 NIL)) DO
       ...
       (CL:SETQ ITER-000 (%%REST ITER-000))))))
   (CL:LET*
    ((TGTTS NULL) (ITER-001 (%THE-CONS-LIST TARGETTYPES)) (SRCTS NULL)
     (ITER-002 (%THE-CONS-LIST SOURCETYPES)) (I NULL-INTEGER) (ITER-003 1)
    ...
    (CL:LOOP WHILE
     (CL:AND (CL:NOT (CL:EQ ITER-001 NIL)) (CL:NOT (CL:EQ ITER-002 NIL))
      (NEXT? IT))
     DO (CL:SETQ TGTTS (%%VALUE ITER-001)) (CL:SETQ SRCTS (%%VALUE ITER-002))
     (CL:SETQ I ITER-003)
     (CL:MULTIPLE-VALUE-SETQ (OTREE OTYPE SUCCESS?)
      (HELP-COERCE-A-TREE (%VALUE IT) SRCTS TGTTS CL:NIL))
     ...
     (CL:WHEN
      (CL:OR (CL:NOT (EQL? OTREE (%VALUE IT)))
       (CL:AND (CL:> I 1) (CL:NOT VALUESTREE?)
        (CL:NOT (CL:EQ *TRANSLATOROUTPUTLANGUAGE* KWD-WALK-COMMON-LISP))
        (CL:NOT
         (CL:EQ (TYPE-SPEC-TO-BASE-TYPE TGTTS) SGT-WALK-STELLA-UNKNOWN))
        (CL:NOT
     ...
     (CL:IF (CL:EQ COLLECT-001 NULL)
      (CL:PROGN (CL:SETQ COLLECT-001 (CONS OTYPE NIL))
       (CL:IF (CL:EQ (%THE-CONS-LIST RETURNTYPES) NIL)
        ...
        (ADD-CONS-TO-END-OF-CONS-LIST (%THE-CONS-LIST RETURNTYPES)
         COLLECT-001)))
   ...
   (CL:LET*
    ...
    (CL:LOOP WHILE (CL:<= ITER-004 UPPER-BOUND-000) DO (CL:SETQ I ITER-004)
     (CL:SETQ I I)
   ...
   (CL:LET*
    ((IT (ALLOCATE-ITERATOR (%%REST VALUESTREE))) (SRCTS NULL)
     (ITER-005 (%THE-CONS-LIST SOURCETYPES)) (TGTTS NULL)
     (ITER-006 (%THE-CONS-LIST TARGETTYPES)))
    (CL:LOOP WHILE
     (CL:AND (NEXT? IT) (CL:NOT (CL:EQ ITER-005 NIL))
      (CL:NOT (CL:EQ ITER-006 NIL)))
     DO (CL:SETQ SRCTS (%%VALUE ITER-005)) (CL:SETQ TGTTS (%%VALUE ITER-006))
   ...
   (CL:LET* ((*SPECIALSENABLED?* CL:NIL))
    ...
    (CL:WHEN
     (CL:AND (CL:= (LENGTH VALUETREES) 1)
      (CL:NOT
       (CL:EQ (REST (METHOD-RETURN-TYPE-SPECIFIERS *METHODBEINGWALKED*))
        NIL)))
     (CL:LET*
     ...
     (CL:IF (CL:EQ COLLECT-000 NULL)
      (CL:PROGN
       ...
       (CL:IF (CL:EQ (%THE-CONS-LIST TARGETTYPES) NIL)
        ...
        (ADD-CONS-TO-END-OF-CONS-LIST (%THE-CONS-LIST TARGETTYPES)
         COLLECT-000)))
      (CL:PROGN
       (CL:SETF (%%REST COLLECT-000)
        (CONS (COMPUTE-RELATIVE-TYPE-SPEC RTYPE (%SLOT-OWNER METHOD)) NIL))
    ...
    (CL:LET* ((*PRINTREADABLY?* CL:T))
     ...
     (CL:WHEN (CL:NOT (SUPPRESS-WARNINGS?))
      ...
      (%%PRINT-STREAM (%NATIVE-STREAM STANDARD-ERROR) EOL
       ...
       "' and `" (DE-UGLIFY-PARSE-TREE TYPE2) "'" EOL
       " in 'choose' expression.." EOL))))
   (CL:WHEN
     ...
     (CL:LET* ((VALUE-000 NULL) (VALUE-001 NULL))
      (CL:MULTIPLE-VALUE-SETQ (VALUE-000 VALUE-001)
       (WALK-A-TREE
        (LIST* SYM-WALK-STELLA-VRLET
         (CONS
          (CONS RESULTVARIABLE (CONS TYPE (CONS SYM-WALK-STELLA-NULL NIL)))
          NIL)
...
(CL:DEFUN COUNT-CASE-TEST-CLAUSES (TREE)
  (CL:LET*
   ((CLAUSES (%%REST (%%REST TREE))) (NOFCLAUSES 0) (OTHERWISE? CL:NIL))
     ...
     (CL:COND
      ...
      (CL:T
       (CL:IF (CL:EQ (%%VALUE CLAUSE) SYM-WALK-STELLA-OTHERWISE)
        (CL:SETQ OTHERWISE? CL:T) (CL:SETQ NOFCLAUSES (CL:1+ NOFCLAUSES)))))
     (CL:SETQ ITER-000 (%%REST ITER-000))))
  ...
  (CL:LET*
   ...
   (CL:LET* ((TEST-VALUE-001 (SAFE-PRIMARY-TYPE FIRSTTESTTREE)))
    (CL:COND
     ...
     ((SUBTYPE-OF-LONG-INTEGER? TEST-VALUE-001)
      (CL:PROGN (CL:SETQ CASECONSTANTTYPE SGT-WALK-STELLA-LONG-INTEGER)))
   ...
   (CL:LET* ((CURSOR (%%REST (%%REST TREE))) (CONDITIONTREE NULL))
    (CL:LOOP WHILE (CL:NOT (CL:EQ CURSOR NIL)) DO
     ...
     (CL:WHEN
      (CL:NOT (CL:EQ (%%VALUE CONDITIONTREE) SYM-WALK-STELLA-OTHERWISE))
         ...
         (CL:LET* ((TEST-VALUE-000 (SAFE-PRIMARY-TYPE TYPETREE)))
          (CL:COND
           ((SUBTYPE-OF-SYMBOL? TEST-VALUE-000)
            (CL:PROGN
             (CL:WHEN
              (CL:NOT (STRING-EQL? (%SYMBOL-NAME TYPETREE) "OTHERWISE"))
              (CL:LET*
               ((TYPE
               ...
               (CL:WHEN
                (CL:AND NEEDCAST? (CL:NOT (CL:EQ (%%REST CASETREE) NIL)))
        ...
        (CL:LET* ((*PRINTREADABLY?* CL:T))
         ...
         (CL:WHEN (CL:NOT (SUPPRESS-WARNINGS?))
          ...
          (%%PRINT-STREAM (%NATIVE-STREAM STANDARD-WARNING) EOL " Type `"
           (DE-UGLIFY-PARSE-TREE CLAUSETYPE) "' of `typecase' clause " EOL
           "    `" (DE-UGLIFY-PARSE-TREE CLAUSE) "'" EOL
           " is shadowed by type `" (DE-UGLIFY-PARSE-TREE SHADOWINGTYPE) "'."
           EOL))))
...
(CL:DEFUN YIELD-NESTED-ARITHMETIC-OPERATOR-CALL-TREE (OPERATOR OPERANDS)
  (CL:LET*
   ...
   (CL:LET*
    ((I NULL-INTEGER) (ITER-000 2) (UPPER-BOUND-000 (CL:1- NOFOPERANDS)))
    (CL:DECLARE (CL:TYPE CL:FIXNUM I ITER-000 UPPER-BOUND-000))
    (CL:LOOP WHILE (CL:<= ITER-000 UPPER-BOUND-000) DO (CL:SETQ I ITER-000)
   ...
   (CL:LET* ((IT (ALLOCATE-ITERATOR OPERANDS)))
    (CL:LOOP WHILE (NEXT? IT) DO
     (CL:MULTIPLE-VALUE-SETQ (OPERAND OPERANDTYPE)
      (WALK-EXPRESSION-TREE (%VALUE IT) SGT-WALK-STELLA-NUMBER OPERATOR
       CL:NIL))
     (CL:SETQ RETURNTYPE
...
(CL:DEFUN WALK-PRINT-STREAM-TREE (TREE)
  ...
  (CL:LET*
   ...
   (CL:LET* ((IT (ALLOCATE-ITERATOR (%%REST (%%REST TREE)))))
    (CL:LOOP WHILE (NEXT? IT) DO
     (CL:MULTIPLE-VALUE-SETQ (OTREE OTYPE)
      (WALK-EXPRESSION-TREE (%VALUE IT) SGT-WALK-STELLA-UNKNOWN OPERATOR
       CL:NIL))
     (VALUE-SETTER IT OTREE)
   ...
   ((CL:EQ *TRANSLATOROUTPUTLANGUAGE* KWD-WALK-COMMON-LISP)
    (CL:RETURN-FROM WALK-TYPE-SPEC-IS-NATIVE-TYPE?
     (CL:NOT
      (CL:EQ
       (%WRAPPER-VALUE
        (DYNAMIC-SLOT-VALUE (%DYNAMIC-SLOTS (TYPE-SPEC-TO-CLASS THETYPE))
   ...
   (CL:WHEN (CL:AND WARN? (CL:NOT (SYMBOL-COMMON-LISP? OPERATORNAME)))
    (CL:IF
     ...
     (CL:WHEN (CL:NOT (WALK-TYPE-SPEC-IS-NATIVE-TYPE? TYPE))
      (%%PRINT-STREAM (%NATIVE-STREAM STANDARD-OUTPUT)
       "Using default native test for `" OPERATORNAME "' in the expression:"
       EOL "  `" TREE "'" EOL))
     (CL:LET* ((*PRINTREADABLY?* CL:T))
      (CL:DECLARE (CL:SPECIAL *PRINTREADABLY?*)) (SIGNAL-TRANSLATION-ERROR)
      (CL:WHEN (CL:NOT (SUPPRESS-WARNINGS?))
       ...
       (%%PRINT-STREAM (%NATIVE-STREAM STANDARD-ERROR) EOL
        ...
        (DE-UGLIFY-PARSE-TREE OPERATORNAME) "'" EOL "   in the expression:"
        EOL "   `" (DE-UGLIFY-PARSE-TREE TREE) "'." EOL)))))
  ...
  (CL:LET*
   ...
   (CL:WHEN (CL:NOT (CL:EQ PROTOTYPEMETHOD NULL))
    ...
    (CL:WHEN (WARN-ABOUT-MISSING-METHODS?)
     (CL:LET*
      ((NOFSUBS NULL-INTEGER) (NOFMETHODS NULL-INTEGER) (COMPATIBLE? CL:NIL))
      ...
      (CL:COND
       ((CL:AND (CL:= NOFSUBS NOFMETHODS) COMPATIBLE?)
        (CL:LET* ((*PRINTREADABLY?* CL:T))
         (CL:DECLARE (CL:SPECIAL *PRINTREADABLY?*)) (SIGNAL-TRANSLATION-NOTE)
         (CL:WHEN (CL:NOT (SUPPRESS-WARNINGS?))
        ...
        (CL:LET* ((*PRINTREADABLY?* CL:T))
         ...
         (CL:WHEN (CL:NOT (SUPPRESS-WARNINGS?))
          ...
          (%%PRINT-STREAM (%NATIVE-STREAM STANDARD-WARNING) EOL
           ...
           (DE-UGLIFY-PARSE-TREE METHODNAME) "' on the non-abstract" EOL
           "   subtypes of `" (DE-UGLIFY-PARSE-TREE ABSTRACTTYPE)
...
(CL:DEFUN COMPATIBLE-REAL-METHODS (PROTOTYPEMETHOD ABSTRACTTYPE)
  (CL:LET*
   ((METHODNAME (%SLOT-NAME PROTOTYPEMETHOD)) (NOFREALSUBTYPES 0)
    (NOFREALMETHODS 0) (COMPATIBLESIGNATURES? CL:T))
...
(CL:DEFUN WALK-VARIABLE-ARGUMENTS (ARGUMENTS METHOD FIRSTARGTYPE)
  (CL:LET*
   ...
   (CL:WHEN
    (CL:AND (CL:NOT (TYPE? TARGETTYPE)) (CL:NOT (CL:EQ FIRSTARGTYPE NULL)))
...
(CL:DEFMETHOD FINISH-WALKING-CALL-SLOT-TREE ((SELF METHOD-SLOT) TREE FIRSTARGTYPE)
  (CL:LET*
   ...
   (CL:LET*
    ...
    (CL:LET*
     ((TARGETTS NULL) (ITER-000 (REST PTYPESPECS)) (PINDEX NULL-INTEGER)
     ...
     (CL:LOOP WHILE
      ...
      DO (CL:SETQ TARGETTS (%%VALUE ITER-000)) (CL:SETQ PINDEX ITER-001)
      ...
      (CL:WHEN
       ...
       (CL:RETURN))
      (CL:SETF (%%VALUE CURSOR)
       (WALK-EXPRESSION-TREE (%%VALUE CURSOR) TARGETTS METHODNAME CL:T))
      (CL:SETQ CURSOR (%%REST CURSOR)) (CL:SETQ ITER-000 (%%REST ITER-000))
   ...
   (CL:WHEN (INLINE-METHOD-CALL? SELF)
    (CL:SETQ OTREE (WALK-INLINE-METHOD-CALL SELF (%%REST TREE) FIRSTARGTYPE))
...
(CL:DEFUN QUOTE-ARGUMENTS (METHOD ARGUMENTS)
  (CL:LET*
   ...
   (CL:LET*
    ((IT (ALLOCATE-ITERATOR ARGUMENTS)) (ARGINDEX NULL-INTEGER) (ITER-000 0))
    (CL:DECLARE (CL:TYPE CL:FIXNUM ARGINDEX ITER-000))
    (CL:LOOP WHILE (NEXT? IT) DO (CL:SETQ ARGINDEX ITER-000)
     (CL:TAGBODY
      (CL:WHEN
       (CL:NOT (CL:OR (SURROGATE? (%VALUE IT)) (KEYWORD? (%VALUE IT))))
       (CL:IF
    ...
    (CL:LET* ((*PRINTREADABLY?* CL:T))
     ...
     (CL:WHEN (CL:NOT (SUPPRESS-WARNINGS?))
      ...
      (%%PRINT-STREAM (%NATIVE-STREAM STANDARD-OUTPUT) EOL
       ...
       "', since there are" EOL " one or more methods that specialize it."
       EOL)))
    (CL:RETURN-FROM METHOD-INLINABLE? CL:NIL))))
...
(CL:DEFUN HELP-MOST-SPECIFIC-METHOD? (CLASS METHOD)
  ...
  (CL:LET* ((TEST-VALUE-000 CL:NIL))
   ...
   (CL:WHEN TEST-VALUE-000
    (CL:LET* ((ALWAYS?-000 CL:T))
     (CL:LET*
      ((SUB NULL) (ITER-001 (%THE-CONS-LIST (%CLASS-DIRECT-SUBS CLASS))))
      (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-001 NIL)) DO
...
(CL:DEFUN WALK-INLINE-METHOD-CALL (METHOD WALKEDARGS FIRSTARGTYPE)
  (CL:LET*
   ...
   (CL:LET* ((*INLININGMETHODCALL?* CL:T) (*METHODBEINGWALKED* METHOD))
    ...
    (CL:LET*
     ((VAR NULL) (ITER-000 (%THE-CONS-LIST (METHOD-PARAMETER-NAMES METHOD)))
      (TSPEC NULL)
     ...
     (CL:LOOP WHILE
      ...
      DO (CL:SETQ VAR (%%VALUE ITER-000)) (CL:SETQ TSPEC (%%VALUE ITER-001))
      ...
      (CL:SETQ ITER-003 (CL:1+ ITER-003))))
    (CL:SETQ BODY
     (WALK-EXPRESSION-TREE BODY (TYPE METHOD) SYM-WALK-STELLA-INLINE-CALL
      CL:T)))
        ...
        (CL:WHEN
         (CL:NOT
          (CL:AND (SIDE-EFFECT-FREE-EXPRESSION? INLINEARG)
           (CL:<= (CL:* (ESTIMATED-EVALUATION-COST INLINEARG) NOFREFERENCES)
            2)))
         (CL:SETQ SUCCESS? CL:NIL) (CL:RETURN))))
      (CL:SETQ ITER-004 (%%REST ITER-004)))))
   (CL:LET*
    ((VAR NULL) (ITER-005 (%THE-CONS-LIST (METHOD-PARAMETER-NAMES METHOD))))
    (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-005 NIL)) DO
     (CL:SETQ VAR (%%VALUE ITER-005)) (CL:SETQ VAR VAR) (POP-VARIABLE-BINDING)
     (CL:SETQ ITER-005 (%%REST ITER-005))))
...
(CL:DEFUN WALK-METHOD-OBJECT (UNIT)
  (CL:LET* ((METHOD (%THE-OBJECT UNIT)) (BODY (%CODE-REGISTER UNIT)))
   (CL:LET*
    ...
    (CL:LET*
     ((NAME NULL) (ITER-000 (%THE-CONS-LIST (METHOD-PARAMETER-NAMES METHOD)))
      (TYPESPEC NULL)
      (ITER-001 (%THE-CONS-LIST (METHOD-PARAMETER-TYPE-SPECIFIERS METHOD))))
     (CL:LOOP WHILE
  ...
  (CL:LET* ((*CURRENTTRANSLATIONUNIT* UNIT))
   ...
   (CL:LET*
    ((METHOD (%THE-OBJECT UNIT)) (NAME (%SLOT-NAME METHOD))
     (BODY (%CODE-REGISTER UNIT)) (CREATEMETHODOBJECT? CL:T)
    ...
    (CL:COND
     ((CL:AND (CL:EQ BODY NIL)
      ...
      (CL:WHEN
       ...
       (SET-DYNAMIC-SLOT-VALUE (%DYNAMIC-SLOTS METHOD)
        SYM-WALK-STELLA-FORWARD-DECLARATION? TRUE-WRAPPER FALSE-WRAPPER)
     ...
     ((CL:OR
       (%WRAPPER-VALUE
        (DYNAMIC-SLOT-VALUE (%DYNAMIC-SLOTS METHOD)
         SYM-WALK-STELLA-SLOT-AUXILIARY? FALSE-WRAPPER))
       (%AUXILIARY? UNIT))
      (CL:SETQ CREATEMETHODOBJECT? CL:NIL) (PUSH *TRANSLATIONUNITS* UNIT)
      (WALK-METHOD-OBJECT UNIT))
  ...
  (CL:LET* ((METHODTREE NULL) (METHOD NULL))
   (CL:WHEN (SYSTEM-DEFINED-SLOT-READER? SLOT)
    ...
    (CL:IF SIGNATURESONLY?
     ...
     (CL:SETQ METHOD
      (%THE-OBJECT (HELP-WALK-AUXILIARY-TREE METHODTREE CL:T))))
   ...
   (CL:COND
    ...
    (CL:T
     (CREATE-ACCESSOR-UNITS-FOR-SLOT SLOT
      (%SURROGATE-VALUE SGT-WALK-STELLA-OBJECT) CL:T CL:NIL))))
  (CL:WHEN (%SLOT-HARDWIRED? SLOT)
   ...
   (CREATE-ACCESSOR-UNITS-FOR-SLOT SLOT
    (%SURROGATE-VALUE SGT-WALK-STELLA-OBJECT) CL:NIL CL:NIL))
  :VOID)
    ...
    (CL:LET* ((FOUND?-000 CL:NIL))
     (CL:LET*
      ...
      (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-001 NIL)) DO
       ...
       (CL:WHEN (%MIXIN? (%SURROGATE-VALUE SUPER)) (CL:SETQ FOUND?-000 CL:T)
        (CL:RETURN))
       (CL:SETQ ITER-001 (%%REST ITER-001))))
     (CL:SETQ TEST-VALUE-000 FOUND?-000)))
   (CL:WHEN TEST-VALUE-000
    ...
    (CL:WHEN (INLINE-METHOD? SLOT)
     (CL:LET* ((NAME NULL) (PARAMETERS NULL) (BODY NULL))
      ...
      (CL:LET* ((SELF-000 (NEW-TRANSLATION-UNIT)))
       ...
       (CL:SETF (%AUXILIARY? SELF-000) CL:T)
       (CL:SETF (%TU-HOME-MODULE SELF-000) *MODULE*)
    ...
    (LIST* SYM-WALK-STELLA-DEFMETHOD (%%VALUE (%%REST TREE))
     (CONS PARAMETERS
      (LIST* KWD-WALK-AUXILIARY? SYM-WALK-STELLA-TRUE KWD-WALK-PUBLIC?
       (CL:IF (%SLOT-PUBLIC? METHOD) SYM-WALK-STELLA-TRUE
        SYM-WALK-STELLA-FALSE)
       (CONCATENATE BODY NIL)))))))
     ...
     (CL:LET*
      ...
      (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-001 NIL)) DO
       ...
       (CL:WHEN (%MIXIN? (%SURROGATE-VALUE SUPER))
        (CL:LET*
         ((SLOT NULL) (ITER-002 (CLASS-SLOTS (%SURROGATE-VALUE SUPER))))
         (CL:LOOP WHILE (NEXT? ITER-002) DO (CL:SETQ SLOT (%VALUE ITER-002))
          (CL:WHEN
       ...
       (CL:SETQ ITER-001 (%%REST ITER-001))))
     (CL:LET*
      ((METHOD NULL) (ITER-003 (%THE-CONS-LIST (REVERSE MIXINMETHODS))))
      (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-003 NIL)) DO
       (CL:SETQ METHOD (%%VALUE ITER-003))
       (REGISTER-AUXILIARY-METHOD
        (%THE-OBJECT
         (HELP-WALK-AUXILIARY-TREE (YIELD-MIXIN-METHOD-TREE METHOD CLASS)
          CL:T))
        METHOD)
       (CL:SETQ ITER-003 (%%REST ITER-003)))))))
  :VOID)
        ...
        (WALK-A-TREE
         (LIST* SYM-WALK-STELLA-IF
          ...
          (LIST* SYM-WALK-STELLA-RETURN
           ...
           NIL)
          NIL)))
       (CL:SETF (%AUXILIARY? SELF-002) CL:T)
       ...
       (CL:COND
        ...
        (CL:T
         (CL:LET* ((*PRINTREADABLY?* CL:T))
          ...
          (CL:WHEN (CL:NOT (SUPPRESS-WARNINGS?))
           (PRINT-ERROR-CONTEXT ">> ERROR: " STANDARD-ERROR)
           (%%PRINT-STREAM (%NATIVE-STREAM STANDARD-ERROR) EOL " Slot `"
   ...
   (WALK-AUXILIARY-TREE
    (CL:IF (CL:EQ STARTUPTIMECODE NIL)
     ...
     (LIST* SYM-WALK-STELLA-STARTUP-TIME-PROGN KWD-WALK-CLASSES
      (LIST* SYM-WALK-STELLA-LET
       (CONS
        (LIST* SYM-WALK-STELLA-CLASS (YIELD-DEFINE-STELLA-CLASS CLASS) NIL)
        NIL)
       (CONCATENATE STARTUPTIMECODE NIL))
      NIL)))
   (CL:LET*
    ((SYNONYM NULL) (ITER-001 (%THE-CONS-LIST (CLASS-SYNONYMS CLASS))))
    (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-001 NIL)) DO
...
(CL:DEFUN WALK-SLOT-UNIT (UNIT)
  (CL:LET*
   ((SLOT (%THE-OBJECT UNIT))
    (OWNERCLASS (%SURROGATE-VALUE (%SLOT-OWNER SLOT)))
...
(CL:DEFUN WALK-DEFGLOBAL-TREE (TREE)
  ...
  (CL:LET* ((GLOBAL NULL) (INITIALVALUETREE NULL))
   ...
   (CL:SETF (%AUXILIARY? *CURRENTTRANSLATIONUNIT*)
    (%VARIABLE-AUXILIARY? GLOBAL)))
  :VOID)
     ...
     ((CL:OR (WRAPPER? INITIALVALUETREE)
       (CL:AND (SYMBOL? INITIALVALUETREE) (CONSTANT-SYMBOL? INITIALVALUETREE)
        (CL:OR (CL:NOT (CL:EQ INITIALVALUETREE SYM-WALK-STELLA-NULL))
         (CL:EQ (TYPE-TO-NULL-VALUE-TREE (%VARIABLE-TYPE GLOBAL))
          SYM-WALK-STELLA-NULL)))
      ...
      (CL:SETQ INITIALVALUETREE
       (WALK-EXPRESSION-TREE INITIALVALUETREE
        (GLOBAL-VARIABLE-TYPE-SPEC GLOBAL) (%VARIABLE-NAME GLOBAL) CL:T)))
  ...
  (CL:LET* ((STRINGIFIEDDEFINITION (STRINGIFY (%CODE-REGISTER UNIT))))
   ...
   (REGISTER-SYMBOL
    (INTERN-SYMBOL-IN-MODULE (%SYMBOL-NAME (%THE-OBJECT UNIT))
     (%HOME-CONTEXT (%THE-OBJECT UNIT)) CL:T)))
  :VOID)
...
(CL:DEFUN COMBINE-STARTUP-FUNCTION-UNITS (STARTUPFNNAME)
  (CL:LET*
   ...
   (CL:LET* ((IT (ALLOCATE-ITERATOR *TRANSLATIONUNITS*)))
    (CL:LOOP WHILE (NEXT? IT) DO
     (CL:WHEN
      (CL:EQ (%CATEGORY (%VALUE IT)) SYM-WALK-STELLA-STARTUP-TIME-PROGN)
   ...
   (CL:LOOP WHILE (CL:NOT (CL:EQ CURSOR NIL)) DO
    (CL:TAGBODY (CL:SETQ UNITPHASE (%CODE-REGISTER (%%VALUE CURSOR)))
     ...
     (CL:LET*
        ...
        (INTERN-DERIVED-SYMBOL STARTUPFNNAME
         (CONCATENATE "HELP-"
          (CONCATENATE (%SYMBOL-NAME STARTUPFNNAME)
           (INTEGER-TO-STRING
            (CL:TRUNCATE (CL:SETQ HELPFNCOUNTER (CL:1+ HELPFNCOUNTER))))))))
      ...
      (CL:LET*
       ((IT (ALLOCATE-ITERATOR PHASESTART)) (I NULL-INTEGER) (ITER-000 2)
        (UPPER-BOUND-000 PHASEUNITS)
        (UNBOUNDED?-000 (CL:= UPPER-BOUND-000 NULL-INTEGER)))
       (CL:DECLARE (CL:TYPE CL:FIXNUM I ITER-000 UPPER-BOUND-000))
       (CL:LOOP WHILE
        (CL:AND (NEXT? IT)
        ...
        (CL:SETQ HELPFNTREE
         (CONCATENATE HELPFNTREE (%THE-OBJECT (%VALUE IT))))
      ...
      (SET-DYNAMIC-SLOT-VALUE
       (%DYNAMIC-SLOTS
        (%THE-OBJECT (HELP-WALK-AUXILIARY-TREE HELPFNTREE CL:T)))
  ...
  (CL:LET*
   ((BASE-NAME
     (JAVA-TRANSLATE-CLASS-NAMESTRING
      (WRAP-STRING (%SYMBOL-NAME FUNCTION-NAME)))))
   (CL:IF (SYSTEM-STARTUP-FILE? *CURRENTFILE*)
    (CL:RETURN-FROM YIELD-STARTUP-FUNCTION-CLASSNAME
     (%WRAPPER-VALUE BASE-NAME))
    (CL:RETURN-FROM YIELD-STARTUP-FUNCTION-CLASSNAME
     (CONCATENATE "_" (%WRAPPER-VALUE BASE-NAME))))))
...
(CL:DEFUN CREATE-STARTUP-FUNCTION-UNITS ()
  (CL:LET*
   ...
   (CL:COND
    ((DONT-GENERATE-STARTUP-CODE?) (REMOVE-ALL-STARTUP-TIME-PROGN-UNITS))
      ...
      (CL:SETQ TREE
       (LIST* SYM-WALK-STELLA-DEFUN STARTUPFNNAME
        (LIST* NIL KWD-WALK-PUBLIC? SYM-WALK-STELLA-TRUE KWD-WALK-AUXILIARY?
         ...
         (CONCATENATE (COMBINE-STARTUP-FUNCTION-UNITS STARTUPFNNAME) NIL)))))
     (SET-DYNAMIC-SLOT-VALUE
      (%DYNAMIC-SLOTS (%THE-OBJECT (HELP-WALK-AUXILIARY-TREE TREE CL:T)))
      SYM-WALK-STELLA-METHOD-STARTUP-CLASSNAME
      (WRAP-STRING (YIELD-STARTUP-FUNCTION-CLASSNAME STARTUPFNNAME))
      NULL-STRING-WRAPPER))
    (CL:T
      ...
      ((CL:EQ (SAFE-PRIMARY-TYPE CLAUSE) SGT-WALK-STELLA-CONS)
       (CL:PROGN
        ...
        (CL:SETQ EXCEPTIONVARIABLESPEC
         (WALK-A-DECLARATION EXCEPTIONVARIABLE EXCEPTIONTYPE NULL CL:T))
        (CL:SETQ CLAUSE
     ...
     (CL:WHEN (CL:EQ VERBATIMTREE NULL)
      (CL:LET* ((*PRINTREADABLY?* CL:T))
       ...
       (CL:WHEN (CL:NOT (SUPPRESS-WARNINGS?))
        (PRINT-ERROR-CONTEXT ">> ERROR: " STANDARD-ERROR)
        (%%PRINT-STREAM (%NATIVE-STREAM STANDARD-ERROR) EOL
         " Verbatim statement has no `" *TRANSLATOROUTPUTLANGUAGE*
         "' option.." EOL)))
...
(CL:DEFUN WALK-DEFMODULE-TREE (TREE)
  ...
  (CL:LET*
   ((MODULE NULL)
    (MODULENAME (COERCE-TO-MODULE-NAME (%%VALUE (%%REST TREE)) CL:NIL)))
...
(CL:DEFUN EXTRACT-REQUIRED-ARGUMENT-VALUES (CLASSTYPE SLOTSANDVALUES)
  (CL:LET*
   ...
   (CL:LET*
    ...
    (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-000 NIL)) DO
     (CL:SETQ REQUIREDSLOTNAME (%%VALUE ITER-000)) (CL:SETQ FOUND? CL:NIL)
     (CL:LET*
      ((SLOT NULL) (VALUEREF NULL) (ITER-001 (%THE-PLIST SLOTSANDVALUES)))
      (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-001 NIL)) DO
       (CL:SETQ SLOT (%%VALUE ITER-001))
       (CL:SETQ VALUEREF (%%VALUE (%%REST ITER-001)))
       (CL:WHEN (CL:EQ (%SLOT-NAME SLOT) REQUIREDSLOTNAME)
        (CL:SETQ FOUND? CL:T)
        (CL:IF ARRAYTYPE?
         ...
         (INSERT-LAST REQUIREDVALUES
          (WALK-EXPRESSION-TREE VALUEREF
           (COMPUTE-RETURN-TYPE-SPEC SLOT CLASSTYPE) SYM-WALK-STELLA-NEW
           CL:NIL)))
...
(CL:DEFUN PREPROCESS-ARRAY-ARGUMENTS (ARRAYTYPE SLOTSANDVALUES)
  (CL:LET*
   ((ARRAYCLASS (%SURROGATE-VALUE (%SPECIFIER-BASE-TYPE ARRAYTYPE)))
    ...
    (SIZEREF (LOOKUP SLOTSANDVALUES ARRAYSIZESLOT)) (NONLISTSIZE? CL:NIL))
  ...
  (CL:LET* ((CLASS (TYPE-SPEC-TO-CLASS CLASSTYPE)))
   (CL:LET* ((SELF-000 (NEW-PROPERTY-LIST)))
    ...
    (CL:LET*
       ...
       (CL:WHEN (CL:EQ SLOT NULL)
        (CL:LET* ((*PRINTREADABLY?* CL:T))
         ...
         (CL:WHEN (CL:NOT (SUPPRESS-WARNINGS?))
          (PRINT-ERROR-CONTEXT ">> ERROR: " STANDARD-ERROR)
          (%%PRINT-STREAM (%NATIVE-STREAM STANDARD-ERROR) EOL
           " No such slot `" (DE-UGLIFY-PARSE-TREE SLOTNAME)
     ...
     (CL:LET*
      ((SLOT NULL) (VALUEREF NULL) (ITER-000 (%THE-PLIST PLIST))
       (COLLECT-000 NULL))
      (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-000 NIL)) DO
       (CL:SETQ SLOT (%%VALUE ITER-000))
    ...
    (CL:WHEN (CL:EQ OWNER NULL)
     (CL:IF
      (%WRAPPER-VALUE
       (DYNAMIC-SLOT-VALUE (%DYNAMIC-SLOTS METHOD)
        SYM-WALK-STELLA-METHOD-CONSTRUCTOR? FALSE-WRAPPER))
      (CL:SETQ OWNER (%SLOT-BASE-TYPE METHOD))
...
(CL:DEFUN WALK-MAKE-TREE (TREE)
  (CL:LET*
   ...
   (CL:COND ((SYMBOL? CLASSNAME))
    ((TYPE? CLASSNAME)
     (SECOND-SETTER TREE
      (INTERN-SYMBOL-IN-MODULE (%SYMBOL-NAME CLASSNAME)
       (%HOME-CONTEXT CLASSNAME) CL:T)))
    (CL:T
     (CL:LET* ((*PRINTREADABLY?* CL:T))
      (CL:DECLARE (CL:SPECIAL *PRINTREADABLY?*)) (SIGNAL-TRANSLATION-ERROR)
      (CL:WHEN (CL:NOT (SUPPRESS-WARNINGS?))
     ...
     (CL:T
      (CL:LET* ((*PRINTREADABLY?* CL:T))
       ...
       (CL:WHEN (CL:NOT (SUPPRESS-WARNINGS?))
        (PRINT-ERROR-CONTEXT ">> WARNING: " STANDARD-WARNING)
        (%%PRINT-STREAM (%NATIVE-STREAM STANDARD-WARNING) EOL
         " MAKE arguments not supported for `"
  ...
  (CL:LET*
   ...
   (CL:RETURN-FROM YIELD-EVALUATOR-WRAPPER-TREE
    (LIST* SYM-WALK-STELLA-DEFUN NAMETREE
     (LIST*
      (CONS (LIST* SYM-WALK-STELLA-ARGUMENTS SYM-WALK-STELLA-CONS NIL) NIL)
      KWD-WALK-AUXILIARY? SYM-WALK-STELLA-TRUE
      (CONCATENATE
       (CL:IF (CL:= NOFPARAMETERS 0)
        (CONS (LIST* SYM-WALK-STELLA-IGNORE SYM-WALK-STELLA-ARGUMENTS NIL)
         NIL)
        NIL)
       (CONS CALLTREE NIL)))))))
...
(CL:DEFUN CREATE-EVALUATOR-WRAPPER-UNIT (METHOD)
  (CL:LET*
   ...
   (CL:WHEN (CL:NOT EVALUATEARGUMENTS?)
    (SET-DYNAMIC-SLOT-VALUE (%DYNAMIC-SLOTS METHOD)
     SYM-WALK-STELLA-METHOD-EVALUATE-ARGUMENTS? TRUE-WRAPPER FALSE-WRAPPER))
   (CL:WHEN VARIABLEARGUMENTS?
    (SET-DYNAMIC-SLOT-VALUE (%DYNAMIC-SLOTS METHOD)
     SYM-WALK-STELLA-METHOD-VARIABLE-ARGUMENTS? FALSE-WRAPPER FALSE-WRAPPER))
   (CL:SETQ WRAPPERMETHOD
    (%THE-OBJECT (HELP-WALK-AUXILIARY-TREE WRAPPERTREE CL:T)))
   (CL:WHEN (CL:NOT EVALUATEARGUMENTS?)
    (SET-DYNAMIC-SLOT-VALUE (%DYNAMIC-SLOTS METHOD)
     SYM-WALK-STELLA-METHOD-EVALUATE-ARGUMENTS? FALSE-WRAPPER FALSE-WRAPPER))
   (CL:WHEN VARIABLEARGUMENTS?
    (SET-DYNAMIC-SLOT-VALUE (%DYNAMIC-SLOTS METHOD)
     SYM-WALK-STELLA-METHOD-VARIABLE-ARGUMENTS? TRUE-WRAPPER FALSE-WRAPPER))
      ...
      (CL:PROGN
       (CL:COND
        ...
        ((CL:EQ OPERATORNAME SYM-WALK-STELLA-BQUOTE)
         (CL:RETURN-FROM EVALUATE-CONS-TREE (EVALUATE-BQUOTE-TREE TREE)))
        ((CL:EQ OPERATORNAME SYM-WALK-STELLA-CONS)
         (CL:LET*
          ...
          (CL:WHEN
           (CL:AND (CONS? ARG2) (CL:EQ (%%REST (%%REST ARGUMENTS)) NIL))
           (CL:RETURN-FROM EVALUATE-CONS-TREE
        ...
        ((CL:EQ OPERATORNAME SYM-WALK-STELLA-APPEND)
         (CL:LET*
          ...
          (CL:LET* ((STREAM-002 (NEW-OUTPUT-STRING-STREAM)))
           ...
           (CL:ERROR
            (NEW-EVALUATION-EXCEPTION (THE-STRING-READER STREAM-002))))))
         ...
         (CL:LET* ((TEST-VALUE-000 CL:NIL))
          ...
          (CL:WHEN TEST-VALUE-000
           (CL:LET* ((STREAM-003 (NEW-OUTPUT-STRING-STREAM)))
            ...
            (CL:ERROR
             (NEW-EVALUATION-EXCEPTION (THE-STRING-READER STREAM-003))))))))))
     (CL:T
      (CL:LET* ((STREAM-004 (NEW-OUTPUT-STRING-STREAM)))
       (%%PRINT-STREAM (%NATIVE-STREAM STREAM-004) "While evaluating '"
        *EVALUATIONTREE*)
       (CL:WHEN (CL:NOT (CL:EQ *EVALUATIONPARENTTREE* NULL))
        (%%PRINT-STREAM (%NATIVE-STREAM STREAM-004) EOL "' inside '"
         *EVALUATIONPARENTTREE*))
       (%%PRINT-STREAM (%NATIVE-STREAM STREAM-004) "':" EOL)
       (%%PRINT-STREAM (%NATIVE-STREAM STREAM-004) "Illegal operator: `"
        OPERATORNAME "'")
    ...
    (CL:LET*
     ...
     (CL:WHEN
      (CL:OR (CL:< NOFARGS MINARGS)
       (CL:AND (CL:NOT (CL:= MAXARGS NULL-INTEGER)) (CL:> NOFARGS MAXARGS)))
      (CL:LET*
       ((MINSTRING (INTEGER-TO-STRING (CL:TRUNCATE MINARGS))) (MAXSTRING ""))
       ...
       (CL:LET* ((STREAM-005 (NEW-OUTPUT-STRING-STREAM)))
        (%%PRINT-STREAM (%NATIVE-STREAM STREAM-005) "While evaluating '"
         *EVALUATIONTREE*)
        (CL:WHEN (CL:NOT (CL:EQ *EVALUATIONPARENTTREE* NULL))
         (%%PRINT-STREAM (%NATIVE-STREAM STREAM-005) EOL "' inside '"
          *EVALUATIONPARENTTREE*))
        (%%PRINT-STREAM (%NATIVE-STREAM STREAM-005) "':" EOL)
        (%%PRINT-STREAM (%NATIVE-STREAM STREAM-005)
         "Wrong number of arguments.  Expected `" MINSTRING "'`" MAXSTRING
         "' but got `" NOFARGS "'")
        (CL:ERROR
         (NEW-EVALUATION-EXCEPTION (THE-STRING-READER STREAM-005))))))
       ...
       ((CL:EQ TEST-VALUE-000 SYM-WALK-STELLA-GET-SYM)
        (CL:RETURN-FROM MAKE-EVALUATABLE-BQUOTE-TREE
         (LIST* SYM-WALK-STELLA-QUOTE
          (GET-SYM (%WRAPPER-VALUE (%%VALUE (%%REST TREE)))) NIL)))
       ((CL:EQ TEST-VALUE-000 SYM-WALK-STELLA-GET-SGT)
        (CL:RETURN-FROM MAKE-EVALUATABLE-BQUOTE-TREE
         (GET-SGT (%WRAPPER-VALUE (%%VALUE (%%REST TREE))))))
       ((CL:EQ TEST-VALUE-000 SYM-WALK-STELLA-GET-KWD)
        (CL:RETURN-FROM MAKE-EVALUATABLE-BQUOTE-TREE
         (GET-KWD (%WRAPPER-VALUE (%%VALUE (%%REST TREE))))))
       (CL:T
        (CL:LET* ((ARGS NIL))
         (CL:LET* ((ARG NULL) (ITER-000 (%%REST TREE)) (COLLECT-000 NULL))
          (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-000 NIL)) DO
...
(CL:DEFUN HELP-STARTUP-WALK1 ()
  (CL:PROGN
   ...
   (CL:SETQ SGT-WALK-STELLA-F-GET-QUOTED-TREE-MEMO-TABLE-000
    (INTERN-RIGID-SYMBOL-WRT-MODULE "F-GET-QUOTED-TREE-MEMO-TABLE-000" NULL
     1))
...
(CL:DEFUN HELP-STARTUP-WALK6 ()
  (CL:PROGN
   ...
   (CL:SETQ SYM-WALK-STELLA-SUBTYPE-OF-PARAMETRIC-TYPE-SPECIFIER?
    (INTERN-RIGID-SYMBOL-WRT-MODULE "SUBTYPE-OF-PARAMETRIC-TYPE-SPECIFIER?"
     NULL 0))
  ...
  (CL:PROGN
   ...
   (CL:SETQ *WRAPPED-TYPE-TABLE*
    (LIST* (LIST* SGT-WALK-STELLA-INTEGER-WRAPPER SGT-WALK-STELLA-INTEGER NIL)
     (LIST* SGT-WALK-STELLA-LONG-INTEGER-WRAPPER SGT-WALK-STELLA-LONG-INTEGER
      NIL)
   ...
   (CL:SETQ *COERSION-TABLE*
    (LIST*
     ...
     (LIST* SGT-WALK-STELLA-LONG-INTEGER SGT-WALK-STELLA-LONG-INTEGER-WRAPPER
      SYM-WALK-STELLA-WRAP-LITERAL NIL)
     ...
     (LIST* SGT-WALK-STELLA-MUTABLE-STRING
      SGT-WALK-STELLA-MUTABLE-STRING-WRAPPER SYM-WALK-STELLA-WRAP-LITERAL NIL)
     ...
     (LIST* SGT-WALK-STELLA-FUNCTION-CODE
      SGT-WALK-STELLA-FUNCTION-CODE-WRAPPER SYM-WALK-STELLA-WRAP-LITERAL NIL)
     ...
     (LIST* SGT-WALK-STELLA-INTEGER-WRAPPER SGT-WALK-STELLA-LONG-INTEGER
      SYM-WALK-STELLA-WRAPPER-VALUE NIL)
     (LIST* SGT-WALK-STELLA-LONG-INTEGER-WRAPPER SGT-WALK-STELLA-LONG-INTEGER
      SYM-WALK-STELLA-WRAPPER-VALUE NIL)
     ...
     (LIST* SGT-WALK-STELLA-NUMBER SGT-WALK-STELLA-FLOAT
      (LIST* SYM-WALK-STELLA-CAST SYM-WALK-STELLA-<X> SGT-WALK-STELLA-FLOAT
       NIL)
      NIL)
   ...
   (CL:SETQ *CURRENTFILE* STELLA::NULL-STRING)
   ...
   (CL:SETQ *TYPE-PREDICATE-TABLE*
    (LIST*
     ...
     (LIST* SGT-WALK-STELLA-INTEGER-WRAPPER SYM-WALK-STELLA-INTEGER?
      SYM-WALK-STELLA-SUBTYPE-OF-INTEGER? NIL)
     (LIST* SGT-WALK-STELLA-LONG-INTEGER-WRAPPER SYM-WALK-STELLA-LONG-INTEGER?
      SYM-WALK-STELLA-SUBTYPE-OF-LONG-INTEGER? NIL)
...
`speed', and `space'.\" :PUBLIC? TRUE)" (CL:FUNCTION SET-OPTIMIZATION-LEVELS)
   ...
   (DEFINE-FUNCTION-OBJECT "TRANSLATE-ALL-UNITS"
    "(DEFUN TRANSLATE-ALL-UNITS ())" (CL:FUNCTION TRANSLATE-ALL-UNITS) NULL)
...
the result.  For C++ and Java print the translation to standard output and
return NIL instead.\" :PUBLIC? TRUE)" (CL:FUNCTION INCREMENTALLY-TRANSLATE)
    NULL)
...
confirmation with the user.\" :PUBLIC? TRUE)" (CL:FUNCTION BREAK-PROGRAM)
    NULL))
  :VOID)
...
(CL:DEFUN HELP-STARTUP-WALK10 ()
  (CL:PROGN
   ...
   (DEFINE-FUNCTION-OBJECT "PROGNIFY"
    "(DEFUN (PROGNIFY OBJECT) ((TREES CONS)))" (CL:FUNCTION PROGNIFY) NULL)
...
(CL:DEFUN HELP-STARTUP-WALK11 ()
  (CL:PROGN
   ...
   (DEFINE-FUNCTION-OBJECT "CLEAR-SYMBOL-REGISTRY"
    "(DEFUN CLEAR-SYMBOL-REGISTRY ())" (CL:FUNCTION CLEAR-SYMBOL-REGISTRY)
    NULL)
...
holding its expander function.\" :PUBLIC? TRUE)" (CL:FUNCTION LOOKUP-MACRO)
    NULL)
   (DEFINE-EXTERNAL-SLOT-FROM-STRINGIFIED-SOURCE
...
evaluation strategies.\" :PUBLIC? TRUE)" (CL:FUNCTION TRY-TO-EVALUATE) NULL)
   ...
   (DEFINE-FUNCTION-OBJECT "STARTUP-WALK"
    "(DEFUN STARTUP-WALK () :PUBLIC? TRUE)" (CL:FUNCTION STARTUP-WALK) NULL)
   (CL:LET* ((FUNCTION (LOOKUP-FUNCTION SYM-WALK-STELLA-STARTUP-WALK)))
    (SET-DYNAMIC-SLOT-VALUE (%DYNAMIC-SLOTS FUNCTION)
     SYM-WALK-STELLA-METHOD-STARTUP-CLASSNAME (WRAP-STRING "_StartupWalk")
     NULL-STRING-WRAPPER)))
  :VOID)
...
to its own gensym counter and/or to related gensyms.\")")
    ...
    (DEFINE-STELLA-GLOBAL-VARIABLE-FROM-STRINGIFIED-SOURCE
     "(DEFSPECIAL *TRANSLATIONNOTES* INTEGER 0 :PUBLIC? TRUE)")
    (DEFINE-STELLA-GLOBAL-VARIABLE-FROM-STRINGIFIED-SOURCE
