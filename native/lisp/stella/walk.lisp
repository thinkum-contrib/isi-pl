...
(CL:DECLAIM
 (CL:SPECIAL NULL-INTEGER-WRAPPER NULL-FLOAT-WRAPPER NULL-FUNCTION-CODE-WRAPPER
  *CURRENTSYSTEMDEFINITION* NULL-STRING-WRAPPER *STELLA-MODULE*
  *STARTUP-TIME-PHASES* NIL-LIST *INLININGMETHODCALL?* KEYWORD-SYM SURROGATE-SYM
  SYMBOL-SYM *MIXIN-IMPLEMENTATION-STYLE* NULL-INTEGER *CURRENTFILE*
  *IGNORETRANSLATIONERRORS?* STANDARD-WARNING TRUE-WRAPPER FALSE-WRAPPER *MODULE*
  FALSE TRUE STANDARD-ERROR *TRANSLATOROUTPUTLANGUAGE* STANDARD-OUTPUT EOL NIL))
...
(CL:DEFUN PRINT-STELLA-FEATURES ()
  ...
  (CL:LET* ((FEATURE NULL) (ITER-000 (%THE-CONS-LIST *CURRENT-STELLA-FEATURES*)))
   (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-000 NIL)) DO
    (CL:PROGN (CL:SETQ FEATURE (%%VALUE ITER-000))
     (CL:SETQ ITER-000 (%%REST ITER-000)))
    (%%PRINT-STREAM (%NATIVE-STREAM STANDARD-OUTPUT) "  :"
     (STRING-DOWNCASE (%SYMBOL-NAME FEATURE)) EOL)))
  (%%PRINT-STREAM (%NATIVE-STREAM STANDARD-OUTPUT) EOL
   "Disabled STELLA features:" EOL)
  (CL:LET*
   ((FEATURE NULL) (ITER-001 (%THE-CONS-LIST *AVAILABLE-STELLA-FEATURES*)))
      ...
      (CL:T
       (CL:IF (MEMBER? *AVAILABLE-STELLA-FEATURES* F)
        (CL:LET* ((STREAM-000 (NEW-OUTPUT-STRING-STREAM)))
         (%%PRINT-STREAM (%NATIVE-STREAM STREAM-000) "STELLA feature `" F
...
one or more of them are trace enabled."
  (CL:LET* ((TEST NIL) (ELEMENTS (COPY-CONS-LIST BODY)))
   (CL:COND
       ...
       (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-000 NIL)) DO
        ...
        (CL:IF (CL:EQ COLLECT-000 NULL)
         (CL:PROGN
          (CL:SETQ COLLECT-000
           (CONS
            (LIST* SYM-WALK-STELLA-MEMB? SYM-WALK-STELLA-*TRACED-KEYWORDS* KWD
             NIL)
            NIL))
    ...
    (CL:T
     (CL:SETQ TEST
      (LIST* SYM-WALK-STELLA-MEMB? SYM-WALK-STELLA-*TRACED-KEYWORDS* KEYWORD
       NIL))))
   (CL:RETURN-FROM TRACE-IF
    (LIST* SYM-WALK-STELLA-WHEN
     (LIST* SYM-WALK-STELLA-AND
      (LIST* SYM-WALK-STELLA-DEFINED? SYM-WALK-STELLA-*TRACED-KEYWORDS* NIL) TEST
      NIL)
     ...
     (CONCATENATE
      (CL:IF
       ...
       NIL
       (CONS
        (LIST* SYM-WALK-STELLA-FLUSH-OUTPUT SYM-WALK-STELLA-STANDARD-OUTPUT NIL)
        NIL))
      NIL)))))
...
will be executed when it is encountered."
  ...
  (CL:LET* ((K NULL) (ITER-000 KEYWORDS))
   (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-000 NIL)) DO
    (CL:PROGN (CL:SETQ K (%%VALUE ITER-000))
     (CL:SETQ ITER-000 (%%REST ITER-000)))
    (INSERT-NEW *TRACED-KEYWORDS* (KEYWORDIFY (%SYMBOL-NAME K)))))
  ...
  (CL:WHEN (CL:NOT (CL:EQ *TRACED-KEYWORDS* NULL))
   (CL:LET* ((K NULL) (ITER-000 KEYWORDS))
    (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-000 NIL)) DO
     (CL:PROGN (CL:SETQ K (%%VALUE ITER-000))
      (CL:SETQ ITER-000 (%%REST ITER-000)))
     (REMOVE *TRACED-KEYWORDS* (KEYWORDIFY (%SYMBOL-NAME K)))))
...
`speed', and `space'."
  ...
  (CL:WHEN (CL:AND (DEFINED? SAFETY) (CL:>= SAFETY 0) (CL:<= SAFETY 3))
   (CL:SETQ *SAFETY* SAFETY))
  (CL:WHEN (CL:AND (DEFINED? DEBUG) (CL:>= DEBUG 0) (CL:<= DEBUG 3))
   (CL:SETQ *DEBUGLEVEL* DEBUG))
  (CL:WHEN (CL:AND (DEFINED? SPEED) (CL:>= SPEED 0) (CL:<= SPEED 3))
   (CL:SETQ *OPTIMIZESPEEDLEVEL* SPEED))
  (CL:WHEN (CL:AND (DEFINED? SPACE) (CL:>= SPACE 0) (CL:<= SPACE 3))
...
(CL:DEFUN NAME-QUOTED-TREE (TREE)
  (CL:LET*
   ((NAMETREE (CONS TREE (CONS (WRAP-STRING (%MODULE-FULL-NAME *MODULE*)) NIL)))
...
(CL:DEFUN GET-QUOTED-TREE (TREE-NAME MODULENAME)
  ...
  (CL:LET* ((QUOTEDTREE (LOOKUP *QUOTATION-TABLE* TREE-NAME)))
   (CL:WHEN (CL:NOT (CL:EQ QUOTEDTREE NULL))
    (CL:RETURN-FROM GET-QUOTED-TREE QUOTEDTREE))
   (CL:LET* ((*MODULE* (GET-STELLA-MODULE MODULENAME TRUE)))
    (CL:DECLARE (CL:SPECIAL *MODULE*))
    (CL:LET* ((TREE (READ-S-EXPRESSION-FROM-STRING TREE-NAME)))
     (CL:SETQ QUOTEDTREE (PERMANENTIFY-FORM (%%VALUE TREE)))
     (INSERT-AT *QUOTATION-TABLE* TREE-NAME QUOTEDTREE)
     (CL:RETURN-FROM GET-QUOTED-TREE QUOTEDTREE)))))
...
(CL:DEFCLASS TRANSLATION-UNIT (STANDARD-OBJECT)
  ((TU-HOME-MODULE :ALLOCATION :INSTANCE :ACCESSOR %TU-HOME-MODULE)
   (THE-OBJECT :ALLOCATION :INSTANCE :ACCESSOR %THE-OBJECT)
   (CATEGORY :ALLOCATION :INSTANCE :ACCESSOR %CATEGORY)
   (ANNOTATION :TYPE CL:SIMPLE-STRING :INITFORM STELLA::NULL-STRING :ALLOCATION
    :INSTANCE :ACCESSOR %ANNOTATION)
...
(CL:DEFUN NEW-TRANSLATION-UNIT ()
  (CL:LET* ((SELF NULL))
   (CL:SETQ SELF (CL:MAKE-INSTANCE (CL:QUOTE TRANSLATION-UNIT)))
   (CL:SETF (%REFERENCED-GLOBALS SELF) (NEW-LIST))
   (CL:SETF (%TRANSLATION SELF) NULL) (CL:SETF (%CODE-REGISTER SELF) NULL)
   (CL:SETF (%AUXILIARY? SELF) FALSE)
   (CL:SETF (%ANNOTATION SELF) STELLA::NULL-STRING)
   (CL:SETF (%CATEGORY SELF) NULL) (CL:SETF (%THE-OBJECT SELF) NULL)
...
(CL:DEFUN ACCESS-TRANSLATION-UNIT-SLOT-VALUE (SELF SLOTNAME VALUE SETVALUE?)
  (CL:COND
   ((CL:EQ SLOTNAME SYM-WALK-STELLA-TU-HOME-MODULE)
    (CL:IF SETVALUE? (CL:SETF (%TU-HOME-MODULE SELF) VALUE)
     (CL:SETQ VALUE (%TU-HOME-MODULE SELF))))
   ((CL:EQ SLOTNAME SYM-WALK-STELLA-THE-OBJECT)
    (CL:IF SETVALUE? (CL:SETF (%THE-OBJECT SELF) VALUE)
     (CL:SETQ VALUE (%THE-OBJECT SELF))))
   ((CL:EQ SLOTNAME SYM-WALK-STELLA-CATEGORY)
    (CL:IF SETVALUE? (CL:SETF (%CATEGORY SELF) VALUE)
     (CL:SETQ VALUE (%CATEGORY SELF))))
   ...
   ((CL:EQ SLOTNAME SYM-WALK-STELLA-AUXILIARY?)
    (CL:IF SETVALUE?
     (CL:SETF (%AUXILIARY? SELF) (COERCE-WRAPPED-BOOLEAN-TO-BOOLEAN VALUE))
     (CL:SETQ VALUE (CL:IF (%AUXILIARY? SELF) TRUE-WRAPPER FALSE-WRAPPER))))
   ((CL:EQ SLOTNAME SYM-WALK-STELLA-CODE-REGISTER)
    (CL:IF SETVALUE? (CL:SETF (%CODE-REGISTER SELF) VALUE)
     (CL:SETQ VALUE (%CODE-REGISTER SELF))))
   ((CL:EQ SLOTNAME SYM-WALK-STELLA-TRANSLATION)
    (CL:IF SETVALUE? (CL:SETF (%TRANSLATION SELF) VALUE)
     (CL:SETQ VALUE (%TRANSLATION SELF))))
   ((CL:EQ SLOTNAME SYM-WALK-STELLA-REFERENCED-GLOBALS)
    (CL:IF SETVALUE? (CL:SETF (%REFERENCED-GLOBALS SELF) VALUE)
     (CL:SETQ VALUE (%REFERENCED-GLOBALS SELF))))
   (CL:T
    (CL:LET* ((STREAM-000 (NEW-OUTPUT-STRING-STREAM)))
...
(CL:DEFUN USE-HARDCODED-SYMBOLS? ()
  (CL:RETURN-FROM USE-HARDCODED-SYMBOLS?
   (CL:OR (MEMBER? *CURRENT-STELLA-FEATURES* KWD-WALK-USE-HARDCODED-SYMBOLS)
    *USEHARDCODEDSYMBOLS?*)))
  ...
  (CL:COND
   ...
   (CL:T
    (CL:RETURN-FROM TRANSLATOR-OUTPUT-LANGUAGE-NAME
     (%SYMBOL-NAME *TRANSLATOROUTPUTLANGUAGE*)))))
(CL:DECLAIM
 (CL:FTYPE (CL:FUNCTION () CL:SIMPLE-STRING) TRANSLATOR-OUTPUT-LANGUAGE-NAME))
...
(CL:DEFUN TRANSLATE-TO-SINGLE-INHERITANCE-LANGUAGE? ()
  (CL:COND
   ((CL:OR (CL:EQ *TRANSLATOROUTPUTLANGUAGE* KWD-WALK-COMMON-LISP)
     (CL:EQ *TRANSLATOROUTPUTLANGUAGE* KWD-WALK-CPP)
     (CL:EQ *TRANSLATOROUTPUTLANGUAGE* KWD-WALK-JAVA))
    (CL:RETURN-FROM TRANSLATE-TO-SINGLE-INHERITANCE-LANGUAGE? TRUE))
   (CL:T (CL:RETURN-FROM TRANSLATE-TO-SINGLE-INHERITANCE-LANGUAGE? FALSE))))
...
(CL:DEFUN USE-BOOTSTRAP-TRANSLATOR? ()
  (CL:RETURN-FROM USE-BOOTSTRAP-TRANSLATOR? FALSE))
   ...
   (CL:WHEN (CL:EQ OPERATOR SYM-WALK-STELLA-PROGN)
    (CL:LET* ((FOUND?-000 FALSE))
     (CL:LET* ((SUBTREE NULL) (ITER-000 (%%REST TREE)))
      (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-000 NIL)) DO
       (CL:PROGN (CL:SETQ SUBTREE (%%VALUE ITER-000))
        (CL:SETQ ITER-000 (%%REST ITER-000)))
    ...
    (CL:LET* ((EXPANSION (EXPAND-MACRO (COPY-CONS-LIST TREE))))
     (CL:COND
      ...
      (CL:T (CL:SETF (%%VALUE TREE) SYM-WALK-STELLA-PROGN)
       (CL:SETF (%%REST TREE) NIL) (CL:RETURN-FROM DECLARATION-TREE? FALSE)))))
   ...
   (CL:LET* ((ANNOTATION STELLA::NULL-STRING))
    ...
    (CL:WHEN CREATEANNOTATION? (CL:SETQ ANNOTATION (CREATE-ANNOTATION TREE))
     (CL:WHEN (CL:>= *TRANSLATIONVERBOSITYLEVEL* 2)
      (%%PRINT-STREAM (%NATIVE-STREAM STANDARD-OUTPUT) "Defining `" ANNOTATION
       "'" EOL)))
    (CL:LET* ((TEST-VALUE-000 (%%VALUE TREE)))
     (CL:COND
      ((CL:EQ TEST-VALUE-000 SYM-WALK-STELLA-DEFCLASS) (WALK-DEFCLASS-TREE TREE))
      ...
      (CL:T
       (CL:COND
        ...
        (CL:T
         ...
         (CL:SETQ TREE (LIST* SYM-WALK-STELLA-STARTUP-TIME-PROGN TREE NIL))
   ...
   (CL:LET* ((OTREE (WALK-WITHOUT-TYPE-TREE TREE)))
    (CL:WHEN (VRLET-EXPRESSION? OTREE)
     (CL:RETURN-FROM WALK-TOP-LEVEL-EXPRESSION
      (WALK-WITHOUT-TYPE-TREE (LIST* SYM-WALK-STELLA-PROGN OTREE NIL))))
...
(CL:DEFUN HELP-WALK-AUXILIARY-TREE (TREE FINALIZE?)
  ...
  (CL:LET* ((UNIT (POP *TRANSLATIONUNITS*))) (CL:SETF (%AUXILIARY? UNIT) TRUE)
   (WALK-PHASE-ONE-UNIT UNIT) (CL:RETURN-FROM HELP-WALK-AUXILIARY-TREE UNIT)))
    ...
    (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-000 NIL)) DO
     ...
     (CL:WHEN
      (CL:AND (CL:>= *TRANSLATIONVERBOSITYLEVEL* 2)
       (CL:NOT (CL:EQ (%ANNOTATION UNIT) STELLA::NULL-STRING)))
      (%%PRINT-STREAM (%NATIVE-STREAM STANDARD-OUTPUT) "Walking `"
       (%ANNOTATION UNIT) "'" EOL))
  ...
  (CL:LET* ((UNIT NULL) (ITER-000 (%THE-CONS-LIST *TRANSLATIONUNITS*)))
   (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-000 NIL)) DO
    ...
    (CL:LET* ((*CURRENTTRANSLATIONUNIT* UNIT))
     ...
     (CL:COND
      ((CL:EQ *TRANSLATOROUTPUTLANGUAGE* KWD-WALK-COMMON-LISP)
       (CL:SETF (%TRANSLATION UNIT) (CL-TRANSLATE-UNIT UNIT)))
      ((CL:EQ *TRANSLATOROUTPUTLANGUAGE* KWD-WALK-IDL)
       (CL:SETF (%TRANSLATION UNIT) (IDL-TRANSLATE-UNIT UNIT)))
      ((CL:OR (CL:EQ *TRANSLATOROUTPUTLANGUAGE* KWD-WALK-JAVA)
        (CL:EQ *TRANSLATOROUTPUTLANGUAGE* KWD-WALK-JAVA-STANDALONE))
       (CL:WHEN (CL:EQ (%TRANSLATION UNIT) NULL)
        (CL:SETF (%TRANSLATION UNIT) (JAVA-TRANSLATE-UNIT UNIT))))
...
(CL:DEFUN UNIT-INCLUDED-IN-OTHER-UNITS? (UNIT)
  (CL:LET* ((METHOD NULL))
   (CL:IF (CL:NOT (CL:EQ (%CATEGORY UNIT) SYM-WALK-STELLA-METHOD))
    (CL:RETURN-FROM UNIT-INCLUDED-IN-OTHER-UNITS? FALSE)
    (CL:PROGN (CL:SETQ METHOD (%THE-OBJECT UNIT))
     (CL:COND
      ((%WRAPPER-VALUE
       ...
       (CL:LET*
        ((OTHER-UNIT NULL) (ITER-000 (%THE-CONS-LIST *TRANSLATIONUNITS*)))
        (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-000 NIL)) DO
         (CL:PROGN (CL:SETQ OTHER-UNIT (%%VALUE ITER-000))
          (CL:SETQ ITER-000 (%%REST ITER-000)))
         (CL:WHEN
          (CL:AND (CL:EQ (%CATEGORY OTHER-UNIT) SYM-WALK-STELLA-CLASS)
           (CL:EQ (CANONICAL-TYPE (%SLOT-BASE-TYPE METHOD))
            (%CLASS-TYPE (%THE-OBJECT OTHER-UNIT))))
          (CL:RETURN-FROM UNIT-INCLUDED-IN-OTHER-UNITS? TRUE))))
       (CL:RETURN-FROM UNIT-INCLUDED-IN-OTHER-UNITS? FALSE))
      (CL:T
       (CL:LET*
        ((OTHER-UNIT NULL) (ITER-001 (%THE-CONS-LIST *TRANSLATIONUNITS*)))
        (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-001 NIL)) DO
         (CL:PROGN (CL:SETQ OTHER-UNIT (%%VALUE ITER-001))
          (CL:SETQ ITER-001 (%%REST ITER-001)))
         (CL:WHEN
          (CL:AND (CL:EQ (%CATEGORY OTHER-UNIT) SYM-WALK-STELLA-CLASS)
           (CL:EQ (CANONICAL-TYPE (%SLOT-OWNER METHOD))
            (%CLASS-TYPE (%THE-OBJECT OTHER-UNIT))))
          (CL:RETURN-FROM UNIT-INCLUDED-IN-OTHER-UNITS? TRUE))))
       (CL:RETURN-FROM UNIT-INCLUDED-IN-OTHER-UNITS? FALSE)))))))
  ...
  (CL:LET* ((OTREE NIL))
   (CL:COND
    ...
    ((CL:OR (CL:EQ *TRANSLATOROUTPUTLANGUAGE* KWD-WALK-JAVA)
      (CL:EQ *TRANSLATOROUTPUTLANGUAGE* KWD-WALK-JAVA-STANDALONE))
     (CL:LET*
      ((UNIT NULL) (ITER-001 (%THE-CONS-LIST *TRANSLATIONUNITS*))
       (COLLECT-001 NULL))
      (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-001 NIL)) DO
   ...
   (CL:COND
    ...
    (CL:T
     (CL:LET* ((STREAM-001 (NEW-OUTPUT-STRING-STREAM)))
      (%%PRINT-STREAM (%NATIVE-STREAM STREAM-001) "`" *TRANSLATOROUTPUTLANGUAGE*
       "' is not a valid case option")
  ...
  (CL:LET*
   ...
   (CL:LET*
    ((*TRANSLATIONUNITS* (NEW-LIST)) (*TRANSLATIONVERBOSITYLEVEL* 0)
     (*TRANSLATIONPHASE* NULL) (*TRANSLATIONERRORS* 0) (*TRANSLATIONWARNINGS* 0))
    (CL:DECLARE
    ...
    (CL:COND
     (DECLARATION? (CL:SETQ *TRANSLATIONPHASE* KWD-WALK-DEFINE)
      ...
      (REVERSE *TRANSLATIONUNITS*) (CL:SETQ *TRANSLATIONPHASE* KWD-WALK-FINALIZE)
      (FINALIZE-CLASSES-AND-SLOTS) (CL:SETQ *TRANSLATIONPHASE* KWD-WALK-WALK)
    ...
    (CL:LET* ((UNIT NULL) (ITER-000 (%THE-CONS-LIST *TRANSLATIONUNITS*)))
     (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-000 NIL)) DO
      (CL:PROGN (CL:SETQ UNIT (%%VALUE ITER-000))
       (CL:SETQ ITER-000 (%%REST ITER-000)))
      (FREE UNIT)))
    (CLEAR *TRANSLATIONUNITS*) (CL:WHEN TOPLEVELINVOCATION? (SWEEP-TRANSIENTS))
...
(CL:DEFUN TRANSLATION-ERRORS? ()
  (CL:RETURN-FROM TRANSLATION-ERRORS?
   (CL:AND (CL:> *TRANSLATIONERRORS* 0) (CL:NOT (IGNORE-TRANSLATION-ERRORS?)))))

;;; (DEFUN SUMMARIZE-TRANSLATION-ERRORS ...)

(CL:DEFUN SUMMARIZE-TRANSLATION-ERRORS ()
  (CL:WHEN (CL:> *TRANSLATIONERRORS* 0)
   (%%PRINT-STREAM (%NATIVE-STREAM STANDARD-OUTPUT) *TRANSLATIONERRORS* " error")
   (CL:WHEN (CL:> *TRANSLATIONERRORS* 1)
    (%%PRINT-STREAM (%NATIVE-STREAM STANDARD-OUTPUT) "s")))
  (CL:WHEN (CL:> *TRANSLATIONWARNINGS* 0)
   (CL:WHEN (CL:> *TRANSLATIONERRORS* 0)
    (%%PRINT-STREAM (%NATIVE-STREAM STANDARD-OUTPUT) ", "))
   (%%PRINT-STREAM (%NATIVE-STREAM STANDARD-OUTPUT) *TRANSLATIONWARNINGS*
    " warning")
...
(CL:DEFUN PRINT-ERROR-CONTEXT (PREFIX STREAM)
   ...
   ((CL:NOT (CL:EQ *TRANSLATIONPHASE* NULL))
    (CL:COND
     ((CL:EQ *TRANSLATIONPHASE* KWD-WALK-DEFINE)
      (%%PRINT-STREAM (%NATIVE-STREAM STREAM) "defining "))
     ((CL:EQ *TRANSLATIONPHASE* KWD-WALK-FINALIZE)
      (%%PRINT-STREAM (%NATIVE-STREAM STREAM) "finalizing "))
     ((CL:EQ *TRANSLATIONPHASE* KWD-WALK-WALK)
      (%%PRINT-STREAM (%NATIVE-STREAM STREAM) "walking "))
     ((CL:EQ *TRANSLATIONPHASE* KWD-WALK-TRANSLATE)
      (%%PRINT-STREAM (%NATIVE-STREAM STREAM) "translating "))
     (CL:T
      (CL:LET* ((STREAM-000 (NEW-OUTPUT-STRING-STREAM)))
       (%%PRINT-STREAM (%NATIVE-STREAM STREAM-000) "`" *TRANSLATIONPHASE*
        "' is not a valid case option")
       (CL:ERROR (NEW-STELLA-EXCEPTION (THE-STRING-READER STREAM-000)))))))
  ...
  (CL:COND
   ((CL:NOT (CL:EQ *CURRENTTRANSLATIONUNIT* NULL))
    (CL:LET*
     ((OBJECT (%THE-OBJECT *CURRENTTRANSLATIONUNIT*))
      (CATEGORY (%CATEGORY *CURRENTTRANSLATIONUNIT*)))
     (CL:COND
      ((CL:EQ CATEGORY SYM-WALK-STELLA-CLASS)
       (%%PRINT-STREAM (%NATIVE-STREAM STREAM) "class ")
       (CL:COND
      ...
      ((CL:EQ CATEGORY SYM-WALK-STELLA-SLOT)
       (%%PRINT-STREAM (%NATIVE-STREAM STREAM) "external slot ")
       (CL:LET* ((TEST-VALUE-000 (SAFE-PRIMARY-TYPE OBJECT)))
        (CL:COND
         ((CL:EQ TEST-VALUE-000 SGT-WALK-STELLA-CONS)
          (CL:PROGN
           (%%PRINT-STREAM (%NATIVE-STREAM STREAM) (%%VALUE (%%REST OBJECT)) "."
            (%%VALUE (%%REST (%%REST OBJECT))))))
         ((SUBTYPE-OF-STORAGE-SLOT? TEST-VALUE-000)
          (CL:PROGN
           (%%PRINT-STREAM (%NATIVE-STREAM STREAM) (%SLOT-OWNER OBJECT) "."
        ...
        (CL:COND
         ((SUBTYPE-OF-METHOD-SLOT? TEST-VALUE-002)
          (CL:PROGN
           (CL:COND
            ((%WRAPPER-VALUE
              (DYNAMIC-SLOT-VALUE (%DYNAMIC-SLOTS OBJECT)
               SYM-WALK-STELLA-METHOD-MACRO? FALSE-WRAPPER))
             (%%PRINT-STREAM (%NATIVE-STREAM STREAM) "macro "
              (%SLOT-NAME OBJECT)))
            ((%METHOD-FUNCTION? OBJECT)
             (%%PRINT-STREAM (%NATIVE-STREAM STREAM) "function "
              (%SLOT-NAME OBJECT)))
            (CL:T
             (%%PRINT-STREAM (%NATIVE-STREAM STREAM) "method "
              (%SLOT-OWNER OBJECT) "." (%SYMBOL-NAME (%SLOT-NAME OBJECT)))))))
          ...
          (CL:PROGN
           ...
           (%%PRINT-STREAM (%NATIVE-STREAM STREAM)
            (CL:IF (CONS? (%%VALUE (%%REST OBJECT)))
             (%%VALUE (%%VALUE (%%REST OBJECT))) (%%VALUE (%%REST OBJECT))))))
         (CL:T
       ...
       (CL:LET* ((TEST-VALUE-003 (SAFE-PRIMARY-TYPE OBJECT)))
        (CL:COND
         ((SUBTYPE-OF? TEST-VALUE-003 SGT-WALK-STELLA-GLOBAL-VARIABLE)
          (CL:PROGN
           (CL:IF (%VARIABLE-CONSTANT? OBJECT)
            (%%PRINT-STREAM (%NATIVE-STREAM STREAM) "constant ")
            (CL:IF (%VARIABLE-SPECIAL? OBJECT)
             (%%PRINT-STREAM (%NATIVE-STREAM STREAM) "special variable ")
         ...
         ((CL:EQ TEST-VALUE-003 SGT-WALK-STELLA-CONS)
          (CL:PROGN
           (%%PRINT-STREAM (%NATIVE-STREAM STREAM) (%%VALUE OBJECT) " "
            (%%VALUE (%%REST OBJECT)))))
         (CL:T
      ...
      ((CL:EQ CATEGORY SYM-WALK-STELLA-TYPE)
       (%%PRINT-STREAM (%NATIVE-STREAM STREAM) "type ")
...
(CL:DEFVAR *LOG-FUNCTION-CALLS?* FALSE
...
(CL:DEFUN LOG-FUNCTION-CALL? (METHOD)
  (CL:WHEN
   (CL:AND *LOG-FUNCTION-CALLS?*
    (CL:NOT
     (%WRAPPER-VALUE
      (DYNAMIC-SLOT-VALUE (%DYNAMIC-SLOTS METHOD) SYM-WALK-STELLA-SLOT-AUXILIARY?
       FALSE-WRAPPER)))
    (CL:NOT
     (%WRAPPER-VALUE
      (DYNAMIC-SLOT-VALUE (%DYNAMIC-SLOTS METHOD)
   ...
   (CL:LET* ((TEST-VALUE-000 (%SLOT-NAME METHOD)))
    (CL:COND
     ((CL:OR (CL:EQ TEST-VALUE-000 SYM-WALK-STELLA-LOG-FUNCTION-CALL)
      ...
      (CL:RETURN-FROM LOG-FUNCTION-CALL? FALSE))
     (CL:T
           ...
           (CL:PROGN
            (CL:LET* ((FOUND?-000 FALSE))
             (CL:LET*
              ...
              (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-000 NIL)) DO
               (CL:PROGN (CL:SETQ TSPEC (%%VALUE ITER-000))
                (CL:SETQ ITER-000 (%%REST ITER-000)))
               (CL:WHEN (SUB-TYPE-SPEC-OF? TSPEC SGT-WALK-STELLA-OUTPUT-STREAM)
                (CL:SETQ FOUND?-000 TRUE) (CL:RETURN))))
              ...
              (CL:LET*
               ((TSPEC NULL)
                (ITER-001
                 (%THE-CONS-LIST (METHOD-PARAMETER-TYPE-SPECIFIERS METHOD))))
               (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-001 NIL)) DO
                (CL:PROGN (CL:SETQ TSPEC (%%VALUE ITER-001))
                 (CL:SETQ ITER-001 (%%REST ITER-001)))
                (CL:WHEN
                 (SUB-TYPE-SPEC-OF? TSPEC SGT-WALK-STELLA-NATIVE-OUTPUT-STREAM)
             ...
             (CL:WHEN (CL:NOT TEST-VALUE-001)
              (CL:SETQ TEST-VALUE-001
               (CL:AND (CL:NOT (CL:EQ *CURRENTFILE* STELLA::NULL-STRING))
                (CL:OR (DEFINED? (STRING-SEARCH *CURRENTFILE* "cl-primal" 0))
                 (DEFINED?
                  (STRING-SEARCH *CURRENTFILE* "stella-to-cl" 0))))))))))))
       (CL:WHEN TEST-VALUE-001 (CL:RETURN-FROM LOG-FUNCTION-CALL? FALSE))))))
   (CL:RETURN-FROM LOG-FUNCTION-CALL? TRUE))
  (CL:RETURN-FROM LOG-FUNCTION-CALL? FALSE))
...
(CL:DEFUN WRAP-BODY-WITH-LOG-FUNCTION-CALL-TREE (METHOD BODY)
  (CL:IF
   ...
   (CL:RETURN-FROM WRAP-BODY-WITH-LOG-FUNCTION-CALL-TREE
    (CONS
     (LIST* SYM-WALK-STELLA-LOG-FUNCTION-CALL (WRAP-STRING (STRINGIFY METHOD))
      NIL)
...
(CL:DEFUN LOG-FUNCTION-CALL (NAME)
  ...
  (CL:WHEN (DEFINED? *LOG-BREAK-POINT-COUNTER*)
...
(CL:DEFUN VARIABLE-EQL? (VAR1 VAR2)
  (CL:RETURN-FROM VARIABLE-EQL?
   (CL:OR (CL:EQ VAR1 VAR2)
    (STRING-EQL? (%SYMBOL-NAME VAR1) (%SYMBOL-NAME VAR2)))))
...
(CL:DEFUN INSERT-AT-VARIABLE-TABLE (SELF VARIABLE VALUE)
  (CL:LET* ((CURSOR (%THE-KV-LIST SELF)))
   (CL:LOOP WHILE (CL:NOT (CL:EQ CURSOR NULL)) DO
    (CL:WHEN (VARIABLE-EQL? (%KEY CURSOR) VARIABLE)
     (CL:SETF (%VALUE CURSOR) VALUE) (CL:RETURN-FROM INSERT-AT-VARIABLE-TABLE))
...
(CL:DEFUN PUSH-VARIABLE-BINDING (VARIABLE TYPE)
  (CL:LET* ((CLASS (TYPE-SPEC-TO-CLASS TYPE)))
   (CL:WHEN (CL:EQ VARIABLE NULL) (CL:RETURN-FROM PUSH-VARIABLE-BINDING))
   (CL:WHEN
    (CL:AND (CL:EQ CLASS NULL)
     (CL:NOT (CL:EQ TYPE SGT-WALK-STELLA-UNINITIALIZED)))
    (CL:LET* ((*PRINTREADABLY?* TRUE)) (CL:DECLARE (CL:SPECIAL *PRINTREADABLY?*))
     (SIGNAL-TRANSLATION-ERROR)
     (CL:WHEN (CL:NOT (SUPPRESS-WARNINGS?))
      (PRINT-ERROR-CONTEXT ">> ERROR: " STANDARD-ERROR)
      (%%PRINT-STREAM (%NATIVE-STREAM STANDARD-ERROR) EOL
       " No class defined for type: `" (TYPE-SPEC-TO-BASE-TYPE TYPE) "'." EOL)))
   ...
   (CL:WHEN
    ...
    (CL:LET* ((*PRINTREADABLY?* TRUE)) (CL:DECLARE (CL:SPECIAL *PRINTREADABLY?*))
     ...
     (CL:WHEN (CL:NOT (SUPPRESS-WARNINGS?))
      (PRINT-ERROR-CONTEXT ">> ERROR: " STANDARD-ERROR)
      (%%PRINT-STREAM (%NATIVE-STREAM STANDARD-ERROR) EOL " Variable `"
       (DE-UGLIFY-PARSE-TREE VARIABLE) "' is typed with a mixin class which is"
       EOL " illegal when translating to a single-inheritance language." EOL))))
   (CL:SETF (%THE-KV-LIST *LOCALVARIABLETYPETABLE*)
...
(CL:DEFUN POP-VARIABLE-BINDING ()
  (CL:LET* ((KVLIST (%THE-KV-LIST *LOCALVARIABLETYPETABLE*)))
   ...
   (CL:COND
    ((SUBTYPE-OF? (SAFE-PRIMARY-TYPE (%VALUE KVLIST))
   ...
   (CL:WHEN (CL:EQ TYPE NULL)
    (CL:LET* ((*PRINTREADABLY?* TRUE)) (CL:DECLARE (CL:SPECIAL *PRINTREADABLY?*))
     ...
     (CL:WHEN (CL:NOT (SUPPRESS-WARNINGS?))
      (PRINT-ERROR-CONTEXT ">> ERROR: " STANDARD-ERROR)
      (%%PRINT-STREAM (%NATIVE-STREAM STANDARD-ERROR) EOL
       " Undeclared variable `" (DE-UGLIFY-PARSE-TREE VARIABLENAME) "'." EOL)))
    (CL:RETURN-FROM LOOKUP-VARIABLE-TYPE SGT-WALK-STELLA-UNKNOWN))
  ...
  (CL:WHEN (CL:NOT (CL:EQ *CURRENTTRANSLATIONUNIT* NULL))
   (CL:LET*
    ((GLOBAL (LOOKUP-GLOBAL-VARIABLE VARIABLENAME))
     (REFERENCEDGLOBALS (%REFERENCED-GLOBALS *CURRENTTRANSLATIONUNIT*)))
    (CL:WHEN
...
(CL:DEFUN YIELD-LOCAL-VARIABLE-ALIAS (VARIABLE LEVEL)
  ...
  (CL:WHEN (CL:< LEVEL 1)
   (CL:ERROR "Safety violation: INTERNAL ERROR: Variable level must be >= 1"))
  (CL:WHEN (CL:EQ *LOCALGENSYMTABLE* NULL)
   (CL:RETURN-FROM YIELD-LOCAL-VARIABLE-ALIAS
    (LOCAL-GENSYM (%SYMBOL-NAME VARIABLE))))
...
(CL:DEFUN MAYBE-RENAME-LOCAL-VARIABLE (VARIABLE)
  (CL:WHEN (CL:EQ *TRANSLATOROUTPUTLANGUAGE* KWD-WALK-JAVA)
   (CL:LET* ((CURSOR (%THE-KV-LIST *LOCALVARIABLETYPETABLE*)) (LEVEL -1))
    (CL:DECLARE (CL:TYPE CL:FIXNUM LEVEL))
    (CL:LOOP WHILE (CL:NOT (CL:EQ CURSOR NULL)) DO
     (CL:WHEN (VARIABLE-EQL? (%KEY CURSOR) VARIABLE)
    ...
    ((CL:< ARGNUM MINARITY)
     (CL:LET* ((*PRINTREADABLY?* TRUE))
      ...
      (CL:WHEN (CL:NOT (SUPPRESS-WARNINGS?))
       (PRINT-ERROR-CONTEXT ">> ERROR: " STANDARD-ERROR)
       (%%PRINT-STREAM (%NATIVE-STREAM STANDARD-ERROR) EOL
        " Missing arguments in the expression: " EOL " `"
        (DE-UGLIFY-PARSE-TREE TREE) "'." EOL)))
     (CL:RETURN-FROM BAD-ARGUMENT-RANGE? TRUE))
    ((CL:AND (DEFINED? MAXARITY) (CL:> ARGNUM MAXARITY))
     (CL:LET* ((*PRINTREADABLY?* TRUE))
      (CL:DECLARE (CL:SPECIAL *PRINTREADABLY?*)) (SIGNAL-TRANSLATION-ERROR)
      (CL:WHEN (CL:NOT (SUPPRESS-WARNINGS?))
       (PRINT-ERROR-CONTEXT ">> ERROR: " STANDARD-ERROR)
       (%%PRINT-STREAM (%NATIVE-STREAM STANDARD-ERROR) EOL
        " Too many arguments in the expression: " EOL " `"
        (DE-UGLIFY-PARSE-TREE TREE) "'." EOL)))
     (CL:RETURN-FROM BAD-ARGUMENT-RANGE? TRUE))
  ...
  (CL:CASE (LENGTH (%%REST PROGN-TREE)) (0 (CL:RETURN-FROM OPTIMIZE-PROGN NIL))
   (1
    (CL:LET* ((TREE (%%VALUE (%%REST PROGN-TREE))))
     (SECOND-SETTER PROGN-TREE NULL) (CL:RETURN-FROM OPTIMIZE-PROGN TREE)))
...
(CL:DEFUN WRAPPER-VALUE-TYPE (SELF)
  ...
  (CL:LET*
   ...
   (CL:IF (CL:EQ VALUETYPE WRAPPERTYPE)
    (CL:ERROR (NEW-STELLA-EXCEPTION "Missing *wrapped-type-table* entry"))
  ...
  (CL:WHEN (CL:EQ (%SURROGATE-VALUE SELF) NULL)
   (CL:LET* ((*PRINTREADABLY?* TRUE)) (CL:DECLARE (CL:SPECIAL *PRINTREADABLY?*))
    ...
    (CL:WHEN (CL:NOT (SUPPRESS-WARNINGS?))
     (PRINT-ERROR-CONTEXT ">> ERROR: " STANDARD-ERROR)
     (%%PRINT-STREAM (%NATIVE-STREAM STANDARD-ERROR) EOL
      " Can't find a class named `" (DE-UGLIFY-PARSE-TREE SELF) "'." EOL)))
...
(CL:DEFUN LOOKUP-COERSION-METHOD (SOURCETYPE TARGETTYPE EXPRESSION)
  ...
  (CL:LET* ((TRIPLE NULL) (ITER-000 *COERSION-TABLE*))
   (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-000 NIL)) DO
    (CL:PROGN (CL:SETQ TRIPLE (%%VALUE ITER-000))
     (CL:SETQ ITER-000 (%%REST ITER-000)))
    (CL:WHEN
...
(CL:DEFUN APPLY-COERCION-METHOD (EXPRESSION SOURCETYPE TARGETTYPE COERCIONMETHOD)
  ...
  (CL:WHEN (CL:EQ COERCIONMETHOD NULL)
   (CL:RETURN-FROM APPLY-COERCION-METHOD (CL:VALUES EXPRESSION SOURCETYPE)))
    ...
    ((SUBTYPE-OF-SYMBOL? TEST-VALUE-000)
     (CL:PROGN
      (CL:RETURN-FROM APPLY-COERCION-METHOD
       (WALK-EXPRESSION-TREE (CONS COERCIONMETHOD (CONS EXPRESSION NIL))
     ...
     (CL:PROGN
      (CL:RETURN-FROM APPLY-COERCION-METHOD
       (WALK-EXPRESSION-TREE
        (COPY-CONS-TREE
         (SUBSTITUTE-CONS-TREE (COPY-CONS-TREE COERCIONMETHOD) EXPRESSION
          SYM-WALK-STELLA-<X>))
        TARGETTYPE (%%VALUE COERCIONMETHOD) FALSE))))
    (CL:T
     (CL:LET* ((STREAM-000 (NEW-OUTPUT-STRING-STREAM)))
      (%%PRINT-STREAM (%NATIVE-STREAM STREAM-000) "`" TEST-VALUE-000
       "' is not a valid case option")
...
(CL:DEFUN VERIFY-TYPE (SELF)
  (CL:WHEN
   (CL:AND (CL:NOT (CL:EQ (%SURROGATE-VALUE SELF) NULL))
    (CL:NOT (STELLA-CLASS? (%SURROGATE-VALUE SELF))))
   (CL:WARN "Illegal object `~A' found~%   where STELLA class expected~%"
  ...
  (CL:WHEN
   ...
   (CL:LET* ((*PRINTREADABLY?* TRUE)) (CL:DECLARE (CL:SPECIAL *PRINTREADABLY?*))
    ...
    (CL:WHEN (CL:NOT (SUPPRESS-WARNINGS?))
     ...
     (%%PRINT-STREAM (%NATIVE-STREAM STANDARD-OUTPUT) EOL
      " Reference to undefined class `" (%SYMBOL-NAME SELF) "'." EOL)))
   (CL:SETF (%SURROGATE-VALUE SELF) (%SURROGATE-VALUE SGT-WALK-STELLA-UNKNOWN)))
...
(CL:DEFUN WARN-ABOUT-UNKNOWN-SOURCE-TYPE (TREE)
  (CL:WHEN (WARN-ABOUT-UNDEFINED-METHODS?)
         ...
         ((CL:EQ TEST-VALUE-000 SYM-WALK-STELLA-SYS-CALL-METHOD)
          (CL:WHEN
           (CL:OR (SYMBOL-COMMON-LISP? (%%VALUE (%%REST (%%REST TREE))))
            (CL:EQ
             (LOOKUP-SLOT (%SURROGATE-VALUE (%%VALUE (%%REST TREE)))
              (%%VALUE (%%REST (%%REST TREE))))
             NULL))
           (CL:RETURN-FROM WARN-ABOUT-UNKNOWN-SOURCE-TYPE)))
         ((CL:EQ TEST-VALUE-000 SYM-WALK-STELLA-SYS-CALL-FUNCTION)
          (CL:WHEN
           (CL:EQ (%SLOT-BASE-TYPE (LOOKUP-FUNCTION (%%VALUE (%%REST TREE))))
            SGT-WALK-STELLA-UNKNOWN)
           (CL:RETURN-FROM WARN-ABOUT-UNKNOWN-SOURCE-TYPE)))
   ...
   (CL:LET* ((*PRINTREADABLY?* TRUE)) (CL:DECLARE (CL:SPECIAL *PRINTREADABLY?*))
    ...
    (CL:WHEN (CL:NOT (SUPPRESS-WARNINGS?))
     (PRINT-ERROR-CONTEXT ">> ERROR: " STANDARD-ERROR)
     (%%PRINT-STREAM (%NATIVE-STREAM STANDARD-ERROR) EOL " The expression" EOL
      "   `" (DE-UGLIFY-PARSE-TREE TREE) "'" EOL " has UNKNOWN type." EOL))))
  :VOID)

;;; (DEFUN (COERCE-A-TREE OBJECT TYPE-SPEC) ...)

(CL:DEFUN COERCE-A-TREE (TREE SOURCETYPE TARGETTYPE)
  (CL:LET* ((OTREE NULL) (OTYPE NULL) (COERCIBLE? FALSE))
   ...
   (CL:WHEN (CL:NOT COERCIBLE?)
    (CL:LET* ((*PRINTREADABLY?* TRUE)) (CL:DECLARE (CL:SPECIAL *PRINTREADABLY?*))
     ...
     (CL:WHEN (CL:NOT (SUPPRESS-WARNINGS?))
      (PRINT-ERROR-CONTEXT ">> ERROR: " STANDARD-ERROR)
      (%%PRINT-STREAM (%NATIVE-STREAM STANDARD-ERROR) EOL
       " Type conflict: the expression:" EOL "   `" (DE-UGLIFY-PARSE-TREE TREE)
       "'" EOL " has type `" (YIELD-TYPE-SPEC-TREE SOURCETYPE)
       "' but should have type `" (YIELD-TYPE-SPEC-TREE TARGETTYPE) "'." EOL))))
...
(CL:DEFUN HELP-COERCE-A-TREE (TREE SOURCETYPE TARGETTYPE TESTONLY?)
  (CL:LET*
   ...
   (CL:WHEN (CL:EQ SOURCETYPE SGT-WALK-STELLA-UNKNOWN)
    ...
    (CL:IF
     ...
     (CL:RETURN-FROM HELP-COERCE-A-TREE
      (CL:VALUES (TYPE-TO-WALKED-NULL-VALUE-TREE TARGETBASETYPE) TARGETTYPE
       TRUE))
   ...
   (CL:WHEN (CL:EQ (%SURROGATE-VALUE SOURCEBASETYPE) NULL)
    (CL:LET* ((*PRINTREADABLY?* TRUE)) (CL:DECLARE (CL:SPECIAL *PRINTREADABLY?*))
     ...
     (CL:WHEN (CL:NOT (SUPPRESS-WARNINGS?))
      (PRINT-ERROR-CONTEXT ">> ERROR: " STANDARD-ERROR)
      (%%PRINT-STREAM (%NATIVE-STREAM STANDARD-ERROR) EOL
       " No class defined for type: `" (DE-UGLIFY-PARSE-TREE SOURCEBASETYPE) "'."
       EOL)))
    (CL:RETURN-FROM HELP-COERCE-A-TREE (CL:VALUES TREE TARGETTYPE TRUE)))
   (CL:WHEN
    (CL:AND (CL:NOT (CL:EQ TARGETBASETYPE NULL))
     (CL:EQ (%SURROGATE-VALUE TARGETBASETYPE) NULL))
    (CL:LET* ((*PRINTREADABLY?* TRUE)) (CL:DECLARE (CL:SPECIAL *PRINTREADABLY?*))
     (SIGNAL-TRANSLATION-ERROR)
     (CL:WHEN (CL:NOT (SUPPRESS-WARNINGS?))
      (PRINT-ERROR-CONTEXT ">> ERROR: " STANDARD-ERROR)
      (%%PRINT-STREAM (%NATIVE-STREAM STANDARD-ERROR) EOL
       " No class defined for type: `" (DE-UGLIFY-PARSE-TREE TARGETBASETYPE) "'."
       EOL)))
    (CL:RETURN-FROM HELP-COERCE-A-TREE (CL:VALUES TREE SOURCETYPE TRUE)))
   ...
   (CL:WHEN
    ...
    (CL:LET* ((TEST-VALUE-000 FALSE)) (CL:SETQ TEST-VALUE-000 (TYPE? SOURCETYPE))
     (CL:WHEN TEST-VALUE-000
      (CL:LET* ()
    ...
    (CL:WHEN (SUBTYPE-OF? TARGETBASETYPE SOURCEBASETYPE)
     ...
     (CL:RETURN-FROM HELP-COERCE-A-TREE
      (CL:VALUES
       (WALK-WITHOUT-TYPE-TREE
        (CONS
         (CL:IF (CL:NOT (CL:EQ REALSOURCETYPE NULL)) SYM-WALK-STELLA-SAFE-CAST
          SYM-WALK-STELLA-CAST)
       ...
       (CL:WHEN (CL:NOT (CL:EQ COERSIONFUNCTION NULL))
        (CL:MULTIPLE-VALUE-SETQ (TREE TARGETTYPE)
         (APPLY-COERCION-METHOD
          (LIST* SYM-WALK-STELLA-CAST TREE (CONS WRAPPERTYPE NIL)) SOURCETYPE
          TARGETBASETYPE COERSIONFUNCTION))
        (CL:RETURN-FROM HELP-COERCE-A-TREE (CL:VALUES TREE TARGETTYPE TRUE)))))))
    ...
    (CL:WHEN (CL:AND (VOID? SOURCETYPE) (CL:NOT (VOID? TARGETTYPE)))
     (CL:LET* ((*PRINTREADABLY?* TRUE))
      ...
      (CL:WHEN (CL:NOT (SUPPRESS-WARNINGS?))
       (PRINT-ERROR-CONTEXT ">> ERROR: " STANDARD-ERROR)
       (%%PRINT-STREAM (%NATIVE-STREAM STANDARD-ERROR) EOL
        " Illegal argument to `" (DE-UGLIFY-PARSE-TREE OPERATORNAME) "':" EOL
...
(CL:DEFUN WALK-LIST-OF-TREES (TREES)
  (CL:LET* ((CURSOR TREES))
   (CL:LOOP WHILE (CL:NOT (CL:EQ CURSOR NIL)) DO
    (CL:SETF (%%VALUE CURSOR) (WALK-STATEMENT (%%VALUE CURSOR) FALSE))
    (CL:SETQ CURSOR (%%REST CURSOR)))
...
(CL:DEFUN WALK-LIST-OF-STATEMENTS (TREES)
  (CL:LET* ((OTREES NIL))
   (CL:LET*
    ((OTREE NULL) (ITER-000 (WALK-LIST-OF-TREES TREES)) (COLLECT-000 NULL))
    (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-000 NIL)) DO
     (CL:PROGN (CL:SETQ OTREE (%%VALUE ITER-000))
      (CL:SETQ ITER-000 (%%REST ITER-000)))
     (CL:WHEN (CONS? OTREE)
      (CL:IF (CL:EQ COLLECT-000 NULL)
   ...
   (CL:COND
    ...
    (CL:T
     (CL:WHEN
      ...
      (CL:LET* ((*PRINTREADABLY?* TRUE))
       (CL:DECLARE (CL:SPECIAL *PRINTREADABLY?*)) (SIGNAL-TRANSLATION-WARNING)
       (CL:WHEN (CL:NOT (SUPPRESS-WARNINGS?))
        (PRINT-ERROR-CONTEXT ">> WARNING: " STANDARD-OUTPUT)
        (%%PRINT-STREAM (%NATIVE-STREAM STANDARD-OUTPUT) EOL
...
(CL:DEFUN SYS-TREE (TREE TYPESPEC)
  ...
  (CL:IF (VOID? TYPESPEC)
   (CL:RETURN-FROM SYS-TREE
    (CL:VALUES (LIST* SYM-WALK-STELLA-VOID-SYS TREE NIL) SGT-WALK-STELLA-VOID))
   (CL:RETURN-FROM SYS-TREE
    (CL:VALUES (LIST* SYM-WALK-STELLA-TYPED-SYS TREE (CONS TYPESPEC NIL))
     TYPESPEC))))
  ...
  (CL:LET*
   ...
   (CL:WHEN (CL:NOT (CL:EQ *TRANSLATOROUTPUTLANGUAGE* KWD-WALK-COMMON-LISP))
    ...
    (CL:IF (CL:NOT (CL:EQ NATIVESLOTHOME NULL))
     ...
     (CL:SETQ SLOTTYPE
      (TYPE-SPEC-TO-BASE-TYPE
       (COMPUTE-RETURN-TYPE-SPEC SLOT (TYPE-SPEC-TO-BASE-TYPE FIRSTARGTYPE)))))
    (CL:WHEN (CL:EQ SLOTTYPE (TYPE-SPEC-TO-BASE-TYPE RETURNTYPE))
     (CL:SETQ SLOTTYPE RETURNTYPE)))
   (CL:WHEN (CL:NOT (CL:EQ SLOT CANONICALSLOT))
    (CL:SETQ SLOTTYPE (%SLOT-BASE-TYPE CANONICALSLOT)))
...
(CL:DEFUN SYS-TREE-IF-NEEDED (SLOT TREE FIRSTARGTYPE RETURNTYPE)
  (CL:WHEN
   (CL:AND (CL:NOT (CL:EQ SLOT NULL)) (CL:NOT (PROCEDURAL-EXPRESSION? TREE)))
   (CL:LET* ((TEST-VALUE-000 (SAFE-PRIMARY-TYPE SLOT)))
    (CL:COND
     ((SUBTYPE-OF-METHOD-SLOT? TEST-VALUE-000)
      (CL:PROGN
       (CL:WHEN
        (CL:AND (CL:NOT (%METHOD-FUNCTION? SLOT))
        ...
        (CL:WHEN (CL:NOT (CL:EQ RETURNTYPE REALSLOTTYPE))
         (CL:WHEN
          (CL:AND (CL:EQ REALSLOTTYPE SGT-WALK-STELLA-UNKNOWN)
           (CL:NOT
            (CL:EQ SLOT (CL:SETQ REALSLOT (SLOT-FROM-EXPRESSION-TREE TREE))))
           (METHOD-SLOT? REALSLOT))
          (CL:RETURN-FROM SYS-TREE-IF-NEEDED
           (SYS-TREE-IF-NEEDED REALSLOT TREE FIRSTARGTYPE RETURNTYPE)))
         (CL:RETURN-FROM SYS-TREE-IF-NEEDED
          (SET-TARGET-LANGUAGE-TYPE (SYS-TREE TREE RETURNTYPE) REALSLOTTYPE))))))
     (CL:T
      (CL:LET* ((STREAM-000 (NEW-OUTPUT-STRING-STREAM)))
       (%%PRINT-STREAM (%NATIVE-STREAM STREAM-000) "`" TEST-VALUE-000
        "' is not a valid case option")
   ...
   (CL:LET*
    ...
    (CL:LET* ((TEST-VALUE-001 FALSE))
     ...
     (CL:WHEN TEST-VALUE-001
      (CL:IF (ANCHORED-TYPE-SPECIFIER? SLOTTYPE) (CL:SETQ TEST-VALUE-001 TRUE)
       (CL:LET* ((FOUND?-000 FALSE))
        (CL:LET*
         ((TS NULL)
          (ITER-000 (%THE-CONS-LIST (%SPECIFIER-PARAMETER-TYPES SLOTTYPE))))
         (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-000 NIL)) DO
          (CL:PROGN (CL:SETQ TS (%%VALUE ITER-000))
           (CL:SETQ ITER-000 (%%REST ITER-000)))
          (CL:WHEN (ANCHORED-TYPE-SPECIFIER? TS) (CL:SETQ FOUND?-000 TRUE)
           (CL:RETURN))))
        (CL:SETQ TEST-VALUE-001 FOUND?-000))))
     (CL:WHEN TEST-VALUE-001
      (CL:IF
       ...
       (CL:RETURN-FROM SYS-TREE-IF-NEEDED
        (SET-TARGET-LANGUAGE-TYPE (SYS-TREE TREE RETURNTYPE)
         (CL:IF (CL:EQ (%SLOT-BASE-TYPE SLOT) SGT-WALK-STELLA-UNKNOWN)
          (TYPE-SPEC-TO-BASE-TYPE RETURNTYPE) (%SLOT-BASE-TYPE SLOT))))
...
(CL:DEFUN HELP-WALK-A-TREE (TREE)
  (CL:IF (CL:EQ TREE NULL)
   (CL:RETURN-FROM HELP-WALK-A-TREE (CL:VALUES NULL SGT-WALK-STELLA-UNKNOWN))
   (CL:COND
    ((CL:EQ (SAFE-PRIMARY-TYPE TREE) SGT-WALK-STELLA-CONS)
     (CL:PROGN
      (CL:WHEN (CL:EQ TREE NIL)
       (CL:RETURN-FROM HELP-WALK-A-TREE (CL:VALUES NIL SGT-WALK-STELLA-CONS)))
      (CL:WHEN (CONS? (%%VALUE TREE))
       (CL:LET* ((*PRINTREADABLY?* TRUE))
        ...
        (CL:WHEN (CL:NOT (SUPPRESS-WARNINGS?))
         (PRINT-ERROR-CONTEXT ">> ERROR: " STANDARD-ERROR)
         (%%PRINT-STREAM (%NATIVE-STREAM STANDARD-ERROR) EOL
          " Unimplemented or illegal parse tree: `" (DE-UGLIFY-PARSE-TREE TREE)
          "'." EOL)))
      ...
      (CL:WHEN (CL:NOT (CONS? (%%REST TREE)))
       (CL:LET* ((*PRINTREADABLY?* TRUE))
        ...
        (CL:WHEN (CL:NOT (SUPPRESS-WARNINGS?))
         (PRINT-ERROR-CONTEXT ">> ERROR: " STANDARD-ERROR)
         (%%PRINT-STREAM (%NATIVE-STREAM STANDARD-ERROR) EOL
          " Illegal dotted pair or list*." EOL)))
       (CL:RETURN-FROM HELP-WALK-A-TREE (CL:VALUES TREE SGT-WALK-STELLA-VOID)))
      (CL:LET* ((TEST-VALUE-000 (%%VALUE TREE)))
       (CL:COND
        ((CL:EQ TEST-VALUE-000 SYM-WALK-STELLA-VOID-SYS)
...
(CL:DEFUN INCREMENTAL-TRANSLATION? ()
  (CL:RETURN-FROM INCREMENTAL-TRANSLATION?
   (CL:EQ *CURRENTFILE* STELLA::NULL-STRING)))
  ...
  (CL:LET* ((PREFIX STELLA::NULL-STRING) (ENVIRONMENTNAME ""))
   ...
   (CL:WHEN (CL:NOT (CL:EQ (%HOME-CONTEXT SYMBOL) NULL))
    (CL:SETQ ENVIRONMENTNAME
     (CONCATENATE (%MODULE-NAME (%HOME-CONTEXT SYMBOL)) "-")))
   (CL:WHEN
    (CL:NOT
     (CL:OR (INCREMENTAL-TRANSLATION?)
      (CL:EQ *TRANSLATOROUTPUTLANGUAGE* KWD-WALK-JAVA)))
   ...
   (CL:LET* ((TEST-VALUE-000 (SAFE-PRIMARY-TYPE SYMBOL)))
    (CL:COND
     ((SUBTYPE-OF-SYMBOL? TEST-VALUE-000) (CL:PROGN (CL:SETQ PREFIX "SYM-")))
   ...
   (CL:RETURN-FROM CONSTRUCT-SYMBOL-CONSTANT-NAME
    (CONCATENATE PREFIX ENVIRONMENTNAME (%SYMBOL-NAME SYMBOL)))))
(CL:DECLAIM
 (CL:FTYPE (CL:FUNCTION (CL:T) CL:SIMPLE-STRING) CONSTRUCT-SYMBOL-CONSTANT-NAME))
...
(CL:DEFUN YIELD-SYMBOL-CONSTANT-NAME (SYMBOL)
  ...
  (CL:COND
   ((SUBTYPE-OF-KEYWORD? (SAFE-PRIMARY-TYPE SYMBOL))
    (CL:PROGN
     (CL:RETURN-FROM YIELD-SYMBOL-CONSTANT-NAME
      (INTERN-SYMBOL-IN-MODULE
       (STRING-UPCASE (CONSTRUCT-SYMBOL-CONSTANT-NAME SYMBOL)) *MODULE* TRUE))))
   (CL:T
    (CL:RETURN-FROM YIELD-SYMBOL-CONSTANT-NAME
     (INTERN-SYMBOL-IN-MODULE
      (STRING-UPCASE (CONSTRUCT-SYMBOL-CONSTANT-NAME SYMBOL)) *MODULE* TRUE)))))
   ...
   (CL:SETQ TREE
    (LIST* SYM-WALK-STELLA-DEFGLOBAL SYMBOLCONSTANT
     (CONS SYMBOLCONSTANTTYPETREE
      (LIST* SYM-WALK-STELLA-NULL KWD-WALK-PUBLIC? SYM-WALK-STELLA-TRUE NIL))))
      ...
      (CONS
       (LIST* SYM-WALK-STELLA-SAFE-CAST
        (LIST* SYM-WALK-STELLA-INTERN-RIGID-SYMBOL-WRT-MODULE
         (WRAP-STRING (%SYMBOL-NAME SYMBOL))
         (CONS
          (CL:IF
           (CL:OR (CL:EQ (%HOME-CONTEXT SYMBOL) *MODULE*) (KEYWORD? SYMBOL))
           SYM-WALK-STELLA-NULL
           (LIST* SYM-WALK-STELLA-GET-STELLA-MODULE
            (WRAP-STRING (%MODULE-FULL-NAME (%HOME-CONTEXT SYMBOL)))
...
(CL:DEFUN CLEAR-SYMBOL-REGISTRY ()
  (CL:LET* ((SYMBOL NULL) (ITER-000 (%THE-CONS-LIST *SYMBOL-SET*)))
   (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-000 NIL)) DO
    (CL:PROGN (CL:SETQ SYMBOL (%%VALUE ITER-000))
     (CL:SETQ ITER-000 (%%REST ITER-000)))
...
(CL:DEFUN YIELD-HARDCODED-INTERN-REGISTERED-SYMBOLS-TREE ()
  (CL:LET*
   ...
   (CL:LET*
    ((SYMBOL NULL) (ITER-000 (%THE-CONS-LIST *SYMBOL-SET*)) (COLLECT-000 NULL))
    (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-000 NIL)) DO
     (CL:PROGN (CL:SETQ SYMBOL (%%VALUE ITER-000))
      (CL:SETQ ITER-000 (%%REST ITER-000)))
     (CL:IF (CL:EQ COLLECT-000 NULL)
        ...
        (CONS
         (CONS
          (CL:IF (SYMBOL? SYMBOL) SYM-WALK-STELLA-INTERN-SYMBOL-AT
           (CL:IF (SURROGATE? SYMBOL) SYM-WALK-STELLA-INTERN-SURROGATE-AT
            SYM-WALK-STELLA-INTERN-KEYWORD-AT))
          (CONS (WRAP-STRING (%SYMBOL-NAME SYMBOL))
           (CONS (WRAP-INTEGER (%SYMBOL-ID SYMBOL)) NIL)))
         NIL))
...
(CL:DEFMETHOD WALK-ATOMIC-TREE ((SELF SYMBOL))
  ...
  (CL:WHEN
   (CL:AND *INLININGMETHODCALL?*
    (CL:NOT
     (CL:EQ (GET-LOCAL-VARIABLE-INFO SELF KWD-WALK-INLINE-ARGUMENT) NULL)))
   (CL:RETURN-FROM WALK-ATOMIC-TREE (WALK-INLINE-VARIABLE-REFERENCE SELF)))
  (CL:LET*
   ((TRUENAME (TRUE-VARIABLE-NAME SELF)) (TYPE (LOOKUP-VARIABLE-TYPE SELF)))
   ...
   ((CL:EQ (SAFE-PRIMARY-TYPE TREE) SGT-WALK-STELLA-CONS)
    (CL:PROGN
     (CL:COND
      ...
      (CL:T))
     (CL:RETURN-FROM ATOMIC-EXPRESSION? FALSE)))
   (CL:T (CL:RETURN-FROM ATOMIC-EXPRESSION? TRUE))))
    ...
    ((CL:EQ TEST-VALUE-000 SGT-WALK-STELLA-CONS)
     (CL:PROGN
      (CL:COND
       ...
       (CL:T))
      (CL:RETURN-FROM VARIABLE-EXPRESSION? FALSE)))
    ((SUBTYPE-OF-SYMBOL? TEST-VALUE-000)
     (CL:PROGN (CL:RETURN-FROM VARIABLE-EXPRESSION? TRUE)))
    (CL:T (CL:RETURN-FROM VARIABLE-EXPRESSION? FALSE)))))
...
(CL:DEFUN PROCEDURAL-EXPRESSION? (TREE)
  (CL:LET* ((TEST-VALUE-000 FALSE)) (CL:SETQ TEST-VALUE-000 (CONS? TREE))
   (CL:WHEN TEST-VALUE-000
      ...
      (CL:LET* ((TERM NULL) (ITER-000 (%%REST TREE)))
       (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-000 NIL)) DO
        (CL:PROGN (CL:SETQ TERM (%%VALUE ITER-000))
         (CL:SETQ ITER-000 (%%REST ITER-000)))
        (CL:WHEN (PROCEDURAL-EXPRESSION? TERM) (CL:SETQ FOUND?-000 TRUE)
         (CL:RETURN))))
...
(CL:DEFUN HELP-TRANSFORM-BOOLEAN-PROCEDURAL-EXPRESSION (EXPRESSION TESTVARIABLE)
  ...
  (CL:LET*
   ((EXP EXPRESSION) (OPERATOR (%%VALUE EXP)) (FIRSTARG (%%VALUE (%%REST EXP)))
        ...
        (CL:RETURN-FROM HELP-TRANSFORM-BOOLEAN-PROCEDURAL-EXPRESSION
         (LIST* (LIST* SYM-WALK-STELLA-SETQ TESTVARIABLE (CONS FIRSTARG NIL))
          (LIST* SYM-WALK-STELLA-WHEN TESTVARIABLE
           (CONCATENATE
            (HELP-TRANSFORM-BOOLEAN-PROCEDURAL-EXPRESSION
             (CONS SYM-WALK-STELLA-AND (CONCATENATE OTHERARGS NIL)) TESTVARIABLE)
            NIL))
          NIL)))))
     ((CL:EQ TEST-VALUE-000 SYM-WALK-STELLA-OR)
      (CL:COND
         ...
         (CONCATENATE
          ...
          (CONS
           (LIST* SYM-WALK-STELLA-WHEN
            ...
            (CONCATENATE
             (HELP-TRANSFORM-BOOLEAN-PROCEDURAL-EXPRESSION
              (CONS SYM-WALK-STELLA-OR (CONCATENATE OTHERARGS NIL)) TESTVARIABLE)
             NIL))
           NIL))))
       (CL:T
        (CL:LET*
         ...
         (CL:WHEN (CL:NOT (CL:EQ (%%REST OTHERARGSTEST) NIL))
          (CL:SETQ OTHERARGSTEST
           (CONS (CONS SYM-WALK-STELLA-PROGN (CONCATENATE OTHERARGSTEST NIL))
            NIL)))
         (CL:RETURN-FROM HELP-TRANSFORM-BOOLEAN-PROCEDURAL-EXPRESSION
          (CONS
     ...
     ((CL:EQ TEST-VALUE-000 SYM-WALK-STELLA-VRLET)
      (CL:LET* ((CURSOR OTHERARGS))
       ...
       (CL:SETF (%%VALUE CURSOR)
        (LIST* SYM-WALK-STELLA-SETQ TESTVARIABLE (CONS (%%VALUE CURSOR) NIL))))
      (CL:RETURN-FROM HELP-TRANSFORM-BOOLEAN-PROCEDURAL-EXPRESSION
       (CONS (LIST* SYM-WALK-STELLA-LET FIRSTARG (CONCATENATE OTHERARGS NIL))
        NIL)))
     (CL:T
      (CL:LET* ((STREAM-000 (NEW-OUTPUT-STRING-STREAM)))
       (%%PRINT-STREAM (%NATIVE-STREAM STREAM-000) "`" TEST-VALUE-000
   ...
   (CL:SETQ OTREE
    (WALK-WITHOUT-TYPE-TREE
     (LIST* SYM-WALK-STELLA-LET
      ...
      (CONCATENATE
       (HELP-TRANSFORM-BOOLEAN-PROCEDURAL-EXPRESSION VREXPRESSION TESTVARIABLE)
       (CONS STATEMENT NIL)))))
   (CL:RETURN-FROM TRANSFORM-BOOLEAN-PROCEDURAL-EXPRESSION
...
(CL:DEFUN PERCOLATE-OUT-VRLET-EXPRESSION (STATEMENT VREXPRESSION TYPE)
  (CL:LET* ((LASTSTATEMENT NULL) (CURSOR (%%REST (%%REST VREXPRESSION))))
   (CL:LOOP WHILE (CL:NOT (CL:EQ CURSOR NIL)) DO
    (CL:WHEN (CL:EQ (%%REST CURSOR) NIL) (CL:SETQ LASTSTATEMENT (%%VALUE CURSOR))
     (CL:SETF (%%VALUE CURSOR) KWD-WALK-PLACE-WHERE-LAST-EXPRESSION-WAS)
     (CL:RETURN))
    (CL:SETQ CURSOR (%%REST CURSOR)))
...
(CL:DEFUN WALK-SETQ-TREE (TREE)
  (CL:WHEN (BAD-ARGUMENT-COUNT? TREE 2)
   (CL:RETURN-FROM WALK-SETQ-TREE
    (WALK-DONT-CALL-ME-TREE TREE SGT-WALK-STELLA-VOID)))
  (CL:LET*
   ((VARIABLE (%%VALUE (%%REST TREE))) (VALUE (%%VALUE (%%REST (%%REST TREE))))
    (VARIABLETYPE NULL) (OVALUE NULL) (OTYPE NULL))
   ...
   (CL:MULTIPLE-VALUE-SETQ (OVALUE OTYPE)
    (WALK-EXPRESSION-TREE VALUE VARIABLETYPE SYM-WALK-STELLA-SETQ TRUE))
     ...
     (CONS OBJECTREF
      (CONS
       (WALK-EXPRESSION-TREE VALUETREE (TYPE SLOT)
        SYM-WALK-STELLA-SLOT-VALUE-SETTER FALSE)
       NIL))))))
   ...
   (CL:WHEN
    (CL:NOT
     (CL:AND (CL:NOT (CL:EQ PLACE NULL)) (SYMBOL? (%%VALUE PLACE))
      (CL:>= (LENGTH PLACE)
       (CL:IF (CL:EQ (%%VALUE PLACE) SYM-WALK-STELLA-SLOT-VALUE) 3 2))))
    (CL:LET* ((*PRINTREADABLY?* TRUE)) (CL:DECLARE (CL:SPECIAL *PRINTREADABLY?*))
     (SIGNAL-TRANSLATION-ERROR)
     (CL:WHEN (CL:NOT (SUPPRESS-WARNINGS?))
      (PRINT-ERROR-CONTEXT ">> ERROR: " STANDARD-ERROR)
        ...
        (CL:PROGN
         (CL:WHEN
          (CL:OR (CL:NOT (CL:EQ (WRITER SLOT) NULL))
           (CL:NOT
            (CL:EQ (LOOKUP-SLOT OBJECTCLASS (YIELD-SETTER-METHOD-NAME SLOTNAME))
             NULL)))
          (CL:RETURN-FROM WALK-SETF-TREE
           (WALK-A-CONS-TREE
            (CONS
            ...
            (SYS-TREE-IF-NEEDED SLOT
             (LIST* SYM-WALK-STELLA-SYS-CALL-METHOD (%SLOT-OWNER SLOT)
              (CONS (YIELD-SETTER-METHOD-NAME SLOTNAME)
               (CONS OBJECTREF
                (CONS
                 (WALK-EXPRESSION-TREE VALUEREF SLOTTYPE SYM-WALK-STELLA-SETF
                  FALSE)
                 NIL))))
             OBJECTTYPE SLOTTYPE))
           (CL:RETURN-FROM WALK-SETF-TREE (CL:VALUES VALUE-000 VALUE-001))))
         (CL:SETQ OTREE
          (YIELD-SLOT-VALUE-SETTER-TREE SLOT OBJECTREF OBJECTTYPE VALUEREF
           SLOTTYPE NULL))
  ...
  (CL:LET* ((TEST-VALUE-000 (ALLOCATION SLOT)))
   (CL:COND
         ...
         (CL:IF (SLOT-VALUE-IS-BARE-LITERAL? SLOT)
          (LIST* SYM-WALK-STELLA-LET
           ...
           (LIST* SYM-WALK-STELLA-SETQ ANSWERVAR
            (CONS
             (LIST* SYM-WALK-STELLA-WRAPPER-VALUE SYM-WALK-STELLA-WRAPPEDVALUE
              NIL)
             NIL))
           NIL)
          (LIST* SYM-WALK-STELLA-SETQ ANSWERVAR
    ...
    ((CL:EQ TEST-VALUE-000 KWD-WALK-BIT)
     (CL:ERROR (NEW-STELLA-EXCEPTION "Allocation :bit IS NOT YET IMPLEMENTED")))
    (CL:T
     (CL:LET* ((STREAM-000 (NEW-OUTPUT-STRING-STREAM)))
      (%%PRINT-STREAM (%NATIVE-STREAM STREAM-000) "`" TEST-VALUE-000
       "' is not a valid case option")
  ...
  (CL:LET* ((SLOTNAME (%SLOT-NAME SLOT)))
   (CL:WHEN (STANDARD-DYNAMIC-SLOT-ACCESS? SLOT)
    (CL:RETURN-FROM YIELD-DYNAMIC-SLOT-VALUE-SETTER-TREE
     (YIELD-STANDARD-DYNAMIC-SLOT-VALUE-SETTER-TREE SLOT OBJECTREF VALUEREF
      RETURNTYPE)))
   (CL:LET* ((TEST-VALUE-000 (ALLOCATION SLOT)))
    (CL:COND
     ((CL:EQ TEST-VALUE-000 KWD-WALK-DYNAMIC)
      (CL:RETURN-FROM YIELD-DYNAMIC-SLOT-VALUE-SETTER-TREE
       (LIST* SYM-WALK-STELLA-VRLET
        (LIST*
         ...
         (LIST* SYM-WALK-STELLA-FOUNDMATCHINGENTRY? SYM-WALK-STELLA-FALSE NIL)
         NIL)
        (LIST* SYM-WALK-STELLA-FOREACH SYM-WALK-STELLA-IT SYM-WALK-STELLA-ON
         SYM-WALK-STELLA-DYNAMICSLOTS SYM-WALK-STELLA-WHERE
         (LIST* SYM-WALK-STELLA-EQ?
          (LIST* SYM-WALK-STELLA-KEY SYM-WALK-STELLA-IT NIL)
         ...
         (CL:IF (SLOT-VALUE-IS-BARE-LITERAL? SLOT)
          (LIST* SYM-WALK-STELLA-LET
           ...
           (LIST* SYM-WALK-STELLA-SETF
            (LIST* SYM-WALK-STELLA-WRAPPER-VALUE SYM-WALK-STELLA-OLDVALUE NIL)
          ...
          (LIST* SYM-WALK-STELLA-SETF
           ...
           SYM-WALK-STELLA-NEWVALUE NIL))
         (CONS
          (LIST* SYM-WALK-STELLA-SETQ SYM-WALK-STELLA-FOUNDMATCHINGENTRY?
           SYM-WALK-STELLA-TRUE NIL)
          NIL))
        (LIST* SYM-WALK-STELLA-WHEN
         (LIST* SYM-WALK-STELLA-AND
          (LIST* SYM-WALK-STELLA-NOT SYM-WALK-STELLA-FOUNDMATCHINGENTRY? NIL)
          (LIST* SYM-WALK-STELLA-DEFINED? SYM-WALK-STELLA-NEWVALUE NIL) NIL)
         (LIST* SYM-WALK-STELLA-SETF
          (LIST* SYM-WALK-STELLA-THE-KV-LIST SYM-WALK-STELLA-DYNAMICSLOTS NIL)
          (LIST* SYM-WALK-STELLA-KV-CONS
           (LIST* SYM-WALK-STELLA-BQUOTE SLOTNAME NIL)
           (CL:IF (SLOT-VALUE-IS-BARE-LITERAL? SLOT)
            (LIST* SYM-WALK-STELLA-WRAP-LITERAL SYM-WALK-STELLA-NEWVALUE NIL)
...
(CL:DEFUN YIELD-NATIVE-SLOT-VALUE-TREE (SLOT OBJECTREF OBJECTTYPE)
  ...
  (CL:LET*
   ((MIXINSLOT? (%MIXIN? (%SURROGATE-VALUE (%SLOT-OWNER SLOT))))
   ...
   (CL:IF (%SLOT-HARDWIRED? SLOT)
    (CL:RETURN-FROM YIELD-NATIVE-SLOT-VALUE-TREE
     (LIST* SYM-WALK-STELLA-SYS-CALL-METHOD (%CLASS-TYPE OBJECTCLASS)
      (CONS (%SLOT-NAME SLOT) (CONS OBJECTREF NIL))))
    (CL:RETURN-FROM YIELD-NATIVE-SLOT-VALUE-TREE
     (LIST* SYM-WALK-STELLA-SYS-SLOT-VALUE (%CLASS-TYPE OBJECTCLASS)
      (CONS (%SLOT-NAME SLOT) (CONS OBJECTREF NIL)))))))
...
(CL:DEFUN YIELD-CONTEXT-SENSITIVE-SLOT-VALUE-TREE (SLOT OBJECTREF RETURNTYPE CSOPTIONS)
  (CL:LET*
   ...
   (CL:SETF (%SLOT-CONTEXT-SENSITIVE? SLOT) FALSE)
   ...
   (CL:SETF (%SLOT-CONTEXT-SENSITIVE? SLOT) TRUE)
   ...
   (CL:SETQ ACCESSTREE
    (LIST* SYM-WALK-STELLA-SAFE-CAST
     (LIST* SYM-WALK-STELLA-ACCESS-IN-CONTEXT
      ...
      (LIST* (LIST* SYM-WALK-STELLA-HOME-CONTEXT OBJECTREF NIL) DONTINHERIT?
       NIL))
     (YIELD-TYPE-SPEC-TREE
      (CL:IF LITERALSLOT? (TYPE-TO-WRAPPED-TYPE (TYPE SLOT)) RETURNTYPE))
     NIL))
   (CL:WHEN LITERALSLOT?
    (CL:SETQ ACCESSTREE (LIST* SYM-WALK-STELLA-WRAPPER-VALUE ACCESSTREE NIL)))
   ...
   (CL:IF (DYNAMIC-STORAGE? SLOT)
    (CL:RETURN-FROM YIELD-SLOT-VALUE-TREE
     (CL:VALUES
      ...
      RETURNTYPE))
    (CL:RETURN-FROM YIELD-SLOT-VALUE-TREE
     (CL:VALUES (YIELD-NATIVE-SLOT-VALUE-TREE SLOT OBJECTREF OBJECTTYPE)
      RETURNTYPE)))))
  ...
  (CL:LET* ((OBJECTREF NULL) (OBJECTTYPE NULL))
   ...
   (CL:LET*
    ((SLOTNAME (%%VALUE (%%REST (%%REST TREE)))) (CSOPTIONS (NTH-REST TREE 3))
     (OBJECTCLASS (TYPE-SPEC-TO-CLASS OBJECTTYPE))
     (SLOT (LOOKUP-SLOT OBJECTCLASS SLOTNAME)) (OTREE NULL) (OTYPE NULL))
    (CL:WHEN (CL:EQ SLOT NULL)
     (CL:LET* ((*PRINTREADABLY?* TRUE))
      ...
      (CL:WHEN (CL:NOT (SUPPRESS-WARNINGS?))
       (PRINT-ERROR-CONTEXT ">> ERROR: " STANDARD-ERROR)
       (%%PRINT-STREAM (%NATIVE-STREAM STANDARD-ERROR) EOL
        " Can't read a non-existent slot `" (DE-UGLIFY-PARSE-TREE SLOTNAME) "'"
        EOL "   on the class `" (CLASS-NAME OBJECTCLASS) "'." EOL)))
       ...
       (CL:PROGN
        (CL:LET* ((*PRINTREADABLY?* TRUE))
         ...
         (CL:WHEN (CL:NOT (SUPPRESS-WARNINGS?))
          (PRINT-ERROR-CONTEXT ">> ERROR: " STANDARD-ERROR)
          (%%PRINT-STREAM (%NATIVE-STREAM STANDARD-ERROR) EOL
           " Can't read the method slot `" (DE-UGLIFY-PARSE-TREE SLOT)
           "' by calling 'slot-value'." EOL)))
   ...
   (CL:WHEN (%SLOT-HARDWIRED? SLOT)
    (CL:LET* ((*PRINTREADABLY?* TRUE)) (CL:DECLARE (CL:SPECIAL *PRINTREADABLY?*))
     ...
     (CL:WHEN (CL:NOT (SUPPRESS-WARNINGS?))
      (PRINT-ERROR-CONTEXT ">> ERROR: " STANDARD-ERROR)
      (%%PRINT-STREAM (%NATIVE-STREAM STANDARD-ERROR) EOL
       " Can't set the value of the hardwired slot `" (%SLOT-OWNER SLOT) "'.`"
       (%SLOT-NAME SLOT) "'." EOL)))
    (CL:RETURN-FROM YIELD-NATIVE-SLOT-VALUE-SETTER-TREE
     (WALK-DONT-CALL-ME-TREE NULL (%SLOT-BASE-TYPE SLOT))))
   (CL:RETURN-FROM YIELD-NATIVE-SLOT-VALUE-SETTER-TREE
  ...
  (CL:LET*
   ((CONTEXTSENSITIVE?
    ...
    (REALTYPESPEC
     (DYNAMIC-SLOT-VALUE (%DYNAMIC-SLOTS SLOT)
      SYM-WALK-STELLA-SLOT-TYPE-SPECIFIER NULL))
    (OBJECTVAR NULL) (VALUEVAR NULL) (OLDVALUEVAR NULL) (NEWVALUEVAR NULL)
    (OLDVALUETREE NULL) (SETNEWVALUETREE NULL))
   (CL:SETF (%SLOT-BASE-TYPE SLOT) SGT-WALK-STELLA-OBJECT)
   (CL:WHEN (CL:NOT (CL:EQ REALTYPESPEC NULL))
    (SET-DYNAMIC-SLOT-VALUE (%DYNAMIC-SLOTS SLOT)
     SYM-WALK-STELLA-SLOT-TYPE-SPECIFIER NULL NULL))
...
(CL:DEFUN YIELD-SLOT-VALUE-SETTER-TREE (SLOT OBJECTREF OBJECTTYPE VALUEREF RETURNTYPE CSOPTIONS)
  (CL:IF (%SLOT-CONTEXT-SENSITIVE? SLOT)
   (CL:RETURN-FROM YIELD-SLOT-VALUE-SETTER-TREE
    (YIELD-CONTEXT-SENSITIVE-SLOT-VALUE-SETTER-TREE SLOT OBJECTREF VALUEREF
     RETURNTYPE CSOPTIONS))
   (CL:IF (DYNAMIC-STORAGE? SLOT)
    (CL:RETURN-FROM YIELD-SLOT-VALUE-SETTER-TREE
     (CL:VALUES
      (WALK-WITHOUT-TYPE-TREE
       (YIELD-DYNAMIC-SLOT-VALUE-SETTER-TREE SLOT OBJECTREF VALUEREF RETURNTYPE))
      RETURNTYPE))
    (CL:RETURN-FROM YIELD-SLOT-VALUE-SETTER-TREE
     (CL:VALUES
  ...
  (CL:LET* ((OBJECTREF NULL) (OBJECTTYPE NULL))
   ...
   (CL:LET*
    ((SLOTNAME (FOURTH TREE)) (CSOPTIONS (NTH-REST TREE 4))
     (OBJECTCLASS (TYPE-SPEC-TO-CLASS OBJECTTYPE))
     (SLOT (LOOKUP-SLOT OBJECTCLASS SLOTNAME)) (VALUEREF NULL) (OTREE NULL)
     (OTYPE NULL))
    (CL:WHEN (CL:EQ SLOT NULL)
     (CL:LET* ((*PRINTREADABLY?* TRUE))
      (CL:DECLARE (CL:SPECIAL *PRINTREADABLY?*)) (SIGNAL-TRANSLATION-ERROR)
      (CL:WHEN (CL:NOT (SUPPRESS-WARNINGS?))
       (PRINT-ERROR-CONTEXT ">> ERROR: " STANDARD-ERROR)
       (%%PRINT-STREAM (%NATIVE-STREAM STANDARD-ERROR) EOL
        " Can't set a non-existent slot `" (DE-UGLIFY-PARSE-TREE SLOTNAME) "'"
        EOL "   on the class `" (CLASS-NAME OBJECTCLASS) "'." EOL)))
       ...
       (CL:PROGN
        (CL:LET* ((*PRINTREADABLY?* TRUE))
         ...
         (CL:WHEN (CL:NOT (SUPPRESS-WARNINGS?))
          (PRINT-ERROR-CONTEXT ">> ERROR: " STANDARD-ERROR)
          (%%PRINT-STREAM (%NATIVE-STREAM STANDARD-ERROR) EOL
           " Can't set the method slot `" (DE-UGLIFY-PARSE-TREE SLOT)
       ...
       (CL:PROGN (CL:SETQ OTYPE (COMPUTE-RETURN-TYPE-SPEC SLOT OBJECTTYPE))
        (CL:SETQ VALUEREF
         (WALK-EXPRESSION-TREE (%%VALUE (%%REST (%%REST TREE))) OTYPE
          SYM-WALK-STELLA-SLOT-VALUE-SETTER FALSE))
        (CL:MULTIPLE-VALUE-SETQ (OTREE OTYPE)
         (YIELD-SLOT-VALUE-SETTER-TREE SLOT OBJECTREF OBJECTTYPE VALUEREF OTYPE
          CSOPTIONS))
        (CL:IF (PROCEDURAL-EXPRESSION? OTREE)
...
(CL:DEFUN WALK-AREF-TREE (TREE)
  (CL:LET*
   ((OPERATOR (%%VALUE TREE)) (OTREE NULL) (OTYPE NULL) (ARRAYTYPE NULL)
    (ELEMENTTYPE NULL) (ARGUMENTS (%%REST TREE)))
   (CL:MULTIPLE-VALUE-SETQ (OTREE OTYPE)
    (WALK-EXPRESSION-TREE (%%VALUE ARGUMENTS) SGT-WALK-STELLA-ARRAY OPERATOR
     TRUE))
   (CL:WHEN (VRLET-EXPRESSION? OTREE) (FIRST-SETTER ARGUMENTS OTREE)
    (CL:RETURN-FROM WALK-AREF-TREE
     (PERCOLATE-OUT-VRLET-EXPRESSION TREE OTREE SGT-WALK-STELLA-UNKNOWN)))
      ...
      (CL:LET* ((DIM NULL) (ITER-000 (REST (ARRAY-TYPE-DIMENSIONS ARRAYTYPE))))
       (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-000 NIL)) DO
        (CL:PROGN (CL:SETQ DIM (%%VALUE ITER-000))
         (CL:SETQ ITER-000 (%%REST ITER-000)))
        (CL:WHEN (CL:EQ DIM NULL) (CL:SETQ ALWAYS?-000 FALSE) (CL:RETURN))))
    ...
    (CL:WHEN TEST-VALUE-000
     (CL:LET* ((*PRINTREADABLY?* TRUE))
      ...
      (CL:WHEN (CL:NOT (SUPPRESS-WARNINGS?))
       (PRINT-ERROR-CONTEXT ">> ERROR: " STANDARD-ERROR)
       (%%PRINT-STREAM (%NATIVE-STREAM STANDARD-ERROR) EOL
        " Can't AREF underspecified array type" EOL "   `"
   ...
   (CL:WHEN (CL:EQ OPERATOR SYM-WALK-STELLA-AREF-SETTER)
    (CL:MULTIPLE-VALUE-SETQ (OTREE OTYPE)
     (WALK-EXPRESSION-TREE (%%VALUE ARGUMENTS) ELEMENTTYPE OPERATOR TRUE))
   ...
   (CL:LOOP WHILE (CL:NOT (CL:EQ ARGUMENTS NIL)) DO
    (CL:MULTIPLE-VALUE-SETQ (OTREE OTYPE)
     (WALK-EXPRESSION-TREE (%%VALUE ARGUMENTS) SGT-WALK-STELLA-INTEGER OPERATOR
      TRUE))
    (FIRST-SETTER ARGUMENTS OTREE)
    (CL:WHEN (VRLET-EXPRESSION? OTREE)
     (CL:RETURN-FROM WALK-AREF-TREE
  ...
  (CL:LET*
   ((SOURCETYPE NULL) (TARGETTYPE (SAFE-YIELD-TYPE-SPECIFIER TYPETREE))
    (METHODOWNERTYPE
     (CL:IF (CL:NOT (CL:EQ *METHODBEINGWALKED* NULL))
      (%SLOT-OWNER *METHODBEINGWALKED*) NULL))
    (OVALUE NULL))
   (CL:WHEN
    (CL:AND (CL:NOT (CL:EQ TARGETTYPE NULL))
     (CL:NOT (CL:EQ METHODOWNERTYPE NULL)) (CL:NOT (VOID? METHODOWNERTYPE)))
   ...
   (CL:WHEN (CL:NOT INPUTPARAMETER?)
    ...
    (CL:MULTIPLE-VALUE-SETQ (OVALUE SOURCETYPE)
     (WALK-EXPRESSION-TREE VALUE TARGETTYPE SYM-WALK-STELLA-VARIABLE-DECLARATION
      TRUE))
    (CL:WHEN (CL:EQ TARGETTYPE NULL) (CL:SETQ TARGETTYPE SOURCETYPE))
   ...
   (CL:IF INPUTPARAMETER?
    ...
    (CL:RETURN-FROM WALK-A-DECLARATION
     (CONS (TRUE-VARIABLE-NAME VARIABLE) (CONS TARGETTYPE (CONS OVALUE NIL)))))))

;;; (DEFUN (WALK-VARIABLE-DECLARATIONS CONS) ...)

(CL:DEFUN WALK-VARIABLE-DECLARATIONS (DECLARATIONS)
  (CL:LET* ((ODECLARATIONS NIL) (VARIABLE NULL) (VRLETENCOUNTERED? FALSE))
   (CL:LET* ((DECL NULL) (ITER-000 DECLARATIONS))
    (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-000 NIL)) DO
     (CL:PROGN (CL:SETQ DECL (%%VALUE ITER-000))
      (CL:SETQ ITER-000 (%%REST ITER-000)))
     (CL:TAGBODY
      (CL:COND
       ((CL:EQ (SAFE-PRIMARY-TYPE DECL) SGT-WALK-STELLA-CONS)
        (CL:PROGN
         (CL:COND
          (VRLETENCOUNTERED? (CL:SETQ ODECLARATIONS (CONS DECL ODECLARATIONS))
           (CL:GO :CONTINUE))
          ...
          (CL:T (CL:SETQ VARIABLE (%%VALUE DECL))
           (CL:WHEN (CL:NOT (CL:EQ (LOOKUP-GLOBAL-VARIABLE VARIABLE) NULL))
            (CL:LET* ((*PRINTREADABLY?* TRUE))
             (CL:DECLARE (CL:SPECIAL *PRINTREADABLY?*))
             (SIGNAL-TRANSLATION-ERROR)
             (CL:WHEN (CL:NOT (SUPPRESS-WARNINGS?))
              ...
              (%%PRINT-STREAM (%NATIVE-STREAM STANDARD-ERROR) EOL
               ...
               EOL "    `" (DE-UGLIFY-PARSE-TREE DECL) "'." EOL)))
            (CL:SETQ VARIABLE SYM-WALK-STELLA-ILLEGAL-VARIABLE))))
         (CL:CASE (LENGTH DECL)
          (1
           (CL:LET* ((*PRINTREADABLY?* TRUE))
          ...
          (2
           ...
           (CL:SETQ ODECLARATIONS
            (CONS
             (WALK-A-DECLARATION VARIABLE NULL (%%VALUE (%%REST DECL)) FALSE)
             ODECLARATIONS)))
          (3
           (CL:SETQ ODECLARATIONS
            (CONS
             (WALK-A-DECLARATION VARIABLE (%%VALUE (%%REST DECL))
              (%%VALUE (%%REST (%%REST DECL))) FALSE)
             ODECLARATIONS)))
          (CL:OTHERWISE
           (CL:LET* ((*PRINTREADABLY?* TRUE))
            (CL:DECLARE (CL:SPECIAL *PRINTREADABLY?*)) (SIGNAL-TRANSLATION-ERROR)
         ...
         (CL:WHEN
          ...
          (CL:SETQ VRLETENCOUNTERED? TRUE) (POP-VARIABLE-BINDING))))
       (CL:T
        (CL:LET* ((*PRINTREADABLY?* TRUE))
         (CL:DECLARE (CL:SPECIAL *PRINTREADABLY?*)) (SIGNAL-TRANSLATION-ERROR)
         (CL:WHEN (CL:NOT (SUPPRESS-WARNINGS?))
          (PRINT-ERROR-CONTEXT ">> ERROR: " STANDARD-ERROR)
          (%%PRINT-STREAM (%NATIVE-STREAM STANDARD-ERROR) EOL
           " Illegal `let' declaration: `" (DE-UGLIFY-PARSE-TREE DECL) "'."
           EOL)))))
      :CONTINUE)))
...
(CL:DEFUN TRANSFORM-LET-WITH-PROCEDURAL-EXPRESSION (TREE)
  (CL:LET*
   ((FIRSTDECLARATION (%%VALUE (%%VALUE (%%REST TREE))))
    ...
    (VRLETTREE
     (WALK-WITHOUT-TYPE-TREE (%%VALUE (%%REST (%%REST FIRSTDECLARATION))))))
  ...
  (CL:LET* ((D NULL) (ITER-000 DECLARATIONS))
   (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-000 NIL)) DO
    (CL:PROGN (CL:SETQ D (%%VALUE ITER-000))
     (CL:SETQ ITER-000 (%%REST ITER-000)))
    (CL:SETQ D D) (POP-VARIABLE-BINDING)))
  :VOID)
...
(CL:DEFUN WALK-LET-TREE (TREE)
  ...
  (CL:LET*
   ((ORIGINALDECLARATIONS (%%VALUE (%%REST TREE))) (LEADINGDECLARATIONS NIL)
    (TRAILINGDECLARATIONS NIL) (LEADING? TRUE))
   (CL:LET* ((D NULL) (ITER-001 ORIGINALDECLARATIONS))
    (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-001 NIL)) DO
     ...
     (CL:COND
      (LEADING? (CL:SETQ LEADINGDECLARATIONS (CONS D LEADINGDECLARATIONS)))
...
(CL:DEFVAR *SPECIALSENABLED?* FALSE
...
(CL:DEFUN POP-SPECIAL ()
  (CL:LET* ((KVLIST (%THE-KV-LIST *SPECIALVARIABLESTACK*)))
   (CL:SETF (%THE-KV-LIST *SPECIALVARIABLESTACK*) (%REST KVLIST))
   (FREE-KV-CONS KVLIST))
  :VOID)
...
(CL:DEFUN NEED-TO-UNBIND-SPECIALS? ()
  (CL:RETURN-FROM NEED-TO-UNBIND-SPECIALS?
   (CL:AND *SPECIALSENABLED?* (CL:> (LENGTH *SPECIALVARIABLESTACK*) 0)
    (CL:NOT
     (MEMBER?
      (GET-QUOTED-TREE "((:COMMON-LISP :UNBIND-WITH-DESTRUCTORS) \"/STELLA\")"
       "/STELLA")
  ...
  (CL:LET* ((OTREE NIL))
   (CL:COND
    ((CL:EQ (SPECIAL-IMPLEMENTATION-STYLE) KWD-WALK-UNWIND-PROTECT)
     (CL:LET*
      ((OLDVALUEVARIABLE NULL) (VARIABLE NULL)
       (ITER-000 (%THE-KV-LIST *SPECIALVARIABLESTACK*)))
      (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-000 NULL)) DO
       (CL:SETQ VARIABLE (%KEY ITER-000))
       (CL:PROGN (CL:SETQ OLDVALUEVARIABLE (%VALUE ITER-000))
        (CL:SETQ ITER-000 (%REST ITER-000)))
       (CL:WHEN (CL:>= (CL:SETQ NOFBINDINGS (CL:1- NOFBINDINGS)) 0)
        ...
        (CL:SETQ OTREE
         (CONS (LIST* SYM-WALK-STELLA-SETQ VARIABLE (CONS OLDVALUEVARIABLE NIL))
          OTREE)))))
...
(CL:DEFUN WALK-SPECIAL-TREE (TREE)
  (CL:WHEN (CL:NOT *SPECIALSENABLED?*)
   ...
   (CL:RETURN-FROM WALK-SPECIAL-TREE
    (WALK-DONT-CALL-ME-TREE TREE SGT-WALK-STELLA-VOID)))
  (CL:LET* ((TEST-VALUE-000 FALSE))
   (CL:IF (CL:< (LENGTH TREE) 2) (CL:SETQ TEST-VALUE-000 TRUE)
    (CL:IF (CL:NOT (CONS? (%%VALUE (%%REST TREE)))) (CL:SETQ TEST-VALUE-000 TRUE)
     (CL:PROGN
      (CL:LET* ((ALWAYS?-000 TRUE))
   ...
   (CL:WHEN TEST-VALUE-000
    (CL:LET* ((*PRINTREADABLY?* TRUE)) (CL:DECLARE (CL:SPECIAL *PRINTREADABLY?*))
     ...
     (CL:WHEN (CL:NOT (SUPPRESS-WARNINGS?))
      (PRINT-ERROR-CONTEXT ">> ERROR: " STANDARD-ERROR)
      (%%PRINT-STREAM (%NATIVE-STREAM STANDARD-ERROR) EOL
       " Illegal 'special' statement: `" (DE-UGLIFY-PARSE-TREE TREE) "'." EOL)))
    (CL:RETURN-FROM WALK-SPECIAL-TREE
     (WALK-DONT-CALL-ME-TREE TREE SGT-WALK-STELLA-VOID))))
  ...
  (CL:LET* ((VARIABLE NULL))
   (CL:LET* ((BINDING NULL) (ITER-001 (%%VALUE (%%REST TREE))))
    (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-001 NIL)) DO
     ...
     (CL:WHEN
      (CL:OR (CL:EQ VARIABLE NULL) (CL:NOT (%VARIABLE-SPECIAL? VARIABLE)))
      (CL:LET* ((*PRINTREADABLY?* TRUE))
       (CL:DECLARE (CL:SPECIAL *PRINTREADABLY?*)) (SIGNAL-TRANSLATION-ERROR)
       (CL:WHEN (CL:NOT (SUPPRESS-WARNINGS?))
        (PRINT-ERROR-CONTEXT ">> ERROR: " STANDARD-ERROR)
        (%%PRINT-STREAM (%NATIVE-STREAM STANDARD-ERROR) EOL
         " Trying to bind non-special variable `" (%%VALUE BINDING) "'" EOL
         " in 'special' statement." EOL)))))))
...
(CL:DEFUN WALK-CL-SPECIAL-TREE (TREE)
  (CL:LET*
   ((BINDINGS (%%VALUE (%%REST TREE))) (BODY (%%REST (%%REST TREE)))
    (VARIABLENAME NULL) (VARIABLETYPE NULL) (BINDVIASETQ? FALSE)
    ...
    (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-000 NIL)) DO
     ...
     (CL:COND
      (BINDVIASETQ?
       ...
       (CL:SETF (%%REST (%%REST BINDING)) (CONS SYM-WALK-STELLA-NULL NIL)))
      (CL:T
       (CL:SETQ OTREE
        (WALK-EXPRESSION-TREE (%%VALUE (%%REST BINDING)) VARIABLETYPE
         SYM-WALK-STELLA-SPECIAL TRUE))
       (CL:WHEN (PROCEDURAL-EXPRESSION? OTREE) (CL:SETQ BINDVIASETQ? TRUE)
        (CL:SETQ BINDVIASETQTREES
         (CONS
          (WALK-A-TREE
  ...
  (CL:LET*
   ...
   (CL:LET* ((BINDING NULL) (ITER-001 BINDINGS))
    (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-001 NIL)) DO
     (CL:PROGN (CL:SETQ BINDING (%%VALUE ITER-001))
      (CL:SETQ ITER-001 (%%REST ITER-001)))
     (CL:SETQ BINDING BINDING) (POP-SPECIAL)))
...
(CL:DEFUN WALK-CAST-TREE (TREE)
  ...
  (CL:LET* ((TYPESPEC (YIELD-TYPE-SPECIFIER (%%VALUE (%%REST (%%REST TREE))))))
   (SECOND-SETTER TREE
    (WALK-EXPRESSION-TREE (%%VALUE (%%REST TREE)) SGT-WALK-STELLA-UNKNOWN
     SYM-WALK-STELLA-CAST TRUE))
   (CL:WHEN (VRLET-EXPRESSION? (%%VALUE (%%REST TREE)))
    (CL:RETURN-FROM WALK-CAST-TREE
     (PERCOLATE-OUT-VRLET-EXPRESSION TREE (%%VALUE (%%REST TREE)) TYPESPEC)))
  ...
  (CL:LET*
   ...
   (CL:LET* ((IT (ALLOCATE-ITERATOR (%%REST TREE))))
    (CL:LOOP WHILE (NEXT? IT) DO
     (CL:MULTIPLE-VALUE-SETQ (OTREE OTYPE) (WALK-A-TREE (%VALUE IT)))
     (CL:WHEN (VRLET-EXPRESSION? OTREE) (VALUE-SETTER IT OTREE)
      (CL:SETQ HASPROCEDURALVALUE? TRUE) (CL:RETURN))
     (CL:SETQ OTREE (SYS-TREE OTREE OTYPE))
     (CL:WHEN (VOID? OTYPE)
      (CL:SETQ OTREE (CONCATENATE OTREE (CONS SGT-WALK-STELLA-VOID NIL))))
      ...
      (CL:WHEN
       ...
       (CL:SETQ BINDTREE
        (CONS
         (CONS VALUEVAR
          (CONS
           (CL:IF (PROCEDURAL-EXPRESSION? VALUE) VALUE (%%VALUE (%%REST VALUE)))
           NIL))
         BINDTREE))
       (CL:COND
        ((PROCEDURAL-EXPRESSION? VALUE) (VALUE-SETTER IT VALUEVAR) (CL:RETURN))
     ...
     (CL:IF
      ...
      (CL:LET* ((*PRINTREADABLY?* TRUE))
       ...
       (CL:WHEN (CL:NOT (SUPPRESS-WARNINGS?))
        (PRINT-ERROR-CONTEXT ">> ERROR: " STANDARD-ERROR)
        (%%PRINT-STREAM (%NATIVE-STREAM STANDARD-ERROR) EOL " `"
         (DE-UGLIFY-PARSE-TREE OPERATOR) "' operator expected `"
         (LENGTH TARGETTYPES) "' value(s) from `" (DE-UGLIFY-PARSE-TREE TREE)
         "'." EOL))))
  ...
  (CL:LET*
   ...
   (CL:LET* ((IT (ALLOCATE-ITERATOR (%%REST TREE))))
    (CL:LOOP WHILE (NEXT? IT) DO (CL:SETQ TYPEDSYSTREE (%VALUE IT))
     ...
     (CL:WHEN
      (CL:EQ SGT-WALK-STELLA-UNKNOWN (%%VALUE (%%REST (%%REST TYPEDSYSTREE))))
...
(CL:DEFUN COERCE-MV-TREE (TREE OPERATOR SOURCETYPES TARGETTYPES)
  (CL:LET*
   ((VALUESTREE? (VALUES-TREE? TREE)) (VALUESTREE NIL) (NEEDTEMPORARIES? FALSE)
    (SUCCESS? FALSE) (OTREE NULL) (OTYPE NULL) (RETURNTYPES (NEW-LIST)))
   (CL:COND (VALUESTREE? (CL:SETQ VALUESTREE TREE))
    (CL:T (CL:SETQ VALUESTREE (CONS SYM-WALK-STELLA-VALUES NIL))
     (CL:LET*
      ((TYPE NULL) (ITER-000 (%THE-CONS-LIST SOURCETYPES)) (COLLECT-000 NULL))
      (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-000 NIL)) DO
       ...
       (CL:IF (CL:EQ COLLECT-000 NULL)
        ...
        (CL:PROGN (CL:SETF (%%REST COLLECT-000) (CONS (SYS-TREE NULL TYPE) NIL))
         (CL:SETQ COLLECT-000 (%%REST COLLECT-000))))))))
   (CL:LET*
    ((I NULL-INTEGER) (SRCTS NULL) (TGTTS NULL)
     (ITER-001 (%THE-CONS-LIST TARGETTYPES))
     (ITER-002 (%THE-CONS-LIST SOURCETYPES)) (ITER-003 1)
    ...
    (CL:LOOP WHILE
     (CL:AND (CL:NOT (CL:EQ ITER-001 NIL)) (CL:NOT (CL:EQ ITER-002 NIL))
      (NEXT? IT))
     DO
     (CL:PROGN (CL:SETQ TGTTS (%%VALUE ITER-001))
      (CL:SETQ ITER-001 (%%REST ITER-001)))
     (CL:PROGN (CL:SETQ SRCTS (%%VALUE ITER-002))
     ...
     (CL:WHEN (CL:NOT SUCCESS?)
      (CL:LET* ((*PRINTREADABLY?* TRUE))
       ...
       (CL:WHEN (CL:NOT (SUPPRESS-WARNINGS?))
        (PRINT-ERROR-CONTEXT ">> ERROR: " STANDARD-ERROR)
        (%%PRINT-STREAM (%NATIVE-STREAM STANDARD-ERROR) EOL
         " Type clash on argument `" (DE-UGLIFY-PARSE-TREE (WRAP-INTEGER I))
         "' of `" (DE-UGLIFY-PARSE-TREE OPERATOR) "' operator." EOL " `"
         (DE-UGLIFY-PARSE-TREE SRCTS) "' found where `"
         (DE-UGLIFY-PARSE-TREE TGTTS) "' expected." EOL)))
      (CL:RETURN-FROM COERCE-MV-TREE
       (CL:VALUES TREE (CL:IF VALUESTREE? TREE NULL) (COPY TARGETTYPES))))
     (CL:WHEN
      (CL:OR (CL:NOT (EQL? OTREE (%VALUE IT)))
       (CL:AND (CL:> I 1) (CL:NOT VALUESTREE?)
        ...
        (CL:NOT
         (CL:EQ (TYPE-SPEC-TO-BASE-TYPE SRCTS) (TYPE-SPEC-TO-BASE-TYPE TGTTS)))))
      (CL:SETQ NEEDTEMPORARIES? TRUE))
     (VALUE-SETTER IT OTREE)
     (CL:IF (CL:EQ COLLECT-001 NULL)
      (CL:PROGN (CL:SETQ COLLECT-001 (CONS OTYPE NIL))
       (CL:IF (CL:EQ (%THE-CONS-LIST RETURNTYPES) NIL)
        (CL:SETF (%THE-CONS-LIST RETURNTYPES) COLLECT-001)
   ...
   (CL:LET*
    ((I NULL-INTEGER) (ITER-004 1) (UPPER-BOUND-000 (LENGTH TARGETTYPES))
     (COLLECT-002 NULL))
   ...
   (CL:SETQ OTREE
    (WALK-WITHOUT-TYPE-TREE
     (LIST* SYM-WALK-STELLA-MV-BIND (COPY-CONS-LIST (%%REST VALUESTREE))
      (CONS TREE (CONS VALUESTREE NIL)))))
   (FIRST-SETTER VALUESTREE (GET-QUOTED-TREE "((VALUES) \"/STELLA\")" "/STELLA"))
   (CL:LET*
    ((TGTTS NULL) (SRCTS NULL) (IT (ALLOCATE-ITERATOR (%%REST VALUESTREE)))
     (ITER-005 (%THE-CONS-LIST SOURCETYPES))
     (ITER-006 (%THE-CONS-LIST TARGETTYPES)))
    (CL:LOOP WHILE
     (CL:AND (NEXT? IT) (CL:NOT (CL:EQ ITER-005 NIL))
      (CL:NOT (CL:EQ ITER-006 NIL)))
     DO
     (CL:PROGN (CL:SETQ SRCTS (%%VALUE ITER-005))
      (CL:SETQ ITER-005 (%%REST ITER-005)))
     (CL:PROGN (CL:SETQ TGTTS (%%VALUE ITER-006))
      (CL:SETQ ITER-006 (%%REST ITER-006)))
     (VALUE-SETTER IT (COERCE-A-TREE (%VALUE IT) SRCTS TGTTS))))
...
(CL:DEFUN WALK-RETURN-AND-UNBIND-SPECIALS (TREE)
  (CL:LET*
   ((UNBINDTREE (YIELD-RETURN-SPECIAL-UNBIND-TREE)) (VALUETREES (%%REST TREE))
    (VALUEVARIABLES NIL) (VALUEBINDINGS NIL))
   (CL:LET* ((*SPECIALSENABLED?* FALSE))
    ...
    (CL:WHEN
     (CL:AND (CL:= (LENGTH VALUETREES) 1)
      (CL:NOT
       (CL:EQ (REST (METHOD-RETURN-TYPE-SPECIFIERS *METHODBEINGWALKED*)) NIL)))
     (CL:LET*
      ...
      (CL:LOOP WHILE (CL:<= ITER-000 UPPER-BOUND-000) DO
       ...
       (CL:IF (CL:EQ COLLECT-000 NULL)
        ...
        (CL:PROGN
         (CL:SETF (%%REST COLLECT-000) (CONS (LOCAL-GENSYM "RETURN-VALUE") NIL))
         (CL:SETQ COLLECT-000 (%%REST COLLECT-000))))))
    ...
    (CL:LET* ((IT (ALLOCATE-ITERATOR VALUETREES)))
     (CL:LOOP WHILE (NEXT? IT) DO
      (CL:WHEN
       (CL:OR (CONS? (%VALUE IT))
        (CL:AND (SYMBOL? (%VALUE IT))
         (CL:NOT (CL:EQ (LOOKUP-OLD-VALUE-VARIABLE (%VALUE IT)) NULL))))
       (CL:SETQ VALUEBINDINGS
        (CONS (CONS (LOCAL-GENSYM "RETURN-VALUE") (CONS (%VALUE IT) NIL))
         VALUEBINDINGS))
...
(CL:DEFUN WALK-RETURN-TREE (TREE)
  ...
  (CL:LET* ((METHOD *METHODBEINGWALKED*) (TARGETTYPES (NEW-LIST)))
   (CL:LET*
    ((RTYPE NULL)
     (ITER-000 (%THE-CONS-LIST (METHOD-RETURN-TYPE-SPECIFIERS METHOD)))
     (COLLECT-000 NULL))
    (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-000 NIL)) DO
     (CL:PROGN (CL:SETQ RTYPE (%%VALUE ITER-000))
      (CL:SETQ ITER-000 (%%REST ITER-000)))
     (CL:IF (CL:EQ COLLECT-000 NULL)
      (CL:PROGN
       (CL:SETQ COLLECT-000
        (CONS (COMPUTE-RELATIVE-TYPE-SPEC RTYPE (%SLOT-OWNER METHOD)) NIL))
       (CL:IF (CL:EQ (%THE-CONS-LIST TARGETTYPES) NIL)
        (CL:SETF (%THE-CONS-LIST TARGETTYPES) COLLECT-000)
   ...
   (CL:LET* ((OTREE NULL) (VALUESTREE NULL) (VALUETYPES NULL))
    ...
    (CL:WHEN (CL:EQ VALUESTREE NULL)
     (CL:WHEN (CL:NOT (CL:EQ (%%REST TREE) NIL)) (SECOND-SETTER TREE OTREE))
...
(CL:DEFUN WALK-MV-SETQ-TREE (TREE)
  (CL:LET* ((TEST-VALUE-000 FALSE))
   (CL:IF (BAD-ARGUMENT-COUNT? TREE 2) (CL:SETQ TEST-VALUE-000 TRUE)
    (CL:IF (CL:NOT (CONS? (%%VALUE (%%REST TREE)))) (CL:SETQ TEST-VALUE-000 TRUE)
     (CL:PROGN
      (CL:LET* ((ALWAYS?-000 TRUE))
       (CL:LET* ((V NULL) (ITER-000 (%%VALUE (%%REST TREE))))
        (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-000 NIL)) DO
         (CL:PROGN (CL:SETQ V (%%VALUE ITER-000))
          (CL:SETQ ITER-000 (%%REST ITER-000)))
         (CL:WHEN (CL:NOT (SYMBOL? V)) (CL:SETQ ALWAYS?-000 FALSE) (CL:RETURN))))
       (CL:SETQ TEST-VALUE-000 ALWAYS?-000))
      (CL:SETQ TEST-VALUE-000 (CL:NOT TEST-VALUE-000)))))
   (CL:WHEN TEST-VALUE-000
    (CL:LET* ((*PRINTREADABLY?* TRUE)) (CL:DECLARE (CL:SPECIAL *PRINTREADABLY?*))
     ...
     (CL:WHEN (CL:NOT (SUPPRESS-WARNINGS?))
      (PRINT-ERROR-CONTEXT ">> ERROR: " STANDARD-ERROR)
      (%%PRINT-STREAM (%NATIVE-STREAM STANDARD-ERROR) EOL
       " Illegal 'mv-setq' expression: `" (DE-UGLIFY-PARSE-TREE TREE) "'." EOL)))
  ...
  (CL:LET* ((VARIABLES (%%VALUE (%%REST TREE))) (TARGETTYPES (NEW-LIST)))
   (CL:LET* ((IT (ALLOCATE-ITERATOR VARIABLES)) (COLLECT-000 NULL))
    (CL:LOOP WHILE (NEXT? IT) DO
     (VALUE-SETTER IT (TRUE-VARIABLE-NAME (%VALUE IT)))
     (CL:IF (CL:EQ COLLECT-000 NULL)
      (CL:PROGN
       (CL:SETQ COLLECT-000 (CONS (LOOKUP-VARIABLE-TYPE (%VALUE IT)) NIL))
       (CL:IF (CL:EQ (%THE-CONS-LIST TARGETTYPES) NIL)
        (CL:SETF (%THE-CONS-LIST TARGETTYPES) COLLECT-000)
        (ADD-CONS-TO-END-OF-CONS-LIST (%THE-CONS-LIST TARGETTYPES) COLLECT-000)))
      (CL:PROGN
       (CL:SETF (%%REST COLLECT-000)
        (CONS (LOOKUP-VARIABLE-TYPE (%VALUE IT)) NIL))
       (CL:SETQ COLLECT-000 (%%REST COLLECT-000))))))
   (CL:LET* ((OTREE NULL) (VALUESTREE NULL) (VALUETYPES NULL))
    (CL:MULTIPLE-VALUE-SETQ (OTREE VALUESTREE VALUETYPES)
     (WALK-MV-EXPRESSION-TREE (%%VALUE (%%REST (%%REST TREE))) TARGETTYPES
      SYM-WALK-STELLA-MV-SETQ))
    (FREE VALUETYPES) (FREE TARGETTYPES)
    (CL:WHEN (CL:NOT (CL:EQ VALUESTREE NULL))
     (FIRST-SETTER VALUESTREE SYM-WALK-STELLA-PROGN)
     (CL:LET*
      ((VAR NULL) (IT (ALLOCATE-ITERATOR (%%REST VALUESTREE)))
       (ITER-001 VARIABLES))
      (CL:LOOP WHILE (CL:AND (NEXT? IT) (CL:NOT (CL:EQ ITER-001 NIL))) DO
       (CL:PROGN (CL:SETQ VAR (%%VALUE ITER-001))
        (CL:SETQ ITER-001 (%%REST ITER-001)))
       (VALUE-SETTER IT
        (LIST* SYM-WALK-STELLA-SETQ VAR (CONS (%VALUE IT) NIL)))))
     (CL:SETF (%%REST (%%REST TREE)) NIL)
     (CL:RETURN-FROM WALK-MV-SETQ-TREE (SYS-TREE OTREE SGT-WALK-STELLA-VOID)))
    (THIRD-SETTER TREE OTREE)
    (CL:RETURN-FROM WALK-MV-SETQ-TREE (SYS-TREE TREE SGT-WALK-STELLA-VOID)))))

;;; (DEFUN (WALK-MV-BIND-TREE CONS TYPE-SPEC) ...)

(CL:DEFUN WALK-MV-BIND-TREE (TREE)
  (CL:WHEN
   (CL:OR (CL:< (LENGTH TREE) 3) (CL:NOT (CONS? (%%VALUE (%%REST TREE)))))
   (CL:LET* ((*PRINTREADABLY?* TRUE)) (CL:DECLARE (CL:SPECIAL *PRINTREADABLY?*))
    (SIGNAL-TRANSLATION-ERROR)
    (CL:WHEN (CL:NOT (SUPPRESS-WARNINGS?))
     (PRINT-ERROR-CONTEXT ">> ERROR: " STANDARD-ERROR)
     (%%PRINT-STREAM (%NATIVE-STREAM STANDARD-ERROR) EOL
      " Illegal 'mv-bind' expression: `" (DE-UGLIFY-PARSE-TREE TREE) "'." EOL)))
  ...
  (CL:LET*
     ...
     (CL:LET* ((TEST-VALUE-000 (SAFE-PRIMARY-TYPE DECL)))
      (CL:COND
       ((CL:EQ TEST-VALUE-000 SGT-WALK-STELLA-CONS)
        (CL:PROGN
         (CL:WHEN
          (CL:NOT (CL:AND (SYMBOL? (%%VALUE DECL)) (CL:= (LENGTH DECL) 2)))
          (CL:LET* ((*PRINTREADABLY?* TRUE))
           (CL:DECLARE (CL:SPECIAL *PRINTREADABLY?*)) (SIGNAL-TRANSLATION-ERROR)
           (CL:WHEN (CL:NOT (SUPPRESS-WARNINGS?))
            (PRINT-ERROR-CONTEXT ">> ERROR: " STANDARD-ERROR)
            (%%PRINT-STREAM (%NATIVE-STREAM STANDARD-ERROR) EOL
             " Illegal variable declaration `" (DE-UGLIFY-PARSE-TREE DECL)
       ...
       ((SUBTYPE-OF-SYMBOL? TEST-VALUE-000)
        (CL:PROGN (PUSH TARGETTYPES SGT-WALK-STELLA-UNKNOWN)
         (VALUE-SETTER IT
          (CONS DECL (LIST* SGT-WALK-STELLA-UNKNOWN SYM-WALK-STELLA-NULL NIL)))
       ...
       (CL:T
        (CL:LET* ((*PRINTREADABLY?* TRUE))
         ...
         (CL:WHEN (CL:NOT (SUPPRESS-WARNINGS?))
          (PRINT-ERROR-CONTEXT ">> ERROR: " STANDARD-ERROR)
          (%%PRINT-STREAM (%NATIVE-STREAM STANDARD-ERROR) EOL
           " Illegal variable `" (DE-UGLIFY-PARSE-TREE DECL)
   ...
   (CL:LET* ((OMVTREE NULL) (VALUESTREE NULL) (VARIABLETYPES NULL))
    ...
    (CL:LET* ((VARIABLE NULL) (ITER-001 VARIABLES))
     (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-001 NIL)) DO
      (CL:PROGN (CL:SETQ VARIABLE (%%VALUE ITER-001))
       (CL:SETQ ITER-001 (%%REST ITER-001)))
      (CL:SETQ VARIABLE VARIABLE) (POP-VARIABLE-BINDING)))
    (FREE TARGETTYPES) (CL:SETF (%%REST (%%REST (%%REST TREE))) NIL)
    (CL:LET*
     ((TYPE NULL) (DECL NULL) (ITER-002 DECLARATIONS)
      (ITER-003 (%THE-CONS-LIST VARIABLETYPES)))
     (CL:LOOP WHILE
      (CL:AND (CL:NOT (CL:EQ ITER-002 NIL)) (CL:NOT (CL:EQ ITER-003 NIL))) DO
      (CL:PROGN (CL:SETQ DECL (%%VALUE ITER-002))
       (CL:SETQ ITER-002 (%%REST ITER-002)))
      (CL:PROGN (CL:SETQ TYPE (%%VALUE ITER-003))
    ...
    (CL:COND
     ((CL:NOT (CL:EQ VALUESTREE NULL))
      ...
      (CL:LET*
       ((VAR NULL) (IT (ALLOCATE-ITERATOR (%%REST VALUESTREE)))
        (ITER-004 VARIABLES))
       (CL:LOOP WHILE (CL:AND (NEXT? IT) (CL:NOT (CL:EQ ITER-004 NIL))) DO
        (CL:PROGN (CL:SETQ VAR (%%VALUE ITER-004))
...
(CL:DEFUN WALK-WHILE-TREE (TREE)
  (CL:LET* ((*NOFSPECIALSATLOOPENTRY* (LENGTH *SPECIALVARIABLESTACK*)))
   ...
   (CL:LET*
    ((TEST
      (WALK-EXPRESSION-TREE (%%VALUE (%%REST TREE)) SGT-WALK-STELLA-BOOLEAN
       SYM-WALK-STELLA-WHILE TRUE))
     (BODY (%%REST (%%REST TREE))))
    ...
    (CL:COND
     ((CL:EQ TEST-VALUE-000 SYM-WALK-STELLA-IF)
      (CL:WHEN (BAD-ARGUMENT-COUNT? TREE 3)
       (CL:RETURN-FROM WALK-CONDITIONAL-TREE
        (WALK-DONT-CALL-ME-TREE TREE SGT-WALK-STELLA-VOID)))
      (THIRD-SETTER TREE (WALK-STATEMENT (%%VALUE (%%REST (%%REST TREE))) TRUE))
  ...
  (CL:LET*
   ...
   (CL:WHEN (VRLET-EXPRESSION? TEST)
    (CL:RETURN-FROM WALK-CHOOSE-TREE
     (PERCOLATE-OUT-VRLET-EXPRESSION TREE TEST SGT-WALK-STELLA-BOOLEAN)))
   (CL:WHEN (BAD-ARGUMENT-COUNT? TREE 3)
    (CL:RETURN-FROM WALK-CHOOSE-TREE
     (WALK-DONT-CALL-ME-TREE TREE SGT-WALK-STELLA-UNKNOWN)))
   (CL:MULTIPLE-VALUE-SETQ (TEMP TYPE1)
    (WALK-EXPRESSION-TREE (%%VALUE (%%REST (%%REST TREE))) *TARGETTYPE*
     SYM-WALK-STELLA-CHOOSE TRUE))
   (THIRD-SETTER TREE TEMP)
   (CL:MULTIPLE-VALUE-SETQ (TEMP TYPE2)
    (WALK-EXPRESSION-TREE (FOURTH TREE) *TARGETTYPE* SYM-WALK-STELLA-CHOOSE
     TRUE))
   ...
   (CL:WHEN
    (CL:OR (CL:EQ TYPE SGT-WALK-STELLA-VOID)
     (CL:AND (CL:NOT (SUB-TYPE-SPEC-OF? TYPE SGT-WALK-STELLA-OBJECT))
      (%ABSTRACT? (TYPE-SPEC-TO-CLASS TYPE))))
    (CL:LET* ((*PRINTREADABLY?* TRUE)) (CL:DECLARE (CL:SPECIAL *PRINTREADABLY?*))
     (SIGNAL-TRANSLATION-ERROR)
     (CL:WHEN (CL:NOT (SUPPRESS-WARNINGS?))
      (PRINT-ERROR-CONTEXT ">> ERROR: " STANDARD-ERROR)
      (%%PRINT-STREAM (%NATIVE-STREAM STANDARD-ERROR) EOL
       " Incompatible subexpression types `" (DE-UGLIFY-PARSE-TREE TYPE1)
       "' and `" (DE-UGLIFY-PARSE-TREE TYPE2) "'" EOL " in 'choose' expression.."
       EOL))))
   (CL:WHEN
    ...
    (CL:LET* ((RESULTVARIABLE (LOCAL-GENSYM "CHOOSE-VALUE")))
     (CL:LET* ((VALUE-000 NULL) (VALUE-001 NULL))
      (CL:MULTIPLE-VALUE-SETQ (VALUE-000 VALUE-001)
       (WALK-A-TREE
        (LIST* SYM-WALK-STELLA-VRLET
         (CONS (CONS RESULTVARIABLE (CONS TYPE (CONS SYM-WALK-STELLA-NULL NIL)))
          NIL)
         (LIST* SYM-WALK-STELLA-IF (%%VALUE (%%REST TREE))
          (LIST*
           (LIST* SYM-WALK-STELLA-SETQ RESULTVARIABLE
            (CONS (%%VALUE (%%REST (%%REST TREE))) NIL))
           (LIST* SYM-WALK-STELLA-SETQ RESULTVARIABLE (CONS (FOURTH TREE) NIL))
           NIL))
         RESULTVARIABLE NIL)))
      ...
      (CL:PROGN
       (CL:WHEN (CL:NOT (CL:EQ (%%VALUE CONDITION) SYM-WALK-STELLA-OTHERWISE))
        (CL:SETF (%%VALUE CONDITION)
         (WALK-EXPRESSION-TREE (%%VALUE CONDITION) SGT-WALK-STELLA-BOOLEAN
          SYM-WALK-STELLA-COND TRUE))
     ...
     (CL:T
      (CL:LET* ((*PRINTREADABLY?* TRUE))
       ...
       (CL:WHEN (CL:NOT (SUPPRESS-WARNINGS?))
        (PRINT-ERROR-CONTEXT ">> ERROR: " STANDARD-ERROR)
        (%%PRINT-STREAM (%NATIVE-STREAM STANDARD-ERROR) EOL
         " Illegal condition in COND statement: `"
    ...
    ((CL:EQ (SAFE-PRIMARY-TYPE FIRSTCONDITION) SGT-WALK-STELLA-CONS)
     (CL:PROGN (CL:SETQ FIRSTTEST (%%VALUE FIRSTCONDITION))
      (CL:COND
       ...
       ((CL:EQ OTHERCONDITIONS NIL) (FIRST-SETTER TREE SYM-WALK-STELLA-WHEN)
      ...
      (CL:PROGN
       (CL:LET* ((IT (ALLOCATE-ITERATOR CASETEST)))
        (CL:LOOP WHILE (NEXT? IT) DO (CL:SETQ SYMBOL (%VALUE IT))
         (CL:WHEN (CL:NOT (DEFINED? (%SYMBOL-ID SYMBOL)))
          (CL:SETQ SYMBOL (INTERN-PERMANENT-SYMBOL (%SYMBOL-NAME SYMBOL))))
         (VALUE-SETTER IT (WRAP-INTEGER (%SYMBOL-ID SYMBOL)))
...
(CL:DEFUN WALK-HARDCODED-SYMBOL-CASE-TREE (TREE)
  ...
  (CL:LET* ((COND NULL) (ITER-000 (%%REST (%%REST TREE))))
   (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-000 NIL)) DO
    (CL:PROGN (CL:SETQ COND (%%VALUE ITER-000))
     (CL:SETQ ITER-000 (%%REST ITER-000)))
    (FIRST-SETTER COND (YIELD-HARDCODED-CASE-SYMBOL-ID-OR-IDS (%%VALUE COND)))))
...
(CL:DEFUN COUNT-CASE-TEST-CLAUSES (TREE)
  (CL:LET* ((CLAUSES (%%REST (%%REST TREE))) (NOFCLAUSES 0) (OTHERWISE? FALSE))
     ...
     (CL:COND
      ...
      (CL:T
       (CL:IF (CL:EQ (%%VALUE CLAUSE) SYM-WALK-STELLA-OTHERWISE)
        (CL:SETQ OTHERWISE? TRUE) (CL:SETQ NOFCLAUSES (CL:1+ NOFCLAUSES)))))))
   ...
   (CL:LET* ((COND NULL) (ITER-000 CONDITIONS))
    (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-000 NIL)) DO
     (CL:PROGN (CL:SETQ COND (%%VALUE ITER-000))
      (CL:SETQ ITER-000 (%%REST ITER-000)))
     (FIRST-SETTER COND
      (YIELD-COND-TEST-OR-TESTS (%%VALUE COND) TESTVARIABLE EQUALITYTEST))))
   (CL:SETQ CONDITIONS
...
(CL:DEFUN WALK-CASE-TREE (TREE)
  (CL:LET* ((TEST-VALUE-000 FALSE)) (CL:SETQ TEST-VALUE-000 (>= (LENGTH TREE) 3))
   (CL:WHEN TEST-VALUE-000
    (CL:LET* ((ALWAYS?-000 TRUE))
     (CL:LET* ((CLAUSE NULL) (ITER-000 (%%REST (%%REST TREE))))
      (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-000 NIL)) DO
       (CL:PROGN (CL:SETQ CLAUSE (%%VALUE ITER-000))
        (CL:SETQ ITER-000 (%%REST ITER-000)))
       (CL:WHEN (CL:NOT (CONS? CLAUSE)) (CL:SETQ ALWAYS?-000 FALSE)
        (CL:RETURN))))
     (CL:SETQ TEST-VALUE-000 ALWAYS?-000)))
   (CL:SETQ TEST-VALUE-000 (CL:NOT TEST-VALUE-000))
   (CL:WHEN TEST-VALUE-000
    (CL:LET* ((*PRINTREADABLY?* TRUE)) (CL:DECLARE (CL:SPECIAL *PRINTREADABLY?*))
     ...
     (CL:WHEN (CL:NOT (SUPPRESS-WARNINGS?))
      (PRINT-ERROR-CONTEXT ">> ERROR: " STANDARD-ERROR)
      (%%PRINT-STREAM (%NATIVE-STREAM STANDARD-ERROR) EOL
       " Illegal `case' statement: `" (DE-UGLIFY-PARSE-TREE TREE) "'." EOL)))
  ...
  (CL:LET*
   ((CLAUSES (%%REST (%%REST TREE)))
    (FIRSTTESTTREE
     (CL:IF (CONS? (%%VALUE (%%VALUE CLAUSES)))
      (%%VALUE (%%VALUE (%%VALUE CLAUSES))) (%%VALUE (%%VALUE CLAUSES))))
    (CASECONSTANTTYPE SGT-WALK-STELLA-UNKNOWN))
   (CL:LET* ((TEST-VALUE-001 (SAFE-PRIMARY-TYPE FIRSTTESTTREE)))
    (CL:COND
     ((SUBTYPE-OF-SYMBOL? TEST-VALUE-001)
      (CL:PROGN (CL:SETQ CASECONSTANTTYPE SGT-WALK-STELLA-GENERALIZED-SYMBOL)))
     ...
     (CL:T
      (CL:LET* ((*PRINTREADABLY?* TRUE))
       ...
       (CL:WHEN (CL:NOT (SUPPRESS-WARNINGS?))
        (PRINT-ERROR-CONTEXT ">> ERROR: " STANDARD-ERROR)
        (%%PRINT-STREAM (%NATIVE-STREAM STANDARD-ERROR) EOL
         " `case' statement contains illegal constant of type `"
         (PRIMARY-TYPE FIRSTTESTTREE) "'" EOL "    `" (DE-UGLIFY-PARSE-TREE TREE)
         "'." EOL)))
      (CL:RETURN-FROM WALK-CASE-TREE
       (WALK-DONT-CALL-ME-TREE TREE SGT-WALK-STELLA-VOID)))))
   (SECOND-SETTER TREE
    (WALK-EXPRESSION-TREE (%%VALUE (%%REST TREE)) CASECONSTANTTYPE
     SYM-WALK-STELLA-CASE TRUE))
   (CL:WHEN (VRLET-EXPRESSION? (%%VALUE (%%REST TREE)))
    (CL:RETURN-FROM WALK-CASE-TREE
   ...
   (CL:WHEN (CL:NOT (CL:EQ *TRANSLATOROUTPUTLANGUAGE* KWD-WALK-COMMON-LISP))
    (CL:SETQ TREE
     (ATTACH-UNHANDLED-CASE-ERROR-CLAUSE TREE (%%VALUE (%%REST TREE)))))
...
(CL:DEFUN WALK-TYPECASE-TREE (TREE)
  (CL:LET*
   ((TESTTREE (%%VALUE (%%REST TREE))) (TESTEXPRESSIONTYPE NULL)
    ...
    (NEEDCAST?
     (CL:AND (SYMBOL? TESTTREE) (CL:EQ (LOOKUP-GLOBAL-VARIABLE TESTTREE) NULL)))
    (PRECEDINGCLAUSETYPES (NEW-LIST)))
   (CL:WHEN NEEDCAST? (CL:SETQ TESTVARIABLE TESTTREE))
   (CL:MULTIPLE-VALUE-SETQ (TESTTREE TESTEXPRESSIONTYPE) (WALK-A-TREE TESTTREE))
   ...
   (CL:WHEN NEEDCAST?
    (CL:LET* ((CASETREE NULL) (ITER-000 (%%REST (%%REST TREE))))
     (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-000 NIL)) DO
      (CL:PROGN (CL:SETQ CASETREE (%%VALUE ITER-000))
       (CL:SETQ ITER-000 (%%REST ITER-000)))
      (CL:COND
             ...
             (CL:LET* ((TYPE NULL) (ITER-001 (%%REST TYPETREE)))
              (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-001 NIL)) DO
               ...
               (CL:SETQ EXPANDEDCASES
                (CONS
                 (CONS TYPE (CONCATENATE (COPY-CONS-TREE (%%REST CASETREE)) NIL))
                 EXPANDEDCASES))))))
   ...
   (CL:LET* ((CASETREE NULL) (ITER-002 (%%REST (%%REST TREE))))
    (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-002 NIL)) DO
     (CL:PROGN (CL:SETQ CASETREE (%%VALUE ITER-002))
      (CL:SETQ ITER-002 (%%REST ITER-002)))
     (CL:COND
      ((CL:EQ (SAFE-PRIMARY-TYPE CASETREE) SGT-WALK-STELLA-CONS)
       (CL:PROGN
           ...
           ((SUBTYPE-OF-SYMBOL? TEST-VALUE-000)
            (CL:PROGN
             (CL:WHEN (CL:NOT (STRING-EQL? (%SYMBOL-NAME TYPETREE) "OTHERWISE"))
              (CL:LET*
               ((TYPE (TYPE-SPEC-TO-BASE-TYPE (YIELD-TYPE-SPECIFIER TYPETREE))))
              ...
              (CL:LOOP WHILE (NEXT? IT) DO
               (CL:WHEN (CONS? (%VALUE IT))
                ...
                (CL:RETURN-FROM WALK-TYPECASE-TREE
                 (WALK-DONT-CALL-ME-TREE TREE SGT-WALK-STELLA-VOID)))
               (VALUE-SETTER IT
                (TYPE-SPEC-TO-BASE-TYPE (YIELD-TYPE-SPECIFIER (%VALUE IT))))
               (VERIFY-TYPECASE-CLAUSE-TYPE TESTEXPRESSIONTYPE (%VALUE IT)
                PRECEDINGCLAUSETYPES CASETREE)))))
           (CL:T
            (CL:LET* ((*PRINTREADABLY?* TRUE))
             (CL:DECLARE (CL:SPECIAL *PRINTREADABLY?*))
   ...
   (CL:RETURN-FROM WALK-TYPECASE-TREE
    (WALK-NON-BUILT-IN-CASE-TREE
     (LIST* SYM-WALK-STELLA-CASE
      (LIST* SYM-WALK-STELLA-SAFE-PRIMARY-TYPE (%%VALUE (%%REST TREE)) NIL)
      (CONCATENATE (%%REST (%%REST TREE)) NIL))
       ...
       (LIST* SYM-WALK-STELLA-LET
        (CL:IF (CL:NOT (CL:EQ AUXVARIABLE NULL))
         (LIST* (CONS AUXVARIABLE (CONS TESTVARIABLE NIL))
          (CONS TESTVARIABLE (CONS CLAUSETYPE (CONS AUXVARIABLE NIL))) NIL)
         (CONS
          (CONS TESTVARIABLE
           (CONS
            (LIST* SYM-WALK-STELLA-SAFE-CAST
             (SYS-TREE (WALK-WITHOUT-TYPE-TREE TESTVARIABLE) CLAUSETYPE)
             (CONS CLAUSETYPE NIL))
            NIL))
          NIL))
...
(CL:DEFUN VERIFY-TYPECASE-CLAUSE-TYPE (TESTTYPE CLAUSETYPE PRECEDINGCLAUSETYPES CLAUSE)
  (CL:LET*
   ((SHADOWINGTYPE NULL) (WRAPPEDCLAUSETYPE (TYPE-TO-WRAPPED-TYPE CLAUSETYPE)))
    ...
    (CL:IF
     ...
     (CL:PROGN
      (CL:LET* ((*PRINTREADABLY?* TRUE))
       ...
       (CL:WHEN (CL:NOT (SUPPRESS-WARNINGS?))
        (PRINT-ERROR-CONTEXT ">> WARNING: " STANDARD-WARNING)
        (%%PRINT-STREAM (%NATIVE-STREAM STANDARD-WARNING) EOL " Type `"
         (DE-UGLIFY-PARSE-TREE CLAUSETYPE) "' of `typecase' clause " EOL "    `"
      ...
      (CL:LET* ((VALUE-000 NULL))
       (CL:LET* ((TYPE NULL) (ITER-000 (%THE-CONS-LIST PRECEDINGCLAUSETYPES)))
        (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-000 NIL)) DO
         (CL:PROGN (CL:SETQ TYPE (%%VALUE ITER-000))
          (CL:SETQ ITER-000 (%%REST ITER-000)))
         (CL:WHEN (SUBTYPE-OF? CLAUSETYPE TYPE) (CL:SETQ VALUE-000 TYPE)
          (CL:RETURN))))
       ...
       (CL:PROGN
        (CL:LET* ((*PRINTREADABLY?* TRUE))
         ...
         (CL:WHEN (CL:NOT (SUPPRESS-WARNINGS?))
          ...
          (%%PRINT-STREAM (%NATIVE-STREAM STANDARD-WARNING) EOL " Type `"
           (DE-UGLIFY-PARSE-TREE CLAUSETYPE) "' of `typecase' clause " EOL
           "    `" (DE-UGLIFY-PARSE-TREE CLAUSE) "'" EOL " is shadowed by type `"
...
(CL:DEFUN WALK-WITH-PROCESS-LOCK-TREE (TREE)
  (SECOND-SETTER TREE
   (WALK-EXPRESSION-TREE (%%VALUE (%%REST TREE))
    SGT-WALK-STELLA-PROCESS-LOCK-OBJECT (%%VALUE TREE) TRUE))
  (CL:SETF (%%REST (%%REST TREE))
   (WALK-LIST-OF-STATEMENTS (%%REST (%%REST TREE))))
...
(CL:DEFUN FINISH-WALKING-EQL-TREE (TREE TYPE1 TYPE2)
  ...
  (CL:WHEN (CL:NOT (SUBTYPE-OF? TYPE2 SGT-WALK-STELLA-LITERAL))
   (CL:LET* ((TEMPARG (%%VALUE (%%REST (%%REST TREE)))) (TEMPTYPE TYPE2))
    (THIRD-SETTER TREE (%%VALUE (%%REST TREE))) (SECOND-SETTER TREE TEMPARG)
    (CL:SETQ TYPE2 TYPE1) (CL:SETQ TYPE1 TEMPTYPE)))
  (CL:COND
   ...
   (CL:T
    (CL:LET* ((STREAM-000 (NEW-OUTPUT-STRING-STREAM)))
     (%%PRINT-STREAM (%NATIVE-STREAM STREAM-000) "`" TYPE2
      "' is not a valid case option")
     (CL:ERROR (NEW-STELLA-EXCEPTION (THE-STRING-READER STREAM-000))))))
  (CL:RETURN-FROM FINISH-WALKING-EQL-TREE
  ...
  (CL:LET* ((ARG1 NULL) (ARG2 NULL) (TYPE1 NULL) (TYPE2 NULL))
   ...
   (CL:MULTIPLE-VALUE-SETQ (ARG2 TYPE2)
    (WALK-EXPRESSION-TREE (%%VALUE (%%REST (%%REST TREE)))
     SGT-WALK-STELLA-UNKNOWN (%%VALUE TREE) TRUE))
   (SECOND-SETTER TREE ARG1) (THIRD-SETTER TREE ARG2)
   (CL:WHEN (VRLET-EXPRESSION? ARG1)
    (CL:RETURN-FROM WALK-EQUALITY-TREE
     (WALK-A-TREE
      (PERCOLATE-OUT-VRLET-EXPRESSION TREE ARG1 SGT-WALK-STELLA-BOOLEAN))))
   (CL:WHEN (VRLET-EXPRESSION? ARG2)
    (CL:RETURN-FROM WALK-EQUALITY-TREE
     (WALK-A-TREE
      (PERCOLATE-OUT-VRLET-EXPRESSION TREE ARG2 SGT-WALK-STELLA-BOOLEAN))))
   ...
   (CL:WHEN
    (CL:NOT
     (CL:OR (CL:EQ TYPE1 SGT-WALK-STELLA-UNKNOWN)
      ...
      (SUBTYPE-OF? TYPE2 TYPE1) (SUBTYPE-OF? (TYPE-TO-WRAPPED-TYPE TYPE1) TYPE2)
    ...
    (CL:LET* ((*PRINTREADABLY?* TRUE)) (CL:DECLARE (CL:SPECIAL *PRINTREADABLY?*))
     ...
     (CL:WHEN (CL:NOT (SUPPRESS-WARNINGS?))
      (PRINT-ERROR-CONTEXT ">> WARNING: " STANDARD-WARNING)
      (%%PRINT-STREAM (%NATIVE-STREAM STANDARD-WARNING) EOL
       " This equality test will always fail due to disjoint argument types:" EOL
       "    `" (DE-UGLIFY-PARSE-TREE TREE) "'." EOL))))
   (CL:LET* ((TEST-VALUE-000 (%%VALUE TREE)))
    (CL:COND
     ((CL:OR (CL:EQ TEST-VALUE-000 SYM-WALK-STELLA-EQ?)
...
(CL:DEFUN MORE-GENERAL-NUMERIC-TYPE (TYPE1 TYPE2)
  (CL:LET*
   ...
   (CL:WHEN (CL:OR (NULL? POSITION1) (NULL? POSITION2))
...
(CL:DEFUN YIELD-ARITHMETIC-OPERATOR-CALL-TREE (OPERATOR OPERANDS)
  (CL:RETURN-FROM YIELD-ARITHMETIC-OPERATOR-CALL-TREE
   (LIST* SYM-WALK-STELLA-SYS-CALL-METHOD SGT-WALK-STELLA-NUMBER OPERATOR
  ...
  (CL:LET*
     ...
     (CL:LET* ((TEST-VALUE-001 OPERATOR))
      (CL:COND
       ((CL:OR (CL:EQ TEST-VALUE-001 SYM-WALK-STELLA-+)
        ...
        (CL:LET* ((VALUE-002 NULL) (VALUE-003 NULL))
         (CL:MULTIPLE-VALUE-SETQ (VALUE-002 VALUE-003)
          (WALK-EXPRESSION-TREE (%%VALUE OPERANDS) SGT-WALK-STELLA-NUMBER
           OPERATOR FALSE))
   ...
   (CL:LET* ((IT (ALLOCATE-ITERATOR OPERANDS)))
    (CL:LOOP WHILE (NEXT? IT) DO
     (CL:MULTIPLE-VALUE-SETQ (OPERAND OPERANDTYPE)
      (WALK-EXPRESSION-TREE (%VALUE IT) SGT-WALK-STELLA-NUMBER OPERATOR FALSE))
     (CL:SETQ RETURNTYPE
   ...
   (CL:WHEN
    (CL:AND (CL:EQ OPERATOR SYM-WALK-STELLA-/)
     (CL:EQ RETURNTYPE SGT-WALK-STELLA-INTEGER))
    (CL:COND
     ((WRAPPER? (%%VALUE OPERANDS))
      (FIRST-SETTER OPERANDS
       (WRAP-FLOAT (CL:* (%WRAPPER-VALUE (%%VALUE OPERANDS)) 1.0d0))))
     ((WRAPPER? (%%VALUE (%%REST OPERANDS)))
      (SECOND-SETTER OPERANDS
       (WRAP-FLOAT (CL:* (%WRAPPER-VALUE (%%VALUE (%%REST OPERANDS))) 1.0d0))))
     (CL:T
      (CL:SETQ OPERANDS
       (CONS
   ...
   (CL:IF
    ...
    (CL:LET* ((VALUE-004 NULL) (VALUE-005 NULL))
     (CL:MULTIPLE-VALUE-SETQ (VALUE-004 VALUE-005)
      (SYS-TREE (YIELD-NESTED-ARITHMETIC-OPERATOR-CALL-TREE OPERATOR OPERANDS)
       RETURNTYPE))
...
(CL:DEFUN WALK-QUOTED-TREE (TREE)
  ...
  (CL:LET*
   ((ARGUMENT (%%VALUE (%%REST TREE)))
    (QUOTEDLITERAL? (CL:OR (CL:NOT (CONS? ARGUMENT)) (CL:EQ ARGUMENT NIL)))
...
(CL:DEFUN WALK-BQUOTE-TREE (TREE)
  ...
  (CL:LET* ((OTREE NULL) (OTYPE NULL))
   (CL:MULTIPLE-VALUE-SETQ (OTREE OTYPE)
    (WALK-A-TREE
     (SIMPLIFY-BQUOTE-TREE (EXPAND-BQUOTE-TREE (%%VALUE (%%REST TREE))))))
...
(CL:DEFUN EXPAND-MACRO (TREE)
  (CL:LET*
   ((MACRONAME (%%VALUE TREE)) (EXPANDEROBJECT (LOOKUP-MACRO MACRONAME))
    (EXPANDERCODE (%FUNCTION-CODE EXPANDEROBJECT)) (ARGS (%%REST TREE))
    (EXPANSION NULL))
   ...
   (CL:IF
    (%WRAPPER-VALUE
     (DYNAMIC-SLOT-VALUE (%DYNAMIC-SLOTS EXPANDEROBJECT)
    ...
    (CL:CASE (METHOD-ARGUMENT-COUNT EXPANDEROBJECT)
     ...
     (2
      (CL:SETQ EXPANSION (CL:FUNCALL EXPANDERCODE (%%VALUE ARGS) (%%REST ARGS)))
     ...
     (5
      (CL:SETQ EXPANSION
       (CL:FUNCALL EXPANDERCODE (%%VALUE ARGS) (%%VALUE (%%REST ARGS))
        (%%VALUE (%%REST (%%REST ARGS))) (FOURTH ARGS) (NTH-REST ARGS 4)))
  ...
  (CL:WHEN (CL:<= (LENGTH TREE) 2)
   (CL:LET* ((*PRINTREADABLY?* TRUE)) (CL:DECLARE (CL:SPECIAL *PRINTREADABLY?*))
    ...
    (CL:WHEN (CL:NOT (SUPPRESS-WARNINGS?))
     (PRINT-ERROR-CONTEXT ">> ERROR: " STANDARD-ERROR)
     (%%PRINT-STREAM (%NATIVE-STREAM STANDARD-ERROR) EOL
      " Missing arguments in print statement: `" (DE-UGLIFY-PARSE-TREE TREE) "'."
      EOL)))
   (CL:RETURN-FROM WALK-PRINT-STREAM-TREE
    (WALK-DONT-CALL-ME-TREE TREE SGT-WALK-STELLA-VOID)))
  (CL:LET*
   ((OPERATOR (%%VALUE TREE)) (STREAMTREE (%%VALUE (%%REST TREE))) (OTREE NULL)
    (OTYPE NULL))
   (CL:COND
    ((KEYWORD? STREAMTREE)
     (CL:WHEN
    ...
    (CL:T
     (CL:MULTIPLE-VALUE-SETQ (OTREE OTYPE)
      (WALK-EXPRESSION-TREE STREAMTREE SGT-WALK-STELLA-NATIVE-OUTPUT-STREAM
       (%%VALUE TREE) FALSE))
   ...
   (CL:LET* ((IT (ALLOCATE-ITERATOR (%%REST (%%REST TREE)))))
    (CL:LOOP WHILE (NEXT? IT) DO
     (CL:MULTIPLE-VALUE-SETQ (OTREE OTYPE)
      (WALK-EXPRESSION-TREE (%VALUE IT) SGT-WALK-STELLA-UNKNOWN OPERATOR FALSE))
     (VALUE-SETTER IT OTREE)
      ...
      (CL:LET* ((TEST-VALUE-000 (SAFE-PRIMARY-TYPE OTREE)))
       (CL:COND ((SUBTYPE-OF-STRING? TEST-VALUE-000) (CL:PROGN))
        ...
        ((SUBTYPE-OF-CHARACTER? TEST-VALUE-000)
         (CL:PROGN
          (VALUE-SETTER IT
           (WRAP-STRING (MAKE-STRING 1 (%WRAPPER-VALUE OTREE))))))
...
(CL:DEFUN WALK-UNDEFINED-SLOT-TREE (TREE FIRSTARGTYPE WARN?)
  (CL:LET*
   ((CURSOR (%%REST (%%REST TREE))) (TYPE (TYPE-SPEC-TO-BASE-TYPE FIRSTARGTYPE))
    ...
    (CL:LET* ((*PRINTREADABLY?* TRUE)) (CL:DECLARE (CL:SPECIAL *PRINTREADABLY?*))
     ...
     (CL:WHEN (CL:NOT (SUPPRESS-WARNINGS?))
      ...
      (%%PRINT-STREAM (%NATIVE-STREAM STANDARD-ERROR) EOL
       ...
       (DE-UGLIFY-PARSE-TREE OPERATORNAME) "'" EOL "   in the expression:" EOL
       "   `" (DE-UGLIFY-PARSE-TREE TREE) "'." EOL))))
   (CL:RETURN-FROM WALK-UNDEFINED-SLOT-TREE
    (CL:VALUES
     (LIST* SYM-WALK-STELLA-SYS-CALL-METHOD TYPE (CONCATENATE TREE NIL))
     SGT-WALK-STELLA-UNKNOWN))))
...
(CL:DEFUN WALK-SLOT-ON-ABSTRACT-TYPE-TREE (TREE ABSTRACTTYPE)
  (CL:LET*
   ((METHODNAME (%%VALUE TREE))
    ...
    (UNDEFINEDMETHOD? TRUE) (OTREE NULL) (OTYPE NULL))
     ...
     (CL:LET*
      ...
      (CL:COND
       ((CL:AND (CL:= NOFSUBS NOFMETHODS) COMPATIBLE?)
        ...
        (SECOND-SETTER TREE
         (SYS-TREE (%%VALUE (%%REST TREE)) (%SLOT-OWNER PROTOTYPEMETHOD)))
        (CL:MULTIPLE-VALUE-SETQ (OTREE OTYPE) (WALK-CALL-SLOT-TREE TREE)))
        ...
        (CL:LET* ((*PRINTREADABLY?* TRUE))
         ...
         (CL:WHEN (CL:NOT (SUPPRESS-WARNINGS?))
          ...
          (%%PRINT-STREAM (%NATIVE-STREAM STANDARD-OUTPUT) EOL
           ...
           "' on abstract type `" (DE-UGLIFY-PARSE-TREE ABSTRACTTYPE) "'," EOL
           "   since the implementations of `" (DE-UGLIFY-PARSE-TREE METHODNAME)
           "' on the non-abstract" EOL "   subtypes of `"
           (DE-UGLIFY-PARSE-TREE ABSTRACTTYPE) "' are not all compatible."
           EOL))))
       (CL:T
        (CL:LET* ((*PRINTREADABLY?* TRUE))
         (CL:DECLARE (CL:SPECIAL *PRINTREADABLY?*)) (SIGNAL-TRANSLATION-WARNING)
         (CL:WHEN (CL:NOT (SUPPRESS-WARNINGS?))
          ...
          (%%PRINT-STREAM (%NATIVE-STREAM STANDARD-OUTPUT) EOL
           " Could not infer `" (DE-UGLIFY-PARSE-TREE METHODNAME)
           "' on abstract type `" (DE-UGLIFY-PARSE-TREE ABSTRACTTYPE) "'," EOL
           "   since `" (DE-UGLIFY-PARSE-TREE METHODNAME)
           "' is only implemented on `"
           (DE-UGLIFY-PARSE-TREE (WRAP-INTEGER NOFMETHODS)) "' of the `"
           (DE-UGLIFY-PARSE-TREE (WRAP-INTEGER NOFSUBS)) "'" EOL
           "   non-abstract subtypes of `" (DE-UGLIFY-PARSE-TREE ABSTRACTTYPE)
           "'." EOL)))
        (CL:WHEN (CL:NOT COMPATIBLE?)
         (%%PRINT-STREAM (%NATIVE-STREAM STANDARD-OUTPUT)
          " Additionally, the method signatures are not compatible." EOL)))))))
...
(CL:DEFUN FIND-PROTOTYPE-METHOD (METHODNAME ABSTRACTTYPE)
  (CL:LET* ((METHOD NULL))
   (CL:LET*
    ((SUB NULL)
     (ITER-000
      (%THE-CONS-LIST (%CLASS-DIRECT-SUBS (%SURROGATE-VALUE ABSTRACTTYPE)))))
    (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-000 NIL)) DO
     ...
     (CL:WHEN (CL:NOT (CL:EQ (%SURROGATE-VALUE SUB) NULL))
      ...
      (CL:WHEN
       (CL:AND (CL:NOT (CL:EQ METHOD NULL)) (CL:NOT (STORAGE-SLOT? METHOD)))
...
(CL:DEFUN COMPATIBLE-REAL-METHODS (PROTOTYPEMETHOD ABSTRACTTYPE)
  (CL:LET*
   ((METHODNAME (%SLOT-NAME PROTOTYPEMETHOD)) (NOFREALSUBTYPES 0)
    (NOFREALMETHODS 0) (COMPATIBLESIGNATURES? TRUE))
    ...
    (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-000 NIL)) DO
     ...
     (CL:IF (%ABSTRACT? (%SURROGATE-VALUE SUB))
      (CL:LET*
       ...
       (CL:WHEN (CL:NOT COMPATIBLE?) (CL:SETQ COMPATIBLESIGNATURES? FALSE)))
      (CL:LET* ((THISMETHOD NULL))
       ...
       (CL:WHEN
        ...
        (CL:WHEN (CL:NOT (IDENTICAL-SIGNATURES? PROTOTYPEMETHOD THISMETHOD))
...
(CL:DECLAIM
 (CL:FTYPE (CL:FUNCTION (CL:T CL:T) (CL:VALUES CL:FIXNUM CL:FIXNUM CL:T))
  ...
  (CL:LET*
   ...
   (CL:IF (SYSTEM-DEFINED-SLOT-READER? SELF)
    (CL:RETURN-FROM FINISH-WALKING-CALL-SLOT-TREE
     (CL:VALUES
      (LIST* SYM-WALK-STELLA-SYS-CALL-METHOD (%SLOT-OWNER SELF)
       (CONS (%SLOT-NAME SELF) (CONS OBJECTREF NIL)))
      OTYPE))
    (CL:RETURN-FROM FINISH-WALKING-CALL-SLOT-TREE
     (CL:VALUES (YIELD-SLOT-VALUE-TREE SELF OBJECTREF FIRSTARGTYPE OTYPE NULL)
      OTYPE)))))
...
(CL:DEFUN STRING-CONCATENATE-METHOD? (METHOD)
  (CL:RETURN-FROM STRING-CONCATENATE-METHOD?
   (CL:AND (CL:EQ (%SLOT-NAME METHOD) SYM-WALK-STELLA-CONCATENATE)
    (CL:EQ (%SLOT-OWNER METHOD) SGT-WALK-STELLA-STRING))))
...
(CL:DEFUN VARIABLE-ARGUMENTS-TYPE (METHOD)
  (CL:RETURN-FROM VARIABLE-ARGUMENTS-TYPE
   (EXTRACT-PARAMETER-TYPE (LAST (METHOD-PARAMETER-TYPE-SPECIFIERS METHOD))
...
(CL:DEFUN YIELD-LISTIFIED-VARIABLE-ARGUMENTS-TYPE (METHOD)
  (CL:LET*
   ...
   (CL:LET* ((SELF-000 (NEW-PARAMETRIC-TYPE-SPECIFIER)))
    (CL:SETF (%SPECIFIER-BASE-TYPE SELF-000) LISTBASETYPE)
    (CL:SETF (%SPECIFIER-PARAMETER-TYPES SELF-000) (LIST ELEMENTTYPE))
    (CL:LET* ((VALUE-000 SELF-000))
     (CL:RETURN-FROM YIELD-LISTIFIED-VARIABLE-ARGUMENTS-TYPE VALUE-000)))))
...
(CL:DEFUN FINISH-WALKING-ARGUMENT-LIST-TREE (SELF TREE FIRSTARGTYPE)
  (CL:WHEN (CL:EQ (%SLOT-NAME SELF) SYM-WALK-STELLA-ALLOCATE-ITERATOR)
   (CL:LET* ((*PRINTREADABLY?* TRUE)) (CL:DECLARE (CL:SPECIAL *PRINTREADABLY?*))
    ...
    (CL:WHEN (CL:NOT (SUPPRESS-WARNINGS?))
     (PRINT-ERROR-CONTEXT ">> ERROR: " STANDARD-ERROR)
     (%%PRINT-STREAM (%NATIVE-STREAM STANDARD-ERROR) EOL " Cannot invoke `"
      (DE-UGLIFY-PARSE-TREE SELF) "' directly, use `foreach' instead." EOL)))
...
(CL:DEFUN WALK-VARIABLE-ARGUMENTS (ARGUMENTS METHOD)
  (CL:LET*
   ...
   (CL:LOOP WHILE (CL:NOT (CL:EQ CURSOR NIL)) DO
    (CL:SETF (%%VALUE CURSOR)
     (WALK-EXPRESSION-TREE (%%VALUE CURSOR) TARGETTYPE (%SLOT-NAME METHOD)
      FALSE))
    (CL:SETQ CURSOR (%%REST CURSOR)))
   (CL:WHEN LISTIFYARGS?
    (CL:LET*
...
(CL:DEFMETHOD FINISH-WALKING-CALL-SLOT-TREE ((SELF METHOD-SLOT) TREE FIRSTARGTYPE)
  (CL:LET*
   ((METHODNAME (%SLOT-NAME SELF))
    (OTYPESPEC (COMPUTE-RETURN-TYPE-SPEC SELF FIRSTARGTYPE)) (OTREE NULL))
   (CL:LET*
    ((PTYPESPECS (METHOD-PARAMETER-TYPE-SPECIFIERS SELF))
     (NOFPARAMETERS (LENGTH PTYPESPECS)) (CURSOR (%%REST (%%REST TREE))))
    (CL:DECLARE (CL:TYPE CL:FIXNUM NOFPARAMETERS))
    (CL:LET*
     ((PINDEX NULL-INTEGER) (TARGETTS NULL) (ITER-000 (REST PTYPESPECS))
      (ITER-001 2) (UPPER-BOUND-000 NOFPARAMETERS)
      (UNBOUNDED?-000 (NULL? UPPER-BOUND-000)))
     (CL:DECLARE (CL:TYPE CL:FIXNUM ITER-001 UPPER-BOUND-000 PINDEX))
     (CL:LOOP WHILE
      (CL:AND (CL:NOT (CL:EQ ITER-000 NIL))
       (CL:OR UNBOUNDED?-000 (CL:<= ITER-001 UPPER-BOUND-000)))
      DO
      (CL:PROGN (CL:SETQ TARGETTS (%%VALUE ITER-000))
       (CL:SETQ ITER-000 (%%REST ITER-000)))
      (CL:PROGN (CL:SETQ PINDEX ITER-001) (CL:SETQ ITER-001 (CL:1+ ITER-001)))
   ...
   (CL:WHEN (INLINE-METHOD-CALL? SELF)
    (CL:SETQ OTREE (WALK-INLINE-METHOD-CALL SELF (%%REST TREE)))
    (CL:WHEN (CL:NOT (CL:EQ OTREE NULL))
     (CL:RETURN-FROM FINISH-WALKING-CALL-SLOT-TREE (SYS-TREE OTREE OTYPESPEC))))
...
(CL:DEFUN QUOTE-ARGUMENTS (METHOD ARGUMENTS)
  (CL:LET*
   ...
   (CL:LET*
    ((ARGINDEX NULL-INTEGER) (IT (ALLOCATE-ITERATOR ARGUMENTS)) (ITER-000 0))
    (CL:DECLARE (CL:TYPE CL:FIXNUM ITER-000 ARGINDEX))
    (CL:LOOP WHILE (NEXT? IT) DO
     (CL:PROGN (CL:SETQ ARGINDEX ITER-000) (CL:SETQ ITER-000 (CL:1+ ITER-000)))
     (CL:TAGBODY
       ...
       (CL:WHEN
        (CL:OR (CL:EQ (%VALUE IT) SYM-WALK-STELLA-NULL)
         (CL:AND (CL:EQ PTYPE SGT-WALK-STELLA-BOOLEAN)
          (CL:OR (CL:EQ (%VALUE IT) SYM-WALK-STELLA-TRUE)
           (CL:EQ (%VALUE IT) SYM-WALK-STELLA-FALSE)))
         (CL:AND (WRAPPER? (%VALUE IT)) (CL:NOT (CL:EQ PTYPE NULL))
          (SUB-TYPE-SPEC-OF? PTYPE SGT-WALK-STELLA-LITERAL)))
        (CL:GO :CONTINUE))
       (VALUE-SETTER IT
        (LIST* SYM-WALK-STELLA-COPY-CONS-TREE
         (LIST* SYM-WALK-STELLA-QUOTE (%VALUE IT) NIL) NIL)))
      :CONTINUE)))
...
(CL:DEFUN WALK-FIRST-ARGUMENT-TO-FUNCTION (FNSLOT TREE)
  (CL:LET*
   ...
   (CL:WHEN
    (CL:AND
     (%WRAPPER-VALUE
      (DYNAMIC-SLOT-VALUE (%DYNAMIC-SLOTS FNSLOT)
       SYM-WALK-STELLA-METHOD-VARIABLE-ARGUMENTS? FALSE-WRAPPER))
     (CL:= (LENGTH PTYPESPECS) 1))
    (CL:SETF (%%REST TREE) (WALK-VARIABLE-ARGUMENTS (%%REST TREE) FNSLOT))
   ...
   (CL:LET* ((OTREE NULL) (OTYPE NULL))
    (CL:MULTIPLE-VALUE-SETQ (OTREE OTYPE)
     (WALK-EXPRESSION-TREE (%%VALUE (%%REST TREE)) TARGETTS (%SLOT-NAME FNSLOT)
      TRUE))
    (SECOND-SETTER TREE OTREE)
    (CL:COND
...
(CL:DEFUN WALK-CALL-SLOT-TREE (TREE)
  (CL:LET*
   ((SLOTNAME (%%VALUE TREE)) (WALKEDFIRSTARG NULL)
    ...
    (ILLEGALFIRSTARG? FALSE) (PREVIOUSERRORS *TRANSLATIONERRORS*) (SLOT NULL))
   (CL:DECLARE (CL:TYPE CL:FIXNUM PREVIOUSERRORS))
   (CL:WHEN (CL:EQ SLOTNAME SYM-WALK-STELLA-ERROR) (CL:SETQ *FOUNDRETURN?* TRUE))
   (CL:SETQ SLOT (LOOKUP-FUNCTION SLOTNAME))
   (CL:IF (CL:NOT (CL:EQ SLOT NULL))
    (CL:IF
     (%WRAPPER-VALUE
      (DYNAMIC-SLOT-VALUE (%DYNAMIC-SLOTS SLOT) SYM-WALK-STELLA-METHOD-MACRO?
       FALSE-WRAPPER))
     ...
     (CL:WHEN (VOID? FIRSTARGTYPE)
      (CL:LET* ((*PRINTREADABLY?* TRUE))
       ...
       (CL:WHEN (CL:NOT (SUPPRESS-WARNINGS?))
        (PRINT-ERROR-CONTEXT ">> ERROR: " STANDARD-ERROR)
        (%%PRINT-STREAM (%NATIVE-STREAM STANDARD-ERROR) EOL
         " First argument in call to `" (DE-UGLIFY-PARSE-TREE SLOTNAME)
         "' returns @VOID." EOL)))
   ...
   (CL:WHEN
    ...
    (CL:SETQ SLOT
     (LOOKUP-SLOT (%SURROGATE-VALUE SGT-WALK-STELLA-CONS) SLOTNAME)))
   (CL:WHEN (CL:EQ SLOT NULL)
    (CL:IF
     ...
     (CL:RETURN-FROM WALK-CALL-SLOT-TREE
      (WALK-UNDEFINED-SLOT-TREE TREE
       (CL:IF (VOID? FIRSTARGTYPE) SGT-WALK-STELLA-UNKNOWN FIRSTARGTYPE)
  ...
  (CL:WHEN
   (CL:OR (VOID? (TYPE METHOD))
    ...
    (%WRAPPER-VALUE
     (DYNAMIC-SLOT-VALUE (%DYNAMIC-SLOTS METHOD)
      SYM-WALK-STELLA-METHOD-VARIABLE-ARGUMENTS? FALSE-WRAPPER)))
   (CL:RETURN-FROM METHOD-INLINABLE? FALSE))
  (CL:COND
   ...
   (CL:T
    (CL:LET* ((*PRINTREADABLY?* TRUE)) (CL:DECLARE (CL:SPECIAL *PRINTREADABLY?*))
     ...
     (CL:WHEN (CL:NOT (SUPPRESS-WARNINGS?))
      (PRINT-ERROR-CONTEXT ">> WARNING: " STANDARD-WARNING)
      (%%PRINT-STREAM (%NATIVE-STREAM STANDARD-WARNING) EOL
       " Cannot inline method `" (DE-UGLIFY-PARSE-TREE METHOD)
  ...
  (CL:LET* ((ALWAYS?-000 TRUE))
   (CL:LET*
    ((SUB NULL)
     (ITER-000
      (%THE-CONS-LIST
       (%CLASS-DIRECT-SUBS (%SURROGATE-VALUE (%SLOT-OWNER METHOD))))))
    (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-000 NIL)) DO
     (CL:PROGN (CL:SETQ SUB (%%VALUE ITER-000))
      (CL:SETQ ITER-000 (%%REST ITER-000)))
     (CL:WHEN (CL:NOT (HELP-MOST-SPECIFIC-METHOD? (%SURROGATE-VALUE SUB) METHOD))
      (CL:SETQ ALWAYS?-000 FALSE) (CL:RETURN))))
...
(CL:DEFUN HELP-MOST-SPECIFIC-METHOD? (CLASS METHOD)
  (CL:WHEN (CL:EQ CLASS NULL) (CL:RETURN-FROM HELP-MOST-SPECIFIC-METHOD? TRUE))
  (CL:LET* ((TEST-VALUE-000 FALSE))
   (CL:LET* ((FOUND?-000 FALSE))
    (CL:LET* ((SLOT NULL) (ITER-000 (%THE-CONS-LIST (%CLASS-LOCAL-SLOTS CLASS))))
     (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-000 NIL)) DO
      (CL:PROGN (CL:SETQ SLOT (%%VALUE ITER-000))
       (CL:SETQ ITER-000 (%%REST ITER-000)))
      (CL:WHEN (CL:EQ (%SLOT-DIRECT-EQUIVALENT SLOT) METHOD)
       (CL:SETQ FOUND?-000 TRUE) (CL:RETURN))))
    (CL:SETQ TEST-VALUE-000 FOUND?-000))
   (CL:SETQ TEST-VALUE-000 (CL:NOT TEST-VALUE-000))
   (CL:WHEN TEST-VALUE-000
     ...
     (CL:LET* ((SUB NULL) (ITER-001 (%THE-CONS-LIST (%CLASS-DIRECT-SUBS CLASS))))
      (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-001 NIL)) DO
       (CL:PROGN (CL:SETQ SUB (%%VALUE ITER-001))
        (CL:SETQ ITER-001 (%%REST ITER-001)))
       (CL:WHEN
        (CL:NOT (HELP-MOST-SPECIFIC-METHOD? (%SURROGATE-VALUE SUB) METHOD))
        (CL:SETQ ALWAYS?-000 FALSE) (CL:RETURN))))
     (CL:SETQ TEST-VALUE-000 ALWAYS?-000)))
   (CL:LET* ((VALUE-000 TEST-VALUE-000))
...
(CL:DEFUN INLINABLE-METHOD-BODY (METHOD)
  (CL:LET*
   ...
   (CL:SETQ DEFINITION
    (UNSTRINGIFY-STELLA-SOURCE (%METHOD-STRINGIFIED-SOURCE METHOD)
     (HOME-MODULE METHOD)))
...
(CL:DEFVAR *INLININGMETHODCALL?* FALSE)

;;; (DEFUN (WALK-INLINE-METHOD-CALL OBJECT) ...)

(CL:DEFUN WALK-INLINE-METHOD-CALL (METHOD WALKEDARGS)
  (CL:LET*
   ((BODY (INLINABLE-METHOD-BODY METHOD)) (NOFREFERENCES NULL-INTEGER)
    (INLINEARG NULL) (SUCCESS? TRUE))
   ...
   (CL:LET* ((*INLININGMETHODCALL?* TRUE) (*METHODBEINGWALKED* METHOD))
    (CL:DECLARE (CL:SPECIAL *INLININGMETHODCALL?* *METHODBEINGWALKED*))
    (CL:LET*
     ((ARG NULL) (TSPEC NULL) (VAR NULL)
     ...
     (CL:LOOP WHILE
      ...
      (SET-LOCAL-VARIABLE-INFO VAR KWD-WALK-INLINE-REFERENCES (WRAP-INTEGER 0))))
    (CL:SETQ BODY
     (WALK-EXPRESSION-TREE BODY (TYPE METHOD) SYM-WALK-STELLA-INLINE-CALL TRUE)))
   (CL:WHEN (PROCEDURAL-EXPRESSION? BODY) (CL:SETQ SUCCESS? FALSE))
   (CL:WHEN SUCCESS?
    (CL:LET*
     ((VAR NULL) (ITER-003 (%THE-CONS-LIST (METHOD-PARAMETER-NAMES METHOD))))
     (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-003 NIL)) DO
      (CL:PROGN (CL:SETQ VAR (%%VALUE ITER-003))
       (CL:SETQ ITER-003 (%%REST ITER-003)))
      (CL:SETQ INLINEARG (GET-LOCAL-VARIABLE-INFO VAR KWD-WALK-INLINE-ARGUMENT))
      (CL:SETQ NOFREFERENCES
       (%WRAPPER-VALUE (GET-LOCAL-VARIABLE-INFO VAR KWD-WALK-INLINE-REFERENCES)))
      (CL:CASE NOFREFERENCES
       (0
        (CL:WHEN (CL:NOT (SIDE-EFFECT-FREE-EXPRESSION? INLINEARG))
         (CL:SETQ SUCCESS? FALSE) (CL:RETURN)))
       (1)
       (CL:OTHERWISE
        (CL:WHEN
         (CL:NOT
         ...
         (CL:SETQ SUCCESS? FALSE) (CL:RETURN)))))))
   (CL:LET*
    ((VAR NULL) (ITER-004 (%THE-CONS-LIST (METHOD-PARAMETER-NAMES METHOD))))
    (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-004 NIL)) DO
     (CL:PROGN (CL:SETQ VAR (%%VALUE ITER-004))
      (CL:SETQ ITER-004 (%%REST ITER-004)))
     (CL:SETQ VAR VAR) (POP-VARIABLE-BINDING)))
...
(CL:DEFUN YIELD-VERBATIM-INLINE-CALL-TREE (METHOD WALKEDARGS)
  (CL:RETURN-FROM YIELD-VERBATIM-INLINE-CALL-TREE
   (LIST* SYM-WALK-STELLA-SYS-INLINE-CALL
    (CONS
     (CL:IF (%METHOD-FUNCTION? METHOD) SYM-WALK-STELLA-SYS-CALL-FUNCTION
      SYM-WALK-STELLA-SYS-CALL-METHOD)
     (CONCATENATE
      (CL:IF (%METHOD-FUNCTION? METHOD) NIL (CONS (%SLOT-OWNER METHOD) NIL))
...
(CL:DEFUN WALK-INLINE-VARIABLE-REFERENCE (SELF)
  (SET-LOCAL-VARIABLE-INFO SELF KWD-WALK-INLINE-REFERENCES
   (WRAP-INTEGER
    (CL:1+
     (%WRAPPER-VALUE (GET-LOCAL-VARIABLE-INFO SELF KWD-WALK-INLINE-REFERENCES)))))
  (CL:RETURN-FROM WALK-INLINE-VARIABLE-REFERENCE
   (SYS-TREE
    (COPY-CONS-TREE (GET-LOCAL-VARIABLE-INFO SELF KWD-WALK-INLINE-ARGUMENT))
    ...
    (CL:PROGN
     (CL:LET* ((TEST-VALUE-000 (%%VALUE TREE)))
      (CL:COND
       ...
       (CL:T)))))
   (CL:T (CL:RETURN-FROM SIDE-EFFECT-FREE-EXPRESSION? TRUE)))
  (CL:RETURN-FROM SIDE-EFFECT-FREE-EXPRESSION? FALSE))
    ...
    ((CL:NOT (CL:EQ BODY NIL))
     (CL:LET* ((*PRINTREADABLY?* TRUE))
      ...
      (CL:WHEN (CL:NOT (SUPPRESS-WARNINGS?))
       (PRINT-ERROR-CONTEXT ">> ERROR: " STANDARD-ERROR)
       (%%PRINT-STREAM (%NATIVE-STREAM STANDARD-ERROR) EOL
        " Over-specified definition of :inherits-through method." EOL)))
  ...
  (CL:LET* ((METHOD (%THE-OBJECT UNIT)) (BODY (%CODE-REGISTER UNIT)))
   (CL:LET*
    ((*LOCALVARIABLETYPETABLE* (NEW-KEY-VALUE-LIST))
     ...
     (*SPECIALVARIABLESTACK* (NEW-KEY-VALUE-LIST)) (*METHODBEINGWALKED* METHOD)
     (*FOUNDRETURN?* FALSE))
    (CL:DECLARE
    ...
    (CL:LET*
     ...
     (CL:LOOP WHILE
      ...
      (CL:PROGN (CL:SETQ NAME (%%VALUE ITER-000))
       (CL:SETQ ITER-000 (%%REST ITER-000)))
      (CL:PROGN (CL:SETQ TYPESPEC (%%VALUE ITER-001))
       (CL:SETQ ITER-001 (%%REST ITER-001)))
    ...
    (CL:WHEN (CL:NOT (CL:EQ BODY NIL))
     (CL:LET* ((TEST-VALUE-000 FALSE))
      ...
      (CL:WHEN TEST-VALUE-000
       ...
       (CL:WHEN TEST-VALUE-000
        (CL:SETQ TEST-VALUE-000 (CL:NOT (%AUXILIARY? UNIT)))
        (CL:WHEN TEST-VALUE-000
         ...
         (CL:WHEN TEST-VALUE-000
          (CL:LET* ((FOUND?-000 FALSE))
           (CL:LET* ((FORM NULL) (ITER-002 BODY))
            (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-002 NIL)) DO
             (CL:PROGN (CL:SETQ FORM (%%VALUE ITER-002))
              (CL:SETQ ITER-002 (%%REST ITER-002)))
             (CL:WHEN
              (CL:AND (CONS? FORM) (CL:EQ (%%VALUE FORM) SYM-WALK-STELLA-RETURN))
              (CL:SETQ FOUND?-000 TRUE) (CL:RETURN))))
           (CL:SETQ TEST-VALUE-000 FOUND?-000))
          (CL:SETQ TEST-VALUE-000 (CL:NOT TEST-VALUE-000))))))
      (CL:WHEN TEST-VALUE-000
     ...
     (CL:WHEN
      (CL:AND (CL:NOT (VOID? (TYPE METHOD))) (CL:NOT (%ABSTRACT? METHOD))
       (CL:NOT *FOUNDRETURN?*))
      (CL:LET* ((*PRINTREADABLY?* TRUE))
       (CL:DECLARE (CL:SPECIAL *PRINTREADABLY?*)) (SIGNAL-TRANSLATION-ERROR)
       (CL:WHEN (CL:NOT (SUPPRESS-WARNINGS?))
        (PRINT-ERROR-CONTEXT ">> ERROR: " STANDARD-ERROR)
        (%%PRINT-STREAM (%NATIVE-STREAM STANDARD-ERROR) EOL
         " Missing return statement." EOL)))))
    (FREE *LOCALVARIABLETYPETABLE*) (FREE *LOCALGENSYMTABLE*)
    (FREE *SPECIALVARIABLESTACK*) (CL:SETF (%CODE-REGISTER UNIT) BODY)
...
(CL:DEFUN WALK-DEFMETHOD-TREE (TREE)
  (CL:LET* ((METHOD NULL))
   (CL:LET* ((SELF-000 (NEW-TRANSLATION-UNIT)))
    (CL:SETF (%CATEGORY SELF-000) SYM-WALK-STELLA-METHOD)
    (CL:SETF (%THE-OBJECT SELF-000) TREE)
   ...
   (CL:COND
    ((CL:AND (CL:NOT (%METHOD-FUNCTION? METHOD))
      (CL:OR (CL:EQ (%SLOT-OWNER METHOD) NULL)
       (CL:EQ (%SURROGATE-VALUE (%SLOT-OWNER METHOD)) NULL)))
     (CL:LET* ((*PRINTREADABLY?* TRUE))
      (CL:DECLARE (CL:SPECIAL *PRINTREADABLY?*)) (SIGNAL-TRANSLATION-ERROR)
      (CL:WHEN (CL:NOT (SUPPRESS-WARNINGS?))
       (PRINT-ERROR-CONTEXT ">> ERROR: " STANDARD-ERROR)
       (%%PRINT-STREAM (%NATIVE-STREAM STANDARD-ERROR) EOL
        " Can't define method `" (%SLOT-NAME METHOD)
    ...
    (CL:T (CL:SETF (%THE-OBJECT *CURRENTTRANSLATIONUNIT*) METHOD)
     ...
     (CL:WHEN (METHOD-NEEDS-LISP-MACRO? METHOD)
      (REGISTER-NATIVE-NAME (%SLOT-NAME METHOD) KWD-WALK-COMMON-LISP
       KWD-WALK-FUNCTION)))))
  :VOID)
...
(CL:DEFUN WALK-METHOD-UNIT (UNIT)
  (CL:LET* ((*CURRENTTRANSLATIONUNIT* UNIT))
   (CL:DECLARE (CL:SPECIAL *CURRENTTRANSLATIONUNIT*))
   (CL:LET*
    ((METHOD (%THE-OBJECT UNIT)) (NAME (%SLOT-NAME METHOD))
     (BODY (%CODE-REGISTER UNIT)) (CREATEMETHODOBJECT? TRUE)
     (STORECODEPOINTER? TRUE) (EVALUATORWRAPPERMETHOD NULL))
    (CL:WHEN
     (CL:AND (MIXIN-METHOD? METHOD) (TRANSLATE-TO-SINGLE-INHERITANCE-LANGUAGE?))
    ...
    (CL:WHEN
     ...
     (SET-DYNAMIC-SLOT-VALUE (%DYNAMIC-SLOTS METHOD)
      SYM-WALK-STELLA-FORWARD-DECLARATION?
     ...
     (CL:AND (CL:NOT (%METHOD-FUNCTION? METHOD))
      ...
      (CL:NOT
       (CL:EQ (HOME-MODULE METHOD)
        (HOME-MODULE (%SURROGATE-VALUE (OWNER METHOD))))))
     (CL:COND
      ((CL:EQ *TRANSLATOROUTPUTLANGUAGE* KWD-WALK-COMMON-LISP)
       (CL:LET* ((*PRINTREADABLY?* TRUE))
        (CL:DECLARE (CL:SPECIAL *PRINTREADABLY?*)) (SIGNAL-TRANSLATION-WARNING)
      ...
      (CL:T
       (CL:LET* ((*PRINTREADABLY?* TRUE))
        ...
        (CL:WHEN (CL:NOT (SUPPRESS-WARNINGS?))
         (PRINT-ERROR-CONTEXT ">> ERROR: " STANDARD-ERROR)
         (%%PRINT-STREAM (%NATIVE-STREAM STANDARD-ERROR) EOL " Defining method `"
          (DE-UGLIFY-PARSE-TREE METHOD) "' outside the home module of" EOL
          "   its owner class is illegal in `" (TRANSLATOR-OUTPUT-LANGUAGE-NAME)
          "'." EOL)))
       (CLEAR-TRANSLATION-UNIT UNIT) (CL:RETURN-FROM WALK-METHOD-UNIT))))
    (CL:COND
     ...
     ((CL:OR
       (%WRAPPER-VALUE
        (DYNAMIC-SLOT-VALUE (%DYNAMIC-SLOTS METHOD)
         SYM-WALK-STELLA-SLOT-AUXILIARY? FALSE-WRAPPER))
       (%AUXILIARY? UNIT))
      (CL:SETQ CREATEMETHODOBJECT? FALSE) (PUSH *TRANSLATIONUNITS* UNIT)
      (WALK-METHOD-OBJECT UNIT))
    ...
    (CL:WHEN CREATEMETHODOBJECT?
     ...
     (CL:WHEN
      ...
      (CL:SETQ STORECODEPOINTER? FALSE))
     (WALK-AUXILIARY-TREE
...
by actual definitions."
  (CL:LET* ((UNDEFINEDMETHODS NIL))
   (CL:LET*
    ((METHOD NULL) (ITER-000 (ALL-METHODS MODULE LOCAL?)) (COLLECT-000 NULL))
     ...
     (CL:WHEN
      ...
      (CL:IF (CL:EQ COLLECT-000 NULL)
       ...
       (CL:PROGN (CL:SETF (%%REST COLLECT-000) (CONS METHOD NIL))
        (CL:SETQ COLLECT-000 (%%REST COLLECT-000)))))))
   (CL:LET*
    ((FUNCTION NULL) (ITER-001 (ALL-FUNCTIONS MODULE LOCAL?)) (COLLECT-001 NULL))
    ...
    (CL:LET* ((METHOD NULL) (ITER-002 UNDEFINEDMETHODS))
     (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-002 NIL)) DO
      (CL:PROGN (CL:SETQ METHOD (%%VALUE ITER-002))
       (CL:SETQ ITER-002 (%%REST ITER-002)))
      (%%PRINT-STREAM (%NATIVE-STREAM STANDARD-OUTPUT) "    " METHOD EOL)))))
  :VOID)
...
(CL:DEFUN WALK-SYS-CALL-TREE (TREE)
  (CL:LET*
   ((SLOT (SLOT-FROM-EXPRESSION-TREE TREE)) (SLOTTYPE SGT-WALK-STELLA-UNKNOWN))
   (CL:WHEN (CL:NOT (CL:EQ SLOT NULL))
    (CL:SETQ SLOTTYPE
     (DYNAMIC-SLOT-VALUE (%DYNAMIC-SLOTS SLOT)
      SYM-WALK-STELLA-SLOT-TYPE-SPECIFIER NULL))
    (CL:LET* ((TEST-VALUE-000 FALSE))
     ...
     (CL:WHEN TEST-VALUE-000
      (CL:IF (ANCHORED-TYPE-SPECIFIER? SLOTTYPE) (CL:SETQ TEST-VALUE-000 TRUE)
       (CL:LET* ((FOUND?-000 FALSE))
        (CL:LET*
         ((TS NULL)
          (ITER-000 (%THE-CONS-LIST (%SPECIFIER-PARAMETER-TYPES SLOTTYPE))))
     ...
     (CL:WHEN TEST-VALUE-000
      (CL:LET* ((STREAM-000 (NEW-OUTPUT-STRING-STREAM)))
       (%%PRINT-STREAM (%NATIVE-STREAM STREAM-000)
        "walk-sys-call-tree: OOPS, can't handle anchored slot types: `" TREE "'")
       (CL:ERROR (NEW-STELLA-EXCEPTION (THE-STRING-READER STREAM-000))))))
...
(CL:DEFUN WALK-DEFCLASS-TREE (TREE)
  (CL:LET* ((SELF-000 (NEW-TRANSLATION-UNIT)))
   (CL:SETF (%CATEGORY SELF-000) SYM-WALK-STELLA-CLASS)
   (CL:SETF (%THE-OBJECT SELF-000) (%%VALUE (%%REST TREE)))
   (CL:SETF (%TU-HOME-MODULE SELF-000) *MODULE*)
   (CL:SETQ *CURRENTTRANSLATIONUNIT* SELF-000))
  (CL:SETF (%THE-OBJECT *CURRENTTRANSLATIONUNIT*)
   (DEFINE-CLASS-FROM-PARSE-TREE TREE))
  (CL:WHEN (CL:EQ (%THE-OBJECT *CURRENTTRANSLATIONUNIT*) NULL)
     ...
     (CL:LOOP WHILE (NEXT? ITER-000) DO (CL:SETQ SLOT (%VALUE ITER-000))
      (CL:COND
       ((SUBTYPE-OF-STORAGE-SLOT? (SAFE-PRIMARY-TYPE SLOT))
        (CL:PROGN
         (CL:WHEN
          (CL:AND (%SLOT-HARDWIRED? SLOT)
           (CL:NOT (CL:EQ (INITIAL-VALUE SLOT) NULL)))
          (CL:SETQ HARDWIREDSLOTINITIALIZERS
           (CONS
            (LIST* SYM-WALK-STELLA-SETQ (YIELD-HARDWIRED-SLOT-VARIABLE SLOT)
...
(CL:DEFUN YIELD-INITIAL-VALUE-EXPRESSION (SLOT)
  (CL:WHEN
   (CL:OR (%ABSTRACT? SLOT) (DYNAMIC-STORAGE? SLOT) (%SLOT-HARDWIRED? SLOT)
       ...
       (CL:T
        ...
        (CL:WHEN
         (CL:OR (CL:EQ REASON NULL) (DELETED? REASON)
          ...
          (CL:EQ (%SLOT-OWNER REASON) NULL)
          (CL:= (%SYMBOL-ID (%SLOT-OWNER REASON)) -1)
          (CL:EQ (%SURROGATE-VALUE (%SLOT-OWNER REASON)) NULL)
          (DELETED? (%SURROGATE-VALUE (%SLOT-OWNER REASON)))
          (COERCE-WRAPPED-BOOLEAN-TO-BOOLEAN
           (BAD? (%SURROGATE-VALUE (%SLOT-OWNER REASON))))
          (CL:NOT
           (CL:EQ
            (LOOKUP-SLOT (%SURROGATE-VALUE (%SLOT-OWNER REASON))
             (%SLOT-NAME REASON))
            REASON)))
         (SET-DYNAMIC-SLOT-VALUE (%DYNAMIC-SLOTS METHOD)
...
(CL:DEFUN REGISTER-AUXILIARY-METHOD (METHOD REASON)
  (CL:WHEN (CL:NOT (CL:EQ METHOD NULL))
   (CL:LET*
    ((CLASS (%SURROGATE-VALUE (%SLOT-OWNER METHOD))) (AUXILIARYMETHODS NULL))
    (CL:WHEN (CL:NOT (CL:EQ CLASS NULL))
     ...
     (CL:LET* ((VALUE-000 NULL))
      (CL:LET* ((AUX NULL) (ITER-000 (%THE-CONS-LIST AUXILIARYMETHODS)))
       (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-000 NIL)) DO
        (CL:PROGN (CL:SETQ AUX (%%VALUE ITER-000))
         (CL:SETQ ITER-000 (%%REST ITER-000)))
        (CL:WHEN
         (CL:AND (CL:EQ (%SLOT-NAME METHOD) (%SLOT-NAME AUX))
          (CL:EQ (%SLOT-OWNER METHOD) (%SLOT-OWNER AUX)))
  ...
  (CL:LET* ((METHODTREE NULL) (METHOD NULL))
   (CL:WHEN (SYSTEM-DEFINED-SLOT-READER? SLOT)
    ...
    (CL:IF SIGNATURESONLY?
     ...
     (CL:SETQ METHOD (%THE-OBJECT (HELP-WALK-AUXILIARY-TREE METHODTREE TRUE))))
   ...
   (CL:WHEN (CL:AND MIXINACCESSORS? (CL:NOT (%ABSTRACT? SLOT)))
    ...
    (CL:IF SIGNATURESONLY?
     ...
     (CL:SETQ METHOD (%THE-OBJECT (HELP-WALK-AUXILIARY-TREE METHODTREE TRUE))))
    (REGISTER-AUXILIARY-METHOD METHOD SLOT)
    (CL:WHEN (CL:NOT (%SLOT-HARDWIRED? SLOT))
...
(CL:DEFUN CREATE-ACCESSOR-UNITS-FOR-MIXIN-SLOT (SLOT CLASS)
  (CL:WHEN
   (CL:AND (NATIVE-SLOT? SLOT) (CL:EQ (NATIVE-SLOT-HOME SLOT CLASS) CLASS))
   (CL:COND
    ...
    (CL:T
     (CREATE-ACCESSOR-UNITS-FOR-SLOT SLOT
      (%SURROGATE-VALUE SGT-WALK-STELLA-OBJECT) TRUE FALSE))))
  (CL:WHEN (%SLOT-HARDWIRED? SLOT)
   ...
   (CREATE-ACCESSOR-UNITS-FOR-SLOT SLOT (%SURROGATE-VALUE SGT-WALK-STELLA-OBJECT)
    FALSE FALSE))
  :VOID)
     ...
     ((SUBTYPE-OF-STORAGE-SLOT? (SAFE-PRIMARY-TYPE SLOT))
      (CL:PROGN
       (CL:IF
        ...
        (CREATE-ACCESSOR-UNITS-FOR-SLOT SLOT CLASS FALSE
         (%SLOT-EXTERNAL? SLOT)))))
     (CL:T))))
  (CL:LET* ((TEST-VALUE-000 FALSE))
   ...
   (CL:WHEN TEST-VALUE-000
    (CL:LET* ((FOUND?-000 FALSE))
     (CL:LET*
      ((SUPER NULL) (ITER-001 (%THE-CONS-LIST (%CLASS-DIRECT-SUPERS CLASS))))
      (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-001 NIL)) DO
       (CL:PROGN (CL:SETQ SUPER (%%VALUE ITER-001))
        (CL:SETQ ITER-001 (%%REST ITER-001)))
       (CL:WHEN (%MIXIN? (%SURROGATE-VALUE SUPER)) (CL:SETQ FOUND?-000 TRUE)
        (CL:RETURN))))
     (CL:SETQ TEST-VALUE-000 FOUND?-000)))
   (CL:WHEN TEST-VALUE-000
    (CL:LET* ((SLOT NULL) (ITER-002 (CLASS-SLOTS CLASS)))
     (CL:LOOP WHILE (NEXT? ITER-002) DO (CL:SETQ SLOT (%VALUE ITER-002))
      (CL:WHEN
       (CL:AND (MIXIN-SLOT? SLOT) (CL:EQ (NATIVE-SLOT-HOME SLOT CLASS) CLASS))
     ...
     (CL:LET* ((NAME NULL) (PARAMETERS NULL) (BODY NULL))
      (CL:MULTIPLE-VALUE-SETQ (NAME PARAMETERS BODY)
       (DESTRUCTURE-DEFMETHOD-TREE
        (UNSTRINGIFY-STELLA-SOURCE (%METHOD-STRINGIFIED-SOURCE SLOT)
         (HOME-MODULE SLOT))
        NULL))
      (CL:PROGN (CL:SETQ NAME NAME) (CL:SETQ PARAMETERS PARAMETERS))
      (CL:LET* ((SELF-000 (NEW-TRANSLATION-UNIT)))
       (CL:SETF (%THE-OBJECT SELF-000) SLOT)
       (CL:SETF (%CATEGORY SELF-000) SYM-WALK-STELLA-METHOD)
       (CL:SETF (%CODE-REGISTER SELF-000) BODY)
       (CL:SETF (%AUXILIARY? SELF-000) TRUE)
       (CL:SETF (%TU-HOME-MODULE SELF-000) *MODULE*)
  ...
  (CL:LET*
   ...
   (CL:COND
    ((CL:EQ (SAFE-PRIMARY-TYPE SELFTYPETREE) SGT-WALK-STELLA-CONS)
     (CL:PROGN
      (FIRST-SETTER SELFTYPETREE (YIELD-TYPE-SPEC-TREE (%CLASS-TYPE CLASS)))))
   ...
   (CL:WHEN (CL:EQ CLASS (%SURROGATE-VALUE SGT-WALK-STELLA-OBJECT))
    (CL:SETQ BODY
     (CONCATENATE (EXTRACT-OPTIONS TREE NULL) (CONS SYM-WALK-STELLA-NULL NIL))))
    ...
    (LIST* SYM-WALK-STELLA-DEFMETHOD (%%VALUE (%%REST TREE))
     (CONS PARAMETERS
      (LIST* KWD-WALK-AUXILIARY? SYM-WALK-STELLA-TRUE KWD-WALK-PUBLIC?
       (CL:IF (%SLOT-PUBLIC? METHOD) SYM-WALK-STELLA-TRUE SYM-WALK-STELLA-FALSE)
       (CONCATENATE BODY NIL)))))))
        ...
        (%THE-OBJECT
         (HELP-WALK-AUXILIARY-TREE
          (YIELD-MIXIN-METHOD-TREE SLOT
           (%SURROGATE-VALUE SGT-WALK-STELLA-OBJECT))
          TRUE))
        SLOT)))))
   (CL:T
    (CL:LET* ((MIXINMETHODS (NEW-LIST)))
     (CL:LET*
      ((SUPER NULL) (ITER-001 (%THE-CONS-LIST (%CLASS-DIRECT-SUPERS CLASS))))
      (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-001 NIL)) DO
       (CL:PROGN (CL:SETQ SUPER (%%VALUE ITER-001))
     ...
     (CL:LET* ((METHOD NULL) (ITER-003 (%THE-CONS-LIST (REVERSE MIXINMETHODS))))
      (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-003 NIL)) DO
       (CL:PROGN (CL:SETQ METHOD (%%VALUE ITER-003))
        (CL:SETQ ITER-003 (%%REST ITER-003)))
       (REGISTER-AUXILIARY-METHOD
        (%THE-OBJECT
         (HELP-WALK-AUXILIARY-TREE (YIELD-MIXIN-METHOD-TREE METHOD CLASS) TRUE))
        METHOD))))))
  :VOID)
...
(CL:DEFUN CREATE-DEFPRINT-UNIT (CLASS)
  (CL:WHEN
   (CL:NOT
    (CL:EQ
     (DYNAMIC-SLOT-VALUE (%DYNAMIC-SLOTS CLASS) SYM-WALK-STELLA-PRINT-FORM NULL)
     NULL))
   (WALK-AUXILIARY-TREE
    (LIST* SYM-WALK-STELLA-DEFMETHOD SYM-WALK-STELLA-PRINT-OBJECT
     (LIST* (LIST* SYM-WALK-STELLA-SELF (%CLASS-TYPE CLASS) NIL)
      (LIST* SYM-WALK-STELLA-STREAM SYM-WALK-STELLA-NATIVE-OUTPUT-STREAM NIL)
      NIL)
     KWD-WALK-PUBLIC? SYM-WALK-STELLA-TRUE
     (COPY-CONS-TREE
      (DYNAMIC-SLOT-VALUE (%DYNAMIC-SLOTS CLASS) SYM-WALK-STELLA-PRINT-FORM
       NULL))
     NIL))
   (CL:LET* ((TEST-VALUE-000 FALSE))
    (CL:SETQ TEST-VALUE-000 (CL:EQ *TRANSLATOROUTPUTLANGUAGE* KWD-WALK-CPP))
    (CL:WHEN TEST-VALUE-000
     (CL:LET* ((FOUND?-000 FALSE))
      (CL:LET* ((SUPER NULL) (ITER-000 (%CLASS-ALL-SUPER-CLASSES CLASS)))
       (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-000 NIL)) DO
        ...
        (CL:WHEN
         (CL:NOT
          (CL:EQ
           (DYNAMIC-SLOT-VALUE (%DYNAMIC-SLOTS SUPER) SYM-WALK-STELLA-PRINT-FORM
            NULL)
           NULL))
         (CL:SETQ FOUND?-000 TRUE) (CL:RETURN))))
      (CL:SETQ TEST-VALUE-000 FOUND?-000))
    ...
    (CL:WHEN TEST-VALUE-000
     ...
     (CL:LET* ((SELF-000 (NEW-TRANSLATION-UNIT)))
      ...
      (CL:SETF (%CATEGORY SELF-000) SYM-WALK-STELLA-PRINT-METHOD)
      (CL:SETF (%TU-HOME-MODULE SELF-000) *MODULE*)
      (CL:SETF (%CODE-REGISTER SELF-000)
       (WALK-A-TREE
        (LIST* SYM-WALK-STELLA-IF
         (LIST* SYM-WALK-STELLA-NULL? SYM-WALK-STELLA-SELF NIL)
         (LIST* SYM-WALK-STELLA-PRINT-NATIVE-STREAM SYM-WALK-STELLA-STREAM
          (WRAP-STRING "!NULL!") NIL)
         (LIST* SYM-WALK-STELLA-PRINT-OBJECT SYM-WALK-STELLA-SELF
          SYM-WALK-STELLA-STREAM NIL)
         NIL)))
      (CL:SETF (%AUXILIARY? SELF-000) TRUE) (PUSH *TRANSLATIONUNITS* SELF-000))
     (POP-VARIABLE-BINDING) (POP-VARIABLE-BINDING)))
   (CL:LET* ((TEST-VALUE-001 FALSE))
    (CL:SETQ TEST-VALUE-001 (CL:EQ *TRANSLATOROUTPUTLANGUAGE* KWD-WALK-JAVA))
    (CL:WHEN TEST-VALUE-001
     (CL:LET* ((FOUND?-001 FALSE))
    ...
    (CL:WHEN TEST-VALUE-001
     (CL:LET* ((*METHODBEINGWALKED* (NEW-METHOD-SLOT)))
      ...
      (CL:SETF (%METHOD-RETURN-TYPE-SPECIFIERS *METHODBEINGWALKED*)
       (LIST SGT-WALK-STELLA-STRING))
      (PUSH-VARIABLE-BINDING SYM-WALK-STELLA-SELF (%CLASS-TYPE CLASS))
      (CL:LET* ((SELF-002 (NEW-TRANSLATION-UNIT)))
       (CL:SETF (%THE-OBJECT SELF-002) CLASS)
       (CL:SETF (%CATEGORY SELF-002) SYM-WALK-STELLA-PRINT-METHOD)
        ...
        (WALK-A-TREE
         (LIST* SYM-WALK-STELLA-IF
          ...
          (LIST* SYM-WALK-STELLA-RETURN
           ...
           NIL)
          NIL)))
       (CL:SETF (%AUXILIARY? SELF-002) TRUE) (PUSH *TRANSLATIONUNITS* SELF-002))
      (POP-VARIABLE-BINDING)))))
  :VOID)
...
(CL:DEFUN WALK-CLASS-UNIT (UNIT)
  (CL:LET* ((CLASS (%THE-OBJECT UNIT)) (STARTUPTIMECODE NULL))
   ...
   (CL:WHEN (CREATE-NATIVE-CLASS? CLASS) (WARN-ABOUT-MULTIPLE-PARENTS CLASS)
    (WARN-ABOUT-NON-DIRECT-SUPERS CLASS) (CLEANUP-AUXILIARY-METHODS CLASS)
    (CL:WHEN
     (CL:NOT
      (CL:AND (%MIXIN? CLASS) (TRANSLATE-TO-SINGLE-INHERITANCE-LANGUAGE?)))
       ...
       (CL:COND
        ...
        (CL:T
         (CL:LET* ((*PRINTREADABLY?* TRUE))
          ...
          (CL:WHEN (CL:NOT (SUPPRESS-WARNINGS?))
           (PRINT-ERROR-CONTEXT ">> ERROR: " STANDARD-ERROR)
           (%%PRINT-STREAM (%NATIVE-STREAM STANDARD-ERROR) EOL " Defining slot `"
            (DE-UGLIFY-PARSE-TREE SLOT) "' outside the home module of" EOL
   ...
   (CL:SETQ STARTUPTIMECODE
    (CONCATENATE (YIELD-INITIALIZE-HARDWIRED-SLOTS CLASS)
     (CONCATENATE (YIELD-CONSTRUCTOR-ATTACHMENT CLASS SYM-WALK-STELLA-CLASS)
      (CONCATENATE
       (YIELD-GENERIC-SLOT-ACCESSOR-ATTACHMENT CLASS SYM-WALK-STELLA-CLASS)
       NIL))))
   (WALK-AUXILIARY-TREE
    (CL:IF (CL:EQ STARTUPTIMECODE NIL)
     ...
     (LIST* SYM-WALK-STELLA-STARTUP-TIME-PROGN KWD-WALK-CLASSES
      (LIST* SYM-WALK-STELLA-LET
       (CONS (LIST* SYM-WALK-STELLA-CLASS (YIELD-DEFINE-STELLA-CLASS CLASS) NIL)
        NIL)
       (CONCATENATE STARTUPTIMECODE NIL))
      NIL)))
   (CL:LET* ((SYNONYM NULL) (ITER-001 (%THE-CONS-LIST (CLASS-SYNONYMS CLASS))))
    (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-001 NIL)) DO
     (CL:PROGN (CL:SETQ SYNONYM (%%VALUE ITER-001))
      (CL:SETQ ITER-001 (%%REST ITER-001)))
     (REGISTER-SYMBOL
      (INTERN-SYMBOL-IN-MODULE (%SYMBOL-NAME SYNONYM) (%HOME-CONTEXT SYNONYM)
       TRUE)))))
  :VOID)
...
(CL:DEFUN WALK-DEFSLOT-TREE (TREE)
  (CL:LET* ((SELF-000 (NEW-TRANSLATION-UNIT)))
   (CL:SETF (%CATEGORY SELF-000) SYM-WALK-STELLA-SLOT)
   (CL:SETF (%THE-OBJECT SELF-000) TREE)
   (CL:SETF (%TU-HOME-MODULE SELF-000) *MODULE*)
   (CL:SETQ *CURRENTTRANSLATIONUNIT* SELF-000))
  (CL:LET* ((SLOT NULL))
   (CL:SETQ SLOT (DEFINE-EXTERNAL-SLOT-FROM-PARSE-TREE TREE))
   (CL:WHEN (CL:EQ SLOT NULL) (CLEAR-TRANSLATION-UNIT *CURRENTTRANSLATIONUNIT*)
    (CL:SETQ *CURRENTTRANSLATIONUNIT* NULL) (CL:RETURN-FROM WALK-DEFSLOT-TREE))
   (CL:SETF (%THE-OBJECT *CURRENTTRANSLATIONUNIT*) SLOT)
...
(CL:DEFUN WALK-SLOT-UNIT (UNIT)
  (CL:LET*
   ...
   (WALK-AUXILIARY-TREE
    (LIST* SYM-WALK-STELLA-STARTUP-TIME-PROGN KWD-WALK-METHODS
     (LIST* SYM-WALK-STELLA-DEFINE-EXTERNAL-SLOT-FROM-STRINGIFIED-SOURCE
...
holding its expander function."
  (CL:LET* ((FUNCTION (LOOKUP-FUNCTION NAME)))
   (CL:WHEN
    (CL:AND (CL:NOT (CL:EQ FUNCTION NULL))
     (%WRAPPER-VALUE
      (DYNAMIC-SLOT-VALUE (%DYNAMIC-SLOTS FUNCTION) SYM-WALK-STELLA-METHOD-MACRO?
       FALSE-WRAPPER)))
...
(CL:DEFUN WALK-DEFMACRO-TREE (TREE)
  (CL:LET* ((NAME (%%VALUE (%%REST TREE))))
   (CL:LET* ((SELF-000 (NEW-PROPERTY-LIST)))
    (CL:SETF (%THE-PLIST SELF-000) (EXTRACT-OPTIONS TREE NULL))
    (CL:LET* ((OPTIONS SELF-000) (METHOD NULL))
     (CL:WHEN (CONS? NAME)
      (CL:LET* ((*PRINTREADABLY?* TRUE))
       ...
       (CL:WHEN (CL:NOT (SUPPRESS-WARNINGS?))
        (PRINT-ERROR-CONTEXT ">> ERROR: " STANDARD-ERROR)
        (%%PRINT-STREAM (%NATIVE-STREAM STANDARD-ERROR) EOL " Macro `"
         (%%VALUE NAME) "' contains return type specification." EOL)))
     ...
     (CL:WHEN (CL:NOT (SYMBOL? NAME))
      (CL:LET* ((*PRINTREADABLY?* TRUE))
       ...
       (CL:WHEN (CL:NOT (SUPPRESS-WARNINGS?))
        (PRINT-ERROR-CONTEXT ">> ERROR: " STANDARD-ERROR)
        (%%PRINT-STREAM (%NATIVE-STREAM STANDARD-ERROR) EOL
         " Illegal macro name: `" (DE-UGLIFY-PARSE-TREE NAME) "'." EOL)))
      (CL:RETURN-FROM WALK-DEFMACRO-TREE))
     ...
     (WALK-DEFMETHOD-TREE TREE)
     (CL:WHEN (CL:NOT (CL:EQ *CURRENTTRANSLATIONUNIT* NULL))
      (CL:SETQ METHOD (%THE-OBJECT *CURRENTTRANSLATIONUNIT*))
      (CL:WHEN (CL:> (METHOD-ARGUMENT-COUNT METHOD) 5)
       (CL:LET* ((*PRINTREADABLY?* TRUE))
        ...
        (CL:WHEN (CL:NOT (SUPPRESS-WARNINGS?))
         (PRINT-ERROR-CONTEXT ">> ERROR: " STANDARD-ERROR)
         (%%PRINT-STREAM (%NATIVE-STREAM STANDARD-ERROR) EOL
          " Too many arguments in macro definition, maximum is 5." EOL)))
       (CL:SETQ *CURRENTTRANSLATIONUNIT* NULL))))))
  :VOID)
...
(CL:DEFUN WALK-DEFGLOBAL-TREE (TREE)
  (CL:LET* ((SELF-000 (NEW-TRANSLATION-UNIT)))
   (CL:SETF (%CATEGORY SELF-000) SYM-WALK-STELLA-GLOBAL-VARIABLE)
   (CL:SETF (%THE-OBJECT SELF-000) TREE)
   (CL:SETF (%TU-HOME-MODULE SELF-000) *MODULE*)
   (CL:SETQ *CURRENTTRANSLATIONUNIT* SELF-000))
...
(CL:DEFUN WALK-GLOBAL-UNIT (UNIT)
  (CL:LET*
   ...
   (CL:WHEN (CL:NOT (CL:EQ INITIALVALUETREE KWD-WALK-UNBOUND-SPECIAL-VARIABLE))
    (CL:COND
     ((CL:AND (%VARIABLE-SPECIAL? GLOBAL) (TRANSLATE-TO-JAVA?))
      (CL:SETF (%VARIABLE-CONSTANT? GLOBAL) FALSE)
      (WALK-AUXILIARY-TREE
       (LIST* SYM-WALK-STELLA-STARTUP-TIME-PROGN KWD-WALK-GLOBALS
        (LIST* SYM-WALK-STELLA-SYS-SET-DEFAULT (%VARIABLE-NAME GLOBAL)
     ...
     ((CL:OR (WRAPPER? INITIALVALUETREE)
      ...
      (CL:SETQ INITIALVALUETREE
       (WALK-EXPRESSION-TREE INITIALVALUETREE (%VARIABLE-TYPE GLOBAL)
        (%VARIABLE-NAME GLOBAL) TRUE)))
     (CL:T (CL:SETF (%VARIABLE-CONSTANT? GLOBAL) FALSE)
      (WALK-AUXILIARY-TREE
       (LIST* SYM-WALK-STELLA-STARTUP-TIME-PROGN KWD-WALK-GLOBALS
        (LIST* SYM-WALK-STELLA-SETQ (%VARIABLE-NAME GLOBAL)
         (CONS INITIALVALUETREE NIL))
        NIL))
      (CL:SETQ INITIALVALUETREE
   ...
   (CL:WHEN (CL:NOT (%AUXILIARY? UNIT))
    (WALK-AUXILIARY-TREE
     (LIST* SYM-WALK-STELLA-STARTUP-TIME-PROGN
      (LIST*
       SYM-WALK-STELLA-DEFINE-STELLA-GLOBAL-VARIABLE-FROM-STRINGIFIED-SOURCE
       (WRAP-STRING STRINGIFIEDSOURCE) NIL)
      NIL))))
  :VOID)
...
(CL:DEFUN WALK-DEFTYPE-TREE (TREE)
  (CL:LET* ((SELF-000 (NEW-TRANSLATION-UNIT)))
   (CL:SETF (%CATEGORY SELF-000) SYM-WALK-STELLA-TYPE)
   (CL:SETF (%THE-OBJECT SELF-000) TREE)
   (CL:SETF (%TU-HOME-MODULE SELF-000) *MODULE*)
   (CL:SETQ *CURRENTTRANSLATIONUNIT* SELF-000))
  (CL:WHEN (CL:< (LENGTH TREE) 3) (BAD-ARGUMENT-COUNT? TREE 3)
  ...
  (CL:LET* ((TYPE NULL)) (CL:SETQ TYPE (DEFINE-STELLA-TYPE-FROM-PARSE-TREE TREE))
   (CL:SETF (%THE-OBJECT *CURRENTTRANSLATIONUNIT*) TYPE)
   (CL:SETF (%CODE-REGISTER *CURRENTTRANSLATIONUNIT*) TREE))
  :VOID)
  ...
  (CL:LET* ((STRINGIFIEDDEFINITION (STRINGIFY (%CODE-REGISTER UNIT))))
   ...
   (WALK-AUXILIARY-TREE
    (LIST* SYM-WALK-STELLA-STARTUP-TIME-PROGN KWD-WALK-CLASSES
     ...
     NIL))
   (REGISTER-SYMBOL
    (INTERN-SYMBOL-IN-MODULE (%SYMBOL-NAME (%THE-OBJECT UNIT))
     (%HOME-CONTEXT (%THE-OBJECT UNIT)) TRUE)))
  :VOID)
...
(CL:DEFUN WALK-STARTUP-TIME-PROGN-TREE (TREE)
  (CL:LET* ((SELF-000 (NEW-TRANSLATION-UNIT)))
   (CL:SETF (%CATEGORY SELF-000) SYM-WALK-STELLA-STARTUP-TIME-PROGN)
   (CL:SETF (%TU-HOME-MODULE SELF-000) *MODULE*)
   (CL:SETF (%CODE-REGISTER SELF-000) TREE)
   (CL:SETQ *CURRENTTRANSLATIONUNIT* SELF-000))
  :VOID)
...
(CL:DEFUN WALK-STARTUP-TIME-PROGN-UNIT (UNIT)
  (CL:LET*
   ((TREE (%CODE-REGISTER UNIT)) (PHASE (EXTRACT-STARTUP-TIME-PHASE TREE)))
   (PUSH *TRANSLATIONUNITS* UNIT)
   (CL:SETF (%THE-OBJECT UNIT) (WALK-LIST-OF-STATEMENTS (%%REST TREE)))
   (CL:SETF (%CODE-REGISTER UNIT) PHASE))
  :VOID)
...
(CL:DEFUN EARLIER-STARTUP-UNIT? (UNIT1 UNIT2)
  (CL:RETURN-FROM EARLIER-STARTUP-UNIT?
   (< (ENCODE-STARTUP-TIME-PHASE (%CODE-REGISTER UNIT1))
...
(CL:DEFUN COMBINE-STARTUP-FUNCTION-UNITS (STARTUPFNNAME)
  (CL:LET*
   ...
   (CL:LET* ((IT (ALLOCATE-ITERATOR *TRANSLATIONUNITS*)))
    (CL:LOOP WHILE (NEXT? IT) DO
     (CL:WHEN (CL:EQ (%CATEGORY (%VALUE IT)) SYM-WALK-STELLA-STARTUP-TIME-PROGN)
      (PUSH STARTUPUNITS (%VALUE IT)) (VALUE-SETTER IT NULL))))
   ...
   (CL:LET* ((PHASE NULL) (ITER-000 (%THE-CONS-LIST *STARTUP-TIME-PHASES*)))
    (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-000 NIL)) DO
     (CL:PROGN (CL:SETQ PHASE (%%VALUE ITER-000))
      (CL:SETQ ITER-000 (%%REST ITER-000)))
     (CL:LOOP WHILE
      (CL:AND (NON-EMPTY? STARTUPUNITS)
       (CL:EQ (%CODE-REGISTER (FIRST STARTUPUNITS)) PHASE))
      DO
      (CL:SETQ STARTUPPHASETREES
       (CONCATENATE STARTUPPHASETREES (%THE-OBJECT (FIRST STARTUPUNITS))))
...
(CL:DEFUN EXTRACT-STARTUP-FUNCTION-UNITS (STARTUPUNITS STARTUPFNNAME)
  (CL:LET*
   ((REMAININGUNITS (LENGTH STARTUPUNITS))
    ...
    (CURSOR (%THE-CONS-LIST STARTUPUNITS)) (PHASESTART CURSOR) (PHASEUNITS 0)
    (PHASE (%CODE-REGISTER (%%VALUE CURSOR))) (UNITPHASE PHASE)
    (HELPFNCOUNTER 0))
   (CL:DECLARE
   ...
   (CL:LOOP WHILE (CL:NOT (CL:EQ CURSOR NIL)) DO
    (CL:TAGBODY (CL:SETQ UNITPHASE (%CODE-REGISTER (%%VALUE CURSOR)))
     ...
     (CL:WHEN (CL:< PHASEUNITS MINUNITSPERFUNCTION) (CL:SETQ PHASESTART CURSOR)
      (CL:SETQ PHASEUNITS 0) (CL:SETQ PHASE UNITPHASE) (CL:GO :CONTINUE))
     (CL:LET*
      ((FUNCTIONNAME
        (INTERN-DERIVED-SYMBOL STARTUPFNNAME
         (CONCATENATE "HELP-"
          (CONCATENATE (%SYMBOL-NAME STARTUPFNNAME)
           (INTEGER-TO-STRING (CL:SETQ HELPFNCOUNTER (CL:1+ HELPFNCOUNTER)))))))
      ...
      (CL:LET*
       ((I NULL-INTEGER) (IT (ALLOCATE-ITERATOR PHASESTART)) (ITER-000 2)
        (UPPER-BOUND-000 PHASEUNITS) (UNBOUNDED?-000 (NULL? UPPER-BOUND-000)))
       (CL:DECLARE (CL:TYPE CL:FIXNUM ITER-000 UPPER-BOUND-000 I))
       (CL:LOOP WHILE
        (CL:AND (NEXT? IT)
        ...
        (CL:SETQ I I)
        (CL:SETQ HELPFNTREE (CONCATENATE HELPFNTREE (%THE-OBJECT (%VALUE IT))))
        (CLEAR-TRANSLATION-UNIT (%VALUE IT)) (VALUE-SETTER IT NULL)))
      (CL:SETQ HELPFNTREE
       (LIST* SYM-WALK-STELLA-DEFUN FUNCTIONNAME
        (LIST* NIL KWD-WALK-PUBLIC? SYM-WALK-STELLA-FALSE
         (LIST* SYM-WALK-STELLA-VOID-SYS
          (CONS SYM-WALK-STELLA-PROGN (CONCATENATE HELPFNTREE NIL)) NIL)
         NIL)))
      (SET-DYNAMIC-SLOT-VALUE
       (%DYNAMIC-SLOTS (%THE-OBJECT (HELP-WALK-AUXILIARY-TREE HELPFNTREE TRUE)))
      ...
      (CL:WHEN (CL:EQ UNITPHASE PHASE) (CL:SETQ CURSOR (%%REST CURSOR)))
...
(CL:DEFUN YIELD-STARTUP-FUNCTION-NAME (FILE)
  ...
  (CL:IF (SYSTEM-STARTUP-FILE? FILE)
   ...
   (CL:RETURN-FROM YIELD-STARTUP-FUNCTION-NAME
    (INTERN-SYMBOL-IN-MODULE
     (CONCATENATE "STARTUP-" (STRING-UPCASE (FILE-BASE-NAME FILE))) *MODULE*
     TRUE))))
...
(CL:DEFUN YIELD-STARTUP-FUNCTION-CLASSNAME (FUNCTION-NAME)
  (CL:IF (SYSTEM-STARTUP-FILE? *CURRENTFILE*)
   (CL:RETURN-FROM YIELD-STARTUP-FUNCTION-CLASSNAME
    (STRING-CAPITALIZE (%SYMBOL-NAME FUNCTION-NAME)))
   (CL:RETURN-FROM YIELD-STARTUP-FUNCTION-CLASSNAME
    (CONCATENATE "_" (STRING-CAPITALIZE (%SYMBOL-NAME FUNCTION-NAME))))))
(CL:DECLAIM
    ...
    ((CL:NOT (CL:EQ STARTUPFNNAME NULL))
     (CL:SETQ TREE
      (LIST* SYM-WALK-STELLA-DEFUN STARTUPFNNAME
       (LIST* NIL KWD-WALK-PUBLIC? SYM-WALK-STELLA-TRUE SYM-WALK-STELLA-NULL
        NIL)))
     (CL:SETQ METHOD (DEFINE-METHOD-FROM-PARSE-TREE TREE))
     (SET-DYNAMIC-SLOT-VALUE (%DYNAMIC-SLOTS METHOD)
      SYM-WALK-STELLA-FORWARD-DECLARATION?
     ...
     (CL:SETQ TREE
      (LIST* SYM-WALK-STELLA-DEFUN STARTUPFNNAME
       (LIST* NIL KWD-WALK-PUBLIC? SYM-WALK-STELLA-TRUE KWD-WALK-AUXILIARY?
        SYM-WALK-STELLA-TRUE
        (CONCATENATE (COMBINE-STARTUP-FUNCTION-UNITS STARTUPFNNAME) NIL))))
     (SET-DYNAMIC-SLOT-VALUE
      (%DYNAMIC-SLOTS (%THE-OBJECT (HELP-WALK-AUXILIARY-TREE TREE TRUE)))
      SYM-WALK-STELLA-METHOD-STARTUP-CLASSNAME
      (WRAP-STRING (YIELD-STARTUP-FUNCTION-CLASSNAME STARTUPFNNAME))
      NULL-STRING-WRAPPER))
    (CL:T
     ...
     (WALK-AUXILIARY-TREE TREE)
     (CL:SETQ TREE
      (CONS SYM-WALK-STELLA-PROGN (%THE-OBJECT (FIRST *TRANSLATIONUNITS*))))
    ...
    (CL:LOOP WHILE (NEXT? IT) DO
     (CL:WHEN (CL:EQ (%CATEGORY (%VALUE IT)) SYM-WALK-STELLA-STARTUP-TIME-PROGN)
      (CL:LET* ((UNIT (%VALUE IT)))
       (CL:IF (CL:EQ PLACEHOLDERUNIT NULL) (CL:SETQ PLACEHOLDERUNIT UNIT)
        (CLEAR-TRANSLATION-UNIT UNIT))
...
(CL:DEFUN WALK-SIGNAL-EXCEPTION-TREE (TREE)
  (CL:LET* ((EXPRESSION NULL) (ITS-TYPE NULL))
   (CL:MULTIPLE-VALUE-SETQ (EXPRESSION ITS-TYPE)
    (WALK-EXPRESSION-TREE (%%VALUE (%%REST TREE))
     SGT-WALK-STELLA-STELLA-ROOT-EXCEPTION SYM-WALK-STELLA-SIGNAL-EXCEPTION
     FALSE))
   (CL:RETURN-FROM WALK-SIGNAL-EXCEPTION-TREE
    (CL:VALUES (LIST* SYM-WALK-STELLA-SYS-SIGNAL EXPRESSION (CONS ITS-TYPE NIL))
     SGT-WALK-STELLA-VOID))))
...
(CL:DEFUN WALK-EXCEPTION-CASE-TREE (TREE)
  (CL:WHEN (CL:<= (LENGTH TREE) 2)
   (CL:LET* ((*PRINTREADABLY?* TRUE)) (CL:DECLARE (CL:SPECIAL *PRINTREADABLY?*))
    ...
    (CL:WHEN (CL:NOT (SUPPRESS-WARNINGS?))
     (PRINT-ERROR-CONTEXT ">> ERROR: " STANDARD-ERROR)
     (%%PRINT-STREAM (%NATIVE-STREAM STANDARD-ERROR) EOL
      " Missing handler(s) in 'exception-case': `" (DE-UGLIFY-PARSE-TREE TREE)
      "'." EOL)))
  ...
  (CL:LET*
   ...
   (CL:RETURN-FROM WALK-EXCEPTION-CASE-TREE
    (CL:VALUES
     (LIST* SYM-WALK-STELLA-SYS-HANDLER-CASE (WALK-A-TREE PROTECTEDTREE)
      (CONCATENATE HANDLERTREES NIL))
     SGT-WALK-STELLA-VOID))))
        ...
        (CL:WHEN (CL:< (LENGTH CLAUSE) 2)
         (CL:LET* ((*PRINTREADABLY?* TRUE))
          ...
          (CL:WHEN (CL:NOT (SUPPRESS-WARNINGS?))
           (PRINT-ERROR-CONTEXT ">> ERROR: " STANDARD-ERROR)
           (%%PRINT-STREAM (%NATIVE-STREAM STANDARD-ERROR) EOL
            " Illegal exception handler clause: `" (DE-UGLIFY-PARSE-TREE CLAUSE)
            "'." EOL)))
        ...
        (CL:WHEN (CL:NOT (SYMBOL? EXCEPTIONTYPE))
         (CL:LET* ((*PRINTREADABLY?* TRUE))
          ...
          (CL:WHEN (CL:NOT (SUPPRESS-WARNINGS?))
           (PRINT-ERROR-CONTEXT ">> ERROR: " STANDARD-ERROR)
           (%%PRINT-STREAM (%NATIVE-STREAM STANDARD-ERROR) EOL
            " Illegal exception type: `" (DE-UGLIFY-PARSE-TREE EXCEPTIONTYPE)
            "'." EOL)))
         (CL:RETURN-FROM WALK-EXCEPTION-HANDLER-TREES NULL))
        ...
        (CL:WHEN (CL:EQ (TYPE-TO-CLASS EXCEPTIONTYPE) NULL)
         (CL:LET* ((*PRINTREADABLY?* TRUE))
          ...
          (CL:WHEN (CL:NOT (SUPPRESS-WARNINGS?))
           (PRINT-ERROR-CONTEXT ">> ERROR: " STANDARD-ERROR)
           (%%PRINT-STREAM (%NATIVE-STREAM STANDARD-ERROR) EOL
            " Undefined exception type: `" (DE-UGLIFY-PARSE-TREE EXCEPTIONTYPE)
            "'." EOL)))
         (CL:RETURN-FROM WALK-EXCEPTION-HANDLER-TREES NULL))
        (CL:WHEN
         (CL:NOT (SUBTYPE-OF? EXCEPTIONTYPE SGT-WALK-STELLA-NATIVE-EXCEPTION))
         (CL:LET* ((*PRINTREADABLY?* TRUE))
          (CL:DECLARE (CL:SPECIAL *PRINTREADABLY?*)) (SIGNAL-TRANSLATION-ERROR)
          (CL:WHEN (CL:NOT (SUPPRESS-WARNINGS?))
           (PRINT-ERROR-CONTEXT ">> ERROR: " STANDARD-ERROR)
      ...
      (CL:T
       (CL:LET* ((*PRINTREADABLY?* TRUE))
        ...
        (CL:WHEN (CL:NOT (SUPPRESS-WARNINGS?))
         (PRINT-ERROR-CONTEXT ">> ERROR: " STANDARD-ERROR)
         (%%PRINT-STREAM (%NATIVE-STREAM STANDARD-ERROR) EOL
          " Illegal exception handler clause: `" (DE-UGLIFY-PARSE-TREE TREE) "'."
          EOL)))
       (CL:RETURN-FROM WALK-EXCEPTION-HANDLER-TREES NULL)))))
...
(CL:DEFUN WALK-VERBATIM-DEFINITION-TREE (TREE)
  (CL:LET* ((SELF-000 (NEW-TRANSLATION-UNIT)))
   (CL:SETF (%CATEGORY SELF-000) SYM-WALK-STELLA-VERBATIM)
   (CL:SETF (%CODE-REGISTER SELF-000) TREE)
   (CL:SETQ *CURRENTTRANSLATIONUNIT* SELF-000))
  :VOID)
...
(CL:DEFUN WALK-VERBATIM-UNIT (UNIT)
  ...
  (CL:COND
   ((CL:NOT (CL:EQ (%THE-OBJECT UNIT) NULL)) (PUSH *TRANSLATIONUNITS* UNIT)
    (CL:SETF (%CODE-REGISTER UNIT) NULL))
...
(CL:DEFUN WALK-VERBATIM-TREE (TREE)
  (CL:LET* ((SELF-000 (NEW-PROPERTY-LIST)))
   (CL:SETF (%THE-PLIST SELF-000) (%%REST TREE))
   (CL:LET*
    ((OPTIONS SELF-000)
     ...
     (CL:WHEN (CL:EQ VERBATIMTREE NULL)
      (CL:LET* ((*PRINTREADABLY?* TRUE))
       ...
       (CL:WHEN (CL:NOT (SUPPRESS-WARNINGS?))
        (PRINT-ERROR-CONTEXT ">> ERROR: " STANDARD-ERROR)
        (%%PRINT-STREAM (%NATIVE-STREAM STANDARD-ERROR) EOL
         " Verbatim statement has no `" *TRANSLATOROUTPUTLANGUAGE* "' option.."
         EOL)))
     ...
     ((SUBTYPE-OF-STRING? (SAFE-PRIMARY-TYPE VERBATIMTREE))
      (CL:PROGN
       (INSERT-AT OPTIONS *TRANSLATOROUTPUTLANGUAGE*
        (NEW-VERBATIM-STRING-WRAPPER (%WRAPPER-VALUE VERBATIMTREE)))))
     (CL:T))
...
(CL:DEFUN VERBATIM-TREE? (TREE)
  (CL:RETURN-FROM VERBATIM-TREE?
   (CL:AND (CONS? TREE) (CL:EQ (%%VALUE TREE) SYM-WALK-STELLA-VERBATIM))))

;;; (DEFUN WALK-DEFMODULE-TREE ...)

(CL:DEFUN WALK-DEFMODULE-TREE (TREE)
  (CL:LET* ((SELF-000 (NEW-TRANSLATION-UNIT)))
   (CL:SETF (%CATEGORY SELF-000) SYM-WALK-STELLA-MODULE)
   (CL:SETF (%THE-OBJECT SELF-000) TREE)
   (CL:SETQ *CURRENTTRANSLATIONUNIT* SELF-000))
  (CL:LET*
   ((MODULE NULL)
    (MODULENAME (COERCE-TO-MODULE-NAME (%%VALUE (%%REST TREE)) FALSE)))
   ...
   (CL:WHEN (CL:EQ MODULENAME STELLA::NULL-STRING)
    ...
    (CLEAR-TRANSLATION-UNIT *CURRENTTRANSLATIONUNIT*)
    (CL:SETQ *CURRENTTRANSLATIONUNIT* NULL) (CL:RETURN-FROM WALK-DEFMODULE-TREE))
...
(CL:DEFUN EXTRACT-REQUIRED-ARGUMENT-VALUES (CLASSTYPE SLOTSANDVALUES)
  (CL:LET*
   ((ARRAYTYPE? (ARRAY-TYPE-SPECIFIER? CLASSTYPE)) (REQUIREDVALUES (NEW-LIST))
    (FOUND? FALSE))
   ...
   (CL:LET*
    ...
    (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-000 NIL)) DO
     (CL:PROGN (CL:SETQ REQUIREDSLOTNAME (%%VALUE ITER-000))
      (CL:SETQ ITER-000 (%%REST ITER-000)))
     (CL:SETQ FOUND? FALSE)
     (CL:LET*
      ((VALUEREF NULL) (SLOT NULL) (ITER-001 (%THE-PLIST SLOTSANDVALUES)))
      (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-001 NIL)) DO
       (CL:SETQ SLOT (%%VALUE ITER-001))
       (CL:PROGN (CL:SETQ VALUEREF (%%VALUE (%%REST ITER-001)))
        (CL:SETQ ITER-001 (%%REST (%%REST ITER-001))))
       (CL:WHEN (CL:EQ (%SLOT-NAME SLOT) REQUIREDSLOTNAME) (CL:SETQ FOUND? TRUE)
        (CL:IF ARRAYTYPE?
         (EVALUATE-ARRAY-ARGUMENT-VALUE CLASSTYPE REQUIREDVALUES SLOT VALUEREF)
         (INSERT-LAST REQUIREDVALUES
          (WALK-EXPRESSION-TREE VALUEREF
           (COMPUTE-RETURN-TYPE-SPEC SLOT CLASSTYPE) SYM-WALK-STELLA-NEW FALSE)))
...
(CL:DEFUN PREPROCESS-ARRAY-ARGUMENTS (ARRAYTYPE SLOTSANDVALUES)
  (CL:LET*
   ((ARRAYCLASS (%SURROGATE-VALUE (%SPECIFIER-BASE-TYPE ARRAYTYPE)))
    ...
    (SIZEREF (LOOKUP SLOTSANDVALUES ARRAYSIZESLOT)) (NONLISTSIZE? FALSE))
    ...
    ((CL:EQ SIZEREF NULL)
     (CL:LET* ((*PRINTREADABLY?* TRUE))
      ...
      (CL:WHEN (CL:NOT (SUPPRESS-WARNINGS?))
       (PRINT-ERROR-CONTEXT ">> ERROR: " STANDARD-ERROR)
       (%%PRINT-STREAM (%NATIVE-STREAM STANDARD-ERROR) EOL
        " Missing array :size argument in NEW expression." EOL))))
    (CL:T
     (CL:COND
      ((CL:EQ (SAFE-PRIMARY-TYPE SIZEREF) SGT-WALK-STELLA-CONS)
       (CL:PROGN
        (CL:WHEN
         ...
         (CL:SETQ NONLISTSIZE? TRUE))))
      (CL:T (CL:SETQ NONLISTSIZE? TRUE)))
      ...
      ((CL:NOT (CL:= (LENGTH SIZEREF) ARRAYRANK))
       (CL:LET* ((*PRINTREADABLY?* TRUE))
        ...
        (CL:WHEN (CL:NOT (SUPPRESS-WARNINGS?))
         (PRINT-ERROR-CONTEXT ">> ERROR: " STANDARD-ERROR)
         (%%PRINT-STREAM (%NATIVE-STREAM STANDARD-ERROR) EOL
          " Array :size initializer `" (DE-UGLIFY-PARSE-TREE SIZEREF) "'" EOL
          "   doesn't match the rank of" EOL "   `"
          (DE-UGLIFY-PARSE-TREE ARRAYTYPE) "'." EOL)))
       (CL:SETQ SIZEREF NULL))
      (CL:T
       (CL:LET*
        ((DIM NULL-INTEGER) (SIZEIT (ALLOCATE-ITERATOR SIZEREF))
         (DIMIT (ALLOCATE-ITERATOR ARRAYDIMENSIONS)) (ITER-000 0))
        (CL:DECLARE (CL:TYPE CL:FIXNUM ITER-000 DIM))
        (CL:LOOP WHILE (CL:AND (NEXT? SIZEIT) (NEXT? DIMIT)) DO
         (CL:PROGN (CL:SETQ DIM ITER-000) (CL:SETQ ITER-000 (CL:1+ ITER-000)))
         (CL:COND
          ((CL:EQ (%VALUE DIMIT) NULL)
           (CL:WHEN (INTEGER? (%VALUE SIZEIT))
            (VALUE-SETTER DIMIT (%VALUE SIZEIT))))
...
(CL:DEFUN EVALUATE-ARRAY-ARGUMENT-VALUE (ARRAYTYPE REQUIREDVALUES SLOT VALUEREF)
  (CL:COND
     ...
     (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-000 NIL)) DO
      ...
      (CL:IF (CL:EQ COLLECT-000 NULL)
       (CL:PROGN
        (CL:SETQ COLLECT-000
         (CONS
          (WALK-EXPRESSION-TREE DIM SGT-WALK-STELLA-INTEGER SYM-WALK-STELLA-NEW
           FALSE)
          NIL))
        (CL:IF (CL:EQ (%THE-CONS-LIST REQUIREDVALUES) NIL)
         (CL:SETF (%THE-CONS-LIST REQUIREDVALUES) COLLECT-000)
         (ADD-CONS-TO-END-OF-CONS-LIST (%THE-CONS-LIST REQUIREDVALUES)
          COLLECT-000)))
       (CL:PROGN
        (CL:SETF (%%REST COLLECT-000)
         (CONS
   ...
   (CL:T
    (INSERT-LAST REQUIREDVALUES
     (WALK-EXPRESSION-TREE VALUEREF (COMPUTE-RETURN-TYPE-SPEC SLOT ARRAYTYPE)
      SYM-WALK-STELLA-NEW FALSE))))
  :VOID)
...
(CL:DEFUN YIELD-NEW-ARGUMENTS-TREE (KEYWORDSANDVALUES CLASSTYPE SELFVARIABLE)
  ...
  (CL:LET* ((CLASS (TYPE-SPEC-TO-CLASS CLASSTYPE)))
   (CL:LET* ((SELF-000 (NEW-PROPERTY-LIST)))
    (CL:SETF (%THE-PLIST SELF-000) KEYWORDSANDVALUES)
    (CL:LET*
     ((PLIST SELF-000) (OTHERASSIGNMENTS NIL) (REQUIREDVALUES NULL)
      (SLOTNAME NULL) (SLOT NULL))
     (CL:LET* ((IT (ALLOCATE-ITERATOR PLIST)))
      (CL:LOOP WHILE (NEXT? IT) DO
       (CL:WHEN (CL:NOT (KEYWORD? (%KEY IT)))
        (CL:LET* ((*PRINTREADABLY?* TRUE))
         (CL:DECLARE (CL:SPECIAL *PRINTREADABLY?*)) (SIGNAL-TRANSLATION-ERROR)
         (CL:WHEN (CL:NOT (SUPPRESS-WARNINGS?))
          (PRINT-ERROR-CONTEXT ">> ERROR: " STANDARD-ERROR)
          (%%PRINT-STREAM (%NATIVE-STREAM STANDARD-ERROR) EOL
           " Illegal slot keyword `" (%KEY IT) "' in NEW expression." EOL)))
        (CL:RETURN-FROM YIELD-NEW-ARGUMENTS-TREE (CL:VALUES NIL NIL)))
       (CL:SETQ SLOTNAME
        (INTERN-SYMBOL-IN-MODULE (%SYMBOL-NAME (%KEY IT)) (HOME-MODULE CLASS)
         FALSE))
       ...
       (CL:WHEN (CL:EQ SLOT NULL)
        (CL:LET* ((*PRINTREADABLY?* TRUE))
         ...
         (CL:WHEN (CL:NOT (SUPPRESS-WARNINGS?))
          (PRINT-ERROR-CONTEXT ">> ERROR: " STANDARD-ERROR)
          (%%PRINT-STREAM (%NATIVE-STREAM STANDARD-ERROR) EOL " No such slot `"
           (DE-UGLIFY-PARSE-TREE SLOTNAME) "' on the class `" (CLASS-NAME CLASS)
           "'." EOL)))
        (CL:RETURN-FROM YIELD-NEW-ARGUMENTS-TREE (CL:VALUES NIL NIL)))
       (KEY-SETTER IT SLOT)))
     (CL:SETQ REQUIREDVALUES (EXTRACT-REQUIRED-ARGUMENT-VALUES CLASSTYPE PLIST))
     (CL:LET*
      ((VALUEREF NULL) (SLOT NULL) (ITER-000 (%THE-PLIST PLIST))
       (COLLECT-000 NULL))
      (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-000 NIL)) DO
       (CL:SETQ SLOT (%%VALUE ITER-000))
       (CL:PROGN (CL:SETQ VALUEREF (%%VALUE (%%REST ITER-000)))
       ...
       (CL:IF (CL:EQ COLLECT-000 NULL)
        (CL:PROGN
         (CL:SETQ COLLECT-000
          (CONS
           (LIST* SYM-WALK-STELLA-SETF
            (CONS (%SLOT-NAME SLOT) (CONS SELFVARIABLE NIL)) VALUEREF NIL)
           NIL))
...
(CL:DEFUN WALK-NEW-TREE (TREE)
  (CL:LET*
   ((OPERATOR (%%VALUE TREE)) (CLASSTREE (%%VALUE (%%REST TREE)))
    (BASECLASSNAME (CL:IF (CONS? CLASSTREE) (%%VALUE CLASSTREE) CLASSTREE))
    (KEYWORDARGUMENTS (%%REST (%%REST TREE)))
    (SELFVARIABLE (LOCAL-GENSYM "SELF")) (CLASSTYPE NULL) (NEWTREE NULL))
   (CL:WHEN
    (CL:AND (CL:NOT (SYMBOL? BASECLASSNAME)) (CL:NOT (KEYWORD? BASECLASSNAME)))
    (CL:LET* ((*PRINTREADABLY?* TRUE)) (CL:DECLARE (CL:SPECIAL *PRINTREADABLY?*))
     (SIGNAL-TRANSLATION-ERROR)
     (CL:WHEN (CL:NOT (SUPPRESS-WARNINGS?))
      (PRINT-ERROR-CONTEXT ">> ERROR: " STANDARD-ERROR)
      (%%PRINT-STREAM (%NATIVE-STREAM STANDARD-ERROR) EOL
       ...
       "' where symbol expected:  `" (DE-UGLIFY-PARSE-TREE BASECLASSNAME) "'."
       EOL)))
   ...
   (CL:LET* ((REQUIREDARGS NULL) (OTHERASSIGNMENTS NULL))
    ...
    (CL:SETQ NEWTREE
     (LIST* SYM-WALK-STELLA-SYS-NEW CLASSTYPE (CONCATENATE REQUIREDARGS NIL)))
    (CL:IF (CL:EQ OTHERASSIGNMENTS NIL)
...
(CL:DEFUN WALK-MAKE-TREE (TREE)
  (CL:LET*
   ((CLASSNAME (%%VALUE (%%REST TREE))) (ARGUMENTS (%%REST (%%REST TREE)))
    (TYPE NULL) (CLASS NULL))
   (CL:COND ((SYMBOL? CLASSNAME))
    ((TYPE? CLASSNAME)
     (SECOND-SETTER TREE
      (INTERN-SYMBOL-IN-MODULE (%SYMBOL-NAME CLASSNAME) (%HOME-CONTEXT CLASSNAME)
       TRUE)))
    (CL:T
     (CL:LET* ((*PRINTREADABLY?* TRUE))
      (CL:DECLARE (CL:SPECIAL *PRINTREADABLY?*)) (SIGNAL-TRANSLATION-ERROR)
      (CL:WHEN (CL:NOT (SUPPRESS-WARNINGS?))
       (PRINT-ERROR-CONTEXT ">> ERROR: " STANDARD-ERROR)
       (%%PRINT-STREAM (%NATIVE-STREAM STANDARD-ERROR) EOL
        " Bad argument to 'make':" EOL "   `" (DE-UGLIFY-PARSE-TREE CLASSNAME)
   ...
   (CL:WHEN (CL:EQ CLASS NULL)
    (CL:LET* ((*PRINTREADABLY?* TRUE)) (CL:DECLARE (CL:SPECIAL *PRINTREADABLY?*))
     ...
     (CL:WHEN (CL:NOT (SUPPRESS-WARNINGS?))
      (PRINT-ERROR-CONTEXT ">> ERROR: " STANDARD-ERROR)
      (%%PRINT-STREAM (%NATIVE-STREAM STANDARD-ERROR) EOL
       " Reference to undefined class `" (DE-UGLIFY-PARSE-TREE CLASSNAME) "'."
       EOL)))
    (CL:RETURN-FROM WALK-MAKE-TREE
     (WALK-DONT-CALL-ME-TREE TREE SGT-WALK-STELLA-UNKNOWN)))
   (CL:WHEN
    (CL:AND (CL:NOT (CL:EQ ARGUMENTS NIL)) (CL:NOT (EXCEPTION-CLASS? CLASS)))
    (CL:COND
     ((CL:EQ *TRANSLATOROUTPUTLANGUAGE* KWD-WALK-CPP)
      (CL:WHEN
       (CL:EQ
       ...
       (CL:LET* ((*PRINTREADABLY?* TRUE))
        ...
        (CL:WHEN (CL:NOT (SUPPRESS-WARNINGS?))
         (PRINT-ERROR-CONTEXT ">> ERROR: " STANDARD-ERROR)
         (%%PRINT-STREAM (%NATIVE-STREAM STANDARD-ERROR) EOL
          " MAKE arguments not supported for non-native class `"
     ...
     (CL:T
      (CL:LET* ((*PRINTREADABLY?* TRUE))
       ...
       (CL:WHEN (CL:NOT (SUPPRESS-WARNINGS?))
        (PRINT-ERROR-CONTEXT ">> WARNING: " STANDARD-WARNING)
        (%%PRINT-STREAM (%NATIVE-STREAM STANDARD-WARNING) EOL
         " MAKE arguments not supported for `" (TRANSLATOR-OUTPUT-LANGUAGE-NAME)
         "'; skipping them." EOL)))
...
(CL:DEFUN WALK-FUNCALL-TREE (TREE)
  ...
  (CL:LET*
   ((RETURNTYPE
     (CL:IF (CL:EQ *TARGETTYPE* SGT-WALK-STELLA-UNKNOWN) SGT-WALK-STELLA-VOID
      *TARGETTYPE*))
    (SIGNATURE (CONS (CONS RETURNTYPE NIL) NIL)))
   (CL:LET* ((OTREE NULL) (OTYPE NULL))
    (CL:MULTIPLE-VALUE-SETQ (OTREE OTYPE)
     (WALK-EXPRESSION-TREE (%%VALUE (%%REST TREE)) SGT-WALK-STELLA-CODE
      SYM-WALK-STELLA-FUNCALL TRUE))
    (FIRST-SETTER TREE
   ...
   (CL:LET* ((IT (ALLOCATE-ITERATOR (%%REST (%%REST TREE)))))
    (CL:LOOP WHILE (NEXT? IT) DO
     (CL:LET* ((ARGTREE NULL) (ARGTYPE NULL))
      (CL:MULTIPLE-VALUE-SETQ (ARGTREE ARGTYPE) (WALK-A-TREE (%VALUE IT)))
       ...
       ((CL:OR (CL:EQ *TRANSLATOROUTPUTLANGUAGE* KWD-WALK-CPP)
        ...
        (CL:LET* ((*PRINTREADABLY?* TRUE))
         ...
         (CL:WHEN (CL:NOT (SUPPRESS-WARNINGS?))
          (PRINT-ERROR-CONTEXT ">> ERROR: " STANDARD-ERROR)
          (%%PRINT-STREAM (%NATIVE-STREAM STANDARD-ERROR) EOL
           " Cannot generate a function pointer to `main' in C++." EOL)))
        (CL:RETURN-FROM WALK-THE-CODE-TREE
         (WALK-DONT-CALL-ME-TREE TREE SGT-WALK-STELLA-FUNCTION-CODE)))
       (CL:T
        (CL:LET* ((*PRINTREADABLY?* TRUE))
      ...
      (CL:IF (CL:EQ (%SURROGATE-VALUE TYPE) NULL)
       (CL:LET* ((*PRINTREADABLY?* TRUE))
        ...
        (CL:WHEN (CL:NOT (SUPPRESS-WARNINGS?))
         (PRINT-ERROR-CONTEXT ">> ERROR: " STANDARD-ERROR)
         (%%PRINT-STREAM (%NATIVE-STREAM STANDARD-ERROR) EOL
          " No class defined for the type: `" (DE-UGLIFY-PARSE-TREE TYPE) "'."
          EOL)))
       (CL:COND
        ((CL:OR (CL:EQ *TRANSLATOROUTPUTLANGUAGE* KWD-WALK-CPP)
          (CL:EQ *TRANSLATOROUTPUTLANGUAGE* KWD-WALK-CPP-STANDALONE))
          ...
          (CL:LET* ((*PRINTREADABLY?* TRUE))
           ...
           (CL:WHEN (CL:NOT (SUPPRESS-WARNINGS?))
            ...
            (%%PRINT-STREAM (%NATIVE-STREAM STANDARD-WARNING) EOL
             ...
             (TRANSLATOR-OUTPUT-LANGUAGE-NAME) "', hence, cannot generate" EOL
             " a method-code pointer for `" (%%VALUE (%%REST (%%REST TREE)))
             "'.`" (FOURTH TREE) "'." EOL)))
          (CL:LET* ((VALUE-000 NULL) (VALUE-001 NULL))
           (CL:MULTIPLE-VALUE-SETQ (VALUE-000 VALUE-001)
            (WALK-A-TREE
   ...
   (CL:LET* ((ARG NULL) (ITER-000 UGLYARGUMENTS) (COLLECT-000 NULL))
    (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-000 NIL)) DO
     ...
     (CL:IF (CL:EQ COLLECT-000 NULL)
      ...
      (CL:PROGN
       (CL:SETF (%%REST COLLECT-000) (CONS (DE-UGLIFY-PARSE-TREE ARG) NIL))
       (CL:SETQ COLLECT-000 (%%REST COLLECT-000))))))
      ...
      (CL:LET* ((OPERATOR (%%VALUE TREE)))
       ...
       (CL:LET* ((TEST-VALUE-000 OPERATOR))
        (CL:COND
         ...
         ((CL:EQ TEST-VALUE-000 SYM-WALK-STELLA-GET-SYM)
          (CL:RETURN-FROM DE-UGLIFY-PARSE-TREE
           (GET-SYM-FROM-OFFSET (%WRAPPER-VALUE (%%VALUE (%%REST TREE))))))
         (CL:T
          (CL:LET* ((PRETTYARGUMENTS NIL))
...
(CL:DEFUN NATIVE-NAME? (NAME LANGUAGE CATEGORY)
  (CL:LET* ((TABLEENTRY (LOOKUP *NATIVE-NAME-TABLE* NAME)) (CATEGORIES NULL))
   ...
   (CL:SETQ CATEGORIES (LOOKUP TABLEENTRY LANGUAGE))
   (CL:IF (CL:EQ CATEGORIES NULL) (CL:RETURN-FROM NATIVE-NAME? FALSE)
   ...
   (CL:LET* ((NEWNAME NULL))
    (CL:COND
     ((CL:EQ LANGUAGE KWD-WALK-COMMON-LISP)
      (CL:SETQ NEWNAME
       (INTERN-DERIVED-SYMBOL NAME (CONCATENATE "%" (%SYMBOL-NAME NAME)))))
     ((CL:EQ LANGUAGE KWD-WALK-CPP)
      (CL:RETURN-FROM YIELD-RENAMED-NAME-IF-NATIVE NAME))
     (CL:T
      (CL:SETQ NEWNAME
       (INTERN-DERIVED-SYMBOL NAME (CONCATENATE (%SYMBOL-NAME NAME) "_")))))
...
(CL:DEFUN YIELD-LISP-MACRO-TREES (NAME METHOD)
  (CL:LET*
   ((MODULE
     (CL:IF (CL:NOT (CL:EQ (%HOME-CONTEXT NAME) NULL)) (%HOME-CONTEXT NAME)
      *MODULE*))
    (TRANSLATEDNAME (YIELD-GLOBAL-LISP-SYMBOL MODULE (%SYMBOL-NAME NAME)))
    (TRANSLATEDFULLNAME
     (YIELD-GLOBAL-LISP-SYMBOL MODULE
      (COMPUTE-FULL-NAME (%SYMBOL-NAME NAME) MODULE)))
    (DOCUMENTATION
     (%WRAPPER-VALUE
      (DYNAMIC-SLOT-VALUE (%DYNAMIC-SLOTS METHOD) SYM-WALK-STELLA-DOCUMENTATION
       NULL-STRING-WRAPPER))))
    ...
    (CL:VALUES
     (LIST* SYM-WALK-STELLA-VERBATIM KWD-WALK-COMMON-LISP
      (LIST* (INTERN-COMMON-LISP-SYMBOL "DEFMACRO") TRANSLATEDNAME
       (CONS
        (LIST* (INTERN-COMMON-LISP-SYMBOL "&WHOLE") SYM-WALK-STELLA-EXPRESSION
         (INTERN-COMMON-LISP-SYMBOL "&REST") SYM-WALK-STELLA-IGNORE NIL)
        (CONCATENATE
         ...
         (LIST*
          (LIST* (INTERN-COMMON-LISP-SYMBOL "DECLARE")
           (LIST* (INTERN-COMMON-LISP-SYMBOL "IGNORE") SYM-WALK-STELLA-IGNORE
            NIL)
           NIL)
...
(CL:DEFUN COMMAND? (METHOD)
  ...
  (CL:RETURN-FROM COMMAND?
   (CL:AND
    (%WRAPPER-VALUE
     (DYNAMIC-SLOT-VALUE (%DYNAMIC-SLOTS METHOD) SYM-WALK-STELLA-METHOD-COMMAND?
      FALSE-WRAPPER))
...
(CL:DEFUN METHOD-MUST-BE-EVALUABLE? (METHOD)
  (CL:RETURN-FROM METHOD-MUST-BE-EVALUABLE?
   (CL:AND (COMMAND? METHOD)
    (CL:NOT
     (%WRAPPER-VALUE
      (DYNAMIC-SLOT-VALUE (%DYNAMIC-SLOTS METHOD) SYM-WALK-STELLA-METHOD-NATIVE?
       FALSE-WRAPPER))))))
...
(CL:DEFUN METHOD-NEEDS-EVALUATOR-WRAPPER? (METHOD)
  (CL:LET* ((TEST-VALUE-000 FALSE))
   (CL:SETQ TEST-VALUE-000 (METHOD-MUST-BE-EVALUABLE? METHOD))
   (CL:WHEN TEST-VALUE-000
    (CL:IF
     (%WRAPPER-VALUE
      (DYNAMIC-SLOT-VALUE (%DYNAMIC-SLOTS METHOD)
       SYM-WALK-STELLA-METHOD-VARIABLE-ARGUMENTS? FALSE-WRAPPER))
     (CL:SETQ TEST-VALUE-000 TRUE)
     (CL:IF (CL:> (LENGTH (METHOD-PARAMETER-NAMES METHOD)) 5)
      (CL:SETQ TEST-VALUE-000 TRUE)
      (CL:IF (CL:> (LENGTH (METHOD-RETURN-TYPE-SPECIFIERS METHOD)) 1)
       ...
       (CL:IF (SUBTYPE-OF? (TYPE METHOD) SGT-WALK-STELLA-LITERAL)
        ...
        (CL:LET* ((FOUND?-000 FALSE))
         (CL:LET*
          ((TSPEC NULL)
           (ITER-000 (%THE-CONS-LIST (METHOD-PARAMETER-TYPE-SPECIFIERS METHOD))))
          (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-000 NIL)) DO
           (CL:PROGN (CL:SETQ TSPEC (%%VALUE ITER-000))
            (CL:SETQ ITER-000 (%%REST ITER-000)))
           (CL:WHEN
            (SUBTYPE-OF? (TYPE-SPEC-TO-BASE-TYPE TSPEC) SGT-WALK-STELLA-LITERAL)
            (CL:SETQ FOUND?-000 TRUE) (CL:RETURN))))
         (CL:SETQ TEST-VALUE-000 FOUND?-000)))))))
   (CL:LET* ((VALUE-000 TEST-VALUE-000))
    (CL:RETURN-FROM METHOD-NEEDS-EVALUATOR-WRAPPER? VALUE-000))))
...
(CL:DEFUN YIELD-EVALUATOR-WRAPPER-NAME (METHODNAME)
  (CL:RETURN-FROM YIELD-EVALUATOR-WRAPPER-NAME
   (INTERN-DERIVED-SYMBOL METHODNAME
    (CONCATENATE (%SYMBOL-NAME METHODNAME) "-EVALUATOR-WRAPPER"))))
...
(CL:DEFUN YIELD-EVALUATOR-WRAPPER-TREE (METHOD)
  (CL:LET*
   ((NAMETREE (YIELD-EVALUATOR-WRAPPER-NAME (%SLOT-NAME METHOD)))
    (CALLTREE (CONS (%SLOT-NAME METHOD) NIL))
    (PARAMETERTYPESPECS (METHOD-PARAMETER-TYPE-SPECIFIERS METHOD))
    (RESULTTYPE (TYPE METHOD)) (NOFPARAMETERS (LENGTH PARAMETERTYPESPECS))
    (VARIABLEARGUMENTS?
     (%WRAPPER-VALUE
      (DYNAMIC-SLOT-VALUE (%DYNAMIC-SLOTS METHOD)
       SYM-WALK-STELLA-METHOD-VARIABLE-ARGUMENTS? FALSE-WRAPPER))))
   ...
   (CL:LET*
    ...
    (CL:DECLARE (CL:TYPE CL:FIXNUM ITER-000 UPPER-BOUND-000 INDEX))
    (CL:LOOP WHILE (CL:OR UNBOUNDED?-000 (CL:<= ITER-000 UPPER-BOUND-000)) DO
     (CL:PROGN (CL:SETQ INDEX ITER-000) (CL:SETQ ITER-000 (CL:1+ ITER-000)))
     (CL:IF (CL:EQ COLLECT-000 NULL)
      (CL:PROGN
       (CL:SETQ COLLECT-000
        (CONS
         (YIELD-ARGUMENT-ACCESS-TREE SYM-WALK-STELLA-ARGUMENTS INDEX
          (CL:AND VARIABLEARGUMENTS? (CL:= INDEX NOFPARAMETERS)))
         NIL))
      ...
      (CL:PROGN
       ...
       (CL:SETQ COLLECT-000 (%%REST COLLECT-000))))))
   (CL:LET*
    ((PTYPE NULL) (ITER-001 (%THE-CONS-LIST PARAMETERTYPESPECS))
    ...
    (CL:LOOP WHILE (CL:AND (CL:NOT (CL:EQ ITER-001 NIL)) (NEXT? IT)) DO
     ...
     (CL:COND
      ((SUB-TYPE-SPEC-OF? PTYPE SGT-WALK-STELLA-LITERAL)
       (VALUE-SETTER IT
        (LIST* SYM-WALK-STELLA-WRAPPER-VALUE
         (LIST* SYM-WALK-STELLA-SAFE-CAST (%VALUE IT)
      ...
      ((SUB-TYPE-SPEC-OF? PTYPE SGT-WALK-STELLA-ARGUMENT-LIST)
       ...
       (VALUE-SETTER IT (SYS-TREE (WALK-WITHOUT-TYPE-TREE (%VALUE IT)) PTYPE))
       (POP-VARIABLE-BINDING))
      ...
      (CL:SETQ CALLTREE
       (LIST* SYM-WALK-STELLA-LET
        ...
        (LIST* SYM-WALK-STELLA-IF
         ...
         (LIST* SYM-WALK-STELLA-RETURN
          (LIST* SYM-WALK-STELLA-WRAP-LITERAL SYM-WALK-STELLA-RESULT NIL) NIL)
   ...
   (CL:RETURN-FROM YIELD-EVALUATOR-WRAPPER-TREE
    (LIST* SYM-WALK-STELLA-DEFUN NAMETREE
     (LIST* (CONS (LIST* SYM-WALK-STELLA-ARGUMENTS SYM-WALK-STELLA-CONS NIL) NIL)
      KWD-WALK-AUXILIARY? SYM-WALK-STELLA-TRUE
      (CONCATENATE
       (CL:IF (CL:= NOFPARAMETERS 0)
        (CONS (LIST* SYM-WALK-STELLA-IGNORE SYM-WALK-STELLA-ARGUMENTS NIL) NIL)
        NIL)
       (CONS CALLTREE NIL)))))))
...
(CL:DEFUN CREATE-EVALUATOR-WRAPPER-UNIT (METHOD)
  (CL:LET*
   ((VARIABLEARGUMENTS?
    ...
    (WRAPPERTREE (YIELD-EVALUATOR-WRAPPER-TREE METHOD)) (WRAPPERMETHOD NULL))
   (CL:WHEN (CL:> (LENGTH (METHOD-RETURN-TYPE-SPECIFIERS METHOD)) 1)
    (CL:LET* ((*PRINTREADABLY?* TRUE)) (CL:DECLARE (CL:SPECIAL *PRINTREADABLY?*))
     ...
     (CL:WHEN (CL:NOT (SUPPRESS-WARNINGS?))
      (PRINT-ERROR-CONTEXT ">> WARNING: " STANDARD-WARNING)
      (%%PRINT-STREAM (%NATIVE-STREAM STANDARD-WARNING) EOL
       " During interpreted command evaluation only the" EOL
       " first return value will be usable." EOL))))
   (CL:WHEN (CL:NOT EVALUATEARGUMENTS?)
    (SET-DYNAMIC-SLOT-VALUE (%DYNAMIC-SLOTS METHOD)
     SYM-WALK-STELLA-METHOD-EVALUATE-ARGUMENTS?
     (CL:IF TRUE TRUE-WRAPPER FALSE-WRAPPER) FALSE-WRAPPER))
   (CL:WHEN VARIABLEARGUMENTS?
    (SET-DYNAMIC-SLOT-VALUE (%DYNAMIC-SLOTS METHOD)
     SYM-WALK-STELLA-METHOD-VARIABLE-ARGUMENTS?
     (CL:IF FALSE TRUE-WRAPPER FALSE-WRAPPER) FALSE-WRAPPER))
...
(CL:DEFUN EVALUATE-CONS-TREE (TREE)
  (CL:LET* ((*EVALUATIONPARENTTREE* *EVALUATIONTREE*) (*EVALUATIONTREE* TREE))
   ...
   (CL:LET*
    ((OPERATORNAME (%%VALUE TREE)) (ARGUMENTS (%%REST TREE)) (OPERATOR NULL))
    (CL:COND
     ((SUBTYPE-OF-SYMBOL? (SAFE-PRIMARY-TYPE OPERATORNAME))
      (CL:PROGN
       (CL:COND
        ((CL:EQ OPERATORNAME SYM-WALK-STELLA-QUOTE)
         (CL:WHEN (CL:= (LENGTH ARGUMENTS) 1)
          (CL:RETURN-FROM EVALUATE-CONS-TREE
           (CL:VALUES (%%VALUE ARGUMENTS) (PRIMARY-TYPE (%%VALUE ARGUMENTS)))))
         (CL:LET* ((STREAM-000 (NEW-OUTPUT-STRING-STREAM)))
          (%%PRINT-STREAM (%NATIVE-STREAM STREAM-000) "While evaluating '"
           *EVALUATIONTREE*)
        ...
        (CL:T
         (CL:LET* ((TEST-VALUE-000 FALSE))
          (CL:LET* () (CL:SETQ OPERATOR (LOOKUP-COMMAND OPERATORNAME))
           (CL:SETQ TEST-VALUE-000 (CL:NOT (CL:EQ OPERATOR NULL))))
          (CL:SETQ TEST-VALUE-000 (CL:NOT TEST-VALUE-000))
          (CL:WHEN TEST-VALUE-000
           (CL:LET* ((STREAM-001 (NEW-OUTPUT-STRING-STREAM)))
            (%%PRINT-STREAM (%NATIVE-STREAM STREAM-001) "While evaluating '"
             *EVALUATIONTREE*)
            (CL:WHEN (CL:NOT (CL:EQ *EVALUATIONPARENTTREE* NULL))
             (%%PRINT-STREAM (%NATIVE-STREAM STREAM-001) EOL "' inside '"
              *EVALUATIONPARENTTREE*))
            (%%PRINT-STREAM (%NATIVE-STREAM STREAM-001) "':" EOL)
            (%%PRINT-STREAM (%NATIVE-STREAM STREAM-001) "Undefined operator: `"
             OPERATORNAME "'")
            (CL:ERROR
             (NEW-EVALUATION-EXCEPTION (THE-STRING-READER STREAM-001))))))))))
     (CL:T
      (CL:LET* ((STREAM-002 (NEW-OUTPUT-STRING-STREAM)))
       (%%PRINT-STREAM (%NATIVE-STREAM STREAM-002) "While evaluating '"
        *EVALUATIONTREE*)
       (CL:WHEN (CL:NOT (CL:EQ *EVALUATIONPARENTTREE* NULL))
        (%%PRINT-STREAM (%NATIVE-STREAM STREAM-002) EOL "' inside '"
         *EVALUATIONPARENTTREE*))
       (%%PRINT-STREAM (%NATIVE-STREAM STREAM-002) "':" EOL)
       (%%PRINT-STREAM (%NATIVE-STREAM STREAM-002) "Illegal operator: `"
        OPERATORNAME "'")
       (CL:ERROR (NEW-EVALUATION-EXCEPTION (THE-STRING-READER STREAM-002))))))
    (CL:LET*
     ((EVALUATORWRAPPERCODE
       (%WRAPPER-VALUE
        (DYNAMIC-SLOT-VALUE (%DYNAMIC-SLOTS OPERATOR)
         SYM-WALK-STELLA-EVALUATOR-WRAPPER-CODE NULL-FUNCTION-CODE-WRAPPER)))
      ...
      (NOFPARAMETERS (LENGTH PARAMETERTYPES)) (NOFARGS (LENGTH ARGUMENTS))
      (MINARGS (CL:IF VARIABLEARGS? (CL:1- NOFPARAMETERS) NOFPARAMETERS))
      (MAXARGS (CL:IF VARIABLEARGS? NULL-INTEGER NOFPARAMETERS))
      (UNEVALUATEDARGS ARGUMENTS) (EVALUATEDARG NULL) (EVALUATEDARGTYPE NULL)
      (ARGINDEX 0) (RETURNTYPE (TYPE OPERATOR)) (RESULT NULL))
     (CL:DECLARE
      (CL:TYPE CL:FIXNUM NOFPARAMETERS NOFARGS MINARGS MAXARGS ARGINDEX))
     (CL:WHEN
      (CL:OR (CL:< NOFARGS MINARGS)
       (CL:AND (DEFINED? MAXARGS) (CL:> NOFARGS MAXARGS)))
      (CL:LET* ((STREAM-003 (NEW-OUTPUT-STRING-STREAM)))
       (%%PRINT-STREAM (%NATIVE-STREAM STREAM-003) "While evaluating '"
        *EVALUATIONTREE*)
       (CL:WHEN (CL:NOT (CL:EQ *EVALUATIONPARENTTREE* NULL))
        (%%PRINT-STREAM (%NATIVE-STREAM STREAM-003) EOL "' inside '"
         *EVALUATIONPARENTTREE*))
       (%%PRINT-STREAM (%NATIVE-STREAM STREAM-003) "':" EOL)
       (%%PRINT-STREAM (%NATIVE-STREAM STREAM-003) "Wrong number of arguments")
     ...
     (CL:LOOP WHILE (CL:NOT (CL:EQ UNEVALUATEDARGS NIL)) DO
      ...
      (CL:MULTIPLE-VALUE-SETQ (EVALUATEDARG EVALUATEDARGTYPE)
       (COERCE-EVALUATED-TREE EVALUATEDARG (%%VALUE UNEVALUATEDARGS)
        EVALUATEDARGTYPE
        (CL:IF (CL:>= ARGINDEX MINARGS) (VARIABLE-ARGUMENTS-TYPE OPERATOR)
...
(CL:DEFUN COERCE-EVALUATED-TREE (TREE SOURCETREE SOURCETYPE TARGETTYPE EVALUATE?)
  (CL:LET*
   ...
   (CL:LET*
    ...
    (CL:WHEN
     (CL:AND (CL:EQ TARGETTYPE SGT-WALK-STELLA-BOOLEAN) (CL:NOT EVALUATE?))
    ...
    (CL:IF (VOID? SOURCETYPE)
     (CL:LET* ((STREAM-000 (NEW-OUTPUT-STRING-STREAM)))
      ...
      (CL:WHEN (CL:NOT (CL:EQ *EVALUATIONPARENTTREE* NULL))
        ...
        *EVALUATIONPARENTTREE*))
      (%%PRINT-STREAM (%NATIVE-STREAM STREAM-000) "':" EOL)
      (%%PRINT-STREAM (%NATIVE-STREAM STREAM-000) "`" SOURCETREE
     ...
     (CL:LET* ((STREAM-001 (NEW-OUTPUT-STRING-STREAM)))
      ...
      (CL:WHEN (CL:NOT (CL:EQ *EVALUATIONPARENTTREE* NULL))
        ...
        *EVALUATIONPARENTTREE*))
      (%%PRINT-STREAM (%NATIVE-STREAM STREAM-001) "':" EOL)
      (%%PRINT-STREAM (%NATIVE-STREAM STREAM-001) "Type conflict: `"
       (YIELD-TYPE-SPEC-TREE SOURCETYPE) "' found where `"
       (YIELD-TYPE-SPEC-TREE TARGETTYPE) "' expected")
      (CL:ERROR (NEW-EVALUATION-EXCEPTION (THE-STRING-READER STREAM-001))))))))
...
(CL:DEFUN HELP-STARTUP-WALK6 ()
  (CL:PROGN
   ...
   (CL:SETQ SYM-WALK-STELLA-SUBTYPE-OF-ANCHORED-TYPE-SPECIFIER?
    (INTERN-RIGID-SYMBOL-WRT-MODULE "SUBTYPE-OF-ANCHORED-TYPE-SPECIFIER?" NULL
     0))
   ...
   (CL:SETQ SYM-WALK-STELLA-SUBTYPE-OF-PARAMETRIC-TYPE-SPECIFIER?
    (INTERN-RIGID-SYMBOL-WRT-MODULE "SUBTYPE-OF-PARAMETRIC-TYPE-SPECIFIER?" NULL
     0))
   ...
   (CL:SETQ KWD-WALK-FIRST-CLASS-WITH-TYPECASE
    (INTERN-RIGID-SYMBOL-WRT-MODULE "FIRST-CLASS-WITH-TYPECASE" NULL 2))
...
(CL:DEFUN HELP-STARTUP-WALK7 ()
  (CL:PROGN
   ...
   (CL:SETQ SYM-WALK-STELLA-DEFINE-STELLA-GLOBAL-VARIABLE-FROM-STRINGIFIED-SOURCE
    (INTERN-RIGID-SYMBOL-WRT-MODULE
     "DEFINE-STELLA-GLOBAL-VARIABLE-FROM-STRINGIFIED-SOURCE" NULL 0))
   (CL:SETQ SYM-WALK-STELLA-DEFINE-STELLA-TYPE-FROM-STRINGIFIED-SOURCE
    (INTERN-RIGID-SYMBOL-WRT-MODULE "DEFINE-STELLA-TYPE-FROM-STRINGIFIED-SOURCE"
     NULL 0))
  ...
  (CL:PROGN
   (CL:SETQ *AVAILABLE-STELLA-FEATURES*
    (LIST KWD-WALK-WARN-ABOUT-UNDEFINED-METHODS
     ...
     KWD-WALK-MINIMIZE-JAVA-PREFIXES KWD-WALK-TRANSLATE-WITH-COPYRIGHT-HEADER))
   (CL:SETQ *CURRENT-STELLA-FEATURES* (LIST))
   (CL:SETQ *DEFAULT-STELLA-FEATURES*
    (LIST KWD-WALK-WARN-ABOUT-UNDEFINED-METHODS
     KWD-WALK-WARN-ABOUT-MISSING-METHODS KWD-WALK-USE-CPP-GARBAGE-COLLECTOR
     KWD-WALK-USE-COMMON-LISP-CONSES KWD-WALK-MINIMIZE-JAVA-PREFIXES))
   (RESET-STELLA-FEATURES) (CL:SETQ *USEHARDCODEDSYMBOLS?* FALSE)
   (CL:SETQ *TRANSLATOROUTPUTLANGUAGE* KWD-WALK-COMMON-LISP)
   (CL:SETQ *FOUNDRETURN?* FALSE) (CL:SETQ *TARGETTYPE* SGT-WALK-STELLA-VOID)
   (CL:SETQ *LOG-FUNCTION-CALLS?* FALSE)
   (CL:SETQ *WRAPPED-TYPE-TABLE*
    (LIST* (LIST* SGT-WALK-STELLA-INTEGER-WRAPPER SGT-WALK-STELLA-INTEGER NIL)
     ...
     (LIST* SGT-WALK-STELLA-MUTABLE-STRING-WRAPPER SGT-WALK-STELLA-MUTABLE-STRING
      NIL)
     ...
     (LIST* SGT-WALK-STELLA-FUNCTION-CODE-WRAPPER SGT-WALK-STELLA-FUNCTION-CODE
      NIL)
     (LIST* SGT-WALK-STELLA-METHOD-CODE-WRAPPER SGT-WALK-STELLA-METHOD-CODE NIL)
     NIL))
   (CL:SETQ *COERSION-TABLE*
    (LIST*
     ...
     (LIST* SGT-WALK-STELLA-MUTABLE-STRING SGT-WALK-STELLA-MUTABLE-STRING-WRAPPER
      SYM-WALK-STELLA-WRAP-LITERAL NIL)
     ...
     (LIST* SGT-WALK-STELLA-FUNCTION-CODE SGT-WALK-STELLA-FUNCTION-CODE-WRAPPER
      SYM-WALK-STELLA-WRAP-LITERAL NIL)
     (LIST* SGT-WALK-STELLA-METHOD-CODE SGT-WALK-STELLA-METHOD-CODE-WRAPPER
      SYM-WALK-STELLA-WRAP-LITERAL NIL)
     ...
     (LIST* SGT-WALK-STELLA-FUNCTION-CODE-WRAPPER SGT-WALK-STELLA-FUNCTION-CODE
      SYM-WALK-STELLA-WRAPPER-VALUE NIL)
     (LIST* SGT-WALK-STELLA-METHOD-CODE-WRAPPER SGT-WALK-STELLA-METHOD-CODE
      SYM-WALK-STELLA-WRAPPER-VALUE NIL)
     ...
     (LIST* SGT-WALK-STELLA-SURROGATE SGT-WALK-STELLA-MODULE
      SYM-WALK-STELLA-SURROGATE-VALUE NIL)
     (LIST* SGT-WALK-STELLA-INPUT-STREAM SGT-WALK-STELLA-NATIVE-INPUT-STREAM
      SYM-WALK-STELLA-NATIVE-STREAM NIL)
     (LIST* SGT-WALK-STELLA-OUTPUT-STREAM SGT-WALK-STELLA-NATIVE-OUTPUT-STREAM
      SYM-WALK-STELLA-NATIVE-STREAM NIL)
     (LIST* SGT-WALK-STELLA-NUMBER SGT-WALK-STELLA-INTEGER
      (LIST* SYM-WALK-STELLA-CAST SYM-WALK-STELLA-<X> SGT-WALK-STELLA-INTEGER
       NIL)
      NIL)
     (LIST* SGT-WALK-STELLA-NUMBER SGT-WALK-STELLA-FLOAT
      (LIST* SYM-WALK-STELLA-CAST SYM-WALK-STELLA-<X> SGT-WALK-STELLA-FLOAT NIL)
      NIL)
     ...
     (LIST* SGT-WALK-STELLA-INTEGER SGT-WALK-STELLA-LONG-INTEGER
      SYM-WALK-STELLA-IDENTITY NIL)
     (LIST* SGT-WALK-STELLA-INTEGER SGT-WALK-STELLA-UNSIGNED-SHORT-INTEGER
      SYM-WALK-STELLA-IDENTITY NIL)
     (LIST* SGT-WALK-STELLA-INTEGER SGT-WALK-STELLA-UNSIGNED-LONG-INTEGER
      SYM-WALK-STELLA-IDENTITY NIL)
     NIL))
   (CL:SETQ *SYMBOL-REGISTRY* (NEW-HASH-TABLE)) (CL:SETQ *SYMBOL-SET* (NEW-LIST))
   (CL:SETQ *SPECIALVARIABLESTACK* (NEW-KEY-VALUE-LIST))
   (CL:SETQ *SPECIALSENABLED?* TRUE)
   (CL:SETQ *TYPE-PREDICATE-TABLE*
    (LIST*
     ...
     (LIST* SGT-WALK-STELLA-STRING-WRAPPER SYM-WALK-STELLA-STRING?
      SYM-WALK-STELLA-SUBTYPE-OF-STRING? NIL)
     (LIST* SGT-WALK-STELLA-CHARACTER-WRAPPER SYM-WALK-STELLA-CHARACTER?
      SYM-WALK-STELLA-SUBTYPE-OF-CHARACTER? NIL)
   ...
   (CL:SETQ *NUMERIC-TYPE-HIERARCHY*
    (LIST SGT-WALK-STELLA-INTEGER SGT-WALK-STELLA-FLOAT SGT-WALK-STELLA-NUMBER))
   (CL:SETQ *INLININGMETHODCALL?* FALSE)
...
print all the elements in `body' to standard output.  Otherwise, do nothing.
`keyword' can also be a list of keywords in which case printing is done if
one or more of them are trace enabled.\" :PUBLIC? TRUE)" (CL:FUNCTION TRACE-IF)
    NULL)
...
calling (`drop-trace' <keyword>) code guarded by (`trace-if' <keyword> ...)
will not be executed when it is encountered.\")" (CL:FUNCTION %DROP-TRACE)
...
`speed', and `space'.\" :PUBLIC? TRUE)" (CL:FUNCTION SET-OPTIMIZATION-LEVELS)
    NULL)
   ...
   (DEFINE-FUNCTION-OBJECT "TOGGLE-TRANSLATORS"
    "(DEFUN (TOGGLE-TRANSLATORS KEYWORD) ())" (CL:FUNCTION TOGGLE-TRANSLATORS)
    NULL)
   ...
   (DEFINE-FUNCTION-OBJECT "WALK-AUXILIARY-TREE"
    "(DEFUN WALK-AUXILIARY-TREE ((TREE CONS)))" (CL:FUNCTION WALK-AUXILIARY-TREE)
    NULL)
   ...
   (DEFINE-FUNCTION-OBJECT "WALK-ALL-PHASE-ONE-UNITS"
    "(DEFUN WALK-ALL-PHASE-ONE-UNITS ())" (CL:FUNCTION WALK-ALL-PHASE-ONE-UNITS)
    NULL)
   (DEFINE-FUNCTION-OBJECT "TRANSLATE-ALL-UNITS" "(DEFUN TRANSLATE-ALL-UNITS ())"
    (CL:FUNCTION TRANSLATE-ALL-UNITS) NULL)
...
return NIL instead.\" :PUBLIC? TRUE)" (CL:FUNCTION INCREMENTALLY-TRANSLATE) NULL)
   (DEFINE-FUNCTION-OBJECT "RESET-TRANSLATION-ERRORS"
    "(DEFUN RESET-TRANSLATION-ERRORS ())" (CL:FUNCTION RESET-TRANSLATION-ERRORS)
    NULL)
   ...
   (DEFINE-FUNCTION-OBJECT "LOG-FUNCTION-CALL"
    "(DEFUN LOG-FUNCTION-CALL ((NAME STRING)))" (CL:FUNCTION LOG-FUNCTION-CALL)
    NULL)
...
(CL:DEFUN HELP-STARTUP-WALK10 ()
  (CL:PROGN
   (DEFINE-FUNCTION-OBJECT "PO" "(DEFUN PO ((THING OBJECT)))" (CL:FUNCTION PO)
    NULL)
   ...
   (DEFINE-FUNCTION-OBJECT "POP-VARIABLE-BINDING"
    "(DEFUN POP-VARIABLE-BINDING ())" (CL:FUNCTION POP-VARIABLE-BINDING) NULL)
   ...
   (DEFINE-FUNCTION-OBJECT "LOCAL-GENSYM"
    "(DEFUN (LOCAL-GENSYM SYMBOL) ((PREFIX STRING)))" (CL:FUNCTION LOCAL-GENSYM)
    NULL)
   ...
   (DEFINE-FUNCTION-OBJECT "ILLEGAL-TREE?"
    "(DEFUN (ILLEGAL-TREE? BOOLEAN) ((TREE OBJECT)))" (CL:FUNCTION ILLEGAL-TREE?)
    NULL)
   (DEFINE-FUNCTION-OBJECT "NATIVE-CLASS-METHOD-INLINING?"
    "(DEFUN (NATIVE-CLASS-METHOD-INLINING? BOOLEAN) ())"
    (CL:FUNCTION NATIVE-CLASS-METHOD-INLINING?) NULL)
   (DEFINE-FUNCTION-OBJECT "PROGNIFY" "(DEFUN (PROGNIFY OBJECT) ((TREES CONS)))"
    (CL:FUNCTION PROGNIFY) NULL)
   ...
   (DEFINE-FUNCTION-OBJECT "TREE-TO-TREES"
    "(DEFUN (TREE-TO-TREES CONS) ((TREE OBJECT)))" (CL:FUNCTION TREE-TO-TREES)
    NULL)
...
or 'self' if it is not a bare literal type.\" :PUBLIC? TRUE)"
    (CL:FUNCTION TYPE-TO-WRAPPED-TYPE) NULL)
   ...
   (DEFINE-FUNCTION-OBJECT "TRANSLATING-CODE?"
    "(DEFUN (TRANSLATING-CODE? BOOLEAN) ())" (CL:FUNCTION TRANSLATING-CODE?)
    NULL)
   (DEFINE-FUNCTION-OBJECT "VERIFY-TYPE"
    "(DEFUN (VERIFY-TYPE TYPE) ((SELF TYPE)))" (CL:FUNCTION VERIFY-TYPE) NULL)
   ...
   (DEFINE-FUNCTION-OBJECT "WALKING-EXPRESSION?"
    "(DEFUN (WALKING-EXPRESSION? BOOLEAN) ())" (CL:FUNCTION WALKING-EXPRESSION?)
    NULL)
...
(CL:DEFUN HELP-STARTUP-WALK11 ()
  (CL:PROGN
   ...
   (DEFINE-FUNCTION-OBJECT "CLEAR-SYMBOL-REGISTRY"
    "(DEFUN CLEAR-SYMBOL-REGISTRY ())" (CL:FUNCTION CLEAR-SYMBOL-REGISTRY) NULL)
   ...
   (DEFINE-FUNCTION-OBJECT "VALUES-TREE?"
    "(DEFUN (VALUES-TREE? BOOLEAN) ((TREE OBJECT)))" (CL:FUNCTION VALUES-TREE?)
    NULL)
...
(CL:DEFUN HELP-STARTUP-WALK12 ()
  (CL:PROGN
   ...
   (DEFINE-FUNCTION-OBJECT "EXPAND-MACRO"
    "(DEFUN (EXPAND-MACRO OBJECT) ((TREE CONS)))" (CL:FUNCTION EXPAND-MACRO)
    NULL)
...
(CL:DEFUN HELP-STARTUP-WALK13 ()
  (CL:PROGN
   ...
   (DEFINE-FUNCTION-OBJECT "WALK-INLINE-METHOD-CALL"
    "(DEFUN (WALK-INLINE-METHOD-CALL OBJECT) ((METHOD METHOD-SLOT) (WALKEDARGS CONS)))"
   ...
   (DEFINE-FUNCTION-OBJECT "WALK-DEFMETHOD-TREE"
    "(DEFUN WALK-DEFMETHOD-TREE ((TREE CONS)))" (CL:FUNCTION WALK-DEFMETHOD-TREE)
    NULL)
   (DEFINE-EXTERNAL-SLOT-FROM-STRINGIFIED-SOURCE
...
by actual definitions.\")" (CL:FUNCTION PRINT-UNDEFINED-METHODS) NULL)
   ...
   (DEFINE-FUNCTION-OBJECT "WALK-DEFCLASS-TREE"
    "(DEFUN WALK-DEFCLASS-TREE ((TREE CONS)))" (CL:FUNCTION WALK-DEFCLASS-TREE)
    NULL)
...
necessary signatures.\" :ALLOCATION :DYNAMIC)")
   ...
   (DEFINE-FUNCTION-OBJECT "WALK-DEFSLOT-TREE"
    "(DEFUN WALK-DEFSLOT-TREE ((TREE CONS)))" (CL:FUNCTION WALK-DEFSLOT-TREE)
    NULL)
...
holding its expander function.\" :PUBLIC? TRUE)" (CL:FUNCTION LOOKUP-MACRO) NULL)
   ...
   (DEFINE-FUNCTION-OBJECT "WALK-DEFMACRO-TREE"
    "(DEFUN WALK-DEFMACRO-TREE ((TREE CONS)))" (CL:FUNCTION WALK-DEFMACRO-TREE)
    NULL)
   (DEFINE-FUNCTION-OBJECT "WALK-DEFGLOBAL-TREE"
    "(DEFUN WALK-DEFGLOBAL-TREE ((TREE CONS)))" (CL:FUNCTION WALK-DEFGLOBAL-TREE)
    NULL)
   ...
   (DEFINE-FUNCTION-OBJECT "WALK-DEFTYPE-TREE"
    "(DEFUN WALK-DEFTYPE-TREE ((TREE CONS)))" (CL:FUNCTION WALK-DEFTYPE-TREE)
    NULL)
...
(CL:DEFUN HELP-STARTUP-WALK14 ()
  (CL:PROGN
   ...
   (DEFINE-FUNCTION-OBJECT "WALK-DEFMODULE-TREE"
    "(DEFUN WALK-DEFMODULE-TREE ((TREE CONS)))" (CL:FUNCTION WALK-DEFMODULE-TREE)
    NULL)
...
are simple to program in Common Lisp, since they are built into the language,
and relatively awkward in Java and C++.  Users of either of those 
languages are more likely to want to call `evaluate-string'.\" :LISP-MACRO? TRUE :PUBLIC? TRUE)"
...
evaluation strategies.\" :PUBLIC? TRUE)" (CL:FUNCTION TRY-TO-EVALUATE) NULL)
   ...
   (DEFINE-FUNCTION-OBJECT "STARTUP-WALK" "(DEFUN STARTUP-WALK () :PUBLIC? TRUE)"
    (CL:FUNCTION STARTUP-WALK) NULL)
   (CL:LET* ((FUNCTION (LOOKUP-FUNCTION SYM-WALK-STELLA-STARTUP-WALK)))
    (SET-DYNAMIC-SLOT-VALUE (%DYNAMIC-SLOTS FUNCTION)
     SYM-WALK-STELLA-METHOD-STARTUP-CLASSNAME (WRAP-STRING "_Startup-Walk")
     NULL-STRING-WRAPPER)))
  :VOID)
...
(CL:DEFUN STARTUP-WALK ()
  ...
  (CL:LET* ((*MODULE* *STELLA-MODULE*) (*CONTEXT* *MODULE*))
   ...
   (CL:WHEN (CURRENT-STARTUP-TIME-PHASE? 7) (HELP-STARTUP-WALK9)
    (HELP-STARTUP-WALK10) (HELP-STARTUP-WALK11) (HELP-STARTUP-WALK12)
    (HELP-STARTUP-WALK13) (HELP-STARTUP-WALK14))
...
with `reset-stella-features'.\" :PUBLIC? TRUE)")
    (REGISTER-NATIVE-NAME SYM-WALK-STELLA-SET-STELLA-FEATURE KWD-WALK-COMMON-LISP
     KWD-WALK-FUNCTION)
    ...
    (REGISTER-NATIVE-NAME SYM-WALK-STELLA-ADD-TRACE KWD-WALK-COMMON-LISP
     KWD-WALK-FUNCTION)
    (REGISTER-NATIVE-NAME SYM-WALK-STELLA-DROP-TRACE KWD-WALK-COMMON-LISP
     KWD-WALK-FUNCTION)
    (DEFINE-STELLA-GLOBAL-VARIABLE-FROM-STRINGIFIED-SOURCE
...
generated during the translation of Stella declarations.\")")
    ...
    (DEFINE-STELLA-GLOBAL-VARIABLE-FROM-STRINGIFIED-SOURCE
     "(DEFSPECIAL *TRANSLATOROUTPUTLANGUAGE* KEYWORD :COMMON-LISP :DOCUMENTATION \"Specifies the current translator output language; either
:common-lisp, :idl, :java, :cpp, or :cpp-standalone.\")")
    (REGISTER-NATIVE-NAME SYM-WALK-STELLA-SET-TRANSLATOR-OUTPUT-LANGUAGE
     KWD-WALK-COMMON-LISP KWD-WALK-FUNCTION)
    (DEFINE-STELLA-GLOBAL-VARIABLE-FROM-STRINGIFIED-SOURCE
...
to its own gensym counter and/or to related gensyms.\")")
    (DEFINE-STELLA-GLOBAL-VARIABLE-FROM-STRINGIFIED-SOURCE
     "(DEFSPECIAL *TRANSLATIONERRORS* INTEGER 0 :PUBLIC? TRUE)")
    (DEFINE-STELLA-GLOBAL-VARIABLE-FROM-STRINGIFIED-SOURCE
...
functions that would cause too much stress for some wimpy compilers).\")")
    ...
    (DEFINE-STELLA-GLOBAL-VARIABLE-FROM-STRINGIFIED-SOURCE
     "(DEFSPECIAL *EVALUATIONTREE* OBJECT NULL :PUBLIC? TRUE)")
    (DEFINE-STELLA-GLOBAL-VARIABLE-FROM-STRINGIFIED-SOURCE
