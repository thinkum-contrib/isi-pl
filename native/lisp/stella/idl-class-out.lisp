...
(CL:DECLAIM (CL:SPECIAL *STELLA-MODULE* *MODULE* *METHODBEINGWALKED*))
...
(CL:DEFUN IDL-YIELD-CONSTRUCTOR-SIGNATURE-TREE (METHOD)
  ...
  (CL:RETURN-FROM IDL-YIELD-CONSTRUCTOR-SIGNATURE-TREE
   (CONS (IDL-TRANSLATE-CLASS-NAME (SYMBOLIZE (%SLOT-OWNER METHOD)))
  ...
  (CL:LET*
   ...
   (CL:LET*
    ...
    (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-000 NIL)) DO
     ...
     (CL:IF (CL:EQ COLLECT-000 NULL)
      (CL:PROGN
       (CL:SETQ COLLECT-000
        (CONS (IDL-TRANSLATE-CLASS-NAME (SYMBOLIZE SUPER)) NIL))
   ...
   (CL:RETURN-FROM IDL-TRANSLATE-DEFINE-NATIVE-CLASS-UNIT
    (CONS (IDL-CLASS-CATEGORY CLASS)
     (CONS (IDL-TRANSLATE-CLASS-NAME (SYMBOLIZE (%CLASS-TYPE CLASS)))
      (CONS PARAMETERS
       (CONS DERIVEDCLASSES
   ...
   (CL:WHEN (CURRENT-STARTUP-TIME-PHASE? 7)
    ...
    (CL:LET*
     ...
     (SET-DYNAMIC-SLOT-VALUE (%DYNAMIC-SLOTS FUNCTION)
      ...
      (WRAP-STRING "Startup-Idl-Class-Out") NULL-STRING-WRAPPER)))
