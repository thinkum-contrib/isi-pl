...
(CL:DECLAIM
 (CL:SPECIAL *PRINTREADABLY?* *STELLA-TOKENIZER-TABLE* *STELLA-LOGICAL-STATE-NAMES* NULL-CHARACTER
  *CHARACTER-TYPE-TABLE* NULL-STRING-WRAPPER *TRANSIENTOBJECTS?* NIL NULL-INTEGER))
...
(CL:DEFUN NEXT-FREE-OFFSET (SELF)
  (CL:LET* ((TOPOFFSET (%TOP-SYMBOL-OFFSET SELF)) (FREEOFFSET (CL:1+ TOPOFFSET)))
   (CL:DECLARE (CL:TYPE CL:FIXNUM TOPOFFSET FREEOFFSET))
   (CL:LET*
    ((I NULL-INTEGER) (ITER-000 (%POTENTIAL-FREE-SYMBOL-OFFSET SELF)) (UPPER-BOUND-000 TOPOFFSET)
    ...
    (CL:LOOP WHILE (CL:OR UNBOUNDED?-000 (CL:<= ITER-000 UPPER-BOUND-000)) DO (CL:SETQ I ITER-000)
     (CL:WHEN (CL:EQ (CL:AREF (CL:THE CL:SIMPLE-VECTOR (%THE-ARRAY SELF)) I) NULL) (CL:SETQ FREEOFFSET I) (CL:RETURN))
...
(CL:DEFUN ADD-TO-SYMBOL-ARRAY (ARRAY SYMBOL)
  (CL:LET* ((OFFSET (NEXT-FREE-OFFSET ARRAY))) (CL:DECLARE (CL:TYPE CL:FIXNUM OFFSET))
   (ADD-TO-SYMBOL-ARRAY-AT ARRAY OFFSET SYMBOL) (CL:RETURN-FROM ADD-TO-SYMBOL-ARRAY OFFSET)))
...
(CL:DEFUN SELECT-SYMBOL-OFFSET-TABLE (MODULE KINDOFSYM)
  ...
  (CL:ECASE KINDOFSYM (0 (CL:RETURN-FROM SELECT-SYMBOL-OFFSET-TABLE (%SYMBOL-OFFSET-TABLE MODULE)))
   (1 (CL:RETURN-FROM SELECT-SYMBOL-OFFSET-TABLE (%SURROGATE-OFFSET-TABLE MODULE)))
...
(CL:DEFUN SELECT-SYMBOL-ARRAY (KINDOFSYM)
  ...
  #+MCL
  (CL:CHECK-TYPE KINDOFSYM CL:FIXNUM)
  (CL:ECASE KINDOFSYM (0 (CL:RETURN-FROM SELECT-SYMBOL-ARRAY *SYMBOL-ARRAY*))
   (1 (CL:RETURN-FROM SELECT-SYMBOL-ARRAY *SURROGATE-ARRAY*)) (2 (CL:RETURN-FROM SELECT-SYMBOL-ARRAY *KEYWORD-ARRAY*))))
...
(CL:DEFUN LOOKUP-RIGID-SYMBOL-LOCALLY (NAME MODULE KINDOFSYM)
  ...
  #+MCL
  (CL:CHECK-TYPE KINDOFSYM CL:FIXNUM)
  (CL:LET* ((OFFSETTABLE (SELECT-SYMBOL-OFFSET-TABLE MODULE KINDOFSYM)) (OFFSET (LOOKUP OFFSETTABLE NAME)))
   (CL:DECLARE (CL:TYPE CL:FIXNUM OFFSET))
   (CL:WHEN (CL:NOT (CL:= OFFSET NULL-INTEGER))
    (CL:ECASE KINDOFSYM (0 (CL:RETURN-FROM LOOKUP-RIGID-SYMBOL-LOCALLY (GET-SYM-FROM-OFFSET OFFSET)))
     (1 (CL:RETURN-FROM LOOKUP-RIGID-SYMBOL-LOCALLY (GET-SGT-FROM-OFFSET OFFSET)))
     (2 (CL:RETURN-FROM LOOKUP-RIGID-SYMBOL-LOCALLY (GET-KWD-FROM-OFFSET OFFSET)))))
...
(CL:DEFUN VISIBLE-RIGID-SYMBOLS-WRT-MODULE (NAME MODULE KINDOFSYM)
  ...
  (CL:RETURN-FROM VISIBLE-RIGID-SYMBOLS-WRT-MODULE
   (ALLOCATE-DESTRUCTIVE-LIST-ITERATOR (YIELD-VISIBLE-RIGID-SYMBOLS-WRT-MODULE NAME MODULE KINDOFSYM))))
     ...
     (CL:WHEN (SHADOWED-SYMBOL? SYMBOL)
      (CL:IF (CL:EQ COLLECT-000 NULL)
       (CL:PROGN (CL:SETQ COLLECT-000 (CONS (%HOME-CONTEXT SYMBOL) NIL))
        (CL:IF (CL:EQ SHADOWINGMODULES NIL) (CL:SETQ SHADOWINGMODULES COLLECT-000)
         (ADD-CONS-TO-END-OF-CONS-LIST SHADOWINGMODULES COLLECT-000)))
       (CL:PROGN (CL:SETF (%%REST COLLECT-000) (CONS (%HOME-CONTEXT SYMBOL) NIL))
        ...
        (CL:LET* ((FOUND?-000 CL:NIL))
         (CL:LET* ((MODULE NULL) (ITER-002 SHADOWINGMODULES))
          (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-002 NIL)) DO (CL:SETQ MODULE (%%VALUE ITER-002))
           (CL:WHEN
            (CL:AND (CL:NOT (CL:EQ MODULE (%HOME-CONTEXT SYMBOL))) (VISIBLE-FROM? (%HOME-CONTEXT SYMBOL) MODULE))
        ...
        (CL:WHEN TEST-VALUE-000
         (CL:IF (CL:EQ COLLECT-001 NULL)
          (CL:PROGN (CL:SETQ COLLECT-001 (CONS SYMBOL NIL))
           (CL:IF (CL:EQ UNSHADOWEDSYMBOLS NIL) (CL:SETQ UNSHADOWEDSYMBOLS COLLECT-001)
            (ADD-CONS-TO-END-OF-CONS-LIST UNSHADOWEDSYMBOLS COLLECT-001)))
  ...
  (CL:LET* ((OFFSETTABLE (SELECT-SYMBOL-OFFSET-TABLE MODULE KINDOFSYM)) (OFFSET (LOOKUP OFFSETTABLE NAME)))
   ...
   (CL:LET* ((SUPER NULL) (ITER-000 (%%REST (VISIBLE-MODULES MODULE))))
    (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-000 NIL)) DO (CL:SETQ SUPER (%%VALUE ITER-000))
     (CL:SETQ OFFSET (LOOKUP (SELECT-SYMBOL-OFFSET-TABLE SUPER KINDOFSYM) NAME))
     (CL:WHEN (CL:NOT (CL:= OFFSET NULL-INTEGER)) (CL:RETURN-FROM LOOKUP-RIGID-SYMBOL-OFFSET-WRT-MODULE OFFSET))
     (CL:SETQ ITER-000 (%%REST ITER-000))))
...
(CL:DEFUN LOOKUP-RIGID-SYMBOL-WRT-MODULE (NAME MODULE KINDOFSYM)
  ...
  #+MCL
  (CL:CHECK-TYPE KINDOFSYM CL:FIXNUM)
  (CL:LET* ((OFFSET (LOOKUP-RIGID-SYMBOL-OFFSET-WRT-MODULE NAME MODULE KINDOFSYM)))
   (CL:DECLARE (CL:TYPE CL:FIXNUM OFFSET))
   (CL:IF (CL:NOT (CL:= OFFSET NULL-INTEGER))
    (CL:ECASE KINDOFSYM (0 (CL:RETURN-FROM LOOKUP-RIGID-SYMBOL-WRT-MODULE (GET-SYM-FROM-OFFSET OFFSET)))
     (1 (CL:RETURN-FROM LOOKUP-RIGID-SYMBOL-WRT-MODULE (GET-SGT-FROM-OFFSET OFFSET)))
     (2 (CL:RETURN-FROM LOOKUP-RIGID-SYMBOL-WRT-MODULE (GET-KWD-FROM-OFFSET OFFSET))))
...
symbols that are shadowed due to some :SHADOW declaration."
  ...
  (CL:LET* ((VISIBLESYMBOLS (YIELD-VISIBLE-RIGID-SYMBOLS-WRT-MODULE NAME MODULE SYMBOL-SYM)))
   (CL:IF (CL:AND ENFORCESHADOWING? (CL:NOT (CL:EQ (%%REST VISIBLESYMBOLS) NIL)))
    (CL:RETURN-FROM LOOKUP-VISIBLE-SYMBOLS-IN-MODULE (REMOVE-SHADOWED-SYMBOLS VISIBLESYMBOLS))
...
(CL:DEFUN HELP-INTERN-GENERALIZED-SYMBOL (NAME KINDOFSYM ARRAY OFFSET MODULE)
  ...
  (CL:LET* ((SYMBOL NULL) (TABLE (SELECT-SYMBOL-OFFSET-TABLE MODULE KINDOFSYM)))
   (CL:ECASE KINDOFSYM
    (0 (CL:SETQ SYMBOL (NEW-SYMBOL NAME)) (INSERT-AT TABLE NAME OFFSET) (CL:SETF (%HOME-CONTEXT SYMBOL) MODULE))
  ...
  (CL:LET* ((OFFSET (LOOKUP-RIGID-SYMBOL-OFFSET-WRT-MODULE NAME MODULE KINDOFSYM)))
   ...
   (CL:WHEN (CL:NOT (CL:= OFFSET NULL-INTEGER))
    (CL:ECASE KINDOFSYM (0 (CL:RETURN-FROM INTERN-RIGID-SYMBOL-WRT-MODULE (GET-SYM-FROM-OFFSET OFFSET)))
     (1 (CL:RETURN-FROM INTERN-RIGID-SYMBOL-WRT-MODULE (GET-SGT-FROM-OFFSET OFFSET)))
     (2 (CL:RETURN-FROM INTERN-RIGID-SYMBOL-WRT-MODULE (GET-KWD-FROM-OFFSET OFFSET)))))
...
interned into the module `module' with name `name'."
  ...
  (CL:CHECK-TYPE KINDOFSYM CL:FIXNUM)
  (CL:WHEN (CL:EQ MODULE NULL) (CL:SETQ MODULE *MODULE*))
  (CL:LET* ((SYMBOL (LOOKUP-RIGID-SYMBOL-LOCALLY NAME MODULE KINDOFSYM)))
   (CL:WHEN (CL:NOT (CL:EQ SYMBOL NULL)) (CL:RETURN-FROM INTERN-RIGID-SYMBOL-LOCALLY SYMBOL))
   (CL:LET* ((ARRAY (SELECT-SYMBOL-ARRAY KINDOFSYM)))
    (CL:RETURN-FROM INTERN-RIGID-SYMBOL-LOCALLY
     (HELP-INTERN-GENERALIZED-SYMBOL NAME KINDOFSYM ARRAY (NEXT-FREE-OFFSET ARRAY) MODULE)))))
...
(CL:DEFUN INTERN-SYMBOL (NAME)
  ...
  (CL:IF (%CASE-SENSITIVE? *MODULE*)
   (CL:RETURN-FROM INTERN-SYMBOL (INTERN-RIGID-SYMBOL-CASE-SENSITIVELY NAME SYMBOL-SYM CL:NIL))
  ...
  (CL:LET* ((CURRENTMODULE *MODULE*))
   (CL:LET* ((*MODULE* (%HOME-CONTEXT BASESYMBOL))) (CL:DECLARE (CL:SPECIAL *MODULE*))
    (CL:WHEN (CL:NOT (CL:EQ *MODULE* NULL))
     (CL:RETURN-FROM INTERN-DERIVED-SYMBOL (INTERN-RIGID-SYMBOL-LOCALLY NEWNAME *MODULE* SYMBOL-SYM)))
    (CL:SETQ *MODULE* CURRENTMODULE)
    (CL:RETURN-FROM INTERN-DERIVED-SYMBOL (INTERN-RIGID-SYMBOL-CASE-SENSITIVELY NEWNAME SYMBOL-SYM CL:NIL)))))
...
(CL:DEFUN INTERN-SURROGATE (NAME)
  ...
  (CL:CHECK-TYPE NAME CL:SIMPLE-STRING)
  (CL:IF (%CASE-SENSITIVE? *MODULE*)
   (CL:RETURN-FROM INTERN-SURROGATE (INTERN-RIGID-SYMBOL-CASE-SENSITIVELY NAME SURROGATE-SYM CL:NIL))
   ...
   (CL:LET* ((*MODULE* (%HOME-CONTEXT BASESYMBOL))) (CL:DECLARE (CL:SPECIAL *MODULE*))
    (CL:WHEN (CL:NOT (CL:EQ *MODULE* NULL))
     (CL:RETURN-FROM INTERN-DERIVED-SURROGATE
      (INTERN-RIGID-SYMBOL-LOCALLY (CL:IF (%CASE-SENSITIVE? *MODULE*) NEWNAME (STRING-UPCASE NEWNAME)) *MODULE*
       SURROGATE-SYM)))
...
inheritance will be shadowed by the newly imported `symbol'."
  (CL:LET* ((NAME (%SYMBOL-NAME SYMBOL)) (MODULESYMBOL (LOOKUP-SYMBOL-IN-MODULE NAME MODULE CL:T)))
   (CL:DECLARE (CL:TYPE CL:SIMPLE-STRING NAME))
   (CL:WHEN (CL:EQ (%HOME-CONTEXT SYMBOL) NULL)
    (CL:LET* ((STREAM-000 (NEW-OUTPUT-STRING-STREAM)))
     (%%PRINT-STREAM (%NATIVE-STREAM STREAM-000) "Can't import the TRANSIENT symbol `" NAME "' into `" MODULE "'")
     (CL:ERROR (NEW-STELLA-EXCEPTION (THE-STRING-READER STREAM-000)))))
   (CL:WHEN (CL:NOT (CL:EQ MODULESYMBOL SYMBOL))
    (CL:WHEN (CL:NOT (CL:EQ MODULESYMBOL NULL))
     (CL:LET* ((STREAM-001 (NEW-OUTPUT-STRING-STREAM)))
      (%%PRINT-STREAM (%NATIVE-STREAM STREAM-001) "Can't import, a symbol with name `" NAME "' already exists in `"
       MODULE "'")
      (CL:ERROR (NEW-STELLA-EXCEPTION (THE-STRING-READER STREAM-001)))))
    (CL:WHEN (CL:NOT (CL:EQ SYMBOL NULL))
     (INSERT-AT (SELECT-SYMBOL-OFFSET-TABLE MODULE SYMBOL-SYM) NAME (%SYMBOL-ID SYMBOL))))
...
inheritance will be shadowed by the newly imported `surrogate'."
  (CL:LET* ((NAME (%SYMBOL-NAME SURROGATE)) (MODULESURROGATE (LOOKUP-SURROGATE-IN-MODULE NAME MODULE CL:T)))
   (CL:DECLARE (CL:TYPE CL:SIMPLE-STRING NAME))
   (CL:WHEN (CL:NOT (CL:EQ MODULESURROGATE SURROGATE))
    (CL:WHEN (CL:NOT (CL:EQ MODULESURROGATE NULL))
     (CL:LET* ((STREAM-000 (NEW-OUTPUT-STRING-STREAM)))
      (%%PRINT-STREAM (%NATIVE-STREAM STREAM-000) "Can't import, a surrogate with name `" NAME "' already exists in `"
       MODULE "'")
      (CL:ERROR (NEW-STELLA-EXCEPTION (THE-STRING-READER STREAM-000)))))
    (CL:WHEN (CL:NOT (CL:EQ SURROGATE NULL))
     (INSERT-AT (SELECT-SYMBOL-OFFSET-TABLE MODULE SURROGATE-SYM) NAME (%SYMBOL-ID SURROGATE))))
...
otherwise."
  (CL:LET* ((NAME (%SYMBOL-NAME SYMBOL)) (MODULESYMBOL (LOOKUP-SYMBOL-IN-MODULE NAME MODULE CL:NIL)))
   (CL:DECLARE (CL:TYPE CL:SIMPLE-STRING NAME))
   (CL:IF (CL:OR (CL:NOT (CL:EQ MODULESYMBOL NULL)) (CL:EQ (%HOME-CONTEXT SYMBOL) NULL))
    (CL:RETURN-FROM SAFE-IMPORT-SYMBOL MODULESYMBOL) (CL:RETURN-FROM SAFE-IMPORT-SYMBOL (IMPORT-SYMBOL SYMBOL MODULE)))))
...
otherwise."
  (CL:LET* ((NAME (%SYMBOL-NAME SURROGATE)) (MODULESURROGATE (LOOKUP-SURROGATE-IN-MODULE NAME MODULE CL:NIL)))
   (CL:DECLARE (CL:TYPE CL:SIMPLE-STRING NAME))
...
(CL:DEFUN UNINTERN-SYMBOL (SELF)
  ...
  (CL:LET*
   ((SYMBOLARRAY (SELECT-SYMBOL-ARRAY SYMBOL-SYM))
    (OFFSETTABLE
     (CL:IF (CL:NOT (CL:EQ (%HOME-CONTEXT SELF) NULL)) (SELECT-SYMBOL-OFFSET-TABLE (%HOME-CONTEXT SELF) SYMBOL-SYM)
      NULL))
    (SYMBOLID (%SYMBOL-ID SELF)) (REALSYMBOL (GET-SYM-FROM-OFFSET SYMBOLID)))
   (CL:DECLARE (CL:TYPE CL:FIXNUM SYMBOLID))
   (CL:WHEN (CL:EQ SELF REALSYMBOL) (FREE-SYMBOL-OFFSET SYMBOLARRAY SYMBOLID))
   (CL:WHEN (CL:AND (CL:NOT (CL:EQ OFFSETTABLE NULL)) (CL:= SYMBOLID (LOOKUP OFFSETTABLE (%SYMBOL-NAME SELF))))
...
(CL:DEFUN UNINTERN-SURROGATE (SELF)
  ...
  (CL:LET*
   ((SURROGATEARRAY (SELECT-SYMBOL-ARRAY SURROGATE-SYM))
    (OFFSETTABLE
     (CL:IF (CL:NOT (CL:EQ (%HOME-CONTEXT SELF) NULL)) (SELECT-SYMBOL-OFFSET-TABLE (%HOME-CONTEXT SELF) SURROGATE-SYM)
      NULL))
    (SURROGATEID (%SYMBOL-ID SELF)) (REALSURROGATE (GET-SGT-FROM-OFFSET SURROGATEID)))
   (CL:DECLARE (CL:TYPE CL:FIXNUM SURROGATEID))
   (CL:WHEN (CL:EQ SELF REALSURROGATE) (FREE-SYMBOL-OFFSET SURROGATEARRAY SURROGATEID))
   (CL:WHEN (CL:AND (CL:NOT (CL:EQ OFFSETTABLE NULL)) (CL:= SURROGATEID (LOOKUP OFFSETTABLE (%SYMBOL-NAME SELF))))
    (REMOVE-AT OFFSETTABLE (%SYMBOL-NAME SELF)))
...
which got hardwired into translated code will refer to the correct objects."
  ...
  (CL:LET* ((SYMBOLARRAY NULL) (SYMBOL NULL))
   (CL:ECASE KINDOFSYM (0 (CL:SETQ SYMBOL (LOOKUP-SYMBOL NAME))) (1 (CL:SETQ SYMBOL (LOOKUP-SURROGATE NAME)))
    (2 (CL:SETQ SYMBOL (LOOKUP-KEYWORD NAME))))
   (CL:WHEN (CL:NOT (CL:EQ SYMBOL NULL))
    (CL:WHEN (CL:NOT (CL:= (%SYMBOL-ID SYMBOL) OFFSET))
     (CL:WARN "intern-bootstrap-symbol-at: `~A' is already interned at offset `~A'" SYMBOL (%SYMBOL-ID SYMBOL)))
   ...
   (CL:WHEN
    (CL:AND (LEGAL-SYMBOL-ARRAY-OFFSET? SYMBOLARRAY OFFSET)
     (CL:NOT (CL:EQ (GET-GENERALIZED-SYMBOL-FROM-OFFSET SYMBOLARRAY OFFSET) NULL)))
    (CL:SETQ SYMBOL (GET-GENERALIZED-SYMBOL-FROM-OFFSET SYMBOLARRAY OFFSET))
    (CL:WARN "intern-bootstrap-symbol-at: `~A' is already interned at offset `~A'" SYMBOL OFFSET)
    (CL:RETURN-FROM INTERN-BOOTSTRAP-SYMBOL-AT SYMBOL))
   (CL:LET* ((ARRAY (SELECT-SYMBOL-ARRAY KINDOFSYM)))
    (CL:RETURN-FROM INTERN-BOOTSTRAP-SYMBOL-AT (HELP-INTERN-GENERALIZED-SYMBOL NAME KINDOFSYM ARRAY OFFSET *MODULE*)))))
...
(CL:DEFUN INITIALIZE-KERNEL-MODULE (MODULE NAME FULLNAME PARENT)
  ...
  (CL:WHEN (CL:NOT (CL:EQ PARENT NULL)) (INSERT (%CHILD-CONTEXTS PARENT) MODULE)
...
(CL:DEFUN INITIALIZE-KERNEL-MODULES ()
  ...
  (SET-DYNAMIC-SLOT-VALUE (%DYNAMIC-SLOTS *COMMON-LISP-MODULE*) SYM-SYMBOLS-STELLA-MODULE-LISP-PACKAGE
   (WRAP-STRING "CL") NULL-STRING-WRAPPER)
...
(CL:DEFUN LOOKUP-TRANSIENT-SYMBOL (NAME)
  ...
  (CL:IF (CL:NOT (CL:EQ *TRANSIENT-SYMBOL-LOOKUP-TABLE* NULL))
   (CL:RETURN-FROM LOOKUP-TRANSIENT-SYMBOL (LOOKUP *TRANSIENT-SYMBOL-LOOKUP-TABLE* NAME))
   (CL:PROGN
...
(CL:DEFUN INTERN-TRANSIENT-SYMBOL (NAME)
  ...
  (CL:LET* ((SYMBOL (LOOKUP-SYMBOL-IN-MODULE NAME *MODULE* CL:NIL)))
   (CL:WHEN (CL:NOT (CL:EQ SYMBOL NULL)) (CL:RETURN-FROM INTERN-TRANSIENT-SYMBOL SYMBOL))
   (CL:SETQ SYMBOL (LOOKUP-TRANSIENT-SYMBOL NAME))
   (CL:WHEN (CL:NOT (CL:EQ SYMBOL NULL)) (CL:RETURN-FROM INTERN-TRANSIENT-SYMBOL SYMBOL))
   (CL:SETQ SYMBOL (NEW-TRANSIENT-SYMBOL NAME)) (CL:SETF (%HOME-CONTEXT SYMBOL) NULL)
   (INSERT-AT *TRANSIENT-SYMBOL-LOOKUP-TABLE* NAME SYMBOL) (CL:RETURN-FROM INTERN-TRANSIENT-SYMBOL SYMBOL)))
...
(CL:DEFUN INTERN-COMMON-LISP-SYMBOL (NAME)
  ...
  (CL:LET* ((SYMBOL (LOOKUP-RIGID-SYMBOL-WRT-MODULE NAME *COMMON-LISP-MODULE* SYMBOL-SYM)))
   ...
   (CL:WHEN (CL:NOT (CL:EQ SYMBOL NULL)) (CL:RETURN-FROM INTERN-COMMON-LISP-SYMBOL SYMBOL))
   (CL:SETQ SYMBOL (INTERN-RIGID-SYMBOL-WRT-MODULE NAME *COMMON-LISP-MODULE* SYMBOL-SYM))
...
(CL:DEFUN YIELD-GENSYM-NAME (PREFIX COUNTER)
  ...
  (CL:LET*
   ((SUFFIX (INTEGER-TO-STRING (CL:TRUNCATE COUNTER))) (MASKEND (CL:- 4 (CL:THE CL:FIXNUM (CL:LENGTH SUFFIX)))))
   (CL:DECLARE (CL:TYPE CL:SIMPLE-STRING SUFFIX) (CL:TYPE CL:FIXNUM MASKEND))
...
(CL:DEFUN YIELD-UNIQUE-GENSYM-NAME (PREFIX MODULE)
  ...
  #+MCL
  (CL:CHECK-TYPE PREFIX CL:SIMPLE-STRING)
  (CL:LET* ((GENSYM-NAME (YIELD-GENSYM-NAME PREFIX (CL:SETQ *GENSYM-COUNTER* (CL:1+ *GENSYM-COUNTER*)))))
...
a new local surrogate is created that shadows the inherited surrogate."
  ...
  (CL:LET* ((SURROGATE (INTERN-SURROGATE-IN-MODULE SELF *MODULE* CL:NIL)))
   (CL:WHEN (CL:OR (CL:EQ (%HOME-CONTEXT SURROGATE) *MODULE*) (CL:NOT (CL:EQ (%SURROGATE-VALUE SURROGATE) NULL)))
...
(%%DEFCONSMETHOD SURROGATIFY ((SELF OBJECT))
  (CL:LET* ((STREAM-000 (NEW-OUTPUT-STRING-STREAM)))
   (%%PRINT-STREAM (%NATIVE-STREAM STREAM-000) "Don't know how to 'surrogatify' `" SELF "'")
   (CL:ERROR (NEW-STELLA-EXCEPTION (THE-STRING-READER STREAM-000)))))
...
(CL:DEFUN IN-PLACE-OBJECTS-TO-SYMBOLS (CONSLIST)
  (CL:LET* ((CURSOR CONSLIST))
   (CL:LOOP WHILE (CL:NOT (CL:EQ CURSOR NIL)) DO (CL:SETF (%%VALUE CURSOR) (PERMANENTIFY (%%VALUE CURSOR)))
...
(CL:DEFUN IN-PLACE-OBJECTS-TO-TYPES (CONSLIST)
  (CL:LET* ((CURSOR CONSLIST))
   (CL:LOOP WHILE (CL:NOT (CL:EQ CURSOR NIL)) DO (CL:SETF (%%VALUE CURSOR) (TYPIFY (%%VALUE CURSOR)))
    (CL:SETQ CURSOR (%%REST CURSOR))))
  :VOID)
   ...
   (CL:LET* ((BARENAME STELLA::NULL-STRING) (MODULENAME STELLA::NULL-STRING) (KIND NULL))
    ...
    (CL:COND
     ((CL:EQ KIND KWD-SYMBOLS-SYMBOL)
      (CL:IF (CL:AND *TRANSIENTOBJECTS?* (CL:EQ MODULENAME STELLA::NULL-STRING))
       (CL:RETURN-FROM INTERN-STELLA-NAME (INTERN-TRANSIENT-SYMBOL BARENAME))
       (CL:RETURN-FROM INTERN-STELLA-NAME (INTERN-SYMBOL-IN-MODULE BARENAME MODULE CL:NIL))))
     ((CL:EQ KIND KWD-SYMBOLS-SURROGATE)
      (CL:RETURN-FROM INTERN-STELLA-NAME (INTERN-SURROGATE-IN-MODULE BARENAME MODULE CL:NIL)))
     ((CL:EQ KIND KWD-SYMBOLS-KEYWORD)
      (CL:RETURN-FROM INTERN-STELLA-NAME (INTERN-RIGID-SYMBOL-WRT-MODULE BARENAME NULL KEYWORD-SYM)))
     (CL:T
      (CL:LET* ((STREAM-000 (NEW-OUTPUT-STRING-STREAM)))
   ...
   ((STRING-EQL? NAME "")
    (CL:LET* ((PATHNAME "")) (CL:DECLARE (CL:TYPE CL:SIMPLE-STRING PATHNAME))
     (CL:LOOP WHILE (CL:NOT (CL:EQ MODULE NULL)) DO
      (CL:SETQ PATHNAME (CONCATENATE MODULE-SEPARATOR-STRING (%MODULE-NAME MODULE) PATHNAME))
...
(CL:DEFMETHOD LOCAL-PRINT-NAME ((SELF GENERALIZED-SYMBOL) READABLE?)
  (CL:IF READABLE?
   (CL:RETURN-FROM LOCAL-PRINT-NAME (READABLE-SYMBOL-NAME (%SYMBOL-NAME SELF) (%CASE-SENSITIVE? *MODULE*)))
...
(CL:DEFMETHOD LOCAL-PRINT-NAME ((SELF SURROGATE) READABLE?)
  (CL:LET*
   ((LOCAL-NAME
     (CL:IF READABLE? (READABLE-SYMBOL-NAME (%SYMBOL-NAME SELF) (%CASE-SENSITIVE? *MODULE*)) (%SYMBOL-NAME SELF))))
...
(CL:DEFMETHOD RELATIVE-NAME ((SELF GENERALIZED-SYMBOL) READABLE?)
  (CL:LET* ((STRING STELLA::NULL-STRING)) (CL:DECLARE (CL:TYPE CL:SIMPLE-STRING STRING))
   ...
   (CL:WHEN (CL:= (%SYMBOL-ID SELF) -1) (CL:SETQ STRING (CONCATENATE "<<UNINTERNED>>/" STRING)))
   ...
   (CL:LET* ((TEST-VALUE-000 (SAFE-PRIMARY-TYPE SELF)))
    (CL:COND
     ((SUBTYPE-OF-SYMBOL? TEST-VALUE-000)
      (CL:PROGN (CL:SETQ VISIBLE? (CL:EQ SELF (LOOKUP-SYMBOL-IN-MODULE (%SYMBOL-NAME SELF) *MODULE* CL:NIL)))))
     ((SUBTYPE-OF-SURROGATE? TEST-VALUE-000)
      (CL:PROGN (CL:SETQ VISIBLE? (CL:EQ SELF (LOOKUP-SURROGATE-IN-MODULE (%SYMBOL-NAME SELF) *MODULE* CL:NIL)))))
     (CL:T
      (CL:LET* ((STREAM-000 (NEW-OUTPUT-STRING-STREAM)))
...
(CL:DEFUN SYMBOL-VALUE-SETTER (SYMBOL VALUE)
  (CL:LET* ((VPLIST (%SYMBOL-VALUE-AND-PLIST SYMBOL)))
   (CL:WHEN (CL:EQ VPLIST NIL) (CL:SETQ VPLIST (CONS NULL NIL)) (CL:SETF (%SYMBOL-VALUE-AND-PLIST SYMBOL) VPLIST))
...
Symbol properties can be set with `setf'."
  (CL:LET* ((PLIST (%%REST (%SYMBOL-VALUE-AND-PLIST SYMBOL))))
   (CL:LOOP WHILE (CL:NOT (CL:EQ PLIST NIL)) DO
    (CL:WHEN (CL:EQ (%%VALUE PLIST) KEY) (CL:RETURN-FROM SYMBOL-PROPERTY (%%VALUE (%%REST PLIST))))
    ...
    (CL:WHEN (CL:EQ (%%VALUE PLIST) KEY)
     (CL:COND ((CL:NOT (CL:EQ VALUE NULL)) (CL:SETF (%%VALUE (%%REST PLIST)) VALUE))
      ((CL:NOT (CL:EQ (%%REST (%%REST PLIST)) NIL))
       (CL:LET* ((RESTPLIST (%%REST PLIST))) (CL:SETF (%%VALUE PLIST) (%%VALUE (%%REST RESTPLIST)))
...
(CL:DEFUN SYMBOL-CONSTITUENT-CHARACTER? (CHARACTER)
  (CL:LET* ((TEST-VALUE-000 (CL:AREF *CHARACTER-TYPE-TABLE* (CL:THE CL:FIXNUM (CL:CHAR-CODE CHARACTER)))))
   (CL:COND
    ((CL:OR (CL:EQ TEST-VALUE-000 KWD-SYMBOLS-LETTER) (CL:EQ TEST-VALUE-000 KWD-SYMBOLS-DIGIT)
...
(CL:DEFUN INITIALIZE-SYMBOL-ESCAPE-CODE-TABLE (CASESENSITIVE?)
  (CL:LET* ((BUFFER (CL:THE CL:SIMPLE-STRING (CL:MAKE-STRING 256 :INITIAL-ELEMENT NULL-CHARACTER))))
   ...
   (CL:LET* ((I NULL-INTEGER) (ITER-000 0) (UPPER-BOUND-000 255))
    ...
    (CL:LOOP WHILE (CL:<= ITER-000 UPPER-BOUND-000) DO (CL:SETQ I ITER-000)
     ...
     (CL:SETQ ITER-000 (CL:1+ ITER-000))))
   (CL:LET*
    ((CH NULL-CHARACTER) (VECTOR-000 ".+-") (INDEX-000 0) (LENGTH-000 (CL:THE CL:FIXNUM (CL:LENGTH VECTOR-000))))
...
(CL:DEFUN COMPUTE-SYMBOL-ESCAPE-CODE (NAME CASESENSITIVE?)
  ...
  (CL:CHECK-TYPE NAME CL:SIMPLE-STRING)
  (CL:LET*
   ((TABLE (CL:IF CASESENSITIVE? *CASE-SENSITIVE-SYMBOL-ESCAPE-CODE-TABLE* *SYMBOL-ESCAPE-CODE-TABLE*)) (ESCAPECODE 0)
    (MAXESCAPECODE 0) (FIRSTCHAR? CL:T) (COULDBENUMBER? CL:T))
   (CL:DECLARE (CL:TYPE CL:SIMPLE-STRING TABLE) (CL:TYPE CL:FIXNUM ESCAPECODE MAXESCAPECODE))
   (CL:LET*
    ((CH NULL-CHARACTER) (VECTOR-000 NAME) (INDEX-000 0) (LENGTH-000 (CL:THE CL:FIXNUM (CL:LENGTH VECTOR-000))))
    (CL:DECLARE (CL:TYPE CL:SIMPLE-STRING VECTOR-000) (CL:TYPE CL:FIXNUM INDEX-000 LENGTH-000))
    (CL:LOOP WHILE (CL:< INDEX-000 LENGTH-000) DO
     (CL:SETQ CH
      (CL:LET ((SELF VECTOR-000) (POSITION INDEX-000))
     ...
     (CL:SETQ ESCAPECODE
      (CL:THE CL:FIXNUM
       (CL:CHAR-CODE
        (CL:LET ((SELF TABLE) (POSITION (CL:THE CL:FIXNUM (CL:CHAR-CODE CH))))
         (CL:DECLARE (CL:TYPE CL:SIMPLE-STRING SELF) (CL:TYPE CL:FIXNUM POSITION))
         (CL:SCHAR (CL:THE CL:SIMPLE-STRING SELF) (CL:THE CL:FIXNUM POSITION))))))
     (CL:COND
      ((CL:= ESCAPECODE 0)
       (CL:WHEN (CL:AND COULDBENUMBER? (CL:NOT (CL:EQL CH #\E)) (CL:NOT (CL:EQL CH #\e)))
   ...
   (CL:IF FIRSTCHAR? (CL:RETURN-FROM COMPUTE-SYMBOL-ESCAPE-CODE KWD-SYMBOLS-ESCAPED)
    (CL:ECASE MAXESCAPECODE (0 (CL:RETURN-FROM COMPUTE-SYMBOL-ESCAPE-CODE KWD-SYMBOLS-UNESCAPED))
     (1
      (CL:WHEN COULDBENUMBER?
       (CL:LET*
        ((TOK_TABLE_ *STELLA-TOKENIZER-TABLE*) (TOK_TRANSITIONS_ (%TRANSITIONS TOK_TABLE_))
         ...
         (TOK_NEXTSTATE_ TOK_STATE_) (TOK_CURSOR_ 0) (TOK_SIZE_ (CL:THE CL:FIXNUM (CL:LENGTH NAME)))
         (TOK_END_ TOK_SIZE_))
      ...
      (CL:IF COULDBENUMBER? (CL:RETURN-FROM COMPUTE-SYMBOL-ESCAPE-CODE KWD-SYMBOLS-ESCAPED)
       (CL:RETURN-FROM COMPUTE-SYMBOL-ESCAPE-CODE KWD-SYMBOLS-UNESCAPED)))
     (2
      (CL:IF
       (CL:AND
        (CL:EQL
...
(CL:DEFUN PRINT-SYMBOL-NAME-READABLY (NAME STREAM CASESENSITIVE?)
  ...
  (CL:LET* ((TEST-VALUE-000 (COMPUTE-SYMBOL-ESCAPE-CODE NAME CASESENSITIVE?)))
   (CL:COND ((CL:EQ TEST-VALUE-000 KWD-SYMBOLS-UNESCAPED) (%%PRINT-STREAM STREAM NAME))
    ((CL:EQ TEST-VALUE-000 KWD-SYMBOLS-ESCAPED) (%%PRINT-STREAM STREAM "|" NAME "|"))
      ...
      (CL:LOOP WHILE (CL:< INDEX-000 LENGTH-000) DO
       (CL:SETQ CH
        (CL:LET ((SELF VECTOR-000) (POSITION INDEX-000))
         (CL:DECLARE (CL:TYPE CL:SIMPLE-STRING SELF) (CL:TYPE CL:FIXNUM POSITION))
         (CL:SCHAR (CL:THE CL:SIMPLE-STRING SELF) (CL:THE CL:FIXNUM POSITION))))
       (CL:WHEN (CL:OR (CL:EQL CH #\\) (CL:EQL CH #\|)) (%%PRINT-STREAM STREAM "\\")) (%%PRINT-STREAM STREAM CH)
       (CL:SETQ INDEX-000 (CL:1+ INDEX-000))))
     (%%PRINT-STREAM STREAM "|"))
    (CL:T
     (CL:LET* ((STREAM-000 (NEW-OUTPUT-STRING-STREAM)))
...
(CL:DEFUN PRINT-SYMBOL (SELF STREAM)
  (CL:LET*
   ((VISIBLE? (CL:EQ SELF (LOOKUP-SYMBOL-IN-MODULE (%SYMBOL-NAME SELF) *MODULE* CL:NIL)))
    (MODULE (%HOME-CONTEXT SELF)))
   (CL:WHEN (CL:NOT VISIBLE?)
    (CL:IF (CL:= (%SYMBOL-ID SELF) -1) (%%PRINT-STREAM STREAM "<<UNINTERNED>>/")
     (CL:WHEN (CL:NOT (CL:EQ MODULE NULL))
      (CL:IF (CL:AND *PRINTREADABLY?* (CL:EQ MODULE *COMMON-LISP-MODULE*))
       (CL:PROGN (%%PRINT-STREAM STREAM "CL:" (%SYMBOL-NAME SELF)) (CL:RETURN-FROM PRINT-SYMBOL))
       (%%PRINT-STREAM STREAM (%MODULE-FULL-NAME MODULE) "/")))))
   (CL:IF *PRINTREADABLY?* (PRINT-SYMBOL-NAME-READABLY (%SYMBOL-NAME SELF) STREAM (%CASE-SENSITIVE? *MODULE*))
...
(CL:DEFUN PRINT-SURROGATE (SELF STREAM)
  (CL:LET*
   ((VISIBLE? (CL:EQ SELF (LOOKUP-SURROGATE-IN-MODULE (%SYMBOL-NAME SELF) *MODULE* CL:NIL)))
    (MODULE (%HOME-CONTEXT SELF)))
   (CL:WHEN (CL:NOT VISIBLE?)
    (CL:IF (CL:OR (CL:= (%SYMBOL-ID SELF) -1) (CL:EQ MODULE NULL)) (%%PRINT-STREAM STREAM "<<UNINTERNED>>/")
     (%%PRINT-STREAM STREAM (%MODULE-FULL-NAME MODULE) "/")))
   (%%PRINT-STREAM STREAM "@")
   (CL:IF *PRINTREADABLY?* (PRINT-SYMBOL-NAME-READABLY (%SYMBOL-NAME SELF) STREAM (%CASE-SENSITIVE? *MODULE*))
    (%%PRINT-STREAM STREAM (%SYMBOL-NAME SELF))))
...
(CL:DEFUN PRINT-KEYWORD (SELF STREAM)
  (%%PRINT-STREAM STREAM ":")
  (CL:IF *PRINTREADABLY?* (PRINT-SYMBOL-NAME-READABLY (%SYMBOL-NAME SELF) STREAM CL:NIL)
   (%%PRINT-STREAM STREAM (%SYMBOL-NAME SELF)))
  :VOID)

(CL:DEFUN HELP-STARTUP-SYMBOLS1 ()
  (CL:PROGN
   (CL:SETQ SYM-SYMBOLS-STELLA-MODULE-LISP-PACKAGE (INTERN-RIGID-SYMBOL-WRT-MODULE "MODULE-LISP-PACKAGE" NULL 0))
   ...
   (CL:SETQ KWD-SYMBOLS-SYMBOL (INTERN-RIGID-SYMBOL-WRT-MODULE "SYMBOL" NULL 2))
   (CL:SETQ KWD-SYMBOLS-SURROGATE (INTERN-RIGID-SYMBOL-WRT-MODULE "SURROGATE" NULL 2))
   (CL:SETQ KWD-SYMBOLS-KEYWORD (INTERN-RIGID-SYMBOL-WRT-MODULE "KEYWORD" NULL 2))
   (CL:SETQ KWD-SYMBOLS-LETTER (INTERN-RIGID-SYMBOL-WRT-MODULE "LETTER" NULL 2))
   ...
   (CL:SETQ KWD-SYMBOLS-ESCAPED (INTERN-RIGID-SYMBOL-WRT-MODULE "ESCAPED" NULL 2))
   (CL:SETQ KWD-SYMBOLS-UNESCAPED (INTERN-RIGID-SYMBOL-WRT-MODULE "UNESCAPED" NULL 2))
...
(CL:DEFUN HELP-STARTUP-SYMBOLS2 ()
  (CL:PROGN
   (DEFINE-FUNCTION-OBJECT "NEXT-FREE-OFFSET" "(DEFUN (NEXT-FREE-OFFSET INTEGER) ((SELF EXTENSIBLE-SYMBOL-ARRAY)))"
    (CL:FUNCTION NEXT-FREE-OFFSET) NULL)
   (DEFINE-FUNCTION-OBJECT "FREE-SYMBOL-OFFSET"
    "(DEFUN FREE-SYMBOL-OFFSET ((SELF EXTENSIBLE-SYMBOL-ARRAY) (OFFSET INTEGER)))" (CL:FUNCTION FREE-SYMBOL-OFFSET)
    NULL)
   ...
   (DEFINE-FUNCTION-OBJECT "GET-SYM" "(DEFUN (GET-SYM SYMBOL) ((OFFSET INTEGER)) :CONSTRUCTOR? TRUE)"
    (CL:FUNCTION GET-SYM) NULL)
   (DEFINE-FUNCTION-OBJECT "GET-SGT" "(DEFUN (GET-SGT SURROGATE) ((OFFSET INTEGER)) :CONSTRUCTOR? TRUE)"
    (CL:FUNCTION GET-SGT) NULL)
   (DEFINE-FUNCTION-OBJECT "GET-KWD" "(DEFUN (GET-KWD KEYWORD) ((OFFSET INTEGER)) :CONSTRUCTOR? TRUE)"
   ...
   (DEFINE-FUNCTION-OBJECT "GET-SYM-FROM-OFFSET"
    "(DEFUN (GET-SYM-FROM-OFFSET SYMBOL) ((OFFSET INTEGER)) :CONSTRUCTOR? TRUE)" (CL:FUNCTION GET-SYM-FROM-OFFSET)
    NULL)
   (DEFINE-FUNCTION-OBJECT "GET-SGT-FROM-OFFSET"
    "(DEFUN (GET-SGT-FROM-OFFSET SURROGATE) ((OFFSET INTEGER)) :CONSTRUCTOR? TRUE)" (CL:FUNCTION GET-SGT-FROM-OFFSET)
    NULL)
   (DEFINE-FUNCTION-OBJECT "GET-KWD-FROM-OFFSET"
    "(DEFUN (GET-KWD-FROM-OFFSET KEYWORD) ((OFFSET INTEGER)) :CONSTRUCTOR? TRUE)" (CL:FUNCTION GET-KWD-FROM-OFFSET)
    NULL)
   ...
   (DEFINE-FUNCTION-OBJECT "SELECT-SYMBOL-ARRAY"
    "(DEFUN (SELECT-SYMBOL-ARRAY EXTENSIBLE-SYMBOL-ARRAY) ((KINDOFSYM INTEGER)))" (CL:FUNCTION SELECT-SYMBOL-ARRAY)
    NULL)
...
which got hardwired into translated code will refer to the correct objects.\")"
   ...
   (DEFINE-FUNCTION-OBJECT "INTERN-SYMBOL-AT" "(DEFUN (INTERN-SYMBOL-AT SYMBOL) ((NAME STRING) (OFFSET INTEGER)))"
    (CL:FUNCTION INTERN-SYMBOL-AT) NULL)
   (DEFINE-FUNCTION-OBJECT "INTERN-SURROGATE-AT"
    "(DEFUN (INTERN-SURROGATE-AT SURROGATE) ((NAME STRING) (OFFSET INTEGER)))" (CL:FUNCTION INTERN-SURROGATE-AT) NULL)
   (DEFINE-FUNCTION-OBJECT "INTERN-KEYWORD-AT" "(DEFUN (INTERN-KEYWORD-AT KEYWORD) ((NAME STRING) (OFFSET INTEGER)))"
   ...
   (DEFINE-FUNCTION-OBJECT "INITIALIZE-KERNEL-MODULES" "(DEFUN INITIALIZE-KERNEL-MODULES ())"
    (CL:FUNCTION INITIALIZE-KERNEL-MODULES) NULL)
   (DEFINE-FUNCTION-OBJECT "INITIALIZE-SYMBOLS-AND-KERNEL-MODULES" "(DEFUN INITIALIZE-SYMBOLS-AND-KERNEL-MODULES ())"
    (CL:FUNCTION INITIALIZE-SYMBOLS-AND-KERNEL-MODULES) NULL)
   (DEFINE-FUNCTION-OBJECT "LOOKUP-TRANSIENT-SYMBOL" "(DEFUN (LOOKUP-TRANSIENT-SYMBOL SYMBOL) ((NAME STRING)))"
    (CL:FUNCTION LOOKUP-TRANSIENT-SYMBOL) NULL)
   (DEFINE-FUNCTION-OBJECT "INTERN-TRANSIENT-SYMBOL" "(DEFUN (INTERN-TRANSIENT-SYMBOL SYMBOL) ((NAME STRING)))"
    (CL:FUNCTION INTERN-TRANSIENT-SYMBOL) NULL)
   (DEFINE-FUNCTION-OBJECT "FREE-TRANSIENT-SYMBOLS" "(DEFUN FREE-TRANSIENT-SYMBOLS ())"
    (CL:FUNCTION FREE-TRANSIENT-SYMBOLS) NULL)
   (DEFINE-FUNCTION-OBJECT "INTERN-COMMON-LISP-SYMBOL" "(DEFUN (INTERN-COMMON-LISP-SYMBOL SYMBOL) ((NAME STRING)))"
    (CL:FUNCTION INTERN-COMMON-LISP-SYMBOL) NULL)
   (DEFINE-FUNCTION-OBJECT "SYMBOL-COMMON-LISP?" "(DEFUN (SYMBOL-COMMON-LISP? BOOLEAN) ((SELF SYMBOL)))"
    (CL:FUNCTION SYMBOL-COMMON-LISP?) NULL)
   (DEFINE-FUNCTION-OBJECT "COMMON-LISP-SYMBOL?" "(DEFUN (COMMON-LISP-SYMBOL? BOOLEAN) ((SELF OBJECT)))"
...
Common Lisp symbols while parsing.\")" (CL:FUNCTION INITIALIZE-PARSING-TABLES) NULL)
   (DEFINE-FUNCTION-OBJECT "YIELD-GENSYM-NAME" "(DEFUN (YIELD-GENSYM-NAME STRING) ((PREFIX STRING) (COUNTER INTEGER)))"
...
`prefix' and ending with a globally gensym'd integer.\" :PUBLIC? TRUE)" (CL:FUNCTION GENSYM) NULL)
   (DEFINE-FUNCTION-OBJECT "SURROGATE-TO-SYMBOL"
    "(DEFUN (SURROGATE-TO-SYMBOL SYMBOL) ((SELF SURROGATE)) :PUBLIC? TRUE)" (CL:FUNCTION SURROGATE-TO-SYMBOL) NULL)
...
as `symbol-to-surrogate' which see).\")" (CL:FUNCTION SURROGATIFY) NULL)
   (DEFINE-METHOD-OBJECT
    ...
    (CL:FUNCTION SURROGATIFY) NULL)
   (DEFINE-METHOD-OBJECT "(DEFMETHOD (SURROGATIFY SURROGATE) ((SELF OBJECT)) :PUBLIC? TRUE)" (CL:FUNCTION SURROGATIFY)
    NULL)
   (DEFINE-FUNCTION-OBJECT "TYPIFY" "(DEFUN (TYPIFY TYPE) ((SELF OBJECT)) :PUBLIC? TRUE)" (CL:FUNCTION TYPIFY) NULL)
   (DEFINE-METHOD-OBJECT "(DEFMETHOD (KEYWORDIFY KEYWORD) ((SELF KEYWORD)) :PUBLIC? TRUE)" (CL:FUNCTION KEYWORDIFY)
    NULL)
   (DEFINE-METHOD-OBJECT "(DEFMETHOD (KEYWORDIFY KEYWORD) ((SELF GENERALIZED-SYMBOL)) :PUBLIC? TRUE)"
    (CL:FUNCTION KEYWORDIFY) NULL)
   (DEFINE-METHOD-OBJECT "(DEFMETHOD (KEYWORDIFY KEYWORD) ((SELF STRING-WRAPPER)) :PUBLIC? TRUE)"
    (CL:FUNCTION KEYWORDIFY) NULL)
   (DEFINE-METHOD-OBJECT "(DEFMETHOD (KEYWORDIFY KEYWORD) ((SELF STRING)) :PUBLIC? TRUE)" (CL:FUNCTION KEYWORDIFY)
    NULL)
   (DEFINE-FUNCTION-OBJECT "IN-PLACE-OBJECTS-TO-SYMBOLS" "(DEFUN IN-PLACE-OBJECTS-TO-SYMBOLS ((CONSLIST CONS)))"
    (CL:FUNCTION IN-PLACE-OBJECTS-TO-SYMBOLS) NULL)
   (DEFINE-FUNCTION-OBJECT "IN-PLACE-OBJECTS-TO-TYPES" "(DEFUN IN-PLACE-OBJECTS-TO-TYPES ((CONSLIST CONS)))"
...
times faster.\" :PUBLIC? TRUE)" (CL:FUNCTION INTERN-STELLA-NAME) NULL)
   (DEFINE-FUNCTION-OBJECT "COMPUTE-FULL-NAME"
    "(DEFUN (COMPUTE-FULL-NAME STRING) ((NAME STRING) (MODULE MODULE)) :PUBLIC? TRUE)" (CL:FUNCTION COMPUTE-FULL-NAME)
    NULL)
   (DEFINE-METHOD-OBJECT "(DEFMETHOD (LOCAL-PRINT-NAME STRING) ((SELF GENERALIZED-SYMBOL) (READABLE? BOOLEAN)))"
    (CL:FUNCTION LOCAL-PRINT-NAME) NULL)
   (DEFINE-METHOD-OBJECT "(DEFMETHOD (LOCAL-PRINT-NAME STRING) ((SELF SURROGATE) (READABLE? BOOLEAN)))"
    (CL:FUNCTION LOCAL-PRINT-NAME) NULL)
   (DEFINE-METHOD-OBJECT "(DEFMETHOD (RELATIVE-NAME STRING) ((SELF GENERALIZED-SYMBOL) (READABLE? BOOLEAN)))"
...
in constant time.  The `symbol-value' of a symbol can be changed with `setf'.\" :PUBLIC? TRUE :GLOBALLY-INLINE? TRUE (RETURN (VALUE (SYMBOL-VALUE-AND-PLIST SYMBOL))))"
   ...
   (DEFINE-FUNCTION-OBJECT "SYMBOL-VALUE-SETTER"
    "(DEFUN (SYMBOL-VALUE-SETTER OBJECT) ((SYMBOL SYMBOL) (VALUE OBJECT)))" (CL:FUNCTION SYMBOL-VALUE-SETTER) NULL)
...
a modfiable copy, e.g., by using `bquote'.\" :PUBLIC? TRUE :GLOBALLY-INLINE? TRUE (RETURN (REST (SYMBOL-VALUE-AND-PLIST SYMBOL))))"
   ...
   (DEFINE-FUNCTION-OBJECT "SYMBOL-PLIST-SETTER" "(DEFUN (SYMBOL-PLIST-SETTER CONS) ((SYMBOL SYMBOL) (PLIST CONS)))"
...
Symbol properties can be set with `setf'.\")" (CL:FUNCTION SYMBOL-PROPERTY) NULL)
   ...
   (DEFINE-FUNCTION-OBJECT "PRINT-SYMBOL" "(DEFUN PRINT-SYMBOL ((SELF SYMBOL) (STREAM NATIVE-OUTPUT-STREAM)))"
    (CL:FUNCTION PRINT-SYMBOL) NULL)
   (DEFINE-FUNCTION-OBJECT "PRINT-SURROGATE" "(DEFUN PRINT-SURROGATE ((SELF SURROGATE) (STREAM NATIVE-OUTPUT-STREAM)))"
    (CL:FUNCTION PRINT-SURROGATE) NULL)
   (DEFINE-FUNCTION-OBJECT "PRINT-KEYWORD" "(DEFUN PRINT-KEYWORD ((SELF KEYWORD) (STREAM NATIVE-OUTPUT-STREAM)))"
    (CL:FUNCTION PRINT-KEYWORD) NULL)
   (DEFINE-FUNCTION-OBJECT "STARTUP-SYMBOLS" "(DEFUN STARTUP-SYMBOLS () :PUBLIC? TRUE)" (CL:FUNCTION STARTUP-SYMBOLS)
    NULL)
   (CL:LET* ((FUNCTION (LOOKUP-FUNCTION SYM-SYMBOLS-STELLA-STARTUP-SYMBOLS)))
    (SET-DYNAMIC-SLOT-VALUE (%DYNAMIC-SLOTS FUNCTION) SYM-SYMBOLS-STELLA-METHOD-STARTUP-CLASSNAME
     (WRAP-STRING "_StartupSymbols") NULL-STRING-WRAPPER)))
  :VOID)

(CL:DEFUN STARTUP-SYMBOLS ()
  (CL:WHEN (CURRENT-STARTUP-TIME-PHASE? 0)
   (CL:WHEN (CL:EQ *FIXED-SYMBOL-ARRAY* NULL) (INITIALIZE-SYMBOLS-AND-KERNEL-MODULES)) (INITIALIZE-PARSING-TABLES))
  (CL:LET* ((*MODULE* *STELLA-MODULE*) (*CONTEXT* *MODULE*)) (CL:DECLARE (CL:SPECIAL *MODULE* *CONTEXT*))
   ...
   (CL:WHEN (CURRENT-STARTUP-TIME-PHASE? 4)
    (SET-DYNAMIC-SLOT-VALUE (%DYNAMIC-SLOTS *STELLA-MODULE*) SYM-SYMBOLS-STELLA-JAVA-PACKAGE
     (WRAP-STRING "edu.isi.stella") NULL-STRING-WRAPPER)
    (SET-DYNAMIC-SLOT-VALUE (%DYNAMIC-SLOTS *STELLA-MODULE*) SYM-SYMBOLS-STELLA-MODULE-LISP-PACKAGE
     (WRAP-STRING "STELLA") NULL-STRING-WRAPPER)
    (SET-DYNAMIC-SLOT-VALUE (%DYNAMIC-SLOTS *STELLA-MODULE*) SYM-SYMBOLS-STELLA-MODULE-CPP-PACKAGE
     (WRAP-STRING "stella") NULL-STRING-WRAPPER)
    ...
    (SET-DYNAMIC-SLOT-VALUE (%DYNAMIC-SLOTS *COMMON-LISP-MODULE*) SYM-SYMBOLS-STELLA-CODE-ONLY? TRUE-WRAPPER
     FALSE-WRAPPER)
   ...
   (CL:WHEN (CURRENT-STARTUP-TIME-PHASE? 7) (HELP-STARTUP-SYMBOLS2) (HELP-STARTUP-SYMBOLS3))
