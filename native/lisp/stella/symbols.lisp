...
(CL:DECLAIM
  ...
  *STELLA-LOGICAL-STATE-NAMES* NULL-CHARACTER *CHARACTER-TYPE-TABLE*
  NULL-STRING-WRAPPER *TRANSIENTOBJECTS?* FALSE TRUE NIL NULL-INTEGER))
  ...
  (CL:LET* ((TOPOFFSET (%TOP-SYMBOL-OFFSET SELF)) (FREEOFFSET (CL:1+ TOPOFFSET)))
   ...
   (CL:LET*
    ((I NULL-INTEGER) (ITER-000 (%POTENTIAL-FREE-SYMBOL-OFFSET SELF))
     (UPPER-BOUND-000 TOPOFFSET) (UNBOUNDED?-000 (NULL? UPPER-BOUND-000)))
    ...
    (CL:LOOP WHILE (CL:OR UNBOUNDED?-000 (CL:<= ITER-000 UPPER-BOUND-000)) DO
     ...
     (CL:WHEN
      (CL:EQ (CL:AREF (CL:THE CL:SIMPLE-VECTOR (%THE-ARRAY SELF)) I) NULL)
...
(CL:DEFUN GET-SYM (OFFSET)
  ...
  (CL:RETURN-FROM GET-SYM
   (CL:AREF (CL:THE CL:SIMPLE-VECTOR (%THE-ARRAY *FIXED-SYMBOL-ARRAY*)) OFFSET)))
...
(CL:DEFUN GET-SGT (OFFSET)
  ...
  (CL:RETURN-FROM GET-SGT
   (CL:AREF (CL:THE CL:SIMPLE-VECTOR (%THE-ARRAY *FIXED-SURROGATE-ARRAY*))
    OFFSET)))
...
(CL:DEFUN GET-KWD (OFFSET)
  ...
  (CL:RETURN-FROM GET-KWD
   (CL:AREF (CL:THE CL:SIMPLE-VECTOR (%THE-ARRAY *FIXED-KEYWORD-ARRAY*)) OFFSET)))
...
(CL:DEFUN SELECT-SYMBOL-OFFSET-TABLE (MODULE KINDOFSYM)
  ...
  (CL:ECASE KINDOFSYM
   (0 (CL:RETURN-FROM SELECT-SYMBOL-OFFSET-TABLE (%SYMBOL-OFFSET-TABLE MODULE)))
   (1
    (CL:RETURN-FROM SELECT-SYMBOL-OFFSET-TABLE (%SURROGATE-OFFSET-TABLE MODULE)))
...
(CL:DEFUN LOOKUP-RIGID-SYMBOL-LOCALLY (NAME MODULE KINDOFSYM)
  ...
  (CL:LET*
   ...
   (CL:WHEN (DEFINED? OFFSET)
    (CL:ECASE KINDOFSYM
     (0
      (CL:RETURN-FROM LOOKUP-RIGID-SYMBOL-LOCALLY (GET-SYM-FROM-OFFSET OFFSET)))
     (1
      (CL:RETURN-FROM LOOKUP-RIGID-SYMBOL-LOCALLY (GET-SGT-FROM-OFFSET OFFSET)))
     (2
...
(CL:DEFUN YIELD-VISIBLE-RIGID-SYMBOLS-WRT-MODULE (NAME MODULE KINDOFSYM)
  ...
  (CL:LET* ((LISTOFSYMBOLS NIL) (SYMBOL NULL))
   (CL:LET* ((VISIBLEMODULE NULL) (ITER-000 (VISIBLE-MODULES MODULE)))
    (CL:LOOP WHILE (NEXT? ITER-000) DO (CL:SETQ VISIBLEMODULE (%VALUE ITER-000))
     (CL:LET* ()
      (CL:SETQ SYMBOL (LOOKUP-RIGID-SYMBOL-LOCALLY NAME VISIBLEMODULE KINDOFSYM))
    ...
    (CL:LET* ((UNSHADOWEDSYMBOLS NIL))
     (CL:LET* ((SYMBOL NULL) (ITER-001 VISIBLESYMBOLS) (COLLECT-001 NULL))
      (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-001 NIL)) DO
       (CL:PROGN (CL:SETQ SYMBOL (%%VALUE ITER-001))
...
(CL:DEFUN LOOKUP-RIGID-SYMBOL-OFFSET-WRT-MODULE (NAME MODULE KINDOFSYM)
  ...
  (CL:LET*
   ...
   (CL:LET* ((SUPER NULL) (ITER-000 (ADVANCE (VISIBLE-MODULES MODULE) 1)))
...
(CL:DEFUN LOOKUP-RIGID-SYMBOL (NAME KINDOFSYM)
  ...
  (CL:LET* ((MODULE *MODULE*))
   (CL:WHEN (QUALIFIED-NAME? NAME)
    (CL:MULTIPLE-VALUE-SETQ (MODULE NAME) (COMPUTE-MODULE-AND-BARE-NAME NAME)))
...
surrogates that are shadowed due to some :SHADOW declaration."
  ...
  (CL:LET*
   ...
   (CL:IF
    (CL:AND ENFORCESHADOWING? (CL:NOT (CL:EQ (%%REST VISIBLESURROGATES) NIL)))
  ...
  (CL:LET* ((SYMBOL NULL)) (CL:SETQ SYMBOL (LOOKUP-RIGID-SYMBOL NAME KINDOFSYM))
   ...
   (CL:WHEN (CL:AND *TRANSIENTOBJECTS?* (CL:= KINDOFSYM SYMBOL-SYM))
    ...
    (CL:WHEN (CL:NOT (CL:EQ SYMBOL NULL))
     (CL:RETURN-FROM INTERN-RIGID-SYMBOL-CASE-SENSITIVELY SYMBOL)))
   (CL:WHEN TRYUPCASING?
    (CL:SETQ SYMBOL (LOOKUP-RIGID-SYMBOL (STRING-UPCASE NAME) KINDOFSYM))
    (CL:WHEN (CL:NOT (CL:EQ SYMBOL NULL))
     (CL:RETURN-FROM INTERN-RIGID-SYMBOL-CASE-SENSITIVELY SYMBOL)))
   (CL:ECASE KINDOFSYM
    (0
...
(CL:DEFUN INTERN-SYMBOL (NAME)
  ...
  (CL:IF (%CASE-SENSITIVE? *MODULE*)
   (CL:RETURN-FROM INTERN-SYMBOL
    (INTERN-RIGID-SYMBOL-CASE-SENSITIVELY NAME SYMBOL-SYM FALSE))
   (CL:IF *TRANSIENTOBJECTS?*
    (CL:RETURN-FROM INTERN-SYMBOL (INTERN-TRANSIENT-SYMBOL (STRING-UPCASE NAME)))
    (CL:RETURN-FROM INTERN-SYMBOL
    ...
    (CL:WHEN (CL:NOT (CL:EQ *MODULE* NULL))
     (CL:RETURN-FROM INTERN-DERIVED-SYMBOL
      (INTERN-RIGID-SYMBOL-LOCALLY
       (CL:IF (%CASE-SENSITIVE? *MODULE*) NEWNAME (STRING-UPCASE NEWNAME))
       *MODULE* SYMBOL-SYM)))
...
(CL:DEFUN INTERN-SURROGATE (NAME)
  ...
  (CL:IF (%CASE-SENSITIVE? *MODULE*)
   (CL:RETURN-FROM INTERN-SURROGATE
    (INTERN-RIGID-SYMBOL-CASE-SENSITIVELY NAME SURROGATE-SYM FALSE))
   (CL:RETURN-FROM INTERN-SURROGATE
    (INTERN-RIGID-SYMBOL-WRT-MODULE (STRING-UPCASE NAME) *MODULE* SURROGATE-SYM))))
...
`newName' which is interned in the same module as `baseSymbol'."
  ...
  (CL:LET* ((CURRENTMODULE *MODULE*))
   (CL:LET* ((*MODULE* (%HOME-CONTEXT BASESYMBOL)))
    ...
    (CL:SETQ *MODULE* CURRENTMODULE)
    (CL:RETURN-FROM INTERN-DERIVED-SURROGATE (INTERN-SURROGATE NEWNAME)))))
    ...
    (CL:WHEN (CL:NOT (CL:EQ MODULESYMBOL NULL))
     (CL:LET* ((STREAM-001 (NEW-OUTPUT-STRING-STREAM)))
      (%%PRINT-STREAM (%NATIVE-STREAM STREAM-001)
       "Can't import, a symbol with name `" NAME "' already exists in `" MODULE
       "'")
  ...
  (CL:LET*
   ...
   (CL:WHEN (CL:NOT (CL:EQ MODULESURROGATE SURROGATE))
    (CL:WHEN (CL:NOT (CL:EQ MODULESURROGATE NULL))
     (CL:LET* ((STREAM-000 (NEW-OUTPUT-STRING-STREAM)))
      (%%PRINT-STREAM (%NATIVE-STREAM STREAM-000)
       "Can't import, a surrogate with name `" NAME "' already exists in `"
       MODULE "'")
      (CL:ERROR (NEW-STELLA-EXCEPTION (THE-STRING-READER STREAM-000)))))
   ...
   ((SYMBOLARRAY (SELECT-SYMBOL-ARRAY SYMBOL-SYM))
    (OFFSETTABLE
     (CL:IF (CL:NOT (CL:EQ (%HOME-CONTEXT SELF) NULL))
      (SELECT-SYMBOL-OFFSET-TABLE (%HOME-CONTEXT SELF) SYMBOL-SYM) NULL))
...
(CL:DEFUN UNINTERN-SURROGATE (SELF)
  ...
  (CL:LET*
   ((SURROGATEARRAY (SELECT-SYMBOL-ARRAY SURROGATE-SYM))
    (OFFSETTABLE
     (CL:IF (CL:NOT (CL:EQ (%HOME-CONTEXT SELF) NULL))
      (SELECT-SYMBOL-OFFSET-TABLE (%HOME-CONTEXT SELF) SURROGATE-SYM) NULL))
...
which got hardwired into translated code will refer to the correct objects."
  ...
  (CL:LET* ((SYMBOLARRAY NULL) (SYMBOL NULL))
   ...
   (CL:WHEN
    ...
    (CL:WARN
     "intern-bootstrap-symbol-at: `~A' is already interned at offset `~A'" SYMBOL
     OFFSET)
    (CL:RETURN-FROM INTERN-BOOTSTRAP-SYMBOL-AT SYMBOL))
   (CL:LET* ((ARRAY (SELECT-SYMBOL-ARRAY KINDOFSYM)))
...
(CL:DEFUN INITIALIZE-KERNEL-MODULES ()
  ...
  (INITIALIZE-KERNEL-MODULE *COMMON-LISP-MODULE* "COMMON-LISP" "/COMMON-LISP"
   *ROOT-MODULE*)
  (SET-DYNAMIC-SLOT-VALUE (%DYNAMIC-SLOTS *COMMON-LISP-MODULE*)
   SYM-SYMBOLS-STELLA-MODULE-LISP-PACKAGE (WRAP-STRING "CL") NULL-STRING-WRAPPER)
...
(CL:DEFUN INTERN-TRANSIENT-SYMBOL (NAME)
  ...
  #+MCL
  (CL:CHECK-TYPE NAME CL:SIMPLE-STRING)
  (CL:LET* ((SYMBOL (LOOKUP-SYMBOL-IN-MODULE NAME *MODULE* FALSE)))
   (CL:WHEN (CL:NOT (CL:EQ SYMBOL NULL))
...
(CL:DEFUN YIELD-UNIQUE-GENSYM-NAME (PREFIX MODULE)
  ...
  (CL:LET*
   ...
   (CL:LOOP WHILE
    (CL:NOT (CL:EQ (LOOKUP-SYMBOL-IN-MODULE GENSYM-NAME MODULE FALSE) NULL)) DO
    (CL:SETQ GENSYM-NAME
     (YIELD-GENSYM-NAME PREFIX
      (CL:SETQ *GENSYM-COUNTER* (CL:1+ *GENSYM-COUNTER*)))))
...
(CL:DEFUN SURROGATE-TO-SYMBOL (SELF)
  (CL:RETURN-FROM SURROGATE-TO-SYMBOL
   (INTERN-SYMBOL-IN-MODULE (%SYMBOL-NAME SELF) *MODULE* FALSE)))
...
(CL:DEFUN TYPE-TO-SYMBOL (TYPE)
  ...
  (CL:RETURN-FROM TYPE-TO-SYMBOL
   (INTERN-SYMBOL-IN-MODULE (%SYMBOL-NAME TYPE) (%HOME-CONTEXT TYPE) TRUE)))
...
(CL:DEFUN SYMBOLIZE (SURROGATE)
  ...
  (CL:RETURN-FROM SYMBOLIZE
   (INTERN-SYMBOL-IN-MODULE (%SYMBOL-NAME SURROGATE) (%HOME-CONTEXT SURROGATE)
    TRUE)))
...
(CL:DEFUN STRING-TO-SURROGATE (SELF)
  ...
  (CL:LET* ((SURROGATE (INTERN-SURROGATE-IN-MODULE SELF *MODULE* FALSE)))
   (CL:WHEN
   ...
   (CL:RETURN-FROM STRING-TO-SURROGATE
    (INTERN-SURROGATE-IN-MODULE SELF *MODULE* TRUE))))
...
(%%DEFCONSMETHOD SURROGATIFY ((SELF CL:CONS))
  (CL:IF (CL:EQ SELF NIL) (CL:RETURN-FROM SURROGATIFY (INTERN-SURROGATE "NIL"))
   (CL:ERROR (NEW-STELLA-EXCEPTION "Cons passed to 'surrogatify'"))))

;;; (DEFMETHOD (SURROGATIFY SURROGATE) ...)

(CL:DEFMETHOD SURROGATIFY ((SELF OBJECT))
  (CL:ERROR (NEW-STELLA-EXCEPTION "OBJECT passed to 'surrogatify'")))
...
(CL:DEFUN QUALIFIED-NAME? (NAME)
  ...
  (CL:CHECK-TYPE NAME CL:SIMPLE-STRING)
  (CL:COND
   ((CL:= (CL:THE CL:FIXNUM (CL:LENGTH NAME)) 0)
    (CL:RETURN-FROM QUALIFIED-NAME? FALSE))
   ((MEMBER? NAME MODULE-SEPARATOR-CHARACTER)
     ...
     (CL:WHEN
      (CL:AND
       ...
       (CL:EQ
        ...
        KWD-SYMBOLS-DIGIT))
      (CL:RETURN-FROM QUALIFIED-NAME? FALSE))
     (CL:RETURN-FROM QUALIFIED-NAME? TRUE)))
   ((CL:EQL
     (CL:LET ((SELF NAME) (POSITION 0))
      (CL:DECLARE (CL:TYPE CL:SIMPLE-STRING SELF) (CL:TYPE CL:FIXNUM POSITION))
      (CL:SCHAR (CL:THE CL:SIMPLE-STRING SELF) (CL:THE CL:FIXNUM POSITION)))
     #\.)
    (CL:CASE (CL:THE CL:FIXNUM (CL:LENGTH NAME))
     (1 (CL:RETURN-FROM QUALIFIED-NAME? TRUE))
     (2
      (CL:WHEN
       (CL:EQL
        (CL:LET ((SELF NAME) (POSITION 1))
...
(CL:DEFUN INTERN-GENERALIZED-SYMBOL (NAME)
  ...
  (CL:COND
   ((QUALIFIED-NAME? NAME)
    (CL:RETURN-FROM INTERN-GENERALIZED-SYMBOL (INTERN-QUALIFIED-NAME NAME TRUE)))
   ((KEYWORD-NAME? NAME)
...
(CL:DEFMETHOD LOCAL-PRINT-NAME ((SELF SURROGATE))
  (CL:RETURN-FROM LOCAL-PRINT-NAME (CONCATENATE "@" (%SYMBOL-NAME SELF))))
...
(CL:DEFMETHOD RELATIVE-NAME ((SELF GENERALIZED-SYMBOL))
  (CL:LET* ((STRING STELLA::NULL-STRING))
   ...
   (CL:IF (CL:EQ (%HOME-CONTEXT SELF) *MODULE*)
    (CL:SETQ STRING (LOCAL-PRINT-NAME SELF))
    (CL:SETQ STRING
     (COMPUTE-FULL-NAME (LOCAL-PRINT-NAME SELF) (%HOME-CONTEXT SELF))))
...
(CL:DEFUN VISIBLE-SYMBOL? (SELF)
  ...
  (CL:RETURN-FROM VISIBLE-SYMBOL?
   (CL:EQ SELF (LOOKUP-SYMBOL-IN-MODULE (%SYMBOL-NAME SELF) *MODULE* FALSE))))
...
(CL:DEFUN VISIBLE-SURROGATE? (SELF)
  ...
  (CL:RETURN-FROM VISIBLE-SURROGATE?
   (CL:EQ SELF (LOOKUP-SURROGATE-IN-MODULE (%SYMBOL-NAME SELF) *MODULE* FALSE))))

;;; (DEFMETHOD (VISIBLE-NAME STRING) ...)

(CL:DEFMETHOD VISIBLE-NAME ((SELF GENERALIZED-SYMBOL))
  (CL:LET* ((VISIBLE? FALSE))
    ...
    (CL:COND
     ((SUBTYPE-OF-SYMBOL? TEST-VALUE-000)
      (CL:PROGN
       (CL:SETQ VISIBLE?
        (CL:EQ SELF
         (LOOKUP-SYMBOL-IN-MODULE (%SYMBOL-NAME SELF) *MODULE* FALSE)))))
     ...
     (CL:T
      (CL:LET* ((STREAM-000 (NEW-OUTPUT-STRING-STREAM)))
       ...
       (CL:ERROR (NEW-STELLA-EXCEPTION (THE-STRING-READER STREAM-000)))))))
   (CL:IF VISIBLE? (CL:RETURN-FROM VISIBLE-NAME (LOCAL-PRINT-NAME SELF))
...
(CL:DEFUN SYMBOL-PROPERTY-SETTER (SYMBOL VALUE KEY)
  (CL:LET* ((VPLIST (%SYMBOL-VALUE-AND-PLIST SYMBOL)) (PLIST (%%REST VPLIST)))
   (CL:LOOP WHILE (CL:NOT (CL:EQ PLIST NIL)) DO
    (CL:WHEN (CL:EQ (%%VALUE PLIST) KEY)
     (CL:COND
      ((CL:NOT (CL:EQ VALUE NULL)) (CL:SETF (%%VALUE (%%REST PLIST)) VALUE))
...
(CL:DEFUN COMPUTE-SYMBOL-ESCAPE-CODE (NAME CASESENSITIVE?)
  ...
  (CL:LET*
   ((TABLE
    ...
    (ESCAPECODE 0) (MAXESCAPECODE 0) (FIRSTCHAR? TRUE) (COULDBENUMBER? TRUE))
   ...
   (CL:LET*
    ...
    (CL:LOOP WHILE (CL:< INDEX-000 LENGTH-000) DO
     ...
     (CL:COND
      ((CL:= ESCAPECODE 0)
       (CL:WHEN
        (CL:AND COULDBENUMBER? (CL:NOT (CL:EQL CH #\E)) (CL:NOT (CL:EQL CH #\e)))
        (CL:SETQ COULDBENUMBER? FALSE)))
      (FIRSTCHAR? (CL:SETQ MAXESCAPECODE ESCAPECODE)
       (CL:SETQ COULDBENUMBER? (CL:= ESCAPECODE 1)))
      (CL:T
       (CL:WHEN (CL:AND (CL:> ESCAPECODE 1) (CL:> ESCAPECODE MAXESCAPECODE))
        (CL:SETQ MAXESCAPECODE ESCAPECODE))))
     (CL:SETQ FIRSTCHAR? FALSE)))
   (CL:IF FIRSTCHAR?
    (CL:RETURN-FROM COMPUTE-SYMBOL-ESCAPE-CODE KWD-SYMBOLS-ESCAPED)
    (CL:ECASE MAXESCAPECODE
     (0 (CL:RETURN-FROM COMPUTE-SYMBOL-ESCAPE-CODE KWD-SYMBOLS-UNESCAPED))
     (1
      (CL:WHEN COULDBENUMBER?
       (CL:LET*
        ((TOK_TABLE_ *STELLA-TOKENIZER-TABLE*)
         ...
         (TOK_TOKENSTART_ -1) (TOK_ENDOFTOKENS?_ FALSE) (TOK_STREAMSTATE_ NULL)
         (TOK_BUFFER_
        ...
        (CL:LET*
          ...
          (CL:PROGN (CL:SETQ TOK_TOKENSTART_ -1)
           (CL:LOOP
            (CL:WHEN (CL:= TOK_CURSOR_ TOK_END_)
             (CL:COND ((CL:= TOK_NEXTSTATE_ -1) (CL:SETQ TOK_ENDOFTOKENS?_ TRUE))
              ((COERCE-WRAPPED-BOOLEAN-TO-BOOLEAN
               ...
               (CL:WHEN (CL:= TOK_TOKENSTART_ -1)
                (CL:SETQ TOK_ENDOFTOKENS?_ TRUE)))
         ...
         (CL:WHEN (CL:EQ TOK_STELLALOGICALSTATENAME_ KWD-SYMBOLS-SYMBOL)
          (CL:SETQ COULDBENUMBER? FALSE)))))
      (CL:IF COULDBENUMBER?
       (CL:RETURN-FROM COMPUTE-SYMBOL-ESCAPE-CODE KWD-SYMBOLS-ESCAPED)
     ...
     (2
      (CL:IF
       ...
       (CL:RETURN-FROM COMPUTE-SYMBOL-ESCAPE-CODE KWD-SYMBOLS-ESCAPED)))
     (3
      (CL:RETURN-FROM COMPUTE-SYMBOL-ESCAPE-CODE KWD-SYMBOLS-COMPLEX-ESCAPED))))))
...
(CL:DEFUN PRINT-SYMBOL-NAME-READABLY (NAME STREAM CASESENSITIVE?)
  ...
  (CL:LET* ((TEST-VALUE-000 (COMPUTE-SYMBOL-ESCAPE-CODE NAME CASESENSITIVE?)))
   (CL:COND
    ((CL:EQ TEST-VALUE-000 KWD-SYMBOLS-UNESCAPED) (%%PRINT-STREAM STREAM NAME))
...
(CL:DEFUN HELP-STARTUP-SYMBOLS2 ()
  (CL:PROGN
   ...
   (DEFINE-FUNCTION-OBJECT "GET-SYM"
    "(DEFUN (GET-SYM SYMBOL) ((OFFSET INTEGER)))" (CL:FUNCTION GET-SYM) NULL)
   (DEFINE-FUNCTION-OBJECT "GET-SGT"
    "(DEFUN (GET-SGT SURROGATE) ((OFFSET INTEGER)))" (CL:FUNCTION GET-SGT) NULL)
   (DEFINE-FUNCTION-OBJECT "GET-KWD"
    "(DEFUN (GET-KWD KEYWORD) ((OFFSET INTEGER)))" (CL:FUNCTION GET-KWD) NULL)
   ...
   (DEFINE-FUNCTION-OBJECT "LOOKUP-SYMBOL"
    "(DEFUN (LOOKUP-SYMBOL SYMBOL) ((NAME STRING)) :DOCUMENTATION \"Return the first symbol with `name' visible from the current module.\" :PUBLIC? TRUE)"
...
If `local?' only consider symbols directly interned in `module'.
If `module' is `null', use `*MODULE*' instead.\" :PUBLIC? TRUE)"
...
symbols that are shadowed due to some :SHADOW declaration.\" :PUBLIC? TRUE)"
   ...
   (DEFINE-FUNCTION-OBJECT "LOOKUP-SURROGATE"
    "(DEFUN (LOOKUP-SURROGATE SURROGATE) ((NAME STRING)) :DOCUMENTATION \"Return the first surrogate with `name' visible from the current module.\" :PUBLIC? TRUE)"
...
surrogates that are shadowed due to some :SHADOW declaration.\" :PUBLIC? TRUE)"
   ...
   (DEFINE-FUNCTION-OBJECT "LOOKUP-KEYWORD"
    "(DEFUN (LOOKUP-KEYWORD KEYWORD) ((NAME STRING)) :DOCUMENTATION \"Return the keyword with `name' if it exists.\" :PUBLIC? TRUE)"
   ...
   (DEFINE-FUNCTION-OBJECT "INTERN-RIGID-SYMBOL-WRT-MODULE"
    "(DEFUN (INTERN-RIGID-SYMBOL-WRT-MODULE GENERALIZED-SYMBOL) ((NAME STRING) (MODULE MODULE) (KINDOFSYM INTEGER)) :PUBLIC? TRUE :DOCUMENTATION \"Return a newly-created or existing rigid symbol with
name `name'.\")" (CL:FUNCTION INTERN-RIGID-SYMBOL-WRT-MODULE) NULL)
   (DEFINE-FUNCTION-OBJECT "INTERN-RIGID-SYMBOL-LOCALLY"
    "(DEFUN (INTERN-RIGID-SYMBOL-LOCALLY GENERALIZED-SYMBOL) ((NAME STRING) (MODULE MODULE) (KINDOFSYM INTEGER)) :PUBLIC? TRUE :DOCUMENTATION \"Return a newly-created or existing rigid symbol
interned into the module `module' with name `name'.\")"
    (CL:FUNCTION INTERN-RIGID-SYMBOL-LOCALLY) NULL)
   (DEFINE-FUNCTION-OBJECT "INTERN-RIGID-SYMBOL-CASE-SENSITIVELY"
    "(DEFUN (INTERN-RIGID-SYMBOL-CASE-SENSITIVELY GENERALIZED-SYMBOL) ((NAME STRING) (KINDOFSYM INTEGER) (TRYUPCASING? BOOLEAN)) :PUBLIC? TRUE)"
    (CL:FUNCTION INTERN-RIGID-SYMBOL-CASE-SENSITIVELY) NULL)
   (DEFINE-FUNCTION-OBJECT "INTERN-PERMANENT-SYMBOL"
    "(DEFUN (INTERN-PERMANENT-SYMBOL SYMBOL) ((NAME STRING)) :PUBLIC? TRUE :DOCUMENTATION \"Return a newly-created or existing permanent symbol with
name `name'.\")" (CL:FUNCTION INTERN-PERMANENT-SYMBOL) NULL)
   (DEFINE-FUNCTION-OBJECT "INTERN-SYMBOL"
    "(DEFUN (INTERN-SYMBOL SYMBOL) ((NAME STRING)) :DOCUMENTATION \"Return a newly-created or existing symbol with name `name'.\" :PUBLIC? TRUE)"
...
not consider inherited modules).  If none exists, intern it locally in
`module'.  Return the existing or newly-created symbol.\" :PUBLIC? TRUE)"
    (CL:FUNCTION INTERN-SYMBOL-IN-MODULE) NULL)
   (DEFINE-FUNCTION-OBJECT "INTERN-DERIVED-SYMBOL"
    "(DEFUN (INTERN-DERIVED-SYMBOL SYMBOL) ((BASESYMBOL GENERALIZED-SYMBOL) (NEWNAME STRING)) :PUBLIC? TRUE :DOCUMENTATION \"Return a newly-created or existing symbol with name
`newName' which is interned in the same module as `baseSymbol'.\")"
    (CL:FUNCTION INTERN-DERIVED-SYMBOL) NULL)
   (DEFINE-FUNCTION-OBJECT "INTERN-SURROGATE"
    "(DEFUN (INTERN-SURROGATE SURROGATE) ((NAME STRING)) :DOCUMENTATION \"Return a newly-created or existing surrogate with name `name'.\" :PUBLIC? TRUE)"
...
which got hardwired into translated code will refer to the correct objects.\")"
   ...
   (DEFINE-FUNCTION-OBJECT "FREE-TRANSIENT-SYMBOLS"
    "(DEFUN FREE-TRANSIENT-SYMBOLS ())" (CL:FUNCTION FREE-TRANSIENT-SYMBOLS)
    NULL)
...
Common Lisp symbols while parsing.\")" (CL:FUNCTION INITIALIZE-PARSING-TABLES)
    NULL)
...
`prefix' and ending with a globally gensym'd integer.\" :PUBLIC? TRUE)"
   ...
   (DEFINE-FUNCTION-OBJECT "SYMBOLIZE"
    "(DEFUN (SYMBOLIZE SYMBOL) ((SURROGATE SURROGATE)) :DOCUMENTATION \"Convert `surrogate' into a symbol with the same name and module.\" :PUBLIC? TRUE :GLOBALLY-INLINE? TRUE (RETURN (TYPE-TO-SYMBOL SURROGATE)))"
    (CL:FUNCTION SYMBOLIZE) NULL)
   (DEFINE-FUNCTION-OBJECT "STRING-TO-SURROGATE"
    "(DEFUN (STRING-TO-SURROGATE SURROGATE) ((SELF STRING)) :PUBLIC? TRUE)"
    (CL:FUNCTION STRING-TO-SURROGATE) NULL)
   (DEFINE-FUNCTION-OBJECT "SYMBOL-TO-SURROGATE"
    "(DEFUN (SYMBOL-TO-SURROGATE SURROGATE) ((SELF SYMBOL)) :PUBLIC? TRUE)"
    (CL:FUNCTION SYMBOL-TO-SURROGATE) NULL)
   (DEFINE-METHOD-OBJECT
    "(DEFMETHOD (SURROGATIFY SURROGATE) ((SELF SURROGATE)) :PUBLIC? TRUE)"
    (CL:FUNCTION SURROGATIFY) NULL)
   (DEFINE-METHOD-OBJECT
    "(DEFMETHOD (SURROGATIFY SURROGATE) ((SELF SYMBOL)) :PUBLIC? TRUE)"
    (CL:FUNCTION SURROGATIFY) NULL)
   (DEFINE-METHOD-OBJECT
    "(DEFMETHOD (SURROGATIFY SURROGATE) ((SELF STRING)) :PUBLIC? TRUE)"
    (CL:FUNCTION SURROGATIFY) NULL)
   (DEFINE-METHOD-OBJECT
    "(DEFMETHOD (SURROGATIFY SURROGATE) ((SELF CONS)) :PUBLIC? TRUE)"
    (CL:FUNCTION SURROGATIFY) NULL)
   (DEFINE-METHOD-OBJECT
    "(DEFMETHOD (SURROGATIFY SURROGATE) ((SELF OBJECT)) :PUBLIC? TRUE)"
    (CL:FUNCTION SURROGATIFY) NULL)
   (DEFINE-FUNCTION-OBJECT "TYPIFY"
    "(DEFUN (TYPIFY TYPE) ((SELF OBJECT)) :PUBLIC? TRUE)" (CL:FUNCTION TYPIFY)
    NULL)
   (DEFINE-METHOD-OBJECT
   ...
   (DEFINE-FUNCTION-OBJECT "SURROGATE-NAME?"
    "(DEFUN (SURROGATE-NAME? BOOLEAN) ((NAME STRING)) :PUBLIC? TRUE)"
    (CL:FUNCTION SURROGATE-NAME?) NULL)
   (DEFINE-FUNCTION-OBJECT "QUALIFIED-NAME?"
    "(DEFUN (QUALIFIED-NAME? BOOLEAN) ((NAME STRING)) :PUBLIC? TRUE)"
    (CL:FUNCTION QUALIFIED-NAME?) NULL)
   (DEFINE-FUNCTION-OBJECT "KEYWORD-NAME?"
    "(DEFUN (KEYWORD-NAME? BOOLEAN) ((NAME STRING)) :PUBLIC? TRUE)"
    (CL:FUNCTION KEYWORD-NAME?) NULL)
   (DEFINE-FUNCTION-OBJECT "INTERN-GENERALIZED-SYMBOL"
    "(DEFUN (INTERN-GENERALIZED-SYMBOL GENERALIZED-SYMBOL) ((NAME STRING)) :PUBLIC? TRUE)"
    (CL:FUNCTION INTERN-GENERALIZED-SYMBOL) NULL)
   ...
   (DEFINE-METHOD-OBJECT
    "(DEFMETHOD (VISIBLE-NAME STRING) ((SELF GENERALIZED-SYMBOL)) :PUBLIC? TRUE)"
...
Symbol properties can be set with `setf'.\")" (CL:FUNCTION SYMBOL-PROPERTY) NULL)
   ...
   (DEFINE-FUNCTION-OBJECT "STARTUP-SYMBOLS"
    "(DEFUN STARTUP-SYMBOLS () :PUBLIC? TRUE)" (CL:FUNCTION STARTUP-SYMBOLS)
    NULL)
   (CL:LET* ((FUNCTION (LOOKUP-FUNCTION SYM-SYMBOLS-STELLA-STARTUP-SYMBOLS)))
    (SET-DYNAMIC-SLOT-VALUE (%DYNAMIC-SLOTS FUNCTION)
     SYM-SYMBOLS-STELLA-METHOD-STARTUP-CLASSNAME (WRAP-STRING "_Startup-Symbols")
     NULL-STRING-WRAPPER)))
  :VOID)
  ...
  (CL:LET* ((*MODULE* *STELLA-MODULE*) (*CONTEXT* *MODULE*))
   ...
   (CL:WHEN (CURRENT-STARTUP-TIME-PHASE? 4)
    ...
    (SET-DYNAMIC-SLOT-VALUE (%DYNAMIC-SLOTS *ROOT-MODULE*)
     SYM-SYMBOLS-STELLA-CODE-ONLY? (CL:IF TRUE TRUE-WRAPPER FALSE-WRAPPER)
     FALSE-WRAPPER)
    (SET-DYNAMIC-SLOT-VALUE (%DYNAMIC-SLOTS *STELLA-MODULE*)
     SYM-SYMBOLS-STELLA-CODE-ONLY? (CL:IF TRUE TRUE-WRAPPER FALSE-WRAPPER)
     FALSE-WRAPPER)
