    ...
    ((WORD NULL)
     (ITER-000
      (LIST* SYM-CPP-TRANSLATE-STELLA-ASM SYM-CPP-TRANSLATE-STELLA-ASSERT
       ...
       SYM-CPP-TRANSLATE-STELLA-TYPEDEF SYM-CPP-TRANSLATE-STELLA-TYPEID
       SYM-CPP-TRANSLATE-STELLA-UNION SYM-CPP-TRANSLATE-STELLA-UNSIGNED
...
(CL:DEFUN CPP-TRANSLATE-INLINE-TREE (TREE)
  ...
  (CL:RETURN-FROM CPP-TRANSLATE-INLINE-TREE
   (LIST* SYM-CPP-TRANSLATE-STELLA-CPP_COMMENT (WRAP-STRING "inline method")
    NIL)))
...
(CL:DEFUN CPP-TRANSLATE-INLINE-CALL-TREE (TREE)
  (CL:LET*
   ((CALLTREE (%%VALUE (%%REST TREE)))
    (ARGUMENTS
     (CL:IF
      (CL:EQ (%%VALUE CALLTREE) SYM-CPP-TRANSLATE-STELLA-SYS-CALL-FUNCTION)
    ...
    (CONS
     ...
     (CONCATENATE
      (CL:IF (CL:NOT (CL:EQ VARIABLE NULL))
       (CONS (LIST* SYM-CPP-TRANSLATE-STELLA-CPP_IDENT HELPERVARIABLE NIL)
        NIL)
       NIL)
      NIL)))
  ...
  (CL:LET* ((BODY (CPP-TRANSLATE-LIST-OF-TREES (%%REST TREE))))
   (CL:RETURN-FROM CPP-TRANSLATE-LOOP
    (LIST* SYM-CPP-TRANSLATE-STELLA-CPP_LOOP
     (LIST* SYM-CPP-TRANSLATE-STELLA-CPP_PROGN
      (CONS SYM-CPP-TRANSLATE-STELLA-CPP_STATEMENTS (CONCATENATE BODY NIL))
      NIL)
     NIL))))
...
(CL:DEFUN CPP-TRANSLATE-FOREACH-TREE (TREE)
  (CL:LET*
   ((ITERATORBINDINGS (%%VALUE (%%REST TREE)))
    ...
    (BODY (CPP-TRANSLATE-LIST-OF-TREES (NTH-REST TREE 5))) (DECLARATION NIL)
    (DECLARATIONS NIL) (VADECLARATIONS NIL) (VALUEASSIGNMENTS NIL)
    (NEXTASSIGNMENTS NIL) (VARARGSITERATOR NULL) (VARIABLES NIL))
   ...
   (CL:LET* ((TREE NULL) (ITER-001 VALUETREES) (COLLECT-001 NULL))
    (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-001 NIL)) DO
     ...
     (CL:IF (CL:EQ COLLECT-001 NULL)
      ...
      (CL:PROGN
       (CL:SETF (%%REST COLLECT-001) (CONS (CPP-TRANSLATE-A-TREE TREE) NIL))
   ...
   (CL:LET* ((TREE NULL) (ITER-002 NEXTTREES) (COLLECT-002 NULL))
    (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-002 NIL)) DO
     ...
     (CL:IF (CL:EQ COLLECT-002 NULL)
      ...
      (CL:PROGN
       (CL:SETF (%%REST COLLECT-002) (CONS (CPP-TRANSLATE-A-TREE TREE) NIL))
   ...
   (CL:LET* ((DECL NULL) (ITER-004 DECLARATIONS) (COLLECT-004 NULL))
    (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-004 NIL)) DO
     ...
     (CL:IF (CL:EQ COLLECT-004 NULL)
      ...
      (CL:PROGN
       (CL:SETF (%%REST COLLECT-004) (CONS (%%VALUE (%%REST DECL)) NIL))
...
(CL:DEFUN CPP-TRANSLATE-SYS-NEW (TREE)
  (CL:LET*
   ((TYPESPEC (%%VALUE (%%REST TREE))) (CLASS (TYPE-SPEC-TO-CLASS TYPESPEC)))
      ...
      (LIST* SYM-CPP-TRANSLATE-STELLA-CPP_IDENT
       (WRAP-STRING
        (CPP-YIELD-QUALIFIED-NAME
         (%WRAPPER-VALUE (CPP-TRANSLATE-NAME (YIELD-CONSTRUCTOR-NAME CLASS)))
         (CLASS-SYMBOL CLASS)))
       NIL)
   ...
   (CL:WHEN (ARRAY-TYPE-SPECIFIER? TYPESPEC)
    (CL:RETURN-FROM CPP-TYPE-WITHOUT-INTERIOR-POINTERS?
     (CPP-NON-POINTER-TYPE?
      (EXTRACT-PARAMETER-TYPE TYPESPEC SYM-CPP-TRANSLATE-STELLA-ANY-VALUE))))
   (CL:WHEN
    (CL:AND (CREATE-NATIVE-CLASS? CLASS)
     (CL:NOT
      (SUBTYPE-OF? BASETYPE SGT-CPP-TRANSLATE-STELLA-NATIVE-EXCEPTION)))
     ...
     (CL:LET* ((SLOT NULL) (ITER-000 (CLASS-SLOTS CLASS)))
      (CL:LOOP WHILE (NEXT? ITER-000) DO (CL:SETQ SLOT (%VALUE ITER-000))
       (CL:WHEN
        ...
        (CL:WHEN (CL:NOT (CPP-NON-POINTER-TYPE? (%SLOT-BASE-TYPE SLOT)))
...
(CL:DEFUN CPP-GENERATE-ARRAY-TYPED-ENTITY (ENTITY TRANSLATEDARRAYTYPE)
  ...
  (CL:LET*
   ((REFERENCETYPE?
     (CL:NOT
      (CL:= (STRING-SEARCH TRANSLATEDARRAYTYPE "(*&)" 0) NULL-INTEGER))))
   (CL:IF REFERENCETYPE?
...
(CL:DEFUN HELP-CPP-CHANGE-CASE (SYMBOL CASECONVENTION)
  (CL:LET*
   ((MODULE (%HOME-CONTEXT SYMBOL)) (NAME (%SYMBOL-NAME SYMBOL))
    ...
    (CAPS-BREAK-KEYWORD
     (CL:IF ALL-UPPER? KWD-CPP-TRANSLATE-CLEVER KWD-CPP-TRANSLATE-YES)))
   (CL:DECLARE (CL:TYPE CL:SIMPLE-STRING NAME))
...
(CL:DEFUN CPP-YIELD-NAMESPACE-PREFIX-FROM-MODULE (MODULE)
  ...
  (CL:LET*
   ...
   (CL:COND
    ...
    (CL:T
     (CL:RETURN-FROM CPP-YIELD-NAMESPACE-PREFIX-FROM-MODULE PACKAGEPREFIX)))))
  ...
  (CL:LET*
   ...
   (CL:LET*
    ...
    (CL:LOOP WHILE
     ...
     (CL:SETQ ITER-002 (CL:1+ ITER-002))))
   (CL:LET*
    ((RTYPE NULL) (ITER-003 (REST (METHOD-RETURN-TYPE-SPECIFIERS METHOD)))
         ...
         (CONS (CPP-TRANSLATE-A-TREE (%%VALUE D))
          (CONCATENATE
           (CL:IF (CL:NOT (CL:EQ (%%VALUE (%%REST (%%REST D))) NULL))
            (CONS-LIST (CPP-TRANSLATE-A-TREE (%%VALUE (%%REST (%%REST D)))))
            NIL)
           NIL)))
        ODECLARATIONS)))
     (CL:SETQ ITER-000 (%%REST ITER-000))))
...
(CL:DEFUN CPP-TRANSLATE-RETURN-TREE (TREE)
  (CL:LET*
   ...
   (CL:LET*
    ((EXP NULL) (ITER-000 (%%REST (%%REST TREE))) (PARAMETERNUM NULL-INTEGER)
     (ITER-001 1))
   ...
   (CL:IF
    ...
    (CL:PROGN
     (CL:LET*
      ...
      (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-002 NIL)) DO
       (CL:SETQ TYPE (%%VALUE ITER-002)) (CL:SETQ PARAMETERNUM ITER-003)
       (CL:SETQ TYPE TYPE)
       (CL:IF (CL:EQ COLLECT-000 NULL)
        (CL:PROGN
         (CL:SETQ COLLECT-000
...
(CL:DEFUN CPP-TRANSLATE-NORMAL-METHOD-CALL (METHODNAME OWNER ARGUMENTS REFERENCED?)
  (CL:LET*
   ...
   (CL:LET*
    ...
    (CL:SETQ OTHERARGS
     (CONCATENATE OTHERARGS (CPP-YIELD-UNUSED-DUMMY-ARGS METHOD ARGUMENTS)))
    (CL:RETURN-FROM CPP-TRANSLATE-NORMAL-METHOD-CALL
     (CONS
...
(CL:DEFUN CPP-TRANSLATE-DEFINED?-METHOD-CALL (ARGUMENTTYPE ARGUMENT NULL?)
  (CL:LET*
   ((NULLVALUE (TYPE-TO-WALKED-NULL-VALUE-TREE ARGUMENTTYPE ARGUMENTTYPE)))
   (CL:COND
...
(CL:DEFUN HELP-STARTUP-CPP-TRANSLATE4 ()
  (CL:PROGN
   ...
   (CL:SETQ SGT-CPP-TRANSLATE-STELLA-F-CPP-CHANGE-CASE-MEMO-TABLE-000
    (INTERN-RIGID-SYMBOL-WRT-MODULE "F-CPP-CHANGE-CASE-MEMO-TABLE-000" NULL
     1))
...
(CL:DEFUN HELP-STARTUP-CPP-TRANSLATE8 ()
  (CL:PROGN
   ...
   (DEFINE-FUNCTION-OBJECT "CPP-TRANSLATE-NULL"
    "(DEFUN (CPP-TRANSLATE-NULL CONS) ())" (CL:FUNCTION CPP-TRANSLATE-NULL)
    NULL)
...
(CL:DEFUN STARTUP-CPP-TRANSLATE ()
  (CL:LET* ((*MODULE* *STELLA-MODULE*) (*CONTEXT* *MODULE*))
   ...
   (CL:WHEN (CURRENT-STARTUP-TIME-PHASE? 7) (HELP-STARTUP-CPP-TRANSLATE7)
    (HELP-STARTUP-CPP-TRANSLATE8)
