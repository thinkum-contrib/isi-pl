...
(CL:DECLAIM
  ...
  *TRANSLATOROUTPUTLANGUAGE* STANDARD-ERROR EOL *CHARACTER-TYPE-TABLE*
  FALSE TRUE *MODULE* *CHARACTER-UPCASE-TABLE* NIL NULL-INTEGER
...
(CL:DEFUN CPP-TRANSLATE-FOREACH-TREE (TREE)
  (CL:LET*
   ...
   (CL:LET*
    ((BINDING NULL) (ITER-000 CURSORBINDINGS) (COLLECT-000 NULL))
    (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-000 NIL)) DO
   ...
   (CL:IF
    ...
    (CL:RETURN-FROM CPP-TRANSLATE-SETQ-TREE
     (LIST* SYM-CPP-TRANSLATE-STELLA-CPP_REFERENCED_METHOD_CALL
      ...
      (LIST* SYM-CPP-TRANSLATE-STELLA-CPP_IDENT
       (CPP-TRANSLATE-GLOBAL-NAME
        (CPP-FIXUP-NAME-SYMBOL (%%VALUE (%%REST TREE))
         (HOME-MODULE GLOBAL)))
       NIL)
      (LIST* SYM-CPP-TRANSLATE-STELLA-CPP_ACTUALS
       ...
       (CL:T
        (CL:RETURN-FROM CPP-TRANSLATE-TYPE-SPEC
         (CPP-TRANSLATE-CLASS-TYPENAME
          (TYPE-TO-SYMBOL
           (%CLASS-TYPE (%SURROGATE-VALUE TYPESPEC)))))))))
    (CL:T
    ...
    (CL:PROGN
     (CL:LET*
      ((PARAMETERNUM NULL-INTEGER) (TYPE NULL)
       (ITER-002 METHODOTHERRETURNTYPES) (ITER-003 1)
       (COLLECT-000 NULL))
  ...
  (CL:LET*
   ...
   (CL:WHEN (CL:> NUMBEROFUNUSEDRETURNPARAMETERS 0)
    (CL:SETQ UNUSEDRETURNTYPES
     (GET-LAST-N-ELEMENTS
      (REST (METHOD-RETURN-TYPE-SPECIFIERS FUNCTION))
...
(CL:DEFUN STARTUP-CPP-TRANSLATE ()
  (CL:LET* ((*MODULE* *STELLA-MODULE*) (*CONTEXT* *MODULE*))
   ...
   (CL:WHEN (CURRENT-STARTUP-TIME-PHASE? 4)
    ...
    (CL:SETQ *CPP-RESERVED-WORD-TABLE*
   ...
   (CL:WHEN (CURRENT-STARTUP-TIME-PHASE? 7)
    (HELP-STARTUP-CPP-TRANSLATE6) (HELP-STARTUP-CPP-TRANSLATE7)
