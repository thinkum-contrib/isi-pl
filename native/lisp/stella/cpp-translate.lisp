...
(CL:DEFVAR SGT-CPP-TRANSLATE-STELLA-INTEGER-WRAPPER NULL)
(CL:DEFVAR SGT-CPP-TRANSLATE-STELLA-INTEGER NULL)
(CL:DEFVAR SGT-CPP-TRANSLATE-STELLA-FLOAT-WRAPPER NULL)
...
(CL:DEFVAR SGT-CPP-TRANSLATE-STELLA-CPP-CHANGE-CASE-MEMO-TABLE-000 NULL)
(CL:DEFVAR KWD-CPP-TRANSLATE-UNESCAPED NULL)
...
(CL:DECLAIM
  ...
  *METHODBEINGWALKED* *CURRENT-STREAM* NULL-CHARACTER *TRANSLATOROUTPUTLANGUAGE*
  STANDARD-ERROR EOL *CHARACTER-TYPE-TABLE* FALSE TRUE *MODULE*
  *CHARACTER-UPCASE-TABLE* NIL NULL-INTEGER *CURRENT-STELLA-FEATURES*))
    ...
    (CL:LET* ((WRAPPER NULL) (ITER-000 ENTRY) (COLLECT-000 NULL))
     (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-000 NIL)) DO
      ...
      (CL:IF (CL:EQ COLLECT-000 NULL)
       (CL:PROGN
        (CL:SETQ COLLECT-000 (CONS (WRAP-STRING (%WRAPPER-VALUE WRAPPER)) NIL))
...
(CL:DEFUN CPP-YIELD-RENAMED-RESERVED-WORD (WORD)
  (CL:LET*
   ((NAME (%SYMBOL-NAME WORD)) (LENGTH (CL:THE CL:FIXNUM (CL:LENGTH NAME))))
...
(CL:DEFUN CPP-CREATE-RESERVED-WORD-TABLE ()
  (CL:LET* ((TABLE (NEW-STRING-HASH-TABLE)))
   (CL:LET*
    ((WORD NULL)
     (ITER-000
      (LIST* SYM-CPP-TRANSLATE-STELLA-ASM SYM-CPP-TRANSLATE-STELLA-ASSERT
       SYM-CPP-TRANSLATE-STELLA-AUTO SYM-CPP-TRANSLATE-STELLA-BREAK
       SYM-CPP-TRANSLATE-STELLA-CASE SYM-CPP-TRANSLATE-STELLA-CATCH
       SYM-CPP-TRANSLATE-STELLA-CHAR SYM-CPP-TRANSLATE-STELLA-CLASS
       SYM-CPP-TRANSLATE-STELLA-CONST SYM-CPP-TRANSLATE-STELLA-CONTINUE
       ...
       SYM-CPP-TRANSLATE-STELLA-WHILE SYM-CPP-TRANSLATE-STELLA-TYPENAME NIL)))
    (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-000 NIL)) DO
...
(CL:DEFUN CPP-TRANSLATE-SPECIAL-TREE (TREE)
  ...
  (CL:LET*
   ...
   (CL:LET*
    ((DECLARATION NULL) (ITER-000 (%%VALUE (%%REST TREE))) (COLLECT-000 NULL))
    (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-000 NIL)) DO
...
(CL:DEFUN TOKENIZE-VERBATIM-METHOD-BODY (TREE)
  (CL:LET*
   ...
   (CL:LET*
    ((PAR NULL) (ITER-000 (%THE-CONS-LIST (METHOD-PARAMETER-NAMES METHOD)))
     (COLLECT-000 NULL))
    (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-000 NIL)) DO
   ...
   (CL:LOOP (CL:WHEN (CL:>= CURSOR BODYLENGTH) (CL:RETURN))
    ...
    (CL:COND
      ...
      (CL:WHEN (CL:< CURSOR BODYLENGTH)
       (CL:CASE
        ...
        (#\/
         (CL:LET*
          ((COMMENT
            (NEW-INPUT-STRING-STREAM (SUBSEQUENCE BODY CURSOR NULL-INTEGER))))
          (CL:SETQ CURSOR
           (CL:+ CURSOR
            (CL:THE CL:FIXNUM
             (CL:LENGTH (CL:THE CL:SIMPLE-STRING (READ-LINE COMMENT))))))))
          ...
          ((NULL? CURSOR)
           (CL:LET* ((*PRINTREADABLY?* TRUE))
            ...
            (CL:WHEN (CL:NOT (SUPPRESS-WARNINGS?))
             ...
             (%%PRINT-STREAM (%NATIVE-STREAM STANDARD-ERROR) EOL " Illegal `"
              *TRANSLATOROUTPUTLANGUAGE* "' verbatim code in `"
     ...
     ((CL:AND (MEMBER? IDENTIFIERCHARS CH)
      ...
      (CL:LET*
       ((I NULL-INTEGER) (ITER-001 END) (UPPER-BOUND-000 (CL:1- BODYLENGTH)))
...
(CL:DEFUN CPP-TRANSLATE-INLINE-CALL-TREE (TREE)
  (CL:LET*
   ((CALLTREE (%%VALUE (%%REST TREE)))
    (ARGUMENTS
     (CL:IF (CL:EQ (%%VALUE CALLTREE) SYM-CPP-TRANSLATE-STELLA-SYS-CALL-FUNCTION)
...
(CL:DEFUN CPP-TRANSLATE-HANDLE-EXCEPTION (TREE)
  (CL:LET*
   ((VARIABLEDECL (%%VALUE (%%REST TREE))) (VARIABLE (%%VALUE VARIABLEDECL))
    (EXCEPTIONTYPE (%%VALUE (%%REST VARIABLEDECL))) (HELPERVARIABLE NULL)
   ...
   (CL:WHEN (CL:NOT (CL:EQ VARIABLE NULL))
    (CL:SETQ HELPERVARIABLE
     (WRAP-STRING
      (CONCATENATE "_" (%WRAPPER-VALUE (CPP-TRANSLATE-NAME VARIABLE)))))
    ...
    (CONS
     ...
     (CONCATENATE
      (CL:IF (CL:NOT (CL:EQ VARIABLE NULL))
       (CONS (LIST* SYM-CPP-TRANSLATE-STELLA-CPP_IDENT HELPERVARIABLE NIL) NIL)
       NIL)
      NIL)))
     ...
     (CONS
      (LIST* SYM-CPP-TRANSLATE-STELLA-CPP_LOCAL NULL
       (CONS (CPP-TRANSLATE-AND-POINTERIZE-TYPE-SPEC EXCEPTIONTYPE)
        (LIST*
         (LIST* SYM-CPP-TRANSLATE-STELLA-CPP_IDENT (CPP-TRANSLATE-NAME VARIABLE)
          NIL)
         (LIST* SYM-CPP-TRANSLATE-STELLA-CPP_IDENT
          (WRAP-STRING (STRING-CONCATENATE "&" (%WRAPPER-VALUE HELPERVARIABLE)))
          NIL)
         NIL)))
...
(CL:DEFUN CPP-TRANSLATE-CAST (TREE)
  (CL:LET*
   ...
   (CL:WHEN
    (CL:AND (SUBTYPE-OF? TYPE SGT-CPP-TRANSLATE-STELLA-FLOAT)
     (ISA? EXPRESSION SGT-CPP-TRANSLATE-STELLA-INTEGER-WRAPPER))
    (CL:RETURN-FROM CPP-TRANSLATE-CAST
     (CPP-TRANSLATE-A-TREE
      (WRAP-FLOAT (CL:FLOAT (%WRAPPER-VALUE EXPRESSION) 0.0d0)))))
   (CL:WHEN
    (CL:AND (SUBTYPE-OF? TYPE SGT-CPP-TRANSLATE-STELLA-INTEGER)
     (ISA? EXPRESSION SGT-CPP-TRANSLATE-STELLA-FLOAT-WRAPPER))
    (CL:RETURN-FROM CPP-TRANSLATE-CAST
     (CPP-TRANSLATE-A-TREE
   ...
   (THIRD-SETTER TREE
    (CPP-TRANSLATE-AND-POINTERIZE-TYPE-SPEC (%%VALUE (%%REST (%%REST TREE)))))
   ...
   ((VARIABLES (%%VALUE (%%REST TREE)))
    ...
    (OTREE
     (LIST* SYM-CPP-TRANSLATE-STELLA-CPP_ASSIGN
      ...
      (CONS (CPP-TRANSLATE-MV-FUNCTION-CALL FUNCTIONCALL (%%REST VARIABLES))
       NIL))))
...
(CL:DEFUN CPP-TRANSLATE-DEFINE-GLOBAL-VARIABLE-UNIT (UNIT)
  (CL:LET*
   ((GLOBAL (%THE-OBJECT UNIT)) (TYPE (GLOBAL-VARIABLE-TYPE-SPEC GLOBAL))
    (INITIALVALUETREE
     (CL:IF
      (CL:EQ (%CODE-REGISTER UNIT) KWD-CPP-TRANSLATE-UNBOUND-SPECIAL-VARIABLE)
      NULL (CPP-TRANSLATE-A-TREE (%CODE-REGISTER UNIT))))
    (VARIABLENAME
     (CPP-TRANSLATE-GLOBAL-NAME
      (CPP-FIXUP-NAME-SYMBOL (%VARIABLE-NAME GLOBAL) (HOME-MODULE GLOBAL)))))
   (CL:COND
...
(CL:DEFUN CPP-YIELD-SYMBOL-ID-FORM (SYMBOLID)
  ...
  (CL:LET* ((SYMBOL (GET-SYM-FROM-OFFSET SYMBOLID)))
   (CL:RETURN-FROM CPP-YIELD-SYMBOL-ID-FORM
    (LIST* SYM-CPP-TRANSLATE-STELLA-CPP_IDENT (CPP-TRANSLATE-SYMBOL-ID SYMBOL)
     NIL))))
        ...
        (CL:IF (CL:EQ (%%VALUE CONDITION) SYM-CPP-TRANSLATE-STELLA-OTHERWISE)
         (CL:SETQ OTHERWISECONDITION
          (CONS SYM-CPP-TRANSLATE-STELLA-CPP_STATEMENTS
           (CONCATENATE (CPP-TRANSLATE-LIST-OF-TREES (%%REST CONDITION)) NIL)))
         (CL:SETQ CONDITIONS
          (CONS (CPP-TRANSLATE-CONDITION CONDITION SYMBOLCASEP) CONDITIONS)))))
      (CL:T
       (CL:LET* ((STREAM-000 (NEW-OUTPUT-STRING-STREAM)))
  ...
  (CL:LET* ((BODY (CPP-TRANSLATE-LIST-OF-TREES (%%REST TREE))))
   (CL:RETURN-FROM CPP-TRANSLATE-LOOP
    (LIST* SYM-CPP-TRANSLATE-STELLA-CPP_LOOP
     (LIST* SYM-CPP-TRANSLATE-STELLA-CPP_PROGN
      (CONS SYM-CPP-TRANSLATE-STELLA-CPP_STATEMENTS (CONCATENATE BODY NIL)) NIL)
     NIL))))
...
(CL:DEFUN CPP-TRANSLATE-IF-TREE (TREE)
  (CL:LET*
   ...
   (CL:IF
    ...
    (CL:SETQ TRUEBODY
     (LIST* SYM-CPP-TRANSLATE-STELLA-CPP_PROGN
      (CONS SYM-CPP-TRANSLATE-STELLA-CPP_STATEMENTS (CONCATENATE TRUEBODY NIL))
      NIL))
    (CL:SETQ TRUEBODY
     (LIST* SYM-CPP-TRANSLATE-STELLA-CPP_PROGN
      (LIST* SYM-CPP-TRANSLATE-STELLA-CPP_STATEMENTS TRUEBODY NIL) NIL)))
   (CL:IF
    (CL:AND (CONS? (%%VALUE FALSEBODY)) (CL:NOT (CL:EQ (%%REST FALSEBODY) NIL)))
    (CL:SETQ FALSEBODY
     (LIST* SYM-CPP-TRANSLATE-STELLA-CPP_PROGN
      (CONS SYM-CPP-TRANSLATE-STELLA-CPP_STATEMENTS (CONCATENATE FALSEBODY NIL))
      NIL))
    (CL:SETQ FALSEBODY
     (LIST* SYM-CPP-TRANSLATE-STELLA-CPP_PROGN
  ...
  (CL:LET*
   ...
   (CL:RETURN-FROM CPP-TRANSLATE-WHEN-TREE
    (LIST* SYM-CPP-TRANSLATE-STELLA-CPP_WHEN TEST
     (CONS (CONS SYM-CPP-TRANSLATE-STELLA-CPP_STATEMENTS (CONCATENATE BODY NIL))
      NIL)))))
...
(CL:DEFUN CPP-TRANSLATE-FOREACH-TREE (TREE)
  (CL:LET*
   ((ITERATORBINDINGS (%%VALUE (%%REST TREE)))
    ...
    (BODY (CPP-TRANSLATE-LIST-OF-TREES (NTH-REST TREE 4))) (DECLARATION NIL)
    (DECLARATIONS NIL) (NEXTASSIGNMENTS NIL) (VARARGSITERATOR NULL))
    ...
    (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-000 NIL)) DO
     ...
     (CL:IF (CL:EQ COLLECT-000 NULL)
      ...
      (CL:PROGN (CL:SETF (%%REST COLLECT-000) (CONS DECLARATION NIL))
       (CL:SETQ COLLECT-000 (%%REST COLLECT-000))))))
   (CL:LET* ((BINDING NULL) (ITER-001 ITERATORBINDINGS) (COLLECT-001 NULL))
   ...
   (CONS
    (LIST* SYM-CPP-TRANSLATE-STELLA-CPP_FUNCTION_CALL
     ...
     (LIST* SYM-CPP-TRANSLATE-STELLA-CPP_ACTUALS
      ...
      (CONS (CPP-TRANSLATE-A-TREE (VARIABLE-ARGUMENTS-NAME *METHODBEINGWALKED*))
       NIL))
     NIL)
    NIL)))
...
(CL:DEFUN CPP-YIELD-VA-ITERATOR-DECLARATIONS (ITERATORVAR)
  (CL:RETURN-FROM CPP-YIELD-VA-ITERATOR-DECLARATIONS
   (LIST*
    ...
    (CONS
     (CPP-TRANSLATE-AND-POINTERIZE-TYPE-SPEC SGT-CPP-TRANSLATE-STELLA-INTEGER)
     (CONS
      (CPP-TRANSLATE-A-TREE (CPP-YIELD-VA-ITERATOR-HELPER-VARIABLE ITERATORVAR))
      (CONS (CPP-TRANSLATE-A-TREE (VARIABLE-ARGUMENTS-NAME *METHODBEINGWALKED*))
       NIL)))
    NIL)))
...
(CL:DEFUN CPP-TRANSLATE-ARGUMENT-LIST-TREE (OPERATOR OWNER ARGUMENT)
  ...
  (CL:COND
    ...
    (CL:RETURN-FROM CPP-TRANSLATE-ARGUMENT-LIST-TREE
     (LIST* SYM-CPP-TRANSLATE-STELLA-CPP_BINARY_OP
      ...
      (CONCATENATE (CPP-LOOKUP-OPERATOR-TABLE SYM-CPP-TRANSLATE-STELLA->)
       (CONS (LIST* SYM-CPP-TRANSLATE-STELLA-CPP_LITERAL (WRAP-INTEGER 0) NIL)
        NIL)))))
   ...
   (CL:T
    ...
    (CL:RETURN-FROM CPP-TRANSLATE-ARGUMENT-LIST-TREE
     (LIST* SYM-CPP-TRANSLATE-STELLA-CPP_FUNCTION_CALL
      (LIST* SYM-CPP-TRANSLATE-STELLA-CPP_IDENT (CPP-TRANSLATE-NAME OPERATOR)
       NIL)
      (LIST* SYM-CPP-TRANSLATE-STELLA-CPP_ACTUALS (CPP-TRANSLATE-A-TREE ARGUMENT)
       NIL)
      NIL)))))
      ...
      (CL:SETQ OTREE
       (LIST* SYM-CPP-TRANSLATE-STELLA-CPP_CAST
        (LIST* SYM-CPP-TRANSLATE-STELLA-CPP_FUNCTION_POINTER
         (CPP-TRANSLATE-FUNCTION-NAME-FROM-NAME (%%VALUE (%%REST (%%REST TREE))))
         NIL)
...
(CL:DEFUN CPP-TRANSLATE-SYS-POINTER-TO-FUNCTION (TREE)
  (CL:LET*
   ((FUNCTIONNAME (%WRAPPER-VALUE (CPP-TRANSLATE-NAME (%%VALUE (%%REST TREE)))))
    (OTREE NULL))
...
(CL:DEFUN CPP-TRANSLATE-NEW-ARRAY (TREE)
  (CL:LET*
   ((ARRAYTYPE (%%VALUE (%%REST TREE)))
    ...
    (ELEMENTTYPE
     (EXTRACT-PARAMETER-TYPE ARRAYTYPE SYM-CPP-TRANSLATE-STELLA-ANY-VALUE)))
  ...
  (CL:LET* ((RETURNTYPE (%%VALUE (%%REST (%%REST TREE)))))
   (CL:IF (CL:EQ RETURNTYPE SGT-CPP-TRANSLATE-STELLA-VOID)
    (CL:RETURN-FROM CPP-TRANSLATE-BAD-SYS
     (LIST* SYM-CPP-TRANSLATE-STELLA-CPP_FUNCTION_CALL
      (LIST* SYM-CPP-TRANSLATE-STELLA-CPP_IDENT
       (WRAP-STRING "illegal_stella_statement_flagged_by_the_translator") NIL)
      NIL))
    (CL:RETURN-FROM CPP-TRANSLATE-BAD-SYS
     (LIST* SYM-CPP-TRANSLATE-STELLA-CPP_IDENT
      (WRAP-STRING "illegal_stella_expression_flagged_by_the_translator") NIL)))))
  ...
  (CL:LET*
   ...
   (CL:RETURN-FROM CPP-TRANSLATE-SYS-REFERENCED-SLOT-VALUE
    (LIST* SYM-CPP-TRANSLATE-STELLA-CPP_REFERENCED_SLOT_VALUE
     (CPP-TRANSLATE-A-TREE OBJECTREF) (CONS (CPP-TRANSLATE-NAME SLOTNAME) NIL)))))
  ...
  (CL:LET*
   ...
   (CL:COND
    ...
    (CL:T
     (CL:RETURN-FROM CPP-TRANSLATE-MAKE-TREE
      (LIST* SYM-CPP-TRANSLATE-STELLA-CPP_FUNCTION_CALL
       (LIST* SYM-CPP-TRANSLATE-STELLA-CPP_IDENT (WRAP-STRING NATIVETYPE) NIL)
       ARGUMENTS NIL))))))
  ...
  (CL:LET* ((IT (ALLOCATE-ITERATOR (%%REST (%%REST TREE)))))
   (CL:LOOP WHILE (NEXT? IT) DO
    (CL:IF (CL:EQ (%VALUE IT) SYM-CPP-TRANSLATE-STELLA-EOL)
     (VALUE-SETTER IT
      (GET-QUOTED-TREE "((CPP_IDENT \"std::endl\") \"/STELLA\")" "/STELLA"))
...
(CL:DEFUN CPP-TRANSLATE-SETQ-TREE (TREE)
  (CL:LET* ((GLOBAL (LOOKUP-GLOBAL-VARIABLE (%%VALUE (%%REST TREE)))))
   (CL:IF
    (CL:AND (CL:NOT (CL:EQ GLOBAL NULL)) (%VARIABLE-SPECIAL? GLOBAL)
     (CL:EQ (SPECIAL-IMPLEMENTATION-STYLE)
      KWD-CPP-TRANSLATE-UNBIND-WITH-DESTRUCTORS))
    (CL:RETURN-FROM CPP-TRANSLATE-SETQ-TREE
     (LIST* SYM-CPP-TRANSLATE-STELLA-CPP_REFERENCED_METHOD_CALL
      ...
      (LIST* SYM-CPP-TRANSLATE-STELLA-CPP_IDENT
       (CPP-TRANSLATE-GLOBAL-NAME
        (CPP-FIXUP-NAME-SYMBOL (%%VALUE (%%REST TREE)) (HOME-MODULE GLOBAL)))
       NIL)
      (LIST* SYM-CPP-TRANSLATE-STELLA-CPP_ACTUALS
   ...
   (CL:COND
    ((CL:NOT (CL:EQ GLOBALVAR NULL))
     (CL:LET*
      ...
      (CL:WHEN
       (CL:AND (%VARIABLE-SPECIAL? GLOBALVAR)
        (CL:EQ (SPECIAL-IMPLEMENTATION-STYLE)
         KWD-CPP-TRANSLATE-UNBIND-WITH-DESTRUCTORS))
       (CL:SETQ OTREE
        (LIST* SYM-CPP-TRANSLATE-STELLA-CPP_REFERENCED_METHOD_CALL
         ...
         OTREE (CONS (CONS SYM-CPP-TRANSLATE-STELLA-CPP_ACTUALS NIL) NIL))))
       ...
       (CONS
        (CONS (CPP-TRANSLATE-AND-POINTERIZE-TYPE-SPEC (%%VALUE (%%REST D)))
         (CONS (CPP-TRANSLATE-A-TREE (%%VALUE D))
          (CONS (CPP-TRANSLATE-A-TREE (%%VALUE (%%REST (%%REST D)))) NIL)))
        ODECLARATIONS)))))
       ...
       (CL:T
        (CL:RETURN-FROM CPP-TRANSLATE-TYPE-SPEC
         (CPP-TRANSLATE-CLASS-TYPENAME
          (TYPE-TO-SYMBOL (%CLASS-TYPE (%SURROGATE-VALUE TYPESPEC)))))))))
    (CL:T
  ...
  (CL:LET*
   ...
   (CL:WHEN (CL:= (LENGTH DIMENSIONS) 1)
    (CL:RETURN-FROM CPP-TRANSLATE-ARRAY-TYPE
     (WRAP-STRING
      (CONCATENATE
       (%WRAPPER-VALUE (CPP-TRANSLATE-AND-POINTERIZE-TYPE-SPEC ELEMENTTYPE))
       "*"))))
   (CL:LET*
    ((I NULL-INTEGER) (DIM NULL) (ITER-000 (%THE-CONS-LIST DIMENSIONS))
     (ITER-001 0))
...
(CL:DEFUN CPP-GENERATE-ARRAY-TYPED-ENTITY (ENTITY TRANSLATEDARRAYTYPE)
  ...
  (CL:LET*
   ((REFERENCETYPE? (DEFINED? (STRING-SEARCH TRANSLATEDARRAYTYPE "(*&)" 0))))
   (CL:IF REFERENCETYPE?
    ...
    (CL:LOOP WHILE (CL:OR UNBOUNDED?-000 (CL:<= ITER-000 UPPER-BOUND-000)) DO
     ...
     (CL:TAGBODY
      (CL:CASE
       ...
       (#\* (CL:RETURN-FROM CPP-NATIVE-POINTER-TYPE? TRUE))
       (CL:OTHERWISE (CL:RETURN)))
      :CONTINUE)))
   (CL:RETURN-FROM CPP-NATIVE-POINTER-TYPE? FALSE)))
...
(CL:DEFUN CPP-CREATE-CHARACTER-SUBSTITUTION-TABLE ()
  (CL:LET*
   ((TABLE (CL:THE CL:SIMPLE-STRING (CL:MAKE-STRING 256 :INITIAL-ELEMENT #\_))))
   ...
   (CL:LET
    ...
    (SETF (CL:SCHAR (CL:THE CL:SIMPLE-STRING SELF) (CL:THE CL:FIXNUM POSITION))
     (CL:THE CL:CHARACTER CH)))
   (CL:LET
    ((SELF TABLE) (CH #\O) (POSITION (CL:THE CL:FIXNUM (CL:CHAR-CODE #\*))))
    (CL:DECLARE (CL:TYPE CL:SIMPLE-STRING SELF) (CL:TYPE CL:FIXNUM POSITION))
    (SETF (CL:SCHAR (CL:THE CL:SIMPLE-STRING SELF) (CL:THE CL:FIXNUM POSITION))
     (CL:THE CL:CHARACTER CH)))
   (CL:LET
...
(CL:DEFUN CPP-CHANGE-CASE (SYMBOL CASECONVENTION)
  (CL:LET*
   ((MEMO-TABLE-000
     (%SURROGATE-VALUE SGT-CPP-TRANSLATE-STELLA-CPP-CHANGE-CASE-MEMO-TABLE-000))
    (MEMOIZED-ENTRY-000 NULL) (MEMOIZED-VALUE-000 NULL))
   (CL:WHEN (CL:EQ MEMO-TABLE-000 NULL)
    (INITIALIZE-MEMOIZATION-TABLE
     SGT-CPP-TRANSLATE-STELLA-CPP-CHANGE-CASE-MEMO-TABLE-000
     "(:MAX-VALUES 2000)")
    (CL:SETQ MEMO-TABLE-000
     (%SURROGATE-VALUE SGT-CPP-TRANSLATE-STELLA-CPP-CHANGE-CASE-MEMO-TABLE-000)))
   (CL:WHEN *MEMOIZATION-ENABLED?*
    (CL:SETQ MEMOIZED-ENTRY-000
     (LOOKUP-MRU-MEMOIZED-VALUE MEMO-TABLE-000 SYMBOL CASECONVENTION *MODULE*
...
(CL:DEFUN HELP-CPP-CHANGE-CASE (SYMBOL CASECONVENTION)
  (CL:LET* ((MODULE (%HOME-CONTEXT SYMBOL)) (NAME (%SYMBOL-NAME SYMBOL)))
   (CL:DECLARE (CL:TYPE CL:SIMPLE-STRING NAME))
   (CL:WHEN (CL:EQ MODULE NULL) (CL:SETQ MODULE *MODULE*))
   (CL:WHEN
    (CL:OR (%CASE-SENSITIVE? MODULE)
     (CL:NOT
      (CL:EQ (COMPUTE-SYMBOL-ESCAPE-CODE NAME FALSE)
       KWD-CPP-TRANSLATE-UNESCAPED)))
   ...
   (CL:COND
    ((CL:EQ CASECONVENTION KWD-CPP-TRANSLATE-UPPERCASE)
     (CL:RETURN-FROM HELP-CPP-CHANGE-CASE
      (MAKE-MATCHING-NAME-FULL NAME KWD-CPP-TRANSLATE-NO KWD-CPP-TRANSLATE-NO
       "- " "" "" "" "" KWD-CPP-TRANSLATE-UPCASE "_")))
    ((CL:EQ CASECONVENTION KWD-CPP-TRANSLATE-LOWERCASE)
     (CL:RETURN-FROM HELP-CPP-CHANGE-CASE
      (MAKE-MATCHING-NAME-FULL NAME KWD-CPP-TRANSLATE-CLEVER
       KWD-CPP-TRANSLATE-CLEVER "- " "" "" "" "" KWD-CPP-TRANSLATE-TITLECASEX
       "")))
    ((CL:EQ CASECONVENTION KWD-CPP-TRANSLATE-CAPITALIZED)
     (CL:RETURN-FROM HELP-CPP-CHANGE-CASE
      (MAKE-MATCHING-NAME-FULL NAME KWD-CPP-TRANSLATE-CLEVER
       KWD-CPP-TRANSLATE-CLEVER "- " "" "" "" "" KWD-CPP-TRANSLATE-TITLECASE
       "")))
    (CL:T
     (CL:LET* ((STREAM-000 (NEW-OUTPUT-STRING-STREAM)))
      (%%PRINT-STREAM (%NATIVE-STREAM STREAM-000) "`" CASECONVENTION
      ...
      (CL:ERROR (NEW-STELLA-EXCEPTION (THE-STRING-READER STREAM-000))))))))
(CL:DECLAIM
 (CL:FTYPE (CL:FUNCTION (CL:T CL:T) CL:SIMPLE-STRING) HELP-CPP-CHANGE-CASE))
...
(CL:DECLAIM
 (CL:FTYPE (CL:FUNCTION (CL:T) CL:SIMPLE-STRING) CPP-YIELD-NAMESPACE-PREFIX))
...
(CL:DEFUN CPP-QUALIFY-NAME? (NAMESYMBOL)
  (CL:LET*
   ...
   (CL:WHEN
    ...
    (CL:RETURN-FROM CPP-QUALIFY-NAME? FALSE))
   (CL:WHEN
    (CL:AND (SYMBOL? NAMESYMBOL)
     (NATIVE-NAME? NAMESYMBOL KWD-CPP-TRANSLATE-CPP NULL))
    (CL:RETURN-FROM CPP-QUALIFY-NAME? TRUE))
   (CL:COND
          ...
          (CL:PROGN
           (CL:RETURN-FROM CPP-QUALIFY-NAME?
            (CL:NOT
             (CL:EQ
              (%%REST
               (LOOKUP-VISIBLE-SYMBOLS-IN-MODULE (%SYMBOL-NAME NAMESYMBOL)
                NAMESPACEMODULE FALSE))
              NIL)))))
         ((SUBTYPE-OF-SURROGATE? TEST-VALUE-000)
          (CL:PROGN
           (CL:RETURN-FROM CPP-QUALIFY-NAME?
            (CL:NOT
             (CL:EQ
              (%%REST
               (LOOKUP-VISIBLE-SURROGATES-IN-MODULE (%SYMBOL-NAME NAMESYMBOL)
                NAMESPACEMODULE FALSE))
              NIL)))))
         (CL:T
          (CL:LET* ((STREAM-000 (NEW-OUTPUT-STRING-STREAM)))
...
(CL:DEFUN CPP-TRANSLATE-CLASS-TYPENAME (NAMESYMBOL)
  (CL:LET*
   ((REALNAMESYMBOL (%CLASS-TYPE (%SURROGATE-VALUE (SURROGATIFY NAMESYMBOL)))))
  ...
  (CL:LET*
   ...
   (CL:LET*
    ...
    (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-003 NIL)) DO
     ...
     (CL:PROGN (CL:SETQ RTYPEINDEX ITER-004) (CL:SETQ ITER-004 (CL:1+ ITER-004)))
     (CL:IF (CL:EQ COLLECT-001 NULL)
      (CL:PROGN
       (CL:SETQ COLLECT-001
  ...
  (CL:LET* ((LOOKEDUPSLOT NULL))
   (CL:WHEN (CL:NOT (%METHOD-FUNCTION? METHOD))
    (CL:SETQ LOOKEDUPSLOT
     (LOOKUP-SLOT (%SURROGATE-VALUE (%SLOT-OWNER METHOD)) (%SLOT-NAME METHOD))))
...
(CL:DEFUN CPP-TRANSLATE-FUNCTION-NAME (FUNCTION)
  (CL:LET*
   ((FUNCTIONNAME
     (YIELD-RENAMED-NAME-IF-NATIVE (%SLOT-NAME FUNCTION) KWD-CPP-TRANSLATE-CPP
   ...
   (CL:WHEN (CPP-METHOD-OBJECT-IS-OVERLOADED-FUNCTION? FUNCTION)
    (CL:SETQ FUNCTIONNAME
     (CPP-CREATE-OVERLOADED-FUNCTION-NAME FUNCTIONNAME (%SLOT-OWNER FUNCTION))))
...
(CL:DEFUN CPP-TRANSLATE-DEFINE-METHOD-UNIT (UNIT)
  (CL:LET*
   ((*METHODBEINGWALKED* NULL) (*CURRENTDUMMYINDEX* 0) (*DUMMYDECLARATIONS* NIL))
   (CL:DECLARE
    (CL:SPECIAL *METHODBEINGWALKED* *CURRENTDUMMYINDEX* *DUMMYDECLARATIONS*))
   ...
   (CL:LET*
    ...
    (CL:WHEN (CL:NOT (CL:EQ *DUMMYDECLARATIONS* NIL))
     (CL:SETQ TRANSLATEDMETHODBODY
      (WRAP-METHOD-BODY-WITH-CPP-AUXILIARY-DECLARATIONS TRANSLATEDMETHODBODY
       *DUMMYDECLARATIONS*)))
    (CL:WHEN
     (CL:NOT
      (CL:EQ
...
(CL:DEFUN CPP-TRANSLATE-RETURN-TREE (TREE)
  (CL:LET*
   ...
   (CL:LET*
    ((PARAMETERNUM NULL-INTEGER) (EXP NULL) (ITER-000 (%%REST (%%REST TREE)))
     (ITER-001 1))
   ...
   (CL:IF
    ...
    (CL:PROGN
     (CL:LET*
      ((PARAMETERNUM NULL-INTEGER) (TYPE NULL) (ITER-002 METHODOTHERRETURNTYPES)
       (ITER-003 1) (COLLECT-000 NULL))
   ...
   (CL:IF (CL:EQ RETURNASSIGNMENTS NIL)
    (CL:IF (CL:EQ (%%REST TREE) NIL)
     ...
     (CL:SETQ OTREE
      (LIST* SYM-CPP-TRANSLATE-STELLA-CPP_RETURN TRANSLATEDRETURNEXPRESSION
       NIL)))
       ...
       (LIST* SYM-CPP-TRANSLATE-STELLA-CPP_BLOCK
        (CONS
         (CONS
          ...
          (LIST*
           (LIST* SYM-CPP-TRANSLATE-STELLA-CPP_IDENT (WRAP-STRING TEMPVAR) NIL)
...
(CL:DEFUN CPP-TRANSLATE-VARIABLE-LENGTH-ACTUALS (ACTUALS METHOD)
  (CL:LET*
   ...
   (CL:LET* ((I NULL-INTEGER) (ACTUAL NULL) (ITER-000 ACTUALS) (ITER-001 0))
    (CL:DECLARE (CL:TYPE CL:FIXNUM ITER-001 I))
    (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-000 NIL)) DO
     ...
     (CL:WHEN (CL:= I RESTARGUMENTSTART) (CL:SETQ PUSHEDDUMMY TRUE)
      (CL:LET* ((RESULT (CL:- (LENGTH ACTUALS) RESTARGUMENTSTART)))
       ...
       (CL:SETQ OTREE
        (CONS
         (LIST* SYM-CPP-TRANSLATE-STELLA-CPP_LITERAL (WRAP-INTEGER RESULT) NIL)
         OTREE))))
  ...
  (CL:LET*
   ...
   (CL:RETURN-FROM CPP-TRANSLATE-CALL-METHOD-SETTER
    (LIST* SYM-CPP-TRANSLATE-STELLA-CPP_METHOD_SETTER_CALL
     (LIST* SYM-CPP-TRANSLATE-STELLA-CPP_IDENT (CPP-TRANSLATE-NAME METHODNAME)
      NIL)
     ...
     (CL:WHEN
      ...
      (CL:RETURN-FROM CPP-TRANSLATE-METHOD-CALL
       (CPP-TRANSLATE-ARGUMENT-LIST-TREE METHODNAME OWNER
        (%%VALUE ARGUMENTS))))))
   (CL:RETURN-FROM CPP-TRANSLATE-METHOD-CALL
    (CPP-TRANSLATE-NORMAL-METHOD-CALL METHODNAME OWNER ARGUMENTS REFERENCED?))))
...
(CL:DEFUN CPP-TRANSLATE-NORMAL-METHOD-CALL (METHODNAME OWNER ARGUMENTS REFERENCED?)
  (CL:LET*
   ((SLOT (LOOKUP-SLOT (%SURROGATE-VALUE OWNER) METHODNAME))
    (METHOD (CL:IF (METHOD-SLOT? SLOT) SLOT NULL)) (FIRSTARG (%%VALUE ARGUMENTS))
    (OTHERARGS (%%REST ARGUMENTS)))
   (CL:LET*
    ((OPERATOR (CPP-LOOKUP-OPERATOR-TABLE (SOFT-PERMANENTIFY METHODNAME))))
    ...
    ((TRANSLATEDNAME
      (CPP-TRANSLATE-NAME
       (YIELD-RENAMED-NAME-IF-NATIVE METHODNAME KWD-CPP-TRANSLATE-CPP
        KWD-CPP-TRANSLATE-FUNCTION))))
    (CL:WHEN
     (CL:AND (CL:EQ METHOD NULL) (SLOT-READER-FROM-NAME? METHODNAME OWNER))
     (CL:SETF (%WRAPPER-VALUE TRANSLATEDNAME)
      (CONCATENATE (%WRAPPER-VALUE TRANSLATEDNAME) "_reader")))
    (CL:RETURN-FROM CPP-TRANSLATE-NORMAL-METHOD-CALL
     (CONS
      (CL:IF REFERENCED? SYM-CPP-TRANSLATE-STELLA-CPP_REFERENCED_METHOD_CALL
     ...
     (CL:RETURN-FROM CPP-TRANSLATE-DEFINED?-METHOD-CALL
      (CPP-TRANSLATE-OPERATOR-CALL
       (CPP-LOOKUP-OPERATOR-TABLE
        (CL:IF NULL? SYM-CPP-TRANSLATE-STELLA-EQ? SYM-CPP-TRANSLATE-STELLA-!=))
...
(CL:DEFUN CPP-TRANSLATE-CODE-SIGNATURE (SIGNATURE)
  (CL:LET* ((TRANSLATEDRETURNTYPES NIL) (TRANSLATEDPARAMETERTYPES NIL))
   ...
   (CL:RETURN-FROM CPP-TRANSLATE-CODE-SIGNATURE
    (LIST* SYM-CPP-TRANSLATE-STELLA-CPP_FUNCTION_SIGNATURE TRANSLATEDRETURNTYPES
...
(CL:DEFUN CPP-TRANSLATE-FUNCTION-CALL (TREE METHOD)
  (CL:LET*
   ((FUNCTIONNAME (%%VALUE TREE)) (FUNCTIONARGS (COPY-CONS-LIST (%%REST TREE)))
    (FIRSTARG (%%VALUE FUNCTIONARGS))
    (FUNCTION
     (CL:IF (CL:NOT (CL:EQ METHOD NULL)) METHOD (LOOKUP-FUNCTION FUNCTIONNAME)))
    ...
    (CL:LET* ((UNUSEDPARAMETERTYPE NULL) (ITER-000 UNUSEDRETURNTYPES))
     (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-000 NIL)) DO
      ...
      (CL:SETQ DUMMYNAME
       (INTERN-SYMBOL
        (%WRAPPER-VALUE
         (CPP-TRANSLATE-RETURN-PARAMETER-NAME SYM-CPP-TRANSLATE-STELLA-DUMMY
          *CURRENTDUMMYINDEX*))))
      (CL:SETQ *DUMMYDECLARATIONS*
   ...
   (CL:IF (CL:NOT (CL:EQ OPERATOR NULL))
    (CL:SETQ OTREE
     (CPP-TRANSLATE-OPERATOR-CALL OPERATOR FUNCTIONARGS (LENGTH FUNCTIONARGS)))
    (CL:SETQ OTREE
     (LIST* SYM-CPP-TRANSLATE-STELLA-CPP_FUNCTION_CALL
      (LIST* SYM-CPP-TRANSLATE-STELLA-CPP_IDENT
...
(CL:DEFUN CPP-TRANSLATE-OPERATOR-TREE (TREE)
  (CL:LET*
   ((OPERATOR (CPP-LOOKUP-OPERATOR-TABLE (%%VALUE TREE))) (ARGS (%%REST TREE))
    (ARITY NULL-INTEGER))
       ...
       (CONS (%%VALUE OPERATORNAMES)
        (CONS (CPP-TRANSLATE-A-TREE (%%VALUE (%%REST ARGUMENTS)))
         (CONS (%%VALUE (%%REST OPERATORNAMES))
          (CONS (CPP-TRANSLATE-A-TREE (%%VALUE (%%REST (%%REST ARGUMENTS))))
           NIL))))))))
...
(CL:DEFUN HELP-STARTUP-CPP-TRANSLATE3 ()
  (CL:PROGN
   ...
   (CL:SETQ SGT-CPP-TRANSLATE-STELLA-INTEGER-WRAPPER
   ...
   (CL:SETQ SGT-CPP-TRANSLATE-STELLA-FLOAT-WRAPPER
...
(CL:DEFUN HELP-STARTUP-CPP-TRANSLATE4 ()
  (CL:PROGN
   ...
   (CL:SETQ SGT-CPP-TRANSLATE-STELLA-CPP-CHANGE-CASE-MEMO-TABLE-000
    (INTERN-RIGID-SYMBOL-WRT-MODULE "CPP-CHANGE-CASE-MEMO-TABLE-000" NULL 1))
   (CL:SETQ KWD-CPP-TRANSLATE-UNESCAPED
...
(CL:DEFUN HELP-STARTUP-CPP-TRANSLATE6 ()
  (CL:PROGN
   ...
   (DEFINE-FUNCTION-OBJECT "CPP-TRANSLATE-NULL"
    "(DEFUN (CPP-TRANSLATE-NULL CONS) ())" (CL:FUNCTION CPP-TRANSLATE-NULL) NULL))
  :VOID)
...
(CL:DEFUN STARTUP-CPP-TRANSLATE ()
  (CL:LET* ((*MODULE* *STELLA-MODULE*) (*CONTEXT* *MODULE*))
   ...
   (CL:WHEN (CURRENT-STARTUP-TIME-PHASE? 2) (HELP-STARTUP-CPP-TRANSLATE1)
    ...
    (HELP-STARTUP-CPP-TRANSLATE4) (HELP-STARTUP-CPP-TRANSLATE5))
   ...
   (CL:WHEN (CURRENT-STARTUP-TIME-PHASE? 7) (HELP-STARTUP-CPP-TRANSLATE6)
    (HELP-STARTUP-CPP-TRANSLATE7)
    ...
    (CL:LET*
     ...
     (SET-DYNAMIC-SLOT-VALUE (%DYNAMIC-SLOTS FUNCTION)
      ...
      (WRAP-STRING "_Startup-Cpp-Translate") NULL-STRING-WRAPPER)))
