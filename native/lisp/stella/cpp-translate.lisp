...
(CL:DEFUN CPP-TRANSLATE-DEFINE-GLOBAL-VARIABLE-UNIT (UNIT)
  (CL:LET*
   ((GLOBAL (%THE-OBJECT UNIT)) (TYPE (GLOBAL-VARIABLE-TYPE-SPEC GLOBAL))
    ...
    (VARIABLENAME (CPP-TRANSLATE-GLOBAL-NAME (%VARIABLE-NAME GLOBAL))))
   (CL:COND
...
(CL:DEFUN CPP-TRANSLATE-AND-POINTERIZE-TYPE-SPEC (TYPESPEC)
  (CL:LET*
   ...
   (CL:WHEN (CREATE-NATIVE-CLASS? (%SURROGATE-VALUE BASETYPE))
  ...
  (CL:LET*
   ...
   (CL:WHEN (CL:= (LENGTH DIMENSIONS) 1)
    (CL:RETURN-FROM CPP-TRANSLATE-ARRAY-TYPE
     (WRAP-STRING
      (CONCATENATE (%WRAPPER-VALUE (CPP-TRANSLATE-TYPE-SPEC ELEMENTTYPE))
       "*"))))
   (CL:LET*
    ...
    ((PACKAGEPREFIX (CPP-PACKAGE SYMBOLMODULE))
     (PACKAGEPREFIXINHERITED?
      (CL:EQ
       ...
       STELLA::NULL-STRING))
     (RELATIVEMODULEPATH
      (CL:IF PACKAGEPREFIXINHERITED? (%MODULE-FULL-NAME SYMBOLMODULE)
       "")))
    (CL:DECLARE
...
(CL:DEFUN CPP-TRANSLATE-METHOD-NAME (METHOD)
  (CL:LET*
   ...
   (CL:DECLARE (CL:TYPE CL:SIMPLE-STRING TRANSLATEDNAME))
   (CL:SETQ TRANSLATEDNAME
    (%WRAPPER-VALUE (CPP-TRANSLATE-FUNCTION-NAME METHOD)))
...
(CL:DEFUN CPP-TRANSLATE-NORMAL-METHOD-CALL (METHODNAME OWNER ARGUMENTS REFERENCED?)
  (CL:LET*
   ((SLOT (SAFE-LOOKUP-SLOT (%SURROGATE-VALUE OWNER) METHODNAME))
