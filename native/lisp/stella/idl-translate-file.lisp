...
(CL:DECLAIM
 (CL:SPECIAL *STELLA-MODULE* *MODULE* FALSE NIL *TRANSLATIONUNITS*
...
(CL:DEFUN IDL-OUTPUT-ALL-UNITS-TO-FILE (SOURCEFILE)
  (CL:LET*
   ((CODEOUTPUTFILE (IDL-MAKE-CODE-OUTPUT-FILE-NAME SOURCEFILE))
    (CODEOUTPUTSTREAM (NEW-OUTPUT-FILE-STREAM CODEOUTPUTFILE)) (GLOBALS NIL)
    (METHODS NIL) (VERBATIMSTATEMENTS NIL) (FORMS NIL))
   (CL:LET* ((*CURRENT-STREAM* CODEOUTPUTSTREAM))
    ...
    (%%PRINT-STREAM (%NATIVE-STREAM STANDARD-OUTPUT) "Writing `" CODEOUTPUTFILE
     "'..." EOL)
    (%%PRINT-STREAM (%NATIVE-STREAM *CURRENT-STREAM*) "// " CODEOUTPUTFILE EOL
     EOL)
   ...
   (CL:WHEN (CURRENT-STARTUP-TIME-PHASE? 7)
    ...
    (CL:LET*
     ...
     (SET-DYNAMIC-SLOT-VALUE (%DYNAMIC-SLOTS FUNCTION)
      ...
      (WRAP-STRING "_Startup-Idl-Translate-File") NULL-STRING-WRAPPER)))
