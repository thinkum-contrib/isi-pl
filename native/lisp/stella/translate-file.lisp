...
(CL:DECLAIM
 (CL:SPECIAL *STELLA-MODULE* *SAFETY* *GENSYM-COUNTER* TRUE-WRAPPER FALSE-WRAPPER *CHARACTER-TYPE-TABLE*
  LOGICAL-HOST-SEPARATOR NULL-INTEGER LOGICAL-DIRECTORY-SEPARATOR *CURRENT-STELLA-FEATURES* NIL *CONTEXT*
  *TRANSLATIONUNITS* *TRANSLATIONPHASE* *TRANSLATOROUTPUTLANGUAGE* *TRANSLATIONVERBOSITYLEVEL* STANDARD-OUTPUT *MODULE*
      ...
      (CL:LET*
       ...
       (CL:COND
        ((STRING-EQL? TEST-VALUE-000 "IN-PACKAGE")
         (CL:RETURN-FROM HANDLE-IN-MODULE-TREE (CL:VALUES CL:T SEENINMODULE?)))
        ((STRING-EQL? TEST-VALUE-000 "IN-MODULE")
         (CL:WHEN (CL:AND SEENINMODULE? ERRORONINMODULE?)
          (CL:LET* ((*PRINTREADABLY?* CL:T)) (CL:DECLARE (CL:SPECIAL *PRINTREADABLY?*)) (SIGNAL-TRANSLATION-ERROR)
           (CL:WHEN (CL:NOT (SUPPRESS-WARNINGS?)) (PRINT-ERROR-CONTEXT ">> ERROR: " STANDARD-ERROR)
            (%%PRINT-STREAM (%NATIVE-STREAM STANDARD-ERROR) EOL " Additional IN-MODULE declaration: `"
         ...
         (CL:COND
          ((SUBTYPE-OF-STRING? (SAFE-PRIMARY-TYPE FIRSTARG))
           (CL:PROGN (CHANGE-MODULE (%WRAPPER-VALUE FIRSTARG)) (CL:SETQ SEENINMODULE? CL:T)))
          (CL:T
           (CL:LET* ((*PRINTREADABLY?* CL:T)) (CL:DECLARE (CL:SPECIAL *PRINTREADABLY?*)) (SIGNAL-TRANSLATION-WARNING)
            (CL:WHEN (CL:NOT (SUPPRESS-WARNINGS?)) (PRINT-ERROR-CONTEXT ">> WARNING: " STANDARD-WARNING)
             (%%PRINT-STREAM (%NATIVE-STREAM STANDARD-WARNING) EOL " Ignoring illegal IN-MODULE declaration: `"
              (DE-UGLIFY-PARSE-TREE TREE) "'." EOL)))))
         (CL:RETURN-FROM HANDLE-IN-MODULE-TREE (CL:VALUES CL:NIL SEENINMODULE?)))
          ...
          (CL:LET* ((*PRINTREADABLY?* CL:T)) (CL:DECLARE (CL:SPECIAL *PRINTREADABLY?*)) (SIGNAL-TRANSLATION-WARNING)
           (CL:WHEN (CL:NOT (SUPPRESS-WARNINGS?)) (PRINT-ERROR-CONTEXT ">> WARNING: " STANDARD-WARNING)
            (%%PRINT-STREAM (%NATIVE-STREAM STANDARD-WARNING) EOL
             " Missing IN-MODULE declaration, translating into module STELLA." EOL)))
  ...
  (CL:COND ((CL:EQ *TRANSLATOROUTPUTLANGUAGE* KWD-TRANSLATE-FILE-JAVA))
   (CL:T
    (CL:WHEN (CL:>= *TRANSLATIONVERBOSITYLEVEL* 1)
     (%%PRINT-STREAM (%NATIVE-STREAM STANDARD-OUTPUT) "Translating `" FILE "' to `" TARGETLANGUAGE "'..." EOL))
    (TRANSLATE-ALL-UNITS)))
...
(CL:DEFUN OPERATE-ON-FILE (FILE OPERATION)
  (CL:LET*
   ((TARGETLANGUAGE (%SYMBOL-NAME *TRANSLATOROUTPUTLANGUAGE*)) (CURRENTMODULE *MODULE*) (CURRENTCONTEXT *CONTEXT*)
   ...
   (CL:LET*
    ((*TRANSLATIONPHASE* NULL) (*TRANSLATIONERRORS* 0) (*TRANSLATIONWARNINGS* 0) (*TRANSLATIONNOTES* 0)
     (*CURRENTFILE* (FILE-BASE-NAME FILE)) (*MODULE* CURRENTMODULE) (*CONTEXT* CURRENTCONTEXT))
    (CL:DECLARE
     (CL:SPECIAL *TRANSLATIONPHASE* *TRANSLATIONERRORS* *TRANSLATIONWARNINGS* *TRANSLATIONNOTES* *CURRENTFILE* *MODULE*
      *CONTEXT*))
    ...
    (CL:WHEN (CL:>= *TRANSLATIONVERBOSITYLEVEL* 1)
     (%%PRINT-STREAM (%NATIVE-STREAM STANDARD-OUTPUT) "Processing `" FILE "':" EOL)
        ...
        (CL:COND
         ((CL:EQ (SAFE-PRIMARY-TYPE TREE) SGT-TRANSLATE-FILE-STELLA-CONS)
          (CL:PROGN (CL:MULTIPLE-VALUE-SETQ (SKIP? SEENINMODULE?) (HANDLE-IN-MODULE-TREE TREE SEENINMODULE? CL:T))
           (CL:WHEN (CL:NOT SKIP?)
            (CL:LET* ((*TRANSLATIONPHASE* KWD-TRANSLATE-FILE-DEFINE)) (CL:DECLARE (CL:SPECIAL *TRANSLATIONPHASE*))
             (WALK-TOP-LEVEL-TREE TREE CL:T)))))
         (CL:T))))))
    (REVERSE *TRANSLATIONUNITS*)
    (CL:WHEN (CL:NOT (CL:EQ OPERATION KWD-TRANSLATE-FILE-DEFINE))
     (CL:WHEN (CL:>= *TRANSLATIONVERBOSITYLEVEL* 1)
      (%%PRINT-STREAM (%NATIVE-STREAM STANDARD-OUTPUT) "*** Pass 2, finalizing objects..." EOL))
     ...
     (CL:WHEN (CL:NOT (CL:EQ OPERATION KWD-TRANSLATE-FILE-FINALIZE))
      (CL:WHEN (CL:>= *TRANSLATIONVERBOSITYLEVEL* 1)
       (%%PRINT-STREAM (%NATIVE-STREAM STANDARD-OUTPUT) "*** Pass 3, walking objects..." EOL))
      (CL:SETQ *TRANSLATIONPHASE* KWD-TRANSLATE-FILE-WALK)
      (CL:WHEN (CL:NOT (CL:OR (USE-HARDCODED-SYMBOLS?) (CL:EQ *TRANSLATOROUTPUTLANGUAGE* KWD-TRANSLATE-FILE-JAVA)))
       (CLEAR-SYMBOL-REGISTRY))
      (CL:LET* ((*USERECORDEDSIGNATURES?* *WALK-WITH-RECORDED-SIGNATURES?*))
       (CL:DECLARE (CL:SPECIAL *USERECORDEDSIGNATURES?*)) (WALK-ALL-PHASE-ONE-UNITS))
      ...
      (CL:WHEN *RECORD-SIGNATURES?*
       (%%PRINT-STREAM (%NATIVE-STREAM STANDARD-OUTPUT) "Recording object signatures..." EOL)
...
(CL:DEFUN TRANSLATE-FILE (FILE OUTPUTLANGUAGE ASPARTOFSYSTEM?)
  (CL:LET* ((MODE KWD-TRANSLATE-FILE-TRANSLATE))
   (CL:LET* ((*JAVA-INDENT-CHARS* 0) (*IDL-INDENT-CHARS* 0) (*CPP-INDENT-CHARS* 0))
    (CL:DECLARE (CL:SPECIAL *JAVA-INDENT-CHARS* *IDL-INDENT-CHARS* *CPP-INDENT-CHARS*))
    (CL:DECLARE (CL:TYPE CL:FIXNUM *JAVA-INDENT-CHARS* *IDL-INDENT-CHARS* *CPP-INDENT-CHARS*))
    (CL:COND
     ((CL:EQ OUTPUTLANGUAGE KWD-TRANSLATE-FILE-JAVA) (CL:WHEN ASPARTOFSYSTEM? (CL:SETQ MODE KWD-TRANSLATE-FILE-WALK)))
     (CL:T))
    (CL:IF ASPARTOFSYSTEM? (OPERATE-ON-FILE FILE MODE)
     (CL:LET* ((*TRANSLATOROUTPUTLANGUAGE* *TRANSLATOROUTPUTLANGUAGE*) (*TRANSLATIONUNITS* (NEW-LIST)))
      ...
      (%SET-TRANSLATOR-OUTPUT-LANGUAGE OUTPUTLANGUAGE) (OPERATE-ON-FILE FILE MODE)
  ...
  (CL:COND ((CL:EQ *TRANSLATOROUTPUTLANGUAGE* KWD-TRANSLATE-FILE-COMMON-LISP) (CL-OUTPUT-ALL-UNITS-TO-FILE SOURCEFILE))
   ((CL:EQ *TRANSLATOROUTPUTLANGUAGE* KWD-TRANSLATE-FILE-JAVA)
    (CL:LET* ((*JAVA-INDENT-CHARS* 0)) (CL:DECLARE (CL:SPECIAL *JAVA-INDENT-CHARS*))
     (CL:DECLARE (CL:TYPE CL:FIXNUM *JAVA-INDENT-CHARS*)) (JAVA-OUTPUT-ALL-UNITS-TO-FILE)))
   ((CL:EQ *TRANSLATOROUTPUTLANGUAGE* KWD-TRANSLATE-FILE-IDL)
    (CL:LET* ((*IDL-INDENT-CHARS* 0)) (CL:DECLARE (CL:SPECIAL *IDL-INDENT-CHARS*))
     (CL:DECLARE (CL:TYPE CL:FIXNUM *IDL-INDENT-CHARS*)) (IDL-OUTPUT-ALL-UNITS-TO-FILE SOURCEFILE)))
   ((CL:OR (CL:EQ *TRANSLATOROUTPUTLANGUAGE* KWD-TRANSLATE-FILE-CPP)
     (CL:EQ *TRANSLATOROUTPUTLANGUAGE* KWD-TRANSLATE-FILE-CPP-STANDALONE))
    (CL:LET* ((*CPP-INDENT-CHARS* 0)) (CL:DECLARE (CL:SPECIAL *CPP-INDENT-CHARS*))
     (CL:DECLARE (CL:TYPE CL:FIXNUM *CPP-INDENT-CHARS*)) (CPP-OUTPUT-ALL-UNITS-TO-FILE SOURCEFILE)))
   (CL:T
...
(CL:DEFUN TRANSLATE-WITH-COPYRIGHT-HEADER? ()
  (CL:RETURN-FROM TRANSLATE-WITH-COPYRIGHT-HEADER?
   (MEMB? *CURRENT-STELLA-FEATURES* KWD-TRANSLATE-FILE-TRANSLATE-WITH-COPYRIGHT-HEADER)))

;;; (DEFUN OUTPUT-COPYRIGHT-HEADER ...)

(CL:DEFUN OUTPUT-COPYRIGHT-HEADER (STREAM)
  (CL:WHEN
   (CL:OR (CL:NOT (TRANSLATE-WITH-COPYRIGHT-HEADER?)) (CL:EQ *CURRENTSYSTEMDEFINITION* NULL)
  ...
  (CL:COND
   ((CL:EQ *TRANSLATOROUTPUTLANGUAGE* KWD-TRANSLATE-FILE-COMMON-LISP) (%%PRINT-STREAM (%NATIVE-STREAM STREAM) "|#"))
   ((CL:OR (CL:EQ *TRANSLATOROUTPUTLANGUAGE* KWD-TRANSLATE-FILE-JAVA)
     (CL:EQ *TRANSLATOROUTPUTLANGUAGE* KWD-TRANSLATE-FILE-CPP)
     (CL:EQ *TRANSLATOROUTPUTLANGUAGE* KWD-TRANSLATE-FILE-CPP-STANDALONE))
...
(CL:DEFUN OUTPUT-FILE-HEADER (STREAM FILE)
  (CL:COND ((CL:EQ *TRANSLATOROUTPUTLANGUAGE* KWD-TRANSLATE-FILE-COMMON-LISP) (CL-OUTPUT-FILE-HEADER STREAM FILE CL:T))
   ...
   ((CL:EQ *TRANSLATOROUTPUTLANGUAGE* KWD-TRANSLATE-FILE-CPP) (CPP-OUTPUT-FILE-HEADER STREAM FILE))
...
(CL:DEFUN OPERATING-SYSTEM ()
  (CL:COND
   ((CL:OR (PROBE-FILE? "C:\\AUTOEXEC.BAT") (PROBE-FILE? "C:\\IO.SYS") (PROBE-FILE? "C:\\BOOT.INI")
     (STARTS-WITH? "" "win" 0))
    (CL:RETURN-FROM OPERATING-SYSTEM KWD-TRANSLATE-FILE-WINDOWS))
   ((CL:MEMBER :UNIX CL:*FEATURES*) (CL:RETURN-FROM OPERATING-SYSTEM KWD-TRANSLATE-FILE-UNIX))
...
the directory portion of `file'"
  (CL:LET* ((START 0) (LENGTH (CL:THE CL:FIXNUM (CL:LENGTH FILE))) (SEPARATOR (DIRECTORY-SEPARATOR-FOR-FILE FILE)))
   ...
   (CL:LOOP WHILE (CL:AND (CL:< START LENGTH) (CL:NOT (CL:= (POSITION FILE SEPARATOR START) NULL-INTEGER))) DO
...
directory separator."
  (CL:LET*
   ((SEPARATOR (DIRECTORY-SEPARATOR-FOR-FILE DIRECTORY)) (LAST (CL:1- (CL:THE CL:FIXNUM (CL:LENGTH DIRECTORY)))))
...
of the root directory."
  (CL:LET* ((SEPARATOR (DIRECTORY-SEPARATOR-FOR-FILE FILE)) (LAST (CL:1- (CL:THE CL:FIXNUM (CL:LENGTH FILE)))))
   (CL:DECLARE (CL:TYPE CL:FIXNUM LAST))
   (CL:IF
    (CL:OR (CL:< LAST 0)
     (CL:EQL
    ...
    (CL:RETURN-FROM FILE-NAME-AS-DIRECTORY (CONCATENATE FILE (MAKE-STRING 1 SEPARATOR))))))
...
but only looks for one-character device strings as used in Windows."
  (CL:LET* ((SEPARATOR #\:))
   (CL:IF
    ...
    (CL:RETURN-FROM FILE-NAME-WITHOUT-DEVICE (SUBSEQUENCE FILE 2 NULL-INTEGER))
...
directory and logical host components."
  (CL:LET* ((START 0) (SEPARATOR (DIRECTORY-SEPARATOR-FOR-FILE FILE))) (CL:DECLARE (CL:TYPE CL:FIXNUM START))
   (CL:IF (CL:EQL SEPARATOR LOGICAL-HOST-SEPARATOR) (CL:SETQ FILE (LOGICAL-PATHNAME-WITHOUT-HOST FILE))
    (CL:SETQ FILE (FILE-NAME-WITHOUT-DEVICE FILE)))
   (CL:LOOP WHILE (CL:NOT (CL:= (POSITION FILE SEPARATOR START) NULL-INTEGER)) DO
    (CL:SETQ START (CL:1+ (POSITION FILE SEPARATOR START))))
...
return the result."
  (CL:LET* ((START 0) (END NULL-INTEGER)) (CL:DECLARE (CL:TYPE CL:FIXNUM START END))
   (CL:LOOP WHILE (CL:NOT (CL:= (POSITION FILE TYPE-SEPARATOR START) NULL-INTEGER)) DO
    (CL:SETQ END (POSITION FILE TYPE-SEPARATOR START)) (CL:SETQ START (CL:1+ END)))
...
the separator character."
  (CL:LET* ((START 0) (END NULL-INTEGER)) (CL:DECLARE (CL:TYPE CL:FIXNUM START END))
   ...
   (CL:COND ((CL:= END NULL-INTEGER) (CL:RETURN-FROM FILE-EXTENSION STELLA::NULL-STRING))
    ((CL:NOT (CL:= (POSITION FILE (DIRECTORY-SEPARATOR-FOR-FILE FILE) END) NULL-INTEGER))
     ...
     ((CL:EQ PROPERTY KWD-TRANSLATE-FILE-ROOT-DIRECTORY) (INSERT-AT PROPERTIES PROPERTY NULL)
      (CL:WHEN (CL:NOT (CL:EQ VALUE NULL))
       (INSERT-AT PROPERTIES PROPERTY
        (WRAP-STRING (TRANSLATE-LOGICAL-PATHNAME (FILE-NAME-AS-DIRECTORY (%WRAPPER-VALUE VALUE)))))))
     ((CL:EQ PROPERTY KWD-TRANSLATE-FILE-LISP-TRANSLATIONS) (INSERT-AT PROPERTIES PROPERTY VALUE))
...
(CL:DEFUN LOOKUP-LOGICAL-HOST-PROPERTY (HOST PROPERTY)
  ...
  (CL:SETQ HOST (STRING-UPCASE HOST))
  (CL:LET* ((PROPERTIES (LOOKUP *LOGICAL-HOST-TABLE* HOST)))
   (CL:IF (CL:EQ PROPERTIES NULL) (CL:RETURN-FROM LOOKUP-LOGICAL-HOST-PROPERTY NULL)
    (CL:RETURN-FROM LOOKUP-LOGICAL-HOST-PROPERTY (LOOKUP PROPERTIES PROPERTY)))))
...
(CL:DEFUN ABSOLUTE-PATHNAME? (PATHNAME)
  ...
  (CL:LET* ((SEPARATOR (DIRECTORY-SEPARATOR)))
   (CL:COND
    ((LOGICAL-PATHNAME? PATHNAME) (CL:SETQ SEPARATOR LOGICAL-DIRECTORY-SEPARATOR)
...
(CL:DEFUN GET-LOGICAL-HOST-NAME (PATHNAME)
  ...
  (CL:LET* ((SEPARATORPOS (POSITION PATHNAME LOGICAL-HOST-SEPARATOR 0))) (CL:DECLARE (CL:TYPE CL:FIXNUM SEPARATORPOS))
   (CL:IF (CL:AND (CL:NOT (CL:= SEPARATORPOS NULL-INTEGER)) (CL:>= SEPARATORPOS 1))
    (CL:RETURN-FROM GET-LOGICAL-HOST-NAME (SUBSEQUENCE PATHNAME 0 SEPARATORPOS))
  ...
  (CL:LET* ((HOSTNAME (GET-LOGICAL-HOST-NAME PATHNAME))) (CL:DECLARE (CL:TYPE CL:SIMPLE-STRING HOSTNAME))
   (CL:IF (CL:EQ HOSTNAME STELLA::NULL-STRING) (CL:RETURN-FROM LOGICAL-PATHNAME-WITHOUT-HOST PATHNAME)
    (CL:RETURN-FROM LOGICAL-PATHNAME-WITHOUT-HOST
     (SUBSEQUENCE PATHNAME (CL:1+ (CL:THE CL:FIXNUM (CL:LENGTH HOSTNAME))) NULL-INTEGER)))))
...
(CL:DEFUN TRANSLATE-LOGICAL-PATHNAME (PATHNAME)
  ...
  (CL:LET* ((HOST (GET-LOGICAL-HOST-NAME PATHNAME)) (TRANSLATEDPATHNAME PATHNAME))
   (CL:DECLARE (CL:TYPE CL:SIMPLE-STRING HOST TRANSLATEDPATHNAME))
   (CL:LET*
    ((TRANSLATIONS (LOOKUP-LOGICAL-HOST-PROPERTY HOST KWD-TRANSLATE-FILE-LISP-TRANSLATIONS))
     (LTRANSLATIONS (CL:IGNORE-ERRORS (CL:LOGICAL-PATHNAME-TRANSLATIONS HOST))))
   ...
   (CL:SETQ TRANSLATEDPATHNAME
    (SUBSTITUTE (LOGICAL-PATHNAME-WITHOUT-HOST PATHNAME) (DIRECTORY-SEPARATOR) LOGICAL-DIRECTORY-SEPARATOR))
   (CL:LET* ((ROOTDIRECTORY (LOOKUP-LOGICAL-HOST-PROPERTY HOST KWD-TRANSLATE-FILE-ROOT-DIRECTORY)))
    (CL:WHEN (CL:NOT (CL:EQ ROOTDIRECTORY NULL))
     (CL:WHEN (ABSOLUTE-PATHNAME? TRANSLATEDPATHNAME)
      (CL:SETQ TRANSLATEDPATHNAME (SUBSEQUENCE TRANSLATEDPATHNAME 1 NULL-INTEGER)))
...
`defaults' if supplied and return the result."
  (CL:LET*
   ((BASESEPARATOR (DIRECTORY-SEPARATOR-FOR-FILE BASEFILE)) (BASEHOST (GET-LOGICAL-HOST-NAME BASEFILE))
    (BASEDIRECTORY (LOGICAL-PATHNAME-WITHOUT-HOST (FILE-NAME-DIRECTORY BASEFILE))) (BASENAME (FILE-BASE-NAME BASEFILE))
    (BASEEXTENSION (FILE-EXTENSION BASEFILE)) (DEFAULTSSEPARATOR (DIRECTORY-SEPARATOR-FOR-FILE DEFAULTS))
    (MERGED? CL:NIL) (RESULT NULL))
   (CL:DECLARE (CL:TYPE CL:SIMPLE-STRING BASEHOST BASEDIRECTORY BASEEXTENSION))
   (CL:WHEN
    (CL:AND (CL:NOT (CL:EQL BASESEPARATOR DEFAULTSSEPARATOR)) (MEMBER? BASEFILE BASESEPARATOR)
   ...
   (CL:WHEN (STRING-EQL? BASEDIRECTORY "")
    (CL:SETQ BASEDIRECTORY (LOGICAL-PATHNAME-WITHOUT-HOST (FILE-NAME-DIRECTORY DEFAULTS)))
   ...
   (CL:WHEN (CL:NOT (CL:EQ BASENAME STELLA::NULL-STRING)) (%%PRINT-STREAM (%NATIVE-STREAM RESULT) BASENAME))
...
(CL:DEFUN COMPUTE-COMMON-LISP-FILE-EXTENSION (TYPE)
  (CL:WHEN (CL:NOT (RUNNING-AS-LISP?))
   (CL:ERROR (NEW-STELLA-EXCEPTION "Shouldn't call COMPUTE-COMMON-LISP-FILE-EXTENSION unless running in Lisp")))
  (CL:LET* ((SUFFIX STELLA::NULL-STRING)) (CL:DECLARE (CL:TYPE CL:SIMPLE-STRING SUFFIX))
   (CL:COND
    ((CL:EQ TYPE KWD-TRANSLATE-FILE-LISP-BINARY)
     ...
     (CL:COND
      ((MEMB? *CURRENT-STELLA-FEATURES* KWD-TRANSLATE-FILE-USE-COMMON-LISP-STRUCTS)
       (CL:SETQ SUFFIX (CONCATENATE "s" SUFFIX)))
      ((MEMB? *CURRENT-STELLA-FEATURES* KWD-TRANSLATE-FILE-USE-COMMON-LISP-VECTOR-STRUCTS)
    ...
    ((CL:EQ TYPE KWD-TRANSLATE-FILE-LISP)
     (CL:COND ((MEMB? *CURRENT-STELLA-FEATURES* KWD-TRANSLATE-FILE-USE-COMMON-LISP-STRUCTS) (CL:SETQ SUFFIX ".slisp"))
      ((MEMB? *CURRENT-STELLA-FEATURES* KWD-TRANSLATE-FILE-USE-COMMON-LISP-VECTOR-STRUCTS) (CL:SETQ SUFFIX ".vslisp"))
    ...
    (CL:T
     (CL:LET* ((STREAM-000 (NEW-OUTPUT-STRING-STREAM)))
      (%%PRINT-STREAM (%NATIVE-STREAM STREAM-000) "`" TYPE "' is not a valid case option")
      (CL:ERROR (NEW-STELLA-EXCEPTION (THE-STRING-READER STREAM-000))))))
  ...
  (CL:LET* ((EXTENSION STELLA::NULL-STRING)) (CL:DECLARE (CL:TYPE CL:SIMPLE-STRING EXTENSION))
   (CL:LET* ((ENTRY NULL) (ITER-000 *TYPE-TO-FILE-EXTENSION-TABLE*))
    (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-000 NIL)) DO (CL:SETQ ENTRY (%%VALUE ITER-000))
     (CL:WHEN (CL:EQ (%%VALUE ENTRY) TYPE) (CL:SETQ EXTENSION (%WRAPPER-VALUE (%%VALUE (%%REST ENTRY)))))
     (CL:SETQ ITER-000 (%%REST ITER-000))))
   (CL:COND
    ((CL:EQ TYPE KWD-TRANSLATE-FILE-DIRECTORY) (CL:RETURN-FROM SELECT-FILE-EXTENSION (DIRECTORY-SEPARATOR-STRING)))
...
(CL:DEFUN CLASSIFY-FILE-EXTENSION (FILE)
  (CL:LET* ((EXTENSION (FILE-EXTENSION FILE))) (CL:DECLARE (CL:TYPE CL:SIMPLE-STRING EXTENSION))
   ...
   (CL:WHEN (RUNNING-AS-LISP?)
    (CL:WHEN (STRING-EQL? (COMPUTE-COMMON-LISP-FILE-EXTENSION KWD-TRANSLATE-FILE-LISP) EXTENSION)
   ...
   (CL:WHEN (STRING-EQL? (DEFAULT-COMMON-LISP-FILE-EXTENSION KWD-TRANSLATE-FILE-LISP) EXTENSION)
    (CL:RETURN-FROM CLASSIFY-FILE-EXTENSION KWD-TRANSLATE-FILE-LISP))
...
(CL:DEFUN SELECT-ROOT-DIRECTORY (TYPE)
  (CL:LET* ((ROOT STELLA::NULL-STRING)) (CL:DECLARE (CL:TYPE CL:SIMPLE-STRING ROOT))
   (CL:COND
    ((CL:OR (CL:EQ TYPE KWD-TRANSLATE-FILE-STELLA) (CL:EQ TYPE KWD-TRANSLATE-FILE-KB))
     (CL:SETQ ROOT (ROOT-SOURCE-DIRECTORY)))
    ((CL:OR (CL:EQ TYPE KWD-TRANSLATE-FILE-LISP-BINARY) (CL:EQ TYPE KWD-TRANSLATE-FILE-DIRECTORY))
...
(CL:DEFUN SELECT-SPLITTER-PATH (TYPE)
  (CL:LET* ((SPLITTERPATH "")) (CL:DECLARE (CL:TYPE CL:SIMPLE-STRING SPLITTERPATH))
   (CL:COND
    ((CL:OR (CL:EQ TYPE KWD-TRANSLATE-FILE-LISP) (CL:EQ TYPE KWD-TRANSLATE-FILE-COMMON-LISP))
     (CL:SETQ SPLITTERPATH *LISP-SPLITTER-PATH*))
    ((CL:EQ TYPE KWD-TRANSLATE-FILE-JAVA) (CL:SETQ SPLITTERPATH *JAVA-SPLITTER-PATH*))
    ((CL:OR (CL:EQ TYPE KWD-TRANSLATE-FILE-CPP) (CL:EQ TYPE KWD-TRANSLATE-FILE-CPP-HEADER)
      (CL:EQ TYPE KWD-TRANSLATE-FILE-CPP-CODE) (CL:EQ TYPE KWD-TRANSLATE-FILE-C-HEADER)
   ...
   (CL:WHEN (CL:NOT (STRING-EQL? SPLITTERPATH ""))
    (CL:SETQ SPLITTERPATH (CONCATENATE SPLITTERPATH (DIRECTORY-SEPARATOR-STRING))))
...
(CL:DEFUN ROOT-DIRECTORY-PREFIX (FILE)
  (CL:LET* ((EXTENSION (FILE-EXTENSION FILE))) (CL:DECLARE (CL:TYPE CL:SIMPLE-STRING EXTENSION))
   (CL:COND ((STRING-EQL? EXTENSION ".ste") (CL:RETURN-FROM ROOT-DIRECTORY-PREFIX (ROOT-SOURCE-DIRECTORY)))
    ((CL:OR (STRING-EQL? EXTENSION ".lisp") (STRING-EQL? EXTENSION ".java") (STRING-EQL? EXTENSION ".cc")
      (STRING-EQL? EXTENSION ".hh"))
    ...
    (RELATIVE? (CL:SETQ ROOTPATH (SELECT-ROOT-DIRECTORY TYPE)) (CL:SETQ SPLITTERPATH (SELECT-SPLITTER-PATH TYPE))
     ...
     (CL:IF
      (CL:OR (CL:EQ TYPE KWD-TRANSLATE-FILE-JAVA)
       (CL:AND (CL:OR (CL:EQ TYPE KWD-TRANSLATE-FILE-OTHER) (CL:EQ TYPE KWD-TRANSLATE-FILE-NONE))
        (CL:EQ *TRANSLATOROUTPUTLANGUAGE* KWD-TRANSLATE-FILE-JAVA)))
     ...
     (CL:LET* ((ROOTPREFIX (ROOT-DIRECTORY-PREFIX FILEPATH)))
      ...
      (CL:WHEN (CL:NOT (MEMBER? (GET-QUOTED-TREE "((:STELLA :KB) \"/STELLA\")" "/STELLA") TYPE))
       (CL:LET* ((RELATIVEPATH (RELATIVIZE-FILE-NAME FILEPATH ROOTPREFIX)))
        (CL:WHEN (CL:NOT (STRING-EQL? FILEPATH RELATIVEPATH)) (CL:SETQ ROOTPATH (SELECT-ROOT-DIRECTORY TYPE))
         (CL:SETQ SPLITTERPATH (SELECT-SPLITTER-PATH TYPE)) (CL:SETQ FILEPATH RELATIVEPATH)))))))
...
(CL:DEFUN RELATIVIZE-FILE-NAME (FILE ROOTPATH)
  (CL:LET* ((ABSOLUTE? (CL:= (STRING-SEARCH FILE ROOTPATH 0) 0)))
   (CL:IF ABSOLUTE?
    (CL:RETURN-FROM RELATIVIZE-FILE-NAME (SUBSEQUENCE FILE (CL:THE CL:FIXNUM (CL:LENGTH ROOTPATH)) NULL-INTEGER))
    ...
    ((CL:EQ (SAFE-PRIMARY-TYPE FILEPATH) SGT-TRANSLATE-FILE-STELLA-CONS)
     (CL:PROGN
      (CL:LET* ((PATH-LENGTH (LENGTH FILEPATH))) (CL:DECLARE (CL:TYPE CL:FIXNUM PATH-LENGTH)) (CL:SETQ FILE "")
       (CL:LET*
        ((NAME NULL) (ITER-000 FILEPATH) (N NULL-INTEGER) (ITER-001 1) (UPPER-BOUND-000 PATH-LENGTH)
         (UNBOUNDED?-000 (CL:= UPPER-BOUND-000 NULL-INTEGER)))
        (CL:DECLARE (CL:TYPE CL:FIXNUM N ITER-001 UPPER-BOUND-000))
        (CL:LOOP WHILE (CL:AND (CL:NOT (CL:EQ ITER-000 NIL)) (CL:OR UNBOUNDED?-000 (CL:<= ITER-001 UPPER-BOUND-000)))
...
(CL:DEFUN LANGUAGE-TO-FILE-TYPE (LANGUAGE)
  (CL:COND
   ((CL:EQ LANGUAGE KWD-TRANSLATE-FILE-COMMON-LISP) (CL:RETURN-FROM LANGUAGE-TO-FILE-TYPE KWD-TRANSLATE-FILE-LISP))
   ((CL:EQ LANGUAGE KWD-TRANSLATE-FILE-CPP) (CL:RETURN-FROM LANGUAGE-TO-FILE-TYPE KWD-TRANSLATE-FILE-CPP-CODE))
   ...
   (CL:IF ABSOLUTE?
    (CL:IF (STRING-EQL? FROMROOT TOROOT) (CL:RETURN-FROM REROOT-FILE-NAME FILE)
     (CL:RETURN-FROM REROOT-FILE-NAME
      (CONCATENATE TOROOT (SUBSEQUENCE FILE (CL:THE CL:FIXNUM (CL:LENGTH FROMROOT)) NULL-INTEGER))))
...
(CL:DEFUN STELLA-NEED-TO-TRANSLATE? (FILE LANGUAGE)
  ...
  (CL:LET*
   ...
   (CL:RETURN-FROM STELLA-NEED-TO-TRANSLATE?
    (CL:AND (PROBE-FILE? SOURCEFILE) (CL:NOT (CL:EQ (FILE-YOUNGER-THAN? TRANSLATEDFILE SOURCEFILE) TRUE-WRAPPER))))))
   ...
   (CL:IF (CL:NOT (CL:EQ *CURRENTSYSTEMDEFINITION* NULL))
    (CL:PROGN
     (CL:LET* ((FOUND?-000 CL:NIL))
      (CL:LET* ((FILE NULL) (ITER-000 (SYSTEM-DEFINITION-SOURCE-FILES *CURRENTSYSTEMDEFINITION*)))
       (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-000 NIL)) DO (CL:SETQ FILE (%%VALUE ITER-000))
        (CL:WHEN (STELLA-NEED-TO-TRANSLATE? FILE LANGUAGE) (CL:SETQ FOUND?-000 CL:T) (CL:RETURN))
        (CL:SETQ ITER-000 (%%REST ITER-000))))
     ...
     (CL:LET* ((STARTUP-FILE (SYSTEM-STARTUP-FILE-NAME NULL))) (CL:DECLARE (CL:TYPE CL:SIMPLE-STRING STARTUP-FILE))
      (CL:WHEN (CL:NOT (PROBE-FILE? (MAKE-FILE-NAME STARTUP-FILE KWD-TRANSLATE-FILE-STELLA CL:T)))
  ...
  (CL:LET* ((HEAD (CONS NULL NIL)) (CURSOR HEAD))
   (CL:LET* ((FILE NULL) (UNITS NULL) (ITER-000 (%THE-KV-LIST SYSTEMUNITS)))
    (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-000 NULL)) DO (CL:SETQ FILE (%KEY ITER-000)) (CL:SETQ UNITS (%VALUE ITER-000))
     (CL:SETQ FILE FILE)
     (CL:WHEN (NON-EMPTY? UNITS) (CONCATENATE CURSOR (%THE-CONS-LIST UNITS)) (CL:SETQ CURSOR (%THE-CONS-LIST UNITS)))
     (CL:SETQ ITER-000 (%REST ITER-000))))
  ...
  (CL:LET*
   ((OPTIONS |LANGUAGE&OPTIONS|)
    ...
    (PLIST
     (VET-OPTIONS (CL:IF (CL:EQ (%%VALUE OPTIONS) LANGUAGE) (%%REST OPTIONS) OPTIONS)
      (GET-QUOTED-TREE
       "((:TWO-PASS? :FORCE-TRANSLATION? :PRODUCTION-SETTINGS? :DEVELOPMENT-SETTINGS? :LANGUAGE :ACTION) \"/STELLA\")"
       "/STELLA")))
    (TWOPASS? CL:NIL) (FORCETRANSLATION? CL:NIL) (PRODUCTIONMODE? CL:T))
   (CL:SETQ LANGUAGE (LOOKUP-WITH-DEFAULT PLIST KWD-TRANSLATE-FILE-LANGUAGE LANGUAGE))
   (INSERT-AT PLIST KWD-TRANSLATE-FILE-LANGUAGE LANGUAGE)
   (INSERT-AT PLIST KWD-TRANSLATE-FILE-ACTION
    (LOOKUP-WITH-DEFAULT PLIST KWD-TRANSLATE-FILE-ACTION KWD-TRANSLATE-FILE-TRANSLATE-SYSTEM))
   ...
   (CL:LET*
    ((*TRANSLATOROUTPUTLANGUAGE* *TRANSLATOROUTPUTLANGUAGE*) (*TRANSLATIONPHASE* NULL) (*SAFETY* *SAFETY*)
     (*RECYCLING-ENABLED?* (CL:NOT (CL:EQ LANGUAGE KWD-TRANSLATE-FILE-JAVA)))
     (*CURRENT-STELLA-FEATURES* (COPY *CURRENT-STELLA-FEATURES*)) (*CURRENT-SYSTEM-ACTION* (COPY PLIST)))
    (CL:DECLARE
     (CL:SPECIAL *TRANSLATOROUTPUTLANGUAGE* *TRANSLATIONPHASE* *SAFETY* *RECYCLING-ENABLED?* *CURRENT-STELLA-FEATURES*
      *CURRENT-SYSTEM-ACTION*))
    (CL:DECLARE (CL:TYPE CL:FIXNUM *SAFETY*))
    (CL:WHEN (CL:NOT (SYSTEM-LOADED-OR-STARTED-UP? SYSTEMNAME)) (CL:SETQ TWOPASS? CL:T)) (CL:SETQ *GENSYM-COUNTER* -1)
    (%SET-STELLA-FEATURE
     (CONS-LIST KWD-TRANSLATE-FILE-TRANSLATE-WITH-COPYRIGHT-HEADER KWD-TRANSLATE-FILE-WARN-ABOUT-MISSING-METHODS
      KWD-TRANSLATE-FILE-WARN-ABOUT-UNDEFINED-METHODS))
    (%UNSET-STELLA-FEATURE (CONS-LIST KWD-TRANSLATE-FILE-USE-HARDCODED-SYMBOLS))
    ...
    (CL:LET*
     ...
     (CL:IF (CL:NOT (CL:EQ *CURRENTSYSTEMDEFINITION* NULL))
      (CL:PROGN (COMPUTE-OPTIMIZATION-LEVELS *CURRENTSYSTEMDEFINITION* PRODUCTIONMODE?)
       (CL:LET*
        ((FILES (FILES-PLUS-SYSTEM-STARTUP (SYSTEM-DEFINITION-SOURCE-FILES *CURRENTSYSTEMDEFINITION*)))
         (TRANSLATEDSOMETHING? CL:NIL))
        (CL:WHEN (CL:OR FORCETRANSLATION? (SYSTEM-NEEDS-TRANSLATION? SYSTEMNAME LANGUAGE))
        ...
        (TRANSFER-NATIVE-SYSTEM-FILES LANGUAGE) (TRANSFER-DATA-FILES LANGUAGE)
...
(CL:DEFUN TRANSLATE-SYSTEM-EVALUATOR-WRAPPER (ARGUMENTS)
  (CL:RETURN-FROM TRANSLATE-SYSTEM-EVALUATOR-WRAPPER
   (CL:IF (%TRANSLATE-SYSTEM (%WRAPPER-VALUE (%%VALUE ARGUMENTS)) (%%REST ARGUMENTS)) TRUE-WRAPPER FALSE-WRAPPER)))
...
(CL:DEFUN HELP-TRANSLATE-SYSTEM (FILES TWOPASS? FORCETRANSLATION?)
  (CL:LET* ((*TRANSLATIONUNITS* (NEW-LIST))) (CL:DECLARE (CL:SPECIAL *TRANSLATIONUNITS*))
   (CL:LET*
    ((OUTPUTLANGUAGE *TRANSLATOROUTPUTLANGUAGE*) (FILENAME STELLA::NULL-STRING) (TRANSLATEDFILE? CL:NIL)
    ...
    (CL:WHEN TWOPASS?
     (CL:LET* ((FILE NULL) (ITER-000 FILES))
      (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-000 NIL)) DO (CL:SETQ FILE (%%VALUE ITER-000))
       (CL:TAGBODY
        (CL:WHEN
         (CL:OR FORCETRANSLATION? (STELLA-NEED-TO-TRANSLATE? FILE OUTPUTLANGUAGE)
         ...
         (CL:WHEN (CL:NOT (PROBE-FILE? FILENAME))
          (%%PRINT-STREAM (%NATIVE-STREAM STANDARD-OUTPUT) "Warning: File `" FILENAME "' does not exist." EOL)
          (CL:GO :CONTINUE))
         (OPERATE-ON-FILE FILENAME KWD-TRANSLATE-FILE-DEFINE) (CLEAN-UP-TRANSLATION-UNITS-SPECIAL)
     ...
     (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-001 NIL)) DO (CL:SETQ FILE (%%VALUE ITER-001))
      (CL:TAGBODY
       (CL:WHEN (CL:OR FORCETRANSLATION? (STELLA-NEED-TO-TRANSLATE? FILE OUTPUTLANGUAGE))
        ...
        (INSERT-AT WALKEDUNITS (WRAP-STRING FILENAME) *TRANSLATIONUNITS*) (CL:SETQ *TRANSLATIONUNITS* (NEW-LIST)))
       :CONTINUE)
    ...
    (CL:COND ((CL:EQ OUTPUTLANGUAGE KWD-TRANSLATE-FILE-COMMON-LISP) (CL-TRANSLATE-WALKED-SYSTEM-UNITS WALKEDUNITS))
     ...
     (CL:T
      (CL:LET* ((STREAM-000 (NEW-OUTPUT-STRING-STREAM)))
       (%%PRINT-STREAM (%NATIVE-STREAM STREAM-000) "`" OUTPUTLANGUAGE "' is not a valid case option")
       (CL:ERROR (NEW-STELLA-EXCEPTION (THE-STRING-READER STREAM-000))))))
  ...
  (CL:LET* ((NATIVE-FILES NULL))
   (CL:COND
    ((CL:EQ OUTPUT-LANGUAGE KWD-TRANSLATE-FILE-COMMON-LISP)
     (CL:SETQ NATIVE-FILES (%LISP-ONLY-FILES *CURRENTSYSTEMDEFINITION*)))
    ((CL:EQ OUTPUT-LANGUAGE KWD-TRANSLATE-FILE-JAVA)
     (CL:SETQ NATIVE-FILES (%JAVA-ONLY-FILES *CURRENTSYSTEMDEFINITION*)))
    ((CL:EQ OUTPUT-LANGUAGE KWD-TRANSLATE-FILE-CPP) (CL:SETQ NATIVE-FILES (%CPP-ONLY-FILES *CURRENTSYSTEMDEFINITION*)))
    (CL:T
     (CL:LET* ((STREAM-000 (NEW-OUTPUT-STRING-STREAM)))
      (%%PRINT-STREAM (%NATIVE-STREAM STREAM-000) "`" OUTPUT-LANGUAGE "' is not a valid case option")
      (CL:ERROR (NEW-STELLA-EXCEPTION (THE-STRING-READER STREAM-000))))))
   (CL:WHEN (CL:NOT (CL:EQ NATIVE-FILES NULL))
    (CL:SETQ NATIVE-FILES (DIFFERENCE NATIVE-FILES (SYSTEM-DEFINITION-SOURCE-FILES *CURRENTSYSTEMDEFINITION*)))
...
(CL:DEFUN TRANSFER-DATA-FILES (OUTPUT-LANGUAGE)
  (CL:LET* ((DATA-FILES (%DATA-FILES *CURRENTSYSTEMDEFINITION*)))
   (CL:WHEN (CL:NOT (CL:EQ DATA-FILES NULL)) (TRANSFER-FILES DATA-FILES OUTPUT-LANGUAGE)))
  :VOID)
...
(CL:DEFUN TRANSFER-FILES (FILES OUTPUT-LANGUAGE)
  ...
  (CL:LET*
   ...
   (CL:WHEN (CL:EQ OUTPUT-LANGUAGE KWD-TRANSLATE-FILE-JAVA)
    (CL:SETQ FLOTSAMFILENAME (JAVA-YIELD-FLOTSAM-CLASS-NAME (GET-CARDINAL-MODULE *CURRENTSYSTEMDEFINITION*))))
   (CL:LET* ((*MODULE* (GET-CARDINAL-MODULE *CURRENTSYSTEMDEFINITION*)) (*CONTEXT* *MODULE*))
    (CL:DECLARE (CL:SPECIAL *MODULE* *CONTEXT*))
    (CL:LET* ((F NULL) (ITER-000 FILES))
     (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-000 NIL)) DO (CL:SETQ F (%%VALUE ITER-000))
      (CL:LET*
       ((FILENAME (%WRAPPER-VALUE F)) (TYPE (CLASSIFY-FILE-EXTENSION FILENAME))
        (RELATIVEFILENAME (RELATIVIZE-FILE-NAME FILENAME (ROOT-SOURCE-DIRECTORY))) (FROMFILENAME STELLA::NULL-STRING)
       ...
       (CL:COND
        ...
        (CL:T))
       (CL:SETQ FROMFILENAME (CONCATENATE (ROOT-SOURCE-DIRECTORY) SYSTEM-SUB-DIRECTORY FILENAME))
       ...
       (CL:WHEN (CL:NOT (CL:EQ (FILE-YOUNGER-THAN? TOFILENAME FROMFILENAME) TRUE-WRAPPER))
        (CL:WHEN (CL:>= *TRANSLATIONVERBOSITYLEVEL* 1)
         (%%PRINT-STREAM (%NATIVE-STREAM STANDARD-OUTPUT) "Copying `" FROMFILENAME "'" EOL " to `" TOFILENAME "' ..."
          EOL))
...
(CL:DEFUN HELP-STARTUP-TRANSLATE-FILE1 ()
  (CL:PROGN (CL:SETQ KWD-TRANSLATE-FILE-TRANSLATE (INTERN-RIGID-SYMBOL-WRT-MODULE "TRANSLATE" NULL 2))
   ...
   (CL:SETQ KWD-TRANSLATE-FILE-IDL (INTERN-RIGID-SYMBOL-WRT-MODULE "IDL" NULL 2))
   (CL:SETQ KWD-TRANSLATE-FILE-DEFINE (INTERN-RIGID-SYMBOL-WRT-MODULE "DEFINE" NULL 2))
   ...
   (CL:SETQ KWD-TRANSLATE-FILE-UNIX (INTERN-RIGID-SYMBOL-WRT-MODULE "UNIX" NULL 2))
   (CL:SETQ KWD-TRANSLATE-FILE-MAC (INTERN-RIGID-SYMBOL-WRT-MODULE "MAC" NULL 2))
   ...
   (CL:SETQ KWD-TRANSLATE-FILE-STELLA (INTERN-RIGID-SYMBOL-WRT-MODULE "STELLA" NULL 2))
   (CL:SETQ KWD-TRANSLATE-FILE-KB (INTERN-RIGID-SYMBOL-WRT-MODULE "KB" NULL 2))
   ...
   (CL:SETQ KWD-TRANSLATE-FILE-OTHER (INTERN-RIGID-SYMBOL-WRT-MODULE "OTHER" NULL 2))
   (CL:SETQ KWD-TRANSLATE-FILE-NONE (INTERN-RIGID-SYMBOL-WRT-MODULE "NONE" NULL 2))
...
(CL:DEFUN HELP-STARTUP-TRANSLATE-FILE2 ()
  (CL:PROGN
   (DEFINE-FUNCTION-OBJECT "ROOT-SOURCE-DIRECTORY" "(DEFUN (ROOT-SOURCE-DIRECTORY FILE-NAME) ())"
    (CL:FUNCTION ROOT-SOURCE-DIRECTORY) NULL)
   (DEFINE-FUNCTION-OBJECT "ROOT-NATIVE-DIRECTORY" "(DEFUN (ROOT-NATIVE-DIRECTORY FILE-NAME) ())"
    (CL:FUNCTION ROOT-NATIVE-DIRECTORY) NULL)
   (DEFINE-FUNCTION-OBJECT "ROOT-BINARY-DIRECTORY" "(DEFUN (ROOT-BINARY-DIRECTORY FILE-NAME) ())"
    (CL:FUNCTION ROOT-BINARY-DIRECTORY) NULL)
   (DEFINE-FUNCTION-OBJECT "SYSTEM-DEFINITIONS-DIRECTORY" "(DEFUN (SYSTEM-DEFINITIONS-DIRECTORY FILE-NAME) ())"
   ...
   (DEFINE-FUNCTION-OBJECT "OPERATE-ON-FILE" "(DEFUN OPERATE-ON-FILE ((FILE FILE-NAME) (OPERATION KEYWORD)))"
    (CL:FUNCTION OPERATE-ON-FILE) NULL)
   (DEFINE-FUNCTION-OBJECT "CLEAN-UP-TRANSLATION-UNITS-SPECIAL" "(DEFUN CLEAN-UP-TRANSLATION-UNITS-SPECIAL ())"
   ...
   (DEFINE-FUNCTION-OBJECT "OUTPUT-ALL-UNITS-TO-FILE" "(DEFUN OUTPUT-ALL-UNITS-TO-FILE ((SOURCEFILE FILE-NAME)))"
    (CL:FUNCTION OUTPUT-ALL-UNITS-TO-FILE) NULL)
   (DEFINE-FUNCTION-OBJECT "RECORD-SIGNATURES-OF-ALL-UNITS"
    "(DEFUN RECORD-SIGNATURES-OF-ALL-UNITS ((SOURCEFILE FILE-NAME)))" (CL:FUNCTION RECORD-SIGNATURES-OF-ALL-UNITS)
    NULL)
   (DEFINE-FUNCTION-OBJECT "TRANSLATE-WITH-COPYRIGHT-HEADER?" "(DEFUN (TRANSLATE-WITH-COPYRIGHT-HEADER? BOOLEAN) ())"
    (CL:FUNCTION TRANSLATE-WITH-COPYRIGHT-HEADER?) NULL)
   (DEFINE-FUNCTION-OBJECT "OUTPUT-COPYRIGHT-HEADER" "(DEFUN OUTPUT-COPYRIGHT-HEADER ((STREAM OUTPUT-STREAM)))"
    (CL:FUNCTION OUTPUT-COPYRIGHT-HEADER) NULL)
   (DEFINE-FUNCTION-OBJECT "OUTPUT-FILE-HEADER" "(DEFUN OUTPUT-FILE-HEADER ((STREAM OUTPUT-STREAM) (FILE FILE-NAME)))"
    (CL:FUNCTION OUTPUT-FILE-HEADER) NULL)
   (DEFINE-FUNCTION-OBJECT "OPERATING-SYSTEM" "(DEFUN (OPERATING-SYSTEM KEYWORD) ())" (CL:FUNCTION OPERATING-SYSTEM)
    NULL)
   (DEFINE-FUNCTION-OBJECT "DIRECTORY-SEPARATOR" "(DEFUN (DIRECTORY-SEPARATOR CHARACTER) ())"
    (CL:FUNCTION DIRECTORY-SEPARATOR) NULL)
   (DEFINE-FUNCTION-OBJECT "DIRECTORY-SEPARATOR-STRING" "(DEFUN (DIRECTORY-SEPARATOR-STRING STRING) ())"
    (CL:FUNCTION DIRECTORY-SEPARATOR-STRING) NULL)
   (DEFINE-FUNCTION-OBJECT "DIRECTORY-SEPARATOR-FOR-FILE"
    "(DEFUN (DIRECTORY-SEPARATOR-FOR-FILE CHARACTER) ((FILE FILE-NAME)))" (CL:FUNCTION DIRECTORY-SEPARATOR-FOR-FILE)
    NULL)
...
`CL:translate-logical-pathname' for more complex translation operations.\" :PUBLIC? TRUE)"
   ...
   (DEFINE-FUNCTION-OBJECT "LOGICAL-HOST?" "(DEFUN (LOGICAL-HOST? BOOLEAN) ((HOST STRING)))"
    (CL:FUNCTION LOGICAL-HOST?) NULL)
   (DEFINE-FUNCTION-OBJECT "LOGICAL-PATHNAME?" "(DEFUN (LOGICAL-PATHNAME? BOOLEAN) ((PATHNAME STRING)))"
    (CL:FUNCTION LOGICAL-PATHNAME?) NULL)
   (DEFINE-FUNCTION-OBJECT "ABSOLUTE-PATHNAME?" "(DEFUN (ABSOLUTE-PATHNAME? BOOLEAN) ((PATHNAME STRING)))"
    (CL:FUNCTION ABSOLUTE-PATHNAME?) NULL)
   (DEFINE-FUNCTION-OBJECT "GET-LOGICAL-HOST-NAME" "(DEFUN (GET-LOGICAL-HOST-NAME STRING) ((PATHNAME STRING)))"
    (CL:FUNCTION GET-LOGICAL-HOST-NAME) NULL)
   (DEFINE-FUNCTION-OBJECT "LOGICAL-PATHNAME-WITHOUT-HOST"
    "(DEFUN (LOGICAL-PATHNAME-WITHOUT-HOST STRING) ((PATHNAME STRING)))" (CL:FUNCTION LOGICAL-PATHNAME-WITHOUT-HOST)
    NULL)
   (DEFINE-FUNCTION-OBJECT "TRANSLATE-LOGICAL-PATHNAME"
    "(DEFUN (TRANSLATE-LOGICAL-PATHNAME STRING) ((PATHNAME STRING)))" (CL:FUNCTION TRANSLATE-LOGICAL-PATHNAME) NULL)
...
`defaults' if supplied and return the result.\" :PUBLIC? TRUE)" (CL:FUNCTION MERGE-FILE-NAMES) NULL)
   ...
   (DEFINE-FUNCTION-OBJECT "SELECT-FILE-EXTENSION" "(DEFUN (SELECT-FILE-EXTENSION STRING) ((TYPE KEYWORD)))"
    (CL:FUNCTION SELECT-FILE-EXTENSION) NULL)
   (DEFINE-FUNCTION-OBJECT "CLASSIFY-FILE-EXTENSION" "(DEFUN (CLASSIFY-FILE-EXTENSION KEYWORD) ((FILE FILE-NAME)))"
    (CL:FUNCTION CLASSIFY-FILE-EXTENSION) NULL)
   (DEFINE-FUNCTION-OBJECT "SELECT-ROOT-DIRECTORY" "(DEFUN (SELECT-ROOT-DIRECTORY STRING) ((TYPE KEYWORD)))"
    (CL:FUNCTION SELECT-ROOT-DIRECTORY) NULL)
   (DEFINE-FUNCTION-OBJECT "SELECT-SPLITTER-PATH" "(DEFUN (SELECT-SPLITTER-PATH STRING) ((TYPE KEYWORD)))"
   ...
   (DEFINE-FUNCTION-OBJECT "ROOT-DIRECTORY-PREFIX" "(DEFUN (ROOT-DIRECTORY-PREFIX FILE-NAME) ((FILE FILE-NAME)))"
   ...
   (DEFINE-FUNCTION-OBJECT "HELP-IMPLODE-PATHNAME" "(DEFUN (HELP-IMPLODE-PATHNAME FILE-NAME) ((FILENAME FILE-NAME)))"
    (CL:FUNCTION HELP-IMPLODE-PATHNAME) NULL)
   (DEFINE-FUNCTION-OBJECT "IMPLODE-PATHNAME" "(DEFUN (IMPLODE-PATHNAME FILE-NAME) ((FILEPATH OBJECT)))"
    (CL:FUNCTION IMPLODE-PATHNAME) NULL)
   (DEFINE-FUNCTION-OBJECT "MAYBE-TRUNCATE-FILENAME"
    "(DEFUN (MAYBE-TRUNCATE-FILENAME FILE-NAME) ((BAREFILENAME FILE-NAME)))" (CL:FUNCTION MAYBE-TRUNCATE-FILENAME)
    NULL)
   (DEFINE-FUNCTION-OBJECT "LANGUAGE-TO-FILE-TYPE" "(DEFUN (LANGUAGE-TO-FILE-TYPE KEYWORD) ((LANGUAGE KEYWORD)))"
   ...
   (DEFINE-FUNCTION-OBJECT "STELLA-NEED-TO-COMPILE?" "(DEFUN (STELLA-NEED-TO-COMPILE? BOOLEAN) ((FILE OBJECT)))"
...
`:production-settings?' (default true): inverse to `:development-settings?'.\" :PUBLIC? TRUE :COMMAND? TRUE)"
    (CL:FUNCTION %TRANSLATE-SYSTEM) (CL:FUNCTION TRANSLATE-SYSTEM-EVALUATOR-WRAPPER))
...
(CL:DEFUN STARTUP-TRANSLATE-FILE ()
  (CL:WHEN (CURRENT-STARTUP-TIME-PHASE? 0) (CL:SETQ *LOGICAL-HOST-TABLE* (NEW-STRING-HASH-TABLE))
  ...
  (CL:LET* ((*MODULE* *STELLA-MODULE*) (*CONTEXT* *MODULE*)) (CL:DECLARE (CL:SPECIAL *MODULE* *CONTEXT*))
   ...
   (CL:WHEN (CURRENT-STARTUP-TIME-PHASE? 4) (CL:SETQ *SYSTEMDEFINITIONSDIRECTORY* STELLA::NULL-STRING)
    (CL:SETQ *OS* (OPERATING-SYSTEM))
    (CL:SETQ *TYPE-TO-FILE-EXTENSION-TABLE*
     (LIST* (LIST* KWD-TRANSLATE-FILE-STELLA (WRAP-STRING ".ste") NIL)
      (LIST* KWD-TRANSLATE-FILE-KB (WRAP-STRING ".kb") NIL) (LIST* KWD-TRANSLATE-FILE-CPP (WRAP-STRING ".cc") NIL)
      ...
      (LIST* KWD-TRANSLATE-FILE-JAVA (WRAP-STRING ".java") NIL) (LIST* KWD-TRANSLATE-FILE-IDL (WRAP-STRING ".idl") NIL)
      (LIST* KWD-TRANSLATE-FILE-OTHER (WRAP-STRING "") NIL) (LIST* KWD-TRANSLATE-FILE-NONE (WRAP-STRING "") NIL) NIL)))
   ...
   (CL:WHEN (CURRENT-STARTUP-TIME-PHASE? 7) (HELP-STARTUP-TRANSLATE-FILE2)
    (DEFINE-FUNCTION-OBJECT "TRANSFER-NATIVE-SYSTEM-FILES"
     "(DEFUN TRANSFER-NATIVE-SYSTEM-FILES ((OUTPUT-LANGUAGE KEYWORD)))" (CL:FUNCTION TRANSFER-NATIVE-SYSTEM-FILES)
     NULL)
    (DEFINE-FUNCTION-OBJECT "TRANSFER-DATA-FILES" "(DEFUN TRANSFER-DATA-FILES ((OUTPUT-LANGUAGE KEYWORD)))"
     (CL:FUNCTION TRANSFER-DATA-FILES) NULL)
    (DEFINE-FUNCTION-OBJECT "TRANSFER-FILES"
     "(DEFUN TRANSFER-FILES ((FILES (CONS OF STRING-WRAPPER)) (OUTPUT-LANGUAGE KEYWORD)))" (CL:FUNCTION TRANSFER-FILES)
     NULL)
    (DEFINE-FUNCTION-OBJECT "STARTUP-TRANSLATE-FILE" "(DEFUN STARTUP-TRANSLATE-FILE () :PUBLIC? TRUE)"
     (CL:FUNCTION STARTUP-TRANSLATE-FILE) NULL)
    (CL:LET* ((FUNCTION (LOOKUP-FUNCTION SYM-TRANSLATE-FILE-STELLA-STARTUP-TRANSLATE-FILE)))
     (SET-DYNAMIC-SLOT-VALUE (%DYNAMIC-SLOTS FUNCTION) SYM-TRANSLATE-FILE-STELLA-METHOD-STARTUP-CLASSNAME
...
conventions are being observed by the software.\")")
    ...
    (REGISTER-NATIVE-NAME SYM-TRANSLATE-FILE-STELLA-TRANSLATE-SYSTEM KWD-TRANSLATE-FILE-COMMON-LISP
     KWD-TRANSLATE-FILE-FUNCTION)))
  :VOID)
