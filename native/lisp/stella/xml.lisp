...
(CL:DECLAIM
 (CL:SPECIAL *STELLA-MODULE* *MODULE* EOL NULL-CHARACTER TRUE-WRAPPER FALSE-WRAPPER STANDARD-INPUT
  *CHARACTER-TYPE-TABLE* NULL-INTEGER NIL))
...
(CL:DEFUN NEW-XML-OBJECT ()
  (CL:LET* ((SELF NULL)) (CL:SETQ SELF (CL:MAKE-INSTANCE (CL:QUOTE XML-OBJECT)))
   (CL:SETF (%SURFACE-FORM SELF) STELLA::NULL-STRING) (CL:SETF (%NAME SELF) STELLA::NULL-STRING)
...
(CL:DEFUN ACCESS-XML-OBJECT-SLOT-VALUE (SELF SLOTNAME VALUE SETVALUE?)
  (CL:COND
   ...
   ((CL:EQ SLOTNAME SYM-XML-STELLA-SURFACE-FORM)
    (CL:IF SETVALUE? (CL:SETF (%SURFACE-FORM SELF) (%WRAPPER-VALUE VALUE))
     (CL:SETQ VALUE (WRAP-STRING (%SURFACE-FORM SELF)))))
   (CL:T
...
(CL:DEFCLASS XML-ELEMENT (XML-OBJECT)
  ((NAMESPACE-NAME :TYPE CL:SIMPLE-STRING :INITFORM STELLA::NULL-STRING :ALLOCATION :INSTANCE :ACCESSOR
    %NAMESPACE-NAME)
...
(CL:DEFUN NEW-XML-ELEMENT ()
  (CL:LET* ((SELF NULL)) (CL:SETQ SELF (CL:MAKE-INSTANCE (CL:QUOTE XML-ELEMENT)))
   (CL:SETF (%SURFACE-FORM SELF) STELLA::NULL-STRING) (CL:SETF (%NAME SELF) STELLA::NULL-STRING)
   (CL:SETF (%ELEMENT-DICTIONARY SELF) NULL) (CL:SETF (%NAMESPACE-URI SELF) STELLA::NULL-STRING)
...
(CL:DEFUN ACCESS-XML-ELEMENT-SLOT-VALUE (SELF SLOTNAME VALUE SETVALUE?)
  (CL:COND
   ((CL:EQ SLOTNAME SYM-XML-STELLA-NAMESPACE-NAME)
    (CL:IF SETVALUE? (CL:SETF (%NAMESPACE-NAME SELF) (%WRAPPER-VALUE VALUE))
     (CL:SETQ VALUE (WRAP-STRING (%NAMESPACE-NAME SELF)))))
   ((CL:EQ SLOTNAME SYM-XML-STELLA-NAMESPACE-URI)
    (CL:IF SETVALUE? (CL:SETF (%NAMESPACE-URI SELF) (%WRAPPER-VALUE VALUE))
     (CL:SETQ VALUE (WRAP-STRING (%NAMESPACE-URI SELF)))))
   ((CL:EQ SLOTNAME SYM-XML-STELLA-ELEMENT-DICTIONARY)
    (CL:IF SETVALUE? (CL:SETF (%ELEMENT-DICTIONARY SELF) VALUE) (CL:SETQ VALUE (%ELEMENT-DICTIONARY SELF))))
   (CL:T
    (CL:LET* ((STREAM-000 (NEW-OUTPUT-STRING-STREAM)))
     (%%PRINT-STREAM (%NATIVE-STREAM STREAM-000) "`" SLOTNAME "' is not a valid case option")
     (CL:ERROR (NEW-STELLA-EXCEPTION (THE-STRING-READER STREAM-000))))))
...
(CL:DEFUN NEW-XML-LOCAL-ATTRIBUTE ()
  (CL:LET* ((SELF NULL)) (CL:SETQ SELF (CL:MAKE-INSTANCE (CL:QUOTE XML-LOCAL-ATTRIBUTE)))
   (CL:SETF (%SURFACE-FORM SELF) STELLA::NULL-STRING) (CL:SETF (%NAME SELF) STELLA::NULL-STRING)
   (CL:SETF (%PARENT-ELEMENT SELF) NULL) (CL:RETURN-FROM NEW-XML-LOCAL-ATTRIBUTE SELF)))
...
(CL:DEFUN ACCESS-XML-LOCAL-ATTRIBUTE-SLOT-VALUE (SELF SLOTNAME VALUE SETVALUE?)
  (CL:COND
   ((CL:EQ SLOTNAME SYM-XML-STELLA-PARENT-ELEMENT)
    (CL:IF SETVALUE? (CL:SETF (%PARENT-ELEMENT SELF) VALUE) (CL:SETQ VALUE (%PARENT-ELEMENT SELF))))
   (CL:T
    (CL:LET* ((STREAM-000 (NEW-OUTPUT-STRING-STREAM)))
     (%%PRINT-STREAM (%NATIVE-STREAM STREAM-000) "`" SLOTNAME "' is not a valid case option")
     (CL:ERROR (NEW-STELLA-EXCEPTION (THE-STRING-READER STREAM-000))))))
...
(CL:DEFUN NEW-XML-GLOBAL-ATTRIBUTE ()
  (CL:LET* ((SELF NULL)) (CL:SETQ SELF (CL:MAKE-INSTANCE (CL:QUOTE XML-GLOBAL-ATTRIBUTE)))
   (CL:SETF (%SURFACE-FORM SELF) STELLA::NULL-STRING) (CL:SETF (%NAME SELF) STELLA::NULL-STRING)
   (CL:SETF (%NAMESPACE-URI SELF) STELLA::NULL-STRING) (CL:SETF (%NAMESPACE-NAME SELF) STELLA::NULL-STRING)
...
(CL:DEFUN NEW-XML-PROCESSING-INSTRUCTION ()
  (CL:LET* ((SELF NULL)) (CL:SETQ SELF (CL:MAKE-INSTANCE (CL:QUOTE XML-PROCESSING-INSTRUCTION)))
   (CL:SETF (%SURFACE-FORM SELF) STELLA::NULL-STRING) (CL:SETF (%NAME SELF) STELLA::NULL-STRING)
   (CL:SETF (%DATA SELF) STELLA::NULL-STRING) (CL:RETURN-FROM NEW-XML-PROCESSING-INSTRUCTION SELF)))
...
(CL:DEFUN ACCESS-XML-PROCESSING-INSTRUCTION-SLOT-VALUE (SELF SLOTNAME VALUE SETVALUE?)
  (CL:COND
   ((CL:EQ SLOTNAME SYM-XML-STELLA-DATA)
    (CL:IF SETVALUE? (CL:SETF (%DATA SELF) (%WRAPPER-VALUE VALUE)) (CL:SETQ VALUE (WRAP-STRING (%DATA SELF)))))
   (CL:T
    (CL:LET* ((STREAM-000 (NEW-OUTPUT-STRING-STREAM)))
     (%%PRINT-STREAM (%NATIVE-STREAM STREAM-000) "`" SLOTNAME "' is not a valid case option")
     (CL:ERROR (NEW-STELLA-EXCEPTION (THE-STRING-READER STREAM-000))))))
...
(CL:DEFUN NEW-XML-DECLARATION ()
  (CL:LET* ((SELF NULL)) (CL:SETQ SELF (CL:MAKE-INSTANCE (CL:QUOTE XML-DECLARATION)))
   (CL:SETF (%SURFACE-FORM SELF) STELLA::NULL-STRING) (CL:SETF (%NAME SELF) STELLA::NULL-STRING)
   (CL:SETF (%DATA SELF) STELLA::NULL-STRING) (CL:RETURN-FROM NEW-XML-DECLARATION SELF)))
...
(CL:DEFUN NEW-XML-DOCTYPE-DECLARATION ()
  (CL:LET* ((SELF NULL)) (CL:SETQ SELF (CL:MAKE-INSTANCE (CL:QUOTE XML-DOCTYPE-DECLARATION)))
   (CL:SETF (%SURFACE-FORM SELF) STELLA::NULL-STRING) (CL:SETF (%NAME SELF) STELLA::NULL-STRING)
   (CL:SETF (%DATA SELF) STELLA::NULL-STRING) (CL:RETURN-FROM NEW-XML-DOCTYPE-DECLARATION SELF)))
...
(CL:DEFUN NEW-XML-SPECIAL ()
  (CL:LET* ((SELF NULL)) (CL:SETQ SELF (CL:MAKE-INSTANCE (CL:QUOTE XML-SPECIAL)))
   (CL:SETF (%SURFACE-FORM SELF) STELLA::NULL-STRING) (CL:SETF (%NAME SELF) STELLA::NULL-STRING)
   (CL:SETF (%DATA SELF) STELLA::NULL-STRING) (CL:RETURN-FROM NEW-XML-SPECIAL SELF)))
...
(CL:DEFUN NEW-XML-COMMENT ()
  (CL:LET* ((SELF NULL)) (CL:SETQ SELF (CL:MAKE-INSTANCE (CL:QUOTE XML-COMMENT)))
   (CL:SETF (%SURFACE-FORM SELF) STELLA::NULL-STRING) (CL:SETF (%NAME SELF) STELLA::NULL-STRING)
...
(CL:DEFMETHOD PRINT-OBJECT ((SELF XML-COMMENT) STREAM)
  (CL:IF (CL:EQ (%SURFACE-FORM SELF) STELLA::NULL-STRING) (%%PRINT-STREAM STREAM "<!-- -->")
   (%%PRINT-STREAM STREAM "<!-- " (CL:THE CL:FIXNUM (CL:LENGTH (CL:THE CL:SIMPLE-STRING (%SURFACE-FORM SELF))))
    " chars -->"))
  :VOID)
...
(CL:DEFCLASS XML-DOCTYPE (STANDARD-OBJECT)
  ((NAME :TYPE CL:SIMPLE-STRING :INITFORM STELLA::NULL-STRING :ALLOCATION :INSTANCE :ACCESSOR %NAME)
   (ENTITY-TABLE :ALLOCATION :INSTANCE :ACCESSOR %ENTITY-TABLE)
   (PARAMETER-ENTITY-TABLE :ALLOCATION :INSTANCE :ACCESSOR %PARAMETER-ENTITY-TABLE)))

(CL:DEFUN NEW-XML-DOCTYPE ()
  (CL:LET* ((SELF NULL)) (CL:SETQ SELF (CL:MAKE-INSTANCE (CL:QUOTE XML-DOCTYPE)))
   (CL:SETF (%PARAMETER-ENTITY-TABLE SELF) (NEW-KEY-VALUE-LIST)) (CL:SETF (%ENTITY-TABLE SELF) (NEW-KEY-VALUE-LIST))
   (CL:SETF (%NAME SELF) STELLA::NULL-STRING) (CL:RETURN-FROM NEW-XML-DOCTYPE SELF)))
...
(CL:DEFUN ACCESS-XML-DOCTYPE-SLOT-VALUE (SELF SLOTNAME VALUE SETVALUE?)
  (CL:COND
   ...
   ((CL:EQ SLOTNAME SYM-XML-STELLA-ENTITY-TABLE)
    (CL:IF SETVALUE? (CL:SETF (%ENTITY-TABLE SELF) VALUE) (CL:SETQ VALUE (%ENTITY-TABLE SELF))))
...
(CL:DEFUN MAKE-XML-CDATA-FORM (THE-DATA)
  ...
  (CL:LET* ((SELF-000 (NEW-XML-SPECIAL))) (CL:SETF (%NAME SELF-000) "CDATA") (CL:SETF (%SURFACE-FORM SELF-000) "CDATA")
   (CL:LET* ((TAG SELF-000))
    (CL:RETURN-FROM MAKE-XML-CDATA-FORM (CONS TAG (CONS (CONS (WRAP-STRING THE-DATA) NIL) NIL))))))
...
(CL:DEFUN MAKE-XMLNS-ATTRIBUTE (NAME)
  ...
  (CL:LET* ((COLON-POSITION (POSITION NAME #\: 0))) (CL:DECLARE (CL:TYPE CL:FIXNUM COLON-POSITION))
   (CL:IF (CL:= COLON-POSITION NULL-INTEGER)
    (CL:LET* ((SELF-000 (NEW-XML-GLOBAL-ATTRIBUTE))) (CL:SETF (%NAME SELF-000) "")
     (CL:SETF (%NAMESPACE-NAME SELF-000) "xmlns") (CL:SETF (%SURFACE-FORM SELF-000) NAME)
     (CL:LET* ((VALUE-000 SELF-000)) (CL:RETURN-FROM MAKE-XMLNS-ATTRIBUTE VALUE-000)))
    (CL:LET* ((SELF-001 (NEW-XML-GLOBAL-ATTRIBUTE)))
     (CL:SETF (%NAME SELF-001) (SUBSEQUENCE NAME (CL:1+ COLON-POSITION) NULL-INTEGER))
  ...
  (CL:LET* ((NS-HASH-TABLE NULL) (ELEMENT NULL))
   (CL:COND
    ((CL:NOT (CL:EQ NAMESPACE STELLA::NULL-STRING)) (CL:SETQ NS-HASH-TABLE (LOOKUP *XML-ELEMENT-HASH-TABLE* NAMESPACE))
     (CL:WHEN (CL:EQ NS-HASH-TABLE NULL) (CL:SETQ NS-HASH-TABLE (NEW-STRING-HASH-TABLE))
   ...
   (CL:WHEN (CL:EQ ELEMENT NULL)
    (CL:LET* ((SELF-001 (NEW-XML-ELEMENT))) (CL:SETF (%NAME SELF-001) NAME)
     (CL:SETF (%NAMESPACE-NAME SELF-001) NAMESPACE-NAME) (CL:SETF (%NAMESPACE-URI SELF-001) NAMESPACE)
     (CL:SETF (%SURFACE-FORM SELF-001) SURFACE-FORM) (CL:SETF (%ELEMENT-DICTIONARY SELF-001) (NEW-KEY-VALUE-LIST))
...
be interned in the null namespace.   `namespace' must otherwise be a URI."
  ...
  (CL:IF (CL:OR (CL:EQ NAMESPACE-NAME STELLA::NULL-STRING) (STRING-EQL? NAMESPACE-NAME ""))
   ...
   (CL:RETURN-FROM MAKE-XML-ELEMENT
    (MAKE-XML-ELEMENT-INTERNAL NAME NAMESPACE-NAME NAMESPACE (CONCATENATE NAMESPACE-NAME ":" NAME)))))
  ...
  (CL:LET* ((COLON-POSITION (POSITION NAME #\: 0)) (NS-PART "") (RAW-NAME "") (NAMESPACE-URI STELLA::NULL-STRING))
   ...
   (CL:IF (CL:= COLON-POSITION NULL-INTEGER) (CL:SETQ RAW-NAME NAME)
    (CL:PROGN (CL:SETQ NS-PART (SUBSEQUENCE NAME 0 COLON-POSITION))
     (CL:SETQ RAW-NAME (SUBSEQUENCE NAME (CL:1+ COLON-POSITION) NULL-INTEGER))))
   ...
   (CL:WHEN (CL:AND (CL:EQ NAMESPACE-URI STELLA::NULL-STRING) (CL:NOT (STRING-EQL? NS-PART "")))
    (CL:LET* ((STREAM-000 (NEW-OUTPUT-STRING-STREAM)))
     (%%PRINT-STREAM (%NATIVE-STREAM STREAM-000) "Undefined Namespace for Element: `" NS-PART "'")
...
(CL:DEFUN MAKE-XML-GLOBAL-ATTRIBUTE-INTERNAL (NAME NAMESPACE-NAME NAMESPACE-URI SURFACE-FORM)
  ...
  (CL:CHECK-TYPE SURFACE-FORM CL:SIMPLE-STRING)
  (CL:WHEN
   (CL:OR (CL:EQ NAMESPACE-URI STELLA::NULL-STRING) (CL:EQ NAMESPACE-NAME STELLA::NULL-STRING)
  ...
  (CL:LET* ((NS-HASH-TABLE (LOOKUP *XML-GLOBAL-ATTRIBUTE-HASH-TABLE* NAMESPACE-URI)) (ATTRIBUTE NULL))
   ...
   (CL:WHEN (CL:EQ ATTRIBUTE NULL)
    (CL:LET* ((SELF-002 (NEW-XML-GLOBAL-ATTRIBUTE))) (CL:SETF (%NAME SELF-002) NAME)
     (CL:SETF (%NAMESPACE-NAME SELF-002) NAMESPACE-NAME) (CL:SETF (%NAMESPACE-URI SELF-002) NAMESPACE-URI)
     (CL:SETF (%SURFACE-FORM SELF-002) SURFACE-FORM) (CL:SETQ ATTRIBUTE SELF-002))
...
`namespace-name' to refer to  `namespace'.  `namespace'must be a URI."
  ...
  (CL:RETURN-FROM MAKE-XML-GLOBAL-ATTRIBUTE
   (MAKE-XML-GLOBAL-ATTRIBUTE-INTERNAL NAME NAMESPACE-NAME NAMESPACE (CONCATENATE NAME ":" NAMESPACE-NAME))))
...
(CL:DEFUN MAKE-XML-GLOBAL-ATTRIBUTE-RESPECTING-NAMESPACE (NAME NAMESPACE-NAME SURFACE-FORM NAMESPACE-TABLE)
  ...
  (CL:LET* ((NAMESPACE-URI (LOOKUP NAMESPACE-TABLE (WRAP-STRING NAMESPACE-NAME))))
   ...
   (CL:RETURN-FROM MAKE-XML-GLOBAL-ATTRIBUTE-RESPECTING-NAMESPACE
    (MAKE-XML-GLOBAL-ATTRIBUTE-INTERNAL NAME NAMESPACE-NAME (%WRAPPER-VALUE NAMESPACE-URI) SURFACE-FORM))))
...
(CL:DEFUN MAKE-XML-LOCAL-ATTRIBUTE (NAME ELEMENT)
  ...
  (CL:LET* ((DICTIONARY (%ELEMENT-DICTIONARY ELEMENT)) (ATTRIBUTE (LOOKUP DICTIONARY (WRAP-STRING NAME))))
   (CL:WHEN (CL:EQ ATTRIBUTE NULL)
    (CL:LET* ((SELF-000 (NEW-XML-LOCAL-ATTRIBUTE))) (CL:SETF (%NAME SELF-000) NAME)
     (CL:SETF (%PARENT-ELEMENT SELF-000) ELEMENT) (CL:SETF (%SURFACE-FORM SELF-000) NAME) (CL:SETQ ATTRIBUTE SELF-000))
...
(CL:DEFUN MAKE-XML-ATTRIBUTE-RESPECTING-NAMESPACE (NAME ELEMENT NAMESPACE-TABLE)
  ...
  (CL:LET* ((COLON-POSITION (POSITION NAME #\: 0))) (CL:DECLARE (CL:TYPE CL:FIXNUM COLON-POSITION))
   (CL:IF (CL:= COLON-POSITION NULL-INTEGER)
    (CL:RETURN-FROM MAKE-XML-ATTRIBUTE-RESPECTING-NAMESPACE (MAKE-XML-LOCAL-ATTRIBUTE NAME ELEMENT))
    (CL:RETURN-FROM MAKE-XML-ATTRIBUTE-RESPECTING-NAMESPACE
     (MAKE-XML-GLOBAL-ATTRIBUTE-RESPECTING-NAMESPACE (SUBSEQUENCE NAME (CL:1+ COLON-POSITION) NULL-INTEGER)
...
(CL:DEFUN XMLNS-ATTRIBUTE? (ATTRIBUTE)
  (CL:RETURN-FROM XMLNS-ATTRIBUTE?
   (CL:AND (ISA? ATTRIBUTE SGT-XML-STELLA-XML-GLOBAL-ATTRIBUTE) (STRING-EQL? "xmlns" (%NAMESPACE-NAME ATTRIBUTE)))))
...
(CL:DEFUN MAKE-XML-ENTITY-TABLE ()
  (CL:LET* ((TABLE (NEW-KEY-VALUE-LIST))) (ADD-XML-REFERENCE "lt" "&#60;" TABLE) (ADD-XML-REFERENCE "gt" "&#62;" TABLE)
   (ADD-XML-REFERENCE "amp" "&#38;" TABLE) (ADD-XML-REFERENCE "apos" "&#39;" TABLE)
   (ADD-XML-REFERENCE "quot" "&#34;" TABLE) (ADD-XML-REFERENCE "nbsp" "&#160;" TABLE)
  ...
  (CL:RETURN-FROM INTERNAL-DTD-DEFINITION?
   (CL:AND
    (CL:EQL
     ...
     #\[)
    (CL:EQL
     (CL:LET ((SELF DEFINITION) (POSITION (CL:1- (CL:THE CL:FIXNUM (CL:LENGTH DEFINITION)))))
...
(CL:DEFUN GET-DOCTYPE-DEFINITION (DOCTYPE)
  (CL:LET* ((DEFINITION (%WRAPPER-VALUE (%%VALUE (%%REST (%%VALUE (%%REST DOCTYPE)))))))
   (CL:DECLARE (CL:TYPE CL:SIMPLE-STRING DEFINITION))
   (CL:IF (INTERNAL-DTD-DEFINITION? DEFINITION)
    (CL:RETURN-FROM GET-DOCTYPE-DEFINITION
     (NEW-INPUT-STRING-STREAM (SUBSEQUENCE DEFINITION 1 (CL:- (CL:THE CL:FIXNUM (CL:LENGTH DEFINITION)) 2))))
...
a PUBLIC or SYSTEM literal for an XML Elternal ID.  (See 4.2.2)"
  (CL:RETURN-FROM EXTERNAL-ID-HEAD?
   (CL:AND (ISA? ATTRIBUTE SGT-XML-STELLA-STRING-WRAPPER)
    (CL:OR (STRING-EQL? (%WRAPPER-VALUE ATTRIBUTE) "SYSTEM") (STRING-EQL? (%WRAPPER-VALUE ATTRIBUTE) "PUBLIC")))))
...
(CL:DEFUN DECODE-XML-ENTITY-REF (DOCTYPE NAME PE-REFERENCE-ALLOWED?)
  ...
  (CL:CHECK-TYPE NAME CL:SIMPLE-STRING)
  (CL:LET* ((VALUE NULL))
   (CL:WHEN (CL:NOT (CL:EQ DOCTYPE NULL)) (CL:SETQ VALUE (LOOKUP (%ENTITY-TABLE DOCTYPE) (WRAP-STRING NAME))))
   (CL:WHEN (CL:EQ VALUE NULL) (CL:SETQ VALUE (LOOKUP *XML-BASE-ENTITY-TABLE* (WRAP-STRING NAME))))
   (CL:IF (CL:EQ VALUE NULL)
    (CL:LET* ((STREAM-000 (NEW-OUTPUT-STRING-STREAM)))
     (%%PRINT-STREAM (%NATIVE-STREAM STREAM-000) "Couldn't find entity reference for `" NAME "'")
     (CL:ERROR (NEW-BAD-ARGUMENT-EXCEPTION (THE-STRING-READER STREAM-000))))
...
(CL:DEFUN DECODE-XML-PARAMETER-ENTITY-REF (DOCTYPE NAME PE-REFERENCE-ALLOWED?)
  ...
  (CL:WHEN (CL:NOT PE-REFERENCE-ALLOWED?)
   (CL:LET* ((STREAM-000 (NEW-OUTPUT-STRING-STREAM)))
    (%%PRINT-STREAM (%NATIVE-STREAM STREAM-000) "Illegal XML Parameter Entity Reference: `" NAME "'")
    (CL:ERROR (NEW-BAD-ARGUMENT-EXCEPTION (THE-STRING-READER STREAM-000)))))
  (CL:WHEN (CL:EQ DOCTYPE NULL)
   (CL:LET* ((STREAM-001 (NEW-OUTPUT-STRING-STREAM)))
    (%%PRINT-STREAM (%NATIVE-STREAM STREAM-001) "Parameter Entity References need a Doctype object: `" NAME "'")
    (CL:ERROR (NEW-BAD-ARGUMENT-EXCEPTION (THE-STRING-READER STREAM-001)))))
  (CL:LET* ((VALUE (%WRAPPER-VALUE (LOOKUP (%ENTITY-TABLE DOCTYPE) (WRAP-STRING NAME)))))
   (CL:DECLARE (CL:TYPE CL:SIMPLE-STRING VALUE))
   (CL:IF (CL:NOT (CL:EQ VALUE STELLA::NULL-STRING))
    (CL:RETURN-FROM DECODE-XML-PARAMETER-ENTITY-REF (DECODE-XML-STRING DOCTYPE VALUE PE-REFERENCE-ALLOWED?))
    (CL:LET* ((STREAM-002 (NEW-OUTPUT-STRING-STREAM)))
     (%%PRINT-STREAM (%NATIVE-STREAM STREAM-002) "No Parameter Entity found to match `" NAME "'")
  ...
  (CL:IF
   ...
   (CL:IF
    ...
    (CL:RETURN-FROM DECODE-XML-REFERENCE
     (DECODE-XML-ENTITY-REF DOCTYPE (SUBSEQUENCE REFERENCE 1 (CL:1- (CL:THE CL:FIXNUM (CL:LENGTH REFERENCE))))
      PE-REFERENCE-ALLOWED?)))
   (CL:RETURN-FROM DECODE-XML-REFERENCE
    (DECODE-XML-PARAMETER-ENTITY-REF DOCTYPE (SUBSEQUENCE REFERENCE 1 (CL:1- (CL:THE CL:FIXNUM (CL:LENGTH REFERENCE))))
     PE-REFERENCE-ALLOWED?))))
...
(CL:DEFUN FIND-REFERENCE-START (INPUT START END)
  ...
  (CL:LET*
   ((I NULL-INTEGER) (ITER-000 START) (UPPER-BOUND-000 END) (UNBOUNDED?-000 (CL:= UPPER-BOUND-000 NULL-INTEGER)))
   (CL:DECLARE (CL:TYPE CL:FIXNUM I ITER-000 UPPER-BOUND-000))
   (CL:LOOP WHILE (CL:OR UNBOUNDED?-000 (CL:<= ITER-000 UPPER-BOUND-000)) DO (CL:SETQ I ITER-000)
    (CL:WHEN
     (CL:OR
...
(CL:DEFUN DECODE-XML-STRING (DOCTYPE INPUT PE-REFERENCE-ALLOWED?)
  ...
  (CL:LET*
   ((INPUT-END (CL:IF PE-REFERENCE-ALLOWED? (CL:1- (CL:THE CL:FIXNUM (CL:LENGTH INPUT))) NULL-INTEGER))
    (REFERENCE-START (CL:IF PE-REFERENCE-ALLOWED? (FIND-REFERENCE-START INPUT 0 INPUT-END) (POSITION INPUT #\& 0)))
   ...
   (CL:IF (CL:= REFERENCE-START NULL-INTEGER) (CL:RETURN-FROM DECODE-XML-STRING INPUT)
    (CL:LET* ((BUFFER (NEW-OUTPUT-STRING-STREAM)) (REFERENCE-END 0)) (CL:DECLARE (CL:TYPE CL:FIXNUM REFERENCE-END))
     ...
     (CL:LOOP WHILE (CL:NOT (CL:= REFERENCE-START NULL-INTEGER)) DO
      (%%PRINT-STREAM (%NATIVE-STREAM BUFFER) (SUBSEQUENCE INPUT REFERENCE-END REFERENCE-START))
      (CL:SETQ REFERENCE-END (POSITION INPUT #\; REFERENCE-START))
      (CL:WHEN (CL:= REFERENCE-END NULL-INTEGER) (CL:ERROR "Safety violation: Unterminated XML reference"))
      (CL:SETQ REFERENCE-END (CL:1+ REFERENCE-END))
      (CL:SETQ SUBSTITUTION
       (DECODE-XML-REFERENCE DOCTYPE (SUBSEQUENCE INPUT REFERENCE-START REFERENCE-END) PE-REFERENCE-ALLOWED?))
      (CL:IF (CL:EQ SUBSTITUTION STELLA::NULL-STRING)
       (CL:LET* ((STREAM-000 (NEW-OUTPUT-STRING-STREAM)))
        (%%PRINT-STREAM (%NATIVE-STREAM STREAM-000) "Unrecognized entity reference: `"
         (SUBSEQUENCE INPUT REFERENCE-START REFERENCE-END) "'")
        (CL:ERROR (NEW-BAD-ARGUMENT-EXCEPTION (THE-STRING-READER STREAM-000))))
       (%%PRINT-STREAM (%NATIVE-STREAM BUFFER) SUBSTITUTION))
      (CL:SETQ REFERENCE-START
       (CL:IF PE-REFERENCE-ALLOWED? (FIND-REFERENCE-START INPUT REFERENCE-END INPUT-END)
        (POSITION INPUT #\& REFERENCE-END))))
     (CL:WHEN (CL:NOT (CL:= REFERENCE-END INPUT-END))
      (%%PRINT-STREAM (%NATIVE-STREAM BUFFER) (SUBSEQUENCE INPUT REFERENCE-END NULL-INTEGER)))
...
a DOCTYPE object."
  (CL:IF
   (CL:AND (CL:NOT (CL:EQ DOCTYPE-DECLARATION NULL)) (CL:NOT (CL:EQ DOCTYPE-DECLARATION NIL))
    ...
    (CL:UNWIND-PROTECT
     (CL:PROGN (CL:SETF (%NAME DOCTYPE) (%WRAPPER-VALUE (%%VALUE (%%VALUE (%%REST DOCTYPE-DECLARATION)))))
      ...
      (CL:WHEN (CL:NOT (CL:EQ DEFINITION-STREAM NULL))
       (CL:LET* ((SELF-001 (NEW-XML-EXPRESSION-ITERATOR))) (CL:SETF (%THE-STREAM SELF-001) DEFINITION-STREAM)
        (CL:SETF (%DOCTYPE-ITERATOR? SELF-001) CL:T) (CL:SETF (%DOCTYPE SELF-001) DOCTYPE) (CL:SETQ ITERATOR SELF-001))
       (CL:LET* ((DECLARATION NULL) (ITER-000 ITERATOR))
        (CL:LOOP WHILE (NEXT? ITER-000) DO (CL:SETQ DECLARATION (%VALUE ITER-000))
         (CL:WHEN
          (CL:AND (ISA? (%%VALUE DECLARATION) SGT-XML-STELLA-XML-DECLARATION)
           (STRING-EQL? "ENTITY" (%NAME (%%VALUE DECLARATION))))
          (CL:LET* ((ATTRIBUTES (%%VALUE (%%REST DECLARATION))))
           (CL:IF (STRING-EQL? "%" (%WRAPPER-VALUE (%%VALUE ATTRIBUTES)))
            (CL:IF (CL:AND (CL:> (LENGTH ATTRIBUTES) 3) (EXTERNAL-ID-HEAD? (%%VALUE (%%REST (%%REST ATTRIBUTES)))))
             (CL:LET* ((STREAM-000 (NEW-OUTPUT-STRING-STREAM)))
              (%%PRINT-STREAM (%NATIVE-STREAM STREAM-000) "Can't handle external entity definitions: `" DECLARATION
               "'")
              (CL:ERROR (NEW-STELLA-EXCEPTION (THE-STRING-READER STREAM-000))))
             (ADD-XML-REFERENCE (%WRAPPER-VALUE (%%VALUE (%%REST ATTRIBUTES)))
              (%WRAPPER-VALUE (%%VALUE (%%REST (%%REST ATTRIBUTES)))) (%PARAMETER-ENTITY-TABLE DOCTYPE)))
            (CL:IF (CL:AND (CL:> (LENGTH ATTRIBUTES) 2) (EXTERNAL-ID-HEAD? (%%VALUE (%%REST ATTRIBUTES))))
             ...
             (ADD-XML-REFERENCE (%WRAPPER-VALUE (%%VALUE ATTRIBUTES)) (%WRAPPER-VALUE (%%VALUE (%%REST ATTRIBUTES)))
  ...
  (CL:WHEN (CL:EQ *XML-WHITESPACE-PRESERVING-TOKENIZER-TABLE* NULL)
   (CL:LET* ((TOKENIZERDEFINITION (COPY-CONS-TREE *XML-TOKENIZER-TABLE-DEFINITION*)))
    (SECOND-SETTER TOKENIZERDEFINITION
     (LIST* KWD-XML-SKIP-WHITESPACE SYM-XML-STELLA-! (WRAP-STRING "<") KWD-XML-OPEN-TAG KWD-XML-EOF KWD-XML-EOF
      SYM-XML-STELLA-* KWD-XML-OTHERWISE KWD-XML-CONTENT NIL))
...
(CL:DEFUN GET-XML-TOKENIZER-TABLE ()
  (CL:IF *XML-PRESERVE-ALL-WHITESPACE?*
   (CL:RETURN-FROM GET-XML-TOKENIZER-TABLE (GET-XML-WHITESPACE-PRESERVING-TOKENIZER-TABLE))
...
(CL:DEFUN TOKENIZE-XML-EXPRESSION (STREAM TOKENLIST REGIONTAGNAME SKIPTOREGION?)
  ...
  (CL:LET*
   ((PARENBALANCE 0) (STARTTAG STELLA::NULL-STRING) (CURRENTTAG STELLA::NULL-STRING)
    (REGIONTAGFOUND? (CL:OR (CL:EQ REGIONTAGNAME STELLA::NULL-STRING) (CL:NOT SKIPTOREGION?))) (ENDOFFILE? CL:T)
    (TOKENTYPE NULL) (TOKENCONTENT STELLA::NULL-STRING) (TOKENCURSOR TOKENLIST))
   ...
   (CL:LET*
    ((TOK_TABLE_ (GET-XML-TOKENIZER-TABLE)) (TOK_TRANSITIONS_ (%TRANSITIONS TOK_TABLE_))
     ...
     (CL:TAGBODY
      ...
      (CL:COND (REGIONTAGFOUND?)
       ((CL:AND (CL:EQ TOKENTYPE KWD-XML-START-TAG)
         (STRING-EQL? (GET-TOKEN-TEXT-INTERNAL TOK_BUFFER_ TOK_TOKENSTART_ TOK_CURSOR_ TOK_SIZE_ CL:NIL)
          REGIONTAGNAME))
        (CL:SETQ REGIONTAGFOUND? CL:T))
       (CL:T (CL:GO :CONTINUE)))
      (CL:COND
       ((CL:OR (CL:EQ TOKENTYPE KWD-XML-START-TAG) (CL:EQ TOKENTYPE KWD-XML-START-PI-TAG)
         (CL:EQ TOKENTYPE KWD-XML-START-DECLARATION-TAG) (CL:EQ TOKENTYPE KWD-XML-START-SPECIAL-TAG))
       ...
       ((CL:EQ TOKENTYPE KWD-XML-START-TAG-END) (CL:SETQ TOKENCONTENT ">")
        (CL:WHEN (CL:AND (CL:NOT (CL:EQ REGIONTAGNAME STELLA::NULL-STRING)) SKIPTOREGION?)
         (CL:SETQ PARENBALANCE (CL:1- PARENBALANCE)))
        (CL:SETQ CURRENTTAG STELLA::NULL-STRING))
       ((CL:OR (CL:EQ TOKENTYPE KWD-XML-END-TAG) (CL:EQ TOKENTYPE KWD-XML-EMPTY-TAG-END)
        ...
        (CL:WHEN
         (CL:OR (STRING-EQL? CURRENTTAG STARTTAG)
          (CL:AND (CL:NOT (CL:EQ REGIONTAGNAME STELLA::NULL-STRING)) (CL:NOT SKIPTOREGION?)
       ...
       ((CL:OR (CL:EQ TOKENTYPE KWD-XML-QUOTED-ATTRIBUTE-VALUE) (CL:EQ TOKENTYPE KWD-XML-QUOTED-DECLARATION-TAG-DATA))
        (CL:SETQ TOKENCONTENT
         (GET-TOKEN-TEXT-INTERNAL TOK_BUFFER_ (CL:1+ TOK_TOKENSTART_) (CL:+ TOK_CURSOR_ -1) TOK_SIZE_ CL:NIL))
       ...
       ((CL:EQ TOKENTYPE KWD-XML-PI-TAG-DATA)
        (CL:SETQ TOKENCONTENT
         (GET-TOKEN-TEXT-INTERNAL TOK_BUFFER_ TOK_TOKENSTART_ (CL:+ TOK_CURSOR_ -1) TOK_SIZE_ CL:NIL)))
       ...
       ((CL:EQ TOKENTYPE KWD-XML-SPECIAL-TAG-DATA)
        (CL:SETQ TOKENCONTENT
         (GET-TOKEN-TEXT-INTERNAL TOK_BUFFER_ (CL:1+ TOK_TOKENSTART_) (CL:+ TOK_CURSOR_ -2) TOK_SIZE_ CL:NIL)))
             ...
             (CL:NOT
              (CL:EQ
               (CL:AREF *CHARACTER-TYPE-TABLE*
                (CL:THE CL:FIXNUM
                 (CL:CHAR-CODE
                  (CL:LET ((SELF TOKENCONTENT) (POSITION (CL:SETQ CURSOR (CL:1- CURSOR))))
                   (CL:DECLARE (CL:TYPE CL:SIMPLE-STRING SELF) (CL:TYPE CL:FIXNUM POSITION))
                   (CL:SCHAR (CL:THE CL:SIMPLE-STRING SELF) (CL:THE CL:FIXNUM POSITION))))))
               KWD-XML-WHITE-SPACE))
             (CL:WHEN (CL:> I 0) (CL:SETQ I (CL:- 0 I))
              (CL:SETQ TOKENCONTENT
               (GET-TOKEN-TEXT-INTERNAL TOK_BUFFER_ TOK_TOKENSTART_
                (CL:IF (CL:< I 0) (CL:+ TOK_CURSOR_ I) (CL:+ TOK_TOKENSTART_ I)) TOK_SIZE_ CL:NIL)))
             (CL:RETURN))
            (CL:SETQ ITER-000 (CL:1+ ITER-000)))))))
       ((CL:EQ TOKENTYPE KWD-XML-ERROR)
        (CL:WHEN (CL:NOT (CL:EQ TOK_STREAMSTATE_ NULL)) (CL:SETF (%CURSOR TOK_STREAMSTATE_) TOK_CURSOR_)
         (CL:SETF (%TABLE TOK_STREAMSTATE_) TOK_TABLE_) (CL:SETF (%STATE TOK_STREAMSTATE_) TOK_STATE_))
        (CL:LET* ((STREAM-000 (NEW-OUTPUT-STRING-STREAM)))
         (%%PRINT-STREAM (%NATIVE-STREAM STREAM-000) "Illegal XML syntax: `" TOKENCONTENT "'")
         (CL:ERROR (NEW-READ-EXCEPTION (THE-STRING-READER STREAM-000)))))
       (CL:T
        (CL:WHEN (CL:NOT (CL:EQ TOK_STREAMSTATE_ NULL)) (CL:SETF (%CURSOR TOK_STREAMSTATE_) TOK_CURSOR_)
         (CL:SETF (%TABLE TOK_STREAMSTATE_) TOK_TABLE_) (CL:SETF (%STATE TOK_STREAMSTATE_) TOK_STATE_))
        (CL:LET* ((STREAM-001 (NEW-OUTPUT-STRING-STREAM)))
         (%%PRINT-STREAM (%NATIVE-STREAM STREAM-001) "Illegal XML syntax: `" TOKENCONTENT "' in state `" TOKENTYPE "'")
      ...
      (CL:WHEN (CL:EQ (%NEXT TOKENCURSOR) NULL) (CL:SETF (%NEXT TOKENCURSOR) (NEW-TOKENIZER-TOKEN)))
      (CL:SETQ TOKENCURSOR (%NEXT TOKENCURSOR)) (CL:WHEN (CL:= PARENBALANCE 0) (CL:RETURN))
      (CL:WHEN (CL:< PARENBALANCE 0)
       (CL:COND
        ((CL:AND (CL:NOT (CL:EQ REGIONTAGNAME STELLA::NULL-STRING)) (CL:NOT SKIPTOREGION?)
          (STRING-EQL? (%CONTENT TOKENLIST) REGIONTAGNAME) (CL:EQ (%NEXT TOKENLIST) TOKENCURSOR))
         (CL:SETQ TOKENLIST NULL) (CL:RETURN))
        (CL:T
         (CL:WHEN (CL:NOT (CL:EQ TOK_STREAMSTATE_ NULL)) (CL:SETF (%CURSOR TOK_STREAMSTATE_) TOK_CURSOR_)
          (CL:SETF (%TABLE TOK_STREAMSTATE_) TOK_TABLE_) (CL:SETF (%STATE TOK_STREAMSTATE_) TOK_STATE_))
         (CL:LET* ((STREAM-002 (NEW-OUTPUT-STRING-STREAM)))
          (%%PRINT-STREAM (%NATIVE-STREAM STREAM-002) "Unmatched end tag encountered: `" TOKENCONTENT "'")
          (CL:ERROR (NEW-READ-EXCEPTION (THE-STRING-READER STREAM-002)))))))
      :CONTINUE))
    (CL:SETF (%TYPE TOKENCURSOR) NULL)
    (CL:WHEN (CL:NOT (CL:EQ TOK_STREAMSTATE_ NULL)) (CL:SETF (%CURSOR TOK_STREAMSTATE_) TOK_CURSOR_)
     (CL:SETF (%TABLE TOK_STREAMSTATE_) TOK_TABLE_) (CL:SETF (%STATE TOK_STREAMSTATE_) TOK_STATE_))
    (CL:IF ENDOFFILE? (CL:RETURN-FROM TOKENIZE-XML-EXPRESSION (CL:VALUES NULL CL:T))
     (CL:RETURN-FROM TOKENIZE-XML-EXPRESSION (CL:VALUES TOKENLIST CL:NIL))))))
...
(CL:DEFUN PROCESS-ATTRIBUTE-LIST (REVERSEATTRIBUTELIST ELEMENT NAMESPACE-TABLE)
  ...
  (CL:LET* ((ATTRIBUTELIST NIL) (CONSCELL NULL) (ATTRIBUTENAME STELLA::NULL-STRING))
   (CL:DECLARE (CL:TYPE CL:SIMPLE-STRING ATTRIBUTENAME))
   (CL:LOOP WHILE (CL:NOT (CL:EQ REVERSEATTRIBUTELIST NIL)) DO (CL:SETQ CONSCELL (CL:CONS CL:NIL CL:NIL))
    (CL:SETF (%%VALUE CONSCELL) (%%VALUE REVERSEATTRIBUTELIST))
    (CL:SETQ REVERSEATTRIBUTELIST (%%REST REVERSEATTRIBUTELIST)) (CL:SETF (%%REST CONSCELL) ATTRIBUTELIST)
    (CL:SETQ ATTRIBUTELIST CONSCELL)
    (CL:WHEN (CL:EQ REVERSEATTRIBUTELIST NIL)
     (CL:LET* ((STREAM-000 (NEW-OUTPUT-STRING-STREAM)))
      (%%PRINT-STREAM (%NATIVE-STREAM STREAM-000) "Malformed attribute list in XML element `" ELEMENT "'")
      (CL:ERROR (NEW-BAD-ARGUMENT-EXCEPTION (THE-STRING-READER STREAM-000)))))
    (CL:SETQ ATTRIBUTENAME (%CONTENT (%%VALUE REVERSEATTRIBUTELIST)))
    (CL:SETQ REVERSEATTRIBUTELIST (%%REST REVERSEATTRIBUTELIST)) (CL:SETQ CONSCELL (CL:CONS CL:NIL CL:NIL))
...
The name is available using class accessors."
  (CL:LET*
   ((PARSEDTREE NULL) (PARSEDTREESTACK NIL) (PARSEDTOKEN NULL) (TAGNAME STELLA::NULL-STRING) (ELEMENT NULL)
    (XMLNS-NAME STELLA::NULL-STRING) (COLON-POSITION 0) (ATTRIBUTELIST NIL) (CONSCELL NULL) (TOKENTYPE NULL)
    ...
    (CL:TAGBODY (CL:SETQ TOKENTYPE (%TYPE TOKENLIST))
     (CL:COND
      ((CL:EQ TOKENTYPE KWD-XML-START-TAG)
       ...
       (CL:SETQ NS-STACK (CONS NAMESPACE-TABLE NS-STACK)) (CL:SETQ PARSEDTREE NIL)
       (CL:SETQ TAGNAME (%CONTENT TOKENLIST)) (CL:SETQ TOKENLIST (%NEXT TOKENLIST)) (CL:GO :CONTINUE))
      ((CL:OR (CL:EQ TOKENTYPE KWD-XML-START-PI-TAG) (CL:EQ TOKENTYPE KWD-XML-START-DECLARATION-TAG)
       ...
       (CL:COND
        ((CL:EQ TOKENTYPE KWD-XML-START-PI-TAG)
         (CL:LET* ((SELF-000 (NEW-XML-PROCESSING-INSTRUCTION))) (CL:SETF (%NAME SELF-000) (%CONTENT TOKENLIST))
          (CL:SETF (%SURFACE-FORM SELF-000) (%CONTENT TOKENLIST)) (CL:SETQ PARSEDTOKEN SELF-000)))
        ((CL:EQ TOKENTYPE KWD-XML-START-DECLARATION-TAG)
         (CL:LET* ((SELF-001 (NEW-XML-DECLARATION))) (CL:SETF (%NAME SELF-001) (%CONTENT TOKENLIST))
          (CL:SETF (%SURFACE-FORM SELF-001) (%CONTENT TOKENLIST)) (CL:SETQ PARSEDTOKEN SELF-001)))
        ((CL:EQ TOKENTYPE KWD-XML-START-SPECIAL-TAG)
         (CL:LET* ((SELF-002 (NEW-XML-SPECIAL))) (CL:SETF (%NAME SELF-002) (%CONTENT TOKENLIST))
          (CL:SETF (%SURFACE-FORM SELF-002) (%CONTENT TOKENLIST)) (CL:SETQ PARSEDTOKEN SELF-002)))
        (CL:T
         (CL:LET* ((STREAM-000 (NEW-OUTPUT-STRING-STREAM)))
          (%%PRINT-STREAM (%NATIVE-STREAM STREAM-000) "`" TOKENTYPE "' is not a valid case option")
          (CL:ERROR (NEW-STELLA-EXCEPTION (THE-STRING-READER STREAM-000)))))))
      ((CL:EQ TOKENTYPE KWD-XML-START-TAG-END)
       (CL:IF (CL:NOT (CL:EQ TAGNAME STELLA::NULL-STRING))
        (CL:PROGN (CL:SETQ ELEMENT (MAKE-XML-ELEMENT-RESPECTING-NAMESPACE TAGNAME NAMESPACE-TABLE))
         (CL:SETQ CONSCELL (CL:CONS CL:NIL CL:NIL)) (CL:SETF (%%VALUE CONSCELL) ELEMENT)
         (CL:SETF (%%REST CONSCELL) PARSEDTREE) (CL:SETQ PARSEDTREE CONSCELL)
      ...
      ((CL:OR (CL:EQ TOKENTYPE KWD-XML-EMPTY-TAG-END) (CL:EQ TOKENTYPE KWD-XML-DATA-TAG-END))
       (CL:IF (CL:NOT (CL:EQ TAGNAME STELLA::NULL-STRING))
        (CL:PROGN (CL:SETQ ELEMENT (MAKE-XML-ELEMENT-RESPECTING-NAMESPACE TAGNAME NAMESPACE-TABLE))
         ...
         (CL:SETQ PARSEDTOKEN (PROCESS-ATTRIBUTE-LIST ATTRIBUTELIST ELEMENT NAMESPACE-TABLE)))
        (CL:SETQ PARSEDTOKEN (CL:IF (CL:EQ ATTRIBUTELIST NIL) NIL (REVERSE ATTRIBUTELIST))))
       (CL:SETQ CONSCELL (CL:CONS CL:NIL CL:NIL)) (CL:SETF (%%VALUE CONSCELL) PARSEDTOKEN)
       (CL:SETF (%%REST CONSCELL) PARSEDTREE) (CL:SETQ PARSEDTREE CONSCELL) (CL:SETQ ATTRIBUTELIST NIL)
       (CL:SETQ TAGNAME STELLA::NULL-STRING)
       (CL:COND ((CL:EQ PARSEDTREESTACK NIL) (CL:SETQ PARSEDTREE (REVERSE PARSEDTREE)) (CL:RETURN))
        (CL:T
         (CL:WHEN (CL:EQ TOKENTYPE KWD-XML-EMPTY-TAG-END) (CL:SETQ NAMESPACE-TABLE (%%VALUE NS-STACK))
      ...
      ((CL:EQ TOKENTYPE KWD-XML-ATTRIBUTE-NAME) (CL:SETQ CONSCELL (CL:CONS CL:NIL CL:NIL))
       (CL:SETF (%%VALUE CONSCELL) TOKENLIST) (CL:SETF (%%REST CONSCELL) ATTRIBUTELIST)
       (CL:SETQ ATTRIBUTELIST CONSCELL)
       (CL:WHEN (XMLNS-ATTRIBUTE-NAME? (%CONTENT TOKENLIST))
        (CL:SETQ XMLNS-NAME (DECODE-XML-STRING DOCTYPE (%CONTENT TOKENLIST) DOCTYPE-DEFINITION?))
        (CL:SETQ TOKENLIST (%NEXT TOKENLIST))
        (CL:WHEN (CL:NOT (CL:EQ (%TYPE TOKENLIST) KWD-XML-ATTRIBUTE-VALUE))
         (CL:LET* ((STREAM-001 (NEW-OUTPUT-STRING-STREAM)))
          (%%PRINT-STREAM (%NATIVE-STREAM STREAM-001) "Illegal XMLNS syntax, namespace value is `" (%CONTENT TOKENLIST)
           "' of type `" (%TYPE TOKENLIST) "'")
          (CL:ERROR (NEW-READ-EXCEPTION (THE-STRING-READER STREAM-001)))))
        (CL:SETQ COLON-POSITION (POSITION XMLNS-NAME #\: 0))
        (CL:LET* ((NAMESPACE-VALUE (NORMALIZE-ATTRIBUTE-VALUE DOCTYPE (%CONTENT TOKENLIST) DOCTYPE-DEFINITION?)))
         (CL:DECLARE (CL:TYPE CL:SIMPLE-STRING NAMESPACE-VALUE))
         (CL:COND
          ((CL:NOT (CL:= COLON-POSITION NULL-INTEGER))
           (CL:SETQ NAMESPACE-TABLE
            (KV-CONS (WRAP-STRING (SUBSEQUENCE XMLNS-NAME (CL:1+ COLON-POSITION) NULL-INTEGER))
         ...
         (CL:SETF (%WRAPPER-VALUE PARSEDTOKEN) NAMESPACE-VALUE) (CL:SETQ CONSCELL (CL:CONS CL:NIL CL:NIL))
         (CL:SETF (%%VALUE CONSCELL) PARSEDTOKEN) (CL:SETF (%%REST CONSCELL) ATTRIBUTELIST)
         (CL:SETQ ATTRIBUTELIST CONSCELL)))
      ...
      ((CL:OR (CL:EQ TOKENTYPE KWD-XML-ATTRIBUTE-VALUE) (CL:EQ TOKENTYPE KWD-XML-DECLARATION-TAG-DATA))
       ...
       (CL:SETQ CONSCELL (CL:CONS CL:NIL CL:NIL)) (CL:SETF (%%VALUE CONSCELL) PARSEDTOKEN)
       (CL:SETF (%%REST CONSCELL) ATTRIBUTELIST) (CL:SETQ ATTRIBUTELIST CONSCELL) (CL:SETQ TOKENLIST (%NEXT TOKENLIST))
       (CL:GO :CONTINUE))
      ((CL:OR (CL:EQ TOKENTYPE KWD-XML-PI-TAG-DATA) (CL:EQ TOKENTYPE KWD-XML-SPECIAL-TAG-DATA)
        (CL:EQ TOKENTYPE KWD-XML-DECLARATION-TAG-MARKUP-DATA))
       (CL:SETQ PARSEDTOKEN (CL:MAKE-INSTANCE (CL:QUOTE STRING-WRAPPER)))
       (CL:SETF (%WRAPPER-VALUE PARSEDTOKEN) (%CONTENT TOKENLIST)) (CL:SETQ CONSCELL (CL:CONS CL:NIL CL:NIL))
       (CL:SETF (%%VALUE CONSCELL) PARSEDTOKEN) (CL:SETF (%%REST CONSCELL) ATTRIBUTELIST)
       (CL:SETQ ATTRIBUTELIST CONSCELL) (CL:SETQ TOKENLIST (%NEXT TOKENLIST)) (CL:GO :CONTINUE))
      (CL:T
       (CL:LET* ((STREAM-002 (NEW-OUTPUT-STRING-STREAM)))
        (%%PRINT-STREAM (%NATIVE-STREAM STREAM-002) "Illegal XML syntax: `" (%CONTENT TOKENLIST) "' of type `"
         TOKENTYPE "'")
        (CL:ERROR (NEW-READ-EXCEPTION (THE-STRING-READER STREAM-002))))))
     (CL:COND
      ...
      (CL:T (CL:RETURN)))
     :CONTINUE))
   (CL:IF (CL:EQ PARSEDTREE NULL) (CL:RETURN-FROM XML-TOKEN-LIST-TO-S-EXPRESSION PARSEDTOKEN)
...
This change will not be backwards-compatible."
  (CL:LET* ((ITER (XML-EXPRESSIONS STREAM START-TAG)) (RESULT NULL) (EOF? CL:NIL))
   (CL:IF (NEXT? ITER) (CL:SETQ RESULT (%VALUE ITER)) (CL:SETQ EOF? CL:T))
...
(CL:DEFCLASS XML-EXPRESSION-ITERATOR (STREAM-ITERATOR)
  ((REGION-TAG :ALLOCATION :INSTANCE :ACCESSOR %REGION-TAG)
   (REGION-MATCH-FUNCTION :ALLOCATION :INSTANCE :ACCESSOR %REGION-MATCH-FUNCTION)
   (DOCTYPE :ALLOCATION :INSTANCE :ACCESSOR %DOCTYPE)
   (DOCTYPE-ITERATOR? :DOCUMENTATION "Set to `true' when iterating over a DTD definition." :ALLOCATION :INSTANCE
    :ACCESSOR %DOCTYPE-ITERATOR?)
...
(CL:DEFUN NEW-XML-EXPRESSION-ITERATOR ()
  (CL:LET* ((SELF NULL)) (CL:SETQ SELF (CL:MAKE-INSTANCE (CL:QUOTE XML-EXPRESSION-ITERATOR)))
   (CL:SETF (%FIRST-ITERATION? SELF) CL:T) (CL:SETF (%VALUE SELF) NULL) (CL:SETF (%THE-STREAM SELF) NULL)
   (CL:SETF (%DOCTYPE-ITERATOR? SELF) CL:NIL) (CL:SETF (%DOCTYPE SELF) NULL)
   (CL:SETF (%REGION-MATCH-FUNCTION SELF) (CL:FUNCTION XML-REGION-MATCHES?)) (CL:SETF (%REGION-TAG SELF) NULL)
...
(CL:DEFUN ACCESS-XML-EXPRESSION-ITERATOR-SLOT-VALUE (SELF SLOTNAME VALUE SETVALUE?)
  (CL:COND
   ((CL:EQ SLOTNAME SYM-XML-STELLA-REGION-TAG)
    (CL:IF SETVALUE? (CL:SETF (%REGION-TAG SELF) VALUE) (CL:SETQ VALUE (%REGION-TAG SELF))))
   ((CL:EQ SLOTNAME SYM-XML-STELLA-REGION-MATCH-FUNCTION)
    (CL:IF SETVALUE? (CL:SETF (%REGION-MATCH-FUNCTION SELF) (%WRAPPER-VALUE VALUE))
     (CL:SETQ VALUE (WRAP-FUNCTION-CODE (%REGION-MATCH-FUNCTION SELF)))))
   ((CL:EQ SLOTNAME SYM-XML-STELLA-DOCTYPE)
    (CL:IF SETVALUE? (CL:SETF (%DOCTYPE SELF) VALUE) (CL:SETQ VALUE (%DOCTYPE SELF))))
...
(CL:DEFMETHOD NEXT? ((SELF XML-EXPRESSION-ITERATOR))
  (CL:LET*
   ((STREAM (%THE-STREAM SELF)) (FIRSTITERATION? (%FIRST-ITERATION? SELF))
    (TOKENLIST (CL:IF FIRSTITERATION? NULL (%TOKEN-LIST (%TOKENIZER-STATE STREAM)))) (REGIONTAG (%REGION-TAG SELF))
    (REGIONTAGNAME (CL:IF (CL:NOT (CL:EQ REGIONTAG NULL)) (%NAME (%%VALUE REGIONTAG)) STELLA::NULL-STRING))
    (SKIPTOREGION? CL:NIL) (EOF? CL:NIL))
   (CL:DECLARE (CL:TYPE CL:SIMPLE-STRING REGIONTAGNAME))
   (CL:WHEN FIRSTITERATION? (CL:SETF (%FIRST-ITERATION? SELF) CL:NIL)
    (CL:WHEN (CL:NOT (CL:EQ REGIONTAG NULL)) (CL:SETQ SKIPTOREGION? CL:T)))
   (CL:LOOP
    (CL:TAGBODY
     (CL:MULTIPLE-VALUE-SETQ (TOKENLIST EOF?) (TOKENIZE-XML-EXPRESSION STREAM TOKENLIST REGIONTAGNAME SKIPTOREGION?))
     (CL:WHEN EOF?
      (CL:WHEN (CL:AND (CL:NOT (CL:EQ REGIONTAG NULL)) (CL:NOT SKIPTOREGION?))
       (CL:LET* ((STREAM-000 (NEW-OUTPUT-STRING-STREAM)))
        (%%PRINT-STREAM (%NATIVE-STREAM STREAM-000) "EOF encountered before the end of the current `" REGIONTAGNAME
         "' region")
        (CL:ERROR (NEW-READ-EXCEPTION (THE-STRING-READER STREAM-000)))))
      (CL:SETF (%VALUE SELF) NULL) (CLOSE-STREAM STREAM) (CL:SETF (%THE-STREAM SELF) NULL)
      (CL:RETURN-FROM NEXT? CL:NIL))
     (CL:WHEN (CL:EQ TOKENLIST NULL) (CL:SETQ SKIPTOREGION? CL:T)
      (CL:SETQ TOKENLIST (%TOKEN-LIST (%TOKENIZER-STATE STREAM))) (CL:GO :CONTINUE))
     (CL:WHEN FIRSTITERATION? (CL:SETF (%TOKEN-LIST (%TOKENIZER-STATE STREAM)) TOKENLIST)
      (CL:SETQ FIRSTITERATION? CL:NIL))
     (CL:COND
      ((CL:AND SKIPTOREGION? (CL:NOT (CL:EQ REGIONTAG NULL)))
       (CL:LET* ((LASTTOKEN TOKENLIST) (EMPTYTAG? CL:NIL))
        (CL:LOOP WHILE (CL:NOT (CL:EQ (%TYPE (%NEXT LASTTOKEN)) NULL)) DO (CL:SETQ LASTTOKEN (%NEXT LASTTOKEN)))
        (CL:IF (CL:EQ (%TYPE LASTTOKEN) KWD-XML-EMPTY-TAG-END) (CL:SETQ EMPTYTAG? CL:T)
         (CL:SETF (%TYPE LASTTOKEN) KWD-XML-EMPTY-TAG-END))
        (CL:WHEN
         (CL:NOT
          (CL:FUNCALL (%REGION-MATCH-FUNCTION SELF) (%REGION-TAG SELF)
           (XML-TOKEN-LIST-TO-S-EXPRESSION TOKENLIST (%DOCTYPE SELF) (%DOCTYPE-ITERATOR? SELF))))
         (CL:SETQ SKIPTOREGION? CL:T) (CL:GO :CONTINUE))
        (CL:SETQ SKIPTOREGION? CL:NIL)
        (CL:WHEN EMPTYTAG? (CL:SETQ REGIONTAG NULL) (CL:SETQ REGIONTAGNAME STELLA::NULL-STRING)
         (CL:SETF (%REGION-TAG SELF) NULL))
        (CL:GO :CONTINUE)))
      (CL:T
       (CL:LET* ((XML-EXPRESSION (XML-TOKEN-LIST-TO-S-EXPRESSION TOKENLIST (%DOCTYPE SELF) (%DOCTYPE-ITERATOR? SELF))))
        (CL:SETF (%VALUE SELF) XML-EXPRESSION)
        (CL:WHEN
         (CL:AND
          (CL:AND (ISA? XML-EXPRESSION SGT-XML-STELLA-CONS)
           (ISA? (%%VALUE XML-EXPRESSION) SGT-XML-STELLA-XML-DECLARATION))
          (STRING-EQL? (%NAME (%%VALUE XML-EXPRESSION)) "DOCTYPE"))
         (CL:WHEN (CL:NOT (CL:EQ (%DOCTYPE SELF) NULL))
          (CL:WARN "Found a DOCTYPE declaration in an XML-EXPRESSION-ITERATOR that already has a doctype!"))
  ...
  (CL:IF (EQL? (%%VALUE REGIONSPEC) (%%VALUE REGIONTAG))
   (CL:LET* ((SPECATTRIBUTES NULL) (TAGATTRIBUTES NULL) (SPECATTRIBUTESOURCE (%%VALUE (%%REST REGIONSPEC))))
    (CL:IF (CL:AND (CL:NOT (CL:EQ SPECATTRIBUTESOURCE NULL)) (CL:NOT (CL:EQ SPECATTRIBUTESOURCE NIL)))
     (CL:LET* ((SELF-000 (NEW-PROPERTY-LIST))) (CL:SETF (%THE-PLIST SELF-000) (%%VALUE (%%REST REGIONSPEC)))
      (CL:SETQ SPECATTRIBUTES SELF-000))
     (CL:RETURN-FROM XML-REGION-MATCHES? CL:T))
    (CL:LET* ((SELF-001 (NEW-PROPERTY-LIST))) (CL:SETF (%THE-PLIST SELF-001) (%%VALUE (%%REST REGIONTAG)))
    ...
    (CL:LET* ((KEY NULL) (VALUE NULL) (ITER-000 (%THE-PLIST SPECATTRIBUTES)))
     (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-000 NIL)) DO (CL:SETQ KEY (%%VALUE ITER-000))
      ...
      (CL:WHEN (CL:NOT (EQL? (LOOKUP TAGATTRIBUTES KEY) VALUE)) (CL:RETURN-FROM XML-REGION-MATCHES? CL:NIL))
  ...
  (CL:LET* ((TEST-VALUE-001 (SAFE-PRIMARY-TYPE REGIONTAG)))
   (CL:COND
    ((SUBTYPE-OF-SYMBOL? TEST-VALUE-001)
     (CL:PROGN
      (CL:RETURN-FROM COERCE-TO-XML-ELEMENT (MAKE-XML-ELEMENT (%SYMBOL-NAME REGIONTAG) "" STELLA::NULL-STRING))))
    ...
    ((SUBTYPE-OF-STRING? TEST-VALUE-001)
     (CL:PROGN
      (CL:RETURN-FROM COERCE-TO-XML-ELEMENT (MAKE-XML-ELEMENT (%WRAPPER-VALUE REGIONTAG) "" STELLA::NULL-STRING))))
    ((CL:EQ TEST-VALUE-001 SGT-XML-STELLA-CONS)
     (CL:PROGN
      (CL:IF (CL:EQ (%%REST REGIONTAG) NIL)
       (CL:RETURN-FROM COERCE-TO-XML-ELEMENT (COERCE-TO-XML-ELEMENT (%%VALUE REGIONTAG)))
          ...
          ((SUBTYPE-OF-SYMBOL? TEST-VALUE-000)
           (CL:PROGN
            (CL:RETURN-FROM COERCE-TO-XML-ELEMENT
             (MAKE-XML-ELEMENT (%SYMBOL-NAME NAME) "" (%WRAPPER-VALUE NAMESPACE)))))
          ((SUBTYPE-OF? TEST-VALUE-000 SGT-XML-STELLA-XML-ELEMENT)
           (CL:PROGN (CL:RETURN-FROM COERCE-TO-XML-ELEMENT NAME)))
          ((SUBTYPE-OF-STRING? TEST-VALUE-000)
           (CL:PROGN
            (CL:RETURN-FROM COERCE-TO-XML-ELEMENT
             (MAKE-XML-ELEMENT (%WRAPPER-VALUE NAME) "" (%WRAPPER-VALUE NAMESPACE)))))
          (CL:T
           (CL:LET* ((STREAM-000 (NEW-OUTPUT-STRING-STREAM)))
       ...
       (CL:PROGN
        (CL:COND ((CL:EQ REGIONTAG NIL))
         ((CL:EQ (%%REST REGIONTAG) NULL)
          (CL:SETF (%REGION-TAG ITERATOR) (CONS (COERCE-TO-XML-ELEMENT (%%VALUE REGIONTAG)) (CONS NIL NIL))))
         ((CL:EQ (%%REST (%%REST REGIONTAG)) NULL)
          (CL:SETF (%REGION-TAG ITERATOR)
           (CONS (COERCE-TO-XML-ELEMENT (%%VALUE REGIONTAG)) (CONS (%%VALUE (%%REST REGIONTAG)) NIL))))
         (CL:T
          (CL:SETF (%REGION-TAG ITERATOR)
           (CONS (COERCE-TO-XML-ELEMENT (%%VALUE REGIONTAG)) (CONS (%%REST REGIONTAG) NIL)))))))
...
(CL:DEFUN XML-CDATA? (ITEM)
  ...
  (CL:COND
   ((SUBTYPE-OF? (SAFE-PRIMARY-TYPE ITEM) SGT-XML-STELLA-XML-SPECIAL)
    (CL:PROGN (CL:RETURN-FROM XML-CDATA? (STRING-EQL? (%NAME ITEM) "CDATA"))))
...
(CL:DEFUN XML-BASE-ATTRIBUTE? (ITEM)
  ...
  (CL:RETURN-FROM XML-BASE-ATTRIBUTE?
   (CL:AND (ISA? ITEM SGT-XML-STELLA-XML-GLOBAL-ATTRIBUTE) (STRING-EQL? "base" (%NAME ITEM))
    (STRING-EQL? *XML-URN* (%NAMESPACE-URI ITEM)))))
...
(CL:DEFUN XML-ELEMENT-FORM? (FORM)
  ...
  (CL:RETURN-FROM XML-ELEMENT-FORM?
   (CL:AND (ISA? FORM SGT-XML-STELLA-CONS) (ISA? (%%VALUE FORM) SGT-XML-STELLA-XML-ELEMENT))))
...
(CL:DEFUN XML-PROCESSING-INSTRUCTION-FORM? (FORM)
  ...
  (CL:RETURN-FROM XML-PROCESSING-INSTRUCTION-FORM?
   (CL:AND (ISA? FORM SGT-XML-STELLA-CONS) (ISA? (%%VALUE FORM) SGT-XML-STELLA-XML-PROCESSING-INSTRUCTION))))
...
(CL:DEFUN XML-DECLARATION-FORM? (FORM)
  ...
  (CL:RETURN-FROM XML-DECLARATION-FORM?
   (CL:AND (ISA? FORM SGT-XML-STELLA-CONS) (ISA? (%%VALUE FORM) SGT-XML-STELLA-XML-DECLARATION))))
...
(CL:DEFUN XML-DOCTYPE-FORM? (FORM)
  ...
  (CL:RETURN-FROM XML-DOCTYPE-FORM?
   (CL:AND (CL:AND (ISA? FORM SGT-XML-STELLA-CONS) (ISA? (%%VALUE FORM) SGT-XML-STELLA-XML-DECLARATION))
    (STRING-EQL? (%NAME (%%VALUE FORM)) "DOCTYPE"))))
...
element if it exists.  Otherwise NULL."
  (CL:LET*
   ((ATTRIBUTE-LIST (%%VALUE (%%REST EXPRESSION))) (ATTRIBUTE NULL) (VALUE STELLA::NULL-STRING)
   ...
   (CL:LOOP WHILE (CL:NOT (CL:EQ ATTRIBUTE-LIST NIL)) DO
    (CL:LET* ((HEAD-000 (%%VALUE ATTRIBUTE-LIST))) (CL:SETQ ATTRIBUTE-LIST (%%REST ATTRIBUTE-LIST))
     (CL:SETQ ATTRIBUTE HEAD-000))
    (CL:LET* ((HEAD-001 (%%VALUE ATTRIBUTE-LIST))) (CL:SETQ ATTRIBUTE-LIST (%%REST ATTRIBUTE-LIST))
     (CL:SETQ VALUE (%WRAPPER-VALUE HEAD-001)))
    (CL:WHEN
     (CL:AND (ISA? ATTRIBUTE SGT-XML-STELLA-XML-GLOBAL-ATTRIBUTE) (STRING-EQL? "base" (%NAME ATTRIBUTE))
      (STRING-EQL? *XML-URN* (%NAMESPACE-URI ATTRIBUTE)))
...
associated with it."
  ...
  (CL:RETURN-FROM XML-ELEMENT-MATCH?
   (CL:AND (STRING-EQL? (%NAME TAG) NAME) (STRING-EQL? (%NAMESPACE-URI TAG) NAMESPACE))))
...
must not have a namespace associated with it."
  ...
  (CL:RETURN-FROM XML-ATTRIBUTE-MATCH?
   (CL:AND (STRING-EQL? (%NAME ATTRIBUTE) NAME) (STRING-EQL? (%NAMESPACE-URI ATTRIBUTE) NAMESPACE))))
...
account use `xml-local-attribute-match?'."
  ...
  (CL:CHECK-TYPE NAMESPACE CL:SIMPLE-STRING)
  (CL:RETURN-FROM XML-ATTRIBUTE-MATCH?
   (CL:AND (CL:EQ NAMESPACE STELLA::NULL-STRING) (STRING-EQL? (%NAME ATTRIBUTE) NAME))))
...
parent element matches `element-name' and `element-namespace'."
  ...
  (CL:RETURN-FROM XML-LOCAL-ATTRIBUTE-MATCH?
   (CL:AND (STRING-EQL? (%NAME ATTRIBUTE) NAME)
    (CL:AND (STRING-EQL? (%NAME (%PARENT-ELEMENT ATTRIBUTE)) ELEMENT-NAME)
     (STRING-EQL? (%NAMESPACE-URI (%PARENT-ELEMENT ATTRIBUTE)) ELEMENT-NAMESPACE)))))
...
not considered by the lookup."
  ...
  (CL:LOOP WHILE (CL:NOT (CL:EQ ATTRIBUTES NIL)) DO
   (CL:WHEN (XML-ATTRIBUTE-MATCH? (%%VALUE ATTRIBUTES) NAME NAMESPACE)
    (CL:RETURN-FROM XML-LOOKUP-ATTRIBUTE (UNWRAP-STRING (%%VALUE (%%REST ATTRIBUTES)))))
         ...
         (CL:COND
          ((CL:EQ (%%REST KEY) NIL)
           (CL:SETQ OUTPUT-CLAUSES
            (CONS
             (CONS (LIST* SYM-XML-STELLA-XML-ELEMENT-MATCH? ITEM (CONS (%%VALUE KEY) (CONS SYM-XML-STELLA-NULL NIL)))
              (CONCATENATE (%%REST CLAUSE) NIL))
             OUTPUT-CLAUSES)))
          ((CL:EQ (%%VALUE (%%REST KEY)) KWD-XML-ANY)
           (CL:SETQ OUTPUT-CLAUSES
            (CONS
             (CONS (LIST* SYM-XML-STELLA-STRING-EQL? (LIST* SYM-XML-STELLA-NAME ITEM NIL) (%%VALUE KEY) NIL)
              (CONCATENATE (%%REST CLAUSE) NIL))
             OUTPUT-CLAUSES)))
          (CL:T
           (CL:SETQ OUTPUT-CLAUSES
            (CONS
             (CONS
              (LIST* SYM-XML-STELLA-XML-ELEMENT-MATCH? ITEM (CONS (%%VALUE KEY) (CONS (%%VALUE (%%REST KEY)) NIL)))
              (CONCATENATE (%%REST CLAUSE) NIL))
             OUTPUT-CLAUSES))))))
       ((SUBTYPE-OF-SYMBOL? TEST-VALUE-000)
        (CL:PROGN
           ...
           (CONS
            (CONS
             (LIST* SYM-XML-STELLA-XML-ELEMENT-MATCH? ITEM
              (CONS (WRAP-STRING (%SYMBOL-NAME KEY)) (CONS SYM-XML-STELLA-NULL NIL)))
             (CONCATENATE (%%REST CLAUSE) NIL))
            OUTPUT-CLAUSES)))))
       ((SUBTYPE-OF-STRING? TEST-VALUE-000)
        (CL:PROGN
         (CL:SETQ OUTPUT-CLAUSES
          (CONS
           (CONS (LIST* SYM-XML-STELLA-XML-ELEMENT-MATCH? ITEM (CONS KEY (CONS SYM-XML-STELLA-NULL NIL)))
            (CONCATENATE (%%REST CLAUSE) NIL))
           OUTPUT-CLAUSES))))
       (CL:T
        (CL:LET* ((STREAM-000 (NEW-OUTPUT-STRING-STREAM)))
  ...
  (CL:IF (ISA? ITEM SGT-XML-STELLA-SYMBOL) (CL:RETURN-FROM XML-TAG-CASE (EXPAND-XML-TAG-CASE ITEM CLAUSES))
   (CL:LET* ((VAR (LOCAL-GENSYM "ITEM")))
    (CL:RETURN-FROM XML-TAG-CASE
     (LIST* SYM-XML-STELLA-LET (CONS (CONS VAR (LIST* SYM-XML-STELLA-XML-ELEMENT ITEM NIL)) NIL)
     ...
     (CL:LET* ((TEST-VALUE-000 (SAFE-PRIMARY-TYPE ITEM)))
      (CL:COND
       ((SUBTYPE-OF? TEST-VALUE-000 SGT-XML-STELLA-XML-ATTRIBUTE)
        (CL:PROGN (%%PRINT-STREAM (%NATIVE-STREAM STREAM) " " (%SURFACE-FORM ITEM))
         (CL:SETQ LAST-WAS-ATTRIBUTE? CL:T)))
       ((SUBTYPE-OF-STRING? TEST-VALUE-000)
        (CL:PROGN
         (CL:IF LAST-WAS-ATTRIBUTE? (%%PRINT-STREAM (%NATIVE-STREAM STREAM) "=")
      ...
      ((SUBTYPE-OF-STRING? TEST-VALUE-000)
       (CL:PROGN (%%PRINT-STREAM (%NATIVE-STREAM STREAM) "\"")
        (CL:LET* ((FOUND?-000 CL:NIL))
         (CL:LET*
          ((CH NULL-CHARACTER) (VECTOR-000 (%WRAPPER-VALUE ITEM)) (INDEX-000 0)
...
In that case, each of the forms is indented by `indent' spaces."
  ...
  (CL:WHEN (ISA? (%%VALUE XML-EXPRESSION) SGT-XML-STELLA-CONS)
   (CL:LET* ((EXP NULL) (ITER-000 XML-EXPRESSION))
    (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-000 NIL)) DO (CL:SETQ EXP (%%VALUE ITER-000))
     (PRINT-XML-EXPRESSION STREAM EXP INDENT) (CL:SETQ ITER-000 (%%REST ITER-000))))
   (CL:RETURN-FROM PRINT-XML-EXPRESSION))
  (CL:LET*
   ((TAG (%%VALUE XML-EXPRESSION)) (ATTRIBUTES (%%VALUE (%%REST XML-EXPRESSION))) (TAGNAME (%SURFACE-FORM TAG))
   ...
   (CL:WHEN (CL:NOT (CL:= INDENT NULL-INTEGER))
    (CL:LET*
     ((I NULL-INTEGER) (ITER-001 1) (UPPER-BOUND-000 INDENT) (UNBOUNDED?-000 (CL:= UPPER-BOUND-000 NULL-INTEGER)))
     ...
     (CL:LOOP WHILE (CL:OR UNBOUNDED?-000 (CL:<= ITER-001 UPPER-BOUND-000)) DO (CL:SETQ I ITER-001) (CL:SETQ I I)
      (%%PRINT-STREAM (%NATIVE-STREAM STREAM) " ") (CL:SETQ ITER-001 (CL:1+ ITER-001)))))
    ...
    (CL:COND
     ((SUBTYPE-OF? TEST-VALUE-001 SGT-XML-STELLA-XML-PROCESSING-INSTRUCTION)
      (CL:PROGN (%%PRINT-STREAM (%NATIVE-STREAM STREAM) "<?" TAGNAME)
       (PRINT-XML-NON-ELEMENT-ATTRIBUTES STREAM ATTRIBUTES) (%%PRINT-STREAM (%NATIVE-STREAM STREAM) "?>" EOL)))
     ...
     ((SUBTYPE-OF? TEST-VALUE-001 SGT-XML-STELLA-XML-SPECIAL)
      (CL:PROGN (%%PRINT-STREAM (%NATIVE-STREAM STREAM) "<![" TAGNAME "[")
       (CL:IF (STRING-EQL? TAGNAME "CDATA")
        (%%PRINT-STREAM (%NATIVE-STREAM STREAM) (UNWRAP-STRING (%%VALUE ATTRIBUTES)))
     ...
     ((SUBTYPE-OF? TEST-VALUE-001 SGT-XML-STELLA-XML-ELEMENT)
      (CL:PROGN
       (CL:COND ((CL:EQ (%%REST XML-EXPRESSION) NIL) (%%PRINT-STREAM (%NATIVE-STREAM STREAM) "<" TAGNAME "/>" EOL))
        (CL:T (%%PRINT-STREAM (%NATIVE-STREAM STREAM) "<" TAGNAME)
         (PRINT-XML-ELEMENT-ATTRIBUTES STREAM (%%VALUE (%%REST XML-EXPRESSION)))
             ...
             ((CL:EQ TEST-VALUE-000 SGT-XML-STELLA-CONS)
              (CL:PROGN
               (CL:IF (XML-CDATA? (%%VALUE ITEM))
                (CL:PROGN
                 (CL:WHEN (CL:NOT IN-CONTENT-FIELD?) (%%PRINT-STREAM (%NATIVE-STREAM STREAM) ">")
                  (CL:SETQ IN-CONTENT-FIELD? CL:T))
                 (PRINT-XML-EXPRESSION STREAM ITEM 0) (CL:SETQ PREVIOUS-ITEM-WAS-STRING? CL:T))
                (CL:PROGN
                 (CL:WHEN (CL:NOT IN-CONTENT-FIELD?) (%%PRINT-STREAM (%NATIVE-STREAM STREAM) ">" EOL)
                  (CL:SETQ IN-CONTENT-FIELD? CL:T))
            ...
            (CL:WHEN (CL:NOT PREVIOUS-ITEM-WAS-STRING?)
             (CL:LET*
              ...
              (CL:LOOP WHILE (CL:OR UNBOUNDED?-001 (CL:<= ITER-003 UPPER-BOUND-001)) DO (CL:SETQ I ITER-003)
               (CL:SETQ I I) (%%PRINT-STREAM (%NATIVE-STREAM STREAM) " ") (CL:SETQ ITER-003 (CL:1+ ITER-003))))))
           (%%PRINT-STREAM (%NATIVE-STREAM STREAM) "</" TAGNAME ">")
           (CL:WHEN (CL:AND (CL:NOT (CL:= INDENT NULL-INTEGER)) (CL:> INDENT 0))
...
(CL:DEFUN HELP-STARTUP-XML1 ()
  (CL:PROGN (CL:SETQ SGT-XML-STELLA-XML-OBJECT (INTERN-RIGID-SYMBOL-WRT-MODULE "XML-OBJECT" NULL 1))
   ...
   (CL:SETQ SGT-XML-STELLA-XML-PROCESSING-INSTRUCTION
    (INTERN-RIGID-SYMBOL-WRT-MODULE "XML-PROCESSING-INSTRUCTION" NULL 1))
   ...
   (CL:SETQ KWD-XML-START (INTERN-RIGID-SYMBOL-WRT-MODULE "START" NULL 2))
   (CL:SETQ KWD-XML-INCLUDE (INTERN-RIGID-SYMBOL-WRT-MODULE "INCLUDE" NULL 2))
   (CL:SETQ KWD-XML-SKIP-WHITESPACE (INTERN-RIGID-SYMBOL-WRT-MODULE "SKIP-WHITESPACE" NULL 2))
   (CL:SETQ SYM-XML-STELLA-! (INTERN-RIGID-SYMBOL-WRT-MODULE "!" NULL 0))
   (CL:SETQ KWD-XML-OPEN-TAG (INTERN-RIGID-SYMBOL-WRT-MODULE "OPEN-TAG" NULL 2))
   (CL:SETQ KWD-XML-EOF (INTERN-RIGID-SYMBOL-WRT-MODULE "EOF" NULL 2))
   (CL:SETQ SYM-XML-STELLA-* (INTERN-RIGID-SYMBOL-WRT-MODULE "*" NULL 0))
   (CL:SETQ KWD-XML-OTHERWISE (INTERN-RIGID-SYMBOL-WRT-MODULE "OTHERWISE" NULL 2))
   (CL:SETQ KWD-XML-CONTENT (INTERN-RIGID-SYMBOL-WRT-MODULE "CONTENT" NULL 2))
   (CL:SETQ KWD-XML-START-TAG-END (INTERN-RIGID-SYMBOL-WRT-MODULE "START-TAG-END" NULL 2))
   ...
   (CL:SETQ KWD-XML-START-PI-TAG (INTERN-RIGID-SYMBOL-WRT-MODULE "START-PI-TAG" NULL 2))
   ...
   (CL:SETQ KWD-XML-EMPTY-TAG-END (INTERN-RIGID-SYMBOL-WRT-MODULE "EMPTY-TAG-END" NULL 2))
   (CL:SETQ KWD-XML-ERROR (INTERN-RIGID-SYMBOL-WRT-MODULE "ERROR" NULL 2))
   (CL:SETQ KWD-XML-END-TAG-END (INTERN-RIGID-SYMBOL-WRT-MODULE "END-TAG-END" NULL 2))
   (CL:SETQ KWD-XML-END-TAG (INTERN-RIGID-SYMBOL-WRT-MODULE "END-TAG" NULL 2))
   ...
   (CL:SETQ KWD-XML-SINGLE-QUOTED-ATTRIBUTE-VALUE
    (INTERN-RIGID-SYMBOL-WRT-MODULE "SINGLE-QUOTED-ATTRIBUTE-VALUE" NULL 2))
   (CL:SETQ KWD-XML-DOUBLE-QUOTED-ATTRIBUTE-VALUE
    (INTERN-RIGID-SYMBOL-WRT-MODULE "DOUBLE-QUOTED-ATTRIBUTE-VALUE" NULL 2))
   ...
   (CL:SETQ KWD-XML-DECLARATION-TAG-MARKUP-DATA-START
    (INTERN-RIGID-SYMBOL-WRT-MODULE "DECLARATION-TAG-MARKUP-DATA-START" NULL 2))
   (CL:SETQ KWD-XML-SINGLE-QUOTED-DECLARATION-TAG-DATA
    (INTERN-RIGID-SYMBOL-WRT-MODULE "SINGLE-QUOTED-DECLARATION-TAG-DATA" NULL 2))
   (CL:SETQ KWD-XML-DOUBLE-QUOTED-DECLARATION-TAG-DATA
    (INTERN-RIGID-SYMBOL-WRT-MODULE "DOUBLE-QUOTED-DECLARATION-TAG-DATA" NULL 2))
...
(CL:DEFUN HELP-STARTUP-XML2 ()
  (CL:PROGN
   (CL:SETQ KWD-XML-DECLARATION-TAG-MARKUP-DATA (INTERN-RIGID-SYMBOL-WRT-MODULE "DECLARATION-TAG-MARKUP-DATA" NULL 2))
   ...
   (CL:SETQ SYM-XML-STELLA-OTHERWISE (INTERN-RIGID-SYMBOL-WRT-MODULE "OTHERWISE" NULL 0))
   (CL:SETQ SYM-XML-STELLA-COND (INTERN-RIGID-SYMBOL-WRT-MODULE "COND" NULL 0))
   (CL:SETQ SGT-XML-STELLA-SYMBOL (INTERN-RIGID-SYMBOL-WRT-MODULE "SYMBOL" NULL 1))
   (CL:SETQ SYM-XML-STELLA-LET (INTERN-RIGID-SYMBOL-WRT-MODULE "LET" NULL 0))
...
(CL:DEFUN HELP-STARTUP-XML3 ()
  (CL:PROGN
   (CL:LET*
    ...
    (CL:SETF (%CLASS-CONSTRUCTOR-CODE CLASS) (CL:FUNCTION NEW-XML-OBJECT))
    (CL:SETF (%CLASS-SLOT-ACCESSOR-CODE CLASS) (CL:FUNCTION ACCESS-XML-OBJECT-SLOT-VALUE)))
   (CL:LET*
    ((CLASS
    ...
    (CL:SETF (%CLASS-CONSTRUCTOR-CODE CLASS) (CL:FUNCTION NEW-XML-ELEMENT))
    (CL:SETF (%CLASS-SLOT-ACCESSOR-CODE CLASS) (CL:FUNCTION ACCESS-XML-ELEMENT-SLOT-VALUE)))
   (CL:LET*
    ((CLASS
   ...
   (CL:LET*
    ...
    (CL:SETF (%CLASS-CONSTRUCTOR-CODE CLASS) (CL:FUNCTION NEW-XML-SPECIAL))
    (CL:SETF (%CLASS-SLOT-ACCESSOR-CODE CLASS) (CL:FUNCTION ACCESS-XML-SPECIAL-SLOT-VALUE)))
   (CL:LET*
    ((CLASS
   ...
   (CL:LET*
    ...
    (CL:SETF (%CLASS-CONSTRUCTOR-CODE CLASS) (CL:FUNCTION NEW-XML-DOCTYPE))
    (CL:SETF (%CLASS-SLOT-ACCESSOR-CODE CLASS) (CL:FUNCTION ACCESS-XML-DOCTYPE-SLOT-VALUE)))
   (CL:LET*
    ((CLASS
...
will not be eq? to already existing ones with the same name.\")" (CL:FUNCTION RESET-XML-HASH-TABLES) NULL)
   (DEFINE-FUNCTION-OBJECT "MAKE-NAMESPACE-TABLE"
    "(DEFUN (MAKE-NAMESPACE-TABLE (KV-CONS OF STRING-WRAPPER STRING-WRAPPER)) ())" (CL:FUNCTION MAKE-NAMESPACE-TABLE)
    NULL)
   (DEFINE-FUNCTION-OBJECT "MAKE-XML-CDATA-FORM" "(DEFUN (MAKE-XML-CDATA-FORM CONS) ((THE-DATA STRING)))"
    (CL:FUNCTION MAKE-XML-CDATA-FORM) NULL)
   (DEFINE-FUNCTION-OBJECT "MAKE-XMLNS-ATTRIBUTE" "(DEFUN (MAKE-XMLNS-ATTRIBUTE XML-ATTRIBUTE) ((NAME STRING)))"
...
`namespace-name' to refer to  `namespace'.  `namespace'must be a URI.\")" (CL:FUNCTION MAKE-XML-GLOBAL-ATTRIBUTE) NULL)
   ...
   (DEFINE-FUNCTION-OBJECT "XMLNS-ATTRIBUTE?" "(DEFUN (XMLNS-ATTRIBUTE? BOOLEAN) ((ATTRIBUTE OBJECT)))"
    (CL:FUNCTION XMLNS-ATTRIBUTE?) NULL)
   (DEFINE-FUNCTION-OBJECT "XMLNS-ATTRIBUTE-NAME?" "(DEFUN (XMLNS-ATTRIBUTE-NAME? BOOLEAN) ((NAME STRING)))"
    (CL:FUNCTION XMLNS-ATTRIBUTE-NAME?) NULL)
   (DEFINE-FUNCTION-OBJECT "EXTRACT-XMLNS-NAME" "(DEFUN (EXTRACT-XMLNS-NAME STRING) ((KEYNAME STRING)))"
   ...
   (DEFINE-FUNCTION-OBJECT "DECODE-XML-CHAR-REF" "(DEFUN (DECODE-XML-CHAR-REF STRING) ((DIGITS STRING)))"
...
a DOCTYPE object.\")" (CL:FUNCTION PROCESS-DOCTYPE) NULL)
   (DEFINE-FUNCTION-OBJECT "GET-XML-WHITESPACE-PRESERVING-TOKENIZER-TABLE"
    "(DEFUN (GET-XML-WHITESPACE-PRESERVING-TOKENIZER-TABLE TOKENIZER-TABLE) ())"
    (CL:FUNCTION GET-XML-WHITESPACE-PRESERVING-TOKENIZER-TABLE) NULL)
   (DEFINE-FUNCTION-OBJECT "GET-XML-TOKENIZER-TABLE" "(DEFUN (GET-XML-TOKENIZER-TABLE TOKENIZER-TABLE) ())"
...
return them in a list.\")" (CL:FUNCTION READ-XML-EXPRESSIONS) NULL)
   (DEFINE-METHOD-OBJECT "(DEFMETHOD (NEXT? BOOLEAN) ((SELF XML-EXPRESSION-ITERATOR)) :PUBLIC? TRUE)"
   ...
   (DEFINE-FUNCTION-OBJECT "XML-REGION-MATCHES?"
    "(DEFUN (XML-REGION-MATCHES? BOOLEAN) ((REGIONSPEC CONS) (REGIONTAG CONS)))" (CL:FUNCTION XML-REGION-MATCHES?)
    NULL)
   (DEFINE-FUNCTION-OBJECT "COERCE-TO-XML-ELEMENT" "(DEFUN (COERCE-TO-XML-ELEMENT XML-ELEMENT) ((REGIONTAG OBJECT)))"
    ...
    (CL:SETQ *XML-TOKENIZER-TABLE-DEFINITION*
     (LIST* (LIST* KWD-XML-START KWD-XML-INCLUDE KWD-XML-SKIP-WHITESPACE NIL)
      (LIST* KWD-XML-SKIP-WHITESPACE SYM-XML-STELLA-!
       ...
       KWD-XML-SKIP-WHITESPACE SYM-XML-STELLA-! (WRAP-STRING "<") KWD-XML-OPEN-TAG KWD-XML-EOF KWD-XML-EOF
       SYM-XML-STELLA-* KWD-XML-OTHERWISE KWD-XML-CONTENT NIL)
      (LIST* KWD-XML-CONTENT SYM-XML-STELLA-! (WRAP-STRING "<") KWD-XML-OPEN-TAG KWD-XML-EOF KWD-XML-EOF
       KWD-XML-OTHERWISE KWD-XML-CONTENT NIL)
      (LIST* KWD-XML-OPEN-TAG SYM-XML-STELLA-* (WRAP-STRING ">") KWD-XML-START-TAG-END SYM-XML-STELLA-!
       (WRAP-STRING "/") KWD-XML-OPEN-END-TAG (WRAP-STRING "?") KWD-XML-OPEN-PI-TAG (WRAP-STRING "!")
       KWD-XML-OPEN-DECLARATION-TAG
       (LIST* (WRAP-CHARACTER #\ ) (WRAP-CHARACTER #\Tab) (WRAP-CHARACTER #\Linefeed) (WRAP-CHARACTER #\Return) NIL)
       KWD-XML-OPEN-TAG SYM-XML-STELLA-* KWD-XML-OTHERWISE KWD-XML-START-TAG NIL)
      (LIST* KWD-XML-START-TAG SYM-XML-STELLA-* (WRAP-STRING ">") KWD-XML-START-TAG-END SYM-XML-STELLA-!
       (WRAP-STRING "/") KWD-XML-OPEN-EMPTY-TAG-END SYM-XML-STELLA-!
       (LIST* (WRAP-CHARACTER #\ ) (WRAP-CHARACTER #\Tab) (WRAP-CHARACTER #\Linefeed) (WRAP-CHARACTER #\Return) NIL)
       KWD-XML-SKIP-TO-ATTRIBUTE-NAME KWD-XML-OTHERWISE KWD-XML-START-TAG NIL)
      ...
      (LIST* KWD-XML-PI-TAG-DATA (WRAP-STRING "?") (LIST* KWD-XML-PI-TAG-DATA-OR-END KWD-XML-PI-TAG-DATA NIL)
       KWD-XML-OTHERWISE KWD-XML-PI-TAG-DATA NIL)
      (LIST* KWD-XML-PI-TAG-DATA-OR-END SYM-XML-STELLA-* (WRAP-STRING ">") KWD-XML-EMPTY-TAG-END KWD-XML-OTHERWISE
       KWD-XML-PI-TAG-DATA NIL)
      (LIST* KWD-XML-OPEN-PI-TAG-END SYM-XML-STELLA-* (WRAP-STRING ">") KWD-XML-EMPTY-TAG-END KWD-XML-OTHERWISE
       KWD-XML-ERROR NIL)
      (LIST* KWD-XML-OPEN-END-TAG SYM-XML-STELLA-! (WRAP-STRING ">") KWD-XML-END-TAG-END SYM-XML-STELLA-*
       KWD-XML-OTHERWISE KWD-XML-END-TAG NIL)
      (LIST* KWD-XML-END-TAG SYM-XML-STELLA-! (WRAP-STRING ">") KWD-XML-END-TAG-END KWD-XML-OTHERWISE KWD-XML-END-TAG
       NIL)
      (LIST* KWD-XML-SKIP-TO-ATTRIBUTE-NAME SYM-XML-STELLA-* (WRAP-STRING ">") KWD-XML-START-TAG-END SYM-XML-STELLA-!
       (WRAP-STRING "/") KWD-XML-OPEN-EMPTY-TAG-END SYM-XML-STELLA-!
       (LIST* (WRAP-CHARACTER #\ ) (WRAP-CHARACTER #\Tab) (WRAP-CHARACTER #\Linefeed) (WRAP-CHARACTER #\Return) NIL)
       KWD-XML-SKIP-TO-ATTRIBUTE-NAME SYM-XML-STELLA-* KWD-XML-OTHERWISE KWD-XML-ATTRIBUTE-NAME NIL)
      (LIST* KWD-XML-ATTRIBUTE-NAME SYM-XML-STELLA-* (WRAP-STRING ">") KWD-XML-START-TAG-END SYM-XML-STELLA-!
       (WRAP-STRING "/") KWD-XML-OPEN-EMPTY-TAG-END SYM-XML-STELLA-!
       (LIST* (WRAP-CHARACTER #\=) (WRAP-CHARACTER #\ ) (WRAP-CHARACTER #\Tab) (WRAP-CHARACTER #\Linefeed)
        (WRAP-CHARACTER #\Return) NIL)
       KWD-XML-SKIP-TO-ATTRIBUTE-VALUE KWD-XML-OTHERWISE KWD-XML-ATTRIBUTE-NAME NIL)
      (LIST* KWD-XML-SKIP-TO-ATTRIBUTE-VALUE SYM-XML-STELLA-* (WRAP-STRING ">") KWD-XML-START-TAG-END SYM-XML-STELLA-!
       (WRAP-STRING "/") KWD-XML-OPEN-EMPTY-TAG-END
       (LIST* (WRAP-CHARACTER #\=) (WRAP-CHARACTER #\ ) (WRAP-CHARACTER #\Tab) (WRAP-CHARACTER #\Linefeed)
        (WRAP-CHARACTER #\Return) NIL)
       KWD-XML-SKIP-TO-ATTRIBUTE-VALUE SYM-XML-STELLA-* (WRAP-STRING "'") KWD-XML-SINGLE-QUOTED-ATTRIBUTE-VALUE
       SYM-XML-STELLA-* (WRAP-STRING "\"") KWD-XML-DOUBLE-QUOTED-ATTRIBUTE-VALUE SYM-XML-STELLA-* KWD-XML-OTHERWISE
       KWD-XML-UNQUOTED-ATTRIBUTE-VALUE NIL)
      (LIST* KWD-XML-SINGLE-QUOTED-ATTRIBUTE-VALUE (WRAP-STRING "'") KWD-XML-QUOTED-ATTRIBUTE-VALUE KWD-XML-OTHERWISE
       KWD-XML-SINGLE-QUOTED-ATTRIBUTE-VALUE NIL)
      (LIST* KWD-XML-DOUBLE-QUOTED-ATTRIBUTE-VALUE (WRAP-STRING "\"") KWD-XML-QUOTED-ATTRIBUTE-VALUE KWD-XML-OTHERWISE
      ...
      (LIST* KWD-XML-UNQUOTED-ATTRIBUTE-VALUE SYM-XML-STELLA-* (WRAP-STRING ">") KWD-XML-START-TAG-END SYM-XML-STELLA-!
       (WRAP-STRING "/") KWD-XML-OPEN-EMPTY-TAG-END SYM-XML-STELLA-!
       (LIST* (WRAP-CHARACTER #\ ) (WRAP-CHARACTER #\Tab) (WRAP-CHARACTER #\Linefeed) (WRAP-CHARACTER #\Return) NIL)
       KWD-XML-SKIP-TO-ATTRIBUTE-NAME KWD-XML-OTHERWISE KWD-XML-UNQUOTED-ATTRIBUTE-VALUE NIL)
      (LIST* KWD-XML-OPEN-DECLARATION-TAG (WRAP-STRING "-") KWD-XML-START-TAG-OR-COMMENT (WRAP-STRING "[")
       KWD-XML-OPEN-SPECIAL-TAG SYM-XML-STELLA-* KWD-XML-OTHERWISE KWD-XML-START-DECLARATION-TAG NIL)
      (LIST* KWD-XML-START-DECLARATION-TAG SYM-XML-STELLA-* (WRAP-STRING ">") KWD-XML-EMPTY-TAG-END SYM-XML-STELLA-!
       (LIST* (WRAP-CHARACTER #\ ) (WRAP-CHARACTER #\Tab) (WRAP-CHARACTER #\Linefeed) (WRAP-CHARACTER #\Return) NIL)
       KWD-XML-DECLARATION-WHITESPACE KWD-XML-OTHERWISE KWD-XML-START-DECLARATION-TAG NIL)
      (LIST* KWD-XML-DECLARATION-WHITESPACE SYM-XML-STELLA-!
       (LIST* (WRAP-CHARACTER #\ ) (WRAP-CHARACTER #\Tab) (WRAP-CHARACTER #\Linefeed) (WRAP-CHARACTER #\Return) NIL)
       KWD-XML-DECLARATION-WHITESPACE SYM-XML-STELLA-* (WRAP-STRING ">") KWD-XML-EMPTY-TAG-END SYM-XML-STELLA-*
       (WRAP-STRING "[") KWD-XML-DECLARATION-TAG-MARKUP-DATA-START SYM-XML-STELLA-* (WRAP-STRING "'")
       KWD-XML-SINGLE-QUOTED-DECLARATION-TAG-DATA SYM-XML-STELLA-* (WRAP-STRING "\"")
       KWD-XML-DOUBLE-QUOTED-DECLARATION-TAG-DATA SYM-XML-STELLA-* KWD-XML-OTHERWISE KWD-XML-DECLARATION-TAG-DATA NIL)
      (LIST* KWD-XML-DECLARATION-TAG-DATA SYM-XML-STELLA-!
       (LIST* (WRAP-CHARACTER #\ ) (WRAP-CHARACTER #\Tab) (WRAP-CHARACTER #\Linefeed) (WRAP-CHARACTER #\Return) NIL)
       KWD-XML-DECLARATION-WHITESPACE SYM-XML-STELLA-* (WRAP-STRING ">") KWD-XML-EMPTY-TAG-END SYM-XML-STELLA-*
       (WRAP-STRING "[") KWD-XML-DECLARATION-TAG-MARKUP-DATA-START (WRAP-STRING "'")
       KWD-XML-SINGLE-QUOTED-DECLARATION-TAG-DATA (WRAP-STRING "\"") KWD-XML-DOUBLE-QUOTED-DECLARATION-TAG-DATA
       KWD-XML-OTHERWISE KWD-XML-DECLARATION-TAG-DATA NIL)
      (LIST* KWD-XML-SINGLE-QUOTED-DECLARATION-TAG-DATA (WRAP-STRING "'") KWD-XML-QUOTED-DECLARATION-TAG-DATA
       KWD-XML-OTHERWISE KWD-XML-SINGLE-QUOTED-DECLARATION-TAG-DATA NIL)
      (LIST* KWD-XML-DOUBLE-QUOTED-DECLARATION-TAG-DATA (WRAP-STRING "\"") KWD-XML-QUOTED-DECLARATION-TAG-DATA
       KWD-XML-OTHERWISE KWD-XML-DOUBLE-QUOTED-DECLARATION-TAG-DATA NIL)
      (LIST* KWD-XML-QUOTED-DECLARATION-TAG-DATA KWD-XML-INCLUDE KWD-XML-DECLARATION-WHITESPACE NIL)
      (LIST* KWD-XML-DECLARATION-TAG-MARKUP-DATA-START (WRAP-STRING "]") KWD-XML-DECLARATION-TAG-MARKUP-DATA
       KWD-XML-OTHERWISE KWD-XML-DECLARATION-TAG-MARKUP-DATA-START NIL)
      (LIST* KWD-XML-DECLARATION-TAG-MARKUP-DATA SYM-XML-STELLA-* (WRAP-STRING ">") KWD-XML-EMPTY-TAG-END
       KWD-XML-OTHERWISE KWD-XML-ERROR NIL)
      (LIST* KWD-XML-OPEN-SPECIAL-TAG SYM-XML-STELLA-* KWD-XML-ANY KWD-XML-START-SPECIAL-TAG NIL)
      (LIST* KWD-XML-START-SPECIAL-TAG SYM-XML-STELLA-* (WRAP-STRING "[") KWD-XML-SPECIAL-TAG-DATA KWD-XML-OTHERWISE
       KWD-XML-START-SPECIAL-TAG NIL)
      (LIST* KWD-XML-SPECIAL-TAG-DATA (WRAP-STRING "]") KWD-XML-SPECIAL-TAG-DATA-OR-END KWD-XML-OTHERWISE
       KWD-XML-SPECIAL-TAG-DATA NIL)
      (LIST* KWD-XML-SPECIAL-TAG-DATA-OR-END (WRAP-STRING "]")
       (LIST* KWD-XML-SPECIAL-TAG-DATA-OR-END2 KWD-XML-SPECIAL-TAG-DATA NIL) KWD-XML-OTHERWISE KWD-XML-SPECIAL-TAG-DATA
       NIL)
      (LIST* KWD-XML-SPECIAL-TAG-DATA-OR-END2 SYM-XML-STELLA-* (WRAP-STRING ">") KWD-XML-DATA-TAG-END KWD-XML-OTHERWISE
       KWD-XML-SPECIAL-TAG-DATA NIL)
      (LIST* KWD-XML-START-TAG-OR-COMMENT (WRAP-STRING "-") KWD-XML-COMMENT-BODY SYM-XML-STELLA-* KWD-XML-OTHERWISE
       KWD-XML-START-TAG NIL)
      (LIST* KWD-XML-COMMENT-BODY (WRAP-STRING "-") KWD-XML-END-COMMENT-OR-COMMENT KWD-XML-OTHERWISE
       KWD-XML-COMMENT-BODY NIL)
      (LIST* KWD-XML-END-COMMENT-OR-COMMENT (WRAP-STRING "-") KWD-XML-END-COMMENT-OR-COMMENT2 KWD-XML-OTHERWISE
       KWD-XML-COMMENT-BODY NIL)
      ...
      (LIST* KWD-XML-OPEN-EMPTY-TAG-END SYM-XML-STELLA-* (WRAP-STRING ">") KWD-XML-EMPTY-TAG-END KWD-XML-OTHERWISE
       KWD-XML-ERROR NIL)
...
not considered by the lookup.\" :PUBLIC? TRUE)" (CL:FUNCTION XML-LOOKUP-ATTRIBUTE) NULL)
    (DEFINE-FUNCTION-OBJECT "EXPAND-XML-TAG-CASE"
     "(DEFUN (EXPAND-XML-TAG-CASE CONS) ((ITEM SYMBOL) (CLAUSES (CONS OF CONS))))" (CL:FUNCTION EXPAND-XML-TAG-CASE)
     NULL)
...
Also handles a list of xml forms such as that returned by `XML-expressions'.
In that case, each of the forms is indented by `indent' spaces.\" :PUBLIC? TRUE)" (CL:FUNCTION PRINT-XML-EXPRESSION)
     NULL)
    ...
    (CL:LET* ((FUNCTION (LOOKUP-FUNCTION SYM-XML-STELLA-STARTUP-XML)))
     (SET-DYNAMIC-SLOT-VALUE (%DYNAMIC-SLOTS FUNCTION) SYM-XML-STELLA-METHOD-STARTUP-CLASSNAME
