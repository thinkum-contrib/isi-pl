...
(CL:DECLAIM
  ...
  *CURRENT-STREAM* *CURRENT-STELLA-FEATURES* *SYMBOL-REGISTRY* EOL
  *MODULE* NULL-CHARACTER *CHARACTER-DOWNCASE-TABLE*
  *CHARACTER-UPCASE-TABLE* NULL-INTEGER *METHODBEINGWALKED*
  *DUMMYDECLARATIONS* *CONTEXT* TRUE NIL FALSE NULL-STRING-WRAPPER))
...
(CL:DEFUN JAVA-YIELD-SPECIAL-VARIABLE-CLASS-NAME ()
  (CL:IF
   (CL:OR
    (CL:NOT
     (CL:EQ (GET-STELLA-CLASS "STELLA-SPECIAL-VARIABLE" FALSE) NULL))
...
(CL:DEFUN JAVA-YIELD-FLOTSAM-TYPE-NAME (FLOTSAM-CLASS-NAME)
  ...
  (CL:LET*
   ...
   (CL:LOOP WHILE (DEFINED? NEXT-PERIOD) DO
...
(CL:DEFUN INHERITED-CLASS-NAME-CONFLICTS? (STELLA-CLASS-NAME)
  ...
  (CL:LET*
   ((STELLA-CLASS (GET-STELLA-CLASS STELLA-CLASS-NAME FALSE))
   ...
   (CL:LET*
    ((MODULE NULL) (ITER-002 (%THE-CONS-LIST (%USES *MODULE*))))
       ...
       (CL:COND
        ((CL:NOT
          (CL:EQ
           (%WRAPPER-VALUE
            (DYNAMIC-SLOT-VALUE
             (%DYNAMIC-SLOTS (%SURROGATE-VALUE TYPE-SPEC))
             SYM-JAVA-TRANSLATE-STELLA-CLASS-JAVA-NATIVE-TYPE
             NULL-STRING-WRAPPER))
           STELLA::NULL-STRING))
         (CL:RETURN-FROM JAVA-TRANSLATE-TYPE-SPEC
          (WRAP-STRING
           (JAVA-NATIVE-TYPE (%SURROGATE-VALUE TYPE-SPEC)))))
        (CL:T
         (CL:SETQ FINAL-TYPE
          (%CLASS-TYPE (%SURROGATE-VALUE TYPE-SPEC)))
         (CL:SETQ TYPE-NAME
          (%WRAPPER-VALUE
           (JAVA-TRANSLATE-CLASS-NAMESTRING
...
(CL:DEFUN JAVA-TRANSLATE-ARRAY-TYPE (ARRAYTYPE)
  (CL:LET*
   ...
   (CL:CASE (LENGTH DIMENSIONS)
    ...
    (CL:OTHERWISE
     (CL:LET*
      ((UNUSED-DIM NULL) (ITER-000 (%THE-CONS-LIST DIMENSIONS)))
      (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-000 NIL)) DO
          ...
          (CONS
           (LIST* SYM-JAVA-TRANSLATE-STELLA-JAVA_METHOD_CALL
            ...
            (LIST* SYM-JAVA-TRANSLATE-STELLA-JAVA_IDENT
             (WRAP-STRING "get") NIL)
            (LIST* SYM-JAVA-TRANSLATE-STELLA-JAVA_IDENT
             (JAVA-TRANSLATE-GLOBAL-NAME SPECIALVARIABLENAME FALSE)
             NIL)
            (CONS SYM-JAVA-TRANSLATE-STELLA-JAVA_ACTUALS NIL) NIL)
           NIL)))
        SAVEDECLARATIONS))
           ...
           (CONS
            (LIST* SYM-JAVA-TRANSLATE-STELLA-JAVA_CAST
             (LIST* SYM-JAVA-TRANSLATE-STELLA-JAVA_METHOD_CALL
              ...
              (CONS SYM-JAVA-TRANSLATE-STELLA-JAVA_ACTUALS NIL) NIL)
             (JAVA-TRANSLATE-TYPE-SPEC
              SGT-JAVA-TRANSLATE-STELLA-OBJECT)
             NIL)
            NIL))
          (CONCATENATE BODY NIL))
         NIL)
  ...
  (CL:LET*
   ...
   (CL:LET*
    ((ITERATORBINDINGS (%%VALUE (%%REST TREE)))
     ...
     (DECLARATIONS NIL) (NEXTASSIGNMENTS NIL)
     (ITERATORCONSTRUCTOR NULL))
    ...
    (CL:LET* ((BINDING NULL) (ITER-001 CURSORBINDINGS))
     (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-001 NIL)) DO
      ...
      (CL:WHEN
       (CL:NOT
        (DUPLICATE-CURSOR-VARIABLE? (%%VALUE BINDING)
         ITERATORBINDINGS))
       ...
       (CONS
        (LIST* SYM-JAVA-TRANSLATE-STELLA-JAVA_STATEMENTS
         (LIST* SYM-JAVA-TRANSLATE-STELLA-JAVA_NAMED_STATEMENT
          (JAVA-TRANSLATE-A-TREE *JAVA-LOOP-NAME*)
          (CONS
           (LIST* SYM-JAVA-TRANSLATE-STELLA-JAVA_FOREACH
            CONTINUATIONTEST
   ...
   (CL:LET*
    ...
    (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-000 NIL)) DO
     ...
     (CL:COND (SKIPPARAMETER? (CL:SETQ SKIPPARAMETER? FALSE))
      ...
      (CL:T
       (CL:SETQ PARAMCLASSES
        (CONS (JAVA-YIELD-CLASS-OBJECT-EXPRESSION TS)
         PARAMCLASSES))))))
   (CL:WHEN
       ...
       (LIST* SYM-JAVA-TRANSLATE-STELLA-JAVA_FUNCTION_CALL
        ...
        (LIST* SYM-JAVA-TRANSLATE-STELLA-JAVA_ACTUALS
         ...
         (CONS (WRAP-STRING FUNCTIONNAME)
          (CONS (JAVA-TRANSLATE-PARAM-TYPE-SPECIFICATIONS FN NULL)
           NIL)))
        NIL)))
...
(CL:DEFUN JAVA-TRANSLATE-EOL ()
  (CL:RETURN-FROM JAVA-TRANSLATE-EOL
   (LIST* SYM-JAVA-TRANSLATE-STELLA-JAVA_EOL
    (JAVA-TRANSLATE-GLOBAL-NAME SYM-JAVA-TRANSLATE-STELLA-EOL FALSE)
    NIL)))
...
(CL:DEFUN JAVA-TRANSLATE-GLOBAL-NAME (NAMESYMBOL DEFINITION?)
  ...
  (CL:WHEN (CL:NOT DEFINITION?)
   (CL:WHEN (CL:EQ NAMESYMBOL SYM-JAVA-TRANSLATE-STELLA-TRUE)
    (CL:RETURN-FROM JAVA-TRANSLATE-GLOBAL-NAME (WRAP-STRING "true")))
   (CL:WHEN (CL:EQ NAMESYMBOL SYM-JAVA-TRANSLATE-STELLA-FALSE)
    (CL:RETURN-FROM JAVA-TRANSLATE-GLOBAL-NAME (WRAP-STRING "false"))))
  (CL:LET*
   ((RAWNAME
     (JAVA-SUBSTITUTE-FORBIDDEN-CHARACTERS
...
(CL:DEFUN JAVA-CREATE-OVERLOADED-FUNCTION-NAME (FUNCTIONNAME CLASSTYPE)
  (CL:RETURN-FROM JAVA-CREATE-OVERLOADED-FUNCTION-NAME
   (INTERN-SYMBOL
    (CONCATENATE (%SYMBOL-NAME CLASSTYPE) "_"
  ...
  (CL:LET* ((OPERATOR (CL:IF NULL? "==" "!=")))
   ...
   (CL:COND
    ...
    ((SUBTYPE-OF? CLASSTYPE SGT-JAVA-TRANSLATE-STELLA-FLOAT)
     (CL:RETURN-FROM JAVA-TRANSLATE-DEFINED-OR-NULL
      (JAVA-TRANSLATE-OPERATOR-CALL (CONS (WRAP-STRING OPERATOR) NIL)
       (CONS OBJECT (CONS SYM-JAVA-TRANSLATE-STELLA-NULL-FLOAT NIL))
       2)))
    ...
    ((SUBTYPE-OF? CLASSTYPE SGT-JAVA-TRANSLATE-STELLA-CHARACTER)
     (CL:RETURN-FROM JAVA-TRANSLATE-DEFINED-OR-NULL
      (JAVA-TRANSLATE-OPERATOR-CALL (CONS (WRAP-STRING OPERATOR) NIL)
       (CONS OBJECT
        (CONS SYM-JAVA-TRANSLATE-STELLA-NULL-CHARACTER NIL))
       2)))
    (CL:T
     (CL:RETURN-FROM JAVA-TRANSLATE-DEFINED-OR-NULL
      (JAVA-TRANSLATE-OPERATOR-CALL (CONS (WRAP-STRING OPERATOR) NIL)
...
(CL:DEFUN HELP-STARTUP-JAVA-TRANSLATE6 ()
  (CL:PROGN (CL:SETQ *VARARGSTATEMENTS* NIL)
...
(CL:DEFUN STARTUP-JAVA-TRANSLATE ()
  (CL:LET* ((*MODULE* *STELLA-MODULE*) (*CONTEXT* *MODULE*))
   ...
   (CL:WHEN (CURRENT-STARTUP-TIME-PHASE? 7)
    (HELP-STARTUP-JAVA-TRANSLATE7) (HELP-STARTUP-JAVA-TRANSLATE8)
