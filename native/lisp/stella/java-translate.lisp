  ...
  (CL:LET*
   ...
   (CL:WHEN
    ...
    (CL:RETURN-FROM JAVA-TRANSLATE-CAST
     (JAVA-TRANSLATE-A-TREE (COERCE-NUMERIC-CONSTANT EXPRESSION TYPE))))
...
(CL:DEFUN STARTUP-JAVA-TRANSLATE ()
  (CL:LET* ((*MODULE* *STELLA-MODULE*) (*CONTEXT* *MODULE*))
   ...
   (CL:WHEN (CURRENT-STARTUP-TIME-PHASE? 7) (HELP-STARTUP-JAVA-TRANSLATE6)
    (HELP-STARTUP-JAVA-TRANSLATE7)
