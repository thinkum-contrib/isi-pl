...
(CL:DEFVAR KWD-JAVA-TRANSLATE-UNESCAPED NULL)
...
(CL:DEFVAR SYM-JAVA-TRANSLATE-STELLA-ARG_ENUM NULL)
(CL:DEFVAR SYM-JAVA-TRANSLATE-STELLA-JAVA_WHILE NULL)
(CL:DEFVAR SYM-JAVA-TRANSLATE-STELLA-JAVA_CAST NULL)
(CL:DEFVAR SYM-JAVA-TRANSLATE-STELLA-ELEMENTS NULL)
(CL:DEFVAR SGT-JAVA-TRANSLATE-STELLA-OBJECT NULL)
(CL:DEFVAR SGT-JAVA-TRANSLATE-STELLA-LISP-CONS-ITERATOR NULL)
...
(CL:DECLAIM
  ...
  *CURRENT-STELLA-FEATURES* *SYMBOL-REGISTRY* EOL *MODULE* NULL-CHARACTER
  *CHARACTER-DOWNCASE-TABLE* *CHARACTER-UPCASE-TABLE* NULL-INTEGER
  *METHODBEINGWALKED* *DUMMYDECLARATIONS* *CONTEXT* TRUE NIL FALSE
  NULL-STRING-WRAPPER))
   ...
   (CL:IF
    ...
    (CL:PROGN
     ...
     (SET-DYNAMIC-SLOT-VALUE (%DYNAMIC-SLOTS MOD)
      SYM-JAVA-TRANSLATE-STELLA-JAVA-FLOTSAM-CLASS (WRAP-STRING FLOTSAMCLASSNAME)
      NULL-STRING-WRAPPER)
     (CL:RETURN-FROM JAVA-YIELD-FLOTSAM-CLASS-NAME FLOTSAMCLASSNAME)))))
(CL:DECLAIM
 (CL:FTYPE (CL:FUNCTION (CL:T) CL:SIMPLE-STRING) JAVA-YIELD-FLOTSAM-CLASS-NAME))

;;; (DEFUN (JAVA-YIELD-NATIVE-CLASS-NAME STRING) ...)

(CL:DEFUN JAVA-YIELD-NATIVE-CLASS-NAME ()
  (CL:IF
   (CL:OR (CL:NOT (CL:EQ (GET-STELLA-CLASS "NATIVE" FALSE) NULL))
...
(CL:DEFUN JAVA-YIELD-SPECIAL-VARIABLE-CLASS-NAME ()
  (CL:IF
   (CL:OR
    (CL:NOT (CL:EQ (GET-STELLA-CLASS "STELLA-SPECIAL-VARIABLE" FALSE) NULL))
...
(CL:DECLAIM
 (CL:FTYPE (CL:FUNCTION () CL:SIMPLE-STRING) JAVA-YIELD-FULL-NATIVE-CLASS-NAME))
   ...
   (CL:LET*
    ...
    (CL:LET*
     ((VARIABLETYPE
      ...
      (VARIABLENAME (JAVA-TRANSLATE-GLOBAL-NAME (%VARIABLE-NAME GLOBAL) TRUE)))
     ...
     (CL:IF
      (CL:OR
       (CL:EQ (%CODE-REGISTER UNIT) KWD-JAVA-TRANSLATE-UNBOUND-SPECIAL-VARIABLE)
...
(CL:DEFUN JAVA-SYNCHRONIZED-METHOD? (METHOD)
  ...
  (CL:RETURN-FROM JAVA-SYNCHRONIZED-METHOD? FALSE))
    ...
    (CL:IF (%ABSTRACT? METHOD) (CL:SETQ TRANSLATEDMETHODBODY NIL)
     (CL:PROGN
      ...
      (CL:WHEN (CL:NOT (CL:EQ *DUMMYDECLARATIONS* NIL))
       (CL:SETQ TRANSLATEDMETHODBODY
        (WRAP-METHOD-BODY-WITH-JAVA-AUXILIARY-DECLARATIONS TRANSLATEDMETHODBODY
         *DUMMYDECLARATIONS*)))))
    (CL:WHEN
     (CL:NOT
      (CL:EQ
...
(CL:DEFUN JAVA-CHANGE-CASE (SYMBOL CASECONVENTION)
  (CL:LET* ((MODULE (%HOME-CONTEXT SYMBOL)) (NAME (%SYMBOL-NAME SYMBOL)))
   ...
   (CL:COND
    ...
    ((CL:EQ CASECONVENTION KWD-JAVA-TRANSLATE-LOWERCASE)
     (CL:RETURN-FROM JAVA-CHANGE-CASE
      (MAKE-MATCHING-NAME-FULL NAME KWD-JAVA-TRANSLATE-CLEVER
       KWD-JAVA-TRANSLATE-CLEVER "- " "" "" "" "" KWD-JAVA-TRANSLATE-TITLECASEX
       "")))
    ((CL:EQ CASECONVENTION KWD-JAVA-TRANSLATE-CAPITALIZED)
     (CL:RETURN-FROM JAVA-CHANGE-CASE
      (MAKE-MATCHING-NAME-FULL NAME KWD-JAVA-TRANSLATE-CLEVER
...
(CL:DEFUN JAVA-YIELD-FLOTSAM-TYPE-NAME (FLOTSAM-CLASS-NAME)
  ...
  (CL:LET*
   ((LAST-PERIOD NULL-INTEGER) (NEXT-PERIOD (POSITION FLOTSAM-CLASS-NAME #\. 0))
  ...
  (CL:LET*
   ((TRANSLATEDNAME
     (JAVA-SUBSTITUTE-FORBIDDEN-CHARACTERS
      ...
      KWD-JAVA-TRANSLATE-CAPITALIZED)))
...
(CL:DEFUN INHERITED-CLASS-NAME-CONFLICTS? (STELLA-CLASS-NAME)
  ...
  (CL:LET*
   ((STELLA-CLASS (GET-STELLA-CLASS STELLA-CLASS-NAME FALSE)) (TEST-CLASS NULL)
    (JAVA-CLASS-NAME "") (CATCHALL-MODULE NULL))
   ...
   (CL:LET* ((MODULE NULL) (ITER-000 (%THE-CONS-LIST (%USES *MODULE*))))
    (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-000 NIL)) DO
     ...
     (CL:LET* ((*MODULE* MODULE)) (CL:DECLARE (CL:SPECIAL *MODULE*))
      (CL:SETQ TEST-CLASS (GET-STELLA-CLASS STELLA-CLASS-NAME FALSE))
      ...
      (CL:WHEN
       ...
       (CL:RETURN-FROM INHERITED-CLASS-NAME-CONFLICTS? TRUE)))))
   (CL:LET* ((MODULE NULL) (ITER-001 (%ALL-SUPER-CONTEXTS *MODULE*)))
    (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-001 NIL)) DO
     (CL:PROGN (CL:SETQ MODULE (%%VALUE ITER-001))
   ...
   (CL:LET* ((MODULE NULL) (ITER-002 (%THE-CONS-LIST (%USES *MODULE*))))
    (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-002 NIL)) DO
     (CL:PROGN (CL:SETQ MODULE (%%VALUE ITER-002))
   ...
   (CL:LET* ((MODULE NULL) (ITER-003 (%ALL-SUPER-CONTEXTS *MODULE*)))
    (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-003 NIL)) DO
     (CL:PROGN (CL:SETQ MODULE (%%VALUE ITER-003))
     ...
     (CL:WHEN
      ...
      (CL:WHEN
       ...
       (CL:RETURN-FROM INHERITED-CLASS-NAME-CONFLICTS? TRUE))
      (CL:SETQ CATCHALL-MODULE MODULE))))
   (CL:RETURN-FROM INHERITED-CLASS-NAME-CONFLICTS? FALSE)))
       ...
       (CL:COND
        ...
        (CL:T (CL:SETQ FINAL-TYPE (%CLASS-TYPE (%SURROGATE-VALUE TYPE-SPEC)))
         ...
         (CL:IF
          ...
          (CL:RETURN-FROM JAVA-TRANSLATE-TYPE-SPEC (WRAP-STRING TYPE-NAME))
          (CL:RETURN-FROM JAVA-TRANSLATE-TYPE-SPEC
           (WRAP-STRING
   ...
   (CL:CASE (LENGTH DIMENSIONS)
    ...
    (CL:OTHERWISE
     (CL:LET* ((UNUSED-DIM NULL) (ITER-000 (%THE-CONS-LIST DIMENSIONS)))
      (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-000 NIL)) DO
       (CL:PROGN (CL:SETQ UNUSED-DIM (%%VALUE ITER-000))
        (CL:SETQ ITER-000 (%%REST ITER-000)))
...
(CL:DEFUN JAVA-CREATE-RESERVED-WORD-TABLE ()
  (CL:LET* ((TABLE (NEW-STRING-HASH-TABLE)))
   (CL:LET*
    ((WORD NULL)
     (ITER-000
      (LIST* SYM-JAVA-TRANSLATE-STELLA-OBJECT SYM-JAVA-TRANSLATE-STELLA-ABSTRACT
       SYM-JAVA-TRANSLATE-STELLA-BOOLEAN SYM-JAVA-TRANSLATE-STELLA-BREAK
       SYM-JAVA-TRANSLATE-STELLA-BYTE SYM-JAVA-TRANSLATE-STELLA-CASE
       SYM-JAVA-TRANSLATE-STELLA-CATCH SYM-JAVA-TRANSLATE-STELLA-CHAR
       SYM-JAVA-TRANSLATE-STELLA-CLASS SYM-JAVA-TRANSLATE-STELLA-CONST
       SYM-JAVA-TRANSLATE-STELLA-CONTINUE SYM-JAVA-TRANSLATE-STELLA-DEFAULT
       SYM-JAVA-TRANSLATE-STELLA-DO SYM-JAVA-TRANSLATE-STELLA-DOUBLE
       SYM-JAVA-TRANSLATE-STELLA-ELSE SYM-JAVA-TRANSLATE-STELLA-EXTENDS
       SYM-JAVA-TRANSLATE-STELLA-FINAL SYM-JAVA-TRANSLATE-STELLA-FINALLY
       SYM-JAVA-TRANSLATE-STELLA-FLOAT SYM-JAVA-TRANSLATE-STELLA-FOR
       SYM-JAVA-TRANSLATE-STELLA-GOTO SYM-JAVA-TRANSLATE-STELLA-IF
       SYM-JAVA-TRANSLATE-STELLA-IMPLEMENTS SYM-JAVA-TRANSLATE-STELLA-IMPORT
       SYM-JAVA-TRANSLATE-STELLA-INSTANCEOF SYM-JAVA-TRANSLATE-STELLA-INT
       SYM-JAVA-TRANSLATE-STELLA-INTERFACE SYM-JAVA-TRANSLATE-STELLA-LONG
       SYM-JAVA-TRANSLATE-STELLA-NATIVE SYM-JAVA-TRANSLATE-STELLA-NEW
       SYM-JAVA-TRANSLATE-STELLA-PACKAGE SYM-JAVA-TRANSLATE-STELLA-PRIVATE
       SYM-JAVA-TRANSLATE-STELLA-PROTECTED SYM-JAVA-TRANSLATE-STELLA-PUBLIC
       ...
       SYM-JAVA-TRANSLATE-STELLA-SWITCH SYM-JAVA-TRANSLATE-STELLA-SYNCHRONIZED
       SYM-JAVA-TRANSLATE-STELLA-THROW SYM-JAVA-TRANSLATE-STELLA-THROWS
       SYM-JAVA-TRANSLATE-STELLA-TRANSIENT SYM-JAVA-TRANSLATE-STELLA-TRY
       SYM-JAVA-TRANSLATE-STELLA-VOID SYM-JAVA-TRANSLATE-STELLA-VOLATILE
       SYM-JAVA-TRANSLATE-STELLA-WHILE SYM-JAVA-TRANSLATE-STELLA-ASSERT NIL)))
    (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-000 NIL)) DO
          ...
          (CONS
           (LIST* SYM-JAVA-TRANSLATE-STELLA-JAVA_METHOD_CALL
            ...
            (LIST* SYM-JAVA-TRANSLATE-STELLA-JAVA_IDENT
             (JAVA-TRANSLATE-GLOBAL-NAME SPECIALVARIABLENAME FALSE) NIL)
            (CONS SYM-JAVA-TRANSLATE-STELLA-JAVA_ACTUALS NIL) NIL)
           NIL)))
        SAVEDECLARATIONS))
      (CL:SETQ SETFORMS
    ...
    (CL:RETURN-FROM JAVA-TRANSLATE-SETQ-TREE
     (LIST* SYM-JAVA-TRANSLATE-STELLA-JAVA_FUNCTION_CALL
      ...
      (LIST* SYM-JAVA-TRANSLATE-STELLA-JAVA_ACTUALS
       (LIST* SYM-JAVA-TRANSLATE-STELLA-JAVA_IDENT
        (JAVA-TRANSLATE-GLOBAL-NAME VARIABLENAME FALSE) NIL)
...
(CL:DEFUN JAVA-TRANSLATE-SYS-SET-DEFAULT (TREE)
  (CL:LET*
   ...
   (CL:RETURN-FROM JAVA-TRANSLATE-SYS-SET-DEFAULT
    (LIST* SYM-JAVA-TRANSLATE-STELLA-JAVA_METHOD_CALL
     (LIST* SYM-JAVA-TRANSLATE-STELLA-JAVA_IDENT (WRAP-STRING "") NIL)
     (LIST* SYM-JAVA-TRANSLATE-STELLA-JAVA_IDENT (WRAP-STRING "setDefaultValue")
      NIL)
     (LIST* SYM-JAVA-TRANSLATE-STELLA-JAVA_IDENT
      (JAVA-TRANSLATE-GLOBAL-NAME VARIABLENAME FALSE) NIL)
     (LIST* SYM-JAVA-TRANSLATE-STELLA-JAVA_ACTUALS
...
(CL:DEFVAR *JAVA-LOOP-NAME-USED?* FALSE)

;;; (DEFUN (JAVA-TRANSLATE-LOOP CONS) ...)

(CL:DEFUN JAVA-TRANSLATE-LOOP (TREE)
  (CL:LET*
   ((*JAVA-LOOP-NAME* (LOCAL-GENSYM "LOOP")) (*JAVA-LOOP-NAME-USED?* FALSE))
...
;;; (DEFUN (JAVA-TRANSLATE-ARGUMENT-LIST-ITERATOR CONS) ...)

(CL:DEFUN JAVA-TRANSLATE-ARGUMENT-LIST-ITERATOR (ITERATORBINDINGS CURSORBINDINGS BODY)
  (CL:LET*
   ((CURSORVAR (%%VALUE (%%VALUE CURSORBINDINGS)))
    (CURSORTYPE (%%VALUE (%%REST (%%VALUE CURSORBINDINGS))))
    (DUMMYARG (FOURTH (%%VALUE (%%REST (%%REST (%%VALUE ITERATORBINDINGS))))))
    (ITERATORCONSTRUCTOR NULL)
    (DECLARATIONS
     (LIST*
      (CONS (WRAP-STRING "Enumeration")
       (CONS (JAVA-TRANSLATE-A-TREE SYM-JAVA-TRANSLATE-STELLA-ARG_ENUM) NIL))
      (CONS (JAVA-TRANSLATE-TYPE-SPEC CURSORTYPE)
       (CONS (JAVA-TRANSLATE-A-TREE CURSORVAR) NIL))
      NIL)))
   (CL:LET*
    ((BINDING NULL) (ITER-000 (%%REST ITERATORBINDINGS)) (COLLECT-000 NULL))
    (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-000 NIL)) DO
     ...
     (CL:IF (CL:EQ COLLECT-000 NULL)
      (CL:PROGN
       (CL:SETQ COLLECT-000
        (CONS
         (CONS (JAVA-TRANSLATE-TYPE-SPEC (%%VALUE (%%REST BINDING)))
          (CONS (JAVA-TRANSLATE-A-TREE (%%VALUE BINDING))
      ...
      (CL:PROGN
       (CL:SETF (%%REST COLLECT-000)
        (CONS
         ...
         NIL))
       (CL:SETQ COLLECT-000 (%%REST COLLECT-000))))))
   (CL:RETURN-FROM JAVA-TRANSLATE-ARGUMENT-LIST-ITERATOR
    (LIST* SYM-JAVA-TRANSLATE-STELLA-JAVA_BLOCK DECLARATIONS
     (CONS
      (LIST* SYM-JAVA-TRANSLATE-STELLA-JAVA_STATEMENTS
       (LIST* SYM-JAVA-TRANSLATE-STELLA-JAVA_ASSIGN
        (LIST* SYM-JAVA-TRANSLATE-STELLA-JAVA_IDENT
         (JAVA-TRANSLATE-NAME SYM-JAVA-TRANSLATE-STELLA-ARG_ENUM) NIL)
        (LIST* SYM-JAVA-TRANSLATE-STELLA-JAVA_METHOD_CALL
         (LIST* SYM-JAVA-TRANSLATE-STELLA-JAVA_IDENT (WRAP-STRING "") NIL)
         (LIST* SYM-JAVA-TRANSLATE-STELLA-JAVA_IDENT
          (JAVA-TRANSLATE-NAME SYM-JAVA-TRANSLATE-STELLA-ELEMENTS) NIL)
         (JAVA-TRANSLATE-A-TREE DUMMYARG)
         (CONS (CONS SYM-JAVA-TRANSLATE-STELLA-JAVA_ACTUALS NIL) NIL))
        NIL)
       (LIST* SYM-JAVA-TRANSLATE-STELLA-JAVA_WHILE
        (LIST* SYM-JAVA-TRANSLATE-STELLA-JAVA_METHOD_CALL
         (LIST* SYM-JAVA-TRANSLATE-STELLA-JAVA_IDENT (WRAP-STRING "") NIL)
         (LIST* SYM-JAVA-TRANSLATE-STELLA-JAVA_IDENT
          (WRAP-STRING "hasMoreElements") NIL)
         (LIST* SYM-JAVA-TRANSLATE-STELLA-JAVA_IDENT
          (JAVA-TRANSLATE-NAME SYM-JAVA-TRANSLATE-STELLA-ARG_ENUM) NIL)
         (CONS SYM-JAVA-TRANSLATE-STELLA-JAVA_ACTUALS NIL) NIL)
        (LIST* SYM-JAVA-TRANSLATE-STELLA-JAVA_PROGN
         (LIST* SYM-JAVA-TRANSLATE-STELLA-JAVA_STATEMENTS
          (LIST* SYM-JAVA-TRANSLATE-STELLA-JAVA_ASSIGN
           (JAVA-TRANSLATE-A-TREE CURSORVAR)
           (CONS
            (LIST* SYM-JAVA-TRANSLATE-STELLA-JAVA_CAST
             (LIST* SYM-JAVA-TRANSLATE-STELLA-JAVA_METHOD_CALL
              (LIST* SYM-JAVA-TRANSLATE-STELLA-JAVA_IDENT (WRAP-STRING "") NIL)
              (LIST* SYM-JAVA-TRANSLATE-STELLA-JAVA_IDENT
               (WRAP-STRING "nextElement") NIL)
              (LIST* SYM-JAVA-TRANSLATE-STELLA-JAVA_IDENT
               (JAVA-TRANSLATE-NAME SYM-JAVA-TRANSLATE-STELLA-ARG_ENUM) NIL)
              (CONS SYM-JAVA-TRANSLATE-STELLA-JAVA_ACTUALS NIL) NIL)
             (JAVA-TRANSLATE-TYPE-SPEC SGT-JAVA-TRANSLATE-STELLA-OBJECT) NIL)
            NIL))
  ...
  (CL:LET*
   ...
   (CL:LET*
    ((ITERATORBINDINGS (%%VALUE (%%REST TREE)))
     ...
     (CONTINUATIONTEST (JAVA-TRANSLATE-A-TREE (FOURTH TREE)))
     (BODY (JAVA-TRANSLATE-LIST-OF-TREES (NTH-REST TREE 4))) (DECLARATIONS NIL)
     (NEXTASSIGNMENTS NIL) (ITERATORCONSTRUCTOR NULL))
    (NTH-REST-SETTER TREE NIL 4)
    (CL:WHEN
     (CL:EQ (%%VALUE (%%REST (%%VALUE ITERATORBINDINGS)))
      SGT-JAVA-TRANSLATE-STELLA-LISP-CONS-ITERATOR)
     (CL:RETURN-FROM JAVA-TRANSLATE-FOREACH-TREE
      (JAVA-TRANSLATE-ARGUMENT-LIST-ITERATOR ITERATORBINDINGS CURSORBINDINGS
       BODY)))
    ...
    (CL:LET* ((BINDING NULL) (ITER-001 CURSORBINDINGS))
     (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-001 NIL)) DO
      ...
      (CL:SETQ NEXTASSIGNMENTS
       (CONS (JAVA-TRANSLATE-A-TREE (%%VALUE (%%REST (%%REST BINDING))))
        NEXTASSIGNMENTS))
      (THIRD-SETTER BINDING NULL)
      (CL:WHEN
       ...
       (CONS
        (LIST* SYM-JAVA-TRANSLATE-STELLA-JAVA_STATEMENTS
         (LIST* SYM-JAVA-TRANSLATE-STELLA-JAVA_NAMED_STATEMENT
          (JAVA-TRANSLATE-A-TREE *JAVA-LOOP-NAME*)
          (CONS
           (LIST* SYM-JAVA-TRANSLATE-STELLA-JAVA_FOREACH CONTINUATIONTEST
...
(CL:DEFUN JAVA-TRANSLATE-RETURN-TREE (TREE)
  (CL:LET*
   ...
   (CL:LET*
    ((PARAMETERTYPE NULL) (PARAMETERINDEX NULL-INTEGER) (EXP NULL)
     (ITER-000 (%%REST (%%REST TREE))) (ITER-001 0)
     (ITER-002 METHODOTHERRETURNTYPES))
    (CL:DECLARE (CL:TYPE CL:FIXNUM ITER-001 PARAMETERINDEX))
    (CL:LOOP WHILE
     (CL:AND (CL:NOT (CL:EQ ITER-000 NIL)) (CL:NOT (CL:EQ ITER-002 NIL))) DO
     (CL:PROGN (CL:SETQ EXP (%%VALUE ITER-000))
      (CL:SETQ ITER-000 (%%REST ITER-000)))
     (CL:PROGN (CL:SETQ PARAMETERINDEX ITER-001)
      (CL:SETQ ITER-001 (CL:1+ ITER-001)))
     (CL:PROGN (CL:SETQ PARAMETERTYPE (%%VALUE ITER-002))
      (CL:SETQ ITER-002 (%%REST ITER-002)))
     (CL:IF
      ...
      (LIST* SYM-JAVA-TRANSLATE-STELLA-JAVA_BLOCK
       (CONS
        (CONS
         ...
         (LIST*
          (LIST* SYM-JAVA-TRANSLATE-STELLA-JAVA_IDENT (WRAP-STRING TEMPVARNAME)
           NIL)
...
(CL:DEFUN JAVA-TRANSLATE-BREAK (TREE)
  ...
  (CL:SETQ *JAVA-LOOP-NAME-USED?* TRUE)
...
(CL:DEFUN JAVA-TRANSLATE-IF-TREE (TREE)
  (CL:LET*
   ...
   (CL:IF
    ...
    (CL:SETQ TRUEBODY
     (LIST* SYM-JAVA-TRANSLATE-STELLA-JAVA_PROGN
      (CONS SYM-JAVA-TRANSLATE-STELLA-JAVA_STATEMENTS (CONCATENATE TRUEBODY NIL))
      NIL))
    (CL:SETQ TRUEBODY
     (LIST* SYM-JAVA-TRANSLATE-STELLA-JAVA_PROGN
...
(CL:DEFUN JAVA-SYMBOL-CASE? (KEYFORM)
  (CL:COND
   ...
   (CL:T (CL:RETURN-FROM JAVA-SYMBOL-CASE? FALSE))))
...
(CL:DEFUN JAVA-YIELD-SYMBOL-ID-FORM (SYMBOLID)
  ...
  (CL:LET* ((SYMBOL (GET-SYM SYMBOLID)))
   (CL:RETURN-FROM JAVA-YIELD-SYMBOL-ID-FORM
    (LIST* SYM-JAVA-TRANSLATE-STELLA-JAVA_IDENT (JAVA-TRANSLATE-SYMBOL-ID SYMBOL)
     NIL))))
        ...
        (CL:IF (CL:EQ (%%VALUE CONDITION) SYM-JAVA-TRANSLATE-STELLA-OTHERWISE)
         (CL:SETQ OTHERWISECONDITION
          (CONS SYM-JAVA-TRANSLATE-STELLA-JAVA_STATEMENTS
           (CONCATENATE (JAVA-TRANSLATE-LIST-OF-TREES (%%REST CONDITION)) NIL)))
         (CL:SETQ CONDITIONS
          (CONS (JAVA-TRANSLATE-CONDITION CONDITION SYMBOLCASEP) CONDITIONS)))))
      (CL:T
       (CL:LET* ((STREAM-000 (NEW-OUTPUT-STRING-STREAM)))
...
(CL:DEFUN JAVA-TRANSLATE-MAKE-TREE (TREE)
  (CL:LET*
   ((CLASS (GET-STELLA-CLASS (%%VALUE (%%REST TREE)) TRUE))
    (CLASSNAME
     (CL:IF
      (CL:NOT
       (CL:EQ
  ...
  (CL:LET* ((TYPESPEC (%%VALUE (%%REST TREE))))
   (CL:IF (ARRAY-TYPE-SPECIFIER? TYPESPEC)
    ...
    (CL:RETURN-FROM JAVA-TRANSLATE-SYS-NEW
     (LIST* SYM-JAVA-TRANSLATE-STELLA-JAVA_FUNCTION_CALL
      (LIST* SYM-JAVA-TRANSLATE-STELLA-JAVA_IDENT
       (JAVA-TRANSLATE-TYPE-SPEC TYPESPEC) NIL)
      (LIST* SYM-JAVA-TRANSLATE-STELLA-JAVA_IDENT
       (JAVA-TRANSLATE-NAME
...
(CL:DEFUN JAVA-TRANSLATE-MV-SETQ (TREE)
  (CL:LET*
   ...
   (CL:LET*
    ((RETURNTYPE NULL) (CURRENTINDEX NULL-INTEGER) (VARIABLE NULL)
     (ITER-000 (%%REST VARIABLES)) (ITER-001 0) (ITER-002 OTHERRETURNTYPES))
    (CL:DECLARE (CL:TYPE CL:FIXNUM ITER-001 CURRENTINDEX))
    (CL:LOOP WHILE
     (CL:AND (CL:NOT (CL:EQ ITER-000 NIL)) (CL:NOT (CL:EQ ITER-002 NIL))) DO
     (CL:PROGN (CL:SETQ VARIABLE (%%VALUE ITER-000))
      (CL:SETQ ITER-000 (%%REST ITER-000)))
     (CL:PROGN (CL:SETQ CURRENTINDEX ITER-001)
      (CL:SETQ ITER-001 (CL:1+ ITER-001)))
     (CL:PROGN (CL:SETQ RETURNTYPE (%%VALUE ITER-002))
      (CL:SETQ ITER-002 (%%REST ITER-002)))
     ...
     (CONS
      (CONS
       (JAVA-TRANSLATE-ARRAY-OF-TYPE-SPEC
        SGT-JAVA-TRANSLATE-STELLA-NATIVE-OBJECT-POINTER FALSE)
       (LIST*
        (LIST* SYM-JAVA-TRANSLATE-STELLA-JAVA_IDENT
         (WRAP-STRING "caller_MV_returnarray") NIL)
        (LIST* SYM-JAVA-TRANSLATE-STELLA-JAVA_MAKE_ARRAY
   ...
   (CL:LET*
    ...
    (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-001 NIL)) DO
     ...
     (CL:IF (CL:EQ COLLECT-001 NULL)
      (CL:PROGN
       (CL:SETQ COLLECT-001 (CONS (JAVA-TRANSLATE-TYPE-SPEC PARAMETERTYPE) NIL))
  ...
  (CL:IF (JAVA-LITERAL? TYPE)
   (CL:RETURN-FROM JAVA-TRANSLATE-WITH-NATIVE-WRAPPER
    (LIST* SYM-JAVA-TRANSLATE-STELLA-JAVA_MAKE
     ...
     (LIST* SYM-JAVA-TRANSLATE-STELLA-JAVA_ACTUALS (JAVA-TRANSLATE-A-TREE TREE)
      NIL)
     NIL))
   (CL:RETURN-FROM JAVA-TRANSLATE-WITH-NATIVE-WRAPPER
...
(CL:DEFUN JAVA-TRANSLATE-CALL-FUNCTION-CODE (TREE)
  (CL:LET*
   ((SIGNATURE (JAVA-TRANSLATE-CODE-SIGNATURE (%%VALUE (%%REST TREE))))
    ...
    (PRIMARYRETURNTYPE (%%VALUE (%%VALUE (%%VALUE (%%REST TREE))))) (OTREE NULL))
   (CL:SETQ OTREE
   ...
   (CL:LET* ((MOD NULL) (ITER-000 (PARENT-CONTEXTS MODULE)))
    (CL:LOOP WHILE (NEXT? ITER-000) DO (CL:SETQ MOD (%VALUE ITER-000))
     (CL:WHEN
      ...
      (CL:SETQ RESULT (CONCATENATE (JAVA-PACKAGE-PREFIX MOD SEPARATOR) RESULT))
      (CL:RETURN))))
...
(CL:DEFUN JAVA-TRANSLATE-CLASS-OBJECT-LOOKUP (CLASSNAME)
  ...
  (CL:RETURN-FROM JAVA-TRANSLATE-CLASS-OBJECT-LOOKUP
   (LIST* SYM-JAVA-TRANSLATE-STELLA-JAVA_FUNCTION_CALL
    (LIST* SYM-JAVA-TRANSLATE-STELLA-JAVA_IDENT
     (WRAP-STRING (JAVA-YIELD-NATIVE-CLASS-NAME)) NIL)
    (LIST* SYM-JAVA-TRANSLATE-STELLA-JAVA_IDENT (WRAP-STRING "find_java_class")
     NIL)
  ...
  (CL:LET*
   ...
   (CL:LET* ((TEST-VALUE-000 (SAFE-PRIMARY-TYPE TYPESPEC)))
    (CL:COND
     ...
     ((SUBTYPE-OF-SURROGATE? TEST-VALUE-000)
      (CL:PROGN (CL:SETQ CLASSTYPE (%CLASS-TYPE (%SURROGATE-VALUE TYPESPEC)))))
     (CL:T
      (CL:LET* ((STREAM-000 (NEW-OUTPUT-STRING-STREAM)))
       (%%PRINT-STREAM (%NATIVE-STREAM STREAM-000) "`" TEST-VALUE-000
        "' is not a valid case option")
...
(CL:DEFUN YIELD-CLASS-OBJECT-LOOKUP-NAME-FOR-NATIVE-TYPE (NATIVETYPE)
  ...
  (CL:LET*
   ((BASETYPE NATIVETYPE) (PACKAGE "java.lang.") (ARRAYDIMENSIONS 0) (INDEX -1)
    (ARRAYMARKERINDEX NULL-INTEGER))
   (CL:DECLARE (CL:TYPE CL:SIMPLE-STRING BASETYPE PACKAGE)
    (CL:TYPE CL:FIXNUM ARRAYDIMENSIONS INDEX ARRAYMARKERINDEX))
   (CL:LET*
    ((I NULL-INTEGER) (CH NULL-CHARACTER) (VECTOR-000 NATIVETYPE) (INDEX-000 0)
    ...
    (CL:LOOP WHILE (CL:< INDEX-000 LENGTH-000) DO
     ...
     (CL:PROGN (CL:SETQ I ITER-000) (CL:SETQ ITER-000 (CL:1+ ITER-000)))
     (CL:WHEN (CL:EQL CH #\.) (CL:SETQ INDEX I))
     (CL:WHEN (CL:EQL CH #\[)
   ...
   (CL:CASE ARRAYDIMENSIONS
    (0 (CL:RETURN-FROM YIELD-CLASS-OBJECT-LOOKUP-NAME-FOR-NATIVE-TYPE BASETYPE))
    (1
...
(CL:DEFUN JAVA-TRANSLATE-PARAM-TYPE-SPECIFICATIONS (FN OWNER)
  (CL:LET*
   ...
   (CL:LET*
    ((TS NULL) (ITER-000 (%THE-CONS-LIST (METHOD-PARAMETER-TYPE-SPECIFIERS FN))))
    (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-000 NIL)) DO
     (CL:PROGN (CL:SETQ TS (%%VALUE ITER-000))
      (CL:SETQ ITER-000 (%%REST ITER-000)))
     (CL:COND (SKIPPARAMETER? (CL:SETQ SKIPPARAMETER? FALSE))
   ...
   (CL:RETURN-FROM JAVA-TRANSLATE-PARAM-TYPE-SPECIFICATIONS
    (LIST* SYM-JAVA-TRANSLATE-STELLA-JAVA_ANONYMOUS_ARRAY
     (WRAP-STRING "java.lang.Class") (CONCATENATE (REVERSE PARAMCLASSES) NIL)))))
       ...
       (LIST* SYM-JAVA-TRANSLATE-STELLA-JAVA_FUNCTION_CALL
        ...
        (LIST* SYM-JAVA-TRANSLATE-STELLA-JAVA_ACTUALS (WRAP-STRING CLASSNAME)
         (CONS (WRAP-STRING FUNCTIONNAME)
          (CONS (JAVA-TRANSLATE-PARAM-TYPE-SPECIFICATIONS FN NULL) NIL)))
        NIL)))
...
(CL:DEFUN JAVA-TRANSLATE-FUNCTION-NAME (FUNCTION)
  (CL:LET*
   ((FUNCTIONNAME
     (YIELD-RENAMED-NAME-IF-NATIVE (%SLOT-NAME FUNCTION) KWD-JAVA-TRANSLATE-JAVA
   ...
   (CL:WHEN (JAVA-METHOD-OBJECT-IS-OVERLOADED-FUNCTION? FUNCTION)
    (CL:SETQ FUNCTIONNAME
     (JAVA-CREATE-OVERLOADED-FUNCTION-NAME FUNCTIONNAME (%SLOT-OWNER FUNCTION))))
     ...
     (CL:RETURN-FROM JAVA-STREAM-IS-STANDARD-OUTPUT?
      (EQUAL-CONS-TREES? TREE
       (GET-QUOTED-TREE
        ...
        "/STELLA")))))
   (CL:T (CL:RETURN-FROM JAVA-STREAM-IS-STANDARD-OUTPUT? FALSE))))
...
(CL:DEFUN JAVA-TRANSLATE-EOL ()
  (CL:RETURN-FROM JAVA-TRANSLATE-EOL
   (LIST* SYM-JAVA-TRANSLATE-STELLA-JAVA_EOL
    (JAVA-TRANSLATE-GLOBAL-NAME SYM-JAVA-TRANSLATE-STELLA-EOL FALSE) NIL)))
     ...
     (CL:RETURN-FROM JAVA-TRANSLATE-GENERAL-SYMBOL
      (JAVA-TRANSLATE-OBJECT-TO-RETURN-TYPE
       (LIST* SYM-JAVA-TRANSLATE-STELLA-JAVA_METHOD_CALL
        ...
        (LIST* SYM-JAVA-TRANSLATE-STELLA-JAVA_IDENT (WRAP-STRING "get") NIL)
        (LIST* SYM-JAVA-TRANSLATE-STELLA-JAVA_IDENT
         (JAVA-TRANSLATE-GLOBAL-NAME TREE FALSE) NIL)
        (CONS SYM-JAVA-TRANSLATE-STELLA-JAVA_ACTUALS NIL) NIL)
...
(CL:DEFUN ZERO-ARGUMENT-FUNCTION? (METHOD)
  (CL:RETURN-FROM ZERO-ARGUMENT-FUNCTION?
   (CL:AND (%METHOD-FUNCTION? METHOD) (EMPTY? (METHOD-PARAMETER-NAMES METHOD)))))
...
(CL:DEFUN JAVA-FUNCTION-IN-DIFFERENT-MODULE? (METHOD)
  (CL:LET*
   ...
   (CL:IF
    ...
    (CL:RETURN-FROM JAVA-FUNCTION-IN-DIFFERENT-MODULE? FALSE)
    (CL:PROGN
     ...
     (CL:RETURN-FROM JAVA-FUNCTION-IN-DIFFERENT-MODULE? TRUE)))))
    ...
    ((CL:NOT (CL:EQ OPERATOR NULL))
     (CL:SETQ OTREE
      (JAVA-TRANSLATE-OPERATOR-CALL OPERATOR FUNCTIONARGS
       (LENGTH FUNCTIONARGS))))
    ((CL:EQ FUNCTION NULL)
     (CL:WARN "Can't translate function call: Undefined function or method `~A'"
      FUNCTIONNAME)
     (CL:SETQ OTREE NIL))
    (CL:T
  ...
  (CL:LET* ((OPERATOR (CL:IF NULL? "==" "!=")))
   ...
   (CL:COND
    ...
    ((SUBTYPE-OF? CLASSTYPE SGT-JAVA-TRANSLATE-STELLA-SINGLE-FLOAT)
     (CL:RETURN-FROM JAVA-TRANSLATE-DEFINED-OR-NULL
      (JAVA-TRANSLATE-OPERATOR-CALL (CONS (WRAP-STRING OPERATOR) NIL)
       (CONS OBJECT (CONS SYM-JAVA-TRANSLATE-STELLA-NULL-SINGLE-FLOAT NIL)) 2)))
...
(CL:DEFUN JAVA-TRANSLATE-METHOD-CALL (TREE)
  (CL:LET*
   ((METHODNAME (%%VALUE (%%REST (%%REST TREE))))
    (CLASSTYPE (%%VALUE (%%REST TREE))) (ALLARGS (%%REST (%%REST (%%REST TREE))))
    (OBJECT (FOURTH TREE)))
   (CL:COND
    ((CL:EQ METHODNAME SYM-JAVA-TRANSLATE-STELLA-DEFINED?)
     (CL:RETURN-FROM JAVA-TRANSLATE-METHOD-CALL
      (JAVA-TRANSLATE-DEFINED-OR-NULL CLASSTYPE OBJECT FALSE)))
    ((CL:EQ METHODNAME SYM-JAVA-TRANSLATE-STELLA-NULL?)
     (CL:RETURN-FROM JAVA-TRANSLATE-METHOD-CALL
      (JAVA-TRANSLATE-DEFINED-OR-NULL CLASSTYPE OBJECT TRUE)))
     ...
     (LIST* SYM-JAVA-TRANSLATE-STELLA-JAVA_METHOD_CALL
      ...
      (LIST* SYM-JAVA-TRANSLATE-STELLA-JAVA_IDENT
       (CL:IF (CL:NOT (CL:EQ METHODSLOT NULL))
        (JAVA-TRANSLATE-METHOD-NAME METHODSLOT) (JAVA-TRANSLATE-NAME METHODNAME))
       NIL)
      (JAVA-TRANSLATE-A-TREE OBJECT)
      (CONS
       (CL:IF
        (CL:AND (CL:NOT (CL:EQ METHODSLOT NULL))
         (CL:NOT (CL:EQ (REST (METHOD-RETURN-TYPE-SPECIFIERS METHODSLOT)) NIL))
...
(CL:DEFUN JAVA-TRANSLATE-OPERATOR-TREE (TREE)
  (CL:LET*
   ((OPERATOR (JAVA-LOOKUP-OPERATOR-TABLE (%%VALUE TREE))) (ARGS (%%REST TREE))
    (ARITY NULL-INTEGER))
      ...
      (CL:SETQ OTREE
       (LIST* SYM-JAVA-TRANSLATE-STELLA-JAVA_BINARY_OP
        ...
        (CONS (%%VALUE OPERATORNAMES)
         (CONS (JAVA-TRANSLATE-OPERATOR-CALL OPERATORNAMES (%%REST ARGUMENTS) 2)
          NIL))))
      (CL:SETQ OTREE
       (LIST* SYM-JAVA-TRANSLATE-STELLA-JAVA_BINARY_OP
        (JAVA-TRANSLATE-A-TREE (%%VALUE ARGUMENTS))
...
(CL:DEFUN HELP-STARTUP-JAVA-TRANSLATE2 ()
  (CL:PROGN
   ...
   (CL:SETQ KWD-JAVA-TRANSLATE-UNESCAPED
...
(CL:DEFUN HELP-STARTUP-JAVA-TRANSLATE3 ()
  (CL:PROGN
   ...
   (CL:SETQ SYM-JAVA-TRANSLATE-STELLA-ARG_ENUM
    (INTERN-RIGID-SYMBOL-WRT-MODULE "ARG_ENUM" NULL 0))
   ...
   (CL:SETQ SYM-JAVA-TRANSLATE-STELLA-ELEMENTS
    (INTERN-RIGID-SYMBOL-WRT-MODULE "ELEMENTS" NULL 0))
   (CL:SETQ SGT-JAVA-TRANSLATE-STELLA-OBJECT
    (INTERN-RIGID-SYMBOL-WRT-MODULE "OBJECT" NULL 1))
   (CL:SETQ SGT-JAVA-TRANSLATE-STELLA-LISP-CONS-ITERATOR
...
(CL:DEFUN HELP-STARTUP-JAVA-TRANSLATE6 ()
  (CL:PROGN (CL:SETQ *VARARGSTATEMENTS* NIL) (CL:SETQ *VARARGDECLS* NIL)
   ...
   (CL:SETQ *JAVA-LOOP-NAME-USED?* FALSE)
   (CL:SETQ *JAVA-PRIMITIVE-ARRAY-TYPE-NAMES*
    (DICTIONARY SGT-JAVA-TRANSLATE-STELLA-KEY-VALUE-LIST (WRAP-STRING "byte")
     ...
     (WRAP-STRING "F") (WRAP-STRING "int") (WRAP-STRING "I") (WRAP-STRING "long")
     (WRAP-STRING "J") (WRAP-STRING "short") (WRAP-STRING "S")
     (WRAP-STRING "boolean") (WRAP-STRING "Z"))))
  :VOID)
...
(CL:DEFUN HELP-STARTUP-JAVA-TRANSLATE7 ()
  (CL:PROGN
   ...
   (DEFINE-FUNCTION-OBJECT "JAVA-TRANSLATE-ARGUMENT-LIST-ITERATOR"
    "(DEFUN (JAVA-TRANSLATE-ARGUMENT-LIST-ITERATOR CONS) ((ITERATORBINDINGS (CONS OF CONS)) (CURSORBINDINGS (CONS OF CONS)) (BODY CONS)))"
    (CL:FUNCTION JAVA-TRANSLATE-ARGUMENT-LIST-ITERATOR) NULL))
  :VOID)
...
(CL:DEFUN HELP-STARTUP-JAVA-TRANSLATE8 ()
  (CL:PROGN
   ...
   (DEFINE-FUNCTION-OBJECT "JAVA-TRANSLATE-EOL"
    "(DEFUN (JAVA-TRANSLATE-EOL CONS) ())" (CL:FUNCTION JAVA-TRANSLATE-EOL) NULL)
   ...
   (CL:WHEN (CURRENT-STARTUP-TIME-PHASE? 7) (HELP-STARTUP-JAVA-TRANSLATE7)
    ...
    (CL:LET*
     ...
     (SET-DYNAMIC-SLOT-VALUE (%DYNAMIC-SLOTS FUNCTION)
      SYM-JAVA-TRANSLATE-STELLA-METHOD-STARTUP-CLASSNAME
      (WRAP-STRING "_Startup-Java-Translate") NULL-STRING-WRAPPER)))
