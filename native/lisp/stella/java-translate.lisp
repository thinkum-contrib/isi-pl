...
(CL:DEFVAR SYM-JAVA-TRANSLATE-STELLA-JAVA_SPECIAL NULL)
...
(CL:DEFVAR SYM-JAVA-TRANSLATE-STELLA-SYS-REFERENCED-SLOT-VALUE NULL)
...
(CL:DEFVAR SYM-JAVA-TRANSLATE-STELLA-SYS-POINTER-TO-FUNCTION NULL)
...
(CL:DECLAIM
  ...
  *SYMBOL-REGISTRY* EOL *MODULE* NULL-CHARACTER *CHARACTER-DOWNCASE-TABLE*
  *CHARACTER-UPCASE-TABLE* *METHODBEINGWALKED* *DUMMYDECLARATIONS*
  *CONTEXT* NULL-STRING-WRAPPER))
...
(CL:DEFUN JAVA-YIELD-FLOTSAM-CLASS-NAME (MOD)
  (CL:LET*
   ...
   (CL:IF
    ...
    (CL:RETURN-FROM JAVA-YIELD-FLOTSAM-CLASS-NAME "Flotsam"))))
...
(CL:DEFUN JAVA-YIELD-FULL-NATIVE-CLASS-NAME ()
  (CL:RETURN-FROM JAVA-YIELD-FULL-NATIVE-CLASS-NAME
   (STRING-CONCATENATE (JAVA-STELLA-PACKAGE) ".javalib.Native")))
  ...
  (CL:LET* ((GLOBAL (%THE-OBJECT UNIT)))
   (CL:LET*
    ...
    (CL:LET*
     ((TYPELIST
       (CONS
        (CL:IF (%VARIABLE-SPECIAL? GLOBAL)
         (WRAP-STRING "InheritableThreadLocal")
     ...
     (CL:WHEN
      (CL:OR (%VARIABLE-CONSTANT? GLOBAL) (%VARIABLE-SPECIAL? GLOBAL))
     ...
     (CL:IF
      ...
      (CL:RETURN-FROM JAVA-TRANSLATE-DEFINE-GLOBAL-VARIABLE-UNIT
       (LIST* SYM-JAVA-TRANSLATE-STELLA-JAVA_SPECIAL
  ...
  (CL:LET*
   ...
   (CL:LET*
    ((METHOD (%THE-OBJECT UNIT))
     ...
     (BODYTREE (%CODE-REGISTER UNIT)) (RETURNTYPE NULL) (MODIFIERS NIL)
      ...
      (CONS MODIFIERS
       (CONS RETURNTYPE
        (CONS (JAVA-TRANSLATE-METHOD-NAME METHOD)
         (CONS (JAVA-TRANSLATE-METHOD-PARAMETERS METHOD)
...
(CL:DEFUN JAVA-TRANSLATE-DEFPRINT-UNIT (UNIT)
  (CL:LET*
   ...
   (CL:DECLARE (CL:TYPE CL:FIXNUM *CURRENTDUMMYINDEX*))
   (CL:LET*
    ((CLASS (%THE-OBJECT UNIT)) (BODYTREE (%CODE-REGISTER UNIT))
     (OTREE NIL) (TRANSLATEDMETHODBODY NULL))
    (CL:LET*
    ...
    (CL:PROGN
     ...
     (CL:LET* ((TEST-VALUE-000 (%%VALUE TREE)))
      (CL:COND
       ...
       ((CL:EQ TEST-VALUE-000 SYM-JAVA-TRANSLATE-STELLA-CATCH)
        (CL:RETURN-FROM JAVA-TRANSLATE-A-TREE
         (JAVA-TRANSLATE-CATCH TREE)))
       ((CL:EQ TEST-VALUE-000 SYM-JAVA-TRANSLATE-STELLA-THROW)
        (CL:RETURN-FROM JAVA-TRANSLATE-A-TREE
         (JAVA-TRANSLATE-THROW TREE)))
       ...
       ((CL:EQ TEST-VALUE-000
         SYM-JAVA-TRANSLATE-STELLA-SYS-REFERENCED-SLOT-VALUE)
        (CL:RETURN-FROM JAVA-TRANSLATE-A-TREE
         (JAVA-TRANSLATE-SYS-REFERENCED-SLOT-VALUE TREE)))
       ((CL:EQ TEST-VALUE-000
       ...
       ((CL:EQ TEST-VALUE-000
        ...
        (CL:RETURN-FROM JAVA-TRANSLATE-A-TREE
         (JAVA-TRANSLATE-STARTUP-TIME-PROGN TREE)))
       ...
       ((CL:EQ TEST-VALUE-000
         SYM-JAVA-TRANSLATE-STELLA-SYS-POINTER-TO-FUNCTION)
        (CL:RETURN-FROM JAVA-TRANSLATE-A-TREE
         (JAVA-TRANSLATE-SYS-POINTER-TO-FUNCTION TREE)))
...
(CL:DEFVAR *VARARGSTATEMENTS* NIL
  "A list of new vectors generated for variable-length argument 
             lists")

;;; (DEFSPECIAL *VARARGDECLS* ...)

(CL:DEFVAR *VARARGDECLS* NIL
  "A list of vector-pushes generated for variable-length argument 
             lists")

;;; (DEFSPECIAL *CURRENTVARARGINDEX* ...)

(CL:PROGN (CL:DEFVAR *CURRENTVARARGINDEX* 1 "The current index of the variable length arguments") (CL:DECLAIM (CL:TYPE CL:FIXNUM *CURRENTVARARGINDEX*)))
...
(CL:PROGN (CL:DEFVAR *JAVA-CHARACTER-SUBSTITUTION-TABLE* STELLA::NULL-STRING) (CL:DECLAIM (CL:TYPE CL:SIMPLE-STRING *JAVA-CHARACTER-SUBSTITUTION-TABLE*)))
...
(CL:DEFUN JAVA-CHANGE-CASE (SYMBOL CASECONVENTION)
  (CL:LET* ((MODULE (%HOME-CONTEXT SYMBOL)) (NAME (%SYMBOL-NAME SYMBOL)))
   ...
   (CL:WHEN (%CASE-SENSITIVE? MODULE)
    (CL:RETURN-FROM JAVA-CHANGE-CASE (COPY NAME)))
   (CL:COND
    ((CL:EQ CASECONVENTION KWD-JAVA-TRANSLATE-UPPERCASE)
     (CL:RETURN-FROM JAVA-CHANGE-CASE (STRING-UPCASE NAME)))
    ((CL:EQ CASECONVENTION KWD-JAVA-TRANSLATE-LOWERCASE)
     (CL:RETURN-FROM JAVA-CHANGE-CASE (STRING-DOWNCASE NAME)))
    ((CL:EQ CASECONVENTION KWD-JAVA-TRANSLATE-CAPITALIZED)
     (CL:RETURN-FROM JAVA-CHANGE-CASE (STRING-CAPITALIZE NAME)))
    (CL:T
     (CL:LET* ((STREAM-000 (NEW-OUTPUT-STRING-STREAM)))
      (%%PRINT-STREAM (%NATIVE-STREAM STREAM-000) "`" CASECONVENTION
       "' is not a valid case option")
   ...
   (CL:COND
    ((CL:EQ TEST-VALUE-000 SGT-JAVA-TRANSLATE-STELLA-BOOLEAN)
     (CL:RETURN-FROM JAVA-SPECIAL-SETTER-NAME
      (WRAP-STRING "set_boolean_special")))
    ((CL:OR (CL:EQ TEST-VALUE-000 SGT-JAVA-TRANSLATE-STELLA-INTEGER)
      (CL:EQ TEST-VALUE-000 SGT-JAVA-TRANSLATE-STELLA-SHORT-INTEGER)
      (CL:EQ TEST-VALUE-000
       SGT-JAVA-TRANSLATE-STELLA-UNSIGNED-SHORT-INTEGER)
      ...
      (CL:EQ TEST-VALUE-000
       SGT-JAVA-TRANSLATE-STELLA-THIRY-TWO-BIT-VECTOR))
     (CL:RETURN-FROM JAVA-SPECIAL-SETTER-NAME
      (WRAP-STRING "set_int_special")))
    ((CL:OR (CL:EQ TEST-VALUE-000 SGT-JAVA-TRANSLATE-STELLA-FLOAT)
      (CL:EQ TEST-VALUE-000 SGT-JAVA-TRANSLATE-STELLA-DOUBLE))
     (CL:RETURN-FROM JAVA-SPECIAL-SETTER-NAME
      (WRAP-STRING "set_double_special")))
    ((CL:EQ TEST-VALUE-000 SGT-JAVA-TRANSLATE-STELLA-CHARACTER)
     (CL:RETURN-FROM JAVA-SPECIAL-SETTER-NAME
      (WRAP-STRING "set_char_special")))
    ((CL:EQ TEST-VALUE-000 SGT-JAVA-TRANSLATE-STELLA-LONG-INTEGER)
     (CL:RETURN-FROM JAVA-SPECIAL-SETTER-NAME
      (WRAP-STRING "set_long_special")))
    ((CL:EQ TEST-VALUE-000 SGT-JAVA-TRANSLATE-STELLA-SINGLE-FLOAT)
     (CL:RETURN-FROM JAVA-SPECIAL-SETTER-NAME
      (WRAP-STRING "set_float_special")))
    (CL:T
     (CL:RETURN-FROM JAVA-SPECIAL-SETTER-NAME
      (WRAP-STRING "set_special"))))))
...
(CL:DEFUN JAVA-TRANSLATE-SYMBOL-CONSTANT-NAME (SYMBOL)
  (CL:LET*
   ...
   (CL:WHEN (CL:NOT (IN-CURRENT-JAVA-PACKAGE? (HOME-MODULE GLOBALSYMBOL)))
    (CL:SETQ TRANSLATEDNAME
  ...
  (CL:LET*
   ((TRANSLATEDNAME
     (JAVA-SUBSTITUTE-FORBIDDEN-CHARACTERS
      (STRING-CAPITALIZE (%WRAPPER-VALUE NAMESTRING))
...
(CL:DEFUN IN-CURRENT-JAVA-PACKAGE? (MODULE)
  (CL:RETURN-FROM IN-CURRENT-JAVA-PACKAGE? (CL:EQ MODULE *MODULE*)))

;;; (DEFUN (JAVA-TRANSLATE-TYPE-SPEC STRING-WRAPPER) ...)

(CL:DEFUN JAVA-TRANSLATE-TYPE-SPEC (TYPESPEC)
  (CL:LET* ((FINALTYPESPEC NULL) (FINALTYPE NULL))
      ...
      (CL:PROGN
       (CL:WHEN (ARRAY-TYPE-SPECIFIER? TYPESPEC)
        (CL:RETURN-FROM JAVA-TRANSLATE-TYPE-SPEC
         (JAVA-TRANSLATE-ARRAY-TYPE TYPESPEC)))
       (CL:SETQ FINALTYPESPEC (%SPECIFIER-BASE-TYPE TYPESPEC))
       (CL:IF (IN-CURRENT-JAVA-PACKAGE? (HOME-MODULE FINALTYPESPEC))
        (CL:RETURN-FROM JAVA-TRANSLATE-TYPE-SPEC
         (JAVA-TRANSLATE-TYPE-SPEC FINALTYPESPEC))
        (CL:RETURN-FROM JAVA-TRANSLATE-TYPE-SPEC
          ...
          (WRAP-STRING
           (%WRAPPER-VALUE
            (DYNAMIC-SLOT-VALUE
             ...
             NULL-STRING-WRAPPER)))))
        (CL:T
         (CL:SETQ FINALTYPE (%CLASS-TYPE (%SURROGATE-VALUE TYPESPEC)))
         (CL:IF (IN-CURRENT-JAVA-PACKAGE? (HOME-MODULE FINALTYPE))
          (CL:RETURN-FROM JAVA-TRANSLATE-TYPE-SPEC
           (JAVA-TRANSLATE-CLASS-NAMESTRING
            (WRAP-STRING (%SYMBOL-NAME FINALTYPE))))
          (CL:RETURN-FROM JAVA-TRANSLATE-TYPE-SPEC
           (WRAP-STRING
            (CONCATENATE (JAVA-PACKAGE-PREFIX (HOME-MODULE FINALTYPE) ".")
             (%WRAPPER-VALUE
              (JAVA-TRANSLATE-CLASS-NAMESTRING
               (WRAP-STRING (%SYMBOL-NAME FINALTYPE))))))))))))
     (CL:T
...
(CL:DEFUN JAVA-TRANSLATE-ARRAY-TYPE (ARRAYTYPE)
  (CL:LET*
   ((DIMENSIONS (ARRAY-TYPE-DIMENSIONS ARRAYTYPE))
    ...
    (TRANSLATEDTYPE
     (%WRAPPER-VALUE (JAVA-TRANSLATE-TYPE-SPEC ELEMENTTYPE))))
...
(CL:DEFUN JAVA-TRANSLATE-ARRAY-OF-TYPE-SPEC (TYPESPEC FULLYQUALIFIED?)
  (CL:LET*
   ...
   (CL:RETURN-FROM JAVA-TRANSLATE-ARRAY-OF-TYPE-SPEC
    (WRAP-STRING
     (STRING-CONCATENATE (%WRAPPER-VALUE BASETYPESTRING) " []")))))
    ...
    ((WORD NULL)
     (ITER-000
      (LIST* SYM-JAVA-TRANSLATE-STELLA-OBJECT
       ...
       SYM-JAVA-TRANSLATE-STELLA-WHILE NIL)))
    (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-000 NIL)) DO
      ...
      (CL:SETQ RESTOREFORMS
       (CONS
        (LIST* SYM-JAVA-TRANSLATE-STELLA-JAVA_METHOD_CALL
         ...
         (LIST* SYM-JAVA-TRANSLATE-STELLA-JAVA_IDENT (WRAP-STRING "set")
          NIL)
         (LIST* SYM-JAVA-TRANSLATE-STELLA-JAVA_IDENT
          (JAVA-TRANSLATE-GLOBAL-NAME SPECIALVARIABLENAME FALSE) NIL)
...
;;; (DEFUN (JAVA-TRANSLATE-CATCH OBJECT) ...)

(CL:DEFUN JAVA-TRANSLATE-CATCH (TREE)
  (CL:WARN "java-translate-catch not yet implemented")
  (CL:RETURN-FROM JAVA-TRANSLATE-CATCH NIL))

;;; (DEFUN (JAVA-TRANSLATE-THROW OBJECT) ...)

(CL:DEFUN JAVA-TRANSLATE-THROW (TREE)
  (CL:WARN "java-translate-throw not yet implemented")
  (CL:RETURN-FROM JAVA-TRANSLATE-THROW NIL))
...
(CL:DEFUN JAVA-TRANSLATE-HANDLE-EXCEPTION (TREE)
  ...
  (SECOND-SETTER TREE
   (CONS
    (JAVA-TRANSLATE-TYPE-SPEC (%%VALUE (%%REST (%%VALUE (%%REST TREE)))))
   ...
   (CL:IF
    ...
    (CL:RETURN-FROM JAVA-TRANSLATE-SETQ-TREE
     (LIST* SYM-JAVA-TRANSLATE-STELLA-JAVA_FUNCTION_CALL
      (LIST* SYM-JAVA-TRANSLATE-STELLA-JAVA_IDENT
       (WRAP-STRING (JAVA-YIELD-FULL-NATIVE-CLASS-NAME)) NIL)
      (LIST* SYM-JAVA-TRANSLATE-STELLA-JAVA_IDENT
...
;;; (DEFUN (JAVA-TRANSLATE-SYS-REFERENCED-SLOT-VALUE OBJECT) ...)

(CL:DEFUN JAVA-TRANSLATE-SYS-REFERENCED-SLOT-VALUE (TREE)
  (CL:WARN "java-translate-sys-referenced-slot-value not yet implemented")
  (CL:RETURN-FROM JAVA-TRANSLATE-SYS-REFERENCED-SLOT-VALUE NIL))
...
(CL:DEFUN JAVA-TRANSLATE-ARGUMENT-LIST-ITERATOR (ITERATORBINDINGS CURSORBINDINGS BODY)
  (CL:LET*
   ((CURSORVAR (%%VALUE (%%VALUE CURSORBINDINGS)))
    ...
    (DUMMYARG
     (FOURTH (%%VALUE (%%REST (%%REST (%%VALUE ITERATORBINDINGS))))))
    (ITERATORCONSTRUCTOR NULL)
    (DECLARATIONS
     (LIST*
      (CONS (WRAP-STRING "Enumeration")
       (CONS (JAVA-TRANSLATE-A-TREE SYM-JAVA-TRANSLATE-STELLA-ARG_ENUM)
        NIL))
      (CONS (JAVA-TRANSLATE-TYPE-SPEC CURSORTYPE)
       (CONS (JAVA-TRANSLATE-A-TREE CURSORVAR) NIL))
      NIL)))
   (CL:LET*
    ((BINDING NULL) (ITER-000 (%%REST ITERATORBINDINGS))
     (COLLECT-000 NULL))
    (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-000 NIL)) DO
           ...
           (CONS
            (LIST* SYM-JAVA-TRANSLATE-STELLA-JAVA_CAST
             (LIST* SYM-JAVA-TRANSLATE-STELLA-JAVA_METHOD_CALL
              ...
              (LIST* SYM-JAVA-TRANSLATE-STELLA-JAVA_IDENT
               (JAVA-TRANSLATE-NAME SYM-JAVA-TRANSLATE-STELLA-ARG_ENUM)
               NIL)
              (CONS SYM-JAVA-TRANSLATE-STELLA-JAVA_ACTUALS NIL) NIL)
             (JAVA-TRANSLATE-TYPE-SPEC SGT-JAVA-TRANSLATE-STELLA-OBJECT)
             NIL)
            NIL))
          (CONCATENATE BODY NIL))
         NIL)
  ...
  (CL:LET*
   ...
   (CL:LET*
    ((ITERATORBINDINGS (%%VALUE (%%REST TREE)))
     ...
     (BODY (JAVA-TRANSLATE-LIST-OF-TREES (NTH-REST TREE 4)))
     (DECLARATIONS NIL) (NEXTASSIGNMENTS NIL) (ITERATORCONSTRUCTOR NULL))
    ...
    (CL:WHEN
     ...
     (CL:RETURN-FROM JAVA-TRANSLATE-FOREACH-TREE
      (JAVA-TRANSLATE-ARGUMENT-LIST-ITERATOR ITERATORBINDINGS
       CURSORBINDINGS BODY)))
    (CL:LET*
    ...
    (CL:LET* ((BINDING NULL) (ITER-001 CURSORBINDINGS))
     (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-001 NIL)) DO
      ...
      (CL:WHEN
       (CL:NOT
        (DUPLICATE-CURSOR-VARIABLE? (%%VALUE BINDING) ITERATORBINDINGS))
...
;;; (DEFUN (JAVA-TRANSLATE-STARTUP-TIME-PROGN OBJECT) ...)

(CL:DEFUN JAVA-TRANSLATE-STARTUP-TIME-PROGN (TREE)
  (CL:WARN "java-translate-startup-time-progn not yet implemented")
  (CL:RETURN-FROM JAVA-TRANSLATE-STARTUP-TIME-PROGN NIL))
    ...
    (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-000 NIL)) DO
     ...
     (CL:COND
      ((CL:EQ (SAFE-PRIMARY-TYPE CONDITION)
       ...
       (CL:PROGN
        (CL:IF
         (CL:EQ (%%VALUE CONDITION) SYM-JAVA-TRANSLATE-STELLA-OTHERWISE)
  ...
  (CL:LET*
   ...
   (CL:LET*
    ((RETURNTYPE NULL) (CURRENTINDEX NULL-INTEGER) (VARIABLE NULL)
     (ITER-000 (%%REST VARIABLES)) (ITER-001 0)
...
(CL:DEFUN JAVA-YIELD-FULLY-QUALIFIED-TYPE-NAME (TYPESPEC)
  (CL:LET*
   ((BASETYPESPEC (TYPE-SPEC-TO-BASE-TYPE TYPESPEC)) (TRANSLATEDTYPE NULL)
    (NATIVETYPE
     (%WRAPPER-VALUE
      (DYNAMIC-SLOT-VALUE (%DYNAMIC-SLOTS (%SURROGATE-VALUE BASETYPESPEC))
       SYM-JAVA-TRANSLATE-STELLA-CLASS-JAVA-NATIVE-TYPE
       NULL-STRING-WRAPPER))))
   ...
   (CL:WHEN (CL:NOT (CL:EQ NATIVETYPE STELLA::NULL-STRING))
    (CL:IF (CL:OR (MEMBER? NATIVETYPE #\.) (JAVA-LITERAL? TYPESPEC))
     ...
     (CL:RETURN-FROM JAVA-YIELD-FULLY-QUALIFIED-TYPE-NAME
      (WRAP-STRING (STRING-CONCATENATE "java.lang." NATIVETYPE)))))
   ...
   (CL:IF (MEMBER? (%WRAPPER-VALUE TRANSLATEDTYPE) #\.)
    ...
    (CL:RETURN-FROM JAVA-YIELD-FULLY-QUALIFIED-TYPE-NAME
     (WRAP-STRING
      (STRING-CONCATENATE
       (JAVA-PACKAGE-PREFIX (HOME-MODULE BASETYPESPEC) ".")
  ...
  (CL:COND
   ((JAVA-FLOTSAM-FUNCTION? F)
    (CL:RETURN-FROM JAVA-YIELD-TRANSLATED-CLASS-AND-FUNCTION-NAMES
     (CL:VALUES
      (WRAP-STRING
       (STRING-CONCATENATE (JAVA-PACKAGE-PREFIX (HOME-MODULE F) ".")
...
(CL:DEFUN JAVA-YIELD-TRANSLATED-CLASS-AND-METHOD-NAMES (OWNER F)
  (CL:COND
   ...
   (CL:T
    (CL:RETURN-FROM JAVA-YIELD-TRANSLATED-CLASS-AND-METHOD-NAMES
     (CL:VALUES
      (%WRAPPER-VALUE (JAVA-YIELD-FULLY-QUALIFIED-TYPE-NAME OWNER))
      (%WRAPPER-VALUE (JAVA-TRANSLATE-FUNCTION-NAME F)))))))
  ...
  (CL:LET*
   ...
   (CL:RETURN-FROM JAVA-YIELD-CLASS-OBJECT-ARRAY-EXPRESSION
    (JAVA-TRANSLATE-CLASS-OBJECT-LOOKUP
     (STRING-CONCATENATE PREFIX CLASSID)))))
      ...
      (CL:AND
       ...
       (CL:NOT
        (CL:EQ
         (%WRAPPER-VALUE
          (DYNAMIC-SLOT-VALUE
           (%DYNAMIC-SLOTS (%SURROGATE-VALUE CLASSTYPE))
           SYM-JAVA-TRANSLATE-STELLA-CLASS-JAVA-NATIVE-TYPE
           NULL-STRING-WRAPPER))
         STELLA::NULL-STRING)))
      (CL:SETQ OTREE
...
(CL:DEFUN YIELD-CLASS-OBJECT-LOOKUP-NAME-FOR-NATIVE-TYPE (NATIVETYPE)
  ...
  (CL:LET*
   ...
   (CL:LET*
    ((I NULL-INTEGER) (CH NULL-CHARACTER) (VECTOR-000 NATIVETYPE)
   ...
   (CL:COND
    ...
    (CL:T (CL:SETQ BASETYPE (STRING-CONCATENATE PACKAGE BASETYPE))))
   (CL:CASE ARRAYDIMENSIONS
    ...
    (1
     (CL:RETURN-FROM YIELD-CLASS-OBJECT-LOOKUP-NAME-FOR-NATIVE-TYPE
      (STRING-CONCATENATE "[" BASETYPE)))
    (2
     (CL:RETURN-FROM YIELD-CLASS-OBJECT-LOOKUP-NAME-FOR-NATIVE-TYPE
      (STRING-CONCATENATE "[[" BASETYPE)))
    (CL:OTHERWISE
     (CL:RETURN-FROM YIELD-CLASS-OBJECT-LOOKUP-NAME-FOR-NATIVE-TYPE
      (STRING-CONCATENATE (MAKE-STRING ARRAYDIMENSIONS #\[) BASETYPE))))))
...
;;; (DEFUN (JAVA-TRANSLATE-SYS-POINTER-TO-FUNCTION OBJECT) ...)

(CL:DEFUN JAVA-TRANSLATE-SYS-POINTER-TO-FUNCTION (TREE)
  (CL:WARN "java-translate-sys-pointer-to-function not yet implemented")
  (CL:RETURN-FROM JAVA-TRANSLATE-SYS-POINTER-TO-FUNCTION
   (JAVA-TRANSLATE-NULL)))
...
(CL:DEFMETHOD JAVA-TRANSLATE-METHOD-NAME ((METHOD METHOD-SLOT))
  (CL:LET*
   ((METHODNAME (%SLOT-NAME METHOD)) (TRANSLATEDNAME STELLA::NULL-STRING))
   (CL:DECLARE (CL:TYPE CL:SIMPLE-STRING TRANSLATEDNAME))
   (CL:WHEN (JAVA-METHOD-OBJECT-IS-OVERLOADED-FUNCTION? METHOD)
    (CL:SETQ METHODNAME
     (JAVA-CREATE-OVERLOADED-FUNCTION-NAME METHODNAME
      (%SLOT-OWNER METHOD))))
   (CL:SETQ TRANSLATEDNAME
    (%WRAPPER-VALUE (JAVA-TRANSLATE-NAME METHODNAME)))
...
;;; (DEFUN (JAVA-TRANSLATE-METHOD CONS) ...)

(CL:DEFUN JAVA-TRANSLATE-METHOD (METHOD)
  (CL:LET*
   ...
   (CL:LET*
    ((UNITISFUNCTION (JAVA-METHOD-OBJECT-IS-FUNCTION? METHOD))
     (BODYTREE NULL) (MODIFIERS NIL) (RETURNTYPE NULL)
     (MOSTGENERALMETHOD METHOD) (OTREE NIL) (TRANSLATEDMETHODBODY NULL))
    (CL:SETQ *METHODBEINGWALKED* METHOD)
    (CL:SETQ BODYTREE (JAVA-DELETE-QUOTED-NULL-STATEMENTS BODYTREE))
    (CL:WHEN (CL:NOT UNITISFUNCTION)
     (SUBSTITUTE-CONS-TREE BODYTREE SYM-JAVA-TRANSLATE-STELLA-THIS
      (FIRST (METHOD-PARAMETER-NAMES METHOD))))
    (CL:LOOP WHILE
     (CL:AND
    ...
    (CL:WHEN (PUBLIC? METHOD)
     (CL:SETQ MODIFIERS (CONS (WRAP-STRING "public") MODIFIERS)))
    (CL:SETQ RETURNTYPE
     (CONS (JAVA-TRANSLATE-TYPE-SPEC (%SLOT-BASE-TYPE MOSTGENERALMETHOD))
      NIL))
    (CL:SETQ OTREE
     (CONS
      (CL:IF UNITISFUNCTION SYM-JAVA-TRANSLATE-STELLA-JAVA_FUNCTION
      ...
      (CONS MODIFIERS
       (CONS RETURNTYPE
        (CONS (JAVA-TRANSLATE-METHOD-NAME METHOD)
         (CONS (JAVA-TRANSLATE-METHOD-PARAMETERS METHOD)
          (CONS TRANSLATEDMETHODBODY NIL)))))))
    (CL:RETURN-FROM JAVA-TRANSLATE-METHOD OTREE))))
...
(CL:DEFUN JAVA-YIELD-CLASS-NAME-FOR-FUNCTION (FUNCTION)
  (CL:COND
   ((JAVA-FLOTSAM-FUNCTION? FUNCTION)
    (CL:IF (IN-CURRENT-JAVA-PACKAGE? (HOME-MODULE FUNCTION))
   ...
   ((%WRAPPER-VALUE
     (DYNAMIC-SLOT-VALUE (%DYNAMIC-SLOTS FUNCTION)
      SYM-JAVA-TRANSLATE-STELLA-METHOD-NATIVE? FALSE-WRAPPER))
    (CL:RETURN-FROM JAVA-YIELD-CLASS-NAME-FOR-FUNCTION "Native"))
      ...
      (CL:LET*
       ...
       (CL:SETQ OTREE
        (LIST* SYM-JAVA-TRANSLATE-STELLA-JAVA_FUNCTION_CALL
         ...
         (LIST* SYM-JAVA-TRANSLATE-STELLA-JAVA_IDENT
          (JAVA-TRANSLATE-NAME FUNCTIONNAME) NIL)
         ACTUALS NIL))
  ...
  (CL:LET* ((OPERATOR (CL:IF NULL? "==" "!=")))
   ...
   (CL:COND
    ...
    ((SUBTYPE-OF? CLASSTYPE SGT-JAVA-TRANSLATE-STELLA-INTEGER)
     (CL:RETURN-FROM JAVA-TRANSLATE-DEFINED-OR-NULL
      (JAVA-TRANSLATE-OPERATOR-CALL (CONS (WRAP-STRING OPERATOR) NIL)
       (CONS OBJECT (CONS SYM-JAVA-TRANSLATE-STELLA-NULL-INTEGER NIL))
       2)))
    ...
    ((SUBTYPE-OF? CLASSTYPE SGT-JAVA-TRANSLATE-STELLA-SINGLE-FLOAT)
     (CL:RETURN-FROM JAVA-TRANSLATE-DEFINED-OR-NULL
      (JAVA-TRANSLATE-OPERATOR-CALL (CONS (WRAP-STRING OPERATOR) NIL)
       (CONS OBJECT
        (CONS SYM-JAVA-TRANSLATE-STELLA-NULL-SINGLE-FLOAT NIL))
       2)))
    ((SUBTYPE-OF? CLASSTYPE SGT-JAVA-TRANSLATE-STELLA-CHARACTER)
     (CL:RETURN-FROM JAVA-TRANSLATE-DEFINED-OR-NULL
      (JAVA-TRANSLATE-OPERATOR-CALL (CONS (WRAP-STRING OPERATOR) NIL)
       (CONS OBJECT (CONS SYM-JAVA-TRANSLATE-STELLA-NULL-CHARACTER NIL))
       2)))
    (CL:T
     (CL:RETURN-FROM JAVA-TRANSLATE-DEFINED-OR-NULL
      (JAVA-TRANSLATE-OPERATOR-CALL (CONS (WRAP-STRING OPERATOR) NIL)
...
(CL:DEFUN JAVA-TRANSLATE-METHOD-CALL (TREE)
  (CL:LET*
   ((METHODNAME (%%VALUE (%%REST (%%REST TREE))))
    ...
    (METHODSLOT
     (SAFE-LOOKUP-SLOT (%SURROGATE-VALUE CLASSTYPE) METHODNAME))
   ...
   (CL:COND
    ...
    ((CL:EQ METHODNAME SYM-JAVA-TRANSLATE-STELLA-GET-SYM)
     (CL:WHEN (ISA? OBJECT SGT-JAVA-TRANSLATE-STELLA-INTEGER-WRAPPER)
      (CL:RETURN-FROM JAVA-TRANSLATE-METHOD-CALL
       (LIST* SYM-JAVA-TRANSLATE-STELLA-JAVA_SYMBOL
        (GET-SYM (%WRAPPER-VALUE OBJECT)) NIL))))
    ((CL:EQ METHODNAME SYM-JAVA-TRANSLATE-STELLA-GET-KWD)
     (CL:WHEN (ISA? OBJECT SGT-JAVA-TRANSLATE-STELLA-INTEGER-WRAPPER)
      (CL:RETURN-FROM JAVA-TRANSLATE-METHOD-CALL
       (LIST* SYM-JAVA-TRANSLATE-STELLA-JAVA_SYMBOL
        (GET-KWD (%WRAPPER-VALUE OBJECT)) NIL))))
    ((CL:EQ METHODNAME SYM-JAVA-TRANSLATE-STELLA-GET-SGT)
     (CL:WHEN (ISA? OBJECT SGT-JAVA-TRANSLATE-STELLA-INTEGER-WRAPPER)
      (CL:RETURN-FROM JAVA-TRANSLATE-METHOD-CALL
       (LIST* SYM-JAVA-TRANSLATE-STELLA-JAVA_SYMBOL
        (GET-SGT (%WRAPPER-VALUE OBJECT)) NIL))))
      ...
      (CL:RETURN-FROM JAVA-TRANSLATE-METHOD-CALL
       (JAVA-TRANSLATE-FUNCTION-CALL
        (LIST* SYM-JAVA-TRANSLATE-STELLA-SYS-CALL-FUNCTION
         ...
         (CONCATENATE (%%REST (%%REST (%%REST TREE))) NIL))
        METHODSLOT)))))
   (CL:IF (CL:NOT (CL:EQ OPERATOR NULL))
    ...
    (CL:SETQ OTREE
     (LIST* SYM-JAVA-TRANSLATE-STELLA-JAVA_METHOD_CALL
      (LIST* SYM-JAVA-TRANSLATE-STELLA-JAVA_IDENT
       (JAVA-TRANSLATE-CLASS-NAME (SYMBOLIZE CLASSTYPE)) NIL)
      (LIST* SYM-JAVA-TRANSLATE-STELLA-JAVA_IDENT
       (JAVA-TRANSLATE-NAME METHODNAME) NIL)
      (JAVA-TRANSLATE-A-TREE OBJECT)
      (CONS
       (CL:IF
        (CL:AND (CL:NOT (CL:EQ METHODSLOT NULL))
         (ISA? METHODSLOT SGT-JAVA-TRANSLATE-STELLA-METHOD-SLOT)
         (CL:NOT
       ...
       NIL))))
   (CL:RETURN-FROM JAVA-TRANSLATE-METHOD-CALL OTREE)))
      ...
      (CL:SETQ OTREE
       (LIST* SYM-JAVA-TRANSLATE-STELLA-JAVA_BINARY_OP
        ...
        (CONS (%%VALUE OPERATORNAMES)
         (CONS
          (JAVA-TRANSLATE-OPERATOR-CALL OPERATORNAMES (%%REST ARGUMENTS)
           2)
          NIL))))
      (CL:SETQ OTREE
       (LIST* SYM-JAVA-TRANSLATE-STELLA-JAVA_BINARY_OP
       ...
       (CONS (%%VALUE OPERATORNAMES)
        (CONS (JAVA-TRANSLATE-A-TREE (%%VALUE (%%REST ARGUMENTS)))
         (CONS (%%VALUE (%%REST OPERATORNAMES))
          (CONS
           (JAVA-TRANSLATE-A-TREE (%%VALUE (%%REST (%%REST ARGUMENTS))))
           NIL))))))))
...
(CL:DEFUN JAVA-TRANSLATE-AREF-METHOD-CALL (OPERATOR OWNER ARGUMENTS)
  (CL:COND
   ...
   (CL:T (CL:RETURN-FROM JAVA-TRANSLATE-AREF-METHOD-CALL NIL))))
...
(CL:DEFUN HELP-STARTUP-JAVA-TRANSLATE1 ()
  (CL:PROGN
   ...
   (CL:SETQ SYM-JAVA-TRANSLATE-STELLA-JAVA_SPECIAL
   ...
   (CL:SETQ SYM-JAVA-TRANSLATE-STELLA-SYS-REFERENCED-SLOT-VALUE
...
(CL:DEFUN HELP-STARTUP-JAVA-TRANSLATE2 ()
  (CL:PROGN
   ...
   (CL:SETQ SYM-JAVA-TRANSLATE-STELLA-SYS-POINTER-TO-FUNCTION
...
(CL:DEFUN HELP-STARTUP-JAVA-TRANSLATE5 ()
  (CL:PROGN
   ...
   (DEFINE-FUNCTION-OBJECT "JAVA-TRANSLATE-TYPE-SPEC"
    "(DEFUN (JAVA-TRANSLATE-TYPE-SPEC STRING-WRAPPER) ((TYPESPEC TYPE-SPEC)))"
   ...
   (DEFINE-FUNCTION-OBJECT "JAVA-TRANSLATE-CATCH"
    "(DEFUN (JAVA-TRANSLATE-CATCH OBJECT) ((TREE CONS)))"
    (CL:FUNCTION JAVA-TRANSLATE-CATCH) NULL)
   (DEFINE-FUNCTION-OBJECT "JAVA-TRANSLATE-THROW"
    "(DEFUN (JAVA-TRANSLATE-THROW OBJECT) ((TREE CONS)))"
    (CL:FUNCTION JAVA-TRANSLATE-THROW) NULL)
   ...
   (DEFINE-FUNCTION-OBJECT "JAVA-TRANSLATE-SYS-REFERENCED-SLOT-VALUE"
    "(DEFUN (JAVA-TRANSLATE-SYS-REFERENCED-SLOT-VALUE OBJECT) ((TREE CONS)))"
    (CL:FUNCTION JAVA-TRANSLATE-SYS-REFERENCED-SLOT-VALUE) NULL)
   ...
   (DEFINE-FUNCTION-OBJECT "JAVA-TRANSLATE-STARTUP-TIME-PROGN"
    "(DEFUN (JAVA-TRANSLATE-STARTUP-TIME-PROGN OBJECT) ((TREE CONS)))"
    (CL:FUNCTION JAVA-TRANSLATE-STARTUP-TIME-PROGN) NULL)
...
(CL:DEFUN HELP-STARTUP-JAVA-TRANSLATE6 ()
  (CL:PROGN
   ...
   (DEFINE-FUNCTION-OBJECT "JAVA-TRANSLATE-SYS-POINTER-TO-FUNCTION"
    "(DEFUN (JAVA-TRANSLATE-SYS-POINTER-TO-FUNCTION OBJECT) ((TREE CONS)))"
    (CL:FUNCTION JAVA-TRANSLATE-SYS-POINTER-TO-FUNCTION) NULL)
...
(CL:DEFUN STARTUP-JAVA-TRANSLATE ()
  (CL:LET* ((*MODULE* *STELLA-MODULE*) (*CONTEXT* *MODULE*))
   ...
   (CL:WHEN (CURRENT-STARTUP-TIME-PHASE? 7) (HELP-STARTUP-JAVA-TRANSLATE5)
    (HELP-STARTUP-JAVA-TRANSLATE6)
    (DEFINE-FUNCTION-OBJECT "JAVA-TRANSLATE-METHOD"
     "(DEFUN (JAVA-TRANSLATE-METHOD CONS) ((METHOD METHOD-SLOT)))"
     (CL:FUNCTION JAVA-TRANSLATE-METHOD) NULL)
    ...
    (CL:LET*
     ...
     (SET-DYNAMIC-SLOT-VALUE (%DYNAMIC-SLOTS FUNCTION)
      SYM-JAVA-TRANSLATE-STELLA-METHOD-STARTUP-CLASSNAME
      (WRAP-STRING "Startup-Java-Translate") NULL-STRING-WRAPPER)))
