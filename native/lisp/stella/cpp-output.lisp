...
(CL:DECLAIM
 (CL:SPECIAL *STELLA-MODULE* *MODULE* *TRANSLATOROUTPUTLANGUAGE*
  NULL-INTEGER EOL TRUE NULL-CHARACTER *CURRENT-STREAM* NIL FALSE))
...
(CL:DEFUN CPP-OUTPUT-FORMAL-PARAMETERS (PARAMETERS)
  (CL:LET*
   ((N-PARAMETERS (LENGTH PARAMETERS)) (VARIABLE-ARGUMENTS? FALSE))
   (CL:DECLARE (CL:TYPE CL:FIXNUM N-PARAMETERS))
   (%%PRINT-STREAM (%NATIVE-STREAM *CURRENT-STREAM*) "(")
   (CL:LET*
    ((N NULL-INTEGER) (PARAMETER NULL) (ITER-000 PARAMETERS)
