...
(CL:DECLAIM
 (CL:SPECIAL *STELLA-MODULE* *MODULE* *TRANSLATOROUTPUTLANGUAGE* NULL-INTEGER
  NULL-CHARACTER EOL *CURRENT-STREAM* NIL))
...
(CL:DEFUN CPP-FLATTEN-STATEMENTS (STATEMENTS)
  (CL:IF
   (CL:AND (CL:NOT (CL:EQ STATEMENTS NULL)) (CL:NOT (CL:EQ STATEMENTS NIL)))
   ...
   (CL:LET* ((RESULT-000 STELLA::NULL-STRING))
    ...
    (CL:LET* ((*CURRENT-STREAM* (NEW-OUTPUT-STRING-STREAM)))
     ...
     (CL:PROGN (%%PRINT-STREAM (%NATIVE-STREAM *CURRENT-STREAM*) " (*) (")
      (CL:LET*
       ((PARTYPE NULL) (ITER-000 PARAMETERTYPES) (I NULL-INTEGER) (ITER-001 1)
...
(CL:DEFUN CPP-OUTPUT-FOREACH (LOOP)
  (CL:LET*
   ...
   (CL:LET* ((VAR NULL) (ITER-000 VARIABLES) (I NULL-INTEGER) (ITER-001 1))
   ...
   (CL:WHEN (CL:NOT (CL:EQ NEXTASSIGNMENTS NIL))
    (CL:WHEN EOLSEPARATEEXPRESSIONS?
     (%%PRINT-STREAM (%NATIVE-STREAM *CURRENT-STREAM*) EOL))
    (CL:LET*
     ((NEXT NULL) (ITER-002 NEXTASSIGNMENTS) (I NULL-INTEGER) (ITER-003 1))
   ...
   (CL:LET*
    ...
    (CL:LOOP WHILE (CL:< INDEX-000 LENGTH-000) DO
     ...
     (CL:CASE CH
      ...
      (CL:OTHERWISE))
     (%%PRINT-STREAM (%NATIVE-STREAM *CURRENT-STREAM*) CH)
     (CL:SETQ FREE (CL:1- FREE)) (CL:SETQ INDEX-000 (CL:1+ INDEX-000))))
   (%%PRINT-STREAM (%NATIVE-STREAM *CURRENT-STREAM*) "\""))
  :VOID)
...
(CL:DEFUN CPP-OUTPUT-CLASS (CLASSDEF)
  ...
  (CL:LET* ((STATEMENT NULL) (ITER-000 (NTH-REST CLASSDEF 4)))
   (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-000 NIL)) DO
    (CL:SETQ STATEMENT (%%VALUE ITER-000)) (CPP-OUTPUT-STATEMENT STATEMENT)
    (CL:SETQ ITER-000 (%%REST ITER-000))))
  (%%PRINT-STREAM (%NATIVE-STREAM *CURRENT-STREAM*) "};" EOL EOL)
...
(CL:DEFUN CPP-OUTPUT-FORMAL-PARAMETERS (PARAMETERS)
  (CL:LET* ((N-PARAMETERS (LENGTH PARAMETERS)) (VARIABLE-ARGUMENTS? CL:NIL))
   ...
   (%%PRINT-STREAM (%NATIVE-STREAM *CURRENT-STREAM*) "(")
   (CL:LET*
    ((PARAMETER NULL) (ITER-000 PARAMETERS) (N NULL-INTEGER) (ITER-001 1)
     (UPPER-BOUND-000 N-PARAMETERS)
     (UNBOUNDED?-000 (CL:= UPPER-BOUND-000 NULL-INTEGER)))
...
(CL:DEFUN HELP-STARTUP-CPP-OUTPUT3 ()
  (CL:PROGN
   ...
   (DEFINE-FUNCTION-OBJECT "CPP-OUTPUT-CATCH"
    "(DEFUN CPP-OUTPUT-CATCH ((TREE CONS)))" (CL:FUNCTION CPP-OUTPUT-CATCH)
    NULL)
   ...
   (DEFINE-FUNCTION-OBJECT "CPP-OUTPUT-CONTINUE"
    "(DEFUN CPP-OUTPUT-CONTINUE ())" (CL:FUNCTION CPP-OUTPUT-CONTINUE) NULL)
   ...
   (DEFINE-FUNCTION-OBJECT "CPP-PROGN?"
    "(DEFUN (CPP-PROGN? BOOLEAN) ((TREE OBJECT)))" (CL:FUNCTION CPP-PROGN?)
    NULL)
   (DEFINE-FUNCTION-OBJECT "CPP-BLOCK?"
    "(DEFUN (CPP-BLOCK? BOOLEAN) ((TREE OBJECT)))" (CL:FUNCTION CPP-BLOCK?)
    NULL)
   (DEFINE-FUNCTION-OBJECT "CPP-OUTPUT-IF"
    "(DEFUN CPP-OUTPUT-IF ((TREE CONS)))" (CL:FUNCTION CPP-OUTPUT-IF) NULL)
   ...
   (DEFINE-FUNCTION-OBJECT "CPP-OUTPUT-WHILE"
    "(DEFUN CPP-OUTPUT-WHILE ((LOOP CONS)))" (CL:FUNCTION CPP-OUTPUT-WHILE)
    NULL)
