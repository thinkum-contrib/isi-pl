...
(CL:DEFUN NORMALIZE-PARENT-MODULES (SELF)
  ...
  (CL:LET*
   ((PARENTS (%PARENT-MODULES SELF)) (RECOMPUTEFULLNAME? CL:NIL))
      ...
      (CL:LOOP WHILE (NEXT? ITER-000) DO (CL:SETQ C (%VALUE ITER-000))
       (CL:LET* ((TEST-VALUE-000 (SAFE-PRIMARY-TYPE C)))
        (CL:COND
         ((SUBTYPE-OF? TEST-VALUE-000 SGT-MODULES-STELLA-MODULE)
          (CL:PROGN
           (CL:WHEN (EMPTY? (%USES C)) (CL:SETF (%USES C) (LIST C)))
           (FINALIZE-MODULE C)))
         ((SUBTYPE-OF? TEST-VALUE-000 SGT-MODULES-STELLA-WORLD)
     ...
     (CL:LET* ((OLDPLIST SELF-000))
      (CL:LET* ((SELF-001 (NEW-PROPERTY-LIST)))
       ...
       (CL:LET* ((NEWPLIST SELF-001))
        ...
        (CL:LET*
         ((KEY NULL) (VALUE NULL) (ITER-000 (%THE-PLIST OLDPLIST)))
         (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-000 NIL)) DO
          (CL:SETQ KEY (%%VALUE ITER-000))
          (CL:SETQ VALUE (%%VALUE (%%REST ITER-000)))
          (CL:WHEN
          ...
          (CL:SETQ ITER-000 (%%REST (%%REST ITER-000)))))
        (CL:LET*
         ((KEY NULL) (VALUE NULL) (ITER-001 (%THE-PLIST NEWPLIST)))
         (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-001 NIL)) DO
...
(CL:DEFUN ALL-SUBCONTEXTS-NEXT? (SELF)
  (CL:LET*
   ...
   (CL:LET*
    ((CHILD NULL)
     (ITER-001 (%THE-CONS-LIST (%CHILD-CONTEXTS THISCONTEXT)))
     (COLLECT-000 NULL))
    (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-001 NIL)) DO
     (CL:SETQ CHILD (%%VALUE ITER-001))
...
(CL:DEFUN ALL-TOPDOWN-SUBCONTEXTS-NEXT? (SELF)
  (CL:LET*
   ...
   (CL:LET*
    ((CHILD NULL)
     (ITER-002 (%THE-CONS-LIST (%CHILD-CONTEXTS THISCONTEXT)))
     (COLLECT-000 NULL))
    (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-002 NIL)) DO
