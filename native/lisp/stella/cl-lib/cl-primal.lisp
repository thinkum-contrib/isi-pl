...
(CL:DECLAIM
 (CL:SPECIAL *STELLA-MODULE* NIL KEYWORD-SYM SURROGATE-SYM SYMBOL-SYM *MODULE*
  FALSE TRUE))
...
(CL:DEFMETHOD NULL? ((VALUE CL:INTEGER))
  (CL:OR (CL:NOT (CL:TYPEP VALUE (CL:QUOTE CL:FIXNUM))) (CL:= VALUE NULL-INTEGER)))
...
(CL:DECLAIM (CL:FTYPE (CL:FUNCTION (CL:FIXNUM) CL:FIXNUM) INTEGER-LENGTH))
...
(CL:DECLAIM
 (CL:FTYPE (CL:FUNCTION (CL:SIMPLE-STRING) CL:SIMPLE-STRING) STRING-UPCASE))
...
(CL:DECLAIM
 (CL:FTYPE (CL:FUNCTION (CL:SIMPLE-STRING) CL:SIMPLE-STRING) STRING-DOWNCASE))
...
(CL:DECLAIM
 (CL:FTYPE (CL:FUNCTION (CL:SIMPLE-STRING) CL:SIMPLE-STRING) STRING-CAPITALIZE))
...
(CL:DECLAIM
 (CL:FTYPE (CL:FUNCTION (CL:SIMPLE-STRING CL:SIMPLE-STRING CL:FIXNUM) CL:FIXNUM)
  STRING-SEARCH))
    ...
    (STELLA-CODE-TO-CONS-TREE
     (CL:LET
      ((CL:*PACKAGE* (CL:FIND-PACKAGE "STELLA"))
       (CL:*READTABLE*
        (CL:IF CASESENSITIVE? *CASE-SENSITIVE-READTABLE* *STANDARD-READTABLE*)))
...
(CL:DECLAIM
 (CL:FTYPE (CL:FUNCTION (CL:FIXNUM) CL:SIMPLE-STRING) INTEGER-TO-STRING))
  ...
  (CL:RETURN-FROM FLOAT-TO-STRING
   (CL:let ((CL:*read-default-float-format* 'CL:double-float))
         ...
         (CL:with-output-to-string (s)
           (CL:prin1 float s)))))
(CL:DECLAIM
 (CL:FTYPE (CL:FUNCTION (CL:DOUBLE-FLOAT) CL:SIMPLE-STRING) FLOAT-TO-STRING))
...
(CL:DECLAIM
 (CL:FTYPE (CL:FUNCTION (CL:SIMPLE-STRING) CL:FIXNUM) STRING-TO-INTEGER))
...
(CL:DECLAIM
 (CL:FTYPE (CL:FUNCTION (CL:SIMPLE-STRING) CL:DOUBLE-FLOAT) STRING-TO-FLOAT))
   ...
   ((CL:SYMBOLP STELLACODE)
    (CL:LET* ((NAME (CL:SYMBOL-NAME STELLACODE)))
     (CL:COND
      ...
      ((SURROGATE-NAME? NAME)
       (CL:RETURN-FROM STELLA-CODE-TO-CONS-TREE
        (INTERN-RIGID-SYMBOL-CASE-SENSITIVELY (CL:SUBSEQ NAME 1) SURROGATE-SYM
         FALSE)))
      (CL:T
       (CL:RETURN-FROM STELLA-CODE-TO-CONS-TREE
...
(CL:DEFUN FILE-WRITE-DATE (FILENAME)
  ...
  (CL:RETURN-FROM FILE-WRITE-DATE
   (CL:LET ((DATE (CL:FILE-WRITE-DATE FILENAME)))
    (CL:IF (CL:NULL DATE) NULL (NATIVE-DATE-TIME-TO-CALENDAR-DATE DATE)))))
...
(CL:DECLAIM
 (CL:FTYPE (CL:FUNCTION (CL:T CL:T) CL:DOUBLE-FLOAT) TICKTOCK-DIFFERENCE))
...
(CL:DEFUN STARTUP-CL-PRIMAL ()
  (CL:LET* ((*MODULE* *STELLA-MODULE*) (*CONTEXT* *MODULE*))
   ...
   (CL:WHEN (CURRENT-STARTUP-TIME-PHASE? 7)
    (DEFINE-FUNCTION-OBJECT ">" "(DEFUN (> BOOLEAN) ((X NUMBER) (Y NUMBER)))"
     (CL:FUNCTION >) NULL)
    (DEFINE-FUNCTION-OBJECT ">=" "(DEFUN (>= BOOLEAN) ((X NUMBER) (Y NUMBER)))"
     (CL:FUNCTION >=) NULL)
    (DEFINE-FUNCTION-OBJECT "<" "(DEFUN (< BOOLEAN) ((X NUMBER) (Y NUMBER)))"
    ...
    (DEFINE-FUNCTION-OBJECT "<=" "(DEFUN (<= BOOLEAN) ((X NUMBER) (Y NUMBER)))"
     (CL:FUNCTION <=) NULL)
    (DEFINE-FUNCTION-OBJECT "+" "(DEFUN (+ NUMBER) (|&REST| (ARGS NUMBER)))"
     (CL:FUNCTION +) NULL)
    (DEFINE-FUNCTION-OBJECT "-"
     "(DEFUN (- NUMBER) ((X NUMBER) |&REST| (ARGS NUMBER)))" (CL:FUNCTION -)
     NULL)
    (DEFINE-FUNCTION-OBJECT "*" "(DEFUN (* NUMBER) (|&REST| (ARGS NUMBER)))"
     (CL:FUNCTION *) NULL)
    (DEFINE-FUNCTION-OBJECT "/"
     "(DEFUN (/ NUMBER) ((X NUMBER) |&REST| (ARGS NUMBER)))" (CL:FUNCTION /)
     NULL)
    (DEFINE-FUNCTION-OBJECT "CEILING" "(DEFUN (CEILING INTEGER) ((N NUMBER)))"
     (CL:FUNCTION CEILING) NULL)
    (DEFINE-FUNCTION-OBJECT "FLOOR" "(DEFUN (FLOOR INTEGER) ((N NUMBER)))"
     (CL:FUNCTION FLOOR) NULL)
    (DEFINE-FUNCTION-OBJECT "ROUND" "(DEFUN (ROUND INTEGER) ((N NUMBER)))"
     (CL:FUNCTION ROUND) NULL)
...
'end' value of NULL stands for the rest of the string.\")"
    ...
    (DEFINE-FUNCTION-OBJECT "STRINGIFY"
     "(DEFUN (STRINGIFY STRING) ((EXPRESSION OBJECT)))" (CL:FUNCTION STRINGIFY)
     NULL)
...
integer and return the result.\" :PUBLIC? TRUE)" (CL:FUNCTION STRING-TO-INTEGER)
     NULL)
...
float and return the result.\" :PUBLIC? TRUE)" (CL:FUNCTION STRING-TO-FLOAT)
     NULL)
    ...
    (DEFINE-FUNCTION-OBJECT "TOGGLE-CL-BASED-READERS"
     "(DEFUN TOGGLE-CL-BASED-READERS ())" (CL:FUNCTION TOGGLE-CL-BASED-READERS)
     NULL)
    ...
    (DEFINE-FUNCTION-OBJECT "DELETE-FILE"
     "(DEFUN DELETE-FILE ((FILENAME FILE-NAME)))" (CL:FUNCTION DELETE-FILE) NULL)
...
the timing grain size may be larger than this resolution.\" :PUBLIC? TRUE)"
    ...
    (DEFINE-FUNCTION-OBJECT "STARTUP-CL-PRIMAL"
     "(DEFUN STARTUP-CL-PRIMAL () :PUBLIC? TRUE)" (CL:FUNCTION STARTUP-CL-PRIMAL)
     NULL)
    (CL:LET*
