  ...
  (CL:LET*
   ...
   (CL:WHEN (CL:EQ (%NATIVE-STREAM SELF) NULL)
    (CL:LET* ((STREAM-000 (NEW-OUTPUT-STRING-STREAM)))
     ...
     (CL:ERROR
      (NEW-INPUT-OUTPUT-EXCEPTION (THE-STRING-READER STREAM-000)))))
     ...
     (LIST* SYM-STREAMS-STELLA-UNWIND-PROTECT
      (LIST* SYM-STREAMS-STELLA-PROGN
       (LIST* SYM-STREAMS-STELLA-SETQ VAR
        (CONS
         (LIST* SYM-STREAMS-STELLA-NEW
          SYM-STREAMS-STELLA-FILE-INPUT-STREAM KWD-STREAMS-FILENAME
     ...
     (LIST* SYM-STREAMS-STELLA-UNWIND-PROTECT
      (LIST* SYM-STREAMS-STELLA-PROGN
       (LIST* SYM-STREAMS-STELLA-SETQ VAR
        (CONS
         (LIST* SYM-STREAMS-STELLA-NEW
          SYM-STREAMS-STELLA-FILE-OUTPUT-STREAM KWD-STREAMS-FILENAME
          (%%VALUE (%%REST BINDING)) NIL)
         NIL))
       (CONCATENATE BODY NIL))
      (LIST* SYM-STREAMS-STELLA-WHEN
...
associated characters.\" :PUBLIC? TRUE)"
   ...
   (CL:LET*
    ...
    (SET-DYNAMIC-SLOT-VALUE (%DYNAMIC-SLOTS FUNCTION)
     ...
     (WRAP-STRING "_Startup-Streams") NULL-STRING-WRAPPER)))
  :VOID)
