...
(CL:DEFUN STARTUP-DYNAMIC-LITERAL-SLOTS ()
  (CL:LET* ((*MODULE* *STELLA-MODULE*) (*CONTEXT* *MODULE*)) (CL:DECLARE (CL:SPECIAL *MODULE* *CONTEXT*))
   (CL:WHEN (CURRENT-STARTUP-TIME-PHASE? 2)
    (CL:SETQ SYM-DYNAMIC-LITERAL-SLOTS-STELLA-STARTUP-DYNAMIC-LITERAL-SLOTS
     (INTERN-RIGID-SYMBOL-WRT-MODULE "STARTUP-DYNAMIC-LITERAL-SLOTS" NULL 0))
    (CL:SETQ SYM-DYNAMIC-LITERAL-SLOTS-STELLA-METHOD-STARTUP-CLASSNAME
     (INTERN-RIGID-SYMBOL-WRT-MODULE "METHOD-STARTUP-CLASSNAME" NULL 0)))
   (CL:WHEN (CURRENT-STARTUP-TIME-PHASE? 6) (FINALIZE-CLASSES))
   (CL:WHEN (CURRENT-STARTUP-TIME-PHASE? 7)
    (DEFINE-FUNCTION-OBJECT "STARTUP-DYNAMIC-LITERAL-SLOTS" "(DEFUN STARTUP-DYNAMIC-LITERAL-SLOTS () :PUBLIC? TRUE)"
    ...
    (CL:LET* ((FUNCTION (LOOKUP-FUNCTION SYM-DYNAMIC-LITERAL-SLOTS-STELLA-STARTUP-DYNAMIC-LITERAL-SLOTS)))
     (SET-DYNAMIC-SLOT-VALUE (%DYNAMIC-SLOTS FUNCTION) SYM-DYNAMIC-LITERAL-SLOTS-STELLA-METHOD-STARTUP-CLASSNAME
      (WRAP-STRING "_StartupDynamicLiteralSlots") NULL-STRING-WRAPPER)))
