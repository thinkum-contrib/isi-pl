...
(CL:DECLAIM
 (CL:SPECIAL NULL-STRING-WRAPPER *CHARACTER-TYPE-TABLE* *STELLA-MODULE* *FUNCTION-LOOKUP-TABLE*
  *CURRENT-STELLA-FEATURES* *TRANSLATOROUTPUTLANGUAGE* NIL-LIST STANDARD-ERROR *CURRENT-SYSTEM-ACTION* *CURRENTFILE*
  *MODULE* *TRANSLATIONUNITS* *EVALUATIONTREE* *EVALUATIONPARENTTREE* *TRANSLATIONPHASE* *CURRENTSYSTEMDEFINITION*
...
(CL:DEFUN PARSE-DIRECTORY-PATH (PATH)
  ...
  (CL:LET* ((SEPARATOR #\|) (LENGTH (CL:THE CL:FIXNUM (CL:LENGTH PATH))) (START 0) (END 0) (PARSEDPATH NIL))
   (CL:DECLARE (CL:TYPE CL:FIXNUM LENGTH START END))
   (CL:LOOP (CL:SETQ END (POSITION PATH SEPARATOR START))
    (CL:SETQ PARSEDPATH (CONS (WRAP-STRING (FILE-NAME-AS-DIRECTORY (SUBSEQUENCE PATH START END))) PARSEDPATH))
...
(CL:DEFUN POP-LOAD-PATH-EVALUATOR-WRAPPER (ARGUMENTS)
  ...
  (CL:LET* ((RESULT (POP-LOAD-PATH))) (CL:DECLARE (CL:TYPE CL:SIMPLE-STRING RESULT))
   (CL:IF (CL:NOT (CL:EQ RESULT STELLA::NULL-STRING))
    (CL:RETURN-FROM POP-LOAD-PATH-EVALUATOR-WRAPPER (WRAP-STRING RESULT))
...
`path' from the PowerLoom load path."
  ...
  (CL:LET* ((DIR NULL) (ITER-000 (PARSE-DIRECTORY-PATH PATH)))
   (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-000 NIL)) DO (CL:SETQ DIR (%%VALUE ITER-000))
    (CL:SETQ *FILE-LOAD-PATH* (REMOVE *FILE-LOAD-PATH* DIR)) (CL:SETQ ITER-000 (%%REST ITER-000))))
...
the value has to be supplied as NIL."
  ...
  (CL:LET* ((EXPANDEDFILE FILE)) (CL:DECLARE (CL:TYPE CL:SIMPLE-STRING EXPANDEDFILE))
   (CL:WHEN (CL:EQ EXTENSIONS NULL) (CL:SETQ EXTENSIONS *STELLA-FILE-EXTENSIONS*))
   (CL:LET* ((DIR NULL) (ITER-000 (CONS (WRAP-STRING "") *FILE-LOAD-PATH*)))
    (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-000 NIL)) DO (CL:SETQ DIR (%%VALUE ITER-000))
     (CL:HANDLER-CASE
      (CL:PROGN (CL:SETQ EXPANDEDFILE (CONCATENATE (UNWRAP-STRING DIR) FILE))
       (CL:WHEN (PROBE-FILE? EXPANDEDFILE) (CL:RETURN-FROM FIND-FILE-IN-LOAD-PATH EXPANDEDFILE))
...
if coercion is not possible or raise an error if `error?' is TRUE."
  (CL:COND
   ((CL:OR (CL:EQ VALUE SYM-SYSTEMS-STELLA-TRUE) (CL:EQ VALUE KWD-SYSTEMS-TRUE))
    (CL:RETURN-FROM COERCE-VALUE-TO-BOOLEAN TRUE-WRAPPER))
   ((CL:OR (CL:EQ VALUE SYM-SYSTEMS-STELLA-FALSE) (CL:EQ VALUE KWD-SYSTEMS-FALSE))
...
otherwise or raise an error if `error?' is true."
  (CL:LET* ((TEST-VALUE-000 (SAFE-PRIMARY-TYPE VALUE)))
   (CL:COND
    ((SUBTYPE-OF-STRING? TEST-VALUE-000) (CL:PROGN (CL:RETURN-FROM COERCE-VALUE-TO-STRING (%WRAPPER-VALUE VALUE))))
    ((SUBTYPE-OF? TEST-VALUE-000 SGT-SYSTEMS-STELLA-GENERALIZED-SYMBOL)
     (CL:PROGN (CL:RETURN-FROM COERCE-VALUE-TO-STRING (%SYMBOL-NAME VALUE))))
    ((SUBTYPE-OF-INTEGER? TEST-VALUE-000)
     (CL:PROGN (CL:RETURN-FROM COERCE-VALUE-TO-STRING (INTEGER-TO-STRING (CL:TRUNCATE (%WRAPPER-VALUE VALUE))))))
    ((SUBTYPE-OF-LONG-INTEGER? TEST-VALUE-000)
     (CL:PROGN (CL:RETURN-FROM COERCE-VALUE-TO-STRING (INTEGER-TO-STRING (%WRAPPER-VALUE VALUE)))))
    ((SUBTYPE-OF-FLOAT? TEST-VALUE-000)
     (CL:PROGN (CL:RETURN-FROM COERCE-VALUE-TO-STRING (FLOAT-TO-STRING (%WRAPPER-VALUE VALUE)))))
    (CL:T)))
  (CL:IF ERROR?
   (CL:LET* ((STREAM-000 (NEW-OUTPUT-STRING-STREAM)))
    (%%PRINT-STREAM (%NATIVE-STREAM STREAM-000) "coerce-value-to-string: don't know how to coerce `" VALUE "'")
    (CL:ERROR (NEW-STELLA-EXCEPTION (THE-STRING-READER STREAM-000))))
...
is possible, simply stringify `object'."
  (CL:LET* ((STRING (COERCE-VALUE-TO-STRING OBJECT CL:NIL))) (CL:DECLARE (CL:TYPE CL:SIMPLE-STRING STRING))
   (CL:WHEN (CL:EQ STRING STELLA::NULL-STRING) (CL:SETQ STRING (STRINGIFY OBJECT)))
...
NULL otherwise or raise an error if `error?' is true."
  (CL:LET* ((TEST-VALUE-000 (SAFE-PRIMARY-TYPE VALUE)))
   (CL:COND
    ((SUBTYPE-OF-INTEGER? TEST-VALUE-000)
     (CL:PROGN (CL:RETURN-FROM COERCE-VALUE-TO-FLOAT (CL:* (%WRAPPER-VALUE VALUE) 1.0d0))))
    ((SUBTYPE-OF-LONG-INTEGER? TEST-VALUE-000)
     (CL:PROGN (CL:RETURN-FROM COERCE-VALUE-TO-FLOAT (CL:* (%WRAPPER-VALUE VALUE) 1.0d0))))
    ((SUBTYPE-OF-FLOAT? TEST-VALUE-000) (CL:PROGN (CL:RETURN-FROM COERCE-VALUE-TO-FLOAT (%WRAPPER-VALUE VALUE))))
    (CL:T)))
  (CL:IF ERROR?
   (CL:LET* ((STREAM-000 (NEW-OUTPUT-STRING-STREAM)))
    (%%PRINT-STREAM (%NATIVE-STREAM STREAM-000) "coerce-value-to-float: don't know how to coerce `" VALUE "'")
    (CL:ERROR (NEW-STELLA-EXCEPTION (THE-STRING-READER STREAM-000))))
...
or raise an error if `error?' is TRUE."
  (CL:COND
   ((CL:EQ TYPE SGT-SYSTEMS-STELLA-INTEGER)
    (CL:LET* ((TEST-VALUE-000 (SAFE-PRIMARY-TYPE VALUE)))
     (CL:COND ((SUBTYPE-OF-INTEGER? TEST-VALUE-000) (CL:PROGN (CL:RETURN-FROM COERCE-VALUE-TO-TYPE VALUE)))
      ((SUBTYPE-OF-FLOAT? TEST-VALUE-000)
       (CL:PROGN (CL:RETURN-FROM COERCE-VALUE-TO-TYPE (WRAP-INTEGER (FLOOR (%WRAPPER-VALUE VALUE))))))
      ((SUBTYPE-OF-LONG-INTEGER? TEST-VALUE-000)
       (CL:PROGN
        (CL:WHEN
         (CL:AND (CL:>= (%WRAPPER-VALUE VALUE) NULL-INTEGER) (CL:<= (%WRAPPER-VALUE VALUE) MOST-POSITIVE-INTEGER))
   ...
   ((CL:EQ TYPE SGT-SYSTEMS-STELLA-FLOAT)
    (CL:LET* ((VAL (COERCE-VALUE-TO-FLOAT VALUE ERROR?))) (CL:DECLARE (CL:TYPE CL:DOUBLE-FLOAT VAL))
     (CL:IF (CL:NOT (CL:= VAL NULL-FLOAT)) (CL:RETURN-FROM COERCE-VALUE-TO-TYPE (WRAP-FLOAT VAL))
   ...
   ((CL:EQ TYPE SGT-SYSTEMS-STELLA-STRING)
    (CL:LET* ((VAL (COERCE-VALUE-TO-STRING VALUE ERROR?))) (CL:DECLARE (CL:TYPE CL:SIMPLE-STRING VAL))
     (CL:IF (CL:NOT (CL:EQ VAL STELLA::NULL-STRING)) (CL:RETURN-FROM COERCE-VALUE-TO-TYPE (WRAP-STRING VAL))
      (CL:RETURN-FROM COERCE-VALUE-TO-TYPE NULL))))
   ((CL:EQ TYPE SGT-SYSTEMS-STELLA-KEYWORD)
    (CL:LET* ((TEST-VALUE-002 (SAFE-PRIMARY-TYPE VALUE)))
     (CL:COND
      ((SUBTYPE-OF? TEST-VALUE-002 SGT-SYSTEMS-STELLA-GENERALIZED-SYMBOL)
       (CL:PROGN (CL:RETURN-FROM COERCE-VALUE-TO-TYPE (KEYWORDIFY VALUE))))
      ((SUBTYPE-OF-STRING? TEST-VALUE-002) (CL:PROGN (CL:RETURN-FROM COERCE-VALUE-TO-TYPE (KEYWORDIFY VALUE))))
      (CL:T))))
   ((CL:EQ TYPE SGT-SYSTEMS-STELLA-SYMBOL)
    (CL:LET* ((TEST-VALUE-003 (SAFE-PRIMARY-TYPE VALUE)))
     (CL:COND
      ((SUBTYPE-OF-KEYWORD? TEST-VALUE-003)
       (CL:PROGN (CL:RETURN-FROM COERCE-VALUE-TO-TYPE (INTERN-SYMBOL (%SYMBOL-NAME VALUE)))))
      ((SUBTYPE-OF-SURROGATE? TEST-VALUE-003)
       (CL:PROGN (CL:RETURN-FROM COERCE-VALUE-TO-TYPE (INTERN-DERIVED-SYMBOL VALUE (%SYMBOL-NAME VALUE)))))
      ((SUBTYPE-OF-SYMBOL? TEST-VALUE-003) (CL:PROGN (CL:RETURN-FROM COERCE-VALUE-TO-TYPE VALUE)))
      ((SUBTYPE-OF-STRING? TEST-VALUE-003)
       (CL:PROGN (CL:RETURN-FROM COERCE-VALUE-TO-TYPE (INTERN-SYMBOL (%WRAPPER-VALUE VALUE)))))
      (CL:T))))
   ((CL:EQ TYPE SGT-SYSTEMS-STELLA-BOOLEAN)
    (CL:RETURN-FROM COERCE-VALUE-TO-TYPE (COERCE-VALUE-TO-BOOLEAN VALUE ERROR?)))
   ((CL:EQ TYPE SGT-SYSTEMS-STELLA-MODULE)
    (CL:LET* ((MODULE (COERCE-TO-MODULE VALUE CL:NIL)))
     (CL:WHEN (CL:NOT (CL:EQ MODULE NULL)) (CL:RETURN-FROM COERCE-VALUE-TO-TYPE MODULE))))
   (CL:T
    (CL:COND ((CL:EQ TYPE NULL) (CL:RETURN-FROM COERCE-VALUE-TO-TYPE VALUE))
  ...
  (CL:IF ERROR?
   (CL:LET* ((STREAM-000 (NEW-OUTPUT-STRING-STREAM)))
    (%%PRINT-STREAM (%NATIVE-STREAM STREAM-000) "coerce-value-to-type: don't know how to coerce `" VALUE "' to type `"
     TYPE "'")
    (CL:ERROR (NEW-STELLA-EXCEPTION (THE-STRING-READER STREAM-000))))
   (CL:RETURN-FROM COERCE-VALUE-TO-TYPE NULL)))
   ...
   (CL:LET* ((TEST-VALUE-000 (SAFE-PRIMARY-TYPE PLIST)))
    (CL:COND ((SUBTYPE-OF? TEST-VALUE-000 SGT-SYSTEMS-STELLA-PROPERTY-LIST) (CL:PROGN (CL:SETQ PROPERTYLIST PLIST)))
     ((CL:EQ TEST-VALUE-000 SGT-SYSTEMS-STELLA-CONS)
      (CL:PROGN
       (CL:LET* ((SELF-000 (NEW-PROPERTY-LIST))) (CL:SETF (%THE-PLIST SELF-000) PLIST)
        (CL:SETQ PROPERTYLIST SELF-000))))
     ((SUBTYPE-OF? TEST-VALUE-000 SGT-SYSTEMS-STELLA-LIST)
      (CL:PROGN
       (CL:LET* ((SELF-001 (NEW-PROPERTY-LIST))) (CL:SETF (%THE-PLIST SELF-001) (%THE-CONS-LIST PLIST))
    ...
    (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-000 NIL)) DO (CL:SETQ KEY (%%VALUE ITER-000))
     ...
     (CL:WHEN
      (CL:OR (CL:NOT (STELLA-OBJECT? KEY)) (CL:NOT (KEYWORD? KEY))
       (CL:AND (CL:NOT (CL:EQ LEGALOPTIONS NULL)) (CL:NOT (MEMBER? LEGALOPTIONS KEY))))
      (CL:SETQ VALUE VALUE)
       ...
       (CL:LET* ((NEWPLIST (NEW-PROPERTY-LIST)))
        (CL:LET* ((KEY NULL) (VALUE NULL) (ITER-001 (%THE-PLIST PROPERTYLIST)))
         (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-001 NIL)) DO (CL:SETQ KEY (%%VALUE ITER-001))
          (CL:SETQ VALUE (%%VALUE (%%REST ITER-001))) (INSERT-AT NEWPLIST (STELLIFY KEY) (STELLIFY VALUE))
      ...
      (%%PRINT-STREAM (%NATIVE-STREAM STANDARD-OUTPUT) "Skipping illegal option: `" KEY "'" EOL EOL)
      (CL:IF (KEYWORD? KEY)
       (%%PRINT-STREAM (%NATIVE-STREAM STANDARD-OUTPUT) "   Legal options are: `" LEGALOPTIONS "'" EOL EOL)
   ...
   (CL:LET* ((LEGALOPTIONS SELF-000) (PARSEDOPTIONS NULL) (TYPE NULL) (COERCEDVALUE NULL))
     ...
     (CL:COND
      ((CL:EQ TEST-VALUE-000 SGT-SYSTEMS-STELLA-CONS)
       (CL:PROGN
        (CL:WHEN (CL:LOGBITP 0 (CL:THE CL:FIXNUM (LENGTH OPTIONS)))
         (CL:LET* ((STREAM-000 (NEW-OUTPUT-STRING-STREAM)))
          (%%PRINT-STREAM (%NATIVE-STREAM STREAM-000) "Odd-length options list: `" OPTIONS "'")
          (CL:ERROR (NEW-STELLA-EXCEPTION (THE-STRING-READER STREAM-000)))))
        (CL:LET* ((SELF-003 (NEW-PROPERTY-LIST))) (CL:SETF (%THE-PLIST SELF-003) OPTIONS)
      ...
      (CL:T
       (CL:LET* ((STREAM-001 (NEW-OUTPUT-STRING-STREAM)))
        (%%PRINT-STREAM (%NATIVE-STREAM STREAM-001) "Illegal options specification: `" OPTIONS "'")
    ...
    (CL:WHEN (CL:NOT (CL:EQ LEGALOPTIONS NULL))
     (CL:LET* ((KEY NULL) (VALUE NULL) (ITER-000 (%THE-PLIST PARSEDOPTIONS)))
      (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-000 NIL)) DO (CL:SETQ KEY (%%VALUE ITER-000))
       (CL:SETQ VALUE (%%VALUE (%%REST ITER-000))) (CL:SETQ TYPE (LOOKUP LEGALOPTIONS KEY))
       (CL:WHEN (CL:AND (CL:EQ TYPE NULL) (CL:NOT ALLOWOTHERKEYS?))
        (CL:LET* ((STREAM-002 (NEW-OUTPUT-STRING-STREAM)))
         (%%PRINT-STREAM (%NATIVE-STREAM STREAM-002) "Illegal option: `" KEY "'")
         (CL:ERROR (NEW-STELLA-EXCEPTION (THE-STRING-READER STREAM-002)))))
       (CL:WHEN (CL:NOT (CL:OR (CL:EQ TYPE SGT-SYSTEMS-STELLA-IDENTITY) (CL:EQ VALUE NULL)))
        (CL:SETQ COERCEDVALUE (COERCE-VALUE-TO-TYPE VALUE TYPE COERCIONERROR?))
...
(CL:DEFUN EVALUATE-COMMAND (COMMAND FINALIZE?)
  (CL:LET*
   ((*TRANSLATIONERRORS* 0) (*TRANSLATIONWARNINGS* 0) (*TRANSLATIONNOTES* 0) (*IGNORETRANSLATIONERRORS?* CL:NIL)
    (*TRANSLATIONUNITS* NULL) (*TRANSLATIONPHASE* KWD-SYSTEMS-DEFINE) (*EVALUATIONTREE* NULL))
   (CL:DECLARE
    (CL:SPECIAL *TRANSLATIONERRORS* *TRANSLATIONWARNINGS* *TRANSLATIONNOTES* *IGNORETRANSLATIONERRORS?*
     *TRANSLATIONUNITS* *TRANSLATIONPHASE* *EVALUATIONTREE*))
   ...
   (CL:LET* ((OPERATOR NULL) (RESULT NULL))
    (CL:LET* ((TEST-VALUE-000 (SAFE-PRIMARY-TYPE COMMAND)))
     (CL:COND
               ...
               (CL:CASE (LENGTH (REVERSE *TRANSLATIONUNITS*))
                (0
                 (CL:LET* ((STREAM-000 (NEW-OUTPUT-STRING-STREAM)))
                  ...
                  (%%PRINT-STREAM (%NATIVE-STREAM STREAM-000) "Couldn't translate `" COMMAND "'")
      ...
      ((SUBTYPE-OF-SURROGATE? TEST-VALUE-000) (CL:PROGN (CL:SETQ RESULT COMMAND))) (CL:T (%EVALUATE COMMAND))))
    (CL:WHEN (CL:AND (CL:NOT (TRANSLATION-ERRORS?)) FINALIZE?) (CL:SETQ *TRANSLATIONPHASE* KWD-SYSTEMS-FINALIZE)
     (CL:IF (CL:NOT (CL:EQ *CURRENTSYSTEMDEFINITION* NULL)) (RUN-SYSTEM-FINALIZATION *CURRENTSYSTEMDEFINITION*)
      (%%PRINT-STREAM (%NATIVE-STREAM STANDARD-OUTPUT)
       "Can't run finalization because *currentSystemDefinition* is not set." EOL)))
...
`evaluate' to each of them."
  ...
  (CL:LET*
   ((TOPLEVELINVOCATION? (CL:EQ *CURRENTFILE* STELLA::NULL-STRING)) (SKIPCOMMAND? CL:NIL) (SEENINMODULE? CL:NIL)
    (COMMANDS NIL) (INPUTSTREAM NULL))
   (CL:UNWIND-PROTECT
    (CL:LET* ((*CURRENTFILE* (FILE-BASE-NAME FILE))) (CL:DECLARE (CL:SPECIAL *CURRENTFILE*))
        ...
        (CL:TAGBODY
         (CL:COND
          ((CL:EQ (SAFE-PRIMARY-TYPE TREE) SGT-SYSTEMS-STELLA-CONS)
           (CL:PROGN
            (CL:MULTIPLE-VALUE-SETQ (SKIPCOMMAND? SEENINMODULE?) (HANDLE-IN-MODULE-TREE TREE SEENINMODULE? CL:T))
            ...
            (CL:LET* ((OPERATOR (%%VALUE TREE)))
             (CL:COND
              ((SUBTYPE-OF-SYMBOL? (SAFE-PRIMARY-TYPE OPERATOR))
               (CL:PROGN
                (CL:COND
                 ((CL:OR (CL:EQ OPERATOR SYM-SYSTEMS-STELLA-DEFMODULE) (CL:EQ OPERATOR SYM-SYSTEMS-STELLA-DEFSYSTEM)
                   (CL:EQ OPERATOR SYM-SYSTEMS-STELLA-DEFCLASS) (CL:EQ OPERATOR SYM-SYSTEMS-STELLA-DEFSLOT)
                   (CL:EQ OPERATOR SYM-SYSTEMS-STELLA-DEFUN) (CL:EQ OPERATOR SYM-SYSTEMS-STELLA-DEFMETHOD))
                  (EVALUATE-COMMAND TREE CL:NIL))
                 (CL:T
                  (CL:IF (CL:NOT (CL:EQ (LOOKUP-COMMAND OPERATOR) NULL)) (CL:SETQ COMMANDS (CONS TREE COMMANDS))
                   (EVALUATE-COMMAND TREE CL:NIL))))))
              (CL:T (EVALUATE-COMMAND TREE CL:NIL))))))
          (CL:T (EVALUATE-COMMAND TREE CL:NIL)))
         :CONTINUE)))
      (CL:LET* ((*TRANSLATIONPHASE* KWD-SYSTEMS-FINALIZE)) (CL:DECLARE (CL:SPECIAL *TRANSLATIONPHASE*))
      ...
      (CL:LET* ((FINALIZE? (CL:NOT (CL:EQ *CURRENTSYSTEMDEFINITION* NULL))))
       (CL:LET* ((TREE NULL) (ITER-001 (REVERSE COMMANDS)))
        (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-001 NIL)) DO (CL:SETQ TREE (%%VALUE ITER-001))
         (EVALUATE-COMMAND TREE FINALIZE?) (CL:SETQ ITER-001 (%%REST ITER-001)))))))
...
(CL:DEFUN MAKE-SYSTEM-DEFINITION-FILE-NAME (NAME)
  ...
  (CL:RETURN-FROM MAKE-SYSTEM-DEFINITION-FILE-NAME
   (CONCATENATE (SYSTEM-DEFINITIONS-DIRECTORY) (DIRECTORY-SEPARATOR-STRING) (STRING-DOWNCASE NAME) "-system.ste")))
...
(CL:DEFUN PARSE-LIST-OF-FILE-PATHS (FILES)
  (CL:LET* ((STRINGS NIL))
   (CL:LET* ((FILESPEC NULL) (ITER-000 FILES))
    (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-000 NIL)) DO (CL:SETQ FILESPEC (%%VALUE ITER-000))
     (CL:SETQ STRINGS (CONS (WRAP-STRING (IMPLODE-PATHNAME FILESPEC)) STRINGS)) (CL:SETQ ITER-000 (%%REST ITER-000))))
  ...
  (CL:LET* ((STRINGNAME STELLA::NULL-STRING)) (CL:DECLARE (CL:TYPE CL:SIMPLE-STRING STRINGNAME))
   (CL:LET* ((TEST-VALUE-000 (SAFE-PRIMARY-TYPE NAME)))
    (CL:COND ((SUBTYPE-OF-STRING? TEST-VALUE-000) (CL:PROGN (CL:SETQ STRINGNAME (%WRAPPER-VALUE NAME))))
     ...
     (CL:T (%%PRINT-STREAM (%NATIVE-STREAM STANDARD-OUTPUT) "Illegal system name: " NAME)
      ...
      (CL:LET* ((PLIST SELF-001))
       (CL:LET* ((VALUE-000 NULL))
        (CL:LET* ((S NULL) (ITER-000 (%THE-CONS-LIST *SYSTEMDEFINITIONS*)))
         (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-000 NIL)) DO (CL:SETQ S (%%VALUE ITER-000))
          (CL:WHEN (STRING-EQL? (%NAME S) STRINGNAME) (CL:SETQ VALUE-000 S) (CL:RETURN))
          (CL:SETQ ITER-000 (%%REST ITER-000))))
         ...
         (CL:LET* ((KEY NULL) (VALUE NULL) (ITER-001 (%THE-PLIST PLIST)))
          (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-001 NIL)) DO (CL:SETQ KEY (%%VALUE ITER-001))
           ...
           (CL:LET* ((TEST-VALUE-001 KEY))
            (CL:COND
             ((CL:EQ TEST-VALUE-001 KWD-SYSTEMS-DIRECTORY) (CL:SETF (%DIRECTORY SYSTEM) (IMPLODE-PATHNAME VALUE)))
             ...
             ((CL:EQ TEST-VALUE-001 KWD-SYSTEMS-REQUIRED-SYSTEMS) (CL:SETF (%REQUIRED-SYSTEMS SYSTEM) VALUE)
              (CL:LET* ((SYS NULL) (ITER-002 VALUE))
               (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-002 NIL)) DO (CL:SETQ SYS (%%VALUE ITER-002))
                 ...
                 (CL:LET* ((CURRENTACTION KWD-SYSTEMS-LOAD-SYSTEM) (CURRENTLANGUAGE (RUNNING-IN-LANGUAGE)))
                  (CL:WHEN (CL:NOT (CL:EQ *CURRENT-SYSTEM-ACTION* NULL))
                   (CL:SETQ CURRENTACTION
                    (LOOKUP-WITH-DEFAULT *CURRENT-SYSTEM-ACTION* KWD-SYSTEMS-ACTION CURRENTACTION))
                   (CL:SETQ CURRENTLANGUAGE
                    (LOOKUP-WITH-DEFAULT *CURRENT-SYSTEM-ACTION* KWD-SYSTEMS-LANGUAGE CURRENTLANGUAGE)))
                  (CL:COND
                   ((CL:EQ CURRENTACTION KWD-SYSTEMS-MAKE-SYSTEM)
                    (%%PRINT-STREAM (%NATIVE-STREAM STANDARD-OUTPUT) "Making required system " (UNWRAP-STRING SYS) EOL)
                    (%MAKE-SYSTEM (%WRAPPER-VALUE SYS) (CONS-LIST CURRENTLANGUAGE)))
                   (CL:T
                    (%%PRINT-STREAM (%NATIVE-STREAM STANDARD-OUTPUT) "Loading required system " (UNWRAP-STRING SYS)
                     EOL)
                    (%LOAD-SYSTEM (%WRAPPER-VALUE SYS) (CONS-LIST CURRENTLANGUAGE))))))
                (CL:SETQ ITER-002 (%%REST ITER-002)))))
             ((CL:EQ TEST-VALUE-001 KWD-SYSTEMS-LISP-ONLY-FILES)
              (CL:SETF (%LISP-ONLY-FILES SYSTEM) (PARSE-LIST-OF-FILE-PATHS VALUE)))
             ((CL:EQ TEST-VALUE-001 KWD-SYSTEMS-CPP-ONLY-FILES)
              (CL:SETF (%CPP-ONLY-FILES SYSTEM) (PARSE-LIST-OF-FILE-PATHS VALUE)))
             ((CL:EQ TEST-VALUE-001 KWD-SYSTEMS-JAVA-ONLY-FILES)
              (CL:SETF (%JAVA-ONLY-FILES SYSTEM) (PARSE-LIST-OF-FILE-PATHS VALUE)))
             ((CL:EQ TEST-VALUE-001 KWD-SYSTEMS-DATA-FILES)
              (CL:SETF (%DATA-FILES SYSTEM) (PARSE-LIST-OF-FILE-PATHS VALUE)))
             ((CL:EQ TEST-VALUE-001 KWD-SYSTEMS-PREPROCESSED-FILES)
              (CL:SETF (%PREPROCESSED-FILES SYSTEM) (PARSE-LIST-OF-FILE-PATHS VALUE)))
             ...
             ((CL:OR (CL:EQ TEST-VALUE-001 KWD-SYSTEMS-BANNER) (CL:EQ TEST-VALUE-001 KWD-SYSTEMS-COPYRIGHT-HEADER))
             ...
             (CL:T
              (CL:LET* ((STREAM-000 (NEW-OUTPUT-STRING-STREAM)))
               ...
               (CL:ERROR (NEW-STELLA-EXCEPTION (THE-STRING-READER STREAM-000)))))))
           (CL:SETQ ITER-001 (%%REST (%%REST ITER-001)))))
         (CL:WHEN (CL:EQ (%DIRECTORY SYSTEM) STELLA::NULL-STRING) (CL:SETF (%DIRECTORY SYSTEM) (%NAME SYSTEM)))
         (PUSH *SYSTEMDEFINITIONS* SYSTEM)
         (CL:WHEN (CL:NOT (CL:EQ OLDSYSTEM NULL))
          (%%PRINT-STREAM (%NATIVE-STREAM STANDARD-OUTPUT) "Redefining system `" (%NAME SYSTEM) "'" EOL EOL)
...
(CL:DEFUN GET-SYSTEM-DEFINITION (NAME)
  ...
  (CL:LET* ((VALUE-000 NULL))
   (CL:LET* ((S NULL) (ITER-000 (%THE-CONS-LIST *SYSTEMDEFINITIONS*)))
    (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-000 NIL)) DO (CL:SETQ S (%%VALUE ITER-000))
     (CL:WHEN (STRING-EQUAL? (%NAME S) NAME) (CL:SETQ VALUE-000 S) (CL:RETURN)) (CL:SETQ ITER-000 (%%REST ITER-000))))
    ...
    (CL:WHEN (CL:EQ SYSTEM NULL)
     (CL:LET* ((SYSTEMFILENAME (MAKE-SYSTEM-DEFINITION-FILE-NAME NAME)))
      (CL:WHEN (CL:NOT (PROBE-FILE? SYSTEMFILENAME))
       (%%PRINT-STREAM (%NATIVE-STREAM STANDARD-ERROR) "ERROR>> File " SYSTEMFILENAME " does not exist." EOL
      ...
      (CL:LET* ((VALUE-001 NULL))
       (CL:LET* ((S NULL) (ITER-001 (%THE-CONS-LIST *SYSTEMDEFINITIONS*)))
        (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-001 NIL)) DO (CL:SETQ S (%%VALUE ITER-001))
         (CL:WHEN (STRING-EQUAL? (%NAME S) NAME) (CL:SETQ VALUE-001 S) (CL:RETURN))
         (CL:SETQ ITER-001 (%%REST ITER-001))))
       (CL:SETQ SYSTEM VALUE-001))
      (CL:WHEN (CL:EQ SYSTEM NULL)
       (%%PRINT-STREAM (%NATIVE-STREAM STANDARD-ERROR) "ERROR>>  Can't find a system definition for system " NAME EOL
...
(CL:DEFUN GET-CARDINAL-MODULE (SYSTEM)
  (CL:LET* ((NAME (%CARDINAL-MODULE SYSTEM)) (MODULE NULL)) (CL:DECLARE (CL:TYPE CL:SIMPLE-STRING NAME))
   ...
   (CL:WHEN (CL:EQ MODULE NULL) (CL:WARN "No cardinal module defined for system: `~A'~%" SYSTEM))
   ...
   (CL:LET*
    ((*CURRENTSYSTEMDEFINITION* (GET-SYSTEM-DEFINITION (%NAME SYSTEM)))
     (*CURRENTSYSTEMDEFINITIONSUBDIRECTORY*
      (CL:IF (CL:NOT (CL:EQ *CURRENTSYSTEMDEFINITION* NULL)) (%DIRECTORY *CURRENTSYSTEMDEFINITION*)
       STELLA::NULL-STRING)))
          ...
          (CL:SETQ FILENAME
           (%WRAPPER-VALUE
            (JAVA-TRANSLATE-CLASS-NAMESTRING
             (WRAP-STRING (CONCATENATE "_STARTUP-" (STRING-UPCASE (%WRAPPER-VALUE F))))))))
      ...
      (CL:COND
       ((CL:EQ TYPE KWD-SYSTEMS-JAVA)
        (CL:WHEN (CL:EQ (GET-CARDINAL-MODULE *CURRENTSYSTEMDEFINITION*) NULL)
         (%%PRINT-STREAM (%NATIVE-STREAM STANDARD-OUTPUT) "No cardinal module defined for system `" (%NAME SYSTEM) "'"
          EOL EOL)
        ...
        (CL:SETQ FILENAME
         (JAVA-MAKE-CODE-OUTPUT-FILE-NAME
          (JAVA-YIELD-FLOTSAM-CLASS-NAME (GET-CARDINAL-MODULE *CURRENTSYSTEMDEFINITION*)) CL:NIL))
        (HELP-GET-SYSTEM-FILES FILENAME FILES PROBEFILES?))
       (CL:T)))
...
(CL:DEFUN CLEAN-SYSTEM (SYSTEMNAME)
  ...
  (CL:LET* ((SYSTEM (GET-SYSTEM-DEFINITION SYSTEMNAME))) (CL:WHEN (CL:EQ SYSTEM NULL) (CL:RETURN-FROM CLEAN-SYSTEM))
   (CL:LET* ((F NULL) (ITER-000 (%THE-CONS-LIST (GET-SYSTEM-FILES SYSTEM KWD-SYSTEMS-LISP CL:T))))
    (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-000 NIL)) DO (CL:SETQ F (%%VALUE ITER-000)) (DELETE-FILE (%WRAPPER-VALUE F))
     (CL:SETQ ITER-000 (%%REST ITER-000))))
   (CL:LET* ((F NULL) (ITER-001 (%THE-CONS-LIST (GET-SYSTEM-FILES SYSTEM KWD-SYSTEMS-JAVA CL:T))))
    (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-001 NIL)) DO (CL:SETQ F (%%VALUE ITER-001)) (DELETE-FILE (%WRAPPER-VALUE F))
     (CL:SETQ ITER-001 (%%REST ITER-001))))
   (CL:LET* ((F NULL) (ITER-002 (%THE-CONS-LIST (GET-SYSTEM-FILES SYSTEM KWD-SYSTEMS-CPP CL:T))))
    (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-002 NIL)) DO (CL:SETQ F (%%VALUE ITER-002)) (DELETE-FILE (%WRAPPER-VALUE F))
     (CL:SETQ ITER-002 (%%REST ITER-002))))
   (CL:LET* ((F NULL) (ITER-003 (%THE-CONS-LIST (GET-SYSTEM-FILES SYSTEM KWD-SYSTEMS-LISP-BINARY CL:T))))
    (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-003 NIL)) DO (CL:SETQ F (%%VALUE ITER-003)) (DELETE-FILE (%WRAPPER-VALUE F))
...
(CL:DEFUN COMPUTE-OPTIMIZATION-LEVELS (SYSTEM PRODUCTIONMODE?)
  (CL:LET* ((SETTINGS NULL))
   ...
   (SET-OPTIMIZATION-LEVELS (%WRAPPER-VALUE (NTH SETTINGS 0)) (%WRAPPER-VALUE (NTH SETTINGS 1))
    (%WRAPPER-VALUE (NTH SETTINGS 2)) (%WRAPPER-VALUE (NTH SETTINGS 3))))
  :VOID)
...
be called once all files have been loaded."
  ...
  (CL:LET*
   ((OPTIONS |LANGUAGE&OPTIONS|)
    (LANGUAGE
     (CL:IF (MEMBER? (GET-QUOTED-TREE "((:COMMON-LISP :CPP :JAVA) \"/STELLA\")" "/STELLA") (%%VALUE OPTIONS))
    ...
    (PLIST
     (VET-OPTIONS (CL:IF (CL:EQ (%%VALUE OPTIONS) LANGUAGE) (%%REST OPTIONS) OPTIONS)
      (GET-QUOTED-TREE
       ...
       "/STELLA")))
    (DEVELOPMENTSETTINGS? CL:NIL) (FORCETRANSLATION? CL:NIL) (FORCERECOMPILATION? CL:NIL)
    (TWOPASS? (CL:NOT (SYSTEM-LOADED-OR-STARTED-UP? SYSTEMNAME))) (LOADSYSTEM? CL:NIL) (STARTUPSYSTEM? CL:NIL)
    (SYSTEM NULL) (UPDATEDSYSTEM? CL:NIL))
   (CL:SETQ LANGUAGE (LOOKUP-WITH-DEFAULT PLIST KWD-SYSTEMS-LANGUAGE LANGUAGE))
   (INSERT-AT PLIST KWD-SYSTEMS-LANGUAGE LANGUAGE) (CL:SETQ LOADSYSTEM? (CL:EQ LANGUAGE KWD-SYSTEMS-COMMON-LISP))
     ...
     (CL:LET* ((TRUEVALUE? (EQL? VALUE TRUE-WRAPPER)))
      (CL:LET* ((TEST-VALUE-000 KEY))
       (CL:COND ((CL:EQ TEST-VALUE-000 KWD-SYSTEMS-DEVELOPMENT-SETTINGS?) (CL:SETQ DEVELOPMENTSETTINGS? TRUEVALUE?))
        ...
        ((CL:EQ TEST-VALUE-000 KWD-SYSTEMS-TWO-PASS?) (CL:SETQ TWOPASS? TRUEVALUE?))
        ((CL:EQ TEST-VALUE-000 KWD-SYSTEMS-LOAD-SYSTEM?) (CL:SETQ LOADSYSTEM? TRUEVALUE?))
   ...
   (CL:LET* ((*CURRENT-SYSTEM-ACTION* (COPY PLIST))) (CL:DECLARE (CL:SPECIAL *CURRENT-SYSTEM-ACTION*))
    ...
    (CL:WHEN (CL:EQ SYSTEM NULL)
     (%%PRINT-STREAM (%NATIVE-STREAM STANDARD-OUTPUT) "Can't find a declaration for system named " SYSTEMNAME EOL
    ...
    (CL:WHEN
     (CL:OR FORCERECOMPILATION?
      (CL:AND (CL:NOT (SYSTEM-LOADED-OR-STARTED-UP? SYSTEMNAME))
       (CL:OR FORCETRANSLATION? (SYSTEM-NEEDS-TRANSLATION? SYSTEMNAME LANGUAGE))))
     (LOAD-PREPROCESSED-FILES SYSTEMNAME))
    (CL:SETQ UPDATEDSYSTEM?
     (%TRANSLATE-SYSTEM SYSTEMNAME
      (CONS-LIST LANGUAGE KWD-SYSTEMS-TWO-PASS? (CL:IF TWOPASS? TRUE-WRAPPER FALSE-WRAPPER)
       KWD-SYSTEMS-FORCE-TRANSLATION? (CL:IF FORCETRANSLATION? TRUE-WRAPPER FALSE-WRAPPER)
       KWD-SYSTEMS-DEVELOPMENT-SETTINGS? (CL:IF DEVELOPMENTSETTINGS? TRUE-WRAPPER FALSE-WRAPPER))))
    (CL:WHEN
     (CL:AND LOADSYSTEM?
      (%LOAD-SYSTEM SYSTEMNAME
       (CONS-LIST LANGUAGE KWD-SYSTEMS-FORCE-RECOMPILATION? (CL:IF FORCERECOMPILATION? TRUE-WRAPPER FALSE-WRAPPER)
...
(CL:DEFUN MAKE-SYSTEM-EVALUATOR-WRAPPER (ARGUMENTS)
  (CL:RETURN-FROM MAKE-SYSTEM-EVALUATOR-WRAPPER
   (CL:IF (%MAKE-SYSTEM (%WRAPPER-VALUE (%%VALUE ARGUMENTS)) (%%REST ARGUMENTS)) TRUE-WRAPPER FALSE-WRAPPER)))
    ...
    (CL:LET* ((FOUND?-000 CL:NIL))
     (CL:LET* ((SYS NULL) (ITER-000 (%THE-CONS-LIST *SYSTEMDEFINITIONS*)))
      (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-000 NIL)) DO (CL:SETQ SYS (%%VALUE ITER-000))
       (CL:WHEN (CL:AND (STRING-EQUAL? (%NAME SYS) NAME) (%LOADED? SYS)) (CL:SETQ FOUND?-000 CL:T) (CL:RETURN))
       (CL:SETQ ITER-000 (%%REST ITER-000))))
   ...
   (CL:IF (STRING-EQUAL? NAME "STELLA") (CL:SETQ TEST-VALUE-000 CL:T)
    (CL:LET* ((FOUND?-000 CL:NIL))
     (CL:LET* ((SYS NULL) (ITER-000 (%THE-CONS-LIST *SYSTEMDEFINITIONS*)))
      (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-000 NIL)) DO (CL:SETQ SYS (%%VALUE ITER-000))
       (CL:WHEN
        (CL:AND (STRING-EQUAL? (%NAME SYS) NAME)
         (CL:OR (%LOADED? SYS) (SYSTEM-STARTED-UP? (%NAME SYS) (%CARDINAL-MODULE SYS))))
...
wants to have it reloaded from the standard location in the file system."
  ...
  (CL:IF (CL:EQ NAME STELLA::NULL-STRING) (CL:SETQ *SYSTEMDEFINITIONS* (NEW-LIST))
   (CL:LET* ((VALUE-000 NULL))
    (CL:LET* ((S NULL) (ITER-000 (%THE-CONS-LIST *SYSTEMDEFINITIONS*)))
     (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-000 NIL)) DO (CL:SETQ S (%%VALUE ITER-000))
      (CL:WHEN (STRING-EQL? (%NAME S) NAME) (CL:SETQ VALUE-000 S) (CL:RETURN)) (CL:SETQ ITER-000 (%%REST ITER-000))))
...
(CL:DEFUN LOAD-PREPROCESSED-FILES (SYSTEMNAME)
  ...
  #+MCL
  (CL:CHECK-TYPE SYSTEMNAME CL:SIMPLE-STRING)
  (CL:WHEN (CL:OR (CL:NOT (RUNNING-AS-LISP?)) (CL:EQ (%PREPROCESSED-FILES (GET-SYSTEM-DEFINITION SYSTEMNAME)) NULL))
      ...
      (CL:LET* ((PREPROCESSEDFILES NIL))
       (CL:LET* ((F NULL) (ITER-000 (%PREPROCESSED-FILES *CURRENTSYSTEMDEFINITION*)) (COLLECT-000 NULL))
        (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-000 NIL)) DO (CL:SETQ F (%%VALUE ITER-000))
         (CL:IF (CL:EQ COLLECT-000 NULL)
          (CL:PROGN
           (CL:SETQ COLLECT-000 (CONS (WRAP-STRING (MAKE-FILE-NAME (%WRAPPER-VALUE F) KWD-SYSTEMS-STELLA CL:T)) NIL))
           (CL:IF (CL:EQ PREPROCESSEDFILES NIL) (CL:SETQ PREPROCESSEDFILES COLLECT-000)
            (ADD-CONS-TO-END-OF-CONS-LIST PREPROCESSEDFILES COLLECT-000)))
          (CL:PROGN
           (CL:SETF (%%REST COLLECT-000)
            (CONS (WRAP-STRING (MAKE-FILE-NAME (%WRAPPER-VALUE F) KWD-SYSTEMS-STELLA CL:T)) NIL))
           (CL:SETQ COLLECT-000 (%%REST COLLECT-000))))
         (CL:SETQ ITER-000 (%%REST ITER-000))))
       (CL:LET* ((*CURRENT-STELLA-FEATURES* (COPY *CURRENT-STELLA-FEATURES*)))
        ...
        (CL:LET* ((F NULL) (ITER-001 PREPROCESSEDFILES))
         (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-001 NIL)) DO (CL:SETQ F (%%VALUE ITER-001))
          (TRANSLATE-FILE (%WRAPPER-VALUE F) *TRANSLATOROUTPUTLANGUAGE* CL:NIL) (CL:SETQ ITER-001 (%%REST ITER-001)))))
       ...
       (CL:WHEN (MEMB? *CURRENT-STELLA-FEATURES* KWD-SYSTEMS-USE-COMMON-LISP-STRUCTS)
        (CL:LET* ((F NULL) (ITER-002 (%PREPROCESSED-FILES *CURRENTSYSTEMDEFINITION*)))
         (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-002 NIL)) DO (CL:SETQ F (%%VALUE ITER-002))
          (DELETE-FILE (MAKE-FILE-NAME (%WRAPPER-VALUE F) KWD-SYSTEMS-LISP CL:T))
          (CL:SETQ ITER-002 (%%REST ITER-002)))))
       (CL:LET*
        ((STARTUPFN NULL) (ITER-003 (STARTUP-NAMES-FROM-FILES (%PREPROCESSED-FILES *CURRENTSYSTEMDEFINITION*))))
        (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-003 NIL)) DO (CL:SETQ STARTUPFN (%%VALUE ITER-003))
         (CL:funcall (lispify startupFn)) (CL:SETQ ITER-003 (%%REST ITER-003))))))
     ...
     (CL:IF (CL:NOT (CL:EQ *CURRENTSYSTEMDEFINITION* NULL))
      (CL:PROGN
       (CL:WHEN (%LOADED? *CURRENTSYSTEMDEFINITION*)
        (%%PRINT-STREAM (%NATIVE-STREAM STANDARD-OUTPUT) "Loading system `" SYSTEMNAME "' over top of itself." EOL
         EOL))
       (CL:WHEN (RUNNING-AS-LISP?)
        (CL:SETQ TRANSLATEDFILE?
         (COMPILE-AND-LOAD-FILES (FILES-PLUS-SYSTEM-STARTUP (SYSTEM-DEFINITION-NATIVE-FILES *CURRENTSYSTEMDEFINITION*))
          LANGUAGE FORCERECOMPILATION?)))
       (CL:SETF (%LOADED? *CURRENTSYSTEMDEFINITION*) CL:T)
       (CL:WHEN STARTUPSYSTEM? (RUN-SYSTEM-STARTUP-FUNCTION *CURRENTSYSTEMDEFINITION*)))
      (CL:WARN "Can't find a system named `~A'~%" SYSTEMNAME)))
...
(CL:DEFUN LOAD-SYSTEM-EVALUATOR-WRAPPER (ARGUMENTS)
  (CL:RETURN-FROM LOAD-SYSTEM-EVALUATOR-WRAPPER
   (CL:IF (%LOAD-SYSTEM (%WRAPPER-VALUE (%%VALUE ARGUMENTS)) (%%REST ARGUMENTS)) TRUE-WRAPPER FALSE-WRAPPER)))
...
(CL:DEFUN COMPILE-AND-LOAD-FILES (FILES LANGUAGE FORCERECOMPILATION?)
  (CL:COND
   ((CL:EQ LANGUAGE KWD-SYSTEMS-COMMON-LISP)
    (CL:RETURN-FROM COMPILE-AND-LOAD-FILES (CL-COMPILE-AND-LOAD-FILES FILES CL:T FORCERECOMPILATION?)))
   (CL:T (%%PRINT-STREAM (%NATIVE-STREAM STANDARD-OUTPUT) "'compile-and-load-files' NOT IMPLEMENTED FOR " LANGUAGE EOL)
...
(CL:DEFUN SYSTEM-STARTUP-FUNCTION-SYMBOL (SYSTEM)
  (CL:RETURN-FROM SYSTEM-STARTUP-FUNCTION-SYMBOL
   (INTERN-SYMBOL-IN-MODULE (SYSTEM-STARTUP-FUNCTION-NAME SYSTEM) (GET-CARDINAL-MODULE SYSTEM) CL:T)))
...
(CL:DEFUN STARTUP-NAME-FROM-FILE (FILE)
  (CL:WHEN (CL:NOT (PROBE-FILE? (MAKE-FILE-NAME FILE KWD-SYSTEMS-STELLA CL:T)))
   (CL:LET* ((STREAM-000 (NEW-OUTPUT-STRING-STREAM)))
    (%%PRINT-STREAM (%NATIVE-STREAM STREAM-000) "STELLA source file `" (MAKE-FILE-NAME FILE KWD-SYSTEMS-STELLA CL:T)
     "' does not exist")
    (CL:ERROR (NEW-STELLA-EXCEPTION (THE-STRING-READER STREAM-000)))))
  (CL:LET*
   ((LONGNAME (MAKE-FILE-NAME FILE KWD-SYSTEMS-STELLA CL:T)) (SAVEDMODULE *MODULE*) (SEENINMODULE? CL:NIL)
    (UNUSED? CL:NIL) (STARTUPFNNAME NULL))
       ...
       (CL:LET* ((TREE NULL) (ITER-000 (S-EXPRESSIONS INPUTSTREAM)))
        (CL:LOOP WHILE (NEXT? ITER-000) DO (CL:SETQ TREE (%VALUE ITER-000))
         (CL:LET* ((*TRANSIENTOBJECTS?* CL:NIL)) (CL:DECLARE (CL:SPECIAL *TRANSIENTOBJECTS?*))
          (CL:COND
           ((CL:EQ (SAFE-PRIMARY-TYPE TREE) SGT-SYSTEMS-STELLA-CONS)
            (CL:PROGN (CL:MULTIPLE-VALUE-SETQ (UNUSED? SEENINMODULE?) (HANDLE-IN-MODULE-TREE TREE SEENINMODULE? CL:T))
             (CL:SETQ UNUSED? UNUSED?)
             (CL:WHEN SEENINMODULE? (CL:SETQ STARTUPFNNAME (YIELD-STARTUP-FUNCTION-NAME FILE))
              (CHANGE-MODULE SAVEDMODULE) (CL:RETURN-FROM STARTUP-NAME-FROM-FILE STARTUPFNNAME))))
           (CL:T)))))))
   ...
   (CL:LET* ((F NULL) (ITER-000 FILES) (COLLECT-000 NULL))
    (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-000 NIL)) DO (CL:SETQ F (%%VALUE ITER-000))
     (CL:IF (CL:EQ COLLECT-000 NULL)
      ...
      (CL:PROGN (CL:SETF (%%REST COLLECT-000) (CONS (STARTUP-NAME-FROM-FILE (%WRAPPER-VALUE F)) NIL))
       (CL:SETQ COLLECT-000 (%%REST COLLECT-000))))
     (CL:SETQ ITER-000 (%%REST ITER-000))))
...
(CL:DEFUN SYSTEM-STARTUP-FILE-NAME (SYSTEM)
  ...
  (CL:IF (CL:NOT (CL:EQ SYSTEM NULL)) (CL:RETURN-FROM SYSTEM-STARTUP-FILE-NAME "startup-system")
...
(CL:DEFUN SYSTEM-STARTED-UP? (SYSTEMNAME SYSTEMMODULENAME)
  ...
  (CL:WHEN (STRING-EQUAL? SYSTEMNAME "STELLA")
   (CL:RETURN-FROM SYSTEM-STARTED-UP? (CL:NOT (CL:EQ *FUNCTION-LOOKUP-TABLE* NULL))))
  ...
  (CL:LET*
   ((STARTUPFUNCTIONSYMBOL
     (LOOKUP-SYMBOL-IN-MODULE (SYSTEM-STARTUP-FUNCTION-NAME SYSTEMNAME) (GET-STELLA-MODULE SYSTEMMODULENAME CL:NIL)
      CL:T))
   ...
   (CL:RETURN-FROM SYSTEM-STARTED-UP?
    (CL:AND (CL:NOT (CL:EQ STARTUPFUNCTION NULL)) (CL:NOT (CL:EQ (%FUNCTION-CODE STARTUPFUNCTION) NULL))))))
...
(CL:DEFUN YIELD-STARTUP-REQUIRED-SYSTEMS (SYSTEM)
  (CL:LET* ((STARTUPFORMS NIL))
        ...
        (CONS
         (LIST* SYM-SYSTEMS-STELLA-UNLESS
          (LIST* SYM-SYSTEMS-STELLA-SYSTEM-STARTED-UP? SYSTEMNAME
           (CONS
            (WRAP-STRING (%MODULE-FULL-NAME (GET-CARDINAL-MODULE (GET-SYSTEM-DEFINITION (%WRAPPER-VALUE SYSTEMNAME)))))
            NIL))
   ...
   (CL:RETURN-FROM YIELD-STARTUP-REQUIRED-SYSTEMS
    (LIST* SYM-SYSTEMS-STELLA-STARTUP-TIME-PROGN KWD-SYSTEMS-EARLY-INITS (CONCATENATE STARTUPFORMS NIL)))))

;;; (DEFUN (COLLECT-STARTUP-FORMS-FROM-SYSTEM-FILE (CONS OF CONS)) ...)

(CL:DEFUN COLLECT-STARTUP-FORMS-FROM-SYSTEM-FILE (SYSTEM)
  (CL:LET*
   ((SYSTEMFILENAME (MAKE-SYSTEM-DEFINITION-FILE-NAME (%NAME SYSTEM))) (MODULE NULL) (STARTUPFORM NULL)
    (STARTUPFORMS NIL))
   (CL:LET* ((*MODULE* *MODULE*) (*CONTEXT* *MODULE*)) (CL:DECLARE (CL:SPECIAL *MODULE* *CONTEXT*))
    (CL:LET* ((INPUTSTREAM NULL))
     (CL:UNWIND-PROTECT
            ...
            (CL:PROGN
             (CL:WHEN (CL:EQ (%%VALUE TREE) SYM-SYSTEMS-STELLA-DEFMODULE) (%EVALUATE TREE)
              ...
              (CL:WHEN (CL:NOT (CL:EQ MODULE NULL))
               (CL:SETQ STARTUPFORM
                (LIST* SYM-SYSTEMS-STELLA-STARTUP-TIME-PROGN KWD-SYSTEMS-MODULES (YIELD-DEFINE-MODULE MODULE) NIL))))
...
(CL:DEFUN CREATE-SYSTEM-STARTUP-FILE (SYSTEM)
  (CL:WHEN (CL:EQ *CURRENTSYSTEMDEFINITION* NULL)
   (%%PRINT-STREAM (%NATIVE-STREAM STANDARD-OUTPUT) "Must be within a system environment to create startup file " EOL
  ...
  (CL:LET* ((*MODULE* (GET-CARDINAL-MODULE SYSTEM)) (*CONTEXT* *MODULE*)) (CL:DECLARE (CL:SPECIAL *MODULE* *CONTEXT*))
   (CL:LET*
    ((FILE (MAKE-FILE-NAME (SYSTEM-STARTUP-FILE-NAME SYSTEM) KWD-SYSTEMS-STELLA CL:T)) (STARTUPFNNAMES NIL)
     (STARTUPFORMS NIL))
     ...
     (CL:UNWIND-PROTECT
      (CL:PROGN (CL:SETQ OUTPUTSTREAM (OPEN-OUTPUT-FILE FILE))
       ...
       (CL:SETQ STARTUPFORMS
        (CONS (LIST* SYM-SYSTEMS-STELLA-IN-MODULE (WRAP-STRING (%MODULE-FULL-NAME (GET-CARDINAL-MODULE SYSTEM))) NIL)
         STARTUPFORMS))
       (CL:SETQ STARTUPFORMS
        (CONS
         ...
         (CL:SETQ STARTUPFORMS
          (CONS
           (LIST* SYM-SYSTEMS-STELLA-STARTUP-TIME-PROGN KWD-SYSTEMS-EARLY-INITS
            (LIST* SYM-SYSTEMS-STELLA-UNLESS
             (LIST* SYM-SYSTEMS-STELLA-SYSTEM-STARTED-UP? (WRAP-STRING "stella") (WRAP-STRING "/STELLA") NIL)
             (LIST* SYM-SYSTEMS-STELLA-STARTUP SYM-SYSTEMS-STELLA-FALSE NIL) NIL)
            NIL)
           STARTUPFORMS)))
        (CL:T
         (CL:WHEN (CL:NOT (CL:EQ (%REQUIRED-SYSTEMS SYSTEM) NULL))
          (CL:SETQ STARTUPFORMS (CONS (YIELD-STARTUP-REQUIRED-SYSTEMS SYSTEM) STARTUPFORMS)))
         (CL:LET* ((FORM NULL) (ITER-001 (COLLECT-STARTUP-FORMS-FROM-SYSTEM-FILE SYSTEM)))
          (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-001 NIL)) DO (CL:SETQ FORM (%%VALUE ITER-001))
           (CL:SETQ STARTUPFORMS (CONS FORM STARTUPFORMS)) (CL:SETQ ITER-001 (%%REST ITER-001))))
           ...
           (CL:WHEN (CL:EQ (LOOKUP-FUNCTION STARTUPFN) NULL)
            (CL:LET* ((*MODULE* (HOME-MODULE STARTUPFN)) (*CONTEXT* *MODULE*))
             ...
             (DEFINE-METHOD-FROM-PARSE-TREE
              (LIST* SYM-SYSTEMS-STELLA-DEFUN STARTUPFN (LIST* NIL KWD-SYSTEMS-PUBLIC? SYM-SYSTEMS-STELLA-TRUE NIL)))))
           (CL:SETQ ITER-002 (%%REST ITER-002))))
          ...
          (CL:LET* ((STARTUPFN NULL) (ITER-003 STARTUPFNNAMES) (COLLECT-001 NULL))
           (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-003 NIL)) DO (CL:SETQ STARTUPFN (%%VALUE ITER-003))
            (CL:IF (CL:EQ COLLECT-001 NULL)
             ...
             (CL:PROGN (CL:SETF (%%REST COLLECT-001) (CONS (CONS STARTUPFN NIL) NIL))
            ...
            (LIST* SYM-SYSTEMS-STELLA-STARTUP-TIME-PROGN
             (LIST* SYM-SYSTEMS-STELLA-FOREACH SYM-SYSTEMS-STELLA-PHASE SYM-SYSTEMS-STELLA-IN
              (LIST* SYM-SYSTEMS-STELLA-INTERVAL
               (LIST* SYM-SYSTEMS-STELLA-PHASE-TO-INTEGER KWD-SYSTEMS-EARLY-INITS NIL)
               (LIST* SYM-SYSTEMS-STELLA-PHASE-TO-INTEGER KWD-SYSTEMS-FINAL NIL) NIL)
              SYM-SYSTEMS-STELLA-DO
              (LIST* SYM-SYSTEMS-STELLA-SETQ SYM-SYSTEMS-STELLA-*STARTUP-TIME-PHASE* SYM-SYSTEMS-STELLA-PHASE NIL)
       ...
       (CL:LET* ((*PRINTREADABLY?* CL:T) (*PRINTPRETTY?* CL:T))
        ...
        (CL:LET* ((FORM NULL) (ITER-004 (REVERSE STARTUPFORMS)))
         (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-004 NIL)) DO (CL:SETQ FORM (%%VALUE ITER-004))
          (%%PRINT-STREAM (%NATIVE-STREAM OUTPUTSTREAM) FORM EOL EOL) (CL:SETQ ITER-004 (%%REST ITER-004))))))
...
(CL:DEFUN HELP-ALL-REQUIRED-SYSTEMS (SYSTEM-NAME FOUND)
  ...
  (CL:LET* ((SYSTEM (GET-SYSTEM-DEFINITION SYSTEM-NAME)))
   (CL:WHEN (CL:EQ SYSTEM NULL)
    (CL:LET* ((STREAM-000 (NEW-OUTPUT-STRING-STREAM)))
     (%%PRINT-STREAM (%NATIVE-STREAM STREAM-000) "Couldn't find system `" SYSTEM-NAME "'")
     (CL:ERROR (NEW-STELLA-EXCEPTION (THE-STRING-READER STREAM-000)))))
   (CL:LET* ((REQUIRED-SYSTEM-NAMES (%REQUIRED-SYSTEMS SYSTEM)))
    (CL:WHEN (CL:NOT (CL:EQ REQUIRED-SYSTEM-NAMES NULL))
     (CL:LET* ((SYS NULL) (ITER-000 REQUIRED-SYSTEM-NAMES))
      (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-000 NIL)) DO (CL:SETQ SYS (%%VALUE ITER-000))
       (CL:WHEN (CL:NOT (MEMBER? FOUND SYS)) (HELP-ALL-REQUIRED-SYSTEMS (%WRAPPER-VALUE SYS) FOUND) (PUSH FOUND SYS))
       (CL:SETQ ITER-000 (%%REST ITER-000)))))
...
and `error?' is true, raise an error.  Otherwise, simply return NULL."
  ...
  (CL:LET* ((FUNCTION NULL))
   (CL:WHEN (CL:NOT (CL:EQ CACHE NULL))
    (CL:LET* ((FUNCTIONWRAPPER (%SURROGATE-VALUE CACHE)))
     (CL:WHEN (CL:NOT (CL:EQ FUNCTIONWRAPPER NULL)) (CL:RETURN-FROM AUTOLOAD (%WRAPPER-VALUE FUNCTIONWRAPPER)))))
   (CL:HANDLER-CASE
    (CL:LET* ((FUNCTIONNAME STELLA::NULL-STRING) (FUNCTIONMODULENAME STELLA::NULL-STRING) (TYPE NULL))
     ...
     (CL:MULTIPLE-VALUE-SETQ (FUNCTIONNAME FUNCTIONMODULENAME TYPE) (PARSE-STELLA-NAME QUALIFIEDNAME CL:NIL))
     (CL:SETQ TYPE TYPE)
     (CL:LET* ((FUNCTIONMODULE NULL) (FUNCTIONNAMESYMBOL NULL) (FUNCTIONOBJECT NULL))
      (CL:WHEN (CL:NOT (CL:EQ FUNCTIONMODULENAME STELLA::NULL-STRING))
       (CL:SETQ FUNCTIONMODULE
        (GET-STELLA-MODULE FUNCTIONMODULENAME (CL:AND ERROR? (CL:EQ SYSTEMNAME STELLA::NULL-STRING)))))
      (CL:WHEN (CL:NOT (CL:EQ FUNCTIONMODULE NULL))
       (CL:SETQ FUNCTIONNAMESYMBOL (LOOKUP-SYMBOL-IN-MODULE FUNCTIONNAME FUNCTIONMODULE CL:NIL)))
    ...
    (STELLA-EXCEPTION (E)
     (CL:WHEN ERROR?
      (CL:IF (CL:NOT (CL:EQ SYSTEMNAME STELLA::NULL-STRING))
       (CL:LET* ((STREAM-000 (NEW-OUTPUT-STRING-STREAM)))
        (%%PRINT-STREAM (%NATIVE-STREAM STREAM-000) "autoload: failed to define `" QUALIFIEDNAME "': `"
         (EXCEPTION-MESSAGE E) "'")
        (CL:ERROR (NEW-STELLA-EXCEPTION (THE-STRING-READER STREAM-000))))
       (CL:ERROR E)))))
   (CL:WHEN (CL:EQ FUNCTION NULL)
    (CL:IF ERROR?
     (CL:LET* ((STREAM-001 (NEW-OUTPUT-STRING-STREAM)))
      (%%PRINT-STREAM (%NATIVE-STREAM STREAM-001) "autoload: failed to define `" QUALIFIEDNAME "'")
      (CL:ERROR (NEW-STELLA-EXCEPTION (THE-STRING-READER STREAM-001))))
     (CL:RETURN-FROM AUTOLOAD NULL)))
   (CL:WHEN (CL:NOT (CL:EQ CACHE NULL)) (CL:SETF (%SURROGATE-VALUE CACHE) (WRAP-FUNCTION-CODE FUNCTION)))
...
(CL:DEFUN MAKE-STELLA (FORCERECOMPILATION?)
  (%MAKE-SYSTEM "STELLA"
   (CONS-LIST KWD-SYSTEMS-COMMON-LISP KWD-SYSTEMS-FORCE-TRANSLATION?
    (CL:IF FORCERECOMPILATION? TRUE-WRAPPER FALSE-WRAPPER) KWD-SYSTEMS-DEVELOPMENT-SETTINGS? FALSE-WRAPPER))
  :VOID)
...
(CL:DEFUN PARSE-CONFIGURATION-FILE-LINE (LINE)
  ...
  (CL:LET*
   ((START 0) (HASHPOS (POSITION LINE #\# 0)) (EQUALPOS (POSITION LINE #\= 0)) (END EQUALPOS)
    (LENGTH (CL:THE CL:FIXNUM (CL:LENGTH LINE))) (PROPERTY STELLA::NULL-STRING) (VALUESTRING STELLA::NULL-STRING)
   ...
   (CL:LET* ((ALWAYS?-000 CL:T))
    (CL:LET*
     ((I NULL-INTEGER) (ITER-000 0)
      (UPPER-BOUND-000 (CL:1- (CL:IF (CL:NOT (CL:= HASHPOS NULL-INTEGER)) HASHPOS LENGTH))))
   ...
   (CL:WHEN (CL:<= END START) (CL:WARN "Illegal property in configuration file: `~A'" LINE)
    (CL:RETURN-FROM PARSE-CONFIGURATION-FILE-LINE (CL:VALUES NULL NULL NULL)))
    ...
    (CL:T
     (CL:HANDLER-CASE
      (CL:LET* ((TEST-VALUE-000 (SAFE-PRIMARY-TYPE (CL:SETQ VALUE (READ-S-EXPRESSION-FROM-STRING VALUESTRING)))))
       (CL:COND
        ((CL:OR (SUBTYPE-OF-INTEGER? TEST-VALUE-000) (SUBTYPE-OF-LONG-INTEGER? TEST-VALUE-000)
          (SUBTYPE-OF-FLOAT? TEST-VALUE-000)))
      ...
      (CL:LET* ((LINE STELLA::NULL-STRING) (ITER-000 (LINES IN))) (CL:DECLARE (CL:TYPE CL:SIMPLE-STRING LINE))
       (CL:LOOP WHILE (NEXT? ITER-000) DO (CL:SETQ LINE (%VALUE ITER-000))
        (CL:LET* ((KEY NULL) (VALUE NULL) (OPERATOR NULL))
         (CL:MULTIPLE-VALUE-SETQ (KEY VALUE OPERATOR) (PARSE-CONFIGURATION-FILE-LINE LINE))
...
(CL:DEFUN LOAD-CONFIGURATION-FILE-EVALUATOR-WRAPPER (ARGUMENTS)
  (CL:RETURN-FROM LOAD-CONFIGURATION-FILE-EVALUATOR-WRAPPER
   (%LOAD-CONFIGURATION-FILE (%WRAPPER-VALUE (%%VALUE ARGUMENTS)))))
...
value."
  (CL:LET* ((TEST-VALUE-000 (SAFE-PRIMARY-TYPE VALUE)))
   (CL:COND
    ((SUBTYPE-OF-STRING? TEST-VALUE-000) (CL:PROGN (%%PRINT-STREAM (%NATIVE-STREAM STREAM) (%WRAPPER-VALUE VALUE))))
    ((SUBTYPE-OF-BOOLEAN? TEST-VALUE-000)
     (CL:PROGN
      (CL:IF (CL:EQ VALUE TRUE-WRAPPER) (%%PRINT-STREAM (%NATIVE-STREAM STREAM) "true")
       (%%PRINT-STREAM (%NATIVE-STREAM STREAM) "false"))))
    ((SUBTYPE-OF-INTEGER? TEST-VALUE-000)
     (CL:PROGN (%%PRINT-STREAM (%NATIVE-STREAM STREAM) (INTEGER-TO-STRING (CL:TRUNCATE (%WRAPPER-VALUE VALUE))))))
    ((SUBTYPE-OF-LONG-INTEGER? TEST-VALUE-000)
     (CL:PROGN (%%PRINT-STREAM (%NATIVE-STREAM STREAM) (INTEGER-TO-STRING (%WRAPPER-VALUE VALUE)))))
    ((SUBTYPE-OF-FLOAT? TEST-VALUE-000)
     (CL:PROGN (%%PRINT-STREAM (%NATIVE-STREAM STREAM) (FLOAT-TO-STRING (%WRAPPER-VALUE VALUE)))))
    (CL:T
   ...
   (CL:LET* ((OUT NULL))
    (CL:UNWIND-PROTECT
     (CL:PROGN (CL:SETQ OUT (OPEN-OUTPUT-FILE FILE))
      (CL:WHEN (CL:NOT (CL:EQ TITLE STELLA::NULL-STRING)) (%%PRINT-STREAM (%NATIVE-STREAM OUT) "# " TITLE EOL))
          ...
          (CL:PROGN
           (CL:LET* ((V NULL) (ITER-001 VALUE))
            (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-001 NIL)) DO (CL:SETQ V (%%VALUE ITER-001))
             (%%PRINT-STREAM (%NATIVE-STREAM OUT) (UNWRAP-STRING KEY) " +=") (SAVE-CONFIGURATION-VALUE OUT V)
             (%%PRINT-STREAM (%NATIVE-STREAM OUT) EOL) (CL:SETQ ITER-001 (%%REST ITER-001))))))
         (CL:T (%%PRINT-STREAM (%NATIVE-STREAM OUT) (UNWRAP-STRING KEY) " =") (SAVE-CONFIGURATION-VALUE OUT VALUE)
          (%%PRINT-STREAM (%NATIVE-STREAM OUT) EOL)))
        (CL:SETQ ITER-000 (%REST ITER-000)))))
...
`defaultValue' if `property' is not defined."
  ...
  (CL:LET* ((VALUE (LOOKUP CONFIGURATION (WRAP-STRING PROPERTY))))
   (CL:IF (CL:NOT (CL:EQ VALUE NULL)) (CL:RETURN-FROM LOOKUP-CONFIGURATION-PROPERTY VALUE)
...
Use the global system configuration table if `configuration' is NULL."
  ...
  (CL:LET* ((TEMP-000 (LOOKUP CONFIGURATION (WRAP-STRING PROPERTY))))
   (INSERT-AT CONFIGURATION (WRAP-STRING PROPERTY)
    (CONCATENATE (CONSIFY (CL:IF (CL:NOT (CL:EQ TEMP-000 NULL)) TEMP-000 NIL)) (CONS VALUE NIL))))
...
Use the global system configuration table if `configuration' is NULL."
  ...
  (CL:LET* ((CURRENT-VALUE (LOOKUP CONFIGURATION (WRAP-STRING PROPERTY))))
   ...
   (RUN-CONFIGURATION-PROPERTY-DEMON KWD-SYSTEMS-CLEAR PROPERTY CURRENT-VALUE CONFIGURATION)
...
Use the global system configuration table if `configuration' is NULL."
  ...
  (CL:LET* ((CURRENT-VALUE (LOOKUP CONFIGURATION (WRAP-STRING PROPERTY))))
   (CL:WHEN (CL:NOT (CL:EQ CURRENT-VALUE NULL))
    (INSERT-AT CONFIGURATION (WRAP-STRING PROPERTY) (REMOVE CURRENT-VALUE VALUE)))
   (RUN-CONFIGURATION-PROPERTY-DEMON KWD-SYSTEMS-REMOVE PROPERTY VALUE CONFIGURATION)
  ...
  (CL:LET* ((*PRINTREADABLY?* CL:T)) (CL:DECLARE (CL:SPECIAL *PRINTREADABLY?*))
   (CL:LET* ((ENTRY NULL) (ITER-000 (SORT-TUPLES (CONSIFY CONFIGURATION) 0 NULL)))
    (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-000 NIL)) DO (CL:SETQ ENTRY (%%VALUE ITER-000))
     (%%PRINT-STREAM (%NATIVE-STREAM STREAM) (UNWRAP-STRING (%%VALUE ENTRY)) " = ")
     (CL:IF (STRING? (%%VALUE (%%REST ENTRY)))
      (%%PRINT-STREAM (%NATIVE-STREAM STREAM) (UNWRAP-STRING (%%VALUE (%%REST ENTRY))) EOL)
...
configuration file `file' first which should be supplied with a physical pathname."
  (CL:WHEN
   (CL:AND (CL:NOT (CL:EQ FILE STELLA::NULL-STRING))
    (CL:NOT (CL:EQ (FIND-FILE-IN-LOAD-PATH FILE NULL) STELLA::NULL-STRING)))
...
sensitive module."
  (CL:LET* ((KEY (COERCE-TO-STRING PROPERTY)) (DEFAULT (%%VALUE DEFAULTVALUE)))
...
a non-case-sensitive module."
  (CL:LET* ((KEY (COERCE-TO-STRING PROPERTY))) (CL:DECLARE (CL:TYPE CL:SIMPLE-STRING KEY))
...
property `stella.test.propertyDemon' to see a test demon in action."
  ...
  (CL:LET* ((DEMON (LOOKUP-FUNCTION DEMONNAME)))
   (CL:WHEN (CL:EQ DEMON NULL) (CL:SETQ DEMON (LOOKUP-GLOBAL-VARIABLE DEMONNAME)))
   (CL:IF (CL:NOT (CL:EQ DEMON NULL)) (INSERT-AT *REGISTERED-PROPERTY-DEMONS* (WRAP-STRING PROPERTY) DEMON)
    (CL:LET* ((STREAM-000 (NEW-OUTPUT-STRING-STREAM)))
     (%%PRINT-STREAM (%NATIVE-STREAM STREAM-000)
      "register-property-demon: cannot find a function or variable with this name: `" DEMONNAME "'")
     (CL:ERROR (NEW-STELLA-EXCEPTION (THE-STRING-READER STREAM-000))))))
  :VOID)
...
(CL:DEFUN LOOKUP-VARIABLE-DEMON-SETTER (DEMON)
  (CL:LET*
   ...
   (CL:RETURN-FROM LOOKUP-VARIABLE-DEMON-SETTER (LOOKUP-FUNCTION SETTERNAME))))
   ...
   (CL:LET* ((TEST-VALUE-000 (SAFE-PRIMARY-TYPE DEMON)))
    (CL:COND
     ((SUBTYPE-OF-METHOD-SLOT? TEST-VALUE-000)
      (CL:PROGN (CL:FUNCALL (%FUNCTION-CODE DEMON) ACTION PROPERTY VALUE TABLE)))
      ...
      (CL:PROGN
       (CL:LET* ((SETTER (LOOKUP-VARIABLE-DEMON-SETTER DEMON)))
        (CL:COND
         ((CL:NOT (CL:EQ SETTER NULL)) (CL:SETQ VALUE (LOOKUP-CONFIGURATION-PROPERTY PROPERTY NULL TABLE))
          (CL:LET*
           ...
           (CL:WHEN (CL:AND (CL:NOT (CL:EQ VALUE NULL)) (CL:EQ COERCEDVALUE NULL))
            (CL:WARN "run-configuration-property-demon: cannot coerce `~A' to type `~A'" VALUE VARIABLETYPE)
            (CL:RETURN-FROM RUN-CONFIGURATION-PROPERTY-DEMON))
           (CL:COND
            ((CL:EQ VARIABLETYPE SGT-SYSTEMS-STELLA-INTEGER)
             (CL:FUNCALL (%FUNCTION-CODE SETTER) (UNWRAP-INTEGER COERCEDVALUE)))
            ((CL:EQ VARIABLETYPE SGT-SYSTEMS-STELLA-LONG-INTEGER)
             (CL:FUNCALL (%FUNCTION-CODE SETTER) (UNWRAP-INTEGER COERCEDVALUE)))
            ((CL:EQ VARIABLETYPE SGT-SYSTEMS-STELLA-FLOAT)
             (CL:FUNCALL (%FUNCTION-CODE SETTER) (UNWRAP-FLOAT COERCEDVALUE)))
         ...
         (CL:T
          (CL:WARN "run-configuration-property-demon: cannot find setter function for `~A'"
           (%VARIABLE-NAME DEMON)))))))
     (CL:T))))
  :VOID)
...
(CL:DEFUN TEST-PROPERTY-DEMON (ACTION PROPERTY VALUE TABLE)
  ...
  (CL:CHECK-TYPE PROPERTY CL:SIMPLE-STRING)
  (CL:SETQ TABLE TABLE)
  (%%PRINT-STREAM (%NATIVE-STREAM STANDARD-OUTPUT) "test-property-demon: action=" ACTION ", property=" PROPERTY
   ", value-arg=" VALUE ", prop-value=" (LOOKUP-CONFIGURATION-PROPERTY PROPERTY NULL TABLE) EOL)
  :VOID)
...
(CL:DEFCLASS CMD-LINE-OPTION (STANDARD-OBJECT)
  ((DOCUMENTATION :TYPE CL:SIMPLE-STRING :INITFORM STELLA::NULL-STRING :ALLOCATION :INSTANCE :ACCESSOR %DOCUMENTATION)
   (KEYS :ALLOCATION :INSTANCE :ACCESSOR %KEYS) (VALUE-TYPE :ALLOCATION :INSTANCE :ACCESSOR %VALUE-TYPE)
   (MULTI-VALUED? :ALLOCATION :INSTANCE :ACCESSOR %MULTI-VALUED?)
   (N-ARGUMENTS :TYPE CL:FIXNUM :INITFORM NULL-INTEGER :DOCUMENTATION "The number of args expected by this option.
Common values are 0 or 1, but certain options might take more than one argument." :ALLOCATION :INSTANCE :ACCESSOR
    %N-ARGUMENTS)
...
Defaults to TRUE for 0-arg options with boolean value type." :ALLOCATION :INSTANCE :ACCESSOR %DEFAULT-VALUE)
   (CONFIGURATION-PROPERTY :TYPE CL:SIMPLE-STRING :INITFORM STELLA::NULL-STRING :ALLOCATION :INSTANCE :ACCESSOR
    %CONFIGURATION-PROPERTY)
   (HANDLER :ALLOCATION :INSTANCE :ACCESSOR %HANDLER)
   (ERROR-ACTION :DOCUMENTATION "One of :ignore, :warn, :error." :ALLOCATION :INSTANCE :ACCESSOR %ERROR-ACTION)))

(CL:DEFUN NEW-CMD-LINE-OPTION ()
  (CL:LET* ((SELF NULL)) (CL:SETQ SELF (CL:MAKE-INSTANCE (CL:QUOTE CMD-LINE-OPTION)))
   (CL:SETF (%ERROR-ACTION SELF) KWD-SYSTEMS-ERROR)
   (CL:SETF (%HANDLER SELF) (CL:FUNCTION DEFAULT-CMD-LINE-OPTION-HANDLER))
   (CL:SETF (%CONFIGURATION-PROPERTY SELF) STELLA::NULL-STRING) (CL:SETF (%DEFAULT-VALUE SELF) NULL)
   (CL:SETF (%N-ARGUMENTS SELF) 0) (CL:SETF (%MULTI-VALUED? SELF) CL:NIL)
   (CL:SETF (%VALUE-TYPE SELF) SGT-SYSTEMS-STELLA-STRING) (CL:SETF (%KEYS SELF) NIL)
   (CL:SETF (%DOCUMENTATION SELF) "Not documented.") (CL:RETURN-FROM NEW-CMD-LINE-OPTION SELF)))
...
(CL:DEFUN ACCESS-CMD-LINE-OPTION-SLOT-VALUE (SELF SLOTNAME VALUE SETVALUE?)
  (CL:COND
   ...
   ((CL:EQ SLOTNAME SYM-SYSTEMS-STELLA-KEYS)
    (CL:IF SETVALUE? (CL:SETF (%KEYS SELF) VALUE) (CL:SETQ VALUE (%KEYS SELF))))
   ((CL:EQ SLOTNAME SYM-SYSTEMS-STELLA-VALUE-TYPE)
    (CL:IF SETVALUE? (CL:SETF (%VALUE-TYPE SELF) VALUE) (CL:SETQ VALUE (%VALUE-TYPE SELF))))
   ((CL:EQ SLOTNAME SYM-SYSTEMS-STELLA-MULTI-VALUED?)
    (CL:IF SETVALUE? (CL:SETF (%MULTI-VALUED? SELF) (COERCE-WRAPPED-BOOLEAN-TO-BOOLEAN VALUE))
     (CL:SETQ VALUE (CL:IF (%MULTI-VALUED? SELF) TRUE-WRAPPER FALSE-WRAPPER))))
   ((CL:EQ SLOTNAME SYM-SYSTEMS-STELLA-N-ARGUMENTS)
    (CL:IF SETVALUE? (CL:SETF (%N-ARGUMENTS SELF) (%WRAPPER-VALUE VALUE))
     (CL:SETQ VALUE (WRAP-INTEGER (%N-ARGUMENTS SELF)))))
   ((CL:EQ SLOTNAME SYM-SYSTEMS-STELLA-DEFAULT-VALUE)
    (CL:IF SETVALUE? (CL:SETF (%DEFAULT-VALUE SELF) VALUE) (CL:SETQ VALUE (%DEFAULT-VALUE SELF))))
   ((CL:EQ SLOTNAME SYM-SYSTEMS-STELLA-CONFIGURATION-PROPERTY)
    (CL:IF SETVALUE? (CL:SETF (%CONFIGURATION-PROPERTY SELF) (%WRAPPER-VALUE VALUE))
     (CL:SETQ VALUE (WRAP-STRING (%CONFIGURATION-PROPERTY SELF)))))
   ((CL:EQ SLOTNAME SYM-SYSTEMS-STELLA-HANDLER)
    (CL:IF SETVALUE? (CL:SETF (%HANDLER SELF) (%WRAPPER-VALUE VALUE))
     (CL:SETQ VALUE (WRAP-FUNCTION-CODE (%HANDLER SELF)))))
   ((CL:EQ SLOTNAME SYM-SYSTEMS-STELLA-ERROR-ACTION)
    (CL:IF SETVALUE? (CL:SETF (%ERROR-ACTION SELF) VALUE) (CL:SETQ VALUE (%ERROR-ACTION SELF))))
   (CL:T
    (CL:LET* ((STREAM-000 (NEW-OUTPUT-STRING-STREAM)))
   ...
   (CL:LET*
    ((THEOPTIONS
      (PARSE-OPTIONS ARGLIST-000
       (LIST* KWD-SYSTEMS-DOCUMENTATION SGT-SYSTEMS-STELLA-STRING KWD-SYSTEMS-KEY SGT-SYSTEMS-STELLA-STRING
        KWD-SYSTEMS-KEY2 SGT-SYSTEMS-STELLA-STRING KWD-SYSTEMS-KEY3 SGT-SYSTEMS-STELLA-STRING KWD-SYSTEMS-KEYS
        SGT-SYSTEMS-STELLA-CONS KWD-SYSTEMS-VALUE-TYPE SGT-SYSTEMS-STELLA-TYPE KWD-SYSTEMS-MULTI-VALUED?
        SGT-SYSTEMS-STELLA-BOOLEAN KWD-SYSTEMS-N-ARGUMENTS SGT-SYSTEMS-STELLA-INTEGER KWD-SYSTEMS-DEFAULT-VALUE
        SGT-SYSTEMS-STELLA-OBJECT KWD-SYSTEMS-PROPERTY SGT-SYSTEMS-STELLA-STRING KWD-SYSTEMS-HANDLER
        SGT-SYSTEMS-STELLA-SYMBOL KWD-SYSTEMS-ERROR-ACTION SGT-SYSTEMS-STELLA-KEYWORD NIL)
       CL:T CL:NIL))
     (CMDLINEOPTION (NEW-CMD-LINE-OPTION)) (VALUE NULL))
    (CL:SETF (%DOCUMENTATION CMDLINEOPTION)
     (%WRAPPER-VALUE (LOOKUP-WITH-DEFAULT THEOPTIONS KWD-SYSTEMS-DOCUMENTATION (WRAP-STRING "Not documented."))))
    (CL:SETQ VALUE (LOOKUP THEOPTIONS KWD-SYSTEMS-KEY))
    (CL:WHEN (CL:NOT (CL:EQ VALUE NULL)) (CL:SETF (%KEYS CMDLINEOPTION) (CONS VALUE (%KEYS CMDLINEOPTION))))
    ...
    (CL:LET* ((VAL NULL) (ITER-001 (LOOKUP-WITH-DEFAULT THEOPTIONS KWD-SYSTEMS-KEYS NIL)))
     (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-001 NIL)) DO (CL:SETQ VAL (%%VALUE ITER-001))
      (CL:SETQ VALUE (COERCE-VALUE-TO-TYPE VAL SGT-SYSTEMS-STELLA-STRING CL:T))
    ...
    (CL:SETF (%VALUE-TYPE CMDLINEOPTION)
     (LOOKUP-WITH-DEFAULT THEOPTIONS KWD-SYSTEMS-VALUE-TYPE SGT-SYSTEMS-STELLA-STRING))
    (CL:SETF (%MULTI-VALUED? CMDLINEOPTION)
     (COERCE-WRAPPED-BOOLEAN-TO-BOOLEAN (LOOKUP-WITH-DEFAULT THEOPTIONS KWD-SYSTEMS-MULTI-VALUED? FALSE-WRAPPER)))
    (CL:SETF (%N-ARGUMENTS CMDLINEOPTION)
     (%WRAPPER-VALUE (LOOKUP-WITH-DEFAULT THEOPTIONS KWD-SYSTEMS-N-ARGUMENTS (WRAP-INTEGER 0))))
    (CL:SETF (%DEFAULT-VALUE CMDLINEOPTION) (LOOKUP THEOPTIONS KWD-SYSTEMS-DEFAULT-VALUE))
    (CL:SETF (%CONFIGURATION-PROPERTY CMDLINEOPTION)
     (%WRAPPER-VALUE (LOOKUP-WITH-DEFAULT THEOPTIONS KWD-SYSTEMS-PROPERTY NULL-STRING-WRAPPER)))
    ...
    (CL:WHEN (CL:NOT (CL:EQ VALUE NULL)) (CL:SETQ VALUE (LOOKUP-FUNCTION VALUE))
     (CL:WHEN (CL:EQ VALUE NULL)
      (CL:LET* ((STREAM-000 (NEW-OUTPUT-STRING-STREAM)))
       (%%PRINT-STREAM (%NATIVE-STREAM STREAM-000) "register-cmd-line-option: cannot find handler function: `"
    ...
    (CL:LET* ((KEY NULL) (ITER-002 (%KEYS CMDLINEOPTION)))
     (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-002 NIL)) DO (CL:SETQ KEY (%%VALUE ITER-002))
      (INSERT-AT *REGISTERED-COMMAND-LINE-OPTIONS* KEY CMDLINEOPTION) (CL:SETQ ITER-002 (%%REST ITER-002))))))
  :VOID)
  ...
  (CL:LET* ((CMDLINEOPTION (LOOKUP *REGISTERED-COMMAND-LINE-OPTIONS* (WRAP-STRING KEY))))
   (CL:WHEN (CL:NOT (CL:EQ CMDLINEOPTION NULL))
    (CL:LET* ((REGISTEREDKEY NULL) (ITER-000 (%KEYS CMDLINEOPTION)))
     (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-000 NIL)) DO (CL:SETQ REGISTEREDKEY (%%VALUE ITER-000))
      (REMOVE-AT *REGISTERED-COMMAND-LINE-OPTIONS* REGISTEREDKEY) (CL:SETQ ITER-000 (%%REST ITER-000))))
...
(CL:DEFUN DEFAULT-CMD-LINE-OPTION-HANDLER (OPTION VALUE)
  ...
  (CL:LET* ((PROPERTY (%CONFIGURATION-PROPERTY OPTION)) (DEFAULTVALUE (%DEFAULT-VALUE OPTION)))
   (CL:DECLARE (CL:TYPE CL:SIMPLE-STRING PROPERTY))
   (CL:WHEN (CL:EQ PROPERTY STELLA::NULL-STRING) (CL:SETQ PROPERTY "")
    (CL:LET* ((KEY NULL) (ITER-000 (%KEYS OPTION)))
     (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-000 NIL)) DO (CL:SETQ KEY (%%VALUE ITER-000))
      (CL:WHEN
       (CL:> (CL:THE CL:FIXNUM (CL:LENGTH (CL:THE CL:SIMPLE-STRING (UNWRAP-STRING KEY))))
        (CL:THE CL:FIXNUM (CL:LENGTH PROPERTY)))
       (CL:SETQ PROPERTY (%WRAPPER-VALUE KEY)))
      (CL:SETQ ITER-000 (%%REST ITER-000)))))
   (CL:WHEN (CL:AND (CL:EQ DEFAULTVALUE NULL) (CL:EQ (%VALUE-TYPE OPTION) SGT-SYSTEMS-STELLA-BOOLEAN))
     ...
     ((CL:EQ (SAFE-PRIMARY-TYPE VALUE) SGT-SYSTEMS-STELLA-CONS)
      (CL:PROGN
       (CL:LET* ((VAL NULL) (ITER-001 VALUE))
        (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-001 NIL)) DO (CL:SETQ VAL (%%VALUE ITER-001))
         (ADD-CONFIGURATION-PROPERTY PROPERTY VAL NULL) (CL:SETQ ITER-001 (%%REST ITER-001))))))
...
accurately reflects the arguments which have been either skipped or not handled yet."
  ...
  (CL:WHEN (CL:EQ *UNPROCESSED-COMMAND-LINE-ARGUMENTS* NULL)
   (CL:SETQ *UNPROCESSED-COMMAND-LINE-ARGUMENTS* (CONSIFY-COMMAND-LINE-ARGUMENTS COUNT ARGUMENTS)))
  (CL:LET*
   ((CMDLINEARGS (COPY-CONS-LIST *UNPROCESSED-COMMAND-LINE-ARGUMENTS*)) (ARGUMENT STELLA::NULL-STRING)
    (NARGS (LENGTH CMDLINEARGS)) (OPTION NULL) (VALUE NULL)
   ...
   (CL:LOOP WHILE (CL:NOT (CL:EQ CMDLINEARGS NIL)) DO
    (CL:TAGBODY
     (CL:LET* ((HEAD-000 (%%VALUE CMDLINEARGS))) (CL:SETQ CMDLINEARGS (%%REST CMDLINEARGS))
      (CL:SETQ ARGUMENT (%WRAPPER-VALUE HEAD-000)))
     (CL:SETQ NARGS (CL:1- NARGS)) (CL:SETQ OPTION (LOOKUP *REGISTERED-COMMAND-LINE-OPTIONS* (WRAP-STRING ARGUMENT)))
     (CL:SETQ VALUE NULL)
     (CL:COND
      ((CL:NOT (CL:EQ OPTION NULL))
        ...
        (CL:LET* ((TEST-VALUE-000 (%ERROR-ACTION OPTION)))
         (CL:COND
          ((CL:EQ TEST-VALUE-000 KWD-SYSTEMS-ERROR)
           (CL:LET* ((STREAM-000 (NEW-OUTPUT-STRING-STREAM)))
            (%%PRINT-STREAM (%NATIVE-STREAM STREAM-000) "process-command-line-arguments: missing value for option: `"
             ARGUMENT "'")
            (CL:ERROR (NEW-STELLA-EXCEPTION (THE-STRING-READER STREAM-000)))))
          ((CL:EQ TEST-VALUE-000 KWD-SYSTEMS-WARN)
           (CL:WARN "process-command-line-arguments: missing value for option: `~A'" ARGUMENT))
       ...
       (CL:CASE (%N-ARGUMENTS OPTION) (0)
        (1
         (CL:LET* ((HEAD-001 (%%VALUE CMDLINEARGS))) (CL:SETQ CMDLINEARGS (%%REST CMDLINEARGS))
          (CL:SETQ VALUE HEAD-001))
         (CL:SETQ NARGS (CL:1- NARGS)))
        (CL:OTHERWISE
         (CL:LET* ((VALUE-000 NIL))
          (CL:LET*
           ((ARG NULL) (ITER-000 CMDLINEARGS) (I NULL-INTEGER) (ITER-001 1) (UPPER-BOUND-000 (%N-ARGUMENTS OPTION))
            (UNBOUNDED?-000 (CL:= UPPER-BOUND-000 NULL-INTEGER)) (COLLECT-000 NULL))
           (CL:DECLARE (CL:TYPE CL:FIXNUM I ITER-001 UPPER-BOUND-000))
           (CL:LOOP WHILE
            (CL:AND (CL:NOT (CL:EQ ITER-000 NIL)) (CL:OR UNBOUNDED?-000 (CL:<= ITER-001 UPPER-BOUND-000))) DO
         ...
         (CL:SETQ CMDLINEARGS (NTH-REST CMDLINEARGS (%N-ARGUMENTS OPTION)))
         (CL:SETQ NARGS (CL:- NARGS (%N-ARGUMENTS OPTION)))))
         ...
         (CL:LET* ((TEST-VALUE-001 (%ERROR-ACTION OPTION)))
          (CL:COND
           ((CL:EQ TEST-VALUE-001 KWD-SYSTEMS-ERROR)
            (CL:LET* ((STREAM-002 (NEW-OUTPUT-STRING-STREAM)))
             (%%PRINT-STREAM (%NATIVE-STREAM STREAM-002) "Error during processing of `" ARGUMENT "' option: `"
              (EXCEPTION-MESSAGE E) "'")
             (CL:ERROR (NEW-STELLA-EXCEPTION (THE-STRING-READER STREAM-002)))))
           ((CL:EQ TEST-VALUE-001 KWD-SYSTEMS-WARN)
            (CL:WARN "Error during processing of `~A' option: `~A'" ARGUMENT (EXCEPTION-MESSAGE E)))
           ((CL:EQ TEST-VALUE-001 KWD-SYSTEMS-IGNORE))
           (CL:T
            (CL:LET* ((STREAM-003 (NEW-OUTPUT-STRING-STREAM)))
             (%%PRINT-STREAM (%NATIVE-STREAM STREAM-003) "`" TEST-VALUE-001 "' is not a valid case option")
     ...
     (CL:WHEN (STARTS-WITH? (UNWRAP-STRING ARG) "-" 0)
      (CL:COND
       ((CL:EQ UNHANDLEDOPTIONACTION KWD-SYSTEMS-WARN)
        (CL:WARN "Unhandled command line option: `~A'" (UNWRAP-STRING ARG)))
       ((CL:EQ UNHANDLEDOPTIONACTION KWD-SYSTEMS-ERROR)
        (CL:LET* ((STREAM-004 (NEW-OUTPUT-STRING-STREAM)))
         (%%PRINT-STREAM (%NATIVE-STREAM STREAM-004) "Unhandled command line option: `" (UNWRAP-STRING ARG) "'")
       ...
       (CL:T
        (CL:LET* ((STREAM-005 (NEW-OUTPUT-STRING-STREAM)))
         (%%PRINT-STREAM (%NATIVE-STREAM STREAM-005) "`" UNHANDLEDOPTIONACTION "' is not a valid case option")
...
to be of the form `(<module-name> <s-expression>)'."
  (CL:COND
   ((CL:EQ (SAFE-PRIMARY-TYPE VALUE) SGT-SYSTEMS-STELLA-CONS)
    (CL:PROGN
     (CL:LET* ((*MODULE* (COERCE-TO-MODULE (%%VALUE VALUE) CL:T)) (*CONTEXT* *MODULE*))
      (CL:DECLARE (CL:SPECIAL *MODULE* *CONTEXT*)) (EVAL-OPTION-HANDLER OPTION (%%VALUE (%%REST VALUE))))))
   (CL:T))
  :VOID)
...
(CL:DEFUN LOAD-PATH-OPTION-HANDLER (OPTION VALUE)
  ...
  (CL:COND ((MEMBER? (%KEYS OPTION) (WRAP-STRING "--path=")) (%SET-LOAD-PATH (%WRAPPER-VALUE VALUE)))
   ((MEMBER? (%KEYS OPTION) (WRAP-STRING "--path=+")) (%ADD-LOAD-PATH (%WRAPPER-VALUE VALUE)))
   (CL:T (%PUSH-LOAD-PATH (%WRAPPER-VALUE VALUE))))
  :VOID)
...
values but leave all other currently set properties as they are."
  ...
  (CL:LET* ((CURRENTCONFIG *SYSTEM-CONFIGURATION-TABLE*))
   (CL:HANDLER-CASE
    (CL:PROGN (CL:SETQ *SYSTEM-CONFIGURATION-TABLE* (COPY CURRENTCONFIG))
     (%LOAD-CONFIGURATION-FILE (%WRAPPER-VALUE VALUE)))
...
(CL:DEFUN DEFINE-PROPERTY-OPTION-HANDLER (OPTION VALUE)
  ...
  (CL:LET* ((PROP NULL) (VAL NULL) (OP NULL))
   (CL:MULTIPLE-VALUE-SETQ (PROP VAL OP) (PARSE-CONFIGURATION-FILE-LINE (%WRAPPER-VALUE VALUE)))
   (CL:IF (CL:EQ OP KWD-SYSTEMS-ADD) (ADD-CONFIGURATION-PROPERTY (%WRAPPER-VALUE PROP) VAL NULL)
    (SET-CONFIGURATION-PROPERTY (%WRAPPER-VALUE PROP) VAL NULL)))
  :VOID)
...
(CL:DEFUN HELP-OPTION-HANDLER (OPTION VALUE)
  ...
  (CL:LET* ((SORTEDOPTIONS NIL))
   (CL:LET*
    ((KEY NULL) (OPTION NULL) (ITER-000 (ALLOCATE-ITERATOR *REGISTERED-COMMAND-LINE-OPTIONS*)) (COLLECT-000 NULL))
    (CL:LOOP WHILE (NEXT? ITER-000) DO (CL:SETQ KEY (%KEY ITER-000)) (CL:SETQ OPTION (%VALUE ITER-000))
     (CL:WHEN (EQL? KEY (%%VALUE (%KEYS OPTION)))
      (CL:LOOP WHILE (STARTS-WITH? (%WRAPPER-VALUE KEY) "-" 0) DO
       (CL:SETQ KEY (WRAP-STRING (SUBSEQUENCE (UNWRAP-STRING KEY) 1 NULL-INTEGER))))
      (CL:SETQ KEY (WRAP-STRING (STRING-DOWNCASE (%WRAPPER-VALUE KEY))))
      (CL:IF (CL:EQ COLLECT-000 NULL)
       (CL:PROGN (CL:SETQ COLLECT-000 (CONS (CONS-LIST KEY OPTION) NIL))
        (CL:IF (CL:EQ SORTEDOPTIONS NIL) (CL:SETQ SORTEDOPTIONS COLLECT-000)
         (ADD-CONS-TO-END-OF-CONS-LIST SORTEDOPTIONS COLLECT-000)))
       (CL:PROGN (CL:SETF (%%REST COLLECT-000) (CONS (CONS-LIST KEY OPTION) NIL))
        (CL:SETQ COLLECT-000 (%%REST COLLECT-000)))))))
   ...
   (CL:WHEN (CL:NOT (BLANK-STRING? *COMMAND-LINE-HELP-HEADER*))
    (%%PRINT-STREAM (%NATIVE-STREAM STANDARD-OUTPUT) *COMMAND-LINE-HELP-HEADER* EOL))
   ...
   (CL:LET* ((TUPLE NULL) (ITER-001 SORTEDOPTIONS))
    (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-001 NIL)) DO (CL:SETQ TUPLE (%%VALUE ITER-001))
     (CL:SETQ OPTION (%%VALUE (%%REST TUPLE)))
     (CL:LET* ((KEY NULL) (ITER-002 (%KEYS OPTION)) (I NULL-INTEGER) (ITER-003 1))
      ...
      (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-002 NIL)) DO (CL:SETQ KEY (%%VALUE ITER-002)) (CL:SETQ I ITER-003)
       (CL:WHEN (CL:> I 1) (%%PRINT-STREAM (%NATIVE-STREAM STANDARD-OUTPUT) ", "))
       (%%PRINT-STREAM (%NATIVE-STREAM STANDARD-OUTPUT) (UNWRAP-STRING KEY)) (CL:SETQ ITER-002 (%%REST ITER-002))
       (CL:SETQ ITER-003 (CL:1+ ITER-003))))
     (%%PRINT-STREAM (%NATIVE-STREAM STANDARD-OUTPUT) " ")
     (%%PRINT-STREAM (%NATIVE-STREAM STANDARD-OUTPUT) (%DOCUMENTATION OPTION) EOL)
     (CL:SETQ ITER-001 (%%REST ITER-001))))
   (CL:WHEN (CL:NOT (BLANK-STRING? *COMMAND-LINE-HELP-TRAILER*))
    (%%PRINT-STREAM (%NATIVE-STREAM STANDARD-OUTPUT) *COMMAND-LINE-HELP-TRAILER* EOL))
...
(CL:DEFUN HELP-STARTUP-SYSTEMS1 ()
  (CL:PROGN (CL:SETQ SYM-SYSTEMS-STELLA-SET-LOAD-PATH (INTERN-RIGID-SYMBOL-WRT-MODULE "SET-LOAD-PATH" NULL 0))
   ...
   (CL:SETQ SYM-SYSTEMS-STELLA-TRUE (INTERN-RIGID-SYMBOL-WRT-MODULE "TRUE" NULL 0))
   (CL:SETQ KWD-SYSTEMS-TRUE (INTERN-RIGID-SYMBOL-WRT-MODULE "TRUE" NULL 2))
   (CL:SETQ SYM-SYSTEMS-STELLA-FALSE (INTERN-RIGID-SYMBOL-WRT-MODULE "FALSE" NULL 0))
   (CL:SETQ KWD-SYSTEMS-FALSE (INTERN-RIGID-SYMBOL-WRT-MODULE "FALSE" NULL 2))
   ...
   (CL:SETQ SGT-SYSTEMS-STELLA-CONS (INTERN-RIGID-SYMBOL-WRT-MODULE "CONS" NULL 1))
   (CL:SETQ SGT-SYSTEMS-STELLA-LIST (INTERN-RIGID-SYMBOL-WRT-MODULE "LIST" NULL 1))
   (CL:SETQ SGT-SYSTEMS-STELLA-IDENTITY (INTERN-RIGID-SYMBOL-WRT-MODULE "IDENTITY" NULL 1))
   ...
   (CL:SETQ KWD-SYSTEMS-DIRECTORY (INTERN-RIGID-SYMBOL-WRT-MODULE "DIRECTORY" NULL 2))
   ...
   (CL:SETQ KWD-SYSTEMS-ACTION (INTERN-RIGID-SYMBOL-WRT-MODULE "ACTION" NULL 2))
   ...
   (CL:SETQ KWD-SYSTEMS-LISP-BINARY (INTERN-RIGID-SYMBOL-WRT-MODULE "LISP-BINARY" NULL 2))
   (CL:SETQ KWD-SYSTEMS-DEVELOPMENT-SETTINGS? (INTERN-RIGID-SYMBOL-WRT-MODULE "DEVELOPMENT-SETTINGS?" NULL 2)))
  :VOID)
...
(CL:DEFUN HELP-STARTUP-SYSTEMS2 ()
  (CL:PROGN (CL:SETQ KWD-SYSTEMS-PRODUCTION-SETTINGS? (INTERN-RIGID-SYMBOL-WRT-MODULE "PRODUCTION-SETTINGS?" NULL 2))
   ...
   (CL:SETQ SYM-SYSTEMS-STELLA-DEFINE-MODULE-FROM-STRINGIFIED-SOURCE
    (INTERN-RIGID-SYMBOL-WRT-MODULE "DEFINE-MODULE-FROM-STRINGIFIED-SOURCE" NULL 0))
   (CL:SETQ KWD-SYSTEMS-PUBLIC? (INTERN-RIGID-SYMBOL-WRT-MODULE "PUBLIC?" NULL 2))
   (CL:SETQ SYM-SYSTEMS-STELLA-STARTUP (INTERN-RIGID-SYMBOL-WRT-MODULE "STARTUP" NULL 0))
   (CL:SETQ SYM-SYSTEMS-STELLA-FOREACH (INTERN-RIGID-SYMBOL-WRT-MODULE "FOREACH" NULL 0))
   (CL:SETQ SYM-SYSTEMS-STELLA-PHASE (INTERN-RIGID-SYMBOL-WRT-MODULE "PHASE" NULL 0))
   ...
   (CL:SETQ KWD-SYSTEMS-WHITE-SPACE (INTERN-RIGID-SYMBOL-WRT-MODULE "WHITE-SPACE" NULL 2))
   ...
   (CL:SETQ KWD-SYSTEMS-CLEAR (INTERN-RIGID-SYMBOL-WRT-MODULE "CLEAR" NULL 2))
   (CL:SETQ KWD-SYSTEMS-REMOVE (INTERN-RIGID-SYMBOL-WRT-MODULE "REMOVE" NULL 2))
   ...
   (CL:SETQ KWD-SYSTEMS-DOCUMENTATION (INTERN-RIGID-SYMBOL-WRT-MODULE "DOCUMENTATION" NULL 2))
   (CL:SETQ KWD-SYSTEMS-KEY (INTERN-RIGID-SYMBOL-WRT-MODULE "KEY" NULL 2))
   (CL:SETQ KWD-SYSTEMS-KEY2 (INTERN-RIGID-SYMBOL-WRT-MODULE "KEY2" NULL 2))
   (CL:SETQ KWD-SYSTEMS-KEY3 (INTERN-RIGID-SYMBOL-WRT-MODULE "KEY3" NULL 2))
   (CL:SETQ KWD-SYSTEMS-KEYS (INTERN-RIGID-SYMBOL-WRT-MODULE "KEYS" NULL 2))
   (CL:SETQ KWD-SYSTEMS-VALUE-TYPE (INTERN-RIGID-SYMBOL-WRT-MODULE "VALUE-TYPE" NULL 2))
   (CL:SETQ SGT-SYSTEMS-STELLA-TYPE (INTERN-RIGID-SYMBOL-WRT-MODULE "TYPE" NULL 1)))
  :VOID)

(CL:DEFUN HELP-STARTUP-SYSTEMS3 ()
  (CL:PROGN (CL:SETQ KWD-SYSTEMS-MULTI-VALUED? (INTERN-RIGID-SYMBOL-WRT-MODULE "MULTI-VALUED?" NULL 2))
   ...
   (CL:SETQ SGT-SYSTEMS-STELLA-OBJECT (INTERN-RIGID-SYMBOL-WRT-MODULE "OBJECT" NULL 1))
   (CL:SETQ KWD-SYSTEMS-PROPERTY (INTERN-RIGID-SYMBOL-WRT-MODULE "PROPERTY" NULL 2))
   (CL:SETQ KWD-SYSTEMS-HANDLER (INTERN-RIGID-SYMBOL-WRT-MODULE "HANDLER" NULL 2))
   (CL:SETQ KWD-SYSTEMS-ERROR-ACTION (INTERN-RIGID-SYMBOL-WRT-MODULE "ERROR-ACTION" NULL 2))
   (CL:SETQ KWD-SYSTEMS-WARN (INTERN-RIGID-SYMBOL-WRT-MODULE "WARN" NULL 2))
   ...
   (CL:SETQ SYM-SYSTEMS-STELLA-EVAL-IN-MODULE-OPTION-HANDLER
    (INTERN-RIGID-SYMBOL-WRT-MODULE "EVAL-IN-MODULE-OPTION-HANDLER" NULL 0))
   ...
   (CL:SETQ SYM-SYSTEMS-STELLA-CONFIG-FILE-OPTION-HANDLER
    (INTERN-RIGID-SYMBOL-WRT-MODULE "CONFIG-FILE-OPTION-HANDLER" NULL 0))
   ...
   (CL:SETQ SYM-SYSTEMS-STELLA-DEFINE-PROPERTY-OPTION-HANDLER
    (INTERN-RIGID-SYMBOL-WRT-MODULE "DEFINE-PROPERTY-OPTION-HANDLER" NULL 0))
...
(CL:DEFUN HELP-STARTUP-SYSTEMS4 ()
  (CL:PROGN
   (DEFINE-FUNCTION-OBJECT "PARSE-DIRECTORY-PATH"
    "(DEFUN (PARSE-DIRECTORY-PATH (CONS OF STRING-WRAPPER)) ((PATH STRING)))" (CL:FUNCTION PARSE-DIRECTORY-PATH) NULL)
...
directories listed in `path'.  Return the resulting load path.\" :PUBLIC? TRUE :COMMAND? TRUE)"
    (CL:FUNCTION %SET-LOAD-PATH) (CL:FUNCTION SET-LOAD-PATH-EVALUATOR-WRAPPER))
...
`path' to the front of the STELLA load path.  Return the
resulting load path.\" :PUBLIC? TRUE :COMMAND? TRUE)" (CL:FUNCTION %PUSH-LOAD-PATH)
...
and return the removed element.\" :PUBLIC? TRUE :COMMAND? TRUE)" (CL:FUNCTION POP-LOAD-PATH)
...
`path' from the PowerLoom load path.\" :PUBLIC? TRUE :COMMAND? TRUE)" (CL:FUNCTION %DROP-LOAD-PATH)
...
or raise an error if `error?' is TRUE.\" :PUBLIC? TRUE)" (CL:FUNCTION COERCE-VALUE-TO-TYPE) NULL)
   ...
   (DEFINE-FUNCTION-OBJECT "VET-OPTIONS"
    "(DEFUN (VET-OPTIONS PROPERTY-LIST) ((PLIST OBJECT) (LEGALOPTIONS (CONS OF KEYWORD))))" (CL:FUNCTION VET-OPTIONS)
    NULL)
...
know their type.\" :PUBLIC? TRUE)" (CL:FUNCTION PARSE-OPTIONS) NULL)
   (DEFINE-FUNCTION-OBJECT "EVALUATE-COMMAND"
    "(DEFUN (EVALUATE-COMMAND OBJECT) ((COMMAND OBJECT) (FINALIZE? BOOLEAN)))" (CL:FUNCTION EVALUATE-COMMAND) NULL)
...
the module within which all remaining commands are to be evaluated
The remaining commands are evaluated one-by-one, applying the function
`evaluate' to each of them.\" :COMMAND? TRUE :PUBLIC? TRUE)" (CL:FUNCTION %LOAD-FILE)
   ...
   (DEFINE-FUNCTION-OBJECT "PARSE-LIST-OF-FILE-PATHS"
    "(DEFUN (PARSE-LIST-OF-FILE-PATHS (CONS OF STRING-WRAPPER)) ((FILES CONS)))" (CL:FUNCTION PARSE-LIST-OF-FILE-PATHS)
    NULL)
   (DEFINE-FUNCTION-OBJECT "DEFINE-SYSTEM" "(DEFUN (DEFINE-SYSTEM SYSTEM-DEFINITION) ((NAME OBJECT) (OPTIONS CONS)))"
...
a Stella application.
   ...
   (DEFINE-FUNCTION-OBJECT "GET-SYSTEM-DEFINITION" "(DEFUN (GET-SYSTEM-DEFINITION SYSTEM-DEFINITION) ((NAME STRING)))"
    (CL:FUNCTION GET-SYSTEM-DEFINITION) NULL)
   (DEFINE-FUNCTION-OBJECT "GET-CARDINAL-MODULE" "(DEFUN (GET-CARDINAL-MODULE MODULE) ((SYSTEM SYSTEM-DEFINITION)))"
...
`:startup?' (default true): if true, the system startup function will
be called once all files have been loaded.\" :PUBLIC? TRUE :COMMAND? TRUE)" (CL:FUNCTION %MAKE-SYSTEM)
    (CL:FUNCTION MAKE-SYSTEM-EVALUATOR-WRAPPER))
   (DEFINE-FUNCTION-OBJECT "RUN-SYSTEM-FINALIZATION" "(DEFUN RUN-SYSTEM-FINALIZATION ((SYSTEM SYSTEM-DEFINITION)))"
...
`name' is `null', then clear out all system definitions.  This function
is useful when changes have been made to the system definition, and one
wants to have it reloaded from the standard location in the file system.\" :PUBLIC? TRUE)" (CL:FUNCTION CLEAR-SYSTEM)
    NULL)
   (DEFINE-FUNCTION-OBJECT "LOAD-PREPROCESSED-FILES" "(DEFUN LOAD-PREPROCESSED-FILES ((SYSTEMNAME STRING)))"
...
`:startup?' (default true): if true, the system startup function will
be called once all files have been loaded.\" :PUBLIC? TRUE :COMMAND? TRUE)" (CL:FUNCTION %LOAD-SYSTEM)
   ...
   (DEFINE-FUNCTION-OBJECT "RUN-SYSTEM-STARTUP-FUNCTION"
    "(DEFUN RUN-SYSTEM-STARTUP-FUNCTION ((SYSTEM SYSTEM-DEFINITION)))" (CL:FUNCTION RUN-SYSTEM-STARTUP-FUNCTION) NULL)
   (DEFINE-METHOD-OBJECT "(DEFMETHOD (SYSTEM-STARTUP-FUNCTION-NAME STRING) ((SYSTEM SYSTEM-DEFINITION)))"
    (CL:FUNCTION SYSTEM-STARTUP-FUNCTION-NAME) NULL)
   (DEFINE-METHOD-OBJECT "(DEFMETHOD (SYSTEM-STARTUP-FUNCTION-NAME STRING) ((SYSTEMNAME STRING)))"
    (CL:FUNCTION SYSTEM-STARTUP-FUNCTION-NAME) NULL)
   ...
   (DEFINE-FUNCTION-OBJECT "STARTUP-NAME-FROM-FILE" "(DEFUN (STARTUP-NAME-FROM-FILE SYMBOL) ((FILE FILE-NAME)))"
   ...
   (DEFINE-FUNCTION-OBJECT "SYSTEM-STARTUP-FILE-NAME"
    "(DEFUN (SYSTEM-STARTUP-FILE-NAME STRING) ((SYSTEM SYSTEM-DEFINITION)))" (CL:FUNCTION SYSTEM-STARTUP-FILE-NAME)
    NULL)
   (DEFINE-FUNCTION-OBJECT "SYSTEM-STARTUP-FILE?" "(DEFUN (SYSTEM-STARTUP-FILE? BOOLEAN) ((FILE FILE-NAME)))"
   ...
   (DEFINE-FUNCTION-OBJECT "CREATE-SYSTEM-STARTUP-FILE"
    "(DEFUN CREATE-SYSTEM-STARTUP-FILE ((SYSTEM SYSTEM-DEFINITION)))" (CL:FUNCTION CREATE-SYSTEM-STARTUP-FILE) NULL)
...
and `error?' is true, raise an error.  Otherwise, simply return NULL.\" :PUBLIC? TRUE)" (CL:FUNCTION AUTOLOAD) NULL)
   (DEFINE-FUNCTION-OBJECT "MAKE-STELLA" "(DEFUN MAKE-STELLA ((FORCERECOMPILATION? BOOLEAN)))"
...
Note that `property' is evaluated and will need to be quoted if supplied as a
symbol.  Symbols will also be upcased if this command is run in a non-case-
sensitive module.\" :PUBLIC? TRUE :COMMAND? TRUE)" (CL:FUNCTION %GET-PROPERTY)
...
values but leave all other currently set properties as they are.\" :PUBLIC? TRUE)"
   ...
   (DEFINE-FUNCTION-OBJECT "STARTUP-SYSTEMS" "(DEFUN STARTUP-SYSTEMS () :PUBLIC? TRUE)" (CL:FUNCTION STARTUP-SYSTEMS)
    NULL)
   (CL:LET* ((FUNCTION (LOOKUP-FUNCTION SYM-SYSTEMS-STELLA-STARTUP-SYSTEMS)))
    (SET-DYNAMIC-SLOT-VALUE (%DYNAMIC-SLOTS FUNCTION) SYM-SYSTEMS-STELLA-METHOD-STARTUP-CLASSNAME
...
(CL:DEFUN STARTUP-SYSTEMS ()
  (CL:LET* ((*MODULE* *STELLA-MODULE*) (*CONTEXT* *MODULE*)) (CL:DECLARE (CL:SPECIAL *MODULE* *CONTEXT*))
   ...
   (CL:WHEN (CURRENT-STARTUP-TIME-PHASE? 4) (CL:SETQ *FILE-LOAD-PATH* NIL)
    (CL:SETQ *STELLA-FILE-EXTENSIONS* (CONS-LIST (WRAP-STRING ".ste"))) (CL:SETQ *SYSTEMDEFINITIONS* (NEW-LIST))
...
Defaults to TRUE for 0-arg options with boolean value type.\") (CONFIGURATION-PROPERTY :TYPE STRING) (HANDLER :TYPE FUNCTION-CODE :INITIALLY (THE-CODE :FUNCTION DEFAULT-CMD-LINE-OPTION-HANDLER)) (ERROR-ACTION :TYPE KEYWORD :INITIALLY :ERROR :DOCUMENTATION \"One of :ignore, :warn, :error.\")))")))
   ...
   (CL:WHEN (CURRENT-STARTUP-TIME-PHASE? 7) (HELP-STARTUP-SYSTEMS4) (HELP-STARTUP-SYSTEMS5))
...
perform the appropriate actions on required systems in `define-system'.\")")
    ...
    (REGISTER-CMD-LINE-OPTION KWD-SYSTEMS-KEY (WRAP-STRING "-e") KWD-SYSTEMS-KEY2 (WRAP-STRING "--eval")
     KWD-SYSTEMS-KEY3 (WRAP-STRING "-eval") KWD-SYSTEMS-DOCUMENTATION
     (WRAP-STRING "<s-expression>
  Evaluate the STELLA <s-expression> in the current module.")
     KWD-SYSTEMS-N-ARGUMENTS (WRAP-INTEGER 1) KWD-SYSTEMS-HANDLER SYM-SYSTEMS-STELLA-EVAL-OPTION-HANDLER
  ...
  Evaluate the STELLA <s-expression> in module <module-name>.")
     KWD-SYSTEMS-N-ARGUMENTS (WRAP-INTEGER 2) KWD-SYSTEMS-HANDLER SYM-SYSTEMS-STELLA-EVAL-IN-MODULE-OPTION-HANDLER
     KWD-SYSTEMS-ERROR-ACTION KWD-SYSTEMS-WARN)
    (REGISTER-CMD-LINE-OPTION KWD-SYSTEMS-KEY (WRAP-STRING "--path") KWD-SYSTEMS-KEY2 (WRAP-STRING "--path+=")
     KWD-SYSTEMS-DOCUMENTATION
     (WRAP-STRING "<path>
  Add <path> to the front of the current file load path.")
     KWD-SYSTEMS-N-ARGUMENTS (WRAP-INTEGER 1) KWD-SYSTEMS-HANDLER SYM-SYSTEMS-STELLA-LOAD-PATH-OPTION-HANDLER
     KWD-SYSTEMS-ERROR-ACTION KWD-SYSTEMS-WARN)
  ...
  Add <path> at the end of the current file load path.")
     KWD-SYSTEMS-N-ARGUMENTS (WRAP-INTEGER 1) KWD-SYSTEMS-HANDLER SYM-SYSTEMS-STELLA-LOAD-PATH-OPTION-HANDLER
     KWD-SYSTEMS-ERROR-ACTION KWD-SYSTEMS-WARN)
    (REGISTER-CMD-LINE-OPTION KWD-SYSTEMS-KEY (WRAP-STRING "-c") KWD-SYSTEMS-KEY2 (WRAP-STRING "--configuration-file")
     KWD-SYSTEMS-DOCUMENTATION
     (WRAP-STRING "<file>
  Load the STELLA configuration file <file>.")
     KWD-SYSTEMS-N-ARGUMENTS (WRAP-INTEGER 1) KWD-SYSTEMS-HANDLER SYM-SYSTEMS-STELLA-CONFIG-FILE-OPTION-HANDLER
     KWD-SYSTEMS-ERROR-ACTION KWD-SYSTEMS-WARN)
    (REGISTER-CMD-LINE-OPTION KWD-SYSTEMS-KEY (WRAP-STRING "-l") KWD-SYSTEMS-KEY2 (WRAP-STRING "--load")
     KWD-SYSTEMS-DOCUMENTATION
     (WRAP-STRING "<file>
  Load the STELLA file <file>.")
     KWD-SYSTEMS-N-ARGUMENTS (WRAP-INTEGER 1) KWD-SYSTEMS-HANDLER SYM-SYSTEMS-STELLA-LOAD-FILE-OPTION-HANDLER
     KWD-SYSTEMS-ERROR-ACTION KWD-SYSTEMS-WARN)
    (REGISTER-CMD-LINE-OPTION KWD-SYSTEMS-KEY (WRAP-STRING "-D") KWD-SYSTEMS-KEY2 (WRAP-STRING "--define")
     KWD-SYSTEMS-DOCUMENTATION
  ...
  added to via the `+=' and removed from via the `-=' assignment operator.")
    ...
    (REGISTER-CMD-LINE-OPTION KWD-SYSTEMS-KEY (WRAP-STRING "-?") KWD-SYSTEMS-KEY2 (WRAP-STRING "--help")
     KWD-SYSTEMS-DOCUMENTATION
     (WRAP-STRING "
