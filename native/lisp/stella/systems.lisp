...
(CL:DECLAIM
  ...
  *FUNCTION-LOOKUP-TABLE* *CURRENT-STELLA-FEATURES* *TRANSLATOROUTPUTLANGUAGE*
  NIL-LIST STANDARD-ERROR *CURRENT-SYSTEM-ACTION* *CURRENTFILE* *MODULE*
  *TRANSLATIONUNITS* *EVALUATIONTREE* *EVALUATIONPARENTTREE*
  *TRANSLATIONPHASE* *CURRENTSYSTEMDEFINITION* STANDARD-OUTPUT EOL
  MOST-POSITIVE-INTEGER NULL-FLOAT TRUE-WRAPPER FALSE-WRAPPER NIL
  NULL-INTEGER))
...
(CL:DEFUN PARSE-DIRECTORY-PATH (PATH)
  ...
  (CL:LET*
   ((SEPARATOR #\|) (LENGTH (CL:THE CL:FIXNUM (CL:LENGTH PATH))) (START 0)
    (END 0) (PARSEDPATH NIL))
   (CL:DECLARE (CL:TYPE CL:FIXNUM LENGTH START END))
   (CL:LOOP (CL:SETQ END (POSITION PATH SEPARATOR START))
    (CL:SETQ PARSEDPATH
     (CONS (WRAP-STRING (FILE-NAME-AS-DIRECTORY (SUBSEQUENCE PATH START END)))
      PARSEDPATH))
...
(CL:DEFUN SET-LOAD-PATH-EVALUATOR-WRAPPER (ARGUMENTS)
  (CL:RETURN-FROM SET-LOAD-PATH-EVALUATOR-WRAPPER
   (%SET-LOAD-PATH (%WRAPPER-VALUE (%%VALUE ARGUMENTS)))))
...
(CL:DEFUN PUSH-LOAD-PATH-EVALUATOR-WRAPPER (ARGUMENTS)
  (CL:RETURN-FROM PUSH-LOAD-PATH-EVALUATOR-WRAPPER
   (%PUSH-LOAD-PATH (%WRAPPER-VALUE (%%VALUE ARGUMENTS)))))
...
and return the removed element."
  (CL:LET* ((HEAD-000 (%%VALUE *FILE-LOAD-PATH*)))
   ...
   (CL:LET* ((VALUE-000 HEAD-000))
    (CL:RETURN-FROM POP-LOAD-PATH (%WRAPPER-VALUE VALUE-000)))))
...
(CL:DEFUN ADD-LOAD-PATH-EVALUATOR-WRAPPER (ARGUMENTS)
  (CL:RETURN-FROM ADD-LOAD-PATH-EVALUATOR-WRAPPER
   (%ADD-LOAD-PATH (%WRAPPER-VALUE (%%VALUE ARGUMENTS)))))
...
(CL:DEFUN DROP-LOAD-PATH-EVALUATOR-WRAPPER (ARGUMENTS)
  (CL:RETURN-FROM DROP-LOAD-PATH-EVALUATOR-WRAPPER
   (%DROP-LOAD-PATH (%WRAPPER-VALUE (%%VALUE ARGUMENTS)))))
       ...
       (CL:LET* ((EXT NULL) (ITER-001 EXTENSIONS))
        (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-001 NIL)) DO
         ...
         (CL:SETQ EXPANDEDFILE
          (CONCATENATE (UNWRAP-STRING DIR) FILE (%WRAPPER-VALUE EXT)))
         (CL:WHEN (PROBE-FILE? EXPANDEDFILE)
          (CL:RETURN-FROM FIND-FILE-IN-LOAD-PATH EXPANDEDFILE))
...
(CL:DECLAIM
 (CL:FTYPE (CL:FUNCTION (CL:T CL:T) CL:SIMPLE-STRING) COERCE-VALUE-TO-STRING))
  ...
  (CL:LET* ((TEST-VALUE-000 (SAFE-PRIMARY-TYPE VALUE)))
   (CL:COND
    ((SUBTYPE-OF-STRING? TEST-VALUE-000)
     (CL:PROGN
      (CL:RETURN-FROM COERCE-VALUE-TO-STRING (%WRAPPER-VALUE VALUE))))
    ...
    ((SUBTYPE-OF-INTEGER? TEST-VALUE-000)
     (CL:PROGN
      (CL:RETURN-FROM COERCE-VALUE-TO-STRING
       (INTEGER-TO-STRING (CL:TRUNCATE (%WRAPPER-VALUE VALUE))))))
    ((SUBTYPE-OF-LONG-INTEGER? TEST-VALUE-000)
     (CL:PROGN
      (CL:RETURN-FROM COERCE-VALUE-TO-STRING
       (INTEGER-TO-STRING (%WRAPPER-VALUE VALUE)))))
...
(CL:DECLAIM
 (CL:FTYPE (CL:FUNCTION (CL:T CL:T) CL:DOUBLE-FLOAT) COERCE-VALUE-TO-FLOAT))
    ...
    ((SUBTYPE-OF-INTEGER? TEST-VALUE-000)
     (CL:PROGN
      (CL:RETURN-FROM COERCE-VALUE-TO-FLOAT
       (CL:* (%WRAPPER-VALUE VALUE) 1.0d0))))
    ((SUBTYPE-OF-LONG-INTEGER? TEST-VALUE-000)
     (CL:PROGN
      (CL:RETURN-FROM COERCE-VALUE-TO-FLOAT
       (CL:* (%WRAPPER-VALUE VALUE) 1.0d0))))
    ((SUBTYPE-OF-FLOAT? TEST-VALUE-000)
     (CL:PROGN (CL:RETURN-FROM COERCE-VALUE-TO-FLOAT (%WRAPPER-VALUE VALUE))))
    (CL:T)))
  (CL:IF ERROR?
   (CL:LET* ((STREAM-000 (NEW-OUTPUT-STRING-STREAM)))
    (%%PRINT-STREAM (%NATIVE-STREAM STREAM-000)
...
or raise an error if `error?' is TRUE."
    ...
    (CL:LET* ((TEST-VALUE-000 (SAFE-PRIMARY-TYPE VALUE)))
     (CL:COND
      ...
      ((SUBTYPE-OF-LONG-INTEGER? TEST-VALUE-000)
       (CL:PROGN
        (CL:WHEN
         (CL:AND (CL:>= (%WRAPPER-VALUE VALUE) NULL-INTEGER)
          (CL:<= (%WRAPPER-VALUE VALUE) MOST-POSITIVE-INTEGER))
    ...
    (CL:LET* ((TEST-VALUE-003 (SAFE-PRIMARY-TYPE VALUE)))
     (CL:COND
      ...
      ((SUBTYPE-OF-STRING? TEST-VALUE-003)
       (CL:PROGN
        (CL:RETURN-FROM COERCE-VALUE-TO-TYPE
         (INTERN-SYMBOL (%WRAPPER-VALUE VALUE)))))
      (CL:T))))
  ...
  (CL:IF ERROR?
   (CL:LET* ((STREAM-000 (NEW-OUTPUT-STRING-STREAM)))
    (%%PRINT-STREAM (%NATIVE-STREAM STREAM-000)
     "coerce-value-to-type: don't know how to coerce `" VALUE "' to type `"
     TYPE "'")
    (CL:ERROR (NEW-STELLA-EXCEPTION (THE-STRING-READER STREAM-000))))
     ...
     (CL:WHEN
      ...
      (CL:WHEN (CL:NOT (STELLA-OBJECT? KEY))
       (CL:LET* ((NEWPLIST (NEW-PROPERTY-LIST)))
        (CL:LET*
         ((KEY NULL) (VALUE NULL) (ITER-001 (%THE-PLIST PROPERTYLIST)))
         (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-001 NIL)) DO
    ...
    (CL:WHEN (CL:NOT (CL:EQ LEGALOPTIONS NULL))
     (CL:LET* ((KEY NULL) (VALUE NULL) (ITER-000 (%THE-PLIST PARSEDOPTIONS)))
      (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-000 NIL)) DO
       ...
       (CL:WHEN
        (CL:NOT
         (CL:OR (CL:EQ TYPE SGT-SYSTEMS-STELLA-IDENTITY) (CL:EQ VALUE NULL)))
...
(CL:DEFUN EVALUATE-COMMAND (COMMAND FINALIZE?)
  (CL:LET*
   ((*TRANSLATIONERRORS* 0) (*TRANSLATIONWARNINGS* 0) (*TRANSLATIONNOTES* 0)
    (*IGNORETRANSLATIONERRORS?* CL:NIL) (*TRANSLATIONUNITS* NULL)
    (*TRANSLATIONPHASE* KWD-SYSTEMS-DEFINE) (*EVALUATIONTREE* NULL))
   (CL:DECLARE
    (CL:SPECIAL *TRANSLATIONERRORS* *TRANSLATIONWARNINGS* *TRANSLATIONNOTES*
     ...
     (CL:LET* ((*MODULE* *MODULE*) (*CONTEXT* *MODULE*))
      ...
      (CL:LET* ((FINALIZE? (CL:NOT (CL:EQ *CURRENTSYSTEMDEFINITION* NULL))))
       (CL:LET* ((TREE NULL) (ITER-001 (REVERSE COMMANDS)))
        (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-001 NIL)) DO
         (CL:SETQ TREE (%%VALUE ITER-001)) (EVALUATE-COMMAND TREE FINALIZE?)
         (CL:SETQ ITER-001 (%%REST ITER-001)))))))
        ...
        (CL:LET* ((OLDSYSTEM VALUE-000))
         (CL:LET* ((KEY NULL) (VALUE NULL) (ITER-001 (%THE-PLIST PLIST)))
          (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-001 NIL)) DO
             ...
             ((CL:EQ TEST-VALUE-001 KWD-SYSTEMS-REQUIRED-SYSTEMS)
              ...
              (CL:LET* ((SYS NULL) (ITER-002 VALUE))
               (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-002 NIL)) DO
                ...
                (CL:WHEN
                 (CL:NOT (SYSTEM-LOADED-OR-STARTED-UP? (%WRAPPER-VALUE SYS)))
                 (CL:LET*
                  ...
                  (CL:COND
                   ...
                   (CL:T
                    (%%PRINT-STREAM (%NATIVE-STREAM STANDARD-OUTPUT)
                     "Loading required system " (UNWRAP-STRING SYS) EOL)
                    (%LOAD-SYSTEM (%WRAPPER-VALUE SYS)
                     (CONS-LIST CURRENTLANGUAGE))))))
           ...
           (CL:SETQ ITER-001 (%%REST (%%REST ITER-001)))))
         (CL:WHEN (CL:EQ (%DIRECTORY SYSTEM) STELLA::NULL-STRING)
          (CL:SETF (%DIRECTORY SYSTEM) (%NAME SYSTEM)))
     ...
     (CL:LET* ((SYSTEMFILENAME (MAKE-SYSTEM-DEFINITION-FILE-NAME NAME)))
      (CL:WHEN (CL:NOT (PROBE-FILE? SYSTEMFILENAME))
       (%%PRINT-STREAM (%NATIVE-STREAM STANDARD-ERROR) "ERROR>> File "
        SYSTEMFILENAME " does not exist." EOL "   Can't define system " NAME
        EOL)
...
(CL:DEFUN CLEAN-SYSTEM (SYSTEMNAME)
  ...
  (CL:LET* ((SYSTEM (GET-SYSTEM-DEFINITION SYSTEMNAME)))
   ...
   (CL:LET*
    ((F NULL)
     (ITER-000
      (%THE-CONS-LIST (GET-SYSTEM-FILES SYSTEM KWD-SYSTEMS-LISP CL:T))))
    (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-000 NIL)) DO
     (CL:SETQ F (%%VALUE ITER-000)) (DELETE-FILE (%WRAPPER-VALUE F))
     (CL:SETQ ITER-000 (%%REST ITER-000))))
   (CL:LET*
    ((F NULL)
     (ITER-001
      (%THE-CONS-LIST (GET-SYSTEM-FILES SYSTEM KWD-SYSTEMS-JAVA CL:T))))
    (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-001 NIL)) DO
     (CL:SETQ F (%%VALUE ITER-001)) (DELETE-FILE (%WRAPPER-VALUE F))
     (CL:SETQ ITER-001 (%%REST ITER-001))))
   (CL:LET*
    ((F NULL)
     (ITER-002
      (%THE-CONS-LIST (GET-SYSTEM-FILES SYSTEM KWD-SYSTEMS-CPP CL:T))))
    (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-002 NIL)) DO
     (CL:SETQ F (%%VALUE ITER-002)) (DELETE-FILE (%WRAPPER-VALUE F))
     (CL:SETQ ITER-002 (%%REST ITER-002))))
   (CL:LET*
    ((F NULL)
     (ITER-003
    ...
    (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-003 NIL)) DO
     (CL:SETQ F (%%VALUE ITER-003)) (DELETE-FILE (%WRAPPER-VALUE F))
  ...
  (CL:LET*
   ((OPTIONS |LANGUAGE&OPTIONS|)
    (LANGUAGE
     (CL:IF
      (MEMBER?
       (GET-QUOTED-TREE "((:COMMON-LISP :CPP :JAVA) \"/STELLA\")" "/STELLA")
       (%%VALUE OPTIONS))
      (%%VALUE OPTIONS) (RUNNING-IN-LANGUAGE)))
    (PLIST
     (VET-OPTIONS
      (CL:IF (CL:EQ (%%VALUE OPTIONS) LANGUAGE) (%%REST OPTIONS) OPTIONS)
      (GET-QUOTED-TREE
   ...
   (INSERT-AT PLIST KWD-SYSTEMS-ACTION
    (LOOKUP-WITH-DEFAULT PLIST KWD-SYSTEMS-ACTION KWD-SYSTEMS-MAKE-SYSTEM))
...
(CL:DEFUN MAKE-SYSTEM-EVALUATOR-WRAPPER (ARGUMENTS)
  (CL:RETURN-FROM MAKE-SYSTEM-EVALUATOR-WRAPPER
   (CL:IF
    (%MAKE-SYSTEM (%WRAPPER-VALUE (%%VALUE ARGUMENTS)) (%%REST ARGUMENTS))
         ...
         (CL:IF (CL:EQ COLLECT-000 NULL)
          (CL:PROGN
           (CL:SETQ COLLECT-000
            (CONS
             (WRAP-STRING
              (MAKE-FILE-NAME (%WRAPPER-VALUE F) KWD-SYSTEMS-STELLA CL:T))
             NIL))
       ...
       (CL:WHEN
        ...
        (CL:LET*
         ...
         (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-002 NIL)) DO
          ...
          (DELETE-FILE
           (MAKE-FILE-NAME (%WRAPPER-VALUE F) KWD-SYSTEMS-LISP CL:T))
          (CL:SETQ ITER-002 (%%REST ITER-002)))))
       (CL:LET*
        ((STARTUPFN NULL)
         (ITER-003
...
be called once all files have been loaded."
  ...
  (CL:LET*
   ...
   (INSERT-AT PLIST KWD-SYSTEMS-LANGUAGE LANGUAGE)
   (INSERT-AT PLIST KWD-SYSTEMS-ACTION
    (LOOKUP-WITH-DEFAULT PLIST KWD-SYSTEMS-ACTION KWD-SYSTEMS-LOAD-SYSTEM))
   (CL:LET* ((KEY NULL) (VALUE NULL) (ITER-000 (%THE-PLIST PLIST)))
    (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-000 NIL)) DO
     (CL:SETQ KEY (%%VALUE ITER-000))
     (CL:SETQ VALUE (%%VALUE (%%REST ITER-000)))
...
(CL:DEFUN LOAD-SYSTEM-EVALUATOR-WRAPPER (ARGUMENTS)
  (CL:RETURN-FROM LOAD-SYSTEM-EVALUATOR-WRAPPER
   (CL:IF
    (%LOAD-SYSTEM (%WRAPPER-VALUE (%%VALUE ARGUMENTS)) (%%REST ARGUMENTS))
    TRUE-WRAPPER FALSE-WRAPPER)))
      ...
      (CL:LET* ((DEF NULL) (ITER-001 (%%REST (%%REST FORM))))
       (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-001 NIL)) DO
        ...
        (CL:WHEN
         ...
         (CL:SETQ MODULE
          (GET-STELLA-MODULE (%WRAPPER-VALUE (%%VALUE (%%REST DEF))) CL:NIL))
         (CL:WHEN (CL:NOT (CL:EQ MODULE NULL))
...
(CL:DEFUN HELP-ALL-REQUIRED-SYSTEMS (SYSTEM-NAME FOUND)
  ...
  (CL:LET* ((SYSTEM (GET-SYSTEM-DEFINITION SYSTEM-NAME)))
   (CL:WHEN (CL:EQ SYSTEM NULL)
    (CL:LET* ((STREAM-000 (NEW-OUTPUT-STRING-STREAM)))
     (%%PRINT-STREAM (%NATIVE-STREAM STREAM-000) "Couldn't find system `"
      SYSTEM-NAME "'")
     (CL:ERROR (NEW-STELLA-EXCEPTION (THE-STRING-READER STREAM-000)))))
     ...
     (CL:LET* ((SYS NULL) (ITER-000 REQUIRED-SYSTEM-NAMES))
      (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-000 NIL)) DO
       ...
       (CL:WHEN (CL:NOT (MEMBER? FOUND SYS))
        (HELP-ALL-REQUIRED-SYSTEMS (%WRAPPER-VALUE SYS) FOUND)
        (PUSH FOUND SYS))
       (CL:SETQ ITER-000 (%%REST ITER-000)))))
...
(CL:DEFUN ALL-REQUIRED-SYSTEMS (SYSTEM-NAME)
  ...
  (CL:RETURN-FROM ALL-REQUIRED-SYSTEMS
   (%THE-CONS-LIST (HELP-ALL-REQUIRED-SYSTEMS SYSTEM-NAME (NEW-LIST)))))
...
and `error?' is true, raise an error.  Otherwise, simply return NULL."
  ...
  (CL:LET* ((FUNCTION NULL))
   (CL:WHEN (CL:NOT (CL:EQ CACHE NULL))
    (CL:LET* ((FUNCTIONWRAPPER (%SURROGATE-VALUE CACHE)))
     (CL:WHEN (CL:NOT (CL:EQ FUNCTIONWRAPPER NULL))
      (CL:RETURN-FROM AUTOLOAD (%WRAPPER-VALUE FUNCTIONWRAPPER)))))
   (CL:HANDLER-CASE
    (CL:LET*
     ...
     (CL:SETQ TYPE TYPE)
     (CL:LET*
      ((FUNCTIONMODULE NULL) (FUNCTIONNAMESYMBOL NULL) (FUNCTIONOBJECT NULL))
      ...
      (CL:COND
       ((CL:NOT (CL:EQ FUNCTIONOBJECT NULL))
        (CL:SETQ FUNCTION (%FUNCTION-CODE FUNCTIONOBJECT)))
   ...
   (CL:WHEN (CL:NOT (CL:EQ CACHE NULL))
    (CL:SETF (%SURROGATE-VALUE CACHE) (WRAP-FUNCTION-CODE FUNCTION)))
   ...
   (CL:LET* ((ALWAYS?-000 CL:T))
    (CL:LET*
     ((I NULL-INTEGER) (ITER-000 0)
      (UPPER-BOUND-000
       (CL:1- (CL:IF (CL:NOT (CL:= HASHPOS NULL-INTEGER)) HASHPOS LENGTH))))
         ...
         (CL:WHEN (CL:NOT (CL:EQ KEY NULL))
          (CL:COND
           ((CL:EQ OPERATOR KWD-SYSTEMS-SET)
            (SET-CONFIGURATION-PROPERTY (%WRAPPER-VALUE KEY) VALUE
             CONFIGURATION)
            (SET-CONFIGURATION-PROPERTY (%WRAPPER-VALUE KEY) VALUE NULL))
           ((CL:EQ OPERATOR KWD-SYSTEMS-ADD)
            (ADD-CONFIGURATION-PROPERTY (%WRAPPER-VALUE KEY) VALUE
             CONFIGURATION)
...
value."
  (CL:LET* ((TEST-VALUE-000 (SAFE-PRIMARY-TYPE VALUE)))
   (CL:COND
    ((SUBTYPE-OF-STRING? TEST-VALUE-000)
     (CL:PROGN
      (%%PRINT-STREAM (%NATIVE-STREAM STREAM) (%WRAPPER-VALUE VALUE))))
    ((SUBTYPE-OF-BOOLEAN? TEST-VALUE-000)
     (CL:PROGN
    ...
    (CL:UNWIND-PROTECT
     (CL:PROGN (CL:SETQ OUT (OPEN-OUTPUT-FILE FILE))
      (CL:WHEN (CL:NOT (CL:EQ TITLE STELLA::NULL-STRING))
       (%%PRINT-STREAM (%NATIVE-STREAM OUT) "# " TITLE EOL))
          ...
          (CL:PROGN
           (CL:LET* ((V NULL) (ITER-001 VALUE))
            (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-001 NIL)) DO
             ...
             (%%PRINT-STREAM (%NATIVE-STREAM OUT) (UNWRAP-STRING KEY) " +=")
             (SAVE-CONFIGURATION-VALUE OUT V)
             (%%PRINT-STREAM (%NATIVE-STREAM OUT) EOL)
             (CL:SETQ ITER-001 (%%REST ITER-001))))))
         (CL:T (%%PRINT-STREAM (%NATIVE-STREAM OUT) (UNWRAP-STRING KEY) " =")
...
Use the global system configuration table if `configuration' is NULL."
  ...
  (CL:LET* ((CURRENT-VALUE (LOOKUP CONFIGURATION (WRAP-STRING PROPERTY))))
   ...
   (RUN-CONFIGURATION-PROPERTY-DEMON KWD-SYSTEMS-CLEAR PROPERTY CURRENT-VALUE
    CONFIGURATION)
...
(CL:DEFUN PRINT-CONFIGURATION-PROPERTIES (CONFIGURATION STREAM)
  ...
  (CL:LET* ((*PRINTREADABLY?* CL:T))
   (CL:DECLARE (CL:SPECIAL *PRINTREADABLY?*))
   (CL:LET*
    ((ENTRY NULL) (ITER-000 (SORT-TUPLES (CONSIFY CONFIGURATION) 0 NULL)))
    (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-000 NIL)) DO
...
sensitive module."
  (CL:LET*
   ...
   (CL:RETURN-FROM %GET-PROPERTY
    (LOOKUP-CONFIGURATION-PROPERTY KEY DEFAULT *SYSTEM-CONFIGURATION-TABLE*))))
...
property `stella.test.propertyDemon' to see a test demon in action."
  ...
  (CL:LET* ((DEMON (LOOKUP-FUNCTION DEMONNAME)))
   ...
   (CL:IF (CL:NOT (CL:EQ DEMON NULL))
    (INSERT-AT *REGISTERED-PROPERTY-DEMONS* (WRAP-STRING PROPERTY) DEMON)
    (CL:LET* ((STREAM-000 (NEW-OUTPUT-STRING-STREAM)))
     (%%PRINT-STREAM (%NATIVE-STREAM STREAM-000)
...
(CL:DEFUN LOOKUP-VARIABLE-DEMON-SETTER (DEMON)
  (CL:LET*
   ((VARIABLENAME (%VARIABLE-NAME DEMON))
    (POSTFIX
     (CL:IF (%CASE-SENSITIVE? (HOME-MODULE DEMON)) "-setter" "-SETTER"))
    (SETTERNAME
     (INTERN-DERIVED-SYMBOL VARIABLENAME
      (CONCATENATE (%SYMBOL-NAME VARIABLENAME) POSTFIX))))
...
(CL:DEFUN RUN-CONFIGURATION-PROPERTY-DEMON (ACTION PROPERTY VALUE TABLE)
  ...
  (CL:CHECK-TYPE PROPERTY CL:SIMPLE-STRING)
  (CL:LET*
   ((DEMON (LOOKUP *REGISTERED-PROPERTY-DEMONS* (WRAP-STRING PROPERTY))))
   (CL:LET* ((TEST-VALUE-000 (SAFE-PRIMARY-TYPE DEMON)))
    (CL:COND
     ((SUBTYPE-OF-METHOD-SLOT? TEST-VALUE-000)
      (CL:PROGN
       (CL:FUNCALL (%FUNCTION-CODE DEMON) ACTION PROPERTY VALUE TABLE)))
       ...
       (CL:LET* ((SETTER (LOOKUP-VARIABLE-DEMON-SETTER DEMON)))
        (CL:COND
         ((CL:NOT (CL:EQ SETTER NULL))
          (CL:SETQ VALUE (LOOKUP-CONFIGURATION-PROPERTY PROPERTY NULL TABLE))
          (CL:LET*
           ((VARIABLETYPE
           ...
           (CL:COND
            ((CL:EQ VARIABLETYPE SGT-SYSTEMS-STELLA-INTEGER)
             (CL:FUNCALL (%FUNCTION-CODE SETTER)
         ...
         (CL:T
          (CL:WARN
           "run-configuration-property-demon: cannot find setter function for `~A'"
           (%VARIABLE-NAME DEMON)))))))
     (CL:T))))
  :VOID)
...
(CL:DEFUN TEST-PROPERTY-DEMON (ACTION PROPERTY VALUE TABLE)
  ...
  (CL:SETQ TABLE TABLE)
  (%%PRINT-STREAM (%NATIVE-STREAM STANDARD-OUTPUT)
   "test-property-demon: action=" ACTION ", property=" PROPERTY ", value-arg="
   VALUE ", prop-value=" (LOOKUP-CONFIGURATION-PROPERTY PROPERTY NULL TABLE)
   EOL)
  :VOID)
...
(CL:DEFCLASS CMD-LINE-OPTION (STANDARD-OBJECT)
  ((DOCUMENTATION :TYPE CL:SIMPLE-STRING :INITFORM STELLA::NULL-STRING
   ...
   (KEYS :ALLOCATION :INSTANCE :ACCESSOR %KEYS)
   (VALUE-TYPE :ALLOCATION :INSTANCE :ACCESSOR %VALUE-TYPE)
   (MULTI-VALUED? :ALLOCATION :INSTANCE :ACCESSOR %MULTI-VALUED?)
   (N-ARGUMENTS :TYPE CL:FIXNUM :INITFORM NULL-INTEGER :DOCUMENTATION
    "The number of args expected by this option.
Common values are 0 or 1, but certain options might take more than one argument."
    :ALLOCATION :INSTANCE :ACCESSOR %N-ARGUMENTS)
   (DEFAULT-VALUE :DOCUMENTATION "The value to use for 0-arg options.
Defaults to TRUE for 0-arg options with boolean value type." :ALLOCATION
    :INSTANCE :ACCESSOR %DEFAULT-VALUE)
   (CONFIGURATION-PROPERTY :TYPE CL:SIMPLE-STRING :INITFORM
    STELLA::NULL-STRING :ALLOCATION :INSTANCE :ACCESSOR
    %CONFIGURATION-PROPERTY)
   (HANDLER :ALLOCATION :INSTANCE :ACCESSOR %HANDLER)
   (ERROR-ACTION :DOCUMENTATION "One of :ignore, :warn, :error." :ALLOCATION
    :INSTANCE :ACCESSOR %ERROR-ACTION)))

(CL:DEFUN NEW-CMD-LINE-OPTION ()
  (CL:LET* ((SELF NULL))
   (CL:SETQ SELF (CL:MAKE-INSTANCE (CL:QUOTE CMD-LINE-OPTION)))
   (CL:SETF (%ERROR-ACTION SELF) KWD-SYSTEMS-ERROR)
   (CL:SETF (%HANDLER SELF) (CL:FUNCTION DEFAULT-CMD-LINE-OPTION-HANDLER))
   (CL:SETF (%CONFIGURATION-PROPERTY SELF) STELLA::NULL-STRING)
   (CL:SETF (%DEFAULT-VALUE SELF) NULL) (CL:SETF (%N-ARGUMENTS SELF) 0)
   (CL:SETF (%MULTI-VALUED? SELF) CL:NIL)
   (CL:SETF (%VALUE-TYPE SELF) SGT-SYSTEMS-STELLA-STRING)
   (CL:SETF (%KEYS SELF) NIL)
   (CL:SETF (%DOCUMENTATION SELF) "Not documented.")
...
(CL:DEFUN ACCESS-CMD-LINE-OPTION-SLOT-VALUE (SELF SLOTNAME VALUE SETVALUE?)
  (CL:COND
   ...
   ((CL:EQ SLOTNAME SYM-SYSTEMS-STELLA-KEYS)
    (CL:IF SETVALUE? (CL:SETF (%KEYS SELF) VALUE)
     (CL:SETQ VALUE (%KEYS SELF))))
   ((CL:EQ SLOTNAME SYM-SYSTEMS-STELLA-VALUE-TYPE)
    (CL:IF SETVALUE? (CL:SETF (%VALUE-TYPE SELF) VALUE)
     (CL:SETQ VALUE (%VALUE-TYPE SELF))))
   ((CL:EQ SLOTNAME SYM-SYSTEMS-STELLA-MULTI-VALUED?)
    (CL:IF SETVALUE?
     (CL:SETF (%MULTI-VALUED? SELF) (COERCE-WRAPPED-BOOLEAN-TO-BOOLEAN VALUE))
     (CL:SETQ VALUE
      (CL:IF (%MULTI-VALUED? SELF) TRUE-WRAPPER FALSE-WRAPPER))))
   ...
   ((CL:EQ SLOTNAME SYM-SYSTEMS-STELLA-DEFAULT-VALUE)
    (CL:IF SETVALUE? (CL:SETF (%DEFAULT-VALUE SELF) VALUE)
     (CL:SETQ VALUE (%DEFAULT-VALUE SELF))))
   ((CL:EQ SLOTNAME SYM-SYSTEMS-STELLA-CONFIGURATION-PROPERTY)
    (CL:IF SETVALUE?
     (CL:SETF (%CONFIGURATION-PROPERTY SELF) (%WRAPPER-VALUE VALUE))
   ...
   ((CL:EQ SLOTNAME SYM-SYSTEMS-STELLA-ERROR-ACTION)
    (CL:IF SETVALUE? (CL:SETF (%ERROR-ACTION SELF) VALUE)
     (CL:SETQ VALUE (%ERROR-ACTION SELF))))
   (CL:T
    (CL:LET* ((STREAM-000 (NEW-OUTPUT-STRING-STREAM)))
  ...
  (CL:LET* ((ARGLIST-000 NIL))
   ...
   (CL:LET*
    ((THEOPTIONS
      (PARSE-OPTIONS ARGLIST-000
       (LIST* KWD-SYSTEMS-DOCUMENTATION SGT-SYSTEMS-STELLA-STRING
        ...
        SGT-SYSTEMS-STELLA-STRING KWD-SYSTEMS-KEY3 SGT-SYSTEMS-STELLA-STRING
        KWD-SYSTEMS-KEYS SGT-SYSTEMS-STELLA-CONS KWD-SYSTEMS-VALUE-TYPE
    ...
    (CL:WHEN (CL:NOT (CL:EQ VALUE NULL))
     (CL:SETF (%KEYS CMDLINEOPTION) (CONS VALUE (%KEYS CMDLINEOPTION))))
    ...
    (CL:SETF (%N-ARGUMENTS CMDLINEOPTION)
     (%WRAPPER-VALUE
      (LOOKUP-WITH-DEFAULT THEOPTIONS KWD-SYSTEMS-N-ARGUMENTS
       (WRAP-INTEGER 0))))
    (CL:SETF (%DEFAULT-VALUE CMDLINEOPTION)
    ...
    (CL:SETF (%ERROR-ACTION CMDLINEOPTION)
...
(CL:DEFUN DEFAULT-CMD-LINE-OPTION-HANDLER (OPTION VALUE)
  ...
  (CL:LET*
   ((PROPERTY (%CONFIGURATION-PROPERTY OPTION))
   ...
   (CL:WHEN
    (CL:AND (CL:EQ DEFAULTVALUE NULL)
     (CL:EQ (%VALUE-TYPE OPTION) SGT-SYSTEMS-STELLA-BOOLEAN))
...
accurately reflects the arguments which have been either skipped or not handled yet."
  ...
  (CL:LET*
   ((CMDLINEARGS (COPY-CONS-LIST *UNPROCESSED-COMMAND-LINE-ARGUMENTS*))
    (ARGUMENT STELLA::NULL-STRING) (NARGS (LENGTH CMDLINEARGS)) (OPTION NULL)
    (VALUE NULL)
   ...
   (CL:LOOP WHILE (CL:NOT (CL:EQ CMDLINEARGS NIL)) DO
    (CL:TAGBODY
     ...
     (CL:SETQ OPTION
      (LOOKUP *REGISTERED-COMMAND-LINE-OPTIONS* (WRAP-STRING ARGUMENT)))
     (CL:SETQ VALUE NULL)
     (CL:COND
      ((CL:NOT (CL:EQ OPTION NULL))
       ...
       (CL:CASE (%N-ARGUMENTS OPTION) (0)
        (1
         (CL:LET* ((HEAD-001 (%%VALUE CMDLINEARGS)))
          (CL:SETQ CMDLINEARGS (%%REST CMDLINEARGS)) (CL:SETQ VALUE HEAD-001))
         (CL:SETQ NARGS (CL:1- NARGS)))
        (CL:OTHERWISE
         (CL:LET* ((VALUE-000 NIL))
          (CL:LET*
           ((ARG NULL) (ITER-000 CMDLINEARGS) (I NULL-INTEGER) (ITER-001 1)
            (UPPER-BOUND-000 (%N-ARGUMENTS OPTION))
       ...
       (CL:SETF (%%REST UNPROCESSEDTRAILER)
        (NTH-REST UNPROCESSEDTRAILER (CL:+ (%N-ARGUMENTS OPTION) 2)))
         ...
         (CL:LET* ((TEST-VALUE-001 (%ERROR-ACTION OPTION)))
          (CL:COND
           ...
           ((CL:EQ TEST-VALUE-001 KWD-SYSTEMS-WARN)
            (CL:WARN "Error during processing of `~A' option: `~A'" ARGUMENT
             (EXCEPTION-MESSAGE E)))
      ...
      (CL:COND
       ...
       (CL:T
        (CL:LET* ((STREAM-005 (NEW-OUTPUT-STRING-STREAM)))
         (%%PRINT-STREAM (%NATIVE-STREAM STREAM-005) "`" UNHANDLEDOPTIONACTION
          "' is not a valid case option")
...
(CL:DEFUN EVAL-OPTION-HANDLER (OPTION VALUE)
  ...
  (%EVALUATE
   (CL:IF (STRING? VALUE)
    (READ-S-EXPRESSION-FROM-STRING (%WRAPPER-VALUE VALUE)) VALUE))
  :VOID)
...
(CL:DEFUN LOAD-PATH-OPTION-HANDLER (OPTION VALUE)
  ...
  (CL:COND
   ((MEMBER? (%KEYS OPTION) (WRAP-STRING "--path="))
    (%SET-LOAD-PATH (%WRAPPER-VALUE VALUE)))
   ((MEMBER? (%KEYS OPTION) (WRAP-STRING "--path=+"))
    (%ADD-LOAD-PATH (%WRAPPER-VALUE VALUE)))
...
(CL:DEFUN DEFINE-PROPERTY-OPTION-HANDLER (OPTION VALUE)
  ...
  (CL:LET* ((PROP NULL) (VAL NULL) (OP NULL))
   (CL:MULTIPLE-VALUE-SETQ (PROP VAL OP)
    (PARSE-CONFIGURATION-FILE-LINE (%WRAPPER-VALUE VALUE)))
   (CL:IF (CL:EQ OP KWD-SYSTEMS-ADD)
    (ADD-CONFIGURATION-PROPERTY (%WRAPPER-VALUE PROP) VAL NULL)
  ...
  (CL:LET* ((SORTEDOPTIONS NIL))
    ...
    (CL:LOOP WHILE (NEXT? ITER-000) DO (CL:SETQ KEY (%KEY ITER-000))
     ...
     (CL:WHEN (EQL? KEY (%%VALUE (%KEYS OPTION)))
      (CL:LOOP WHILE (STARTS-WITH? (%WRAPPER-VALUE KEY) "-" 0) DO
       (CL:SETQ KEY
        (WRAP-STRING (SUBSEQUENCE (UNWRAP-STRING KEY) 1 NULL-INTEGER))))
      ...
      (CL:IF (CL:EQ COLLECT-000 NULL)
       ...
       (CL:PROGN
        (CL:SETF (%%REST COLLECT-000) (CONS (CONS-LIST KEY OPTION) NIL))
        (CL:SETQ COLLECT-000 (%%REST COLLECT-000)))))))
   ...
   (CL:LET* ((TUPLE NULL) (ITER-001 SORTEDOPTIONS))
    (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-001 NIL)) DO
     ...
     (CL:LET*
      ((KEY NULL) (ITER-002 (%KEYS OPTION)) (I NULL-INTEGER) (ITER-003 1))
      (CL:DECLARE (CL:TYPE CL:FIXNUM I ITER-003))
      (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-002 NIL)) DO
       (CL:SETQ KEY (%%VALUE ITER-002)) (CL:SETQ I ITER-003)
       (CL:WHEN (CL:> I 1)
        (%%PRINT-STREAM (%NATIVE-STREAM STANDARD-OUTPUT) ", "))
       (%%PRINT-STREAM (%NATIVE-STREAM STANDARD-OUTPUT) (UNWRAP-STRING KEY))
       (CL:SETQ ITER-002 (%%REST ITER-002))
       (CL:SETQ ITER-003 (CL:1+ ITER-003))))
     (%%PRINT-STREAM (%NATIVE-STREAM STANDARD-OUTPUT) " ")
     (%%PRINT-STREAM (%NATIVE-STREAM STANDARD-OUTPUT) (%DOCUMENTATION OPTION)
      EOL)
     (CL:SETQ ITER-001 (%%REST ITER-001))))
...
(CL:DEFUN HELP-STARTUP-SYSTEMS2 ()
  (CL:PROGN
   ...
   (CL:SETQ SYM-SYSTEMS-STELLA-DEFINE-MODULE-FROM-STRINGIFIED-SOURCE
    (INTERN-RIGID-SYMBOL-WRT-MODULE "DEFINE-MODULE-FROM-STRINGIFIED-SOURCE"
     NULL 0))
...
and return the removed element.\" :PUBLIC? TRUE :COMMAND? TRUE)"
    (CL:FUNCTION POP-LOAD-PATH) (CL:FUNCTION POP-LOAD-PATH-EVALUATOR-WRAPPER))
...
`path' to the end of the STELLA load path.  Return the resulting
load path.\" :PUBLIC? TRUE :COMMAND? TRUE)" (CL:FUNCTION %ADD-LOAD-PATH)
...
`:startup?' (default true): if true, the system startup function will
be called once all files have been loaded.\" :PUBLIC? TRUE :COMMAND? TRUE)"
    (CL:FUNCTION %LOAD-SYSTEM) (CL:FUNCTION LOAD-SYSTEM-EVALUATOR-WRAPPER))
...
perform the appropriate actions on required systems in `define-system'.\")")
  ...
  Evaluate the STELLA <s-expression> in the current module.")
     ...
     KWD-SYSTEMS-WARN)
    (REGISTER-CMD-LINE-OPTION KWD-SYSTEMS-KEY (WRAP-STRING "--eval-in-module")
  ...
  Evaluate the STELLA <s-expression> in module <module-name>.")
     ...
     SYM-SYSTEMS-STELLA-EVAL-IN-MODULE-OPTION-HANDLER KWD-SYSTEMS-ERROR-ACTION
     KWD-SYSTEMS-WARN)
    (REGISTER-CMD-LINE-OPTION KWD-SYSTEMS-KEY (WRAP-STRING "--path")
     KWD-SYSTEMS-KEY2 (WRAP-STRING "--path+=") KWD-SYSTEMS-DOCUMENTATION
     (WRAP-STRING "<path>
  Add <path> to the front of the current file load path.")
     KWD-SYSTEMS-N-ARGUMENTS (WRAP-INTEGER 1) KWD-SYSTEMS-HANDLER
     SYM-SYSTEMS-STELLA-LOAD-PATH-OPTION-HANDLER KWD-SYSTEMS-ERROR-ACTION
     KWD-SYSTEMS-WARN)
    (REGISTER-CMD-LINE-OPTION KWD-SYSTEMS-KEY (WRAP-STRING "--path=")
     KWD-SYSTEMS-DOCUMENTATION
     (WRAP-STRING "<path>
  ...
  Load the STELLA configuration file <file>.")
     KWD-SYSTEMS-N-ARGUMENTS (WRAP-INTEGER 1) KWD-SYSTEMS-HANDLER
     SYM-SYSTEMS-STELLA-CONFIG-FILE-OPTION-HANDLER KWD-SYSTEMS-ERROR-ACTION
     KWD-SYSTEMS-WARN)
  ...
  Load the STELLA file <file>.")
     KWD-SYSTEMS-N-ARGUMENTS (WRAP-INTEGER 1) KWD-SYSTEMS-HANDLER
     SYM-SYSTEMS-STELLA-LOAD-FILE-OPTION-HANDLER KWD-SYSTEMS-ERROR-ACTION
     KWD-SYSTEMS-WARN)
    (REGISTER-CMD-LINE-OPTION KWD-SYSTEMS-KEY (WRAP-STRING "-D")
     KWD-SYSTEMS-KEY2 (WRAP-STRING "--define") KWD-SYSTEMS-DOCUMENTATION
