...
(CL:DECLAIM
  ...
  *MODULE* NIL *CURRENTSYSTEMDEFINITION* TRUE EOL FALSE
...
(CL:DEFUN CPP-OUTPUT-NAMESPACE-HEADER (MODULE)
  ...
  (CL:LET*
   ((USEE NULL)
    (ITER-000 (REVERSE (%%REST (CONSIFY (VISIBLE-MODULES MODULE))))))
   (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-000 NIL)) DO
...
(CL:DEFUN CPP-UNIT-DEFINES-MAIN? (UNIT)
  (CL:RETURN-FROM CPP-UNIT-DEFINES-MAIN?
   (CL:AND
    ...
    (CL:EQ (%SLOT-NAME (%THE-OBJECT UNIT))
     SYM-CPP-TRANSLATE-FILE-STELLA-MAIN))))
...
(CL:DEFUN CPP-OUTPUT-MAIN (UNIT)
  (CL:LET*
   ((*CURRENT-STREAM*
     (NEW-OUTPUT-FILE-STREAM (CPP-YIELD-MAIN-FILE-NAME))))
   ...
   (CL:LET*
    ((USEE NULL)
     (ITER-000 (REVERSE (CONSIFY (VISIBLE-MODULES *MODULE*)))))
    (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-000 NIL)) DO
     (CL:PROGN (CL:SETQ USEE (%%VALUE ITER-000))
      (CL:SETQ ITER-000 (%%REST ITER-000)))
     (%%PRINT-STREAM (%NATIVE-STREAM *CURRENT-STREAM*)
    ...
    (CL:LET* ((BUCKET NULL) (ITER-000 (%THE-CONS-LIST HEADERUNITS)))
     (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-000 NIL)) DO
      (CL:PROGN (CL:SETQ BUCKET (%%VALUE ITER-000))
       (CL:SETQ ITER-000 (%%REST ITER-000)))
      (CL:LET*
       ((I NULL-INTEGER) (UNIT NULL) (ITER-001 BUCKET) (ITER-002 1))
      ...
      (CL:PROGN
       (CL:SETQ MAKEFILE
        (MAKE-FILE-NAME "Makefile-default"
         KWD-CPP-TRANSLATE-FILE-STELLA TRUE))
...
(CL:DEFUN SUBSTITUTE-TEMPLATE-VARIABLES-TO-MAKEFILE (TEMPLATEFILE OUTPUTFILE VARIABLES)
  ...
  (CL:LET* ((OUT (NEW-OUTPUT-FILE-STREAM OUTPUTFILE)))
   ...
   (SUBSTITUTE-TEMPLATE-VARIABLES-TO-STREAM
    (NEW-INPUT-FILE-STREAM TEMPLATEFILE) OUT VARIABLES)
   (FREE OUT))
  :VOID)
   ...
   (CL:WHEN (CURRENT-STARTUP-TIME-PHASE? 7)
    ...
    (CL:LET*
     ...
     (SET-DYNAMIC-SLOT-VALUE (%DYNAMIC-SLOTS FUNCTION)
      ...
      (WRAP-STRING "_Startup-Cpp-Translate-File")
      NULL-STRING-WRAPPER)))
