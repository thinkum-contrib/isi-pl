...
(CL:DECLAIM
 (CL:SPECIAL *STELLA-MODULE* *CPP-CURRENT-UNIT-MODULE* *CURRENTFILE*
  TRUE-WRAPPER *TRANSLATIONUNITS* NULL-INTEGER *CHARACTER-TYPE-TABLE* *MODULE*
  NIL *CURRENTSYSTEMDEFINITION* EOL *TRANSLATOROUTPUTLANGUAGE*
  STANDARD-OUTPUT))
...
(CL:DEFUN CPP-STANDALONE-OUTPUT-IMPORT-DECLARATIONS (HEADERFILENAME)
  (CPP-OUTPUT-INCLUDE-DIRECTIVE
   (MAKE-FILE-NAME "cpp-standalone" KWD-CPP-TRANSLATE-FILE-CPP-HEADER CL:T)
   CL:T)
  ...
  (CL:LET*
   ...
   (CL:IF (CL:NOT (CL:EQ *CURRENTSYSTEMDEFINITION* NULL))
    (CL:PROGN
     (CL:LET*
      ((DIRECTORYFILE
        (MAKE-FILE-NAME "dummy" KWD-CPP-TRANSLATE-FILE-CPP-HEADER CL:T)))
      (CL:SETQ HEADERFILE
...
(CL:DEFUN CPP-OUTPUT-NAMESPACE-HEADER (MODULE)
  ...
  (CL:LET*
   ((USEE NULL)
    (ITER-000
     (REVERSE (COPY-CONS-LIST (%%REST (CONSIFY (VISIBLE-MODULES MODULE)))))))
   (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-000 NIL)) DO
     ...
     (CL:LET* ((*CURRENT-STREAM* OUT))
      ...
      (CL:WHEN (CL:NOT (CL:EQ *CURRENTSYSTEMDEFINITION* NULL))
       (%%PRINT-STREAM (%NATIVE-STREAM *CURRENT-STREAM*)
        "// main entry point for " (%NAME *CURRENTSYSTEMDEFINITION*) " system"
        EOL EOL))
      (CPP-OUTPUT-IMPORT-DECLARATIONS STELLA::NULL-STRING)
      (CL:LET*
       ((USEE NULL)
        (ITER-000
         (REVERSE (COPY-CONS-TREE (CONSIFY (VISIBLE-MODULES *MODULE*))))))
       (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-000 NIL)) DO
        (CL:SETQ USEE (%%VALUE ITER-000))
        (%%PRINT-STREAM (%NATIVE-STREAM *CURRENT-STREAM*) "using namespace "
         (CPP-YIELD-NAMESPACE-PREFIX-FROM-MODULE USEE) ";" EOL)
         ...
         (CL:LET* ((*CURRENT-STREAM* HEADEROUTPUTSTREAM))
          ...
          (CL:LET* ((BUCKET NULL) (ITER-000 (%THE-CONS-LIST HEADERUNITS)))
           (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-000 NIL)) DO
            ...
            (CL:LET*
             ((UNIT NULL) (ITER-001 BUCKET) (I NULL-INTEGER) (ITER-002 1))
          ...
          (CL:LET*
           ...
           (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-003 NIL)) DO
            ...
            (CL:LET* ((TEST-VALUE-002 (%CATEGORY UNIT)))
             (CL:COND
              ((CL:OR
                (CL:EQ TEST-VALUE-002 SYM-CPP-TRANSLATE-FILE-STELLA-METHOD)
...
(CL:DEFUN CPP-TRANSLATE-SYSTEM (SYSTEMNAME)
  ...
  (%TRANSLATE-SYSTEM SYSTEMNAME
   (CONS-LIST KWD-CPP-TRANSLATE-FILE-CPP KWD-CPP-TRANSLATE-FILE-TWO-PASS?
    TRUE-WRAPPER KWD-CPP-TRANSLATE-FILE-FORCE-TRANSLATION? TRUE-WRAPPER
    ...
    (CL:UNWIND-PROTECT
     (CL:PROGN
      ...
      (CL:LET*
       ...
       (CL:DECLARE
        (CL:SPECIAL *CURRENT-STREAM* *MODULE* *CPP-CURRENT-UNIT-MODULE*))
       (%%PRINT-STREAM (%NATIVE-STREAM *CURRENT-STREAM*) "// "
   ...
   (CL:LET*
    ...
    (CL:SETQ MAKEFILE
     (FILE-NAME-WITHOUT-EXTENSION
      (MAKE-FILE-NAME "Makefile" KWD-CPP-TRANSLATE-FILE-CPP-CODE CL:T)))
