...
(CL:DECLAIM
  ...
  *CHARACTER-TYPE-TABLE* TRUE TRUE-WRAPPER FALSE-WRAPPER NULL-FLOAT
  NULL-INTEGER NIL FALSE))
      ...
      (CL:WHEN (CL:= (%DATE-TIME-ZONE PARSED-VALUES) NULL-FLOAT)
       (CL:SETF (%DATE-TIME-ZONE PARSED-VALUES)
        (GET-LOCAL-TIME-ZONE-FOR-DATE (%DATE-TIME-YEAR PARSED-VALUES)
         (%DATE-TIME-MONTH PARSED-VALUES)
         (%DATE-TIME-DAY PARSED-VALUES) (%DATE-TIME-HOUR PARSED-VALUES)
         (%DATE-TIME-MINUTE PARSED-VALUES)
  ...
  (CL:LET* ((*MODULE* *STELLA-MODULE*) (*CONTEXT* *MODULE*))
     ...
     ((ITEM NULL)
      (ITER-039
       (LIST*
        ...
        (LIST* (WRAP-STRING "tuesday") KWD-DATE-TIME-PARSER-TUESDAY
         NIL)
    ...
    (CL:SETQ *DATE-TIME-PATTERNS*
     (LIST*
      ...
      (LIST* SYM-DATE-TIME-PARSER-STELLA-WEEKDAY
       SYM-DATE-TIME-PARSER-STELLA-MONTH
       SYM-DATE-TIME-PARSER-STELLA-DAY SYM-DATE-TIME-PARSER-STELLA-HOUR
       (CONS SYM-DATE-TIME-PARSER-STELLA-TIME-DIVIDER NIL)
   ...
   (CL:WHEN (CURRENT-STARTUP-TIME-PHASE? 7)
    ...
    (DEFINE-FUNCTION-OBJECT "TODAY"
     "(DEFUN TODAY ((PARSED-VALUES DECODED-DATE-TIME)))"
    ...
    (DEFINE-FUNCTION-OBJECT "NOW"
     "(DEFUN NOW ((PARSED-VALUES DECODED-DATE-TIME)))"
