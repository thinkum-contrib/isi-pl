...
(CL:DECLAIM
 (CL:SPECIAL *STELLA-MODULE* *MODULE* TRUE *CHARACTER-TYPE-TABLE* NULL-CHARACTER
  NULL-INTEGER FALSE TRUE-WRAPPER NIL))
...
appropriate transforms.  The arguments are used as follows:
  ...
  (CL:LET* ((SELF-000 (NEW-PROPERTY-LIST)))
   ...
   (CL:LET*
    ...
    (CL:DECLARE
     (CL:TYPE CL:SIMPLE-STRING BREAKONSEPARATORS REMOVEPREFIX REMOVESUFFIX
      ADDPREFIX ADDSUFFIX OUTPUTSEPARATOR))
    (VET-OPTIONS PLIST
     (GET-QUOTED-TREE
      ...
      (CL:LET* ((TEST-VALUE-000 KEY))
       (CL:COND
        ...
        ((CL:EQ TEST-VALUE-000 KWD-NAME-UTILITY-BREAK-ON-NUMBER)
         (CL:IF (CL:NOT (CL:EQ VALUE NULL)) (CL:SETQ BREAKONNUMBER VALUE)
    ...
    (CL:RETURN-FROM MAKE-MATCHING-NAME
     (MAKE-MATCHING-NAME-FULL ORIGINAL BREAKONCAP BREAKONNUMBER BREAKONSEPARATORS
      REMOVEPREFIX REMOVESUFFIX ADDPREFIX ADDSUFFIX OUTPUTCASE OUTPUTSEPARATOR)))))
(CL:DECLAIM
  ...
  (CL:LET* ((SELF-000 (NEW-PROPERTY-LIST)))
   ...
   (CL:LET*
    ((PLIST SELF-000) (PREFIX "") (SUFFIX "")
     (OUTPUTCASE KWD-NAME-UTILITY-TITLECASE) (OUTPUTSEPARATOR "")
     (TRANSLATION-TABLE NULL) (USE-ACRONYM-HEURISTICS? FALSE))
...
(CL:DECLAIM
 (CL:FTYPE (CL:FUNCTION (CL:T CL:T) CL:SIMPLE-STRING) COMPOSE-NAMESTRING))
...
easier to use when called from non-Lisp languages."
  (CL:DECLARE
   (CL:TYPE CL:SIMPLE-STRING ORIGINALNAME BREAKONSEPARATORS REMOVEPREFIX
  ...
  (CL:LET*
   ...
   (CL:DECLARE (CL:TYPE CL:FIXNUM PREFIXLENGTH SUFFIXLENGTH RESULT-LENGTH)
...
(CL:DECLAIM
 (CL:FTYPE
  (CL:FUNCTION
   (CL:SIMPLE-STRING CL:T CL:T CL:SIMPLE-STRING CL:SIMPLE-STRING CL:SIMPLE-STRING
    CL:SIMPLE-STRING CL:SIMPLE-STRING CL:T CL:SIMPLE-STRING)
   CL:SIMPLE-STRING)
...
easier to use when called from non-Lisp languages."
  ...
  (CL:LET*
   ((LEN (CL:THE CL:FIXNUM (CL:LENGTH NAMESTRING))) (RESULT NIL) (LAG 0) (LEAD 0)
    (INCAPRUN? FALSE) (INNUMBER? FALSE))
     ...
     (CL:LET* ((FOUND?-000 FALSE))
      (CL:LET*
       ...
       (CL:LOOP WHILE (CL:< INDEX-001 LENGTH-001) DO
        ...
        (CL:WHEN (CL:EQL SEP C) (CL:SETQ FOUND?-000 TRUE) (CL:RETURN))))
      (CL:IF FOUND?-000
       (CL:PROGN
        (CL:SETQ RESULT
         (CONS (WRAP-STRING (SUBSEQUENCE NAMESTRING LAG LEAD)) RESULT))
        (CL:SETQ LAG (CL:1+ LEAD)) (CL:SETQ INNUMBER? FALSE)
        (CL:SETQ INCAPRUN? FALSE))
       (CL:IF (CL:> LAG LEAD) (CL:PROGN)
        (CL:IF
         (CL:EQ
          (CL:AREF *CHARACTER-TYPE-TABLE* (CL:THE CL:FIXNUM (CL:CHAR-CODE C)))
          ...
          (CL:COND
           ((CL:AND (CL:NOT INNUMBER?)
            ...
            (CL:WHEN (CL:NOT (CL:= LEAD LAG))
             ...
             (CL:SETQ LAG LEAD)))
           (CL:T))
          (CL:SETQ INCAPRUN? FALSE) (CL:SETQ INNUMBER? TRUE))
           ...
           (CL:WHEN
            ...
            (CL:COND ((CL:= LEAD LAG))
             ...
             ((CL:AND (CL:< LEAD (CL:1- LEN))
              ...
              (CL:SETQ RESULT
               (CONS (WRAP-STRING (SUBSEQUENCE NAMESTRING LAG (CL:+ LEAD 2)))
                RESULT))
           ...
           (CL:COND ((CL:> LAG LEAD)) ((CL:EQ BREAK-ON-CAP KWD-NAME-UTILITY-NO))
            ...
            (INCAPRUN?
             (CL:WHEN (CL:NOT (CL:= LEAD (CL:1+ LAG)))
              (CL:SETQ RESULT
               (CONS (WRAP-STRING (SUBSEQUENCE NAMESTRING LAG (CL:1- LEAD)))
                RESULT))
              (CL:SETQ LAG (CL:1- LEAD)))))
           (CL:SETQ INNUMBER? FALSE) (CL:SETQ INCAPRUN? FALSE))
            ...
            (CL:T
             (CL:WHEN (CL:NOT (CL:= LEAD LAG))
              (CL:SETQ RESULT
               (CONS (WRAP-STRING (SUBSEQUENCE NAMESTRING LAG LEAD)) RESULT))
              (CL:SETQ LAG LEAD))
             (CL:SETQ INCAPRUN? TRUE)))
           (CL:SETQ INNUMBER? FALSE)))))))
     (CL:SETQ LEAD (CL:1+ LEAD))))
   (CL:WHEN (CL:>= LEAD LAG)
    (CL:SETQ RESULT
     (CONS (WRAP-STRING (SUBSEQUENCE NAMESTRING LAG NULL-INTEGER)) RESULT)))
  ...
  (CL:LET*
   ...
   (CL:RETURN-FROM SUFFIX-MATCHES?
    (CL:AND (CL:<= SUFFIXLENGTH STRINGLENGTH)
     (STRING-EQL? SUFFIX
      (SUBSEQUENCE TESTSTRING (CL:- STRINGLENGTH SUFFIXLENGTH) NULL-INTEGER))))))
...
(CL:DEFUN ORDINAL-NUMBER-STRING? (TESTSTRING)
  ...
  (CL:LET*
   ...
   (CL:WHEN (CL:< LEN 3) (CL:RETURN-FROM ORDINAL-NUMBER-STRING? FALSE))
   (CL:LET*
    ((I NULL-INTEGER) (C NULL-CHARACTER) (VECTOR-000 TESTSTRING) (INDEX-000 0)
     (LENGTH-000 (CL:THE CL:FIXNUM (CL:LENGTH VECTOR-000))) (ITER-000 0)
     ...
     (CL:WHEN
      (CL:NOT
       (CL:EQ
        (CL:AREF *CHARACTER-TYPE-TABLE* (CL:THE CL:FIXNUM (CL:CHAR-CODE C)))
        KWD-NAME-UTILITY-DIGIT))
      (CL:RETURN-FROM ORDINAL-NUMBER-STRING? FALSE))))
   (CL:WHEN (CL:NOT TEEN?)
    (CL:CASE
...
(CL:DEFUN HEURISTIC-ACRONYM? (ITEMSTRING)
  ...
  (CL:LET* ((LETTERFOUND? FALSE) (NUMBERFOUND? FALSE))
   (CL:LET*
    ...
    (CL:LOOP WHILE (CL:< INDEX-000 LENGTH-000) DO
     ...
     (CL:COND
      ((CL:EQ
        (CL:AREF *CHARACTER-TYPE-TABLE* (CL:THE CL:FIXNUM (CL:CHAR-CODE C)))
        KWD-NAME-UTILITY-DIGIT)
       (CL:SETQ NUMBERFOUND? TRUE))
      ((CL:OR (LOWER-CASE-CHARACTER? C) (UPPER-CASE-CHARACTER? C))
       (CL:SETQ LETTERFOUND? TRUE))
      ((MEMBER? (GET-QUOTED-TREE "((#\\. #\\- #\\/) \"/STELLA\")" "/STELLA")
        (WRAP-CHARACTER C))
       (CL:SETQ NUMBERFOUND? TRUE))
      (CL:T (CL:RETURN-FROM HEURISTIC-ACRONYM? FALSE)))))
...
easier to use when called from non-Lisp languages."
  ...
  (CL:LET*
   ((N 0) (I 0) (OUT STELLA::NULL-STRING)
    ...
    (FIRSTTIME? TRUE) (S STELLA::NULL-STRING) (S-LEN 0))
    ...
    (CL:LET* ((TEMP STRINGS)) (CL:SETQ STRINGS NIL)
     (CL:LET* ((SW NULL) (ITER-000 TEMP) (COLLECT-000 NULL))
      (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-000 NIL)) DO
       (CL:PROGN (CL:SETQ SW (%%VALUE ITER-000))
        (CL:SETQ ITER-000 (%%REST ITER-000)))
       (CL:WHEN
        (CL:NOT (CL:EQ (LOOKUP TRANSLATIONTABLE (%WRAPPER-VALUE SW)) NULL))
        (CL:IF (CL:EQ COLLECT-000 NULL)
         (CL:PROGN
          (CL:SETQ COLLECT-000
   ...
   (CL:LET* ((SW NULL) (ITER-001 STRINGS))
    (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-001 NIL)) DO
     (CL:PROGN (CL:SETQ SW (%%VALUE ITER-001))
      (CL:SETQ ITER-001 (%%REST ITER-001)))
     (CL:SETQ N
      (CL:+ N
       (CL:THE CL:FIXNUM
        (CL:LENGTH (CL:THE CL:SIMPLE-STRING (%WRAPPER-VALUE SW))))))))
   (CL:SETQ N (CL:+ N (CL:* (CL:1- (LENGTH STRINGS)) SEPARATOR-LENGTH)))
   (CL:SETQ OUT (MAKE-RAW-MUTABLE-STRING N))
   (CL:WHEN (CL:NOT (CL:EQ PREFIX STELLA::NULL-STRING))
    (CL:SETQ I
     (INSERT-STRING PREFIX 0 NULL-INTEGER OUT I KWD-NAME-UTILITY-PRESERVE)))
   (CL:LET* ((SW NULL) (ITER-002 STRINGS))
    (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-002 NIL)) DO
     (CL:PROGN (CL:SETQ SW (%%VALUE ITER-002))
      (CL:SETQ ITER-002 (%%REST ITER-002)))
     (CL:SETQ S (%WRAPPER-VALUE SW))
     ...
     (CL:COND ((CL:= S-LEN 0))
      ((CL:AND USEACRONYMHEURISTICS? (HEURISTIC-ACRONYM? S))
       (CL:SETQ I
        (INSERT-STRING S 0 (CL:1- S-LEN) OUT I KWD-NAME-UTILITY-PRESERVE)))
      (CL:T
       (CL:COND
        ((CL:OR (CL:EQ OUTPUTCASE KWD-NAME-UTILITY-ALLCAPS)
          (CL:EQ OUTPUTCASE KWD-NAME-UTILITY-UPCASE))
         (CL:SETQ I
          (INSERT-STRING S 0 (CL:1- S-LEN) OUT I KWD-NAME-UTILITY-UPCASE)))
        ((CL:EQ OUTPUTCASE KWD-NAME-UTILITY-DOWNCASE)
         (CL:SETQ I
          (INSERT-STRING S 0 (CL:1- S-LEN) OUT I KWD-NAME-UTILITY-DOWNCASE)))
        ((CL:EQ OUTPUTCASE KWD-NAME-UTILITY-TITLECASE)
         (CL:SETQ I
          (INSERT-STRING S 0 (CL:1- S-LEN) OUT I KWD-NAME-UTILITY-CAPITALIZE)))
   ...
   (CL:WHEN (CL:NOT (CL:EQ SUFFIX STELLA::NULL-STRING))
    (CL:SETQ I
     (INSERT-STRING SUFFIX 0 NULL-INTEGER OUT I KWD-NAME-UTILITY-PRESERVE)))
...
(CL:DECLAIM
 (CL:FTYPE
  (CL:FUNCTION
   (CL:T CL:SIMPLE-STRING CL:SIMPLE-STRING CL:T CL:SIMPLE-STRING CL:T CL:T)
   CL:SIMPLE-STRING)
  COMPOSE-NAMESTRING-FULL))
...
appropriate transforms.  The arguments are used as follows:
  ...
  :separator       This is a string specifying the word separator to use in the
                   ...
                   resulting words are concatenated without any separation.  This
                   normally only makes sense when using one of the title case values
                   for the case keyword.\")" (CL:FUNCTION MAKE-MATCHING-NAME)
     NULL)
...
easier to use when called from non-Lisp languages.\")"
    ...
    (CL:LET*
     ((FUNCTION (LOOKUP-FUNCTION SYM-NAME-UTILITY-STELLA-STARTUP-NAME-UTILITY)))
     (SET-DYNAMIC-SLOT-VALUE (%DYNAMIC-SLOTS FUNCTION)
      SYM-NAME-UTILITY-STELLA-METHOD-STARTUP-CLASSNAME
      (WRAP-STRING "_Startup-Name-Utility") NULL-STRING-WRAPPER)))
