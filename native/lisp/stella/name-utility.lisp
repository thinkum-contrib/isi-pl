...
appropriate transforms.  The arguments are used as follows:
  ...
  (CL:LET* ((SELF-000 (NEW-PROPERTY-LIST)))
   ...
   (CL:LET*
    ((PLIST SELF-000) (BREAKONCAP KWD-NAME-UTILITY-CLEVER) (BREAKONNUMBER KWD-NAME-UTILITY-CLEVER)
     (BREAKONSEPARATORS "-_ ") (REMOVEPREFIX "") (REMOVESUFFIX "") (ADDPREFIX "") (ADDSUFFIX "")
     (OUTPUTCASE KWD-NAME-UTILITY-TITLECASE) (OUTPUTSEPARATOR ""))
    (CL:DECLARE
     (CL:TYPE CL:SIMPLE-STRING BREAKONSEPARATORS REMOVEPREFIX REMOVESUFFIX ADDPREFIX ADDSUFFIX OUTPUTSEPARATOR))
    (VET-OPTIONS PLIST
     (GET-QUOTED-TREE
      ...
      (CL:LET* ((TEST-VALUE-000 KEY))
       (CL:COND
        ((CL:EQ TEST-VALUE-000 KWD-NAME-UTILITY-BREAK-ON-CAP)
         (CL:IF (CL:NOT (CL:EQ VALUE NULL)) (CL:SETQ BREAKONCAP VALUE) (CL:SETQ BREAKONCAP KWD-NAME-UTILITY-NO)))
    ...
    (CL:RETURN-FROM MAKE-MATCHING-NAME
     (MAKE-MATCHING-NAME-FULL ORIGINAL BREAKONCAP BREAKONNUMBER BREAKONSEPARATORS REMOVEPREFIX REMOVESUFFIX ADDPREFIX
      ADDSUFFIX OUTPUTCASE OUTPUTSEPARATOR)))))
...
input STRING.  The arguments are used as follows:
  ...
  (CL:LET* ((SELF-000 (NEW-PROPERTY-LIST)))
   ...
   (CL:LET*
    ...
    (VET-OPTIONS PLIST
     (GET-QUOTED-TREE "((:BREAK-ON-CAP :BREAK-ON-NUMBER :BREAK-ON-SEPARATORS) \"/STELLA\")" "/STELLA"))
    (CL:LET* ((KEY NULL) (VALUE NULL) (ITER-001 (%THE-PLIST PLIST)))
     (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-001 NIL)) DO (CL:SETQ KEY (%%VALUE ITER-001))
      (CL:SETQ VALUE (%%VALUE (%%REST ITER-001)))
      (CL:LET* ((TEST-VALUE-000 KEY))
...
"
  (CL:LET* ((SELF-000 (NEW-PROPERTY-LIST)))
   (CL:LET* ((ARGLIST-000 NIL))
    ...
    (CL:SETF (%THE-PLIST SELF-000) ARGLIST-000))
   (CL:LET*
    ((PLIST SELF-000) (PREFIX "") (SUFFIX "") (OUTPUTCASE KWD-NAME-UTILITY-TITLECASE) (OUTPUTSEPARATOR "")
     (TRANSLATION-TABLE NULL) (USE-ACRONYM-HEURISTICS? CL:NIL))
    (CL:DECLARE (CL:TYPE CL:SIMPLE-STRING PREFIX SUFFIX OUTPUTSEPARATOR))
    (VET-OPTIONS PLIST
     (GET-QUOTED-TREE "((:PREFIX :SUFFIX :CASE :SEPARATOR :TRANSLATION-TABLE :USE-ACRONYM-HEURISTICS?) \"/STELLA\")"
      "/STELLA"))
    (CL:LET* ((KEY NULL) (VALUE NULL) (ITER-001 (%THE-PLIST PLIST)))
     (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-001 NIL)) DO (CL:SETQ KEY (%%VALUE ITER-001))
      (CL:SETQ VALUE (%%VALUE (%%REST ITER-001)))
      (CL:LET* ((TEST-VALUE-000 KEY))
       (CL:COND ((CL:EQ TEST-VALUE-000 KWD-NAME-UTILITY-PREFIX) (CL:SETQ PREFIX (%WRAPPER-VALUE VALUE)))
        ...
        ((CL:EQ TEST-VALUE-000 KWD-NAME-UTILITY-USE-ACRONYM-HEURISTICS?)
    ...
    (CL:RETURN-FROM COMPOSE-NAMESTRING
     (COMPOSE-NAMESTRING-FULL NAME-COMPONENTS PREFIX SUFFIX OUTPUTCASE OUTPUTSEPARATOR TRANSLATION-TABLE
...
(CL:DECLAIM
 (CL:FTYPE
  (CL:FUNCTION
   (CL:SIMPLE-STRING CL:T CL:T CL:SIMPLE-STRING CL:SIMPLE-STRING CL:SIMPLE-STRING CL:SIMPLE-STRING CL:SIMPLE-STRING
    CL:T CL:SIMPLE-STRING)
   CL:SIMPLE-STRING)
...
easier to use when called from non-Lisp languages."
  (CL:DECLARE
   (CL:TYPE CL:SIMPLE-STRING ORIGINALNAME BREAKONSEPARATORS REMOVEPREFIX REMOVESUFFIX ADDPREFIX ADDSUFFIX
    OUTPUTSEPARATOR))
  #+MCL
  ...
  (CL:LET*
   ((PREFIXLENGTH (CL:THE CL:FIXNUM (CL:LENGTH REMOVEPREFIX)))
    (SUFFIXLENGTH (CL:THE CL:FIXNUM (CL:LENGTH REMOVESUFFIX))) (RESULT-STRING ORIGINALNAME) (RESULT-LENGTH 0))
   (CL:DECLARE (CL:TYPE CL:FIXNUM PREFIXLENGTH SUFFIXLENGTH RESULT-LENGTH) (CL:TYPE CL:SIMPLE-STRING RESULT-STRING))
   (CL:WHEN
    (CL:AND (CL:> PREFIXLENGTH 0) (CL:<= PREFIXLENGTH (CL:THE CL:FIXNUM (CL:LENGTH ORIGINALNAME)))
     (STRING-EQL? REMOVEPREFIX (SUBSEQUENCE ORIGINALNAME 0 PREFIXLENGTH)))
   ...
   (CL:SETQ RESULT-STRING
    (COMPOSE-NAMESTRING-FULL (DECOMPOSE-NAMESTRING-FULL RESULT-STRING BREAKONCAP BREAKONNUMBER BREAKONSEPARATORS)
     ADDPREFIX ADDSUFFIX OUTPUTCASE OUTPUTSEPARATOR NULL CL:NIL))
   (CL:IF (STRING-EQL? RESULT-STRING "") (CL:RETURN-FROM MAKE-MATCHING-NAME-FULL ORIGINALNAME)
...
easier to use when called from non-Lisp languages."
  ...
  (CL:LET*
   ((LEN (CL:THE CL:FIXNUM (CL:LENGTH NAMESTRING))) (RESULT NIL) (LAG 0) (LEAD 0) (INCAPRUN? CL:NIL)
    (INNUMBER? CL:NIL))
   (CL:DECLARE (CL:TYPE CL:FIXNUM LEN LAG LEAD))
   (CL:LET*
    ((C NULL-CHARACTER) (VECTOR-000 NAMESTRING) (INDEX-000 0) (LENGTH-000 (CL:THE CL:FIXNUM (CL:LENGTH VECTOR-000))))
    ...
    (CL:LOOP WHILE (CL:< INDEX-000 LENGTH-000) DO
     ...
     (CL:LET* ((FOUND?-000 CL:NIL))
      (CL:LET*
       ((SEP NULL-CHARACTER) (VECTOR-001 BREAK-ON-SEPARATORS) (INDEX-001 0)
      ...
      (CL:IF FOUND?-000
       (CL:PROGN (CL:SETQ RESULT (CONS (WRAP-STRING (SUBSEQUENCE NAMESTRING LAG LEAD)) RESULT))
        (CL:SETQ LAG (CL:1+ LEAD)) (CL:SETQ INNUMBER? CL:NIL) (CL:SETQ INCAPRUN? CL:NIL))
          ...
          (CL:COND
           ((CL:AND (CL:NOT INNUMBER?) (CL:NOT (CL:EQ BREAK-ON-NUMBER KWD-NAME-UTILITY-NO)))
            (CL:WHEN (CL:NOT (CL:= LEAD LAG))
             (CL:SETQ RESULT (CONS (WRAP-STRING (SUBSEQUENCE NAMESTRING LAG LEAD)) RESULT)) (CL:SETQ LAG LEAD)))
           (CL:T))
           ...
           (CL:WHEN (CL:AND INNUMBER? (CL:NOT (CL:EQ BREAK-ON-NUMBER KWD-NAME-UTILITY-NO)))
            (CL:COND ((CL:= LEAD LAG))
             ...
             ((CL:AND (CL:< LEAD (CL:1- LEN)) (ORDINAL-NUMBER-STRING? (SUBSEQUENCE NAMESTRING LAG (CL:+ LEAD 2))))
              (CL:SETQ RESULT (CONS (WRAP-STRING (SUBSEQUENCE NAMESTRING LAG (CL:+ LEAD 2))) RESULT))
           ...
           (CL:COND ((CL:> LAG LEAD)) ((CL:EQ BREAK-ON-CAP KWD-NAME-UTILITY-NO))
            ...
            (INCAPRUN?
             (CL:WHEN (CL:NOT (CL:= LEAD (CL:1+ LAG)))
              (CL:SETQ RESULT (CONS (WRAP-STRING (SUBSEQUENCE NAMESTRING LAG (CL:1- LEAD))) RESULT))
...
(CL:DEFUN SUFFIX-MATCHES? (TESTSTRING SUFFIX)
  ...
  (CL:LET*
   ((STRINGLENGTH (CL:THE CL:FIXNUM (CL:LENGTH TESTSTRING))) (SUFFIXLENGTH (CL:THE CL:FIXNUM (CL:LENGTH SUFFIX))))
   (CL:DECLARE (CL:TYPE CL:FIXNUM STRINGLENGTH SUFFIXLENGTH))
   (CL:RETURN-FROM SUFFIX-MATCHES?
    (CL:AND (CL:<= SUFFIXLENGTH STRINGLENGTH)
     (STRING-EQL? SUFFIX (SUBSEQUENCE TESTSTRING (CL:- STRINGLENGTH SUFFIXLENGTH) NULL-INTEGER))))))
     ...
     (CL:AND (CL:> LEN 3)
      (CL:EQL #\1
       (CL:LET ((SELF TESTSTRING) (POSITION (CL:- LEN 4)))
        ...
        (CL:SCHAR (CL:THE CL:SIMPLE-STRING SELF) (CL:THE CL:FIXNUM POSITION))))))
    (SUFFIX "th"))
   (CL:DECLARE (CL:TYPE CL:FIXNUM LEN) (CL:TYPE CL:SIMPLE-STRING SUFFIX))
   (CL:WHEN (CL:< LEN 3) (CL:RETURN-FROM ORDINAL-NUMBER-STRING? CL:NIL))
   (CL:LET*
    ((C NULL-CHARACTER) (VECTOR-000 TESTSTRING) (INDEX-000 0) (LENGTH-000 (CL:THE CL:FIXNUM (CL:LENGTH VECTOR-000)))
    ...
    (CL:LOOP WHILE (CL:AND (CL:< INDEX-000 LENGTH-000) (CL:<= ITER-000 UPPER-BOUND-000)) DO
     ...
     (CL:WHEN
      (CL:NOT (CL:EQ (CL:AREF *CHARACTER-TYPE-TABLE* (CL:THE CL:FIXNUM (CL:CHAR-CODE C))) KWD-NAME-UTILITY-DIGIT))
...
(CL:DEFUN HEURISTIC-ACRONYM? (ITEMSTRING)
  ...
  (CL:LET* ((LETTERFOUND? CL:NIL) (NUMBERFOUND? CL:NIL))
   (CL:LET*
    ((C NULL-CHARACTER) (VECTOR-000 ITEMSTRING) (INDEX-000 0) (LENGTH-000 (CL:THE CL:FIXNUM (CL:LENGTH VECTOR-000))))
    (CL:DECLARE (CL:TYPE CL:SIMPLE-STRING VECTOR-000) (CL:TYPE CL:FIXNUM INDEX-000 LENGTH-000))
    (CL:LOOP WHILE (CL:< INDEX-000 LENGTH-000) DO
     (CL:SETQ C
      (CL:LET ((SELF VECTOR-000) (POSITION INDEX-000))
       ...
       (CL:SCHAR (CL:THE CL:SIMPLE-STRING SELF) (CL:THE CL:FIXNUM POSITION))))
     (CL:COND
      ((CL:EQ (CL:AREF *CHARACTER-TYPE-TABLE* (CL:THE CL:FIXNUM (CL:CHAR-CODE C))) KWD-NAME-UTILITY-DIGIT)
       (CL:SETQ NUMBERFOUND? CL:T))
      ((CL:OR (LOWER-CASE-CHARACTER? C) (UPPER-CASE-CHARACTER? C)) (CL:SETQ LETTERFOUND? CL:T))
      ((MEMBER? (GET-QUOTED-TREE "((#\\. #\\- #\\/) \"/STELLA\")" "/STELLA") (WRAP-CHARACTER C))
       (CL:SETQ NUMBERFOUND? CL:T))
...
(CL:DECLAIM
 (CL:FTYPE (CL:FUNCTION (CL:T CL:SIMPLE-STRING CL:SIMPLE-STRING CL:T CL:SIMPLE-STRING CL:T CL:T) CL:SIMPLE-STRING)
...
easier to use when called from non-Lisp languages."
  ...
  (CL:LET*
   ((N 0) (I 0) (OUT STELLA::NULL-STRING)
    (SEPARATOR-LENGTH
     (CL:IF (CL:NOT (CL:EQ OUTPUTSEPARATOR STELLA::NULL-STRING)) (CL:THE CL:FIXNUM (CL:LENGTH OUTPUTSEPARATOR)) 0))
      ...
      (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-000 NIL)) DO (CL:SETQ SW (%%VALUE ITER-000))
       (CL:WHEN (CL:NOT (CL:EQ (LOOKUP TRANSLATIONTABLE (%WRAPPER-VALUE SW)) NULL))
        (CL:IF (CL:EQ COLLECT-000 NULL)
         ...
         (CL:PROGN (CL:SETF (%%REST COLLECT-000) (CONS (LOOKUP TRANSLATIONTABLE (%WRAPPER-VALUE SW)) NIL))
   ...
   (CL:LET* ((SW NULL) (ITER-001 STRINGS))
    (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-001 NIL)) DO (CL:SETQ SW (%%VALUE ITER-001))
     (CL:SETQ N (CL:+ N (CL:THE CL:FIXNUM (CL:LENGTH (CL:THE CL:SIMPLE-STRING (%WRAPPER-VALUE SW))))))
   ...
   (CL:WHEN (CL:NOT (CL:EQ PREFIX STELLA::NULL-STRING))
    (CL:SETQ I (INSERT-STRING PREFIX 0 NULL-INTEGER OUT I KWD-NAME-UTILITY-PRESERVE)))
   (CL:LET* ((SW NULL) (ITER-002 STRINGS))
    (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-002 NIL)) DO (CL:SETQ SW (%%VALUE ITER-002)) (CL:SETQ S (%WRAPPER-VALUE SW))
     (CL:SETQ S-LEN (CL:THE CL:FIXNUM (CL:LENGTH S)))
     (CL:WHEN (CL:NOT FIRSTTIME?)
      (CL:WHEN (CL:> SEPARATOR-LENGTH 0)
       (CL:SETQ I (INSERT-STRING OUTPUTSEPARATOR 0 (CL:1- SEPARATOR-LENGTH) OUT I KWD-NAME-UTILITY-PRESERVE))))
     (CL:COND ((CL:= S-LEN 0))
      ((CL:AND USEACRONYMHEURISTICS? (HEURISTIC-ACRONYM? S))
       (CL:SETQ I (INSERT-STRING S 0 (CL:1- S-LEN) OUT I KWD-NAME-UTILITY-PRESERVE)))
      (CL:T
       (CL:COND
        ...
        (CL:T
         (CL:LET* ((STREAM-000 (NEW-OUTPUT-STRING-STREAM)))
          (%%PRINT-STREAM (%NATIVE-STREAM STREAM-000) "`" OUTPUTCASE "' is not a valid case option")
          (CL:ERROR (NEW-STELLA-EXCEPTION (THE-STRING-READER STREAM-000))))))))
     (CL:SETQ FIRSTTIME? CL:NIL) (CL:SETQ ITER-002 (%%REST ITER-002))))
   (CL:WHEN (CL:NOT (CL:EQ SUFFIX STELLA::NULL-STRING))
    (CL:SETQ I (INSERT-STRING SUFFIX 0 NULL-INTEGER OUT I KWD-NAME-UTILITY-PRESERVE)))
   (CL:RETURN-FROM COMPOSE-NAMESTRING-FULL
    (CL:LET ((S OUT)) (CL:DECLARE (CL:TYPE CL:SIMPLE-STRING S)) (CL:THE CL:SIMPLE-STRING S)))))

(CL:DEFUN STARTUP-NAME-UTILITY ()
  (CL:LET* ((*MODULE* *STELLA-MODULE*) (*CONTEXT* *MODULE*)) (CL:DECLARE (CL:SPECIAL *MODULE* *CONTEXT*))
   (CL:WHEN (CURRENT-STARTUP-TIME-PHASE? 2)
    (CL:SETQ KWD-NAME-UTILITY-CLEVER (INTERN-RIGID-SYMBOL-WRT-MODULE "CLEVER" NULL 2))
    ...
    (CL:SETQ KWD-NAME-UTILITY-PREFIX (INTERN-RIGID-SYMBOL-WRT-MODULE "PREFIX" NULL 2))
    (CL:SETQ KWD-NAME-UTILITY-SUFFIX (INTERN-RIGID-SYMBOL-WRT-MODULE "SUFFIX" NULL 2))
...
easier to use when called from non-Lisp languages.\")" (CL:FUNCTION DECOMPOSE-NAMESTRING-FULL) NULL)
    (DEFINE-FUNCTION-OBJECT "SUFFIX-MATCHES?" "(DEFUN (SUFFIX-MATCHES? BOOLEAN) ((TESTSTRING STRING) (SUFFIX STRING)))"
     (CL:FUNCTION SUFFIX-MATCHES?) NULL)
    (DEFINE-FUNCTION-OBJECT "ORDINAL-NUMBER-STRING?" "(DEFUN (ORDINAL-NUMBER-STRING? BOOLEAN) ((TESTSTRING STRING)))"
     (CL:FUNCTION ORDINAL-NUMBER-STRING?) NULL)
    (DEFINE-FUNCTION-OBJECT "HEURISTIC-ACRONYM?" "(DEFUN (HEURISTIC-ACRONYM? BOOLEAN) ((ITEMSTRING STRING)))"
...
easier to use when called from non-Lisp languages.\")" (CL:FUNCTION COMPOSE-NAMESTRING-FULL) NULL)
    (DEFINE-FUNCTION-OBJECT "STARTUP-NAME-UTILITY" "(DEFUN STARTUP-NAME-UTILITY () :PUBLIC? TRUE)"
     (CL:FUNCTION STARTUP-NAME-UTILITY) NULL)
    (CL:LET* ((FUNCTION (LOOKUP-FUNCTION SYM-NAME-UTILITY-STELLA-STARTUP-NAME-UTILITY)))
     (SET-DYNAMIC-SLOT-VALUE (%DYNAMIC-SLOTS FUNCTION) SYM-NAME-UTILITY-STELLA-METHOD-STARTUP-CLASSNAME
