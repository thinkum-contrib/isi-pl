...
(CL:DECLAIM
 (CL:SPECIAL *STELLA-MODULE* *MODULE* NULL-CHARACTER *CHARACTER-TYPE-TABLE*
  NULL-INTEGER TRUE-WRAPPER NIL))
 ...
 (CL:FTYPE
  (CL:FUNCTION
   (CL:SIMPLE-STRING CL:T CL:T CL:SIMPLE-STRING CL:SIMPLE-STRING
    CL:SIMPLE-STRING CL:SIMPLE-STRING CL:SIMPLE-STRING CL:T CL:SIMPLE-STRING)
   CL:SIMPLE-STRING)
...
easier to use when called from non-Lisp languages."
  ...
  (CL:LET*
   ((LEN (CL:THE CL:FIXNUM (CL:LENGTH NAMESTRING))) (RESULT NIL) (LAG 0)
    (LEAD 0) (INCAPRUN? CL:NIL) (INNUMBER? CL:NIL))
  ...
  (CL:LET*
   ...
   (CL:LET*
    ((C NULL-CHARACTER) (VECTOR-000 TESTSTRING) (INDEX-000 0)
     ...
     (ITER-000 0) (UPPER-BOUND-000 (CL:- LEN 3)))
    (CL:DECLARE (CL:TYPE CL:SIMPLE-STRING VECTOR-000)
