   ...
   (CL:AND (CL:NOT (CL:EQ X NULL))
    (CL:OR (CL:EQ (PRIMARY-TYPE X) TYPE)
     (CL:AND (CL:NOT (CL:EQ (%SURROGATE-VALUE TYPE) NULL))
      (CL:NOT (CL:EQ (%SURROGATE-VALUE (PRIMARY-TYPE X)) NULL)) (ISA? X TYPE))))))
...
(CL:DEFUN WRAPPER? (X)
  (CL:WHEN *CLASS-HIERARCHY-BOOTED?*
   (CL:RETURN-FROM WRAPPER?
    (CL:AND (CL:NOT (CL:EQ X NULL)) (ISA? X SGT-TYPE-PREDICATES-STELLA-WRAPPER))))
  (CL:RETURN-FROM WRAPPER?
...
(CL:DEFUN SYMBOL? (X)
  (CL:WHEN *CLASS-HIERARCHY-BOOTED?*
   (CL:RETURN-FROM SYMBOL?
    (CL:AND (CL:NOT (CL:EQ X NULL)) (ISA? X SGT-TYPE-PREDICATES-STELLA-SYMBOL))))
  (CL:RETURN-FROM SYMBOL?
...
(CL:DEFUN KEYWORD? (X)
  (CL:WHEN *CLASS-HIERARCHY-BOOTED?*
   (CL:RETURN-FROM KEYWORD?
    (CL:AND (CL:NOT (CL:EQ X NULL)) (ISA? X SGT-TYPE-PREDICATES-STELLA-KEYWORD))))
  ...
  (CL:LET* ((*MODULE* *STELLA-MODULE*) (*CONTEXT* *MODULE*))
   ...
   (CL:WHEN (CURRENT-STARTUP-TIME-PHASE? 7)
    ...
    (DEFINE-FUNCTION-OBJECT "FLOAT?"
     "(DEFUN (FLOAT? BOOLEAN) ((X OBJECT)) :PUBLIC? TRUE)" (CL:FUNCTION FLOAT?)
     NULL)
    ...
    (DEFINE-FUNCTION-OBJECT "STRING?"
     "(DEFUN (STRING? BOOLEAN) ((X OBJECT)) :PUBLIC? TRUE)" (CL:FUNCTION STRING?)
     NULL)
    ...
    (DEFINE-FUNCTION-OBJECT "SYMBOL?"
     "(DEFUN (SYMBOL? BOOLEAN) ((X OBJECT)) :PUBLIC? TRUE)" (CL:FUNCTION SYMBOL?)
     NULL)
