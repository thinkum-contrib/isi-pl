...
(CL:DEFUN SUBTYPE-OF-LONG-INTEGER? (TYPE)
  (CL:IF *CLASS-HIERARCHY-BOOTED?*
   (CL:RETURN-FROM SUBTYPE-OF-LONG-INTEGER?
    (SUBCLASS-OF? (%SURROGATE-VALUE TYPE)
     (%SURROGATE-VALUE SGT-TYPE-PREDICATES-STELLA-LONG-INTEGER-WRAPPER)))
   (CL:RETURN-FROM SUBTYPE-OF-LONG-INTEGER?
...
(CL:DEFUN WRAPPER? (X)
  ...
  (CL:RETURN-FROM WRAPPER?
   (CL:OR (BOOLEAN? X) (INTEGER? X) (LONG-INTEGER? X) (FLOAT? X) (STRING? X)
    (CHARACTER? X) (BOOTSTRAP-ISA? X SGT-TYPE-PREDICATES-STELLA-WRAPPER))))
