   ...
   ((SUBTYPE-OF-STORAGE-SLOT? (SAFE-PRIMARY-TYPE SLOT))
    (CL:PROGN
     (CL:LET* ((INVERSEDEMON (LOOKUP-DEMON "inverse-slot-demon")))
      ...
      (SET-DYNAMIC-SLOT-VALUE (%DYNAMIC-SLOTS SLOT) SYM-MORE-DEMONS-STELLA-SLOT-DEMONS
...
(CL:DEFUN STARTUP-MORE-DEMONS ()
  (CL:LET* ((*MODULE* *STELLA-MODULE*) (*CONTEXT* *MODULE*)) (CL:DECLARE (CL:SPECIAL *MODULE* *CONTEXT*))
   (CL:WHEN (CURRENT-STARTUP-TIME-PHASE? 2)
    (CL:SETQ SYM-MORE-DEMONS-STELLA-INVERSE (INTERN-RIGID-SYMBOL-WRT-MODULE "INVERSE" NULL 0))
    ...
    (CL:SETQ KWD-MORE-DEMONS-CREATE (INTERN-RIGID-SYMBOL-WRT-MODULE "CREATE" NULL 2))
    (CL:SETQ KWD-MORE-DEMONS-ALL (INTERN-RIGID-SYMBOL-WRT-MODULE "ALL" NULL 2))
   ...
   (CL:WHEN (CURRENT-STARTUP-TIME-PHASE? 7)
    ...
    (DEFINE-FUNCTION-OBJECT "ATTACH-INVERSE-SLOT-DEMON" "(DEFUN ATTACH-INVERSE-SLOT-DEMON ((SLOT SLOT)))"
    ...
    (DEFINE-FUNCTION-OBJECT "STARTUP-MORE-DEMONS" "(DEFUN STARTUP-MORE-DEMONS () :PUBLIC? TRUE)"
     (CL:FUNCTION STARTUP-MORE-DEMONS) NULL)
    (CL:LET* ((FUNCTION (LOOKUP-FUNCTION SYM-MORE-DEMONS-STELLA-STARTUP-MORE-DEMONS)))
     (SET-DYNAMIC-SLOT-VALUE (%DYNAMIC-SLOTS FUNCTION) SYM-MORE-DEMONS-STELLA-METHOD-STARTUP-CLASSNAME
