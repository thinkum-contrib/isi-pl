...
(CL:DEFUN INVERSE-SLOT-DEMON (SELF SLOT OLDVALUE NEWVALUE)
  (CL:LET*
   ((INVERSESLOT
     (DYNAMIC-SLOT-VALUE (%DYNAMIC-SLOTS SLOT) SYM-MORE-DEMONS-STELLA-INVERSE
      NULL)))
...
(CL:DEFUN STARTUP-MORE-DEMONS ()
  (CL:LET* ((*MODULE* *STELLA-MODULE*) (*CONTEXT* *MODULE*))
   ...
   (CL:WHEN (CURRENT-STARTUP-TIME-PHASE? 7)
    ...
    (CL:LET*
     ((FUNCTION (LOOKUP-FUNCTION SYM-MORE-DEMONS-STELLA-STARTUP-MORE-DEMONS)))
     (SET-DYNAMIC-SLOT-VALUE (%DYNAMIC-SLOTS FUNCTION)
      SYM-MORE-DEMONS-STELLA-METHOD-STARTUP-CLASSNAME
      (WRAP-STRING "_Startup-More-Demons") NULL-STRING-WRAPPER)))
