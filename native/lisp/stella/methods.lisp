...
(CL:DECLAIM
 (CL:SPECIAL *STELLA-MODULE* SYMBOL-SYM STANDARD-OUTPUT *MODULE*
  NULL-FUNCTION-CODE-WRAPPER *REDEFINE-RELATION-HOOKS*
  NULL-STRING-WRAPPER STANDARD-WARNING TRUE-WRAPPER FALSE-WRAPPER
  NULL-INTEGER TRUE STANDARD-ERROR EOL NIL FALSE))
    ...
    (CL:LET* ((BASETYPE HEAD-000))
     (CL:LET* ((HEAD-001 (%%VALUE CURSOR)))
      ...
      (CL:LET* ((OPERATOR HEAD-001) (ARRAYTYPE? FALSE))
       (CL:SETF (%SPECIFIER-BASE-TYPE TYPESPEC)
       ...
       (CL:WHEN
        (CL:AND ARRAYTYPE?
         (CL:EQ (%SPECIFIER-DIMENSIONS TYPESPEC) NULL))
       ...
       (CL:LET*
        ((P NULL) (ITER-000 CURSOR)
         (INTO-000 (%SPECIFIER-PARAMETER-TYPES TYPESPEC))
         (COLLECT-000 NULL))
...
(CL:DEFUN YIELD-ARRAY-DIMENSIONS-TREE (ARRAYTYPE)
  (CL:LET*
   ((DIMENSIONS (%SPECIFIER-DIMENSIONS ARRAYTYPE)) (RESULT NIL))
   (CL:WHEN (CL:EQ DIMENSIONS NULL)
    (CL:RETURN-FROM YIELD-ARRAY-DIMENSIONS-TREE NULL))
   (CL:LET*
    ((DIM NULL) (ITER-000 (%THE-CONS-LIST DIMENSIONS))
     (COLLECT-000 NULL))
    (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-000 NIL)) DO
...
(CL:DEFUN ARRAY-TYPE-DIMENSIONS (ARRAYTYPE)
  (CL:RETURN-FROM ARRAY-TYPE-DIMENSIONS
   (%SPECIFIER-DIMENSIONS ARRAYTYPE)))
...
(CL:DEFUN INDEFINITE-ARRAY-TYPE? (ARRAYTYPE)
  (CL:LET* ((DIMENSIONS (%SPECIFIER-DIMENSIONS ARRAYTYPE)))
   (CL:IF (CL:EQ DIMENSIONS NULL)
    (CL:RETURN-FROM INDEFINITE-ARRAY-TYPE? TRUE)
...
to the class identified by the first parameter in 'inputParameters'."
  (CL:LET*
   ...
   (CL:LET*
    ...
    (CL:IF (TYPE? TYPESPEC)
     (CL:SETF (%SLOT-BASE-TYPE NEWMETHOD) TYPESPEC)
         ...
         (CL:LET* ((*PRINTREADABLY?* TRUE))
          ...
          (CL:WHEN (CL:NOT (SUPPRESS-WARNINGS?))
           ...
           (%%PRINT-STREAM (%NATIVE-STREAM STANDARD-WARNING) EOL
            ...
            "in the definition of method `" (%SLOT-OWNER NEWMETHOD)
  ...
  (CL:LET* ((TEST-VALUE-000 (SAFE-PRIMARY-TYPE SELF)))
   (CL:COND
    ((SUBTYPE-OF-PARAMETRIC-TYPE-SPECIFIER? TEST-VALUE-000)
     (CL:PROGN
      (CL:WHEN
       (CL:EQ (%SURROGATE-VALUE (%SPECIFIER-BASE-TYPE SELF)) NULL)
         ...
         (CL:LET*
          ...
          (CL:WHEN (%CLASS-SLOTS-FINALIZED? BASECLASS)
           (CL:LET*
            ...
            (CL:LET*
             ((SUBTYPESPEC NULL) (SUPERTYPE NULL)
              (ITER-000 INHERITEDTYPES)
              (ITER-001
               (%THE-CONS-LIST (%SPECIFIER-PARAMETER-TYPES SELF))))
             (CL:LOOP WHILE
...
argument (and hence nothing to anchor onto).")
       (CL:RETURN-FROM VALIDATE-TYPE-SPECIFIER NULL))
      (CL:LET*
       ((SLOTNAME (%SPECIFIER-PARAMETER-NAME SELF)) (ANCHORSLOT NULL))
       (CL:WHEN (CL:EQ SLOTNAME NULL)
        (CL:RETURN-FROM VALIDATE-TYPE-SPECIFIER
         (%CLASS-TYPE ANCHORCLASS)))
       (CL:LET* ()
...
(CL:DEFMETHOD FINALIZE-SLOT-TYPE-COMPUTATIONS ((SELF METHOD-SLOT))
  (CL:LET*
   ...
   (CL:LET*
    ((TS NULL)
     (ITER-000
      (%THE-CONS-LIST (METHOD-PARAMETER-TYPE-SPECIFIERS SELF))))
    (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-000 NIL)) DO
     (CL:PROGN (CL:SETQ TS (%%VALUE ITER-000))
      (CL:SETQ ITER-000 (%%REST ITER-000)))
    ...
    (CL:LOOP WHILE (NEXT? ITER-000) DO
     ...
     (CL:LET*
      ...
      (CL:LOOP WHILE (NEXT? ITER-001) DO
       ...
       (CL:WHEN
        (CL:AND (CL:EQ (%SLOT-NAME SLOT) NAME) (%SLOT-EXTERNAL? SLOT))
        (CL:IF (CL:EQ COLLECT-000 NULL)
...
(CL:DEFMETHOD METHOD-ARGUMENT-COUNT ((SELF TABLE))
  (CL:RETURN-FROM METHOD-ARGUMENT-COUNT
   (CL:1- (LENGTH (%TUPLE-DOMAINS SELF)))))
           ...
           (CL:PROGN (CL:SETQ COLLECT-000 (CONS PARAMETERTYPE NIL))
            (CL:IF (CL:EQ (%THE-CONS-LIST PARAMETERTYPES) NIL)
             ...
             (ADD-CONS-TO-END-OF-CONS-LIST
              (%THE-CONS-LIST PARAMETERTYPES) COLLECT-000)))
           (CL:PROGN
   ...
   (CL:LET* ((TEST-VALUE-000 (SAFE-PRIMARY-TYPE SUBTYPE)))
    (CL:COND
     ...
     ((SUBTYPE-OF-PARAMETRIC-TYPE-SPECIFIER? TEST-VALUE-000)
      (CL:PROGN
       (CL:SETQ SUBCLASS
        (%SURROGATE-VALUE (%SPECIFIER-BASE-TYPE SUBTYPE)))))
     (CL:T
      (CL:LET* ((STREAM-000 (NEW-OUTPUT-STRING-STREAM)))
    ...
    (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-000 NIL)) DO
     ...
     (CL:TAGBODY
      (CL:LET* ((FOUND?-000 FALSE))
       (CL:LET*
        ((SUBPAR NULL)
         (ITER-001 (%THE-CONS-LIST (PARAMETERS SUBCLASS))))
        (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-001 NIL)) DO
         (CL:PROGN (CL:SETQ SUBPAR (%%VALUE ITER-001))
          (CL:SETQ ITER-001 (%%REST ITER-001)))
         (CL:WHEN (CL:EQ SUPPAR SUBPAR) (CL:SETQ FOUND?-000 TRUE)
          (CL:RETURN))))
      ...
      (CL:LET*
       ...
       (CL:WHEN
        (CL:AND (CL:NOT (ANCHORED-TYPE-SPECIFIER? SUBPARTYPE))
         (CL:EQ (%SURROGATE-VALUE (TYPE-SPEC-TO-BASE-TYPE SUBPARTYPE))
          NULL))
        (CL:LET* ((*PRINTREADABLY?* TRUE))
         (CL:DECLARE (CL:SPECIAL *PRINTREADABLY?*))
         (SIGNAL-TRANSLATION-ERROR)
         (CL:WHEN (CL:NOT (SUPPRESS-WARNINGS?))
          (PRINT-ERROR-CONTEXT ">> ERROR: " STANDARD-ERROR)
          (%%PRINT-STREAM (%NATIVE-STREAM STANDARD-ERROR) EOL
           " Parameter type `" (TYPE-SPEC-TO-BASE-TYPE SUBPARTYPE)
           "' of `" (DE-UGLIFY-PARSE-TREE SUBTYPE)
           "' is not yet defined." EOL)))
        (CL:RETURN-FROM COMPATIBLE-PARAMETER-TYPES? FALSE))
       (CL:WHEN
        (CL:AND (CL:NOT (ANCHORED-TYPE-SPECIFIER? SUPPARTYPE))
         (CL:EQ (%SURROGATE-VALUE (TYPE-SPEC-TO-BASE-TYPE SUPPARTYPE))
          NULL))
        (CL:LET* ((*PRINTREADABLY?* TRUE))
         (CL:DECLARE (CL:SPECIAL *PRINTREADABLY?*))
         (SIGNAL-TRANSLATION-ERROR)
         (CL:WHEN (CL:NOT (SUPPRESS-WARNINGS?))
          (PRINT-ERROR-CONTEXT ">> ERROR: " STANDARD-ERROR)
          (%%PRINT-STREAM (%NATIVE-STREAM STANDARD-ERROR) EOL
           " Parameter type `" (TYPE-SPEC-TO-BASE-TYPE SUPPARTYPE)
...
(CL:DEFUN SUB-TYPE-SPEC-OF? (SUBTYPE SUPERTYPE)
  (CL:WHEN (CL:EQ SUBTYPE SUPERTYPE)
   (CL:RETURN-FROM SUB-TYPE-SPEC-OF? TRUE))
       ...
       (CL:COND
        ...
        ((SUBTYPE-OF-PARAMETRIC-TYPE-SPECIFIER? TEST-VALUE-000)
         (CL:PROGN
          (CL:RETURN-FROM SUB-TYPE-SPEC-OF?
           (CL:AND
            (SUBTYPE-OF? SUBTYPE (%SPECIFIER-BASE-TYPE SUPERTYPE))
            (COMPATIBLE-PARAMETER-TYPES? SUBTYPE SUPERTYPE)))))
       ...
       (CL:COND
        ((SUBTYPE-OF-SURROGATE? TEST-VALUE-001)
         (CL:PROGN
          (CL:RETURN-FROM SUB-TYPE-SPEC-OF?
           (CL:AND
            (SUBTYPE-OF? (%SPECIFIER-BASE-TYPE SUBTYPE) SUPERTYPE)
            (COMPATIBLE-PARAMETER-TYPES? SUBTYPE SUPERTYPE)))))
        ((SUBTYPE-OF-PARAMETRIC-TYPE-SPECIFIER? TEST-VALUE-001)
         (CL:PROGN
          (CL:RETURN-FROM SUB-TYPE-SPEC-OF?
       ...
       (CL:WHEN (CL:EQ SLOT NULL)
        (CL:LET* ((*PRINTREADABLY?* TRUE))
         ...
         (CL:WHEN (CL:NOT (SUPPRESS-WARNINGS?))
          (PRINT-ERROR-CONTEXT ">> ERROR: " STANDARD-ERROR)
          (%%PRINT-STREAM (%NATIVE-STREAM STANDARD-ERROR) EOL
           " Missing :parameter named `"
           (%SPECIFIER-PARAMETER-NAME RELTYPE) "'" EOL
           "   for the class `" (DE-UGLIFY-PARSE-TREE OWNERTYPE) "'"
           EOL "." EOL)))
      ...
      (CL:LET*
       ((PTYPE NULL) (PNAME NULL)
        (ITER-000
         (%THE-CONS-LIST
          (PARAMETERS
           (%SURROGATE-VALUE (%SPECIFIER-BASE-TYPE OWNERTYPE)))))
        (ITER-001
         (%THE-CONS-LIST (%SPECIFIER-PARAMETER-TYPES OWNERTYPE))))
       (CL:LOOP WHILE
        (CL:AND (CL:NOT (CL:EQ ITER-000 NIL))
         (CL:NOT (CL:EQ ITER-001 NIL)))
        DO
      ...
      (CL:LET* ((ALWAYS?-000 TRUE))
       (CL:LET*
        ...
        (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-000 NIL)) DO
         (CL:PROGN (CL:SETQ TS (%%VALUE ITER-000))
          (CL:SETQ ITER-000 (%%REST ITER-000)))
         (CL:WHEN (CL:NOT (TYPE? TS)) (CL:SETQ ALWAYS?-000 FALSE)
          (CL:RETURN))))
       (CL:WHEN ALWAYS?-000
    ...
    ((SUBTYPE-OF-SURROGATE? TEST-VALUE-000)
     (CL:PROGN
      (CL:RETURN-FROM YIELD-TYPE-SPEC-TREE
       (INTERN-SYMBOL-IN-MODULE (%SYMBOL-NAME SELF)
        (%HOME-CONTEXT SELF) TRUE))))
    ((SUBTYPE-OF-PARAMETRIC-TYPE-SPECIFIER? TEST-VALUE-000)
     (CL:PROGN
       ...
       (CL:RETURN-FROM YIELD-TYPE-SPEC-TREE
        (CONS
         (INTERN-SYMBOL-IN-MODULE
          (%SYMBOL-NAME (%SPECIFIER-BASE-TYPE SELF))
   ...
   (CL:WHEN
    ...
    (CL:LET*
     ((RECORD FUNCTION)
      ...
      (OLDFUNCTION
       (CL:AREF (CL:THE CL:SIMPLE-VECTOR (%THE-ARRAY RECORD)) 1))
      (MODULENAME
       (%WRAPPER-VALUE
     ...
     (CL:LET*
      ...
      (CL:SETQ FUNCTION
       (DEFINE-METHOD-FROM-STRINGIFIED-SOURCE
        (%SYMBOL-NAME FUNCTIONSYMBOL) STELLA::NULL-STRING DEFINITION)))
   ...
   (CL:LET* ((MODULE NULL) (ITER-000 (VISIBLE-MODULES *MODULE*)))
    (CL:LOOP WHILE (NEXT? ITER-000) DO
     ...
     (CL:LET* ((TEST-VALUE-000 FALSE))
      (CL:LET* ()
       (CL:SETQ SYMBOL (LOOKUP-SYMBOL-IN-MODULE NAME MODULE TRUE))
...
(CL:DEFUN DESTROY-FUNCTION (FUNCTION)
  (CL:LET*
   ((FUNCTIONNAME (%SLOT-NAME FUNCTION))
...
(CL:DEFUN DEFINE-FUNCTION-OBJECT (NAME DEFINITION CODE WRAPPERCODE)
  ...
  (CL:LET*
   ...
   (CL:LET
    ((SELF (%THE-ARRAY RECORD)) (VALUE (WRAP-STRING DEFINITION))
     (POSITION 0))
    (CL:DECLARE (CL:TYPE CL:SIMPLE-VECTOR SELF)
     (CL:TYPE CL:FIXNUM POSITION))
    (CL:SETF (CL:AREF SELF POSITION) VALUE))
   (CL:LET
    ((SELF (%THE-ARRAY RECORD)) (VALUE OLDFUNCTION) (POSITION 1))
    (CL:DECLARE (CL:TYPE CL:SIMPLE-VECTOR SELF)
     (CL:TYPE CL:FIXNUM POSITION))
    (CL:SETF (CL:AREF SELF POSITION) VALUE))
   (CL:LET
  ...
  (CL:LET*
   ...
   (CL:WHEN (CL:NOT (CL:EQ OLDGLOBAL NULL))
    (CL:COND
     ...
     (CL:T
      (%%PRINT-STREAM (%NATIVE-STREAM STANDARD-OUTPUT)
       "Redefining the global variable `" (%VARIABLE-NAME GLOBAL) "'"
       EOL)
      (FREE OLDGLOBAL))))
...
(CL:DEFMETHOD LOOKUP-GLOBAL-VARIABLE ((SELF SURROGATE))
  ...
  (CL:LET*
   ((SYMBOL
     (LOOKUP-RIGID-SYMBOL-WRT-MODULE (%SYMBOL-NAME SELF)
      (%HOME-CONTEXT SELF) SYMBOL-SYM)))
...
(CL:DEFUN DEFINE-STELLA-GLOBAL-VARIABLE-FROM-PARSE-TREE (TREE STRINGIFIEDSOURCE)
  ...
  (CL:LET*
   ((TYPETREE (%%VALUE (%%REST (%%REST TREE))))
    ...
    (NOINITIALVALUE? FALSE) (GLOBAL (NEW-GLOBAL-VARIABLE))
    (INTERNEDGLOBAL NULL))
   (CL:WHEN
...
variable for the surrogate 'self'."
  (CL:RETURN-FROM GET-GLOBAL-VALUE
   (CL:FUNCALL
    (%VARIABLE-GET-VALUE-CODE (LOOKUP-GLOBAL-VARIABLE SELF)))))
...
'self' to 'value'."
  (CL:RETURN-FROM SET-GLOBAL-VALUE
   (CL:FUNCALL (%VARIABLE-SET-VALUE-CODE (LOOKUP-GLOBAL-VARIABLE SELF))
    VALUE)))
      ...
      (CL:WHEN
       ...
       (CL:LET* ((*PRINTREADABLY?* TRUE))
        ...
        (CL:WHEN (CL:NOT (SUPPRESS-WARNINGS?))
         (PRINT-ERROR-CONTEXT ">> ERROR: " STANDARD-ERROR)
         (%%PRINT-STREAM (%NATIVE-STREAM STANDARD-ERROR) EOL
          " Cannot define type `" (DE-UGLIFY-PARSE-TREE TYPENAME)
    ...
    (CL:T
     (CL:LET* ((*PRINTREADABLY?* TRUE))
      ...
      (CL:WHEN (CL:NOT (SUPPRESS-WARNINGS?))
       (PRINT-ERROR-CONTEXT ">> ERROR: " STANDARD-ERROR)
       (%%PRINT-STREAM (%NATIVE-STREAM STANDARD-ERROR) EOL
        " Illegal type name: `" (DE-UGLIFY-PARSE-TREE TYPENAME) "'."
        EOL)))
     (CL:RETURN-FROM DEFINE-STELLA-TYPE-FROM-PARSE-TREE NULL)))))
...
'self' to 'value'.\" :PUBLIC? TRUE)" (CL:FUNCTION SET-GLOBAL-VALUE)
     NULL)
