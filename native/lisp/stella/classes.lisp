...
(CL:DECLAIM
  ...
  *REDEFINE-RELATION-HOOKS* *CLASSES-WITH-UNRESOLVED-CHILDREN-REFERENCES*
  NULL-STRING-WRAPPER STANDARD-WARNING *DEBUGLEVEL* *CLASS-TAXONOMY-GRAPH*
  SYMBOL-SYM STANDARD-OUTPUT EOL *MODULE* NIL SURROGATE-SYM))
...
(CL:DEFUN CLASS-SYMBOL (CLASS)
  (CL:RETURN-FROM CLASS-SYMBOL
   (INTERN-SYMBOL-IN-MODULE (%SYMBOL-NAME (%CLASS-TYPE CLASS))
    (%HOME-CONTEXT (%CLASS-TYPE CLASS)) CL:T)))
...
(CL:DEFMETHOD LOOKUP-CLASS ((NAME SYMBOL))
  "Return a class with name `name'.  Scan all
visible surrogates looking for one that has a class defined for it."
  (CL:LET* ((*MODULE* (%HOME-CONTEXT NAME)))
    ...
    ((CL:NOT (CL:EQ OLDMODULE *MODULE*))
     ...
     (CL:WHEN ASKFORPERMISSION?
      (CL:WARN "Shadowing the `~A' named `~A'"
       (%SYMBOL-NAME (PRIMARY-TYPE SELF)) NAME)
...
(CL:DEFUN SHADOWED-SYMBOL? (SYMBOL)
  ...
  (CL:LET*
   ((SYMBOLNAME (%SYMBOL-NAME SYMBOL)) (MODULE (%HOME-CONTEXT SYMBOL)))
   ...
   (CL:LET* ((TEST-VALUE-000 CL:NIL))
    ...
    (CL:WHEN TEST-VALUE-000
     (CL:LET* ((FOUND?-000 CL:NIL))
      (CL:LET*
       ((SHADOW NULL)
        (ITER-000 (%THE-CONS-LIST (SHADOWED-SURROGATES MODULE))))
       (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-000 NIL)) DO
   ...
   (CL:LET* ((CHOOSE-VALUE-000 NULL))
    ...
    (CL:LET*
     ((INITIALVALUES CHOOSE-VALUE-000)
      ...
      (REQUIREDSLOTVALUES NIL) (SLOTVALUE NULL) (SLOT NULL) (OBJECT NULL))
     ...
     (CL:WHEN (CL:NOT (CL:EQ INITIALVALUES NULL))
      (CL:LET*
       ((SLOTNAME NULL) (VALUE NULL) (ITER-002 (%THE-PLIST INITIALVALUES)))
           ...
           (CL:WHEN (CL:NOT (STORAGE-SLOT? SLOT))
            (CL:LET* ((STREAM-004 (NEW-OUTPUT-STRING-STREAM)))
             (%%PRINT-STREAM (%NATIVE-STREAM STREAM-004)
              "create-object: slot `" SLOTNAME "' does not exist on class `"
              TYPE "'")
             (CL:ERROR
...
redefined, but the native C++ class is not redefined."
  (CL:LET*
   ((CLASS (NEW-CLASS))
    (PARAMETERSLOTS (LOOKUP OPTIONS KWD-CLASSES-PARAMETERS)) (OLDCLASS NULL)
    (SUCCESS? CL:NIL))
   (CL:WHEN
   ...
   (CL:MULTIPLE-VALUE-SETQ (SUCCESS? OLDCLASS NAME)
    (BIND-TO-SURROGATE? CLASS (%SYMBOL-NAME NAME) CL:T CL:T))
   ...
   (CL:WHEN (CL:NOT (CL:EQ PARAMETERSLOTS NULL))
    (CL:LET* ((S NULL) (ITER-000 (%THE-CONS-LIST PARAMETERSLOTS)))
     (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-000 NIL)) DO
      (CL:SETQ S (%%VALUE ITER-000)) (CL:SETF (%ABSTRACT? S) CL:T)
     ...
     (CL:LET* ((FOUND?-000 CL:NIL))
      (CL:LET* ((SLOT NULL) (ITER-002 (%THE-CONS-LIST SLOTS)))
       (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-002 NIL)) DO
        ...
        (CL:WHEN (PRIMITIVE? SLOT) (CL:SETQ FOUND?-000 CL:T) (CL:RETURN))
   ...
   (CL:LOOP WHILE (NEXT? ITER-000) DO (CL:SETQ KEY (%KEY ITER-000))
    ...
    (CL:COND
        ...
        (CL:IF (CL:EQ COLLECT-001 NULL)
         (CL:PROGN (CL:SETQ COLLECT-001 (CONS (%SLOT-NAME SLOT) NIL))
          (CL:IF (CL:EQ (%THE-CONS-LIST INTO-001) NIL)
           ...
           (ADD-CONS-TO-END-OF-CONS-LIST (%THE-CONS-LIST INTO-001)
            COLLECT-001)))
        ...
        (CL:IF (CL:EQ COLLECT-002 NULL)
         (CL:PROGN (CL:SETQ COLLECT-002 (CONS TYPE NIL))
          (CL:IF (CL:EQ (%THE-CONS-LIST INTO-002) NIL)
           ...
           (ADD-CONS-TO-END-OF-CONS-LIST (%THE-CONS-LIST INTO-002)
            COLLECT-002)))
     ...
     ((CL:EQ KEY KWD-CLASSES-CHILDREN)
      (CL:SETF (%CLASS-DIRECT-SUBS CLASS) VALUE)
...
(CL:DEFUN UNDEFINE-OLD-CLASS (OLDCLASS NEWCLASS)
  ...
  (CL:LET*
   ...
   (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-002 NIL)) DO
    ...
    (CL:SETQ ITER-002 (%%REST ITER-002))))
  (CL:SETF (%CLASS-CONSTRUCTOR-CODE NEWCLASS)
   (%CLASS-CONSTRUCTOR-CODE OLDCLASS))
...
(CL:DEFUN DESTROY-CLASS-AND-SUBCLASSES (SELF)
  ...
  (CL:LET*
   ((SUBTYPE NULL) (ITER-000 (%THE-CONS-LIST (%CLASS-DIRECT-SUBS SELF))))
   (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-000 NIL)) DO
...
(CL:DEFUN RESOLVE-CHILDREN-REFERENCES ()
  ...
  (CL:LET* ((UNRESOLVABLECLASSES NIL))
   ...
   (CL:LET*
    ((CLASS NULL)
     (ITER-000
      (%THE-CONS-LIST *CLASSES-WITH-UNRESOLVED-CHILDREN-REFERENCES*)))
    (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-000 NIL)) DO
     (CL:SETQ CLASS (%%VALUE ITER-000)) (ADD-DIRECT-SUBS-BACK-LINKS CLASS)
     (CL:LET* ((FOUND?-000 CL:NIL))
      (CL:LET*
       ((SUB NULL) (ITER-001 (%THE-CONS-LIST (%CLASS-DIRECT-SUBS CLASS))))
       (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-001 NIL)) DO
        (CL:SETQ SUB (%%VALUE ITER-001))
        (CL:WHEN (CL:EQ (TYPE-TO-CLASS SUB) NULL) (CL:SETQ FOUND?-000 CL:T)
         (CL:RETURN))
        (CL:SETQ ITER-001 (%%REST ITER-001))))
      (CL:WHEN FOUND?-000
...
(CL:DEFUN FINALIZE-ONE-CLASS (CLASS)
  (CL:LET* ((*MODULE* (HOME-MODULE CLASS)) (*CONTEXT* *MODULE*))
    ...
    (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-000 NIL)) DO
     ...
     (CL:IF
      (CL:AND (CL:NOT (CL:EQ (%SURROGATE-VALUE ALIAS) NULL))
       ...
       (CL:NOT
        (STRING-EQL? (CLASS-NAME (%SURROGATE-VALUE ALIAS))
         (CLASS-NAME CLASS))))
      (CL:WARN
       "Alias `~A' can't point to `~A' because it already points to ~%the class `~A'."
       (INTERN-SYMBOL-IN-MODULE (%SYMBOL-NAME ALIAS) (%HOME-CONTEXT ALIAS)
        CL:T)
   ...
   (CL:SETF (%CLASS-FINALIZED? CLASS) CL:T))
  :VOID)
     ...
     (CL:LET* ((VALUE-001 NULL))
      (CL:LET* ((S NULL) (ITER-001 (CLASS-SLOTS CLASS)))
       (CL:LOOP WHILE (NEXT? ITER-001) DO (CL:SETQ S (%VALUE ITER-001))
        (CL:WHEN
         (CL:AND (CL:NOT (CL:EQ S SELF)) (CL:EQ (%SLOT-NAME S) SLOTNAME))
...
(CL:DEFUN FINALIZE-CLASS-SLOTS (CLASS)
  ...
  (CL:LET* ((CLASSTYPE (%CLASS-TYPE CLASS)))
   (CL:LET*
    ((SLOT NULL) (ITER-001 (%THE-CONS-LIST (%CLASS-LOCAL-SLOTS CLASS))))
    (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-001 NIL)) DO
     (CL:SETQ SLOT (%%VALUE ITER-001)) (REGISTER-SLOT-NAME SLOT)
     (CL:SETF (%SLOT-OWNER SLOT) CLASSTYPE)
     (CL:SETQ ITER-001 (%%REST ITER-001)))))
  (CL:LET*
...
(CL:DEFUN UNFINALIZE-CLASS-SLOTS (CLASS)
  (CL:WHEN (CL:NOT (%CLASS-SLOTS-FINALIZED? CLASS))
   (CLEAR-SLOT-AND-METHOD-CACHE CLASS) (CL:RETURN-FROM UNFINALIZE-CLASS-SLOTS))
  (CL:LET*
...
(CL:DEFUN ADD-DIRECT-SUPERS-BACK-LINKS (CLASS)
  (CL:LET*
   ((DIRECTSUPERS (%CLASS-DIRECT-SUPERS CLASS))
     ...
     (CL:LET* ((OTHERSUPERCLASS NULL) (ITER-002 (%THE-CONS-LIST PARENTS)))
      (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-002 NIL)) DO
       ...
       (CL:WHEN (CL:NOT (CL:EQ OTHERSUPERCLASS SUPERCLASS))
        (CL:WHEN
         (MEMBER? (%CLASS-ALL-SUPER-CLASSES SUPERCLASS) OTHERSUPERCLASS)
...
If there is none, return `null'."
  ...
  (CL:LET* ((C NULL) (ITER-000 (%CLASS-ALL-SUPER-CLASSES CLASS1)))
   (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-000 NIL)) DO
    (CL:SETQ C (%%VALUE ITER-000)) (CL:SETF (%CLASS-MARKED? C) CL:NIL)
    (CL:SETQ ITER-000 (%%REST ITER-000))))
  (CL:LET* ((C NULL) (ITER-001 (%CLASS-ALL-SUPER-CLASSES CLASS2)))
   (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-001 NIL)) DO
    (CL:SETQ C (%%VALUE ITER-001)) (CL:SETF (%CLASS-MARKED? C) CL:T)
    (CL:SETQ ITER-001 (%%REST ITER-001))))
...
also try to generalize parameter types if necessary."
  ...
  (CL:LET*
   ...
   (CL:LET*
    ...
    (CL:WHEN
     (CL:AND (ARRAY-TYPE-SPECIFIER? TYPE1) (ARRAY-TYPE-SPECIFIER? TYPE2))
     (CL:WHEN
      (CL:NOT
...
(CL:DEFUN INHERIT-SLOTS (CLASS)
  (CL:LET*
   ((SLOTS (COPY-CONS-LIST (%THE-CONS-LIST (%CLASS-LOCAL-SLOTS CLASS)))))
...
(CL:DEFUN LOCAL-SLOT? (SLOT CLASS)
  (CL:RETURN-FROM LOCAL-SLOT?
   (CL:EQ (%SURROGATE-VALUE (%SLOT-OWNER SLOT)) CLASS)))
...
slot in the system."
  (CL:RETURN-FROM REGISTERED-SLOT-NAME?
   (CL:NOT (CL:= (%SYMBOL-SLOT-OFFSET SLOT-NAME) NULL-INTEGER))))
      ...
      (CL:LET* ((*PRINTREADABLY?* CL:T))
       ...
       (CL:WHEN (CL:NOT (SUPPRESS-WARNINGS?))
        ...
        (%%PRINT-STREAM (%NATIVE-STREAM STANDARD-WARNING) EOL " Macro `"
         (DE-UGLIFY-PARSE-TREE NAME) "' shadows the following methods/slots:"
         EOL "    `" (DE-UGLIFY-PARSE-TREE SLOTS) "'." EOL)))
      (CL:LET* ((*PRINTREADABLY?* CL:T))
       (CL:DECLARE (CL:SPECIAL *PRINTREADABLY?*)) (SIGNAL-TRANSLATION-WARNING)
       (CL:WHEN (CL:NOT (SUPPRESS-WARNINGS?))
        (PRINT-ERROR-CONTEXT ">> WARNING: " STANDARD-WARNING)
...
precedence order for classes with multiple parents (similar to CLOS)."
  ...
  (CL:LET* ((OFFSET (%SYMBOL-SLOT-OFFSET SLOT-NAME)) (CACHEDSLOT NULL))
    ...
    (CL:SETQ CACHEDSLOT
     (CL:AREF
      (CL:THE CL:SIMPLE-VECTOR
       (%THE-ARRAY (%CLASS-SLOT-AND-METHOD-CACHE CLASS)))
   ...
   (CL:LET*
    ...
    (INSERT-AT (%CLASS-SLOT-AND-METHOD-CACHE CLASS) *SLOT-CACHE-SIZE*
     CACHEDSLOT)
    (CL:RETURN-FROM LOOKUP-SLOT CACHEDSLOT))))
...
(CL:DEFUN LOOKUP-VISIBLE-SLOT (CLASS SLOT-NAME)
  (CL:LET*
   ...
   (CL:LET*
    ((SYMBOL NULL)
     (ITER-000 (LOOKUP-VISIBLE-SYMBOLS-IN-MODULE SLOTNAMESTRING MODULE CL:T)))
    (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-000 NIL)) DO
  ...
  (CL:RETURN-FROM CONFORMING-TYPE-SPEC?
   (CL:OR (CL:EQ SUB-TYPE-SPEC NULL)
    ...
    (CL:AND (TYPE? SUB-TYPE-SPEC)
     (CL:EQ (%SURROGATE-VALUE SUB-TYPE-SPEC) NULL))
   ...
   (CL:COND
    ((SUBTYPE-OF? (SAFE-PRIMARY-TYPE SUPERSLOT) SGT-CLASSES-STELLA-TABLE)
     (CL:PROGN
      (CL:LET* ((ALWAYS?-000 CL:T))
       (CL:LET*
        ((TS1 NULL) (ITER-000 (REST (%TUPLE-DOMAINS SELF))) (TS2 NULL)
         (ITER-001 (REST (%TUPLE-DOMAINS SUPERSLOT))))
        (CL:LOOP WHILE
         (CL:AND (CL:NOT (CL:EQ ITER-000 NIL)) (CL:NOT (CL:EQ ITER-001 NIL)))
         DO (CL:SETQ TS1 (%%VALUE ITER-000)) (CL:SETQ TS2 (%%VALUE ITER-001))
         (CL:WHEN (CL:NOT (CONFORMING-TYPE-SPEC? TS2 TS1))
          (CL:SETQ ALWAYS?-000 CL:NIL) (CL:RETURN))
         (CL:SETQ ITER-000 (%%REST ITER-000))
         (CL:SETQ ITER-001 (%%REST ITER-001))))
...
(CL:DEFUN IDENTICAL-SIGNATURES? (METHOD1 METHOD2)
  (CL:LET* ((TEST-VALUE-000 CL:NIL))
   (CL:LET* ((ALWAYS?-000 CL:T))
    (CL:LET*
     ((TS1 NULL) (ITER-000 (REST (METHOD-PARAMETER-TYPE-SPECIFIERS METHOD1)))
      (TS2 NULL) (ITER-001 (REST (METHOD-PARAMETER-TYPE-SPECIFIERS METHOD2))))
     (CL:LOOP WHILE
     ...
     (CL:LET* ((CLASSES (%ITERATOR-OBJECT SELF)))
      ...
      (CL:WHEN (CL:EQ CLASSES NIL)
       (CL:WHEN (CL:EQ LOCALSLOTS NIL) (CL:SETF (%VALUE SELF) NULL)
        (CL:SETF (%ITERATOR-OBJECT SELF) NULL) (CL:RETURN-FROM NEXT? CL:NIL)))
...
(CL:DEFUN FILTER-UNBOUND-SURROGATE? (SELF ITERATOR)
  ...
  (CL:RETURN-FROM FILTER-UNBOUND-SURROGATE?
   (CL:EQ (%SURROGATE-VALUE SELF) NULL)))
...
surrogates interned in `module'."
  (CL:LET* ((ITERATOR (NEW-ALL-PURPOSE-ITERATOR)))
   (CL:SETF (%ITERATOR-NESTED-ITERATOR ITERATOR)
     ...
     ((SUBTYPE-OF-STRING? TEST-VALUE-000)
      (CL:PROGN
       (CL:RETURN-FROM COERCE-TO-SYMBOL
        (LOOKUP-SYMBOL (%WRAPPER-VALUE NAME)))))
     (CL:T))))
...
(CL:DEFUN %PRINT-UNDEFINED-SUPER-CLASSES (CLASS)
  ...
  (CL:LET* ((TYPE (TYPIFY (COERCE-TO-SYMBOL CLASS))) (BADONES (NEW-LIST)))
   (CL:WHEN (CL:EQ TYPE NULL)
    (%%PRINT-STREAM (%NATIVE-STREAM STANDARD-OUTPUT) "Illegal class name: "
     CLASS EOL)
   ...
   (CL:LET* ((FOUND?-000 CL:NIL))
    (CL:LET* ((SUPER NULL) (ITER-000 (%THE-CONS-LIST BADONES)))
     (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-000 NIL)) DO
      (CL:SETQ SUPER (%%VALUE ITER-000))
      (CL:WHEN (CL:EQ (%SURROGATE-VALUE SUPER) NULL) (CL:SETQ FOUND?-000 CL:T)
       (CL:RETURN))
      (CL:SETQ ITER-000 (%%REST ITER-000))))
    (CL:WHEN FOUND?-000
     (%%PRINT-STREAM (%NATIVE-STREAM STANDARD-OUTPUT)
   ...
   (CL:LET* ((FOUND?-001 CL:NIL))
    ...
    (CL:WHEN FOUND?-001
     (%%PRINT-STREAM (%NATIVE-STREAM STANDARD-OUTPUT)
      "The following (indirect) super(s) of " TYPE " point to non-classes:"
      EOL)
  ...
  (CL:LET* ((GRAPH *CLASS-TAXONOMY-GRAPH*))
   ...
   (CL:LET* ((CLASS NULL) (ITER-001 (ALL-CLASSES NULL CL:NIL)))
    (CL:LOOP WHILE (NEXT? ITER-001) DO (CL:SETQ CLASS (%VALUE ITER-001))
     (CL:LET*
      ((SUB NULL) (ITER-002 (%THE-CONS-LIST (%CLASS-DIRECT-SUBS CLASS))))
      (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-002 NIL)) DO
...
(CL:DEFUN FAST-SUBCLASS-OF? (SUBCLASS SUPERCLASS)
  (CL:LET* ((SUBLABEL (%LABEL (%CLASS-TAXONOMY-NODE SUBCLASS))))
   ...
   (CL:LET*
    ((INTERVAL NULL)
     (ITER-000 (%INTERVALS (%CLASS-TAXONOMY-NODE SUPERCLASS))))
    (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-000 NIL)) DO
     (CL:SETQ INTERVAL (%%VALUE ITER-000))
     (CL:WHEN
      (CL:AND (CL:>= SUBLABEL (%LOWER-BOUND INTERVAL))
...
(CL:DEFUN LOOKUP-SLOTREF (SELF SLOTNAME)
  ...
  (CL:LET* ((CLASS (%SURROGATE-VALUE SELF)) (SLOT NULL) (SLOTREF NULL))
   ...
   (CL:WHEN (CL:EQ SLOTREF NULL)
    ...
    (CL:WHEN (CL:NOT (CL:EQ SLOT NULL))
     (CL:SETF (%SLOT-SLOTREF SLOT) SLOTREF)))
...
(CL:DEFUN SLOTREF? (SELF)
  (CL:RETURN-FROM SLOTREF?
   (CL:NOT (CL:= (POSITION (%SYMBOL-NAME SELF) #\. 0) NULL-INTEGER))))
...
(CL:DEFUN LOOKUP-SLOT-FROM-SLOTREF (SLOTREF)
  ...
  (CL:LET*
   ((SLOTREFNAME (%SYMBOL-NAME SLOTREF))
    (SLOTREFMODULE (%HOME-CONTEXT SLOTREF))
...
slot initialization, etc. is handled dynamically at run time, `create-object'
is much slower than `new'; therefore, it should only be used if `type' cannot
be known at translation time.\" :PUBLIC? TRUE)" (CL:FUNCTION CREATE-OBJECT)
    NULL)
   (DEFINE-METHOD-OBJECT
...
and set `*NEWLY-UNFINALIZED-CLASSES?*' to `false'.\")"
   ...
   (DEFINE-FUNCTION-OBJECT "ACTIVATE-CLASS"
    "(DEFUN ACTIVATE-CLASS ((CLASS CLASS)))" (CL:FUNCTION ACTIVATE-CLASS)
    NULL)
...
also try to generalize parameter types if necessary.\")"
   ...
   (DEFINE-FUNCTION-OBJECT "UNINHERIT-SLOTS"
    "(DEFUN UNINHERIT-SLOTS ((CLASS CLASS)))" (CL:FUNCTION UNINHERIT-SLOTS)
    NULL)
...
representing the type of `self'.\" :PUBLIC? TRUE)" (CL:FUNCTION GET-SLOT)
    NULL)
...
a value.\" :PUBLIC? TRUE)" (CL:FUNCTION INITIALLY) NULL)
   ...
   (DEFINE-FUNCTION-OBJECT "DISCONNECT-CLASSES"
    "(DEFUN DISCONNECT-CLASSES ())" (CL:FUNCTION DISCONNECT-CLASSES) NULL)
  ...
  (CL:LET* ((*MODULE* *STELLA-MODULE*) (*CONTEXT* *MODULE*))
   ...
   (CL:WHEN (CURRENT-STARTUP-TIME-PHASE? 7) (HELP-STARTUP-CLASSES3)
    ...
    (DEFINE-FUNCTION-OBJECT "CREATE-CLASS-TAXONOMY"
     "(DEFUN CREATE-CLASS-TAXONOMY ())" (CL:FUNCTION CREATE-CLASS-TAXONOMY)
     NULL)
...
of the class named `super-type'.\" :PUBLIC? TRUE)" (CL:FUNCTION SUBTYPE-OF?)
    ...
    (DEFINE-FUNCTION-OBJECT "SLOTREF?"
     "(DEFUN (SLOTREF? BOOLEAN) ((SELF SURROGATE)))" (CL:FUNCTION SLOTREF?)
     NULL)
