...
(CL:DEFVAR SYM-CLASSES-STELLA-SLOT-HOME-MODULE NULL)
...
(CL:DECLAIM
 (CL:SPECIAL STANDARD-ERROR *FINALIZE-RELATION-HOOKS* *STELLA-MODULE*
  *REDEFINE-RELATION-HOOKS* *CLASSES-WITH-UNRESOLVED-CHILDREN-REFERENCES*
  ...
  TRUE-WRAPPER FALSE-WRAPPER SYMBOL-SYM STANDARD-OUTPUT EOL *MODULE*
  SURROGATE-SYM))
...
(CL:DEFUN CLASS-SYMBOL (CLASS)
  (CL:RETURN-FROM CLASS-SYMBOL (TYPE-TO-SYMBOL (%CLASS-TYPE CLASS))))

;;; (DEFUN (TYPE-TO-SYMBOL SYMBOL) ...)

(CL:DEFUN TYPE-TO-SYMBOL (TYPE)
  (CL:RETURN-FROM TYPE-TO-SYMBOL
   (INTERN-DERIVED-SYMBOL TYPE (%SYMBOL-NAME TYPE))))
...
(CL:DEFMETHOD GET-STELLA-CLASS ((CLASSNAME SURROGATE) ERROR?)
  "Return a class with name 'className'.  If none exists, break
if 'error?', else return NULL."
  (CL:LET* ((CLASS (%SURROGATE-VALUE CLASSNAME)))
...
(CL:DEFMETHOD GET-STELLA-CLASS ((CLASSNAME CL:STRING) ERROR?)
  "Return a class with name 'className'.  If none exists, break
if 'error?', else return NULL."
  (CL:DECLARE (CL:TYPE CL:SIMPLE-STRING CLASSNAME))
  (CL:LET* ((TYPE (LOOKUP-SURROGATE CLASSNAME)))
...
(CL:DEFMETHOD GET-STELLA-CLASS ((CLASSNAME SYMBOL) ERROR?)
  "Return a class with name 'className'.  If non exists, break
if 'error?', else return NULL."
  (CL:RETURN-FROM GET-STELLA-CLASS
   (GET-STELLA-CLASS (%SYMBOL-NAME CLASSNAME) ERROR?)))

;;; (DEFSPECIAL *WARNIFREDEFINE?* ...)

(CL:DEFVAR *WARNIFREDEFINE?* TRUE
     ...
     (CL:WHEN ASKFORPERMISSION?
      ...
      (CL:WHEN (YES-OR-NO? "Do it anyway? ")
       ...
       (CL:RETURN-FROM BIND-TO-SURROGATE?
        (CL:VALUES TRUE OLDVALUE SURROGATE))))
     (CL:RETURN-FROM BIND-TO-SURROGATE? (CL:VALUES TRUE NULL SURROGATE)))
    (CLIPOLDVALUE?
     ...
     (CL:WHEN ASKFORPERMISSION?
      ...
      (CL:WHEN (YES-OR-NO? "Do it anyway? ")
       ...
       (CL:RETURN-FROM BIND-TO-SURROGATE?
        (CL:VALUES TRUE OLDVALUE SURROGATE))))
     (CL:RETURN-FROM BIND-TO-SURROGATE?
      (CL:VALUES FALSE NULL SURROGATE))))))
...
for this type must be included.  'create' runs more slowly than 'new'."
  (CL:LET*
   ((CLASS (GET-STELLA-CLASS TYPE TRUE))
    (CONSTRUCTORCODE (GET-CONSTRUCTOR CLASS TRUE)) (OPTIONS NIL)
    (NEWOBJECT NULL) (CURSOR NULL))
  ...
  (CL:LET* ((TEST-VALUE-000 (SAFE-PRIMARY-TYPE OBJECT)))
   (CL:COND
    ((SUBTYPE-OF-SYMBOL? TEST-VALUE-000)
     (CL:PROGN
      (CL:COND
       ((CL:EQ OBJECT SYM-CLASSES-STELLA-TRUE)
        (CL:RETURN-FROM COERCE-TO-BOOLEAN TRUE-WRAPPER))
       ((CL:EQ OBJECT SYM-CLASSES-STELLA-FALSE)
    ...
    (CL:T)))
  (%%PRINT-STREAM (%NATIVE-STREAM STANDARD-OUTPUT)
   "Don't know how to coerce `" OBJECT "' of type `" (PRIMARY-TYPE OBJECT)
     ...
     (CL:LET* ((FOUND?-000 FALSE))
      (CL:LET* ((SLOT NULL) (ITER-002 (%THE-CONS-LIST SLOTS)))
       (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-002 NIL)) DO
        ...
        (CL:WHEN (PRIMITIVE? SLOT) (CL:SETQ FOUND?-000 TRUE)
         (CL:RETURN))))
...
(CL:DEFUN DEFINE-STELLA-SLOT (NAME OWNER BASETYPE TYPESPECIFIER OPTIONS)
  (CL:LET* ((SLOT (NEW-STORAGE-SLOT))) (CL:SETF (%SLOT-NAME SLOT) NAME)
   ...
   (CL:LET*
    ((VALUE NULL) (KEY NULL) (ITER-000 (ALLOCATE-ITERATOR OPTIONS)))
        ...
        (CL:LET* ((*PRINTREADABLY?* TRUE))
         ...
         (CL:WHEN (CL:NOT (SUPPRESS-WARNINGS?))
          ...
          (%%PRINT-STREAM (%NATIVE-STREAM STANDARD-WARNING) EOL
           ...
           "'" EOL "in the definition of slot `" (TYPE-TO-SYMBOL OWNER)
    ...
    (CL:COND
     ...
     ((CL:EQ KEY KWD-CLASSES-PUBLIC?)
      (CL:SETF (%CLASS-PUBLIC? CLASS)
       (COERCE-WRAPPED-BOOLEAN-TO-BOOLEAN VALUE)))
     ((CL:EQ KEY KWD-CLASSES-ABSTRACT?)
      (CL:SETF (%ABSTRACT? CLASS)
       (COERCE-WRAPPED-BOOLEAN-TO-BOOLEAN VALUE)))
     ((CL:EQ KEY KWD-CLASSES-ACTIVE?)
      (SET-DYNAMIC-SLOT-VALUE (%DYNAMIC-SLOTS CLASS)
       SYM-CLASSES-STELLA-STORED-ACTIVE? VALUE NULL))
     ((CL:EQ KEY KWD-CLASSES-CL-STRUCT?)
      (CL:SETF (%CL-STRUCT? CLASS)
       (COERCE-WRAPPED-BOOLEAN-TO-BOOLEAN VALUE)))
         ...
         (CL:PROGN (CL:SETQ COLLECT-001 (CONS (%SLOT-NAME SLOT) NIL))
          (CL:IF (CL:EQ (%THE-CONS-LIST INTO-001) NIL)
           ...
           (ADD-CONS-TO-END-OF-CONS-LIST (%THE-CONS-LIST INTO-001)
            COLLECT-001)))
         (CL:PROGN
          (CL:SETF (%%REST COLLECT-001) (CONS (%SLOT-NAME SLOT) NIL))
...
(CL:DEFUN TRANSFER-DEMONS-FROM-OLDCLASS (OLDCLASS NEWCLASS)
  (CL:LET* ((NEWSLOT NULL))
   (CL:LET*
    ((OLDSLOT NULL)
     (ITER-000 (%THE-CONS-LIST (%CLASS-LOCAL-SLOTS OLDCLASS))))
    (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-000 NIL)) DO
...
(CL:DEFUN UNDEFINE-OLD-CLASS (OLDCLASS NEWCLASS)
  (CL:LET*
   ...
   (CL:LET*
    ((OLDSUB NULL)
     (ITER-000 (%THE-CONS-LIST (%CLASS-DIRECT-SUBS OLDCLASS)))
     (COLLECT-000 NULL))
    (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-000 NIL)) DO
  ...
  (CL:LET* ((TAXONOMYNODE (%CLASS-TAXONOMY-NODE OLDCLASS)))
   (CL:LET*
    ((SUPER NULL)
     (ITER-001 (%THE-CONS-LIST (%CLASS-DIRECT-SUPERS OLDCLASS))))
    (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-001 NIL)) DO
  ...
  (CL:LET*
   ((OLDSLOT NULL)
    (ITER-002 (%THE-CONS-LIST (%CLASS-LOCAL-SLOTS OLDCLASS))))
   (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-002 NIL)) DO
   ...
   (CL:LET* ((SUP NULL) (ITER-000 (%THE-CONS-LIST SUPERS)))
    (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-000 NIL)) DO
     (CL:PROGN (CL:SETQ SUP (%%VALUE ITER-000))
      (CL:SETQ ITER-000 (%%REST ITER-000)))
     (CL:WHEN (SUBTYPE-OF? NEWSUPER SUP) (CL:SETQ FOUND?-000 TRUE)
      (CL:RETURN))))
  ...
  (CL:LET* ((ALWAYS?-000 TRUE))
   ...
   (CL:IF ALWAYS?-000
    (CL:RETURN-FROM CLASS-NATIVE-SUPERS
     (ALLOCATE-ITERATOR (%CLASS-DIRECT-SUPERS CLASS)))
    (CL:RETURN-FROM CLASS-NATIVE-SUPERS
   ...
   (CL:LET* ((TEST-VALUE-000 FALSE))
       ...
       (CL:LET*
        ...
        (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-000 NIL)) DO
         (CL:PROGN (CL:SETQ SLOT (%%VALUE ITER-000))
          (CL:SETQ ITER-000 (%%REST ITER-000)))
         (CL:WHEN
          (CL:EQ (%SLOT-NAME SLOT) SYM-CLASSES-STELLA-PRIMARY-TYPE)
          (CL:SETQ FOUND?-000 TRUE) (CL:RETURN))))
       (CL:SETQ TEST-VALUE-000 FOUND?-000))
    ...
    (CL:WHEN TEST-VALUE-000
     (CL:SETQ SLOTTREE
      (LIST*
       (CONS
        (LIST* SYM-CLASSES-STELLA-SELF (TYPE-TO-SYMBOL CLASSTYPE) NIL)
        NIL)
...
(CL:DEFUN FINALIZE-ONE-CLASS (CLASS)
  ...
  (CL:LET*
   ((ALIAS NULL) (ITER-000 (%THE-CONS-LIST (CLASS-SYNONYMS CLASS))))
   (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-000 NIL)) DO
    ...
    (CL:IF
     ...
     (CL:WARN
      ...
      (TYPE-TO-SYMBOL ALIAS) (CLASS-SYMBOL CLASS)
...
(CL:DEFUN UNFINALIZE-CLASS-AND-SUBCLASSES (CLASS)
  ...
  (CL:LET* ((SUBS (COPY (%CLASS-DIRECT-SUBS CLASS))))
   ...
   (FREE SUBS))
  (CL:LET*
   ((ALIAS NULL) (ITER-001 (%THE-CONS-LIST (CLASS-SYNONYMS CLASS))))
   (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-001 NIL)) DO
...
(CL:DEFUN ATTACH-SLOT-TO-OWNER (NEWSLOT)
  (CL:LET*
   ...
   (CL:SETF (%SLOT-EXTERNAL? NEWSLOT) TRUE)
   (CL:WHEN (CL:NOT (CL:EQ (HOME-MODULE NEWSLOT) *MODULE*))
    (SET-DYNAMIC-SLOT-VALUE (%DYNAMIC-SLOTS NEWSLOT)
     SYM-CLASSES-STELLA-SLOT-HOME-MODULE *MODULE* NULL))
...
(CL:DEFUN COMPUTE-SLOT-DIRECT-EQUIVALENT (SELF)
  (CL:LET*
   ((CLASS (%SURROGATE-VALUE (%SLOT-OWNER SELF)))
   ...
   (CL:WHEN
    ...
    (CL:LET* ((STREAM-000 (NEW-OUTPUT-STRING-STREAM)))
     (%%PRINT-STREAM (%NATIVE-STREAM STREAM-000) "Class `"
      ...
      EOL "   context sensitive slot `" (%SLOT-NAME SELF) "' " EOL)
...
(CL:DEFUN ADD-DIRECT-SUBS-BACK-LINKS (CLASS)
  (CL:LET*
   ((DIRECTSUBS (%CLASS-DIRECT-SUBS CLASS))
    (CLASSTYPE (%CLASS-TYPE CLASS)))
     ...
     (CL:WHEN (CL:NOT (CL:EQ (%SURROGATE-VALUE SUBTYPE) NULL))
      (CL:LET* ((SUBCLASS (%SURROGATE-VALUE SUBTYPE)))
       (CL:IF (%CLASS-FINALIZED? SUBCLASS)
        (CL:WHEN
         (CL:NOT (MEMBER? (%CLASS-ALL-SUPER-CLASSES SUBCLASS) CLASS))
   ...
   (CL:LET*
    ...
    (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-000 NIL)) DO
     (CL:PROGN (CL:SETQ SUPERTYPE (%%VALUE ITER-000))
      (CL:SETQ ITER-000 (%%REST ITER-000)))
     (CL:WHEN (CL:NOT (CL:EQ (%SURROGATE-VALUE SUPERTYPE) NULL))
      (REMOVE (%CLASS-DIRECT-SUBS (%SURROGATE-VALUE SUPERTYPE))
       CLASSTYPE)))))
  :VOID)
   ...
   (CL:LET*
    ...
    (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-000 NIL)) DO
     ...
     (CL:WHEN (CL:NOT (CL:EQ (%SURROGATE-VALUE SUPERTYPE) NULL))
      (CL:IF (CL:EQ COLLECT-000 NULL)
       (CL:PROGN
        (CL:SETQ COLLECT-000 (CONS (%SURROGATE-VALUE SUPERTYPE) NIL))
        (CL:IF (CL:EQ (%THE-CONS-LIST PARENTS) NIL)
         (CL:SETF (%THE-CONS-LIST PARENTS) COLLECT-000)
         (ADD-CONS-TO-END-OF-CONS-LIST (%THE-CONS-LIST PARENTS)
          COLLECT-000)))
       (CL:PROGN
        (CL:SETF (%%REST COLLECT-000)
         (CONS (%SURROGATE-VALUE SUPERTYPE) NIL))
        (CL:SETQ COLLECT-000 (%%REST COLLECT-000)))))))
  ...
  (CL:LET*
   ...
   (CL:LET*
    ((SUPERTYPE (%CLASS-TYPE SUPERCLASS))
     ...
     (SPTYPE NULL) (PTYPE1 NULL) (PTYPE2 NULL) (PARAMETEREXISTS? FALSE)
     (RESULT NULL))
    ...
    (CL:WHEN
     ...
     (CL:WHEN
      ...
      (CL:RETURN-FROM TWO-ARGUMENT-LEAST-COMMON-SUPERTYPE SUPERTYPE))
     (CL:SETF (%SPECIFIER-DIMENSIONS RESULT)
      (%SPECIFIER-DIMENSIONS TYPE1)))
     ...
     (CL:LET*
      ...
      (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-000 NIL)) DO
       ...
       (CL:SETQ SLOTS
        (CONCATENATE SLOTS
         (COPY-CONS-LIST
          (%CLASS-ALL-SLOTS (%SURROGATE-VALUE SUPERTYPE)))))))
...
(CL:PROGN (CL:DEFVAR *SYMBOL-SLOT-OFFSET-COUNTER* 0) (CL:DECLAIM (CL:TYPE CL:FIXNUM *SYMBOL-SLOT-OFFSET-COUNTER*)))

;;; (DEFGLOBAL *SLOT-CACHE-SIZE* ...)

(CL:PROGN (CL:DEFVAR *SLOT-CACHE-SIZE* 20) (CL:DECLAIM (CL:TYPE CL:FIXNUM *SLOT-CACHE-SIZE*)))
...
slot in the system."
  (CL:RETURN-FROM REGISTERED-SLOT-NAME?
   (DEFINED? (%SYMBOL-SLOT-OFFSET SLOTNAME))))
    ...
    (CL:LET* ((SLOTS NIL))
     (CL:LET* ((MODULE NULL) (ITER-000 (ALL-MODULES)))
      (CL:LOOP WHILE (NEXT? ITER-000) DO
       ...
       (CL:LET*
        ((SLOT NULL) (ITER-001 (ALL-SLOTS MODULE TRUE))
         (COLLECT-000 NULL))
...
Multiply inherited slots are disambiguated by a left-to-right class precedence
order for classes with multiple parents (similar to CLOS)."
  (CL:LET*
   ((CACHEDSLOT
     (CL:AREF
      (CL:THE CL:SIMPLE-VECTOR
       (%THE-ARRAY (%CLASS-SLOT-AND-METHOD-CACHE CLASS)))
      (CL:THE CL:FIXNUM (%SYMBOL-SLOT-OFFSET SLOTNAME)))))
   (CL:WHEN
    (CL:AND (CL:NOT (CL:EQ CACHEDSLOT NULL))
     (CL:EQ (%SLOT-NAME CACHEDSLOT) SLOTNAME))
   ...
   (CL:LET* ((SLOT NULL) (ITER-000 (CLASS-SLOTS CLASS)))
    (CL:LOOP WHILE (NEXT? ITER-000) DO (CL:SETQ SLOT (%VALUE ITER-000))
     (CL:WHEN (CL:EQ (%SLOT-NAME SLOT) SLOTNAME) (CL:SETQ CACHEDSLOT SLOT)
      (CL:RETURN))))
   (CL:WHEN (CL:EQ CACHEDSLOT NULL) (CL:RETURN-FROM LOOKUP-SLOT NULL))
   (CL:LET*
    ((NEWOFFSET
      (CL:THE CL:FIXNUM
       (CL:MOD (CL:THE CL:FIXNUM (CL:1+ *SYMBOL-SLOT-OFFSET-COUNTER*))
        *SLOT-CACHE-SIZE*))))
    (CL:DECLARE (CL:TYPE CL:FIXNUM NEWOFFSET))
    (CL:SETQ *SYMBOL-SLOT-OFFSET-COUNTER* NEWOFFSET)
    (CL:SETF (%SYMBOL-SLOT-OFFSET SLOTNAME) NEWOFFSET)
...
and then call 'lookup-slot'."
  ...
  (CL:RETURN-FROM SAFE-LOOKUP-SLOT
   (CL:IF
    (CL:AND (DEFINED? (%SYMBOL-SLOT-OFFSET SLOTNAME))
     (CL:NOT (CL:EQ CLASS NULL)))
    (LOOKUP-SLOT CLASS SLOTNAME) NULL)))
...
(CL:DEFUN LOOKUP-LOCAL-SLOT (CLASS SLOTNAME)
  ...
  (CL:LET*
   ...
   (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-000 NIL)) DO
    (CL:PROGN (CL:SETQ SLOT (%%VALUE ITER-000))
     (CL:SETQ ITER-000 (%%REST ITER-000)))
    (CL:WHEN (CL:EQ (%SLOT-NAME SLOT) SLOTNAME)
...
(CL:DEFUN CONFORMING-TYPE-SPEC? (SUBTYPESPEC SUPERTYPESPEC)
  (CL:RETURN-FROM CONFORMING-TYPE-SPEC?
   (CL:OR (CL:EQ SUBTYPESPEC NULL)
    (CL:EQ SUBTYPESPEC SGT-CLASSES-STELLA-UNKNOWN)
    (CL:AND (TYPE? SUBTYPESPEC)
     (CL:EQ (%SURROGATE-VALUE SUBTYPESPEC) NULL))
    (ANCHORED-TYPE-SPECIFIER? SUBTYPESPEC) (CL:EQ SUPERTYPESPEC NULL)
    (CL:EQ SUPERTYPESPEC SGT-CLASSES-STELLA-UNKNOWN)
    (CL:AND (TYPE? SUPERTYPESPEC)
     (CL:EQ (%SURROGATE-VALUE SUPERTYPESPEC) NULL))
    (ANCHORED-TYPE-SPECIFIER? SUPERTYPESPEC)
    (SUB-TYPE-SPEC-OF? SUBTYPESPEC SUPERTYPESPEC))))
        ...
        (CL:WHEN TEST-VALUE-000
         (CL:LET* ((ALWAYS?-001 TRUE))
          (CL:LET*
           ((TS2 NULL) (TS1 NULL)
            (ITER-002
             (%THE-CONS-LIST (METHOD-RETURN-TYPE-SPECIFIERS SELF)))
            (ITER-003
    ...
    (CL:LET* ((ALWAYS?-001 TRUE))
     (CL:LET*
      ((TS2 NULL) (TS1 NULL)
       ...
       (ITER-003
        (%THE-CONS-LIST (METHOD-RETURN-TYPE-SPECIFIERS METHOD2))))
      (CL:LOOP WHILE
       (CL:AND (CL:NOT (CL:EQ ITER-002 NIL))
        (CL:NOT (CL:EQ ITER-003 NIL)))
       DO
...
of 'self'.  Non-reflexive."
  (CL:LET* ((ITERATOR (NEW-LIST-ITERATOR)))
   (CL:SETF (%LIST-ITERATOR-CURSOR ITERATOR)
...
(CL:DEFMETHOD ACTIVE? ((SLOT SLOT))
  (CL:RETURN-FROM ACTIVE?
   (CL:IF
    ...
    (CL:AND
     (CL:NOT
      (CL:EQ (%SURROGATE-VALUE SGT-CLASSES-STELLA-COLLECTION) NULL))
   ...
   (CL:COND ((CL:NOT (CL:EQ VALUE NULL)) (CL:RETURN-FROM INITIALLY VALUE))
    ((CL:NOT (CL:EQ (%SLOT-DIRECT-EQUIVALENT SELF) NULL))
     (CL:RETURN-FROM INITIALLY
      (INITIALLY (%SLOT-DIRECT-EQUIVALENT SELF))))
...
(CL:DEFUN COLLECT-BAD-SUPER-CLASSES (TYPE BADONES)
  (CL:LET* ((VALUE (%SURROGATE-VALUE TYPE)))
   (CL:IF (STELLA-CLASS? VALUE)
    (CL:LET*
     ((SUPER NULL)
      (ITER-000 (%THE-CONS-LIST (%CLASS-DIRECT-SUPERS VALUE))))
     (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-000 NIL)) DO
      (CL:PROGN (CL:SETQ SUPER (%%VALUE ITER-000))
       (CL:SETQ ITER-000 (%%REST ITER-000)))
...
of the class named 'superType'."
  ...
  (CL:LET*
   ((SUBCLASS (TYPE-TO-CLASS SUBTYPE))
    (SUPERCLASS (TYPE-TO-CLASS SUPERTYPE)))
    ...
    (CL:LET* ((*PRINTREADABLY?* TRUE))
     ...
     (CL:WHEN (CL:NOT (SUPPRESS-WARNINGS?))
      ...
      (%%PRINT-STREAM (%NATIVE-STREAM STANDARD-ERROR) EOL
       ...
       (DE-UGLIFY-PARSE-TREE SUBTYPE) "'" EOL EOL ".")))
   ...
   (CL:WHEN (CL:EQ SUPERCLASS NULL)
    (CL:LET* ((*PRINTREADABLY?* TRUE))
     ...
     (CL:WHEN (CL:NOT (SUPPRESS-WARNINGS?))
      ...
      (%%PRINT-STREAM (%NATIVE-STREAM STANDARD-ERROR) EOL
       " Reference to non-existent class: `"
       (DE-UGLIFY-PARSE-TREE SUPERTYPE) "'" EOL EOL ".")))
    (CL:RETURN-FROM SUBTYPE-OF? FALSE))
  ...
  (CL:LET*
   ...
   (CL:WHEN
    ...
    (CL:WHEN (CL:NOT (CL:EQ SLOTNAME NULL))
     (CL:SETQ SLOT (LOOKUP-FUNCTION SLOTNAME))
     (CL:WHEN (CL:EQ SLOT NULL)
      (CL:SETQ SLOT (SAFE-LOOKUP-SLOT (%SURROGATE-VALUE TYPE) SLOTNAME)))
     (CL:WHEN (CL:NOT (CL:EQ SLOT NULL))
...
(CL:DEFUN HELP-STARTUP-CLASSES2 ()
  (CL:PROGN
   ...
   (CL:SETQ SYM-CLASSES-STELLA-CLASS-GUARD-CONSTRUCTOR-DEMONS
    (INTERN-RIGID-SYMBOL-WRT-MODULE "CLASS-GUARD-CONSTRUCTOR-DEMONS" NULL
     0))
   ...
   (CL:SETQ SYM-CLASSES-STELLA-CLASS-GUARD-DESTRUCTOR-DEMONS
    (INTERN-RIGID-SYMBOL-WRT-MODULE "CLASS-GUARD-DESTRUCTOR-DEMONS" NULL
     0))
   ...
   (CL:SETQ SYM-CLASSES-STELLA-SLOT-HOME-MODULE
   ...
   (CL:SETQ SYM-CLASSES-STELLA-PRINT-UNDEFINED-SUPER-CLASSES
    (INTERN-RIGID-SYMBOL-WRT-MODULE "PRINT-UNDEFINED-SUPER-CLASSES" NULL
     0))
...
(CL:DEFUN HELP-STARTUP-CLASSES3 ()
  (CL:PROGN
   ...
   (DEFINE-FUNCTION-OBJECT "TYPE-TO-SYMBOL"
    "(DEFUN (TYPE-TO-SYMBOL SYMBOL) ((TYPE TYPE)) :PUBLIC? TRUE)"
...
visible surrogates looking for one that has a class defined for it.\" :PUBLIC? TRUE)"
   ...
   (DEFINE-METHOD-OBJECT
    "(DEFMETHOD (GET-STELLA-CLASS CLASS) ((CLASSNAME TYPE) (ERROR? BOOLEAN)) :DOCUMENTATION \"Return a class with name 'className'.  If none exists, break
if 'error?', else return NULL.\" :PUBLIC? TRUE)"
    (CL:FUNCTION GET-STELLA-CLASS) NULL)
   (DEFINE-METHOD-OBJECT
    "(DEFMETHOD (GET-STELLA-CLASS CLASS) ((CLASSNAME STRING) (ERROR? BOOLEAN)) :DOCUMENTATION \"Return a class with name 'className'.  If none exists, break
if 'error?', else return NULL.\" :PUBLIC? TRUE)"
    (CL:FUNCTION GET-STELLA-CLASS) NULL)
   (DEFINE-METHOD-OBJECT
    "(DEFMETHOD (GET-STELLA-CLASS CLASS) ((CLASSNAME SYMBOL) (ERROR? BOOLEAN)) :DOCUMENTATION \"Return a class with name 'className'.  If non exists, break
if 'error?', else return NULL.\" :PUBLIC? TRUE)"
    (CL:FUNCTION GET-STELLA-CLASS) NULL)
...
slot in the system.\" (RETURN (DEFINED? (SYMBOL-SLOT-OFFSET SLOTNAME))))"
...
Multiply inherited slots are disambiguated by a left-to-right class precedence
order for classes with multiple parents (similar to CLOS).\" :PUBLIC? TRUE)"
...
and then call 'lookup-slot'.\" :PUBLIC? TRUE)"
    (CL:FUNCTION SAFE-LOOKUP-SLOT) NULL)
   (DEFINE-FUNCTION-OBJECT "LOOKUP-LOCAL-SLOT"
    "(DEFUN (LOOKUP-LOCAL-SLOT SLOT) ((CLASS CLASS) (SLOTNAME SYMBOL)) :DOCUMENTATION \"Lookup a local slot with 'slotName' on 'class'.\" :PUBLIC? TRUE)"
...
of the class named 'superType'.\" :PUBLIC? TRUE)"
    ...
    (CL:LET*
     ...
     (SET-DYNAMIC-SLOT-VALUE (%DYNAMIC-SLOTS FUNCTION)
      ...
      (WRAP-STRING "Startup-Classes") NULL-STRING-WRAPPER)))
