...
(CL:DECLAIM
  ...
  *GLOBAL-VARIABLE-LOOKUP-TABLE* FALSE-WRAPPER *SYMBOL-ARRAY* NIL TRUE
  FALSE))
...
(CL:DEFMETHOD ALLOCATE-DESTRUCTIVE-LIST-ITERATOR ((SELF LIST))
  (CL:LET*
   ((ITERATOR
     (ALLOCATE-DESTRUCTIVE-LIST-ITERATOR (%THE-CONS-LIST SELF))))
  ...
  (CL:LET* ((ALWAYS?-000 TRUE))
   (CL:LET* ((FILTER NULL) (ITER-000 (%ITERATOR-OBJECT ITERATOR)))
    (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-000 NIL)) DO
     ...
     (CL:WHEN
      (CL:NOT (CL:FUNCALL (%WRAPPER-VALUE FILTER) SELF ITERATOR))
