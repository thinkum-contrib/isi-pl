...
(CL:DECLAIM
 (CL:SPECIAL *STELLA-MODULE* *MODULE* *SURROGATE-ARRAY* *GLOBAL-VARIABLE-LOOKUP-TABLE* FALSE-WRAPPER *SYMBOL-ARRAY*
  NULL-INTEGER NIL))
...
collection, since in that case it will run forever.'"
  (CL:LET* ((COUNT 0)) (CL:DECLARE (CL:TYPE CL:FIXNUM COUNT))
   (CL:LET* ((I SELF)) (CL:LOOP WHILE (NEXT? I) DO (CL:SETQ COUNT (CL:1+ COUNT)))) (CL:RETURN-FROM LENGTH COUNT)))
...
(CL:DEFMETHOD NEXT? ((SELF DESTRUCTIVE-LIST-ITERATOR))
  (CL:LET* ((CURSOR (%LIST-ITERATOR-CURSOR SELF))) (CL:WHEN (CL:EQ CURSOR NIL) (CL:RETURN-FROM NEXT? CL:NIL))
   (CL:SETF (%VALUE SELF) (%%VALUE CURSOR)) (CL:SETF (%LIST-ITERATOR-CURSOR SELF) (%%REST CURSOR))
...
(%%DEFCONSMETHOD ALLOCATE-DESTRUCTIVE-LIST-ITERATOR ((SELF CL:CONS))
  (CL:LET* ((ITERATOR (NEW-DESTRUCTIVE-LIST-ITERATOR))) (CL:SETF (%THE-CONS-LIST ITERATOR) SELF)
   (CL:SETF (%LIST-ITERATOR-CURSOR ITERATOR) SELF) (CL:RETURN-FROM ALLOCATE-DESTRUCTIVE-LIST-ITERATOR ITERATOR)))

;;; (DEFMETHOD (ALLOCATE-DESTRUCTIVE-LIST-ITERATOR (ITERATOR OF (LIKE (ANY-VALUE SELF)))) ...)

(CL:DEFMETHOD ALLOCATE-DESTRUCTIVE-LIST-ITERATOR ((SELF LIST))
  (CL:LET* ((ITERATOR (ALLOCATE-DESTRUCTIVE-LIST-ITERATOR (%THE-CONS-LIST SELF)))) (CL:SETF (%THE-CONS-LIST SELF) NIL)
   (FREE SELF) (CL:RETURN-FROM ALLOCATE-DESTRUCTIVE-LIST-ITERATOR ITERATOR)))
...
(CL:DEFUN FILTERED-NESTED-ITERATOR-NEXT? (SELF)
  (CL:LET* ((NESTEDITERATOR (%ITERATOR-NESTED-ITERATOR SELF)) (VALUE NULL))
   (CL:LOOP WHILE (NEXT? NESTEDITERATOR) DO (CL:SETQ VALUE (%VALUE NESTEDITERATOR))
    (CL:WHEN (CL:FUNCALL (%ITERATOR-FILTER-CODE SELF) VALUE SELF) (CL:SETF (%VALUE SELF) VALUE)
...
(CL:DEFUN ITERATOR-CONS-LIST-NEXT? (SELF)
  (CL:LET* ((CURSOR (%ITERATOR-CONS-LIST SELF)))
   (CL:WHEN (CL:EQ CURSOR NIL) (CL:RETURN-FROM ITERATOR-CONS-LIST-NEXT? CL:NIL))
   (CL:SETF (%VALUE SELF) (%%VALUE CURSOR)) (CL:SETF (%ITERATOR-CONS-LIST SELF) (%%REST CURSOR))
...
(CL:DEFUN FILTERED-CONCATENATED-ITERATOR-NEXT? (SELF)
  (CL:LET* ((NESTEDITERATOR (%ITERATOR-NESTED-ITERATOR SELF)) (FILTERCODE (%ITERATOR-FILTER-CODE SELF)) (VALUE NULL))
   (CL:LOOP
    (CL:LOOP WHILE (NEXT? NESTEDITERATOR) DO (CL:SETQ VALUE (%VALUE NESTEDITERATOR))
     (CL:WHEN (CL:IF (CL:NOT (CL:EQ FILTERCODE NULL)) (CL:FUNCALL FILTERCODE VALUE SELF) CL:T)
      (CL:SETF (%VALUE SELF) VALUE) (CL:RETURN-FROM FILTERED-CONCATENATED-ITERATOR-NEXT? CL:T)))
    (CL:SETQ NESTEDITERATOR (%%VALUE (%ITERATOR-CONS-LIST SELF)))
...
resulting iterator."
  (CL:LET* ((ITERATORLIST (CONS ITERATOR2 NIL)))
   ...
   (CL:LET* ((SELF-000 (NEW-ALL-PURPOSE-ITERATOR))) (CL:SETF (%ITERATOR-NESTED-ITERATOR SELF-000) ITERATOR1)
    (CL:SETF (%ITERATOR-CONS-LIST SELF-000) ITERATORLIST)
    (CL:SETF (%ITERATOR-NEXT-CODE SELF-000) (CL:FUNCTION FILTERED-CONCATENATED-ITERATOR-NEXT?))
    (CL:LET* ((VALUE-000 SELF-000)) (CL:RETURN-FROM CONCATENATE VALUE-000)))))
...
(CL:DEFMETHOD NEXT? ((SELF INTEGER-INTERVAL-ITERATOR))
  (CL:IF (%FIRST-ITERATION? SELF) (CL:SETF (%FIRST-ITERATION? SELF) CL:NIL)
   (CL:SETF (%INTERVAL-CURSOR SELF) (CL:1+ (%INTERVAL-CURSOR SELF))))
  (CL:LET* ((UPPERBOUND (%UPPER-BOUND SELF))) (CL:DECLARE (CL:TYPE CL:FIXNUM UPPERBOUND))
   (CL:SETF (%VALUE SELF) (%INTERVAL-CURSOR SELF))
...
(CL:DEFMETHOD NEXT? ((SELF REVERSE-INTEGER-INTERVAL-ITERATOR))
  (CL:IF (%FIRST-ITERATION? SELF) (CL:SETF (%FIRST-ITERATION? SELF) CL:NIL)
   (CL:SETF (%INTERVAL-CURSOR SELF) (CL:1- (%INTERVAL-CURSOR SELF))))
  (CL:LET* ((LOWERBOUND (%LOWER-BOUND SELF))) (CL:DECLARE (CL:TYPE CL:FIXNUM LOWERBOUND))
   (CL:SETF (%VALUE SELF) (%INTERVAL-CURSOR SELF))
...
(CL:DEFMETHOD ALLOCATE-ITERATOR ((SELF CL:STRING))
  ...
  (CL:LET* ((SELF-000 (NEW-STRING-ITERATOR))) (CL:SETF (%THE-STRING SELF-000) SELF)
   (CL:LET* ((ITERATOR SELF-000)) (CL:SETF (%CURSOR ITERATOR) 0)
    (CL:SETF (%END ITERATOR) (CL:THE CL:FIXNUM (CL:LENGTH SELF))) (CL:RETURN-FROM ALLOCATE-ITERATOR ITERATOR))))
...
(CL:DEFMETHOD NEXT? ((SELF STRING-ITERATOR))
  (CL:LET* ((POS (%CURSOR SELF))) (CL:DECLARE (CL:TYPE CL:FIXNUM POS))
   (CL:WHEN (CL:< POS (%END SELF))
    (CL:SETF (%VALUE SELF)
     (CL:LET ((SELF (%THE-STRING SELF)) (POSITION POS))
...
(CL:DEFUN ALLOCATE-ALL-META-OBJECTS-ITERATOR (ARRAYSIZE NEXTCODE MODULE LOCAL?)
  ...
  (CL:LET* ((ITERATOR (NEW-ALL-PURPOSE-ITERATOR)) (MODULESLIST NIL)) (CL:SETF (%ITERATOR-INTEGER ITERATOR) 0)
   (CL:SETF (%ITERATOR-SECOND-INTEGER ITERATOR) ARRAYSIZE)
      ...
      (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-000 NIL)) DO (CL:SETQ MOD (%%VALUE ITER-000))
       (CL:IF (CL:EQ COLLECT-000 NULL)
        (CL:PROGN (CL:SETQ COLLECT-000 (CONS MOD NIL))
         (CL:IF (CL:EQ MODULESLIST NIL) (CL:SETQ MODULESLIST COLLECT-000)
   ...
   (CL:SETF (%ITERATOR-CONS-LIST ITERATOR) MODULESLIST) (CL:SETF (%ITERATOR-NEXT-CODE ITERATOR) NEXTCODE)
  ...
  (CL:LET* ((MODULES (%ITERATOR-CONS-LIST SELF)))
   (CL:IF (CL:EQ MODULES NIL) (CL:RETURN-FROM SELECTED-META-OBJECT? CL:T)
    (CL:IF (CL:EQ (%%REST MODULES) NIL)
     (CL:IF (CL:EQ OBJECTMODULE (%%VALUE MODULES)) (CL:RETURN-FROM SELECTED-META-OBJECT? CL:T)
...
(CL:DEFUN ALL-SYMBOLS-NEXT? (SELF)
  (CL:LET* ((CURSOR (%ITERATOR-INTEGER SELF)) (SYMBOL NULL)) (CL:DECLARE (CL:TYPE CL:FIXNUM CURSOR))
   (CL:LOOP WHILE (CL:< CURSOR (%ITERATOR-SECOND-INTEGER SELF)) DO
    (CL:SETQ SYMBOL (CL:AREF (CL:THE CL:SIMPLE-VECTOR (%THE-ARRAY *SYMBOL-ARRAY*)) CURSOR))
    (CL:WHEN (CL:AND (CL:NOT (CL:EQ SYMBOL NULL)) (SELECTED-META-OBJECT? SELF (%HOME-CONTEXT SYMBOL)))
     (CL:SETF (%VALUE SELF) SYMBOL) (CL:SETF (%ITERATOR-INTEGER SELF) (CL:1+ CURSOR))
...
If 'module' is null, return all symbols interned everywhere."
  (CL:RETURN-FROM ALL-SYMBOLS
   (ALLOCATE-ALL-META-OBJECTS-ITERATOR (CL:1+ (%TOP-SYMBOL-OFFSET *SYMBOL-ARRAY*)) (CL:FUNCTION ALL-SYMBOLS-NEXT?)
    MODULE LOCAL?)))
...
(CL:DEFUN FILTER-NON-PARAMETER-SLOT? (SELF ITERATOR)
  ...
  (CL:RETURN-FROM FILTER-NON-PARAMETER-SLOT?
   (CL:NOT (MEMBER? (CLASS-PARAMETERS (%SURROGATE-VALUE (%SLOT-OWNER SELF))) (%SLOT-NAME SELF)))))
...
(CL:DEFUN FILTER-NON-AUXILIARY-SLOT? (SELF ITERATOR)
  ...
  (CL:RETURN-FROM FILTER-NON-AUXILIARY-SLOT?
   (CL:NOT
    (%WRAPPER-VALUE (DYNAMIC-SLOT-VALUE (%DYNAMIC-SLOTS SELF) SYM-ITERATORS-STELLA-SLOT-AUXILIARY? FALSE-WRAPPER)))))
  ...
  (CL:LET* ((ALWAYS?-000 CL:T))
   (CL:LET* ((FILTER NULL) (ITER-000 (%ITERATOR-OBJECT ITERATOR)))
    (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-000 NIL)) DO (CL:SETQ FILTER (%%VALUE ITER-000))
     (CL:WHEN (CL:NOT (CL:FUNCALL (%WRAPPER-VALUE FILTER) SELF ITERATOR)) (CL:SETQ ALWAYS?-000 CL:NIL) (CL:RETURN))
     (CL:SETQ ITER-000 (%%REST ITER-000))))
...
(CL:DEFUN ALL-FUNCTIONS-NEXT? (SELF)
  (CL:LET* ((CURSOR (%ITERATOR-INTEGER SELF)) (SYMBOL NULL) (FUNCTION NULL)) (CL:DECLARE (CL:TYPE CL:FIXNUM CURSOR))
   (CL:LOOP WHILE (CL:< CURSOR (%ITERATOR-SECOND-INTEGER SELF)) DO
    (CL:SETQ SYMBOL (CL:AREF (CL:THE CL:SIMPLE-VECTOR (%THE-ARRAY *SYMBOL-ARRAY*)) CURSOR))
    (CL:WHEN (CL:AND (CL:NOT (CL:EQ SYMBOL NULL)) (SELECTED-META-OBJECT? SELF (LOOKUP-FUNCTION-HOME-MODULE SYMBOL)))
     (CL:SETQ FUNCTION (LOOKUP-FUNCTION SYMBOL))
     (CL:WHEN
      (CL:AND (CL:NOT (CL:EQ FUNCTION NULL))
       (CL:OR (CL:EQ (%ITERATOR-FILTER-CODE SELF) NULL) (CL:FUNCALL (%ITERATOR-FILTER-CODE SELF) FUNCTION SELF)))
      (CL:SETF (%VALUE SELF) FUNCTION) (CL:SETF (%ITERATOR-INTEGER SELF) (CL:1+ CURSOR))
...
If 'module' is null, return all functions defined everywhere."
  (CL:RETURN-FROM ALL-FUNCTIONS
   (ALLOCATE-ALL-META-OBJECTS-ITERATOR (CL:1+ (%TOP-SYMBOL-OFFSET *SYMBOL-ARRAY*)) (CL:FUNCTION ALL-FUNCTIONS-NEXT?)
    MODULE LOCAL?)))
...
If 'module' is null, return all functions defined everywhere."
  (CL:LET* ((ITERATOR (ALL-FUNCTIONS MODULE LOCAL?)))
   (CL:SETF (%ITERATOR-FILTER-CODE ITERATOR) (CL:FUNCTION FILTER-PUBLIC-SLOT?))
   ...
   (CL:LOOP WHILE (CL:< CURSOR (%ITERATOR-SECOND-INTEGER SELF)) DO
    ...
    (CL:WHEN (CL:AND (CL:NOT (CL:EQ SYMBOL NULL)) (SELECTED-META-OBJECT? SELF (%HOME-CONTEXT SYMBOL)))
     ...
     (CL:WHEN
      ...
      (CL:SETF (%VALUE SELF) VARIABLE) (CL:SETF (%ITERATOR-INTEGER SELF) (CL:1+ CURSOR))
...
If 'module' is null, return all variables defined everywhere."
  (CL:RETURN-FROM ALL-VARIABLES
   (ALLOCATE-ALL-META-OBJECTS-ITERATOR (CL:1+ (%TOP-SYMBOL-OFFSET *SYMBOL-ARRAY*)) (CL:FUNCTION ALL-VARIABLES-NEXT?)
    MODULE LOCAL?)))
...
(CL:DEFUN ALL-SURROGATES-NEXT? (SELF)
  (CL:LET* ((CURSOR (%ITERATOR-INTEGER SELF)) (SURROGATE NULL)) (CL:DECLARE (CL:TYPE CL:FIXNUM CURSOR))
   (CL:LOOP WHILE (CL:< CURSOR (%ITERATOR-SECOND-INTEGER SELF)) DO
    ...
    (CL:WHEN (CL:AND (CL:NOT (CL:EQ SURROGATE NULL)) (SELECTED-META-OBJECT? SELF (%HOME-CONTEXT SURROGATE)))
     (CL:SETF (%VALUE SELF) SURROGATE) (CL:SETF (%ITERATOR-INTEGER SELF) (CL:1+ CURSOR))
...
(CL:DEFUN ALL-CLASSES-NEXT? (SELF)
  (CL:LET* ((CURSOR (%ITERATOR-INTEGER SELF)) (SURROGATE NULL) (VALUE NULL)) (CL:DECLARE (CL:TYPE CL:FIXNUM CURSOR))
   (CL:LOOP WHILE (CL:< CURSOR (%ITERATOR-SECOND-INTEGER SELF)) DO
    (CL:SETQ SURROGATE (CL:AREF (CL:THE CL:SIMPLE-VECTOR (%THE-ARRAY *SURROGATE-ARRAY*)) CURSOR))
    (CL:WHEN (CL:AND (CL:NOT (CL:EQ SURROGATE NULL)) (SELECTED-META-OBJECT? SELF (%HOME-CONTEXT SURROGATE)))
     (CL:SETQ VALUE (%SURROGATE-VALUE SURROGATE))
     (CL:WHEN (CL:AND (CL:NOT (CL:EQ VALUE NULL)) (STELLA-CLASS? VALUE) (CL:EQ (%CLASS-TYPE VALUE) SURROGATE))
      (CL:SETF (%VALUE SELF) VALUE) (CL:SETF (%ITERATOR-INTEGER SELF) (CL:1+ CURSOR))
...
If 'module' is null, return all classes interned everywhere."
  (CL:RETURN-FROM ALL-CLASSES
   (ALLOCATE-ALL-META-OBJECTS-ITERATOR (CL:1+ (%TOP-SYMBOL-OFFSET *SURROGATE-ARRAY*)) (CL:FUNCTION ALL-CLASSES-NEXT?)
    MODULE LOCAL?)))
  ...
  (CL:LET* ((SLOT NULL))
   (CL:LOOP
    (CL:LOOP (CL:LET* () (CL:SETQ SLOT (%%VALUE (%ITERATOR-CONS-LIST SELF))) (CL:WHEN (CL:EQ SLOT NULL) (CL:RETURN)))
     (CL:SETF (%ITERATOR-CONS-LIST SELF) (%%REST (%ITERATOR-CONS-LIST SELF)))
     (CL:WHEN (CL:OR (CL:EQ (%ITERATOR-FILTER-CODE SELF) NULL) (CL:FUNCALL (%ITERATOR-FILTER-CODE SELF) SLOT SELF))
      (CL:SETF (%VALUE SELF) SLOT) (CL:RETURN-FROM SLOTS-NEXT? CL:T)))
    (CL:WHEN (CL:NOT (NEXT? (%ITERATOR-NESTED-ITERATOR SELF))) (CL:RETURN-FROM SLOTS-NEXT? CL:NIL))
    (CL:SETF (%ITERATOR-CONS-LIST SELF)
     (%THE-CONS-LIST (%CLASS-LOCAL-SLOTS (%VALUE (%ITERATOR-NESTED-ITERATOR SELF))))))))
...
If 'module' is null, return all methods interned everywhere."
  (CL:LET* ((ITERATOR (NEW-ALL-PURPOSE-ITERATOR))) (CL:SETF (%ITERATOR-NEXT-CODE ITERATOR) (CL:FUNCTION SLOTS-NEXT?))
   (CL:SETF (%ITERATOR-NESTED-ITERATOR ITERATOR) (ALL-CLASSES MODULE LOCAL?))
   (CL:SETF (%ITERATOR-CONS-LIST ITERATOR) NIL) (CL:RETURN-FROM ALL-SLOTS ITERATOR)))
...
If 'module' is null, return all methods interned everywhere."
  (CL:LET* ((ITERATOR (NEW-ALL-PURPOSE-ITERATOR))) (CL:SETF (%ITERATOR-NEXT-CODE ITERATOR) (CL:FUNCTION SLOTS-NEXT?))
   (CL:SETF (%ITERATOR-NESTED-ITERATOR ITERATOR) (ALL-CLASSES MODULE LOCAL?))
   (CL:SETF (%ITERATOR-FILTER-CODE ITERATOR) (CL:FUNCTION FILTER-METHOD-SLOT?))
...
If 'module' is null, return all methods interned everywhere."
  (CL:LET* ((ITERATOR (ALL-SLOTS MODULE LOCAL?)))
   (CL:SETF (%ITERATOR-FILTER-CODE ITERATOR) (CL:FUNCTION FILTER-PUBLIC-METHOD-SLOT?))
   ...
   (CL:LOOP (CL:LET* () (CL:SETQ SLOT (%%VALUE (%ITERATOR-CONS-LIST SELF))) (CL:WHEN (CL:EQ SLOT NULL) (CL:RETURN)))
    ...
    (CL:WHEN
     (CL:AND (METHOD-SLOT? SLOT)
      (CL:OR (CL:EQ (%ITERATOR-FILTER-CODE SELF) NULL) (CL:FUNCALL (%ITERATOR-FILTER-CODE SELF) SLOT SELF)))
...
(CL:DEFUN CLASS-METHODS (CLASS FILTERS)
  (CL:LET* ((ITERATOR (NEW-ALL-PURPOSE-ITERATOR)))
   (CL:SETF (%ITERATOR-NEXT-CODE ITERATOR) (CL:FUNCTION CLASS-METHODS-NEXT?))
   (CL:SETF (%ITERATOR-CONS-LIST ITERATOR) (%THE-CONS-LIST (%CLASS-LOCAL-SLOTS CLASS)))
   (CL:SETF (%ITERATOR-OBJECT ITERATOR) FILTERS) (CL:SETF (%ITERATOR-FILTER-CODE ITERATOR) (CL:FUNCTION FILTER-SLOT?))
   ...
   (CLASS-METHODS CLASS
    (CONS (WRAP-FUNCTION-CODE (CL:FUNCTION FILTER-PUBLIC-SLOT?))
     (CONS (WRAP-FUNCTION-CODE (CL:FUNCTION FILTER-NON-EXTERNAL-SLOT?))
      (CONS (WRAP-FUNCTION-CODE (CL:FUNCTION FILTER-NON-AUXILIARY-SLOT?)) NIL))))))
...
(CL:DEFUN CLASS-STORAGE-SLOTS (CLASS FILTERS)
  (CL:LET* ((ITERATOR (NEW-ALL-PURPOSE-ITERATOR)))
   (CL:SETF (%ITERATOR-NEXT-CODE ITERATOR) (CL:FUNCTION CLASS-STORAGE-SLOTS-NEXT?))
   (CL:SETF (%ITERATOR-CONS-LIST ITERATOR) (%THE-CONS-LIST (%CLASS-LOCAL-SLOTS CLASS)))
   (CL:SETF (%ITERATOR-OBJECT ITERATOR) FILTERS) (CL:SETF (%ITERATOR-FILTER-CODE ITERATOR) (CL:FUNCTION FILTER-SLOT?))
...
(CL:DEFUN CLASS-TABLES (CLASS FILTERS)
  (CL:LET* ((ITERATOR (NEW-ALL-PURPOSE-ITERATOR)))
   (CL:SETF (%ITERATOR-NEXT-CODE ITERATOR) (CL:FUNCTION CLASS-TABLES-NEXT?))
   (CL:SETF (%ITERATOR-CONS-LIST ITERATOR) (%THE-CONS-LIST (%CLASS-LOCAL-SLOTS CLASS)))
   (CL:SETF (%ITERATOR-OBJECT ITERATOR) FILTERS) (CL:SETF (%ITERATOR-FILTER-CODE ITERATOR) (CL:FUNCTION FILTER-SLOT?))
...
(CL:DEFUN NEW-CROSS-PRODUCT-ITERATOR ()
  (CL:LET* ((SELF NULL)) (CL:SETQ SELF (CL:MAKE-INSTANCE (CL:QUOTE CROSS-PRODUCT-ITERATOR)))
   (CL:SETF (%FIRST-ITERATION? SELF) CL:T) (CL:SETF (%VALUE SELF) NULL) (CL:SETF (%CURSORS SELF) NIL)
   (CL:SETF (%DOMAINS SELF) NIL) (CL:RETURN-FROM NEW-CROSS-PRODUCT-ITERATOR SELF)))
...
(CL:DEFUN ACCESS-CROSS-PRODUCT-ITERATOR-SLOT-VALUE (SELF SLOTNAME VALUE SETVALUE?)
  (CL:COND
   ((CL:EQ SLOTNAME SYM-ITERATORS-STELLA-DOMAINS)
    (CL:IF SETVALUE? (CL:SETF (%DOMAINS SELF) VALUE) (CL:SETQ VALUE (%DOMAINS SELF))))
   ((CL:EQ SLOTNAME SYM-ITERATORS-STELLA-CURSORS)
    (CL:IF SETVALUE? (CL:SETF (%CURSORS SELF) VALUE) (CL:SETQ VALUE (%CURSORS SELF))))
   (CL:T
...
(CL:DEFUN ALLOCATE-CROSS-PRODUCT-ITERATOR (DOMAINS)
  ...
  (CL:LET* ((SELF-000 (NEW-CROSS-PRODUCT-ITERATOR))) (CL:SETF (%DOMAINS SELF-000) DOMAINS)
   (CL:LET* ((ITERATOR SELF-000) (CURSORS NIL) (VALUES NIL))
    (CL:LET* ((DOMAIN NULL) (ITER-000 DOMAINS) (I NULL-INTEGER) (ITER-001 0))
     ...
     (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-000 NIL)) DO (CL:SETQ DOMAIN (%%VALUE ITER-000)) (CL:SETQ I ITER-001)
      ...
      (CL:SETQ CURSORS (CONS (CL:IF (CL:= I 0) DOMAIN (%%REST DOMAIN)) CURSORS))
      (CL:SETQ VALUES (CONS (%%VALUE DOMAIN) VALUES)) (CL:SETQ ITER-000 (%%REST ITER-000))
      (CL:SETQ ITER-001 (CL:1+ ITER-001))))
    (CL:SETF (%CURSORS ITERATOR) (REVERSE CURSORS)) (CL:SETF (%VALUE ITERATOR) (REVERSE VALUES))
    (CL:RETURN-FROM ALLOCATE-CROSS-PRODUCT-ITERATOR ITERATOR))))
...
this is somewhat expensive, costing almost as much as allocating the iterator."
  (CL:LET* ((DOMAINS (%DOMAINS SELF)) (CURSORS NIL) (VALUES NIL))
   (CL:LET* ((DOMAIN NULL) (ITER-000 DOMAINS) (I NULL-INTEGER) (ITER-001 0))
    (CL:DECLARE (CL:TYPE CL:FIXNUM I ITER-001))
    (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-000 NIL)) DO (CL:SETQ DOMAIN (%%VALUE ITER-000)) (CL:SETQ I ITER-001)
     (CL:WHEN (CL:OR (CL:EQ DOMAIN NULL) (CL:EQ DOMAIN NIL)) (CL:RETURN-FROM RESET))
     (CL:SETQ CURSORS (CONS (CL:IF (CL:= I 0) DOMAIN (%%REST DOMAIN)) CURSORS))
     (CL:SETQ VALUES (CONS (%%VALUE DOMAIN) VALUES)) (CL:SETQ ITER-000 (%%REST ITER-000))
     (CL:SETQ ITER-001 (CL:1+ ITER-001))))
...
(CL:DEFMETHOD NEXT? ((SELF CROSS-PRODUCT-ITERATOR))
  (CL:LET* ((DOMAINS (%DOMAINS SELF)) (CURSORS (%CURSORS SELF)) (CURSOR NIL) (VALUES (%VALUE SELF)))
   ...
   (CL:LOOP WHILE (CL:NOT (CL:EQ CURSORS NIL)) DO (CL:SETQ CURSOR (%%VALUE CURSORS))
    (CL:COND
     ((CL:NOT (CL:EQ CURSOR NIL)) (FIRST-SETTER VALUES (%%VALUE CURSOR)) (FIRST-SETTER CURSORS (%%REST CURSOR))
      (CL:RETURN-FROM NEXT? CL:T))
     (CL:T (CL:SETQ CURSOR (%%VALUE DOMAINS)) (FIRST-SETTER VALUES (%%VALUE CURSOR))
...
if one of them is 'eql' to 'value.\")" (CL:FUNCTION MEMBER?) NULL)
   (DEFINE-METHOD-OBJECT "(DEFMETHOD (NEXT? BOOLEAN) ((SELF DESTRUCTIVE-LIST-ITERATOR)) :PUBLIC? TRUE)"
    (CL:FUNCTION NEXT?) NULL)
   (DEFINE-METHOD-OBJECT "(DEFMETHOD (EMPTY? BOOLEAN) ((SELF DESTRUCTIVE-LIST-ITERATOR)) :PUBLIC? TRUE)"
   ...
   (DEFINE-METHOD-OBJECT
    ...
    (CL:FUNCTION NEXT?) NULL)
   (DEFINE-METHOD-OBJECT "(DEFMETHOD (EMPTY? BOOLEAN) ((SELF ALL-PURPOSE-ITERATOR)) :PUBLIC? TRUE)"
    (CL:FUNCTION EMPTY?) NULL)
   (DEFINE-METHOD-OBJECT
   ...
   (DEFINE-FUNCTION-OBJECT "ITERATOR-CONS-LIST-NEXT?"
    "(DEFUN (ITERATOR-CONS-LIST-NEXT? BOOLEAN) ((SELF ALL-PURPOSE-ITERATOR)))" (CL:FUNCTION ITERATOR-CONS-LIST-NEXT?)
    NULL)
   (DEFINE-FUNCTION-OBJECT "ITERATOR-CONS-LIST-EMPTY?"
    "(DEFUN (ITERATOR-CONS-LIST-EMPTY? BOOLEAN) ((SELF ALL-PURPOSE-ITERATOR)))" (CL:FUNCTION ITERATOR-CONS-LIST-EMPTY?)
    NULL)
...
resulting iterator.\" :PUBLIC? TRUE)" (CL:FUNCTION CONCATENATE) NULL)
   (DEFINE-METHOD-OBJECT "(DEFMETHOD INITIALIZE-INTEGER-INTERVAL-ITERATOR ((SELF INTEGER-INTERVAL-ITERATOR)))"
    (CL:FUNCTION INITIALIZE-INTEGER-INTERVAL-ITERATOR) NULL)
   ...
   (DEFINE-METHOD-OBJECT "(DEFMETHOD (NEXT? BOOLEAN) ((SELF REVERSE-INTEGER-INTERVAL-ITERATOR)) :PUBLIC? TRUE)"
    (CL:FUNCTION NEXT?) NULL)
   ...
   (DEFINE-METHOD-OBJECT "(DEFMETHOD (ALLOCATE-ITERATOR STRING-ITERATOR) ((SELF STRING)) :PUBLIC? TRUE)"
   ...
   (DEFINE-FUNCTION-OBJECT "ALL-SYMBOLS-NEXT?"
    "(DEFUN (ALL-SYMBOLS-NEXT? BOOLEAN) ((SELF ALL-PURPOSE-ITERATOR)) :PUBLIC? TRUE)" (CL:FUNCTION ALL-SYMBOLS-NEXT?)
    NULL)
...
If 'module' is null, return all symbols interned everywhere.\" :PUBLIC? TRUE)" (CL:FUNCTION ALL-SYMBOLS) NULL)
   ...
   (DEFINE-FUNCTION-OBJECT "FILTER-SLOT?"
    "(DEFUN (FILTER-SLOT? BOOLEAN) ((SELF SLOT) (ITERATOR ALL-PURPOSE-ITERATOR)))" (CL:FUNCTION FILTER-SLOT?) NULL)
   (DEFINE-FUNCTION-OBJECT "ALL-FUNCTIONS-NEXT?" "(DEFUN (ALL-FUNCTIONS-NEXT? BOOLEAN) ((SELF ALL-PURPOSE-ITERATOR)))"
...
If 'local?', return only functions bound to symbols interned in 'module'.
If 'module' is null, return all functions defined everywhere.\" :PUBLIC? TRUE)" (CL:FUNCTION ALL-PUBLIC-FUNCTIONS)
    NULL)
   (DEFINE-FUNCTION-OBJECT "ALL-VARIABLES-NEXT?" "(DEFUN (ALL-VARIABLES-NEXT? BOOLEAN) ((SELF ALL-PURPOSE-ITERATOR)))"
...
If 'module' is null, return all variables defined everywhere.\" :PUBLIC? TRUE)" (CL:FUNCTION ALL-VARIABLES) NULL)
   (DEFINE-FUNCTION-OBJECT "ALL-SURROGATES-NEXT?"
    "(DEFUN (ALL-SURROGATES-NEXT? BOOLEAN) ((SELF ALL-PURPOSE-ITERATOR)))" (CL:FUNCTION ALL-SURROGATES-NEXT?) NULL)
...
If 'module' is null, return all surrogates interned everywhere.\" :PUBLIC? TRUE)" (CL:FUNCTION ALL-SURROGATES) NULL)
   (DEFINE-FUNCTION-OBJECT "ALL-CLASSES-NEXT?" "(DEFUN (ALL-CLASSES-NEXT? BOOLEAN) ((SELF ALL-PURPOSE-ITERATOR)))"
...
If 'module' is null, return all classes interned everywhere.\" :PUBLIC? TRUE)" (CL:FUNCTION ALL-CLASSES) NULL)
   (DEFINE-FUNCTION-OBJECT "SLOTS-NEXT?" "(DEFUN (SLOTS-NEXT? BOOLEAN) ((SELF ALL-PURPOSE-ITERATOR)))"
...
If 'module' is null, return all methods interned everywhere.\" :PUBLIC? TRUE)" (CL:FUNCTION ALL-PUBLIC-METHODS) NULL)
   (DEFINE-FUNCTION-OBJECT "CLASS-METHODS-NEXT?" "(DEFUN (CLASS-METHODS-NEXT? BOOLEAN) ((SELF ALL-PURPOSE-ITERATOR)))"
   ...
   (DEFINE-FUNCTION-OBJECT "CLASS-STORAGE-SLOTS-NEXT?"
    "(DEFUN (CLASS-STORAGE-SLOTS-NEXT? BOOLEAN) ((SELF ALL-PURPOSE-ITERATOR)))" (CL:FUNCTION CLASS-STORAGE-SLOTS-NEXT?)
    NULL)
...
iteration.\" :PUBLIC? TRUE :PARAMETERS ((ANY-VALUE :TYPE CONS)) :SLOTS ((DOMAINS :TYPE (CONS OF CONS) :INITIALLY NIL) (CURSORS :TYPE (CONS OF CONS) :INITIALLY NIL)))")))
   ...
   (CL:WHEN (CURRENT-STARTUP-TIME-PHASE? 7) (HELP-STARTUP-ITERATORS2)
    (DEFINE-FUNCTION-OBJECT "CLASS-TABLES-NEXT?" "(DEFUN (CLASS-TABLES-NEXT? BOOLEAN) ((SELF ALL-PURPOSE-ITERATOR)))"
...
this is somewhat expensive, costing almost as much as allocating the iterator.\" :PUBLIC? TRUE)" (CL:FUNCTION RESET)
     NULL)
    (DEFINE-METHOD-OBJECT "(DEFMETHOD (NEXT? BOOLEAN) ((SELF CROSS-PRODUCT-ITERATOR)))" (CL:FUNCTION NEXT?) NULL)
    (DEFINE-FUNCTION-OBJECT "STARTUP-ITERATORS" "(DEFUN STARTUP-ITERATORS () :PUBLIC? TRUE)"
     (CL:FUNCTION STARTUP-ITERATORS) NULL)
    (CL:LET* ((FUNCTION (LOOKUP-FUNCTION SYM-ITERATORS-STELLA-STARTUP-ITERATORS)))
     (SET-DYNAMIC-SLOT-VALUE (%DYNAMIC-SLOTS FUNCTION) SYM-ITERATORS-STELLA-METHOD-STARTUP-CLASSNAME
