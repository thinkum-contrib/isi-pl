...
(CL:DEFVAR SYM-READ-STELLA-SAVE-TOKENIZER-STREAM-STATE-EXPANDER NULL)
...
(CL:DEFVAR SYM-READ-STELLA-GET-NEXT-TOKEN-EXPANDER NULL)
...
(CL:DEFVAR SYM-READ-STELLA-TOK_STELLASTATENAME_ NULL)
...
(CL:DEFVAR SYM-READ-STELLA-WITH-STELLA-TOKENIZER NULL)
(CL:DEFVAR SYM-READ-STELLA-WITH-STELLA-TOKENIZER-EXPANDER NULL)
(CL:DEFVAR SYM-READ-STELLA-GET-NEXT-STELLA-TOKEN NULL)
(CL:DEFVAR SYM-READ-STELLA-GET-NEXT-STELLA-TOKEN-EXPANDER NULL)
(CL:DEFVAR SYM-READ-STELLA-GET-STELLA-TOKEN-TYPE NULL)
(CL:DEFVAR SYM-READ-STELLA-GET-STELLA-TOKEN-TYPE-EXPANDER NULL)
(CL:DEFVAR SYM-READ-STELLA-GET-QUALIFIED-SYMBOL-SEPARATOR-POSITION-INTERNAL NULL)
(CL:DEFVAR SYM-READ-STELLA-GET-QUALIFIED-SYMBOL-SEPARATOR-POSITION NULL)
(CL:DEFVAR SYM-READ-STELLA-GET-QUALIFIED-SYMBOL-SEPARATOR-POSITION-EXPANDER NULL)
...
(CL:DEFVAR KWD-READ-SKIP-WHITESPACE NULL)
(CL:DEFVAR KWD-READ-OPEN-TAG NULL)
(CL:DEFVAR KWD-READ-CONTENT NULL)
(CL:DEFVAR KWD-READ-START-TAG-END NULL)
(CL:DEFVAR KWD-READ-OPEN-END-TAG NULL)
(CL:DEFVAR KWD-READ-OPEN-PI-TAG NULL)
(CL:DEFVAR KWD-READ-OPEN-DECLARATION-TAG NULL)
(CL:DEFVAR KWD-READ-START-TAG NULL)
(CL:DEFVAR KWD-READ-OPEN-EMPTY-TAG-END NULL)
(CL:DEFVAR KWD-READ-SKIP-TO-ATTRIBUTE-NAME NULL)
(CL:DEFVAR KWD-READ-START-PI-TAG NULL)
(CL:DEFVAR KWD-READ-OPEN-PI-TAG-END NULL)
(CL:DEFVAR KWD-READ-PI-TAG-DATA NULL)
(CL:DEFVAR KWD-READ-PI-TAG-DATA-OR-END NULL)
(CL:DEFVAR KWD-READ-EMPTY-TAG-END NULL)
(CL:DEFVAR KWD-READ-END-TAG-END NULL)
(CL:DEFVAR KWD-READ-END-TAG NULL)
(CL:DEFVAR KWD-READ-ATTRIBUTE-NAME NULL)
(CL:DEFVAR KWD-READ-SKIP-TO-ATTRIBUTE-VALUE NULL)
(CL:DEFVAR KWD-READ-SINGLE-QUOTED-ATTRIBUTE-VALUE NULL)
(CL:DEFVAR KWD-READ-DOUBLE-QUOTED-ATTRIBUTE-VALUE NULL)
(CL:DEFVAR KWD-READ-UNQUOTED-ATTRIBUTE-VALUE NULL)
(CL:DEFVAR KWD-READ-QUOTED-ATTRIBUTE-VALUE NULL)
(CL:DEFVAR KWD-READ-START-TAG-OR-COMMENT NULL)
(CL:DEFVAR KWD-READ-OPEN-SPECIAL-TAG NULL)
(CL:DEFVAR KWD-READ-START-DECLARATION-TAG NULL)
(CL:DEFVAR KWD-READ-DECLARATION-TAG-DATA NULL)
(CL:DEFVAR KWD-READ-SINGLE-QUOTED-DECLARATION-TAG-DATA NULL)
(CL:DEFVAR KWD-READ-DOUBLE-QUOTED-DECLARATION-TAG-DATA NULL)
(CL:DEFVAR KWD-READ-START-SPECIAL-TAG NULL)
(CL:DEFVAR KWD-READ-SPECIAL-TAG-DATA NULL)
(CL:DEFVAR KWD-READ-SPECIAL-TAG-DATA-OR-END NULL)
(CL:DEFVAR KWD-READ-SPECIAL-TAG-DATA-OR-END2 NULL)
(CL:DEFVAR KWD-READ-COMMENT-BODY NULL)
(CL:DEFVAR KWD-READ-END-COMMENT-OR-COMMENT NULL)
(CL:DEFVAR KWD-READ-END-COMMENT-OR-COMMENT2 NULL)
(CL:DEFVAR KWD-READ-ATTRIBUTE-VALUE NULL)
(CL:DEFVAR SYM-READ-STELLA-? NULL)
(CL:DEFVAR SYM-READ-STELLA-[ NULL)
(CL:DEFVAR SGT-READ-STELLA-XML-EXPRESSION-ITERATOR NULL)
(CL:DEFVAR SYM-READ-STELLA-REGION-TAG NULL)
(CL:DEFVAR SYM-READ-STELLA-REGION-MATCH-FUNCTION NULL)
...
(CL:DECLAIM
 (CL:SPECIAL *STELLA-MODULE* STANDARD-OUTPUT *CHARACTER-TYPE-TABLE*
  *TRANSIENTOBJECTS?* KEYWORD-SYM *MODULE* MODULE-SEPARATOR-CHARACTER
  *CHARACTER-UPCASE-TABLE* ZERO-WRAPPER STANDARD-ERROR EOL STANDARD-INPUT
  EOL-STRING NIL-LIST NULL-CHARACTER TRUE-WRAPPER FALSE-WRAPPER))

;;; (DEFCLASS TOKENIZER-TABLE ...)

(CL:DEFCLASS TOKENIZER-TABLE (STANDARD-OBJECT)
  ((TRANSITIONS :ALLOCATION :INSTANCE :ACCESSOR %TRANSITIONS)
...
(CL:PROGN (CL:DEFVAR *MAX-TOKENIZER-STATES* 64) (CL:DECLAIM (CL:TYPE CL:FIXNUM *MAX-TOKENIZER-STATES*)))

;;; (DEFGLOBAL *MAX-TOKENIZER-CHARACTERS* ...)

(CL:PROGN (CL:DEFVAR *MAX-TOKENIZER-CHARACTERS* 256) (CL:DECLAIM (CL:TYPE CL:FIXNUM *MAX-TOKENIZER-CHARACTERS*)))
...
(CL:DEFUN PARSE-TOKENIZER-DEFINITION (DEFINITION)
  (CL:LET*
   ((TRANSITIONTABLE (NEW-VECTOR *MAX-TOKENIZER-STATES*))
    ...
    (CHARACTERSPEC NULL) (CHARACTERSET NULL) (ALLCHARACTERSETS (NEW-LIST))
    (STATEMODIFIERS 0) (ERRORS? FALSE) (TABLE (NEW-TOKENIZER-TABLE)))
   ...
   (CL:LET
    ((SELF (%THE-ARRAY STATENAMES)) (VALUE KWD-READ-ERROR) (POSITION 0))
    (CL:DECLARE (CL:TYPE CL:SIMPLE-VECTOR SELF)
     (CL:TYPE CL:FIXNUM POSITION))
    (CL:SETF (CL:AREF SELF POSITION) VALUE))
   (CL:LET
     ...
     (CL:TAGBODY
       ...
       (CL:TAGBODY
        (CL:WHEN (TOKENIZER-INCLUDE-SPEC? (%%VALUE STATEDEFINITION))
         ...
         (CL:LET* ((STATEDEF NULL) (ITER-002 DEFINITION))
          (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-002 NIL)) DO
           (CL:PROGN (CL:SETQ STATEDEF (%%VALUE ITER-002))
            (CL:SETQ ITER-002 (%%REST ITER-002)))
           (CL:WHEN
            (EQL? (%%VALUE STATEDEF) (%%VALUE (%%REST STATEDEFINITION)))
        ...
        (CL:LET* ((CHAR NULL) (ITER-003 CHARACTERSET))
         (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-003 NIL)) DO
          (CL:PROGN (CL:SETQ CHAR (%%VALUE ITER-003))
      ...
      (CL:LET
       ((SELF (%THE-ARRAY TRANSITIONTABLE))
        (VALUE (WRAP-MUTABLE-STRING TRANSITIONS)) (POSITION FROMSTATEID))
       (CL:DECLARE (CL:TYPE CL:SIMPLE-VECTOR SELF)
        (CL:TYPE CL:FIXNUM POSITION))
       (CL:SETF (CL:AREF SELF POSITION) VALUE))
      (CL:SETQ TRANSITIONS
      ...
      :CONTINUE)))
   (CL:LET*
    ((I NULL-INTEGER) (ITER-004 0) (UPPER-BOUND-001 (CL:1- FREESTATEID)))
    (CL:DECLARE (CL:TYPE CL:FIXNUM ITER-004 UPPER-BOUND-001 I))
    (CL:LOOP WHILE (CL:<= ITER-004 UPPER-BOUND-001) DO
     (CL:PROGN (CL:SETQ I ITER-004) (CL:SETQ ITER-004 (CL:1+ ITER-004)))
     (CL:WHEN
      (CL:EQ
       (CL:AREF (CL:THE CL:SIMPLE-VECTOR (%THE-ARRAY TRANSITIONTABLE)) I)
       NULL)
   ...
   (CL:LET*
    ((I NULL-INTEGER) (ITER-005 0) (UPPER-BOUND-002 (CL:1- FREESTATEID)))
    (CL:DECLARE (CL:TYPE CL:FIXNUM ITER-005 UPPER-BOUND-002 I))
    (CL:LOOP WHILE (CL:<= ITER-005 UPPER-BOUND-002) DO
     (CL:PROGN (CL:SETQ I ITER-005) (CL:SETQ ITER-005 (CL:1+ ITER-005)))
     (CL:LET*
      ((K NULL-INTEGER) (J NULL-INTEGER) (ITER-006 0)
       (UPPER-BOUND-003 (CL:1- *MAX-TOKENIZER-CHARACTERS*))
       (ITER-007 (CL:* *MAX-TOKENIZER-CHARACTERS* I)))
      (CL:DECLARE
       (CL:TYPE CL:FIXNUM ITER-006 UPPER-BOUND-003 ITER-007 J K))
      (CL:LOOP WHILE (CL:<= ITER-006 UPPER-BOUND-003) DO
       (CL:PROGN (CL:SETQ J ITER-006) (CL:SETQ ITER-006 (CL:1+ ITER-006)))
       (CL:PROGN (CL:SETQ K ITER-007) (CL:SETQ ITER-007 (CL:1+ ITER-007)))
       (CL:LET
        ((SELF TRANSITIONS)
         (CH
          (CL:LET
           ((SELF
             (%WRAPPER-VALUE
              (CL:AREF
               (CL:THE CL:SIMPLE-VECTOR (%THE-ARRAY TRANSITIONTABLE)) I)))
            (POSITION J))
           (CL:DECLARE (CL:TYPE CL:SIMPLE-STRING SELF)
            (CL:TYPE CL:FIXNUM POSITION))
           (CL:AREF (CL:THE CL:SIMPLE-STRING SELF)
   ...
   (CL:LET*
    ((I NULL-INTEGER) (ITER-008 0) (UPPER-BOUND-004 (CL:1- FREESTATEID)))
   ...
   (CL:LET*
    ((I NULL-INTEGER) (ITER-009 0) (UPPER-BOUND-005 (CL:1- FREESTATEID)))
    (CL:DECLARE (CL:TYPE CL:FIXNUM ITER-009 UPPER-BOUND-005 I))
    (CL:LOOP WHILE (CL:<= ITER-009 UPPER-BOUND-005) DO
     (CL:PROGN (CL:SETQ I ITER-009) (CL:SETQ ITER-009 (CL:1+ ITER-009)))
     (CL:LET
   ...
   (CL:LET* ((TEST-VALUE-001 (SAFE-PRIMARY-TYPE CHARACTERSPEC)))
    (CL:COND
     ((SUBTYPE-OF-STRING? TEST-VALUE-001)
      (CL:PROGN
       (CL:LET*
        ((CHAR NULL-CHARACTER) (VECTOR-000 (%WRAPPER-VALUE CHARACTERSPEC))
         (INDEX-000 0)
        ...
        (CL:LOOP WHILE (CL:< INDEX-000 LENGTH-000) DO
         ...
         (CL:IF (CL:EQ COLLECT-000 NULL)
          ...
          (CL:PROGN
           (CL:SETF (%%REST COLLECT-000) (CONS (WRAP-CHARACTER CHAR) NIL))
     ...
     ((CL:EQ TEST-VALUE-001 SGT-READ-STELLA-CONS)
      (CL:PROGN
       (CL:LET* ((SPEC NULL) (ITER-000 CHARACTERSPEC))
        (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-000 NIL)) DO
         (CL:PROGN (CL:SETQ SPEC (%%VALUE ITER-000))
          (CL:SETQ ITER-000 (%%REST ITER-000)))
         (CL:SETQ PARSEDSPEC
         ...
         (CL:LET* ((CHAR NULL) (ITER-001 PARSEDSPEC) (COLLECT-001 NULL))
          (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-001 NIL)) DO
           (CL:PROGN (CL:SETQ CHAR (%%VALUE ITER-001))
         ...
         ((STRING-EQL? TEST-VALUE-000 "OTHERWISE")
          ...
          (CL:LET*
           ((I NULL-INTEGER) (ITER-005 0)
            ...
            (COLLECT-004 NULL))
           (CL:DECLARE (CL:TYPE CL:FIXNUM ITER-005 UPPER-BOUND-001 I))
           (CL:LOOP WHILE (CL:<= ITER-005 UPPER-BOUND-001) DO
            (CL:PROGN (CL:SETQ I ITER-005)
             (CL:SETQ ITER-005 (CL:1+ ITER-005)))
            (CL:WHEN
             (CL:NOT (MEMBER? CHARSET (WRAP-CHARACTER (CL:CODE-CHAR I))))
...
(CL:DEFUN STRINGIFY-TOKENIZER-TABLE (TABLE)
  (CL:LET*
   ...
   (CL:DECLARE (CL:TYPE CL:FIXNUM ACODE J)
    (CL:TYPE CL:SIMPLE-STRING TRANSITIONS ENCODEDTRANSITIONS SEPARATOR))
   (%%PRINT-STREAM (%NATIVE-STREAM RESULT)
    (CL:* 2 *MAX-TOKENIZER-STATES* *MAX-TOKENIZER-CHARACTERS*) SEPARATOR)
   (CL:LET*
    ((I NULL-INTEGER) (ITER-000 0)
     (UPPER-BOUND-000
      (CL:1- (CL:* *MAX-TOKENIZER-STATES* *MAX-TOKENIZER-CHARACTERS*))))
...
(CL:DEFUN UNSTRINGIFY-TOKENIZER-TABLE (TABLE)
  ...
  (CL:LET*
   ((RESULT (NEW-TOKENIZER-TABLE))
    (ACODE (CL:THE CL:FIXNUM (CL:CHAR-CODE #\A)))
    (LINE STELLA::NULL-STRING) (COUNT 0) (TRANSITIONS STELLA::NULL-STRING)
    (SEPARATOR #\|) (START 0) (END 0))
   ...
   (CL:SETQ START (CL:1+ END)) (CL:SETQ COUNT (STRING-TO-INTEGER LINE))
   (CL:SETQ END (POSITION TABLE SEPARATOR START))
   (CL:SETQ LINE (SUBSEQUENCE TABLE START END))
   (CL:SETQ START (CL:1+ END))
   (CL:SETQ TRANSITIONS
    (CL:THE CL:SIMPLE-STRING
     (CL:MAKE-STRING (CL:THE CL:FIXNUM (CL:TRUNCATE (CL:/ COUNT 2.0d0)))
      :INITIAL-ELEMENT NULL-CHARACTER)))
   (CL:LET*
    ((I NULL-INTEGER) (ITER-000 0)
   ...
   (CL:LET*
    ...
    (CL:DECLARE (CL:TYPE CL:FIXNUM ITER-002 UPPER-BOUND-002 I))
   ...
   (CL:LET*
    ...
    (CL:DECLARE (CL:TYPE CL:FIXNUM ITER-003 UPPER-BOUND-003 I))
...
(CL:DEFMETHOD BYTE-ARRAY-NTH ((BUFFER CL:STRING) POSITION)
  ...
  (CL:RETURN-FROM BYTE-ARRAY-NTH
   (CL:AREF (CL:THE CL:SIMPLE-STRING BUFFER) (CL:THE CL:FIXNUM POSITION))))
...
(CL:DEFUN BYTE-ARRAY-READ-SEQUENCE (BUFFER STREAM START END)
  ...
  (CL:LET* ((N 0)) (CL:DECLARE (CL:TYPE CL:FIXNUM N)) (setq n
   ...
   (CL:RETURN-FROM BYTE-ARRAY-READ-SEQUENCE (CL:+ N START))))

;;; (DEFGLOBAL *TOKENIZER-INITIAL-BUFFER-SIZE* ...)

(CL:PROGN (CL:DEFVAR *TOKENIZER-INITIAL-BUFFER-SIZE* 2048) (CL:DECLAIM (CL:TYPE CL:FIXNUM *TOKENIZER-INITIAL-BUFFER-SIZE*)))
...
(CL:DEFUN ENSURE-TOKENIZER-BUFFER-SIZE (STATE CURRENTTOKENSTART REQUIREDSPACE)
  ...
  (CL:LET*
   ((SIZE (%BUFFER-SIZE STATE)) (NEWSIZE SIZE)
    (END (CL:THE CL:FIXNUM (CL:MOD (CL:THE CL:FIXNUM (%END STATE)) SIZE)))
    (FREESPACE
         ...
         ((BUFFER NEWBUFFER)
          (CH
           (CL:LET ((BUFFER BUFFER) (POSITION I))
            (CL:DECLARE (CL:TYPE CL:FIXNUM POSITION))
            (CL:AREF (CL:THE CL:SIMPLE-STRING BUFFER)
             (CL:THE CL:FIXNUM POSITION))))
          (POSITION I))
         (CL:DECLARE (CL:TYPE CL:FIXNUM POSITION))
         (CL:SETF
       ...
       (CL:LOOP WHILE (CL:<= ITER-001 UPPER-BOUND-001) DO
        ...
        (CL:LET
         ...
         (CL:SETF
          ...
          (CL:THE CL:CHARACTER CH)))))
      (CL:LET*
       ((J NULL-INTEGER) (I NULL-INTEGER) (ITER-002 0)
        (UPPER-BOUND-002 (CL:1- END)) (ITER-003 SIZE))
       (CL:DECLARE
        (CL:TYPE CL:FIXNUM ITER-002 UPPER-BOUND-002 ITER-003 I J))
       (CL:LOOP WHILE (CL:<= ITER-002 UPPER-BOUND-002) DO
        (CL:PROGN (CL:SETQ I ITER-002)
         (CL:SETQ ITER-002 (CL:1+ ITER-002)))
        (CL:PROGN (CL:SETQ J ITER-003)
...
(CL:DEFUN READ-INTO-TOKENIZER-BUFFER (STREAM STATE CURRENTTOKENSTART)
  ...
  (CL:LET*
   ((REQUIREDSPACE
    ...
    (INTERACTIVESTREAM? (CL:EQ STREAM STANDARD-INPUT))
    (INPUTLINE STELLA::NULL-STRING))
   (CL:DECLARE (CL:TYPE CL:FIXNUM REQUIREDSPACE)
    (CL:TYPE CL:SIMPLE-STRING INPUTLINE))
   (CL:WHEN INTERACTIVESTREAM? (CL:SETF (%TOKENIZER-STATE STREAM) NULL)
    (CL:SETQ INPUTLINE (READ-LINE STREAM))
   ...
   (CL:LET*
    ...
    (CL:COND
     ...
     (CL:T
      (CL:SETQ END
       (BYTE-ARRAY-READ-SEQUENCE BUFFER NATIVESTREAM START END))))
    (CL:SETF (%END STATE) END)
    (CL:RETURN-FROM READ-INTO-TOKENIZER-BUFFER (CL:= START END)))))
     ...
     (CL:EQL CHAR
      (CL:LET ((BUFFER (%BUFFER STATE)) (POSITION CURSOR))
       ...
       (CL:AREF (CL:THE CL:SIMPLE-STRING BUFFER)
        (CL:THE CL:FIXNUM POSITION)))))
    (CL:LET* ((STREAM-000 (NEW-OUTPUT-STRING-STREAM)))
     (%%PRINT-STREAM (%NATIVE-STREAM STREAM-000) "Unread character `" CHAR
      "' does not match last character read")
     (CL:ERROR (NEW-STELLA-EXCEPTION (THE-STRING-READER STREAM-000)))))
   (CL:SETF (%CURSOR STATE) CURSOR))
  :VOID)

;;; (DEFUN (READ-LINE-FROM-TOKENIZER-BUFFER STRING BOOLEAN) ...)

(CL:DEFUN READ-LINE-FROM-TOKENIZER-BUFFER (STREAM)
  (CL:LET*
   ((BUFFER (NEW-OUTPUT-STRING-STREAM)) (LINE STELLA::NULL-STRING)
    (CH NULL-CHARACTER) (CH2 NULL-CHARACTER) (EOF? FALSE)
    (NEWLINE
    ...
    (CL:TAGBODY
     ...
     (CL:WHEN EOF? (CL:SETQ LINE (THE-STRING-READER BUFFER))
      (CL:IF (CL:= (CL:THE CL:FIXNUM (CL:LENGTH LINE)) 0)
       (CL:SETQ LINE STELLA::NULL-STRING) (CL:SETQ EOF? FALSE))
      (CL:RETURN))
   ...
   (CL:RETURN-FROM READ-LINE-FROM-TOKENIZER-BUFFER (CL:VALUES LINE EOF?))))

;;; (DEFCLASS TOKENIZER-TOKEN ...)

(CL:DEFCLASS TOKENIZER-TOKEN (STANDARD-OBJECT)
  ((TYPE :ALLOCATION :INSTANCE :ACCESSOR %TYPE)
   (CONTENT :ALLOCATION :INSTANCE :ACCESSOR %CONTENT)
...
(CL:DEFCLASS TOKENIZER-STREAM-STATE (STANDARD-OBJECT)
  ((BUFFER :ALLOCATION :INSTANCE :ACCESSOR %BUFFER)
   (BUFFER-SIZE :ALLOCATION :INSTANCE :ACCESSOR %BUFFER-SIZE)
   (CURSOR :ALLOCATION :INSTANCE :ACCESSOR %CURSOR)
   (END :ALLOCATION :INSTANCE :ACCESSOR %END)
...
(CL:DEFUN NEW-TOKENIZER-STREAM-STATE ()
  (CL:LET* ((SELF NULL))
   ...
   (CL:SETF (%TOKEN-LIST SELF) NULL) (CL:SETF (%STATE SELF) 1)
...
(CL:DEFUN WITH-TOKENIZER-EXPANDER (TABLE INPUT BODY)
  (CL:LET* ((INPUTTREE NULL) (INPUTTYPE NULL))
   ...
   (CL:WHEN
    ...
    (CL:RETURN-FROM WITH-TOKENIZER-EXPANDER
        ...
        (CONCATENATE
         (CL:IF STRING?
          (LIST*
           ...
           (LIST* SYM-READ-STELLA-TOK_END_ SYM-READ-STELLA-TOK_SIZE_ NIL)
           NIL)
          (LIST*
           ...
           (LIST* SYM-READ-STELLA-TOK_STREAMSTATE_
            ...
            NIL)
           (LIST* SYM-READ-STELLA-TOK_BUFFER_
            (LIST* SYM-READ-STELLA-BUFFER SYM-READ-STELLA-TOK_STREAMSTATE_
             NIL)
            NIL)
           (LIST* SYM-READ-STELLA-TOK_SIZE_
           ...
           (LIST* SYM-READ-STELLA-TOK_STATE_
            (LIST* SYM-READ-STELLA-STATE SYM-READ-STELLA-TOK_STREAMSTATE_
             NIL)
            NIL)
           (LIST* SYM-READ-STELLA-TOK_NEXTSTATE_
            SYM-READ-STELLA-TOK_STATE_ NIL)
...
(CL:DEFUN END-OF-TOKENS?-EXPANDER ()
   ...
   (CL:LET* ((*PRINTREADABLY?* TRUE))
    ...
    (CL:WHEN (CL:NOT (SUPPRESS-WARNINGS?))
     ...
     (%%PRINT-STREAM (%NATIVE-STREAM STANDARD-ERROR) EOL
      ...
      EOL ".")))
   (CL:RETURN-FROM END-OF-TOKENS?-EXPANDER
    (CONS SYM-READ-STELLA-END-OF-TOKENS? NIL)))
  (CL:RETURN-FROM END-OF-TOKENS?-EXPANDER
   SYM-READ-STELLA-TOK_ENDOFTOKENS?_))

;;; (DEFMACRO GET-TOKEN-TEXT ...)

(CL:DEFUN GET-TOKEN-TEXT-EXPANDER (OPTIONS)
  (CL:WHEN (CL:NOT (INSIDE-WITH-TOKENIZER?))
   (CL:LET* ((*PRINTREADABLY?* TRUE))
    (CL:DECLARE (CL:SPECIAL *PRINTREADABLY?*)) (SIGNAL-TRANSLATION-ERROR)
    (CL:WHEN (CL:NOT (SUPPRESS-WARNINGS?))
     ...
     (%%PRINT-STREAM (%NATIVE-STREAM STANDARD-ERROR) EOL
      ...
      EOL ".")))
   (CL:RETURN-FROM GET-TOKEN-TEXT-EXPANDER
      ...
      (CL:IF (CL:EQ END NULL) SYM-READ-STELLA-TOK_CURSOR_
       (CL:IF (INTEGER? END)
        ...
        (LIST* SYM-READ-STELLA-CHOOSE
         ...
         NIL)))
      (LIST* SYM-READ-STELLA-TOK_SIZE_
       (CL:IF (CL:NOT (CL:EQ UPCASE? NULL)) UPCASE? SYM-READ-STELLA-FALSE)
       NIL))))))
...
(CL:DEFUN GET-TOKEN-TYPE-EXPANDER ()
  (CL:WHEN (CL:NOT (INSIDE-WITH-TOKENIZER?))
   (CL:LET* ((*PRINTREADABLY?* TRUE))
    (CL:DECLARE (CL:SPECIAL *PRINTREADABLY?*)) (SIGNAL-TRANSLATION-ERROR)
    (CL:WHEN (CL:NOT (SUPPRESS-WARNINGS?))
     ...
     (%%PRINT-STREAM (%NATIVE-STREAM STANDARD-ERROR) EOL
      ...
      EOL ".")))
   (CL:RETURN-FROM GET-TOKEN-TYPE-EXPANDER
...
(CL:DEFUN SAVE-TOKENIZER-STREAM-STATE-EXPANDER ()
  (CL:RETURN-FROM SAVE-TOKENIZER-STREAM-STATE-EXPANDER
   (LIST* SYM-READ-STELLA-WHEN
    (LIST* SYM-READ-STELLA-DEFINED? SYM-READ-STELLA-TOK_STREAMSTATE_ NIL)
    (LIST* SYM-READ-STELLA-SETF
     (LIST* SYM-READ-STELLA-CURSOR SYM-READ-STELLA-TOK_STREAMSTATE_ NIL)
...
(CL:DEFUN GET-NEXT-TOKEN-EXPANDER (OPTIONS)
  (CL:WHEN (CL:NOT (INSIDE-WITH-TOKENIZER?))
   (CL:LET* ((*PRINTREADABLY?* TRUE))
    (CL:DECLARE (CL:SPECIAL *PRINTREADABLY?*)) (SIGNAL-TRANSLATION-ERROR)
    (CL:WHEN (CL:NOT (SUPPRESS-WARNINGS?))
     ...
     (%%PRINT-STREAM (%NATIVE-STREAM STANDARD-ERROR) EOL
      ...
      EOL ".")))
   (CL:RETURN-FROM GET-NEXT-TOKEN-EXPANDER
    (CONS SYM-READ-STELLA-GET-NEXT-TOKEN NIL)))
  (CL:LET*
   ((SAVESTREAMSTATE? (%%VALUE OPTIONS))
    (SAVESTREAMSTATETREE
     (CONS (CONS SYM-READ-STELLA-SAVE-TOKENIZER-STREAM-STATE NIL) NIL)))
   (CL:COND
       ...
       (LIST* SYM-READ-STELLA-COND
        ...
        (LIST*
         ...
         (LIST* SYM-READ-STELLA-SETQ SYM-READ-STELLA-TOK_STATE_
          ...
          NIL)
         (LIST* SYM-READ-STELLA-++ SYM-READ-STELLA-TOK_CURSOR_ NIL) NIL)
        (LIST* SYM-READ-STELLA-OTHERWISE (CONS SYM-READ-STELLA-BREAK NIL)
         NIL)
        NIL)
       (CONCATENATE
        (CL:IF (CL:NOT (WITH-TOKENIZER-STRING-INPUT?))
         (CONS
          (LIST* SYM-READ-STELLA-WHEN
           (LIST* SYM-READ-STELLA-DEFINED? SYM-READ-STELLA-TOK_ECHOSTREAM_
            NIL)
...
(CL:DEFUN UNESCAPE-TOKEN-STRING (TOKEN ESCAPECHAR UPCASE?)
  ...
  (CL:LET*
   ((NOFESCAPES 0) (CURSOR 0) (CURSOR2 0)
    ...
    (RESULT STELLA::NULL-STRING) (ESCAPE? FALSE))
      ...
      (CL:LET
       ...
       (SETF
        (CL:AREF (CL:THE CL:SIMPLE-STRING SELF)
         (CL:THE CL:FIXNUM POSITION))
        (CL:THE CL:CHARACTER CH)))
      (CL:SETQ ESCAPE? FALSE) (CL:SETQ CURSOR2 (CL:1+ CURSOR2))))
    (CL:SETQ CURSOR (CL:1+ CURSOR)))
...
(CL:DEFMETHOD NEXT? ((SELF STREAM-TOKENIZER))
  (CL:LET*
   ((TOK_TABLE_ (%TABLE SELF))
    ...
    (TOK_TOKENSTART_ -1) (TOK_ENDOFTOKENS?_ FALSE)
    ...
    (TOK_STATE_ (%STATE TOK_STREAMSTATE_)) (TOK_NEXTSTATE_ TOK_STATE_)
   ...
   (CL:DECLARE (CL:TYPE CL:SIMPLE-STRING TOK_TRANSITIONS_)
    ...
    (CL:TYPE CL:FIXNUM TOK_TOKENSTART_ TOK_SIZE_ TOK_STATE_ TOK_NEXTSTATE_
     TOK_CURSOR_ TOK_END_ TOK_CHECKPOINT_))
    ...
    (CL:LOOP
     (CL:WHEN (CL:= TOK_CURSOR_ TOK_CHECKPOINT_)
      (CL:COND
       ((CL:= TOK_CURSOR_ TOK_END_)
        ...
        (CL:SETQ TOK_CURSOR_
         (CL:THE CL:FIXNUM
          (CL:MOD (CL:THE CL:FIXNUM (%CURSOR TOK_STREAMSTATE_))
           TOK_SIZE_)))
         ...
         (CL:COND ((CL:= TOK_NEXTSTATE_ -1))
          ((COERCE-WRAPPED-BOOLEAN-TO-BOOLEAN
           ...
           (CL:WHEN (CL:NOT (CL:= TOK_TOKENSTART_ -1))
            (CL:SETQ TOK_ENDOFTOKENS?_ FALSE)))
          (CL:T (CL:SETQ TOK_ENDOFTOKENS?_ FALSE) (CL:SETQ TOK_STATE_ 0)
           (CL:SETQ TOK_NEXTSTATE_ -1)))
         (CL:RETURN))
     ...
     (CL:COND
      ...
      ((CL:= TOK_TOKENSTART_ -1)
       (CL:WHEN (CL:= (CL:THE CL:FIXNUM (CL:LOGAND TOK_NEXTSTATE_ 64)) 0)
...
(CL:DEFUN WITH-STELLA-TOKENIZER-EXPANDER (INPUT BODY)
  (CL:RETURN-FROM WITH-STELLA-TOKENIZER-EXPANDER
   (LIST* SYM-READ-STELLA-WITH-TOKENIZER
    SYM-READ-STELLA-*STELLA-TOKENIZER-TABLE* INPUT
    (CONS
     (LIST* SYM-READ-STELLA-LET
      (LIST*
       (LIST* SYM-READ-STELLA-TOK_STELLASTATENAME_ SYM-READ-STELLA-KEYWORD
...
(CL:DEFUN GET-NEXT-STELLA-TOKEN-EXPANDER (OPTIONS)
  (CL:RETURN-FROM GET-NEXT-STELLA-TOKEN-EXPANDER
   (LIST* SYM-READ-STELLA-PROGN
    (CONS SYM-READ-STELLA-GET-NEXT-TOKEN (CONCATENATE OPTIONS NIL))
    (LIST* SYM-READ-STELLA-SETQ SYM-READ-STELLA-TOK_STELLASTATENAME_
     (LIST* SYM-READ-STELLA-NTH SYM-READ-STELLA-TOK_STATENAMES_
      SYM-READ-STELLA-TOK_STATE_ NIL)
     NIL)
    (LIST* SYM-READ-STELLA-SETQ
...
(CL:DEFUN GET-STELLA-TOKEN-TYPE-EXPANDER ()
  (CL:RETURN-FROM GET-STELLA-TOKEN-TYPE-EXPANDER
   SYM-READ-STELLA-TOK_STELLALOGICALSTATENAME_))

;;; (DEFMACRO GET-QUALIFIED-SYMBOL-SEPARATOR-POSITION ...)

(CL:DEFUN GET-QUALIFIED-SYMBOL-SEPARATOR-POSITION-EXPANDER ()
  (CL:RETURN-FROM GET-QUALIFIED-SYMBOL-SEPARATOR-POSITION-EXPANDER
   (LIST* SYM-READ-STELLA-GET-QUALIFIED-SYMBOL-SEPARATOR-POSITION-INTERNAL
...
(CL:DEFUN GET-QUALIFIED-SYMBOL-SEPARATOR-POSITION-INTERNAL (BUFFER TOKENSTART TOKENEND SIZE)
      ...
      ((CL:EQL
       ...
       (CL:WHEN
        ...
        (CL:IF (CL:< SEPARATORPOSITION 0)
         (CL:RETURN-FROM GET-QUALIFIED-SYMBOL-SEPARATOR-POSITION-INTERNAL
...
(CL:DEFUN TOKENIZE-S-EXPRESSION (STREAM TOKENLIST)
  (CL:LET*
   ((UPCASE? (CL:NOT (%CASE-SENSITIVE? *MODULE*))) (PARENBALANCE 0)
    (ENDOFFILE? TRUE) (SKIPCLOSINGQUOTE? FALSE) (TOKENCURSOR TOKENLIST))
   (CL:DECLARE (CL:TYPE CL:FIXNUM PARENBALANCE))
   (CL:WHEN (CL:EQ TOKENLIST NULL) (CL:SETQ TOKENLIST (NEW-STELLA-TOKEN))
    ...
    (CL:LET*
     ...
     (CL:LOOP
      (CL:TAGBODY
             ...
             (CL:WHEN TOK_ENDOFTOKENS?_
              (CL:COND ((CL:= TOK_NEXTSTATE_ -1))
               ((COERCE-WRAPPED-BOOLEAN-TO-BOOLEAN
                ...
                (CL:WHEN (CL:NOT (CL:= TOK_TOKENSTART_ -1))
                 (CL:SETQ TOK_ENDOFTOKENS?_ FALSE)))
               (CL:T (CL:SETQ TOK_ENDOFTOKENS?_ FALSE)
       ...
       (CL:SETQ ENDOFFILE? FALSE)
       (CL:WHEN (CL:NOT SKIPCLOSINGQUOTE?)
        (CL:SETF (%TYPE TOKENCURSOR) (CL:AREF TOK_STATENAMES_ TOK_STATE_))
       ...
       (CL:SETQ SKIPCLOSINGQUOTE? FALSE)
       (CL:COND
        ...
        ((CL:EQ TOK_STELLALOGICALSTATENAME_ KWD-READ-CLOSE-PAREN)
         ...
         (CL:WHEN (CL:< PARENBALANCE 0)
          (CL:WHEN (CL:NOT (CL:EQ TOK_STREAMSTATE_ NULL))
           ...
           (CL:SETF (%STATE TOK_STREAMSTATE_) TOK_STATE_))
          (CL:ERROR
           (NEW-READ-EXCEPTION "Extra right parenthesis encountered"))))
         ...
         (CL:LET* ((TEST-VALUE-000 (CL:AREF TOK_STATENAMES_ TOK_STATE_)))
          (CL:COND
            ...
            (CL:SETF (%CONTENT TOKENCURSOR)
             (UNESCAPE-TOKEN-STRING
              (GET-TOKEN-TEXT-INTERNAL TOK_BUFFER_ (CL:1+ TOK_TOKENSTART_)
               TOK_CURSOR_ TOK_SIZE_ FALSE)
              #\\ FALSE))
            (CL:SETF (%ESCAPE-MODE TOKENCURSOR) KWD-READ-FULL)
            (CL:SETQ SKIPCLOSINGQUOTE? TRUE))
           ...
           ((CL:EQ TEST-VALUE-000 KWD-READ-CL-SYMBOL)
            (CL:SETF (%CONTENT TOKENCURSOR)
             (GET-TOKEN-TEXT-INTERNAL TOK_BUFFER_ (CL:+ TOK_TOKENSTART_ 3)
              TOK_CURSOR_ TOK_SIZE_ TRUE))
          ...
          (CL:COND
           ...
           ((CL:EQ TEST-VALUE-001 KWD-READ-FULLY-ESCAPED-SURROGATE)
            (CL:SETF (%CONTENT TOKENCURSOR)
             (UNESCAPE-TOKEN-STRING
              (GET-TOKEN-TEXT-INTERNAL TOK_BUFFER_
               (CL:+ TOK_TOKENSTART_ 2) TOK_CURSOR_ TOK_SIZE_ FALSE)
              #\\ FALSE))
            (CL:SETF (%ESCAPE-MODE TOKENCURSOR) KWD-READ-FULL)
            (CL:SETQ SKIPCLOSINGQUOTE? TRUE))
    ...
    (CL:TAGBODY (CL:SETQ TOKENTYPE (%LOGICAL-TOKEN-TYPE TOKENLIST))
     (CL:COND
       ...
       (CL:COND
        ...
        (CL:T
         (CL:LET* ((PARENTTREE PARSEDTREESTACK))
          (CL:LET* ((HEAD-000 (%%VALUE PARSEDTREESTACK)))
        ...
        ((MODULENAME (%MODULE TOKENLIST)) (NAME (%CONTENT TOKENLIST))
         (MODULE
          (CL:IF (CL:NOT (CL:EQ MODULENAME STELLA::NULL-STRING))
           (GET-STELLA-MODULE MODULENAME FALSE) *MODULE*)))
      ...
      ((CL:EQ TOKENTYPE KWD-READ-INTEGER)
       (CL:SETQ PARSEDTOKEN (CL:MAKE-INSTANCE (CL:QUOTE INTEGER-WRAPPER)))
       (CL:SETF (%WRAPPER-VALUE PARSEDTOKEN)
        (STRING-TO-INTEGER (%CONTENT TOKENLIST))))
      ((CL:EQ TOKENTYPE KWD-READ-FLOAT)
       (CL:SETQ PARSEDTOKEN (CL:MAKE-INSTANCE (CL:QUOTE FLOAT-WRAPPER)))
       (CL:SETF (%WRAPPER-VALUE PARSEDTOKEN)
  ...
  (CL:LET* ((QUOTESTRING (%CONTENT QUOTEDLIST)))
   ...
   (CL:LET* ((SELF-000 (NEW-STELLA-TOKEN)))
    ...
    (CL:LET* ((TOKEN SELF-000) (TOKENTYPE NULL) (BALANCE 0))
     ...
     (CL:SETF (%NEXT QUOTEDLIST) TOKEN) (CL:SETQ QUOTEDLIST (%NEXT TOKEN))
...
the result.  Return TRUE as the second value on EOF."
  (CL:LET*
   ...
   (CL:RETURN-FROM READ-S-EXPRESSION
    (CL:VALUES (STELLA-TOKEN-LIST-TO-S-EXPRESSION TOKENLIST) FALSE))))

;;; (DEFGLOBAL *STELLA-TOKENIZER-WHITE-SPACE-STATE* ...)

(CL:PROGN (CL:DEFVAR *STELLA-TOKENIZER-WHITE-SPACE-STATE* NULL-INTEGER) (CL:DECLAIM (CL:TYPE CL:FIXNUM *STELLA-TOKENIZER-WHITE-SPACE-STATE*)))
...
(CL:DEFUN EAT-NEXT-CHARACTER-IF-WHITESPACE (STREAM)
  (CL:LET* ((CHAR NULL-CHARACTER) (EOF? FALSE))
   ...
   (CL:SETQ CHAR CHAR)
   (CL:WHEN EOF? (CL:RETURN-FROM EAT-NEXT-CHARACTER-IF-WHITESPACE TRUE))
   (CL:COND
    ((CL:EQ
      (CL:AREF
       (CL:THE CL:SIMPLE-VECTOR (%THE-ARRAY *CHARACTER-TYPE-TABLE*))
...
(CL:DEFUN CONSUME-WHITESPACE (STREAM)
  (CL:LOOP
   (CL:LET* ((CHAR NULL-CHARACTER) (EOF? FALSE))
    (CL:MULTIPLE-VALUE-SETQ (CHAR EOF?) (READ-CHARACTER STREAM))
    (CL:WHEN EOF? (CL:RETURN-FROM CONSUME-WHITESPACE TRUE))
    (CL:WHEN
     (CL:NOT
      (CL:EQ
       (CL:AREF
  ...
  (CL:RETURN-FROM CONSUME-WHITESPACE FALSE))
...
(CL:DEFUN MAKE-TOKENIZER-STRING-STREAM (STRING)
  ...
  (CL:LET*
   ...
   (CL:SETF (%BUFFER-SIZE STATE) LENGTH) (CL:SETF (%CURSOR STATE) LENGTH)
   (CL:SETF (%END STATE) LENGTH) (CL:SETF (%STATE STATE) 1)
...
(CL:DEFUN READ-LINE (INPUTSTREAM)
...
the input is read.  See also special variable *USER-QUERY-ACTION*."
  ...
  (CL:COND
   ...
   ((CL:EQ *USER-QUERY-ACTION* KWD-READ-ASK)
    (CL:LET* ((INPUT STELLA::NULL-STRING))
     (CL:DECLARE (CL:TYPE CL:SIMPLE-STRING INPUT))
     (CL:LOOP
      (CL:WHEN (CL:NOT (CL:EQ MESSAGE STELLA::NULL-STRING))
       (%%PRINT-STREAM (%NATIVE-STREAM STANDARD-OUTPUT) MESSAGE))
      (CONSUME-WHITESPACE STANDARD-INPUT)
      (CL:SETQ INPUT (READ-LINE STANDARD-INPUT))
      (CL:WHEN (CL:> (CL:THE CL:FIXNUM (CL:LENGTH INPUT)) 0)
       (CL:SETQ INPUT (STRING-UPCASE INPUT))
       (CL:WHEN (STRING-EQL? INPUT "YES")
        (CL:RETURN-FROM YES-OR-NO? TRUE))
       (CL:WHEN (STRING-EQL? INPUT "NO")
        (CL:RETURN-FROM YES-OR-NO? FALSE))
       (%%PRINT-STREAM (%NATIVE-STREAM STANDARD-OUTPUT)
        "Type `yes' for yes or `no' for no." EOL)))))
   (CL:T
    (CL:LET* ((STREAM-000 (NEW-OUTPUT-STRING-STREAM)))
     (%%PRINT-STREAM (%NATIVE-STREAM STREAM-000) "`" *USER-QUERY-ACTION*
      "' is not a valid case option")
     (CL:ERROR (NEW-STELLA-EXCEPTION (THE-STRING-READER STREAM-000)))))))
...
the input is read.  See also special variable *USER-QUERY-ACTION*."
  ...
  (CL:COND
   ((CL:EQ *USER-QUERY-ACTION* KWD-READ-YES)
    (CL:RETURN-FROM Y-OR-N? TRUE))
   ((CL:EQ *USER-QUERY-ACTION* KWD-READ-NO)
    (CL:RETURN-FROM Y-OR-N? FALSE))
   ((CL:EQ *USER-QUERY-ACTION* KWD-READ-YES-VERBOSE)
    (%%PRINT-STREAM (%NATIVE-STREAM STANDARD-OUTPUT) MESSAGE
     " [Auto => Y]" EOL)
    (CL:RETURN-FROM Y-OR-N? TRUE))
     ...
     (CL:LOOP
      ...
      (CL:WHEN (CL:> (CL:THE CL:FIXNUM (CL:LENGTH INPUT)) 0)
       (CL:CASE
        ...
        ((#\n #\N) (CL:RETURN-FROM Y-OR-N? FALSE)) (CL:OTHERWISE)))
      (%%PRINT-STREAM (%NATIVE-STREAM STANDARD-OUTPUT)
  ...
  (CL:LET*
   ((PARENBALANCE 0) (STARTTAG STELLA::NULL-STRING)
    ...
    (REGIONTAGFOUND?
     (CL:OR (CL:EQ REGIONTAGNAME STELLA::NULL-STRING)
      (CL:NOT SKIPTOREGION?)))
    (ENDOFFILE? TRUE) (TOKENTYPE NULL) (TOKENCONTENT STELLA::NULL-STRING)
   ...
   (CL:LET*
    ...
    (CL:LOOP
     (CL:TAGBODY
      ...
      (CL:COND (REGIONTAGFOUND?)
       ((CL:AND (CL:EQ TOKENTYPE KWD-READ-START-TAG)
         (STRING-EQL?
          (GET-TOKEN-TEXT-INTERNAL TOK_BUFFER_ TOK_TOKENSTART_ TOK_CURSOR_
           TOK_SIZE_ FALSE)
          REGIONTAGNAME))
        (CL:SETQ REGIONTAGFOUND? TRUE))
       (CL:T (CL:GO :CONTINUE)))
      (CL:COND
       ((CL:OR (CL:EQ TOKENTYPE KWD-READ-START-TAG)
         (CL:EQ TOKENTYPE KWD-READ-START-PI-TAG)
         (CL:EQ TOKENTYPE KWD-READ-START-DECLARATION-TAG)
         (CL:EQ TOKENTYPE KWD-READ-START-SPECIAL-TAG))
        ...
        (CL:WHEN (STRING-EQL? TOKENCONTENT STARTTAG)
         (CL:SETQ PARENBALANCE (CL:1+ PARENBALANCE))))
       ((CL:EQ TOKENTYPE KWD-READ-START-TAG-END)
        (CL:SETQ TOKENCONTENT ">")
        (CL:WHEN
       ...
       ((CL:OR (CL:EQ TOKENTYPE KWD-READ-END-TAG)
         (CL:EQ TOKENTYPE KWD-READ-EMPTY-TAG-END))
        (CL:COND
         ((CL:EQ TOKENTYPE KWD-READ-END-TAG)
          (CL:SETQ TOKENCONTENT
           (GET-TOKEN-TEXT-INTERNAL TOK_BUFFER_ TOK_TOKENSTART_
            TOK_CURSOR_ TOK_SIZE_ FALSE))
          (CL:SETQ CURRENTTAG TOKENCONTENT))
        ...
        (CL:WHEN
         (CL:OR (STRING-EQL? CURRENTTAG STARTTAG)
          (CL:AND (CL:NOT (CL:EQ REGIONTAGNAME STELLA::NULL-STRING))
           (CL:NOT SKIPTOREGION?) (STRING-EQL? CURRENTTAG REGIONTAGNAME)))
         (CL:SETQ PARENBALANCE (CL:1- PARENBALANCE)))
        (CL:SETQ CURRENTTAG STELLA::NULL-STRING))
       ((CL:EQ TOKENTYPE KWD-READ-ATTRIBUTE-NAME)
        (CL:SETQ TOKENCONTENT
         (GET-TOKEN-TEXT-INTERNAL TOK_BUFFER_ TOK_TOKENSTART_ TOK_CURSOR_
          TOK_SIZE_ TRUE)))
       ((CL:EQ TOKENTYPE KWD-READ-QUOTED-ATTRIBUTE-VALUE)
        (CL:SETQ TOKENCONTENT
         (GET-TOKEN-TEXT-INTERNAL TOK_BUFFER_ (CL:1+ TOK_TOKENSTART_)
          (CL:+ TOK_CURSOR_ -1) TOK_SIZE_ FALSE))
        (CL:SETQ TOKENTYPE KWD-READ-ATTRIBUTE-VALUE))
       ((CL:EQ TOKENTYPE KWD-READ-UNQUOTED-ATTRIBUTE-VALUE)
        (CL:SETQ TOKENCONTENT
         (GET-TOKEN-TEXT-INTERNAL TOK_BUFFER_ TOK_TOKENSTART_ TOK_CURSOR_
          TOK_SIZE_ FALSE))
        (CL:SETQ TOKENTYPE KWD-READ-ATTRIBUTE-VALUE))
       ((CL:EQ TOKENTYPE KWD-READ-PI-TAG-DATA)
        (CL:SETQ TOKENCONTENT
         (GET-TOKEN-TEXT-INTERNAL TOK_BUFFER_ TOK_TOKENSTART_
          (CL:+ TOK_CURSOR_ -1) TOK_SIZE_ FALSE)))
       ((CL:EQ TOKENTYPE KWD-READ-DECLARATION-TAG-DATA)
        (CL:SETQ TOKENCONTENT
         (GET-TOKEN-TEXT-INTERNAL TOK_BUFFER_ TOK_TOKENSTART_ TOK_CURSOR_
          TOK_SIZE_ FALSE)))
       ((CL:EQ TOKENTYPE KWD-READ-SPECIAL-TAG-DATA)
        (CL:SETQ TOKENCONTENT
         (GET-TOKEN-TEXT-INTERNAL TOK_BUFFER_ (CL:1+ TOK_TOKENSTART_)
          (CL:+ TOK_CURSOR_ -2) TOK_SIZE_ FALSE)))
       ((CL:EQ TOKENTYPE KWD-READ-CONTENT)
        (CL:SETQ TOKENCONTENT
         (GET-TOKEN-TEXT-INTERNAL TOK_BUFFER_ TOK_TOKENSTART_ TOK_CURSOR_
          TOK_SIZE_ FALSE))
        (CL:LET* ((CURSOR (CL:THE CL:FIXNUM (CL:LENGTH TOKENCONTENT))))
         ...
         (CL:LET* ((I NULL-INTEGER) (ITER-000 0))
          (CL:DECLARE (CL:TYPE CL:FIXNUM ITER-000 I))
          (CL:LOOP WHILE TRUE DO
           (CL:PROGN (CL:SETQ I ITER-000)
            (CL:SETQ ITER-000 (CL:1+ ITER-000)))
           (CL:WHEN
            (CL:NOT
             (CL:EQ
              (CL:AREF
               (CL:THE CL:SIMPLE-VECTOR
                (%THE-ARRAY *CHARACTER-TYPE-TABLE*))
               (CL:THE CL:FIXNUM
                (CL:CHAR-CODE
                 (CL:LET
                  ((SELF TOKENCONTENT)
            ...
            (CL:WHEN (CL:> I 0) (CL:SETQ I (CL:- 0 I))
             (CL:SETQ TOKENCONTENT
              (GET-TOKEN-TEXT-INTERNAL TOK_BUFFER_ TOK_TOKENSTART_
               ...
               TOK_SIZE_ FALSE)))
            (CL:RETURN))))))
       ((CL:EQ TOKENTYPE KWD-READ-ERROR)
        (CL:WHEN (CL:NOT (CL:EQ TOK_STREAMSTATE_ NULL))
         (CL:SETF (%CURSOR TOK_STREAMSTATE_) TOK_CURSOR_)
         (CL:SETF (%STATE TOK_STREAMSTATE_) TOK_STATE_))
        (CL:LET* ((STREAM-000 (NEW-OUTPUT-STRING-STREAM)))
       ...
       (CL:T
        ...
        (CL:LET* ((STREAM-001 (NEW-OUTPUT-STRING-STREAM)))
         (%%PRINT-STREAM (%NATIVE-STREAM STREAM-001)
          ...
          "'")
         (CL:ERROR (NEW-READ-EXCEPTION (THE-STRING-READER STREAM-001))))))
      (CL:SETF (%TYPE TOKENCURSOR) TOKENTYPE)
      (CL:SETF (%CONTENT TOKENCURSOR) TOKENCONTENT)
      (CL:WHEN (CL:EQ (%NEXT TOKENCURSOR) NULL)
       (CL:SETF (%NEXT TOKENCURSOR) (NEW-TOKENIZER-TOKEN)))
      (CL:SETQ TOKENCURSOR (%NEXT TOKENCURSOR))
      (CL:WHEN (CL:= PARENBALANCE 0) (CL:RETURN))
      (CL:WHEN (CL:< PARENBALANCE 0)
       (CL:COND
        ((CL:AND (CL:NOT (CL:EQ REGIONTAGNAME STELLA::NULL-STRING))
          (CL:NOT SKIPTOREGION?)
          (STRING-EQL? (%CONTENT TOKENLIST) REGIONTAGNAME)
    ...
    (CL:WHEN (CL:NOT (CL:EQ TOK_STREAMSTATE_ NULL))
     ...
     (CL:SETF (%STATE TOK_STREAMSTATE_) TOK_STATE_))
    (CL:IF ENDOFFILE?
     (CL:RETURN-FROM TOKENIZE-XML-EXPRESSION (CL:VALUES NULL TRUE))
     (CL:RETURN-FROM TOKENIZE-XML-EXPRESSION
      (CL:VALUES TOKENLIST FALSE))))))

;;; (DEFUN (XML-TOKEN-LIST-TO-S-EXPRESSION OBJECT) ...)

(CL:DEFUN XML-TOKEN-LIST-TO-S-EXPRESSION (TOKENLIST)
...
with the tag name as its header, followed by a possibly empty list of keyword
...
when represented as an s-expression.  The tag names `?', `!' and `[' are special
and mark processing instruction tags (`?'), delcaration tags (`!') and
CDATA and conditional tags (`[').  For these tags the second element in the
list is the actual tag name, and the third element is the unparsed data string
following the name (including whitespace)."
  (CL:LET*
   ((PARSEDTREE NULL) (PARSEDTREESTACK NIL) (PARSEDTOKEN NULL)
    (CONSCELL NULL) (TOKENTYPE NULL) (TAGMODULE *MODULE*))
   (CL:LOOP
    (CL:TAGBODY (CL:SETQ TOKENTYPE (%TYPE TOKENLIST))
     (CL:COND
      ((CL:OR (CL:EQ TOKENTYPE KWD-READ-START-TAG)
       ...
       (CL:COND
        ((CL:EQ TOKENTYPE KWD-READ-START-PI-TAG)
         (CL:SETQ PARSEDTREE (CONS SYM-READ-STELLA-? NIL)))
        ((CL:EQ TOKENTYPE KWD-READ-START-DECLARATION-TAG)
         (CL:SETQ PARSEDTREE (CONS SYM-READ-STELLA-! NIL)))
        ((CL:EQ TOKENTYPE KWD-READ-START-SPECIAL-TAG)
         (CL:SETQ PARSEDTREE (CONS SYM-READ-STELLA-[ NIL)))
        (CL:T (CL:SETQ PARSEDTREE NIL)))
       (CL:SETQ PARSEDTOKEN
        (INTERN-SYMBOL-IN-MODULE (%CONTENT TOKENLIST) TAGMODULE FALSE)))
      ((CL:EQ TOKENTYPE KWD-READ-START-TAG-END)
       (CL:SETQ TOKENLIST (%NEXT TOKENLIST)) (CL:GO :CONTINUE))
      ((CL:OR (CL:EQ TOKENTYPE KWD-READ-END-TAG)
        (CL:EQ TOKENTYPE KWD-READ-EMPTY-TAG-END))
      ...
      ((CL:EQ TOKENTYPE KWD-READ-ATTRIBUTE-NAME)
       (CL:SETQ PARSEDTOKEN
        (INTERN-RIGID-SYMBOL-WRT-MODULE (%CONTENT TOKENLIST) NULL
         KEYWORD-SYM)))
      ((CL:OR (CL:EQ TOKENTYPE KWD-READ-ATTRIBUTE-VALUE)
        (CL:EQ TOKENTYPE KWD-READ-PI-TAG-DATA)
        (CL:EQ TOKENTYPE KWD-READ-DECLARATION-TAG-DATA)
        (CL:EQ TOKENTYPE KWD-READ-SPECIAL-TAG-DATA))
       (CL:SETQ PARSEDTOKEN (CL:MAKE-INSTANCE (CL:QUOTE STRING-WRAPPER)))
      ...
      (CL:T
       (CL:LET* ((STREAM-000 (NEW-OUTPUT-STRING-STREAM)))
        (%%PRINT-STREAM (%NATIVE-STREAM STREAM-000)
         "Illegal XML syntax: `" (%CONTENT TOKENLIST) "' of type `"
         TOKENTYPE "'")
        (CL:ERROR (NEW-READ-EXCEPTION (THE-STRING-READER STREAM-000))))))
     (CL:COND
      ((CL:NOT (CL:EQ PARSEDTREE NULL))
...
(CL:DEFUN READ-XML-EXPRESSION (STREAM STARTTAGNAME)
...
`startTagName' is non-NULL, skip all tags until a start tag `startTagName'
is encountered.  Return TRUE as the second value on EOF."
  (CL:DECLARE (CL:TYPE CL:SIMPLE-STRING STARTTAGNAME))
  (CL:LET*
   ((TOKENIZERSTATE (%TOKENIZER-STATE STREAM))
    (TOKENLIST
     (CL:IF (CL:NOT (CL:EQ TOKENIZERSTATE NULL))
      (%TOKEN-LIST TOKENIZERSTATE) NULL))
    (EOF? FALSE) (RESULT NULL))
   (CL:SETQ TOKENLIST
    (TOKENIZE-XML-EXPRESSION STREAM TOKENLIST STARTTAGNAME
     (CL:NOT (CL:EQ STARTTAGNAME STELLA::NULL-STRING))))
   (CL:WHEN (CL:EQ TOKENLIST NULL)
    (CL:RETURN-FROM READ-XML-EXPRESSION (CL:VALUES NULL TRUE)))
   (CL:SETF (%TOKEN-LIST (%TOKENIZER-STATE STREAM)) TOKENLIST)
   (CL:WHEN (CL:NOT (CL:EQ STARTTAGNAME STELLA::NULL-STRING))
    (CL:LET* ((LASTTOKEN TOKENLIST))
     (CL:LOOP WHILE (CL:NOT (CL:EQ (%TYPE (%NEXT LASTTOKEN)) NULL)) DO
      (CL:SETQ LASTTOKEN (%NEXT LASTTOKEN)))
     (CL:WHEN (CL:NOT (CL:EQ (%TYPE LASTTOKEN) KWD-READ-EMPTY-TAG-END))
      (CL:SETF (%TYPE LASTTOKEN) KWD-READ-EMPTY-TAG-END)
      (CL:SETQ RESULT (XML-TOKEN-LIST-TO-S-EXPRESSION TOKENLIST))
      (CL:LET*
       ((I NULL-INTEGER) (ITER-000 0) (INTO-000 RESULT)
        (COLLECT-000 NULL))
       (CL:DECLARE (CL:TYPE CL:FIXNUM ITER-000 I))
       (CL:LOOP WHILE TRUE DO
        (CL:PROGN (CL:SETQ I ITER-000)
        ...
        (CL:MULTIPLE-VALUE-SETQ (TOKENLIST EOF?)
         (TOKENIZE-XML-EXPRESSION STREAM TOKENLIST STARTTAGNAME FALSE))
        (CL:WHEN (CL:EQ TOKENLIST NULL)
         (CL:IF EOF?
          (CL:ERROR
        ...
        (CL:IF (CL:EQ COLLECT-000 NULL)
         (CL:PROGN
          (CL:SETQ COLLECT-000
           (CONS (XML-TOKEN-LIST-TO-S-EXPRESSION TOKENLIST) NIL))
          (CL:IF (CL:EQ INTO-000 NIL) (CL:SETQ INTO-000 COLLECT-000)
           (ADD-CONS-TO-END-OF-CONS-LIST INTO-000 COLLECT-000)))
         (CL:PROGN
   ...
   (CL:WHEN
    (CL:OR (CL:EQ STREAM STANDARD-INPUT)
     (CL:NOT (CL:EQ (%ECHO-STREAM STREAM) NULL)))
    (EAT-NEXT-CHARACTER-IF-WHITESPACE STREAM))
   (CL:RETURN-FROM READ-XML-EXPRESSION (CL:VALUES RESULT FALSE))))
...
(CL:DEFCLASS XML-EXPRESSION-ITERATOR (STREAM-ITERATOR)
  ((REGION-TAG :ALLOCATION :INSTANCE :ACCESSOR %REGION-TAG)
   (REGION-MATCH-FUNCTION :ALLOCATION :INSTANCE :ACCESSOR
...
(CL:DEFUN NEW-XML-EXPRESSION-ITERATOR ()
  (CL:LET* ((SELF NULL))
   (CL:SETQ SELF (CL:MAKE-INSTANCE (CL:QUOTE XML-EXPRESSION-ITERATOR)))
   (CL:SETF (%FIRST-ITERATION? SELF) TRUE) (CL:SETF (%VALUE SELF) NULL)
   (CL:SETF (%THE-STREAM SELF) NULL)
   (CL:SETF (%REGION-MATCH-FUNCTION SELF)
...
(CL:DEFMETHOD PRIMARY-TYPE ((SELF XML-EXPRESSION-ITERATOR))
  (CL:RETURN-FROM PRIMARY-TYPE SGT-READ-STELLA-XML-EXPRESSION-ITERATOR))

(CL:DEFUN ACCESS-XML-EXPRESSION-ITERATOR-SLOT-VALUE (SELF SLOTNAME VALUE SETVALUE?)
  (CL:COND
   ((CL:EQ SLOTNAME SYM-READ-STELLA-REGION-TAG)
    (CL:IF SETVALUE? (CL:SETF (%REGION-TAG SELF) VALUE)
     (CL:SETQ VALUE (%REGION-TAG SELF))))
   ((CL:EQ SLOTNAME SYM-READ-STELLA-REGION-MATCH-FUNCTION)
    (CL:IF SETVALUE?
     (CL:SETF (%REGION-MATCH-FUNCTION SELF) (%WRAPPER-VALUE VALUE))
...
(CL:DEFMETHOD NEXT? ((SELF XML-EXPRESSION-ITERATOR))
  (CL:LET*
   ((STREAM (%THE-STREAM SELF)) (FIRSTITERATION? (%FIRST-ITERATION? SELF))
    (TOKENLIST
     (CL:IF FIRSTITERATION? NULL (%TOKEN-LIST (%TOKENIZER-STATE STREAM))))
    (REGIONTAG (%REGION-TAG SELF))
    (REGIONTAGNAME
     (CL:IF (CL:NOT (CL:EQ REGIONTAG NULL))
      (%SYMBOL-NAME (%%VALUE REGIONTAG)) STELLA::NULL-STRING))
    (SKIPTOREGION? FALSE) (EOF? FALSE))
   (CL:DECLARE (CL:TYPE CL:SIMPLE-STRING REGIONTAGNAME))
   (CL:WHEN FIRSTITERATION? (CL:SETF (%FIRST-ITERATION? SELF) FALSE)
    (CL:WHEN (CL:NOT (CL:EQ REGIONTAG NULL))
     (CL:SETQ SKIPTOREGION? TRUE)))
   (CL:LOOP
    (CL:TAGBODY
     (CL:MULTIPLE-VALUE-SETQ (TOKENLIST EOF?)
     ...
     (CL:WHEN EOF?
      (CL:WHEN
       ...
       (CL:LET* ((STREAM-000 (NEW-OUTPUT-STRING-STREAM)))
        (%%PRINT-STREAM (%NATIVE-STREAM STREAM-000)
         "EOF encountered before the end of the current `" REGIONTAGNAME
         "' region")
        (CL:ERROR (NEW-READ-EXCEPTION (THE-STRING-READER STREAM-000)))))
      (CL:SETF (%VALUE SELF) NULL) (CLOSE-STREAM STREAM)
      (CL:SETF (%THE-STREAM SELF) NULL) (CL:RETURN-FROM NEXT? FALSE))
     (CL:WHEN (CL:EQ TOKENLIST NULL) (CL:SETQ SKIPTOREGION? TRUE)
      (CL:SETQ TOKENLIST (%TOKEN-LIST (%TOKENIZER-STATE STREAM)))
      (CL:GO :CONTINUE))
     (CL:WHEN FIRSTITERATION?
      (CL:SETF (%TOKEN-LIST (%TOKENIZER-STATE STREAM)) TOKENLIST)
      (CL:SETQ FIRSTITERATION? FALSE))
     (CL:COND
      ((CL:AND SKIPTOREGION? (CL:NOT (CL:EQ REGIONTAG NULL)))
       (CL:LET* ((LASTTOKEN TOKENLIST) (EMPTYTAG? FALSE))
        (CL:LOOP WHILE (CL:NOT (CL:EQ (%TYPE (%NEXT LASTTOKEN)) NULL)) DO
         (CL:SETQ LASTTOKEN (%NEXT LASTTOKEN)))
        (CL:IF (CL:EQ (%TYPE LASTTOKEN) KWD-READ-EMPTY-TAG-END)
         (CL:SETQ EMPTYTAG? TRUE)
         (CL:SETF (%TYPE LASTTOKEN) KWD-READ-EMPTY-TAG-END))
        (CL:WHEN
         (CL:NOT
          (CL:FUNCALL (%REGION-MATCH-FUNCTION SELF) (%REGION-TAG SELF)
           (XML-TOKEN-LIST-TO-S-EXPRESSION TOKENLIST)))
         (CL:SETQ SKIPTOREGION? TRUE) (CL:GO :CONTINUE))
        (CL:SETQ SKIPTOREGION? FALSE)
        (CL:WHEN EMPTYTAG? (CL:SETQ REGIONTAG NULL)
         (CL:SETQ REGIONTAGNAME STELLA::NULL-STRING)
         (CL:SETF (%REGION-TAG SELF) NULL))
        (CL:GO :CONTINUE)))
      (CL:T
       (CL:SETF (%VALUE SELF) (XML-TOKEN-LIST-TO-S-EXPRESSION TOKENLIST))
...
(CL:DEFUN XML-REGION-MATCHES? (REGIONSPEC REGIONTAG)
  (CL:IF (EQL? (%%VALUE REGIONSPEC) (%%VALUE REGIONTAG))
   (CL:LET* ((SELF-000 (NEW-PROPERTY-LIST)))
    (CL:SETF (%THE-PLIST SELF-000) (%%REST REGIONSPEC))
    (CL:LET* ((SPECATTRIBUTES SELF-000))
     (CL:LET* ((SELF-001 (NEW-PROPERTY-LIST)))
      (CL:SETF (%THE-PLIST SELF-001) (%%REST REGIONTAG))
      (CL:LET* ((TAGATTRIBUTES SELF-001))
       (CL:LET*
        ((VALUE NULL) (KEY NULL) (ITER-000 (%THE-PLIST SPECATTRIBUTES)))
        (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-000 NIL)) DO
         ...
         (CL:WHEN (CL:NOT (EQL? (LOOKUP TAGATTRIBUTES KEY) VALUE))
          (CL:RETURN-FROM XML-REGION-MATCHES? FALSE))))
       (CL:RETURN-FROM XML-REGION-MATCHES? TRUE)))))
   (CL:RETURN-FROM XML-REGION-MATCHES? FALSE)))
...
`regionTag', e.g., `(KIF :version \"1.0\")'."
  (CL:LET* ((SELF-000 (NEW-XML-EXPRESSION-ITERATOR)))
   ...
   (CL:LET* ((ITERATOR SELF-000))
    (CL:WHEN
     (CL:AND (CL:NOT (CL:EQ REGIONTAG NULL))
      (CL:NOT (CL:EQ REGIONTAG NIL)))
     (CL:SETF (%REGION-TAG ITERATOR) REGIONTAG))
...
(CL:DEFUN HELP-STARTUP-READ1 ()
  (CL:PROGN
   ...
   (CL:SETQ SYM-READ-STELLA-STRING-TO-TOKENIZER-BYTE-ARRAY
    (INTERN-RIGID-SYMBOL-WRT-MODULE "STRING-TO-TOKENIZER-BYTE-ARRAY" NULL
     0))
   ...
   (CL:SETQ SYM-READ-STELLA-WITH-TOKENIZER-EXPANDER
    (INTERN-RIGID-SYMBOL-WRT-MODULE "WITH-TOKENIZER-EXPANDER" NULL 0))
   (CL:SETQ SYM-READ-STELLA-END-OF-TOKENS?
    (INTERN-RIGID-SYMBOL-WRT-MODULE "END-OF-TOKENS?" NULL 0))
   (CL:SETQ SYM-READ-STELLA-END-OF-TOKENS?-EXPANDER
    (INTERN-RIGID-SYMBOL-WRT-MODULE "END-OF-TOKENS?-EXPANDER" NULL 0))
...
(CL:DEFUN HELP-STARTUP-READ2 ()
  (CL:PROGN
   ...
   (CL:SETQ SYM-READ-STELLA-< (INTERN-RIGID-SYMBOL-WRT-MODULE "<" NULL 0))
   (CL:SETQ SYM-READ-STELLA-GET-TOKEN-TEXT-EXPANDER
    (INTERN-RIGID-SYMBOL-WRT-MODULE "GET-TOKEN-TEXT-EXPANDER" NULL 0))
   ...
   (CL:SETQ SYM-READ-STELLA-GET-TOKEN-TYPE-EXPANDER
    (INTERN-RIGID-SYMBOL-WRT-MODULE "GET-TOKEN-TYPE-EXPANDER" NULL 0))
   ...
   (CL:SETQ SYM-READ-STELLA-SAVE-TOKENIZER-STREAM-STATE-EXPANDER
    (INTERN-RIGID-SYMBOL-WRT-MODULE "SAVE-TOKENIZER-STREAM-STATE-EXPANDER"
     NULL 0))
   ...
   (CL:SETQ SYM-READ-STELLA-GET-NEXT-TOKEN-EXPANDER
    (INTERN-RIGID-SYMBOL-WRT-MODULE "GET-NEXT-TOKEN-EXPANDER" NULL 0))
...
(CL:DEFUN HELP-STARTUP-READ3 ()
  (CL:PROGN
   ...
   (CL:SETQ KWD-READ-OPEN-FULLY-ESCAPED-SYMBOL
    (INTERN-RIGID-SYMBOL-WRT-MODULE "OPEN-FULLY-ESCAPED-SYMBOL" NULL 2))
   ...
   (CL:SETQ KWD-READ-FULLY-ESCAPED-SYMBOL-ESCAPE
    (INTERN-RIGID-SYMBOL-WRT-MODULE "FULLY-ESCAPED-SYMBOL-ESCAPE" NULL 2))
   ...
   (CL:SETQ KWD-READ-FULLY-ESCAPED-SURROGATE-ESCAPE
    (INTERN-RIGID-SYMBOL-WRT-MODULE "FULLY-ESCAPED-SURROGATE-ESCAPE" NULL
     2))
   ...
   (CL:SETQ KWD-READ-QUALIFIED-ESCAPED-SYMBOL-ESCAPE
    (INTERN-RIGID-SYMBOL-WRT-MODULE "QUALIFIED-ESCAPED-SYMBOL-ESCAPE" NULL
     2))
   (CL:SETQ KWD-READ-QUALIFIED-FULLY-ESCAPED-SYMBOL
    (INTERN-RIGID-SYMBOL-WRT-MODULE "QUALIFIED-FULLY-ESCAPED-SYMBOL" NULL
     2))
   ...
   (CL:SETQ KWD-READ-QUALIFIED-ESCAPED-SURROGATE-ESCAPE
    (INTERN-RIGID-SYMBOL-WRT-MODULE "QUALIFIED-ESCAPED-SURROGATE-ESCAPE"
     NULL 2))
   ...
   (CL:SETQ KWD-READ-QUALIFIED-ESCAPED-SURROGATE
    (INTERN-RIGID-SYMBOL-WRT-MODULE "QUALIFIED-ESCAPED-SURROGATE" NULL 2))
   ...
   (CL:SETQ SYM-READ-STELLA-TOK_STELLASTATENAME_
    (INTERN-RIGID-SYMBOL-WRT-MODULE "TOK_STELLASTATENAME_" NULL 0))
   ...
   (CL:SETQ SYM-READ-STELLA-WITH-STELLA-TOKENIZER
    (INTERN-RIGID-SYMBOL-WRT-MODULE "WITH-STELLA-TOKENIZER" NULL 0))
   (CL:SETQ SYM-READ-STELLA-WITH-STELLA-TOKENIZER-EXPANDER
    (INTERN-RIGID-SYMBOL-WRT-MODULE "WITH-STELLA-TOKENIZER-EXPANDER" NULL
     0))
   (CL:SETQ SYM-READ-STELLA-GET-NEXT-STELLA-TOKEN
    (INTERN-RIGID-SYMBOL-WRT-MODULE "GET-NEXT-STELLA-TOKEN" NULL 0))
   (CL:SETQ SYM-READ-STELLA-GET-NEXT-STELLA-TOKEN-EXPANDER
    (INTERN-RIGID-SYMBOL-WRT-MODULE "GET-NEXT-STELLA-TOKEN-EXPANDER" NULL
     0))
   (CL:SETQ SYM-READ-STELLA-GET-STELLA-TOKEN-TYPE
    (INTERN-RIGID-SYMBOL-WRT-MODULE "GET-STELLA-TOKEN-TYPE" NULL 0))
   (CL:SETQ SYM-READ-STELLA-GET-STELLA-TOKEN-TYPE-EXPANDER
    (INTERN-RIGID-SYMBOL-WRT-MODULE "GET-STELLA-TOKEN-TYPE-EXPANDER" NULL
     0))
   (CL:SETQ
...
(CL:DEFUN HELP-STARTUP-READ4 ()
  (CL:PROGN
   (CL:SETQ SYM-READ-STELLA-GET-QUALIFIED-SYMBOL-SEPARATOR-POSITION
    (INTERN-RIGID-SYMBOL-WRT-MODULE
     "GET-QUALIFIED-SYMBOL-SEPARATOR-POSITION" NULL 0))
   (CL:SETQ
    SYM-READ-STELLA-GET-QUALIFIED-SYMBOL-SEPARATOR-POSITION-EXPANDER
    (INTERN-RIGID-SYMBOL-WRT-MODULE
     "GET-QUALIFIED-SYMBOL-SEPARATOR-POSITION-EXPANDER" NULL 0))
...
(CL:DEFUN HELP-STARTUP-READ5 ()
  (CL:PROGN
   (CL:SETQ *STELLA-TOKENIZER-TABLE-DEFINITION*
    (LIST*
     ...
     (LIST* KWD-READ-DELIMITER SYM-READ-STELLA-* (WRAP-STRING "(")
      ...
      (LIST* KWD-READ-OPEN-STRING KWD-READ-STRING NIL) SYM-READ-STELLA-*
      (WRAP-STRING "'") KWD-READ-SINGLE-QUOTE SYM-READ-STELLA-*
      (WRAP-STRING "`") KWD-READ-BACK-QUOTE SYM-READ-STELLA-*
      (WRAP-STRING ",") KWD-READ-COMMA SYM-READ-STELLA-! (WRAP-STRING ";")
      KWD-READ-COMMENT SYM-READ-STELLA-! (WRAP-STRING "#") KWD-READ-HASH
      SYM-READ-STELLA-!
     ...
     (LIST* KWD-READ-PAREN-COMMENT (WRAP-STRING "\\")
      ...
      KWD-READ-PAREN-COMMENT-BAR KWD-READ-OTHERWISE KWD-READ-PAREN-COMMENT
      NIL)
     ...
     (LIST* KWD-READ-PAREN-COMMENT-BAR (WRAP-STRING "#") KWD-READ-START
      (WRAP-STRING "\\") KWD-READ-PAREN-COMMENT-ESCAPE (WRAP-STRING "|")
      KWD-READ-PAREN-COMMENT-BAR KWD-READ-OTHERWISE KWD-READ-PAREN-COMMENT
      NIL)
     ...
     (LIST* KWD-READ-COMMA (WRAP-STRING ".") KWD-READ-COMMA-SPLICE
      ...
      SYM-READ-STELLA-* (WRAP-STRING "\\") KWD-READ-ESCAPED-SYMBOL-ESCAPE
      SYM-READ-STELLA-* (WRAP-STRING "/") KWD-READ-QUALIFIED-NAME
      SYM-READ-STELLA-* (WRAP-STRING ":")
      (LIST* KWD-READ-OPEN-KEYWORD KWD-READ-KEYWORD NIL) SYM-READ-STELLA-*
      (WRAP-STRING "@")
     ...
     (LIST* KWD-READ-STRING-ESCAPE KWD-READ-ANY KWD-READ-ESCAPED-STRING
      NIL)
     (LIST* KWD-READ-ESCAPED-STRING SYM-READ-STELLA-* (WRAP-STRING "\"")
      KWD-READ-CLOSE-STRING (WRAP-STRING "\\") KWD-READ-STRING-ESCAPE
      KWD-READ-OTHERWISE KWD-READ-ESCAPED-STRING NIL)
     (LIST* KWD-READ-HASH (WRAP-STRING "\\") KWD-READ-CHARACTER-CONSTANT
      (WRAP-STRING "|") KWD-READ-PAREN-COMMENT NIL)
     ...
     (LIST* KWD-READ-SYMBOL-OR-SIGNED-NUMBER KWD-READ-INCLUDE
      ...
      (WRAP-STRING ".")
      (LIST* KWD-READ-SYMBOL-OR-MANTISSA KWD-READ-SYMBOL NIL)
      (WRAP-STRING "|") KWD-READ-ERROR KWD-READ-OTHERWISE KWD-READ-SYMBOL
      NIL)
     (LIST* KWD-READ-SYMBOL-OR-NUMBER KWD-READ-INCLUDE KWD-READ-DELIMITER
      (WRAP-STRING "/") KWD-READ-QUALIFIED-NAME (WRAP-STRING "\\")
      KWD-READ-ESCAPED-SYMBOL-ESCAPE (WRAP-STRING "0123456789")
      (LIST* KWD-READ-SYMBOL-OR-NUMBER KWD-READ-INTEGER NIL)
      (WRAP-STRING ".")
     ...
     (LIST* KWD-READ-OPEN-KEYWORD KWD-READ-INCLUDE KWD-READ-DELIMITER
      (WRAP-STRING "|") KWD-READ-FULLY-ESCAPED-KEYWORD (WRAP-STRING "\\")
      KWD-READ-ESCAPED-KEYWORD-ESCAPE KWD-READ-OTHERWISE KWD-READ-KEYWORD
      NIL)
     (LIST* KWD-READ-KEYWORD KWD-READ-INCLUDE KWD-READ-DELIMITER
      (WRAP-STRING "\\") KWD-READ-ESCAPED-KEYWORD-ESCAPE (WRAP-STRING "|")
      KWD-READ-ERROR KWD-READ-OTHERWISE KWD-READ-KEYWORD NIL)
     (LIST* KWD-READ-ESCAPED-KEYWORD-ESCAPE KWD-READ-ANY
      KWD-READ-ESCAPED-KEYWORD NIL)
     (LIST* KWD-READ-ESCAPED-KEYWORD KWD-READ-INCLUDE KWD-READ-DELIMITER
      (WRAP-STRING "\\") KWD-READ-ESCAPED-KEYWORD-ESCAPE (WRAP-STRING "|")
      KWD-READ-ERROR KWD-READ-OTHERWISE KWD-READ-ESCAPED-KEYWORD NIL)
     ...
     (LIST* KWD-READ-ESCAPED-SURROGATE KWD-READ-INCLUDE KWD-READ-DELIMITER
      (WRAP-STRING "/|") KWD-READ-ERROR (WRAP-STRING "\\")
      KWD-READ-ESCAPED-SURROGATE-ESCAPE KWD-READ-OTHERWISE
     ...
     (LIST* KWD-READ-QUALIFIED-NAME KWD-READ-INCLUDE KWD-READ-DELIMITER
      ...
      KWD-READ-QUALIFIED-NAME KWD-READ-OTHERWISE KWD-READ-QUALIFIED-SYMBOL
      NIL)
     (LIST* KWD-READ-QUALIFIED-SYMBOL KWD-READ-INCLUDE KWD-READ-DELIMITER
      (WRAP-STRING "/") KWD-READ-QUALIFIED-NAME (WRAP-STRING "\\")
      KWD-READ-QUALIFIED-ESCAPED-SYMBOL-ESCAPE (WRAP-STRING "|")
      KWD-READ-ERROR KWD-READ-OTHERWISE KWD-READ-QUALIFIED-SYMBOL NIL)
     ...
     (LIST* KWD-READ-QUALIFIED-FULLY-ESCAPED-SURROGATE SYM-READ-STELLA-*
      (WRAP-STRING "|") KWD-READ-CLOSE-FULLY-ESCAPED-NAME
      (WRAP-STRING "\\") KWD-READ-QUALIFIED-FULLY-ESCAPED-SURROGATE-ESCAPE
      KWD-READ-OTHERWISE KWD-READ-QUALIFIED-FULLY-ESCAPED-SURROGATE NIL)
     (LIST* KWD-READ-QUALIFIED-FULLY-ESCAPED-SURROGATE-ESCAPE KWD-READ-ANY
      KWD-READ-QUALIFIED-FULLY-ESCAPED-SURROGATE NIL)
   ...
   (CL:LET* ((SELF-031 (NEW-PROPERTY-LIST)))
    (CL:SETF (%THE-PLIST SELF-031)
    ...
    (CL:SETQ *STELLA-LOGICAL-STATE-NAMES-TABLE* SELF-031))
   (CL:SETQ *STELLA-LOGICAL-STATE-NAMES*
    (NEW-VECTOR (LENGTH (%STATE-NAMES *STELLA-TOKENIZER-TABLE*))))
   (CL:LET*
    ((I NULL-INTEGER) (ITER-033 0)
     (UPPER-BOUND-034 (CL:1- (LENGTH *STELLA-LOGICAL-STATE-NAMES*))))
    (CL:DECLARE (CL:TYPE CL:FIXNUM ITER-033 UPPER-BOUND-034 I))
    (CL:LOOP WHILE (CL:<= ITER-033 UPPER-BOUND-034) DO
     (CL:PROGN (CL:SETQ I ITER-033) (CL:SETQ ITER-033 (CL:1+ ITER-033)))
     (CL:LET
   ...
   (CL:SETQ *STELLA-TOKENIZER-WHITE-SPACE-STATE*
    (POSITION (%STATE-NAMES *STELLA-TOKENIZER-TABLE*) KWD-READ-WHITE-SPACE
     0))
   (CL:SETQ *USER-QUERY-ACTION* KWD-READ-ASK)
   (CL:SETQ *XML-TOKENIZER-TABLE-DEFINITION*
    (LIST*
     (LIST* KWD-READ-START KWD-READ-INCLUDE KWD-READ-SKIP-WHITESPACE NIL)
     (LIST* KWD-READ-SKIP-WHITESPACE SYM-READ-STELLA-!
      (LIST* (WRAP-CHARACTER #\ ) (WRAP-CHARACTER #\Tab)
       (WRAP-CHARACTER #\Linefeed) (WRAP-CHARACTER #\Return) NIL)
      KWD-READ-SKIP-WHITESPACE SYM-READ-STELLA-! (WRAP-STRING "<")
      KWD-READ-OPEN-TAG KWD-READ-EOF KWD-READ-EOF SYM-READ-STELLA-*
      KWD-READ-OTHERWISE KWD-READ-CONTENT NIL)
     (LIST* KWD-READ-CONTENT SYM-READ-STELLA-! (WRAP-STRING "<")
      KWD-READ-OPEN-TAG KWD-READ-EOF KWD-READ-EOF KWD-READ-OTHERWISE
      KWD-READ-CONTENT NIL)
     (LIST* KWD-READ-OPEN-TAG SYM-READ-STELLA-* (WRAP-STRING ">")
      KWD-READ-START-TAG-END SYM-READ-STELLA-! (WRAP-STRING "/")
      KWD-READ-OPEN-END-TAG (WRAP-STRING "?") KWD-READ-OPEN-PI-TAG
      (WRAP-STRING "!") KWD-READ-OPEN-DECLARATION-TAG
      (LIST* (WRAP-CHARACTER #\ ) (WRAP-CHARACTER #\Tab)
       (WRAP-CHARACTER #\Linefeed) (WRAP-CHARACTER #\Return) NIL)
      KWD-READ-OPEN-TAG SYM-READ-STELLA-* KWD-READ-OTHERWISE
      KWD-READ-START-TAG NIL)
     (LIST* KWD-READ-START-TAG SYM-READ-STELLA-* (WRAP-STRING ">")
      KWD-READ-START-TAG-END SYM-READ-STELLA-! (WRAP-STRING "/")
      KWD-READ-OPEN-EMPTY-TAG-END SYM-READ-STELLA-!
      (LIST* (WRAP-CHARACTER #\ ) (WRAP-CHARACTER #\Tab)
       (WRAP-CHARACTER #\Linefeed) (WRAP-CHARACTER #\Return) NIL)
      KWD-READ-SKIP-TO-ATTRIBUTE-NAME KWD-READ-OTHERWISE
      KWD-READ-START-TAG NIL)
     (LIST* KWD-READ-OPEN-PI-TAG SYM-READ-STELLA-* KWD-READ-ANY
      KWD-READ-START-PI-TAG NIL)
     (LIST* KWD-READ-START-PI-TAG SYM-READ-STELLA-! (WRAP-STRING "?")
      KWD-READ-OPEN-PI-TAG-END SYM-READ-STELLA-*
      (LIST* (WRAP-CHARACTER #\ ) (WRAP-CHARACTER #\Tab)
       (WRAP-CHARACTER #\Linefeed) (WRAP-CHARACTER #\Return) NIL)
      KWD-READ-PI-TAG-DATA KWD-READ-OTHERWISE KWD-READ-START-PI-TAG NIL)
     (LIST* KWD-READ-PI-TAG-DATA (WRAP-STRING "?")
      (LIST* KWD-READ-PI-TAG-DATA-OR-END KWD-READ-PI-TAG-DATA NIL)
      KWD-READ-OTHERWISE KWD-READ-PI-TAG-DATA NIL)
     (LIST* KWD-READ-PI-TAG-DATA-OR-END SYM-READ-STELLA-*
      (WRAP-STRING ">") KWD-READ-EMPTY-TAG-END KWD-READ-OTHERWISE
      KWD-READ-PI-TAG-DATA NIL)
     (LIST* KWD-READ-OPEN-PI-TAG-END SYM-READ-STELLA-* (WRAP-STRING ">")
      KWD-READ-EMPTY-TAG-END KWD-READ-OTHERWISE KWD-READ-ERROR NIL)
     (LIST* KWD-READ-OPEN-END-TAG SYM-READ-STELLA-! (WRAP-STRING ">")
      KWD-READ-END-TAG-END SYM-READ-STELLA-* KWD-READ-OTHERWISE
      KWD-READ-END-TAG NIL)
     (LIST* KWD-READ-END-TAG SYM-READ-STELLA-! (WRAP-STRING ">")
      KWD-READ-END-TAG-END KWD-READ-OTHERWISE KWD-READ-END-TAG NIL)
     (LIST* KWD-READ-SKIP-TO-ATTRIBUTE-NAME SYM-READ-STELLA-*
      (WRAP-STRING ">") KWD-READ-START-TAG-END SYM-READ-STELLA-!
      (WRAP-STRING "/") KWD-READ-OPEN-EMPTY-TAG-END SYM-READ-STELLA-!
      (LIST* (WRAP-CHARACTER #\ ) (WRAP-CHARACTER #\Tab)
       (WRAP-CHARACTER #\Linefeed) (WRAP-CHARACTER #\Return) NIL)
      KWD-READ-SKIP-TO-ATTRIBUTE-NAME SYM-READ-STELLA-* KWD-READ-OTHERWISE
      KWD-READ-ATTRIBUTE-NAME NIL)
     (LIST* KWD-READ-ATTRIBUTE-NAME SYM-READ-STELLA-* (WRAP-STRING ">")
      KWD-READ-START-TAG-END SYM-READ-STELLA-! (WRAP-STRING "/")
      KWD-READ-OPEN-EMPTY-TAG-END SYM-READ-STELLA-!
      (LIST* (WRAP-CHARACTER #\=) (WRAP-CHARACTER #\ )
       (WRAP-CHARACTER #\Tab) (WRAP-CHARACTER #\Linefeed)
       (WRAP-CHARACTER #\Return) NIL)
      KWD-READ-SKIP-TO-ATTRIBUTE-VALUE KWD-READ-OTHERWISE
      KWD-READ-ATTRIBUTE-NAME NIL)
     (LIST* KWD-READ-SKIP-TO-ATTRIBUTE-VALUE SYM-READ-STELLA-*
      (WRAP-STRING ">") KWD-READ-START-TAG-END SYM-READ-STELLA-!
      (WRAP-STRING "/") KWD-READ-OPEN-EMPTY-TAG-END
      (LIST* (WRAP-CHARACTER #\=) (WRAP-CHARACTER #\ )
       (WRAP-CHARACTER #\Tab) (WRAP-CHARACTER #\Linefeed)
       (WRAP-CHARACTER #\Return) NIL)
      KWD-READ-SKIP-TO-ATTRIBUTE-VALUE SYM-READ-STELLA-* (WRAP-STRING "'")
      KWD-READ-SINGLE-QUOTED-ATTRIBUTE-VALUE SYM-READ-STELLA-*
      (WRAP-STRING "\"") KWD-READ-DOUBLE-QUOTED-ATTRIBUTE-VALUE
      SYM-READ-STELLA-* KWD-READ-OTHERWISE
      KWD-READ-UNQUOTED-ATTRIBUTE-VALUE NIL)
     (LIST* KWD-READ-SINGLE-QUOTED-ATTRIBUTE-VALUE (WRAP-STRING "'")
      KWD-READ-QUOTED-ATTRIBUTE-VALUE KWD-READ-OTHERWISE
      KWD-READ-SINGLE-QUOTED-ATTRIBUTE-VALUE NIL)
     (LIST* KWD-READ-DOUBLE-QUOTED-ATTRIBUTE-VALUE (WRAP-STRING "\"")
      KWD-READ-QUOTED-ATTRIBUTE-VALUE KWD-READ-OTHERWISE
      KWD-READ-DOUBLE-QUOTED-ATTRIBUTE-VALUE NIL)
     (LIST* KWD-READ-QUOTED-ATTRIBUTE-VALUE KWD-READ-INCLUDE
      KWD-READ-SKIP-TO-ATTRIBUTE-NAME NIL)
     (LIST* KWD-READ-UNQUOTED-ATTRIBUTE-VALUE SYM-READ-STELLA-*
      (WRAP-STRING ">") KWD-READ-START-TAG-END SYM-READ-STELLA-!
      (WRAP-STRING "/") KWD-READ-OPEN-EMPTY-TAG-END SYM-READ-STELLA-!
      (LIST* (WRAP-CHARACTER #\ ) (WRAP-CHARACTER #\Tab)
       (WRAP-CHARACTER #\Linefeed) (WRAP-CHARACTER #\Return) NIL)
      KWD-READ-SKIP-TO-ATTRIBUTE-NAME KWD-READ-OTHERWISE
      KWD-READ-UNQUOTED-ATTRIBUTE-VALUE NIL)
     (LIST* KWD-READ-OPEN-DECLARATION-TAG (WRAP-STRING "-")
      KWD-READ-START-TAG-OR-COMMENT (WRAP-STRING "[")
      KWD-READ-OPEN-SPECIAL-TAG SYM-READ-STELLA-* KWD-READ-OTHERWISE
      KWD-READ-START-DECLARATION-TAG NIL)
     (LIST* KWD-READ-START-DECLARATION-TAG SYM-READ-STELLA-*
      (WRAP-STRING ">") KWD-READ-EMPTY-TAG-END SYM-READ-STELLA-*
      (LIST* (WRAP-CHARACTER #\ ) (WRAP-CHARACTER #\Tab)
       (WRAP-CHARACTER #\Linefeed) (WRAP-CHARACTER #\Return) NIL)
      KWD-READ-DECLARATION-TAG-DATA KWD-READ-OTHERWISE
      KWD-READ-START-DECLARATION-TAG NIL)
     (LIST* KWD-READ-DECLARATION-TAG-DATA SYM-READ-STELLA-*
      (WRAP-STRING ">") KWD-READ-EMPTY-TAG-END (WRAP-STRING "'")
      KWD-READ-SINGLE-QUOTED-DECLARATION-TAG-DATA (WRAP-STRING "\"")
      KWD-READ-DOUBLE-QUOTED-DECLARATION-TAG-DATA KWD-READ-OTHERWISE
      KWD-READ-DECLARATION-TAG-DATA NIL)
     (LIST* KWD-READ-SINGLE-QUOTED-DECLARATION-TAG-DATA (WRAP-STRING "'")
      KWD-READ-DECLARATION-TAG-DATA KWD-READ-OTHERWISE
      KWD-READ-SINGLE-QUOTED-DECLARATION-TAG-DATA NIL)
     (LIST* KWD-READ-DOUBLE-QUOTED-DECLARATION-TAG-DATA (WRAP-STRING "\"")
      KWD-READ-DECLARATION-TAG-DATA KWD-READ-OTHERWISE
      KWD-READ-DOUBLE-QUOTED-DECLARATION-TAG-DATA NIL)
     (LIST* KWD-READ-OPEN-SPECIAL-TAG SYM-READ-STELLA-* KWD-READ-ANY
      KWD-READ-START-SPECIAL-TAG NIL)
     (LIST* KWD-READ-START-SPECIAL-TAG SYM-READ-STELLA-* (WRAP-STRING "[")
      KWD-READ-SPECIAL-TAG-DATA KWD-READ-OTHERWISE
      KWD-READ-START-SPECIAL-TAG NIL)
     (LIST* KWD-READ-SPECIAL-TAG-DATA (WRAP-STRING "]")
      KWD-READ-SPECIAL-TAG-DATA-OR-END KWD-READ-OTHERWISE
      KWD-READ-SPECIAL-TAG-DATA NIL)
     (LIST* KWD-READ-SPECIAL-TAG-DATA-OR-END (WRAP-STRING "]")
      (LIST* KWD-READ-SPECIAL-TAG-DATA-OR-END2 KWD-READ-SPECIAL-TAG-DATA
       NIL)
      KWD-READ-OTHERWISE KWD-READ-SPECIAL-TAG-DATA NIL)
     (LIST* KWD-READ-SPECIAL-TAG-DATA-OR-END2 SYM-READ-STELLA-*
      (WRAP-STRING ">") KWD-READ-EMPTY-TAG-END KWD-READ-OTHERWISE
      KWD-READ-SPECIAL-TAG-DATA NIL)
     (LIST* KWD-READ-START-TAG-OR-COMMENT (WRAP-STRING "-")
      KWD-READ-COMMENT-BODY SYM-READ-STELLA-* KWD-READ-OTHERWISE
      KWD-READ-START-TAG NIL)
     (LIST* KWD-READ-COMMENT-BODY (WRAP-STRING "-")
      KWD-READ-END-COMMENT-OR-COMMENT KWD-READ-OTHERWISE
      KWD-READ-COMMENT-BODY NIL)
     (LIST* KWD-READ-END-COMMENT-OR-COMMENT (WRAP-STRING "-")
      KWD-READ-END-COMMENT-OR-COMMENT2 KWD-READ-OTHERWISE
      KWD-READ-COMMENT-BODY NIL)
     (LIST* KWD-READ-END-COMMENT-OR-COMMENT2 (WRAP-STRING ">")
      KWD-READ-COMMENT KWD-READ-OTHERWISE KWD-READ-ERROR NIL)
     (LIST* KWD-READ-COMMENT KWD-READ-INCLUDE KWD-READ-START NIL)
     (LIST* KWD-READ-START-TAG-END KWD-READ-INCLUDE KWD-READ-START NIL)
     (LIST* KWD-READ-END-TAG-END KWD-READ-INCLUDE KWD-READ-START NIL)
     (LIST* KWD-READ-OPEN-EMPTY-TAG-END SYM-READ-STELLA-*
      (WRAP-STRING ">") KWD-READ-EMPTY-TAG-END KWD-READ-OTHERWISE
      KWD-READ-ERROR NIL)
     (LIST* KWD-READ-EMPTY-TAG-END KWD-READ-INCLUDE KWD-READ-START NIL)
     (LIST* KWD-READ-ERROR KWD-READ-INCLUDE KWD-READ-START NIL) NIL)))
  :VOID)
...
(CL:DEFUN HELP-STARTUP-READ7 ()
  (CL:PROGN
   ...
   (DEFINE-FUNCTION-OBJECT "MAKE-TOKENIZER-BYTE-ARRAY"
    "(DEFUN (MAKE-TOKENIZER-BYTE-ARRAY TOKENIZER-BYTE-ARRAY) ((SIZE INTEGER)) :GLOBALLY-INLINE? TRUE :PUBLIC? TRUE (RETURN (VERBATIM :COMMON-LISP (CL:MAKE-STRING SIZE) :CPP \"new (GC) char[size]\" :JAVA \"new byte[size]\")))"
   ...
   (DEFINE-METHOD-OBJECT
    "(DEFMETHOD (BYTE-ARRAY-NTH CHARACTER) ((BUFFER TOKENIZER-BYTE-ARRAY) (POSITION INTEGER)) :GLOBALLY-INLINE? TRUE :PUBLIC? TRUE (RETURN (VERBATIM :COMMON-LISP (CL:AREF (CL:THE CL:SIMPLE-STRING BUFFER) (CL:THE CL:FIXNUM POSITION)) :CPP \"buffer[position]\" :JAVA \"(char)buffer[position]\")))"
    (CL:FUNCTION BYTE-ARRAY-NTH) NULL)
   (DEFINE-METHOD-OBJECT
    "(DEFMETHOD (BYTE-ARRAY-NTH-SETTER TOKENIZER-BYTE) ((BUFFER TOKENIZER-BYTE-ARRAY) (CH CHARACTER) (POSITION INTEGER)) :GLOBALLY-INLINE? TRUE :PUBLIC? TRUE (RETURN (VERBATIM :COMMON-LISP (CL:SETF (CL:AREF (CL:THE CL:SIMPLE-STRING BUFFER) (CL:THE CL:FIXNUM POSITION)) (CL:THE CL:CHARACTER CH)) :CPP \"buffer[position] = ch\" :JAVA \"buffer[position] = (byte)ch\")))"
    (CL:FUNCTION BYTE-ARRAY-NTH-SETTER) NULL)
   (DEFINE-FUNCTION-OBJECT "BYTE-ARRAY-READ-SEQUENCE"
    "(DEFUN (BYTE-ARRAY-READ-SEQUENCE INTEGER) ((BUFFER TOKENIZER-BYTE-ARRAY) (STREAM NATIVE-INPUT-STREAM) (START INTEGER) (END INTEGER)))"
   ...
   (DEFINE-FUNCTION-OBJECT "READ-LINE-FROM-TOKENIZER-BUFFER"
    "(DEFUN (READ-LINE-FROM-TOKENIZER-BUFFER STRING BOOLEAN) ((STREAM INPUT-STREAM)))"
    (CL:FUNCTION READ-LINE-FROM-TOKENIZER-BUFFER) NULL)
   (DEFINE-FUNCTION-OBJECT "WITH-TOKENIZER-EXPANDER"
    "(DEFUN (WITH-TOKENIZER-EXPANDER OBJECT) ((TABLE OBJECT) (INPUT OBJECT) |&BODY| (BODY CONS)) :PUBLIC? TRUE)"
    (CL:FUNCTION WITH-TOKENIZER-EXPANDER) NULL)
   ...
   (DEFINE-FUNCTION-OBJECT "END-OF-TOKENS?-EXPANDER"
    "(DEFUN (END-OF-TOKENS?-EXPANDER OBJECT) () :PUBLIC? TRUE)"
    (CL:FUNCTION END-OF-TOKENS?-EXPANDER) NULL)
   (DEFINE-FUNCTION-OBJECT "GET-TOKEN-TEXT-EXPANDER"
    "(DEFUN (GET-TOKEN-TEXT-EXPANDER OBJECT) (|&BODY| (OPTIONS CONS)) :PUBLIC? TRUE)"
    (CL:FUNCTION GET-TOKEN-TEXT-EXPANDER) NULL)
   ...
   (DEFINE-FUNCTION-OBJECT "GET-TOKEN-TYPE-EXPANDER"
    "(DEFUN (GET-TOKEN-TYPE-EXPANDER OBJECT) ())"
    (CL:FUNCTION GET-TOKEN-TYPE-EXPANDER) NULL)
   (DEFINE-FUNCTION-OBJECT "SAVE-TOKENIZER-STREAM-STATE-EXPANDER"
    "(DEFUN (SAVE-TOKENIZER-STREAM-STATE-EXPANDER OBJECT) ())"
    (CL:FUNCTION SAVE-TOKENIZER-STREAM-STATE-EXPANDER) NULL)
   (DEFINE-FUNCTION-OBJECT "GET-NEXT-TOKEN-EXPANDER"
    "(DEFUN (GET-NEXT-TOKEN-EXPANDER OBJECT) (|&BODY| (OPTIONS CONS)))"
    (CL:FUNCTION GET-NEXT-TOKEN-EXPANDER) NULL)
   ...
   (DEFINE-FUNCTION-OBJECT "WITH-STELLA-TOKENIZER-EXPANDER"
    "(DEFUN (WITH-STELLA-TOKENIZER-EXPANDER OBJECT) ((INPUT OBJECT) |&BODY| (BODY CONS)))"
    (CL:FUNCTION WITH-STELLA-TOKENIZER-EXPANDER) NULL)
   (DEFINE-FUNCTION-OBJECT "GET-NEXT-STELLA-TOKEN-EXPANDER"
    "(DEFUN (GET-NEXT-STELLA-TOKEN-EXPANDER OBJECT) (|&BODY| (OPTIONS CONS)))"
    (CL:FUNCTION GET-NEXT-STELLA-TOKEN-EXPANDER) NULL)
   (DEFINE-FUNCTION-OBJECT "GET-STELLA-TOKEN-TYPE-EXPANDER"
    "(DEFUN (GET-STELLA-TOKEN-TYPE-EXPANDER OBJECT) ())"
    (CL:FUNCTION GET-STELLA-TOKEN-TYPE-EXPANDER) NULL)
   (DEFINE-FUNCTION-OBJECT
    "GET-QUALIFIED-SYMBOL-SEPARATOR-POSITION-EXPANDER"
    "(DEFUN (GET-QUALIFIED-SYMBOL-SEPARATOR-POSITION-EXPANDER OBJECT) ())"
    (CL:FUNCTION GET-QUALIFIED-SYMBOL-SEPARATOR-POSITION-EXPANDER) NULL)
   (DEFINE-FUNCTION-OBJECT
    "GET-QUALIFIED-SYMBOL-SEPARATOR-POSITION-INTERNAL"
    "(DEFUN (GET-QUALIFIED-SYMBOL-SEPARATOR-POSITION-INTERNAL INTEGER) ((BUFFER TOKENIZER-BYTE-ARRAY) (TOKENSTART INTEGER) (TOKENEND INTEGER) (SIZE INTEGER)))"
...
return the result.\" :PUBLIC? TRUE)"
   ...
   (DEFINE-FUNCTION-OBJECT "READ-LINE"
    "(DEFUN (READ-LINE STRING BOOLEAN) ((INPUTSTREAM INPUT-STREAM)) :DOCUMENTATION \"Read one line from `inputStream' and return the result.
...
the input is read.  See also special variable *USER-QUERY-ACTION*.\" :PUBLIC? TRUE)"
   ...
   (DEFINE-FUNCTION-OBJECT "XML-TOKEN-LIST-TO-S-EXPRESSION"
    "(DEFUN (XML-TOKEN-LIST-TO-S-EXPRESSION OBJECT) ((TOKENLIST STELLA-TOKEN)) :DOCUMENTATION \"Convert the XML `tokenList' into a representative s-expression
and return the result.  Every XML tag is represented as a cons-list starting
with the tag name as its header, followed by a possibly empty list of keyword
value pairs representing tag attributes, followed by a possibly empty list of
content expressions which might themselves be XML expressions.  For example,
...
CDATA and conditional tags (`[').  For these tags the second element in the
list is the actual tag name, and the third element is the unparsed data string
following the name (including whitespace).\" :PUBLIC? TRUE)"
    (CL:FUNCTION XML-TOKEN-LIST-TO-S-EXPRESSION) NULL)
   (DEFINE-FUNCTION-OBJECT "READ-XML-EXPRESSION"
    "(DEFUN (READ-XML-EXPRESSION OBJECT BOOLEAN) ((STREAM INPUT-STREAM) (STARTTAGNAME STRING)) :DOCUMENTATION \"Read one balanced XML expression from `stream' and return
its s-expression representation (see `xml-token-list-to-s-expression').  If
`startTagName' is non-NULL, skip all tags until a start tag `startTagName'
is encountered.  Return TRUE as the second value on EOF.\" :PUBLIC? TRUE)"
   ...
   (DEFINE-FUNCTION-OBJECT "XML-EXPRESSIONS"
    "(DEFUN (XML-EXPRESSIONS XML-EXPRESSION-ITERATOR) ((STREAM INPUT-STREAM) (REGIONTAG CONS)) :DOCUMENTATION \"Return an XML-expression-iterator (which see) reading from
`stream'.  `regionTag' can be used to define delimited regions from which
expressions should be considered (use s-expression representation to specify
`regionTag', e.g., `(KIF :version \\\"1.0\\\")'.\" :PUBLIC? TRUE)"
   ...
   (CL:LET* ((FUNCTION (LOOKUP-FUNCTION SYM-READ-STELLA-STARTUP-READ)))
    (SET-DYNAMIC-SLOT-VALUE (%DYNAMIC-SLOTS FUNCTION)
     SYM-READ-STELLA-METHOD-STARTUP-CLASSNAME (WRAP-STRING "Startup-Read")
     NULL-STRING-WRAPPER)))
  :VOID)
...
(CL:DEFUN STARTUP-READ ()
  (CL:LET* ((*MODULE* *STELLA-MODULE*) (*CONTEXT* *MODULE*))
   ...
   (CL:WHEN (CURRENT-STARTUP-TIME-PHASE? 9)
    ...
    (STORE-MACRO SYM-READ-STELLA-WITH-TOKENIZER
     SYM-READ-STELLA-WITH-TOKENIZER-EXPANDER
     (CL:FUNCTION WITH-TOKENIZER-EXPANDER))
    (STORE-MACRO SYM-READ-STELLA-END-OF-TOKENS?
     SYM-READ-STELLA-END-OF-TOKENS?-EXPANDER
     (CL:FUNCTION END-OF-TOKENS?-EXPANDER))
    (STORE-MACRO SYM-READ-STELLA-GET-TOKEN-TEXT
     SYM-READ-STELLA-GET-TOKEN-TEXT-EXPANDER
     (CL:FUNCTION GET-TOKEN-TEXT-EXPANDER))
    (STORE-MACRO SYM-READ-STELLA-GET-TOKEN-TYPE
     SYM-READ-STELLA-GET-TOKEN-TYPE-EXPANDER
     (CL:FUNCTION GET-TOKEN-TYPE-EXPANDER))
    (STORE-MACRO SYM-READ-STELLA-SAVE-TOKENIZER-STREAM-STATE
     SYM-READ-STELLA-SAVE-TOKENIZER-STREAM-STATE-EXPANDER
     (CL:FUNCTION SAVE-TOKENIZER-STREAM-STATE-EXPANDER))
    (STORE-MACRO SYM-READ-STELLA-GET-NEXT-TOKEN
     SYM-READ-STELLA-GET-NEXT-TOKEN-EXPANDER
     (CL:FUNCTION GET-NEXT-TOKEN-EXPANDER))
    (DEFINE-STELLA-GLOBAL-VARIABLE-FROM-STRINGIFIED-SOURCE
    ...
    (STORE-MACRO SYM-READ-STELLA-WITH-STELLA-TOKENIZER
     SYM-READ-STELLA-WITH-STELLA-TOKENIZER-EXPANDER
     (CL:FUNCTION WITH-STELLA-TOKENIZER-EXPANDER))
    (STORE-MACRO SYM-READ-STELLA-GET-NEXT-STELLA-TOKEN
     SYM-READ-STELLA-GET-NEXT-STELLA-TOKEN-EXPANDER
     (CL:FUNCTION GET-NEXT-STELLA-TOKEN-EXPANDER))
    (STORE-MACRO SYM-READ-STELLA-GET-STELLA-TOKEN-TYPE
     SYM-READ-STELLA-GET-STELLA-TOKEN-TYPE-EXPANDER
     (CL:FUNCTION GET-STELLA-TOKEN-TYPE-EXPANDER))
    (STORE-MACRO SYM-READ-STELLA-GET-QUALIFIED-SYMBOL-SEPARATOR-POSITION
     SYM-READ-STELLA-GET-QUALIFIED-SYMBOL-SEPARATOR-POSITION-EXPANDER
     (CL:FUNCTION GET-QUALIFIED-SYMBOL-SEPARATOR-POSITION-EXPANDER))
    (DEFINE-STELLA-GLOBAL-VARIABLE-FROM-STRINGIFIED-SOURCE
