...
(CL:DECLAIM
 (CL:SPECIAL *STELLA-MODULE* STANDARD-OUTPUT *CHARACTER-TYPE-TABLE*
  STANDARD-INPUT *TRANSIENTOBJECTS?* KEYWORD-SYM *MODULE*
  MODULE-SEPARATOR-CHARACTER *CHARACTER-UPCASE-TABLE* ZERO-WRAPPER STANDARD-ERROR
  EOL EOL-STRING NIL-LIST NULL-CHARACTER NULL-INTEGER FALSE NIL TRUE TRUE-WRAPPER
  FALSE-WRAPPER))

;;; (DEFCLASS TOKENIZER-TABLE ...)

(CL:DEFCLASS TOKENIZER-TABLE (STANDARD-OBJECT)
  ((TRANSITIONS :TYPE CL:SIMPLE-STRING :INITFORM STELLA::NULL-STRING :ALLOCATION
    :INSTANCE :ACCESSOR %TRANSITIONS)
...
(CL:DEFUN NEW-TOKENIZER-TABLE ()
  (CL:LET* ((SELF NULL))
   ...
   (CL:SETF (%LEGAL-EOF-STATES SELF) NULL) (CL:SETF (%STATE-NAMES SELF) NULL)
...
(CL:DEFUN PARSE-TOKENIZER-DEFINITION (DEFINITION)
  (CL:LET*
   ((TRANSITIONTABLE (NEW-VECTOR *MAX-TOKENIZER-STATES*))
    ...
    (LEGALEOFSTATES (NEW-VECTOR *MAX-TOKENIZER-STATES*)) (FROMSTATENAME NULL)
    (FROMSTATEID NULL-INTEGER) (TOSTATENAME NULL) (TOSTATEALIAS NULL)
    (TOSTATEID NULL-INTEGER) (FREESTATEID 2) (CHARACTERSPEC NULL)
    (CHARACTERSET NULL) (ALLCHARACTERSETS (NEW-LIST)) (STATEMODIFIERS 0)
    (ERRORS? FALSE) (TABLE (NEW-TOKENIZER-TABLE)))
   (CL:DECLARE (CL:TYPE CL:SIMPLE-STRING TRANSITIONS)
    (CL:TYPE CL:FIXNUM FROMSTATEID TOSTATEID FREESTATEID STATEMODIFIERS))
   (CL:LET
    ((SELF (%THE-ARRAY UNIQUESTATENAMES)) (VALUE KWD-READ-ERROR) (POSITION 0))
   ...
   (CL:LET ((SELF (%THE-ARRAY STATENAMES)) (VALUE KWD-READ-ERROR) (POSITION 0))
    ...
    (CL:SETF (CL:AREF SELF POSITION) VALUE))
   (CL:LET
    ((SELF (%THE-ARRAY UNIQUESTATENAMES)) (VALUE KWD-READ-START) (POSITION 1))
    (CL:DECLARE (CL:TYPE CL:SIMPLE-VECTOR SELF) (CL:TYPE CL:FIXNUM POSITION))
    (CL:SETF (CL:AREF SELF POSITION) VALUE))
      ...
      (CL:LOOP WHILE (CL:NOT (CL:EQ STATEDEFINITION NIL)) DO
       (CL:TAGBODY
        (CL:WHEN (TOKENIZER-INCLUDE-SPEC? (%%VALUE STATEDEFINITION))
         (CL:WHEN
          (CL:NOT
           (LEGAL-TOKENIZER-FROM-STATE? (%%VALUE (%%REST STATEDEFINITION))))
          (CL:WARN "Illegal include specification for state `~A'" FROMSTATENAME)
          (CL:SETQ ERRORS? TRUE) (CL:RETURN))
        ...
        (CL:WHEN
         (CL:AND
          (CL:NOT
           (CL:EQ
            (CL:AREF (CL:THE CL:SIMPLE-VECTOR (%THE-ARRAY STATENAMES)) TOSTATEID)
            TOSTATEALIAS))
          (CL:NOT
           (CL:EQ
            (CL:AREF (CL:THE CL:SIMPLE-VECTOR (%THE-ARRAY STATENAMES)) TOSTATEID)
   ...
   (CL:LET* ((I NULL-INTEGER) (ITER-004 0) (UPPER-BOUND-001 (CL:1- FREESTATEID)))
    ...
    (CL:LOOP WHILE (CL:<= ITER-004 UPPER-BOUND-001) DO
     ...
     (CL:WHEN
      (CL:EQ (CL:AREF (CL:THE CL:SIMPLE-VECTOR (%THE-ARRAY TRANSITIONTABLE)) I)
       NULL)
      (CL:WARN "State `~A' is undefined"
       (CL:AREF (CL:THE CL:SIMPLE-VECTOR (%THE-ARRAY UNIQUESTATENAMES)) I))
      (CL:SETQ ERRORS? TRUE))))
   ...
   (CL:LET* ((I NULL-INTEGER) (ITER-005 0) (UPPER-BOUND-002 (CL:1- FREESTATEID)))
    ...
    (CL:LOOP WHILE (CL:<= ITER-005 UPPER-BOUND-002) DO
     ...
     (CL:LET*
      ...
      (CL:DECLARE (CL:TYPE CL:FIXNUM ITER-006 UPPER-BOUND-003 ITER-007 J K))
    ...
    (CL:LOOP WHILE (CL:<= ITER-008 UPPER-BOUND-004) DO
     ...
     (CL:LET
      ((SELF (%THE-ARRAY (%STATE-NAMES TABLE)))
       (VALUE (CL:AREF (CL:THE CL:SIMPLE-VECTOR (%THE-ARRAY STATENAMES)) I))
       (POSITION I))
      (CL:DECLARE (CL:TYPE CL:SIMPLE-VECTOR SELF) (CL:TYPE CL:FIXNUM POSITION))
      (CL:SETF (CL:AREF SELF POSITION) VALUE))))
    ...
    (CL:LOOP WHILE (CL:<= ITER-009 UPPER-BOUND-005) DO
     ...
     (CL:LET
      ((SELF (%THE-ARRAY (%LEGAL-EOF-STATES TABLE)))
       (VALUE
        (CL:IF
         (CL:EQ (CL:AREF (CL:THE CL:SIMPLE-VECTOR (%THE-ARRAY LEGALEOFSTATES)) I)
          NULL)
         FALSE-WRAPPER
    ...
    (CL:PROGN
     (CL:LET* ((TEST-VALUE-000 (%SYMBOL-NAME MODIFIER)))
      ...
      (CL:COND
       ...
       ((CL:OR (STRING-EQL? TEST-VALUE-000 "!") (STRING-EQL? TEST-VALUE-000 "*!")
         (STRING-EQL? TEST-VALUE-000 "!*"))
        (CL:RETURN-FROM PARSE-TOKENIZER-STATE-MODIFIERS 3))
       (CL:T (CL:RETURN-FROM PARSE-TOKENIZER-STATE-MODIFIERS 0))))))
   (CL:T (CL:RETURN-FROM PARSE-TOKENIZER-STATE-MODIFIERS 0))))
(CL:DECLAIM
 (CL:FTYPE (CL:FUNCTION (CL:T) CL:FIXNUM) PARSE-TOKENIZER-STATE-MODIFIERS))
      ...
      (CL:PROGN
       (CL:LET*
        ((CHAR NULL-CHARACTER) (VECTOR-000 (%WRAPPER-VALUE CHARACTERSPEC))
         (INDEX-000 0) (LENGTH-000 (CL:THE CL:FIXNUM (CL:LENGTH VECTOR-000)))
         (COLLECT-000 NULL))
          ...
          (CL:LET*
           ...
           (CL:LOOP WHILE (CL:<= ITER-002 UPPER-BOUND-000) DO
            ...
            (CL:IF (CL:EQ COLLECT-002 NULL)
             (CL:PROGN
              (CL:SETQ COLLECT-002 (CONS (WRAP-CHARACTER (CL:CODE-CHAR I)) NIL))
           ...
           (CL:LOOP WHILE (CL:<= ITER-005 UPPER-BOUND-001) DO
            ...
            (CL:WHEN (CL:NOT (MEMBER? CHARSET (WRAP-CHARACTER (CL:CODE-CHAR I))))
             (CL:IF (CL:EQ COLLECT-004 NULL)
              (CL:PROGN
               (CL:SETQ COLLECT-004 (CONS (WRAP-CHARACTER (CL:CODE-CHAR I)) NIL))
...
(CL:DEFUN STRINGIFY-TOKENIZER-TABLE (TABLE)
  (CL:LET*
   ((RESULT (NEW-OUTPUT-STRING-STREAM))
    ...
    (STATENAMES (%STATE-NAMES TABLE)) (EOFSTATES (%LEGAL-EOF-STATES TABLE))
    (SEPARATOR "|"))
    ...
    (CL:LOOP WHILE (CL:<= ITER-000 UPPER-BOUND-000) DO
     ...
     (CL:LET
      ...
      (SETF (CL:SCHAR (CL:THE CL:SIMPLE-STRING SELF) (CL:THE CL:FIXNUM POSITION))
       (CL:THE CL:CHARACTER CH)))))
   (%%PRINT-STREAM (%NATIVE-STREAM RESULT)
    (CL:LET ((S ENCODEDTRANSITIONS)) (CL:DECLARE (CL:TYPE CL:SIMPLE-STRING S))
     (CL:THE CL:SIMPLE-STRING S))
    SEPARATOR)
   ...
   (CL:LET*
    ...
    (CL:LOOP WHILE (CL:< INDEX-000 LENGTH-000) DO
     (CL:PROGN
      ...
      (CL:SETQ INDEX-000 (CL:1+ INDEX-000)))
     (%%PRINT-STREAM (%NATIVE-STREAM RESULT) (%SYMBOL-NAME STATE) SEPARATOR)))
...
(CL:DECLAIM
 (CL:FTYPE (CL:FUNCTION (CL:T) CL:SIMPLE-STRING) STRINGIFY-TOKENIZER-TABLE))
...
(CL:DEFUN UNSTRINGIFY-TOKENIZER-TABLE (TABLE)
  ...
  (CL:LET*
   ((RESULT (NEW-TOKENIZER-TABLE)) (ACODE (CL:THE CL:FIXNUM (CL:CHAR-CODE #\A)))
   ...
   (CL:SETQ LINE (SUBSEQUENCE TABLE START END)) (CL:SETQ START (CL:1+ END))
   (CL:SETQ COUNT (STRING-TO-INTEGER LINE))
   (CL:SETQ END (POSITION TABLE SEPARATOR START))
   (CL:SETQ LINE (SUBSEQUENCE TABLE START END)) (CL:SETQ START (CL:1+ END))
   (CL:SETQ TRANSITIONS
    (CL:THE CL:SIMPLE-STRING
   ...
   (CL:LET* ((I NULL-INTEGER) (ITER-002 0) (UPPER-BOUND-002 (CL:1- COUNT)))
    ...
    (CL:LOOP WHILE (CL:<= ITER-002 UPPER-BOUND-002) DO
     ...
     (CL:SETQ LINE (SUBSEQUENCE TABLE START END)) (CL:SETQ START (CL:1+ END))
     (CL:LET
      ((SELF (%THE-ARRAY (%STATE-NAMES RESULT))) (VALUE (INTERN-KEYWORD LINE))
       (POSITION I))
      (CL:DECLARE (CL:TYPE CL:SIMPLE-VECTOR SELF) (CL:TYPE CL:FIXNUM POSITION))
      (CL:SETF (CL:AREF SELF POSITION) VALUE))))
   (CL:SETQ END (POSITION TABLE SEPARATOR START))
   ...
   (CL:LET* ((I NULL-INTEGER) (ITER-003 0) (UPPER-BOUND-003 (CL:1- COUNT)))
    ...
    (CL:LOOP WHILE (CL:<= ITER-003 UPPER-BOUND-003) DO
     ...
     (CL:ECASE
      ...
      (#\T
       (CL:LET
        ((SELF (%THE-ARRAY (%LEGAL-EOF-STATES RESULT))) (VALUE TRUE-WRAPPER)
         (POSITION I))
        (CL:DECLARE (CL:TYPE CL:SIMPLE-VECTOR SELF) (CL:TYPE CL:FIXNUM POSITION))
        (CL:SETF (CL:AREF SELF POSITION) VALUE)))
      (#\F
       (CL:LET
        ((SELF (%THE-ARRAY (%LEGAL-EOF-STATES RESULT))) (VALUE FALSE-WRAPPER)
         (POSITION I))
        (CL:DECLARE (CL:TYPE CL:SIMPLE-VECTOR SELF) (CL:TYPE CL:FIXNUM POSITION))
        (CL:SETF (CL:AREF SELF POSITION) VALUE))))))
...
(CL:DECLAIM
 (CL:FTYPE (CL:FUNCTION (CL:T) CL:SIMPLE-STRING) TOKENIZER-BYTE-ARRAY-TO-STRING))
...
(CL:DEFUN ENSURE-TOKENIZER-BUFFER-SIZE (STATE CURRENTTOKENSTART REQUIREDSPACE)
  ...
  (CL:LET*
   ((SIZE (%BUFFER-SIZE STATE)) (NEWSIZE SIZE)
    (END (CL:THE CL:FIXNUM (CL:REM (CL:THE CL:FIXNUM (%END STATE)) SIZE)))
    (FREESPACE
    ...
    (CL:COND
     ...
     (CL:T
      ...
      (CL:LET*
       ...
       (CL:DECLARE (CL:TYPE CL:FIXNUM ITER-002 UPPER-BOUND-002 ITER-003 I J))
       (CL:LOOP WHILE (CL:<= ITER-002 UPPER-BOUND-002) DO
        (CL:PROGN (CL:SETQ I ITER-002) (CL:SETQ ITER-002 (CL:1+ ITER-002)))
        (CL:PROGN (CL:SETQ J ITER-003) (CL:SETQ ITER-003 (CL:1+ ITER-003)))
        (CL:LET
         ((BUFFER NEWBUFFER)
          (CH
           (CL:LET ((BUFFER BUFFER) (POSITION I))
...
(CL:DEFUN READ-INTO-TOKENIZER-BUFFER (STREAM STATE CURRENTTOKENSTART)
  ...
  (CL:LET*
   ((REQUIREDSPACE
     (CL:IF (CL:< (%BUFFER-SIZE STATE) *TOKENIZER-INITIAL-BUFFER-SIZE*) 1
      (CL:LET ((ARG *TOKENIZER-INITIAL-BUFFER-SIZE*) (COUNT 1))
       (CL:DECLARE (CL:TYPE CL:FIXNUM ARG COUNT))
       (CL:THE CL:FIXNUM (CL:ASH ARG (CL:THE CL:FIXNUM (CL:- COUNT)))))))
    (INPUTCHAR NULL-CHARACTER) (INPUTLINE STELLA::NULL-STRING) (EOF? FALSE))
   ...
   (CL:WHEN (CL:NOT (CL:EQ (%BUFFERING-SCHEME STREAM) KWD-READ-BLOCK))
    (CL:SETF (%TOKENIZER-STATE STREAM) NULL)
    (CL:LET* ((TEST-VALUE-000 (%BUFFERING-SCHEME STREAM)))
     (CL:COND
      ((CL:EQ TEST-VALUE-000 KWD-READ-LINE)
       (CL:MULTIPLE-VALUE-SETQ (INPUTLINE EOF?) (READ-LINE STREAM))
       (CL:WHEN (CL:EQ INPUTLINE STELLA::NULL-STRING) (CL:SETQ INPUTLINE ""))
       (CL:SETQ INPUTLINE (STRING-CONCATENATE INPUTLINE EOL-STRING)))
      ((CL:EQ TEST-VALUE-000 KWD-READ-CHARACTER)
       (CL:MULTIPLE-VALUE-SETQ (INPUTCHAR EOF?) (READ-CHARACTER STREAM))
       ...
       (CL:LOOP WHILE (CL:< INDEX-000 LENGTH-000) DO
        ...
        (CL:LET ((BUFFER BUFFER) (CH CH) (POSITION END))
         ...
         (CL:SETF
          (CL:SCHAR (CL:THE CL:SIMPLE-STRING BUFFER) (CL:THE CL:FIXNUM POSITION))
          (CL:THE CL:CHARACTER CH)))
        (CL:SETQ END (CL:1+ END)) (CL:WHEN (CL:= END SIZE) (CL:SETQ END 0)))))
     (CL:T
      (CL:SETQ END (BYTE-ARRAY-READ-SEQUENCE BUFFER NATIVESTREAM START END))))
    (CL:SETF (%END STATE) END)
    (CL:RETURN-FROM READ-INTO-TOKENIZER-BUFFER (CL:OR EOF? (CL:= START END))))))

;;; (DEFUN (READ-CHARACTER-FROM-TOKENIZER-BUFFER CHARACTER BOOLEAN) ...)

(CL:DEFUN READ-CHARACTER-FROM-TOKENIZER-BUFFER (STREAM)
  (CL:LET*
   ((STATE (%TOKENIZER-STATE STREAM)) (CURSOR (%CURSOR STATE)) (END (%END STATE))
    (SIZE (%BUFFER-SIZE STATE)) (ECHOSTREAM (%ECHO-STREAM STREAM))
    (CH NULL-CHARACTER))
   ...
   (CL:RETURN-FROM READ-CHARACTER-FROM-TOKENIZER-BUFFER (CL:VALUES CH FALSE))))
...
(CL:DEFCLASS TOKENIZER-TOKEN (STANDARD-OBJECT)
  ((TYPE :ALLOCATION :INSTANCE :ACCESSOR %TYPE)
   (CONTENT :TYPE CL:SIMPLE-STRING :INITFORM STELLA::NULL-STRING :ALLOCATION
    :INSTANCE :ACCESSOR %CONTENT)
   (NEXT :ALLOCATION :INSTANCE :ACCESSOR %NEXT)))

(CL:DEFUN NEW-TOKENIZER-TOKEN ()
  (CL:LET* ((SELF NULL))
   (CL:SETQ SELF (CL:MAKE-INSTANCE (CL:QUOTE TOKENIZER-TOKEN)))
   (CL:SETF (%NEXT SELF) NULL) (CL:SETF (%CONTENT SELF) STELLA::NULL-STRING)
...
(CL:DEFUN ACCESS-TOKENIZER-TOKEN-SLOT-VALUE (SELF SLOTNAME VALUE SETVALUE?)
  (CL:COND
   ((CL:EQ SLOTNAME SYM-READ-STELLA-TYPE)
    (CL:IF SETVALUE? (CL:SETF (%TYPE SELF) VALUE) (CL:SETQ VALUE (%TYPE SELF))))
   ...
   ((CL:EQ SLOTNAME SYM-READ-STELLA-NEXT)
    (CL:IF SETVALUE? (CL:SETF (%NEXT SELF) VALUE) (CL:SETQ VALUE (%NEXT SELF))))
   (CL:T
    (CL:LET* ((STREAM-000 (NEW-OUTPUT-STRING-STREAM)))
     (%%PRINT-STREAM (%NATIVE-STREAM STREAM-000) "`" SLOTNAME
      "' is not a valid case option")
...
(CL:DEFCLASS TOKENIZER-STREAM-STATE (STANDARD-OBJECT)
  ((BUFFER :ALLOCATION :INSTANCE :ACCESSOR %BUFFER)
   (BUFFER-SIZE :TYPE CL:FIXNUM :INITFORM NULL-INTEGER :ALLOCATION :INSTANCE
    :ACCESSOR %BUFFER-SIZE)
   (CURSOR :TYPE CL:FIXNUM :INITFORM NULL-INTEGER :ALLOCATION :INSTANCE :ACCESSOR
    %CURSOR)
   (END :TYPE CL:FIXNUM :INITFORM NULL-INTEGER :ALLOCATION :INSTANCE :ACCESSOR
    %END)
   (STATE :TYPE CL:FIXNUM :INITFORM NULL-INTEGER :ALLOCATION :INSTANCE :ACCESSOR
    %STATE)
      ...
      (LIST* SYM-READ-STELLA-LET
       (LIST* (LIST* SYM-READ-STELLA-TOK_TABLE_ TABLE NIL)
        (LIST* SYM-READ-STELLA-TOK_TRANSITIONS_
         (LIST* SYM-READ-STELLA-TRANSITIONS SYM-READ-STELLA-TOK_TABLE_ NIL) NIL)
        (LIST* SYM-READ-STELLA-TOK_STATENAMES_
         (LIST* SYM-READ-STELLA-THE-ARRAY
          (LIST* SYM-READ-STELLA-STATE-NAMES SYM-READ-STELLA-TOK_TABLE_ NIL) NIL)
         NIL)
         ...
         (CL:IF STRING?
          (LIST*
           (LIST* SYM-READ-STELLA-TOK_STREAMSTATE_
            SYM-READ-STELLA-TOKENIZER-STREAM-STATE SYM-READ-STELLA-NULL NIL)
           (LIST* SYM-READ-STELLA-TOK_BUFFER_
            (LIST* SYM-READ-STELLA-STRING-TO-TOKENIZER-BYTE-ARRAY INPUT NIL) NIL)
          ...
          (LIST*
           (LIST* SYM-READ-STELLA-TOK_INPUTSTREAM_ (SYS-TREE INPUTTREE INPUTTYPE)
            NIL)
           (LIST* SYM-READ-STELLA-TOK_ECHOSTREAM_
            (LIST* SYM-READ-STELLA-ECHO-STREAM SYM-READ-STELLA-TOK_INPUTSTREAM_
             NIL)
            NIL)
           (LIST* SYM-READ-STELLA-TOK_STREAMSTATE_
            (LIST* SYM-READ-STELLA-CHOOSE
             ...
             (LIST* SYM-READ-STELLA-SETF
              (LIST* SYM-READ-STELLA-TOKENIZER-STATE
               SYM-READ-STELLA-TOK_INPUTSTREAM_ NIL)
              (LIST* SYM-READ-STELLA-NEW SYM-READ-STELLA-TOKENIZER-STREAM-STATE
               NIL)
              NIL)
             (LIST* SYM-READ-STELLA-TOKENIZER-STATE
              SYM-READ-STELLA-TOK_INPUTSTREAM_ NIL)
            ...
            NIL)
           (LIST* SYM-READ-STELLA-TOK_BUFFER_
            (LIST* SYM-READ-STELLA-BUFFER SYM-READ-STELLA-TOK_STREAMSTATE_ NIL)
            NIL)
           (LIST* SYM-READ-STELLA-TOK_SIZE_
            (LIST* SYM-READ-STELLA-BUFFER-SIZE SYM-READ-STELLA-TOK_STREAMSTATE_
             NIL)
            NIL)
       ...
       (CONCATENATE
        (CL:IF STRING?
         (CONS
          (LIST* SYM-READ-STELLA-IGNORE SYM-READ-STELLA-TOK_STREAMSTATE_ NIL)
          NIL)
         NIL)
...
(CL:DECLAIM
 (CL:FTYPE
  (CL:FUNCTION (CL:T CL:FIXNUM CL:FIXNUM CL:FIXNUM CL:T) CL:SIMPLE-STRING)
        ...
        (LIST* SYM-READ-STELLA-COND
         ...
         (LIST*
          (LIST* SYM-READ-STELLA-NTH
           (LIST* SYM-READ-STELLA-LEGAL-EOF-STATES SYM-READ-STELLA-TOK_TABLE_
            NIL)
           SYM-READ-STELLA-TOK_STATE_ NIL)
         ...
         (LIST* SYM-READ-STELLA-OTHERWISE
          (LIST* SYM-READ-STELLA-SETQ SYM-READ-STELLA-TOK_STATE_ (WRAP-INTEGER 0)
           NIL)
          (LIST* SYM-READ-STELLA-SETQ SYM-READ-STELLA-TOK_NEXTSTATE_
           (WRAP-INTEGER -1) NIL)
          NIL)
         ...
         (LIST*
          ...
          (LIST* SYM-READ-STELLA-SETQ SYM-READ-STELLA-TOK_ENDOFTOKENS?_
           (LIST* SYM-READ-STELLA-READ-INTO-TOKENIZER-BUFFER
            SYM-READ-STELLA-TOK_INPUTSTREAM_ SYM-READ-STELLA-TOK_STREAMSTATE_
       ...
       (LIST* SYM-READ-STELLA-COND
        ...
        (LIST*
         ...
         (LIST* SYM-READ-STELLA-SETQ SYM-READ-STELLA-TOK_STATE_
          ...
          NIL)
         (LIST* SYM-READ-STELLA-++ SYM-READ-STELLA-TOK_CURSOR_ NIL) NIL)
        (LIST* SYM-READ-STELLA-OTHERWISE (CONS SYM-READ-STELLA-BREAK NIL) NIL)
        NIL)
       (CONCATENATE
        (CL:IF (CL:NOT (WITH-TOKENIZER-STRING-INPUT?))
         (CONS
          (LIST* SYM-READ-STELLA-WHEN
           (LIST* SYM-READ-STELLA-DEFINED? SYM-READ-STELLA-TOK_ECHOSTREAM_ NIL)
...
(CL:DEFUN UNESCAPE-TOKEN-STRING (TOKEN ESCAPECHAR UPCASE?)
  ...
  (CL:LET*
   ((NOFESCAPES 0) (CURSOR 0) (CURSOR2 0)
    (SIZE (CL:THE CL:FIXNUM (CL:LENGTH TOKEN))) (RESULT STELLA::NULL-STRING)
    (ESCAPE? FALSE))
...
(CL:DEFMETHOD NEXT? ((SELF STREAM-TOKENIZER))
  (CL:LET*
   ((TOK_TABLE_ (%TABLE SELF)) (TOK_TRANSITIONS_ (%TRANSITIONS TOK_TABLE_))
    (TOK_STATENAMES_ (%THE-ARRAY (%STATE-NAMES TOK_TABLE_))) (TOK_TOKENSTART_ -1)
    (TOK_ENDOFTOKENS?_ FALSE) (TOK_INPUTSTREAM_ (%STREAM SELF))
    (TOK_ECHOSTREAM_ (%ECHO-STREAM TOK_INPUTSTREAM_))
    (TOK_STREAMSTATE_
     (CL:IF (CL:EQ (%TOKENIZER-STATE TOK_INPUTSTREAM_) NULL)
      (CL:SETF (%TOKENIZER-STATE TOK_INPUTSTREAM_) (NEW-TOKENIZER-STREAM-STATE))
   ...
   (CL:IF TOK_ENDOFTOKENS?_ (CL:SETF (%VALUE SELF) NULL)
    (CL:LET* ((SELF-001 (NEW-TOKENIZER-TOKEN)))
     ...
     (CL:SETF (%CONTENT SELF-001)
      (GET-TOKEN-TEXT-INTERNAL TOK_BUFFER_ TOK_TOKENSTART_ TOK_CURSOR_ TOK_SIZE_
       FALSE))
...
(CL:DEFUN WITH-STELLA-TOKENIZER (INPUT BODY)
  (CL:RETURN-FROM WITH-STELLA-TOKENIZER
   (LIST* SYM-READ-STELLA-WITH-TOKENIZER SYM-READ-STELLA-*STELLA-TOKENIZER-TABLE*
    INPUT
    (CONS
     (LIST* SYM-READ-STELLA-LET
      (LIST*
       (LIST* SYM-READ-STELLA-TOK_STELLALOGICALSTATENAMES_
        ...
        NIL)
       (LIST* SYM-READ-STELLA-TOK_STELLALOGICALSTATENAME_ SYM-READ-STELLA-KEYWORD
  ...
  (CL:RETURN-FROM GET-NEXT-STELLA-TOKEN
   (LIST* SYM-READ-STELLA-PROGN
    ...
    (LIST* SYM-READ-STELLA-SETQ SYM-READ-STELLA-TOK_STELLALOGICALSTATENAME_
     (LIST* SYM-READ-STELLA-NTH SYM-READ-STELLA-TOK_STELLALOGICALSTATENAMES_
      SYM-READ-STELLA-TOK_STATE_ NIL)
     NIL)
    NIL)))
...
(CL:DEFUN NEW-STELLA-TOKEN ()
  (CL:LET* ((SELF NULL))
   ...
   (CL:SETF (%CONTENT SELF) STELLA::NULL-STRING) (CL:SETF (%TYPE SELF) NULL)
   (CL:SETF (%NEXT SELF) NULL) (CL:SETF (%ESCAPE-MODE SELF) NULL)
  ...
  (CL:LET*
   ...
   (CL:LET*
    ((TOK_TABLE_ *STELLA-TOKENIZER-TABLE*)
     ...
     (TOK_TOKENSTART_ -1) (TOK_ENDOFTOKENS?_ FALSE) (TOK_INPUTSTREAM_ STREAM)
     (TOK_ECHOSTREAM_ (%ECHO-STREAM TOK_INPUTSTREAM_))
     (TOK_STREAMSTATE_
      (CL:IF (CL:EQ (%TOKENIZER-STATE TOK_INPUTSTREAM_) NULL)
       (CL:SETF (%TOKENIZER-STATE TOK_INPUTSTREAM_) (NEW-TOKENIZER-STREAM-STATE))
    ...
    (CL:PROGN (CL:SETQ TOK_STATENAMES_ TOK_STATENAMES_)
     (CL:SETQ TOK_ENDOFTOKENS?_ TOK_ENDOFTOKENS?_))
    (CL:LET*
     ((TOK_STELLALOGICALSTATENAMES_ (%THE-ARRAY *STELLA-LOGICAL-STATE-NAMES*))
         ...
         (CL:LET* ((TEST-VALUE-000 (CL:AREF TOK_STATENAMES_ TOK_STATE_)))
          (CL:COND
           ...
           ((CL:EQ TEST-VALUE-000 KWD-READ-QUALIFIED-SYMBOL)
            (CL:LET*
             ((SEPARATORPOS
               (GET-QUALIFIED-SYMBOL-SEPARATOR-POSITION-INTERNAL TOK_BUFFER_
                TOK_TOKENSTART_ TOK_CURSOR_ TOK_SIZE_ KWD-READ-NONE)))
             (CL:DECLARE (CL:TYPE CL:FIXNUM SEPARATORPOS))
             (CL:SETF (%CONTENT TOKENCURSOR)
              (GET-TOKEN-TEXT-INTERNAL TOK_BUFFER_
               (CL:+ TOK_TOKENSTART_ (CL:1+ SEPARATORPOS)) TOK_CURSOR_ TOK_SIZE_
               UPCASE?))
             (CL:SETF (%MODULE TOKENCURSOR)
              (CL:IF (CL:= SEPARATORPOS 0) "ROOT-MODULE"
               (GET-TOKEN-TEXT-INTERNAL TOK_BUFFER_ TOK_TOKENSTART_
                (CL:IF (CL:< SEPARATORPOS 0) (CL:+ TOK_CURSOR_ SEPARATORPOS)
           ...
           ((CL:EQ TEST-VALUE-000 KWD-READ-QUALIFIED-FULLY-ESCAPED-SYMBOL)
            (CL:LET*
             ((SEPARATORPOS
               (GET-QUALIFIED-SYMBOL-SEPARATOR-POSITION-INTERNAL TOK_BUFFER_
                TOK_TOKENSTART_ TOK_CURSOR_ TOK_SIZE_ KWD-READ-FULLY-ESCAPED)))
             (CL:DECLARE (CL:TYPE CL:FIXNUM SEPARATORPOS))
             (CL:SETF (%CONTENT TOKENCURSOR)
              (UNESCAPE-TOKEN-STRING
               (GET-TOKEN-TEXT-INTERNAL TOK_BUFFER_
           ...
           ((CL:EQ TEST-VALUE-000 KWD-READ-QUALIFIED-ESCAPED-SYMBOL)
            (CL:LET*
             ((SEPARATORPOS
               (GET-QUALIFIED-SYMBOL-SEPARATOR-POSITION-INTERNAL TOK_BUFFER_
                TOK_TOKENSTART_ TOK_CURSOR_ TOK_SIZE_ KWD-READ-ESCAPED)))
             (CL:DECLARE (CL:TYPE CL:FIXNUM SEPARATORPOS))
             (CL:SETF (%CONTENT TOKENCURSOR)
              (UNESCAPE-TOKEN-STRING
               (GET-TOKEN-TEXT-INTERNAL TOK_BUFFER_
          ...
          (CL:COND
           ...
           ((CL:EQ TEST-VALUE-001 KWD-READ-QUALIFIED-SURROGATE)
            (CL:LET*
             ...
             (CL:SETF (%CONTENT TOKENCURSOR)
              (GET-TOKEN-TEXT-INTERNAL TOK_BUFFER_
               (CL:+ TOK_TOKENSTART_ (CL:+ SEPARATORPOS 2)) TOK_CURSOR_ TOK_SIZE_
               UPCASE?))
             (CL:SETF (%MODULE TOKENCURSOR)
              (CL:IF (CL:= SEPARATORPOS 0) "ROOT-MODULE"
               (GET-TOKEN-TEXT-INTERNAL TOK_BUFFER_ TOK_TOKENSTART_
           ...
           ((CL:EQ TEST-VALUE-001 KWD-READ-FULLY-ESCAPED-SURROGATE)
            (CL:SETF (%CONTENT TOKENCURSOR)
             (UNESCAPE-TOKEN-STRING
              (GET-TOKEN-TEXT-INTERNAL TOK_BUFFER_ (CL:+ TOK_TOKENSTART_ 2)
               TOK_CURSOR_ TOK_SIZE_ FALSE)
              #\\ FALSE))
            (CL:SETF (%ESCAPE-MODE TOKENCURSOR) KWD-READ-FULL)
            (CL:SETQ SKIPCLOSINGQUOTE? TRUE))
...
(CL:DEFUN STELLA-TOKEN-LIST-TO-S-EXPRESSION (TOKENLIST)
  (CL:LET*
   ((PARSEDTREE NULL) (PARSEDTREESTACK NIL) (PARSEDTOKEN NULL) (CONSCELL NULL)
    (TOKENTYPE NULL))
   (CL:LOOP
    (CL:TAGBODY (CL:SETQ TOKENTYPE (%LOGICAL-TOKEN-TYPE TOKENLIST))
     (CL:COND
      ...
      ((CL:EQ TOKENTYPE KWD-READ-CLOSE-PAREN)
       (CL:COND
        ((CL:EQ PARSEDTREESTACK NIL) (CL:SETQ PARSEDTREE (REVERSE PARSEDTREE))
         (CL:RETURN))
        (CL:T
         (CL:LET* ((PARENTTREE PARSEDTREESTACK))
          ...
          (CL:SETQ PARSEDTREE PARENTTREE) (CL:SETQ TOKENLIST (%NEXT TOKENLIST))
          (CL:GO :CONTINUE)))))
      ((CL:OR (CL:EQ TOKENTYPE KWD-READ-SYMBOL)
       ...
       (CL:LET*
        ...
        (CL:COND
         ((CL:EQ MODULE NULL)
          (CL:LET* ((STREAM-000 (NEW-OUTPUT-STRING-STREAM)))
           (%%PRINT-STREAM (%NATIVE-STREAM STREAM-000) "Module `" MODULENAME
            "' does not exist")
           (CL:ERROR (NEW-READ-EXCEPTION (THE-STRING-READER STREAM-000)))))
         ((CL:EQ TOKENTYPE KWD-READ-SURROGATE)
          (CL:SETQ PARSEDTOKEN (INTERN-SURROGATE-IN-MODULE NAME MODULE FALSE)))
         (CL:T
          (CL:SETQ PARSEDTOKEN
           (CL:IF
            (CL:AND *TRANSIENTOBJECTS?* (CL:EQ MODULENAME STELLA::NULL-STRING))
            (INTERN-TRANSIENT-SYMBOL NAME)
            (INTERN-SYMBOL-IN-MODULE NAME MODULE FALSE)))))))
      ((CL:EQ TOKENTYPE KWD-READ-KEYWORD)
       (CL:SETQ PARSEDTOKEN
        (INTERN-RIGID-SYMBOL-WRT-MODULE (%CONTENT TOKENLIST) NULL KEYWORD-SYM)))
      ...
      ((CL:EQ TOKENTYPE KWD-READ-CHARACTER)
       (CL:SETQ PARSEDTOKEN (CL:MAKE-INSTANCE (CL:QUOTE CHARACTER-WRAPPER)))
       (CL:SETF (%WRAPPER-VALUE PARSEDTOKEN)
      ...
      (CL:T
       (CL:LET* ((STREAM-001 (NEW-OUTPUT-STRING-STREAM)))
        (%%PRINT-STREAM (%NATIVE-STREAM STREAM-001) "Illegal read syntax: `"
         (%CONTENT TOKENLIST) "' of type `" TOKENTYPE "'")
  ...
  (CL:LET* ((QUOTESTRING (%CONTENT QUOTEDLIST)))
   ...
   (CL:LET* ((SELF-000 (NEW-STELLA-TOKEN)))
    ...
    (CL:LET* ((TOKEN SELF-000) (TOKENTYPE NULL) (BALANCE 0))
     ...
     (CL:SETF (%CONTENT QUOTEDLIST) "(") (CL:SETF (%NEXT QUOTEDLIST) TOKEN)
     ...
     (CL:LOOP (CL:SETQ TOKENTYPE (%LOGICAL-TOKEN-TYPE QUOTEDLIST))
      ...
      (CL:COND
       ((CL:EQ TOKENTYPE KWD-READ-OPEN-PAREN) (CL:SETQ BALANCE (CL:1+ BALANCE)))
       ((CL:EQ TOKENTYPE KWD-READ-CLOSE-PAREN) (CL:SETQ BALANCE (CL:1- BALANCE))
        (CL:COND ((CL:= BALANCE 0) (CL:RETURN))
         ((CL:< BALANCE 0)
          (CL:LET* ((STREAM-000 (NEW-OUTPUT-STRING-STREAM)))
           (%%PRINT-STREAM (%NATIVE-STREAM STREAM-000) "Illegal `" QUOTESTRING
            "' syntax")
           (CL:ERROR (NEW-READ-EXCEPTION (THE-STRING-READER STREAM-000)))))))
  ...
  (CL:LET*
   ...
   (CL:WHEN (CL:> (CL:THE CL:FIXNUM (CL:LENGTH NAME)) 1)
    (CL:COND ((STRING-EQL? NAME "SPACE") (CL:SETQ CHAR #\ ))
     ...
     ((STRING-EQL? NAME "NULL") (CL:SETQ CHAR #\ ))
     (CL:T
      (CL:LET* ((STREAM-000 (NEW-OUTPUT-STRING-STREAM)))
...
the result.  Return `true' as the second value on EOF."
  (CL:LET*
   ((TOKENIZERSTATE (%TOKENIZER-STATE STREAM))
    (TOKENLIST
     (CL:IF (CL:NOT (CL:EQ TOKENIZERSTATE NULL)) (%TOKEN-LIST TOKENIZERSTATE)
      NULL)))
   (CL:COND
...
(CL:DEFUN EAT-NEXT-CHARACTER-IF-WHITESPACE (STREAM)
  (CL:LET* ((CHAR NULL-CHARACTER) (EOF? FALSE))
   ...
   (CL:COND
    ((CL:EQ
      (CL:AREF *CHARACTER-TYPE-TABLE* (CL:THE CL:FIXNUM (CL:CHAR-CODE CHAR)))
...
Return `true' as the second value on EOF."
  (CL:WHEN (CL:NOT (CL:EQ (%TOKENIZER-STATE INPUTSTREAM) NULL))
   (CL:RETURN-FROM READ-LINE (READ-LINE-FROM-TOKENIZER-BUFFER INPUTSTREAM)))
  (CL:LET*
   ((STREAM (%NATIVE-STREAM INPUTSTREAM)) (ECHOSTREAM (%ECHO-STREAM INPUTSTREAM))
   ...
   (CL:RETURN-FROM READ-LINE (CL:VALUES INPUT (CL:EQ INPUT STELLA::NULL-STRING)))))
(CL:DECLAIM
 (CL:FTYPE (CL:FUNCTION (CL:T) (CL:VALUES CL:SIMPLE-STRING CL:T)) READ-LINE))
...
Return `true' as the second value on EOF."
  ...
  (CL:LET*
   ((STREAM (%NATIVE-STREAM INPUTSTREAM)) (ECHOSTREAM (%ECHO-STREAM INPUTSTREAM))
    (INPUT NULL-CHARACTER) (EOF FALSE))
...
the input is read.  See also special variable `*USER-QUERY-ACTION*'."
  ...
  (CL:COND
   ((CL:EQ *USER-QUERY-ACTION* KWD-READ-YES) (CL:RETURN-FROM YES-OR-NO? TRUE))
   ((CL:EQ *USER-QUERY-ACTION* KWD-READ-NO) (CL:RETURN-FROM YES-OR-NO? FALSE))
   ((CL:EQ *USER-QUERY-ACTION* KWD-READ-YES-VERBOSE)
    (%%PRINT-STREAM (%NATIVE-STREAM STANDARD-OUTPUT) MESSAGE " [Auto => YES]"
     EOL)
    (CL:RETURN-FROM YES-OR-NO? TRUE))
   ((CL:EQ *USER-QUERY-ACTION* KWD-READ-NO-VERBOSE)
    (%%PRINT-STREAM (%NATIVE-STREAM STANDARD-OUTPUT) MESSAGE " [Auto => NO]" EOL)
    ...
    (CL:LET* ((INPUT STELLA::NULL-STRING) (START 0))
     ...
     (CL:LOOP
      ...
      (CL:WHEN (CL:> (CL:THE CL:FIXNUM (CL:LENGTH INPUT)) START)
       ...
       (CL:WHEN (STRING-EQUAL? INPUT "yes") (CL:RETURN-FROM YES-OR-NO? TRUE))
       (CL:WHEN (STRING-EQUAL? INPUT "no") (CL:RETURN-FROM YES-OR-NO? FALSE))
...
the input is read.  See also special variable `*USER-QUERY-ACTION*'."
  ...
  (CL:CHECK-TYPE MESSAGE CL:SIMPLE-STRING)
  (CL:COND
   ((CL:EQ *USER-QUERY-ACTION* KWD-READ-YES) (CL:RETURN-FROM Y-OR-N? TRUE))
   ((CL:EQ *USER-QUERY-ACTION* KWD-READ-NO) (CL:RETURN-FROM Y-OR-N? FALSE))
   ((CL:EQ *USER-QUERY-ACTION* KWD-READ-YES-VERBOSE)
    (%%PRINT-STREAM (%NATIVE-STREAM STANDARD-OUTPUT) MESSAGE " [Auto => Y]" EOL)
    (CL:RETURN-FROM Y-OR-N? TRUE))
   ((CL:EQ *USER-QUERY-ACTION* KWD-READ-NO-VERBOSE)
    (%%PRINT-STREAM (%NATIVE-STREAM STANDARD-OUTPUT) MESSAGE " [Auto => N]" EOL)
...
(CL:DEFUN HELP-STARTUP-READ3 ()
  (CL:PROGN
   ...
   (CL:SETQ KWD-READ-QUALIFIED-FULLY-ESCAPED-SYMBOL-ESCAPE
    (INTERN-RIGID-SYMBOL-WRT-MODULE "QUALIFIED-FULLY-ESCAPED-SYMBOL-ESCAPE" NULL
     2))
   (CL:SETQ KWD-READ-QUALIFIED-FULLY-ESCAPED-SURROGATE-ESCAPE
    (INTERN-RIGID-SYMBOL-WRT-MODULE "QUALIFIED-FULLY-ESCAPED-SURROGATE-ESCAPE"
     NULL 2))
...
(CL:DEFUN HELP-STARTUP-READ6 ()
  (CL:PROGN
   ...
   (DEFINE-FUNCTION-OBJECT "BYTE-ARRAY-WRITE-SEQUENCE"
    "(DEFUN BYTE-ARRAY-WRITE-SEQUENCE ((BUFFER TOKENIZER-BYTE-ARRAY) (STREAM NATIVE-OUTPUT-STREAM) (START INTEGER) (END INTEGER)))"
   ...
   (DEFINE-METHOD-OBJECT "(DEFMETHOD (NEXT? BOOLEAN) ((SELF STREAM-TOKENIZER)))"
...
return the result.\" :PUBLIC? TRUE)" (CL:FUNCTION READ-S-EXPRESSION-FROM-STRING)
    NULL)
...
was not the last character read.\" :PUBLIC? TRUE)" (CL:FUNCTION UNREAD-CHARACTER)
    NULL)
...
the input is read.  See also special variable `*USER-QUERY-ACTION*'.\" :PUBLIC? TRUE)"
   ...
   (DEFINE-FUNCTION-OBJECT "STARTUP-READ" "(DEFUN STARTUP-READ () :PUBLIC? TRUE)"
    (CL:FUNCTION STARTUP-READ) NULL)
   (CL:LET* ((FUNCTION (LOOKUP-FUNCTION SYM-READ-STELLA-STARTUP-READ)))
    (SET-DYNAMIC-SLOT-VALUE (%DYNAMIC-SLOTS FUNCTION)
     SYM-READ-STELLA-METHOD-STARTUP-CLASSNAME (WRAP-STRING "_Startup-Read")
     NULL-STRING-WRAPPER)))
  :VOID)
  ...
  (CL:LET* ((*MODULE* *STELLA-MODULE*) (*CONTEXT* *MODULE*))
   ...
   (CL:WHEN (CURRENT-STARTUP-TIME-PHASE? 4)
    (CL:SETQ *STELLA-TOKENIZER-TABLE-DEFINITION*
     (LIST*
      (LIST* KWD-READ-START KWD-READ-INCLUDE KWD-READ-DELIMITER KWD-READ-INCLUDE
       KWD-READ-ATOM NIL)
      (LIST* KWD-READ-DELIMITER SYM-READ-STELLA-* (WRAP-STRING "(")
       ...
       (WRAP-STRING "`") KWD-READ-BACK-QUOTE SYM-READ-STELLA-* (WRAP-STRING ",")
       KWD-READ-COMMA SYM-READ-STELLA-! (WRAP-STRING ";") KWD-READ-COMMENT
       SYM-READ-STELLA-! (WRAP-STRING "#") KWD-READ-HASH SYM-READ-STELLA-!
      ...
      (LIST* KWD-READ-PAREN-COMMENT (WRAP-STRING "\\")
       KWD-READ-PAREN-COMMENT-ESCAPE (WRAP-STRING "|") KWD-READ-PAREN-COMMENT-BAR
       KWD-READ-OTHERWISE KWD-READ-PAREN-COMMENT NIL)
      (LIST* KWD-READ-PAREN-COMMENT-ESCAPE KWD-READ-ANY KWD-READ-PAREN-COMMENT
       NIL)
      ...
      (LIST* KWD-READ-COMMA (WRAP-STRING ".") KWD-READ-COMMA-SPLICE
       KWD-READ-INCLUDE KWD-READ-DELIMITER SYM-READ-STELLA-* (WRAP-STRING "-+")
       (LIST* KWD-READ-SYMBOL-OR-SIGNED-NUMBER KWD-READ-SYMBOL NIL)
       SYM-READ-STELLA-* (WRAP-STRING "0123456789")
       (LIST* KWD-READ-SYMBOL-OR-NUMBER KWD-READ-INTEGER NIL) SYM-READ-STELLA-*
       (WRAP-STRING "cC")
       (LIST* KWD-READ-SYMBOL-OR-CL-SYMBOL KWD-READ-SYMBOL NIL) SYM-READ-STELLA-*
       (WRAP-STRING "|")
       (LIST* KWD-READ-OPEN-FULLY-ESCAPED-SYMBOL KWD-READ-FULLY-ESCAPED-SYMBOL
        NIL)
       ...
       (WRAP-STRING "@") (LIST* KWD-READ-OPEN-SURROGATE KWD-READ-SURROGATE NIL)
      ...
      (LIST* KWD-READ-ATOM SYM-READ-STELLA-* (WRAP-STRING "-+")
       ...
       SYM-READ-STELLA-* (WRAP-STRING "0123456789")
       (LIST* KWD-READ-SYMBOL-OR-NUMBER KWD-READ-INTEGER NIL) SYM-READ-STELLA-*
       (WRAP-STRING ".") (LIST* KWD-READ-SYMBOL-OR-MANTISSA KWD-READ-SYMBOL NIL)
       ...
       (WRAP-STRING "@") (LIST* KWD-READ-OPEN-SURROGATE KWD-READ-SURROGATE NIL)
       SYM-READ-STELLA-* KWD-READ-OTHERWISE KWD-READ-SYMBOL NIL)
      (LIST* KWD-READ-SYMBOL-OR-SIGNED-NUMBER KWD-READ-INCLUDE KWD-READ-DELIMITER
       ...
       (LIST* KWD-READ-SYMBOL-OR-MANTISSA KWD-READ-SYMBOL NIL) (WRAP-STRING "|")
       KWD-READ-ERROR KWD-READ-OTHERWISE KWD-READ-SYMBOL NIL)
      ...
      (LIST* KWD-READ-SYMBOL-OR-MANTISSA KWD-READ-INCLUDE KWD-READ-DELIMITER
       (WRAP-STRING "/") KWD-READ-QUALIFIED-NAME (WRAP-STRING "\\")
       KWD-READ-ESCAPED-SYMBOL-ESCAPE (WRAP-STRING "0123456789")
       (LIST* KWD-READ-SYMBOL-OR-MANTISSA2 KWD-READ-FLOAT NIL) (WRAP-STRING "eE")
       (LIST* KWD-READ-SYMBOL-OR-EXPONENT-DELIMITER KWD-READ-SYMBOL NIL)
      ...
      (LIST* KWD-READ-SYMBOL-OR-EXPONENT-DELIMITER KWD-READ-INCLUDE
       ...
       (LIST* KWD-READ-SYMBOL-OR-EXPONENT2 KWD-READ-FLOAT NIL) (WRAP-STRING "|")
       KWD-READ-ERROR KWD-READ-OTHERWISE KWD-READ-SYMBOL NIL)
      (LIST* KWD-READ-SYMBOL-OR-EXPONENT KWD-READ-INCLUDE KWD-READ-DELIMITER
       (WRAP-STRING "/") KWD-READ-QUALIFIED-NAME (WRAP-STRING "\\")
       KWD-READ-ESCAPED-SYMBOL-ESCAPE (WRAP-STRING "0123456789")
       (LIST* KWD-READ-SYMBOL-OR-EXPONENT2 KWD-READ-FLOAT NIL) (WRAP-STRING "|")
       KWD-READ-ERROR KWD-READ-OTHERWISE KWD-READ-SYMBOL NIL)
      ...
      (LIST* KWD-READ-SYMBOL-OR-CL-SYMBOL KWD-READ-INCLUDE KWD-READ-DELIMITER
       (WRAP-STRING "/") KWD-READ-QUALIFIED-NAME (WRAP-STRING "\\")
       KWD-READ-ESCAPED-SYMBOL-ESCAPE (WRAP-STRING "lL")
       (LIST* KWD-READ-SYMBOL-OR-CL-SYMBOL2 KWD-READ-SYMBOL NIL)
       (WRAP-STRING "|") KWD-READ-ERROR KWD-READ-OTHERWISE KWD-READ-SYMBOL NIL)
      (LIST* KWD-READ-SYMBOL-OR-CL-SYMBOL2 KWD-READ-INCLUDE KWD-READ-DELIMITER
       (WRAP-STRING "/") KWD-READ-QUALIFIED-NAME (WRAP-STRING "\\")
       KWD-READ-ESCAPED-SYMBOL-ESCAPE (WRAP-STRING ":")
       (LIST* KWD-READ-SYMBOL-OR-CL-SYMBOL3 KWD-READ-SYMBOL NIL)
       (WRAP-STRING "|") KWD-READ-ERROR KWD-READ-OTHERWISE KWD-READ-SYMBOL NIL)
      (LIST* KWD-READ-SYMBOL-OR-CL-SYMBOL3 KWD-READ-INCLUDE KWD-READ-DELIMITER
       (WRAP-STRING "|") KWD-READ-ERROR KWD-READ-OTHERWISE KWD-READ-CL-SYMBOL
       NIL)
      (LIST* KWD-READ-CL-SYMBOL KWD-READ-INCLUDE KWD-READ-DELIMITER
       (WRAP-STRING "|") KWD-READ-ERROR KWD-READ-OTHERWISE KWD-READ-CL-SYMBOL
       NIL)
      (LIST* KWD-READ-ESCAPED-SYMBOL-ESCAPE KWD-READ-ANY KWD-READ-ESCAPED-SYMBOL
       NIL)
      (LIST* KWD-READ-ESCAPED-SYMBOL KWD-READ-INCLUDE KWD-READ-DELIMITER
       (WRAP-STRING "/|") KWD-READ-ERROR (WRAP-STRING "\\")
       KWD-READ-ESCAPED-SYMBOL-ESCAPE KWD-READ-OTHERWISE KWD-READ-ESCAPED-SYMBOL
       NIL)
      (LIST* KWD-READ-OPEN-FULLY-ESCAPED-SYMBOL SYM-READ-STELLA-*
       (WRAP-STRING "|") KWD-READ-CLOSE-FULLY-ESCAPED-NAME (WRAP-STRING "\\")
       KWD-READ-FULLY-ESCAPED-SYMBOL-ESCAPE KWD-READ-OTHERWISE
       KWD-READ-FULLY-ESCAPED-SYMBOL NIL)
      (LIST* KWD-READ-FULLY-ESCAPED-SYMBOL-ESCAPE KWD-READ-ANY
       KWD-READ-FULLY-ESCAPED-SYMBOL NIL)
      (LIST* KWD-READ-FULLY-ESCAPED-SYMBOL SYM-READ-STELLA-* (WRAP-STRING "|")
       KWD-READ-CLOSE-FULLY-ESCAPED-NAME (WRAP-STRING "\\")
       KWD-READ-FULLY-ESCAPED-SYMBOL-ESCAPE KWD-READ-OTHERWISE
       KWD-READ-FULLY-ESCAPED-SYMBOL NIL)
      (LIST* KWD-READ-CLOSE-FULLY-ESCAPED-NAME KWD-READ-INCLUDE KWD-READ-START
       NIL)
      ...
      (LIST* KWD-READ-OPEN-KEYWORD KWD-READ-INCLUDE KWD-READ-DELIMITER
       ...
       KWD-READ-ESCAPED-KEYWORD-ESCAPE KWD-READ-OTHERWISE KWD-READ-KEYWORD NIL)
      ...
      (LIST* KWD-READ-FULLY-ESCAPED-KEYWORD SYM-READ-STELLA-* (WRAP-STRING "|")
       KWD-READ-CLOSE-FULLY-ESCAPED-NAME (WRAP-STRING "\\")
       KWD-READ-FULLY-ESCAPED-KEYWORD-ESCAPE KWD-READ-OTHERWISE
      ...
      (LIST* KWD-READ-OPEN-SURROGATE KWD-READ-INCLUDE KWD-READ-DELIMITER
       (WRAP-STRING "|") KWD-READ-FULLY-ESCAPED-SURROGATE (WRAP-STRING "\\")
       KWD-READ-ESCAPED-SURROGATE-ESCAPE KWD-READ-OTHERWISE KWD-READ-SURROGATE
       NIL)
      ...
      (LIST* KWD-READ-ESCAPED-SURROGATE-ESCAPE KWD-READ-ANY
       KWD-READ-ESCAPED-SURROGATE NIL)
      (LIST* KWD-READ-FULLY-ESCAPED-SURROGATE SYM-READ-STELLA-* (WRAP-STRING "|")
       KWD-READ-CLOSE-FULLY-ESCAPED-NAME (WRAP-STRING "\\")
       KWD-READ-FULLY-ESCAPED-SURROGATE-ESCAPE KWD-READ-OTHERWISE
      ...
      (LIST* KWD-READ-QUALIFIED-NAME KWD-READ-INCLUDE KWD-READ-DELIMITER
       ...
       KWD-READ-ERROR (WRAP-STRING "\\") KWD-READ-QUALIFIED-ESCAPED-SYMBOL-ESCAPE
       (WRAP-STRING "|") KWD-READ-QUALIFIED-FULLY-ESCAPED-SYMBOL
       (WRAP-STRING "/") KWD-READ-QUALIFIED-NAME KWD-READ-OTHERWISE
       KWD-READ-QUALIFIED-SYMBOL NIL)
      (LIST* KWD-READ-QUALIFIED-SYMBOL KWD-READ-INCLUDE KWD-READ-DELIMITER
       (WRAP-STRING "/") KWD-READ-QUALIFIED-NAME (WRAP-STRING "\\")
       KWD-READ-QUALIFIED-ESCAPED-SYMBOL-ESCAPE (WRAP-STRING "|") KWD-READ-ERROR
       KWD-READ-OTHERWISE KWD-READ-QUALIFIED-SYMBOL NIL)
      (LIST* KWD-READ-QUALIFIED-SURROGATE KWD-READ-INCLUDE KWD-READ-DELIMITER
       (WRAP-STRING "/") KWD-READ-ERROR (WRAP-STRING "\\")
       KWD-READ-QUALIFIED-ESCAPED-SURROGATE-ESCAPE (WRAP-STRING "|")
       KWD-READ-QUALIFIED-FULLY-ESCAPED-SURROGATE KWD-READ-OTHERWISE
       KWD-READ-QUALIFIED-SURROGATE NIL)
      (LIST* KWD-READ-QUALIFIED-ESCAPED-SYMBOL KWD-READ-INCLUDE
       KWD-READ-DELIMITER (WRAP-STRING "/|") KWD-READ-ERROR (WRAP-STRING "\\")
       KWD-READ-QUALIFIED-ESCAPED-SYMBOL-ESCAPE KWD-READ-OTHERWISE
      ...
      (LIST* KWD-READ-QUALIFIED-ESCAPED-SURROGATE KWD-READ-INCLUDE
       KWD-READ-DELIMITER (WRAP-STRING "/|") KWD-READ-ERROR (WRAP-STRING "\\")
       KWD-READ-QUALIFIED-ESCAPED-SURROGATE-ESCAPE KWD-READ-OTHERWISE
      ...
      (LIST* KWD-READ-QUALIFIED-FULLY-ESCAPED-SYMBOL SYM-READ-STELLA-*
       (WRAP-STRING "|") KWD-READ-CLOSE-FULLY-ESCAPED-NAME (WRAP-STRING "\\")
       KWD-READ-QUALIFIED-FULLY-ESCAPED-SYMBOL-ESCAPE KWD-READ-OTHERWISE
      ...
      (LIST* KWD-READ-QUALIFIED-FULLY-ESCAPED-SURROGATE SYM-READ-STELLA-*
       (WRAP-STRING "|") KWD-READ-CLOSE-FULLY-ESCAPED-NAME (WRAP-STRING "\\")
       KWD-READ-QUALIFIED-FULLY-ESCAPED-SURROGATE-ESCAPE KWD-READ-OTHERWISE
    ...
    (CL:LET* ((SELF-049 (NEW-PROPERTY-LIST)))
     (CL:SETF (%THE-PLIST SELF-049)
      (LIST* KWD-READ-SYMBOL KWD-READ-SYMBOL KWD-READ-ESCAPED-SYMBOL
       ...
       KWD-READ-QUALIFIED-FULLY-ESCAPED-SYMBOL KWD-READ-SYMBOL KWD-READ-CL-SYMBOL
       KWD-READ-SYMBOL KWD-READ-SURROGATE KWD-READ-SURROGATE
       KWD-READ-ESCAPED-SURROGATE KWD-READ-SURROGATE KWD-READ-QUALIFIED-SURROGATE
       KWD-READ-SURROGATE KWD-READ-QUALIFIED-ESCAPED-SURROGATE KWD-READ-SURROGATE
       ...
       KWD-READ-STRING KWD-READ-ESCAPED-STRING KWD-READ-STRING KWD-READ-INTEGER
       KWD-READ-INTEGER KWD-READ-FLOAT KWD-READ-FLOAT KWD-READ-CHARACTER
       KWD-READ-CHARACTER KWD-READ-OPEN-PAREN KWD-READ-OPEN-PAREN
       KWD-READ-CLOSE-PAREN KWD-READ-CLOSE-PAREN KWD-READ-SINGLE-QUOTE
       KWD-READ-SINGLE-QUOTE KWD-READ-BACK-QUOTE KWD-READ-BACK-QUOTE
       KWD-READ-COMMA KWD-READ-COMMA KWD-READ-COMMA-SPLICE KWD-READ-COMMA-SPLICE
       KWD-READ-CLOSE-STRING KWD-READ-CLOSE-BALANCED-QUOTE
       KWD-READ-CLOSE-FULLY-ESCAPED-NAME KWD-READ-CLOSE-BALANCED-QUOTE
       KWD-READ-ERROR KWD-READ-ERROR NIL))
     (CL:SETQ *STELLA-LOGICAL-STATE-NAMES-TABLE* SELF-049))
    (CL:SETQ *STELLA-LOGICAL-STATE-NAMES*
     (NEW-VECTOR (LENGTH (%STATE-NAMES *STELLA-TOKENIZER-TABLE*))))
    (CL:LET*
     ((I NULL-INTEGER) (ITER-051 0)
      (UPPER-BOUND-052 (CL:1- (LENGTH *STELLA-LOGICAL-STATE-NAMES*))))
     (CL:DECLARE (CL:TYPE CL:FIXNUM ITER-051 UPPER-BOUND-052 I))
     (CL:LOOP WHILE (CL:<= ITER-051 UPPER-BOUND-052) DO
      (CL:PROGN (CL:SETQ I ITER-051) (CL:SETQ ITER-051 (CL:1+ ITER-051)))
      (CL:LET
      ...
      (CL:WHEN
       (CL:EQ
        (CL:AREF
         (CL:THE CL:SIMPLE-VECTOR (%THE-ARRAY *STELLA-LOGICAL-STATE-NAMES*)) I)
        NULL)
       (CL:LET
        ((SELF (%THE-ARRAY *STELLA-LOGICAL-STATE-NAMES*)) (VALUE KWD-READ-ERROR)
         (POSITION I))
        (CL:DECLARE (CL:TYPE CL:SIMPLE-VECTOR SELF) (CL:TYPE CL:FIXNUM POSITION))
        (CL:SETF (CL:AREF SELF POSITION) VALUE)))))
   ...
   (CL:WHEN (CURRENT-STARTUP-TIME-PHASE? 5) (HELP-STARTUP-READ5))
   (CL:WHEN (CURRENT-STARTUP-TIME-PHASE? 6) (FINALIZE-CLASSES))
   (CL:WHEN (CURRENT-STARTUP-TIME-PHASE? 7) (HELP-STARTUP-READ6))
