...
(CL:DECLAIM
 (CL:SPECIAL *STELLA-MODULE* STANDARD-OUTPUT STANDARD-INPUT *MEMOIZATION-ENABLED?* MEMOIZED-NULL-VALUE
  *CHARACTER-TYPE-TABLE* *TRANSIENTOBJECTS?* KEYWORD-SYM *MODULE* MOST-POSITIVE-LONG-INTEGER NULL-LONG-INTEGER
  MOST-POSITIVE-INTEGER MOST-NEGATIVE-INTEGER MODULE-SEPARATOR-CHARACTER *CHARACTER-UPCASE-TABLE* ZERO-WRAPPER
...
(CL:DEFCLASS TOKENIZER-TABLE (STANDARD-OBJECT)
  ((TRANSITIONS :TYPE CL:SIMPLE-STRING :INITFORM STELLA::NULL-STRING :ALLOCATION :INSTANCE :ACCESSOR %TRANSITIONS)
   (UNIQUE-STATE-NAMES :ALLOCATION :INSTANCE :ACCESSOR %UNIQUE-STATE-NAMES)
...
(CL:DEFUN NEW-TOKENIZER-TABLE ()
  (CL:LET* ((SELF NULL)) (CL:SETQ SELF (CL:MAKE-INSTANCE (CL:QUOTE TOKENIZER-TABLE)))
   (CL:SETF (%LEGAL-EOF-STATES SELF) NULL) (CL:SETF (%STATE-NAMES SELF) NULL) (CL:SETF (%UNIQUE-STATE-NAMES SELF) NULL)
   (CL:SETF (%TRANSITIONS SELF) STELLA::NULL-STRING) (CL:RETURN-FROM NEW-TOKENIZER-TABLE SELF)))
...
(CL:DEFUN ACCESS-TOKENIZER-TABLE-SLOT-VALUE (SELF SLOTNAME VALUE SETVALUE?)
  (CL:COND
   ((CL:EQ SLOTNAME SYM-READ-STELLA-TRANSITIONS)
    (CL:IF SETVALUE? (CL:SETF (%TRANSITIONS SELF) (%WRAPPER-VALUE VALUE))
     (CL:SETQ VALUE (WRAP-STRING (%TRANSITIONS SELF)))))
   ((CL:EQ SLOTNAME SYM-READ-STELLA-UNIQUE-STATE-NAMES)
    (CL:IF SETVALUE? (CL:SETF (%UNIQUE-STATE-NAMES SELF) VALUE) (CL:SETQ VALUE (%UNIQUE-STATE-NAMES SELF))))
   ((CL:EQ SLOTNAME SYM-READ-STELLA-STATE-NAMES)
    (CL:IF SETVALUE? (CL:SETF (%STATE-NAMES SELF) VALUE) (CL:SETQ VALUE (%STATE-NAMES SELF))))
   ((CL:EQ SLOTNAME SYM-READ-STELLA-LEGAL-EOF-STATES)
    (CL:IF SETVALUE? (CL:SETF (%LEGAL-EOF-STATES SELF) VALUE) (CL:SETQ VALUE (%LEGAL-EOF-STATES SELF))))
   (CL:T
...
(CL:DEFUN PARSE-TOKENIZER-DEFINITION (DEFINITION)
  (CL:LET*
   ((TRANSITIONTABLE (NEW-VECTOR *MAX-TOKENIZER-STATES*))
    ...
    (UNIQUESTATENAMES (NEW-VECTOR *MAX-TOKENIZER-STATES*)) (STATENAMES (NEW-VECTOR *MAX-TOKENIZER-STATES*))
    (LEGALEOFSTATES (NEW-VECTOR *MAX-TOKENIZER-STATES*)) (FROMSTATENAME NULL) (FROMSTATEID NULL-INTEGER)
    (TOSTATENAME NULL) (TOSTATEALIAS NULL) (TOSTATEID NULL-INTEGER) (FREESTATEID 2) (CHARACTERSPEC NULL)
    (CHARACTERSET NULL) (ALLCHARACTERSETS (NEW-LIST)) (STATEMODIFIERS 0) (ERRORS? CL:NIL)
    (TABLE (NEW-TOKENIZER-TABLE)))
   (CL:DECLARE (CL:TYPE CL:SIMPLE-STRING TRANSITIONS)
    (CL:TYPE CL:FIXNUM FROMSTATEID TOSTATEID FREESTATEID STATEMODIFIERS))
   (CL:LET ((SELF (%THE-ARRAY UNIQUESTATENAMES)) (VALUE KWD-READ-ERROR) (POSITION 0))
    (CL:DECLARE (CL:TYPE CL:SIMPLE-VECTOR SELF) (CL:TYPE CL:FIXNUM POSITION)) (CL:SETF (CL:AREF SELF POSITION) VALUE))
   (CL:LET ((SELF (%THE-ARRAY STATENAMES)) (VALUE KWD-READ-ERROR) (POSITION 0))
    (CL:DECLARE (CL:TYPE CL:SIMPLE-VECTOR SELF) (CL:TYPE CL:FIXNUM POSITION)) (CL:SETF (CL:AREF SELF POSITION) VALUE))
   (CL:LET ((SELF (%THE-ARRAY UNIQUESTATENAMES)) (VALUE KWD-READ-START) (POSITION 1))
    (CL:DECLARE (CL:TYPE CL:SIMPLE-VECTOR SELF) (CL:TYPE CL:FIXNUM POSITION)) (CL:SETF (CL:AREF SELF POSITION) VALUE))
   (CL:LET ((SELF (%THE-ARRAY STATENAMES)) (VALUE KWD-READ-START) (POSITION 1))
    (CL:DECLARE (CL:TYPE CL:SIMPLE-VECTOR SELF) (CL:TYPE CL:FIXNUM POSITION)) (CL:SETF (CL:AREF SELF POSITION) VALUE))
   (CL:LET* ((STATEDEFINITION NULL) (ITER-000 DEFINITION))
    (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-000 NIL)) DO (CL:SETQ STATEDEFINITION (%%VALUE ITER-000))
     (CL:TAGBODY
      (CL:WHEN (CL:NOT (LEGAL-TOKENIZER-FROM-STATE? (%%VALUE STATEDEFINITION)))
       (CL:WARN "Illegal from state: `~A'" (%%VALUE STATEDEFINITION)) (CL:SETQ ERRORS? CL:T) (CL:GO :CONTINUE))
      ...
      (CL:WHEN (CL:= FROMSTATEID NULL-INTEGER)
       (CL:WHEN (CL:= FREESTATEID *MAX-TOKENIZER-STATES*)
        (CL:WARN "Too many tokenizer states; maximum is `~A'" *MAX-TOKENIZER-STATES*) (CL:SETQ ERRORS? CL:T)
        (CL:RETURN))
       ...
       (CL:LET ((SELF (%THE-ARRAY STATENAMES)) (VALUE FROMSTATENAME) (POSITION FREESTATEID))
        (CL:DECLARE (CL:TYPE CL:SIMPLE-VECTOR SELF) (CL:TYPE CL:FIXNUM POSITION))
        (CL:SETF (CL:AREF SELF POSITION) VALUE))
       (CL:SETQ FROMSTATEID FREESTATEID) (CL:SETQ FREESTATEID (CL:1+ FREESTATEID)))
      (CLEAR ALLCHARACTERSETS)
      (CL:LET* ((I NULL-INTEGER) (ITER-001 0) (UPPER-BOUND-000 (CL:1- *MAX-TOKENIZER-CHARACTERS*)))
      ...
      (CL:LOOP WHILE (CL:NOT (CL:EQ STATEDEFINITION NIL)) DO
       (CL:TAGBODY
        (CL:WHEN (TOKENIZER-INCLUDE-SPEC? (%%VALUE STATEDEFINITION))
         (CL:WHEN (CL:NOT (LEGAL-TOKENIZER-FROM-STATE? (%%VALUE (%%REST STATEDEFINITION))))
          (CL:WARN "Illegal include specification for state `~A'" FROMSTATENAME) (CL:SETQ ERRORS? CL:T) (CL:RETURN))
         ...
         (CL:LET* ((STATEDEF NULL) (ITER-002 DEFINITION))
          (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-002 NIL)) DO (CL:SETQ STATEDEF (%%VALUE ITER-002))
           (CL:WHEN (EQL? (%%VALUE STATEDEF) (%%VALUE (%%REST STATEDEFINITION)))
            (FIRST-SETTER STATEDEFINITION (%%VALUE (%%REST STATEDEF)))
            (CL:SETF (%%REST STATEDEFINITION)
             (CONCATENATE (COPY-CONS-LIST (%%REST (%%REST STATEDEF))) (%%REST (%%REST STATEDEFINITION))))
            (CL:RETURN))
           (CL:SETQ ITER-002 (%%REST ITER-002))))
         (CL:GO :CONTINUE))
        (CL:SETQ STATEMODIFIERS (PARSE-TOKENIZER-STATE-MODIFIERS (%%VALUE STATEDEFINITION)))
        (CL:WHEN (CL:> STATEMODIFIERS 0) (CL:SETQ STATEDEFINITION (%%REST STATEDEFINITION)))
        (CL:SETQ CHARACTERSPEC (%%VALUE STATEDEFINITION)) (CL:SETQ STATEDEFINITION (%%REST STATEDEFINITION))
        (CL:WHEN (CL:EQ CHARACTERSPEC NULL) (CL:WARN "Illegal definition of `~A' state" FROMSTATENAME)
         (CL:SETQ ERRORS? CL:T) (CL:RETURN))
        (CL:WHEN (CL:NOT (LEGAL-TOKENIZER-TO-STATE? (%%VALUE STATEDEFINITION)))
         (CL:WARN "Illegal to state `~A' for state `~A'" (%%VALUE STATEDEFINITION) FROMSTATENAME)
         (CL:SETQ ERRORS? CL:T) (CL:RETURN))
        ...
        (CL:SETQ TOSTATENAME (TOKENIZER-TO-STATE-NAME (%%VALUE STATEDEFINITION)))
        (CL:SETQ TOSTATEALIAS (TOKENIZER-TO-STATE-ALIAS (%%VALUE STATEDEFINITION)))
        ...
        (CL:WHEN (CL:= TOSTATEID NULL-INTEGER)
         ...
         (CL:LET ((SELF (%THE-ARRAY UNIQUESTATENAMES)) (VALUE TOSTATENAME) (POSITION FREESTATEID))
          (CL:DECLARE (CL:TYPE CL:SIMPLE-VECTOR SELF) (CL:TYPE CL:FIXNUM POSITION))
          (CL:SETF (CL:AREF SELF POSITION) VALUE))
         (CL:LET ((SELF (%THE-ARRAY STATENAMES)) (VALUE TOSTATEALIAS) (POSITION FREESTATEID))
          (CL:DECLARE (CL:TYPE CL:SIMPLE-VECTOR SELF) (CL:TYPE CL:FIXNUM POSITION))
          (CL:SETF (CL:AREF SELF POSITION) VALUE))
        ...
        (CL:WHEN
         ...
         (CL:WARN "Illegal redefinition of alias `~A' for state `~A' in state `~A'" TOSTATEALIAS TOSTATENAME
          FROMSTATENAME)
         (CL:SETQ ERRORS? CL:T))
        (CL:SETQ CHARACTERSET (PARSE-TOKENIZER-CHARACTER-SPEC CHARACTERSPEC ALLCHARACTERSETS))
        (CL:WHEN (CL:EQ CHARACTERSET NULL)
         (CL:WARN "Illegal character specification `~A' for state `~A'" CHARACTERSPEC FROMSTATENAME)
        ...
        (CL:LET* ((CHAR NULL) (ITER-003 CHARACTERSET))
         (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-003 NIL)) DO (CL:SETQ CHAR (%%VALUE ITER-003))
          (CL:LET
           ((SELF TRANSITIONS)
            (CH (CL:CODE-CHAR (CL:THE CL:FIXNUM (CL:LOGIOR (CL:THE CL:FIXNUM (CL:ASH STATEMODIFIERS 6)) TOSTATEID))))
      ...
      (CL:LET ((SELF (%THE-ARRAY TRANSITIONTABLE)) (VALUE (WRAP-MUTABLE-STRING TRANSITIONS)) (POSITION FROMSTATEID))
       ...
       (CL:SETF (CL:AREF SELF POSITION) VALUE))
      (CL:SETQ TRANSITIONS
       (CL:THE CL:SIMPLE-STRING (CL:MAKE-STRING *MAX-TOKENIZER-CHARACTERS* :INITIAL-ELEMENT NULL-CHARACTER)))
      :CONTINUE)
     (CL:SETQ ITER-000 (%%REST ITER-000))))
   (CL:LET* ((I NULL-INTEGER) (ITER-004 0) (UPPER-BOUND-001 (CL:1- FREESTATEID)))
    ...
    (CL:LOOP WHILE (CL:<= ITER-004 UPPER-BOUND-001) DO (CL:SETQ I ITER-004)
     (CL:WHEN (CL:EQ (CL:AREF (CL:THE CL:SIMPLE-VECTOR (%THE-ARRAY TRANSITIONTABLE)) I) NULL)
      (CL:WARN "State `~A' is undefined" (CL:AREF (CL:THE CL:SIMPLE-VECTOR (%THE-ARRAY UNIQUESTATENAMES)) I))
      (CL:SETQ ERRORS? CL:T))
     (CL:SETQ ITER-004 (CL:1+ ITER-004))))
   (CL:WHEN ERRORS? (CL:RETURN-FROM PARSE-TOKENIZER-DEFINITION NULL))
   (CL:SETQ TRANSITIONS
    (CL:THE CL:SIMPLE-STRING
     (CL:MAKE-STRING (CL:THE CL:FIXNUM (CL:* FREESTATEID *MAX-TOKENIZER-CHARACTERS*)) :INITIAL-ELEMENT
      NULL-CHARACTER)))
   (CL:LET* ((I NULL-INTEGER) (ITER-005 0) (UPPER-BOUND-002 (CL:1- FREESTATEID)))
    (CL:DECLARE (CL:TYPE CL:FIXNUM I ITER-005 UPPER-BOUND-002))
    (CL:LOOP WHILE (CL:<= ITER-005 UPPER-BOUND-002) DO (CL:SETQ I ITER-005)
     (CL:LET*
      ((J NULL-INTEGER) (ITER-006 0) (UPPER-BOUND-003 (CL:1- *MAX-TOKENIZER-CHARACTERS*)) (K NULL-INTEGER)
       (ITER-007 (CL:* *MAX-TOKENIZER-CHARACTERS* I)))
      ...
      (CL:LOOP WHILE (CL:<= ITER-006 UPPER-BOUND-003) DO (CL:SETQ J ITER-006) (CL:SETQ K ITER-007)
       (CL:LET
        ((SELF TRANSITIONS)
         (CH
          (CL:LET
           ((SELF (%WRAPPER-VALUE (CL:AREF (CL:THE CL:SIMPLE-VECTOR (%THE-ARRAY TRANSITIONTABLE)) I))) (POSITION J))
           (CL:DECLARE (CL:TYPE CL:SIMPLE-STRING SELF) (CL:TYPE CL:FIXNUM POSITION))
   ...
   (CL:SETF (%TRANSITIONS TABLE)
    (CL:LET ((S TRANSITIONS)) (CL:DECLARE (CL:TYPE CL:SIMPLE-STRING S)) (CL:THE CL:SIMPLE-STRING S)))
   (CL:SETF (%UNIQUE-STATE-NAMES TABLE) (NEW-VECTOR FREESTATEID))
   (CL:SETF (%STATE-NAMES TABLE) (NEW-VECTOR FREESTATEID))
   (CL:LET* ((I NULL-INTEGER) (ITER-008 0) (UPPER-BOUND-004 (CL:1- FREESTATEID)))
    ...
    (CL:LOOP WHILE (CL:<= ITER-008 UPPER-BOUND-004) DO (CL:SETQ I ITER-008)
     (CL:LET
      ((SELF (%THE-ARRAY (%UNIQUE-STATE-NAMES TABLE)))
       (VALUE (CL:AREF (CL:THE CL:SIMPLE-VECTOR (%THE-ARRAY UNIQUESTATENAMES)) I)) (POSITION I))
      (CL:DECLARE (CL:TYPE CL:SIMPLE-VECTOR SELF) (CL:TYPE CL:FIXNUM POSITION))
      (CL:SETF (CL:AREF SELF POSITION) VALUE))
     (CL:LET
      ((SELF (%THE-ARRAY (%STATE-NAMES TABLE))) (VALUE (CL:AREF (CL:THE CL:SIMPLE-VECTOR (%THE-ARRAY STATENAMES)) I))
       (POSITION I))
      (CL:DECLARE (CL:TYPE CL:SIMPLE-VECTOR SELF) (CL:TYPE CL:FIXNUM POSITION))
      (CL:SETF (CL:AREF SELF POSITION) VALUE))
     (CL:SETQ ITER-008 (CL:1+ ITER-008))))
   (CL:SETF (%LEGAL-EOF-STATES TABLE) (NEW-VECTOR FREESTATEID))
   (CL:LET* ((I NULL-INTEGER) (ITER-009 0) (UPPER-BOUND-005 (CL:1- FREESTATEID)))
...
(CL:DEFUN LEGAL-TOKENIZER-TO-STATE? (X)
  (CL:RETURN-FROM LEGAL-TOKENIZER-TO-STATE?
   (CL:OR (LEGAL-TOKENIZER-STATE? X)
    (CL:AND (CONS? X) (LEGAL-TOKENIZER-STATE? (%%VALUE X)) (LEGAL-TOKENIZER-STATE? (%%VALUE (%%REST X)))))))

;;; (DEFUN (TOKENIZER-TO-STATE-NAME GENERALIZED-SYMBOL) ...)

(CL:DEFUN TOKENIZER-TO-STATE-NAME (STATE)
  (CL:IF (CONS? STATE) (CL:RETURN-FROM TOKENIZER-TO-STATE-NAME (%%VALUE STATE))
...
(CL:DEFUN TOKENIZER-TO-STATE-ALIAS (STATE)
  (CL:IF (CONS? STATE) (CL:RETURN-FROM TOKENIZER-TO-STATE-ALIAS (%%VALUE (%%REST STATE)))
    ...
    (CL:PROGN
     (CL:LET* ((TEST-VALUE-000 (%SYMBOL-NAME MODIFIER))) (CL:DECLARE (CL:TYPE CL:SIMPLE-STRING TEST-VALUE-000))
      (CL:COND ((STRING-EQL? TEST-VALUE-000 "*") (CL:RETURN-FROM PARSE-TOKENIZER-STATE-MODIFIERS 2))
       ((CL:OR (STRING-EQL? TEST-VALUE-000 "!") (STRING-EQL? TEST-VALUE-000 "*!") (STRING-EQL? TEST-VALUE-000 "!*"))
...
(CL:DEFUN TOKENIZER-INCLUDE-SPEC? (X)
  (CL:RETURN-FROM TOKENIZER-INCLUDE-SPEC?
   (CL:AND (ISA? X SGT-READ-STELLA-GENERALIZED-SYMBOL) (STRING-EQL? (%SYMBOL-NAME X) "INCLUDE"))))
   ...
   (CL:LET* ((TEST-VALUE-001 (SAFE-PRIMARY-TYPE CHARACTERSPEC)))
    (CL:COND
     ((SUBTYPE-OF-STRING? TEST-VALUE-001)
      (CL:PROGN
       (CL:LET*
        ((CHAR NULL-CHARACTER) (VECTOR-000 (%WRAPPER-VALUE CHARACTERSPEC)) (INDEX-000 0)
         (LENGTH-000 (CL:THE CL:FIXNUM (CL:LENGTH VECTOR-000))) (COLLECT-000 NULL))
        ...
        (CL:LOOP WHILE (CL:< INDEX-000 LENGTH-000) DO
         ...
         (CL:IF (CL:EQ COLLECT-000 NULL)
          ...
          (CL:PROGN (CL:SETF (%%REST COLLECT-000) (CONS (WRAP-CHARACTER CHAR) NIL))
     ...
     ((CL:EQ TEST-VALUE-001 SGT-READ-STELLA-CONS)
      (CL:PROGN
       (CL:LET* ((SPEC NULL) (ITER-000 CHARACTERSPEC))
        (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-000 NIL)) DO (CL:SETQ SPEC (%%VALUE ITER-000))
         (CL:SETQ PARSEDSPEC (PARSE-TOKENIZER-CHARACTER-SPEC SPEC NIL-LIST))
       ...
       (CL:LET* ((TEST-VALUE-000 (%SYMBOL-NAME CHARACTERSPEC))) (CL:DECLARE (CL:TYPE CL:SIMPLE-STRING TEST-VALUE-000))
        (CL:COND
         ((STRING-EQL? TEST-VALUE-000 "ANY")
          (CL:LET*
           ((I NULL-INTEGER) (ITER-002 0) (UPPER-BOUND-000 (CL:1- *MAX-TOKENIZER-CHARACTERS*)) (COLLECT-002 NULL))
           ...
           (CL:LOOP WHILE (CL:<= ITER-002 UPPER-BOUND-000) DO (CL:SETQ I ITER-002)
            (CL:IF (CL:EQ COLLECT-002 NULL)
             ...
             (CL:PROGN (CL:SETF (%%REST COLLECT-002) (CONS (WRAP-CHARACTER (CL:CODE-CHAR I)) NIL))
         ...
         ((STRING-EQL? TEST-VALUE-000 "OTHERWISE")
          (CL:LET* ((SET NULL) (ITER-003 (%THE-CONS-LIST ALLCHARACTERSETS)))
           (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-003 NIL)) DO (CL:SETQ SET (%%VALUE ITER-003))
             ...
             (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-004 NIL)) DO (CL:SETQ CHAR (%%VALUE ITER-004))
              (CL:IF (CL:EQ COLLECT-003 NULL)
               (CL:PROGN (CL:SETQ COLLECT-003 (CONS CHAR NIL))
                (CL:IF (CL:EQ CHARSET NIL) (CL:SETQ CHARSET COLLECT-003)
            ...
            (CL:SETQ ITER-003 (%%REST ITER-003))))
          (CL:LET*
           ((I NULL-INTEGER) (ITER-005 0) (UPPER-BOUND-001 (CL:1- *MAX-TOKENIZER-CHARACTERS*)) (COLLECT-004 NULL))
            ...
            (CL:WHEN (CL:NOT (MEMBER? CHARSET (WRAP-CHARACTER (CL:CODE-CHAR I))))
             (CL:IF (CL:EQ COLLECT-004 NULL)
              (CL:PROGN (CL:SETQ COLLECT-004 (CONS (WRAP-CHARACTER (CL:CODE-CHAR I)) NIL))
               (CL:IF (CL:EQ COMPLEMENTSET NIL) (CL:SETQ COMPLEMENTSET COLLECT-004)
                (ADD-CONS-TO-END-OF-CONS-LIST COMPLEMENTSET COLLECT-004)))
              (CL:PROGN (CL:SETF (%%REST COLLECT-004) (CONS (WRAP-CHARACTER (CL:CODE-CHAR I)) NIL))
...
(CL:DEFUN STRINGIFY-TOKENIZER-TABLE (TABLE)
  (CL:LET*
   ((RESULT (NEW-OUTPUT-STRING-STREAM)) (ACODE (CL:THE CL:FIXNUM (CL:CHAR-CODE #\A)))
    (TRANSITIONS (%TRANSITIONS TABLE))
    (ENCODEDTRANSITIONS
     (CL:THE CL:SIMPLE-STRING
      (CL:MAKE-STRING (CL:THE CL:FIXNUM (CL:* 2 *MAX-TOKENIZER-STATES* *MAX-TOKENIZER-CHARACTERS*)) :INITIAL-ELEMENT
       NULL-CHARACTER)))
    (J -1) (UNIQUESTATENAMES (%UNIQUE-STATE-NAMES TABLE)) (STATENAMES (%STATE-NAMES TABLE))
   ...
   (CL:LET*
    ((I NULL-INTEGER) (ITER-000 0) (UPPER-BOUND-000 (CL:1- (CL:* *MAX-TOKENIZER-STATES* *MAX-TOKENIZER-CHARACTERS*))))
   ...
   (%%PRINT-STREAM (%NATIVE-STREAM RESULT)
    (CL:LET ((S ENCODEDTRANSITIONS)) (CL:DECLARE (CL:TYPE CL:SIMPLE-STRING S)) (CL:THE CL:SIMPLE-STRING S)) SEPARATOR)
   (%%PRINT-STREAM (%NATIVE-STREAM RESULT) (LENGTH UNIQUESTATENAMES) SEPARATOR)
   (CL:LET* ((STATE NULL) (VECTOR-000 UNIQUESTATENAMES) (INDEX-000 0) (LENGTH-000 (LENGTH VECTOR-000)))
    (CL:DECLARE (CL:TYPE CL:FIXNUM INDEX-000 LENGTH-000))
    (CL:LOOP WHILE (CL:< INDEX-000 LENGTH-000) DO
     (CL:SETQ STATE (CL:AREF (CL:THE CL:SIMPLE-VECTOR (%THE-ARRAY VECTOR-000)) INDEX-000))
   ...
   (CL:LET* ((STATE NULL) (VECTOR-001 STATENAMES) (INDEX-001 0) (LENGTH-001 (LENGTH VECTOR-001)))
    (CL:DECLARE (CL:TYPE CL:FIXNUM INDEX-001 LENGTH-001))
    (CL:LOOP WHILE (CL:< INDEX-001 LENGTH-001) DO
     (CL:SETQ STATE (CL:AREF (CL:THE CL:SIMPLE-VECTOR (%THE-ARRAY VECTOR-001)) INDEX-001))
   ...
   (CL:LET* ((STATE NULL) (VECTOR-002 EOFSTATES) (INDEX-002 0) (LENGTH-002 (LENGTH VECTOR-002)))
    (CL:DECLARE (CL:TYPE CL:FIXNUM INDEX-002 LENGTH-002))
    (CL:LOOP WHILE (CL:< INDEX-002 LENGTH-002) DO
     (CL:SETQ STATE (CL:AREF (CL:THE CL:SIMPLE-VECTOR (%THE-ARRAY VECTOR-002)) INDEX-002))
     (%%PRINT-STREAM (%NATIVE-STREAM RESULT) (CL:IF (COERCE-WRAPPED-BOOLEAN-TO-BOOLEAN STATE) "T" "F"))
     (CL:SETQ INDEX-002 (CL:1+ INDEX-002))))
   (%%PRINT-STREAM (%NATIVE-STREAM RESULT) SEPARATOR)
   (CL:RETURN-FROM STRINGIFY-TOKENIZER-TABLE (THE-STRING-READER RESULT))))
...
(CL:DEFUN UNSTRINGIFY-TOKENIZER-TABLE (TABLE)
  ...
  (CL:LET*
   ((RESULT (NEW-TOKENIZER-TABLE)) (ACODE (CL:THE CL:FIXNUM (CL:CHAR-CODE #\A))) (LINE STELLA::NULL-STRING) (COUNT 0)
    (TRANSITIONS STELLA::NULL-STRING) (SEPARATOR #\|) (START 0) (END 0))
   (CL:DECLARE (CL:TYPE CL:FIXNUM ACODE COUNT START END) (CL:TYPE CL:SIMPLE-STRING LINE TRANSITIONS))
   (CL:SETQ END (POSITION TABLE SEPARATOR START)) (CL:SETQ LINE (SUBSEQUENCE TABLE START END))
   (CL:SETQ START (CL:1+ END)) (CL:SETQ COUNT (CL:TRUNCATE (STRING-TO-INTEGER LINE)))
   (CL:SETQ END (POSITION TABLE SEPARATOR START)) (CL:SETQ LINE (SUBSEQUENCE TABLE START END))
   (CL:SETQ START (CL:1+ END))
   (CL:SETQ TRANSITIONS
    (CL:THE CL:SIMPLE-STRING
     (CL:MAKE-STRING (CL:THE CL:FIXNUM (CL:TRUNCATE (CL:/ COUNT 2.0d0))) :INITIAL-ELEMENT NULL-CHARACTER)))
   (CL:LET* ((I NULL-INTEGER) (ITER-000 0) (UPPER-BOUND-000 (CL:TRUNCATE (CL:1- (CL:/ COUNT 2.0d0)))))
    (CL:DECLARE (CL:TYPE CL:FIXNUM I ITER-000 UPPER-BOUND-000))
    (CL:LOOP WHILE (CL:<= ITER-000 UPPER-BOUND-000) DO (CL:SETQ I ITER-000)
     (CL:LET
      ((SELF TRANSITIONS)
   ...
   (CL:LET* ((I NULL-INTEGER) (ITER-001 0) (UPPER-BOUND-001 (CL:1- COUNT)))
   ...
   (CL:LET* ((I NULL-INTEGER) (ITER-002 0) (UPPER-BOUND-002 (CL:1- COUNT)))
   ...
   (CL:LET* ((I NULL-INTEGER) (ITER-003 0) (UPPER-BOUND-003 (CL:1- COUNT)))
...
(CL:DEFUN TOKENIZER-BYTE-ARRAY-READ-SEQUENCE (BUFFER STREAM START END)
  ...
  (CL:CHECK-TYPE END CL:FIXNUM)
  (CL:LET*
   ((STATE (%TOKENIZER-STATE STREAM)) (CURSOR (%CURSOR STATE)) (INTERNAL-END (%END STATE))
    (INTERNAL-SIZE (%BUFFER-SIZE STATE)) (ECHOSTREAM (%ECHO-STREAM STREAM)))
   (CL:DECLARE (CL:TYPE CL:FIXNUM CURSOR INTERNAL-END INTERNAL-SIZE))
   (CL:WHEN (CL:= CURSOR INTERNAL-END)
    (CL:WHEN (READ-INTO-TOKENIZER-BUFFER STREAM STATE -1) (CL:RETURN-FROM TOKENIZER-BYTE-ARRAY-READ-SEQUENCE 0))
    (CL:SETQ CURSOR (%CURSOR STATE)) (CL:SETQ INTERNAL-END (%END STATE))
    (CL:WHEN (CL:= CURSOR INTERNAL-SIZE) (CL:SETQ CURSOR 0)))
   (CL:LET*
    ((READ-SIZE (MIN (CL:- END START) (CL:- INTERNAL-END CURSOR))) (ORIGINAL-START START)
     (INTERNAL-BUFFER (%BUFFER STATE)))
    (CL:DECLARE (CL:TYPE CL:FIXNUM READ-SIZE ORIGINAL-START))
    (CL:LET*
     ((I NULL-INTEGER) (ITER-000 1) (UPPER-BOUND-000 READ-SIZE) (UNBOUNDED?-000 (CL:= UPPER-BOUND-000 NULL-INTEGER)))
     (CL:DECLARE (CL:TYPE CL:FIXNUM I ITER-000 UPPER-BOUND-000))
    ...
    (CL:WHEN (CL:NOT (CL:EQ ECHOSTREAM NULL))
     (BYTE-ARRAY-WRITE-SEQUENCE BUFFER (%NATIVE-STREAM ECHOSTREAM) ORIGINAL-START END))
    (CL:SETF (%CURSOR STATE) CURSOR) (CL:RETURN-FROM TOKENIZER-BYTE-ARRAY-READ-SEQUENCE READ-SIZE))))
...
indicated by the return value being equal to start."
  ...
  (CL:IF (CL:NOT (CL:EQ (%TOKENIZER-STATE STREAM) NULL))
   (CL:RETURN-FROM BYTE-ARRAY-READ-SEQUENCE (TOKENIZER-BYTE-ARRAY-READ-SEQUENCE BUFFER STREAM START END))
   ...
   ((SIZE (%BUFFER-SIZE STATE)) (NEWSIZE SIZE) (END (CL:THE CL:FIXNUM (CL:REM (CL:THE CL:FIXNUM (%END STATE)) SIZE)))
    (FREESPACE
     (CL:IF (CL:= CURRENTTOKENSTART -1) SIZE
      (CL:IF (CL:<= END CURRENTTOKENSTART) (CL:- CURRENTTOKENSTART END) (CL:+ CURRENTTOKENSTART (CL:- SIZE END)))))
    (BUFFER (%BUFFER STATE)) (NEWBUFFER BUFFER))
   (CL:DECLARE (CL:TYPE CL:FIXNUM SIZE NEWSIZE END FREESPACE))
   (CL:LOOP WHILE (CL:< FREESPACE REQUIREDSPACE) DO (CL:SETQ FREESPACE (CL:+ FREESPACE NEWSIZE))
   ...
   (CL:WHEN (CL:> NEWSIZE SIZE) (CL:SETQ NEWBUFFER (CL:MAKE-STRING NEWSIZE))
    (CL:COND ((CL:< CURRENTTOKENSTART 0) (CL:SETF (%CURSOR STATE) 0) (CL:SETF (%END STATE) NEWSIZE))
     ((CL:> END CURRENTTOKENSTART)
      (CL:LET* ((I NULL-INTEGER) (ITER-000 CURRENTTOKENSTART) (UPPER-BOUND-000 (CL:1- END)))
       (CL:DECLARE (CL:TYPE CL:FIXNUM I ITER-000 UPPER-BOUND-000))
       (CL:LOOP WHILE (CL:<= ITER-000 UPPER-BOUND-000) DO (CL:SETQ I ITER-000)
        (CL:LET
         ((BUFFER NEWBUFFER)
          (CH
           (CL:LET ((BUFFER BUFFER) (POSITION I)) (CL:DECLARE (CL:TYPE CL:FIXNUM POSITION))
            (CL:SCHAR (CL:THE CL:SIMPLE-STRING BUFFER) (CL:THE CL:FIXNUM POSITION))))
          (POSITION I))
         (CL:DECLARE (CL:TYPE CL:FIXNUM POSITION))
         (CL:SETF (CL:SCHAR (CL:THE CL:SIMPLE-STRING BUFFER) (CL:THE CL:FIXNUM POSITION)) (CL:THE CL:CHARACTER CH)))
        (CL:SETQ ITER-000 (CL:1+ ITER-000)))))
     (CL:T
      (CL:LET* ((I NULL-INTEGER) (ITER-001 CURRENTTOKENSTART) (UPPER-BOUND-001 (CL:1- SIZE)))
       (CL:DECLARE (CL:TYPE CL:FIXNUM I ITER-001 UPPER-BOUND-001))
       (CL:LOOP WHILE (CL:<= ITER-001 UPPER-BOUND-001) DO (CL:SETQ I ITER-001)
        (CL:LET
         ((BUFFER NEWBUFFER)
...
(CL:DEFUN READ-INTO-TOKENIZER-BUFFER (STREAM STATE CURRENTTOKENSTART)
  ...
  (CL:LET*
      ...
      (CL:LET* ((TEST-VALUE-000 (%BUFFERING-SCHEME STREAM)))
       (CL:COND
        ((CL:EQ TEST-VALUE-000 KWD-READ-LINE) (CL:SETQ INPUTLINE (NATIVE-READ-LINE STREAM))
         (CL:WHEN (CL:EQ INPUTLINE STELLA::NULL-STRING) (CL:SETQ INPUTLINE "") (CL:SETQ EOF? CL:T))
   ...
   (CL:LET*
    ((NATIVESTREAM (%NATIVE-STREAM STREAM)) (BUFFER (%BUFFER STATE)) (SIZE (%BUFFER-SIZE STATE)) (END (%END STATE))
     (START -1))
    ...
    (CL:COND ((CL:< CURRENTTOKENSTART 0) (CL:SETQ START 0) (CL:SETQ END SIZE) (CL:SETF (%CURSOR STATE) 0))
     ((CL:<= END CURRENTTOKENSTART) (CL:SETQ START END) (CL:SETQ END CURRENTTOKENSTART))
     ((CL:> END CURRENTTOKENSTART) (CL:SETQ START END) (CL:SETQ END SIZE)))
    (CL:COND
...
(CL:DEFUN READ-CHARACTER-FROM-TOKENIZER-BUFFER (STREAM)
  (CL:LET*
   ((STATE (%TOKENIZER-STATE STREAM)) (CURSOR (%CURSOR STATE)) (END (%END STATE)) (SIZE (%BUFFER-SIZE STATE))
   ...
   (CL:WHEN (CL:= CURSOR END)
    (CL:WHEN (READ-INTO-TOKENIZER-BUFFER STREAM STATE -1)
     (CL:RETURN-FROM READ-CHARACTER-FROM-TOKENIZER-BUFFER (CL:VALUES NULL-CHARACTER CL:T)))
   ...
   (CL:SETQ CH
    (CL:LET ((BUFFER (%BUFFER STATE)) (POSITION CURSOR)) (CL:DECLARE (CL:TYPE CL:FIXNUM POSITION))
     (CL:SCHAR (CL:THE CL:SIMPLE-STRING BUFFER) (CL:THE CL:FIXNUM POSITION))))
   (CL:WHEN (CL:NOT (CL:EQ ECHOSTREAM NULL)) (%%PRINT-STREAM (%NATIVE-STREAM ECHOSTREAM) CH))
   (CL:SETF (%CURSOR STATE) (CL:1+ CURSOR)) (CL:RETURN-FROM READ-CHARACTER-FROM-TOKENIZER-BUFFER (CL:VALUES CH CL:NIL))))
    ...
    (CL:NOT
     (CL:EQL CHAR
      (CL:LET ((BUFFER (%BUFFER STATE)) (POSITION CURSOR)) (CL:DECLARE (CL:TYPE CL:FIXNUM POSITION))
       (CL:SCHAR (CL:THE CL:SIMPLE-STRING BUFFER) (CL:THE CL:FIXNUM POSITION)))))
    (CL:LET* ((STREAM-000 (NEW-OUTPUT-STRING-STREAM)))
     (%%PRINT-STREAM (%NATIVE-STREAM STREAM-000) "Unread character `" CHAR "' does not match last character read")
     (CL:ERROR (NEW-STELLA-EXCEPTION (THE-STRING-READER STREAM-000)))))
...
(CL:DEFUN READ-LINE-FROM-TOKENIZER-BUFFER (STREAM)
  (CL:LET*
   ((BUFFER (NEW-OUTPUT-STRING-STREAM)) (LINE STELLA::NULL-STRING) (CH NULL-CHARACTER) (CH2 NULL-CHARACTER)
    (EOF? CL:NIL)
    (NEWLINE
   ...
   (CL:LOOP
    (CL:TAGBODY (CL:MULTIPLE-VALUE-SETQ (CH EOF?) (READ-CHARACTER-FROM-TOKENIZER-BUFFER STREAM))
     (CL:WHEN EOF? (CL:SETQ LINE (THE-STRING-READER BUFFER))
      (CL:IF (CL:= (CL:THE CL:FIXNUM (CL:LENGTH LINE)) 0) (CL:SETQ LINE STELLA::NULL-STRING) (CL:SETQ EOF? CL:NIL))
      (CL:RETURN))
     (CL:WHEN (CL:EQL CH NEWLINE)
      (CL:WHEN (CL:= (CL:THE CL:FIXNUM (CL:LENGTH EOL-STRING)) 2)
       (CL:MULTIPLE-VALUE-SETQ (CH2 EOF?) (READ-CHARACTER-FROM-TOKENIZER-BUFFER STREAM))
       (CL:WHEN EOF? (CL:SETQ LINE (THE-STRING-READER BUFFER))
        (CL:IF (CL:= (CL:THE CL:FIXNUM (CL:LENGTH LINE)) 0) (CL:SETQ LINE STELLA::NULL-STRING) (CL:SETQ EOF? CL:NIL))
        (CL:RETURN))
       (CL:WHEN
...
(CL:DEFCLASS TOKENIZER-TOKEN (STANDARD-OBJECT)
  ((TYPE :ALLOCATION :INSTANCE :ACCESSOR %TYPE)
   (CONTENT :TYPE CL:SIMPLE-STRING :INITFORM STELLA::NULL-STRING :ALLOCATION :INSTANCE :ACCESSOR %CONTENT)
   (NEXT :ALLOCATION :INSTANCE :ACCESSOR %NEXT)))

(CL:DEFUN NEW-TOKENIZER-TOKEN ()
  (CL:LET* ((SELF NULL)) (CL:SETQ SELF (CL:MAKE-INSTANCE (CL:QUOTE TOKENIZER-TOKEN))) (CL:SETF (%NEXT SELF) NULL)
   (CL:SETF (%CONTENT SELF) STELLA::NULL-STRING) (CL:SETF (%TYPE SELF) NULL) (CL:RETURN-FROM NEW-TOKENIZER-TOKEN SELF)))
...
(CL:DEFUN ACCESS-TOKENIZER-TOKEN-SLOT-VALUE (SELF SLOTNAME VALUE SETVALUE?)
  (CL:COND
   ((CL:EQ SLOTNAME SYM-READ-STELLA-TYPE) (CL:IF SETVALUE? (CL:SETF (%TYPE SELF) VALUE) (CL:SETQ VALUE (%TYPE SELF))))
   ((CL:EQ SLOTNAME SYM-READ-STELLA-CONTENT)
    (CL:IF SETVALUE? (CL:SETF (%CONTENT SELF) (%WRAPPER-VALUE VALUE)) (CL:SETQ VALUE (WRAP-STRING (%CONTENT SELF)))))
...
(CL:DEFCLASS TOKENIZER-STREAM-STATE (STANDARD-OBJECT)
  ((BUFFER :ALLOCATION :INSTANCE :ACCESSOR %BUFFER)
   (BUFFER-SIZE :TYPE CL:FIXNUM :INITFORM NULL-INTEGER :ALLOCATION :INSTANCE :ACCESSOR %BUFFER-SIZE)
   ...
   (STATE :TYPE CL:FIXNUM :INITFORM NULL-INTEGER :ALLOCATION :INSTANCE :ACCESSOR %STATE)
   (TABLE :ALLOCATION :INSTANCE :ACCESSOR %TABLE) (STATE-DICTIONARY :ALLOCATION :INSTANCE :ACCESSOR %STATE-DICTIONARY)
   (TOKEN-LIST :ALLOCATION :INSTANCE :ACCESSOR %TOKEN-LIST)))

(CL:DEFUN NEW-TOKENIZER-STREAM-STATE ()
  (CL:LET* ((SELF NULL)) (CL:SETQ SELF (CL:MAKE-INSTANCE (CL:QUOTE TOKENIZER-STREAM-STATE)))
   (CL:SETF (%TOKEN-LIST SELF) NULL) (CL:SETF (%STATE-DICTIONARY SELF) NULL) (CL:SETF (%TABLE SELF) NULL)
   (CL:SETF (%STATE SELF) 1) (CL:SETF (%END SELF) *TOKENIZER-INITIAL-BUFFER-SIZE*)
   (CL:SETF (%CURSOR SELF) *TOKENIZER-INITIAL-BUFFER-SIZE*)
   (CL:SETF (%BUFFER-SIZE SELF) *TOKENIZER-INITIAL-BUFFER-SIZE*)
   (CL:SETF (%BUFFER SELF) (CL:MAKE-STRING *TOKENIZER-INITIAL-BUFFER-SIZE*))
...
(CL:DEFUN ACCESS-TOKENIZER-STREAM-STATE-SLOT-VALUE (SELF SLOTNAME VALUE SETVALUE?)
  (CL:COND
   ((CL:EQ SLOTNAME SYM-READ-STELLA-BUFFER-SIZE)
    (CL:IF SETVALUE? (CL:SETF (%BUFFER-SIZE SELF) (%WRAPPER-VALUE VALUE))
   ...
   ((CL:EQ SLOTNAME SYM-READ-STELLA-STATE)
    (CL:IF SETVALUE? (CL:SETF (%STATE SELF) (%WRAPPER-VALUE VALUE)) (CL:SETQ VALUE (WRAP-INTEGER (%STATE SELF)))))
   ((CL:EQ SLOTNAME SYM-READ-STELLA-TABLE)
    (CL:IF SETVALUE? (CL:SETF (%TABLE SELF) VALUE) (CL:SETQ VALUE (%TABLE SELF))))
   ((CL:EQ SLOTNAME SYM-READ-STELLA-STATE-DICTIONARY)
    (CL:IF SETVALUE? (CL:SETF (%STATE-DICTIONARY SELF) VALUE) (CL:SETQ VALUE (%STATE-DICTIONARY SELF))))
   ((CL:EQ SLOTNAME SYM-READ-STELLA-TOKEN-LIST)
    (CL:IF SETVALUE? (CL:SETF (%TOKEN-LIST SELF) VALUE) (CL:SETQ VALUE (%TOKEN-LIST SELF))))
   (CL:T
    (CL:LET* ((STREAM-000 (NEW-OUTPUT-STRING-STREAM)))
     (%%PRINT-STREAM (%NATIVE-STREAM STREAM-000) "`" SLOTNAME "' is not a valid case option")
     (CL:ERROR (NEW-STELLA-EXCEPTION (THE-STRING-READER STREAM-000))))))
...
(CL:DEFMETHOD GET-SAVED-STATE ((STATE-OBJECT TOKENIZER-STREAM-STATE) TABLE)
  (CL:COND
   ((CL:EQ (%TABLE STATE-OBJECT) NULL) (CL:SETF (%TABLE STATE-OBJECT) TABLE)
   ...
   (CL:T
    ...
    (CL:LET* ((SAVED-STATE (LOOKUP (%STATE-DICTIONARY STATE-OBJECT) TABLE)))
     (CL:IF (CL:NOT (CL:EQ SAVED-STATE NULL)) (CL:RETURN-FROM GET-SAVED-STATE (%WRAPPER-VALUE SAVED-STATE))
   ...
   (CL:WHEN
    ...
    (CL:LET* ((*PRINTREADABLY?* CL:T)) (CL:DECLARE (CL:SPECIAL *PRINTREADABLY?*)) (SIGNAL-TRANSLATION-ERROR)
     (CL:WHEN (CL:NOT (SUPPRESS-WARNINGS?)) (PRINT-ERROR-CONTEXT ">> ERROR: " STANDARD-ERROR)
      (%%PRINT-STREAM (%NATIVE-STREAM STANDARD-ERROR) EOL " with-tokenizer: Can't handle input of type `"
      ...
      (LIST* SYM-READ-STELLA-LET
       (LIST* (LIST* SYM-READ-STELLA-TOK_TABLE_ TABLE NIL)
        ...
        (LIST* SYM-READ-STELLA-TOK_STATENAMES_
         (LIST* SYM-READ-STELLA-THE-ARRAY (LIST* SYM-READ-STELLA-STATE-NAMES SYM-READ-STELLA-TOK_TABLE_ NIL) NIL) NIL)
        (LIST* SYM-READ-STELLA-TOK_TOKENSTART_ (WRAP-INTEGER -1) NIL)
        (LIST* SYM-READ-STELLA-TOK_ENDOFTOKENS?_ SYM-READ-STELLA-FALSE NIL)
        (CONCATENATE
         (CL:IF STRING?
          (LIST*
           (LIST* SYM-READ-STELLA-TOK_STREAMSTATE_ SYM-READ-STELLA-TOKENIZER-STREAM-STATE SYM-READ-STELLA-NULL NIL)
           ...
           (LIST* SYM-READ-STELLA-TOK_SIZE_ (LIST* SYM-READ-STELLA-LENGTH INPUT NIL) NIL)
          ...
          (LIST* (LIST* SYM-READ-STELLA-TOK_INPUTSTREAM_ (SYS-TREE INPUTTREE INPUTTYPE) NIL)
           (LIST* SYM-READ-STELLA-TOK_ECHOSTREAM_
            (LIST* SYM-READ-STELLA-ECHO-STREAM SYM-READ-STELLA-TOK_INPUTSTREAM_ NIL) NIL)
           (LIST* SYM-READ-STELLA-TOK_STREAMSTATE_
            (LIST* SYM-READ-STELLA-CHOOSE
             (LIST* SYM-READ-STELLA-NULL? (LIST* SYM-READ-STELLA-TOKENIZER-STATE SYM-READ-STELLA-TOK_INPUTSTREAM_ NIL)
              NIL)
           ...
           (LIST* SYM-READ-STELLA-TOK_SIZE_ (LIST* SYM-READ-STELLA-BUFFER-SIZE SYM-READ-STELLA-TOK_STREAMSTATE_ NIL)
            NIL)
           (LIST* SYM-READ-STELLA-TOK_STATE_
            (LIST* SYM-READ-STELLA-GET-SAVED-STATE SYM-READ-STELLA-TOK_STREAMSTATE_ SYM-READ-STELLA-TOK_TABLE_ NIL)
            NIL)
           (LIST* SYM-READ-STELLA-TOK_NEXTSTATE_ SYM-READ-STELLA-TOK_STATE_ NIL)
           ...
           (LIST* SYM-READ-STELLA-TOK_CHECKPOINT_
            (LIST* SYM-READ-STELLA-CHOOSE
             (LIST* SYM-READ-STELLA-<= SYM-READ-STELLA-TOK_CURSOR_ SYM-READ-STELLA-TOK_END_ NIL)
       ...
       (CONCATENATE (CL:IF STRING? (CONS (LIST* SYM-READ-STELLA-IGNORE SYM-READ-STELLA-TOK_STREAMSTATE_ NIL) NIL) NIL)
   ...
   (CL:LET* ((*PRINTREADABLY?* CL:T)) (CL:DECLARE (CL:SPECIAL *PRINTREADABLY?*)) (SIGNAL-TRANSLATION-ERROR)
    (CL:WHEN (CL:NOT (SUPPRESS-WARNINGS?)) (PRINT-ERROR-CONTEXT ">> ERROR: " STANDARD-ERROR)
     (%%PRINT-STREAM (%NATIVE-STREAM STANDARD-ERROR) EOL
      " Encountered `end-of-tokens?' outside of `with-tokenizer' macro.." EOL)))
...
(CL:DEFUN GET-TOKEN-TEXT (OPTIONS)
  (CL:WHEN (CL:NOT (INSIDE-WITH-TOKENIZER?))
   (CL:LET* ((*PRINTREADABLY?* CL:T)) (CL:DECLARE (CL:SPECIAL *PRINTREADABLY?*)) (SIGNAL-TRANSLATION-ERROR)
    (CL:WHEN (CL:NOT (SUPPRESS-WARNINGS?)) (PRINT-ERROR-CONTEXT ">> ERROR: " STANDARD-ERROR)
     (%%PRINT-STREAM (%NATIVE-STREAM STANDARD-ERROR) EOL
      " Encountered `get-token-text' outside of `with-tokenizer' macro.." EOL)))
  ...
  (CL:LET* ((UPCASE? (%%VALUE OPTIONS)) (START (%%VALUE (%%REST OPTIONS))) (END (%%VALUE (%%REST (%%REST OPTIONS)))))
   (CL:WHEN (CL:EQ UPCASE? SYM-READ-STELLA-FALSE) (CL:SETQ UPCASE? NULL))
   ...
   (CL:RETURN-FROM GET-TOKEN-TEXT
    (LIST* SYM-READ-STELLA-GET-TOKEN-TEXT-INTERNAL SYM-READ-STELLA-TOK_BUFFER_
     (CL:IF (CL:EQ START NULL) SYM-READ-STELLA-TOK_TOKENSTART_
      (LIST* SYM-READ-STELLA-+ SYM-READ-STELLA-TOK_TOKENSTART_ START NIL))
     (CONS
      (CL:IF (CL:EQ END NULL) SYM-READ-STELLA-TOK_CURSOR_
       (CL:IF (INTEGER? END)
        ...
        (LIST* SYM-READ-STELLA-CHOOSE (LIST* SYM-READ-STELLA-< END (CONS (WRAP-INTEGER 0) NIL))
...
(CL:DEFUN GET-TOKEN-TYPE ()
  (CL:WHEN (CL:NOT (INSIDE-WITH-TOKENIZER?))
   (CL:LET* ((*PRINTREADABLY?* CL:T)) (CL:DECLARE (CL:SPECIAL *PRINTREADABLY?*)) (SIGNAL-TRANSLATION-ERROR)
    (CL:WHEN (CL:NOT (SUPPRESS-WARNINGS?)) (PRINT-ERROR-CONTEXT ">> ERROR: " STANDARD-ERROR)
     (%%PRINT-STREAM (%NATIVE-STREAM STANDARD-ERROR) EOL
      " Encountered `get-token-type' outside of `with-tokenizer' macro.." EOL)))
   (CL:RETURN-FROM GET-TOKEN-TYPE (CONS SYM-READ-STELLA-GET-TOKEN-TYPE NIL)))
  (CL:RETURN-FROM GET-TOKEN-TYPE
   (LIST* SYM-READ-STELLA-NTH SYM-READ-STELLA-TOK_STATENAMES_ SYM-READ-STELLA-TOK_STATE_ NIL)))
...
(CL:DEFUN SAVE-TOKENIZER-STREAM-STATE ()
  (CL:RETURN-FROM SAVE-TOKENIZER-STREAM-STATE
   (LIST* SYM-READ-STELLA-WHEN (LIST* SYM-READ-STELLA-DEFINED? SYM-READ-STELLA-TOK_STREAMSTATE_ NIL)
    (LIST* SYM-READ-STELLA-SETF (LIST* SYM-READ-STELLA-CURSOR SYM-READ-STELLA-TOK_STREAMSTATE_ NIL)
     SYM-READ-STELLA-TOK_CURSOR_ NIL)
    (LIST* SYM-READ-STELLA-SETF (LIST* SYM-READ-STELLA-TABLE SYM-READ-STELLA-TOK_STREAMSTATE_ NIL)
     SYM-READ-STELLA-TOK_TABLE_ NIL)
    (LIST* SYM-READ-STELLA-SETF (LIST* SYM-READ-STELLA-STATE SYM-READ-STELLA-TOK_STREAMSTATE_ NIL)
...
(CL:DEFUN GET-NEXT-TOKEN (OPTIONS)
  (CL:WHEN (CL:NOT (INSIDE-WITH-TOKENIZER?))
   (CL:LET* ((*PRINTREADABLY?* CL:T)) (CL:DECLARE (CL:SPECIAL *PRINTREADABLY?*)) (SIGNAL-TRANSLATION-ERROR)
    (CL:WHEN (CL:NOT (SUPPRESS-WARNINGS?)) (PRINT-ERROR-CONTEXT ">> ERROR: " STANDARD-ERROR)
     (%%PRINT-STREAM (%NATIVE-STREAM STANDARD-ERROR) EOL
      " Encountered `get-next-token' outside of `with-tokenizer' macro.." EOL)))
   (CL:RETURN-FROM GET-NEXT-TOKEN (CONS SYM-READ-STELLA-GET-NEXT-TOKEN NIL)))
  (CL:LET*
   ((SAVESTREAMSTATE? (%%VALUE OPTIONS))
    (SAVESTREAMSTATETREE (CONS (CONS SYM-READ-STELLA-SAVE-TOKENIZER-STREAM-STATE NIL) NIL)))
   (CL:COND ((CL:OR (CL:EQ SAVESTREAMSTATE? NULL) (CL:EQ SAVESTREAMSTATE? SYM-READ-STELLA-TRUE)))
    ...
    (CL:T
     (CL:SETQ SAVESTREAMSTATETREE
      (CONS (LIST* SYM-READ-STELLA-WHEN SAVESTREAMSTATE? (CONCATENATE SAVESTREAMSTATETREE NIL)) NIL))))
      ...
      (CL:IF (WITH-TOKENIZER-STRING-INPUT?)
       (LIST* SYM-READ-STELLA-WHEN (LIST* SYM-READ-STELLA-= SYM-READ-STELLA-TOK_CURSOR_ SYM-READ-STELLA-TOK_END_ NIL)
        (LIST* SYM-READ-STELLA-COND
         ...
         (LIST*
          (LIST* SYM-READ-STELLA-NTH (LIST* SYM-READ-STELLA-LEGAL-EOF-STATES SYM-READ-STELLA-TOK_TABLE_ NIL)
           SYM-READ-STELLA-TOK_STATE_ NIL)
       ...
       (LIST* SYM-READ-STELLA-WHEN
        (LIST* SYM-READ-STELLA-= SYM-READ-STELLA-TOK_CURSOR_ SYM-READ-STELLA-TOK_CHECKPOINT_ NIL)
        (LIST* SYM-READ-STELLA-COND
         (LIST* (LIST* SYM-READ-STELLA-= SYM-READ-STELLA-TOK_CURSOR_ SYM-READ-STELLA-TOK_END_ NIL)
          ...
          (LIST* SYM-READ-STELLA-SETQ SYM-READ-STELLA-TOK_ENDOFTOKENS?_
           (LIST* SYM-READ-STELLA-READ-INTO-TOKENIZER-BUFFER SYM-READ-STELLA-TOK_INPUTSTREAM_
            SYM-READ-STELLA-TOK_STREAMSTATE_ SYM-READ-STELLA-TOK_TOKENSTART_ NIL)
           NIL)
          (LIST* SYM-READ-STELLA-SETQ SYM-READ-STELLA-TOK_BUFFER_
           (LIST* SYM-READ-STELLA-BUFFER SYM-READ-STELLA-TOK_STREAMSTATE_ NIL) NIL)
          (LIST* SYM-READ-STELLA-SETQ SYM-READ-STELLA-TOK_SIZE_
           (LIST* SYM-READ-STELLA-BUFFER-SIZE SYM-READ-STELLA-TOK_STREAMSTATE_ NIL) NIL)
          (LIST* SYM-READ-STELLA-SETQ SYM-READ-STELLA-TOK_CURSOR_
           (LIST* SYM-READ-STELLA-MOD (LIST* SYM-READ-STELLA-CURSOR SYM-READ-STELLA-TOK_STREAMSTATE_ NIL)
            SYM-READ-STELLA-TOK_SIZE_ NIL)
           NIL)
          (LIST* SYM-READ-STELLA-SETQ SYM-READ-STELLA-TOK_END_
           (LIST* SYM-READ-STELLA-END SYM-READ-STELLA-TOK_STREAMSTATE_ NIL) NIL)
          (LIST* SYM-READ-STELLA-WHEN SYM-READ-STELLA-TOK_ENDOFTOKENS?_
           (LIST* SYM-READ-STELLA-SETQ SYM-READ-STELLA-TOK_CHECKPOINT_ SYM-READ-STELLA-TOK_CURSOR_ NIL)
           (LIST* SYM-READ-STELLA-COND
            (CONS (LIST* SYM-READ-STELLA-= SYM-READ-STELLA-TOK_NEXTSTATE_ (WRAP-INTEGER -1) NIL) NIL)
            (LIST*
             (LIST* SYM-READ-STELLA-NTH (LIST* SYM-READ-STELLA-LEGAL-EOF-STATES SYM-READ-STELLA-TOK_TABLE_ NIL)
              SYM-READ-STELLA-TOK_STATE_ NIL)
             (LIST* SYM-READ-STELLA-SETQ SYM-READ-STELLA-TOK_NEXTSTATE_ (WRAP-INTEGER -1) NIL)
             (LIST* SYM-READ-STELLA-UNLESS
              (LIST* SYM-READ-STELLA-= SYM-READ-STELLA-TOK_TOKENSTART_ (WRAP-INTEGER -1) NIL)
              (LIST* SYM-READ-STELLA-SETQ SYM-READ-STELLA-TOK_ENDOFTOKENS?_ SYM-READ-STELLA-FALSE NIL) NIL)
             NIL)
            (LIST* SYM-READ-STELLA-OTHERWISE
             (LIST* SYM-READ-STELLA-SETQ SYM-READ-STELLA-TOK_ENDOFTOKENS?_ SYM-READ-STELLA-FALSE NIL)
          ...
          NIL)
         (LIST* SYM-READ-STELLA-OTHERWISE
          (LIST* SYM-READ-STELLA-SETQ SYM-READ-STELLA-TOK_CHECKPOINT_ SYM-READ-STELLA-TOK_END_ NIL)
      ...
      (LIST*
       (LIST* SYM-READ-STELLA-SETQ SYM-READ-STELLA-TOK_NEXTSTATE_
        (LIST* SYM-READ-STELLA-CHARACTER-CODE
         (LIST* SYM-READ-STELLA-BYTE-ARRAY-NTH SYM-READ-STELLA-TOK_BUFFER_ SYM-READ-STELLA-TOK_CURSOR_ NIL) NIL)
        NIL)
        ...
        (LIST* SYM-READ-STELLA-CHARACTER-CODE
         (LIST* SYM-READ-STELLA-NTH SYM-READ-STELLA-TOK_TRANSITIONS_
          (LIST* SYM-READ-STELLA-LOGOR
           (LIST* SYM-READ-STELLA-SHIFT-LEFT SYM-READ-STELLA-TOK_STATE_ (WRAP-INTEGER 8) NIL)
       ...
       (LIST* SYM-READ-STELLA-COND
        (LIST*
         (LIST* SYM-READ-STELLA-= (LIST* SYM-READ-STELLA-LOGAND SYM-READ-STELLA-TOK_NEXTSTATE_ (WRAP-INTEGER 128) NIL)
          (WRAP-INTEGER 0) NIL)
         (LIST* SYM-READ-STELLA-SETQ SYM-READ-STELLA-TOK_STATE_ SYM-READ-STELLA-TOK_NEXTSTATE_ NIL)
        ...
        (LIST* (LIST* SYM-READ-STELLA-= SYM-READ-STELLA-TOK_TOKENSTART_ (WRAP-INTEGER -1) NIL)
         (LIST* SYM-READ-STELLA-WHEN
          (LIST* SYM-READ-STELLA-= (LIST* SYM-READ-STELLA-LOGAND SYM-READ-STELLA-TOK_NEXTSTATE_ (WRAP-INTEGER 64) NIL)
           (WRAP-INTEGER 0) NIL)
         ...
         (LIST* SYM-READ-STELLA-SETQ SYM-READ-STELLA-TOK_STATE_
          (LIST* SYM-READ-STELLA-LOGAND SYM-READ-STELLA-TOK_NEXTSTATE_ (WRAP-INTEGER 63) NIL) NIL)
         (LIST* SYM-READ-STELLA-++ SYM-READ-STELLA-TOK_CURSOR_ NIL) NIL)
         ...
         (CONS
          (LIST* SYM-READ-STELLA-WHEN (LIST* SYM-READ-STELLA-DEFINED? SYM-READ-STELLA-TOK_ECHOSTREAM_ NIL)
           (LIST* SYM-READ-STELLA-PRINT-STREAM SYM-READ-STELLA-TOK_ECHOSTREAM_
            (LIST* SYM-READ-STELLA-BYTE-ARRAY-NTH SYM-READ-STELLA-TOK_BUFFER_
             (LIST* SYM-READ-STELLA-1- SYM-READ-STELLA-TOK_CURSOR_ NIL) NIL)
            NIL)
           NIL)
          NIL)
         NIL)
...
(CL:DEFUN UNESCAPE-TOKEN-STRING (TOKEN ESCAPECHAR UPCASE?)
  ...
  (CL:LET*
   ((NOFESCAPES 0) (CURSOR 0) (CURSOR2 0) (SIZE (CL:THE CL:FIXNUM (CL:LENGTH TOKEN))) (RESULT STELLA::NULL-STRING)
    (ESCAPE? CL:NIL))
   ...
   (CL:WHEN (CL:= NOFESCAPES 0) (CL:RETURN-FROM UNESCAPE-TOKEN-STRING TOKEN))
   (CL:SETQ RESULT (MAKE-RAW-MUTABLE-STRING (CL:- SIZE NOFESCAPES))) (CL:SETQ CURSOR 0)
   (CL:LOOP WHILE (CL:< CURSOR SIZE) DO
    (CL:COND
     ((CL:AND
       (CL:EQL
...
(CL:DEFUN NEW-STREAM-TOKENIZER (STREAM TABLE)
  (CL:LET* ((SELF NULL)) (CL:SETQ SELF (CL:MAKE-INSTANCE (CL:QUOTE STREAM-TOKENIZER))) (CL:SETF (%STREAM SELF) STREAM)
   (CL:SETF (%TABLE SELF) TABLE) (CL:SETF (%FIRST-ITERATION? SELF) CL:T) (CL:SETF (%VALUE SELF) NULL)
...
(CL:DEFUN ACCESS-STREAM-TOKENIZER-SLOT-VALUE (SELF SLOTNAME VALUE SETVALUE?)
  (CL:COND
   ((CL:EQ SLOTNAME SYM-READ-STELLA-STREAM)
    (CL:IF SETVALUE? (CL:SETF (%STREAM SELF) VALUE) (CL:SETQ VALUE (%STREAM SELF))))
   ((CL:EQ SLOTNAME SYM-READ-STELLA-TABLE)
    (CL:IF SETVALUE? (CL:SETF (%TABLE SELF) VALUE) (CL:SETQ VALUE (%TABLE SELF))))
   (CL:T
    (CL:LET* ((STREAM-000 (NEW-OUTPUT-STRING-STREAM)))
...
(CL:DEFMETHOD NEXT? ((SELF STREAM-TOKENIZER))
  (CL:LET*
   ((TOK_TABLE_ (%TABLE SELF)) (TOK_TRANSITIONS_ (%TRANSITIONS TOK_TABLE_))
    (TOK_STATENAMES_ (%THE-ARRAY (%STATE-NAMES TOK_TABLE_))) (TOK_TOKENSTART_ -1) (TOK_ENDOFTOKENS?_ CL:NIL)
    (TOK_INPUTSTREAM_ (%STREAM SELF)) (TOK_ECHOSTREAM_ (%ECHO-STREAM TOK_INPUTSTREAM_))
    (TOK_STREAMSTATE_
     (CL:IF (CL:EQ (%TOKENIZER-STATE TOK_INPUTSTREAM_) NULL)
      (CL:SETF (%TOKENIZER-STATE TOK_INPUTSTREAM_) (NEW-TOKENIZER-STREAM-STATE)) (%TOKENIZER-STATE TOK_INPUTSTREAM_)))
    (TOK_BUFFER_ (%BUFFER TOK_STREAMSTATE_)) (TOK_SIZE_ (%BUFFER-SIZE TOK_STREAMSTATE_))
    (TOK_STATE_ (GET-SAVED-STATE TOK_STREAMSTATE_ TOK_TABLE_)) (TOK_NEXTSTATE_ TOK_STATE_)
    (TOK_CURSOR_ (%CURSOR TOK_STREAMSTATE_)) (TOK_END_ (%END TOK_STREAMSTATE_))
     ...
     (CL:WHEN (CL:= TOK_CURSOR_ TOK_CHECKPOINT_)
      (CL:COND
       ((CL:= TOK_CURSOR_ TOK_END_) (CL:SETF (%CURSOR TOK_STREAMSTATE_) TOK_CURSOR_)
        (CL:SETQ TOK_ENDOFTOKENS?_ (READ-INTO-TOKENIZER-BUFFER TOK_INPUTSTREAM_ TOK_STREAMSTATE_ TOK_TOKENSTART_))
        (CL:SETQ TOK_BUFFER_ (%BUFFER TOK_STREAMSTATE_)) (CL:SETQ TOK_SIZE_ (%BUFFER-SIZE TOK_STREAMSTATE_))
        (CL:SETQ TOK_CURSOR_ (MOD (%CURSOR TOK_STREAMSTATE_) TOK_SIZE_)) (CL:SETQ TOK_END_ (%END TOK_STREAMSTATE_))
        (CL:WHEN TOK_ENDOFTOKENS?_ (CL:SETQ TOK_CHECKPOINT_ TOK_CURSOR_)
         (CL:COND ((CL:= TOK_NEXTSTATE_ -1))
          ((COERCE-WRAPPED-BOOLEAN-TO-BOOLEAN
            (CL:AREF (CL:THE CL:SIMPLE-VECTOR (%THE-ARRAY (%LEGAL-EOF-STATES TOK_TABLE_))) TOK_STATE_))
       ...
       (CL:CHAR-CODE
        (CL:LET
         ((SELF TOK_TRANSITIONS_)
          (POSITION (CL:THE CL:FIXNUM (CL:LOGIOR (CL:THE CL:FIXNUM (CL:ASH TOK_STATE_ 8)) TOK_NEXTSTATE_))))
         (CL:DECLARE (CL:TYPE CL:SIMPLE-STRING SELF) (CL:TYPE CL:FIXNUM POSITION))
         (CL:SCHAR (CL:THE CL:SIMPLE-STRING SELF) (CL:THE CL:FIXNUM POSITION))))))
     (CL:COND
      ((CL:= (CL:THE CL:FIXNUM (CL:LOGAND TOK_NEXTSTATE_ 128)) 0) (CL:SETQ TOK_STATE_ TOK_NEXTSTATE_)
       (CL:SETQ TOK_CURSOR_ (CL:1+ TOK_CURSOR_)))
      ((CL:= TOK_TOKENSTART_ -1)
       (CL:WHEN (CL:= (CL:THE CL:FIXNUM (CL:LOGAND TOK_NEXTSTATE_ 64)) 0) (CL:SETQ TOK_TOKENSTART_ TOK_CURSOR_))
     ...
     (CL:WHEN (CL:NOT (CL:EQ TOK_ECHOSTREAM_ NULL))
      (%%PRINT-STREAM (%NATIVE-STREAM TOK_ECHOSTREAM_)
       (CL:LET ((BUFFER TOK_BUFFER_) (POSITION (CL:1- TOK_CURSOR_))) (CL:DECLARE (CL:TYPE CL:FIXNUM POSITION))
        (CL:SCHAR (CL:THE CL:SIMPLE-STRING BUFFER) (CL:THE CL:FIXNUM POSITION))))))
    (CL:WHEN (CL:NOT (CL:EQ TOK_STREAMSTATE_ NULL)) (CL:SETF (%CURSOR TOK_STREAMSTATE_) TOK_CURSOR_)
     (CL:SETF (%TABLE TOK_STREAMSTATE_) TOK_TABLE_) (CL:SETF (%STATE TOK_STREAMSTATE_) TOK_STATE_)))
   (CL:IF TOK_ENDOFTOKENS?_ (CL:SETF (%VALUE SELF) NULL)
    (CL:LET* ((SELF-001 (NEW-TOKENIZER-TOKEN))) (CL:SETF (%TYPE SELF-001) (CL:AREF TOK_STATENAMES_ TOK_STATE_))
     (CL:SETF (%CONTENT SELF-001) (GET-TOKEN-TEXT-INTERNAL TOK_BUFFER_ TOK_TOKENSTART_ TOK_CURSOR_ TOK_SIZE_ CL:NIL))
     ...
     (LIST* SYM-READ-STELLA-LET
      (LIST*
       (LIST* SYM-READ-STELLA-TOK_STELLALOGICALSTATENAMES_
        (LIST* SYM-READ-STELLA-THE-ARRAY SYM-READ-STELLA-*STELLA-LOGICAL-STATE-NAMES* NIL) NIL)
...
(CL:DEFUN GET-QUALIFIED-SYMBOL-SEPARATOR-POSITION (ESCAPEMODE)
  (CL:LET* ((ESCAPE (%%VALUE ESCAPEMODE))) (CL:WHEN (CL:EQ ESCAPE NULL) (CL:SETQ ESCAPE KWD-READ-NONE))
   (CL:RETURN-FROM GET-QUALIFIED-SYMBOL-SEPARATOR-POSITION
    (LIST* SYM-READ-STELLA-GET-QUALIFIED-SYMBOL-SEPARATOR-POSITION-INTERNAL SYM-READ-STELLA-TOK_BUFFER_
     SYM-READ-STELLA-TOK_TOKENSTART_ SYM-READ-STELLA-TOK_CURSOR_ SYM-READ-STELLA-TOK_SIZE_ ESCAPE NIL))))

;;; (DEFUN (GET-QUALIFIED-SYMBOL-SEPARATOR-POSITION-INTERNAL INTEGER) ...)

(CL:DECLAIM
 (CL:FTYPE (CL:FUNCTION (CL:T CL:FIXNUM CL:FIXNUM CL:FIXNUM CL:T) CL:FIXNUM)
  ...
  (CL:LET*
   ...
   (CL:LOOP
    (CL:LOOP WHILE (CL:>= CURSOR 0) DO
     (CL:COND
      ((CL:EQL
        (CL:LET ((BUFFER BUFFER) (POSITION CURSOR)) (CL:DECLARE (CL:TYPE CL:FIXNUM POSITION))
         (CL:SCHAR (CL:THE CL:SIMPLE-STRING BUFFER) (CL:THE CL:FIXNUM POSITION)))
        TARGETCHAR)
       (CL:SETQ SEPARATORPOSITION CURSOR) (CL:SETQ CURSOR (CL:1- CURSOR))
       (CL:WHEN (CL:< CURSOR 0) (CL:SETQ CURSOR (CL:1- SIZE))) (CL:SETQ NOFESCAPES 0)
       (CL:LOOP
        (CL:LOOP WHILE
         (CL:AND (CL:>= CURSOR 0)
          (CL:EQL
        ...
        (CL:IF
         (CL:AND (CL:< CURSOR 0)
          (CL:EQL
           (CL:LET ((BUFFER BUFFER) (POSITION 0)) (CL:DECLARE (CL:TYPE CL:FIXNUM POSITION))
            (CL:SCHAR (CL:THE CL:SIMPLE-STRING BUFFER) (CL:THE CL:FIXNUM POSITION)))
           #\\))
       ...
       (CL:WHEN (CL:LET ((X NOFESCAPES)) (CL:DECLARE (CL:TYPE CL:FIXNUM X)) (CL:NOT (CL:LOGBITP 0 X)))
        ...
        (CL:IF (CL:< SEPARATORPOSITION 0)
         (CL:RETURN-FROM GET-QUALIFIED-SYMBOL-SEPARATOR-POSITION-INTERNAL (CL:+ SEPARATORPOSITION SIZE))
...
This assumes correct signed integer syntax and only checks for overflows."
  (CL:WHEN (CL:NOT (INSIDE-WITH-TOKENIZER?))
   (CL:LET* ((*PRINTREADABLY?* CL:T)) (CL:DECLARE (CL:SPECIAL *PRINTREADABLY?*)) (SIGNAL-TRANSLATION-ERROR)
    (CL:WHEN (CL:NOT (SUPPRESS-WARNINGS?)) (PRINT-ERROR-CONTEXT ">> ERROR: " STANDARD-ERROR)
     (%%PRINT-STREAM (%NATIVE-STREAM STANDARD-ERROR) EOL
      " Encountered `get-token-integer' outside of `with-tokenizer' macro.." EOL)))
   (CL:RETURN-FROM GET-TOKEN-INTEGER (CONS SYM-READ-STELLA-GET-TOKEN-INTEGER NIL)))
  (CL:RETURN-FROM GET-TOKEN-INTEGER
   (LIST* SYM-READ-STELLA-GET-TOKEN-INTEGER-INTERNAL SYM-READ-STELLA-TOK_BUFFER_ SYM-READ-STELLA-TOK_TOKENSTART_
...
(CL:DEFUN GET-TOKEN-INTEGER-INTERNAL (BUFFER START END SIZE)
  ...
  (CL:LET* ((RESULT (GET-TOKEN-LONG-INTEGER-INTERNAL BUFFER START END SIZE)))
   (CL:WHEN (CL:OR (CL:> RESULT MOST-POSITIVE-INTEGER) (CL:< RESULT MOST-NEGATIVE-INTEGER))
    (CL:LET* ((STREAM-000 (NEW-OUTPUT-STRING-STREAM)))
     (%%PRINT-STREAM (%NATIVE-STREAM STREAM-000) "get-token-integer: integer overflow: `" RESULT "'")
     (CL:ERROR (NEW-STELLA-EXCEPTION (THE-STRING-READER STREAM-000)))))
...
This assumes correct signed long-integer syntax and only checks for overflows."
  (CL:WHEN (CL:NOT (INSIDE-WITH-TOKENIZER?))
   (CL:LET* ((*PRINTREADABLY?* CL:T)) (CL:DECLARE (CL:SPECIAL *PRINTREADABLY?*)) (SIGNAL-TRANSLATION-ERROR)
    (CL:WHEN (CL:NOT (SUPPRESS-WARNINGS?)) (PRINT-ERROR-CONTEXT ">> ERROR: " STANDARD-ERROR)
     (%%PRINT-STREAM (%NATIVE-STREAM STANDARD-ERROR) EOL
      " Encountered `get-token-long-integer' outside of `with-tokenizer' macro.." EOL)))
  ...
  (CL:RETURN-FROM GET-TOKEN-LONG-INTEGER
   (LIST* SYM-READ-STELLA-GET-TOKEN-LONG-INTEGER-INTERNAL SYM-READ-STELLA-TOK_BUFFER_ SYM-READ-STELLA-TOK_TOKENSTART_
    SYM-READ-STELLA-TOK_CURSOR_ SYM-READ-STELLA-TOK_SIZE_ NIL)))
...
(CL:DEFUN GET-TOKEN-LONG-INTEGER-INTERNAL (BUFFER START END SIZE)
  ...
  #+MCL
  (CL:CHECK-TYPE SIZE CL:FIXNUM)
  (CL:LET* ((LENGTH (CL:- END START)) (AUXEND END) (RESULT 0) (NEGATIVE? CL:NIL) (DIGIT 0))
   ...
   (CL:LOOP
    ...
    (CL:WHEN (CL:= AUXEND END) (CL:RETURN)) (CL:SETQ START 0) (CL:SETQ AUXEND END))
   (CL:IF NEGATIVE? (CL:RETURN-FROM GET-TOKEN-LONG-INTEGER-INTERNAL (CL:- 0 RESULT))
...
covering all special cases here; but we are fast :-)"
  (CL:WHEN (CL:NOT (INSIDE-WITH-TOKENIZER?))
   (CL:LET* ((*PRINTREADABLY?* CL:T)) (CL:DECLARE (CL:SPECIAL *PRINTREADABLY?*)) (SIGNAL-TRANSLATION-ERROR)
    (CL:WHEN (CL:NOT (SUPPRESS-WARNINGS?)) (PRINT-ERROR-CONTEXT ">> ERROR: " STANDARD-ERROR)
     (%%PRINT-STREAM (%NATIVE-STREAM STANDARD-ERROR) EOL
      " Encountered `get-token-float' outside of `with-tokenizer' macro.." EOL)))
   (CL:RETURN-FROM GET-TOKEN-FLOAT (CONS SYM-READ-STELLA-GET-TOKEN-FLOAT NIL)))
  (CL:RETURN-FROM GET-TOKEN-FLOAT
   (LIST* SYM-READ-STELLA-GET-TOKEN-FLOAT-INTERNAL SYM-READ-STELLA-TOK_BUFFER_ SYM-READ-STELLA-TOK_TOKENSTART_
    SYM-READ-STELLA-TOK_CURSOR_ SYM-READ-STELLA-TOK_SIZE_ NIL)))
...
(CL:DEFUN GET-TOKEN-FLOAT-INTERNAL (BUFFER START END SIZE)
  ...
  (CL:CHECK-TYPE SIZE CL:FIXNUM)
  (CL:LET*
   ((LENGTH (CL:- END START)) (AUXEND END) (MANTISSA 0) (EXPONENT 0) (MANTISSASIGN 1.0d0) (EXPONENTSIGN 1.0d0)
    (EXPONENT? CL:NIL) (DECIMALS? CL:NIL) (DECIMALS 0) (CH NULL-CHARACTER) (DIGIT 0) (RESULT 0.0d0))
   (CL:DECLARE (CL:TYPE CL:FIXNUM LENGTH AUXEND EXPONENT DECIMALS DIGIT)
   ...
   (CL:LOOP
    (CL:LOOP WHILE (CL:< START AUXEND) DO
     (CL:SETQ CH
      (CL:LET ((BUFFER BUFFER) (POSITION START)) (CL:DECLARE (CL:TYPE CL:FIXNUM POSITION))
       (CL:SCHAR (CL:THE CL:SIMPLE-STRING BUFFER) (CL:THE CL:FIXNUM POSITION))))
     (CL:CASE CH (#\- (CL:IF EXPONENT? (CL:SETQ EXPONENTSIGN -1.0d0) (CL:SETQ MANTISSASIGN -1.0d0))) (#\+)
      (#\. (CL:SETQ DECIMALS? CL:T)) ((#\e #\E) (CL:SETQ EXPONENT? CL:T))
   ...
   (CL:SETQ EXPONENT (CL:TRUNCATE (CL:- (CL:* EXPONENT EXPONENTSIGN) DECIMALS)))
   (CL:WHEN (CL:NOT (CL:= EXPONENT 0))
    (CL:SETQ RESULT
     (CL:* RESULT (CL:THE CL:DOUBLE-FLOAT (CL:EXPT 10.0d0 (CL:THE CL:DOUBLE-FLOAT (CL:FLOAT EXPONENT 0.0d0)))))))
...
(CL:DEFCLASS STELLA-TOKEN (TOKENIZER-TOKEN)
  ((LOGICAL-TOKEN-TYPE :ALLOCATION :INSTANCE :ACCESSOR %LOGICAL-TOKEN-TYPE)
   (MODULE :TYPE CL:SIMPLE-STRING :INITFORM STELLA::NULL-STRING :ALLOCATION :INSTANCE :ACCESSOR %MODULE)
   (ESCAPE-MODE :ALLOCATION :INSTANCE :ACCESSOR %ESCAPE-MODE)))

(CL:DEFUN NEW-STELLA-TOKEN ()
  (CL:LET* ((SELF NULL)) (CL:SETQ SELF (CL:MAKE-INSTANCE (CL:QUOTE STELLA-TOKEN)))
   (CL:SETF (%CONTENT SELF) STELLA::NULL-STRING) (CL:SETF (%TYPE SELF) NULL) (CL:SETF (%NEXT SELF) NULL)
   (CL:SETF (%ESCAPE-MODE SELF) NULL) (CL:SETF (%MODULE SELF) STELLA::NULL-STRING)
   (CL:SETF (%LOGICAL-TOKEN-TYPE SELF) NULL) (CL:RETURN-FROM NEW-STELLA-TOKEN SELF)))
...
(CL:DEFUN ACCESS-STELLA-TOKEN-SLOT-VALUE (SELF SLOTNAME VALUE SETVALUE?)
  (CL:COND
   ((CL:EQ SLOTNAME SYM-READ-STELLA-LOGICAL-TOKEN-TYPE)
    (CL:IF SETVALUE? (CL:SETF (%LOGICAL-TOKEN-TYPE SELF) VALUE) (CL:SETQ VALUE (%LOGICAL-TOKEN-TYPE SELF))))
   ((CL:EQ SLOTNAME SYM-READ-STELLA-MODULE)
    (CL:IF SETVALUE? (CL:SETF (%MODULE SELF) (%WRAPPER-VALUE VALUE)) (CL:SETQ VALUE (WRAP-STRING (%MODULE SELF)))))
   ((CL:EQ SLOTNAME SYM-READ-STELLA-ESCAPE-MODE)
    (CL:IF SETVALUE? (CL:SETF (%ESCAPE-MODE SELF) VALUE) (CL:SETQ VALUE (%ESCAPE-MODE SELF))))
   ((CL:EQ SLOTNAME SYM-READ-STELLA-NEXT) (CL:IF SETVALUE? (CL:SETF (%NEXT SELF) VALUE) (CL:SETQ VALUE (%NEXT SELF))))
   (CL:T
    (CL:LET* ((STREAM-000 (NEW-OUTPUT-STRING-STREAM)))
     (%%PRINT-STREAM (%NATIVE-STREAM STREAM-000) "`" SLOTNAME "' is not a valid case option")
...
(CL:DEFUN TOKENIZE-S-EXPRESSION (STREAM TOKENLIST)
  (CL:LET*
   ((UPCASE? (CL:NOT (%CASE-SENSITIVE? *MODULE*))) (PARENBALANCE 0) (ENDOFFILE? CL:T) (SKIPCLOSINGQUOTE? CL:NIL)
    (TOKENCURSOR TOKENLIST))
   (CL:DECLARE (CL:TYPE CL:FIXNUM PARENBALANCE))
   (CL:WHEN (CL:EQ TOKENLIST NULL) (CL:SETQ TOKENLIST (NEW-STELLA-TOKEN)) (CL:SETQ TOKENCURSOR TOKENLIST))
   (CL:LET*
    ((TOK_TABLE_ *STELLA-TOKENIZER-TABLE*) (TOK_TRANSITIONS_ (%TRANSITIONS TOK_TABLE_))
     (TOK_STATENAMES_ (%THE-ARRAY (%STATE-NAMES TOK_TABLE_))) (TOK_TOKENSTART_ -1) (TOK_ENDOFTOKENS?_ CL:NIL)
     (TOK_INPUTSTREAM_ STREAM) (TOK_ECHOSTREAM_ (%ECHO-STREAM TOK_INPUTSTREAM_))
     (TOK_STREAMSTATE_
      (CL:IF (CL:EQ (%TOKENIZER-STATE TOK_INPUTSTREAM_) NULL)
       (CL:SETF (%TOKENIZER-STATE TOK_INPUTSTREAM_) (NEW-TOKENIZER-STREAM-STATE)) (%TOKENIZER-STATE TOK_INPUTSTREAM_)))
     (TOK_BUFFER_ (%BUFFER TOK_STREAMSTATE_)) (TOK_SIZE_ (%BUFFER-SIZE TOK_STREAMSTATE_))
    ...
    (CL:PROGN (CL:SETQ TOK_STATENAMES_ TOK_STATENAMES_) (CL:SETQ TOK_ENDOFTOKENS?_ TOK_ENDOFTOKENS?_))
    (CL:LET*
     ((TOK_STELLALOGICALSTATENAMES_ (%THE-ARRAY *STELLA-LOGICAL-STATE-NAMES*)) (TOK_STELLALOGICALSTATENAME_ NULL))
     ...
     (CL:LOOP
      (CL:TAGBODY
        ...
        (CL:PROGN (CL:SETQ TOK_TOKENSTART_ -1)
         (CL:LOOP
          (CL:WHEN (CL:= TOK_CURSOR_ TOK_CHECKPOINT_)
           (CL:COND
            ((CL:= TOK_CURSOR_ TOK_END_) (CL:SETF (%CURSOR TOK_STREAMSTATE_) TOK_CURSOR_)
             (CL:SETQ TOK_ENDOFTOKENS?_ (READ-INTO-TOKENIZER-BUFFER TOK_INPUTSTREAM_ TOK_STREAMSTATE_ TOK_TOKENSTART_))
             (CL:SETQ TOK_BUFFER_ (%BUFFER TOK_STREAMSTATE_)) (CL:SETQ TOK_SIZE_ (%BUFFER-SIZE TOK_STREAMSTATE_))
             (CL:SETQ TOK_CURSOR_ (MOD (%CURSOR TOK_STREAMSTATE_) TOK_SIZE_))
             ...
             (CL:WHEN TOK_ENDOFTOKENS?_ (CL:SETQ TOK_CHECKPOINT_ TOK_CURSOR_)
              (CL:COND ((CL:= TOK_NEXTSTATE_ -1))
               ...
               (CL:T (CL:SETQ TOK_ENDOFTOKENS?_ CL:NIL) (CL:SETQ TOK_STATE_ 0) (CL:SETQ TOK_NEXTSTATE_ -1)))
              (CL:RETURN))
             (CL:IF (CL:>= TOK_CURSOR_ TOK_END_) (CL:SETQ TOK_CHECKPOINT_ TOK_SIZE_)
          ...
          (CL:COND
           ...
           ((CL:= TOK_TOKENSTART_ -1)
            (CL:WHEN (CL:= (CL:THE CL:FIXNUM (CL:LOGAND TOK_NEXTSTATE_ 64)) 0) (CL:SETQ TOK_TOKENSTART_ TOK_CURSOR_))
            (CL:SETQ TOK_STATE_ (CL:THE CL:FIXNUM (CL:LOGAND TOK_NEXTSTATE_ 63)))
            (CL:SETQ TOK_CURSOR_ (CL:1+ TOK_CURSOR_)))
           (CL:T (CL:RETURN)))
          (CL:WHEN (CL:NOT (CL:EQ TOK_ECHOSTREAM_ NULL))
           (%%PRINT-STREAM (%NATIVE-STREAM TOK_ECHOSTREAM_)
       ...
       (CL:WHEN (CL:NOT SKIPCLOSINGQUOTE?) (CL:SETF (%TYPE TOKENCURSOR) (CL:AREF TOK_STATENAMES_ TOK_STATE_))
        (CL:SETF (%LOGICAL-TOKEN-TYPE TOKENCURSOR) TOK_STELLALOGICALSTATENAME_)
        (CL:SETF (%MODULE TOKENCURSOR) STELLA::NULL-STRING) (CL:SETF (%ESCAPE-MODE TOKENCURSOR) NULL))
       (CL:SETQ SKIPCLOSINGQUOTE? CL:NIL)
       (CL:COND
        ((CL:EQ TOK_STELLALOGICALSTATENAME_ KWD-READ-OPEN-PAREN) (CL:SETQ PARENBALANCE (CL:1+ PARENBALANCE))
         (CL:SETF (%CONTENT TOKENCURSOR) "("))
        ((CL:EQ TOK_STELLALOGICALSTATENAME_ KWD-READ-CLOSE-PAREN) (CL:SETQ PARENBALANCE (CL:1- PARENBALANCE))
         (CL:SETF (%CONTENT TOKENCURSOR) ")")
         ...
         (CL:LET* ((TEST-VALUE-000 (CL:AREF TOK_STATENAMES_ TOK_STATE_)))
          (CL:COND
           ((CL:EQ TEST-VALUE-000 KWD-READ-SYMBOL)
            (CL:SETF (%CONTENT TOKENCURSOR)
             (GET-TOKEN-TEXT-INTERNAL TOK_BUFFER_ TOK_TOKENSTART_ TOK_CURSOR_ TOK_SIZE_ UPCASE?)))
           ((CL:EQ TEST-VALUE-000 KWD-READ-QUALIFIED-SYMBOL)
            (CL:LET*
             ((SEPARATORPOS
               (GET-QUALIFIED-SYMBOL-SEPARATOR-POSITION-INTERNAL TOK_BUFFER_ TOK_TOKENSTART_ TOK_CURSOR_ TOK_SIZE_
                KWD-READ-NONE)))
             (CL:DECLARE (CL:TYPE CL:FIXNUM SEPARATORPOS))
             (CL:SETF (%CONTENT TOKENCURSOR)
              (GET-TOKEN-TEXT-INTERNAL TOK_BUFFER_ (CL:+ TOK_TOKENSTART_ (CL:1+ SEPARATORPOS)) TOK_CURSOR_ TOK_SIZE_
               UPCASE?))
             (CL:SETF (%MODULE TOKENCURSOR)
              (CL:IF (CL:= SEPARATORPOS 0) "ROOT-MODULE"
               (GET-TOKEN-TEXT-INTERNAL TOK_BUFFER_ TOK_TOKENSTART_
                (CL:IF (CL:< SEPARATORPOS 0) (CL:+ TOK_CURSOR_ SEPARATORPOS) (CL:+ TOK_TOKENSTART_ SEPARATORPOS))
                TOK_SIZE_ CL:T)))))
           ((CL:EQ TEST-VALUE-000 KWD-READ-FULLY-ESCAPED-SYMBOL)
            (CL:SETF (%CONTENT TOKENCURSOR)
             (UNESCAPE-TOKEN-STRING
              (GET-TOKEN-TEXT-INTERNAL TOK_BUFFER_ (CL:1+ TOK_TOKENSTART_) TOK_CURSOR_ TOK_SIZE_ CL:NIL) #\\ CL:NIL))
           ...
           ((CL:EQ TEST-VALUE-000 KWD-READ-QUALIFIED-FULLY-ESCAPED-SYMBOL)
            (CL:LET*
             ...
             (CL:SETF (%CONTENT TOKENCURSOR)
              (UNESCAPE-TOKEN-STRING
               (GET-TOKEN-TEXT-INTERNAL TOK_BUFFER_ (CL:+ TOK_TOKENSTART_ (CL:+ SEPARATORPOS 2)) TOK_CURSOR_ TOK_SIZE_
                CL:NIL)
               #\\ CL:NIL))
             (CL:SETF (%MODULE TOKENCURSOR)
              (CL:IF (CL:= SEPARATORPOS 0) "ROOT-MODULE"
           ...
           ((CL:EQ TEST-VALUE-000 KWD-READ-ESCAPED-SYMBOL)
            (CL:SETF (%CONTENT TOKENCURSOR)
             (UNESCAPE-TOKEN-STRING (GET-TOKEN-TEXT-INTERNAL TOK_BUFFER_ TOK_TOKENSTART_ TOK_CURSOR_ TOK_SIZE_ CL:NIL)
              #\\ UPCASE?))
           ...
           ((CL:EQ TEST-VALUE-000 KWD-READ-CL-SYMBOL)
            (CL:SETF (%CONTENT TOKENCURSOR)
             (GET-TOKEN-TEXT-INTERNAL TOK_BUFFER_ (CL:+ TOK_TOKENSTART_ 3) TOK_CURSOR_ TOK_SIZE_ CL:T))
         ...
         (CL:LET* ((TEST-VALUE-001 (CL:AREF TOK_STATENAMES_ TOK_STATE_)))
          (CL:COND
           ((CL:EQ TEST-VALUE-001 KWD-READ-SURROGATE)
            (CL:SETF (%CONTENT TOKENCURSOR)
             (GET-TOKEN-TEXT-INTERNAL TOK_BUFFER_ (CL:1+ TOK_TOKENSTART_) TOK_CURSOR_ TOK_SIZE_ UPCASE?)))
           ...
           ((CL:EQ TEST-VALUE-001 KWD-READ-FULLY-ESCAPED-SURROGATE)
            (CL:SETF (%CONTENT TOKENCURSOR)
             (UNESCAPE-TOKEN-STRING
              (GET-TOKEN-TEXT-INTERNAL TOK_BUFFER_ (CL:+ TOK_TOKENSTART_ 2) TOK_CURSOR_ TOK_SIZE_ CL:NIL) #\\ CL:NIL))
            (CL:SETF (%ESCAPE-MODE TOKENCURSOR) KWD-READ-FULL) (CL:SETQ SKIPCLOSINGQUOTE? CL:T))
           ((CL:EQ TEST-VALUE-001 KWD-READ-QUALIFIED-FULLY-ESCAPED-SURROGATE)
            (CL:LET*
             ...
             (CL:SETF (%CONTENT TOKENCURSOR)
              (UNESCAPE-TOKEN-STRING
               (GET-TOKEN-TEXT-INTERNAL TOK_BUFFER_ (CL:+ TOK_TOKENSTART_ (CL:+ SEPARATORPOS 3)) TOK_CURSOR_ TOK_SIZE_
                CL:NIL)
               #\\ CL:NIL))
             (CL:SETF (%MODULE TOKENCURSOR)
              (CL:IF (CL:= SEPARATORPOS 0) "ROOT-MODULE"
           ...
           ((CL:EQ TEST-VALUE-001 KWD-READ-ESCAPED-SURROGATE)
            (CL:SETF (%CONTENT TOKENCURSOR)
             (UNESCAPE-TOKEN-STRING
              (GET-TOKEN-TEXT-INTERNAL TOK_BUFFER_ (CL:1+ TOK_TOKENSTART_) TOK_CURSOR_ TOK_SIZE_ CL:NIL) #\\ UPCASE?))
            (CL:SETF (%ESCAPE-MODE TOKENCURSOR) KWD-READ-PARTIAL))
         ...
         (CL:LET* ((TEST-VALUE-002 (CL:AREF TOK_STATENAMES_ TOK_STATE_)))
          (CL:COND
           ((CL:EQ TEST-VALUE-002 KWD-READ-KEYWORD)
            (CL:SETF (%CONTENT TOKENCURSOR)
             (GET-TOKEN-TEXT-INTERNAL TOK_BUFFER_ (CL:1+ TOK_TOKENSTART_) TOK_CURSOR_ TOK_SIZE_ CL:T)))
           ...
           ((CL:EQ TEST-VALUE-002 KWD-READ-ESCAPED-KEYWORD)
            (CL:SETF (%CONTENT TOKENCURSOR)
             (UNESCAPE-TOKEN-STRING
              (GET-TOKEN-TEXT-INTERNAL TOK_BUFFER_ (CL:1+ TOK_TOKENSTART_) TOK_CURSOR_ TOK_SIZE_ CL:NIL) #\\ CL:T))
            (CL:SETF (%ESCAPE-MODE TOKENCURSOR) KWD-READ-PARTIAL))
           (CL:T
        ...
        ((CL:EQ TOK_STELLALOGICALSTATENAME_ KWD-READ-STRING)
         (CL:SETF (%CONTENT TOKENCURSOR)
          (GET-TOKEN-TEXT-INTERNAL TOK_BUFFER_ (CL:1+ TOK_TOKENSTART_) TOK_CURSOR_ TOK_SIZE_ CL:NIL))
         (CL:LET* ((TEST-VALUE-003 (CL:AREF TOK_STATENAMES_ TOK_STATE_)))
          (CL:COND ((CL:EQ TEST-VALUE-003 KWD-READ-STRING))
           ((CL:EQ TEST-VALUE-003 KWD-READ-ESCAPED-STRING)
            (CL:SETF (%CONTENT TOKENCURSOR) (UNESCAPE-TOKEN-STRING (%CONTENT TOKENCURSOR) #\\ CL:NIL))
            (CL:SETF (%ESCAPE-MODE TOKENCURSOR) KWD-READ-PARTIAL))
           (CL:T
        ...
        ((CL:OR (CL:EQ TOK_STELLALOGICALSTATENAME_ KWD-READ-INTEGER)
         ...
         (CL:SETF (%CONTENT TOKENCURSOR)
          (GET-TOKEN-TEXT-INTERNAL TOK_BUFFER_ TOK_TOKENSTART_ TOK_CURSOR_ TOK_SIZE_ CL:NIL)))
        ((CL:EQ TOK_STELLALOGICALSTATENAME_ KWD-READ-CHARACTER)
         (CL:LET* ((NAME (GET-TOKEN-TEXT-INTERNAL TOK_BUFFER_ TOK_TOKENSTART_ TOK_CURSOR_ TOK_SIZE_ CL:NIL)))
          (CL:DECLARE (CL:TYPE CL:SIMPLE-STRING NAME))
          (CL:WHEN (CL:> (CL:THE CL:FIXNUM (CL:LENGTH NAME)) 1) (CL:SETQ NAME (STRING-UPCASE NAME)))
          (CL:SETF (%CONTENT TOKENCURSOR) NAME)))
        ((CL:OR (CL:EQ TOK_STELLALOGICALSTATENAME_ KWD-READ-SINGLE-QUOTE)
          (CL:EQ TOK_STELLALOGICALSTATENAME_ KWD-READ-BACK-QUOTE) (CL:EQ TOK_STELLALOGICALSTATENAME_ KWD-READ-COMMA)
          (CL:EQ TOK_STELLALOGICALSTATENAME_ KWD-READ-COMMA-SPLICE))
         (CL:SETF (%CONTENT TOKENCURSOR)
          (GET-TOKEN-TEXT-INTERNAL TOK_BUFFER_ TOK_TOKENSTART_ TOK_CURSOR_ TOK_SIZE_ CL:NIL))
         (CL:WHEN (CL:EQ (%NEXT TOKENCURSOR) NULL) (CL:SETF (%NEXT TOKENCURSOR) (NEW-STELLA-TOKEN)))
         (CL:SETQ TOKENCURSOR (%NEXT TOKENCURSOR)) (CL:GO :CONTINUE))
        ((CL:EQ TOK_STELLALOGICALSTATENAME_ KWD-READ-QUALIFIED-NAME)
         (CL:LET*
          ((TOKEN (GET-TOKEN-TEXT-INTERNAL TOK_BUFFER_ TOK_TOKENSTART_ TOK_CURSOR_ TOK_SIZE_ CL:T))
             ...
             (CL:OR (CL:= LENGTH 1)
              (CL:EQL
               (CL:LET ((SELF TOKEN) (POSITION (CL:- LENGTH 2)))
                ...
                (CL:SCHAR (CL:THE CL:SIMPLE-STRING SELF) (CL:THE CL:FIXNUM POSITION)))
               #\/)))
            (CL:SETF (%CONTENT TOKENCURSOR) "/") (CL:SETF (%TYPE TOKENCURSOR) KWD-READ-SYMBOL)
            (CL:SETF (%LOGICAL-TOKEN-TYPE TOKENCURSOR) KWD-READ-SYMBOL)
            (CL:WHEN (CL:> LENGTH 1) (CL:SETF (%MODULE TOKENCURSOR) (SUBSEQUENCE TOKEN 0 (CL:- LENGTH 2)))
        ...
        ((CL:EQ TOK_STELLALOGICALSTATENAME_ KWD-READ-ERROR)
         ...
         (CL:LET* ((STREAM-004 (NEW-OUTPUT-STRING-STREAM)))
          (%%PRINT-STREAM (%NATIVE-STREAM STREAM-004) "Illegal read syntax: `"
           (GET-TOKEN-TEXT-INTERNAL TOK_BUFFER_ TOK_TOKENSTART_ TOK_CURSOR_ TOK_SIZE_ CL:NIL) "'")
        ...
        (CL:T
         ...
         (CL:LET* ((STREAM-005 (NEW-OUTPUT-STRING-STREAM)))
          (%%PRINT-STREAM (%NATIVE-STREAM STREAM-005) "Illegal read syntax: `"
           (GET-TOKEN-TEXT-INTERNAL TOK_BUFFER_ TOK_TOKENSTART_ TOK_CURSOR_ TOK_SIZE_ CL:NIL) "' in state `"
...
(CL:DECLAIM
 (CL:FTYPE (CL:FUNCTION (CL:SIMPLE-STRING CL:T) (CL:VALUES CL:SIMPLE-STRING CL:SIMPLE-STRING CL:T)) PARSE-STELLA-NAME))
  ...
  (CL:LET*
   ...
   (CL:LET*
    ((TOK_TABLE_ *STELLA-TOKENIZER-TABLE*) (TOK_TRANSITIONS_ (%TRANSITIONS TOK_TABLE_))
     ...
     (TOK_BUFFER_ (CL:LET ((STRING NAME)) (CL:DECLARE (CL:TYPE CL:SIMPLE-STRING STRING)) STRING)) (TOK_STATE_ 1)
    ...
    (CL:LET*
       ...
       (CL:LOOP
        (CL:WHEN (CL:= TOK_CURSOR_ TOK_END_)
         (CL:COND ((CL:= TOK_NEXTSTATE_ -1) (CL:SETQ TOK_ENDOFTOKENS?_ CL:T))
          ((COERCE-WRAPPED-BOOLEAN-TO-BOOLEAN
            (CL:AREF (CL:THE CL:SIMPLE-VECTOR (%THE-ARRAY (%LEGAL-EOF-STATES TOK_TABLE_))) TOK_STATE_))
           (CL:SETQ TOK_NEXTSTATE_ -1) (CL:WHEN (CL:= TOK_TOKENSTART_ -1) (CL:SETQ TOK_ENDOFTOKENS?_ CL:T)))
     ...
     (CL:WHEN TOK_ENDOFTOKENS?_
      (CL:RETURN-FROM PARSE-STELLA-NAME (CL:VALUES STELLA::NULL-STRING STELLA::NULL-STRING NULL)))
     (CL:COND
      ((CL:EQ TOK_STELLALOGICALSTATENAME_ KWD-READ-SYMBOL)
       (CL:LET* ((TEST-VALUE-000 (CL:AREF TOK_STATENAMES_ TOK_STATE_)))
        (CL:COND
         ((CL:EQ TEST-VALUE-000 KWD-READ-SYMBOL)
          (CL:SETQ SYMBOLNAME (GET-TOKEN-TEXT-INTERNAL TOK_BUFFER_ TOK_TOKENSTART_ TOK_CURSOR_ TOK_SIZE_ UPCASE?)))
         ((CL:EQ TEST-VALUE-000 KWD-READ-QUALIFIED-SYMBOL)
      ...
      ((CL:EQ TOK_STELLALOGICALSTATENAME_ KWD-READ-QUALIFIED-NAME)
       (CL:LET*
        ...
        (CL:COND
         ...
         (CL:T
          (CL:LET* ((STREAM-003 (NEW-OUTPUT-STRING-STREAM)))
           (%%PRINT-STREAM (%NATIVE-STREAM STREAM-003) "Illegal symbol syntax: `"
            (GET-TOKEN-TEXT-INTERNAL TOK_BUFFER_ TOK_TOKENSTART_ TOK_CURSOR_ TOK_SIZE_ CL:NIL) "' in state `"
            (CL:AREF TOK_STATENAMES_ TOK_STATE_) "'")
      ...
      (CL:T
       (CL:LET* ((STREAM-005 (NEW-OUTPUT-STRING-STREAM)))
        (%%PRINT-STREAM (%NATIVE-STREAM STREAM-005) "Illegal symbol syntax: `"
         (GET-TOKEN-TEXT-INTERNAL TOK_BUFFER_ TOK_TOKENSTART_ TOK_CURSOR_ TOK_SIZE_ CL:NIL) "' in state `"
         (CL:AREF TOK_STATENAMES_ TOK_STATE_) "'")
        (CL:ERROR (NEW-READ-EXCEPTION (THE-STRING-READER STREAM-005))))))
     ...
     (CL:IF (CL:OR TOK_ENDOFTOKENS?_ (CL:EQ (CL:AREF TOK_STATENAMES_ TOK_STATE_) KWD-READ-CLOSE-FULLY-ESCAPED-NAME))
      ...
      (CL:LET* ((STREAM-006 (NEW-OUTPUT-STRING-STREAM)))
       (%%PRINT-STREAM (%NATIVE-STREAM STREAM-006) "Garbage found after `" NAME "'")
    ...
    (CL:LET* ((TEST-VALUE-000 (CL:AREF TOK_STATENAMES_ TOK_STATE_)))
     (CL:COND
      ((CL:OR (CL:EQ TEST-VALUE-000 KWD-READ-QUALIFIED-SYMBOL)
        ...
        (CL:EQ TEST-VALUE-000 KWD-READ-QUALIFIED-FULLY-ESCAPED-SURROGATE)
      ...
      ((CL:EQ TEST-VALUE-000 KWD-READ-QUALIFIED-NAME)
       (CL:RETURN-FROM QUALIFIED-STELLA-NAME? (CL:NOT (STRING-EQL? NAME "/"))))
    ...
    (CL:TAGBODY (CL:SETQ TOKENTYPE (%LOGICAL-TOKEN-TYPE TOKENLIST))
     (CL:COND
      ((CL:EQ TOKENTYPE KWD-READ-OPEN-PAREN)
       (CL:WHEN (CL:NOT (CL:EQ PARSEDTREE NULL)) (CL:SETQ PARSEDTREESTACK (CONS PARSEDTREE PARSEDTREESTACK)))
      ...
      ((CL:EQ TOKENTYPE KWD-READ-CLOSE-PAREN)
       (CL:COND ((CL:EQ PARSEDTREESTACK NIL) (CL:SETQ PARSEDTREE (REVERSE PARSEDTREE)) (CL:RETURN))
        (CL:T
         (CL:LET* ((PARENTTREE PARSEDTREESTACK)) (CL:SETQ PARSEDTREESTACK (%%REST PARSEDTREESTACK))
          (CL:SETF (%%REST PARENTTREE) (%%VALUE PARENTTREE)) (FIRST-SETTER PARENTTREE (REVERSE PARSEDTREE))
          (CL:SETQ PARSEDTREE PARENTTREE) (CL:SETQ TOKENLIST (%NEXT TOKENLIST)) (CL:GO :CONTINUE)))))
      ((CL:OR (CL:EQ TOKENTYPE KWD-READ-SYMBOL) (CL:EQ TOKENTYPE KWD-READ-SURROGATE))
       (CL:LET*
        ((MODULENAME (%MODULE TOKENLIST)) (NAME (%CONTENT TOKENLIST))
         (MODULE
          (CL:IF (CL:NOT (CL:EQ MODULENAME STELLA::NULL-STRING)) (GET-STELLA-MODULE MODULENAME CL:NIL) *MODULE*)))
        ...
        (CL:COND
         ...
         (CL:T
          (CL:SETQ PARSEDTOKEN
           (CL:IF (CL:AND *TRANSIENTOBJECTS?* (CL:EQ MODULENAME STELLA::NULL-STRING)) (INTERN-TRANSIENT-SYMBOL NAME)
            (INTERN-SYMBOL-IN-MODULE NAME MODULE CL:NIL)))))))
      ((CL:EQ TOKENTYPE KWD-READ-KEYWORD)
       (CL:SETQ PARSEDTOKEN (INTERN-RIGID-SYMBOL-WRT-MODULE (%CONTENT TOKENLIST) NULL KEYWORD-SYM)))
      ((CL:EQ TOKENTYPE KWD-READ-STRING) (CL:SETQ PARSEDTOKEN (CL:MAKE-INSTANCE (CL:QUOTE STRING-WRAPPER)))
       (CL:SETF (%WRAPPER-VALUE PARSEDTOKEN) (%CONTENT TOKENLIST)))
      ((CL:EQ TOKENTYPE KWD-READ-INTEGER)
       (CL:SETQ PARSEDTOKEN (WRAP-INTEGER-VALUE (STRING-TO-INTEGER (%CONTENT TOKENLIST)))))
      ...
      ((CL:EQ TOKENTYPE KWD-READ-COMMA) (CL:SETQ PARSEDTOKEN |SYM-READ-STELLA-&|))
      ((CL:EQ TOKENTYPE KWD-READ-COMMA-SPLICE) (CL:SETQ PARSEDTOKEN |SYM-READ-STELLA-&&|))
      ((CL:OR (CL:EQ TOKENTYPE KWD-READ-SINGLE-QUOTE) (CL:EQ TOKENTYPE KWD-READ-BACK-QUOTE))
       (EXPAND-QUOTE-MACRO-TOKEN TOKENLIST) (CL:GO :CONTINUE))
      (CL:T
       (CL:LET* ((STREAM-001 (NEW-OUTPUT-STRING-STREAM)))
        (%%PRINT-STREAM (%NATIVE-STREAM STREAM-001) "Illegal read syntax: `" (%CONTENT TOKENLIST) "' of type `"
         TOKENTYPE "'")
        (CL:ERROR (NEW-READ-EXCEPTION (THE-STRING-READER STREAM-001))))))
     (CL:COND
      ((CL:NOT (CL:EQ PARSEDTREE NULL)) (CL:SETQ CONSCELL (CL:CONS CL:NIL CL:NIL))
       (CL:SETF (%%VALUE CONSCELL) PARSEDTOKEN) (CL:SETF (%%REST CONSCELL) PARSEDTREE) (CL:SETQ PARSEDTREE CONSCELL)
       (CL:SETQ TOKENLIST (%NEXT TOKENLIST)))
      (CL:T (CL:RETURN)))
     :CONTINUE))
   (CL:IF (CL:EQ PARSEDTREE NULL) (CL:RETURN-FROM STELLA-TOKEN-LIST-TO-S-EXPRESSION PARSEDTOKEN)
...
(CL:DEFUN EXPAND-QUOTE-MACRO-TOKEN (QUOTEDLIST)
  (CL:LET* ((QUOTESTRING (%CONTENT QUOTEDLIST))) (CL:DECLARE (CL:TYPE CL:SIMPLE-STRING QUOTESTRING))
   (CL:LET* ((SELF-000 (NEW-STELLA-TOKEN))) (CL:SETF (%TYPE SELF-000) KWD-READ-SYMBOL)
    (CL:SETF (%LOGICAL-TOKEN-TYPE SELF-000) KWD-READ-SYMBOL)
    (CL:SETF (%CONTENT SELF-000) (CL:IF (STRING-EQL? QUOTESTRING "'") "QUOTE" "BQUOTE"))
    (CL:SETF (%MODULE SELF-000) "/STELLA") (CL:SETF (%NEXT SELF-000) (%NEXT QUOTEDLIST))
    (CL:LET* ((TOKEN SELF-000) (TOKENTYPE NULL) (BALANCE 0)) (CL:DECLARE (CL:TYPE CL:FIXNUM BALANCE))
     (CL:SETF (%TYPE QUOTEDLIST) KWD-READ-OPEN-PAREN) (CL:SETF (%LOGICAL-TOKEN-TYPE QUOTEDLIST) KWD-READ-OPEN-PAREN)
     (CL:SETF (%CONTENT QUOTEDLIST) "(") (CL:SETF (%NEXT QUOTEDLIST) TOKEN) (CL:SETQ QUOTEDLIST (%NEXT TOKEN))
      ...
      (CL:COND ((CL:EQ TOKENTYPE KWD-READ-OPEN-PAREN) (CL:SETQ BALANCE (CL:1+ BALANCE)))
       ((CL:EQ TOKENTYPE KWD-READ-CLOSE-PAREN) (CL:SETQ BALANCE (CL:1- BALANCE))
        (CL:COND ((CL:= BALANCE 0) (CL:RETURN))
         ((CL:< BALANCE 0)
          (CL:LET* ((STREAM-000 (NEW-OUTPUT-STRING-STREAM)))
           (%%PRINT-STREAM (%NATIVE-STREAM STREAM-000) "Illegal `" QUOTESTRING "' syntax")
           (CL:ERROR (NEW-READ-EXCEPTION (THE-STRING-READER STREAM-000)))))))
       (CL:T (CL:WHEN (CL:= BALANCE 0) (CL:RETURN))))
      (CL:SETQ QUOTEDLIST (%NEXT QUOTEDLIST)))
     (CL:WHEN (CL:EQ TOKENTYPE NULL)
      (CL:LET* ((STREAM-001 (NEW-OUTPUT-STRING-STREAM)))
       (%%PRINT-STREAM (%NATIVE-STREAM STREAM-001) "EOF encountered while parsing `" QUOTESTRING "' syntax")
       (CL:ERROR (NEW-READ-EXCEPTION (THE-STRING-READER STREAM-001)))))
     (CL:LET* ((SELF-005 (NEW-STELLA-TOKEN))) (CL:SETF (%TYPE SELF-005) KWD-READ-CLOSE-PAREN)
      (CL:SETF (%LOGICAL-TOKEN-TYPE SELF-005) KWD-READ-CLOSE-PAREN) (CL:SETF (%CONTENT SELF-005) ")")
      (CL:SETF (%NEXT SELF-005) (%NEXT QUOTEDLIST)) (CL:SETQ TOKEN SELF-005))
  ...
  (CL:LET*
   ...
   (CL:WHEN (CL:> (CL:THE CL:FIXNUM (CL:LENGTH NAME)) 1)
    (CL:COND ((STRING-EQL? NAME "SPACE") (CL:SETQ CHAR #\ )) ((STRING-EQL? NAME "LINEFEED") (CL:SETQ CHAR #\Linefeed))
     ...
     ((STRING-EQL? NAME "BACKSPACE") (CL:SETQ CHAR #\Backspace)) ((STRING-EQL? NAME "TAB") (CL:SETQ CHAR #\Tab))
     ((STRING-EQL? NAME "RETURN") (CL:SETQ CHAR #\Return)) ((STRING-EQL? NAME "PAGE") (CL:SETQ CHAR #\Page))
     ((STRING-EQL? NAME "NULL") (CL:SETQ CHAR NULL-CHARACTER))
     (CL:T
      (CL:LET* ((STREAM-000 (NEW-OUTPUT-STRING-STREAM)))
       (%%PRINT-STREAM (%NATIVE-STREAM STREAM-000) "Illegal character constant: `" (CONCATENATE "#\\" NAME) "'")
       (CL:ERROR (NEW-READ-EXCEPTION (THE-STRING-READER STREAM-000)))))))
...
(CL:DEFUN CREATE-TOKENIZE-STRING-TABLE (PUNCTUATIONCHARS QUOTECHARS ESCAPECHARS)
  ...
  (CL:LET* ((CHARTYPETABLE (NEW-VECTOR 256)))
   (CL:LET* ((I NULL-INTEGER) (ITER-000 0) (UPPER-BOUND-000 (CL:1- (LENGTH CHARTYPETABLE))))
    (CL:DECLARE (CL:TYPE CL:FIXNUM I ITER-000 UPPER-BOUND-000))
    (CL:LOOP WHILE (CL:<= ITER-000 UPPER-BOUND-000) DO (CL:SETQ I ITER-000)
     (CL:IF
      (CL:EQ (CL:AREF *CHARACTER-TYPE-TABLE* (CL:THE CL:FIXNUM (CL:CHAR-CODE (CL:CODE-CHAR I)))) KWD-READ-WHITE-SPACE)
      (CL:LET ((SELF (%THE-ARRAY CHARTYPETABLE)) (VALUE KWD-READ-WHITE-SPACE) (POSITION I))
       (CL:DECLARE (CL:TYPE CL:SIMPLE-VECTOR SELF) (CL:TYPE CL:FIXNUM POSITION))
       (CL:SETF (CL:AREF SELF POSITION) VALUE))
      (CL:LET ((SELF (%THE-ARRAY CHARTYPETABLE)) (VALUE KWD-READ-TEXT) (POSITION I))
       (CL:DECLARE (CL:TYPE CL:SIMPLE-VECTOR SELF) (CL:TYPE CL:FIXNUM POSITION))
       (CL:SETF (CL:AREF SELF POSITION) VALUE)))
     (CL:SETQ ITER-000 (CL:1+ ITER-000))))
   (CL:LET*
    ...
    (CL:LOOP WHILE (CL:< INDEX-000 LENGTH-000) DO
     (CL:SETQ CH
      (CL:LET ((SELF VECTOR-000) (POSITION INDEX-000))
       ...
       (CL:SCHAR (CL:THE CL:SIMPLE-STRING SELF) (CL:THE CL:FIXNUM POSITION))))
     (CL:LET
      ((SELF (%THE-ARRAY CHARTYPETABLE)) (VALUE KWD-READ-PUNCTUATION) (POSITION (CL:THE CL:FIXNUM (CL:CHAR-CODE CH))))
      (CL:DECLARE (CL:TYPE CL:SIMPLE-VECTOR SELF) (CL:TYPE CL:FIXNUM POSITION))
      (CL:SETF (CL:AREF SELF POSITION) VALUE))
     (CL:SETQ INDEX-000 (CL:1+ INDEX-000))))
   (CL:LET*
    ((CH NULL-CHARACTER) (VECTOR-001 QUOTECHARS) (INDEX-001 0) (LENGTH-001 (CL:THE CL:FIXNUM (CL:LENGTH VECTOR-001))))
   ...
   (CL:LET*
    ((CH NULL-CHARACTER) (VECTOR-002 ESCAPECHARS) (INDEX-002 0) (LENGTH-002 (CL:THE CL:FIXNUM (CL:LENGTH VECTOR-002))))
    ...
    (CL:LOOP WHILE (CL:< INDEX-002 LENGTH-002) DO
     (CL:SETQ CH
      (CL:LET ((SELF VECTOR-002) (POSITION INDEX-002))
       ...
       (CL:SCHAR (CL:THE CL:SIMPLE-STRING SELF) (CL:THE CL:FIXNUM POSITION))))
     (CL:LET
      ((SELF (%THE-ARRAY CHARTYPETABLE)) (VALUE KWD-READ-ESCAPE) (POSITION (CL:THE CL:FIXNUM (CL:CHAR-CODE CH))))
      (CL:DECLARE (CL:TYPE CL:SIMPLE-VECTOR SELF) (CL:TYPE CL:FIXNUM POSITION))
      (CL:SETF (CL:AREF SELF POSITION) VALUE))
     (CL:SETQ INDEX-002 (CL:1+ INDEX-002))))
  ...
  (CL:LET* ((MEMO-TABLE-000 NULL) (MEMOIZED-ENTRY-000 NULL) (MEMOIZED-VALUE-000 NULL))
   (CL:WHEN *MEMOIZATION-ENABLED?*
    ...
    (CL:WHEN (CL:EQ MEMO-TABLE-000 NULL)
     (INITIALIZE-MEMOIZATION-TABLE SGT-READ-STELLA-F-TOKENIZE-STRING-MEMO-TABLE-000 "(:MAX-VALUES 10)")
     (CL:SETQ MEMO-TABLE-000 (%SURROGATE-VALUE SGT-READ-STELLA-F-TOKENIZE-STRING-MEMO-TABLE-000)))
    (CL:SETQ MEMOIZED-ENTRY-000
     (LOOKUP-MRU-MEMOIZED-VALUE MEMO-TABLE-000 (WRAP-STRING PUNCTUATIONCHARS) (WRAP-STRING QUOTECHARS)
   ...
   (CL:LET*
    ((CHARTYPETABLE MEMOIZED-VALUE-000) (I 0) (CH NULL-CHARACTER) (START 0) (END (CL:THE CL:FIXNUM (CL:LENGTH STRING)))
     (STATE KWD-READ-TEXT) (NEWSTATE KWD-READ-TEXT) (QUOTEDTOKEN? CL:NIL) (QUOTECHAR NULL-CHARACTER)
     (ENDOFTOKEN? CL:NIL) (ESCAPEPOSITIONS NIL) (TOKEN STELLA::NULL-STRING) (RESULT NIL))
      ...
      (CL:WHEN (CL:< I END)
       (CL:SETQ CH
        (CL:LET ((SELF STRING) (POSITION I)) (CL:DECLARE (CL:TYPE CL:SIMPLE-STRING SELF) (CL:TYPE CL:FIXNUM POSITION))
         (CL:SCHAR (CL:THE CL:SIMPLE-STRING SELF) (CL:THE CL:FIXNUM POSITION))))
       (CL:SETQ NEWSTATE
        (CL:AREF (CL:THE CL:SIMPLE-VECTOR (%THE-ARRAY CHARTYPETABLE)) (CL:THE CL:FIXNUM (CL:CHAR-CODE CH))))
       (CL:COND
        ((CL:EQ NEWSTATE KWD-READ-TEXT)
         (CL:COND
          ((CL:OR (CL:EQ STATE KWD-READ-PUNCTUATION) (CL:EQ STATE KWD-READ-WHITE-SPACE) (CL:EQ STATE KWD-READ-QUOTE))
        ...
        ((CL:EQ NEWSTATE KWD-READ-QUOTE)
         (CL:COND
          ((CL:AND QUOTEDTOKEN? (CL:EQL CH QUOTECHAR)) (CL:SETQ ENDOFTOKEN? CL:T) (CL:SETQ QUOTEDTOKEN? CL:NIL))
        ...
        ((CL:EQ NEWSTATE KWD-READ-PUNCTUATION)
         (CL:COND
          ((CL:EQ STATE KWD-READ-TEXT)
           (CL:IF QUOTEDTOKEN? (CL:SETQ NEWSTATE KWD-READ-TEXT) (CL:SETQ ENDOFTOKEN? CL:T)))
        ...
        (CL:T
         (CL:LET* ((STREAM-000 (NEW-OUTPUT-STRING-STREAM)))
          (%%PRINT-STREAM (%NATIVE-STREAM STREAM-000) "`" NEWSTATE "' is not a valid case option")
          (CL:ERROR (NEW-STELLA-EXCEPTION (THE-STRING-READER STREAM-000)))))))
          ...
          (CL:LET* ((PARTS NIL) (S START)) (CL:DECLARE (CL:TYPE CL:FIXNUM S))
           (CL:LET* ((E NULL) (ITER-000 (REVERSE ESCAPEPOSITIONS)))
            (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-000 NIL)) DO (CL:SETQ E (%%VALUE ITER-000))
             (CL:SETQ PARTS (CONS (WRAP-STRING (SUBSEQUENCE STRING S (%WRAPPER-VALUE E))) PARTS))
             (CL:SETQ S (CL:1+ (%WRAPPER-VALUE E))) (CL:SETQ ITER-000 (%%REST ITER-000))))
           (CL:SETQ PARTS (CONS (WRAP-STRING (SUBSEQUENCE STRING (MIN S END) (MIN I END))) PARTS))
           (CL:SETQ PARTS (REVERSE PARTS))
           (CL:SETQ TOKEN
            (STRING-CONCATENATE (%WRAPPER-VALUE (%%VALUE PARTS)) (%WRAPPER-VALUE (%%VALUE (%%REST PARTS)))))
           (CL:LET* ((PART NULL) (ITER-001 (%%REST (%%REST PARTS))))
            (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-001 NIL)) DO (CL:SETQ PART (%%VALUE ITER-001))
             (CL:SETQ TOKEN (STRING-CONCATENATE TOKEN (%WRAPPER-VALUE PART))) (CL:SETQ ITER-001 (%%REST ITER-001)))))
...
the result.  Return `true' as the second value on EOF."
  (CL:LET*
   ((TOKENIZERSTATE (%TOKENIZER-STATE STREAM))
    (TOKENLIST (CL:IF (CL:NOT (CL:EQ TOKENIZERSTATE NULL)) (%TOKEN-LIST TOKENIZERSTATE) NULL)))
   ...
   (CL:WHEN (CL:OR (CL:EQ STREAM STANDARD-INPUT) (CL:NOT (CL:EQ (%ECHO-STREAM STREAM) NULL)))
   ...
   (CL:COND
    ((CL:EQ (CL:AREF *CHARACTER-TYPE-TABLE* (CL:THE CL:FIXNUM (CL:CHAR-CODE CHAR))) KWD-READ-WHITE-SPACE)
     (CL:LET* ((STATE (%TOKENIZER-STATE STREAM)))
      (CL:WHEN (CL:NOT (CL:EQ STATE NULL)) (CL:SETF (%STATE STATE) *STELLA-TOKENIZER-WHITE-SPACE-STATE*))))
...
(CL:DEFUN CONSUME-WHITESPACE (STREAM)
  (CL:LOOP
   (CL:LET* ((CHAR NULL-CHARACTER) (EOF? CL:NIL)) (CL:MULTIPLE-VALUE-SETQ (CHAR EOF?) (READ-CHARACTER STREAM))
    ...
    (CL:WHEN
     (CL:NOT (CL:EQ (CL:AREF *CHARACTER-TYPE-TABLE* (CL:THE CL:FIXNUM (CL:CHAR-CODE CHAR))) KWD-READ-WHITE-SPACE))
...
(CL:DEFUN MAKE-TOKENIZER-STRING-STREAM (STRING)
  ...
  (CL:CHECK-TYPE STRING CL:SIMPLE-STRING)
  (CL:LET*
   ((STREAM (NEW-INPUT-STRING-STREAM STRING)) (STATE (CL:MAKE-INSTANCE (CL:QUOTE TOKENIZER-STREAM-STATE)))
    (LENGTH (CL:1+ (CL:THE CL:FIXNUM (CL:LENGTH STRING)))))
   (CL:DECLARE (CL:TYPE CL:FIXNUM LENGTH)) (CL:SETF (%BUFFER STATE) (CL:MAKE-STRING LENGTH))
   (CL:SETF (%BUFFER-SIZE STATE) LENGTH) (CL:SETF (%CURSOR STATE) LENGTH) (CL:SETF (%END STATE) LENGTH)
   (CL:SETF (%STATE STATE) 1) (CL:SETF (%TABLE STATE) NULL) (CL:SETF (%STATE-DICTIONARY STATE) NULL)
   (CL:SETF (%TOKEN-LIST STATE) (NEW-STELLA-TOKEN)) (CL:SETF (%TOKENIZER-STATE STREAM) STATE)
...
readline algorithm and return the result.  On EOF return `null'"
  (CL:WHEN (CL:NOT (CL:EQ (%TOKENIZER-STATE INPUTSTREAM) NULL))
   (CL:RETURN-FROM NATIVE-READ-LINE (READ-LINE-FROM-TOKENIZER-BUFFER INPUTSTREAM)))
  (CL:LET* ((STREAM (%NATIVE-STREAM INPUTSTREAM)) (ECHOSTREAM (%ECHO-STREAM INPUTSTREAM)) (INPUT STELLA::NULL-STRING))
   ...
   (CL:WHEN (CL:AND (CL:NOT (CL:EQ ECHOSTREAM NULL)) (CL:NOT (CL:EQ INPUT STELLA::NULL-STRING)))
...
in any combination.  It is not as fast as `native-read-line', however."
  ...
  (CL:LET*
   ((TOK_TABLE_ *READ-LINE-TOKENIZER-TABLE*) (TOK_TRANSITIONS_ (%TRANSITIONS TOK_TABLE_))
    (TOK_STATENAMES_ (%THE-ARRAY (%STATE-NAMES TOK_TABLE_))) (TOK_TOKENSTART_ -1) (TOK_ENDOFTOKENS?_ CL:NIL)
    (TOK_INPUTSTREAM_ STREAM) (TOK_ECHOSTREAM_ (%ECHO-STREAM TOK_INPUTSTREAM_))
    (TOK_STREAMSTATE_
     (CL:IF (CL:EQ (%TOKENIZER-STATE TOK_INPUTSTREAM_) NULL)
     ...
     (CL:COND
      ...
      ((CL:EQ TEST-VALUE-000 KWD-READ-ERROR)
       (CL:WHEN (CL:NOT (CL:EQ TOK_STREAMSTATE_ NULL)) (CL:SETF (%CURSOR TOK_STREAMSTATE_) TOK_CURSOR_)
        (CL:SETF (%TABLE TOK_STREAMSTATE_) TOK_TABLE_) (CL:SETF (%STATE TOK_STREAMSTATE_) TOK_STATE_))
       (CL:LET* ((STREAM-000 (NEW-OUTPUT-STRING-STREAM)))
        (%%PRINT-STREAM (%NATIVE-STREAM STREAM-000) "Illegal read syntax: `"
         (GET-TOKEN-TEXT-INTERNAL TOK_BUFFER_ TOK_TOKENSTART_ TOK_CURSOR_ TOK_SIZE_ CL:NIL) "'")
        (CL:ERROR (NEW-READ-EXCEPTION (THE-STRING-READER STREAM-000)))))
      (CL:T
       (CL:LET* ((STREAM-001 (NEW-OUTPUT-STRING-STREAM)))
   ...
   (CL:LET*
    ...
    (CL:LOOP
     ...
     (CL:WHEN TOK_ENDOFTOKENS?_
      (CL:WHEN (CL:NOT (CL:EQ TOK_STREAMSTATE_ NULL)) (CL:SETF (%CURSOR TOK_STREAMSTATE_) TOK_CURSOR_)
       (CL:SETF (%TABLE TOK_STREAMSTATE_) TOK_TABLE_) (CL:SETF (%STATE TOK_STREAMSTATE_) TOK_STATE_))
      (CL:IF (STRING-EQL? LINE "") (CL:RETURN-FROM READ-LINE2 (CL:VALUES STELLA::NULL-STRING KWD-READ-EOF))
       (CL:RETURN-FROM READ-LINE2 (CL:VALUES LINE KWD-READ-EOF))))
     (CL:LET* ((TEST-VALUE-000 (CL:AREF TOK_STATENAMES_ TOK_STATE_)))
      (CL:COND
       ((CL:EQ TEST-VALUE-000 KWD-READ-LINE)
        (CL:SETQ LINE (GET-TOKEN-TEXT-INTERNAL TOK_BUFFER_ TOK_TOKENSTART_ TOK_CURSOR_ TOK_SIZE_ CL:NIL)))
...
Return `true' as the second value on EOF."
  (CL:WHEN (CL:NOT (CL:EQ (%TOKENIZER-STATE INPUTSTREAM) NULL))
   (CL:RETURN-FROM READ-CHARACTER (READ-CHARACTER-FROM-TOKENIZER-BUFFER INPUTSTREAM)))
  (CL:LET*
   ((STREAM (%NATIVE-STREAM INPUTSTREAM)) (ECHOSTREAM (%ECHO-STREAM INPUTSTREAM)) (INPUT NULL-CHARACTER) (EOF CL:NIL))
...
the input is read.  See also special variable `*USER-QUERY-ACTION*'."
  ...
  (CL:COND ((CL:EQ *USER-QUERY-ACTION* KWD-READ-YES) (CL:RETURN-FROM YES-OR-NO? CL:T))
   ((CL:EQ *USER-QUERY-ACTION* KWD-READ-NO) (CL:RETURN-FROM YES-OR-NO? CL:NIL))
   ((CL:EQ *USER-QUERY-ACTION* KWD-READ-YES-VERBOSE)
    (%%PRINT-STREAM (%NATIVE-STREAM STANDARD-OUTPUT) MESSAGE " [Auto => YES]" EOL) (CL:RETURN-FROM YES-OR-NO? CL:T))
   ((CL:EQ *USER-QUERY-ACTION* KWD-READ-NO-VERBOSE)
    (%%PRINT-STREAM (%NATIVE-STREAM STANDARD-OUTPUT) MESSAGE " [Auto => NO]" EOL) (CL:RETURN-FROM YES-OR-NO? CL:NIL))
   ((CL:EQ *USER-QUERY-ACTION* KWD-READ-ASK)
    (CL:LET* ((INPUT STELLA::NULL-STRING) (START 0))
     (CL:DECLARE (CL:TYPE CL:SIMPLE-STRING INPUT) (CL:TYPE CL:FIXNUM START))
     (CL:LOOP
      (CL:WHEN (CL:NOT (CL:EQ MESSAGE STELLA::NULL-STRING)) (%%PRINT-STREAM (%NATIVE-STREAM STANDARD-OUTPUT) MESSAGE))
      (CL:SETQ INPUT (READ-LINE STANDARD-INPUT)) (CL:SETQ START 0)
      (CL:LET*
       ((CH NULL-CHARACTER) (VECTOR-000 INPUT) (INDEX-000 0) (LENGTH-000 (CL:THE CL:FIXNUM (CL:LENGTH VECTOR-000))))
       (CL:DECLARE (CL:TYPE CL:SIMPLE-STRING VECTOR-000) (CL:TYPE CL:FIXNUM INDEX-000 LENGTH-000))
       (CL:LOOP WHILE (CL:< INDEX-000 LENGTH-000) DO
        (CL:SETQ CH
         (CL:LET ((SELF VECTOR-000) (POSITION INDEX-000))
          (CL:DECLARE (CL:TYPE CL:SIMPLE-STRING SELF) (CL:TYPE CL:FIXNUM POSITION))
          (CL:SCHAR (CL:THE CL:SIMPLE-STRING SELF) (CL:THE CL:FIXNUM POSITION))))
        (CL:IF (CL:EQ (CL:AREF *CHARACTER-TYPE-TABLE* (CL:THE CL:FIXNUM (CL:CHAR-CODE CH))) KWD-READ-WHITE-SPACE)
      ...
      (CL:WHEN (CL:> (CL:THE CL:FIXNUM (CL:LENGTH INPUT)) START) (CL:SETQ INPUT (SUBSEQUENCE INPUT START NULL-INTEGER))
       (CL:WHEN (STRING-EQUAL? INPUT "yes") (CL:RETURN-FROM YES-OR-NO? CL:T))
       (CL:WHEN (STRING-EQUAL? INPUT "no") (CL:RETURN-FROM YES-OR-NO? CL:NIL))
       (%%PRINT-STREAM (%NATIVE-STREAM STANDARD-OUTPUT) "Type `yes' for yes or `no' for no." EOL)))))
   (CL:T
    (CL:LET* ((STREAM-000 (NEW-OUTPUT-STRING-STREAM)))
     (%%PRINT-STREAM (%NATIVE-STREAM STREAM-000) "`" *USER-QUERY-ACTION* "' is not a valid case option")
     (CL:ERROR (NEW-STELLA-EXCEPTION (THE-STRING-READER STREAM-000)))))))
...
the input is read.  See also special variable `*USER-QUERY-ACTION*'."
  ...
  #+MCL
  (CL:CHECK-TYPE MESSAGE CL:SIMPLE-STRING)
  (CL:COND ((CL:EQ *USER-QUERY-ACTION* KWD-READ-YES) (CL:RETURN-FROM Y-OR-N? CL:T))
   ((CL:EQ *USER-QUERY-ACTION* KWD-READ-NO) (CL:RETURN-FROM Y-OR-N? CL:NIL))
   ((CL:EQ *USER-QUERY-ACTION* KWD-READ-YES-VERBOSE)
    (%%PRINT-STREAM (%NATIVE-STREAM STANDARD-OUTPUT) MESSAGE " [Auto => Y]" EOL) (CL:RETURN-FROM Y-OR-N? CL:T))
   ((CL:EQ *USER-QUERY-ACTION* KWD-READ-NO-VERBOSE)
    (%%PRINT-STREAM (%NATIVE-STREAM STANDARD-OUTPUT) MESSAGE " [Auto => N]" EOL) (CL:RETURN-FROM Y-OR-N? CL:NIL))
   ((CL:EQ *USER-QUERY-ACTION* KWD-READ-ASK)
    (CL:LET* ((INPUT STELLA::NULL-STRING) (START 0))
     (CL:DECLARE (CL:TYPE CL:SIMPLE-STRING INPUT) (CL:TYPE CL:FIXNUM START))
     (CL:LOOP
...
(CL:DEFMETHOD STREAM-TO-STRING ((FROM INPUT-STREAM))
  ...
  (CL:LET* ((TO (NEW-OUTPUT-STRING-STREAM))) (COPY-STREAM-TO-STREAM FROM TO)
...
(CL:DEFUN FILE-TO-STRING (FILE)
  ...
  (CL:LET* ((IN NULL))
   (CL:UNWIND-PROTECT
    (CL:PROGN (CL:SETQ IN (OPEN-INPUT-FILE FILE)) (CL:RETURN-FROM FILE-TO-STRING (STREAM-TO-STRING IN)))
...
(CL:DEFUN HELP-STARTUP-READ1 ()
  (CL:PROGN (CL:SETQ SGT-READ-STELLA-TOKENIZER-TABLE (INTERN-RIGID-SYMBOL-WRT-MODULE "TOKENIZER-TABLE" NULL 1))
   ...
   (CL:SETQ KWD-READ-ERROR (INTERN-RIGID-SYMBOL-WRT-MODULE "ERROR" NULL 2))
   (CL:SETQ KWD-READ-START (INTERN-RIGID-SYMBOL-WRT-MODULE "START" NULL 2))
   ...
   (CL:SETQ SGT-READ-STELLA-CONS (INTERN-RIGID-SYMBOL-WRT-MODULE "CONS" NULL 1))
   (CL:SETQ KWD-READ-BLOCK (INTERN-RIGID-SYMBOL-WRT-MODULE "BLOCK" NULL 2))
   (CL:SETQ KWD-READ-LINE (INTERN-RIGID-SYMBOL-WRT-MODULE "LINE" NULL 2))
   (CL:SETQ KWD-READ-CHARACTER (INTERN-RIGID-SYMBOL-WRT-MODULE "CHARACTER" NULL 2))
   (CL:SETQ SGT-READ-STELLA-TOKENIZER-TOKEN (INTERN-RIGID-SYMBOL-WRT-MODULE "TOKENIZER-TOKEN" NULL 1))
   (CL:SETQ SYM-READ-STELLA-TYPE (INTERN-RIGID-SYMBOL-WRT-MODULE "TYPE" NULL 0))
   (CL:SETQ SYM-READ-STELLA-CONTENT (INTERN-RIGID-SYMBOL-WRT-MODULE "CONTENT" NULL 0))
   ...
   (CL:SETQ SYM-READ-STELLA-CURSOR (INTERN-RIGID-SYMBOL-WRT-MODULE "CURSOR" NULL 0))
   (CL:SETQ SYM-READ-STELLA-END (INTERN-RIGID-SYMBOL-WRT-MODULE "END" NULL 0))
   (CL:SETQ SYM-READ-STELLA-STATE (INTERN-RIGID-SYMBOL-WRT-MODULE "STATE" NULL 0))
   (CL:SETQ SYM-READ-STELLA-TABLE (INTERN-RIGID-SYMBOL-WRT-MODULE "TABLE" NULL 0))
   ...
   (CL:SETQ SGT-READ-STELLA-STRING (INTERN-RIGID-SYMBOL-WRT-MODULE "STRING" NULL 1))
   (CL:SETQ SGT-READ-STELLA-VOID (INTERN-RIGID-SYMBOL-WRT-MODULE "VOID" NULL 1))
   (CL:SETQ SGT-READ-STELLA-MUTABLE-STRING (INTERN-RIGID-SYMBOL-WRT-MODULE "MUTABLE-STRING" NULL 1))
   (CL:SETQ SYM-READ-STELLA-LET (INTERN-RIGID-SYMBOL-WRT-MODULE "LET" NULL 0))
   (CL:SETQ SYM-READ-STELLA-TOK_TABLE_ (INTERN-RIGID-SYMBOL-WRT-MODULE "TOK_TABLE_" NULL 0))
   ...
   (CL:SETQ SYM-READ-STELLA-FALSE (INTERN-RIGID-SYMBOL-WRT-MODULE "FALSE" NULL 0))
   (CL:SETQ SYM-READ-STELLA-IGNORE (INTERN-RIGID-SYMBOL-WRT-MODULE "IGNORE" NULL 0))
   ...
   (CL:SETQ SYM-READ-STELLA-STRING-TO-TOKENIZER-BYTE-ARRAY
    (INTERN-RIGID-SYMBOL-WRT-MODULE "STRING-TO-TOKENIZER-BYTE-ARRAY" NULL 0))
   ...
   (CL:SETQ SYM-READ-STELLA-CHOOSE (INTERN-RIGID-SYMBOL-WRT-MODULE "CHOOSE" NULL 0))
   (CL:SETQ SYM-READ-STELLA-NULL? (INTERN-RIGID-SYMBOL-WRT-MODULE "NULL?" NULL 0))
   (CL:SETQ SYM-READ-STELLA-TOKENIZER-STATE (INTERN-RIGID-SYMBOL-WRT-MODULE "TOKENIZER-STATE" NULL 0))
   (CL:SETQ SYM-READ-STELLA-SETF (INTERN-RIGID-SYMBOL-WRT-MODULE "SETF" NULL 0))
   (CL:SETQ SYM-READ-STELLA-NEW (INTERN-RIGID-SYMBOL-WRT-MODULE "NEW" NULL 0))
...
(CL:DEFUN HELP-STARTUP-READ2 ()
  (CL:PROGN (CL:SETQ SYM-READ-STELLA-TOK_CHECKPOINT_ (INTERN-RIGID-SYMBOL-WRT-MODULE "TOK_CHECKPOINT_" NULL 0))
   ...
   (CL:SETQ SYM-READ-STELLA-NTH (INTERN-RIGID-SYMBOL-WRT-MODULE "NTH" NULL 0))
   (CL:SETQ SYM-READ-STELLA-WHEN (INTERN-RIGID-SYMBOL-WRT-MODULE "WHEN" NULL 0))
   ...
   (CL:SETQ SYM-READ-STELLA-SAVE-TOKENIZER-STREAM-STATE
    (INTERN-RIGID-SYMBOL-WRT-MODULE "SAVE-TOKENIZER-STREAM-STATE" NULL 0))
   (CL:SETQ SYM-READ-STELLA-TRUE (INTERN-RIGID-SYMBOL-WRT-MODULE "TRUE" NULL 0))
   (CL:SETQ SYM-READ-STELLA-PROGN (INTERN-RIGID-SYMBOL-WRT-MODULE "PROGN" NULL 0))
   (CL:SETQ SYM-READ-STELLA-SETQ (INTERN-RIGID-SYMBOL-WRT-MODULE "SETQ" NULL 0))
   (CL:SETQ SYM-READ-STELLA-LOOP (INTERN-RIGID-SYMBOL-WRT-MODULE "LOOP" NULL 0))
   ...
   (CL:SETQ KWD-READ-COMMON-LISP (INTERN-RIGID-SYMBOL-WRT-MODULE "COMMON-LISP" NULL 2))
   (CL:SETQ SYM-READ-STELLA-> (INTERN-RIGID-SYMBOL-WRT-MODULE ">" NULL 0))
   ...
   (CL:SETQ SYM-READ-STELLA-COND (INTERN-RIGID-SYMBOL-WRT-MODULE "COND" NULL 0))
   (CL:SETQ SYM-READ-STELLA-= (INTERN-RIGID-SYMBOL-WRT-MODULE "=" NULL 0))
   (CL:SETQ SYM-READ-STELLA-LOGAND (INTERN-RIGID-SYMBOL-WRT-MODULE "LOGAND" NULL 0))
   (CL:SETQ SYM-READ-STELLA-++ (INTERN-RIGID-SYMBOL-WRT-MODULE "++" NULL 0))
   ...
   (CL:SETQ SYM-READ-STELLA-READ-INTO-TOKENIZER-BUFFER
    (INTERN-RIGID-SYMBOL-WRT-MODULE "READ-INTO-TOKENIZER-BUFFER" NULL 0))
   (CL:SETQ SYM-READ-STELLA-MOD (INTERN-RIGID-SYMBOL-WRT-MODULE "MOD" NULL 0))
   (CL:SETQ SYM-READ-STELLA-UNLESS (INTERN-RIGID-SYMBOL-WRT-MODULE "UNLESS" NULL 0))
   (CL:SETQ SYM-READ-STELLA-IF (INTERN-RIGID-SYMBOL-WRT-MODULE "IF" NULL 0))
   (CL:SETQ SYM-READ-STELLA->= (INTERN-RIGID-SYMBOL-WRT-MODULE ">=" NULL 0))
   ...
   (CL:SETQ SYM-READ-STELLA-STREAM (INTERN-RIGID-SYMBOL-WRT-MODULE "STREAM" NULL 0))
   (CL:SETQ KWD-READ-INCLUDE (INTERN-RIGID-SYMBOL-WRT-MODULE "INCLUDE" NULL 2))
   (CL:SETQ KWD-READ-DELIMITER (INTERN-RIGID-SYMBOL-WRT-MODULE "DELIMITER" NULL 2))
   (CL:SETQ KWD-READ-ATOM (INTERN-RIGID-SYMBOL-WRT-MODULE "ATOM" NULL 2))
   (CL:SETQ SYM-READ-STELLA-* (INTERN-RIGID-SYMBOL-WRT-MODULE "*" NULL 0))
   (CL:SETQ KWD-READ-OPEN-PAREN (INTERN-RIGID-SYMBOL-WRT-MODULE "OPEN-PAREN" NULL 2))
   (CL:SETQ KWD-READ-CLOSE-PAREN (INTERN-RIGID-SYMBOL-WRT-MODULE "CLOSE-PAREN" NULL 2))
   (CL:SETQ KWD-READ-OPEN-STRING (INTERN-RIGID-SYMBOL-WRT-MODULE "OPEN-STRING" NULL 2))
   (CL:SETQ KWD-READ-STRING (INTERN-RIGID-SYMBOL-WRT-MODULE "STRING" NULL 2))
   (CL:SETQ KWD-READ-SINGLE-QUOTE (INTERN-RIGID-SYMBOL-WRT-MODULE "SINGLE-QUOTE" NULL 2))
   (CL:SETQ KWD-READ-BACK-QUOTE (INTERN-RIGID-SYMBOL-WRT-MODULE "BACK-QUOTE" NULL 2))
   (CL:SETQ KWD-READ-COMMA (INTERN-RIGID-SYMBOL-WRT-MODULE "COMMA" NULL 2))
   (CL:SETQ SYM-READ-STELLA-! (INTERN-RIGID-SYMBOL-WRT-MODULE "!" NULL 0))
   (CL:SETQ KWD-READ-COMMENT (INTERN-RIGID-SYMBOL-WRT-MODULE "COMMENT" NULL 2))
   (CL:SETQ KWD-READ-HASH (INTERN-RIGID-SYMBOL-WRT-MODULE "HASH" NULL 2))
   (CL:SETQ KWD-READ-WHITE-SPACE (INTERN-RIGID-SYMBOL-WRT-MODULE "WHITE-SPACE" NULL 2))
   ...
   (CL:SETQ KWD-READ-PAREN-COMMENT-BAR (INTERN-RIGID-SYMBOL-WRT-MODULE "PAREN-COMMENT-BAR" NULL 2))
...
(CL:DEFUN HELP-STARTUP-READ3 ()
  (CL:PROGN
   (CL:SETQ KWD-READ-SYMBOL-OR-SIGNED-NUMBER (INTERN-RIGID-SYMBOL-WRT-MODULE "SYMBOL-OR-SIGNED-NUMBER" NULL 2))
   ...
   (CL:SETQ KWD-READ-OPEN-KEYWORD (INTERN-RIGID-SYMBOL-WRT-MODULE "OPEN-KEYWORD" NULL 2))
   (CL:SETQ KWD-READ-KEYWORD (INTERN-RIGID-SYMBOL-WRT-MODULE "KEYWORD" NULL 2))
   ...
   (CL:SETQ KWD-READ-SYMBOL-OR-EXPONENT-DELIMITER
    (INTERN-RIGID-SYMBOL-WRT-MODULE "SYMBOL-OR-EXPONENT-DELIMITER" NULL 2))
   ...
   (CL:SETQ KWD-READ-FULLY-ESCAPED-KEYWORD-ESCAPE
    (INTERN-RIGID-SYMBOL-WRT-MODULE "FULLY-ESCAPED-KEYWORD-ESCAPE" NULL 2))
   ...
   (CL:SETQ KWD-READ-FULLY-ESCAPED-SURROGATE-ESCAPE
    (INTERN-RIGID-SYMBOL-WRT-MODULE "FULLY-ESCAPED-SURROGATE-ESCAPE" NULL 2))
   ...
   (CL:SETQ KWD-READ-QUALIFIED-ESCAPED-SYMBOL-ESCAPE
    (INTERN-RIGID-SYMBOL-WRT-MODULE "QUALIFIED-ESCAPED-SYMBOL-ESCAPE" NULL 2))
   (CL:SETQ KWD-READ-QUALIFIED-FULLY-ESCAPED-SYMBOL
    (INTERN-RIGID-SYMBOL-WRT-MODULE "QUALIFIED-FULLY-ESCAPED-SYMBOL" NULL 2))
   ...
   (CL:SETQ KWD-READ-QUALIFIED-ESCAPED-SURROGATE-ESCAPE
    (INTERN-RIGID-SYMBOL-WRT-MODULE "QUALIFIED-ESCAPED-SURROGATE-ESCAPE" NULL 2))
   (CL:SETQ KWD-READ-QUALIFIED-FULLY-ESCAPED-SURROGATE
    (INTERN-RIGID-SYMBOL-WRT-MODULE "QUALIFIED-FULLY-ESCAPED-SURROGATE" NULL 2))
   ...
   (CL:SETQ KWD-READ-QUALIFIED-FULLY-ESCAPED-SYMBOL-ESCAPE
    (INTERN-RIGID-SYMBOL-WRT-MODULE "QUALIFIED-FULLY-ESCAPED-SYMBOL-ESCAPE" NULL 2))
   (CL:SETQ KWD-READ-QUALIFIED-FULLY-ESCAPED-SURROGATE-ESCAPE
    (INTERN-RIGID-SYMBOL-WRT-MODULE "QUALIFIED-FULLY-ESCAPED-SURROGATE-ESCAPE" NULL 2))
   ...
   (CL:SETQ SYM-READ-STELLA-TOK_STELLALOGICALSTATENAMES_
    (INTERN-RIGID-SYMBOL-WRT-MODULE "TOK_STELLALOGICALSTATENAMES_" NULL 0))
   (CL:SETQ SYM-READ-STELLA-*STELLA-LOGICAL-STATE-NAMES*
    (INTERN-RIGID-SYMBOL-WRT-MODULE "*STELLA-LOGICAL-STATE-NAMES*" NULL 0))
   (CL:SETQ SYM-READ-STELLA-TOK_STELLALOGICALSTATENAME_
    (INTERN-RIGID-SYMBOL-WRT-MODULE "TOK_STELLALOGICALSTATENAME_" NULL 0))
   (CL:SETQ SYM-READ-STELLA-KEYWORD (INTERN-RIGID-SYMBOL-WRT-MODULE "KEYWORD" NULL 0))
   (CL:SETQ KWD-READ-NONE (INTERN-RIGID-SYMBOL-WRT-MODULE "NONE" NULL 2))
   (CL:SETQ SYM-READ-STELLA-GET-QUALIFIED-SYMBOL-SEPARATOR-POSITION-INTERNAL
    (INTERN-RIGID-SYMBOL-WRT-MODULE "GET-QUALIFIED-SYMBOL-SEPARATOR-POSITION-INTERNAL" NULL 0))
   ...
   (CL:SETQ SYM-READ-STELLA-GET-TOKEN-INTEGER-INTERNAL
    (INTERN-RIGID-SYMBOL-WRT-MODULE "GET-TOKEN-INTEGER-INTERNAL" NULL 0))
...
(CL:DEFUN HELP-STARTUP-READ4 ()
  (CL:PROGN
   (CL:SETQ SYM-READ-STELLA-GET-TOKEN-LONG-INTEGER-INTERNAL
    (INTERN-RIGID-SYMBOL-WRT-MODULE "GET-TOKEN-LONG-INTEGER-INTERNAL" NULL 0))
   ...
   (CL:SETQ SYM-READ-STELLA-ESCAPE-MODE (INTERN-RIGID-SYMBOL-WRT-MODULE "ESCAPE-MODE" NULL 0))
   (CL:SETQ KWD-READ-FULL (INTERN-RIGID-SYMBOL-WRT-MODULE "FULL" NULL 2))
   (CL:SETQ KWD-READ-PARTIAL (INTERN-RIGID-SYMBOL-WRT-MODULE "PARTIAL" NULL 2))
   (CL:SETQ KWD-READ-ESCAPED (INTERN-RIGID-SYMBOL-WRT-MODULE "ESCAPED" NULL 2))
   (CL:SETQ |SYM-READ-STELLA-&| (INTERN-RIGID-SYMBOL-WRT-MODULE "&" NULL 0))
   (CL:SETQ |SYM-READ-STELLA-&&| (INTERN-RIGID-SYMBOL-WRT-MODULE "&&" NULL 0))
   (CL:SETQ KWD-READ-TEXT (INTERN-RIGID-SYMBOL-WRT-MODULE "TEXT" NULL 2))
   (CL:SETQ KWD-READ-PUNCTUATION (INTERN-RIGID-SYMBOL-WRT-MODULE "PUNCTUATION" NULL 2))
   (CL:SETQ KWD-READ-QUOTE (INTERN-RIGID-SYMBOL-WRT-MODULE "QUOTE" NULL 2))
   (CL:SETQ KWD-READ-ESCAPE (INTERN-RIGID-SYMBOL-WRT-MODULE "ESCAPE" NULL 2))
   (CL:SETQ SGT-READ-STELLA-F-TOKENIZE-STRING-MEMO-TABLE-000
    (INTERN-RIGID-SYMBOL-WRT-MODULE "F-TOKENIZE-STRING-MEMO-TABLE-000" NULL 1))
   ...
   (CL:SETQ KWD-READ-LINEFEED (INTERN-RIGID-SYMBOL-WRT-MODULE "LINEFEED" NULL 2))
   (CL:SETQ KWD-READ-RETURN (INTERN-RIGID-SYMBOL-WRT-MODULE "RETURN" NULL 2))
   (CL:SETQ KWD-READ-RETURN-LINEFEED (INTERN-RIGID-SYMBOL-WRT-MODULE "RETURN-LINEFEED" NULL 2))
   (CL:SETQ KWD-READ-LF (INTERN-RIGID-SYMBOL-WRT-MODULE "LF" NULL 2))
   (CL:SETQ KWD-READ-CRLF (INTERN-RIGID-SYMBOL-WRT-MODULE "CRLF" NULL 2))
   ...
   (CL:SETQ KWD-READ-YES-VERBOSE (INTERN-RIGID-SYMBOL-WRT-MODULE "YES-VERBOSE" NULL 2))
  ...
  (CL:PROGN
   (CL:SETQ *STELLA-TOKENIZER-TABLE-DEFINITION*
    (LIST* (LIST* KWD-READ-START KWD-READ-INCLUDE KWD-READ-DELIMITER KWD-READ-INCLUDE KWD-READ-ATOM NIL)
     (LIST* KWD-READ-DELIMITER SYM-READ-STELLA-* (WRAP-STRING "(") KWD-READ-OPEN-PAREN SYM-READ-STELLA-*
      (WRAP-STRING ")") KWD-READ-CLOSE-PAREN SYM-READ-STELLA-* (WRAP-STRING "\"")
      (LIST* KWD-READ-OPEN-STRING KWD-READ-STRING NIL) SYM-READ-STELLA-* (WRAP-STRING "'") KWD-READ-SINGLE-QUOTE
      SYM-READ-STELLA-* (WRAP-STRING "`") KWD-READ-BACK-QUOTE SYM-READ-STELLA-* (WRAP-STRING ",") KWD-READ-COMMA
      SYM-READ-STELLA-! (WRAP-STRING ";") KWD-READ-COMMENT SYM-READ-STELLA-! (WRAP-STRING "#") KWD-READ-HASH
      SYM-READ-STELLA-!
      (LIST* (WRAP-CHARACTER #\ ) (WRAP-CHARACTER #\Tab) (WRAP-CHARACTER #\Linefeed) (WRAP-CHARACTER #\Return) NIL)
      KWD-READ-WHITE-SPACE KWD-READ-EOF KWD-READ-EOF NIL)
     (LIST* KWD-READ-WHITE-SPACE KWD-READ-INCLUDE KWD-READ-START NIL)
     (LIST* KWD-READ-COMMENT (LIST* (WRAP-CHARACTER #\Linefeed) (WRAP-CHARACTER #\Return) NIL) KWD-READ-START
      KWD-READ-EOF KWD-READ-EOF KWD-READ-OTHERWISE KWD-READ-COMMENT NIL)
     (LIST* KWD-READ-PAREN-COMMENT (WRAP-STRING "\\") KWD-READ-PAREN-COMMENT-ESCAPE (WRAP-STRING "|")
      KWD-READ-PAREN-COMMENT-BAR KWD-READ-OTHERWISE KWD-READ-PAREN-COMMENT NIL)
     (LIST* KWD-READ-PAREN-COMMENT-ESCAPE KWD-READ-ANY KWD-READ-PAREN-COMMENT NIL)
     (LIST* KWD-READ-PAREN-COMMENT-BAR (WRAP-STRING "#") KWD-READ-START (WRAP-STRING "\\")
      KWD-READ-PAREN-COMMENT-ESCAPE (WRAP-STRING "|") KWD-READ-PAREN-COMMENT-BAR KWD-READ-OTHERWISE
     ...
     (LIST* KWD-READ-COMMA (WRAP-STRING ".") KWD-READ-COMMA-SPLICE KWD-READ-INCLUDE KWD-READ-DELIMITER
      SYM-READ-STELLA-* (WRAP-STRING "-+") (LIST* KWD-READ-SYMBOL-OR-SIGNED-NUMBER KWD-READ-SYMBOL NIL)
      SYM-READ-STELLA-* (WRAP-STRING "0123456789") (LIST* KWD-READ-SYMBOL-OR-NUMBER KWD-READ-INTEGER NIL)
      SYM-READ-STELLA-* (WRAP-STRING "cC") (LIST* KWD-READ-SYMBOL-OR-CL-SYMBOL KWD-READ-SYMBOL NIL) SYM-READ-STELLA-*
      (WRAP-STRING "|") (LIST* KWD-READ-OPEN-FULLY-ESCAPED-SYMBOL KWD-READ-FULLY-ESCAPED-SYMBOL NIL) SYM-READ-STELLA-*
      (WRAP-STRING "\\") KWD-READ-ESCAPED-SYMBOL-ESCAPE SYM-READ-STELLA-* (WRAP-STRING "/") KWD-READ-QUALIFIED-NAME
      SYM-READ-STELLA-* (WRAP-STRING ":") (LIST* KWD-READ-OPEN-KEYWORD KWD-READ-KEYWORD NIL) SYM-READ-STELLA-*
      (WRAP-STRING "@") (LIST* KWD-READ-OPEN-SURROGATE KWD-READ-SURROGATE NIL) SYM-READ-STELLA-* KWD-READ-OTHERWISE
      KWD-READ-SYMBOL NIL)
     (LIST* KWD-READ-COMMA-SPLICE KWD-READ-INCLUDE KWD-READ-START NIL)
     (LIST* KWD-READ-OPEN-STRING SYM-READ-STELLA-* (WRAP-STRING "\"") KWD-READ-CLOSE-STRING (WRAP-STRING "\\")
      KWD-READ-STRING-ESCAPE KWD-READ-OTHERWISE KWD-READ-STRING NIL)
     (LIST* KWD-READ-STRING SYM-READ-STELLA-* (WRAP-STRING "\"") KWD-READ-CLOSE-STRING (WRAP-STRING "\\")
      KWD-READ-STRING-ESCAPE KWD-READ-OTHERWISE KWD-READ-STRING NIL)
     (LIST* KWD-READ-CLOSE-STRING KWD-READ-INCLUDE KWD-READ-START NIL)
     (LIST* KWD-READ-STRING-ESCAPE KWD-READ-ANY KWD-READ-ESCAPED-STRING NIL)
     (LIST* KWD-READ-ESCAPED-STRING SYM-READ-STELLA-* (WRAP-STRING "\"") KWD-READ-CLOSE-STRING (WRAP-STRING "\\")
      KWD-READ-STRING-ESCAPE KWD-READ-OTHERWISE KWD-READ-ESCAPED-STRING NIL)
     ...
     (LIST* KWD-READ-ATOM SYM-READ-STELLA-* (WRAP-STRING "-+")
      (LIST* KWD-READ-SYMBOL-OR-SIGNED-NUMBER KWD-READ-SYMBOL NIL) SYM-READ-STELLA-* (WRAP-STRING "0123456789")
      (LIST* KWD-READ-SYMBOL-OR-NUMBER KWD-READ-INTEGER NIL) SYM-READ-STELLA-* (WRAP-STRING ".")
      (LIST* KWD-READ-SYMBOL-OR-MANTISSA KWD-READ-SYMBOL NIL) SYM-READ-STELLA-* (WRAP-STRING "cC")
      (LIST* KWD-READ-SYMBOL-OR-CL-SYMBOL KWD-READ-SYMBOL NIL) SYM-READ-STELLA-* (WRAP-STRING "|")
      (LIST* KWD-READ-OPEN-FULLY-ESCAPED-SYMBOL KWD-READ-FULLY-ESCAPED-SYMBOL NIL) SYM-READ-STELLA-* (WRAP-STRING "\\")
      KWD-READ-ESCAPED-SYMBOL-ESCAPE SYM-READ-STELLA-* (WRAP-STRING "/") KWD-READ-QUALIFIED-NAME SYM-READ-STELLA-*
      (WRAP-STRING ":") (LIST* KWD-READ-OPEN-KEYWORD KWD-READ-KEYWORD NIL) SYM-READ-STELLA-* (WRAP-STRING "@")
      (LIST* KWD-READ-OPEN-SURROGATE KWD-READ-SURROGATE NIL) SYM-READ-STELLA-* KWD-READ-OTHERWISE KWD-READ-SYMBOL NIL)
     (LIST* KWD-READ-SYMBOL-OR-SIGNED-NUMBER KWD-READ-INCLUDE KWD-READ-DELIMITER (WRAP-STRING "/")
      KWD-READ-QUALIFIED-NAME (WRAP-STRING "\\") KWD-READ-ESCAPED-SYMBOL-ESCAPE (WRAP-STRING "0123456789")
      (LIST* KWD-READ-SYMBOL-OR-NUMBER KWD-READ-INTEGER NIL) (WRAP-STRING ".")
      (LIST* KWD-READ-SYMBOL-OR-MANTISSA KWD-READ-SYMBOL NIL) (WRAP-STRING "|") KWD-READ-ERROR KWD-READ-OTHERWISE
      KWD-READ-SYMBOL NIL)
     (LIST* KWD-READ-SYMBOL-OR-NUMBER KWD-READ-INCLUDE KWD-READ-DELIMITER (WRAP-STRING "/") KWD-READ-QUALIFIED-NAME
      (WRAP-STRING "\\") KWD-READ-ESCAPED-SYMBOL-ESCAPE (WRAP-STRING "0123456789")
      (LIST* KWD-READ-SYMBOL-OR-NUMBER KWD-READ-INTEGER NIL) (WRAP-STRING ".")
      (LIST* KWD-READ-SYMBOL-OR-MANTISSA2 KWD-READ-FLOAT NIL) (WRAP-STRING "eE")
      (LIST* KWD-READ-SYMBOL-OR-EXPONENT-DELIMITER KWD-READ-SYMBOL NIL) (WRAP-STRING "|") KWD-READ-ERROR
      KWD-READ-OTHERWISE KWD-READ-SYMBOL NIL)
     (LIST* KWD-READ-SYMBOL-OR-MANTISSA KWD-READ-INCLUDE KWD-READ-DELIMITER (WRAP-STRING "/") KWD-READ-QUALIFIED-NAME
      (WRAP-STRING "\\") KWD-READ-ESCAPED-SYMBOL-ESCAPE (WRAP-STRING "0123456789")
      (LIST* KWD-READ-SYMBOL-OR-MANTISSA2 KWD-READ-FLOAT NIL) (WRAP-STRING "eE")
      (LIST* KWD-READ-SYMBOL-OR-EXPONENT-DELIMITER KWD-READ-SYMBOL NIL) (WRAP-STRING "|") KWD-READ-ERROR
      KWD-READ-OTHERWISE KWD-READ-SYMBOL NIL)
     (LIST* KWD-READ-SYMBOL-OR-MANTISSA2 KWD-READ-INCLUDE KWD-READ-SYMBOL-OR-MANTISSA NIL)
     (LIST* KWD-READ-SYMBOL-OR-EXPONENT-DELIMITER KWD-READ-INCLUDE KWD-READ-DELIMITER (WRAP-STRING "/")
      KWD-READ-QUALIFIED-NAME (WRAP-STRING "\\") KWD-READ-ESCAPED-SYMBOL-ESCAPE (WRAP-STRING "+-")
      (LIST* KWD-READ-SYMBOL-OR-EXPONENT KWD-READ-SYMBOL NIL) (WRAP-STRING "0123456789")
      (LIST* KWD-READ-SYMBOL-OR-EXPONENT2 KWD-READ-FLOAT NIL) (WRAP-STRING "|") KWD-READ-ERROR KWD-READ-OTHERWISE
      KWD-READ-SYMBOL NIL)
     (LIST* KWD-READ-SYMBOL-OR-EXPONENT KWD-READ-INCLUDE KWD-READ-DELIMITER (WRAP-STRING "/") KWD-READ-QUALIFIED-NAME
      (WRAP-STRING "\\") KWD-READ-ESCAPED-SYMBOL-ESCAPE (WRAP-STRING "0123456789")
      (LIST* KWD-READ-SYMBOL-OR-EXPONENT2 KWD-READ-FLOAT NIL) (WRAP-STRING "|") KWD-READ-ERROR KWD-READ-OTHERWISE
      KWD-READ-SYMBOL NIL)
     (LIST* KWD-READ-SYMBOL-OR-EXPONENT2 KWD-READ-INCLUDE KWD-READ-SYMBOL-OR-EXPONENT NIL)
     (LIST* KWD-READ-SYMBOL-OR-CL-SYMBOL KWD-READ-INCLUDE KWD-READ-DELIMITER (WRAP-STRING "/") KWD-READ-QUALIFIED-NAME
      (WRAP-STRING "\\") KWD-READ-ESCAPED-SYMBOL-ESCAPE (WRAP-STRING "lL")
      (LIST* KWD-READ-SYMBOL-OR-CL-SYMBOL2 KWD-READ-SYMBOL NIL) (WRAP-STRING "|") KWD-READ-ERROR KWD-READ-OTHERWISE
      KWD-READ-SYMBOL NIL)
     (LIST* KWD-READ-SYMBOL-OR-CL-SYMBOL2 KWD-READ-INCLUDE KWD-READ-DELIMITER (WRAP-STRING "/") KWD-READ-QUALIFIED-NAME
      (WRAP-STRING "\\") KWD-READ-ESCAPED-SYMBOL-ESCAPE (WRAP-STRING ":")
      (LIST* KWD-READ-SYMBOL-OR-CL-SYMBOL3 KWD-READ-SYMBOL NIL) (WRAP-STRING "|") KWD-READ-ERROR KWD-READ-OTHERWISE
      KWD-READ-SYMBOL NIL)
     (LIST* KWD-READ-SYMBOL-OR-CL-SYMBOL3 KWD-READ-INCLUDE KWD-READ-DELIMITER (WRAP-STRING "|") KWD-READ-ERROR
      KWD-READ-OTHERWISE KWD-READ-CL-SYMBOL NIL)
     (LIST* KWD-READ-CL-SYMBOL KWD-READ-INCLUDE KWD-READ-DELIMITER (WRAP-STRING "|") KWD-READ-ERROR KWD-READ-OTHERWISE
      KWD-READ-CL-SYMBOL NIL)
     (LIST* KWD-READ-ESCAPED-SYMBOL-ESCAPE KWD-READ-ANY KWD-READ-ESCAPED-SYMBOL NIL)
     (LIST* KWD-READ-ESCAPED-SYMBOL KWD-READ-INCLUDE KWD-READ-DELIMITER (WRAP-STRING "/|") KWD-READ-ERROR
      (WRAP-STRING "\\") KWD-READ-ESCAPED-SYMBOL-ESCAPE KWD-READ-OTHERWISE KWD-READ-ESCAPED-SYMBOL NIL)
     (LIST* KWD-READ-OPEN-FULLY-ESCAPED-SYMBOL SYM-READ-STELLA-* (WRAP-STRING "|") KWD-READ-CLOSE-FULLY-ESCAPED-NAME
      (WRAP-STRING "\\") KWD-READ-FULLY-ESCAPED-SYMBOL-ESCAPE KWD-READ-OTHERWISE KWD-READ-FULLY-ESCAPED-SYMBOL NIL)
     (LIST* KWD-READ-FULLY-ESCAPED-SYMBOL-ESCAPE KWD-READ-ANY KWD-READ-FULLY-ESCAPED-SYMBOL NIL)
     (LIST* KWD-READ-FULLY-ESCAPED-SYMBOL SYM-READ-STELLA-* (WRAP-STRING "|") KWD-READ-CLOSE-FULLY-ESCAPED-NAME
      (WRAP-STRING "\\") KWD-READ-FULLY-ESCAPED-SYMBOL-ESCAPE KWD-READ-OTHERWISE KWD-READ-FULLY-ESCAPED-SYMBOL NIL)
     (LIST* KWD-READ-CLOSE-FULLY-ESCAPED-NAME KWD-READ-INCLUDE KWD-READ-START NIL)
     (LIST* KWD-READ-SYMBOL KWD-READ-INCLUDE KWD-READ-DELIMITER (WRAP-STRING "/") KWD-READ-QUALIFIED-NAME
      (WRAP-STRING "\\") KWD-READ-ESCAPED-SYMBOL-ESCAPE (WRAP-STRING "|") KWD-READ-ERROR KWD-READ-OTHERWISE
      KWD-READ-SYMBOL NIL)
     (LIST* KWD-READ-OPEN-KEYWORD KWD-READ-INCLUDE KWD-READ-DELIMITER (WRAP-STRING "|") KWD-READ-FULLY-ESCAPED-KEYWORD
      (WRAP-STRING "\\") KWD-READ-ESCAPED-KEYWORD-ESCAPE KWD-READ-OTHERWISE KWD-READ-KEYWORD NIL)
     (LIST* KWD-READ-KEYWORD KWD-READ-INCLUDE KWD-READ-DELIMITER (WRAP-STRING "\\") KWD-READ-ESCAPED-KEYWORD-ESCAPE
      (WRAP-STRING "|") KWD-READ-ERROR KWD-READ-OTHERWISE KWD-READ-KEYWORD NIL)
     (LIST* KWD-READ-ESCAPED-KEYWORD-ESCAPE KWD-READ-ANY KWD-READ-ESCAPED-KEYWORD NIL)
     (LIST* KWD-READ-ESCAPED-KEYWORD KWD-READ-INCLUDE KWD-READ-DELIMITER (WRAP-STRING "\\")
      KWD-READ-ESCAPED-KEYWORD-ESCAPE (WRAP-STRING "|") KWD-READ-ERROR KWD-READ-OTHERWISE KWD-READ-ESCAPED-KEYWORD NIL)
     (LIST* KWD-READ-FULLY-ESCAPED-KEYWORD SYM-READ-STELLA-* (WRAP-STRING "|") KWD-READ-CLOSE-FULLY-ESCAPED-NAME
      (WRAP-STRING "\\") KWD-READ-FULLY-ESCAPED-KEYWORD-ESCAPE KWD-READ-OTHERWISE KWD-READ-FULLY-ESCAPED-KEYWORD NIL)
     (LIST* KWD-READ-FULLY-ESCAPED-KEYWORD-ESCAPE KWD-READ-ANY KWD-READ-FULLY-ESCAPED-KEYWORD NIL)
     (LIST* KWD-READ-OPEN-SURROGATE KWD-READ-INCLUDE KWD-READ-DELIMITER (WRAP-STRING "|")
      KWD-READ-FULLY-ESCAPED-SURROGATE (WRAP-STRING "\\") KWD-READ-ESCAPED-SURROGATE-ESCAPE KWD-READ-OTHERWISE
      KWD-READ-SURROGATE NIL)
     (LIST* KWD-READ-SURROGATE KWD-READ-INCLUDE KWD-READ-DELIMITER (WRAP-STRING "/|") KWD-READ-ERROR (WRAP-STRING "\\")
      KWD-READ-ESCAPED-SURROGATE-ESCAPE KWD-READ-OTHERWISE KWD-READ-SURROGATE NIL)
     (LIST* KWD-READ-ESCAPED-SURROGATE KWD-READ-INCLUDE KWD-READ-DELIMITER (WRAP-STRING "/|") KWD-READ-ERROR
      (WRAP-STRING "\\") KWD-READ-ESCAPED-SURROGATE-ESCAPE KWD-READ-OTHERWISE KWD-READ-ESCAPED-SURROGATE NIL)
     (LIST* KWD-READ-ESCAPED-SURROGATE-ESCAPE KWD-READ-ANY KWD-READ-ESCAPED-SURROGATE NIL)
     (LIST* KWD-READ-FULLY-ESCAPED-SURROGATE SYM-READ-STELLA-* (WRAP-STRING "|") KWD-READ-CLOSE-FULLY-ESCAPED-NAME
      (WRAP-STRING "\\") KWD-READ-FULLY-ESCAPED-SURROGATE-ESCAPE KWD-READ-OTHERWISE KWD-READ-FULLY-ESCAPED-SURROGATE
      NIL)
     (LIST* KWD-READ-FULLY-ESCAPED-SURROGATE-ESCAPE KWD-READ-ANY KWD-READ-FULLY-ESCAPED-SURROGATE NIL)
     (LIST* KWD-READ-QUALIFIED-NAME KWD-READ-INCLUDE KWD-READ-DELIMITER (WRAP-STRING "@") KWD-READ-QUALIFIED-SURROGATE
      (WRAP-STRING ":") KWD-READ-ERROR (WRAP-STRING "\\") KWD-READ-QUALIFIED-ESCAPED-SYMBOL-ESCAPE (WRAP-STRING "|")
      KWD-READ-QUALIFIED-FULLY-ESCAPED-SYMBOL (WRAP-STRING "/") KWD-READ-QUALIFIED-NAME KWD-READ-OTHERWISE
      KWD-READ-QUALIFIED-SYMBOL NIL)
     (LIST* KWD-READ-QUALIFIED-SYMBOL KWD-READ-INCLUDE KWD-READ-DELIMITER (WRAP-STRING "/") KWD-READ-QUALIFIED-NAME
      (WRAP-STRING "\\") KWD-READ-QUALIFIED-ESCAPED-SYMBOL-ESCAPE (WRAP-STRING "|") KWD-READ-ERROR KWD-READ-OTHERWISE
      KWD-READ-QUALIFIED-SYMBOL NIL)
     (LIST* KWD-READ-QUALIFIED-SURROGATE KWD-READ-INCLUDE KWD-READ-DELIMITER (WRAP-STRING "/") KWD-READ-ERROR
      (WRAP-STRING "\\") KWD-READ-QUALIFIED-ESCAPED-SURROGATE-ESCAPE (WRAP-STRING "|")
      KWD-READ-QUALIFIED-FULLY-ESCAPED-SURROGATE KWD-READ-OTHERWISE KWD-READ-QUALIFIED-SURROGATE NIL)
     (LIST* KWD-READ-QUALIFIED-ESCAPED-SYMBOL KWD-READ-INCLUDE KWD-READ-DELIMITER (WRAP-STRING "/|") KWD-READ-ERROR
      (WRAP-STRING "\\") KWD-READ-QUALIFIED-ESCAPED-SYMBOL-ESCAPE KWD-READ-OTHERWISE KWD-READ-QUALIFIED-ESCAPED-SYMBOL
      NIL)
     (LIST* KWD-READ-QUALIFIED-ESCAPED-SYMBOL-ESCAPE KWD-READ-ANY KWD-READ-QUALIFIED-ESCAPED-SYMBOL NIL)
     (LIST* KWD-READ-QUALIFIED-ESCAPED-SURROGATE KWD-READ-INCLUDE KWD-READ-DELIMITER (WRAP-STRING "/|") KWD-READ-ERROR
      (WRAP-STRING "\\") KWD-READ-QUALIFIED-ESCAPED-SURROGATE-ESCAPE KWD-READ-OTHERWISE
     ...
     (LIST* KWD-READ-QUALIFIED-FULLY-ESCAPED-SYMBOL SYM-READ-STELLA-* (WRAP-STRING "|")
      KWD-READ-CLOSE-FULLY-ESCAPED-NAME (WRAP-STRING "\\") KWD-READ-QUALIFIED-FULLY-ESCAPED-SYMBOL-ESCAPE
     ...
     (LIST* KWD-READ-QUALIFIED-FULLY-ESCAPED-SURROGATE SYM-READ-STELLA-* (WRAP-STRING "|")
      KWD-READ-CLOSE-FULLY-ESCAPED-NAME (WRAP-STRING "\\") KWD-READ-QUALIFIED-FULLY-ESCAPED-SURROGATE-ESCAPE
      KWD-READ-OTHERWISE KWD-READ-QUALIFIED-FULLY-ESCAPED-SURROGATE NIL)
     (LIST* KWD-READ-QUALIFIED-FULLY-ESCAPED-SURROGATE-ESCAPE KWD-READ-ANY KWD-READ-QUALIFIED-FULLY-ESCAPED-SURROGATE
      NIL)
   ...
   (CL:LET* ((SELF-061 (NEW-PROPERTY-LIST)))
    (CL:SETF (%THE-PLIST SELF-061)
     (LIST* KWD-READ-SYMBOL KWD-READ-SYMBOL KWD-READ-ESCAPED-SYMBOL KWD-READ-SYMBOL KWD-READ-FULLY-ESCAPED-SYMBOL
      KWD-READ-SYMBOL KWD-READ-QUALIFIED-SYMBOL KWD-READ-SYMBOL KWD-READ-QUALIFIED-ESCAPED-SYMBOL KWD-READ-SYMBOL
      KWD-READ-QUALIFIED-FULLY-ESCAPED-SYMBOL KWD-READ-SYMBOL KWD-READ-CL-SYMBOL KWD-READ-SYMBOL KWD-READ-SURROGATE
      KWD-READ-SURROGATE KWD-READ-ESCAPED-SURROGATE KWD-READ-SURROGATE KWD-READ-QUALIFIED-SURROGATE KWD-READ-SURROGATE
      KWD-READ-QUALIFIED-ESCAPED-SURROGATE KWD-READ-SURROGATE KWD-READ-FULLY-ESCAPED-SURROGATE KWD-READ-SURROGATE
      KWD-READ-QUALIFIED-FULLY-ESCAPED-SURROGATE KWD-READ-SURROGATE KWD-READ-KEYWORD KWD-READ-KEYWORD
      KWD-READ-ESCAPED-KEYWORD KWD-READ-KEYWORD KWD-READ-FULLY-ESCAPED-KEYWORD KWD-READ-KEYWORD KWD-READ-QUALIFIED-NAME
      KWD-READ-QUALIFIED-NAME KWD-READ-STRING KWD-READ-STRING KWD-READ-ESCAPED-STRING KWD-READ-STRING KWD-READ-INTEGER
      KWD-READ-INTEGER KWD-READ-FLOAT KWD-READ-FLOAT KWD-READ-CHARACTER KWD-READ-CHARACTER KWD-READ-OPEN-PAREN
      KWD-READ-OPEN-PAREN KWD-READ-CLOSE-PAREN KWD-READ-CLOSE-PAREN KWD-READ-SINGLE-QUOTE KWD-READ-SINGLE-QUOTE
      KWD-READ-BACK-QUOTE KWD-READ-BACK-QUOTE KWD-READ-COMMA KWD-READ-COMMA KWD-READ-COMMA-SPLICE KWD-READ-COMMA-SPLICE
      KWD-READ-CLOSE-STRING KWD-READ-CLOSE-BALANCED-QUOTE KWD-READ-CLOSE-FULLY-ESCAPED-NAME
   ...
   (CL:LET* ((I NULL-INTEGER) (ITER-063 0) (UPPER-BOUND-064 (CL:1- (LENGTH *STELLA-LOGICAL-STATE-NAMES*))))
      ...
      ((SELF (%THE-ARRAY *STELLA-LOGICAL-STATE-NAMES*))
       (VALUE
        (LOOKUP *STELLA-LOGICAL-STATE-NAMES-TABLE*
         (CL:AREF (CL:THE CL:SIMPLE-VECTOR (%THE-ARRAY (%STATE-NAMES *STELLA-TOKENIZER-TABLE*))) I)))
       (POSITION I))
      (CL:DECLARE (CL:TYPE CL:SIMPLE-VECTOR SELF) (CL:TYPE CL:FIXNUM POSITION))
      (CL:SETF (CL:AREF SELF POSITION) VALUE))
   ...
   (CL:SETQ *GET-TOKEN-INTEGER-CHECKPOINT*
    (CL:LET ((X (CL:- MOST-POSITIVE-INTEGER 9)) (Y 10)) (CL:DECLARE (CL:TYPE CL:FIXNUM X Y))
     (CL:THE CL:FIXNUM (CL:VALUES (CL:TRUNCATE X Y)))))
   (CL:SETQ *GET-TOKEN-LONG-INTEGER-CHECKPOINT*
    (CL:LET ((X (CL:- MOST-POSITIVE-LONG-INTEGER 9)) (Y 10)) (CL:VALUES (CL:TRUNCATE X Y))))
   (CL:SETQ *STELLA-TOKENIZER-WHITE-SPACE-STATE*
    (POSITION (%STATE-NAMES *STELLA-TOKENIZER-TABLE*) KWD-READ-WHITE-SPACE 0))
   (CL:SETQ *READ-LINE-TOKENIZER-TABLE-DEFINITION*
    (LIST*
     (LIST* KWD-READ-START SYM-READ-STELLA-* (CONS (WRAP-CHARACTER #\Linefeed) NIL) KWD-READ-INITIAL-LINEFEED
      SYM-READ-STELLA-* (CONS (WRAP-CHARACTER #\Return) NIL) KWD-READ-INITIAL-RETURN KWD-READ-EOF KWD-READ-EOF
      SYM-READ-STELLA-* KWD-READ-OTHERWISE KWD-READ-LINE NIL)
     (LIST* KWD-READ-INITIAL-LINEFEED KWD-READ-INCLUDE KWD-READ-LINEFEED NIL)
     (LIST* KWD-READ-INITIAL-RETURN KWD-READ-INCLUDE KWD-READ-RETURN NIL)
     (LIST* KWD-READ-RETURN SYM-READ-STELLA-* (CONS (WRAP-CHARACTER #\Linefeed) NIL) KWD-READ-LINEFEED
      SYM-READ-STELLA-* (CONS (WRAP-CHARACTER #\Return) NIL) KWD-READ-INITIAL-RETURN KWD-READ-EOF KWD-READ-EOF
      SYM-READ-STELLA-* KWD-READ-OTHERWISE KWD-READ-LINE NIL)
     (LIST* KWD-READ-LINEFEED KWD-READ-EOF KWD-READ-EOF SYM-READ-STELLA-* (CONS (WRAP-CHARACTER #\Linefeed) NIL)
      KWD-READ-INITIAL-LINEFEED SYM-READ-STELLA-* (CONS (WRAP-CHARACTER #\Return) NIL) KWD-READ-INITIAL-RETURN
      SYM-READ-STELLA-* KWD-READ-OTHERWISE KWD-READ-LINE NIL)
     (LIST* KWD-READ-LINE SYM-READ-STELLA-* (CONS (WRAP-CHARACTER #\Linefeed) NIL) KWD-READ-LINEFEED SYM-READ-STELLA-*
      (CONS (WRAP-CHARACTER #\Return) NIL) KWD-READ-RETURN SYM-READ-STELLA-* KWD-READ-EOF KWD-READ-EOF
      KWD-READ-OTHERWISE KWD-READ-LINE NIL)
     (LIST* KWD-READ-ERROR KWD-READ-INCLUDE KWD-READ-START NIL) NIL))
   (CL:SETQ *READ-LINE2-TOKENIZER-TABLE-DEFINITION*
    (LIST*
     (LIST* KWD-READ-START SYM-READ-STELLA-* (CONS (WRAP-CHARACTER #\Linefeed) NIL) KWD-READ-LINEFEED SYM-READ-STELLA-*
      (CONS (WRAP-CHARACTER #\Return) NIL) KWD-READ-RETURN KWD-READ-EOF KWD-READ-EOF SYM-READ-STELLA-*
      KWD-READ-OTHERWISE KWD-READ-LINE NIL)
     (LIST* KWD-READ-LINE SYM-READ-STELLA-* (CONS (WRAP-CHARACTER #\Linefeed) NIL) KWD-READ-LINEFEED SYM-READ-STELLA-*
      (CONS (WRAP-CHARACTER #\Return) NIL) KWD-READ-RETURN SYM-READ-STELLA-* KWD-READ-EOF KWD-READ-EOF
      KWD-READ-OTHERWISE KWD-READ-LINE NIL)
     (LIST* KWD-READ-RETURN SYM-READ-STELLA-* KWD-READ-EOF KWD-READ-EOF (CONS (WRAP-CHARACTER #\Linefeed) NIL)
      KWD-READ-RETURN-LINEFEED SYM-READ-STELLA-* (CONS (WRAP-CHARACTER #\Return) NIL) KWD-READ-RETURN SYM-READ-STELLA-*
      KWD-READ-OTHERWISE KWD-READ-LINE NIL)
     (LIST* KWD-READ-LINEFEED KWD-READ-EOF KWD-READ-EOF SYM-READ-STELLA-* (CONS (WRAP-CHARACTER #\Linefeed) NIL)
      KWD-READ-LINEFEED SYM-READ-STELLA-* (CONS (WRAP-CHARACTER #\Return) NIL) KWD-READ-RETURN SYM-READ-STELLA-*
      KWD-READ-OTHERWISE KWD-READ-LINE NIL)
     (LIST* KWD-READ-RETURN-LINEFEED SYM-READ-STELLA-* KWD-READ-EOF KWD-READ-EOF SYM-READ-STELLA-*
      (CONS (WRAP-CHARACTER #\Linefeed) NIL) KWD-READ-LINEFEED SYM-READ-STELLA-* (CONS (WRAP-CHARACTER #\Return) NIL)
      KWD-READ-RETURN SYM-READ-STELLA-* KWD-READ-OTHERWISE KWD-READ-LINE NIL)
     (LIST* KWD-READ-ERROR KWD-READ-INCLUDE KWD-READ-START NIL) NIL))
...
according to a particular tokenization `table'.\" :PUBLIC? TRUE :PARAMETERS ((ANY-VALUE :TYPE TOKENIZER-TOKEN)) :SLOTS ((STREAM :TYPE INPUT-STREAM :REQUIRED? TRUE) (TABLE :TYPE TOKENIZER-TABLE :REQUIRED? TRUE) (TOKEN :RENAMES VALUE)))")))
   ...
   (CL:LET*
    ...
    (CL:SETF (%CLASS-CONSTRUCTOR-CODE CLASS) (CL:FUNCTION NEW-STELLA-TOKEN))
    (CL:SETF (%CLASS-SLOT-ACCESSOR-CODE CLASS) (CL:FUNCTION ACCESS-STELLA-TOKEN-SLOT-VALUE))))
  :VOID)
...
(CL:DEFUN HELP-STARTUP-READ7 ()
  (CL:PROGN
   ...
   (DEFINE-FUNCTION-OBJECT "LEGAL-TOKENIZER-STATE?" "(DEFUN (LEGAL-TOKENIZER-STATE? BOOLEAN) ((X OBJECT)))"
    (CL:FUNCTION LEGAL-TOKENIZER-STATE?) NULL)
   (DEFINE-FUNCTION-OBJECT "LEGAL-TOKENIZER-FROM-STATE?" "(DEFUN (LEGAL-TOKENIZER-FROM-STATE? BOOLEAN) ((X OBJECT)))"
    (CL:FUNCTION LEGAL-TOKENIZER-FROM-STATE?) NULL)
   (DEFINE-FUNCTION-OBJECT "LEGAL-TOKENIZER-TO-STATE?" "(DEFUN (LEGAL-TOKENIZER-TO-STATE? BOOLEAN) ((X OBJECT)))"
    (CL:FUNCTION LEGAL-TOKENIZER-TO-STATE?) NULL)
   (DEFINE-FUNCTION-OBJECT "TOKENIZER-TO-STATE-NAME"
    "(DEFUN (TOKENIZER-TO-STATE-NAME GENERALIZED-SYMBOL) ((STATE OBJECT)))" (CL:FUNCTION TOKENIZER-TO-STATE-NAME) NULL)
   (DEFINE-FUNCTION-OBJECT "TOKENIZER-TO-STATE-ALIAS"
    "(DEFUN (TOKENIZER-TO-STATE-ALIAS GENERALIZED-SYMBOL) ((STATE OBJECT)))" (CL:FUNCTION TOKENIZER-TO-STATE-ALIAS)
    NULL)
   ...
   (DEFINE-FUNCTION-OBJECT "TOKENIZER-INCLUDE-SPEC?" "(DEFUN (TOKENIZER-INCLUDE-SPEC? BOOLEAN) ((X OBJECT)))"
   ...
   (DEFINE-FUNCTION-OBJECT "STRINGIFY-TOKENIZER-TABLE"
    "(DEFUN (STRINGIFY-TOKENIZER-TABLE STRING) ((TABLE TOKENIZER-TABLE)))" (CL:FUNCTION STRINGIFY-TOKENIZER-TABLE)
    NULL)
   (DEFINE-FUNCTION-OBJECT "UNSTRINGIFY-TOKENIZER-TABLE"
    "(DEFUN (UNSTRINGIFY-TOKENIZER-TABLE TOKENIZER-TABLE) ((TABLE STRING)))" (CL:FUNCTION UNSTRINGIFY-TOKENIZER-TABLE)
    NULL)
...
`start' stopping just before `end'.\")" (CL:FUNCTION BYTE-ARRAY-WRITE-SEQUENCE) NULL)
   ...
   (DEFINE-METHOD-OBJECT "(DEFMETHOD (BUFFERED-INPUT-LENGTH INTEGER) ((STATE TOKENIZER-STREAM-STATE)))"
   ...
   (DEFINE-FUNCTION-OBJECT "WITH-TOKENIZER-STRING-INPUT?" "(DEFUN (WITH-TOKENIZER-STRING-INPUT? BOOLEAN) ())"
    (CL:FUNCTION WITH-TOKENIZER-STRING-INPUT?) NULL)
   (DEFINE-FUNCTION-OBJECT "INSIDE-WITH-TOKENIZER?" "(DEFUN (INSIDE-WITH-TOKENIZER? BOOLEAN) ())"
    (CL:FUNCTION INSIDE-WITH-TOKENIZER?) NULL)
   (DEFINE-FUNCTION-OBJECT "END-OF-TOKENS?" "(DEFUN END-OF-TOKENS? () :TYPE OBJECT :MACRO? TRUE :PUBLIC? TRUE)"
   ...
   (DEFINE-FUNCTION-OBJECT "GET-TOKEN-TYPE" "(DEFUN GET-TOKEN-TYPE () :TYPE OBJECT :MACRO? TRUE)"
    (CL:FUNCTION GET-TOKEN-TYPE) NULL)
   (DEFINE-FUNCTION-OBJECT "SAVE-TOKENIZER-STREAM-STATE"
    "(DEFUN SAVE-TOKENIZER-STREAM-STATE () :TYPE OBJECT :MACRO? TRUE)" (CL:FUNCTION SAVE-TOKENIZER-STREAM-STATE) NULL)
   (DEFINE-FUNCTION-OBJECT "GET-NEXT-TOKEN" "(DEFUN GET-NEXT-TOKEN (|&BODY| (OPTIONS CONS)) :TYPE OBJECT :MACRO? TRUE)"
   ...
   (DEFINE-FUNCTION-OBJECT "GET-STELLA-TOKEN-TYPE" "(DEFUN GET-STELLA-TOKEN-TYPE () :TYPE OBJECT :MACRO? TRUE)"
...
escape characters).\" :PUBLIC? TRUE)" (CL:FUNCTION QUALIFIED-STELLA-NAME?) NULL)
   ...
   (DEFINE-FUNCTION-OBJECT "EXPAND-QUOTE-MACRO-TOKEN" "(DEFUN EXPAND-QUOTE-MACRO-TOKEN ((QUOTEDLIST STELLA-TOKEN)))"
    (CL:FUNCTION EXPAND-QUOTE-MACRO-TOKEN) NULL)
   (DEFINE-FUNCTION-OBJECT "STRING-TO-CHARACTER" "(DEFUN (STRING-TO-CHARACTER CHARACTER) ((NAME STRING)))"
...
(CL:DEFUN STARTUP-READ ()
  (CL:LET* ((*MODULE* *STELLA-MODULE*) (*CONTEXT* *MODULE*)) (CL:DECLARE (CL:SPECIAL *MODULE* *CONTEXT*))
   (CL:WHEN (CURRENT-STARTUP-TIME-PHASE? 2) (HELP-STARTUP-READ1) (HELP-STARTUP-READ2) (HELP-STARTUP-READ3)
    (HELP-STARTUP-READ4))
...
the result.  Return `true' as the second value on EOF.\" :PUBLIC? TRUE)" (CL:FUNCTION READ-S-EXPRESSION) NULL)
    ...
    (DEFINE-FUNCTION-OBJECT "CONSUME-WHITESPACE" "(DEFUN (CONSUME-WHITESPACE BOOLEAN) ((STREAM INPUT-STREAM)))"
...
the input is read.  See also special variable `*USER-QUERY-ACTION*'.\" :PUBLIC? TRUE)" (CL:FUNCTION Y-OR-N?) NULL)
    ...
    (CL:LET* ((FUNCTION (LOOKUP-FUNCTION SYM-READ-STELLA-STARTUP-READ)))
     (SET-DYNAMIC-SLOT-VALUE (%DYNAMIC-SLOTS FUNCTION) SYM-READ-STELLA-METHOD-STARTUP-CLASSNAME
