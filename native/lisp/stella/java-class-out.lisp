...
(CL:DECLAIM
 (CL:SPECIAL *STELLA-MODULE* *MODULE* *CONTEXT* *TRANSLATIONUNITS* FALSE-WRAPPER
  TRUE NULL-STRING-WRAPPER NIL))
...
(CL:DEFUN JAVA-YIELD-INSTANCE-VAR-TREE (SLOT CLASS)
  (CL:LET*
   ...
   (CL:COND
    ((CL:EQ ALLOCATION KWD-JAVA-CLASS-OUT-EMBEDDED) (CL:SETQ ALLOCATIONFORM NIL))
  ...
  (CL:LET* ((INSTANCEVARDEFS NIL) (SUPERCLASS NULL))
   ...
   (CL:LET*
    ...
    (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-001 NIL)) DO
     ...
     (CL:SETQ SUPERCLASS (GET-STELLA-CLASS SUPER TRUE))
     (CL:WHEN (%MIXIN? SUPERCLASS)
      (CL:LET*
       ((SLOT NULL) (ITER-002 (CLASS-SLOTS SUPERCLASS)) (COLLECT-001 NULL))
  ...
  (CL:LET* ((CONSTRUCTORDEFINITIONS NIL) (METHODDEFINITIONS NIL) (METHOD NULL))
   (CL:LET* ((TU NULL) (ITER-000 (%THE-CONS-LIST *TRANSLATIONUNITS*)))
    (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-000 NIL)) DO
     (CL:PROGN (CL:SETQ TU (%%VALUE ITER-000))
     ...
     (CL:WHEN
      ...
      (CL:IF (CL:EQ (%CATEGORY TU) SYM-JAVA-CLASS-OUT-STELLA-PRINT-METHOD)
       (CL:WHEN
        (CL:EQ (CANONICAL-TYPE (%CLASS-TYPE (%THE-OBJECT TU)))
         (%CLASS-TYPE CLASS))
        ...
        (CL:COND
         ...
         ((%WRAPPER-VALUE
           (DYNAMIC-SLOT-VALUE (%DYNAMIC-SLOTS METHOD)
            SYM-JAVA-CLASS-OUT-STELLA-METHOD-CONSTRUCTOR? FALSE-WRAPPER))
          (CL:WHEN
           (CL:EQ (CANONICAL-TYPE (%SLOT-BASE-TYPE METHOD)) (%CLASS-TYPE CLASS))
...
(CL:DEFUN JAVA-TRANSLATE-DEFINE-NATIVE-CLASS-UNIT (UNIT)
  (CL:RETURN-FROM JAVA-TRANSLATE-DEFINE-NATIVE-CLASS-UNIT
   (JAVA-TRANSLATE-DEFINE-NATIVE-CLASS (%THE-OBJECT UNIT))))
    ...
    (CL:WHEN (CL:NOT (CL:EQ (FIRST (%CLASS-DIRECT-SUPERS CLASS)) NULL))
     (CL:SETQ PARENTCLASS
      (JAVA-TRANSLATE-CLASS-NAME
       (TYPE-TO-SYMBOL (FIRST (%CLASS-DIRECT-SUPERS CLASS))))))
    ...
    (CL:RETURN-FROM JAVA-TRANSLATE-DEFINE-NATIVE-CLASS
     (CONS
      ...
      (CONS
       ...
       (CONS MODIFIERS
        (CONS
         (CL:IF (%MIXIN? CLASS) (WRAP-STRING "interface") (WRAP-STRING "class"))
         (CONS
          (JAVA-TRANSLATE-CLASS-NAME
...
(CL:DEFUN STARTUP-JAVA-CLASS-OUT ()
  (CL:LET* ((*MODULE* *STELLA-MODULE*) (*CONTEXT* *MODULE*))
   ...
   (CL:WHEN (CURRENT-STARTUP-TIME-PHASE? 7)
    ...
    (CL:LET*
     ((FUNCTION
       (LOOKUP-FUNCTION SYM-JAVA-CLASS-OUT-STELLA-STARTUP-JAVA-CLASS-OUT)))
     (SET-DYNAMIC-SLOT-VALUE (%DYNAMIC-SLOTS FUNCTION)
      SYM-JAVA-CLASS-OUT-STELLA-METHOD-STARTUP-CLASSNAME
      (WRAP-STRING "_Startup-Java-Class-Out") NULL-STRING-WRAPPER)))
