...
(CL:DEFVAR SYM-DEMONS-STELLA-DEFDEMON-EXPANDER NULL)
...
(CL:DECLAIM
 (CL:SPECIAL *STELLA-MODULE* *MODULE* STANDARD-ERROR TRUE-WRAPPER
  STANDARD-OUTPUT EOL))
...
:destroy, :class, :slot, :guard?, :code, :method, :inherit?, and :documentation."
  ...
  (CL:LET*
   ...
   (CL:SETF (%THE-PLIST PLIST) CONSLIST)
   (CL:SETF (%DEMON-NAME DEMON) NAME)
   (CL:SETQ ACTIVATE?
   ...
   (CL:COND
     ...
     (CL:IF (%DEMON-ALL? DEMON)
      ...
      (CL:LET*
       ...
       (CL:LOOP WHILE
        ...
        (CL:TAGBODY
         (CL:LET*
          ((SLOT (SAFE-LOOKUP-SLOT (%SURROGATE-VALUE TYPE) SLOTNAME)))
    ...
    ((CL:EQ TEST-VALUE-000 KWD-DEMONS-CREATE)
     (CL:IF (%DEMON-ALL? DEMON)
      ...
      (CL:LET*
       ((CLASSREF NULL)
        (ITER-002 (%THE-CONS-LIST (%DEMON-CLASS-REFS DEMON))))
    ...
    ((CL:EQ TEST-VALUE-000 KWD-DEMONS-DESTROY)
     (CL:IF (%DEMON-ALL? DEMON)
      ...
      (CL:LET*
       ((CLASSREF NULL)
        (ITER-003 (%THE-CONS-LIST (%DEMON-CLASS-REFS DEMON))))
...
(CL:DEFUN DEFDEMON-EXPANDER (NAME PARAMETERSTREE OPTIONSANDBODY)
  ...
  (CL:LET*
   ...
   (CL:LET* ((OPTIONSTREE NULL) (BODYTREE NULL))
    ...
    (CL:RETURN-FROM DEFDEMON-EXPANDER
...
(CL:DEFUN READ-SLOT-VALUE (SELF SLOT)
  (CL:LET*
   ((CODE
     (%CLASS-SLOT-ACCESSOR-CODE (%SURROGATE-VALUE (%SLOT-OWNER SLOT)))))
...
(CL:DEFUN WRITE-SLOT-VALUE (SELF SLOT VALUE)
  (CL:LET*
   ...
   (CL:IF (SUBTYPE-OF? (PRIMARY-TYPE SELF) (%SLOT-OWNER SLOT))
    (CL:WARN
     "write-slot-value: No generic slot writer available for `~A'." SLOT)
    (CL:WARN
  ...
  (CL:LET* ((CLASS (PRIMARY-CLASS SELF)))
   (CL:WHEN (CL:NOT (CL:EQ CLASS NULL))
    (CL:WHEN (CL:NOT (CL:EQ *CONSTRUCTOR-DEMONS* NULL))
     (CL:LET*
      ((DEMON NULL) (ITER-000 (%THE-CONS-LIST *CONSTRUCTOR-DEMONS*)))
      (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-000 NIL)) DO
       (CL:PROGN (CL:SETQ DEMON (%%VALUE ITER-000))
        (CL:SETQ ITER-000 (%%REST ITER-000)))
  ...
  (CL:LET* ((CLASS (PRIMARY-CLASS SELF)))
   (CL:WHEN (CL:NOT (CL:EQ CLASS NULL))
    (CL:WHEN (CL:NOT (CL:EQ *DESTRUCTOR-DEMONS* NULL))
     (CL:LET*
      ((DEMON NULL) (ITER-000 (%THE-CONS-LIST *DESTRUCTOR-DEMONS*)))
      (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-000 NIL)) DO
       (CL:PROGN (CL:SETQ DEMON (%%VALUE ITER-000))
        (CL:SETQ ITER-000 (%%REST ITER-000)))
       (CL:FUNCALL (%DEMON-CODE DEMON) SELF CLASS))))
          ...
          (LIST*
           (LIST* SYM-DEMONS-STELLA-WRAPPEDOLDVALUE
            (LIST* SYM-DEMONS-STELLA-CHOOSE
             (LIST* SYM-DEMONS-STELLA-DEFINED? SYM-DEMONS-STELLA-OLDVALUE
              NIL)
...
(CL:DEFCLASS HOOK-LIST (KEY-VALUE-LIST)
  ((SIGNATURE :ALLOCATION :INSTANCE :ACCESSOR %SIGNATURE)
...
(CL:DEFUN HELP-STARTUP-DEMONS1 ()
  (CL:PROGN
   ...
   (CL:SETQ SYM-DEMONS-STELLA-DEFDEMON-EXPANDER
...
structure.\")" (CL:FUNCTION DEACTIVATE-DEMON) NULL)
    ...
    (DEFINE-FUNCTION-OBJECT "DEFDEMON-EXPANDER"
     ...
     (CL:FUNCTION DEFDEMON-EXPANDER) NULL)
...
each one to 'argument'.\")" (CL:FUNCTION RUN-HOOKS) NULL)
    ...
    (CL:LET*
     ...
     (SET-DYNAMIC-SLOT-VALUE (%DYNAMIC-SLOTS FUNCTION)
      ...
      (WRAP-STRING "Startup-Demons") NULL-STRING-WRAPPER)))
...
cancel slot update when they return FALSE.\")")
    (STORE-MACRO SYM-DEMONS-STELLA-DEFDEMON
     SYM-DEMONS-STELLA-DEFDEMON-EXPANDER (CL:FUNCTION DEFDEMON-EXPANDER))
    (DEFINE-STELLA-GLOBAL-VARIABLE-FROM-STRINGIFIED-SOURCE
