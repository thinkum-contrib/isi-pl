...
(CL:DECLAIM
 (CL:SPECIAL *STELLA-MODULE* *MODULE* STANDARD-ERROR TRUE-WRAPPER NIL
  STANDARD-OUTPUT TRUE FALSE EOL))
...
(CL:DEFUN INCORPORATE-DEMON-OPTIONS? (DEMON OPTIONS)
  ...
  (CL:LET* ((V NULL) (K NULL) (ITER-000 (%THE-PLIST OPTIONS)))
   (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-000 NIL)) DO (CL:SETQ K (%%VALUE ITER-000))
    (CL:PROGN (CL:SETQ V (%%VALUE (%%REST ITER-000)))
    ...
    (CL:LET* ((TEST-VALUE-000 K))
     (CL:COND
      ((CL:OR (CL:EQ TEST-VALUE-000 KWD-DEMONS-CREATE)
       ...
       (CL:IF (CL:EQ V KWD-DEMONS-ALL) (CL:SETF (%DEMON-ALL? DEMON) TRUE)
      ...
      ((CL:EQ TEST-VALUE-000 KWD-DEMONS-GUARD?)
       (CL:SETF (%DEMON-GUARD? DEMON) TRUE))
      ((CL:EQ TEST-VALUE-000 KWD-DEMONS-INHERITED?)
       (CL:SETF (%DEMON-INHERIT? DEMON) TRUE)
   ...
   (CL:COND
    ((CL:EQ TEST-VALUE-000 KWD-DEMONS-MODIFY)
     (CL:IF (%DEMON-ALL? DEMON)
      ...
      (CL:LET*
       ((SLOTNAME NULL) (TYPE NULL)
        (ITER-000 (%THE-CONS-LIST (%DEMON-CLASS-REFS DEMON)))
        ...
        (CL:TAGBODY
         (CL:LET* ((SLOT (LOOKUP-SLOT (%SURROGATE-VALUE TYPE) SLOTNAME)))
          ...
          (CL:IF (%DEMON-GUARD? DEMON)
           ...
           (SET-DYNAMIC-SLOT-VALUE (%DYNAMIC-SLOTS SLOT)
            SYM-DEMONS-STELLA-SLOT-DEMONS (INJECT-DEMON (SLOT-DEMONS SLOT) DEMON)
            NULL)))
         :CONTINUE)))))
     ...
     (CL:IF (%DEMON-ALL? DEMON)
      ...
      (CL:LET*
       ...
       (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-002 NIL)) DO
        (CL:PROGN (CL:SETQ CLASSREF (%%VALUE ITER-002))
     ...
     (CL:IF (%DEMON-ALL? DEMON)
      ...
      (CL:LET*
       ...
       (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-003 NIL)) DO
        (CL:PROGN (CL:SETQ CLASSREF (%%VALUE ITER-003))
        ...
        (CL:TAGBODY
         (CL:LET* ((SLOT (LOOKUP-SLOT (%SURROGATE-VALUE TYPE) SLOTNAME)))
          ...
          (CL:IF (%DEMON-GUARD? DEMON)
           ...
           (SET-DYNAMIC-SLOT-VALUE (%DYNAMIC-SLOTS SLOT)
            SYM-DEMONS-STELLA-SLOT-DEMONS (EJECT-DEMON (SLOT-DEMONS SLOT) DEMON)
            NULL)))
         :CONTINUE)))))
    ((CL:EQ TEST-VALUE-000 KWD-DEMONS-CREATE)
     (CL:IF (%DEMON-ALL? DEMON)
...
(CL:DEFUN IN-PLACE-NORMALIZE-DEMON-OPTIONS (OPTIONSTREE)
  (CL:LET* ((IT (ALLOCATE-ITERATOR OPTIONSTREE)))
   (CL:LOOP WHILE (NEXT? IT) DO
    (CL:COND
     ((WRAPPER? (%VALUE IT))
      (VALUE-SETTER IT (LIST* SYM-DEMONS-STELLA-WRAP-LITERAL (%VALUE IT) NIL)))
   ...
   (CL:WHEN (CL:EQ (%SURROGATE-VALUE TYPE) NULL)
    (CL:LET* ((*PRINTREADABLY?* TRUE)) (CL:DECLARE (CL:SPECIAL *PRINTREADABLY?*))
     ...
     (CL:WHEN (CL:NOT (SUPPRESS-WARNINGS?))
      (PRINT-ERROR-CONTEXT ">> ERROR: " STANDARD-ERROR)
      (%%PRINT-STREAM (%NATIVE-STREAM STANDARD-ERROR) EOL
       " Demon defined on the non-existent class `" (DE-UGLIFY-PARSE-TREE TYPE)
       "'." EOL)))
    (CL:RETURN-FROM %DEFDEMON NIL))
  ...
  (CL:LET*
   ...
   (CL:WHEN (CL:NOT (CL:EQ CODE NULL))
    (CL:RETURN-FROM READ-SLOT-VALUE
     (CL:FUNCALL CODE SELF (%SLOT-NAME SLOT) NULL FALSE)))
  ...
  (CL:LET*
   ...
   (CL:WHEN (CL:NOT (CL:EQ CODE NULL))
    (CL:RETURN-FROM WRITE-SLOT-VALUE
     (CL:FUNCALL CODE SELF (%SLOT-NAME SLOT) VALUE TRUE)))
   (CL:IF (SUBTYPE-OF? (PRIMARY-TYPE SELF) (%SLOT-OWNER SLOT))
  ...
  (CL:WHEN (CL:NOT (CL:EQ *ALL-SLOTS-GUARD-DEMONS* NULL))
   (CL:LET* ((DEMON NULL) (ITER-000 (%THE-CONS-LIST *ALL-SLOTS-GUARD-DEMONS*)))
    (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-000 NIL)) DO
     (CL:PROGN (CL:SETQ DEMON (%%VALUE ITER-000))
      (CL:SETQ ITER-000 (%%REST ITER-000)))
     (CL:WHEN
  ...
  (CL:WHEN (CL:NOT (CL:EQ (SLOT-GUARD-DEMONS SLOT) NULL))
   (CL:LET* ((DEMON NULL) (ITER-001 (%THE-CONS-LIST (SLOT-GUARD-DEMONS SLOT))))
    (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-001 NIL)) DO
     (CL:PROGN (CL:SETQ DEMON (%%VALUE ITER-001))
      (CL:SETQ ITER-001 (%%REST ITER-001)))
     (CL:WHEN
      (CL:NOT (CL:FUNCALL (%DEMON-CODE DEMON) SELF SLOT OLDVALUE NEWVALUE))
      (CL:RETURN-FROM RUN-SLOT-GUARD-DEMONS? FALSE)))))
  ...
  (CL:LET* ((CLASS (PRIMARY-CLASS SELF)))
   (CL:WHEN (CL:NOT (CL:EQ CLASS NULL))
    ...
    (CL:WHEN (CL:NOT (CL:EQ (CLASS-CONSTRUCTOR-DEMONS CLASS) NULL))
     (CL:LET*
      ((DEMON NULL) (ITER-001 (%THE-CONS-LIST (CLASS-CONSTRUCTOR-DEMONS CLASS))))
      (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-001 NIL)) DO
       (CL:PROGN (CL:SETQ DEMON (%%VALUE ITER-001))
        (CL:SETQ ITER-001 (%%REST ITER-001)))
       (CL:FUNCALL (%DEMON-CODE DEMON) SELF CLASS))))))
  ...
  (CL:LET* ((CLASS (PRIMARY-CLASS SELF)))
   (CL:WHEN (CL:NOT (CL:EQ CLASS NULL))
    ...
    (CL:WHEN (CL:NOT (CL:EQ (CLASS-DESTRUCTOR-DEMONS CLASS) NULL))
     (CL:LET*
      ((DEMON NULL) (ITER-001 (%THE-CONS-LIST (CLASS-DESTRUCTOR-DEMONS CLASS))))
      (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-001 NIL)) DO
       (CL:PROGN (CL:SETQ DEMON (%%VALUE ITER-001))
        (CL:SETQ ITER-001 (%%REST ITER-001)))
       (CL:FUNCALL (%DEMON-CODE DEMON) SELF CLASS))))))
      ...
      (LIST* SYM-DEMONS-STELLA-LET
       (CONS
        (LIST* SYM-DEMONS-STELLA-VALUE
         (LIST* SYM-DEMONS-STELLA-SLOT-VALUE SYM-DEMONS-STELLA-SELF SLOTNAME NIL)
         NIL)
        NIL)
     ...
     (CL:RETURN-FROM YIELD-ACTIVE-SLOT-WRITER-BODY
      (LIST* SYM-DEMONS-STELLA-PROGN SYM-DEMONS-STELLA-VALUE
       (LIST* SYM-DEMONS-STELLA-CANT-OVERWRITE-ACTIVE-COLLECTION-SLOT
        SYM-DEMONS-STELLA-SELF (LIST* SYM-DEMONS-STELLA-BQUOTE SLOTNAME NIL) NIL)
      ...
      (LIST* SYM-DEMONS-STELLA-LET
       ...
       (LIST* SYM-DEMONS-STELLA-WHEN
        ...
        (LIST* SYM-DEMONS-STELLA-IF
         (LIST* SYM-DEMONS-STELLA-CHECK-FOR-SLOT-DEMONS? SYM-DEMONS-STELLA-SLOT
          NIL)
         (LIST* SYM-DEMONS-STELLA-LET
          (LIST*
           ...
           NIL)
          (LIST* SYM-DEMONS-STELLA-WHEN
           (LIST* SYM-DEMONS-STELLA-RUN-SLOT-GUARD-DEMONS? SYM-DEMONS-STELLA-SELF
           ...
           (LIST* SYM-DEMONS-STELLA-RUN-SLOT-DEMONS SYM-DEMONS-STELLA-SELF
            ...
            SYM-DEMONS-STELLA-WRAPPEDNEWVALUE NIL)
           (LIST* SYM-DEMONS-STELLA-WHEN
            (LIST* SYM-DEMONS-STELLA-DEFINED? SYM-DEMONS-STELLA-WRAPPEDOLDVALUE
             NIL)
            (LIST* SYM-DEMONS-STELLA-FREE SYM-DEMONS-STELLA-WRAPPEDOLDVALUE NIL)
            NIL)
           (LIST* SYM-DEMONS-STELLA-WHEN
            (LIST* SYM-DEMONS-STELLA-DEFINED? SYM-DEMONS-STELLA-WRAPPEDNEWVALUE
             NIL)
            (LIST* SYM-DEMONS-STELLA-FREE SYM-DEMONS-STELLA-WRAPPEDNEWVALUE NIL)
            NIL)
           (LIST* SYM-DEMONS-STELLA-RETURN SYM-DEMONS-STELLA-VALUE NIL) NIL)
...
(CL:DEFUN NEW-HOOK-LIST ()
  (CL:LET* ((SELF NULL)) (CL:SETQ SELF (CL:MAKE-INSTANCE (CL:QUOTE HOOK-LIST)))
...
(CL:DEFUN HELP-STARTUP-DEMONS1 ()
  (CL:PROGN
   (CL:SETQ KWD-DEMONS-MODIFY (INTERN-RIGID-SYMBOL-WRT-MODULE "MODIFY" NULL 2))
   ...
   (CL:SETQ SYM-DEMONS-STELLA-CANT-OVERWRITE-ACTIVE-COLLECTION-SLOT
    (INTERN-RIGID-SYMBOL-WRT-MODULE "CANT-OVERWRITE-ACTIVE-COLLECTION-SLOT" NULL
     0))
...
(CL:DEFUN HELP-STARTUP-DEMONS2 ()
  (CL:PROGN
   (CL:SETQ SYM-DEMONS-STELLA-AND (INTERN-RIGID-SYMBOL-WRT-MODULE "AND" NULL 0))
...
each one to `argument'.\")" (CL:FUNCTION RUN-HOOKS) NULL)
    (DEFINE-FUNCTION-OBJECT "STARTUP-DEMONS"
     "(DEFUN STARTUP-DEMONS () :PUBLIC? TRUE)" (CL:FUNCTION STARTUP-DEMONS) NULL)
    (CL:LET* ((FUNCTION (LOOKUP-FUNCTION SYM-DEMONS-STELLA-STARTUP-DEMONS)))
     (SET-DYNAMIC-SLOT-VALUE (%DYNAMIC-SLOTS FUNCTION)
      SYM-DEMONS-STELLA-METHOD-STARTUP-CLASSNAME (WRAP-STRING "_Startup-Demons")
      NULL-STRING-WRAPPER)))
