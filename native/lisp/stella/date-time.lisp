...
(CL:DEFVAR SYM-DATE-TIME-STELLA-DEFUN NULL)
(CL:DEFVAR SYM-DATE-TIME-STELLA-BOOLEAN NULL)
(CL:DEFVAR SYM-DATE-TIME-STELLA-T1 NULL)
(CL:DEFVAR SYM-DATE-TIME-STELLA-DATE-TIME-OBJECT NULL)
...
(CL:DEFVAR SYM-DATE-TIME-STELLA-ERROR NULL)
...
(CL:DECLAIM
 (CL:SPECIAL *STELLA-MODULE* *MODULE* NIL *PRINTREADABLY?* FALSE NULL-FLOAT
  NULL-INTEGER PI))
  ...
  (CL:LET* ((JUL 0) (JA 0) (JY 0) (JM 0))
   ...
   (CL:WHEN (CL:< MM 0)
    (CL:LET* ((STREAM-001 (NEW-OUTPUT-STRING-STREAM)))
     (%%PRINT-STREAM (%NATIVE-STREAM STREAM-001) "Month `" MM
      "' must be > zero.")
   ...
   (CL:SETQ JUL
    (CL:+ (FLOOR (CL:* 365.25d0 JY)) (FLOOR (CL:* 30.6001d0 JM)) DD 1720995))
   (CL:WHEN
...
(CL:DECLAIM
 (CL:FTYPE (CL:FUNCTION (CL:FIXNUM) CL:FIXNUM) JULIAN-DAY-TO-MODIFIED-JULIAN-DAY))
...
(CL:DECLAIM
 (CL:FTYPE (CL:FUNCTION (CL:FIXNUM) CL:FIXNUM) MODIFIED-JULIAN-DAY-TO-JULIAN-DAY))
...
:FULL-MOON, :LAST-QUARTER"
  ...
  (CL:LET*
   ((I 0) (AM 0.0d0) (AS 0.0d0) (C 0.0d0) (X 0.0d0) (X2 0.0d0) (EXTRA 0.0d0)
    (RAD (CL:/ PI 180.0d0)) (JULIAN-DAY 0))
   (CL:DECLARE (CL:TYPE CL:FIXNUM I JULIAN-DAY)
    (CL:TYPE CL:DOUBLE-FLOAT AM AS C X X2 EXTRA RAD))
   (CL:COND
    ((CL:EQ PHASE KWD-DATE-TIME-NEW-MOON) (CL:SETQ C (CL:FLOAT N 0.0d0))
     (CL:SETQ JULIAN-DAY 0))
    ((CL:EQ PHASE KWD-DATE-TIME-FIRST-QUARTER) (CL:SETQ C (CL:+ N 0.25d0))
     (CL:SETQ JULIAN-DAY 7))
    ((CL:EQ PHASE KWD-DATE-TIME-FULL-MOON) (CL:SETQ C (CL:+ N 0.5d0))
     (CL:SETQ JULIAN-DAY 14))
    ((CL:EQ PHASE KWD-DATE-TIME-LAST-QUARTER) (CL:SETQ C (CL:+ N 0.75d0))
     (CL:SETQ JULIAN-DAY 21))
    (CL:T
     (CL:LET* ((STREAM-000 (NEW-OUTPUT-STRING-STREAM)))
      (%%PRINT-STREAM (%NATIVE-STREAM STREAM-000) "`" PHASE
   ...
   (CL:COND
    ...
    (CL:T
     (CL:LET* ((STREAM-001 (NEW-OUTPUT-STRING-STREAM)))
      (%%PRINT-STREAM (%NATIVE-STREAM STREAM-001) "`" PHASE
       "' is not a valid case option")
      (CL:ERROR (NEW-STELLA-EXCEPTION (THE-STRING-READER STREAM-001))))))
   (CL:SETQ I
    (CL:IF (CL:>= EXTRA 0.0d0) (FLOOR EXTRA) (CEILING (CL:- EXTRA 1.0d0))))
   (CL:RETURN-FROM COMPUTE-NEXT-MOON-PHASE
    (CL:VALUES (CL:+ JULIAN-DAY I) (CL:- EXTRA I)))))
(CL:DECLAIM
 (CL:FTYPE (CL:FUNCTION (CL:FIXNUM CL:T) (CL:VALUES CL:FIXNUM CL:DOUBLE-FLOAT))
...
`julian-day' begins at noon."
  ...
  (CL:CHECK-TYPE JULIAN-DAY CL:FIXNUM)
  (CL:LET*
   ((JA JULIAN-DAY) (JALPHA 0) (JB 0) (JC 0) (JD 0) (JE 0) (IGREG 2299161)
    (YYYY 0) (MM 0) (DD 0))
   ...
   (CL:SETQ JC
    (CL:TRUNCATE (CL:+ 6680.0d0 (CL:/ (CL:- JB 2439870 122.1d0) 365.25d0))))
   ...
   (CL:SETQ MM (CL:1- JE)) (CL:WHEN (CL:> MM 12) (CL:SETQ MM (CL:- MM 12)))
...
(CL:DECLAIM
 (CL:FTYPE
  (CL:FUNCTION (CL:FIXNUM) (CL:VALUES CL:FIXNUM CL:FIXNUM CL:FIXNUM CL:T))
...
millisecond will always be zero (even in Java where it is technically available)."
  ...
  (CL:LET*
   ...
   (CL:RETURN-FROM GET-CURRENT-DATE-TIME
    (CL:VALUES YEAR MONTH DAY (COMPUTE-DAY-OF-WEEK YEAR MONTH DAY) HOUR MINUTE
     SECOND MILLISECOND))))
(CL:DECLAIM
 (CL:FTYPE
  (CL:FUNCTION ()
   (CL:VALUES CL:FIXNUM CL:FIXNUM CL:FIXNUM CL:T CL:FIXNUM CL:FIXNUM CL:FIXNUM
    CL:FIXNUM))
...
considering the effects of daylight savings time."
  (CL:LET* ((OFFSET 0.0d0)) (CL:DECLARE (CL:TYPE CL:DOUBLE-FLOAT OFFSET))
...
(CL:DECLAIM
 (CL:FTYPE (CL:FUNCTION () CL:DOUBLE-FLOAT) GET-LOCAL-STANDARD-TIME-ZONE))
...
(CL:DECLAIM
 (CL:FTYPE
  (CL:FUNCTION (CL:FIXNUM CL:FIXNUM CL:FIXNUM CL:FIXNUM CL:FIXNUM CL:FIXNUM)
   CL:DOUBLE-FLOAT)
...
(CL:DEFCLASS DECODED-DATE-TIME (STANDARD-OBJECT)
  ((DATE-TIME-MILLIS :TYPE CL:DOUBLE-FLOAT :INITFORM NULL-FLOAT :ALLOCATION
    :INSTANCE :ACCESSOR %DATE-TIME-MILLIS)
   (DATE-TIME-SECOND :TYPE CL:FIXNUM :INITFORM NULL-INTEGER :ALLOCATION :INSTANCE
    :ACCESSOR %DATE-TIME-SECOND)
   (DATE-TIME-MINUTE :TYPE CL:FIXNUM :INITFORM NULL-INTEGER :ALLOCATION :INSTANCE
    :ACCESSOR %DATE-TIME-MINUTE)
   (DATE-TIME-HOUR :TYPE CL:FIXNUM :INITFORM NULL-INTEGER :ALLOCATION :INSTANCE
    :ACCESSOR %DATE-TIME-HOUR)
   (DATE-TIME-DAY :TYPE CL:FIXNUM :INITFORM NULL-INTEGER :ALLOCATION :INSTANCE
    :ACCESSOR %DATE-TIME-DAY)
   (DATE-TIME-MONTH :TYPE CL:FIXNUM :INITFORM NULL-INTEGER :ALLOCATION :INSTANCE
    :ACCESSOR %DATE-TIME-MONTH)
   (DATE-TIME-YEAR :TYPE CL:FIXNUM :INITFORM NULL-INTEGER :ALLOCATION :INSTANCE
    :ACCESSOR %DATE-TIME-YEAR)
   (DATE-TIME-ZONE :TYPE CL:DOUBLE-FLOAT :INITFORM NULL-FLOAT :ALLOCATION
    :INSTANCE :ACCESSOR %DATE-TIME-ZONE)
...
(CL:DEFUN NEW-DECODED-DATE-TIME ()
  (CL:LET* ((SELF NULL))
   (CL:SETQ SELF (CL:MAKE-INSTANCE (CL:QUOTE DECODED-DATE-TIME)))
   (CL:SETF (%DATE-TIME-DOW SELF) KWD-DATE-TIME-SUNDAY)
   (CL:SETF (%DATE-TIME-ZONE SELF) 0.0d0) (CL:SETF (%DATE-TIME-YEAR SELF) 1900)
   (CL:SETF (%DATE-TIME-MONTH SELF) 1) (CL:SETF (%DATE-TIME-DAY SELF) 1)
   (CL:SETF (%DATE-TIME-HOUR SELF) 0) (CL:SETF (%DATE-TIME-MINUTE SELF) 0)
   (CL:SETF (%DATE-TIME-SECOND SELF) 0) (CL:SETF (%DATE-TIME-MILLIS SELF) 0.0d0)
...
(CL:DEFUN ACCESS-DECODED-DATE-TIME-SLOT-VALUE (SELF SLOTNAME VALUE SETVALUE?)
  (CL:COND
   ...
   ((CL:EQ SLOTNAME SYM-DATE-TIME-STELLA-DATE-TIME-DOW)
    (CL:IF SETVALUE? (CL:SETF (%DATE-TIME-DOW SELF) VALUE)
     (CL:SETQ VALUE (%DATE-TIME-DOW SELF))))
   (CL:T
    (CL:LET* ((STREAM-000 (NEW-OUTPUT-STRING-STREAM)))
    ...
    (CL:LOGXOR
     (CL:THE CL:FIXNUM
      (CL:LOGIOR
       (CL:THE CL:FIXNUM
        (CL:LOGIOR
         (CL:THE CL:FIXNUM (CL:ASH (CL:THE CL:FIXNUM (%DATE-TIME-YEAR SELF)) 9))
         (CL:THE CL:FIXNUM
          (CL:ASH (CL:THE CL:FIXNUM (%DATE-TIME-MONTH SELF)) 5))))
       (CL:THE CL:FIXNUM (%DATE-TIME-DAY SELF))))
     (CL:THE CL:FIXNUM
      (CL:LOGIOR
       (CL:THE CL:FIXNUM
        (CL:LOGIOR
         (CL:THE CL:FIXNUM (CL:ASH (CL:THE CL:FIXNUM (%DATE-TIME-HOUR SELF)) 12))
         (CL:THE CL:FIXNUM
          (CL:ASH (CL:THE CL:FIXNUM (%DATE-TIME-MINUTE SELF)) 6))))
       (CL:THE CL:FIXNUM (%DATE-TIME-SECOND SELF))))))))

;;; (DEFUN SET-CURRENT-TIME ...)

(CL:DEFUN SET-CURRENT-TIME (VALUES-STRUCTURE)
  (CL:LET*
   ((YEAR NULL-INTEGER) (MON NULL-INTEGER) (DAY NULL-INTEGER) (DOW NULL)
   ...
   (CL:SETF (%DATE-TIME-SECOND VALUES-STRUCTURE) SEC)
   (CL:SETF (%DATE-TIME-MINUTE VALUES-STRUCTURE) MIN)
   (CL:SETF (%DATE-TIME-HOUR VALUES-STRUCTURE) HOUR))
  :VOID)

;;; (DEFUN SET-CURRENT-DATE ...)

(CL:DEFUN SET-CURRENT-DATE (VALUES-STRUCTURE)
  (CL:LET*
   ((YEAR NULL-INTEGER) (MON NULL-INTEGER) (DAY NULL-INTEGER) (DOW NULL)
    (HOUR NULL-INTEGER) (MIN NULL-INTEGER) (SEC NULL-INTEGER)
    (MILLIS NULL-INTEGER))
   ...
   (CL:SETF (%DATE-TIME-DOW VALUES-STRUCTURE) DOW)
   (CL:SETF (%DATE-TIME-DAY VALUES-STRUCTURE) DAY)
   (CL:SETF (%DATE-TIME-MONTH VALUES-STRUCTURE) MON)
   (CL:SETF (%DATE-TIME-YEAR VALUES-STRUCTURE) YEAR))
  :VOID)

;;; (DEFUN SET-CURRENT-DATE-TIME ...)

(CL:DEFUN SET-CURRENT-DATE-TIME (VALUES-STRUCTURE)
  (CL:LET*
   ((YEAR NULL-INTEGER) (MON NULL-INTEGER) (DAY NULL-INTEGER) (DOW NULL)
    (HOUR NULL-INTEGER) (MIN NULL-INTEGER) (SEC NULL-INTEGER)
    (MILLIS NULL-INTEGER))
...
(CL:DEFCLASS DECODED-TIME-DURATION (STANDARD-OBJECT)
  ((DURATION-MILLIS :TYPE CL:DOUBLE-FLOAT :INITFORM NULL-FLOAT :ALLOCATION
    :INSTANCE :ACCESSOR %DURATION-MILLIS)
   (DURATION-SECONDS :TYPE CL:FIXNUM :INITFORM NULL-INTEGER :ALLOCATION :INSTANCE
    :ACCESSOR %DURATION-SECONDS)
   (DURATION-MINUTES :TYPE CL:FIXNUM :INITFORM NULL-INTEGER :ALLOCATION :INSTANCE
    :ACCESSOR %DURATION-MINUTES)
   (DURATION-HOURS :TYPE CL:FIXNUM :INITFORM NULL-INTEGER :ALLOCATION :INSTANCE
    :ACCESSOR %DURATION-HOURS)
   (DURATION-DAYS :TYPE CL:FIXNUM :INITFORM NULL-INTEGER :ALLOCATION :INSTANCE
    :ACCESSOR %DURATION-DAYS))
...
(CL:DEFUN NEW-DECODED-TIME-DURATION ()
  (CL:LET* ((SELF NULL))
   (CL:SETQ SELF (CL:MAKE-INSTANCE (CL:QUOTE DECODED-TIME-DURATION)))
   (CL:SETF (%DURATION-DAYS SELF) 0) (CL:SETF (%DURATION-HOURS SELF) 0)
   (CL:SETF (%DURATION-MINUTES SELF) 0) (CL:SETF (%DURATION-SECONDS SELF) 0)
   (CL:SETF (%DURATION-MILLIS SELF) 0.0d0)
    ...
    (CL:LOGXOR (CL:THE CL:FIXNUM (%DURATION-DAYS SELF))
     (CL:THE CL:FIXNUM
      (CL:LOGIOR
       (CL:THE CL:FIXNUM
        (CL:LOGIOR
         (CL:THE CL:FIXNUM (CL:ASH (CL:THE CL:FIXNUM (%DURATION-HOURS SELF)) 12))
         (CL:THE CL:FIXNUM
          (CL:ASH (CL:THE CL:FIXNUM (%DURATION-MINUTES SELF)) 6))))
       (CL:THE CL:FIXNUM (%DURATION-SECONDS SELF))))))))

;;; (DEFCLASS DATE-TIME-OBJECT ...)

(CL:DEFCLASS DATE-TIME-OBJECT (STANDARD-OBJECT)
  ())

;;; (DEFCLASS CALENDAR-DATE ...)

(CL:DEFCLASS CALENDAR-DATE (DATE-TIME-OBJECT)
  ((MODIFIED-JULIAN-DAY :TYPE CL:FIXNUM :INITFORM NULL-INTEGER :ALLOCATION
    :INSTANCE :ACCESSOR %MODIFIED-JULIAN-DAY)
   (TIME-MILLIS :TYPE CL:FIXNUM :INITFORM NULL-INTEGER :ALLOCATION :INSTANCE
    :ACCESSOR %TIME-MILLIS))
...
(CL:DEFUN NEW-CALENDAR-DATE ()
  (CL:LET* ((SELF NULL))
   (CL:SETQ SELF (CL:MAKE-INSTANCE (CL:QUOTE CALENDAR-DATE)))
   (CL:SETF (%TIME-MILLIS SELF) NULL-INTEGER)
   (CL:SETF (%MODIFIED-JULIAN-DAY SELF) NULL-INTEGER)
...
(CL:DEFMETHOD HASH-CODE ((SELF CALENDAR-DATE))
  (CL:RETURN-FROM HASH-CODE
   (CL:THE CL:FIXNUM
    (CL:LOGXOR (CL:THE CL:FIXNUM (%MODIFIED-JULIAN-DAY SELF))
     (CL:THE CL:FIXNUM (%TIME-MILLIS SELF))))))

;;; (DEFUN (CALENDAR-DATE-TO-STRING STRING) ...)

(CL:DEFUN CALENDAR-DATE-TO-STRING (DATE TIMEZONE INCLUDE-TIMEZONE?)
  ...
  (CL:LET*
   ...
   (CL:LET*
    ...
    (CL:LET*
     ((YEAR-STRING
       (CL:IF (CL:< YEAR 0) (CONCATENATE (INTEGER-TO-STRING (CL:- 0 YEAR)) "BC")
      ...
      (TIMEZONE-STRING
       (CL:IF INCLUDE-TIMEZONE?
        ...
        "")))
     (CL:DECLARE (CL:TYPE CL:SIMPLE-STRING YEAR-STRING TIMEZONE-STRING))
     (CL:RETURN-FROM CALENDAR-DATE-TO-STRING
      (CONCATENATE YEAR-STRING "-"
       (%WRAPPER-VALUE
        (CL:AREF
         (CL:THE CL:SIMPLE-VECTOR (%THE-ARRAY *MONTH-ABBREVIATION-VECTOR*))
         MONTH))
       "-"
       (FORMAT-WITH-PADDING (INTEGER-TO-STRING DAY) 2 #\0 KWD-DATE-TIME-RIGHT
        FALSE)
       " " (INTEGER-TO-STRING HOURS) ":"
       (FORMAT-WITH-PADDING (INTEGER-TO-STRING MINUTES) 2 #\0 KWD-DATE-TIME-RIGHT
        FALSE)
       ":"
       (FORMAT-WITH-PADDING (INTEGER-TO-STRING SECONDS) 2 #\0 KWD-DATE-TIME-RIGHT
        FALSE)
       "."
       (FORMAT-WITH-PADDING (INTEGER-TO-STRING MILLI) 3 #\0 KWD-DATE-TIME-RIGHT
        FALSE)
       TIMEZONE-STRING))))))
(CL:DECLAIM
 (CL:FTYPE (CL:FUNCTION (CL:T CL:DOUBLE-FLOAT CL:T) CL:SIMPLE-STRING)
  CALENDAR-DATE-TO-STRING))

;;; (DEFUN (CALENDAR-DATE-TO-NATIVE-DATE-TIME NATIVE-DATE-TIME) ...)

(CL:DEFUN CALENDAR-DATE-TO-NATIVE-DATE-TIME (DATE)
  (CL:LET* ((MJD (%MODIFIED-JULIAN-DAY DATE)) (MILLIS (%TIME-MILLIS DATE)))
...
;;; (DEFUN PRINT-CALENDAR-DATE ...)

(CL:DEFUN PRINT-CALENDAR-DATE (DATE STREAM)
  (CL:IF *PRINTREADABLY?* (%%PRINT-STREAM STREAM "\"")
   (%%PRINT-STREAM STREAM "<" (%MODIFIED-JULIAN-DAY DATE) " "))
  (%%PRINT-STREAM STREAM (CALENDAR-DATE-TO-STRING DATE 0.0d0 FALSE))
...
(CL:DEFCLASS TIME-DURATION (DATE-TIME-OBJECT)
  ((DAYS :TYPE CL:FIXNUM :INITFORM NULL-INTEGER :ALLOCATION :INSTANCE :ACCESSOR
    %DAYS)
   (MILLIS :TYPE CL:FIXNUM :INITFORM NULL-INTEGER :ALLOCATION :INSTANCE :ACCESSOR
    %MILLIS))
  (:DOCUMENTATION
...
(CL:DEFUN NEW-TIME-DURATION ()
  (CL:LET* ((SELF NULL))
   (CL:SETQ SELF (CL:MAKE-INSTANCE (CL:QUOTE TIME-DURATION)))
   (CL:SETF (%MILLIS SELF) NULL-INTEGER) (CL:SETF (%DAYS SELF) NULL-INTEGER)
...
(CL:DEFUN ACCESS-TIME-DURATION-SLOT-VALUE (SELF SLOTNAME VALUE SETVALUE?)
  (CL:COND
   ((CL:EQ SLOTNAME SYM-DATE-TIME-STELLA-DAYS)
    (CL:IF SETVALUE? (CL:SETF (%DAYS SELF) (%WRAPPER-VALUE VALUE))
     (CL:SETQ VALUE (WRAP-INTEGER (%DAYS SELF)))))
   ((CL:EQ SLOTNAME SYM-DATE-TIME-STELLA-MILLIS)
    (CL:IF SETVALUE? (CL:SETF (%MILLIS SELF) (%WRAPPER-VALUE VALUE))
     (CL:SETQ VALUE (WRAP-INTEGER (%MILLIS SELF)))))
   (CL:T
    (CL:LET* ((STREAM-000 (NEW-OUTPUT-STRING-STREAM)))
     (%%PRINT-STREAM (%NATIVE-STREAM STREAM-000) "`" SLOTNAME
      "' is not a valid case option")
...
(CL:DEFMETHOD HASH-CODE ((SELF TIME-DURATION))
  (CL:RETURN-FROM HASH-CODE
   (CL:THE CL:FIXNUM
    (CL:LOGXOR (CL:THE CL:FIXNUM (%DAYS SELF))
     (CL:THE CL:FIXNUM (%MILLIS SELF))))))

;;; (DEFUN (TIME-DURATION-TO-STRING STRING) ...)

(CL:DEFUN TIME-DURATION-TO-STRING (DATE)
  "Returns a string representation of `date'"
  (CL:LET* ((N-DAYS (%DAYS DATE)) (N-MILLIS (%MILLIS DATE)))
   (CL:DECLARE (CL:TYPE CL:FIXNUM N-DAYS N-MILLIS))
   (CL:IF (CL:< N-DAYS 0)
    (CL:IF (CL:<= N-MILLIS 0)
     (CL:RETURN-FROM TIME-DURATION-TO-STRING
      (CONCATENATE "minus " (INTEGER-TO-STRING (CL:- 0 N-DAYS)) " days; "
       (INTEGER-TO-STRING (CL:- 0 N-MILLIS)) " ms"))
     (CL:RETURN-FROM TIME-DURATION-TO-STRING
      (CONCATENATE "minus " (INTEGER-TO-STRING (CL:- 0 (CL:1+ N-DAYS))) " days; "
       (INTEGER-TO-STRING (CL:- MILLIS-PER-DAY N-MILLIS)) " ms")))
    (CL:IF (CL:< N-MILLIS 0)
     (CL:IF (CL:> N-DAYS 0)
      (CL:RETURN-FROM TIME-DURATION-TO-STRING
       (CONCATENATE "plus " (INTEGER-TO-STRING (CL:1- N-DAYS)) " days; "
        (INTEGER-TO-STRING (CL:+ MILLIS-PER-DAY N-MILLIS)) " ms"))
      (CL:RETURN-FROM TIME-DURATION-TO-STRING
       (CONCATENATE "minus 0 days; " (INTEGER-TO-STRING (CL:- 0 N-MILLIS))
        " ms")))
     (CL:RETURN-FROM TIME-DURATION-TO-STRING
      (CONCATENATE "plus " (INTEGER-TO-STRING N-DAYS) " days; "
       (INTEGER-TO-STRING N-MILLIS) " ms"))))))
(CL:DECLAIM
 (CL:FTYPE (CL:FUNCTION (CL:T) CL:SIMPLE-STRING) TIME-DURATION-TO-STRING))
...
integer values for days and milliseconds.  If no valid parse is found, `null' is returned."
  ...
  (CL:LET*
   ((N-DAYS 0) (N-MILLIS 0)
    ...
    (MS-END-POSITION 0))
   (CL:DECLARE
    (CL:TYPE CL:FIXNUM N-DAYS N-MILLIS DAY-START-POSITION DAY-END-POSITION
     MS-START-POSITION MS-END-POSITION))
   (CL:COND (NEGATIVE? (CL:SETQ DAY-START-POSITION 6))
    ((DEFINED? (STRING-SEARCH DURATION "plus" 0)) (CL:SETQ DAY-START-POSITION 5))
    (CL:T (CL:SETQ DAY-START-POSITION 0)))
   (CL:SETQ DAY-END-POSITION (STRING-SEARCH DURATION "days" DAY-START-POSITION))
   (CL:IF (NULL? DAY-END-POSITION) (CL:RETURN-FROM STRING-TO-TIME-DURATION NULL)
    (CL:SETQ N-DAYS
     (STRING-TO-INTEGER
      (SUBSEQUENCE DURATION DAY-START-POSITION (CL:1- DAY-END-POSITION)))))
   (CL:SETQ MS-START-POSITION (POSITION DURATION #\  DAY-END-POSITION))
   (CL:WHEN (DEFINED? MS-START-POSITION)
    (CL:SETQ MS-END-POSITION (STRING-SEARCH DURATION "ms" MS-START-POSITION))
    (CL:WHEN (DEFINED? MS-END-POSITION)
     (CL:SETQ N-MILLIS
      (STRING-TO-INTEGER
       (SUBSEQUENCE DURATION MS-START-POSITION (CL:1- MS-END-POSITION))))))
   (CL:RETURN-FROM STRING-TO-TIME-DURATION (MAKE-TIME-DURATION N-DAYS N-MILLIS))))

;;; (DEFUN PRINT-TIME-DURATION ...)

(CL:DEFUN PRINT-TIME-DURATION (DATE STREAM)
...
is the number of hours to add to UTC to arrive at local time."
  (CL:DECLARE (CL:TYPE CL:FIXNUM YEAR MONTH DAY HOUR MINUTE SECOND MILLIS)
  ...
  (CL:LET*
   ((TIME
     (CL:+ (CL:* HOUR MILLIS-PER-HOUR) (CL:* MINUTE 60000) (CL:* SECOND 1000)
      MILLIS)))
   ...
   (CL:RETURN-FROM MAKE-DATE-TIME
    (MAKE-CALENDAR-DATE
     (JULIAN-DAY-TO-MODIFIED-JULIAN-DAY (COMPUTE-JULIAN-DAY YEAR MONTH DAY))
     TIME))))
...
(CL:DEFUN MAKE-CURRENT-DATE-TIME ()
  ...
  (CL:LET*
   ...
   (CL:DECLARE (CL:TYPE CL:FIXNUM YEAR MONTH DAY HOUR MINUTE SECOND MILLISECOND))
   (CL:MULTIPLE-VALUE-SETQ (YEAR MONTH DAY DOW HOUR MINUTE SECOND MILLISECOND)
    (GET-CURRENT-DATE-TIME))
   (CL:SETQ DOW DOW)
   (CL:RETURN-FROM MAKE-CURRENT-DATE-TIME
    (MAKE-DATE-TIME YEAR MONTH DAY HOUR MINUTE SECOND MILLISECOND 0.0d0))))
...
(CL:DEFUN MAKE-CALENDAR-DATE (DAY TIME)
  ...
  (CL:LOOP WHILE (CL:< TIME 0) DO (CL:SETQ TIME (CL:+ TIME MILLIS-PER-DAY))
   (CL:SETQ DAY (CL:1- DAY)))
  ...
  (CL:LET* ((SELF-000 (NEW-CALENDAR-DATE)))
   (CL:SETF (%MODIFIED-JULIAN-DAY SELF-000) DAY)
...
(CL:DEFUN MAKE-TIME-DURATION (DAYS MILLIS)
  ...
  (CL:LOOP WHILE (CL:< MILLIS (CL:- 0 MILLIS-PER-DAY)) DO
   (CL:SETQ MILLIS (CL:+ MILLIS MILLIS-PER-DAY)) (CL:SETQ DAYS (CL:1- DAYS)))
  ...
  (CL:COND
   ...
   ((CL:> DAYS 0)
    (CL:WHEN (CL:< MILLIS 0) (CL:SETQ DAYS (CL:1- DAYS))
     (CL:SETQ MILLIS (CL:+ MILLIS MILLIS-PER-DAY))))
   (CL:T))
  (CL:LET* ((SELF-000 (NEW-TIME-DURATION))) (CL:SETF (%DAYS SELF-000) DAYS)
   (CL:SETF (%MILLIS SELF-000) MILLIS)
...
(CL:DECLAIM
 (CL:FTYPE
  (CL:FUNCTION (CL:FIXNUM) (CL:VALUES CL:FIXNUM CL:FIXNUM CL:FIXNUM CL:FIXNUM))
...
is in the range -12.0 to +14.0 where UTC is zone 0.0"
  ...
  (CL:WHEN (CL:= TIMEZONE NULL-FLOAT)
   (CL:WARN "Timezone not specified in GET-CALENDAR-DATE  Using local zone.")
   (CL:LET*
    ((YEAR NULL-INTEGER) (MONTH NULL-INTEGER) (DAY NULL-INTEGER) (DOW NULL))
    (CL:DECLARE (CL:TYPE CL:FIXNUM YEAR MONTH DAY))
    (CL:MULTIPLE-VALUE-SETQ (YEAR MONTH DAY DOW)
   ...
   (CL:RETURN-FROM GET-CALENDAR-DATE
    (COMPUTE-CALENDAR-DATE
     (MODIFIED-JULIAN-DAY-TO-JULIAN-DAY
      (CL:+ (%MODIFIED-JULIAN-DAY DATE) DAY-OFFSET))))))
...
to get local time.  It is in the range -12.0 to +14.0 where UTC is zone 0.0"
  ...
  (CL:COND
   ((CL:= TIMEZONE 0.0d0)
    (CL:RETURN-FROM GET-TIME (DECODE-TIME-IN-MILLIS (%TIME-MILLIS DATE))))
   ((CL:< TIMEZONE 0.0d0)
     ...
     (DECODE-TIME-IN-MILLIS
      (CL:THE CL:FIXNUM
       (CL:REM
        (CL:THE CL:FIXNUM
         (CL:TRUNCATE
          (CL:+ (%TIME-MILLIS DATE) MILLIS-PER-DAY
     ...
     (DECODE-TIME-IN-MILLIS
      (CL:THE CL:FIXNUM
       (CL:REM
        (CL:THE CL:FIXNUM
         (CL:TRUNCATE
          (CL:+ (%TIME-MILLIS DATE) (CL:* TIMEZONE MILLIS-PER-HOUR))))
        MILLIS-PER-DAY)))))))
  ...
  (CL:LET*
   ...
   (CL:LET*
    ...
    (CL:LET* ((SELF-000 (NEW-DECODED-DATE-TIME)))
     (CL:SETF (%DATE-TIME-MILLIS SELF-000) (CL:FLOAT MILLIS 0.0d0))
     (CL:SETF (%DATE-TIME-SECOND SELF-000) SEC)
     (CL:SETF (%DATE-TIME-MINUTE SELF-000) MIN)
     (CL:SETF (%DATE-TIME-HOUR SELF-000) HOUR)
     (CL:SETF (%DATE-TIME-DAY SELF-000) DAY)
     (CL:SETF (%DATE-TIME-MONTH SELF-000) MONTH)
     (CL:SETF (%DATE-TIME-YEAR SELF-000) YEAR)
     (CL:SETF (%DATE-TIME-ZONE SELF-000) TIMEZONE)
     (CL:SETF (%DATE-TIME-DOW SELF-000) DOW)
...
(CL:DEFMETHOD ENCODE-CALENDAR-DATE ((TIME-STRUCTURE DECODED-DATE-TIME))
  ...
  (CL:RETURN-FROM ENCODE-CALENDAR-DATE
   (MAKE-DATE-TIME (%DATE-TIME-YEAR TIME-STRUCTURE)
    (%DATE-TIME-MONTH TIME-STRUCTURE) (%DATE-TIME-DAY TIME-STRUCTURE)
    (%DATE-TIME-HOUR TIME-STRUCTURE) (%DATE-TIME-MINUTE TIME-STRUCTURE)
    (%DATE-TIME-SECOND TIME-STRUCTURE) (ROUND (%DATE-TIME-MILLIS TIME-STRUCTURE))
...
(CL:DEFMETHOD DECODE-TIME-DURATION ((DURATION TIME-DURATION))
  (CL:IF (CL:> (%MILLIS DURATION) 0)
   (CL:LET* ((SELF-000 (NEW-DECODED-TIME-DURATION)))
    (CL:SETF (%DURATION-DAYS SELF-000) (%DAYS DURATION))
    (CL:SETF (%DURATION-HOURS SELF-000)
     (CL:LET ((X (%MILLIS DURATION)) (Y MILLIS-PER-HOUR))
    ...
    (CL:SETF (%DURATION-MINUTES SELF-000)
     (CL:LET
      ((X
        (CL:THE CL:FIXNUM
         (CL:REM (CL:THE CL:FIXNUM (%MILLIS DURATION)) MILLIS-PER-HOUR)))
       (Y 60000))
      (CL:DECLARE (CL:TYPE CL:FIXNUM X Y))
      (CL:THE CL:FIXNUM (CL:VALUES (CL:TRUNCATE X Y)))))
    (CL:SETF (%DURATION-SECONDS SELF-000)
     (CL:LET
      ((X
        (CL:THE CL:FIXNUM (CL:REM (CL:THE CL:FIXNUM (%MILLIS DURATION)) 60000)))
       (Y 1000))
      (CL:DECLARE (CL:TYPE CL:FIXNUM X Y))
      (CL:THE CL:FIXNUM (CL:VALUES (CL:TRUNCATE X Y)))))
    (CL:SETF (%DURATION-MILLIS SELF-000)
     (CL:FLOAT
      (CL:THE CL:FIXNUM (CL:REM (CL:THE CL:FIXNUM (%MILLIS DURATION)) 1000))
      0.0d0))
    (CL:LET* ((VALUE-000 SELF-000))
     (CL:RETURN-FROM DECODE-TIME-DURATION VALUE-000)))
   (CL:LET* ((SELF-001 (NEW-DECODED-TIME-DURATION)))
    (CL:SETF (%DURATION-DAYS SELF-001) (%DAYS DURATION))
    (CL:SETF (%DURATION-HOURS SELF-001)
     (CL:- 0
      (CL:LET ((X (CL:- 0 (%MILLIS DURATION))) (Y MILLIS-PER-HOUR))
       (CL:DECLARE (CL:TYPE CL:FIXNUM X Y))
       (CL:THE CL:FIXNUM (CL:VALUES (CL:TRUNCATE X Y))))))
    (CL:SETF (%DURATION-MINUTES SELF-001)
     (CL:- 0
      (CL:LET
       ((X
         (CL:THE CL:FIXNUM
          (CL:REM (CL:THE CL:FIXNUM (CL:- 0 (%MILLIS DURATION)))
           MILLIS-PER-HOUR)))
        (Y 60000))
       (CL:DECLARE (CL:TYPE CL:FIXNUM X Y))
       (CL:THE CL:FIXNUM (CL:VALUES (CL:TRUNCATE X Y))))))
    (CL:SETF (%DURATION-SECONDS SELF-001)
     (CL:- 0
      (CL:LET
       ((X
         (CL:THE CL:FIXNUM
          (CL:REM (CL:THE CL:FIXNUM (CL:- 0 (%MILLIS DURATION))) 60000)))
        (Y 1000))
       (CL:DECLARE (CL:TYPE CL:FIXNUM X Y))
       (CL:THE CL:FIXNUM (CL:VALUES (CL:TRUNCATE X Y))))))
    (CL:SETF (%DURATION-MILLIS SELF-001)
     (CL:FLOAT
      (CL:- 0
       (CL:THE CL:FIXNUM
        (CL:REM (CL:THE CL:FIXNUM (CL:- 0 (%MILLIS DURATION))) 1000)))
      0.0d0))
...
(CL:DEFMETHOD ENCODE-TIME-DURATION ((TIME-STRUCTURE DECODED-TIME-DURATION))
  (CL:RETURN-FROM ENCODE-TIME-DURATION
   (MAKE-TIME-DURATION (%DURATION-DAYS TIME-STRUCTURE)
    (CL:TRUNCATE
     (CL:+ (CL:* (%DURATION-HOURS TIME-STRUCTURE) MILLIS-PER-HOUR)
      (CL:* (%DURATION-MINUTES TIME-STRUCTURE) 60000)
      (CL:* (%DURATION-SECONDS TIME-STRUCTURE) 1000)
        ...
        ((SUBTYPE-OF? TEST-VALUE-000 SGT-DATE-TIME-STELLA-TIME-DURATION)
         (CL:PROGN
          (CL:RETURN-FROM TIME-ADD
           (MAKE-CALENDAR-DATE (CL:+ (%MODIFIED-JULIAN-DAY T1) (%DAYS T2))
            (CL:+ (%TIME-MILLIS T1) (%MILLIS T2))))))
        (CL:T
         (CL:LET* ((STREAM-001 (NEW-OUTPUT-STRING-STREAM)))
      ...
      (CL:LET* ((TEST-VALUE-001 (SAFE-PRIMARY-TYPE T2)))
       (CL:COND
        ((SUBTYPE-OF? TEST-VALUE-001 SGT-DATE-TIME-STELLA-CALENDAR-DATE)
         (CL:PROGN
          (CL:RETURN-FROM TIME-ADD
           (MAKE-CALENDAR-DATE (CL:+ (%DAYS T1) (%MODIFIED-JULIAN-DAY T2))
            (CL:+ (%MILLIS T1) (%TIME-MILLIS T2))))))
        ((SUBTYPE-OF? TEST-VALUE-001 SGT-DATE-TIME-STELLA-TIME-DURATION)
         (CL:PROGN
          (CL:RETURN-FROM TIME-ADD
           (MAKE-TIME-DURATION (CL:+ (%DAYS T1) (%DAYS T2))
            (CL:+ (%MILLIS T1) (%MILLIS T2))))))
        (CL:T
         (CL:LET* ((STREAM-002 (NEW-OUTPUT-STRING-STREAM)))
        ...
        ((SUBTYPE-OF? TEST-VALUE-000 SGT-DATE-TIME-STELLA-CALENDAR-DATE)
         (CL:PROGN
          (CL:RETURN-FROM TIME-SUBTRACT
           (MAKE-TIME-DURATION
            (CL:- (%MODIFIED-JULIAN-DAY T1) (%MODIFIED-JULIAN-DAY T2))
         ...
         (CL:PROGN
          (CL:LET* ((STREAM-001 (NEW-OUTPUT-STRING-STREAM)))
           (%%PRINT-STREAM (%NATIVE-STREAM STREAM-001)
            "You can't subtract a calendar date from a relative date: `" T1
            "'  `" T2 "'")
           (CL:ERROR (NEW-STELLA-EXCEPTION (THE-STRING-READER STREAM-001))))))
        ((SUBTYPE-OF? TEST-VALUE-001 SGT-DATE-TIME-STELLA-TIME-DURATION)
         (CL:PROGN
   ...
   (CL:COND
    ((SUBTYPE-OF? TEST-VALUE-003 SGT-DATE-TIME-STELLA-CALENDAR-DATE)
     (CL:PROGN
      (CL:LET* ((STREAM-000 (NEW-OUTPUT-STRING-STREAM)))
       (%%PRINT-STREAM (%NATIVE-STREAM STREAM-000)
        "Calendar dates cannot be involved in multiplication:  `" T1 "'  `" T2
        "'")
       (CL:ERROR (NEW-STELLA-EXCEPTION (THE-STRING-READER STREAM-000))))))
        ...
        ((SUBTYPE-OF-INTEGER? TEST-VALUE-000)
         (CL:PROGN
          (CL:RETURN-FROM TIME-MULTIPLY
           (MAKE-TIME-DURATION (CL:* (%DAYS T1) (%WRAPPER-VALUE T2))
            (CL:* (%MILLIS T1) (%WRAPPER-VALUE T2))))))
      ...
      (CL:LET* ((TEST-VALUE-001 (SAFE-PRIMARY-TYPE T2)))
       (CL:COND
        ...
        ((SUBTYPE-OF? TEST-VALUE-001 SGT-DATE-TIME-STELLA-TIME-DURATION)
         (CL:PROGN
          (CL:RETURN-FROM TIME-MULTIPLY
           (MAKE-TIME-DURATION (CL:* (%WRAPPER-VALUE T1) (%DAYS T2))
            (CL:* (%WRAPPER-VALUE T1) (%MILLIS T2))))))
        ...
        (CL:T
         (CL:LET* ((STREAM-006 (NEW-OUTPUT-STRING-STREAM)))
          (%%PRINT-STREAM (%NATIVE-STREAM STREAM-006) "`" TEST-VALUE-001
           "' is not a valid case option")
       ...
       (CL:COND
        ...
        (CL:T
         (CL:LET* ((STREAM-009 (NEW-OUTPUT-STRING-STREAM)))
          (%%PRINT-STREAM (%NATIVE-STREAM STREAM-009) "`" TEST-VALUE-002
           "' is not a valid case option")
          (CL:ERROR (NEW-STELLA-EXCEPTION (THE-STRING-READER STREAM-009)))))))))
    (CL:T
     (CL:LET* ((STREAM-010 (NEW-OUTPUT-STRING-STREAM)))
      (%%PRINT-STREAM (%NATIVE-STREAM STREAM-010) "`" TEST-VALUE-003
       "' is not a valid case option")
   ...
   (CL:COND
    ((SUBTYPE-OF? TEST-VALUE-000 SGT-DATE-TIME-STELLA-CALENDAR-DATE)
     (CL:PROGN
      (CL:LET* ((STREAM-000 (NEW-OUTPUT-STRING-STREAM)))
       (%%PRINT-STREAM (%NATIVE-STREAM STREAM-000)
        "Calendar dates cannot be involved in division:  `" T1 "'  `" T2 "'")
       (CL:ERROR (NEW-STELLA-EXCEPTION (THE-STRING-READER STREAM-000))))))
    ((SUBTYPE-OF? TEST-VALUE-000 SGT-DATE-TIME-STELLA-TIME-DURATION)
     (CL:PROGN
      (CL:RETURN-FROM TIME-DIVIDE
       (WRAP-FLOAT
        (CL:/
         (CL:+ (%DAYS T1) (CL:/ (CL:FLOAT (%MILLIS T1) 0.0d0) MILLIS-PER-DAY))
         (CL:+ (%DAYS T2)
          (CL:/ (CL:FLOAT (%MILLIS T2) 0.0d0) MILLIS-PER-DAY)))))))
    ((SUBTYPE-OF-INTEGER? TEST-VALUE-000)
     (CL:PROGN
      (CL:RETURN-FROM TIME-DIVIDE
       (MAKE-TIME-DURATION
        (ROUND (CL:/ (CL:FLOAT (%DAYS T1) 0.0d0) (%WRAPPER-VALUE T2)))
...
(CL:DEFUN DEFINE-TIME-COMPARISON (NAME OPERATOR)
  (CL:RETURN-FROM DEFINE-TIME-COMPARISON
   (LIST* SYM-DATE-TIME-STELLA-DEFUN
    (CONS NAME (CONS SYM-DATE-TIME-STELLA-BOOLEAN NIL))
    (LIST*
     (LIST* SYM-DATE-TIME-STELLA-T1 SYM-DATE-TIME-STELLA-DATE-TIME-OBJECT NIL)
     (LIST* SYM-DATE-TIME-STELLA-T2 SYM-DATE-TIME-STELLA-DATE-TIME-OBJECT NIL)
     NIL)
    (LIST* SYM-DATE-TIME-STELLA-TYPECASE SYM-DATE-TIME-STELLA-T1
     (LIST* SYM-DATE-TIME-STELLA-CALENDAR-DATE
      (LIST* SYM-DATE-TIME-STELLA-TYPECASE SYM-DATE-TIME-STELLA-T2
       (LIST* SYM-DATE-TIME-STELLA-CALENDAR-DATE
        (LIST* SYM-DATE-TIME-STELLA-IF
         (LIST* SYM-DATE-TIME-STELLA-=
          (LIST* SYM-DATE-TIME-STELLA-MODIFIED-JULIAN-DAY SYM-DATE-TIME-STELLA-T1
           NIL)
          (LIST* SYM-DATE-TIME-STELLA-MODIFIED-JULIAN-DAY SYM-DATE-TIME-STELLA-T2
           NIL)
          NIL)
         (LIST* SYM-DATE-TIME-STELLA-RETURN
          (CONS OPERATOR
           (LIST*
            (LIST* SYM-DATE-TIME-STELLA-TIME-MILLIS SYM-DATE-TIME-STELLA-T1 NIL)
            (LIST* SYM-DATE-TIME-STELLA-TIME-MILLIS SYM-DATE-TIME-STELLA-T2 NIL)
            NIL))
          NIL)
         (LIST* SYM-DATE-TIME-STELLA-RETURN
          (CONS OPERATOR
       ...
       (LIST* SYM-DATE-TIME-STELLA-TIME-DURATION
        (LIST* SYM-DATE-TIME-STELLA-ERROR
         (WRAP-STRING "Can't compare calendar and relative dates: ")
         SYM-DATE-TIME-STELLA-T1 (WRAP-STRING "  ") SYM-DATE-TIME-STELLA-T2 NIL)
        NIL)
       NIL)
      NIL)
     (LIST* SYM-DATE-TIME-STELLA-TIME-DURATION
      (LIST* SYM-DATE-TIME-STELLA-TYPECASE SYM-DATE-TIME-STELLA-T2
       (LIST* SYM-DATE-TIME-STELLA-CALENDAR-DATE
        (LIST* SYM-DATE-TIME-STELLA-ERROR
         (WRAP-STRING "Can't compare relative and calendar dates: ")
         SYM-DATE-TIME-STELLA-T1 (WRAP-STRING "  ") SYM-DATE-TIME-STELLA-T2 NIL)
        NIL)
       (LIST* SYM-DATE-TIME-STELLA-TIME-DURATION
        (LIST* SYM-DATE-TIME-STELLA-IF
...
;;; (DEFUN (TIME-EQL? BOOLEAN) ...)

(CL:DEFUN TIME-EQL? (T1 T2)
  (CL:LET* ((TEST-VALUE-002 (SAFE-PRIMARY-TYPE T1)))
   (CL:COND
    ((SUBTYPE-OF? TEST-VALUE-002 SGT-DATE-TIME-STELLA-CALENDAR-DATE)
     (CL:PROGN
        ...
        ((SUBTYPE-OF? TEST-VALUE-000 SGT-DATE-TIME-STELLA-CALENDAR-DATE)
         (CL:PROGN
          (CL:IF (CL:= (%MODIFIED-JULIAN-DAY T1) (%MODIFIED-JULIAN-DAY T2))
           (CL:RETURN-FROM TIME-EQL? (CL:= (%TIME-MILLIS T1) (%TIME-MILLIS T2)))
           (CL:RETURN-FROM TIME-EQL?
            (CL:= (%MODIFIED-JULIAN-DAY T1) (%MODIFIED-JULIAN-DAY T2))))))
        ((SUBTYPE-OF? TEST-VALUE-000 SGT-DATE-TIME-STELLA-TIME-DURATION)
         (CL:PROGN
          (CL:LET* ((STREAM-000 (NEW-OUTPUT-STRING-STREAM)))
           (%%PRINT-STREAM (%NATIVE-STREAM STREAM-000)
            "Can't compare calendar and relative dates: `" T1 "'  `" T2 "'")
           (CL:ERROR (NEW-STELLA-EXCEPTION (THE-STRING-READER STREAM-000))))))
        (CL:T
         (CL:LET* ((STREAM-001 (NEW-OUTPUT-STRING-STREAM)))
          (%%PRINT-STREAM (%NATIVE-STREAM STREAM-001) "`" TEST-VALUE-000
       ...
       (CL:COND
        ((SUBTYPE-OF? TEST-VALUE-001 SGT-DATE-TIME-STELLA-CALENDAR-DATE)
         (CL:PROGN
          (CL:LET* ((STREAM-002 (NEW-OUTPUT-STRING-STREAM)))
           (%%PRINT-STREAM (%NATIVE-STREAM STREAM-002)
            "Can't compare relative and calendar dates: `" T1 "'  `" T2 "'")
           (CL:ERROR (NEW-STELLA-EXCEPTION (THE-STRING-READER STREAM-002))))))
        ((SUBTYPE-OF? TEST-VALUE-001 SGT-DATE-TIME-STELLA-TIME-DURATION)
         (CL:PROGN
          (CL:IF (CL:= (%DAYS T1) (%DAYS T2))
           (CL:RETURN-FROM TIME-EQL? (CL:= (%MILLIS T1) (%MILLIS T2)))
           (CL:RETURN-FROM TIME-EQL? (CL:= (%DAYS T1) (%DAYS T2))))))
        (CL:T
         (CL:LET* ((STREAM-003 (NEW-OUTPUT-STRING-STREAM)))
          (%%PRINT-STREAM (%NATIVE-STREAM STREAM-003) "`" TEST-VALUE-001
           "' is not a valid case option")
          (CL:ERROR (NEW-STELLA-EXCEPTION (THE-STRING-READER STREAM-003)))))))))
    (CL:T
     (CL:LET* ((STREAM-004 (NEW-OUTPUT-STRING-STREAM)))
      (%%PRINT-STREAM (%NATIVE-STREAM STREAM-004) "`" TEST-VALUE-002
       "' is not a valid case option")
      (CL:ERROR (NEW-STELLA-EXCEPTION (THE-STRING-READER STREAM-004))))))))

;;; (DEFUN (TIME-LESS? BOOLEAN) ...)

(CL:DEFUN TIME-LESS? (T1 T2)
  (CL:LET* ((TEST-VALUE-002 (SAFE-PRIMARY-TYPE T1)))
   (CL:COND
    ((SUBTYPE-OF? TEST-VALUE-002 SGT-DATE-TIME-STELLA-CALENDAR-DATE)
     (CL:PROGN
      (CL:LET* ((TEST-VALUE-000 (SAFE-PRIMARY-TYPE T2)))
       (CL:COND
        ((SUBTYPE-OF? TEST-VALUE-000 SGT-DATE-TIME-STELLA-CALENDAR-DATE)
         (CL:PROGN
          (CL:IF (CL:= (%MODIFIED-JULIAN-DAY T1) (%MODIFIED-JULIAN-DAY T2))
           (CL:RETURN-FROM TIME-LESS? (< (%TIME-MILLIS T1) (%TIME-MILLIS T2)))
           (CL:RETURN-FROM TIME-LESS?
            (< (%MODIFIED-JULIAN-DAY T1) (%MODIFIED-JULIAN-DAY T2))))))
        ((SUBTYPE-OF? TEST-VALUE-000 SGT-DATE-TIME-STELLA-TIME-DURATION)
         (CL:PROGN
          (CL:LET* ((STREAM-000 (NEW-OUTPUT-STRING-STREAM)))
           (%%PRINT-STREAM (%NATIVE-STREAM STREAM-000)
      ...
      (CL:LET* ((TEST-VALUE-001 (SAFE-PRIMARY-TYPE T2)))
       (CL:COND
        ...
        ((SUBTYPE-OF? TEST-VALUE-001 SGT-DATE-TIME-STELLA-TIME-DURATION)
         (CL:PROGN
          (CL:IF (CL:= (%DAYS T1) (%DAYS T2))
           (CL:RETURN-FROM TIME-LESS? (< (%MILLIS T1) (%MILLIS T2)))
           (CL:RETURN-FROM TIME-LESS? (< (%DAYS T1) (%DAYS T2))))))
        (CL:T
         (CL:LET* ((STREAM-003 (NEW-OUTPUT-STRING-STREAM)))
          (%%PRINT-STREAM (%NATIVE-STREAM STREAM-003) "`" TEST-VALUE-001
           "' is not a valid case option")
...
;;; (DEFUN (TIME-GREATER? BOOLEAN) ...)

(CL:DEFUN TIME-GREATER? (T1 T2)
  (CL:LET* ((TEST-VALUE-002 (SAFE-PRIMARY-TYPE T1)))
   (CL:COND
    ((SUBTYPE-OF? TEST-VALUE-002 SGT-DATE-TIME-STELLA-CALENDAR-DATE)
     (CL:PROGN
      (CL:LET* ((TEST-VALUE-000 (SAFE-PRIMARY-TYPE T2)))
       (CL:COND
        ((SUBTYPE-OF? TEST-VALUE-000 SGT-DATE-TIME-STELLA-CALENDAR-DATE)
         (CL:PROGN
          (CL:IF (CL:= (%MODIFIED-JULIAN-DAY T1) (%MODIFIED-JULIAN-DAY T2))
           (CL:RETURN-FROM TIME-GREATER? (> (%TIME-MILLIS T1) (%TIME-MILLIS T2)))
           (CL:RETURN-FROM TIME-GREATER?
            (> (%MODIFIED-JULIAN-DAY T1) (%MODIFIED-JULIAN-DAY T2))))))
        ((SUBTYPE-OF? TEST-VALUE-000 SGT-DATE-TIME-STELLA-TIME-DURATION)
         (CL:PROGN
          (CL:LET* ((STREAM-000 (NEW-OUTPUT-STRING-STREAM)))
      ...
      (CL:LET* ((TEST-VALUE-001 (SAFE-PRIMARY-TYPE T2)))
       (CL:COND
        ...
        ((SUBTYPE-OF? TEST-VALUE-001 SGT-DATE-TIME-STELLA-TIME-DURATION)
         (CL:PROGN
          (CL:IF (CL:= (%DAYS T1) (%DAYS T2))
           (CL:RETURN-FROM TIME-GREATER? (> (%MILLIS T1) (%MILLIS T2)))
           (CL:RETURN-FROM TIME-GREATER? (> (%DAYS T1) (%DAYS T2))))))
        (CL:T
         (CL:LET* ((STREAM-003 (NEW-OUTPUT-STRING-STREAM)))
          (%%PRINT-STREAM (%NATIVE-STREAM STREAM-003) "`" TEST-VALUE-001
           "' is not a valid case option")
...
;;; (DEFUN (TIME-LESS-EQUAL? BOOLEAN) ...)

(CL:DEFUN TIME-LESS-EQUAL? (T1 T2)
  (CL:LET* ((TEST-VALUE-002 (SAFE-PRIMARY-TYPE T1)))
   (CL:COND
    ((SUBTYPE-OF? TEST-VALUE-002 SGT-DATE-TIME-STELLA-CALENDAR-DATE)
     (CL:PROGN
      (CL:LET* ((TEST-VALUE-000 (SAFE-PRIMARY-TYPE T2)))
       (CL:COND
        ((SUBTYPE-OF? TEST-VALUE-000 SGT-DATE-TIME-STELLA-CALENDAR-DATE)
         (CL:PROGN
          (CL:IF (CL:= (%MODIFIED-JULIAN-DAY T1) (%MODIFIED-JULIAN-DAY T2))
           (CL:RETURN-FROM TIME-LESS-EQUAL?
      ...
      (CL:LET* ((TEST-VALUE-001 (SAFE-PRIMARY-TYPE T2)))
       (CL:COND
        ...
        ((SUBTYPE-OF? TEST-VALUE-001 SGT-DATE-TIME-STELLA-TIME-DURATION)
         (CL:PROGN
          (CL:IF (CL:= (%DAYS T1) (%DAYS T2))
           (CL:RETURN-FROM TIME-LESS-EQUAL? (<= (%MILLIS T1) (%MILLIS T2)))
           (CL:RETURN-FROM TIME-LESS-EQUAL? (<= (%DAYS T1) (%DAYS T2))))))
        (CL:T
         (CL:LET* ((STREAM-003 (NEW-OUTPUT-STRING-STREAM)))
          (%%PRINT-STREAM (%NATIVE-STREAM STREAM-003) "`" TEST-VALUE-001
           "' is not a valid case option")
...
;;; (DEFUN (TIME-GREATER-EQUAL? BOOLEAN) ...)

(CL:DEFUN TIME-GREATER-EQUAL? (T1 T2)
  (CL:LET* ((TEST-VALUE-002 (SAFE-PRIMARY-TYPE T1)))
   (CL:COND
    ((SUBTYPE-OF? TEST-VALUE-002 SGT-DATE-TIME-STELLA-CALENDAR-DATE)
     (CL:PROGN
      (CL:LET* ((TEST-VALUE-000 (SAFE-PRIMARY-TYPE T2)))
       (CL:COND
        ((SUBTYPE-OF? TEST-VALUE-000 SGT-DATE-TIME-STELLA-CALENDAR-DATE)
         (CL:PROGN
          (CL:IF (CL:= (%MODIFIED-JULIAN-DAY T1) (%MODIFIED-JULIAN-DAY T2))
           (CL:RETURN-FROM TIME-GREATER-EQUAL?
            (>= (%TIME-MILLIS T1) (%TIME-MILLIS T2)))
           (CL:RETURN-FROM TIME-GREATER-EQUAL?
            (>= (%MODIFIED-JULIAN-DAY T1) (%MODIFIED-JULIAN-DAY T2))))))
        ((SUBTYPE-OF? TEST-VALUE-000 SGT-DATE-TIME-STELLA-TIME-DURATION)
      ...
      (CL:LET* ((TEST-VALUE-001 (SAFE-PRIMARY-TYPE T2)))
       (CL:COND
        ...
        ((SUBTYPE-OF? TEST-VALUE-001 SGT-DATE-TIME-STELLA-TIME-DURATION)
         (CL:PROGN
          (CL:IF (CL:= (%DAYS T1) (%DAYS T2))
           (CL:RETURN-FROM TIME-GREATER-EQUAL? (>= (%MILLIS T1) (%MILLIS T2)))
           (CL:RETURN-FROM TIME-GREATER-EQUAL? (>= (%DAYS T1) (%DAYS T2))))))
        (CL:T
         (CL:LET* ((STREAM-003 (NEW-OUTPUT-STRING-STREAM)))
          (%%PRINT-STREAM (%NATIVE-STREAM STREAM-003) "`" TEST-VALUE-001
           "' is not a valid case option")
...
(CL:DEFMETHOD OBJECT-EQL? ((SELF CALENDAR-DATE) X)
  (CL:RETURN-FROM OBJECT-EQL?
   (CL:AND (ISA? X SGT-DATE-TIME-STELLA-CALENDAR-DATE) (TIME-EQL? SELF X))))

;;; (DEFMETHOD (OBJECT-EQL? BOOLEAN) ...)

(CL:DEFMETHOD OBJECT-EQL? ((SELF TIME-DURATION) X)
  (CL:RETURN-FROM OBJECT-EQL?
   (CL:AND (ISA? X SGT-DATE-TIME-STELLA-TIME-DURATION) (TIME-EQL? SELF X))))
...
These substitutions can then be used with `substitute-template-variables-in-string'"
  (CL:LET*
   ...
   (INSERT-AT SUBSTITUTION-LIST (WRAP-STRING "YEAR")
    (WRAP-STRING (INTEGER-TO-STRING YEAR)))
...
(CL:DEFUN HELP-STARTUP-DATE-TIME1 ()
  (CL:PROGN
   ...
   (CL:SETQ SYM-DATE-TIME-STELLA-DEFUN
   ...
   (CL:SETQ SYM-DATE-TIME-STELLA-DATE-TIME-OBJECT
    (INTERN-RIGID-SYMBOL-WRT-MODULE "DATE-TIME-OBJECT" NULL 0))
   ...
   (CL:SETQ SYM-DATE-TIME-STELLA-ERROR
...
returns 0.0\")" (CL:FUNCTION GET-LOCAL-TIME-ZONE-FOR-DATE) NULL)
   ...
   (DEFINE-METHOD-OBJECT
    ...
    (CL:FUNCTION HASH-CODE) NULL)
   (DEFINE-FUNCTION-OBJECT "CALENDAR-DATE-TO-STRING"
    "(DEFUN (CALENDAR-DATE-TO-STRING STRING) ((DATE CALENDAR-DATE) (TIMEZONE FLOAT) (INCLUDE-TIMEZONE? BOOLEAN)) :PUBLIC? TRUE :DOCUMENTATION \"Returns a string representation of `date' adjusted for `timezone'\")"
    (CL:FUNCTION CALENDAR-DATE-TO-STRING) NULL)
   (DEFINE-FUNCTION-OBJECT "CALENDAR-DATE-TO-NATIVE-DATE-TIME"
   ...
   (DEFINE-FUNCTION-OBJECT "PRINT-CALENDAR-DATE"
   ...
   (DEFINE-METHOD-OBJECT
    ...
    (CL:FUNCTION HASH-CODE) NULL)
   (DEFINE-FUNCTION-OBJECT "TIME-DURATION-TO-STRING"
    "(DEFUN (TIME-DURATION-TO-STRING STRING) ((DATE TIME-DURATION)) :PUBLIC? TRUE :DOCUMENTATION \"Returns a string representation of `date'\")"
    (CL:FUNCTION TIME-DURATION-TO-STRING) NULL)
   (DEFINE-FUNCTION-OBJECT "STRING-TO-TIME-DURATION"
    "(DEFUN (STRING-TO-TIME-DURATION TIME-DURATION) ((DURATION STRING)) :PUBLIC? TRUE :DOCUMENTATION \"Parses and returns an time-duration object corresponding to `duration'.
The syntax for time duration strings is \\\"{plus|minus} N days[; M ms]\\\" where N and M are
integer values for days and milliseconds.  If no valid parse is found, `null' is returned.\")"
    (CL:FUNCTION STRING-TO-TIME-DURATION) NULL)
   (DEFINE-FUNCTION-OBJECT "PRINT-TIME-DURATION"
...
in `timezone'.  `timezone' is the number of hours added to UTC to get local time.  It
is in the range -12.0 to +14.0 where UTC is zone 0.0\")"
    (CL:FUNCTION GET-CALENDAR-DATE) NULL)
   (DEFINE-METHOD-OBJECT
...
`timezone' is the number of hours added to UTC to get local time.  It is 
in the range -12.0 to +14.0 where UTC is zone 0.0\")"
    (CL:FUNCTION DECODE-CALENDAR-DATE) NULL)
   (DEFINE-METHOD-OBJECT
...
either a relative date or a wrapped number.  If `t2' is a relative date,
then the return value will be a wrapped float.  If `t2' is a wrapped number,
then the reutrn value will be a relative date.\")" (CL:FUNCTION TIME-DIVIDE)
    NULL)
   (DEFINE-FUNCTION-OBJECT "DEFINE-TIME-COMPARISON"
    "(DEFUN DEFINE-TIME-COMPARISON ((NAME SYMBOL) (OPERATOR SYMBOL)) :TYPE OBJECT :MACRO? TRUE :PUBLIC? FALSE)"
    (CL:FUNCTION DEFINE-TIME-COMPARISON) NULL)
   (DEFINE-FUNCTION-OBJECT "TIME-EQL?"
    "(DEFUN (TIME-EQL? BOOLEAN) ((T1 DATE-TIME-OBJECT) (T2 DATE-TIME-OBJECT)))"
    (CL:FUNCTION TIME-EQL?) NULL)
   (DEFINE-FUNCTION-OBJECT "TIME-LESS?"
    "(DEFUN (TIME-LESS? BOOLEAN) ((T1 DATE-TIME-OBJECT) (T2 DATE-TIME-OBJECT)))"
    (CL:FUNCTION TIME-LESS?) NULL)
   (DEFINE-FUNCTION-OBJECT "TIME-GREATER?"
    "(DEFUN (TIME-GREATER? BOOLEAN) ((T1 DATE-TIME-OBJECT) (T2 DATE-TIME-OBJECT)))"
    (CL:FUNCTION TIME-GREATER?) NULL)
   (DEFINE-FUNCTION-OBJECT "TIME-LESS-EQUAL?"
    "(DEFUN (TIME-LESS-EQUAL? BOOLEAN) ((T1 DATE-TIME-OBJECT) (T2 DATE-TIME-OBJECT)))"
    (CL:FUNCTION TIME-LESS-EQUAL?) NULL)
   (DEFINE-FUNCTION-OBJECT "TIME-GREATER-EQUAL?"
    "(DEFUN (TIME-GREATER-EQUAL? BOOLEAN) ((T1 DATE-TIME-OBJECT) (T2 DATE-TIME-OBJECT)))"
    (CL:FUNCTION TIME-GREATER-EQUAL?) NULL)
   (DEFINE-METHOD-OBJECT
...
for the names YEAR and DATE which correspond to the current year and date.
These substitutions can then be used with `substitute-template-variables-in-string'\" :PUBLIC? TRUE)"
    (CL:FUNCTION FILL-IN-DATE-SUBSTITUTION) NULL)
   (DEFINE-FUNCTION-OBJECT "STARTUP-DATE-TIME"
    "(DEFUN STARTUP-DATE-TIME () :PUBLIC? TRUE)" (CL:FUNCTION STARTUP-DATE-TIME)
    NULL)
   (CL:LET* ((FUNCTION (LOOKUP-FUNCTION SYM-DATE-TIME-STELLA-STARTUP-DATE-TIME)))
    (SET-DYNAMIC-SLOT-VALUE (%DYNAMIC-SLOTS FUNCTION)
     ...
     (WRAP-STRING "_Startup-Date-Time") NULL-STRING-WRAPPER)))
  :VOID)
...
(CL:DEFUN STARTUP-DATE-TIME ()
  (CL:LET* ((*MODULE* *STELLA-MODULE*) (*CONTEXT* *MODULE*))
   ...
   (CL:WHEN (CURRENT-STARTUP-TIME-PHASE? 4)
    ...
    (CL:LET*
     ((ABBREVIATION NULL) (I NULL-INTEGER) (ITER-032 0) (UPPER-BOUND-033 12)
      (ITER-034
       (GET-QUOTED-TREE
        "((\"NUL\" \"JAN\" \"FEB\" \"MAR\" \"APR\" \"MAY\" \"JUN\" \"JUL\" \"AUG\" \"SEP\" \"OCT\" \"NOV\" \"DEC\") \"/STELLA\")"
        "/STELLA")))
     (CL:DECLARE (CL:TYPE CL:FIXNUM ITER-032 UPPER-BOUND-033 I))
     (CL:LOOP WHILE
      (CL:AND (CL:<= ITER-032 UPPER-BOUND-033) (CL:NOT (CL:EQ ITER-034 NIL))) DO
      (CL:PROGN (CL:SETQ I ITER-032) (CL:SETQ ITER-032 (CL:1+ ITER-032)))
      (CL:PROGN (CL:SETQ ABBREVIATION (%%VALUE ITER-034))
       (CL:SETQ ITER-034 (%%REST ITER-034)))
      (CL:LET
       ((SELF (%THE-ARRAY *MONTH-ABBREVIATION-VECTOR*)) (VALUE ABBREVIATION)
        (POSITION I))
...
should have the same sign.\" :PUBLIC-SLOTS ((DURATION-MILLIS :INITIALLY 0.0 :TYPE FLOAT) (DURATION-SECONDS :INITIALLY 0 :TYPE INTEGER) (DURATION-MINUTES :INITIALLY 0 :TYPE INTEGER) (DURATION-HOURS :INITIALLY 0 :TYPE INTEGER) (DURATION-DAYS :INITIALLY 0 :TYPE INTEGER)))")))
    ...
    (DEFINE-CLASS-FROM-STRINGIFIED-SOURCE "DATE-TIME-OBJECT"
     "(DEFCLASS DATE-TIME-OBJECT (STANDARD-OBJECT) :ABSTRACT? TRUE)")
    (CL:LET*
     ((CLASS
