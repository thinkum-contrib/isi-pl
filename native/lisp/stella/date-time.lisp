...
(CL:DECLAIM
 (CL:SPECIAL *STELLA-MODULE* *MODULE* NIL *PRINTREADABLY?* NULL-FLOAT
  NULL-INTEGER PI))
  ...
  (CL:LET* ((JUL 0) (JA 0) (JY 0) (JM 0))
   ...
   (CL:WHEN (CL:> MM 12)
    (CL:LET* ((STREAM-000 (NEW-OUTPUT-STRING-STREAM)))
     (%%PRINT-STREAM (%NATIVE-STREAM STREAM-000) "Month `" MM
      "' must be <= 12")
   ...
   (CL:WHEN (CL:< DD 0)
    (CL:LET* ((STREAM-003 (NEW-OUTPUT-STRING-STREAM)))
     (%%PRINT-STREAM (%NATIVE-STREAM STREAM-003) "Day `" DD
      "' must be > zero.")
...
(CL:DEFUN TIME-ZONE-FORMAT60 (TIMEZONE INCLUDE-COLON?)
  ...
  (CL:LET* ((SIGN "+") (HOURS 0))
   (CL:DECLARE (CL:TYPE CL:SIMPLE-STRING SIGN) (CL:TYPE CL:FIXNUM HOURS))
...
(CL:DEFCLASS DECODED-DATE-TIME (STANDARD-OBJECT)
  ((DATE-TIME-MILLIS :TYPE CL:DOUBLE-FLOAT :INITFORM NULL-FLOAT :ALLOCATION
   ...
   (DATE-TIME-SECOND :TYPE CL:FIXNUM :INITFORM NULL-INTEGER :ALLOCATION
    :INSTANCE :ACCESSOR %DATE-TIME-SECOND)
   (DATE-TIME-MINUTE :TYPE CL:FIXNUM :INITFORM NULL-INTEGER :ALLOCATION
    :INSTANCE :ACCESSOR %DATE-TIME-MINUTE)
   (DATE-TIME-HOUR :TYPE CL:FIXNUM :INITFORM NULL-INTEGER :ALLOCATION
    :INSTANCE :ACCESSOR %DATE-TIME-HOUR)
   (DATE-TIME-DAY :TYPE CL:FIXNUM :INITFORM NULL-INTEGER :ALLOCATION :INSTANCE
    :ACCESSOR %DATE-TIME-DAY)
   (DATE-TIME-MONTH :TYPE CL:FIXNUM :INITFORM NULL-INTEGER :ALLOCATION
    :INSTANCE :ACCESSOR %DATE-TIME-MONTH)
   (DATE-TIME-YEAR :TYPE CL:FIXNUM :INITFORM NULL-INTEGER :ALLOCATION
    :INSTANCE :ACCESSOR %DATE-TIME-YEAR)
...
(CL:DEFUN NEW-DECODED-DATE-TIME ()
  (CL:LET* ((SELF NULL))
   ...
   (CL:SETF (%DATE-TIME-ZONE SELF) 0.0d0)
   (CL:SETF (%DATE-TIME-YEAR SELF) 1900) (CL:SETF (%DATE-TIME-MONTH SELF) 1)
   (CL:SETF (%DATE-TIME-DAY SELF) 1) (CL:SETF (%DATE-TIME-HOUR SELF) 0)
   (CL:SETF (%DATE-TIME-MINUTE SELF) 0) (CL:SETF (%DATE-TIME-SECOND SELF) 0)
   (CL:SETF (%DATE-TIME-MILLIS SELF) 0.0d0)
     ...
     (CL:THE CL:FIXNUM
      (CL:LOGIOR
       (CL:THE CL:FIXNUM
        (CL:LOGIOR
         (CL:THE CL:FIXNUM
          (CL:ASH (CL:THE CL:FIXNUM (%DATE-TIME-YEAR SELF)) 9))
         (CL:THE CL:FIXNUM
     ...
     (CL:THE CL:FIXNUM
      (CL:LOGIOR
       (CL:THE CL:FIXNUM
        (CL:LOGIOR
         (CL:THE CL:FIXNUM
          (CL:ASH (CL:THE CL:FIXNUM (%DATE-TIME-HOUR SELF)) 12))
         (CL:THE CL:FIXNUM
...
be included (if present) if a time value is given."
  (CL:LET* ((BUFFER (MAKE-RAW-MUTABLE-STRING 25)) (INDEX 0))
   ...
   (CL:WHEN (CL:NOT (CL:= (%DATE-TIME-YEAR DATE) NULL-INTEGER))
    (CL:SETQ INDEX
     (INSERT-STRING (INTEGER-TO-STRING (CL:TRUNCATE (%DATE-TIME-YEAR DATE))) 0
      NULL-INTEGER BUFFER INDEX KWD-DATE-TIME-PRESERVE))
    (CL:WHEN (CL:NOT (CL:= (%DATE-TIME-MONTH DATE) NULL-INTEGER))
     (CL:SETQ INDEX
      (INSERT-STRING "-" 0 NULL-INTEGER BUFFER INDEX KWD-DATE-TIME-PRESERVE))
     (CL:SETQ INDEX
      (INSERT-STRING
       (FORMAT-WITH-PADDING
        (INTEGER-TO-STRING (CL:TRUNCATE (%DATE-TIME-MONTH DATE))) 2 #\0
        KWD-DATE-TIME-RIGHT CL:NIL)
     ...
     (CL:WHEN (CL:NOT (CL:= (%DATE-TIME-DAY DATE) NULL-INTEGER))
      ...
      (CL:SETQ INDEX
       (INSERT-STRING
        (FORMAT-WITH-PADDING
         (INTEGER-TO-STRING (CL:TRUNCATE (%DATE-TIME-DAY DATE))) 2 #\0
         KWD-DATE-TIME-RIGHT CL:NIL)
        0 NULL-INTEGER BUFFER INDEX KWD-DATE-TIME-PRESERVE))
      (CL:WHEN (CL:NOT (CL:= (%DATE-TIME-HOUR DATE) NULL-INTEGER))
       ...
       (CL:SETQ INDEX
        (INSERT-STRING
         (FORMAT-WITH-PADDING
          (INTEGER-TO-STRING (CL:TRUNCATE (%DATE-TIME-HOUR DATE))) 2 #\0
          KWD-DATE-TIME-RIGHT CL:NIL)
         0 NULL-INTEGER BUFFER INDEX KWD-DATE-TIME-PRESERVE))
       (CL:WHEN (CL:NOT (CL:= (%DATE-TIME-MINUTE DATE) NULL-INTEGER))
        ...
        (CL:SETQ INDEX
         (INSERT-STRING
          (FORMAT-WITH-PADDING
           (INTEGER-TO-STRING (CL:TRUNCATE (%DATE-TIME-MINUTE DATE))) 2 #\0
           KWD-DATE-TIME-RIGHT CL:NIL)
          0 NULL-INTEGER BUFFER INDEX KWD-DATE-TIME-PRESERVE))
        (CL:WHEN (CL:NOT (CL:= (%DATE-TIME-SECOND DATE) NULL-INTEGER))
         ...
         (CL:SETQ INDEX
          (INSERT-STRING
           (FORMAT-WITH-PADDING
            (INTEGER-TO-STRING (CL:TRUNCATE (%DATE-TIME-SECOND DATE))) 2 #\0
            KWD-DATE-TIME-RIGHT CL:NIL)
           0 NULL-INTEGER BUFFER INDEX KWD-DATE-TIME-PRESERVE))))
        ...
        (CL:IF (CL:= (%DATE-TIME-ZONE DATE) 0.0d0)
         (CL:SETQ INDEX
          (INSERT-STRING "Z" 0 NULL-INTEGER BUFFER INDEX
           KWD-DATE-TIME-PRESERVE))
         (CL:SETQ INDEX
          (INSERT-STRING (TIME-ZONE-FORMAT60 (%DATE-TIME-ZONE DATE) CL:T) 0
           NULL-INTEGER BUFFER INDEX KWD-DATE-TIME-PRESERVE))))))))
...
(CL:DEFMETHOD SET-CONSISTENT-DOW ((SELF DECODED-DATE-TIME))
  (CL:WHEN
   (CL:AND (CL:NOT (CL:= (%DATE-TIME-YEAR SELF) NULL-INTEGER))
    (CL:NOT (CL:= (%DATE-TIME-MONTH SELF) NULL-INTEGER))
    (CL:NOT (CL:= (%DATE-TIME-DAY SELF) NULL-INTEGER)))
   (CL:SETF (%DATE-TIME-DOW SELF)
    (COMPUTE-DAY-OF-WEEK (%DATE-TIME-YEAR SELF) (%DATE-TIME-MONTH SELF)
     (%DATE-TIME-DAY SELF))))
  :VOID)
...
(CL:DEFMETHOD HELP-MERGE-NULL-FIELDS ((SELF DECODED-DATE-TIME) DEFAULT INDEX)
  ...
  (CL:WHEN
   (CL:AND (CL:= (%DATE-TIME-MONTH SELF) NULL-INTEGER) (CL:>= INDEX 1))
  ...
  (CL:WHEN
   (CL:AND (CL:= (%DATE-TIME-MINUTE SELF) NULL-INTEGER) (CL:>= INDEX 4))
   (CL:SETF (%DATE-TIME-MINUTE SELF) (%DATE-TIME-MINUTE DEFAULT)))
  (CL:WHEN
   (CL:AND (CL:= (%DATE-TIME-SECOND SELF) NULL-INTEGER) (CL:>= INDEX 5))
  ...
  (CL:WHEN (CL:= (%DATE-TIME-ZONE SELF) NULL-FLOAT)
   (CL:SETF (%DATE-TIME-ZONE SELF) (%DATE-TIME-ZONE DEFAULT)))
...
of the answer."
  (CL:COND
   ((CL:NOT (CL:= (%DATE-TIME-MILLIS SELF) NULL-FLOAT))
    (HELP-MERGE-NULL-FIELDS SELF DEFAULT 6))
   ((CL:NOT (CL:= (%DATE-TIME-SECOND SELF) NULL-INTEGER))
    (HELP-MERGE-NULL-FIELDS SELF DEFAULT 5))
   ((CL:NOT (CL:= (%DATE-TIME-MINUTE SELF) NULL-INTEGER))
    (HELP-MERGE-NULL-FIELDS SELF DEFAULT 4))
   ((CL:NOT (CL:= (%DATE-TIME-HOUR SELF) NULL-INTEGER))
...
(CL:DEFCLASS DECODED-TIME-DURATION (STANDARD-OBJECT)
  ((DURATION-MILLIS :TYPE CL:DOUBLE-FLOAT :INITFORM NULL-FLOAT :ALLOCATION
   ...
   (DURATION-SECONDS :TYPE CL:FIXNUM :INITFORM NULL-INTEGER :ALLOCATION
    :INSTANCE :ACCESSOR %DURATION-SECONDS)
   (DURATION-MINUTES :TYPE CL:FIXNUM :INITFORM NULL-INTEGER :ALLOCATION
    :INSTANCE :ACCESSOR %DURATION-MINUTES)
   (DURATION-HOURS :TYPE CL:FIXNUM :INITFORM NULL-INTEGER :ALLOCATION
    :INSTANCE :ACCESSOR %DURATION-HOURS)
     ...
     (CL:THE CL:FIXNUM
      (CL:LOGIOR
       (CL:THE CL:FIXNUM
        (CL:LOGIOR
         (CL:THE CL:FIXNUM
          (CL:ASH (CL:THE CL:FIXNUM (%DURATION-HOURS SELF)) 12))
         (CL:THE CL:FIXNUM
...
(CL:DEFUN ACCESS-CALENDAR-DATE-SLOT-VALUE (SELF SLOTNAME VALUE SETVALUE?)
  (CL:COND
   ((CL:EQ SLOTNAME SYM-DATE-TIME-STELLA-MODIFIED-JULIAN-DAY)
    (CL:IF SETVALUE?
     (CL:SETF (%MODIFIED-JULIAN-DAY SELF) (%WRAPPER-VALUE VALUE))
...
(CL:DEFMETHOD COERCE-TO ((X CALENDAR-DATE) Y)
  (CL:COND
   ((SUBTYPE-OF? (SAFE-PRIMARY-TYPE Y) SGT-DATE-TIME-STELLA-CALENDAR-DATE)
    (CL:PROGN (CL:RETURN-FROM COERCE-TO Y)))
   (CL:T
    (CL:LET* ((STREAM-000 (NEW-OUTPUT-STRING-STREAM)))
     (%%PRINT-STREAM (%NATIVE-STREAM STREAM-000) "Can't coerce `" Y
      "' to a CALENDAR-DATE")
     (CL:ERROR
      (NEW-INCOMPATIBLE-QUANTITY-EXCEPTION (THE-STRING-READER STREAM-000)))))))
...
recommended."
  ...
  (CL:LET*
   ...
   (CL:LET*
    ((YEAR-STRING
      (CL:IF (CL:< YEAR 0)
       (CONCATENATE (INTEGER-TO-STRING (CL:TRUNCATE (CL:- 0 YEAR))) "BC")
       (INTEGER-TO-STRING (CL:TRUNCATE YEAR))))
     (MONTH-STRING
      (CL:IF NUMERIC-MONTH?
       (FORMAT-WITH-PADDING (INTEGER-TO-STRING (CL:TRUNCATE MONTH)) 2 #\0
        KWD-DATE-TIME-RIGHT CL:NIL)
       (UNWRAP-STRING
        (CL:AREF
   ...
   (CL:LET*
    ((TIMEZONE-STRING
     ...
     (MILLI-STRING
      (CL:IF INCLUDE-MILLIS?
       (CONCATENATE "."
        (FORMAT-WITH-PADDING (INTEGER-TO-STRING (CL:TRUNCATE MILLI)) 3 #\0
         KWD-DATE-TIME-RIGHT CL:NIL))
       "")))
    ...
    (CL:RETURN-FROM CALENDAR-DATE-TO-TIME-STRING
     (CONCATENATE
      ...
      ":"
      (FORMAT-WITH-PADDING (INTEGER-TO-STRING (CL:TRUNCATE MINUTES)) 2 #\0
       KWD-DATE-TIME-RIGHT CL:NIL)
      ":"
      (FORMAT-WITH-PADDING (INTEGER-TO-STRING (CL:TRUNCATE SECONDS)) 2 #\0
       KWD-DATE-TIME-RIGHT CL:NIL)
...
(CL:DEFCLASS TIME-DURATION (DATE-TIME-OBJECT)
  ((DAYS :TYPE CL:FIXNUM :INITFORM NULL-INTEGER :ALLOCATION :INSTANCE
    :ACCESSOR %DAYS)
   (MILLIS :TYPE CL:FIXNUM :INITFORM NULL-INTEGER :ALLOCATION :INSTANCE
    :ACCESSOR %MILLIS))
  (:DOCUMENTATION
...
(CL:DEFMETHOD COERCE-TO ((X TIME-DURATION) Y)
  (CL:COND
   ((SUBTYPE-OF? (SAFE-PRIMARY-TYPE Y) SGT-DATE-TIME-STELLA-TIME-DURATION)
    (CL:PROGN (CL:RETURN-FROM COERCE-TO Y)))
   (CL:T
    (CL:LET* ((STREAM-000 (NEW-OUTPUT-STRING-STREAM)))
     (%%PRINT-STREAM (%NATIVE-STREAM STREAM-000) "Can't coerce `" Y
   ...
   (CL:IF (CL:< N-DAYS 0)
    (CL:IF (CL:<= N-MILLIS 0)
     (CL:RETURN-FROM TIME-DURATION-TO-STRING
      (CONCATENATE "minus " (INTEGER-TO-STRING (CL:TRUNCATE (CL:- 0 N-DAYS)))
       " days; " (INTEGER-TO-STRING (CL:TRUNCATE (CL:- 0 N-MILLIS))) " ms"))
     (CL:RETURN-FROM TIME-DURATION-TO-STRING
      (CONCATENATE "minus "
       (INTEGER-TO-STRING (CL:TRUNCATE (CL:- 0 (CL:1+ N-DAYS)))) " days; "
       (INTEGER-TO-STRING (CL:TRUNCATE (CL:- MILLIS-PER-DAY N-MILLIS)))
       " ms")))
    (CL:IF (CL:< N-MILLIS 0)
     (CL:IF (CL:> N-DAYS 0)
      (CL:RETURN-FROM TIME-DURATION-TO-STRING
       (CONCATENATE "plus " (INTEGER-TO-STRING (CL:TRUNCATE (CL:1- N-DAYS)))
        " days; "
        (INTEGER-TO-STRING (CL:TRUNCATE (CL:+ MILLIS-PER-DAY N-MILLIS)))
        " ms"))
      (CL:RETURN-FROM TIME-DURATION-TO-STRING
...
is in the range -12.0 to +14.0 where UTC is zone 0.0"
  ...
  (CL:LET*
   ...
   (CL:COND ((CL:< TIMEZONE-ADJUSTED-TIME 0) (CL:SETQ DAY-OFFSET -1))
    ((CL:> TIMEZONE-ADJUSTED-TIME MILLIS-PER-DAY) (CL:SETQ DAY-OFFSET 1))
    (CL:T))
   ...
   (CL:LET* ((SELF-000 (NEW-DECODED-TIME-DURATION)))
    ...
    (CL:SETF (%DURATION-SECONDS SELF-000)
     (CL:LET
      ((X
        (CL:THE CL:FIXNUM
         (CL:REM (CL:THE CL:FIXNUM (%MILLIS DURATION)) 60000)))
       (Y 1000))
      (CL:DECLARE (CL:TYPE CL:FIXNUM X Y))
      (CL:THE CL:FIXNUM (CL:VALUES (CL:TRUNCATE X Y)))))
   ...
   ((OTHERWISE-CLAUSE
     (CL:IF (CL:EQ ERROR? SYM-DATE-TIME-STELLA-TRUE)
      (LIST* SYM-DATE-TIME-STELLA-SIGNAL
       ...
       (WRAP-STRING "Can't compare calendar date ") SYM-DATE-TIME-STELLA-T1
   ...
   (CL:RETURN-FROM DEFINE-TIME-COMPARISON
    (LIST* SYM-DATE-TIME-STELLA-PROGN
     (LIST* SYM-DATE-TIME-STELLA-DEFMETHOD
      ...
      (LIST*
       (LIST* SYM-DATE-TIME-STELLA-T1 SYM-DATE-TIME-STELLA-CALENDAR-DATE NIL)
       ...
       (LIST* SYM-DATE-TIME-STELLA-CALENDAR-DATE
        (LIST* SYM-DATE-TIME-STELLA-IF
         ...
         (LIST* SYM-DATE-TIME-STELLA-RETURN
          (CONS OPERATOR
           (LIST*
            (LIST* SYM-DATE-TIME-STELLA-TIME-MILLIS SYM-DATE-TIME-STELLA-T1
             NIL)
            (LIST* SYM-DATE-TIME-STELLA-TIME-MILLIS SYM-DATE-TIME-STELLA-T2
             NIL)
            NIL))
          NIL)
         (LIST* SYM-DATE-TIME-STELLA-RETURN
         ...
         NIL)
        NIL)
       (LIST* SYM-DATE-TIME-STELLA-OTHERWISE (COPY-CONS-LIST OTHERWISE-CLAUSE)
        NIL)
       NIL)
      NIL)
     (LIST* SYM-DATE-TIME-STELLA-DEFMETHOD
      (CONS NAME (CONS SYM-DATE-TIME-STELLA-BOOLEAN NIL))
      (LIST*
       (LIST* SYM-DATE-TIME-STELLA-T1 SYM-DATE-TIME-STELLA-TIME-DURATION NIL)
       (LIST* SYM-DATE-TIME-STELLA-T2 SYM-DATE-TIME-STELLA-OBJECT NIL) NIL)
      (LIST* SYM-DATE-TIME-STELLA-TYPECASE SYM-DATE-TIME-STELLA-T2
       (LIST* SYM-DATE-TIME-STELLA-TIME-DURATION
        (LIST* SYM-DATE-TIME-STELLA-IF
         ...
         (LIST* SYM-DATE-TIME-STELLA-RETURN
          (CONS OPERATOR
           (LIST*
            (LIST* SYM-DATE-TIME-STELLA-MILLIS SYM-DATE-TIME-STELLA-T1 NIL)
            (LIST* SYM-DATE-TIME-STELLA-MILLIS SYM-DATE-TIME-STELLA-T2 NIL)
            NIL))
          NIL)
         (LIST* SYM-DATE-TIME-STELLA-RETURN
          (CONS OPERATOR
   ...
   ((SUBTYPE-OF? (SAFE-PRIMARY-TYPE T2) SGT-DATE-TIME-STELLA-TIME-DURATION)
    (CL:PROGN
     (CL:IF (CL:= (%DAYS T1) (%DAYS T2))
      (CL:RETURN-FROM OBJECT-EQL? (CL:= (%MILLIS T1) (%MILLIS T2)))
...
(CL:DEFMETHOD LESS? ((T1 TIME-DURATION) T2)
  (CL:COND
   ((SUBTYPE-OF? (SAFE-PRIMARY-TYPE T2) SGT-DATE-TIME-STELLA-TIME-DURATION)
    (CL:PROGN
     (CL:IF (CL:= (%DAYS T1) (%DAYS T2))
      (CL:RETURN-FROM LESS? (< (%MILLIS T1) (%MILLIS T2)))
...
(CL:DEFMETHOD GREATER? ((T1 TIME-DURATION) T2)
  (CL:COND
   ((SUBTYPE-OF? (SAFE-PRIMARY-TYPE T2) SGT-DATE-TIME-STELLA-TIME-DURATION)
    (CL:PROGN
     (CL:IF (CL:= (%DAYS T1) (%DAYS T2))
      (CL:RETURN-FROM GREATER? (> (%MILLIS T1) (%MILLIS T2)))
...
(CL:DEFMETHOD LESS-EQUAL? ((T1 TIME-DURATION) T2)
  (CL:COND
   ((SUBTYPE-OF? (SAFE-PRIMARY-TYPE T2) SGT-DATE-TIME-STELLA-TIME-DURATION)
    (CL:PROGN
     (CL:IF (CL:= (%DAYS T1) (%DAYS T2))
      (CL:RETURN-FROM LESS-EQUAL? (<= (%MILLIS T1) (%MILLIS T2)))
...
(CL:DEFMETHOD GREATER-EQUAL? ((T1 TIME-DURATION) T2)
  (CL:COND
   ((SUBTYPE-OF? (SAFE-PRIMARY-TYPE T2) SGT-DATE-TIME-STELLA-TIME-DURATION)
    (CL:PROGN
     (CL:IF (CL:= (%DAYS T1) (%DAYS T2))
      (CL:RETURN-FROM GREATER-EQUAL? (>= (%MILLIS T1) (%MILLIS T2)))
  ...
  (CL:LET* ((TZ (GET-LOCAL-TIME-ZONE)))
   ...
   (CL:LET*
    ...
    (INSERT-AT SUBSTITUTION-LIST (WRAP-STRING "MONTH")
     (CL:AREF (CL:THE CL:SIMPLE-VECTOR (%THE-ARRAY *MONTH-NAME-VECTOR*))
      MONTH))
    ...
    (INSERT-AT SUBSTITUTION-LIST (WRAP-STRING "DAY-OF-WEEK")
     (WRAP-STRING (STRING-CAPITALIZE (%SYMBOL-NAME DOW))))
...
when a null value is first encountered.  The time zone will only
be included (if present) if a time value is given.\")"
    (CL:FUNCTION DECODED-DATE-TIME-TO-ISO8601-STRING) NULL)
   (DEFINE-METHOD-OBJECT
...
The day of the week will be set consistently, if possible.\")"
    (CL:FUNCTION MERGE-NULL-FIELDS) NULL)
   (DEFINE-METHOD-OBJECT
...
Recommended values for the flag is `true'.\")"
    (CL:FUNCTION CALENDAR-DATE-TO-ISO8601-STRING) NULL)
   (DEFINE-METHOD-OBJECT
...
`time' specified in milliseconds.\")" (CL:FUNCTION DECODE-TIME-IN-MILLIS)
    NULL)
   (DEFINE-METHOD-OBJECT
  ...
  (CL:LET* ((*MODULE* *STELLA-MODULE*) (*CONTEXT* *MODULE*))
   ...
   (CL:WHEN (CURRENT-STARTUP-TIME-PHASE? 4)
    ...
    (CL:LET*
     ...
     (CL:LOOP WHILE
      (CL:AND (CL:<= ITER-035 UPPER-BOUND-036) (CL:NOT (CL:EQ ITER-037 NIL)))
      DO (CL:SETQ I ITER-035) (CL:SETQ ABBREVIATION (%%VALUE ITER-037))
      (CL:LET
       ((SELF (%THE-ARRAY *MONTH-NAME-VECTOR*)) (VALUE ABBREVIATION)
        (POSITION I))
       (CL:DECLARE (CL:TYPE CL:SIMPLE-VECTOR SELF)
        (CL:TYPE CL:FIXNUM POSITION))
       (CL:SETF (CL:AREF SELF POSITION) VALUE))
      (CL:SETQ ITER-035 (CL:1+ ITER-035))
      (CL:SETQ ITER-037 (%%REST ITER-037))))
    ...
    (CL:LET*
     ...
     (CL:LOOP WHILE
      (CL:AND (CL:<= ITER-039 UPPER-BOUND-040) (CL:NOT (CL:EQ ITER-041 NIL)))
      DO (CL:SETQ I ITER-039) (CL:SETQ ABBREVIATION (%%VALUE ITER-041))
      (CL:LET
       ...
       (CL:DECLARE (CL:TYPE CL:SIMPLE-VECTOR SELF)
        (CL:TYPE CL:FIXNUM POSITION))
       (CL:SETF (CL:AREF SELF POSITION) VALUE))
      (CL:SETQ ITER-039 (CL:1+ ITER-039))
      (CL:SETQ ITER-041 (%%REST ITER-041))))
    (CL:SETQ *DEFAULT-DECODED-DATE-TIME* (NEW-DECODED-DATE-TIME))
    (CL:LET* ((SELF-043 (NEW-DECODED-DATE-TIME)))
     (CL:SETF (%DATE-TIME-MILLIS SELF-043) NULL-FLOAT)
     (CL:SETF (%DATE-TIME-SECOND SELF-043) NULL-INTEGER)
     (CL:SETF (%DATE-TIME-MINUTE SELF-043) NULL-INTEGER)
     (CL:SETF (%DATE-TIME-HOUR SELF-043) NULL-INTEGER)
     (CL:SETF (%DATE-TIME-DAY SELF-043) NULL-INTEGER)
     (CL:SETF (%DATE-TIME-MONTH SELF-043) NULL-INTEGER)
     (CL:SETF (%DATE-TIME-YEAR SELF-043) NULL-INTEGER)
     (CL:SETF (%DATE-TIME-ZONE SELF-043) NULL-FLOAT)
     (CL:SETF (%DATE-TIME-DOW SELF-043) NULL)
...
date and time.  See `add-date-substitution' for details.\" :PUBLIC? TRUE)"
    ...
    (CL:LET*
     ((FUNCTION (LOOKUP-FUNCTION SYM-DATE-TIME-STELLA-STARTUP-DATE-TIME)))
