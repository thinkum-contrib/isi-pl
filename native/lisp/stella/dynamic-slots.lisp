...
(CL:DECLAIM
 (CL:SPECIAL *STELLA-MODULE* *MODULE* NIL TRUE *TRANSLATOROUTPUTLANGUAGE*
  FALSE-WRAPPER))

;;; (DEFUN (DYNAMIC-SLOT-VALUE OBJECT) ...)

(CL:DEFUN DYNAMIC-SLOT-VALUE (DYNAMICSLOTS SLOTNAME NULLVALUE)
  (CL:LET* ((VALUE NULL) (KEY NULL) (ITER-000 (%THE-KV-LIST DYNAMICSLOTS)))
...
(CL:DEFUN YIELD-DOWN-CAST-TREE (TREE RETURNTYPE)
  (CL:LET* ((OTREE (SYS-TREE TREE RETURNTYPE)))
   (CL:WHEN
    (CL:NOT (CL:EQ *TRANSLATOROUTPUTLANGUAGE* KWD-DYNAMIC-SLOTS-COMMON-LISP))
...
(CL:DEFUN YIELD-STANDARD-DYNAMIC-SLOT-VALUE-SETTER-TREE (SLOT OBJECTREF VALUEREF RETURNTYPE)
  (CL:LET*
   ((SLOTNAME (%SLOT-NAME (CANONICAL-SLOT SLOT)))
    (LITERALSLOT? (SLOT-VALUE-IS-BARE-LITERAL? SLOT)) (SETTERTREE NULL))
   (CL:IF LITERALSLOT?
    (CL:SETQ SETTERTREE
     (LIST* SYM-DYNAMIC-SLOTS-STELLA-SET-DYNAMIC-SLOT-VALUE
      (LIST* SYM-DYNAMIC-SLOTS-STELLA-DYNAMIC-SLOTS OBJECTREF NIL)
      (LIST* SYM-DYNAMIC-SLOTS-STELLA-BQUOTE SLOTNAME NIL)
      (CONS
...
(CL:DEFUN STARTUP-DYNAMIC-SLOTS ()
  (CL:LET* ((*MODULE* *STELLA-MODULE*) (*CONTEXT* *MODULE*))
   ...
   (CL:WHEN (CURRENT-STARTUP-TIME-PHASE? 2)
    ...
    (CL:SETQ KWD-DYNAMIC-SLOTS-WRAP-FUNCTION
   ...
   (CL:WHEN (CURRENT-STARTUP-TIME-PHASE? 7)
    ...
    (CL:LET*
     ((FUNCTION
       (LOOKUP-FUNCTION SYM-DYNAMIC-SLOTS-STELLA-STARTUP-DYNAMIC-SLOTS)))
     (SET-DYNAMIC-SLOT-VALUE (%DYNAMIC-SLOTS FUNCTION)
      SYM-DYNAMIC-SLOTS-STELLA-METHOD-STARTUP-CLASSNAME
      (WRAP-STRING "_Startup-Dynamic-Slots") NULL-STRING-WRAPPER)))
