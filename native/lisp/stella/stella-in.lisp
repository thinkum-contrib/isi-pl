...
(CL:DECLAIM
 (CL:SPECIAL *SAFETY* *STELLA-MODULE* STANDARD-WARNING FALSE-WRAPPER NULL-INTEGER
  STANDARD-OUTPUT NIL STANDARD-ERROR EOL TRUE *MODULE* FALSE))
...
(CL:DECLAIM
 (CL:FTYPE (CL:FUNCTION (CL:T CL:T) CL:SIMPLE-STRING) STRINGIFY-IN-MODULE))
       ...
       (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-000 NIL)) DO
        ...
        (CL:TAGBODY
          ...
          (CL:LET* ((*PRINTREADABLY?* TRUE))
           ...
           (CL:WHEN (CL:NOT (SUPPRESS-WARNINGS?))
            ...
            (%%PRINT-STREAM (%NATIVE-STREAM STANDARD-ERROR) EOL
             " Ignoring illegal feature `" (DE-UGLIFY-PARSE-TREE FEATURE)
             "' in feature list: `" (DE-UGLIFY-PARSE-TREE TREE) "'." EOL)))
          (CL:GO :CONTINUE))
         (CL:IF (CL:EQ COLLECT-000 NULL)
          ...
          (CL:PROGN
           (CL:SETF (%%REST COLLECT-000) (CONS (PERMANENTIFY FEATURE) NIL))
   ...
   (CL:T
    (CL:LET* ((*PRINTREADABLY?* TRUE)) (CL:DECLARE (CL:SPECIAL *PRINTREADABLY?*))
     ...
     (CL:WHEN (CL:NOT (SUPPRESS-WARNINGS?))
      (PRINT-ERROR-CONTEXT ">> ERROR: " STANDARD-ERROR)
      (%%PRINT-STREAM (%NATIVE-STREAM STANDARD-ERROR) EOL
       " Illegal atomic feature list: `" (DE-UGLIFY-PARSE-TREE TREE) "'." EOL)))
...
(CL:DEFUN HELP-DEFINE-CLASS-FROM-PARSE-TREE (PARSETREE STRINGIFIEDSOURCE)
  ...
  (CL:LET*
   ((TREEDEFINITION (%%REST PARSETREE))
    ...
    (CLASSTYPE (TYPIFY (%%VALUE TREEDEFINITION))) (DIRECTSUPERS (NEW-LIST))
    (SLOTS (NEW-LIST)) (CLASSOPTIONS (NEW-KEYWORD-KEY-VALUE-LIST)) (KEY NULL)
    ...
    (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-000 NIL)) DO
     ...
     (CL:IF (CL:EQ COLLECT-000 NULL)
      ...
      (CL:PROGN (CL:SETF (%%REST COLLECT-000) (CONS (TYPIFY S) NIL))
       (CL:SETQ COLLECT-000 (%%REST COLLECT-000))))))
   (CL:LET* ((THEVALUE NULL) (THEKEY NULL) (ITER-001 (%THE-PLIST THEOPTIONS)))
    (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-001 NIL)) DO
     (CL:SETQ THEKEY (%%VALUE ITER-001))
     (CL:PROGN (CL:SETQ THEVALUE (%%VALUE (%%REST ITER-001)))
     ...
     (CL:COND
       ...
       (CL:LET* ((LOCALSLOT NULL))
        (CL:LET* ((SLOTDEF NULL) (ITER-002 THEVALUE) (COLLECT-001 NULL))
         (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-002 NIL)) DO
          (CL:PROGN (CL:SETQ SLOTDEF (%%VALUE ITER-002))
          ...
          (CL:TAGBODY
           ...
           (CL:WHEN (CL:EQ KEY KWD-STELLA-IN-PUBLIC-SLOTS)
            (CL:SETF (%SLOT-PUBLIC? LOCALSLOT) TRUE))
           (CL:IF (CL:EQ COLLECT-001 NULL)
            ...
            (CL:PROGN (CL:SETF (%%REST COLLECT-001) (CONS LOCALSLOT NIL))
       ...
       (CL:LET* ((LOCALSLOT NULL))
        (CL:LET* ((METHODDEF NULL) (ITER-003 THEVALUE) (COLLECT-002 NULL))
         (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-003 NIL)) DO
          (CL:PROGN (CL:SETQ METHODDEF (%%VALUE ITER-003))
          ...
          (CL:TAGBODY
           (CL:WHEN (CL:NOT (CONS? METHODDEF))
            ...
            (CL:GO :CONTINUE))
           (CL:SETQ LOCALSLOT
            (DEFINE-INLINE-METHOD (%%VALUE METHODDEF) (%%REST METHODDEF)))
           ...
           (CL:WHEN (CL:NOT (CL:EQ (%SLOT-OWNER LOCALSLOT) CLASSTYPE))
            (CL:LET* ((*PRINTREADABLY?* TRUE))
             ...
             (CL:WHEN (CL:NOT (SUPPRESS-WARNINGS?))
              (PRINT-ERROR-CONTEXT ">> ERROR: " STANDARD-ERROR)
              (%%PRINT-STREAM (%NATIVE-STREAM STANDARD-ERROR) EOL
               " Defining a method for the class `" (%SLOT-OWNER LOCALSLOT)
               "' inside of the class `" (DE-UGLIFY-PARSE-TREE CLASSTYPE) "'."
               EOL))))
           (CL:IF (CL:EQ COLLECT-002 NULL)
            ...
            (CL:PROGN (CL:SETF (%%REST COLLECT-002) (CONS LOCALSLOT NIL))
      ...
      ((CL:EQ KEY KWD-STELLA-IN-PARAMETERS) (CL:SETQ PARAMETERS (NEW-LIST))
       (CL:LET* ((SLOTDEF NULL) (ITER-004 THEVALUE) (COLLECT-003 NULL))
        (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-004 NIL)) DO
         (CL:PROGN (CL:SETQ SLOTDEF (%%VALUE ITER-004))
          (CL:SETQ ITER-004 (%%REST ITER-004)))
         (CL:IF (CL:EQ COLLECT-003 NULL)
          (CL:PROGN
           (CL:SETQ COLLECT-003
            (CONS (DEFINE-STORAGE-SLOT-FROM-PARSE-TREE SLOTDEF CLASSTYPE) NIL))
      ...
      ((CL:EQ KEY KWD-STELLA-IN-KEY)
       (CL:WHEN (CL:NOT (CONS? THEVALUE)) (CL:SETQ THEVALUE (CONS THEKEY NIL)))
      ...
      ((CL:OR (CL:EQ KEY KWD-STELLA-IN-ABSTRACT?)
        (CL:EQ KEY KWD-STELLA-IN-ACTIVE?) (CL:EQ KEY KWD-STELLA-IN-PUBLIC?)
      ...
      ((CL:EQ KEY KWD-STELLA-IN-RECYCLE-METHOD)
       ...
       (CL:WHEN
        (MEMBER?
         (GET-QUOTED-TREE "((:SWEEP-LIST :FREE-AND-SWEEP-LIST) \"/STELLA\")"
          "/STELLA")
         THEVALUE)
        (CL:SETQ SLOTTREE
         (LIST* SYM-STELLA-IN-STELLA-NEXT-SWEEP-LIST-OBJECT KWD-STELLA-IN-TYPE
          (%%VALUE TREEDEFINITION) NIL))
        (PUSH SLOTS (DEFINE-STORAGE-SLOT-FROM-PARSE-TREE SLOTTREE CLASSTYPE))))
      ((CL:OR (CL:EQ KEY KWD-STELLA-IN-EXTENSION)
        (CL:EQ KEY KWD-STELLA-IN-CREATOR) (CL:EQ KEY KWD-STELLA-IN-DESTRUCTOR)
          ...
          (CL:LET* ((CHILDREN (NEW-LIST)))
           (CL:LET* ((CHILD NULL) (ITER-005 THEVALUE) (COLLECT-004 NULL))
            (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-005 NIL)) DO
             (CL:PROGN (CL:SETQ CHILD (%%VALUE ITER-005))
              ...
              (CL:IF (CL:EQ COLLECT-004 NULL)
               (CL:PROGN (CL:SETQ COLLECT-004 (CONS (TYPIFY CHILD) NIL))
                (CL:IF (CL:EQ (%THE-CONS-LIST CHILDREN) NIL)
                 ...
                 (ADD-CONS-TO-END-OF-CONS-LIST (%THE-CONS-LIST CHILDREN)
                  COLLECT-004)))
        ...
        (CL:T
         (CL:LET* ((*PRINTREADABLY?* TRUE))
          ...
          (CL:WHEN (CL:NOT (SUPPRESS-WARNINGS?))
           (PRINT-ERROR-CONTEXT ">> ERROR: " STANDARD-ERROR)
           (%%PRINT-STREAM (%NATIVE-STREAM STANDARD-ERROR) EOL
            " Illegal :children specification: `" (DE-UGLIFY-PARSE-TREE THEVALUE)
            "'." EOL))))))
      (CL:T (INSERT-AT CLASSOPTIONS KEY THEVALUE)))))
   (CL:SETF (%THE-PLIST THEOPTIONS) NULL)
   (CL:LET*
    ((CLASS
      (DEFINE-STELLA-CLASS CLASSTYPE DIRECTSUPERS SLOTS (REVERSE CLASSOPTIONS))))
...
(CL:DEFUN DEFINE-STORAGE-SLOT-FROM-PARSE-TREE (SLOTDEF OWNER)
  (CL:LET*
   ((NAME (PERMANENTIFY (%%VALUE SLOTDEF))) (BASETYPE NULL) (TYPEEXPRESSION NIL)
    (THEOPTIONS (NEW-PROPERTY-LIST)) (SLOTOPTIONS (NEW-KEYWORD-KEY-VALUE-LIST))
    (KEY NULL) (SLOT NULL))
   (CL:SETF (%THE-PLIST THEOPTIONS) (%%REST SLOTDEF))
   (CL:LET* ((THEVALUE NULL) (THEKEY NULL) (ITER-000 (%THE-PLIST THEOPTIONS)))
    (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-000 NIL)) DO
     (CL:SETQ THEKEY (%%VALUE ITER-000))
     (CL:PROGN (CL:SETQ THEVALUE (%%VALUE (%%REST ITER-000)))
     ...
     (CL:COND
      ...
      ((CL:OR (CL:EQ KEY KWD-STELLA-IN-PUBLIC?)
        (CL:EQ KEY KWD-STELLA-IN-REQUIRED?) (CL:EQ KEY KWD-STELLA-IN-COMPONENT?)
        (CL:EQ KEY KWD-STELLA-IN-READ-ONLY?) (CL:EQ KEY KWD-STELLA-IN-ACTIVE?)
        (CL:EQ KEY KWD-STELLA-IN-CONTEXT-SENSITIVE?)
        (CL:EQ KEY KWD-STELLA-IN-HARDWIRED?) (CL:EQ KEY KWD-STELLA-IN-ABSTRACT?))
...
(CL:DEFUN EXPLICITLY-QUALIFIED-NAME? (NAME DEFINITIONMODULE)
  (CL:LET* ((NAMEMODULE (%HOME-CONTEXT NAME)) (SHADOW NULL))
   (CL:IF (CL:EQ NAMEMODULE DEFINITIONMODULE)
    (CL:PROGN (CL:RETURN-FROM EXPLICITLY-QUALIFIED-NAME? FALSE))
    (CL:IF (CL:NOT (VISIBLE-FROM? NAMEMODULE DEFINITIONMODULE))
     (CL:PROGN (CL:RETURN-FROM EXPLICITLY-QUALIFIED-NAME? TRUE))
     (CL:LET* ((TEST-VALUE-000 FALSE))
      (CL:LET* ()
       (CL:SETQ SHADOW
        (LOOKUP-SYMBOL-IN-MODULE (%SYMBOL-NAME NAME) DEFINITIONMODULE TRUE))
...
(CL:DEFUN GET-IDENTICAL-CLASS (CLASSNAME STRINGIFIEDSOURCE)
  ...
  (CL:LET*
   ((SURROGATE (LOOKUP-SURROGATE CLASSNAME))
    (OLDVALUE
     (CL:IF (CL:NOT (CL:EQ SURROGATE NULL)) (%SURROGATE-VALUE SURROGATE) NULL)))
     ...
     ((SUBTYPE-OF-CLASS? (SAFE-PRIMARY-TYPE OLDVALUE))
      (CL:PROGN
       (CL:WHEN
        (CL:AND
         (CL:NOT
          (CL:EQ (%CLASS-STRINGIFIED-SOURCE OLDVALUE) STELLA::NULL-STRING))
  ...
  (CL:WHEN
   ...
   (CL:LET* ((*PRINTREADABLY?* TRUE)) (CL:DECLARE (CL:SPECIAL *PRINTREADABLY?*))
    ...
    (CL:WHEN (CL:NOT (SUPPRESS-WARNINGS?))
     (PRINT-ERROR-CONTEXT ">> ERROR: " STANDARD-ERROR)
     (%%PRINT-STREAM (%NATIVE-STREAM STANDARD-ERROR) EOL
      " Illegal class definition: `" (DE-UGLIFY-PARSE-TREE PARSETREE) "'." EOL)))
   (CL:RETURN-FROM DEFINE-CLASS-FROM-PARSE-TREE NULL))
  (CL:LET*
...
(CL:DEFUN DEFINE-CLASS-FROM-STRINGIFIED-SOURCE (CLASSNAME STRINGIFIEDSOURCE)
  ...
  (CL:CHECK-TYPE STRINGIFIEDSOURCE CL:SIMPLE-STRING)
  (CL:LET*
   ((OLDCLASS (GET-IDENTICAL-CLASS CLASSNAME STRINGIFIEDSOURCE)) (NEWCLASS NULL))
   (CL:WHEN
    (CL:AND (CL:NOT (CL:EQ OLDCLASS NULL))
     (CL:NOT *REDEFINE-IDENTICAL-CLASSES?*))
...
(CL:DEFUN EXTRACT-OPTIONS (TREE OPTIONSTABLE)
  (CL:LET* ((OPTIONS NULL) (TAIL NULL))
   ...
   (CL:WHEN (CL:OR (CL:EQ (%%REST TREE) NIL) (CL:EQ (%%REST (%%REST TREE)) NIL))
    ...
    (CL:IF (CL:EQ PARAMETERSTREE NULL)
     ...
     (CL:LET* ((*PRINTREADABLY?* TRUE))
      ...
      (CL:WHEN (CL:NOT (SUPPRESS-WARNINGS?))
       (PRINT-ERROR-CONTEXT ">> ERROR: " STANDARD-ERROR)
       (%%PRINT-STREAM (%NATIVE-STREAM STANDARD-ERROR) EOL
        " Illegal parameter list: `" (DE-UGLIFY-PARSE-TREE PARAMETERSTREE) "'."
        EOL))))
...
(CL:DEFUN YIELD-SETTER-METHOD-NAME (METHODNAME)
  (CL:RETURN-FROM YIELD-SETTER-METHOD-NAME
   (INTERN-DERIVED-SYMBOL METHODNAME
    (CONCATENATE (%SYMBOL-NAME METHODNAME) "-SETTER"))))
      ...
      (CL:WHEN (CL:NOT (SYMBOL? (%%VALUE NAMETREE)))
       (CL:LET* ((*PRINTREADABLY?* TRUE))
        ...
        (CL:WHEN (CL:NOT (SUPPRESS-WARNINGS?))
         (PRINT-ERROR-CONTEXT ">> ERROR: " STANDARD-ERROR)
         (%%PRINT-STREAM (%NATIVE-STREAM STANDARD-ERROR) EOL
          " Illegal method name: `" (DE-UGLIFY-PARSE-TREE NAMETREE) "'." EOL)))
...
(CL:DEFUN IN-PLACE-NORMALIZE-METHOD-OPTIONS (METHODOPTIONS METHODNAME)
  ...
  (CL:LET* ((VALUE NULL) (KEY NULL) (ITER-000 (ALLOCATE-ITERATOR METHODOPTIONS)))
   (CL:LOOP WHILE (NEXT? ITER-000) DO (CL:SETQ KEY (%KEY ITER-000))
    ...
    (CL:COND
     ...
     ((CL:OR (CL:EQ KEY KWD-STELLA-IN-PUBLIC?)
       (CL:EQ KEY KWD-STELLA-IN-ABSTRACT?) (CL:EQ KEY KWD-STELLA-IN-SETTER?)
       (CL:EQ KEY KWD-STELLA-IN-NATIVE?) (CL:EQ KEY KWD-STELLA-IN-CONSTRUCTOR?)
       (CL:EQ KEY KWD-STELLA-IN-AUXILIARY?)
       (CL:EQ KEY KWD-STELLA-IN-GLOBALLY-INLINE?)
       (CL:EQ KEY KWD-STELLA-IN-COMMAND?) (CL:EQ KEY KWD-STELLA-IN-LISP-MACRO?)
           ...
           (CL:LET* ((SYMBOL NULL) (ITER-001 VALUE) (COLLECT-000 NULL))
            (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-001 NIL)) DO
             ...
             (CL:IF (CL:EQ COLLECT-000 NULL)
              ...
              (CL:PROGN
               (CL:SETF (%%REST COLLECT-000) (CONS (PERMANENTIFY SYMBOL) NIL))
               (CL:SETQ COLLECT-000 (%%REST COLLECT-000))))))
  ...
  (CL:LET* ((OLDMETHOD (LOOKUP-FUNCTION NAME)))
   (CL:WHEN
    (CL:AND (CL:NOT (CL:EQ OLDMETHOD NULL))
     (STRING-EQL? (%METHOD-STRINGIFIED-SOURCE OLDMETHOD) STRINGIFIEDSOURCE))
   ...
   (CL:WHEN (CONS? (%%VALUE PARAMETERSTREE))
    ...
    (CL:WHEN (SYMBOL? (LAST PARAMETERSTREE))
     (CL:SETQ EXISTINGSLOT
      (LOOKUP-SLOT (TYPE-TO-CLASS (TYPIFY (LAST PARAMETERSTREE))) NAME))
...
(CL:DEFUN HELP-DEFINE-METHOD-FROM-PARSE-TREE (INPUTTREE STRINGIFIEDSOURCE)
  ...
  (CL:LET*
   ((NAMETREE NULL) (PARAMETERSTREE NULL)
    (METHODOPTIONS (NEW-KEYWORD-KEY-VALUE-LIST)) (BODYTREE NULL) (NAME NULL)
   ...
   (CL:WHEN (CL:EQ NAME NULL)
    (CL:RETURN-FROM HELP-DEFINE-METHOD-FROM-PARSE-TREE (CL:VALUES NULL FALSE)))
   (CL:SETQ OLDMETHOD
   ...
   (CL:LET*
    ((METHOD
      (DEFINE-STELLA-METHOD-SLOT NAME RETURNTYPESTREE FUNCTION? PARAMETERSTREE
       METHODOPTIONS)))
    (CL:WHEN (CL:EQ STRINGIFIEDSOURCE STELLA::NULL-STRING)
     (CL:SETQ STRINGIFIEDSOURCE
      (CL:IF (STRINGIFY-METHOD-BODY? METHOD)
       (STRINGIFY
        (CONCATENATE (READ-S-EXPRESSION-FROM-STRING SIGNATURESTRING) BODYTREE))
       SIGNATURESTRING)))
    (CL:SETF (%METHOD-STRINGIFIED-SOURCE METHOD) STRINGIFIEDSOURCE)
    (RECORD-SLOT-HOME-MODULE METHOD)
    (CL:RETURN-FROM HELP-DEFINE-METHOD-FROM-PARSE-TREE (CL:VALUES METHOD FALSE)))))
...
(CL:DEFUN DEFINE-METHOD-FROM-PARSE-TREE (PARSETREE)
  ...
  (CL:LET* ((METHOD NULL) (IDENTICALMETHOD? FALSE))
   ...
   (CL:WHEN (CL:NOT (CL:OR IDENTICALMETHOD? (CL:EQ METHOD NULL)))
    (CL:IF
     ...
     (CL:SETF (%SLOT-EXTERNAL? METHOD) TRUE)
...
(CL:DECLAIM
 (CL:FTYPE (CL:FUNCTION (CL:T) CL:SIMPLE-STRING) STRINGIFY-METHOD-SIGNATURE))
...
(CL:DEFUN DEFINE-METHOD-OBJECT (DEFINITION CODE WRAPPERCODE)
  ...
  (CL:LET*
   ...
   (CL:WHEN (CL:NOT (CL:EQ METHOD NULL))
    (CL:WHEN (CL:NOT (CL:EQ CODE NULL)) (CL:SETF (%METHOD-CODE METHOD) CODE))))
  :VOID)
  ...
  (CL:WHEN
   ...
   (CL:LET* ((*PRINTREADABLY?* TRUE)) (CL:DECLARE (CL:SPECIAL *PRINTREADABLY?*))
    ...
    (CL:WHEN (CL:NOT (SUPPRESS-WARNINGS?))
     (PRINT-ERROR-CONTEXT ">> ERROR: " STANDARD-ERROR)
     (%%PRINT-STREAM (%NATIVE-STREAM STANDARD-ERROR) EOL
      " Illegal external slot definition: `" (DE-UGLIFY-PARSE-TREE PARSETREE)
      "'." EOL)))
   (CL:RETURN-FROM DEFINE-EXTERNAL-SLOT-FROM-PARSE-TREE NULL))
  (CL:LET*
   ((CLASSNAME (%%VALUE (%%REST PARSETREE))) (OWNER (TYPIFY CLASSNAME))
    (OWNERCLASS (%SURROGATE-VALUE OWNER)) (SLOT NULL)
    (OPTIONS (NTH-REST PARSETREE 3)) (MARKER *STELLA-MODULE*) (ABSTRACT? FALSE))
...
(CL:DEFUN STARTUP-STELLA-IN ()
  (CL:LET* ((*MODULE* *STELLA-MODULE*) (*CONTEXT* *MODULE*))
   ...
   (CL:WHEN (CURRENT-STARTUP-TIME-PHASE? 4)
    (CL:SETQ *REDEFINE-IDENTICAL-CLASSES?* FALSE)
...
removed from `method-tree'.\")" (CL:FUNCTION DESTRUCTURE-DEFMETHOD-TREE) NULL)
    ...
    (DEFINE-FUNCTION-OBJECT "STARTUP-STELLA-IN"
     "(DEFUN STARTUP-STELLA-IN () :PUBLIC? TRUE)" (CL:FUNCTION STARTUP-STELLA-IN)
     NULL)
    (CL:LET*
     ((FUNCTION (LOOKUP-FUNCTION SYM-STELLA-IN-STELLA-STARTUP-STELLA-IN)))
     (SET-DYNAMIC-SLOT-VALUE (%DYNAMIC-SLOTS FUNCTION)
      SYM-STELLA-IN-STELLA-METHOD-STARTUP-CLASSNAME
      (WRAP-STRING "_Startup-Stella-In") NULL-STRING-WRAPPER)))
