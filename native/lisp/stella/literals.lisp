...
(CL:DECLAIM
 (CL:SPECIAL *STELLA-MODULE* *MODULE* SYMBOL-SYM STANDARD-ERROR *CLASS-HIERARCHY-BOOTED?* NIL EOL NULL-CHARACTER
  NULL-FLOAT MOST-POSITIVE-INTEGER NULL-LONG-INTEGER NULL-INTEGER))
...
(CL:DEFMETHOD TERMINATE-WRAPPER? ((SELF WRAPPER))
  (CL:IF
   (CL:OR (CL:EQ SELF NULL-LONG-INTEGER-WRAPPER) (CL:EQ SELF NULL-FLOAT-WRAPPER) (CL:EQ SELF NULL-STRING-WRAPPER)
    (CL:EQ SELF NULL-MUTABLE-STRING-WRAPPER) (CL:EQ SELF NULL-CHARACTER-WRAPPER)
    (CL:EQ SELF NULL-FUNCTION-CODE-WRAPPER) (CL:EQ SELF NULL-METHOD-CODE-WRAPPER))
...
(CL:DEFMETHOD TERMINATE-WRAPPER? ((SELF INTEGER-WRAPPER))
  (CL:IF (CL:OR (CL:EQ SELF ZERO-WRAPPER) (CL:EQ SELF ONE-WRAPPER) (CL:EQ SELF NULL-INTEGER-WRAPPER))
   (CL:RETURN-FROM TERMINATE-WRAPPER? CL:NIL) (CL:RETURN-FROM TERMINATE-WRAPPER? CL:T)))
...
(CL:DEFUN LOOKUP-LITERAL-TYPE-INFO (TYPE KEY)
  (CL:LET* ((ENTRY (LOOKUP *LITERAL-TYPE-INFO-TABLE* TYPE)))
   (CL:IF (CL:NOT (CL:EQ ENTRY NULL)) (CL:RETURN-FROM LOOKUP-LITERAL-TYPE-INFO (LOOKUP ENTRY KEY))
...
(CL:DEFUN SET-LITERAL-TYPE-INFO (TYPE KEY VALUE)
  (CL:LET* ((ENTRY (LOOKUP *LITERAL-TYPE-INFO-TABLE* TYPE)))
   (CL:WHEN (CL:EQ ENTRY NULL) (CL:SETQ ENTRY (NEW-KEY-VALUE-LIST)) (INSERT-AT *LITERAL-TYPE-INFO-TABLE* TYPE ENTRY)
...
Return NULL if `wrapper' is NULL."
  (CL:IF (CL:EQ WRAPPER NULL) (CL:RETURN-FROM UNWRAP-INTEGER NULL-INTEGER)
...
(CL:DEFUN WRAP-LONG-INTEGER (VALUE)
  ...
  (CL:IF (CL:= VALUE NULL-LONG-INTEGER) (CL:RETURN-FROM WRAP-LONG-INTEGER NULL-LONG-INTEGER-WRAPPER)
...
(CL:DEFUN UNWRAP-LONG-INTEGER (WRAPPER)
  "Unwrap `wrapper' and return the result.
Return NULL if `wrapper' is NULL."
  (CL:IF (CL:EQ WRAPPER NULL) (CL:RETURN-FROM UNWRAP-LONG-INTEGER NULL-LONG-INTEGER)
...
wrapper unless `value' is too large and needs to be stored in a long wrapper."
  (CL:IF (CL:AND (CL:>= VALUE NULL-INTEGER) (CL:<= VALUE MOST-POSITIVE-INTEGER))
   (CL:LET* ((INTWRAPPER (CL:MAKE-INSTANCE (CL:QUOTE INTEGER-WRAPPER))))
    (CL:SETF (%WRAPPER-VALUE INTWRAPPER) (CL:TRUNCATE VALUE)) (CL:RETURN-FROM WRAP-INTEGER-VALUE INTWRAPPER))
   (CL:LET* ((LONGWRAPPER (CL:MAKE-INSTANCE (CL:QUOTE LONG-INTEGER-WRAPPER))))
    (CL:SETF (%WRAPPER-VALUE LONGWRAPPER) VALUE) (CL:RETURN-FROM WRAP-INTEGER-VALUE LONGWRAPPER))))
...
(CL:DEFUN WRAP-FLOAT (VALUE)
  ...
  (CL:IF (CL:= VALUE NULL-FLOAT) (CL:RETURN-FROM WRAP-FLOAT NULL-FLOAT-WRAPPER)
...
(CL:DEFUN WRAP-STRING (VALUE)
  ...
  (CL:IF (CL:EQ VALUE STELLA::NULL-STRING) (CL:RETURN-FROM WRAP-STRING NULL-STRING-WRAPPER)
...
(CL:DEFUN UNWRAP-STRING (WRAPPER)
  "Unwrap `wrapper' and return the result.
Return NULL if `wrapper' is NULL."
  (CL:IF (CL:EQ WRAPPER NULL) (CL:RETURN-FROM UNWRAP-STRING STELLA::NULL-STRING)
...
(CL:DEFUN WRAP-MUTABLE-STRING (VALUE)
  ...
  #+MCL
  (CL:CHECK-TYPE VALUE CL:SIMPLE-STRING)
  (CL:IF (NULL? VALUE) (CL:RETURN-FROM WRAP-MUTABLE-STRING NULL-MUTABLE-STRING-WRAPPER)
...
(CL:DEFUN UNWRAP-MUTABLE-STRING (WRAPPER)
  "Unwrap `wrapper' and return the result.
Return NULL if `wrapper' is NULL."
  (CL:IF (CL:EQ WRAPPER NULL) (CL:RETURN-FROM UNWRAP-MUTABLE-STRING STELLA::NULL-STRING)
...
(CL:DEFUN UNWRAP-CHARACTER (WRAPPER)
  "Unwrap `wrapper' and return the result.
Return NULL if `wrapper' is NULL."
  (CL:IF (CL:EQ WRAPPER NULL) (CL:RETURN-FROM UNWRAP-CHARACTER NULL-CHARACTER)
...
(CL:DEFUN WRAP-FUNCTION-CODE (VALUE)
  ...
  (CL:IF (CL:EQ VALUE NULL) (CL:RETURN-FROM WRAP-FUNCTION-CODE NULL-FUNCTION-CODE-WRAPPER)
...
(CL:DEFUN UNWRAP-FUNCTION-CODE (WRAPPER)
  "Unwrap `wrapper' and return the result.
Return NULL if `wrapper' is NULL."
  (CL:IF (CL:EQ WRAPPER NULL) (CL:RETURN-FROM UNWRAP-FUNCTION-CODE NULL)
...
(CL:DEFUN WRAP-METHOD-CODE (VALUE)
  ...
  (CL:IF (CL:EQ VALUE NULL) (CL:RETURN-FROM WRAP-METHOD-CODE NULL-METHOD-CODE-WRAPPER)
...
(CL:DEFUN INLINE-WRAP-BOOLEAN (EXPRESSION)
  (CL:LET* ((WALKEDEXP (WALKED-EXPRESSION-EXPRESSION EXPRESSION)))
   (CL:COND
    ((CL:EQ WALKEDEXP SYM-LITERALS-STELLA-TRUE) (CL:RETURN-FROM INLINE-WRAP-BOOLEAN SYM-LITERALS-STELLA-TRUE-WRAPPER))
    ((CL:EQ WALKEDEXP SYM-LITERALS-STELLA-FALSE)
     (CL:RETURN-FROM INLINE-WRAP-BOOLEAN SYM-LITERALS-STELLA-FALSE-WRAPPER))
   ...
   (CL:COND
    ...
    (CL:T
     (CL:RETURN-FROM INLINE-UNWRAP-BOOLEAN
      (LIST* SYM-LITERALS-STELLA-COERCE-WRAPPED-BOOLEAN-TO-BOOLEAN EXPRESSION NIL))))))
...
(CL:DEFMETHOD OBJECT-EQL? ((X OBJECT) Y)
  (CL:LET* ((STREAM-000 (NEW-OUTPUT-STRING-STREAM)))
   (%%PRINT-STREAM (%NATIVE-STREAM STREAM-000) "object-eql?: Don't know how to compare `" X "' with `" Y "'")
...
(CL:DEFMETHOD OBJECT-EQL? ((X INTEGER-WRAPPER) Y)
  (CL:RETURN-FROM OBJECT-EQL?
   (CL:AND (CL:NOT (CL:EQ Y NULL))
    (CL:OR (CL:EQ (PRIMARY-TYPE Y) SGT-LITERALS-STELLA-INTEGER-WRAPPER) (ISA? Y SGT-LITERALS-STELLA-INTEGER-WRAPPER))
...
(CL:DEFMETHOD OBJECT-EQL? ((X LONG-INTEGER-WRAPPER) Y)
  (CL:RETURN-FROM OBJECT-EQL?
   (CL:AND (CL:NOT (CL:EQ Y NULL))
    (CL:OR (CL:EQ (PRIMARY-TYPE Y) SGT-LITERALS-STELLA-LONG-INTEGER-WRAPPER)
...
(CL:DEFMETHOD OBJECT-EQL? ((X FLOAT-WRAPPER) Y)
  (CL:RETURN-FROM OBJECT-EQL?
   (CL:AND (CL:NOT (CL:EQ Y NULL))
    (CL:OR (CL:EQ (PRIMARY-TYPE Y) SGT-LITERALS-STELLA-FLOAT-WRAPPER) (ISA? Y SGT-LITERALS-STELLA-FLOAT-WRAPPER))
    (CL:= (%WRAPPER-VALUE X) (%WRAPPER-VALUE Y)))))
...
(CL:DEFMETHOD OBJECT-EQL? ((X BOOLEAN-WRAPPER) Y)
  (CL:RETURN-FROM OBJECT-EQL?
   (CL:OR (CL:EQ X Y)
    (CL:AND (CL:NOT (CL:EQ Y NULL))
     (CL:OR (CL:EQ (PRIMARY-TYPE Y) SGT-LITERALS-STELLA-BOOLEAN-WRAPPER) (ISA? Y SGT-LITERALS-STELLA-BOOLEAN-WRAPPER))
    ...
    (CL:WHEN
     (CL:OR (CL:EQ YTYPE SGT-LITERALS-STELLA-STRING-WRAPPER) (CL:EQ YTYPE SGT-LITERALS-STELLA-VERBATIM-STRING-WRAPPER)
      (CL:AND (CL:NOT *CLASS-HIERARCHY-BOOTED?*)
       (CL:OR (CL:EQ YTYPE NULL) (CL:EQ SGT-LITERALS-STELLA-STRING-WRAPPER NULL)
...
(CL:DEFMETHOD OBJECT-EQL? ((X CHARACTER-WRAPPER) Y)
  (CL:RETURN-FROM OBJECT-EQL?
   (CL:AND (CL:NOT (CL:EQ Y NULL))
    (CL:OR (CL:EQ (PRIMARY-TYPE Y) SGT-LITERALS-STELLA-CHARACTER-WRAPPER)
     ...
     (CL:PROGN
      (CL:IF (CL:EQ TREE NIL) (CL:RETURN-FROM HELP-BQUOTIFY SYM-LITERALS-STELLA-NIL)
       (CL:RETURN-FROM HELP-BQUOTIFY
        (CONS-LIST SYM-LITERALS-STELLA-CONS (HELP-BQUOTIFY (%%VALUE TREE)) (HELP-BQUOTIFY (%%REST TREE)))))))
    ((SUBTYPE-OF-INTEGER? TEST-VALUE-000)
     (CL:PROGN (CL:RETURN-FROM HELP-BQUOTIFY (CONS-LIST SYM-LITERALS-STELLA-WRAP-LITERAL TREE))))
    ...
    ((SUBTYPE-OF-KEYWORD? TEST-VALUE-000)
     (CL:PROGN
      (CL:IF (USE-HARDCODED-SYMBOLS?)
       (CL:RETURN-FROM HELP-BQUOTIFY (CONS-LIST SYM-LITERALS-STELLA-GET-KWD (WRAP-INTEGER (%SYMBOL-ID TREE))))
       (CL:RETURN-FROM HELP-BQUOTIFY
        (CONS-LIST SYM-LITERALS-STELLA-TYPED-SYS (REGISTER-SYMBOL TREE) SGT-LITERALS-STELLA-SYMBOL)))))
    ((SUBTYPE-OF-SURROGATE? TEST-VALUE-000)
     (CL:PROGN
      (CL:IF (USE-HARDCODED-SYMBOLS?)
       (CL:RETURN-FROM HELP-BQUOTIFY (CONS-LIST SYM-LITERALS-STELLA-GET-SGT (WRAP-INTEGER (%SYMBOL-ID TREE))))
       (CL:RETURN-FROM HELP-BQUOTIFY
        (CONS-LIST SYM-LITERALS-STELLA-TYPED-SYS (REGISTER-SYMBOL TREE) SGT-LITERALS-STELLA-SYMBOL)))))
    ((SUBTYPE-OF-SYMBOL? TEST-VALUE-000)
     (CL:PROGN
      (CL:IF (SYMBOL-COMMON-LISP? TREE)
       (CL:RETURN-FROM HELP-BQUOTIFY
        (CONS-LIST SYM-LITERALS-STELLA-INTERN-COMMON-LISP-SYMBOL (WRAP-STRING (%SYMBOL-NAME TREE))))
       (CL:IF (USE-HARDCODED-SYMBOLS?)
        (CL:RETURN-FROM HELP-BQUOTIFY
         (CONS-LIST SYM-LITERALS-STELLA-GET-SYM (WRAP-INTEGER (%SYMBOL-ID (PERMANENTIFY TREE)))))
        (CL:RETURN-FROM HELP-BQUOTIFY
         (CONS-LIST SYM-LITERALS-STELLA-TYPED-SYS (REGISTER-SYMBOL TREE) SGT-LITERALS-STELLA-SYMBOL))))))
    (CL:T
     (CL:LET* ((*PRINTREADABLY?* CL:T)) (CL:DECLARE (CL:SPECIAL *PRINTREADABLY?*)) (SIGNAL-TRANSLATION-ERROR)
      (CL:WHEN (CL:NOT (SUPPRESS-WARNINGS?)) (PRINT-ERROR-CONTEXT ">> ERROR: " STANDARD-ERROR)
       (%%PRINT-STREAM (%NATIVE-STREAM STANDARD-ERROR) EOL " Illegal argument to quote: `" (DE-UGLIFY-PARSE-TREE TREE)
        "'." EOL)))
     ...
     (CL:LET* ((EXPANDEDTREE (CONS SYM-LITERALS-STELLA-LIST* NIL)) (CURSOR TREE) (TERM (%%VALUE CURSOR)))
      (CL:LOOP WHILE
       (CL:AND (CL:NOT (CL:EQ CURSOR NIL))
        (CL:NOT (CL:OR (CL:EQ TERM |SYM-LITERALS-STELLA-&|) (CL:EQ TERM |SYM-LITERALS-STELLA-&&|))))
       DO (CL:SETQ EXPANDEDTREE (CONS (EXPAND-BQUOTE-TREE TERM) EXPANDEDTREE)) (CL:SETQ CURSOR (%%REST CURSOR))
       (CL:SETQ TERM (%%VALUE CURSOR)))
      (CL:COND
       ((CL:EQ CURSOR NIL) (CL:RETURN-FROM EXPAND-BQUOTE-TREE (REVERSE (CONS SYM-LITERALS-STELLA-NIL EXPANDEDTREE))))
       ((CL:EQ TERM |SYM-LITERALS-STELLA-&|) (CL:SETQ CURSOR (%%REST CURSOR))
        (CL:WHEN (CL:EQ CURSOR NIL)
         (CL:LET* ((*PRINTREADABLY?* CL:T)) (CL:DECLARE (CL:SPECIAL *PRINTREADABLY?*)) (SIGNAL-TRANSLATION-ERROR)
          (CL:WHEN (CL:NOT (SUPPRESS-WARNINGS?)) (PRINT-ERROR-CONTEXT ">> ERROR: " STANDARD-ERROR)
           (%%PRINT-STREAM (%NATIVE-STREAM STANDARD-ERROR) EOL " Illegal bquote tree -- missing term after '&'.."
            EOL))))
        (CL:RETURN-FROM EXPAND-BQUOTE-TREE
         (REVERSE (CONS (EXPAND-BQUOTE-TREE (%%REST CURSOR)) (CONS (%%VALUE CURSOR) EXPANDEDTREE)))))
       (CL:T (CL:SETQ CURSOR (%%REST CURSOR))
        ...
        (CL:RETURN-FROM EXPAND-BQUOTE-TREE
         (REVERSE
          (CONS (CONS-LIST SYM-LITERALS-STELLA-CONCATENATE (%%VALUE CURSOR) (EXPAND-BQUOTE-TREE (%%REST CURSOR)))
           EXPANDEDTREE))))))))
   ...
   ((CL:EQ (SAFE-PRIMARY-TYPE TREE) SGT-LITERALS-STELLA-CONS)
    (CL:PROGN
     (CL:LET* ((CURSOR (%%REST TREE)))
      (CL:LOOP WHILE (CL:NOT (CL:EQ CURSOR NIL)) DO (CL:SETF (%%VALUE CURSOR) (SIMPLIFY-BQUOTE-TREE (%%VALUE CURSOR)))
      ...
      (CL:CASE (LENGTH (%%REST TREE)) (1 (CL:RETURN-FROM SIMPLIFY-BQUOTE-TREE (%%VALUE (%%REST TREE))))
       (2 (CL:SETF (%%VALUE TREE) SYM-LITERALS-STELLA-CONS) (CL:RETURN-FROM SIMPLIFY-BQUOTE-TREE TREE))
  ...
  (CL:LET*
   ((PERMANENTSYMBOL
     (LOOKUP-RIGID-SYMBOL-WRT-MODULE (%SYMBOL-NAME SYMBOL)
      (CL:IF (CL:NOT (CL:EQ (%HOME-CONTEXT SYMBOL) NULL)) (%HOME-CONTEXT SYMBOL) *MODULE*) SYMBOL-SYM)))
   (CL:IF (CL:NOT (CL:EQ PERMANENTSYMBOL NULL)) (CL:RETURN-FROM SOFT-PERMANENTIFY PERMANENTSYMBOL)
    (CL:RETURN-FROM SOFT-PERMANENTIFY SYMBOL))))
...
(CL:DEFUN PRINT-CHARACTER (CHAR STREAM)
  (%%PRINT-STREAM STREAM "#\\")
  (CL:CASE CHAR (#\Linefeed (%%PRINT-STREAM STREAM "Linefeed")) (#\Backspace (%%PRINT-STREAM STREAM "Backspace"))
   (#\Tab (%%PRINT-STREAM STREAM "Tab")) (#\Return (%%PRINT-STREAM STREAM "Return"))
   (#\Page (%%PRINT-STREAM STREAM "Page")) (CL:OTHERWISE (%%PRINT-STREAM STREAM CHAR)))
  :VOID)
...
(CL:DEFUN CREATE-CHARACTER-TYPE-TABLE ()
  (CL:LET* ((TABLE (CL:MAKE-ARRAY 256))) (CL:DECLARE (CL:TYPE CL:SIMPLE-VECTOR TABLE))
   (CL:LET* ((CODE NULL-INTEGER) (ITER-000 0) (UPPER-BOUND-000 255))
    ...
    (CL:LOOP WHILE (CL:<= ITER-000 UPPER-BOUND-000) DO (CL:SETQ CODE ITER-000)
     (CL:SETF (CL:AREF TABLE CODE) KWD-LITERALS-OTHER) (CL:SETQ ITER-000 (CL:1+ ITER-000))))
   (CL:LET*
    ((CODE NULL-INTEGER) (ITER-001 (CL:THE CL:FIXNUM (CL:CHAR-CODE #\0)))
     (UPPER-BOUND-001 (CL:THE CL:FIXNUM (CL:CHAR-CODE #\9))) (UNBOUNDED?-000 (CL:= UPPER-BOUND-001 NULL-INTEGER)))
    (CL:DECLARE (CL:TYPE CL:FIXNUM CODE ITER-001 UPPER-BOUND-001))
    (CL:LOOP WHILE (CL:OR UNBOUNDED?-000 (CL:<= ITER-001 UPPER-BOUND-001)) DO (CL:SETQ CODE ITER-001)
     (CL:SETF (CL:AREF TABLE CODE) KWD-LITERALS-DIGIT) (CL:SETQ ITER-001 (CL:1+ ITER-001))))
   (CL:LET*
    ((CODE NULL-INTEGER) (ITER-002 (CL:THE CL:FIXNUM (CL:CHAR-CODE #\A)))
     (UPPER-BOUND-002 (CL:THE CL:FIXNUM (CL:CHAR-CODE #\Z))) (UNBOUNDED?-001 (CL:= UPPER-BOUND-002 NULL-INTEGER)))
    (CL:DECLARE (CL:TYPE CL:FIXNUM CODE ITER-002 UPPER-BOUND-002))
    (CL:LOOP WHILE (CL:OR UNBOUNDED?-001 (CL:<= ITER-002 UPPER-BOUND-002)) DO (CL:SETQ CODE ITER-002)
     (CL:SETF (CL:AREF TABLE CODE) KWD-LITERALS-LETTER) (CL:SETQ ITER-002 (CL:1+ ITER-002))))
   (CL:LET*
    ((CODE NULL-INTEGER) (ITER-003 (CL:THE CL:FIXNUM (CL:CHAR-CODE #\a)))
     (UPPER-BOUND-003 (CL:THE CL:FIXNUM (CL:CHAR-CODE #\z))) (UNBOUNDED?-002 (CL:= UPPER-BOUND-003 NULL-INTEGER)))
    (CL:DECLARE (CL:TYPE CL:FIXNUM CODE ITER-003 UPPER-BOUND-003))
    (CL:LOOP WHILE (CL:OR UNBOUNDED?-002 (CL:<= ITER-003 UPPER-BOUND-003)) DO (CL:SETQ CODE ITER-003)
     (CL:SETF (CL:AREF TABLE CODE) KWD-LITERALS-LETTER) (CL:SETQ ITER-003 (CL:1+ ITER-003))))
   ...
   (CL:SETF (CL:AREF TABLE (CL:THE CL:FIXNUM (CL:CHAR-CODE #\Linefeed))) KWD-LITERALS-WHITE-SPACE)
   (CL:SETF (CL:AREF TABLE (CL:THE CL:FIXNUM (CL:CHAR-CODE #\Page))) KWD-LITERALS-WHITE-SPACE)
...
(CL:DEFUN DIGIT-CHARACTER? (CH)
  ...
  (CL:RETURN-FROM DIGIT-CHARACTER?
   (CL:EQ (CL:AREF *CHARACTER-TYPE-TABLE* (CL:THE CL:FIXNUM (CL:CHAR-CODE CH))) KWD-LITERALS-DIGIT)))
...
(CL:DEFUN LETTER-CHARACTER? (CH)
  ...
  (CL:RETURN-FROM LETTER-CHARACTER?
   (CL:EQ (CL:AREF *CHARACTER-TYPE-TABLE* (CL:THE CL:FIXNUM (CL:CHAR-CODE CH))) KWD-LITERALS-LETTER)))
...
(CL:DEFUN WHITE-SPACE-CHARACTER? (CH)
  ...
  (CL:RETURN-FROM WHITE-SPACE-CHARACTER?
   (CL:EQ (CL:AREF *CHARACTER-TYPE-TABLE* (CL:THE CL:FIXNUM (CL:CHAR-CODE CH))) KWD-LITERALS-WHITE-SPACE)))
...
(CL:DEFUN ALL-UPPER-CASE-STRING? (S)
  ...
  (CL:LET* ((CODE 0) (CODEA (CL:THE CL:FIXNUM (CL:CHAR-CODE #\a))) (CODEZ (CL:THE CL:FIXNUM (CL:CHAR-CODE #\z))))
   ...
   (CL:LET* ((CH NULL-CHARACTER) (VECTOR-000 S) (INDEX-000 0) (LENGTH-000 (CL:THE CL:FIXNUM (CL:LENGTH VECTOR-000))))
    ...
    (CL:LOOP WHILE (CL:< INDEX-000 LENGTH-000) DO
     ...
     (CL:WHEN (CL:AND (CL:>= CODE CODEA) (CL:<= CODE CODEZ)) (CL:RETURN-FROM ALL-UPPER-CASE-STRING? CL:NIL))
    ...
    (CL:LOOP WHILE (CL:< INDEX-000 LENGTH-000) DO
     (CL:SETQ CH
      (CL:LET ((SELF VECTOR-000) (POSITION INDEX-000))
       ...
       (CL:SCHAR (CL:THE CL:SIMPLE-STRING SELF) (CL:THE CL:FIXNUM POSITION))))
     (CL:SETQ CODE (CL:THE CL:FIXNUM (CL:CHAR-CODE CH)))
     (CL:WHEN (CL:AND (CL:<= CODE CODEZ) (CL:>= CODE CODEA)) (CL:RETURN-FROM ALL-LOWER-CASE-STRING? CL:NIL))
     (CL:SETQ INDEX-000 (CL:1+ INDEX-000))))
      ...
      (CL:LET
       ((SELF BUFFER)
        (CH
         (CL:CODE-CHAR
          (CL:THE CL:FIXNUM
           (CL:+ (CL:THE CL:FIXNUM (CL:CHAR-CODE #\A)) (CL:- I (CL:THE CL:FIXNUM (CL:CHAR-CODE #\a)))))))
        (POSITION I))
       (CL:DECLARE (CL:TYPE CL:SIMPLE-STRING SELF) (CL:TYPE CL:FIXNUM POSITION))
       (SETF (CL:SCHAR (CL:THE CL:SIMPLE-STRING SELF) (CL:THE CL:FIXNUM POSITION)) (CL:THE CL:CHARACTER CH))))
...
otherwise, return 'char' unmodified."
  (CL:RETURN-FROM UPCASE-CHARACTER
   (CL:LET ((SELF *CHARACTER-UPCASE-TABLE*) (POSITION (CL:THE CL:FIXNUM (CL:CHAR-CODE CHAR))))
    (CL:DECLARE (CL:TYPE CL:SIMPLE-STRING SELF) (CL:TYPE CL:FIXNUM POSITION))
    (CL:SCHAR (CL:THE CL:SIMPLE-STRING SELF) (CL:THE CL:FIXNUM POSITION)))))
...
(%%DEFCONSMETHOD NUMBER-WRAPPER-TO-FLOAT ((SELF OBJECT))
  (CL:LET* ((STREAM-000 (NEW-OUTPUT-STRING-STREAM)))
   (%%PRINT-STREAM (%NATIVE-STREAM STREAM-000) "`" SELF "' is not a number wrapper")
...
(CL:DEFUN HELP-STARTUP-LITERALS1 ()
  (CL:PROGN (CL:SETQ SGT-LITERALS-STELLA-BOOLEAN (INTERN-RIGID-SYMBOL-WRT-MODULE "BOOLEAN" NULL 1))
   ...
   (CL:SETQ SYM-LITERALS-STELLA-NULL-LONG-INTEGER-WRAPPER
    (INTERN-RIGID-SYMBOL-WRT-MODULE "NULL-LONG-INTEGER-WRAPPER" NULL 0))
   ...
   (CL:SETQ SYM-LITERALS-STELLA-COERCE-WRAPPED-BOOLEAN-TO-BOOLEAN
    (INTERN-RIGID-SYMBOL-WRT-MODULE "COERCE-WRAPPED-BOOLEAN-TO-BOOLEAN" NULL 0))
   ...
   (CL:SETQ SYM-LITERALS-STELLA-NULL (INTERN-RIGID-SYMBOL-WRT-MODULE "NULL" NULL 0))
   (CL:SETQ SYM-LITERALS-STELLA-NIL (INTERN-RIGID-SYMBOL-WRT-MODULE "NIL" NULL 0))
   ...
   (CL:SETQ SGT-LITERALS-STELLA-CONS (INTERN-RIGID-SYMBOL-WRT-MODULE "CONS" NULL 1))
   (CL:SETQ SYM-LITERALS-STELLA-LIST* (INTERN-RIGID-SYMBOL-WRT-MODULE "LIST*" NULL 0))
   ...
   (CL:SETQ KWD-LITERALS-OTHER (INTERN-RIGID-SYMBOL-WRT-MODULE "OTHER" NULL 2))
   (CL:SETQ KWD-LITERALS-DIGIT (INTERN-RIGID-SYMBOL-WRT-MODULE "DIGIT" NULL 2))
...
(CL:DEFUN HELP-STARTUP-LITERALS2 ()
  (CL:PROGN (CL:SETQ *LITERAL-TYPE-INFO-TABLE* (NEW-HASH-TABLE)) (CL:SETQ *LITERAL-TYPES* (NEW-LIST))
   ...
   (SET-LITERAL-TYPE-INFO SGT-LITERALS-STELLA-INTEGER KWD-LITERALS-NULL-WRAPPER
    SYM-LITERALS-STELLA-NULL-INTEGER-WRAPPER)
   (SET-LITERAL-TYPE-INFO SGT-LITERALS-STELLA-LONG-INTEGER KWD-LITERALS-NULL-WRAPPER
   ...
   (SET-LITERAL-TYPE-INFO SGT-LITERALS-STELLA-MUTABLE-STRING KWD-LITERALS-NULL-WRAPPER
    SYM-LITERALS-STELLA-NULL-MUTABLE-STRING-WRAPPER)
   (SET-LITERAL-TYPE-INFO SGT-LITERALS-STELLA-CHARACTER KWD-LITERALS-NULL-WRAPPER
    SYM-LITERALS-STELLA-NULL-CHARACTER-WRAPPER)
   (SET-LITERAL-TYPE-INFO SGT-LITERALS-STELLA-FUNCTION-CODE KWD-LITERALS-NULL-WRAPPER
    SYM-LITERALS-STELLA-NULL-FUNCTION-CODE-WRAPPER)
   (SET-LITERAL-TYPE-INFO SGT-LITERALS-STELLA-METHOD-CODE KWD-LITERALS-NULL-WRAPPER
   ...
   (SET-LITERAL-TYPE-INFO SGT-LITERALS-STELLA-LONG-INTEGER KWD-LITERALS-WRAP-FUNCTION
    SYM-LITERALS-STELLA-WRAP-LONG-INTEGER)
   ...
   (SET-LITERAL-TYPE-INFO SGT-LITERALS-STELLA-FUNCTION-CODE KWD-LITERALS-WRAP-FUNCTION
    SYM-LITERALS-STELLA-WRAP-FUNCTION-CODE)
   (SET-LITERAL-TYPE-INFO SGT-LITERALS-STELLA-METHOD-CODE KWD-LITERALS-WRAP-FUNCTION
    SYM-LITERALS-STELLA-WRAP-METHOD-CODE)
...
(CL:DEFUN HELP-STARTUP-LITERALS3 ()
  (CL:PROGN
   (DEFINE-METHOD-OBJECT "(DEFMETHOD (TERMINATE-WRAPPER? BOOLEAN) ((SELF WRAPPER)) :PUBLIC? TRUE)"
    (CL:FUNCTION TERMINATE-WRAPPER?) NULL)
   (DEFINE-METHOD-OBJECT "(DEFMETHOD (TERMINATE-WRAPPER? BOOLEAN) ((SELF INTEGER-WRAPPER)) :PUBLIC? TRUE)"
    (CL:FUNCTION TERMINATE-WRAPPER?) NULL)
   (DEFINE-FUNCTION-OBJECT "LOOKUP-LITERAL-TYPE-INFO"
    "(DEFUN (LOOKUP-LITERAL-TYPE-INFO OBJECT) ((TYPE TYPE) (KEY KEYWORD)))" (CL:FUNCTION LOOKUP-LITERAL-TYPE-INFO)
    NULL)
   (DEFINE-FUNCTION-OBJECT "SET-LITERAL-TYPE-INFO"
    "(DEFUN SET-LITERAL-TYPE-INFO ((TYPE TYPE) (KEY KEYWORD) (VALUE OBJECT)))" (CL:FUNCTION SET-LITERAL-TYPE-INFO)
    NULL)
...
Map NULL onto FALSE.\" :PUBLIC? TRUE :GLOBALLY-INLINE? TRUE (RETURN (EQ? WRAPPER TRUE-WRAPPER)))"
   ...
   (DEFINE-FUNCTION-OBJECT "INLINE-WRAP-BOOLEAN"
    "(DEFUN INLINE-WRAP-BOOLEAN ((EXPRESSION OBJECT)) :TYPE OBJECT :MACRO? TRUE)" (CL:FUNCTION INLINE-WRAP-BOOLEAN)
    NULL)
   (DEFINE-FUNCTION-OBJECT "INLINE-UNWRAP-BOOLEAN"
    "(DEFUN INLINE-UNWRAP-BOOLEAN ((EXPRESSION OBJECT)) :TYPE OBJECT :MACRO? TRUE)" (CL:FUNCTION INLINE-UNWRAP-BOOLEAN)
    NULL)
   ...
   (DEFINE-METHOD-OBJECT
    ...
    (CL:FUNCTION WRAP-LITERAL) NULL)
   (DEFINE-METHOD-OBJECT "(DEFMETHOD (COPY-WRAPPED-LITERAL OBJECT) ((SELF STANDARD-OBJECT)))"
    (CL:FUNCTION COPY-WRAPPED-LITERAL) NULL)
   (DEFINE-METHOD-OBJECT "(DEFMETHOD (COPY-WRAPPED-LITERAL OBJECT) ((SELF LITERAL-WRAPPER)))"
    (CL:FUNCTION COPY-WRAPPED-LITERAL) NULL)
   (DEFINE-METHOD-OBJECT "(DEFMETHOD (COPY-WRAPPED-LITERAL OBJECT) ((SELF INTEGER-WRAPPER)))"
    (CL:FUNCTION COPY-WRAPPED-LITERAL) NULL)
   (DEFINE-METHOD-OBJECT "(DEFMETHOD (COPY-WRAPPED-LITERAL OBJECT) ((SELF LONG-INTEGER-WRAPPER)))"
    (CL:FUNCTION COPY-WRAPPED-LITERAL) NULL)
   (DEFINE-METHOD-OBJECT "(DEFMETHOD (COPY-WRAPPED-LITERAL OBJECT) ((SELF FLOAT-WRAPPER)))"
    (CL:FUNCTION COPY-WRAPPED-LITERAL) NULL)
   (DEFINE-METHOD-OBJECT "(DEFMETHOD (COPY-WRAPPED-LITERAL OBJECT) ((SELF STRING-WRAPPER)))"
    (CL:FUNCTION COPY-WRAPPED-LITERAL) NULL)
   (DEFINE-METHOD-OBJECT "(DEFMETHOD (COPY-WRAPPED-LITERAL OBJECT) ((SELF MUTABLE-STRING-WRAPPER)))"
    (CL:FUNCTION COPY-WRAPPED-LITERAL) NULL)
   (DEFINE-METHOD-OBJECT "(DEFMETHOD (COPY-WRAPPED-LITERAL OBJECT) ((SELF CHARACTER-WRAPPER)))"
    (CL:FUNCTION COPY-WRAPPED-LITERAL) NULL)
   (DEFINE-METHOD-OBJECT "(DEFMETHOD (COPY-WRAPPED-LITERAL OBJECT) ((SELF FUNCTION-CODE-WRAPPER)))"
    (CL:FUNCTION COPY-WRAPPED-LITERAL) NULL)
   (DEFINE-METHOD-OBJECT "(DEFMETHOD (COPY-WRAPPED-LITERAL OBJECT) ((SELF METHOD-CODE-WRAPPER)))"
    (CL:FUNCTION COPY-WRAPPED-LITERAL) NULL)
   (DEFINE-METHOD-OBJECT "(DEFMETHOD (OBJECT-EQL? BOOLEAN) ((X OBJECT) (Y OBJECT)))" (CL:FUNCTION OBJECT-EQL?) NULL)
   (DEFINE-METHOD-OBJECT "(DEFMETHOD (OBJECT-EQL? BOOLEAN) ((X STANDARD-OBJECT) (Y OBJECT)))" (CL:FUNCTION OBJECT-EQL?)
    NULL)
   (DEFINE-METHOD-OBJECT "(DEFMETHOD (OBJECT-EQL? BOOLEAN) ((X INTEGER-WRAPPER) (Y OBJECT)))" (CL:FUNCTION OBJECT-EQL?)
    NULL)
   (DEFINE-METHOD-OBJECT "(DEFMETHOD (OBJECT-EQL? BOOLEAN) ((X LONG-INTEGER-WRAPPER) (Y OBJECT)))"
    (CL:FUNCTION OBJECT-EQL?) NULL)
   (DEFINE-METHOD-OBJECT "(DEFMETHOD (OBJECT-EQL? BOOLEAN) ((X FLOAT-WRAPPER) (Y OBJECT)))" (CL:FUNCTION OBJECT-EQL?)
    NULL)
   (DEFINE-METHOD-OBJECT "(DEFMETHOD (OBJECT-EQL? BOOLEAN) ((X BOOLEAN-WRAPPER) (Y OBJECT)))" (CL:FUNCTION OBJECT-EQL?)
    NULL)
   (DEFINE-METHOD-OBJECT "(DEFMETHOD (OBJECT-EQL? BOOLEAN) ((X STRING-WRAPPER) (Y OBJECT)))" (CL:FUNCTION OBJECT-EQL?)
    NULL)
   (DEFINE-METHOD-OBJECT "(DEFMETHOD (OBJECT-EQL? BOOLEAN) ((X MUTABLE-STRING-WRAPPER) (Y OBJECT)))"
    (CL:FUNCTION OBJECT-EQL?) NULL)
   (DEFINE-METHOD-OBJECT "(DEFMETHOD (OBJECT-EQL? BOOLEAN) ((X CHARACTER-WRAPPER) (Y OBJECT)))"
    (CL:FUNCTION OBJECT-EQL?) NULL)
   (DEFINE-FUNCTION-OBJECT "EQL-TO-BOOLEAN?" "(DEFUN (EQL-TO-BOOLEAN? BOOLEAN) ((Y OBJECT) (X BOOLEAN)))"
    (CL:FUNCTION EQL-TO-BOOLEAN?) NULL)
   (DEFINE-FUNCTION-OBJECT "EQL-TO-INTEGER?" "(DEFUN (EQL-TO-INTEGER? BOOLEAN) ((Y OBJECT) (X INTEGER)))"
    (CL:FUNCTION EQL-TO-INTEGER?) NULL)
   (DEFINE-FUNCTION-OBJECT "EQL-TO-LONG-INTEGER?"
    "(DEFUN (EQL-TO-LONG-INTEGER? BOOLEAN) ((Y OBJECT) (X LONG-INTEGER)))" (CL:FUNCTION EQL-TO-LONG-INTEGER?) NULL)
   (DEFINE-FUNCTION-OBJECT "EQL-TO-FLOAT?" "(DEFUN (EQL-TO-FLOAT? BOOLEAN) ((Y OBJECT) (X FLOAT)))"
    (CL:FUNCTION EQL-TO-FLOAT?) NULL)
   (DEFINE-FUNCTION-OBJECT "EQL-TO-STRING?" "(DEFUN (EQL-TO-STRING? BOOLEAN) ((Y OBJECT) (X STRING)))"
    (CL:FUNCTION EQL-TO-STRING?) NULL)
   (DEFINE-FUNCTION-OBJECT "EQL-TO-CHARACTER?" "(DEFUN (EQL-TO-CHARACTER? BOOLEAN) ((Y OBJECT) (X CHARACTER)))"
    (CL:FUNCTION EQL-TO-CHARACTER?) NULL)
   (DEFINE-FUNCTION-OBJECT "HELP-BQUOTIFY" "(DEFUN (HELP-BQUOTIFY OBJECT) ((TREE OBJECT)))" (CL:FUNCTION HELP-BQUOTIFY)
    NULL))
  :VOID)
...
(CL:DEFUN HELP-STARTUP-LITERALS4 ()
  (CL:PROGN (DEFINE-FUNCTION-OBJECT "BQUOTIFY" "(DEFUN (BQUOTIFY OBJECT) ((TREE OBJECT)))" (CL:FUNCTION BQUOTIFY) NULL)
   (DEFINE-FUNCTION-OBJECT "EXPAND-BQUOTE-TREE" "(DEFUN (EXPAND-BQUOTE-TREE OBJECT) ((TREE OBJECT)))"
    (CL:FUNCTION EXPAND-BQUOTE-TREE) NULL)
   (DEFINE-FUNCTION-OBJECT "SIMPLIFY-BQUOTE-TREE" "(DEFUN (SIMPLIFY-BQUOTE-TREE OBJECT) ((TREE OBJECT)))"
    (CL:FUNCTION SIMPLIFY-BQUOTE-TREE) NULL)
   (DEFINE-METHOD-OBJECT "(DEFMETHOD (PERMANENTIFY OBJECT) ((SELF OBJECT)) :PUBLIC? TRUE)" (CL:FUNCTION PERMANENTIFY)
    NULL)
   (DEFINE-METHOD-OBJECT "(DEFMETHOD (PERMANENTIFY SYMBOL) ((SELF SYMBOL)) :PUBLIC? TRUE)" (CL:FUNCTION PERMANENTIFY)
    NULL)
   (DEFINE-METHOD-OBJECT "(DEFMETHOD (PERMANENTIFY SYMBOL) ((SELF TRANSIENT-SYMBOL)) :PUBLIC? TRUE)"
    (CL:FUNCTION PERMANENTIFY) NULL)
   (DEFINE-METHOD-OBJECT "(DEFMETHOD (PERMANENTIFY LITERAL-WRAPPER) ((SELF LITERAL-WRAPPER)) :PUBLIC? TRUE)"
    (CL:FUNCTION PERMANENTIFY) NULL)
   (DEFINE-FUNCTION-OBJECT "PERMANENT-COPY" "(DEFUN (PERMANENT-COPY OBJECT) ((TREE OBJECT)) :PUBLIC? TRUE)"
    (CL:FUNCTION PERMANENT-COPY) NULL)
   (DEFINE-METHOD-OBJECT "(DEFMETHOD (SOFT-PERMANENTIFY SYMBOL) ((SYMBOL SYMBOL)))" (CL:FUNCTION SOFT-PERMANENTIFY)
    NULL)
   (DEFINE-METHOD-OBJECT "(DEFMETHOD (SOFT-PERMANENTIFY SYMBOL) ((SYMBOL TRANSIENT-SYMBOL)))"
   ...
   (DEFINE-FUNCTION-OBJECT "CREATE-CHARACTER-TYPE-TABLE"
    "(DEFUN (CREATE-CHARACTER-TYPE-TABLE (ARRAY (256) OF KEYWORD)) ())" (CL:FUNCTION CREATE-CHARACTER-TYPE-TABLE) NULL)
   ...
   (DEFINE-FUNCTION-OBJECT "INITIALIZE-CHARACTER-UPCASE-TABLE" "(DEFUN (INITIALIZE-CHARACTER-UPCASE-TABLE STRING) ())"
    (CL:FUNCTION INITIALIZE-CHARACTER-UPCASE-TABLE) NULL)
   (DEFINE-FUNCTION-OBJECT "INITIALIZE-CHARACTER-DOWNCASE-TABLE"
    "(DEFUN (INITIALIZE-CHARACTER-DOWNCASE-TABLE STRING) ())" (CL:FUNCTION INITIALIZE-CHARACTER-DOWNCASE-TABLE) NULL)
...
otherwise, return 'char' unmodified.\" (RETURN (NTH *CHARACTER-DOWNCASE-TABLE* (CHARACTER-CODE CHAR))))"
   ...
   (DEFINE-FUNCTION-OBJECT "PRINT-STRING-READABLY"
    "(DEFUN PRINT-STRING-READABLY ((STRING STRING) (STREAM NATIVE-OUTPUT-STREAM)))" (CL:FUNCTION PRINT-STRING-READABLY)
    NULL)
...
In Lisp and C++ this is a no-op.\" :PUBLIC? TRUE :GLOBALLY-INLINE? TRUE (RETURN (VERBATIM :COMMON-LISP S :CPP \"s\" :JAVA \"s.toString()\")))"
   ...
   (DEFINE-METHOD-OBJECT "(DEFMETHOD (NUMBER-WRAPPER-TO-FLOAT FLOAT) ((SELF OBJECT)) :PUBLIC? TRUE)"
    (CL:FUNCTION NUMBER-WRAPPER-TO-FLOAT) NULL)
   (DEFINE-METHOD-OBJECT "(DEFMETHOD (NUMBER-WRAPPER-TO-FLOAT FLOAT) ((SELF INTEGER-WRAPPER)) :PUBLIC? TRUE)"
    (CL:FUNCTION NUMBER-WRAPPER-TO-FLOAT) NULL)
   (DEFINE-METHOD-OBJECT "(DEFMETHOD (NUMBER-WRAPPER-TO-FLOAT FLOAT) ((SELF LONG-INTEGER-WRAPPER)) :PUBLIC? TRUE)"
    (CL:FUNCTION NUMBER-WRAPPER-TO-FLOAT) NULL)
   (DEFINE-METHOD-OBJECT "(DEFMETHOD (NUMBER-WRAPPER-TO-FLOAT FLOAT) ((SELF FLOAT-WRAPPER)) :PUBLIC? TRUE)"
    (CL:FUNCTION NUMBER-WRAPPER-TO-FLOAT) NULL)
   (DEFINE-FUNCTION-OBJECT "STARTUP-LITERALS" "(DEFUN STARTUP-LITERALS () :PUBLIC? TRUE)"
    (CL:FUNCTION STARTUP-LITERALS) NULL)
   (CL:LET* ((FUNCTION (LOOKUP-FUNCTION SYM-LITERALS-STELLA-STARTUP-LITERALS)))
    (SET-DYNAMIC-SLOT-VALUE (%DYNAMIC-SLOTS FUNCTION) SYM-LITERALS-STELLA-METHOD-STARTUP-CLASSNAME
     (WRAP-STRING "_StartupLiterals") NULL-STRING-WRAPPER)))
  :VOID)

(CL:DEFUN STARTUP-LITERALS ()
  (CL:WHEN (CURRENT-STARTUP-TIME-PHASE? 0) (CL:SETQ ZERO-WRAPPER (NEW-INTEGER-WRAPPER 0))
   (CL:SETQ ONE-WRAPPER (NEW-INTEGER-WRAPPER 1)) (CL:SETQ FALSE-WRAPPER (NEW-BOOLEAN-WRAPPER CL:NIL))
   (CL:SETQ TRUE-WRAPPER (NEW-BOOLEAN-WRAPPER CL:T)) (CL:SETQ NULL-INTEGER-WRAPPER (NEW-INTEGER-WRAPPER NULL-INTEGER))
   (CL:SETQ NULL-LONG-INTEGER-WRAPPER (NEW-LONG-INTEGER-WRAPPER NULL-LONG-INTEGER))
   (CL:SETQ NULL-FLOAT-WRAPPER (NEW-FLOAT-WRAPPER NULL-FLOAT))
   (CL:SETQ NULL-STRING-WRAPPER (NEW-STRING-WRAPPER STELLA::NULL-STRING))
   (CL:SETQ NULL-MUTABLE-STRING-WRAPPER (NEW-MUTABLE-STRING-WRAPPER STELLA::NULL-STRING))
  ...
  (CL:LET* ((*MODULE* *STELLA-MODULE*) (*CONTEXT* *MODULE*)) (CL:DECLARE (CL:SPECIAL *MODULE* *CONTEXT*))
   (CL:WHEN (CURRENT-STARTUP-TIME-PHASE? 2) (HELP-STARTUP-LITERALS1)
    (CL:SETQ KWD-LITERALS-DELIMITER (INTERN-RIGID-SYMBOL-WRT-MODULE "DELIMITER" NULL 2))
