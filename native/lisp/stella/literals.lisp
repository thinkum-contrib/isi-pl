...
(CL:DECLAIM
  ...
  *CLASS-HIERARCHY-BOOTED?* NIL EOL NULL-CHARACTER NULL-FLOAT NULL-INTEGER FALSE
  TRUE))
...
(CL:DEFUN INLINE-WRAP-BOOLEAN (EXPRESSION)
  (CL:COND
   ((CL:EQ EXPRESSION SYM-LITERALS-STELLA-TRUE)
    (CL:RETURN-FROM INLINE-WRAP-BOOLEAN SYM-LITERALS-STELLA-TRUE-WRAPPER))
...
(CL:DEFMETHOD OBJECT-EQL? ((X INTEGER-WRAPPER) Y)
  (CL:RETURN-FROM OBJECT-EQL?
   (CL:AND (CL:NOT (CL:EQ Y NULL))
    (CL:EQ (PRIMARY-TYPE Y) SGT-LITERALS-STELLA-INTEGER-WRAPPER)
...
(CL:DEFMETHOD OBJECT-EQL? ((X FLOAT-WRAPPER) Y)
  (CL:RETURN-FROM OBJECT-EQL?
   (CL:AND (CL:NOT (CL:EQ Y NULL))
    (CL:EQ (PRIMARY-TYPE Y) SGT-LITERALS-STELLA-FLOAT-WRAPPER)
    (CL:= (%WRAPPER-VALUE X) (%WRAPPER-VALUE Y)))))
   ...
   (CL:COND
    ...
    ((SUBTYPE-OF-KEYWORD? TEST-VALUE-000)
     (CL:PROGN
      (CL:IF (USE-HARDCODED-SYMBOLS?)
       (CL:RETURN-FROM HELP-BQUOTIFY
        (CONS-LIST SYM-LITERALS-STELLA-GET-KWD (WRAP-INTEGER (%SYMBOL-ID TREE))))
       (CL:RETURN-FROM HELP-BQUOTIFY
    ...
    ((SUBTYPE-OF-SURROGATE? TEST-VALUE-000)
     (CL:PROGN
      (CL:IF (USE-HARDCODED-SYMBOLS?)
       (CL:RETURN-FROM HELP-BQUOTIFY
        (CONS-LIST SYM-LITERALS-STELLA-GET-SGT (WRAP-INTEGER (%SYMBOL-ID TREE))))
       (CL:RETURN-FROM HELP-BQUOTIFY
        (CONS-LIST SYM-LITERALS-STELLA-TYPED-SYS (REGISTER-SYMBOL TREE)
         SGT-LITERALS-STELLA-SYMBOL)))))
     ...
     (CL:LET* ((*PRINTREADABLY?* TRUE))
      ...
      (CL:WHEN (CL:NOT (SUPPRESS-WARNINGS?))
       ...
       (%%PRINT-STREAM (%NATIVE-STREAM STANDARD-ERROR) EOL
        " Illegal argument to quote: `" (DE-UGLIFY-PARSE-TREE TREE) "'." EOL)))
    ...
    (CL:PROGN
     (CL:IF (CL:EQ TREE NIL) (CL:RETURN-FROM PERMANENT-COPY TREE)
      (CL:RETURN-FROM PERMANENT-COPY
       (CONS (PERMANENT-COPY (%%VALUE TREE)) (PERMANENT-COPY (%%REST TREE)))))))
  ...
  (CL:LET*
   ((PERMANENTSYMBOL
     (LOOKUP-RIGID-SYMBOL-WRT-MODULE (%SYMBOL-NAME SYMBOL)
      (CL:IF (CL:NOT (CL:EQ (%HOME-CONTEXT SYMBOL) NULL)) (%HOME-CONTEXT SYMBOL)
       *MODULE*)
      SYMBOL-SYM)))
...
(CL:DEFUN CREATE-CHARACTER-TYPE-TABLE ()
  (CL:LET* ((TABLE (CL:MAKE-ARRAY 256)))
   ...
   (CL:SETF (CL:AREF TABLE (CL:THE CL:FIXNUM (CL:CHAR-CODE #\Tab)))
    KWD-LITERALS-WHITE-SPACE)
   (CL:SETF (CL:AREF TABLE (CL:THE CL:FIXNUM (CL:CHAR-CODE #\Linefeed)))
    KWD-LITERALS-WHITE-SPACE)
...
(CL:DEFUN DIGIT-CHARACTER? (CH)
  ...
  (CL:RETURN-FROM DIGIT-CHARACTER?
   (CL:EQ (CL:AREF *CHARACTER-TYPE-TABLE* (CL:THE CL:FIXNUM (CL:CHAR-CODE CH)))
    KWD-LITERALS-DIGIT)))
   ...
   (CL:LET*
    ...
    (CL:LOOP WHILE (CL:< INDEX-000 LENGTH-000) DO
     ...
     (CL:WHEN (CL:AND (CL:>= CODE CODEA) (CL:<= CODE CODEZ))
      (CL:RETURN-FROM ALL-UPPER-CASE-STRING? FALSE))))
   (CL:RETURN-FROM ALL-UPPER-CASE-STRING? TRUE)))
   ...
   (CL:LET*
    ...
    (CL:LOOP WHILE (CL:< INDEX-000 LENGTH-000) DO
     ...
     (CL:WHEN (CL:AND (CL:<= CODE CODEZ) (CL:>= CODE CODEA))
      (CL:RETURN-FROM ALL-LOWER-CASE-STRING? FALSE))))
   (CL:RETURN-FROM ALL-LOWER-CASE-STRING? TRUE)))
...
(CL:DECLAIM
 (CL:FTYPE (CL:FUNCTION () CL:SIMPLE-STRING) INITIALIZE-CHARACTER-UPCASE-TABLE))
  ...
  (CL:LET*
   ...
   (CL:RETURN-FROM INITIALIZE-CHARACTER-DOWNCASE-TABLE
    (CL:LET ((S BUFFER)) (CL:DECLARE (CL:TYPE CL:SIMPLE-STRING S))
     (CL:THE CL:SIMPLE-STRING S)))))
(CL:DECLAIM
 (CL:FTYPE (CL:FUNCTION () CL:SIMPLE-STRING) INITIALIZE-CHARACTER-DOWNCASE-TABLE))
...
(CL:DEFMETHOD NUMBER-WRAPPER-TO-FLOAT ((SELF INTEGER-WRAPPER))
  (CL:RETURN-FROM NUMBER-WRAPPER-TO-FLOAT (CL:* (%WRAPPER-VALUE SELF) 1.0d0)))
...
(CL:DEFUN HELP-STARTUP-LITERALS2 ()
  (CL:PROGN (CL:SETQ *LITERAL-TYPE-INFO-TABLE* (NEW-HASH-TABLE))
   ...
   (SET-LITERAL-TYPE-INFO SGT-LITERALS-STELLA-BOOLEAN KWD-LITERALS-NULL-WRAPPER
   ...
   (SET-LITERAL-TYPE-INFO SGT-LITERALS-STELLA-BOOLEAN KWD-LITERALS-WRAP-FUNCTION
    SYM-LITERALS-STELLA-WRAP-BOOLEAN)
   (SET-LITERAL-TYPE-INFO SGT-LITERALS-STELLA-INTEGER KWD-LITERALS-WRAP-FUNCTION
    SYM-LITERALS-STELLA-WRAP-INTEGER)
   (SET-LITERAL-TYPE-INFO SGT-LITERALS-STELLA-FLOAT KWD-LITERALS-WRAP-FUNCTION
    SYM-LITERALS-STELLA-WRAP-FLOAT)
   (SET-LITERAL-TYPE-INFO SGT-LITERALS-STELLA-STRING KWD-LITERALS-WRAP-FUNCTION
    SYM-LITERALS-STELLA-WRAP-STRING)
...
(CL:DEFUN HELP-STARTUP-LITERALS3 ()
  (CL:PROGN
   ...
   (DEFINE-FUNCTION-OBJECT "WRAP-INTEGER"
    "(DEFUN (WRAP-INTEGER INTEGER-WRAPPER) ((VALUE INTEGER)) :DOCUMENTATION \"Return a literal object whose value is the INTEGER 'value'.\" :PUBLIC? TRUE)"
...
Return NULL if `wrapper' is NULL.\" :PUBLIC? TRUE)" (CL:FUNCTION UNWRAP-INTEGER)
    NULL)
   (DEFINE-FUNCTION-OBJECT "WRAP-FLOAT"
    "(DEFUN (WRAP-FLOAT FLOAT-WRAPPER) ((VALUE FLOAT)) :DOCUMENTATION \"Return a literal object whose value is the FLOAT 'value'.\" :PUBLIC? TRUE)"
...
Return NULL if `wrapper' is NULL.\" :PUBLIC? TRUE)" (CL:FUNCTION UNWRAP-FLOAT)
    NULL)
   (DEFINE-FUNCTION-OBJECT "WRAP-STRING"
    "(DEFUN (WRAP-STRING STRING-WRAPPER) ((VALUE STRING)) :DOCUMENTATION \"Return a literal object whose value is the STRING 'value'.\" :PUBLIC? TRUE)"
...
Return NULL if `wrapper' is NULL.\" :PUBLIC? TRUE)" (CL:FUNCTION UNWRAP-STRING)
    NULL)
   (DEFINE-FUNCTION-OBJECT "WRAP-MUTABLE-STRING"
    "(DEFUN (WRAP-MUTABLE-STRING MUTABLE-STRING-WRAPPER) ((VALUE MUTABLE-STRING)) :DOCUMENTATION \"Return a literal object whose value is the MUTABLE-STRING 'value'.\" :PUBLIC? TRUE)"
...
Return NULL if `wrapper' is NULL.\" :PUBLIC? TRUE)"
   ...
   (DEFINE-FUNCTION-OBJECT "WRAP-CHARACTER"
    "(DEFUN (WRAP-CHARACTER CHARACTER-WRAPPER) ((VALUE CHARACTER)) :DOCUMENTATION \"Return a literal object whose value is the CHARACTER 'value'.\" :PUBLIC? TRUE)"
...
Return NULL if `wrapper' is NULL.\" :PUBLIC? TRUE)"
   ...
   (DEFINE-FUNCTION-OBJECT "WRAP-FUNCTION-CODE"
    "(DEFUN (WRAP-FUNCTION-CODE FUNCTION-CODE-WRAPPER) ((VALUE FUNCTION-CODE)) :DOCUMENTATION \"Return a literal object whose value is the FUNCTION-CODE 'value'.\" :PUBLIC? TRUE)"
...
Return NULL if `wrapper' is NULL.\" :PUBLIC? TRUE)"
   ...
   (DEFINE-FUNCTION-OBJECT "WRAP-METHOD-CODE"
    "(DEFUN (WRAP-METHOD-CODE METHOD-CODE-WRAPPER) ((VALUE METHOD-CODE)) :DOCUMENTATION \"Return a literal object whose value is the METHOD-CODE 'value'.\" :PUBLIC? TRUE)"
...
Return NULL if `wrapper' is NULL.\" :PUBLIC? TRUE)"
   ...
   (DEFINE-FUNCTION-OBJECT "WRAP-BOOLEAN"
    "(DEFUN (WRAP-BOOLEAN BOOLEAN-WRAPPER) ((VALUE BOOLEAN)) :DOCUMENTATION \"Return a literal object whose value is the BOOLEAN 'value'.\" :PUBLIC? TRUE :GLOBALLY-INLINE? TRUE (RETURN (CHOOSE VALUE TRUE-WRAPPER FALSE-WRAPPER)))"
...
Map NULL onto FALSE.\" :PUBLIC? TRUE :GLOBALLY-INLINE? TRUE (RETURN (EQ? WRAPPER TRUE-WRAPPER)))"
   ...
   (DEFINE-FUNCTION-OBJECT "HELP-BQUOTIFY"
    "(DEFUN (HELP-BQUOTIFY OBJECT) ((TREE OBJECT)))" (CL:FUNCTION HELP-BQUOTIFY)
    NULL)
   (DEFINE-FUNCTION-OBJECT "BQUOTIFY" "(DEFUN (BQUOTIFY OBJECT) ((TREE OBJECT)))"
    (CL:FUNCTION BQUOTIFY) NULL)
...
In Lisp and C++ this is a no-op.\" :PUBLIC? TRUE :GLOBALLY-INLINE? TRUE (RETURN (VERBATIM :COMMON-LISP S :CPP \"s\" :JAVA \"s.toString()\")))"
    ...
    (DEFINE-FUNCTION-OBJECT "STARTUP-LITERALS"
     "(DEFUN STARTUP-LITERALS () :PUBLIC? TRUE)" (CL:FUNCTION STARTUP-LITERALS)
     NULL)
    (CL:LET* ((FUNCTION (LOOKUP-FUNCTION SYM-LITERALS-STELLA-STARTUP-LITERALS)))
     (SET-DYNAMIC-SLOT-VALUE (%DYNAMIC-SLOTS FUNCTION)
      ...
      (WRAP-STRING "_Startup-Literals") NULL-STRING-WRAPPER)))
