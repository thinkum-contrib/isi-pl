...
(CL:DECLAIM
 (CL:SPECIAL *STARTUP-TIME-PHASE* *MODULE* *PRINTREADABLY?* VALUE-OF-SEPARATOR
...
(CL:DECLAIM
 (CL:FTYPE (CL:FUNCTION (CL:T) CL:SIMPLE-STRING) LOGIC-OBJECT-DISPLAY-TYPE))
(CL:DEFUN LOGIC-OBJECT-DISPLAY-TYPE (OBJ)
  (CL:COND
   ((SUBTYPE-OF? (SAFE-PRIMARY-TYPE OBJ) SGT-HTML-PPRINT-LOGIC-DESCRIPTION)
    (CL:PROGN "relation"))
   (CL:T "object")))
...
(CL:DEFUN STARTUP-HTML-PPRINT ()
  (CL:LET*
   ...
   (CL:WHEN (CURRENT-STARTUP-TIME-PHASE? 7)
    ...
    (CL:LET*
     ((FUNCTION
       (LOOKUP-FUNCTION SYM-HTML-PPRINT-ONTOSAURUS-STARTUP-HTML-PPRINT)))
