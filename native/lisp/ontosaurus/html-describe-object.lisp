...
(CL:DECLAIM
 (CL:SPECIAL *STARTUP-TIME-PHASE* *MODULE-BACKGROUND-COLOR* *STANDARD-BACKGROUND-COLOR* *ERROR-BACKGROUND-COLOR* FALSE-WRAPPER *POWERLOOM-LOCK* *CONTEXT*
  ASSERTION-INFERENCE *REVERSEPOLARITY?* TRUE-WRAPPER NULL-INTEGER NIL *MODULE* EOL))
...
(CL:DEFUN LOOKUP-TERM (TERM CAPITALIZED? PLURAL?)
  (CL:COND
   ((CL:AND PLURAL? CAPITALIZED?)
    (CL:COND ((CL:EQ TERM KWD-HTML-DESCRIBE-OBJECT-CONCEPT) "Concepts") ((CL:EQ TERM KWD-HTML-DESCRIBE-OBJECT-RELATION) "Relations")
     ((CL:EQ TERM KWD-HTML-DESCRIBE-OBJECT-CONTEXT) "Modules") ((CL:EQ TERM KWD-HTML-DESCRIBE-OBJECT-INSTANCE) "Instances")
   ...
   (CAPITALIZED?
    (CL:COND ((CL:EQ TERM KWD-HTML-DESCRIBE-OBJECT-CONCEPT) "Concept") ((CL:EQ TERM KWD-HTML-DESCRIBE-OBJECT-RELATION) "Relation")
     ((CL:EQ TERM KWD-HTML-DESCRIBE-OBJECT-CONTEXT) "Module") ((CL:EQ TERM KWD-HTML-DESCRIBE-OBJECT-INSTANCE) "Instance")
     ((CL:EQ TERM KWD-HTML-DESCRIBE-OBJECT-QUERY) "Query") ((CL:EQ TERM KWD-HTML-DESCRIBE-OBJECT-OBJECT) "Object") (CL:T (STRING-CAPITALIZE (%SYMBOL-NAME TERM)))))
   (PLURAL?
    (CL:COND ((CL:EQ TERM KWD-HTML-DESCRIBE-OBJECT-CONCEPT) "concepts") ((CL:EQ TERM KWD-HTML-DESCRIBE-OBJECT-RELATION) "relations")
     ((CL:EQ TERM KWD-HTML-DESCRIBE-OBJECT-CONTEXT) "modules") ((CL:EQ TERM KWD-HTML-DESCRIBE-OBJECT-INSTANCE) "instances")
     ((CL:EQ TERM KWD-HTML-DESCRIBE-OBJECT-QUERY) "queries") ((CL:EQ TERM KWD-HTML-DESCRIBE-OBJECT-OBJECT) "objects")
   ...
   (CL:T
    (CL:COND ((CL:EQ TERM KWD-HTML-DESCRIBE-OBJECT-CONCEPT) "concept") ((CL:EQ TERM KWD-HTML-DESCRIBE-OBJECT-RELATION) "relation")
     ((CL:EQ TERM KWD-HTML-DESCRIBE-OBJECT-CONTEXT) "module") ((CL:EQ TERM KWD-HTML-DESCRIBE-OBJECT-INSTANCE) "instance")
     ((CL:EQ TERM KWD-HTML-DESCRIBE-OBJECT-QUERY) "query") ((CL:EQ TERM KWD-HTML-DESCRIBE-OBJECT-OBJECT) "object") (CL:T (STRING-DOWNCASE (%SYMBOL-NAME TERM)))))))
...
(CL:DEFUN SAFE-OBJECT-NAME-STRING (INSTANCE)
  (CL:LET* ((SURROGATE (%SURROGATE-VALUE-INVERSE INSTANCE))) (CL:IF (CL:NOT (CL:EQ SURROGATE NULL)) (%SYMBOL-NAME SURROGATE) STELLA::NULL-STRING)))

;;; (DEFUN HTML-DESCRIBE-LOCATION ...)

(CL:DEFUN HTML-DESCRIBE-LOCATION (SELF STREAM)
  (CL:PROGN (%%PRINT-STREAM STREAM "<PRE>") (%%PRINT-STREAM STREAM (LOOKUP-TERM KWD-HTML-DESCRIBE-OBJECT-CONTEXT CL:T CL:NIL) ": ")
   ...
   (CL:WHEN (CL:AND (CL:NOT (CL:EQ SELF NULL)) (CL:NOT (CL:EQ (OBJECT-NAME SELF) NULL)) (CL:NOT (CL:EQ (HOME-MODULE (OBJECT-NAME SELF)) (HOME-MODULE SELF))))
    (%%PRINT-STREAM STREAM "Namespace: ") (HTML-WRITE-HREF STREAM "show" "context" (HOME-MODULE (OBJECT-NAME SELF))) (%%PRINT-STREAM STREAM EOL))
...
(CL:DEFUN HTML-DESCRIBE-CONTEXT-VIEW (SELF STREAM)
  (CL:LET* ((HOMEC (HOME-MODULE SELF)) (OBJECTNAME (GET-HTML-OBJECT-HANDLE SELF)) (CONTEXTLIST (ALL-SUBCONTEXTS HOMEC KWD-HTML-DESCRIBE-OBJECT-PREORDER)))
   (CL:DECLARE (CL:TYPE CL:SIMPLE-STRING OBJECTNAME))
     ...
     (CL:PROGN (%%PRINT-STREAM STREAM "<SELECT NAME='context' onchange='jumpLink(this);'>") (%%PRINT-STREAM STREAM EOL)
      ...
      (CL:LET* ((C NULL) (ITER-000 CONTEXTLIST))
       (CL:LOOP WHILE (NEXT? ITER-000) DO (CL:SETQ C (%VALUE ITER-000))
        (CL:WHEN (ISA? C SGT-HTML-DESCRIBE-OBJECT-STELLA-MODULE) (HTML-WRITE-CONTEXT-VIEW-OPTION STREAM OBJECTNAME C))))
   ...
   (CL:WHEN (CL:NOT (EMPTY? IMAGES)) (%%PRINT-STREAM STREAM EOL)
    (CL:PROGN (%%PRINT-STREAM STREAM "<P>")
     (CL:LET* ((I NULL) (ITER-000 IMAGES))
      (CL:LOOP WHILE (NEXT? ITER-000) DO (CL:SETQ I (%VALUE ITER-000)) (CL:IF FIRST? (HTML-LINE-BREAK STREAM) (%%PRINT-STREAM STREAM " "))
       (HTML-EMIT-IMAGE STREAM (%WRAPPER-VALUE I) "" NULL-INTEGER NULL-INTEGER "BOTTOM" 0)))
     ...
     (CL:PROGN (%%PRINT-STREAM STREAM "<DL>")
      (CL:LET* ((DOC NULL) (ITER-000 DOCSTRINGS))
       (CL:LOOP WHILE (NEXT? ITER-000) DO (CL:SETQ DOC (%VALUE ITER-000))
        (CL:WHEN (CL:AND (CL:NOT (CL:EQ DOC NULL)) (CL:NOT (CL:EQ (%WRAPPER-VALUE DOC) STELLA::NULL-STRING)))
         (CL:PROGN (%%PRINT-STREAM STREAM "<DT>") (HTML-DISPLAY-STRING-IN-PARAGRAPHS (%WRAPPER-VALUE DOC) STREAM) (%%PRINT-STREAM STREAM "</DT>")))))
...
(CL:DEFUN HTML-DISPLAY-SYNONYMS (SELF STREAM)
  (CL:LET* ((SYNONYMS (GET-SYNONYMS SELF)))
   (CL:WHEN (CL:NOT (CL:EQ SYNONYMS NIL))
    (CL:PROGN (%%PRINT-STREAM STREAM "<P>") (CL:PROGN (%%PRINT-STREAM STREAM "<B>") (%%PRINT-STREAM STREAM "Synonyms: ") (%%PRINT-STREAM STREAM "</B>"))
     ...
     (CL:LET* ((SYN NULL) (ITER-000 (%%REST SYNONYMS)))
      (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-000 NIL)) DO (CL:SETQ SYN (%%VALUE ITER-000)) (%%PRINT-STREAM STREAM ", ")
       (WRITE-HTML-ESCAPING-URL-SPECIAL-CHARACTERS STREAM (OBJECT-STRING-NAME SYN)) (CL:SETQ ITER-000 (%%REST ITER-000))))
...
(CL:DEFUN HTML-DESCRIBE-EQUIVALENTS (TITLE HEAD RELATION STREAM RULE?)
  ...
  (CL:LET* ((EQUIVALENTS (COPY-CONS-LIST (ALL-EQUIVALENT-RELATIONS RELATION CL:T))))
   (CL:WHEN (CL:NOT (CL:EQ (%%REST EQUIVALENTS) NIL)) (CL:SETQ EQUIVALENTS (SORT (REMOVE EQUIVALENTS RELATION) (CL:FUNCTION OBJECT-NAME-LESS-THAN?)))
    ...
    (CL:LET* ((C NULL) (ITER-000 (%%REST EQUIVALENTS)))
     (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-000 NIL)) DO (CL:SETQ C (%%VALUE ITER-000)) (%%PRINT-STREAM STREAM ", ") (HTML-WRITE-HREF STREAM "show" "concept" C)
...
(CL:DEFUN HTML-DESCRIBE-ONE-SUB-LEVEL (OBJECT DEPTH CUTOFF STREAM)
  ...
  (CL:LET* ((DIRECTSUBS (CONSIFY (PLI::GET-DIRECT-SUBRELATIONS OBJECT NULL NULL)))) (CL:WHEN (CL:EQ DIRECTSUBS NIL) (CL:RETURN-FROM HTML-DESCRIBE-ONE-SUB-LEVEL))
    ...
    (CL:LET* ((SUB NULL) (ITER-000 DIRECTSUBS))
     (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-000 NIL)) DO (CL:SETQ SUB (%%VALUE ITER-000))
      (CL:PROGN (%%PRINT-STREAM STREAM "<DT STYLE='margin-top: 0'>") (HTML-WRITE-HREF STREAM "show" "concept" SUB)
       (CL:WHEN (CL:AND (CL:>= DEPTH CUTOFF) (CL:NOT (EMPTY? (PLI::GET-DIRECT-SUBRELATIONS SUB NULL NULL)))) (%%PRINT-STREAM STREAM "    +..."))
       (%%PRINT-STREAM STREAM "</DT>" EOL))
      (CL:WHEN (CL:< DEPTH CUTOFF)
       (CL:PROGN (%%PRINT-STREAM STREAM "<DD>") (HTML-DESCRIBE-ONE-SUB-LEVEL SUB (CL:1+ DEPTH) CUTOFF STREAM) (%%PRINT-STREAM STREAM "</DD>" EOL)))
      (CL:SETQ ITER-000 (%%REST ITER-000))))
...
(CL:DEFUN HTML-DESCRIBE-SUBS (TITLE HEAD RELATION STREAM RULE?)
  ...
  #+MCL
  (CL:CHECK-TYPE HEAD CL:SIMPLE-STRING)
  (CL:LET* ((HEURISTICDEPTH 4) (SUBLENGTH (LENGTH (PLI::GET-DIRECT-SUBRELATIONS RELATION NULL NULL)))) (CL:DECLARE (CL:TYPE CL:FIXNUM HEURISTICDEPTH SUBLENGTH))
   (CL:WHEN (CL:> SUBLENGTH 30) (CL:SETQ HEURISTICDEPTH (CL:1- HEURISTICDEPTH))) (HTML-WRITE-HEADER-WITH-TABLE STREAM TITLE HEAD)
   (CL:IF (CL:= SUBLENGTH 0) (CL:PROGN (%%PRINT-STREAM STREAM "<I>") (%%PRINT-STREAM STREAM "None") (%%PRINT-STREAM STREAM "</I>" EOL))
  ...
  (CL:LET* ((ALREADYOUTPUT? CL:NIL)) (CL:WHEN (CL:EQ DIRECTSUPERS NIL) (CL:RETURN-FROM HTML-DESCRIBE-ONE-SUPER-LEVEL))
   ...
   (CL:PROGN (%%PRINT-STREAM STREAM "<DL STYLE=' margin-top: 0; margin-bottom:0'>")
    (CL:LET* ((SUPER NULL) (ITER-000 DIRECTSUPERS))
     (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-000 NIL)) DO (CL:SETQ SUPER (%%VALUE ITER-000)) (CL:SETQ ALREADYOUTPUT? (CL:NOT (CL:EQ (LOOKUP ALREADYOUTPUT SUPER) NULL)))
      ...
      (CL:WHEN (CL:NOT ALREADYOUTPUT?) (INSERT-AT ALREADYOUTPUT SUPER TRUE-WRAPPER)
       (CL:PROGN (%%PRINT-STREAM STREAM "<DD>") (HTML-DESCRIBE-ONE-SUPER-LEVEL (CONSIFY (PLI::GET-DIRECT-SUPERRELATIONS SUPER NULL NULL)) ALREADYOUTPUT STREAM)
...
(CL:DEFUN HTML-DESCRIBE-SUPERS (TITLE HEAD RELATION STREAM RULE?)
  ...
  #+MCL
  (CL:CHECK-TYPE HEAD CL:SIMPLE-STRING)
  (CL:LET* ((ALREADYOUTPUT (NEW-HASH-TABLE)) (DIRECTSUPERS (CONSIFY (PLI::GET-DIRECT-SUPERRELATIONS RELATION NULL NULL))))
   (HTML-WRITE-HEADER-WITH-TABLE STREAM TITLE HEAD)
   (CL:IF (CL:EQ DIRECTSUPERS NIL) (CL:PROGN (%%PRINT-STREAM STREAM "<I>") (%%PRINT-STREAM STREAM "None") (%%PRINT-STREAM STREAM "</I>" EOL))
...
(CL:DEFUN HTML-DESCRIBE-TYPES (TITLE HEAD RELATION STREAM RULE?)
  ...
  #+MCL
  (CL:CHECK-TYPE HEAD CL:SIMPLE-STRING)
  (CL:LET* ((ALREADYOUTPUT (NEW-HASH-TABLE)) (TYPES (CONSIFY (PLI::GET-DIRECT-TYPES RELATION NULL NULL)))) (HTML-WRITE-HEADER-WITH-TABLE STREAM TITLE HEAD)
   (CL:IF (CL:EQ TYPES NIL) (CL:PROGN (%%PRINT-STREAM STREAM "<I>") (%%PRINT-STREAM STREAM "None") (%%PRINT-STREAM STREAM "</I>" EOL))
...
(CL:DEFUN HTML-DESCRIBE-ONE-PARENT-WITH-SIBLINGS (PARENT CHILD STREAM)
  (CL:LET* ((DIRECTSUBS (CONSIFY (PLI::GET-DIRECT-SUBRELATIONS PARENT NULL NULL)))) (CL:SETQ DIRECTSUBS (SORT DIRECTSUBS (CL:FUNCTION OBJECT-NAME-LESS-THAN?)))
   (CL:PROGN (%%PRINT-STREAM STREAM "<DT>") (%%PRINT-STREAM STREAM "Common parent: ") (HTML-WRITE-HREF STREAM "show" "concept" PARENT)
    (%%PRINT-STREAM STREAM "</DT>" EOL))
   (CL:LET* ((SUB NULL) (ITER-000 DIRECTSUBS))
    (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-000 NIL)) DO (CL:SETQ SUB (%%VALUE ITER-000))
     (CL:WHEN (CL:NOT (CL:EQ SUB CHILD)) (CL:PROGN (%%PRINT-STREAM STREAM "<DD>") (HTML-WRITE-HREF STREAM "show" "concept" SUB) (%%PRINT-STREAM STREAM "</DD>" EOL)))
     (CL:SETQ ITER-000 (%%REST ITER-000))))
   NULL))
...
(CL:DEFUN HAS-CHILD-OTHER-THAN? (PARENT CHILD)
  (CL:LET* ((C NULL) (ITER-000 (PLI::GET-DIRECT-SUBRELATIONS PARENT NULL NULL)))
   (CL:LOOP WHILE (NEXT? ITER-000) DO (CL:SETQ C (%VALUE ITER-000)) (CL:WHEN (CL:NOT (CL:EQ C CHILD)) (CL:RETURN-FROM HAS-CHILD-OTHER-THAN? CL:T))))
  CL:NIL)
     ...
     (CL:WHEN (HAS-CHILD-OTHER-THAN? P RELATION)
      (CL:IF (CL:EQ COLLECT-000 NULL)
       (CL:PROGN (CL:SETQ COLLECT-000 (CONS P NIL))
        (CL:IF (CL:EQ PARENTSOFSIBS NIL) (CL:SETQ PARENTSOFSIBS COLLECT-000) (ADD-CONS-TO-END-OF-CONS-LIST PARENTSOFSIBS COLLECT-000)))
       (CL:PROGN (CL:SETF (%%REST COLLECT-000) (CONS P NIL)) (CL:SETQ COLLECT-000 (%%REST COLLECT-000)))))))
   (CL:SETQ PARENTSOFSIBS (SORT PARENTSOFSIBS (CL:FUNCTION OBJECT-NAME-LESS-THAN?))) (HTML-WRITE-HEADER-WITH-TABLE STREAM TITLE HEAD)
   (CL:IF (CL:EQ PARENTSOFSIBS NIL) (CL:PROGN (%%PRINT-STREAM STREAM "<I>") (%%PRINT-STREAM STREAM "None") (%%PRINT-STREAM STREAM "</I>" EOL))
    (CL:PROGN (%%PRINT-STREAM STREAM "<DL>")
     (CL:LET* ((P NULL) (ITER-001 PARENTSOFSIBS))
      (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-001 NIL)) DO (CL:SETQ P (%%VALUE ITER-001)) (HTML-DESCRIBE-ONE-PARENT-WITH-SIBLINGS P RELATION STREAM)
...
(CL:DEFUN HTML-DESCRIBE-RULES (TITLE HEAD RELATION STREAM RULE?)
  ...
  #+MCL
  (CL:CHECK-TYPE HEAD CL:SIMPLE-STRING)
  (CL:LET* ((RULES (CONSIFY (PLI::GET-RULES RELATION NULL NULL))) (RULE-WRITTEN? CL:NIL)) (HTML-WRITE-HEADER-WITH-TABLE STREAM TITLE HEAD)
    ...
    (CL:LET* ((RULE NULL) (ITER-000 RULES))
     (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-000 NIL)) DO (CL:SETQ RULE (%%VALUE ITER-000))
      (CL:WHEN (CL:AND (CL:NOT (DELETED? RULE)) (CL:IF *REVERSEPOLARITY?* (FALSE? RULE) (CL:OR (TRUE? RULE) (FUNCTION-WITH-DEFINED-VALUE? RULE))))
       (CL:WHEN (CL:NOT (SIMPLE-SUBRELATION-PROPOSITION? RULE)) (PPRINT-OBJECT RULE STREAM) (%%PRINT-STREAM STREAM EOL EOL) (CL:SETQ RULE-WRITTEN? CL:T)))
      (CL:SETQ ITER-000 (%%REST ITER-000))))
    (%%PRINT-STREAM STREAM "</PRE>" EOL))
   (CL:WHEN (CL:NOT RULE-WRITTEN?) (CL:PROGN (%%PRINT-STREAM STREAM "<I>") (%%PRINT-STREAM STREAM "None") (%%PRINT-STREAM STREAM "</I>" EOL)))
   (CL:WHEN RULE? (%%PRINT-STREAM STREAM "<HR SIZE=2>" EOL)) NULL))
...
(CL:DEFUN HTML-DESCRIBE-FACTS (TITLE HEAD RELATION STREAM FILTER-RULES? RULE?)
  ...
  #+MCL
  (CL:CHECK-TYPE HEAD CL:SIMPLE-STRING)
  (CL:LET* ((FACTS (CONSIFY (PLI::GET-PROPOSITIONS-OF RELATION NULL NULL))) (FACT-WRITTEN? CL:NIL)) (HTML-WRITE-HEADER-WITH-TABLE STREAM TITLE HEAD)
   (CL:PROGN (%%PRINT-STREAM STREAM "<PRE>") (CL:SETQ FACTS (SORT FACTS (CL:FUNCTION PROPOSITION-LESS-THAN?)))
    (CL:LET* ((FACT NULL) (ITER-000 FACTS))
     (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-000 NIL)) DO (CL:SETQ FACT (%%VALUE ITER-000))
      (CL:WHEN (CL:AND (CL:NOT (DELETED? FACT)) (CL:IF *REVERSEPOLARITY?* (FALSE? FACT) (CL:OR (TRUE? FACT) (FUNCTION-WITH-DEFINED-VALUE? FACT))))
       (CL:WHEN (CL:NOT (CLASS? (%OPERATOR FACT)))
        (CL:WHEN (CL:NOT (CL:EQ (%KIND FACT) KWD-HTML-DESCRIBE-OBJECT-EQUIVALENT))
         (CL:WHEN (CL:NOT (CL:AND FILTER-RULES? (CL:EQ (%KIND FACT) KWD-HTML-DESCRIBE-OBJECT-IMPLIES))) (CL:SETQ FACT-WRITTEN? CL:T) (PPRINT-OBJECT FACT STREAM)
          (%%PRINT-STREAM STREAM EOL EOL)))))
      (CL:SETQ ITER-000 (%%REST ITER-000))))
    (%%PRINT-STREAM STREAM "</PRE>" EOL))
   (CL:WHEN (CL:NOT FACT-WRITTEN?) (CL:PROGN (%%PRINT-STREAM STREAM "<I>") (%%PRINT-STREAM STREAM "None") (%%PRINT-STREAM STREAM "</I>" EOL)))
   (CL:WHEN RULE? (%%PRINT-STREAM STREAM "<HR SIZE=2>" EOL)) NULL))
...
(CL:DEFUN HTML-DESCRIBE-INSTANCES (TITLE HEAD RELATION STREAM RULE?)
  ...
  (CL:LET*
   ((INSTANCES (CONSIFY (PLI::GET-CONCEPT-INSTANCES RELATION NULL NULL)))
    (ASSERTEDINSTANCES (LEVELLIZED-ALL-CLASS-INSTANCES ASSERTION-INFERENCE (%SURROGATE-VALUE-INVERSE RELATION)))
    (DIRECTINSTANCES (CONSIFY (PLI::GET-DIRECT-CONCEPT-INSTANCES RELATION NULL NULL))) (N-INSTANCES (LENGTH INSTANCES)))
   (CL:DECLARE (CL:TYPE CL:FIXNUM N-INSTANCES)) (HTML-WRITE-HEADER-WITH-TABLE STREAM TITLE HEAD)
   (CL:IF (CL:EQ INSTANCES NIL) (CL:PROGN (%%PRINT-STREAM STREAM "<I>") (%%PRINT-STREAM STREAM "None") (%%PRINT-STREAM STREAM "</I>" EOL))
    (CL:PROGN (%%PRINT-STREAM STREAM N-INSTANCES (CL:IF (CL:= N-INSTANCES 1) " instance; " " instances; ") (LENGTH DIRECTINSTANCES) " direct (")
      ...
      (CL:LET* ((INSTANCE NULL) (ITER-000 INSTANCES))
       (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-000 NIL)) DO (CL:SETQ INSTANCE (%%VALUE ITER-000))
        (CL:PROGN (%%PRINT-STREAM STREAM "<DT>")
         (HTML-EMIT-IMAGE STREAM (CL:IF (MEMBER? DIRECTINSTANCES INSTANCE) "icons/small-circ-filled.gif" "icons/small-circ-open.gif")
...
(CL:DEFUN HTML-DESCRIBE-TUPLES (TITLE HEAD RELATION STREAM RULE?)
  ...
  #+MCL
  (CL:CHECK-TYPE HEAD CL:SIMPLE-STRING)
  (CL:LET* ((TUPLES (CONSIFY (PLI::GET-RELATION-EXTENSION RELATION NULL NULL)))) (HTML-WRITE-HEADER-WITH-TABLE STREAM TITLE HEAD)
   (CL:IF (CL:EQ TUPLES NIL) (CL:PROGN (%%PRINT-STREAM STREAM "<I>") (%%PRINT-STREAM STREAM "None") (%%PRINT-STREAM STREAM "</I>" EOL))
    (CL:PROGN (%%PRINT-STREAM STREAM "<PRE>") (CL:SETQ TUPLES (SORT TUPLES (CL:FUNCTION PROPOSITION-LESS-THAN?)))
     (CL:LET* ((TUPLE NULL) (ITER-000 TUPLES))
      (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-000 NIL)) DO (CL:SETQ TUPLE (%%VALUE ITER-000)) (PPRINT-OBJECT TUPLE STREAM) (%%PRINT-STREAM STREAM EOL EOL)
       (CL:SETQ ITER-000 (%%REST ITER-000))))
     (%%PRINT-STREAM STREAM "</PRE>" EOL)))
   (CL:WHEN RULE? (%%PRINT-STREAM STREAM "<HR SIZE=2>" EOL)) NULL))
...
(CL:DEFUN HTML-DESCRIBE-NAMED-DESCRIPTION (CONCEPT STREAM)
  ...
  (CL:LET*
   ((NAMESTRING (OBJECT-NAME-STRING CONCEPT))
    (DESCRIPTIONTERM (LOOKUP-TERM (CL:IF (CLASS? CONCEPT) KWD-HTML-DESCRIBE-OBJECT-CONCEPT KWD-HTML-DESCRIBE-OBJECT-RELATION) CL:NIL CL:T)))
   (CL:DECLARE (CL:TYPE CL:SIMPLE-STRING NAMESTRING DESCRIPTIONTERM))
   (WITH-PROCESS-LOCK *POWERLOOM-LOCK*
    (CL:LET* ((*CONTEXT* (GET-QUERY-CONTEXT)) (*MODULE* (%BASE-MODULE *CONTEXT*))) (CL:DECLARE (CL:SPECIAL *CONTEXT* *MODULE*)) (ELABORATE-INSTANCE CONCEPT)))
   (HTML-DESCRIBE-LOCATION CONCEPT STREAM) (HTML-DESCRIBE-CONTEXT-VIEW CONCEPT STREAM) (HTML-DISPLAY-SYNONYMS CONCEPT STREAM) (HTML-DISPLAY-IMAGES CONCEPT STREAM)
   (HTML-DISPLAY-DOCUMENTATION CONCEPT STREAM) (HTML-DESCRIBE-EQUIVALENTS (STRING-CONCATENATE "Equivalent " DESCRIPTIONTERM) NAMESTRING CONCEPT STREAM CL:T)
   (CL:WHEN (VIZ-SERVER-AVAILABLE?)
    (HTML-WRITE-HREF-IN-DETAIL STREAM "Graph" "graph" "relation" (NAME *MODULE*) (VISIBLE-NAME (OBJECT-NAME CONCEPT) CL:T) (CONCATENATE "Graph " NAMESTRING) CL:NIL)
    (%%PRINT-STREAM STREAM "<HR SIZE=2>" EOL))
   (HTML-DESCRIBE-TYPES "Types" NAMESTRING CONCEPT STREAM CL:T) (HTML-DESCRIBE-SUBS (STRING-CONCATENATE "Sub" DESCRIPTIONTERM) NAMESTRING CONCEPT STREAM CL:T)
   (HTML-DESCRIBE-SUPERS (STRING-CONCATENATE "Super" DESCRIPTIONTERM) NAMESTRING CONCEPT STREAM CL:T) (HTML-DESCRIBE-SIBLINGS "Siblings" NAMESTRING CONCEPT STREAM CL:T)
   (HTML-DESCRIBE-FACTS "Facts" NAMESTRING CONCEPT STREAM CL:T CL:T) (HTML-DESCRIBE-RULES "Rules" NAMESTRING CONCEPT STREAM CL:T)
...
(CL:DEFUN HTML-DESCRIBE-INSTANCE (INSTANCE STREAM)
  ...
  (CL:LET* ((NAMESTRING (GET-HTML-OBJECT-HANDLE INSTANCE))) (CL:DECLARE (CL:TYPE CL:SIMPLE-STRING NAMESTRING))
   (WITH-PROCESS-LOCK *POWERLOOM-LOCK*
    (CL:LET* ((*CONTEXT* (GET-QUERY-CONTEXT)) (*MODULE* (%BASE-MODULE *CONTEXT*))) (CL:DECLARE (CL:SPECIAL *CONTEXT* *MODULE*)) (ELABORATE-INSTANCE INSTANCE)))
   (HTML-DESCRIBE-LOCATION INSTANCE STREAM) (HTML-DESCRIBE-CONTEXT-VIEW INSTANCE STREAM) (HTML-DISPLAY-SYNONYMS INSTANCE STREAM) (HTML-DISPLAY-IMAGES INSTANCE STREAM)
   (HTML-DISPLAY-DOCUMENTATION INSTANCE STREAM) (HTML-DESCRIBE-TYPES "Types" NAMESTRING INSTANCE STREAM CL:T)
   (CL:LET* ((*CONTEXT* (GET-QUERY-CONTEXT)) (*MODULE* (%BASE-MODULE *CONTEXT*))) (CL:DECLARE (CL:SPECIAL *CONTEXT* *MODULE*))
    (HTML-DESCRIBE-FACTS "Facts" NAMESTRING INSTANCE STREAM CL:NIL CL:T))
   NULL))
...
(CL:DEFUN CHILD-MODULES (MODULE)
  (CL:LET* ((DIRECTSUBMODULES NIL))
   (CL:LET* ((CHILD NULL) (ITER-000 (%THE-CONS-LIST (%CHILD-CONTEXTS MODULE))) (COLLECT-000 NULL))
     ...
     (CL:WHEN (ISA? CHILD SGT-HTML-DESCRIBE-OBJECT-STELLA-MODULE)
      (CL:IF (CL:EQ COLLECT-000 NULL)
       (CL:PROGN (CL:SETQ COLLECT-000 (CONS CHILD NIL))
        (CL:IF (CL:EQ DIRECTSUBMODULES NIL) (CL:SETQ DIRECTSUBMODULES COLLECT-000) (ADD-CONS-TO-END-OF-CONS-LIST DIRECTSUBMODULES COLLECT-000)))
...
(CL:DEFUN HTML-DESCRIBE-ONE-MODULE-SUB-LEVEL (MODULE DEPTH CUTOFF STREAM)
  ...
  #+MCL
  (CL:CHECK-TYPE CUTOFF CL:FIXNUM)
  (CL:LET* ((DIRECTSUBMODULES (CHILD-MODULES MODULE))) (CL:WHEN (CL:EQ DIRECTSUBMODULES NIL) (CL:RETURN-FROM HTML-DESCRIBE-ONE-MODULE-SUB-LEVEL))
    ...
    (CL:LET* ((SUB NULL) (ITER-000 DIRECTSUBMODULES))
     (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-000 NIL)) DO (CL:SETQ SUB (%%VALUE ITER-000))
      (CL:PROGN (%%PRINT-STREAM STREAM "<DT STYLE='margin-top: 0'>") (HTML-WRITE-HREF STREAM "show" "context" SUB)
       (CL:WHEN (CL:AND (CL:>= DEPTH CUTOFF) (CL:NOT (CL:EQ (CHILD-MODULES SUB) NIL))) (%%PRINT-STREAM STREAM "    +...")) (%%PRINT-STREAM STREAM "</DT>" EOL))
      (CL:WHEN (CL:< DEPTH CUTOFF)
       (CL:PROGN (%%PRINT-STREAM STREAM "<DD>") (HTML-DESCRIBE-ONE-MODULE-SUB-LEVEL SUB (CL:1+ DEPTH) CUTOFF STREAM) (%%PRINT-STREAM STREAM "</DD>" EOL)))
      (CL:SETQ ITER-000 (%%REST ITER-000))))
    (%%PRINT-STREAM STREAM "</DL>" EOL))
   NULL))
...
(CL:DEFUN HTML-DESCRIBE-MODULE-SUBS (TITLE HEAD MODULE STREAM RULE?)
  ...
  #+MCL
  (CL:CHECK-TYPE HEAD CL:SIMPLE-STRING)
  (CL:LET* ((HEURISTICDEPTH 4) (SUBLENGTH (LENGTH (CHILD-MODULES MODULE)))) (CL:DECLARE (CL:TYPE CL:FIXNUM HEURISTICDEPTH SUBLENGTH))
   (CL:WHEN (CL:> SUBLENGTH 30) (CL:SETQ HEURISTICDEPTH (CL:1- HEURISTICDEPTH))) (HTML-WRITE-HEADER-WITH-TABLE STREAM TITLE HEAD)
   (CL:IF (CL:= SUBLENGTH 0) (CL:PROGN (%%PRINT-STREAM STREAM "<I>") (%%PRINT-STREAM STREAM "None") (%%PRINT-STREAM STREAM "</I>" EOL))
...
(CL:DEFUN HTML-DESCRIBE-ONE-MODULE-SUPER-LEVEL (MODULE ALREADYOUTPUT STREAM)
  (CL:LET* ((PARENTS (SORT (COPY-CONS-LIST (%THE-CONS-LIST (%PARENT-MODULES MODULE))) (CL:FUNCTION MODULE-NAME-LESS-THAN?))) (ALREADYOUTPUT? CL:NIL))
   (CL:WHEN (CL:EQ PARENTS NIL) (CL:RETURN-FROM HTML-DESCRIBE-ONE-MODULE-SUPER-LEVEL))
   (CL:PROGN (%%PRINT-STREAM STREAM "<DL STYLE=' margin-top: 0; margin-bottom:0'>")
    (CL:LET* ((PARENT NULL) (ITER-000 PARENTS))
     (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-000 NIL)) DO (CL:SETQ PARENT (%%VALUE ITER-000)) (CL:SETQ ALREADYOUTPUT? (CL:NOT (CL:EQ (LOOKUP ALREADYOUTPUT PARENT) NULL)))
      ...
      (CL:WHEN (CL:NOT ALREADYOUTPUT?) (INSERT-AT ALREADYOUTPUT PARENT TRUE-WRAPPER)
       (CL:PROGN (%%PRINT-STREAM STREAM "<DD>") (HTML-DESCRIBE-ONE-MODULE-SUPER-LEVEL PARENT ALREADYOUTPUT STREAM) (%%PRINT-STREAM STREAM "</DD>" EOL)))
      (CL:SETQ ITER-000 (%%REST ITER-000))))
    (%%PRINT-STREAM STREAM "</DL>" EOL)))
  NULL)
...
(CL:DEFUN HTML-DESCRIBE-MODULE-SUPERS (TITLE HEAD MODULE STREAM RULE?)
  ...
  (CL:LET* ((ALREADYOUTPUT (NEW-HASH-TABLE))) (HTML-WRITE-HEADER-WITH-TABLE STREAM TITLE HEAD)
   (CL:IF (CL:EQ (PARENT-MODULE MODULE) NULL) (CL:PROGN (%%PRINT-STREAM STREAM "<I>") (%%PRINT-STREAM STREAM "None") (%%PRINT-STREAM STREAM "</I>" EOL))
...
(CL:DEFUN HTML-DISPLAY-MODULE-STATS (TITLE HEAD MODULE STREAM RULE?)
  ...
  #+MCL
  (CL:CHECK-TYPE HEAD CL:SIMPLE-STRING)
  (CL:LET* ((NCONCEPTS 0) (NRELATIONS 0) (NINSTANCES 0) (ALLCLASSES (NEW-LIST)) (TOPLEVELCLASSES (NEW-LIST)) (ADD? CL:NIL))
   (CL:DECLARE (CL:TYPE CL:FIXNUM NCONCEPTS NRELATIONS NINSTANCES))
   (CL:LET* ((OBJECT NULL) (ITER-000 (ALL-NAMED-TERMS MODULE CL:T)))
    (CL:LOOP WHILE (NEXT? ITER-000) DO (CL:SETQ OBJECT (%VALUE ITER-000))
     (CL:COND
      ((ISA? OBJECT SGT-HTML-DESCRIBE-OBJECT-LOGIC-NAMED-DESCRIPTION)
       (CL:COND ((CLASS? OBJECT) (CL:SETQ NCONCEPTS (CL:1+ NCONCEPTS)) (PUSH ALLCLASSES OBJECT)) ((RELATION? OBJECT) (CL:SETQ NRELATIONS (CL:1+ NRELATIONS)))
   ...
   (CL:LET* ((CLASS NULL) (ITER-001 (%THE-CONS-LIST ALLCLASSES)))
    (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-001 NIL)) DO (CL:SETQ CLASS (%%VALUE ITER-001)) (CL:SETQ ADD? CL:T)
     (CL:LET* ((PARENT NULL) (ITER-002 (ALL-DIRECT-SUPERRELATIONS CLASS CL:T)))
      (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-002 NIL)) DO (CL:SETQ PARENT (%%VALUE ITER-002)) (CL:WHEN (MEMBER? ALLCLASSES PARENT) (CL:SETQ ADD? CL:NIL) (CL:RETURN))
       (CL:SETQ ITER-002 (%%REST ITER-002))))
     (CL:WHEN ADD? (PUSH TOPLEVELCLASSES CLASS)) (CL:SETQ ITER-001 (%%REST ITER-001))))
   (HTML-WRITE-HEADER-WITH-TABLE STREAM TITLE HEAD)
   (%%PRINT-STREAM STREAM NCONCEPTS " " (LOOKUP-TERM KWD-HTML-DESCRIBE-OBJECT-CONCEPT CL:NIL (CL:NOT (CL:= NCONCEPTS 1))) "; " NRELATIONS " "
    (LOOKUP-TERM KWD-HTML-DESCRIBE-OBJECT-RELATION CL:NIL (CL:NOT (CL:= NRELATIONS 1))) "; " NINSTANCES " "
    (LOOKUP-TERM KWD-HTML-DESCRIBE-OBJECT-INSTANCE CL:NIL (CL:NOT (CL:= NINSTANCES 1))) ";  TOTAL of objects = " (CL:+ NCONCEPTS NRELATIONS NINSTANCES))
   (CL:PROGN (%%PRINT-STREAM STREAM "<P>") (CL:PROGN (%%PRINT-STREAM STREAM "<B>") (%%PRINT-STREAM STREAM "Top Level Classes:") (%%PRINT-STREAM STREAM "</B>"))
    (%%PRINT-STREAM STREAM "<BR>" EOL)
    (CL:IF (EMPTY? TOPLEVELCLASSES) (CL:PROGN (%%PRINT-STREAM STREAM "<I>") (%%PRINT-STREAM STREAM "None") (%%PRINT-STREAM STREAM "</I>" EOL))
     (CL:PROGN (%%PRINT-STREAM STREAM "<DL>") (CL:SETQ TOPLEVELCLASSES (SORT TOPLEVELCLASSES (CL:FUNCTION OBJECT-NAME-LESS-THAN?)))
      (CL:LET* ((CLASS NULL) (ITER-003 (%THE-CONS-LIST TOPLEVELCLASSES)))
       (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-003 NIL)) DO (CL:SETQ CLASS (%%VALUE ITER-003))
        (CL:PROGN (%%PRINT-STREAM STREAM "<DT STYLE='margin-top: 0'>") (HTML-WRITE-HREF STREAM "show" "concept" CLASS) (%%PRINT-STREAM STREAM "</DT>" EOL))
...
(CL:DEFUN HTML-DESCRIBE-MODULE (MODULE STREAM)
  ...
  (CL:LET* ((NAMESTRING (NAME MODULE))) (CL:DECLARE (CL:TYPE CL:SIMPLE-STRING NAMESTRING))
   (CL:WHEN
    (CL:AND (VIZ-SERVER-AVAILABLE?) (CL:NOT (%WRAPPER-VALUE (DYNAMIC-SLOT-VALUE (%DYNAMIC-SLOTS MODULE) SYM-HTML-DESCRIBE-OBJECT-STELLA-CODE-ONLY? FALSE-WRAPPER)))
     (CL:NOT (%WRAPPER-VALUE (DYNAMIC-SLOT-VALUE (%DYNAMIC-SLOTS MODULE) SYM-HTML-DESCRIBE-OBJECT-STELLA-NAMESPACE? FALSE-WRAPPER))))
    (HTML-WRITE-HREF-IN-DETAIL STREAM "Graph" "graph" "context" (NAME MODULE) (NAME MODULE) (CONCATENATE "Graph " (NAME MODULE)) CL:NIL))
   (HTML-DISPLAY-IMAGES MODULE STREAM) (HTML-DISPLAY-DOCUMENTATION MODULE STREAM) (HTML-DESCRIBE-MODULE-SUBS "Child Modules" NAMESTRING MODULE STREAM CL:T)
   (HTML-DESCRIBE-MODULE-SUPERS "Parent Modules" NAMESTRING MODULE STREAM CL:T) (HTML-DISPLAY-MODULE-STATS "Contents" NAMESTRING MODULE STREAM CL:T) NULL))
...
(CL:DEFUN HTML-UNKNOWN-MODULE-RESPONSE (ITEMTYPE ITEMNAME MODULENAME STREAM)
  ...
  (CL:PROGN (%%PRINT-STREAM STREAM "<HTML>")
   (CL:PROGN (%%PRINT-STREAM STREAM "<HEAD>")
    (CL:PROGN (%%PRINT-STREAM STREAM "<TITLE>") (%%PRINT-STREAM STREAM (LOOKUP-TERM ITEMTYPE CL:T CL:NIL) " ") (WRITE-HTML-QUOTING-SPECIAL-CHARACTERS STREAM ITEMNAME)
     (%%PRINT-STREAM STREAM "</TITLE>" EOL))
    (%%PRINT-STREAM STREAM "</HEAD>" EOL))
   (CL:LET* ((TAG-001 (CONCATENATE "BODY BGCOLOR='#" *ERROR-BACKGROUND-COLOR* "'"))) (CL:DECLARE (CL:TYPE CL:SIMPLE-STRING TAG-001))
    (%%PRINT-STREAM STREAM "<" TAG-001 ">")
    (CL:PROGN (%%PRINT-STREAM STREAM "<H1>") (%%PRINT-STREAM STREAM (LOOKUP-TERM ITEMTYPE CL:T CL:NIL) " ") (WRITE-HTML-QUOTING-SPECIAL-CHARACTERS STREAM ITEMNAME)
     (%%PRINT-STREAM STREAM "</H1>" EOL))
    (%%PRINT-STREAM STREAM "<HR SIZE=4>" EOL)
    (CL:PROGN (%%PRINT-STREAM STREAM "<STRONG>") (%%PRINT-STREAM STREAM "SORRY: Unknown " (LOOKUP-TERM KWD-HTML-DESCRIBE-OBJECT-CONTEXT CL:NIL CL:NIL) " `")
     (WRITE-HTML-QUOTING-SPECIAL-CHARACTERS STREAM MODULENAME) (%%PRINT-STREAM STREAM "'.") (HTML-LINE-BREAK STREAM) (%%PRINT-STREAM STREAM "<HR SIZE=2>" EOL)
     (WRITE-POWERLOOM-TRAILER STREAM) (%%PRINT-STREAM STREAM "</STRONG>" EOL))
...
(CL:DEFUN HTML-UNKNOWN-OBJECT-RESPONSE (ITEMTYPE ITEMNAME STREAM)
  ...
  (CL:PROGN (%%PRINT-STREAM STREAM "<HTML>")
   ...
   (%%PRINT-STREAM STREAM EOL)
   (CL:LET* ((TAG-002 (CONCATENATE "BODY BGCOLOR='#" *ERROR-BACKGROUND-COLOR* "'"))) (CL:DECLARE (CL:TYPE CL:SIMPLE-STRING TAG-002))
    (%%PRINT-STREAM STREAM "<" TAG-002 ">")
    (CL:PROGN (%%PRINT-STREAM STREAM "<H1>") (%%PRINT-STREAM STREAM (LOOKUP-TERM ITEMTYPE CL:T CL:NIL) " ") (WRITE-HTML-QUOTING-SPECIAL-CHARACTERS STREAM ITEMNAME)
     (%%PRINT-STREAM STREAM "</H1>" EOL))
    (%%PRINT-STREAM STREAM "<HR SIZE=4>" EOL)
    (CL:PROGN (%%PRINT-STREAM STREAM "<STRONG>")
     (%%PRINT-STREAM STREAM "SORRY: Unknown " (LOOKUP-TERM ITEMTYPE CL:NIL CL:NIL) " `" ITEMNAME "' in " (LOOKUP-TERM KWD-HTML-DESCRIBE-OBJECT-CONTEXT CL:NIL CL:NIL)
      " ")
     (WRITE-HTML-QUOTING-SPECIAL-CHARACTERS STREAM (NAME *MODULE*)) (%%PRINT-STREAM STREAM ".") (%%PRINT-STREAM STREAM "</STRONG>"))
   ...
   (CL:PROGN (%%PRINT-STREAM STREAM "<HTML>")
    (CL:PROGN (%%PRINT-STREAM STREAM "<HEAD>") (%%PRINT-STREAM STREAM "<BASE TARGET='content'>" EOL)
     (CL:PROGN (%%PRINT-STREAM STREAM "<TITLE>")
      (%%PRINT-STREAM STREAM (LOOKUP-TERM (CL:IF (CLASS? RELATION) KWD-HTML-DESCRIBE-OBJECT-CONCEPT KWD-HTML-DESCRIBE-OBJECT-RELATION) CL:T CL:NIL) " ")
      (WRITE-HTML-QUOTING-SPECIAL-CHARACTERS STREAM OBJECTNAME) (%%PRINT-STREAM STREAM "</TITLE>" EOL))
     (%%PRINT-STREAM STREAM "</HEAD>" EOL))
    (CL:LET* ((TAG-003 (CONCATENATE "BODY BGCOLOR='#" *STANDARD-BACKGROUND-COLOR* "'"))) (CL:DECLARE (CL:TYPE CL:SIMPLE-STRING TAG-003))
     ...
     (%%PRINT-STREAM STREAM "<HR SIZE=4>" EOL) (HTML-DESCRIBE-NAMED-DESCRIPTION RELATION STREAM) (WRITE-POWERLOOM-TRAILER STREAM)
...
(CL:DEFUN HTML-WRITE-INSTANCE-RESPONSE-PAGE (INSTANCE STREAM)
  (CL:LET* ((OBJECTNAME (GET-HTML-OBJECT-HANDLE INSTANCE))) (CL:DECLARE (CL:TYPE CL:SIMPLE-STRING OBJECTNAME))
   (CL:PROGN (%%PRINT-STREAM STREAM "<HTML>")
    (CL:PROGN (%%PRINT-STREAM STREAM "<HEAD>") (%%PRINT-STREAM STREAM "<BASE TARGET='content'>" EOL)
     (CL:PROGN (%%PRINT-STREAM STREAM "<TITLE>") (%%PRINT-STREAM STREAM (LOOKUP-TERM KWD-HTML-DESCRIBE-OBJECT-INSTANCE CL:T CL:NIL) " ")
      (WRITE-HTML-QUOTING-SPECIAL-CHARACTERS STREAM OBJECTNAME) (%%PRINT-STREAM STREAM "</TITLE>" EOL))
     (%%PRINT-STREAM STREAM "</HEAD>" EOL))
    (CL:LET* ((TAG-004 (CONCATENATE "BODY BGCOLOR='#" *STANDARD-BACKGROUND-COLOR* "'"))) (CL:DECLARE (CL:TYPE CL:SIMPLE-STRING TAG-004))
     (%%PRINT-STREAM STREAM "<" TAG-004 ">")
     (CL:PROGN (%%PRINT-STREAM STREAM "<H1>") (%%PRINT-STREAM STREAM (LOOKUP-TERM KWD-HTML-DESCRIBE-OBJECT-INSTANCE CL:T CL:NIL) " ")
      (WRITE-HTML-QUOTING-SPECIAL-CHARACTERS STREAM OBJECTNAME) (%%PRINT-STREAM STREAM "</H1>" EOL))
     (%%PRINT-STREAM STREAM "<HR SIZE=4>" EOL) (HTML-DESCRIBE-INSTANCE INSTANCE STREAM) (WRITE-POWERLOOM-TRAILER STREAM)
...
(CL:DEFUN HTML-WRITE-OBJECT-RESPONSE-PAGE-INTERNAL (OBJECT STREAM)
  (CL:LET* ((OBJECTNAME (GET-HTML-OBJECT-HANDLE OBJECT))) (CL:DECLARE (CL:TYPE CL:SIMPLE-STRING OBJECTNAME))
   ...
   (CL:PROGN (%%PRINT-STREAM STREAM "<HTML>")
    (CL:PROGN (%%PRINT-STREAM STREAM "<HEAD>") (%%PRINT-STREAM STREAM "<BASE TARGET='content'>" EOL)
     (CL:PROGN (%%PRINT-STREAM STREAM "<TITLE>") (%%PRINT-STREAM STREAM (LOOKUP-TERM KWD-HTML-DESCRIBE-OBJECT-OBJECT CL:T CL:NIL) " ")
      (WRITE-HTML-QUOTING-SPECIAL-CHARACTERS STREAM OBJECTNAME) (%%PRINT-STREAM STREAM "</TITLE>" EOL))
     (%%PRINT-STREAM STREAM "</HEAD>" EOL))
    (CL:LET* ((TAG-005 (CONCATENATE "BODY BGCOLOR='#" *STANDARD-BACKGROUND-COLOR* "'"))) (CL:DECLARE (CL:TYPE CL:SIMPLE-STRING TAG-005))
     (%%PRINT-STREAM STREAM "<" TAG-005 ">")
     (CL:PROGN (%%PRINT-STREAM STREAM "<H1>") (%%PRINT-STREAM STREAM (LOOKUP-TERM KWD-HTML-DESCRIBE-OBJECT-OBJECT CL:T CL:NIL) " ")
      (WRITE-HTML-QUOTING-SPECIAL-CHARACTERS STREAM OBJECTNAME) (%%PRINT-STREAM STREAM "</H1>" EOL))
     (%%PRINT-STREAM STREAM "<HR SIZE=4>" EOL) (WRITE-HTML-QUOTING-SPECIAL-CHARACTERS STREAM OBJECTNAME) (%%PRINT-STREAM STREAM "<BR>" EOL)
     (%%PRINT-STREAM STREAM "<HR SIZE=2>" EOL) (WRITE-POWERLOOM-TRAILER STREAM) (%%PRINT-STREAM STREAM "</" (SUBSEQUENCE TAG-005 0 (POSITION TAG-005 #\  0)) ">" EOL))
    (%%PRINT-STREAM STREAM "</HTML>" EOL))))
...
(CL:DEFUN HTML-WRITE-MODULE-RESPONSE-PAGE-INTERNAL (MODULE STREAM)
  (CL:LET* ((MODULENAME (NAME MODULE))) (CL:DECLARE (CL:TYPE CL:SIMPLE-STRING MODULENAME))
   (CL:PROGN (%%PRINT-STREAM STREAM "<HTML>")
    (CL:PROGN (%%PRINT-STREAM STREAM "<HEAD>") (%%PRINT-STREAM STREAM "<BASE TARGET='content'>" EOL)
     (CL:PROGN (%%PRINT-STREAM STREAM "<TITLE>") (%%PRINT-STREAM STREAM (LOOKUP-TERM KWD-HTML-DESCRIBE-OBJECT-MODULE CL:T CL:NIL) " ")
      (WRITE-HTML-QUOTING-SPECIAL-CHARACTERS STREAM MODULENAME) (%%PRINT-STREAM STREAM "</TITLE>" EOL))
     (%%PRINT-STREAM STREAM "</HEAD>" EOL))
    (CL:LET* ((TAG-006 (CONCATENATE "BODY BGCOLOR='#" *MODULE-BACKGROUND-COLOR* "'"))) (CL:DECLARE (CL:TYPE CL:SIMPLE-STRING TAG-006))
     (%%PRINT-STREAM STREAM "<" TAG-006 ">")
     (CL:PROGN (%%PRINT-STREAM STREAM "<H1>") (%%PRINT-STREAM STREAM (LOOKUP-TERM KWD-HTML-DESCRIBE-OBJECT-CONTEXT CL:T CL:NIL) " ")
...
(CL:DEFUN HTML-WRITE-MODULE-RESPONSE-PAGE (MODULENAME STREAM)
  ...
  (CL:LET* ((MODULE (GET-STELLA-MODULE MODULENAME CL:NIL)))
   (CL:COND ((CL:EQ MODULE NULL) (HTML-UNKNOWN-OBJECT-RESPONSE KWD-HTML-DESCRIBE-OBJECT-CONTEXT MODULENAME STREAM))
    (CL:T (CL:LET* ((*MODULE* MODULE) (*CONTEXT* *MODULE*)) (CL:DECLARE (CL:SPECIAL *MODULE* *CONTEXT*)) (HTML-WRITE-MODULE-RESPONSE-PAGE-INTERNAL MODULE STREAM))))))
...
(CL:DEFUN HTML-WRITE-OBJECT-RESPONSE-PAGE (MODULENAME OBJECTNAME STREAM)
  ...
  (CL:CHECK-TYPE OBJECTNAME CL:SIMPLE-STRING)
  (CL:LET* ((MODULE (GET-STELLA-MODULE MODULENAME CL:NIL)))
   (CL:WHEN (CL:EQ MODULE NULL) (HTML-UNKNOWN-MODULE-RESPONSE KWD-HTML-DESCRIBE-OBJECT-RELATION OBJECTNAME MODULENAME STREAM)
    (CL:RETURN-FROM HTML-WRITE-OBJECT-RESPONSE-PAGE))
   (CL:LET* ((*MODULE* MODULE) (*CONTEXT* *MODULE*)) (CL:DECLARE (CL:SPECIAL *MODULE* *CONTEXT*))
    (CL:LET*
     ((INSTANCE (CL:IF (STARTS-WITH? OBJECTNAME "(" 0) (COERCE-TO-INSTANCE (READ-S-EXPRESSION-FROM-STRING OBJECTNAME) NULL) (PLI::GET-OBJECT OBJECTNAME NULL NULL))))
     (CL:IF (CL:NOT (CL:EQ INSTANCE NULL))
      (CL:LET* ((TEST-VALUE-000 (SAFE-PRIMARY-TYPE INSTANCE)))
       (CL:COND ((SUBTYPE-OF? TEST-VALUE-000 SGT-HTML-DESCRIBE-OBJECT-LOGIC-NAMED-DESCRIPTION) (CL:PROGN (HTML-WRITE-RELATION-RESPONSE-PAGE INSTANCE STREAM)))
        ((SUBTYPE-OF? TEST-VALUE-000 SGT-HTML-DESCRIBE-OBJECT-LOGIC-LOGIC-OBJECT) (CL:PROGN (HTML-WRITE-INSTANCE-RESPONSE-PAGE INSTANCE STREAM)))
...
(CL:DEFUN FIND-CANDIDATE-OBJECTS (OBJECTNAME OBJECTTYPE MATCHTYPE)
  ...
  (CL:LET*
   ((BARENAME STELLA::NULL-STRING) (MODULENAME STELLA::NULL-STRING) (KIND NULL) (RESULTS (NEW-LIST)) (CANDIDATEOBJECTNAME NULL) (OBJECTMODULE NULL)
    (UPCASEDOBJECTNAME STELLA::NULL-STRING) (CANDIDATETERMS NULL))
   (CL:DECLARE (CL:TYPE CL:SIMPLE-STRING BARENAME MODULENAME UPCASEDOBJECTNAME)) (CL:SETQ KIND KIND)
   (CL:HANDLER-CASE (CL:MULTIPLE-VALUE-SETQ (BARENAME MODULENAME KIND) (PARSE-STELLA-NAME OBJECTNAME CL:NIL)) (READ-EXCEPTION () (CL:SETQ BARENAME OBJECTNAME)))
   ...
   (CL:COND
    ((CL:EQ MATCHTYPE KWD-HTML-DESCRIBE-OBJECT-EXACT)
     (CL:LET* ((OBJ NULL) (ITER-000 CANDIDATETERMS))
      (CL:LOOP WHILE (NEXT? ITER-000) DO (CL:SETQ OBJ (%VALUE ITER-000))
       (CL:TAGBODY
        (CL:WHEN (ISA? OBJ SGT-HTML-DESCRIBE-OBJECT-LOGIC-LOGIC-OBJECT) (CL:SETQ CANDIDATEOBJECTNAME (OBJECT-NAME OBJ))
         (CL:WHEN (CL:NOT (CL:EQ CANDIDATEOBJECTNAME NULL))
          (CL:WHEN
           (CL:AND (STRING-EQL? (%SYMBOL-NAME CANDIDATEOBJECTNAME) BARENAME) (CL:OR (CL:EQ OBJECTMODULE NULL) (CL:EQ (HOME-MODULE CANDIDATEOBJECTNAME) OBJECTMODULE)))
           (PUSH RESULTS OBJ) (CL:GO :CONTINUE)))
         (CL:LET* ((SYN NULL) (ITER-001 (GET-SYNONYMS OBJ)))
          (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-001 NIL)) DO (CL:SETQ SYN (%%VALUE ITER-001)) (CL:SETQ CANDIDATEOBJECTNAME (OBJECT-NAME SYN))
           (CL:WHEN (CL:NOT (CL:EQ CANDIDATEOBJECTNAME NULL))
            (CL:WHEN
             (CL:AND (STRING-EQL? (%SYMBOL-NAME CANDIDATEOBJECTNAME) BARENAME) (CL:OR (CL:EQ OBJECTMODULE NULL) (CL:EQ (HOME-MODULE CANDIDATEOBJECTNAME) OBJECTMODULE)))
      ...
      (CL:LOOP WHILE (NEXT? ITER-002) DO (CL:SETQ OBJ (%VALUE ITER-002))
       (CL:TAGBODY
        (CL:WHEN (ISA? OBJ SGT-HTML-DESCRIBE-OBJECT-LOGIC-LOGIC-OBJECT) (CL:SETQ CANDIDATEOBJECTNAME (OBJECT-NAME OBJ))
         (CL:WHEN (CL:NOT (CL:EQ CANDIDATEOBJECTNAME NULL))
          (CL:WHEN
           (CL:AND (STRING-EQUAL? (%SYMBOL-NAME CANDIDATEOBJECTNAME) BARENAME) (CL:OR (CL:EQ OBJECTMODULE NULL) (CL:EQ (HOME-MODULE CANDIDATEOBJECTNAME) OBJECTMODULE)))
           (PUSH RESULTS OBJ) (CL:GO :CONTINUE)))
         (CL:LET* ((SYN NULL) (ITER-003 (GET-SYNONYMS OBJ)))
          (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-003 NIL)) DO (CL:SETQ SYN (%%VALUE ITER-003)) (CL:SETQ CANDIDATEOBJECTNAME (OBJECT-NAME SYN))
           (CL:WHEN (CL:NOT (CL:EQ CANDIDATEOBJECTNAME NULL))
            (CL:WHEN
             (CL:AND (STRING-EQUAL? (%SYMBOL-NAME CANDIDATEOBJECTNAME) BARENAME)
    ...
    ((CL:EQ MATCHTYPE KWD-HTML-DESCRIBE-OBJECT-SUBSTRING)
     (CL:LET* ((OBJ NULL) (ITER-004 CANDIDATETERMS))
      (CL:LOOP WHILE (NEXT? ITER-004) DO (CL:SETQ OBJ (%VALUE ITER-004))
       (CL:TAGBODY
        (CL:WHEN (ISA? OBJ SGT-HTML-DESCRIBE-OBJECT-LOGIC-LOGIC-OBJECT) (CL:SETQ CANDIDATEOBJECTNAME (OBJECT-NAME OBJ))
         (CL:WHEN (CL:NOT (CL:EQ CANDIDATEOBJECTNAME NULL))
          (CL:WHEN
           (CL:AND (CL:NOT (CL:= (STRING-SEARCH (STRING-UPCASE (%SYMBOL-NAME CANDIDATEOBJECTNAME)) UPCASEDOBJECTNAME 0) NULL-INTEGER))
            (CL:OR (CL:EQ OBJECTMODULE NULL) (CL:EQ (HOME-MODULE CANDIDATEOBJECTNAME) OBJECTMODULE)))
           (PUSH RESULTS OBJ) (CL:GO :CONTINUE)))
         (CL:LET* ((SYN NULL) (ITER-005 (GET-SYNONYMS OBJ)))
          (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-005 NIL)) DO (CL:SETQ SYN (%%VALUE ITER-005)) (CL:SETQ CANDIDATEOBJECTNAME (OBJECT-NAME SYN))
           (CL:WHEN (CL:NOT (CL:EQ CANDIDATEOBJECTNAME NULL))
            (CL:WHEN
             (CL:AND (CL:NOT (CL:= (STRING-SEARCH (STRING-UPCASE (%SYMBOL-NAME CANDIDATEOBJECTNAME)) UPCASEDOBJECTNAME 0) NULL-INTEGER))
              (CL:OR (CL:EQ OBJECTMODULE NULL) (CL:EQ (HOME-MODULE CANDIDATEOBJECTNAME) OBJECTMODULE)))
        ...
        :CONTINUE))))
    ((CL:EQ MATCHTYPE KWD-HTML-DESCRIBE-OBJECT-WILDCARD) (CL:ERROR (NEW-STELLA-EXCEPTION ":WILDCARD matching not implemented yet")))
    ((CL:EQ MATCHTYPE KWD-HTML-DESCRIBE-OBJECT-REGEX) (CL:ERROR (NEW-STELLA-EXCEPTION ":REGEX matching not implemented yet")))
    (CL:T
     (CL:LET* ((STREAM-000 (NEW-OUTPUT-STRING-STREAM))) (%%PRINT-STREAM (%NATIVE-STREAM STREAM-000) "`" MATCHTYPE "' is not a valid case option")
...
(CL:DEFUN RESOLVE-SYNONYMS (OBJ)
  (CL:LET* ((SURROGATE (%SURROGATE-VALUE-INVERSE OBJ))) (CL:IF (CL:AND (CL:NOT (CL:EQ SURROGATE NULL)) (SYNONYM-SURROGATE? SURROGATE)) (%SURROGATE-VALUE SURROGATE) OBJ)))
   ...
   (CL:LET* ((*MODULE* MODULE) (*CONTEXT* *MODULE*)) (CL:DECLARE (CL:SPECIAL *MODULE* *CONTEXT*))
    (CL:LET* ((CANDIDATEOBJECTS (FIND-CANDIDATE-OBJECTS OBJECTNAME OBJECTTYPE MATCHTYPE)))
     (CL:CASE (LENGTH CANDIDATEOBJECTS)
      (0 (HTML-UNKNOWN-OBJECT-RESPONSE (CL:IF (STRING-EQL? OBJECTTYPE "instance") KWD-HTML-DESCRIBE-OBJECT-OBJECT KWD-HTML-DESCRIBE-OBJECT-RELATION) OBJECTNAME STREAM))
      (1
...
(CL:DEFUN HTML-WRITE-MULTIPLE-CHOICE-PAGE (SEARCHSTRING CANDIDATEOBJECTS STREAM)
  ...
  (CL:PROGN (%%PRINT-STREAM STREAM "<HTML>")
   (CL:PROGN (%%PRINT-STREAM STREAM "<HEAD>") (%%PRINT-STREAM STREAM "<BASE TARGET='content'>" EOL)
    (CL:PROGN (%%PRINT-STREAM STREAM "<TITLE>") (WRITE-HTML-QUOTING-SPECIAL-CHARACTERS STREAM SEARCHSTRING) (%%PRINT-STREAM STREAM "</TITLE>" EOL))
    (%%PRINT-STREAM STREAM "</HEAD>" EOL))
   (CL:LET* ((TAG-007 (CONCATENATE "BODY BGCOLOR='#" *STANDARD-BACKGROUND-COLOR* "'"))) (CL:DECLARE (CL:TYPE CL:SIMPLE-STRING TAG-007))
    (%%PRINT-STREAM STREAM "<" TAG-007 ">")
    (CL:PROGN (%%PRINT-STREAM STREAM "<H1>") (%%PRINT-STREAM STREAM "Matches for &quot;")
     (CL:PROGN (%%PRINT-STREAM STREAM "<FONT COLOR='#990033'>") (WRITE-HTML-QUOTING-SPECIAL-CHARACTERS STREAM SEARCHSTRING) (%%PRINT-STREAM STREAM "</FONT>"))
     ...
     (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-000 NIL)) DO (CL:SETQ OBJ (%%VALUE ITER-000))
      (CL:COND
       ((SUBTYPE-OF? (SAFE-PRIMARY-TYPE OBJ) SGT-HTML-DESCRIBE-OBJECT-LOGIC-DESCRIPTION)
        (CL:PROGN (CL:IF (CLASS? OBJ) (%%PRINT-STREAM STREAM "Concept ") (%%PRINT-STREAM STREAM "Relation ")) (PPRINT-OBJECT OBJ STREAM)))
       (CL:T (%%PRINT-STREAM STREAM "Object ") (PPRINT-OBJECT OBJ STREAM)))
      (HTML-LINE-BREAK STREAM) (CL:SETQ ITER-000 (%%REST ITER-000))))
    (%%PRINT-STREAM STREAM "<HR SIZE=2>" EOL) (WRITE-POWERLOOM-TRAILER STREAM) (%%PRINT-STREAM STREAM "</" (SUBSEQUENCE TAG-007 0 (POSITION TAG-007 #\  0)) ">" EOL))
   (%%PRINT-STREAM STREAM "</HTML>" EOL)))
...
(CL:DEFUN HTML-POWERLOOM-RESPONSE (ACTION OBJECTTYPE MODULENAME OBJECTNAME STREAM)
  ...
  (CL:CHECK-TYPE OBJECTNAME CL:SIMPLE-STRING)
  (CL:LET*
   ((*PPRINT-ATOMIC-OBJECT-RENDERER* (%FUNCTION-CODE (LOOKUP-FUNCTION SYM-HTML-DESCRIBE-OBJECT-ONTOSAURUS-PPRINT-ATOMIC-OBJECT-FOR-HTML))) (*PPRINT-INDENT* 0)
    (*PRINTREADABLY?* CL:T))
   (CL:DECLARE (CL:SPECIAL *PPRINT-ATOMIC-OBJECT-RENDERER* *PPRINT-INDENT* *PRINTREADABLY?*)) (CL:DECLARE (CL:TYPE CL:FIXNUM *PPRINT-INDENT*))
   (CL:COND
    ((CL:OR (STRING-EQL? OBJECTTYPE "object") (STRING-EQL? OBJECTTYPE "concept") (STRING-EQL? OBJECTTYPE "relation") (STRING-EQL? OBJECTTYPE "instance"))
     (CL:COND
      ((STRING-EQL? ACTION "show")
       (CL:LET* ((*ONTOSAURUS-URL-ACTION* "show")) (CL:DECLARE (CL:SPECIAL *ONTOSAURUS-URL-ACTION*)) (CL:DECLARE (CL:TYPE CL:SIMPLE-STRING *ONTOSAURUS-URL-ACTION*))
      ...
      ((CL:OR (STRING-EQL? ACTION "find") (STRING-EQL? ACTION "findsubstring"))
       (CL:LET* ((*ONTOSAURUS-URL-ACTION* "show")) (CL:DECLARE (CL:SPECIAL *ONTOSAURUS-URL-ACTION*)) (CL:DECLARE (CL:TYPE CL:SIMPLE-STRING *ONTOSAURUS-URL-ACTION*))
        (HTML-WRITE-FIND-OBJECT-RESPONSE-PAGE MODULENAME OBJECTNAME OBJECTTYPE KWD-HTML-DESCRIBE-OBJECT-SUBSTRING STREAM))
       (CL:RETURN-FROM HTML-POWERLOOM-RESPONSE))
      ...
      ((STRING-EQL? ACTION "findinsensitive")
       (CL:LET* ((*ONTOSAURUS-URL-ACTION* "show")) (CL:DECLARE (CL:SPECIAL *ONTOSAURUS-URL-ACTION*)) (CL:DECLARE (CL:TYPE CL:SIMPLE-STRING *ONTOSAURUS-URL-ACTION*))
        (HTML-WRITE-FIND-OBJECT-RESPONSE-PAGE MODULENAME OBJECTNAME OBJECTTYPE KWD-HTML-DESCRIBE-OBJECT-CASE-INSENSITIVE STREAM))
       (CL:RETURN-FROM HTML-POWERLOOM-RESPONSE))))
    ((CL:AND (STRING-EQL? OBJECTTYPE "context") (STRING-EQL? ACTION "show")) (HTML-WRITE-MODULE-RESPONSE-PAGE MODULENAME STREAM)
     (CL:RETURN-FROM HTML-POWERLOOM-RESPONSE))
    ((STRING-EQL? OBJECTTYPE "query")
     (CL:COND ((STRING-EQL? ACTION "explain") (HTML-WRITE-EXPLANATION-RESPONSE-PAGE MODULENAME OBJECTNAME STREAM) (CL:RETURN-FROM HTML-POWERLOOM-RESPONSE))))))
  (CL:PROGN (%%PRINT-STREAM STREAM "<FONT COLOR='#BB0000'>")
   (CL:PROGN (%%PRINT-STREAM STREAM "<B>") (%%PRINT-STREAM STREAM "ERROR: Unrecognized action-type pair: '" ACTION "' '" OBJECTTYPE "'.") (%%PRINT-STREAM STREAM "</B>"))
   (%%PRINT-STREAM STREAM "</FONT>" EOL))
  NULL)
...
(CL:DEFUN DO-ACTION-HANDLER (XCHG)
  (CL:LET*
   ((KEYS (PARSE-AND-DECODE-URL-ARGUMENTS (GET-REQUEST-URI-QUERY XCHG) #\+)) (ACTION (%%VALUE KEYS)) (OBJECTTYPE (%%VALUE (%%REST KEYS)))
    (MODULENAME (%%VALUE (%%REST (%%REST KEYS)))) (OBJECTNAME (FOURTH KEYS)) (STREAM (GET-REPLY-STREAM XCHG)))
   (CL:HANDLER-CASE
    (CL:COND
     ((CL:>= (LENGTH KEYS) 4)
      (CL:COND ((STARTS-WITH? (%WRAPPER-VALUE ACTION) "graph" 0) (VIZ-SERVER-HANDLER XCHG))
       (CL:T (HTML-POWERLOOM-RESPONSE (%WRAPPER-VALUE ACTION) (%WRAPPER-VALUE OBJECTTYPE) (%WRAPPER-VALUE MODULENAME) (%WRAPPER-VALUE OBJECTNAME) STREAM))))
     (CL:T (SET-RESPONSE-CODE XCHG KWD-HTML-DESCRIBE-OBJECT-BAD-REQUEST)
      (CL:LET* ((TAG-008 (MAKE-HTML-BODY-TAG *ERROR-BACKGROUND-COLOR*))) (CL:DECLARE (CL:TYPE CL:SIMPLE-STRING TAG-008)) (%%PRINT-STREAM STREAM "<" TAG-008 ">")
       (%%PRINT-STREAM STREAM "ERROR: expected four parameters, only received " (LENGTH KEYS) EOL) (%%PRINT-STREAM STREAM "<BR><OL>" EOL)
       (CL:LET* ((KEY NULL) (ITER-000 KEYS))
        (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-000 NIL)) DO (CL:SETQ KEY (%%VALUE ITER-000)) (%%PRINT-STREAM STREAM "<LI>" KEY "</LI>" EOL)
         (CL:SETQ ITER-000 (%%REST ITER-000))))
       (%%PRINT-STREAM STREAM "</OL>" EOL) (%%PRINT-STREAM STREAM "</" (SUBSEQUENCE TAG-008 0 (POSITION TAG-008 #\  0)) ">" EOL))))
...
(CL:DEFUN HELP-STARTUP-HTML-DESCRIBE-OBJECT1 ()
  (CL:PROGN (CL:SETQ KWD-HTML-DESCRIBE-OBJECT-CONCEPT (INTERN-RIGID-SYMBOL-WRT-MODULE "CONCEPT" NULL 2))
   ...
   (CL:SETQ SGT-HTML-DESCRIBE-OBJECT-STELLA-MODULE (INTERN-RIGID-SYMBOL-WRT-MODULE "MODULE" (GET-STELLA-MODULE "/STELLA" CL:T) 1))
   ...
   (CL:SETQ SGT-HTML-DESCRIBE-OBJECT-LOGIC-NAMED-DESCRIPTION (INTERN-RIGID-SYMBOL-WRT-MODULE "NAMED-DESCRIPTION" (GET-STELLA-MODULE "/LOGIC" CL:T) 1))
   (CL:SETQ SYM-HTML-DESCRIBE-OBJECT-STELLA-CODE-ONLY? (INTERN-RIGID-SYMBOL-WRT-MODULE "CODE-ONLY?" (GET-STELLA-MODULE "/STELLA" CL:T) 0))
   (CL:SETQ SYM-HTML-DESCRIBE-OBJECT-STELLA-NAMESPACE? (INTERN-RIGID-SYMBOL-WRT-MODULE "NAMESPACE?" (GET-STELLA-MODULE "/STELLA" CL:T) 0))
   (CL:SETQ KWD-HTML-DESCRIBE-OBJECT-MODULE (INTERN-RIGID-SYMBOL-WRT-MODULE "MODULE" NULL 2))
   (CL:SETQ SGT-HTML-DESCRIBE-OBJECT-LOGIC-LOGIC-OBJECT (INTERN-RIGID-SYMBOL-WRT-MODULE "LOGIC-OBJECT" (GET-STELLA-MODULE "/LOGIC" CL:T) 1))
   ...
   (CL:SETQ SGT-HTML-DESCRIBE-OBJECT-LOGIC-DESCRIPTION (INTERN-RIGID-SYMBOL-WRT-MODULE "DESCRIPTION" (GET-STELLA-MODULE "/LOGIC" CL:T) 1))
   (CL:SETQ SYM-HTML-DESCRIBE-OBJECT-ONTOSAURUS-PPRINT-ATOMIC-OBJECT-FOR-HTML (INTERN-RIGID-SYMBOL-WRT-MODULE "PPRINT-ATOMIC-OBJECT-FOR-HTML" NULL 0))
   ...
   (CL:SETQ SYM-HTML-DESCRIBE-OBJECT-ONTOSAURUS-STARTUP-HTML-DESCRIBE-OBJECT (INTERN-RIGID-SYMBOL-WRT-MODULE "STARTUP-HTML-DESCRIBE-OBJECT" NULL 0))
   (CL:SETQ SYM-HTML-DESCRIBE-OBJECT-STELLA-METHOD-STARTUP-CLASSNAME (INTERN-RIGID-SYMBOL-WRT-MODULE "METHOD-STARTUP-CLASSNAME" (GET-STELLA-MODULE "/STELLA" CL:T) 0))))
...
(CL:DEFUN STARTUP-HTML-DESCRIBE-OBJECT ()
  (CL:LET* ((*MODULE* (GET-STELLA-MODULE "/ONTOSAURUS" (> *STARTUP-TIME-PHASE* 1))) (*CONTEXT* *MODULE*)) (CL:DECLARE (CL:SPECIAL *MODULE* *CONTEXT*))
   ...
   (CL:WHEN (CURRENT-STARTUP-TIME-PHASE? 4) (CL:SETQ *IMAGE-URL-RELATION* (PLI::S-GET-RELATION "IMAGE-URL" "PL-USER" NULL))
    (CL:SETQ *DOCUMENTATION-RELATION* (PLI::S-GET-RELATION "DOCUMENTATION" "PL-USER" NULL)))
   (CL:WHEN (CURRENT-STARTUP-TIME-PHASE? 6) (FINALIZE-CLASSES))
   (CL:WHEN (CURRENT-STARTUP-TIME-PHASE? 7)
    (DEFINE-FUNCTION-OBJECT "LOOKUP-TERM" "(DEFUN (LOOKUP-TERM STRING) ((TERM KEYWORD) (CAPITALIZED? BOOLEAN) (PLURAL? BOOLEAN)))" (CL:FUNCTION LOOKUP-TERM) NULL)
    (DEFINE-FUNCTION-OBJECT "SAFE-OBJECT-NAME-STRING" "(DEFUN (SAFE-OBJECT-NAME-STRING STRING) ((INSTANCE LOGIC-OBJECT)))" (CL:FUNCTION SAFE-OBJECT-NAME-STRING) NULL)
    (DEFINE-FUNCTION-OBJECT "HTML-DESCRIBE-LOCATION" "(DEFUN HTML-DESCRIBE-LOCATION ((SELF LOGIC-OBJECT) (STREAM NATIVE-OUTPUT-STREAM)))"
     (CL:FUNCTION HTML-DESCRIBE-LOCATION) NULL)
    (DEFINE-FUNCTION-OBJECT "HTML-WRITE-CONTEXT-VIEW-OPTION" "(DEFUN HTML-WRITE-CONTEXT-VIEW-OPTION ((STREAM NATIVE-OUTPUT-STREAM) (OBJECTNAME STRING) (CTX MODULE)))"
     (CL:FUNCTION HTML-WRITE-CONTEXT-VIEW-OPTION) NULL)
    (DEFINE-FUNCTION-OBJECT "HTML-DESCRIBE-CONTEXT-VIEW" "(DEFUN HTML-DESCRIBE-CONTEXT-VIEW ((SELF LOGIC-OBJECT) (STREAM NATIVE-OUTPUT-STREAM)))"
     (CL:FUNCTION HTML-DESCRIBE-CONTEXT-VIEW) NULL)
    (DEFINE-FUNCTION-OBJECT "HTML-DISPLAY-IMAGES" "(DEFUN HTML-DISPLAY-IMAGES ((SELF STANDARD-OBJECT) (STREAM NATIVE-OUTPUT-STREAM)))" (CL:FUNCTION HTML-DISPLAY-IMAGES)
     NULL)
    (DEFINE-FUNCTION-OBJECT "HTML-DISPLAY-DOCUMENTATION" "(DEFUN HTML-DISPLAY-DOCUMENTATION ((SELF STANDARD-OBJECT) (STREAM NATIVE-OUTPUT-STREAM)))"
     (CL:FUNCTION HTML-DISPLAY-DOCUMENTATION) NULL)
    (DEFINE-FUNCTION-OBJECT "HTML-DISPLAY-SYNONYMS" "(DEFUN HTML-DISPLAY-SYNONYMS ((SELF OBJECT) (STREAM NATIVE-OUTPUT-STREAM)))" (CL:FUNCTION HTML-DISPLAY-SYNONYMS)
     NULL)
    ...
    (DEFINE-FUNCTION-OBJECT "HTML-DESCRIBE-TYPES"
     "(DEFUN HTML-DESCRIBE-TYPES ((TITLE STRING) (HEAD STRING) (RELATION LOGIC-OBJECT) (STREAM NATIVE-OUTPUT-STREAM) (RULE? BOOLEAN)))" (CL:FUNCTION HTML-DESCRIBE-TYPES)
     NULL)
    ...
    (DEFINE-FUNCTION-OBJECT "HAS-CHILD-OTHER-THAN?" "(DEFUN (HAS-CHILD-OTHER-THAN? BOOLEAN) ((PARENT NAMED-DESCRIPTION) (CHILD NAMED-DESCRIPTION)))"
    ...
    (DEFINE-FUNCTION-OBJECT "HTML-DESCRIBE-RULES"
     "(DEFUN HTML-DESCRIBE-RULES ((TITLE STRING) (HEAD STRING) (RELATION LOGIC-OBJECT) (STREAM NATIVE-OUTPUT-STREAM) (RULE? BOOLEAN)))" (CL:FUNCTION HTML-DESCRIBE-RULES)
     NULL)
    ...
    (DEFINE-FUNCTION-OBJECT "HTML-DESCRIBE-NAMED-DESCRIPTION" "(DEFUN HTML-DESCRIBE-NAMED-DESCRIPTION ((CONCEPT NAMED-DESCRIPTION) (STREAM NATIVE-OUTPUT-STREAM)))"
     (CL:FUNCTION HTML-DESCRIBE-NAMED-DESCRIPTION) NULL)
    (DEFINE-FUNCTION-OBJECT "HTML-DESCRIBE-INSTANCE" "(DEFUN HTML-DESCRIBE-INSTANCE ((INSTANCE LOGIC-OBJECT) (STREAM NATIVE-OUTPUT-STREAM)))"
     (CL:FUNCTION HTML-DESCRIBE-INSTANCE) NULL)
    (DEFINE-FUNCTION-OBJECT "CHILD-MODULES" "(DEFUN (CHILD-MODULES (CONS OF MODULE)) ((MODULE MODULE)))" (CL:FUNCTION CHILD-MODULES) NULL)
    ...
    (DEFINE-FUNCTION-OBJECT "HTML-DESCRIBE-MODULE" "(DEFUN HTML-DESCRIBE-MODULE ((MODULE MODULE) (STREAM NATIVE-OUTPUT-STREAM)))" (CL:FUNCTION HTML-DESCRIBE-MODULE)
     NULL)
    ...
    (DEFINE-FUNCTION-OBJECT "HTML-UNKNOWN-OBJECT-RESPONSE" "(DEFUN HTML-UNKNOWN-OBJECT-RESPONSE ((ITEMTYPE KEYWORD) (ITEMNAME STRING) (STREAM NATIVE-OUTPUT-STREAM)))"
     (CL:FUNCTION HTML-UNKNOWN-OBJECT-RESPONSE) NULL)
    (DEFINE-FUNCTION-OBJECT "HTML-WRITE-RELATION-RESPONSE-PAGE" "(DEFUN HTML-WRITE-RELATION-RESPONSE-PAGE ((RELATION NAMED-DESCRIPTION) (STREAM NATIVE-OUTPUT-STREAM)))"
     (CL:FUNCTION HTML-WRITE-RELATION-RESPONSE-PAGE) NULL)
    (DEFINE-FUNCTION-OBJECT "HTML-WRITE-INSTANCE-RESPONSE-PAGE" "(DEFUN HTML-WRITE-INSTANCE-RESPONSE-PAGE ((INSTANCE LOGIC-OBJECT) (STREAM NATIVE-OUTPUT-STREAM)))"
     (CL:FUNCTION HTML-WRITE-INSTANCE-RESPONSE-PAGE) NULL)
    (DEFINE-FUNCTION-OBJECT "HTML-WRITE-OBJECT-RESPONSE-PAGE-INTERNAL" "(DEFUN HTML-WRITE-OBJECT-RESPONSE-PAGE-INTERNAL ((OBJECT OBJECT) (STREAM NATIVE-OUTPUT-STREAM)))"
     (CL:FUNCTION HTML-WRITE-OBJECT-RESPONSE-PAGE-INTERNAL) NULL)
    (DEFINE-FUNCTION-OBJECT "HTML-WRITE-MODULE-RESPONSE-PAGE-INTERNAL" "(DEFUN HTML-WRITE-MODULE-RESPONSE-PAGE-INTERNAL ((MODULE MODULE) (STREAM NATIVE-OUTPUT-STREAM)))"
     (CL:FUNCTION HTML-WRITE-MODULE-RESPONSE-PAGE-INTERNAL) NULL)
    (DEFINE-FUNCTION-OBJECT "HTML-WRITE-MODULE-RESPONSE-PAGE" "(DEFUN HTML-WRITE-MODULE-RESPONSE-PAGE ((MODULENAME STRING) (STREAM NATIVE-OUTPUT-STREAM)))"
     (CL:FUNCTION HTML-WRITE-MODULE-RESPONSE-PAGE) NULL)
    (DEFINE-FUNCTION-OBJECT "HTML-WRITE-OBJECT-RESPONSE-PAGE"
     "(DEFUN HTML-WRITE-OBJECT-RESPONSE-PAGE ((MODULENAME STRING) (OBJECTNAME STRING) (STREAM NATIVE-OUTPUT-STREAM)))" (CL:FUNCTION HTML-WRITE-OBJECT-RESPONSE-PAGE)
     NULL)
    (DEFINE-FUNCTION-OBJECT "FIND-CANDIDATE-OBJECTS"
     "(DEFUN (FIND-CANDIDATE-OBJECTS (LIST OF LOGIC-OBJECT)) ((OBJECTNAME STRING) (OBJECTTYPE STRING) (MATCHTYPE KEYWORD)))" (CL:FUNCTION FIND-CANDIDATE-OBJECTS) NULL)
    (DEFINE-FUNCTION-OBJECT "RESOLVE-SYNONYMS" "(DEFUN (RESOLVE-SYNONYMS LOGIC-OBJECT) ((OBJ LOGIC-OBJECT)))" (CL:FUNCTION RESOLVE-SYNONYMS) NULL)
    ...
    (DEFINE-FUNCTION-OBJECT "DO-ACTION-HANDLER" "(DEFUN DO-ACTION-HANDLER ((XCHG /HTTP/HTTP-EXCHANGE)))" (CL:FUNCTION DO-ACTION-HANDLER) NULL)
    (DEFINE-FUNCTION-OBJECT "STARTUP-HTML-DESCRIBE-OBJECT" "(DEFUN STARTUP-HTML-DESCRIBE-OBJECT () :PUBLIC? TRUE)" (CL:FUNCTION STARTUP-HTML-DESCRIBE-OBJECT) NULL)
    (CL:LET* ((FUNCTION (LOOKUP-FUNCTION SYM-HTML-DESCRIBE-OBJECT-ONTOSAURUS-STARTUP-HTML-DESCRIBE-OBJECT)))
     (SET-DYNAMIC-SLOT-VALUE (%DYNAMIC-SLOTS FUNCTION) SYM-HTML-DESCRIBE-OBJECT-STELLA-METHOD-STARTUP-CLASSNAME (WRAP-STRING "_StartupHtmlDescribeObject")
      NULL-STRING-WRAPPER)))
   ...
   (CL:WHEN (CURRENT-STARTUP-TIME-PHASE? 9) (%IN-MODULE (COPY-CONS-TREE (WRAP-STRING "ONTOSAURUS")))
    (DEFINE-STELLA-GLOBAL-VARIABLE-FROM-STRINGIFIED-SOURCE "(DEFGLOBAL *IMAGE-URL-RELATION* LOGIC-OBJECT (/PLI/S-GET-RELATION \"IMAGE-URL\" \"PL-USER\" NULL))")
    (DEFINE-STELLA-GLOBAL-VARIABLE-FROM-STRINGIFIED-SOURCE "(DEFGLOBAL *DOCUMENTATION-RELATION* LOGIC-OBJECT (/PLI/S-GET-RELATION \"DOCUMENTATION\" \"PL-USER\" NULL))")
    (PUBLISH-HANDLER "/ploom/ontosaurus/do-action" (CL:FUNCTION DO-ACTION-HANDLER) KWD-HTML-DESCRIBE-OBJECT-CONTENT-TYPE
     (WRAP-STRING (GET-HTTP-MIME-TYPE KWD-HTML-DESCRIBE-OBJECT-HTML NULL)) KWD-HTML-DESCRIBE-OBJECT-DOCUMENTATION
