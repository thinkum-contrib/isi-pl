...
(CL:DECLAIM
 (CL:SPECIAL *STARTUP-TIME-PHASE* *MODULE* EOL NULL-CHARACTER *CONTEXT* NIL *MEMOIZATION-ENABLED?* MEMOIZED-NULL-VALUE
...
(CL:DEFCLASS VIZ-INFO (STANDARD-OBJECT)
  ((STREAM :ALLOCATION :INSTANCE :ACCESSOR %STREAM) (ALLOWED-OBJECTS :ALLOCATION :INSTANCE :ACCESSOR %ALLOWED-OBJECTS)
   (SHOW-RELATIONS? :ALLOCATION :INSTANCE :ACCESSOR %SHOW-RELATIONS?)
   (SHOW-ATTRIBUTES? :ALLOCATION :INSTANCE :ACCESSOR %SHOW-ATTRIBUTES?)
   (SHOW-RULES? :ALLOCATION :INSTANCE :ACCESSOR %SHOW-RULES?) (ADD-TOP? :ALLOCATION :INSTANCE :ACCESSOR %ADD-TOP?)
   (NODE-COLOR :TYPE CL:SIMPLE-STRING :INITFORM STELLA::NULL-STRING :ALLOCATION :INSTANCE :ACCESSOR %NODE-COLOR)
   (RELATION-COLOR :TYPE CL:SIMPLE-STRING :INITFORM STELLA::NULL-STRING :ALLOCATION :INSTANCE :ACCESSOR
    %RELATION-COLOR)
   (RELATION-STYLE :TYPE CL:SIMPLE-STRING :INITFORM STELLA::NULL-STRING :ALLOCATION :INSTANCE :ACCESSOR
    %RELATION-STYLE)
   (FONT-SIZE :TYPE CL:FIXNUM :INITFORM NULL-INTEGER :ALLOCATION :INSTANCE :ACCESSOR %FONT-SIZE))
...
(CL:DEFUN NEW-VIZ-INFO ()
  (CL:LET* ((SELF NULL)) (CL:SETQ SELF (CL:MAKE-INSTANCE (CL:QUOTE VIZ-INFO)))
   (CL:SETF (%FONT-SIZE SELF) *VIZ-FONT-SIZE*) (CL:SETF (%RELATION-STYLE SELF) *VIZ-RELATION-STYLE*)
   (CL:SETF (%RELATION-COLOR SELF) *VIZ-RELATION-COLOR*) (CL:SETF (%NODE-COLOR SELF) *VIZ-NODE-COLOR*)
   (CL:SETF (%ADD-TOP? SELF) *VIZ-ADD-TOP?*) (CL:SETF (%SHOW-RULES? SELF) *VIZ-SHOW-RULES?*)
   (CL:SETF (%SHOW-ATTRIBUTES? SELF) *VIZ-SHOW-ATTRIBUTES?*) (CL:SETF (%SHOW-RELATIONS? SELF) *VIZ-SHOW-RELATIONS?*)
   (CL:SETF (%ALLOWED-OBJECTS SELF) NULL) (CL:SETF (%STREAM SELF) NULL) SELF))
...
(CL:DEFUN ACCESS-VIZ-INFO-SLOT-VALUE (SELF SLOTNAME VALUE SETVALUE?)
  (CL:COND
   ((CL:EQ SLOTNAME SYM-VISUALIZE-STELLA-STREAM)
   ...
   ((CL:EQ SLOTNAME SYM-VISUALIZE-ONTOSAURUS-ALLOWED-OBJECTS)
    (CL:IF SETVALUE? (CL:SETF (%ALLOWED-OBJECTS SELF) VALUE) (CL:SETQ VALUE (%ALLOWED-OBJECTS SELF))))
   ((CL:EQ SLOTNAME SYM-VISUALIZE-ONTOSAURUS-SHOW-RELATIONS?)
    (CL:IF SETVALUE? (CL:SETF (%SHOW-RELATIONS? SELF) (COERCE-WRAPPED-BOOLEAN-TO-BOOLEAN VALUE))
     (CL:SETQ VALUE (CL:IF (%SHOW-RELATIONS? SELF) TRUE-WRAPPER FALSE-WRAPPER))))
   ((CL:EQ SLOTNAME SYM-VISUALIZE-ONTOSAURUS-SHOW-ATTRIBUTES?)
    (CL:IF SETVALUE? (CL:SETF (%SHOW-ATTRIBUTES? SELF) (COERCE-WRAPPED-BOOLEAN-TO-BOOLEAN VALUE))
     (CL:SETQ VALUE (CL:IF (%SHOW-ATTRIBUTES? SELF) TRUE-WRAPPER FALSE-WRAPPER))))
   ((CL:EQ SLOTNAME SYM-VISUALIZE-ONTOSAURUS-SHOW-RULES?)
    (CL:IF SETVALUE? (CL:SETF (%SHOW-RULES? SELF) (COERCE-WRAPPED-BOOLEAN-TO-BOOLEAN VALUE))
     (CL:SETQ VALUE (CL:IF (%SHOW-RULES? SELF) TRUE-WRAPPER FALSE-WRAPPER))))
   ((CL:EQ SLOTNAME SYM-VISUALIZE-ONTOSAURUS-ADD-TOP?)
    (CL:IF SETVALUE? (CL:SETF (%ADD-TOP? SELF) (COERCE-WRAPPED-BOOLEAN-TO-BOOLEAN VALUE))
     (CL:SETQ VALUE (CL:IF (%ADD-TOP? SELF) TRUE-WRAPPER FALSE-WRAPPER))))
   ((CL:EQ SLOTNAME SYM-VISUALIZE-ONTOSAURUS-NODE-COLOR)
    (CL:IF SETVALUE? (CL:SETF (%NODE-COLOR SELF) (%WRAPPER-VALUE VALUE))
     (CL:SETQ VALUE (WRAP-STRING (%NODE-COLOR SELF)))))
   ((CL:EQ SLOTNAME SYM-VISUALIZE-ONTOSAURUS-RELATION-COLOR)
    (CL:IF SETVALUE? (CL:SETF (%RELATION-COLOR SELF) (%WRAPPER-VALUE VALUE))
     (CL:SETQ VALUE (WRAP-STRING (%RELATION-COLOR SELF)))))
   ((CL:EQ SLOTNAME SYM-VISUALIZE-ONTOSAURUS-RELATION-STYLE)
    (CL:IF SETVALUE? (CL:SETF (%RELATION-STYLE SELF) (%WRAPPER-VALUE VALUE))
     (CL:SETQ VALUE (WRAP-STRING (%RELATION-STYLE SELF)))))
   ((CL:EQ SLOTNAME SYM-VISUALIZE-ONTOSAURUS-FONT-SIZE)
    (CL:IF SETVALUE? (CL:SETF (%FONT-SIZE SELF) (%WRAPPER-VALUE VALUE))
     (CL:SETQ VALUE (WRAP-INTEGER (%FONT-SIZE SELF)))))
   (CL:T
...
(CL:DEFUN VIZ-GET-OBJECT-NAME (OBJECT)
  ...
  (CL:LET* ((NAME (OBJECT-NAME-STRING OBJECT))) (CL:DECLARE (CL:TYPE CL:SIMPLE-STRING NAME))
   (CL:WHEN (CL:EQ NAME STELLA::NULL-STRING) (CL:SETQ NAME (STRINGIFY OBJECT))) NAME))

;;; (DEFMETHOD (VIZ-GENERATE-ONTOSAURUS-HANDLE STRING) ...)

(CL:DEFMETHOD VIZ-GENERATE-ONTOSAURUS-HANDLE ((SELF VIZ-INFO) OBJECT)
  (CL:LET* ((URL (NEW-OUTPUT-STRING-STREAM))) (HTML-WRITE-URL (%NATIVE-STREAM URL) "show" OBJECT)
  ...
  (CL:LET* ((MEMO-TABLE-000 NULL) (MEMOIZED-ENTRY-000 NULL) (MEMOIZED-VALUE-000 NULL))
   (CL:WHEN *MEMOIZATION-ENABLED?*
    (CL:SETQ MEMO-TABLE-000
     (%SURROGATE-VALUE SGT-VISUALIZE-ONTOSAURUS-M-VIZ-INFO.VIZ-GET-BINARY-RELATIONS-OF-MEMO-TABLE-000))
    (CL:WHEN (CL:EQ MEMO-TABLE-000 NULL)
     (INITIALIZE-MEMOIZATION-TABLE SGT-VISUALIZE-ONTOSAURUS-M-VIZ-INFO.VIZ-GET-BINARY-RELATIONS-OF-MEMO-TABLE-000
      "(:MAX-VALUES 1000 :TIMESTAMPS (:META-KB-UPDATE))")
     (CL:SETQ MEMO-TABLE-000
      (%SURROGATE-VALUE SGT-VISUALIZE-ONTOSAURUS-M-VIZ-INFO.VIZ-GET-BINARY-RELATIONS-OF-MEMO-TABLE-000)))
    (CL:SETQ MEMOIZED-ENTRY-000
     (LOOKUP-MRU-MEMOIZED-VALUE MEMO-TABLE-000 CONCEPT *CONTEXT* MEMOIZED-NULL-VALUE NULL -1))
    ...
    (CL:T
     (CL:SETQ MEMOIZED-VALUE-000
      (APPLY-CACHED-RETRIEVE (LIST* SYM-VISUALIZE-LOGIC-?RELATION SYM-VISUALIZE-ONTOSAURUS-?DOMAIN NIL)
       (LIST* SYM-VISUALIZE-STELLA-AND
        (LIST* SYM-VISUALIZE-PL-KERNEL-KB-NTH-DOMAIN SYM-VISUALIZE-LOGIC-?RELATION (WRAP-INTEGER 0)
         SYM-VISUALIZE-ONTOSAURUS-?DOMAIN NIL)
        (LIST* SYM-VISUALIZE-ONTOSAURUS-BINARY-RELATION SYM-VISUALIZE-LOGIC-?RELATION NIL) NIL)
       (CONS-LIST NULL CONCEPT)
       (CONS-LIST KWD-VISUALIZE-SINGLETONS? TRUE-WRAPPER KWD-VISUALIZE-INFERENCE-LEVEL KWD-VISUALIZE-SHALLOW)
...
(CL:DEFUN VIZ-DOT-STRING (NAME)
  ...
  (CL:LET* ((BUFFER (MAKE-RAW-MUTABLE-STRING (CL:* (CL:THE CL:FIXNUM (CL:LENGTH NAME)) 2))) (I -1) (SOL? CL:NIL))
   ...
   (CL:LET*
    ((CHAR NULL-CHARACTER) (VECTOR-000 NAME) (INDEX-000 0) (LENGTH-000 (CL:THE CL:FIXNUM (CL:LENGTH VECTOR-000))))
    ...
    (CL:LOOP WHILE (CL:< INDEX-000 LENGTH-000) DO
     ...
     (CL:CASE CHAR
      (#\
       (CL:IF SOL?
        (CL:LET ((SELF BUFFER) (CH #\.) (POSITION (CL:SETQ I (CL:1+ I))))
         (CL:DECLARE (CL:TYPE CL:SIMPLE-STRING SELF) (CL:TYPE CL:FIXNUM POSITION))
         (SETF (CL:SCHAR (CL:THE CL:SIMPLE-STRING SELF) (CL:THE CL:FIXNUM POSITION)) (CL:THE CL:CHARACTER CH)))
        (CL:LET ((SELF BUFFER) (CH CHAR) (POSITION (CL:SETQ I (CL:1+ I))))
         (CL:DECLARE (CL:TYPE CL:SIMPLE-STRING SELF) (CL:TYPE CL:FIXNUM POSITION))
         (SETF (CL:SCHAR (CL:THE CL:SIMPLE-STRING SELF) (CL:THE CL:FIXNUM POSITION)) (CL:THE CL:CHARACTER CH)))))
      ((#\Linefeed #\Return)
       (CL:LET ((SELF BUFFER) (CH #\\) (POSITION (CL:SETQ I (CL:1+ I))))
        (CL:DECLARE (CL:TYPE CL:SIMPLE-STRING SELF) (CL:TYPE CL:FIXNUM POSITION))
        (SETF (CL:SCHAR (CL:THE CL:SIMPLE-STRING SELF) (CL:THE CL:FIXNUM POSITION)) (CL:THE CL:CHARACTER CH)))
       (CL:LET ((SELF BUFFER) (CH #\l) (POSITION (CL:SETQ I (CL:1+ I))))
        (CL:DECLARE (CL:TYPE CL:SIMPLE-STRING SELF) (CL:TYPE CL:FIXNUM POSITION))
        (SETF (CL:SCHAR (CL:THE CL:SIMPLE-STRING SELF) (CL:THE CL:FIXNUM POSITION)) (CL:THE CL:CHARACTER CH)))
       (CL:SETQ SOL? CL:T))
      ((#\" #\{ #\} #\| #\< #\> #\\)
...
(CL:DEFMETHOD VIZ-ALLOWED-OBJECT? ((SELF VIZ-INFO) OBJECT)
  (CL:IF (CL:EQ (%ALLOWED-OBJECTS SELF) NULL) (CL:NOT (VIZ-EXCLUDED-MODULE? SELF (HOME-MODULE OBJECT)))
   (MEMBER? (%ALLOWED-OBJECTS SELF) OBJECT)))

;;; (DEFMETHOD VIZ-ALLOW-OBJECT ...)

(CL:DEFMETHOD VIZ-ALLOW-OBJECT ((SELF VIZ-INFO) OBJECT)
  (CL:LET* ((ALLOWEDOBJECTS (%ALLOWED-OBJECTS SELF)))
   (CL:WHEN (CL:EQ ALLOWEDOBJECTS NULL) (CL:SETQ ALLOWEDOBJECTS (NEW-HASH-SET))
    (CL:SETF (%ALLOWED-OBJECTS SELF) ALLOWEDOBJECTS))
...
(CL:DEFMETHOD VIZ-CONCEPT-TO-DOT-NODE ((SELF VIZ-INFO) CONCEPT MODULE)
  (CL:LET*
   ((STREAM (%STREAM SELF)) (CONCEPTNAME (VIZ-DOT-OBJECT-NAME CONCEPT)) (CONCEPTCOLOR (%NODE-COLOR SELF))
   ...
   (CL:COND
    ((CL:OR (%SHOW-ATTRIBUTES? SELF) (%SHOW-RULES? SELF))
     (%%PRINT-STREAM (%NATIVE-STREAM STREAM) "  \"" CONCEPTNAME "\" [shape=record, style=filled, fillcolor="
      CONCEPTCOLOR ", URL=\"")
     (%%PRINT-STREAM (%NATIVE-STREAM STREAM) CONCEPTURL)
     (%%PRINT-STREAM (%NATIVE-STREAM STREAM) "\", label=\"{" CONCEPTNAME "|")
     (CL:WHEN (%SHOW-ATTRIBUTES? SELF) (VIZ-ADD-CONCEPT-ATTRIBUTES-TO-DOT-NODE SELF CONCEPT MODULE))
     (CL:WHEN (%SHOW-RULES? SELF) (CL:WHEN (%SHOW-ATTRIBUTES? SELF) (%%PRINT-STREAM (%NATIVE-STREAM STREAM) "|"))
      (VIZ-ADD-CONCEPT-RULES-TO-DOT-NODE SELF CONCEPT MODULE))
     (%%PRINT-STREAM (%NATIVE-STREAM STREAM) "}\"]" EOL))
    (CL:T
     (%%PRINT-STREAM (%NATIVE-STREAM STREAM) "  \"" CONCEPTNAME "\" [shape=box, style=filled, fillcolor=" CONCEPTCOLOR
      ", URL=\"" CONCEPTURL "\"]")))))
...
(CL:DEFMETHOD VIZ-ADD-CONCEPT-ATTRIBUTES-TO-DOT-NODE ((SELF VIZ-INFO) CONCEPT MODULE)
  (CL:LET* ((STREAM (%STREAM SELF)) (RANGE NULL))
   (CL:LET* ((*MODULE* MODULE) (*CONTEXT* *MODULE*)) (CL:DECLARE (CL:SPECIAL *MODULE* *CONTEXT*))
    (CL:LET* ((RELATION NULL) (ITER-000 (VIZ-GET-BINARY-RELATIONS-OF SELF CONCEPT)))
     (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-000 NIL)) DO (CL:SETQ RELATION (%%VALUE ITER-000))
      (CL:SETQ RANGE (PLI::GET-RANGE RELATION))
      (%%PRINT-STREAM (%NATIVE-STREAM STREAM) (VIZ-DOT-OBJECT-NAME RELATION) ": " (VIZ-DOT-OBJECT-NAME RANGE) "\\l")
...
(CL:DEFMETHOD VIZ-ADD-CONCEPT-RULES-TO-DOT-NODE ((SELF VIZ-INFO) CONCEPT MODULE)
  (CL:LET* ((STREAM (%STREAM SELF)) (FIRST? CL:T))
   (CL:LET* ((*MODULE* MODULE) (*CONTEXT* *MODULE*)) (CL:DECLARE (CL:SPECIAL *MODULE* *CONTEXT*))
     ...
     (CL:LET* ((RULE NULL) (ITER-000 (PLI::GET-RULES CONCEPT MODULE NULL)))
      (CL:LOOP WHILE (NEXT? ITER-000) DO (CL:SETQ RULE (%VALUE ITER-000))
       (CL:WHEN (CL:NOT (SIMPLE-SUBRELATION-PROPOSITION? RULE))
        (CL:WHEN (CL:NOT FIRST?) (%%PRINT-STREAM (%NATIVE-STREAM STREAM) "\\l")) (CL:SETQ FIRST? CL:NIL)
        (%%PRINT-STREAM (%NATIVE-STREAM STREAM) (VIZ-DOT-STRING (STRINGIFY RULE))))))))))

;;; (DEFMETHOD VIZ-CONCEPT-LINKS-TO-DOT-EDGES ...)

(CL:DEFMETHOD VIZ-CONCEPT-LINKS-TO-DOT-EDGES ((SELF VIZ-INFO) CONCEPT MODULE)
  (CL:LET* ((STREAM (%STREAM SELF)) (COUNT 0)) (CL:DECLARE (CL:TYPE CL:FIXNUM COUNT))
       ...
       (CL:PROGN
        (CL:COND
         ((VIZ-ALLOWED-OBJECT? SELF SUPER)
          (%%PRINT-STREAM (%NATIVE-STREAM STREAM) "  \"" (VIZ-DOT-OBJECT-NAME SUPER) "\" -> \""
           (VIZ-DOT-OBJECT-NAME CONCEPT) "\" [dir=back]" EOL)
          (CL:SETQ COUNT (CL:1+ COUNT)))
         (CL:T
          (%%PRINT-STREAM (%NATIVE-STREAM STREAM) "  \"" (VIZ-DOT-OBJECT-NAME SUPER)
           "\" [shape=box, style=filled, fillcolor=grey,URL=\"" (VIZ-GENERATE-ONTOSAURUS-HANDLE SELF SUPER) "\"]")
          (%%PRINT-STREAM (%NATIVE-STREAM STREAM) "  \"" (VIZ-DOT-OBJECT-NAME SUPER) "\" -> \""
           (VIZ-DOT-OBJECT-NAME CONCEPT) "\" [dir=back]" EOL)
          (CL:SETQ COUNT (CL:1+ COUNT))))))
      (CL:T
       (CL:LET* ((STREAM-000 (NEW-OUTPUT-STRING-STREAM)))
        (%%PRINT-STREAM (%NATIVE-STREAM STREAM-000) "viz-concept-links-to-dot-edges: unhandled super concept: `" SUPER
         "'")
        (CL:ERROR (NEW-STELLA-EXCEPTION (THE-STRING-READER STREAM-000))))))))
   (CL:WHEN (CL:AND (CL:= COUNT 0) (%ADD-TOP? SELF))
    (%%PRINT-STREAM (%NATIVE-STREAM STREAM) "  \"" VIZ-TOP "\" -> \"" (VIZ-DOT-OBJECT-NAME CONCEPT) "\" [dir=back]"
     EOL))
   (CL:WHEN (%SHOW-RELATIONS? SELF)
    (CL:LET* ((RANGE NULL) (RELCOLOR (%RELATION-COLOR SELF)) (RELSTYLE (%RELATION-STYLE SELF)))
     ...
     (CL:LET* ((*MODULE* MODULE) (*CONTEXT* *MODULE*)) (CL:DECLARE (CL:SPECIAL *MODULE* *CONTEXT*))
      (CL:LET* ((RELATION NULL) (ITER-001 (VIZ-GET-BINARY-RELATIONS-OF SELF CONCEPT)))
       (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-001 NIL)) DO (CL:SETQ RELATION (%%VALUE ITER-001))
        (CL:SETQ RANGE (PLI::GET-RANGE RELATION))
        (CL:WHEN (VIZ-ALLOWED-OBJECT? SELF RELATION)
         (%%PRINT-STREAM (%NATIVE-STREAM STREAM) "  \"" (VIZ-DOT-OBJECT-NAME CONCEPT) "\" -> \""
          (VIZ-DOT-OBJECT-NAME RANGE) "\" [label=\"" (VIZ-DOT-OBJECT-NAME RELATION) "\", color=" RELCOLOR ", style="
          RELSTYLE "]" EOL))
...
(CL:DEFMETHOD VIZ-EXPORT-DOT-HEADER ((SELF VIZ-INFO))
  (CL:LET* ((STREAM (%STREAM SELF))) (%%PRINT-STREAM (%NATIVE-STREAM STREAM) "digraph Ontology {" EOL)
   (%%PRINT-STREAM (%NATIVE-STREAM STREAM) "  node [fontname = Arial, fontsize=" (%FONT-SIZE SELF)
    ", shape=box, style=filled, fillcolor=" (%NODE-COLOR SELF) ", height=0.2];" EOL)
   (%%PRINT-STREAM (%NATIVE-STREAM STREAM) "  edge [fontname = Arial, fontsize=" (%FONT-SIZE SELF) "];" EOL)))

;;; (DEFMETHOD VIZ-EXPORT-DOT-TRAILER ...)

(CL:DEFMETHOD VIZ-EXPORT-DOT-TRAILER ((SELF VIZ-INFO))
  (%%PRINT-STREAM (%NATIVE-STREAM (%STREAM SELF)) "}" EOL))
...
(CL:DEFMETHOD VIZ-EXPORT-CONCEPT-TREE ((SELF VIZ-INFO) CONCEPT MODULE)
  (CL:SETF (%NODE-COLOR SELF) "palegreen")
  (VIZ-EXPORT-CONCEPT SELF CONCEPT MODULE)
  (CL:SETF (%NODE-COLOR SELF) "yellow")
  (VIZ-ALLOW-OBJECT SELF CONCEPT)
  (CL:LET* ((SUPER NULL) (ITER-000 (PLI::GET-PROPER-SUPERRELATIONS CONCEPT MODULE NULL)))
   (CL:LOOP WHILE (NEXT? ITER-000) DO (CL:SETQ SUPER (%VALUE ITER-000)) (VIZ-ALLOW-OBJECT SELF SUPER)))
  (CL:LET* ((SUB NULL) (ITER-001 (PLI::GET-PROPER-SUBRELATIONS CONCEPT MODULE NULL)))
   (CL:LOOP WHILE (NEXT? ITER-001) DO (CL:SETQ SUB (%VALUE ITER-001)) (VIZ-ALLOW-OBJECT SELF SUB)))
  (CL:LET* ((SUPER NULL) (ITER-002 (PLI::GET-PROPER-SUPERRELATIONS CONCEPT MODULE NULL)))
   (CL:LOOP WHILE (NEXT? ITER-002) DO (CL:SETQ SUPER (%VALUE ITER-002))
    (CL:COND
     ((SUBTYPE-OF? (SAFE-PRIMARY-TYPE SUPER) SGT-VISUALIZE-LOGIC-LOGIC-OBJECT)
      (CL:PROGN (VIZ-EXPORT-CONCEPT SELF SUPER MODULE)))
     (CL:T
      (CL:LET* ((STREAM-000 (NEW-OUTPUT-STRING-STREAM)))
       (%%PRINT-STREAM (%NATIVE-STREAM STREAM-000) "viz-export-concept-tree: concept not handled: `" SUPER "'")
       (CL:ERROR (NEW-STELLA-EXCEPTION (THE-STRING-READER STREAM-000))))))))
  (CL:LET* ((SUB NULL) (ITER-003 (PLI::GET-PROPER-SUBRELATIONS CONCEPT MODULE NULL)))
   (CL:LOOP WHILE (NEXT? ITER-003) DO (CL:SETQ SUB (%VALUE ITER-003))
    (CL:COND
     ((SUBTYPE-OF? (SAFE-PRIMARY-TYPE SUB) SGT-VISUALIZE-LOGIC-LOGIC-OBJECT)
      (CL:PROGN (VIZ-EXPORT-CONCEPT SELF SUB MODULE)))
     (CL:T
      (CL:LET* ((STREAM-001 (NEW-OUTPUT-STRING-STREAM)))
       (%%PRINT-STREAM (%NATIVE-STREAM STREAM-001) "viz-export-concept-tree: concept not handled: `" SUB "'")
...
(CL:DEFMETHOD VIZ-EXPORT-CONCEPTS ((SELF VIZ-INFO) MODULE)
  (CL:LET*
   ((CONCEPT NULL)
    (ITER-000 (PLI::GET-CONCEPT-INSTANCES (GET-INSTANCE SGT-VISUALIZE-PL-KERNEL-KB-CONCEPT) MODULE NULL)))
   (CL:LOOP WHILE (NEXT? ITER-000) DO (CL:SETQ CONCEPT (%VALUE ITER-000))
    (CL:COND
     ((SUBTYPE-OF? (SAFE-PRIMARY-TYPE CONCEPT) SGT-VISUALIZE-LOGIC-LOGIC-OBJECT)
      (CL:PROGN
       (CL:WHEN (CL:AND (CL:EQ (HOME-MODULE CONCEPT) MODULE) (VIZ-ALLOWED-OBJECT? SELF CONCEPT))
        (VIZ-EXPORT-CONCEPT SELF CONCEPT MODULE))))
     (CL:T
      (CL:LET* ((STREAM-000 (NEW-OUTPUT-STRING-STREAM)))
       (%%PRINT-STREAM (%NATIVE-STREAM STREAM-000) "viz-export-concepts: concept not handled: `" CONCEPT "'")
       (CL:ERROR (NEW-STELLA-EXCEPTION (THE-STRING-READER STREAM-000)))))))))
  ...
  (CL:LET* ((OUT NULL))
   (CL:UNWIND-PROTECT
    (CL:PROGN (CL:SETQ OUT (OPEN-OUTPUT-FILE FILE))
     (CL:LET* ((*MODULE* MODULE) (*CONTEXT* *MODULE*)) (CL:DECLARE (CL:SPECIAL *MODULE* *CONTEXT*))
      (CL:LET* ((SELF-000 (NEW-VIZ-INFO))) (CL:SETF (%SHOW-RELATIONS? SELF-000) CL:T) (CL:SETF (%STREAM SELF-000) OUT)
       (CL:LET* ((INFO SELF-000)) (VIZ-EXPORT-HEADER INFO) (VIZ-EXPORT-MODULE INFO MODULE)
...
(CL:DEFUN VIZ-EXPORT-CONCEPT-TO-FILE (CONCEPT MODULE FILE)
  ...
  (CL:LET* ((OUT NULL))
   (CL:UNWIND-PROTECT
    (CL:PROGN (CL:SETQ OUT (OPEN-OUTPUT-FILE FILE))
     (CL:LET* ((*MODULE* MODULE) (*CONTEXT* *MODULE*)) (CL:DECLARE (CL:SPECIAL *MODULE* *CONTEXT*))
      (CL:LET* ((SELF-000 (NEW-VIZ-INFO))) (CL:SETF (%SHOW-RELATIONS? SELF-000) CL:T)
       (CL:SETF (%SHOW-ATTRIBUTES? SELF-000) CL:T) (CL:SETF (%SHOW-RULES? SELF-000) CL:T)
       (CL:SETF (%STREAM SELF-000) OUT)
       (CL:LET* ((INFO SELF-000)) (VIZ-EXPORT-HEADER INFO) (VIZ-EXPORT-CONCEPT-TREE INFO CONCEPT MODULE)
        (VIZ-EXPORT-TRAILER INFO)))))
    (CL:WHEN (CL:NOT (CL:EQ OUT NULL)) (FREE OUT)))))
...
(CL:DEFUN VIZ-SERVER-EXPORT-OBJECT (OBJECT MODULE)
  (CL:LET* ((MEMO-TABLE-000 NULL) (MEMOIZED-ENTRY-000 NULL) (MEMOIZED-VALUE-000 NULL))
   (CL:WHEN *MEMOIZATION-ENABLED?*
    (CL:SETQ MEMO-TABLE-000 (%SURROGATE-VALUE SGT-VISUALIZE-ONTOSAURUS-F-VIZ-SERVER-EXPORT-OBJECT-MEMO-TABLE-000))
    (CL:WHEN (CL:EQ MEMO-TABLE-000 NULL)
     (INITIALIZE-MEMOIZATION-TABLE SGT-VISUALIZE-ONTOSAURUS-F-VIZ-SERVER-EXPORT-OBJECT-MEMO-TABLE-000
      "(:MAX-VALUES 20 :TIMESTAMPS (:META-KB-UPDATE))")
     (CL:SETQ MEMO-TABLE-000 (%SURROGATE-VALUE SGT-VISUALIZE-ONTOSAURUS-F-VIZ-SERVER-EXPORT-OBJECT-MEMO-TABLE-000)))
...
(CL:DEFUN HELP-VIZ-SERVER-EXPORT-OBJECT (OBJECT MODULE)
  (CL:LET* ((DOTOUT (NEW-OUTPUT-STRING-STREAM)))
   (CL:IF (ISA? OBJECT SGT-VISUALIZE-STELLA-MODULE) (VIZ-SERVER-EXPORT-MODULE OBJECT DOTOUT)
    (VIZ-SERVER-EXPORT-CONCEPT OBJECT MODULE DOTOUT))
   (THE-STRING-READER DOTOUT)))

;;; (DEFUN VIZ-SERVER-HANDLER ...)

(CL:DEFUN VIZ-SERVER-HANDLER (XCHG)
  (CL:WHEN (CL:NOT (VIZ-SERVER-AVAILABLE?))
   (GENERATE-ERROR-RESPONSE XCHG KWD-VISUALIZE-NOT-IMPLEMENTED
    (CONCATENATE "Graphing not supported, program `" *VIZ-DOT-PROGRAM* "' not found"))
   (CL:RETURN-FROM VIZ-SERVER-HANDLER))
  (CL:LET* ((KEYS (PARSE-AND-DECODE-URL-ARGUMENTS (GET-REQUEST-URI-QUERY XCHG) #\+)))
   (CL:WHEN (CL:< (LENGTH KEYS) 4) (DO-ACTION-HANDLER XCHG))
   (CL:LET*
    ((ACTION (%%VALUE KEYS)) (OBJECTTYPE (%%VALUE (%%REST KEYS))) (MODULENAME (%%VALUE (%%REST (%%REST KEYS))))
     (OBJECTNAME (FOURTH KEYS)) (STREAM (GET-REPLY-STREAM XCHG))
     (MODULE (PLI::GET-MODULE (%WRAPPER-VALUE MODULENAME) NULL)) (VISUALIZEDOBJECT NULL)
     (GENERATEMAP? (CL:AND *VIZ-SERVER-IMAGE-MAPS-ENABLED?* (EQL-TO-STRING? ACTION "graph"))))
    (CL:WHEN (CL:EQ MODULE NULL)
     (HTML-UNKNOWN-OBJECT-RESPONSE KWD-VISUALIZE-CONTEXT (%WRAPPER-VALUE MODULENAME) STREAM)
     (CL:RETURN-FROM VIZ-SERVER-HANDLER))
    (CL:LET* ((TEST-VALUE-000 (%WRAPPER-VALUE OBJECTTYPE))) (CL:DECLARE (CL:TYPE CL:SIMPLE-STRING TEST-VALUE-000))
     (CL:COND ((STRING-EQL? TEST-VALUE-000 "context") (CL:SETQ VISUALIZEDOBJECT MODULE))
      ((CL:OR (STRING-EQL? TEST-VALUE-000 "relation") (STRING-EQL? TEST-VALUE-000 "concept"))
       (CL:SETQ VISUALIZEDOBJECT (PLI::GET-RELATION (%WRAPPER-VALUE OBJECTNAME) MODULE NULL)))
      (CL:T
       (GENERATE-ERROR-RESPONSE XCHG KWD-VISUALIZE-BAD-REQUEST
        (CONCATENATE "Malformed URL, graph of type `" (%WRAPPER-VALUE OBJECTTYPE) "' is not supported."))
       (CL:RETURN-FROM VIZ-SERVER-HANDLER))))
    (CL:WHEN (CL:EQ VISUALIZEDOBJECT NULL)
     (HTML-UNKNOWN-OBJECT-RESPONSE (CL:IF (CL:EQ MODULE NULL) KWD-VISUALIZE-CONTEXT KWD-VISUALIZE-RELATION)
      (CL:IF (CL:EQ MODULE NULL) (%WRAPPER-VALUE MODULENAME) (%WRAPPER-VALUE OBJECTNAME)) STREAM)
     (CL:RETURN-FROM VIZ-SERVER-HANDLER))
    (CL:IF GENERATEMAP? (VIZ-SERVER-SERVE-IMAGE-PLUS-MAP XCHG VISUALIZEDOBJECT MODULE)
...
(CL:DEFUN VIZ-SERVER-SERVE-IMAGE (XCHG OBJECT MODULE)
  (CL:LET* ((STREAM (GET-REPLY-STREAM XCHG)) (DOTCOMMANDS (VIZ-SERVER-EXPORT-OBJECT OBJECT MODULE)) (DOTEXIT 0))
   ...
   (CL:WHEN (BLANK-STRING? DOTCOMMANDS) (GENERATE-ERROR-RESPONSE XCHG KWD-VISUALIZE-BAD-REQUEST "Nothing to graph")
    (CL:RETURN-FROM VIZ-SERVER-SERVE-IMAGE))
   (SET-REPLY-HEADER-VALUE XCHG KWD-VISUALIZE-CONTENT-TYPE (GET-HTTP-MIME-TYPE KWD-VISUALIZE-IMAGE-GIF NULL))
   (CL:LET* ((SELF-001 (NEW-OUTPUT-STREAM))) (CL:SETF (%NATIVE-STREAM SELF-001) STREAM)
    (CL:SETQ DOTEXIT
     (EXECUTE-SHELL-COMMAND (CONS (WRAP-STRING *VIZ-DOT-PROGRAM*) (CONS (WRAP-STRING "-Tgif") NIL)) "."
      (NEW-INPUT-STRING-STREAM DOTCOMMANDS) SELF-001 NULL)))
   (CL:WHEN (CL:NOT (CL:= DOTEXIT 0))
    (GENERATE-ERROR-RESPONSE XCHG KWD-VISUALIZE-INTERNAL-ERROR "Problem running `dot'") NULL)))

;;; (DEFUN VIZ-SERVER-SERVE-IMAGE-PLUS-MAP ...)

(CL:DEFUN VIZ-SERVER-SERVE-IMAGE-PLUS-MAP (XCHG OBJECT MODULE)
  (CL:LET*
   ((URI (UNESCAPE-URL-STRING (GET-REQUEST-URI XCHG))) (STREAM (GET-REPLY-STREAM XCHG))
    (DOTCOMMANDS (VIZ-SERVER-EXPORT-OBJECT OBJECT MODULE)) (IMAGEMAP STELLA::NULL-STRING))
   (CL:DECLARE (CL:TYPE CL:SIMPLE-STRING URI DOTCOMMANDS IMAGEMAP))
   (CL:WHEN (BLANK-STRING? DOTCOMMANDS) (GENERATE-ERROR-RESPONSE XCHG KWD-VISUALIZE-BAD-REQUEST "Nothing to graph")
    (CL:RETURN-FROM VIZ-SERVER-SERVE-IMAGE-PLUS-MAP))
   (CL:HANDLER-CASE
    (CL:SETQ IMAGEMAP
     (%WRAPPER-VALUE
      (%SHELL-COMMAND (CONS (WRAP-STRING *VIZ-DOT-PROGRAM*) (CONS (WRAP-STRING "-Tcmap") NIL))
       (CONS-LIST KWD-VISUALIZE-INPUT (WRAP-STRING DOTCOMMANDS)))))
    (STELLA-EXCEPTION (E) (GENERATE-ERROR-RESPONSE XCHG KWD-VISUALIZE-INTERNAL-ERROR (EXCEPTION-MESSAGE E))
     (CL:RETURN-FROM VIZ-SERVER-SERVE-IMAGE-PLUS-MAP)))
   ...
   (CL:PROGN (%%PRINT-STREAM STREAM "<HTML>")
    (CL:PROGN (%%PRINT-STREAM STREAM "<HEAD>") (%%PRINT-STREAM STREAM "<TITLE>PowerLoom Graph</TITLE>" EOL)
     (%%PRINT-STREAM STREAM "<BASE TARGET='content'>" EOL) (%%PRINT-STREAM STREAM "</HEAD>" EOL))
    (CL:PROGN (%%PRINT-STREAM STREAM "<BODY>")
     (CL:PROGN (%%PRINT-STREAM STREAM "<MAP NAME='ontomap'>") (%%PRINT-STREAM STREAM IMAGEMAP)
      (%%PRINT-STREAM STREAM "</MAP>" EOL))
     (%%PRINT-STREAM STREAM "<IMG SRC='" (REPLACE-SUBSTRINGS URI "/do-action?graph-bare+" "/do-action?graph+")
...
(CL:DEFUN HELP-STARTUP-VISUALIZE1 ()
  (CL:PROGN (CL:SETQ SGT-VISUALIZE-ONTOSAURUS-VIZ-INFO (INTERN-RIGID-SYMBOL-WRT-MODULE "VIZ-INFO" NULL 1))
   ...
   (CL:SETQ SYM-VISUALIZE-LOGIC-?RELATION
    (INTERN-RIGID-SYMBOL-WRT-MODULE "?RELATION" (GET-STELLA-MODULE "/LOGIC" CL:T) 0))
   ...
   (CL:SETQ SYM-VISUALIZE-PL-KERNEL-KB-NTH-DOMAIN
   ...
   (CL:SETQ SGT-VISUALIZE-ONTOSAURUS-F-VIZ-SERVER-EXPORT-OBJECT-MEMO-TABLE-000
    (INTERN-RIGID-SYMBOL-WRT-MODULE "F-VIZ-SERVER-EXPORT-OBJECT-MEMO-TABLE-000" NULL 1))
   ...
   (CL:SETQ KWD-VISUALIZE-INPUT (INTERN-RIGID-SYMBOL-WRT-MODULE "INPUT" NULL 2))
   (CL:SETQ KWD-VISUALIZE-HTML (INTERN-RIGID-SYMBOL-WRT-MODULE "HTML" NULL 2))
   (CL:SETQ SYM-VISUALIZE-ONTOSAURUS-STARTUP-VISUALIZE (INTERN-RIGID-SYMBOL-WRT-MODULE "STARTUP-VISUALIZE" NULL 0))
   (CL:SETQ SYM-VISUALIZE-STELLA-METHOD-STARTUP-CLASSNAME
...
(CL:DEFUN STARTUP-VISUALIZE ()
  (CL:LET* ((*MODULE* (GET-STELLA-MODULE "/ONTOSAURUS" (> *STARTUP-TIME-PHASE* 1))) (*CONTEXT* *MODULE*))
   (CL:DECLARE (CL:SPECIAL *MODULE* *CONTEXT*)) (CL:WHEN (CURRENT-STARTUP-TIME-PHASE? 2) (HELP-STARTUP-VISUALIZE1))
   (CL:WHEN (CURRENT-STARTUP-TIME-PHASE? 4) (CL:SETQ *VIZ-EXCLUDED-MODULES* (LIST)))
...
visualize a set of concepts as a graph.\" :SLOTS ((STREAM :TYPE OUTPUT-STREAM) (ALLOWED-OBJECTS :TYPE HASH-SET) (SHOW-RELATIONS? :TYPE BOOLEAN :INITIALLY *VIZ-SHOW-RELATIONS?*) (SHOW-ATTRIBUTES? :TYPE BOOLEAN :INITIALLY *VIZ-SHOW-ATTRIBUTES?*) (SHOW-RULES? :TYPE BOOLEAN :INITIALLY *VIZ-SHOW-RULES?*) (ADD-TOP? :TYPE BOOLEAN :INITIALLY *VIZ-ADD-TOP?*) (NODE-COLOR :TYPE STRING :INITIALLY *VIZ-NODE-COLOR*) (RELATION-COLOR :TYPE STRING :INITIALLY *VIZ-RELATION-COLOR*) (RELATION-STYLE :TYPE STRING :INITIALLY *VIZ-RELATION-STYLE*) (FONT-SIZE :TYPE INTEGER :INITIALLY *VIZ-FONT-SIZE*)))")))
     (CL:SETF (%CLASS-CONSTRUCTOR-CODE CLASS) (CL:FUNCTION NEW-VIZ-INFO))
     (CL:SETF (%CLASS-SLOT-ACCESSOR-CODE CLASS) (CL:FUNCTION ACCESS-VIZ-INFO-SLOT-VALUE))))
   (CL:WHEN (CURRENT-STARTUP-TIME-PHASE? 6) (FINALIZE-CLASSES))
   (CL:WHEN (CURRENT-STARTUP-TIME-PHASE? 7)
    (DEFINE-FUNCTION-OBJECT "VIZ-GET-OBJECT-NAME" "(DEFUN (VIZ-GET-OBJECT-NAME STRING) ((OBJECT OBJECT)))"
     (CL:FUNCTION VIZ-GET-OBJECT-NAME) NULL)
    (DEFINE-METHOD-OBJECT
     "(DEFMETHOD (VIZ-GENERATE-ONTOSAURUS-HANDLE STRING) ((SELF VIZ-INFO) (OBJECT STANDARD-OBJECT)))"
     (CL:FUNCTION VIZ-GENERATE-ONTOSAURUS-HANDLE) NULL)
    (DEFINE-METHOD-OBJECT
    ...
    (DEFINE-FUNCTION-OBJECT "VIZ-DOT-STRING" "(DEFUN (VIZ-DOT-STRING STRING) ((NAME STRING)))"
     (CL:FUNCTION VIZ-DOT-STRING) NULL)
    (DEFINE-FUNCTION-OBJECT "VIZ-DOT-OBJECT-NAME" "(DEFUN (VIZ-DOT-OBJECT-NAME STRING) ((OBJECT OBJECT)))"
     (CL:FUNCTION VIZ-DOT-OBJECT-NAME) NULL)
    (DEFINE-METHOD-OBJECT "(DEFMETHOD (VIZ-EXCLUDED-MODULE? BOOLEAN) ((SELF VIZ-INFO) (MODULE MODULE)))"
     (CL:FUNCTION VIZ-EXCLUDED-MODULE?) NULL)
    (DEFINE-METHOD-OBJECT "(DEFMETHOD (VIZ-ALLOWED-OBJECT? BOOLEAN) ((SELF VIZ-INFO) (OBJECT OBJECT)))"
     (CL:FUNCTION VIZ-ALLOWED-OBJECT?) NULL)
    (DEFINE-METHOD-OBJECT "(DEFMETHOD VIZ-ALLOW-OBJECT ((SELF VIZ-INFO) (OBJECT OBJECT)))"
     (CL:FUNCTION VIZ-ALLOW-OBJECT) NULL)
    (DEFINE-METHOD-OBJECT "(DEFMETHOD VIZ-EXCLUDE-OBJECT ((SELF VIZ-INFO) (OBJECT OBJECT)))"
     (CL:FUNCTION VIZ-EXCLUDE-OBJECT) NULL)
    (DEFINE-METHOD-OBJECT
     "(DEFMETHOD VIZ-CONCEPT-TO-DOT-NODE ((SELF VIZ-INFO) (CONCEPT LOGIC-OBJECT) (MODULE MODULE)))"
     (CL:FUNCTION VIZ-CONCEPT-TO-DOT-NODE) NULL)
    (DEFINE-METHOD-OBJECT
     "(DEFMETHOD VIZ-ADD-CONCEPT-ATTRIBUTES-TO-DOT-NODE ((SELF VIZ-INFO) (CONCEPT LOGIC-OBJECT) (MODULE MODULE)))"
     (CL:FUNCTION VIZ-ADD-CONCEPT-ATTRIBUTES-TO-DOT-NODE) NULL)
    (DEFINE-METHOD-OBJECT
     "(DEFMETHOD VIZ-ADD-CONCEPT-RULES-TO-DOT-NODE ((SELF VIZ-INFO) (CONCEPT LOGIC-OBJECT) (MODULE MODULE)))"
    ...
    (DEFINE-METHOD-OBJECT
     ...
     (CL:FUNCTION VIZ-EXPORT-CONCEPT-TO-DOT) NULL)
    (DEFINE-METHOD-OBJECT "(DEFMETHOD VIZ-EXPORT-DOT-HEADER ((SELF VIZ-INFO)))" (CL:FUNCTION VIZ-EXPORT-DOT-HEADER)
     NULL)
    (DEFINE-METHOD-OBJECT "(DEFMETHOD VIZ-EXPORT-DOT-TRAILER ((SELF VIZ-INFO)))" (CL:FUNCTION VIZ-EXPORT-DOT-TRAILER)
     NULL)
    (DEFINE-METHOD-OBJECT "(DEFMETHOD VIZ-EXPORT-CONCEPT ((SELF VIZ-INFO) (CONCEPT LOGIC-OBJECT) (MODULE MODULE)))"
     (CL:FUNCTION VIZ-EXPORT-CONCEPT) NULL)
    (DEFINE-METHOD-OBJECT
     "(DEFMETHOD VIZ-EXPORT-CONCEPT-TREE ((SELF VIZ-INFO) (CONCEPT LOGIC-OBJECT) (MODULE MODULE)))"
     (CL:FUNCTION VIZ-EXPORT-CONCEPT-TREE) NULL)
    (DEFINE-METHOD-OBJECT "(DEFMETHOD VIZ-EXPORT-CONCEPTS ((SELF VIZ-INFO) (MODULE MODULE)))"
     (CL:FUNCTION VIZ-EXPORT-CONCEPTS) NULL)
    (DEFINE-METHOD-OBJECT "(DEFMETHOD VIZ-EXPORT-MODULE ((SELF VIZ-INFO) (MODULE MODULE)))"
     (CL:FUNCTION VIZ-EXPORT-MODULE) NULL)
    ...
    (DEFINE-FUNCTION-OBJECT "VIZ-EXPORT-MODULE-TO-FILE"
     "(DEFUN VIZ-EXPORT-MODULE-TO-FILE ((MODULE MODULE) (FILE STRING)))" (CL:FUNCTION VIZ-EXPORT-MODULE-TO-FILE) NULL)
    (DEFINE-FUNCTION-OBJECT "VIZ-EXPORT-CONCEPT-TO-FILE"
    ...
    (DEFINE-FUNCTION-OBJECT "VIZ-SERVER-AVAILABLE?" "(DEFUN (VIZ-SERVER-AVAILABLE? BOOLEAN) ())"
     (CL:FUNCTION VIZ-SERVER-AVAILABLE?) NULL)
    (DEFINE-FUNCTION-OBJECT "VIZ-SERVER-EXPORT-MODULE"
     "(DEFUN VIZ-SERVER-EXPORT-MODULE ((MODULE MODULE) (OUT OUTPUT-STREAM)))" (CL:FUNCTION VIZ-SERVER-EXPORT-MODULE)
     NULL)
    (DEFINE-FUNCTION-OBJECT "VIZ-SERVER-EXPORT-CONCEPT"
    ...
    (DEFINE-FUNCTION-OBJECT "STARTUP-VISUALIZE" "(DEFUN STARTUP-VISUALIZE () :PUBLIC? TRUE)"
     (CL:FUNCTION STARTUP-VISUALIZE) NULL)
    (CL:LET* ((FUNCTION (LOOKUP-FUNCTION SYM-VISUALIZE-ONTOSAURUS-STARTUP-VISUALIZE)))
     (SET-DYNAMIC-SLOT-VALUE (%DYNAMIC-SLOTS FUNCTION) SYM-VISUALIZE-STELLA-METHOD-STARTUP-CLASSNAME
      (WRAP-STRING "_StartupVisualize") NULL-STRING-WRAPPER)))
...
clickable image map.\" :PUBLIC? TRUE)")
    (CL:HANDLER-CASE (%SHELL-COMMAND (CONS (WRAP-STRING *VIZ-DOT-PROGRAM*) (CONS (WRAP-STRING "-V") NIL)) NIL)
     (STELLA-EXCEPTION (E)
      (CL:WHEN (CL:= (STRING-SEARCH (STRING-DOWNCASE (EXCEPTION-MESSAGE E)) "graphviz" NULL-INTEGER) NULL-INTEGER)
       (CL:SETQ *VIZ-SERVER-ENABLED?* CL:NIL)))))))
