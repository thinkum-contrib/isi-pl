...
(CL:DECLAIM
 (CL:SPECIAL *STARTUP-TIME-PHASE* *MODULE* EOL NULL-CHARACTER *CONTEXT*
  NIL *MEMOIZATION-ENABLED?* MEMOIZED-NULL-VALUE TRUE-WRAPPER
  FALSE-WRAPPER NULL-INTEGER))
...
(CL:DEFCLASS VIZ-INFO (STANDARD-OBJECT)
  ((STREAM :ALLOCATION :INSTANCE :ACCESSOR %STREAM)
   ...
   (FONT-SIZE :TYPE CL:FIXNUM :INITFORM NULL-INTEGER :ALLOCATION
    :INSTANCE :ACCESSOR %FONT-SIZE))
  (:DOCUMENTATION
...
(CL:DEFUN NEW-VIZ-INFO ()
  (CL:LET* ((SELF NULL))
   (CL:SETQ SELF (CL:MAKE-INSTANCE (CL:QUOTE VIZ-INFO)))
   ...
   (CL:SETF (%ALLOWED-OBJECTS SELF) NULL) (CL:SETF (%STREAM SELF) NULL)
   SELF))
...
(CL:DEFMETHOD VIZ-GENERATE-ONTOSAURUS-HANDLE ((SELF VIZ-INFO) OBJECT)
  (CL:LET* ((URL (NEW-OUTPUT-STRING-STREAM)))
   (HTML-WRITE-URL (%NATIVE-STREAM URL) "show" OBJECT)
    ...
    (CL:T
     (CL:SETQ MEMOIZED-VALUE-000
      (APPLY-CACHED-RETRIEVE
       (LIST* SYM-VISUALIZE-LOGIC-?RELATION
  ...
  (CL:LET*
   ((BUFFER
     (MAKE-RAW-MUTABLE-STRING
      (CL:* (CL:THE CL:FIXNUM (CL:LENGTH NAME)) 2)))
    (I -1) (SOL? CL:NIL))
    ...
    (CL:LOOP WHILE (CL:< INDEX-000 LENGTH-000) DO
     ...
     (CL:CASE CHAR
      (#\
       (CL:IF SOL?
        (CL:LET
         ((SELF BUFFER) (CH #\.) (POSITION (CL:SETQ I (CL:1+ I))))
         (CL:DECLARE (CL:TYPE CL:SIMPLE-STRING SELF)
          (CL:TYPE CL:FIXNUM POSITION))
         (SETF
          (CL:SCHAR (CL:THE CL:SIMPLE-STRING SELF)
        ...
        (CL:LET
         ((SELF BUFFER) (CH CHAR) (POSITION (CL:SETQ I (CL:1+ I))))
         (CL:DECLARE (CL:TYPE CL:SIMPLE-STRING SELF)
          (CL:TYPE CL:FIXNUM POSITION))
         (SETF
          (CL:SCHAR (CL:THE CL:SIMPLE-STRING SELF)
      ...
      ((#\Linefeed #\Return)
       (CL:LET
        ...
        (SETF
         ...
         (CL:THE CL:CHARACTER CH)))
       (CL:LET
        ((SELF BUFFER) (CH #\l) (POSITION (CL:SETQ I (CL:1+ I))))
        (CL:DECLARE (CL:TYPE CL:SIMPLE-STRING SELF)
         (CL:TYPE CL:FIXNUM POSITION))
        (SETF
         (CL:SCHAR (CL:THE CL:SIMPLE-STRING SELF)
...
(CL:DEFMETHOD VIZ-CONCEPT-TO-DOT-NODE ((SELF VIZ-INFO) CONCEPT MODULE)
  (CL:LET*
   ...
   (CL:DECLARE
    (CL:TYPE CL:SIMPLE-STRING CONCEPTNAME CONCEPTCOLOR CONCEPTURL))
   (CL:COND
    ((CL:OR (%SHOW-ATTRIBUTES? SELF) (%SHOW-RULES? SELF))
     (%%PRINT-STREAM (%NATIVE-STREAM STREAM) "  \"" CONCEPTNAME
      "\" [shape=record, style=filled, fillcolor=" CONCEPTCOLOR
      ", URL=\"")
...
(CL:DEFMETHOD VIZ-ADD-CONCEPT-ATTRIBUTES-TO-DOT-NODE ((SELF VIZ-INFO) CONCEPT MODULE)
  (CL:LET* ((STREAM (%STREAM SELF)) (RANGE NULL))
   (CL:LET* ((*MODULE* MODULE) (*CONTEXT* *MODULE*))
    ...
    (CL:LET*
     ((RELATION NULL)
      (ITER-000 (VIZ-GET-BINARY-RELATIONS-OF SELF CONCEPT)))
     (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-000 NIL)) DO
      (CL:SETQ RELATION (%%VALUE ITER-000))
      (CL:SETQ RANGE (PLI::GET-RANGE RELATION))
      (%%PRINT-STREAM (%NATIVE-STREAM STREAM)
       (VIZ-DOT-OBJECT-NAME RELATION) ": " (VIZ-DOT-OBJECT-NAME RANGE)
       "\\l")
  ...
  (CL:LET* ((STREAM (%STREAM SELF)) (FIRST? CL:T))
   (CL:LET* ((*MODULE* MODULE) (*CONTEXT* *MODULE*))
    ...
    (CL:LET* ((*PRETTYPRINTLOGICALFORMS?* CL:T))
     ...
     (CL:LET*
      ((RULE NULL) (ITER-000 (PLI::GET-RULES CONCEPT MODULE NULL)))
   ...
   (CL:WHEN (%SHOW-RELATIONS? SELF)
    (CL:LET*
     ...
     (CL:LET* ((*MODULE* MODULE) (*CONTEXT* *MODULE*))
      ...
      (CL:LET*
       ((RELATION NULL)
        (ITER-001 (VIZ-GET-BINARY-RELATIONS-OF SELF CONCEPT)))
       (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-001 NIL)) DO
        ...
        (CL:WHEN (VIZ-ALLOWED-OBJECT? SELF RELATION)
         (%%PRINT-STREAM (%NATIVE-STREAM STREAM) "  \""
          ...
          (VIZ-DOT-OBJECT-NAME RANGE) "\" [label=\""
          (VIZ-DOT-OBJECT-NAME RELATION) "\", color=" RELCOLOR
          ", style=" RELSTYLE "]" EOL))
...
(CL:DEFMETHOD VIZ-EXPORT-CONCEPT-TREE ((SELF VIZ-INFO) CONCEPT MODULE)
  ...
  (CL:LET*
   ((SUB NULL)
    (ITER-001 (PLI::GET-PROPER-SUBRELATIONS CONCEPT MODULE NULL)))
  ...
  (CL:LET*
   ((SUB NULL)
    (ITER-003 (PLI::GET-PROPER-SUBRELATIONS CONCEPT MODULE NULL)))
    ...
    (CL:PROGN (CL:SETQ OUT (OPEN-OUTPUT-FILE FILE))
     (CL:LET* ((*MODULE* MODULE) (*CONTEXT* *MODULE*))
      ...
      (CL:LET* ((SELF-000 (NEW-VIZ-INFO)))
       ...
       (CL:SETF (%SHOW-RULES? SELF-000) CL:T)
       (CL:SETF (%STREAM SELF-000) OUT)
       (CL:LET* ((INFO SELF-000)) (VIZ-EXPORT-HEADER INFO)
   ...
   (CL:LET*
    ...
    (CL:WHEN (CL:EQ VISUALIZEDOBJECT NULL)
     (HTML-UNKNOWN-OBJECT-RESPONSE
      (CL:IF (CL:EQ MODULE NULL) KWD-VISUALIZE-CONTEXT
       KWD-VISUALIZE-RELATION)
   ...
   (CL:PROGN (%%PRINT-STREAM STREAM "<HTML>")
    ...
    (CL:PROGN (%%PRINT-STREAM STREAM "<BODY>")
     ...
     (%%PRINT-STREAM STREAM "<IMG SRC='"
      (REPLACE-SUBSTRINGS URI "/do-action?graph-bare+"
       "/do-action?graph+")
...
visualize a set of concepts as a graph.\" :SLOTS ((STREAM :TYPE OUTPUT-STREAM) (ALLOWED-OBJECTS :TYPE HASH-SET) (SHOW-RELATIONS? :TYPE BOOLEAN :INITIALLY *VIZ-SHOW-RELATIONS?*) (SHOW-ATTRIBUTES? :TYPE BOOLEAN :INITIALLY *VIZ-SHOW-ATTRIBUTES?*) (SHOW-RULES? :TYPE BOOLEAN :INITIALLY *VIZ-SHOW-RULES?*) (ADD-TOP? :TYPE BOOLEAN :INITIALLY *VIZ-ADD-TOP?*) (NODE-COLOR :TYPE STRING :INITIALLY *VIZ-NODE-COLOR*) (RELATION-COLOR :TYPE STRING :INITIALLY *VIZ-RELATION-COLOR*) (RELATION-STYLE :TYPE STRING :INITIALLY *VIZ-RELATION-STYLE*) (FONT-SIZE :TYPE INTEGER :INITIALLY *VIZ-FONT-SIZE*)))")))
   ...
   (CL:WHEN (CURRENT-STARTUP-TIME-PHASE? 7)
    ...
    (CL:LET*
     ((FUNCTION
       (LOOKUP-FUNCTION SYM-VISUALIZE-ONTOSAURUS-STARTUP-VISUALIZE)))
...
clickable image map.\" :PUBLIC? TRUE)")
    (CL:HANDLER-CASE
     (%SHELL-COMMAND
      (CONS (WRAP-STRING *VIZ-DOT-PROGRAM*)
       (CONS (WRAP-STRING "-V") NIL))
      NIL)
     (STELLA-EXCEPTION (E)
      (CL:WHEN
       (CL:=
        (STRING-SEARCH (STRING-DOWNCASE (EXCEPTION-MESSAGE E))
         "graphviz" NULL-INTEGER)
        NULL-INTEGER)
