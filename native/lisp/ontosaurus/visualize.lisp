...
(CL:DECLAIM
 (CL:SPECIAL *STARTUP-TIME-PHASE* *MODULE* EOL NULL-CHARACTER *CONTEXT* NIL *MEMOIZATION-ENABLED?* MEMOIZED-NULL-VALUE TRUE-WRAPPER FALSE-WRAPPER NULL-INTEGER))
...
(CL:DEFCLASS VIZ-INFO (STANDARD-OBJECT)
  ((STREAM :ALLOCATION :INSTANCE :ACCESSOR %STREAM) (ALLOWED-OBJECTS :ALLOCATION :INSTANCE :ACCESSOR %ALLOWED-OBJECTS)
   (SHOW-RELATIONS? :ALLOCATION :INSTANCE :ACCESSOR %SHOW-RELATIONS?) (SHOW-ATTRIBUTES? :ALLOCATION :INSTANCE :ACCESSOR %SHOW-ATTRIBUTES?)
   ...
   (RELATION-COLOR :TYPE CL:SIMPLE-STRING :INITFORM STELLA::NULL-STRING :ALLOCATION :INSTANCE :ACCESSOR %RELATION-COLOR)
   (RELATION-STYLE :TYPE CL:SIMPLE-STRING :INITFORM STELLA::NULL-STRING :ALLOCATION :INSTANCE :ACCESSOR %RELATION-STYLE)
...
(CL:DEFUN NEW-VIZ-INFO ()
  (CL:LET* ((SELF NULL)) (CL:SETQ SELF (CL:MAKE-INSTANCE (CL:QUOTE VIZ-INFO))) (CL:SETF (%FONT-SIZE SELF) *VIZ-FONT-SIZE*)
   (CL:SETF (%RELATION-STYLE SELF) *VIZ-RELATION-STYLE*) (CL:SETF (%RELATION-COLOR SELF) *VIZ-RELATION-COLOR*) (CL:SETF (%NODE-COLOR SELF) *VIZ-NODE-COLOR*)
   (CL:SETF (%ADD-TOP? SELF) *VIZ-ADD-TOP?*) (CL:SETF (%SHOW-RULES? SELF) *VIZ-SHOW-RULES?*) (CL:SETF (%SHOW-ATTRIBUTES? SELF) *VIZ-SHOW-ATTRIBUTES?*)
   (CL:SETF (%SHOW-RELATIONS? SELF) *VIZ-SHOW-RELATIONS?*) (CL:SETF (%ALLOWED-OBJECTS SELF) NULL) (CL:SETF (%STREAM SELF) NULL) SELF))
...
(CL:DEFUN ACCESS-VIZ-INFO-SLOT-VALUE (SELF SLOTNAME VALUE SETVALUE?)
  (CL:COND ((CL:EQ SLOTNAME SYM-VISUALIZE-STELLA-STREAM) (CL:IF SETVALUE? (CL:SETF (%STREAM SELF) VALUE) (CL:SETQ VALUE (%STREAM SELF))))
   ((CL:EQ SLOTNAME SYM-VISUALIZE-ONTOSAURUS-ALLOWED-OBJECTS) (CL:IF SETVALUE? (CL:SETF (%ALLOWED-OBJECTS SELF) VALUE) (CL:SETQ VALUE (%ALLOWED-OBJECTS SELF))))
   ...
   ((CL:EQ SLOTNAME SYM-VISUALIZE-ONTOSAURUS-SHOW-RULES?)
    (CL:IF SETVALUE? (CL:SETF (%SHOW-RULES? SELF) (COERCE-WRAPPED-BOOLEAN-TO-BOOLEAN VALUE)) (CL:SETQ VALUE (CL:IF (%SHOW-RULES? SELF) TRUE-WRAPPER FALSE-WRAPPER))))
   ((CL:EQ SLOTNAME SYM-VISUALIZE-ONTOSAURUS-ADD-TOP?)
    (CL:IF SETVALUE? (CL:SETF (%ADD-TOP? SELF) (COERCE-WRAPPED-BOOLEAN-TO-BOOLEAN VALUE)) (CL:SETQ VALUE (CL:IF (%ADD-TOP? SELF) TRUE-WRAPPER FALSE-WRAPPER))))
   ((CL:EQ SLOTNAME SYM-VISUALIZE-ONTOSAURUS-NODE-COLOR)
    (CL:IF SETVALUE? (CL:SETF (%NODE-COLOR SELF) (%WRAPPER-VALUE VALUE)) (CL:SETQ VALUE (WRAP-STRING (%NODE-COLOR SELF)))))
   ((CL:EQ SLOTNAME SYM-VISUALIZE-ONTOSAURUS-RELATION-COLOR)
    (CL:IF SETVALUE? (CL:SETF (%RELATION-COLOR SELF) (%WRAPPER-VALUE VALUE)) (CL:SETQ VALUE (WRAP-STRING (%RELATION-COLOR SELF)))))
   ((CL:EQ SLOTNAME SYM-VISUALIZE-ONTOSAURUS-RELATION-STYLE)
    (CL:IF SETVALUE? (CL:SETF (%RELATION-STYLE SELF) (%WRAPPER-VALUE VALUE)) (CL:SETQ VALUE (WRAP-STRING (%RELATION-STYLE SELF)))))
   ((CL:EQ SLOTNAME SYM-VISUALIZE-ONTOSAURUS-FONT-SIZE)
    (CL:IF SETVALUE? (CL:SETF (%FONT-SIZE SELF) (%WRAPPER-VALUE VALUE)) (CL:SETQ VALUE (WRAP-INTEGER (%FONT-SIZE SELF)))))
   (CL:T
...
(CL:DEFMETHOD VIZ-GENERATE-ONTOSAURUS-HANDLE ((SELF VIZ-INFO) OBJECT)
  (CL:LET* ((URL (NEW-OUTPUT-STRING-STREAM))) (HTML-WRITE-URL (%NATIVE-STREAM URL) "show" OBJECT) (THE-STRING-READER URL)))
...
(CL:DEFMETHOD VIZ-GET-BINARY-RELATIONS-OF ((SELF VIZ-INFO) CONCEPT)
  (CL:LET* ((MEMO-TABLE-000 NULL) (MEMOIZED-ENTRY-000 NULL) (MEMOIZED-VALUE-000 NULL))
   (CL:WHEN *MEMOIZATION-ENABLED?* (CL:SETQ MEMO-TABLE-000 (%SURROGATE-VALUE SGT-VISUALIZE-ONTOSAURUS-M-VIZ-INFO.VIZ-GET-BINARY-RELATIONS-OF-MEMO-TABLE-000))
    (CL:WHEN (CL:EQ MEMO-TABLE-000 NULL)
     ...
     (CL:SETQ MEMO-TABLE-000 (%SURROGATE-VALUE SGT-VISUALIZE-ONTOSAURUS-M-VIZ-INFO.VIZ-GET-BINARY-RELATIONS-OF-MEMO-TABLE-000)))
...
(CL:DEFMETHOD VIZ-ALLOWED-OBJECT? ((SELF VIZ-INFO) OBJECT)
  (CL:IF (CL:EQ (%ALLOWED-OBJECTS SELF) NULL) (CL:NOT (VIZ-EXCLUDED-MODULE? SELF (HOME-MODULE OBJECT))) (MEMBER? (%ALLOWED-OBJECTS SELF) OBJECT)))

;;; (DEFMETHOD VIZ-ALLOW-OBJECT ...)

(CL:DEFMETHOD VIZ-ALLOW-OBJECT ((SELF VIZ-INFO) OBJECT)
  (CL:LET* ((ALLOWEDOBJECTS (%ALLOWED-OBJECTS SELF)))
   (CL:WHEN (CL:EQ ALLOWEDOBJECTS NULL) (CL:SETQ ALLOWEDOBJECTS (NEW-HASH-SET)) (CL:SETF (%ALLOWED-OBJECTS SELF) ALLOWEDOBJECTS)) (INSERT ALLOWEDOBJECTS OBJECT)))

;;; (DEFMETHOD VIZ-EXCLUDE-OBJECT ...)

(CL:DEFMETHOD VIZ-EXCLUDE-OBJECT ((SELF VIZ-INFO) OBJECT)
  (CL:LET* ((ALLOWEDOBJECTS (%ALLOWED-OBJECTS SELF)))
   (CL:WHEN (CL:EQ ALLOWEDOBJECTS NULL) (CL:SETQ ALLOWEDOBJECTS (NEW-HASH-SET)) (CL:SETF (%ALLOWED-OBJECTS SELF) ALLOWEDOBJECTS)) (REMOVE ALLOWEDOBJECTS OBJECT)))

;;; (DEFMETHOD VIZ-CONCEPT-TO-DOT-NODE ...)

(CL:DEFMETHOD VIZ-CONCEPT-TO-DOT-NODE ((SELF VIZ-INFO) CONCEPT MODULE)
  (CL:LET*
   ((STREAM (%STREAM SELF)) (CONCEPTNAME (VIZ-DOT-OBJECT-NAME CONCEPT)) (CONCEPTCOLOR (%NODE-COLOR SELF)) (CONCEPTURL (VIZ-GENERATE-ONTOSAURUS-HANDLE SELF CONCEPT)))
   (CL:DECLARE (CL:TYPE CL:SIMPLE-STRING CONCEPTNAME CONCEPTCOLOR CONCEPTURL))
   (CL:COND
    ((CL:OR (%SHOW-ATTRIBUTES? SELF) (%SHOW-RULES? SELF))
     (%%PRINT-STREAM (%NATIVE-STREAM STREAM) "  \"" CONCEPTNAME "\" [shape=record, style=filled, fillcolor=" CONCEPTCOLOR ", URL=\"")
     (%%PRINT-STREAM (%NATIVE-STREAM STREAM) CONCEPTURL) (%%PRINT-STREAM (%NATIVE-STREAM STREAM) "\", label=\"{" CONCEPTNAME "|")
    ...
    (CL:T (%%PRINT-STREAM (%NATIVE-STREAM STREAM) "  \"" CONCEPTNAME "\" [shape=box, style=filled, fillcolor=" CONCEPTCOLOR ", URL=\"" CONCEPTURL "\"]")))))
   ...
   (CL:LET* ((*MODULE* MODULE) (*CONTEXT* *MODULE*)) (CL:DECLARE (CL:SPECIAL *MODULE* *CONTEXT*))
    (CL:LET* ((RELATION NULL) (ITER-000 (VIZ-GET-BINARY-RELATIONS-OF SELF CONCEPT)))
     (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-000 NIL)) DO (CL:SETQ RELATION (%%VALUE ITER-000)) (CL:SETQ RANGE (PLI::GET-RANGE RELATION))
      (%%PRINT-STREAM (%NATIVE-STREAM STREAM) (VIZ-DOT-OBJECT-NAME RELATION) ": " (VIZ-DOT-OBJECT-NAME RANGE) "\\l") (CL:SETQ ITER-000 (%%REST ITER-000)))))))
    ...
    (CL:LET* ((*PRETTYPRINTLOGICALFORMS?* CL:T)) (CL:DECLARE (CL:SPECIAL *PRETTYPRINTLOGICALFORMS?*))
     (CL:LET* ((RULE NULL) (ITER-000 (PLI::GET-RULES CONCEPT MODULE NULL)))
      (CL:LOOP WHILE (NEXT? ITER-000) DO (CL:SETQ RULE (%VALUE ITER-000))
       (CL:WHEN (CL:NOT (SIMPLE-SUBRELATION-PROPOSITION? RULE)) (CL:WHEN (CL:NOT FIRST?) (%%PRINT-STREAM (%NATIVE-STREAM STREAM) "\\l")) (CL:SETQ FIRST? CL:NIL)
...
(CL:DEFMETHOD VIZ-CONCEPT-LINKS-TO-DOT-EDGES ((SELF VIZ-INFO) CONCEPT MODULE)
  (CL:LET* ((STREAM (%STREAM SELF)) (COUNT 0)) (CL:DECLARE (CL:TYPE CL:FIXNUM COUNT))
       ...
       (CL:PROGN
        (CL:COND
         ((VIZ-ALLOWED-OBJECT? SELF SUPER)
          (%%PRINT-STREAM (%NATIVE-STREAM STREAM) "  \"" (VIZ-DOT-OBJECT-NAME SUPER) "\" -> \"" (VIZ-DOT-OBJECT-NAME CONCEPT) "\" [dir=back]" EOL)
          (CL:SETQ COUNT (CL:1+ COUNT)))
         (CL:T
          (%%PRINT-STREAM (%NATIVE-STREAM STREAM) "  \"" (VIZ-DOT-OBJECT-NAME SUPER) "\" [shape=box, style=filled, fillcolor=grey,URL=\""
   ...
   (CL:WHEN (CL:AND (CL:= COUNT 0) (%ADD-TOP? SELF))
    (%%PRINT-STREAM (%NATIVE-STREAM STREAM) "  \"" VIZ-TOP "\" -> \"" (VIZ-DOT-OBJECT-NAME CONCEPT) "\" [dir=back]" EOL))
   (CL:WHEN (%SHOW-RELATIONS? SELF)
    (CL:LET* ((RANGE NULL) (RELCOLOR (%RELATION-COLOR SELF)) (RELSTYLE (%RELATION-STYLE SELF))) (CL:DECLARE (CL:TYPE CL:SIMPLE-STRING RELCOLOR RELSTYLE))
     (CL:LET* ((*MODULE* MODULE) (*CONTEXT* *MODULE*)) (CL:DECLARE (CL:SPECIAL *MODULE* *CONTEXT*))
      (CL:LET* ((RELATION NULL) (ITER-001 (VIZ-GET-BINARY-RELATIONS-OF SELF CONCEPT)))
       (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-001 NIL)) DO (CL:SETQ RELATION (%%VALUE ITER-001)) (CL:SETQ RANGE (PLI::GET-RANGE RELATION))
        (CL:WHEN (VIZ-ALLOWED-OBJECT? SELF RELATION)
         (%%PRINT-STREAM (%NATIVE-STREAM STREAM) "  \"" (VIZ-DOT-OBJECT-NAME CONCEPT) "\" -> \"" (VIZ-DOT-OBJECT-NAME RANGE) "\" [label=\""
...
(CL:DEFMETHOD VIZ-EXPORT-DOT-HEADER ((SELF VIZ-INFO))
  (CL:LET* ((STREAM (%STREAM SELF))) (%%PRINT-STREAM (%NATIVE-STREAM STREAM) "digraph Ontology {" EOL)
   (%%PRINT-STREAM (%NATIVE-STREAM STREAM) "  node [fontname = Arial, fontsize=" (%FONT-SIZE SELF) ", shape=box, style=filled, fillcolor=" (%NODE-COLOR SELF)
    ", height=0.2];" EOL)
  ...
  (CL:LET* ((SUPER NULL) (ITER-002 (PLI::GET-PROPER-SUPERRELATIONS CONCEPT MODULE NULL)))
   (CL:LOOP WHILE (NEXT? ITER-002) DO (CL:SETQ SUPER (%VALUE ITER-002))
    (CL:COND ((SUBTYPE-OF? (SAFE-PRIMARY-TYPE SUPER) SGT-VISUALIZE-LOGIC-LOGIC-OBJECT) (CL:PROGN (VIZ-EXPORT-CONCEPT SELF SUPER MODULE)))
     (CL:T
      (CL:LET* ((STREAM-000 (NEW-OUTPUT-STRING-STREAM))) (%%PRINT-STREAM (%NATIVE-STREAM STREAM-000) "viz-export-concept-tree: concept not handled: `" SUPER "'")
       (CL:ERROR (NEW-STELLA-EXCEPTION (THE-STRING-READER STREAM-000))))))))
  (CL:LET* ((SUB NULL) (ITER-003 (PLI::GET-PROPER-SUBRELATIONS CONCEPT MODULE NULL)))
   (CL:LOOP WHILE (NEXT? ITER-003) DO (CL:SETQ SUB (%VALUE ITER-003))
    (CL:COND ((SUBTYPE-OF? (SAFE-PRIMARY-TYPE SUB) SGT-VISUALIZE-LOGIC-LOGIC-OBJECT) (CL:PROGN (VIZ-EXPORT-CONCEPT SELF SUB MODULE)))
     (CL:T
      (CL:LET* ((STREAM-001 (NEW-OUTPUT-STRING-STREAM))) (%%PRINT-STREAM (%NATIVE-STREAM STREAM-001) "viz-export-concept-tree: concept not handled: `" SUB "'")
  ...
  (CL:LET* ((CONCEPT NULL) (ITER-000 (PLI::GET-CONCEPT-INSTANCES (GET-INSTANCE SGT-VISUALIZE-PL-KERNEL-KB-CONCEPT) MODULE NULL)))
   (CL:LOOP WHILE (NEXT? ITER-000) DO (CL:SETQ CONCEPT (%VALUE ITER-000))
    (CL:COND
     ...
     (CL:T
      (CL:LET* ((STREAM-000 (NEW-OUTPUT-STRING-STREAM))) (%%PRINT-STREAM (%NATIVE-STREAM STREAM-000) "viz-export-concepts: concept not handled: `" CONCEPT "'")
       (CL:ERROR (NEW-STELLA-EXCEPTION (THE-STRING-READER STREAM-000)))))))))
...
(CL:DEFUN VIZ-EXPORT-CONCEPT-TO-FILE (CONCEPT MODULE FILE)
  ...
  (CL:LET* ((OUT NULL))
   (CL:UNWIND-PROTECT
    (CL:PROGN (CL:SETQ OUT (OPEN-OUTPUT-FILE FILE))
     (CL:LET* ((*MODULE* MODULE) (*CONTEXT* *MODULE*)) (CL:DECLARE (CL:SPECIAL *MODULE* *CONTEXT*))
      (CL:LET* ((SELF-000 (NEW-VIZ-INFO))) (CL:SETF (%SHOW-RELATIONS? SELF-000) CL:T) (CL:SETF (%SHOW-ATTRIBUTES? SELF-000) CL:T) (CL:SETF (%SHOW-RULES? SELF-000) CL:T)
       (CL:SETF (%STREAM SELF-000) OUT) (CL:LET* ((INFO SELF-000)) (VIZ-EXPORT-HEADER INFO) (VIZ-EXPORT-CONCEPT-TREE INFO CONCEPT MODULE) (VIZ-EXPORT-TRAILER INFO)))))
    (CL:WHEN (CL:NOT (CL:EQ OUT NULL)) (FREE OUT)))))
...
(CL:DEFUN VIZ-SERVER-EXPORT-OBJECT (OBJECT MODULE)
  (CL:LET* ((MEMO-TABLE-000 NULL) (MEMOIZED-ENTRY-000 NULL) (MEMOIZED-VALUE-000 NULL))
   (CL:WHEN *MEMOIZATION-ENABLED?* (CL:SETQ MEMO-TABLE-000 (%SURROGATE-VALUE SGT-VISUALIZE-ONTOSAURUS-F-VIZ-SERVER-EXPORT-OBJECT-MEMO-TABLE-000))
    (CL:WHEN (CL:EQ MEMO-TABLE-000 NULL)
  ...
  (CL:LET* ((KEYS (PARSE-AND-DECODE-URL-ARGUMENTS (GET-REQUEST-URI-QUERY XCHG) #\+))) (CL:WHEN (CL:< (LENGTH KEYS) 4) (DO-ACTION-HANDLER XCHG))
   (CL:LET*
    ((ACTION (%%VALUE KEYS)) (OBJECTTYPE (%%VALUE (%%REST KEYS))) (MODULENAME (%%VALUE (%%REST (%%REST KEYS)))) (OBJECTNAME (FOURTH KEYS))
     (STREAM (GET-REPLY-STREAM XCHG)) (MODULE (PLI::GET-MODULE (%WRAPPER-VALUE MODULENAME) NULL)) (VISUALIZEDOBJECT NULL)
     (GENERATEMAP? (CL:AND *VIZ-SERVER-IMAGE-MAPS-ENABLED?* (EQL-TO-STRING? ACTION "graph"))))
    (CL:WHEN (CL:EQ MODULE NULL) (HTML-UNKNOWN-OBJECT-RESPONSE KWD-VISUALIZE-CONTEXT (%WRAPPER-VALUE MODULENAME) STREAM) (CL:RETURN-FROM VIZ-SERVER-HANDLER))
    (CL:LET* ((TEST-VALUE-000 (%WRAPPER-VALUE OBJECTTYPE))) (CL:DECLARE (CL:TYPE CL:SIMPLE-STRING TEST-VALUE-000))
     (CL:COND ((STRING-EQL? TEST-VALUE-000 "context") (CL:SETQ VISUALIZEDOBJECT MODULE))
      ...
      (CL:T (GENERATE-ERROR-RESPONSE XCHG KWD-VISUALIZE-BAD-REQUEST (CONCATENATE "Malformed URL, graph of type `" (%WRAPPER-VALUE OBJECTTYPE) "' is not supported."))
       (CL:RETURN-FROM VIZ-SERVER-HANDLER))))
...
visualize a set of concepts as a graph.\" :SLOTS ((STREAM :TYPE OUTPUT-STREAM) (ALLOWED-OBJECTS :TYPE HASH-SET) (SHOW-RELATIONS? :TYPE BOOLEAN :INITIALLY *VIZ-SHOW-RELATIONS?*) (SHOW-ATTRIBUTES? :TYPE BOOLEAN :INITIALLY *VIZ-SHOW-ATTRIBUTES?*) (SHOW-RULES? :TYPE BOOLEAN :INITIALLY *VIZ-SHOW-RULES?*) (ADD-TOP? :TYPE BOOLEAN :INITIALLY *VIZ-ADD-TOP?*) (NODE-COLOR :TYPE STRING :INITIALLY *VIZ-NODE-COLOR*) (RELATION-COLOR :TYPE STRING :INITIALLY *VIZ-RELATION-COLOR*) (RELATION-STYLE :TYPE STRING :INITIALLY *VIZ-RELATION-STYLE*) (FONT-SIZE :TYPE INTEGER :INITIALLY *VIZ-FONT-SIZE*)))")))
     (CL:SETF (%CLASS-CONSTRUCTOR-CODE CLASS) (CL:FUNCTION NEW-VIZ-INFO)) (CL:SETF (%CLASS-SLOT-ACCESSOR-CODE CLASS) (CL:FUNCTION ACCESS-VIZ-INFO-SLOT-VALUE))))
   ...
   (CL:WHEN (CURRENT-STARTUP-TIME-PHASE? 7)
    ...
    (CL:LET* ((FUNCTION (LOOKUP-FUNCTION SYM-VISUALIZE-ONTOSAURUS-STARTUP-VISUALIZE)))
     (SET-DYNAMIC-SLOT-VALUE (%DYNAMIC-SLOTS FUNCTION) SYM-VISUALIZE-STELLA-METHOD-STARTUP-CLASSNAME (WRAP-STRING "_StartupVisualize") NULL-STRING-WRAPPER)))
