...
(CL:DECLAIM
 (CL:SPECIAL *STARTUP-TIME-PHASE* NULL-INTEGER STANDARD-OUTPUT STANDARD-ERROR MODULE-SEPARATOR-STRING *MODULE* EOL))
   ...
   (CL:LET* ((TEST-VALUE-000 (SAFE-PRIMARY-TYPE OBJECT)))
    (CL:COND
     ((SUBTYPE-OF? TEST-VALUE-000 SGT-HTML-UTILITIES-LOGIC-LOGIC-OBJECT)
      (CL:PROGN
       (CL:COND ((CLASS? OBJECT) (CL:SETQ OBJECTTYPE "concept")) ((RELATION? OBJECT) (CL:SETQ OBJECTTYPE "relation"))
...
(CL:DEFUN GET-HTML-OBJECT-LOOKUP-MODULE (OBJECT)
  (CL:LET* ((LOOKUPMODULE (HOME-MODULE OBJECT)))
   (CL:WHEN (CL:AND (CL:NOT (CL:EQ *MODULE* NULL)) (VISIBLE-FROM? LOOKUPMODULE *MODULE*))
...
(CL:DEFUN GET-HTML-OBJECT-HANDLE (OBJECT)
  (CL:LET* ((NAME (OBJECT-NAME OBJECT)))
   (CL:COND ((CL:NOT (CL:EQ NAME NULL)) (VISIBLE-NAME NAME CL:T))
    ((FUNCTION-OUTPUT-SKOLEM? OBJECT) (STRINGIFY (GENERATE-TERM OBJECT))) (CL:T (STRINGIFY OBJECT)))))
   ...
   (CL:IF
    (CL:OR
     (CL:AND (CL:NOT (CL:EQ NAME NULL))
      (CL:NOT (CL:EQ NAME (LOOKUP-SYMBOL-IN-MODULE (%SYMBOL-NAME NAME) *MODULE* CL:NIL))))
...
(CL:DEFUN HTML-WRITE-3PART-HREF-IN-DETAIL (STREAM TARGET ACTION OBJECT-TYPE CONTEXT-NAME OBJECT-NAME OBJECT-TITLE-PREFIX OBJECT-TITLE OBJECT-TITLE-SUFFIX RAWTITLE?)
  (CL:DECLARE
   (CL:TYPE CL:SIMPLE-STRING TARGET ACTION OBJECT-TYPE CONTEXT-NAME OBJECT-NAME OBJECT-TITLE-PREFIX OBJECT-TITLE
    OBJECT-TITLE-SUFFIX))
  #+MCL
  ...
  (CL:IF RAWTITLE? (%%PRINT-STREAM STREAM OBJECT-TITLE-PREFIX OBJECT-TITLE OBJECT-TITLE-SUFFIX)
   (CL:PROGN
    (CL:WHEN
     (CL:AND (CL:NOT (CL:EQ OBJECT-TITLE-PREFIX STELLA::NULL-STRING)) (CL:NOT (STRING-EQL? OBJECT-TITLE-PREFIX "")))
    ...
    (CL:WHEN
     (CL:AND (CL:NOT (CL:EQ OBJECT-TITLE-SUFFIX STELLA::NULL-STRING)) (CL:NOT (STRING-EQL? OBJECT-TITLE-SUFFIX "")))
...
(CL:DEFUN HTML-WRITE-HREF (STREAM ACTION OBJECTTYPE OBJECT)
  ...
  (CL:LET* ((TEST-VALUE-000 (SAFE-PRIMARY-TYPE OBJECT)))
   (CL:COND
    ((SUBTYPE-OF? TEST-VALUE-000 SGT-HTML-UTILITIES-LOGIC-LOGIC-OBJECT)
     (CL:PROGN
      (HTML-WRITE-3PART-HREF-IN-DETAIL STREAM STELLA::NULL-STRING ACTION OBJECTTYPE
       (GET-HTML-OBJECT-LOOKUP-MODULE OBJECT) (GET-HTML-OBJECT-HANDLE OBJECT) (GET-HTML-OBJECT-TITLE-PREFIX OBJECT)
       (GET-HTML-OBJECT-TITLE OBJECT) "" CL:NIL)))
    ((SUBTYPE-OF? TEST-VALUE-000 SGT-HTML-UTILITIES-STELLA-MODULE)
     (CL:PROGN
      (HTML-WRITE-HREF-IN-DETAIL STREAM STELLA::NULL-STRING ACTION OBJECTTYPE (NAME OBJECT) (NAME OBJECT) (NAME OBJECT)
       CL:NIL)))
    (CL:T
     (%%PRINT-STREAM (%NATIVE-STREAM STANDARD-OUTPUT) STANDARD-ERROR "Don't know how to write HREF for object" OBJECT)
...
(CL:DEFUN HTML-WRITE-URL (STREAM ACTION OBJECT)
  ...
  (CL:LET* ((TEST-VALUE-000 (SAFE-PRIMARY-TYPE OBJECT)))
   (CL:COND
    ((SUBTYPE-OF? TEST-VALUE-000 SGT-HTML-UTILITIES-LOGIC-LOGIC-OBJECT)
     (CL:PROGN
      (HTML-WRITE-URL-IN-DETAIL STREAM ACTION (GET-HTML-OBJECT-TYPE OBJECT) (GET-HTML-OBJECT-LOOKUP-MODULE OBJECT)
...
(CL:DEFUN HTML-WRITE-JAVASCRIPT (STREAM JS)
  ...
  (%%PRINT-STREAM STREAM "<SCRIPT LANGUAGE=\"JAVASCRIPT\"><!-- Hide from old browsers" EOL JS EOL
  ...
  (CL:PROGN (%%PRINT-STREAM STREAM "<TABLE WIDTH='100%'>") (%%PRINT-STREAM STREAM EOL)
   (CL:PROGN (%%PRINT-STREAM STREAM "<TR>")
    (CL:PROGN (%%PRINT-STREAM STREAM "<TD ALIGN='LEFT'>")
     (CL:PROGN (%%PRINT-STREAM STREAM "<B>") (WRITE-HTML-QUOTING-SPECIAL-CHARACTERS STREAM TITLE)
    ...
    (CL:PROGN (%%PRINT-STREAM STREAM "<TD ALIGN='RIGHT'>")
     (CL:PROGN (%%PRINT-STREAM STREAM "<FONT SIZE=3 COLOR='#663333'>")
      (WRITE-HTML-QUOTING-SPECIAL-CHARACTERS STREAM HEAD) (%%PRINT-STREAM STREAM "</FONT>"))
...
(CL:DEFUN WRITE-BOOKMARK-ICON (INSTANCE STREAM)
  (HTML-WRITE-HREF-IN-DETAIL STREAM "bookmark" "bookmark" "object" (NAME (HOME-MODULE INSTANCE))
...
(CL:DEFUN HTML-EMIT-IMAGE (STREAM IMAGEURL ALTERNATETEXT WIDTH HEIGHT ALIGNMENT BORDER)
  ...
  (CL:IF (CL:NOT (CL:= BORDER NULL-INTEGER)) (%%PRINT-STREAM STREAM " BORDER='" BORDER "'/>")
...
" START))
    (CL:PROGN (%%PRINT-STREAM STREAM "<P>") (WRITE-HTML-QUOTING-SPECIAL-CHARACTERS STREAM (SUBSEQUENCE S START POS))
...
(CL:DEFUN STARTUP-HTML-UTILITIES ()
  (CL:LET* ((*MODULE* (GET-STELLA-MODULE "/ONTOSAURUS" (> *STARTUP-TIME-PHASE* 1))) (*CONTEXT* *MODULE*))
   ...
   (CL:WHEN (CURRENT-STARTUP-TIME-PHASE? 7)
    (DEFINE-FUNCTION-OBJECT "MAKE-HTML-BODY-TAG" "(DEFUN (MAKE-HTML-BODY-TAG STRING) ((BACKGROUNDCOLOR STRING)))"
     (CL:FUNCTION MAKE-HTML-BODY-TAG) NULL)
    (DEFINE-FUNCTION-OBJECT "HTML-LINE-BREAK" "(DEFUN HTML-LINE-BREAK ((STREAM NATIVE-OUTPUT-STREAM)))"
     (CL:FUNCTION HTML-LINE-BREAK) NULL)
    (DEFINE-FUNCTION-OBJECT "GET-HTML-OBJECT-TYPE" "(DEFUN (GET-HTML-OBJECT-TYPE STRING) ((OBJECT OBJECT)))"
     (CL:FUNCTION GET-HTML-OBJECT-TYPE) NULL)
    (DEFINE-FUNCTION-OBJECT "GET-HTML-OBJECT-LOOKUP-MODULE"
     "(DEFUN (GET-HTML-OBJECT-LOOKUP-MODULE STRING) ((OBJECT OBJECT)))" (CL:FUNCTION GET-HTML-OBJECT-LOOKUP-MODULE)
     NULL)
    (DEFINE-FUNCTION-OBJECT "GET-HTML-OBJECT-HANDLE" "(DEFUN (GET-HTML-OBJECT-HANDLE STRING) ((OBJECT OBJECT)))"
     (CL:FUNCTION GET-HTML-OBJECT-HANDLE) NULL)
    (DEFINE-FUNCTION-OBJECT "GET-HTML-OBJECT-TITLE" "(DEFUN (GET-HTML-OBJECT-TITLE STRING) ((OBJECT OBJECT)))"
     (CL:FUNCTION GET-HTML-OBJECT-TITLE) NULL)
    (DEFINE-FUNCTION-OBJECT "GET-HTML-OBJECT-TITLE-PREFIX"
     "(DEFUN (GET-HTML-OBJECT-TITLE-PREFIX STRING) ((OBJECT OBJECT)))" (CL:FUNCTION GET-HTML-OBJECT-TITLE-PREFIX) NULL)
    ...
    (DEFINE-FUNCTION-OBJECT "HTML-WRITE-JAVASCRIPT"
     "(DEFUN HTML-WRITE-JAVASCRIPT ((STREAM NATIVE-OUTPUT-STREAM) (JS STRING)))" (CL:FUNCTION HTML-WRITE-JAVASCRIPT)
     NULL)
    ...
    (DEFINE-FUNCTION-OBJECT "WRITE-POWERLOOM-TRAILER" "(DEFUN WRITE-POWERLOOM-TRAILER ((STREAM NATIVE-OUTPUT-STREAM)))"
     (CL:FUNCTION WRITE-POWERLOOM-TRAILER) NULL)
    (DEFINE-FUNCTION-OBJECT "STARTUP-HTML-UTILITIES" "(DEFUN STARTUP-HTML-UTILITIES () :PUBLIC? TRUE)"
    ...
    (CL:LET* ((FUNCTION (LOOKUP-FUNCTION SYM-HTML-UTILITIES-ONTOSAURUS-STARTUP-HTML-UTILITIES)))
     (SET-DYNAMIC-SLOT-VALUE (%DYNAMIC-SLOTS FUNCTION) SYM-HTML-UTILITIES-STELLA-METHOD-STARTUP-CLASSNAME
