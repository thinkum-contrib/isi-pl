     ...
     (CL:PROGN
      (CL:LET*
         ...
         (CL:IF
          (CL:EQ NAME
           (LOOKUP-SYMBOL-IN-MODULE (%SYMBOL-NAME NAME) *MODULE*
            CL:NIL))
          ""
          (CONCATENATE (%MODULE-FULL-NAME (%HOME-CONTEXT NAME))
       ...
       (HTML-WRITE-3PART-HREF-IN-DETAIL STREAM STELLA::NULL-STRING
        ACTION OBJECTTYPE (NAME WRITEMODULE) (VISIBLE-NAME NAME CL:T)
        MODULE-PREFIX WRITE-NAME "" CL:NIL))))
     ...
     ((SUBTYPE-OF? TEST-VALUE-000
      ...
      (CL:PROGN
       (CL:LET* ((WRITEMODULE (HOME-MODULE OBJECT)))
        ...
        (HTML-WRITE-URL-IN-DETAIL STREAM ACTION OBJECTTYPE
         (NAME WRITEMODULE)
