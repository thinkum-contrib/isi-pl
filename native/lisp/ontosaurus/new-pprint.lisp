...
(CL:DECLAIM
 (CL:SPECIAL *STARTUP-TIME-PHASE* *MODULE* FALSE-WRAPPER SYSTEM-DEFINED-ARGUMENT-NAMES NIL *PRINTFUNCTIONSASRELATIONS?*
  *PRINTREADABLY?* *SKOLEMNAMEMAPPINGTABLE* *CURRENTJUSTIFICATION* VALUE-OF-SEPARATOR EOL NULL-INTEGER))
      ...
      (CL:PROGN
       (CL:COND ((CL:NOT (CL:EQ (NATIVE-VALUE-OF SELF) NULL)) (PPRINT-ATOMIC-OBJECT (NATIVE-VALUE-OF SELF) STREAM))
        ((CL:NOT (CL:EQ (INNERMOST-OF SELF) NULL))
         ...
         (CL:COND
          ((CL:NOT (CL:EQ (INNERMOST-OF SELF) SELF)) (%%PRINT-STREAM STREAM VALUE-OF-SEPARATOR)
           (PPRINT-OBJECT (INNERMOST-OF SELF) STREAM))
          ((CL:NOT (CL:EQ (%DEFINING-PROPOSITION SELF) NULL)) (%%PRINT-STREAM STREAM VALUE-OF-SEPARATOR)
     ...
     ((SUBTYPE-OF? TEST-VALUE-000 SGT-NEW-PPRINT-LOGIC-LOGIC-OBJECT)
      (CL:PROGN
       (CL:IF (CL:NOT (CL:EQ (%SURROGATE-VALUE-INVERSE SELF) NULL))
        (%%PRINT-STREAM STREAM (SURROGATE-TO-SYMBOL (%SURROGATE-VALUE-INVERSE SELF)))
     ...
     ((SUBTYPE-OF? TEST-VALUE-000 SGT-NEW-PPRINT-LOGIC-LOGIC-THING)
      (CL:PROGN
       (CL:COND ((CL:NOT (CL:EQ (GENERATE-TERM SELF) NULL)) (PPRINT-OBJECT (GENERATE-TERM SELF) STREAM))
        ((CL:NOT (CL:EQ (%SURROGATE-VALUE-INVERSE SELF) NULL)) (%%PRINT-STREAM STREAM (%SURROGATE-VALUE-INVERSE SELF)))
        (CL:T (%%PRINT-STREAM STREAM SELF)))))
     ((SUBTYPE-OF? TEST-VALUE-000 SGT-NEW-PPRINT-STELLA-THING)
      (CL:PROGN
       (CL:IF (CL:NOT (CL:EQ (%SURROGATE-VALUE-INVERSE SELF) NULL))
        (%%PRINT-STREAM STREAM (%SURROGATE-VALUE-INVERSE SELF)) (%%PRINT-STREAM STREAM SELF))))
     (CL:T (%%PRINT-STREAM STREAM SELF))))))
...
(CL:DEFUN PPRINT-AS-ATOMIC-OBJECT? (SELF)
  (CL:LET* ((TEST-VALUE-000 (SAFE-PRIMARY-TYPE SELF)))
   (CL:COND ((SUBTYPE-OF? TEST-VALUE-000 SGT-NEW-PPRINT-LOGIC-NAMED-DESCRIPTION) (CL:PROGN CL:T))
    ((SUBTYPE-OF? TEST-VALUE-000 SGT-NEW-PPRINT-LOGIC-PROPOSITION) (CL:PROGN CL:NIL))
    ((SUBTYPE-OF? TEST-VALUE-000 SGT-NEW-PPRINT-LOGIC-DESCRIPTION) (CL:PROGN CL:NIL))
    ((SUBTYPE-OF? TEST-VALUE-000 SGT-NEW-PPRINT-STELLA-COLLECTION) (CL:PROGN CL:NIL))
    ((CL:EQ TEST-VALUE-000 SGT-NEW-PPRINT-STELLA-CONS) (CL:PROGN CL:NIL)) (CL:T CL:T))))
...
(CL:DEFUN PPRINT-COMPOSITE-OBJECT (SELF STREAM)
  (CL:LET* ((TEST-VALUE-000 (SAFE-PRIMARY-TYPE SELF)))
   (CL:COND ((SUBTYPE-OF? TEST-VALUE-000 SGT-NEW-PPRINT-LOGIC-PROPOSITION) (CL:PROGN (PPRINT-PROPOSITION SELF STREAM)))
    ...
    ((CL:EQ TEST-VALUE-000 SGT-NEW-PPRINT-STELLA-CONS) (CL:PROGN (PPRINT-STELLA-CONS SELF STREAM)))
...
(CL:DEFUN PPRINT-OBJECT (SELF STREAM)
  (CL:COND ((CL:EQ SELF NULL)) ((CL:NOT (PPRINT-AS-ATOMIC-OBJECT? SELF)) (PPRINT-COMPOSITE-OBJECT SELF STREAM))
   ((CL:NOT (CL:EQ *PPRINT-ATOMIC-OBJECT-RENDERER* NULL)) (CL:FUNCALL *PPRINT-ATOMIC-OBJECT-RENDERER* SELF STREAM))
   ...
   (CL:LET* ((ARG NULL) (ITER-000 ARGUMENTSITERATOR))
    (CL:LOOP WHILE (NEXT? ITER-000) DO (CL:SETQ ARG (%VALUE ITER-000))
     (CL:WHEN (CL:OR (VISIBLE-ARGUMENT? ARG) (CL:= VISIBLEARGCOUNT 0)) (CL:SETQ ARGINDEX (CL:1+ ARGINDEX))
      (CL:WHEN (CL:> ARGINDEX 1) (CL:IF SEPARATELINES? (PPRINT-NEWLINE STREAM) (%%PRINT-STREAM STREAM " ")))
  ...
  (CL:LET* ((TEST-VALUE-001 (SAFE-PRIMARY-TYPE ARG)))
   (CL:COND
    ...
    ((SUBTYPE-OF-SYMBOL? TEST-VALUE-001)
     (CL:PROGN (< (CL:THE CL:FIXNUM (CL:LENGTH (CL:THE CL:SIMPLE-STRING (%SYMBOL-NAME ARG)))) 9)))
     ...
     (CL:PROGN
      (CL:LET* ((NAME (OBJECT-NAME ARG)))
       (CL:IF (CL:NOT (CL:EQ NAME NULL))
        (< (CL:THE CL:FIXNUM (CL:LENGTH (CL:THE CL:SIMPLE-STRING (%SYMBOL-NAME NAME)))) 9) CL:NIL))))
    (CL:T CL:NIL))))
    ...
    ((SUBTYPE-OF-SURROGATE? TEST-VALUE-000)
     (CL:PROGN
      (CL:LET* ((PRINTNAME (STRINGIFIED-SURROGATE OPERATOR))) (CL:DECLARE (CL:TYPE CL:SIMPLE-STRING PRINTNAME))
       (CL:COND
        ((CL:OR (CL:EQ OPERATOR SGT-NEW-PPRINT-PL-KERNEL-KB-AND) (CL:EQ OPERATOR SGT-NEW-PPRINT-PL-KERNEL-KB-OR)
          (CL:EQ OPERATOR SGT-NEW-PPRINT-PL-KERNEL-KB-NOT) (CL:EQ OPERATOR SGT-NEW-PPRINT-PL-KERNEL-KB-FAIL)
          (CL:EQ OPERATOR SGT-NEW-PPRINT-PL-KERNEL-KB-FORALL) (CL:EQ OPERATOR SGT-NEW-PPRINT-PL-KERNEL-KB-EXISTS)
          (CL:EQ OPERATOR SGT-NEW-PPRINT-PL-KERNEL-KB-KAPPA) (CL:EQ OPERATOR SGT-NEW-PPRINT-PL-KERNEL-KB-SUBSET-OF)
          (CL:EQ OPERATOR SGT-NEW-PPRINT-PL-KERNEL-KB-SETOF) (CL:EQ OPERATOR SGT-NEW-PPRINT-PL-KERNEL-KB-LISTOF)
          (CL:EQ OPERATOR SGT-NEW-PPRINT-PL-KERNEL-KB-BAGOF) (CL:EQ OPERATOR SGT-NEW-PPRINT-STELLA-TRUE)
...
(CL:DEFUN PPRINT-OPERATOR-WITH-ARGUMENTS (OPERATORNAME ARGUMENTS SEPARATELINES? OMITLASTARGUMENT? STREAM)
  ...
  (CL:LET* ((OPERATORINDENT (CL:+ (CL:THE CL:FIXNUM (CL:LENGTH OPERATORNAME)) 2)))
   (CL:DECLARE (CL:TYPE CL:FIXNUM OPERATORINDENT)) (%%PRINT-STREAM STREAM "(" OPERATORNAME " ")
   (CL:SETQ *PPRINT-INDENT* (CL:+ *PPRINT-INDENT* OPERATORINDENT))
   (PPRINT-ARGUMENTS ARGUMENTS SEPARATELINES? OMITLASTARGUMENT? STREAM)
   (CL:SETQ *PPRINT-INDENT* (CL:- *PPRINT-INDENT* OPERATORINDENT)) (%%PRINT-STREAM STREAM ")")))

;;; (DEFUN PPRINT-RELATION-PROPOSITION ...)

(CL:DEFUN PPRINT-RELATION-PROPOSITION (SELF STREAM)
  (CL:LET* ((NARGS (LENGTH (%ARGUMENTS SELF)))) (CL:DECLARE (CL:TYPE CL:FIXNUM NARGS)) (%%PRINT-STREAM STREAM "(")
   (PPRINT-OBJECT (%OPERATOR SELF) STREAM) (CL:SETQ *PPRINT-INDENT* (CL:+ *PPRINT-INDENT* 3))
    ...
    (CL:IF TEST-VALUE-000
     (CL:LET* ((ARG NULL) (VECTOR-001 (%ARGUMENTS SELF)) (INDEX-001 0) (LENGTH-001 (LENGTH VECTOR-001)))
      ...
      (CL:LOOP WHILE (CL:< INDEX-001 LENGTH-001) DO
       (CL:SETQ ARG (CL:AREF (CL:THE CL:SIMPLE-VECTOR (%THE-ARRAY VECTOR-001)) INDEX-001)) (PPRINT-NEWLINE STREAM)
       (PPRINT-OBJECT ARG STREAM) (CL:SETQ INDEX-001 (CL:1+ INDEX-001))))
     (CL:LET* ((ARG NULL) (VECTOR-002 (%ARGUMENTS SELF)) (INDEX-002 0) (LENGTH-002 (LENGTH VECTOR-002)))
      ...
      (CL:LOOP WHILE (CL:< INDEX-002 LENGTH-002) DO
       ...
       (CL:IF (PPRINT-AS-ATOMIC-OBJECT? ARG) (%%PRINT-STREAM STREAM " ") (PPRINT-NEWLINE STREAM))
...
(CL:DEFUN PPRINT-FUNCTION-TERM (SELF STREAM)
  (CL:LET*
   ...
   (HTML-WRITE-HREF-IN-DETAIL STREAM STELLA::NULL-STRING "show" (GET-HTML-OBJECT-TYPE SKOLEM)
    (GET-HTML-OBJECT-LOOKUP-MODULE SKOLEM) (GET-HTML-OBJECT-HANDLE SKOLEM) "(" CL:T))
  ...
  (CL:LET* ((TEST-VALUE-000 CL:NIL))
   ...
   (CL:IF TEST-VALUE-000
    (CL:LET*
     ((INDENT (CL:+ (CL:THE CL:FIXNUM (CL:LENGTH (CL:THE CL:SIMPLE-STRING (%SYMBOL-NAME (%OPERATOR SELF))))) 2))
      (FIRST? CL:T))
     ...
     (CL:LET* ((ARG NULL) (ITER-000 (BUT-LAST (%ARGUMENTS SELF))))
      (CL:LOOP WHILE (NEXT? ITER-000) DO (CL:SETQ ARG (%VALUE ITER-000))
       (CL:IF FIRST? (CL:PROGN (%%PRINT-STREAM STREAM " ") (CL:SETQ FIRST? CL:NIL)) (PPRINT-NEWLINE STREAM))
       (PPRINT-OBJECT ARG STREAM)))
     (CL:SETQ *PPRINT-INDENT* (CL:- *PPRINT-INDENT* INDENT)))
    (CL:LET* ((ARG NULL) (ITER-001 (BUT-LAST (%ARGUMENTS SELF))))
     (CL:LOOP WHILE (NEXT? ITER-001) DO (CL:SETQ ARG (%VALUE ITER-001)) (%%PRINT-STREAM STREAM " ")
      (PPRINT-OBJECT ARG STREAM)))))
  (%%PRINT-STREAM STREAM ")"))
...
(CL:DEFUN PPRINT-FUNCTION-PROPOSITION (SELF STREAM)
  (CL:LET* ((LASTARG (LAST (%ARGUMENTS SELF)))) (%%PRINT-STREAM STREAM "(= ")
   (CL:SETQ *PPRINT-INDENT* (CL:+ *PPRINT-INDENT* 3)) (PPRINT-FUNCTION-TERM SELF STREAM)
   (CL:IF (PPRINT-AS-ATOMIC-OBJECT? LASTARG) (%%PRINT-STREAM STREAM " ") (PPRINT-NEWLINE STREAM))
   (PPRINT-OBJECT LASTARG STREAM) (CL:SETQ *PPRINT-INDENT* (CL:- *PPRINT-INDENT* 3)) (%%PRINT-STREAM STREAM ")")))
...
(CL:DEFUN PPRINT-PROPOSITION (SELF STREAM)
  ...
  (CL:LET* ((TEST-VALUE-000 (%KIND SELF)))
   (CL:COND
    ((CL:OR (CL:EQ TEST-VALUE-000 KWD-NEW-PPRINT-PREDICATE) (CL:EQ TEST-VALUE-000 KWD-NEW-PPRINT-ISA))
     (PPRINT-RELATION-PROPOSITION SELF STREAM))
    ((CL:EQ TEST-VALUE-000 KWD-NEW-PPRINT-FUNCTION)
     (CL:IF *PRINTFUNCTIONSASRELATIONS?* (PPRINT-RELATION-PROPOSITION SELF STREAM)
      (PPRINT-FUNCTION-PROPOSITION SELF STREAM)))
    ((CL:EQ TEST-VALUE-000 KWD-NEW-PPRINT-AND) (%%PRINT-STREAM STREAM "(") (PPRINT-OBJECT (%OPERATOR SELF) STREAM)
     (CL:SETQ *PPRINT-INDENT* (CL:+ *PPRINT-INDENT* 5)) (%%PRINT-STREAM STREAM " ")
     (PPRINT-ARGUMENTS (%ARGUMENTS SELF) CL:T CL:NIL STREAM) (CL:SETQ *PPRINT-INDENT* (CL:- *PPRINT-INDENT* 5))
     (%%PRINT-STREAM STREAM ")"))
    ((CL:EQ TEST-VALUE-000 KWD-NEW-PPRINT-OR) (%%PRINT-STREAM STREAM "(") (PPRINT-OBJECT (%OPERATOR SELF) STREAM)
     (CL:SETQ *PPRINT-INDENT* (CL:+ *PPRINT-INDENT* 4)) (%%PRINT-STREAM STREAM " ")
     (PPRINT-ARGUMENTS (%ARGUMENTS SELF) CL:T CL:NIL STREAM) (CL:SETQ *PPRINT-INDENT* (CL:- *PPRINT-INDENT* 4))
     (%%PRINT-STREAM STREAM ")"))
    ((CL:EQ TEST-VALUE-000 KWD-NEW-PPRINT-NOT) (%%PRINT-STREAM STREAM "(") (PPRINT-OBJECT (%OPERATOR SELF) STREAM)
     (CL:SETQ *PPRINT-INDENT* (CL:+ *PPRINT-INDENT* 5)) (%%PRINT-STREAM STREAM " ")
     (PPRINT-OBJECT (CL:AREF (CL:THE CL:SIMPLE-VECTOR (%THE-ARRAY (%ARGUMENTS SELF))) 0) STREAM)
     (CL:SETQ *PPRINT-INDENT* (CL:- *PPRINT-INDENT* 5)) (%%PRINT-STREAM STREAM ")"))
    ((CL:EQ TEST-VALUE-000 KWD-NEW-PPRINT-EQUIVALENT) (%%PRINT-STREAM STREAM "(=")
     (CL:SETQ *PPRINT-INDENT* (CL:+ *PPRINT-INDENT* 3)) (%%PRINT-STREAM STREAM " ")
     (PPRINT-ARGUMENTS (%ARGUMENTS SELF) CL:NIL CL:NIL STREAM) (CL:SETQ *PPRINT-INDENT* (CL:- *PPRINT-INDENT* 3))
     (%%PRINT-STREAM STREAM ")"))
    ((CL:EQ TEST-VALUE-000 KWD-NEW-PPRINT-FAIL) (%%PRINT-STREAM STREAM "(") (PPRINT-OBJECT (%OPERATOR SELF) STREAM)
     (CL:SETQ *PPRINT-INDENT* (CL:+ *PPRINT-INDENT* 6)) (%%PRINT-STREAM STREAM " ")
     (PPRINT-PROPOSITION (CL:AREF (CL:THE CL:SIMPLE-VECTOR (%THE-ARRAY (%ARGUMENTS SELF))) 0) STREAM)
     (CL:SETQ *PPRINT-INDENT* (CL:- *PPRINT-INDENT* 6)) (%%PRINT-STREAM STREAM ")"))
    ((CL:EQ TEST-VALUE-000 KWD-NEW-PPRINT-CONSTANT) (PPRINT-OBJECT (GENERATE-OPERATOR SELF) STREAM))
    ((CL:EQ TEST-VALUE-000 KWD-NEW-PPRINT-EXISTS) (%%PRINT-STREAM STREAM "(") (PPRINT-OBJECT (%OPERATOR SELF) STREAM)
     (CL:SETQ *PPRINT-INDENT* (CL:+ *PPRINT-INDENT* 8)) (%%PRINT-STREAM STREAM " ")
     (PPRINT-QUANTIFIED-VARIABLES (DYNAMIC-SLOT-VALUE (%DYNAMIC-SLOTS SELF) SYM-NEW-PPRINT-LOGIC-IO-VARIABLES NULL)
      CL:NIL STREAM)
     (CL:SETQ *PPRINT-INDENT* (CL:- *PPRINT-INDENT* 5)) (PPRINT-NEWLINE STREAM)
     (PPRINT-PROPOSITION (CL:AREF (CL:THE CL:SIMPLE-VECTOR (%THE-ARRAY (%ARGUMENTS SELF))) 0) STREAM)
     (CL:SETQ *PPRINT-INDENT* (CL:- *PPRINT-INDENT* 3)) (%%PRINT-STREAM STREAM ")"))
    ((CL:EQ TEST-VALUE-000 KWD-NEW-PPRINT-FORALL) (%%PRINT-STREAM STREAM "(") (PPRINT-OBJECT (%OPERATOR SELF) STREAM)
     (CL:SETQ *PPRINT-INDENT* (CL:+ *PPRINT-INDENT* 8)) (%%PRINT-STREAM STREAM " ")
     (PPRINT-QUANTIFIED-VARIABLES (DYNAMIC-SLOT-VALUE (%DYNAMIC-SLOTS SELF) SYM-NEW-PPRINT-LOGIC-IO-VARIABLES NULL)
      CL:NIL STREAM)
     (CL:SETQ *PPRINT-INDENT* (CL:- *PPRINT-INDENT* 5)) (PPRINT-NEWLINE STREAM) (%%PRINT-STREAM STREAM "(=> ")
     (CL:SETQ *PPRINT-INDENT* (CL:+ *PPRINT-INDENT* 4))
     (PPRINT-PROPOSITION (CL:AREF (CL:THE CL:SIMPLE-VECTOR (%THE-ARRAY (%ARGUMENTS SELF))) 0) STREAM)
     (PPRINT-NEWLINE STREAM)
     (PPRINT-PROPOSITION (CL:AREF (CL:THE CL:SIMPLE-VECTOR (%THE-ARRAY (%ARGUMENTS SELF))) 1) STREAM)
     (CL:SETQ *PPRINT-INDENT* (CL:- *PPRINT-INDENT* 7)) (%%PRINT-STREAM STREAM ")"))
  ...
  (CL:LET*
   ...
   (CL:LOOP WHILE (CL:< INDEX-000 LENGTH-000) DO
    ...
    (CL:LET* ((TEST-VALUE-000 (SAFE-PRIMARY-TYPE VBL)))
     (CL:COND
      ((SUBTYPE-OF? TEST-VALUE-000 SGT-NEW-PPRINT-LOGIC-PATTERN-VARIABLE) (CL:PROGN (PPRINT-OBJECT VBL STREAM)))
    ...
    (CL:WHEN (CL:< I (LENGTH VARIABLES)) (CL:IF INCLUDETYPES? (PPRINT-NEWLINE STREAM) (%%PRINT-STREAM STREAM " ")))
...
(CL:DEFUN PPRINT-NAMED-DESCRIPTION (SELF STREAM)
  (CL:IF (CL:NOT (CL:EQ *PPRINT-ATOMIC-OBJECT-RENDERER* NULL)) (CL:FUNCALL *PPRINT-ATOMIC-OBJECT-RENDERER* SELF STREAM)
...
(CL:DEFUN PPRINT-DESCRIPTION (SELF STREAM)
  (CL:COND ((NAMED-DESCRIPTION? SELF) (PPRINT-NAMED-DESCRIPTION SELF STREAM))
   ((CL:NOT (CL:EQ (DYNAMIC-SLOT-VALUE (%DYNAMIC-SLOTS SELF) SYM-NEW-PPRINT-LOGIC-COMPLEMENT-DESCRIPTION NULL) NULL))
    (%%PRINT-STREAM STREAM "(" (OPERATOR-TO-STRING SGT-NEW-PPRINT-PL-KERNEL-KB-NOT) " ")
    (CL:SETQ *PPRINT-INDENT* (CL:+ *PPRINT-INDENT* 5))
    (PPRINT-OBJECT (DYNAMIC-SLOT-VALUE (%DYNAMIC-SLOTS SELF) SYM-NEW-PPRINT-LOGIC-COMPLEMENT-DESCRIPTION NULL) STREAM)
    (CL:SETQ *PPRINT-INDENT* (CL:- *PPRINT-INDENT* 5)) (%%PRINT-STREAM STREAM ")"))
   (CL:T (%%PRINT-STREAM STREAM "(" (OPERATOR-TO-STRING SGT-NEW-PPRINT-PL-KERNEL-KB-KAPPA) " ")
    (CL:SETQ *PPRINT-INDENT* (CL:+ *PPRINT-INDENT* 7)) (PPRINT-OBJECT (%IO-VARIABLES SELF) STREAM)
    (CL:SETQ *PPRINT-INDENT* (CL:- *PPRINT-INDENT* 4)) (PPRINT-OBJECT (%PROPOSITION SELF) STREAM)
    (CL:SETQ *PPRINT-INDENT* (CL:- *PPRINT-INDENT* 3)) (%%PRINT-STREAM STREAM ")"))))
...
(CL:DEFUN PPRINT-DESCRIPTION-BODY (DESCRIPTION STREAM)
  (CL:COND
   ((CL:EQ (%PROPOSITION DESCRIPTION) NULL) (%%PRINT-STREAM STREAM "(")
    (PPRINT-OBJECT (%SURROGATE-VALUE-INVERSE DESCRIPTION) STREAM) (CL:SETQ *PPRINT-INDENT* (CL:+ *PPRINT-INDENT* 3))
    (CL:IF (CL:NOT (CL:EQ *SKOLEMNAMEMAPPINGTABLE* NULL))
     (CL:LET* ((VAR NULL) (VECTOR-000 (%IO-VARIABLES DESCRIPTION)) (INDEX-000 0) (LENGTH-000 (LENGTH VECTOR-000)))
      (CL:DECLARE (CL:TYPE CL:FIXNUM INDEX-000 LENGTH-000))
      (CL:LOOP WHILE (CL:< INDEX-000 LENGTH-000) DO
       (CL:SETQ VAR (CL:AREF (CL:THE CL:SIMPLE-VECTOR (%THE-ARRAY VECTOR-000)) INDEX-000)) (%%PRINT-STREAM STREAM " ")
       (CL:IF (CL:NOT (CL:EQ (LOOKUP *SKOLEMNAMEMAPPINGTABLE* VAR) NULL))
        (PPRINT-OBJECT (LOOKUP *SKOLEMNAMEMAPPINGTABLE* VAR) STREAM) (PPRINT-OBJECT VAR STREAM))
       (CL:SETQ INDEX-000 (CL:1+ INDEX-000))))
     (CL:LET* ((NAME NULL) (ITER-000 (%THE-CONS-LIST (%IO-VARIABLE-NAMES DESCRIPTION))))
      (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-000 NIL)) DO (CL:SETQ NAME (%%VALUE ITER-000)) (%%PRINT-STREAM STREAM " ")
...
(CL:DEFUN PPRINT-NAMED-DESCRIPTIONS-AS-RULE (HEAD TAIL OPERATORPREFIX STREAM)
  ...
  (CL:LET* ((OPERATORINDENT (CL:+ (CL:THE CL:FIXNUM (CL:LENGTH OPERATORPREFIX)) 2)) (VARIABLES NIL))
   ...
   (%%PRINT-STREAM STREAM "(" (OPERATOR-TO-STRING SGT-NEW-PPRINT-PL-KERNEL-KB-FORALL) " (")
   (PPRINT-OBJECT (%%VALUE VARIABLES) STREAM)
   (CL:LET* ((V NULL) (ITER-001 (%%REST VARIABLES)))
    (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-001 NIL)) DO (CL:SETQ V (%%VALUE ITER-001)) (%%PRINT-STREAM STREAM " ")
     (PPRINT-OBJECT V STREAM) (CL:SETQ ITER-001 (%%REST ITER-001))))
   (%%PRINT-STREAM STREAM ")") (PPRINT-NEWLINE STREAM) (%%PRINT-STREAM STREAM "(" OPERATORPREFIX " (")
   (PPRINT-OBJECT HEAD STREAM) (CL:SETQ *PPRINT-INDENT* (CL:+ *PPRINT-INDENT* OPERATORINDENT))
   (CL:LET* ((V NULL) (ITER-002 VARIABLES))
    (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-002 NIL)) DO (CL:SETQ V (%%VALUE ITER-002)) (%%PRINT-STREAM STREAM " ")
   ...
   (CL:LET* ((V NULL) (ITER-003 VARIABLES))
    (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-003 NIL)) DO (CL:SETQ V (%%VALUE ITER-003)) (%%PRINT-STREAM STREAM " ")
     (PPRINT-OBJECT V STREAM) (CL:SETQ ITER-003 (%%REST ITER-003))))
   (%%PRINT-STREAM STREAM "))") (CL:SETQ *PPRINT-INDENT* (CL:- *PPRINT-INDENT* OPERATORINDENT))
   (CL:SETQ *PPRINT-INDENT* (CL:- *PPRINT-INDENT* 3))))
...
(CL:DEFUN HELP-PPRINT-DESCRIPTIONS-AS-RULE (DESC STREAM)
  (CL:LET*
   ((EXISTENTIALS (COPY-CONS-LIST-TO-VARIABLES-VECTOR (TOP-LEVEL-EXISTENTIAL-VARIABLES DESC)))
    (EXISTENTIALVARIABLES? (NON-EMPTY? EXISTENTIALS)))
   (CL:WHEN EXISTENTIALVARIABLES?
    (%%PRINT-STREAM STREAM "(" (OPERATOR-TO-STRING SGT-NEW-PPRINT-PL-KERNEL-KB-EXISTS) " ")
    (CL:SETQ *PPRINT-INDENT* (CL:+ *PPRINT-INDENT* 8)) (PPRINT-QUANTIFIED-VARIABLES EXISTENTIALS CL:NIL STREAM)
    (CL:SETQ *PPRINT-INDENT* (CL:- *PPRINT-INDENT* 5)) (PPRINT-NEWLINE STREAM))
   (PPRINT-DESCRIPTION-BODY DESC STREAM)
   (CL:WHEN EXISTENTIALVARIABLES? (%%PRINT-STREAM STREAM ")") (CL:SETQ *PPRINT-INDENT* (CL:- *PPRINT-INDENT* 3)))))
...
(CL:DEFUN PPRINT-DESCRIPTIONS-AS-RULE (HEAD TAIL RULE STREAM)
  (CL:LET*
   ((HEADVARIABLES NULL) (TAILVARIABLES NULL)
    (FORWARDRULE?
     (%WRAPPER-VALUE (DYNAMIC-SLOT-VALUE (%DYNAMIC-SLOTS RULE) SYM-NEW-PPRINT-LOGIC-FORWARD-ONLY? FALSE-WRAPPER)))
   ...
   (CL:WHEN (CL:AND (CL:EQ (%PROPOSITION TAIL) NULL) (CL:EQ (%PROPOSITION HEAD) NULL))
    (PPRINT-NAMED-DESCRIPTIONS-AS-RULE HEAD TAIL OPERATORPREFIX STREAM) (CL:RETURN-FROM PPRINT-DESCRIPTIONS-AS-RULE))
   (CL:SETQ HEADVARIABLES (%IO-VARIABLES HEAD)) (CL:SETQ TAILVARIABLES (%IO-VARIABLES TAIL))
   (CL:COND ((CL:EQ (%PROPOSITION TAIL) NULL) (CL:SETQ TAILVARIABLES HEADVARIABLES))
    ((CL:EQ (%PROPOSITION HEAD) NULL) (CL:SETQ HEADVARIABLES TAILVARIABLES)))
   (CLEAR REUSABLE-SKOLEM-MAPPING-TABLE)
   (CL:LET*
    ((TAILVBL NULL) (VECTOR-000 TAILVARIABLES) (INDEX-000 0) (LENGTH-000 (LENGTH VECTOR-000)) (HEADVBL NULL)
     (VECTOR-001 HEADVARIABLES) (INDEX-001 0) (LENGTH-001 (LENGTH VECTOR-001)))
    ...
    (CL:LOOP WHILE (CL:AND (CL:< INDEX-000 LENGTH-000) (CL:< INDEX-001 LENGTH-001)) DO
     ...
     (CL:SETQ HEADVBL (CL:AREF (CL:THE CL:SIMPLE-VECTOR (%THE-ARRAY VECTOR-001)) INDEX-001))
     (INSERT-AT REUSABLE-SKOLEM-MAPPING-TABLE HEADVBL TAILVBL) (CL:SETQ INDEX-000 (CL:1+ INDEX-000))
     (CL:SETQ INDEX-001 (CL:1+ INDEX-001))))
   (%%PRINT-STREAM STREAM "(" (OPERATOR-TO-STRING SGT-NEW-PPRINT-PL-KERNEL-KB-FORALL) " ")
   (CL:SETQ *PPRINT-INDENT* (CL:+ *PPRINT-INDENT* 8)) (PPRINT-QUANTIFIED-VARIABLES TAILVARIABLES CL:NIL STREAM)
   (CL:SETQ *PPRINT-INDENT* (CL:- *PPRINT-INDENT* 5)) (PPRINT-NEWLINE STREAM) (%%PRINT-STREAM STREAM "(")
   (CL:LET* ((*PRINTREADABLY?* CL:NIL)) (CL:DECLARE (CL:SPECIAL *PRINTREADABLY?*))
    (PPRINT-OBJECT (WRAP-STRING OPERATORPREFIX) STREAM))
   (%%PRINT-STREAM STREAM " ") (CL:SETQ *PPRINT-INDENT* (CL:+ *PPRINT-INDENT* OPERATORINDENT))
   (CL:LET* ((*SKOLEMNAMEMAPPINGTABLE* REUSABLE-SKOLEM-MAPPING-TABLE))
    (CL:DECLARE (CL:SPECIAL *SKOLEMNAMEMAPPINGTABLE*)) (HELP-PPRINT-DESCRIPTIONS-AS-RULE HEAD STREAM))
   (CLEAR REUSABLE-SKOLEM-MAPPING-TABLE) (PPRINT-NEWLINE STREAM) (HELP-PPRINT-DESCRIPTIONS-AS-RULE TAIL STREAM)
   (CL:SETQ *PPRINT-INDENT* (CL:- *PPRINT-INDENT* OPERATORINDENT)) (CL:SETQ *PPRINT-INDENT* (CL:- *PPRINT-INDENT* 3))
   (%%PRINT-STREAM STREAM "))")))
...
(CL:DEFUN PPRINT-IMPLIES-PROPOSITION (SELF STREAM)
  (CL:LET*
   ...
   (CL:IF (CL:AND (ISA? HEADARG SGT-NEW-PPRINT-LOGIC-DESCRIPTION) (ISA? TAILARG SGT-NEW-PPRINT-LOGIC-DESCRIPTION))
    ...
    (PPRINT-OPERATOR-WITH-ARGUMENTS (OPERATOR-TO-STRING SGT-NEW-PPRINT-PL-KERNEL-KB-SUBSET-OF) (%ARGUMENTS SELF) CL:NIL
     CL:NIL STREAM))))
...
(CL:DEFUN PPRINT-STELLA-COLLECTION (SELF STREAM)
  (CL:LET* ((SET? (NO-DUPLICATES? SELF)) (FIRST? CL:T))
   (CL:IF SET?
    (CL:PROGN (%%PRINT-STREAM STREAM "(" (OPERATOR-TO-STRING SGT-NEW-PPRINT-PL-KERNEL-KB-SETOF))
     (CL:SETQ *PPRINT-INDENT* (CL:+ *PPRINT-INDENT* 7)))
    (CL:PROGN (%%PRINT-STREAM STREAM "(" (OPERATOR-TO-STRING SGT-NEW-PPRINT-PL-KERNEL-KB-LISTOF))
     (CL:SETQ *PPRINT-INDENT* (CL:+ *PPRINT-INDENT* 8))))
   (CL:CASE (LENGTH SELF) (0)
    (1
     (CL:LET* ((M NULL) (ITER-000 (ALLOCATE-ITERATOR SELF)))
      (CL:LOOP WHILE (NEXT? ITER-000) DO (CL:SETQ M (%VALUE ITER-000)) (PPRINT-OBJECT M STREAM))))
    ((2 3)
     (CL:LET* ((M NULL) (ITER-001 (ALLOCATE-ITERATOR SELF)))
      (CL:LOOP WHILE (NEXT? ITER-001) DO (CL:SETQ M (%VALUE ITER-001)) (%%PRINT-STREAM STREAM " ")
    ...
    (CL:OTHERWISE
     (CL:LET* ((M NULL) (ITER-002 (ALLOCATE-ITERATOR SELF)))
      (CL:LOOP WHILE (NEXT? ITER-002) DO (CL:SETQ M (%VALUE ITER-002))
       ...
       (PPRINT-OBJECT M STREAM)))))
   (%%PRINT-STREAM STREAM ")")
   (CL:IF SET? (CL:SETQ *PPRINT-INDENT* (CL:- *PPRINT-INDENT* 7)) (CL:SETQ *PPRINT-INDENT* (CL:- *PPRINT-INDENT* 8)))))
...
(CL:DEFUN PPRINT-STELLA-CONS (SELF STREAM)
  ...
  (CL:CASE (LENGTH SELF) (0) (1 (PPRINT-OBJECT (%%VALUE SELF) STREAM))
   ...
   (3 (PPRINT-OBJECT (%%VALUE SELF) STREAM) (%%PRINT-STREAM STREAM " ") (PPRINT-OBJECT (%%VALUE (%%REST SELF)) STREAM)
    (%%PRINT-STREAM STREAM " ") (PPRINT-OBJECT (%%VALUE (%%REST (%%REST SELF))) STREAM))
   ((4 5) (PPRINT-OBJECT (%%VALUE SELF) STREAM)
    (CL:LET* ((OBJ NULL) (ITER-000 (%%REST SELF)))
     (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-000 NIL)) DO (CL:SETQ OBJ (%%VALUE ITER-000))
      (CL:IF (CL:> *PPRINT-INDENT* 2) (PPRINT-NEWLINE STREAM) (%%PRINT-STREAM STREAM " ")) (PPRINT-OBJECT OBJ STREAM)
      (CL:SETQ ITER-000 (%%REST ITER-000)))))
   (CL:OTHERWISE (PPRINT-OBJECT (%%VALUE SELF) STREAM)
    (CL:LET* ((OBJ NULL) (ITER-001 (%%REST SELF)))
     (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-001 NIL)) DO (CL:SETQ OBJ (%%VALUE ITER-001)) (PPRINT-NEWLINE STREAM)
...
(CL:DEFUN PPRINT-DEFINITION (SELF HASVARIABLES? STREAM)
  ...
  (CL:IF (ISA? (%%VALUE (%%REST SELF)) SGT-NEW-PPRINT-STELLA-SYMBOL)
   (PPRINT-ATOMIC-OBJECT (%%VALUE (%%REST SELF)) STREAM) (PPRINT-OBJECT (%%VALUE (%%REST SELF)) STREAM))
  (CL:COND
   ((CL:NOT HASVARIABLES?) (CL:SETQ SELF (%%REST (%%REST SELF))) (CL:SETQ *PPRINT-INDENT* (CL:+ *PPRINT-INDENT* 3)))
   ((CL:> (LENGTH (%%VALUE (%%REST (%%REST SELF)))) 5) (CL:SETQ *PPRINT-INDENT* (CL:+ *PPRINT-INDENT* 10))
    (PPRINT-NEWLINE STREAM) (PPRINT-OBJECT (%%VALUE (%%REST (%%REST SELF))) STREAM)
    (CL:SETQ SELF (%%REST (%%REST (%%REST SELF)))) (CL:SETQ *PPRINT-INDENT* (CL:- *PPRINT-INDENT* 7)))
   (CL:T (%%PRINT-STREAM STREAM " ") (PPRINT-OBJECT (%%VALUE (%%REST (%%REST SELF))) STREAM)
    (CL:SETQ SELF (%%REST (%%REST (%%REST SELF)))) (CL:SETQ *PPRINT-INDENT* (CL:+ *PPRINT-INDENT* 3))))
  (CL:LOOP WHILE (CL:NOT (CL:EQ SELF NIL)) DO (PPRINT-NEWLINE STREAM) (PPRINT-OBJECT (%%VALUE SELF) STREAM)
   (%%PRINT-STREAM STREAM " ") (CL:SETQ *PPRINT-INDENT* (CL:+ *PPRINT-INDENT* 8))
   (PPRINT-OBJECT (%%VALUE (%%REST SELF)) STREAM) (CL:SETQ *PPRINT-INDENT* (CL:- *PPRINT-INDENT* 8))
...
(CL:DEFUN PPRINT-ONTOSAURUS-OBJECT (SELF STREAM)
  (CL:LET*
   ((*LOGIC-DIALECT* KWD-NEW-PPRINT-KIF) (*PPRINT-ATOMIC-OBJECT-RENDERER* (CL:FUNCTION PPRINT-ATOMIC-OBJECT-FOR-HTML)))
   ...
   (CL:COND
    ((SUBTYPE-OF? (SAFE-PRIMARY-TYPE SELF) SGT-NEW-PPRINT-LOGIC-PROPOSITION)
     (CL:PROGN
      (CL:LET* ((TEST-VALUE-000 (%KIND SELF)))
       (CL:COND
        ((CL:OR (CL:EQ TEST-VALUE-000 KWD-NEW-PPRINT-ISA) (CL:EQ TEST-VALUE-000 KWD-NEW-PPRINT-FUNCTION)
          (CL:EQ TEST-VALUE-000 KWD-NEW-PPRINT-PREDICATE) (CL:EQ TEST-VALUE-000 KWD-NEW-PPRINT-NOT)
          (CL:EQ TEST-VALUE-000 KWD-NEW-PPRINT-EQUIVALENT) (CL:EQ TEST-VALUE-000 KWD-NEW-PPRINT-FAIL)))
        (CL:T
         (CL:PROGN (%%PRINT-STREAM (%NATIVE-STREAM STREAM) "<PRE>") (PPRINT-OBJECT SELF (%NATIVE-STREAM STREAM))
...
(CL:DEFUN HELP-STARTUP-NEW-PPRINT1 ()
  (CL:PROGN
   ...
   (CL:SETQ SGT-NEW-PPRINT-LOGIC-PROPOSITION
    (INTERN-RIGID-SYMBOL-WRT-MODULE "PROPOSITION" (GET-STELLA-MODULE "/LOGIC" CL:T) 1))
   ...
   (CL:SETQ SGT-NEW-PPRINT-PL-KERNEL-KB-BAGOF
    (INTERN-RIGID-SYMBOL-WRT-MODULE "BAGOF" (GET-STELLA-MODULE "/PL-KERNEL-KB" CL:T) 1))
   ...
   (CL:SETQ KWD-NEW-PPRINT-PREDICATE (INTERN-RIGID-SYMBOL-WRT-MODULE "PREDICATE" NULL 2))
   (CL:SETQ KWD-NEW-PPRINT-ISA (INTERN-RIGID-SYMBOL-WRT-MODULE "ISA" NULL 2))
   (CL:SETQ KWD-NEW-PPRINT-FUNCTION (INTERN-RIGID-SYMBOL-WRT-MODULE "FUNCTION" NULL 2))
   ...
   (CL:SETQ KWD-NEW-PPRINT-EQUIVALENT (INTERN-RIGID-SYMBOL-WRT-MODULE "EQUIVALENT" NULL 2))
   (CL:SETQ KWD-NEW-PPRINT-FAIL (INTERN-RIGID-SYMBOL-WRT-MODULE "FAIL" NULL 2))
   (CL:SETQ KWD-NEW-PPRINT-CONSTANT (INTERN-RIGID-SYMBOL-WRT-MODULE "CONSTANT" NULL 2))
   (CL:SETQ KWD-NEW-PPRINT-EXISTS (INTERN-RIGID-SYMBOL-WRT-MODULE "EXISTS" NULL 2))
   (CL:SETQ SYM-NEW-PPRINT-LOGIC-IO-VARIABLES
    (INTERN-RIGID-SYMBOL-WRT-MODULE "IO-VARIABLES" (GET-STELLA-MODULE "/LOGIC" CL:T) 0))
   (CL:SETQ KWD-NEW-PPRINT-FORALL (INTERN-RIGID-SYMBOL-WRT-MODULE "FORALL" NULL 2))
   (CL:SETQ KWD-NEW-PPRINT-IMPLIES (INTERN-RIGID-SYMBOL-WRT-MODULE "IMPLIES" NULL 2))
   (CL:SETQ SYM-NEW-PPRINT-LOGIC-COMPLEMENT-DESCRIPTION
    (INTERN-RIGID-SYMBOL-WRT-MODULE "COMPLEMENT-DESCRIPTION" (GET-STELLA-MODULE "/LOGIC" CL:T) 0))
   (CL:SETQ SYM-NEW-PPRINT-LOGIC-FORWARD-ONLY?
    (INTERN-RIGID-SYMBOL-WRT-MODULE "FORWARD-ONLY?" (GET-STELLA-MODULE "/LOGIC" CL:T) 0))
...
(CL:DEFUN STARTUP-NEW-PPRINT ()
  (CL:LET* ((*MODULE* (GET-STELLA-MODULE "/ONTOSAURUS" (> *STARTUP-TIME-PHASE* 1))) (*CONTEXT* *MODULE*))
   (CL:DECLARE (CL:SPECIAL *MODULE* *CONTEXT*)) (CL:WHEN (CURRENT-STARTUP-TIME-PHASE? 2) (HELP-STARTUP-NEW-PPRINT1))
   (CL:WHEN (CURRENT-STARTUP-TIME-PHASE? 4) (CL:SETQ REUSABLE-SKOLEM-MAPPING-TABLE (NEW-KEY-VALUE-MAP)))
   (CL:WHEN (CURRENT-STARTUP-TIME-PHASE? 6) (FINALIZE-CLASSES))
   (CL:WHEN (CURRENT-STARTUP-TIME-PHASE? 7)
    (DEFINE-FUNCTION-OBJECT "PPRINT-NEWLINE" "(DEFUN PPRINT-NEWLINE ((STREAM NATIVE-OUTPUT-STREAM)))"
     (CL:FUNCTION PPRINT-NEWLINE) NULL)
    (DEFINE-FUNCTION-OBJECT "PPRINT-ATOMIC-OBJECT"
     "(DEFUN PPRINT-ATOMIC-OBJECT ((SELF OBJECT) (STREAM NATIVE-OUTPUT-STREAM)))" (CL:FUNCTION PPRINT-ATOMIC-OBJECT)
     NULL)
    ...
    (DEFINE-FUNCTION-OBJECT "PPRINT-AS-ATOMIC-OBJECT?" "(DEFUN (PPRINT-AS-ATOMIC-OBJECT? BOOLEAN) ((SELF OBJECT)))"
    ...
    (DEFINE-FUNCTION-OBJECT "PPRINT-OBJECT" "(DEFUN PPRINT-OBJECT ((SELF OBJECT) (STREAM NATIVE-OUTPUT-STREAM)))"
    ...
    (DEFINE-FUNCTION-OBJECT "SHORT-TERM?" "(DEFUN (SHORT-TERM? BOOLEAN) ((ARG OBJECT)))" (CL:FUNCTION SHORT-TERM?)
     NULL)
    (DEFINE-FUNCTION-OBJECT "OPERATOR-TO-STRING" "(DEFUN (OPERATOR-TO-STRING STRING) ((OPERATOR OBJECT)))"
    ...
    (DEFINE-FUNCTION-OBJECT "PPRINT-PROPOSITION"
     "(DEFUN PPRINT-PROPOSITION ((SELF PROPOSITION) (STREAM NATIVE-OUTPUT-STREAM)))" (CL:FUNCTION PPRINT-PROPOSITION)
     NULL)
    ...
    (DEFINE-FUNCTION-OBJECT "PPRINT-DESCRIPTION"
     "(DEFUN PPRINT-DESCRIPTION ((SELF DESCRIPTION) (STREAM NATIVE-OUTPUT-STREAM)))" (CL:FUNCTION PPRINT-DESCRIPTION)
     NULL)
    ...
    (DEFINE-FUNCTION-OBJECT "PPRINT-STELLA-CONS"
     "(DEFUN PPRINT-STELLA-CONS ((SELF CONS) (STREAM NATIVE-OUTPUT-STREAM)))" (CL:FUNCTION PPRINT-STELLA-CONS) NULL)
    ...
    (DEFINE-FUNCTION-OBJECT "PPRINT-ONTOSAURUS-OBJECT"
     "(DEFUN PPRINT-ONTOSAURUS-OBJECT ((SELF OBJECT) (STREAM OUTPUT-STREAM)))" (CL:FUNCTION PPRINT-ONTOSAURUS-OBJECT)
     NULL)
    (DEFINE-FUNCTION-OBJECT "STARTUP-NEW-PPRINT" "(DEFUN STARTUP-NEW-PPRINT () :PUBLIC? TRUE)"
     (CL:FUNCTION STARTUP-NEW-PPRINT) NULL)
    (CL:LET* ((FUNCTION (LOOKUP-FUNCTION SYM-NEW-PPRINT-ONTOSAURUS-STARTUP-NEW-PPRINT)))
     (SET-DYNAMIC-SLOT-VALUE (%DYNAMIC-SLOTS FUNCTION) SYM-NEW-PPRINT-STELLA-METHOD-STARTUP-CLASSNAME
