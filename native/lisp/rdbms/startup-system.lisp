  ...
  (WITH-PROCESS-LOCK *BOOTSTRAP-LOCK*
   ...
   (CL:LET* ((*MODULE* (GET-STELLA-MODULE "/RDBMS" (> *STARTUP-TIME-PHASE* 1))) (*CONTEXT* *MODULE*))
    ...
    (CL:WHEN (CURRENT-STARTUP-TIME-PHASE? 2)
     (CL:SETQ SYM-STARTUP-SYSTEM-RDBMS-STARTUP-RDBMS-SYSTEM
      (INTERN-RIGID-SYMBOL-WRT-MODULE "STARTUP-RDBMS-SYSTEM" NULL 0))
    ...
    (CL:WHEN (CURRENT-STARTUP-TIME-PHASE? 7)
     (DEFINE-FUNCTION-OBJECT "STARTUP-RDBMS-SYSTEM" "(DEFUN STARTUP-RDBMS-SYSTEM () :PUBLIC? TRUE)"
    ...
    (CL:WHEN (CURRENT-STARTUP-TIME-PHASE? 9) (%IN-MODULE (COPY-CONS-TREE (WRAP-STRING "/RDBMS")))
     (CL:LET* ((PHASE NULL-INTEGER) (ITER-000 0) (UPPER-BOUND-001 9))
      ...
      (CL:LOOP WHILE (CL:<= ITER-000 UPPER-BOUND-001) DO (CL:SETQ PHASE ITER-000) (CL:SETQ *STARTUP-TIME-PHASE* PHASE)
       (STARTUP-ONTOLOGY) (STARTUP-RDBMS) (STARTUP-FETCH-INTERFACE) (CL:SETQ ITER-000 (CL:1+ ITER-000))))
