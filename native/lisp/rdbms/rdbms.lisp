...
(CL:DECLAIM
  ...
  *CHARACTER-TYPE-TABLE* *QUERYITERATOR* TRUE-TRUTH-VALUE *REVERSEPOLARITY?*
  *MEMOIZATION-ENABLED?* MEMOIZED-NULL-VALUE TRUE-WRAPPER FALSE-WRAPPER
  *CONTEXT* *MODULE* EOL NULL-INTEGER NIL STANDARD-ERROR))
...
Expects the same arguments as `deftable' but supplied as a list."
  (CL:LET*
   ((RELCONST (%%VALUE ARGUMENTS)) (DBCONST (%%VALUE (%%REST ARGUMENTS)))
    ...
    (DBAXIOMS
     (LIST*
      (LIST* SYM-RDBMS-RDBMS-RELATION-TABLE RELCONST (CONS TABLENAME NIL))
...
(CL:DEFUN PARSE-ONE-COLUMN-SPEC (COLUMNSPEC)
  (CL:LET*
   ((PARSEDCOLUMN (NEW-PROPERTY-LIST)) (VAR NULL) (NAME NULL) (OPTIONS NIL)
    (OPTIONSPLIST NULL) (TYPE NULL))
      ...
      (CL:LET* ((STREAM-000 (NEW-OUTPUT-STRING-STREAM)))
       (CL:LET* ((*PRINTREADABLY?* CL:T))
        ...
        (%%PRINT-STREAM (%NATIVE-STREAM STREAM-000)
         "PARSING ERROR: Illegal table column specification: `" COLUMNSPEC
         "'." EOL)
   ...
   (CL:COND
    ...
    (CL:T (CL:SETQ NAME (WRAP-STRING (%SYMBOL-NAME VAR)))
     (CL:SETQ VAR
      (INTERN-DERIVED-SYMBOL VAR (CONCATENATE "?" (%WRAPPER-VALUE NAME))))))
  ...
  (CL:WHEN (CL:NOT (CONS? COLUMNSPECS))
   (CL:LET* ((STREAM-000 (NEW-OUTPUT-STRING-STREAM)))
    (CL:LET* ((*PRINTREADABLY?* CL:T))
     (CL:DECLARE (CL:SPECIAL *PRINTREADABLY?*))
     (%%PRINT-STREAM (%NATIVE-STREAM STREAM-000)
      "PARSING ERROR: Illegal variable/column specifications: `" COLUMNSPECS
      "'." EOL)
     (HELP-SIGNAL-PROPOSITION-ERROR STREAM-000 KWD-RDBMS-ERROR))
    (CL:ERROR (NEW-PARSING-ERROR (THE-STRING-READER STREAM-000)))))
  (CL:LET* ((RELATIONARGS NIL) (AXIOMS NIL))
   (CL:LET*
    ((COLUMNSPEC NULL) (ITER-000 COLUMNSPECS) (I NULL-INTEGER) (ITER-001 1))
...
Expects the same arguments as `defdb' but supplied as a list."
  (CL:LET*
   ((DEFINITION (CONS SYM-RDBMS-RDBMS-DEFDB (CONCATENATE ARGUMENTS NIL)))
   ...
   (CL:LET* ((*TERMSOURCEBEINGPARSED* (STRINGIFY DEFINITION)))
    ...
    (CL:SETF (%%REST ARGUMENTS)
     (CONCATENATE RELATIONOPTIONS (LIST* KWD-RDBMS-AXIOMS DBAXIOMS NIL)))
...
(CL:DEFUN EXTRACT-RDBMS-OPTIONS (SELFNAME OPTIONS)
  (CL:LET* ((SELF-000 (NEW-PROPERTY-LIST)))
   ...
   (CL:LET*
    ((SOURCEOPTIONS SELF-000) (RDBMSMODULE (GET-STELLA-MODULE "RDBMS" CL:T))
     (RELATIONREF NULL) (RELATION NULL) (AXIOMS NIL) (OTHEROPTIONS NIL))
    (CL:LET* ((KEY NULL) (VALUE NULL) (ITER-000 (%THE-PLIST SOURCEOPTIONS)))
     (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-000 NIL)) DO
      ...
      (CL:TAGBODY
       (CL:WHEN (KEYWORD? KEY)
        (CL:SETQ RELATIONREF
         (LOOKUP-SURROGATE-IN-MODULE (%SYMBOL-NAME KEY) RDBMSMODULE CL:T))
        (CL:WHEN (CL:NOT (CL:EQ RELATIONREF NULL))
         ...
         (CL:WHEN (CL:NOT (CL:EQ RELATION NULL))
          (CL:COND
           ((CONS? VALUE)
            (CL:SETQ AXIOMS
             (CONS (CONS (DESCRIPTION-NAME RELATION) (CONS SELFNAME VALUE))
              AXIOMS)))
           (CL:T
  ...
  (CL:LET*
   ((THEOPTIONS
     (PARSE-LOGIC-COMMAND-OPTIONS OPTIONS
      (LIST* KWD-RDBMS-CONNECTION-STRING SGT-RDBMS-STELLA-STRING
       ...
       KWD-RDBMS-ODBC-CONNECTION-STRING SGT-RDBMS-STELLA-STRING KWD-RDBMS-DSN
       SGT-RDBMS-STELLA-STRING KWD-RDBMS-DB SGT-RDBMS-STELLA-STRING
       KWD-RDBMS-HOST SGT-RDBMS-STELLA-STRING KWD-RDBMS-PORT
       SGT-RDBMS-STELLA-INTEGER KWD-RDBMS-USER SGT-RDBMS-STELLA-STRING
       KWD-RDBMS-PASSWORD SGT-RDBMS-STELLA-STRING KWD-RDBMS-MODULE
       SGT-RDBMS-STELLA-MODULE KWD-RDBMS-CONFIGURATION
    ...
    (ASSERTION-TEMPLATE
     (INSTANTIATE-STRING-TEMPLATE
      ...
      "#$HOST" (CL:IF (CL:NOT (CL:EQ HOST NULL)) (%WRAPPER-VALUE HOST) "")
      "#$PORT"
      (CL:IF (CL:NOT (CL:EQ PORT NULL))
       (INTEGER-TO-STRING (CL:TRUNCATE (%WRAPPER-VALUE PORT))) "")
      "#$USER" (CL:IF (CL:NOT (CL:EQ USER NULL)) (%WRAPPER-VALUE USER) "")
      "#$PWD"
   ...
   (CL:WHEN (CL:NOT (CL:EQ CON-STRING NULL))
    (PLI::S-ASSERT-PROPOSITION
     (INSTANTIATE-STRING-TEMPLATE
      "(RDBMS/#$PROTOCOL-CONNECTION-STRING #$DB \"#$CON\")" "#$PROTOCOL"
      (CL:IF (ODBC-CONNECTION-STRING? (%WRAPPER-VALUE CON-STRING)) "ODBC"
       "JDBC")
...
Expects the same arguments as `deftable' but supplied as a list."
  (CL:LET*
   ((DEFINITION (CONS SYM-RDBMS-RDBMS-DEFQUERY (CONCATENATE ARGUMENTS NIL)))
   ...
   (CL:LET* ((*TERMSOURCEBEINGPARSED* (STRINGIFY DEFINITION)))
    ...
    (CL:SETF (%%REST (%%REST ARGUMENTS))
     (CONCATENATE RELATIONOPTIONS (LIST* KWD-RDBMS-AXIOMS QUERYAXIOMS NIL)))
    ...
    ((SUBTYPE-OF-INTEGER? TEST-VALUE-000)
     (CL:PROGN
      (CL:IF (NULL-WRAPPER? ARG) NULL
       (WRAP-STRING (INTEGER-TO-STRING (CL:TRUNCATE (%WRAPPER-VALUE ARG)))))))
...
(CL:DEFUN CONNECT-TO-DATABASE (DATABASE)
  (CL:LET*
   ...
   (CL:LET*
    ((TEMP-000
      (ACCESS-BINARY-VALUE DATABASE SGT-RDBMS-RDBMS-ODBC-CONNECTION-STRING)))
    (CL:LET*
     ((CONNECTIONSTRING
     ...
     (CL:SETQ CONNECTION
      (%CONNECT
       (CONS-LIST KWD-RDBMS-PROTOCOL (NORMALIZE-CONNECTION-ARGUMENT PROTOCOL)
        KWD-RDBMS-SERVER-TYPE (NORMALIZE-CONNECTION-ARGUMENT SERVERTYPE)
        KWD-RDBMS-DSN (NORMALIZE-CONNECTION-ARGUMENT DSN) KWD-RDBMS-DB-NAME
...
(CL:DEFUN DISCONNECT-FROM-DATABASE (DATABASE)
  (CL:LET*
   ((CONNECTION (ACCESS-BINARY-VALUE DATABASE SGT-RDBMS-RDBMS-DB-CONNECTION)))
   (CL:COND
...
(CL:DEFUN RESULT-SET-ITERATOR-NEXT? (SELF)
  (CL:LET*
   ...
   (CL:COND
    ((NEXT? RESULTSET)
     (CL:SETF (%VALUE SELF) (COERCE-VALUES (%VALUE RESULTSET) TABLEINFO))
     CL:T)
    (CL:T CL:NIL))))
  ...
  (CL:LET* ((VALUE-000 NIL))
   (CL:LET*
    ...
    (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-000 NIL)) DO
     ...
     (CL:IF (CL:EQ COLLECT-000 NULL)
      (CL:PROGN
       (CL:SETQ COLLECT-000 (CONS (WRAP-STRING (%COLUMN-NAME COLUMN)) NIL))
...
(CL:DEFUN NEW-RELATION-TABLE-INFO ()
  (CL:LET* ((SELF NULL))
   ...
   (CL:SETF (%COLUMN-VECTOR SELF) NULL) (CL:SETF (%COLUMN-LIST SELF) NULL)
...
(CL:DEFCLASS RELATION-COLUMN-INFO (STANDARD-OBJECT)
  ((TABLE-INFO :ALLOCATION :INSTANCE :ACCESSOR %TABLE-INFO)
   ...
   (COLUMN-INDEX :TYPE CL:FIXNUM :INITFORM NULL-INTEGER :ALLOCATION :INSTANCE
   ...
   (MODULE-REFERENCE :TYPE CL:SIMPLE-STRING :INITFORM STELLA::NULL-STRING
    :ALLOCATION :INSTANCE :ACCESSOR %MODULE-REFERENCE)
...
(CL:DEFUN ACCESS-RELATION-COLUMN-INFO-SLOT-VALUE (SELF SLOTNAME VALUE SETVALUE?)
  (CL:COND
   ...
   ((CL:EQ SLOTNAME SYM-RDBMS-RDBMS-MODULE-LOCAL?)
    (CL:IF SETVALUE?
     (CL:SETF (%MODULE-LOCAL? SELF) (COERCE-WRAPPED-BOOLEAN-TO-BOOLEAN VALUE))
     (CL:SETQ VALUE
   ...
   (CL:LET*
    ...
    (CL:SETF (%DBMS-NAME TABLEINFO)
     (CL:IF (CL:NOT (CL:EQ (%DATABASE TABLEINFO) NULL))
      (GET-DBMS-NAME (GET-CONNECTION-FROM-DATABASE (%DATABASE TABLEINFO)))
      KWD-RDBMS-UNKNOWN))
    ...
    (CL:LET*
     ...
     (CL:LOOP WHILE
      ...
      (INSERT-AT (%COLUMN-INDEX TABLEINFO) (WRAP-STRING (%SYMBOL-NAME VAR))
       COLUMNINFO)
      (CL:IF (CL:EQ COLLECT-000 NULL)
...
(CL:DEFUN GET-RELATION-TABLE-INFO (TABLERELATION)
  (CL:LET*
   ...
   (CL:COND
    ...
    (CL:T
     (CL:SETQ MEMOIZED-VALUE-000 (CREATE-RELATION-TABLE-INFO TABLERELATION))
     (CL:WHEN *MEMOIZATION-ENABLED?*
...
(CL:DEFUN PRINT-SQL-VALUE (STREAM VALUE COLUMN)
  (CL:LET*
   ...
   (CL:COND
    ...
    ((CL:OR
      (SUBRELATION-OF? TARGET-TYPE (GET-DESCRIPTION SGT-RDBMS-STELLA-NUMBER))
...
(CL:DEFUN PRINT-COLUMN-CONSTRAINT (SQL COLUMN VALUE CASESENSITIVE?)
  ...
  (CL:LET*
   ((TABLEINFO (%TABLE-INFO COLUMN)) (TABLEALIAS (%TABLE-ALIAS TABLEINFO))
...
(CL:DEFUN PRINT-ARGUMENT-CONSTRAINT (SQL ARGUMENT COLUMN)
  (CL:LET*
   ((COLUMNTYPE (%COLUMN-TYPE COLUMN)) (ARGNAME (OBJECT-SURROGATE ARGUMENT))
    (ARGMODULE
     (CL:IF (CL:NOT (CL:EQ ARGNAME NULL)) (%HOME-CONTEXT ARGNAME) NULL))
    (MODULEREFCOLUMN (%MODULE-REFERENCE-COLUMN COLUMN))
    (CASESENSITIVE?
     (CL:OR
      (CL:AND (CL:NOT (CL:EQ ARGMODULE NULL)) (%CASE-SENSITIVE? ARGMODULE))
     ...
     (CL:LET*
      ...
      (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-000 NIL)) DO
       ...
       (PRINT-COLUMN-CONSTRAINT SQL COLUMN
        (COERCE-POWERLOOM-OBJECT-TO-STRING SUBARG COLUMNTYPE) CASESENSITIVE?)
       (CL:SETQ ITER-000 (%%REST ITER-000))
       (CL:SETQ ITER-001 (CL:1+ ITER-001))))
     (%%PRINT-STREAM (%NATIVE-STREAM SQL) ")"))
    (CL:T
   ...
   (CL:WHEN
    ...
    (PRINT-COLUMN-CONSTRAINT SQL MODULEREFCOLUMN (%MODULE-NAME ARGMODULE)
     CL:NIL))))
  ...
  (CL:LET* ((FIRST? CL:T))
   (CL:LET*
    ((COLUMN NULL) (ITER-000 (%COLUMN-LIST TABLE-INFO)) (ARG NULL)
     (VECTOR-000 ARGUMENTS) (INDEX-000 0) (LENGTH-000 (LENGTH VECTOR-000)))
...
(CL:DECLAIM
 (CL:FTYPE (CL:FUNCTION (CL:T) CL:SIMPLE-STRING) CREATE-SQL-FROM-PROPOSITION))
(CL:DEFUN CREATE-SQL-FROM-PROPOSITION (PROPOSITION)
  (CL:LET*
   ((RELATION (GET-DESCRIPTION (%OPERATOR PROPOSITION)))
    ...
    (TABLEALIAS (%TABLE-ALIAS TABLEINFO)) (ARGUMENTS (%ARGUMENTS PROPOSITION))
   ...
   (%%PRINT-STREAM (%NATIVE-STREAM SQL) " FROM " (%TABLE-NAME TABLEINFO))
   (CL:WHEN (CL:NOT (CL:EQ TABLEALIAS STELLA::NULL-STRING))
...
(CL:DEFUN ALLOCATE-DBTABLE-SPECIALIST-ITERATOR (FRAME)
  (CL:WHEN
   (CL:EQ
    ...
    NULL)
   (CL:LET*
    ((PROPOSITION (%PROPOSITION FRAME)) (RELATIONREF (%OPERATOR PROPOSITION))
     ...
     (CL:LET*
      ...
      (CL:LOOP WHILE
       ...
       (CL:COND ((CL:EQ COL NULL) (CL:SETQ NONULLS? CL:NIL))
        ((CL:NOT (CL:EQ BINDING NULL)) (CL:SETQ COL BINDING)))
       (CL:IF (CL:EQ COLLECT-000 NULL)
     ...
     (CL:T
      (CL:SETQ MEMOIZED-VALUE-000
       (APPLY-CACHED-RETRIEVE
        (LIST* SYM-RDBMS-RDBMS-?REL SYM-RDBMS-RDBMS-?EV SYM-RDBMS-RDBMS-?DB
         SYM-RDBMS-RDBMS-?ARGS NIL)
        (LIST* SYM-RDBMS-STELLA-AND
         (LIST* SYM-RDBMS-RDBMS-QUERY-PATTERN SYM-RDBMS-RDBMS-?REL
          SYM-RDBMS-RDBMS-?EV SYM-RDBMS-RDBMS-?DB SYM-RDBMS-RDBMS-?ARGS NIL)
        ...
        (CONS-LIST KWD-RDBMS-DONT-OPTIMIZE? TRUE-WRAPPER KWD-RDBMS-HOW-MANY
         KWD-RDBMS-ALL KWD-RDBMS-INFERENCE-LEVEL KWD-RDBMS-ASSERTION)
       ...
       (CL:LET* ((CODE (FUNCTION-CODE-FROM-PROCEDURE (%%VALUE TRIPLE))))
        (CL:WHEN (CL:NOT (CL:EQ CODE NULL))
         (CL:SETQ EVALUATORFORMS
          (CONS
           (CONS-LIST (WRAP-FUNCTION-CODE CODE) (%%VALUE (%%REST TRIPLE))
   ...
   (CL:COND
    ((CL:EQ (SAFE-PRIMARY-TYPE ARGS) SGT-RDBMS-STELLA-CONS)
     (CL:PROGN
           ...
           (CONS
            (CL:IF (CONS? TABLE)
             (CONS (WRAP-STRING (COERCE-TO-STRING (%%VALUE TABLE)))
              (CONS (WRAP-STRING (COERCE-TO-STRING (%%VALUE (%%REST TABLE))))
               NIL))
      ...
      (CL:LET*
       ((PAIR NULL) (ITER-005 (%%VALUE (%%REST ARGS))) (COLLECT-001 NULL))
...
(CL:DEFUN HELP-MEMOIZE-SQL-JOIN (PROPOSITION DATABASE ARGUMENTS)
  (CL:LET*
   ((RELATION (GET-DESCRIPTION (%OPERATOR PROPOSITION)))
    (TABLEINFO (GET-RELATION-TABLE-INFO RELATION)) (TABLES NIL) (JOINARGS NIL)
    (SQL (NEW-OUTPUT-STRING-STREAM)))
   ...
   (CL:LET* ((TABLE NULL) (ITER-002 TABLES) (I NULL-INTEGER) (ITER-003 1))
   ...
   (CL:LET* ((PAIR NULL) (ITER-004 JOINARGS) (I NULL-INTEGER) (ITER-005 1))
    ...
    (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-004 NIL)) DO
     ...
     (%%PRINT-STREAM (%NATIVE-STREAM SQL) (UNWRAP-STRING (%%VALUE PAIR)) "="
   ...
   (CL:LET*
    ...
    (CL:DECLARE (CL:TYPE CL:FIXNUM INDEX-000 LENGTH-000))
    (CL:LOOP WHILE
     (CL:AND (CL:< INDEX-000 LENGTH-000) (CL:NOT (CL:EQ ITER-006 NIL))) DO
     (CL:SETQ ARG
      (CL:AREF (CL:THE CL:SIMPLE-VECTOR (%THE-ARRAY VECTOR-000)) INDEX-000))
   ...
   (ALLOCATE-RESULT-SET-ITERATOR (GET-CONNECTION-FROM-DATABASE DATABASE)
    RELATION (THE-STRING-READER SQL))))
...
(CL:DEFUN COLLECT-VARIABLE-BINDING (NAME TYPE BINDING BINDINGS)
  ...
  (CL:WHEN (CL:NOT (CL:EQ BINDING NULL))
   (CL:WHEN (CL:NOT (CL:EQ TYPE NULL)) (CL:SETQ TYPE (GET-DESCRIPTION TYPE)))
   (CL:COND
    ((COLLECTION-VALUED-CONSTRAINT? BINDING)
     (CL:LET* ((ARGS NIL))
      (CL:LET*
       ((ELT NULL) (ITER-000 (COLLECTION-VALUED-CONSTRAINT-ELEMENTS BINDING))
        (COLLECT-000 NULL))
       (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-000 NIL)) DO
        ...
        (CL:IF (CL:EQ COLLECT-000 NULL)
         (CL:PROGN
          (CL:SETQ COLLECT-000
           (CONS (WRAP-STRING (COERCE-POWERLOOM-OBJECT-TO-STRING ELT TYPE))
            NIL))
...
(CL:DEFUN CREATE-SQL-QUERY-FROM-PROPOSITION (PROPOSITION DATABASE ARGUMENTS)
  ...
  (CL:LET*
   ((RELATION (GET-DESCRIPTION (%OPERATOR PROPOSITION)))
    (TEMPLATE (%WRAPPER-VALUE ARGUMENTS)) (BINDINGS (NEW-KEY-VALUE-LIST))
    (SQL STELLA::NULL-STRING))
   (CL:DECLARE (CL:TYPE CL:SIMPLE-STRING TEMPLATE SQL))
   (CL:LET*
    ((VAR NULL) (ITER-000 (%THE-CONS-LIST (%IO-VARIABLE-NAMES RELATION)))
     (ARG NULL) (VECTOR-000 (%ARGUMENTS PROPOSITION)) (INDEX-000 0)
    ...
    (CL:LOOP WHILE
     ...
     (COLLECT-VARIABLE-BINDING (%SYMBOL-NAME VAR)
      (PLI::GET-NTH-DOMAIN RELATION I) (SAFE-ARGUMENT-BOUND-TO ARG) BINDINGS)
     (CL:SETQ ITER-000 (%%REST ITER-000))
     (CL:SETQ INDEX-000 (CL:1+ INDEX-000))
     (CL:SETQ ITER-001 (CL:1+ ITER-001))))
    ...
    (CL:TAGBODY (CL:SETQ VARSTART (POSITION SQL #\? VAREND))
     (CL:WHEN (CL:= VARSTART NULL-INTEGER)
      (CL:COND
       ...
       (CL:T
        (CL:SETQ RESULT
         (CONS (WRAP-STRING (SUBSEQUENCE SQL START NULL-INTEGER)) RESULT))
        (CL:RETURN))))
     ...
     (CL:WHEN
      ...
      (CL:SETQ CONSTRAINT KWD-RDBMS-SET)
      (CL:SETQ RESULT
       (CONS (WRAP-STRING (SUBSEQUENCE SQL START (CL:1+ COLSTART))) RESULT))
     ...
     (CL:COND
      ...
      ((CL:EQ CONSTRAINT KWD-RDBMS-SET)
       ...
       (CL:LET* ((SET (NEW-OUTPUT-STRING-STREAM)))
        ...
        (CL:LET*
         ((ELT NULL) (ITER-001 (CONSIFY VALUE)) (I NULL-INTEGER) (ITER-002 1))
      ...
      (CL:T
       ...
       (CL:SETQ RESULT
        (CONS
         (CL:IF (DEFINED? QUOTE)
          (WRAP-STRING (SQL-ESCAPE-STRING (%WRAPPER-VALUE VALUE) QUOTE))
          VALUE)
         RESULT))))
...
(CL:DEFUN ALLOCATE-QUERY-SPECIALIST-ITERATOR (FRAME)
  (CL:WHEN
   (CL:EQ
    ...
    NULL)
   (CL:LET*
    ((ITERATOR NULL) (ITERATOR2 NULL) (PROPOSITION (%PROPOSITION FRAME))
     (RELATIONREF (%OPERATOR PROPOSITION)))
    (CL:LET*
     ((TRIPLE NULL) (ITER-000 (GET-QUERY-PATTERN-EVALUATORS RELATIONREF)))
     (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-000 NIL)) DO
      (CL:SETQ TRIPLE (%%VALUE ITER-000))
      (CL:COND
       ((CL:EQ ITERATOR NULL)
        (CL:SETQ ITERATOR
         (CL:FUNCALL (%WRAPPER-VALUE (%%VALUE TRIPLE)) PROPOSITION
          (%%VALUE (%%REST TRIPLE)) (%%VALUE (%%REST (%%REST TRIPLE))))))
       (CL:T
        (CL:SETQ ITERATOR2
         (CL:FUNCALL (%WRAPPER-VALUE (%%VALUE TRIPLE)) PROPOSITION
          (%%VALUE (%%REST TRIPLE)) (%%VALUE (%%REST (%%REST TRIPLE)))))
    ...
    (CL:LET* ((ALWAYS?-000 CL:T))
     (CL:LET*
      ((OUTPUT NULL) (ITER-000 (%VALUE ITERATOR)) (I NULL-INTEGER)
       (ITER-001 FIRSTARGINDEX) (UPPER-BOUND-000 (CL:1- (LENGTH ARGUMENTS))))
  ...
  (CL:LET*
   ...
   (CL:WHEN
    ...
    (CL:LET* ((BINDINGS (COLLECT-QUERY-DATABASE-SPECIALIST-BINDINGS FRAME 2)))
     ...
     (CL:SETQ QUERY
      (WRAP-STRING
       (SQL-QUERY-INSTANTIATE-CONSTRAINTS (%WRAPPER-VALUE QUERY) BINDINGS)))
     (SET-DYNAMIC-SLOT-VALUE (%DYNAMIC-SLOTS FRAME) SYM-RDBMS-STELLA-ITERATOR
...
(CL:DEFUN DB-UPDATE-DEMON (DBPROPOSITION)
  (CL:LET*
   ((DB
     (CL:AREF
      (CL:THE CL:SIMPLE-VECTOR (%THE-ARRAY (%ARGUMENTS DBPROPOSITION))) 0)))
  ...
  (CL:LET* ((RESULT NIL) (MODULE NULL) (LOCAL? CL:NIL))
   (CL:LET*
    ...
    (CL:LOOP WHILE
     ...
     (CL:SETQ VALUE (%%VALUE ITER-000)) (CL:SETQ COLUMN (%%VALUE ITER-001))
...
(CL:DEFUN COERCE-STRING-TO-POWERLOOM-OBJECT (VALUE TYPE MODULE LOCAL?)
  ...
  (CL:LET*
   ...
   (CL:COND
    ...
    (CL:T
     (CL:WARN
      "RDBMS: Don't yet know how to coerce string \"`~A'\" to type `~A'" VALUE
      TYPENAME)))
   RESULT))
...
(CL:DEFUN COERCE-POWERLOOM-OBJECT-TO-STRING (OBJECT TYPE)
  ...
  (CL:LET* ((*PRINTREADABLY?* CL:T))
   ...
   (CL:LET* ((TEST-VALUE-000 (SAFE-PRIMARY-TYPE OBJECT)))
    (CL:COND
     ((SUBTYPE-OF-STRING? TEST-VALUE-000) (CL:PROGN (%WRAPPER-VALUE OBJECT)))
     ((SUBTYPE-OF? TEST-VALUE-000 SGT-RDBMS-LOGIC-LOGIC-OBJECT)
...
if it does not yet exist.  If `local?' do not look into any inherited modules."
  ...
  (CL:LET*
   ((INSTANCEREF (LOOKUP-SURROGATE-IN-MODULE NAME MODULE LOCAL?))
    (VALUE
     (CL:IF (CL:NOT (CL:EQ INSTANCEREF NULL)) (%SURROGATE-VALUE INSTANCEREF)
      NULL))
    (TYPEREF NULL))
   (CL:COND
    ((CL:NOT (CL:EQ VALUE NULL))
     (CL:IF (STELLA-CLASS? VALUE)
      (CL:RETURN-FROM FIND-OR-CREATE-INSTANCE (CLASS.GET-DESCRIPTION VALUE))
      (CL:RETURN-FROM FIND-OR-CREATE-INSTANCE VALUE)))
    ((CL:EQ INSTANCEREF NULL)
     (CL:SETQ INSTANCEREF (INTERN-SURROGATE-IN-MODULE NAME MODULE LOCAL?))))
   (CL:SETQ TYPEREF (OBJECT-SURROGATE TYPE))
   (CL:WHEN (CL:EQ TYPEREF SGT-RDBMS-STELLA-THING) (CL:SETQ TYPEREF NULL))
   (CL:LET* ((*MODULE* MODULE) (*CONTEXT* *MODULE*))
    (CL:DECLARE (CL:SPECIAL *MODULE* *CONTEXT*))
...
(CL:DEFUN CREATE-SQL-ASSERTION-FROM-PROPOSITION (PROPOSITION MODE)
  (CL:LET*
   ((RELATION-REF (GET-PROPOSITION-BASE-OPERATOR PROPOSITION))
    ...
    (FUNCTION-VALUE NULL) (ARGUMENTS NULL) (SQL (NEW-OUTPUT-STRING-STREAM))
    (FIRST? CL:T))
   ...
   (CL:IF ISFUNCTION?
    (CL:PROGN
     ...
     (CL:LET*
      ...
      (CL:SETQ ARGUMENTS
       (NEW-VECTOR
        (CL:IF (CL:EQ MODE KWD-RDBMS-CLIP) (CL:1- ARGS-LENGTH) ARGS-LENGTH)))
      (CL:LET*
       ((I NULL-INTEGER) (ITER-000 0) (UPPER-BOUND-000 (CL:- ARGS-LENGTH 2)))
       (CL:DECLARE (CL:TYPE CL:FIXNUM I ITER-000 UPPER-BOUND-000))
       (CL:LOOP WHILE (CL:<= ITER-000 UPPER-BOUND-000) DO (CL:SETQ I ITER-000)
        (CL:LET
         ((SELF (%THE-ARRAY ARGUMENTS))
          (VALUE (CL:AREF (CL:THE CL:SIMPLE-VECTOR (%THE-ARRAY ARGS)) I))
          (POSITION I))
   ...
   (CL:COND
    ((CL:EQ MODE KWD-RDBMS-ASSERT)
     ...
     (CL:LET*
      ...
      (CL:DECLARE (CL:TYPE CL:FIXNUM INDEX-000 LENGTH-000))
      (CL:LOOP WHILE
       (CL:AND (CL:NOT (CL:EQ ITER-001 NIL)) (CL:< INDEX-000 LENGTH-000)) DO
       ...
       (PRINT-SQL-VALUE SQL ARG COLUMN) (CL:SETQ ITER-001 (%%REST ITER-001))
       (CL:SETQ INDEX-000 (CL:1+ INDEX-000))))
     (%%PRINT-STREAM (%NATIVE-STREAM SQL) ")"))
...
(CL:DEFUN DB-RELATION-GOES-TRUE (PROPOSITION)
  (CL:LET*
   ...
   (CL:IF
    (CL:AND *CLIPPINGENABLED?* (FUNCTION? (GET-DESCRIPTION BASE-RELATION)))
    (%EXECUTE-SQL CONNECTION
     (WRAP-STRING
      (CREATE-SQL-ASSERTION-FROM-PROPOSITION PROPOSITION KWD-RDBMS-CLIP))
     NIL)
    (%EXECUTE-SQL CONNECTION
     (WRAP-STRING
      (CREATE-SQL-ASSERTION-FROM-PROPOSITION PROPOSITION KWD-RDBMS-RETRACT))
     NIL))
   (%EXECUTE-SQL CONNECTION
    (WRAP-STRING
     (CREATE-SQL-ASSERTION-FROM-PROPOSITION PROPOSITION KWD-RDBMS-ASSERT))
    NIL)))
...
(CL:DEFUN HELP-STARTUP-RDBMS1 ()
  (CL:PROGN
   ...
   (CL:SETQ SYM-RDBMS-LOGIC-?X
    (INTERN-RIGID-SYMBOL-WRT-MODULE "?X" (GET-STELLA-MODULE "/LOGIC" CL:T) 0))
...
(CL:DEFUN HELP-STARTUP-RDBMS2 ()
  (CL:PROGN
   ...
   (CL:SETQ SGT-RDBMS-RDBMS-F-GET-RELATION-TABLE-INFO-MEMO-TABLE-000
    (INTERN-RIGID-SYMBOL-WRT-MODULE "F-GET-RELATION-TABLE-INFO-MEMO-TABLE-000"
     NULL 1))
   ...
   (CL:SETQ SYM-RDBMS-RDBMS-F-GET-QUERY-PATTERN-EVALUATORS-QUERY-000
    (INTERN-RIGID-SYMBOL-WRT-MODULE "F-GET-QUERY-PATTERN-EVALUATORS-QUERY-000"
     NULL 0))
   ...
   (CL:SETQ SYM-RDBMS-RDBMS-F-GET-QUERY-PATTERN-EVALUATORS-QUERY-001
    (INTERN-RIGID-SYMBOL-WRT-MODULE "F-GET-QUERY-PATTERN-EVALUATORS-QUERY-001"
     NULL 0))
...
if it does not yet exist.  If `local?' do not look into any inherited modules.\" :PUBLIC? TRUE)"
    ...
    (DEFINE-FUNCTION-OBJECT "STARTUP-RDBMS"
     "(DEFUN STARTUP-RDBMS () :PUBLIC? TRUE)" (CL:FUNCTION STARTUP-RDBMS)
     NULL)
    (CL:LET* ((FUNCTION (LOOKUP-FUNCTION SYM-RDBMS-RDBMS-STARTUP-RDBMS)))
     (SET-DYNAMIC-SLOT-VALUE (%DYNAMIC-SLOTS FUNCTION)
      SYM-RDBMS-STELLA-METHOD-STARTUP-CLASSNAME (WRAP-STRING "_StartupRdbms")
      NULL-STRING-WRAPPER)))
   (CL:WHEN (CURRENT-STARTUP-TIME-PHASE? 8) (FINALIZE-SLOTS)
    (CLEANUP-UNFINALIZED-CLASSES))
   (CL:WHEN (CURRENT-STARTUP-TIME-PHASE? 9)
    (%IN-MODULE (COPY-CONS-TREE (WRAP-STRING "RDBMS")))
    (REGISTER-NATIVE-NAME SYM-RDBMS-RDBMS-DEFUNTABLE KWD-RDBMS-COMMON-LISP
     KWD-RDBMS-FUNCTION)
    (SAFE-IMPORT-SYMBOL SYM-RDBMS-RDBMS-DEFUNTABLE
     (GET-STELLA-MODULE "PL-KERNEL" CL:T))
    (REGISTER-NATIVE-NAME SYM-RDBMS-RDBMS-DEFTABLE KWD-RDBMS-COMMON-LISP
     KWD-RDBMS-FUNCTION)
    ...
    (REGISTER-NATIVE-NAME SYM-RDBMS-RDBMS-DEFQUERY KWD-RDBMS-COMMON-LISP
     KWD-RDBMS-FUNCTION)
