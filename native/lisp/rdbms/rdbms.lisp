...
(CL:DECLAIM
  ...
  *CHARACTER-TYPE-TABLE* *QUERYITERATOR* TRUE-TRUTH-VALUE
  *REVERSEPOLARITY?* *MEMOIZATION-ENABLED?* MEMOIZED-NULL-VALUE
  TRUE-WRAPPER FALSE-WRAPPER *CONTEXT* *MODULE* EOL NULL-INTEGER NIL
  STANDARD-ERROR))
