...
void helpStartupDescribe2() {
  {
    ...
    { MethodSlot* function = lookupFunction(SYM_DESCRIBE_STELLA_STARTUP_DESCRIBE);
      ...
      setDynamicSlotValue(function->dynamicSlots, SYM_DESCRIBE_STELLA_METHOD_STARTUP_CLASSNAME, wrapString("_Startup-Describe"), NULL_STRING_WRAPPER);
    }
  }
}
