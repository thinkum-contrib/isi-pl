  ...
  { 
    ...
    if (currentStartupTimePhaseP(7)) {
      ...
      { MethodSlot* function = lookupFunction(SYM_IDL_TRANSLATE_FILE_STELLA_STARTUP_IDL_TRANSLATE_FILE);
        ...
        setDynamicSlotValue(function->dynamicSlots, SYM_IDL_TRANSLATE_FILE_STELLA_METHOD_STARTUP_CLASSNAME, wrapString("_Startup-Idl-Translate-File"), NULL_STRING_WRAPPER);
      }
    }
