      ...
      { Object* basetype = head000;
        ...
        { Object* head001 = cursor->value;
          ...
          { Object* operatoR = head001;
            ...
            typespec->specifierBaseType = verifyType(typify(basetype));
  ...
  { 
    ...
    if (currentStartupTimePhaseP(7)) {
      ...
      { MethodSlot* function = lookupFunction(SYM_METHODS_STELLA_STARTUP_METHODS);
        ...
        setDynamicSlotValue(function->dynamicSlots, SYM_METHODS_STELLA_METHOD_STARTUP_CLASSNAME, wrapString("_Startup-Methods"), NULL_STRING_WRAPPER);
      }
    }
