  ...
  { Object* parentclass = NULL;
    ...
    { 
      ...
      if (((boolean)(((Surrogate*)(clasS->classDirectSupers->first()))))) {
        parentclass = javaTranslateClassName(typeToSymbol(((Surrogate*)(clasS->classDirectSupers->first()))));
      }
  ...
  { 
    ...
    if (currentStartupTimePhaseP(7)) {
      ...
      { MethodSlot* function = lookupFunction(SYM_JAVA_CLASS_OUT_STELLA_STARTUP_JAVA_CLASS_OUT);
        ...
        setDynamicSlotValue(function->dynamicSlots, SYM_JAVA_CLASS_OUT_STELLA_METHOD_STARTUP_CLASSNAME, wrapString("_Startup-Java-Class-Out"), NULL_STRING_WRAPPER);
      }
    }
