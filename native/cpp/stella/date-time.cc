  ...
  { int year = NULL_INTEGER;
    ...
    { int hours = NULL_INTEGER;
      ...
      { char* yearString = ((year < 0) ? stringConcatenate(integerToString(0 - year), "BC", 0) : integerToString(year));
        ...
        return (stringConcatenate(yearString, "-", 12, ((StringWrapper*)((oMONTH_ABBREVIATION_VECTORo->theArray)[month]))->wrapperValue, "-", formatWithPadding(integerToString(day), 2, '0', KWD_DATE_TIME_RIGHT, FALSE), " ", integerToString(hours), ":", formatWithPadding(integerToString(minutes), 2, '0', KWD_DATE_TIME_RIGHT, FALSE), ":", formatWithPadding(integerToString(seconds), 2, '0', KWD_DATE_TIME_RIGHT, FALSE), ".", formatWithPadding(integerToString(milli), 3, '0', KWD_DATE_TIME_RIGHT, FALSE), timezoneString));
      }
    }
  }
}
...
void printCalendarDate(CalendarDate* date, std::ostream* stream) {
  ...
  *(stream) << calendarDateToString(date, 0.0, FALSE);
  if (oPRINTREADABLYpo.get()) {
    *(stream) << " UTC\"";
  }
  else {
...
void printTimeDuration(TimeDuration* date, std::ostream* stream) {
  *(stream) << "<" << timeDurationToString(date) << ">";
}
...
CalendarDate* DecodedDateTime::encodeCalendarDate() {
  ...
  { DecodedDateTime* timeStructure = this;
    ...
    return (makeDateTime(timeStructure->dateTimeYear, timeStructure->dateTimeMonth, timeStructure->dateTimeDay, timeStructure->dateTimeHour, timeStructure->dateTimeMinute, timeStructure->dateTimeSecond, stella::round(timeStructure->dateTimeMillis), timeStructure->dateTimeZone));
  }
}
...
Object* defineTimeComparison(Symbol* name, Symbol* operatoR) {
  return (listO(5, SYM_DATE_TIME_STELLA_DEFUN, cons(name, cons(SYM_DATE_TIME_STELLA_BOOLEAN, NIL)), listO(3, listO(3, SYM_DATE_TIME_STELLA_T1, SYM_DATE_TIME_STELLA_DATE_TIME_OBJECT, NIL), listO(3, SYM_DATE_TIME_STELLA_T2, SYM_DATE_TIME_STELLA_DATE_TIME_OBJECT, NIL), NIL), listO(5, SYM_DATE_TIME_STELLA_TYPECASE, SYM_DATE_TIME_STELLA_T1, listO(3, SYM_DATE_TIME_STELLA_CALENDAR_DATE, listO(5, SYM_DATE_TIME_STELLA_TYPECASE, SYM_DATE_TIME_STELLA_T2, listO(3, SYM_DATE_TIME_STELLA_CALENDAR_DATE, listO(5, SYM_DATE_TIME_STELLA_IF, listO(4, SYM_DATE_TIME_STELLA_e, listO(3, SYM_DATE_TIME_STELLA_MODIFIED_JULIAN_DAY, SYM_DATE_TIME_STELLA_T1, NIL), listO(3, SYM_DATE_TIME_STELLA_MODIFIED_JULIAN_DAY, SYM_DATE_TIME_STELLA_T2, NIL), NIL), listO(3, SYM_DATE_TIME_STELLA_RETURN, cons(operatoR, listO(3, listO(3, SYM_DATE_TIME_STELLA_TIME_MILLIS, SYM_DATE_TIME_STELLA_T1, NIL), listO(3, SYM_DATE_TIME_STELLA_TIME_MILLIS, SYM_DATE_TIME_STELLA_T2, NIL), NIL)), NIL), listO(3, SYM_DATE_TIME_STELLA_RETURN, cons(operatoR, listO(3, listO(3, SYM_DATE_TIME_STELLA_MODIFIED_JULIAN_DAY, SYM_DATE_TIME_STELLA_T1, NIL), listO(3, SYM_DATE_TIME_STELLA_MODIFIED_JULIAN_DAY, SYM_DATE_TIME_STELLA_T2, NIL), NIL)), NIL), NIL), NIL), listO(3, SYM_DATE_TIME_STELLA_TIME_DURATION, listO(6, SYM_DATE_TIME_STELLA_ERROR, wrapString("Can't compare calendar and relative dates: "), SYM_DATE_TIME_STELLA_T1, wrapString("  "), SYM_DATE_TIME_STELLA_T2, NIL), NIL), NIL), NIL), listO(3, SYM_DATE_TIME_STELLA_TIME_DURATION, listO(5, SYM_DATE_TIME_STELLA_TYPECASE, SYM_DATE_TIME_STELLA_T2, listO(3, SYM_DATE_TIME_STELLA_CALENDAR_DATE, listO(6, SYM_DATE_TIME_STELLA_ERROR, wrapString("Can't compare relative and calendar dates: "), SYM_DATE_TIME_STELLA_T1, wrapString("  "), SYM_DATE_TIME_STELLA_T2, NIL), NIL), listO(3, SYM_DATE_TIME_STELLA_TIME_DURATION, listO(5, SYM_DATE_TIME_STELLA_IF, listO(4, SYM_DATE_TIME_STELLA_e, listO(3, SYM_DATE_TIME_STELLA_DAYS, SYM_DATE_TIME_STELLA_T1, NIL), listO(3, SYM_DATE_TIME_STELLA_DAYS, SYM_DATE_TIME_STELLA_T2, NIL), NIL), listO(3, SYM_DATE_TIME_STELLA_RETURN, cons(operatoR, listO(3, listO(3, SYM_DATE_TIME_STELLA_MILLIS, SYM_DATE_TIME_STELLA_T1, NIL), listO(3, SYM_DATE_TIME_STELLA_MILLIS, SYM_DATE_TIME_STELLA_T2, NIL), NIL)), NIL), listO(3, SYM_DATE_TIME_STELLA_RETURN, cons(operatoR, listO(3, listO(3, SYM_DATE_TIME_STELLA_DAYS, SYM_DATE_TIME_STELLA_T1, NIL), listO(3, SYM_DATE_TIME_STELLA_DAYS, SYM_DATE_TIME_STELLA_T2, NIL), NIL)), NIL), NIL), NIL), NIL), NIL), NIL), NIL));
}
  ...
  { Surrogate* testValue000 = safePrimaryType(t1);
    ...
    if (subtypeOfP(testValue000, SGT_DATE_TIME_STELLA_CALENDAR_DATE)) {
          ...
          if (subtypeOfP(testValue001, SGT_DATE_TIME_STELLA_CALENDAR_DATE)) {
            ...
            { DateTimeObject* t2001 = t2;
              ...
              { OutputStringStream* stream000 = newOutputStringStream();
                ...
                *(stream000->nativeStream) << "Can't compare calendar and relative dates: " << "`" << t1 << "'" << "  " << "`" << t2 << "'";
                throw *newStellaException(stream000->theStringReader());
              }
            }
          }
          ...
          if (subtypeOfP(testValue002, SGT_DATE_TIME_STELLA_CALENDAR_DATE)) {
            { DateTimeObject* t2002 = t2;
              ...
              { OutputStringStream* stream002 = newOutputStringStream();
                ...
                *(stream002->nativeStream) << "Can't compare relative and calendar dates: " << "`" << t1 << "'" << "  " << "`" << t2 << "'";
                throw *newStellaException(stream002->theStringReader());
              }
            }
          }
            ...
            { OutputStringStream* stream003 = newOutputStringStream();
              ...
              *(stream003->nativeStream) << "`" << testValue002 << "'" << " is not a valid case option";
              throw *newStellaException(stream003->theStringReader());
            }
          }
        }
      ...
      { OutputStringStream* stream004 = newOutputStringStream();
        ...
        *(stream004->nativeStream) << "`" << testValue000 << "'" << " is not a valid case option";
        throw *newStellaException(stream004->theStringReader());
      }
    }
  }
...
boolean CalendarDate::objectEqlP(Object* x) {
  { CalendarDate* self = this;

    return (isaP(x, SGT_DATE_TIME_STELLA_CALENDAR_DATE) &&
        timeEqlP(self, ((DateTimeObject*)(x))));
  }
}

boolean TimeDuration::objectEqlP(Object* x) {
  { TimeDuration* self = this;

    return (isaP(x, SGT_DATE_TIME_STELLA_TIME_DURATION) &&
        timeEqlP(self, ((DateTimeObject*)(x))));
  }
}
...
void helpStartupDateTime1() {
  {
    ...
    SYM_DATE_TIME_STELLA_DEFUN = ((Symbol*)(internRigidSymbolWrtModule("DEFUN", NULL, 0)));
    ...
    SYM_DATE_TIME_STELLA_DATE_TIME_OBJECT = ((Symbol*)(internRigidSymbolWrtModule("DATE-TIME-OBJECT", NULL, 0)));
    ...
    SYM_DATE_TIME_STELLA_ERROR = ((Symbol*)(internRigidSymbolWrtModule("ERROR", NULL, 0)));
...
void helpStartupDateTime2() {
  {
    ...
    defineFunctionObject("SET-CURRENT-TIME", "(DEFUN SET-CURRENT-TIME ((VALUES-STRUCTURE DECODED-DATE-TIME)))", ((cpp_function_code)(&setCurrentTime)), NULL);
    defineFunctionObject("SET-CURRENT-DATE", "(DEFUN SET-CURRENT-DATE ((VALUES-STRUCTURE DECODED-DATE-TIME)))", ((cpp_function_code)(&setCurrentDate)), NULL);
    defineFunctionObject("SET-CURRENT-DATE-TIME", "(DEFUN SET-CURRENT-DATE-TIME ((VALUES-STRUCTURE DECODED-DATE-TIME)))", ((cpp_function_code)(&setCurrentDateTime)), NULL);
    ...
    defineFunctionObject("CALENDAR-DATE-TO-STRING", "(DEFUN (CALENDAR-DATE-TO-STRING STRING) ((DATE CALENDAR-DATE) (TIMEZONE FLOAT) (INCLUDE-TIMEZONE? BOOLEAN)) :PUBLIC? TRUE :DOCUMENTATION \"Returns a string representation of `date' adjusted for `timezone'\")", ((cpp_function_code)(&calendarDateToString)), NULL);
    defineFunctionObject("CALENDAR-DATE-TO-NATIVE-DATE-TIME", "(DEFUN (CALENDAR-DATE-TO-NATIVE-DATE-TIME NATIVE-DATE-TIME) ((DATE CALENDAR-DATE)))", ((cpp_function_code)(&calendarDateToNativeDateTime)), NULL);
    ...
    defineFunctionObject("PRINT-CALENDAR-DATE", "(DEFUN PRINT-CALENDAR-DATE ((DATE CALENDAR-DATE) (STREAM NATIVE-OUTPUT-STREAM)))", ((cpp_function_code)(&printCalendarDate)), NULL);
    ...
    defineFunctionObject("TIME-DURATION-TO-STRING", "(DEFUN (TIME-DURATION-TO-STRING STRING) ((DATE TIME-DURATION)) :PUBLIC? TRUE :DOCUMENTATION \"Returns a string representation of `date'\")", ((cpp_function_code)(&timeDurationToString)), NULL);
    defineFunctionObject("STRING-TO-TIME-DURATION", "(DEFUN (STRING-TO-TIME-DURATION TIME-DURATION) ((DURATION STRING)) :PUBLIC? TRUE :DOCUMENTATION \"Parses and returns an time-duration object corresponding to `duration'.\nThe syntax for time duration strings is \\\"{plus|minus} N days[; M ms]\\\" where N and M are\ninteger values for days and milliseconds.  If no valid parse is found, `null' is returned.\")", ((cpp_function_code)(&stringToTimeDuration)), NULL);
    defineFunctionObject("PRINT-TIME-DURATION", "(DEFUN PRINT-TIME-DURATION ((DATE TIME-DURATION) (STREAM NATIVE-OUTPUT-STREAM)))", ((cpp_function_code)(&printTimeDuration)), NULL);
    ...
    defineFunctionObject("DEFINE-TIME-COMPARISON", "(DEFUN DEFINE-TIME-COMPARISON ((NAME SYMBOL) (OPERATOR SYMBOL)) :TYPE OBJECT :MACRO? TRUE :PUBLIC? FALSE)", ((cpp_function_code)(&defineTimeComparison)), NULL);
    defineFunctionObject("TIME-EQL?", "(DEFUN (TIME-EQL? BOOLEAN) ((T1 DATE-TIME-OBJECT) (T2 DATE-TIME-OBJECT)))", ((cpp_function_code)(&timeEqlP)), NULL);
    defineFunctionObject("TIME-LESS?", "(DEFUN (TIME-LESS? BOOLEAN) ((T1 DATE-TIME-OBJECT) (T2 DATE-TIME-OBJECT)))", ((cpp_function_code)(&timeLessP)), NULL);
    defineFunctionObject("TIME-GREATER?", "(DEFUN (TIME-GREATER? BOOLEAN) ((T1 DATE-TIME-OBJECT) (T2 DATE-TIME-OBJECT)))", ((cpp_function_code)(&timeGreaterP)), NULL);
    defineFunctionObject("TIME-LESS-EQUAL?", "(DEFUN (TIME-LESS-EQUAL? BOOLEAN) ((T1 DATE-TIME-OBJECT) (T2 DATE-TIME-OBJECT)))", ((cpp_function_code)(&timeLessEqualP)), NULL);
    defineFunctionObject("TIME-GREATER-EQUAL?", "(DEFUN (TIME-GREATER-EQUAL? BOOLEAN) ((T1 DATE-TIME-OBJECT) (T2 DATE-TIME-OBJECT)))", ((cpp_function_code)(&timeGreaterEqualP)), NULL);
    defineMethodObject("(DEFMETHOD (OBJECT-EQL? BOOLEAN) ((SELF CALENDAR-DATE) (X OBJECT)))", ((cpp_method_code)(&CalendarDate::objectEqlP)), ((cpp_method_code)(NULL)));
    defineMethodObject("(DEFMETHOD (OBJECT-EQL? BOOLEAN) ((SELF TIME-DURATION) (X OBJECT)))", ((cpp_method_code)(&TimeDuration::objectEqlP)), ((cpp_method_code)(NULL)));
    ...
    { MethodSlot* function = lookupFunction(SYM_DATE_TIME_STELLA_STARTUP_DATE_TIME);
      ...
      setDynamicSlotValue(function->dynamicSlots, SYM_DATE_TIME_STELLA_METHOD_STARTUP_CLASSNAME, wrapString("_Startup-Date-Time"), NULL_STRING_WRAPPER);
    }
  }
}
  ...
  { 
    ...
    if (currentStartupTimePhaseP(4)) {
      ...
      { int i = NULL_INTEGER;
        ...
        Cons* iter034 = getQuotedTree("((\"NUL\" \"JAN\" \"FEB\" \"MAR\" \"APR\" \"MAY\" \"JUN\" \"JUL\" \"AUG\" \"SEP\" \"OCT\" \"NOV\" \"DEC\") \"/STELLA\")", "/STELLA");
    ...
    if (currentStartupTimePhaseP(5)) {
      ...
      defineClassFromStringifiedSource("DATE-TIME-OBJECT", "(DEFCLASS DATE-TIME-OBJECT (STANDARD-OBJECT) :ABSTRACT? TRUE)");
...
Symbol* SYM_DATE_TIME_STELLA_DEFUN = NULL;

Symbol* SYM_DATE_TIME_STELLA_BOOLEAN = NULL;

Symbol* SYM_DATE_TIME_STELLA_T1 = NULL;

Symbol* SYM_DATE_TIME_STELLA_DATE_TIME_OBJECT = NULL;
...
Symbol* SYM_DATE_TIME_STELLA_ERROR = NULL;
