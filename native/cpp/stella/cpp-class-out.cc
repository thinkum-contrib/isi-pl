  ...
  { 
    ...
    if (currentStartupTimePhaseP(7)) {
      ...
      { MethodSlot* function = lookupFunction(SYM_CPP_CLASS_OUT_STELLA_STARTUP_CPP_CLASS_OUT);
        ...
        setDynamicSlotValue(function->dynamicSlots, SYM_CPP_CLASS_OUT_STELLA_METHOD_STARTUP_CLASSNAME, wrapString("_Startup-Cpp-Class-Out"), NULL_STRING_WRAPPER);
      }
    }
