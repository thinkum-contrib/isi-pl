...
boolean oUSE_STELLA_HASH_TABLESpo = FALSE;
...
;
  ...
  { 
    ...
    if (currentStartupTimePhaseP(4)) {
      oUSE_STELLA_HASH_TABLESpo = FALSE;
...
;
    ...
    if (currentStartupTimePhaseP(7)) {
      ...
      { MethodSlot* function = lookupFunction(SYM_COLLECTIONS_STELLA_STARTUP_COLLECTIONS);
        ...
        setDynamicSlotValue(function->dynamicSlots, SYM_COLLECTIONS_STELLA_METHOD_STARTUP_CLASSNAME, wrapString("_Startup-Collections"), NULL_STRING_WRAPPER);
      }
    }
    ...
    if (currentStartupTimePhaseP(9)) {
      ...
      defineStellaGlobalVariableFromStringifiedSource("(DEFGLOBAL *USE-STELLA-HASH-TABLES?* BOOLEAN FALSE)");
