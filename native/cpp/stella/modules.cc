              ...
              { Keyword* testValue001 = ((Keyword*)(key));
                ...
                if (testValue001 == KWD_MODULES_DOCUMENTATION) {
                  ...
                  setDynamicSlotValue(self->dynamicSlots, SYM_MODULES_STELLA_APIp, (((value == SYM_MODULES_STELLA_TRUE) ||
                      eqlP(value, TRUE_WRAPPER)) ? TRUE_WRAPPER : FALSE_WRAPPER), FALSE_WRAPPER);
                }
...
void helpStartupModules2() {
  {
    ...
    defineFunctionObject("TRUE-OPTION?", "(DEFUN (TRUE-OPTION? BOOLEAN) ((VALUE OBJECT)) :GLOBALLY-INLINE? TRUE (RETURN (OR (EQL? VALUE (QUOTE TRUE)) (EQL? VALUE TRUE-WRAPPER))))", ((cpp_function_code)(&trueOptionP)), NULL);
