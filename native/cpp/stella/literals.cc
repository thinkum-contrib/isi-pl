...
double NumberWrapper::numberWrapperToFloat() {
  { NumberWrapper* self = this;
...
void helpStartupLiterals3() {
  {
    ...
    defineFunctionObject("WRAP-INTEGER", "(DEFUN (WRAP-INTEGER INTEGER-WRAPPER) ((VALUE INTEGER)) :DOCUMENTATION \"Return a literal object whose value is the INTEGER 'value'.\" :PUBLIC? TRUE)", ((cpp_function_code)(&wrapInteger)), NULL);
    ...
    defineFunctionObject("WRAP-FLOAT", "(DEFUN (WRAP-FLOAT FLOAT-WRAPPER) ((VALUE FLOAT)) :DOCUMENTATION \"Return a literal object whose value is the FLOAT 'value'.\" :PUBLIC? TRUE)", ((cpp_function_code)(&wrapFloat)), NULL);
    ...
    defineFunctionObject("WRAP-STRING", "(DEFUN (WRAP-STRING STRING-WRAPPER) ((VALUE STRING)) :DOCUMENTATION \"Return a literal object whose value is the STRING 'value'.\" :PUBLIC? TRUE)", ((cpp_function_code)(&wrapString)), NULL);
    ...
    defineFunctionObject("WRAP-MUTABLE-STRING", "(DEFUN (WRAP-MUTABLE-STRING MUTABLE-STRING-WRAPPER) ((VALUE MUTABLE-STRING)) :DOCUMENTATION \"Return a literal object whose value is the MUTABLE-STRING 'value'.\" :PUBLIC? TRUE)", ((cpp_function_code)(&wrapMutableString)), NULL);
    ...
    defineFunctionObject("WRAP-CHARACTER", "(DEFUN (WRAP-CHARACTER CHARACTER-WRAPPER) ((VALUE CHARACTER)) :DOCUMENTATION \"Return a literal object whose value is the CHARACTER 'value'.\" :PUBLIC? TRUE)", ((cpp_function_code)(&wrapCharacter)), NULL);
    ...
    defineFunctionObject("WRAP-FUNCTION-CODE", "(DEFUN (WRAP-FUNCTION-CODE FUNCTION-CODE-WRAPPER) ((VALUE FUNCTION-CODE)) :DOCUMENTATION \"Return a literal object whose value is the FUNCTION-CODE 'value'.\" :PUBLIC? TRUE)", ((cpp_function_code)(&wrapFunctionCode)), NULL);
    ...
    defineFunctionObject("WRAP-METHOD-CODE", "(DEFUN (WRAP-METHOD-CODE METHOD-CODE-WRAPPER) ((VALUE METHOD-CODE)) :DOCUMENTATION \"Return a literal object whose value is the METHOD-CODE 'value'.\" :PUBLIC? TRUE)", ((cpp_function_code)(&wrapMethodCode)), NULL);
    ...
    defineFunctionObject("WRAP-BOOLEAN", "(DEFUN (WRAP-BOOLEAN BOOLEAN-WRAPPER) ((VALUE BOOLEAN)) :DOCUMENTATION \"Return a literal object whose value is the BOOLEAN 'value'.\" :PUBLIC? TRUE :GLOBALLY-INLINE? TRUE (RETURN (CHOOSE VALUE TRUE-WRAPPER FALSE-WRAPPER)))", ((cpp_function_code)(&wrapBoolean)), NULL);
...
void startupLiterals() {
  ...
  { 
    ...
    if (currentStartupTimePhaseP(7)) {
      ...
      defineMethodObject("(DEFMETHOD (NUMBER-WRAPPER-TO-FLOAT FLOAT) ((SELF NUMBER-WRAPPER)) :PUBLIC? TRUE)", ((cpp_method_code)(&NumberWrapper::numberWrapperToFloat)), ((cpp_method_code)(NULL)));
      ...
      { MethodSlot* function = lookupFunction(SYM_LITERALS_STELLA_STARTUP_LITERALS);
        ...
        setDynamicSlotValue(function->dynamicSlots, SYM_LITERALS_STELLA_METHOD_STARTUP_CLASSNAME, wrapString("_Startup-Literals"), NULL_STRING_WRAPPER);
      }
    }
