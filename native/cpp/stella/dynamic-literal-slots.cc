  ...
  { 
    ...
    if (currentStartupTimePhaseP(7)) {
      ...
      { MethodSlot* function = lookupFunction(SYM_DYNAMIC_LITERAL_SLOTS_STELLA_STARTUP_DYNAMIC_LITERAL_SLOTS);
        ...
        setDynamicSlotValue(function->dynamicSlots, SYM_DYNAMIC_LITERAL_SLOTS_STELLA_METHOD_STARTUP_CLASSNAME, wrapString("_StartupDynamicLiteralSlots"), NULL_STRING_WRAPPER);
      }
    }
