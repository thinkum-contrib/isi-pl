...
Class* stringLookupClass(char* name) {
  ...
  { Class* clasS = NULL;
    ...
    { Module* module = NULL;
      Iterator* iter000 = visibleModules(oMODULEo.get());
...
DEFINE_STELLA_SPECIAL(oWARNIFREDEFINEpo, boolean , FALSE);
  ...
  { 
    ...
    if (currentStartupTimePhaseP(7)) {
      ...
      { MethodSlot* function = lookupFunction(SYM_CLASSES_STELLA_STARTUP_CLASSES);
        ...
        setDynamicSlotValue(function->dynamicSlots, SYM_CLASSES_STELLA_METHOD_STARTUP_CLASSNAME, wrapString("_Startup-Classes"), NULL_STRING_WRAPPER);
      }
    }
