...
void startupTypePredicates() {
  { 
    ...
    if (currentStartupTimePhaseP(4)) {
      oCLASS_HIERARCHY_BOOTEDpo = FALSE;
    }
    ...
    if (currentStartupTimePhaseP(7)) {
      ...
      { MethodSlot* function = lookupFunction(SYM_TYPE_PREDICATES_STELLA_STARTUP_TYPE_PREDICATES);
        ...
        setDynamicSlotValue(function->dynamicSlots, SYM_TYPE_PREDICATES_STELLA_METHOD_STARTUP_CLASSNAME, wrapString("_Startup-Type-Predicates"), NULL_STRING_WRAPPER);
      }
    }
