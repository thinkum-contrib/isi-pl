  ...
  { 
    ...
    if (currentStartupTimePhaseP(7)) {
      ...
      { MethodSlot* function = lookupFunction(SYM_CL_TRANSLATE_FILE_STELLA_STARTUP_CL_TRANSLATE_FILE);
        ...
        setDynamicSlotValue(function->dynamicSlots, SYM_CL_TRANSLATE_FILE_STELLA_METHOD_STARTUP_CLASSNAME, wrapString("_Startup-Cl-Translate-File"), NULL_STRING_WRAPPER);
      }
    }
