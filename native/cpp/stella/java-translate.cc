...
char* javaChangeCase(GeneralizedSymbol* symbol, Keyword* caseconvention) {
  { Module* module = ((Module*)(symbol->homeContext));
    ...
    if (module->caseSensitiveP ||
        (!(computeSymbolEscapeCode(name, FALSE) == KWD_JAVA_TRANSLATE_UNESCAPED))) {
    ...
    if (caseconvention == KWD_JAVA_TRANSLATE_UPPERCASE) {
      ...
      return (makeMatchingNameFull(name, KWD_JAVA_TRANSLATE_CLEVER, KWD_JAVA_TRANSLATE_CLEVER, "- ", "", "", "", "", KWD_JAVA_TRANSLATE_TITLECASEX, ""));
    }
    else if (caseconvention == KWD_JAVA_TRANSLATE_CAPITALIZED) {
      return (makeMatchingNameFull(name, KWD_JAVA_TRANSLATE_CLEVER, KWD_JAVA_TRANSLATE_CLEVER, "- ", "", "", "", "", KWD_JAVA_TRANSLATE_TITLECASE, ""));
    }
    else {
      { OutputStringStream* stream000 = newOutputStringStream();
...
StringWrapper* javaNativeLiteralWrapperNames(StandardObject* typespec, StringWrapper*& _Return1) {
  { GeneralizedSymbol* testValue000 = ((GeneralizedSymbol*)(typespec));
    ...
    if (testValue000 == SGT_JAVA_TRANSLATE_STELLA_BOOLEAN) {
      { StringWrapper* _return_temp = wrapString("Boolean");
      ...
      { StringWrapper* _return_temp = wrapString("Integer");
      ...
      { StringWrapper* _return_temp = wrapString("Double");
      ...
      { StringWrapper* _return_temp = wrapString("Character");
      ...
      { StringWrapper* _return_temp = wrapString("Long");
      ...
      { StringWrapper* _return_temp = wrapString("Float");
...
StringWrapper* javaTranslateClassNamestring(StringWrapper* namestring) {
  { char* translatedname = javaSubstituteForbiddenCharacters(makeMatchingNameFull(namestring->wrapperValue, KWD_JAVA_TRANSLATE_CLEVER, KWD_JAVA_TRANSLATE_CLEVER, "- ", "", "", "", "", KWD_JAVA_TRANSLATE_TITLECASE, ""), KWD_JAVA_TRANSLATE_CAPITALIZED);
...
Cons* javaTranslateArgumentListIterator(Cons* iteratorbindings, Cons* cursorbindings, Cons* body) {
  { Object* cursorvar = ((Cons*)(cursorbindings->value))->value;
    Object* cursortype = ((Cons*)(cursorbindings->value))->rest->value;
    Object* dummyarg = ((Cons*)(((Cons*)(iteratorbindings->value))->rest->rest->value))->fourth();
    Object* iteratorconstructor = NULL;
    Cons* declarations = listO(3, cons(wrapString("Enumeration"), cons(javaTranslateATree(SYM_JAVA_TRANSLATE_STELLA_ARG_ENUM), NIL)), cons(javaTranslateTypeSpec(((StandardObject*)(cursortype))), cons(javaTranslateATree(cursorvar), NIL)), NIL);
    ...
    { Cons* binding = NULL;
      ...
      while (!(iter000 == NIL)) {
        ...
        iter000 = iter000->rest;
        iteratorconstructor = javaTranslateATree(((Cons*)(binding))->rest->rest->value);
        binding->thirdSetter(NULL);
        if (!((boolean)(collect000))) {
          {
            collect000 = cons(cons(javaTranslateTypeSpec(((StandardObject*)(((Cons*)(binding))->rest->value))), cons(javaTranslateATree(((Cons*)(binding))->value), cons(iteratorconstructor, NIL))), NIL);
            if (declarations == NIL) {
          ...
          {
            collect000->rest = cons(cons(javaTranslateTypeSpec(((StandardObject*)(((Cons*)(binding))->rest->value))), cons(javaTranslateATree(((Cons*)(binding))->value), cons(iteratorconstructor, NIL))), NIL);
            collect000 = collect000->rest;
          }
        }
      }
    }
    return (listO(3, SYM_JAVA_TRANSLATE_STELLA_JAVA_BLOCK, declarations, cons(listO(4, SYM_JAVA_TRANSLATE_STELLA_JAVA_STATEMENTS, listO(4, SYM_JAVA_TRANSLATE_STELLA_JAVA_ASSIGN, listO(3, SYM_JAVA_TRANSLATE_STELLA_JAVA_IDENT, javaTranslateName(SYM_JAVA_TRANSLATE_STELLA_ARG_ENUM), NIL), listO(5, SYM_JAVA_TRANSLATE_STELLA_JAVA_METHOD_CALL, listO(3, SYM_JAVA_TRANSLATE_STELLA_JAVA_IDENT, wrapString(""), NIL), listO(3, SYM_JAVA_TRANSLATE_STELLA_JAVA_IDENT, javaTranslateName(SYM_JAVA_TRANSLATE_STELLA_ELEMENTS), NIL), javaTranslateATree(dummyarg), cons(cons(SYM_JAVA_TRANSLATE_STELLA_JAVA_ACTUALS, NIL), NIL)), NIL), listO(4, SYM_JAVA_TRANSLATE_STELLA_JAVA_WHILE, listO(6, SYM_JAVA_TRANSLATE_STELLA_JAVA_METHOD_CALL, listO(3, SYM_JAVA_TRANSLATE_STELLA_JAVA_IDENT, wrapString(""), NIL), listO(3, SYM_JAVA_TRANSLATE_STELLA_JAVA_IDENT, wrapString("hasMoreElements"), NIL), listO(3, SYM_JAVA_TRANSLATE_STELLA_JAVA_IDENT, javaTranslateName(SYM_JAVA_TRANSLATE_STELLA_ARG_ENUM), NIL), cons(SYM_JAVA_TRANSLATE_STELLA_JAVA_ACTUALS, NIL), NIL), listO(3, SYM_JAVA_TRANSLATE_STELLA_JAVA_PROGN, listO(3, SYM_JAVA_TRANSLATE_STELLA_JAVA_STATEMENTS, listO(3, SYM_JAVA_TRANSLATE_STELLA_JAVA_ASSIGN, javaTranslateATree(cursorvar), cons(listO(4, SYM_JAVA_TRANSLATE_STELLA_JAVA_CAST, listO(6, SYM_JAVA_TRANSLATE_STELLA_JAVA_METHOD_CALL, listO(3, SYM_JAVA_TRANSLATE_STELLA_JAVA_IDENT, wrapString(""), NIL), listO(3, SYM_JAVA_TRANSLATE_STELLA_JAVA_IDENT, wrapString("nextElement"), NIL), listO(3, SYM_JAVA_TRANSLATE_STELLA_JAVA_IDENT, javaTranslateName(SYM_JAVA_TRANSLATE_STELLA_ARG_ENUM), NIL), cons(SYM_JAVA_TRANSLATE_STELLA_JAVA_ACTUALS, NIL), NIL), javaTranslateTypeSpec(SGT_JAVA_TRANSLATE_STELLA_OBJECT), NIL), NIL)), body->concatenate(NIL, 0)), NIL), NIL), NIL), NIL)));
  }
}
...
Cons* javaTranslateForeachTree(Cons* tree) {
  { 
    ...
    { Cons* iteratorbindings = ((Cons*)(tree->rest->value));
      ...
      Object* continuationtest = javaTranslateATree(tree->fourth());
      Cons* body = javaTranslateListOfTrees(tree->nthRest(4));
      Cons* declarations = NIL;
      Cons* nextassignments = NIL;
      Object* iteratorconstructor = NULL;

      tree->nthRestSetter(NIL, 4);
      if (((Cons*)(((Cons*)(iteratorbindings->value))))->rest->value == SGT_JAVA_TRANSLATE_STELLA_LISP_CONS_ITERATOR) {
        return (javaTranslateArgumentListIterator(iteratorbindings, cursorbindings, body));
      }
      { Cons* binding = NULL;
        ...
        while (!(iter000 == NIL)) {
          binding = ((Cons*)(iter000->value));
          iter000 = iter000->rest;
          iteratorconstructor = javaTranslateATree(binding->rest->rest->value);
          binding->thirdSetter(NULL);
          if (!((boolean)(collect000))) {
            {
              collect000 = cons(cons(javaTranslateTypeSpec(((StandardObject*)(((Cons*)(binding))->rest->value))), cons(javaTranslateATree(((Cons*)(binding))->value), cons(iteratorconstructor, NIL))), NIL);
      ...
      { Cons* binding = NULL;
        ...
        while (!(iter001 == NIL)) {
          ...
          iter001 = iter001->rest;
          nextassignments = cons(javaTranslateATree(binding->rest->rest->value), nextassignments);
          binding->thirdSetter(NULL);
          if (!(duplicateCursorVariableP(((Symbol*)(binding->value)), iteratorbindings))) {
            declarations = cons(cons(javaTranslateTypeSpec(((StandardObject*)(((Cons*)(binding))->rest->value))), cons(javaTranslateATree(((Cons*)(binding))->value), cons(javaTranslateATree(typeToWalkedNullValueTree(typeSpecToBaseType(((StandardObject*)(binding->rest->value))))), NIL))), declarations);
          }
        }
      }
      if (oJAVA_LOOP_NAME_USEDpo.get()) {
        return (listO(3, SYM_JAVA_TRANSLATE_STELLA_JAVA_BLOCK, declarations, cons(listO(3, SYM_JAVA_TRANSLATE_STELLA_JAVA_STATEMENTS, listO(3, SYM_JAVA_TRANSLATE_STELLA_JAVA_NAMED_STATEMENT, javaTranslateATree(oJAVA_LOOP_NAMEo.get()), cons(listO(3, SYM_JAVA_TRANSLATE_STELLA_JAVA_FOREACH, continuationtest, cons(nextassignments->reverse(), cons(body, NIL))), NIL)), NIL), NIL)));
      }
      else {
        return (listO(3, SYM_JAVA_TRANSLATE_STELLA_JAVA_BLOCK, declarations, cons(listO(3, SYM_JAVA_TRANSLATE_STELLA_JAVA_STATEMENTS, listO(3, SYM_JAVA_TRANSLATE_STELLA_JAVA_FOREACH, continuationtest, cons(nextassignments->reverse(), cons(body, NIL))), NIL), NIL)));
      }
    }
  }
}
...
Cons* javaTranslateSysNew(Cons* tree) {
  { StandardObject* typespec = ((StandardObject*)(tree->rest->value));
    ...
    if (arrayTypeSpecifierP(typespec)) {
      ...
      return (listO(5, SYM_JAVA_TRANSLATE_STELLA_JAVA_FUNCTION_CALL, listO(3, SYM_JAVA_TRANSLATE_STELLA_JAVA_IDENT, javaTranslateTypeSpec(typespec), NIL), listO(3, SYM_JAVA_TRANSLATE_STELLA_JAVA_IDENT, javaTranslateName(yieldConstructorName(typeSpecToClass(typespec))), NIL), javaTranslateActualParameters(tree->rest->rest), NIL));
    }
  }
}
...
StringWrapper* javaYieldTranslatedClassAndFunctionNames(MethodSlot* f, StringWrapper*& _Return1) {
  if (javaFlotsamFunctionP(f)) {
    { StringWrapper* _return_temp = wrapString(stringConcatenate(javaPackagePrefix(f->homeModule(), "."), javaYieldFlotsamClassName(f->homeModule()), 0));
    ...
    { StringWrapper* _return_temp = wrapString(javaYieldFullNativeClassName());
    ...
    { StringWrapper* _return_temp = wrapString(stringConcatenate(javaPackagePrefix(f->homeModule(), "."), javaTranslateClassNamestring(wrapString(((StringWrapper*)(dynamicSlotValue(f->dynamicSlots, SYM_JAVA_TRANSLATE_STELLA_METHOD_STARTUP_CLASSNAME, NULL_STRING_WRAPPER)))->wrapperValue))->wrapperValue, 0));
    ...
    { StringWrapper* _return_temp = javaYieldFullyQualifiedTypeName(((StandardObject*)(f->methodReturnTypeSpecifiers_reader()->first())));
    ...
    { StringWrapper* _return_temp = javaYieldFullyQualifiedTypeName(((StandardObject*)(f->methodParameterTypeSpecifiers_reader()->first())));
...
char* javaYieldTranslatedClassAndMethodNames(StandardObject* owner, MethodSlot* f, char*& _Return1) {
  if (((BooleanWrapper*)(dynamicSlotValue(f->dynamicSlots, SYM_JAVA_TRANSLATE_STELLA_METHOD_NATIVEp, FALSE_WRAPPER)))->wrapperValue) {
    { char* _return_temp = javaYieldFullNativeClassName();
    ...
    { char* _return_temp = stringConcatenate(javaPackagePrefix(f->homeModule(), "."), javaYieldFlotsamClassName(f->homeModule()), 0);
    ...
    { char* _return_temp = javaYieldFullyQualifiedTypeName(owner)->wrapperValue;
...
Symbol* javaCreateOverloadedFunctionName(Symbol* functionname, Surrogate* classtype) {
  return (internSymbol(stringConcatenate(classtype->symbolName, "_", 1, functionname->symbolName)));
}
...
char* javaYieldClassNameForFunction(MethodSlot* function) {
  { char* rawClassName = "";
    ...
    if (javaFlotsamFunctionP(function)) {
      ...
      return (javaTranslateTypeSpec(((StandardObject*)(function->methodReturnTypeSpecifiers_reader()->first())))->wrapperValue);
    }
    else {
      return (javaTranslateTypeSpec(((StandardObject*)(function->methodParameterTypeSpecifiers_reader()->first())))->wrapperValue);
    }
  }
}
...
Cons* javaTranslateNormalMethodCall(Symbol* methodname, Surrogate* classtype, Cons* allargs) {
  { Slot* slot = lookupSlot(((Class*)(classtype->surrogateValue)), methodname);
    ...
    if (((boolean)(operatoR))) {
      ...
      return (listO(5, SYM_JAVA_TRANSLATE_STELLA_JAVA_METHOD_CALL, listO(3, SYM_JAVA_TRANSLATE_STELLA_JAVA_IDENT, javaTranslateClassName(internSymbolInModule(classtype->symbolName, ((Module*)(classtype->homeContext)), TRUE)), NIL), listO(3, SYM_JAVA_TRANSLATE_STELLA_JAVA_IDENT, (((boolean)(methodslot)) ? methodslot->javaTranslateMethodName() : javaTranslateName(methodname)), NIL), javaTranslateATree(object), cons(((((boolean)(methodslot)) &&
...
void helpStartupJavaTranslate2() {
  {
    ...
    KWD_JAVA_TRANSLATE_UNESCAPED = ((Keyword*)(internRigidSymbolWrtModule("UNESCAPED", NULL, 2)));
...
void helpStartupJavaTranslate3() {
  {
    ...
    SYM_JAVA_TRANSLATE_STELLA_ARG_ENUM = ((Symbol*)(internRigidSymbolWrtModule("ARG_ENUM", NULL, 0)));
    ...
    SYM_JAVA_TRANSLATE_STELLA_ELEMENTS = ((Symbol*)(internRigidSymbolWrtModule("ELEMENTS", NULL, 0)));
    SGT_JAVA_TRANSLATE_STELLA_OBJECT = ((Surrogate*)(internRigidSymbolWrtModule("OBJECT", NULL, 1)));
    SGT_JAVA_TRANSLATE_STELLA_LISP_CONS_ITERATOR = ((Surrogate*)(internRigidSymbolWrtModule("LISP-CONS-ITERATOR", NULL, 1)));
...
void helpStartupJavaTranslate6() {
  {
    ...
    oJAVA_LOOP_NAME_USEDpo.set(FALSE);
...
void helpStartupJavaTranslate7() {
  {
    ...
    defineFunctionObject("JAVA-TRANSLATE-ARGUMENT-LIST-ITERATOR", "(DEFUN (JAVA-TRANSLATE-ARGUMENT-LIST-ITERATOR CONS) ((ITERATORBINDINGS (CONS OF CONS)) (CURSORBINDINGS (CONS OF CONS)) (BODY CONS)))", ((cpp_function_code)(&javaTranslateArgumentListIterator)), NULL);
  }
}
  ...
  { 
    ...
    if (currentStartupTimePhaseP(7)) {
      ...
      { MethodSlot* function = lookupFunction(SYM_JAVA_TRANSLATE_STELLA_STARTUP_JAVA_TRANSLATE);
        ...
        setDynamicSlotValue(function->dynamicSlots, SYM_JAVA_TRANSLATE_STELLA_METHOD_STARTUP_CLASSNAME, wrapString("_Startup-Java-Translate"), NULL_STRING_WRAPPER);
      }
    }
...
Keyword* KWD_JAVA_TRANSLATE_UNESCAPED = NULL;
...
Symbol* SYM_JAVA_TRANSLATE_STELLA_ARG_ENUM = NULL;

Symbol* SYM_JAVA_TRANSLATE_STELLA_JAVA_WHILE = NULL;

Symbol* SYM_JAVA_TRANSLATE_STELLA_JAVA_CAST = NULL;

Symbol* SYM_JAVA_TRANSLATE_STELLA_ELEMENTS = NULL;

Surrogate* SGT_JAVA_TRANSLATE_STELLA_OBJECT = NULL;

Surrogate* SGT_JAVA_TRANSLATE_STELLA_LISP_CONS_ITERATOR = NULL;
