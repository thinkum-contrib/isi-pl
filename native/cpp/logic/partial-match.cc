...
boolean oGREEDY_NETWORK_PRUNINGo = FALSE;
...
void helpStartupPartialMatch2() {
  {
    ...
    oGREEDY_NETWORK_PRUNINGo = TRUE;
    oRULE_COMBINATIONo = KWD_PARTIAL_MATCH_MAX;
    oPLANNING_MODEo = FALSE;
    oPLANABLE_PREDICATESo = NIL;
    oFAIL_UNBOUND_CLAUSESpo = FALSE;
    oAND_MISSED_A_BINDINGo = FALSE;
  }
}
...
void helpStartupPartialMatch4() {
  {
    ...
    { MethodSlot* function = lookupFunction(SYM_PARTIAL_MATCH_LOGIC_STARTUP_PARTIAL_MATCH);
      ...
      setDynamicSlotValue(function->dynamicSlots, SYM_PARTIAL_MATCH_STELLA_METHOD_STARTUP_CLASSNAME, wrapString("_Startup-Partial-Match"), NULL_STRING_WRAPPER);
    }
  }
}
