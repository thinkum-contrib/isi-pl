...
Object* accessExceptionRecordSlotValue(ExceptionRecord* self, Symbol* slotname, Object* value, boolean setvalueP) {
  ...
  else if (slotname == SYM_KIF_IN_STELLA_MODULE) {
    if (setvalueP) {
...
void helpStartupKifIn1() {
  {
    SGT_KIF_IN_LOGIC_EXCEPTION_RECORD = ((Surrogate*)(internRigidSymbolWrtModule("EXCEPTION-RECORD", NULL, 1)));
    SYM_KIF_IN_STELLA_CONTEXT = ((Symbol*)(internRigidSymbolWrtModule("CONTEXT", getStellaModule("/STELLA", true), 0)));
    SYM_KIF_IN_STELLA_MODULE = ((Symbol*)(internRigidSymbolWrtModule("MODULE", getStellaModule("/STELLA", true), 0)));
...
Surrogate* SGT_KIF_IN_LOGIC_EXCEPTION_RECORD = NULL;

Symbol* SYM_KIF_IN_STELLA_CONTEXT = NULL;

Symbol* SYM_KIF_IN_STELLA_MODULE = NULL;
