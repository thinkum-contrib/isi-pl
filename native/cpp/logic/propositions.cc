...
List* LogicObject::dependentDescriptions_reader() {
  { LogicObject* self = this;

    { List* answer = ((List*)(dynamicSlotValue(self->dynamicSlots, SYM_PROPOSITIONS_LOGIC_DEPENDENT_DESCRIPTIONS, NULL)));
...
Object* accessLogicObjectSlotValue(LogicObject* self, Symbol* slotname, Object* value, boolean setvalueP) {
  if (slotname == SYM_PROPOSITIONS_LOGIC_DEPENDENT_DESCRIPTIONS) {
    if (setvalueP) {
      setDynamicSlotValue(self->dynamicSlots, SYM_PROPOSITIONS_LOGIC_DEPENDENT_DESCRIPTIONS, ((List*)(value)), NULL);
    }
    else {
      value = self->dependentDescriptions_reader();
    }
  }
...
Object* accessTruthValueSlotValue(TruthValue* self, Symbol* slotname, Object* value, boolean setvalueP) {
  if (slotname == SYM_PROPOSITIONS_LOGIC_POSITIVE_SCORE) {
    if (setvalueP) {
...
Object* accessPropositionSlotValue(Proposition* self, Symbol* slotname, Object* value, boolean setvalueP) {
  if (slotname == SYM_PROPOSITIONS_LOGIC_KIND) {
    if (setvalueP) {
...
Proposition* createProposition(Symbol* kind, int argumentcount) {
  ...
  { Proposition* proposition = newProposition();
    ...
    proposition->arguments = newVector(argumentcount);
    ...
    if (descriptionModeP()) {
      setDynamicSlotValue(proposition->dynamicSlots, SYM_PROPOSITIONS_LOGIC_DESCRIPTIVEp, (TRUE ? TRUE_WRAPPER : FALSE_WRAPPER), FALSE_WRAPPER);
    }
  ...
  { NamedDescription* desc = surrogateToDescription(type);
    ...
    if (!((boolean)(desc))) {
      ...
      { 
        ...
        { MemoizationTable* memoTable000 = ((MemoizationTable*)(SGT_PROPOSITIONS_LOGIC_LOGICAL_SUBTYPE_OF_LITERALp_MEMO_TABLE_000->surrogateValue));
          Cons* memoizedEntry000 = NULL;
          Object* memoizedValue000 = NULL;

          if (!((boolean)(memoTable000))) {
            initializeMemoizationTable(SGT_PROPOSITIONS_LOGIC_LOGICAL_SUBTYPE_OF_LITERALp_MEMO_TABLE_000, "(:MAX-VALUES 10 :TIMESTAMPS (:META-KB-UPDATE))");
            memoTable000 = ((MemoizationTable*)(SGT_PROPOSITIONS_LOGIC_LOGICAL_SUBTYPE_OF_LITERALp_MEMO_TABLE_000->surrogateValue));
          }
...
DEFINE_STELLA_SPECIAL(oCLIPPINGENABLEDpo, boolean , FALSE);

// When enabled, blocks normalizations that significantly
// change the behavior of inference rules.
DEFINE_STELLA_SPECIAL(oNATURALDEDUCTIONMODEpo, boolean , FALSE);
...
void logNewlyConceivedProposition(Module* self, Proposition* proposition) {
  { boolean foundP000 = FALSE;
    ...
    if (foundP000) {
      *(STANDARD_WARNING->nativeStream) << "Warning: " << "LOGGED QUESTIONABLE CONCEPTION: " << std::endl << "   " << "`" << proposition << "'" << std::endl << std::endl;
    }
  }
        ...
        { boolean alwaysP000 = TRUE;
          ...
          if (alwaysP000) {
            if (eqlP(valueOf((p->arguments->theArray)[(p->arguments->length() - 1)]), valueOf(arguments->last()))) {
              ...
              signalUnificationClash(valueOf((p->arguments->theArray)[(p->arguments->length() - 1)]), valueOf(arguments->last()));
            }
          }
        }
      }
...
void runTruthChangeDemon(Proposition* proposition, Surrogate* truthchangerelation) {
  { NamedDescription* description = getDescription(((Surrogate*)(proposition->operatoR)));
    Object* demoncomputation = accessBinaryValue(description, truthchangerelation);
    ...
    if (oldtruthvalue == newtruthvalue) {
      ...
      if (newtruthvalue == TRUE_TRUTH_VALUE) {
        ...
        if (oDEFERINGDEFAULTFORWARDINFERENCESpo.get()) {
          deferredDefaultPropositionsSetter(oCONTEXTo.get(), cons(self, deferredDefaultPropositions(oCONTEXTo.get())));
          return;
        }
        else if ((oldtruthvalue == TRUE_TRUTH_VALUE) ||
...
boolean variableP(Object* self) {
  return (isaP(self, SGT_PROPOSITIONS_LOGIC_PATTERN_VARIABLE));
}
...
Symbol* yieldAnonymousSkolemName(boolean variableP) {
  { char* suffix = (variableP ? integerToString(oVARIABLEIDCOUNTERo.set(oVARIABLEIDCOUNTERo.get() + 1)) : integerToString(oSKOLEM_ID_COUNTERo = oSKOLEM_ID_COUNTERo + 1));
...
boolean unknownP(Proposition* self) {
  return (unknownTruthValueP(((TruthValue*)(accessInContext(self->truthValue, self->homeContext, FALSE)))) ||
      ((!(!oDONTUSEDEFAULTKNOWLEDGEpo.get())) &&
       defaultTruthValueP(((TruthValue*)(accessInContext(self->truthValue, self->homeContext, FALSE))))));
}
    ...
    if (subtypeOfP(testValue000, SGT_PROPOSITIONS_LOGIC_DESCRIPTION)) {
      { Object* self000 = self;
        ...
        if (monadicP(self) &&
          ...
          return (SGT_PROPOSITIONS_PL_KERNEL_KB_CLASS);
        }
        else {
...
void bindSkolemToValue(Skolem* fromskolem, Object* tovalue, boolean toplevelupdateP) {
  { boolean typeisokP = FALSE;
    ...
    typeisokP = checkTypeP(tovalue, type, TRUE, tovalue);
    if (!typeisokP) {
      equatingproposition = findEquatingProposition(tovalue, fromskolem);
      if (!((boolean)(equatingproposition))) {
        { 
...
void unbindSkolemValue(Skolem* skolem, boolean toplevelupdateP) {
  { Object* oldvalue = valueOf(skolem);
    ...
    Proposition* equatingprop = findEquatingProposition(oldvalue, skolem);
...
boolean oEQUIVALENCE_COLLECTIONSpo = FALSE;
...
Proposition* findEquatingProposition(Object* directobject, LogicObject* indirectobject) {
  { Object* indirectobjectvalue = valueOf(indirectobject);
    ...
    if (!isaP(backlinkedindirectobject, SGT_PROPOSITIONS_LOGIC_LOGIC_OBJECT)) {
      ...
      while (!eqlP(valueOf(backlinkedindirectobject), indirectobjectvalue)) {
        backlinkedindirectobject = valueOf(backlinkedindirectobject);
      }
    }
  ...
  { List* descriptions = newList();
    ...
    { NamedDescription* desc = NULL;
      ...
      while (!(iter001 == NIL)) {
        ...
        iter001 = iter001->rest;
        size = integerToString(desc->extension->estimatedLength());
...
Proposition* assertImpliesLinkBetweenRelations(NamedDescription* sub, NamedDescription* super) {
  { Proposition* impliesprop = assertDescriptionImpliesDescription(sub, super, TRUE);
    ...
    setDynamicSlotValue(impliesprop->dynamicSlots, SYM_PROPOSITIONS_LOGIC_SUBRELATION_LINKp, (TRUE ? TRUE_WRAPPER : FALSE_WRAPPER), FALSE_WRAPPER);
    updatePropositionTruthValue(impliesprop, KWD_PROPOSITIONS_ASSERT_TRUE);
  ...
  { Proposition* value000 = NULL;
    ...
    { Proposition* isaproposition = value000;
      ...
      if (!((boolean)(isaproposition))) {
        ...
        fastenDownOneProposition(isaproposition, TRUE);
      }
  ...
  { Proposition* value000 = NULL;
    ...
    { Proposition* propertyproposition = value000;
      ...
      if (!((boolean)(propertyproposition))) {
        ...
        fastenDownOneProposition(propertyproposition, TRUE);
      }
...
Object* createLogicInstance(Surrogate* name, Surrogate* type) {
  ...
  { NamedDescription* description = (((boolean)(type)) ? getDescription(type) : ((NamedDescription*)(NULL)));
    ...
    if (((boolean)(type)) &&
        (!((boolean)(description)))) {
      std::cout << "Can't create an instance of the undefined class " << "`" << type->symbolName << "'" << std::endl << std::endl;
      return (NULL);
    }
    if (!((boolean)(description))) {
    ...
    else {
      {
        if (!classDescriptionP(description)) {
          std::cout << "Can't create an instance of a relation: " << "`" << type->symbolName << "'" << std::endl;
          return (NULL);
        }
        ...
        if ((!((boolean)(nativeclass))) ||
          ...
          std::cout << "Can't create an instance of the class " << "`" << type->symbolName << "'" << std::endl << "   because it doesn't inherit the class 'THING'." << std::endl;
          return (NULL);
        }
      }
    }
    if (((boolean)(name))) {
      if (((boolean)(name->surrogateValue))) {
        std::cout << "Redefining the surrogate " << name->symbolName << " will cause the existing" << std::endl << "   object named " << name->symbolName << " to be destroyed. ";
        if (!yOrNP("Do it? ")) {
          std::cout << "Returning existing object:" << std::endl;
          return (name->surrogateValue);
        }
        destroyInstance(name->surrogateValue);
      }
...
StringHashTable* oSTRINGIFIED_PROPOSITION_INDEXo = NULL;

Proposition* findExactDuplicateProposition(Proposition* self) {
  { char* stringification = stringify(self);
    List* bucket = ((List*)(oSTRINGIFIED_PROPOSITION_INDEXo->lookup(stringification)));

    if (!((boolean)(bucket))) {
      oSTRINGIFIED_PROPOSITION_INDEXo->insertAt(stringification, list(1, self));
      return (NULL);
    }
    bucket->removeIf(((cpp_function_code)(&deletedPropositionP)));
    { Proposition* p = NULL;
...
Proposition* findDuplicateProposition(Proposition* self) {
  { Keyword* testValue000 = self->kind;
    ...
    if ((testValue000 == KWD_PROPOSITIONS_FORALL) ||
      ...
      if (!descriptionModeP()) {
        return (findExactDuplicateProposition(self));
      }
    }
    else {
    }
        ...
        if (subtypeOfP(testValue000, SGT_PROPOSITIONS_LOGIC_PROPOSITION)) {
          { Object* arg000 = arg;
            ...
            if (coerceWrappedBooleanToBoolean(arg->unfastenedP_reader())) {
              (self->arguments->theArray)[i] = (helpFastenDownPropositions(arg, dontcheckforduplicatesP));
            }
          }
        }
        else if (subtypeOfP(testValue000, SGT_PROPOSITIONS_LOGIC_SKOLEM)) {
          { Object* arg001 = arg;
            ...
            { Proposition* definingprop = arg->definingProposition;
              ...
              if (((boolean)(definingprop)) &&
                ...
                helpFastenDownPropositions(definingprop, dontcheckforduplicatesP);
              }
            }
          }
        }
              ...
              { Object* value000 = value;
                ...
                { char* testValue000 = stringUpcase(value->symbolName);
                  ...
                  if (stringEqlP(testValue000, "FORWARD")) {
                    setDynamicSlotValue(proposition->dynamicSlots, SYM_PROPOSITIONS_LOGIC_FORWARD_ONLYp, (TRUE ? TRUE_WRAPPER : FALSE_WRAPPER), FALSE_WRAPPER);
                  }
                  else if (stringEqlP(testValue000, "BACKWARD")) {
                    setDynamicSlotValue(proposition->dynamicSlots, SYM_PROPOSITIONS_LOGIC_BACKWARD_ONLYp, (TRUE ? TRUE_WRAPPER : FALSE_WRAPPER), FALSE_WRAPPER);
                  }
                  else {
    ...
    if (((boolean)(annotations))) {
      { Keyword* option = NULL;
        ...
        while (!(iter000 == NIL)) {
          ...
          value = value;
          if (option == KWD_PROPOSITIONS_DIRECTION) {
            setDynamicSlotValue(proposition->dynamicSlots, SYM_PROPOSITIONS_LOGIC_FORWARD_ONLYp, (FALSE ? TRUE_WRAPPER : FALSE_WRAPPER), FALSE_WRAPPER);
            setDynamicSlotValue(proposition->dynamicSlots, SYM_PROPOSITIONS_LOGIC_BACKWARD_ONLYp, (FALSE ? TRUE_WRAPPER : FALSE_WRAPPER), FALSE_WRAPPER);
          }
          else if (option == KWD_PROPOSITIONS_WEIGHT) {
...
Object* evaluateTypedArgument(Object* argument, Surrogate* type) {
  if ((type == SGT_PROPOSITIONS_LOGIC_PROPOSITION) ||
    ...
    return (buildProposition(argument));
  }
...
Proposition* buildPredicateProposition(Cons* tree) {
  ...
  { Object* predicatename = tree->value;
    ...
    if (tree->rest == NIL) {
      if (predicatename == SYM_PROPOSITIONS_PL_KERNEL_KB_CUT) {
      }
      else {
        std::cout << "Predicate " << "`" << predicatename << "'" << " applied to zero arguments." << std::endl;
      }
    }
    else {
      firstargument = evaluateFirstArgument(tree->rest->value, ((Symbol*)(predicatename)));
      (proposition->arguments->theArray)[0] = firstargument;
    }
    predicatevalue = evaluatePredicate(((GeneralizedSymbol*)(predicatename)), firstargument);
    if (((boolean)(predicatevalue)) &&
      ...
      if (descriptionModeP()) {
        ...
        { int lastargindex = tree->length() - 1;
          Object* resultargument = tree->nth(lastargindex);
...
boolean checkTypeP(Object* self, Surrogate* type, boolean shallowP, Object*& _Return1) {
  shallowP = shallowP;
  if ((!((boolean)(type))) ||
      (type == SGT_PROPOSITIONS_STELLA_THING)) {
    _Return1 = self;
      ...
      if (subtypeOfP(testValue000, SGT_PROPOSITIONS_LOGIC_PATTERN_VARIABLE)) {
        ...
        { Object* self001 = self;
          ...
          if (isaP(type->surrogateValue, SGT_PROPOSITIONS_STELLA_CLASS)) {
            typeisokP = subtypeOfP(logicalType(self), type);
          }
          else {
            typeisokP = FALSE;
          }
...
void verifyOneArgumentType(Object* arg, Surrogate* type, Proposition* proposition, NamedDescription* description) {
  ...
  { Object* argvalue = valueOf(arg);
    ...
    typeisokP = checkTypeP(argvalue, type, FALSE, substitutevalue);
    ...
    { Keyword* testValue000 = proposition->kind;
      ...
      if ((testValue000 == KWD_PROPOSITIONS_PREDICATE) ||
        ...
        { Object* arg1 = (proposition->arguments->theArray)[0];
          ...
          typeisokP = checkTypeP(arg1, requiredtype, FALSE, substitutevalue);
          ...
          if (typeisokP) {
            ...
            typeisokP = checkTypeP(arg2, requiredtype, FALSE, substitutevalue);
...
void handleArgumentTypeViolation(Proposition* proposition, Object* arg, Surrogate* requiredtype) {
  if (oTYPECHECKMODEo.get() == KWD_PROPOSITIONS_POST_TYPE_VIOLATIONS) {
    ...
    { Proposition* isaproposition = assertIsaProposition(arg, requiredtype);
      ...
      setDynamicSlotValue(isaproposition->dynamicSlots, SYM_PROPOSITIONS_LOGIC_ASSERTED_BY_TYPE_CHECKERp, (TRUE ? TRUE_WRAPPER : FALSE_WRAPPER), FALSE_WRAPPER);
    }
  }
  else {
    { OutputStringStream* stream000 = newOutputStringStream();

      *(stream000->nativeStream) << "`" << oTYPECHECKMODEo.get() << "'" << " is not a valid case option";
      throw *newStellaException(stream000->theStringReader());
    }
  }
}
...
Object* accessCheckTypesRecordSlotValue(CheckTypesRecord* self, Symbol* slotname, Object* value, boolean setvalueP) {
  if (slotname == SYM_PROPOSITIONS_LOGIC_PARENT_PROPOSITION) {
    if (setvalueP) {
...
KeyValueList* oCHECK_TYPES_AGENDAo = NULL;
...
void postToCheckTypesAgenda(Proposition* self) {
  { CheckTypesRecord* self000 = newCheckTypesRecord();
    ...
    oCHECK_TYPES_AGENDAo->insertAt(self, self000);
  }
}

void processCheckTypesAgenda() {
  if (oCHECK_TYPES_AGENDAo->emptyP() ||
      oINHIBITOBJECTFINALIZATIONpo.get()) {
    return;
  }
  std::cout << "Processing check-types agenda..." << std::endl;
  { KeyValueList* agenda = oCHECK_TYPES_AGENDAo->reverse();

    oCHECK_TYPES_AGENDAo = newKeyValueList();
    { Proposition* proposition = NULL;
      ...
      while (((boolean)(iter000))) {
        ...
        if (!proposition->deletedP()) {
          { 
            ...
            if (proposition->deletedP() ||
                ((((boolean)(oTERMUNDERCONSTRUCTIONo.get())) &&
...
Vector* collectSkolemizedExistsVariables(Proposition* proposition) {
  { List* skolems = newList();
    ...
    if (skolems->emptyP()) {
      ...
      result = newVector(skolems->length());
    }
    { Skolem* skolem = NULL;
      int i = NULL_INTEGER;
      ...
      { Proposition* antecedent = ((Proposition*)((proposition->arguments->theArray)[0]));
        ...
        if (!(cqvars->nonEmptyP() &&
          ...
          { OutputStringStream* stream000 = newOutputStringStream();
            ...
            { 
              BIND_STELLA_SPECIAL(oPRINTREADABLYpo, boolean, TRUE);
              *(stream000->nativeStream) << "ERROR: " << "Illegal implication rule, consequent has variables" << std::endl << "   that are not restricted by the antecedent: " << std::endl << "   " << "`" << proposition << "'" << "." << std::endl;
              helpSignalPropositionError(stream000, KWD_PROPOSITIONS_ERROR);
            }
            throw *newPropositionError(stream000->theStringReader());
          }
...
Proposition* findDuplicateFunctionProposition(Proposition* proposition) {
  ...
  { GeneralizedSymbol* surrogate = proposition->operatoR;
    ...
    if (!isaP(surrogate, SGT_PROPOSITIONS_STELLA_SURROGATE)) {
      return (NULL);
    }
    { Proposition* value000 = NULL;

      { Proposition* p = NULL;
        Iterator* iter000 = findSimilarPropositions(proposition)->allocateIterator();
...
Skolem* createEnumeratedSet(List* set) {
  { Proposition* setprop = beginCreatingFunctionProposition(SGT_PROPOSITIONS_PL_KERNEL_KB_SETOF, set->theConsList);
    Skolem* skolem = createSkolem(SGT_PROPOSITIONS_PL_KERNEL_KB_SET, NULL);
...
Skolem* createLogicalList(List* list) {
  { Proposition* listprop = beginCreatingFunctionProposition(SGT_PROPOSITIONS_PL_KERNEL_KB_LISTOF, list->theConsList);
    Skolem* skolem = createSkolem(SGT_PROPOSITIONS_PL_KERNEL_KB_LIST, NULL);
...
Object* removeTrueAndFalse(Cons* tree, boolean& _Return1) {
  { Symbol* t = SYM_PROPOSITIONS_STELLA_TRUE;
    Symbol* f = SYM_PROPOSITIONS_STELLA_FALSE;
    ...
    { Symbol* testValue001 = ((Symbol*)(tree->value));

      if (testValue001 == SYM_PROPOSITIONS_STELLA_AND) {
        ...
        { boolean foundP001 = FALSE;
          ...
          if (foundP001) {
            _Return1 = TRUE;
            return (SYM_PROPOSITIONS_STELLA_FALSE);
          }
        }
      }
      else if (testValue001 == SYM_PROPOSITIONS_STELLA_OR) {
        tree->rest = tree->rest->remove(f);
        { boolean foundP002 = FALSE;
          ...
          if (foundP002) {
            _Return1 = TRUE;
            return (SYM_PROPOSITIONS_STELLA_TRUE);
          }
        }
      }
      else if (testValue001 == SYM_PROPOSITIONS_STELLA_NOT) {
        { Symbol* testValue002 = ((Symbol*)(tree->rest->value));

          if (testValue002 == SYM_PROPOSITIONS_STELLA_TRUE) {
            _Return1 = TRUE;
            return (SYM_PROPOSITIONS_STELLA_FALSE);
          }
          else if (testValue002 == SYM_PROPOSITIONS_STELLA_FALSE) {
            _Return1 = FALSE;
            return (SYM_PROPOSITIONS_STELLA_TRUE);
          }
          else {
    ...
    _Return1 = TRUE;
    return (canonicalizePropositionTree(tree));
  }
}

Object* flattenNestedOperators(Cons* tree, boolean& _Return1) {
  { boolean testValue000 = FALSE;
    ...
    { boolean foundP000 = FALSE;
      ...
      { Object* arg = NULL;
        ...
        while (!(iter000 == NIL)) {
          ...
          iter000 = iter000->rest;
          if (consP(arg) &&
              eqlP(((Cons*)(arg))->value, tree->value)) {
            foundP000 = TRUE;
            break;
          }
        }
  ...
  { Symbol* targetoperator = ((Symbol*)(tree->value));
    Cons* tail = tree->rest;

    for (;;) {
      if (consP(tail->value) &&
          (((Cons*)(tail->value))->value == targetoperator)) {
        { Cons* nestedargs = ((Cons*)(tail->value))->rest;

          if (nestedargs == NIL) {
            if (targetoperator == SYM_PROPOSITIONS_STELLA_AND) {
              tail->value = SYM_PROPOSITIONS_STELLA_TRUE;
            }
            else if (targetoperator == SYM_PROPOSITIONS_STELLA_OR) {
              tail->value = SYM_PROPOSITIONS_LOGIC_FALS;
            }
            else {
              { OutputStringStream* stream000 = newOutputStringStream();

                *(stream000->nativeStream) << "`" << targetoperator << "'" << " is not a valid case option";
                throw *newStellaException(stream000->theStringReader());
              }
            }
          }
          else if (nestedargs->rest == NIL) {
            tail->value = nestedargs->value;
          }
          else {
            tail->value = nestedargs->value;
            lastCons(nestedargs)->rest = tail->rest;
            tail->rest = nestedargs->rest;
          }
        }
      }
      tail = tail->rest;
...
Object* canonicalizeAndOrTree(Cons* tree) {
  { Symbol* operatoR = ((Symbol*)(tree->value));
    ...
    resulttree = removeTrueAndFalse(tree, canonicalP);
    if (canonicalP) {
      return (resulttree);
    }
    else {
    ...
    if (argcount > 1) {
      resulttree = flattenNestedOperators(tree, canonicalP);
      return (resulttree);
    }
    else if (argcount == 1) {
      arg = tree->rest->value;
      return (canonicalizePropositionTree(arg));
    }
    else {
      if (operatoR == SYM_PROPOSITIONS_STELLA_AND) {
        return (SYM_PROPOSITIONS_STELLA_TRUE);
      }
      else if (operatoR == SYM_PROPOSITIONS_STELLA_OR) {
        return (SYM_PROPOSITIONS_STELLA_FALSE);
      }
      else {
        { OutputStringStream* stream000 = newOutputStringStream();
...
Object* canonicalizeNegationTree(Cons* tree) {
  { Cons* argument = ((Cons*)(tree->rest->value));
    Symbol* nestedoperator = ((Symbol*)(argument->value));

    if (nestedoperator == SYM_PROPOSITIONS_STELLA_NOT) {
      return (canonicalizePropositionTree(argument->rest->value));
    }
    else if ((nestedoperator == SYM_PROPOSITIONS_STELLA_AND) ||
        (nestedoperator == SYM_PROPOSITIONS_STELLA_OR)) {
      { ConsIterator* it = argument->rest->allocateIterator();

        while (it->nextP()) {
          it->valueSetter(listO(3, SYM_PROPOSITIONS_STELLA_NOT, it->value, NIL));
        }
      }
      if (nestedoperator == SYM_PROPOSITIONS_STELLA_AND) {
        argument->firstSetter(SYM_PROPOSITIONS_STELLA_OR);
      }
      else if (nestedoperator == SYM_PROPOSITIONS_STELLA_OR) {
        argument->firstSetter(SYM_PROPOSITIONS_STELLA_AND);
      }
      else {
        { OutputStringStream* stream000 = newOutputStringStream();

          *(stream000->nativeStream) << "`" << nestedoperator << "'" << " is not a valid case option";
          throw *newStellaException(stream000->theStringReader());
        }
      }
    }
    else if (nestedoperator == SYM_PROPOSITIONS_STELLA_EXISTS) {
      { Object* whereclause = argument->rest->rest->value;

        return (canonicalizePropositionTree(listO(3, SYM_PROPOSITIONS_STELLA_FORALL, argument->rest->value, listO(3, SYM_PROPOSITIONS_STELLA_TRUE, listO(3, SYM_PROPOSITIONS_STELLA_NOT, whereclause, NIL), NIL))));
      }
    }
    else if (nestedoperator == SYM_PROPOSITIONS_STELLA_FORALL) {
      { Object* whereclause = argument->rest->rest->value;
        Object* alwaysclause = argument->fourth();

        return (canonicalizePropositionTree(listO(3, SYM_PROPOSITIONS_STELLA_EXISTS, argument->rest->value, cons(listO(3, SYM_PROPOSITIONS_STELLA_AND, whereclause, cons(listO(3, SYM_PROPOSITIONS_STELLA_NOT, alwaysclause, NIL), NIL)), NIL))));
      }
    }
    else {
      return (tree);
    }
    return (canonicalizePropositionTree(argument));
  }
}

boolean quantifierSymbolP(Symbol* self) {
  return ((self == SYM_PROPOSITIONS_STELLA_EXISTS) ||
      ((self == SYM_PROPOSITIONS_STELLA_FORALL) ||
       ((self == SYM_PROPOSITIONS_LOGIC_SETOFALL) ||
        ((self == SYM_PROPOSITIONS_LOGIC_THE_ONLY) ||
         ((self == SYM_PROPOSITIONS_LOGIC_KAPPA) ||
          (self == SYM_PROPOSITIONS_STELLA_SOME))))));
}

boolean allVariablesGoalP(Object* tree) {
  if (!consP(tree)) {
    return (FALSE);
  }
  { Cons* goal = ((Cons*)(tree));
    Object* operatoR = goal->value;

    { boolean testValue000 = FALSE;

      testValue000 = symbolP(operatoR);
      if (testValue000) {
        testValue000 = !oKIF_SENTENCE_OPERATORSo->memberP(operatoR);
        if (testValue000) {
          { boolean alwaysP000 = TRUE;

            { Object* arg = NULL;
              Cons* iter000 = goal->rest;
...
boolean equalArgumentsP(Cons* goal1, Cons* goal2) {
  { boolean testValue000 = FALSE;
    ...
    { boolean alwaysP000 = TRUE;
      ...
      { Object* arg1 = NULL;
        Object* arg2 = NULL;
        Cons* iter000 = goal1->rest;
        Cons* iter001 = goal2->rest;
    ...
    if (testValue000) {
      testValue000 = goal1->length() == goal2->length();
    }
    { boolean value000 = testValue000;
...
Cons* explodeForallTree(Cons* tree) {
  { Object* antecedent = tree->rest->rest->value;
    Object* consequent = tree->fourth();

    if ((!allVariablesGoalP(antecedent)) ||
        ((!consP(consequent)) ||
         (!(((Cons*)(consequent))->value == SYM_PROPOSITIONS_STELLA_AND)))) {
      return (tree);
    }
    { Cons* antecedentgoal = ((Cons*)(antecedent));
      Cons* conjuncts = ((Cons*)(consequent))->rest;
      ...
      { Cons* v025 = NIL;
        ...
        { Object* goal = NULL;
          ...
          while (!(iter000 == NIL)) {
            goal = iter000->value;
            iter000 = iter000->rest;
            if (allVariablesGoalP(goal) &&
                equalArgumentsP(((Cons*)(goal)), antecedentgoal)) {
              if (!((boolean)(collect000))) {
                {
                  collect000 = cons(goal, NIL);
                  if (v025 == NIL) {
                    v025 = collect000;
                  }
                  else {
                    addConsToEndOfConsList(v025, collect000);
                  }
                }
              }
              else {
                {
                  collect000->rest = cons(goal, NIL);
                  collect000 = collect000->rest;
                }
              }
            }
        ...
        { Cons* matchinggoals = v025;
          Cons* othergoals = conjuncts->difference(matchinggoals);
          Cons* rules = NIL;
          ...
          { Object* g = NULL;
            Cons* iter001 = matchinggoals;

            while (!(iter001 == NIL)) {
              g = iter001->value;
              iter001 = iter001->rest;
              rules = cons(((Cons*)(copyConsTree(listO(3, SYM_PROPOSITIONS_STELLA_FORALL, tree->rest->value, cons(antecedentgoal, cons(g, NIL)))))), rules);
            }
          }
          if (!(othergoals == NIL)) {
            rules = cons(listO(3, SYM_PROPOSITIONS_STELLA_FORALL, tree->rest->value, cons(antecedentgoal, cons(cons(SYM_PROPOSITIONS_STELLA_AND, othergoals->concatenate(NIL, 0)), NIL))), rules);
          }
          return (((Cons*)(canonicalizePropositionTree(cons(SYM_PROPOSITIONS_STELLA_AND, rules->concatenate(NIL, 0))))));
        }
      }
    }
  }
...
Cons* canonicalizeQuantificationTree(Cons* tree) {
  { Object* whereclause = tree->rest->rest->value;
    Object* alwaysclause = tree->fourth();

    if (((boolean)(whereclause))) {
      tree->thirdSetter(canonicalizePropositionTree(whereclause));
    }
    else {
      tree->concatenate(cons(SYM_PROPOSITIONS_STELLA_TRUE, NIL), 0);
    }
    if (((boolean)(alwaysclause))) {
      tree->fourthSetter(canonicalizePropositionTree(alwaysclause));
    }
    if (((GeneralizedSymbol*)(tree->value)) == SYM_PROPOSITIONS_STELLA_FORALL) {
      return (explodeForallTree(tree));
    }
    else {
      return (tree);
    }
...
Object* consDcanonicalizePropositionTree(Cons* tree) {
  { Symbol* operatoR = ((Symbol*)(tree->value));

    if (quantifierSymbolP(operatoR)) {
      return (canonicalizeQuantificationTree(tree));
    }
    { ConsIterator* it = tree->rest->allocateIterator();

      while (it->nextP()) {
        it->valueSetter(canonicalizePropositionTree(it->value));
      }
    }
    if ((operatoR == SYM_PROPOSITIONS_STELLA_AND) ||
        (operatoR == SYM_PROPOSITIONS_STELLA_OR)) {
      return (canonicalizeAndOrTree(tree));
    }
    else if (operatoR == SYM_PROPOSITIONS_STELLA_NOT) {
      { Object* arg = tree->rest->value;

        if (consP(arg)) {
          return (canonicalizeNegationTree(tree));
        }
        if (arg == SGT_PROPOSITIONS_STELLA_TRUE) {
          return (SGT_PROPOSITIONS_STELLA_FALSE);
        }
        else if (arg == SGT_PROPOSITIONS_STELLA_FALSE) {
          return (SGT_PROPOSITIONS_STELLA_TRUE);
        }
        else {
          return (tree);
        }
...
Object* canonicalizePropositionTree(Object* tree) {
  if (safePrimaryType(tree) == SGT_PROPOSITIONS_STELLA_CONS) {
    { Object* tree000 = tree;
      ...
      return (consDcanonicalizePropositionTree(tree));
    }
  }
  else {
    return (tree);
...
Proposition* skolemizeExistsProposition(Proposition* existsproposition) {
  { KeyValueList* mapping = newKeyValueList();
    ...
    eraseProposition(existsproposition);
  ...
  { Surrogate* testValue000 = safePrimaryType(tree);
    ...
    if (subtypeOfStringP(testValue000)) {
      ...
      { Object* tree003 = tree;
        ...
        return (conceiveTerm(surrogateToSymbol(tree)));
      }
    }
    else {
      return (conceiveSentence(tree));
...
void unassert(Object* proposition) {
  ...
  // already be defined.
  unassertFact(buildTopLevelProposition(proposition, FALSE));
}

void unassertFact(Proposition* self) {
  ...
  if (((boolean)(self))) {
    if (self->kind == KWD_PROPOSITIONS_FUNCTION) {
      { Skolem* outputskolem = ((Skolem*)((self->arguments->theArray)[(self->arguments->length() - 1)]));
        ...
        if (((boolean)(((Object*)(accessInContext(outputskolem->variableValue, outputskolem->homeContext, FALSE)))))) {
          unequateValuesP(outputskolem, ((Object*)(accessInContext(outputskolem->variableValue, outputskolem->homeContext, FALSE))));
        }
      }
    }
    else if (trueP(self)) {
...
void clearLogicModuleHook(Module* module) {
  { 
    ...
    oSTRINGIFIED_PROPOSITION_INDEXo = newStringHashTable();
...
void destroyLogicContextHook(Context* self) {
  setDynamicSlotValue(self->dynamicSlots, SYM_PROPOSITIONS_LOGIC_MONOTONICp, (FALSE ? TRUE_WRAPPER : FALSE_WRAPPER), FALSE_WRAPPER);
  { 
...
boolean propositionLessThanP(Proposition* p1, Proposition* p2) {
  if (stringLessP(p1->operatoR->symbolName, p2->operatoR->symbolName)) {
    return (TRUE);
  }
  if (stringLessP(p2->operatoR->symbolName, p1->operatoR->symbolName)) {
    return (FALSE);
  }
  { Object* a1 = NULL;
    Object* a2 = NULL;
  ...
  { Surrogate* testValue000 = safePrimaryType(o);
    ...
    if (subtypeOfIntegerP(testValue000)) {
      ...
      { Object* o006 = o;
        ...
        std::cout << "Skolem " << o << " value = " << ((Object*)(accessInContext(o->variableValue, o->homeContext, FALSE)));
...
boolean logicFormLessP(Object* o1, Object* o2) {
  ...
  if (isaP(o1, SGT_PROPOSITIONS_LOGIC_SKOLEM)) {
    o1 = ((Object*)(accessInContext(((Skolem*)(o1))->variableValue, ((Skolem*)(o1))->homeContext, FALSE)));
  }
  if (isaP(o2, SGT_PROPOSITIONS_LOGIC_SKOLEM)) {
    o2 = ((Object*)(accessInContext(((Skolem*)(o2))->variableValue, ((Skolem*)(o2))->homeContext, FALSE)));
  }
  if (!((boolean)(o1))) {
    return (FALSE);
  }
  ...
  { Surrogate* testValue000 = safePrimaryType(o1);
    ...
    if (subtypeOfIntegerP(testValue000)) {
      ...
      { Object* o1001 = o1;
        ...
        { Surrogate* testValue002 = safePrimaryType(o2);
          ...
          if (subtypeOfIntegerP(testValue002)) {
            { Object* o2002 = o2;
              IntegerWrapper* o2 = ((IntegerWrapper*)(o2002));
            ...
            { Object* o2003 = o2;
              FloatWrapper* o2 = ((FloatWrapper*)(o2003));
      ...
      { Object* o1002 = o1;
        Proposition* o1 = ((Proposition*)(o1002));

        { Surrogate* testValue003 = safePrimaryType(o2);

          if (subtypeOfP(testValue003, SGT_PROPOSITIONS_LOGIC_PROPOSITION)) {
            { Object* o2004 = o2;
              Proposition* o2 = ((Proposition*)(o2004));

              return (propositionLessThanP(o1, o2));
            }
          }
          else if (subtypeOfP(testValue003, SGT_PROPOSITIONS_LOGIC_NAMED_DESCRIPTION)) {
            { Object* o2005 = o2;
              NamedDescription* o2 = ((NamedDescription*)(o2005));

              return (stringLessP(propositionHeadSortString(o1), objectSortString(o2)));
            }
          }
          else if (subtypeOfP(testValue003, SGT_PROPOSITIONS_LOGIC_DESCRIPTION)) {
            { Object* o2006 = o2;
              Description* o2 = ((Description*)(o2006));
      ...
      { Object* o1003 = o1;
        ...
        { Surrogate* testValue004 = safePrimaryType(o2);
          ...
          if (subtypeOfP(testValue004, SGT_PROPOSITIONS_LOGIC_PROPOSITION)) {
            ...
            { Object* o2008 = o2;
              NamedDescription* o2 = ((NamedDescription*)(o2008));
            ...
            { Object* o2009 = o2;
              Description* o2 = ((Description*)(o2009));
      ...
      { Object* o1004 = o1;
        Description* o1 = ((Description*)(o1004));
      ...
      { Surrogate* testValue005 = safePrimaryType(o2);
        ...
        if (subtypeOfP(testValue005, SGT_PROPOSITIONS_LOGIC_PROPOSITION)) {
          { Object* o2010 = o2;
            Proposition* o2 = ((Proposition*)(o2010));
          ...
          { Object* o2011 = o2;
            NamedDescription* o2 = ((NamedDescription*)(o2011));
          ...
          { Object* o2012 = o2;
            Description* o2 = ((Description*)(o2012));
...
void helpStartupPropositions1() {
  {
    ...
    SYM_PROPOSITIONS_LOGIC_DEPENDENT_DESCRIPTIONS = ((Symbol*)(internRigidSymbolWrtModule("DEPENDENT-DESCRIPTIONS", NULL, 0)));
...
void helpStartupPropositions2() {
  {
    ...
    SGT_PROPOSITIONS_LOGIC_LOGICAL_SUBTYPE_OF_LITERALp_MEMO_TABLE_000 = ((Surrogate*)(internRigidSymbolWrtModule("LOGICAL-SUBTYPE-OF-LITERAL?-MEMO-TABLE-000", NULL, 1)));
...
void helpStartupPropositions3() {
  {
    ...
    SGT_PROPOSITIONS_PL_KERNEL_KB_CLASS = ((Surrogate*)(internRigidSymbolWrtModule("CLASS", getStellaModule("/PL-KERNEL-KB", TRUE), 1)));
    ...
    SYM_PROPOSITIONS_LOGIC_p = ((Symbol*)(internRigidSymbolWrtModule("?", NULL, 0)));
...
void helpStartupPropositions4() {
  {
    ...
    SYM_PROPOSITIONS_PL_KERNEL_KB_CUT = ((Symbol*)(internRigidSymbolWrtModule("CUT", getStellaModule("/PL-KERNEL-KB", TRUE), 0)));
    ...
    SYM_PROPOSITIONS_LOGIC_FALS = ((Symbol*)(internRigidSymbolWrtModule("FALS", NULL, 0)));
    SYM_PROPOSITIONS_STELLA_SOME = ((Symbol*)(internRigidSymbolWrtModule("SOME", getStellaModule("/STELLA", TRUE), 0)));
...
void helpStartupPropositions5() {
  {
    ...
    oCLIPPINGENABLEDpo.set(TRUE);
    oNATURALDEDUCTIONMODEpo.set(TRUE);
    oCONTEXT_DEPENDENT_SEARCH_MODEpo = FALSE;
    oCOMPUTEDQUERYpo.set(FALSE);
    TRUE_TRUTH_VALUE = newTruthValue();
    FALSE_TRUTH_VALUE = newTruthValue();
    DEFAULT_TRUE_TRUTH_VALUE = newTruthValue();
    DEFAULT_FALSE_TRUTH_VALUE = newTruthValue();
    UNKNOWN_TRUTH_VALUE = newTruthValue();
    oSUPPRESSUNTYPEDTYPEERRORpo.set(FALSE);
    oEQUIVALENCE_COLLECTIONSpo = TRUE;
    { Proposition* self010 = newProposition();

      self010->kind = KWD_PROPOSITIONS_CONSTANT;
      self010->operatoR = SGT_PROPOSITIONS_STELLA_TRUE;
      self010->arguments = newVector(0);
    ...
    ANONYMOUS_VARIABLE_NAME = SYM_PROPOSITIONS_LOGIC_p;
    oMISSING_KEY_VALUE_LISTo = newKeyValueList();
    oAUTOMATICINSTANCETABLEo.set(oMISSING_KEY_VALUE_LISTo);
    oSTRINGIFIED_PROPOSITION_INDEXo = newStringHashTable();
    oDONT_CHECK_FOR_DUPLICATE_PROPOSITIONSpo.set(FALSE);
    oAUTO_COERCE_PROPOSITIONAL_ARGUMENTSpo = FALSE;
...
void helpStartupPropositions6() {
  {
    ...
    { Class* clasS = defineClassFromStringifiedSource("TRUTH-VALUE", "(DEFCLASS TRUTH-VALUE (LOGIC-OBJECT) :PUBLIC-SLOTS ((POSITIVE-SCORE :TYPE PARTIAL-MATCH-SCORE :INITIALLY 0.0)))");
    ...
    { Class* clasS = defineClassFromStringifiedSource("STRING-LOGIC-WRAPPER", "(DEFCLASS STRING-LOGIC-WRAPPER (STRING-WRAPPER BACKLINKS-MIXIN) :PRINT-FORM (IF *PRINTREADABLY?* (PRINT-NATIVE-STREAM STREAM (WRAPPER-VALUE SELF)) (PRINT-NATIVE-STREAM STREAM \"|W|\" (WRAPPER-VALUE SELF))))");

      clasS->classConstructorCode = ((cpp_function_code)(&newStringLogicWrapper));
    }
    { Class* clasS = defineClassFromStringifiedSource("CHECK-TYPES-RECORD", "(DEFCLASS CHECK-TYPES-RECORD (STANDARD-OBJECT) :SLOTS ((PARENT-PROPOSITION :TYPE OBJECT) (PARENT-DESCRIPTION :TYPE DESCRIPTION) (MODULE :TYPE MODULE)))");
...
void helpStartupPropositions7() {
  {
    ...
    defineFunctionObject("OBJECT-SURROGATE", "(DEFUN (OBJECT-SURROGATE SURROGATE) ((SELF OBJECT)) :DOCUMENTATION \"Return the surrogate naming the logic object `self'.\" :PUBLIC? TRUE)", ((cpp_function_code)(&objectSurrogate)), NULL);
...
void helpStartupPropositions8() {
  {
    ...
    defineFunctionObject("TRUE?", "(DEFUN (TRUE? BOOLEAN) ((SELF PROPOSITION)) :PUBLIC? TRUE)", ((cpp_function_code)(&trueP)), NULL);
    defineFunctionObject("FALSE?", "(DEFUN (FALSE? BOOLEAN) ((SELF PROPOSITION)) :PUBLIC? TRUE)", ((cpp_function_code)(&falseP)), NULL);
    defineFunctionObject("UNKNOWN?", "(DEFUN (UNKNOWN? BOOLEAN) ((SELF PROPOSITION)) :PUBLIC? TRUE)", ((cpp_function_code)(&unknownP)), NULL);
    defineFunctionObject("DEFAULT-TRUE?", "(DEFUN (DEFAULT-TRUE? BOOLEAN) ((SELF PROPOSITION)) :PUBLIC? TRUE)", ((cpp_function_code)(&defaultTrueP)), NULL);
    defineFunctionObject("DEFAULT-FALSE?", "(DEFUN (DEFAULT-FALSE? BOOLEAN) ((SELF PROPOSITION)) :PUBLIC? TRUE)", ((cpp_function_code)(&defaultFalseP)), NULL);
...
void helpStartupPropositions9() {
  {
    ...
    defineFunctionObject("UPDATE-TUPLE", "(DEFUN (UPDATE-TUPLE PROPOSITION) ((RELATION SURROGATE) (ARGUMENTS (CONS OF OBJECT)) (UPDATEMODE KEYWORD)) :PUBLIC? TRUE)", ((cpp_function_code)(&updateTuple)), NULL);
    ...
    defineFunctionObject("FIND-EXACT-DUPLICATE-PROPOSITION", "(DEFUN (FIND-EXACT-DUPLICATE-PROPOSITION PROPOSITION) ((SELF PROPOSITION)))", ((cpp_function_code)(&findExactDuplicateProposition)), NULL);
...
void helpStartupPropositions10() {
  {
    ...
    defineFunctionObject("CHECK-TYPE?", "(DEFUN (CHECK-TYPE? BOOLEAN OBJECT) ((SELF OBJECT) (TYPE SURROGATE) (SHALLOW? BOOLEAN)))", ((cpp_function_code)(&checkTypeP)), NULL);
    ...
    defineFunctionObject("REMOVE-TRUE-AND-FALSE", "(DEFUN (REMOVE-TRUE-AND-FALSE OBJECT BOOLEAN) ((TREE CONS)))", ((cpp_function_code)(&removeTrueAndFalse)), NULL);
    defineFunctionObject("FLATTEN-NESTED-OPERATORS", "(DEFUN (FLATTEN-NESTED-OPERATORS OBJECT BOOLEAN) ((TREE CONS)))", ((cpp_function_code)(&flattenNestedOperators)), NULL);
  }
}

void helpStartupPropositions11() {
  {
    defineFunctionObject("CANONICALIZE-AND-OR-TREE", "(DEFUN (CANONICALIZE-AND-OR-TREE OBJECT) ((TREE CONS)))", ((cpp_function_code)(&canonicalizeAndOrTree)), NULL);
    defineFunctionObject("CANONICALIZE-NEGATION-TREE", "(DEFUN (CANONICALIZE-NEGATION-TREE OBJECT) ((TREE CONS)))", ((cpp_function_code)(&canonicalizeNegationTree)), NULL);
    defineFunctionObject("QUANTIFIER-SYMBOL?", "(DEFUN (QUANTIFIER-SYMBOL? BOOLEAN) ((SELF SYMBOL)))", ((cpp_function_code)(&quantifierSymbolP)), NULL);
    defineFunctionObject("ALL-VARIABLES-GOAL?", "(DEFUN (ALL-VARIABLES-GOAL? BOOLEAN) ((TREE OBJECT)))", ((cpp_function_code)(&allVariablesGoalP)), NULL);
    defineFunctionObject("EQUAL-ARGUMENTS?", "(DEFUN (EQUAL-ARGUMENTS? BOOLEAN) ((GOAL1 CONS) (GOAL2 CONS)))", ((cpp_function_code)(&equalArgumentsP)), NULL);
    defineFunctionObject("EXPLODE-FORALL-TREE", "(DEFUN (EXPLODE-FORALL-TREE CONS) ((TREE CONS)))", ((cpp_function_code)(&explodeForallTree)), NULL);
    defineFunctionObject("CANONICALIZE-QUANTIFICATION-TREE", "(DEFUN (CANONICALIZE-QUANTIFICATION-TREE CONS) ((TREE CONS)))", ((cpp_function_code)(&canonicalizeQuantificationTree)), NULL);
    defineFunctionObject("CONS.CANONICALIZE-PROPOSITION-TREE", "(DEFUN (CONS.CANONICALIZE-PROPOSITION-TREE OBJECT) ((TREE CONS)))", ((cpp_function_code)(&consDcanonicalizePropositionTree)), NULL);
    ...
    defineFunctionObject("ERASE-PROPOSITION", "(DEFUN ERASE-PROPOSITION ((PROPOSITION PROPOSITION)))", ((cpp_function_code)(&eraseProposition)), NULL);
    ...
    defineFunctionObject("UNASSERT", "(DEFUN UNASSERT ((PROPOSITION PARSE-TREE)) :DOCUMENTATION \"Retract the truth or falsity of `proposition'.  This is a more general\nversion of `retract' that also handles falsity.  For example, if we\nassert the proposition \\\"(not (sad Fred))\\\", and then execute the statement\n\\\"(unassert (sad Fred))\\\", the truth value of the proposition \\\"(sad Fred)\\\"\nwill be set to UNKNOWN.  If we had called `retract' in place of `unassert',\nthe proposition \\\"(sad Fred)\\\" would remain set to FALSE.   Note that for this\nunassertion to succeed, the logic constant `Fred' and the relation `sad' must\nalready be defined.\" :PUBLIC? TRUE :COMMAND? TRUE :EVALUATE-ARGUMENTS? FALSE)", ((cpp_function_code)(&unassert)), NULL);
    defineFunctionObject("UNASSERT-FACT", "(DEFUN UNASSERT-FACT ((SELF PROPOSITION)) :DOCUMENTATION \"Retract the truth or falsity of the proposition 'self'\" :PUBLIC? TRUE)", ((cpp_function_code)(&unassertFact)), NULL);
    ...
    { MethodSlot* function = lookupFunction(SYM_PROPOSITIONS_LOGIC_STARTUP_PROPOSITIONS);
      ...
      setDynamicSlotValue(function->dynamicSlots, SYM_PROPOSITIONS_STELLA_METHOD_STARTUP_CLASSNAME, wrapString("_Startup-Propositions"), NULL_STRING_WRAPPER);
    }
  }
}
...
void startupPropositions() {
  { 
    ...
    if (currentStartupTimePhaseP(9)) {
      ...
      defineStellaGlobalVariableFromStringifiedSource("(DEFCONSTANT TRUE-TRUTH-VALUE TRUTH-VALUE (NEW TRUTH-VALUE) :DOCUMENTATION \"Value representing TRUE.\")");
      defineStellaGlobalVariableFromStringifiedSource("(DEFCONSTANT FALSE-TRUTH-VALUE TRUTH-VALUE (NEW TRUTH-VALUE) :DOCUMENTATION \"Value representing FALSE.\")");
      defineStellaGlobalVariableFromStringifiedSource("(DEFCONSTANT DEFAULT-TRUE-TRUTH-VALUE TRUTH-VALUE (NEW TRUTH-VALUE) :DOCUMENTATION \"Value representing DEFAULT-TRUE.\")");
      defineStellaGlobalVariableFromStringifiedSource("(DEFCONSTANT DEFAULT-FALSE-TRUTH-VALUE TRUTH-VALUE (NEW TRUTH-VALUE) :DOCUMENTATION \"Value representing DEFAULT-FALSE.\")");
      defineStellaGlobalVariableFromStringifiedSource("(DEFCONSTANT UNKNOWN-TRUTH-VALUE TRUTH-VALUE (NEW TRUTH-VALUE) :DOCUMENTATION \"Value representing UNKNOWN.  Needed for those cases\nwhere we need a non-NULL truth value to represents UNKNOWN.\")");
      TRUE_TRUTH_VALUE->positiveScore = 1.0;
      FALSE_TRUTH_VALUE->positiveScore = -1.0;
      DEFAULT_TRUE_TRUTH_VALUE->positiveScore = 0.8;
      DEFAULT_FALSE_TRUTH_VALUE->positiveScore = -0.8;
      ...
      defineStellaGlobalVariableFromStringifiedSource("(DEFCONSTANT TRUE-PROPOSITION PROPOSITION (NEW PROPOSITION :KIND :CONSTANT :OPERATOR @TRUE :ARGUMENTS (NEW ARGUMENTS-VECTOR :ARRAY-SIZE 0) :TRUTH-VALUE TRUE-TRUTH-VALUE))");
      defineStellaGlobalVariableFromStringifiedSource("(DEFCONSTANT FALSE-PROPOSITION PROPOSITION (NEW PROPOSITION :KIND :CONSTANT :OPERATOR @FALSE :ARGUMENTS (NEW ARGUMENTS-VECTOR :ARRAY-SIZE 0) :TRUTH-VALUE FALSE-TRUTH-VALUE))");
      ...
      defineStellaGlobalVariableFromStringifiedSource("(DEFGLOBAL *STRINGIFIED-PROPOSITION-INDEX* (STRING-HASH-TABLE OF STRING LIST) (NEW STRING-HASH-TABLE) :DOCUMENTATION \"Contains a table of propositions, indexed by their\nstringifications.  Tricky: Propositions in two\ndifferent modules could have the same stringification but be different.\")");
      ...
      defineStellaGlobalVariableFromStringifiedSource("(DEFGLOBAL *CHECK-TYPES-AGENDA* (KEY-VALUE-LIST OF PROPOSITION CHECK-TYPES-RECORD) (NEW KEY-VALUE-LIST) :DOCUMENTATION \"List of propositions that have failed a type check,\nbut might pass once finalization is complete.\")");
...
Symbol* SYM_PROPOSITIONS_LOGIC_DEPENDENT_DESCRIPTIONS = NULL;
...
Surrogate* SGT_PROPOSITIONS_LOGIC_LOGICAL_SUBTYPE_OF_LITERALp_MEMO_TABLE_000 = NULL;
...
Surrogate* SGT_PROPOSITIONS_PL_KERNEL_KB_CLASS = NULL;
...
Symbol* SYM_PROPOSITIONS_LOGIC_p = NULL;
...
Symbol* SYM_PROPOSITIONS_PL_KERNEL_KB_CUT = NULL;
...
Symbol* SYM_PROPOSITIONS_LOGIC_FALS = NULL;

Symbol* SYM_PROPOSITIONS_STELLA_SOME = NULL;
