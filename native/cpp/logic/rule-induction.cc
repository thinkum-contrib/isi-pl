...
boolean oENABLE_USER_THINGo = FALSE;

boolean oOPTIMIZE_INDUCED_QUERIESo = FALSE;
...
boolean oINDUCE_RULES_FROM_SIGNATURESo = FALSE;
...
boolean oALLOW_RECURSIVE_DECISION_NODESo = FALSE;
...
void helpStartupRuleInduction2() {
  {
    ...
    oENABLE_USER_THINGo = TRUE;
    oOPTIMIZE_INDUCED_QUERIESo = TRUE;
    oSIMPLIFY_RULE_ANTECEDENTpo = FALSE;
    oTRACE_ID3o = FALSE;
    oTRACE_FOILo = FALSE;
    oINDUCE_RULES_FROM_SIGNATURESo = TRUE;
    oENFORCE_LINKED_VARIABLESo = FALSE;
    oLOG_INDUCED_RULESo = FALSE;
    oALLOW_RECURSIVE_DECISION_NODESo = TRUE;
    oLOG_DECISION_RULE_CONSTRUCTIONo = FALSE;
  }
}
  ...
  { 
    ...
    if (currentStartupTimePhaseP(7)) {
      ...
      { MethodSlot* function = lookupFunction(SYM_RULE_INDUCTION_LOGIC_STARTUP_RULE_INDUCTION);
        ...
        setDynamicSlotValue(function->dynamicSlots, SYM_RULE_INDUCTION_STELLA_METHOD_STARTUP_CLASSNAME, wrapString("_Startup-Rule-Induction"), NULL_STRING_WRAPPER);
      }
    }
