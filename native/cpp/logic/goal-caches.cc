...
boolean oCACHE_SUCCEEDED_GOALSpo = FALSE;

boolean oCACHE_FAILED_GOALSpo = FALSE;
  ...
  { 
    ...
    if (currentStartupTimePhaseP(7)) {
      ...
      { MethodSlot* function = lookupFunction(SYM_GOAL_CACHES_LOGIC_STARTUP_GOAL_CACHES);
        ...
        setDynamicSlotValue(function->dynamicSlots, SYM_GOAL_CACHES_STELLA_METHOD_STARTUP_CLASSNAME, wrapString("_Startup-Goal-Caches"), NULL_STRING_WRAPPER);
      }
    }
