                      ...
                      if (!((boolean)(collect000))) {
                        {
                          ...
                          if (v029 == NIL) {
                            ...
                            addConsToEndOfConsList(v029, collect000);
                          }
                        }
                      }
                      else {
                          ...
                          if (!((boolean)(collect000))) {
                            {
                              ...
                              if (v030 == NIL) {
                                ...
                                addConsToEndOfConsList(v030, collect000);
                              }
                            }
                          }
                          else {
                          ...
                          if (!((boolean)(collect001))) {
                            {
                              ...
                              if (v031 == NIL) {
                                ...
                                addConsToEndOfConsList(v031, collect001);
                              }
                            }
                          }
                          else {
                              ...
                              if (!((boolean)(collect000))) {
                                {
                                  ...
                                  if (v032 == NIL) {
                                    ...
                                    addConsToEndOfConsList(v032, collect000);
                                  }
                                }
                              }
                              else {
                              ...
                              if (!((boolean)(collect001))) {
                                {
                                  ...
                                  if (v033 == NIL) {
                                    ...
                                    addConsToEndOfConsList(v033, collect001);
                                  }
                                }
                              }
                              else {
          ...
          { HashTable* table = index->predicatePropositionsTable;
            ...
            if (((boolean)(table))) {
              { SequenceIndex* temp000 = ((SequenceIndex*)(table->lookup(SGT_BACKLINKS_PL_KERNEL_KB_SUBSET_OF)));
                ...
                { SequenceIndex* value000 = (((boolean)(temp000)) ? ((SequenceIndex*)(temp000)) : NIL_NON_PAGING_INDEX);

                  return (((SequenceIndex*)(value000)));
                }
              }
            }
            else {
        ...
        if (!((boolean)(collect000))) {
          {
            ...
            if (v034 == NIL) {
              ...
              addConsToEndOfConsList(v034, collect000);
            }
          }
        }
        else {
