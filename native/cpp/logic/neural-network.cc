        ...
        { TrainingExample* example = NULL;
          ...
          for  (example, vector000, index000, length000, k, iter002; 
            ...
            { Cons* form = ((Cons*)(copyConsTree(example->query)));
              ...
              QueryIterator* query = makeQuery(NIL, coerceToTree(form), NIL, NIL, "NNexample");
  ...
  { double mse = 0.0;
    ...
    { TrainingExample* example = NULL;
      ...
      for  (example, iter000, i, iter001; 
        ...
        query = makeQuery(NIL, coerceToTree(form), NIL, NIL, "NNexample2");
  ...
  { double mse = 0.0;
    ...
    { TrainingExample* example = NULL;
      ...
      for  (example, vector000, index000, length000; 
        ...
        { Cons* form = ((Cons*)(copyConsTree(example->query)));
          QueryIterator* query = makeQuery(NIL, coerceToTree(form), NIL, NIL, "NNTest");
          double output = returnPartialTruth(query, true);
  ...
  { double errorSum = 0.0;
    ...
    { TrainingExample* example = NULL;
      ...
      for (example, iter000; !(iter000 == NIL); iter000 = iter000->rest) {
        ...
        { Cons* form = ((Cons*)(copyConsTree(example->query)));
          QueryIterator* query = makeQuery(NIL, coerceToTree(form), NIL, NIL, "NNTest2");
          double output = returnPartialTruth(query, true);
          double error = example->score - output;
...
Cons* createCachedNetwork(Cons* consQuery) {
  { QueryIterator* query = makeQuery(NIL, coerceToTree(((Cons*)(copyConsTree(consQuery)))), NIL, NIL, "NNCached");
...
Vector* createHiddenSignature(Cons* consQuery) {
  { QueryIterator* query = makeQuery(NIL, ((Cons*)(copyConsTree(consQuery))), NIL, NIL, "NNsignature");
