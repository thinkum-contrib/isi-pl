...
boolean oTRAIN_CACHED_NETWORKSpo = FALSE;
...
void helpStartupNeuralNetwork2() {
  {
    oNEURAL_NETWORK_TRAINING_METHODo = KWD_NEURAL_NETWORK_BACKPROP;
    oTRACE_NEURAL_NETWORK_TRAININGo = FALSE;
    oTRAIN_CACHED_NETWORKSpo = TRUE;
  ...
  { 
    ...
    if (currentStartupTimePhaseP(7)) {
      ...
      { MethodSlot* function = lookupFunction(SYM_NEURAL_NETWORK_LOGIC_STARTUP_NEURAL_NETWORK);
        ...
        setDynamicSlotValue(function->dynamicSlots, SYM_NEURAL_NETWORK_STELLA_METHOD_STARTUP_CLASSNAME, wrapString("_Startup-Neural-Network"), NULL_STRING_WRAPPER);
      }
    }
