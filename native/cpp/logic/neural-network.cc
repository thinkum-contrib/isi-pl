          ...
          { Cons* proofs = prop->support_reader();
            ...
            if (oRULE_COMBINATIONo == KWD_NEURAL_NETWORK_MAX) {
              ...
              { PartialSupport* proof = NULL;
                ...
                for (; !(iter011 == NIL); iter011 = iter011->rest) {
            ...
            { PartialSupport* proof = NULL;
              ...
              for (; !(iter012 == NIL); iter012 = iter012->rest) {
