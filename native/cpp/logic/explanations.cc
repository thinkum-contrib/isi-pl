...
Object* accessExplanationInfoSlotValue(ExplanationInfo* self, Symbol* slotname, Object* value, boolean setvalueP) {
  ...
  else if (slotname == SYM_EXPLANATIONS_LOGIC_DEPTH) {
    if (setvalueP) {
...
void helpStartupExplanations1() {
  {
    ...
    SYM_EXPLANATIONS_LOGIC_DEPTH = ((Symbol*)(internRigidSymbolWrtModule("DEPTH", NULL, 0)));
  ...
  { 
    ...
    if (currentStartupTimePhaseP(7)) {
      ...
      { MethodSlot* function = lookupFunction(SYM_EXPLANATIONS_LOGIC_STARTUP_EXPLANATIONS);
        ...
        setDynamicSlotValue(function->dynamicSlots, SYM_EXPLANATIONS_STELLA_METHOD_STARTUP_CLASSNAME, wrapString("_Startup-Explanations"), NULL_STRING_WRAPPER);
      }
    }
...
Symbol* SYM_EXPLANATIONS_LOGIC_DEPTH = NULL;
