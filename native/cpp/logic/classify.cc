  ...
  { boolean inferableP = FALSE;
    ...
    if (subtypeOfP(safePrimaryType(self), SGT_CLASSIFY_LOGIC_NAMED_DESCRIPTION)) {
      { Description* self000 = self;
        ...
        { MemoizationTable* memoTable000 = ((MemoizationTable*)(SGT_CLASSIFY_LOGIC_INFERABLE_WITH_CYCLE_CHECKp_MEMO_TABLE_000->surrogateValue));
          Cons* memoizedEntry000 = NULL;
          Object* memoizedValue000 = NULL;

          if (!((boolean)(memoTable000))) {
            initializeMemoizationTable(SGT_CLASSIFY_LOGIC_INFERABLE_WITH_CYCLE_CHECKp_MEMO_TABLE_000, "(:MAX-VALUES 500 :TIMESTAMPS (:IMPLIES-PROPOSITION-UPDATE))");
            memoTable000 = ((MemoizationTable*)(SGT_CLASSIFY_LOGIC_INFERABLE_WITH_CYCLE_CHECKp_MEMO_TABLE_000->surrogateValue));
          }
          ...
          if (((boolean)(memoizedValue000))) {
            ...
            { boolean testValue000 = FALSE;
              ...
              testValue000 = !(self->surrogateValueInverse == SGT_CLASSIFY_STELLA_THING);
              if (testValue000) {
                testValue000 = ((boolean)(alreadyvisitedlist = cons(self, alreadyvisitedlist)));
                if (testValue000) {
                  { boolean foundP000 = FALSE;

                    { Proposition* p = NULL;
                      Cons* iter000 = applicableRulesOfDescription(self, KWD_CLASSIFY_BACKWARD, FALSE);
...
boolean oCACHE_INFERABLE_SUBCOLLECTIONSpo = FALSE;
...
DEFINE_STELLA_SPECIAL(oCLASSIFY_FROM_NON_INFERABLE_PARENTS_ONLYpo, boolean , FALSE);
...
void helpStartupClassify1() {
  {
    ...
    SGT_CLASSIFY_LOGIC_INFERABLE_WITH_CYCLE_CHECKp_MEMO_TABLE_000 = ((Surrogate*)(internRigidSymbolWrtModule("INFERABLE-WITH-CYCLE-CHECK?-MEMO-TABLE-000", NULL, 1)));
...
void startupClassify() {
  { 
    ...
    if (currentStartupTimePhaseP(4)) {
      oCACHE_INFERABLE_SUBCOLLECTIONSpo = TRUE;
      oCLASSIFY_FROM_NON_INFERABLE_PARENTS_ONLYpo.set(TRUE);
    }
    ...
    if (currentStartupTimePhaseP(7)) {
      ...
      { MethodSlot* function = lookupFunction(SYM_CLASSIFY_LOGIC_STARTUP_CLASSIFY);
        ...
        setDynamicSlotValue(function->dynamicSlots, SYM_CLASSIFY_STELLA_METHOD_STARTUP_CLASSNAME, wrapString("_Startup-Classify"), NULL_STRING_WRAPPER);
      }
    }
...
Surrogate* SGT_CLASSIFY_LOGIC_INFERABLE_WITH_CYCLE_CHECKp_MEMO_TABLE_000 = NULL;
