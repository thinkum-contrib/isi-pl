...
Iterator* allTrueDependentPropositions(Object* self, Surrogate* relation, boolean specializeP) {
  ...
  { Cons* pattern = (((boolean)(relation)) ? cons(KWD_SPECIALIZE_RELATION, cons(((!((boolean)(NIL))) ? NIL : NIL), cons(relation, cons(self, NIL)))) : cons(KWD_SPECIALIZE_DEPENDENTS, cons(((!((boolean)(NIL))) ? NIL : NIL), cons(self, NIL))));
...
Iterator* allTrueDependentIsaPropositions(Object* self) {
  { Cons* pattern = cons(KWD_SPECIALIZE_ISA, cons(((!((boolean)(NIL))) ? NIL : NIL), cons(self, NIL)));
    SequenceIndex* index = selectPropositions(pattern);
              ...
              if (!((boolean)(collect000))) {
                {
                  ...
                  if (v074 == NIL) {
                    ...
                    addConsToEndOfConsList(v074, collect000);
                  }
                }
              }
              else {
...
boolean testPropertyP(Object* self, Surrogate* relation) {
  { MemoizationTable* memoTable000 = ((MemoizationTable*)(SGT_SPECIALIZE_LOGIC_TEST_PROPERTYp_MEMO_TABLE_000->surrogateValue));
    Cons* memoizedEntry000 = NULL;
    Object* memoizedValue000 = NULL;

    if (!((boolean)(memoTable000))) {
      initializeMemoizationTable(SGT_SPECIALIZE_LOGIC_TEST_PROPERTYp_MEMO_TABLE_000, "(:MAX-VALUES 500 :TIMESTAMPS (:KB-UPDATE))");
      memoTable000 = ((MemoizationTable*)(SGT_SPECIALIZE_LOGIC_TEST_PROPERTYp_MEMO_TABLE_000->surrogateValue));
    }
...
boolean testIsaP(Object* member, Surrogate* type) {
  if (type == SGT_SPECIALIZE_STELLA_THING) {
    ...
    { MemoizationTable* memoTable000 = ((MemoizationTable*)(SGT_SPECIALIZE_LOGIC_TEST_ISAp_MEMO_TABLE_000->surrogateValue));
      Cons* memoizedEntry000 = NULL;
      Object* memoizedValue000 = NULL;

      if (!((boolean)(memoTable000))) {
        initializeMemoizationTable(SGT_SPECIALIZE_LOGIC_TEST_ISAp_MEMO_TABLE_000, "(:MAX-VALUES 1000 :TIMESTAMPS (:META-KB-UPDATE))");
        memoTable000 = ((MemoizationTable*)(SGT_SPECIALIZE_LOGIC_TEST_ISAp_MEMO_TABLE_000->surrogateValue));
      }
      if (oMEMOIZATION_ENABLEDpo) {
    ...
    { MemoizationTable* memoTable001 = ((MemoizationTable*)(SGT_SPECIALIZE_LOGIC_TEST_ISAp_MEMO_TABLE_001->surrogateValue));
      Cons* memoizedEntry001 = NULL;
      Object* memoizedValue001 = NULL;

      if (!((boolean)(memoTable001))) {
        initializeMemoizationTable(SGT_SPECIALIZE_LOGIC_TEST_ISAp_MEMO_TABLE_001, "(:MAX-VALUES 1000 :TIMESTAMPS (:KB-UPDATE))");
        memoTable001 = ((MemoizationTable*)(SGT_SPECIALIZE_LOGIC_TEST_ISAp_MEMO_TABLE_001->surrogateValue));
      }
      if (oMEMOIZATION_ENABLEDpo) {
      ...
      { Object* value001 = memoizedValue001;

        return (coerceWrappedBooleanToBoolean(((BooleanWrapper*)(value001))));
      }
    }
  }
}
...
Object* accessBinaryValue(Object* self, Surrogate* relation) {
  { MemoizationTable* memoTable000 = ((MemoizationTable*)(SGT_SPECIALIZE_LOGIC_ACCESS_BINARY_VALUE_MEMO_TABLE_000->surrogateValue));
    Cons* memoizedEntry000 = NULL;
    Object* memoizedValue000 = NULL;

    if (!((boolean)(memoTable000))) {
      initializeMemoizationTable(SGT_SPECIALIZE_LOGIC_ACCESS_BINARY_VALUE_MEMO_TABLE_000, "(:MAX-VALUES 1000 :TIMESTAMPS (:KB-UPDATE))");
      memoTable000 = ((MemoizationTable*)(SGT_SPECIALIZE_LOGIC_ACCESS_BINARY_VALUE_MEMO_TABLE_000->surrogateValue));
    }
    if (oMEMOIZATION_ENABLEDpo) {
      memoizedEntry000 = lookupMruMemoizedValue(((MruMemoizationTable*)(memoTable000)), self, relation, oCONTEXTo.get(), MEMOIZED_NULL_VALUE, 6);
      memoizedValue000 = memoizedEntry000->value;
...
Iterator* allDirectlyLinkedObjects(Object* self, Surrogate* relation, boolean inverseP) {
  { Cons* pattern = (inverseP ? makeRelationPattern2(relation, NULL, self) : makeRelationPattern2(relation, self, NULL));
    SequenceIndex* index = selectPropositions(pattern);
...
Iterator* allSupercollections(LogicObject* self) {
  { MemoizationTable* memoTable000 = ((MemoizationTable*)(SGT_SPECIALIZE_LOGIC_ALL_SUPERCOLLECTIONS_MEMO_TABLE_000->surrogateValue));
    Cons* memoizedEntry000 = NULL;
    Object* memoizedValue000 = NULL;

    if (!((boolean)(memoTable000))) {
      initializeMemoizationTable(SGT_SPECIALIZE_LOGIC_ALL_SUPERCOLLECTIONS_MEMO_TABLE_000, "(:MAX-VALUES 1000 :TIMESTAMPS (:META-KB-UPDATE))");
      memoTable000 = ((MemoizationTable*)(SGT_SPECIALIZE_LOGIC_ALL_SUPERCOLLECTIONS_MEMO_TABLE_000->surrogateValue));
    }
    if (oMEMOIZATION_ENABLEDpo) {
...
Cons* allSupportedNamedSubcollections(LogicObject* self) {
  { MemoizationTable* memoTable000 = ((MemoizationTable*)(SGT_SPECIALIZE_LOGIC_ALL_SUPPORTED_NAMED_SUBCOLLECTIONS_MEMO_TABLE_000->surrogateValue));
    Cons* memoizedEntry000 = NULL;
    Object* memoizedValue000 = NULL;

    if (!((boolean)(memoTable000))) {
      initializeMemoizationTable(SGT_SPECIALIZE_LOGIC_ALL_SUPPORTED_NAMED_SUBCOLLECTIONS_MEMO_TABLE_000, "(:MAX-VALUES 1000 :TIMESTAMPS (:META-KB-UPDATE))");
      memoTable000 = ((MemoizationTable*)(SGT_SPECIALIZE_LOGIC_ALL_SUPPORTED_NAMED_SUBCOLLECTIONS_MEMO_TABLE_000->surrogateValue));
    }
    if (oMEMOIZATION_ENABLEDpo) {
...
boolean valueClashesWithSkolemP(Skolem* skolem, Object* value) {
  { Object* dummy1;
    ...
    { Surrogate* type = skolem->skolemType;
      ...
      else if (!checkTypeP(value, type, TRUE, dummy1)) {
        return (TRUE);
      }
...
Iterator* allClashingPropositions(Proposition* self) {
  { boolean dummy1;
    ...
    if (!(self->kind == KWD_SPECIALIZE_FUNCTION)) {
      return (EMPTY_PROPOSITIONS_ITERATOR);
    }
    { Object* backlinkedargument = selectArgumentWithBacklinks(self, dummy1);

      if (!((boolean)(backlinkedargument))) {
        return (EMPTY_PROPOSITIONS_ITERATOR);
      }
      { Cons* pattern = cons(KWD_SPECIALIZE_RELATION, cons(((!((boolean)(NIL))) ? NIL : NIL), cons(((Surrogate*)(self->operatoR)), cons(backlinkedargument, NIL))));
        SequenceIndex* index = selectPropositions(pattern);

        if (emptyPropositionsIndexP(index, backlinkedargument, FALSE)) {
          return (EMPTY_PROPOSITIONS_ITERATOR);
        }
...
void dropTaxonomyImpliesSubsumesLink(Description* taildescription, Description* headdescription) {
  ...
  std::cout << "'drop-taxonomy-implies-subsumes-link':  Write me, I am a dummy!" << std::endl;
  return;
}
...
void helpStartupSpecialize1() {
  {
    ...
    SGT_SPECIALIZE_LOGIC_TEST_PROPERTYp_MEMO_TABLE_000 = ((Surrogate*)(internRigidSymbolWrtModule("TEST-PROPERTY?-MEMO-TABLE-000", NULL, 1)));
    ...
    SGT_SPECIALIZE_LOGIC_TEST_ISAp_MEMO_TABLE_000 = ((Surrogate*)(internRigidSymbolWrtModule("TEST-ISA?-MEMO-TABLE-000", NULL, 1)));
    SGT_SPECIALIZE_LOGIC_TEST_ISAp_MEMO_TABLE_001 = ((Surrogate*)(internRigidSymbolWrtModule("TEST-ISA?-MEMO-TABLE-001", NULL, 1)));
    SGT_SPECIALIZE_LOGIC_ACCESS_BINARY_VALUE_MEMO_TABLE_000 = ((Surrogate*)(internRigidSymbolWrtModule("ACCESS-BINARY-VALUE-MEMO-TABLE-000", NULL, 1)));
    ...
    SGT_SPECIALIZE_LOGIC_ALL_SUPERCOLLECTIONS_MEMO_TABLE_000 = ((Surrogate*)(internRigidSymbolWrtModule("ALL-SUPERCOLLECTIONS-MEMO-TABLE-000", NULL, 1)));
    SGT_SPECIALIZE_PL_KERNEL_KB_MEMBER_OF = ((Surrogate*)(internRigidSymbolWrtModule("MEMBER-OF", getStellaModule("/PL-KERNEL-KB", TRUE), 1)));
    SGT_SPECIALIZE_LOGIC_ALL_SUPPORTED_NAMED_SUBCOLLECTIONS_MEMO_TABLE_000 = ((Surrogate*)(internRigidSymbolWrtModule("ALL-SUPPORTED-NAMED-SUBCOLLECTIONS-MEMO-TABLE-000", NULL, 1)));
...
void helpStartupSpecialize3() {
  {
    ...
    { MethodSlot* function = lookupFunction(SYM_SPECIALIZE_LOGIC_STARTUP_SPECIALIZE);
      ...
      setDynamicSlotValue(function->dynamicSlots, SYM_SPECIALIZE_STELLA_METHOD_STARTUP_CLASSNAME, wrapString("_Startup-Specialize"), NULL_STRING_WRAPPER);
    }
  }
}
...
Surrogate* SGT_SPECIALIZE_LOGIC_TEST_PROPERTYp_MEMO_TABLE_000 = NULL;
...
Surrogate* SGT_SPECIALIZE_LOGIC_TEST_ISAp_MEMO_TABLE_000 = NULL;

Surrogate* SGT_SPECIALIZE_LOGIC_TEST_ISAp_MEMO_TABLE_001 = NULL;

Surrogate* SGT_SPECIALIZE_LOGIC_ACCESS_BINARY_VALUE_MEMO_TABLE_000 = NULL;
...
Surrogate* SGT_SPECIALIZE_LOGIC_ALL_SUPERCOLLECTIONS_MEMO_TABLE_000 = NULL;

Surrogate* SGT_SPECIALIZE_PL_KERNEL_KB_MEMBER_OF = NULL;

Surrogate* SGT_SPECIALIZE_LOGIC_ALL_SUPPORTED_NAMED_SUBCOLLECTIONS_MEMO_TABLE_000 = NULL;
