...
boolean testPropertyP(Object* self, Surrogate* relation) {
  { MemoizationTable* memoTable000 = ((MemoizationTable*)(SGT_SPECIALIZE_LOGIC_F_TEST_PROPERTYp_MEMO_TABLE_000->surrogateValue));
...
boolean testIsaP(Object* member, Surrogate* type) {
  if (type == SGT_SPECIALIZE_STELLA_THING) {
    ...
    { MemoizationTable* memoTable000 = ((MemoizationTable*)(SGT_SPECIALIZE_LOGIC_F_TEST_ISAp_MEMO_TABLE_000->surrogateValue));
      Cons* memoizedEntry000 = NULL;
      Object* memoizedValue000 = NULL;
    ...
    { MemoizationTable* memoTable001 = ((MemoizationTable*)(SGT_SPECIALIZE_LOGIC_F_TEST_ISAp_MEMO_TABLE_001->surrogateValue));
...
Object* accessBinaryValue(Object* self, Surrogate* relation) {
  { MemoizationTable* memoTable000 = ((MemoizationTable*)(SGT_SPECIALIZE_LOGIC_F_ACCESS_BINARY_VALUE_MEMO_TABLE_000->surrogateValue));
    Cons* memoizedEntry000 = NULL;
    Object* memoizedValue000 = NULL;
...
Iterator* allSupercollections(LogicObject* self) {
  { MemoizationTable* memoTable000 = ((MemoizationTable*)(SGT_SPECIALIZE_LOGIC_F_ALL_SUPERCOLLECTIONS_MEMO_TABLE_000->surrogateValue));
    Cons* memoizedEntry000 = NULL;
    Object* memoizedValue000 = NULL;
...
Cons* allSupportedNamedSubcollections(LogicObject* self) {
  { MemoizationTable* memoTable000 = ((MemoizationTable*)(SGT_SPECIALIZE_LOGIC_F_ALL_SUPPORTED_NAMED_SUBCOLLECTIONS_MEMO_TABLE_000->surrogateValue));
    Cons* memoizedEntry000 = NULL;
    Object* memoizedValue000 = NULL;
