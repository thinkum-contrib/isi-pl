...
int WhynotPartialMatch::numberOfFailedSubgoals() {
  { WhynotPartialMatch* self = this;
    ...
    { Justification* proof = ((Justification*)(dynamicSlotValue(self->controlFrame->dynamicSlots, SYM_WHYNOT_LOGIC_JUSTIFICATION, NULL)));
      ...
      { MemoizationTable* memoTable000 = ((MemoizationTable*)(SGT_WHYNOT_LOGIC_NUMBER_OF_FAILED_SUBGOALS_MEMO_TABLE_000->surrogateValue));
        Cons* memoizedEntry000 = NULL;
        Object* memoizedValue000 = NULL;

        if (!((boolean)(memoTable000))) {
          initializeMemoizationTable(SGT_WHYNOT_LOGIC_NUMBER_OF_FAILED_SUBGOALS_MEMO_TABLE_000, "(:MAX-VALUES 500)");
          memoTable000 = ((MemoizationTable*)(SGT_WHYNOT_LOGIC_NUMBER_OF_FAILED_SUBGOALS_MEMO_TABLE_000->surrogateValue));
        }
...
void helpStartupWhynot1() {
  {
    ...
    SGT_WHYNOT_LOGIC_NUMBER_OF_FAILED_SUBGOALS_MEMO_TABLE_000 = ((Surrogate*)(internRigidSymbolWrtModule("NUMBER-OF-FAILED-SUBGOALS-MEMO-TABLE-000", NULL, 1)));
  ...
  { 
    ...
    if (currentStartupTimePhaseP(7)) {
      ...
      { MethodSlot* function = lookupFunction(SYM_WHYNOT_LOGIC_STARTUP_WHYNOT);
        ...
        setDynamicSlotValue(function->dynamicSlots, SYM_WHYNOT_STELLA_METHOD_STARTUP_CLASSNAME, wrapString("_Startup-Whynot"), NULL_STRING_WRAPPER);
      }
    }
...
Surrogate* SGT_WHYNOT_LOGIC_NUMBER_OF_FAILED_SUBGOALS_MEMO_TABLE_000 = NULL;
