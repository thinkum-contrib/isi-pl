          ...
          if (!((boolean)(collect000))) {
            {
              ...
              if (v002 == NIL) {
                ...
                addConsToEndOfConsList(v002, collect000);
              }
            }
          }
          else {
...
NonPagingIndex* NonPagingIndex::remove(Object* value) {
  { NonPagingIndex* self = this;
...
void startupSequenceIndices() {
  { 
    ...
    if (currentStartupTimePhaseP(4)) {
      ...
      oLOADINGREGENERABLEOBJECTSpo.set(FALSE);
    }
    ...
    if (currentStartupTimePhaseP(7)) {
      ...
      defineMethodObject("(DEFMETHOD (REMOVE NON-PAGING-INDEX) ((SELF NON-PAGING-INDEX) (VALUE OBJECT)))", ((cpp_method_code)(&NonPagingIndex::remove)), ((cpp_method_code)(NULL)));
      ...
      { MethodSlot* function = lookupFunction(SYM_SEQUENCE_INDICES_LOGIC_STARTUP_SEQUENCE_INDICES);
        ...
        setDynamicSlotValue(function->dynamicSlots, SYM_SEQUENCE_INDICES_STELLA_METHOD_STARTUP_CLASSNAME, wrapString("_Startup-Sequence-Indices"), NULL_STRING_WRAPPER);
      }
    }
