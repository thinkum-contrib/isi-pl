...
Cons* allTypes(Object* self) {
  // Return a set of all of the types that are
  // satisfied by 'self'.
  { MemoizationTable* memoTable000 = ((MemoizationTable*)(SGT_FRAME_SUPPORT_LOGIC_ALL_TYPES_MEMO_TABLE_000->surrogateValue));
    Cons* memoizedEntry000 = NULL;
    Object* memoizedValue000 = NULL;

    if (!((boolean)(memoTable000))) {
      initializeMemoizationTable(SGT_FRAME_SUPPORT_LOGIC_ALL_TYPES_MEMO_TABLE_000, "(:MAX-VALUES 500 :TIMESTAMPS (:KB-UPDATE))");
      memoTable000 = ((MemoizationTable*)(SGT_FRAME_SUPPORT_LOGIC_ALL_TYPES_MEMO_TABLE_000->surrogateValue));
    }
...
Cons* allEquivalentRelations(NamedDescription* relation, boolean reflexiveP) {
  ...
  { MemoizationTable* memoTable000 = ((MemoizationTable*)(SGT_FRAME_SUPPORT_LOGIC_ALL_EQUIVALENT_RELATIONS_MEMO_TABLE_000->surrogateValue));
    Cons* memoizedEntry000 = NULL;
    Object* memoizedValue000 = NULL;

    if (!((boolean)(memoTable000))) {
      initializeMemoizationTable(SGT_FRAME_SUPPORT_LOGIC_ALL_EQUIVALENT_RELATIONS_MEMO_TABLE_000, "(:MAX-VALUES 500 :TIMESTAMPS (:META-KB-UPDATE))");
      memoTable000 = ((MemoizationTable*)(SGT_FRAME_SUPPORT_LOGIC_ALL_EQUIVALENT_RELATIONS_MEMO_TABLE_000->surrogateValue));
    }
    if (oMEMOIZATION_ENABLEDpo) {
...
Cons* allSuperrelations(NamedDescription* relation, boolean removeequivalentsP) {
  ...
  { MemoizationTable* memoTable000 = ((MemoizationTable*)(SGT_FRAME_SUPPORT_LOGIC_ALL_SUPERRELATIONS_MEMO_TABLE_000->surrogateValue));
    Cons* memoizedEntry000 = NULL;
    Object* memoizedValue000 = NULL;

    if (!((boolean)(memoTable000))) {
      initializeMemoizationTable(SGT_FRAME_SUPPORT_LOGIC_ALL_SUPERRELATIONS_MEMO_TABLE_000, "(:MAX-VALUES 500 :TIMESTAMPS (:META-KB-UPDATE))");
      memoTable000 = ((MemoizationTable*)(SGT_FRAME_SUPPORT_LOGIC_ALL_SUPERRELATIONS_MEMO_TABLE_000->surrogateValue));
    }
    if (oMEMOIZATION_ENABLEDpo) {
...
Cons* allSubrelations(NamedDescription* relation, boolean removeequivalentsP) {
  ...
  // relation.
  { MemoizationTable* memoTable000 = ((MemoizationTable*)(SGT_FRAME_SUPPORT_LOGIC_ALL_SUBRELATIONS_MEMO_TABLE_000->surrogateValue));
    Cons* memoizedEntry000 = NULL;
    Object* memoizedValue000 = NULL;

    if (!((boolean)(memoTable000))) {
      initializeMemoizationTable(SGT_FRAME_SUPPORT_LOGIC_ALL_SUBRELATIONS_MEMO_TABLE_000, "(:MAX-VALUES 1000 :TIMESTAMPS (:META-KB-UPDATE))");
      memoTable000 = ((MemoizationTable*)(SGT_FRAME_SUPPORT_LOGIC_ALL_SUBRELATIONS_MEMO_TABLE_000->surrogateValue));
    }
    if (oMEMOIZATION_ENABLEDpo) {
      memoizedEntry000 = lookupMruMemoizedValue(((MruMemoizationTable*)(memoTable000)), relation, oCONTEXTo.get(), (removeequivalentsP ? TRUE_WRAPPER : FALSE_WRAPPER), MEMOIZED_NULL_VALUE, -1);
      memoizedValue000 = memoizedEntry000->value;
...
Cons* allDirectSuperrelations(NamedDescription* relation, boolean removeequivalentsP) {
  ...
  { MemoizationTable* memoTable000 = ((MemoizationTable*)(SGT_FRAME_SUPPORT_LOGIC_ALL_DIRECT_SUPERRELATIONS_MEMO_TABLE_000->surrogateValue));
    Cons* memoizedEntry000 = NULL;
    Object* memoizedValue000 = NULL;

    if (!((boolean)(memoTable000))) {
      initializeMemoizationTable(SGT_FRAME_SUPPORT_LOGIC_ALL_DIRECT_SUPERRELATIONS_MEMO_TABLE_000, "(:MAX-VALUES 500 :TIMESTAMPS (:META-KB-UPDATE))");
      memoTable000 = ((MemoizationTable*)(SGT_FRAME_SUPPORT_LOGIC_ALL_DIRECT_SUPERRELATIONS_MEMO_TABLE_000->surrogateValue));
    }
    if (oMEMOIZATION_ENABLEDpo) {
      memoizedEntry000 = lookupMruMemoizedValue(((MruMemoizationTable*)(memoTable000)), relation, oCONTEXTo.get(), (removeequivalentsP ? TRUE_WRAPPER : FALSE_WRAPPER), MEMOIZED_NULL_VALUE, -1);
      memoizedValue000 = memoizedEntry000->value;
...
Cons* allDirectSubrelations(NamedDescription* relation, boolean removeequivalentsP) {
  ...
  // 'relation'.  If 'removeEquivalents?' (recommended), don't include any
  // relations equivalent to 'relation'.
  { MemoizationTable* memoTable000 = ((MemoizationTable*)(SGT_FRAME_SUPPORT_LOGIC_ALL_DIRECT_SUBRELATIONS_MEMO_TABLE_000->surrogateValue));
    Cons* memoizedEntry000 = NULL;
    Object* memoizedValue000 = NULL;

    if (!((boolean)(memoTable000))) {
      initializeMemoizationTable(SGT_FRAME_SUPPORT_LOGIC_ALL_DIRECT_SUBRELATIONS_MEMO_TABLE_000, "(:MAX-VALUES 500 :TIMESTAMPS (:META-KB-UPDATE))");
      memoTable000 = ((MemoizationTable*)(SGT_FRAME_SUPPORT_LOGIC_ALL_DIRECT_SUBRELATIONS_MEMO_TABLE_000->surrogateValue));
    }
    if (oMEMOIZATION_ENABLEDpo) {
      memoizedEntry000 = lookupMruMemoizedValue(((MruMemoizationTable*)(memoTable000)), relation, oCONTEXTo.get(), (removeequivalentsP ? TRUE_WRAPPER : FALSE_WRAPPER), MEMOIZED_NULL_VALUE, -1);
      memoizedValue000 = memoizedEntry000->value;
...
void helpStartupFrameSupport1() {
  {
    ...
    SGT_FRAME_SUPPORT_LOGIC_ALL_TYPES_MEMO_TABLE_000 = ((Surrogate*)(internRigidSymbolWrtModule("ALL-TYPES-MEMO-TABLE-000", NULL, 1)));
    KWD_FRAME_SUPPORT_ISA = ((Keyword*)(internRigidSymbolWrtModule("ISA", NULL, 2)));
    SGT_FRAME_SUPPORT_LOGIC_ALL_EQUIVALENT_RELATIONS_MEMO_TABLE_000 = ((Surrogate*)(internRigidSymbolWrtModule("ALL-EQUIVALENT-RELATIONS-MEMO-TABLE-000", NULL, 1)));
    SGT_FRAME_SUPPORT_LOGIC_ALL_SUPERRELATIONS_MEMO_TABLE_000 = ((Surrogate*)(internRigidSymbolWrtModule("ALL-SUPERRELATIONS-MEMO-TABLE-000", NULL, 1)));
    SGT_FRAME_SUPPORT_LOGIC_ALL_SUBRELATIONS_MEMO_TABLE_000 = ((Surrogate*)(internRigidSymbolWrtModule("ALL-SUBRELATIONS-MEMO-TABLE-000", NULL, 1)));
    SGT_FRAME_SUPPORT_LOGIC_ALL_DIRECT_SUPERRELATIONS_MEMO_TABLE_000 = ((Surrogate*)(internRigidSymbolWrtModule("ALL-DIRECT-SUPERRELATIONS-MEMO-TABLE-000", NULL, 1)));
    SGT_FRAME_SUPPORT_LOGIC_ALL_DIRECT_SUBRELATIONS_MEMO_TABLE_000 = ((Surrogate*)(internRigidSymbolWrtModule("ALL-DIRECT-SUBRELATIONS-MEMO-TABLE-000", NULL, 1)));
...
Surrogate* SGT_FRAME_SUPPORT_LOGIC_ALL_TYPES_MEMO_TABLE_000 = NULL;

Keyword* KWD_FRAME_SUPPORT_ISA = NULL;

Surrogate* SGT_FRAME_SUPPORT_LOGIC_ALL_EQUIVALENT_RELATIONS_MEMO_TABLE_000 = NULL;

Surrogate* SGT_FRAME_SUPPORT_LOGIC_ALL_SUPERRELATIONS_MEMO_TABLE_000 = NULL;

Surrogate* SGT_FRAME_SUPPORT_LOGIC_ALL_SUBRELATIONS_MEMO_TABLE_000 = NULL;

Surrogate* SGT_FRAME_SUPPORT_LOGIC_ALL_DIRECT_SUPERRELATIONS_MEMO_TABLE_000 = NULL;

Surrogate* SGT_FRAME_SUPPORT_LOGIC_ALL_DIRECT_SUBRELATIONS_MEMO_TABLE_000 = NULL;
