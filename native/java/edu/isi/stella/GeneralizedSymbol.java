...
;
  ...
  public static String javaChangeCase(GeneralizedSymbol symbol, Keyword caseconvention) {
    { Module module = ((Module)(symbol.homeContext));
      ...
      if (module.caseSensitiveP ||
          (!(Stella.computeSymbolEscapeCode(name, false) == Stella.KWD_UNESCAPED))) {
  ...
  public static String cppChangeCase(GeneralizedSymbol symbol, Keyword caseconvention) {
    { MemoizationTable memoTable000 = ((MemoizationTable)(Stella.SGT_STELLA_F_CPP_CHANGE_CASE_MEMO_TABLE_000.surrogateValue));
  ...
  public static Symbol yieldSymbolConstantName(GeneralizedSymbol symbol) {
    ...
    if (Surrogate.subtypeOfKeywordP(Stella_Object.safePrimaryType(symbol))) {
      { Keyword symbol000 = ((Keyword)(symbol));
        ...
        return (Stella.internSymbolInModule(Native.stringUpcase(GeneralizedSymbol.constructSymbolConstantName(symbol000)), ((Module)(Stella.$MODULE$.get())), true));
      }
    }
    else {
      return (Stella.internSymbolInModule(Native.stringUpcase(GeneralizedSymbol.constructSymbolConstantName(symbol)), ((Module)(Stella.$MODULE$.get())), true));
    }
  }
