...
public abstract class GeneralizedSymbol extends ContextSensitiveObject {
  ...
  public static StringWrapper idlTranslateSymbolConstantName(GeneralizedSymbol symbol) {
    { String prefix = null;
      ...
      return (Stella.wrapString(Stella.idlSubstituteForbiddenCharacters(prefix + "_" + symbol.symbolName, Stella.KWD_UPPERCASE)));
    }
  }
  ...
  public static StringWrapper idlTranslateClassName(GeneralizedSymbol namesymbol) {
    return (Stella.wrapString(Stella.idlSubstituteForbiddenCharacters(GeneralizedSymbol.idlChangeCase(((Stella_Class)(namesymbol.surrogatify().surrogateValue)).classType, Stella.KWD_CAPITALIZED), Stella.KWD_CAPITALIZED)));
  }
...
;
  ...
  public static String javaChangeCase(GeneralizedSymbol symbol, Keyword caseconvention) {
    { Module module = ((Module)(symbol.homeContext));
      ...
      if (module.caseSensitiveP ||
          (!(Stella.computeSymbolEscapeCode(name, Stella.FALSE) == Stella.KWD_UNESCAPED))) {
      ...
      if (caseconvention == Stella.KWD_UPPERCASE) {
        ...
        return (Stella.makeMatchingNameFull(name, Stella.KWD_CLEVER, Stella.KWD_CLEVER, "- ", "", "", "", "", Stella.KWD_TITLECASEX, ""));
      }
      else if (caseconvention == Stella.KWD_CAPITALIZED) {
        return (Stella.makeMatchingNameFull(name, Stella.KWD_CLEVER, Stella.KWD_CLEVER, "- ", "", "", "", "", Stella.KWD_TITLECASE, ""));
      }
      else {
        { OutputStringStream stream000 = OutputStringStream.newOutputStringStream();
  ...
  public static StringWrapper cppTranslateClassTypename(GeneralizedSymbol namesymbol) {
    { Surrogate realnamesymbol = ((Stella_Class)(namesymbol.surrogatify().surrogateValue)).classType;
      ...
      return (Stella.wrapString(Stella.cppYieldQualifiedName(Stella.cppSubstituteForbiddenCharacters(GeneralizedSymbol.cppChangeCase(realnamesymbol, Stella.KWD_CAPITALIZED), Stella.KWD_CAPITALIZED), realnamesymbol)));
    }
  }
  ...
  public static StringWrapper cppTranslateSymbolConstantName(GeneralizedSymbol symbol) {
    { String prefix = null;
      ...
      return (Stella.wrapString(Stella.cppSubstituteForbiddenCharacters(prefix + "_" + symbol.symbolName, Stella.KWD_UPPERCASE)));
    }
  }
          ...
          { Surrogate testValue000 = Stella_Object.safePrimaryType(namesymbol);
            ...
            if (Surrogate.subtypeOfSymbolP(testValue000)) {
              { Symbol namesymbol000 = ((Symbol)(namesymbol));
                ...
                return (!(Stella.lookupVisibleSymbolsInModule(namesymbol000.symbolName, namespacemodule, Stella.FALSE).rest == Stella.NIL));
              }
            }
            else if (Surrogate.subtypeOfSurrogateP(testValue000)) {
              { Surrogate namesymbol000 = ((Surrogate)(namesymbol));

                return (!(Stella.lookupVisibleSurrogatesInModule(namesymbol000.symbolName, namespacemodule, Stella.FALSE).rest == Stella.NIL));
              }
            }
            else {
              { OutputStringStream stream000 = OutputStringStream.newOutputStringStream();
  ...
  public static String cppChangeCase(GeneralizedSymbol symbol, Keyword caseconvention) {
    { MemoizationTable memoTable000 = ((MemoizationTable)(Stella.SGT_STELLA_CPP_CHANGE_CASE_MEMO_TABLE_000.surrogateValue));
      Cons memoizedEntry000 = null;
      Stella_Object memoizedValue000 = null;

      if (memoTable000 == null) {
        Surrogate.initializeMemoizationTable(Stella.SGT_STELLA_CPP_CHANGE_CASE_MEMO_TABLE_000, "(:MAX-VALUES 2000)");
        memoTable000 = ((MemoizationTable)(Stella.SGT_STELLA_CPP_CHANGE_CASE_MEMO_TABLE_000.surrogateValue));
      }
      ...
      if (memoizedValue000 != null) {
        ...
        memoizedValue000 = Stella.wrapString(GeneralizedSymbol.helpCppChangeCase(symbol, caseconvention));
        if (Stella.$MEMOIZATION_ENABLEDp$) {
  ...
  public static Symbol yieldSymbolConstantName(GeneralizedSymbol symbol) {
    symbol = ((GeneralizedSymbol)(symbol.permanentify()));
    if (Surrogate.subtypeOfKeywordP(Stella_Object.safePrimaryType(symbol))) {
      { Keyword symbol000 = ((Keyword)(symbol));

        return (Stella.internSymbolInModule(Native.stringUpcase(GeneralizedSymbol.constructSymbolConstantName(symbol000)), ((Module)(Stella.$MODULE$.get())), Stella.TRUE));
      }
    }
    else {
      return (Stella.internSymbolInModule(Native.stringUpcase(GeneralizedSymbol.constructSymbolConstantName(symbol)), ((Module)(Stella.$MODULE$.get())), Stella.TRUE));
    }
  }
      ...
      if (namemodule == definitionmodule) {
        ...
        if (!Context.visibleFromP(namemodule, definitionmodule)) {
          ...
          { boolean testValue000 = Stella.FALSE;
            ...
            { 
              shadow = Stella.lookupSymbolInModule(name.symbolName, definitionmodule, Stella.TRUE);
        ...
        { Surrogate testValue000 = Stella_Object.safePrimaryType(self);
          ...
          if (Surrogate.subtypeOfSymbolP(testValue000)) {
            { Symbol self000 = ((Symbol)(self));
              ...
              visibleP = self000 == Stella.lookupSymbolInModule(self000.symbolName, ((Module)(Stella.$MODULE$.get())), Stella.FALSE);
            }
          }
          else if (Surrogate.subtypeOfSurrogateP(testValue000)) {
            { Surrogate self000 = ((Surrogate)(self));

              visibleP = self000 == Stella.lookupSurrogateInModule(self000.symbolName, ((Module)(Stella.$MODULE$.get())), Stella.FALSE);
            }
          }
          else {
            { OutputStringStream stream000 = OutputStringStream.newOutputStringStream();
    ...
    { Module currentmodule = ((Module)(Stella.$MODULE$.get()));
      ...
      { Object old$Module$000 = Stella.$MODULE$.get();
        ...
        try {
          Native.setSpecial(Stella.$MODULE$, ((Module)(basesymbol.homeContext)));
          if (((Module)(Stella.$MODULE$.get())) != null) {
            return (((Symbol)(Stella.internRigidSymbolLocally((((Module)(Stella.$MODULE$.get())).caseSensitiveP ? newname : Native.stringUpcase(newname)), ((Module)(Stella.$MODULE$.get())), Stella.SYMBOL_SYM))));
          }
          Native.setSpecial(Stella.$MODULE$, currentmodule);
          return (Stella.internSymbol(newname));
  ...
  public static Stella_Object accessGeneralizedSymbolSlotValue(GeneralizedSymbol self, Symbol slotname, Stella_Object value, boolean setvalueP) {
    if (slotname == Stella.SYM_STELLA_SYMBOL_NAME) {
      ...
      if (setvalueP) {
        ...
        value = Stella.wrapInteger(self.symbolId);
      }
    }
