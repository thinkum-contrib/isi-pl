...
public class CsValue extends KeyValueList {
      ...
      while (!(iter000 == Stella.NIL)) {
        ...
        { Object old$Context$000 = Stella.$CONTEXT$.get();
          ...
          try {
            ...
            { Stella_Object currentvalue = Stella_Object.accessInContext(csvalue, homecontext, Stella.FALSE);

              if (!Stella_Object.eqlP(currentvalue, parentvalue)) {
                KvCons.helpInsertACsValue(csvalue.theKvList, currentvalue, childcxt, Stella.FALSE);
              }
            }
  ...
  public void insertAt(Context context, Stella_Object newvalue) {
    { CsValue self = this;
      ...
      KvCons.helpInsertACsValue(self.theKvList, newvalue, context, Stella.TRUE);
    }
  }
