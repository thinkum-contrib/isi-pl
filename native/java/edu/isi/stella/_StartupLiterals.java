...
public class _StartupLiterals {
  static void helpStartupLiterals1() {
    {
      ...
      Stella.KWD_WHITE_SPACE = ((Keyword)(Stella.internRigidSymbolWrtModule("WHITE-SPACE", null, 2)));
  ...
  static void helpStartupLiterals3() {
    {
      ...
      Stella.defineFunctionObject("WRAP-INTEGER", "(DEFUN (WRAP-INTEGER INTEGER-WRAPPER) ((VALUE INTEGER)) :DOCUMENTATION \"Return a literal object whose value is the INTEGER 'value'.\" :PUBLIC? TRUE)", Native.find_java_method("edu.isi.stella.Stella", "wrapInteger", new java.lang.Class [] {java.lang.Integer.TYPE}), null);
      ...
      Stella.defineFunctionObject("WRAP-FLOAT", "(DEFUN (WRAP-FLOAT FLOAT-WRAPPER) ((VALUE FLOAT)) :DOCUMENTATION \"Return a literal object whose value is the FLOAT 'value'.\" :PUBLIC? TRUE)", Native.find_java_method("edu.isi.stella.Stella", "wrapFloat", new java.lang.Class [] {java.lang.Double.TYPE}), null);
      ...
      Stella.defineFunctionObject("WRAP-STRING", "(DEFUN (WRAP-STRING STRING-WRAPPER) ((VALUE STRING)) :DOCUMENTATION \"Return a literal object whose value is the STRING 'value'.\" :PUBLIC? TRUE)", Native.find_java_method("edu.isi.stella.Stella", "wrapString", new java.lang.Class [] {Native.find_java_class("java.lang.String")}), null);
      ...
      Stella.defineFunctionObject("WRAP-MUTABLE-STRING", "(DEFUN (WRAP-MUTABLE-STRING MUTABLE-STRING-WRAPPER) ((VALUE MUTABLE-STRING)) :DOCUMENTATION \"Return a literal object whose value is the MUTABLE-STRING 'value'.\" :PUBLIC? TRUE)", Native.find_java_method("edu.isi.stella.Stella", "wrapMutableString", new java.lang.Class [] {Native.find_java_class("java.lang.StringBuffer")}), null);
      ...
      Stella.defineFunctionObject("WRAP-CHARACTER", "(DEFUN (WRAP-CHARACTER CHARACTER-WRAPPER) ((VALUE CHARACTER)) :DOCUMENTATION \"Return a literal object whose value is the CHARACTER 'value'.\" :PUBLIC? TRUE)", Native.find_java_method("edu.isi.stella.Stella", "wrapCharacter", new java.lang.Class [] {java.lang.Character.TYPE}), null);
      ...
      Stella.defineFunctionObject("WRAP-FUNCTION-CODE", "(DEFUN (WRAP-FUNCTION-CODE FUNCTION-CODE-WRAPPER) ((VALUE FUNCTION-CODE)) :DOCUMENTATION \"Return a literal object whose value is the FUNCTION-CODE 'value'.\" :PUBLIC? TRUE)", Native.find_java_method("edu.isi.stella.Stella", "wrapFunctionCode", new java.lang.Class [] {Native.find_java_class("java.lang.reflect.Method")}), null);
      ...
      Stella.defineFunctionObject("WRAP-METHOD-CODE", "(DEFUN (WRAP-METHOD-CODE METHOD-CODE-WRAPPER) ((VALUE METHOD-CODE)) :DOCUMENTATION \"Return a literal object whose value is the METHOD-CODE 'value'.\" :PUBLIC? TRUE)", Native.find_java_method("edu.isi.stella.Stella", "wrapMethodCode", new java.lang.Class [] {Native.find_java_class("java.lang.reflect.Method")}), null);
      ...
      Stella.defineFunctionObject("WRAP-BOOLEAN", "(DEFUN (WRAP-BOOLEAN BOOLEAN-WRAPPER) ((VALUE BOOLEAN)) :DOCUMENTATION \"Return a literal object whose value is the BOOLEAN 'value'.\" :PUBLIC? TRUE :GLOBALLY-INLINE? TRUE (RETURN (CHOOSE VALUE TRUE-WRAPPER FALSE-WRAPPER)))", Native.find_java_method("edu.isi.stella.Stella", "wrapBoolean", new java.lang.Class [] {java.lang.Boolean.TYPE}), null);
  ...
  public static void startupLiterals() {
    if (Stella.currentStartupTimePhaseP(0)) {
      ...
      Stella.FALSE_WRAPPER = BooleanWrapper.newBooleanWrapper(Stella.FALSE);
      Stella.TRUE_WRAPPER = BooleanWrapper.newBooleanWrapper(Stella.TRUE);
    ...
    { Object old$Module$000 = Stella.$MODULE$.get();
      ...
      try {
        ...
        if (Stella.currentStartupTimePhaseP(7)) {
          ...
          Stella.defineFunctionObject("PRINT-CHARACTER", "(DEFUN PRINT-CHARACTER ((CHAR CHARACTER) (STREAM NATIVE-OUTPUT-STREAM)) :PUBLIC? TRUE)", Native.find_java_method("edu.isi.stella.Stella", "printCharacter", new java.lang.Class [] {java.lang.Character.TYPE, Native.find_java_class("java.io.PrintStream")}), null);
          ...
          Stella.defineFunctionObject("PRINT-STRING-READABLY", "(DEFUN PRINT-STRING-READABLY ((STRING STRING) (STREAM NATIVE-OUTPUT-STREAM)))", Native.find_java_method("edu.isi.stella.Stella", "printStringReadably", new java.lang.Class [] {Native.find_java_class("java.lang.String"), Native.find_java_class("java.io.PrintStream")}), null);
          ...
          Stella.defineMethodObject("(DEFMETHOD (NUMBER-WRAPPER-TO-FLOAT FLOAT) ((SELF NUMBER-WRAPPER)) :PUBLIC? TRUE)", Native.find_java_method("edu.isi.stella.NumberWrapper", "numberWrapperToFloat", new java.lang.Class [] {}), ((java.lang.reflect.Method)(null)));
          ...
          { MethodSlot function = Symbol.lookupFunction(Stella.SYM_STELLA_STARTUP_LITERALS);
            ...
            KeyValueList.setDynamicSlotValue(function.dynamicSlots, Stella.SYM_STELLA_METHOD_STARTUP_CLASSNAME, Stella.wrapString("_Startup-Literals"), Stella.NULL_STRING_WRAPPER);
          }
        }
