  ...
  public static StringWrapper javaTranslateArrayType(ParametricTypeSpecifier arraytype) {
    { List dimensions = ParametricTypeSpecifier.arrayTypeDimensions(arraytype);
      ...
      switch (dimensions.length()) {
        case 1: 
          return (Stella.wrapString(translatedtype + "[]"));
        case 2: 
          return (Stella.wrapString(translatedtype + "[][]"));
        case 3: 
          return (Stella.wrapString(translatedtype + "[][][]"));
  ...
  public static StringWrapper cppTranslateArrayType(ParametricTypeSpecifier arraytype) {
    { List dimensions = ParametricTypeSpecifier.arrayTypeDimensions(arraytype);
      ...
      if (dimensions.length() == 1) {
        return (Stella.wrapString(StandardObject.cppTranslateAndPointerizeTypeSpec(elementtype).wrapperValue + "*"));
      }
...
;
    ...
    if (slot.slotName == Stella.SYM_STELLA_SIZE) {
      { Stella_Object dim = null;
        ...
        while (!(iter000 == Stella.NIL)) {
          ...
          if (collect000 == null) {
            {
              collect000 = Stella_Object.cons(Stella_Object.walkExpressionTree(dim, Stella.SGT_STELLA_INTEGER, Stella.SYM_STELLA_NEW, Stella.FALSE, new Object[1]), Stella.NIL);
            ...
            {
              collect000.rest = Stella_Object.cons(Stella_Object.walkExpressionTree(dim, Stella.SGT_STELLA_INTEGER, Stella.SYM_STELLA_NEW, Stella.FALSE, new Object[1]), Stella.NIL);
      ...
      requiredvalues.insertLast(Stella_Object.walkExpressionTree(valueref, slot.computeReturnTypeSpec(arraytype), Stella.SYM_STELLA_NEW, Stella.FALSE, new Object[1]));
    }
  }
  ...
  public static void preprocessArrayArguments(ParametricTypeSpecifier arraytype, PropertyList slotsandvalues) {
    { Stella_Class arrayclass = ((Stella_Class)(arraytype.specifierBaseType.surrogateValue));
      ...
      boolean nonlistsizeP = Stella.FALSE;
                ...
                { Object old$PrintreadablyP$002 = Stella.$PRINTREADABLYp$.get();
                  ...
                  try {
                    ...
                    if (!(Stella.suppressWarningsP())) {
                      ...
                      {
                        Stella.STANDARD_ERROR.nativeStream.println();
                        Stella.STANDARD_ERROR.nativeStream.println(" Array :size initializer `" + sizeit.value + "' doesn't match array dimension `" + Stella_Object.deUglifyParseTree(Stella.wrapInteger(dim)) + "' of");
                        Stella.STANDARD_ERROR.nativeStream.println("   `" + Stella_Object.deUglifyParseTree(arraytype) + "'.");
                      }
;
                    }
