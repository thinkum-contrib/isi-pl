...
public class Demon extends StandardObject {
  ...
  public static Demon newDemon() {
    { Demon self = null;
      ...
      self = new Demon();
      self.demonInheritP = Stella.FALSE;
      self.demonAllP = Stella.FALSE;
      self.demonGuardP = Stella.FALSE;
      ...
      if (testValue000 == Stella.KWD_MODIFY) {
        ...
        if (demon.demonAllP) {
          ...
          { Surrogate classref = null;
            ...
            loop002 : while (!(iter003 == Stella.NIL)) {
              {
      ...
      while (!(iter000 == Stella.NIL)) {
        ...
        { GeneralizedSymbol testValue000 = ((GeneralizedSymbol)(k));
          ...
          if ((testValue000 == Stella.KWD_CREATE) ||
            ...
            demon.demonGuardP = Stella.TRUE;
          }
          else if (testValue000 == Stella.KWD_INHERITEDp) {
            demon.demonInheritP = Stella.TRUE;
            System.out.println("Inherit? not yet implemented for demons");
          }
  ...
  public static Stella_Object accessDemonSlotValue(Demon self, Symbol slotname, Stella_Object value, boolean setvalueP) {
    if (slotname == Stella.SYM_STELLA_DEMON_NAME) {
      if (setvalueP) {
        ...
        value = Stella.wrapString(self.demonName);
      }
    }
      ...
      if (setvalueP) {
        ...
        value = Stella.wrapFunctionCode(self.demonCode);
      }
    }
      ...
      if (setvalueP) {
        ...
        value = Stella.wrapString(self.demonDocumentation);
      }
    }
