        ...
        try {
          ...
          if (!(Stella.suppressWarningsP())) {
            Stella.printErrorContext(">> WARNING: ", Stella.STANDARD_WARNING);
            {
              ...
              Stella.STANDARD_WARNING.nativeStream.println(" Applying CONS-methods to &rest-arguments is deprecated.");
              Stella.STANDARD_WARNING.nativeStream.println("   `" + Stella_Object.deUglifyParseTree(tree) + "'");
              Stella.STANDARD_WARNING.nativeStream.println(" Use `foreach' or explicitly coerce with `coerce-&rest-to-cons'.");
            }
;
          }
    ...
    { Slot directequivalent = slot.slotDirectEquivalent;
      ...
      if (directequivalent != null) {
        if (directequivalent.slotMarkedP) {
          slot.slotMarkedP = Stella.TRUE;
        }
        else {
          directequivalent.slotMarkedP = Stella.TRUE;
        }
      }
    }
  }
    ...
    { Stella_Class renamed_Class = ((Stella_Class)(self.slotOwner.surrogateValue));
      ...
      if (slotrenames != null) {
        ...
        if (renamesslot != null) {
          ...
          renamesslot.slotRenamedP = Stella.TRUE;
        }
        else {
          {
...
;
  ...
  public static Slot attachSlotToOwner(Slot newslot) {
    { Symbol name = newslot.slotName;
      ...
      newslot.slotExternalP = Stella.TRUE;
