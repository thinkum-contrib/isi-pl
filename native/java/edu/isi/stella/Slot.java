      ...
      { Object old$PrintreadablyP$001 = Stella.$PRINTREADABLYp$.get();
        ...
        try {
          ...
          if (!(Stella.suppressWarningsP())) {
            ...
            {
              System.out.println();
              System.out.println(" Applying CONS-methods to &rest-arguments is deprecated.");
              System.out.println("   `" + Stella_Object.deUglifyParseTree(tree) + "'");
              System.out.println(" Use `foreach' or explicitly coerce with `coerce-&rest-to-cons'.");
            }
;
          }
