...
public class IntegerWrapper extends NumberWrapper {
  ...
  public Stella_Object copyWrappedLiteral() {
    { IntegerWrapper self = this;
      ...
      return (Stella.wrapInteger(self.wrapperValue));
    }
  }
  ...
  public static Stella_Object safety(IntegerWrapper level, Stella_Object test, Cons body) {
    ...
    return (Stella.list$(Stella_Object.cons(Stella.SYM_STELLA_WHEN, Stella_Object.cons(Stella.list$(Stella_Object.cons(Stella.SYM_STELLA_NOT, Stella_Object.cons(test, Stella_Object.cons(Stella.NIL, Stella.NIL)))), Stella_Object.cons(Stella.list$(Stella_Object.cons(Stella.SYM_STELLA_PRINT_STREAM, Stella_Object.cons(Stella.KWD_ERROR, Stella_Object.cons(Stella.wrapString("Safety violation: "), Stella_Object.cons(body.concatenate(Stella.NIL, Stella.NIL), Stella.NIL))))), Stella_Object.cons(Stella.NIL, Stella.NIL))))));
  }
  ...
  public void printObject(java.io.PrintStream stream) {
    { IntegerWrapper self = this;
      ...
      if (((Boolean)(Stella.$PRINTREADABLYp$.get())).booleanValue()) {
        ...
        stream.print("|L|" + self.wrapperValue);
      }
    }
  }
  ...
  public static Stella_Object accessIntegerWrapperSlotValue(IntegerWrapper self, Symbol slotname, Stella_Object value, boolean setvalueP) {
    if (slotname == Stella.SYM_STELLA_WRAPPER_VALUE) {
      if (setvalueP) {
        ...
        value = Stella.wrapInteger(self.wrapperValue);
      }
    }
    else {
