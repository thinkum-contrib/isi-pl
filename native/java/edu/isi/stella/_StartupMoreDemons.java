      ...
      try {
        ...
        if (Stella.currentStartupTimePhaseP(7)) {
          ...
          { MethodSlot function = Symbol.lookupFunction(Stella.SYM_STELLA_STARTUP_MORE_DEMONS);
            ...
            KeyValueList.setDynamicSlotValue(function.dynamicSlots, Stella.SYM_STELLA_METHOD_STARTUP_CLASSNAME, Stella.wrapString("_Startup-More-Demons"), Stella.NULL_STRING_WRAPPER);
          }
        }
        ...
        if (Stella.currentStartupTimePhaseP(9)) {
          Stella.defineDemon("inverse-slot-demon", Stella_Object.cons(Stella.KWD_CODE, Stella_Object.cons(Stella.wrapFunctionCode(Native.find_java_method("edu.isi.stella.StandardObject", "inverseSlotDemon", new java.lang.Class [] {Native.find_java_class("edu.isi.stella.StandardObject"), Native.find_java_class("edu.isi.stella.StorageSlot"), Native.find_java_class("edu.isi.stella.StandardObject"), Native.find_java_class("edu.isi.stella.StandardObject")})), Stella.NIL)));
          Stella.defineDemon("class-extension-constructor-demon", Stella_Object.cons(Stella.KWD_DOCUMENTATION, Stella_Object.cons(Stella.wrapString("Demon that inserts the instance 'self' into the extension of\nthe class 'class'."), Stella_Object.cons(Stella.KWD_CREATE, Stella_Object.cons(Stella.KWD_ALL, Stella_Object.cons(Stella.KWD_CODE, Stella_Object.cons(Stella.wrapFunctionCode(Native.find_java_method("edu.isi.stella.ActiveObject", "classExtensionConstructorDemon", new java.lang.Class [] {Native.find_java_class("edu.isi.stella.ActiveObject"), Native.find_java_class("edu.isi.stella.Stella_Class")})), Stella.NIL)))))));
          Stella.defineDemon("class-extension-destructor-demon", Stella_Object.cons(Stella.KWD_DOCUMENTATION, Stella_Object.cons(Stella.wrapString("Demon that removes the instance 'self' from the extension of\nthe class 'class'.  Removal removes the instance forever.  Deletion without\nremoval can be achieved in constant time by setting 'deleted?' on 'self'."), Stella_Object.cons(Stella.KWD_DESTROY, Stella_Object.cons(Stella.KWD_ALL, Stella_Object.cons(Stella.KWD_CODE, Stella_Object.cons(Stella.wrapFunctionCode(Native.find_java_method("edu.isi.stella.ActiveObject", "classExtensionDestructorDemon", new java.lang.Class [] {Native.find_java_class("edu.isi.stella.ActiveObject"), Native.find_java_class("edu.isi.stella.Stella_Class")})), Stella.NIL)))))));
