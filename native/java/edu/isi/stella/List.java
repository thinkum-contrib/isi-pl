...
public class List extends Sequence {
            ...
            if ((testValue000 == Stella.SYM_STELLA_METHOD) ||
              ...
              { Cons translation = ((Cons)(unit.translation));
                ...
                if ((code.charAt(0) == '#') &&
                  ...
                  translation.secondSetter(Stella.wrapString(""));
                }
              }
            }
      ...
      while (!(iter000 == Stella.NIL)) {
        ...
        if (unit.theObject != null) {
          { Symbol testValue000 = unit.category;
            ...
            if ((testValue000 == Stella.SYM_STELLA_STARTUP_TIME_PROGN) ||
  ...
  public static void helpPrintContextTree(List list, int level) {
    { Context c = null;
      ...
      while (!(iter000 == Stella.NIL)) {
        ...
        System.out.print(c.contextNumber);
        if (c.contextName() != null) {
          System.out.print("   " + c.contextName());
        }
        System.out.println();
  ...
  public static void clOutputSystemClStructsFile(List classunits) {
    { String outputfile = Stella.makeFileName(Stella.clYieldStructClassFileName(((SystemDefinition)(Stella.$CURRENTSYSTEMDEFINITION$.get())).name), Stella.KWD_LISP, Stella.TRUE);
      ...
      { Object old$Module$000 = Stella.$MODULE$.get();
        ...
        try {
          ...
          if (classes.nonEmptyP()) {
            ...
            Native.setSpecial(Stella.$MODULE$, Stella.getStellaModule(((SystemDefinition)(Stella.$CURRENTSYSTEMDEFINITION$.get())).cardinalModule, Stella.TRUE));
          }
          currentmodule = ((Module)(Stella.$MODULE$.get()));
          OutputStream.clOutputFileHeader(outputstream, outputfile, Stella.TRUE);
          { Stella_Class renamed_Class = null;
            ...
            while ((!(iter001 == Stella.NIL)) &&
              ...
              if (!(((Module)(Stella.$MODULE$.get())) == currentmodule)) {
                ...
                if (!(ensuredpackages.memberP(Stella.wrapString(renamed_Package)))) {
                  ensuredpackages.push(Stella.wrapString(renamed_Package));
    ...
    { int remainingunits = startupunits.length();
      ...
      loop000 : while (!(cursor == Stella.NIL)) {
        ...
        { Symbol functionname = GeneralizedSymbol.internDerivedSymbol(startupfnname, "HELP-" + startupfnname.symbolName + Native.integerToString(helpfncounter = helpfncounter + 1));
          ...
          KeyValueList.setDynamicSlotValue(((MethodSlot)(Cons.helpWalkAuxiliaryTree(helpfntree, Stella.TRUE).theObject)).dynamicSlots, Stella.SYM_STELLA_METHOD_STARTUP_CLASSNAME, Stella.wrapString(Symbol.yieldStartupFunctionClassname(startupfnname)), Stella.NULL_STRING_WRAPPER);
