...
;
  ...
  public static Cons cppTranslateReturnTree(Cons tree) {
    { Cons otree = null;
      ...
      Stella_Object returnexpression = null;
      Cons translatedreturnexpression = Stella.NIL;
      boolean needtemporaryreturnvariableP = false;
...
;
  ...
  public static Cons clTranslateForeachTree(Cons tree) {
    { Cons iteratorbindings = ((Cons)(tree.rest.value));
      Cons cursorbindings = ((Cons)(tree.rest.rest.value));
      Stella_Object continuationtest = Stella_Object.clTranslateBooleanTest(tree.fourth(), false);
      ...
      return (Stella.list$(Stella_Object.cons(Stella.internCommonLispSymbol("LET*"), Stella_Object.cons(declarations, Stella_Object.cons(Cons.clYieldDeclareTree(typedeclarations, false).concatenate(Stella_Object.cons(Stella.list$(Stella_Object.cons(Stella.internCommonLispSymbol("LOOP"), Stella_Object.cons(Stella.SYM_STELLA_WHILE, Stella_Object.cons(continuationtest, Stella_Object.cons(Stella_Object.cons(Stella.SYM_STELLA_DO, nextassignments.reverse().concatenate(Cons.maybeWrapWithContinueLabel(body).concatenate(Stella.NIL, Stella.NIL), Stella.NIL)), Stella.NIL))))), Stella.NIL), Stella.NIL), Stella.NIL)))));
    }
  }
...
;
      ...
      { Object [] caller_MV_returnarray = new Object[2];
        ...
        iteratorclauses = Cons.walkCursorsTree(iteratorssubtree, true, caller_MV_returnarray);
    ...
    { Stella_Object nametree = null;
      ...
      if (oldmethod != null) {
        { MethodSlot _return_temp = oldmethod;
          ...
          MV_returnarray[0] = Stella.wrapBoolean(true);
          return (_return_temp);
        }
      }
