  ...
  public static void idlOutputSignatures(Cons signatures) {
    ...
    { Stella_Object signature = null;
      ...
      while (!(iter000 == Stella.NIL)) {
        ...
        Stella.idlIndent();
        Cons.idlOutputSignature(((Cons)(signature)), Stella.FALSE);
...
;
  ...
  public static void idlOutputEnum(Cons enum) {
    ((OutputStream)(Stella.$CURRENT_STREAM$.get())).nativeStream.print("enum {");
    Cons.idlOutputEnumerands(((Cons)(((Cons)(enum.nth(4))).rest.value)));
    {
      ((OutputStream)(Stella.$CURRENT_STREAM$.get())).nativeStream.println("};");
      ((OutputStream)(Stella.$CURRENT_STREAM$.get())).nativeStream.println();
    }
...
;
        ...
        while (!(iter000 == Stella.NIL)) {
          ...
          if (Cons.javaLiteralStringP(newItem)) {
            if (Cons.javaLiteralStringP(lastItem)) {
              lastItem = Stella.list$(Stella_Object.cons(Stella.SYM_STELLA_JAVA_LITERAL, Stella_Object.cons(Stella.wrapString(((StringWrapper)(newItem.rest.value)).wrapperValue + ((StringWrapper)(lastItem.rest.value)).wrapperValue), Stella_Object.cons(Stella.NIL, Stella.NIL))));
            }
            else {
              {
  ...
  public static void javaOutputPrintStream(Cons exps, boolean nativestreamP) {
    { Stella_Object stream = exps.value;
      boolean foundeolP = Stella.FALSE;
      boolean embeddedeolP = Stella.FALSE;
      ...
      { Stella_Object i = null;
        ...
        loop000 : while (!(iter000 == Stella.NIL)) {
          ...
          if (foundeolP) {
            embeddedeolP = Stella.TRUE;
            break loop000;
          }
          if (Stella_Object.javaEndOfLineTokenP(i)) {
            foundeolP = Stella.TRUE;
          }
        }
      }
      if (embeddedeolP) {
            ...
            if (Stella_Object.javaEndOfLineTokenP(item)) {
              {
                ...
                Stella_Object.javaHelpOutputPrintStream(stream, Cons.javaReverseAndConsolidateStrings(printitems), nativestreamP, Stella.TRUE);
                if (embeddedeolP) {
                  ((OutputStream)(Stella.$CURRENT_STREAM$.get())).nativeStream.println(";");
                }
      ...
      if (!(printitems == Stella.NIL)) {
        ...
        Stella_Object.javaHelpOutputPrintStream(stream, Cons.javaReverseAndConsolidateStrings(printitems), nativestreamP, Stella.FALSE);
        if (embeddedeolP) {
          ((OutputStream)(Stella.$CURRENT_STREAM$.get())).nativeStream.println(";");
        }
      }
  ...
  public static void javaOutputForeach(Cons loop) {
    { Stella_Object continuationtest = loop.value;
      Stella_Object nextassignments = loop.rest.value;
      Stella_Object body = loop.rest.rest.value;

      ((OutputStream)(Stella.$CURRENT_STREAM$.get())).nativeStream.print("while (");
      Stella_Object.javaOutputStatement(continuationtest);
      ((OutputStream)(Stella.$CURRENT_STREAM$.get())).nativeStream.println(") {");
      Stella.javaBumpIndent();
      Cons.javaOutputStatements(((Cons)(nextassignments)));
      Cons.javaOutputStatements(((Cons)(body)));
      Stella.javaUnbumpIndent();
      Stella.javaIndent();
      ((OutputStream)(Stella.$CURRENT_STREAM$.get())).nativeStream.println("}");
    }
  ...
  public static void javaOutputActualsAsConsExpression(Cons arglist) {
    if (arglist == Stella.NIL) {
      ...
      {
        ((OutputStream)(Stella.$CURRENT_STREAM$.get())).nativeStream.print(((StringWrapper)(Stella.$JAVA_STELLA_PACKAGE_MAPPING$.lookup(Stella.wrapString("STELLAROOT")))) + ".Stella_Object.cons(");
...
;
  ...
  public static void javaOutputBlock(Cons block) {
    { boolean firststatementP = Stella.TRUE;
  ...
  public static void javaOutputMethod(Cons method) {
    { Cons body = null;
      ...
      else if (((Cons)(method.value)).memberP(Stella.wrapString("abstract"))) {
        ((OutputStream)(Stella.$CURRENT_STREAM$.get())).nativeStream.println(";");
      }
      else if (((Cons)(method.rest.value)).memberP(Stella.wrapString("void"))) {
        System.out.println("Note: Void method `" + method.rest.rest.value + "' has an empty body.");
        ((OutputStream)(Stella.$CURRENT_STREAM$.get())).nativeStream.println(" {}");
      }
      else {
  ...
  public static void javaOutputParseTree(Cons constree) {
    { Object old$JavaIndentChars$000 = Stella.$JAVA_INDENT_CHARS$.get();
      ...
      try {
        ...
        Stella.$JAVA_STELLA_PACKAGE_MAPPING$.insertAt(Stella.wrapString("STELLAROOT"), Stella.wrapString(Stella.javaStellaPackage()));
  ...
  public static Cons javaTranslateMethodCall(Cons tree) {
    { Symbol methodname = ((Symbol)(tree.rest.rest.value));
      ...
      if (methodname == Stella.SYM_STELLA_DEFINEDp) {
        return (Surrogate.javaTranslateDefinedOrNull(classtype, renamed_Object, Stella.FALSE));
      }
      else if (methodname == Stella.SYM_STELLA_NULLp) {
        return (Surrogate.javaTranslateDefinedOrNull(classtype, renamed_Object, Stella.TRUE));
      }
          ...
          try {
            ...
            { Cons actuals = (((BooleanWrapper)(KeyValueList.dynamicSlotValue(function.dynamicSlots, Stella.SYM_STELLA_METHOD_VARIABLE_ARGUMENTSp, Stella.FALSE_WRAPPER))).wrapperValue ? Cons.javaTranslateVariableLengthActuals(functionargs, function) : Cons.javaTranslateActualParameters(functionargs));
              ...
              if (!((function.methodReturnTypeSpecifiers().rest() == Stella.NIL) ||
                ...
                actuals = actuals.concatenate(Stella_Object.cons(Stella.list$(Stella_Object.cons(Stella.SYM_STELLA_JAVA_MAKE_ARRAY, Stella_Object.cons(StandardObject.javaTranslateTypeSpec(Stella.SGT_STELLA_NATIVE_OBJECT_POINTER), Stella_Object.cons(Stella_Object.cons(Stella.wrapInteger(function.methodReturnTypeSpecifiers().length() - 1), Stella.NIL), Stella.NIL)))), Stella.NIL), Stella.NIL);
              }
              otree = Stella.list$(Stella_Object.cons(Stella.SYM_STELLA_JAVA_FUNCTION_CALL, Stella_Object.cons(Stella.list$(Stella_Object.cons(Stella.SYM_STELLA_JAVA_IDENT, Stella_Object.cons(Stella.wrapString(MethodSlot.javaYieldClassNameForFunction(function)), Stella_Object.cons(Stella.NIL, Stella.NIL)))), Stella_Object.cons(Stella.list$(Stella_Object.cons(Stella.SYM_STELLA_JAVA_IDENT, Stella_Object.cons(MethodSlot.javaTranslateFunctionName(function), Stella_Object.cons(Stella.NIL, Stella.NIL)))), Stella_Object.cons(actuals, Stella_Object.cons(Stella.NIL, Stella.NIL))))));
...
;
          ...
          otree = Stella.list$(Stella_Object.cons(Stella.SYM_STELLA_JAVA_FUNCTION_CALL, Stella_Object.cons(Stella.list$(Stella_Object.cons(Stella.SYM_STELLA_JAVA_IDENT, Stella_Object.cons(Stella.wrapString(Stella.javaYieldNativeClassName()), Stella_Object.cons(Stella.NIL, Stella.NIL)))), Stella_Object.cons(Stella.list$(Stella_Object.cons(Stella.SYM_STELLA_JAVA_IDENT, Stella_Object.cons(Stella.wrapString("find_java_method"), Stella_Object.cons(Stella.NIL, Stella.NIL)))), Stella_Object.cons(Stella.list$(Stella_Object.cons(Stella.SYM_STELLA_JAVA_ACTUALS, Stella_Object.cons(Stella.wrapString(classname), Stella_Object.cons(Stella_Object.cons(Stella.wrapString(functionname), Stella_Object.cons(MethodSlot.javaTranslateParamTypeSpecifications(fn, null), Stella.NIL)), Stella.NIL)))), Stella_Object.cons(Stella.NIL, Stella.NIL))))));
        }
...
;
  ...
  public static Cons javaWrapWithNativeValueExtraction(Cons tree, StandardObject primaryreturntype) {
    { StringWrapper wrappertype = null;
      ...
      return (Stella.list$(Stella_Object.cons(Stella.SYM_STELLA_JAVA_METHOD_CALL, Stella_Object.cons(Stella.list$(Stella_Object.cons(Stella.SYM_STELLA_JAVA_IDENT, Stella_Object.cons(Stella.wrapString(""), Stella_Object.cons(Stella.NIL, Stella.NIL)))), Stella_Object.cons(Stella.list$(Stella_Object.cons(Stella.SYM_STELLA_JAVA_IDENT, Stella_Object.cons(extractorname, Stella_Object.cons(Stella.NIL, Stella.NIL)))), Stella_Object.cons(Stella.list$(Stella_Object.cons(Stella.SYM_STELLA_JAVA_CAST, Stella_Object.cons(tree, Stella_Object.cons(Stella_Object.cons(wrappertype, Stella.NIL), Stella.NIL)))), Stella_Object.cons(Stella_Object.cons(Stella.SYM_STELLA_JAVA_ACTUALS, Stella.NIL), Stella_Object.cons(Stella.NIL, Stella.NIL))))))));
    }
  }
  ...
  public static Cons javaTranslateMvSetq(Cons tree) {
    { Cons variables = ((Cons)(tree.rest.value));
      ...
      otree = Stella.list$(Stella_Object.cons(Stella.SYM_STELLA_JAVA_BLOCK, Stella_Object.cons(Stella_Object.cons(Stella_Object.cons(StandardObject.javaTranslateArrayOfTypeSpec(Stella.SGT_STELLA_NATIVE_OBJECT_POINTER, Stella.FALSE), Stella.list$(Stella_Object.cons(Stella.list$(Stella_Object.cons(Stella.SYM_STELLA_JAVA_IDENT, Stella_Object.cons(Stella.wrapString("caller_MV_returnarray"), Stella_Object.cons(Stella.NIL, Stella.NIL)))), Stella_Object.cons(Stella.list$(Stella_Object.cons(Stella.SYM_STELLA_JAVA_MAKE_ARRAY, Stella_Object.cons(StandardObject.javaTranslateTypeSpec(Stella.SGT_STELLA_NATIVE_OBJECT_POINTER), Stella_Object.cons(Stella_Object.cons(Stella.wrapInteger(otherreturntypes.length()), Stella.NIL), Stella.NIL)))), Stella_Object.cons(Stella.NIL, Stella.NIL))))), Stella.NIL), Stella_Object.cons(Stella.list$(Stella_Object.cons(Stella.SYM_STELLA_JAVA_STATEMENTS, Stella_Object.cons(Stella.list$(Stella_Object.cons(Stella.SYM_STELLA_JAVA_ASSIGN, Stella_Object.cons(Stella_Object.javaTranslateATree(variables.value), Stella_Object.cons(Stella_Object.cons(Cons.javaTranslateMvFunctionCall(functioncall, Stella.SYM_STELLA_CALLER_MV_RETURNARRAY), Stella.NIL), Stella.NIL)))), Stella_Object.cons(mvassignments.reverse().concatenate(Stella.NIL, Stella.NIL), Stella.NIL)))), Stella_Object.cons(Stella.NIL, Stella.NIL)))));
      return (otree);
    }
  }
  ...
  public static Cons javaTranslateChooseTree(Cons tree) {
    { Stella_Object test = tree.rest.value;
      ...
      tree.rest.rest = Stella.NIL;
      return (Cons.javaTranslateOperatorCall(Stella_Object.cons(Stella.wrapString("?"), Stella_Object.cons(Stella.wrapString(":"), Stella.NIL)), Stella_Object.cons(test, Stella_Object.cons(truebody, Stella_Object.cons(falsebody, Stella.NIL))), 3));
    }
  }
  ...
  public static Cons javaTranslateWhile(Cons tree) {
    { Object old$JavaLoopName$000 = Stella.$JAVA_LOOP_NAME$.get();
      ...
      try {
        ...
        Native.setBooleanSpecial(Stella.$JAVA_LOOP_NAME_USEDp$, Stella.FALSE);
        { Stella_Object test = Stella_Object.javaTranslateATree(tree.rest.value);
          Cons body = Cons.javaTranslateListOfTrees(tree.rest.rest);
  ...
  public static Cons javaTranslateCaseTree(Cons tree) {
    { Cons otherwisecondition = null;
      ...
      boolean symbolcasep = Stella.FALSE;
  ...
  public static Cons javaTranslateContinue(Cons tree) {
    ...
    Native.setBooleanSpecial(Stella.$JAVA_LOOP_NAME_USEDp$, Stella.TRUE);
    ...
    { Cons otree = null;
      ...
      { StandardObject parametertype = null;
        ...
        while ((!(iter000 == Stella.NIL)) &&
          ...
          returnassignments = Stella_Object.cons(Stella.list$(Stella_Object.cons(Stella.SYM_STELLA_JAVA_ASSIGN, Stella_Object.cons(Stella.list$(Stella_Object.cons(Stella.SYM_STELLA_JAVA_AREF, Stella_Object.cons(Stella.list$(Stella_Object.cons(Stella.SYM_STELLA_JAVA_IDENT, Stella_Object.cons(Stella.wrapString("MV_returnarray"), Stella_Object.cons(Stella.NIL, Stella.NIL)))), Stella_Object.cons(Stella.wrapInteger(parameterindex), Stella_Object.cons(Stella.NIL, Stella.NIL))))), Stella_Object.cons(mvreturnparametertranslation, Stella_Object.cons(Stella.NIL, Stella.NIL))))), returnassignments);
        }
      }
      ...
      if (returnassignments == Stella.NIL) {
        ...
        { String tempvarname = "_return_temp";
          ...
          otree = Stella.list$(Stella_Object.cons(Stella.SYM_STELLA_JAVA_BLOCK, Stella_Object.cons(Stella_Object.cons(Stella_Object.cons(StandardObject.javaTranslateTypeSpec(((MethodSlot)(Stella.$METHODBEINGWALKED$.get())).computeReturnTypeSpec(((MethodSlot)(Stella.$METHODBEINGWALKED$.get())).slotOwner)), Stella.list$(Stella_Object.cons(Stella.list$(Stella_Object.cons(Stella.SYM_STELLA_JAVA_IDENT, Stella_Object.cons(Stella.wrapString(tempvarname), Stella_Object.cons(Stella.NIL, Stella.NIL)))), Stella_Object.cons(translatedreturnexpression, Stella_Object.cons(Stella.NIL, Stella.NIL))))), Stella.NIL), Stella_Object.cons(Stella_Object.cons(Stella.SYM_STELLA_JAVA_STATEMENTS, returnassignments.concatenate(Stella_Object.cons(Stella.list$(Stella_Object.cons(Stella.SYM_STELLA_JAVA_RETURN, Stella_Object.cons(Stella.list$(Stella_Object.cons(Stella.SYM_STELLA_JAVA_IDENT, Stella_Object.cons(Stella.wrapString(tempvarname), Stella_Object.cons(Stella.NIL, Stella.NIL)))), Stella_Object.cons(Stella.NIL, Stella.NIL)))), Stella.NIL), Stella.NIL)), Stella_Object.cons(Stella.NIL, Stella.NIL)))));
        }
      }
      return (otree);
    }
  ...
  public static Cons javaTranslateCast(Cons tree) {
    { Stella_Object expression = tree.rest.value;
      ...
      if (Surrogate.subtypeOfP(type, Stella.SGT_STELLA_FLOAT) &&
        ...
        return (((Cons)(Stella_Object.javaTranslateATree(Stella.wrapFloat(((double)(((IntegerWrapper)(expression)).wrapperValue)))))));
      }
      if (Surrogate.subtypeOfP(type, Stella.SGT_STELLA_INTEGER) &&
          Stella_Object.isaP(expression, Stella.SGT_STELLA_FLOAT_WRAPPER)) {
        return (((Cons)(Stella_Object.javaTranslateATree(Stella.wrapInteger(((int)(((FloatWrapper)(expression)).wrapperValue)))))));
      }
    ...
    { Object old$JavaLoopName$000 = Stella.$JAVA_LOOP_NAME$.get();
      ...
      try {
        ...
        { Cons iteratorbindings = ((Cons)(tree.rest.value));
          Cons cursorbindings = ((Cons)(tree.rest.rest.value));
          Stella_Object continuationtest = Stella_Object.javaTranslateATree(tree.fourth());
          Cons body = Cons.javaTranslateListOfTrees(tree.nthRest(4));
          Cons declarations = Stella.NIL;
          Cons nextassignments = Stella.NIL;
          Stella_Object iteratorconstructor = null;

          tree.nthRestSetter(Stella.NIL, 4);
          if (((Cons)(((Cons)(iteratorbindings.value)))).rest.value == Stella.SGT_STELLA_LISP_CONS_ITERATOR) {
            return (Cons.javaTranslateArgumentListIterator(iteratorbindings, cursorbindings, body));
          }
          { Cons binding = null;
            ...
            while (!(iter000 == Stella.NIL)) {
              ...
              iteratorconstructor = Stella_Object.javaTranslateATree(binding.rest.rest.value);
              binding.thirdSetter(null);
              if (collect000 == null) {
                {
                  collect000 = Stella_Object.cons(Stella_Object.cons(StandardObject.javaTranslateTypeSpec(((StandardObject)(((Cons)(binding)).rest.value))), Stella_Object.cons(Stella_Object.javaTranslateATree(((Cons)(binding)).value), Stella_Object.cons(iteratorconstructor, Stella.NIL))), Stella.NIL);
                ...
                {
                  collect000.rest = Stella_Object.cons(Stella_Object.cons(StandardObject.javaTranslateTypeSpec(((StandardObject)(((Cons)(binding)).rest.value))), Stella_Object.cons(Stella_Object.javaTranslateATree(((Cons)(binding)).value), Stella_Object.cons(iteratorconstructor, Stella.NIL))), Stella.NIL);
                  collect000 = collect000.rest;
                }
              }
            }
          ...
          { Cons binding = null;
            ...
            while (!(iter001 == Stella.NIL)) {
              ...
              nextassignments = Stella_Object.cons(Stella_Object.javaTranslateATree(binding.rest.rest.value), nextassignments);
              binding.thirdSetter(null);
              if (!(Symbol.duplicateCursorVariableP(((Symbol)(binding.value)), iteratorbindings))) {
                declarations = Stella_Object.cons(Stella_Object.cons(StandardObject.javaTranslateTypeSpec(((StandardObject)(((Cons)(binding)).rest.value))), Stella_Object.cons(Stella_Object.javaTranslateATree(((Cons)(binding)).value), Stella_Object.cons(Stella_Object.javaTranslateATree(Surrogate.typeToWalkedNullValueTree(StandardObject.typeSpecToBaseType(((StandardObject)(binding.rest.value))))), Stella.NIL))), declarations);
              }
            }
          }
          if (((Boolean)(Stella.$JAVA_LOOP_NAME_USEDp$.get())).booleanValue()) {
            return (Stella.list$(Stella_Object.cons(Stella.SYM_STELLA_JAVA_BLOCK, Stella_Object.cons(declarations, Stella_Object.cons(Stella_Object.cons(Stella.list$(Stella_Object.cons(Stella.SYM_STELLA_JAVA_STATEMENTS, Stella_Object.cons(Stella.list$(Stella_Object.cons(Stella.SYM_STELLA_JAVA_NAMED_STATEMENT, Stella_Object.cons(Stella_Object.javaTranslateATree(((Symbol)(Stella.$JAVA_LOOP_NAME$.get()))), Stella_Object.cons(Stella_Object.cons(Stella.list$(Stella_Object.cons(Stella.SYM_STELLA_JAVA_FOREACH, Stella_Object.cons(continuationtest, Stella_Object.cons(Stella_Object.cons(nextassignments.reverse(), Stella_Object.cons(body, Stella.NIL)), Stella.NIL)))), Stella.NIL), Stella.NIL)))), Stella_Object.cons(Stella.NIL, Stella.NIL)))), Stella.NIL), Stella.NIL)))));
          }
          else {
            return (Stella.list$(Stella_Object.cons(Stella.SYM_STELLA_JAVA_BLOCK, Stella_Object.cons(declarations, Stella_Object.cons(Stella_Object.cons(Stella.list$(Stella_Object.cons(Stella.SYM_STELLA_JAVA_STATEMENTS, Stella_Object.cons(Stella.list$(Stella_Object.cons(Stella.SYM_STELLA_JAVA_FOREACH, Stella_Object.cons(continuationtest, Stella_Object.cons(Stella_Object.cons(nextassignments.reverse(), Stella_Object.cons(body, Stella.NIL)), Stella.NIL)))), Stella_Object.cons(Stella.NIL, Stella.NIL)))), Stella.NIL), Stella.NIL)))));
          }
        }
  ...
  public static Cons javaTranslateArgumentListIterator(Cons iteratorbindings, Cons cursorbindings, Cons body) {
    { Stella_Object cursorvar = ((Cons)(cursorbindings.value)).value;
      Stella_Object cursortype = ((Cons)(cursorbindings.value)).rest.value;
      Stella_Object dummyarg = ((Cons)(((Cons)(iteratorbindings.value)).rest.rest.value)).fourth();
      Stella_Object iteratorconstructor = null;
      Cons declarations = Stella.list$(Stella_Object.cons(Stella_Object.cons(Stella.wrapString("Enumeration"), Stella_Object.cons(Stella_Object.javaTranslateATree(Stella.SYM_STELLA_ARG_ENUM), Stella.NIL)), Stella_Object.cons(Stella_Object.cons(StandardObject.javaTranslateTypeSpec(((StandardObject)(cursortype))), Stella_Object.cons(Stella_Object.javaTranslateATree(cursorvar), Stella.NIL)), Stella_Object.cons(Stella.NIL, Stella.NIL))));

      { Cons binding = null;
        Cons iter000 = iteratorbindings.rest;
        Cons collect000 = null;
        ...
        while (!(iter000 == Stella.NIL)) {
          ...
          iteratorconstructor = Stella_Object.javaTranslateATree(((Cons)(binding)).rest.rest.value);
          binding.thirdSetter(null);
          if (collect000 == null) {
            {
              collect000 = Stella_Object.cons(Stella_Object.cons(StandardObject.javaTranslateTypeSpec(((StandardObject)(((Cons)(binding)).rest.value))), Stella_Object.cons(Stella_Object.javaTranslateATree(((Cons)(binding)).value), Stella_Object.cons(iteratorconstructor, Stella.NIL))), Stella.NIL);
      ...
      return (Stella.list$(Stella_Object.cons(Stella.SYM_STELLA_JAVA_BLOCK, Stella_Object.cons(declarations, Stella_Object.cons(Stella_Object.cons(Stella.list$(Stella_Object.cons(Stella.SYM_STELLA_JAVA_STATEMENTS, Stella_Object.cons(Stella.list$(Stella_Object.cons(Stella.SYM_STELLA_JAVA_ASSIGN, Stella_Object.cons(Stella.list$(Stella_Object.cons(Stella.SYM_STELLA_JAVA_IDENT, Stella_Object.cons(Symbol.javaTranslateName(Stella.SYM_STELLA_ARG_ENUM), Stella_Object.cons(Stella.NIL, Stella.NIL)))), Stella_Object.cons(Stella.list$(Stella_Object.cons(Stella.SYM_STELLA_JAVA_METHOD_CALL, Stella_Object.cons(Stella.list$(Stella_Object.cons(Stella.SYM_STELLA_JAVA_IDENT, Stella_Object.cons(Stella.wrapString(""), Stella_Object.cons(Stella.NIL, Stella.NIL)))), Stella_Object.cons(Stella.list$(Stella_Object.cons(Stella.SYM_STELLA_JAVA_IDENT, Stella_Object.cons(Symbol.javaTranslateName(Stella.SYM_STELLA_ELEMENTS), Stella_Object.cons(Stella.NIL, Stella.NIL)))), Stella_Object.cons(Stella_Object.javaTranslateATree(dummyarg), Stella_Object.cons(Stella_Object.cons(Stella_Object.cons(Stella.SYM_STELLA_JAVA_ACTUALS, Stella.NIL), Stella.NIL), Stella.NIL)))))), Stella_Object.cons(Stella.NIL, Stella.NIL))))), Stella_Object.cons(Stella.list$(Stella_Object.cons(Stella.SYM_STELLA_JAVA_WHILE, Stella_Object.cons(Stella.list$(Stella_Object.cons(Stella.SYM_STELLA_JAVA_METHOD_CALL, Stella_Object.cons(Stella.list$(Stella_Object.cons(Stella.SYM_STELLA_JAVA_IDENT, Stella_Object.cons(Stella.wrapString(""), Stella_Object.cons(Stella.NIL, Stella.NIL)))), Stella_Object.cons(Stella.list$(Stella_Object.cons(Stella.SYM_STELLA_JAVA_IDENT, Stella_Object.cons(Stella.wrapString("hasMoreElements"), Stella_Object.cons(Stella.NIL, Stella.NIL)))), Stella_Object.cons(Stella.list$(Stella_Object.cons(Stella.SYM_STELLA_JAVA_IDENT, Stella_Object.cons(Symbol.javaTranslateName(Stella.SYM_STELLA_ARG_ENUM), Stella_Object.cons(Stella.NIL, Stella.NIL)))), Stella_Object.cons(Stella_Object.cons(Stella.SYM_STELLA_JAVA_ACTUALS, Stella.NIL), Stella_Object.cons(Stella.NIL, Stella.NIL))))))), Stella_Object.cons(Stella.list$(Stella_Object.cons(Stella.SYM_STELLA_JAVA_PROGN, Stella_Object.cons(Stella.list$(Stella_Object.cons(Stella.SYM_STELLA_JAVA_STATEMENTS, Stella_Object.cons(Stella.list$(Stella_Object.cons(Stella.SYM_STELLA_JAVA_ASSIGN, Stella_Object.cons(Stella_Object.javaTranslateATree(cursorvar), Stella_Object.cons(Stella_Object.cons(Stella.list$(Stella_Object.cons(Stella.SYM_STELLA_JAVA_CAST, Stella_Object.cons(Stella.list$(Stella_Object.cons(Stella.SYM_STELLA_JAVA_METHOD_CALL, Stella_Object.cons(Stella.list$(Stella_Object.cons(Stella.SYM_STELLA_JAVA_IDENT, Stella_Object.cons(Stella.wrapString(""), Stella_Object.cons(Stella.NIL, Stella.NIL)))), Stella_Object.cons(Stella.list$(Stella_Object.cons(Stella.SYM_STELLA_JAVA_IDENT, Stella_Object.cons(Stella.wrapString("nextElement"), Stella_Object.cons(Stella.NIL, Stella.NIL)))), Stella_Object.cons(Stella.list$(Stella_Object.cons(Stella.SYM_STELLA_JAVA_IDENT, Stella_Object.cons(Symbol.javaTranslateName(Stella.SYM_STELLA_ARG_ENUM), Stella_Object.cons(Stella.NIL, Stella.NIL)))), Stella_Object.cons(Stella_Object.cons(Stella.SYM_STELLA_JAVA_ACTUALS, Stella.NIL), Stella_Object.cons(Stella.NIL, Stella.NIL))))))), Stella_Object.cons(StandardObject.javaTranslateTypeSpec(Stella.SGT_STELLA_OBJECT), Stella_Object.cons(Stella.NIL, Stella.NIL))))), Stella.NIL), Stella.NIL)))), Stella_Object.cons(body.concatenate(Stella.NIL, Stella.NIL), Stella.NIL)))), Stella_Object.cons(Stella.NIL, Stella.NIL)))), Stella_Object.cons(Stella.NIL, Stella.NIL))))), Stella_Object.cons(Stella.NIL, Stella.NIL))))), Stella.NIL), Stella.NIL)))));
    }
  }
  ...
  public static Stella_Object javaTranslateSysSetDefault(Cons tree) {
    { Symbol variablename = ((Symbol)(tree.rest.value));
      ...
      return (Stella.list$(Stella_Object.cons(Stella.SYM_STELLA_JAVA_METHOD_CALL, Stella_Object.cons(Stella.list$(Stella_Object.cons(Stella.SYM_STELLA_JAVA_IDENT, Stella_Object.cons(Stella.wrapString(""), Stella_Object.cons(Stella.NIL, Stella.NIL)))), Stella_Object.cons(Stella.list$(Stella_Object.cons(Stella.SYM_STELLA_JAVA_IDENT, Stella_Object.cons(Stella.wrapString("setDefaultValue"), Stella_Object.cons(Stella.NIL, Stella.NIL)))), Stella_Object.cons(Stella.list$(Stella_Object.cons(Stella.SYM_STELLA_JAVA_IDENT, Stella_Object.cons(Symbol.javaTranslateGlobalName(variablename, Stella.FALSE), Stella_Object.cons(Stella.NIL, Stella.NIL)))), Stella_Object.cons(Stella.list$(Stella_Object.cons(Stella.SYM_STELLA_JAVA_ACTUALS, Stella_Object.cons(Stella_Object.javaTranslateWithNativeWrapper(tree.rest.rest.value, ((((StandardObject)(KeyValueList.dynamicSlotValue(globalvar.dynamicSlots, Stella.SYM_STELLA_VARIABLE_TYPE_SPECIFIER, null))) != null) ? ((StandardObject)(((StandardObject)(KeyValueList.dynamicSlotValue(globalvar.dynamicSlots, Stella.SYM_STELLA_VARIABLE_TYPE_SPECIFIER, null))))) : globalvar.variableType)), Stella_Object.cons(Stella.NIL, Stella.NIL)))), Stella_Object.cons(Stella.NIL, Stella.NIL))))))));
    }
  }
  ...
  public static Stella_Object javaTranslateSetqTree(Cons tree) {
    { Symbol variablename = ((Symbol)(tree.rest.value));
      ...
      if ((globalvar != null) &&
        ...
        return (Stella.list$(Stella_Object.cons(Stella.SYM_STELLA_JAVA_FUNCTION_CALL, Stella_Object.cons(Stella.list$(Stella_Object.cons(Stella.SYM_STELLA_JAVA_IDENT, Stella_Object.cons(Stella.wrapString(Stella.javaYieldNativeClassName()), Stella_Object.cons(Stella.NIL, Stella.NIL)))), Stella_Object.cons(Stella.list$(Stella_Object.cons(Stella.SYM_STELLA_JAVA_IDENT, Stella_Object.cons(StandardObject.javaSpecialSetterName(GlobalVariable.globalVariableTypeSpec(globalvar)), Stella_Object.cons(Stella.NIL, Stella.NIL)))), Stella_Object.cons(Stella.list$(Stella_Object.cons(Stella.SYM_STELLA_JAVA_ACTUALS, Stella_Object.cons(Stella.list$(Stella_Object.cons(Stella.SYM_STELLA_JAVA_IDENT, Stella_Object.cons(Symbol.javaTranslateGlobalName(variablename, Stella.FALSE), Stella_Object.cons(Stella.NIL, Stella.NIL)))), Stella_Object.cons(Stella_Object.javaTranslateATree(tree.rest.rest.value), Stella_Object.cons(Stella.NIL, Stella.NIL))))), Stella_Object.cons(Stella.NIL, Stella.NIL)))))));
      }
      else {
  ...
  public static Stella_Object javaTranslateBadSys(Cons tree) {
    return (Stella.list$(Stella_Object.cons(Stella.SYM_STELLA_JAVA_VERBATIM, Stella_Object.cons(Stella.wrapString("*** TRANSLATION FAILURE FROM " + Native.stringify(tree.rest.value)), Stella_Object.cons(Stella.NIL, Stella.NIL)))));
  }
      ...
      { Stella_Object declaration = null;
        ...
        while (!(iter000 == Stella.NIL)) {
          ...
          { Cons d = ((Cons)(declaration));
            ...
            savedeclarations = Stella_Object.cons(Stella_Object.cons(Stella.wrapString("Object"), Stella_Object.cons(oldvaluevariable, Stella_Object.cons(Stella.list$(Stella_Object.cons(Stella.SYM_STELLA_JAVA_METHOD_CALL, Stella_Object.cons(Stella.list$(Stella_Object.cons(Stella.SYM_STELLA_JAVA_IDENT, Stella_Object.cons(Stella.wrapString(""), Stella_Object.cons(Stella.NIL, Stella.NIL)))), Stella_Object.cons(Stella.list$(Stella_Object.cons(Stella.SYM_STELLA_JAVA_IDENT, Stella_Object.cons(Stella.wrapString("get"), Stella_Object.cons(Stella.NIL, Stella.NIL)))), Stella_Object.cons(Stella.list$(Stella_Object.cons(Stella.SYM_STELLA_JAVA_IDENT, Stella_Object.cons(Symbol.javaTranslateGlobalName(specialvariablename, Stella.FALSE), Stella_Object.cons(Stella.NIL, Stella.NIL)))), Stella_Object.cons(Stella_Object.cons(Stella.SYM_STELLA_JAVA_ACTUALS, Stella.NIL), Stella_Object.cons(Stella.NIL, Stella.NIL))))))), Stella.NIL))), savedeclarations);
            ...
            restoreforms = Stella_Object.cons(Stella.list$(Stella_Object.cons(Stella.SYM_STELLA_JAVA_METHOD_CALL, Stella_Object.cons(Stella.list$(Stella_Object.cons(Stella.SYM_STELLA_JAVA_IDENT, Stella_Object.cons(Stella.wrapString(""), Stella_Object.cons(Stella.NIL, Stella.NIL)))), Stella_Object.cons(Stella.list$(Stella_Object.cons(Stella.SYM_STELLA_JAVA_IDENT, Stella_Object.cons(Stella.wrapString("set"), Stella_Object.cons(Stella.NIL, Stella.NIL)))), Stella_Object.cons(Stella.list$(Stella_Object.cons(Stella.SYM_STELLA_JAVA_IDENT, Stella_Object.cons(Symbol.javaTranslateGlobalName(specialvariablename, Stella.FALSE), Stella_Object.cons(Stella.NIL, Stella.NIL)))), Stella_Object.cons(Stella.list$(Stella_Object.cons(Stella.SYM_STELLA_JAVA_ACTUALS, Stella_Object.cons(oldvaluevariable, Stella_Object.cons(Stella.NIL, Stella.NIL)))), Stella_Object.cons(Stella.NIL, Stella.NIL))))))), restoreforms);
          }
        }
      }
  ...
  public static void cppOutputFunctionSignature(Cons function) {
    { String result000 = null;
      ...
      { String baresignature = result000;
        ...
        Stella_Object.cppOutputTypedEntity(function.value, Stella.wrapString(baresignature), null);
      }
    }
  }
  ...
  public static void cppOutputDefprint(Cons defprint) {
    ...
    { Object old$OutputtingdefprintP$000 = Stella.$OUTPUTTINGDEFPRINTp$.get();
      ...
      try {
        Native.setBooleanSpecial(Stella.$OUTPUTTINGDEFPRINTp$, Stella.TRUE);
  ...
  public static void cppOutputFormalParameters(Cons parameters) {
    { int nParameters = parameters.length();
      boolean variableArgumentsP = Stella.FALSE;
          ...
          if (n == nParameters) {
            {
              ...
              Stella_Object.cppOutputTypedEntity((variableArgumentsP ? Stella.wrapString("int") : parameter.value), parameter.rest.value, null);
...
;
  ...
  public static void cppOutputWithProcessLock(Cons synch) {
    { OutputStringStream s = OutputStringStream.newOutputStringStream();
      ...
      StringWrapper.cppOutputComment(Stella.wrapString("Should be synchronized on process lock " + s.theStringReader()));
      Stella.cppIndent();
    }
    ...
    { StringWrapper methodclass = ((StringWrapper)(signature.value));
      ...
      { String result000 = null;
        ...
        { String baresignature = result000;
          ...
          Stella_Object.cppOutputTypedEntity(returntype, Stella.wrapString(baresignature), null);
        }
      }
    }
  }
  ...
  public static void cppOutputForeach(Cons loop) {
    { Stella_Object continuationtest = loop.value;
      Cons nextassignments = ((Cons)(loop.rest.value));
      Cons body = ((Cons)(loop.rest.rest.value));

      ((OutputStream)(Stella.$CURRENT_STREAM$.get())).nativeStream.print("while (");
      Stella_Object.cppOutputStatement(continuationtest);
      ((OutputStream)(Stella.$CURRENT_STREAM$.get())).nativeStream.println(") {");
      Stella.cppBumpIndent();
      loop.secondSetter(null);
      loop.thirdSetter(Cons.cppFlattenStatements(nextassignments.concatenate(body, Stella.NIL)));
      Cons.cppOutputStatements(((Cons)(loop.rest.rest.value)));
      Stella.cppUnbumpIndent();
      Stella.cppIndent();
      ((OutputStream)(Stella.$CURRENT_STREAM$.get())).nativeStream.println("}");
    }
  ...
  public static void cppOutputVariableDefinition(Cons variable) {
    { Stella_Object kind = variable.value;
      ...
      if (documentation != null) {
        StringWrapper.cppOutputComment(Stella.wrapString(documentation));
      }
      if (((GeneralizedSymbol)(kind)) == Stella.SYM_STELLA_CPP_SPECIAL) {
        if (Stella.specialImplementationStyle() == Stella.KWD_UNBIND_WITH_DESTRUCTORS) {
          Stella_Object.cppOutputStatement(Stella.list$(Stella_Object.cons(Stella.SYM_STELLA_CPP_FUNCTION_CALL, Stella_Object.cons(Stella.list$(Stella_Object.cons(Stella.SYM_STELLA_CPP_IDENT, Stella_Object.cons(Stella.wrapString("DEFINE_STELLA_SPECIAL"), Stella_Object.cons(Stella.NIL, Stella.NIL)))), Stella_Object.cons(Stella.list$(Stella_Object.cons(Stella.SYM_STELLA_CPP_ACTUALS, Stella_Object.cons(Stella.list$(Stella_Object.cons(Stella.SYM_STELLA_CPP_IDENT, Stella_Object.cons(name, Stella_Object.cons(Stella.NIL, Stella.NIL)))), Stella_Object.cons(type, Stella_Object.cons(Stella_Object.cons(initialvalue, Stella.NIL), Stella.NIL))))), Stella_Object.cons(Stella.NIL, Stella.NIL))))));
        }
        else {
...
;
  ...
  public static void cppOutputGlobalDeclaration(Cons global) {
    { Stella_Object kind = global.value;
      ...
      if (((GeneralizedSymbol)(kind)) == Stella.SYM_STELLA_CPP_SPECIAL) {
        if (Stella.specialImplementationStyle() == Stella.KWD_UNBIND_WITH_DESTRUCTORS) {
          Stella_Object.cppOutputStatement(Stella.list$(Stella_Object.cons(Stella.SYM_STELLA_CPP_FUNCTION_CALL, Stella_Object.cons(Stella.list$(Stella_Object.cons(Stella.SYM_STELLA_CPP_IDENT, Stella_Object.cons(Stella.wrapString("DECLARE_STELLA_SPECIAL"), Stella_Object.cons(Stella.NIL, Stella.NIL)))), Stella_Object.cons(Stella.list$(Stella_Object.cons(Stella.SYM_STELLA_CPP_ACTUALS, Stella_Object.cons(Stella.list$(Stella_Object.cons(Stella.SYM_STELLA_CPP_IDENT, Stella_Object.cons(name, Stella_Object.cons(Stella.NIL, Stella.NIL)))), Stella_Object.cons(type, Stella_Object.cons(Stella.NIL, Stella.NIL))))), Stella_Object.cons(Stella.NIL, Stella.NIL))))));
        }
        else {
  ...
  public static Cons cppTranslateVariableLengthActuals(Cons actuals, MethodSlot method) {
    { int nofparameters = method.methodParameterNames().length();
      ...
      boolean pusheddummy = Stella.FALSE;
      ...
      { int i = Stella.NULL_INTEGER;
        ...
        while (!(iter000 == Stella.NIL)) {
          ...
          if (i == restargumentstart) {
            pusheddummy = Stella.TRUE;
            { int result = actuals.length() - restargumentstart;

              otree = Stella_Object.cons(Stella.list$(Stella_Object.cons(Stella.SYM_STELLA_CPP_LITERAL, Stella_Object.cons(Stella.wrapInteger(result), Stella_Object.cons(Stella.NIL, Stella.NIL)))), otree);
            }
          }
      ...
      if (!(pusheddummy)) {
        otree = Stella_Object.cons(Stella.list$(Stella_Object.cons(Stella.SYM_STELLA_CPP_LITERAL, Stella_Object.cons(Stella.wrapInteger(0), Stella_Object.cons(Stella.NIL, Stella.NIL)))), otree);
      }
  ...
  public static Cons cppTranslateReturnTree(Cons tree) {
    { Cons otree = null;
      ...
      Stella_Object returnexpression = null;
      Cons translatedreturnexpression = Stella.NIL;
      boolean needtemporaryreturnvariableP = Stella.FALSE;
      ...
      { int parameternum = Stella.NULL_INTEGER;
        ...
        while (!(iter000 == Stella.NIL)) {
          ...
          if (!Stella_Object.sideEffectFreeExpressionP(exp)) {
            needtemporaryreturnvariableP = Stella.TRUE;
          }
  ...
  public static Cons cppTranslateMakeTree(Cons tree) {
    { Symbol classname = ((Symbol)(tree.rest.value));
      ...
      if (nativetype == null) {
        ...
        return (Stella.list$(Stella_Object.cons(Stella.SYM_STELLA_CPP_MAKE, Stella_Object.cons(Stella.list$(Stella_Object.cons(Stella.SYM_STELLA_CPP_IDENT, Stella_Object.cons(Stella.wrapString(Stella.cppUnpointerizeNativeType(nativetype)), Stella_Object.cons(Stella.NIL, Stella.NIL)))), Stella_Object.cons(arguments, Stella_Object.cons(Stella.NIL, Stella.NIL))))));
      }
      else {
        return (Stella.list$(Stella_Object.cons(Stella.SYM_STELLA_CPP_FUNCTION_CALL, Stella_Object.cons(Stella.list$(Stella_Object.cons(Stella.SYM_STELLA_CPP_IDENT, Stella_Object.cons(Stella.wrapString(nativetype), Stella_Object.cons(Stella.NIL, Stella.NIL)))), Stella_Object.cons(arguments, Stella_Object.cons(Stella.NIL, Stella.NIL))))));
      }
    }
  }
  ...
  public static Stella_Object cppTranslateBadSys(Cons tree) {
    { Stella_Object returntype = tree.rest.rest.value;
      ...
      if (returntype == Stella.SGT_STELLA_VOID) {
        return (Stella.list$(Stella_Object.cons(Stella.SYM_STELLA_CPP_FUNCTION_CALL, Stella_Object.cons(Stella.list$(Stella_Object.cons(Stella.SYM_STELLA_CPP_IDENT, Stella_Object.cons(Stella.wrapString("illegal_stella_statement_flagged_by_the_translator"), Stella_Object.cons(Stella.NIL, Stella.NIL)))), Stella_Object.cons(Stella.NIL, Stella.NIL)))));
      }
      else {
        return (Stella.list$(Stella_Object.cons(Stella.SYM_STELLA_CPP_IDENT, Stella_Object.cons(Stella.wrapString("illegal_stella_expression_flagged_by_the_translator"), Stella_Object.cons(Stella.NIL, Stella.NIL)))));
      }
    }
  }
  ...
  public static Cons cppTranslateNewArray(Cons tree) {
    { ParametricTypeSpecifier arraytype = ((ParametricTypeSpecifier)(tree.rest.value));
      ...
      return (Stella.list$(Stella_Object.cons(Stella.SYM_STELLA_CPP_FUNCTION_CALL, Stella_Object.cons(Stella.list$(Stella_Object.cons(Stella.SYM_STELLA_CPP_IDENT, Stella_Object.cons((Stella.cppUseGarbageCollectorP() ? Stella.wrapString("new (GC)") : Stella.wrapString("new")), Stella_Object.cons(Stella.NIL, Stella.NIL)))), Stella_Object.cons(Stella.list$(Stella_Object.cons(Stella.SYM_STELLA_CPP_ACTUALS, Stella_Object.cons(Stella.list$(Stella_Object.cons(Stella.SYM_STELLA_CPP_ARRAY_REFERENCE, Stella_Object.cons(Stella.list$(Stella_Object.cons(Stella.SYM_STELLA_CPP_IDENT, Stella_Object.cons(StandardObject.cppTranslateAndPointerizeTypeSpec(elementtype), Stella_Object.cons(Stella.NIL, Stella.NIL)))), Stella_Object.cons(dimensions.concatenate(Stella.NIL, Stella.NIL), Stella.NIL)))), Stella_Object.cons(Stella.NIL, Stella.NIL)))), Stella_Object.cons(Stella.NIL, Stella.NIL))))));
    }
  }
  ...
  public static Cons cppTranslateSysPointerToFunction(Cons tree) {
    { String functionname = Symbol.cppTranslateName(((Symbol)(tree.rest.value))).wrapperValue;
      ...
      otree = Stella.list$(Stella_Object.cons(Stella.SYM_STELLA_CPP_FUNCTION_POINTER, Stella_Object.cons(Stella.wrapString(functionname), Stella_Object.cons(Stella.NIL, Stella.NIL))));
      return (otree);
    }
  }
  ...
  public static Cons cppTranslateTheCode(Cons tree) {
    { Cons otree = null;
      ...
      { GeneralizedSymbol testValue000 = ((GeneralizedSymbol)(tree.rest.value));
        ...
        if (testValue000 == Stella.KWD_FUNCTION) {
          otree = Stella.list$(Stella_Object.cons(Stella.SYM_STELLA_CPP_CAST, Stella_Object.cons(Stella.list$(Stella_Object.cons(Stella.SYM_STELLA_CPP_FUNCTION_POINTER, Stella_Object.cons(Symbol.cppTranslateFunctionNameFromName(((Symbol)(tree.rest.rest.value))), Stella_Object.cons(Stella.NIL, Stella.NIL)))), Stella_Object.cons(Stella.wrapString("cpp_function_code"), Stella_Object.cons(Stella.NIL, Stella.NIL)))));
        }
        else if (testValue000 == Stella.KWD_METHOD) {
          otree = Stella.list$(Stella_Object.cons(Stella.SYM_STELLA_CPP_CAST, Stella_Object.cons(Stella.list$(Stella_Object.cons(Stella.SYM_STELLA_CPP_METHOD_POINTER, Stella_Object.cons(Symbol.cppTranslateMethodNameFromName(((Symbol)(tree.fourth())), ((StandardObject)(tree.rest.rest.value))), Stella_Object.cons(Stella.NIL, Stella.NIL)))), Stella_Object.cons(Stella.wrapString("cpp_method_code"), Stella_Object.cons(Stella.NIL, Stella.NIL)))));
        }
        else {
          { OutputStringStream stream000 = OutputStringStream.newOutputStringStream();
  ...
  public static Cons cppTranslateForeachTree(Cons tree) {
    { Cons iteratorbindings = ((Cons)(tree.rest.value));
      Cons cursorbindings = ((Cons)(tree.rest.rest.value));
      Stella_Object continuationtest = Stella_Object.cppTranslateATree(tree.fourth());
      Cons body = Cons.cppTranslateListOfTrees(tree.nthRest(4));
      ...
      { Cons binding = null;
        ...
        while (!(iter000 == Stella.NIL)) {
          ...
          nextassignments = Stella_Object.cons(Stella_Object.cppTranslateATree(binding.rest.rest.value), nextassignments);
          declaration = Stella_Object.cons(StandardObject.cppTranslateAndPointerizeTypeSpec(((StandardObject)(binding.rest.value))), Stella_Object.cons(Stella_Object.cppTranslateATree(binding.value), Stella_Object.cons(Stella_Object.cppTranslateATree(Surrogate.typeToWalkedNullValueTree(StandardObject.typeSpecToBaseType(((StandardObject)(binding.rest.value))))), Stella.NIL)));
          if (collect000 == null) {
            {
      ...
      { Cons binding = null;
        ...
        loop001 : while (!(iter001 == Stella.NIL)) {
          ...
          if (StandardObject.subTypeSpecOfP(((StandardObject)(binding.rest.value)), Stella.SGT_STELLA_ARGUMENT_LIST_ITERATOR)) {
            ...
            declarations = declarations.concatenate(Symbol.cppYieldVaIteratorDeclarations(varargsiterator), Stella.NIL);
            continue loop001;
          }
          else {
          ...
          if (collect001 == null) {
            {
              collect001 = Stella_Object.cons(declaration, Stella.NIL);
              if (declarations == Stella.NIL) {
                declarations = collect001;
              }
              else {
                Cons.addConsToEndOfConsList(declarations, collect001);
              }
            }
          }
          else {
            {
              collect001.rest = Stella_Object.cons(declaration, Stella.NIL);
              collect001 = collect001.rest;
            }
          }
        }
      }
      return (Stella.list$(Stella_Object.cons(Stella.SYM_STELLA_CPP_BLOCK, Stella_Object.cons(declarations, Stella_Object.cons(Stella_Object.cons(Stella_Object.cons(Stella.SYM_STELLA_CPP_STATEMENTS, (((varargsiterator != null) ? Symbol.cppYieldVaStartTree(varargsiterator) : Stella.NIL)).concatenate(Stella_Object.cons(Stella.list$(Stella_Object.cons(Stella.SYM_STELLA_CPP_FOREACH, Stella_Object.cons(continuationtest, Stella_Object.cons(Stella_Object.cons(nextassignments.reverse(), Stella_Object.cons(body, Stella.NIL)), Stella.NIL)))), (((varargsiterator != null) ? Symbol.cppYieldVaEndTree(varargsiterator) : Stella.NIL)).concatenate(Stella.NIL, Stella.NIL)), Stella.NIL)), Stella.NIL), Stella.NIL)))));
    }
  }
  ...
  public static Cons cppTranslateChooseTree(Cons tree) {
    return (Cons.cppTranslateOperatorCall(Stella_Object.cons(Stella.wrapString("?"), Stella_Object.cons(Stella.wrapString(":"), Stella.NIL)), tree.rest, 3));
  }
  ...
  public static Cons cppTranslateCast(Cons tree) {
    { Stella_Object expression = tree.rest.value;
      ...
      if (Surrogate.subtypeOfP(type, Stella.SGT_STELLA_FLOAT) &&
          Stella_Object.isaP(expression, Stella.SGT_STELLA_INTEGER_WRAPPER)) {
        return (((Cons)(Stella_Object.cppTranslateATree(Stella.wrapFloat(((double)(((IntegerWrapper)(expression)).wrapperValue)))))));
      }
      if (Surrogate.subtypeOfP(type, Stella.SGT_STELLA_INTEGER) &&
          Stella_Object.isaP(expression, Stella.SGT_STELLA_FLOAT_WRAPPER)) {
        return (((Cons)(Stella_Object.cppTranslateATree(Stella.wrapInteger(((int)(((FloatWrapper)(expression)).wrapperValue)))))));
      }
  ...
  public static Cons cppTranslateHandleException(Cons tree) {
    { Cons variabledecl = ((Cons)(tree.rest.value));
      ...
      if (variable != null) {
        helpervariable = Stella.wrapString("_" + Symbol.cppTranslateName(((Symbol)(variable))).wrapperValue);
        helpervariabletype = Stella.wrapString(Native.stringConcatenate(StandardObject.cppTranslateTypeSpec(((StandardObject)(exceptiontype))).wrapperValue, "&"));
      }
      ...
      if (variable != null) {
        tree.rest.rest = Stella_Object.cons(Stella.list$(Stella_Object.cons(Stella.SYM_STELLA_CPP_LOCAL, Stella_Object.cons(null, Stella_Object.cons(Stella_Object.cons(StandardObject.cppTranslateAndPointerizeTypeSpec(((StandardObject)(exceptiontype))), Stella.list$(Stella_Object.cons(Stella.list$(Stella_Object.cons(Stella.SYM_STELLA_CPP_IDENT, Stella_Object.cons(Symbol.cppTranslateName(((Symbol)(variable))), Stella_Object.cons(Stella.NIL, Stella.NIL)))), Stella_Object.cons(Stella.list$(Stella_Object.cons(Stella.SYM_STELLA_CPP_IDENT, Stella_Object.cons(Stella.wrapString(Native.stringConcatenate("&", helpervariable.wrapperValue)), Stella_Object.cons(Stella.NIL, Stella.NIL)))), Stella_Object.cons(Stella.NIL, Stella.NIL))))), Stella.NIL)))), tree.rest.rest.concatenate(Stella.NIL, Stella.NIL));
      }
      return (tree);
    }
  }
            ...
            switch (body.charAt(cursor)) {
              case '/': 
                { InputStringStream comment = InputStringStream.newInputStringStream(Native.string_subsequence(body, cursor, Stella.NULL_INTEGER));
                  ...
                  cursor = cursor + (InputStream.readLine(comment, new Object[1])).length();
                }
              break;
              case '*': 
...
;
          ...
          { int i = Stella.NULL_INTEGER;
            ...
            loop002 : while (iter001 <= upperBound000) {
              {
                i = iter001;
                iter001 = iter001 + 1;
              }
          ...
          parameterposition = parameters.position(Stella.wrapString(Native.string_subsequence(body, cursor, end)), Stella.NULL_INTEGER);
          if (parameterposition != Stella.NULL_INTEGER) {
            result = Stella_Object.cons(Stella.wrapString(Native.string_subsequence(body, bodystart, cursor)), result);
            result = Stella_Object.cons(Stella_Object.cons(parameters.nth(parameterposition), Stella_Object.cons(Stella.wrapInteger(parameterposition), Stella.NIL)), result);
            bodystart = end;
          }
          cursor = end;
        }
      ...
      if (bodystart < bodylength) {
        result = Stella_Object.cons(Stella.wrapString(Native.string_subsequence(body, bodystart, bodylength)), result);
      }
  ...
  public static Cons cppTranslateInlineTree(Cons tree) {
    tree = tree;
    return (Stella.list$(Stella_Object.cons(Stella.SYM_STELLA_CPP_COMMENT, Stella_Object.cons(Stella.wrapString("inline method"), Stella_Object.cons(Stella.NIL, Stella.NIL)))));
  }
    ...
    { Cons odeclarations = Stella.NIL;
      ...
      { Cons declaration = null;
        ...
        while (!(iter000 == Stella.NIL)) {
          ...
          if (collect000 == null) {
            {
              collect000 = Stella_Object.cons(Stella.list$(Stella_Object.cons(Stella.SYM_STELLA_CPP_FUNCTION_CALL, Stella_Object.cons(Stella.list$(Stella_Object.cons(Stella.SYM_STELLA_CPP_IDENT, Stella_Object.cons(Stella.wrapString("BIND_STELLA_SPECIAL"), Stella_Object.cons(Stella.NIL, Stella.NIL)))), Stella_Object.cons(Stella.list$(Stella_Object.cons(Stella.SYM_STELLA_CPP_ACTUALS, Stella_Object.cons(Stella.list$(Stella_Object.cons(Stella.SYM_STELLA_CPP_IDENT, Stella_Object.cons(Symbol.cppTranslateGlobalName(Symbol.cppFixupNameSymbol(variablename, variable.homeModule())), Stella_Object.cons(Stella.NIL, Stella.NIL)))), Stella_Object.cons(Stella.list$(Stella_Object.cons(Stella.SYM_STELLA_CPP_IDENT, Stella_Object.cons(StandardObject.cppTranslateAndPointerizeTypeSpec(type), Stella_Object.cons(Stella.NIL, Stella.NIL)))), Stella_Object.cons(Stella_Object.cppTranslateATree(initialvaluetree), Stella_Object.cons(Stella.NIL, Stella.NIL)))))), Stella_Object.cons(Stella.NIL, Stella.NIL))))), Stella.NIL);
            ...
            {
              collect000.rest = Stella_Object.cons(Stella.list$(Stella_Object.cons(Stella.SYM_STELLA_CPP_FUNCTION_CALL, Stella_Object.cons(Stella.list$(Stella_Object.cons(Stella.SYM_STELLA_CPP_IDENT, Stella_Object.cons(Stella.wrapString("BIND_STELLA_SPECIAL"), Stella_Object.cons(Stella.NIL, Stella.NIL)))), Stella_Object.cons(Stella.list$(Stella_Object.cons(Stella.SYM_STELLA_CPP_ACTUALS, Stella_Object.cons(Stella.list$(Stella_Object.cons(Stella.SYM_STELLA_CPP_IDENT, Stella_Object.cons(Symbol.cppTranslateGlobalName(Symbol.cppFixupNameSymbol(variablename, variable.homeModule())), Stella_Object.cons(Stella.NIL, Stella.NIL)))), Stella_Object.cons(Stella.list$(Stella_Object.cons(Stella.SYM_STELLA_CPP_IDENT, Stella_Object.cons(StandardObject.cppTranslateAndPointerizeTypeSpec(type), Stella_Object.cons(Stella.NIL, Stella.NIL)))), Stella_Object.cons(Stella_Object.cppTranslateATree(initialvaluetree), Stella_Object.cons(Stella.NIL, Stella.NIL)))))), Stella_Object.cons(Stella.NIL, Stella.NIL))))), Stella.NIL);
              collect000 = collect000.rest;
            }
          }
        }
  ...
  public static void prettyPrintDefinitionTree(Cons tree, OutputStream stream) {
    ...
    { Object old$PrintprettycodeP$000 = Stella.$PRINTPRETTYCODEp$.get();
      ...
      try {
        Native.setBooleanSpecial(Stella.$PRINTPRETTYCODEp$, Stella.TRUE);
  ...
  public static boolean compileAndLoadFiles(Cons files, Keyword language, boolean forcerecompilationP) {
    if (language == Stella.KWD_COMMON_LISP) {
      return (Cons.clCompileAndLoadFiles(files, Stella.TRUE, forcerecompilationP));
    }
    else {
      System.out.println("'compile-and-load-files' NOT IMPLEMENTED FOR " + language);
      return (Stella.FALSE);
    }
  }

  public static Cons filesPlusSystemStartup(Cons files) {
    return (files.concatenate(Stella.consList(Stella_Object.cons(Stella.wrapString(SystemDefinition.systemStartupFileName(null)), Stella.NIL)), Stella.NIL));
  }
    ...
    { Cons strings = Stella.NIL;
      ...
      { Stella_Object filespec = null;
        ...
        while (!(iter000 == Stella.NIL)) {
          ...
          strings = Stella_Object.cons(Stella.wrapString(Stella_Object.implodePathname(filespec)), strings);
        }
      }
    ...
    { Object old$Translationunits$000 = Stella.$TRANSLATIONUNITS$.get();
      ...
      try {
        ...
        { Keyword outputlanguage = ((Keyword)(Stella.$TRANSLATOROUTPUTLANGUAGE$.get()));
          ...
          boolean translatedfileP = Stella.FALSE;
            ...
            { StringWrapper file = null;
              ...
              loop000 : while (!(iter000 == Stella.NIL)) {
                ...
                if (forcetranslationP ||
                  ...
                  filename = Stella.makeFileName(file.wrapperValue, Stella.KWD_STELLA, Stella.TRUE);
          ...
          { StringWrapper file = null;
            ...
            loop001 : while (!(iter001 == Stella.NIL)) {
              ...
              if (forcetranslationP ||
                ...
                walkedunits.insertAt(Stella.wrapString(filename), ((List)(Stella.$TRANSLATIONUNITS$.get())));
                Native.setSpecial(Stella.$TRANSLATIONUNITS$, List.newList());
              }
            }
          }
        ...
        { Symbol operator000 = ((Symbol)(operator));
          ...
          { String testValue000 = (((Module)(Stella.$MODULE$.get())).caseSensitiveP ? Native.stringUpcase(operator000.symbolName) : operator000.symbolName);
            ...
            if (Stella.stringEqlP(testValue000, "IN-PACKAGE")) {
              { boolean _return_temp = Stella.TRUE;

                MV_returnarray[0] = Stella.wrapBoolean(seeninmoduleP);
                return (_return_temp);
              }
            }
...
;
      ...
      { boolean _return_temp = Stella.FALSE;
  ...
  public static String composeNamestringFull(Cons strings, String prefix, String suffix, Keyword outputcase, String outputseparator, StringHashTable translationtable, boolean useacronymheuristicsP) {
    { int n = 0;
      ...
      boolean firsttimeP = Stella.TRUE;
      String s = null;
      int sLen = 0;
  ...
  public static String composeNamestring(Cons nameComponents, Cons options) {
    { PropertyList self000 = PropertyList.newPropertyList();
      ...
      { PropertyList plist = self000;
        ...
        boolean useAcronymHeuristicsP = Stella.FALSE;
...
;
        ...
        case 1: 
          lookuptree = Stella_Object.cons(lookupfunction, Stella_Object.cons(memotablevar, Stella_Object.cons(inputargs.value, Stella.list$(Stella_Object.cons(Stella.SYM_STELLA_MEMOIZED_NULL_VALUE, Stella_Object.cons(Stella.SYM_STELLA_NULL, Stella_Object.cons(Stella.SYM_STELLA_NULL, Stella_Object.cons((alleqP ? Stella.wrapInteger(-1) : Stella.wrapInteger(eqvector)), Stella_Object.cons(Stella.NIL, Stella.NIL)))))))));
        break;
        case 2: 
          lookuptree = Stella_Object.cons(lookupfunction, Stella_Object.cons(memotablevar, Stella_Object.cons(inputargs.value, Stella_Object.cons(inputargs.rest.value, Stella.list$(Stella_Object.cons(Stella.SYM_STELLA_MEMOIZED_NULL_VALUE, Stella_Object.cons(Stella.SYM_STELLA_NULL, Stella_Object.cons((alleqP ? Stella.wrapInteger(-1) : Stella.wrapInteger(eqvector)), Stella_Object.cons(Stella.NIL, Stella.NIL)))))))));
        break;
        case 3: 
          lookuptree = Stella_Object.cons(lookupfunction, Stella_Object.cons(memotablevar, Stella_Object.cons(inputargs.value, Stella_Object.cons(inputargs.rest.value, Stella_Object.cons(inputargs.rest.rest.value, Stella.list$(Stella_Object.cons(Stella.SYM_STELLA_MEMOIZED_NULL_VALUE, Stella_Object.cons((alleqP ? Stella.wrapInteger(-1) : Stella.wrapInteger(eqvector)), Stella_Object.cons(Stella.NIL, Stella.NIL)))))))));
        break;
        case 4: 
          lookuptree = Stella_Object.cons(lookupfunction, Stella_Object.cons(memotablevar, Stella_Object.cons(inputargs.value, Stella_Object.cons(inputargs.rest.value, Stella_Object.cons(inputargs.rest.rest.value, Stella_Object.cons(inputargs.fourth(), Stella_Object.cons((alleqP ? Stella.wrapInteger(-1) : Stella.wrapInteger(eqvector)), Stella.NIL)))))));
        break;
        default:
          lookuptree = Stella_Object.cons(lookupfunction, Stella_Object.cons(memotablevar, Stella.list$(Stella_Object.cons(Stella_Object.cons(Stella.SYM_STELLA_CONS_LIST, inputargs.concatenate(Stella.NIL, Stella.NIL)), Stella_Object.cons((alleqP ? Stella.wrapInteger(-1) : Stella.wrapInteger(eqvector)), Stella_Object.cons(Stella.NIL, Stella.NIL))))));
        break;
      }
      return (Stella.list$(Stella_Object.cons(Stella.SYM_STELLA_VRLET, Stella_Object.cons(Stella.list$(Stella_Object.cons(Stella_Object.cons(memotablevar, Stella.list$(Stella_Object.cons(Stella.SYM_STELLA_MEMOIZATION_TABLE, Stella_Object.cons(Stella.list$(Stella_Object.cons(Stella.SYM_STELLA_SURROGATE_VALUE, Stella_Object.cons(memoname, Stella_Object.cons(Stella.NIL, Stella.NIL)))), Stella_Object.cons(Stella.NIL, Stella.NIL))))), Stella_Object.cons(Stella_Object.cons(memoentryvar, Stella.list$(Stella_Object.cons(Stella.SYM_STELLA_CONS, Stella_Object.cons(Stella.SYM_STELLA_NULL, Stella_Object.cons(Stella.NIL, Stella.NIL))))), Stella_Object.cons(Stella_Object.cons(memovaluevar, Stella.list$(Stella_Object.cons(Stella.SYM_STELLA_OBJECT, Stella_Object.cons(Stella.SYM_STELLA_NULL, Stella_Object.cons(Stella.NIL, Stella.NIL))))), Stella_Object.cons(Stella.NIL, Stella.NIL))))), Stella_Object.cons(Stella.list$(Stella_Object.cons(Stella.SYM_STELLA_WHEN, Stella_Object.cons(Stella.list$(Stella_Object.cons(Stella.SYM_STELLA_NULLp, Stella_Object.cons(memotablevar, Stella_Object.cons(Stella.NIL, Stella.NIL)))), Stella_Object.cons(Stella.list$(Stella_Object.cons(Stella.SYM_STELLA_INITIALIZE_MEMOIZATION_TABLE, Stella_Object.cons(memoname, Stella_Object.cons(Stella_Object.cons(Stella.wrapString(Native.stringify(options.thePlist)), Stella.NIL), Stella.NIL)))), Stella_Object.cons(Stella.list$(Stella_Object.cons(Stella.SYM_STELLA_SETQ, Stella_Object.cons(memotablevar, Stella_Object.cons(Stella_Object.cons(Stella.list$(Stella_Object.cons(Stella.SYM_STELLA_SURROGATE_VALUE, Stella_Object.cons(memoname, Stella_Object.cons(Stella.NIL, Stella.NIL)))), Stella.NIL), Stella.NIL)))), Stella_Object.cons(Stella.NIL, Stella.NIL)))))), Stella_Object.cons(Stella.list$(Stella_Object.cons(Stella.SYM_STELLA_WHEN, Stella_Object.cons(Stella.SYM_STELLA_$MEMOIZATION_ENABLEDp$, Stella_Object.cons(Stella.list$(Stella_Object.cons(Stella.SYM_STELLA_SETQ, Stella_Object.cons(memoentryvar, Stella_Object.cons(Stella_Object.cons(lookuptree, Stella.NIL), Stella.NIL)))), Stella_Object.cons(Stella.list$(Stella_Object.cons(Stella.SYM_STELLA_SETQ, Stella_Object.cons(memovaluevar, Stella_Object.cons(Stella_Object.cons(Stella.list$(Stella_Object.cons(Stella.SYM_STELLA_FIRST, Stella_Object.cons(memoentryvar, Stella_Object.cons(Stella.NIL, Stella.NIL)))), Stella.NIL), Stella.NIL)))), Stella_Object.cons(Stella.NIL, Stella.NIL)))))), Stella_Object.cons(Stella.list$(Stella_Object.cons(Stella.SYM_STELLA_COND, Stella_Object.cons(Stella.list$(Stella_Object.cons(Stella.list$(Stella_Object.cons(Stella.SYM_STELLA_DEFINEDp, Stella_Object.cons(memovaluevar, Stella_Object.cons(Stella.NIL, Stella.NIL)))), Stella_Object.cons(Stella.list$(Stella_Object.cons(Stella.SYM_STELLA_WHEN, Stella_Object.cons(Stella.list$(Stella_Object.cons(Stella.SYM_STELLA_EQLp, Stella_Object.cons(memovaluevar, Stella_Object.cons(Stella_Object.cons(Stella.SYM_STELLA_MEMOIZED_NULL_VALUE, Stella.NIL), Stella.NIL)))), Stella_Object.cons(Stella.list$(Stella_Object.cons(Stella.SYM_STELLA_SETQ, Stella_Object.cons(memovaluevar, Stella_Object.cons(Stella_Object.cons(Stella.SYM_STELLA_NULL, Stella.NIL), Stella.NIL)))), Stella_Object.cons(Stella.NIL, Stella.NIL))))), Stella_Object.cons(Stella.NIL, Stella.NIL)))), Stella_Object.cons(Stella.list$(Stella_Object.cons(Stella.SYM_STELLA_OTHERWISE, Stella_Object.cons(Stella.list$(Stella_Object.cons(Stella.SYM_STELLA_SETQ, Stella_Object.cons(memovaluevar, Stella_Object.cons(body.concatenate(Stella.NIL, Stella.NIL), Stella.NIL)))), Stella_Object.cons(Stella.list$(Stella_Object.cons(Stella.SYM_STELLA_WHEN, Stella_Object.cons(Stella.SYM_STELLA_$MEMOIZATION_ENABLEDp$, Stella_Object.cons(Stella.list$(Stella_Object.cons(Stella.SYM_STELLA_SETF, Stella_Object.cons(Stella.list$(Stella_Object.cons(Stella.SYM_STELLA_VALUE, Stella_Object.cons(memoentryvar, Stella_Object.cons(Stella.NIL, Stella.NIL)))), Stella_Object.cons(Stella.list$(Stella_Object.cons(Stella.SYM_STELLA_CHOOSE, Stella_Object.cons(Stella.list$(Stella_Object.cons(Stella.SYM_STELLA_NULLp, Stella_Object.cons(memovaluevar, Stella_Object.cons(Stella.NIL, Stella.NIL)))), Stella_Object.cons(Stella.SYM_STELLA_MEMOIZED_NULL_VALUE, Stella_Object.cons(memovaluevar, Stella_Object.cons(Stella.NIL, Stella.NIL)))))), Stella_Object.cons(Stella.NIL, Stella.NIL))))), Stella_Object.cons(Stella.NIL, Stella.NIL))))), Stella_Object.cons(Stella.NIL, Stella.NIL))))), Stella_Object.cons(Stella.NIL, Stella.NIL))))), Stella_Object.cons(memovaluevar, Stella_Object.cons(Stella.NIL, Stella.NIL)))))))));
    }
  }
      ...
      if (eqvector < 0) {
        ...
        loop002 : while (!(entries == Stella.NIL)) {
          ...
          { Stella_Object inputarg = null;
            ...
            loop003 : while ((!(iter002 == Stella.NIL)) &&
                (!(iter003 == Stella.NIL))) {
              {
        ...
        { PropertyList options = self000;
          ...
          if (!processcmdlineargsP) {
            if (((Keyword)(Stella.$TRANSLATOROUTPUTLANGUAGE$.get())) == Stella.KWD_COMMON_LISP) {
              return (Stella.list$(Stella_Object.cons(Stella.SYM_STELLA_DEFUN, Stella_Object.cons(Stella.SYM_STELLA_MAIN, Stella_Object.cons(Stella.NIL, Stella_Object.cons(Stella.KWD_PUBLICp, Stella_Object.cons(Stella.SYM_STELLA_TRUE, Stella_Object.cons(startupfunctioncall.concatenate(body.concatenate(Stella.NIL, Stella.NIL), Stella.NIL), Stella.NIL))))))));
            }
              ...
              return (Stella.list$(Stella_Object.cons(Stella.SYM_STELLA_DEFUN, Stella_Object.cons(Stella.list$(Stella_Object.cons(Stella.SYM_STELLA_MAIN, Stella_Object.cons(Stella.SYM_STELLA_INTEGER, Stella_Object.cons(Stella.NIL, Stella.NIL)))), Stella_Object.cons(Stella.NIL, Stella_Object.cons(Stella.KWD_PUBLICp, Stella_Object.cons(Stella.SYM_STELLA_TRUE, Stella_Object.cons(startupfunctioncall.concatenate(body.concatenate(Stella_Object.cons(Stella.list$(Stella_Object.cons(Stella.SYM_STELLA_RETURN, Stella_Object.cons(Stella.wrapInteger(1), Stella_Object.cons(Stella.NIL, Stella.NIL)))), Stella.NIL), Stella.NIL), Stella.NIL), Stella.NIL))))))));
            }
            else if (((Keyword)(Stella.$TRANSLATOROUTPUTLANGUAGE$.get())) == Stella.KWD_JAVA) {
              return (Stella.list$(Stella_Object.cons(Stella.SYM_STELLA_DEFUN, Stella_Object.cons(Stella.SYM_STELLA_MAIN, Stella_Object.cons(Stella_Object.cons(Stella_Object.cons(Stella.localGensym("ARGV"), Stella_Object.cons(Stella.list$(Stella_Object.cons(Stella.SYM_STELLA_ARRAY, Stella_Object.cons(Stella.NIL, Stella_Object.cons(Stella.SYM_STELLA_OF, Stella_Object.cons(Stella.SYM_STELLA_STRING, Stella_Object.cons(Stella.NIL, Stella.NIL)))))), Stella.NIL)), Stella.NIL), Stella_Object.cons(Stella.KWD_PUBLICp, Stella_Object.cons(Stella.SYM_STELLA_TRUE, Stella_Object.cons(startupfunctioncall.concatenate(body.concatenate(Stella.NIL, Stella.NIL), Stella.NIL), Stella.NIL))))))));
            }
            else {
            }
          }
            ...
            if (((Keyword)(Stella.$TRANSLATOROUTPUTLANGUAGE$.get())) == Stella.KWD_COMMON_LISP) {
              return (Stella.list$(Stella_Object.cons(Stella.SYM_STELLA_DEFUN, Stella_Object.cons(Stella.SYM_STELLA_MAIN, Stella_Object.cons(Stella.list$(Stella_Object.cons(Stella.SYM_STELLA_aREST, Stella_Object.cons(Stella.list$(Stella_Object.cons(Stella.SYM_STELLA_rrARGS, Stella_Object.cons(Stella.SYM_STELLA_STRING, Stella_Object.cons(Stella.NIL, Stella.NIL)))), Stella_Object.cons(Stella.NIL, Stella.NIL)))), Stella_Object.cons(Stella.KWD_PUBLICp, Stella_Object.cons(Stella.SYM_STELLA_TRUE, Stella_Object.cons(Stella.list$(Stella_Object.cons(Stella.SYM_STELLA_LET, Stella_Object.cons(Stella.list$(Stella_Object.cons(Stella_Object.cons(v1Name, Stella.list$(Stella_Object.cons(Stella.SYM_STELLA_INTEGER, Stella_Object.cons(Stella.list$(Stella_Object.cons(Stella.SYM_STELLA_VERBATIM, Stella_Object.cons(Stella.KWD_COMMON_LISP, Stella_Object.cons(Stella.list$(Stella_Object.cons(Stella.internCommonLispSymbol("LENGTH"), Stella_Object.cons(Stella.SYM_STELLA_rrARGS, Stella_Object.cons(Stella.NIL, Stella.NIL)))), Stella_Object.cons(Stella.NIL, Stella.NIL))))), Stella_Object.cons(Stella.NIL, Stella.NIL))))), Stella_Object.cons(Stella_Object.cons(v2Name, Stella.list$(Stella_Object.cons(Stella.list$(Stella_Object.cons(Stella.SYM_STELLA_ARRAY, Stella_Object.cons(Stella.NIL, Stella_Object.cons(Stella.SYM_STELLA_OF, Stella_Object.cons(Stella.SYM_STELLA_STRING, Stella_Object.cons(Stella.NIL, Stella.NIL)))))), Stella_Object.cons(Stella.list$(Stella_Object.cons(Stella.SYM_STELLA_VERBATIM, Stella_Object.cons(Stella.KWD_COMMON_LISP, Stella_Object.cons(Stella.list$(Stella_Object.cons(Stella.internCommonLispSymbol("MAKE-ARRAY"), Stella_Object.cons(Stella.list$(Stella_Object.cons(Stella.internCommonLispSymbol("LENGTH"), Stella_Object.cons(Stella.SYM_STELLA_rrARGS, Stella_Object.cons(Stella.NIL, Stella.NIL)))), Stella_Object.cons(Stella.KWD_INITIAL_CONTENTS, Stella_Object.cons(Stella.SYM_STELLA_rrARGS, Stella_Object.cons(Stella.NIL, Stella.NIL)))))), Stella_Object.cons(Stella.NIL, Stella.NIL))))), Stella_Object.cons(Stella.NIL, Stella.NIL))))), Stella_Object.cons(Stella.NIL, Stella.NIL)))), Stella_Object.cons(startupfunctioncall.concatenate(body.concatenate(Stella.NIL, Stella.NIL), Stella.NIL), Stella.NIL)))), Stella_Object.cons(Stella.NIL, Stella.NIL)))))))));
            }
            else if (((Keyword)(Stella.$TRANSLATOROUTPUTLANGUAGE$.get())) == Stella.KWD_JAVA) {
              return (Stella.list$(Stella_Object.cons(Stella.SYM_STELLA_DEFUN, Stella_Object.cons(Stella.SYM_STELLA_MAIN, Stella_Object.cons(Stella_Object.cons(Stella_Object.cons(v2Name, Stella_Object.cons(Stella.list$(Stella_Object.cons(Stella.SYM_STELLA_ARRAY, Stella_Object.cons(Stella.NIL, Stella_Object.cons(Stella.SYM_STELLA_OF, Stella_Object.cons(Stella.SYM_STELLA_STRING, Stella_Object.cons(Stella.NIL, Stella.NIL)))))), Stella.NIL)), Stella.NIL), Stella_Object.cons(Stella.KWD_PUBLICp, Stella_Object.cons(Stella.SYM_STELLA_TRUE, Stella_Object.cons(Stella.list$(Stella_Object.cons(Stella.SYM_STELLA_LET, Stella_Object.cons(Stella_Object.cons(Stella_Object.cons(v1Name, Stella.list$(Stella_Object.cons(Stella.SYM_STELLA_INTEGER, Stella_Object.cons(Stella.list$(Stella_Object.cons(Stella.SYM_STELLA_VERBATIM, Stella_Object.cons(Stella.KWD_JAVA, Stella_Object.cons(Stella.wrapString(Symbol.javaTranslateName(v2Name).wrapperValue + ".length"), Stella_Object.cons(Stella.NIL, Stella.NIL))))), Stella_Object.cons(Stella.NIL, Stella.NIL))))), Stella.NIL), Stella_Object.cons(startupfunctioncall.concatenate(body.concatenate(Stella.NIL, Stella.NIL), Stella.NIL), Stella.NIL)))), Stella_Object.cons(Stella.NIL, Stella.NIL)))))))));
            }
            else if ((((Keyword)(Stella.$TRANSLATOROUTPUTLANGUAGE$.get())) == Stella.KWD_CPP) ||
                ((((Keyword)(Stella.$TRANSLATOROUTPUTLANGUAGE$.get())) == Stella.KWD_CPP_STANDALONE) ||
                 (((Keyword)(Stella.$TRANSLATOROUTPUTLANGUAGE$.get())) == Stella.KWD_IDL))) {
              return (Stella.list$(Stella_Object.cons(Stella.SYM_STELLA_DEFUN, Stella_Object.cons(Stella.list$(Stella_Object.cons(Stella.SYM_STELLA_MAIN, Stella_Object.cons(Stella.SYM_STELLA_INTEGER, Stella_Object.cons(Stella.NIL, Stella.NIL)))), Stella_Object.cons(Stella.list$(Stella_Object.cons(Stella_Object.cons(v1Name, Stella_Object.cons(Stella.SYM_STELLA_INTEGER, Stella.NIL)), Stella_Object.cons(Stella_Object.cons(v2Name, Stella_Object.cons(Stella.list$(Stella_Object.cons(Stella.SYM_STELLA_ARRAY, Stella_Object.cons(Stella.NIL, Stella_Object.cons(Stella.SYM_STELLA_OF, Stella_Object.cons(Stella.SYM_STELLA_STRING, Stella_Object.cons(Stella.NIL, Stella.NIL)))))), Stella.NIL)), Stella_Object.cons(Stella.NIL, Stella.NIL)))), Stella_Object.cons(Stella.KWD_PUBLICp, Stella_Object.cons(Stella.SYM_STELLA_TRUE, Stella_Object.cons(startupfunctioncall.concatenate(body.concatenate(Stella_Object.cons(Stella.list$(Stella_Object.cons(Stella.SYM_STELLA_RETURN, Stella_Object.cons(Stella.wrapInteger(1), Stella_Object.cons(Stella.NIL, Stella.NIL)))), Stella.NIL), Stella.NIL), Stella.NIL), Stella.NIL))))))));
            }
            else {
            }
          }
  ...
  public static Cons processAttributeList(Cons reverseattributelist, XmlElement element, KvCons namespaceTable) {
    ...
    { Cons attributelist = Stella.NIL;
      ...
      while (!(reverseattributelist == Stella.NIL)) {
        ...
        reverseattributelist = reverseattributelist.rest;
        conscell = new Cons();
        if (Stella.xmlnsAttributeP(attributename)) {
...
;
    ...
    { Stella_Object savestreamstateP = options.value;
      ...
      return (Stella.list$(Stella_Object.cons(Stella.SYM_STELLA_PROGN, Stella_Object.cons(Stella.list$(Stella_Object.cons(Stella.SYM_STELLA_SETQ, Stella_Object.cons(Stella.SYM_STELLA_TOK_TOKENSTART_, Stella_Object.cons(Stella.wrapInteger(-1), Stella_Object.cons(Stella.NIL, Stella.NIL))))), Stella_Object.cons(Stella.list$(Stella_Object.cons(Stella.SYM_STELLA_LOOP, Stella_Object.cons((Stella.withTokenizerStringInputP() ? Stella.list$(Stella_Object.cons(Stella.SYM_STELLA_WHEN, Stella_Object.cons(Stella.list$(Stella_Object.cons(Stella.SYM_STELLA_e, Stella_Object.cons(Stella.SYM_STELLA_TOK_CURSOR_, Stella_Object.cons(Stella.SYM_STELLA_TOK_END_, Stella_Object.cons(Stella.NIL, Stella.NIL))))), Stella_Object.cons(Stella.list$(Stella_Object.cons(Stella.SYM_STELLA_COND, Stella_Object.cons(Stella.list$(Stella_Object.cons(Stella.list$(Stella_Object.cons(Stella.SYM_STELLA_e, Stella_Object.cons(Stella.SYM_STELLA_TOK_NEXTSTATE_, Stella_Object.cons(Stella.wrapInteger(-1), Stella_Object.cons(Stella.NIL, Stella.NIL))))), Stella_Object.cons(Stella.list$(Stella_Object.cons(Stella.SYM_STELLA_SETQ, Stella_Object.cons(Stella.SYM_STELLA_TOK_ENDOFTOKENSp_, Stella_Object.cons(Stella.SYM_STELLA_TRUE, Stella_Object.cons(Stella.NIL, Stella.NIL))))), Stella_Object.cons(Stella.NIL, Stella.NIL)))), Stella_Object.cons(Stella.list$(Stella_Object.cons(Stella.list$(Stella_Object.cons(Stella.SYM_STELLA_NTH, Stella_Object.cons(Stella.list$(Stella_Object.cons(Stella.SYM_STELLA_LEGAL_EOF_STATES, Stella_Object.cons(Stella.SYM_STELLA_TOK_TABLE_, Stella_Object.cons(Stella.NIL, Stella.NIL)))), Stella_Object.cons(Stella.SYM_STELLA_TOK_STATE_, Stella_Object.cons(Stella.NIL, Stella.NIL))))), Stella_Object.cons(Stella.list$(Stella_Object.cons(Stella.SYM_STELLA_SETQ, Stella_Object.cons(Stella.SYM_STELLA_TOK_NEXTSTATE_, Stella_Object.cons(Stella.wrapInteger(-1), Stella_Object.cons(Stella.NIL, Stella.NIL))))), Stella_Object.cons(Stella.list$(Stella_Object.cons(Stella.SYM_STELLA_WHEN, Stella_Object.cons(Stella.list$(Stella_Object.cons(Stella.SYM_STELLA_e, Stella_Object.cons(Stella.SYM_STELLA_TOK_TOKENSTART_, Stella_Object.cons(Stella.wrapInteger(-1), Stella_Object.cons(Stella.NIL, Stella.NIL))))), Stella_Object.cons(Stella.list$(Stella_Object.cons(Stella.SYM_STELLA_SETQ, Stella_Object.cons(Stella.SYM_STELLA_TOK_ENDOFTOKENSp_, Stella_Object.cons(Stella.SYM_STELLA_TRUE, Stella_Object.cons(Stella.NIL, Stella.NIL))))), Stella_Object.cons(Stella.NIL, Stella.NIL))))), Stella_Object.cons(Stella.NIL, Stella.NIL))))), Stella_Object.cons(Stella.list$(Stella_Object.cons(Stella.SYM_STELLA_OTHERWISE, Stella_Object.cons(Stella.list$(Stella_Object.cons(Stella.SYM_STELLA_SETQ, Stella_Object.cons(Stella.SYM_STELLA_TOK_STATE_, Stella_Object.cons(Stella.wrapInteger(0), Stella_Object.cons(Stella.NIL, Stella.NIL))))), Stella_Object.cons(Stella.list$(Stella_Object.cons(Stella.SYM_STELLA_SETQ, Stella_Object.cons(Stella.SYM_STELLA_TOK_NEXTSTATE_, Stella_Object.cons(Stella.wrapInteger(-1), Stella_Object.cons(Stella.NIL, Stella.NIL))))), Stella_Object.cons(Stella.NIL, Stella.NIL))))), Stella_Object.cons(Stella.NIL, Stella.NIL)))))), Stella_Object.cons(Stella_Object.cons(Stella.SYM_STELLA_BREAK, Stella.NIL), Stella_Object.cons(Stella.NIL, Stella.NIL)))))) : Stella.list$(Stella_Object.cons(Stella.SYM_STELLA_WHEN, Stella_Object.cons(Stella.list$(Stella_Object.cons(Stella.SYM_STELLA_e, Stella_Object.cons(Stella.SYM_STELLA_TOK_CURSOR_, Stella_Object.cons(Stella.SYM_STELLA_TOK_CHECKPOINT_, Stella_Object.cons(Stella.NIL, Stella.NIL))))), Stella_Object.cons(Stella.list$(Stella_Object.cons(Stella.SYM_STELLA_COND, Stella_Object.cons(Stella.list$(Stella_Object.cons(Stella.list$(Stella_Object.cons(Stella.SYM_STELLA_e, Stella_Object.cons(Stella.SYM_STELLA_TOK_CURSOR_, Stella_Object.cons(Stella.SYM_STELLA_TOK_END_, Stella_Object.cons(Stella.NIL, Stella.NIL))))), Stella_Object.cons(Stella.list$(Stella_Object.cons(Stella.SYM_STELLA_SETF, Stella_Object.cons(Stella.list$(Stella_Object.cons(Stella.SYM_STELLA_CURSOR, Stella_Object.cons(Stella.SYM_STELLA_TOK_STREAMSTATE_, Stella_Object.cons(Stella.NIL, Stella.NIL)))), Stella_Object.cons(Stella.SYM_STELLA_TOK_CURSOR_, Stella_Object.cons(Stella.NIL, Stella.NIL))))), Stella_Object.cons(Stella.list$(Stella_Object.cons(Stella.SYM_STELLA_SETQ, Stella_Object.cons(Stella.SYM_STELLA_TOK_ENDOFTOKENSp_, Stella_Object.cons(Stella.list$(Stella_Object.cons(Stella.SYM_STELLA_READ_INTO_TOKENIZER_BUFFER, Stella_Object.cons(Stella.SYM_STELLA_TOK_INPUTSTREAM_, Stella_Object.cons(Stella.SYM_STELLA_TOK_STREAMSTATE_, Stella_Object.cons(Stella.SYM_STELLA_TOK_TOKENSTART_, Stella_Object.cons(Stella.NIL, Stella.NIL)))))), Stella_Object.cons(Stella.NIL, Stella.NIL))))), Stella_Object.cons(Stella.list$(Stella_Object.cons(Stella.SYM_STELLA_SETQ, Stella_Object.cons(Stella.SYM_STELLA_TOK_BUFFER_, Stella_Object.cons(Stella.list$(Stella_Object.cons(Stella.SYM_STELLA_BUFFER, Stella_Object.cons(Stella.SYM_STELLA_TOK_STREAMSTATE_, Stella_Object.cons(Stella.NIL, Stella.NIL)))), Stella_Object.cons(Stella.NIL, Stella.NIL))))), Stella_Object.cons(Stella.list$(Stella_Object.cons(Stella.SYM_STELLA_SETQ, Stella_Object.cons(Stella.SYM_STELLA_TOK_SIZE_, Stella_Object.cons(Stella.list$(Stella_Object.cons(Stella.SYM_STELLA_BUFFER_SIZE, Stella_Object.cons(Stella.SYM_STELLA_TOK_STREAMSTATE_, Stella_Object.cons(Stella.NIL, Stella.NIL)))), Stella_Object.cons(Stella.NIL, Stella.NIL))))), Stella_Object.cons(Stella.list$(Stella_Object.cons(Stella.SYM_STELLA_SETQ, Stella_Object.cons(Stella.SYM_STELLA_TOK_CURSOR_, Stella_Object.cons(Stella.list$(Stella_Object.cons(Stella.SYM_STELLA_MOD, Stella_Object.cons(Stella.list$(Stella_Object.cons(Stella.SYM_STELLA_CURSOR, Stella_Object.cons(Stella.SYM_STELLA_TOK_STREAMSTATE_, Stella_Object.cons(Stella.NIL, Stella.NIL)))), Stella_Object.cons(Stella.SYM_STELLA_TOK_SIZE_, Stella_Object.cons(Stella.NIL, Stella.NIL))))), Stella_Object.cons(Stella.NIL, Stella.NIL))))), Stella_Object.cons(Stella.list$(Stella_Object.cons(Stella.SYM_STELLA_SETQ, Stella_Object.cons(Stella.SYM_STELLA_TOK_END_, Stella_Object.cons(Stella.list$(Stella_Object.cons(Stella.SYM_STELLA_END, Stella_Object.cons(Stella.SYM_STELLA_TOK_STREAMSTATE_, Stella_Object.cons(Stella.NIL, Stella.NIL)))), Stella_Object.cons(Stella.NIL, Stella.NIL))))), Stella_Object.cons(Stella.list$(Stella_Object.cons(Stella.SYM_STELLA_WHEN, Stella_Object.cons(Stella.SYM_STELLA_TOK_ENDOFTOKENSp_, Stella_Object.cons(Stella.list$(Stella_Object.cons(Stella.SYM_STELLA_COND, Stella_Object.cons(Stella_Object.cons(Stella.list$(Stella_Object.cons(Stella.SYM_STELLA_e, Stella_Object.cons(Stella.SYM_STELLA_TOK_NEXTSTATE_, Stella_Object.cons(Stella.wrapInteger(-1), Stella_Object.cons(Stella.NIL, Stella.NIL))))), Stella.NIL), Stella_Object.cons(Stella.list$(Stella_Object.cons(Stella.list$(Stella_Object.cons(Stella.SYM_STELLA_NTH, Stella_Object.cons(Stella.list$(Stella_Object.cons(Stella.SYM_STELLA_LEGAL_EOF_STATES, Stella_Object.cons(Stella.SYM_STELLA_TOK_TABLE_, Stella_Object.cons(Stella.NIL, Stella.NIL)))), Stella_Object.cons(Stella.SYM_STELLA_TOK_STATE_, Stella_Object.cons(Stella.NIL, Stella.NIL))))), Stella_Object.cons(Stella.list$(Stella_Object.cons(Stella.SYM_STELLA_SETQ, Stella_Object.cons(Stella.SYM_STELLA_TOK_NEXTSTATE_, Stella_Object.cons(Stella.wrapInteger(-1), Stella_Object.cons(Stella.NIL, Stella.NIL))))), Stella_Object.cons(Stella.list$(Stella_Object.cons(Stella.SYM_STELLA_UNLESS, Stella_Object.cons(Stella.list$(Stella_Object.cons(Stella.SYM_STELLA_e, Stella_Object.cons(Stella.SYM_STELLA_TOK_TOKENSTART_, Stella_Object.cons(Stella.wrapInteger(-1), Stella_Object.cons(Stella.NIL, Stella.NIL))))), Stella_Object.cons(Stella.list$(Stella_Object.cons(Stella.SYM_STELLA_SETQ, Stella_Object.cons(Stella.SYM_STELLA_TOK_ENDOFTOKENSp_, Stella_Object.cons(Stella.SYM_STELLA_FALSE, Stella_Object.cons(Stella.NIL, Stella.NIL))))), Stella_Object.cons(Stella.NIL, Stella.NIL))))), Stella_Object.cons(Stella.NIL, Stella.NIL))))), Stella_Object.cons(Stella.list$(Stella_Object.cons(Stella.SYM_STELLA_OTHERWISE, Stella_Object.cons(Stella.list$(Stella_Object.cons(Stella.SYM_STELLA_SETQ, Stella_Object.cons(Stella.SYM_STELLA_TOK_ENDOFTOKENSp_, Stella_Object.cons(Stella.SYM_STELLA_FALSE, Stella_Object.cons(Stella.NIL, Stella.NIL))))), Stella_Object.cons(Stella.list$(Stella_Object.cons(Stella.SYM_STELLA_SETQ, Stella_Object.cons(Stella.SYM_STELLA_TOK_STATE_, Stella_Object.cons(Stella.wrapInteger(0), Stella_Object.cons(Stella.NIL, Stella.NIL))))), Stella_Object.cons(Stella.list$(Stella_Object.cons(Stella.SYM_STELLA_SETQ, Stella_Object.cons(Stella.SYM_STELLA_TOK_NEXTSTATE_, Stella_Object.cons(Stella.wrapInteger(-1), Stella_Object.cons(Stella.NIL, Stella.NIL))))), Stella_Object.cons(Stella.NIL, Stella.NIL)))))), Stella_Object.cons(Stella.NIL, Stella.NIL)))))), Stella_Object.cons(Stella_Object.cons(Stella.SYM_STELLA_BREAK, Stella.NIL), Stella_Object.cons(Stella.NIL, Stella.NIL)))))), Stella_Object.cons(Stella.list$(Stella_Object.cons(Stella.SYM_STELLA_IF, Stella_Object.cons(Stella.list$(Stella_Object.cons(Stella.SYM_STELLA_ge, Stella_Object.cons(Stella.SYM_STELLA_TOK_CURSOR_, Stella_Object.cons(Stella.SYM_STELLA_TOK_END_, Stella_Object.cons(Stella.NIL, Stella.NIL))))), Stella_Object.cons(Stella.list$(Stella_Object.cons(Stella.SYM_STELLA_SETQ, Stella_Object.cons(Stella.SYM_STELLA_TOK_CHECKPOINT_, Stella_Object.cons(Stella.SYM_STELLA_TOK_SIZE_, Stella_Object.cons(Stella.NIL, Stella.NIL))))), Stella_Object.cons(Stella.list$(Stella_Object.cons(Stella.SYM_STELLA_SETQ, Stella_Object.cons(Stella.SYM_STELLA_TOK_CHECKPOINT_, Stella_Object.cons(Stella.SYM_STELLA_TOK_END_, Stella_Object.cons(Stella.NIL, Stella.NIL))))), Stella_Object.cons(Stella.NIL, Stella.NIL)))))), Stella_Object.cons(Stella.NIL, Stella.NIL))))))))))), Stella_Object.cons(Stella.list$(Stella_Object.cons(Stella.SYM_STELLA_OTHERWISE, Stella_Object.cons(Stella.list$(Stella_Object.cons(Stella.SYM_STELLA_SETQ, Stella_Object.cons(Stella.SYM_STELLA_TOK_CHECKPOINT_, Stella_Object.cons(Stella.SYM_STELLA_TOK_END_, Stella_Object.cons(Stella.NIL, Stella.NIL))))), Stella_Object.cons(Stella.list$(Stella_Object.cons(Stella.SYM_STELLA_SETQ, Stella_Object.cons(Stella.SYM_STELLA_TOK_CURSOR_, Stella_Object.cons(Stella.wrapInteger(0), Stella_Object.cons(Stella.NIL, Stella.NIL))))), Stella_Object.cons(Stella.NIL, Stella.NIL))))), Stella_Object.cons(Stella.NIL, Stella.NIL))))), Stella_Object.cons(Stella.NIL, Stella.NIL)))))), Stella_Object.cons(Stella.list$(Stella_Object.cons(Stella.list$(Stella_Object.cons(Stella.SYM_STELLA_SETQ, Stella_Object.cons(Stella.SYM_STELLA_TOK_NEXTSTATE_, Stella_Object.cons(Stella.list$(Stella_Object.cons(Stella.SYM_STELLA_CHARACTER_CODE, Stella_Object.cons(Stella.list$(Stella_Object.cons(Stella.SYM_STELLA_NTH, Stella_Object.cons(Stella.SYM_STELLA_TOK_TRANSITIONS_, Stella_Object.cons(Stella.list$(Stella_Object.cons(Stella.SYM_STELLA_LOGOR, Stella_Object.cons(Stella.list$(Stella_Object.cons(Stella.SYM_STELLA_SHIFT_LEFT, Stella_Object.cons(Stella.SYM_STELLA_TOK_STATE_, Stella_Object.cons(Stella.wrapInteger(8), Stella_Object.cons(Stella.NIL, Stella.NIL))))), Stella_Object.cons(Stella.list$(Stella_Object.cons(Stella.SYM_STELLA_CHARACTER_CODE, Stella_Object.cons(Stella.list$(Stella_Object.cons(Stella.SYM_STELLA_BYTE_ARRAY_NTH, Stella_Object.cons(Stella.SYM_STELLA_TOK_BUFFER_, Stella_Object.cons(Stella.SYM_STELLA_TOK_CURSOR_, Stella_Object.cons(Stella.NIL, Stella.NIL))))), Stella_Object.cons(Stella.NIL, Stella.NIL)))), Stella_Object.cons(Stella.NIL, Stella.NIL))))), Stella_Object.cons(Stella.NIL, Stella.NIL))))), Stella_Object.cons(Stella.NIL, Stella.NIL)))), Stella_Object.cons(Stella.NIL, Stella.NIL))))), Stella_Object.cons(Stella.list$(Stella_Object.cons(Stella.SYM_STELLA_COND, Stella_Object.cons(Stella.list$(Stella_Object.cons(Stella.list$(Stella_Object.cons(Stella.SYM_STELLA_e, Stella_Object.cons(Stella.list$(Stella_Object.cons(Stella.SYM_STELLA_LOGAND, Stella_Object.cons(Stella.SYM_STELLA_TOK_NEXTSTATE_, Stella_Object.cons(Stella.wrapInteger(128), Stella_Object.cons(Stella.NIL, Stella.NIL))))), Stella_Object.cons(Stella.wrapInteger(0), Stella_Object.cons(Stella.NIL, Stella.NIL))))), Stella_Object.cons(Stella.list$(Stella_Object.cons(Stella.SYM_STELLA_SETQ, Stella_Object.cons(Stella.SYM_STELLA_TOK_STATE_, Stella_Object.cons(Stella.SYM_STELLA_TOK_NEXTSTATE_, Stella_Object.cons(Stella.NIL, Stella.NIL))))), Stella_Object.cons(Stella.list$(Stella_Object.cons(Stella.SYM_STELLA_ii, Stella_Object.cons(Stella.SYM_STELLA_TOK_CURSOR_, Stella_Object.cons(Stella.NIL, Stella.NIL)))), Stella_Object.cons(Stella.NIL, Stella.NIL))))), Stella_Object.cons(Stella.list$(Stella_Object.cons(Stella.list$(Stella_Object.cons(Stella.SYM_STELLA_e, Stella_Object.cons(Stella.SYM_STELLA_TOK_TOKENSTART_, Stella_Object.cons(Stella.wrapInteger(-1), Stella_Object.cons(Stella.NIL, Stella.NIL))))), Stella_Object.cons(Stella.list$(Stella_Object.cons(Stella.SYM_STELLA_WHEN, Stella_Object.cons(Stella.list$(Stella_Object.cons(Stella.SYM_STELLA_e, Stella_Object.cons(Stella.list$(Stella_Object.cons(Stella.SYM_STELLA_LOGAND, Stella_Object.cons(Stella.SYM_STELLA_TOK_NEXTSTATE_, Stella_Object.cons(Stella.wrapInteger(64), Stella_Object.cons(Stella.NIL, Stella.NIL))))), Stella_Object.cons(Stella.wrapInteger(0), Stella_Object.cons(Stella.NIL, Stella.NIL))))), Stella_Object.cons(Stella.list$(Stella_Object.cons(Stella.SYM_STELLA_SETQ, Stella_Object.cons(Stella.SYM_STELLA_TOK_TOKENSTART_, Stella_Object.cons(Stella.SYM_STELLA_TOK_CURSOR_, Stella_Object.cons(Stella.NIL, Stella.NIL))))), Stella_Object.cons(Stella.NIL, Stella.NIL))))), Stella_Object.cons(Stella.list$(Stella_Object.cons(Stella.SYM_STELLA_SETQ, Stella_Object.cons(Stella.SYM_STELLA_TOK_STATE_, Stella_Object.cons(Stella.list$(Stella_Object.cons(Stella.SYM_STELLA_LOGAND, Stella_Object.cons(Stella.SYM_STELLA_TOK_NEXTSTATE_, Stella_Object.cons(Stella.wrapInteger(63), Stella_Object.cons(Stella.NIL, Stella.NIL))))), Stella_Object.cons(Stella.NIL, Stella.NIL))))), Stella_Object.cons(Stella.list$(Stella_Object.cons(Stella.SYM_STELLA_ii, Stella_Object.cons(Stella.SYM_STELLA_TOK_CURSOR_, Stella_Object.cons(Stella.NIL, Stella.NIL)))), Stella_Object.cons(Stella.NIL, Stella.NIL)))))), Stella_Object.cons(Stella.list$(Stella_Object.cons(Stella.SYM_STELLA_OTHERWISE, Stella_Object.cons(Stella_Object.cons(Stella.SYM_STELLA_BREAK, Stella.NIL), Stella_Object.cons(Stella.NIL, Stella.NIL)))), Stella_Object.cons(Stella.NIL, Stella.NIL)))))), Stella_Object.cons((((!Stella.withTokenizerStringInputP()) ? Stella_Object.cons(Stella.list$(Stella_Object.cons(Stella.SYM_STELLA_WHEN, Stella_Object.cons(Stella.list$(Stella_Object.cons(Stella.SYM_STELLA_DEFINEDp, Stella_Object.cons(Stella.SYM_STELLA_TOK_ECHOSTREAM_, Stella_Object.cons(Stella.NIL, Stella.NIL)))), Stella_Object.cons(Stella.list$(Stella_Object.cons(Stella.SYM_STELLA_PRINT_STREAM, Stella_Object.cons(Stella.SYM_STELLA_TOK_ECHOSTREAM_, Stella_Object.cons(Stella.list$(Stella_Object.cons(Stella.SYM_STELLA_BYTE_ARRAY_NTH, Stella_Object.cons(Stella.SYM_STELLA_TOK_BUFFER_, Stella_Object.cons(Stella.list$(Stella_Object.cons(Stella.SYM_STELLA_1_, Stella_Object.cons(Stella.SYM_STELLA_TOK_CURSOR_, Stella_Object.cons(Stella.NIL, Stella.NIL)))), Stella_Object.cons(Stella.NIL, Stella.NIL))))), Stella_Object.cons(Stella.NIL, Stella.NIL))))), Stella_Object.cons(Stella.NIL, Stella.NIL))))), Stella.NIL) : Stella.NIL)).concatenate(Stella.NIL, Stella.NIL), Stella.NIL)))), Stella.NIL)))), Stella_Object.cons(savestreamstatetree.concatenate(Stella.NIL, Stella.NIL), Stella.NIL))))));
    }
  }
...
;
    ...
    { Vector transitiontable = Vector.newVector(Stella.$MAX_TOKENIZER_STATES$);
      ...
      { Cons statedefinition = null;
        ...
        loop000 : while (!(iter000 == Stella.NIL)) {
          ...
          (transitiontable.theArray)[fromstateid] = (Stella.wrapMutableString(transitions));
  ...
  public static Stella_Object clTranslateInlineCallTree(Cons tree) {
    { Cons calltree = ((Cons)(tree.rest.value));
      ...
      return (Stella.list$(Stella_Object.cons(Stella.internCommonLispSymbol("LET"), Stella_Object.cons(otree, Stella_Object.cons(Cons.clYieldDeclareTree(MethodSlot.clYieldMethodParameterTypeDeclarationTrees(method), Stella.FALSE).concatenate(Stella_Object.cons(Stella_Object.clYieldTypedExpressionTree(Stella_Object.clTranslateVerbatimBodySymbols(Stella_Object.copyConsTree(body), parameters), method.type()), Stella.NIL), Stella.NIL), Stella.NIL)))));
    }
  }
  ...
  public static Cons clTranslatePrintStreamTree(Cons tree) {
    { Stella_Object stream = tree.rest.value;
      ...
      if (stream == Stella.KWD_WARN) {
        ...
        return (Stella.list$(Stella_Object.cons(Stella.internCommonLispSymbol("CERROR"), Stella_Object.cons(Stella.wrapString("Continue anyway? "), Stella_Object.cons(Cons.yieldFormatArguments(tree).concatenate(Stella.NIL, Stella.NIL), Stella.NIL)))));
      }
      else {
            ...
            if (Surrogate.subtypeOfStringP(Stella_Object.safePrimaryType(arg))) {
              { StringWrapper arg000 = ((StringWrapper)(arg));
                ...
                if (compoundedstring != null) {
                  ...
                  printforms.firstSetter(Stella.wrapString(compoundedstring));
                  continue loop000;
                }
  ...
  public static Cons yieldFormatArguments(Cons tree) {
    { String formatstring = "";
      ...
      formatarguments = Stella_Object.cons(Stella.wrapString(formatstring), formatarguments);
  ...
  public static Cons clTranslateOperatorTree(Cons tree) {
    { Symbol operator = null;
      ...
      if (operator == Stella.SYM_STELLA_i) {
        ...
        return (((Cons)(Stella_Object.clTranslatePlainBooleanTest(tree, Stella.FALSE))));
      }
      else {
      }
      if ((operator == Stella.SYM_STELLA_i) ||
  ...
  public static Cons clTranslateNewTree(Cons tree) {
    ...
    { Stella_Object typespec = tree.rest.value;
      Stella_Object constructorname = Symbol.clTranslateGlobalSymbol(Stella_Class.yieldConstructorName(((Stella_Object.typeP(typespec) ? ((Surrogate)(typespec)) : ((ParametricTypeSpecifier)(typespec)).specifierBaseType)).getStellaClass(Stella.TRUE)));
  ...
  public static Cons clTranslateMakeTree(Cons tree) {
    { Stella_Class renamed_Class = ((Stella_Class)(Stella_Object.typify(tree.rest.value).surrogateValue));
      ...
      if (Stella_Class.exceptionClassP(renamed_Class)) {
        otree = Stella.list$(Stella_Object.cons(Stella.internCommonLispSymbol("MAKE-CONDITION"), Stella_Object.cons(Stella.list$(Stella_Object.cons(Stella.internCommonLispSymbol("QUOTE"), Stella_Object.cons(classsymbol, Stella_Object.cons(Stella.NIL, Stella.NIL)))), Stella_Object.cons(Symbol.clTranslateGlobalSymbol(Stella.SYM_STELLA_$CONDITION_MESSAGE_KEYWORD$), Stella_Object.cons(Stella_Object.cons(Stella_Object.clTranslateATree(tree.rest.rest.value), Stella.NIL), Stella.NIL)))));
      }
        ...
        otree = Stella_Object.cons(Symbol.clTranslateGlobalSymbol(Stella.SYM_STELLA_CLSYS_MAKE), Stella_Object.cons(classsymbol, Stella_Object.cons(Stella.wrapInteger(Stella_Class.clStructSlots(renamed_Class).length() + 1), Stella.NIL)));
      }
      else {
  ...
  public static Cons clTranslateBooleanTree(Cons tree) {
    return (((Cons)(Stella_Object.clTranslateBooleanTest(tree, Stella.FALSE))));
  }

  public static Cons clTranslateCaseTree(Cons tree) {
    { boolean otherwiseP = Stella.FALSE;
    ...
    { Cons condition = null;
      ...
      while (!(iter000 == Stella.NIL)) {
        ...
        if (condition.value == Stella.SYM_STELLA_OTHERWISE) {
          ...
          condition.value = Stella_Object.clTranslateBooleanTest(condition.value, Stella.FALSE);
        }
    ...
    { Stella_Object operator = tree.value;
      ...
      { GeneralizedSymbol testValue000 = ((GeneralizedSymbol)(operator));
        ...
        if ((testValue000 == Stella.SYM_STELLA_IF) ||
          ...
          return (Stella.list$(Stella_Object.cons(Stella.internCommonLispSymbol("IF"), Stella_Object.cons(Stella_Object.clTranslateBooleanTest(test, Stella.FALSE), Stella_Object.cons(Stella_Object.cons(Stella_Object.clTranslateATree(body.value), Stella_Object.cons(Stella_Object.clTranslateATree(body.rest.value), Stella.NIL)), Stella.NIL)))));
        }
        else if (testValue000 == Stella.SYM_STELLA_WHEN) {
          return (Stella.list$(Stella_Object.cons(Stella.internCommonLispSymbol("WHEN"), Stella_Object.cons(Stella_Object.clTranslateBooleanTest(test, Stella.FALSE), Stella_Object.cons(Cons.clTranslateListOfTrees(body).concatenate(Stella.NIL, Stella.NIL), Stella.NIL)))));
        }
        else if (testValue000 == Stella.SYM_STELLA_UNLESS) {
          return (Stella.list$(Stella_Object.cons(Stella.internCommonLispSymbol("WHEN"), Stella_Object.cons(Stella_Object.clTranslateBooleanTest(test, Stella.TRUE), Stella_Object.cons(Cons.clTranslateListOfTrees(body).concatenate(Stella.NIL, Stella.NIL), Stella.NIL)))));
        }
        else {
          { OutputStringStream stream000 = OutputStringStream.newOutputStringStream();
  ...
  public static Cons clTranslateWhileTree(Cons tree) {
    { Stella_Object test = Stella_Object.clTranslateBooleanTest(tree.rest.value, Stella.FALSE);
    ...
    { Stella_Object expression = tree.rest.value;
      ...
      if (Surrogate.subtypeOfP(type, Stella.SGT_STELLA_FLOAT)) {
        if (Stella_Object.isaP(expression, Stella.SGT_STELLA_INTEGER_WRAPPER)) {
          return (Stella.wrapFloat(((double)(((IntegerWrapper)(expression)).wrapperValue))).clTranslateAtomicTree());
        }
        else {
      ...
      if (Surrogate.subtypeOfP(type, Stella.SGT_STELLA_INTEGER)) {
        if (Stella_Object.isaP(expression, Stella.SGT_STELLA_FLOAT_WRAPPER)) {
          return (Stella.wrapInteger(((int)(((FloatWrapper)(expression)).wrapperValue))));
        }
        else {
  ...
  public static Cons clTranslateSpecialTree(Cons tree) {
    { Cons translatedtree = Cons.clTranslateLetTree(tree, Stella.TRUE);
  ...
  public static Cons clTranslateLetTree(Cons tree, boolean specialP) {
    { Cons odeclarations = Stella.NIL;
      ...
      tree.rest.rest = Cons.clYieldDeclareTree(typedeclarations, Stella.FALSE).concatenate(Cons.clTranslateListOfTrees(tree.rest.rest), Stella.NIL);
      return (tree);
    }
  }
  ...
  public static Cons clTranslateForeachTree(Cons tree) {
    { Cons iteratorbindings = ((Cons)(tree.rest.value));
      Cons cursorbindings = ((Cons)(tree.rest.rest.value));
      Stella_Object continuationtest = Stella_Object.clTranslateBooleanTest(tree.fourth(), Stella.FALSE);
      Cons body = Cons.clTranslateListOfTrees(tree.nthRest(4));
      Cons declarations = Stella.NIL;
      Cons nextassignments = Stella.NIL;
      ...
      if (Stella.generateClTypeDeclarationsP()) {
        typedeclarations = typedeclarations.concatenate(Cons.clYieldLetVariableTypeDeclarationTrees(cursorbindings), Stella.NIL);
      }
      { Cons binding = null;
        Cons iter001 = cursorbindings;
        ...
        while (!(iter001 == Stella.NIL)) {
          ...
          nextassignments = Stella_Object.cons(Stella_Object.clTranslateATree(binding.rest.rest.value), nextassignments);
          binding.thirdSetter(null);
          if (!(Symbol.duplicateCursorVariableP(((Symbol)(binding.value)), iteratorbindings))) {
            declarations = Stella_Object.cons(Stella_Object.cons(Symbol.clTranslateLocalSymbol(((Symbol)(binding.value))), Stella_Object.cons(Stella_Object.clTranslateATree(Surrogate.typeToWalkedNullValueTree(StandardObject.typeSpecToBaseType(((StandardObject)(binding.rest.value))))), Stella.NIL)), declarations);
          }
        }
      }
      return (Stella.list$(Stella_Object.cons(Stella.internCommonLispSymbol("LET*"), Stella_Object.cons(declarations, Stella_Object.cons(Cons.clYieldDeclareTree(typedeclarations, Stella.FALSE).concatenate(Stella_Object.cons(Stella.list$(Stella_Object.cons(Stella.internCommonLispSymbol("LOOP"), Stella_Object.cons(Stella.SYM_STELLA_WHILE, Stella_Object.cons(continuationtest, Stella_Object.cons(Stella_Object.cons(Stella.SYM_STELLA_DO, nextassignments.reverse().concatenate(Cons.maybeWrapWithContinueLabel(body).concatenate(Stella.NIL, Stella.NIL), Stella.NIL)), Stella.NIL))))), Stella.NIL), Stella.NIL), Stella.NIL)))));
    }
  }
  ...
  public static Stella_Object clTranslateCallMethodTree(Cons tree) {
    { Symbol operator = null;
      ...
      if ((operator == Stella.SYM_STELLA_NTH) ||
        ...
        return (Stella_Object.clTranslatePlainBooleanTest(tree, Stella.FALSE));
      }
      else {
      }
      if ((owner == Stella.SGT_STELLA_ARGUMENT_LIST) ||
    ...
    { StandardObject returntype = ((((StandardObject)(Stella.$TARGETTYPE$.get())) == Stella.SGT_STELLA_UNKNOWN) ? Stella.SGT_STELLA_VOID : ((StandardObject)(((StandardObject)(Stella.$TARGETTYPE$.get())))));
      ...
      { Stella_Object otree = null;
        ...
        { Object [] caller_MV_returnarray = new Object[1];
          ...
          otree = Stella_Object.walkExpressionTree(tree.rest.value, Stella.SGT_STELLA_CODE, Stella.SYM_STELLA_FUNCALL, Stella.TRUE, caller_MV_returnarray);
  ...
  public static Cons walkMakeTree(Cons tree, Object [] MV_returnarray) {
    { Stella_Object classname = tree.rest.value;
      ...
      if (Stella_Object.symbolP(classname)) {
        ...
        tree.secondSetter(Stella.internSymbolInModule(((Surrogate)(classname)).symbolName, ((Module)(((Surrogate)(classname)).homeContext)), Stella.TRUE));
      }
      else {
        { Object old$PrintreadablyP$000 = Stella.$PRINTREADABLYp$.get();
...
;
              ...
              slotname = Stella.internSymbolInModule(((Keyword)(it.key)).symbolName, renamed_Class.homeModule(), Stella.FALSE);
...
;
  ...
  public static void walkDefmoduleTree(Cons tree) {
    ...
    { Module module = null;
      String modulename = Stella_Object.coerceToModuleName(tree.rest.value, Stella.FALSE);
...
;
      ...
      module = Stella.defineModule(modulename, tree.rest.rest);
...
;
              ...
              exceptionvariablespec = Symbol.walkADeclaration(exceptionvariable, exceptiontype, null, Stella.TRUE);
  ...
  public static Cons walkSignalExceptionTree(Cons tree, Object [] MV_returnarray) {
    { Stella_Object expression = null;
      ...
      { Object [] caller_MV_returnarray = new Object[1];
        ...
        expression = Stella_Object.walkExpressionTree(tree.rest.value, Stella.SGT_STELLA_STELLA_ROOT_EXCEPTION, Stella.SYM_STELLA_SIGNAL_EXCEPTION, Stella.FALSE, caller_MV_returnarray);
      ...
      if (slot != null) {
        ...
        if (!(tree.rest == Stella.NIL)) {
          { Object [] caller_MV_returnarray = new Object[1];
            ...
            walkedfirstarg = Stella_Object.walkExpressionTree(tree.rest.value, Stella.SGT_STELLA_UNKNOWN, ((Symbol)(slotname)), Stella.TRUE, caller_MV_returnarray);
...
;
  ...
  public static Cons walkVariableArguments(Cons arguments, MethodSlot method) {
    { StandardObject targettype = MethodSlot.variableArgumentsType(method);
      ...
      while (!(cursor == Stella.NIL)) {
        cursor.value = Stella_Object.walkExpressionTree(cursor.value, targettype, method.slotName, Stella.FALSE, new Object[1]);
        cursor = cursor.rest;
      }
      if (listifyargsP) {
  ...
  public static Cons walkSlotOnAbstractTypeTree(Cons tree, Surrogate abstracttype, Object [] MV_returnarray) {
    { Stella_Object methodname = tree.value;
      ...
      boolean undefinedmethodP = Stella.TRUE;
      Stella_Object otree = null;
      StandardObject otype = null;

      if (prototypemethod != null) {
        undefinedmethodP = Stella.FALSE;
              ...
              { Object old$PrintreadablyP$000 = Stella.$PRINTREADABLYp$.get();
                ...
                try {
                  ...
                  if (!(Stella.suppressWarningsP())) {
                    ...
                    {
                      System.out.println();
                      System.out.println(" Inferred the method `" + Stella_Object.deUglifyParseTree(methodname) + "' on the abstract");
                      System.out.println("   type `" + Stella_Object.deUglifyParseTree(abstracttype) + "', since `" + Stella_Object.deUglifyParseTree(methodname) + "' is implemented");
                      System.out.println("   on all non-abstract subtypes of `" + Stella_Object.deUglifyParseTree(abstracttype) + "'.");
                    }
;
                  }
              ...
              { Object old$PrintreadablyP$001 = Stella.$PRINTREADABLYp$.get();
                ...
                try {
                  ...
                  if (!(Stella.suppressWarningsP())) {
                    ...
                    {
                      System.out.println();
                      System.out.println(" Could not infer `" + Stella_Object.deUglifyParseTree(methodname) + "' on abstract type `" + Stella_Object.deUglifyParseTree(abstracttype) + "',");
                      System.out.println("   since the implementations of `" + Stella_Object.deUglifyParseTree(methodname) + "' on the non-abstract");
                      System.out.println("   subtypes of `" + Stella_Object.deUglifyParseTree(abstracttype) + "' are not all compatible.");
                    }
;
                  }
                ...
                try {
                  ...
                  if (!(Stella.suppressWarningsP())) {
                    Stella.printErrorContext(">> WARNING: ", Stella.STANDARD_OUTPUT);
                    {
                      System.out.println();
                      System.out.println(" Could not infer `" + Stella_Object.deUglifyParseTree(methodname) + "' on abstract type `" + Stella_Object.deUglifyParseTree(abstracttype) + "',");
                      System.out.println("   since `" + Stella_Object.deUglifyParseTree(methodname) + "' is only implemented on `" + Stella_Object.deUglifyParseTree(Stella.wrapInteger(nofmethods)) + "' of the `" + Stella_Object.deUglifyParseTree(Stella.wrapInteger(nofsubs)) + "'");
                      System.out.println("   non-abstract subtypes of `" + Stella_Object.deUglifyParseTree(abstracttype) + "'.");
                    }
;
                  }
              ...
              if (!(compatibleP)) {
                System.out.println(" Additionally, the method signatures are not compatible.");
              }
            }
          }
        }
      ...
      if (undefinedmethodP) {
        ...
        { Cons value002 = null;
          ...
          { Object [] caller_MV_returnarray = new Object[1];
            ...
            value002 = Cons.walkUndefinedSlotTree(tree, abstracttype, Stella.FALSE, caller_MV_returnarray);
  ...
  public static Cons walkUndefinedSlotTree(Cons tree, StandardObject firstargtype, boolean warnP, Object [] MV_returnarray) {
    { Cons cursor = tree.rest.rest;
      ...
      while (!(cursor == Stella.NIL)) {
        cursor.value = Stella_Object.walkExpressionTree(cursor.value, null, operatorname, Stella.TRUE, new Object[1]);
        cursor = cursor.rest;
      }
      if (warnP &&
...
;
        ...
        { Object [] caller_MV_returnarray = new Object[1];
          ...
          otree = Stella_Object.walkExpressionTree(streamtree, Stella.SGT_STELLA_NATIVE_OUTPUT_STREAM, ((Symbol)(tree.value)), Stella.FALSE, caller_MV_returnarray);
          otype = ((StandardObject)(caller_MV_returnarray[0]));
        }
      ...
      { ConsIterator it = tree.rest.rest.allocateIterator();
        ...
        while (it.nextP()) {
          { Object [] caller_MV_returnarray = new Object[1];
            ...
            otree = Stella_Object.walkExpressionTree(it.value, Stella.SGT_STELLA_UNKNOWN, ((Symbol)(operator)), Stella.FALSE, caller_MV_returnarray);
            otype = ((StandardObject)(caller_MV_returnarray[0]));
          }
            ...
            { Surrogate testValue000 = Stella_Object.safePrimaryType(otree);
              ...
              if (Surrogate.subtypeOfStringP(testValue000)) {
                ...
                { IntegerWrapper otree000 = ((IntegerWrapper)(otree));
                  ...
                  it.valueSetter(Stella.wrapString(Native.stringify(otree000)));
                }
              }
                ...
                { CharacterWrapper otree000 = ((CharacterWrapper)(otree));
                  ...
                  it.valueSetter(Stella.wrapString(Native.makeString(1, otree000.wrapperValue)));
                }
              }
              else {
...
;
  ...
  public static Stella_Object walkQuotedTree(Cons tree, Object [] MV_returnarray) {
    ...
    { Stella_Object argument = tree.rest.value;
      ...
      return (Stella_Object.walkATree(Stella.list$(Stella_Object.cons(Stella.SYM_STELLA_GET_QUOTED_TREE, Stella_Object.cons(Stella.wrapString(objectname), Stella_Object.cons(Stella_Object.cons(Stella.wrapString(((Module)(Stella.$MODULE$.get())).moduleFullName), Stella.NIL), Stella.NIL)))), MV_returnarray));
    }
  }
    ...
    { Stella_Object operator = tree.value;
        ...
        case 0: 
          { GeneralizedSymbol testValue000 = ((GeneralizedSymbol)(operator));
            ...
            if (testValue000 == Stella.SYM_STELLA_i) {
              { Stella_Object _return_temp = Stella.wrapInteger(0);
              ...
              { Stella_Object _return_temp = Stella.wrapInteger(1);
            ...
            if ((testValue001 == Stella.SYM_STELLA_i) ||
              ...
              { Stella_Object value002 = null;
                ...
                { Object [] caller_MV_returnarray = new Object[1];
                  ...
                  value002 = Stella_Object.walkExpressionTree(operands.value, Stella.SGT_STELLA_NUMBER, ((Symbol)(operator)), Stella.FALSE, caller_MV_returnarray);
                  value003 = ((StandardObject)(caller_MV_returnarray[0]));
                }
              ...
              operands.firstSetter(((operator == Stella.SYM_STELLA__) ? Stella.wrapInteger(0) : Stella.wrapInteger(1)));
            }
            else {
              { OutputStringStream stream000 = OutputStringStream.newOutputStringStream();
      ...
      { ConsIterator it = operands.allocateIterator();
        ...
        while (it.nextP()) {
          { Object [] caller_MV_returnarray = new Object[1];
            ...
            operand = Stella_Object.walkExpressionTree(it.value, Stella.SGT_STELLA_NUMBER, ((Symbol)(operator)), Stella.FALSE, caller_MV_returnarray);
      ...
      if ((operator == Stella.SYM_STELLA_s) &&
        ...
        if (Stella_Object.wrapperP(operands.value)) {
          operands.firstSetter(Stella.wrapFloat(((IntegerWrapper)(operands.value)).wrapperValue * 1.0));
        }
        else if (Stella_Object.wrapperP(operands.rest.value)) {
          operands.secondSetter(Stella.wrapFloat(((IntegerWrapper)(operands.rest.value)).wrapperValue * 1.0));
        }
        else {
  ...
  public static Stella_Object walkEqualityTree(Cons tree, Object [] MV_returnarray) {
    { Stella_Object arg1 = null;
      ...
      { Object [] caller_MV_returnarray = new Object[1];
        ...
        arg1 = Stella_Object.walkExpressionTree(tree.rest.value, Stella.SGT_STELLA_UNKNOWN, ((Symbol)(tree.value)), Stella.TRUE, caller_MV_returnarray);
        type1 = ((StandardObject)(caller_MV_returnarray[0]));
      }
      { Object [] caller_MV_returnarray = new Object[1];

        arg2 = Stella_Object.walkExpressionTree(tree.rest.rest.value, Stella.SGT_STELLA_UNKNOWN, ((Symbol)(tree.value)), Stella.TRUE, caller_MV_returnarray);
...
;
  ...
  public static Cons walkWithProcessLockTree(Cons tree, Object [] MV_returnarray) {
    tree.secondSetter(Stella_Object.walkExpressionTree(tree.rest.value, Stella.SGT_STELLA_PROCESS_LOCK_OBJECT, ((Symbol)(tree.value)), Stella.TRUE, new Object[1]));
...
;
      ...
      tree.secondSetter(Stella_Object.walkExpressionTree(tree.rest.value, caseconstanttype, Stella.SYM_STELLA_CASE, Stella.TRUE, new Object[1]));
      if (Stella_Object.vrletExpressionP(tree.rest.value)) {
  ...
  public static Cons attachUnhandledCaseErrorClause(Cons casetree, Stella_Object testtree) {
    { Stella_Object lastclause = casetree.last();
      ...
      if (Stella_Object.consP(lastclause) &&
        ...
        return (casetree.concatenate(Stella_Object.cons(Stella.list$(Stella_Object.cons(Stella.SYM_STELLA_OTHERWISE, Stella_Object.cons(Stella.list$(Stella_Object.cons(Stella.SYM_STELLA_ERROR, Stella_Object.cons(Stella_Object.copyConsTree(testtree), Stella_Object.cons(Stella_Object.cons(Stella.wrapString(" is not a valid case option"), Stella.NIL), Stella.NIL)))), Stella_Object.cons(Stella.NIL, Stella.NIL)))), Stella.NIL), Stella.NIL));
      }
      else {
        return (casetree);
      }
  ...
  public static int countCaseTestClauses(Cons tree, Object [] MV_returnarray) {
    { Cons clauses = ((Cons)(tree.rest.rest));
      ...
      { int _return_temp = nofclauses;
        ...
        MV_returnarray[0] = Stella.wrapBoolean(otherwiseP);
        return (_return_temp);
      }
    }
  }
      ...
      while (!(iter000 == Stella.NIL)) {
        ...
        if (Stella_Object.safePrimaryType(condition) == Stella.SGT_STELLA_CONS) {
          { Cons condition000 = ((Cons)(condition));
            ...
            if (!(condition000.value == Stella.SYM_STELLA_OTHERWISE)) {
              condition000.value = Stella_Object.walkExpressionTree(condition000.value, Stella.SGT_STELLA_BOOLEAN, Stella.SYM_STELLA_COND, Stella.TRUE, new Object[1]);
...
;
  ...
  public static Stella_Object helpWalkBooleanTree(Cons tree) {
    { Cons cursor = tree.rest;
      ...
      while (!(cursor == Stella.NIL)) {
        cursor.value = (Stella_Object.andOrNotTreeP(cursor.value) ? Cons.helpWalkBooleanTree(((Cons)(cursor.value))) : Stella_Object.walkExpressionTree(cursor.value, Stella.SGT_STELLA_BOOLEAN, ((Symbol)(tree.value)), Stella.TRUE, new Object[1]));
        cursor = cursor.rest;
      }
      { GeneralizedSymbol testValue000 = ((GeneralizedSymbol)(tree.value));
  ...
  public static Cons walkChooseTree(Cons tree, Object [] MV_returnarray) {
    { Stella_Object operator = tree.value;
      Stella_Object test = Stella_Object.walkExpressionTree(tree.rest.value, Stella.SGT_STELLA_BOOLEAN, ((Symbol)(operator)), Stella.TRUE, new Object[1]);
      Stella_Object temp = null;
      StandardObject type1 = null;
      StandardObject type2 = null;
      StandardObject type = null;
      ...
      { Object [] caller_MV_returnarray = new Object[1];
        ...
        temp = Stella_Object.walkExpressionTree(tree.rest.rest.value, ((StandardObject)(Stella.$TARGETTYPE$.get())), Stella.SYM_STELLA_CHOOSE, Stella.TRUE, caller_MV_returnarray);
        type1 = ((StandardObject)(caller_MV_returnarray[0]));
      }
      tree.thirdSetter(temp);
      { Object [] caller_MV_returnarray = new Object[1];

        temp = Stella_Object.walkExpressionTree(tree.fourth(), ((StandardObject)(Stella.$TARGETTYPE$.get())), Stella.SYM_STELLA_CHOOSE, Stella.TRUE, caller_MV_returnarray);
        type2 = ((StandardObject)(caller_MV_returnarray[0]));
      }
    ...
    { Stella_Object operator = tree.value;
      ...
      { GeneralizedSymbol testValue000 = ((GeneralizedSymbol)(operator));
        ...
        if (testValue000 == Stella.SYM_STELLA_IF) {
          ...
          tree.thirdSetter(Stella_Object.walkStatement(tree.rest.rest.value, Stella.TRUE));
          tree.fourthSetter(Stella_Object.walkStatement(tree.fourth(), Stella.TRUE));
        }
        else if ((testValue000 == Stella.SYM_STELLA_WHEN) ||
  ...
  public static Cons walkWhileTree(Cons tree, Object [] MV_returnarray) {
    { Object old$Nofspecialsatloopentry$000 = Stella.$NOFSPECIALSATLOOPENTRY$.get();
      ...
      try {
        ...
        { Stella_Object test = Stella_Object.walkExpressionTree(tree.rest.value, Stella.SGT_STELLA_BOOLEAN, Stella.SYM_STELLA_WHILE, Stella.TRUE, new Object[1]);
          Cons body = tree.rest.rest;
    ...
    if (Stella.needToUnbindSpecialsP()) {
      { Cons unbindtree = Stella.yieldLoopExitSpecialUnbindTree();
        ...
        { Object old$SpecialsenabledP$000 = Stella.$SPECIALSENABLEDp$.get();
          ...
          try {
            Native.setBooleanSpecial(Stella.$SPECIALSENABLEDp$, Stella.FALSE);
...
;
  ...
  public static Cons walkValuesTree(Cons tree, Object [] MV_returnarray) {
    { Stella_Object otree = null;
      ...
      boolean hasproceduralvalueP = Stella.FALSE;
      ...
      { ConsIterator it = tree.rest.allocateIterator();
        ...
        loop000 : while (it.nextP()) {
          ...
          if (Stella_Object.vrletExpressionP(otree)) {
            it.valueSetter(otree);
            hasproceduralvalueP = Stella.TRUE;
            break loop000;
          }
  ...
  public static Cons walkCastTree(Cons tree, Object [] MV_returnarray) {
    ...
    { StandardObject typespec = tree.rest.rest.value.yieldTypeSpecifier();
      ...
      tree.secondSetter(Stella_Object.walkExpressionTree(tree.rest.value, Stella.SGT_STELLA_UNKNOWN, Stella.SYM_STELLA_CAST, Stella.TRUE, new Object[1]));
      if (Stella_Object.vrletExpressionP(tree.rest.value)) {
  ...
  public static Cons walkClSpecialTree(Cons tree, Object [] MV_returnarray) {
    { Cons bindings = ((Cons)(tree.rest.value));
      ...
      boolean bindviasetqP = Stella.FALSE;
      ...
      { Cons binding = null;
        ...
        while (!(iter000 == Stella.NIL)) {
          ...
          if (bindviasetqP) {
            ...
            otree = Stella_Object.walkExpressionTree(binding.rest.value, variabletype, Stella.SYM_STELLA_SPECIAL, Stella.TRUE, new Object[1]);
            if (Stella_Object.proceduralExpressionP(otree)) {
              bindviasetqP = Stella.TRUE;
...
;
  ...
  public static Cons walkVariableDeclarations(Cons declarations) {
    { Cons odeclarations = Stella.NIL;
      Symbol variable = null;
      boolean vrletencounteredP = Stella.FALSE;
                  ...
                  { Object old$PrintreadablyP$001 = Stella.$PRINTREADABLYp$.get();
                    ...
                    try {
                      ...
                      if (!(Stella.suppressWarningsP())) {
                        ...
                        {
                          Stella.STANDARD_ERROR.nativeStream.println();
                          Stella.STANDARD_ERROR.nativeStream.println(" Illegal binding of global or special variable in `let' declaration:");
...
;
                  ...
                  odeclarations = Stella_Object.cons(Symbol.walkADeclaration(variable, null, decl000.rest.value, Stella.FALSE), odeclarations);
                break;
                case 3: 
                  odeclarations = Stella_Object.cons(Symbol.walkADeclaration(variable, decl000.rest.value, decl000.rest.rest.value, Stella.FALSE), odeclarations);
                break;
                default:
                  { Object old$PrintreadablyP$004 = Stella.$PRINTREADABLYp$.get();
  ...
  public static Cons walkArefTree(Cons tree, Object [] MV_returnarray) {
    { Stella_Object operator = tree.value;
      ...
      { Object [] caller_MV_returnarray = new Object[1];
        ...
        otree = Stella_Object.walkExpressionTree(arguments.value, Stella.SGT_STELLA_ARRAY, ((Symbol)(operator)), Stella.TRUE, caller_MV_returnarray);
        otype = ((StandardObject)(caller_MV_returnarray[0]));
      }
      if (Stella_Object.vrletExpressionP(otree)) {
...
;
      ...
      if (operator == Stella.SYM_STELLA_AREF_SETTER) {
        { Object [] caller_MV_returnarray = new Object[1];
          ...
          otree = Stella_Object.walkExpressionTree(arguments.value, elementtype, ((Symbol)(operator)), Stella.TRUE, caller_MV_returnarray);
          otype = ((StandardObject)(caller_MV_returnarray[0]));
        }
        arguments.firstSetter(otree);
        if (Stella_Object.vrletExpressionP(otree)) {
...
;
      ...
      while (!(arguments == Stella.NIL)) {
        { Object [] caller_MV_returnarray = new Object[1];
          ...
          otree = Stella_Object.walkExpressionTree(arguments.value, Stella.SGT_STELLA_INTEGER, ((Symbol)(operator)), Stella.TRUE, caller_MV_returnarray);
          otype = ((StandardObject)(caller_MV_returnarray[0]));
        }
        arguments.firstSetter(otree);
        if (Stella_Object.vrletExpressionP(otree)) {
...
;
            ...
            { StorageSlot slot000 = ((StorageSlot)(slot));
              ...
              valueref = Stella_Object.walkExpressionTree(tree.rest.rest.value, otype, Stella.SYM_STELLA_SLOT_VALUE_SETTER, Stella.FALSE, new Object[1]);
              { Object [] caller_MV_returnarray = new Object[1];
        ...
        { Stella_Class objectclass = StandardObject.typeSpecToClass(objecttype);
          ...
          { Stella_Object valueref = null;
            ...
            { Object [] caller_MV_returnarray = new Object[1];
              ...
              valueref = Stella_Object.walkExpressionTree(tree.rest.rest.value, slottype, Stella.SYM_STELLA_SETF, Stella.TRUE, caller_MV_returnarray);
...
;
      ...
      { Object [] caller_MV_returnarray = new Object[1];
        ...
        ovalue = Stella_Object.walkExpressionTree(value, variabletype, Stella.SYM_STELLA_SETQ, Stella.TRUE, caller_MV_returnarray);
        otype = ((StandardObject)(caller_MV_returnarray[0]));
      }
  ...
  public static Cons walkListOfTrees(Cons trees) {
    { Cons cursor = trees;
      ...
      while (!(cursor == Stella.NIL)) {
        cursor.value = Stella_Object.walkStatement(cursor.value, Stella.FALSE);
        cursor = cursor.rest;
      }
      return (trees);
    }
...
;
  ...
  public static void walkAuxiliaryTree(Cons tree) {
    Cons.helpWalkAuxiliaryTree(tree, Stella.TRUE);
  }
        ...
        { String annotation = null;
          ...
          if (createannotationP) {
            ...
            if (((Integer)(Stella.$TRANSLATIONVERBOSITYLEVEL$.get())).intValue() >= 2) {
              System.out.println("Defining `" + annotation + "'");
            }
          }
          { GeneralizedSymbol testValue000 = ((GeneralizedSymbol)(tree.value));
...
;
  ...
  public static String nameQuotedTree(Cons tree) {
    { Cons nametree = Stella_Object.cons(tree, Stella_Object.cons(Stella.wrapString(((Module)(Stella.$MODULE$.get())).moduleFullName), Stella.NIL));
  ...
  public static Cons walkSetofTree(Cons tree, Object [] MV_returnarray) {
    tree = Cons.foreachToPrefixForeachTree(tree);
    { Cons iteratorssubtree = ((Cons)(tree.rest.value));
      Symbol iteratorvariable = Stella.localGensym("ITER");
      Cons tail = null;
      ...
      tree.secondSetter(null);
      if (Stella.getQuotedTree("((ON AS) \"/STELLA\")", "/STELLA").memberP(iteratorssubtree.value)) {
        { Object old$PrintreadablyP$000 = Stella.$PRINTREADABLYp$.get();
          ...
          try {
            ...
            if (!(Stella.suppressWarningsP())) {
              ...
              {
                Stella.STANDARD_ERROR.nativeStream.println();
                Stella.STANDARD_ERROR.nativeStream.println(" Illegal reserved word `" + iteratorssubtree.value + "' in 'setof' expression..");
              }
;
            }
      ...
      { Object [] caller_MV_returnarray = new Object[2];
        ...
        iteratorclauses = Cons.walkCursorsTree(iteratorssubtree, Stella.TRUE, caller_MV_returnarray);
        valueclauses = ((Cons)(caller_MV_returnarray[0]));
        continuationtest = ((Stella_Object)(caller_MV_returnarray[1]));
      }
      continuationtest = continuationtest;
      tail = ((Cons)(tree.rest.rest));
      if ((!(tail == Stella.NIL)) &&
          (((Cons)(tail.value)).value == Stella.SYM_STELLA_WHERE)) {
        wheretest = ((Cons)(tail.value)).rest.value;
        ((Cons)(tail.value)).secondSetter(null);
        tail = tail.rest;
      }
      if (!(tail == Stella.NIL)) {
        { Object old$PrintreadablyP$001 = Stella.$PRINTREADABLYp$.get();
          ...
          try {
            ...
            if (!(Stella.suppressWarningsP())) {
              ...
              {
                Stella.STANDARD_ERROR.nativeStream.println();
                Stella.STANDARD_ERROR.nativeStream.println(" Illegal 'setof' expression.  Syntax is ");
                Stella.STANDARD_ERROR.nativeStream.println("   (SETOF <iterators> WHERE <boolean expression>).");
              }
;
            }
      ...
      { Cons _return_temp = Stella.list$(Stella_Object.cons(Stella.SYM_STELLA_VRLET, Stella_Object.cons(Stella_Object.cons(Stella_Object.cons(iteratorvariable, Stella_Object.cons(Stella.list$(Stella_Object.cons(Stella.SYM_STELLA_NEW, Stella_Object.cons(Stella.SYM_STELLA_ALL_PURPOSE_ITERATOR, Stella_Object.cons(Stella.NIL, Stella.NIL)))), Stella.NIL)), Stella.NIL), Stella_Object.cons(Stella.list$(Stella_Object.cons(Stella.SYM_STELLA_SETF, Stella_Object.cons(Stella.list$(Stella_Object.cons(Stella.SYM_STELLA_ITERATOR_NESTED_ITERATOR, Stella_Object.cons(iteratorvariable, Stella_Object.cons(Stella.NIL, Stella.NIL)))), Stella_Object.cons(Cons.extractSetofNestedIteratorTree(iteratorclauses), Stella_Object.cons(Stella.NIL, Stella.NIL))))), Stella_Object.cons(Stella.list$(Stella_Object.cons(Stella.SYM_STELLA_SETF, Stella_Object.cons(Stella.list$(Stella_Object.cons(Stella.SYM_STELLA_ITERATOR_NEXT_CODE, Stella_Object.cons(iteratorvariable, Stella_Object.cons(Stella.NIL, Stella.NIL)))), Stella_Object.cons(Stella.list$(Stella_Object.cons(Stella.SYM_STELLA_THE_CODE, Stella_Object.cons(Stella.KWD_FUNCTION, Stella_Object.cons(Cons.yieldSetofNextFunctionName(valueclauses, ((Cons)(wheretest))), Stella_Object.cons(Stella.NIL, Stella.NIL))))), Stella_Object.cons(Stella.NIL, Stella.NIL))))), Stella_Object.cons(iteratorvariable, Stella_Object.cons(Stella.NIL, Stella.NIL)))))));

        MV_returnarray[0] = Stella.SGT_STELLA_ALL_PURPOSE_ITERATOR;
        return (_return_temp);
      }
    }
  }

  public static Symbol yieldSetofNextFunctionName(Cons valueclauses, Cons wheretest) {
    { Cons onlyvalueclause = ((Cons)(valueclauses.value));
      Stella_Object valuevariable = onlyvalueclause.value;
      Stella_Object valuetype = onlyvalueclause.rest.value;
      Symbol nextfunctionname = null;

      nextfunctionname = Stella.gensym("SETOF-NEXT-P");
      Cons.walkAuxiliaryTree(Stella.list$(Stella_Object.cons(Stella.SYM_STELLA_DEFUN, Stella_Object.cons(Stella_Object.cons(nextfunctionname, Stella_Object.cons(Stella.SYM_STELLA_BOOLEAN, Stella.NIL)), Stella_Object.cons(Stella_Object.cons(Stella.list$(Stella_Object.cons(Stella.SYM_STELLA_SELF, Stella_Object.cons(Stella.SYM_STELLA_ALL_PURPOSE_ITERATOR, Stella_Object.cons(Stella.NIL, Stella.NIL)))), Stella.NIL), Stella_Object.cons(Stella.list$(Stella_Object.cons(Stella.SYM_STELLA_LET, Stella_Object.cons(Stella.list$(Stella_Object.cons(Stella.list$(Stella_Object.cons(Stella.SYM_STELLA_NESTEDITERATOR, Stella_Object.cons(Stella.list$(Stella_Object.cons(Stella.SYM_STELLA_ITERATOR_NESTED_ITERATOR, Stella_Object.cons(Stella.SYM_STELLA_SELF, Stella_Object.cons(Stella.NIL, Stella.NIL)))), Stella_Object.cons(Stella.NIL, Stella.NIL)))), Stella_Object.cons(Stella_Object.cons(valuevariable, Stella_Object.cons(valuetype, Stella_Object.cons(Stella.SYM_STELLA_NULL, Stella.NIL))), Stella_Object.cons(Stella.NIL, Stella.NIL)))), Stella_Object.cons(Stella.list$(Stella_Object.cons(Stella.SYM_STELLA_WHILE, Stella_Object.cons(Stella.list$(Stella_Object.cons(Stella.SYM_STELLA_NEXTp, Stella_Object.cons(Stella.SYM_STELLA_NESTEDITERATOR, Stella_Object.cons(Stella.NIL, Stella.NIL)))), Stella_Object.cons(Stella.list$(Stella_Object.cons(Stella.SYM_STELLA_SETQ, Stella_Object.cons(valuevariable, Stella_Object.cons(Stella_Object.cons(Stella.list$(Stella_Object.cons(Stella.SYM_STELLA_VALUE, Stella_Object.cons(Stella.SYM_STELLA_NESTEDITERATOR, Stella_Object.cons(Stella.NIL, Stella.NIL)))), Stella.NIL), Stella.NIL)))), Stella_Object.cons(Stella.list$(Stella_Object.cons(Stella.SYM_STELLA_WHEN, Stella_Object.cons(wheretest, Stella_Object.cons(Stella.list$(Stella_Object.cons(Stella.list$(Stella_Object.cons(Stella.SYM_STELLA_SETF, Stella_Object.cons(Stella.list$(Stella_Object.cons(Stella.SYM_STELLA_VALUE, Stella_Object.cons(Stella.SYM_STELLA_SELF, Stella_Object.cons(Stella.NIL, Stella.NIL)))), Stella_Object.cons(valuevariable, Stella_Object.cons(Stella.NIL, Stella.NIL))))), Stella_Object.cons(Stella.list$(Stella_Object.cons(Stella.SYM_STELLA_RETURN, Stella_Object.cons(Stella.SYM_STELLA_TRUE, Stella_Object.cons(Stella.NIL, Stella.NIL)))), Stella_Object.cons(Stella.NIL, Stella.NIL)))), Stella.NIL)))), Stella_Object.cons(Stella.NIL, Stella.NIL)))))), Stella_Object.cons(Stella.list$(Stella_Object.cons(Stella.SYM_STELLA_RETURN, Stella_Object.cons(Stella.SYM_STELLA_FALSE, Stella_Object.cons(Stella.NIL, Stella.NIL)))), Stella_Object.cons(Stella.NIL, Stella.NIL)))))), Stella_Object.cons(Stella.NIL, Stella.NIL)))))));
      return (nextfunctionname);
    }
  }

  public static Cons extractSetofNestedIteratorTree(Cons iteratorclauses) {
    { Cons iterclauses = ((Cons)(iteratorclauses));
      Stella_Object subtree = ((Cons)(iterclauses.value)).rest.rest.value;

      ((Cons)(iterclauses.value)).thirdSetter(null);
      if (!(iterclauses.rest == Stella.NIL)) {
        { Object old$PrintreadablyP$000 = Stella.$PRINTREADABLYp$.get();
          ...
          try {
            ...
            if (!(Stella.suppressWarningsP())) {
              ...
              {
                Stella.STANDARD_ERROR.nativeStream.println();
                Stella.STANDARD_ERROR.nativeStream.println(" Too many iterators in 'setof' expression.");
              }
;
            }
  ...
  public static Cons walkPrefixForeachTree(Cons tree, Object [] MV_returnarray) {
    { Cons tail = null;
      ...
      { Object [] caller_MV_returnarray = new Object[2];
        ...
        iteratorclauses = Cons.walkCursorsTree(((Cons)(tree.rest.value)), Stella.FALSE, caller_MV_returnarray);
        valueclauses = ((Cons)(caller_MV_returnarray[0]));
        continuationtest = ((Stella_Object)(caller_MV_returnarray[1]));
      }
      tree.secondSetter(null);
      ...
      if (((Cons)(tail.value)).value == Stella.SYM_STELLA_DO) {
        ...
        ((Cons)(tail.value)).rest = Stella.NIL;
        tail = tail.rest;
      }
      if (!(tail == Stella.NIL)) {
        { Object [] caller_MV_returnarray = new Object[1];

          iteratorclauses = Cons.walkPrefixCollectIntoTree(((Cons)(tail.value)), iteratorclauses, valueclauses, doactions, caller_MV_returnarray);
          doactions = ((Cons)(caller_MV_returnarray[0]));
        }
        tail.firstSetter(null);
      }
      { Cons _return_temp = Stella.list$(Stella_Object.cons(Stella.SYM_STELLA_SYS_FOREACH, Stella_Object.cons(iteratorclauses, Stella_Object.cons(Stella_Object.cons(valueclauses, Stella_Object.cons(continuationtest, Cons.walkPrefixForeachBody(iteratorclauses, valueclauses, wheretest, doactions).concatenate(Stella.NIL, Stella.NIL))), Stella.NIL))));
  ...
  public static Cons walkPrefixForeachBody(Cons iteratorclauses, Cons valueclauses, Stella_Object wheretest, Cons doactions) {
    { Cons otree = null;
      ...
      { Cons c = null;
        Cons iter001 = ((Cons)(valueclauses));

        while (!(iter001 == Stella.NIL)) {
          {
            c = ((Cons)(iter001.value));
            iter001 = iter001.rest;
          }
          Symbol.pushVariableBinding(((Symbol)(c.value)), ((StandardObject)(c.rest.value)));
          c.firstSetter(Symbol.trueVariableName(((Symbol)(c.value))));
  ...
  public static Cons walkPrefixCollectIntoTree(Cons collectintotree, Cons iterators, Cons valuebindings, Cons docode, Object [] MV_returnarray) {
    { Stella_Object collecttree = collectintotree.rest.value;
      ...
      if (Stella_Object.symbolP(intotree)) {
        ...
        {
          { Cons d = null;
            Cons iter000 = ((Cons)(valuebindings));
          ...
          { Object [] caller_MV_returnarray = new Object[1];
            ...
            intotree = Stella_Object.walkExpressionTree(intotree, null, Stella.SYM_STELLA_FOREACH, Stella.FALSE, caller_MV_returnarray);
            intovariabletype = ((StandardObject)(caller_MV_returnarray[0]));
          }
          { Stella_Object d = null;
            Cons iter001 = valuebindings;
    ...
    { Cons iteratorclauses = null;
        ...
        while (!(iter000 == Stella.NIL)) {
          ...
          { Stella_Object iteratortree = null;
            ...
            { Object [] caller_MV_returnarray = new Object[1];
              ...
              iteratortree = Stella_Object.walkExpressionTree(clause.rest.rest.value, ((StandardObject)(clause.rest.value)), Stella.SYM_STELLA_FOREACH, Stella.FALSE, caller_MV_returnarray);
      ...
      { Cons clause = null;
        ...
        while (!(iter001 == Stella.NIL)) {
          ...
          Symbol.pushVariableBinding(((Symbol)(clause.value)), ((StandardObject)(clause.rest.value)));
          clause.thirdSetter(Stella_Object.walkWithoutTypeTree(clause.rest.rest.value));
        }
      }
      continuationtest = Stella_Object.walkWithoutTypeTree(continuationtest);
      { int i = Stella.NULL_INTEGER;
        int iter002 = 1;
        int upperBound000 = iteratorclauses.length() + valueclauses.length();
      ...
      { Cons _return_temp = iteratorclauses;
        ...
        MV_returnarray[1] = continuationtest;
        return (_return_temp);
      }
    }
  }
      ...
      if (testValue000 == Stella.SYM_STELLA_IN) {
        ...
        { Cons alliteratorclauses = Stella.NIL;
          ...
          { Cons _return_temp = alliteratorclauses;
            ...
            MV_returnarray[1] = ((continuationtests.length() == 1) ? continuationtests.value : Stella_Object.cons(Stella.SYM_STELLA_AND, continuationtests.reverse().remove(Stella.SYM_STELLA_TRUE).concatenate(Stella.NIL, Stella.NIL)));
            return (_return_temp);
          }
        }
      }
...
;
        ...
        { Cons _return_temp = Stella.NIL;
          ...
          MV_returnarray[0] = Stella.NIL;
          MV_returnarray[1] = Stella.SYM_STELLA_FALSE;
          return (_return_temp);
        }
      }
      { Stella_Object collectiontree = null;
        ...
        { Object [] caller_MV_returnarray = new Object[1];
          ...
          collectiontree = Stella_Object.walkCollectionTree(ontree.rest.rest.value, Stella.TRUE, caller_MV_returnarray);
...
;
        ...
        { Cons _return_temp = Stella_Object.cons(Stella_Object.cons(iteratorvar, Stella.list$(Stella_Object.cons(Stella.SGT_STELLA_ABSTRACT_ITERATOR, Stella_Object.cons(collectiontree, Stella_Object.cons(Stella.NIL, Stella.NIL))))), Stella.NIL);
          ...
          MV_returnarray[0] = Stella.NIL;
          MV_returnarray[1] = Stella.list$(Stella_Object.cons(Stella.SYM_STELLA_NEXTp, Stella_Object.cons(iteratorvar, Stella_Object.cons(Stella.NIL, Stella.NIL))));
          return (_return_temp);
        }
      }
    }
...
;
    ...
    { Stella_Object upperbound = collectiontree.rest.rest.value;
      ...
      boolean knownboundedP = (!knownunboundedP) &&
          (Stella_Object.isaP(Stella_Object.walkExpressionTree(Stella_Object.copyConsTree(upperbound), Stella.SGT_STELLA_INTEGER, Stella.SYM_STELLA_FOREACH, Stella.FALSE, new Object[1]), Stella.SGT_STELLA_NUMBER_WRAPPER) ||
      ...
      { Cons _return_temp = Stella_Object.cons(Stella_Object.cons(iteratorvar, Stella.list$(Stella_Object.cons(Stella.SGT_STELLA_INTEGER, Stella_Object.cons(collectiontree.rest.value, Stella_Object.cons(Stella.NIL, Stella.NIL))))), ((knownunboundedP ? Stella.NIL : Stella_Object.cons(Stella_Object.cons(upperboundvar, Stella.list$(Stella_Object.cons(Stella.SGT_STELLA_INTEGER, Stella_Object.cons(upperbound, Stella_Object.cons(Stella.NIL, Stella.NIL))))), Stella.NIL))).concatenate((((knownunboundedP ||
            knownboundedP) ? Stella.NIL : Stella_Object.cons(Stella_Object.cons(unboundedvar, Stella.list$(Stella_Object.cons(Stella.SGT_STELLA_BOOLEAN, Stella_Object.cons(Stella.list$(Stella_Object.cons(Stella.SYM_STELLA_NULLp, Stella_Object.cons(upperboundvar, Stella_Object.cons(Stella.NIL, Stella.NIL)))), Stella_Object.cons(Stella.NIL, Stella.NIL))))), Stella.NIL))).concatenate(Stella.NIL, Stella.NIL), Stella.NIL));

        MV_returnarray[0] = Stella_Object.cons(Stella_Object.cons(valuevar, Stella.list$(Stella_Object.cons(Stella.SGT_STELLA_INTEGER, Stella_Object.cons(Stella.list$(Stella_Object.cons(Stella.SYM_STELLA_PROGN, Stella_Object.cons(Stella.list$(Stella_Object.cons(Stella.SYM_STELLA_SETQ, Stella_Object.cons(valuevar, Stella_Object.cons(Stella_Object.cons(iteratorvar, Stella.NIL), Stella.NIL)))), Stella_Object.cons(Stella.list$(Stella_Object.cons(Stella.SYM_STELLA_ii, Stella_Object.cons(iteratorvar, Stella_Object.cons(Stella.NIL, Stella.NIL)))), Stella_Object.cons(Stella.NIL, Stella.NIL))))), Stella_Object.cons(Stella.NIL, Stella.NIL))))), Stella.NIL);
        MV_returnarray[1] = (knownunboundedP ? ((StandardObject)(Stella.SYM_STELLA_TRUE)) : ((StandardObject)((knownboundedP ? Stella.list$(Stella_Object.cons(Stella.SYM_STELLA_le, Stella_Object.cons(iteratorvar, Stella_Object.cons(Stella_Object.cons(upperboundvar, Stella.NIL), Stella.NIL)))) : Stella.list$(Stella_Object.cons(Stella.SYM_STELLA_OR, Stella_Object.cons(unboundedvar, Stella_Object.cons(Stella_Object.cons(Stella.list$(Stella_Object.cons(Stella.SYM_STELLA_le, Stella_Object.cons(iteratorvar, Stella_Object.cons(Stella_Object.cons(upperboundvar, Stella.NIL), Stella.NIL)))), Stella.NIL), Stella.NIL))))))));
        return (_return_temp);
      }
    }
  }
      ...
      { Stella_Object collectiontree = null;
        ...
        if (dontoptimizeP &&
          ...
          { Object [] caller_MV_returnarray = new Object[1];
            ...
            collectiontree = Stella_Object.walkCollectionTree(Stella.list$(Stella_Object.cons(Stella.SYM_STELLA_ALLOCATE_ITERATOR, Stella_Object.cons(collectiontree, Stella_Object.cons(Stella.NIL, Stella.NIL)))), Stella.TRUE, caller_MV_returnarray);
            collectiontype = ((StandardObject)(caller_MV_returnarray[0]));
          }
          collectionbasetype = StandardObject.typeSpecToBaseType(collectiontype);
        }
    ...
    { Object old$Nofspecialsatloopentry$000 = Stella.$NOFSPECIALSATLOOPENTRY$.get();
      ...
      try {
        ...
        { GeneralizedSymbol testValue000 = ((GeneralizedSymbol)(tree.value));
          ...
          else if ((testValue000 == Stella.SYM_STELLA_SETOF) ||
              (testValue000 == Stella.SYM_STELLA_SET_OF)) {
            return (Cons.walkSetofTree(tree, MV_returnarray));
          }
          else {
            { OutputStringStream stream000 = OutputStringStream.newOutputStringStream();
...
;
    ...
    { Symbol classname = ((Symbol)(parsetree.rest.value));
      ...
      boolean abstractP = Stella.FALSE;
...
;
  ...
  public static MethodSlot defineMethodFromParseTree(Cons parsetree) {
    ...
    { MethodSlot method = null;
      boolean identicalmethodP = Stella.FALSE;
      ...
      if (!(identicalmethodP ||
        ...
        if (((BooleanWrapper)(KeyValueList.dynamicSlotValue(method.dynamicSlots, Stella.SYM_STELLA_SLOT_AUXILIARYp, Stella.FALSE_WRAPPER))).wrapperValue) {
          method.slotExternalP = Stella.TRUE;
        }
        else {
                    ...
                    { Object old$PrintreadablyP$000 = Stella.$PRINTREADABLYp$.get();
                      ...
                      try {
                        ...
                        if (!(Stella.suppressWarningsP())) {
                          ...
                          {
                            System.out.println();
                            System.out.println(" Illegal slot definition:");
                            System.out.println("   `" + Stella_Object.deUglifyParseTree(slotdef) + "'");
                            System.out.println(".");
                          }
;
                        }
                  ...
                  if (key == Stella.KWD_PUBLIC_SLOTS) {
                    localslot.slotPublicP = Stella.TRUE;
                  }
                  if (collect001 == null) {
                    {
                    ...
                    { Object old$PrintreadablyP$001 = Stella.$PRINTREADABLYp$.get();
                      ...
                      try {
                        ...
                        if (!(Stella.suppressWarningsP())) {
                          ...
                          {
                            System.out.println();
                            System.out.println(" Illegal inline method definition:");
                            System.out.println("   `" + Stella_Object.deUglifyParseTree(methoddef) + "'");
                            System.out.println(".");
                          }
;
                        }
...
;
  ...
  public static void setTimeValues(Cons stringForm, DecodedDateTime parsedValues) {
        ...
        while (!(iter000 == Stella.NIL)) {
          ...
          { GeneralizedSymbol testValue000 = ((GeneralizedSymbol)(formType));
            ...
            if (testValue000 == Stella.SYM_STELLA_SECONDP) {
              ...
              edu.isi.stella.javalib.Native.funcall(Symbol.lookupFunction(((Symbol)(formValue))).functionCode, null, new java.lang.Object [] {parsedValues});
            }
            else {
              { OutputStringStream stream001 = OutputStringStream.newOutputStringStream();
  ...
  public static Cons matchPattern(Cons pattern, Cons datum, int datumLength) {
    if (pattern.length() < datumLength) {
      ...
      { Cons formList = Stella.NIL;
        ...
        boolean optionalP = Stella.FALSE;
...
;
  ...
  public static GlobalVariable defineStellaGlobalVariableFromParseTree(Cons tree, String stringifiedsource, Object [] MV_returnarray) {
    { Stella_Object typetree = tree.rest.rest.value;
      ...
      boolean noinitialvalueP = Stella.FALSE;
...
;
      ...
      StandardObject.validateTypeSpecifier(((StandardObject)(typetree)), null, Stella.TRUE);
  ...
  public static ParametricTypeSpecifier yieldParametricTypeSpecifier(Cons typespectree) {
    { ParametricTypeSpecifier typespec = ParametricTypeSpecifier.newParametricTypeSpecifier();
      ...
      { Stella_Object head000 = cursor.value;
        ...
        cursor = cursor.rest;
        { Stella_Object basetype = head000;

          { Stella_Object head001 = cursor.value;

            cursor = cursor.rest;
            { Stella_Object operator = head001;
              boolean arraytypeP = Stella.FALSE;

              typespec.specifierBaseType = Surrogate.verifyType(Stella_Object.typify(basetype));
              if (StandardObject.arrayTypeSpecifierP(typespec)) {
...
;
  ...
  public Surrogate surrogatify() {
    { Cons self = this;
      ...
      if (self == Stella.NIL) {
        return (Stella.internSurrogate("NIL"));
      }
      else {
        throw ((StellaException)(StellaException.newStellaException("Cons passed to 'surrogatify'").fillInStackTrace()));
      }
    }
  }
  ...
  public static int safeTreeSize(Cons tree, Object [] MV_returnarray) {
    { Object old$DepthexceededP$000 = Stella.$DEPTHEXCEEDEDp$.get();
      ...
      try {
        Native.setBooleanSpecial(Stella.$DEPTHEXCEEDEDp$, Stella.FALSE);
        { int cutoff = 99;
          int size = Cons.safelyComputeTreeSize(tree, 0, cutoff);

          { int _return_temp = size;

            MV_returnarray[0] = Stella.wrapString(((((Boolean)(Stella.$DEPTHEXCEEDEDp$.get())).booleanValue() ||
  ...
  public static int safelyComputeTreeSize(Cons tree, int depthcount, int cutoff) {
    { int count = 1;
      ...
      if (depthcount > Stella.$DEPTHCUTOFF$) {
        Native.setBooleanSpecial(Stella.$DEPTHEXCEEDEDp$, Stella.TRUE);
        return (1);
      }
      for (;;) {
        value = tree.value;
  ...
  public static void pprintCons(Cons tree, java.io.PrintStream stream, String lparen, String rparen) {
    { Object old$PrintprettyP$000 = Stella.$PRINTPRETTYp$.get();
      ...
      try {
        Native.setBooleanSpecial(Stella.$PRINTPRETTYp$, Stella.FALSE);
  ...
  public Iterator butLast() {
    { Cons self = this;
      ...
      { AllPurposeIterator iterator = AllPurposeIterator.newAllPurposeIterator();
        ...
        iterator.firstIterationP = Stella.TRUE;
  ...
  public static Stella_Object withXmlTag(Cons tagAndStream, Cons body) {
    return (Cons.expandMarkupTagFunction(tagAndStream, body, Stella.TRUE));
  }

  public static Stella_Object withHtmlTag(Cons tagAndStream, Cons body) {
    return (Cons.expandMarkupTagFunction(tagAndStream, body, Stella.FALSE));
  }
        ...
        { Surrogate testValue000 = Stella_Object.safePrimaryType(tag);
          ...
          if (Surrogate.subtypeOfStringP(testValue000)) {
            { StringWrapper tag000 = ((StringWrapper)(tag));
              ...
              if (eolP) {
                return (Stella.list$(Stella_Object.cons(Stella.SYM_STELLA_PRINT_STREAM, Stella_Object.cons(stream, Stella_Object.cons(Stella_Object.cons(Stella.wrapString("<" + tag000.wrapperValue + ((xmlP ? "/>" : ">"))), Stella_Object.cons(Stella.SYM_STELLA_EOL, Stella.NIL)), Stella.NIL)))));
              }
              else {
                return (Stella.list$(Stella_Object.cons(Stella.SYM_STELLA_PRINT_STREAM, Stella_Object.cons(stream, Stella_Object.cons(Stella_Object.cons(Stella.wrapString("<" + tag000.wrapperValue + ((xmlP ? "/>" : ">"))), Stella.NIL), Stella.NIL)))));
              }
            }
          }
            ...
            { Stella_Object tag000 = ((Stella_Object)(tag));
              ...
              if (eolP) {
                return (Stella.list$(Stella_Object.cons(Stella.SYM_STELLA_PRINT_STREAM, Stella_Object.cons(stream, Stella_Object.cons(Stella.list$(Stella_Object.cons(Stella.wrapString("<"), Stella_Object.cons(tag000, Stella_Object.cons(Stella_Object.cons((xmlP ? Stella.wrapString("/>") : Stella.wrapString(">")), Stella_Object.cons(Stella.SYM_STELLA_EOL, Stella.NIL)), Stella.NIL)))), Stella.NIL)))));
              }
              else {
                return (Stella.list$(Stella_Object.cons(Stella.SYM_STELLA_PRINT_STREAM, Stella_Object.cons(stream, Stella_Object.cons(Stella.list$(Stella_Object.cons(Stella.wrapString("<"), Stella_Object.cons(tag000, Stella_Object.cons(Stella_Object.cons((xmlP ? Stella.wrapString("/>") : Stella.wrapString(">")), Stella.NIL), Stella.NIL)))), Stella.NIL)))));
              }
            }
          }
          else {
        ...
        { Surrogate testValue001 = Stella_Object.safePrimaryType(tag);
          ...
          if (Surrogate.subtypeOfStringP(testValue001)) {
            { StringWrapper tag000 = ((StringWrapper)(tag));
              ...
              if (eolP) {
                return (Stella.list$(Stella_Object.cons(Stella.SYM_STELLA_PROGN, Stella_Object.cons(Stella.list$(Stella_Object.cons(Stella.SYM_STELLA_PRINT_STREAM, Stella_Object.cons(stream, Stella_Object.cons(Stella_Object.cons(Stella.wrapString("<" + tagvalue + ">"), Stella.NIL), Stella.NIL)))), Stella_Object.cons(body.concatenate(Stella_Object.cons(Stella.list$(Stella_Object.cons(Stella.SYM_STELLA_PRINT_STREAM, Stella_Object.cons(stream, Stella_Object.cons(Stella_Object.cons(Stella.wrapString("</" + Native.string_subsequence(tagvalue, 0, Native.string_position(tagvalue, ' ', 0)) + ">"), Stella_Object.cons(Stella.SYM_STELLA_EOL, Stella.NIL)), Stella.NIL)))), Stella.NIL), Stella.NIL), Stella.NIL)))));
              }
              else {
                return (Stella.list$(Stella_Object.cons(Stella.SYM_STELLA_PROGN, Stella_Object.cons(Stella.list$(Stella_Object.cons(Stella.SYM_STELLA_PRINT_STREAM, Stella_Object.cons(stream, Stella_Object.cons(Stella_Object.cons(Stella.wrapString("<" + tagvalue + ">"), Stella.NIL), Stella.NIL)))), Stella_Object.cons(body.concatenate(Stella_Object.cons(Stella.list$(Stella_Object.cons(Stella.SYM_STELLA_PRINT_STREAM, Stella_Object.cons(stream, Stella_Object.cons(Stella_Object.cons(Stella.wrapString("</" + Native.string_subsequence(tagvalue, 0, Native.string_position(tagvalue, ' ', 0)) + ">"), Stella.NIL), Stella.NIL)))), Stella.NIL), Stella.NIL), Stella.NIL)))));
              }
            }
          }
            ...
            { Symbol tag000 = ((Symbol)(tag));
              ...
              if (eolP) {
                return (Stella.list$(Stella_Object.cons(Stella.SYM_STELLA_PROGN, Stella_Object.cons(Stella.list$(Stella_Object.cons(Stella.SYM_STELLA_PRINT_STREAM, Stella_Object.cons(stream, Stella_Object.cons(Stella.list$(Stella_Object.cons(Stella.wrapString("<"), Stella_Object.cons(tag000, Stella_Object.cons(Stella_Object.cons(Stella.wrapString(">"), Stella.NIL), Stella.NIL)))), Stella.NIL)))), Stella_Object.cons(body.concatenate(Stella_Object.cons(Stella.list$(Stella_Object.cons(Stella.SYM_STELLA_PRINT_STREAM, Stella_Object.cons(stream, Stella_Object.cons(Stella.list$(Stella_Object.cons(Stella.wrapString("</"), Stella_Object.cons(Stella.list$(Stella_Object.cons(Stella.SYM_STELLA_SUBSEQUENCE, Stella_Object.cons(tag000, Stella_Object.cons(Stella.list$(Stella_Object.cons(Stella.wrapInteger(0), Stella_Object.cons(Stella.list$(Stella_Object.cons(Stella.SYM_STELLA_POSITION, Stella_Object.cons(tag000, Stella_Object.cons(Stella.list$(Stella_Object.cons(Stella.wrapCharacter(' '), Stella_Object.cons(Stella.wrapInteger(0), Stella_Object.cons(Stella.NIL, Stella.NIL)))), Stella.NIL)))), Stella_Object.cons(Stella.NIL, Stella.NIL)))), Stella.NIL)))), Stella_Object.cons(Stella.wrapString(">"), Stella_Object.cons(Stella.SYM_STELLA_EOL, Stella_Object.cons(Stella.NIL, Stella.NIL)))))), Stella.NIL)))), Stella.NIL), Stella.NIL), Stella.NIL)))));
              }
              else {
                return (Stella.list$(Stella_Object.cons(Stella.SYM_STELLA_PROGN, Stella_Object.cons(Stella.list$(Stella_Object.cons(Stella.SYM_STELLA_PRINT_STREAM, Stella_Object.cons(stream, Stella_Object.cons(Stella.list$(Stella_Object.cons(Stella.wrapString("<"), Stella_Object.cons(tag000, Stella_Object.cons(Stella_Object.cons(Stella.wrapString(">"), Stella.NIL), Stella.NIL)))), Stella.NIL)))), Stella_Object.cons(body.concatenate(Stella_Object.cons(Stella.list$(Stella_Object.cons(Stella.SYM_STELLA_PRINT_STREAM, Stella_Object.cons(stream, Stella_Object.cons(Stella.list$(Stella_Object.cons(Stella.wrapString("</"), Stella_Object.cons(Stella.list$(Stella_Object.cons(Stella.SYM_STELLA_SUBSEQUENCE, Stella_Object.cons(tag000, Stella_Object.cons(Stella.list$(Stella_Object.cons(Stella.wrapInteger(0), Stella_Object.cons(Stella.list$(Stella_Object.cons(Stella.SYM_STELLA_POSITION, Stella_Object.cons(tag000, Stella_Object.cons(Stella.list$(Stella_Object.cons(Stella.wrapCharacter(' '), Stella_Object.cons(Stella.wrapInteger(0), Stella_Object.cons(Stella.NIL, Stella.NIL)))), Stella.NIL)))), Stella_Object.cons(Stella.NIL, Stella.NIL)))), Stella.NIL)))), Stella_Object.cons(Stella.wrapString(">"), Stella_Object.cons(Stella.NIL, Stella.NIL))))), Stella.NIL)))), Stella.NIL), Stella.NIL), Stella.NIL)))));
              }
            }
          }
            ...
            { Stella_Object tag000 = ((Stella_Object)(tag));
              ...
              if (eolP) {
                return (Stella.list$(Stella_Object.cons(Stella.SYM_STELLA_LET, Stella_Object.cons(Stella_Object.cons(Stella_Object.cons(tagvar, Stella.list$(Stella_Object.cons(Stella.SYM_STELLA_STRING, Stella_Object.cons(tag000, Stella_Object.cons(Stella.NIL, Stella.NIL))))), Stella.NIL), Stella_Object.cons(Stella.list$(Stella_Object.cons(Stella.SYM_STELLA_PRINT_STREAM, Stella_Object.cons(stream, Stella_Object.cons(Stella.list$(Stella_Object.cons(Stella.wrapString("<"), Stella_Object.cons(tagvar, Stella_Object.cons(Stella_Object.cons(Stella.wrapString(">"), Stella.NIL), Stella.NIL)))), Stella.NIL)))), Stella_Object.cons(body.concatenate(Stella_Object.cons(Stella.list$(Stella_Object.cons(Stella.SYM_STELLA_PRINT_STREAM, Stella_Object.cons(stream, Stella_Object.cons(Stella.list$(Stella_Object.cons(Stella.wrapString("</"), Stella_Object.cons(Stella.list$(Stella_Object.cons(Stella.SYM_STELLA_SUBSEQUENCE, Stella_Object.cons(tagvar, Stella_Object.cons(Stella.list$(Stella_Object.cons(Stella.wrapInteger(0), Stella_Object.cons(Stella.list$(Stella_Object.cons(Stella.SYM_STELLA_POSITION, Stella_Object.cons(tagvar, Stella_Object.cons(Stella.list$(Stella_Object.cons(Stella.wrapCharacter(' '), Stella_Object.cons(Stella.wrapInteger(0), Stella_Object.cons(Stella.NIL, Stella.NIL)))), Stella.NIL)))), Stella_Object.cons(Stella.NIL, Stella.NIL)))), Stella.NIL)))), Stella_Object.cons(Stella.wrapString(">"), Stella_Object.cons(Stella.SYM_STELLA_EOL, Stella_Object.cons(Stella.NIL, Stella.NIL)))))), Stella.NIL)))), Stella.NIL), Stella.NIL), Stella.NIL))))));
              }
              else {
                return (Stella.list$(Stella_Object.cons(Stella.SYM_STELLA_LET, Stella_Object.cons(Stella_Object.cons(Stella_Object.cons(tagvar, Stella.list$(Stella_Object.cons(Stella.SYM_STELLA_STRING, Stella_Object.cons(tag000, Stella_Object.cons(Stella.NIL, Stella.NIL))))), Stella.NIL), Stella_Object.cons(Stella.list$(Stella_Object.cons(Stella.SYM_STELLA_PRINT_STREAM, Stella_Object.cons(stream, Stella_Object.cons(Stella.list$(Stella_Object.cons(Stella.wrapString("<"), Stella_Object.cons(tagvar, Stella_Object.cons(Stella_Object.cons(Stella.wrapString(">"), Stella.NIL), Stella.NIL)))), Stella.NIL)))), Stella_Object.cons(body.concatenate(Stella_Object.cons(Stella.list$(Stella_Object.cons(Stella.SYM_STELLA_PRINT_STREAM, Stella_Object.cons(stream, Stella_Object.cons(Stella.list$(Stella_Object.cons(Stella.wrapString("</"), Stella_Object.cons(Stella.list$(Stella_Object.cons(Stella.SYM_STELLA_SUBSEQUENCE, Stella_Object.cons(tagvar, Stella_Object.cons(Stella.list$(Stella_Object.cons(Stella.wrapInteger(0), Stella_Object.cons(Stella.list$(Stella_Object.cons(Stella.SYM_STELLA_POSITION, Stella_Object.cons(tagvar, Stella_Object.cons(Stella.list$(Stella_Object.cons(Stella.wrapCharacter(' '), Stella_Object.cons(Stella.wrapInteger(0), Stella_Object.cons(Stella.NIL, Stella.NIL)))), Stella.NIL)))), Stella_Object.cons(Stella.NIL, Stella.NIL)))), Stella.NIL)))), Stella_Object.cons(Stella.wrapString(">"), Stella_Object.cons(Stella.NIL, Stella.NIL))))), Stella.NIL)))), Stella.NIL), Stella.NIL), Stella.NIL))))));
              }
  ...
  public static Stella_Object withOutputFile(Cons binding, Cons body) {
    { Symbol var = ((Symbol)(binding.value));
      ...
      return (Stella.list$(Stella_Object.cons(Stella.SYM_STELLA_LET, Stella_Object.cons(Stella_Object.cons(Stella_Object.cons(var, Stella.list$(Stella_Object.cons(Stella.SYM_STELLA_FILE_OUTPUT_STREAM, Stella_Object.cons(Stella.SYM_STELLA_NULL, Stella_Object.cons(Stella.NIL, Stella.NIL))))), Stella.NIL), Stella_Object.cons(Stella.list$(Stella_Object.cons(Stella.SYM_STELLA_UNWIND_PROTECT, Stella_Object.cons(Stella.list$(Stella_Object.cons(Stella.SYM_STELLA_PROGN, Stella_Object.cons(Stella.list$(Stella_Object.cons(Stella.SYM_STELLA_SETQ, Stella_Object.cons(var, Stella_Object.cons(Stella_Object.cons(Stella.list$(Stella_Object.cons(Stella.SYM_STELLA_NEW, Stella_Object.cons(Stella.SYM_STELLA_FILE_OUTPUT_STREAM, Stella_Object.cons(Stella.KWD_FILENAME, Stella_Object.cons(binding.rest.value, Stella_Object.cons(Stella.NIL, Stella.NIL)))))), Stella.NIL), Stella.NIL)))), Stella_Object.cons(body.concatenate(Stella.NIL, Stella.NIL), Stella.NIL)))), Stella_Object.cons(Stella.list$(Stella_Object.cons(Stella.SYM_STELLA_WHEN, Stella_Object.cons(Stella.list$(Stella_Object.cons(Stella.SYM_STELLA_DEFINEDp, Stella_Object.cons(var, Stella_Object.cons(Stella.NIL, Stella.NIL)))), Stella_Object.cons(Stella.list$(Stella_Object.cons(Stella.SYM_STELLA_FREE, Stella_Object.cons(var, Stella_Object.cons(Stella.NIL, Stella.NIL)))), Stella_Object.cons(Stella.NIL, Stella.NIL))))), Stella_Object.cons(Stella.NIL, Stella.NIL))))), Stella_Object.cons(Stella.NIL, Stella.NIL))))));
    }
  }
  ...
  public static Stella_Object withInputFile(Cons binding, Cons body) {
    { Symbol var = ((Symbol)(binding.value));
      ...
      return (Stella.list$(Stella_Object.cons(Stella.SYM_STELLA_LET, Stella_Object.cons(Stella_Object.cons(Stella_Object.cons(var, Stella.list$(Stella_Object.cons(Stella.SYM_STELLA_FILE_INPUT_STREAM, Stella_Object.cons(Stella.SYM_STELLA_NULL, Stella_Object.cons(Stella.NIL, Stella.NIL))))), Stella.NIL), Stella_Object.cons(Stella.list$(Stella_Object.cons(Stella.SYM_STELLA_UNWIND_PROTECT, Stella_Object.cons(Stella.list$(Stella_Object.cons(Stella.SYM_STELLA_PROGN, Stella_Object.cons(Stella.list$(Stella_Object.cons(Stella.SYM_STELLA_SETQ, Stella_Object.cons(var, Stella_Object.cons(Stella_Object.cons(Stella.list$(Stella_Object.cons(Stella.SYM_STELLA_NEW, Stella_Object.cons(Stella.SYM_STELLA_FILE_INPUT_STREAM, Stella_Object.cons(Stella.KWD_FILENAME, Stella_Object.cons(binding.rest.value, Stella_Object.cons(Stella.NIL, Stella.NIL)))))), Stella.NIL), Stella.NIL)))), Stella_Object.cons(body.concatenate(Stella.NIL, Stella.NIL), Stella.NIL)))), Stella_Object.cons(Stella.list$(Stella_Object.cons(Stella.SYM_STELLA_WHEN, Stella_Object.cons(Stella.list$(Stella_Object.cons(Stella.SYM_STELLA_DEFINEDp, Stella_Object.cons(var, Stella_Object.cons(Stella.NIL, Stella.NIL)))), Stella_Object.cons(Stella.list$(Stella_Object.cons(Stella.SYM_STELLA_FREE, Stella_Object.cons(var, Stella_Object.cons(Stella.NIL, Stella.NIL)))), Stella_Object.cons(Stella.NIL, Stella.NIL))))), Stella_Object.cons(Stella.NIL, Stella.NIL))))), Stella_Object.cons(Stella.NIL, Stella.NIL))))));
    }
  }

  public static Stella_Object messageToString(Cons body) {
    { Cons messagearguments = Cons.formatStringMessageArguments(body, Stella.FALSE);
        ...
        while (it.nextP()) {
          { Surrogate testValue000 = Stella_Object.safePrimaryType(it.value);
            ...
            if (Surrogate.subtypeOfStringP(testValue000)) {
              ...
              it.valueSetter(Stella.wrapString(Native.stringify(it.value)));
            }
            else {
              if (it.value == Stella.SYM_STELLA_EOL) {
                it.valueSetter(Stella.wrapString(Stella.EOL_STRING));
              }
              else {
  ...
  public static Stella_Object walkInform(Cons body) {
    { Cons messagearguments = Cons.formatMessageArguments(Cons.formatWalkMessageArguments(body), Stella.FALSE);
      ...
      return (Stella.list$(Stella_Object.cons(Stella.SYM_STELLA_SPECIAL, Stella_Object.cons(Stella_Object.cons(Stella.list$(Stella_Object.cons(Stella.SYM_STELLA_$PRINTREADABLYp$, Stella_Object.cons(Stella.SYM_STELLA_TRUE, Stella_Object.cons(Stella.NIL, Stella.NIL)))), Stella.NIL), Stella_Object.cons(Stella_Object.cons(Stella.SYM_STELLA_SIGNAL_TRANSLATION_WARNING, Stella.NIL), Stella_Object.cons(Stella.list$(Stella_Object.cons(Stella.SYM_STELLA_UNLESS, Stella_Object.cons(Stella_Object.cons(Stella.SYM_STELLA_SUPPRESS_WARNINGSp, Stella.NIL), Stella_Object.cons(Stella.list$(Stella_Object.cons(Stella.SYM_STELLA_PRINT_ERROR_CONTEXT, Stella_Object.cons(Stella.wrapString(">> WARNING: "), Stella_Object.cons(Stella.SYM_STELLA_STANDARD_OUTPUT, Stella_Object.cons(Stella.NIL, Stella.NIL))))), Stella_Object.cons(Stella.list$(Stella_Object.cons(Stella.SYM_STELLA_PRINT_STREAM, Stella_Object.cons(Stella.SYM_STELLA_STANDARD_OUTPUT, Stella_Object.cons(Stella.SYM_STELLA_EOL, Stella_Object.cons(Stella.wrapString(" "), Stella_Object.cons(messagearguments.concatenate(Stella.list$(Stella_Object.cons(Stella.wrapString("."), Stella_Object.cons(Stella.SYM_STELLA_EOL, Stella_Object.cons(Stella.NIL, Stella.NIL)))), Stella.NIL), Stella.NIL)))))), Stella_Object.cons(Stella.NIL, Stella.NIL)))))), Stella_Object.cons(Stella.NIL, Stella.NIL)))))));
    }
  }
  ...
  public static Stella_Object continuableError(Cons body) {
    body = Cons.formatMessageArguments(body, Stella.FALSE);
    if (((Keyword)(Stella.$TRANSLATOROUTPUTLANGUAGE$.get())) == Stella.KWD_JAVA) {
      if ((body.length() == 1) &&
          Stella_Object.isaP(body.value, Stella.SGT_STELLA_STRING_WRAPPER)) {
        return (Stella.list$(Stella_Object.cons(Stella.SYM_STELLA_LET, Stella_Object.cons(Stella_Object.cons(Stella.list$(Stella_Object.cons(Stella.SYM_STELLA_ERROR_MESSAGE_, Stella_Object.cons(Stella.wrapString(((StringWrapper)(body.value)).wrapperValue), Stella_Object.cons(Stella.NIL, Stella.NIL)))), Stella.NIL), Stella_Object.cons(Stella.list$(Stella_Object.cons(Stella.SYM_STELLA_VERBATIM, Stella_Object.cons(Stella.KWD_JAVA, Stella_Object.cons(Stella.wrapString("Native.continuableError(error_message_)"), Stella_Object.cons(Stella.NIL, Stella.NIL))))), Stella_Object.cons(Stella.NIL, Stella.NIL))))));
      }
      else {
        { Symbol streamvar = Stella.localGensym("STREAM");

          return (Stella.list$(Stella_Object.cons(Stella.SYM_STELLA_LET, Stella_Object.cons(Stella_Object.cons(Stella_Object.cons(streamvar, Stella_Object.cons(Stella.list$(Stella_Object.cons(Stella.SYM_STELLA_NEW, Stella_Object.cons(Stella.SYM_STELLA_OUTPUT_STRING_STREAM, Stella_Object.cons(Stella.NIL, Stella.NIL)))), Stella.NIL)), Stella.NIL), Stella_Object.cons(Stella.list$(Stella_Object.cons(Stella.SYM_STELLA_PRINT_STREAM, Stella_Object.cons(streamvar, Stella_Object.cons(Cons.formatMessageArguments(body, Stella.FALSE).concatenate(Stella.NIL, Stella.NIL), Stella.NIL)))), Stella_Object.cons(Stella.list$(Stella_Object.cons(Stella.SYM_STELLA_LET, Stella_Object.cons(Stella_Object.cons(Stella.list$(Stella_Object.cons(Stella.SYM_STELLA_ERROR_MESSAGE_, Stella_Object.cons(Stella.list$(Stella_Object.cons(Stella.SYM_STELLA_THE_STRING, Stella_Object.cons(streamvar, Stella_Object.cons(Stella.NIL, Stella.NIL)))), Stella_Object.cons(Stella.NIL, Stella.NIL)))), Stella.NIL), Stella_Object.cons(Stella.list$(Stella_Object.cons(Stella.SYM_STELLA_VERBATIM, Stella_Object.cons(Stella.KWD_JAVA, Stella_Object.cons(Stella.wrapString("Native.continuableError(error_message_)"), Stella_Object.cons(Stella.NIL, Stella.NIL))))), Stella_Object.cons(Stella.NIL, Stella.NIL))))), Stella_Object.cons(Stella.NIL, Stella.NIL)))))));
        }
      }
    }
    else {
  ...
  public static Stella_Object warn(Cons body) {
    ...
    if (((Keyword)(Stella.$TRANSLATOROUTPUTLANGUAGE$.get())) == Stella.KWD_COMMON_LISP) {
      ...
      return (Stella.list$(Stella_Object.cons(Stella.SYM_STELLA_PRINT_STREAM, Stella_Object.cons(Stella.SYM_STELLA_STANDARD_WARNING, Stella_Object.cons(Stella.wrapString("Warning: "), Stella_Object.cons(body.concatenate(Stella_Object.cons(Stella.SYM_STELLA_EOL, Stella.NIL), Stella.NIL), Stella.NIL))))));
    }
  }
  ...
  public static Stella_Object inform(Cons body) {
    body = Cons.formatMessageArguments(body, Stella.TRUE);
  ...
  public static Stella_Object printSpaces(Cons body) {
    if (body.rest == Stella.NIL) {
      return (Stella.list$(Stella_Object.cons(Stella.SYM_STELLA_FOREACH, Stella_Object.cons(Stella.SYM_STELLA_I, Stella_Object.cons(Stella.SYM_STELLA_IN, Stella_Object.cons(Stella.list$(Stella_Object.cons(Stella.SYM_STELLA_INTERVAL, Stella_Object.cons(Stella.wrapInteger(1), Stella_Object.cons(body.value, Stella_Object.cons(Stella.NIL, Stella.NIL))))), Stella_Object.cons(Stella.SYM_STELLA_DO, Stella_Object.cons(Stella.list$(Stella_Object.cons(Stella.SYM_STELLA_IGNORE, Stella_Object.cons(Stella.SYM_STELLA_I, Stella_Object.cons(Stella.NIL, Stella.NIL)))), Stella_Object.cons(Stella.list$(Stella_Object.cons(Stella.SYM_STELLA_PRINT_STREAM, Stella_Object.cons(Stella.SYM_STELLA_STANDARD_OUTPUT, Stella_Object.cons(Stella.wrapString(" "), Stella_Object.cons(Stella.NIL, Stella.NIL))))), Stella_Object.cons(Stella.NIL, Stella.NIL))))))))));
    }
    else {
      return (Stella.list$(Stella_Object.cons(Stella.SYM_STELLA_FOREACH, Stella_Object.cons(Stella.SYM_STELLA_I, Stella_Object.cons(Stella.SYM_STELLA_IN, Stella_Object.cons(Stella.list$(Stella_Object.cons(Stella.SYM_STELLA_INTERVAL, Stella_Object.cons(Stella.wrapInteger(1), Stella_Object.cons(body.rest.value, Stella_Object.cons(Stella.NIL, Stella.NIL))))), Stella_Object.cons(Stella.SYM_STELLA_DO, Stella_Object.cons(Stella.list$(Stella_Object.cons(Stella.SYM_STELLA_IGNORE, Stella_Object.cons(Stella.SYM_STELLA_I, Stella_Object.cons(Stella.NIL, Stella.NIL)))), Stella_Object.cons(Stella.list$(Stella_Object.cons(Stella.SYM_STELLA_PRINT_STREAM, Stella_Object.cons(body.value, Stella_Object.cons(Stella_Object.cons(Stella.wrapString(" "), Stella.NIL), Stella.NIL)))), Stella_Object.cons(Stella.NIL, Stella.NIL))))))))));
    }
  }
