...
public class StringHashTable extends AbstractHashTable {
              ...
              if ((startupfunctions != null) &&
                ...
                { Object old$Module$000 = Stella.$MODULE$.get();
                  ...
                  try {
                    ...
                    classoutputfile = Stella.string_javaMakeCodeOutputFileName(classname.wrapperValue, Stella.FALSE);
                    ...
                    OutputStream.javaOutputFileHeader(classoutputstream, Stella.string_javaMakeCodeOutputFileName(classname.wrapperValue, Stella.TRUE));
  ...
  public void removeAt(String key) {
    { StringHashTable self = this;
      ...
      if (Stella.$USE_STELLA_HASH_TABLESp$) {
        StellaHashTable.stellaHashTableRemoveAt(self.theStellaHashTable, Stella.wrapString(key));
        return;
      }
  ...
  public void insertAt(String key, Stella_Object value) {
    { StringHashTable self = this;
      ...
      if (Stella.$USE_STELLA_HASH_TABLESp$) {
        StellaHashTable.stellaHashTableInsertAt(self.theStellaHashTable, Stella.wrapString(key), value);
        return;
      }
      { java.util.HashMap nativeTable = self.theHashTable;
