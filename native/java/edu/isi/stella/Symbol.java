  ...
  public static Cons javaTranslateGeneralSymbol(Symbol tree) {
    { GlobalVariable globalvar = tree.softPermanentify().lookupGlobalVariable();
      ...
      if (globalvar == null) {
        ...
        return (Cons.javaTranslateObjectToReturnType(Stella.list$(Stella_Object.cons(Stella.SYM_STELLA_JAVA_METHOD_CALL, Stella_Object.cons(Stella.list$(Stella_Object.cons(Stella.SYM_STELLA_JAVA_IDENT, Stella_Object.cons(Stella.wrapString(""), Stella_Object.cons(Stella.NIL, Stella.NIL)))), Stella_Object.cons(Stella.list$(Stella_Object.cons(Stella.SYM_STELLA_JAVA_IDENT, Stella_Object.cons(Stella.wrapString("get"), Stella_Object.cons(Stella.NIL, Stella.NIL)))), Stella_Object.cons(Stella.list$(Stella_Object.cons(Stella.SYM_STELLA_JAVA_IDENT, Stella_Object.cons(Symbol.javaTranslateGlobalName(tree, false), Stella_Object.cons(Stella.NIL, Stella.NIL)))), Stella_Object.cons(Stella_Object.cons(Stella.SYM_STELLA_JAVA_ACTUALS, Stella.NIL), Stella_Object.cons(Stella.NIL, Stella.NIL))))))), GlobalVariable.globalVariableTypeSpec(globalvar)));
      }
      else {
        return (Stella.list$(Stella_Object.cons(Stella.SYM_STELLA_JAVA_IDENT, Stella_Object.cons(Symbol.javaTranslateGlobalName(tree, false), Stella_Object.cons(Stella.NIL, Stella.NIL)))));
      }
    }
  }
  ...
  public static StringWrapper javaTranslateGlobalName(Symbol namesymbol, boolean definitionP) {
    ...
    if (!(definitionP)) {
      if (namesymbol == Stella.SYM_STELLA_TRUE) {
        return (Stella.wrapString("true"));
      }
      if (namesymbol == Stella.SYM_STELLA_FALSE) {
        return (Stella.wrapString("false"));
      }
    }
                ...
                try {
                  ...
                  if (!(Stella.suppressWarningsP())) {
                    Stella.printErrorContext(">> WARNING: ", Stella.STANDARD_WARNING);
                    {
                      ...
                      Stella.STANDARD_WARNING.nativeStream.println("in the definition of slot `" + Stella.internSymbolInModule(owner.symbolName, ((Module)(owner.homeContext)), true) + "'.`" + Stella_Object.deUglifyParseTree(name) + "'.");
                    }
;
                  }
  ...
  public static void printSymbol(Symbol self, java.io.PrintStream stream) {
    { boolean visibleP = self == Stella.lookupSymbolInModule(self.symbolName, ((Module)(Stella.$MODULE$.get())), false);
  ...
  public static boolean visibleSymbolP(Symbol self) {
    return (self == Stella.lookupSymbolInModule(self.symbolName, ((Module)(Stella.$MODULE$.get())), false));
  }
  ...
  public static Surrogate symbolToSurrogate(Symbol self) {
    { Surrogate surrogate = Stella.lookupSurrogateInModule(self.symbolName, ((Module)(self.homeContext)), false);
  ...
  public static Symbol safeImportSymbol(Symbol symbol, Module module) {
    { String name = symbol.symbolName;
      Symbol modulesymbol = Stella.lookupSymbolInModule(name, module, false);
  ...
  public static Symbol importSymbol(Symbol symbol, Module module) {
    { String name = symbol.symbolName;
      Symbol modulesymbol = Stella.lookupSymbolInModule(name, module, true);
