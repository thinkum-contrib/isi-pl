  ...
  static void helpStartupDefclass3() {
    {
      ...
      Stella.defineFunctionObject("TYPE-TO-WALKED-NULL-VALUE-TREE", "(DEFUN (TYPE-TO-WALKED-NULL-VALUE-TREE OBJECT) ((TYPE TYPE)))", Native.find_java_method("edu.isi.stella.Surrogate", "typeToWalkedNullValueTree", new java.lang.Class [] {Native.find_java_class("edu.isi.stella.Surrogate")}), null);
  ...
  static void helpStartupDefclass4() {
    {
      ...
      { MethodSlot function = Symbol.lookupFunction(Stella.SYM_STELLA_STARTUP_DEFCLASS);
        ...
        KeyValueList.setDynamicSlotValue(function.dynamicSlots, Stella.SYM_STELLA_METHOD_STARTUP_CLASSNAME, Stella.wrapString("_Startup-Defclass"), Stella.NULL_STRING_WRAPPER);
      }
    }
  }
    ...
    { Object old$Module$000 = Stella.$MODULE$.get();
      ...
      try {
        ...
        if (Stella.currentStartupTimePhaseP(4)) {
          Stella.$RECYCLING_ENABLEDp$.setDefaultValue(new Boolean(Stella.TRUE));
          Stella.$RECYCLE_LISTS_MAINTENANCE_TIMER$ = Stella.$RECYCLE_LISTS_MAINTENANCE_INTERVAL$;
          Stella.$TRANSLATE_WITH_RECYCLE_LIST_DEBUGGINGp$ = Stella.FALSE;
        }
