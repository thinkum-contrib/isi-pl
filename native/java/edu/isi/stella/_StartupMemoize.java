    ...
    { Object old$Module$000 = Stella.$MODULE$.get();
      ...
      try {
        ...
        if (Stella.currentStartupTimePhaseP(4)) {
          ...
          { Symbol self057 = Symbol.newSymbol("MEMOIZED-NULL-VALUE");

            self057.homeContext = null;
            Stella.MEMOIZED_NULL_VALUE = self057;
          }
        }
        ...
        if (Stella.currentStartupTimePhaseP(7)) {
          ...
          { MethodSlot function = Symbol.lookupFunction(Stella.SYM_STELLA_STARTUP_MEMOIZE);
            ...
            KeyValueList.setDynamicSlotValue(function.dynamicSlots, Stella.SYM_STELLA_METHOD_STARTUP_CLASSNAME, Stella.wrapString("_Startup-Memoize"), Stella.NULL_STRING_WRAPPER);
          }
        }
        ...
        if (Stella.currentStartupTimePhaseP(9)) {
          ...
          Stella.defineStellaGlobalVariableFromStringifiedSource("(DEFGLOBAL *MEMOIZATION-ENABLED?* BOOLEAN TRUE)");
