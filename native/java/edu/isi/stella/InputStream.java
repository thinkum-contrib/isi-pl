      ...
      { TokenizerTable tok_table_ = Stella.$XML_TOKENIZER_TABLE$;
        ...
        loop000 : for (;;) {
          ...
          if ((tokentype == Stella.KWD_START_TAG) ||
            ...
            tokencontent = Stella.unescapeHtmlString(Stella.getTokenTextInternal(tok_buffer_, tok_tokenstart_ + 1, tok_cursor_ + -1, tok_size_, false));
            tokentype = Stella.KWD_ATTRIBUTE_VALUE;
          }
          else if (tokentype == Stella.KWD_UNQUOTED_ATTRIBUTE_VALUE) {
            tokencontent = Stella.unescapeHtmlString(Stella.getTokenTextInternal(tok_buffer_, tok_tokenstart_, tok_cursor_, tok_size_, false));
            tokentype = Stella.KWD_ATTRIBUTE_VALUE;
          }
...
;
  ...
  public static boolean terminateInputStreamP(InputStream self) {
    { java.io.PushbackInputStream nativeStream = self.nativeStream;
      ...
      throw InputOutputException.newInputOutputException("terminateInputStreamP: " + e.getMessage());
      }
;
      }
      self.nativeStream = null;
