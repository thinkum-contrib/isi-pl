  ...
  static void helpStartupStreams1() {
    {
      ...
      Stella.SGT_STELLA_FILE_INPUT_STREAM = ((Surrogate)(Stella.internRigidSymbolWrtModule("FILE-INPUT-STREAM", null, 1)));
      Stella.SGT_STELLA_FILE_OUTPUT_STREAM = ((Surrogate)(Stella.internRigidSymbolWrtModule("FILE-OUTPUT-STREAM", null, 1)));
      ...
      Stella.KWD_FILENAME = ((Keyword)(Stella.internRigidSymbolWrtModule("FILENAME", null, 2)));
  ...
  static void helpStartupStreams2() {
    {
      ...
      Stella.$IGNORETRANSLATIONERRORSp$.setDefaultValue(new Boolean(Stella.TRUE));
      Stella.SINGLE_QUOTE_STRING = Stella.wrapString("'");
      Stella.SINGLE_BQUOTE_STRING = Stella.wrapString("`");
  ...
  static void helpStartupStreams3() {
    {
      ...
      Stella.defineFunctionObject("INITIALIZE-STRING-OUTPUT-STREAM", "(DEFUN INITIALIZE-STRING-OUTPUT-STREAM ((SELF STRING-OUTPUT-STREAM)))", Native.find_java_method("edu.isi.stella.OutputStringStream", "initializeStringOutputStream", new java.lang.Class [] {Native.find_java_class("edu.isi.stella.OutputStringStream")}), null);
      Stella.defineMethodObject("(DEFMETHOD (THE-STRING-READER STRING) ((SELF STRING-OUTPUT-STREAM)))", Native.find_java_method("edu.isi.stella.OutputStringStream", "theStringReader", new java.lang.Class [] {}), ((java.lang.reflect.Method)(null)));
      Stella.defineFunctionObject("INITIALIZE-STRING-INPUT-STREAM", "(DEFUN INITIALIZE-STRING-INPUT-STREAM ((SELF STRING-INPUT-STREAM)))", Native.find_java_method("edu.isi.stella.InputStringStream", "initializeStringInputStream", new java.lang.Class [] {Native.find_java_class("edu.isi.stella.InputStringStream")}), null);
      ...
      { MethodSlot function = Symbol.lookupFunction(Stella.SYM_STELLA_STARTUP_STREAMS);
        ...
        KeyValueList.setDynamicSlotValue(function.dynamicSlots, Stella.SYM_STELLA_METHOD_STARTUP_CLASSNAME, Stella.wrapString("_Startup-Streams"), Stella.NULL_STRING_WRAPPER);
      }
    }
  }
    ...
    { Object old$Module$000 = Stella.$MODULE$.get();
      ...
      try {
        ...
        if (Stella.currentStartupTimePhaseP(5)) {
          ...
          { Stella_Class renamed_Class = Stella.defineClassFromStringifiedSource("LINE-ITERATOR", "(DEFCLASS LINE-ITERATOR (STREAM-ITERATOR) :PUBLIC? TRUE :DOCUMENTATION \"Iterator that yields lines from an input stream.\" :PARAMETERS ((ANY-VALUE :TYPE STRING)))");
        ...
        if (Stella.currentStartupTimePhaseP(9)) {
          ...
          Stella.$HTML_ESCAPE_TABLE$.insertAt(Stella.wrapString("lt"), Stella.wrapCharacter('<'));
          Stella.$HTML_ESCAPE_TABLE$.insertAt(Stella.wrapString("gt"), Stella.wrapCharacter('>'));
          Stella.$HTML_ESCAPE_TABLE$.insertAt(Stella.wrapString("amp"), Stella.wrapCharacter('&'));
          Stella.$HTML_ESCAPE_TABLE$.insertAt(Stella.wrapString("quot"), Stella.wrapCharacter('"'));
          Stella.$HTML_ESCAPE_TABLE$.insertAt(Stella.wrapString("apos"), Stella.wrapCharacter('\''));
          Stella.$HTML_ESCAPE_TABLE$.insertAt(Stella.wrapString("nbsp"), Stella.wrapCharacter(' '));
          Stella.$HTML_ESCAPE_TABLE$.insertAt(Stella.wrapString("NBSP"), Stella.wrapCharacter(' '));
        }
