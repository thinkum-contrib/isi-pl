      ...
      try {
        ...
        if (Stella.currentStartupTimePhaseP(7)) {
          ...
          { MethodSlot function = Symbol.lookupFunction(Stella.SYM_STELLA_STARTUP_IDL_OUTPUT);
            ...
            KeyValueList.setDynamicSlotValue(function.dynamicSlots, Stella.SYM_STELLA_METHOD_STARTUP_CLASSNAME, Stella.wrapString("_Startup-Idl-Output"), Stella.NULL_STRING_WRAPPER);
          }
        }
