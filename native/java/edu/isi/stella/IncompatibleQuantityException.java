//  -*- Mode: Java -*-
//
// IncompatibleQuantityException.java
 ...
 */
public class IncompatibleQuantityException extends StellaException {
  public IncompatibleQuantityException (String message) {
    super(message);
  }

  public static IncompatibleQuantityException newIncompatibleQuantityException(String message) {
