    ...
    { java.io.PushbackInputStream nativeStream = self.nativeStream;
      ...
      if (!(nativeStream == null)) {
        try {
          ...
          throw InputOutputException.newInputOutputException("terminateFileInputStreamP: " + e.getMessage());
        }
;
      }
      self.nativeStream = null;
  ...
  public static void initializeFileInputStream(InputFileStream self) {
    { String filename = Stella.translateLogicalPathname(self.filename);
      String ifnotexistsaction = self.ifNotExistsAction.symbolName;
      ...
      if (self.nativeStream == null) {
        { OutputStringStream stream000 = OutputStringStream.newOutputStringStream();
          ...
          stream000.nativeStream.print("initialize-file-input-stream: Could not open `" + self + "'");
