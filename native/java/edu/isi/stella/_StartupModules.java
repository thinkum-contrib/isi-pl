...
public class _StartupModules {
  static void helpStartupModules1() {
    {
      Stella.KWD_CLEAR = ((Keyword)(Stella.internRigidSymbolWrtModule("CLEAR", null, 2)));
      Stella.SGT_STELLA_UNKNOWN_SURROGATE = ((Surrogate)(Stella.internRigidSymbolWrtModule("UNKNOWN-SURROGATE", null, 1)));
      Stella.SYM_STELLA_UNKNOWN_SYMBOL = ((Symbol)(Stella.internRigidSymbolWrtModule("UNKNOWN-SYMBOL", null, 0)));
      Stella.KWD_INCLUDES = ((Keyword)(Stella.internRigidSymbolWrtModule("INCLUDES", null, 2)));
      Stella.KWD_USES = ((Keyword)(Stella.internRigidSymbolWrtModule("USES", null, 2)));
      Stella.KWD_SHADOW = ((Keyword)(Stella.internRigidSymbolWrtModule("SHADOW", null, 2)));
      Stella.KWD_CASE_SENSITIVEp = ((Keyword)(Stella.internRigidSymbolWrtModule("CASE-SENSITIVE?", null, 2)));
      Stella.KWD_APIp = ((Keyword)(Stella.internRigidSymbolWrtModule("API?", null, 2)));
      Stella.SYM_STELLA_APIp = ((Symbol)(Stella.internRigidSymbolWrtModule("API?", null, 0)));
      Stella.KWD_LISP_PACKAGE = ((Keyword)(Stella.internRigidSymbolWrtModule("LISP-PACKAGE", null, 2)));
      Stella.KWD_CPP_PACKAGE = ((Keyword)(Stella.internRigidSymbolWrtModule("CPP-PACKAGE", null, 2)));
      Stella.KWD_JAVA_PACKAGE = ((Keyword)(Stella.internRigidSymbolWrtModule("JAVA-PACKAGE", null, 2)));
      Stella.KWD_JAVA_CATCHALL_CLASS = ((Keyword)(Stella.internRigidSymbolWrtModule("JAVA-CATCHALL-CLASS", null, 2)));
      Stella.SYM_STELLA_JAVA_FLOTSAM_CLASS = ((Symbol)(Stella.internRigidSymbolWrtModule("JAVA-FLOTSAM-CLASS", null, 0)));
      Stella.KWD_NICKNAME = ((Keyword)(Stella.internRigidSymbolWrtModule("NICKNAME", null, 2)));
      Stella.KWD_CLEARABLEp = ((Keyword)(Stella.internRigidSymbolWrtModule("CLEARABLE?", null, 2)));
      Stella.KWD_PROTECT_SURROGATESp = ((Keyword)(Stella.internRigidSymbolWrtModule("PROTECT-SURROGATES?", null, 2)));
      Stella.KWD_CODE_ONLYp = ((Keyword)(Stella.internRigidSymbolWrtModule("CODE-ONLY?", null, 2)));
      Stella.KWD_REQUIRES = ((Keyword)(Stella.internRigidSymbolWrtModule("REQUIRES", null, 2)));
      Stella.KWD_DESTROY = ((Keyword)(Stella.internRigidSymbolWrtModule("DESTROY", null, 2)));
      Stella.KWD_PREORDER = ((Keyword)(Stella.internRigidSymbolWrtModule("PREORDER", null, 2)));
      Stella.SYM_STELLA_DEFINE_MODULE_FROM_STRINGIFIED_SOURCE = ((Symbol)(Stella.internRigidSymbolWrtModule("DEFINE-MODULE-FROM-STRINGIFIED-SOURCE", null, 0)));
      Stella.KWD_POSTORDER = ((Keyword)(Stella.internRigidSymbolWrtModule("POSTORDER", null, 2)));
      Stella.KWD_INORDER = ((Keyword)(Stella.internRigidSymbolWrtModule("INORDER", null, 2)));
      Stella.SYM_STELLA_STARTUP_MODULES = ((Symbol)(Stella.internRigidSymbolWrtModule("STARTUP-MODULES", null, 0)));
    }
  }
  ...
  static void helpStartupModules2() {
    {
      ...
      Stella.defineFunctionObject("COMPUTE-MODULE-AND-BARE-NAME", "(DEFUN (COMPUTE-MODULE-AND-BARE-NAME MODULE STRING) ((NAME STRING)) :PUBLIC? TRUE)", Native.find_java_method("edu.isi.stella.Stella", "computeModuleAndBareName", new java.lang.Class [] {Native.find_java_class("java.lang.String"), Native.find_java_class("[Ljava.lang.Object;")}), null);
      Stella.defineFunctionObject("QUALIFIED-NAME-MODULE-NAME", "(DEFUN (QUALIFIED-NAME-MODULE-NAME STRING) ((QUALIFIEDNAME STRING)))", Native.find_java_method("edu.isi.stella.Stella", "qualifiedNameModuleName", new java.lang.Class [] {Native.find_java_class("java.lang.String")}), null);
      Stella.defineFunctionObject("QUALIFIED-NAME-BARE-NAME", "(DEFUN (QUALIFIED-NAME-BARE-NAME STRING) ((QUALIFIEDNAME STRING)))", Native.find_java_method("edu.isi.stella.Stella", "qualifiedNameBareName", new java.lang.Class [] {Native.find_java_class("java.lang.String")}), null);
      Stella.defineFunctionObject("DWIM-MODULE-AND-BARE-NAME", "(DEFUN (DWIM-MODULE-AND-BARE-NAME MODULE STRING) ((NAME STRING) (WARN? BOOLEAN)))", Native.find_java_method("edu.isi.stella.Stella", "dwimModuleAndBareName", new java.lang.Class [] {Native.find_java_class("java.lang.String"), java.lang.Boolean.TYPE, Native.find_java_class("[Ljava.lang.Object;")}), null);
      Stella.defineFunctionObject("INTERN-QUALIFIED-NAME", "(DEFUN (INTERN-QUALIFIED-NAME GENERALIZED-SYMBOL) ((NAME STRING) (ENABLE-CASE-CONVERSION? BOOLEAN)))", Native.find_java_method("edu.isi.stella.Stella", "internQualifiedName", new java.lang.Class [] {Native.find_java_class("java.lang.String"), java.lang.Boolean.TYPE}), null);
      ...
      Stella.defineFunctionObject("INHERIT-SUPERCONTEXTS", "(DEFUN INHERIT-SUPERCONTEXTS ((MODULE MODULE)))", Native.find_java_method("edu.isi.stella.Module", "inheritSupercontexts", new java.lang.Class [] {Native.find_java_class("edu.isi.stella.Module")}), null);
      Stella.defineFunctionObject("UNINHERIT-SUPERCONTEXTS", "(DEFUN UNINHERIT-SUPERCONTEXTS ((MODULE MODULE)))", Native.find_java_method("edu.isi.stella.Module", "uninheritSupercontexts", new java.lang.Class [] {Native.find_java_class("edu.isi.stella.Module")}), null);
      ...
      Stella.defineFunctionObject("TRUE-OPTION?", "(DEFUN (TRUE-OPTION? BOOLEAN) ((VALUE OBJECT)) :GLOBALLY-INLINE? TRUE (RETURN (OR (EQL? VALUE (QUOTE TRUE)) (EQL? VALUE TRUE-WRAPPER))))", Native.find_java_method("edu.isi.stella.Stella_Object", "trueOptionP", new java.lang.Class [] {Native.find_java_class("edu.isi.stella.Stella_Object")}), null);
      ...
      Stella.defineFunctionObject("DEFINE-MODULE", "(DEFUN (DEFINE-MODULE MODULE) ((NAME STRING) (OPTIONS CONS)) :DOCUMENTATION \"Define or redefine a module named 'name' having the\noptions 'options'.  Return the new module.\" :PUBLIC? TRUE)", Native.find_java_method("edu.isi.stella.Stella", "defineModule", new java.lang.Class [] {Native.find_java_class("java.lang.String"), Native.find_java_class("edu.isi.stella.Cons")}), null);
      Stella.defineFunctionObject("IDENTICAL-MODULE-SIGNATURES?", "(DEFUN (IDENTICAL-MODULE-SIGNATURES? BOOLEAN) ((OLDMODULE MODULE) (NEWMODULE MODULE) (NEWOPTIONS STRING)))", Native.find_java_method("edu.isi.stella.Module", "identicalModuleSignaturesP", new java.lang.Class [] {Native.find_java_class("edu.isi.stella.Module"), Native.find_java_class("edu.isi.stella.Module"), Native.find_java_class("java.lang.String")}), null);
      Stella.defineFunctionObject("DEFINE-MODULE-FROM-STRINGIFIED-SOURCE", "(DEFUN (DEFINE-MODULE-FROM-STRINGIFIED-SOURCE MODULE) ((NAME STRING) (STRINGIFIEDOPTIONS STRING)) :PUBLIC? TRUE)", Native.find_java_method("edu.isi.stella.Stella", "defineModuleFromStringifiedSource", new java.lang.Class [] {Native.find_java_class("java.lang.String"), Native.find_java_class("java.lang.String")}), null);
    ...
    { Object old$Module$000 = Stella.$MODULE$.get();
      ...
      try {
        ...
        if (Stella.currentStartupTimePhaseP(7)) {
          ...
          Stella.defineFunctionObject("VISIBLE-MODULES", "(DEFUN (VISIBLE-MODULES (ITERATOR OF MODULE)) ((FROM MODULE)) :PUBLIC? TRUE :DOCUMENTATION \"Return an iterator that generates all modules visible from module `from'.\nThe generated modules are generated from most- to least-specific and \nwill start with the module `from'.\")", Native.find_java_method("edu.isi.stella.Module", "visibleModules", new java.lang.Class [] {Native.find_java_class("edu.isi.stella.Module")}), null);
          ...
          { MethodSlot function = Symbol.lookupFunction(Stella.SYM_STELLA_STARTUP_MODULES);
            ...
            KeyValueList.setDynamicSlotValue(function.dynamicSlots, Stella.SYM_STELLA_METHOD_STARTUP_CLASSNAME, Stella.wrapString("_Startup-Modules"), Stella.NULL_STRING_WRAPPER);
          }
        }
        ...
        if (Stella.currentStartupTimePhaseP(9)) {
          ...
          KeyValueList.setDynamicSlotValue(Stella.$ROOT_MODULE$.dynamicSlots, Stella.SYM_STELLA_CLEARABLEp, (false ? Stella.TRUE_WRAPPER : Stella.FALSE_WRAPPER), Stella.FALSE_WRAPPER);
          KeyValueList.setDynamicSlotValue(Stella.$STELLA_MODULE$.dynamicSlots, Stella.SYM_STELLA_CLEARABLEp, (false ? Stella.TRUE_WRAPPER : Stella.FALSE_WRAPPER), Stella.FALSE_WRAPPER);
          KeyValueList.setDynamicSlotValue(Stella.$COMMON_LISP_MODULE$.dynamicSlots, Stella.SYM_STELLA_CLEARABLEp, (false ? Stella.TRUE_WRAPPER : Stella.FALSE_WRAPPER), Stella.FALSE_WRAPPER);
        }
