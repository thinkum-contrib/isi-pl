  ...
  static void helpStartupJavaTranslate1() {
    {
      ...
      Stella.SYM_STELLA_ARG_ENUM = ((Symbol)(Stella.internRigidSymbolWrtModule("ARG_ENUM", null, 0)));
      ...
      Stella.SYM_STELLA_ELEMENTS = ((Symbol)(Stella.internRigidSymbolWrtModule("ELEMENTS", null, 0)));
      Stella.SGT_STELLA_LISP_CONS_ITERATOR = ((Surrogate)(Stella.internRigidSymbolWrtModule("LISP-CONS-ITERATOR", null, 1)));
  ...
  static void helpStartupJavaTranslate2() {
    {
      ...
      Stella.SYM_STELLA_NULL_FLOAT = ((Symbol)(Stella.internRigidSymbolWrtModule("NULL-FLOAT", null, 0)));
      Stella.SYM_STELLA_NULL_SINGLE_FLOAT = ((Symbol)(Stella.internRigidSymbolWrtModule("NULL-SINGLE-FLOAT", null, 0)));
      Stella.SYM_STELLA_NULL_CHARACTER = ((Symbol)(Stella.internRigidSymbolWrtModule("NULL-CHARACTER", null, 0)));
  ...
  static void helpStartupJavaTranslate3() {
    {
      ...
      Stella.$JAVA_OPERATOR_TABLE$ = ((KeyValueList)(Surrogate.dictionary(Stella.SGT_STELLA_KEY_VALUE_LIST, Stella_Object.cons(Stella.SYM_STELLA_ii, Stella_Object.cons(Stella_Object.cons(Stella.wrapString("++"), Stella.NIL), Stella_Object.cons(Stella.SYM_STELLA___, Stella_Object.cons(Stella_Object.cons(Stella.wrapString("--"), Stella.NIL), Stella_Object.cons(Stella.SYM_STELLA_i, Stella_Object.cons(Stella_Object.cons(Stella.wrapString("+"), Stella.NIL), Stella_Object.cons(Stella.SYM_STELLA__, Stella_Object.cons(Stella_Object.cons(Stella.wrapString("-"), Stella.NIL), Stella_Object.cons(Stella.SYM_STELLA_$, Stella_Object.cons(Stella_Object.cons(Stella.wrapString("*"), Stella.NIL), Stella_Object.cons(Stella.SYM_STELLA_s, Stella_Object.cons(Stella_Object.cons(Stella.wrapString("/"), Stella.NIL), Stella_Object.cons(Stella.SYM_STELLA_EQp, Stella_Object.cons(Stella_Object.cons(Stella.wrapString("=="), Stella.NIL), Stella_Object.cons(Stella.SYM_STELLA_g, Stella_Object.cons(Stella_Object.cons(Stella.wrapString(">"), Stella.NIL), Stella_Object.cons(Stella.SYM_STELLA_ge, Stella_Object.cons(Stella_Object.cons(Stella.wrapString(">="), Stella.NIL), Stella_Object.cons(Stella.SYM_STELLA_eg, Stella_Object.cons(Stella_Object.cons(Stella.wrapString(">="), Stella.NIL), Stella_Object.cons(Stella.SYM_STELLA_l, Stella_Object.cons(Stella_Object.cons(Stella.wrapString("<"), Stella.NIL), Stella_Object.cons(Stella.SYM_STELLA_el, Stella_Object.cons(Stella_Object.cons(Stella.wrapString("<="), Stella.NIL), Stella_Object.cons(Stella.SYM_STELLA_le, Stella_Object.cons(Stella_Object.cons(Stella.wrapString("<="), Stella.NIL), Stella_Object.cons(Stella.SYM_STELLA_AND, Stella_Object.cons(Stella_Object.cons(Stella.wrapString("&&"), Stella.NIL), Stella_Object.cons(Stella.SYM_STELLA_OR, Stella_Object.cons(Stella_Object.cons(Stella.wrapString("||"), Stella.NIL), Stella_Object.cons(Stella.SYM_STELLA_NOT, Stella_Object.cons(Stella_Object.cons(Stella.wrapString("!"), Stella.NIL), Stella_Object.cons(Stella.SYM_STELLA_CHOOSE, Stella_Object.cons(Stella_Object.cons(Stella.wrapString("?"), Stella_Object.cons(Stella.wrapString(":"), Stella.NIL)), Stella.NIL)))))))))))))))))))))))))))))))))))));
      ...
      Stella.$JAVA_LOOP_NAME_USEDp$.setDefaultValue(new Boolean(Stella.FALSE));
      Stella.$JAVA_PRIMITIVE_ARRAY_TYPE_NAMES$ = ((KeyValueList)(Surrogate.dictionary(Stella.SGT_STELLA_KEY_VALUE_LIST, Stella_Object.cons(Stella.wrapString("byte"), Stella_Object.cons(Stella.wrapString("B"), Stella_Object.cons(Stella.wrapString("char"), Stella_Object.cons(Stella.wrapString("C"), Stella_Object.cons(Stella.wrapString("double"), Stella_Object.cons(Stella.wrapString("D"), Stella_Object.cons(Stella.wrapString("float"), Stella_Object.cons(Stella.wrapString("F"), Stella_Object.cons(Stella.wrapString("int"), Stella_Object.cons(Stella.wrapString("I"), Stella_Object.cons(Stella.wrapString("long"), Stella_Object.cons(Stella.wrapString("J"), Stella_Object.cons(Stella.wrapString("short"), Stella_Object.cons(Stella.wrapString("S"), Stella_Object.cons(Stella.wrapString("boolean"), Stella_Object.cons(Stella.wrapString("Z"), Stella.NIL)))))))))))))))))));
    }
  }
  ...
  static void helpStartupJavaTranslate4() {
    {
      ...
      Stella.defineFunctionObject("JAVA-TRANSLATE-ARGUMENT-LIST-ITERATOR", "(DEFUN (JAVA-TRANSLATE-ARGUMENT-LIST-ITERATOR CONS) ((ITERATORBINDINGS (CONS OF CONS)) (CURSORBINDINGS (CONS OF CONS)) (BODY CONS)))", Native.find_java_method("edu.isi.stella.Cons", "javaTranslateArgumentListIterator", new java.lang.Class [] {Native.find_java_class("edu.isi.stella.Cons"), Native.find_java_class("edu.isi.stella.Cons"), Native.find_java_class("edu.isi.stella.Cons")}), null);
    }
  }
      ...
      try {
        ...
        if (Stella.currentStartupTimePhaseP(7)) {
          ...
          { MethodSlot function = Symbol.lookupFunction(Stella.SYM_STELLA_STARTUP_JAVA_TRANSLATE);
            ...
            KeyValueList.setDynamicSlotValue(function.dynamicSlots, Stella.SYM_STELLA_METHOD_STARTUP_CLASSNAME, Stella.wrapString("_Startup-Java-Translate"), Stella.NULL_STRING_WRAPPER);
          }
        }
