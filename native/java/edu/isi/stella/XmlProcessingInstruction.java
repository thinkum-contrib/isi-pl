...
public class XmlProcessingInstruction extends XmlObject {
  ...
  public static XmlProcessingInstruction newXmlProcessingInstruction() {
  ...
  public static Stella_Object accessXmlProcessingInstructionSlotValue(XmlProcessingInstruction self, Symbol slotname, Stella_Object value, boolean setvalueP) {
    if (slotname == Stella.SYM_STELLA_DATA) {
      if (setvalueP) {
        self.data = ((StringWrapper)(value)).wrapperValue;
      }
      else {
        value = Stella.wrapString(self.data);
      }
    }
    else {
  ...
  public Surrogate primaryType() {
    { XmlProcessingInstruction self = this;
      ...
      return (Stella.SGT_STELLA_XML_PROCESSING_INSTRUCTION);
    }
  }
