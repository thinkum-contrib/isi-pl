...
public abstract class Context extends Thing {
    ...
    if (Surrogate.subtypeOfP(Stella_Object.safePrimaryType(self), Stella.SGT_STELLA_MODULE)) {
      { Module self000 = ((Module)(self));
        ...
        { MethodSlot function = null;
          Iterator iter000 = Module.allFunctions(self000, Stella.TRUE);
        ...
        { GlobalVariable variable = null;
          Iterator iter001 = Module.allVariables(self000, Stella.TRUE);
        ...
        { Stella_Class renamed_Class = null;
          Iterator iter002 = Module.allClasses(self000, Stella.TRUE);
        ...
        { Surrogate surrogate = null;
          Iterator iter003 = Module.allSurrogates(self000, Stella.TRUE);
        ...
        if (!(self000.protectSurrogatesP())) {
          { Symbol symbol = null;
            Iterator iter004 = Module.allSymbols(self000, Stella.TRUE);
  ...
  public static World createWorld(Context parentcontext, String name) {
    { World world = World.newWorld();
      ...
      if (name != null) {
        KeyValueList.setDynamicSlotValue(world.dynamicSlots, Stella.SYM_STELLA_WORLD_NAME, Stella.wrapString(name), Stella.NULL_STRING_WRAPPER);
        { boolean foundP000 = Stella.FALSE;
  ...
  public static Stella_Object accessContextSlotValue(Context self, Symbol slotname, Stella_Object value, boolean setvalueP) {
    if (slotname == Stella.SYM_STELLA_CHILD_CONTEXTS) {
      ...
      if (setvalueP) {
        ...
        value = Stella.wrapInteger(self.contextNumber);
      }
    }
    else {
      if (setvalueP) {
