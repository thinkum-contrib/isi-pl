...
public class Stella {
  ...
  public static int $STELLA_PATCH_LEVEL$ = 21;
...
;
   ...
   * <code>string</code> represents a long integer, the behavior is undefined.
   * @param string
   * @return int
   */
          ...
          if (((char) (0x00ff & buffer[cursor])) == targetchar) {
            ...
            if (((nofescapes % 2) == 0)) {
              if (fullyescapedP) {
                ...
                if (!(((char) (0x00ff & buffer[separatorposition])) == Stella.MODULE_SEPARATOR_CHARACTER)) {
                  separatorposition = separatorposition - 1;
                }
              }
...
;
   ...
   * @return Stella_Object
   */
  public static Stella_Object lookupConfigurationProperty(String property, Wrapper defaultvalue, KeyValueList configuration) {
