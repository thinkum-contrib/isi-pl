...
public class Stella {
  ...
  public static boolean $HARDWIRED_TRANSIENTp_ON_TRANSIENT_MIXIN$ = Stella.FALSE;
   ...
   */
  public static OutputStream STANDARD_OUTPUT = null;

  /** Denotes the standard warning stream for the host language.
   */
  public static OutputStream STANDARD_WARNING = null;

  /** Denotes the standard error stream for the host language.
   */
  public static OutputStream STANDARD_ERROR = null;
  ...
  public static Keyword KWD_FILENAME = null;
  ...
  public static boolean $CLASS_HIERARCHY_BOOTEDp$ = Stella.FALSE;
  ...
  public static boolean $USE_STELLA_HASH_TABLESp$ = Stella.FALSE;
   ...
   */
  public static boolean $NEWLY_UNFINALIZED_CLASSESp$ = Stella.FALSE;
  ...
  public static boolean $TRANSLATE_WITH_RECYCLE_LIST_DEBUGGINGp$ = Stella.FALSE;
  ...
  public static Symbol SYM_STELLA_DATE_TIME_OBJECT = null;
   ...
   */
  public static boolean $REDEFINE_IDENTICAL_CLASSESp$ = Stella.FALSE;
  ...
  public static Symbol SYM_STELLA_ALL_PURPOSE_ITERATOR = null;

  public static Symbol SYM_STELLA_NESTEDITERATOR = null;
   ...
   */
  public static StringHashTable $QUOTATION_TABLE$ = null;
   ...
   */
  public static boolean $LOG_FUNCTION_CALLSp$ = Stella.FALSE;
  ...
  public static Surrogate SGT_STELLA_UNKNOWN_SURROGATE = null;

  public static Symbol SYM_STELLA_UNKNOWN_SYMBOL = null;
   ...
   */
  public static boolean $UNLINK_DISCARDED_CONTEXTS_ON_READp$ = Stella.FALSE;

  /** Eliminate pointers to discarded contexts while
   * inserting into a CS-VALUE context table.
   */
  public static boolean $UNLINK_DISCARDED_CONTEXTS_ON_WRITEp$ = Stella.FALSE;
   ...
   */
  public static boolean $CONTEXT_BACKTRACKING_MODE$ = Stella.FALSE;
  ...
  public static boolean $MEMOIZATION_ENABLEDp$ = Stella.FALSE;
   ...
   */
  public static boolean $RECORD_SIGNATURESp$ = Stella.FALSE;
   ...
   */
  public static boolean $WALK_WITH_RECORDED_SIGNATURESp$ = Stella.FALSE;
  ...
  public static Symbol SYM_STELLA_SET = null;

  public static Symbol SYM_STELLA_CPP_SYMBOL = null;

  public static Symbol SYM_STELLA_GET = null;
  ...
  public static Surrogate SGT_STELLA_CPP_CHANGE_CASE_MEMO_TABLE_000 = null;
  ...
  public static Symbol SYM_STELLA_ARG_ENUM = null;

  public static Symbol SYM_STELLA_JAVA_WHILE = null;

  public static Symbol SYM_STELLA_JAVA_CAST = null;

  public static Symbol SYM_STELLA_ELEMENTS = null;

  public static Surrogate SGT_STELLA_LISP_CONS_ITERATOR = null;
  ...
  public static int $STELLA_MINOR_VERSION_NUMBER$ = 3;

  public static String $STELLA_RELEASE_STATE$ = "";

  public static int $STELLA_PATCH_LEVEL$ = 1;
...
;
  ...
  public static int hexCharacterValue(char c) {
    { int v = Native.string_position("0123456789ABCDEF", c, 0);

      if (v == Stella.NULL_INTEGER) {
        v = Native.string_position("0123456789abcdef", c, 0);
      }
      return (v);
    }
  }
  ...
  public static String unescapeHtmlString(String input) {
    { int incursor = 0;
      ...
      loop000 : for (;;) {
        ...
        character = ((CharacterWrapper)(Stella.$HTML_ESCAPE_TABLE$.lookup(Stella.wrapString(Native.string_subsequence(input, escapestart + 1, escapeend)))));
        if (character == null) {
  ...
  public static int random(int n) {
    ...
    { int rnum = (int) Math.floor(Math.random()*n);
  ...
  public static boolean stringL(String x, String y) {
    return (Stella.stringCompare(x, y, Stella.TRUE) < 0);
  }
  ...
  public static boolean stringLessP(String x, String y) {
    return (Stella.stringCompare(x, y, Stella.FALSE) < 0);
  }
  ...
  public static int character_hashCode_(char self) {
    return (((Stella.$HASH_BYTE_RANDOM_TABLE$[(int) self]) ^ 33485726));
  }
  ...
  public static void copyFile(String fromfile, String tofile) {
    if (!Native.probeFileP(fromfile)) {
      { OutputStringStream stream000 = OutputStringStream.newOutputStringStream();

        stream000.nativeStream.println("Can't copy non-existent file: `" + fromfile + "'");
        throw ((StellaException)(StellaException.newStellaException(stream000.theStringReader()).fillInStackTrace()));
      }
    }
    { InputFileStream from = null;
      ...
      try {
        from = InputFileStream.newInputFileStream(fromfile);
        { OutputFileStream to = null;

          try {
            to = OutputFileStream.newOutputFileStream(tofile);
            { byte[] buffer = new byte[Stella.$TOKENIZER_INITIAL_BUFFER_SIZE$];
              int bytesRead = 0;

              loop000 : for (;;) {
                bytesRead = Stella.byteArrayReadSequence(buffer, from.nativeStream, 0, Stella.$TOKENIZER_INITIAL_BUFFER_SIZE$);
                if (bytesRead > 0) {
...
;
    ...
    { AllPurposeIterator iterator = AllPurposeIterator.newAllPurposeIterator();
      ...
      if (module != null) {
        if (localP) {
          ...
          { Module mod = null;
            Iterator iter000 = Module.visibleModules(module);
            Cons collect000 = null;
  ...
  public static int lookupRigidSymbolOffsetWrtModule(String name, Module module, int kindofsym) {
    { StringToIntegerHashTable offsettable = Module.selectSymbolOffsetTable(module, kindofsym);
      ...
      { Module renamed_Super = null;
        Iterator iter000 = Module.visibleModules(module).advance(1);
  ...
  /** Return the symbol named <code>name</code>.  Case sensitive.
   * @param name
   * @param kindofsym
    ...
    { Module module = ((Module)(Stella.$MODULE$.get()));
      ...
      if (Stella.qualifiedNameP(name)) {
        { Object [] caller_MV_returnarray = new Object[1];
          ...
          module = Stella.computeModuleAndBareName(name, caller_MV_returnarray);
          name = ((String)(((StringWrapper)(caller_MV_returnarray[0])).wrapperValue));
        }
      }
      if (module != null) {
        return (Stella.lookupRigidSymbolWrtModule(name, module, kindofsym));
      }
      else {
        return (null);
      }
  ...
  public static Symbol internSymbol(String name) {
    if (((Module)(Stella.$MODULE$.get())).caseSensitiveP) {
      return (((Symbol)(Stella.internRigidSymbolCaseSensitively(name, Stella.SYMBOL_SYM, Stella.FALSE))));
    }
    else {
      if (((Boolean)(Stella.$TRANSIENTOBJECTSp$.get())).booleanValue()) {
  ...
  public static Surrogate internSurrogate(String name) {
    if (((Module)(Stella.$MODULE$.get())).caseSensitiveP) {
      return (((Surrogate)(Stella.internRigidSymbolCaseSensitively(name, Stella.SURROGATE_SYM, Stella.FALSE))));
    }
    else {
  ...
  public static void initializeKernelModules() {
    ...
    KeyValueList.setDynamicSlotValue(Stella.$COMMON_LISP_MODULE$.dynamicSlots, Stella.SYM_STELLA_MODULE_LISP_PACKAGE, Stella.wrapString("CL"), Stella.NULL_STRING_WRAPPER);
  ...
  public static Symbol internTransientSymbol(String name) {
    { Symbol symbol = Stella.lookupSymbolInModule(name, ((Module)(Stella.$MODULE$.get())), Stella.FALSE);
  ...
  public static String yieldUniqueGensymName(String prefix, Module module) {
    { String gensymName = Stella.yieldGensymName(prefix, Stella.$GENSYM_COUNTER$ = Stella.$GENSYM_COUNTER$ + 1);
      ...
      while (Stella.lookupSymbolInModule(gensymName, module, Stella.FALSE) != null) {
  ...
  public static Surrogate stringToSurrogate(String self) {
    { Surrogate surrogate = Stella.internSurrogateInModule(self, ((Module)(Stella.$MODULE$.get())), Stella.FALSE);

      if ((surrogate.homeContext == ((Module)(Stella.$MODULE$.get()))) ||
          (surrogate.surrogateValue != null)) {
        return (surrogate);
      }
      return (Stella.internSurrogateInModule(self, ((Module)(Stella.$MODULE$.get())), Stella.TRUE));
    }
  }
  ...
  public static boolean qualifiedNameP(String name) {
    if (name.length() == 0) {
      return (Stella.FALSE);
    }
    else if (Native.string_memberP(name, Stella.MODULE_SEPARATOR_CHARACTER)) {
      if (name.length() > 1) {
        if (Stella.$CHARACTER_TYPE_TABLE$[(int) (name.charAt(0))] == Stella.KWD_DIGIT) {
          return (Stella.FALSE);
        }
        if ((name.charAt(0) == '.') &&
            (Stella.$CHARACTER_TYPE_TABLE$[(int) (name.charAt(1))] == Stella.KWD_DIGIT)) {
          return (Stella.FALSE);
        }
        return (Stella.TRUE);
      }
  ...
  public static GeneralizedSymbol internGeneralizedSymbol(String name) {
    if (Stella.qualifiedNameP(name)) {
      return (Stella.internQualifiedName(name, Stella.TRUE));
    }
    else if (Stella.keywordNameP(name)) {
      return (Stella.internKeyword(Native.string_rest(name)));
    }
    else if (Stella.surrogateNameP(name)) {
      return (Stella.internSurrogate(Native.string_rest(name)));
    }
    else {
      return (Stella.internSymbol(name));
    }
  }
  ...
  public static Keyword computeSymbolEscapeCode(String name, boolean casesensitiveP) {
    { String table = (casesensitiveP ? Stella.$CASE_SENSITIVE_SYMBOL_ESCAPE_CODE_TABLE$ : Stella.$SYMBOL_ESCAPE_CODE_TABLE$);
      int escapecode = 0;
      int maxescapecode = 0;
      boolean firstcharP = Stella.TRUE;
      boolean couldbenumberP = Stella.TRUE;
   ...
   * @param value
   * @return FunctionCodeWrapper
   */
  public static FunctionCodeWrapper wrapFunctionCode(java.lang.reflect.Method value) {
    if (value == null) {
      return (Stella.NULL_FUNCTION_CODE_WRAPPER);
    }
    else {
      return (FunctionCodeWrapper.newFunctionCodeWrapper(value));
    }
  }

  /** Return a literal object whose value is the METHOD-CODE 'value'.
   * @param value
   * @return MethodCodeWrapper
   */
  public static MethodCodeWrapper wrapMethodCode(java.lang.reflect.Method value) {
    if (value == null) {
      return (Stella.NULL_METHOD_CODE_WRAPPER);
    }
    else {
      return (MethodCodeWrapper.newMethodCodeWrapper(value));
    }
  }
  ...
  public static Stella_Class string_lookupClass(String name) {
    { Stella_Class renamed_Class = null;
      ...
      { Module module = null;
        Iterator iter000 = Module.visibleModules(((Module)(Stella.$MODULE$.get())));
  ...
  public static void finalizeClasses() {
    ...
    { boolean hierarchymighthavechangedP = Stella.FALSE;
      ...
      { Stella_Class renamed_Class = null;
        ...
        while (!(iter000 == Stella.NIL)) {
          ...
          if ((!renamed_Class.classFinalizedP) &&
            ...
            hierarchymighthavechangedP = Stella.TRUE;
          }
        }
      }
  ...
  public static void cleanupUnfinalizedClasses() {
    { Cons unfinalizedclasses = Stella.NIL;
      ...
      Stella.$NEWLY_UNFINALIZED_CLASSESp$ = Stella.FALSE;
    }
  }
  ...
  public static void resizeSlotCaches(int size) {
    ...
    { Stella_Class c = null;
      Iterator iter000 = Module.allClasses(null, Stella.FALSE);
  ...
  public static void disconnectClasses() {
    { Surrogate surrogate = null;
      Iterator iter000 = Module.allSurrogates(((Module)(Stella.$MODULE$.get())), Stella.FALSE);
  ...
  public static void printUnboundSurrogates(Cons args) {
    { Cons arglist = args;
      ...
      Module module = ((name != null) ? Stella.getStellaModule(name, Stella.TRUE) : ((Module)(null)));
      boolean localP = Stella.FALSE;
  ...
  public static void createClassTaxonomy() {
    { TaxonomyGraph graph = Stella.$CLASS_TAXONOMY_GRAPH$;
      ...
      { Stella_Class renamed_Class = null;
        Iterator iter001 = Module.allClasses(null, Stella.FALSE);
  ...
  public static Stella_Object yieldStringConstantTree(String string) {
    { int length = string.length();
      ...
      while ((start + Stella.$MAXIMUM_STRING_CONSTANT_SIZE$) < length) {
        chunks = Stella_Object.cons(Stella.wrapString(Native.string_subsequence(string, start, start + Stella.$MAXIMUM_STRING_CONSTANT_SIZE$)), chunks);
        start = start + Stella.$MAXIMUM_STRING_CONSTANT_SIZE$;
      }
      if (start < length) {
        chunks = Stella_Object.cons(Stella.wrapString(Native.string_subsequence(string, start, length)), chunks);
      }
      ...
      { Module module = null;
        ...
        while (iter000.nextP()) {
          ...
          { boolean testValue000 = Stella.FALSE;
            ...
            { 
              symbol = Stella.lookupSymbolInModule(name, module, Stella.TRUE);
  ...
  public static void defineFunctionObject(String name, String definition, java.lang.reflect.Method code, java.lang.reflect.Method wrappercode) {
    { Stella_Object namesymbol = ((name.charAt(0) == ' ') ? Stella.readSExpressionFromString(name) : Stella.internSymbolInModule(name, null, Stella.FALSE));
      ...
      (record.theArray)[0] = (Stella.wrapString(definition));
      (record.theArray)[1] = oldfunction;
      (record.theArray)[2] = (Stella.wrapString(((Module)(Stella.$MODULE$.get())).moduleFullName));
      if (code != null) {
        (record.theArray)[3] = (Stella.wrapFunctionCode(code));
      }
      if (wrappercode != null) {
        (record.theArray)[4] = (Stella.wrapFunctionCode(wrappercode));
      }
  ...
  public static void maintainRecycleLists() {
    ...
    { int totalsize = Stella.totalRecycleListsSize();
      ...
      boolean classredefinitionP = Stella.FALSE;
      ...
      { RecycleList list = null;
        ...
        while (!(iter000 == Stella.NIL)) {
          ...
          if ((((Stella_Class)(list.recycleListOf.surrogateValue)) != null) &&
            ...
            classredefinitionP = Stella.TRUE;
            RecycleList.clearRecycleList(list);
            list.deletedPSetter(Stella.TRUE);
          }
        }
      }
  ...
  public static int computeNextMoonPhase(int n, Keyword phase, Object [] MV_returnarray) {
    { int i = 0;
      ...
      { int _return_temp = julianDay + i;
        ...
        MV_returnarray[0] = Stella.wrapFloat(extra - i);
        return (_return_temp);
      }
    }
  }
  ...
  public static int computeCalendarDate(int julianDay, Object [] MV_returnarray) {
    { int ja = julianDay;
      ...
      { int _return_temp = yyyy;
        ...
        MV_returnarray[0] = Stella.wrapInteger(mm);
        MV_returnarray[1] = Stella.wrapInteger(dd);
  ...
  public static int getCurrentDateTime(Object [] MV_returnarray) {
    { int year = 0;
      ...
      { int _return_temp = year;
        ...
        MV_returnarray[0] = Stella.wrapInteger(month);
        MV_returnarray[1] = Stella.wrapInteger(day);
        MV_returnarray[2] = Stella.computeDayOfWeek(year, month, day);
        MV_returnarray[3] = Stella.wrapInteger(hour);
        MV_returnarray[4] = Stella.wrapInteger(minute);
        MV_returnarray[5] = Stella.wrapInteger(second);
        MV_returnarray[6] = Stella.wrapInteger(millisecond);
        return (_return_temp);
      }
    }
  }
  ...
  public static int decodeTimeInMillis(int time, Object [] MV_returnarray) {
    { int millis = (time % 1000);
      ...
      { int _return_temp = hours;
        ...
        MV_returnarray[0] = Stella.wrapInteger(mins);
        MV_returnarray[1] = Stella.wrapInteger(secs);
        MV_returnarray[2] = Stella.wrapInteger(millis);
        return (_return_temp);
      }
    }
  }
  ...
  public static Cons decomposeDateTimeString(String string, int start, int end) {
    { int stringIndex = start;
      boolean nextNegativeP = Stella.FALSE;
      boolean parsingTimeP = Stella.FALSE;
      ...
      while (stringIndex < end) {
        ...
        if (Stella.$CHARACTER_TYPE_TABLE$[(int) nextChar] == Stella.KWD_LETTER) {
          ...
          { int numericValue = Stella.digitValue(nextChar);
            ...
            boolean inFractionP = Stella.FALSE;
            ...
            { int scanIndex = Stella.NULL_INTEGER;
              ...
              loop002 : while (Stella.TRUE) {
                ...
                if ((scanIndex == end) ||
                  ...
                  if (nextNegativeP) {
                    nextNegativeP = Stella.FALSE;
                    numericValue = 0 - numericValue;
                    fractionalValue = 0 - fractionalValue;
                  }
                  if (inFractionP) {
                    partsList = Stella_Object.cons(Stella.wrapFloat(numericValue + (fractionalValue / fractionalDivisor)), partsList);
                  }
                  else {
                    partsList = Stella_Object.cons(Stella.wrapInteger(numericValue), partsList);
                  }
                  stringIndex = scanIndex;
                  break loop002;
                }
            ...
            ((prevChar == Stella.NULL_CHARACTER) ||
             (Stella.WHITESPACE_CHARS.memberP(Stella.wrapCharacter(prevChar)) ||
              (Stella.DATE_DIVIDERS.memberP(Stella.wrapCharacter(prevChar)) ||
               (parsingTimeP &&
                (Stella.$CHARACTER_TYPE_TABLE$[(int) prevChar] == Stella.KWD_DIGIT)))))) {
          nextNegativeP = Stella.TRUE;
          stringIndex = stringIndex + 1;
        }
        else if (Stella.TIME_DIVIDERS.memberP(Stella.wrapCharacter(nextChar))) {
          partsList = Stella_Object.cons(Stella.consList(Stella_Object.cons(Stella.SYM_STELLA_TIME_DIVIDER, Stella_Object.cons(Stella.wrapCharacter(nextChar), Stella.NIL))), partsList);
          parsingTimeP = Stella.TRUE;
          stringIndex = stringIndex + 1;
        }
        else if (Stella.DATE_DIVIDERS.memberP(Stella.wrapCharacter(nextChar))) {
          partsList = Stella_Object.cons(Stella.consList(Stella_Object.cons(Stella.SYM_STELLA_DATE_DIVIDER, Stella_Object.cons(Stella.wrapCharacter(nextChar), Stella.NIL))), partsList);
          parsingTimeP = Stella.FALSE;
          stringIndex = stringIndex + 1;
        }
        else if (Stella.DATE_TIME_DIVIDERS.memberP(Stella.wrapCharacter(nextChar))) {
          partsList = Stella_Object.cons(Stella.consList(Stella_Object.cons(Stella.SYM_STELLA_DATE_TIME_DIVIDER, Stella_Object.cons(Stella.wrapCharacter(nextChar), Stella.NIL))), partsList);
          parsingTimeP = Stella.TRUE;
          stringIndex = stringIndex + 1;
        }
        else if (Stella.WHITESPACE_CHARS.memberP(Stella.wrapCharacter(nextChar))) {
          parsingTimeP = Stella.FALSE;
          stringIndex = stringIndex + 1;
        }
        else if (nextChar == '+') {
      ...
      try {
        ...
        { Cons stringParts = Stella.decomposeDateTimeString(dateTimeString, start, end);
          ...
          if (stringForm == Stella.NIL) {
            ...
            { DecodedDateTime parsedValues = CalendarDate.makeCurrentDateTime().decodeCalendarDate(((timeZone == Stella.NULL_FLOAT) ? Stella.getLocalTimeZone() : timeZone));

              parsedValues.dateTimeMillis = 0.0;
              parsedValues.dateTimeSecond = 0;
              parsedValues.dateTimeMinute = 0;
              parsedValues.dateTimeHour = 0;
              parsedValues.dateTimeZone = timeZone;
              Cons.setTimeValues(stringForm, parsedValues);
              if (parsedValues.dateTimeZone == Stella.NULL_FLOAT) {
                parsedValues.dateTimeZone = Stella.getLocalTimeZoneForDate(parsedValues.dateTimeYear, parsedValues.dateTimeMonth, parsedValues.dateTimeDay, parsedValues.dateTimeHour, parsedValues.dateTimeMinute, parsedValues.dateTimeSecond);
              }
              return (parsedValues);
            }
          }
  ...
  public static DecodedDateTime parseDateTime(String dateTimeString, int start, int end, boolean errorOnMismatchP) {
    return (Stella.parseDateTimeInTimeZone(dateTimeString, Stella.NULL_FLOAT, start, end, errorOnMismatchP));
  }
  ...
  public static CalendarDate stringToCalendarDate(String input) {
    { DecodedDateTime renamed_Do = Stella.parseDateTimeInTimeZone(input, Stella.NULL_FLOAT, 0, Stella.NULL_INTEGER, Stella.FALSE);

      if (renamed_Do == null) {
        return (null);
      }
      else {
        return (renamed_Do.encodeCalendarDate());
      }
    }
  }
  ...
  public static Stella_Object unstringifyStellaSource(String source, Module module) {
    { Stella_Object result = null;
      ...
      { Object old$TransientobjectsP$000 = Stella.$TRANSIENTOBJECTSp$.get();
        ...
        try {
          Native.setBooleanSpecial(Stella.$TRANSIENTOBJECTSp$, Stella.TRUE);
  ...
  public static void printStellaFeatures() {
    System.out.println("Enabled STELLA features:");
    { Keyword feature = null;
      ...
      while (!(iter000 == Stella.NIL)) {
        ...
        System.out.println("  :" + Native.stringDowncase(feature.symbolName));
      }
    }
    {
      System.out.println();
      System.out.println("Disabled STELLA features:");
    }
;
    { Keyword feature = null;
  ...
  public static Cons getQuotedTree(String treeName, String modulename) {
    { Cons quotedtree = ((Cons)(Stella.$QUOTATION_TABLE$.lookup(treeName)));
      ...
      { Object old$Module$000 = Stella.$MODULE$.get();
        ...
        try {
          ...
          { Cons tree = ((Cons)(Stella.readSExpressionFromString(treeName)));

            quotedtree = ((Cons)(Stella_Object.permanentifyForm(tree.value)));
            Stella.$QUOTATION_TABLE$.insertAt(treeName, quotedtree);
            return (quotedtree);
          }
      ...
      { TranslationUnit unit = null;
        ...
        while (!(iter000 == Stella.NIL)) {
          ...
          if ((((Integer)(Stella.$TRANSLATIONVERBOSITYLEVEL$.get())).intValue() >= 2) &&
            ...
            System.out.println("Walking `" + unit.annotation + "'");
          }
      ...
      while (!(iter000 == Stella.NIL)) {
        ...
        { Object old$Currenttranslationunit$000 = Stella.$CURRENTTRANSLATIONUNIT$.get();
          ...
          try {
            ...
            if ((((Integer)(Stella.$TRANSLATIONVERBOSITYLEVEL$.get())).intValue() >= 2) &&
                (unit.annotation != null)) {
              System.out.println("Translating `" + unit.annotation + "'");
            }
            if (((Keyword)(Stella.$TRANSLATOROUTPUTLANGUAGE$.get())) == Stella.KWD_COMMON_LISP) {
  ...
  public static void breakProgram(String message) {
    {
      {
        System.out.println("Program break: " + message);
        System.out.println();
      }
;
  ...
  public static Symbol localGensym(String prefix) {
    ...
    { IntegerWrapper prefixcounter = ((IntegerWrapper)(((KeyValueList)(Stella.$LOCALGENSYMTABLE$.get())).lookup(Stella.wrapString(prefix))));

      if (prefixcounter == null) {
        prefixcounter = Stella.wrapInteger(0);
      }
      else {
        prefixcounter = Stella.wrapInteger(prefixcounter.wrapperValue + 1);
      }
      ((KeyValueList)(Stella.$LOCALGENSYMTABLE$.get())).insertAt(Stella.wrapString(prefix), prefixcounter);
  ...
  public static Cons yieldIllegalStatementTree() {
    { Object old$Localvariabletypetable$000 = Stella.$LOCALVARIABLETYPETABLE$.get();
      ...
      try {
        ...
        return (((Cons)(Stella_Object.walkWithoutTypeTree(Stella.list$(Stella_Object.cons(Stella.SYM_STELLA_ERROR, Stella_Object.cons(Stella.wrapString("Attempt to execute illegal statement flagged by the translator"), Stella_Object.cons(Stella.SYM_STELLA_EOL, Stella_Object.cons(Stella.wrapString("    but not yet fixed."), Stella_Object.cons(Stella.NIL, Stella.NIL))))))))));
    ...
    { Cons interntrees = Stella.list$(Stella_Object.cons(Stella.SYM_STELLA_STARTUP_TIME_PROGN, Stella_Object.cons(Stella.KWD_SYMBOLS, Stella_Object.cons(Stella.NIL, Stella.NIL))));
      ...
      { GeneralizedSymbol symbol = null;
        ...
        while (!(iter000 == Stella.NIL)) {
          ...
          if (collect000 == null) {
            {
              collect000 = Stella_Object.cons(Stella_Object.cons((Stella_Object.symbolP(symbol) ? Stella.SYM_STELLA_INTERN_SYMBOL_AT : ((Stella_Object.surrogateP(symbol) ? Stella.SYM_STELLA_INTERN_SURROGATE_AT : Stella.SYM_STELLA_INTERN_KEYWORD_AT))), Stella_Object.cons(Stella.wrapString(symbol.symbolName), Stella_Object.cons(Stella.wrapInteger(symbol.symbolId), Stella.NIL))), Stella.NIL);
  ...
  public static Symbol yieldStartupFunctionName(String file) {
    ...
    if (Stella.systemStartupFileP(file)) {
      ...
      return (Stella.internSymbolInModule("STARTUP-" + Native.stringUpcase(Stella.fileBaseName(file)), ((Module)(Stella.$MODULE$.get())), Stella.TRUE));
    }
  }
  ...
  public static void createStartupFunctionUnits() {
    { Symbol startupfnname = (Stella.incrementalTranslationP() ? ((Symbol)(null)) : Stella.yieldStartupFunctionName(((String)(Stella.$CURRENTFILE$.get()))));
      ...
      if (Stella.dontGenerateStartupCodeP()) {
        ...
        KeyValueList.setDynamicSlotValue(method.dynamicSlots, Stella.SYM_STELLA_FORWARD_DECLARATIONp, (Stella.FALSE ? Stella.TRUE_WRAPPER : Stella.FALSE_WRAPPER), Stella.FALSE_WRAPPER);
        KeyValueList.setDynamicSlotValue(method.dynamicSlots, Stella.SYM_STELLA_METHOD_STARTUP_CLASSNAME, Stella.wrapString(Symbol.yieldStartupFunctionClassname(startupfnname)), Stella.NULL_STRING_WRAPPER);
        tree = Stella.list$(Stella_Object.cons(Stella.SYM_STELLA_STARTUP_TIME_PROGN, Stella_Object.cons(Stella.KWD_METHODS, Stella_Object.cons(MethodSlot.yieldDefineStellaMethodObject(method, method, null), Stella_Object.cons(Stella_Object.cons(Stella.list$(Stella_Object.cons(Stella.SYM_STELLA_LET, Stella_Object.cons(Stella_Object.cons(Stella.list$(Stella_Object.cons(Stella.SYM_STELLA_FUNCTION, Stella_Object.cons(Stella.list$(Stella_Object.cons(Stella.SYM_STELLA_LOOKUP_FUNCTION, Stella_Object.cons(Stella.list$(Stella_Object.cons(Stella.SYM_STELLA_QUOTE, Stella_Object.cons(startupfnname, Stella_Object.cons(Stella.NIL, Stella.NIL)))), Stella_Object.cons(Stella.NIL, Stella.NIL)))), Stella_Object.cons(Stella.NIL, Stella.NIL)))), Stella.NIL), Stella_Object.cons(Stella.list$(Stella_Object.cons(Stella.SYM_STELLA_SETF, Stella_Object.cons(Stella.list$(Stella_Object.cons(Stella.SYM_STELLA_METHOD_STARTUP_CLASSNAME, Stella_Object.cons(Stella.SYM_STELLA_FUNCTION, Stella_Object.cons(Stella.NIL, Stella.NIL)))), Stella_Object.cons(Stella.wrapString(((StringWrapper)(KeyValueList.dynamicSlotValue(method.dynamicSlots, Stella.SYM_STELLA_METHOD_STARTUP_CLASSNAME, Stella.NULL_STRING_WRAPPER))).wrapperValue), Stella_Object.cons(Stella.NIL, Stella.NIL))))), Stella_Object.cons(Stella.NIL, Stella.NIL))))), Stella.NIL), Stella.NIL)))));
        ...
        KeyValueList.setDynamicSlotValue(((MethodSlot)(Cons.helpWalkAuxiliaryTree(tree, Stella.TRUE).theObject)).dynamicSlots, Stella.SYM_STELLA_METHOD_STARTUP_CLASSNAME, Stella.wrapString(Symbol.yieldStartupFunctionClassname(startupfnname)), Stella.NULL_STRING_WRAPPER);
      }
      else {
  ...
  public static void clOutputAllUnitsToFile(String sourcefile) {
    { String outputfile = Stella.makeFileName(sourcefile, Stella.KWD_LISP, Stella.FALSE);
...
;
  ...
  public static void clTranslateFile(String file, boolean relativeP) {
    if (relativeP) {
      file = Stella.makeFileName(file, Stella.KWD_STELLA, Stella.TRUE);
    }
    Stella.translateFile(file, Stella.KWD_COMMON_LISP, Stella.FALSE);
  }
    ...
    { Module context = ((pathname.charAt(0) == Stella.MODULE_SEPARATOR_CHARACTER) ? Stella.$ROOT_MODULE$ : ((Module)(null)));
      ...
      loop000 : while (componentend < lastcharpos) {
        ...
        if (symbolnameP &&
          ...
          { Context _return_temp = ((context != null) ? context : ((moduleP ? ((Module)(Stella.$MODULE$.get())) : ((Context)(Stella.$CONTEXT$.get())))));
            ...
            MV_returnarray[0] = Stella.wrapInteger(componentstart);
            return (_return_temp);
          }
        }
        if (context == null) {
      ...
      if (context == null) {
        ...
        { Context _return_temp = context;
          ...
          MV_returnarray[0] = Stella.wrapInteger(Stella.NULL_INTEGER);
          return (_return_temp);
        }
      }
    }
  ...
  public static Module computeModuleAndBareName(String name, Object [] MV_returnarray) {
    { Context module = null;
      int barenamestart = Stella.NULL_INTEGER;

      { Object [] caller_MV_returnarray = new Object[1];

        module = Stella.computeContextOrModuleFromPathname(name, Stella.TRUE, Stella.TRUE, caller_MV_returnarray);
        barenamestart = ((int)(((IntegerWrapper)(caller_MV_returnarray[0])).wrapperValue));
      }
      { Module _return_temp = ((Module)(module));

        MV_returnarray[0] = Stella.wrapString(((barenamestart != Stella.NULL_INTEGER) ? Native.string_subsequence(name, barenamestart, Stella.NULL_INTEGER) : ((String)(null))));
        return (_return_temp);
      }
    }
  }

  public static String qualifiedNameModuleName(String qualifiedname) {
    { int end = qualifiedname.length();
      ...
      { int i = Stella.NULL_INTEGER;
        ...
        while (unboundedP000 ||
          ...
          if (qualifiedname.charAt((end - i)) == Stella.MODULE_SEPARATOR_CHARACTER) {
            return (Native.string_subsequence(qualifiedname, 0, end - i));
          }
        }
      }
      return (null);
  ...
  public static String qualifiedNameBareName(String qualifiedname) {
    { int end = qualifiedname.length();
      ...
      { int i = Stella.NULL_INTEGER;
        ...
        while (unboundedP000 ||
          ...
          if (qualifiedname.charAt((end - i)) == Stella.MODULE_SEPARATOR_CHARACTER) {
            return (Native.string_subsequence(qualifiedname, (end - i) + 1, end));
          }
        }
      }
  ...
  public static Module dwimModuleAndBareName(String name, boolean warnP, Object [] MV_returnarray) {
    { Module module = null;
      int barenamestart = Stella.NULL_INTEGER;

      try {
        { Context value000 = null;
          int value001 = Stella.NULL_INTEGER;

          { Object [] caller_MV_returnarray = new Object[1];

            value000 = Stella.computeContextOrModuleFromPathname(name, Stella.TRUE, Stella.TRUE, caller_MV_returnarray);
            value001 = ((int)(((IntegerWrapper)(caller_MV_returnarray[0])).wrapperValue));
          }
          {
        ...
        if (barenamestart != Stella.NULL_INTEGER) {
          { String modulename = Stella.qualifiedNameBareName(Stella.qualifiedNameModuleName(name));

            try {
              module = Stella.getStellaModule(modulename, Stella.FALSE);
            } catch (NoSuchContextException e001) {
              module = Stella.getStellaModule(Native.stringUpcase(modulename), Stella.FALSE);
            }
            if (warnP) {
              if (module == null) {
                Stella.STANDARD_WARNING.nativeStream.println("Warning: Module `" + Native.string_subsequence(name, 0, barenamestart - 1) + "' of symbol `" + name + "' does not exist.");
              }
              else {
                {
                  Stella.STANDARD_WARNING.nativeStream.println("Warning: Module `" + Native.string_subsequence(name, 0, barenamestart - 1) + "' of symbol `" + name + "' does not exist.");
                  Stella.STANDARD_WARNING.nativeStream.println("    Assuming you mean `" + ((Module)(module)).moduleFullName + "'.");
                }
;
              }
            }
  ...
  public static GeneralizedSymbol internQualifiedName(String name, boolean enableCaseConversionP) {
    { Module module = null;
      String barename = null;

      { Object [] caller_MV_returnarray = new Object[1];

        module = Stella.dwimModuleAndBareName(name, Stella.TRUE, caller_MV_returnarray);
        barename = ((String)(((StringWrapper)(caller_MV_returnarray[0])).wrapperValue));
      }
      if (module == null) {
        if ((barename == null) ||
            Stella.surrogateNameP(barename)) {
          return (Stella.SGT_STELLA_UNKNOWN_SURROGATE);
        }
        else {
          return (Stella.SYM_STELLA_UNKNOWN_SYMBOL);
        }
      }
      if (Stella.stringEqlP(barename, "")) {
        if ((module == ((Module)(Stella.$MODULE$.get()))) ||
            (module == Stella.$ROOT_MODULE$)) {
          return (Stella.internRigidSymbolWrtModule("/", Stella.$STELLA_MODULE$, Stella.SYMBOL_SYM));
        }
        else {
          {
            Stella.STANDARD_WARNING.nativeStream.println("Warning: Empty symbol name encountered");
            return (Stella.SYM_STELLA_UNKNOWN_SYMBOL);
          }
        }
      }
      if (enableCaseConversionP &&
        ...
        barename = Native.stringUpcase(barename);
      }
      if (Stella.surrogateNameP(barename)) {
        return (Stella.internRigidSymbolWrtModule(Native.string_subsequence(barename, 1, Stella.NULL_INTEGER), module, Stella.SURROGATE_SYM));
      }
      else {
        return (Stella.internRigidSymbolWrtModule(barename, module, Stella.SYMBOL_SYM));
      }
    }
  }

  public static Context helpGetStellaContextOrModule(String pathname, boolean moduleP) {
    if (Stella.qualifiedNameP(pathname)) {
      return (Stella.computeContextOrModuleFromPathname(pathname, moduleP, Stella.FALSE, new Object[1]));
    }
    else {
  ...
  public static Context getStellaContext(String pathname, boolean errorP) {
    if (errorP) {
      return (Stella.helpGetStellaContextOrModule(pathname, Stella.FALSE));
    }
    else {
      try {
        return (Stella.helpGetStellaContextOrModule(pathname, Stella.FALSE));
  ...
  public static Module getStellaModule(String pathname, boolean errorP) {
    ...
    { Context context = null;
      ...
      if (errorP) {
        context = Stella.helpGetStellaContextOrModule(pathname, Stella.TRUE);
      }
      else {
        try {
          context = Stella.helpGetStellaContextOrModule(pathname, Stella.TRUE);
  ...
  public static Module findOrCreateModule(String pathname) {
    { Module module = Stella.getStellaModule(pathname, Stella.FALSE);

      if (!(module != null)) {
        module = Stella.defineModule(pathname, Stella.NIL);
      }
      return (module);
    }
  }
  ...
  public static Context string_changeContext(String contextname) {
    { Context context = Stella.getStellaContext(contextname, Stella.TRUE);
  ...
  public static Module string_changeModule(String modulename) {
    { Module module = Stella.getStellaModule(modulename, Stella.TRUE);
  ...
  public static void string_destroyContext(String self) {
    { Context context = Stella.getStellaContext(self, Stella.TRUE);
    ...
    { Object old$Shadowedsurrogates$000 = Stella.$SHADOWEDSURROGATES$.get();
      ...
      try {
        ...
        { Module module = null;
          ...
          oldmodule = Stella.getStellaModule(name, Stella.FALSE);
          if ((oldmodule != null) &&
              Module.identicalModuleSignaturesP(oldmodule, null, stringifiedoptions)) {
            return (oldmodule);
          }
          ...
          if (oldmodule != null) {
            if (Module.identicalModuleSignaturesP(oldmodule, module, null)) {
  ...
  public static Module defineModuleFromStringifiedSource(String name, String stringifiedoptions) {
    return (Stella.defineModule(name, ((Cons)(Stella.readSExpressionFromString(stringifiedoptions)))));
  }
  ...
  public static void callClearModule(Cons name) {
    { Cons arglist = name;
      Module module = Stella_Object.coerceToModule(arglist.value, Stella.TRUE);
          ...
          if (Stella.stringEqlP(cxt.contextName(), self) ||
              (Stella_Object.isaP(cxt, Stella.SGT_STELLA_MODULE) &&
               ((((Module)(cxt)).nicknames != null) &&
                ((Module)(cxt)).nicknames.memberP(Stella.wrapString(self))))) {
            if (context != null) {
              { OutputStringStream stream000 = OutputStringStream.newOutputStringStream();
    ...
    { Context context = ((Context)(Stella.$CONTEXT$.get()));
      ...
      if (namespec != null) {
        if (Surrogate.subtypeOfIntegerP(Stella_Object.safePrimaryType(namespec))) {
          ...
          { String contextname = Stella_Object.coerceToModuleName(namespec, Stella.TRUE);

            if (contextname != null) {
              context = Stella.getStellaContext(contextname, Stella.TRUE);
            }
          }
        }
      }
  ...
  public static int byteArrayReadSequence(byte[] buffer, java.io.PushbackInputStream stream, int start, int end) {
    { int n = 0;
  ...
  public static void unreadCharacterFromTokenizerBuffer(char renamed_Char, InputStream stream) {
    { TokenizerStreamState state = stream.tokenizerState;
      ...
      if (!(renamed_Char == ((char) (0x00ff & (state.buffer)[cursor])))) {
        { OutputStringStream stream000 = OutputStringStream.newOutputStringStream();
  ...
  public static String getTokenTextInternal(byte[] buffer, int start, int end, int size, boolean upcaseP) {
    ...
    { int length = end - start;
      ...
      if (upcaseP) {
        loop000 : for (;;) {
          while (start < auxend) {
            edu.isi.stella.javalib.Native.mutableString_nthSetter(result, (Stella.$CHARACTER_UPCASE_TABLE$.charAt(((int) (((char) (0x00ff & buffer[start])))))), cursor);
            cursor = cursor + 1;
            start = start + 1;
          }
          if (auxend == end) {
        ...
        loop002 : for (;;) {
          while (start < auxend) {
            edu.isi.stella.javalib.Native.mutableString_nthSetter(result, (((char) (0x00ff & buffer[start]))), cursor);
            cursor = cursor + 1;
            start = start + 1;
          }
          if (auxend == end) {
...
;
  ...
  public static int getQualifiedSymbolSeparatorPositionInternal(byte[] buffer, int tokenstart, int tokenend, int size, Keyword escapemode) {
    { int cursor = tokenend - 1;
      ...
      for (;;) {
        while (cursor >= 0) {
          if (((char) (0x00ff & buffer[cursor])) == targetchar) {
            ...
            loop002 : for (;;) {
              while ((cursor >= 0) &&
                  (((char) (0x00ff & buffer[cursor])) == '\\')) {
                nofescapes = nofescapes + 1;
                cursor = cursor - 1;
              }
              if ((cursor < 0) &&
                  (((char) (0x00ff & buffer[0])) == '\\')) {
                cursor = size - 1;
              }
              else {
                break loop002;
  ...
  public static boolean yesOrNoP(String message) {
    if (((Keyword)(Stella.$USER_QUERY_ACTION$.get())) == Stella.KWD_YES) {
      ...
      System.out.println(message + " [Auto => YES]");
      return (Stella.TRUE);
    }
    else if (((Keyword)(Stella.$USER_QUERY_ACTION$.get())) == Stella.KWD_NO_VERBOSE) {
      System.out.println(message + " [Auto => NO]");
      return (Stella.FALSE);
    }
      ...
      { String input = null;
        ...
        for (;;) {
          ...
          input = InputStream.readLine(Stella.STANDARD_INPUT, new Object[1]);
          start = 0;
          { char ch = Stella.NULL_CHARACTER;
            String vector000 = input;
            int index000 = 0;
  ...
  public static boolean yOrNP(String message) {
    if (((Keyword)(Stella.$USER_QUERY_ACTION$.get())) == Stella.KWD_YES) {
      ...
      System.out.println(message + " [Auto => Y]");
      return (Stella.TRUE);
    }
    else if (((Keyword)(Stella.$USER_QUERY_ACTION$.get())) == Stella.KWD_NO_VERBOSE) {
      System.out.println(message + " [Auto => N]");
      return (Stella.FALSE);
    }
    else if (((Keyword)(Stella.$USER_QUERY_ACTION$.get())) == Stella.KWD_ASK) {
      { String input = null;
  ...
  public static KvCons makeNamespaceTable() {
    return (Stella_Object.kvCons(Stella.wrapString("xml"), Stella.wrapString(Stella.$XML_URN$), null));
  }
  ...
  public static XmlElement makeXmlElementRespectingNamespace(String name, KvCons namespaceTable) {
    { int colonPosition = Native.string_position(name, ':', 0);
      ...
      namespaceUri = StringWrapper.unwrapString(((StringWrapper)(namespaceTable.lookup(Stella.wrapString(nsPart)))));
    ...
    if ((namespaceUri == null) ||
        ((namespaceName == null) ||
         (Stella.stringEqlP(namespaceUri, "") ||
          Stella.stringEqlP(namespaceName, "")))) {
      throw ((StellaException)(StellaException.newStellaException("namespace-name and namespace must be specified").fillInStackTrace()));
    }
  ...
  public static XmlGlobalAttribute makeXmlGlobalAttributeRespectingNamespace(String name, String namespaceName, String surfaceForm, KvCons namespaceTable) {
    { StringWrapper namespaceUri = ((StringWrapper)(namespaceTable.lookup(Stella.wrapString(namespaceName))));

      if (namespaceUri == null) {
        throw ((StellaException)(StellaException.newStellaException("Undefined Namespace for Attribute!").fillInStackTrace()));
      }
  ...
  public static XmlLocalAttribute makeXmlLocalAttribute(String name, XmlElement element) {
    { KeyValueList dictionary = element.elementDictionary;
      XmlAttribute attribute = ((XmlAttribute)(dictionary.lookup(Stella.wrapString(name))));
      ...
      if (attribute == null) {
        ...
        element.elementDictionary.insertAt(Stella.wrapString(name), attribute);
      }
  ...
  public static boolean xmlnsAttributeP(String name) {
    { int colonPosition = Native.string_position(name, ':', 0);
  ...
  public static void enableMemoization() {
    Stella.$MEMOIZATION_ENABLEDp$ = Stella.TRUE;
  }

  /** Enable memoization and use of memoized expression results.
   */
  public static void disableMemoization() {
    Stella.$MEMOIZATION_ENABLEDp$ = Stella.FALSE;
  }
  ...
  public static Demon defineDemon(String name, Cons options) {
    { Demon demon = Demon.newDemon();
      ...
      Demon olddemon = null;
      boolean activateP = Stella.FALSE;
  ...
  public static String makeMatchingNameFull(String originalname, Keyword breakoncap, Keyword breakonnumber, String breakonseparators, String removeprefix, String removesuffix, String addprefix, String addsuffix, Keyword outputcase, String outputseparator) {
    { int prefixlength = removeprefix.length();
      ...
      resultString = Cons.composeNamestringFull(Stella.decomposeNamestringFull(resultString, breakoncap, breakonnumber, breakonseparators), addprefix, addsuffix, outputcase, outputseparator, null, Stella.FALSE);
      if (Stella.stringEqlP(resultString, "")) {
        return (originalname);
      }
      else {
  ...
  public static Cons decomposeNamestringFull(String namestring, Keyword breakOnCap, Keyword breakOnNumber, String breakOnSeparators) {
    { int len = namestring.length();
      ...
      int lag = 0;
      int lead = 0;
      boolean incaprunP = Stella.FALSE;
      boolean innumberP = Stella.FALSE;
      ...
      { char c = Stella.NULL_CHARACTER;
        ...
        while (index000 < length000) {
          ...
          { boolean foundP000 = Stella.FALSE;
            ...
            if (foundP000) {
              {
                result = Stella_Object.cons(Stella.wrapString(Native.string_subsequence(namestring, lag, lead)), result);
                lag = lead + 1;
                innumberP = Stella.FALSE;
                incaprunP = Stella.FALSE;
              }
            }
            else {
              if (lag > lead) {
                  ...
                  if (Stella.lowerCaseCharacterP(c)) {
                    {
                      if (innumberP &&
                        ...
                        if (lead == lag) {
                          ...
                          result = Stella_Object.cons(Stella.wrapString(Native.string_subsequence(namestring, lag, lead + 2)), result);
                          lag = lead + 2;
                        }
                        else {
                          result = Stella_Object.cons(Stella.wrapString(Native.string_subsequence(namestring, lag, lead)), result);
                      ...
                      if (lag > lead) {
                        ...
                        if (!(lead == (lag + 1))) {
                          result = Stella_Object.cons(Stella.wrapString(Native.string_subsequence(namestring, lag, lead - 1)), result);
                          lag = lead - 1;
                        }
                      }
                      innumberP = Stella.FALSE;
      ...
      if (!(lead < lag)) {
        result = Stella_Object.cons(Stella.wrapString(Native.string_subsequence(namestring, lag, Stella.NULL_INTEGER)), result);
      }
  ...
  public static boolean heuristicAcronymP(String itemstring) {
    { boolean letterfoundP = Stella.FALSE;
      boolean numberfoundP = Stella.FALSE;
      ...
      { char c = Stella.NULL_CHARACTER;
        ...
        while (index000 < length000) {
          ...
          if (Stella.$CHARACTER_TYPE_TABLE$[(int) c] == Stella.KWD_DIGIT) {
            numberfoundP = Stella.TRUE;
          }
          else if (Stella.lowerCaseCharacterP(c) ||
              Stella.upperCaseCharacterP(c)) {
            letterfoundP = Stella.TRUE;
          }
          else if (Stella.getQuotedTree("((#\\. #\\- #\\/) \"/STELLA\")", "/STELLA").memberP(Stella.wrapCharacter(c))) {
            numberfoundP = Stella.TRUE;
          }
          else {
            return (Stella.FALSE);
  ...
  public static void translateAndOutputUnitsToFile(String file, String targetlanguage) {
    ...
    if (((Keyword)(Stella.$TRANSLATOROUTPUTLANGUAGE$.get())) == Stella.KWD_JAVA) {
      ...
      if (((Integer)(Stella.$TRANSLATIONVERBOSITYLEVEL$.get())).intValue() >= 1) {
        System.out.println("Translating `" + file + "' to `" + targetlanguage + "'...");
      }
  ...
  public static void operateOnFile(String file, Keyword operation) {
    { String targetlanguage = ((Keyword)(Stella.$TRANSLATOROUTPUTLANGUAGE$.get())).symbolName;
      ...
      boolean seeninmoduleP = Stella.FALSE;
      boolean skipP = Stella.FALSE;
              ...
              { Stella_Object tree = null;
                ...
                while (iter000.nextP()) {
                  ...
                  { Object old$TransientobjectsP$001 = Stella.$TRANSIENTOBJECTSp$.get();
                    ...
                    try {
                      Native.setBooleanSpecial(Stella.$TRANSIENTOBJECTSp$, Stella.FALSE);
                          ...
                          if (!(skipP)) {
                            { Object old$Translationphase$001 = Stella.$TRANSLATIONPHASE$.get();
                              ...
                              try {
                                ...
                                Cons.walkTopLevelTree(tree000, Stella.TRUE);
    ...
    { KeyValueList properties = ((KeyValueList)(Stella.$LOGICAL_HOST_TABLE$.lookup(host)));
      ...
      if (property != null) {
        if (property == Stella.KWD_ROOT_DIRECTORY) {
          ...
          if (value != null) {
            properties.insertAt(property, Stella.wrapString(Stella.translateLogicalPathname(Stella.fileNameAsDirectory(((StringWrapper)(value)).wrapperValue))));
          }
        }
    ...
    if ((!Native.probeFileP(file1)) ||
      ...
      { CalendarDate file1Date = Native.fileWriteDate(file1);
        ...
        if ((file1Date == null) ||
          ...
          return ((DateTimeObject.timeGreaterP(file1Date, file2Date) ? Stella.TRUE_WRAPPER : Stella.FALSE_WRAPPER));
        }
      }
    }
  }
...
;
  ...
  public static boolean translateSystem(String systemname, Keyword outputlanguage, Cons options) {
    { PropertyList self000 = PropertyList.newPropertyList();
      ...
      self000.thePlist = options;
      { PropertyList plist = self000;
        boolean twopassP = Stella.FALSE;
        boolean forcetranslationP = Stella.FALSE;
        boolean productionmodeP = Stella.TRUE;
                ...
                if (((SystemDefinition)(Stella.$CURRENTSYSTEMDEFINITION$.get())) != null) {
                  {
                    ...
                    { Cons files = Cons.filesPlusSystemStartup(SystemDefinition.systemDefinitionSourceFiles(((SystemDefinition)(Stella.$CURRENTSYSTEMDEFINITION$.get()))));
                      boolean translatedsomethingP = Stella.FALSE;
...
;
  ...
  public static void loadFile(String file) {
    ...
    { boolean toplevelinvocationP = ((String)(Stella.$CURRENTFILE$.get())) == null;
      boolean skipcommandP = Stella.FALSE;
      boolean seeninmoduleP = Stella.FALSE;
              ...
              try {
                ...
                { Stella_Object tree = null;
                  ...
                  loop000 : while (iter000.nextP()) {
                    ...
                    if (Stella_Object.safePrimaryType(tree) == Stella.SGT_STELLA_CONS) {
                          ...
                          if (Surrogate.subtypeOfSymbolP(Stella_Object.safePrimaryType(operator))) {
                            { Symbol operator000 = ((Symbol)(operator));
                              ...
                              if ((operator000 == Stella.SYM_STELLA_DEFMODULE) ||
                                ...
                                Stella_Object.evaluateCommand(tree000, Stella.FALSE);
                              }
                              else {
                      ...
                      Stella_Object.evaluateCommand(tree, Stella.FALSE);
                    }
                  }
                }
                { Object old$Translationphase$000 = Stella.$TRANSLATIONPHASE$.get();
                ...
                { Stella_Object tree = null;
                  ...
                  while (!(iter001 == Stella.NIL)) {
                    ...
                    Stella_Object.evaluateCommand(tree, Stella.TRUE);
                  }
                }
...
;
  ...
  public static void helpGetSystemFiles(String filename, List collection, boolean probefileP) {
    if ((!probefileP) ||
      ...
      collection.push(Stella.wrapString(filename));
    }
  }
  ...
  public static void cleanSystem(String systemname) {
    { SystemDefinition system = Stella.getSystemDefinition(systemname);
      ...
      { StringWrapper f = null;
        Cons iter000 = SystemDefinition.getSystemFiles(system, Stella.KWD_LISP, Stella.TRUE).theConsList;
      ...
      { StringWrapper f = null;
        Cons iter001 = SystemDefinition.getSystemFiles(system, Stella.KWD_JAVA, Stella.TRUE).theConsList;
      ...
      { StringWrapper f = null;
        Cons iter002 = SystemDefinition.getSystemFiles(system, Stella.KWD_CPP, Stella.TRUE).theConsList;
      ...
      { StringWrapper f = null;
        Cons iter003 = SystemDefinition.getSystemFiles(system, Stella.KWD_LISP_BINARY, Stella.TRUE).theConsList;
    ...
    { Object old$Translatoroutputlanguage$000 = Stella.$TRANSLATOROUTPUTLANGUAGE$.get();
      ...
      try {
        ...
        { PropertyList self000 = PropertyList.newPropertyList();
          ...
          self000.thePlist = options;
          { PropertyList plist = self000;
            boolean developmentsettingsP = Stella.FALSE;
            boolean forcetranslationP = Stella.FALSE;
            boolean forcerecompilationP = Stella.FALSE;
            ...
            boolean updatedsystemP = Stella.FALSE;
            SystemDefinition system = Stella.getSystemDefinition(systemname);
                ...
                { Cons preprocessedfiles = Stella.NIL;
                  ...
                  { StringWrapper f = null;
                    ...
                    while (!(iter000 == Stella.NIL)) {
                      ...
                      if (collect000 == null) {
                        {
                          collect000 = Stella_Object.cons(Stella.wrapString(Stella.makeFileName(f.wrapperValue, Stella.KWD_STELLA, Stella.TRUE)), Stella.NIL);
                        ...
                        {
                          collect000.rest = Stella_Object.cons(Stella.wrapString(Stella.makeFileName(f.wrapperValue, Stella.KWD_STELLA, Stella.TRUE)), Stella.NIL);
                          collect000 = collect000.rest;
                        }
                      }
                    }
                    ...
                    try {
                      ...
                      { Stella_Object f = null;
                        ...
                        while (!(iter001 == Stella.NIL)) {
                          ...
                          Stella.translateFile(((StringWrapper)(f)).wrapperValue, ((Keyword)(Stella.$TRANSLATOROUTPUTLANGUAGE$.get())), Stella.FALSE);
                        }
                      }
                  ...
                  Cons.compileAndLoadFiles(((SystemDefinition)(Stella.$CURRENTSYSTEMDEFINITION$.get())).preprocessedFiles, ((Keyword)(Stella.$TRANSLATOROUTPUTLANGUAGE$.get())), Stella.FALSE);
                  if (((List)(Stella.$CURRENT_STELLA_FEATURES$.get())).membP(Stella.KWD_USE_COMMON_LISP_STRUCTS)) {
                    { StringWrapper f = null;
                      ...
                      while (!(iter002 == Stella.NIL)) {
                        ...
                        Native.deleteFile(Stella.makeFileName(f.wrapperValue, Stella.KWD_LISP, Stella.TRUE));
                      }
                    }
                  }
...
;
  ...
  public static boolean loadSystem(String systemname, Keyword language, Cons options) {
    ...
    { PropertyList self000 = PropertyList.newPropertyList();
      ...
      { PropertyList plist = self000;
        boolean forcerecompilationP = Stella.FALSE;
        boolean startupsystemP = Stella.TRUE;
...
;
                ...
                ((SystemDefinition)(Stella.$CURRENTSYSTEMDEFINITION$.get())).loadedP = Stella.TRUE;
                if (startupsystemP) {
...
;
  ...
  public static String string_systemStartupFunctionName(String systemname) {
    return (Native.stringUpcase("startup-" + systemname + "-system"));
  }

  public static Symbol startupNameFromFile(String file) {
    if (!Native.probeFileP(Stella.makeFileName(file, Stella.KWD_STELLA, Stella.TRUE))) {
      { OutputStringStream stream000 = OutputStringStream.newOutputStringStream();

        stream000.nativeStream.print("STELLA source file `" + Stella.makeFileName(file, Stella.KWD_STELLA, Stella.TRUE) + "' does not exist");
        throw ((StellaException)(StellaException.newStellaException(stream000.theStringReader()).fillInStackTrace()));
      }
    }
    { String longname = Stella.makeFileName(file, Stella.KWD_STELLA, Stella.TRUE);
      InputFileStream inputstream = InputFileStream.newInputFileStream(longname);
      Module savedmodule = ((Module)(Stella.$MODULE$.get()));
      boolean seeninmoduleP = Stella.FALSE;
      boolean unusedP = Stella.FALSE;
...
;
  ...
  public static boolean systemStartedUpP(String systemname, String systemmodulename) {
    if (Stella.stringEqlP(Native.stringUpcase(systemname), "STELLA")) {
      return (((Module)(Stella.$MODULE$.get())) != null);
    }
    if (Stella.getStellaModule(systemmodulename, Stella.FALSE) == null) {
      return (Stella.FALSE);
    }
    { Symbol startupfunctionsymbol = Stella.lookupSymbolInModule(Stella.string_systemStartupFunctionName(systemname), Stella.getStellaModule(systemmodulename, Stella.FALSE), Stella.TRUE);
  ...
  public static StringWrapper parseConfigurationFileLine(String line, Object [] MV_returnarray) {
    { int start = 0;
        ...
        try {
          { Surrogate testValue000 = Stella_Object.safePrimaryType(value = Stella.readSExpressionFromString(valuestring));
            ...
            if (Surrogate.subtypeOfIntegerP(testValue000) ||
              ...
              value = Stella.wrapString(valuestring);
            }
          }
      ...
      { StringWrapper _return_temp = Stella.wrapString(property);
  ...
  public static KeyValueList loadConfigurationFile(String file) {
    { KeyValueList configuration = KeyValueList.newKeyValueList();
      ...
      { String line = null;
        LineIterator iter000 = InputStream.lines(InputFileStream.newInputFileStream(file));
        ...
        while (iter000.nextP()) {
          ...
          { StringWrapper key = null;
            ...
            if (key != null) {
              ...
              Stella.$SYSTEM_CONFIGURATION_TABLE$.insertAt(key, value);
            }
          }
        }
      }
   ...
   * @return Wrapper
   */
  public static Wrapper lookupConfigurationProperty(String property, Wrapper defaultvalue, KeyValueList configuration) {
    if (configuration == null) {
      configuration = Stella.$SYSTEM_CONFIGURATION_TABLE$;
    }
    { Wrapper value = ((Wrapper)(configuration.lookup(Stella.wrapString(property))));
   ...
   * @return Wrapper
   */
  public static Wrapper setConfigurationProperty(String property, Wrapper value, KeyValueList configuration) {
    if (configuration == null) {
      configuration = Stella.$SYSTEM_CONFIGURATION_TABLE$;
    }
    configuration.insertAt(Stella.wrapString(property), value);
    return (value);
  }
  ...
  public static void configureStella(String file) {
    if ((file != null) &&
      ...
      Stella.loadConfigurationFile(file);
    }
  ...
  public static Stella_Object string_getObject(String self, Stella_Object type) {
    { StringWrapper wrappedstring = Stella.wrapString(self);
  ...
  public static Stella_Object integer_getObject(int self, Stella_Object type) {
    { IntegerWrapper wrappedinteger = Stella.wrapInteger(self);
  ...
  public static Iterator stringToClasses(String string, boolean exactP) {
    { AllPurposeIterator iterator = AllPurposeIterator.newAllPurposeIterator();
      ...
      iterator.iteratorNestedIterator = Module.allClasses(null, Stella.FALSE);
      ...
      iterator.iteratorNextCode = Native.find_java_method("edu.isi.stella.AllPurposeIterator", "filteredNestedIteratorNextP", new java.lang.Class [] {Native.find_java_class("edu.isi.stella.AllPurposeIterator")});
      iterator.iteratorObject = Stella.wrapString(string);
  ...
  public static Stella_Object stringToClass(String string) {
    return (Stella.string_getStellaClass(string, Stella.FALSE));
  }
  ...
  public static String yieldExplodedMethodName(String dottedstring, Object [] MV_returnarray) {
    { int dotposition = Native.string_position(dottedstring, '.', 0);
      ...
      { String _return_temp = firststring;
        ...
        MV_returnarray[0] = Stella.wrapString(secondstring);
        return (_return_temp);
      }
    }
  }
  ...
  public static Stella_Object stringToSlot(String string) {
    if (Stella.dottedStringP(string)) {
      { String classstring = null;
        ...
        { Stella_Class renamed_Class = Stella.string_getStellaClass(classstring, Stella.FALSE);
  ...
  public static Stella_Object stringToSurrogateValue(String string) {
    { Surrogate sgt = null;
      Iterator iter000 = Module.allSurrogates(null, Stella.FALSE);
  ...
  public static void printDocumentationString(String string, int indent, OutputStream stream) {
    { boolean freshlineP = Stella.TRUE;
      ...
      { char renamed_Char = Stella.NULL_CHARACTER;
        ...
        while (index000 < length000) {
          ...
          if (freshlineP) {
            ...
            freshlineP = Stella.FALSE;
          }
          stream.nativeStream.print(renamed_Char);
          if (renamed_Char == '\n') {
            freshlineP = Stella.TRUE;
          }
        }
      }
  ...
  public static String cppMakeCodeOutputFileName(String filename) {
    return (Stella.makeFileName(filename, Stella.KWD_CPP_CODE, Stella.FALSE));
  }

  public static String cppMakeHeaderOutputFileName(String filename) {
    return (Stella.makeFileName(filename, Stella.KWD_CPP_HEADER, Stella.FALSE));
  }
  ...
  public static void cppStandaloneOutputImportDeclarations(String headerfilename) {
    Stella.cppOutputIncludeDirective(Stella.makeFileName("cpp-standalone", Stella.KWD_CPP_HEADER, Stella.TRUE), Stella.TRUE);
    Stella.cppOutputIncludeDirective(headerfilename, Stella.TRUE);
  ...
  public static String cppRelativizeHeaderFile(String headerfile, String systemname) {
    ...
    { Object old$Currentsystemdefinition$000 = Stella.$CURRENTSYSTEMDEFINITION$.get();
      ...
      try {
        ...
        if (((SystemDefinition)(Stella.$CURRENTSYSTEMDEFINITION$.get())) != null) {
          {
            { String directoryfile = Stella.makeFileName("dummy", Stella.KWD_CPP_HEADER, Stella.TRUE);
  ...
  public static void cppOutputImportDeclarations(String systemname) {
    ...
    { Object old$Currentsystemdefinition$000 = Stella.$CURRENTSYSTEMDEFINITION$.get();
      ...
      try {
        ...
        if (((SystemDefinition)(Stella.$CURRENTSYSTEMDEFINITION$.get())) != null) {
          {
            Stella.cppOutputIncludeDirective(Stella.cppRelativizeHeaderFile(Stella.makeFileName(Stella.cppYieldSystemHeaderFileName(systemname), Stella.KWD_CPP_HEADER, Stella.TRUE), systemname), Stella.FALSE);
            ((OutputStream)(Stella.$CURRENT_STREAM$.get())).nativeStream.println();
          }
        }
        else {
...
;
  ...
  public static String cppYieldMainFileName() {
    return (Stella.makeFileName("main", Stella.KWD_CPP_CODE, Stella.TRUE));
  }

  public static void cppOutputAllUnitsToFile(String filename) {
    { String codeoutputfile = Stella.makeFileName(filename, Stella.KWD_CPP_CODE, Stella.FALSE);
      String headeroutputfile = Stella.makeFileName(filename, Stella.KWD_CPP_HEADER, Stella.FALSE);
      OutputFileStream codeoutputstream = OutputFileStream.newOutputFileStream(codeoutputfile);
      OutputFileStream headeroutputstream = OutputFileStream.newOutputFileStream(headeroutputfile);
      ...
      { Object old$CurrentStream$000 = Stella.$CURRENT_STREAM$.get();
        ...
        try {
          ...
          System.out.println("Writing `" + headeroutputfile + "'...");
          ...
          System.out.println("Writing `" + codeoutputfile + "'...");
...
;
  ...
  public static void cppTranslateFile(String filename) {
    Stella.translateFile(filename, Stella.KWD_CPP, Stella.FALSE);
  }

  public static void cppStandaloneTranslateFile(String filename) {
    Stella.translateFile(filename, Stella.KWD_CPP_STANDALONE, Stella.FALSE);
  }
  ...
  public static String cppYieldSystemHeaderFileGuard(String systemname) {
    return ("_STELLA_" + Native.stringUpcase(systemname) + "_SYSTEM_HH");
  }
  ...
  public static void cppOutputSystemHeaderFile() {
    { SystemDefinition system = ((SystemDefinition)(Stella.$CURRENTSYSTEMDEFINITION$.get()));
      ...
      String headeroutputfile = Stella.makeFileName(Stella.cppYieldSystemHeaderFileName(systemname), Stella.KWD_CPP_HEADER, Stella.TRUE);
      OutputFileStream headeroutputstream = OutputFileStream.newOutputFileStream(headeroutputfile);
...
;
          ...
          { Module currentnamespacemodule = null;
            ...
            { Stella_Class renamed_Class = null;
              Iterator iter001 = Module.allClasses(((Module)(Stella.$MODULE$.get())), Stella.TRUE);
...
;
          ...
          if (Stella.stringEqlP(systemname, "stella")) {
            Stella.cppOutputIncludeDirective(Stella.cppRelativizeHeaderFile(Stella_Object.makeFileNameFromRelativePath(Stella.list$(Stella_Object.cons(Stella.wrapString("cpp-lib"), Stella_Object.cons(Stella.wrapString("cpp-primal"), Stella_Object.cons(Stella.NIL, Stella.NIL)))), Stella.KWD_CPP_HEADER), systemname), Stella.FALSE);
          }
          { StringWrapper file = null;
            ...
            while (!(iter002 == Stella.NIL)) {
              ...
              Stella.cppOutputIncludeDirective(Stella.cppRelativizeHeaderFile(Stella.makeFileName(file.wrapperValue, Stella.KWD_CPP_HEADER, Stella.TRUE), systemname), Stella.FALSE);
            }
          }
          {
            ((OutputStream)(Stella.$CURRENT_STREAM$.get())).nativeStream.println();
  ...
  public static String cppYieldStellaRootDirectory() {
    { Object old$Currentsystemdefinition$000 = Stella.$CURRENTSYSTEMDEFINITION$.get();
      ...
      try {
        ...
        if (((SystemDefinition)(Stella.$CURRENTSYSTEMDEFINITION$.get())) != null) {
          {
            return (Stella.cppYieldSystemsRootDirectory() + "/" + Stella.fileBaseName(Stella.directoryFileName(Stella.directoryParentDirectory(Stella.makeFileName("dummy", Stella.KWD_CPP_CODE, Stella.TRUE), 1))));
          }
        }
        else {
          {
...
;
  ...
  public static void cppOutputSystemMakefile() {
    { String makefile = Stella.makeFileName("Makefile", Stella.KWD_STELLA, Stella.TRUE);
      ...
      if (!(Native.probeFileP(templatefile))) {
        { Object old$Currentsystemdefinition$000 = Stella.$CURRENTSYSTEMDEFINITION$.get();
          ...
          try {
            ...
            if (((SystemDefinition)(Stella.$CURRENTSYSTEMDEFINITION$.get())) != null) {
              {
                makefile = Stella.makeFileName("Makefile-default", Stella.KWD_STELLA, Stella.TRUE);
...
;
      ...
      { KeyValueList variables = KeyValueList.newKeyValueList();
        ...
        variables.insertAt(Stella.wrapString("SYSTEM-NAME"), Stella.wrapString(system.name));
        variables.insertAt(Stella.wrapString("PROGRAM-NAME"), Stella.wrapString(system.name));
        variables.insertAt(Stella.wrapString("MAIN-NAME"), Stella.wrapString(Stella.fileNameWithoutDirectory(Stella.cppYieldMainFileName())));
        variables.insertAt(Stella.wrapString("SYSTEMS-ROOT"), Stella.wrapString(Stella.cppYieldSystemsRootDirectory()));
        variables.insertAt(Stella.wrapString("STELLA-ROOT"), Stella.wrapString(Stella.cppYieldStellaRootDirectory()));
        { StringWrapper file = null;
          ...
          while (!(iter000 == Stella.NIL)) {
            ...
            systemfiles.nativeStream.print(Stella.fileNameWithoutDirectory(Stella.makeFileName(file.wrapperValue, Stella.KWD_CPP_CODE, Stella.TRUE)) + " ");
          }
        }
        variables.insertAt(Stella.wrapString("SYSTEM-FILES"), Stella.wrapString(systemfiles.theStringReader()));
        if (system.requiredSystems != null) {
          { StringWrapper reqsys = null;
        ...
        variables.insertAt(Stella.wrapString("REQUIRED-SYSTEMS"), Stella.wrapString(requiredsystems.theStringReader()));
        makefile = Stella.fileNameWithoutExtension(Stella.makeFileName("Makefile", Stella.KWD_CPP_CODE, Stella.TRUE));
...
;
        ...
        variablevalue = ((StringWrapper)(variables.lookup(Stella.wrapString(variablename))));
  ...
  public static void substituteTemplateVariablesToMakefile(String templatefile, String outputfile, KeyValueList variables) {
    { OutputFileStream out = OutputFileStream.newOutputFileStream(outputfile);
...
;
      InputStream.substituteTemplateVariablesToStream(InputFileStream.newInputFileStream(templatefile), out, variables);
      out.free();
    }
  }
  ...
  public static StringHashTable cppCreateReservedWordTable() {
    { StringHashTable table = StringHashTable.newStringHashTable();
      ...
      table.insertAt("++", Stella.wrapString("stella_Increment"));
      table.insertAt("--", Stella.wrapString("stella_Decrement"));
      return (table);
    }
  }
  ...
  public static Cons cppTranslateNull() {
    return (Stella.list$(Stella_Object.cons(Stella.SYM_STELLA_CPP_IDENT, Stella_Object.cons(Stella.wrapString("NULL"), Stella_Object.cons(Stella.NIL, Stella.NIL)))));
  }
  ...
  public static String string_javaMakeCodeOutputFileName(String barefile, boolean donttruncateP) {
    if (donttruncateP) {
      { Object old$DonttruncatefilenamesP$000 = Stella.$DONTTRUNCATEFILENAMESp$.get();
        ...
        try {
          Native.setBooleanSpecial(Stella.$DONTTRUNCATEFILENAMESp$, Stella.TRUE);
          return (Stella_Object.makeFileNameFromRelativePath(Stella.wrapString(barefile), Stella.KWD_JAVA));
          ...
          { Symbol testValue000 = unit.category;
            ...
            if ((testValue000 == Stella.SYM_STELLA_METHOD) ||
              ...
              if (MethodSlot.javaFlotsamFunctionP(((MethodSlot)(unit.theObject)))) {
                ...
                startupclassname = StringWrapper.javaTranslateClassNamestring(Stella.wrapString(((StringWrapper)(KeyValueList.dynamicSlotValue(((MethodSlot)(unit.theObject)).dynamicSlots, Stella.SYM_STELLA_METHOD_STARTUP_CLASSNAME, Stella.NULL_STRING_WRAPPER))).wrapperValue));
        ...
        while (!(iter001 == Stella.NIL)) {
          ...
          if (TranslationUnit.javaClassUnitDefinesFlotsamClassP(classunit)) {
            { Module module = classunit.theObject.homeModule();
              ...
              Module.javaOutputFlotsamUnitsToFileForModule(module, classunit, globals, functions);
  ...
  public static void javaTranslateFile(String filename) {
    Stella.translateFile(filename, Stella.KWD_JAVA, Stella.FALSE);
  }

  public static void javaTranslateFileAsPartOfSystem(String filename) {
    Stella.translateFile(filename, Stella.KWD_JAVA, Stella.TRUE);
  }
  ...
  public static boolean inheritedClassNameConflictsP(String stellaClassName) {
    { Stella_Class stellaClass = Stella.string_getStellaClass(stellaClassName, Stella.FALSE);
      ...
      { Module module = null;
        ...
        while (!(iter000 == Stella.NIL)) {
          ...
          { Object old$Module$000 = Stella.$MODULE$.get();
            ...
            try {
              Native.setSpecial(Stella.$MODULE$, module);
              testClass = Stella.string_getStellaClass(stellaClassName, Stella.FALSE);
              if (stellaClass == null) {
      ...
      javaClassName = StringWrapper.javaTranslateClassNamestring(Stella.wrapString(stellaClassName)).wrapperValue;
      { Module module = null;
  ...
  public static Cons javaTranslateClassObjectLookup(String classname) {
    return (Stella.list$(Stella_Object.cons(Stella.SYM_STELLA_JAVA_FUNCTION_CALL, Stella_Object.cons(Stella.list$(Stella_Object.cons(Stella.SYM_STELLA_JAVA_IDENT, Stella_Object.cons(Stella.wrapString(Stella.javaYieldNativeClassName()), Stella_Object.cons(Stella.NIL, Stella.NIL)))), Stella_Object.cons(Stella.list$(Stella_Object.cons(Stella.SYM_STELLA_JAVA_IDENT, Stella_Object.cons(Stella.wrapString("find_java_class"), Stella_Object.cons(Stella.NIL, Stella.NIL)))), Stella_Object.cons(Stella.list$(Stella_Object.cons(Stella.SYM_STELLA_JAVA_ACTUALS, Stella_Object.cons(Stella.wrapString(classname), Stella_Object.cons(Stella.NIL, Stella.NIL)))), Stella_Object.cons(Stella.NIL, Stella.NIL)))))));
  }
  ...
  public static String yieldClassObjectLookupNameForNativeType(String nativetype) {
    { String basetype = nativetype;
      ...
      if (Stella.$JAVA_PRIMITIVE_ARRAY_TYPE_NAMES$.lookup(Stella.wrapString(basetype)) != null) {
        basetype = ((StringWrapper)(Stella.$JAVA_PRIMITIVE_ARRAY_TYPE_NAMES$.lookup(Stella.wrapString(basetype)))).wrapperValue;
      }
  ...
  public static Cons javaTranslateNull() {
    return (Stella.list$(Stella_Object.cons(Stella.SYM_STELLA_JAVA_IDENT, Stella_Object.cons(Stella.wrapString("null"), Stella_Object.cons(Stella.NIL, Stella.NIL)))));
  }

  public static Cons javaTranslateEol() {
    return (Stella.list$(Stella_Object.cons(Stella.SYM_STELLA_JAVA_EOL, Stella_Object.cons(Symbol.javaTranslateGlobalName(Stella.SYM_STELLA_EOL, Stella.FALSE), Stella_Object.cons(Stella.NIL, Stella.NIL)))));
  }
  ...
  public static Cons javaTranslateReturnParameter() {
    return (Stella.list$(Stella_Object.cons(Stella.wrapString("Object []"), Stella_Object.cons(Stella.wrapString("MV_returnarray"), Stella_Object.cons(Stella.NIL, Stella.NIL)))));
  }
...
;
  ...
  public static void javaOutputCommentString(String comment, String commentStart, String commentContinuation, String commentEnd, boolean javadocCommentP, Cons caseConvertedNameList) {
    { boolean returnP = Stella.FALSE;
      boolean escapeP = Stella.FALSE;
      boolean insideQuoteP = Stella.FALSE;
  ...
  public static Cons idlTranslateNull() {
    return (Stella.list$(Stella_Object.cons(Stella.SYM_STELLA_IDL_IDENT, Stella_Object.cons(Stella.wrapString("NULL"), Stella_Object.cons(Stella.NIL, Stella.NIL)))));
  }
...
;
  ...
  public static void idlTranslateFile(String filename) {
    Stella.translateFile(filename, Stella.KWD_IDL, Stella.FALSE);
  }
      ...
      loop000 : while (iter000 <= upperBound000) {
        ...
        if (verboseP) {
          if (phase == 0) {
            ...
            System.out.println("Running kernel startup code...");
            System.out.println("Initializing symbol tables...");
          }
          else if (phase == 3) {
            System.out.println("Initializing quoted constants...");
          }
          else if (phase == 4) {
            System.out.println("Initializing global variables...");
          }
          else if (phase == 5) {
            System.out.println("Creating class objects...");
          }
          else if (phase == 6) {
            System.out.println("Finalizing classes...");
          }
          else if (phase == 7) {
            System.out.println("Creating method objects...");
          }
          else if (phase == 8) {
            System.out.println("Finalizing methods...");
          }
          else if (phase == 9) {
            System.out.println("Running non-phased startup code...");
          }
        }
        if (phase == 6) {
          Stella.finalizeClasses();
          Stella.$CLASS_HIERARCHY_BOOTEDp$ = Stella.TRUE;
          continue loop000;
        }
        if (phase == 8) {
          Stella.finalizeSlots();
