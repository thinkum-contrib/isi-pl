...
public class Stella {
   ...
   */
  public static boolean $UNLINK_DISCARDED_CONTEXTS_ON_READp$ = false;

  /** Eliminate pointers to discarded contexts while
   * inserting into a CS-VALUE context table.
   */
  public static boolean $UNLINK_DISCARDED_CONTEXTS_ON_WRITEp$ = false;
  ...
  public static int $STELLA_PATCH_LEVEL$ = 2;
  ...
  public static InputStream openNetworkStream(String host, int port, Object [] MV_returnarray) {
    { java.io.PushbackInputStream in = null;
      ...
      try {
        ...
        throw InputOutputException.newInputOutputException("Unknown host: " + host);
      } catch (java.io.IOException ioe) {
        throw InputOutputException.newInputOutputException(ioe.getMessage());
      }
;
...
;
  ...
  public static GeneralizedSymbol internGeneralizedSymbol(String name) {
    if (Stella.qualifiedNameP(name)) {
      return (Stella.internQualifiedName(name, true));
    }
...
;
  ...
  public static CalendarDate stringToCalendarDate(String input) {
    { DecodedDateTime renamed_Do = Stella.parseDateTimeInTimeZone(input, Stella.NULL_FLOAT, 0, Stella.NULL_INTEGER, false);
  ...
  public static void createStartupFunctionUnits() {
    { Symbol startupfnname = (Stella.incrementalTranslationP() ? ((Symbol)(null)) : Stella.yieldStartupFunctionName(((String)(Stella.$CURRENTFILE$.get()))));
      ...
      if (Stella.dontGenerateStartupCodeP()) {
        ...
        KeyValueList.setDynamicSlotValue(((MethodSlot)(Cons.helpWalkAuxiliaryTree(tree, true).theObject)).dynamicSlots, Stella.SYM_STELLA_METHOD_STARTUP_CLASSNAME, Stella.wrapString(Symbol.yieldStartupFunctionClassname(startupfnname)), Stella.NULL_STRING_WRAPPER);
      }
      else {
  ...
  public static Module computeModuleAndBareName(String name, Object [] MV_returnarray) {
    { Context module = null;
      ...
      { Object [] caller_MV_returnarray = new Object[1];
        ...
        module = Stella.computeContextOrModuleFromPathname(name, true, true, caller_MV_returnarray);
      ...
      try {
        { Context value000 = null;
          ...
          { Object [] caller_MV_returnarray = new Object[1];
            ...
            value000 = Stella.computeContextOrModuleFromPathname(name, true, true, caller_MV_returnarray);
        ...
        if (barenamestart != Stella.NULL_INTEGER) {
          { String modulename = Stella.qualifiedNameBareName(Stella.qualifiedNameModuleName(name));
            ...
            try {
              module = Stella.getStellaModule(modulename, false);
            } catch (NoSuchContextException e001) {
              module = Stella.getStellaModule(Native.stringUpcase(modulename), false);
            }
            if (warnP) {
              if (module == null) {
  ...
  public static GeneralizedSymbol internQualifiedName(String name, boolean enableCaseConversionP) {
    { Module module = null;
      ...
      { Object [] caller_MV_returnarray = new Object[1];
        ...
        module = Stella.dwimModuleAndBareName(name, true, caller_MV_returnarray);
                ...
                { Cons preprocessedfiles = Stella.NIL;
                  ...
                  { StringWrapper f = null;
                    ...
                    while (!(iter000 == Stella.NIL)) {
                      ...
                      if (collect000 == null) {
                        {
                          collect000 = Stella_Object.cons(Stella.wrapString(Stella.makeFileName(f.wrapperValue, Stella.KWD_STELLA, true)), Stella.NIL);
                        ...
                        {
                          collect000.rest = Stella_Object.cons(Stella.wrapString(Stella.makeFileName(f.wrapperValue, Stella.KWD_STELLA, true)), Stella.NIL);
                          collect000 = collect000.rest;
                        }
                      }
                    }
...
;
          ...
          { Module currentnamespacemodule = null;
            ...
            { Stella_Class renamed_Class = null;
              Iterator iter001 = Module.allClasses(((Module)(Stella.$MODULE$.get())), true);
...
;
          ...
          if (Stella.stringEqlP(systemname, "stella")) {
            Stella.cppOutputIncludeDirective(Stella.cppRelativizeHeaderFile(Stella_Object.makeFileNameFromRelativePath(Stella.list$(Stella_Object.cons(Stella.wrapString("cpp-lib"), Stella_Object.cons(Stella.wrapString("cpp-primal"), Stella_Object.cons(Stella.NIL, Stella.NIL)))), Stella.KWD_CPP_HEADER), systemname), false);
          }
          { StringWrapper file = null;
  ...
  public static String cppYieldStellaRootDirectory() {
    { Object old$Currentsystemdefinition$000 = Stella.$CURRENTSYSTEMDEFINITION$.get();
      ...
      try {
        ...
        if (((SystemDefinition)(Stella.$CURRENTSYSTEMDEFINITION$.get())) != null) {
          {
            return (Stella.cppYieldSystemsRootDirectory() + "/" + Stella.fileBaseName(Stella.directoryFileName(Stella.directoryParentDirectory(Stella.makeFileName("dummy", Stella.KWD_CPP_CODE, true), 1))));
          }
        }
        else {
          {
      ...
      { KeyValueList variables = KeyValueList.newKeyValueList();
        ...
        { StringWrapper file = null;
          ...
          while (!(iter000 == Stella.NIL)) {
            ...
            systemfiles.nativeStream.print(Stella.fileNameWithoutDirectory(Stella.makeFileName(file.wrapperValue, Stella.KWD_CPP_CODE, true)) + " ");
          }
        }
