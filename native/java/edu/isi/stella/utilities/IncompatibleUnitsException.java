//  -*- Mode: Java -*-
//
// IncompatibleUnitsException.java
...
public class IncompatibleUnitsException extends IncompatibleQuantityException {
  public IncompatibleUnitsException (String message) {
    super(message);
  }

  public static IncompatibleUnitsException newIncompatibleUnitsException(String message) {
