    ...
    { Object old$Module$000 = Stella.$MODULE$.get();
      ...
      try {
        ...
        if (Stella.currentStartupTimePhaseP(4)) {
          Stella.$NEEDEXPLICITRETURNp$.setDefaultValue(new Boolean(Stella.FALSE));
        }
        ...
        if (Stella.currentStartupTimePhaseP(7)) {
          ...
          { MethodSlot function = Symbol.lookupFunction(Stella.SYM_STELLA_STARTUP_CL_TRANSLATE);
            ...
            KeyValueList.setDynamicSlotValue(function.dynamicSlots, Stella.SYM_STELLA_METHOD_STARTUP_CLASSNAME, Stella.wrapString("_Startup-Cl-Translate"), Stella.NULL_STRING_WRAPPER);
          }
        }
        ...
        if (Stella.currentStartupTimePhaseP(9)) {
          ...
          { boolean usestructsP = Stella.FALSE;
            boolean usevectorstructsP = Stella.FALSE;
            boolean useclconsesP = Stella.FALSE;
