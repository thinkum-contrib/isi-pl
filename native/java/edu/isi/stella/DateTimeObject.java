...
public abstract class DateTimeObject extends StandardObject {
  public static boolean timeGreaterEqualP(DateTimeObject t1, DateTimeObject t2) {
    { Surrogate testValue000 = Stella_Object.safePrimaryType(t1);
      ...
      if (Surrogate.subtypeOfP(testValue000, Stella.SGT_STELLA_CALENDAR_DATE)) {
          ...
          { Surrogate testValue001 = Stella_Object.safePrimaryType(t2);
            ...
            if (Surrogate.subtypeOfP(testValue001, Stella.SGT_STELLA_CALENDAR_DATE)) {
              { CalendarDate t2000 = ((CalendarDate)(t2));
                ...
                if (t1000.modifiedJulianDay == t2000.modifiedJulianDay) {
                  return (t1000.timeMillis >= t2000.timeMillis);
                }
                else {
                  return (t1000.modifiedJulianDay >= t2000.modifiedJulianDay);
                }
              }
            }
              ...
              { TimeDuration t2000 = ((TimeDuration)(t2));
                ...
                { OutputStringStream stream000 = OutputStringStream.newOutputStringStream();
                  ...
                  stream000.nativeStream.print("Can't compare calendar and relative dates: `" + t1000 + "'  `" + t2000 + "'");
            ...
            if (Surrogate.subtypeOfP(testValue002, Stella.SGT_STELLA_CALENDAR_DATE)) {
              { CalendarDate t2000 = ((CalendarDate)(t2));
                ...
                { OutputStringStream stream002 = OutputStringStream.newOutputStringStream();
                  ...
                  stream002.nativeStream.print("Can't compare relative and calendar dates: `" + t1000 + "'  `" + t2000 + "'");
              ...
              { TimeDuration t2000 = ((TimeDuration)(t2));
                ...
                if (t1000.days == t2000.days) {
                  return (t1000.millis >= t2000.millis);
                }
                else {
                  return (t1000.days >= t2000.days);
                }
              }
            }
            else {
              { OutputStringStream stream003 = OutputStringStream.newOutputStringStream();
                ...
                stream003.nativeStream.print("`" + testValue002 + "' is not a valid case option");
        ...
        { OutputStringStream stream004 = OutputStringStream.newOutputStringStream();
          ...
          stream004.nativeStream.print("`" + testValue000 + "' is not a valid case option");
  ...
  public static boolean timeLessEqualP(DateTimeObject t1, DateTimeObject t2) {
    { Surrogate testValue000 = Stella_Object.safePrimaryType(t1);
  ...
  public static boolean timeGreaterP(DateTimeObject t1, DateTimeObject t2) {
    { Surrogate testValue000 = Stella_Object.safePrimaryType(t1);
  ...
  public static boolean timeLessP(DateTimeObject t1, DateTimeObject t2) {
    { Surrogate testValue000 = Stella_Object.safePrimaryType(t1);
  ...
  public static boolean timeEqlP(DateTimeObject t1, DateTimeObject t2) {
    { Surrogate testValue000 = Stella_Object.safePrimaryType(t1);
