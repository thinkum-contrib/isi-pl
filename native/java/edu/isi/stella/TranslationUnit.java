...
public class TranslationUnit extends StandardObject {
    ...
    { Stella_Class renamed_Class = ((Stella_Class)(unit.theObject));
      ...
      { Surrogate renamed_Super = null;
        ...
        while (!(iter000 == Stella.NIL)) {
          ...
          if (collect000 == null) {
            {
              collect000 = Stella_Object.cons(GeneralizedSymbol.idlTranslateClassName(Stella.internSymbolInModule(renamed_Super.symbolName, ((Module)(renamed_Super.homeContext)), true)), Stella.NIL);
            ...
            {
              collect000.rest = Stella_Object.cons(GeneralizedSymbol.idlTranslateClassName(Stella.internSymbolInModule(renamed_Super.symbolName, ((Module)(renamed_Super.homeContext)), true)), Stella.NIL);
  ...
  public static boolean javaClassUnitDefinesFlotsamClassP(TranslationUnit classunit) {
    { Stella_Class renamed_Class = ((Stella_Class)(classunit.theObject));
      ...
      return (Stella.stringEqlP(StringWrapper.javaTranslateClassNamestring(Stella.wrapString(Stella.internSymbolInModule(renamed_Class.classType.symbolName, ((Module)(renamed_Class.classType.homeContext)), true).symbolName)).wrapperValue, Module.javaYieldFlotsamClassName(module)));
    }
  }
...
;
  ...
  public static void walkTypeUnit(TranslationUnit unit) {
    { String stringifieddefinition = Native.stringify(unit.codeRegister);
      ...
      GeneralizedSymbol.registerSymbol(Stella.internSymbolInModule(((Surrogate)(unit.theObject)).symbolName, ((Module)(((Surrogate)(unit.theObject)).homeContext)), true));
    }
  }
    ...
    { GlobalVariable global = ((GlobalVariable)(unit.theObject));
      ...
      if (!(initialvaluetree == Stella.KWD_UNBOUND_SPECIAL_VARIABLE)) {
        if (global.variableSpecialP &&
          ...
          initialvaluetree = Stella_Object.walkExpressionTree(initialvaluetree, global.variableType, global.variableName, true, new Object[1]);
        }
        else {
          global.variableConstantP = false;
...
;
      ...
      { Surrogate synonym = null;
        ...
        while (!(iter001 == Stella.NIL)) {
          ...
          GeneralizedSymbol.registerSymbol(Stella.internSymbolInModule(synonym.symbolName, ((Module)(synonym.homeContext)), true));
        }
      }
    }
  }
...
;
          ...
          if ((body == Stella.NIL) &&
            ...
            if (!(((BooleanWrapper)(KeyValueList.dynamicSlotValue(method.dynamicSlots, Stella.SYM_STELLA_METHOD_NATIVEp, Stella.FALSE_WRAPPER))).wrapperValue ||
              ...
              KeyValueList.setDynamicSlotValue(method.dynamicSlots, Stella.SYM_STELLA_FORWARD_DECLARATIONp, (true ? Stella.TRUE_WRAPPER : Stella.FALSE_WRAPPER), Stella.FALSE_WRAPPER);
