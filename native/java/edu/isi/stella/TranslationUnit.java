...
public class TranslationUnit extends StandardObject {
    ...
    { Stella_Class renamed_Class = ((Stella_Class)(unit.theObject));
      ...
      { Surrogate renamed_Super = null;
        ...
        while (!(iter000 == Stella.NIL)) {
          ...
          if (collect000 == null) {
            {
              collect000 = Stella_Object.cons(GeneralizedSymbol.idlTranslateClassName(Stella.internSymbolInModule(renamed_Super.symbolName, ((Module)(renamed_Super.homeContext)), Stella.TRUE)), Stella.NIL);
            ...
            {
              collect000.rest = Stella_Object.cons(GeneralizedSymbol.idlTranslateClassName(Stella.internSymbolInModule(renamed_Super.symbolName, ((Module)(renamed_Super.homeContext)), Stella.TRUE)), Stella.NIL);
      ...
      { Symbol parameter = null;
        ...
        while (!(iter001 == Stella.NIL)) {
          ...
          if (collect001 == null) {
            {
              collect001 = Stella_Object.cons(Symbol.idlTranslateClassParameterName(parameter), Stella.NIL);
            ...
            {
              collect001.rest = Stella_Object.cons(Symbol.idlTranslateClassParameterName(parameter), Stella.NIL);
      ...
      return (Stella_Object.cons(Stella_Class.idlClassCategory(renamed_Class), Stella_Object.cons(GeneralizedSymbol.idlTranslateClassName(Stella.internSymbolInModule(renamed_Class.classType.symbolName, ((Module)(renamed_Class.classType.homeContext)), Stella.TRUE)), Stella_Object.cons(parameters, Stella_Object.cons(derivedclasses, Stella_Object.cons(staticattributedefs, (((!(parameterizedattributedefs == Stella.NIL)) ? Stella_Object.cons(Stella.list$(Stella_Object.cons(Stella.SYM_STELLA_IDL_DECLARATIONS, Stella_Object.cons(parameterizedattributedefs, Stella_Object.cons(Stella.NIL, Stella.NIL)))), Stella.NIL) : Stella.NIL)).concatenate((((!(attributedefs == Stella.NIL)) ? Stella_Object.cons(Stella.list$(Stella_Object.cons(Stella.SYM_STELLA_IDL_DECLARATIONS, Stella_Object.cons(attributedefs, Stella_Object.cons(Stella.NIL, Stella.NIL)))), Stella.NIL) : Stella.NIL)).concatenate((((!(constructordefs == Stella.NIL)) ? Stella_Object.cons(Stella.list$(Stella_Object.cons(Stella.SYM_STELLA_IDL_SIGNATURES, Stella_Object.cons(constructordefs, Stella_Object.cons(Stella.NIL, Stella.NIL)))), Stella.NIL) : Stella.NIL)).concatenate((((!(operationdefs == Stella.NIL)) ? Stella_Object.cons(Stella.list$(Stella_Object.cons(Stella.SYM_STELLA_IDL_SIGNATURES, Stella_Object.cons(operationdefs, Stella_Object.cons(Stella.NIL, Stella.NIL)))), Stella.NIL) : Stella.NIL)).concatenate(Stella.NIL, Stella.NIL), Stella.NIL), Stella.NIL), Stella.NIL)))))));
    }
  }

  public static Cons idlTranslateDeftypeUnit(TranslationUnit unit) {
    return (Stella.list$(Stella_Object.cons(Stella.SYM_STELLA_IDL_TYPEDEF, Stella_Object.cons(Symbol.idlTranslateName(((Symbol)(((Cons)(unit.codeRegister)).rest.value))), Stella_Object.cons(Stella_Object.cons(StandardObject.idlTranslateTypeSpec(((StandardObject)(((Surrogate)(unit.theObject)).surrogateValue))), Stella.NIL), Stella.NIL)))));
  }
        ...
        { Stella_Class renamed_Class = ((Stella_Class)(unit.theObject));
          ...
          { Object old$Context$000 = Stella.$CONTEXT$.get();
            ...
            try {
              ...
              Native.setSpecial(Stella.$DUMMYDECLARATIONS$, Stella_Object.cons(Stella.list$(Stella_Object.cons(Stella.SYM_STELLA_SELF, Stella_Object.cons(Surrogate.canonicalType(renamed_Class.classType), Stella_Object.cons(Stella_Object.cons(Stella.SYM_STELLA_THIS, Stella.NIL), Stella.NIL)))), ((Cons)(Stella.$DUMMYDECLARATIONS$.get()))));
              translatedmethodbody = Cons.wrapMethodBodyWithJavaAuxiliaryDeclarations(Stella.list$(Stella_Object.cons(Stella.SYM_STELLA_JAVA_STATEMENTS, Stella_Object.cons(Stella_Object.javaTranslateATree(bodytree), Stella_Object.cons(Stella.NIL, Stella.NIL)))), ((Cons)(Stella.$DUMMYDECLARATIONS$.get())));
              otree = Stella.list$(Stella_Object.cons(Stella.SYM_STELLA_JAVA_METHOD, Stella_Object.cons(Stella_Object.cons(Stella.wrapString("public"), Stella.NIL), Stella_Object.cons(Stella_Object.cons(Stella.wrapString("String"), Stella.NIL), Stella_Object.cons(Stella.wrapString("toString"), Stella_Object.cons(Stella.list$(Stella_Object.cons(Stella.NIL, Stella_Object.cons(translatedmethodbody, Stella_Object.cons(Stella.NIL, Stella.NIL)))), Stella.NIL))))));
    ...
    { Object old$Localgensymtable$000 = Stella.$LOCALGENSYMTABLE$.get();
      ...
      try {
        ...
        { MethodSlot method = ((MethodSlot)(unit.theObject));
          ...
          bodytree = Cons.deleteQuotedNullStatements(bodytree);
          if (!unitisfunction) {
            Native.setSpecial(Stella.$DUMMYDECLARATIONS$, Stella_Object.cons(Stella_Object.cons(((Symbol)(method.methodParameterNames().first())), Stella_Object.cons(method.slotOwner, Stella_Object.cons(Stella.SYM_STELLA_THIS, Stella.NIL))), ((Cons)(Stella.$DUMMYDECLARATIONS$.get()))));
          }
          if (method.abstractP) {
            ...
            {
              translatedmethodbody = Stella_Object.cons(Stella.SYM_STELLA_JAVA_STATEMENTS, Cons.javaTranslateListOfTrees(bodytree).concatenate(Stella.NIL, Stella.NIL));
          ...
          if (((StringWrapper)(KeyValueList.dynamicSlotValue(method.dynamicSlots, Stella.SYM_STELLA_DOCUMENTATION, Stella.NULL_STRING_WRAPPER))).wrapperValue != null) {
            if (translatedmethodbody == Stella.NIL) {
              translatedmethodbody = Stella.list$(Stella_Object.cons(Stella.SYM_STELLA_JAVA_STATEMENTS, Stella_Object.cons(Stella.list$(Stella_Object.cons(Stella.SYM_STELLA_JAVA_COMMENT, Stella_Object.cons(Stella.wrapString(((StringWrapper)(KeyValueList.dynamicSlotValue(method.dynamicSlots, Stella.SYM_STELLA_DOCUMENTATION, Stella.NULL_STRING_WRAPPER))).wrapperValue), Stella_Object.cons(Stella.NIL, Stella.NIL)))), Stella_Object.cons(Stella.NIL, Stella.NIL))));
            }
            else {
              translatedmethodbody.rest = Stella_Object.cons(Stella.list$(Stella_Object.cons(Stella.SYM_STELLA_JAVA_COMMENT, Stella_Object.cons(Stella.wrapString(((StringWrapper)(KeyValueList.dynamicSlotValue(method.dynamicSlots, Stella.SYM_STELLA_DOCUMENTATION, Stella.NULL_STRING_WRAPPER))).wrapperValue), Stella_Object.cons(Stella.NIL, Stella.NIL)))), translatedmethodbody.rest.concatenate(Stella.NIL, Stella.NIL));
            }
          }
          otree = Stella_Object.cons((unitisfunction ? Stella.SYM_STELLA_JAVA_FUNCTION : Stella.SYM_STELLA_JAVA_METHOD), MethodSlot.javaTranslateMethodSignature(method).concatenate(Stella_Object.cons(translatedmethodbody, Stella.NIL), Stella.NIL));
          unit.translation = Stella.NIL;
          return (otree);
        }
    ...
    { GlobalVariable global = ((GlobalVariable)(unit.theObject));
      ...
      { Object old$Context$000 = Stella.$CONTEXT$.get();
        ...
        try {
          ...
          Native.setSpecial(Stella.$MODULE$, ((Context)(Stella.$CONTEXT$.get())).baseModule);
          { StringWrapper variabletype = (global.variableSpecialP ? Stella.wrapString(Stella.javaYieldSpecialVariableClassName()) : StandardObject.javaTranslateTypeSpec(GlobalVariable.globalVariableTypeSpec(global)));
            Cons typelist = Stella_Object.cons(variabletype, Stella.NIL);
            Stella_Object initialvaluetree = Stella_Object.javaTranslateATree(unit.codeRegister);
            StringWrapper variablename = Symbol.javaTranslateGlobalName(global.variableName, Stella.TRUE);

            typelist = Stella_Object.cons(Stella.wrapString("static"), typelist);
            if (global.variableConstantP ||
                global.variableSpecialP) {
              typelist = Stella_Object.cons(Stella.wrapString("final"), typelist);
            }
            if (global.variablePublicP) {
              typelist = Stella_Object.cons(Stella.wrapString("public"), typelist);
            }
            if ((unit.codeRegister == Stella.KWD_UNBOUND_SPECIAL_VARIABLE) ||
                global.variableSpecialP) {
              return (Stella.list$(Stella_Object.cons(Stella.SYM_STELLA_JAVA_GLOBAL, Stella_Object.cons(Stella.wrapString(global.documentation), Stella_Object.cons(Stella.list$(Stella_Object.cons(Stella_Object.cons(Stella.SYM_STELLA_JAVA_TYPE, typelist.concatenate(Stella.NIL, Stella.NIL)), Stella_Object.cons(variablename, Stella_Object.cons(Stella_Object.cons(Stella.list$(Stella_Object.cons(Stella.SYM_STELLA_JAVA_MAKE, Stella_Object.cons(Stella.list$(Stella_Object.cons(Stella.SYM_STELLA_JAVA_IDENT, Stella_Object.cons(variabletype, Stella_Object.cons(Stella.NIL, Stella.NIL)))), Stella_Object.cons(Stella_Object.cons(Stella.SYM_STELLA_JAVA_ACTUALS, Stella.NIL), Stella_Object.cons(Stella.NIL, Stella.NIL))))), Stella.NIL), Stella.NIL)))), Stella.NIL)))));
            }
            else {
              return (Stella.list$(Stella_Object.cons(Stella.SYM_STELLA_JAVA_GLOBAL, Stella_Object.cons(Stella.wrapString(global.documentation), Stella_Object.cons(Stella.list$(Stella_Object.cons(Stella_Object.cons(Stella.SYM_STELLA_JAVA_TYPE, typelist.concatenate(Stella.NIL, Stella.NIL)), Stella_Object.cons(variablename, Stella_Object.cons(Stella_Object.cons(initialvaluetree, Stella.NIL), Stella.NIL)))), Stella.NIL)))));
            }
          }
  ...
  public static boolean javaClassUnitDefinesFlotsamClassP(TranslationUnit classunit) {
    { Stella_Class renamed_Class = ((Stella_Class)(classunit.theObject));
      ...
      return (Stella.stringEqlP(StringWrapper.javaTranslateClassNamestring(Stella.wrapString(Stella.internSymbolInModule(renamed_Class.classType.symbolName, ((Module)(renamed_Class.classType.homeContext)), Stella.TRUE).symbolName)).wrapperValue, Module.javaYieldFlotsamClassName(module)));
    }
  }
  ...
  public static Cons cppTranslateDefineNativeClassUnit(TranslationUnit unit) {
    { Stella_Class renamed_Class = ((Stella_Class)(unit.theObject));
      ...
      { Surrogate renamed_Super = null;
        ...
        while (!(iter000 == Stella.NIL)) {
          ...
          if ((!((Stella_Class)(renamed_Super.surrogateValue)).mixinP) ||
            ...
            if (collect000 == null) {
              {
                collect000 = Stella_Object.cons(GeneralizedSymbol.cppTranslateClassName(renamed_Super), Stella.NIL);
              ...
              {
                collect000.rest = Stella_Object.cons(GeneralizedSymbol.cppTranslateClassName(renamed_Super), Stella.NIL);
                collect000 = collect000.rest;
              }
            }
          }
      ...
      if (((baseclasses == Stella.NIL) ||
        ...
        baseclasses = Stella_Object.cons(Symbol.cppTranslateName(Stella.SYM_STELLA_GC), baseclasses);
      }
      { Symbol parameter = null;
        Cons iter001 = renamed_Class.classParameters().theConsList;
        Cons collect001 = null;
        ...
        while (!(iter001 == Stella.NIL)) {
          ...
          if (collect001 == null) {
            {
              collect001 = Stella_Object.cons(Symbol.cppTranslateClassParameterName(parameter), Stella.NIL);
              if (parameters == Stella.NIL) {
                parameters = collect001;
              }
              else {
            ...
            {
              collect001.rest = Stella_Object.cons(Symbol.cppTranslateClassParameterName(parameter), Stella.NIL);
              collect001 = collect001.rest;
            }
          }
        }
      ...
      return (Stella.list$(Stella_Object.cons(Stella.SYM_STELLA_CPP_CLASS, Stella_Object.cons(GeneralizedSymbol.cppTranslateClassName(Stella.internSymbolInModule(renamed_Class.classType.symbolName, ((Module)(renamed_Class.classType.homeContext)), Stella.TRUE)), Stella_Object.cons(Stella_Object.cons(parameters, Stella_Object.cons(baseclasses, Stella_Object.cons(staticmembervardefs, (((((StringWrapper)(KeyValueList.dynamicSlotValue(renamed_Class.dynamicSlots, Stella.SYM_STELLA_DOCUMENTATION, Stella.NULL_STRING_WRAPPER))).wrapperValue != null) ? Stella_Object.cons(Stella.list$(Stella_Object.cons(Stella.SYM_STELLA_CPP_COMMENT, Stella_Object.cons(Stella.wrapString(((StringWrapper)(KeyValueList.dynamicSlotValue(renamed_Class.dynamicSlots, Stella.SYM_STELLA_DOCUMENTATION, Stella.NULL_STRING_WRAPPER))).wrapperValue), Stella_Object.cons(Stella.NIL, Stella.NIL)))), Stella.NIL) : Stella.NIL)).concatenate((((!(parameterizedmembervardefs == Stella.NIL)) ? Stella_Object.cons(Stella.list$(Stella_Object.cons(Stella.SYM_STELLA_CPP_DECLARATIONS, Stella_Object.cons(Stella.KWD_PUBLIC, Stella_Object.cons(parameterizedmembervardefs, Stella_Object.cons(Stella.NIL, Stella.NIL))))), Stella.NIL) : Stella.NIL)).concatenate((((!(publicmembervardefs == Stella.NIL)) ? Stella_Object.cons(Stella.list$(Stella_Object.cons(Stella.SYM_STELLA_CPP_DECLARATIONS, Stella_Object.cons(Stella.KWD_PUBLIC, Stella_Object.cons(publicmembervardefs, Stella_Object.cons(Stella.NIL, Stella.NIL))))), Stella.NIL) : Stella.NIL)).concatenate((((!(protectedmembervardefs == Stella.NIL)) ? Stella_Object.cons(Stella.list$(Stella_Object.cons(Stella.SYM_STELLA_CPP_DECLARATIONS, Stella_Object.cons(Stella.KWD_PUBLIC, Stella_Object.cons(protectedmembervardefs, Stella_Object.cons(Stella.NIL, Stella.NIL))))), Stella.NIL) : Stella.NIL)).concatenate((((!(constructordefs == Stella.NIL)) ? Stella_Object.cons(Stella.list$(Stella_Object.cons(Stella.SYM_STELLA_CPP_SIGNATURES, Stella_Object.cons(Stella.KWD_PUBLIC, Stella_Object.cons(constructordefs, Stella_Object.cons(Stella.NIL, Stella.NIL))))), Stella.NIL) : Stella.NIL)).concatenate(((Stella_Class.exceptionClassP(renamed_Class) ? Stella_Object.cons(Stella.list$(Stella_Object.cons(Stella.SYM_STELLA_CPP_DEFINITIONS, Stella_Object.cons(Stella.KWD_PUBLIC, Stella_Object.cons(Stella_Object.cons(Stella_Class.cppYieldExceptionConstructorDefinition(renamed_Class), Stella.NIL), Stella_Object.cons(Stella.NIL, Stella.NIL))))), Stella.NIL) : Stella.NIL)).concatenate((((!(publicmemberfuncdefs == Stella.NIL)) ? Stella_Object.cons(Stella.list$(Stella_Object.cons(Stella.SYM_STELLA_CPP_SIGNATURES, Stella_Object.cons(Stella.KWD_PUBLIC, Stella_Object.cons(publicmemberfuncdefs, Stella_Object.cons(Stella.NIL, Stella.NIL))))), Stella.NIL) : Stella.NIL)).concatenate((((!(protectedmemberfuncdefs == Stella.NIL)) ? Stella_Object.cons(Stella.list$(Stella_Object.cons(Stella.SYM_STELLA_CPP_SIGNATURES, Stella_Object.cons(Stella.KWD_PUBLIC, Stella_Object.cons(protectedmemberfuncdefs, Stella_Object.cons(Stella.NIL, Stella.NIL))))), Stella.NIL) : Stella.NIL)).concatenate(Stella.NIL, Stella.NIL), Stella.NIL), Stella.NIL), Stella.NIL), Stella.NIL), Stella.NIL), Stella.NIL), Stella.NIL)))), Stella.NIL)))));
    }
  }
    ...
    { Object old$Methodbeingwalked$000 = Stella.$METHODBEINGWALKED$.get();
      ...
      try {
        ...
        { MethodSlot method = ((MethodSlot)(unit.theObject));
          ...
          translatedmethodbody = Stella_Object.cons(Stella.SYM_STELLA_CPP_STATEMENTS, Cons.cppTranslateListOfTrees(bodytree).concatenate(Stella.NIL, Stella.NIL));
          if (!(((Cons)(Stella.$DUMMYDECLARATIONS$.get())) == Stella.NIL)) {
          ...
          if (((StringWrapper)(KeyValueList.dynamicSlotValue(method.dynamicSlots, Stella.SYM_STELLA_DOCUMENTATION, Stella.NULL_STRING_WRAPPER))).wrapperValue != null) {
            translatedmethodbody.rest = Stella_Object.cons(Stella.list$(Stella_Object.cons(Stella.SYM_STELLA_CPP_COMMENT, Stella_Object.cons(Stella.wrapString(((StringWrapper)(KeyValueList.dynamicSlotValue(method.dynamicSlots, Stella.SYM_STELLA_DOCUMENTATION, Stella.NULL_STRING_WRAPPER))).wrapperValue), Stella_Object.cons(Stella.NIL, Stella.NIL)))), translatedmethodbody.rest.concatenate(Stella.NIL, Stella.NIL));
          }
          returntype = (MethodSlot.cppConstructorP(method) ? Stella.NIL : Stella_Object.cons(StandardObject.cppTranslateAndPointerizeTypeSpec(MethodSlot.computeMostGeneralReturnType(method, method.computeReturnTypeSpec(method.slotOwner))), Stella.NIL));
          otree = Stella_Object.cons((unitisfunction ? Stella.SYM_STELLA_CPP_FUNCTION : Stella.SYM_STELLA_CPP_METHOD), Stella_Object.cons(returntype, Stella_Object.cons(MethodSlot.cppTranslateMethodName(method), Stella_Object.cons(MethodSlot.cppTranslateFunctionParameters(method), Stella_Object.cons(translatedmethodbody, Stella.NIL)))));
          return (otree);
        }
    ...
    { GlobalVariable global = ((GlobalVariable)(unit.theObject));
      ...
      if (global.variableSpecialP) {
        if ((initialvaluetree == null) &&
          ...
          initialvaluetree = Stella_Object.cppTranslateATree(Surrogate.typeToWalkedNullValueTree(StandardObject.typeSpecToBaseType(type)));
        }
        return (Stella.list$(Stella_Object.cons(Stella.SYM_STELLA_CPP_SPECIAL, Stella_Object.cons(Stella.wrapString(global.documentation), Stella_Object.cons(Stella.list$(Stella_Object.cons(Stella.list$(Stella_Object.cons(Stella.SYM_STELLA_CPP_TYPE, Stella_Object.cons(StandardObject.cppTranslateAndPointerizeTypeSpec(type), Stella_Object.cons(Stella.NIL, Stella.NIL)))), Stella_Object.cons(variablename, Stella_Object.cons((((initialvaluetree != null) ? Stella_Object.cons(initialvaluetree, Stella.NIL) : Stella.NIL)).concatenate(Stella.NIL, Stella.NIL), Stella.NIL)))), Stella.NIL)))));
      }
      else {
        return (Stella.list$(Stella_Object.cons(Stella.SYM_STELLA_CPP_GLOBAL, Stella_Object.cons(Stella.wrapString(global.documentation), Stella_Object.cons(Stella.list$(Stella_Object.cons(Stella.list$(Stella_Object.cons(Stella.SYM_STELLA_CPP_TYPE, Stella_Object.cons(StandardObject.cppTranslateAndPointerizeTypeSpec(type), Stella_Object.cons(Stella.NIL, Stella.NIL)))), Stella_Object.cons(variablename, Stella_Object.cons(Stella_Object.cons(initialvaluetree, Stella.NIL), Stella.NIL)))), Stella.NIL)))));
      }
    }
  }
  ...
  public static Cons cppTranslateDefprintUnit(TranslationUnit unit) {
    { Stella_Object printform = unit.codeRegister;
      ...
      return (Stella.list$(Stella_Object.cons(Stella.SYM_STELLA_CPP_DEFPRINT, Stella_Object.cons(classname, Stella_Object.cons(Stella_Object.cons(Stella.list$(Stella_Object.cons(Stella.SYM_STELLA_CPP_STATEMENTS, Stella_Object.cons(Stella_Object.cppTranslateATree(printform), Stella_Object.cons(Stella_Object.cons(Stella.list$(Stella_Object.cons(Stella.SYM_STELLA_CPP_RETURN, Stella_Object.cons(Stella.list$(Stella_Object.cons(Stella.SYM_STELLA_CPP_IDENT, Stella_Object.cons(Symbol.cppTranslateName(Stella.SYM_STELLA_STREAM), Stella_Object.cons(Stella.NIL, Stella.NIL)))), Stella_Object.cons(Stella.NIL, Stella.NIL)))), Stella.NIL), Stella.NIL)))), Stella.NIL), Stella.NIL)))));
    }
  }
  ...
  public static void cppOutputMain(TranslationUnit unit) {
    { Object old$CurrentStream$000 = Stella.$CURRENT_STREAM$.get();
      ...
      try {
        Native.setSpecial(Stella.$CURRENT_STREAM$, OutputFileStream.newOutputFileStream(Stella.cppYieldMainFileName()));
...
;
        ...
        { Module usee = null;
          Cons iter000 = Module.visibleModules(((Module)(Stella.$MODULE$.get()))).consify().reverse();
        ...
        ((OutputStream)(Stella.$CURRENT_STREAM$.get())).free();
  ...
  public static boolean cppUnitDefinesMainP(TranslationUnit unit) {
    return ((unit.category == Stella.SYM_STELLA_METHOD) &&
        (((MethodSlot)(unit.theObject)).slotName == Stella.SYM_STELLA_MAIN));
  }
...
;
  ...
  public static Cons clTranslateDefprintUnit(TranslationUnit unit) {
    { Stella_Class renamed_Class = ((Stella_Class)(unit.theObject));
      ...
      if (Symbol.methodCallTypeForVectorStructs(Stella.SYM_STELLA_PRINT_OBJECT, renamed_Class.classType, Stella.FALSE) == Stella.SYM_STELLA_PRINT_OBJECT) {
        extratrees = Stella_Object.cons(Stella.list$(Stella_Object.cons(Stella.SYM_STELLA_SETQ, Stella_Object.cons(Stella.SYM_STELLA_SELF, Stella_Object.cons(Symbol.clTranslateGlobalSymbol(Stella.SYM_STELLA_$CLSYS_SELF$), Stella_Object.cons(Stella.NIL, Stella.NIL))))), Stella.NIL);
      }
      else {
      }
      return (Stella.list$(Stella_Object.cons(Stella.internCommonLispSymbol("DEFMETHOD"), Stella_Object.cons(Stella.internCommonLispSymbol("PRINT-OBJECT"), Stella_Object.cons(Stella.list$(Stella_Object.cons(Stella.list$(Stella_Object.cons(Stella.SYM_STELLA_SELF, Stella_Object.cons(Stella_Class.classSymbol(renamed_Class), Stella_Object.cons(Stella.NIL, Stella.NIL)))), Stella_Object.cons(Stella.SYM_STELLA_STREAM, Stella_Object.cons(Stella.NIL, Stella.NIL)))), Stella_Object.cons(extratrees.concatenate(Stella_Object.cons(Stella_Object.clTranslateATree(body), Stella.NIL), Stella.NIL), Stella.NIL))))));
    }
  }
  ...
  public static Cons clTranslateDefineGlobalVariableUnit(TranslationUnit unit) {
    { GlobalVariable global = ((GlobalVariable)(unit.theObject));
      ...
      if (global.variableConstantP &&
          Stella.FALSE) {
        operator = Stella.internCommonLispSymbol("DEFCONSTANT");
      }
      otree = (unboundspecialP ? Stella.list$(Stella_Object.cons(Stella.internCommonLispSymbol("DEFVAR"), Stella_Object.cons(name, Stella_Object.cons(Stella.NIL, Stella.NIL)))) : Stella_Object.cons(operator, Stella_Object.cons(name, Stella_Object.cons(initialvaluetree, (((documentation != null) ? Stella_Object.cons(Stella.wrapString(documentation), Stella.NIL) : Stella.NIL)).concatenate(Stella.NIL, Stella.NIL)))));
      if (typedeclarationtree != null) {
        otree = Stella.list$(Stella_Object.cons(Stella.internCommonLispSymbol("PROGN"), Stella_Object.cons(otree, Stella_Object.cons(Stella_Object.cons(Stella.list$(Stella_Object.cons(Stella.internCommonLispSymbol("DECLAIM"), Stella_Object.cons(typedeclarationtree, Stella_Object.cons(Stella.NIL, Stella.NIL)))), Stella.NIL), Stella.NIL))));
      }
      return (otree);
    }
  }
    ...
    { MethodSlot method = ((MethodSlot)(unit.theObject));
      ...
      { Symbol testValue000 = Symbol.methodCallTypeForVectorStructs(methodname, method.slotOwner, functionP);
        ...
        if (testValue000 == Stella.SYM_STELLA_PRINT_OBJECT) {
          bodytree = Stella_Object.cons(Stella.list$(Stella_Object.cons(Stella.SYM_STELLA_SETQ, Stella_Object.cons(Stella.SYM_STELLA_SELF, Stella_Object.cons(Symbol.clTranslateGlobalSymbol(Stella.SYM_STELLA_$CLSYS_SELF$), Stella_Object.cons(Stella.NIL, Stella.NIL))))), bodytree);
        }
        else if (testValue000 == Stella.SYM_STELLA_NON_OBJECT_METHOD) {
          declarations = Stella_Object.cons(Stella.list$(Stella_Object.cons(Stella.internCommonLispSymbol("IGNORE"), Stella_Object.cons(Stella.SYM_STELLA_CLSYS_DUMMY, Stella_Object.cons(Stella.NIL, Stella.NIL)))), Stella.NIL);
        }
        else {
        }
      }
      ...
      otree = Stella_Object.cons((functionP ? Stella.internCommonLispSymbol("DEFUN") : ((MethodSlot.useDefconsmethodP(method) ? Stella.SYM_STELLA_rrDEFCONSMETHOD : Stella.internCommonLispSymbol("DEFMETHOD")))), Stella_Object.cons(Symbol.clTranslateGlobalSymbol(Symbol.yieldRenamedNameIfNative(methodname, Stella.KWD_COMMON_LISP, Stella.KWD_FUNCTION)), Stella_Object.cons(MethodSlot.clTranslateMethodParameters(method), (((documentation != null) ? Stella_Object.cons(Stella.wrapString(documentation), Stella.NIL) : Stella.NIL)).concatenate(Cons.clYieldDeclareTree(declarations, Stella.TRUE).concatenate(Cons.clTranslateListOfTrees(bodytree).concatenate((((StandardObject.voidP(method.type()) &&
          (!Stella.preserveTailMergeOptimizabilityP())) ? Stella_Object.cons(Stella.KWD_VOID, Stella.NIL) : Stella.NIL)).concatenate(Stella.NIL, Stella.NIL), Stella.NIL), Stella.NIL), Stella.NIL))));
      ...
      if (methoddeclaration != null) {
        otree = Stella.list$(Stella_Object.cons(Stella.internCommonLispSymbol("PROGN"), Stella_Object.cons(otree, Stella_Object.cons(Stella_Object.cons(Stella.list$(Stella_Object.cons(Stella.internCommonLispSymbol("DECLAIM"), Stella_Object.cons(methoddeclaration, Stella_Object.cons(Stella.NIL, Stella.NIL)))), Stella.NIL), Stella.NIL))));
      }
      return (otree);
    }
  }
  ...
  public static void walkModuleUnit(TranslationUnit unit) {
    { Module module = ((Module)(unit.theObject));
      ...
      Cons.walkAuxiliaryTree(Stella.list$(Stella_Object.cons(Stella.SYM_STELLA_STARTUP_TIME_PROGN, Stella_Object.cons(Stella.KWD_MODULES, Stella_Object.cons(Module.yieldDefineModule(module), Stella_Object.cons(Stella.NIL, Stella.NIL))))));
    }
  }
  ...
  public static void walkTypeUnit(TranslationUnit unit) {
    { String stringifieddefinition = Native.stringify(unit.codeRegister);
      ...
      ((List)(Stella.$TRANSLATIONUNITS$.get())).push(unit);
      Cons.walkAuxiliaryTree(Stella.list$(Stella_Object.cons(Stella.SYM_STELLA_STARTUP_TIME_PROGN, Stella_Object.cons(Stella.KWD_CLASSES, Stella_Object.cons(Stella.list$(Stella_Object.cons(Stella.SYM_STELLA_DEFINE_STELLA_TYPE_FROM_STRINGIFIED_SOURCE, Stella_Object.cons(Stella.wrapString(stringifieddefinition), Stella_Object.cons(Stella.NIL, Stella.NIL)))), Stella_Object.cons(Stella.NIL, Stella.NIL))))));
      GeneralizedSymbol.registerSymbol(Stella.internSymbolInModule(((Surrogate)(unit.theObject)).symbolName, ((Module)(((Surrogate)(unit.theObject)).homeContext)), Stella.TRUE));
    }
  }
    ...
    { GlobalVariable global = ((GlobalVariable)(unit.theObject));
      ...
      if (!(initialvaluetree == Stella.KWD_UNBOUND_SPECIAL_VARIABLE)) {
        if (global.variableSpecialP &&
          ...
          global.variableConstantP = Stella.FALSE;
          Cons.walkAuxiliaryTree(Stella.list$(Stella_Object.cons(Stella.SYM_STELLA_STARTUP_TIME_PROGN, Stella_Object.cons(Stella.KWD_GLOBALS, Stella_Object.cons(Stella.list$(Stella_Object.cons(Stella.SYM_STELLA_SYS_SET_DEFAULT, Stella_Object.cons(global.variableName, Stella_Object.cons(Stella_Object.cons(initialvaluetree, Stella.NIL), Stella.NIL)))), Stella_Object.cons(Stella.NIL, Stella.NIL))))));
          ...
          initialvaluetree = Stella_Object.walkExpressionTree(initialvaluetree, global.variableType, global.variableName, Stella.TRUE, new Object[1]);
        }
        else {
          global.variableConstantP = Stella.FALSE;
          Cons.walkAuxiliaryTree(Stella.list$(Stella_Object.cons(Stella.SYM_STELLA_STARTUP_TIME_PROGN, Stella_Object.cons(Stella.KWD_GLOBALS, Stella_Object.cons(Stella.list$(Stella_Object.cons(Stella.SYM_STELLA_SETQ, Stella_Object.cons(global.variableName, Stella_Object.cons(Stella_Object.cons(initialvaluetree, Stella.NIL), Stella.NIL)))), Stella_Object.cons(Stella.NIL, Stella.NIL))))));
          initialvaluetree = Surrogate.typeToWalkedNullValueTree(StandardObject.typeSpecToBaseType(global.variableType));
        }
      }
      unit.codeRegister = initialvaluetree;
      if (!(unit.auxiliaryP)) {
        Cons.walkAuxiliaryTree(Stella.list$(Stella_Object.cons(Stella.SYM_STELLA_STARTUP_TIME_PROGN, Stella_Object.cons(Stella.list$(Stella_Object.cons(Stella.SYM_STELLA_DEFINE_STELLA_GLOBAL_VARIABLE_FROM_STRINGIFIED_SOURCE, Stella_Object.cons(Stella.wrapString(stringifiedsource), Stella_Object.cons(Stella.NIL, Stella.NIL)))), Stella_Object.cons(Stella.NIL, Stella.NIL)))));
      }
    }
  }
  ...
  public static void walkSlotUnit(TranslationUnit unit) {
    { StorageSlot slot = ((StorageSlot)(unit.theObject));
      ...
      StorageSlot.createAccessorUnitsForSlot(slot, ownerclass, Stella.FALSE, Stella.FALSE);
      TranslationUnit.clearTranslationUnit(unit);
      Cons.walkAuxiliaryTree(Stella.list$(Stella_Object.cons(Stella.SYM_STELLA_STARTUP_TIME_PROGN, Stella_Object.cons(Stella.KWD_METHODS, Stella_Object.cons(Stella.list$(Stella_Object.cons(Stella.SYM_STELLA_DEFINE_EXTERNAL_SLOT_FROM_STRINGIFIED_SOURCE, Stella_Object.cons(Stella.wrapString(stringifieddefinition), Stella_Object.cons(Stella.NIL, Stella.NIL)))), Stella_Object.cons(Stella.NIL, Stella.NIL))))));
    }
  }
                ...
                { Object old$PrintreadablyP$002 = Stella.$PRINTREADABLYp$.get();
                  ...
                  try {
                    ...
                    if (!(Stella.suppressWarningsP())) {
                      ...
                      {
                        Stella.STANDARD_ERROR.nativeStream.println();
                        Stella.STANDARD_ERROR.nativeStream.println(" Defining slot `" + Stella_Object.deUglifyParseTree(slot) + "' outside the home module of");
...
;
      ...
      Cons.walkAuxiliaryTree(((startuptimecode == Stella.NIL) ? Stella.list$(Stella_Object.cons(Stella.SYM_STELLA_STARTUP_TIME_PROGN, Stella_Object.cons(Stella.KWD_CLASSES, Stella_Object.cons(Stella_Class.yieldDefineStellaClass(renamed_Class), Stella_Object.cons(Stella.NIL, Stella.NIL))))) : Stella.list$(Stella_Object.cons(Stella.SYM_STELLA_STARTUP_TIME_PROGN, Stella_Object.cons(Stella.KWD_CLASSES, Stella_Object.cons(Stella.list$(Stella_Object.cons(Stella.SYM_STELLA_LET, Stella_Object.cons(Stella_Object.cons(Stella.list$(Stella_Object.cons(Stella.SYM_STELLA_CLASS, Stella_Object.cons(Stella_Class.yieldDefineStellaClass(renamed_Class), Stella_Object.cons(Stella.NIL, Stella.NIL)))), Stella.NIL), Stella_Object.cons(startuptimecode.concatenate(Stella.NIL, Stella.NIL), Stella.NIL)))), Stella_Object.cons(Stella.NIL, Stella.NIL)))))));
      { Surrogate synonym = null;
        ...
        while (!(iter001 == Stella.NIL)) {
          ...
          GeneralizedSymbol.registerSymbol(Stella.internSymbolInModule(synonym.symbolName, ((Module)(synonym.homeContext)), Stella.TRUE));
        }
      }
    }
  }
    ...
    { Object old$Currenttranslationunit$000 = Stella.$CURRENTTRANSLATIONUNIT$.get();
      ...
      try {
        ...
        { MethodSlot method = ((MethodSlot)(unit.theObject));
          ...
          boolean createmethodobjectP = Stella.TRUE;
          boolean storecodepointerP = Stella.TRUE;
...
;
          ...
          if ((body == Stella.NIL) &&
            ...
            if (!(((BooleanWrapper)(KeyValueList.dynamicSlotValue(method.dynamicSlots, Stella.SYM_STELLA_METHOD_NATIVEp, Stella.FALSE_WRAPPER))).wrapperValue ||
                method.abstractP)) {
              createmethodobjectP = Stella.FALSE;
              KeyValueList.setDynamicSlotValue(method.dynamicSlots, Stella.SYM_STELLA_FORWARD_DECLARATIONp, (Stella.TRUE ? Stella.TRUE_WRAPPER : Stella.FALSE_WRAPPER), Stella.FALSE_WRAPPER);
              if (((Integer)(Stella.$TRANSLATIONVERBOSITYLEVEL$.get())).intValue() >= 3) {
                System.out.println("Forward declaration of `" + method + "'");
              }
            }
            TranslationUnit.clearTranslationUnit(unit);
          }
...
;
            ...
            if (((BooleanWrapper)(KeyValueList.dynamicSlotValue(method.dynamicSlots, Stella.SYM_STELLA_METHOD_NATIVEp, Stella.FALSE_WRAPPER))).wrapperValue ||
              ...
              storecodepointerP = Stella.FALSE;
            }
            Cons.walkAuxiliaryTree(Stella.list$(Stella_Object.cons(Stella.SYM_STELLA_STARTUP_TIME_PROGN, Stella_Object.cons(Stella.KWD_METHODS, Stella_Object.cons(MethodSlot.yieldDefineStellaMethodObject(method, (storecodepointerP ? method : null), (storecodepointerP ? evaluatorwrappermethod : null)), Stella_Object.cons(Stella.NIL, Stella.NIL))))));
          }
        }
    ...
    { MethodSlot method = ((MethodSlot)(unit.theObject));
      ...
      { Object old$Localvariabletypetable$000 = Stella.$LOCALVARIABLETYPETABLE$.get();
        ...
        try {
          ...
          Native.setSpecial(Stella.$METHODBEINGWALKED$, method);
          Native.setBooleanSpecial(Stella.$FOUNDRETURNp$, Stella.FALSE);
          ...
          { StandardObject typespec = null;
            ...
            while ((!(iter000 == Stella.NIL)) &&
              ...
              Symbol.walkADeclaration(name, typespec, null, Stella.TRUE);
            }
          }
          if (!(body == Stella.NIL)) {
            { boolean testValue000 = Stella.FALSE;
              ...
              if (testValue000) {
                body = body.concatenate(Stella_Object.cons(Stella.list$(Stella_Object.cons(Stella.SYM_STELLA_ERROR, Stella_Object.cons(Stella.wrapString("Returned from `"), Stella_Object.cons(Stella.wrapString(Native.stringify(method)), Stella_Object.cons(Stella_Object.cons(Stella.wrapString("' without a `return'."), Stella.NIL), Stella.NIL))))), Stella.NIL), Stella.NIL);
              }
            }
  ...
  public static Stella_Object accessTranslationUnitSlotValue(TranslationUnit self, Symbol slotname, Stella_Object value, boolean setvalueP) {
    if (slotname == Stella.SYM_STELLA_TU_HOME_MODULE) {
      ...
      if (setvalueP) {
        ...
        value = Stella.wrapString(self.annotation);
      }
    }
