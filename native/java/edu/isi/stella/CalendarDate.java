...
;
  ...
  public static void printCalendarDate(CalendarDate date, java.io.PrintStream stream) {
    ...
    stream.print(CalendarDate.calendarDateToString(date, 0.0, false));
    if (((Boolean)(Stella.$PRINTREADABLYp$.get())).booleanValue()) {
      stream.print(" UTC\"");
    }
    else {
    ...
    { int year = Stella.NULL_INTEGER;
      ...
      { int hours = Stella.NULL_INTEGER;
        ...
        { String yearString = ((year < 0) ? (Native.integerToString(0 - year) + "BC") : Native.integerToString(year));
          ...
          return (yearString + "-" + ((StringWrapper)((Stella.$MONTH_ABBREVIATION_VECTOR$.theArray)[month])).wrapperValue + "-" + Stella.formatWithPadding(Native.integerToString(day), 2, '0', Stella.KWD_RIGHT, false) + " " + Native.integerToString(hours) + ":" + Stella.formatWithPadding(Native.integerToString(minutes), 2, '0', Stella.KWD_RIGHT, false) + ":" + Stella.formatWithPadding(Native.integerToString(seconds), 2, '0', Stella.KWD_RIGHT, false) + "." + Stella.formatWithPadding(Native.integerToString(milli), 3, '0', Stella.KWD_RIGHT, false) + timezoneString);
        }
      }
    }
  }
