...
public class StringIterator extends AbstractIterator {
  ...
  public boolean nextP() {
    { StringIterator self = this;
      ...
      { int pos = self.cursor;
        ...
        if (pos < self.end) {
          self.value = (self.theString).charAt(pos);
          self.cursor = pos + 1;
          return (Stella.TRUE);
        }
        return (Stella.FALSE);
  ...
  public static Stella_Object accessStringIteratorSlotValue(StringIterator self, Symbol slotname, Stella_Object value, boolean setvalueP) {
    if (slotname == Stella.SYM_STELLA_THE_STRING) {
      if (setvalueP) {
        self.theString = ((StringWrapper)(value)).wrapperValue;
      }
      else {
        value = Stella.wrapString(self.theString);
      }
    }
  ...
  public Surrogate primaryType() {
    { StringIterator self = this;
      ...
      return (Stella.SGT_STELLA_STRING_ITERATOR);
    }
  }
