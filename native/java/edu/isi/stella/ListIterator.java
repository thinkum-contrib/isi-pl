...
public class ListIterator extends Iterator {
    ...
    public List listIteratorCollection;

  public static ListIterator newListIterator() {
  ...
  public boolean emptyP() {
    { ListIterator self = this;
      ...
      return ((self.firstIterationP ? (self.listIteratorCollection.theConsList == Stella.NIL) : (self.listIteratorCursor.rest == Stella.NIL)));
    }
  }
  ...
  public static boolean terminateListIteratorP(ListIterator self) {
    self.listIteratorCursor = Stella.NIL;
    self.listIteratorCollection = null;
    return (true);
  }

  public static Stella_Object accessListIteratorSlotValue(ListIterator self, Symbol slotname, Stella_Object value, boolean setvalueP) {
    if (slotname == Stella.SYM_STELLA_LIST_ITERATOR_CURSOR) {
      if (setvalueP) {
    ...
    else if (slotname == Stella.SYM_STELLA_LIST_ITERATOR_COLLECTION) {
      if (setvalueP) {
  ...
  public Surrogate primaryType() {
    { ListIterator self = this;
      ...
      return (Stella.SGT_STELLA_LIST_ITERATOR);
    }
  }
  ...
  public void free() {
    { ListIterator self = this;
      ...
      if (ListIterator.terminateListIteratorP(self)) {
