...
public class _StartupTranslateFile {
  ...
  static void helpStartupTranslateFile2() {
    {
      Stella.$RECORD_SIGNATURESp$ = Stella.FALSE;
      Stella.$WALK_WITH_RECORDED_SIGNATURESp$ = Stella.FALSE;
      Stella.$USERECORDEDSIGNATURESp$.setDefaultValue(new Boolean(Stella.FALSE));
      ...
      Stella.$TYPE_TO_FILE_EXTENSION_TABLE$ = Stella.list$(Stella_Object.cons(Stella.list$(Stella_Object.cons(Stella.KWD_STELLA, Stella_Object.cons(Stella.wrapString(".ste"), Stella_Object.cons(Stella.NIL, Stella.NIL)))), Stella_Object.cons(Stella.list$(Stella_Object.cons(Stella.KWD_KB, Stella_Object.cons(Stella.wrapString(".kb"), Stella_Object.cons(Stella.NIL, Stella.NIL)))), Stella_Object.cons(Stella.list$(Stella_Object.cons(Stella.KWD_CPP, Stella_Object.cons(Stella.wrapString(".cc"), Stella_Object.cons(Stella.NIL, Stella.NIL)))), Stella_Object.cons(Stella.list$(Stella_Object.cons(Stella.KWD_CPP_CODE, Stella_Object.cons(Stella.wrapString(".cc"), Stella_Object.cons(Stella.NIL, Stella.NIL)))), Stella_Object.cons(Stella.list$(Stella_Object.cons(Stella.KWD_CPP_HEADER, Stella_Object.cons(Stella.wrapString(".hh"), Stella_Object.cons(Stella.NIL, Stella.NIL)))), Stella_Object.cons(Stella.list$(Stella_Object.cons(Stella.KWD_C_CODE, Stella_Object.cons(Stella.wrapString(".c"), Stella_Object.cons(Stella.NIL, Stella.NIL)))), Stella_Object.cons(Stella.list$(Stella_Object.cons(Stella.KWD_C_HEADER, Stella_Object.cons(Stella.wrapString(".h"), Stella_Object.cons(Stella.NIL, Stella.NIL)))), Stella_Object.cons(Stella.list$(Stella_Object.cons(Stella.KWD_JAVA, Stella_Object.cons(Stella.wrapString(".java"), Stella_Object.cons(Stella.NIL, Stella.NIL)))), Stella_Object.cons(Stella.list$(Stella_Object.cons(Stella.KWD_IDL, Stella_Object.cons(Stella.wrapString(".idl"), Stella_Object.cons(Stella.NIL, Stella.NIL)))), Stella_Object.cons(Stella.list$(Stella_Object.cons(Stella.KWD_NONE, Stella_Object.cons(Stella.wrapString(""), Stella_Object.cons(Stella.NIL, Stella.NIL)))), Stella_Object.cons(Stella.NIL, Stella.NIL))))))))))));
      Stella.$DONTTRUNCATEFILENAMESp$.setDefaultValue(new Boolean(Stella.FALSE));
    }
  }
      ...
      try {
        ...
        if (Stella.currentStartupTimePhaseP(7)) {
          ...
          { MethodSlot function = Symbol.lookupFunction(Stella.SYM_STELLA_STARTUP_TRANSLATE_FILE);
            ...
            KeyValueList.setDynamicSlotValue(function.dynamicSlots, Stella.SYM_STELLA_METHOD_STARTUP_CLASSNAME, Stella.wrapString("_Startup-Translate-File"), Stella.NULL_STRING_WRAPPER);
          }
        }
