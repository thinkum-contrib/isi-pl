...
public class AllClassSlotsIterator extends Iterator {
    public Cons iteratorConsList;
    public Stella_Object iteratorObject;

  public static AllClassSlotsIterator newAllClassSlotsIterator() {
  ...
  public boolean nextP() {
    { AllClassSlotsIterator self = this;
      ...
      { Cons localslots = self.iteratorConsList;
        ...
        if (localslots == Stella.NIL) {
          { Cons classes = ((Cons)(self.iteratorObject));

            while ((!(classes == Stella.NIL)) &&
                (localslots == Stella.NIL)) {
              localslots = ((Stella_Class)(classes.value)).classLocalSlots.theConsList;
  ...
  public static Stella_Object accessAllClassSlotsIteratorSlotValue(AllClassSlotsIterator self, Symbol slotname, Stella_Object value, boolean setvalueP) {
    if (slotname == Stella.SYM_STELLA_ITERATOR_CONS_LIST) {
      if (setvalueP) {
  ...
  public Surrogate primaryType() {
    { AllClassSlotsIterator self = this;
      ...
      return (Stella.SGT_STELLA_ALL_CLASS_SLOTS_ITERATOR);
    }
  }
