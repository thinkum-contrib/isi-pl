...
public class Stella_Class extends Relation {
  ...
  public static Stella_Class newClass() {
    { Stella_Class self = null;
      ...
      self.classMarkedP = Stella.FALSE;
      self.classSlotAccessorCode = null;
      self.classConstructorCode = null;
      self.classStringifiedSource = null;
      self.classSlotsFinalizedP = Stella.FALSE;
      self.classFinalizedP = Stella.FALSE;
      self.classPublicP = Stella.TRUE;
      self.clStructP = Stella.FALSE;
      self.classCollectionP = Stella.FALSE;
      self.mixinP = Stella.FALSE;
      ...
      { Object old$Context$000 = Stella.$CONTEXT$.get();
        ...
        try {
          ...
          if (((Surrogate)(renamed_Class.classDirectSupers.first())) != null) {
            parentclass = GeneralizedSymbol.javaTranslateClassName(Surrogate.typeToSymbol(((Surrogate)(renamed_Class.classDirectSupers.first()))));
          }
          ...
          return (Stella_Object.cons((Stella_Class.exceptionClassP(renamed_Class) ? Stella.SYM_STELLA_JAVA_EXCEPTION_CLASS : Stella.SYM_STELLA_JAVA_CLASS), Stella_Object.cons(((((StringWrapper)(KeyValueList.dynamicSlotValue(renamed_Class.dynamicSlots, Stella.SYM_STELLA_DOCUMENTATION, Stella.NULL_STRING_WRAPPER))).wrapperValue != null) ? Stella.wrapString(((StringWrapper)(KeyValueList.dynamicSlotValue(renamed_Class.dynamicSlots, Stella.SYM_STELLA_DOCUMENTATION, Stella.NULL_STRING_WRAPPER))).wrapperValue) : null), Stella_Object.cons(modifiers, Stella_Object.cons((renamed_Class.mixinP ? Stella.wrapString("interface") : Stella.wrapString("class")), Stella_Object.cons(GeneralizedSymbol.javaTranslateClassName(Stella.internSymbolInModule(renamed_Class.classType.symbolName, ((Module)(renamed_Class.classType.homeContext)), Stella.TRUE)), Stella_Object.cons(parentclass, Stella_Object.cons(interfaceclasses, Stella_Object.cons(((!(instancevardefs == Stella.NIL)) ? Stella_Object.cons(Stella_Object.cons(Stella.SYM_STELLA_JAVA_DECLARATIONS, instancevardefs.concatenate(Stella.NIL, Stella.NIL)), Stella.NIL) : Stella.NIL), Stella_Object.cons(constructordefs, Stella_Object.cons(methoddefs, Stella.NIL)))))))))));
    ...
    { Cons instancevardefs = Stella.NIL;
      ...
      { Surrogate renamed_Super = null;
        ...
        while (!(iter001 == Stella.NIL)) {
          ...
          superclass = renamed_Super.getStellaClass(Stella.TRUE);
  ...
  public static void javaOutputClassToFile(Stella_Class renamed_Class) {
    { Object old$Context$000 = Stella.$CONTEXT$.get();
      ...
      try {
        Native.setSpecial(Stella.$CONTEXT$, renamed_Class.homeModule());
        Native.setSpecial(Stella.$MODULE$, ((Context)(Stella.$CONTEXT$.get())).baseModule);
        { String classoutputfile = renamed_Class.javaMakeCodeOutputFileName(Stella.FALSE);
          OutputFileStream classoutputstream = OutputFileStream.newOutputFileStream(classoutputfile);
          ...
          { Object old$CurrentStream$000 = Stella.$CURRENT_STREAM$.get();
            ...
            try {
              ...
              OutputStream.javaOutputFileHeader(classoutputstream, renamed_Class.javaMakeCodeOutputFileName(Stella.TRUE));
  ...
  public String javaMakeCodeOutputFileName(boolean donttruncateP) {
    { Stella_Class source = this;
      ...
      { StringWrapper barefile = GeneralizedSymbol.javaTranslateClassName(Stella.internSymbolInModule(source.classType.symbolName, ((Module)(source.classType.homeContext)), Stella.TRUE));
  ...
  public static Cons cppYieldExceptionConstructorDefinition(Stella_Class renamed_Class) {
    { Surrogate value000 = null;
      ...
      { Surrogate renamed_Super = value000;
        ...
        return (Stella.list$(Stella_Object.cons(Stella.SYM_STELLA_CPP_FUNCTION, Stella_Object.cons(Stella.NIL, Stella_Object.cons(GeneralizedSymbol.cppTranslateClassName(renamed_Class.classType), Stella_Object.cons(Stella.list$(Stella_Object.cons(Stella_Object.cons(Stella.list$(Stella_Object.cons(Stella.wrapString("const std::string&"), Stella_Object.cons(Stella.wrapString("msg"), Stella_Object.cons(Stella.NIL, Stella.NIL)))), Stella.NIL), Stella_Object.cons(Stella.NIL, Stella_Object.cons(Stella_Object.cons(Stella.list$(Stella_Object.cons(Stella.SYM_STELLA_CPP_FUNCTION_CALL, Stella_Object.cons(Stella.list$(Stella_Object.cons(Stella.SYM_STELLA_CPP_IDENT, Stella_Object.cons(GeneralizedSymbol.cppTranslateClassName(renamed_Super), Stella_Object.cons(Stella.NIL, Stella.NIL)))), Stella_Object.cons(Stella.list$(Stella_Object.cons(Stella.SYM_STELLA_CPP_ACTUALS, Stella_Object.cons(Stella.list$(Stella_Object.cons(Stella.SYM_STELLA_CPP_IDENT, Stella_Object.cons(Stella.wrapString("msg"), Stella_Object.cons(Stella.NIL, Stella.NIL)))), Stella_Object.cons(Stella.NIL, Stella.NIL)))), Stella_Object.cons(Stella.NIL, Stella.NIL))))), Stella.NIL), Stella_Object.cons(Stella.NIL, Stella.NIL))))), Stella.NIL))))));
      }
    }
  }
                ...
                if (!(optionvalue000.emptyP() ||
                  ...
                  { Object old$PrintreadablyP$000 = Stella.$PRINTREADABLYp$.get();
                    ...
                    try {
                      ...
                      Native.setBooleanSpecial(Stella.$PRINTPRETTYp$, Stella.TRUE);
                      {
                        stream.nativeStream.println();
                        stream.nativeStream.print("  :" + Native.stringDowncase(((Keyword)(KeyValueList.dynamicSlotValue(optionslot.dynamicSlots, Stella.SYM_STELLA_SLOT_OPTION_KEYWORD, null))).symbolName) + " ");
                      }
  ...
  public static Cons yieldVectorStructTree(Stella_Class renamed_Class) {
    { Surrogate value000 = null;
      ...
      { Surrogate renamed_Super = value000;
        ...
        return (Stella.list$(Stella_Object.cons(Stella.internCommonLispSymbol("DEFCLASS"), Stella_Object.cons(Symbol.clTranslateGlobalSymbol(Stella_Class.classSymbol(renamed_Class)), Stella_Object.cons(Stella_Object.cons(((renamed_Super != null) ? Stella_Object.cons(Symbol.clTranslateGlobalSymbol(Stella.internSymbolInModule(renamed_Super.symbolName, ((Module)(renamed_Super.homeContext)), Stella.TRUE)), Stella.NIL) : Stella.NIL), Stella_Object.cons(Stella.NIL, (((documentation != null) ? Stella_Object.cons(Stella.list$(Stella_Object.cons(Stella.KWD_DOCUMENTATION, Stella_Object.cons(Stella.wrapString(documentation), Stella_Object.cons(Stella.NIL, Stella.NIL)))), Stella.NIL) : Stella.NIL)).concatenate(Stella.NIL, Stella.NIL))), Stella.NIL)))));
      }
    }
  }
...
;
      ...
      return (Stella.list$(Stella_Object.cons(Stella.internCommonLispSymbol("DEFCLASS"), Stella_Object.cons(Symbol.clTranslateGlobalSymbol(Stella_Class.classSymbol(renamed_Class)), Stella_Object.cons(Stella_Object.cons(directsupers, Stella_Object.cons(closslotdefs, (((documentation != null) ? Stella_Object.cons(Stella.list$(Stella_Object.cons(Stella.KWD_DOCUMENTATION, Stella_Object.cons(Stella.wrapString(documentation), Stella_Object.cons(Stella.NIL, Stella.NIL)))), Stella.NIL) : Stella.NIL)).concatenate(Stella.NIL, Stella.NIL))), Stella.NIL)))));
    }
  }
      ...
      { boolean testValue000 = Stella.FALSE;
        ...
        if (testValue000) {
          ...
          { TranslationUnit self000 = TranslationUnit.newTranslationUnit();
            ...
            self000.codeRegister = Stella_Object.walkATree(Stella.list$(Stella_Object.cons(Stella.SYM_STELLA_IF, Stella_Object.cons(Stella.list$(Stella_Object.cons(Stella.SYM_STELLA_NULLp, Stella_Object.cons(Stella.SYM_STELLA_SELF, Stella_Object.cons(Stella.NIL, Stella.NIL)))), Stella_Object.cons(Stella.list$(Stella_Object.cons(Stella.SYM_STELLA_PRINT_NATIVE_STREAM, Stella_Object.cons(Stella.SYM_STELLA_STREAM, Stella_Object.cons(Stella.wrapString("!NULL!"), Stella_Object.cons(Stella.NIL, Stella.NIL))))), Stella_Object.cons(Stella.list$(Stella_Object.cons(Stella.SYM_STELLA_PRINT_OBJECT, Stella_Object.cons(Stella.SYM_STELLA_SELF, Stella_Object.cons(Stella.SYM_STELLA_STREAM, Stella_Object.cons(Stella.NIL, Stella.NIL))))), Stella_Object.cons(Stella.NIL, Stella.NIL)))))), new Object[1]);
            self000.auxiliaryP = Stella.TRUE;
          ...
          { Object old$Methodbeingwalked$000 = Stella.$METHODBEINGWALKED$.get();
            ...
            try {
              ...
              { TranslationUnit self002 = TranslationUnit.newTranslationUnit();
                ...
                self002.codeRegister = Stella_Object.walkATree(Stella.list$(Stella_Object.cons(Stella.SYM_STELLA_IF, Stella_Object.cons(Stella.list$(Stella_Object.cons(Stella.SYM_STELLA_NULLp, Stella_Object.cons(Stella.SYM_STELLA_SELF, Stella_Object.cons(Stella.NIL, Stella.NIL)))), Stella_Object.cons(Stella.list$(Stella_Object.cons(Stella.SYM_STELLA_RETURN, Stella_Object.cons(Stella.wrapString("!NULL!"), Stella_Object.cons(Stella.NIL, Stella.NIL)))), Stella_Object.cons(Stella.list$(Stella_Object.cons(Stella.SYM_STELLA_RETURN, Stella_Object.cons(Stella.list$(Stella_Object.cons(Stella.SYM_STELLA_VERBATIM, Stella_Object.cons(Stella.KWD_JAVA, Stella_Object.cons(Stella.wrapString("#$(STELLAROOT).javalib.Native.stringify_via_print(self)"), Stella_Object.cons(Stella.NIL, Stella.NIL))))), Stella_Object.cons(Stella.NIL, Stella.NIL)))), Stella_Object.cons(Stella.NIL, Stella.NIL)))))), new Object[1]);
                self002.auxiliaryP = Stella.TRUE;
      ...
      { Slot slot = null;
        ...
        while (!(iter000 == Stella.NIL)) {
          ...
          if (Stella_Object.methodSlotP(slot)) {
            MethodSlot.registerAuxiliaryMethod(((MethodSlot)(Cons.helpWalkAuxiliaryTree(MethodSlot.yieldMixinMethodTree(((MethodSlot)(slot)), ((Stella_Class)(Stella.SGT_STELLA_OBJECT.surrogateValue))), Stella.TRUE).theObject)), slot);
          }
        }
      }
    }
      ...
      { List mixinmethods = List.newList();
        ...
        { MethodSlot method = null;
          ...
          while (!(iter003 == Stella.NIL)) {
            ...
            MethodSlot.registerAuxiliaryMethod(((MethodSlot)(Cons.helpWalkAuxiliaryTree(MethodSlot.yieldMixinMethodTree(method, renamed_Class), Stella.TRUE).theObject)), method);
          }
        }
      }
    }
        ...
        if (Surrogate.subtypeOfStorageSlotP(Stella_Object.safePrimaryType(slot))) {
          { StorageSlot slot000 = ((StorageSlot)(slot));
            ...
            if ((Stella.translateToSingleInheritanceLanguageP() &&
              ...
              StorageSlot.createAccessorUnitsForSlot(slot000, renamed_Class, Stella.FALSE, slot000.slotExternalP);
            }
          }
        }
        else {
        ...
        while (!(iter000 == Stella.NIL)) {
          ...
          if (!method.deletedP()) {
            if (BooleanWrapper.coerceWrappedBooleanToBoolean(method.badP())) {
              method.deletedPSetter(Stella.TRUE);
            }
            else {
      ...
      { Surrogate sub = null;
        ...
        while (!(iter000 == Stella.NIL)) {
          ...
          if (!Surrogate.typeToClass(sub).mixinP) {
            if (collect000 == null) {
              {
                collect000 = Stella_Object.cons(Stella.internSymbolInModule(sub.symbolName, ((Module)(sub.homeContext)), Stella.TRUE), Stella.NIL);
              ...
              {
                collect000.rest = Stella_Object.cons(Stella.internSymbolInModule(sub.symbolName, ((Module)(sub.homeContext)), Stella.TRUE), Stella.NIL);
                collect000 = collect000.rest;
              }
            }
          }
  ...
  public static Symbol yieldGenericSlotAccessorName(Stella_Class renamed_Class) {
    return (GeneralizedSymbol.internDerivedSymbol(renamed_Class.classType, "ACCESS-" + renamed_Class.classType.symbolName + "-SLOT-VALUE"));
  }
  ...
  public static Symbol yieldInitializerName(Stella_Class renamed_Class) {
    return (GeneralizedSymbol.internDerivedSymbol(renamed_Class.classType, "initialize-" + Stella_Class.className(renamed_Class)));
  }
...
;
  ...
  public static Symbol yieldConstructorName(Stella_Class renamed_Class) {
    return (GeneralizedSymbol.internDerivedSymbol(renamed_Class.classType, "NEW-" + Stella_Class.className(renamed_Class)));
  }
...
;
  ...
  public static Cons yieldDefineStellaClass(Stella_Class renamed_Class) {
    return (Stella.list$(Stella_Object.cons(Stella.SYM_STELLA_DEFINE_CLASS_FROM_STRINGIFIED_SOURCE, Stella_Object.cons(Stella.wrapString(renamed_Class.name()), Stella_Object.cons(Stella_Object.cons(Stella.yieldStringConstantTree(renamed_Class.classStringifiedSource), Stella.NIL), Stella.NIL)))));
  }
  ...
  public static Slot lookupVisibleSlot(Stella_Class renamed_Class, Stella_Object slotName) {
    { Slot slot = null;
      ...
      { Symbol symbol = null;
        Cons iter000 = Stella.lookupVisibleSymbolsInModule(slotnamestring, module, Stella.TRUE);
  ...
  public static void helpUnfinalizeClassSlots(Stella_Class renamed_Class) {
    ...
    Stella_Class.rememberUnfinalizedClass(renamed_Class, Stella.FALSE);
    renamed_Class.classSlotsFinalizedP = Stella.FALSE;
  }
  ...
  public static void finalizeClassSlots(Stella_Class renamed_Class) {
    ...
    renamed_Class.classSlotsFinalizedP = Stella.TRUE;
  ...
  public static void unfinalizeClassAndSubclasses(Stella_Class renamed_Class) {
    ...
    Stella_Class.rememberUnfinalizedClass(renamed_Class, Stella.FALSE);
    renamed_Class.classFinalizedP = Stella.FALSE;
  }
        ...
        { Surrogate alias = null;
          ...
          while (!(iter000 == Stella.NIL)) {
            ...
            if ((((Stella_Class)(alias.surrogateValue)) != null) &&
              ...
              {
                Stella.STANDARD_WARNING.nativeStream.println("Warning: Alias `" + Stella.internSymbolInModule(alias.symbolName, ((Module)(alias.homeContext)), Stella.TRUE) + "' can't point to `" + Stella_Class.classSymbol(renamed_Class) + "' because it already points to ");
...
;
        ...
        renamed_Class.classFinalizedP = Stella.TRUE;
  ...
  public static void addPrimaryType(Stella_Class renamed_Class) {
    { Surrogate classtype = renamed_Class.classType;
      ...
      { boolean testValue000 = Stella.FALSE;
        ...
        if (testValue000) {
          slottree = Stella.list$(Stella_Object.cons(Stella_Object.cons(Stella.list$(Stella_Object.cons(Stella.SYM_STELLA_SELF, Stella_Object.cons(Stella.internSymbolInModule(classtype.symbolName, ((Module)(classtype.homeContext)), Stella.TRUE), Stella_Object.cons(Stella.NIL, Stella.NIL)))), Stella.NIL), Stella_Object.cons(Stella.KWD_TYPE, Stella_Object.cons(Stella.SYM_STELLA_TYPE, Stella_Object.cons(Stella.KWD_AUXILIARYp, Stella_Object.cons(Stella.SYM_STELLA_TRUE, Stella_Object.cons(Stella.list$(Stella_Object.cons(Stella.SYM_STELLA_RETURN, Stella_Object.cons(classtype, Stella_Object.cons(Stella.NIL, Stella.NIL)))), Stella_Object.cons(Stella.NIL, Stella.NIL))))))));
...
;
  ...
  public static void rememberUnfinalizedClass(Stella_Class renamed_Class, boolean forceP) {
    if (forceP ||
      ...
      Stella.$NEWLY_UNFINALIZED_CLASSESp$ = Stella.TRUE;
    }
  }
  ...
  public void destroyClass() {
    { Stella_Class self = this;
      ...
      self.deletedPSetter(Stella.TRUE);
      self.free();
    }
  }
    ...
    { Stella_Object value = null;
      ...
      while (iter000.nextP()) {
        ...
        if (key == Stella.KWD_DOCUMENTATION) {
          KeyValueList.setDynamicSlotValue(renamed_Class.dynamicSlots, Stella.SYM_STELLA_DOCUMENTATION, Stella.wrapString(((StringWrapper)(value)).wrapperValue), Stella.NULL_STRING_WRAPPER);
        }
        else if (key == Stella.KWD_CL_NATIVE_TYPE) {
          KeyValueList.setDynamicSlotValue(renamed_Class.dynamicSlots, Stella.SYM_STELLA_CLASS_CL_NATIVE_TYPE, Stella.wrapString(((StringWrapper)(value)).wrapperValue), Stella.NULL_STRING_WRAPPER);
        }
        else if (key == Stella.KWD_CPP_NATIVE_TYPE) {
          KeyValueList.setDynamicSlotValue(renamed_Class.dynamicSlots, Stella.SYM_STELLA_CLASS_CPP_NATIVE_TYPE, Stella.wrapString(((StringWrapper)(value)).wrapperValue), Stella.NULL_STRING_WRAPPER);
        }
        else if (key == Stella.KWD_IDL_NATIVE_TYPE) {
          KeyValueList.setDynamicSlotValue(renamed_Class.dynamicSlots, Stella.SYM_STELLA_CLASS_IDL_NATIVE_TYPE, Stella.wrapString(((StringWrapper)(value)).wrapperValue), Stella.NULL_STRING_WRAPPER);
        }
        else if (key == Stella.KWD_JAVA_NATIVE_TYPE) {
          KeyValueList.setDynamicSlotValue(renamed_Class.dynamicSlots, Stella.SYM_STELLA_CLASS_JAVA_NATIVE_TYPE, Stella.wrapString(((StringWrapper)(value)).wrapperValue), Stella.NULL_STRING_WRAPPER);
        }
          ...
          if (renamed_Class.mixinP) {
            renamed_Class.abstractP = Stella.TRUE;
          }
        }
...
;
  ...
  public static Symbol classSymbol(Stella_Class renamed_Class) {
    return (Stella.internSymbolInModule(renamed_Class.classType.symbolName, ((Module)(renamed_Class.classType.homeContext)), Stella.TRUE));
  }
  ...
  public static Stella_Object accessClassSlotValue(Stella_Class self, Symbol slotname, Stella_Object value, boolean setvalueP) {
    if (slotname == Stella.SYM_STELLA_CL_STRUCTp) {
      ...
      value = Stella.wrapInteger(self.classArity());
    }
      ...
      if (setvalueP) {
        ...
        value = Stella.wrapString(self.classStringifiedSource);
      }
    }
      ...
      if (setvalueP) {
        ...
        value = Stella.wrapFunctionCode(self.classConstructorCode);
      }
    }
      ...
      if (setvalueP) {
        ...
        value = Stella.wrapFunctionCode(self.classSlotAccessorCode);
      }
    }
