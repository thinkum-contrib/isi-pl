...
public class Stella_Class extends Relation {
  ...
  public String javaMakeCodeOutputFileName(boolean donttruncateP) {
    { Stella_Class source = this;
      ...
      { StringWrapper barefile = GeneralizedSymbol.javaTranslateClassName(Stella.internSymbolInModule(source.classType.symbolName, ((Module)(source.classType.homeContext)), true));
  ...
  public static Cons yieldVectorStructTree(Stella_Class renamed_Class) {
    { Surrogate value000 = null;
      ...
      { Surrogate renamed_Super = value000;
        ...
        return (Stella.list$(Stella_Object.cons(Stella.internCommonLispSymbol("DEFCLASS"), Stella_Object.cons(Symbol.clTranslateGlobalSymbol(Stella_Class.classSymbol(renamed_Class)), Stella_Object.cons(Stella_Object.cons(((renamed_Super != null) ? Stella_Object.cons(Symbol.clTranslateGlobalSymbol(Stella.internSymbolInModule(renamed_Super.symbolName, ((Module)(renamed_Super.homeContext)), true)), Stella.NIL) : Stella.NIL), Stella_Object.cons(Stella.NIL, (((documentation != null) ? Stella_Object.cons(Stella.list$(Stella_Object.cons(Stella.KWD_DOCUMENTATION, Stella_Object.cons(Stella.wrapString(documentation), Stella_Object.cons(Stella.NIL, Stella.NIL)))), Stella.NIL) : Stella.NIL)).concatenate(Stella.NIL, Stella.NIL))), Stella.NIL)))));
      }
    }
  }
