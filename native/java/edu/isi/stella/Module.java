...
public class Module extends Context {
  ...
  public static Module newModule() {
    { Module self = null;
      ...
      self.caseSensitiveP = Stella.FALSE;
      self.requires = null;
    ...
    { String classoutputfile = null;
      ...
      { Object old$Module$000 = Stella.$MODULE$.get();
        ...
        try {
          ...
          classoutputfile = Module.javaMakeGlobalOutputFileName(module, Stella.FALSE);
          ...
          { Object old$CurrentStream$000 = Stella.$CURRENT_STREAM$.get();
            ...
            try {
              ...
              OutputStream.javaOutputFileHeader(classoutputstream, Module.javaMakeGlobalOutputFileName(module, Stella.TRUE));
              if (classunit != null) {
              ...
              if (testValue000 == Stella.KWD_INCLUDES) {
                ...
                { Keyword testValue001 = ((Keyword)(key));
                  ...
                  if (testValue001 == Stella.KWD_DOCUMENTATION) {
                    ...
                    KeyValueList.setDynamicSlotValue(self.dynamicSlots, Stella.SYM_STELLA_APIp, ((value == Stella.SYM_STELLA_TRUE) ? Stella.TRUE_WRAPPER : Stella.FALSE_WRAPPER), Stella.FALSE_WRAPPER);
                  }
                    ...
                    KeyValueList.setDynamicSlotValue(self.dynamicSlots, Stella.SYM_STELLA_CLEARABLEp, ((value == Stella.SYM_STELLA_TRUE) ? Stella.TRUE_WRAPPER : Stella.FALSE_WRAPPER), Stella.FALSE_WRAPPER);
                  }
                  else if (testValue001 == Stella.KWD_PROTECT_SURROGATESp) {
                    KeyValueList.setDynamicSlotValue(self.dynamicSlots, Stella.SYM_STELLA_PROTECT_SURROGATESp, ((value == Stella.SYM_STELLA_TRUE) ? Stella.TRUE_WRAPPER : Stella.FALSE_WRAPPER), Stella.FALSE_WRAPPER);
                  }
                  else if (testValue001 == Stella.KWD_CODE_ONLYp) {
                    KeyValueList.setDynamicSlotValue(self.dynamicSlots, Stella.SYM_STELLA_CODE_ONLYp, ((value == Stella.SYM_STELLA_TRUE) ? Stella.TRUE_WRAPPER : Stella.FALSE_WRAPPER), Stella.FALSE_WRAPPER);
                  }
    ...
    { Surrogate testValue000 = Stella_Object.safePrimaryType(usees);
      ...
      if (testValue000 == Stella.SGT_STELLA_CONS) {
        ...
        { StringWrapper usees000 = ((StringWrapper)(usees));
          ...
          { Module useemodule = Stella_Object.coerceToModule(usees000, Stella.TRUE);
    ...
    { Surrogate testValue000 = Stella_Object.safePrimaryType(includees);
      ...
      if (testValue000 == Stella.SGT_STELLA_CONS) {
        ...
        { StringWrapper includees000 = ((StringWrapper)(includees));
          ...
          { Module includeemodule = Stella_Object.coerceToModule(includees000, Stella.TRUE);
...
;
              ...
              Module.linkToParentModule(module, parentmodule, Stella.TRUE);
            }
          }
        }
      }
      else {
        {
          if (module.parentModules.emptyP()) {
            Module.linkToParentModule(module, Stella.$ROOT_MODULE$, Stella.TRUE);
          }
          barename = name;
        }
      }
