...
public class KeyValueList extends Dictionary {
          ...
          if (useclstructsP) {
            ...
            { StringWrapper file = null;
              ...
              while (!(iter002 == Stella.NIL)) {
                ...
                if (((List)(systemunits.lookup(Stella.wrapString(filename = Stella.makeFileName(file.wrapperValue, Stella.KWD_STELLA, Stella.TRUE))))) == null) {
                  Native.setSpecial(Stella.$TRANSLATIONUNITS$, List.newList());
  ...
  public static void fillInDateSubstitution(KeyValueList substitutionList) {
    { int year = Stella.NULL_INTEGER;
      ...
      substitutionList.insertAt(Stella.wrapString("DATE"), Stella.wrapString(Stella.formatWithPadding(Native.integerToString(day), 2, '0', Stella.KWD_RIGHT, Stella.FALSE) + "-" + ((StringWrapper)((Stella.$MONTH_ABBREVIATION_VECTOR$.theArray)[month])).wrapperValue + "-" + Native.integerToString(year)));
    }
  }
