  ...
  static void helpStartupDescribe2() {
    {
      ...
      { MethodSlot function = Symbol.lookupFunction(Stella.SYM_STELLA_STARTUP_DESCRIBE);
        ...
        KeyValueList.setDynamicSlotValue(function.dynamicSlots, Stella.SYM_STELLA_METHOD_STARTUP_CLASSNAME, Stella.wrapString("_Startup-Describe"), Stella.NULL_STRING_WRAPPER);
      }
    }
  }
    ...
    { Object old$Module$000 = Stella.$MODULE$.get();
      ...
      try {
        ...
        if (Stella.currentStartupTimePhaseP(9)) {
          ...
          Stella.$STRING_TO_OBJECT_FUNCTIONS$.insertAt(Stella.SGT_STELLA_CLASS, Stella.wrapFunctionCode(Native.find_java_method("edu.isi.stella.Stella", "stringToClass", new java.lang.Class [] {Native.find_java_class("java.lang.String")})));
          Stella.$STRING_TO_OBJECT_FUNCTIONS$.insertAt(Stella.SGT_STELLA_CONTEXT, Stella.wrapFunctionCode(Native.find_java_method("edu.isi.stella.Stella", "stringToContext", new java.lang.Class [] {Native.find_java_class("java.lang.String")})));
          Stella.$STRING_TO_OBJECT_FUNCTIONS$.insertAt(Stella.SGT_STELLA_METHOD_SLOT, Stella.wrapFunctionCode(Native.find_java_method("edu.isi.stella.Stella", "stringToFunction", new java.lang.Class [] {Native.find_java_class("java.lang.String")})));
          Stella.$STRING_TO_OBJECT_FUNCTIONS$.insertAt(Stella.SGT_STELLA_SLOT, Stella.wrapFunctionCode(Native.find_java_method("edu.isi.stella.Stella", "stringToSlot", new java.lang.Class [] {Native.find_java_class("java.lang.String")})));
          Stella.$STRING_TO_OBJECT_FUNCTIONS$.insertAt(Stella.SGT_STELLA_OBJECT, Stella.wrapFunctionCode(Native.find_java_method("edu.isi.stella.Stella", "stringToSurrogateValue", new java.lang.Class [] {Native.find_java_class("java.lang.String")})));
          Stella.$STRING_TO_OBJECT_FUNCTIONS$.insertAt(Stella.SGT_STELLA_DEMON, Stella.wrapFunctionCode(Native.find_java_method("edu.isi.stella.Stella", "stringToDemon", new java.lang.Class [] {Native.find_java_class("java.lang.String")})));
          Stella.$INTEGER_TO_OBJECT_FUNCTIONS$.insert(Stella.wrapFunctionCode(Native.find_java_method("edu.isi.stella.Stella", "integerToContext", new java.lang.Class [] {java.lang.Integer.TYPE})));
