      ...
      { Object old$PrintreadablyP$000 = Stella.$PRINTREADABLYp$.get();
        ...
        try {
          ...
          if (!(Stella.suppressWarningsP())) {
            ...
            {
              System.out.println();
              System.out.println(" Cannot inline method `" + Stella_Object.deUglifyParseTree(method) + "', since there are");
              System.out.println(" one or more methods that specialize it.");
            }
;
          }
