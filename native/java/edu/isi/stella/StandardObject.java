...
public abstract class StandardObject extends Stella_Object {
    ...
    { Surrogate testValue000 = Stella_Object.safePrimaryType(typespec);
      ...
      if (Surrogate.subtypeOfParametricTypeSpecifierP(testValue000)) {
        { ParametricTypeSpecifier typespec000 = ((ParametricTypeSpecifier)(typespec));
          ...
          return (Stella.wrapString(StandardObject.idlTranslateTypeSpec(typespec000.specifierBaseType).wrapperValue + "<" + StandardObject.idlTranslateTypeSpec(((StandardObject)(typespec000.specifierParameterTypes.first()))).wrapperValue + ">"));
        }
      }
        ...
        { Surrogate typespec000 = ((Surrogate)(typespec));
          ...
          if (((StringWrapper)(KeyValueList.dynamicSlotValue(((Stella_Class)(typespec000.surrogateValue)).dynamicSlots, Stella.SYM_STELLA_CLASS_IDL_NATIVE_TYPE, Stella.NULL_STRING_WRAPPER))).wrapperValue != null) {
            return (Stella.wrapString(((StringWrapper)(KeyValueList.dynamicSlotValue(((Stella_Class)(typespec000.surrogateValue)).dynamicSlots, Stella.SYM_STELLA_CLASS_IDL_NATIVE_TYPE, Stella.NULL_STRING_WRAPPER))).wrapperValue));
          }
          else {
            return (GeneralizedSymbol.idlTranslateClassName(Surrogate.typeToSymbol(((Stella_Class)(typespec000.surrogateValue)).classType)));
          }
        }
      }
      else {
  ...
  public static Cons javaYieldClassObjectExpression(StandardObject typespec) {
    { Cons otree = null;
      ...
      if (classtype == Stella.SGT_STELLA_VOID) {
        otree = Stella.list$(Stella_Object.cons(Stella.SYM_STELLA_JAVA_VERBATIM, Stella_Object.cons(Stella.wrapString("java.lang.Void.TYPE"), Stella_Object.cons(Stella.NIL, Stella.NIL))));
      }
      else if (classtype == Stella.SGT_STELLA_BOOLEAN) {
        otree = Stella.list$(Stella_Object.cons(Stella.SYM_STELLA_JAVA_VERBATIM, Stella_Object.cons(Stella.wrapString("java.lang.Boolean.TYPE"), Stella_Object.cons(Stella.NIL, Stella.NIL))));
      }
      else if ((classtype == Stella.SGT_STELLA_INTEGER) ||
          (classtype == Stella.SGT_STELLA_THIRTY_TWO_BIT_VECTOR)) {
        otree = Stella.list$(Stella_Object.cons(Stella.SYM_STELLA_JAVA_VERBATIM, Stella_Object.cons(Stella.wrapString("java.lang.Integer.TYPE"), Stella_Object.cons(Stella.NIL, Stella.NIL))));
      }
      else if (classtype == Stella.SGT_STELLA_CHARACTER) {
        otree = Stella.list$(Stella_Object.cons(Stella.SYM_STELLA_JAVA_VERBATIM, Stella_Object.cons(Stella.wrapString("java.lang.Character.TYPE"), Stella_Object.cons(Stella.NIL, Stella.NIL))));
      }
      else if ((classtype == Stella.SGT_STELLA_BYTE) ||
          (classtype == Stella.SGT_STELLA_OCTET)) {
        otree = Stella.list$(Stella_Object.cons(Stella.SYM_STELLA_JAVA_VERBATIM, Stella_Object.cons(Stella.wrapString("java.lang.Byte.TYPE"), Stella_Object.cons(Stella.NIL, Stella.NIL))));
      }
      else if ((classtype == Stella.SGT_STELLA_FLOAT) ||
          (classtype == Stella.SGT_STELLA_DOUBLE_FLOAT)) {
        otree = Stella.list$(Stella_Object.cons(Stella.SYM_STELLA_JAVA_VERBATIM, Stella_Object.cons(Stella.wrapString("java.lang.Double.TYPE"), Stella_Object.cons(Stella.NIL, Stella.NIL))));
      }
      else if ((classtype == Stella.SGT_STELLA_SHORT_INTEGER) ||
          (classtype == Stella.SGT_STELLA_UNSIGNED_SHORT_INTEGER)) {
        otree = Stella.list$(Stella_Object.cons(Stella.SYM_STELLA_JAVA_VERBATIM, Stella_Object.cons(Stella.wrapString("java.lang.Short.TYPE"), Stella_Object.cons(Stella.NIL, Stella.NIL))));
      }
        ...
        otree = Stella.list$(Stella_Object.cons(Stella.SYM_STELLA_JAVA_VERBATIM, Stella_Object.cons(Stella.wrapString("java.lang.Long.TYPE"), Stella_Object.cons(Stella.NIL, Stella.NIL))));
      }
      else if (classtype == Stella.SGT_STELLA_SINGLE_FLOAT) {
        otree = Stella.list$(Stella_Object.cons(Stella.SYM_STELLA_JAVA_VERBATIM, Stella_Object.cons(Stella.wrapString("java.lang.Float.TYPE"), Stella_Object.cons(Stella.NIL, Stella.NIL))));
      }
  ...
  public static String javaYieldTranslatedClassAndMethodNames(StandardObject owner, MethodSlot f, Object [] MV_returnarray) {
    if (((BooleanWrapper)(KeyValueList.dynamicSlotValue(f.dynamicSlots, Stella.SYM_STELLA_METHOD_NATIVEp, Stella.FALSE_WRAPPER))).wrapperValue) {
      { String _return_temp = Stella.javaYieldFullNativeClassName();
        ...
        MV_returnarray[0] = Stella.wrapString(MethodSlot.javaTranslateFunctionName(f).wrapperValue);
        return (_return_temp);
      }
    }
    ...
    { Surrogate basetypespec = StandardObject.typeSpecToBaseType(typespec);
      ...
      if (nativetype != null) {
        if (Native.string_memberP(nativetype, '.') ||
          ...
          return (Stella.wrapString(nativetype));
        }
        else {
          return (Stella.wrapString("java.lang." + nativetype));
        }
      }
      ...
      if (Native.string_memberP(translatedtype.wrapperValue, '.')) {
        ...
        return (Stella.wrapString(Module.javaPackagePrefix(basetypespec.homeModule(), ".") + translatedtype.wrapperValue));
      }
    }
  }
  ...
  public static StringWrapper javaTranslateArrayOfTypeSpec(StandardObject typespec, boolean fullyqualifiedP) {
    { String basetypestring = (fullyqualifiedP ? StandardObject.javaYieldFullyQualifiedTypeName(typespec).wrapperValue : StandardObject.javaTranslateTypeSpec(typespec).wrapperValue);
      ...
      return (Stella.wrapString(basetypestring + " []"));
    }
  }
        ...
        if (Surrogate.subtypeOfParametricTypeSpecifierP(testValue000)) {
          ...
          { Surrogate typeSpec000 = ((Surrogate)(typeSpec));
            ...
            if (((StringWrapper)(KeyValueList.dynamicSlotValue(((Stella_Class)(typeSpec000.surrogateValue)).dynamicSlots, Stella.SYM_STELLA_CLASS_JAVA_NATIVE_TYPE, Stella.NULL_STRING_WRAPPER))).wrapperValue != null) {
              return (Stella.wrapString(((Stella_Class)(typeSpec000.surrogateValue)).javaNativeType()));
            }
            else {
              finalType = ((Stella_Class)(typeSpec000.surrogateValue)).classType;
              typeName = StringWrapper.javaTranslateClassNamestring(Stella.wrapString(finalType.symbolName)).wrapperValue;
              if (Module.omitJavaPackagePrefixP(finalType.homeModule(), finalType.symbolName)) {
                return (Stella.wrapString(typeName));
              }
              else {
                return (Stella.wrapString(Module.javaPackagePrefix(finalType.homeModule(), ".") + typeName));
              }
            }
          }
        }
  ...
  public static StringWrapper javaSpecialSetterName(StandardObject typespec) {
    { Surrogate testValue000 = StandardObject.typeSpecToBaseType(typespec);
      ...
      if (testValue000 == Stella.SGT_STELLA_BOOLEAN) {
        return (Stella.wrapString("setBooleanSpecial"));
      }
        ...
        return (Stella.wrapString("setIntSpecial"));
      }
      else if ((testValue000 == Stella.SGT_STELLA_FLOAT) ||
          (testValue000 == Stella.SGT_STELLA_DOUBLE)) {
        return (Stella.wrapString("setDoubleSpecial"));
      }
      else if (testValue000 == Stella.SGT_STELLA_CHARACTER) {
        return (Stella.wrapString("setCharSpecial"));
      }
      else if (testValue000 == Stella.SGT_STELLA_LONG_INTEGER) {
        return (Stella.wrapString("setLongSpecial"));
      }
      else if (testValue000 == Stella.SGT_STELLA_SINGLE_FLOAT) {
        return (Stella.wrapString("setFloatSpecial"));
      }
      else {
        return (Stella.wrapString("setSpecial"));
      }
    }
  }
  ...
  public static StringWrapper javaNativeLiteralWrapperNames(StandardObject typespec, Object [] MV_returnarray) {
    { GeneralizedSymbol testValue000 = ((GeneralizedSymbol)(typespec));
      ...
      if (testValue000 == Stella.SGT_STELLA_BOOLEAN) {
        { StringWrapper _return_temp = Stella.wrapString("Boolean");

          MV_returnarray[0] = Stella.wrapString("booleanValue");
          return (_return_temp);
        }
      }
      else if ((testValue000 == Stella.SGT_STELLA_INTEGER) ||
          ((testValue000 == Stella.SGT_STELLA_SHORT_INTEGER) ||
           ((testValue000 == Stella.SGT_STELLA_UNSIGNED_SHORT_INTEGER) ||
            ((testValue000 == Stella.SGT_STELLA_BYTE) ||
             ((testValue000 == Stella.SGT_STELLA_OCTET) ||
              (testValue000 == Stella.SGT_STELLA_THIRY_TWO_BIT_VECTOR)))))) {
        { StringWrapper _return_temp = Stella.wrapString("Integer");

          MV_returnarray[0] = Stella.wrapString("intValue");
          return (_return_temp);
        }
      }
      else if ((testValue000 == Stella.SGT_STELLA_FLOAT) ||
          (testValue000 == Stella.SGT_STELLA_DOUBLE)) {
        { StringWrapper _return_temp = Stella.wrapString("Double");

          MV_returnarray[0] = Stella.wrapString("doubleValue");
          return (_return_temp);
        }
      }
      else if (testValue000 == Stella.SGT_STELLA_CHARACTER) {
        { StringWrapper _return_temp = Stella.wrapString("Character");

          MV_returnarray[0] = Stella.wrapString("charValue");
          return (_return_temp);
        }
      }
      else if (testValue000 == Stella.SGT_STELLA_LONG_INTEGER) {
        { StringWrapper _return_temp = Stella.wrapString("Long");

          MV_returnarray[0] = Stella.wrapString("longValue");
          return (_return_temp);
        }
      }
      else if (testValue000 == Stella.SGT_STELLA_SINGLE_FLOAT) {
        { StringWrapper _return_temp = Stella.wrapString("Float");

          MV_returnarray[0] = Stella.wrapString("floatValue");
          return (_return_temp);
        }
      }
      else {
  ...
  public static StringWrapper cppReferencizeType(StandardObject typespec) {
    return (Stella.wrapString(Native.string_substitute(StandardObject.cppTranslateTypeSpec(typespec).wrapperValue, '&', '*')));
  }
      ...
      if (Surrogate.subtypeOfParametricTypeSpecifierP(testValue000)) {
        { ParametricTypeSpecifier typespec000 = ((ParametricTypeSpecifier)(typespec));
          ...
          if (((Keyword)(Stella.$TRANSLATOROUTPUTLANGUAGE$.get())) == Stella.KWD_CPP_STANDALONE) {
            return (Stella.wrapString(StandardObject.cppTranslateTypeSpec(typespec000.specifierBaseType).wrapperValue + "<" + StandardObject.cppTranslateAndPointerizeTypeSpec(((StandardObject)(typespec000.specifierParameterTypes.first()))).wrapperValue + ">"));
          }
        ...
        { Surrogate typespec000 = ((Surrogate)(typespec));
          ...
          if (((StringWrapper)(KeyValueList.dynamicSlotValue(((Stella_Class)(typespec000.surrogateValue)).dynamicSlots, Stella.SYM_STELLA_CLASS_CPP_NATIVE_TYPE, Stella.NULL_STRING_WRAPPER))).wrapperValue != null) {
            return (Stella.wrapString(((StringWrapper)(KeyValueList.dynamicSlotValue(((Stella_Class)(typespec000.surrogateValue)).dynamicSlots, Stella.SYM_STELLA_CLASS_CPP_NATIVE_TYPE, Stella.NULL_STRING_WRAPPER))).wrapperValue));
          }
          else {
            return (GeneralizedSymbol.cppTranslateClassTypename(Surrogate.typeToSymbol(((Stella_Class)(typespec000.surrogateValue)).classType)));
          }
        }
      }
      else {
...
;
  ...
  public static Stella_Object writeSlotValue(StandardObject self, StorageSlot slot, Stella_Object value) {
    { java.lang.reflect.Method code = ((Stella_Class)(slot.slotOwner.surrogateValue)).classSlotAccessorCode;
      ...
      if (code != null) {
        return (((Stella_Object)(edu.isi.stella.javalib.Native.funcall(code, null, new java.lang.Object [] {self, slot.slotName, value, new Boolean(Stella.TRUE)}))));
      }
...
;
  ...
  public static Stella_Object readSlotValue(StandardObject self, StorageSlot slot) {
    { java.lang.reflect.Method code = ((Stella_Class)(slot.slotOwner.surrogateValue)).classSlotAccessorCode;
      ...
      if (code != null) {
        return (((Stella_Object)(edu.isi.stella.javalib.Native.funcall(code, null, new java.lang.Object [] {self, slot.slotName, ((Stella_Object)(null)), new Boolean(Stella.FALSE)}))));
      }
      if (Surrogate.subtypeOfP(self.primaryType(), slot.slotOwner)) {
            ...
            loop001 : while (!(iter001 == Stella.NIL)) {
              ...
              if (slot.slotName == requiredslotname) {
                ...
                if (arraytypeP) {
                  ...
                  requiredvalues.insertLast(Stella_Object.walkExpressionTree(valueref, slot.computeReturnTypeSpec(classtype), Stella.SYM_STELLA_NEW, Stella.FALSE, new Object[1]));
                }
    ...
    { Surrogate testValue000 = Stella_Object.safePrimaryType(self);
      ...
      if (Surrogate.subtypeOfSurrogateP(testValue000)) {
        { Surrogate self000 = ((Surrogate)(self));
          ...
          return (Stella.internSymbolInModule(self000.symbolName, ((Module)(self000.homeContext)), Stella.TRUE));
        }
      }
        ...
        { ParametricTypeSpecifier self000 = ((ParametricTypeSpecifier)(self));
          ...
          { Cons listoftypes = Stella.NIL;
            ...
            return (Stella_Object.cons(Stella.internSymbolInModule(self000.specifierBaseType.symbolName, ((Module)(self000.specifierBaseType.homeContext)), Stella.TRUE), ((StandardObject.arrayTypeSpecifierP(self000) ? Stella.list$(Stella_Object.cons(Stella.SYM_STELLA_SIZE, Stella_Object.cons(ParametricTypeSpecifier.yieldArrayDimensionsTree(self000), Stella_Object.cons(Stella.NIL, Stella.NIL)))) : Stella.NIL)).concatenate(Stella_Object.cons(Stella.SYM_STELLA_OF, listoftypes.concatenate(Stella.NIL, Stella.NIL)), Stella.NIL)));
          }
        }
      }
      ...
      if (Surrogate.subtypeOfParametricTypeSpecifierP(testValue000)) {
        { ParametricTypeSpecifier relativetype000 = ((ParametricTypeSpecifier)(relativetype));
          ...
          { List typeslist = List.newList();
            ...
            boolean foundrelativistictypeP = Stella.FALSE;
            ...
            { StandardObject ts = null;
              ...
              while (!(iter001 == Stella.NIL)) {
                ...
                if (!(relativets == ts)) {
                  foundrelativistictypeP = Stella.TRUE;
                }
                if (collect000 == null) {
                  {
