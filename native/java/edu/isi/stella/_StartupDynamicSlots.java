    ...
    { Object old$Module$000 = Stella.$MODULE$.get();
      ...
      try {
        ...
        if (Stella.currentStartupTimePhaseP(2)) {
          Stella.SYM_STELLA_DYNAMIC_SLOT_VALUE = ((Symbol)(Stella.internRigidSymbolWrtModule("DYNAMIC-SLOT-VALUE", null, 0)));
          Stella.SYM_STELLA_STARTUP_DYNAMIC_SLOTS = ((Symbol)(Stella.internRigidSymbolWrtModule("STARTUP-DYNAMIC-SLOTS", null, 0)));
        }
        ...
        if (Stella.currentStartupTimePhaseP(7)) {
          ...
          { MethodSlot function = Symbol.lookupFunction(Stella.SYM_STELLA_STARTUP_DYNAMIC_SLOTS);
            ...
            KeyValueList.setDynamicSlotValue(function.dynamicSlots, Stella.SYM_STELLA_METHOD_STARTUP_CLASSNAME, Stella.wrapString("_Startup-Dynamic-Slots"), Stella.NULL_STRING_WRAPPER);
          }
        }
