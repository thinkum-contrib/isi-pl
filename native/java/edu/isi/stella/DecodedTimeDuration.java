  ...
  public static Stella_Object accessDecodedTimeDurationSlotValue(DecodedTimeDuration self, Symbol slotname, Stella_Object value, boolean setvalueP) {
    if (slotname == Stella.SYM_STELLA_DURATION_MILLIS) {
      if (setvalueP) {
        ...
        value = Stella.wrapFloat(self.durationMillis);
      }
    }
      ...
      if (setvalueP) {
        ...
        value = Stella.wrapInteger(self.durationSeconds);
      }
    }
      ...
      if (setvalueP) {
        ...
        value = Stella.wrapInteger(self.durationMinutes);
      }
    }
      ...
      if (setvalueP) {
        ...
        value = Stella.wrapInteger(self.durationHours);
      }
    }
      ...
      if (setvalueP) {
        ...
        value = Stella.wrapInteger(self.durationDays);
      }
    }
    else {
