...
public abstract class Stella_Object {
  ...
  public static void javaHelpOutputPrintStream(Stella_Object stream, Cons exps, boolean nativestreamP, boolean endoflineP) {
    if (stream == Stella.SYM_STELLA_JAVA_STANDARD_OUT) {
      if ((Stella.string_getStellaClass("SYSTEM", Stella.FALSE) != null) ||
        ...
        if (Stella_Object.consP(statement000.value) ||
          ...
          { GeneralizedSymbol testValue000 = ((GeneralizedSymbol)(statement000.value));
            ...
            if (testValue000 == Stella.SYM_STELLA_JAVA_CLASS) {
              Cons.javaOutputClass(statement000.rest, Stella.FALSE);
            }
            else if (testValue000 == Stella.SYM_STELLA_JAVA_EXCEPTION_CLASS) {
              Cons.javaOutputClass(statement000.rest, Stella.TRUE);
            }
              ...
              Cons.javaOutputPrintStream(statement000.rest, Stella.FALSE);
            }
            else if (testValue000 == Stella.SYM_STELLA_JAVA_PRINT_NATIVE_STREAM) {
              Cons.javaOutputPrintStream(statement000.rest, Stella.TRUE);
            }
      ...
      { Cons tree000 = ((Cons)(tree));
        ...
        { GeneralizedSymbol testValue000 = ((GeneralizedSymbol)(tree000.value));
          ...
          if (testValue000 == Stella.SYM_STELLA_SPECIAL) {
            ...
            return (Cons.cppTranslateMethodCall(tree000.rest, Stella.FALSE));
          }
          else if (testValue000 == Stella.SYM_STELLA_SYS_REFERENCED_CALL_METHOD) {
            return (Cons.cppTranslateMethodCall(tree000.rest, Stella.TRUE));
          }
          else if (testValue000 == Stella.SYM_STELLA_SYS_CALL_FUNCTION) {
  ...
  public static void describe(Stella_Object name, Cons mode) {
    { Stella_Object renamed_Object = ((name == null) ? ((Stella_Object)(null)) : name.getObject(null));
      ...
      if (validmode == null) {
        {
          System.out.println("Valid modes (the second argument to 'describe') are ");
          System.out.println("   :VERBOSE, :TERSE, and :SOURCE");
        }
;
        ...
        { Surrogate testValue000 = Stella_Object.safePrimaryType(typeref);
          ...
          if (Surrogate.subtypeOfSymbolP(testValue000)) {
            { Symbol typeref000 = ((Symbol)(typeref));
              ...
              classtype = Stella.lookupSurrogateInModule(typeref000.symbolName, ((Module)(typeref000.homeContext)), Stella.FALSE);
            }
          }
          else if (Surrogate.subtypeOfSurrogateP(testValue000)) {
            ...
            System.out.println("Invalid type reference: `" + typeref + "'");
          }
        }
        if ((classtype != null) &&
            ((classtype.surrogateValue == null) ||
             (!Stella_Object.isaP(classtype.surrogateValue, Stella.SGT_STELLA_CLASS)))) {
          System.out.println("No class exists with name: `" + classtype.symbolName + "'");
          classtype = null;
        }
      }
      { Surrogate testValue001 = Stella_Object.safePrimaryType(self);
        ...
        if (Surrogate.subtypeOfStringP(testValue001)) {
          ...
          { Symbol self000 = ((Symbol)(self));
            ...
            return (Stella_Object.searchForObject(Stella.wrapString(self000.symbolName), classtype));
          }
        }
      ...
      { Stella_Object value = null;
        ...
        while (!(iter000 == Stella.NIL)) {
          ...
          if ((!Stella_Object.stellaObjectP(key)) ||
            ...
            {
              System.out.println("Skipping illegal option: `" + key + "'");
              System.out.println();
            }
;
            if (Stella_Object.keywordP(key)) {
              {
                System.out.println("   Legal options are: `" + legaloptions + "'");
                System.out.println();
              }
;
            }
            else {
              System.out.println("   Option must be a keyword.");
            }
            Stella_Object.vetOptions(propertylist, legaloptions);
            return (propertylist);
          }
  ...
  public static Stella_Object evaluateCommand(Stella_Object command, boolean finalizeP) {
    { Object old$Translationerrors$000 = Stella.$TRANSLATIONERRORS$.get();
      ...
      try {
        ...
        Native.setBooleanSpecial(Stella.$IGNORETRANSLATIONERRORSp$, Stella.FALSE);
                ...
                if (Surrogate.subtypeOfSymbolP(Stella_Object.safePrimaryType(operator))) {
                  { Symbol operator000 = ((Symbol)(operator));
                    ...
                    if (operator000 == Stella.SYM_STELLA_IN_MODULE) {
                      Cons.handleInModuleTree(command000, Stella.FALSE, new Object[1]);
                    }
                    else {
                      if (Cons.declarationTreeP(command000)) {
                        Native.setSpecial(Stella.$TRANSLATIONUNITS$, Stella.list(Stella.NIL));
                        Cons.walkTopLevelTree(command000, Stella.FALSE);
...
;
  ...
  public static boolean stellaNeedToCompileP(Stella_Object file) {
    { String sourcefile = Stella.makeFileName(((StringWrapper)(file)).wrapperValue, Stella.KWD_LISP, Stella.TRUE);
      String compiledfile = Stella.makeFileName(((StringWrapper)(file)).wrapperValue, Stella.KWD_LISP_BINARY, Stella.TRUE);
  ...
  public static boolean stellaNeedToTranslateP(Stella_Object file, Keyword language) {
    ...
    { String sourcefile = Stella.makeFileName(((StringWrapper)(file)).wrapperValue, Stella.KWD_STELLA, Stella.TRUE);
      String translatedfile = Stella.makeFileName(((StringWrapper)(file)).wrapperValue, Keyword.languageToFileType(language), Stella.TRUE);
  ...
  public static String makeFileNameFromRelativePath(Stella_Object filepath, Keyword type) {
    return (Stella.makeFileName(Stella_Object.implodePathname(filepath), type, Stella.TRUE));
  }
  ...
  public static Stella_Object withinWorld(Stella_Object worldform, Cons body) {
    return (Stella.list$(Stella_Object.cons(Stella.SYM_STELLA_SPECIAL, Stella_Object.cons(Stella_Object.cons(Stella.list$(Stella_Object.cons(Stella.SYM_STELLA_$CONTEXT$, Stella_Object.cons(worldform, Stella_Object.cons(Stella.NIL, Stella.NIL)))), Stella.NIL), Stella_Object.cons(Stella.list$(Stella_Object.cons(Stella.SYM_STELLA_SAFETY, Stella_Object.cons(Stella.wrapInteger(3), Stella_Object.cons(Stella.list$(Stella_Object.cons(Stella.SYM_STELLA_EQLp, Stella_Object.cons(Stella.list$(Stella_Object.cons(Stella.SYM_STELLA_BASE_MODULE, Stella_Object.cons(Stella.list$(Stella_Object.cons(Stella.SYM_STELLA_CAST, Stella_Object.cons(Stella.SYM_STELLA_$CONTEXT$, Stella_Object.cons(Stella.SYM_STELLA_WORLD, Stella_Object.cons(Stella.NIL, Stella.NIL))))), Stella_Object.cons(Stella.NIL, Stella.NIL)))), Stella_Object.cons(Stella.SYM_STELLA_$MODULE$, Stella_Object.cons(Stella.NIL, Stella.NIL))))), Stella_Object.cons(Stella.wrapString("within-world: The base module of world "), Stella_Object.cons(Stella.SYM_STELLA_$CONTEXT$, Stella_Object.cons(Stella.wrapString(" does not match the current module."), Stella_Object.cons(Stella.NIL, Stella.NIL)))))))), Stella_Object.cons(body.concatenate(Stella.NIL, Stella.NIL), Stella.NIL))))));
  }
  ...
  public static Stella_Object one(Stella_Object expression) {
    return (Stella.list$(Stella_Object.cons(Stella.SYM_STELLA__, Stella_Object.cons(expression, Stella_Object.cons(Stella_Object.cons(Stella.wrapInteger(1), Stella.NIL), Stella.NIL)))));
  }
  ...
  public static Stella_Object oneI(Stella_Object expression) {
    return (Stella.list$(Stella_Object.cons(Stella.SYM_STELLA_i, Stella_Object.cons(expression, Stella_Object.cons(Stella_Object.cons(Stella.wrapInteger(1), Stella.NIL), Stella.NIL)))));
  }
...
;
  ...
  /** Return <code>true</code> if <code>form</code> is an CONS headed by a CDATA tag
   * @param form
   * @return boolean
   */
  public static boolean xmlCdataFormP(Stella_Object form) {
    return (Stella_Object.isaP(form, Stella.SGT_STELLA_CONS) &&
        Stella_Object.xmlCdataP(((XmlObject)(((Cons)(form)).value))));
  }
...
;
          ...
          { StringWrapper characterspec000 = ((StringWrapper)(characterspec));
            ...
            { char renamed_Char = Stella.NULL_CHARACTER;
              ...
              while (index000 < length000) {
                ...
                if (collect000 == null) {
                  {
                    collect000 = Stella_Object.cons(Stella.wrapCharacter(renamed_Char), Stella.NIL);
                  ...
                  {
                    collect000.rest = Stella_Object.cons(Stella.wrapCharacter(renamed_Char), Stella.NIL);
                    collect000 = collect000.rest;
                  }
                }
              }
              ...
              if (Stella.stringEqlP(testValue001, "ANY")) {
                { int i = Stella.NULL_INTEGER;
                  ...
                  while (iter002 <= upperBound000) {
                    ...
                    if (collect002 == null) {
                      {
                        collect002 = Stella_Object.cons(Stella.wrapCharacter((char) i), Stella.NIL);
                        if (charset == Stella.NIL) {
                          charset = collect002;
                        }
                        else {
                      ...
                      {
                        collect002.rest = Stella_Object.cons(Stella.wrapCharacter((char) i), Stella.NIL);
                ...
                { int i = Stella.NULL_INTEGER;
                  ...
                  while (iter005 <= upperBound001) {
                    ...
                    if (!charset.memberP(Stella.wrapCharacter((char) i))) {
                      if (collect004 == null) {
                        {
                          collect004 = Stella_Object.cons(Stella.wrapCharacter((char) i), Stella.NIL);
                        ...
                        {
                          collect004.rest = Stella_Object.cons(Stella.wrapCharacter((char) i), Stella.NIL);
  ...
  public static Module inModule(Stella_Object name) {
    { String modulename = Stella_Object.coerceToModuleName(name, Stella.TRUE);
      Module module = ((modulename != null) ? Stella.getStellaModule(modulename, Stella.FALSE) : ((Module)(null)));
  ...
  public static void defmodule(Stella_Object name, Cons options) {
    { String modulename = Stella_Object.coerceToModuleName(name, Stella.TRUE);
      ...
      if (modulename != null) {
        Stella.defineModule(modulename, options);
      }
    }
  }
  ...
  public static Module coerceToModule(Stella_Object renamed_Object, boolean warnP) {
    ...
    if (Surrogate.subtypeOfP(Stella_Object.safePrimaryType(renamed_Object), Stella.SGT_STELLA_MODULE)) {
      ...
      { String modulename = Stella_Object.coerceToModuleName(renamed_Object, warnP);
        ...
        if (modulename != null) {
          if (Stella.qualifiedNameP(modulename)) {
          ...
          if ((operator == Stella.SYM_STELLA_l) ||
            ...
            if (Stella.methodCallInliningEnabledP()) {
              if ((owner == Stella.SGT_STELLA_OBJECT) ||
                ...
                tree000 = Stella.list$(Stella_Object.cons(Stella.internCommonLispSymbol("EQ"), Stella_Object.cons(Stella_Object.clTranslateATree(arguments.value), Stella_Object.cons(Stella_Object.cons(Stella_Object.clTranslateATree(Surrogate.typeToWalkedNullValueTree(owner)), Stella.NIL), Stella.NIL))));
          ...
          if (testValue000 == Stella.SYM_STELLA_NOT) {
            ...
            { Cons cursor = tree000.rest;
              ...
              while (!(cursor == Stella.NIL)) {
                cursor.value = Stella_Object.clTranslateBooleanTest(cursor.value, Stella.FALSE);
                cursor = cursor.rest;
              }
            }
        ...
        { GeneralizedSymbol testValue000 = ((GeneralizedSymbol)(tree000.value));
          ...
          if (testValue000 == Stella.SYM_STELLA_VOID_SYS) {
            ...
            { Object old$NeedexplicitreturnP$000 = Stella.$NEEDEXPLICITRETURNp$.get();
              ...
              try {
                Native.setBooleanSpecial(Stella.$NEEDEXPLICITRETURNp$, Stella.TRUE);
            ...
            return (Cons.clTranslateLetTree(tree000, Stella.FALSE));
          }
          else if (testValue000 == Stella.SYM_STELLA_STARTUP_TIME_PROGN) {
...
;
      ...
      { Surrogate testValue000 = Stella_Object.safePrimaryType(casetest);
        ...
        if (testValue000 == Stella.SGT_STELLA_CONS) {
          { Cons casetest000 = ((Cons)(casetest));
            ...
            { ConsIterator it = casetest000.allocateIterator();
              ...
              while (it.nextP()) {
                ...
                it.valueSetter(Stella.wrapInteger(symbol.symbolId));
          ...
          { Symbol casetest000 = ((Symbol)(casetest));
            ...
            return (Stella.wrapInteger(symbol.symbolId));
          }
        }
        else {
          { OutputStringStream stream000 = OutputStringStream.newOutputStringStream();
  ...
  public static Stella_Object coerceMvTree(Stella_Object tree, Symbol operator, List sourcetypes, List targettypes, Object [] MV_returnarray) {
    { boolean valuestreeP = Stella_Object.valuesTreeP(tree);
      ...
      boolean needtemporariesP = Stella.FALSE;
      ...
      { int i = Stella.NULL_INTEGER;
        ...
        while ((!(iter001 == Stella.NIL)) &&
          ...
          { Object [] caller_MV_returnarray = new Object[2];
            ...
            otree = Stella_Object.helpCoerceATree(it.value, srcts, tgtts, Stella.FALSE, caller_MV_returnarray);
            ...
            { Object old$PrintreadablyP$000 = Stella.$PRINTREADABLYp$.get();
              ...
              try {
                ...
                if (!(Stella.suppressWarningsP())) {
                  ...
                  {
                    Stella.STANDARD_ERROR.nativeStream.println();
                    Stella.STANDARD_ERROR.nativeStream.println(" Type clash on argument `" + Stella_Object.deUglifyParseTree(Stella.wrapInteger(i)) + "' of `" + Stella_Object.deUglifyParseTree(operator) + "' operator.");
  ...
  public static StandardObject safeYieldTypeSpecifier(Stella_Object typetree) {
    if (typetree != null) {
      { StandardObject typespec = typetree.yieldTypeSpecifier();
        ...
        StandardObject.validateTypeSpecifier(typespec, null, Stella.TRUE);
        return (typespec);
      }
    }
    else {
          ...
          { Object old$PrintreadablyP$000 = Stella.$PRINTREADABLYp$.get();
            ...
            try {
              ...
              if (!(Stella.suppressWarningsP())) {
                ...
                {
                  System.out.println();
                  System.out.println(" Expression found where statement expected: `" + Stella_Object.deUglifyParseTree(tree) + "'.");
                }
;
              }
...
;
  ...
  public static boolean coercibleP(Stella_Object tree, StandardObject sourcetype, StandardObject targettype) {
    { Stella_Object otree = null;
      StandardObject otype = null;
      boolean coercibleP = Stella.FALSE;

      { Object [] caller_MV_returnarray = new Object[2];

        otree = Stella_Object.helpCoerceATree(tree, sourcetype, targettype, Stella.TRUE, caller_MV_returnarray);
        otype = ((StandardObject)(caller_MV_returnarray[0]));
  ...
  public static Stella_Object helpCoerceATree(Stella_Object tree, StandardObject sourcetype, StandardObject targettype, boolean testonlyP, Object [] MV_returnarray) {
    { Stella_Object coersionfunction = null;
      ...
      if (sourcetype == Stella.SGT_STELLA_UNKNOWN) {
        ...
        if ((tree == Stella.SYM_STELLA_NULL) &&
            (targetbasetype != null)) {
          { Stella_Object _return_temp = Surrogate.typeToWalkedNullValueTree(targetbasetype);

            MV_returnarray[0] = targettype;
            MV_returnarray[1] = Stella.wrapBoolean(Stella.TRUE);
            return (_return_temp);
          }
        }
        else {
...
;
      ...
      { Stella_Object _return_temp = tree;
        ...
        MV_returnarray[0] = sourcetype;
        MV_returnarray[1] = Stella.wrapBoolean(Stella.FALSE);
        return (_return_temp);
      }
    }
  }
  ...
  public static Stella_Object coerceATree(Stella_Object tree, StandardObject sourcetype, StandardObject targettype, Object [] MV_returnarray) {
    { Stella_Object otree = null;
      ...
      { Object [] caller_MV_returnarray = new Object[2];
        ...
        otree = Stella_Object.helpCoerceATree(tree, sourcetype, targettype, Stella.FALSE, caller_MV_returnarray);
        otype = ((StandardObject)(caller_MV_returnarray[0]));
        coercibleP = ((boolean)(((BooleanWrapper)(caller_MV_returnarray[1])).wrapperValue));
      }
      if (!(coercibleP)) {
    ...
    { Surrogate testValue000 = Stella_Object.safePrimaryType(coercionmethod);
      ...
      if (Surrogate.subtypeOfSymbolP(testValue000)) {
        { Symbol coercionmethod000 = ((Symbol)(coercionmethod));
          ...
          return (Stella_Object.walkExpressionTree(Stella_Object.cons(coercionmethod000, Stella_Object.cons(expression, Stella.NIL)), targettype, coercionmethod000, Stella.FALSE, MV_returnarray));
        }
      }
      else if (testValue000 == Stella.SGT_STELLA_CONS) {
        { Cons coercionmethod000 = ((Cons)(coercionmethod));

          return (Stella_Object.walkExpressionTree(Stella_Object.copyConsTree(Stella_Object.substituteConsTree(((Cons)(Stella_Object.copyConsTree(coercionmethod000))), expression, Stella.SYM_STELLA_lXg)), targettype, ((Symbol)(coercionmethod000.value)), Stella.FALSE, MV_returnarray));
        }
      }
      else {
        { OutputStringStream stream000 = OutputStringStream.newOutputStringStream();
    ...
    { boolean toplevelinvocationP = ((List)(Stella.$TRANSLATIONUNITS$.get())) == null;
      ...
      { Object old$Translationunits$000 = Stella.$TRANSLATIONUNITS$.get();
        ...
        try {
          ...
          if (declarationP) {
            Native.setSpecial(Stella.$TRANSLATIONPHASE$, Stella.KWD_DEFINE);
            Cons.walkTopLevelTree(((Cons)(tree)), Stella.FALSE);
            if (Stella.translationErrorsP()) {
            ...
            { Object old$UsehardcodedsymbolsP$000 = Stella.$USEHARDCODEDSYMBOLSp$.get();
              ...
              try {
                Native.setBooleanSpecial(Stella.$USEHARDCODEDSYMBOLSp$, Stella.TRUE);
...
;
    ...
    { Symbol vectorvar = Stella.localGensym("VECTOR");
      ...
      { Cons _return_temp = Stella.list$(Stella_Object.cons(Stella_Object.cons(vectorvar, Stella_Object.cons(collectiontype, Stella_Object.cons(collectiontree, Stella.NIL))), Stella_Object.cons(Stella_Object.cons(indexvar, Stella.list$(Stella_Object.cons(Stella.SGT_STELLA_INTEGER, Stella_Object.cons(Stella.wrapInteger(0), Stella_Object.cons(Stella.NIL, Stella.NIL))))), Stella_Object.cons(Stella_Object.cons(lengthvar, Stella.list$(Stella_Object.cons(Stella.SGT_STELLA_INTEGER, Stella_Object.cons(Stella.list$(Stella_Object.cons(Stella.SYM_STELLA_LENGTH, Stella_Object.cons(vectorvar, Stella_Object.cons(Stella.NIL, Stella.NIL)))), Stella_Object.cons(Stella.NIL, Stella.NIL))))), Stella_Object.cons(Stella.NIL, Stella.NIL)))));

        MV_returnarray[0] = Stella_Object.cons(Stella_Object.cons(valuevar, Stella_Object.cons((((collectiontype == Stella.SGT_STELLA_STRING) ||
            (collectiontype == Stella.SGT_STELLA_MUTABLE_STRING)) ? Stella.SGT_STELLA_CHARACTER : ((StandardObject)(StandardObject.extractParameterType(collectiontype, Stella.SYM_STELLA_ANY_VALUE, new Object[1])))), Stella_Object.cons(Stella.list$(Stella_Object.cons(Stella.SYM_STELLA_PROGN, Stella_Object.cons(Stella.list$(Stella_Object.cons(Stella.SYM_STELLA_SETQ, Stella_Object.cons(valuevar, Stella_Object.cons(Stella_Object.cons(Stella.list$(Stella_Object.cons(Stella.SYM_STELLA_NTH, Stella_Object.cons(vectorvar, Stella_Object.cons(Stella_Object.cons(indexvar, Stella.NIL), Stella.NIL)))), Stella.NIL), Stella.NIL)))), Stella_Object.cons(Stella.list$(Stella_Object.cons(Stella.SYM_STELLA_ii, Stella_Object.cons(indexvar, Stella_Object.cons(Stella.NIL, Stella.NIL)))), Stella_Object.cons(Stella.NIL, Stella.NIL))))), Stella.NIL))), Stella.NIL);
        MV_returnarray[1] = Stella.list$(Stella_Object.cons(Stella.SYM_STELLA_l, Stella_Object.cons(indexvar, Stella_Object.cons(Stella_Object.cons(lengthvar, Stella.NIL), Stella.NIL))));
        return (_return_temp);
      }
    }
  }
  ...
  public static Cons yieldInCursorClausesForGeneralCollection(Stella_Object collectiontree, StandardObject collectiontype, Symbol keyvar, Symbol valuevar, Object [] MV_returnarray) {
    { Surrogate collectionbasetype = StandardObject.typeSpecToBaseType(collectiontype);
      ...
      valueclauses = Stella_Object.cons(Stella_Object.cons(valuevar, Stella_Object.cons(StandardObject.extractParameterType(collectiontype, Stella.SYM_STELLA_ANY_VALUE, new Object[1]), Stella_Object.cons(Cons.optimizeProgn(Stella.list$(Stella_Object.cons(Stella.SYM_STELLA_PROGN, Stella_Object.cons(Stella.list$(Stella_Object.cons(Stella.SYM_STELLA_SETQ, Stella_Object.cons(valuevar, Stella_Object.cons(Stella_Object.cons(valuetree, Stella.NIL), Stella.NIL)))), Stella_Object.cons(bumptrees.concatenate(Stella.NIL, Stella.NIL), Stella.NIL))))), Stella.NIL))), valueclauses);
      if (keyvar != null) {
        { StandardObject keytype = null;
          boolean parameterexistsP = Stella.FALSE;
          ...
          if (parameterexistsP) {
            valueclauses = Stella_Object.cons(Stella_Object.cons(keyvar, Stella_Object.cons(keytype, Stella_Object.cons(Stella.list$(Stella_Object.cons(Stella.SYM_STELLA_SETQ, Stella_Object.cons(keyvar, Stella_Object.cons(Stella_Object.cons(keytree, Stella.NIL), Stella.NIL)))), Stella.NIL))), valueclauses);
          }
          else {
            { Object old$PrintreadablyP$000 = Stella.$PRINTREADABLYp$.get();
...
;
  ...
  public static Stella_Object walkCollectionTree(Stella_Object tree, boolean dontoptimizeP, Object [] MV_returnarray) {
    ...
    return (Stella_Object.walkExpressionTree(tree, Stella.SGT_STELLA_UNKNOWN, Stella.SYM_STELLA_FOREACH, Stella.FALSE, MV_returnarray));
  }
...
;
      ...
      if (Surrogate.subtypeOfStringP(testValue000)) {
        { StringWrapper thing000 = ((StringWrapper)(thing));
          ...
          if (Stella.stringEqualP(thing000.wrapperValue, "local")) {
            return (Stella.wrapFloat(Stella.NULL_FLOAT));
          }
        ...
        { IntegerWrapper thing000 = ((IntegerWrapper)(thing));
          ...
          { int offset = thing000.wrapperValue;
            ...
            if ((-12 <= offset) &&
                (offset <= 14)) {
              return (Stella.wrapFloat(((double)(offset))));
            }
            else if ((-1200 <= offset) &&
                (offset <= 1400)) {
              return (Stella.wrapFloat((offset / 100) + ((offset % 100) / 60.0)));
            }
            else {
              return (null);
            }
        ...
        { StringWrapper thing000 = ((StringWrapper)(thing));
          ...
          { int monthNumber = ((StringToIntegerHashTable)(Stella.$MONTH_STRINGS$.get())).lookup(thing000.wrapperValue);
            ...
            if (monthNumber != Stella.NULL_INTEGER) {
              return (Stella.wrapInteger(monthNumber));
            }
            else {
              return (null);
            }
  ...
  public static void printUndefinedSuperClasses(Stella_Object renamed_Class) {
    { Surrogate type = Stella_Object.typify(Stella_Object.coerceToSymbol(renamed_Class));
      ...
      if (type == null) {
        System.out.println("Illegal class name: " + renamed_Class);
        return;
      }
      Surrogate.collectBadSuperClasses(type, badones);
      if (badones.memberP(type)) {
        if (type.surrogateValue == null) {
          System.out.println(type + " is itself undefined.");
        }
        else {
          System.out.println(type + " itself points to non-class " + type.surrogateValue);
        }
        return;
      }
      { boolean foundP000 = Stella.FALSE;
        ...
        if (foundP000) {
          System.out.println("The following (indirect) super(s) of " + type + " are undefined:");
          { Surrogate renamed_Super = null;
            ...
            while (!(iter001 == Stella.NIL)) {
              ...
              if (renamed_Super.surrogateValue == null) {
                System.out.println("    " + renamed_Super);
              }
            }
          }
        }
      ...
      { boolean foundP001 = Stella.FALSE;
        ...
        if (foundP001) {
          System.out.println("The following (indirect) super(s) of " + type + " point to non-classes:");
          { Surrogate renamed_Super = null;
            ...
            while (!(iter003 == Stella.NIL)) {
              ...
              if (renamed_Super.surrogateValue != null) {
                System.out.println("    " + renamed_Super + " points to " + renamed_Super.surrogateValue);
              }
            }
          }
        }
...
;
        ...
        if (((Boolean)(Stella.$WARNIFREDEFINEp$.get())).booleanValue()) {
          System.out.println("Redefining the `" + self.primaryType().symbolName + "' named `" + name + "'");
        }
        surrogate.surrogateValue = self;
    ...
    { Surrogate testValue000 = Stella_Object.safePrimaryType(tree);
      ...
      if (testValue000 == Stella.SGT_STELLA_CONS) {
        ...
        { Keyword tree000 = ((Keyword)(tree));
          ...
          if (Stella.useHardcodedSymbolsP()) {
            return (Stella.consList(Stella_Object.cons(Stella.SYM_STELLA_GET_KWD, Stella_Object.cons(Stella.wrapInteger(tree000.symbolId), Stella.NIL))));
          }
          else {
        ...
        { Surrogate tree000 = ((Surrogate)(tree));
          ...
          if (Stella.useHardcodedSymbolsP()) {
            return (Stella.consList(Stella_Object.cons(Stella.SYM_STELLA_GET_SGT, Stella_Object.cons(Stella.wrapInteger(tree000.symbolId), Stella.NIL))));
          }
          else {
            return (Stella.consList(Stella_Object.cons(Stella.SYM_STELLA_TYPED_SYS, Stella_Object.cons(GeneralizedSymbol.registerSymbol(tree000), Stella_Object.cons(Stella.SGT_STELLA_SYMBOL, Stella.NIL)))));
          }
        ...
        { Symbol tree000 = ((Symbol)(tree));
          ...
          if (Symbol.symbolCommonLispP(tree000)) {
            return (Stella.consList(Stella_Object.cons(Stella.SYM_STELLA_INTERN_COMMON_LISP_SYMBOL, Stella_Object.cons(Stella.wrapString(tree000.symbolName), Stella.NIL))));
          }
          else {
            if (Stella.useHardcodedSymbolsP()) {
              return (Stella.consList(Stella_Object.cons(Stella.SYM_STELLA_GET_SYM, Stella_Object.cons(Stella.wrapInteger(((Symbol)(tree000.permanentify())).symbolId), Stella.NIL))));
            }
            else {
              return (Stella.consList(Stella_Object.cons(Stella.SYM_STELLA_TYPED_SYS, Stella_Object.cons(GeneralizedSymbol.registerSymbol(tree000), Stella_Object.cons(Stella.SGT_STELLA_SYMBOL, Stella.NIL)))));
            }
...
;
  ...
  public Surrogate surrogatify() {
    { Stella_Object self = this;
      ...
      throw ((StellaException)(StellaException.newStellaException("OBJECT passed to 'surrogatify'").fillInStackTrace()));
    }
  }
