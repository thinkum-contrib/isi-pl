...
public class IntegerHashTable extends AbstractHashTable {
  ...
  public void removeAt(int key) {
    { IntegerHashTable self = this;
      ...
      if (Stella.$USE_STELLA_HASH_TABLESp$) {
        StellaHashTable.stellaHashTableRemoveAt(self.theStellaHashTable, Stella.wrapInteger(key));
        return;
      }
  ...
  public void insertAt(int key, Stella_Object value) {
    { IntegerHashTable self = this;
      ...
      if (Stella.$USE_STELLA_HASH_TABLESp$) {
        StellaHashTable.stellaHashTableInsertAt(self.theStellaHashTable, Stella.wrapInteger(key), value);
        return;
      }
      { java.util.HashMap nativeTable = self.theHashTable;
  ...
  public Stella_Object lookup(int key) {
    { IntegerHashTable self = this;
      ...
      if (Stella.$USE_STELLA_HASH_TABLESp$) {
        return (StellaHashTable.stellaHashTableLookup(self.theStellaHashTable, Stella.wrapInteger(key)));
      }
      { java.util.HashMap nativeTable = self.theHashTable;
