...
public class _StartupIdlTranslate {
  public static void startupIdlTranslate() {
    if (Stella.currentStartupTimePhaseP(1)) {
      Stella.defineModuleFromStringifiedSource("/IDL-THEORY", "(:CASE-SENSITIVE? TRUE :USES () :LISP-PACKAGE \"IDL\")");
      Stella.defineModuleFromStringifiedSource("/IDL-THEORY/IDL-USER-THEORY", "(:CASE-SENSITIVE? TRUE :USES () :LISP-PACKAGE \"IDL-USER\")");
    }
      ...
      try {
        ...
        if (Stella.currentStartupTimePhaseP(7)) {
          ...
          { MethodSlot function = Symbol.lookupFunction(Stella.SYM_STELLA_STARTUP_IDL_TRANSLATE);
            ...
            KeyValueList.setDynamicSlotValue(function.dynamicSlots, Stella.SYM_STELLA_METHOD_STARTUP_CLASSNAME, Stella.wrapString("_Startup-Idl-Translate"), Stella.NULL_STRING_WRAPPER);
          }
        }
