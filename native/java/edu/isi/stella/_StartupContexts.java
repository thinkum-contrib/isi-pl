    ...
    { Object old$Module$000 = Stella.$MODULE$.get();
      ...
      try {
        ...
        if (Stella.currentStartupTimePhaseP(4)) {
          Stella.$UNLINK_DISCARDED_CONTEXTS_ON_READp$ = Stella.TRUE;
          Stella.$UNLINK_DISCARDED_CONTEXTS_ON_WRITEp$ = Stella.TRUE;
          Stella.$CONTEXT_BACKTRACKING_MODE$ = Stella.FALSE;
        }
        ...
        if (Stella.currentStartupTimePhaseP(7)) {
          ...
          { MethodSlot function = Symbol.lookupFunction(Stella.SYM_STELLA_STARTUP_CONTEXTS);
            ...
            KeyValueList.setDynamicSlotValue(function.dynamicSlots, Stella.SYM_STELLA_METHOD_STARTUP_CLASSNAME, Stella.wrapString("_Startup-Contexts"), Stella.NULL_STRING_WRAPPER);
          }
        }
