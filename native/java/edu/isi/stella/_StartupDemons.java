  ...
  static void helpStartupDemons1() {
    {
      ...
      Stella.KWD_CREATE = ((Keyword)(Stella.internRigidSymbolWrtModule("CREATE", null, 2)));
      ...
      try {
        ...
        if (Stella.currentStartupTimePhaseP(7)) {
          ...
          { MethodSlot function = Symbol.lookupFunction(Stella.SYM_STELLA_STARTUP_DEMONS);
            ...
            KeyValueList.setDynamicSlotValue(function.dynamicSlots, Stella.SYM_STELLA_METHOD_STARTUP_CLASSNAME, Stella.wrapString("_Startup-Demons"), Stella.NULL_STRING_WRAPPER);
          }
        }
