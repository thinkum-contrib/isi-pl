  ...
  public static Stella_Object accessTaxonomyNodeSlotValue(TaxonomyNode self, Symbol slotname, Stella_Object value, boolean setvalueP) {
    if (slotname == Stella.SYM_STELLA_NATIVE_OBJECT) {
      ...
      if (setvalueP) {
        ...
        value = Stella.wrapInteger(self.label);
      }
    }
      ...
      if (setvalueP) {
        ...
        value = Stella.wrapInteger(self.firstIntervalLowerBound);
      }
    }
      ...
      if (setvalueP) {
        ...
        value = Stella.wrapInteger(self.firstIntervalUpperBound);
      }
    }
      ...
      if (setvalueP) {
        ...
        value = Stella.wrapInteger(self.totalAncestors);
      }
    }
