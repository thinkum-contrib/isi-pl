  ...
  static void helpStartupHierarchy8() {
    {
      ...
      { Stella_Class renamed_Class = Stella.defineClassFromStringifiedSource("NO-SUCH-FILE-EXCEPTION", "(DEFCLASS NO-SUCH-FILE-EXCEPTION (INPUT-OUTPUT-EXCEPTION) :PUBLIC? TRUE)");
