...
public class _StartupHierarchy {
  static void helpStartupHierarchy1() {
    {
      Stella.SYM_STELLA_TYPE_SPEC = ((Symbol)(Stella.internRigidSymbolWrtModule("TYPE-SPEC", null, 0)));
      Stella.SYM_STELLA_REFERENCE_COUNT = ((Symbol)(Stella.internRigidSymbolWrtModule("REFERENCE-COUNT", null, 0)));
      Stella.SYM_STELLA_BADp = ((Symbol)(Stella.internRigidSymbolWrtModule("BAD?", null, 0)));
      Stella.SYM_STELLA_DELETED_OBJECTp = ((Symbol)(Stella.internRigidSymbolWrtModule("DELETED-OBJECT?", null, 0)));
      Stella.SYM_STELLA_FIRST_ITERATIONp = ((Symbol)(Stella.internRigidSymbolWrtModule("FIRST-ITERATION?", null, 0)));
      Stella.SYM_STELLA_OBJECT_ITERATOR = ((Symbol)(Stella.internRigidSymbolWrtModule("OBJECT-ITERATOR", null, 0)));
      Stella.SGT_STELLA_CONS_ITERATOR = ((Surrogate)(Stella.internRigidSymbolWrtModule("CONS-ITERATOR", null, 1)));
      Stella.SYM_STELLA_CONS_ITERATOR_CURSOR = ((Symbol)(Stella.internRigidSymbolWrtModule("CONS-ITERATOR-CURSOR", null, 0)));
      Stella.SGT_STELLA_LIST_ITERATOR = ((Surrogate)(Stella.internRigidSymbolWrtModule("LIST-ITERATOR", null, 1)));
      Stella.SYM_STELLA_LIST_ITERATOR_CURSOR = ((Symbol)(Stella.internRigidSymbolWrtModule("LIST-ITERATOR-CURSOR", null, 0)));
      Stella.SYM_STELLA_LIST_ITERATOR_COLLECTION = ((Symbol)(Stella.internRigidSymbolWrtModule("LIST-ITERATOR-COLLECTION", null, 0)));
      Stella.SGT_STELLA_DESTRUCTIVE_LIST_ITERATOR = ((Surrogate)(Stella.internRigidSymbolWrtModule("DESTRUCTIVE-LIST-ITERATOR", null, 1)));
      Stella.SYM_STELLA_THE_CONS_LIST = ((Symbol)(Stella.internRigidSymbolWrtModule("THE-CONS-LIST", null, 0)));
      Stella.SGT_STELLA_ALL_PURPOSE_ITERATOR = ((Surrogate)(Stella.internRigidSymbolWrtModule("ALL-PURPOSE-ITERATOR", null, 1)));
      Stella.SYM_STELLA_KEY = ((Symbol)(Stella.internRigidSymbolWrtModule("KEY", null, 0)));
      Stella.SYM_STELLA_ITERATOR_NEXT_CODE = ((Symbol)(Stella.internRigidSymbolWrtModule("ITERATOR-NEXT-CODE", null, 0)));
      Stella.SYM_STELLA_ITERATOR_FILTER_CODE = ((Symbol)(Stella.internRigidSymbolWrtModule("ITERATOR-FILTER-CODE", null, 0)));
      Stella.SYM_STELLA_ITERATOR_EMPTY_CODE = ((Symbol)(Stella.internRigidSymbolWrtModule("ITERATOR-EMPTY-CODE", null, 0)));
      Stella.SYM_STELLA_ITERATOR_NESTED_ITERATOR = ((Symbol)(Stella.internRigidSymbolWrtModule("ITERATOR-NESTED-ITERATOR", null, 0)));
      Stella.SYM_STELLA_ITERATOR_CONS_LIST = ((Symbol)(Stella.internRigidSymbolWrtModule("ITERATOR-CONS-LIST", null, 0)));
      Stella.SYM_STELLA_ITERATOR_OBJECT = ((Symbol)(Stella.internRigidSymbolWrtModule("ITERATOR-OBJECT", null, 0)));
      Stella.SYM_STELLA_ITERATOR_SECOND_OBJECT = ((Symbol)(Stella.internRigidSymbolWrtModule("ITERATOR-SECOND-OBJECT", null, 0)));
      Stella.SYM_STELLA_ITERATOR_INTEGER = ((Symbol)(Stella.internRigidSymbolWrtModule("ITERATOR-INTEGER", null, 0)));
      Stella.SYM_STELLA_ITERATOR_SECOND_INTEGER = ((Symbol)(Stella.internRigidSymbolWrtModule("ITERATOR-SECOND-INTEGER", null, 0)));
      Stella.SGT_STELLA_TYPES_TO_CLASSES_ITERATOR = ((Surrogate)(Stella.internRigidSymbolWrtModule("TYPES-TO-CLASSES-ITERATOR", null, 1)));
      Stella.SYM_STELLA_ITERATOR_CURSOR = ((Symbol)(Stella.internRigidSymbolWrtModule("ITERATOR-CURSOR", null, 0)));
      Stella.SYM_STELLA_OBJECT_DICTIONARY_ITERATOR = ((Symbol)(Stella.internRigidSymbolWrtModule("OBJECT-DICTIONARY-ITERATOR", null, 0)));
      Stella.SGT_STELLA_PROPERTY_LIST_ITERATOR = ((Surrogate)(Stella.internRigidSymbolWrtModule("PROPERTY-LIST-ITERATOR", null, 1)));
      Stella.SYM_STELLA_PLIST_ITERATOR_CURSOR = ((Symbol)(Stella.internRigidSymbolWrtModule("PLIST-ITERATOR-CURSOR", null, 0)));
      Stella.SYM_STELLA_PLIST_ITERATOR_COLLECTION = ((Symbol)(Stella.internRigidSymbolWrtModule("PLIST-ITERATOR-COLLECTION", null, 0)));
      Stella.SGT_STELLA_KV_LIST_ITERATOR = ((Surrogate)(Stella.internRigidSymbolWrtModule("KV-LIST-ITERATOR", null, 1)));
      Stella.SYM_STELLA_THE_KV_LIST = ((Symbol)(Stella.internRigidSymbolWrtModule("THE-KV-LIST", null, 0)));
      Stella.SYM_STELLA_KV_LIST_ITERATOR_CURSOR = ((Symbol)(Stella.internRigidSymbolWrtModule("KV-LIST-ITERATOR-CURSOR", null, 0)));
      Stella.SGT_STELLA_INTEGER_INTERVAL_ITERATOR = ((Surrogate)(Stella.internRigidSymbolWrtModule("INTEGER-INTERVAL-ITERATOR", null, 1)));
      Stella.SYM_STELLA_INTERVAL_CURSOR = ((Symbol)(Stella.internRigidSymbolWrtModule("INTERVAL-CURSOR", null, 0)));
      Stella.SYM_STELLA_LOWER_BOUND = ((Symbol)(Stella.internRigidSymbolWrtModule("LOWER-BOUND", null, 0)));
      Stella.SYM_STELLA_UPPER_BOUND = ((Symbol)(Stella.internRigidSymbolWrtModule("UPPER-BOUND", null, 0)));
      Stella.SGT_STELLA_REVERSE_INTEGER_INTERVAL_ITERATOR = ((Surrogate)(Stella.internRigidSymbolWrtModule("REVERSE-INTEGER-INTERVAL-ITERATOR", null, 1)));
      Stella.SGT_STELLA_STRING_ITERATOR = ((Surrogate)(Stella.internRigidSymbolWrtModule("STRING-ITERATOR", null, 1)));
      Stella.SYM_STELLA_THE_STRING = ((Symbol)(Stella.internRigidSymbolWrtModule("THE-STRING", null, 0)));
      Stella.SYM_STELLA_CURSOR = ((Symbol)(Stella.internRigidSymbolWrtModule("CURSOR", null, 0)));
      Stella.SYM_STELLA_END = ((Symbol)(Stella.internRigidSymbolWrtModule("END", null, 0)));
      Stella.SYM_STELLA_OBJECT_COLLECTION = ((Symbol)(Stella.internRigidSymbolWrtModule("OBJECT-COLLECTION", null, 0)));
      Stella.SYM_STELLA_OBJECT_SEQUENCE = ((Symbol)(Stella.internRigidSymbolWrtModule("OBJECT-SEQUENCE", null, 0)));
      Stella.SGT_STELLA_LIST = ((Surrogate)(Stella.internRigidSymbolWrtModule("LIST", null, 1)));
      Stella.SGT_STELLA_SET = ((Surrogate)(Stella.internRigidSymbolWrtModule("SET", null, 1)));
      Stella.SGT_STELLA_CLASS_EXTENSION = ((Surrogate)(Stella.internRigidSymbolWrtModule("CLASS-EXTENSION", null, 1)));
      Stella.SGT_STELLA_CONS = ((Surrogate)(Stella.internRigidSymbolWrtModule("CONS", null, 1)));
      Stella.SYM_STELLA_VALUE = ((Symbol)(Stella.internRigidSymbolWrtModule("VALUE", null, 0)));
      Stella.SYM_STELLA_REST = ((Symbol)(Stella.internRigidSymbolWrtModule("REST", null, 0)));
      Stella.SYM_STELLA_OBJECT_TO_OBJECT_DICTIONARY = ((Symbol)(Stella.internRigidSymbolWrtModule("OBJECT-TO-OBJECT-DICTIONARY", null, 0)));
      Stella.SGT_STELLA_PROPERTY_LIST = ((Surrogate)(Stella.internRigidSymbolWrtModule("PROPERTY-LIST", null, 1)));
      Stella.SYM_STELLA_THE_PLIST = ((Symbol)(Stella.internRigidSymbolWrtModule("THE-PLIST", null, 0)));
      Stella.SGT_STELLA_KV_CONS = ((Surrogate)(Stella.internRigidSymbolWrtModule("KV-CONS", null, 1)));
      Stella.SGT_STELLA_KEY_VALUE_LIST = ((Surrogate)(Stella.internRigidSymbolWrtModule("KEY-VALUE-LIST", null, 1)));
      Stella.SGT_STELLA_RECYCLE_LIST = ((Surrogate)(Stella.internRigidSymbolWrtModule("RECYCLE-LIST", null, 1)));
      Stella.SYM_STELLA_RECYCLE_LIST_OF = ((Symbol)(Stella.internRigidSymbolWrtModule("RECYCLE-LIST-OF", null, 0)));
      Stella.SYM_STELLA_RECYCLED_ITEMS = ((Symbol)(Stella.internRigidSymbolWrtModule("RECYCLED-ITEMS", null, 0)));
      Stella.SYM_STELLA_LIST_OF_RECYCLED_ITEMS = ((Symbol)(Stella.internRigidSymbolWrtModule("LIST-OF-RECYCLED-ITEMS", null, 0)));
      Stella.SYM_STELLA_ALL_ITEMS = ((Symbol)(Stella.internRigidSymbolWrtModule("ALL-ITEMS", null, 0)));
    }
  }

  static void helpStartupHierarchy2() {
    {
      Stella.SYM_STELLA_UNUSED_ITEMS = ((Symbol)(Stella.internRigidSymbolWrtModule("UNUSED-ITEMS", null, 0)));
      Stella.SYM_STELLA_CURRENT_LENGTH = ((Symbol)(Stella.internRigidSymbolWrtModule("CURRENT-LENGTH", null, 0)));
      Stella.SYM_STELLA_ITEM_SIZE = ((Symbol)(Stella.internRigidSymbolWrtModule("ITEM-SIZE", null, 0)));
      Stella.SYM_STELLA_THE_STELLA_HASH_TABLE = ((Symbol)(Stella.internRigidSymbolWrtModule("THE-STELLA-HASH-TABLE", null, 0)));
      Stella.SGT_STELLA_HASH_TABLE = ((Surrogate)(Stella.internRigidSymbolWrtModule("HASH-TABLE", null, 1)));
      Stella.SYM_STELLA_OBJECT_TO_OBJECT_HASH_TABLE = ((Symbol)(Stella.internRigidSymbolWrtModule("OBJECT-TO-OBJECT-HASH-TABLE", null, 0)));
      Stella.SGT_STELLA_INTEGER_HASH_TABLE = ((Surrogate)(Stella.internRigidSymbolWrtModule("INTEGER-HASH-TABLE", null, 1)));
      Stella.SGT_STELLA_FLOAT_HASH_TABLE = ((Surrogate)(Stella.internRigidSymbolWrtModule("FLOAT-HASH-TABLE", null, 1)));
      Stella.SGT_STELLA_STRING_HASH_TABLE = ((Surrogate)(Stella.internRigidSymbolWrtModule("STRING-HASH-TABLE", null, 1)));
      Stella.SGT_STELLA_STRING_TO_INTEGER_HASH_TABLE = ((Surrogate)(Stella.internRigidSymbolWrtModule("STRING-TO-INTEGER-HASH-TABLE", null, 1)));
      Stella.SGT_STELLA_VECTOR = ((Surrogate)(Stella.internRigidSymbolWrtModule("VECTOR", null, 1)));
      Stella.SYM_STELLA_ARRAY_SIZE = ((Symbol)(Stella.internRigidSymbolWrtModule("ARRAY-SIZE", null, 0)));
      Stella.SGT_STELLA_EXTENSIBLE_VECTOR = ((Surrogate)(Stella.internRigidSymbolWrtModule("EXTENSIBLE-VECTOR", null, 1)));
      Stella.SGT_STELLA_EXTENSIBLE_SYMBOL_ARRAY = ((Surrogate)(Stella.internRigidSymbolWrtModule("EXTENSIBLE-SYMBOL-ARRAY", null, 1)));
      Stella.SYM_STELLA_TOP_SYMBOL_OFFSET = ((Symbol)(Stella.internRigidSymbolWrtModule("TOP-SYMBOL-OFFSET", null, 0)));
      Stella.SYM_STELLA_POTENTIAL_FREE_SYMBOL_OFFSET = ((Symbol)(Stella.internRigidSymbolWrtModule("POTENTIAL-FREE-SYMBOL-OFFSET", null, 0)));
      Stella.SYM_STELLA_RESIZE_INCREMENT = ((Symbol)(Stella.internRigidSymbolWrtModule("RESIZE-INCREMENT", null, 0)));
      Stella.SYM_STELLA_SEQUENCE_LENGTH = ((Symbol)(Stella.internRigidSymbolWrtModule("SEQUENCE-LENGTH", null, 0)));
      Stella.SYM_STELLA_VSEQ = ((Symbol)(Stella.internRigidSymbolWrtModule("VSEQ", null, 0)));
      Stella.SGT_STELLA_SHORT_VECTOR_SEQUENCE = ((Surrogate)(Stella.internRigidSymbolWrtModule("SHORT-VECTOR-SEQUENCE", null, 1)));
      Stella.SYM_STELLA_SVSEQ = ((Symbol)(Stella.internRigidSymbolWrtModule("SVSEQ", null, 0)));
      Stella.SGT_STELLA_BOOLEAN_VECTOR = ((Surrogate)(Stella.internRigidSymbolWrtModule("BOOLEAN-VECTOR", null, 1)));
      Stella.SGT_STELLA_INTEGER_VECTOR = ((Surrogate)(Stella.internRigidSymbolWrtModule("INTEGER-VECTOR", null, 1)));
      Stella.SGT_STELLA_ACTIVE_LIST = ((Surrogate)(Stella.internRigidSymbolWrtModule("ACTIVE-LIST", null, 1)));
      Stella.SGT_STELLA_ACTIVE_SET = ((Surrogate)(Stella.internRigidSymbolWrtModule("ACTIVE-SET", null, 1)));
      Stella.SGT_STELLA_DEMON = ((Surrogate)(Stella.internRigidSymbolWrtModule("DEMON", null, 1)));
      Stella.SYM_STELLA_DEMON_NAME = ((Symbol)(Stella.internRigidSymbolWrtModule("DEMON-NAME", null, 0)));
      Stella.SYM_STELLA_DEMON_ACTION = ((Symbol)(Stella.internRigidSymbolWrtModule("DEMON-ACTION", null, 0)));
      Stella.SYM_STELLA_DEMON_CLASS_REFS = ((Symbol)(Stella.internRigidSymbolWrtModule("DEMON-CLASS-REFS", null, 0)));
      Stella.SYM_STELLA_DEMON_SLOT_REFS = ((Symbol)(Stella.internRigidSymbolWrtModule("DEMON-SLOT-REFS", null, 0)));
      Stella.SYM_STELLA_DEMON_CODE = ((Symbol)(Stella.internRigidSymbolWrtModule("DEMON-CODE", null, 0)));
      Stella.SYM_STELLA_DEMON_METHOD = ((Symbol)(Stella.internRigidSymbolWrtModule("DEMON-METHOD", null, 0)));
      Stella.SYM_STELLA_DEMON_DOCUMENTATION = ((Symbol)(Stella.internRigidSymbolWrtModule("DEMON-DOCUMENTATION", null, 0)));
      Stella.SYM_STELLA_DEMON_GUARDp = ((Symbol)(Stella.internRigidSymbolWrtModule("DEMON-GUARD?", null, 0)));
      Stella.SYM_STELLA_DEMON_ALLp = ((Symbol)(Stella.internRigidSymbolWrtModule("DEMON-ALL?", null, 0)));
      Stella.SYM_STELLA_DEMON_INHERITp = ((Symbol)(Stella.internRigidSymbolWrtModule("DEMON-INHERIT?", null, 0)));
      Stella.SGT_STELLA_KEYWORD_KEY_VALUE_LIST = ((Surrogate)(Stella.internRigidSymbolWrtModule("KEYWORD-KEY-VALUE-LIST", null, 1)));
      Stella.SYM_STELLA_SYMBOL_NAME = ((Symbol)(Stella.internRigidSymbolWrtModule("SYMBOL-NAME", null, 0)));
      Stella.SYM_STELLA_SYMBOL_ID = ((Symbol)(Stella.internRigidSymbolWrtModule("SYMBOL-ID", null, 0)));
      Stella.SYM_STELLA_INTERNED_IN = ((Symbol)(Stella.internRigidSymbolWrtModule("INTERNED-IN", null, 0)));
      Stella.SGT_STELLA_SYMBOL = ((Surrogate)(Stella.internRigidSymbolWrtModule("SYMBOL", null, 1)));
      Stella.SYM_STELLA_SYMBOL_SLOT_OFFSET = ((Symbol)(Stella.internRigidSymbolWrtModule("SYMBOL-SLOT-OFFSET", null, 0)));
      Stella.SYM_STELLA_SYMBOL_VALUE_AND_PLIST = ((Symbol)(Stella.internRigidSymbolWrtModule("SYMBOL-VALUE-AND-PLIST", null, 0)));
      Stella.SGT_STELLA_SURROGATE = ((Surrogate)(Stella.internRigidSymbolWrtModule("SURROGATE", null, 1)));
      Stella.SYM_STELLA_SURROGATE_VALUE = ((Symbol)(Stella.internRigidSymbolWrtModule("SURROGATE-VALUE", null, 0)));
      Stella.SYM_STELLA_SURROGATE_NAME = ((Symbol)(Stella.internRigidSymbolWrtModule("SURROGATE-NAME", null, 0)));
      Stella.SYM_STELLA_TYPE_CLASS = ((Symbol)(Stella.internRigidSymbolWrtModule("TYPE-CLASS", null, 0)));
      Stella.SYM_STELLA_TYPE_NAME = ((Symbol)(Stella.internRigidSymbolWrtModule("TYPE-NAME", null, 0)));
      Stella.SYM_STELLA_SLOTREF_SLOT = ((Symbol)(Stella.internRigidSymbolWrtModule("SLOTREF-SLOT", null, 0)));
      Stella.SYM_STELLA_TYPE = ((Symbol)(Stella.internRigidSymbolWrtModule("TYPE", null, 0)));
      Stella.SYM_STELLA_SLOTREF = ((Symbol)(Stella.internRigidSymbolWrtModule("SLOTREF", null, 0)));
      Stella.SGT_STELLA_KEYWORD = ((Surrogate)(Stella.internRigidSymbolWrtModule("KEYWORD", null, 1)));
      Stella.SYM_STELLA_KEYWORD_NAME = ((Symbol)(Stella.internRigidSymbolWrtModule("KEYWORD-NAME", null, 0)));
      Stella.SGT_STELLA_TRANSIENT_SYMBOL = ((Surrogate)(Stella.internRigidSymbolWrtModule("TRANSIENT-SYMBOL", null, 1)));
      Stella.SYM_STELLA_PROJECTS_ONTO = ((Symbol)(Stella.internRigidSymbolWrtModule("PROJECTS-ONTO", null, 0)));
      Stella.SYM_STELLA_PROJECTED_FROM = ((Symbol)(Stella.internRigidSymbolWrtModule("PROJECTED-FROM", null, 0)));
      Stella.SYM_STELLA_PROPERTIES = ((Symbol)(Stella.internRigidSymbolWrtModule("PROPERTIES", null, 0)));
      Stella.SYM_STELLA_ABSTRACTp = ((Symbol)(Stella.internRigidSymbolWrtModule("ABSTRACT?", null, 0)));
      Stella.SGT_STELLA_CLASS = ((Surrogate)(Stella.internRigidSymbolWrtModule("CLASS", null, 1)));
      Stella.SYM_STELLA_STORED_ACTIVEp = ((Symbol)(Stella.internRigidSymbolWrtModule("STORED-ACTIVE?", null, 0)));
    }
  }

  static void helpStartupHierarchy3() {
    {
      Stella.SGT_STELLA_ACTIVE_OBJECT = ((Surrogate)(Stella.internRigidSymbolWrtModule("ACTIVE-OBJECT", null, 1)));
      Stella.SYM_STELLA_CLASS_CREATOR = ((Symbol)(Stella.internRigidSymbolWrtModule("CLASS-CREATOR", null, 0)));
      Stella.SYM_STELLA_CLASS_INITIALIZER = ((Symbol)(Stella.internRigidSymbolWrtModule("CLASS-INITIALIZER", null, 0)));
      Stella.SYM_STELLA_CLASS_TERMINATOR = ((Symbol)(Stella.internRigidSymbolWrtModule("CLASS-TERMINATOR", null, 0)));
      Stella.SYM_STELLA_CLASS_DESTRUCTOR = ((Symbol)(Stella.internRigidSymbolWrtModule("CLASS-DESTRUCTOR", null, 0)));
      Stella.SYM_STELLA_CLASS_PARAMETERS = ((Symbol)(Stella.internRigidSymbolWrtModule("CLASS-PARAMETERS", null, 0)));
      Stella.SYM_STELLA_CLASS_INITIAL_VALUE = ((Symbol)(Stella.internRigidSymbolWrtModule("CLASS-INITIAL-VALUE", null, 0)));
      Stella.SYM_STELLA_CLASS_EXTENSION = ((Symbol)(Stella.internRigidSymbolWrtModule("CLASS-EXTENSION", null, 0)));
      Stella.SYM_STELLA_CLASS_CL_NATIVE_TYPE = ((Symbol)(Stella.internRigidSymbolWrtModule("CLASS-CL-NATIVE-TYPE", null, 0)));
      Stella.SYM_STELLA_CLASS_CPP_NATIVE_TYPE = ((Symbol)(Stella.internRigidSymbolWrtModule("CLASS-CPP-NATIVE-TYPE", null, 0)));
      Stella.SYM_STELLA_CLASS_JAVA_NATIVE_TYPE = ((Symbol)(Stella.internRigidSymbolWrtModule("CLASS-JAVA-NATIVE-TYPE", null, 0)));
      Stella.SYM_STELLA_CLASS_CL_STRUCT_SLOTS = ((Symbol)(Stella.internRigidSymbolWrtModule("CLASS-CL-STRUCT-SLOTS", null, 0)));
      Stella.SYM_STELLA_CLASS_RECYCLE_METHOD = ((Symbol)(Stella.internRigidSymbolWrtModule("CLASS-RECYCLE-METHOD", null, 0)));
      Stella.KWD_NONE = ((Keyword)(Stella.internRigidSymbolWrtModule("NONE", null, 2)));
      Stella.SYM_STELLA_CLASS_REQUIRED_SLOT_NAMES = ((Symbol)(Stella.internRigidSymbolWrtModule("CLASS-REQUIRED-SLOT-NAMES", null, 0)));
      Stella.SYM_STELLA_CLASS_GUARD_CONSTRUCTOR_DEMONS = ((Symbol)(Stella.internRigidSymbolWrtModule("CLASS-GUARD-CONSTRUCTOR-DEMONS", null, 0)));
      Stella.SYM_STELLA_CLASS_CONSTRUCTOR_DEMONS = ((Symbol)(Stella.internRigidSymbolWrtModule("CLASS-CONSTRUCTOR-DEMONS", null, 0)));
      Stella.SYM_STELLA_CLASS_GUARD_DESTRUCTOR_DEMONS = ((Symbol)(Stella.internRigidSymbolWrtModule("CLASS-GUARD-DESTRUCTOR-DEMONS", null, 0)));
      Stella.SYM_STELLA_CLASS_DESTRUCTOR_DEMONS = ((Symbol)(Stella.internRigidSymbolWrtModule("CLASS-DESTRUCTOR-DEMONS", null, 0)));
      Stella.SYM_STELLA_CLASS_KEY = ((Symbol)(Stella.internRigidSymbolWrtModule("CLASS-KEY", null, 0)));
      Stella.SYM_STELLA_CLASS_SYNONYMS = ((Symbol)(Stella.internRigidSymbolWrtModule("CLASS-SYNONYMS", null, 0)));
      Stella.SYM_STELLA_CL_STRUCTp = ((Symbol)(Stella.internRigidSymbolWrtModule("CL-STRUCT?", null, 0)));
      Stella.SYM_STELLA_MIXINp = ((Symbol)(Stella.internRigidSymbolWrtModule("MIXIN?", null, 0)));
      Stella.SYM_STELLA_CLASS_TYPE = ((Symbol)(Stella.internRigidSymbolWrtModule("CLASS-TYPE", null, 0)));
      Stella.SYM_STELLA_CLASS_ARITY = ((Symbol)(Stella.internRigidSymbolWrtModule("CLASS-ARITY", null, 0)));
      Stella.SYM_STELLA_CLASS_DIRECT_SUPERS = ((Symbol)(Stella.internRigidSymbolWrtModule("CLASS-DIRECT-SUPERS", null, 0)));
      Stella.SYM_STELLA_CLASS_DIRECT_SUBS = ((Symbol)(Stella.internRigidSymbolWrtModule("CLASS-DIRECT-SUBS", null, 0)));
      Stella.SYM_STELLA_CLASS_ALL_SUPER_CLASSES = ((Symbol)(Stella.internRigidSymbolWrtModule("CLASS-ALL-SUPER-CLASSES", null, 0)));
      Stella.SYM_STELLA_CLASS_ALL_SLOTS = ((Symbol)(Stella.internRigidSymbolWrtModule("CLASS-ALL-SLOTS", null, 0)));
      Stella.SYM_STELLA_CLASS_LOCAL_SLOTS = ((Symbol)(Stella.internRigidSymbolWrtModule("CLASS-LOCAL-SLOTS", null, 0)));
      Stella.SYM_STELLA_CLASS_SLOT_AND_METHOD_CACHE = ((Symbol)(Stella.internRigidSymbolWrtModule("CLASS-SLOT-AND-METHOD-CACHE", null, 0)));
      Stella.SYM_STELLA_CLASS_ABSTRACTp = ((Symbol)(Stella.internRigidSymbolWrtModule("CLASS-ABSTRACT?", null, 0)));
      Stella.SYM_STELLA_CLASS_MIXINp = ((Symbol)(Stella.internRigidSymbolWrtModule("CLASS-MIXIN?", null, 0)));
      Stella.SYM_STELLA_CLASS_COLLECTIONp = ((Symbol)(Stella.internRigidSymbolWrtModule("CLASS-COLLECTION?", null, 0)));
      Stella.SYM_STELLA_CLASS_CL_STRUCTp = ((Symbol)(Stella.internRigidSymbolWrtModule("CLASS-CL-STRUCT?", null, 0)));
      Stella.SYM_STELLA_CLASS_PUBLICp = ((Symbol)(Stella.internRigidSymbolWrtModule("CLASS-PUBLIC?", null, 0)));
      Stella.SYM_STELLA_CLASS_FINALIZEDp = ((Symbol)(Stella.internRigidSymbolWrtModule("CLASS-FINALIZED?", null, 0)));
      Stella.SYM_STELLA_CLASS_SLOTS_FINALIZEDp = ((Symbol)(Stella.internRigidSymbolWrtModule("CLASS-SLOTS-FINALIZED?", null, 0)));
      Stella.SYM_STELLA_CLASS_STRINGIFIED_SOURCE = ((Symbol)(Stella.internRigidSymbolWrtModule("CLASS-STRINGIFIED-SOURCE", null, 0)));
      Stella.SYM_STELLA_CLASS_CONSTRUCTOR_CODE = ((Symbol)(Stella.internRigidSymbolWrtModule("CLASS-CONSTRUCTOR-CODE", null, 0)));
      Stella.SYM_STELLA_CLASS_SLOT_ACCESSOR_CODE = ((Symbol)(Stella.internRigidSymbolWrtModule("CLASS-SLOT-ACCESSOR-CODE", null, 0)));
      Stella.SYM_STELLA_CLASS_MARKEDp = ((Symbol)(Stella.internRigidSymbolWrtModule("CLASS-MARKED?", null, 0)));
      Stella.SYM_STELLA_CLASS_TAXONOMY_NODE = ((Symbol)(Stella.internRigidSymbolWrtModule("CLASS-TAXONOMY-NODE", null, 0)));
      Stella.SYM_STELLA_CLASS_DOCUMENTATION = ((Symbol)(Stella.internRigidSymbolWrtModule("CLASS-DOCUMENTATION", null, 0)));
      Stella.SYM_STELLA_CLASS_PRINT_FORM = ((Symbol)(Stella.internRigidSymbolWrtModule("CLASS-PRINT-FORM", null, 0)));
      Stella.SYM_STELLA_DOCUMENTATION = ((Symbol)(Stella.internRigidSymbolWrtModule("DOCUMENTATION", null, 0)));
      Stella.SYM_STELLA_PRINT_FORM = ((Symbol)(Stella.internRigidSymbolWrtModule("PRINT-FORM", null, 0)));
      Stella.SYM_STELLA_SLOT_DIRECT_EQUIVALENT = ((Symbol)(Stella.internRigidSymbolWrtModule("SLOT-DIRECT-EQUIVALENT", null, 0)));
      Stella.SYM_STELLA_SLOT_TYPE_SPECIFIER = ((Symbol)(Stella.internRigidSymbolWrtModule("SLOT-TYPE-SPECIFIER", null, 0)));
      Stella.SYM_STELLA_SLOT_HOME_MODULE = ((Symbol)(Stella.internRigidSymbolWrtModule("SLOT-HOME-MODULE", null, 0)));
      Stella.SYM_STELLA_SLOT_RENAMES = ((Symbol)(Stella.internRigidSymbolWrtModule("SLOT-RENAMES", null, 0)));
      Stella.SGT_STELLA_COLLECTION = ((Surrogate)(Stella.internRigidSymbolWrtModule("COLLECTION", null, 1)));
      Stella.SYM_STELLA_SLOT_CLOSURE_ASSUMPTION = ((Symbol)(Stella.internRigidSymbolWrtModule("SLOT-CLOSURE-ASSUMPTION", null, 0)));
      Stella.SYM_STELLA_SLOT_DIRECT_SUPERS = ((Symbol)(Stella.internRigidSymbolWrtModule("SLOT-DIRECT-SUPERS", null, 0)));
      Stella.SYM_STELLA_SLOT_DIRECT_SUBS = ((Symbol)(Stella.internRigidSymbolWrtModule("SLOT-DIRECT-SUBS", null, 0)));
      Stella.SYM_STELLA_SLOT_NAME = ((Symbol)(Stella.internRigidSymbolWrtModule("SLOT-NAME", null, 0)));
      Stella.SYM_STELLA_SLOT_OWNER = ((Symbol)(Stella.internRigidSymbolWrtModule("SLOT-OWNER", null, 0)));
      Stella.SYM_STELLA_SLOT_BASE_TYPE = ((Symbol)(Stella.internRigidSymbolWrtModule("SLOT-BASE-TYPE", null, 0)));
      Stella.SYM_STELLA_SLOT_SLOTREF = ((Symbol)(Stella.internRigidSymbolWrtModule("SLOT-SLOTREF", null, 0)));
      Stella.SYM_STELLA_SLOT_PUBLICp = ((Symbol)(Stella.internRigidSymbolWrtModule("SLOT-PUBLIC?", null, 0)));
    }
  }

  static void helpStartupHierarchy4() {
    {
      Stella.SYM_STELLA_SLOT_RENAMEDp = ((Symbol)(Stella.internRigidSymbolWrtModule("SLOT-RENAMED?", null, 0)));
      Stella.SYM_STELLA_SLOT_EXTERNALp = ((Symbol)(Stella.internRigidSymbolWrtModule("SLOT-EXTERNAL?", null, 0)));
      Stella.SYM_STELLA_SLOT_MARKEDp = ((Symbol)(Stella.internRigidSymbolWrtModule("SLOT-MARKED?", null, 0)));
      Stella.SYM_STELLA_SLOT_DOCUMENTATION = ((Symbol)(Stella.internRigidSymbolWrtModule("SLOT-DOCUMENTATION", null, 0)));
      Stella.SGT_STELLA_STORAGE_SLOT = ((Surrogate)(Stella.internRigidSymbolWrtModule("STORAGE-SLOT", null, 1)));
      Stella.SYM_STELLA_SLOT_ALLOCATION = ((Symbol)(Stella.internRigidSymbolWrtModule("SLOT-ALLOCATION", null, 0)));
      Stella.KWD_INSTANCE = ((Keyword)(Stella.internRigidSymbolWrtModule("INSTANCE", null, 2)));
      Stella.SYM_STELLA_SLOT_DEFAULT_EXPRESSION = ((Symbol)(Stella.internRigidSymbolWrtModule("SLOT-DEFAULT-EXPRESSION", null, 0)));
      Stella.SYM_STELLA_SLOT_READER = ((Symbol)(Stella.internRigidSymbolWrtModule("SLOT-READER", null, 0)));
      Stella.SYM_STELLA_SLOT_WRITER = ((Symbol)(Stella.internRigidSymbolWrtModule("SLOT-WRITER", null, 0)));
      Stella.SYM_STELLA_SLOT_GUARD_DEMONS = ((Symbol)(Stella.internRigidSymbolWrtModule("SLOT-GUARD-DEMONS", null, 0)));
      Stella.SYM_STELLA_SLOT_DEMONS = ((Symbol)(Stella.internRigidSymbolWrtModule("SLOT-DEMONS", null, 0)));
      Stella.SYM_STELLA_SLOT_REQUIREDp = ((Symbol)(Stella.internRigidSymbolWrtModule("SLOT-REQUIRED?", null, 0)));
      Stella.SYM_STELLA_SLOT_COMPONENTp = ((Symbol)(Stella.internRigidSymbolWrtModule("SLOT-COMPONENT?", null, 0)));
      Stella.SYM_STELLA_SLOT_READ_ONLYp = ((Symbol)(Stella.internRigidSymbolWrtModule("SLOT-READ-ONLY?", null, 0)));
      Stella.SYM_STELLA_SLOT_HARDWIREDp = ((Symbol)(Stella.internRigidSymbolWrtModule("SLOT-HARDWIRED?", null, 0)));
      Stella.SYM_STELLA_SLOT_CONTEXT_SENSITIVEp = ((Symbol)(Stella.internRigidSymbolWrtModule("SLOT-CONTEXT-SENSITIVE?", null, 0)));
      Stella.SGT_STELLA_METHOD_SLOT = ((Surrogate)(Stella.internRigidSymbolWrtModule("METHOD-SLOT", null, 1)));
      Stella.SYM_STELLA_METHOD_PARAMETER_DIRECTIONS = ((Symbol)(Stella.internRigidSymbolWrtModule("METHOD-PARAMETER-DIRECTIONS", null, 0)));
      Stella.SYM_STELLA_METHOD_INLINED_FUNCTIONS = ((Symbol)(Stella.internRigidSymbolWrtModule("METHOD-INLINED-FUNCTIONS", null, 0)));
      Stella.SYM_STELLA_METHOD_EVALUATE_ARGUMENTSp = ((Symbol)(Stella.internRigidSymbolWrtModule("METHOD-EVALUATE-ARGUMENTS?", null, 0)));
      Stella.SYM_STELLA_METHOD_SETTERp = ((Symbol)(Stella.internRigidSymbolWrtModule("METHOD-SETTER?", null, 0)));
      Stella.SYM_STELLA_METHOD_PARAMETER_NAMES = ((Symbol)(Stella.internRigidSymbolWrtModule("METHOD-PARAMETER-NAMES", null, 0)));
      Stella.SYM_STELLA_METHOD_PARAMETER_TYPE_SPECIFIERS = ((Symbol)(Stella.internRigidSymbolWrtModule("METHOD-PARAMETER-TYPE-SPECIFIERS", null, 0)));
      Stella.SYM_STELLA_METHOD_RETURN_TYPE_SPECIFIERS = ((Symbol)(Stella.internRigidSymbolWrtModule("METHOD-RETURN-TYPE-SPECIFIERS", null, 0)));
      Stella.SYM_STELLA_METHOD_STRINGIFIED_SOURCE = ((Symbol)(Stella.internRigidSymbolWrtModule("METHOD-STRINGIFIED-SOURCE", null, 0)));
      Stella.SYM_STELLA_METHOD_CODE = ((Symbol)(Stella.internRigidSymbolWrtModule("METHOD-CODE", null, 0)));
      Stella.SYM_STELLA_FUNCTION_CODE = ((Symbol)(Stella.internRigidSymbolWrtModule("FUNCTION-CODE", null, 0)));
      Stella.SYM_STELLA_METHOD_FUNCTIONp = ((Symbol)(Stella.internRigidSymbolWrtModule("METHOD-FUNCTION?", null, 0)));
      Stella.SYM_STELLA_METHOD_DOCUMENTATION = ((Symbol)(Stella.internRigidSymbolWrtModule("METHOD-DOCUMENTATION", null, 0)));
      Stella.SYM_STELLA_METHOD_AUXILIARYp = ((Symbol)(Stella.internRigidSymbolWrtModule("METHOD-AUXILIARY?", null, 0)));
      Stella.SYM_STELLA_METHOD_STORAGE_SLOT = ((Symbol)(Stella.internRigidSymbolWrtModule("METHOD-STORAGE-SLOT", null, 0)));
      Stella.SYM_STELLA_SLOT_AUXILIARYp = ((Symbol)(Stella.internRigidSymbolWrtModule("SLOT-AUXILIARY?", null, 0)));
      Stella.SYM_STELLA_STORAGE_SLOT = ((Symbol)(Stella.internRigidSymbolWrtModule("STORAGE-SLOT", null, 0)));
      Stella.SYM_STELLA_FUNCTION = ((Symbol)(Stella.internRigidSymbolWrtModule("FUNCTION", null, 0)));
      Stella.SGT_STELLA_PARAMETRIC_TYPE_SPECIFIER = ((Surrogate)(Stella.internRigidSymbolWrtModule("PARAMETRIC-TYPE-SPECIFIER", null, 1)));
      Stella.SYM_STELLA_SPECIFIER_BASE_TYPE = ((Symbol)(Stella.internRigidSymbolWrtModule("SPECIFIER-BASE-TYPE", null, 0)));
      Stella.SYM_STELLA_SPECIFIER_PARAMETER_TYPES = ((Symbol)(Stella.internRigidSymbolWrtModule("SPECIFIER-PARAMETER-TYPES", null, 0)));
      Stella.SYM_STELLA_SPECIFIER_DIMENSIONS = ((Symbol)(Stella.internRigidSymbolWrtModule("SPECIFIER-DIMENSIONS", null, 0)));
      Stella.SGT_STELLA_ANCHORED_TYPE_SPECIFIER = ((Surrogate)(Stella.internRigidSymbolWrtModule("ANCHORED-TYPE-SPECIFIER", null, 1)));
      Stella.SYM_STELLA_SPECIFIER_PARAMETER_NAME = ((Symbol)(Stella.internRigidSymbolWrtModule("SPECIFIER-PARAMETER-NAME", null, 0)));
      Stella.SGT_STELLA_TABLE = ((Surrogate)(Stella.internRigidSymbolWrtModule("TABLE", null, 1)));
      Stella.SYM_STELLA_TUPLE_DOMAINS = ((Symbol)(Stella.internRigidSymbolWrtModule("TUPLE-DOMAINS", null, 0)));
      Stella.SGT_STELLA_GLOBAL_VARIABLE = ((Surrogate)(Stella.internRigidSymbolWrtModule("GLOBAL-VARIABLE", null, 1)));
      Stella.SYM_STELLA_VARIABLE_HOME_MODULE = ((Symbol)(Stella.internRigidSymbolWrtModule("VARIABLE-HOME-MODULE", null, 0)));
      Stella.SYM_STELLA_VARIABLE_NAME = ((Symbol)(Stella.internRigidSymbolWrtModule("VARIABLE-NAME", null, 0)));
      Stella.SYM_STELLA_VARIABLE_TYPE = ((Symbol)(Stella.internRigidSymbolWrtModule("VARIABLE-TYPE", null, 0)));
      Stella.SYM_STELLA_VARIABLE_SPECIALp = ((Symbol)(Stella.internRigidSymbolWrtModule("VARIABLE-SPECIAL?", null, 0)));
      Stella.SYM_STELLA_VARIABLE_CONSTANTp = ((Symbol)(Stella.internRigidSymbolWrtModule("VARIABLE-CONSTANT?", null, 0)));
      Stella.SYM_STELLA_VARIABLE_PUBLICp = ((Symbol)(Stella.internRigidSymbolWrtModule("VARIABLE-PUBLIC?", null, 0)));
      Stella.SYM_STELLA_VARIABLE_AUXILIARYp = ((Symbol)(Stella.internRigidSymbolWrtModule("VARIABLE-AUXILIARY?", null, 0)));
      Stella.SYM_STELLA_VARIABLE_GET_VALUE_CODE = ((Symbol)(Stella.internRigidSymbolWrtModule("VARIABLE-GET-VALUE-CODE", null, 0)));
      Stella.SYM_STELLA_VARIABLE_SET_VALUE_CODE = ((Symbol)(Stella.internRigidSymbolWrtModule("VARIABLE-SET-VALUE-CODE", null, 0)));
      Stella.SYM_STELLA_VARIABLE_VALUE_STACK = ((Symbol)(Stella.internRigidSymbolWrtModule("VARIABLE-VALUE-STACK", null, 0)));
      Stella.SYM_STELLA_VARIABLE_DOCUMENTATION = ((Symbol)(Stella.internRigidSymbolWrtModule("VARIABLE-DOCUMENTATION", null, 0)));
      Stella.SYM_STELLA_VARIABLE_STRINGIFIED_SOURCE = ((Symbol)(Stella.internRigidSymbolWrtModule("VARIABLE-STRINGIFIED-SOURCE", null, 0)));
      Stella.SGT_STELLA_QUOTED_EXPRESSION = ((Surrogate)(Stella.internRigidSymbolWrtModule("QUOTED-EXPRESSION", null, 1)));
      Stella.SYM_STELLA_QUOTATION_TABLE_OFFSET = ((Symbol)(Stella.internRigidSymbolWrtModule("QUOTATION-TABLE-OFFSET", null, 0)));
      Stella.SYM_STELLA_SURROGATE_VALUE_INVERSE = ((Symbol)(Stella.internRigidSymbolWrtModule("SURROGATE-VALUE-INVERSE", null, 0)));
      Stella.SGT_STELLA_MODULE = ((Surrogate)(Stella.internRigidSymbolWrtModule("MODULE", null, 1)));
    }
  }

  static void helpStartupHierarchy5() {
    {
      Stella.SGT_STELLA_WORLD = ((Surrogate)(Stella.internRigidSymbolWrtModule("WORLD", null, 1)));
      Stella.SYM_STELLA_WORLD_NAME = ((Symbol)(Stella.internRigidSymbolWrtModule("WORLD-NAME", null, 0)));
      Stella.SYM_STELLA_CHILD_CONTEXTS = ((Symbol)(Stella.internRigidSymbolWrtModule("CHILD-CONTEXTS", null, 0)));
      Stella.SYM_STELLA_BASE_MODULE = ((Symbol)(Stella.internRigidSymbolWrtModule("BASE-MODULE", null, 0)));
      Stella.SYM_STELLA_ALL_SUPER_CONTEXTS = ((Symbol)(Stella.internRigidSymbolWrtModule("ALL-SUPER-CONTEXTS", null, 0)));
      Stella.SYM_STELLA_CONTEXT_NUMBER = ((Symbol)(Stella.internRigidSymbolWrtModule("CONTEXT-NUMBER", null, 0)));
      Stella.SYM_STELLA_MODULE_LISP_PACKAGE = ((Symbol)(Stella.internRigidSymbolWrtModule("MODULE-LISP-PACKAGE", null, 0)));
      Stella.SYM_STELLA_MODULE_CPP_PACKAGE = ((Symbol)(Stella.internRigidSymbolWrtModule("MODULE-CPP-PACKAGE", null, 0)));
      Stella.SYM_STELLA_SHADOWED_SURROGATES = ((Symbol)(Stella.internRigidSymbolWrtModule("SHADOWED-SURROGATES", null, 0)));
      Stella.SYM_STELLA_JAVA_PACKAGE = ((Symbol)(Stella.internRigidSymbolWrtModule("JAVA-PACKAGE", null, 0)));
      Stella.SYM_STELLA_CLEARABLEp = ((Symbol)(Stella.internRigidSymbolWrtModule("CLEARABLE?", null, 0)));
      Stella.SYM_STELLA_PROTECT_SURROGATESp = ((Symbol)(Stella.internRigidSymbolWrtModule("PROTECT-SURROGATES?", null, 0)));
      Stella.SYM_STELLA_PARENT_MODULES = ((Symbol)(Stella.internRigidSymbolWrtModule("PARENT-MODULES", null, 0)));
      Stella.SYM_STELLA_NICKNAMES = ((Symbol)(Stella.internRigidSymbolWrtModule("NICKNAMES", null, 0)));
      Stella.SYM_STELLA_USES = ((Symbol)(Stella.internRigidSymbolWrtModule("USES", null, 0)));
      Stella.SYM_STELLA_USED_BY = ((Symbol)(Stella.internRigidSymbolWrtModule("USED-BY", null, 0)));
      Stella.SYM_STELLA_REQUIRES = ((Symbol)(Stella.internRigidSymbolWrtModule("REQUIRES", null, 0)));
      Stella.SYM_STELLA_CASE_SENSITIVEp = ((Symbol)(Stella.internRigidSymbolWrtModule("CASE-SENSITIVE?", null, 0)));
      Stella.SYM_STELLA_MODULE_FULL_NAME = ((Symbol)(Stella.internRigidSymbolWrtModule("MODULE-FULL-NAME", null, 0)));
      Stella.SYM_STELLA_MODULE_NAME = ((Symbol)(Stella.internRigidSymbolWrtModule("MODULE-NAME", null, 0)));
      Stella.SYM_STELLA_MODULE_STRINGIFIED_SOURCE = ((Symbol)(Stella.internRigidSymbolWrtModule("MODULE-STRINGIFIED-SOURCE", null, 0)));
      Stella.SYM_STELLA_STRINGIFIED_OPTIONS = ((Symbol)(Stella.internRigidSymbolWrtModule("STRINGIFIED-OPTIONS", null, 0)));
      Stella.SYM_STELLA_CARDINAL_MODULE = ((Symbol)(Stella.internRigidSymbolWrtModule("CARDINAL-MODULE", null, 0)));
      Stella.SYM_STELLA_SYMBOL_OFFSET_TABLE = ((Symbol)(Stella.internRigidSymbolWrtModule("SYMBOL-OFFSET-TABLE", null, 0)));
      Stella.SYM_STELLA_SURROGATE_OFFSET_TABLE = ((Symbol)(Stella.internRigidSymbolWrtModule("SURROGATE-OFFSET-TABLE", null, 0)));
      Stella.SYM_STELLA_STRICT_INFERENCE_CACHE = ((Symbol)(Stella.internRigidSymbolWrtModule("STRICT-INFERENCE-CACHE", null, 0)));
      Stella.SYM_STELLA_DEFAULT_INFERENCE_CACHE = ((Symbol)(Stella.internRigidSymbolWrtModule("DEFAULT-INFERENCE-CACHE", null, 0)));
      Stella.SYM_STELLA_PROTOTYPE_INFERENCE_CACHE = ((Symbol)(Stella.internRigidSymbolWrtModule("PROTOTYPE-INFERENCE-CACHE", null, 0)));
      Stella.SYM_STELLA_PARENT_CONTEXT = ((Symbol)(Stella.internRigidSymbolWrtModule("PARENT-CONTEXT", null, 0)));
      Stella.SGT_STELLA_CS_VALUE = ((Surrogate)(Stella.internRigidSymbolWrtModule("CS-VALUE", null, 1)));
      Stella.SGT_STELLA_INTERVAL = ((Surrogate)(Stella.internRigidSymbolWrtModule("INTERVAL", null, 1)));
      Stella.SGT_STELLA_TAXONOMY_NODE = ((Surrogate)(Stella.internRigidSymbolWrtModule("TAXONOMY-NODE", null, 1)));
      Stella.SYM_STELLA_NATIVE_OBJECT = ((Symbol)(Stella.internRigidSymbolWrtModule("NATIVE-OBJECT", null, 0)));
      Stella.SYM_STELLA_LABEL = ((Symbol)(Stella.internRigidSymbolWrtModule("LABEL", null, 0)));
      Stella.SYM_STELLA_INTERVALS = ((Symbol)(Stella.internRigidSymbolWrtModule("INTERVALS", null, 0)));
      Stella.SYM_STELLA_INITIAL_INTERVAL = ((Symbol)(Stella.internRigidSymbolWrtModule("INITIAL-INTERVAL", null, 0)));
      Stella.SYM_STELLA_FIRST_INTERVAL_LOWER_BOUND = ((Symbol)(Stella.internRigidSymbolWrtModule("FIRST-INTERVAL-LOWER-BOUND", null, 0)));
      Stella.SYM_STELLA_FIRST_INTERVAL_UPPER_BOUND = ((Symbol)(Stella.internRigidSymbolWrtModule("FIRST-INTERVAL-UPPER-BOUND", null, 0)));
      Stella.SYM_STELLA_PARENTS = ((Symbol)(Stella.internRigidSymbolWrtModule("PARENTS", null, 0)));
      Stella.SYM_STELLA_CHILDREN = ((Symbol)(Stella.internRigidSymbolWrtModule("CHILDREN", null, 0)));
      Stella.SYM_STELLA_TOTAL_ANCESTORS = ((Symbol)(Stella.internRigidSymbolWrtModule("TOTAL-ANCESTORS", null, 0)));
      Stella.SYM_STELLA_TREE_CHILDREN = ((Symbol)(Stella.internRigidSymbolWrtModule("TREE-CHILDREN", null, 0)));
      Stella.SYM_STELLA_MARKER = ((Symbol)(Stella.internRigidSymbolWrtModule("MARKER", null, 0)));
      Stella.SGT_STELLA_TAXONOMY_GRAPH = ((Surrogate)(Stella.internRigidSymbolWrtModule("TAXONOMY-GRAPH", null, 1)));
      Stella.SYM_STELLA_RENUMBER_IF_OUT_OF_NUMBERSp = ((Symbol)(Stella.internRigidSymbolWrtModule("RENUMBER-IF-OUT-OF-NUMBERS?", null, 0)));
      Stella.SYM_STELLA_RENUMBER_RATIO = ((Symbol)(Stella.internRigidSymbolWrtModule("RENUMBER-RATIO", null, 0)));
      Stella.SYM_STELLA_INCREMENTAL_MODEp = ((Symbol)(Stella.internRigidSymbolWrtModule("INCREMENTAL-MODE?", null, 0)));
      Stella.SYM_STELLA_LARGEST_POSTORDER_NUMBER = ((Symbol)(Stella.internRigidSymbolWrtModule("LARGEST-POSTORDER-NUMBER", null, 0)));
      Stella.SYM_STELLA_NUMBER_OF_NODES = ((Symbol)(Stella.internRigidSymbolWrtModule("NUMBER-OF-NODES", null, 0)));
      Stella.SYM_STELLA_NUMBER_OF_FOREIGN_INTERVAL_NODES = ((Symbol)(Stella.internRigidSymbolWrtModule("NUMBER-OF-FOREIGN-INTERVAL-NODES", null, 0)));
      Stella.SYM_STELLA_ROOTS = ((Symbol)(Stella.internRigidSymbolWrtModule("ROOTS", null, 0)));
      Stella.SYM_STELLA_BROKEN_LINKS = ((Symbol)(Stella.internRigidSymbolWrtModule("BROKEN-LINKS", null, 0)));
      Stella.SYM_STELLA_ADDED_LINKS = ((Symbol)(Stella.internRigidSymbolWrtModule("ADDED-LINKS", null, 0)));
      Stella.SYM_STELLA_REMOVED_LINKS = ((Symbol)(Stella.internRigidSymbolWrtModule("REMOVED-LINKS", null, 0)));
      Stella.SYM_STELLA_FILE_NAME = ((Symbol)(Stella.internRigidSymbolWrtModule("FILE-NAME", null, 0)));
      Stella.SGT_STELLA_INTEGER_WRAPPER = ((Surrogate)(Stella.internRigidSymbolWrtModule("INTEGER-WRAPPER", null, 1)));
      Stella.SYM_STELLA_WRAPPER_VALUE = ((Symbol)(Stella.internRigidSymbolWrtModule("WRAPPER-VALUE", null, 0)));
      Stella.SGT_STELLA_FLOAT_WRAPPER = ((Surrogate)(Stella.internRigidSymbolWrtModule("FLOAT-WRAPPER", null, 1)));
      Stella.SGT_STELLA_STRING_WRAPPER = ((Surrogate)(Stella.internRigidSymbolWrtModule("STRING-WRAPPER", null, 1)));
      Stella.SGT_STELLA_MUTABLE_STRING_WRAPPER = ((Surrogate)(Stella.internRigidSymbolWrtModule("MUTABLE-STRING-WRAPPER", null, 1)));
    }
  }

  static void helpStartupHierarchy6() {
    {
      Stella.SGT_STELLA_CHARACTER_WRAPPER = ((Surrogate)(Stella.internRigidSymbolWrtModule("CHARACTER-WRAPPER", null, 1)));
      Stella.SGT_STELLA_BOOLEAN_WRAPPER = ((Surrogate)(Stella.internRigidSymbolWrtModule("BOOLEAN-WRAPPER", null, 1)));
      Stella.SYM_STELLA_TRUE = ((Symbol)(Stella.internRigidSymbolWrtModule("TRUE", null, 0)));
      Stella.SYM_STELLA_FALSE = ((Symbol)(Stella.internRigidSymbolWrtModule("FALSE", null, 0)));
      Stella.SGT_STELLA_FUNCTION_CODE_WRAPPER = ((Surrogate)(Stella.internRigidSymbolWrtModule("FUNCTION-CODE-WRAPPER", null, 1)));
      Stella.SGT_STELLA_METHOD_CODE_WRAPPER = ((Surrogate)(Stella.internRigidSymbolWrtModule("METHOD-CODE-WRAPPER", null, 1)));
      Stella.SGT_STELLA_VERBATIM_STRING_WRAPPER = ((Surrogate)(Stella.internRigidSymbolWrtModule("VERBATIM-STRING-WRAPPER", null, 1)));
      Stella.SYM_STELLA_THREE_VALUED_BOOLEAN = ((Symbol)(Stella.internRigidSymbolWrtModule("THREE-VALUED-BOOLEAN", null, 0)));
      Stella.SGT_STELLA_SYSTEM_DEFINITION = ((Surrogate)(Stella.internRigidSymbolWrtModule("SYSTEM-DEFINITION", null, 1)));
      Stella.SYM_STELLA_NAME = ((Symbol)(Stella.internRigidSymbolWrtModule("NAME", null, 0)));
      Stella.SYM_STELLA_DIRECTORY = ((Symbol)(Stella.internRigidSymbolWrtModule("DIRECTORY", null, 0)));
      Stella.SYM_STELLA_FILES = ((Symbol)(Stella.internRigidSymbolWrtModule("FILES", null, 0)));
      Stella.SYM_STELLA_LISP_ONLY_FILES = ((Symbol)(Stella.internRigidSymbolWrtModule("LISP-ONLY-FILES", null, 0)));
      Stella.SYM_STELLA_CPP_ONLY_FILES = ((Symbol)(Stella.internRigidSymbolWrtModule("CPP-ONLY-FILES", null, 0)));
      Stella.SYM_STELLA_JAVA_ONLY_FILES = ((Symbol)(Stella.internRigidSymbolWrtModule("JAVA-ONLY-FILES", null, 0)));
      Stella.SYM_STELLA_PREPROCESSED_FILES = ((Symbol)(Stella.internRigidSymbolWrtModule("PREPROCESSED-FILES", null, 0)));
      Stella.SYM_STELLA_REQUIRED_SYSTEMS = ((Symbol)(Stella.internRigidSymbolWrtModule("REQUIRED-SYSTEMS", null, 0)));
      Stella.SYM_STELLA_LOADEDp = ((Symbol)(Stella.internRigidSymbolWrtModule("LOADED?", null, 0)));
      Stella.SYM_STELLA_UP_TO_DATEp = ((Symbol)(Stella.internRigidSymbolWrtModule("UP-TO-DATE?", null, 0)));
      Stella.SYM_STELLA_SOURCE_ROOT_DIRECTORY = ((Symbol)(Stella.internRigidSymbolWrtModule("SOURCE-ROOT-DIRECTORY", null, 0)));
      Stella.SYM_STELLA_NATIVE_ROOT_DIRECTORY = ((Symbol)(Stella.internRigidSymbolWrtModule("NATIVE-ROOT-DIRECTORY", null, 0)));
      Stella.SYM_STELLA_BINARY_ROOT_DIRECTORY = ((Symbol)(Stella.internRigidSymbolWrtModule("BINARY-ROOT-DIRECTORY", null, 0)));
      Stella.SYM_STELLA_BANNER = ((Symbol)(Stella.internRigidSymbolWrtModule("BANNER", null, 0)));
      Stella.SYM_STELLA_COPYRIGHT_HEADER = ((Symbol)(Stella.internRigidSymbolWrtModule("COPYRIGHT-HEADER", null, 0)));
      Stella.SYM_STELLA_PRODUCTION_SETTINGS = ((Symbol)(Stella.internRigidSymbolWrtModule("PRODUCTION-SETTINGS", null, 0)));
      Stella.SYM_STELLA_DEVELOPMENT_SETTINGS = ((Symbol)(Stella.internRigidSymbolWrtModule("DEVELOPMENT-SETTINGS", null, 0)));
      Stella.SYM_STELLA_FINALIZATION_FUNCTION = ((Symbol)(Stella.internRigidSymbolWrtModule("FINALIZATION-FUNCTION", null, 0)));
      Stella.SYM_STELLA_STATE = ((Symbol)(Stella.internRigidSymbolWrtModule("STATE", null, 0)));
      Stella.SGT_STELLA_OUTPUT_STREAM = ((Surrogate)(Stella.internRigidSymbolWrtModule("OUTPUT-STREAM", null, 1)));
      Stella.KWD_LINE = ((Keyword)(Stella.internRigidSymbolWrtModule("LINE", null, 2)));
      Stella.SGT_STELLA_INPUT_STREAM = ((Surrogate)(Stella.internRigidSymbolWrtModule("INPUT-STREAM", null, 1)));
      Stella.SYM_STELLA_ECHO_STREAM = ((Symbol)(Stella.internRigidSymbolWrtModule("ECHO-STREAM", null, 0)));
      Stella.SYM_STELLA_TOKENIZER_STATE = ((Symbol)(Stella.internRigidSymbolWrtModule("TOKENIZER-STATE", null, 0)));
      Stella.SYM_STELLA_BUFFERING_SCHEME = ((Symbol)(Stella.internRigidSymbolWrtModule("BUFFERING-SCHEME", null, 0)));
      Stella.KWD_SUPERSEDE = ((Keyword)(Stella.internRigidSymbolWrtModule("SUPERSEDE", null, 2)));
      Stella.SGT_STELLA_OUTPUT_FILE_STREAM = ((Surrogate)(Stella.internRigidSymbolWrtModule("OUTPUT-FILE-STREAM", null, 1)));
      Stella.SYM_STELLA_FILENAME = ((Symbol)(Stella.internRigidSymbolWrtModule("FILENAME", null, 0)));
      Stella.SYM_STELLA_IF_EXISTS_ACTION = ((Symbol)(Stella.internRigidSymbolWrtModule("IF-EXISTS-ACTION", null, 0)));
      Stella.SYM_STELLA_FILE_OUTPUT_STREAM = ((Symbol)(Stella.internRigidSymbolWrtModule("FILE-OUTPUT-STREAM", null, 0)));
      Stella.KWD_BLOCK = ((Keyword)(Stella.internRigidSymbolWrtModule("BLOCK", null, 2)));
      Stella.KWD_ERROR = ((Keyword)(Stella.internRigidSymbolWrtModule("ERROR", null, 2)));
      Stella.SGT_STELLA_INPUT_FILE_STREAM = ((Surrogate)(Stella.internRigidSymbolWrtModule("INPUT-FILE-STREAM", null, 1)));
      Stella.SYM_STELLA_IF_NOT_EXISTS_ACTION = ((Symbol)(Stella.internRigidSymbolWrtModule("IF-NOT-EXISTS-ACTION", null, 0)));
      Stella.SYM_STELLA_FILE_INPUT_STREAM = ((Symbol)(Stella.internRigidSymbolWrtModule("FILE-INPUT-STREAM", null, 0)));
      Stella.SGT_STELLA_OUTPUT_STRING_STREAM = ((Surrogate)(Stella.internRigidSymbolWrtModule("OUTPUT-STRING-STREAM", null, 1)));
      Stella.SYM_STELLA_STRING_OUTPUT_STREAM = ((Symbol)(Stella.internRigidSymbolWrtModule("STRING-OUTPUT-STREAM", null, 0)));
      Stella.SGT_STELLA_INPUT_STRING_STREAM = ((Surrogate)(Stella.internRigidSymbolWrtModule("INPUT-STRING-STREAM", null, 1)));
      Stella.SYM_STELLA_STRING_INPUT_STREAM = ((Symbol)(Stella.internRigidSymbolWrtModule("STRING-INPUT-STREAM", null, 0)));
      Stella.SYM_STELLA_STARTUP_HIERARCHY = ((Symbol)(Stella.internRigidSymbolWrtModule("STARTUP-HIERARCHY", null, 0)));
      Stella.SYM_STELLA_METHOD_STARTUP_CLASSNAME = ((Symbol)(Stella.internRigidSymbolWrtModule("METHOD-STARTUP-CLASSNAME", null, 0)));
    }
  }
  ...
  static void helpStartupHierarchy7() {
    {
      ...
      { Stella_Class renamed_Class = Stella.defineClassFromStringifiedSource("TRANSIENT-MIXIN", "(DEFCLASS TRANSIENT-MIXIN () :DOCUMENTATION \"Transient objects are periodically swept back into a pool\nof free objects.  A transient object should never be pointed at by a\npermanent object.\" :MIXIN? TRUE :PUBLIC-SLOTS ((TRANSIENT? :TYPE BOOLEAN :INITIALLY TRUE :HARDWIRED? TRUE)))");
        ...
        Stella.$HARDWIRED_TRANSIENTp_ON_TRANSIENT_MIXIN$ = Stella.TRUE;
      }
      ...
      { Stella_Class renamed_Class = Stella.defineClassFromStringifiedSource("VECTOR-SEQUENCE", "(DEFCLASS VECTOR-SEQUENCE (VECTOR) :ABSTRACT? TRUE :PUBLIC-SLOTS ((RESIZE-INCREMENT :TYPE INTEGER :HARDWIRED? TRUE :INITIALLY 100) (SEQUENCE-LENGTH :TYPE INTEGER)) :INITIALIZER INITIALIZE-VECTOR :SYNONYMS (VSEQ))");

        Stella.$HARDWIRED_RESIZE_INCREMENT_ON_VECTOR_SEQUENCE$ = 100;
      ...
      { Stella_Class renamed_Class = Stella.defineClassFromStringifiedSource("SHORT-VECTOR-SEQUENCE", "(DEFCLASS SHORT-VECTOR-SEQUENCE (VECTOR-SEQUENCE) :PUBLIC-SLOTS ((RESIZE-INCREMENT :TYPE INTEGER :HARDWIRED? TRUE :INITIALLY 4) (SEQUENCE-LENGTH :TYPE INTEGER :INITIALLY 0)) :INITIALIZER INITIALIZE-VECTOR :SYNONYMS (SVSEQ))");

        Stella.$HARDWIRED_RESIZE_INCREMENT_ON_VECTOR_SEQUENCE$ = 100;
        Stella.$HARDWIRED_RESIZE_INCREMENT_ON_SHORT_VECTOR_SEQUENCE$ = 4;
        renamed_Class.classConstructorCode = Native.find_java_method("edu.isi.stella.ShortVectorSequence", "newShortVectorSequence", new java.lang.Class [] {java.lang.Integer.TYPE});
        renamed_Class.classSlotAccessorCode = Native.find_java_method("edu.isi.stella.ShortVectorSequence", "accessShortVectorSequenceSlotValue", new java.lang.Class [] {Native.find_java_class("edu.isi.stella.ShortVectorSequence"), Native.find_java_class("edu.isi.stella.Symbol"), Native.find_java_class("edu.isi.stella.Stella_Object"), java.lang.Boolean.TYPE});
      }
  ...
  static void helpStartupHierarchy8() {
    {
      ...
      Stella.defineClassFromStringifiedSource("COMPOUND-TYPE-SPECIFIER", "(DEFCLASS COMPOUND-TYPE-SPECIFIER (STANDARD-OBJECT) :ABSTRACT? TRUE :PUBLIC? FALSE :PRINT-FORM (PRINT-NATIVE-STREAM STREAM \"|TS|\" (YIELD-TYPE-SPEC-TREE SELF)))");
      ...
      { Stella_Class renamed_Class = Stella.defineClassFromStringifiedSource("MODULE", "(DEFCLASS MODULE (CONTEXT) :PUBLIC-SLOTS ((PARENT-MODULES :TYPE (LIST OF MODULE) :ALLOCATION :EMBEDDED) (DOCUMENTATION :TYPE STRING) (NICKNAMES :TYPE (LIST OF STRING-WRAPPER)) (USES :TYPE (LIST OF MODULE) :ALLOCATION :EMBEDDED) (USED-BY :TYPE (LIST OF MODULE) :ALLOCATION :EMBEDDED) (SHADOWED-SURROGATES :TYPE (LIST OF SURROGATE) :ALLOCATION :DYNAMIC) (REQUIRES :TYPE (LIST OF MODULE)) (MODULE-LISP-PACKAGE :TYPE STRING :DEFAULT \"STELLA\" :ALLOCATION :DYNAMIC) (MODULE-CPP-PACKAGE :TYPE STRING :DEFAULT \"stella\" :ALLOCATION :DYNAMIC) (JAVA-PACKAGE :TYPE STRING :DEFAULT NULL :ALLOCATION :DYNAMIC) (CASE-SENSITIVE? :TYPE BOOLEAN :INITIALLY FALSE) (CLEARABLE? :TYPE BOOLEAN :ALLOCATION :DYNAMIC :DEFAULT TRUE :OPTION-KEYWORD :CLEARABLE?) (CODE-ONLY? :TYPE BOOLEAN :ALLOCATION :DYNAMIC) (API? :TYPE BOOLEAN :ALLOCATION :DYNAMIC) (PROTECT-SURROGATES? :TYPE BOOLEAN :ALLOCATION :DYNAMIC :OPTION-KEYWORD :PROTECT-SURROGATES? :DEFAULT TRUE) (JAVA-FLOTSAM-CLASS :TYPE STRING :ALLOCATION :DYNAMIC :OPTION-KEYWORD :JAVA-CATCHALL-CLASS) (MODULE-FULL-NAME :TYPE STRING) (MODULE-NAME :TYPE STRING :ALLOCATION :INSTANCE) (MODULE-STRINGIFIED-SOURCE :TYPE STRING) (STRINGIFIED-OPTIONS :TYPE STRING) (CARDINAL-MODULE :TYPE MODULE) (SYMBOL-OFFSET-TABLE :TYPE STRING-TO-INTEGER-HASH-TABLE) (SURROGATE-OFFSET-TABLE :TYPE STRING-TO-INTEGER-HASH-TABLE) (STRICT-INFERENCE-CACHE :TYPE WORLD) (DEFAULT-INFERENCE-CACHE :TYPE WORLD) (PROTOTYPE-INFERENCE-CACHE :TYPE WORLD)) :PUBLIC-METHODS ((NAME ((SELF MODULE)) :TYPE STRING (RETURN (MODULE-NAME SELF))) (PARENT-MODULE ((SELF MODULE)) :TYPE MODULE (RETURN (POP (PARENT-CONTEXTS SELF)))) (LISP-PACKAGE ((SELF MODULE)) :TYPE STRING :STORAGE-SLOT MODULE-LISP-PACKAGE :INHERITS-THROUGH PARENT-MODULES) (CPP-PACKAGE ((SELF MODULE)) :TYPE STRING :STORAGE-SLOT MODULE-CPP-PACKAGE :INHERITS-THROUGH PARENT-MODULES)))");
      ...
      { Stella_Class renamed_Class = Stella.defineClassFromStringifiedSource("STELLA-EXCEPTION", "(DEFCLASS STELLA-EXCEPTION (STELLA-ROOT-EXCEPTION))");
      ...
      { Stella_Class renamed_Class = Stella.defineClassFromStringifiedSource("READ-EXCEPTION", "(DEFCLASS READ-EXCEPTION (STELLA-EXCEPTION))");
      ...
      { Stella_Class renamed_Class = Stella.defineClassFromStringifiedSource("UNHANDLED-EXCEPTION", "(DEFCLASS UNHANDLED-EXCEPTION (STELLA-EXCEPTION))");
      ...
      { Stella_Class renamed_Class = Stella.defineClassFromStringifiedSource("EVALUATION-EXCEPTION", "(DEFCLASS EVALUATION-EXCEPTION (STELLA-EXCEPTION))");
      ...
      { Stella_Class renamed_Class = Stella.defineClassFromStringifiedSource("NO-SUCH-OBJECT-EXCEPTION", "(DEFCLASS NO-SUCH-OBJECT-EXCEPTION (STELLA-EXCEPTION))");
      ...
      { Stella_Class renamed_Class = Stella.defineClassFromStringifiedSource("NO-SUCH-CONTEXT-EXCEPTION", "(DEFCLASS NO-SUCH-CONTEXT-EXCEPTION (NO-SUCH-OBJECT-EXCEPTION))");
      ...
      Stella.defineClassFromStringifiedSource("INTEGER", "(DEFCLASS INTEGER (NUMBER) :CL-NATIVE-TYPE \"INTEGER\" :CPP-NATIVE-TYPE \"int\" :IDL-NATIVE-TYPE \"long\" :JAVA-NATIVE-TYPE \"int\" :INITIAL-VALUE NULL-INTEGER :EQUALITY-TEST EQL?)");
      ...
      Stella.defineClassFromStringifiedSource("SHORT-INTEGER", "(DEFCLASS SHORT-INTEGER (INTEGER) :CL-NATIVE-TYPE \"INTEGER\" :CPP-NATIVE-TYPE \"short int\" :IDL-NATIVE-TYPE \"short int\" :JAVA-NATIVE-TYPE \"short\" :INITIAL-VALUE NULL-SHORT-INTEGER :EQUALITY-TEST EQL?)");
      Stella.defineClassFromStringifiedSource("LONG-INTEGER", "(DEFCLASS LONG-INTEGER (INTEGER) :CL-NATIVE-TYPE \"INTEGER\" :CPP-NATIVE-TYPE \"long int\" :IDL-NATIVE-TYPE \"long int\" :JAVA-NATIVE-TYPE \"long\" :INITIAL-VALUE NULL-LONG-INTEGER :EQUALITY-TEST EQL?)");
      Stella.defineClassFromStringifiedSource("UNSIGNED-SHORT-INTEGER", "(DEFCLASS UNSIGNED-SHORT-INTEGER (INTEGER) :CL-NATIVE-TYPE \"INTEGER\" :CPP-NATIVE-TYPE \"unsigned short int\" :IDL-NATIVE-TYPE \"unsigned short int\" :JAVA-NATIVE-TYPE \"short\" :INITIAL-VALUE NULL-UNSIGNED-SHORT-INTEGER :EQUALITY-TEST EQL?)");
      Stella.defineClassFromStringifiedSource("UNSIGNED-LONG-INTEGER", "(DEFCLASS UNSIGNED-LONG-INTEGER (INTEGER) :CL-NATIVE-TYPE \"INTEGER\" :IDL-NATIVE-TYPE \"unsigned long int\" :CPP-NATIVE-TYPE \"unsigned long int\" :JAVA-NATIVE-TYPE \"long\" :INITIAL-VALUE NULL-UNSIGNED-LONG-INTEGER :EQUALITY-TEST EQL?)");
      Stella.defineClassFromStringifiedSource("SINGLE-FLOAT", "(DEFCLASS SINGLE-FLOAT (FLOAT) :CL-NATIVE-TYPE \"FLOAT\" :JAVA-NATIVE-TYPE \"float\" :IDL-NATIVE-TYPE \"float\" :CPP-NATIVE-TYPE \"float\" :INITIAL-VALUE NULL-SINGLE-FLOAT :EQUALITY-TEST EQL?)");
      Stella.defineClassFromStringifiedSource("DOUBLE-FLOAT", "(DEFCLASS DOUBLE-FLOAT (FLOAT) :CL-NATIVE-TYPE \"FLOAT\" :CPP-NATIVE-TYPE \"double\" :JAVA-NATIVE-TYPE \"double\" :IDL-NATIVE-TYPE \"double\" :INITIAL-VALUE NULL-DOUBLE-FLOAT :EQUALITY-TEST EQL?)");
      ...
      { Stella_Class renamed_Class = Stella.defineClassFromStringifiedSource("INTEGER-WRAPPER", "(DEFCLASS INTEGER-WRAPPER (NUMBER-WRAPPER) :PUBLIC-SLOTS ((WRAPPER-VALUE :TYPE INTEGER)) :PRINT-FORM (IF *PRINTREADABLY?* (PRINT-NATIVE-STREAM STREAM (WRAPPER-VALUE SELF)) (PRINT-NATIVE-STREAM STREAM \"|L|\" (WRAPPER-VALUE SELF))))");
      ...
      { Stella_Class renamed_Class = Stella.defineClassFromStringifiedSource("FLOAT-WRAPPER", "(DEFCLASS FLOAT-WRAPPER (NUMBER-WRAPPER) :PUBLIC-SLOTS ((WRAPPER-VALUE :TYPE FLOAT)) :PRINT-FORM (IF *PRINTREADABLY?* (PRINT-NATIVE-STREAM STREAM (WRAPPER-VALUE SELF)) (PRINT-NATIVE-STREAM STREAM \"|L|\" (WRAPPER-VALUE SELF))))");
      ...
      { Stella_Class renamed_Class = Stella.defineClassFromStringifiedSource("CHARACTER-WRAPPER", "(DEFCLASS CHARACTER-WRAPPER (LITERAL-WRAPPER) :PUBLIC-SLOTS ((WRAPPER-VALUE :TYPE CHARACTER)) :PRINT-FORM (IF *PRINTREADABLY?* (PRINT-CHARACTER (WRAPPER-VALUE SELF) STREAM) (PROGN (PRINT-NATIVE-STREAM STREAM \"|L|\") (PRINT-CHARACTER (WRAPPER-VALUE SELF) STREAM))))");
    ...
    { Object old$Module$000 = Stella.$MODULE$.get();
      ...
      try {
        ...
        if (Stella.currentStartupTimePhaseP(5)) {
          ...
          { Stella_Class renamed_Class = Stella.defineClassFromStringifiedSource("BOOLEAN-WRAPPER", "(DEFCLASS BOOLEAN-WRAPPER (LITERAL-WRAPPER) :DOCUMENTATION \"Objectified version of the BOOLEAN data type.  The NULL\nvalue can be used for a 3-valued semantics (see THREE-VALUED-BOOLEAN).\" :PUBLIC-SLOTS ((WRAPPER-VALUE :TYPE BOOLEAN :ALLOCATION :INSTANCE)) :PRINT-FORM (PRINT-NATIVE-STREAM STREAM (CHOOSE *PRINTREADABLY?* \"\" \"|L|\") (CHOOSE (WRAPPER-VALUE SELF) (QUOTE TRUE) (QUOTE FALSE))))");
          ...
          Stella.defineClassFromStringifiedSource("NATIVE-OUTPUT-STREAM", "(DEFCLASS NATIVE-OUTPUT-STREAM (NATIVE-STREAM) :ABSTRACT? TRUE :CPP-NATIVE-TYPE \"std::ostream*\" :JAVA-NATIVE-TYPE \"java.io.PrintStream\" :CL-NATIVE-TYPE \"STREAM\")");
          Stella.defineClassFromStringifiedSource("NATIVE-INPUT-STREAM", "(DEFCLASS NATIVE-INPUT-STREAM (NATIVE-STREAM) :ABSTRACT? TRUE :CPP-NATIVE-TYPE \"std::istream*\" :JAVA-NATIVE-TYPE \"java.io.PushbackInputStream\" :CL-NATIVE-TYPE \"STREAM\")");
          ...
          { Stella_Class renamed_Class = Stella.defineClassFromStringifiedSource("OUTPUT-STRING-STREAM", "(DEFCLASS OUTPUT-STRING-STREAM (OUTPUT-STREAM) :SYNONYMS (STRING-OUTPUT-STREAM) :PUBLIC-SLOTS ((THE-STRING :TYPE STRING :PUBLIC? TRUE :READER THE-STRING-READER)) :INITIALIZER INITIALIZE-STRING-OUTPUT-STREAM)");
          ...
          { Stella_Class renamed_Class = Stella.defineClassFromStringifiedSource("INPUT-STRING-STREAM", "(DEFCLASS INPUT-STRING-STREAM (INPUT-STREAM) :SYNONYMS (STRING-INPUT-STREAM) :PUBLIC-SLOTS ((THE-STRING :TYPE STRING :REQUIRED? TRUE :PUBLIC? TRUE) (BUFFERING-SCHEME :INITIALLY :BLOCK)) :INITIALIZER INITIALIZE-STRING-INPUT-STREAM)");
        ...
        if (Stella.currentStartupTimePhaseP(7)) {
          ...
          { MethodSlot function = Symbol.lookupFunction(Stella.SYM_STELLA_STARTUP_HIERARCHY);
            ...
            KeyValueList.setDynamicSlotValue(function.dynamicSlots, Stella.SYM_STELLA_METHOD_STARTUP_CLASSNAME, Stella.wrapString("_Startup-Hierarchy"), Stella.NULL_STRING_WRAPPER);
          }
        }
