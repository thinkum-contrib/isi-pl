  ...
  public static void cppOutputSignatures(Keyword accesscontrolmode, Cons signatures) {
    ...
    { Stella_Object signature = null;
      ...
      while (!(iter000 == Stella.NIL)) {
        ...
        Stella.cppIndent();
        Cons.cppOutputSignature(((Cons)(signature)), Stella.FALSE);
...
;
                ...
                tofilename = Stella.makeFileName(relativefilename, type, Stella.TRUE);
...
;
  ...
  public static String computeCommonLispFileExtension(Keyword type) {
    ...
    { String suffix = null;
      ...
      return (Native.string_subsequence(dummypathname, 1, Stella.NULL_INTEGER));
    }
  }
  ...
  public static Stella_Object phaseToInteger(Keyword startuptimephase) {
    return (Stella.wrapInteger(Keyword.encodeStartupTimePhase(startuptimephase)));
  }
  ...
  public Stella_Object clTranslateAtomicTree() {
    { Keyword tree = this;
      ...
      if (Stella.useHardcodedSymbolsP()) {
        { IntegerWrapper offset = Stella.wrapInteger(tree.keywordify().symbolId);
  ...
  public static void printKeyword(Keyword self, java.io.PrintStream stream) {
    ...
    if (((Boolean)(Stella.$PRINTREADABLYp$.get())).booleanValue()) {
      Stella.printSymbolNameReadably(self.symbolName, stream, Stella.FALSE);
    }
    else {
