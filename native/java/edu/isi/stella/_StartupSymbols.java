    ...
    { Object old$Module$000 = Stella.$MODULE$.get();
      ...
      try {
        ...
        if (Stella.currentStartupTimePhaseP(4)) {
          ...
          KeyValueList.setDynamicSlotValue(Stella.$ROOT_MODULE$.dynamicSlots, Stella.SYM_STELLA_CODE_ONLYp, (Stella.TRUE ? Stella.TRUE_WRAPPER : Stella.FALSE_WRAPPER), Stella.FALSE_WRAPPER);
          KeyValueList.setDynamicSlotValue(Stella.$STELLA_MODULE$.dynamicSlots, Stella.SYM_STELLA_CODE_ONLYp, (Stella.TRUE ? Stella.TRUE_WRAPPER : Stella.FALSE_WRAPPER), Stella.FALSE_WRAPPER);
          KeyValueList.setDynamicSlotValue(Stella.$COMMON_LISP_MODULE$.dynamicSlots, Stella.SYM_STELLA_CODE_ONLYp, (Stella.TRUE ? Stella.TRUE_WRAPPER : Stella.FALSE_WRAPPER), Stella.FALSE_WRAPPER);
          Stella.$SYMBOL_ESCAPE_CODE_TABLE$ = Stella.initializeSymbolEscapeCodeTable(Stella.FALSE);
          Stella.$CASE_SENSITIVE_SYMBOL_ESCAPE_CODE_TABLE$ = Stella.initializeSymbolEscapeCodeTable(Stella.TRUE);
        }
