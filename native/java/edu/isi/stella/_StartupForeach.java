  ...
  static void helpStartupForeach1() {
    {
      ...
      Stella.SYM_STELLA_SETOF = ((Symbol)(Stella.internRigidSymbolWrtModule("SETOF", null, 0)));
      Stella.SYM_STELLA_SET_OF = ((Symbol)(Stella.internRigidSymbolWrtModule("SET-OF", null, 0)));
      ...
      Stella.SYM_STELLA_NULL_INTEGER = ((Symbol)(Stella.internRigidSymbolWrtModule("NULL-INTEGER", null, 0)));
      ...
      Stella.SYM_STELLA_ALL_PURPOSE_ITERATOR = ((Symbol)(Stella.internRigidSymbolWrtModule("ALL-PURPOSE-ITERATOR", null, 0)));
      Stella.SYM_STELLA_NESTEDITERATOR = ((Symbol)(Stella.internRigidSymbolWrtModule("NESTEDITERATOR", null, 0)));
    ...
    { Object old$Module$000 = Stella.$MODULE$.get();
      ...
      try {
        ...
        if (Stella.currentStartupTimePhaseP(7)) {
          ...
          Stella.defineFunctionObject("YIELD-IN-CURSOR-CLAUSES", "(DEFUN (YIELD-IN-CURSOR-CLAUSES CONS CONS OBJECT) ((INTREE CONS) (DONTOPTIMIZE? BOOLEAN)))", Native.find_java_method("edu.isi.stella.Cons", "yieldInCursorClauses", new java.lang.Class [] {Native.find_java_class("edu.isi.stella.Cons"), java.lang.Boolean.TYPE, Native.find_java_class("[Ljava.lang.Object;")}), null);
          ...
          Stella.defineFunctionObject("WALK-PREFIX-COLLECT-INTO-TREE", "(DEFUN (WALK-PREFIX-COLLECT-INTO-TREE CONS CONS) ((COLLECTINTOTREE CONS) (ITERATORS CONS) (VALUEBINDINGS CONS) (DOCODE CONS)))", Native.find_java_method("edu.isi.stella.Cons", "walkPrefixCollectIntoTree", new java.lang.Class [] {Native.find_java_class("edu.isi.stella.Cons"), Native.find_java_class("edu.isi.stella.Cons"), Native.find_java_class("edu.isi.stella.Cons"), Native.find_java_class("edu.isi.stella.Cons"), Native.find_java_class("[Ljava.lang.Object;")}), null);
          ...
          Stella.defineFunctionObject("WALK-PREFIX-FOREACH-BODY", "(DEFUN (WALK-PREFIX-FOREACH-BODY CONS) ((ITERATORCLAUSES CONS) (VALUECLAUSES CONS) (WHERETEST OBJECT) (DOACTIONS CONS)))", Native.find_java_method("edu.isi.stella.Cons", "walkPrefixForeachBody", new java.lang.Class [] {Native.find_java_class("edu.isi.stella.Cons"), Native.find_java_class("edu.isi.stella.Cons"), Native.find_java_class("edu.isi.stella.Stella_Object"), Native.find_java_class("edu.isi.stella.Cons")}), null);
          ...
          Stella.defineFunctionObject("EXTRACT-SETOF-NESTED-ITERATOR-TREE", "(DEFUN (EXTRACT-SETOF-NESTED-ITERATOR-TREE CONS) ((ITERATORCLAUSES CONS)))", Native.find_java_method("edu.isi.stella.Cons", "extractSetofNestedIteratorTree", new java.lang.Class [] {Native.find_java_class("edu.isi.stella.Cons")}), null);
          Stella.defineFunctionObject("YIELD-SETOF-NEXT-FUNCTION-NAME", "(DEFUN (YIELD-SETOF-NEXT-FUNCTION-NAME SYMBOL) ((VALUECLAUSES CONS) (WHERETEST CONS)))", Native.find_java_method("edu.isi.stella.Cons", "yieldSetofNextFunctionName", new java.lang.Class [] {Native.find_java_class("edu.isi.stella.Cons"), Native.find_java_class("edu.isi.stella.Cons")}), null);
          Stella.defineFunctionObject("WALK-SETOF-TREE", "(DEFUN (WALK-SETOF-TREE CONS TYPE-SPEC) ((TREE CONS)))", Native.find_java_method("edu.isi.stella.Cons", "walkSetofTree", new java.lang.Class [] {Native.find_java_class("edu.isi.stella.Cons"), Native.find_java_class("[Ljava.lang.Object;")}), null);
          ...
          { MethodSlot function = Symbol.lookupFunction(Stella.SYM_STELLA_STARTUP_FOREACH);
            ...
            KeyValueList.setDynamicSlotValue(function.dynamicSlots, Stella.SYM_STELLA_METHOD_STARTUP_CLASSNAME, Stella.wrapString("_Startup-Foreach"), Stella.NULL_STRING_WRAPPER);
          }
        }
