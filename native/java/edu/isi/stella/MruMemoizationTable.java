...
public class MruMemoizationTable extends MemoizationTable {
    ...
    { edu.isi.stella.Stella_Object[] mrubuckets = memotable.mruBuckets;
      ...
      if (mrubucket != null) {
        if (((Cons)(mrubucket.value)) == mrutimestamp) {
          entry = Cons.findMemoizedValueEntryn(mrubucket, args, eqvector, Stella.FALSE);
          if (entry != null) {
            return (entry);
          }
        }
      ...
      if (lrubucket != null) {
        if (((Cons)(lrubucket.value)) == memotable.lruTimestamp) {
          entry = Cons.findMemoizedValueEntryn(lrubucket, args, eqvector, Stella.TRUE);
        }
        else {
  ...
  public static Cons lookupMruMemoizedValue(MruMemoizationTable memotable, Stella_Object arg1, Stella_Object arg2, Stella_Object arg3, Stella_Object arg4, int eqvector) {
    { edu.isi.stella.Stella_Object[] mrubuckets = memotable.mruBuckets;
      ...
      if (mrubucket != null) {
        if (((Cons)(mrubucket.value)) == mrutimestamp) {
          entry = Cons.findMemoizedValueEntry(mrubucket, arg1, arg2, arg3, arg4, eqvector, Stella.FALSE);
          if (entry != null) {
            return (entry);
          }
        }
      ...
      if (lrubucket != null) {
        if (((Cons)(lrubucket.value)) == memotable.lruTimestamp) {
          entry = Cons.findMemoizedValueEntry(lrubucket, arg1, arg2, arg3, arg4, eqvector, Stella.TRUE);
        }
        else {
          lrubucket.rest = Stella.NIL;
        }
  ...
  public static Stella_Object accessMruMemoizationTableSlotValue(MruMemoizationTable self, Symbol slotname, Stella_Object value, boolean setvalueP) {
    if (slotname == Stella.SYM_STELLA_MRU_BUCKETS_VECTOR) {
      ...
      if (setvalueP) {
        ...
        value = Stella.wrapInteger(self.nofBuckets);
      }
    }
      ...
      if (setvalueP) {
        ...
        value = Stella.wrapInteger(self.freeEntries);
      }
    }
      ...
      if (setvalueP) {
        ...
        value = Stella.wrapInteger(self.maxEntries);
      }
    }
    else {
