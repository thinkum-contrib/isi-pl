...
public class Body extends XMLObject {
    public XMLObject contents;

  public static Body new_Body() {
    { Body self = null;
  ...
  public static Stella_Object access_Body_Slot_Value(Body self, Symbol slotname, Stella_Object value, boolean setvalueP) {
  ...
  public Surrogate primaryType() {
    { Body self = this;
      ...
      return (SoapEnv.SGT_SOAP_ENV_Body);
    }
  }
