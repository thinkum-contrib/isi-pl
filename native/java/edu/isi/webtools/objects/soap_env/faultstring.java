...
public class faultstring extends XMLObject {
  public static faultstring new_faultstring() {
    { faultstring self = null;

      self = new faultstring();
  ...
  public Surrogate primaryType() {
    { faultstring self = this;

      return (SoapEnv.SGT_SOAP_ENV_faultstring);
    }
  }
