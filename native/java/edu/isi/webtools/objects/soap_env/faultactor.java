...
public class faultactor extends XMLObject {
  public static faultactor new_faultactor() {
    { faultactor self = null;
  ...
  public Surrogate primaryType() {
    { faultactor self = this;

      return (SoapEnv.SGT_SOAP_ENV_faultactor);
    }
  }
