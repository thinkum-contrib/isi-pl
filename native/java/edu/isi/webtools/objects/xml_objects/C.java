...
public class C extends XMLObject {
    public D d;
    public E e;

  public static C NEW_C() {
    { C self = null;
  ...
  public static Stella_Object ACCESS_C_SLOT_VALUE(C self, Symbol slotname, Stella_Object value, boolean setvalueP) {
    if (slotname == XmlObjects.SYM_XML_OBJECTS_d) {
      if (setvalueP) {
        self.d = ((D)(value));
      }
      else {
    ...
    else if (slotname == XmlObjects.SYM_XML_OBJECTS_e) {
      if (setvalueP) {
        self.e = ((E)(value));
      }
      else {
  ...
  public Surrogate primaryType() {
    { C self = this;
      ...
      return (XmlObjects.SGT_XML_OBJECTS_C);
    }
  }
