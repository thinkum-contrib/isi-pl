...
public class A extends XMLObject {
    public B b;
    public C c;

  public static A NEW_A() {
    { A self = null;
  ...
  public static Stella_Object ACCESS_A_SLOT_VALUE(A self, Symbol slotname, Stella_Object value, boolean setvalueP) {
    if (slotname == XmlObjects.SYM_XML_OBJECTS_b) {
      if (setvalueP) {
        self.b = ((B)(value));
      }
      else {
    ...
    else if (slotname == XmlObjects.SYM_XML_OBJECTS_c) {
      if (setvalueP) {
        self.c = ((C)(value));
      }
      else {
  ...
  public Surrogate primaryType() {
    { A self = this;
      ...
      return (XmlObjects.SGT_XML_OBJECTS_A);
    }
  }
