...
public class E extends XMLObject {
    public F f;

  public static E NEW_E() {
    { E self = null;
  ...
  public static Stella_Object ACCESS_E_SLOT_VALUE(E self, Symbol slotname, Stella_Object value, boolean setvalueP) {
    if (slotname == XmlObjects.SYM_XML_OBJECTS_f) {
      if (setvalueP) {
        self.f = ((F)(value));
      }
      else {
  ...
  public Surrogate primaryType() {
    { E self = this;
      ...
      return (XmlObjects.SGT_XML_OBJECTS_E);
    }
  }
