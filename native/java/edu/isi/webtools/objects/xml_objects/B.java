...
public class B extends XMLObject {
    public D d;

  public static B NEW_B() {
    { B self = null;
  ...
  public static Stella_Object ACCESS_B_SLOT_VALUE(B self, Symbol slotname, Stella_Object value, boolean setvalueP) {
  ...
  public Surrogate primaryType() {
    { B self = this;
      ...
      return (XmlObjects.SGT_XML_OBJECTS_B);
    }
  }
