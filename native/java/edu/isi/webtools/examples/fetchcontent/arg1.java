...
public class arg1 extends XMLObject {
    public item item;

  public static arg1 new_arg1() {
    { arg1 self = null;
  ...
  public static Stella_Object access_arg1_Slot_Value(arg1 self, Symbol slotname, Stella_Object value, boolean setvalueP) {
    if (slotname == FetchContent.SYM_FETCH_CONTENT_item) {
      if (setvalueP) {
  ...
  public Surrogate primaryType() {
    { arg1 self = this;
      ...
      return (FetchContent.SGT_FETCH_CONTENT_arg1);
    }
  }
