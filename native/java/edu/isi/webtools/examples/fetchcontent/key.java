...
public class key extends XMLObject {
  ...
  public static Stella_Object access_key_Slot_Value(key self, Symbol slotname, Stella_Object value, boolean setvalueP) {
  ...
  public Surrogate primaryType() {
    { key self = this;
      ...
      return (FetchContent.SGT_FETCH_CONTENT_key);
    }
  }
