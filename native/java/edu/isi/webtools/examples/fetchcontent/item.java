...
public class item extends XMLObject {
  ...
  public static Stella_Object access_item_Slot_Value(item self, Symbol slotname, Stella_Object value, boolean setvalueP) {
    if (slotname == FetchContent.SYM_FETCH_CONTENT_key) {
      if (setvalueP) {
        self.key = ((key)(value));
      }
      else {
    ...
    else if (slotname == FetchContent.SYM_FETCH_CONTENT_val) {
      if (setvalueP) {
  ...
  public Surrogate primaryType() {
    { item self = this;
      ...
      return (FetchContent.SGT_FETCH_CONTENT_item);
    }
  }
