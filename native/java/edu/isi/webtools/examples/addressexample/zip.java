...
public class zip extends XMLObject {
    public String type;

  public static zip new_zip() {
    { zip self = null;
  ...
  public static Stella_Object access_zip_Slot_Value(zip self, Symbol slotname, Stella_Object value, boolean setvalueP) {
  ...
  public Surrogate primaryType() {
    { zip self = this;
      ...
      return (AddressExample.SGT_ADDRESS_EXAMPLE_zip);
    }
  }
