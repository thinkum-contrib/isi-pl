...
public class city extends XMLObject {
    public String type;

  public static city new_city() {
    { city self = null;
  ...
  public static Stella_Object access_city_Slot_Value(city self, Symbol slotname, Stella_Object value, boolean setvalueP) {
  ...
  public Surrogate primaryType() {
    { city self = this;
      ...
      return (AddressExample.SGT_ADDRESS_EXAMPLE_city);
    }
  }
