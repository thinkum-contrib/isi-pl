...
public class state extends XMLObject {
    public String type;
  ...
  public static Stella_Object access_state_Slot_Value(state self, Symbol slotname, Stella_Object value, boolean setvalueP) {
  ...
  public Surrogate primaryType() {
    { state self = this;
      ...
      return (AddressExample.SGT_ADDRESS_EXAMPLE_state);
    }
  }
