...
public class areaCode extends XMLObject {
    public String type;

  public static areaCode new_areaCode() {
    { areaCode self = null;
  ...
  public static Stella_Object access_areaCode_Slot_Value(areaCode self, Symbol slotname, Stella_Object value, boolean setvalueP) {
  ...
  public Surrogate primaryType() {
    { areaCode self = this;
      ...
      return (AddressExample.SGT_ADDRESS_EXAMPLE_areaCode);
    }
  }
