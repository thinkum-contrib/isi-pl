...
public class streetName extends XMLObject {
    public String type;

  public static streetName new_streetName() {
    { streetName self = null;
  ...
  public static Stella_Object access_streetName_Slot_Value(streetName self, Symbol slotname, Stella_Object value, boolean setvalueP) {
  ...
  public Surrogate primaryType() {
    { streetName self = this;

      return (AddressExample.SGT_ADDRESS_EXAMPLE_streetName);
    }
  }
