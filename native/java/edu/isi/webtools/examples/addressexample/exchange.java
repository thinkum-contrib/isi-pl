...
public class exchange extends XMLObject {
    public String type;

  public static exchange new_exchange() {
    { exchange self = null;
  ...
  public static Stella_Object access_exchange_Slot_Value(exchange self, Symbol slotname, Stella_Object value, boolean setvalueP) {
  ...
  public Surrogate primaryType() {
    { exchange self = this;
      ...
      return (AddressExample.SGT_ADDRESS_EXAMPLE_exchange);
    }
  }
