...
public class streetNum extends XMLObject {
    public String type;

  public static streetNum new_streetNum() {
    { streetNum self = null;
  ...
  public static Stella_Object access_streetNum_Slot_Value(streetNum self, Symbol slotname, Stella_Object value, boolean setvalueP) {
  ...
  public Surrogate primaryType() {
    { streetNum self = this;
      ...
      return (AddressExample.SGT_ADDRESS_EXAMPLE_streetNum);
    }
  }
