...
public class SoapFaultException extends StellaException {
    public Fault fault;
  ...
  public static SoapFaultException newSoapFaultException(String message) {
    { SoapFaultException self = null;

      self = new SoapFaultException(message);
      self.fault = null;
      return (self);
    }
  }
