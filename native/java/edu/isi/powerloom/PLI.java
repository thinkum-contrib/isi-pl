...
public class PLI {
    ...
    { Module mdl000 = module;
      ...
      { Object old$Module$000 = Stella.$MODULE$.get();
        ...
        try {
          ...
          environment = environment;
          synchronized (Logic.$POWERLOOM_LOCK$) {
            return (PLI.listToPlIterator(Logic.assertedCollectionMembers(concept, true)));
          }
    ...
    { Module mdl000 = module;
      ...
      { Object old$Module$000 = Stella.$MODULE$.get();
        ...
        try {
          ...
          environment = environment;
          synchronized (Logic.$POWERLOOM_LOCK$) {
            return (PLI.consToPlIterator(PLI.helpGetTrueExtensionMembers(((NamedDescription)(relation)), true)));
          }
  ...
  public static Module createModule(String name, Module parent, boolean caseSensitiveP) {
    { String fullName = ((parent != null) ? (parent.moduleFullName + "/" + name) : name);
      ...
      return (Stella.defineModule(fullName, Stella.list$(Stella_Object.cons(PLI.KWD_CASE_SENSITIVEp, Stella_Object.cons(caseSensitiveSymbol, Stella_Object.cons(Stella.NIL, Stella.NIL))))));
    }
  }
...
;
  ...
  public static Cons getEnumeratedCollectionMembers(Stella_Object collection) {
    return (Logic.assertedCollectionMembers(collection, true).theConsList);
  }
   ...
   * @param argv060
   */
  public static void main(String[] argv060) {
