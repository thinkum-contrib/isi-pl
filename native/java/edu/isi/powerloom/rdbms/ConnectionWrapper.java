...
public class ConnectionWrapper extends LogicThing {
    public edu.isi.sdbc.Connection wrapperValue;

  public static ConnectionWrapper newConnectionWrapper() {
  ...
  public static Stella_Object accessConnectionWrapperSlotValue(ConnectionWrapper self, Symbol slotname, Stella_Object value, boolean setvalueP) {
    if (slotname == RDBMS.SYM_STELLA_WRAPPER_VALUE) {
      if (setvalueP) {
        self.wrapperValue = ((edu.isi.sdbc.Connection)(value));
      }
      else {
