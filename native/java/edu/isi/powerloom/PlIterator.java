            ...
            if (collect000 == null) {
              {
                ...
                if (v098 == Stella.NIL) {
                  ...
                  Cons.addConsToEndOfConsList(v098, collect000);
                }
              }
            }
            else {
              ...
              if (collect000 == null) {
                {
                  ...
                  if (v097 == Stella.NIL) {
                    ...
                    Cons.addConsToEndOfConsList(v097, collect000);
                  }
                }
              }
              else {
