  ...
  static void helpStartupGoalCaches1() {
    {
      ...
      Logic.SGT_PL_KERNEL_KB_FRAME_PREDICATE = ((Surrogate)(Stella.internRigidSymbolWrtModule("FRAME-PREDICATE", Stella.getStellaModule("/PL-KERNEL-KB", Stella.TRUE), 1)));
    ...
    { Object old$Module$000 = Stella.$MODULE$.get();
      ...
      try {
        ...
        if (Stella.currentStartupTimePhaseP(4)) {
          Logic.$CACHE_SUCCEEDED_GOALSp$ = Stella.TRUE;
          Logic.$CACHE_FAILED_GOALSp$ = Stella.TRUE;
