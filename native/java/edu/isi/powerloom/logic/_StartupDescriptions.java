...
public class _StartupDescriptions {
  static void helpStartupDescriptions1() {
    {
      Logic.SGT_STELLA_METHOD_SLOT = ((Surrogate)(Stella.internRigidSymbolWrtModule("METHOD-SLOT", Stella.getStellaModule("/STELLA", Stella.TRUE), 1)));
      Logic.SYM_STELLA_ANY_VALUE = ((Symbol)(Stella.internRigidSymbolWrtModule("ANY-VALUE", Stella.getStellaModule("/STELLA", Stella.TRUE), 0)));
  ...
  static void helpStartupDescriptions2() {
    {
      ...
      Logic.SGT_PL_KERNEL_KB_CONCEPT = ((Surrogate)(Stella.internRigidSymbolWrtModule("CONCEPT", Stella.getStellaModule("/PL-KERNEL-KB", Stella.TRUE), 1)));
      Logic.SYM_LOGIC_ENTITY_MAPPING = ((Symbol)(Stella.internRigidSymbolWrtModule("ENTITY-MAPPING", null, 0)));
      Logic.SGT_STELLA_LIST = ((Surrogate)(Stella.internRigidSymbolWrtModule("LIST", Stella.getStellaModule("/STELLA", Stella.TRUE), 1)));
      Logic.SYM_LOGIC_ORIGINAL_SKOLEM_NAME = ((Symbol)(Stella.internRigidSymbolWrtModule("ORIGINAL-SKOLEM-NAME", null, 0)));
      Logic.SYM_LOGIC_EXTERNAL_VARIABLES = ((Symbol)(Stella.internRigidSymbolWrtModule("EXTERNAL-VARIABLES", null, 0)));
      Logic.SGT_STELLA_PROPOSITIONdIF = ((Surrogate)(Stella.internRigidSymbolWrtModule("PROPOSITION.IF", Stella.getStellaModule("/STELLA", Stella.TRUE), 1)));
      ...
      Logic.SYM_PL_KERNEL_KB_RELATION = ((Symbol)(Stella.internRigidSymbolWrtModule("RELATION", Stella.getStellaModule("/PL-KERNEL-KB", Stella.TRUE), 0)));
      Logic.SYM_LOGIC_QUERY_038 = ((Symbol)(Stella.internRigidSymbolWrtModule("QUERY-038", null, 0)));
  ...
  static void helpStartupDescriptions3() {
    {
      ...
      Logic.$UNIFY_PROPOSITIONSp$.setDefaultValue(new Boolean(Stella.FALSE));
      Logic.$STRINGIFIED_DESCRIPTION_INDEX$ = StringHashTable.newStringHashTable();
      Logic.$RECURSIVEGETCOMPLEMENTARGUMENT$.setDefaultValue(null);
      Logic.$ADDEDNEWTYPEp$.setDefaultValue(new Boolean(Stella.FALSE));
    }
  }
  ...
  static void helpStartupDescriptions4() {
    {
      ...
      Stella.defineFunctionObject("SAME-ARGUMENTS?", "(DEFUN (SAME-ARGUMENTS? BOOLEAN) ((VARIABLES VARIABLES-VECTOR) (ARGUMENTS VECTOR)))", Native.find_java_method("edu.isi.powerloom.logic.Logic", "sameArgumentsP", new java.lang.Class [] {Native.find_java_class("edu.isi.stella.Vector"), Native.find_java_class("edu.isi.stella.Vector")}), null);
      ...
      Stella.defineFunctionObject("NAMED-DESCRIPTION?", "(DEFUN (NAMED-DESCRIPTION? BOOLEAN) ((SELF DESCRIPTION)) :PUBLIC? TRUE)", Native.find_java_method("edu.isi.powerloom.logic.Description", "namedDescriptionP", new java.lang.Class [] {Native.find_java_class("edu.isi.powerloom.logic.Description")}), null);
      ...
      Stella.defineFunctionObject("DELETED-LOGIC-OBJECT?", "(DEFUN (DELETED-LOGIC-OBJECT? BOOLEAN) ((SELF LOGIC-OBJECT)))", Native.find_java_method("edu.isi.powerloom.logic.LogicObject", "deletedLogicObjectP", new java.lang.Class [] {Native.find_java_class("edu.isi.powerloom.logic.LogicObject")}), null);
      Stella.defineFunctionObject("UNIQUIFY-DESCRIPTION-VARIABLES", "(DEFUN UNIQUIFY-DESCRIPTION-VARIABLES ((SELF DESCRIPTION)))", Native.find_java_method("edu.isi.powerloom.logic.Description", "uniquifyDescriptionVariables", new java.lang.Class [] {Native.find_java_class("edu.isi.powerloom.logic.Description")}), null);
      Stella.defineFunctionObject("RESTORE-DESCRIPTION-VARIABLE-NAMES", "(DEFUN RESTORE-DESCRIPTION-VARIABLE-NAMES ((SELF DESCRIPTION)))", Native.find_java_method("edu.isi.powerloom.logic.Description", "restoreDescriptionVariableNames", new java.lang.Class [] {Native.find_java_class("edu.isi.powerloom.logic.Description")}), null);
      Stella.defineFunctionObject("CONS-TREE-LESS-THAN?", "(DEFUN (CONS-TREE-LESS-THAN? BOOLEAN) ((TREE1 OBJECT) (TREE2 OBJECT)))", Native.find_java_method("edu.isi.powerloom.logic.Logic", "consTreeLessThanP", new java.lang.Class [] {Native.find_java_class("edu.isi.stella.Stella_Object"), Native.find_java_class("edu.isi.stella.Stella_Object")}), null);
      Stella.defineFunctionObject("SORT-PROPOSITION-CLAUSES", "(DEFUN (SORT-PROPOSITION-CLAUSES CONS) ((CLAUSES CONS)))", Native.find_java_method("edu.isi.powerloom.logic.Logic", "sortPropositionClauses", new java.lang.Class [] {Native.find_java_class("edu.isi.stella.Cons")}), null);
      Stella.defineFunctionObject("UNIQUIFY-PROPOSITION-TREE", "(DEFUN (UNIQUIFY-PROPOSITION-TREE OBJECT) ((TREE OBJECT)))", Native.find_java_method("edu.isi.powerloom.logic.Logic", "uniquifyPropositionTree", new java.lang.Class [] {Native.find_java_class("edu.isi.stella.Stella_Object")}), null);
      Stella.defineFunctionObject("FIND-EXACT-DUPLICATE-DESCRIPTION", "(DEFUN (FIND-EXACT-DUPLICATE-DESCRIPTION DESCRIPTION) ((SELF DESCRIPTION)))", Native.find_java_method("edu.isi.powerloom.logic.Description", "findExactDuplicateDescription", new java.lang.Class [] {Native.find_java_class("edu.isi.powerloom.logic.Description")}), null);
      Stella.defineFunctionObject("HELP-COLLECT-CONSTANT-REFERENCES", "(DEFUN HELP-COLLECT-CONSTANT-REFERENCES ((SELF OBJECT) (COLLECTION (LIST OF LOGIC-OBJECT)) (STOPATONE? BOOLEAN)))", Native.find_java_method("edu.isi.powerloom.logic.Logic", "helpCollectConstantReferences", new java.lang.Class [] {Native.find_java_class("edu.isi.stella.Stella_Object"), Native.find_java_class("edu.isi.stella.List"), java.lang.Boolean.TYPE}), null);
      Stella.defineFunctionObject("COLLECT-CONSTANT-DESCRIPTION-REFERENCES", "(DEFUN (COLLECT-CONSTANT-DESCRIPTION-REFERENCES (LIST OF LOGIC-OBJECT)) ((SELF DESCRIPTION) (COLLECTION (LIST OF LOGIC-OBJECT)) (STOPATONE? BOOLEAN)))", Native.find_java_method("edu.isi.powerloom.logic.Description", "collectConstantDescriptionReferences", new java.lang.Class [] {Native.find_java_class("edu.isi.powerloom.logic.Description"), Native.find_java_class("edu.isi.stella.List"), java.lang.Boolean.TYPE}), null);
      Stella.defineFunctionObject("FIND-DUPLICATE-DESCRIPTION-WITH-CONSTANT-REFERENCE", "(DEFUN (FIND-DUPLICATE-DESCRIPTION-WITH-CONSTANT-REFERENCE DESCRIPTION) ((SELF DESCRIPTION)))", Native.find_java_method("edu.isi.powerloom.logic.Description", "findDuplicateDescriptionWithConstantReference", new java.lang.Class [] {Native.find_java_class("edu.isi.powerloom.logic.Description")}), null);
      ...
      Stella.defineFunctionObject("ADD-DEPENDENT-DESCRIPTION-LINK", "(DEFUN ADD-DEPENDENT-DESCRIPTION-LINK ((SELF OBJECT) (DESCRIPTION DESCRIPTION)))", Native.find_java_method("edu.isi.powerloom.logic.Logic", "addDependentDescriptionLink", new java.lang.Class [] {Native.find_java_class("edu.isi.stella.Stella_Object"), Native.find_java_class("edu.isi.powerloom.logic.Description")}), null);
      Stella.defineFunctionObject("FASTEN-DOWN-DESCRIPTION", "(DEFUN FASTEN-DOWN-DESCRIPTION ((SELF DESCRIPTION)))", Native.find_java_method("edu.isi.powerloom.logic.Description", "fastenDownDescription", new java.lang.Class [] {Native.find_java_class("edu.isi.powerloom.logic.Description")}), null);
    ...
    { Object old$Module$000 = Stella.$MODULE$.get();
      ...
      try {
        ...
        if (Stella.currentStartupTimePhaseP(5)) {
          Stella.defineStellaTypeFromStringifiedSource("(DEFTYPE ENTITY-MAPPING (KEY-VALUE-LIST OF OBJECT OBJECT) :DOCUMENTATION \"Used to keep track of already copied variables\nand propositions within a 'copy-description' procedure.\")");
        ...
        if (Stella.currentStartupTimePhaseP(7)) {
          ...
          Stella.defineFunctionObject("COLLAPSE-VALUE-OF-CHAINS", "(DEFUN COLLAPSE-VALUE-OF-CHAINS ((DESCRIPTION DESCRIPTION)))", Native.find_java_method("edu.isi.powerloom.logic.Description", "collapseValueOfChains", new java.lang.Class [] {Native.find_java_class("edu.isi.powerloom.logic.Description")}), null);
          ...
          { MethodSlot function = Symbol.lookupFunction(Logic.SYM_LOGIC_STARTUP_DESCRIPTIONS);
            ...
            KeyValueList.setDynamicSlotValue(function.dynamicSlots, Logic.SYM_STELLA_METHOD_STARTUP_CLASSNAME, Stella.wrapString("_Startup-Descriptions"), Stella.NULL_STRING_WRAPPER);
          }
        }
        ...
        if (Stella.currentStartupTimePhaseP(9)) {
          ...
          Stella.defineStellaGlobalVariableFromStringifiedSource("(DEFGLOBAL *STRINGIFIED-DESCRIPTION-INDEX* (STRING-HASH-TABLE OF STRING LIST) (NEW STRING-HASH-TABLE) :DOCUMENTATION \"Contains a table of unnamed descriptions, indexed by the\nstringification of their propositions.  Tricky: Descriptions in two\ndifferent modules could have the same stringification but be different.\")");
