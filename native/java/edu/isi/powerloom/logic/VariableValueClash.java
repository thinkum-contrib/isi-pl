...
public class VariableValueClash extends Clash {
  ...
  public VariableValueClash (String message) {
    super(message);
  }

  public static VariableValueClash newVariableValueClash(String message) {
