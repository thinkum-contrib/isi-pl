...
public class _StartupLogicMacros {
  static void helpStartupLogicMacros1() {
    {
      Stella.internSurrogateInModule("PROPOSITION.IF", Stella.$STELLA_MODULE$, true);
      Logic.SYM_STELLA_LET = ((Symbol)(Stella.internRigidSymbolWrtModule("LET", Stella.getStellaModule("/STELLA", true), 0)));
      Logic.SYM_STELLA_NEW = ((Symbol)(Stella.internRigidSymbolWrtModule("NEW", Stella.getStellaModule("/STELLA", true), 0)));
      Logic.SYM_STELLA_OUTPUT_STRING_STREAM = ((Symbol)(Stella.internRigidSymbolWrtModule("OUTPUT-STRING-STREAM", Stella.getStellaModule("/STELLA", true), 0)));
      Logic.SYM_STELLA_SPECIAL = ((Symbol)(Stella.internRigidSymbolWrtModule("SPECIAL", Stella.getStellaModule("/STELLA", true), 0)));
      Logic.SYM_STELLA_$PRINTREADABLYp$ = ((Symbol)(Stella.internRigidSymbolWrtModule("*PRINTREADABLY?*", Stella.getStellaModule("/STELLA", true), 0)));
      Logic.SYM_STELLA_TRUE = ((Symbol)(Stella.internRigidSymbolWrtModule("TRUE", Stella.getStellaModule("/STELLA", true), 0)));
      Logic.SYM_STELLA_PRINT_STREAM = ((Symbol)(Stella.internRigidSymbolWrtModule("PRINT-STREAM", Stella.getStellaModule("/STELLA", true), 0)));
      Logic.SYM_STELLA_EOL = ((Symbol)(Stella.internRigidSymbolWrtModule("EOL", Stella.getStellaModule("/STELLA", true), 0)));
      ...
      Logic.SYM_STELLA_SIGNAL_EXCEPTION = ((Symbol)(Stella.internRigidSymbolWrtModule("SIGNAL-EXCEPTION", Stella.getStellaModule("/STELLA", true), 0)));
      ...
      Logic.SYM_STELLA_THE_STRING = ((Symbol)(Stella.internRigidSymbolWrtModule("THE-STRING", Stella.getStellaModule("/STELLA", true), 0)));
      Logic.SYM_LOGIC_PROPOSITION_ERROR = ((Symbol)(Stella.internRigidSymbolWrtModule("PROPOSITION-ERROR", null, 0)));
      Logic.SYM_STELLA_STANDARD_WARNING = ((Symbol)(Stella.internRigidSymbolWrtModule("STANDARD-WARNING", Stella.getStellaModule("/STELLA", true), 0)));
      Logic.KWD_WARNING = ((Keyword)(Stella.internRigidSymbolWrtModule("WARNING", null, 2)));
      Logic.SYM_STELLA_DEFUN = ((Symbol)(Stella.internRigidSymbolWrtModule("DEFUN", Stella.getStellaModule("/STELLA", true), 0)));
      Logic.SYM_STELLA_STRING = ((Symbol)(Stella.internRigidSymbolWrtModule("STRING", Stella.getStellaModule("/STELLA", true), 0)));
      Logic.SYM_STELLA_PRINT = ((Symbol)(Stella.internRigidSymbolWrtModule("PRINT", Stella.getStellaModule("/STELLA", true), 0)));
      Logic.SYM_STELLA_RETURN = ((Symbol)(Stella.internRigidSymbolWrtModule("RETURN", Stella.getStellaModule("/STELLA", true), 0)));
      Logic.SYM_STELLA_PROGN = ((Symbol)(Stella.internRigidSymbolWrtModule("PROGN", Stella.getStellaModule("/STELLA", true), 0)));
      Logic.SYM_STELLA_SETF = ((Symbol)(Stella.internRigidSymbolWrtModule("SETF", Stella.getStellaModule("/STELLA", true), 0)));
      ...
      Logic.SYM_STELLA_NULL = ((Symbol)(Stella.internRigidSymbolWrtModule("NULL", Stella.getStellaModule("/STELLA", true), 0)));
      Logic.SYM_LOGIC_JUSTIFICATION = ((Symbol)(Stella.internRigidSymbolWrtModule("JUSTIFICATION", null, 0)));
      Logic.SYM_STELLA_WHEN = ((Symbol)(Stella.internRigidSymbolWrtModule("WHEN", Stella.getStellaModule("/STELLA", true), 0)));
      Logic.SYM_STELLA_DEFINEDp = ((Symbol)(Stella.internRigidSymbolWrtModule("DEFINED?", Stella.getStellaModule("/STELLA", true), 0)));
      ...
      Logic.SYM_STELLA_SETQ = ((Symbol)(Stella.internRigidSymbolWrtModule("SETQ", Stella.getStellaModule("/STELLA", true), 0)));
      ...
      Logic.SYM_STELLA_COND = ((Symbol)(Stella.internRigidSymbolWrtModule("COND", Stella.getStellaModule("/STELLA", true), 0)));
      ...
      Logic.SYM_STELLA__ = ((Symbol)(Stella.internRigidSymbolWrtModule("-", Stella.getStellaModule("/STELLA", true), 0)));
      ...
      Logic.SYM_STELLA___ = ((Symbol)(Stella.internRigidSymbolWrtModule("--", Stella.getStellaModule("/STELLA", true), 0)));
      ...
      Logic.SYM_STELLA_ii = ((Symbol)(Stella.internRigidSymbolWrtModule("++", Stella.getStellaModule("/STELLA", true), 0)));
      Logic.SYM_STELLA_le = ((Symbol)(Stella.internRigidSymbolWrtModule("<=", Stella.getStellaModule("/STELLA", true), 0)));
      Logic.SYM_LOGIC_POP_FRAMES_UP_TO = ((Symbol)(Stella.internRigidSymbolWrtModule("POP-FRAMES-UP-TO", null, 0)));
      Logic.SYM_STELLA_MV_SETQ = ((Symbol)(Stella.internRigidSymbolWrtModule("MV-SETQ", Stella.getStellaModule("/STELLA", true), 0)));
      ...
      Logic.SYM_STELLA_1i = ((Symbol)(Stella.internRigidSymbolWrtModule("1+", Stella.getStellaModule("/STELLA", true), 0)));
      Logic.SYM_STELLA_OTHERWISE = ((Symbol)(Stella.internRigidSymbolWrtModule("OTHERWISE", Stella.getStellaModule("/STELLA", true), 0)));
  ...
  static void helpStartupLogicMacros2() {
    {
      Logic.SYM_STELLA_AND = ((Symbol)(Stella.internRigidSymbolWrtModule("AND", Stella.getStellaModule("/STELLA", true), 0)));
      Logic.SYM_STELLA_NULLp = ((Symbol)(Stella.internRigidSymbolWrtModule("NULL?", Stella.getStellaModule("/STELLA", true), 0)));
      Logic.SYM_STELLA_1_ = ((Symbol)(Stella.internRigidSymbolWrtModule("1-", Stella.getStellaModule("/STELLA", true), 0)));
      Logic.SYM_LOGIC_PROPOSITION = ((Symbol)(Stella.internRigidSymbolWrtModule("PROPOSITION", null, 0)));
      Logic.SYM_STELLA_NTH = ((Symbol)(Stella.internRigidSymbolWrtModule("NTH", Stella.getStellaModule("/STELLA", true), 0)));
      Logic.SYM_STELLA_ARGUMENTS = ((Symbol)(Stella.internRigidSymbolWrtModule("ARGUMENTS", Stella.getStellaModule("/STELLA", true), 0)));
      ...
      Logic.SYM_STELLA_g = ((Symbol)(Stella.internRigidSymbolWrtModule(">", Stella.getStellaModule("/STELLA", true), 0)));
      Logic.SYM_LOGIC_CURRENT_DEPTH_CUTOFF = ((Symbol)(Stella.internRigidSymbolWrtModule("CURRENT-DEPTH-CUTOFF", null, 0)));
      Logic.SYM_STELLA_EQLp = ((Symbol)(Stella.internRigidSymbolWrtModule("EQL?", Stella.getStellaModule("/STELLA", true), 0)));
      Logic.SYM_STELLA_STATE = ((Symbol)(Stella.internRigidSymbolWrtModule("STATE", Stella.getStellaModule("/STELLA", true), 0)));
      ...
      Logic.SYM_STELLA_NOT = ((Symbol)(Stella.internRigidSymbolWrtModule("NOT", Stella.getStellaModule("/STELLA", true), 0)));
      ...
      Logic.SYM_STELLA_FALSE = ((Symbol)(Stella.internRigidSymbolWrtModule("FALSE", Stella.getStellaModule("/STELLA", true), 0)));
      Logic.SYM_STELLA_RESULT = ((Symbol)(Stella.internRigidSymbolWrtModule("RESULT", Stella.getStellaModule("/STELLA", true), 0)));
      Logic.SYM_STELLA_IF = ((Symbol)(Stella.internRigidSymbolWrtModule("IF", Stella.getStellaModule("/STELLA", true), 0)));
      ...
      Logic.SYM_STELLA_BREAK = ((Symbol)(Stella.internRigidSymbolWrtModule("BREAK", Stella.getStellaModule("/STELLA", true), 0)));
      ...
      Logic.SYM_STELLA_BQUOTE = ((Symbol)(Stella.internRigidSymbolWrtModule("BQUOTE", Stella.getStellaModule("/STELLA", true), 0)));
      Logic.SYM_STELLA_CONS_LIST = ((Symbol)(Stella.internRigidSymbolWrtModule("CONS-LIST", Stella.getStellaModule("/STELLA", true), 0)));
      Logic.SYM_STELLA_QUOTE = ((Symbol)(Stella.internRigidSymbolWrtModule("QUOTE", Stella.getStellaModule("/STELLA", true), 0)));
      Logic.SYM_LOGIC_APPLY_CACHED_ASK = ((Symbol)(Stella.internRigidSymbolWrtModule("APPLY-CACHED-ASK", null, 0)));
      Logic.SYM_STELLA_$CONTEXT$ = ((Symbol)(Stella.internRigidSymbolWrtModule("*CONTEXT*", Stella.getStellaModule("/STELLA", true), 0)));
      Logic.SYM_LOGIC_GET_INFERENCE_CACHE = ((Symbol)(Stella.internRigidSymbolWrtModule("GET-INFERENCE-CACHE", null, 0)));
      Logic.SYM_STELLA_$MODULE$ = ((Symbol)(Stella.internRigidSymbolWrtModule("*MODULE*", Stella.getStellaModule("/STELLA", true), 0)));
      ...
      Logic.SYM_STELLA_OBJECT = ((Symbol)(Stella.internRigidSymbolWrtModule("OBJECT", Stella.getStellaModule("/STELLA", true), 0)));
      Logic.SYM_LOGIC_MISSING_ARGUMENT = ((Symbol)(Stella.internRigidSymbolWrtModule("MISSING-ARGUMENT", null, 0)));
      Logic.SYM_STELLA_INTEGER_WRAPPER = ((Symbol)(Stella.internRigidSymbolWrtModule("INTEGER-WRAPPER", Stella.getStellaModule("/STELLA", true), 0)));
      Logic.SYM_STELLA_CASE = ((Symbol)(Stella.internRigidSymbolWrtModule("CASE", Stella.getStellaModule("/STELLA", true), 0)));
      Logic.SYM_STELLA_WRAPPER_VALUE = ((Symbol)(Stella.internRigidSymbolWrtModule("WRAPPER-VALUE", Stella.getStellaModule("/STELLA", true), 0)));
      Logic.SYM_STELLA_BOOLEAN = ((Symbol)(Stella.internRigidSymbolWrtModule("BOOLEAN", Stella.getStellaModule("/STELLA", true), 0)));
      Logic.SYM_STELLA_X = ((Symbol)(Stella.internRigidSymbolWrtModule("X", Stella.getStellaModule("/STELLA", true), 0)));
      Logic.SYM_STELLA_NUMBER_WRAPPER = ((Symbol)(Stella.internRigidSymbolWrtModule("NUMBER-WRAPPER", Stella.getStellaModule("/STELLA", true), 0)));
      Logic.SYM_STELLA_Y = ((Symbol)(Stella.internRigidSymbolWrtModule("Y", Stella.getStellaModule("/STELLA", true), 0)));
      Logic.KWD_PUBLICp = ((Keyword)(Stella.internRigidSymbolWrtModule("PUBLIC?", null, 2)));
      Logic.SYM_STELLA_TYPECASE = ((Symbol)(Stella.internRigidSymbolWrtModule("TYPECASE", Stella.getStellaModule("/STELLA", true), 0)));
      Logic.SYM_STELLA_FLOAT_WRAPPER = ((Symbol)(Stella.internRigidSymbolWrtModule("FLOAT-WRAPPER", Stella.getStellaModule("/STELLA", true), 0)));
      Logic.SYM_STELLA_CAST = ((Symbol)(Stella.internRigidSymbolWrtModule("CAST", Stella.getStellaModule("/STELLA", true), 0)));
      Logic.SYM_STELLA_FLOAT = ((Symbol)(Stella.internRigidSymbolWrtModule("FLOAT", Stella.getStellaModule("/STELLA", true), 0)));
      Logic.SYM_LOGIC_FLOATRESULT = ((Symbol)(Stella.internRigidSymbolWrtModule("FLOATRESULT", null, 0)));
      Logic.SYM_STELLA_WRAP_LITERAL = ((Symbol)(Stella.internRigidSymbolWrtModule("WRAP-LITERAL", Stella.getStellaModule("/STELLA", true), 0)));
      Logic.SYM_STELLA_SAFE_CAST = ((Symbol)(Stella.internRigidSymbolWrtModule("SAFE-CAST", Stella.getStellaModule("/STELLA", true), 0)));
      Logic.SYM_STELLA_INTEGER = ((Symbol)(Stella.internRigidSymbolWrtModule("INTEGER", Stella.getStellaModule("/STELLA", true), 0)));
      Logic.SYM_STELLA_MODULE = ((Symbol)(Stella.internRigidSymbolWrtModule("MODULE", Stella.getStellaModule("/STELLA", true), 0)));
      Logic.SYM_STELLA_CONTEXT = ((Symbol)(Stella.internRigidSymbolWrtModule("CONTEXT", Stella.getStellaModule("/STELLA", true), 0)));
      Logic.SYM_STELLA_IGNORE = ((Symbol)(Stella.internRigidSymbolWrtModule("IGNORE", Stella.getStellaModule("/STELLA", true), 0)));
    }
  }
    ...
    { Object old$Module$000 = Stella.$MODULE$.get();
      ...
      try {
        ...
        if (Stella.currentStartupTimePhaseP(2)) {
          ...
          Logic.SYM_STELLA_WITH_PROCESS_LOCK = ((Symbol)(Stella.internRigidSymbolWrtModule("WITH-PROCESS-LOCK", Stella.getStellaModule("/STELLA", true), 0)));
          ...
          Logic.SYM_STELLA_METHOD_STARTUP_CLASSNAME = ((Symbol)(Stella.internRigidSymbolWrtModule("METHOD-STARTUP-CLASSNAME", Stella.getStellaModule("/STELLA", true), 0)));
        }
        if (Stella.currentStartupTimePhaseP(4)) {
          Logic.$SUPPRESSNONLOGICOBJECTWARNINGp$.setDefaultValue(new Boolean(true));
          Logic.$CYC_KLUDGES_ENABLEDp$ = false;
        }
