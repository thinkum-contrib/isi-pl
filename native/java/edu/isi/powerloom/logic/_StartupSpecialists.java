  ...
  static void helpStartupSpecialists1() {
    {
      ...
      Logic.SGT_PL_KERNEL_KB_RELATION_SPECIALIST = ((Surrogate)(Stella.internRigidSymbolWrtModule("RELATION-SPECIALIST", Stella.getStellaModule("/PL-KERNEL-KB", Stella.TRUE), 1)));
      Logic.SGT_PL_KERNEL_KB_HANDLES_REVERSE_POLARITY = ((Surrogate)(Stella.internRigidSymbolWrtModule("HANDLES-REVERSE-POLARITY", Stella.getStellaModule("/PL-KERNEL-KB", Stella.TRUE), 1)));
      Logic.SGT_PL_KERNEL_KB_RELATION_CONSTRAINT = ((Surrogate)(Stella.internRigidSymbolWrtModule("RELATION-CONSTRAINT", Stella.getStellaModule("/PL-KERNEL-KB", Stella.TRUE), 1)));
      Logic.SGT_PL_KERNEL_KB_RELATION_EVALUATOR = ((Surrogate)(Stella.internRigidSymbolWrtModule("RELATION-EVALUATOR", Stella.getStellaModule("/PL-KERNEL-KB", Stella.TRUE), 1)));
      Logic.SGT_STELLA_FUNCTION_CODE_WRAPPER = ((Surrogate)(Stella.internRigidSymbolWrtModule("FUNCTION-CODE-WRAPPER", Stella.getStellaModule("/STELLA", Stella.TRUE), 1)));
      Logic.SGT_STELLA_METHOD_CODE_WRAPPER = ((Surrogate)(Stella.internRigidSymbolWrtModule("METHOD-CODE-WRAPPER", Stella.getStellaModule("/STELLA", Stella.TRUE), 1)));
      ...
      Logic.SYM_STELLA_START = ((Symbol)(Stella.internRigidSymbolWrtModule("START", Stella.getStellaModule("/STELLA", Stella.TRUE), 0)));
      Logic.SYM_LOGIC_SUB_LENGTH = ((Symbol)(Stella.internRigidSymbolWrtModule("SUB-LENGTH", null, 0)));
      Logic.SYM_STELLA_DUMMY = ((Symbol)(Stella.internRigidSymbolWrtModule("DUMMY", Stella.getStellaModule("/STELLA", Stella.TRUE), 0)));
      ...
      Logic.SGT_LOGIC_CLOSED_TERMp_MEMO_TABLE_000 = ((Surrogate)(Stella.internRigidSymbolWrtModule("CLOSED-TERM?-MEMO-TABLE-000", null, 1)));
      Logic.SGT_LOGIC_CLOSED_PROPOSITIONp_MEMO_TABLE_000 = ((Surrogate)(Stella.internRigidSymbolWrtModule("CLOSED-PROPOSITION?-MEMO-TABLE-000", null, 1)));
      Logic.SGT_PL_KERNEL_KB_SINGLE_VALUED = ((Surrogate)(Stella.internRigidSymbolWrtModule("SINGLE-VALUED", Stella.getStellaModule("/PL-KERNEL-KB", Stella.TRUE), 1)));
      Logic.SGT_LOGIC_SINGLE_VALUED_TERMp_MEMO_TABLE_000 = ((Surrogate)(Stella.internRigidSymbolWrtModule("SINGLE-VALUED-TERM?-MEMO-TABLE-000", null, 1)));
      ...
      Logic.SYM_LOGIC_QUERY_072 = ((Symbol)(Stella.internRigidSymbolWrtModule("QUERY-072", null, 0)));
      Logic.SGT_PL_KERNEL_KB_MUTUALLY_DISJOINT_COLLECTION = ((Surrogate)(Stella.internRigidSymbolWrtModule("MUTUALLY-DISJOINT-COLLECTION", Stella.getStellaModule("/PL-KERNEL-KB", Stella.TRUE), 1)));
      Logic.SGT_PL_KERNEL_KB_PARTITION_MEMBERSHIP = ((Surrogate)(Stella.internRigidSymbolWrtModule("PARTITION-MEMBERSHIP", Stella.getStellaModule("/PL-KERNEL-KB", Stella.TRUE), 1)));
      Logic.SGT_PL_KERNEL_KB_HAS_PARTITION_MEMBERSHIP = ((Surrogate)(Stella.internRigidSymbolWrtModule("HAS-PARTITION-MEMBERSHIP", Stella.getStellaModule("/PL-KERNEL-KB", Stella.TRUE), 1)));
      Logic.SGT_PL_KERNEL_KB_EMPTY = ((Surrogate)(Stella.internRigidSymbolWrtModule("EMPTY", Stella.getStellaModule("/PL-KERNEL-KB", Stella.TRUE), 1)));
      ...
      Logic.SGT_PL_KERNEL_KB_THE_ROLESET = ((Surrogate)(Stella.internRigidSymbolWrtModule("THE-ROLESET", Stella.getStellaModule("/PL-KERNEL-KB", Stella.TRUE), 1)));
      Logic.SGT_PL_KERNEL_KB_CARDINALITY = ((Surrogate)(Stella.internRigidSymbolWrtModule("CARDINALITY", Stella.getStellaModule("/PL-KERNEL-KB", Stella.TRUE), 1)));
      ...
      Logic.SGT_PL_KERNEL_KB_DIRECT_SUBRELATION = ((Surrogate)(Stella.internRigidSymbolWrtModule("DIRECT-SUBRELATION", Stella.getStellaModule("/PL-KERNEL-KB", Stella.TRUE), 1)));
      Logic.SGT_PL_KERNEL_KB_DIRECT_SUPERRELATION = ((Surrogate)(Stella.internRigidSymbolWrtModule("DIRECT-SUPERRELATION", Stella.getStellaModule("/PL-KERNEL-KB", Stella.TRUE), 1)));
      Logic.SGT_PL_KERNEL_KB_SUBRELATION = ((Surrogate)(Stella.internRigidSymbolWrtModule("SUBRELATION", Stella.getStellaModule("/PL-KERNEL-KB", Stella.TRUE), 1)));
      Logic.SGT_PL_KERNEL_KB_SUPERRELATION = ((Surrogate)(Stella.internRigidSymbolWrtModule("SUPERRELATION", Stella.getStellaModule("/PL-KERNEL-KB", Stella.TRUE), 1)));
      Logic.SGT_PL_KERNEL_KB_PROPER_SUBRELATION = ((Surrogate)(Stella.internRigidSymbolWrtModule("PROPER-SUBRELATION", Stella.getStellaModule("/PL-KERNEL-KB", Stella.TRUE), 1)));
      Logic.SGT_PL_KERNEL_KB_PROPER_SUPERRELATION = ((Surrogate)(Stella.internRigidSymbolWrtModule("PROPER-SUPERRELATION", Stella.getStellaModule("/PL-KERNEL-KB", Stella.TRUE), 1)));
      Logic.SGT_PL_KERNEL_KB_EQUIVALENT_RELATION = ((Surrogate)(Stella.internRigidSymbolWrtModule("EQUIVALENT-RELATION", Stella.getStellaModule("/PL-KERNEL-KB", Stella.TRUE), 1)));
      Logic.SGT_PL_KERNEL_KB_SYNONYM = ((Surrogate)(Stella.internRigidSymbolWrtModule("SYNONYM", Stella.getStellaModule("/PL-KERNEL-KB", Stella.TRUE), 1)));
    ...
    { Object old$Module$000 = Stella.$MODULE$.get();
      ...
      try {
        ...
        if (Stella.currentStartupTimePhaseP(4)) {
          Logic.$ACCELERATE_FRAME_COMPUTATIONSp$ = Stella.TRUE;
        }
