  ...
  static void helpStartupSpecialize1() {
    {
      ...
      Logic.SGT_LOGIC_TEST_PROPERTYp_MEMO_TABLE_000 = ((Surrogate)(Stella.internRigidSymbolWrtModule("TEST-PROPERTY?-MEMO-TABLE-000", null, 1)));
      Logic.SGT_PL_KERNEL_KB_COLLECTION = ((Surrogate)(Stella.internRigidSymbolWrtModule("COLLECTION", Stella.getStellaModule("/PL-KERNEL-KB", Stella.TRUE), 1)));
      Logic.SGT_LOGIC_TEST_ISAp_MEMO_TABLE_000 = ((Surrogate)(Stella.internRigidSymbolWrtModule("TEST-ISA?-MEMO-TABLE-000", null, 1)));
      Logic.SGT_LOGIC_TEST_ISAp_MEMO_TABLE_001 = ((Surrogate)(Stella.internRigidSymbolWrtModule("TEST-ISA?-MEMO-TABLE-001", null, 1)));
      Logic.SGT_LOGIC_ACCESS_BINARY_VALUE_MEMO_TABLE_000 = ((Surrogate)(Stella.internRigidSymbolWrtModule("ACCESS-BINARY-VALUE-MEMO-TABLE-000", null, 1)));
      ...
      Logic.SGT_LOGIC_ALL_SUPERCOLLECTIONS_MEMO_TABLE_000 = ((Surrogate)(Stella.internRigidSymbolWrtModule("ALL-SUPERCOLLECTIONS-MEMO-TABLE-000", null, 1)));
      Logic.SGT_LOGIC_ALL_SUPPORTED_NAMED_SUBCOLLECTIONS_MEMO_TABLE_000 = ((Surrogate)(Stella.internRigidSymbolWrtModule("ALL-SUPPORTED-NAMED-SUBCOLLECTIONS-MEMO-TABLE-000", null, 1)));
      Logic.SGT_STELLA_NUMBER = ((Surrogate)(Stella.internRigidSymbolWrtModule("NUMBER", Stella.getStellaModule("/STELLA", Stella.TRUE), 1)));
      ...
      Logic.SYM_STELLA_TAXONOMY_NODE = ((Symbol)(Stella.internRigidSymbolWrtModule("TAXONOMY-NODE", Stella.getStellaModule("/STELLA", Stella.TRUE), 0)));
  ...
  static void helpStartupSpecialize3() {
    {
      ...
      { MethodSlot function = Symbol.lookupFunction(Logic.SYM_LOGIC_STARTUP_SPECIALIZE);
        ...
        KeyValueList.setDynamicSlotValue(function.dynamicSlots, Logic.SYM_STELLA_METHOD_STARTUP_CLASSNAME, Stella.wrapString("_Startup-Specialize"), Stella.NULL_STRING_WRAPPER);
      }
    }
  }
