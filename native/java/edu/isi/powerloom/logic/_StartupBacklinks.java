  ...
  static void helpStartupBacklinks1() {
    {
      ...
      Logic.SGT_STELLA_STRING = ((Surrogate)(Stella.internRigidSymbolWrtModule("STRING", Stella.getStellaModule("/STELLA", Stella.TRUE), 1)));
  ...
  static void helpStartupBacklinks2() {
    {
      ...
      Stella.defineFunctionObject("FIND-SELECTION-KEY-WITH-EQUIVALENTS", "(DEFUN (FIND-SELECTION-KEY-WITH-EQUIVALENTS LOGIC-OBJECT) ((PATTERN SELECTION-PATTERN)))", Native.find_java_method("edu.isi.powerloom.logic.Logic", "findSelectionKeyWithEquivalents", new java.lang.Class [] {Native.find_java_class("edu.isi.stella.Cons")}), null);
    ...
    { Object old$Module$000 = Stella.$MODULE$.get();
      ...
      try {
        ...
        if (Stella.currentStartupTimePhaseP(4)) {
          ...
          Logic.$BACKLINK_ALL_PROPOSITION_ARGUMENTSp$ = Stella.FALSE;
          Logic.$SUPPRESSINSERTIONINTOCLASSEXTENSIONp$.setDefaultValue(new Boolean(Stella.FALSE));
        }
        ...
        if (Stella.currentStartupTimePhaseP(7)) {
          ...
          { MethodSlot function = Symbol.lookupFunction(Logic.SYM_LOGIC_STARTUP_BACKLINKS);
            ...
            KeyValueList.setDynamicSlotValue(function.dynamicSlots, Logic.SYM_STELLA_METHOD_STARTUP_CLASSNAME, Stella.wrapString("_Startup-Backlinks"), Stella.NULL_STRING_WRAPPER);
          }
        }
