  ...
  static void helpStartupKifIn1() {
    {
      ...
      Logic.SGT_STELLA_CONS = ((Surrogate)(Stella.internRigidSymbolWrtModule("CONS", Stella.getStellaModule("/STELLA", Stella.TRUE), 1)));
      Logic.SYM_STELLA_ISA = ((Symbol)(Stella.internRigidSymbolWrtModule("ISA", Stella.getStellaModule("/STELLA", Stella.TRUE), 0)));
      ...
      Logic.SYM_STELLA_e = ((Symbol)(Stella.internRigidSymbolWrtModule("=", Stella.getStellaModule("/STELLA", Stella.TRUE), 0)));
      Logic.SYM_STELLA_OR = ((Symbol)(Stella.internRigidSymbolWrtModule("OR", Stella.getStellaModule("/STELLA", Stella.TRUE), 0)));
      Logic.SYM_STELLA_eg = ((Symbol)(Stella.internRigidSymbolWrtModule("=>", Stella.getStellaModule("/STELLA", Stella.TRUE), 0)));
      ...
      Logic.SYM_STELLA_EXISTS = ((Symbol)(Stella.internRigidSymbolWrtModule("EXISTS", Stella.getStellaModule("/STELLA", Stella.TRUE), 0)));
      Logic.SYM_STELLA_FORALL = ((Symbol)(Stella.internRigidSymbolWrtModule("FORALL", Stella.getStellaModule("/STELLA", Stella.TRUE), 0)));
      Logic.SYM_LOGIC_ABOUT = ((Symbol)(Stella.internRigidSymbolWrtModule("ABOUT", null, 0)));
      Logic.SYM_PL_KERNEL_KB_VALUE = ((Symbol)(Stella.internRigidSymbolWrtModule("VALUE", Stella.getStellaModule("/PL-KERNEL-KB", Stella.TRUE), 0)));
      ...
      Logic.SYM_PL_KERNEL_KB_HOLDS = ((Symbol)(Stella.internRigidSymbolWrtModule("HOLDS", Stella.getStellaModule("/PL-KERNEL-KB", Stella.TRUE), 0)));
      ...
      Logic.SYM_STELLA_SETOF = ((Symbol)(Stella.internRigidSymbolWrtModule("SETOF", Stella.getStellaModule("/STELLA", Stella.TRUE), 0)));
      Logic.SYM_LOGIC_LISTOF = ((Symbol)(Stella.internRigidSymbolWrtModule("LISTOF", null, 0)));
      Logic.SYM_STELLA_WHERE = ((Symbol)(Stella.internRigidSymbolWrtModule("WHERE", Stella.getStellaModule("/STELLA", Stella.TRUE), 0)));
      Logic.SYM_STELLA_ALWAYS = ((Symbol)(Stella.internRigidSymbolWrtModule("ALWAYS", Stella.getStellaModule("/STELLA", Stella.TRUE), 0)));
      ...
      try {
        ...
        if (Stella.currentStartupTimePhaseP(7)) {
          ...
          { MethodSlot function = Symbol.lookupFunction(Logic.SYM_LOGIC_STARTUP_KIF_IN);
            ...
            KeyValueList.setDynamicSlotValue(function.dynamicSlots, Logic.SYM_STELLA_METHOD_STARTUP_CLASSNAME, Stella.wrapString("_Startup-Kif-In"), Stella.NULL_STRING_WRAPPER);
          }
        }
