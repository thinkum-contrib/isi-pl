...
public class UnificationClash extends Clash {
  ...
  public UnificationClash (String message) {
    super(message);
  }

  public static UnificationClash newUnificationClash(String message) {
