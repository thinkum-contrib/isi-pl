...
public class _StartupPropositions {
  static void helpStartupPropositions1() {
    {
      Logic.SYM_LOGIC_PROPOSITIONS_INDEX = ((Symbol)(Stella.internRigidSymbolWrtModule("PROPOSITIONS-INDEX", null, 0)));
      Logic.SYM_LOGIC_INSTANCES_INDEX = ((Symbol)(Stella.internRigidSymbolWrtModule("INSTANCES-INDEX", null, 0)));
      Logic.SGT_LOGIC_BACKLINKS_INDEX = ((Surrogate)(Stella.internRigidSymbolWrtModule("BACKLINKS-INDEX", null, 1)));
      Logic.SYM_LOGIC_DEPENDENT_PROPOSITIONS_LIST = ((Symbol)(Stella.internRigidSymbolWrtModule("DEPENDENT-PROPOSITIONS-LIST", null, 0)));
      Logic.SYM_LOGIC_DEPENDENT_ISA_PROPOSITIONS_LIST = ((Symbol)(Stella.internRigidSymbolWrtModule("DEPENDENT-ISA-PROPOSITIONS-LIST", null, 0)));
      Logic.SYM_LOGIC_PREDICATE_PROPOSITIONS_TABLE = ((Symbol)(Stella.internRigidSymbolWrtModule("PREDICATE-PROPOSITIONS-TABLE", null, 0)));
      Logic.SGT_LOGIC_LOGIC_OBJECT = ((Surrogate)(Stella.internRigidSymbolWrtModule("LOGIC-OBJECT", null, 1)));
      Logic.SYM_LOGIC_DEPENDENT_DESCRIPTIONS = ((Symbol)(Stella.internRigidSymbolWrtModule("DEPENDENT-DESCRIPTIONS", null, 0)));
      Logic.SYM_STELLA_BADp = ((Symbol)(Stella.internRigidSymbolWrtModule("BAD?", Stella.getStellaModule("/STELLA", Stella.TRUE), 0)));
      Logic.SYM_LOGIC_VARIABLE_VALUE_INVERSE = ((Symbol)(Stella.internRigidSymbolWrtModule("VARIABLE-VALUE-INVERSE", null, 0)));
      Logic.SYM_STELLA_SURROGATE_VALUE_INVERSE = ((Symbol)(Stella.internRigidSymbolWrtModule("SURROGATE-VALUE-INVERSE", Stella.getStellaModule("/STELLA", Stella.TRUE), 0)));
      Logic.SYM_LOGIC_OBJECT_STRINGIFIED_SOURCE = ((Symbol)(Stella.internRigidSymbolWrtModule("OBJECT-STRINGIFIED-SOURCE", null, 0)));
      Logic.SYM_LOGIC_OBJECT_ORIGINATED_PROPOSITIONS = ((Symbol)(Stella.internRigidSymbolWrtModule("OBJECT-ORIGINATED-PROPOSITIONS", null, 0)));
      Logic.SGT_STELLA_CS_VALUE = ((Surrogate)(Stella.internRigidSymbolWrtModule("CS-VALUE", Stella.getStellaModule("/STELLA", Stella.TRUE), 1)));
      Logic.SYM_STELLA_DELETED_OBJECTp = ((Symbol)(Stella.internRigidSymbolWrtModule("DELETED-OBJECT?", Stella.getStellaModule("/STELLA", Stella.TRUE), 0)));
      Logic.SGT_LOGIC_LOGIC_THING = ((Surrogate)(Stella.internRigidSymbolWrtModule("LOGIC-THING", null, 1)));
      Logic.SGT_LOGIC_PATTERN_VARIABLE = ((Surrogate)(Stella.internRigidSymbolWrtModule("PATTERN-VARIABLE", null, 1)));
      Logic.SGT_LOGIC_SKOLEM = ((Surrogate)(Stella.internRigidSymbolWrtModule("SKOLEM", null, 1)));
      Logic.SYM_LOGIC_SKOLEM_TYPE = ((Symbol)(Stella.internRigidSymbolWrtModule("SKOLEM-TYPE", null, 0)));
      Logic.SYM_LOGIC_SKOLEM_NAME = ((Symbol)(Stella.internRigidSymbolWrtModule("SKOLEM-NAME", null, 0)));
      Logic.SYM_LOGIC_VARIABLE_VALUE = ((Symbol)(Stella.internRigidSymbolWrtModule("VARIABLE-VALUE", null, 0)));
      Logic.SYM_LOGIC_DEFINING_PROPOSITION = ((Symbol)(Stella.internRigidSymbolWrtModule("DEFINING-PROPOSITION", null, 0)));
      Logic.SYM_LOGIC_BOUND_TO_OFFSET = ((Symbol)(Stella.internRigidSymbolWrtModule("BOUND-TO-OFFSET", null, 0)));
      Logic.SYM_STELLA_VARIABLE_NAME = ((Symbol)(Stella.internRigidSymbolWrtModule("VARIABLE-NAME", Stella.getStellaModule("/STELLA", Stella.TRUE), 0)));
      Logic.SYM_LOGIC_OBJECT_VECTOR = ((Symbol)(Stella.internRigidSymbolWrtModule("OBJECT-VECTOR", null, 0)));
      Logic.SYM_LOGIC_ARGUMENTS_VECTOR = ((Symbol)(Stella.internRigidSymbolWrtModule("ARGUMENTS-VECTOR", null, 0)));
      Logic.SYM_LOGIC_VARIABLES_VECTOR = ((Symbol)(Stella.internRigidSymbolWrtModule("VARIABLES-VECTOR", null, 0)));
      Logic.SGT_LOGIC_FORWARD_CHAINING_INDEX = ((Surrogate)(Stella.internRigidSymbolWrtModule("FORWARD-CHAINING-INDEX", null, 1)));
      Logic.SYM_LOGIC_FORWARD_GOAL = ((Symbol)(Stella.internRigidSymbolWrtModule("FORWARD-GOAL", null, 0)));
      Logic.SYM_LOGIC_MASTER_RULE = ((Symbol)(Stella.internRigidSymbolWrtModule("MASTER-RULE", null, 0)));
      Logic.SYM_LOGIC_IO_VARIABLES = ((Symbol)(Stella.internRigidSymbolWrtModule("IO-VARIABLES", null, 0)));
      Logic.SYM_LOGIC_QUERY_BODY = ((Symbol)(Stella.internRigidSymbolWrtModule("QUERY-BODY", null, 0)));
      Logic.SYM_LOGIC_INPUT_BINDINGS = ((Symbol)(Stella.internRigidSymbolWrtModule("INPUT-BINDINGS", null, 0)));
      Logic.SYM_LOGIC_CACHE_ID = ((Symbol)(Stella.internRigidSymbolWrtModule("CACHE-ID", null, 0)));
      Logic.SYM_LOGIC_CONSEQUENT = ((Symbol)(Stella.internRigidSymbolWrtModule("CONSEQUENT", null, 0)));
      Logic.SGT_LOGIC_DESCRIPTION = ((Surrogate)(Stella.internRigidSymbolWrtModule("DESCRIPTION", null, 1)));
      Logic.SYM_LOGIC_FORWARD_CHAINING_INDICES = ((Symbol)(Stella.internRigidSymbolWrtModule("FORWARD-CHAINING-INDICES", null, 0)));
      Logic.SYM_LOGIC_DEFERRED_CONTRAPOSITIVESp = ((Symbol)(Stella.internRigidSymbolWrtModule("DEFERRED-CONTRAPOSITIVES?", null, 0)));
      Logic.SYM_LOGIC_INTERNAL_VARIABLES = ((Symbol)(Stella.internRigidSymbolWrtModule("INTERNAL-VARIABLES", null, 0)));
      Logic.SYM_LOGIC_QUERY_PATTERNS = ((Symbol)(Stella.internRigidSymbolWrtModule("QUERY-PATTERNS", null, 0)));
      Logic.SYM_LOGIC_RELATIVE_COMPLEMENT = ((Symbol)(Stella.internRigidSymbolWrtModule("RELATIVE-COMPLEMENT", null, 0)));
      Logic.SYM_LOGIC_COMPLEMENT_DESCRIPTION = ((Symbol)(Stella.internRigidSymbolWrtModule("COMPLEMENT-DESCRIPTION", null, 0)));
      Logic.SGT_LOGIC_NAMED_DESCRIPTION = ((Surrogate)(Stella.internRigidSymbolWrtModule("NAMED-DESCRIPTION", null, 1)));
      Logic.SYM_LOGIC_NATIVE_RELATION_BACK_POINTER = ((Symbol)(Stella.internRigidSymbolWrtModule("NATIVE-RELATION-BACK-POINTER", null, 0)));
      Logic.SYM_LOGIC_IO_VARIABLE_NAMES = ((Symbol)(Stella.internRigidSymbolWrtModule("IO-VARIABLE-NAMES", null, 0)));
      Logic.SYM_LOGIC_IO_VARIABLE_TYPES = ((Symbol)(Stella.internRigidSymbolWrtModule("IO-VARIABLE-TYPES", null, 0)));
      Logic.SYM_STELLA_EXTENSION = ((Symbol)(Stella.internRigidSymbolWrtModule("EXTENSION", Stella.getStellaModule("/STELLA", Stella.TRUE), 0)));
      Logic.SYM_LOGIC_PARTIAL_MATCH_SCORE = ((Symbol)(Stella.internRigidSymbolWrtModule("PARTIAL-MATCH-SCORE", null, 0)));
      Logic.SYM_LOGIC_SET_OF_SUPPORT = ((Symbol)(Stella.internRigidSymbolWrtModule("SET-OF-SUPPORT", null, 0)));
      Logic.SYM_LOGIC_TIMESTAMP = ((Symbol)(Stella.internRigidSymbolWrtModule("TIMESTAMP", null, 0)));
      Logic.SGT_LOGIC_TRUTH_VALUE = ((Surrogate)(Stella.internRigidSymbolWrtModule("TRUTH-VALUE", null, 1)));
      Logic.SYM_LOGIC_POSITIVE_SCORE = ((Symbol)(Stella.internRigidSymbolWrtModule("POSITIVE-SCORE", null, 0)));
      Logic.SGT_LOGIC_PARTIAL_SUPPORT = ((Surrogate)(Stella.internRigidSymbolWrtModule("PARTIAL-SUPPORT", null, 1)));
      Logic.SYM_LOGIC_FACT = ((Symbol)(Stella.internRigidSymbolWrtModule("FACT", null, 0)));
      Logic.SYM_LOGIC_AXIOM = ((Symbol)(Stella.internRigidSymbolWrtModule("AXIOM", null, 0)));
      Logic.SYM_LOGIC_SCORE = ((Symbol)(Stella.internRigidSymbolWrtModule("SCORE", null, 0)));
      Logic.SYM_LOGIC_ID = ((Symbol)(Stella.internRigidSymbolWrtModule("ID", null, 0)));
      Logic.SYM_LOGIC_ARGUMENT_SCORES = ((Symbol)(Stella.internRigidSymbolWrtModule("ARGUMENT-SCORES", null, 0)));
      Logic.SGT_LOGIC_PROPOSITION = ((Surrogate)(Stella.internRigidSymbolWrtModule("PROPOSITION", null, 1)));
      Logic.SYM_LOGIC_VARIABLE_TYPEp = ((Symbol)(Stella.internRigidSymbolWrtModule("VARIABLE-TYPE?", null, 0)));
    }
  }

  static void helpStartupPropositions2() {
    {
      Logic.SYM_LOGIC_SATELLITE_PROPOSITIONS = ((Symbol)(Stella.internRigidSymbolWrtModule("SATELLITE-PROPOSITIONS", null, 0)));
      Logic.SYM_LOGIC_UNFASTENEDp = ((Symbol)(Stella.internRigidSymbolWrtModule("UNFASTENED?", null, 0)));
      Logic.SYM_LOGIC_WEIGHT_DELTA = ((Symbol)(Stella.internRigidSymbolWrtModule("WEIGHT-DELTA", null, 0)));
      Logic.SYM_LOGIC_SUPPORT = ((Symbol)(Stella.internRigidSymbolWrtModule("SUPPORT", null, 0)));
      Logic.SYM_LOGIC_KIND = ((Symbol)(Stella.internRigidSymbolWrtModule("KIND", null, 0)));
      Logic.SYM_STELLA_OPERATOR = ((Symbol)(Stella.internRigidSymbolWrtModule("OPERATOR", Stella.getStellaModule("/STELLA", Stella.TRUE), 0)));
      Logic.SYM_LOGIC_RELATIONREF = ((Symbol)(Stella.internRigidSymbolWrtModule("RELATIONREF", null, 0)));
      Logic.SYM_LOGIC_DEPENDENT_PROPOSITIONS = ((Symbol)(Stella.internRigidSymbolWrtModule("DEPENDENT-PROPOSITIONS", null, 0)));
      Logic.SYM_LOGIC_PROPOSITION_ORIGINATED_PROPOSITIONS = ((Symbol)(Stella.internRigidSymbolWrtModule("PROPOSITION-ORIGINATED-PROPOSITIONS", null, 0)));
      Logic.SYM_LOGIC_PROPOSITION_STRINGIFIED_SOURCE = ((Symbol)(Stella.internRigidSymbolWrtModule("PROPOSITION-STRINGIFIED-SOURCE", null, 0)));
      Logic.SGT_LOGIC_INTEGER_LOGIC_WRAPPER = ((Surrogate)(Stella.internRigidSymbolWrtModule("INTEGER-LOGIC-WRAPPER", null, 1)));
      Logic.SGT_LOGIC_FLOAT_LOGIC_WRAPPER = ((Surrogate)(Stella.internRigidSymbolWrtModule("FLOAT-LOGIC-WRAPPER", null, 1)));
      Logic.SGT_LOGIC_STRING_LOGIC_WRAPPER = ((Surrogate)(Stella.internRigidSymbolWrtModule("STRING-LOGIC-WRAPPER", null, 1)));
      Logic.KWD_AND = ((Keyword)(Stella.internRigidSymbolWrtModule("AND", null, 2)));
      Logic.SGT_PL_KERNEL_KB_AND = ((Surrogate)(Stella.internRigidSymbolWrtModule("AND", Stella.getStellaModule("/PL-KERNEL-KB", Stella.TRUE), 1)));
      Logic.KWD_OR = ((Keyword)(Stella.internRigidSymbolWrtModule("OR", null, 2)));
      Logic.SGT_PL_KERNEL_KB_OR = ((Surrogate)(Stella.internRigidSymbolWrtModule("OR", Stella.getStellaModule("/PL-KERNEL-KB", Stella.TRUE), 1)));
      Logic.KWD_NOT = ((Keyword)(Stella.internRigidSymbolWrtModule("NOT", null, 2)));
      Logic.SGT_PL_KERNEL_KB_NOT = ((Surrogate)(Stella.internRigidSymbolWrtModule("NOT", Stella.getStellaModule("/PL-KERNEL-KB", Stella.TRUE), 1)));
      Logic.KWD_FORALL = ((Keyword)(Stella.internRigidSymbolWrtModule("FORALL", null, 2)));
      Logic.SGT_PL_KERNEL_KB_FORALL = ((Surrogate)(Stella.internRigidSymbolWrtModule("FORALL", Stella.getStellaModule("/PL-KERNEL-KB", Stella.TRUE), 1)));
      Logic.KWD_EXISTS = ((Keyword)(Stella.internRigidSymbolWrtModule("EXISTS", null, 2)));
      Logic.SGT_PL_KERNEL_KB_EXISTS = ((Surrogate)(Stella.internRigidSymbolWrtModule("EXISTS", Stella.getStellaModule("/PL-KERNEL-KB", Stella.TRUE), 1)));
      Logic.KWD_EQUIVALENT = ((Keyword)(Stella.internRigidSymbolWrtModule("EQUIVALENT", null, 2)));
      Logic.SGT_PL_KERNEL_KB_EQUIVALENT = ((Surrogate)(Stella.internRigidSymbolWrtModule("EQUIVALENT", Stella.getStellaModule("/PL-KERNEL-KB", Stella.TRUE), 1)));
      Logic.KWD_FAIL = ((Keyword)(Stella.internRigidSymbolWrtModule("FAIL", null, 2)));
      Logic.SGT_PL_KERNEL_KB_FAIL = ((Surrogate)(Stella.internRigidSymbolWrtModule("FAIL", Stella.getStellaModule("/PL-KERNEL-KB", Stella.TRUE), 1)));
      Logic.KWD_COLLECT_INTO = ((Keyword)(Stella.internRigidSymbolWrtModule("COLLECT-INTO", null, 2)));
      Logic.SGT_PL_KERNEL_KB_COLLECT_INTO = ((Surrogate)(Stella.internRigidSymbolWrtModule("COLLECT-INTO", Stella.getStellaModule("/PL-KERNEL-KB", Stella.TRUE), 1)));
      Logic.KWD_IMPLIES = ((Keyword)(Stella.internRigidSymbolWrtModule("IMPLIES", null, 2)));
      Logic.SGT_PL_KERNEL_KB_SUBSET_OF = ((Surrogate)(Stella.internRigidSymbolWrtModule("SUBSET-OF", Stella.getStellaModule("/PL-KERNEL-KB", Stella.TRUE), 1)));
      Logic.SYM_STELLA_FUNCTION = ((Symbol)(Stella.internRigidSymbolWrtModule("FUNCTION", Stella.getStellaModule("/STELLA", Stella.TRUE), 0)));
      Logic.SYM_STELLA_PREDICATE = ((Symbol)(Stella.internRigidSymbolWrtModule("PREDICATE", Stella.getStellaModule("/STELLA", Stella.TRUE), 0)));
      Logic.SYM_LOGIC_DESCRIPTIVEp = ((Symbol)(Stella.internRigidSymbolWrtModule("DESCRIPTIVE?", null, 0)));
      Logic.SYM_STELLA_CODE_ONLYp = ((Symbol)(Stella.internRigidSymbolWrtModule("CODE-ONLY?", Stella.getStellaModule("/STELLA", Stella.TRUE), 0)));
      Logic.SYM_LOGIC_LOCALLY_CONCEIVED_PROPOSITIONS_INTERNAL = ((Symbol)(Stella.internRigidSymbolWrtModule("LOCALLY-CONCEIVED-PROPOSITIONS-INTERNAL", null, 0)));
      Logic.KWD_CONTEXT_PROPOSITIONS = ((Keyword)(Stella.internRigidSymbolWrtModule("CONTEXT-PROPOSITIONS", null, 2)));
      Logic.SYM_LOGIC_LOCALLY_CONCEIVED_INSTANCES_INTERNAL = ((Symbol)(Stella.internRigidSymbolWrtModule("LOCALLY-CONCEIVED-INSTANCES-INTERNAL", null, 0)));
      Logic.KWD_CONTEXT_INSTANCES = ((Keyword)(Stella.internRigidSymbolWrtModule("CONTEXT-INSTANCES", null, 2)));
      Logic.KWD_UPDATE_PROPOSITION = ((Keyword)(Stella.internRigidSymbolWrtModule("UPDATE-PROPOSITION", null, 2)));
      Logic.KWD_EXECUTE_QUERY = ((Keyword)(Stella.internRigidSymbolWrtModule("EXECUTE-QUERY", null, 2)));
      Logic.SYM_LOGIC_BOTTOM = ((Symbol)(Stella.internRigidSymbolWrtModule("BOTTOM", null, 0)));
      Logic.SGT_STELLA_LITERAL = ((Surrogate)(Stella.internRigidSymbolWrtModule("LITERAL", Stella.getStellaModule("/STELLA", Stella.TRUE), 1)));
      Logic.SGT_LOGIC_LOGICAL_SUBTYPE_OF_LITERALp_MEMO_TABLE_000 = ((Surrogate)(Stella.internRigidSymbolWrtModule("LOGICAL-SUBTYPE-OF-LITERAL?-MEMO-TABLE-000", null, 1)));
      Logic.SGT_STELLA_CLASS = ((Surrogate)(Stella.internRigidSymbolWrtModule("CLASS", Stella.getStellaModule("/STELLA", Stella.TRUE), 1)));
      Logic.SGT_STELLA_LITERAL_WRAPPER = ((Surrogate)(Stella.internRigidSymbolWrtModule("LITERAL-WRAPPER", Stella.getStellaModule("/STELLA", Stella.TRUE), 1)));
      Logic.SGT_STELLA_BOOLEAN = ((Surrogate)(Stella.internRigidSymbolWrtModule("BOOLEAN", Stella.getStellaModule("/STELLA", Stella.TRUE), 1)));
      Logic.SGT_STELLA_BOOLEAN_WRAPPER = ((Surrogate)(Stella.internRigidSymbolWrtModule("BOOLEAN-WRAPPER", Stella.getStellaModule("/STELLA", Stella.TRUE), 1)));
      Logic.SGT_PL_KERNEL_KB_VARIABLE_ARITY = ((Surrogate)(Stella.internRigidSymbolWrtModule("VARIABLE-ARITY", Stella.getStellaModule("/PL-KERNEL-KB", Stella.TRUE), 1)));
      Logic.SGT_STELLA_COLLECTION = ((Surrogate)(Stella.internRigidSymbolWrtModule("COLLECTION", Stella.getStellaModule("/STELLA", Stella.TRUE), 1)));
      Logic.SGT_PL_KERNEL_KB_RELATION_COMPUTATION = ((Surrogate)(Stella.internRigidSymbolWrtModule("RELATION-COMPUTATION", Stella.getStellaModule("/PL-KERNEL-KB", Stella.TRUE), 1)));
      Logic.SGT_STELLA_THING = ((Surrogate)(Stella.internRigidSymbolWrtModule("THING", Stella.getStellaModule("/STELLA", Stella.TRUE), 1)));
      Logic.KWD_EXTENSIONAL_ASSERTION = ((Keyword)(Stella.internRigidSymbolWrtModule("EXTENSIONAL-ASSERTION", null, 2)));
      Logic.KWD_DESCRIPTION = ((Keyword)(Stella.internRigidSymbolWrtModule("DESCRIPTION", null, 2)));
      Logic.KWD_RETRACT_TRUE = ((Keyword)(Stella.internRigidSymbolWrtModule("RETRACT-TRUE", null, 2)));
      Logic.KWD_FUNCTION = ((Keyword)(Stella.internRigidSymbolWrtModule("FUNCTION", null, 2)));
      Logic.KWD_ISA = ((Keyword)(Stella.internRigidSymbolWrtModule("ISA", null, 2)));
      Logic.SGT_PL_KERNEL_KB_GOES_TRUE_DEMON = ((Surrogate)(Stella.internRigidSymbolWrtModule("GOES-TRUE-DEMON", Stella.getStellaModule("/PL-KERNEL-KB", Stella.TRUE), 1)));
      Logic.KWD_PREDICATE = ((Keyword)(Stella.internRigidSymbolWrtModule("PREDICATE", null, 2)));
      Logic.SGT_PL_KERNEL_KB_GOES_FALSE_DEMON = ((Surrogate)(Stella.internRigidSymbolWrtModule("GOES-FALSE-DEMON", Stella.getStellaModule("/PL-KERNEL-KB", Stella.TRUE), 1)));
    }
  }

  static void helpStartupPropositions3() {
    {
      Logic.SGT_PL_KERNEL_KB_GOES_UNKNOWN_DEMON = ((Surrogate)(Stella.internRigidSymbolWrtModule("GOES-UNKNOWN-DEMON", Stella.getStellaModule("/PL-KERNEL-KB", Stella.TRUE), 1)));
      Logic.SYM_LOGIC_MASTER_PROPOSITION = ((Symbol)(Stella.internRigidSymbolWrtModule("MASTER-PROPOSITION", null, 0)));
      Logic.KWD_ASSERT_TRUE = ((Keyword)(Stella.internRigidSymbolWrtModule("ASSERT-TRUE", null, 2)));
      Logic.KWD_PRESUME_TRUE = ((Keyword)(Stella.internRigidSymbolWrtModule("PRESUME-TRUE", null, 2)));
      Logic.KWD_ASSERT_FALSE = ((Keyword)(Stella.internRigidSymbolWrtModule("ASSERT-FALSE", null, 2)));
      Logic.KWD_PRESUME_FALSE = ((Keyword)(Stella.internRigidSymbolWrtModule("PRESUME-FALSE", null, 2)));
      Logic.KWD_RETRACT_FALSE = ((Keyword)(Stella.internRigidSymbolWrtModule("RETRACT-FALSE", null, 2)));
      Logic.KWD_CONSTANT = ((Keyword)(Stella.internRigidSymbolWrtModule("CONSTANT", null, 2)));
      Logic.KWD_ASSERT = ((Keyword)(Stella.internRigidSymbolWrtModule("ASSERT", null, 2)));
      Logic.KWD_RETRACT = ((Keyword)(Stella.internRigidSymbolWrtModule("RETRACT", null, 2)));
      Logic.KWD_CONCEIVE = ((Keyword)(Stella.internRigidSymbolWrtModule("CONCEIVE", null, 2)));
      Logic.SGT_PL_KERNEL_KB_HIDDEN_RELATION = ((Surrogate)(Stella.internRigidSymbolWrtModule("HIDDEN-RELATION", Stella.getStellaModule("/PL-KERNEL-KB", Stella.TRUE), 1)));
      Logic.SGT_LOGIC_HIDDEN_INSTANCE = ((Surrogate)(Stella.internRigidSymbolWrtModule("HIDDEN-INSTANCE", null, 1)));
      Logic.KWD_KB_UPDATE = ((Keyword)(Stella.internRigidSymbolWrtModule("KB-UPDATE", null, 2)));
      Logic.KWD_META_KB_UPDATE = ((Keyword)(Stella.internRigidSymbolWrtModule("META-KB-UPDATE", null, 2)));
      Logic.SGT_STELLA_STORAGE_SLOT = ((Surrogate)(Stella.internRigidSymbolWrtModule("STORAGE-SLOT", Stella.getStellaModule("/STELLA", Stella.TRUE), 1)));
      Logic.SGT_STELLA_SURROGATE = ((Surrogate)(Stella.internRigidSymbolWrtModule("SURROGATE", Stella.getStellaModule("/STELLA", Stella.TRUE), 1)));
      Logic.SGT_STELLA_RELATION = ((Surrogate)(Stella.internRigidSymbolWrtModule("RELATION", Stella.getStellaModule("/STELLA", Stella.TRUE), 1)));
      Logic.SYM_LOGIC_DESCRIPTION = ((Symbol)(Stella.internRigidSymbolWrtModule("DESCRIPTION", null, 0)));
      Logic.SYM_LOGIC_EQUIVALENT_VALUE = ((Symbol)(Stella.internRigidSymbolWrtModule("EQUIVALENT-VALUE", null, 0)));
      Logic.SYM_LOGIC_META_INFERENCE_CACHE = ((Symbol)(Stella.internRigidSymbolWrtModule("META-INFERENCE-CACHE", null, 0)));
      Logic.SYM_LOGIC_TRUTH_MAINTAINED_INFERENCE_CACHE = ((Symbol)(Stella.internRigidSymbolWrtModule("TRUTH-MAINTAINED-INFERENCE-CACHE", null, 0)));
      Logic.SYM_LOGIC_IOTAp = ((Symbol)(Stella.internRigidSymbolWrtModule("IOTA?", null, 0)));
      Logic.SGT_PL_KERNEL_KB_CLASS = ((Surrogate)(Stella.internRigidSymbolWrtModule("CLASS", Stella.getStellaModule("/PL-KERNEL-KB", Stella.TRUE), 1)));
      Logic.SGT_PL_KERNEL_KB_RELATION = ((Surrogate)(Stella.internRigidSymbolWrtModule("RELATION", Stella.getStellaModule("/PL-KERNEL-KB", Stella.TRUE), 1)));
      Logic.SGT_STELLA_SET = ((Surrogate)(Stella.internRigidSymbolWrtModule("SET", Stella.getStellaModule("/STELLA", Stella.TRUE), 1)));
      Logic.SGT_PL_KERNEL_KB_SET = ((Surrogate)(Stella.internRigidSymbolWrtModule("SET", Stella.getStellaModule("/PL-KERNEL-KB", Stella.TRUE), 1)));
      Logic.SGT_PL_KERNEL_KB_INTERVAL_CACHE = ((Surrogate)(Stella.internRigidSymbolWrtModule("INTERVAL-CACHE", Stella.getStellaModule("/PL-KERNEL-KB", Stella.TRUE), 1)));
      Logic.SGT_PL_KERNEL_KB_ge = ((Surrogate)(Stella.internRigidSymbolWrtModule(">=", Stella.getStellaModule("/PL-KERNEL-KB", Stella.TRUE), 1)));
      Logic.SYM_LOGIC_CONFLICTING_DEFAULT_VALUES = ((Symbol)(Stella.internRigidSymbolWrtModule("CONFLICTING-DEFAULT-VALUES", null, 0)));
      Logic.SGT_STELLA_TRUE = ((Surrogate)(Stella.internRigidSymbolWrtModule("TRUE", Stella.getStellaModule("/STELLA", Stella.TRUE), 1)));
      Logic.SGT_STELLA_FALSE = ((Surrogate)(Stella.internRigidSymbolWrtModule("FALSE", Stella.getStellaModule("/STELLA", Stella.TRUE), 1)));
      Logic.SYM_LOGIC_CREATE = ((Symbol)(Stella.internRigidSymbolWrtModule("CREATE", null, 0)));
      Logic.KWD_INTENSIONAL_ASSERTION = ((Keyword)(Stella.internRigidSymbolWrtModule("INTENSIONAL-ASSERTION", null, 2)));
      Logic.SYM_LOGIC_p = ((Symbol)(Stella.internRigidSymbolWrtModule("?", null, 0)));
      Logic.SYM_STELLA_CLASS_EXTENSION = ((Symbol)(Stella.internRigidSymbolWrtModule("CLASS-EXTENSION", Stella.getStellaModule("/STELLA", Stella.TRUE), 0)));
      Logic.SYM_LOGIC_TRANSFER_LOGIC_INFORMATION_FROM_RELATION_HOOK = ((Symbol)(Stella.internRigidSymbolWrtModule("TRANSFER-LOGIC-INFORMATION-FROM-RELATION-HOOK", null, 0)));
      Logic.SYM_LOGIC_SUBRELATION_LINKp = ((Symbol)(Stella.internRigidSymbolWrtModule("SUBRELATION-LINK?", null, 0)));
      Logic.SGT_PL_KERNEL_KB_MEMBER_OF = ((Surrogate)(Stella.internRigidSymbolWrtModule("MEMBER-OF", Stella.getStellaModule("/PL-KERNEL-KB", Stella.TRUE), 1)));
      Logic.SYM_LOGIC_ANNOTATIONS = ((Symbol)(Stella.internRigidSymbolWrtModule("ANNOTATIONS", null, 0)));
      Logic.SGT_STELLA_STRING_WRAPPER = ((Surrogate)(Stella.internRigidSymbolWrtModule("STRING-WRAPPER", Stella.getStellaModule("/STELLA", Stella.TRUE), 1)));
      Logic.SYM_LOGIC_CONSTANT = ((Symbol)(Stella.internRigidSymbolWrtModule("CONSTANT", null, 0)));
      Logic.SGT_STELLA_SYMBOL = ((Surrogate)(Stella.internRigidSymbolWrtModule("SYMBOL", Stella.getStellaModule("/STELLA", Stella.TRUE), 1)));
      Logic.SYM_PL_KERNEL_KB_MEMBER_OF = ((Symbol)(Stella.internRigidSymbolWrtModule("MEMBER-OF", Stella.getStellaModule("/PL-KERNEL-KB", Stella.TRUE), 0)));
      Logic.SYM_LOGIC_IMPLIES = ((Symbol)(Stella.internRigidSymbolWrtModule("IMPLIES", null, 0)));
      Logic.SYM_PL_KERNEL_KB_SUBSET_OF = ((Symbol)(Stella.internRigidSymbolWrtModule("SUBSET-OF", Stella.getStellaModule("/PL-KERNEL-KB", Stella.TRUE), 0)));
      Logic.SYM_STELLA_COLLECT_INTO = ((Symbol)(Stella.internRigidSymbolWrtModule("COLLECT-INTO", Stella.getStellaModule("/STELLA", Stella.TRUE), 0)));
      Logic.SGT_STELLA_SLOT = ((Surrogate)(Stella.internRigidSymbolWrtModule("SLOT", Stella.getStellaModule("/STELLA", Stella.TRUE), 1)));
      Logic.SGT_STELLA_GENERALIZED_SYMBOL = ((Surrogate)(Stella.internRigidSymbolWrtModule("GENERALIZED-SYMBOL", Stella.getStellaModule("/STELLA", Stella.TRUE), 1)));
      Logic.SYM_LOGIC_FORWARD_ONLYp = ((Symbol)(Stella.internRigidSymbolWrtModule("FORWARD-ONLY?", null, 0)));
      Logic.SYM_LOGIC_BACKWARD_ONLYp = ((Symbol)(Stella.internRigidSymbolWrtModule("BACKWARD-ONLY?", null, 0)));
      Logic.KWD_WEIGHT = ((Keyword)(Stella.internRigidSymbolWrtModule("WEIGHT", null, 2)));
      Logic.SYM_LOGIC_WEIGHT = ((Symbol)(Stella.internRigidSymbolWrtModule("WEIGHT", null, 0)));
      Logic.SYM_LOGIC_EQUIVALENT = ((Symbol)(Stella.internRigidSymbolWrtModule("EQUIVALENT", null, 0)));
      Logic.SGT_PL_KERNEL_KB_FUNCTION = ((Surrogate)(Stella.internRigidSymbolWrtModule("FUNCTION", Stella.getStellaModule("/PL-KERNEL-KB", Stella.TRUE), 1)));
      Logic.SGT_PL_KERNEL_KB_HOLDS = ((Surrogate)(Stella.internRigidSymbolWrtModule("HOLDS", Stella.getStellaModule("/PL-KERNEL-KB", Stella.TRUE), 1)));
      Logic.SGT_STELLA_TABLE = ((Surrogate)(Stella.internRigidSymbolWrtModule("TABLE", Stella.getStellaModule("/STELLA", Stella.TRUE), 1)));
      Logic.SGT_PL_KERNEL_KB_POLYMORPHIC = ((Surrogate)(Stella.internRigidSymbolWrtModule("POLYMORPHIC", Stella.getStellaModule("/PL-KERNEL-KB", Stella.TRUE), 1)));
      Logic.SYM_PL_KERNEL_KB_CUT = ((Symbol)(Stella.internRigidSymbolWrtModule("CUT", Stella.getStellaModule("/PL-KERNEL-KB", Stella.TRUE), 0)));
      Logic.SGT_PL_KERNEL_KB_VALUE = ((Surrogate)(Stella.internRigidSymbolWrtModule("VALUE", Stella.getStellaModule("/PL-KERNEL-KB", Stella.TRUE), 1)));
    }
  }

  static void helpStartupPropositions4() {
    {
      Logic.SGT_PL_KERNEL_KB_QUANTITY = ((Surrogate)(Stella.internRigidSymbolWrtModule("QUANTITY", Stella.getStellaModule("/PL-KERNEL-KB", Stella.TRUE), 1)));
      Logic.SGT_PL_KERNEL_KB_DATE = ((Surrogate)(Stella.internRigidSymbolWrtModule("DATE", Stella.getStellaModule("/PL-KERNEL-KB", Stella.TRUE), 1)));
      Logic.SGT_STELLA_FLOAT = ((Surrogate)(Stella.internRigidSymbolWrtModule("FLOAT", Stella.getStellaModule("/STELLA", Stella.TRUE), 1)));
      Logic.SGT_STELLA_INTEGER = ((Surrogate)(Stella.internRigidSymbolWrtModule("INTEGER", Stella.getStellaModule("/STELLA", Stella.TRUE), 1)));
      Logic.KWD_AUTOMATICALLY_FIX_TYPE_VIOLATIONS = ((Keyword)(Stella.internRigidSymbolWrtModule("AUTOMATICALLY-FIX-TYPE-VIOLATIONS", null, 2)));
      Logic.KWD_POST_TYPE_VIOLATIONS = ((Keyword)(Stella.internRigidSymbolWrtModule("POST-TYPE-VIOLATIONS", null, 2)));
      Logic.KWD_IGNORE_TYPE_VIOLATIONS = ((Keyword)(Stella.internRigidSymbolWrtModule("IGNORE-TYPE-VIOLATIONS", null, 2)));
      Logic.KWD_REPORT_TYPE_VIOLATIONS = ((Keyword)(Stella.internRigidSymbolWrtModule("REPORT-TYPE-VIOLATIONS", null, 2)));
      Logic.SYM_LOGIC_ASSERTED_BY_TYPE_CHECKERp = ((Symbol)(Stella.internRigidSymbolWrtModule("ASSERTED-BY-TYPE-CHECKER?", null, 0)));
      Logic.SGT_LOGIC_CHECK_TYPES_RECORD = ((Surrogate)(Stella.internRigidSymbolWrtModule("CHECK-TYPES-RECORD", null, 1)));
      Logic.SYM_LOGIC_PARENT_PROPOSITION = ((Symbol)(Stella.internRigidSymbolWrtModule("PARENT-PROPOSITION", null, 0)));
      Logic.SYM_LOGIC_PARENT_DESCRIPTION = ((Symbol)(Stella.internRigidSymbolWrtModule("PARENT-DESCRIPTION", null, 0)));
      Logic.SGT_PL_KERNEL_KB_TOTAL = ((Surrogate)(Stella.internRigidSymbolWrtModule("TOTAL", Stella.getStellaModule("/PL-KERNEL-KB", Stella.TRUE), 1)));
      Logic.SGT_PL_KERNEL_KB_SETOF = ((Surrogate)(Stella.internRigidSymbolWrtModule("SETOF", Stella.getStellaModule("/PL-KERNEL-KB", Stella.TRUE), 1)));
      Logic.SGT_PL_KERNEL_KB_LISTOF = ((Surrogate)(Stella.internRigidSymbolWrtModule("LISTOF", Stella.getStellaModule("/PL-KERNEL-KB", Stella.TRUE), 1)));
      Logic.SGT_PL_KERNEL_KB_LIST = ((Surrogate)(Stella.internRigidSymbolWrtModule("LIST", Stella.getStellaModule("/PL-KERNEL-KB", Stella.TRUE), 1)));
      Logic.SYM_LOGIC_FALS = ((Symbol)(Stella.internRigidSymbolWrtModule("FALS", null, 0)));
      Logic.SYM_STELLA_SOME = ((Symbol)(Stella.internRigidSymbolWrtModule("SOME", Stella.getStellaModule("/STELLA", Stella.TRUE), 0)));
      Logic.SYM_PL_KERNEL_KB_SETOF = ((Symbol)(Stella.internRigidSymbolWrtModule("SETOF", Stella.getStellaModule("/PL-KERNEL-KB", Stella.TRUE), 0)));
      Logic.SYM_PL_KERNEL_KB_LISTOF = ((Symbol)(Stella.internRigidSymbolWrtModule("LISTOF", Stella.getStellaModule("/PL-KERNEL-KB", Stella.TRUE), 0)));
      Logic.SYM_LOGIC_BAGOF = ((Symbol)(Stella.internRigidSymbolWrtModule("BAGOF", null, 0)));
      Logic.SYM_STELLA_ASSERT = ((Symbol)(Stella.internRigidSymbolWrtModule("ASSERT", Stella.getStellaModule("/STELLA", Stella.TRUE), 0)));
      Logic.KWD_CPP = ((Keyword)(Stella.internRigidSymbolWrtModule("CPP", null, 2)));
      Logic.KWD_DELETED = ((Keyword)(Stella.internRigidSymbolWrtModule("DELETED", null, 2)));
      Logic.SYM_LOGIC_INTRODUCE_MODULE = ((Symbol)(Stella.internRigidSymbolWrtModule("INTRODUCE-MODULE", null, 0)));
      Logic.SYM_LOGIC_CLEAR_LOGIC_MODULE_HOOK = ((Symbol)(Stella.internRigidSymbolWrtModule("CLEAR-LOGIC-MODULE-HOOK", null, 0)));
      Logic.SYM_LOGIC_MONOTONICp = ((Symbol)(Stella.internRigidSymbolWrtModule("MONOTONIC?", null, 0)));
      Logic.SGT_STELLA_WORLD = ((Surrogate)(Stella.internRigidSymbolWrtModule("WORLD", Stella.getStellaModule("/STELLA", Stella.TRUE), 1)));
      Logic.SYM_LOGIC_DESTROY_LOGIC_CONTEXT_HOOK = ((Symbol)(Stella.internRigidSymbolWrtModule("DESTROY-LOGIC-CONTEXT-HOOK", null, 0)));
      Logic.SGT_STELLA_MUTABLE_STRING_WRAPPER = ((Surrogate)(Stella.internRigidSymbolWrtModule("MUTABLE-STRING-WRAPPER", Stella.getStellaModule("/STELLA", Stella.TRUE), 1)));
      Logic.SGT_STELLA_CONTEXT = ((Surrogate)(Stella.internRigidSymbolWrtModule("CONTEXT", Stella.getStellaModule("/STELLA", Stella.TRUE), 1)));
      Logic.SGT_LOGIC_COMPUTED_PROCEDURE = ((Surrogate)(Stella.internRigidSymbolWrtModule("COMPUTED-PROCEDURE", null, 1)));
      Logic.SYM_LOGIC_STARTUP_PROPOSITIONS = ((Symbol)(Stella.internRigidSymbolWrtModule("STARTUP-PROPOSITIONS", null, 0)));
    }
  }
  ...
  static void helpStartupPropositions5() {
    {
      ...
      { PropertyList self005 = PropertyList.newPropertyList();

        self005.thePlist = Stella.list$(Stella_Object.cons(Logic.KWD_AND, Stella_Object.cons(Logic.SGT_PL_KERNEL_KB_AND, Stella_Object.cons(Logic.KWD_OR, Stella_Object.cons(Logic.SGT_PL_KERNEL_KB_OR, Stella_Object.cons(Logic.KWD_NOT, Stella_Object.cons(Logic.SGT_PL_KERNEL_KB_NOT, Stella_Object.cons(Logic.KWD_FORALL, Stella_Object.cons(Logic.SGT_PL_KERNEL_KB_FORALL, Stella_Object.cons(Logic.KWD_EXISTS, Stella_Object.cons(Logic.SGT_PL_KERNEL_KB_EXISTS, Stella_Object.cons(Logic.KWD_EQUIVALENT, Stella_Object.cons(Logic.SGT_PL_KERNEL_KB_EQUIVALENT, Stella_Object.cons(Logic.KWD_FAIL, Stella_Object.cons(Logic.SGT_PL_KERNEL_KB_FAIL, Stella_Object.cons(Logic.KWD_COLLECT_INTO, Stella_Object.cons(Logic.SGT_PL_KERNEL_KB_COLLECT_INTO, Stella_Object.cons(Logic.KWD_IMPLIES, Stella_Object.cons(Logic.SGT_PL_KERNEL_KB_SUBSET_OF, Stella_Object.cons(Stella.NIL, Stella.NIL))))))))))))))))))));
        Logic.$OPERATOR_NAME_TO_SURROGATE_TABLE$ = self005;
      }
      Logic.$LOGIC_MODULE$ = Stella.getStellaModule("LOGIC", Stella.TRUE);
      Logic.$PL_KERNEL_MODULE$ = Stella.getStellaModule("PL-KERNEL", Stella.TRUE);
      Logic.$LAST_KB_ACTION$ = Logic.KWD_UPDATE_PROPOSITION;
      Logic.$EVALUATIONMODE$.setDefaultValue(Logic.KWD_EXTENSIONAL_ASSERTION);
      Logic.$CLIPPINGENABLEDp$.setDefaultValue(new Boolean(Stella.TRUE));
      Logic.$NATURALDEDUCTIONMODEp$.setDefaultValue(new Boolean(Stella.TRUE));
      Logic.$CONTEXT_DEPENDENT_SEARCH_MODEp$ = Stella.FALSE;
      Logic.$COMPUTEDQUERYp$.setDefaultValue(new Boolean(Stella.FALSE));
      Logic.$VARIABLEIDCOUNTER$.setDefaultValue(new Integer(0));
      Logic.$FREESKOLEMS$.setDefaultValue(null);
      Logic.TRUE_TRUTH_VALUE = TruthValue.newTruthValue();
      Logic.FALSE_TRUTH_VALUE = TruthValue.newTruthValue();
      Logic.DEFAULT_TRUE_TRUTH_VALUE = TruthValue.newTruthValue();
      Logic.DEFAULT_FALSE_TRUTH_VALUE = TruthValue.newTruthValue();
      Logic.UNKNOWN_TRUTH_VALUE = TruthValue.newTruthValue();
      Logic.$SUPPRESSUNTYPEDTYPEERRORp$.setDefaultValue(new Boolean(Stella.FALSE));
      Logic.$EQUIVALENCE_COLLECTIONSp$ = Stella.TRUE;
      { Proposition self011 = Proposition.newProposition();
        ...
        { Proposition object013 = self011;
          ...
          Stella_Object newValue016 = Stella_Object.updateInContext(oldValue015, value014, object013.homeContext, Stella.FALSE);
      ...
      { Proposition self017 = Proposition.newProposition();
        ...
        { Proposition object019 = self017;
          ...
          Stella_Object newValue022 = Stella_Object.updateInContext(oldValue021, value020, object019.homeContext, Stella.FALSE);
      ...
      Logic.ANONYMOUS_VARIABLE_NAME = Logic.SYM_LOGIC_p;
      ...
      Logic.$STRINGIFIED_PROPOSITION_INDEX$ = StringHashTable.newStringHashTable();
      Logic.$DONT_CHECK_FOR_DUPLICATE_PROPOSITIONSp$.setDefaultValue(new Boolean(Stella.FALSE));
      Logic.$VISITEDUNFASTENEDDEFININGPROPOSITIONS$.setDefaultValue(null);
      Logic.$AUTO_COERCE_PROPOSITIONAL_ARGUMENTSp$ = Stella.FALSE;
  ...
  static void helpStartupPropositions6() {
    {
      ...
      { Stella_Class renamed_Class = Stella.defineClassFromStringifiedSource("TRUTH-VALUE", "(DEFCLASS TRUTH-VALUE (LOGIC-OBJECT) :PUBLIC-SLOTS ((POSITIVE-SCORE :TYPE PARTIAL-MATCH-SCORE :INITIALLY 0.0)))");
      ...
      { Stella_Class renamed_Class = Stella.defineClassFromStringifiedSource("STRING-LOGIC-WRAPPER", "(DEFCLASS STRING-LOGIC-WRAPPER (STRING-WRAPPER BACKLINKS-MIXIN) :PRINT-FORM (IF *PRINTREADABLY?* (PRINT-NATIVE-STREAM STREAM (WRAPPER-VALUE SELF)) (PRINT-NATIVE-STREAM STREAM \"|W|\" (WRAPPER-VALUE SELF))))");
      ...
      { Stella_Class renamed_Class = Stella.defineClassFromStringifiedSource("CHECK-TYPES-RECORD", "(DEFCLASS CHECK-TYPES-RECORD (STANDARD-OBJECT) :SLOTS ((PARENT-PROPOSITION :TYPE OBJECT) (PARENT-DESCRIPTION :TYPE DESCRIPTION) (MODULE :TYPE MODULE)))");
  ...
  static void helpStartupPropositions7() {
    {
      ...
      Stella.defineFunctionObject("OBJECT-SURROGATE", "(DEFUN (OBJECT-SURROGATE SURROGATE) ((SELF OBJECT)) :DOCUMENTATION \"Return the surrogate naming the logic object `self'.\" :PUBLIC? TRUE)", Native.find_java_method("edu.isi.powerloom.logic.Logic", "objectSurrogate", new java.lang.Class [] {Native.find_java_class("edu.isi.stella.Stella_Object")}), null);
      ...
      Stella.defineFunctionObject("ASSIGN-NATIVE-SLOT-VALUE", "(DEFUN ASSIGN-NATIVE-SLOT-VALUE ((SELF THING) (SLOT STORAGE-SLOT) (VALUE OBJECT)))", Native.find_java_method("edu.isi.powerloom.logic.Logic", "assignNativeSlotValue", new java.lang.Class [] {Native.find_java_class("edu.isi.stella.Thing"), Native.find_java_class("edu.isi.stella.StorageSlot"), Native.find_java_class("edu.isi.stella.Stella_Object")}), null);
  ...
  static void helpStartupPropositions8() {
    {
      ...
      Stella.defineFunctionObject("TRUE?", "(DEFUN (TRUE? BOOLEAN) ((SELF PROPOSITION)) :PUBLIC? TRUE)", Native.find_java_method("edu.isi.powerloom.logic.Proposition", "trueP", new java.lang.Class [] {Native.find_java_class("edu.isi.powerloom.logic.Proposition")}), null);
      Stella.defineFunctionObject("FALSE?", "(DEFUN (FALSE? BOOLEAN) ((SELF PROPOSITION)) :PUBLIC? TRUE)", Native.find_java_method("edu.isi.powerloom.logic.Proposition", "falseP", new java.lang.Class [] {Native.find_java_class("edu.isi.powerloom.logic.Proposition")}), null);
      Stella.defineFunctionObject("UNKNOWN?", "(DEFUN (UNKNOWN? BOOLEAN) ((SELF PROPOSITION)) :PUBLIC? TRUE)", Native.find_java_method("edu.isi.powerloom.logic.Proposition", "unknownP", new java.lang.Class [] {Native.find_java_class("edu.isi.powerloom.logic.Proposition")}), null);
      Stella.defineFunctionObject("DEFAULT-TRUE?", "(DEFUN (DEFAULT-TRUE? BOOLEAN) ((SELF PROPOSITION)) :PUBLIC? TRUE)", Native.find_java_method("edu.isi.powerloom.logic.Proposition", "defaultTrueP", new java.lang.Class [] {Native.find_java_class("edu.isi.powerloom.logic.Proposition")}), null);
      Stella.defineFunctionObject("DEFAULT-FALSE?", "(DEFUN (DEFAULT-FALSE? BOOLEAN) ((SELF PROPOSITION)) :PUBLIC? TRUE)", Native.find_java_method("edu.isi.powerloom.logic.Proposition", "defaultFalseP", new java.lang.Class [] {Native.find_java_class("edu.isi.powerloom.logic.Proposition")}), null);
      ...
      Stella.defineFunctionObject("SIGNAL-UNIFICATION-CLASH", "(DEFUN SIGNAL-UNIFICATION-CLASH ((TERM1 OBJECT) (TERM2 OBJECT)))", Native.find_java_method("edu.isi.powerloom.logic.Logic", "signalUnificationClash", new java.lang.Class [] {Native.find_java_class("edu.isi.stella.Stella_Object"), Native.find_java_class("edu.isi.stella.Stella_Object")}), null);
      Stella.defineFunctionObject("SIGNAL-VARIABLE-VALUE-CLASH", "(DEFUN SIGNAL-VARIABLE-VALUE-CLASH ((SKOLEM SKOLEM) (VALUE1 OBJECT) (VALUE2 OBJECT)))", Native.find_java_method("edu.isi.powerloom.logic.Skolem", "signalVariableValueClash", new java.lang.Class [] {Native.find_java_class("edu.isi.powerloom.logic.Skolem"), Native.find_java_class("edu.isi.stella.Stella_Object"), Native.find_java_class("edu.isi.stella.Stella_Object")}), null);
      ...
      Stella.defineFunctionObject("UNIFY-TYPES", "(DEFUN UNIFY-TYPES ((TERM1 SKOLEM) (TERM2 OBJECT)))", Native.find_java_method("edu.isi.powerloom.logic.Skolem", "unifyTypes", new java.lang.Class [] {Native.find_java_class("edu.isi.powerloom.logic.Skolem"), Native.find_java_class("edu.isi.stella.Stella_Object")}), null);
      ...
      Stella.defineFunctionObject("CONSTRAIN-AS-SUBSET", "(DEFUN CONSTRAIN-AS-SUBSET ((SET1 COLLECTION) (SET2 COLLECTION)))", Native.find_java_method("edu.isi.powerloom.logic.Logic", "constrainAsSubset", new java.lang.Class [] {Native.find_java_class("edu.isi.stella.Collection"), Native.find_java_class("edu.isi.stella.Collection")}), null);
      Stella.defineFunctionObject("EQUATE-COLLECTIONS", "(DEFUN EQUATE-COLLECTIONS ((COL1 COLLECTION) (COL2 COLLECTION)))", Native.find_java_method("edu.isi.powerloom.logic.Logic", "equateCollections", new java.lang.Class [] {Native.find_java_class("edu.isi.stella.Collection"), Native.find_java_class("edu.isi.stella.Collection")}), null);
      Stella.defineFunctionObject("EQUATE-VALUES", "(DEFUN EQUATE-VALUES ((TERM1 OBJECT) (TERM2 OBJECT)))", Native.find_java_method("edu.isi.powerloom.logic.Logic", "equateValues", new java.lang.Class [] {Native.find_java_class("edu.isi.stella.Stella_Object"), Native.find_java_class("edu.isi.stella.Stella_Object")}), null);
  ...
  static void helpStartupPropositions9() {
    {
      ...
      Stella.defineFunctionObject("FIND-EXACT-DUPLICATE-PROPOSITION", "(DEFUN (FIND-EXACT-DUPLICATE-PROPOSITION PROPOSITION) ((SELF PROPOSITION)))", Native.find_java_method("edu.isi.powerloom.logic.Proposition", "findExactDuplicateProposition", new java.lang.Class [] {Native.find_java_class("edu.isi.powerloom.logic.Proposition")}), null);
  ...
  static void helpStartupPropositions10() {
    {
      ...
      Stella.defineFunctionObject("CHECK-TYPE?", "(DEFUN (CHECK-TYPE? BOOLEAN OBJECT) ((SELF OBJECT) (TYPE SURROGATE) (SHALLOW? BOOLEAN)))", Native.find_java_method("edu.isi.powerloom.logic.Logic", "checkTypeP", new java.lang.Class [] {Native.find_java_class("edu.isi.stella.Stella_Object"), Native.find_java_class("edu.isi.stella.Surrogate"), java.lang.Boolean.TYPE, Native.find_java_class("[Ljava.lang.Object;")}), null);
      ...
      Stella.defineFunctionObject("REMOVE-TRUE-AND-FALSE", "(DEFUN (REMOVE-TRUE-AND-FALSE OBJECT BOOLEAN) ((TREE CONS)))", Native.find_java_method("edu.isi.powerloom.logic.Logic", "removeTrueAndFalse", new java.lang.Class [] {Native.find_java_class("edu.isi.stella.Cons"), Native.find_java_class("[Ljava.lang.Object;")}), null);
      Stella.defineFunctionObject("FLATTEN-NESTED-OPERATORS", "(DEFUN (FLATTEN-NESTED-OPERATORS OBJECT BOOLEAN) ((TREE CONS)))", Native.find_java_method("edu.isi.powerloom.logic.Logic", "flattenNestedOperators", new java.lang.Class [] {Native.find_java_class("edu.isi.stella.Cons"), Native.find_java_class("[Ljava.lang.Object;")}), null);
    }
  }

  static void helpStartupPropositions11() {
    {
      Stella.defineFunctionObject("CANONICALIZE-AND-OR-TREE", "(DEFUN (CANONICALIZE-AND-OR-TREE OBJECT) ((TREE CONS)))", Native.find_java_method("edu.isi.powerloom.logic.Logic", "canonicalizeAndOrTree", new java.lang.Class [] {Native.find_java_class("edu.isi.stella.Cons")}), null);
      Stella.defineFunctionObject("CANONICALIZE-NEGATION-TREE", "(DEFUN (CANONICALIZE-NEGATION-TREE OBJECT) ((TREE CONS)))", Native.find_java_method("edu.isi.powerloom.logic.Logic", "canonicalizeNegationTree", new java.lang.Class [] {Native.find_java_class("edu.isi.stella.Cons")}), null);
      Stella.defineFunctionObject("QUANTIFIER-SYMBOL?", "(DEFUN (QUANTIFIER-SYMBOL? BOOLEAN) ((SELF SYMBOL)))", Native.find_java_method("edu.isi.powerloom.logic.Logic", "quantifierSymbolP", new java.lang.Class [] {Native.find_java_class("edu.isi.stella.Symbol")}), null);
      Stella.defineFunctionObject("ALL-VARIABLES-GOAL?", "(DEFUN (ALL-VARIABLES-GOAL? BOOLEAN) ((TREE OBJECT)))", Native.find_java_method("edu.isi.powerloom.logic.Logic", "allVariablesGoalP", new java.lang.Class [] {Native.find_java_class("edu.isi.stella.Stella_Object")}), null);
      Stella.defineFunctionObject("EQUAL-ARGUMENTS?", "(DEFUN (EQUAL-ARGUMENTS? BOOLEAN) ((GOAL1 CONS) (GOAL2 CONS)))", Native.find_java_method("edu.isi.powerloom.logic.Logic", "equalArgumentsP", new java.lang.Class [] {Native.find_java_class("edu.isi.stella.Cons"), Native.find_java_class("edu.isi.stella.Cons")}), null);
      Stella.defineFunctionObject("EXPLODE-FORALL-TREE", "(DEFUN (EXPLODE-FORALL-TREE CONS) ((TREE CONS)))", Native.find_java_method("edu.isi.powerloom.logic.Logic", "explodeForallTree", new java.lang.Class [] {Native.find_java_class("edu.isi.stella.Cons")}), null);
      Stella.defineFunctionObject("CANONICALIZE-QUANTIFICATION-TREE", "(DEFUN (CANONICALIZE-QUANTIFICATION-TREE CONS) ((TREE CONS)))", Native.find_java_method("edu.isi.powerloom.logic.Logic", "canonicalizeQuantificationTree", new java.lang.Class [] {Native.find_java_class("edu.isi.stella.Cons")}), null);
      Stella.defineFunctionObject("CONS.CANONICALIZE-PROPOSITION-TREE", "(DEFUN (CONS.CANONICALIZE-PROPOSITION-TREE OBJECT) ((TREE CONS)))", Native.find_java_method("edu.isi.powerloom.logic.Logic", "consDcanonicalizePropositionTree", new java.lang.Class [] {Native.find_java_class("edu.isi.stella.Cons")}), null);
      ...
      Stella.defineFunctionObject("ERASE-PROPOSITION", "(DEFUN ERASE-PROPOSITION ((PROPOSITION PROPOSITION)))", Native.find_java_method("edu.isi.powerloom.logic.Proposition", "eraseProposition", new java.lang.Class [] {Native.find_java_class("edu.isi.powerloom.logic.Proposition")}), null);
      ...
      Stella.defineFunctionObject("SAFE-STRING-LESS?", "(DEFUN (SAFE-STRING-LESS? BOOLEAN) ((S1 STRING) (S2 STRING)))", Native.find_java_method("edu.isi.powerloom.logic.Logic", "safeStringLessP", new java.lang.Class [] {Native.find_java_class("java.lang.String"), Native.find_java_class("java.lang.String")}), null);
      ...
      { MethodSlot function = Symbol.lookupFunction(Logic.SYM_LOGIC_STARTUP_PROPOSITIONS);
        ...
        KeyValueList.setDynamicSlotValue(function.dynamicSlots, Logic.SYM_STELLA_METHOD_STARTUP_CLASSNAME, Stella.wrapString("_Startup-Propositions"), Stella.NULL_STRING_WRAPPER);
      }
    }
  }
    ...
    { Object old$Module$000 = Stella.$MODULE$.get();
      ...
      try {
        ...
        if (Stella.currentStartupTimePhaseP(9)) {
          ...
          Stella.defineStellaGlobalVariableFromStringifiedSource("(DEFCONSTANT TRUE-TRUTH-VALUE TRUTH-VALUE (NEW TRUTH-VALUE) :DOCUMENTATION \"Value representing TRUE.\")");
          Stella.defineStellaGlobalVariableFromStringifiedSource("(DEFCONSTANT FALSE-TRUTH-VALUE TRUTH-VALUE (NEW TRUTH-VALUE) :DOCUMENTATION \"Value representing FALSE.\")");
          Stella.defineStellaGlobalVariableFromStringifiedSource("(DEFCONSTANT DEFAULT-TRUE-TRUTH-VALUE TRUTH-VALUE (NEW TRUTH-VALUE) :DOCUMENTATION \"Value representing DEFAULT-TRUE.\")");
          Stella.defineStellaGlobalVariableFromStringifiedSource("(DEFCONSTANT DEFAULT-FALSE-TRUTH-VALUE TRUTH-VALUE (NEW TRUTH-VALUE) :DOCUMENTATION \"Value representing DEFAULT-FALSE.\")");
          Stella.defineStellaGlobalVariableFromStringifiedSource("(DEFCONSTANT UNKNOWN-TRUTH-VALUE TRUTH-VALUE (NEW TRUTH-VALUE) :DOCUMENTATION \"Value representing UNKNOWN.  Needed for those cases\nwhere we need a non-NULL truth value to represents UNKNOWN.\")");
          Logic.TRUE_TRUTH_VALUE.positiveScore = 1.0;
          Logic.FALSE_TRUTH_VALUE.positiveScore = -1.0;
          Logic.DEFAULT_TRUE_TRUTH_VALUE.positiveScore = 0.8;
          Logic.DEFAULT_FALSE_TRUTH_VALUE.positiveScore = -0.8;
          ...
          Stella.defineStellaGlobalVariableFromStringifiedSource("(DEFCONSTANT TRUE-PROPOSITION PROPOSITION (NEW PROPOSITION :KIND :CONSTANT :OPERATOR @TRUE :ARGUMENTS (NEW ARGUMENTS-VECTOR :ARRAY-SIZE 0) :TRUTH-VALUE TRUE-TRUTH-VALUE))");
          Stella.defineStellaGlobalVariableFromStringifiedSource("(DEFCONSTANT FALSE-PROPOSITION PROPOSITION (NEW PROPOSITION :KIND :CONSTANT :OPERATOR @FALSE :ARGUMENTS (NEW ARGUMENTS-VECTOR :ARRAY-SIZE 0) :TRUTH-VALUE FALSE-TRUTH-VALUE))");
          ...
          Stella.defineStellaGlobalVariableFromStringifiedSource("(DEFGLOBAL *STRINGIFIED-PROPOSITION-INDEX* (STRING-HASH-TABLE OF STRING LIST) (NEW STRING-HASH-TABLE) :DOCUMENTATION \"Contains a table of propositions, indexed by their\nstringifications.  Tricky: Propositions in two\ndifferent modules could have the same stringification but be different.\")");
          ...
          Stella.defineStellaGlobalVariableFromStringifiedSource("(DEFGLOBAL *CHECK-TYPES-AGENDA* (KEY-VALUE-LIST OF PROPOSITION CHECK-TYPES-RECORD) (NEW KEY-VALUE-LIST) :DOCUMENTATION \"List of propositions that have failed a type check,\nbut might pass once finalization is complete.\")");
