    ...
    { Object old$Module$000 = Stella.$MODULE$.get();
      ...
      try {
        ...
        if (Stella.currentStartupTimePhaseP(2)) {
          Logic.SGT_PL_KERNEL_KB_CUT = ((Surrogate)(Stella.internRigidSymbolWrtModule("CUT", Stella.getStellaModule("/PL-KERNEL-KB", Stella.TRUE), 1)));
          Logic.SGT_PL_KERNEL_KB_BOUND_VARIABLES = ((Surrogate)(Stella.internRigidSymbolWrtModule("BOUND-VARIABLES", Stella.getStellaModule("/PL-KERNEL-KB", Stella.TRUE), 1)));
          Logic.SGT_PL_KERNEL_KB_FORK = ((Surrogate)(Stella.internRigidSymbolWrtModule("FORK", Stella.getStellaModule("/PL-KERNEL-KB", Stella.TRUE), 1)));
          Logic.SGT_PL_KERNEL_KB_QUERY = ((Surrogate)(Stella.internRigidSymbolWrtModule("QUERY", Stella.getStellaModule("/PL-KERNEL-KB", Stella.TRUE), 1)));
          Logic.SYM_LOGIC_NEURAL_NETWORK = ((Symbol)(Stella.internRigidSymbolWrtModule("NEURAL-NETWORK", null, 0)));
          Logic.SGT_PL_KERNEL_KB_ARITY = ((Surrogate)(Stella.internRigidSymbolWrtModule("ARITY", Stella.getStellaModule("/PL-KERNEL-KB", Stella.TRUE), 1)));
        ...
        if (Stella.currentStartupTimePhaseP(7)) {
          ...
          Stella.defineFunctionObject("HELP-NORMALIZE-PREDICATE-PROPOSITION", "(DEFUN HELP-NORMALIZE-PREDICATE-PROPOSITION ((SELF PROPOSITION) (RELATIONREF SURROGATE) (PREDICATEARGUMENTS LIST)))", Native.find_java_method("edu.isi.powerloom.logic.Proposition", "helpNormalizePredicateProposition", new java.lang.Class [] {Native.find_java_class("edu.isi.powerloom.logic.Proposition"), Native.find_java_class("edu.isi.stella.Surrogate"), Native.find_java_class("edu.isi.stella.List")}), null);
          ...
          { MethodSlot function = Symbol.lookupFunction(Logic.SYM_LOGIC_STARTUP_NORMALIZE);
            ...
            KeyValueList.setDynamicSlotValue(function.dynamicSlots, Logic.SYM_STELLA_METHOD_STARTUP_CLASSNAME, Stella.wrapString("_Startup-Normalize"), Stella.NULL_STRING_WRAPPER);
          }
        }
