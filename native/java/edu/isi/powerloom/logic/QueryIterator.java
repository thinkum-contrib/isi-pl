...
public class QueryIterator extends Iterator {
  ...
  public static QueryIterator newQueryIterator() {
    { QueryIterator self = null;
      ...
      self.foundAtLeastOneSolutionP = Stella.FALSE;
      self.failedToFindDuplicateSubgoalP = Stella.FALSE;
      self.triggeredDepthCutoffP = Stella.FALSE;
      self.activeGoalCaches = List.newList();
      self.augmentedGoalCacheP = Stella.FALSE;
    ...
    { Object old$Queryiterator$000 = Logic.$QUERYITERATOR$.get();
      ...
      try {
        ...
        { QueryIterator askquery = Logic.allocateQueryIterator();
          ...
          return (QueryIterator.getQueryJustifications(askquery, Stella.NULL_INTEGER, maxjustifications, Stella.FALSE));
        }
  ...
  public static Cons updatePropositionsFromQuery(QueryIterator query, Description description, Module module, Keyword updatemode) {
    ...
    { Description querydescription = query.queryDescription();
      ...
      boolean dontcheckduplicatesP = Stella.FALSE;
      ...
      { Object old$Module$000 = Stella.$MODULE$.get();
        ...
        try {
          ...
          dontcheckduplicatesP = Description.namedDescriptionP(description) &&
              NamedDescription.getDescriptionExtension(((NamedDescription)(description)), Stella.FALSE).emptyP();
          { QuerySolution solution = null;
            ...
            while (iter000.nextP()) {
              ...
              { Proposition prop = null;
                Cons iter001 = Proposition.inheritAsTopLevelProposition(proposition, mapping);
                ...
                while (!(iter001 == Stella.NIL)) {
                  ...
                  KeyValueList.setDynamicSlotValue(prop.dynamicSlots, Logic.SYM_LOGIC_DESCRIPTIVEp, (Stella.FALSE ? Stella.TRUE_WRAPPER : Stella.FALSE_WRAPPER), Stella.FALSE_WRAPPER);
                  ...
                  { Keyword thisupdatemode = updatemode;
                    ...
                    if (partialP) {
                      KeyValueList.setDynamicSlotValue(prop.dynamicSlots, Logic.SYM_LOGIC_WEIGHT, Stella.wrapFloat(solution.matchScore), Stella.NULL_FLOAT_WRAPPER);
                    }
  ...
  public static BooleanWrapper runYesOrNoQueryP(QueryIterator query) {
    { TruthValue truthvalue = Logic.callAsk(query);
      ...
      if ((truthvalue == Logic.TRUE_TRUTH_VALUE) ||
        ...
        return ((Stella.TRUE ? Stella.TRUE_WRAPPER : Stella.FALSE_WRAPPER));
      }
          ...
          { GeneralizedSymbol testValue000 = ((GeneralizedSymbol)(key));
            ...
            if (testValue000 == Logic.KWD_TIMEOUT) {
              { Surrogate testValue001 = Stella_Object.safePrimaryType(value);
                ...
                if (Surrogate.subtypeOfIntegerP(testValue001)) {
                  { IntegerWrapper value000 = ((IntegerWrapper)(value));
                    ...
                    theoptions.insertAt(key, Stella.wrapFloat(query.allottedTime));
                  }
                }
              ...
              { Surrogate testValue002 = Stella_Object.safePrimaryType(value);
                ...
                if (Surrogate.subtypeOfIntegerP(testValue002)) {
                  { IntegerWrapper value000 = ((IntegerWrapper)(value));
                    ...
                    theoptions.insertAt(key, Stella.wrapInteger(Native.floor(value000.wrapperValue)));
                  }
                }
              ...
              if (Stella_Object.eqlP(value, Stella.TRUE_WRAPPER)) {
                KeyValueList.setDynamicSlotValue(query.dynamicSlots, Logic.SYM_LOGIC_ITERATIVE_DEEPENINGp, (Stella.TRUE ? Stella.TRUE_WRAPPER : Stella.FALSE_WRAPPER), Stella.FALSE_WRAPPER);
              }
            }
                ...
                if (Surrogate.subtypeOfIntegerP(testValue005)) {
                  ...
                  { GeneralizedSymbol value000 = ((GeneralizedSymbol)(value));
                    ...
                    if (Stella.stringEqlP(value000.symbolName, "ALL")) {
                      theoptions.insertAt(key, Stella.wrapInteger(Stella.NULL_INTEGER));
                    }
                    else {
              ...
              { Surrogate testValue007 = Stella_Object.safePrimaryType(value);
                ...
                if (Surrogate.subtypeOfIntegerP(testValue007)) {
                  { IntegerWrapper value000 = ((IntegerWrapper)(value));
                    ...
                    theoptions.insertAt(key, Stella.wrapFloat(((double)(value000.wrapperValue))));
                  }
                }
              ...
              { Surrogate testValue008 = Stella_Object.safePrimaryType(value);
                ...
                if (Surrogate.subtypeOfIntegerP(testValue008)) {
                  ...
                  { FloatWrapper value000 = ((FloatWrapper)(value));
                    ...
                    theoptions.insertAt(key, Stella.wrapInteger(((int)(value000.wrapperValue))));
                  }
                }
                else {
  ...
  public static boolean tryToDefeatLastAnswerP(QueryIterator self) {
    { QueryIterator negatedquery = (self.queryIsTrueFalseP() ? self : ((QueryIterator)(KeyValueList.dynamicSlotValue(self.dynamicSlots, Logic.SYM_LOGIC_AUXILIARY_QUERY, null))));
      ...
      boolean strictpositiveanswerP = Stella.FALSE;
      boolean strictnegativeanswerP = Stella.FALSE;
      boolean defeatedP = Stella.FALSE;
      ...
      negatedquery.baseControlFrame.reversePolarityP = Stella.TRUE;
      negatedquery.reset();
      if ((Stella.$TRACED_KEYWORDS$ != null) &&
      ...
      if (negatedquery.nextP()) {
        ...
        negatedquery.baseControlFrame.reversePolarityP = Stella.FALSE;
        negatedquery.reset();
...
;
            ...
            defeatedP = Stella.TRUE;
          }
          else {
            defeatedP = Stella.FALSE;
          }
        }
        else {
          defeatedP = Stella.TRUE;
              ...
              { Object old$Context$000 = Stella.$CONTEXT$.get();
                ...
                try {
                  ...
                  loop001 : for (;;) {
                    ...
                    self.foundAtLeastOneSolutionP = Stella.TRUE;
              ...
              if (self.timeoutP) {
                ...
                if (self.failedToFindDuplicateSubgoalP &&
                    (!self.foundAtLeastOneSolutionP)) {
                  {
                    ...
                    System.out.println("   the depth cutoff " + self.currentDepthCutoff + " was exceeded.  Consider increasing the cutoff");
                    System.out.println("   (by setting the variable *maximum-backtracking-depth*)");
                    System.out.println("   and trying again.");
                  }
;
                }
                self.exhaustedP = Stella.TRUE;
                return (Stella.FALSE);
              }
            }
          }
      ...
      { Object old$Queryiterator$000 = Logic.$QUERYITERATOR$.get();
        ...
        try {
          ...
          if (Logic.testQueryOptionP(queryiterator, Logic.KWD_DONT_OPTIMIZEp)) {
            KeyValueList.setDynamicSlotValue(description.dynamicSlots, Logic.SYM_LOGIC_DONT_OPTIMIZEp, (Stella.TRUE ? Stella.TRUE_WRAPPER : Stella.FALSE_WRAPPER), Stella.FALSE_WRAPPER);
            KeyValueList.setDynamicSlotValue(description.proposition.dynamicSlots, Logic.SYM_LOGIC_DONT_OPTIMIZEp, (Stella.TRUE ? Stella.TRUE_WRAPPER : Stella.FALSE_WRAPPER), Stella.FALSE_WRAPPER);
          }
              ...
              if (outsidebindings != null) {
                if (outsidebindings.length() > externalvariables.length()) {
                  { OutputStringStream stream000 = OutputStringStream.newOutputStringStream();
                    ...
                    stream000.nativeStream.print("Arity mismatch between bindings `" + outsidebindings + "' and external varaibles `" + externalvariables + "'.");
                ...
                { Stella_Object value = null;
                  ...
                  while ((index000 < length000) &&
                    ...
                    if ((value != null) &&
                        (!Logic.bindArgumentToValueP(arg, value, Stella.FALSE))) {
                      { OutputStringStream stream001 = OutputStringStream.newOutputStringStream();
          ...
          queryiterator.augmentedGoalCacheP = Stella.FALSE;
          ...
          if (Logic.$ITERATIVE_DEEPENING_MODEp$ &&
            ...
            KeyValueList.setDynamicSlotValue(queryiterator.dynamicSlots, Logic.SYM_LOGIC_ITERATIVE_DEEPENINGp, (Stella.TRUE ? Stella.TRUE_WRAPPER : Stella.FALSE_WRAPPER), Stella.FALSE_WRAPPER);
          }
          ...
          queryiterator.triggeredDepthCutoffP = Stella.FALSE;
          queryiterator.failedToFindDuplicateSubgoalP = Stella.FALSE;
          queryiterator.foundAtLeastOneSolutionP = Stella.FALSE;
                ...
                if (parent != null) {
                  ...
                  if ((Logic.$CACHE_SUCCEEDED_GOALSp$ ||
                      ...
                      ((Logic.$DUPLICATE_SUBGOAL_STRATEGY$ == Logic.KWD_DUPLICATE_GOALS) &&
                       (!((((QueryIterator)(Logic.$QUERYITERATOR$.get())) != null) &&
                      (((QueryIterator)(Logic.$QUERYITERATOR$.get())).partialMatchStrategy != null))))) {
                    ControlFrame.cacheGoal(frame, Stella.TRUE, Stella.FALSE, clockticks);
                  }
                  else {
                    ControlFrame.updateGoalCache(frame, Stella.TRUE);
                  }
                }
                depth = depth - 1;
                if (checkformoveoutP) {
                ...
                if (parent != null) {
                  ...
                  if ((Logic.$CACHE_SUCCEEDED_GOALSp$ ||
                      ...
                      ((Logic.$DUPLICATE_SUBGOAL_STRATEGY$ == Logic.KWD_DUPLICATE_GOALS) &&
                       (!((((QueryIterator)(Logic.$QUERYITERATOR$.get())) != null) &&
                      (((QueryIterator)(Logic.$QUERYITERATOR$.get())).partialMatchStrategy != null))))) {
                    ControlFrame.cacheGoal(frame, Stella.TRUE, Stella.TRUE, clockticks);
                  }
                  else {
                    ControlFrame.updateGoalCache(frame, Stella.TRUE);
                  }
                ...
                if (parent != null) {
                  ...
                  if ((Logic.$CACHE_SUCCEEDED_GOALSp$ ||
                      ...
                      ((Logic.$DUPLICATE_SUBGOAL_STRATEGY$ == Logic.KWD_DUPLICATE_GOALS) &&
                       (!((((QueryIterator)(Logic.$QUERYITERATOR$.get())) != null) &&
                      (((QueryIterator)(Logic.$QUERYITERATOR$.get())).partialMatchStrategy != null))))) {
                    ControlFrame.cacheGoal(frame, Stella.FALSE, Stella.FALSE, clockticks);
                  }
                  else {
                    ControlFrame.updateGoalCache(frame, Stella.FALSE);
                  }
                }
                depth = depth - 1;
                if (checkformoveoutP) {
                ...
                if (parent != null) {
                  ...
                  if ((Logic.$CACHE_SUCCEEDED_GOALSp$ ||
                      ...
                      ((Logic.$DUPLICATE_SUBGOAL_STRATEGY$ == Logic.KWD_DUPLICATE_GOALS) &&
                       (!((((QueryIterator)(Logic.$QUERYITERATOR$.get())) != null) &&
                      (((QueryIterator)(Logic.$QUERYITERATOR$.get())).partialMatchStrategy != null))))) {
                    ControlFrame.cacheGoal(frame, Stella.FALSE, Stella.TRUE, clockticks);
                  }
                  else {
                    ControlFrame.updateGoalCache(frame, Stella.FALSE);
                  }
  ...
  public static Stella_Object accessQueryIteratorSlotValue(QueryIterator self, Symbol slotname, Stella_Object value, boolean setvalueP) {
    if (slotname == Logic.SYM_LOGIC_EXTERNAL_VARIABLES) {
      ...
      if (setvalueP) {
        ...
        value = Stella.wrapInteger(self.currentDepthCutoff);
      }
    }
      ...
      if (setvalueP) {
        ...
        value = Stella.wrapInteger(self.maximumDepth);
      }
    }
      ...
      if (setvalueP) {
        ...
        value = Stella.wrapFloat(self.allottedTime);
      }
    }
      ...
      if (setvalueP) {
        ...
        value = Stella.wrapInteger(self.currentClockTicks);
      }
    }
