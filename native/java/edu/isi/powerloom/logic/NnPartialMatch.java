  ...
  public double propositionWeight(Proposition proposition) {
    { NnPartialMatch self = this;
      ...
      if (((TruthValue)(Stella_Object.accessInContext(proposition.truthValue, proposition.homeContext, false))) != null) {
        KeyValueList.setDynamicSlotValue(proposition.dynamicSlots, Logic.SYM_LOGIC_WEIGHT, Stella.wrapFloat(((TruthValue)(Stella_Object.accessInContext(proposition.truthValue, proposition.homeContext, false))).positiveScore), Stella.NULL_FLOAT_WRAPPER);
      }
