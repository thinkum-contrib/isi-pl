...
public class NnPartialMatch extends PartialMatchFrame {
        ...
        { Object old$Queryiterator$000 = Logic.$QUERYITERATOR$.get();
          ...
          try {
            ...
            loop000 : for (;;) {
              ...
              if (scorelist.memberP(Stella.wrapFloat(latestscore))) {
                break loop000;
              }
                    ...
                    { List propscores = List.newList();
                      ...
                      { Stella_Object prop = null;
                        ...
                        while (index000 < length000) {
                          ...
                          if (collect000 == null) {
                            {
                              collect000 = Stella_Object.cons(Stella.wrapFloat(((FloatWrapper)(KeyValueList.dynamicSlotValue(((Proposition)(prop)).dynamicSlots, Logic.SYM_LOGIC_MATCH_SCORE, Stella.NULL_FLOAT_WRAPPER))).wrapperValue), Stella.NIL);
                            ...
                            {
                              collect000.rest = Stella_Object.cons(Stella.wrapFloat(((FloatWrapper)(KeyValueList.dynamicSlotValue(((Proposition)(prop)).dynamicSlots, Logic.SYM_LOGIC_MATCH_SCORE, Stella.NULL_FLOAT_WRAPPER))).wrapperValue), Stella.NIL);
              ...
              scorelist.push(Stella.wrapFloat(latestscore));
            }
            ...
            while ((!(iter001 == Stella.NIL)) &&
              ...
              { FloatWrapper k = null;
                ...
                while ((index001 < length001) &&
                  ...
                  KeyValueList.setDynamicSlotValue(((Proposition)(prop)).dynamicSlots, Logic.SYM_LOGIC_MATCH_SCORE, Stella.wrapFloat(k.wrapperValue), Stella.NULL_FLOAT_WRAPPER);
                }
              }
            }
          }
      ...
      if (Logic.$GREEDY_NETWORK_PRUNING$ &&
           ...
           (maxPossibleActive < self.dynamicCutoff))) {
        {
          if (Stella_Object.traceKeywordP(Logic.KWD_GOAL_TREE)) {
            System.out.println("*** Cutting off search, cutoff: " + self.dynamicCutoff + "+, Max possible score: " + maxPossibleActive);
          }
          return (Stella.TRUE);
        }
      }
  ...
  public void recordPartialMatchScore(double score, double weight) {
    { NnPartialMatch self = this;
      ...
      self.argumentScores = Stella_Object.cons(Stella.wrapFloat(score), self.argumentScores);
      self.argumentWeights = Stella_Object.cons(Stella.wrapFloat(weight), self.argumentWeights);
      ...
      { ControlFrame frame = self.controlFrame;
        ...
        if ((self.kind == Logic.KWD_ATOMIC_GOAL) &&
          ...
          { Proposition r = ((Proposition)(((Iterator)(KeyValueList.dynamicSlotValue(frame.dynamicSlots, Logic.SYM_STELLA_ITERATOR, null))).value));
            ...
            KeyValueList.setDynamicSlotValue(ante.dynamicSlots, Logic.SYM_LOGIC_MATCH_SCORE, Stella.wrapFloat(score), Stella.NULL_FLOAT_WRAPPER);
          }
        }
      }
    }
  ...
  public void setBasePartialMatchTruth(Proposition prop, Keyword truth) {
    { NnPartialMatch self = this;
      ...
      if (truth == Logic.KWD_TRUE) {
        if (prop != null) {
          {
            if (((FloatWrapper)(KeyValueList.dynamicSlotValue(prop.dynamicSlots, Logic.SYM_LOGIC_WEIGHT, Stella.NULL_FLOAT_WRAPPER))).wrapperValue != Stella.NULL_FLOAT) {
              KeyValueList.setDynamicSlotValue(prop.dynamicSlots, Logic.SYM_LOGIC_MATCH_SCORE, Stella.wrapFloat(((FloatWrapper)(KeyValueList.dynamicSlotValue(prop.dynamicSlots, Logic.SYM_LOGIC_WEIGHT, Stella.NULL_FLOAT_WRAPPER))).wrapperValue), Stella.NULL_FLOAT_WRAPPER);
            }
            else {
              KeyValueList.setDynamicSlotValue(prop.dynamicSlots, Logic.SYM_LOGIC_MATCH_SCORE, Stella.wrapFloat(1.0), Stella.NULL_FLOAT_WRAPPER);
            }
            KeyValueList.setDynamicSlotValue(((QueryIterator)(Logic.$QUERYITERATOR$.get())).dynamicSlots, Logic.SYM_LOGIC_LATEST_POSITIVE_SCORE, Stella.wrapFloat(((FloatWrapper)(KeyValueList.dynamicSlotValue(prop.dynamicSlots, Logic.SYM_LOGIC_MATCH_SCORE, Stella.NULL_FLOAT_WRAPPER))).wrapperValue), Stella.NULL_FLOAT_WRAPPER);
          }
        }
        else {
        ...
        if (prop != null) {
          KeyValueList.setDynamicSlotValue(prop.dynamicSlots, Logic.SYM_LOGIC_MATCH_SCORE, Stella.wrapFloat(0.0), Stella.NULL_FLOAT_WRAPPER);
        }
  ...
  public double propositionWeight(Proposition proposition) {
    { NnPartialMatch self = this;
      ...
      if (BooleanWrapper.coerceWrappedBooleanToBoolean(proposition.variableTypeP())) {
        KeyValueList.setDynamicSlotValue(proposition.dynamicSlots, Logic.SYM_LOGIC_WEIGHT, Stella.wrapFloat(0.0), Stella.NULL_FLOAT_WRAPPER);
      }
      if (((TruthValue)(Stella_Object.accessInContext(proposition.truthValue, proposition.homeContext, Stella.FALSE))) != null) {
        KeyValueList.setDynamicSlotValue(proposition.dynamicSlots, Logic.SYM_LOGIC_WEIGHT, Stella.wrapFloat(((TruthValue)(Stella_Object.accessInContext(proposition.truthValue, proposition.homeContext, Stella.FALSE))).positiveScore), Stella.NULL_FLOAT_WRAPPER);
      }
      if (((FloatWrapper)(KeyValueList.dynamicSlotValue(proposition.dynamicSlots, Logic.SYM_LOGIC_WEIGHT, Stella.NULL_FLOAT_WRAPPER))).wrapperValue == Stella.NULL_FLOAT) {
        KeyValueList.setDynamicSlotValue(proposition.dynamicSlots, Logic.SYM_LOGIC_WEIGHT, Stella.wrapFloat(1.0), Stella.NULL_FLOAT_WRAPPER);
      }
  ...
  public static Stella_Object accessNnPartialMatchSlotValue(NnPartialMatch self, Symbol slotname, Stella_Object value, boolean setvalueP) {
    if (slotname == Logic.SYM_LOGIC_PARENT) {
      ...
      if (setvalueP) {
        ...
        value = Stella.wrapFloat(self.accumulatedScore);
      }
    }
      ...
      if (setvalueP) {
        ...
        value = Stella.wrapFloat(self.maximumScore);
      }
    }
      ...
      if (setvalueP) {
        ...
        value = Stella.wrapInteger(self.arity);
      }
    }
    else {
      { OutputStringStream stream000 = OutputStringStream.newOutputStringStream();
