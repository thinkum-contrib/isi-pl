...
;
    ...
    { Vector skolemsvector = Vector.newVector(sub.ioVariables.length());
      ...
      try {
        ...
        result = Logic.callAsk(Description.createQueryIterator(renamed_Super, skolemsvector, "d-specialize"));
...
;
      ...
      try {
        { Object old$Context$000 = Stella.$CONTEXT$.get();
          ...
          try {
            ...
            result = Logic.callAsk(Description.createQueryIterator(renamed_Super, Stella.vector(Cons.cons(Description.getPrototype(sub), Stella.NIL)), "u-specializes"));
  ...
  public static QueryIterator createQueryIterator(Description description, Vector outsidebindings, String debugid) {
    return (QueryIterator.initializeQueryIterator(Logic.allocateQueryIterator(), description, outsidebindings, debugid));
  }
        ...
        loop002 : for (;iter002 != null; iter002 = iter002.rest) {
          ...
          { Cons outputbindings = null;
            ...
            if (traceforwardinferenceP) {
              if (tracegoaltreeP) {
                System.out.println("Proving forward goal: " + fwdindex.queryBody);
              }
            }
            ...
            if (tracegoaltreeP) {
              {
                System.out.println("Done proving forward goal: " + fwdindex.queryBody);
                System.out.println();
              }
;
            }
