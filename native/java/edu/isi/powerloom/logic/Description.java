    ...
    { boolean inferableP = false;
      ...
      if (Surrogate.subtypeOfP(Stella_Object.safePrimaryType(self), Logic.SGT_LOGIC_NAMED_DESCRIPTION)) {
        { NamedDescription self000 = ((NamedDescription)(self));
          ...
          { MemoizationTable memoTable000 = ((MemoizationTable)(Logic.SGT_LOGIC_F_INFERABLE_WITH_CYCLE_CHECKp_MEMO_TABLE_000.surrogateValue));
                ...
                if (testValue000) {
                  ...
                  if (testValue000) {
                    { boolean foundP000 = false;
                      ...
                      { Proposition p = null;
                        Cons iter000 = LogicObject.applicableRulesOfDescription(self000, Logic.KWD_BACKWARD, false);
...
;
  ...
  public static Description finishBuildingDescription(Description description, boolean checkforduplicateP) {
    ...
    Description.simplifyDescription(description, false);
    ...
    { Stella_Object value = null;
      ...
      { int i = Stella.NULL_INTEGER;
        ...
        while (index000 < length000) {
          ...
          if ((((Stella_Object)(Stella_Object.accessInContext(vbl.variableValue, vbl.homeContext, false))) != null) &&
              Logic.variableP(((Stella_Object)(Stella_Object.accessInContext(vbl.variableValue, vbl.homeContext, false))))) {
            value = ((Stella_Object)(Stella_Object.accessInContext(vbl.variableValue, vbl.homeContext, false)));
              ...
              { LogicObject value000 = ((LogicObject)(value));
                ...
                if (!(description.ioVariables.memberP(value000.variableValueInverse()))) {
                  { LogicObject object000 = value000;
                    ...
                    Stella_Object newValue000 = Stella_Object.updateInContext(oldValue003, value001, object000.homeContext, false);
  ...
  public static void fastenDownDescription(Description self) {
    { LogicObject ref = null;
      Cons iter000 = Description.collectConstantDescriptionReferences(self, null, false).theConsList;
  ...
  public static Description findDuplicateDescriptionWithConstantReference(Description self) {
    { LogicObject referencedconstant = ((LogicObject)(Description.collectConstantDescriptionReferences(self, null, true).first()));
  ...
  public static KeyValueList collectForwardChainingRules(Description description, Object [] MV_returnarray) {
    { MemoizationTable memoTable000 = ((MemoizationTable)(Logic.SGT_LOGIC_F_COLLECT_FORWARD_CHAINING_RULES_MEMO_TABLE_000.surrogateValue));
      Cons memoizedEntry000 = null;
      Stella_Object memoizedValue000 = null;
