...
public class NamedDescription extends Description {
  ...
  public static Cons allDirectSubrelations(NamedDescription relation, boolean removeequivalentsP) {
    { MemoizationTable memoTable000 = ((MemoizationTable)(Logic.SGT_LOGIC_F_ALL_DIRECT_SUBRELATIONS_MEMO_TABLE_000.surrogateValue));
  ...
  public static Cons allDirectSuperrelations(NamedDescription relation, boolean removeequivalentsP) {
    { MemoizationTable memoTable000 = ((MemoizationTable)(Logic.SGT_LOGIC_F_ALL_DIRECT_SUPERRELATIONS_MEMO_TABLE_000.surrogateValue));
      Cons memoizedEntry000 = null;
      Stella_Object memoizedValue000 = null;
  ...
  public static Cons allSubrelations(NamedDescription relation, boolean removeequivalentsP) {
    { MemoizationTable memoTable000 = ((MemoizationTable)(Logic.SGT_LOGIC_F_ALL_SUBRELATIONS_MEMO_TABLE_000.surrogateValue));
      Cons memoizedEntry000 = null;
      Stella_Object memoizedValue000 = null;
  ...
  public static Cons allSuperrelations(NamedDescription relation, boolean removeequivalentsP) {
    { MemoizationTable memoTable000 = ((MemoizationTable)(Logic.SGT_LOGIC_F_ALL_SUPERRELATIONS_MEMO_TABLE_000.surrogateValue));
      Cons memoizedEntry000 = null;
      Stella_Object memoizedValue000 = null;
  ...
  public static Cons allEquivalentRelations(NamedDescription relation, boolean reflexiveP) {
    { MemoizationTable memoTable000 = ((MemoizationTable)(Logic.SGT_LOGIC_F_ALL_EQUIVALENT_RELATIONS_MEMO_TABLE_000.surrogateValue));
      Cons memoizedEntry000 = null;
      Stella_Object memoizedValue000 = null;
          ...
          { int i = Stella.NULL_INTEGER;
            ...
            while ((!(iter002 == Stella.NIL)) &&
              ...
              if ((type != null) &&
                ...
                if (collect000 == null) {
                  {
                    collect000 = Stella_Object.cons(Stella.list$(Stella_Object.cons(Logic.SYM_PL_KERNEL_KB_NTH_DOMAIN, Stella_Object.cons(name, Stella_Object.cons(Stella_Object.cons(Stella.wrapInteger(i), Stella_Object.cons(Stella.internSymbolInModule(type.symbolName, ((Module)(type.homeContext)), true), Stella.NIL)), Stella.NIL)))), Stella.NIL);
                  ...
                  {
                    collect000.rest = Stella_Object.cons(Stella.list$(Stella_Object.cons(Logic.SYM_PL_KERNEL_KB_NTH_DOMAIN, Stella_Object.cons(name, Stella_Object.cons(Stella_Object.cons(Stella.wrapInteger(i), Stella_Object.cons(Stella.internSymbolInModule(type.symbolName, ((Module)(type.homeContext)), true), Stella.NIL)), Stella.NIL)))), Stella.NIL);
  ...
  public static boolean relationSupportsExtensionP(NamedDescription self) {
    return ((!Logic.testPropertyP(self, Logic.SGT_PL_KERNEL_KB_ABSTRACT)) &&
        ((!Logic.logicalSubtypeOfLiteralP(self.surrogateValueInverse)) &&
         (true ||
          (((Description)(Stella_Object.accessInContext(KeyValueList.dynamicSlotValue(self.dynamicSlots, Logic.SYM_LOGIC_EQUIVALENT_VALUE, null), self.homeContext, false))) != null))));
  }
