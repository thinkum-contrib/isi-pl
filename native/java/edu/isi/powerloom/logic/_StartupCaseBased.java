...
public class _StartupCaseBased {
  static void helpStartupCaseBased1() {
    {
      ...
      Logic.SYM_PL_KERNEL_KB_CASE_MATCH = ((Symbol)(Stella.internRigidSymbolWrtModule("CASE-MATCH", Stella.getStellaModule("/PL-KERNEL-KB", Stella.TRUE), 0)));
      Logic.KWD_WEIGHTED_AVERAGE = ((Keyword)(Stella.internRigidSymbolWrtModule("WEIGHTED-AVERAGE", null, 2)));
      Logic.SGT_STELLA_FLOAT_WRAPPER = ((Surrogate)(Stella.internRigidSymbolWrtModule("FLOAT-WRAPPER", Stella.getStellaModule("/STELLA", Stella.TRUE), 1)));
      Logic.SGT_STELLA_INTEGER_WRAPPER = ((Surrogate)(Stella.internRigidSymbolWrtModule("INTEGER-WRAPPER", Stella.getStellaModule("/STELLA", Stella.TRUE), 1)));
      ...
      Logic.SYM_STELLA_SECOND = ((Symbol)(Stella.internRigidSymbolWrtModule("SECOND", Stella.getStellaModule("/STELLA", Stella.TRUE), 0)));
  ...
  static void helpStartupCaseBased2() {
    {
      Logic.$LOG_MATCH_RULES$ = Stella.FALSE;
      Logic.$LOG_ANTECEDENT_CONSTRUCTION$ = Stella.FALSE;
      ...
      Logic.$ONLY_VARIABLIZE_VISITED_INSTANCES$ = Stella.FALSE;
      ...
      Logic.$PRINT_CASE_DISTANCES$ = Stella.FALSE;
    }
  }
  ...
  static void helpStartupCaseBased3() {
    {
      ...
      { MethodSlot function = Symbol.lookupFunction(Logic.SYM_LOGIC_STARTUP_CASE_BASED);
        ...
        KeyValueList.setDynamicSlotValue(function.dynamicSlots, Logic.SYM_STELLA_METHOD_STARTUP_CLASSNAME, Stella.wrapString("_Startup-Case-Based"), Stella.NULL_STRING_WRAPPER);
      }
    }
  }
