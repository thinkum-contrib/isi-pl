  ...
  static void helpStartupRuleInduction1() {
    {
      ...
      Logic.SYM_STELLA_l = ((Symbol)(Stella.internRigidSymbolWrtModule("<", Stella.getStellaModule("/STELLA", Stella.TRUE), 0)));
  ...
  static void helpStartupRuleInduction2() {
    {
      ...
      Logic.$ENABLE_USER_THING$ = Stella.TRUE;
      Logic.$OPTIMIZE_INDUCED_QUERIES$ = Stella.TRUE;
      Logic.$SIMPLIFY_RULE_ANTECEDENTp$ = Stella.FALSE;
      Logic.$TRACE_ID3$ = Stella.FALSE;
      Logic.$TRACE_FOIL$ = Stella.FALSE;
      Logic.$INDUCE_RULES_FROM_SIGNATURES$ = Stella.TRUE;
      Logic.$ENFORCE_LINKED_VARIABLES$ = Stella.FALSE;
      Logic.$LOG_INDUCED_RULES$ = Stella.FALSE;
      Logic.$ALLOW_RECURSIVE_DECISION_NODES$ = Stella.TRUE;
      Logic.$LOG_DECISION_RULE_CONSTRUCTION$ = Stella.FALSE;
      Logic.$BOTTOM_UP_VARIABLE_COUNTER$.setDefaultValue(new Integer(-1));
    }
  }

  static void helpStartupRuleInduction3() {
    {
      ...
      Stella.defineFunctionObject("PRINT-DECISION-TREE", "(DEFUN PRINT-DECISION-TREE ((TREE DECISION-TREE) (STREAM NATIVE-OUTPUT-STREAM)))", Native.find_java_method("edu.isi.powerloom.logic.DecisionTree", "printDecisionTree", new java.lang.Class [] {Native.find_java_class("edu.isi.powerloom.logic.DecisionTree"), Native.find_java_class("java.io.PrintStream")}), null);
      Stella.defineFunctionObject("HELP-PRINT-DECISION-TREE", "(DEFUN HELP-PRINT-DECISION-TREE ((TREE DECISION-TREE) (LEVEL INTEGER) (STREAM NATIVE-OUTPUT-STREAM)))", Native.find_java_method("edu.isi.powerloom.logic.DecisionTree", "helpPrintDecisionTree", new java.lang.Class [] {Native.find_java_class("edu.isi.powerloom.logic.DecisionTree"), java.lang.Integer.TYPE, Native.find_java_class("java.io.PrintStream")}), null);
    ...
    { Object old$Module$000 = Stella.$MODULE$.get();
      ...
      try {
        ...
        if (Stella.currentStartupTimePhaseP(7)) {
          _StartupRuleInduction.helpStartupRuleInduction3();
          ...
          { MethodSlot function = Symbol.lookupFunction(Logic.SYM_LOGIC_STARTUP_RULE_INDUCTION);
            ...
            KeyValueList.setDynamicSlotValue(function.dynamicSlots, Logic.SYM_STELLA_METHOD_STARTUP_CLASSNAME, Stella.wrapString("_Startup-Rule-Induction"), Stella.NULL_STRING_WRAPPER);
          }
        }
