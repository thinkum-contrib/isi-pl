  ...
  static void helpStartupRuleInduction2() {
    {
      ...
      Logic.$SIMPLIFY_RULE_ANTECEDENTp$ = false;
      Logic.$TRACE_ID3$ = false;
      Logic.$TRACE_FOIL$ = false;
      Logic.$INDUCE_RULES_FROM_SIGNATURES$ = true;
      Logic.$ENFORCE_LINKED_VARIABLES$ = false;
      Logic.$LOG_INDUCED_RULES$ = false;
      Logic.$ALLOW_RECURSIVE_DECISION_NODES$ = true;
      Logic.$LOG_DECISION_RULE_CONSTRUCTION$ = false;
