  ...
  static void helpStartupMachineLearning1() {
    {
      ...
      Logic.SYM_STELLA_NAME = ((Symbol)(Stella.internRigidSymbolWrtModule("NAME", Stella.getStellaModule("/STELLA", Stella.TRUE), 0)));
      ...
      Logic.SYM_STELLA_THING = ((Symbol)(Stella.internRigidSymbolWrtModule("THING", Stella.getStellaModule("/STELLA", Stella.TRUE), 0)));
      ...
      Logic.SGT_STELLA_NUMBER_WRAPPER = ((Surrogate)(Stella.internRigidSymbolWrtModule("NUMBER-WRAPPER", Stella.getStellaModule("/STELLA", Stella.TRUE), 1)));
      Logic.SYM_STELLA_ge = ((Symbol)(Stella.internRigidSymbolWrtModule(">=", Stella.getStellaModule("/STELLA", Stella.TRUE), 0)));
      Logic.SYM_STELLA_el = ((Symbol)(Stella.internRigidSymbolWrtModule("=<", Stella.getStellaModule("/STELLA", Stella.TRUE), 0)));
    ...
    { Object old$Module$000 = Stella.$MODULE$.get();
      ...
      try {
        ...
        if (Stella.currentStartupTimePhaseP(4)) {
          ...
          Logic.$CLOSED_WORLD_TRAINING_EXAMPLES$ = Stella.TRUE;
          Logic.$DROP_FUNCTION_VALUESp$ = Stella.TRUE;
