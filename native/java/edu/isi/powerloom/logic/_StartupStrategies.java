  ...
  static void helpStartupStrategies1() {
    {
      ...
      Logic.SYM_STELLA_PHASE = ((Symbol)(Stella.internRigidSymbolWrtModule("PHASE", Stella.getStellaModule("/STELLA", Stella.TRUE), 0)));
  ...
  static void helpStartupStrategies2() {
    {
      ...
      Stella.defineFunctionObject("CREATE-HYPOTHESIZED-SKOLEM", "(DEFUN (CREATE-HYPOTHESIZED-SKOLEM SKOLEM) ((PREFIX STRING)))", Native.find_java_method("edu.isi.powerloom.logic.Logic", "createHypothesizedSkolem", new java.lang.Class [] {Native.find_java_class("java.lang.String")}), null);
      ...
      try {
        ...
        if (Stella.currentStartupTimePhaseP(7)) {
          ...
          { MethodSlot function = Symbol.lookupFunction(Logic.SYM_LOGIC_STARTUP_STRATEGIES);
            ...
            KeyValueList.setDynamicSlotValue(function.dynamicSlots, Logic.SYM_STELLA_METHOD_STARTUP_CLASSNAME, Stella.wrapString("_Startup-Strategies"), Stella.NULL_STRING_WRAPPER);
          }
        }
