    ...
    { IncrementalPartialMatch self = this;
      ...
      { ControlFrame frame = self.controlFrame;
        ...
        if (result == Logic.KWD_MOVE_DOWN) {
          ...
          self.setFramePartialTruth(null, self.computeOrScore(), Stella.NULL_FLOAT, Stella.FALSE);
        }
        else {
        }
        return (result);
          ...
          { Proposition arg = null;
            ...
            while (index000 < length000) {
              ...
              if ((arg.kind == Logic.KWD_AND) &&
                ...
                KeyValueList.setDynamicSlotValue(arg.dynamicSlots, Logic.SYM_LOGIC_WEIGHT, Stella.wrapFloat(argumentweight), Stella.NULL_FLOAT_WRAPPER);
              }
              else {
  ...
  public static Stella_Object accessIncrementalPartialMatchSlotValue(IncrementalPartialMatch self, Symbol slotname, Stella_Object value, boolean setvalueP) {
    if (slotname == Logic.SYM_LOGIC_PARENT) {
      ...
      if (setvalueP) {
        ...
        value = Stella.wrapFloat(self.accumulatedWeight);
      }
    }
      ...
      if (setvalueP) {
        ...
        value = Stella.wrapFloat(self.totalWeight);
      }
    }
