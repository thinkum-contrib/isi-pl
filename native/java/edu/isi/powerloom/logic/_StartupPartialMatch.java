...
public class _StartupPartialMatch {
  static void helpStartupPartialMatch1() {
    {
      ...
      Logic.SYM_STELLA_ARITY = ((Symbol)(Stella.internRigidSymbolWrtModule("ARITY", Stella.getStellaModule("/STELLA", Stella.TRUE), 0)));
      ...
      Logic.SGT_PL_KERNEL_KB_NULL = ((Surrogate)(Stella.internRigidSymbolWrtModule("NULL", Stella.getStellaModule("/PL-KERNEL-KB", Stella.TRUE), 1)));
  ...
  static void helpStartupPartialMatch2() {
    {
      ...
      Logic.$GREEDY_NETWORK_PRUNING$ = Stella.TRUE;
      Logic.$RULE_COMBINATION$ = Logic.KWD_MAX;
      Logic.$PLANNING_MODE$ = Stella.FALSE;
      Logic.$PLANABLE_PREDICATES$ = Stella.NIL;
      Logic.$FAIL_UNBOUND_CLAUSESp$ = Stella.FALSE;
      Logic.$AND_MISSED_A_BINDING$ = Stella.FALSE;
    }
  }
  ...
  static void helpStartupPartialMatch4() {
    {
      ...
      { MethodSlot function = Symbol.lookupFunction(Logic.SYM_LOGIC_STARTUP_PARTIAL_MATCH);
        ...
        KeyValueList.setDynamicSlotValue(function.dynamicSlots, Logic.SYM_STELLA_METHOD_STARTUP_CLASSNAME, Stella.wrapString("_Startup-Partial-Match"), Stella.NULL_STRING_WRAPPER);
      }
    }
  }
    ...
    { Object old$Module$000 = Stella.$MODULE$.get();
      ...
      try {
        ...
        if (Stella.currentStartupTimePhaseP(7)) {
          ...
          _StartupPartialMatch.helpStartupPartialMatch4();
        }
