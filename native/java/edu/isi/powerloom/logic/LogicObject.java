...
public class LogicObject extends ContextSensitiveObject {
      ...
      if (LogicObject.allSupercollections(self).memberP(self)) {
        loop000 : for (;;) {
          ...
          { LogicObject parent = null;
            Iterator iter000 = LogicObject.allDirectSupercollections(u, Stella.FALSE);
      ...
      try {
        ...
        if (!LogicObject.downclassifiedP(self)) {
          ...
          if ((Stella.$TRACED_KEYWORDS$ != null) &&
            ...
            System.out.println("DOWNCLASSIFY-ONE-DESCRIPTION:  " + self);
          }
          Logic.emitThinkingDot(Logic.KWD_DOWNCLASSIFY);
          { MarkerTable alreadyvisitedtable = Logic.createMarkerStorage(Stella.FALSE);
            Cons parents = Description.allNamedDirectSuperdescriptions(((Description)(self)), Stella.FALSE);
  ...
  public static void helpDownclassifyOneDescription(LogicObject node, LogicObject self, Cons necessaryancestors, MarkerTable alreadyvisitedtable) {
    ...
    { boolean nodecouldbetheoneP = Stella.TRUE;
      ...
      if (Logic.upclassificationTimestamp(node) == -1) {
        ...
        { boolean foundP000 = Stella.FALSE;
          ...
          if (foundP000) {
            nodecouldbetheoneP = Stella.FALSE;
          }
          else {
            LogicObject.upclassifyOneDescription(node);
          }
  ...
  public static void upclassifyOneDescription(LogicObject self) {
    ...
    if ((Stella.$TRACED_KEYWORDS$ != null) &&
        (Stella.$TRACED_KEYWORDS$.membP(Logic.KWD_CLASSIFIER) ||
         Stella.$TRACED_KEYWORDS$.membP(Logic.KWD_CLASSIFIER_PROFILE))) {
      System.out.println("UPCLASSIFY: " + self);
    }
    Logic.emitThinkingDot(Logic.KWD_UPCLASSIFY);
    { Cons equivalents = LogicObject.allEquivalentCollections(self, Stella.TRUE);
    ...
    { NamedDescription renamed_Super = null;
      Cons iter002 = Description.allNamedDirectSuperdescriptions(((Description)(self)), Stella.TRUE);
  ...
  public static void helpUpclassifyOneEntity(LogicObject self, Keyword instanceordescription) {
    ...
    { MarkerTable alreadyvisitedtable = Logic.createMarkerStorage(Stella.FALSE);
      MarkerTable instanceisbelowtable = Logic.createMarkerStorage(Stella.FALSE);
      ...
      if ((Stella.$TRACED_KEYWORDS$ != null) &&
          Stella.$TRACED_KEYWORDS$.membP(Logic.KWD_CLASSIFIER)) {
        {
          System.out.println("   WORLD: " + ((Context)(Stella.$CONTEXT$.get())) + "  self: " + self);
          System.out.println("   ANCESTORS: " + Logic.allAncestorCollections(self, instanceordescription).consify());
        }
;
      }
      { LogicObject renamed_Super = null;
  ...
  public static void collectSubsumingParentsBelow(LogicObject self, Description renamed_Super, List newparentdescriptions, MarkerTable alreadyvisitedtable, MarkerTable selfisbelowtable, java.lang.reflect.Method subsumptiontest) {
    if ((Stella.$TRACED_KEYWORDS$ != null) &&
        Stella.$TRACED_KEYWORDS$.membP(Logic.KWD_CLASSIFIER)) {
      System.out.println("COLLECT-SUBSUMING  self= " + self + "    super= " + renamed_Super);
    }
    if ((Stella.$TRACED_KEYWORDS$ != null) &&
        Stella.$TRACED_KEYWORDS$.membP(Logic.KWD_CLASSIFIER)) {
  ...
  public static boolean helpCollectParentsBelowP(LogicObject self, Description renamed_Super, List newparentdescriptions, MarkerTable alreadyvisitedtable, MarkerTable selfisbelowtable, java.lang.reflect.Method subsumptiontest) {
    if ((Stella.$TRACED_KEYWORDS$ != null) &&
        Stella.$TRACED_KEYWORDS$.membP(Logic.KWD_CLASSIFIER)) {
      System.out.println("HELP-COLLECT-PARENTS-BELOW  self= " + self + "    super= " + renamed_Super);
    }
    if ((Stella.$TRACED_KEYWORDS$ != null) &&
        Stella.$TRACED_KEYWORDS$.membP(Logic.KWD_CLASSIFIER)) {
      System.out.println("   TEST-MARKER of 'super': " + selfisbelowtable.testMarkerP(renamed_Super));
    }
    { boolean foundsubsumingsubP = Stella.FALSE;

      alreadyvisitedtable.setMarker(renamed_Super);
      if (selfisbelowtable.testMarkerP(renamed_Super)) {
        foundsubsumingsubP = Stella.TRUE;
        { Description sub = null;
          Cons iter000 = LogicObject.allInferableDirectSubcollections(renamed_Super).theConsList;
          ...
          { boolean existsmorespecificsubP = foundP000;
            ...
            if (!existsmorespecificsubP) {
              if ((Stella.$TRACED_KEYWORDS$ != null) &&
                ...
                {
                  System.out.println();
                  System.out.println("XXXXXXX PUSHING NEW PARENT: " + renamed_Super + "  of " + self);
                  System.out.println();
                }
;
              }
  ...
  public static void addIsaLink(LogicObject instance, Description superdescription) {
    { Proposition isaprop = Logic.assertIsaProposition(instance, superdescription.surrogateValueInverse);
      ...
      KeyValueList.setDynamicSlotValue(isaprop.dynamicSlots, Logic.SYM_LOGIC_SUBSUMPTION_LINKp, (Stella.TRUE ? Stella.TRUE_WRAPPER : Stella.FALSE_WRAPPER), Stella.FALSE_WRAPPER);
      if (Stella_Object.traceKeywordP(Logic.KWD_CLASSIFIER_INFERENCES)) {
        { Object old$PrintreadablyP$000 = Stella.$PRINTREADABLYp$.get();
          ...
          try {
            ...
            System.out.println("Recognized type: " + isaprop);
  ...
  public static Cons allSupportedNamedSubcollections(LogicObject self) {
    { MemoizationTable memoTable000 = ((MemoizationTable)(Logic.SGT_LOGIC_ALL_SUPPORTED_NAMED_SUBCOLLECTIONS_MEMO_TABLE_000.surrogateValue));
      Cons memoizedEntry000 = null;
      Stella_Object memoizedValue000 = null;

      if (memoTable000 == null) {
        Surrogate.initializeMemoizationTable(Logic.SGT_LOGIC_ALL_SUPPORTED_NAMED_SUBCOLLECTIONS_MEMO_TABLE_000, "(:MAX-VALUES 1000 :TIMESTAMPS (:META-KB-UPDATE))");
        memoTable000 = ((MemoizationTable)(Logic.SGT_LOGIC_ALL_SUPPORTED_NAMED_SUBCOLLECTIONS_MEMO_TABLE_000.surrogateValue));
      }
  ...
  public static Iterator allSupercollections(LogicObject self) {
    { MemoizationTable memoTable000 = ((MemoizationTable)(Logic.SGT_LOGIC_ALL_SUPERCOLLECTIONS_MEMO_TABLE_000.surrogateValue));
      Cons memoizedEntry000 = null;
      Stella_Object memoizedValue000 = null;

      if (memoTable000 == null) {
        Surrogate.initializeMemoizationTable(Logic.SGT_LOGIC_ALL_SUPERCOLLECTIONS_MEMO_TABLE_000, "(:MAX-VALUES 1000 :TIMESTAMPS (:META-KB-UPDATE))");
        memoTable000 = ((MemoizationTable)(Logic.SGT_LOGIC_ALL_SUPERCOLLECTIONS_MEMO_TABLE_000.surrogateValue));
      }
      if (Stella.$MEMOIZATION_ENABLEDp$) {
  ...
  public static Iterator allDirectSubcollectionsWithEquivalents(LogicObject self) {
    return (LogicObject.allDirectSubcollections(self, Stella.FALSE));
  }
          ...
          { LogicObject e = null;
            ...
            while (!(iter000 == Stella.NIL)) {
              ...
              { LogicObject child = null;
                Iterator iter001 = LogicObject.allDirectSubcollections(e, Stella.FALSE);
  ...
  public static Iterator allDirectSupercollectionsWithEquivalents(LogicObject self) {
    return (LogicObject.allDirectSupercollections(self, Stella.FALSE));
  }
        ...
        if (!(equivalents.rest == Stella.NIL)) {
          { LogicObject e = null;
            ...
            while (!(iter000 == Stella.NIL)) {
              ...
              { LogicObject parent = null;
                Iterator iter001 = LogicObject.allDirectSupercollections(e, Stella.FALSE);
  ...
  public static boolean expensiveEmptyTermP(LogicObject self) {
    { LogicObject super1 = null;
      Iterator iter000 = LogicObject.allDirectSupercollections(self, Stella.FALSE);

      while (iter000.nextP()) {
        super1 = ((LogicObject)(iter000.value));
        { LogicObject super2 = null;
          Iterator iter001 = LogicObject.allDirectSupercollections(self, Stella.FALSE);
  ...
  public static void helpDerivePartitionMemberships(LogicObject self, LogicObject renamed_Super, List tuples) {
    { Stella_Object mc = null;
      ...
      while (!(iter000 == Stella.NIL)) {
        ...
        { Proposition mdcproposition = ((Proposition)(Logic.allTrueDependentPropositions(mc, Logic.SGT_PL_KERNEL_KB_MUTUALLY_DISJOINT_COLLECTION, Stella.FALSE).consify().value));
    ...
    { Proposition p = null;
      Iterator iter001 = Logic.allTrueDependentPropositions(renamed_Super, Logic.SGT_PL_KERNEL_KB_DISJOINT, Stella.FALSE);
  ...
  public static boolean conceptPrototypeP(LogicObject self) {
    { boolean testValue000 = Stella.FALSE;
      ...
      testValue000 = ((BooleanWrapper)(KeyValueList.dynamicSlotValue(self.dynamicSlots, Logic.SYM_LOGIC_HYPOTHESIZED_INSTANCEp, Stella.FALSE_WRAPPER))).wrapperValue;
      if (testValue000) {
        { boolean foundP000 = Stella.FALSE;
    ...
    { int num = cases.length();
      ...
      { int i = Stella.NULL_INTEGER;
        ...
        while (iter000 <= upperBound000) {
          ...
          (nearestNeighbors.theArray)[i] = (Stella.wrapInteger(0));
        }
      }
      { int i = Stella.NULL_INTEGER;
        int iter001 = 0;
        ...
        while (iter001 <= upperBound001) {
          ...
          (matchScores.theArray)[i] = (Stella.wrapFloat(1.0));
        }
      }
          ...
          if (!(probe == renamed_Case)) {
            { FloatWrapper score = LogicObject.matchInstances(probe, ((LogicObject)(renamed_Case)));
              ...
              if (score.wrapperValue > ((FloatWrapper)((matchScores.theArray)[(((IntegerWrapper)((nearestNeighbors.theArray)[farthest])).wrapperValue)])).wrapperValue) {
                (nearestNeighbors.theArray)[farthest] = (Stella.wrapInteger(i));
                farthest = 0;
  ...
  public static FloatWrapper matchInstances(LogicObject x, LogicObject y) {
    { Cons prop = Stella.list$(Stella_Object.cons(Logic.SYM_PL_KERNEL_KB_CASE_MATCH, Stella_Object.cons(x, Stella_Object.cons(Stella_Object.cons(y, Stella.NIL), Stella.NIL))));
      ...
      return (Stella.wrapFloat(QueryIterator.returnPartialTruth(Logic.makeQuery(Stella.NIL, Logic.coerceToTree(prop), Stella.NIL, Stella.NIL), Stella.TRUE)));
    }
  }
  ...
  public static boolean deletedLogicObjectP(LogicObject self) {
  ...
  public static void retractFactsOfInstance(LogicObject self) {
    ...
    { Proposition p = null;
      Cons iter000 = Logic.allFactsOfInstance(self, Stella.FALSE, Stella.TRUE).theConsList;
      ...
      loop000 : while (!(iter000 == Stella.NIL)) {
        ...
        if (p.kind == Logic.KWD_FUNCTION) {
          { Skolem skolem = ((Skolem)(p.arguments.last()));
            ...
            if ((skolem != null) &&
                (((Stella_Object)(Stella_Object.accessInContext(skolem.variableValue, skolem.homeContext, Stella.FALSE))) != null)) {
              Proposition.unassertFact(p);
            }
  ...
  public static void evaluateReachableInequalities(LogicObject self, List visitedlist) {
    { Proposition p = null;
      Iterator iter000 = Logic.allTrueDependentPropositions(self, Logic.SGT_PL_KERNEL_KB_INEQUALITY, Stella.TRUE);
    ...
    { Proposition value000 = null;
      ...
      { Proposition propertyproposition = value000;
        ...
        if ((surrogate == null) ||
          ...
          System.out.println("Error: Property " + surrogate + " is not defined.");
          return (null);
        }
        if (propertyproposition == null) {
          ...
          Proposition.fastenDownOneProposition(propertyproposition, Stella.TRUE);
        }
    ...
    { Stella_Object oldvalue = null;
      ...
      if (Surrogate.subtypeOfP(Stella_Object.safePrimaryType(self), Logic.SGT_LOGIC_SKOLEM)) {
        ...
        { LogicObject object001 = self;
          ...
          Stella_Object newValue001 = Stella_Object.updateInContext(oldValue001, value001, object001.homeContext, Stella.FALSE);
        ...
        { LogicObject oldvalue000 = ((LogicObject)(oldvalue));
          ...
          if (((LogicObject)(oldvalue000.variableValueInverse().value)) == self) {
            { LogicObject object002 = oldvalue000;
              ...
              Stella_Object newValue002 = Stella_Object.updateInContext(oldValue002, value002, object002.homeContext, Stella.FALSE);
            ...
            { LogicObject object003 = oldvalue000;
              ...
              Stella_Object newValue003 = Stella_Object.updateInContext(oldValue003, value003, object003.homeContext, Stella.FALSE);
  ...
  public static void unbindEquivalentValue(LogicObject self) {
    if (Surrogate.subtypeOfP(Stella_Object.safePrimaryType(self), Logic.SGT_LOGIC_SKOLEM)) {
      { Skolem self000 = ((Skolem)(self));
        ...
        Skolem.unbindSkolemValue(self000, Stella.FALSE);
      }
    }
    else {
  ...
  public static void bindToEquivalentValue(LogicObject from, Description to) {
    ...
    if (Surrogate.subtypeOfP(Stella_Object.safePrimaryType(from), Logic.SGT_LOGIC_SKOLEM)) {
      ...
      if (((Description)(Stella_Object.accessInContext(KeyValueList.dynamicSlotValue(from.dynamicSlots, Logic.SYM_LOGIC_EQUIVALENT_VALUE, null), from.homeContext, Stella.FALSE))) == to) {
        return;
      }
  ...
  public static Stella_Object accessLogicObjectSlotValue(LogicObject self, Symbol slotname, Stella_Object value, boolean setvalueP) {
    if (slotname == Logic.SYM_LOGIC_DEPENDENT_DESCRIPTIONS) {
      if (setvalueP) {
        KeyValueList.setDynamicSlotValue(self.dynamicSlots, Logic.SYM_LOGIC_DEPENDENT_DESCRIPTIONS, ((List)(value)), null);
      }
      else {
        value = self.dependentDescriptions();
      }
    }
  ...
  public Cons variableValueInverse() {
    { LogicObject self = this;
      ...
      { Cons answer = ((Cons)(Stella_Object.accessInContext(self.variableValueInverse, self.homeContext, Stella.FALSE)));
  ...
  public List dependentDescriptions() {
    { LogicObject self = this;

      { List answer = ((List)(KeyValueList.dynamicSlotValue(self.dynamicSlots, Logic.SYM_LOGIC_DEPENDENT_DESCRIPTIONS, null)));
