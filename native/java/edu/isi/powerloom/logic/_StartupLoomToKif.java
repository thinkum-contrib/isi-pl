...
public class _StartupLoomToKif {
  static void helpStartupLoomToKif1() {
    {
      Logic.SYM_STELLA_INVERSE = ((Symbol)(Stella.internRigidSymbolWrtModule("INVERSE", Stella.getStellaModule("/STELLA", Stella.TRUE), 0)));
      Logic.SYM_PL_KERNEL_KB_INVERSE = ((Symbol)(Stella.internRigidSymbolWrtModule("INVERSE", Stella.getStellaModule("/PL-KERNEL-KB", Stella.TRUE), 0)));
      ...
      Logic.SYM_PL_KERNEL_KB_RANGE_CARDINALITY_LOWER_BOUND = ((Symbol)(Stella.internRigidSymbolWrtModule("RANGE-CARDINALITY-LOWER-BOUND", Stella.getStellaModule("/PL-KERNEL-KB", Stella.TRUE), 0)));
      Logic.SYM_PL_KERNEL_KB_RANGE_CARDINALITY_UPPER_BOUND = ((Symbol)(Stella.internRigidSymbolWrtModule("RANGE-CARDINALITY-UPPER-BOUND", Stella.getStellaModule("/PL-KERNEL-KB", Stella.TRUE), 0)));
      Logic.SYM_PL_KERNEL_KB_RANGE_CARDINALITY = ((Symbol)(Stella.internRigidSymbolWrtModule("RANGE-CARDINALITY", Stella.getStellaModule("/PL-KERNEL-KB", Stella.TRUE), 0)));
      Logic.SYM_PL_KERNEL_KB_RANGE_TYPE = ((Symbol)(Stella.internRigidSymbolWrtModule("RANGE-TYPE", Stella.getStellaModule("/PL-KERNEL-KB", Stella.TRUE), 0)));
      ...
      Logic.SYM_STELLA_RETRACT = ((Symbol)(Stella.internRigidSymbolWrtModule("RETRACT", Stella.getStellaModule("/STELLA", Stella.TRUE), 0)));
      Logic.KWD_3_VALUED_P = ((Keyword)(Stella.internRigidSymbolWrtModule("3-VALUED-P", null, 2)));
      Logic.SYM_STELLA_ASK = ((Symbol)(Stella.internRigidSymbolWrtModule("ASK", Stella.getStellaModule("/STELLA", Stella.TRUE), 0)));
      Logic.SYM_STELLA_CONSIFY = ((Symbol)(Stella.internRigidSymbolWrtModule("CONSIFY", Stella.getStellaModule("/STELLA", Stella.TRUE), 0)));
      Logic.SYM_STELLA_RETRIEVE = ((Symbol)(Stella.internRigidSymbolWrtModule("RETRIEVE", Stella.getStellaModule("/STELLA", Stella.TRUE), 0)));
      ...
      Logic.SYM_STELLA_CHANGE_CONTEXT = ((Symbol)(Stella.internRigidSymbolWrtModule("CHANGE-CONTEXT", Stella.getStellaModule("/STELLA", Stella.TRUE), 0)));
    ...
    { Object old$Module$000 = Stella.$MODULE$.get();
      ...
      try {
        ...
        if (Stella.currentStartupTimePhaseP(7)) {
          ...
          Stella.defineFunctionObject("TRANSLATE-LOOM-FILE", "(DEFUN TRANSLATE-LOOM-FILE ((INPUT FILE-NAME) (OUTPUT FILE-NAME)))", Native.find_java_method("edu.isi.powerloom.logic.Logic", "translateLoomFile", new java.lang.Class [] {Native.find_java_class("java.lang.String"), Native.find_java_class("java.lang.String")}), null);
          ...
          { MethodSlot function = Symbol.lookupFunction(Logic.SYM_LOGIC_STARTUP_LOOM_TO_KIF);
            ...
            KeyValueList.setDynamicSlotValue(function.dynamicSlots, Logic.SYM_STELLA_METHOD_STARTUP_CLASSNAME, Stella.wrapString("_Startup-Loom-To-Kif"), Stella.NULL_STRING_WRAPPER);
          }
        }
