...
;
  ...
  public static Iterator allClashingPropositions(Proposition self) {
    ...
    { Stella_Object backlinkedargument = Proposition.selectArgumentWithBacklinks(self, new Object[1]);
      ...
      { Cons pattern = Stella_Object.cons(Logic.KWD_RELATION, Stella_Object.cons(((Stella.NIL == null) ? Stella.NIL : Stella.NIL), Stella_Object.cons(((Surrogate)(self.operator)), Stella_Object.cons(backlinkedargument, Stella.NIL))));
        ...
        if (SequenceIndex.emptyPropositionsIndexP(index, backlinkedargument, false)) {
          return (Logic.EMPTY_PROPOSITIONS_ITERATOR);
        }
  ...
  public static boolean closedPropositionP(Proposition self) {
    { MemoizationTable memoTable000 = ((MemoizationTable)(Logic.SGT_LOGIC_F_CLOSED_PROPOSITIONp_MEMO_TABLE_000.surrogateValue));
  ...
  public static Stella_Object generateProposition(Proposition self) {
    { Keyword testValue000 = self.kind;
      ...
      if ((testValue000 == Logic.KWD_PREDICATE) ||
        ...
        return (Stella.list$(Stella_Object.cons(Logic.SYM_STELLA_FORALL, Stella_Object.cons(Logic.generateVariables(((Vector)(KeyValueList.dynamicSlotValue(self.dynamicSlots, Logic.SYM_LOGIC_IO_VARIABLES, null))), false), Stella_Object.cons(Stella_Object.cons(Stella.list$(Stella_Object.cons(Logic.SYM_STELLA_eg, Stella_Object.cons(Proposition.generateProposition(((Proposition)((self.arguments.theArray)[0]))), Stella_Object.cons(Stella_Object.cons(Proposition.generateProposition(((Proposition)((self.arguments.theArray)[1]))), Stella.NIL), Stella.NIL)))), Stella.NIL), Stella.NIL)))));
      }
      else if (testValue000 == Logic.KWD_IMPLIES) {
  ...
  public static void printKifTopLevelExistsProposition(Proposition self) {
    { OutputStream stream = ((OutputStream)(Logic.$PRINTLOGICALFORMSTREAM$.get()));
      ...
      Logic.printKifQuantifiedVariables(Proposition.collectSkolemizedExistsVariables(self), false);
      stream.nativeStream.println();
        ...
        if ((testValue000 == Logic.KWD_PREDICATE) ||
          ...
          { Stella_Object arg1 = (proposition.arguments.theArray)[0];
            ...
            { Object [] caller_MV_returnarray = new Object[1];
              ...
              typeisokP = Logic.checkTypeP(arg1, requiredtype, false, caller_MV_returnarray);
            ...
            if (typeisokP) {
              ...
              { Object [] caller_MV_returnarray = new Object[1];
                ...
                typeisokP = Logic.checkTypeP(arg2, requiredtype, false, caller_MV_returnarray);
                substitutevalue = ((Stella_Object)(caller_MV_returnarray[0]));
              }
