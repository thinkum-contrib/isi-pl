...
public class ObjectAlreadyExistsException extends StellaException {
    public Stella_Object existingObject;

  public ObjectAlreadyExistsException (String message) {
    super(message);
  }

  public static ObjectAlreadyExistsException newObjectAlreadyExistsException(String message) {
