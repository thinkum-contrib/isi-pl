  ...
  static void helpStartupOptimize1() {
    {
      ...
      Logic.SGT_PL_KERNEL_KB_COMPUTED = ((Surrogate)(Stella.internRigidSymbolWrtModule("COMPUTED", Stella.getStellaModule("/PL-KERNEL-KB", true), 1)));
      Logic.SGT_PL_KERNEL_KB_ABSTRACT = ((Surrogate)(Stella.internRigidSymbolWrtModule("ABSTRACT", Stella.getStellaModule("/PL-KERNEL-KB", true), 1)));
      ...
      Logic.SGT_PL_KERNEL_KB_OBSERVED_CARDINALITY_OF = ((Surrogate)(Stella.internRigidSymbolWrtModule("OBSERVED-CARDINALITY-OF", Stella.getStellaModule("/PL-KERNEL-KB", true), 1)));
      ...
      Logic.SGT_PL_KERNEL_KB_INSTANCE_OF = ((Surrogate)(Stella.internRigidSymbolWrtModule("INSTANCE-OF", Stella.getStellaModule("/PL-KERNEL-KB", true), 1)));
