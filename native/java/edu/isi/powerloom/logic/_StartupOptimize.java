...
public class _StartupOptimize {
  static void helpStartupOptimize1() {
    {
      Logic.SGT_LOGIC_GOAL_RECORD = ((Surrogate)(Stella.internRigidSymbolWrtModule("GOAL-RECORD", null, 1)));
      Logic.SYM_LOGIC_GENERATOR_GOALS = ((Symbol)(Stella.internRigidSymbolWrtModule("GENERATOR-GOALS", null, 0)));
      Logic.SYM_LOGIC_OTHER_GOALS = ((Symbol)(Stella.internRigidSymbolWrtModule("OTHER-GOALS", null, 0)));
      Logic.SYM_LOGIC_PERMUTATION_TABLE = ((Symbol)(Stella.internRigidSymbolWrtModule("PERMUTATION-TABLE", null, 0)));
      Logic.SGT_PL_KERNEL_KB_COMPUTED = ((Surrogate)(Stella.internRigidSymbolWrtModule("COMPUTED", Stella.getStellaModule("/PL-KERNEL-KB", Stella.TRUE), 1)));
      Logic.SGT_PL_KERNEL_KB_ABSTRACT = ((Surrogate)(Stella.internRigidSymbolWrtModule("ABSTRACT", Stella.getStellaModule("/PL-KERNEL-KB", Stella.TRUE), 1)));
      Logic.SYM_LOGIC_OPTIMIZER_GOAL_RECORDS = ((Symbol)(Stella.internRigidSymbolWrtModule("OPTIMIZER-GOAL-RECORDS", null, 0)));
      Logic.SYM_LOGIC_UNIQUENESSVECTORS = ((Symbol)(Stella.internRigidSymbolWrtModule("UNIQUENESSVECTORS", null, 0)));
      Logic.SYM_LOGIC_INVERSE_DESCRIPTION = ((Symbol)(Stella.internRigidSymbolWrtModule("INVERSE-DESCRIPTION", null, 0)));
      Logic.SYM_LOGIC_INDEXING_VECTOR = ((Symbol)(Stella.internRigidSymbolWrtModule("INDEXING-VECTOR", null, 0)));
      Logic.SGT_PL_KERNEL_KB_OBSERVED_CARDINALITY_OF = ((Surrogate)(Stella.internRigidSymbolWrtModule("OBSERVED-CARDINALITY-OF", Stella.getStellaModule("/PL-KERNEL-KB", Stella.TRUE), 1)));
      Logic.KWD_OPTIMIZER = ((Keyword)(Stella.internRigidSymbolWrtModule("OPTIMIZER", null, 2)));
      Logic.SYM_LOGIC_BEST_COST = ((Symbol)(Stella.internRigidSymbolWrtModule("BEST-COST", null, 0)));
      Logic.KWD_STATIC_WITH_CLUSTERING = ((Keyword)(Stella.internRigidSymbolWrtModule("STATIC-WITH-CLUSTERING", null, 2)));
      Logic.KWD_BOUND = ((Keyword)(Stella.internRigidSymbolWrtModule("BOUND", null, 2)));
      Logic.KWD_DYNAMIC = ((Keyword)(Stella.internRigidSymbolWrtModule("DYNAMIC", null, 2)));
      Logic.KWD_DYNAMIC_WITH_CLUSTERING = ((Keyword)(Stella.internRigidSymbolWrtModule("DYNAMIC-WITH-CLUSTERING", null, 2)));
      Logic.SGT_PL_KERNEL_KB_INSTANCE_OF = ((Surrogate)(Stella.internRigidSymbolWrtModule("INSTANCE-OF", Stella.getStellaModule("/PL-KERNEL-KB", Stella.TRUE), 1)));
      Logic.SYM_LOGIC_STARTUP_OPTIMIZE = ((Symbol)(Stella.internRigidSymbolWrtModule("STARTUP-OPTIMIZE", null, 0)));
    }
  }

  static void helpStartupOptimize2() {
    {
      Logic.$DISTRIBUTEDOPENGOALp$.setDefaultValue(new Boolean(Stella.FALSE));
      Logic.V_0_0 = Logic.zeroOneListToBooleanVector(Stella.list(Stella_Object.cons(Stella.wrapInteger(0), Stella_Object.cons(Stella.wrapInteger(0), Stella.NIL))));
      Logic.V_1_0 = Logic.zeroOneListToBooleanVector(Stella.list(Stella_Object.cons(Stella.wrapInteger(1), Stella_Object.cons(Stella.wrapInteger(0), Stella.NIL))));
      Logic.V_0_1 = Logic.zeroOneListToBooleanVector(Stella.list(Stella_Object.cons(Stella.wrapInteger(0), Stella_Object.cons(Stella.wrapInteger(1), Stella.NIL))));
      Logic.V_1_1 = Logic.zeroOneListToBooleanVector(Stella.list(Stella_Object.cons(Stella.wrapInteger(1), Stella_Object.cons(Stella.wrapInteger(1), Stella.NIL))));
      Logic.V_1_0_AND_V_0_1 = Stella.list(Stella_Object.cons(Logic.V_1_0, Stella_Object.cons(Logic.V_0_1, Stella.NIL)));
      Logic.V_1_0_SINGLETON = Stella.list(Stella_Object.cons(Logic.V_1_0, Stella.NIL));
      Logic.V_0_1_SINGLETON = Stella.list(Stella_Object.cons(Logic.V_0_1, Stella.NIL));
      ...
      Logic.$POSTOPTIMIZATIONp$.setDefaultValue(new Boolean(Stella.FALSE));
    }
  }
  ...
  static void helpStartupOptimize4() {
    {
      ...
      Stella.defineFunctionObject("COPY-DESCRIPTION", "(DEFUN (COPY-DESCRIPTION DESCRIPTION) ((SELF DESCRIPTION) (PARENTMAPPING ENTITY-MAPPING) (ADDBACKLINKS? BOOLEAN)))", Native.find_java_method("edu.isi.powerloom.logic.Description", "copyDescription", new java.lang.Class [] {Native.find_java_class("edu.isi.powerloom.logic.Description"), Native.find_java_class("edu.isi.stella.KeyValueList"), java.lang.Boolean.TYPE}), null);
      Stella.defineFunctionObject("COPY-VARIABLE", "(DEFUN (COPY-VARIABLE PATTERN-VARIABLE) ((SELF PATTERN-VARIABLE) (MAPPING ENTITY-MAPPING)))", Native.find_java_method("edu.isi.powerloom.logic.PatternVariable", "copyVariable", new java.lang.Class [] {Native.find_java_class("edu.isi.powerloom.logic.PatternVariable"), Native.find_java_class("edu.isi.stella.KeyValueList")}), null);
      Stella.defineFunctionObject("COPY-VARIABLES-VECTOR", "(DEFUN (COPY-VARIABLES-VECTOR VARIABLES-VECTOR) ((SELF VARIABLES-VECTOR) (MAPPING ENTITY-MAPPING)))", Native.find_java_method("edu.isi.powerloom.logic.Logic", "copyVariablesVector", new java.lang.Class [] {Native.find_java_class("edu.isi.stella.Vector"), Native.find_java_class("edu.isi.stella.KeyValueList")}), null);
      Stella.defineFunctionObject("COPY-PROPOSITION", "(DEFUN (COPY-PROPOSITION PROPOSITION) ((SELF PROPOSITION) (MAPPING ENTITY-MAPPING)))", Native.find_java_method("edu.isi.powerloom.logic.Proposition", "copyProposition", new java.lang.Class [] {Native.find_java_class("edu.isi.powerloom.logic.Proposition"), Native.find_java_class("edu.isi.stella.KeyValueList")}), null);
      Stella.defineFunctionObject("COPY-PROPOSITION-ARGUMENT", "(DEFUN (COPY-PROPOSITION-ARGUMENT OBJECT) ((SELF OBJECT) (MAPPING ENTITY-MAPPING)))", Native.find_java_method("edu.isi.powerloom.logic.Logic", "copyPropositionArgument", new java.lang.Class [] {Native.find_java_class("edu.isi.stella.Stella_Object"), Native.find_java_class("edu.isi.stella.KeyValueList")}), null);
      Stella.defineFunctionObject("MAPPED-VALUE-OF", "(DEFUN (MAPPED-VALUE-OF OBJECT) ((SELF OBJECT) (MAPPING ENTITY-MAPPING) (CREATESKOLEM? BOOLEAN)))", Native.find_java_method("edu.isi.powerloom.logic.Logic", "mappedValueOf", new java.lang.Class [] {Native.find_java_class("edu.isi.stella.Stella_Object"), Native.find_java_class("edu.isi.stella.KeyValueList"), java.lang.Boolean.TYPE}), null);
      ...
      Stella.defineFunctionObject("INHERIT-FUNCTION-PROPOSITION", "(DEFUN (INHERIT-FUNCTION-PROPOSITION PROPOSITION) ((SELF PROPOSITION) (MAPPING ENTITY-MAPPING)))", Native.find_java_method("edu.isi.powerloom.logic.Proposition", "inheritFunctionProposition", new java.lang.Class [] {Native.find_java_class("edu.isi.powerloom.logic.Proposition"), Native.find_java_class("edu.isi.stella.KeyValueList")}), null);
      Stella.defineFunctionObject("EQUAL-UP-TO-SKOLEM-IDENTITY?", "(DEFUN (EQUAL-UP-TO-SKOLEM-IDENTITY? BOOLEAN) ((INHERITEDARG OBJECT) (BASEARG OBJECT) (MAPPING ENTITY-MAPPING)))", Native.find_java_method("edu.isi.powerloom.logic.Logic", "equalUpToSkolemIdentityP", new java.lang.Class [] {Native.find_java_class("edu.isi.stella.Stella_Object"), Native.find_java_class("edu.isi.stella.Stella_Object"), Native.find_java_class("edu.isi.stella.KeyValueList")}), null);
      Stella.defineFunctionObject("FIND-SIMILAR-PROPOSITION", "(DEFUN (FIND-SIMILAR-PROPOSITION PROPOSITION) ((PROPOSITION PROPOSITION) (MAPPING ENTITY-MAPPING)))", Native.find_java_method("edu.isi.powerloom.logic.Proposition", "findSimilarProposition", new java.lang.Class [] {Native.find_java_class("edu.isi.powerloom.logic.Proposition"), Native.find_java_class("edu.isi.stella.KeyValueList")}), null);
      Stella.defineFunctionObject("INHERIT-PROPOSITION-ARGUMENT", "(DEFUN (INHERIT-PROPOSITION-ARGUMENT OBJECT) ((ARGUMENT OBJECT) (PARENT PROPOSITION) (MAPPING ENTITY-MAPPING)))", Native.find_java_method("edu.isi.powerloom.logic.Logic", "inheritPropositionArgument", new java.lang.Class [] {Native.find_java_class("edu.isi.stella.Stella_Object"), Native.find_java_class("edu.isi.powerloom.logic.Proposition"), Native.find_java_class("edu.isi.stella.KeyValueList")}), null);
      ...
      Stella.defineFunctionObject("INHERIT-PROPOSITION", "(DEFUN (INHERIT-PROPOSITION PROPOSITION) ((SELF PROPOSITION) (MAPPING ENTITY-MAPPING)))", Native.find_java_method("edu.isi.powerloom.logic.Proposition", "inheritProposition", new java.lang.Class [] {Native.find_java_class("edu.isi.powerloom.logic.Proposition"), Native.find_java_class("edu.isi.stella.KeyValueList")}), null);
      Stella.defineFunctionObject("CREATE-SKOLEM-FOR-UNMAPPED-VARIABLE", "(DEFUN (CREATE-SKOLEM-FOR-UNMAPPED-VARIABLE SKOLEM) ((VARIABLE PATTERN-VARIABLE) (MAPPING ENTITY-MAPPING)))", Native.find_java_method("edu.isi.powerloom.logic.PatternVariable", "createSkolemForUnmappedVariable", new java.lang.Class [] {Native.find_java_class("edu.isi.powerloom.logic.PatternVariable"), Native.find_java_class("edu.isi.stella.KeyValueList")}), null);
      Stella.defineFunctionObject("INHERIT-AS-TOP-LEVEL-PROPOSITION", "(DEFUN (INHERIT-AS-TOP-LEVEL-PROPOSITION (CONS OF PROPOSITION)) ((PROPOSITION PROPOSITION) (MAPPING ENTITY-MAPPING)))", Native.find_java_method("edu.isi.powerloom.logic.Proposition", "inheritAsTopLevelProposition", new java.lang.Class [] {Native.find_java_class("edu.isi.powerloom.logic.Proposition"), Native.find_java_class("edu.isi.stella.KeyValueList")}), null);
      Stella.defineFunctionObject("MAP-AND-ENQUEUE-VARIABLE", "(DEFUN MAP-AND-ENQUEUE-VARIABLE ((VARIABLE OBJECT) (LOCALVALUE OBJECT) (MAPPING ENTITY-MAPPING) (QUEUE LIST)))", Native.find_java_method("edu.isi.powerloom.logic.Logic", "mapAndEnqueueVariable", new java.lang.Class [] {Native.find_java_class("edu.isi.stella.Stella_Object"), Native.find_java_class("edu.isi.stella.Stella_Object"), Native.find_java_class("edu.isi.stella.KeyValueList"), Native.find_java_class("edu.isi.stella.List")}), null);
      ...
      Stella.defineFunctionObject("MAP-FUNCTIONAL-VALUE", "(DEFUN MAP-FUNCTIONAL-VALUE ((PROPOSITION PROPOSITION) (MAPPING ENTITY-MAPPING) (QUEUE LIST)))", Native.find_java_method("edu.isi.powerloom.logic.Proposition", "mapFunctionalValue", new java.lang.Class [] {Native.find_java_class("edu.isi.powerloom.logic.Proposition"), Native.find_java_class("edu.isi.stella.KeyValueList"), Native.find_java_class("edu.isi.stella.List")}), null);
      Stella.defineFunctionObject("INHERIT-DESCRIPTION-PROPOSITIONS", "(DEFUN (INHERIT-DESCRIPTION-PROPOSITIONS (CONS OF PROPOSITION)) ((ARGUMENTS VECTOR) (DESCRIPTION DESCRIPTION)))", Native.find_java_method("edu.isi.powerloom.logic.Logic", "inheritDescriptionPropositions", new java.lang.Class [] {Native.find_java_class("edu.isi.stella.Vector"), Native.find_java_class("edu.isi.powerloom.logic.Description")}), null);
      ...
      { MethodSlot function = Symbol.lookupFunction(Logic.SYM_LOGIC_STARTUP_OPTIMIZE);
        ...
        KeyValueList.setDynamicSlotValue(function.dynamicSlots, Logic.SYM_STELLA_METHOD_STARTUP_CLASSNAME, Stella.wrapString("_Startup-Optimize"), Stella.NULL_STRING_WRAPPER);
      }
    }
  }
