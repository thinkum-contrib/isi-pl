...
public class ClashJustification extends Justification {
    /** The inference direction for this inference.
     */
    public Keyword direction;

  public static ClashJustification newClashJustification() {
    { ClashJustification self = null;
      ...
      self.direction = Logic.KWD_FORWARD;
      return (self);
    }
  }

  public static Stella_Object accessClashJustificationSlotValue(ClashJustification self, Symbol slotname, Stella_Object value, boolean setvalueP) {
    if (slotname == Logic.SYM_LOGIC_DIRECTION) {
      if (setvalueP) {
  ...
  public Surrogate primaryType() {
    { ClashJustification self = this;
      ...
      return (Logic.SGT_LOGIC_CLASH_JUSTIFICATION);
    }
  }
