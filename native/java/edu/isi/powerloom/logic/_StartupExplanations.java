  ...
  static void helpStartupExplanations1() {
    {
      ...
      Logic.SYM_STELLA_LABEL = ((Symbol)(Stella.internRigidSymbolWrtModule("LABEL", Stella.getStellaModule("/STELLA", Stella.TRUE), 0)));
      ...
      try {
        ...
        if (Stella.currentStartupTimePhaseP(7)) {
          ...
          { MethodSlot function = Symbol.lookupFunction(Logic.SYM_LOGIC_STARTUP_EXPLANATIONS);
            ...
            KeyValueList.setDynamicSlotValue(function.dynamicSlots, Logic.SYM_STELLA_METHOD_STARTUP_CLASSNAME, Stella.wrapString("_Startup-Explanations"), Stella.NULL_STRING_WRAPPER);
          }
        }
