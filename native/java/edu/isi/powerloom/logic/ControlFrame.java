...
;
      ...
      { List listvalue = Logic.assertedCollectionMembers(listskolem, Stella.TRUE);
        ...
        switch (numbercount) {
          case 0: 
            return (Logic.KWD_TERMINAL_FAILURE);
          case 1: 
            if (Logic.bindArgumentToValueP(resultargg, Stella.wrapFloat(0.0), Stella.TRUE)) {
              {
          ...
          default:
            ...
            if (Logic.bindArgumentToValueP(resultargg, Stella.wrapFloat(x), Stella.TRUE)) {
              {
                ControlFrame.setFrameTruthValue(frame, Logic.TRUE_TRUTH_VALUE);
                return (Logic.KWD_FINAL_SUCCESS);
              }
    ...
    { Proposition proposition = null;
      ...
      { QueryIterator subqueryiterator = Logic.allocateQueryIterator();
        ...
        { QueryIterator _return_temp = subqueryiterator;
          ...
          MV_returnarray[0] = Stella.wrapBoolean(truefalsequeryP);
          MV_returnarray[1] = Stella.wrapBoolean(partialqueryP);
          return (_return_temp);
        }
      }
    }
        ...
        { Stella_Object value = StandardObject.readSlotValue(((StandardObject)(argumentvalue)), ((StorageSlot)(slot)));
          ...
          if (!Logic.nullWrapperP(value)) {
            if (NamedDescription.functionDescriptionP(description)) {
              successP = PatternVariable.bindVariableToValueP(((PatternVariable)((proposition.arguments.theArray)[(proposition.arguments.length() - 1)])), value, Stella.TRUE);
            }
            else {
        ...
        { Proposition goal = ControlFrame.extractSubgoalOfFrame(frame);
          ...
          { Justification self001 = Justification.newJustification();
            ...
            { PrimitiveStrategy self002 = PrimitiveStrategy.newPrimitiveStrategy();
              ...
              self002.truthValue = ((TruthValue)(Stella_Object.accessInContext(rule.truthValue, rule.homeContext, Stella.FALSE)));
              self002.positiveScore = ((TruthValue)(Stella_Object.accessInContext(rule.truthValue, rule.homeContext, Stella.FALSE))).positiveScore;
    ...
    { ControlFrame argument = frame.result;
      ...
      if ((lastmove == Logic.KWD_UP_TRUE) ||
        ...
        { KeyValueList substitution = KeyValueList.newKeyValueList();
          ...
          ((Justification)(KeyValueList.dynamicSlotValue(frame.dynamicSlots, Logic.SYM_LOGIC_JUSTIFICATION, null))).substitution = ((KeyValueList)(substitution.reverse()));
        }
      }
      else {
      }
  ...
  public static Keyword continueConstantProof(ControlFrame frame, Keyword lastmove) {
    ...
    { Proposition proposition = frame.proposition;
      ...
      frame.truthValue = ((TruthValue)(Stella_Object.accessInContext(proposition.truthValue, proposition.homeContext, Stella.FALSE)));
      if (((Boolean)(Logic.$RECORD_JUSTIFICATIONSp$.get())).booleanValue() &&
          ...
          { Proposition prop = null;
            ...
            while (!(iter000 == Stella.NIL)) {
              ...
              if ((Stella.$TRACED_KEYWORDS$ != null) &&
                ...
                {
                  System.out.println();
                  System.out.println("  Assume that " + prop + " is " + ((negatedtruthvalueP ? "true" : "false")) + ".");
                }
;
              }
              Proposition.recursivelyFastenDownPropositions(prop, Stella.FALSE);
      ...
      { Proposition forallprop = frame.proposition;
        ...
        { PatternVariable v = null;
          ...
          while (index000 < length000) {
            ...
            { Skolem skolem = Logic.createHypothesizedSkolem("ANONYMOUS");

              if (v.skolemType != null) {
                Logic.assertMemberOfProposition(skolem, Logic.getDescription(v.skolemType));
              }
              PatternVariable.bindVariableToValueP(v, skolem, Stella.FALSE);
            }
          }
        }
        try {
            ...
            { Proposition disj = null;
              ...
              while (index002 < length002) {
                ...
                if (!(disj == subgoaldisjunct)) {
                  assumption = Proposition.recursivelyFastenDownPropositions(((!negatedtruthvalueP) ? Proposition.inheritProposition(disj, KeyValueList.newKeyValueList()) : Logic.conjoinPropositions(Proposition.inheritAsTopLevelProposition(disj, KeyValueList.newKeyValueList()))), Stella.FALSE);
                  if ((Stella.$TRACED_KEYWORDS$ != null) &&
                      Stella.$TRACED_KEYWORDS$.membP(Logic.KWD_GOAL_TREE)) {
                    {
                      System.out.println();
                      System.out.println("  Assume that " + assumption + " is " + ((negatedtruthvalueP ? "true" : "false")) + ".");
                      System.out.println();
                    }
;
                  }
        ...
        { int i = Stella.NULL_INTEGER;
          ...
          loop003 : while (index003 < length003) {
            {
    ...
    { Vector arguments = frame.proposition.arguments;
      ...
      if (firstvalue != null) {
        if (secondvalue != null) {
          ...
          successP = PatternVariable.bindVariableToValueP(((PatternVariable)(secondarg)), firstvalue, Stella.TRUE);
        }
      }
      else {
        if (secondvalue != null) {
          successP = PatternVariable.bindVariableToValueP(((PatternVariable)(firstarg)), secondvalue, Stella.TRUE);
        }
        else {
    ...
    { Proposition proposition = frame.proposition;
      ...
      if (Logic.$CYC_KLUDGES_ENABLEDp$) {
        if (!(((Boolean)(Logic.$REVERSEPOLARITYp$.get())).booleanValue())) {
          scanisapropositionsP = Stella.FALSE;
        }
      }
      if (member == null) {
        return (ControlFrame.tryScanCollectionProof(frame));
      }
      else if (Stella_Object.isaP(member, Logic.SGT_STELLA_LITERAL_WRAPPER)) {
    ...
    { ConditionalAntecedentProofAdjunct proofadjunct = ((ConditionalAntecedentProofAdjunct)(((ProofAdjunct)(KeyValueList.dynamicSlotValue(frame.dynamicSlots, Logic.SYM_LOGIC_PROOF_ADJUNCT, null)))));
      ...
      if (lastmove == Logic.KWD_DOWN) {
        ...
        if (proofadjunct.phase == Logic.KWD_ORIGINAL_GOAL) {
          frame.truthValue = TruthValue.weakenTruthValue(ControlFrame.propagateFrameTruthValue(frame.result, frame), ((TruthValue)(Stella_Object.accessInContext(provablerule.truthValue, provablerule.homeContext, Stella.FALSE))));
          return (Logic.selectProofResult(Stella.TRUE, frame.down != null, Stella.FALSE));
        }
  ...
  public static Keyword tryGoalComplementProof(ControlFrame frame) {
    { Description description = ControlFrame.extractSubgoalDescriptionOfFrame(frame);
      ...
      downframe.reversePolarityP = Stella.FALSE;
      return (Logic.KWD_MOVE_DOWN);
    }
  }
    ...
    { Iterator iterator = ((Iterator)(KeyValueList.dynamicSlotValue(frame.dynamicSlots, Logic.SYM_STELLA_ITERATOR, null)));
      ...
      if (lastmove == Logic.KWD_UP_TRUE) {
        { Proposition object000 = ((Proposition)(KeyValueList.dynamicSlotValue(frame.dynamicSlots, Logic.SYM_LOGIC_ANTECEDENTS_RULE, null)));
          ...
          frame.truthValue = TruthValue.weakenTruthValue(ControlFrame.propagateFrameTruthValue(frame.result, frame), ((TruthValue)(Stella_Object.accessInContext(oldValue000, object000.homeContext, Stella.FALSE))));
        }
        if (((Boolean)(Logic.$RECORD_JUSTIFICATIONSp$.get())).booleanValue()) {
          ...
          { boolean testValue000 = Stella.FALSE;
            ...
            if (testValue000) {
              if ((Stella.$TRACED_KEYWORDS$ != null) &&
                ...
                System.out.println("DUPLICATE RULE.  BINDINGS: " + goalbindings);
              }
              if (Stella.FALSE) {
      ...
      { boolean chooseValue000 = Stella.FALSE;
        ...
        if (reversepolarityP) {
          { boolean foundP000 = Stella.FALSE;
            ...
            { ConsIterator p = LogicObject.applicableRulesOfDescription(description, Logic.KWD_FORWARD, Stella.TRUE).allocateIterator();
  ...
  public static Keyword tryManufactureSkolemProof(ControlFrame frame) {
    { Proposition proposition = frame.proposition;
      ...
      { Cons inputvalues = argumentvalues.rest.reverse();
        ...
        PatternVariable.bindVariableToValueP(((PatternVariable)((proposition.arguments.theArray)[(proposition.arguments.length() - 1)])), (definingproposition.arguments.theArray)[(definingproposition.arguments.length() - 1)], Stella.TRUE);
        return (Logic.KWD_FINAL_SUCCESS);
      }
    }
  }
  ...
  public static boolean hasShallowDisproofP(ControlFrame frame) {
    { Iterator iterator = ((Iterator)(KeyValueList.dynamicSlotValue(frame.dynamicSlots, Logic.SYM_STELLA_ITERATOR, null)));
      ...
      boolean hasdisproofP = Stella.FALSE;
  ...
  public static Keyword tryScanPropositionsProof(ControlFrame frame) {
    { Proposition proposition = frame.proposition;
      boolean allkeyargumentsboundP = Stella.FALSE;
      Iterator iterator = ((Iterator)(KeyValueList.dynamicSlotValue(frame.dynamicSlots, Logic.SYM_STELLA_ITERATOR, null)));
      ...
      if (!(result == Logic.KWD_FAILURE)) {
        { TruthValue truthvalue = Logic.propositionsIteratorTruthValue(iterator);
          ...
          if (frame.partialMatchFrame != null) {
            ...
            frame.partialMatchFrame.setFramePartialTruth(truthvalue, truthvalue.positiveScore * weight, Stella.NULL_FLOAT, Stella.TRUE);
          }
        }
      }
      return (result);
        ...
        { boolean alwaysP000 = Stella.TRUE;
          ...
          { Stella_Object cachedbinding = null;
            ...
            loop001 : while ((index000 < length000) &&
              ...
              if (!Logic.bindArgumentToValueP(arg, cachedbinding, Stella.TRUE)) {
                alwaysP000 = Stella.FALSE;
                break loop001;
              }
            }
          ...
          if (alwaysP000) {
            return (AtomicGoalCache.finishCachedGoalProcessing(cachedgoal, frame, Logic.KWD_SUCCESS, Stella.TRUE));
          }
        }
  ...
  public static Keyword lookupCachedProof(ControlFrame frame) {
    ...
    { Keyword successorfailure = Logic.KWD_FAILURE;
      ...
      if ((cachedgoal != null) &&
        ...
        return (AtomicGoalCache.finishCachedGoalProcessing(cachedgoal, frame, successorfailure, Stella.FALSE));
      }
      else {
        return (Logic.KWD_FAILURE);
      }
  ...
  public static Keyword continueCurrentOrNextStrategy(ControlFrame frame) {
    { Keyword result = null;
      ...
      for (;;) {
        ...
        if ((Stella.$TRACED_KEYWORDS$ != null) &&
            Stella.$TRACED_KEYWORDS$.membP(Logic.KWD_STRATEGIES)) {
          System.out.print(" " + frame.currentStrategy);
        ...
        if (Stella_Object.traceKeywordP(Logic.KWD_STRATEGIES)) {
          { Description description = ((Description)(KeyValueList.dynamicSlotValue(frame.dynamicSlots, Logic.SYM_LOGIC_DESCRIPTION, null)));
            ...
            if ((description != null) &&
              ...
              System.out.print("(" + description.surrogateValueInverse.symbolName + ")");
            }
          }
        }
        if (frame.reversePolarityP) {
          { Object old$ReversepolarityP$000 = Logic.$REVERSEPOLARITYp$.get();
            ...
            try {
              Native.setBooleanSpecial(Logic.$REVERSEPOLARITYp$, Stella.TRUE);
      ...
      loop000 : for (;;) {
        ...
        if ((result == Logic.KWD_CONTINUING_SUCCESS) ||
          ...
          if (((((QueryIterator)(Logic.$QUERYITERATOR$.get())) != null) &&
            ...
            frame.partialMatchFrame.setFramePartialTruth(Logic.TRUE_TRUTH_VALUE, Stella.NULL_FLOAT, Stella.NULL_FLOAT, Stella.FALSE);
          }
          if (((Boolean)(Logic.$RECORD_JUSTIFICATIONSp$.get())).booleanValue() &&
              (((Justification)(KeyValueList.dynamicSlotValue(frame.dynamicSlots, Logic.SYM_LOGIC_JUSTIFICATION, null))) == null)) {
        ...
        if ((testValue000 == Logic.KWD_ISA) ||
          ...
          { AtomicGoalCache cachedgoal = null;
            ...
            if (successorfailure == Logic.KWD_SUCCESS) {
              ...
              if ((cachedgoal != null) &&
                  (AtomicGoalCache.cacheMatchesGoalP(cachedgoal, frame, Stella.TRUE, Logic.KWD_GOAL_INSTANTIATES_CACHE) &&
              ...
              if ((cachedgoal != null) &&
                  AtomicGoalCache.cacheMatchesGoalP(cachedgoal, frame, Stella.FALSE, Logic.KWD_GOAL_INSTANTIATES_CACHE)) {
                return (cachedgoal);
              }
            }
            else {
  ...
  public static void cacheGoal(ControlFrame frame, boolean successP, boolean keepframeP, int clockticks) {
    ...
    if (frame.state == Logic.KWD_ATOMIC_GOAL) {
      ...
      if (successP) {
        frame.dontCacheGoalFailureP = Stella.TRUE;
      }
      ...
      if (((clockticks - frame.startingClockTicks) >= Logic.$CACHE_GOAL_QUANTUM$) ||
        ...
        { Keyword testValue000 = frame.proposition.kind;
          ...
          if ((testValue000 == Logic.KWD_ISA) ||
            ...
            KeyValueList.setDynamicSlotValue(Logic.surrogateToDescription(((Surrogate)(frame.proposition.operator))).dynamicSlots, Logic.SYM_LOGIC_CHECK_FOR_CACHED_GOALSp, (Stella.TRUE ? Stella.TRUE_WRAPPER : Stella.FALSE_WRAPPER), Stella.FALSE_WRAPPER);
              ...
              if (successP) {
                ...
                if ((cachedgoal == null) ||
                    ((!AtomicGoalCache.cacheMatchesGoalP(cachedgoal, frame, Stella.TRUE, Logic.KWD_GOAL_INSTANTIATES_CACHE)) ||
                     (((Boolean)(Logic.$RECORD_JUSTIFICATIONSp$.get())).booleanValue() &&
                      (cachedgoal.justification == null)))) {
                  (Logic.$SUCCEEDED_GOALS_CACHE$.theArray)[index] = (ControlFrame.createAtomicGoalCache(frame, cachedgoal, Stella.TRUE));
                }
                ...
                if ((cachedgoal == null) ||
                    (!AtomicGoalCache.cacheMatchesGoalP(cachedgoal, frame, Stella.FALSE, Logic.KWD_GOAL_INSTANTIATES_CACHE))) {
                  (Logic.$FAILED_GOALS_CACHE$.theArray)[index] = (ControlFrame.createAtomicGoalCache(frame, cachedgoal, Stella.FALSE));
                }
              }
            }
          }
  ...
  public static void dontCacheGoalFailureBetweenFrames(ControlFrame topframe, ControlFrame bottomframe) {
    for (;;) {
      topframe.dontCacheGoalFailureP = Stella.TRUE;
  ...
  public static AtomicGoalCache createAtomicGoalCache(ControlFrame frame, AtomicGoalCache cache, boolean successP) {
    ...
    { Proposition proposition = frame.proposition;
      ...
      frame.cachedGoalResultP = Stella.TRUE;
      return (cache);
    }
  }
    ...
    { GoalCache goalcache = ControlFrame.findGoalCache(frame);
      ...
      if (goalcache != null) {
        { List cachedbindings = goalcache.cachedBindings;
          ...
          if ((Stella.$TRACED_KEYWORDS$ != null) &&
              Stella.$TRACED_KEYWORDS$.membP(Logic.KWD_GOAL_CACHES)) {
            System.out.println("AUGMENT CACHE: " + bindings + "  " + frame);
          }
          cachedbindings.push(bindings);
          ((QueryIterator)(Logic.$QUERYITERATOR$.get())).augmentedGoalCacheP = Stella.TRUE;
        }
      }
    }
  }
    ...
    { Proposition proposition = frame.proposition;
      ...
      if (!(result == Logic.KWD_FAILURE)) {
        { TruthValue truthvalue = Logic.propositionsIteratorTruthValue(iterator);
          ...
          frame.partialMatchFrame.setFramePartialTruth(Logic.UNKNOWN_TRUTH_VALUE, truthvalue.positiveScore * weight, Stella.NULL_FLOAT, Stella.TRUE);
        }
      }
      return (result);
    }
  ...
  public static boolean computePartialMatchScoreP(ControlFrame frame) {
    { PartialMatchFrame partialmatchframe = frame.partialMatchFrame;
      ...
      KeyValueList.setDynamicSlotValue(((QueryIterator)(Logic.$QUERYITERATOR$.get())).dynamicSlots, Logic.SYM_LOGIC_LATEST_POSITIVE_SCORE, Stella.wrapFloat(score), Stella.NULL_FLOAT_WRAPPER);
      partialmatchframe.positiveScore = score;
      KeyValueList.setDynamicSlotValue(frame.proposition.dynamicSlots, Logic.SYM_LOGIC_MATCH_SCORE, Stella.wrapFloat(score), Stella.NULL_FLOAT_WRAPPER);
    ...
    { Proposition prop = null;
      ...
      if ((pframe.kind == Logic.KWD_AND) &&
          (BooleanWrapper.coerceWrappedBooleanToBoolean(prop.variableTypeP()) &&
           (!pframe.successP))) {
        Logic.$AND_MISSED_A_BINDING$ = Stella.TRUE;
      }
      if ((pframe.kind == Logic.KWD_AND) &&
          ((score == 0.0) &&
    ...
    { int variablescount = description.ioVariables.length();
      ...
      { int i = Stella.NULL_INTEGER;
        ...
        while (index000 < length000) {
          ...
          (externalvariables.theArray)[i] = (Logic.createVariable(iovar.skolemType, iovar.skolemName, Stella.FALSE));
    ...
    { Object old$Printinframe$000 = Logic.$PRINTINFRAME$.get();
      ...
      try {
        ...
        { boolean printtimesP = self.allottedClockTicks != Stella.NULL_INTEGER;
          ...
          stream.print(" " + self.state + " " + self.currentStrategy + "  UP: " + (((self.up != null) ? ControlFrame.debugFrameId(self.up) : ((int)(Stella.NULL_INTEGER)))) + "  DOWN: " + (((self.down != null) ? ControlFrame.debugFrameId(self.down) : ((int)(Stella.NULL_INTEGER)))) + "  DEPTH: " + ControlFrame.computeFrameDepth(self));
          if (printtimesP) {
  ...
  public static ControlFrame handleTimeout(ControlFrame frame, int depth, Object [] MV_returnarray) {
    if ((Stella.$TRACED_KEYWORDS$ != null) &&
        Stella.$TRACED_KEYWORDS$.membP(Logic.KWD_GOAL_TREE)) {
      System.out.println("*** Timeout: start=" + frame.startingClockTicks + " depth=" + depth);
    }
    if ((Logic.$CACHE_SUCCEEDED_GOALSp$ ||
        Logic.$CACHE_FAILED_GOALSp$) &&
        ((Logic.$DUPLICATE_SUBGOAL_STRATEGY$ == Logic.KWD_DUPLICATE_GOALS) &&
    ...
    if ((((QueryIterator)(Logic.$QUERYITERATOR$.get())) != null) &&
      ...
      frame.partialMatchFrame.setFramePartialTruth(null, 0.0, Stella.NULL_FLOAT, Stella.TRUE);
    }
    if (((Boolean)(Logic.$RECORD_JUSTIFICATIONSp$.get())).booleanValue()) {
      { PrimitiveStrategy self000 = PrimitiveStrategy.newPrimitiveStrategy();
    ...
    { ControlFrame _return_temp = frame;
      ...
      MV_returnarray[0] = Stella.wrapInteger(depth);
      return (_return_temp);
    }
  }
  ...
  public static ControlFrame handleDepthViolation(ControlFrame frame, int depth, Object [] MV_returnarray) {
    ...
    ((QueryIterator)(Logic.$QUERYITERATOR$.get())).triggeredDepthCutoffP = Stella.TRUE;
    if ((Logic.$CACHE_SUCCEEDED_GOALSp$ ||
        Logic.$CACHE_FAILED_GOALSp$) &&
        ((Logic.$DUPLICATE_SUBGOAL_STRATEGY$ == Logic.KWD_DUPLICATE_GOALS) &&
         (!((((QueryIterator)(Logic.$QUERYITERATOR$.get())) != null) &&
    ...
    if ((Logic.$DUPLICATE_SUBGOAL_STRATEGY$ == Logic.KWD_DUPLICATE_GOALS) ||
      ...
      { ControlFrame goalframe = null;
        ...
        if ((goalframe != null) &&
          ...
          if ((Stella.$TRACED_KEYWORDS$ != null) &&
              Stella.$TRACED_KEYWORDS$.membP(Logic.KWD_GOAL_CACHES)) {
            System.out.println("*** Inference restart: restartDepth=" + restartdepth);
          }
  ...
  public static ControlFrame findDuplicatedGoal(ControlFrame frame, Object [] MV_returnarray) {
    { ControlFrame trialframe = frame;
            ...
            if ((testValue000 == Logic.KWD_ISA) ||
              ...
              { ControlFrame goalframe = null;
                ...
                if (goalframe != null) {
                  ...
                  if ((Stella.$TRACED_KEYWORDS$ != null) &&
                      Stella.$TRACED_KEYWORDS$.membP(Logic.KWD_GOAL_CACHES)) {
                    System.out.println("   RESTART DEPTH " + restartdepth);
                  }
                  { ControlFrame _return_temp = goalframe;

                    MV_returnarray[0] = restartframe;
                    MV_returnarray[1] = Stella.wrapInteger(restartdepth);
                    return (_return_temp);
                  }
                }
              }
      ...
      ((QueryIterator)(Logic.$QUERYITERATOR$.get())).failedToFindDuplicateSubgoalP = Stella.TRUE;
      { ControlFrame _return_temp = null;

        MV_returnarray[0] = null;
        MV_returnarray[1] = Stella.wrapInteger(Stella.NULL_INTEGER);
        return (_return_temp);
      }
    }
  }
  ...
  public static Keyword continuePatternProof(ControlFrame frame, Keyword lastmove) {
    if (lastmove == Logic.KWD_DOWN) {
      ...
      { boolean futurebindingsP = frame.down != null;
        ...
        frame.truthValue = TruthValue.weakenTruthValue(ControlFrame.propagateFrameTruthValue(result, frame), ((rule != null) ? ((TruthValue)(Stella_Object.accessInContext(rule.truthValue, rule.homeContext, Stella.FALSE))) : Logic.TRUE_TRUTH_VALUE));
        if (result.partialMatchFrame != null) {
          result.partialMatchFrame.propagateFramePartialTruth(frame);
        }
        if (((Boolean)(Logic.$RECORD_JUSTIFICATIONSp$.get())).booleanValue()) {
        ...
        { BooleanWrapper initiallyboundP = null;
          ...
          while ((!(iter001 == Stella.NIL)) &&
            ...
            if (!BooleanWrapper.coerceWrappedBooleanToBoolean(initiallyboundP)) {
              if (!Logic.bindArgumentToValueP(externalarg, value, Stella.FALSE)) {
                if ((Stella.$TRACED_KEYWORDS$ != null) &&
                    Stella.$TRACED_KEYWORDS$.membP(Logic.KWD_QUERY_STACKS)) {
  ...
  public static boolean overlayWithPatternFrameP(ControlFrame frame, Description description, Vector ioarguments) {
    { Cons iobindings = Logic.computeExternalBindings(ioarguments);
      ...
      if (Description.checkForSingleValuedGoalP(optimalpattern, iobindings)) {
        KeyValueList.setDynamicSlotValue(frame.dynamicSlots, Logic.SYM_LOGIC_CACHED_SINGLE_VALUEDp, (Stella.TRUE ? Stella.TRUE_WRAPPER : Stella.FALSE_WRAPPER), Stella.FALSE_WRAPPER);
      }
      ...
      { Stella_Object binding = null;
        ...
        while ((index000 < length000) &&
          ...
          if ((binding != null) &&
              (!PatternVariable.bindVariableToValueP(iovar, binding, Stella.FALSE))) {
            return (Stella.FALSE);
          }
        }
      }
      if (!(externalbindings == Stella.NIL)) {
        { Stella_Object binding = null;
          ...
          while ((index001 < length001) &&
            ...
            if ((binding != null) &&
                (!PatternVariable.bindVariableToValueP(externalvar, binding, Stella.FALSE))) {
              return (Stella.FALSE);
            }
          }
        }
  ...
  public static Keyword overlayWithFailFrame(ControlFrame frame, Proposition proposition) {
    { Proposition failproposition = Logic.createProposition(Logic.SYM_LOGIC_FAIL, 1);
      ...
      frame.reversePolarityP = Stella.FALSE;
      return (Logic.KWD_MOVE_IN_PLACE);
    }
  }
  ...
  public static Keyword continueNotProof(ControlFrame frame, Keyword lastmove) {
    if (lastmove == Logic.KWD_DOWN) {
      ...
      else if (((Boolean)(Logic.$GENERATE_ALL_PROOFSp$.get())).booleanValue()) {
        return (Logic.KWD_CONTINUING_SUCCESS);
      }
      else {
        ControlFrame.popFramesUpTo(frame.down);
  ...
  public static Keyword continueOrProof(ControlFrame frame, Keyword lastmove) {
    { Proposition proposition = frame.proposition;
      ...
      if (lastmove == Logic.KWD_DOWN) {
        ...
        frame.truthValue = ((frame.truthValue == null) ? frame.result.truthValue : TruthValue.disjoinTruthValues(frame.truthValue, frame.result.truthValue));
        frame.argumentCursor = frame.argumentCursor + 1;
        if (frame.argumentCursor < proposition.arguments.length()) {
          {
            ControlFrame.createChoicePoint(frame);
  ...
  public static int debugFrameId(ControlFrame frame) {
    { int id = ((IntegerWrapper)(KeyValueList.dynamicSlotValue(frame.dynamicSlots, Logic.SYM_LOGIC_DEBUG_FRAME_ID_INTERNAL, Stella.NULL_INTEGER_WRAPPER))).wrapperValue;
      ...
      if (id == Stella.NULL_INTEGER) {
        ...
        KeyValueList.setDynamicSlotValue(frame.dynamicSlots, Logic.SYM_LOGIC_DEBUG_FRAME_ID_INTERNAL, Stella.wrapInteger(id), Stella.NULL_INTEGER_WRAPPER);
      }
      return (id);
    }
  }
  ...
  public static Keyword interpretIterativeForallScores(ControlFrame frame, Keyword lastmove) {
    if (lastmove == Logic.KWD_DOWN) {
      ...
      ControlFrame.recordLatestPartialMatchScore(frame);
      if (Stella_Object.traceKeywordP(Logic.KWD_GOAL_TREE)) {
        System.out.println("ITERATIVE-FORALL " + ((FloatWrapper)(KeyValueList.dynamicSlotValue(((QueryIterator)(Logic.$QUERYITERATOR$.get())).dynamicSlots, Logic.SYM_LOGIC_LATEST_POSITIVE_SCORE, Stella.NULL_FLOAT_WRAPPER))).wrapperValue);
      }
  ...
  public static Keyword oldInterpretAndScores(ControlFrame frame, Keyword lastmove) {
    if (lastmove == Logic.KWD_DOWN) {
      ...
      { PartialMatchFrame pmf = frame.partialMatchFrame;
        ...
        ControlFrame.recordLatestPartialMatchScore(frame);
        if (Stella_Object.traceKeywordP(Logic.KWD_GOAL_TREE)) {
          System.out.println(((FloatWrapper)(KeyValueList.dynamicSlotValue(((QueryIterator)(Logic.$QUERYITERATOR$.get())).dynamicSlots, Logic.SYM_LOGIC_LATEST_POSITIVE_SCORE, Stella.NULL_FLOAT_WRAPPER))).wrapperValue + ", " + frame.partialMatchFrame.computeAndScore());
        }
        if (!(pmf.unboundVars == Stella.NIL)) {
          ...
          if (Stella_Object.traceKeywordP(Logic.KWD_GOAL_TREE)) {
            System.out.println("   *** Skipping " + i + " propositions . . .");
          }
        }
  ...
  public static void traceGoalTree(ControlFrame frame, int depth, Keyword lastmove) {
    ...
    if (Stella_Object.traceKeywordP(Logic.KWD_STATE_MACHINE)) {
      if (Surrogate.subtypeOfP(Stella_Object.safePrimaryType(frame), Logic.SGT_LOGIC_PARALLEL_CONTROL_FRAME)) {
        { ParallelControlFrame frame000 = ((ParallelControlFrame)(frame));
          ...
          System.out.print("P" + ControlFrame.debugFrameId(frame000));
        }
      }
      else {
        System.out.print("F" + ControlFrame.debugFrameId(frame));
      }
      if (frame.choicePointUnbindingOffset != Stella.NULL_INTEGER) {
        System.out.print("," + frame.choicePointUnbindingOffset + " ");
      }
      else {
        System.out.print("   ");
      }
      System.out.print(((((frame.truthValue == Logic.DEFAULT_TRUE_TRUTH_VALUE) ||
    ...
    if (Stella_Object.traceKeywordP(Logic.KWD_STATE_MACHINE)) {
      System.out.print(" state= " + frame.state + "  lastMove= " + lastmove + " depth= " + depth + " revPty?= " + frame.reversePolarityP);
    }
    if (!(frame.partialMatchFrame != null)) {
      System.out.println();
    }
  ...
  public static void printGoalInGoalTree(ControlFrame frame, int depth) {
    if (frame.proposition != null) {
        ...
        { Object old$Printmode$000 = Logic.$PRINTMODE$.get();
          ...
          try {
            ...
            if (frame.allottedClockTicks != Stella.NULL_INTEGER) {
              System.out.print(" ticks=" + frame.allottedClockTicks);
            }
      ...
      System.out.print("STRATEGY: " + frame.up.currentStrategy);
    }
  }
  ...
  public static void createChoicePoint(ControlFrame frame) {
    { PatternRecord patternrecord = frame.inheritedPatternRecord;
      ...
      if ((Stella.$TRACED_KEYWORDS$ != null) &&
          Stella.$TRACED_KEYWORDS$.membP(Logic.KWD_QUERY_STACKS)) {
        System.out.println("create-choice-point: F " + ControlFrame.debugFrameId(frame) + " CP= " + frame.choicePointUnbindingOffset + " NEWCP= " + (patternrecord.topUnbindingStackOffset + 1));
      }
      if (frame.choicePointUnbindingOffset == Stella.NULL_INTEGER) {
  ...
  public static Stella_Object accessControlFrameSlotValue(ControlFrame self, Symbol slotname, Stella_Object value, boolean setvalueP) {
    if (slotname == Logic.SYM_STELLA_STATE) {
      ...
      if (setvalueP) {
        ...
        value = Stella.wrapInteger(self.startingClockTicks);
      }
    }
      ...
      if (setvalueP) {
        ...
        value = Stella.wrapInteger(self.allottedClockTicks);
      }
    }
      ...
      if (setvalueP) {
        ...
        value = Stella.wrapInteger(self.argumentCursor);
      }
    }
      ...
      if (setvalueP) {
        ...
        value = Stella.wrapInteger(self.choicePointUnbindingOffset);
      }
    }
