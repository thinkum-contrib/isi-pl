...
public class PlKernelKb {
  ...
  public static Surrogate SGT_PL_KERNEL_KB_INTEGER_INTERVAL_CACHE = null;

  public static Symbol SYM_STELLA_LOWER_BOUND = null;

  public static Symbol SYM_STELLA_UPPER_BOUND = null;

  public static Surrogate SGT_PL_KERNEL_KB_FLOAT_INTERVAL_CACHE = null;
    ...
    { Proposition proposition = frame.proposition;
      ...
      if (NamedDescription.functionDescriptionP(description)) {
        ...
        { Stella_Object lastarg = (proposition.arguments.theArray)[(proposition.arguments.length() - 1)];
          ...
          successP = (Stella_Object.isaP(lastarg, Logic.SGT_LOGIC_PATTERN_VARIABLE) ? PatternVariable.bindVariableToValueP(((PatternVariable)(lastarg)), value, Stella.TRUE) : Stella_Object.eqlP(Logic.valueOf(lastarg), value));
        }
      }
      else {
        { Stella_Object arg = null;
      ...
      return (Logic.reportComputedResult(successP, proposition));
    }
  }
  ...
  public static Keyword constraintSpecialist(ControlFrame frame, Keyword lastmove) {
    { Proposition proposition = frame.proposition;
      ...
      switch (nullcount) {
        case 0: 
          value = Stella.apply(computationcode, Stella_Object.cons(Stella.wrapInteger(variableindex), argumentvalues));
          if (BooleanWrapper.coerceWrappedBooleanToBoolean(((BooleanWrapper)(value)))) {
            ControlFrame.setFrameTruthValue(frame, Logic.TRUE_TRUTH_VALUE);
          }
          else {
            ControlFrame.setFrameTruthValue(frame, Logic.FALSE_TRUTH_VALUE);
          }
          return (Logic.reportComputedResult(BooleanWrapper.coerceWrappedBooleanToBoolean(((BooleanWrapper)(value))), proposition));
        case 1: 
          value = Stella.apply(computationcode, Stella_Object.cons(Stella.wrapInteger(variableindex), argumentvalues));
          if (value == null) {
            return (Logic.KWD_FAILURE);
          }
          return (Logic.reportComputedResult(PatternVariable.bindVariableToValueP(((PatternVariable)((proposition.arguments.theArray)[variableindex])), value, Stella.TRUE), proposition));
        default:
          return (Logic.KWD_FAILURE);
      }
    }
  ...
  public static Keyword squareRootSpecialist(ControlFrame frame, Keyword lastmove) {
    { Proposition proposition = frame.proposition;
        ...
        if (mainargvalue == null) {
          if (rootargvalue == null) {
            ...
            if (Stella_Object.isaP(rootargvalue, Logic.SGT_STELLA_NUMBER_WRAPPER)) {
              return (Logic.selectProofResult(Logic.bindArgumentToValueP(mainarg, PlKernelKb.timesComputation(((NumberWrapper)(rootargvalue)), ((NumberWrapper)(rootargvalue))), Stella.TRUE), Stella.FALSE, Stella.TRUE));
            }
            else {
              return (Logic.KWD_TERMINAL_FAILURE);
            }
          ...
          if (Stella_Object.isaP(mainargvalue, Logic.SGT_STELLA_NUMBER_WRAPPER)) {
            if (PlKernelKb.arithmeticLessTest(((NumberWrapper)(mainargvalue)), Stella.wrapInteger(0))) {
              return (Logic.KWD_TERMINAL_FAILURE);
            }
            else {
              { NumberWrapper sqrt = PlKernelKb.sqrtComputation(((NumberWrapper)(mainargvalue)));

                collection = Stella_Object.cons(sqrt, Stella_Object.cons(PlKernelKb.timesComputation(Stella.wrapInteger(-1), sqrt), Stella.NIL));
              }
            }
          }
          else {
      ...
      if (rootargvalue != null) {
        if (PlKernelKb.arithmeticEqualTest(((NumberWrapper)(rootargvalue)), ((NumberWrapper)(collection.value))) ||
            PlKernelKb.arithmeticEqualTest(((NumberWrapper)(rootargvalue)), ((NumberWrapper)(collection.rest.value)))) {
          {
            ControlFrame.setFrameTruthValue(frame, Logic.TRUE_TRUTH_VALUE);
      ...
      if (iterator.nextP() &&
          Logic.bindArgumentToValueP(rootarg, iterator.value, Stella.TRUE)) {
  ...
  public static Keyword memberOfSpecialist(ControlFrame frame, Keyword lastmove) {
    { Proposition proposition = frame.proposition;
          ...
          { Surrogate testValue000 = Stella_Object.safePrimaryType(collection);
            ...
            if (Surrogate.subtypeOfP(testValue000, Logic.SGT_LOGIC_NAMED_DESCRIPTION)) {
              ...
              { Collection collection000 = ((Collection)(collection));
                ...
                if (member == null) {
                  iterator = ((ListIterator)(Logic.assertedCollectionMembers(collection000, Stella.FALSE).allocateIterator()));
                }
                else {
                  if (Logic.memberOfCollectionP(member, collection000)) {
                    {
                      ControlFrame.setFrameTruthValue(frame, Logic.TRUE_TRUTH_VALUE);
                      return (Logic.KWD_FINAL_SUCCESS);
                    }
      ...
      while (iterator.nextP()) {
        if (collection == null) {
          if (PatternVariable.bindVariableToValueP(((PatternVariable)(collectionarg)), Logic.valueOf(iterator.value), Stella.TRUE)) {
            return (Logic.KWD_CONTINUING_SUCCESS);
          }
        }
        else {
          if (PatternVariable.bindVariableToValueP(((PatternVariable)(memberarg)), Logic.valueOf(iterator.value), Stella.TRUE)) {
            return (Logic.KWD_CONTINUING_SUCCESS);
          }
        }
      }
  ...
  public static void memberOfEvaluator(Proposition self) {
    { Stella_Object value1 = Logic.valueOf((self.arguments.theArray)[0]);
      ...
      if (Stella_Object.isaP(value2, Logic.SGT_LOGIC_DESCRIPTION) &&
          (Stella_Object.isaP(value1, Logic.SGT_LOGIC_LOGIC_OBJECT) &&
           (!Description.namedDescriptionP(((Description)(value2)))))) {
        Logic.inheritUnnamedDescription(((LogicObject)(value1)), ((Description)(value2)), Proposition.defaultTrueP(self));
      }
    }
  }
  ...
  public static Keyword instanceOfSpecialist(ControlFrame frame, Keyword lastmove) {
    { Proposition proposition = frame.proposition;
      ...
      if (iterator != null) {
        if (iterator.nextP()) {
          PatternVariable.bindVariableToValueP(((PatternVariable)(collectionarg)), iterator.value, Stella.TRUE);
          return (Logic.KWD_CONTINUING_SUCCESS);
        }
        return (Logic.KWD_FAILURE);
      }
...
;
      ...
      while (iterator.nextP()) {
        { Stella_Object value = Logic.valueOf(iterator.value);
          ...
          if (Stella.TRUE &&
              (((subcollection != null) ? PatternVariable.bindVariableToValueP(((PatternVariable)(supercollectionarg)), value, Stella.TRUE) : PatternVariable.bindVariableToValueP(((PatternVariable)(subcollectionarg)), value, Stella.TRUE)))) {
            return (Logic.KWD_CONTINUING_SUCCESS);
          }
        }
      }
  ...
  public static Keyword querySpecialist(ControlFrame frame, Keyword lastmove) {
    { QueryIterator subqueryiterator = ((QueryIterator)(((Iterator)(KeyValueList.dynamicSlotValue(frame.dynamicSlots, Logic.SYM_STELLA_ITERATOR, null)))));
      boolean truefalsequeryP = Stella.FALSE;
      boolean partialqueryP = Stella.FALSE;
      boolean successP = Stella.FALSE;
        ...
        if (partialqueryP) {
          ...
          { Object old$Queryiterator$000 = Logic.$QUERYITERATOR$.get();
            ...
            try {
              ...
              Native.setBooleanSpecial(Logic.$GENERATE_ALL_PROOFSp$, Stella.FALSE);
              { int howmany = Logic.lookupHowManySolutions(subqueryiterator);
                ...
                if (howmany == Stella.NULL_INTEGER) {
                  ...
                  subqueryiterator.exhaustedP = Stella.TRUE;
                }
                else {
                  subqueryiterator.options.insertAt(Logic.KWD_HOW_MANY, Stella.wrapInteger(howmany - 1));
                }
                if (successP) {
                  result = subqueryiterator.baseControlFrame;
                }
        ...
        if (successP) {
          { Stella_Object value = null;
            ...
            loop001 : while ((!(iter000 == Stella.NIL)) &&
              ...
              if (!(PatternVariable.bindVariableToValueP(((PatternVariable)(var)), value, Stella.TRUE))) {
    ...
    { Proposition proposition = frame.proposition;
      ...
      if (prototype == null) {
        { String name = null;
          ...
          if (Stella_Object.isaP(renamed_Class, Logic.SGT_LOGIC_NAMED_DESCRIPTION)) {
            name = "PROTO-" + renamed_Class.descriptionName().symbolName;
          }
          else {
            name = "PROTOTYPE" + Native.integerToString(Logic.$PROTOTYPE_ID_COUNTER$ = Logic.$PROTOTYPE_ID_COUNTER$ + 1);
          }
            ...
            try {
              ...
              { Object old$InvisibleassertionP$000 = Logic.$INVISIBLEASSERTIONp$.get();
                ...
                try {
                  ...
                  prototype = ((LogicObject)(Logic.createLogicInstance(Stella.string_surrogatify(name), null)));
                  KeyValueList.setDynamicSlotValue(prototype.dynamicSlots, Logic.SYM_LOGIC_HYPOTHESIZED_INSTANCEp, (Stella.TRUE ? Stella.TRUE_WRAPPER : Stella.FALSE_WRAPPER), Stella.FALSE_WRAPPER);
      ...
      return (Logic.selectProofResult(Logic.bindArgumentToValueP(prototypeargument, prototype, Stella.TRUE), Stella.FALSE, Stella.TRUE));
    }
  }
  ...
  public static Keyword closedSpecialist(ControlFrame frame, Keyword lastmove) {
    { Proposition proposition = frame.proposition;
      ...
      return (Logic.selectProofResult(closedP, Stella.FALSE, Stella.TRUE));
    }
  }
    ...
    { Proposition proposition = frame.proposition;
      ...
      if (((Iterator)(KeyValueList.dynamicSlotValue(frame.dynamicSlots, Logic.SYM_STELLA_ITERATOR, null))) == null) {
        if (Logic.enumeratedSetP(collectionvalue) &&
          ...
          Logic.bindArgumentToValueP(listarg, collectionvalue, Stella.TRUE);
          return (Logic.KWD_FINAL_SUCCESS);
        }
        { Surrogate testValue000 = Stella_Object.safePrimaryType(collectionvalue);
          ...
          if (Surrogate.subtypeOfP(testValue000, Logic.SGT_STELLA_COLLECTION)) {
            { Collection collectionvalue000 = ((Collection)(collectionvalue));
              ...
              { List members = Logic.assertedCollectionMembers(collectionvalue000, Stella.FALSE);

                if (members == null) {
                  return (Logic.KWD_TERMINAL_FAILURE);
                }
                Logic.bindArgumentToValueP(listarg, Logic.createEnumeratedSet(members), Stella.TRUE);
                return (Logic.KWD_FINAL_SUCCESS);
              }
            }
          }
      ...
      { List list = frame.down.patternRecord.collectionList;
        ...
        Logic.bindArgumentToValueP(listarg, Logic.createEnumeratedSet(list), Stella.TRUE);
        return (Logic.KWD_FINAL_SUCCESS);
      }
    }
  }
...
;
      ...
      { List listvalue = Logic.assertedCollectionMembers(listskolem, Stella.TRUE);
        ...
        if (Logic.bindArgumentToValueP(lengtharg, Stella.wrapInteger(len), Stella.TRUE)) {
          {
            ControlFrame.setFrameTruthValue(frame, Logic.TRUE_TRUTH_VALUE);
            return (Logic.KWD_FINAL_SUCCESS);
          }
  ...
  public static Keyword minimumOfNumbersSpecialist(ControlFrame frame, Keyword lastmove) {
    { Proposition proposition = frame.proposition;
      ...
      boolean missingnumbersP = Stella.FALSE;
...
;
      ...
      { List listvalue = Logic.assertedCollectionMembers(listskolem, Stella.TRUE);
        ...
        if (Logic.bindArgumentToValueP(minarg, minimum, Stella.TRUE)) {
          {
            ControlFrame.setFrameTruthValue(frame, Logic.TRUE_TRUTH_VALUE);
            return (Logic.KWD_FINAL_SUCCESS);
          }
...
;
      ...
      { List listvalue = Logic.assertedCollectionMembers(listskolem, Stella.TRUE);
        ...
        if (Logic.bindArgumentToValueP(maxarg, maximum, Stella.TRUE)) {
          {
            ControlFrame.setFrameTruthValue(frame, Logic.TRUE_TRUTH_VALUE);
            return (Logic.KWD_FINAL_SUCCESS);
          }
...
;
      ...
      { List listvalue = Logic.assertedCollectionMembers(listskolem, Stella.TRUE);
        ...
        if (Logic.bindArgumentToValueP(sumarg, sum, Stella.TRUE)) {
          {
            ControlFrame.setFrameTruthValue(frame, Logic.TRUE_TRUTH_VALUE);
            return (Logic.KWD_FINAL_SUCCESS);
          }
  ...
  public static Keyword meanOfNumbersSpecialist(ControlFrame frame, Keyword lastmove) {
    { Proposition proposition = frame.proposition;
      ...
      NumberWrapper sum = Stella.wrapInteger(0);
      int numbercount = 0;
...
;
      ...
      { List listvalue = Logic.assertedCollectionMembers(listskolem, Stella.TRUE);
        ...
        if (Logic.bindArgumentToValueP(meanarg, PlKernelKb.divideComputation(sum, Stella.wrapInteger(numbercount)), Stella.TRUE)) {
          {
            ControlFrame.setFrameTruthValue(frame, Logic.TRUE_TRUTH_VALUE);
            return (Logic.KWD_FINAL_SUCCESS);
          }
...
;
      ...
      { List listvalue = Logic.assertedCollectionMembers(listskolem, Stella.TRUE);
        ...
        if (((numbercount % 2) == 1)) {
          ...
          result = PlKernelKb.divideComputation(PlKernelKb.plusComputation(((NumberWrapper)(sortlist.nth(((int)((numbercount / 2.0) - 1))))), ((NumberWrapper)(sortlist.nth(((int)(numbercount / 2.0)))))), Stella.wrapInteger(2));
        }
        if (Logic.bindArgumentToValueP(medianarg, result, Stella.TRUE)) {
          {
            ControlFrame.setFrameTruthValue(frame, Logic.TRUE_TRUTH_VALUE);
            return (Logic.KWD_FINAL_SUCCESS);
          }
  ...
  public static Keyword standardDeviationSpecialist(ControlFrame frame, Keyword lastmove) {
    return (ControlFrame.computeVarianceOrStandardDeviation(frame, lastmove, Stella.TRUE));
  }

  public static Keyword varianceSpecialist(ControlFrame frame, Keyword lastmove) {
    return (ControlFrame.computeVarianceOrStandardDeviation(frame, lastmove, Stella.FALSE));
  }
  ...
  public static Keyword refutationDisjointSpecialist(ControlFrame frame, Keyword lastmove) {
    { Proposition proposition = frame.proposition;
      ...
      try {
        { Skolem skolem = Logic.createHypothesizedSkolem("REFUTATION-DISJOINT");
  ...
  public static Keyword emptySpecialist(ControlFrame frame, Keyword lastmove) {
    { Proposition proposition = frame.proposition;
      ...
      lastmove = lastmove;
      return (Logic.selectProofResult(emptyP, Stella.FALSE, Stella.TRUE));
    }
  }
  ...
  public static Keyword rangeMinCardinalitySpecialist(ControlFrame frame, Keyword lastmove) {
    { Proposition proposition = frame.proposition;
      ...
      IntegerWrapper mincardvalue = ((IntegerWrapper)(Logic.argumentBoundTo(mincardarg)));
      ...
      { boolean testValue000 = Stella.FALSE;
        ...
        if (testValue000) {
          { boolean successP = ((mincardvalue != null) ? (computedvalue >= mincardvalue.wrapperValue) : Logic.bindArgumentToValueP(mincardarg, Stella.wrapInteger(computedvalue), Stella.TRUE));

            return (Logic.selectProofResult(successP, Stella.FALSE, Stella.TRUE));
          }
        }
        else {
          return (Logic.KWD_FAILURE);
  ...
  public static Keyword rangeMaxCardinalitySpecialist(ControlFrame frame, Keyword lastmove) {
    { Proposition proposition = frame.proposition;
      ...
      IntegerWrapper maxcardvalue = ((IntegerWrapper)(Logic.argumentBoundTo(maxcardarg)));
      int computedvalue = Stella.NULL_INTEGER;
      ...
      { boolean testValue000 = Stella.FALSE;
        ...
        if (testValue000) {
          { boolean successP = ((maxcardvalue != null) ? (computedvalue <= maxcardvalue.wrapperValue) : Logic.bindArgumentToValueP(maxcardarg, Stella.wrapInteger(computedvalue), Stella.TRUE));
  ...
  public static Keyword rangeTypeSpecialist(ControlFrame frame, Keyword lastmove) {
    { Proposition proposition = frame.proposition;
      ...
      return (Logic.selectProofResult(NamedDescription.testRangeTypeP(((NamedDescription)(relation)), instance, ((NamedDescription)(valuetypevalue))), Stella.FALSE, Stella.TRUE));
    }
  }
      ...
      if (description != null) {
        if (Surrogate.subtypeOfP(Stella_Object.safePrimaryType(description), Logic.SGT_LOGIC_DESCRIPTION)) {
          { Description description000 = ((Description)(description));
            ...
            return (Stella.wrapInteger(description000.arity()));
          }
        }
        else {
          return (null);
  ...
  public static Keyword relationHierarchySpecialist(ControlFrame frame, Keyword lastmove) {
    { Proposition proposition = frame.proposition;
      ...
      boolean reflexiveP = Stella.FALSE;
      Iterator iterator = ((Iterator)(KeyValueList.dynamicSlotValue(frame.dynamicSlots, Logic.SYM_STELLA_ITERATOR, null)));
      Cons collection = Stella.NIL;
      ...
      if (iterator == null) {
        if (relation == Logic.SGT_PL_KERNEL_KB_DIRECT_SUBRELATION) {
          collection = NamedDescription.allDirectSubrelations(((NamedDescription)(boundargvalue)), Stella.TRUE);
        }
        else if (relation == Logic.SGT_PL_KERNEL_KB_SUBRELATION) {
          reflexiveP = Stella.TRUE;
          collection = NamedDescription.allSubrelations(((NamedDescription)(boundargvalue)), Stella.FALSE);
        }
        else if (relation == Logic.SGT_PL_KERNEL_KB_PROPER_SUBRELATION) {
          collection = NamedDescription.allSubrelations(((NamedDescription)(boundargvalue)), Stella.TRUE);
        }
        else if (relation == Logic.SGT_PL_KERNEL_KB_DIRECT_SUPERRELATION) {
          collection = NamedDescription.allDirectSuperrelations(((NamedDescription)(boundargvalue)), Stella.TRUE);
        }
        else if (relation == Logic.SGT_PL_KERNEL_KB_SUPERRELATION) {
          reflexiveP = Stella.TRUE;
          collection = NamedDescription.allSuperrelations(((NamedDescription)(boundargvalue)), Stella.FALSE);
        }
        else if (relation == Logic.SGT_PL_KERNEL_KB_PROPER_SUPERRELATION) {
          collection = NamedDescription.allSuperrelations(((NamedDescription)(boundargvalue)), Stella.TRUE);
        }
        else if (relation == Logic.SGT_PL_KERNEL_KB_EQUIVALENT_RELATION) {
          collection = NamedDescription.allEquivalentRelations(((NamedDescription)(boundargvalue)), Stella.TRUE);
        }
        else {
          { OutputStringStream stream000 = OutputStringStream.newOutputStringStream();
      ...
      if (iterator.nextP() &&
          Logic.bindArgumentToValueP(otherarg, iterator.value, Stella.TRUE)) {
        return (Logic.KWD_CONTINUING_SUCCESS);
      }
      else {
        return (Logic.KWD_TERMINAL_FAILURE);
  ...
  public static Keyword projectColumnSpecialist(ControlFrame frame, Keyword lastmove) {
    { Proposition proposition = frame.proposition;
        ...
        { Surrogate testValue000 = Stella_Object.safePrimaryType(collectionvalue);
          ...
          if (Surrogate.subtypeOfP(testValue000, Logic.SGT_STELLA_COLLECTION)) {
            { Collection collectionvalue000 = ((Collection)(collectionvalue));
              ...
              { List members = Logic.helpProjectNthColumn(selector, Logic.assertedCollectionMembers(collectionvalue000, Stella.FALSE));

                if (members == null) {
                  return (Logic.KWD_TERMINAL_FAILURE);
                }
                return (Logic.selectProofResult(Logic.bindArgumentToValueP(listarg, Logic.createLogicalList(members), Stella.TRUE), Stella.FALSE, Stella.TRUE));
              }
            }
          }
          else if (Surrogate.subtypeOfP(testValue000, Logic.SGT_LOGIC_SKOLEM)) {
      ...
      { List list = Logic.helpProjectNthColumn(selector, frame.down.patternRecord.collectionList);
        ...
        return (Logic.selectProofResult(Logic.bindArgumentToValueP(listarg, Logic.createLogicalList(list), Stella.TRUE), Stella.FALSE, Stella.TRUE));
      }
    }
  }
  ...
  public static void retractSynonymDemon(Proposition self) {
    { Stella_Object term = Logic.valueOf((self.arguments.theArray)[0]);
      ...
      { Proposition prop = null;
        Iterator iter000 = Logic.allTrueDependentPropositions(term, Logic.SGT_PL_KERNEL_KB_SYNONYM, Stella.FALSE);
  ...
  public static Keyword differentSpecialist(ControlFrame frame, Keyword lastmove) {
    { Vector arguments = frame.proposition.arguments;
      ...
      { Stella_Object arg = null;
        ...
        loop000 : while (index000 < length000) {
          ...
          if ((value == null) ||
            ...
            nofboundarguments = nofboundarguments + 1;
          }
          if (collect000 == null) {
            {
              collect000 = Stella_Object.cons(value, Stella.NIL);
      ...
      nofuniquearguments = argumentvalues.removeDuplicates().length();
      if ((nofboundarguments == nofarguments) &&
          (nofboundarguments == nofuniquearguments)) {
        ControlFrame.setFrameTruthValue(frame, Logic.TRUE_TRUTH_VALUE);
        return (Logic.KWD_FINAL_SUCCESS);
      }
      else if (nofboundarguments == nofuniquearguments) {
        return (Logic.KWD_FAILURE);
      }
      else {
        ControlFrame.setFrameTruthValue(frame, Logic.FALSE_TRUTH_VALUE);
  ...
  public static void initializeKernelKb() {
    { Wrapper kernelinitfile = Stella.lookupConfigurationProperty("PLKernelKBInitFile", Stella.wrapString("PL:sources;logic;pl-kernel-kb.plm"), null);
      ...
      { Object old$WarnifredefineP$000 = Stella.$WARNIFREDEFINEp$.get();
        ...
        try {
          Native.setBooleanSpecial(Stella.$WARNIFREDEFINEp$, Stella.FALSE);
          { Object old$Module$000 = Stella.$MODULE$.get();
            Object old$Context$000 = Stella.$CONTEXT$.get();

            try {
              Native.setSpecial(Stella.$MODULE$, Stella.getStellaModule("PL-KERNEL-KB", Stella.TRUE));
              ...
              NamedDescription.getDescriptionExtension(dummyconcept, Stella.TRUE);
              ...
              { NamedDescription thing = Logic.getDescription(Logic.SYM_STELLA_THING.getStellaClass(Stella.TRUE));
  ...
  public static NumberWrapper plusComputation(NumberWrapper x, NumberWrapper y) {
    { double floatresult = Stella.NULL_FLOAT;
            ...
            { Surrogate testValue001 = Stella_Object.safePrimaryType(y);
              ...
              if (Surrogate.subtypeOfIntegerP(testValue001)) {
                { IntegerWrapper y000 = ((IntegerWrapper)(y));
                  ...
                  return (Stella.wrapInteger(((int)(x000.wrapperValue + y000.wrapperValue))));
                }
              }
              else if (Surrogate.subtypeOfFloatP(testValue001)) {
                { FloatWrapper y000 = ((FloatWrapper)(y));
      ...
      return (Stella.wrapFloat(floatresult));
    }
  }
                ...
                if (Surrogate.subtypeOfIntegerP(testValue001)) {
                  { IntegerWrapper y000 = ((IntegerWrapper)(y));
                    ...
                    if (((x000.wrapperValue) % (y000.wrapperValue)) == 0) {
                      return (Stella.wrapInteger(((x000.wrapperValue) / (y000.wrapperValue))));
                    }
                    else {
        ...
        if (Surrogate.subtypeOfIntegerP(testValue000)) {
          { IntegerWrapper x000 = ((IntegerWrapper)(x));
            ...
            if (floatresult == ((double)(integerresult))) {
              return (Stella.wrapInteger(integerresult));
            }
            else {
              return (Stella.wrapFloat(floatresult));
            }
  ...
  public static Stella_Object sqrtConstraint(IntegerWrapper missingArgument, NumberWrapper x1, NumberWrapper x2) {
    { Stella_Object value = null;
      ...
      switch (missingArgument.wrapperValue) {
        ...
        break;
        case 1: 
          if (PlKernelKb.arithmeticLessTest(x1, Stella.wrapInteger(0))) {
            value = null;
          }
          else {
  ...
  public static IntervalCache createIntervalCache(LogicObject intervalmember, boolean integerP) {
    { IntervalCache intervalcache = (integerP ? ((IntervalCache)(IntegerIntervalCache.newIntegerIntervalCache())) : ((IntervalCache)(FloatIntervalCache.newFloatIntervalCache())));
    ...
    { Stella_Object intervalcache = Logic.accessBinaryValue(self, PlKernelKb.SGT_PL_KERNEL_KB_INTERVAL_CACHE_OF);
      ...
      if ((intervalcache != null) &&
          ((!Logic.skolemP(intervalcache)) &&
           (((IntervalCache)(intervalcache)).homeContext == ((Context)(Stella.$CONTEXT$.get()))))) {
        return (((IntervalCache)(intervalcache)));
      }
      else {
        return (PlKernelKb.createIntervalCache(self, Logic.testIsaP(self, Logic.SGT_STELLA_INTEGER) ||
            (Logic.functionOutputSkolemP(self) &&
             Logic.logicalSubtypeOfP(((Skolem)(self)).skolemType, Logic.SGT_STELLA_INTEGER))));
      }
    }
  }

  public static int coerceIntervalBoundToInteger(Stella_Object self, Surrogate operator) {
    { Surrogate testValue000 = Stella_Object.safePrimaryType(self);

      if (Surrogate.subtypeOfIntegerP(testValue000)) {
        { IntegerWrapper self000 = ((IntegerWrapper)(self));

          return (PlKernelKb.integerDcoerceIntervalBoundToInteger(self000, operator));
        }
      }
      else if (Surrogate.subtypeOfFloatP(testValue000)) {
        { FloatWrapper self000 = ((FloatWrapper)(self));

          return (PlKernelKb.floatDcoerceIntervalBoundToInteger(self000, operator));
        }
      }
      else {
  ...
  public static int integerDcoerceIntervalBoundToInteger(IntegerWrapper self, Surrogate operator) {
    if (self.wrapperValue == Stella.NULL_INTEGER) {
      return (Stella.NULL_INTEGER);
    }
  ...
  public static int floatDcoerceIntervalBoundToInteger(FloatWrapper self, Surrogate operator) {
    if (self.wrapperValue == Stella.NULL_FLOAT) {
      return (Stella.NULL_INTEGER);
    }
    if (operator == PlKernelKb.SGT_PL_KERNEL_KB_g) {
      return (Native.floor(self.wrapperValue) + 1);
    }
    else if (operator == Logic.SGT_PL_KERNEL_KB_ge) {
      return (Native.ceiling(self.wrapperValue));
    }
    else if (operator == PlKernelKb.SGT_PL_KERNEL_KB_l) {
      return (Native.ceiling(self.wrapperValue) - 1);
    }
    else if (operator == PlKernelKb.SGT_PL_KERNEL_KB_el) {
      return (Native.floor(self.wrapperValue));
    }
    else {
      { OutputStringStream stream000 = OutputStringStream.newOutputStringStream();
  ...
  public static NumberWrapper accessIntervalBounds(Stella_Object x, Keyword lowerorupper, Object [] MV_returnarray) {
    if (Surrogate.subtypeOfP(Stella_Object.safePrimaryType(x), Logic.SGT_STELLA_NUMBER_WRAPPER)) {
      { NumberWrapper x000 = ((NumberWrapper)(x));

        { NumberWrapper _return_temp = x000;
  ...
  public static boolean compareIntervalBoundsP(Surrogate relation, NumberWrapper x, NumberWrapper y) {
    if (PlKernelKb.nullNumberP(x) ||
        PlKernelKb.nullNumberP(y)) {
      return (Stella.FALSE);
    }
  ...
  public static boolean satisfiesIntervalBoundsP(Stella_Object renamed_Object, NumberWrapper value) {
    { NumberWrapper lb = null;
      boolean strictlowerP = Stella.FALSE;
      NumberWrapper ub = null;
      boolean strictupperP = Stella.FALSE;
      boolean answer = Stella.TRUE;
      ...
      if (PlKernelKb.nullNumberP(value)) {
        return (Stella.FALSE);
      }
      if (!(PlKernelKb.nullNumberP(lb))) {
        if (strictlowerP) {
  ...
  public static Keyword lessSpecialist(ControlFrame frame, Keyword lastmove) {
    { Proposition proposition = frame.proposition;
      Surrogate relation = ((Surrogate)(proposition.operator));
      Stella_Object xarg = (proposition.arguments.theArray)[0];
      Stella_Object yarg = (proposition.arguments.theArray)[1];
      Stella_Object x = Logic.argumentBoundTo(xarg);
      Stella_Object y = Logic.argumentBoundTo(yarg);
      NumberWrapper xbound = null;
      boolean strictxP = Stella.FALSE;
      NumberWrapper ybound = null;
      boolean strictyP = Stella.FALSE;
      ...
      { boolean successP = Stella.FALSE;
        ...
        if (y == null) {
          ...
          if (relation == PlKernelKb.SGT_PL_KERNEL_KB_l) {
            if ((!PlKernelKb.nullNumberP(xbound)) &&
                Stella_Object.isaP(xbound, Logic.SGT_STELLA_INTEGER_WRAPPER)) {
              xbound = Stella.wrapInteger(((IntegerWrapper)(xbound)).wrapperValue + 1);
            }
          }
          else {
          }
          if (!PlKernelKb.nullNumberP(xbound)) {
            successP = PatternVariable.bindVariableToValueP(((PatternVariable)(yarg)), xbound, Stella.TRUE);
          }
          return (Logic.selectProofResult(successP, Stella.FALSE, Stella.FALSE));
        }
        if (x == null) {
          { Object [] caller_MV_returnarray = new Object[1];
          ...
          if (relation == PlKernelKb.SGT_PL_KERNEL_KB_l) {
            if ((!PlKernelKb.nullNumberP(ybound)) &&
                Stella_Object.isaP(ybound, Logic.SGT_STELLA_INTEGER_WRAPPER)) {
              ybound = Stella.wrapInteger(((IntegerWrapper)(ybound)).wrapperValue - 1);
            }
          }
          else {
          }
          if (!PlKernelKb.nullNumberP(ybound)) {
            successP = PatternVariable.bindVariableToValueP(((PatternVariable)(xarg)), ybound, Stella.TRUE);
          }
          return (Logic.selectProofResult(successP, Stella.FALSE, Stella.FALSE));
        }
      }
      if (((Boolean)(Logic.$REVERSEPOLARITYp$.get())).booleanValue()) {
        { Stella_Object tempnumber = x;
        ...
        if (relation == PlKernelKb.SGT_PL_KERNEL_KB_l) {
          ...
          relation = PlKernelKb.SGT_PL_KERNEL_KB_l;
        }
        else {
          { OutputStringStream stream000 = OutputStringStream.newOutputStringStream();
      ...
      { boolean successP = Stella.FALSE;
        ...
        if (relation == PlKernelKb.SGT_PL_KERNEL_KB_l) {
          ...
          successP = PlKernelKb.compareIntervalBoundsP(relation, xbound, ybound);
        }
        else {
          { OutputStringStream stream001 = OutputStringStream.newOutputStringStream();
        ...
        if (relation == PlKernelKb.SGT_PL_KERNEL_KB_el) {
          ...
          successP = PlKernelKb.compareIntervalBoundsP(PlKernelKb.SGT_PL_KERNEL_KB_el, ybound, xbound);
        }
        else {
          { OutputStringStream stream002 = OutputStringStream.newOutputStringStream();

            stream002.nativeStream.print("`" + relation + "' is not a valid case option");
            throw ((StellaException)(StellaException.newStellaException(stream002.theStringReader()).fillInStackTrace()));
          }
        }
        if (successP) {
  ...
  public static Keyword greaterSpecialist(ControlFrame frame, Keyword lastmove) {
    { Proposition proposition = frame.proposition;
      Surrogate relation = ((Surrogate)(proposition.operator));
      Vector arguments = proposition.arguments;

      if (relation == PlKernelKb.SGT_PL_KERNEL_KB_g) {
        proposition.operator = PlKernelKb.SGT_PL_KERNEL_KB_l;
      }
      else if (relation == Logic.SGT_PL_KERNEL_KB_ge) {
        proposition.operator = PlKernelKb.SGT_PL_KERNEL_KB_el;
      }
      else {
        { OutputStringStream stream000 = OutputStringStream.newOutputStringStream();
      ...
      { Stella_Object temp = (arguments.theArray)[0];

        (arguments.theArray)[0] = ((arguments.theArray)[1]);
        (arguments.theArray)[1] = temp;
      }
      return (PlKernelKb.lessSpecialist(frame, lastmove));
    }
  }
  ...
  public static Stella_Object concatenateConstraint(IntegerWrapper missingArgument, StringWrapper x1, StringWrapper x2, StringWrapper x3) {
    { Stella_Object value = null;
      ...
      switch (missingArgument.wrapperValue) {
        ...
        case 0: 
          { String s2 = x2.wrapperValue;
            ...
            if ((n >= 0) &&
              ...
              value = Stella.wrapString(Native.string_subsequence(s3, 0, n));
            }
            else {
              value = null;
            }
        ...
        case 1: 
          { String s1 = x1.wrapperValue;
            ...
            if (Stella.stringEqlP(Native.string_subsequence(s3, 0, l1), s1)) {
              value = Stella.wrapString(Native.string_subsequence(s3, l1, Stella.NULL_INTEGER));
            }
            else {
              value = null;
            }
        ...
        break;
        case 2: 
          value = Stella.wrapString(x1.wrapperValue + x2.wrapperValue);
        break;
        default:
        break;
      }
        ...
        if (superargvalue == null) {
            ...
            if ((p1Argvalue == null) ||
            ...
            else {
              {
                ...
                if ((p1 < 0) ||
                  ...
                  return (Logic.selectProofResult(Logic.bindArgumentToValueP(subarg, Stella.wrapString(Native.string_subsequence(renamed_Super, p1, p2)), Stella.TRUE), Stella.FALSE, Stella.TRUE));
                }
              }
            }
          }
          ...
          if (p2Argvalue == null) {
            ...
            { int p2 = ((IntegerWrapper)(p2Argvalue)).wrapperValue;
              ...
              if (lsub > p2) {
                ...
                return (Logic.selectProofResult(Logic.bindArgumentToValueP(p1Arg, Stella.wrapInteger(p2 - lsub), Stella.TRUE), Stella.FALSE, Stella.TRUE));
              }
              else {
                return (Logic.KWD_TERMINAL_FAILURE);
              }
          ...
          { int p1 = ((IntegerWrapper)(p1Argvalue)).wrapperValue;
            ...
            if ((p1 < 0) ||
              ...
              return (Logic.selectProofResult(Logic.bindArgumentToValueP(p2Arg, Stella.wrapInteger(p1 + lsub), Stella.TRUE), Stella.FALSE, Stella.TRUE));
            }
            else {
              return (Logic.KWD_TERMINAL_FAILURE);
            }
          ...
          { boolean matchP = Logic.bindArgumentToValueP(subarg, Stella.wrapString(Native.string_subsequence(StringWrapper.unwrapString(((StringWrapper)(superargvalue))), ((IntegerWrapper)(p1Argvalue)).wrapperValue, ((IntegerWrapper)(p2Argvalue)).wrapperValue)), Stella.TRUE);

            ControlFrame.setFrameTruthValue(frame, (matchP ? Logic.TRUE_TRUTH_VALUE : Logic.FALSE_TRUTH_VALUE));
            return (Logic.selectProofResult(matchP, Stella.FALSE, Stella.TRUE));
          }
        }
      }
      if (iterator.nextP() &&
          (Logic.bindArgumentToValueP(p1Arg, ((Cons)(iterator.value)).value, Stella.TRUE) &&
           Logic.bindArgumentToValueP(p2Arg, ((Cons)(iterator.value)).rest.value, Stella.TRUE))) {
        return (Logic.KWD_CONTINUING_SUCCESS);
      }
      else {
        return (Logic.KWD_TERMINAL_FAILURE);
  ...
  public static IntegerWrapper stringMatchComputation(Stella_Object pattern, Stella_Object x, Stella_Object start, Stella_Object end) {
    ...
    { String thepattern = ((StringWrapper)(pattern)).wrapperValue;
      ...
      if (matchposition != Stella.NULL_INTEGER) {
        return (Stella.wrapInteger(matchposition));
      }
      else {
        return (null);
      }
  ...
  public static IntegerWrapper lengthComputation(Stella_Object x) {
    if (Surrogate.subtypeOfStringP(Stella_Object.safePrimaryType(x))) {
      { StringWrapper x000 = ((StringWrapper)(x));
        ...
        return (Stella.wrapInteger((x000.wrapperValue).length()));
      }
    }
    else {
      System.out.print("Length computation not yet implemented for Lists");
      return (Stella.wrapInteger(Stella.NULL_INTEGER));
    }
  }
