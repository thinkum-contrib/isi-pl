  ...
  static void helpStartupLoomSupport1() {
    {
      ...
      LoomApi.SYM_LOOM_API_QUERY_082 = ((Symbol)(Stella.internRigidSymbolWrtModule("QUERY-082", null, 0)));
      LoomApi.SGT_LOOM_API_LOOM_ROLE_OF = ((Surrogate)(Stella.internRigidSymbolWrtModule("LOOM-ROLE-OF", null, 1)));
      LoomApi.SYM_LOOM_API_QUERY_083 = ((Symbol)(Stella.internRigidSymbolWrtModule("QUERY-083", null, 0)));
      ...
      LoomApi.SYM_LOOM_API_RANGE_MAX_CARDINALITY = ((Symbol)(Stella.internRigidSymbolWrtModule("RANGE-MAX-CARDINALITY", null, 0)));
      LoomApi.SYM_LOOM_API_INSTANCE_OF = ((Symbol)(Stella.internRigidSymbolWrtModule("INSTANCE-OF", null, 0)));
      LoomApi.SYM_LOOM_API_QUERY_084 = ((Symbol)(Stella.internRigidSymbolWrtModule("QUERY-084", null, 0)));
      LoomApi.SYM_LOOM_API_QUERY_085 = ((Symbol)(Stella.internRigidSymbolWrtModule("QUERY-085", null, 0)));
      LoomApi.KWD_CONCEPTS = ((Keyword)(Stella.internRigidSymbolWrtModule("CONCEPTS", null, 2)));
      LoomApi.SYM_LOOM_API_QUERY_086 = ((Symbol)(Stella.internRigidSymbolWrtModule("QUERY-086", null, 0)));
      LoomApi.KWD_RELATIONS = ((Keyword)(Stella.internRigidSymbolWrtModule("RELATIONS", null, 2)));
      LoomApi.SYM_LOOM_API_QUERY_087 = ((Symbol)(Stella.internRigidSymbolWrtModule("QUERY-087", null, 0)));
      ...
      LoomApi.SYM_LOOM_API_QUERY_088 = ((Symbol)(Stella.internRigidSymbolWrtModule("QUERY-088", null, 0)));
      LoomApi.SYM_LOOM_API_QUERY_089 = ((Symbol)(Stella.internRigidSymbolWrtModule("QUERY-089", null, 0)));
      LoomApi.SYM_PL_KERNEL_KB_MUTUALLY_DISJOINT_COLLECTION = ((Symbol)(Stella.internRigidSymbolWrtModule("MUTUALLY-DISJOINT-COLLECTION", Stella.getStellaModule("/PL-KERNEL-KB", Stella.TRUE), 0)));
      LoomApi.SYM_LOOM_API_QUERY_090 = ((Symbol)(Stella.internRigidSymbolWrtModule("QUERY-090", null, 0)));
      ...
      LoomApi.SYM_LOOM_API_QUERY_091 = ((Symbol)(Stella.internRigidSymbolWrtModule("QUERY-091", null, 0)));
      ...
      try {
        ...
        if (Stella.currentStartupTimePhaseP(7)) {
          ...
          { MethodSlot function = Symbol.lookupFunction(LoomApi.SYM_LOOM_API_STARTUP_LOOM_SUPPORT);
            ...
            KeyValueList.setDynamicSlotValue(function.dynamicSlots, Logic.SYM_STELLA_METHOD_STARTUP_CLASSNAME, Stella.wrapString("_Startup-Loom-Support"), Stella.NULL_STRING_WRAPPER);
          }
        }
        ...
        if (Stella.currentStartupTimePhaseP(9)) {
          Logic.defrelation(Stella_Object.cons(((Symbol)(Stella_Object.copyConsTree(LoomApi.SYM_LOOM_API_LOOM_ROLE_OF))), Stella_Object.cons(((Cons)(Stella_Object.copyConsTree(Stella.getQuotedTree("(((?C CLASS) (?R RELATION) (?ROLE LOOM-ROLE)) \"/PL-KERNEL-KB/LOOM-API\")", "/PL-KERNEL-KB/LOOM-API")))), Stella_Object.cons(LoomApi.KWD_DOCUMENTATION, Stella_Object.cons(((StringWrapper)(Stella_Object.copyConsTree(Stella.wrapString("")))), Stella_Object.cons(LoomApi.KWD_AXIOMS, Stella_Object.cons(((Cons)(Stella_Object.copyConsTree(Stella.getQuotedTree("((SINGLE-VALUED LOOM-ROLE-OF) \"/PL-KERNEL-KB/LOOM-API\")", "/PL-KERNEL-KB/LOOM-API")))), Stella.NIL)))))));
        }
