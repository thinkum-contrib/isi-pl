...
public class LoomApi {
  ...
  public static Symbol SYM_LOOM_API_QUERY_082 = null;

  public static Surrogate SGT_LOOM_API_LOOM_ROLE_OF = null;

  public static Symbol SYM_LOOM_API_QUERY_083 = null;
  ...
  public static Symbol SYM_LOOM_API_RANGE_MAX_CARDINALITY = null;

  public static Symbol SYM_LOOM_API_INSTANCE_OF = null;

  public static Symbol SYM_LOOM_API_QUERY_084 = null;

  public static Symbol SYM_LOOM_API_QUERY_085 = null;

  public static Keyword KWD_CONCEPTS = null;

  public static Symbol SYM_LOOM_API_QUERY_086 = null;

  public static Keyword KWD_RELATIONS = null;

  public static Symbol SYM_LOOM_API_QUERY_087 = null;
  ...
  public static Symbol SYM_LOOM_API_QUERY_088 = null;

  public static Symbol SYM_LOOM_API_QUERY_089 = null;

  public static Symbol SYM_PL_KERNEL_KB_MUTUALLY_DISJOINT_COLLECTION = null;

  public static Symbol SYM_LOOM_API_QUERY_090 = null;

  public static Symbol SYM_LOOM_API_pCOVERED = null;

  public static Symbol SYM_LOOM_API_COVERING = null;

  public static Symbol SYM_LOOM_API_QUERY_091 = null;
    ...
    { Stella_Object instance = Logic.getInstance(instanceref);
      ...
      { Stella_Object r = null;
        ...
        while (!(iter000 == Stella.NIL)) {
          ...
          roles = Stella_Object.cons(LoomApi.findOrCreateLoomRole(instance, r, Stella.TRUE), roles);
        }
      }
      return (roles);
    }
  ...
  public static Cons getRoleNamesAndValues(Stella_Object instanceref) {
    { Stella_Object instance = Logic.getInstance(instanceref);
      ...
      { Proposition p = null;
        Iterator iter000 = ((Iterator)(Logic.allTrueDependentPropositions(instance, null, Stella.TRUE).concatenate(Logic.allTrueDependentPropositions(instance, null, Stella.TRUE), Stella.NIL)));
  ...
  public static Cons getEquivalentNames(Stella_Object relationref) {
    { LogicObject relation = Logic.getRelation(relationref);
      ...
      { LogicObject e = null;
        Cons iter000 = LogicObject.allEquivalentCollections(relation, Stella.TRUE);
  ...
  public static boolean instanceP(Stella_Object objectref) {
    { Object old$SuppressnonlogicobjectwarningP$000 = Logic.$SUPPRESSNONLOGICOBJECTWARNINGp$.get();
      ...
      try {
        Native.setBooleanSpecial(Logic.$SUPPRESSNONLOGICOBJECTWARNINGp$, Stella.TRUE);
  ...
  public static void addRoleValue(Stella_Object instanceref, Stella_Object relationref, Stella_Object valueref) {
    LoomApi.updateRoleValue(instanceref, relationref, valueref, Stella.TRUE);
  }
  ...
  public static void removeRoleValue(Stella_Object instanceref, Stella_Object relationref, Stella_Object valueref) {
    LoomApi.updateRoleValue(instanceref, relationref, valueref, Stella.FALSE);
  }
      ...
      if (Logic.classP(classtype)) {
        if (directP) {
          { Cons instances = Logic.allClassInstances(classtype);
            ...
            Cons directsubs = NamedDescription.allDirectSubrelations(((NamedDescription)(Logic.getInstance(classref))), Stella.TRUE);
            boolean instanceOfSubP = Stella.FALSE;
  ...
  public static boolean subrelationP(Stella_Object subrelationref, Stella_Object superrelationref) {
    { LogicObject subrelation = Logic.getRelation(subrelationref);
      ...
      if (Logic.relationP(subrelationtype) &&
        ...
        {
          Description.findDirectSupersAndSubs(((Description)(subrelation)), Stella.TRUE, new Object[2]);
      ...
      if (Logic.relationP(relation)) {
        if (directP) {
          { NamedDescription renamed_Super = null;
            Cons iter000 = NamedDescription.allDirectSuperrelations(((NamedDescription)(relation)), Stella.TRUE);
          ...
          { NamedDescription renamed_Super = null;
            Cons iter001 = NamedDescription.allSuperrelations(((NamedDescription)(relation)), Stella.TRUE);
      ...
      if (Logic.relationP(relation)) {
        if (directP) {
          { NamedDescription sub = null;
            Cons iter000 = NamedDescription.allDirectSubrelations(((NamedDescription)(relation)), Stella.TRUE);
          ...
          { NamedDescription sub = null;
            Cons iter001 = NamedDescription.allSubrelations(((NamedDescription)(relation)), Stella.TRUE);
    ...
    { Cons relations = Stella.NIL;
        ...
        { Description r = null;
          ...
          while (!(iter002 == Stella.NIL)) {
            ...
            if (LoomApi.namedP(r)) {
              ...
              clauses = Stella_Object.cons(((Cons)(LogicObject.generateExpression(r, Stella.TRUE))).rest.rest.value, clauses);
            }
          }
        }
      ...
      { Cons supers = null;
        ...
        { Object [] caller_MV_returnarray = new Object[2];
          ...
          supers = Description.findDirectSupersAndSubs(((Description)(conjunctiondescription)), Stella.TRUE, caller_MV_returnarray);
  ...
  public static Stella_Object generateSourceExpression(Stella_Object instanceref) {
    { Stella_Object instance = Logic.getInstance(instanceref);
      ...
      return (LogicObject.generateExpression(((LogicObject)(instance)), Stella.FALSE));
    }
  }
  ...
  public static Cons getPartitions(Stella_Object classref) {
    { LogicObject renamed_Class = Logic.getClass(classref);
      ...
      if (renamed_Class != null) {
        { LogicObject c = null;
          Cons iter000 = LoomApi.getSubrelations(renamed_Class, Stella.TRUE);
  ...
  public static Cons collectionMembers(Stella_Object instanceref) {
    { Stella_Object instance = Logic.getInstance(instanceref);
      ...
      if (instance != null) {
        return (Logic.assertedCollectionMembers(instance, Stella.FALSE).consify());
      }
      return (Stella.NIL);
    }
  }
