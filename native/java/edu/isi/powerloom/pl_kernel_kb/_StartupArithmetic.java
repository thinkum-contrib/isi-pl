  ...
  static void helpStartupArithmetic1() {
    {
      ...
      PlKernelKb.SYM_STELLA_HOME_CONTEXT = ((Symbol)(Stella.internRigidSymbolWrtModule("HOME-CONTEXT", Stella.getStellaModule("/STELLA", Stella.TRUE), 0)));
      ...
      PlKernelKb.SYM_STELLA_LOWER_BOUND = ((Symbol)(Stella.internRigidSymbolWrtModule("LOWER-BOUND", Stella.getStellaModule("/STELLA", Stella.TRUE), 0)));
      PlKernelKb.SYM_STELLA_UPPER_BOUND = ((Symbol)(Stella.internRigidSymbolWrtModule("UPPER-BOUND", Stella.getStellaModule("/STELLA", Stella.TRUE), 0)));
