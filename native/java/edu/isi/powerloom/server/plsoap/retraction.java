...
public class retraction extends SoapCommand {
  public static retraction new_retraction() {
    { retraction self = null;
  ...
  public static Stella_Object access_retraction_Slot_Value(retraction self, Symbol slotname, Stella_Object value, boolean setvalueP) {
  ...
  public Surrogate primaryType() {
    { retraction self = this;

      return (Plsoap.SGT_PLSOAP_retraction);
    }
  }
