...
public class assertion extends SoapCommand {
  public static assertion new_assertion() {
    { assertion self = null;
  ...
  public static Stella_Object access_assertion_Slot_Value(assertion self, Symbol slotname, Stella_Object value, boolean setvalueP) {
  ...
  public Surrogate primaryType() {
    { assertion self = this;
      ...
      return (Plsoap.SGT_PLSOAP_assertion);
    }
  }
