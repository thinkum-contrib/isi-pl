...
public class nresults extends XMLObject {
    public String type;

  public static nresults new_nresults() {
    { nresults self = null;
  ...
  public static Stella_Object access_nresults_Slot_Value(nresults self, Symbol slotname, Stella_Object value, boolean setvalueP) {
    if (slotname == Plsoap.SYM_XSI_type) {
      if (setvalueP) {
  ...
  public Surrogate primaryType() {
    { nresults self = this;
      ...
      return (Plsoap.SGT_PLSOAP_nresults);
    }
  }
