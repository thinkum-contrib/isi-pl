...
public class stellaerror extends XMLObject {
  public static stellaerror new_stellaerror() {
    { stellaerror self = null;

      self = new stellaerror();
  ...
  public Surrogate primaryType() {
    { stellaerror self = this;

      return (Plsoap.SGT_PLSOAP_stellaerror);
    }
  }
