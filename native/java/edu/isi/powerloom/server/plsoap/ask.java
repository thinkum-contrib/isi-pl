...
public class ask extends SoapCommand {
    public options options;

  public static ask new_ask() {
    { ask self = null;
  ...
  public static Stella_Object access_ask_Slot_Value(ask self, Symbol slotname, Stella_Object value, boolean setvalueP) {
