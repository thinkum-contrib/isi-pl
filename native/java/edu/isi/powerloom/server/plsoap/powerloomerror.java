...
public class powerloomerror extends XMLObject {
  public static powerloomerror new_powerloomerror() {
    { powerloomerror self = null;

      self = new powerloomerror();
  ...
  public Surrogate primaryType() {
    { powerloomerror self = this;

      return (Plsoap.SGT_PLSOAP_powerloomerror);
    }
  }
