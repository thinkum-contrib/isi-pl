...
public class nativeerror extends XMLObject {
  public static nativeerror new_nativeerror() {
    { nativeerror self = null;

      self = new nativeerror();
  ...
  public Surrogate primaryType() {
    { nativeerror self = this;

      return (Plsoap.SGT_PLSOAP_nativeerror);
    }
  }
