...
public class command extends SoapCommand {
  ...
  public static Stella_Object access_command_Slot_Value(command self, Symbol slotname, Stella_Object value, boolean setvalueP) {
  ...
  public Surrogate primaryType() {
    { command self = this;
      ...
      return (Plsoap.SGT_PLSOAP_command);
    }
  }
