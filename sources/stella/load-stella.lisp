...
;;; Version: $Id: load-stella.lisp,v 1.21 2000/04/06 17:42:36 tar Exp $
...
(defvar *stella-native-directory* "PL:natives;lisp;stella;")
...
(("PL:sources;stella;**;*.*" "/u0/stella/**/*.*")
    ("PL:natives;stella;**;*.*" "/u0/stella/LISP-SRC/**/*.*")
    #+allegro-v4.2
...
(defvar *stella-binary-extension*
    (format nil ".~a~a"
            ...
            #+(or :mcl :allegro) "fasl"
            #+:lucid "sbin"
            #+(:and :lispworks :harlequin-pc-lisp) "fsl"
