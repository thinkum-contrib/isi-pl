...
(CL:DEFUN JAVA-OUTPUT-ALL-UNITS-TO-FILE (SOURCEFILE)
  NULL
  :VOID)
    ...
    (CL:LET*
     ((METHOD
       (DEFINE-METHOD-FROM-STRINGIFIED-SOURCE
        ...
        "FILE-NAME"
        "(DEFUN JAVA-OUTPUT-ALL-UNITS-TO-FILE ((SOURCEFILE FILE-NAME)))")))
     (CL:SETF
      (CLSYS-SVAL METHOD-SLOT FUNCTION-CODE METHOD)
      (CL:FUNCTION JAVA-OUTPUT-ALL-UNITS-TO-FILE)))
    (CL:LET*
     ((METHOD
       (DEFINE-METHOD-FROM-STRINGIFIED-SOURCE
        "JAVA-TRANSLATE-FILE"
     ...
     (CL:SETF
      (CLSYS-SVAL METHOD-SLOT FUNCTION-CODE METHOD)
      (CL:FUNCTION JAVA-TRANSLATE-FILE)))
    (DEFINE-METHOD-FROM-STRINGIFIED-SOURCE
     "STARTUP-JAVA-TRANSLATE-FILE"
     NULL
     "(DEFUN STARTUP-JAVA-TRANSLATE-FILE ())"))
   (CL:WHEN
