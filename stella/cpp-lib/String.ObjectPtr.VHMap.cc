...
StringObjectPtrVHMap::StringObjectPtrVHMap(ObjectPtr  dflt, unsigned int sz)
     :StringObjectPtrMap(dflt)
{
...
StringObjectPtrVHMap::StringObjectPtrVHMap(StringObjectPtrVHMap& a) : StringObjectPtrMap(a.def)
{
...
Pix StringObjectPtrVHMap::seek(String  key)
{
...
ObjectPtr& StringObjectPtrVHMap::operator [](String  item)
{
...
void StringObjectPtrVHMap::del(String  key)
{
  unsigned int hashval = StringHASH(key);
  unsigned int h = hashval % size;
  for (unsigned int i = 0; i <= size; ++i)
...
void StringObjectPtrVHMap::clear()
{
  for (unsigned int i = 0; i < size; ++i) status[i] = EMPTYCELL;
  count = 0;
}

void StringObjectPtrVHMap::resize(unsigned int newsize)
{
  if (newsize <= count)
  {
...
Pix StringObjectPtrVHMap::first()
{
...
void StringObjectPtrVHMap::next(Pix& i)
{
  if (i == 0) return;
