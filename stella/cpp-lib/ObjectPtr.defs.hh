...
#ifndef _ObjectPtrdefs_h
#define _ObjectPtrdefs_h 1


// equality operator
#ifndef ObjectPtrEQ
#define ObjectPtrEQ(a, b)  ((a) == (b))
#endif

// less-than-or-equal
#ifndef ObjectPtrLE
#define ObjectPtrLE(a, b)  ((a) <= (b))
#endif

// comparison : less-than -> < 0; equal -> 0; greater-than -> > 0
#ifndef ObjectPtrCMP
#define ObjectPtrCMP(a, b) ( ((a) <= (b))? (((a) == (b))? 0 : -1) : 1 )
#endif

// hash function
#ifndef ObjectPtrHASH
extern unsigned int hash(ObjectPtr );
#define ObjectPtrHASH(x)  identhash((int)x)
#endif
